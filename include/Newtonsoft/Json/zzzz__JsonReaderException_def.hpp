...
namespace Newtonsoft::Json {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11765))}
...
/// @brief Method get_LineNumber addr 0x2505058 size 0x8 virtual false final false
 int32_t get_LineNumber() ;

/// @brief Method set_LineNumber addr 0x2505060 size 0x8 virtual false final false
 void set_LineNumber(int32_t value) ;

/// @brief Method get_LinePosition addr 0x2505068 size 0x8 virtual false final false
 int32_t get_LinePosition() ;

/// @brief Method set_LinePosition addr 0x2505070 size 0x8 virtual false final false
 void set_LinePosition(int32_t value) ;

/// @brief Method get_Path addr 0x2505078 size 0x8 virtual false final false
 ::StringW get_Path() ;

/// @brief Method set_Path addr 0x2505080 size 0x8 virtual false final false
 void set_Path(::StringW value) ;

// Ctor Parameters []
explicit JsonReaderException() ;

/// @brief Method .ctor addr 0x2505088 size 0x4 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit JsonReaderException(::StringW message) ;

/// @brief Method .ctor addr 0x250508c size 0x4 virtual false final false
 void _ctor(::StringW message) ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "innerException", ty: "System::Exception", modifiers: "", def_value: None }]
explicit JsonReaderException(::StringW message, System::Exception innerException) ;

/// @brief Method .ctor addr 0x2505090 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x2505094 size 0x4 virtual false final false
