...
/// @brief Method get_Id addr 0x24f9dd8 size 0x8 virtual false final false
 ::StringW get_Id() ;

/// @brief Method set_Id addr 0x24f9de0 size 0x8 virtual false final false
 void set_Id(::StringW value) ;

/// @brief Method get_Title addr 0x24f9de8 size 0x8 virtual false final false
 ::StringW get_Title() ;

/// @brief Method set_Title addr 0x24f9df0 size 0x8 virtual false final false
 void set_Title(::StringW value) ;

/// @brief Method get_Description addr 0x24f9df8 size 0x8 virtual false final false
 ::StringW get_Description() ;

/// @brief Method set_Description addr 0x24f9e00 size 0x8 virtual false final false
 void set_Description(::StringW value) ;

/// @brief Method get_ItemConverterType addr 0x24f9e08 size 0x8 virtual false final false
 System::Type get_ItemConverterType() ;

/// @brief Method set_ItemConverterType addr 0x24f9e10 size 0x8 virtual false final false
 void set_ItemConverterType(System::Type value) ;

/// @brief Method get_ItemConverterParameters addr 0x24f9e18 size 0x8 virtual false final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> get_ItemConverterParameters() ;

/// @brief Method set_ItemConverterParameters addr 0x24f9e20 size 0x8 virtual false final false
 void set_ItemConverterParameters(::ArrayW<::bs_hook::Il2CppWrapperType> value) ;

/// @brief Method get_IsReference addr 0x24f9e28 size 0x5c virtual false final false
 bool get_IsReference() ;

/// @brief Method set_IsReference addr 0x24f9e84 size 0x68 virtual false final false
 void set_IsReference(bool value) ;

/// @brief Method get_ItemIsReference addr 0x24f9eec size 0x5c virtual false final false
 bool get_ItemIsReference() ;

/// @brief Method set_ItemIsReference addr 0x24f9f48 size 0x68 virtual false final false
 void set_ItemIsReference(bool value) ;

/// @brief Method get_ItemReferenceLoopHandling addr 0x24f9fb0 size 0x50 virtual false final false
 Newtonsoft::Json::ReferenceLoopHandling get_ItemReferenceLoopHandling() ;

/// @brief Method set_ItemReferenceLoopHandling addr 0x24fa000 size 0x68 virtual false final false
 void set_ItemReferenceLoopHandling(Newtonsoft::Json::ReferenceLoopHandling value) ;

/// @brief Method get_ItemTypeNameHandling addr 0x24fa068 size 0x50 virtual false final false
 Newtonsoft::Json::TypeNameHandling get_ItemTypeNameHandling() ;

/// @brief Method set_ItemTypeNameHandling addr 0x24fa0b8 size 0x68 virtual false final false
 void set_ItemTypeNameHandling(Newtonsoft::Json::TypeNameHandling value) ;

// Ctor Parameters []
explicit JsonContainerAttribute() ;

/// @brief Method .ctor addr 0x24f9180 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "id", ty: "::StringW", modifiers: "", def_value: None }]
explicit JsonContainerAttribute(::StringW id) ;

/// @brief Method .ctor addr 0x24f91b0 size 0x28 virtual false final false
