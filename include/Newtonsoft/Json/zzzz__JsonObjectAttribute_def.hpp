...
/// @brief Method get_MemberSerialization addr 0x24fa1d4 size 0x8 virtual false final false
 Newtonsoft::Json::MemberSerialization get_MemberSerialization() ;

/// @brief Method set_MemberSerialization addr 0x24fa1dc size 0x8 virtual false final false
 void set_MemberSerialization(Newtonsoft::Json::MemberSerialization value) ;

/// @brief Method get_ItemRequired addr 0x24fa1e4 size 0x50 virtual false final false
 Newtonsoft::Json::Required get_ItemRequired() ;

/// @brief Method set_ItemRequired addr 0x24fa234 size 0x68 virtual false final false
 void set_ItemRequired(Newtonsoft::Json::Required value) ;

// Ctor Parameters []
explicit JsonObjectAttribute() ;

/// @brief Method .ctor addr 0x24fa29c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x24fa2a4 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x24fa2cc size 0x28 virtual false final false
