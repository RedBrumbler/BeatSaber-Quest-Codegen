...
/// @brief Method get_CurrentState addr 0x2505330 size 0x8 virtual false final false
 Newtonsoft::Json::Newtonsoft__Json__JsonReader__State get_CurrentState() ;

/// @brief Method get_CloseInput addr 0x2505338 size 0x8 virtual false final false
 bool get_CloseInput() ;

/// @brief Method set_CloseInput addr 0x2505340 size 0xc virtual false final false
 void set_CloseInput(bool value) ;

/// @brief Method get_SupportMultipleContent addr 0x250534c size 0x8 virtual false final false
 bool get_SupportMultipleContent() ;

/// @brief Method set_SupportMultipleContent addr 0x2505354 size 0xc virtual false final false
 void set_SupportMultipleContent(bool value) ;

/// @brief Method get_QuoteChar addr 0x2505360 size 0x8 virtual true final false
 char16_t get_QuoteChar() ;

/// @brief Method set_QuoteChar addr 0x2505368 size 0x8 virtual true final false
 void set_QuoteChar(char16_t value) ;

/// @brief Method get_DateTimeZoneHandling addr 0x2505370 size 0x8 virtual false final false
 Newtonsoft::Json::DateTimeZoneHandling get_DateTimeZoneHandling() ;

/// @brief Method set_DateTimeZoneHandling addr 0x2505378 size 0x64 virtual false final false
 void set_DateTimeZoneHandling(Newtonsoft::Json::DateTimeZoneHandling value) ;

/// @brief Method get_DateParseHandling addr 0x25053dc size 0x8 virtual false final false
 Newtonsoft::Json::DateParseHandling get_DateParseHandling() ;

/// @brief Method set_DateParseHandling addr 0x25053e4 size 0x64 virtual false final false
 void set_DateParseHandling(Newtonsoft::Json::DateParseHandling value) ;

/// @brief Method get_FloatParseHandling addr 0x2505448 size 0x8 virtual false final false
 Newtonsoft::Json::FloatParseHandling get_FloatParseHandling() ;

/// @brief Method set_FloatParseHandling addr 0x2505450 size 0x64 virtual false final false
 void set_FloatParseHandling(Newtonsoft::Json::FloatParseHandling value) ;

/// @brief Method get_DateFormatString addr 0x25054b4 size 0x8 virtual false final false
 ::StringW get_DateFormatString() ;

/// @brief Method set_DateFormatString addr 0x25054bc size 0x8 virtual false final false
 void set_DateFormatString(::StringW value) ;

/// @brief Method get_MaxDepth addr 0x25054c4 size 0x8 virtual false final false
 System::Nullable_1<int32_t> get_MaxDepth() ;

/// @brief Method set_MaxDepth addr 0x25054cc size 0xc0 virtual false final false
 void set_MaxDepth(System::Nullable_1<int32_t> value) ;

/// @brief Method get_TokenType addr 0x250558c size 0x8 virtual true final false
 Newtonsoft::Json::JsonToken get_TokenType() ;

/// @brief Method get_Value addr 0x2505594 size 0x8 virtual true final false
 ::bs_hook::Il2CppWrapperType get_Value() ;

/// @brief Method get_ValueType addr 0x250559c size 0x14 virtual true final false
 System::Type get_ValueType() ;

/// @brief Method get_Depth addr 0x25055b0 size 0x7c virtual true final false
 int32_t get_Depth() ;

/// @brief Method get_Path addr 0x250562c size 0x120 virtual true final false
 ::StringW get_Path() ;

/// @brief Method get_Culture addr 0x24fc270 size 0x68 virtual false final false
 System::Globalization::CultureInfo get_Culture() ;

/// @brief Method set_Culture addr 0x250574c size 0x8 virtual false final false
 void set_Culture(System::Globalization::CultureInfo value) ;

/// @brief Method GetPosition addr 0x2505754 size 0xa4 virtual false final false
 Newtonsoft::Json::JsonPosition GetPosition(int32_t depth) ;

// Ctor Parameters []
explicit JsonReader() ;

/// @brief Method .ctor addr 0x24fb6dc size 0x38 virtual false final false
 void _ctor() ;

/// @brief Method Push addr 0x25057f8 size 0x288 virtual false final false
 void Push(Newtonsoft::Json::JsonContainerType value) ;

/// @brief Method Pop addr 0x2505a98 size 0x11c virtual false final false
 Newtonsoft::Json::JsonContainerType Pop() ;

/// @brief Method Peek addr 0x2505bb4 size 0x8 virtual false final false
 Newtonsoft::Json::JsonContainerType Peek() ;

/// @brief Method Read addr 0x0 size 0xffffffffffffffff virtual true final false
 bool Read() ;

/// @brief Method ReadAsInt32 addr 0x2505bbc size 0x2dc virtual true final false
 System::Nullable_1<int32_t> ReadAsInt32() ;

/// @brief Method ReadInt32String addr 0x2500dc8 size 0x1e8 virtual false final false
 System::Nullable_1<int32_t> ReadInt32String(::StringW s) ;

/// @brief Method ReadAsString addr 0x2505f0c size 0x368 virtual true final false
 ::StringW ReadAsString() ;

/// @brief Method ReadAsBytes addr 0x2506274 size 0x3f8 virtual true final false
 ::ArrayW<uint8_t> ReadAsBytes() ;

/// @brief Method ReadArrayIntoByteArray addr 0x24fe7f4 size 0x29c virtual false final false
 ::ArrayW<uint8_t> ReadArrayIntoByteArray() ;

/// @brief Method ReadAsDouble addr 0x250666c size 0x2cc virtual true final false
 System::Nullable_1<double_t> ReadAsDouble() ;

/// @brief Method ReadDoubleString addr 0x25011dc size 0x1dc virtual false final false
 System::Nullable_1<double_t> ReadDoubleString(::StringW s) ;

/// @brief Method ReadAsBoolean addr 0x2506938 size 0x2c0 virtual true final false
 System::Nullable_1<bool> ReadAsBoolean() ;

/// @brief Method ReadBooleanString addr 0x2500af0 size 0x1e8 virtual false final false
 System::Nullable_1<bool> ReadBooleanString(::StringW s) ;

/// @brief Method ReadAsDecimal addr 0x2506bf8 size 0x310 virtual true final false
 System::Nullable_1<System::Decimal> ReadAsDecimal() ;

/// @brief Method ReadDecimalString addr 0x2500fb0 size 0x22c virtual false final false
 System::Nullable_1<System::Decimal> ReadDecimalString(::StringW s) ;

/// @brief Method ReadAsDateTime addr 0x2506f08 size 0x2c0 virtual true final false
 System::Nullable_1<System::DateTime> ReadAsDateTime() ;

/// @brief Method ReadDateTimeString addr 0x24fee74 size 0x288 virtual false final false
 System::Nullable_1<System::DateTime> ReadDateTimeString(::StringW s) ;

/// @brief Method ReadAsDateTimeOffset addr 0x25071c8 size 0x2cc virtual true final false
 System::Nullable_1<System::DateTimeOffset> ReadAsDateTimeOffset() ;

/// @brief Method ReadDateTimeOffsetString addr 0x24ff0fc size 0x268 virtual false final false
 System::Nullable_1<System::DateTimeOffset> ReadDateTimeOffsetString(::StringW s) ;

/// @brief Method ReaderReadAndAssert addr 0x24fe5f8 size 0x44 virtual false final false
 void ReaderReadAndAssert() ;

/// @brief Method CreateUnexpectedEndException addr 0x25016b0 size 0x4c virtual false final false
 Newtonsoft::Json::JsonReaderException CreateUnexpectedEndException() ;

/// @brief Method ReadIntoWrappedTypeObject addr 0x24fe63c size 0x1b8 virtual false final false
 void ReadIntoWrappedTypeObject() ;

/// @brief Method Skip addr 0x2507494 size 0x98 virtual false final false
 void Skip() ;

/// @brief Method SetToken addr 0x24fd13c size 0xc virtual false final false
 void SetToken(Newtonsoft::Json::JsonToken newToken) ;

/// @brief Method SetToken addr 0x2500348 size 0x8 virtual false final false
 void SetToken(Newtonsoft::Json::JsonToken newToken, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method SetToken addr 0x24fc118 size 0x158 virtual false final false
 void SetToken(Newtonsoft::Json::JsonToken newToken, ::bs_hook::Il2CppWrapperType value, bool updateIndex) ;

/// @brief Method SetPostValueState addr 0x24fc0d8 size 0x40 virtual false final false
 void SetPostValueState(bool updateIndex) ;

/// @brief Method UpdateScopeWithFinishedValue addr 0x2505a80 size 0x18 virtual false final false
 void UpdateScopeWithFinishedValue() ;

/// @brief Method ValidateEnd addr 0x250752c size 0x100 virtual false final false
 void ValidateEnd(Newtonsoft::Json::JsonToken endToken) ;

/// @brief Method SetStateBasedOnCurrent addr 0x2500cd8 size 0xf0 virtual false final false
 void SetStateBasedOnCurrent() ;

/// @brief Method SetFinished addr 0x250762c size 0x18 virtual false final false
 void SetFinished() ;

/// @brief Method GetTypeForCloseToken addr 0x2507644 size 0xa8 virtual false final false
 Newtonsoft::Json::JsonContainerType GetTypeForCloseToken(Newtonsoft::Json::JsonToken token) ;

/// @brief Method System.IDisposable.Dispose addr 0x25076ec size 0x70 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method Dispose addr 0x250775c size 0x24 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Close addr 0x25027c0 size 0x14 virtual true final false
 void Close() ;

/// @brief Method ReadAndAssert addr 0x2507780 size 0x54 virtual false final false
 void ReadAndAssert() ;

/// @brief Method ReadAndMoveToContent addr 0x25077dc size 0x30 virtual false final false
 bool ReadAndMoveToContent() ;

/// @brief Method MoveToContent addr 0x250780c size 0x58 virtual false final false
 bool MoveToContent() ;

/// @brief Method GetContentToken addr 0x2505e98 size 0x74 virtual false final false
