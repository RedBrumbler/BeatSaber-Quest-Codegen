...
/// @brief Method .ctor addr 0x250acd8 size 0x4 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit JsonSerializationException(::StringW message) ;

/// @brief Method .ctor addr 0x250a40c size 0x4 virtual false final false
 void _ctor(::StringW message) ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "innerException", ty: "System::Exception", modifiers: "", def_value: None }]
explicit JsonSerializationException(::StringW message, System::Exception innerException) ;

/// @brief Method .ctor addr 0x250acdc size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x250ace0 size 0x4 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method Create addr 0x25077d4 size 0x8 virtual false final false
static Newtonsoft::Json::JsonSerializationException Create(Newtonsoft::Json::JsonReader reader, ::StringW message) ;

/// @brief Method Create addr 0x250ace4 size 0x84 virtual false final false
...
/// @brief Method Create addr 0x250ad68 size 0xbc virtual false final false
