...
/// @brief Method get_Path addr 0x2504f60 size 0x8 virtual false final false
 ::StringW get_Path() ;

/// @brief Method set_Path addr 0x2504f68 size 0x8 virtual false final false
 void set_Path(::StringW value) ;

// Ctor Parameters []
explicit JsonWriterException() ;

/// @brief Method .ctor addr 0x2504f70 size 0x4 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit JsonWriterException(::StringW message) ;

/// @brief Method .ctor addr 0x2504f74 size 0x4 virtual false final false
 void _ctor(::StringW message) ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "innerException", ty: "System::Exception", modifiers: "", def_value: None }]
explicit JsonWriterException(::StringW message, System::Exception innerException) ;

/// @brief Method .ctor addr 0x2504f78 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x2504f7c size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x2504f80 size 0x24 virtual false final false
 void _ctor(::StringW message, System::Exception innerException, ::StringW path) ;

/// @brief Method Create addr 0x2503640 size 0x34 virtual false final false
static Newtonsoft::Json::JsonWriterException Create(Newtonsoft::Json::JsonWriter writer, ::StringW message, System::Exception ex) ;

/// @brief Method Create addr 0x2504fa4 size 0xb4 virtual false final false
