...
/// @brief Method .ctor addr 0x24f97a8 size 0x7c virtual false final false
 void _ctor(Newtonsoft::Json::JsonContainerType type) ;

/// @brief Method CalculateLength addr 0x24f9834 size 0x98 virtual false final false
 int32_t CalculateLength() ;

/// @brief Method WriteTo addr 0x24f98cc size 0x168 virtual false final false
 void WriteTo(System::Text::StringBuilder sb) ;

/// @brief Method TypeHasIndex addr 0x24f9824 size 0x10 virtual false final false
static bool TypeHasIndex(Newtonsoft::Json::JsonContainerType type) ;

/// @brief Method BuildPath addr 0x24f9a34 size 0x29c virtual false final false
...
/// @brief Method FormatMessage addr 0x24f9434 size 0x32c virtual false final false
