...
/// @brief Method get_CanRead addr 0x25052d0 size 0x8 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanWrite addr 0x25052d8 size 0x8 virtual true final false
 bool get_CanWrite() ;

// Ctor Parameters []
explicit JsonConverter() ;

/// @brief Method .ctor addr 0x25052e0 size 0x8 virtual false final false
 void _ctor() ;
