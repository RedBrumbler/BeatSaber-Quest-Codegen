...
/// @brief Method WriteJson addr 0x256cbac size 0x580 virtual true final false
...
/// @brief Method ReadJson addr 0x256d12c size 0x380 virtual true final false
...
/// @brief Method get_CanRead addr 0x256d4ac size 0x8 virtual true final false
 bool get_CanRead() ;

/// @brief Method CanConvert addr 0x256d4b4 size 0x84 virtual true final false
 bool CanConvert(System::Type objectType) ;

// Ctor Parameters []
explicit Matrix4x4Converter() ;

/// @brief Method .ctor addr 0x256d538 size 0x8 virtual false final false
 void _ctor() ;
