...
/// @brief Method .ctor addr 0x2572c7c size 0x28 virtual false final false
 void _ctor(System::Xml::Linq::XObject xmlObject) ;

/// @brief Method get_WrappedNode addr 0x25747f0 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType get_WrappedNode() ;

/// @brief Method get_NodeType addr 0x25747f8 size 0x20 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_LocalName addr 0x2574818 size 0x8 virtual true final false
 ::StringW get_LocalName() ;

/// @brief Method get_ChildNodes addr 0x2574820 size 0x58 virtual true final false
 System::Collections::Generic::List_1<Newtonsoft::Json::Converters::IXmlNode> get_ChildNodes() ;

/// @brief Method get_Attributes addr 0x2574878 size 0x8 virtual true final false
 System::Collections::Generic::List_1<Newtonsoft::Json::Converters::IXmlNode> get_Attributes() ;

/// @brief Method get_ParentNode addr 0x2574880 size 0x8 virtual true final false
 Newtonsoft::Json::Converters::IXmlNode get_ParentNode() ;

/// @brief Method get_Value addr 0x2574888 size 0x8 virtual true final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x2574890 size 0x40 virtual true final false
 void set_Value(::StringW value) ;

/// @brief Method AppendChild addr 0x25748d0 size 0x40 virtual true final false
 Newtonsoft::Json::Converters::IXmlNode AppendChild(Newtonsoft::Json::Converters::IXmlNode newChild) ;

/// @brief Method get_NamespaceUri addr 0x2574910 size 0x8 virtual true final false
