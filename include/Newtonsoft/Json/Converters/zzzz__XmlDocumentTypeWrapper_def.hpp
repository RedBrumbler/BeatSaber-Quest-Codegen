...
/// @brief Method .ctor addr 0x2571a18 size 0x2c virtual false final false
 void _ctor(System::Xml::XmlDocumentType documentType) ;

/// @brief Method get_Name addr 0x2571ff4 size 0x20 virtual true final true
 ::StringW get_Name() ;

/// @brief Method get_System addr 0x2572014 size 0x1c virtual true final true
 ::StringW get_System() ;

/// @brief Method get_Public addr 0x2572030 size 0x1c virtual true final true
 ::StringW get_Public() ;

/// @brief Method get_InternalSubset addr 0x257204c size 0x1c virtual true final true
 ::StringW get_InternalSubset() ;

/// @brief Method get_LocalName addr 0x2572068 size 0x40 virtual true final false
