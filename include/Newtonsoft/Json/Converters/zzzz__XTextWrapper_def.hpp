...
/// @brief Method get_Text addr 0x2573f00 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x2573f78 size 0x6c virtual false final false
 void _ctor(System::Xml::Linq::XText text) ;

/// @brief Method get_Value addr 0x2573fe4 size 0x1c virtual true final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x2574000 size 0x24 virtual true final false
 void set_Value(::StringW value) ;

/// @brief Method get_ParentNode addr 0x2574024 size 0x44 virtual true final false
