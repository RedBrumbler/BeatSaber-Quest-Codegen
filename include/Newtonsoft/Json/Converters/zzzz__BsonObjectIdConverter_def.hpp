...
/// @brief Method WriteJson addr 0x256c890 size 0x100 virtual true final false
...
/// @brief Method ReadJson addr 0x256c990 size 0x190 virtual true final false
...
/// @brief Method CanConvert addr 0x256cb20 size 0x84 virtual true final false
 bool CanConvert(System::Type objectType) ;

// Ctor Parameters []
explicit BsonObjectIdConverter() ;

/// @brief Method .ctor addr 0x256cba4 size 0x8 virtual false final false
 void _ctor() ;
