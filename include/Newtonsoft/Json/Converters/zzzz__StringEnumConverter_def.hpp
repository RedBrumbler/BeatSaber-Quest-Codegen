...
/// @brief Method get_CamelCaseText addr 0x256edec size 0x8 virtual false final false
 bool get_CamelCaseText() ;

/// @brief Method set_CamelCaseText addr 0x256edf4 size 0xc virtual false final false
 void set_CamelCaseText(bool value) ;

/// @brief Method get_AllowIntegerValues addr 0x256ee00 size 0x8 virtual false final false
 bool get_AllowIntegerValues() ;

/// @brief Method set_AllowIntegerValues addr 0x256ee08 size 0xc virtual false final false
 void set_AllowIntegerValues(bool value) ;

// Ctor Parameters []
explicit StringEnumConverter() ;

/// @brief Method .ctor addr 0x256ee14 size 0x20 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x256ee34 size 0x34 virtual false final false
 void _ctor(bool camelCaseText) ;

/// @brief Method WriteJson addr 0x256ee68 size 0x1c8 virtual true final false
...
/// @brief Method ReadJson addr 0x256f030 size 0x444 virtual true final false
...
/// @brief Method CanConvert addr 0x256f474 size 0x78 virtual true final false
