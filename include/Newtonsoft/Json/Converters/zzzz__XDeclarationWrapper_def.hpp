...
/// @brief Method get_Declaration addr 0x2572c00 size 0x8 virtual false final false
 System::Xml::Linq::XDeclaration get_Declaration() ;

/// @brief Method set_Declaration addr 0x2572c08 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2572c10 size 0x6c virtual false final false
 void _ctor(System::Xml::Linq::XDeclaration declaration) ;

/// @brief Method get_NodeType addr 0x2572ca4 size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Version addr 0x2572cac size 0x1c virtual true final true
 ::StringW get_Version() ;

/// @brief Method get_Encoding addr 0x2572cc8 size 0x1c virtual true final true
 ::StringW get_Encoding() ;

/// @brief Method set_Encoding addr 0x2572ce4 size 0x1c virtual true final true
 void set_Encoding(::StringW value) ;

/// @brief Method get_Standalone addr 0x2572d00 size 0x1c virtual true final true
 ::StringW get_Standalone() ;

/// @brief Method set_Standalone addr 0x2572d1c size 0x1c virtual true final true
