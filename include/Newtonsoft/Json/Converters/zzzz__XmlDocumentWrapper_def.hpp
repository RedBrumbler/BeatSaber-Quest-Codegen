...
namespace Newtonsoft::Json::Converters {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12013))}
...
/// @brief Method .ctor addr 0x2571588 size 0x2c virtual false final false
 void _ctor(System::Xml::XmlDocument document) ;

/// @brief Method CreateComment addr 0x25715dc size 0x8c virtual true final true
 Newtonsoft::Json::Converters::IXmlNode CreateComment(::StringW data) ;

/// @brief Method CreateTextNode addr 0x2571668 size 0x8c virtual true final true
 Newtonsoft::Json::Converters::IXmlNode CreateTextNode(::StringW text) ;

/// @brief Method CreateCDataSection addr 0x25716f4 size 0x8c virtual true final true
 Newtonsoft::Json::Converters::IXmlNode CreateCDataSection(::StringW data) ;

/// @brief Method CreateWhitespace addr 0x2571780 size 0x8c virtual true final true
 Newtonsoft::Json::Converters::IXmlNode CreateWhitespace(::StringW text) ;

/// @brief Method CreateSignificantWhitespace addr 0x257180c size 0x8c virtual true final true
 Newtonsoft::Json::Converters::IXmlNode CreateSignificantWhitespace(::StringW text) ;

/// @brief Method CreateXmlDeclaration addr 0x2571898 size 0xa8 virtual true final true
 Newtonsoft::Json::Converters::IXmlNode CreateXmlDeclaration(::StringW version, ::StringW encoding, ::StringW standalone) ;

/// @brief Method CreateXmlDocumentType addr 0x257196c size 0xac virtual true final true
...
/// @brief Method CreateProcessingInstruction addr 0x2571a44 size 0x9c virtual true final true
 Newtonsoft::Json::Converters::IXmlNode CreateProcessingInstruction(::StringW target, ::StringW data) ;

/// @brief Method CreateElement addr 0x2571ae0 size 0x88 virtual true final true
 Newtonsoft::Json::Converters::IXmlElement CreateElement(::StringW elementName) ;

/// @brief Method CreateElement addr 0x2571b94 size 0x98 virtual true final true
 Newtonsoft::Json::Converters::IXmlElement CreateElement(::StringW qualifiedName, ::StringW namespaceUri) ;

/// @brief Method CreateAttribute addr 0x2571c2c size 0xa8 virtual true final true
 Newtonsoft::Json::Converters::IXmlNode CreateAttribute(::StringW name, ::StringW value) ;

/// @brief Method CreateAttribute addr 0x2571cf4 size 0xb0 virtual true final true
 Newtonsoft::Json::Converters::IXmlNode CreateAttribute(::StringW qualifiedName, ::StringW namespaceUri, ::StringW value) ;

/// @brief Method get_DocumentElement addr 0x2571da4 size 0x9c virtual true final true
