...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11791)), TypeDefinitionIndex(TypeDefinitionIndex(11992))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11992), inst: 2 })
