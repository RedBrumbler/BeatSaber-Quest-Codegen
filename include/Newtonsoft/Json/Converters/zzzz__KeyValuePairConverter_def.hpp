...
/// @brief Method InitializeReflectionObject addr 0x256be68 size 0x280 virtual false final false
static Newtonsoft::Json::Utilities::ReflectionObject InitializeReflectionObject(System::Type t) ;

/// @brief Method WriteJson addr 0x256c0e8 size 0x240 virtual true final false
...
/// @brief Method ReadJson addr 0x256c328 size 0x37c virtual true final false
...
/// @brief Method CanConvert addr 0x256c6a4 size 0x10c virtual true final false
 bool CanConvert(System::Type objectType) ;

// Ctor Parameters []
explicit KeyValuePairConverter() ;

/// @brief Method .ctor addr 0x256c7b0 size 0x8 virtual false final false
 void _ctor() ;
