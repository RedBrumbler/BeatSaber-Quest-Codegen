...
/// @brief Method .ctor addr 0x2571b68 size 0x2c virtual false final false
 void _ctor(System::Xml::XmlElement element) ;

/// @brief Method SetAttributeNode addr 0x2571e40 size 0xe8 virtual true final true
 void SetAttributeNode(Newtonsoft::Json::Converters::IXmlNode attribute) ;

/// @brief Method GetPrefixOfNamespace addr 0x2571f28 size 0x24 virtual true final true
 ::StringW GetPrefixOfNamespace(::StringW namespaceUri) ;

/// @brief Method get_IsEmpty addr 0x2571f4c size 0x1c virtual true final true
 bool get_IsEmpty() ;
