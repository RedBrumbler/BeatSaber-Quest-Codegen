...
/// @brief Method get_ProcessingInstruction addr 0x2574660 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x257393c size 0x6c virtual false final false
 void _ctor(System::Xml::Linq::XProcessingInstruction processingInstruction) ;

/// @brief Method get_LocalName addr 0x25746d8 size 0x1c virtual true final false
 ::StringW get_LocalName() ;

/// @brief Method get_Value addr 0x25746f4 size 0x1c virtual true final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x2574710 size 0x24 virtual true final false
