...
/// @brief Method .ctor addr 0x2571940 size 0x2c virtual false final false
 void _ctor(System::Xml::XmlDeclaration declaration) ;

/// @brief Method get_Version addr 0x2571f68 size 0x1c virtual true final true
 ::StringW get_Version() ;

/// @brief Method get_Encoding addr 0x2571f84 size 0x1c virtual true final true
 ::StringW get_Encoding() ;

/// @brief Method set_Encoding addr 0x2571fa0 size 0x1c virtual true final true
 void set_Encoding(::StringW value) ;

/// @brief Method get_Standalone addr 0x2571fbc size 0x1c virtual true final true
 ::StringW get_Standalone() ;

/// @brief Method set_Standalone addr 0x2571fd8 size 0x1c virtual true final true
