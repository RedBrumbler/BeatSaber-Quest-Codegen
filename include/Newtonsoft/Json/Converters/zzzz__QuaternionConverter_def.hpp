...
/// @brief Method .ctor addr 0x256df68 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ReadJson>b__2_0 addr 0x256df70 size 0x54 virtual false final false
 bool _ReadJson_b__2_0(Newtonsoft::Json::Linq::JProperty p) ;

/// @brief Method <ReadJson>b__2_1 addr 0x256dfc4 size 0x54 virtual false final false
 bool _ReadJson_b__2_1(Newtonsoft::Json::Linq::JProperty p) ;

/// @brief Method <ReadJson>b__2_2 addr 0x256e018 size 0x54 virtual false final false
 bool _ReadJson_b__2_2(Newtonsoft::Json::Linq::JProperty p) ;

/// @brief Method <ReadJson>b__2_3 addr 0x256e06c size 0x54 virtual false final false
 bool _ReadJson_b__2_3(Newtonsoft::Json::Linq::JProperty p) ;

/// @brief Method <ReadJson>b__2_4 addr 0x256e0c0 size 0x54 virtual false final false
...
/// @brief Method WriteJson addr 0x256d540 size 0x334 virtual true final false
...
/// @brief Method CanConvert addr 0x256d874 size 0x84 virtual true final false
 bool CanConvert(System::Type objectType) ;

/// @brief Method ReadJson addr 0x256d8f8 size 0x5fc virtual true final false
...
/// @brief Method get_CanRead addr 0x256def4 size 0x8 virtual true final false
 bool get_CanRead() ;

// Ctor Parameters []
explicit QuaternionConverter() ;

/// @brief Method .ctor addr 0x256defc size 0x8 virtual false final false
 void _ctor() ;
