...
/// @brief Method WriteJson addr 0x256abb8 size 0x54 virtual true final false
...
/// @brief Method GetByteArray addr 0x256ac0c size 0x178 virtual false final false
 ::ArrayW<uint8_t> GetByteArray(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method EnsureReflectionObject addr 0x256ad84 size 0x188 virtual false final false
 void EnsureReflectionObject(System::Type t) ;

/// @brief Method ReadJson addr 0x256af0c size 0x320 virtual true final false
...
/// @brief Method ReadByteArray addr 0x256b22c size 0x28c virtual false final false
 ::ArrayW<uint8_t> ReadByteArray(Newtonsoft::Json::JsonReader reader) ;

/// @brief Method CanConvert addr 0x256b4b8 size 0x4c virtual true final false
 bool CanConvert(System::Type objectType) ;

// Ctor Parameters []
explicit BinaryConverter() ;

/// @brief Method .ctor addr 0x256b504 size 0x8 virtual false final false
 void _ctor() ;
