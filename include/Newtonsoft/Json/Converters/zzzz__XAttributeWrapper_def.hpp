...
/// @brief Method get_Attribute addr 0x25749a4 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x2573bc0 size 0x6c virtual false final false
 void _ctor(System::Xml::Linq::XAttribute attribute) ;

/// @brief Method get_Value addr 0x2574a1c size 0x1c virtual true final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x2574a38 size 0x24 virtual true final false
 void set_Value(::StringW value) ;

/// @brief Method get_LocalName addr 0x2574a5c size 0x24 virtual true final false
 ::StringW get_LocalName() ;

/// @brief Method get_NamespaceUri addr 0x2574a80 size 0x24 virtual true final false
 ::StringW get_NamespaceUri() ;

/// @brief Method get_ParentNode addr 0x2574aa4 size 0x44 virtual true final false
