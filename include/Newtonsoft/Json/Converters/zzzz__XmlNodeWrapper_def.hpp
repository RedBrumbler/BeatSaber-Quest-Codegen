...
/// @brief Method .ctor addr 0x25715b4 size 0x28 virtual false final false
 void _ctor(System::Xml::XmlNode node) ;

/// @brief Method get_WrappedNode addr 0x25720a8 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType get_WrappedNode() ;

/// @brief Method get_NodeType addr 0x25720b0 size 0x20 virtual true final true
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_LocalName addr 0x25720d0 size 0x24 virtual true final false
 ::StringW get_LocalName() ;

/// @brief Method get_ChildNodes addr 0x25720f4 size 0x3dc virtual true final true
 System::Collections::Generic::List_1<Newtonsoft::Json::Converters::IXmlNode> get_ChildNodes() ;

/// @brief Method WrapNode addr 0x25724d0 size 0x184 virtual false final false
static Newtonsoft::Json::Converters::IXmlNode WrapNode(System::Xml::XmlNode node) ;

/// @brief Method get_Attributes addr 0x2572654 size 0x424 virtual true final true
 System::Collections::Generic::List_1<Newtonsoft::Json::Converters::IXmlNode> get_Attributes() ;

/// @brief Method get_ParentNode addr 0x2572a78 size 0xa0 virtual true final true
 Newtonsoft::Json::Converters::IXmlNode get_ParentNode() ;

/// @brief Method get_Value addr 0x2572b18 size 0x20 virtual true final true
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x2571cd4 size 0x20 virtual true final true
 void set_Value(::StringW value) ;

/// @brief Method AppendChild addr 0x2572b38 size 0xa4 virtual true final true
 Newtonsoft::Json::Converters::IXmlNode AppendChild(Newtonsoft::Json::Converters::IXmlNode newChild) ;

/// @brief Method get_NamespaceUri addr 0x2572bdc size 0x24 virtual true final true
