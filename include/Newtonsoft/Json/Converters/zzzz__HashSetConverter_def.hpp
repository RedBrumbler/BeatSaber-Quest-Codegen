...
/// @brief Method WriteJson addr 0x256bba8 size 0x4 virtual true final false
...
/// @brief Method ReadJson addr 0x256bbac size 0x1f4 virtual true final false
...
/// @brief Method CanConvert addr 0x256bda0 size 0xb8 virtual true final false
 bool CanConvert(System::Type objectType) ;

/// @brief Method get_CanWrite addr 0x256be58 size 0x8 virtual true final false
 bool get_CanWrite() ;

// Ctor Parameters []
explicit HashSetConverter() ;

/// @brief Method .ctor addr 0x256be60 size 0x8 virtual false final false
 void _ctor() ;
