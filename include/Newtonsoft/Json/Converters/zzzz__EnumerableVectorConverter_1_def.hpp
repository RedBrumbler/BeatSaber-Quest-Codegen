...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11994)), TypeDefinitionIndex(TypeDefinitionIndex(11791))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11994), inst: 2 })
