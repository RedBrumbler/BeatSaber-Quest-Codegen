...
/// @brief Method Parse addr 0x2512db0 size 0xd8 virtual false final false
 bool Parse(::ArrayW<char16_t> text, int32_t startIndex, int32_t length) ;

/// @brief Method ParseDate addr 0x2512e88 size 0x198 virtual false final false
 bool ParseDate(int32_t start) ;

/// @brief Method ParseTimeAndZoneAndWhitespace addr 0x251306c size 0x40 virtual false final false
 bool ParseTimeAndZoneAndWhitespace(int32_t start) ;

/// @brief Method ParseTime addr 0x251321c size 0x2c0 virtual false final false
 bool ParseTime(ByRef<int32_t> start) ;

/// @brief Method ParseZone addr 0x25134dc size 0x1d0 virtual false final false
 bool ParseZone(int32_t start) ;

/// @brief Method Parse4Digit addr 0x25130ac size 0xdc virtual false final false
 bool Parse4Digit(int32_t start, ByRef<int32_t> num) ;

/// @brief Method Parse2Digit addr 0x2513188 size 0x94 virtual false final false
 bool Parse2Digit(int32_t start, ByRef<int32_t> num) ;

/// @brief Method ParseChar addr 0x2513020 size 0x4c virtual false final false
