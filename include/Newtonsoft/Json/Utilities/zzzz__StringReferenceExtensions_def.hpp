...
/// @brief Method IndexOf addr 0x251583c size 0x84 virtual false final false
static int32_t IndexOf(Newtonsoft::Json::Utilities::StringReference s, char16_t c, int32_t startIndex, int32_t length) ;

/// @brief Method StartsWith addr 0x25158c0 size 0xb4 virtual false final false
static bool StartsWith(Newtonsoft::Json::Utilities::StringReference s, ::StringW text) ;

/// @brief Method EndsWith addr 0x2515974 size 0xb8 virtual false final false
