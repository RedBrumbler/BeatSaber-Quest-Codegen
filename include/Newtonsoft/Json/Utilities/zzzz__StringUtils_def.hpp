...
/// @brief Method FormatWith addr 0x25127d4 size 0xa8 virtual false final false
static ::StringW FormatWith(::StringW format, System::IFormatProvider provider, ::bs_hook::Il2CppWrapperType arg0) ;

/// @brief Method FormatWith addr 0x25105d8 size 0xdc virtual false final false
...
/// @brief Method FormatWith addr 0x2523874 size 0x108 virtual false final false
...
/// @brief Method FormatWith addr 0x252397c size 0x13c virtual false final false
...
/// @brief Method FormatWith addr 0x2523808 size 0x6c virtual false final false
static ::StringW FormatWith(::StringW format, System::IFormatProvider provider, ::ArrayW<::bs_hook::Il2CppWrapperType> args) ;

/// @brief Method IsWhiteSpace addr 0x2512a3c size 0x100 virtual false final false
static bool IsWhiteSpace(::StringW s) ;

/// @brief Method NullEmptyString addr 0x2523ab8 size 0x20 virtual false final false
static ::StringW NullEmptyString(::StringW s) ;

/// @brief Method CreateStringWriter addr 0x251df08 size 0xd4 virtual false final false
static System::IO::StringWriter CreateStringWriter(int32_t capacity) ;

/// @brief Method GetLength addr 0x251dea0 size 0x68 virtual false final false
static System::Nullable_1<int32_t> GetLength(::StringW value) ;

/// @brief Method ToCharAsUnicode addr 0x251db9c size 0xb8 virtual false final false
...
/// @brief Method ToCamelCase addr 0x251c2f8 size 0x1ec virtual false final false
static ::StringW ToCamelCase(::StringW s) ;

/// @brief Method IsHighSurrogate addr 0x2523ad8 size 0x58 virtual false final false
static bool IsHighSurrogate(char16_t c) ;

/// @brief Method IsLowSurrogate addr 0x2523b30 size 0x58 virtual false final false
static bool IsLowSurrogate(char16_t c) ;

/// @brief Method StartsWith addr 0x2523b88 size 0x44 virtual false final false
static bool StartsWith(::StringW source, char16_t value) ;

/// @brief Method EndsWith addr 0x2523bcc size 0x40 virtual false final false
...
template<::cordl_internals::il2cpp_reference_type TSource>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11860))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11860), inst: 2 })
