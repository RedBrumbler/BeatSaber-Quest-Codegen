...
/// @brief Method GetCharEscapeFlags addr 0x251d590 size 0x98 virtual false final false
static ::ArrayW<bool> GetCharEscapeFlags(Newtonsoft::Json::StringEscapeHandling stringEscapeHandling, char16_t quoteChar) ;

/// @brief Method ShouldEscapeJavaScriptString addr 0x251d628 size 0x88 virtual false final false
static bool ShouldEscapeJavaScriptString(::StringW s, ::ArrayW<bool> charEscapeFlags) ;

/// @brief Method WriteEscapedJavaScriptString addr 0x251d6b0 size 0x4ec virtual false final false
...
/// @brief Method ToEscapedJavaScriptString addr 0x251dc54 size 0x24c virtual false final false
