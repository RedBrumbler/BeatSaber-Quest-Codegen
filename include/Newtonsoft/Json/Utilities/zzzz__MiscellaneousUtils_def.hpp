...
/// @brief Method ValueEquals addr 0x251f52c size 0x2b0 virtual false final false
static bool ValueEquals(::bs_hook::Il2CppWrapperType objA, ::bs_hook::Il2CppWrapperType objB) ;

/// @brief Method CreateArgumentOutOfRangeException addr 0x250fbfc size 0x100 virtual false final false
...
/// @brief Method ToString addr 0x251f7dc size 0xac virtual false final false
static ::StringW ToString(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method ByteArrayCompare addr 0x251f888 size 0xb4 virtual false final false
static int32_t ByteArrayCompare(::ArrayW<uint8_t> a1, ::ArrayW<uint8_t> a2) ;

/// @brief Method GetPrefix addr 0x251f93c size 0x24 virtual false final false
static ::StringW GetPrefix(::StringW qualifiedName) ;

/// @brief Method GetLocalName addr 0x251f9f4 size 0x24 virtual false final false
static ::StringW GetLocalName(::StringW qualifiedName) ;

/// @brief Method GetQualifiedNameParts addr 0x251f960 size 0x94 virtual false final false
static void GetQualifiedNameParts(::StringW qualifiedName, ByRef<::StringW> prefix, ByRef<::StringW> localName) ;

/// @brief Method FormatValueForPrint addr 0x251fa18 size 0xb0 virtual false final false
