...
/// @brief Method get_Item addr 0x25157d4 size 0x30 virtual false final false
 char16_t get_Item(int32_t i) ;

/// @brief Method get_Chars addr 0x2515804 size 0x8 virtual false final false
 ::ArrayW<char16_t> get_Chars() ;

/// @brief Method get_StartIndex addr 0x251580c size 0x8 virtual false final false
 int32_t get_StartIndex() ;

/// @brief Method get_Length addr 0x2515814 size 0x8 virtual false final false
 int32_t get_Length() ;

/// @brief Method .ctor addr 0x251581c size 0xc virtual false final false
 void _ctor(::ArrayW<char16_t> chars, int32_t startIndex, int32_t length) ;

/// @brief Method ToString addr 0x2515828 size 0x14 virtual true final false
 ::StringW ToString() ;
