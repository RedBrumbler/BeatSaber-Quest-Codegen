...
/// @brief Method .ctor addr 0x2514134 size 0x40 virtual false final false
...
/// @brief Method .ctor addr 0x2513bd4 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method Get addr 0x2513c3c size 0x188 virtual false final false
 ::StringW Get(::ArrayW<char16_t> key, int32_t start, int32_t length) ;

/// @brief Method Add addr 0x2513e74 size 0x1b4 virtual false final false
 ::StringW Add(::StringW key) ;

/// @brief Method AddEntry addr 0x2514028 size 0x10c virtual false final false
 ::StringW AddEntry(::StringW str, int32_t hashCode) ;

/// @brief Method Grow addr 0x2514174 size 0x124 virtual false final false
 void Grow() ;

/// @brief Method TextEquals addr 0x2513dc4 size 0xb0 virtual false final false
