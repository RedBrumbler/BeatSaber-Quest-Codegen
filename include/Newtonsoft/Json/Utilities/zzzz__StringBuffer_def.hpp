...
/// @brief Method get_Position addr 0x251dfdc size 0x8 virtual false final false
 int32_t get_Position() ;

/// @brief Method set_Position addr 0x251dfe4 size 0x8 virtual false final false
 void set_Position(int32_t value) ;

/// @brief Method get_IsEmpty addr 0x251dfec size 0x10 virtual false final false
 bool get_IsEmpty() ;

/// @brief Method .ctor addr 0x251dffc size 0x24 virtual false final false
 void _ctor(Newtonsoft::Json::IArrayPool_1<char16_t> bufferPool, int32_t initalSize) ;

/// @brief Method .ctor addr 0x251e020 size 0xc virtual false final false
 void _ctor(::ArrayW<char16_t> buffer) ;

/// @brief Method Append addr 0x251e02c size 0x78 virtual false final false
 void Append(Newtonsoft::Json::IArrayPool_1<char16_t> bufferPool, char16_t value) ;

/// @brief Method Append addr 0x251e104 size 0x80 virtual false final false
 void Append(Newtonsoft::Json::IArrayPool_1<char16_t> bufferPool, ::ArrayW<char16_t> buffer, int32_t startIndex, int32_t count) ;

/// @brief Method Clear addr 0x251e184 size 0x2c virtual false final false
 void Clear(Newtonsoft::Json::IArrayPool_1<char16_t> bufferPool) ;

/// @brief Method EnsureSize addr 0x251e0a4 size 0x60 virtual false final false
 void EnsureSize(Newtonsoft::Json::IArrayPool_1<char16_t> bufferPool, int32_t appendLength) ;

/// @brief Method ToString addr 0x251e1b0 size 0x18 virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x251e1c8 size 0x1c virtual false final false
 ::StringW ToString(int32_t start, int32_t length) ;

/// @brief Method get_InternalBuffer addr 0x251e1e4 size 0x8 virtual false final false
