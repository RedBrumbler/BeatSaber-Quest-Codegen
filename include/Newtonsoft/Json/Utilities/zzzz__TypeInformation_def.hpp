...
/// @brief Method get_Type addr 0x2515a2c size 0x8 virtual false final false
 System::Type get_Type() ;

/// @brief Method set_Type addr 0x2515a34 size 0x8 virtual false final false
 void set_Type(System::Type value) ;

/// @brief Method get_TypeCode addr 0x2515a3c size 0x8 virtual false final false
 Newtonsoft::Json::Utilities::PrimitiveTypeCode get_TypeCode() ;

/// @brief Method set_TypeCode addr 0x2515a44 size 0x8 virtual false final false
 void set_TypeCode(Newtonsoft::Json::Utilities::PrimitiveTypeCode value) ;

// Ctor Parameters []
explicit TypeInformation() ;

/// @brief Method .ctor addr 0x2515a4c size 0x8 virtual false final false
 void _ctor() ;
