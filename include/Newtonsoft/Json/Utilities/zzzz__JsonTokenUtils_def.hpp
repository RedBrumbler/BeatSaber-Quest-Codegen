...
/// @brief Method IsEndToken addr 0x25100c4 size 0x10 virtual false final false
static bool IsEndToken(Newtonsoft::Json::JsonToken token) ;

/// @brief Method IsStartToken addr 0x250fec4 size 0x10 virtual false final false
static bool IsStartToken(Newtonsoft::Json::JsonToken token) ;

/// @brief Method IsPrimitiveToken addr 0x2513b60 size 0x24 virtual false final false
