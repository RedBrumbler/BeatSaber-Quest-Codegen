...
/// @brief Method GetUtcOffset addr 0x2518c20 size 0x2c virtual false final false
static System::TimeSpan GetUtcOffset(System::DateTime d) ;

/// @brief Method ToSerializationMode addr 0x2518c4c size 0x80 virtual false final false
static System::Xml::XmlDateTimeSerializationMode ToSerializationMode(System::DateTimeKind kind) ;

/// @brief Method EnsureDateTime addr 0x2518ccc size 0x128 virtual false final false
static System::DateTime EnsureDateTime(System::DateTime value, Newtonsoft::Json::DateTimeZoneHandling timeZone) ;

/// @brief Method SwitchToLocalTime addr 0x2518df4 size 0x78 virtual false final false
static System::DateTime SwitchToLocalTime(System::DateTime value) ;

/// @brief Method SwitchToUtcTime addr 0x2518e6c size 0x78 virtual false final false
static System::DateTime SwitchToUtcTime(System::DateTime value) ;

/// @brief Method ToUniversalTicks addr 0x2518ee4 size 0x8c virtual false final false
static int64_t ToUniversalTicks(System::DateTime dateTime) ;

/// @brief Method ToUniversalTicks addr 0x2518f70 size 0x108 virtual false final false
static int64_t ToUniversalTicks(System::DateTime dateTime, System::TimeSpan offset) ;

/// @brief Method ConvertDateTimeToJavaScriptTicks addr 0x2519078 size 0x68 virtual false final false
static int64_t ConvertDateTimeToJavaScriptTicks(System::DateTime dateTime, System::TimeSpan offset) ;

/// @brief Method ConvertDateTimeToJavaScriptTicks addr 0x251915c size 0x58 virtual false final false
static int64_t ConvertDateTimeToJavaScriptTicks(System::DateTime dateTime) ;

/// @brief Method ConvertDateTimeToJavaScriptTicks addr 0x25191b4 size 0x98 virtual false final false
static int64_t ConvertDateTimeToJavaScriptTicks(System::DateTime dateTime, bool convertToUtc) ;

/// @brief Method UniversialTicksToJavaScriptTicks addr 0x25190e0 size 0x7c virtual false final false
static int64_t UniversialTicksToJavaScriptTicks(int64_t universialTicks) ;

/// @brief Method ConvertJavaScriptTicksToDateTime addr 0x25100d4 size 0x88 virtual false final false
static System::DateTime ConvertJavaScriptTicksToDateTime(int64_t javaScriptTicks) ;

/// @brief Method TryParseDateTimeIso addr 0x251924c size 0x36c virtual false final false
...
/// @brief Method TryParseDateTimeOffsetIso addr 0x2519638 size 0x1cc virtual false final false
static bool TryParseDateTimeOffsetIso(Newtonsoft::Json::Utilities::StringReference text, ByRef<System::DateTimeOffset> dt) ;

/// @brief Method CreateDateTime addr 0x25195b8 size 0x80 virtual false final false
static System::DateTime CreateDateTime(Newtonsoft::Json::Utilities::DateTimeParser dateTimeParser) ;

/// @brief Method TryParseDateTime addr 0x2519804 size 0x220 virtual false final false
...
/// @brief Method TryParseDateTime addr 0x2519c70 size 0x2b4 virtual false final false
...
/// @brief Method TryParseDateTimeOffset addr 0x2519f24 size 0x210 virtual false final false
...
/// @brief Method TryParseDateTimeOffset addr 0x251a31c size 0x2b4 virtual false final false
...
/// @brief Method TryParseMicrosoftDate addr 0x251a5d0 size 0x174 virtual false final false
...
/// @brief Method TryParseDateTimeMicrosoft addr 0x2519a24 size 0x164 virtual false final false
...
/// @brief Method TryParseDateTimeExact addr 0x2519b88 size 0xe8 virtual false final false
...
/// @brief Method TryParseDateTimeOffsetMicrosoft addr 0x251a134 size 0x138 virtual false final false
...
/// @brief Method TryParseDateTimeOffsetExact addr 0x251a26c size 0xb0 virtual false final false
...
/// @brief Method TryReadOffset addr 0x251a744 size 0x174 virtual false final false
...
/// @brief Method WriteDateTimeString addr 0x251a8b8 size 0x138 virtual false final false
...
/// @brief Method WriteDateTimeString addr 0x251a9f0 size 0x304 virtual false final false
...
/// @brief Method WriteDefaultIsoDate addr 0x251ae6c size 0x298 virtual false final false
static int32_t WriteDefaultIsoDate(::ArrayW<char16_t> chars, int32_t start, System::DateTime dt) ;

/// @brief Method CopyIntToCharArray addr 0x251b2fc size 0x68 virtual false final false
static void CopyIntToCharArray(::ArrayW<char16_t> chars, int32_t start, int32_t value, int32_t digits) ;

/// @brief Method WriteDateTimeOffset addr 0x251acf4 size 0x178 virtual false final false
...
/// @brief Method WriteDateTimeOffsetString addr 0x251b364 size 0x174 virtual false final false
...
/// @brief Method GetDateValues addr 0x251b104 size 0x1f8 virtual false final false
