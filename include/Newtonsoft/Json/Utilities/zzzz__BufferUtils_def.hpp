...
/// @brief Method RentBuffer addr 0x251c670 size 0xc8 virtual false final false
static ::ArrayW<char16_t> RentBuffer(Newtonsoft::Json::IArrayPool_1<char16_t> bufferPool, int32_t minSize) ;

/// @brief Method ReturnBuffer addr 0x251c738 size 0xb0 virtual false final false
static void ReturnBuffer(Newtonsoft::Json::IArrayPool_1<char16_t> bufferPool, ::ArrayW<char16_t> buffer) ;

/// @brief Method EnsureBufferSize addr 0x251c7e8 size 0x13c virtual false final false
