...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11829), inst: 80 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11829))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11829), inst: 1585 })
// CS Name: Newtonsoft.Json.Utilities.ThreadSafeStore`2
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11829))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11829), inst: 1586 })
// CS Name: Newtonsoft.Json.Utilities.ThreadSafeStore`2
