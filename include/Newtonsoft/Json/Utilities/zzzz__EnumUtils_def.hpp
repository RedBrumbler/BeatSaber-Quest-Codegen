...
/// @brief Method .ctor addr 0x251c620 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <InitializeEnumType>b__1_0 addr 0x251c628 size 0x18 virtual false final false
 ::StringW _InitializeEnumType_b__1_0(System::Runtime::Serialization::EnumMemberAttribute a) ;

/// @brief Method <GetValues>b__5_0 addr 0x251c640 size 0x18 virtual false final false
 bool _GetValues_b__5_0(System::Reflection::FieldInfo f) ;

/// @brief Method <GetNames>b__6_0 addr 0x251c658 size 0x18 virtual false final false
...
/// @brief Method InitializeEnumType addr 0x251b4d8 size 0x434 virtual false final false
...
/// @brief Method GetValues addr 0x250dfa0 size 0x530 virtual false final false
static System::Collections::Generic::IList_1<::bs_hook::Il2CppWrapperType> GetValues(System::Type enumType) ;

/// @brief Method GetNames addr 0x251b90c size 0x524 virtual false final false
static System::Collections::Generic::IList_1<::StringW> GetNames(System::Type enumType) ;

/// @brief Method ParseEnumName addr 0x251be30 size 0x268 virtual false final false
static ::bs_hook::Il2CppWrapperType ParseEnumName(::StringW enumText, bool isNullable, System::Type t) ;

/// @brief Method ToEnumName addr 0x251c110 size 0x1e8 virtual false final false
static ::StringW ToEnumName(System::Type enumType, ::StringW enumText, bool camelCaseText) ;

/// @brief Method ResolvedEnumName addr 0x251c098 size 0x78 virtual false final false
