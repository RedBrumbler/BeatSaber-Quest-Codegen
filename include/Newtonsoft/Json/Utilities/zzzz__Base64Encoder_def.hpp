...
/// @brief Method .ctor addr 0x25136ac size 0x8c virtual false final false
 void _ctor(System::IO::TextWriter writer) ;

/// @brief Method Encode addr 0x2513738 size 0x34c virtual false final false
 void Encode(::ArrayW<uint8_t> buffer, int32_t index, int32_t count) ;

/// @brief Method Flush addr 0x2513aa8 size 0xb8 virtual false final false
 void Flush() ;

/// @brief Method WriteChars addr 0x2513a84 size 0x24 virtual false final false
