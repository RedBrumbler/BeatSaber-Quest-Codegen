...
/// @brief Method IsDictionaryType addr 0x251e1ec size 0x138 virtual false final false
static bool IsDictionaryType(System::Type type) ;

/// @brief Method ResolveEnumerableCollectionConstructor addr 0x251e398 size 0x110 virtual false final false
...
/// @brief Method ResolveEnumerableCollectionConstructor addr 0x251e4a8 size 0x2c4 virtual false final false
...
/// @brief Method GetDimensions addr 0x251e76c size 0x2e4 virtual false final false
static System::Collections::Generic::IList_1<int32_t> GetDimensions(System::Collections::IList values, int32_t dimensionsCount) ;

/// @brief Method CopyFromJaggedToMultidimensionalArray addr 0x251ea50 size 0x2c0 virtual false final false
...
/// @brief Method JaggedArrayGetValue addr 0x251ed10 size 0x13c virtual false final false
static ::bs_hook::Il2CppWrapperType JaggedArrayGetValue(System::Collections::IList values, ::ArrayW<int32_t> indices) ;

/// @brief Method ToMultidimensionalArray addr 0x251ee4c size 0x1a0 virtual false final false
