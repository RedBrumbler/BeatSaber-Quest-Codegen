...
/// @brief Method .ctor addr 0x253f698 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x253f6a0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <CreateObjectUsingCreatorWithParameters>b__1 addr 0x253f6a8 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x253f730 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <CreateObjectUsingCreatorWithParameters>b__36_0 addr 0x253f738 size 0x18 virtual false final false
 ::StringW _CreateObjectUsingCreatorWithParameters_b__36_0(Newtonsoft::Json::Serialization::JsonProperty p) ;

/// @brief Method <CreateObjectUsingCreatorWithParameters>b__36_2 addr 0x253f750 size 0x18 virtual false final false
 ::StringW _CreateObjectUsingCreatorWithParameters_b__36_2(Newtonsoft::Json::Serialization::JsonProperty p) ;

/// @brief Method <PopulateObject>b__41_0 addr 0x253f768 size 0x8 virtual false final false
 Newtonsoft::Json::Serialization::JsonProperty _PopulateObject_b__41_0(Newtonsoft::Json::Serialization::JsonProperty m) ;

/// @brief Method <PopulateObject>b__41_1 addr 0x253f770 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x25345d8 size 0x4 virtual false final false
 void _ctor(Newtonsoft::Json::JsonSerializer serializer) ;

/// @brief Method Populate addr 0x25345dc size 0x538 virtual false final false
 void Populate(Newtonsoft::Json::JsonReader reader, ::bs_hook::Il2CppWrapperType target) ;

/// @brief Method GetContractSafe addr 0x253631c size 0xc4 virtual false final false
 Newtonsoft::Json::Serialization::JsonContract GetContractSafe(System::Type type) ;

/// @brief Method Deserialize addr 0x25363e0 size 0x348 virtual false final false
...
/// @brief Method GetInternalSerializer addr 0x2537264 size 0x70 virtual false final false
 Newtonsoft::Json::Serialization::JsonSerializerProxy GetInternalSerializer() ;

/// @brief Method CreateJToken addr 0x25372d4 size 0x2e0 virtual false final false
...
/// @brief Method CreateJObject addr 0x25375b4 size 0x340 virtual false final false
 Newtonsoft::Json::Linq::JToken CreateJObject(Newtonsoft::Json::JsonReader reader) ;

/// @brief Method CreateValueInternal addr 0x2536d64 size 0x494 virtual false final false
...
/// @brief Method CoerceEmptyStringToNull addr 0x2538ebc size 0x104 virtual false final false
static bool CoerceEmptyStringToNull(System::Type objectType, Newtonsoft::Json::Serialization::JsonContract contract, ::StringW s) ;

/// @brief Method GetExpectedDescription addr 0x2538fc0 size 0xcc virtual false final false
 ::StringW GetExpectedDescription(Newtonsoft::Json::Serialization::JsonContract contract) ;

/// @brief Method GetConverter addr 0x2536728 size 0x6c virtual false final false
...
/// @brief Method CreateObject addr 0x2537a10 size 0xa88 virtual false final false
...
/// @brief Method ReadMetadataPropertiesToken addr 0x253908c size 0x728 virtual false final false
...
/// @brief Method ReadMetadataProperties addr 0x25397b4 size 0x678 virtual false final false
...
/// @brief Method ResolveTypeName addr 0x253a8d8 size 0x500 virtual false final false
...
/// @brief Method EnsureArrayContract addr 0x253add8 size 0x180 virtual false final false
...
/// @brief Method CreateList addr 0x2538498 size 0x690 virtual false final false
...
/// @brief Method HasNoDefinedType addr 0x2539e2c size 0x98 virtual false final false
 bool HasNoDefinedType(Newtonsoft::Json::Serialization::JsonContract contract) ;

/// @brief Method EnsureType addr 0x2538b28 size 0x394 virtual false final false
...
/// @brief Method SetPropertyValue addr 0x253b864 size 0x480 virtual false final false
...
/// @brief Method CalculatePropertyDetails addr 0x253bce4 size 0x358 virtual false final false
...
/// @brief Method AddReference addr 0x253c168 size 0x3c4 virtual false final false
 void AddReference(Newtonsoft::Json::JsonReader reader, ::StringW id, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method HasFlag addr 0x253c15c size 0xc virtual false final false
 bool HasFlag(Newtonsoft::Json::DefaultValueHandling value, Newtonsoft::Json::DefaultValueHandling flag) ;

/// @brief Method ShouldSetPropertyValue addr 0x253c03c size 0x120 virtual false final false
 bool ShouldSetPropertyValue(Newtonsoft::Json::Serialization::JsonProperty property, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method CreateNewList addr 0x253af58 size 0x268 virtual false final false
...
/// @brief Method CreateNewDictionary addr 0x253a0ac size 0x1f8 virtual false final false
...
/// @brief Method OnDeserializing addr 0x253c52c size 0x22c virtual false final false
...
/// @brief Method OnDeserialized addr 0x253c758 size 0x22c virtual false final false
...
/// @brief Method PopulateDictionary addr 0x253502c size 0x8c8 virtual false final false
...
/// @brief Method PopulateMultidimensionalArray addr 0x253b1c0 size 0x6a4 virtual false final false
...
/// @brief Method ThrowUnexpectedEndException addr 0x253c984 size 0x134 virtual false final false
...
/// @brief Method PopulateList addr 0x2534b14 size 0x518 virtual false final false
...
/// @brief Method CreateISerializable addr 0x253a2a4 size 0x634 virtual false final false
...
/// @brief Method CreateISerializableItem addr 0x252680c size 0xf4 virtual false final false
...
/// @brief Method CreateObjectUsingCreatorWithParameters addr 0x253cab8 size 0x1b6c virtual false final false
...
/// @brief Method DeserializeConvertable addr 0x2536950 size 0x414 virtual false final false
...
/// @brief Method ResolvePropertyAndCreatorValues addr 0x253e624 size 0x620 virtual false final false
...
/// @brief Method ReadForType addr 0x2536794 size 0x1bc virtual false final false
 bool ReadForType(Newtonsoft::Json::JsonReader reader, Newtonsoft::Json::Serialization::JsonContract contract, bool hasConverter) ;

/// @brief Method CreateNewObject addr 0x2539ec4 size 0x1e8 virtual false final false
...
/// @brief Method PopulateObject addr 0x25358f4 size 0xa28 virtual false final false
...
/// @brief Method ShouldDeserialize addr 0x253f314 size 0x274 virtual false final false
...
/// @brief Method CheckPropertyName addr 0x25378f4 size 0x11c virtual false final false
 bool CheckPropertyName(Newtonsoft::Json::JsonReader reader, ::StringW memberName) ;

/// @brief Method SetExtensionData addr 0x253f1a0 size 0x174 virtual false final false
...
/// @brief Method ReadExtensionDataValue addr 0x253f0e4 size 0xbc virtual false final false
...
/// @brief Method EndProcessProperty addr 0x253ec44 size 0x4a0 virtual false final false
...
/// @brief Method SetPropertyPresence addr 0x253f588 size 0x110 virtual false final false
...
/// @brief Method HandleError addr 0x25371f8 size 0x6c virtual false final false
