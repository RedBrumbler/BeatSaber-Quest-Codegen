...
/// @brief Method .ctor addr 0x2547364 size 0x6c virtual false final false
 void _ctor(System::Reflection::MemberInfo memberInfo) ;

/// @brief Method SetValue addr 0x25473d0 size 0x1a4 virtual true final true
 void SetValue(::bs_hook::Il2CppWrapperType target, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetValue addr 0x2547574 size 0x1a0 virtual true final true
