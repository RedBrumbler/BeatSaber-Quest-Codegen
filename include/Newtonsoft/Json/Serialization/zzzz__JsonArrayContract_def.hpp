...
/// @brief Method get_CollectionItemType addr 0x2530708 size 0x8 virtual false final false
 System::Type get_CollectionItemType() ;

/// @brief Method set_CollectionItemType addr 0x2530710 size 0x8 virtual false final false
 void set_CollectionItemType(System::Type value) ;

/// @brief Method get_IsMultidimensionalArray addr 0x2530718 size 0x8 virtual false final false
 bool get_IsMultidimensionalArray() ;

/// @brief Method set_IsMultidimensionalArray addr 0x2530720 size 0xc virtual false final false
 void set_IsMultidimensionalArray(bool value) ;

/// @brief Method get_IsArray addr 0x253072c size 0x8 virtual false final false
 bool get_IsArray() ;

/// @brief Method set_IsArray addr 0x2530734 size 0xc virtual false final false
 void set_IsArray(bool value) ;

/// @brief Method get_ShouldCreateWrapper addr 0x2530740 size 0x8 virtual false final false
 bool get_ShouldCreateWrapper() ;

/// @brief Method set_ShouldCreateWrapper addr 0x2530748 size 0xc virtual false final false
 void set_ShouldCreateWrapper(bool value) ;

/// @brief Method get_CanDeserialize addr 0x2530754 size 0x8 virtual false final false
 bool get_CanDeserialize() ;

/// @brief Method set_CanDeserialize addr 0x253075c size 0xc virtual false final false
 void set_CanDeserialize(bool value) ;

/// @brief Method get_ParameterizedCreator addr 0x2530768 size 0x7c virtual false final false
 Newtonsoft::Json::Serialization::ObjectConstructor_1<::bs_hook::Il2CppWrapperType> get_ParameterizedCreator() ;

/// @brief Method get_OverrideCreator addr 0x25307e4 size 0x8 virtual false final false
 Newtonsoft::Json::Serialization::ObjectConstructor_1<::bs_hook::Il2CppWrapperType> get_OverrideCreator() ;

/// @brief Method set_OverrideCreator addr 0x252dc1c size 0x10 virtual false final false
 void set_OverrideCreator(Newtonsoft::Json::Serialization::ObjectConstructor_1<::bs_hook::Il2CppWrapperType> value) ;

/// @brief Method get_HasParameterizedCreator addr 0x25307ec size 0x8 virtual false final false
 bool get_HasParameterizedCreator() ;

/// @brief Method set_HasParameterizedCreator addr 0x25307f4 size 0xc virtual false final false
 void set_HasParameterizedCreator(bool value) ;

/// @brief Method get_HasParameterizedCreatorInternal addr 0x2530800 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x252d384 size 0x898 virtual false final false
 void _ctor(System::Type underlyingType) ;

/// @brief Method CreateWrapper addr 0x2530884 size 0x3c0 virtual false final false
 Newtonsoft::Json::Utilities::IWrappedCollection CreateWrapper(::bs_hook::Il2CppWrapperType list) ;

/// @brief Method CreateTemporaryCollection addr 0x2530c44 size 0x22c virtual false final false
