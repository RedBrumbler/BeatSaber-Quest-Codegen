...
/// @brief Method .ctor addr 0x2527a78 size 0x8 virtual false final false
 void _ctor(System::Type resolverType, System::Type contractType) ;

/// @brief Method GetHashCode addr 0x2527a80 size 0x48 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2527ac8 size 0x88 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2527b50 size 0x24 virtual false final false
