...
/// @brief Method get_MemberSerialization addr 0x2533ab4 size 0x8 virtual false final false
 Newtonsoft::Json::MemberSerialization get_MemberSerialization() ;

/// @brief Method set_MemberSerialization addr 0x2533abc size 0x8 virtual false final false
 void set_MemberSerialization(Newtonsoft::Json::MemberSerialization value) ;

/// @brief Method get_ItemRequired addr 0x2533ac4 size 0x8 virtual false final false
 System::Nullable_1<Newtonsoft::Json::Required> get_ItemRequired() ;

/// @brief Method set_ItemRequired addr 0x2533acc size 0x8 virtual false final false
 void set_ItemRequired(System::Nullable_1<Newtonsoft::Json::Required> value) ;

/// @brief Method get_Properties addr 0x2533ad4 size 0x8 virtual false final false
 Newtonsoft::Json::Serialization::JsonPropertyCollection get_Properties() ;

/// @brief Method set_Properties addr 0x2533adc size 0x8 virtual false final false
 void set_Properties(Newtonsoft::Json::Serialization::JsonPropertyCollection value) ;

/// @brief Method get_ConstructorParameters addr 0x2533ae4 size 0x4 virtual false final false
 Newtonsoft::Json::Serialization::JsonPropertyCollection get_ConstructorParameters() ;

/// @brief Method get_CreatorParameters addr 0x2529490 size 0x70 virtual false final false
 Newtonsoft::Json::Serialization::JsonPropertyCollection get_CreatorParameters() ;

/// @brief Method get_OverrideConstructor addr 0x2533ae8 size 0x8 virtual false final false
 System::Reflection::ConstructorInfo get_OverrideConstructor() ;

/// @brief Method set_OverrideConstructor addr 0x2529408 size 0x88 virtual false final false
 void set_OverrideConstructor(System::Reflection::ConstructorInfo value) ;

/// @brief Method get_ParametrizedConstructor addr 0x2533af0 size 0x8 virtual false final false
 System::Reflection::ConstructorInfo get_ParametrizedConstructor() ;

/// @brief Method set_ParametrizedConstructor addr 0x2529660 size 0x88 virtual false final false
 void set_ParametrizedConstructor(System::Reflection::ConstructorInfo value) ;

/// @brief Method get_OverrideCreator addr 0x2533af8 size 0x8 virtual false final false
 Newtonsoft::Json::Serialization::ObjectConstructor_1<::bs_hook::Il2CppWrapperType> get_OverrideCreator() ;

/// @brief Method set_OverrideCreator addr 0x2533b00 size 0x8 virtual false final false
 void set_OverrideCreator(Newtonsoft::Json::Serialization::ObjectConstructor_1<::bs_hook::Il2CppWrapperType> value) ;

/// @brief Method get_ParameterizedCreator addr 0x2533b08 size 0x8 virtual false final false
 Newtonsoft::Json::Serialization::ObjectConstructor_1<::bs_hook::Il2CppWrapperType> get_ParameterizedCreator() ;

/// @brief Method get_ExtensionDataSetter addr 0x2533b10 size 0x8 virtual false final false
 Newtonsoft::Json::Serialization::ExtensionDataSetter get_ExtensionDataSetter() ;

/// @brief Method set_ExtensionDataSetter addr 0x2533b18 size 0x8 virtual false final false
 void set_ExtensionDataSetter(Newtonsoft::Json::Serialization::ExtensionDataSetter value) ;

/// @brief Method get_ExtensionDataGetter addr 0x2533b20 size 0x8 virtual false final false
 Newtonsoft::Json::Serialization::ExtensionDataGetter get_ExtensionDataGetter() ;

/// @brief Method set_ExtensionDataGetter addr 0x2533b28 size 0x8 virtual false final false
 void set_ExtensionDataGetter(Newtonsoft::Json::Serialization::ExtensionDataGetter value) ;

/// @brief Method get_ExtensionDataValueType addr 0x2533b30 size 0x8 virtual false final false
 System::Type get_ExtensionDataValueType() ;

/// @brief Method set_ExtensionDataValueType addr 0x252a3ac size 0xac virtual false final false
 void set_ExtensionDataValueType(System::Type value) ;

/// @brief Method get_HasRequiredOrDefaultValueProperties addr 0x2533b38 size 0x3f4 virtual false final false
...
/// @brief Method .ctor addr 0x2528ce4 size 0x88 virtual false final false
 void _ctor(System::Type underlyingType) ;

/// @brief Method GetUninitializedObject addr 0x2533f2c size 0x10c virtual false final false
