...
/// @brief Method get_LevelFilter addr 0x2524120 size 0x8 virtual true final true
 System::Diagnostics::TraceLevel get_LevelFilter() ;

/// @brief Method set_LevelFilter addr 0x2524128 size 0x8 virtual false final false
 void set_LevelFilter(System::Diagnostics::TraceLevel value) ;

/// @brief Method GetTraceEventType addr 0x2524130 size 0x70 virtual false final false
 System::Diagnostics::TraceEventType GetTraceEventType(System::Diagnostics::TraceLevel level) ;

/// @brief Method Trace addr 0x25241a0 size 0x470 virtual true final true
 void Trace(System::Diagnostics::TraceLevel level, ::StringW message, System::Exception ex) ;

// Ctor Parameters []
explicit DiagnosticsTraceWriter() ;

/// @brief Method .ctor addr 0x2524610 size 0x8 virtual false final false
 void _ctor() ;
