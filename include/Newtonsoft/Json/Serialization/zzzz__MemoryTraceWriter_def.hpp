...
/// @brief Method get_LevelFilter addr 0x2524788 size 0x8 virtual true final true
 System::Diagnostics::TraceLevel get_LevelFilter() ;

/// @brief Method set_LevelFilter addr 0x2524790 size 0x8 virtual false final false
 void set_LevelFilter(System::Diagnostics::TraceLevel value) ;

// Ctor Parameters []
explicit MemoryTraceWriter() ;

/// @brief Method .ctor addr 0x2524798 size 0x88 virtual false final false
 void _ctor() ;

/// @brief Method Trace addr 0x2524820 size 0x230 virtual true final true
 void Trace(System::Diagnostics::TraceLevel level, ::StringW message, System::Exception ex) ;

/// @brief Method GetTraceMessages addr 0x2524a50 size 0x8 virtual false final false
 System::Collections::Generic::IEnumerable_1<::StringW> GetTraceMessages() ;

/// @brief Method ToString addr 0x2524a58 size 0x1b8 virtual true final false
 ::StringW ToString() ;
