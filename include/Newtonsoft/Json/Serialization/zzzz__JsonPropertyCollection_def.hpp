...
namespace Newtonsoft::Json::Serialization {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11906)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3801), inst: 3809 }), TypeDefinitionIndex(TypeDefinitionIndex(3801))}
...
/// @brief Method .ctor addr 0x252a5e0 size 0x160 virtual false final false
 void _ctor(System::Type type) ;

/// @brief Method GetKeyForItem addr 0x25338d4 size 0x18 virtual true final false
 ::StringW GetKeyForItem(Newtonsoft::Json::Serialization::JsonProperty item) ;

/// @brief Method AddProperty addr 0x252a780 size 0x234 virtual false final false
 void AddProperty(Newtonsoft::Json::Serialization::JsonProperty property) ;

/// @brief Method GetClosestMatchProperty addr 0x252a740 size 0x40 virtual false final false
 Newtonsoft::Json::Serialization::JsonProperty GetClosestMatchProperty(::StringW propertyName) ;

/// @brief Method TryGetValue addr 0x25339d8 size 0xdc virtual false final false
 bool TryGetValue(::StringW key, ByRef<Newtonsoft::Json::Serialization::JsonProperty> item) ;

/// @brief Method GetProperty addr 0x25338ec size 0xec virtual false final false
