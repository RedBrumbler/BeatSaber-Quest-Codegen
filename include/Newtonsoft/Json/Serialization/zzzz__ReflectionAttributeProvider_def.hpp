...
/// @brief Method .ctor addr 0x2524c10 size 0x68 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType attributeProvider) ;

/// @brief Method GetAttributes addr 0x2524c78 size 0x6c virtual true final true
 System::Collections::Generic::IList_1<System::Attribute> GetAttributes(bool inherit) ;

/// @brief Method GetAttributes addr 0x2524ce4 size 0x70 virtual true final true
