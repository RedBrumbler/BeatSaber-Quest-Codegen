...
/// @brief Method get_ItemContract addr 0x2524618 size 0x8 virtual false final false
 Newtonsoft::Json::Serialization::JsonContract get_ItemContract() ;

/// @brief Method set_ItemContract addr 0x2524620 size 0x44 virtual false final false
 void set_ItemContract(Newtonsoft::Json::Serialization::JsonContract value) ;

/// @brief Method get_FinalItemContract addr 0x2524664 size 0x8 virtual false final false
 Newtonsoft::Json::Serialization::JsonContract get_FinalItemContract() ;

/// @brief Method get_ItemConverter addr 0x252466c size 0x8 virtual false final false
 Newtonsoft::Json::JsonConverter get_ItemConverter() ;

/// @brief Method set_ItemConverter addr 0x2524674 size 0x8 virtual false final false
 void set_ItemConverter(Newtonsoft::Json::JsonConverter value) ;

/// @brief Method get_ItemIsReference addr 0x252467c size 0x8 virtual false final false
 System::Nullable_1<bool> get_ItemIsReference() ;

/// @brief Method set_ItemIsReference addr 0x2524684 size 0x8 virtual false final false
 void set_ItemIsReference(System::Nullable_1<bool> value) ;

/// @brief Method get_ItemReferenceLoopHandling addr 0x252468c size 0x8 virtual false final false
 System::Nullable_1<Newtonsoft::Json::ReferenceLoopHandling> get_ItemReferenceLoopHandling() ;

/// @brief Method set_ItemReferenceLoopHandling addr 0x2524694 size 0x8 virtual false final false
 void set_ItemReferenceLoopHandling(System::Nullable_1<Newtonsoft::Json::ReferenceLoopHandling> value) ;

/// @brief Method get_ItemTypeNameHandling addr 0x252469c size 0x8 virtual false final false
 System::Nullable_1<Newtonsoft::Json::TypeNameHandling> get_ItemTypeNameHandling() ;

/// @brief Method set_ItemTypeNameHandling addr 0x25246a4 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x25246ac size 0xdc virtual false final false
