...
/// @brief Method get_WriteData addr 0x24f9760 size 0x8 virtual false final false
 bool get_WriteData() ;

/// @brief Method set_WriteData addr 0x24f9768 size 0xc virtual false final false
 void set_WriteData(bool value) ;

/// @brief Method get_ReadData addr 0x24f9774 size 0x8 virtual false final false
 bool get_ReadData() ;

/// @brief Method set_ReadData addr 0x24f977c size 0xc virtual false final false
 void set_ReadData(bool value) ;

// Ctor Parameters []
explicit JsonExtensionDataAttribute() ;

/// @brief Method .ctor addr 0x24f9788 size 0x20 virtual false final false
 void _ctor() ;
