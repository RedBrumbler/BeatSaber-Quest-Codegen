...
namespace Newtonsoft::Json::Bson {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12035))}
...
/// @brief Method get_Pattern addr 0x2580224 size 0x8 virtual false final false
 Newtonsoft::Json::Bson::BsonString get_Pattern() ;

/// @brief Method set_Pattern addr 0x258022c size 0x8 virtual false final false
 void set_Pattern(Newtonsoft::Json::Bson::BsonString value) ;

/// @brief Method get_Options addr 0x2580234 size 0x8 virtual false final false
 Newtonsoft::Json::Bson::BsonString get_Options() ;

/// @brief Method set_Options addr 0x258023c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2580244 size 0xbc virtual false final false
 void _ctor(::StringW pattern, ::StringW options) ;

/// @brief Method get_Type addr 0x2580300 size 0x8 virtual true final false
