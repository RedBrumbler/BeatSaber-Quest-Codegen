...
/// @brief Method get_DateTimeKindHandling addr 0x257c75c size 0x8 virtual false final false
 System::DateTimeKind get_DateTimeKindHandling() ;

/// @brief Method set_DateTimeKindHandling addr 0x257c764 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x257c76c size 0x30 virtual false final false
 void _ctor(System::IO::BinaryWriter writer) ;

/// @brief Method Flush addr 0x257c79c size 0x20 virtual false final false
 void Flush() ;

/// @brief Method Close addr 0x257c7bc size 0x20 virtual false final false
 void Close() ;

/// @brief Method WriteToken addr 0x257c7dc size 0x28 virtual false final false
 void WriteToken(Newtonsoft::Json::Bson::BsonToken t) ;

/// @brief Method WriteTokenInternal addr 0x257d0a0 size 0xe50 virtual false final false
 void WriteTokenInternal(Newtonsoft::Json::Bson::BsonToken t) ;

/// @brief Method WriteString addr 0x257df80 size 0xa4 virtual false final false
 void WriteString(::StringW s, int32_t byteCount, System::Nullable_1<int32_t> calculatedlengthPrefix) ;

/// @brief Method WriteUtf8Bytes addr 0x257e0b4 size 0x13c virtual false final false
 void WriteUtf8Bytes(::StringW s, int32_t byteCount) ;

/// @brief Method CalculateSize addr 0x257e1f0 size 0x8 virtual false final false
 int32_t CalculateSize(int32_t stringByteCount) ;

/// @brief Method CalculateSizeWithLength addr 0x257e1f8 size 0x14 virtual false final false
 int32_t CalculateSizeWithLength(int32_t stringByteCount, bool includeSize) ;

/// @brief Method CalculateSize addr 0x257c804 size 0x89c virtual false final false
