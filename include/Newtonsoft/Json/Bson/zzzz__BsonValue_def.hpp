...
/// @brief Method .ctor addr 0x2580178 size 0x30 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType value, Newtonsoft::Json::Bson::BsonType type) ;

/// @brief Method get_Value addr 0x25801a8 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_Value() ;

/// @brief Method get_Type addr 0x25801b0 size 0x8 virtual true final false
