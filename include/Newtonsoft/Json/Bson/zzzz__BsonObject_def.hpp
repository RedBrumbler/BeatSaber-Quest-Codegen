...
/// @brief Method Add addr 0x257fe40 size 0x134 virtual false final false
 void Add(::StringW name, Newtonsoft::Json::Bson::BsonToken token) ;

/// @brief Method get_Type addr 0x257ffb8 size 0x8 virtual true final false
 Newtonsoft::Json::Bson::BsonType get_Type() ;

/// @brief Method GetEnumerator addr 0x257def0 size 0x90 virtual true final true
 System::Collections::Generic::IEnumerator_1<Newtonsoft::Json::Bson::BsonProperty> GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x257ffc0 size 0x4 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

// Ctor Parameters []
explicit BsonObject() ;

/// @brief Method .ctor addr 0x257ffc4 size 0x7c virtual false final false
 void _ctor() ;
