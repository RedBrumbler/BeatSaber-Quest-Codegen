...
/// @brief Method get_Name addr 0x2580308 size 0x8 virtual false final false
 Newtonsoft::Json::Bson::BsonString get_Name() ;

/// @brief Method set_Name addr 0x2580310 size 0x8 virtual false final false
 void set_Name(Newtonsoft::Json::Bson::BsonString value) ;

/// @brief Method get_Value addr 0x2580318 size 0x8 virtual false final false
 Newtonsoft::Json::Bson::BsonToken get_Value() ;

/// @brief Method set_Value addr 0x2580320 size 0x8 virtual false final false
 void set_Value(Newtonsoft::Json::Bson::BsonToken value) ;

// Ctor Parameters []
explicit BsonProperty() ;

/// @brief Method .ctor addr 0x257ff74 size 0x8 virtual false final false
 void _ctor() ;
