...
/// @brief Method Add addr 0x2580040 size 0xb0 virtual false final false
 void Add(Newtonsoft::Json::Bson::BsonToken token) ;

/// @brief Method get_Type addr 0x25800f0 size 0x8 virtual true final false
 Newtonsoft::Json::Bson::BsonType get_Type() ;

/// @brief Method GetEnumerator addr 0x257e024 size 0x90 virtual true final true
 System::Collections::Generic::IEnumerator_1<Newtonsoft::Json::Bson::BsonToken> GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x25800f8 size 0x4 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

// Ctor Parameters []
explicit BsonArray() ;

/// @brief Method .ctor addr 0x25800fc size 0x7c virtual false final false
 void _ctor() ;
