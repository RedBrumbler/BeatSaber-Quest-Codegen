...
/// @brief Method get_Parent addr 0x257fe18 size 0x8 virtual false final false
 Newtonsoft::Json::Bson::BsonToken get_Parent() ;

/// @brief Method set_Parent addr 0x257fe20 size 0x8 virtual false final false
 void set_Parent(Newtonsoft::Json::Bson::BsonToken value) ;

/// @brief Method get_CalculatedSize addr 0x257fe28 size 0x8 virtual false final false
 int32_t get_CalculatedSize() ;

/// @brief Method set_CalculatedSize addr 0x257fe30 size 0x8 virtual false final false
 void set_CalculatedSize(int32_t value) ;

// Ctor Parameters []
explicit BsonToken() ;

/// @brief Method .ctor addr 0x257fe38 size 0x8 virtual false final false
 void _ctor() ;
