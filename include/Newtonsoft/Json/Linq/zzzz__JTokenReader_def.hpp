...
/// @brief Method get_CurrentToken addr 0x2553a04 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2553a0c size 0x6c virtual false final false
...
/// @brief Method .ctor addr 0x2553a78 size 0x24 virtual false final false
 void _ctor(Newtonsoft::Json::Linq::JToken token, ::StringW initialPath) ;

/// @brief Method Read addr 0x2553a9c size 0xc4 virtual true final false
 bool Read() ;

/// @brief Method ReadOver addr 0x2553bc8 size 0xb4 virtual false final false
 bool ReadOver(Newtonsoft::Json::Linq::JToken t) ;

/// @brief Method ReadToEnd addr 0x2554160 size 0x20 virtual false final false
 bool ReadToEnd() ;

/// @brief Method GetEndToken addr 0x2554204 size 0x150 virtual false final false
 System::Nullable_1<Newtonsoft::Json::JsonToken> GetEndToken(Newtonsoft::Json::Linq::JContainer c) ;

/// @brief Method ReadInto addr 0x2553b60 size 0x68 virtual false final false
 bool ReadInto(Newtonsoft::Json::Linq::JContainer c) ;

/// @brief Method SetEnd addr 0x2554180 size 0x84 virtual false final false
 bool SetEnd(Newtonsoft::Json::Linq::JContainer c) ;

/// @brief Method SetToken addr 0x2553c7c size 0x4e4 virtual false final false
 void SetToken(Newtonsoft::Json::Linq::JToken token) ;

/// @brief Method SafeToString addr 0x2554354 size 0x20 virtual false final false
 ::StringW SafeToString(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method Newtonsoft.Json.IJsonLineInfo.HasLineInfo addr 0x2554374 size 0xb4 virtual true final true
 bool Newtonsoft_Json_IJsonLineInfo_HasLineInfo() ;

/// @brief Method Newtonsoft.Json.IJsonLineInfo.get_LineNumber addr 0x2554428 size 0xb8 virtual true final true
 int32_t Newtonsoft_Json_IJsonLineInfo_get_LineNumber() ;

/// @brief Method Newtonsoft.Json.IJsonLineInfo.get_LinePosition addr 0x25544e0 size 0xb8 virtual true final true
 int32_t Newtonsoft_Json_IJsonLineInfo_get_LinePosition() ;

/// @brief Method get_Path addr 0x2554598 size 0xe4 virtual true final false
 ::StringW get_Path() ;
