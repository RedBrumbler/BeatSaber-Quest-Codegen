...
namespace Newtonsoft::Json::Linq::JsonPath {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11983))}
...
/// @brief Method get_Path addr 0x25692cc size 0x8 virtual false final false
 System::Collections::Generic::List_1<Newtonsoft::Json::Linq::JsonPath::PathFilter> get_Path() ;

/// @brief Method set_Path addr 0x25692d4 size 0x8 virtual false final false
 void set_Path(System::Collections::Generic::List_1<Newtonsoft::Json::Linq::JsonPath::PathFilter> value) ;

/// @brief Method get_Value addr 0x25692dc size 0x8 virtual false final false
 Newtonsoft::Json::Linq::JValue get_Value() ;

/// @brief Method set_Value addr 0x25692e4 size 0x8 virtual false final false
 void set_Value(Newtonsoft::Json::Linq::JValue value) ;

/// @brief Method IsMatch addr 0x25692ec size 0x470 virtual true final false
 bool IsMatch(Newtonsoft::Json::Linq::JToken t) ;

/// @brief Method EqualsWithStringCoercion addr 0x256975c size 0x4d4 virtual false final false
...
/// @brief Method .ctor addr 0x2568adc size 0x8 virtual false final false
 void _ctor() ;
