...
/// @brief Method get_Filters addr 0x256684c size 0x8 virtual false final false
 System::Collections::Generic::List_1<Newtonsoft::Json::Linq::JsonPath::PathFilter> get_Filters() ;

/// @brief Method set_Filters addr 0x2566854 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x256685c size 0xb8 virtual false final false
 void _ctor(::StringW expression) ;

/// @brief Method ParseMain addr 0x2566914 size 0x160 virtual false final false
 void ParseMain() ;

/// @brief Method ParsePath addr 0x2566ac8 size 0x608 virtual false final false
...
/// @brief Method ParseIndexer addr 0x25670d8 size 0xf4 virtual false final false
 Newtonsoft::Json::Linq::JsonPath::PathFilter ParseIndexer(char16_t indexerOpenChar) ;

/// @brief Method ParseArrayIndexer addr 0x256773c size 0x798 virtual false final false
 Newtonsoft::Json::Linq::JsonPath::PathFilter ParseArrayIndexer(char16_t indexerCloseChar) ;

/// @brief Method EatWhitespace addr 0x2566a74 size 0x54 virtual false final false
 void EatWhitespace() ;

/// @brief Method ParseQuery addr 0x2567594 size 0x1a8 virtual false final false
 Newtonsoft::Json::Linq::JsonPath::PathFilter ParseQuery(char16_t indexerCloseChar) ;

/// @brief Method ParseExpression addr 0x2567ed4 size 0x690 virtual false final false
 Newtonsoft::Json::Linq::JsonPath::QueryExpression ParseExpression() ;

/// @brief Method ParseValue addr 0x2568750 size 0x38c virtual false final false
 ::bs_hook::Il2CppWrapperType ParseValue() ;

/// @brief Method ReadQuotedString addr 0x2568c0c size 0x244 virtual false final false
 ::StringW ReadQuotedString() ;

/// @brief Method Match addr 0x2568ae4 size 0xa8 virtual false final false
 bool Match(::StringW s) ;

/// @brief Method ParseOperator addr 0x256856c size 0x1e4 virtual false final false
 Newtonsoft::Json::Linq::JsonPath::QueryOperator ParseOperator() ;

/// @brief Method ParseQuotedField addr 0x2567240 size 0x354 virtual false final false
 Newtonsoft::Json::Linq::JsonPath::PathFilter ParseQuotedField(char16_t indexerCloseChar) ;

/// @brief Method EnsureLength addr 0x25671cc size 0x74 virtual false final false
 void EnsureLength(::StringW message) ;

/// @brief Method Evaluate addr 0x2568e50 size 0xc virtual false final false
...
/// @brief Method Evaluate addr 0x2568e5c size 0x1cc virtual false final false
