...
/// @brief Method get_CommentHandling addr 0x2548c1c size 0x8 virtual false final false
 Newtonsoft::Json::Linq::CommentHandling get_CommentHandling() ;

/// @brief Method set_CommentHandling addr 0x2548c24 size 0x64 virtual false final false
 void set_CommentHandling(Newtonsoft::Json::Linq::CommentHandling value) ;

/// @brief Method get_LineInfoHandling addr 0x2548c88 size 0x8 virtual false final false
 Newtonsoft::Json::Linq::LineInfoHandling get_LineInfoHandling() ;

/// @brief Method set_LineInfoHandling addr 0x2548c90 size 0x64 virtual false final false
 void set_LineInfoHandling(Newtonsoft::Json::Linq::LineInfoHandling value) ;

// Ctor Parameters []
explicit JsonLoadSettings() ;

/// @brief Method .ctor addr 0x2548cf4 size 0x8 virtual false final false
 void _ctor() ;
