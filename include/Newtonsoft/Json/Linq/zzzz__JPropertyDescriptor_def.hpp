...
/// @brief Method .ctor addr 0x254771c size 0xc virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method CastInstance addr 0x2547728 size 0x7c virtual false final false
static Newtonsoft::Json::Linq::JObject CastInstance(::bs_hook::Il2CppWrapperType instance) ;

/// @brief Method CanResetValue addr 0x25477a4 size 0x8 virtual true final false
 bool CanResetValue(::bs_hook::Il2CppWrapperType component) ;

/// @brief Method GetValue addr 0x25477ac size 0x44 virtual true final false
 ::bs_hook::Il2CppWrapperType GetValue(::bs_hook::Il2CppWrapperType component) ;

/// @brief Method ResetValue addr 0x2547870 size 0x4 virtual true final false
 void ResetValue(::bs_hook::Il2CppWrapperType component) ;

/// @brief Method SetValue addr 0x2547874 size 0xe8 virtual true final false
 void SetValue(::bs_hook::Il2CppWrapperType component, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method ShouldSerializeValue addr 0x2547a3c size 0x8 virtual true final false
 bool ShouldSerializeValue(::bs_hook::Il2CppWrapperType component) ;

/// @brief Method get_ComponentType addr 0x2547a44 size 0x6c virtual true final false
 System::Type get_ComponentType() ;

/// @brief Method get_IsReadOnly addr 0x2547ab0 size 0x8 virtual true final false
 bool get_IsReadOnly() ;

/// @brief Method get_PropertyType addr 0x2547ab8 size 0x6c virtual true final false
 System::Type get_PropertyType() ;

/// @brief Method get_NameHashCode addr 0x2547b24 size 0x8 virtual true final false
