...
namespace Newtonsoft::Json::Linq {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11968))}
...
/// @brief Method .ctor addr 0x2548ddc size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2548de4 size 0xc virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType rawJson) ;

/// @brief Method Create addr 0x2548df0 size 0x378 virtual false final false
static Newtonsoft::Json::Linq::JRaw Create(Newtonsoft::Json::JsonReader reader) ;

/// @brief Method CloneToken addr 0x2549168 size 0x64 virtual true final false
