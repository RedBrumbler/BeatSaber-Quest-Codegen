...
/// @brief Method get_ChildrenTokens addr 0x2549564 size 0x8 virtual true final false
 System::Collections::Generic::IList_1<Newtonsoft::Json::Linq::JToken> get_ChildrenTokens() ;

/// @brief Method IndexOfItem addr 0x254956c size 0x58 virtual true final false
 int32_t IndexOfItem(Newtonsoft::Json::Linq::JToken item) ;

/// @brief Method MergeItem addr 0x25495c4 size 0xb0 virtual true final false
 void MergeItem(::bs_hook::Il2CppWrapperType content, Newtonsoft::Json::Linq::JsonMergeSettings settings) ;

/// @brief Method get_Name addr 0x254a44c size 0x8 virtual false final false
 ::StringW get_Name() ;

/// @brief Method set_Name addr 0x254a454 size 0x8 virtual false final false
 void set_Name(::StringW value) ;

/// @brief Method get_Type addr 0x254a45c size 0x8 virtual true final false
 Newtonsoft::Json::Linq::JTokenType get_Type() ;

// Ctor Parameters []
explicit JConstructor() ;

/// @brief Method .ctor addr 0x254a464 size 0x78 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x254a534 size 0x98 virtual false final false
...
/// @brief Method .ctor addr 0x254a8e4 size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x254a918 size 0x34 virtual false final false
 void _ctor(::StringW name, ::bs_hook::Il2CppWrapperType content) ;

// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }]
explicit JConstructor(::StringW name) ;

/// @brief Method .ctor addr 0x254a94c size 0x130 virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method DeepEquals addr 0x254aa7c size 0xac virtual true final false
 bool DeepEquals(Newtonsoft::Json::Linq::JToken node) ;

/// @brief Method CloneToken addr 0x254ade0 size 0x60 virtual true final false
 Newtonsoft::Json::Linq::JToken CloneToken() ;

/// @brief Method WriteTo addr 0x254ae40 size 0x2ec virtual true final false
 void WriteTo(Newtonsoft::Json::JsonWriter writer, ::ArrayW<Newtonsoft::Json::JsonConverter> converters) ;

/// @brief Method get_Item addr 0x254b12c size 0x12c virtual true final false
 Newtonsoft::Json::Linq::JToken get_Item(::bs_hook::Il2CppWrapperType key) ;

/// @brief Method set_Item addr 0x254b258 size 0x134 virtual true final false
 void set_Item(::bs_hook::Il2CppWrapperType key, Newtonsoft::Json::Linq::JToken value) ;

/// @brief Method GetDeepHashCode addr 0x254b38c size 0x40 virtual true final false
 int32_t GetDeepHashCode() ;

/// @brief Method Load addr 0x254b6d0 size 0x8 virtual false final false
static Newtonsoft::Json::Linq::JConstructor Load(Newtonsoft::Json::JsonReader reader) ;

/// @brief Method Load addr 0x254b6d8 size 0x1f8 virtual false final false
