...
/// @brief Method Equals addr 0x25491cc size 0x94 virtual true final true
 bool Equals(Newtonsoft::Json::Linq::JToken x, Newtonsoft::Json::Linq::JToken y) ;

/// @brief Method GetHashCode addr 0x254928c size 0x24 virtual true final true
 int32_t GetHashCode(Newtonsoft::Json::Linq::JToken obj) ;

// Ctor Parameters []
explicit JTokenEqualityComparer() ;

/// @brief Method .ctor addr 0x25492b0 size 0x8 virtual false final false
 void _ctor() ;
