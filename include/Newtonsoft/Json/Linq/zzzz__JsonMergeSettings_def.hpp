...
/// @brief Method get_MergeArrayHandling addr 0x2548cfc size 0x8 virtual false final false
 Newtonsoft::Json::Linq::MergeArrayHandling get_MergeArrayHandling() ;

/// @brief Method set_MergeArrayHandling addr 0x2548d04 size 0x64 virtual false final false
 void set_MergeArrayHandling(Newtonsoft::Json::Linq::MergeArrayHandling value) ;

/// @brief Method get_MergeNullValueHandling addr 0x2548d68 size 0x8 virtual false final false
 Newtonsoft::Json::Linq::MergeNullValueHandling get_MergeNullValueHandling() ;

/// @brief Method set_MergeNullValueHandling addr 0x2548d70 size 0x64 virtual false final false
 void set_MergeNullValueHandling(Newtonsoft::Json::Linq::MergeNullValueHandling value) ;

// Ctor Parameters []
explicit JsonMergeSettings() ;

/// @brief Method .ctor addr 0x2548dd4 size 0x8 virtual false final false
 void _ctor() ;
