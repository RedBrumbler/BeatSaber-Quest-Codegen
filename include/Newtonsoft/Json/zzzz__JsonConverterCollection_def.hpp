...
namespace Newtonsoft::Json {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3799), inst: 992 }), TypeDefinitionIndex(TypeDefinitionIndex(3799)), TypeDefinitionIndex(TypeDefinitionIndex(11791))}
...
/// @brief Method .ctor addr 0x25052e8 size 0x48 virtual false final false
 void _ctor() ;
