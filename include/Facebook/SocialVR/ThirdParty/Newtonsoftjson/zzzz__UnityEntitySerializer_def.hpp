...
/// @brief Method CanConvert addr 0x220ec28 size 0xac virtual true final false
 bool CanConvert(System::Type objectType) ;

/// @brief Method ReadJson addr 0x220ecd4 size 0x84 virtual true final false
...
/// @brief Method WriteJson addr 0x220ed58 size 0xfc virtual true final false
...
/// @brief Method .ctor addr 0x220ee54 size 0x8 virtual false final false
 void _ctor() ;
