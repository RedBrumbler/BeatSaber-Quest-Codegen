...
/// @brief Method Debug addr 0x2d74e78 size 0x4 virtual false final false
static void Debug(::StringW message, ::ArrayW<::bs_hook::Il2CppWrapperType> args) ;

/// @brief Method Info addr 0x2d74e7c size 0x78 virtual false final false
static void Info(::StringW message, ::ArrayW<::bs_hook::Il2CppWrapperType> args) ;

/// @brief Method Warn addr 0x2d74870 size 0x78 virtual false final false
static void Warn(::StringW message, ::ArrayW<::bs_hook::Il2CppWrapperType> args) ;

/// @brief Method Trace addr 0x2d74ef4 size 0x78 virtual false final false
static void Trace(::StringW message, ::ArrayW<::bs_hook::Il2CppWrapperType> args) ;

/// @brief Method ErrorException addr 0x2d74f6c size 0x58 virtual false final false
static void ErrorException(System::Exception e) ;

/// @brief Method ErrorException addr 0x2d74fc4 size 0x70 virtual false final false
static void ErrorException(::StringW message, System::Exception e) ;

/// @brief Method Error addr 0x2d75034 size 0x78 virtual false final false
