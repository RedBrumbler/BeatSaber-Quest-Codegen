...
/// @brief Method CheckConsistency addr 0x2bce214 size 0x3c virtual false final false
 void CheckConsistency() ;

/// @brief Method SetLayerMask addr 0x2bce28c size 0x10 virtual false final false
 void SetLayerMask(UnityEngine::LayerMask layerMask) ;

/// @brief Method SetDepth addr 0x2bce29c size 0x48 virtual false final false
 void SetDepth(float_t minDepth, float_t maxDepth) ;

/// @brief Method CreateLegacyFilter addr 0x2bccc60 size 0x100 virtual false final false
static UnityEngine::ContactFilter2D CreateLegacyFilter(int32_t layerMask, float_t minDepth, float_t maxDepth) ;

/// @brief Method CheckConsistency_Injected addr 0x2bce250 size 0x3c virtual false final false
