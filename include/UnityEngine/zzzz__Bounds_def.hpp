...
/// @brief Method .ctor addr 0x2b84d48 size 0x20 virtual false final false
 void _ctor(UnityEngine::Vector3 center, UnityEngine::Vector3 size) ;

/// @brief Method GetHashCode addr 0x2b84d68 size 0xd0 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2b84e50 size 0xd0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method Equals addr 0x2b84f20 size 0x6c virtual true final true
 bool Equals(UnityEngine::Bounds other) ;

/// @brief Method get_center addr 0x2b84e38 size 0xc virtual false final false
 UnityEngine::Vector3 get_center() ;

/// @brief Method set_center addr 0x2b84f8c size 0xc virtual false final false
 void set_center(UnityEngine::Vector3 value) ;

/// @brief Method get_size addr 0x2b84f98 size 0x18 virtual false final false
 UnityEngine::Vector3 get_size() ;

/// @brief Method set_size addr 0x2b84fb0 size 0x1c virtual false final false
 void set_size(UnityEngine::Vector3 value) ;

/// @brief Method get_extents addr 0x2b84e44 size 0xc virtual false final false
 UnityEngine::Vector3 get_extents() ;

/// @brief Method set_extents addr 0x2b84fcc size 0xc virtual false final false
 void set_extents(UnityEngine::Vector3 value) ;

/// @brief Method get_min addr 0x2b84fd8 size 0x20 virtual false final false
 UnityEngine::Vector3 get_min() ;

/// @brief Method get_max addr 0x2b84ff8 size 0x20 virtual false final false
 UnityEngine::Vector3 get_max() ;

/// @brief Method op_Equality addr 0x2b85018 size 0x7c virtual false final false
static bool op_Equality(UnityEngine::Bounds lhs, UnityEngine::Bounds rhs) ;

/// @brief Method op_Inequality addr 0x2b85094 size 0x48 virtual false final false
static bool op_Inequality(UnityEngine::Bounds lhs, UnityEngine::Bounds rhs) ;

/// @brief Method SetMinMax addr 0x2b850dc size 0x38 virtual false final false
 void SetMinMax(UnityEngine::Vector3 min, UnityEngine::Vector3 max) ;

/// @brief Method Encapsulate addr 0x2b85114 size 0x78 virtual false final false
 void Encapsulate(UnityEngine::Vector3 point) ;

/// @brief Method Intersects addr 0x2b8518c size 0xa0 virtual false final false
 bool Intersects(UnityEngine::Bounds bounds) ;

/// @brief Method IntersectRay addr 0x2b8522c size 0x74 virtual false final false
 bool IntersectRay(UnityEngine::Ray ray, ByRef<float_t> distance) ;

/// @brief Method ToString addr 0x2b852f4 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x2b85300 size 0x188 virtual true final true
 ::StringW ToString(::StringW format, System::IFormatProvider formatProvider) ;

/// @brief Method Contains addr 0x2b85488 size 0x58 virtual false final false
 bool Contains(UnityEngine::Vector3 point) ;

/// @brief Method IntersectRayAABB addr 0x2b852a0 size 0x54 virtual false final false
static bool IntersectRayAABB(UnityEngine::Ray ray, UnityEngine::Bounds bounds, ByRef<float_t> dist) ;

/// @brief Method Contains_Injected addr 0x2b854e0 size 0x44 virtual false final false
static bool Contains_Injected(ByRef<UnityEngine::Bounds> _unity_self, ByRef<UnityEngine::Vector3> point) ;

/// @brief Method IntersectRayAABB_Injected addr 0x2b85524 size 0x54 virtual false final false
