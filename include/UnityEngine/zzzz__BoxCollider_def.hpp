...
/// @brief Method get_center addr 0x2bd16a8 size 0x5c virtual false final false
 UnityEngine::Vector3 get_center() ;

/// @brief Method set_center addr 0x2bd1748 size 0x54 virtual false final false
 void set_center(UnityEngine::Vector3 value) ;

/// @brief Method get_size addr 0x2bd17e0 size 0x5c virtual false final false
 UnityEngine::Vector3 get_size() ;

/// @brief Method set_size addr 0x2bd1880 size 0x54 virtual false final false
 void set_size(UnityEngine::Vector3 value) ;

/// @brief Method get_center_Injected addr 0x2bd1704 size 0x44 virtual false final false
 void get_center_Injected(ByRef<UnityEngine::Vector3> ret) ;

/// @brief Method set_center_Injected addr 0x2bd179c size 0x44 virtual false final false
 void set_center_Injected(ByRef<UnityEngine::Vector3> value) ;

/// @brief Method get_size_Injected addr 0x2bd183c size 0x44 virtual false final false
 void get_size_Injected(ByRef<UnityEngine::Vector3> ret) ;

/// @brief Method set_size_Injected addr 0x2bd18d4 size 0x44 virtual false final false
