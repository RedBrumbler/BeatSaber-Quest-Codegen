...
/// @brief Method get_width addr 0x2b72464 size 0x8 virtual false final false
 int32_t get_width() ;

/// @brief Method set_width addr 0x2b7246c size 0x8 virtual false final false
 void set_width(int32_t value) ;

/// @brief Method get_height addr 0x2b72474 size 0x8 virtual false final false
 int32_t get_height() ;

/// @brief Method set_height addr 0x2b7247c size 0x8 virtual false final false
 void set_height(int32_t value) ;

/// @brief Method get_refreshRate addr 0x2b72484 size 0x8 virtual false final false
 int32_t get_refreshRate() ;

/// @brief Method set_refreshRate addr 0x2b7248c size 0x8 virtual false final false
 void set_refreshRate(int32_t value) ;

/// @brief Method ToString addr 0x2b72494 size 0x16c virtual true final false
 ::StringW ToString() ;
