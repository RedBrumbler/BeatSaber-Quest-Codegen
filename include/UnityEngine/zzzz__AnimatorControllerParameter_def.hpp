...
/// @brief Method get_name addr 0x2b4c41c size 0x8 virtual false final false
 ::StringW get_name() ;

/// @brief Method Equals addr 0x2b4c424 size 0xdc virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method GetHashCode addr 0x2b4c500 size 0x20 virtual true final false
 int32_t GetHashCode() ;

// Ctor Parameters []
explicit AnimatorControllerParameter() ;

/// @brief Method .ctor addr 0x2b4c520 size 0x50 virtual false final false
 void _ctor() ;
