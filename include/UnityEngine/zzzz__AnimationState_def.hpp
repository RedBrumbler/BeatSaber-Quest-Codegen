...
/// @brief Method set_time addr 0x2b4cb04 size 0x4c virtual false final false
 void set_time(float_t value) ;

/// @brief Method set_normalizedTime addr 0x2b4cb50 size 0x4c virtual false final false
 void set_normalizedTime(float_t value) ;

/// @brief Method set_speed addr 0x2b4cb9c size 0x4c virtual false final false
 void set_speed(float_t value) ;

/// @brief Method set_layer addr 0x2b4cbe8 size 0x44 virtual false final false
 void set_layer(int32_t value) ;

// Ctor Parameters []
explicit AnimationState() ;

/// @brief Method .ctor addr 0x2b4cc2c size 0x8 virtual false final false
 void _ctor() ;
