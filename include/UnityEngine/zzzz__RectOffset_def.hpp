...
/// @brief Method .ctor addr 0x2b83848 size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2b838b8 size 0x2c virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType sourceStyle, ::cordl_internals::intptr_t source) ;

/// @brief Method Finalize addr 0x2b838e4 size 0xa0 virtual true final false
 void Finalize() ;
...
/// @brief Method .ctor addr 0x2b83a24 size 0x114 virtual false final false
 void _ctor(int32_t left, int32_t right, int32_t top, int32_t bottom) ;

/// @brief Method ToString addr 0x2b83c48 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x2b83c54 size 0x29c virtual true final true
 ::StringW ToString(::StringW format, System::IFormatProvider formatProvider) ;

/// @brief Method Destroy addr 0x2b83984 size 0xa0 virtual false final false
 void Destroy() ;

/// @brief Method InternalCreate addr 0x2b83890 size 0x28 virtual false final false
static ::cordl_internals::intptr_t InternalCreate() ;

/// @brief Method InternalDestroy addr 0x2b83fe0 size 0x3c virtual false final false
static void InternalDestroy(::cordl_internals::intptr_t ptr) ;

/// @brief Method get_left addr 0x2b83ef0 size 0x3c virtual false final false
 int32_t get_left() ;

/// @brief Method set_left addr 0x2b83b38 size 0x44 virtual false final false
 void set_left(int32_t value) ;

/// @brief Method get_right addr 0x2b83f2c size 0x3c virtual false final false
 int32_t get_right() ;

/// @brief Method set_right addr 0x2b83b7c size 0x44 virtual false final false
 void set_right(int32_t value) ;

/// @brief Method get_top addr 0x2b83f68 size 0x3c virtual false final false
 int32_t get_top() ;

/// @brief Method set_top addr 0x2b83bc0 size 0x44 virtual false final false
 void set_top(int32_t value) ;

/// @brief Method get_bottom addr 0x2b83fa4 size 0x3c virtual false final false
 int32_t get_bottom() ;

/// @brief Method set_bottom addr 0x2b83c04 size 0x44 virtual false final false
 void set_bottom(int32_t value) ;

/// @brief Method get_horizontal addr 0x2b8401c size 0x3c virtual false final false
 int32_t get_horizontal() ;

/// @brief Method get_vertical addr 0x2b84058 size 0x3c virtual false final false
 int32_t get_vertical() ;

/// @brief Method Remove addr 0x2b84094 size 0x64 virtual false final false
 UnityEngine::Rect Remove(UnityEngine::Rect rect) ;

/// @brief Method Remove_Injected addr 0x2b840f8 size 0x54 virtual false final false
