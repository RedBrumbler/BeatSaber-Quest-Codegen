...
template<::cordl_internals::il2cpp_reference_type TSubsystem>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15865)), TypeDefinitionIndex(TypeDefinitionIndex(15864))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15865), inst: 2 })
