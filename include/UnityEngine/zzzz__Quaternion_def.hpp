...
/// @brief Method FromToRotation addr 0x2b95f0c size 0x60 virtual false final false
static UnityEngine::Quaternion FromToRotation(UnityEngine::Vector3 fromDirection, UnityEngine::Vector3 toDirection) ;

/// @brief Method Inverse addr 0x2b95fc0 size 0x54 virtual false final false
static UnityEngine::Quaternion Inverse(UnityEngine::Quaternion rotation) ;

/// @brief Method Slerp addr 0x2b96058 size 0x70 virtual false final false
static UnityEngine::Quaternion Slerp(UnityEngine::Quaternion a, UnityEngine::Quaternion b, float_t t) ;

/// @brief Method SlerpUnclamped addr 0x2b9612c size 0x70 virtual false final false
static UnityEngine::Quaternion SlerpUnclamped(UnityEngine::Quaternion a, UnityEngine::Quaternion b, float_t t) ;

/// @brief Method Lerp addr 0x2b96200 size 0x70 virtual false final false
static UnityEngine::Quaternion Lerp(UnityEngine::Quaternion a, UnityEngine::Quaternion b, float_t t) ;

/// @brief Method Internal_FromEulerRad addr 0x2b962d4 size 0x54 virtual false final false
static UnityEngine::Quaternion Internal_FromEulerRad(UnityEngine::Vector3 euler) ;

/// @brief Method Internal_ToEulerRad addr 0x2b9636c size 0x58 virtual false final false
static UnityEngine::Vector3 Internal_ToEulerRad(UnityEngine::Quaternion rotation) ;

/// @brief Method Internal_ToAxisAngleRad addr 0x2b96408 size 0x5c virtual false final false
static void Internal_ToAxisAngleRad(UnityEngine::Quaternion q, ByRef<UnityEngine::Vector3> axis, ByRef<float_t> angle) ;

/// @brief Method AngleAxis addr 0x2b964b8 size 0x64 virtual false final false
static UnityEngine::Quaternion AngleAxis(float_t angle, UnityEngine::Vector3 axis) ;

/// @brief Method LookRotation addr 0x2b96570 size 0x60 virtual false final false
static UnityEngine::Quaternion LookRotation(UnityEngine::Vector3 forward, UnityEngine::Vector3 upwards) ;

/// @brief Method LookRotation addr 0x2b96624 size 0x6c virtual false final false
static UnityEngine::Quaternion LookRotation(UnityEngine::Vector3 forward) ;

/// @brief Method get_Item addr 0x2b96690 size 0x94 virtual false final false
 float_t get_Item(int32_t index) ;

/// @brief Method set_Item addr 0x2b96724 size 0x94 virtual false final false
 void set_Item(int32_t index, float_t value) ;

/// @brief Method .ctor addr 0x2b967b8 size 0xc virtual false final false
 void _ctor(float_t x, float_t y, float_t z, float_t w) ;

/// @brief Method get_identity addr 0x2b967c4 size 0x4c virtual false final false
static UnityEngine::Quaternion get_identity() ;

/// @brief Method op_Multiply addr 0x2b96810 size 0x74 virtual false final false
static UnityEngine::Quaternion op_Multiply(UnityEngine::Quaternion lhs, UnityEngine::Quaternion rhs) ;

/// @brief Method op_Multiply addr 0x2b96884 size 0xa4 virtual false final false
static UnityEngine::Vector3 op_Multiply(UnityEngine::Quaternion rotation, UnityEngine::Vector3 point) ;

/// @brief Method IsEqualUsingDot addr 0x2b96928 size 0x14 virtual false final false
static bool IsEqualUsingDot(float_t dot) ;

/// @brief Method op_Equality addr 0x2b9693c size 0x30 virtual false final false
static bool op_Equality(UnityEngine::Quaternion lhs, UnityEngine::Quaternion rhs) ;

/// @brief Method op_Inequality addr 0x2b9696c size 0x30 virtual false final false
static bool op_Inequality(UnityEngine::Quaternion lhs, UnityEngine::Quaternion rhs) ;

/// @brief Method Dot addr 0x2b9699c size 0x20 virtual false final false
static float_t Dot(UnityEngine::Quaternion a, UnityEngine::Quaternion b) ;

/// @brief Method SetLookRotation addr 0x2b969bc size 0x84 virtual false final false
 void SetLookRotation(UnityEngine::Vector3 view) ;

/// @brief Method SetLookRotation addr 0x2b96a40 size 0x1c virtual false final false
 void SetLookRotation(UnityEngine::Vector3 view, UnityEngine::Vector3 up) ;

/// @brief Method Angle addr 0x2b96a5c size 0x60 virtual false final false
static float_t Angle(UnityEngine::Quaternion a, UnityEngine::Quaternion b) ;

/// @brief Method Internal_MakePositive addr 0x2b96abc size 0x88 virtual false final false
static UnityEngine::Vector3 Internal_MakePositive(UnityEngine::Vector3 euler) ;

/// @brief Method get_eulerAngles addr 0x2b96b44 size 0x2c virtual false final false
 UnityEngine::Vector3 get_eulerAngles() ;

/// @brief Method set_eulerAngles addr 0x2b96b70 size 0x30 virtual false final false
 void set_eulerAngles(UnityEngine::Vector3 value) ;

/// @brief Method Euler addr 0x2b96ba0 size 0x18 virtual false final false
static UnityEngine::Quaternion Euler(float_t x, float_t y, float_t z) ;

/// @brief Method Euler addr 0x2b96bb8 size 0x18 virtual false final false
static UnityEngine::Quaternion Euler(UnityEngine::Vector3 euler) ;

/// @brief Method ToAngleAxis addr 0x2b96bd0 size 0x34 virtual false final false
 void ToAngleAxis(ByRef<float_t> angle, ByRef<UnityEngine::Vector3> axis) ;

/// @brief Method RotateTowards addr 0x2b96c04 size 0x100 virtual false final false
...
/// @brief Method Normalize addr 0x2b96d04 size 0xdc virtual false final false
static UnityEngine::Quaternion Normalize(UnityEngine::Quaternion q) ;

/// @brief Method Normalize addr 0x2b96de0 size 0xc8 virtual false final false
 void Normalize() ;

/// @brief Method GetHashCode addr 0x2b96ea8 size 0x64 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2b96f0c size 0xd4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method Equals addr 0x2b96fe0 size 0x80 virtual true final true
 bool Equals(UnityEngine::Quaternion other) ;

/// @brief Method ToString addr 0x2b97060 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x2b9706c size 0x208 virtual true final true
 ::StringW ToString(::StringW format, System::IFormatProvider formatProvider) ;

/// @brief Method FromToRotation_Injected addr 0x2b95f6c size 0x54 virtual false final false
...
/// @brief Method Inverse_Injected addr 0x2b96014 size 0x44 virtual false final false
static void Inverse_Injected(ByRef<UnityEngine::Quaternion> rotation, ByRef<UnityEngine::Quaternion> ret) ;

/// @brief Method Slerp_Injected addr 0x2b960c8 size 0x64 virtual false final false
...
/// @brief Method SlerpUnclamped_Injected addr 0x2b9619c size 0x64 virtual false final false
...
/// @brief Method Lerp_Injected addr 0x2b96270 size 0x64 virtual false final false
...
/// @brief Method Internal_FromEulerRad_Injected addr 0x2b96328 size 0x44 virtual false final false
static void Internal_FromEulerRad_Injected(ByRef<UnityEngine::Vector3> euler, ByRef<UnityEngine::Quaternion> ret) ;

/// @brief Method Internal_ToEulerRad_Injected addr 0x2b963c4 size 0x44 virtual false final false
static void Internal_ToEulerRad_Injected(ByRef<UnityEngine::Quaternion> rotation, ByRef<UnityEngine::Vector3> ret) ;

/// @brief Method Internal_ToAxisAngleRad_Injected addr 0x2b96464 size 0x54 virtual false final false
...
/// @brief Method AngleAxis_Injected addr 0x2b9651c size 0x54 virtual false final false
static void AngleAxis_Injected(float_t angle, ByRef<UnityEngine::Vector3> axis, ByRef<UnityEngine::Quaternion> ret) ;

/// @brief Method LookRotation_Injected addr 0x2b965d0 size 0x54 virtual false final false
