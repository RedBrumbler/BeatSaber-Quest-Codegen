...
/// @brief Method .ctor addr 0x2b8d270 size 0x80 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit UnityException(::StringW message) ;

/// @brief Method .ctor addr 0x2b8a65c size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x2b8d2f0 size 0x80 virtual false final false
