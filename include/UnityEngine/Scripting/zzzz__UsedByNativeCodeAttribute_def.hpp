...
/// @brief Method .ctor addr 0x2bd3170 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }]
explicit UsedByNativeCodeAttribute(::StringW name) ;

/// @brief Method .ctor addr 0x2bd3178 size 0x28 virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method set_Name addr 0x2bd31a0 size 0x8 virtual false final false
