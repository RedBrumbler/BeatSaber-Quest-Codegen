...
/// @brief Method .ctor addr 0x2bd31a8 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }]
explicit RequiredByNativeCodeAttribute(::StringW name) ;

/// @brief Method .ctor addr 0x2bd31b0 size 0x28 virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method set_Name addr 0x2bd31d8 size 0x8 virtual false final false
 void set_Name(::StringW value) ;

/// @brief Method set_Optional addr 0x2bd31e0 size 0xc virtual false final false
 void set_Optional(bool value) ;

/// @brief Method set_GenerateProxy addr 0x2bd31ec size 0xc virtual false final false
