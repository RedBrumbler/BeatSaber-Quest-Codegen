...
/// @brief Method InvokeSpriteChanged addr 0x2b9e37c size 0xf4 virtual false final false
 void InvokeSpriteChanged() ;

/// @brief Method set_sprite addr 0x2b9e470 size 0x44 virtual false final false
 void set_sprite(UnityEngine::Sprite value) ;

/// @brief Method get_color addr 0x2b9e4b4 size 0x58 virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method set_color addr 0x2b9e550 size 0x54 virtual false final false
 void set_color(UnityEngine::Color value) ;

/// @brief Method get_color_Injected addr 0x2b9e50c size 0x44 virtual false final false
 void get_color_Injected(ByRef<UnityEngine::Color> ret) ;

/// @brief Method set_color_Injected addr 0x2b9e5a4 size 0x44 virtual false final false
