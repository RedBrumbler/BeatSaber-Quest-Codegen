...
/// @brief Method CaptureFrameTimings addr 0x2b7f164 size 0x28 virtual false final false
static void CaptureFrameTimings() ;

/// @brief Method GetLatestTimings addr 0x2b7f18c size 0x44 virtual false final false
