...
/// @brief Method get_x addr 0x2b8414c size 0x8 virtual false final false
 int32_t get_x() ;

/// @brief Method set_x addr 0x2b84154 size 0x8 virtual false final false
 void set_x(int32_t value) ;

/// @brief Method get_y addr 0x2b8415c size 0x8 virtual false final false
 int32_t get_y() ;

/// @brief Method set_y addr 0x2b84164 size 0x8 virtual false final false
 void set_y(int32_t value) ;

/// @brief Method get_width addr 0x2b8416c size 0x8 virtual false final false
 int32_t get_width() ;

/// @brief Method set_width addr 0x2b84174 size 0x8 virtual false final false
 void set_width(int32_t value) ;

/// @brief Method get_height addr 0x2b8417c size 0x8 virtual false final false
 int32_t get_height() ;

/// @brief Method set_height addr 0x2b84184 size 0x8 virtual false final false
 void set_height(int32_t value) ;

/// @brief Method get_xMin addr 0x2b8418c size 0x64 virtual false final false
 int32_t get_xMin() ;

/// @brief Method get_yMin addr 0x2b841f0 size 0x64 virtual false final false
 int32_t get_yMin() ;

/// @brief Method get_xMax addr 0x2b84254 size 0x64 virtual false final false
 int32_t get_xMax() ;

/// @brief Method get_yMax addr 0x2b842b8 size 0x64 virtual false final false
 int32_t get_yMax() ;

/// @brief Method .ctor addr 0x2b8431c size 0xc virtual false final false
 void _ctor(int32_t xMin, int32_t yMin, int32_t width, int32_t height) ;

/// @brief Method Overlaps addr 0x2b84328 size 0x9c virtual false final false
 bool Overlaps(UnityEngine::RectInt other) ;

/// @brief Method ToString addr 0x2b843c4 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x2b843d0 size 0x20c virtual true final true
 ::StringW ToString(::StringW format, System::IFormatProvider formatProvider) ;

/// @brief Method Equals addr 0x2b845dc size 0x44 virtual true final true
