...
/// @brief Method GetUpdateOrder addr 0x2b7d6f0 size 0x118 virtual false final false
static int32_t GetUpdateOrder(UnityEngine::Events::UnityAction callback) ;

/// @brief Method RegisterCallback addr 0x2b7d808 size 0x348 virtual false final false
static void RegisterCallback(UnityEngine::Events::UnityAction callback) ;

/// @brief Method UnregisterCallback addr 0x2b7db50 size 0x310 virtual false final false
static void UnregisterCallback(UnityEngine::Events::UnityAction callback) ;

/// @brief Method Invoke addr 0x2b7de60 size 0x19c virtual false final false
static void Invoke() ;
