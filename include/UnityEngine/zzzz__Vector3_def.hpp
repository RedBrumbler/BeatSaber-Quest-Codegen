...
/// @brief Method Lerp addr 0x2b93610 size 0x3c virtual false final false
static UnityEngine::Vector3 Lerp(UnityEngine::Vector3 a, UnityEngine::Vector3 b, float_t t) ;

/// @brief Method LerpUnclamped addr 0x2b9364c size 0x28 virtual false final false
static UnityEngine::Vector3 LerpUnclamped(UnityEngine::Vector3 a, UnityEngine::Vector3 b, float_t t) ;

/// @brief Method SmoothDamp addr 0x2b93674 size 0x8c virtual false final false
...
/// @brief Method SmoothDamp addr 0x2b93700 size 0x23c virtual false final false
...
/// @brief Method get_Item addr 0x2b9393c size 0x7c virtual false final false
 float_t get_Item(int32_t index) ;

/// @brief Method set_Item addr 0x2b939b8 size 0x7c virtual false final false
 void set_Item(int32_t index, float_t value) ;

/// @brief Method .ctor addr 0x2b93a34 size 0xc virtual false final false
 void _ctor(float_t x, float_t y, float_t z) ;

/// @brief Method .ctor addr 0x2b93a40 size 0xc virtual false final false
 void _ctor(float_t x, float_t y) ;

/// @brief Method Scale addr 0x2b93a4c size 0x10 virtual false final false
static UnityEngine::Vector3 Scale(UnityEngine::Vector3 a, UnityEngine::Vector3 b) ;

/// @brief Method Scale addr 0x2b93a5c size 0x20 virtual false final false
 void Scale(UnityEngine::Vector3 scale) ;

/// @brief Method Cross addr 0x2b93a7c size 0x28 virtual false final false
static UnityEngine::Vector3 Cross(UnityEngine::Vector3 lhs, UnityEngine::Vector3 rhs) ;

/// @brief Method GetHashCode addr 0x2b93aa4 size 0x48 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2b93aec size 0x98 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method Equals addr 0x2b93b84 size 0x30 virtual true final true
 bool Equals(UnityEngine::Vector3 other) ;

/// @brief Method Reflect addr 0x2b93bb4 size 0x38 virtual false final false
static UnityEngine::Vector3 Reflect(UnityEngine::Vector3 inDirection, UnityEngine::Vector3 inNormal) ;

/// @brief Method Normalize addr 0x2b93bec size 0xd0 virtual false final false
static UnityEngine::Vector3 Normalize(UnityEngine::Vector3 value) ;

/// @brief Method Normalize addr 0x2b93cbc size 0xe8 virtual false final false
 void Normalize() ;

/// @brief Method get_normalized addr 0x2b93da4 size 0xcc virtual false final false
 UnityEngine::Vector3 get_normalized() ;

/// @brief Method Dot addr 0x2b93e70 size 0x18 virtual false final false
static float_t Dot(UnityEngine::Vector3 lhs, UnityEngine::Vector3 rhs) ;

/// @brief Method Project addr 0x2b93e88 size 0xfc virtual false final false
static UnityEngine::Vector3 Project(UnityEngine::Vector3 vector, UnityEngine::Vector3 onNormal) ;

/// @brief Method ProjectOnPlane addr 0x2b93f84 size 0xd8 virtual false final false
static UnityEngine::Vector3 ProjectOnPlane(UnityEngine::Vector3 vector, UnityEngine::Vector3 planeNormal) ;

/// @brief Method Angle addr 0x2b9405c size 0x11c virtual false final false
static float_t Angle(UnityEngine::Vector3 from, UnityEngine::Vector3 to) ;

/// @brief Method Distance addr 0x2b94178 size 0xa0 virtual false final false
static float_t Distance(UnityEngine::Vector3 a, UnityEngine::Vector3 b) ;

/// @brief Method ClampMagnitude addr 0x2b94218 size 0xb4 virtual false final false
static UnityEngine::Vector3 ClampMagnitude(UnityEngine::Vector3 vector, float_t maxLength) ;

/// @brief Method Magnitude addr 0x2b942cc size 0x80 virtual false final false
static float_t Magnitude(UnityEngine::Vector3 vector) ;

/// @brief Method get_magnitude addr 0x2b9434c size 0x80 virtual false final false
 float_t get_magnitude() ;

/// @brief Method SqrMagnitude addr 0x2b943cc size 0x18 virtual false final false
static float_t SqrMagnitude(UnityEngine::Vector3 vector) ;

/// @brief Method get_sqrMagnitude addr 0x2b943e4 size 0x20 virtual false final false
 float_t get_sqrMagnitude() ;

/// @brief Method Min addr 0x2b94404 size 0x1c virtual false final false
static UnityEngine::Vector3 Min(UnityEngine::Vector3 lhs, UnityEngine::Vector3 rhs) ;

/// @brief Method Max addr 0x2b94420 size 0x1c virtual false final false
static UnityEngine::Vector3 Max(UnityEngine::Vector3 lhs, UnityEngine::Vector3 rhs) ;

/// @brief Method get_zero addr 0x2b9443c size 0x4c virtual false final false
static UnityEngine::Vector3 get_zero() ;

/// @brief Method get_one addr 0x2b94488 size 0x4c virtual false final false
static UnityEngine::Vector3 get_one() ;

/// @brief Method get_forward addr 0x2b944d4 size 0x4c virtual false final false
static UnityEngine::Vector3 get_forward() ;

/// @brief Method get_back addr 0x2b94520 size 0x4c virtual false final false
static UnityEngine::Vector3 get_back() ;

/// @brief Method get_up addr 0x2b9456c size 0x4c virtual false final false
static UnityEngine::Vector3 get_up() ;

/// @brief Method get_down addr 0x2b945b8 size 0x4c virtual false final false
static UnityEngine::Vector3 get_down() ;

/// @brief Method get_left addr 0x2b94604 size 0x4c virtual false final false
static UnityEngine::Vector3 get_left() ;

/// @brief Method get_right addr 0x2b94650 size 0x4c virtual false final false
static UnityEngine::Vector3 get_right() ;

/// @brief Method get_positiveInfinity addr 0x2b9469c size 0x4c virtual false final false
static UnityEngine::Vector3 get_positiveInfinity() ;

/// @brief Method op_Addition addr 0x2b946e8 size 0x10 virtual false final false
static UnityEngine::Vector3 op_Addition(UnityEngine::Vector3 a, UnityEngine::Vector3 b) ;

/// @brief Method op_Subtraction addr 0x2b946f8 size 0x10 virtual false final false
static UnityEngine::Vector3 op_Subtraction(UnityEngine::Vector3 a, UnityEngine::Vector3 b) ;

/// @brief Method op_UnaryNegation addr 0x2b94708 size 0x10 virtual false final false
static UnityEngine::Vector3 op_UnaryNegation(UnityEngine::Vector3 a) ;

/// @brief Method op_Multiply addr 0x2b94718 size 0x10 virtual false final false
static UnityEngine::Vector3 op_Multiply(UnityEngine::Vector3 a, float_t d) ;

/// @brief Method op_Multiply addr 0x2b94728 size 0x14 virtual false final false
static UnityEngine::Vector3 op_Multiply(float_t d, UnityEngine::Vector3 a) ;

/// @brief Method op_Division addr 0x2b9473c size 0x10 virtual false final false
static UnityEngine::Vector3 op_Division(UnityEngine::Vector3 a, float_t d) ;

/// @brief Method op_Equality addr 0x2b9474c size 0x34 virtual false final false
static bool op_Equality(UnityEngine::Vector3 lhs, UnityEngine::Vector3 rhs) ;

/// @brief Method op_Inequality addr 0x2b94780 size 0x34 virtual false final false
static bool op_Inequality(UnityEngine::Vector3 lhs, UnityEngine::Vector3 rhs) ;

/// @brief Method ToString addr 0x2b947b4 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x2b94988 size 0x8 virtual false final false
 ::StringW ToString(::StringW format) ;

/// @brief Method ToString addr 0x2b947c0 size 0x1c8 virtual true final true
 ::StringW ToString(::StringW format, System::IFormatProvider formatProvider) ;

/// @brief Method Slerp addr 0x2b94990 size 0x74 virtual false final false
static UnityEngine::Vector3 Slerp(UnityEngine::Vector3 a, UnityEngine::Vector3 b, float_t t) ;

/// @brief Method OrthoNormalize2 addr 0x2b94a68 size 0x44 virtual false final false
static void OrthoNormalize2(ByRef<UnityEngine::Vector3> a, ByRef<UnityEngine::Vector3> b) ;

/// @brief Method OrthoNormalize addr 0x2b94aac size 0x44 virtual false final false
static void OrthoNormalize(ByRef<UnityEngine::Vector3> normal, ByRef<UnityEngine::Vector3> tangent) ;

/// @brief Method RotateTowards addr 0x2b94af0 size 0x7c virtual false final false
...
/// @brief Method Slerp_Injected addr 0x2b94a04 size 0x64 virtual false final false
...
/// @brief Method RotateTowards_Injected addr 0x2b94b6c size 0x6c virtual false final false
