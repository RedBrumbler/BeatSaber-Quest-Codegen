...
namespace UnityEngine::AddressableAssets {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14383), inst: 754 }), TypeDefinitionIndex(TypeDefinitionIndex(10036)), TypeDefinitionIndex(TypeDefinitionIndex(14383))}
...
/// @brief Method .ctor addr 0x28c43f8 size 0x58 virtual false final false
