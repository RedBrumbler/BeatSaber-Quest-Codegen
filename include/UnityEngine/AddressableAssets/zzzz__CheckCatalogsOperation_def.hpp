...
/// @brief Method .ctor addr 0x28c5984 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Start>b__5_0 addr 0x28c598c size 0x9c virtual false final false
...
namespace UnityEngine::AddressableAssets {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14333)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3828), inst: 380 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14333), inst: 771 }), TypeDefinitionIndex(TypeDefinitionIndex(3828))}
...
/// @brief Method .ctor addr 0x28c1700 size 0x5c virtual false final false
 void _ctor(UnityEngine::AddressableAssets::AddressablesImpl aa) ;

/// @brief Method Start addr 0x28c175c size 0x5f4 virtual false final false
...
/// @brief Method InvokeWaitForCompletion addr 0x28c4f9c size 0x134 virtual true final false
 bool InvokeWaitForCompletion() ;

/// @brief Method Destroy addr 0x28c50d0 size 0x70 virtual true final false
 void Destroy() ;

/// @brief Method GetDependencies addr 0x28c5140 size 0x124 virtual true final false
...
/// @brief Method ProcessDependentOpResults addr 0x28c5264 size 0x624 virtual false final false
...
/// @brief Method Execute addr 0x28c5888 size 0x98 virtual true final false
 void Execute() ;
