...
namespace UnityEngine::AddressableAssets {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10157)), TypeDefinitionIndex(TypeDefinitionIndex(14383)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14383), inst: 298 })}
...
/// @brief Method .ctor addr 0x28c42f0 size 0x58 virtual false final false
