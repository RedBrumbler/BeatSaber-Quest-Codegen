...
template<::cordl_internals::il2cpp_reference_type TObject>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14390)), TypeDefinitionIndex(TypeDefinitionIndex(14383))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14383), inst: 2 })
