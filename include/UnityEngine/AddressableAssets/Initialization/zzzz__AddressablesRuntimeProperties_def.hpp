...
/// @brief Method GetAssemblies addr 0x28cff14 size 0x20 virtual false final false
static ::ArrayW<System::Reflection::Assembly> GetAssemblies() ;

/// @brief Method GetCachedValueCount addr 0x28cff34 size 0x78 virtual false final false
static int32_t GetCachedValueCount() ;

/// @brief Method SetPropertyValue addr 0x28cffac size 0x90 virtual false final false
static void SetPropertyValue(::StringW name, ::StringW val) ;

/// @brief Method ClearCachedPropertyValues addr 0x28d003c size 0x78 virtual false final false
static void ClearCachedPropertyValues() ;

/// @brief Method EvaluateProperty addr 0x28d00b4 size 0x438 virtual false final false
static ::StringW EvaluateProperty(::StringW name) ;

/// @brief Method EvaluateString addr 0x28bca80 size 0xac virtual false final false
static ::StringW EvaluateString(::StringW input) ;

/// @brief Method EvaluateString addr 0x28d04ec size 0x58c virtual false final false
