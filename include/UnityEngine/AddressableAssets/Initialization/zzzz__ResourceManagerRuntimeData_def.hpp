...
/// @brief Method get_BuildTarget addr 0x28d4388 size 0x8 virtual false final false
 ::StringW get_BuildTarget() ;

/// @brief Method set_BuildTarget addr 0x28d4390 size 0x8 virtual false final false
 void set_BuildTarget(::StringW value) ;

/// @brief Method get_SettingsHash addr 0x28d4398 size 0x8 virtual false final false
 ::StringW get_SettingsHash() ;

/// @brief Method set_SettingsHash addr 0x28d43a0 size 0x8 virtual false final false
 void set_SettingsHash(::StringW value) ;

/// @brief Method get_CatalogLocations addr 0x28d43a8 size 0x8 virtual false final false
...
/// @brief Method get_ProfileEvents addr 0x28d43b0 size 0x8 virtual false final false
 bool get_ProfileEvents() ;

/// @brief Method set_ProfileEvents addr 0x28d43b8 size 0xc virtual false final false
 void set_ProfileEvents(bool value) ;

/// @brief Method get_LogResourceManagerExceptions addr 0x28d43c4 size 0x8 virtual false final false
 bool get_LogResourceManagerExceptions() ;

/// @brief Method set_LogResourceManagerExceptions addr 0x28d43cc size 0xc virtual false final false
 void set_LogResourceManagerExceptions(bool value) ;

/// @brief Method get_InitializationObjects addr 0x28d43d8 size 0x8 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::ResourceManagement::Util::ObjectInitializationData> get_InitializationObjects() ;

/// @brief Method get_DisableCatalogUpdateOnStartup addr 0x28d43e0 size 0x8 virtual false final false
 bool get_DisableCatalogUpdateOnStartup() ;

/// @brief Method set_DisableCatalogUpdateOnStartup addr 0x28d43e8 size 0xc virtual false final false
 void set_DisableCatalogUpdateOnStartup(bool value) ;

/// @brief Method get_IsLocalCatalogInBundle addr 0x28d43f4 size 0x8 virtual false final false
 bool get_IsLocalCatalogInBundle() ;

/// @brief Method set_IsLocalCatalogInBundle addr 0x28d43fc size 0xc virtual false final false
 void set_IsLocalCatalogInBundle(bool value) ;

/// @brief Method get_CertificateHandlerType addr 0x28d4408 size 0xc virtual false final false
 System::Type get_CertificateHandlerType() ;

/// @brief Method set_CertificateHandlerType addr 0x28d4414 size 0xc virtual false final false
 void set_CertificateHandlerType(System::Type value) ;

/// @brief Method get_AddressablesVersion addr 0x28d4420 size 0x8 virtual false final false
 ::StringW get_AddressablesVersion() ;

/// @brief Method set_AddressablesVersion addr 0x28d4428 size 0x8 virtual false final false
 void set_AddressablesVersion(::StringW value) ;

/// @brief Method get_MaxConcurrentWebRequests addr 0x28d4430 size 0x8 virtual false final false
 int32_t get_MaxConcurrentWebRequests() ;

/// @brief Method set_MaxConcurrentWebRequests addr 0x28d4438 size 0x1c virtual false final false
 void set_MaxConcurrentWebRequests(int32_t value) ;

/// @brief Method get_CatalogRequestsTimeout addr 0x28d4454 size 0x8 virtual false final false
 int32_t get_CatalogRequestsTimeout() ;

/// @brief Method set_CatalogRequestsTimeout addr 0x28d445c size 0x1c virtual false final false
 void set_CatalogRequestsTimeout(int32_t value) ;

// Ctor Parameters []
explicit ResourceManagerRuntimeData() ;

/// @brief Method .ctor addr 0x28d4478 size 0xd0 virtual false final false
 void _ctor() ;
