...
namespace UnityEngine::AddressableAssets::Initialization {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14333)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14333), inst: 99 })}
...
/// @brief Method Init addr 0x28d0f20 size 0x8 virtual false final false
 void Init(System::Func_1<bool> callback) ;

/// @brief Method InvokeWaitForCompletion addr 0x28d0f28 size 0x94 virtual true final false
 bool InvokeWaitForCompletion() ;

/// @brief Method Update addr 0x28d0fbc size 0xb4 virtual true final true
 void Update(float_t unscaledDeltaTime) ;

/// @brief Method Execute addr 0x28d1070 size 0x98 virtual true final false
 void Execute() ;

// Ctor Parameters []
explicit UnityEngine__AddressableAssets__Initialization__CacheInitialization__CacheInitOp() ;

/// @brief Method .ctor addr 0x28d0e50 size 0x50 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x28d0e48 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <InitializeAsync>b__0 addr 0x28d1108 size 0x24 virtual false final false
...
/// @brief Method Initialize addr 0x28d0ba8 size 0x14c virtual true final true
 bool Initialize(::StringW id, ::StringW dataStr) ;

/// @brief Method InitializeAsync addr 0x28d0cf4 size 0x154 virtual true final false
...
/// @brief Method get_RootPath addr 0x28d0ea0 size 0x78 virtual false final false
static ::StringW get_RootPath() ;

// Ctor Parameters []
explicit CacheInitialization() ;

/// @brief Method .ctor addr 0x28d0f18 size 0x8 virtual false final false
 void _ctor() ;
