...
/// @brief Method ReadInt32FromByteArray addr 0x28c9d88 size 0x74 virtual false final false
static int32_t ReadInt32FromByteArray(::ArrayW<uint8_t> data, int32_t offset) ;

/// @brief Method WriteInt32ToByteArray addr 0x28c9dfc size 0x84 virtual false final false
static int32_t WriteInt32ToByteArray(::ArrayW<uint8_t> data, int32_t val, int32_t offset) ;

/// @brief Method ReadObjectFromByteArray addr 0x28c9e80 size 0x5a0 virtual false final false
static ::bs_hook::Il2CppWrapperType ReadObjectFromByteArray(::ArrayW<uint8_t> keyData, int32_t dataIndex) ;

/// @brief Method WriteObjectToByteList addr 0x28ca420 size 0xb60 virtual false final false
