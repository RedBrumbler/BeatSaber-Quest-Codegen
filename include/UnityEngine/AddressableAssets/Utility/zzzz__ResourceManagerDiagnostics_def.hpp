...
/// @brief Method .ctor addr 0x28c8fe8 size 0xec virtual false final false
 void _ctor(UnityEngine::ResourceManagement::ResourceManager resourceManager) ;

/// @brief Method SumDependencyNameHashCodes addr 0x28c90d4 size 0x218 virtual false final false
 int32_t SumDependencyNameHashCodes(UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle handle) ;

/// @brief Method CalculateHashCode addr 0x28c92ec size 0x144 virtual false final false
 int32_t CalculateHashCode(UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle handle) ;

/// @brief Method CalculateCompletedOperationHashcode addr 0x28c9430 size 0x8c virtual false final false
 int32_t CalculateCompletedOperationHashcode(UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle handle) ;

/// @brief Method GenerateCompletedOperationDisplayName addr 0x28c94bc size 0x430 virtual false final false
 ::StringW GenerateCompletedOperationDisplayName(UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle handle) ;

/// @brief Method OnResourceManagerDiagnosticEvent addr 0x28c98ec size 0x3c8 virtual false final false
...
/// @brief Method Dispose addr 0x28c9cb4 size 0xd4 virtual true final true
 void Dispose() ;
