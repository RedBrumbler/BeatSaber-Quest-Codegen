...
/// @brief Method get_Keys addr 0x28cf184 size 0x8 virtual false final false
 ::ArrayW<::StringW> get_Keys() ;

/// @brief Method get_InternalId addr 0x28cf18c size 0x8 virtual false final false
 ::StringW get_InternalId() ;

/// @brief Method get_Provider addr 0x28cf194 size 0x8 virtual false final false
 ::StringW get_Provider() ;

/// @brief Method get_Dependencies addr 0x28cf19c size 0x8 virtual false final false
 ::ArrayW<::StringW> get_Dependencies() ;

/// @brief Method get_ResourceType addr 0x28cf1a4 size 0xc virtual false final false
 System::Type get_ResourceType() ;

/// @brief Method get_Data addr 0x28cf1b0 size 0x40 virtual false final false
 ::bs_hook::Il2CppWrapperType get_Data() ;

/// @brief Method set_Data addr 0x28cf1f0 size 0xac virtual false final false
...
/// @brief Method .ctor addr 0x28cf29c size 0x138 virtual false final false
