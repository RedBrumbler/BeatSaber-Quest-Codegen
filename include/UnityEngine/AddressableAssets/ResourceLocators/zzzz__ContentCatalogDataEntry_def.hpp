...
/// @brief Method get_InternalId addr 0x28cd80c size 0x8 virtual false final false
 ::StringW get_InternalId() ;

/// @brief Method set_InternalId addr 0x28cd814 size 0x8 virtual false final false
 void set_InternalId(::StringW value) ;

/// @brief Method get_Provider addr 0x28cd81c size 0x8 virtual false final false
 ::StringW get_Provider() ;

/// @brief Method set_Provider addr 0x28cd824 size 0x8 virtual false final false
 void set_Provider(::StringW value) ;

/// @brief Method get_Keys addr 0x28cd82c size 0x8 virtual false final false
 System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType> get_Keys() ;

/// @brief Method set_Keys addr 0x28cd834 size 0x8 virtual false final false
 void set_Keys(System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType> value) ;

/// @brief Method get_Dependencies addr 0x28cd83c size 0x8 virtual false final false
 System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType> get_Dependencies() ;

/// @brief Method set_Dependencies addr 0x28cd844 size 0x8 virtual false final false
 void set_Dependencies(System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType> value) ;

/// @brief Method get_Data addr 0x28cd84c size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_Data() ;

/// @brief Method set_Data addr 0x28cd854 size 0x8 virtual false final false
 void set_Data(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_ResourceType addr 0x28cd85c size 0x8 virtual false final false
 System::Type get_ResourceType() ;

/// @brief Method set_ResourceType addr 0x28cd864 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x28cd86c size 0x108 virtual false final false
