...
/// @brief Method .ctor addr 0x28ce184 size 0xa0 virtual false final false
 void _ctor(::StringW id, int32_t capacity) ;

/// @brief Method get_LocatorId addr 0x28cf3d4 size 0x8 virtual true final true
 ::StringW get_LocatorId() ;

/// @brief Method set_LocatorId addr 0x28cf3dc size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x28cf3e4 size 0x96c virtual false final false
...
/// @brief Method get_Locations addr 0x28cfeb4 size 0x8 virtual false final false
...
/// @brief Method set_Locations addr 0x28cfebc size 0x8 virtual false final false
...
/// @brief Method get_Keys addr 0x28cfec4 size 0x50 virtual true final true
 System::Collections::Generic::IEnumerable_1<::bs_hook::Il2CppWrapperType> get_Keys() ;

/// @brief Method Locate addr 0x28ce5c0 size 0x86c virtual true final true
...
/// @brief Method Add addr 0x28cfd50 size 0x164 virtual false final false
 void Add(::bs_hook::Il2CppWrapperType key, UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation location) ;

/// @brief Method Add addr 0x28ce418 size 0x68 virtual false final false
