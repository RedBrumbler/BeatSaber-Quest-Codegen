...
/// @brief Method Locate addr 0x28ceec0 size 0x274 virtual true final true
...
/// @brief Method get_Keys addr 0x28cf134 size 0x8 virtual true final true
 System::Collections::Generic::IEnumerable_1<::bs_hook::Il2CppWrapperType> get_Keys() ;

/// @brief Method get_LocatorId addr 0x28cf13c size 0x40 virtual true final true
 ::StringW get_LocatorId() ;

// Ctor Parameters []
explicit LegacyResourcesLocator() ;

/// @brief Method .ctor addr 0x28cf17c size 0x8 virtual false final false
 void _ctor() ;
