...
/// @brief Method get_InternalId addr 0x28ce4fc size 0x8 virtual true final true
 ::StringW get_InternalId() ;

/// @brief Method get_ProviderId addr 0x28ce504 size 0x8 virtual true final true
 ::StringW get_ProviderId() ;

/// @brief Method get_Dependencies addr 0x28ce50c size 0xb4 virtual true final true
 System::Collections::Generic::IList_1<UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation> get_Dependencies() ;

/// @brief Method get_HasDependencies addr 0x28cee2c size 0x10 virtual true final true
 bool get_HasDependencies() ;

/// @brief Method get_DependencyHashCode addr 0x28cee3c size 0x8 virtual true final true
 int32_t get_DependencyHashCode() ;

/// @brief Method get_Data addr 0x28cee44 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType get_Data() ;

/// @brief Method get_PrimaryKey addr 0x28cee4c size 0x8 virtual true final true
 ::StringW get_PrimaryKey() ;

/// @brief Method set_PrimaryKey addr 0x28cee54 size 0x8 virtual false final false
 void set_PrimaryKey(::StringW value) ;

/// @brief Method get_ResourceType addr 0x28cee5c size 0x8 virtual true final true
 System::Type get_ResourceType() ;

/// @brief Method ToString addr 0x28cee64 size 0x8 virtual true final false
 ::StringW ToString() ;

/// @brief Method Hash addr 0x28cee6c size 0x54 virtual true final true
...
/// @brief Method .ctor addr 0x28ce2e4 size 0x134 virtual false final false
...
/// @brief Method get_ProviderId addr 0x28cd974 size 0x8 virtual false final false
 ::StringW get_ProviderId() ;

/// @brief Method set_ProviderId addr 0x28cd97c size 0x8 virtual false final false
 void set_ProviderId(::StringW value) ;

/// @brief Method get_InstanceProviderData addr 0x28cd984 size 0x18 virtual false final false
 UnityEngine::ResourceManagement::Util::ObjectInitializationData get_InstanceProviderData() ;

/// @brief Method set_InstanceProviderData addr 0x28cd99c size 0x18 virtual false final false
 void set_InstanceProviderData(UnityEngine::ResourceManagement::Util::ObjectInitializationData value) ;

/// @brief Method get_SceneProviderData addr 0x28cd9b4 size 0x18 virtual false final false
 UnityEngine::ResourceManagement::Util::ObjectInitializationData get_SceneProviderData() ;

/// @brief Method set_SceneProviderData addr 0x28cd9cc size 0x18 virtual false final false
 void set_SceneProviderData(UnityEngine::ResourceManagement::Util::ObjectInitializationData value) ;

/// @brief Method get_ResourceProviderData addr 0x28cd9e4 size 0x8 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::ResourceManagement::Util::ObjectInitializationData> get_ResourceProviderData() ;

/// @brief Method set_ResourceProviderData addr 0x28cd9ec size 0x8 virtual false final false
...
/// @brief Method get_ProviderIds addr 0x28cd9f4 size 0x8 virtual false final false
 ::ArrayW<::StringW> get_ProviderIds() ;

/// @brief Method get_InternalIds addr 0x28cd9fc size 0x8 virtual false final false
 ::ArrayW<::StringW> get_InternalIds() ;

/// @brief Method CleanData addr 0x28cc238 size 0x58 virtual false final false
 void CleanData() ;

/// @brief Method CreateCustomLocator addr 0x28c6e70 size 0xc virtual false final false
...
/// @brief Method CreateLocator addr 0x28cda04 size 0x780 virtual false final false
 UnityEngine::AddressableAssets::ResourceLocators::ResourceLocationMap CreateLocator(::StringW providerSuffix) ;

/// @brief Method ExpandInternalId addr 0x28ce224 size 0xc0 virtual false final false
static ::StringW ExpandInternalId(::ArrayW<::StringW> internalIdPrefixes, ::StringW v) ;

// Ctor Parameters []
explicit ContentCatalogData() ;

/// @brief Method .ctor addr 0x28ce480 size 0x7c virtual false final false
 void _ctor() ;
