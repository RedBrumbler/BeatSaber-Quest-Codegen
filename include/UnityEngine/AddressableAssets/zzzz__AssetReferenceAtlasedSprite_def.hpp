...
namespace UnityEngine::AddressableAssets {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14383), inst: 753 }), TypeDefinitionIndex(TypeDefinitionIndex(10246)), TypeDefinitionIndex(TypeDefinitionIndex(14383))}
...
/// @brief Method .ctor addr 0x28c44b0 size 0x58 virtual false final false
 void _ctor(::StringW guid) ;

/// @brief Method ValidateAsset addr 0x28c4508 size 0x78 virtual true final false
 bool ValidateAsset(UnityEngine::Object obj) ;

/// @brief Method ValidateAsset addr 0x28c4580 size 0x8 virtual true final false
