...
/// @brief Method .ctor addr 0x28c3074 size 0x84 virtual false final false
 void _ctor(UnityEngine::AddressableAssets::AddressablesImpl aa, bool forceSingleThreading) ;

/// @brief Method Start addr 0x28c30f8 size 0x10c virtual false final false
...
/// @brief Method CompleteInternal addr 0x28c5a28 size 0x90 virtual false final false
 void CompleteInternal(bool result, bool success, ::StringW errorMsg) ;

/// @brief Method InvokeWaitForCompletion addr 0x28c5ab8 size 0xd0 virtual true final false
 bool InvokeWaitForCompletion() ;

/// @brief Method Destroy addr 0x28c5d1c size 0x7c virtual true final false
 void Destroy() ;

/// @brief Method GetDependencies addr 0x28c5d98 size 0x124 virtual true final false
...
/// @brief Method Execute addr 0x28c5ebc size 0x1c0 virtual true final false
 void Execute() ;

/// @brief Method UnityEngine.ResourceManagement.IUpdateReceiver.Update addr 0x28c6dac size 0x40 virtual true final true
 void UnityEngine_ResourceManagement_IUpdateReceiver_Update(float_t unscaledDeltaTime) ;

/// @brief Method RemoveCacheEntries addr 0x28c5b88 size 0x194 virtual false final false
 void RemoveCacheEntries() ;

/// @brief Method DetermineCacheDirsNotInUse addr 0x28c6dec size 0x84 virtual false final false
 void DetermineCacheDirsNotInUse(::bs_hook::Il2CppWrapperType data) ;

/// @brief Method DetermineCacheDirsNotInUse addr 0x28c69ac size 0x400 virtual false final false
 void DetermineCacheDirsNotInUse(System::Collections::Generic::HashSet_1<::StringW> cacheDirsInUse) ;

/// @brief Method GetCacheDirsInUse addr 0x28c607c size 0x930 virtual false final false
