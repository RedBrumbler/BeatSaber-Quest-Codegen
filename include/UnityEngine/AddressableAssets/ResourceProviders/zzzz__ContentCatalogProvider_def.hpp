...
/// @brief Method add_OnLoaded addr 0x28cc474 size 0xb0 virtual false final false
 void add_OnLoaded(System::Action_1<UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogData> value) ;

/// @brief Method remove_OnLoaded addr 0x28cd060 size 0xb0 virtual false final false
 void remove_OnLoaded(System::Action_1<UnityEngine::AddressableAssets::ResourceLocators::ContentCatalogData> value) ;

/// @brief Method get_OpInProgress addr 0x28cd110 size 0x8 virtual false final false
 bool get_OpInProgress() ;

/// @brief Method get_OpIsSuccess addr 0x28cd118 size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0x28cc34c size 0x128 virtual false final false
 void _ctor(::StringW bundlePath, int32_t webRequestTimeout) ;

/// @brief Method Finalize addr 0x28cd138 size 0xa8 virtual true final false
 void Finalize() ;

/// @brief Method Unload addr 0x28cd1e0 size 0x28 virtual false final false
 void Unload() ;

/// @brief Method LoadCatalogFromBundleAsync addr 0x28cc524 size 0x294 virtual false final false
 void LoadCatalogFromBundleAsync() ;

/// @brief Method WebRequestOperationCompleted addr 0x28cd208 size 0x1fc virtual false final false
 void WebRequestOperationCompleted(UnityEngine::AsyncOperation op) ;

/// @brief Method LoadTextAssetRequestComplete addr 0x28cd404 size 0x198 virtual false final false
 void LoadTextAssetRequestComplete(UnityEngine::AsyncOperation op) ;

/// @brief Method WaitForCompletion addr 0x28cc154 size 0xe4 virtual false final false
 bool WaitForCompletion() ;

/// @brief Method <LoadCatalogFromBundleAsync>b__19_1 addr 0x28cd59c size 0x98 virtual false final false
 void _LoadCatalogFromBundleAsync_b__19_1(UnityEngine::Networking::UnityWebRequestAsyncOperation asyncOp) ;

/// @brief Method <LoadCatalogFromBundleAsync>b__19_0 addr 0x28cd634 size 0x1d8 virtual false final false
...
/// @brief Method Start addr 0x28cb268 size 0x17c virtual false final false
...
/// @brief Method WaitForCompletionCallback addr 0x28cc08c size 0xc8 virtual false final false
 bool WaitForCompletionCallback() ;

/// @brief Method Release addr 0x28cb0f4 size 0x10 virtual false final false
 void Release() ;

/// @brief Method CanLoadCatalogFromBundle addr 0x28cbb2c size 0xc4 virtual false final false
...
/// @brief Method LoadCatalog addr 0x28cbbf0 size 0x49c virtual false final false
 void LoadCatalog(::StringW idToLoad, bool loadCatalogFromLocalBundle) ;

/// @brief Method CatalogLoadOpCompleteCallback addr 0x28cc7b8 size 0xe0 virtual false final false
...
/// @brief Method GetTransformedInternalId addr 0x28cc290 size 0xbc virtual false final false
 ::StringW GetTransformedInternalId(UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation loc) ;

/// @brief Method DetermineIdToLoad addr 0x28cb3e4 size 0x748 virtual false final false
...
/// @brief Method OnCatalogLoaded addr 0x28cc898 size 0x7c0 virtual false final false
...
/// @brief Method .ctor addr 0x28cb260 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <LoadCatalog>b__14_0 addr 0x28cd058 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x28caf80 size 0x98 virtual false final false
 void _ctor(UnityEngine::ResourceManagement::ResourceManager resourceManagerInstance) ;

/// @brief Method Release addr 0x28cb018 size 0xdc virtual true final false
 void Release(UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation location, ::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Provide addr 0x28cb104 size 0x15c virtual true final false
