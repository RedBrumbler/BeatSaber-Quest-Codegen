...
/// @brief Method get_labelString addr 0x28c41e4 size 0x8 virtual false final false
 ::StringW get_labelString() ;

/// @brief Method set_labelString addr 0x28c41ec size 0x8 virtual false final false
 void set_labelString(::StringW value) ;

/// @brief Method get_RuntimeKey addr 0x28c41f4 size 0x58 virtual true final true
 ::bs_hook::Il2CppWrapperType get_RuntimeKey() ;

/// @brief Method RuntimeKeyIsValid addr 0x28c424c size 0x7c virtual true final true
 bool RuntimeKeyIsValid() ;

/// @brief Method GetHashCode addr 0x28c42c8 size 0x20 virtual true final false
 int32_t GetHashCode() ;

// Ctor Parameters []
explicit AssetLabelReference() ;

/// @brief Method .ctor addr 0x28c42e8 size 0x8 virtual false final false
 void _ctor() ;
