...
/// @brief Method get_Current addr 0x2b8fae0 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType get_Current() ;

/// @brief Method MoveNext addr 0x2b8fae8 size 0xc virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x2b8faf4 size 0x4 virtual true final false
 void Reset() ;

// Ctor Parameters []
explicit CustomYieldInstruction() ;

/// @brief Method .ctor addr 0x2b89e58 size 0x8 virtual false final false
 void _ctor() ;
