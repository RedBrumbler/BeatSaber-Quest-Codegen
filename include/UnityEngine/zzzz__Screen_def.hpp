...
/// @brief Method get_width addr 0x2b74140 size 0x28 virtual false final false
static int32_t get_width() ;

/// @brief Method get_height addr 0x2b74168 size 0x28 virtual false final false
static int32_t get_height() ;

/// @brief Method get_dpi addr 0x2b74190 size 0x28 virtual false final false
static float_t get_dpi() ;

/// @brief Method GetScreenOrientation addr 0x2b741b8 size 0x28 virtual false final false
static UnityEngine::ScreenOrientation GetScreenOrientation() ;

/// @brief Method get_orientation addr 0x2b741e0 size 0x28 virtual false final false
static UnityEngine::ScreenOrientation get_orientation() ;

/// @brief Method get_currentResolution addr 0x2b74208 size 0x4c virtual false final false
static UnityEngine::Resolution get_currentResolution() ;

/// @brief Method get_fullScreen addr 0x2b74290 size 0x28 virtual false final false
static bool get_fullScreen() ;

/// @brief Method set_fullScreen addr 0x2b742b8 size 0x3c virtual false final false
static void set_fullScreen(bool value) ;

/// @brief Method SetResolution addr 0x2b742f4 size 0x5c virtual false final false
...
/// @brief Method SetResolution addr 0x2b74350 size 0x64 virtual false final false
static void SetResolution(int32_t width, int32_t height, bool fullscreen, int32_t preferredRefreshRate) ;

/// @brief Method SetResolution addr 0x2b743b4 size 0x60 virtual false final false
static void SetResolution(int32_t width, int32_t height, bool fullscreen) ;

/// @brief Method get_resolutions addr 0x2b74414 size 0x28 virtual false final false
static ::ArrayW<UnityEngine::Resolution> get_resolutions() ;

/// @brief Method get_currentResolution_Injected addr 0x2b74254 size 0x3c virtual false final false
