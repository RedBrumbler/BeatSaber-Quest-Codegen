...
/// @brief Method get_isValid addr 0x2b98734 size 0x20 virtual false final false
 bool get_isValid() ;

/// @brief Method CompareTo addr 0x2b98754 size 0x38 virtual true final true
 int32_t CompareTo(UnityEngine::Hash128 rhs) ;

/// @brief Method ToString addr 0x2b987d8 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method Parse addr 0x2b98824 size 0x54 virtual false final false
static UnityEngine::Hash128 Parse(::StringW hashString) ;

/// @brief Method Hash128ToStringImpl addr 0x2b987e4 size 0x40 virtual false final false
static ::StringW Hash128ToStringImpl(UnityEngine::Hash128 hash) ;

/// @brief Method ComputeFromString addr 0x2b988f8 size 0x44 virtual false final false
static void ComputeFromString(::StringW data, ByRef<UnityEngine::Hash128> hash) ;

/// @brief Method Compute addr 0x2b9893c size 0x54 virtual false final false
static UnityEngine::Hash128 Compute(::StringW data) ;

/// @brief Method Equals addr 0x2b98990 size 0x84 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2b98a2c size 0x1c virtual true final true
 bool Equals(UnityEngine::Hash128 obj) ;

/// @brief Method GetHashCode addr 0x2b98a48 size 0x34 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method CompareTo addr 0x2b98a7c size 0xa4 virtual true final true
 int32_t CompareTo(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method op_Equality addr 0x2b98a14 size 0x18 virtual false final false
static bool op_Equality(UnityEngine::Hash128 hash1, UnityEngine::Hash128 hash2) ;

/// @brief Method op_LessThan addr 0x2b9878c size 0x18 virtual false final false
static bool op_LessThan(UnityEngine::Hash128 x, UnityEngine::Hash128 y) ;

/// @brief Method op_GreaterThan addr 0x2b987a4 size 0x34 virtual false final false
static bool op_GreaterThan(UnityEngine::Hash128 x, UnityEngine::Hash128 y) ;

/// @brief Method Parse_Injected addr 0x2b98878 size 0x44 virtual false final false
static void Parse_Injected(::StringW hashString, ByRef<UnityEngine::Hash128> ret) ;

/// @brief Method Hash128ToStringImpl_Injected addr 0x2b988bc size 0x3c virtual false final false
