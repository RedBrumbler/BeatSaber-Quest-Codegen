...
namespace UnityEngine {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14802))}
...
/// @brief Method .ctor addr 0x2bc5fbc size 0x60 virtual false final false
 void _ctor() ;

/// @brief Method CalcWidth addr 0x2bc601c size 0x80 virtual true final false
 void CalcWidth() ;

/// @brief Method SetHorizontal addr 0x2bc609c size 0x12c virtual true final false
 void SetHorizontal(float_t x, float_t width) ;

/// @brief Method CalcHeight addr 0x2bc62ac size 0x100 virtual true final false
 void CalcHeight() ;

/// @brief Method SetVertical addr 0x2bc63e8 size 0x218 virtual true final false
