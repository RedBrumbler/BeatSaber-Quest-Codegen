...
/// @brief Method set_textColor addr 0x2bc6600 size 0x54 virtual false final false
 void set_textColor(UnityEngine::Color value) ;

/// @brief Method Init addr 0x2bc6698 size 0x28 virtual false final false
static ::cordl_internals::intptr_t Init() ;

/// @brief Method Cleanup addr 0x2bc66c0 size 0x3c virtual false final false
 void Cleanup() ;

// Ctor Parameters []
explicit GUIStyleState() ;

/// @brief Method .ctor addr 0x2bc66fc size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2bc6744 size 0x2c virtual false final false
 void _ctor(UnityEngine::GUIStyle sourceStyle, ::cordl_internals::intptr_t source) ;

/// @brief Method GetGUIStyleState addr 0x2bc6770 size 0x70 virtual false final false
static UnityEngine::GUIStyleState GetGUIStyleState(UnityEngine::GUIStyle sourceStyle, ::cordl_internals::intptr_t source) ;

/// @brief Method Finalize addr 0x2bc67e0 size 0xf8 virtual true final false
 void Finalize() ;

/// @brief Method set_textColor_Injected addr 0x2bc6654 size 0x44 virtual false final false
