...
/// @brief Method set_menuName addr 0x2b8d428 size 0x8 virtual false final false
 void set_menuName(::StringW value) ;

/// @brief Method set_fileName addr 0x2b8d430 size 0x8 virtual false final false
 void set_fileName(::StringW value) ;

// Ctor Parameters []
explicit CreateAssetMenuAttribute() ;

/// @brief Method .ctor addr 0x2b8d438 size 0x8 virtual false final false
 void _ctor() ;
