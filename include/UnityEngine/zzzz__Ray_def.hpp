...
/// @brief Method .ctor addr 0x2b86bb4 size 0xec virtual false final false
 void _ctor(UnityEngine::Vector3 origin, UnityEngine::Vector3 direction) ;

/// @brief Method get_origin addr 0x2b84ba8 size 0xc virtual false final false
 UnityEngine::Vector3 get_origin() ;

/// @brief Method set_origin addr 0x2b86ca0 size 0xc virtual false final false
 void set_origin(UnityEngine::Vector3 value) ;

/// @brief Method get_direction addr 0x2b84b9c size 0xc virtual false final false
 UnityEngine::Vector3 get_direction() ;

/// @brief Method set_direction addr 0x2b86cac size 0xe4 virtual false final false
 void set_direction(UnityEngine::Vector3 value) ;

/// @brief Method GetPoint addr 0x2b86d90 size 0x28 virtual false final false
 UnityEngine::Vector3 GetPoint(float_t distance) ;

/// @brief Method ToString addr 0x2b86db8 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x2b86dc4 size 0x188 virtual true final true
