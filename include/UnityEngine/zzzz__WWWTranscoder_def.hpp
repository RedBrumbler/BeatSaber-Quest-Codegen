...
/// @brief Method Hex2Byte addr 0x2d66b50 size 0xac virtual false final false
static uint8_t Hex2Byte(::ArrayW<uint8_t> b, int32_t offset) ;

/// @brief Method Byte2Hex addr 0x2d66bfc size 0x54 virtual false final false
static void Byte2Hex(uint8_t b, ::ArrayW<uint8_t> hexChars, ByRef<uint8_t> byte0, ByRef<uint8_t> byte1) ;

/// @brief Method URLEncode addr 0x2d66c50 size 0x6c virtual false final false
static ::ArrayW<uint8_t> URLEncode(::ArrayW<uint8_t> toEncode) ;

/// @brief Method Encode addr 0x2d66cbc size 0x3ac virtual false final false
...
/// @brief Method ByteArrayContains addr 0x2d67068 size 0x4c virtual false final false
static bool ByteArrayContains(::ArrayW<uint8_t> array, uint8_t b) ;

/// @brief Method URLDecode addr 0x2d6681c size 0x64 virtual false final false
static ::ArrayW<uint8_t> URLDecode(::ArrayW<uint8_t> toEncode) ;

/// @brief Method ByteSubArrayEquals addr 0x2d67394 size 0x78 virtual false final false
static bool ByteSubArrayEquals(::ArrayW<uint8_t> array, int32_t index, ::ArrayW<uint8_t> comperand) ;

/// @brief Method Decode addr 0x2d670b4 size 0x2e0 virtual false final false
