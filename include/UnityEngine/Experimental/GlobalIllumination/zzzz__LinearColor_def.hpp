...
/// @brief Method get_red addr 0x2ba9e70 size 0x8 virtual false final false
 float_t get_red() ;

/// @brief Method set_red addr 0x2ba9e78 size 0xb4 virtual false final false
 void set_red(float_t value) ;

/// @brief Method get_green addr 0x2ba9f2c size 0x8 virtual false final false
 float_t get_green() ;

/// @brief Method set_green addr 0x2ba9f34 size 0xb4 virtual false final false
 void set_green(float_t value) ;

/// @brief Method get_blue addr 0x2ba9fe8 size 0x8 virtual false final false
 float_t get_blue() ;

/// @brief Method set_blue addr 0x2ba9ff0 size 0xb4 virtual false final false
 void set_blue(float_t value) ;

/// @brief Method Convert addr 0x2baa0a4 size 0x3d4 virtual false final false
static UnityEngine::Experimental::GlobalIllumination::LinearColor Convert(UnityEngine::Color color, float_t intensity) ;

/// @brief Method Black addr 0x2baa478 size 0x1014 virtual false final false
