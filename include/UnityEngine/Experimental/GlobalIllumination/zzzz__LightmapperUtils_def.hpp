...
/// @brief Method Extract addr 0x2bab6cc size 0x20 virtual false final false
static UnityEngine::Experimental::GlobalIllumination::LightMode Extract(UnityEngine::LightmapBakeType baketype) ;

/// @brief Method ExtractIndirect addr 0x2bab6ec size 0x7c virtual false final false
static UnityEngine::Experimental::GlobalIllumination::LinearColor ExtractIndirect(UnityEngine::Light l) ;

/// @brief Method ExtractInnerCone addr 0x2bab768 size 0x54 virtual false final false
static float_t ExtractInnerCone(UnityEngine::Light l) ;

/// @brief Method ExtractColorTemperature addr 0x2bab7bc size 0x74 virtual false final false
static UnityEngine::Color ExtractColorTemperature(UnityEngine::Light l) ;

/// @brief Method ApplyColorTemperature addr 0x2bab830 size 0x78 virtual false final false
