...
/// @brief Method GetGraphicsFormat addr 0x2bacb60 size 0x84 virtual false final false
static UnityEngine::Experimental::Rendering::GraphicsFormat GetGraphicsFormat(UnityEngine::TextureFormat format, bool isSRGB) ;

/// @brief Method GetGraphicsFormat_Native_TextureFormat addr 0x2bacbe4 size 0x44 virtual false final false
...
/// @brief Method GetGraphicsFormat addr 0x2bacc28 size 0x84 virtual false final false
...
/// @brief Method GetGraphicsFormat_Native_RenderTextureFormat addr 0x2baccac size 0x44 virtual false final false
...
/// @brief Method GetGraphicsFormat addr 0x2baccf0 size 0x88 virtual false final false
...
/// @brief Method GetDepthStencilFormatFromBitsLegacy_Native addr 0x2bacd78 size 0x3c virtual false final false
...
/// @brief Method GetDepthStencilFormat addr 0x2bacdb4 size 0x74 virtual false final false
static UnityEngine::Experimental::Rendering::GraphicsFormat GetDepthStencilFormat(int32_t minimumDepthBits) ;

/// @brief Method GetDepthBits addr 0x2bace28 size 0x3c virtual false final false
static int32_t GetDepthBits(UnityEngine::Experimental::Rendering::GraphicsFormat format) ;

/// @brief Method GetDepthStencilFormat addr 0x2bace64 size 0x1f4 virtual false final false
...
/// @brief Method IsSRGBFormat addr 0x2bad058 size 0x3c virtual false final false
static bool IsSRGBFormat(UnityEngine::Experimental::Rendering::GraphicsFormat format) ;

/// @brief Method GetRenderTextureFormat addr 0x2bad094 size 0x3c virtual false final false
static UnityEngine::RenderTextureFormat GetRenderTextureFormat(UnityEngine::Experimental::Rendering::GraphicsFormat format) ;

/// @brief Method IsCompressedTextureFormat addr 0x2bad0d0 size 0x3c virtual false final false
static bool IsCompressedTextureFormat(UnityEngine::TextureFormat format) ;

/// @brief Method CanDecompressFormat addr 0x2bad10c size 0x44 virtual false final false
static bool CanDecompressFormat(UnityEngine::Experimental::Rendering::GraphicsFormat format, bool wholeImage) ;

/// @brief Method CanDecompressFormat addr 0x2bad150 size 0x78 virtual false final false
static bool CanDecompressFormat(UnityEngine::Experimental::Rendering::GraphicsFormat format) ;

/// @brief Method IsDepthFormat addr 0x2bad1c8 size 0x3c virtual false final false
static bool IsDepthFormat(UnityEngine::Experimental::Rendering::GraphicsFormat format) ;

/// @brief Method IsStencilFormat addr 0x2bad204 size 0x3c virtual false final false
static bool IsStencilFormat(UnityEngine::Experimental::Rendering::GraphicsFormat format) ;

/// @brief Method IsPVRTCFormat addr 0x2bad240 size 0x3c virtual false final false
static bool IsPVRTCFormat(UnityEngine::Experimental::Rendering::GraphicsFormat format) ;

/// @brief Method IsCrunchFormat addr 0x2bad27c size 0x24 virtual false final false
