...
/// @brief Method GetPoseFromProvider addr 0x2bd5034 size 0x24 virtual true final false
 UnityEngine::SpatialTracking::PoseDataFlags GetPoseFromProvider(ByRef<UnityEngine::Pose> output) ;

/// @brief Method TryGetPoseFromProvider addr 0x2bd5058 size 0x88 virtual true final false
 bool TryGetPoseFromProvider(ByRef<UnityEngine::Pose> output) ;

// Ctor Parameters []
explicit BasePoseProvider() ;

/// @brief Method .ctor addr 0x2bd50e0 size 0x8 virtual false final false
 void _ctor() ;
