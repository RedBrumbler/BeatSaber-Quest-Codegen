...
/// @brief Method get_glyphIndex addr 0x2bdda5c size 0x8 virtual false final false
 uint32_t get_glyphIndex() ;

/// @brief Method get_glyphValueRecord addr 0x2bdda64 size 0xc virtual false final false
 UnityEngine::TextCore::LowLevel::GlyphValueRecord get_glyphValueRecord() ;

/// @brief Method GetHashCode addr 0x2bdda70 size 0x6c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2bddadc size 0x80 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2bddb5c size 0xa4 virtual true final true
