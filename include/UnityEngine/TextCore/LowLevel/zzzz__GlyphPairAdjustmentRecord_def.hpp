...
/// @brief Method get_firstAdjustmentRecord addr 0x2bddc00 size 0x14 virtual false final false
 UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord get_firstAdjustmentRecord() ;

/// @brief Method get_secondAdjustmentRecord addr 0x2bddc14 size 0x14 virtual false final false
 UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord get_secondAdjustmentRecord() ;

/// @brief Method GetHashCode addr 0x2bddc28 size 0x6c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2bddc94 size 0x80 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2bddd14 size 0xa4 virtual true final true
