...
/// @brief Method get_width addr 0x2bdb7d0 size 0x8 virtual false final false
 float_t get_width() ;

/// @brief Method get_height addr 0x2bdb7d8 size 0x8 virtual false final false
 float_t get_height() ;

/// @brief Method get_horizontalBearingX addr 0x2bdb7e0 size 0x8 virtual false final false
 float_t get_horizontalBearingX() ;

/// @brief Method get_horizontalBearingY addr 0x2bdb7e8 size 0x8 virtual false final false
 float_t get_horizontalBearingY() ;

/// @brief Method get_horizontalAdvance addr 0x2bdb7f0 size 0x8 virtual false final false
 float_t get_horizontalAdvance() ;

/// @brief Method .ctor addr 0x2bdb7f8 size 0x10 virtual false final false
 void _ctor(float_t width, float_t height, float_t bearingX, float_t bearingY, float_t advance) ;

/// @brief Method GetHashCode addr 0x2bdb808 size 0x6c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2bdb874 size 0x80 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2bdb8f4 size 0xa4 virtual true final true
