...
/// @brief Method get_x addr 0x2bdb594 size 0x8 virtual false final false
 int32_t get_x() ;

/// @brief Method get_y addr 0x2bdb59c size 0x8 virtual false final false
 int32_t get_y() ;

/// @brief Method get_width addr 0x2bdb5a4 size 0x8 virtual false final false
 int32_t get_width() ;

/// @brief Method get_height addr 0x2bdb5ac size 0x8 virtual false final false
 int32_t get_height() ;

/// @brief Method get_zero addr 0x2bdb5b4 size 0x58 virtual false final false
static UnityEngine::TextCore::GlyphRect get_zero() ;

/// @brief Method .ctor addr 0x2bdb60c size 0xc virtual false final false
 void _ctor(int32_t x, int32_t y, int32_t width, int32_t height) ;

/// @brief Method GetHashCode addr 0x2bdb618 size 0x64 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2bdb67c size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2bdb6f4 size 0x94 virtual true final true
