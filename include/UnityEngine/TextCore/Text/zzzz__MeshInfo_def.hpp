...
/// @brief Method .ctor addr 0x2c05508 size 0x354 virtual false final false
 void _ctor(int32_t size) ;

/// @brief Method ResizeMeshInfo addr 0x2c0585c size 0x1e8 virtual false final false
 void ResizeMeshInfo(int32_t size) ;

/// @brief Method Clear addr 0x2c02194 size 0x2c virtual false final false
 void Clear(bool uploadChanges) ;

/// @brief Method ClearUnusedVertices addr 0x2c05a44 size 0x3c virtual false final false
 void ClearUnusedVertices() ;

/// @brief Method SortGeometry addr 0x2c05a80 size 0x7c virtual false final false
 void SortGeometry(UnityEngine::TextCore::Text::VertexSortingOrder order) ;

/// @brief Method SwapVertexData addr 0x2c05afc size 0x58c virtual false final false
