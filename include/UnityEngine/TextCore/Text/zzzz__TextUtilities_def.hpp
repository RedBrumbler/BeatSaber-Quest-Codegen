...
/// @brief Method ToUpperFast addr 0x2bfe4fc size 0x74 virtual false final false
static char16_t ToUpperFast(char16_t c) ;

/// @brief Method ToUpperASCIIFast addr 0x2bfe570 size 0x74 virtual false final false
static uint32_t ToUpperASCIIFast(uint32_t c) ;

/// @brief Method GetHashCodeCaseInSensitive addr 0x2bf2a10 size 0x70 virtual false final false
static int32_t GetHashCodeCaseInSensitive(::StringW s) ;

/// @brief Method UintToString addr 0x2bf8e9c size 0xd8 virtual false final false
