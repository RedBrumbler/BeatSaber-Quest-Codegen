...
/// @brief Method Approximately addr 0x2bfe8f4 size 0x30 virtual false final false
static bool Approximately(float_t a, float_t b) ;

/// @brief Method HexCharsToColor addr 0x2bfe924 size 0x5bc virtual false final false
static UnityEngine::Color32 HexCharsToColor(::ArrayW<char16_t> hexChars, int32_t tagCount) ;

/// @brief Method HexCharsToColor addr 0x2bfef0c size 0x284 virtual false final false
static UnityEngine::Color32 HexCharsToColor(::ArrayW<char16_t> hexChars, int32_t startIndex, int32_t length) ;

/// @brief Method HexToInt addr 0x2bfeee0 size 0x2c virtual false final false
static int32_t HexToInt(char16_t hex) ;

/// @brief Method ConvertToFloat addr 0x2bff190 size 0x80 virtual false final false
static float_t ConvertToFloat(::ArrayW<char16_t> chars, int32_t startIndex, int32_t length) ;

/// @brief Method ConvertToFloat addr 0x2bff210 size 0x164 virtual false final false
static float_t ConvertToFloat(::ArrayW<char16_t> chars, int32_t startIndex, int32_t length, ByRef<int32_t> lastIndex) ;

/// @brief Method PackUV addr 0x2bff374 size 0x60 virtual false final false
static UnityEngine::Vector2 PackUV(float_t x, float_t y, float_t scale) ;

/// @brief Method StringToCharArray addr 0x2bff3d4 size 0x848 virtual false final false
...
/// @brief Method IsTagName addr 0x2bffe14 size 0xa8 virtual false final false
static bool IsTagName(ByRef<::StringW> text, ::StringW tag, int32_t index) ;

/// @brief Method IsTagName addr 0x2c00518 size 0xcc virtual false final false
static bool IsTagName(ByRef<::ArrayW<int32_t>> text, ::StringW tag, int32_t index) ;

/// @brief Method ReplaceOpeningStyleTag addr 0x2c005e4 size 0x334 virtual false final false
...
/// @brief Method ReplaceOpeningStyleTag addr 0x2bffebc size 0x334 virtual false final false
static bool ReplaceOpeningStyleTag(ByRef<::StringW> sourceText, int32_t srcIndex, ByRef<int32_t> srcOffset, ByRef<::ArrayW<int32_t>> charBuffer, ByRef<int32_t> writeIndex, ByRef<UnityEngine::TextCore::Text::TextProcessingStack_1<int32_t>> styleStack, ByRef<UnityEngine::TextCore::Text::TextGenerationSettings> generationSettings) ;

/// @brief Method ReplaceClosingStyleTag addr 0x2c001f0 size 0x328 virtual false final false
...
/// @brief Method GetStyle addr 0x2c009ac size 0xec virtual false final false
...
/// @brief Method GetUtf32 addr 0x2bffc1c size 0x12c virtual false final false
static int32_t GetUtf32(::StringW text, int32_t i) ;

/// @brief Method GetUtf16 addr 0x2bffd48 size 0xcc virtual false final false
static int32_t GetUtf16(::StringW text, int32_t i) ;

/// @brief Method GetTagHashCode addr 0x2c00918 size 0x94 virtual false final false
static int32_t GetTagHashCode(ByRef<::ArrayW<int32_t>> text, int32_t index, ByRef<int32_t> closeIndex) ;

/// @brief Method GetTagHashCode addr 0x2c00a98 size 0xb8 virtual false final false
static int32_t GetTagHashCode(ByRef<::StringW> text, int32_t index, ByRef<int32_t> closeIndex) ;

/// @brief Method FillCharacterVertexBuffers addr 0x2c00b50 size 0x880 virtual false final false
...
/// @brief Method FillSpriteVertexBuffers addr 0x2c013d0 size 0x7f0 virtual false final false
...
/// @brief Method AdjustLineOffset addr 0x2c01bc0 size 0x180 virtual false final false
...
/// @brief Method ResizeLineExtents addr 0x2c01d40 size 0x1ac virtual false final false
static void ResizeLineExtents(int32_t size, UnityEngine::TextCore::Text::TextInfo textInfo) ;

/// @brief Method LegacyStyleToNewStyle addr 0x2c01eec size 0x10 virtual false final false
static UnityEngine::TextCore::Text::FontStyles LegacyStyleToNewStyle(UnityEngine::FontStyle fontStyle) ;

/// @brief Method LegacyAlignmentToNewAlignment addr 0x2c01efc size 0x24 virtual false final false
