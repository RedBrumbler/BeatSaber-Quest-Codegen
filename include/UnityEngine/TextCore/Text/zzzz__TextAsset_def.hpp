...
/// @brief Method get_version addr 0x2c04704 size 0x8 virtual false final false
 ::StringW get_version() ;

/// @brief Method set_version addr 0x2c0470c size 0x8 virtual false final false
 void set_version(::StringW value) ;

/// @brief Method get_instanceID addr 0x2c042fc size 0x28 virtual false final false
 int32_t get_instanceID() ;

/// @brief Method get_hashCode addr 0x2c04324 size 0x30 virtual false final false
 int32_t get_hashCode() ;

/// @brief Method set_hashCode addr 0x2c04714 size 0x8 virtual false final false
 void set_hashCode(int32_t value) ;

/// @brief Method get_material addr 0x2c0471c size 0x8 virtual false final false
 UnityEngine::Material get_material() ;

/// @brief Method set_material addr 0x2c04724 size 0x8 virtual false final false
 void set_material(UnityEngine::Material value) ;

/// @brief Method get_materialHashCode addr 0x2c0472c size 0x98 virtual false final false
 int32_t get_materialHashCode() ;

/// @brief Method set_materialHashCode addr 0x2c047c4 size 0x8 virtual false final false
 void set_materialHashCode(int32_t value) ;

// Ctor Parameters []
explicit TextAsset() ;

/// @brief Method .ctor addr 0x2c047cc size 0x8 virtual false final false
 void _ctor() ;
