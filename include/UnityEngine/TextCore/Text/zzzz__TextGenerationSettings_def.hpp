...
/// @brief Method Equals addr 0x2bfb850 size 0x3b4 virtual false final false
 bool Equals(UnityEngine::TextCore::Text::TextGenerationSettings other) ;

/// @brief Method Equals addr 0x2bfbc04 size 0xc8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2bfbccc size 0x56c virtual true final false
 int32_t GetHashCode() ;

// Ctor Parameters []
explicit TextGenerationSettings() ;

/// @brief Method .ctor addr 0x2bfc238 size 0x5c virtual false final false
 void _ctor() ;
