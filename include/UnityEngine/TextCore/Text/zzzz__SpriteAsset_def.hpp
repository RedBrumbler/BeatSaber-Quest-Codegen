...
/// @brief Method .ctor addr 0x2bfd7b4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SortGlyphTable>b__37_0 addr 0x2bfd7bc size 0x18 virtual false final false
 uint32_t _SortGlyphTable_b__37_0(UnityEngine::TextCore::Text::SpriteGlyph item) ;

/// @brief Method <SortCharacterTable>b__38_0 addr 0x2bfd7d4 size 0x18 virtual false final false
...
/// @brief Method get_faceInfo addr 0x2bfc388 size 0x1c virtual false final false
 UnityEngine::TextCore::FaceInfo get_faceInfo() ;

/// @brief Method set_faceInfo addr 0x2bfc3a4 size 0x18 virtual false final false
 void set_faceInfo(UnityEngine::TextCore::FaceInfo value) ;

/// @brief Method get_spriteSheet addr 0x2bfc3bc size 0x8 virtual false final false
 UnityEngine::Texture get_spriteSheet() ;

/// @brief Method set_spriteSheet addr 0x2bfc3c4 size 0x8 virtual false final false
 void set_spriteSheet(UnityEngine::Texture value) ;

/// @brief Method get_spriteCharacterTable addr 0x2bfc3cc size 0x24 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::TextCore::Text::SpriteCharacter> get_spriteCharacterTable() ;

/// @brief Method set_spriteCharacterTable addr 0x2bfc8cc size 0x8 virtual false final false
 void set_spriteCharacterTable(System::Collections::Generic::List_1<UnityEngine::TextCore::Text::SpriteCharacter> value) ;

/// @brief Method get_spriteCharacterLookupTable addr 0x2bfc8d4 size 0x24 virtual false final false
...
/// @brief Method set_spriteCharacterLookupTable addr 0x2bfc8f8 size 0x8 virtual false final false
...
/// @brief Method get_spriteGlyphTable addr 0x2bfc900 size 0x8 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::TextCore::Text::SpriteGlyph> get_spriteGlyphTable() ;

/// @brief Method set_spriteGlyphTable addr 0x2bfc908 size 0x8 virtual false final false
 void set_spriteGlyphTable(System::Collections::Generic::List_1<UnityEngine::TextCore::Text::SpriteGlyph> value) ;

/// @brief Method Awake addr 0x2bfc910 size 0x4 virtual false final false
 void Awake() ;

/// @brief Method UpdateLookupTables addr 0x2bfc3f0 size 0x4dc virtual false final false
 void UpdateLookupTables() ;

/// @brief Method GetSpriteIndexFromHashcode addr 0x2bfc914 size 0x88 virtual false final false
 int32_t GetSpriteIndexFromHashcode(int32_t hashCode) ;

/// @brief Method GetSpriteIndexFromUnicode addr 0x2bfc99c size 0x94 virtual false final false
 int32_t GetSpriteIndexFromUnicode(uint32_t unicode) ;

/// @brief Method GetSpriteIndexFromName addr 0x2bfca30 size 0x3c virtual false final false
 int32_t GetSpriteIndexFromName(::StringW name) ;

/// @brief Method SearchForSpriteByUnicode addr 0x2bfca6c size 0x1c8 virtual false final false
...
/// @brief Method SearchForSpriteByUnicodeInternal addr 0x2bfcc34 size 0x1a0 virtual false final false
...
/// @brief Method SearchForSpriteByUnicodeInternal addr 0x2bfcdd4 size 0xb0 virtual false final false
...
/// @brief Method SearchForSpriteByHashCode addr 0x2bfce84 size 0x32c virtual false final false
...
/// @brief Method SearchForSpriteByHashCodeInternal addr 0x2bfd1b0 size 0x1a0 virtual false final false
...
/// @brief Method SearchForSpriteByHashCodeInternal addr 0x2bfd350 size 0xb0 virtual false final false
...
/// @brief Method SortGlyphTable addr 0x2bfd400 size 0x138 virtual false final false
 void SortGlyphTable() ;

/// @brief Method SortCharacterTable addr 0x2bfd538 size 0x13c virtual false final false
 void SortCharacterTable() ;

/// @brief Method SortGlyphAndCharacterTables addr 0x2bfd674 size 0x18 virtual false final false
 void SortGlyphAndCharacterTables() ;

// Ctor Parameters []
explicit SpriteAsset() ;

/// @brief Method .ctor addr 0x2bfd68c size 0xc4 virtual false final false
 void _ctor() ;
