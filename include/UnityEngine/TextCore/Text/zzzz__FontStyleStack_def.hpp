...
/// @brief Method Clear addr 0x2c047fc size 0xc virtual false final false
 void Clear() ;

/// @brief Method Add addr 0x2c04808 size 0xfc virtual false final false
 uint8_t Add(UnityEngine::TextCore::Text::FontStyles style) ;

/// @brief Method Remove addr 0x2c04904 size 0x120 virtual false final false
