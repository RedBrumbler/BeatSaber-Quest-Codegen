...
/// @brief Method GetFallbackMaterial addr 0x2bfda98 size 0x360 virtual false final false
static UnityEngine::Material GetFallbackMaterial(UnityEngine::Material sourceMaterial, UnityEngine::Material targetMaterial) ;

/// @brief Method GetFallbackMaterial addr 0x2bfddf8 size 0x1d0 virtual false final false
