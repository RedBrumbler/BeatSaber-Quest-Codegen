...
/// @brief Method get_elementType addr 0x2bfe8dc size 0x8 virtual false final false
 UnityEngine::TextCore::Text::TextElementType get_elementType() ;

/// @brief Method get_unicode addr 0x2bf45c4 size 0x8 virtual false final false
 uint32_t get_unicode() ;

/// @brief Method set_unicode addr 0x2bfe4ec size 0x8 virtual false final false
 void set_unicode(uint32_t value) ;

/// @brief Method get_textAsset addr 0x2bfc380 size 0x8 virtual false final false
 UnityEngine::TextCore::Text::TextAsset get_textAsset() ;

/// @brief Method set_textAsset addr 0x2bf45cc size 0x8 virtual false final false
 void set_textAsset(UnityEngine::TextCore::Text::TextAsset value) ;

/// @brief Method get_glyph addr 0x2bfe8e4 size 0x8 virtual false final false
 UnityEngine::TextCore::Glyph get_glyph() ;

/// @brief Method set_glyph addr 0x2bf45d4 size 0x8 virtual false final false
 void set_glyph(UnityEngine::TextCore::Glyph value) ;

/// @brief Method get_glyphIndex addr 0x2bf3f5c size 0x8 virtual false final false
 uint32_t get_glyphIndex() ;

/// @brief Method set_glyphIndex addr 0x2bfe4f4 size 0x8 virtual false final false
 void set_glyphIndex(uint32_t value) ;

/// @brief Method get_scale addr 0x2bfe8ec size 0x8 virtual false final false
 float_t get_scale() ;

/// @brief Method set_scale addr 0x2bfe4e4 size 0x8 virtual false final false
 void set_scale(float_t value) ;

// Ctor Parameters []
explicit TextElement() ;

/// @brief Method .ctor addr 0x2bfe4dc size 0x8 virtual false final false
 void _ctor() ;
