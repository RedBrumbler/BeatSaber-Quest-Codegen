...
/// @brief Method get_index addr 0x2bdb998 size 0x8 virtual false final false
 uint32_t get_index() ;

/// @brief Method set_index addr 0x2bdb9a0 size 0x8 virtual false final false
 void set_index(uint32_t value) ;

/// @brief Method get_metrics addr 0x2bdb9a8 size 0x14 virtual false final false
 UnityEngine::TextCore::GlyphMetrics get_metrics() ;

/// @brief Method set_metrics addr 0x2bdb9bc size 0x14 virtual false final false
 void set_metrics(UnityEngine::TextCore::GlyphMetrics value) ;

/// @brief Method get_glyphRect addr 0x2bdb9d0 size 0xc virtual false final false
 UnityEngine::TextCore::GlyphRect get_glyphRect() ;

/// @brief Method set_glyphRect addr 0x2bdb9dc size 0x8 virtual false final false
 void set_glyphRect(UnityEngine::TextCore::GlyphRect value) ;

/// @brief Method get_scale addr 0x2bdb9e4 size 0x8 virtual false final false
 float_t get_scale() ;

/// @brief Method set_scale addr 0x2bdb9ec size 0x8 virtual false final false
 void set_scale(float_t value) ;

/// @brief Method get_atlasIndex addr 0x2bdb9f4 size 0x8 virtual false final false
 int32_t get_atlasIndex() ;

/// @brief Method set_atlasIndex addr 0x2bdb9fc size 0x8 virtual false final false
 void set_atlasIndex(int32_t value) ;

// Ctor Parameters []
explicit Glyph() ;

/// @brief Method .ctor addr 0x2bdba04 size 0x28 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2bdba2c size 0x8c virtual false final false
...
/// @brief Method .ctor addr 0x2bdbab8 size 0x70 virtual false final false
