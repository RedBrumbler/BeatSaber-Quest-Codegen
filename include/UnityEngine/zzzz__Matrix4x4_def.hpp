...
/// @brief Method .ctor addr 0x2b909d8 size 0x1c virtual false final false
...
/// @brief Method get_Item addr 0x2b909f4 size 0x8 virtual false final false
 float_t get_Item(int32_t row, int32_t column) ;

/// @brief Method set_Item addr 0x2b90af0 size 0x8 virtual false final false
 void set_Item(int32_t row, int32_t column, float_t value) ;

/// @brief Method get_Item addr 0x2b909fc size 0xf4 virtual false final false
 float_t get_Item(int32_t index) ;

/// @brief Method set_Item addr 0x2b90af8 size 0xf4 virtual false final false
 void set_Item(int32_t index, float_t value) ;

/// @brief Method GetHashCode addr 0x2b90bec size 0x194 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2b90e58 size 0x174 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method Equals addr 0x2b90fcc size 0x108 virtual true final true
 bool Equals(UnityEngine::Matrix4x4 other) ;

/// @brief Method op_Multiply addr 0x2b910d4 size 0x1a8 virtual false final false
static UnityEngine::Matrix4x4 op_Multiply(UnityEngine::Matrix4x4 lhs, UnityEngine::Matrix4x4 rhs) ;

/// @brief Method op_Multiply addr 0x2b9127c size 0x34 virtual false final false
static UnityEngine::Vector4 op_Multiply(UnityEngine::Matrix4x4 lhs, UnityEngine::Vector4 vector) ;

/// @brief Method op_Equality addr 0x2b912b0 size 0xe4 virtual false final false
static bool op_Equality(UnityEngine::Matrix4x4 lhs, UnityEngine::Matrix4x4 rhs) ;

/// @brief Method op_Inequality addr 0x2b91394 size 0x48 virtual false final false
static bool op_Inequality(UnityEngine::Matrix4x4 lhs, UnityEngine::Matrix4x4 rhs) ;

/// @brief Method GetColumn addr 0x2b90d80 size 0xd8 virtual false final false
 UnityEngine::Vector4 GetColumn(int32_t index) ;

/// @brief Method GetRow addr 0x2b913dc size 0xd8 virtual false final false
 UnityEngine::Vector4 GetRow(int32_t index) ;

/// @brief Method SetColumn addr 0x2b914b4 size 0x78 virtual false final false
 void SetColumn(int32_t index, UnityEngine::Vector4 column) ;

/// @brief Method MultiplyPoint addr 0x2b9152c size 0x80 virtual false final false
 UnityEngine::Vector3 MultiplyPoint(UnityEngine::Vector3 point) ;

/// @brief Method MultiplyPoint3x4 addr 0x2b915ac size 0x58 virtual false final false
 UnityEngine::Vector3 MultiplyPoint3x4(UnityEngine::Vector3 point) ;

/// @brief Method MultiplyVector addr 0x2b91604 size 0x48 virtual false final false
 UnityEngine::Vector3 MultiplyVector(UnityEngine::Vector3 vector) ;

/// @brief Method Scale addr 0x2b9164c size 0x2c virtual false final false
static UnityEngine::Matrix4x4 Scale(UnityEngine::Vector3 vector) ;

/// @brief Method Rotate addr 0x2b91678 size 0x98 virtual false final false
static UnityEngine::Matrix4x4 Rotate(UnityEngine::Quaternion q) ;

/// @brief Method get_zero addr 0x2b91710 size 0x58 virtual false final false
static UnityEngine::Matrix4x4 get_zero() ;

/// @brief Method get_identity addr 0x2b91768 size 0x58 virtual false final false
static UnityEngine::Matrix4x4 get_identity() ;

/// @brief Method ToString addr 0x2b917c0 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x2b917cc size 0x508 virtual true final true
 ::StringW ToString(::StringW format, System::IFormatProvider formatProvider) ;

/// @brief Method GetRotation addr 0x2b91cd4 size 0x58 virtual false final false
 UnityEngine::Quaternion GetRotation() ;

/// @brief Method GetLossyScale addr 0x2b91d70 size 0x5c virtual false final false
 UnityEngine::Vector3 GetLossyScale() ;

/// @brief Method get_rotation addr 0x2b91e10 size 0x4 virtual false final false
 UnityEngine::Quaternion get_rotation() ;

/// @brief Method get_lossyScale addr 0x2b91e14 size 0x4 virtual false final false
 UnityEngine::Vector3 get_lossyScale() ;

/// @brief Method TRS addr 0x2b91e18 size 0x90 virtual false final false
static UnityEngine::Matrix4x4 TRS(UnityEngine::Vector3 pos, UnityEngine::Quaternion q, UnityEngine::Vector3 s) ;

/// @brief Method SetTRS addr 0x2b91f04 size 0x40 virtual false final false
 void SetTRS(UnityEngine::Vector3 pos, UnityEngine::Quaternion q, UnityEngine::Vector3 s) ;

/// @brief Method Inverse3DAffine addr 0x2b91f44 size 0x44 virtual false final false
static bool Inverse3DAffine(UnityEngine::Matrix4x4 input, ByRef<UnityEngine::Matrix4x4> result) ;

/// @brief Method Inverse addr 0x2b91fcc size 0x6c virtual false final false
static UnityEngine::Matrix4x4 Inverse(UnityEngine::Matrix4x4 m) ;

/// @brief Method get_inverse addr 0x2b9207c size 0x88 virtual false final false
 UnityEngine::Matrix4x4 get_inverse() ;

/// @brief Method Transpose addr 0x2b92104 size 0x6c virtual false final false
static UnityEngine::Matrix4x4 Transpose(UnityEngine::Matrix4x4 m) ;

/// @brief Method get_transpose addr 0x2b921b4 size 0x88 virtual false final false
 UnityEngine::Matrix4x4 get_transpose() ;

/// @brief Method Ortho addr 0x2b9223c size 0xac virtual false final false
static UnityEngine::Matrix4x4 Ortho(float_t left, float_t right, float_t bottom, float_t top, float_t zNear, float_t zFar) ;

/// @brief Method Perspective addr 0x2b9236c size 0x94 virtual false final false
static UnityEngine::Matrix4x4 Perspective(float_t fov, float_t aspect, float_t zNear, float_t zFar) ;

/// @brief Method GetRotation_Injected addr 0x2b91d2c size 0x44 virtual false final false
static void GetRotation_Injected(ByRef<UnityEngine::Matrix4x4> _unity_self, ByRef<UnityEngine::Quaternion> ret) ;

/// @brief Method GetLossyScale_Injected addr 0x2b91dcc size 0x44 virtual false final false
static void GetLossyScale_Injected(ByRef<UnityEngine::Matrix4x4> _unity_self, ByRef<UnityEngine::Vector3> ret) ;

/// @brief Method TRS_Injected addr 0x2b91ea8 size 0x5c virtual false final false
...
/// @brief Method Inverse3DAffine_Injected addr 0x2b91f88 size 0x44 virtual false final false
static bool Inverse3DAffine_Injected(ByRef<UnityEngine::Matrix4x4> input, ByRef<UnityEngine::Matrix4x4> result) ;

/// @brief Method Inverse_Injected addr 0x2b92038 size 0x44 virtual false final false
static void Inverse_Injected(ByRef<UnityEngine::Matrix4x4> m, ByRef<UnityEngine::Matrix4x4> ret) ;

/// @brief Method Transpose_Injected addr 0x2b92170 size 0x44 virtual false final false
static void Transpose_Injected(ByRef<UnityEngine::Matrix4x4> m, ByRef<UnityEngine::Matrix4x4> ret) ;

/// @brief Method Ortho_Injected addr 0x2b922e8 size 0x84 virtual false final false
...
/// @brief Method Perspective_Injected addr 0x2b92400 size 0x6c virtual false final false
