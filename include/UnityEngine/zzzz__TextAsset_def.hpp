...
/// @brief Method get_bytes addr 0x2b8bcdc size 0x3c virtual false final false
 ::ArrayW<uint8_t> get_bytes() ;

/// @brief Method get_text addr 0x2b8bd18 size 0x40 virtual false final false
 ::StringW get_text() ;

/// @brief Method ToString addr 0x2b8bfdc size 0x4 virtual true final false
 ::StringW ToString() ;

/// @brief Method DecodeString addr 0x2b8bd58 size 0x284 virtual false final false
