...
/// @brief Method WriteStringToUnityLog addr 0x2b5d7e8 size 0x44 virtual false final false
static void WriteStringToUnityLog(::StringW s) ;

/// @brief Method WriteStringToUnityLogImpl addr 0x2b5d82c size 0x3c virtual false final false
static void WriteStringToUnityLogImpl(::StringW s) ;

/// @brief Method Init addr 0x2b5d868 size 0x80 virtual false final false
static void Init() ;

/// @brief Method get_Encoding addr 0x2b5d940 size 0x8 virtual true final false
 System::Text::Encoding get_Encoding() ;

/// @brief Method Write addr 0x2b5d948 size 0x54 virtual true final false
 void Write(char16_t value) ;

/// @brief Method Write addr 0x2b5d99c size 0x44 virtual true final false
 void Write(::StringW s) ;

/// @brief Method Write addr 0x2b5d9e0 size 0x48 virtual true final false
 void Write(::ArrayW<char16_t> buffer, int32_t index, int32_t count) ;

// Ctor Parameters []
explicit UnityLogWriter() ;

/// @brief Method .ctor addr 0x2b5d8e8 size 0x58 virtual false final false
 void _ctor() ;
