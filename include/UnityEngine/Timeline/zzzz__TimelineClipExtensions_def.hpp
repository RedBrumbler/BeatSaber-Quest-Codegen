...
/// @brief Method MoveToTrack addr 0x2b0ae3c size 0x3c0 virtual false final false
static void MoveToTrack(UnityEngine::Timeline::TimelineClip clip, UnityEngine::Timeline::TrackAsset destinationTrack) ;

/// @brief Method TryMoveToTrack addr 0x2b0b31c size 0x1a4 virtual false final false
static bool TryMoveToTrack(UnityEngine::Timeline::TimelineClip clip, UnityEngine::Timeline::TrackAsset destinationTrack) ;

/// @brief Method MoveToTrack_Impl addr 0x2b0b1fc size 0x120 virtual false final false
