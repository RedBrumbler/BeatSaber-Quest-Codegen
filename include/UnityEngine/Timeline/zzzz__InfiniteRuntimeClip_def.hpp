...
namespace UnityEngine::Timeline {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14115))}
...
/// @brief Method .ctor addr 0x2aee7c8 size 0x2c virtual false final false
 void _ctor(UnityEngine::Playables::Playable playable) ;

/// @brief Method get_intervalStart addr 0x2b01f64 size 0x8 virtual true final false
 int64_t get_intervalStart() ;

/// @brief Method get_intervalEnd addr 0x2b01f6c size 0x58 virtual true final false
 int64_t get_intervalEnd() ;

/// @brief Method set_enable addr 0x2b01fc4 size 0x74 virtual true final false
 void set_enable(bool value) ;

/// @brief Method EvaluateAt addr 0x2b02038 size 0x58 virtual true final false
 void EvaluateAt(double_t localTime, UnityEngine::Playables::FrameData frameData) ;

/// @brief Method DisableAt addr 0x2b02090 size 0x6c virtual true final false
