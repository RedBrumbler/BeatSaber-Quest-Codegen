...
/// @brief Method CanCompileClips addr 0x2ae9534 size 0x5c virtual true final false
 bool CanCompileClips() ;

/// @brief Method get_postPlaybackState addr 0x2ae9640 size 0x8 virtual false final false
 UnityEngine::Timeline::UnityEngine__Timeline__ActivationTrack__PostPlaybackState get_postPlaybackState() ;

/// @brief Method set_postPlaybackState addr 0x2ae9648 size 0x14 virtual false final false
 void set_postPlaybackState(UnityEngine::Timeline::UnityEngine__Timeline__ActivationTrack__PostPlaybackState value) ;

/// @brief Method CreateTrackMixer addr 0x2ae9670 size 0xe4 virtual true final false
...
/// @brief Method UpdateTrackMode addr 0x2ae965c size 0x14 virtual false final false
 void UpdateTrackMode() ;

/// @brief Method GatherProperties addr 0x2ae9754 size 0x12c virtual true final false
 void GatherProperties(UnityEngine::Playables::PlayableDirector director, UnityEngine::Timeline::IPropertyCollector driver) ;

/// @brief Method OnCreateClip addr 0x2ae99f8 size 0x50 virtual true final false
 void OnCreateClip(UnityEngine::Timeline::TimelineClip clip) ;

// Ctor Parameters []
explicit ActivationTrack() ;

/// @brief Method .ctor addr 0x2ae9a4c size 0x5c virtual false final false
 void _ctor() ;
