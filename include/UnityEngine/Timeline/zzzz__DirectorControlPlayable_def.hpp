...
/// @brief Method Create addr 0x2affb84 size 0x130 virtual false final false
...
/// @brief Method OnPlayableDestroy addr 0x2b04fe0 size 0xc0 virtual true final false
 void OnPlayableDestroy(UnityEngine::Playables::Playable playable) ;

/// @brief Method PrepareFrame addr 0x2b050a0 size 0x1b4 virtual true final false
 void PrepareFrame(UnityEngine::Playables::Playable playable, UnityEngine::Playables::FrameData info) ;

/// @brief Method OnBehaviourPlay addr 0x2b05554 size 0xd4 virtual true final false
 void OnBehaviourPlay(UnityEngine::Playables::Playable playable, UnityEngine::Playables::FrameData info) ;

/// @brief Method OnBehaviourPause addr 0x2b05628 size 0x100 virtual true final false
 void OnBehaviourPause(UnityEngine::Playables::Playable playable, UnityEngine::Playables::FrameData info) ;

/// @brief Method ProcessFrame addr 0x2b05728 size 0x200 virtual true final false
...
/// @brief Method SyncSpeed addr 0x2b05368 size 0x12c virtual false final false
 void SyncSpeed(double_t speed) ;

/// @brief Method SyncStart addr 0x2b05494 size 0xc0 virtual false final false
 void SyncStart(UnityEngine::Playables::PlayableGraph graph, double_t time) ;

/// @brief Method SyncStop addr 0x2b05c04 size 0x84 virtual false final false
 void SyncStop(UnityEngine::Playables::PlayableGraph graph, double_t time) ;

/// @brief Method DetectDiscontinuity addr 0x2b05254 size 0x114 virtual false final false
 bool DetectDiscontinuity(UnityEngine::Playables::Playable playable, UnityEngine::Playables::FrameData info) ;

/// @brief Method DetectOutOfSync addr 0x2b05928 size 0x14c virtual false final false
 bool DetectOutOfSync(UnityEngine::Playables::Playable playable) ;

/// @brief Method UpdateTime addr 0x2b05a74 size 0x190 virtual false final false
 void UpdateTime(UnityEngine::Playables::Playable playable) ;

// Ctor Parameters []
explicit DirectorControlPlayable() ;

/// @brief Method .ctor addr 0x2b05c88 size 0x10 virtual false final false
 void _ctor() ;
