...
/// @brief Method PushDestroyUndo addr 0x2b0bedc size 0x88 virtual false final false
...
/// @brief Method PushUndo addr 0x2b0bf64 size 0x4 virtual false final false
static void PushUndo(::ArrayW<UnityEngine::Object> thingsToDirty, ::StringW operation) ;

/// @brief Method PushUndo addr 0x2b0bf68 size 0x4 virtual false final false
static void PushUndo(UnityEngine::Object thingToDirty, ::StringW operation) ;

/// @brief Method RegisterCreatedObjectUndo addr 0x2b0bf6c size 0x4 virtual false final false
static void RegisterCreatedObjectUndo(UnityEngine::Object thingCreated, ::StringW operation) ;

/// @brief Method UndoName addr 0x2b0bf70 size 0x4c virtual false final false
