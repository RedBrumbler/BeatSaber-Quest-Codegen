...
/// @brief Method Create addr 0x2b06254 size 0x144 virtual false final false
...
/// @brief Method get_prefabInstance addr 0x2b06620 size 0x8 virtual false final false
 UnityEngine::GameObject get_prefabInstance() ;

/// @brief Method Initialize addr 0x2b06398 size 0x288 virtual false final false
 UnityEngine::GameObject Initialize(UnityEngine::GameObject prefabGameObject, UnityEngine::Transform parentTransform) ;

/// @brief Method OnPlayableDestroy addr 0x2b06970 size 0xac virtual true final false
 void OnPlayableDestroy(UnityEngine::Playables::Playable playable) ;

/// @brief Method OnBehaviourPlay addr 0x2b06a1c size 0x88 virtual true final false
 void OnBehaviourPlay(UnityEngine::Playables::Playable playable, UnityEngine::Playables::FrameData info) ;

/// @brief Method OnBehaviourPause addr 0x2b06aa4 size 0xa8 virtual true final false
 void OnBehaviourPause(UnityEngine::Playables::Playable playable, UnityEngine::Playables::FrameData info) ;

/// @brief Method SetHideFlagsRecursive addr 0x2b06628 size 0x348 virtual false final false
static void SetHideFlagsRecursive(UnityEngine::GameObject gameObject) ;

// Ctor Parameters []
explicit PrefabControlPlayable() ;

/// @brief Method .ctor addr 0x2b06b4c size 0x8 virtual false final false
 void _ctor() ;
