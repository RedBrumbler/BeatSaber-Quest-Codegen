...
/// @brief Method Create addr 0x2b05c98 size 0x144 virtual false final false
...
/// @brief Method get_particleSystem addr 0x2b05e5c size 0x8 virtual false final false
 UnityEngine::ParticleSystem get_particleSystem() ;

/// @brief Method set_particleSystem addr 0x2b05e64 size 0x8 virtual false final false
 void set_particleSystem(UnityEngine::ParticleSystem value) ;

/// @brief Method Initialize addr 0x2b05ddc size 0x80 virtual false final false
 void Initialize(UnityEngine::ParticleSystem ps, uint32_t randomSeed) ;

/// @brief Method SetRandomSeed addr 0x2b05e6c size 0x13c virtual false final false
static void SetRandomSeed(UnityEngine::ParticleSystem particleSystem, uint32_t randomSeed) ;

/// @brief Method PrepareFrame addr 0x2b05fa8 size 0x1b4 virtual true final false
 void PrepareFrame(UnityEngine::Playables::Playable playable, UnityEngine::Playables::FrameData data) ;

/// @brief Method OnBehaviourPlay addr 0x2b06220 size 0xc virtual true final false
 void OnBehaviourPlay(UnityEngine::Playables::Playable playable, UnityEngine::Playables::FrameData info) ;

/// @brief Method OnBehaviourPause addr 0x2b0622c size 0xc virtual true final false
 void OnBehaviourPause(UnityEngine::Playables::Playable playable, UnityEngine::Playables::FrameData info) ;

/// @brief Method Simulate addr 0x2b0615c size 0xc4 virtual false final false
 void Simulate(float_t time, bool restart) ;

// Ctor Parameters []
explicit ParticleControlPlayable() ;

/// @brief Method .ctor addr 0x2b06238 size 0x1c virtual false final false
 void _ctor() ;
