...
/// @brief Method get_markers addr 0x2b03004 size 0x18 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::Timeline::IMarker> get_markers() ;

/// @brief Method .ctor addr 0x2afbb80 size 0xd4 virtual false final false
 void _ctor(int32_t capacity) ;

/// @brief Method Add addr 0x2af8704 size 0xec virtual false final false
 void Add(UnityEngine::ScriptableObject item) ;

/// @brief Method Remove addr 0x2af76b8 size 0x1e4 virtual false final false
 bool Remove(UnityEngine::Timeline::IMarker item) ;

/// @brief Method Remove addr 0x2af8824 size 0xc0 virtual false final false
...
/// @brief Method Clear addr 0x2af868c size 0x70 virtual false final false
 void Clear() ;

/// @brief Method Contains addr 0x2b032f4 size 0x58 virtual false final false
 bool Contains(UnityEngine::ScriptableObject item) ;

/// @brief Method GetMarkers addr 0x2af789c size 0x18 virtual false final false
 System::Collections::Generic::IEnumerable_1<UnityEngine::Timeline::IMarker> GetMarkers() ;

/// @brief Method get_Count addr 0x2af78b4 size 0x50 virtual false final false
 int32_t get_Count() ;

/// @brief Method get_Item addr 0x2af790c size 0x60 virtual false final false
 UnityEngine::Timeline::IMarker get_Item(int32_t idx) ;

/// @brief Method GetRawMarkerList addr 0x2b0334c size 0x8 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::ScriptableObject> GetRawMarkerList() ;

/// @brief Method CreateMarker addr 0x2af73b0 size 0x300 virtual false final false
 UnityEngine::Timeline::IMarker CreateMarker(System::Type type, double_t time, UnityEngine::Timeline::TrackAsset owner) ;

/// @brief Method HasNotifications addr 0x2afbb68 size 0x18 virtual false final false
 bool HasNotifications() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize addr 0x2b03354 size 0x4 virtual true final true
 void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize addr 0x2b03358 size 0xc virtual true final true
 void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize() ;

/// @brief Method BuildCache addr 0x2b0301c size 0x2d8 virtual false final false
 void BuildCache() ;
