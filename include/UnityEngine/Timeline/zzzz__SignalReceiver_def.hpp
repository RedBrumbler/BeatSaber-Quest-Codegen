...
/// @brief Method TryGetValue addr 0x2b039e4 size 0xb0 virtual false final false
 bool TryGetValue(UnityEngine::Timeline::SignalAsset key, ByRef<UnityEngine::Events::UnityEvent> value) ;

/// @brief Method Append addr 0x2b03bd4 size 0x128 virtual false final false
 void Append(UnityEngine::Timeline::SignalAsset key, UnityEngine::Events::UnityEvent value) ;

/// @brief Method Remove addr 0x2b04280 size 0x94 virtual false final false
 void Remove(int32_t idx) ;

/// @brief Method Remove addr 0x2b03e28 size 0xc0 virtual false final false
 void Remove(UnityEngine::Timeline::SignalAsset key) ;

/// @brief Method get_signals addr 0x2b04680 size 0x8 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::Timeline::SignalAsset> get_signals() ;

/// @brief Method get_events addr 0x2b04688 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2b045c0 size 0xc0 virtual false final false
 void _ctor() ;
...
/// @brief Method OnNotify addr 0x2b038cc size 0x118 virtual true final true
...
/// @brief Method AddReaction addr 0x2b03a94 size 0x140 virtual false final false
 void AddReaction(UnityEngine::Timeline::SignalAsset asset, UnityEngine::Events::UnityEvent reaction) ;

/// @brief Method AddEmptyReaction addr 0x2b03cfc size 0x6c virtual false final false
 int32_t AddEmptyReaction(UnityEngine::Events::UnityEvent reaction) ;

/// @brief Method Remove addr 0x2b03d68 size 0xc0 virtual false final false
 void Remove(UnityEngine::Timeline::SignalAsset asset) ;

/// @brief Method GetRegisteredSignals addr 0x2b03ee8 size 0x1c virtual false final false
 System::Collections::Generic::IEnumerable_1<UnityEngine::Timeline::SignalAsset> GetRegisteredSignals() ;

/// @brief Method GetReaction addr 0x2b03f04 size 0x30 virtual false final false
 UnityEngine::Events::UnityEvent GetReaction(UnityEngine::Timeline::SignalAsset key) ;

/// @brief Method Count addr 0x2b03f34 size 0x50 virtual false final false
 int32_t Count() ;

/// @brief Method ChangeSignalAtIndex addr 0x2b03f84 size 0x258 virtual false final false
 void ChangeSignalAtIndex(int32_t idx, UnityEngine::Timeline::SignalAsset newKey) ;

/// @brief Method RemoveAtIndex addr 0x2b041dc size 0xa4 virtual false final false
 void RemoveAtIndex(int32_t idx) ;

/// @brief Method ChangeReactionAtIndex addr 0x2b04314 size 0xcc virtual false final false
 void ChangeReactionAtIndex(int32_t idx, UnityEngine::Events::UnityEvent reaction) ;

/// @brief Method GetReactionAtIndex addr 0x2b043e0 size 0xbc virtual false final false
 UnityEngine::Events::UnityEvent GetReactionAtIndex(int32_t idx) ;

/// @brief Method GetSignalAssetAtIndex addr 0x2b0449c size 0xbc virtual false final false
 UnityEngine::Timeline::SignalAsset GetSignalAssetAtIndex(int32_t idx) ;

/// @brief Method OnEnable addr 0x2b04558 size 0x4 virtual false final false
 void OnEnable() ;

// Ctor Parameters []
explicit SignalReceiver() ;

/// @brief Method .ctor addr 0x2b0455c size 0x64 virtual false final false
 void _ctor() ;
