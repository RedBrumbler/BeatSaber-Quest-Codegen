...
/// @brief Method .ctor addr 0x2b0dbc0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ParseTimeCode>b__15_0 addr 0x2b0dbc8 size 0x58 virtual false final false
 bool _ParseTimeCode_b__15_0(char16_t c) ;

/// @brief Method <ParseTimeCode>b__15_1 addr 0x2b0dc20 size 0x1c virtual false final false
 bool _ParseTimeCode_b__15_1(char16_t c) ;

/// @brief Method <ParseTimeSeconds>b__16_0 addr 0x2b0dc3c size 0x58 virtual false final false
...
/// @brief Method ValidateFrameRate addr 0x2b0bfbc size 0xb8 virtual false final false
static void ValidateFrameRate(double_t frameRate) ;

/// @brief Method ToFrames addr 0x2b0c074 size 0x114 virtual false final false
static int32_t ToFrames(double_t time, double_t frameRate) ;

/// @brief Method ToExactFrames addr 0x2b0c230 size 0x68 virtual false final false
static double_t ToExactFrames(double_t time, double_t frameRate) ;

/// @brief Method FromFrames addr 0x2b0c298 size 0x6c virtual false final false
static double_t FromFrames(int32_t frames, double_t frameRate) ;

/// @brief Method FromFrames addr 0x2b0c304 size 0x68 virtual false final false
static double_t FromFrames(double_t frames, double_t frameRate) ;

/// @brief Method OnFrameBoundary addr 0x2b0c36c size 0x74 virtual false final false
static bool OnFrameBoundary(double_t time, double_t frameRate) ;

/// @brief Method GetEpsilon addr 0x2b0c188 size 0xa8 virtual false final false
static double_t GetEpsilon(double_t time, double_t frameRate) ;

/// @brief Method OnFrameBoundary addr 0x2b0c3e0 size 0x120 virtual false final false
static bool OnFrameBoundary(double_t time, double_t frameRate, double_t epsilon) ;

/// @brief Method RoundToFrame addr 0x2b0c500 size 0xdc virtual false final false
static double_t RoundToFrame(double_t time, double_t frameRate) ;

/// @brief Method TimeAsFrames addr 0x2b0c5dc size 0xd0 virtual false final false
static ::StringW TimeAsFrames(double_t timeValue, double_t frameRate, ::StringW format) ;

/// @brief Method TimeAsTimeCode addr 0x2b0c6ac size 0x49c virtual false final false
static ::StringW TimeAsTimeCode(double_t timeValue, double_t frameRate, ::StringW format) ;

/// @brief Method ParseTimeCode addr 0x2b0cb48 size 0x510 virtual false final false
static double_t ParseTimeCode(::StringW timeCode, double_t frameRate, double_t defaultValue) ;

/// @brief Method ParseTimeSeconds addr 0x2b0d128 size 0x378 virtual false final false
static double_t ParseTimeSeconds(::StringW timeCode, double_t frameRate, double_t defaultValue) ;

/// @brief Method GetAnimationClipLength addr 0x2b0d4a0 size 0x164 virtual false final false
static double_t GetAnimationClipLength(UnityEngine::AnimationClip clip) ;

/// @brief Method RemoveChar addr 0x2b0d058 size 0xd0 virtual false final false
static ::StringW RemoveChar(::StringW str, System::Func_2<char16_t,bool> charToRemoveFunc) ;

/// @brief Method GetClosestFrameRate addr 0x2b0d604 size 0xf0 virtual false final false
static UnityEngine::Playables::FrameRate GetClosestFrameRate(double_t frameRate) ;

/// @brief Method ToFrameRate addr 0x2b0d6f4 size 0x168 virtual false final false
static UnityEngine::Playables::FrameRate ToFrameRate(UnityEngine::Timeline::StandardFrameRates enumValue) ;

/// @brief Method ToStandardFrameRate addr 0x2b0d85c size 0x2a8 virtual false final false
