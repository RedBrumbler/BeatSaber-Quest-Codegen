...
/// @brief Method add_OnEnableCallback addr 0x2b035a4 size 0xcc virtual false final false
static void add_OnEnableCallback(System::Action_1<UnityEngine::Timeline::SignalAsset> value) ;

/// @brief Method remove_OnEnableCallback addr 0x2b03670 size 0xcc virtual false final false
static void remove_OnEnableCallback(System::Action_1<UnityEngine::Timeline::SignalAsset> value) ;

/// @brief Method OnEnable addr 0x2b0373c size 0x6c virtual false final false
 void OnEnable() ;

// Ctor Parameters []
explicit SignalAsset() ;

/// @brief Method .ctor addr 0x2b037a8 size 0x8 virtual false final false
 void _ctor() ;
