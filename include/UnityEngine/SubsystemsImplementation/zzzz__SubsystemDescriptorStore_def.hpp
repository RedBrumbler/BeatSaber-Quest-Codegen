...
/// @brief Method RegisterDeprecatedDescriptor addr 0x2bd5220 size 0x78 virtual false final false
static void RegisterDeprecatedDescriptor(UnityEngine::SubsystemDescriptor descriptor) ;

/// @brief Method InitializeManagedDescriptor addr 0x2bd6054 size 0xdc virtual false final false
static void InitializeManagedDescriptor(::cordl_internals::intptr_t ptr, UnityEngine::IntegratedSubsystemDescriptor desc) ;

/// @brief Method ClearManagedDescriptors addr 0x2bd6130 size 0x1e4 virtual false final false
static void ClearManagedDescriptors() ;

/// @brief Method ReportSingleSubsystemAnalytics addr 0x2bd6314 size 0x3c virtual false final false
