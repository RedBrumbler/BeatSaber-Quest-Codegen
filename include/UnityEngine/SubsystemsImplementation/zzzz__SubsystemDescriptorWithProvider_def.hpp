...
/// @brief Method get_id addr 0x2bd6474 size 0x8 virtual true final true
 ::StringW get_id() ;

/// @brief Method CreateImpl addr 0x0 size 0xffffffffffffffff virtual true final false
 UnityEngine::ISubsystem CreateImpl() ;

/// @brief Method UnityEngine.ISubsystemDescriptor.Create addr 0x2bd647c size 0xc virtual true final true
 UnityEngine::ISubsystem UnityEngine_ISubsystemDescriptor_Create() ;

// Ctor Parameters []
explicit SubsystemDescriptorWithProvider() ;

/// @brief Method .ctor addr 0x2bd6488 size 0x8 virtual false final false
 void _ctor() ;
