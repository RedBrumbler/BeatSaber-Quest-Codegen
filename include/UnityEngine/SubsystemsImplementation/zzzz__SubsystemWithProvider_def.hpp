...
/// @brief Method Start addr 0x2bd6490 size 0x3c virtual true final true
 void Start() ;

/// @brief Method OnStart addr 0x0 size 0xffffffffffffffff virtual true final false
 void OnStart() ;

/// @brief Method Stop addr 0x2bd64cc size 0x38 virtual true final true
 void Stop() ;

/// @brief Method OnStop addr 0x0 size 0xffffffffffffffff virtual true final false
 void OnStop() ;

/// @brief Method Destroy addr 0x2bd6504 size 0x7c virtual true final true
 void Destroy() ;

/// @brief Method OnDestroy addr 0x0 size 0xffffffffffffffff virtual true final false
 void OnDestroy() ;

/// @brief Method get_running addr 0x2bd6580 size 0x8 virtual true final true
 bool get_running() ;

/// @brief Method set_running addr 0x2bd6588 size 0xc virtual false final false
 void set_running(bool value) ;

/// @brief Method get_providerBase addr 0x2bd6594 size 0x8 virtual false final false
 UnityEngine::SubsystemsImplementation::SubsystemProvider get_providerBase() ;

// Ctor Parameters []
explicit SubsystemWithProvider() ;

/// @brief Method .ctor addr 0x2bd659c size 0x8 virtual false final false
 void _ctor() ;
