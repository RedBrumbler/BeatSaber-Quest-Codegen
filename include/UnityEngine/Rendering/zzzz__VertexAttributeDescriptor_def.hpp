...
/// @brief Method get_attribute addr 0x2ba4f2c size 0x8 virtual false final false
 UnityEngine::Rendering::VertexAttribute get_attribute() ;

/// @brief Method set_attribute addr 0x2ba4f34 size 0x8 virtual false final false
 void set_attribute(UnityEngine::Rendering::VertexAttribute value) ;

/// @brief Method get_format addr 0x2ba4f3c size 0x8 virtual false final false
 UnityEngine::Rendering::VertexAttributeFormat get_format() ;

/// @brief Method set_format addr 0x2ba4f44 size 0x8 virtual false final false
 void set_format(UnityEngine::Rendering::VertexAttributeFormat value) ;

/// @brief Method get_dimension addr 0x2ba4f4c size 0x8 virtual false final false
 int32_t get_dimension() ;

/// @brief Method set_dimension addr 0x2ba4f54 size 0x8 virtual false final false
 void set_dimension(int32_t value) ;

/// @brief Method get_stream addr 0x2ba4f5c size 0x8 virtual false final false
 int32_t get_stream() ;

/// @brief Method set_stream addr 0x2ba4f64 size 0x8 virtual false final false
 void set_stream(int32_t value) ;

/// @brief Method .ctor addr 0x2ba4f6c size 0xc virtual false final false
...
/// @brief Method ToString addr 0x2ba4f78 size 0x1d4 virtual true final false
 ::StringW ToString() ;

/// @brief Method GetHashCode addr 0x2ba514c size 0x28 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2ba5174 size 0xa8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method Equals addr 0x2ba521c size 0x44 virtual true final true
