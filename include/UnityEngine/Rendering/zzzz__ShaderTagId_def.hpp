...
/// @brief Method .ctor addr 0x2ba6be0 size 0x20 virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method get_id addr 0x2ba6c00 size 0x8 virtual false final false
 int32_t get_id() ;

/// @brief Method set_id addr 0x2ba6c08 size 0x8 virtual false final false
 void set_id(int32_t value) ;

/// @brief Method Equals addr 0x2ba6c10 size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2ba6c88 size 0x10 virtual true final true
 bool Equals(UnityEngine::Rendering::ShaderTagId other) ;

/// @brief Method GetHashCode addr 0x2ba6c98 size 0x20 virtual true final false
 int32_t GetHashCode() ;
