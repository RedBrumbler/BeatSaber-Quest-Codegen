...
/// @brief Method .ctor addr 0x2ba4bf0 size 0x18 virtual false final false
 void _ctor(int32_t indexStart, int32_t indexCount, UnityEngine::MeshTopology topology) ;

/// @brief Method get_bounds addr 0x2ba4c08 size 0x14 virtual false final false
 UnityEngine::Bounds get_bounds() ;

/// @brief Method set_bounds addr 0x2ba4c1c size 0x14 virtual false final false
 void set_bounds(UnityEngine::Bounds value) ;

/// @brief Method get_topology addr 0x2ba4c30 size 0x8 virtual false final false
 UnityEngine::MeshTopology get_topology() ;

/// @brief Method set_topology addr 0x2ba4c38 size 0x8 virtual false final false
 void set_topology(UnityEngine::MeshTopology value) ;

/// @brief Method get_indexStart addr 0x2ba4c40 size 0x8 virtual false final false
 int32_t get_indexStart() ;

/// @brief Method set_indexStart addr 0x2ba4c48 size 0x8 virtual false final false
 void set_indexStart(int32_t value) ;

/// @brief Method get_indexCount addr 0x2ba4c50 size 0x8 virtual false final false
 int32_t get_indexCount() ;

/// @brief Method set_indexCount addr 0x2ba4c58 size 0x8 virtual false final false
 void set_indexCount(int32_t value) ;

/// @brief Method get_baseVertex addr 0x2ba4c60 size 0x8 virtual false final false
 int32_t get_baseVertex() ;

/// @brief Method set_baseVertex addr 0x2ba4c68 size 0x8 virtual false final false
 void set_baseVertex(int32_t value) ;

/// @brief Method get_firstVertex addr 0x2ba4c70 size 0x8 virtual false final false
 int32_t get_firstVertex() ;

/// @brief Method set_firstVertex addr 0x2ba4c78 size 0x8 virtual false final false
 void set_firstVertex(int32_t value) ;

/// @brief Method get_vertexCount addr 0x2ba4c80 size 0x8 virtual false final false
 int32_t get_vertexCount() ;

/// @brief Method set_vertexCount addr 0x2ba4c88 size 0x8 virtual false final false
 void set_vertexCount(int32_t value) ;

/// @brief Method ToString addr 0x2ba4c90 size 0x29c virtual true final false
 ::StringW ToString() ;
