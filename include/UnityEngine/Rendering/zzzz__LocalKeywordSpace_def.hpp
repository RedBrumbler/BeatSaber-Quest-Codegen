...
/// @brief Method Equals addr 0x2ba8150 size 0x7c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method Equals addr 0x2ba81cc size 0xc virtual true final true
 bool Equals(UnityEngine::Rendering::LocalKeywordSpace rhs) ;

/// @brief Method op_Equality addr 0x2ba80d0 size 0x8 virtual false final false
static bool op_Equality(UnityEngine::Rendering::LocalKeywordSpace lhs, UnityEngine::Rendering::LocalKeywordSpace rhs) ;

/// @brief Method GetHashCode addr 0x2ba8128 size 0x20 virtual true final false
 int32_t GetHashCode() ;
