...
/// @brief Method get_renderFrameInterval addr 0x2ba4950 size 0x58 virtual false final false
static int32_t get_renderFrameInterval() ;

/// @brief Method GetRenderFrameInterval addr 0x2ba49a8 size 0x58 virtual false final false
