...
/// @brief Method get_currentPipeline addr 0x2ba5a08 size 0x58 virtual false final false
static UnityEngine::Rendering::RenderPipeline get_currentPipeline() ;

/// @brief Method set_currentPipeline addr 0x2ba5a60 size 0xb0 virtual false final false
static void set_currentPipeline(UnityEngine::Rendering::RenderPipeline value) ;

/// @brief Method add_beginCameraRendering addr 0x2ba5b10 size 0xf4 virtual false final false
...
/// @brief Method remove_beginCameraRendering addr 0x2ba5c04 size 0xf4 virtual false final false
...
/// @brief Method OnActiveRenderPipelineTypeChanged addr 0x2ba5cf8 size 0x74 virtual false final false
static void OnActiveRenderPipelineTypeChanged() ;

/// @brief Method HandleRenderPipelineChange addr 0x2ba5d6c size 0x80 virtual false final false
static void HandleRenderPipelineChange(UnityEngine::Rendering::RenderPipelineAsset pipelineAsset) ;

/// @brief Method CleanupRenderPipeline addr 0x2ba5dec size 0x188 virtual false final false
static void CleanupRenderPipeline() ;

/// @brief Method GetCurrentPipelineAssetType addr 0x2ba60d8 size 0x58 virtual false final false
static ::StringW GetCurrentPipelineAssetType() ;

/// @brief Method DoRenderLoop_Internal addr 0x2ba6130 size 0x1c8 virtual false final false
static void DoRenderLoop_Internal(UnityEngine::Rendering::RenderPipelineAsset pipe, ::cordl_internals::intptr_t loopPtr, System::Collections::Generic::List_1<UnityEngine::UnityEngine__Camera__RenderRequest> renderRequests) ;

/// @brief Method PrepareRenderPipeline addr 0x2ba62f8 size 0x16c virtual false final false
