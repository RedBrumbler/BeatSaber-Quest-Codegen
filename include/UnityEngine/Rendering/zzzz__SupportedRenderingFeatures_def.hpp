...
/// @brief Method get_active addr 0x2ba740c size 0xa8 virtual false final false
static UnityEngine::Rendering::SupportedRenderingFeatures get_active() ;

/// @brief Method set_active addr 0x2ba607c size 0x5c virtual false final false
static void set_active(UnityEngine::Rendering::SupportedRenderingFeatures value) ;

/// @brief Method get_defaultMixedLightingModes addr 0x2ba74b4 size 0x8 virtual false final false
...
/// @brief Method get_mixedLightingModes addr 0x2ba74bc size 0x8 virtual false final false
 UnityEngine::Rendering::UnityEngine__Rendering__SupportedRenderingFeatures__LightmapMixedBakeModes get_mixedLightingModes() ;

/// @brief Method get_lightmapBakeTypes addr 0x2ba74c4 size 0x8 virtual false final false
 UnityEngine::LightmapBakeType get_lightmapBakeTypes() ;

/// @brief Method get_lightmapsModes addr 0x2ba74cc size 0x8 virtual false final false
 UnityEngine::LightmapsMode get_lightmapsModes() ;

/// @brief Method get_enlightenLightmapper addr 0x2ba74d4 size 0x8 virtual false final false
 bool get_enlightenLightmapper() ;

/// @brief Method get_enlighten addr 0x2ba74dc size 0x8 virtual false final false
 bool get_enlighten() ;

/// @brief Method get_rendersUIOverlay addr 0x2ba74e4 size 0x8 virtual false final false
 bool get_rendersUIOverlay() ;

/// @brief Method get_autoAmbientProbeBaking addr 0x2ba74ec size 0x8 virtual false final false
 bool get_autoAmbientProbeBaking() ;

/// @brief Method get_autoDefaultReflectionProbeBaking addr 0x2ba74f4 size 0x8 virtual false final false
 bool get_autoDefaultReflectionProbeBaking() ;

/// @brief Method FallbackMixedLightingModeByRef addr 0x2ba74fc size 0x134 virtual false final false
static void FallbackMixedLightingModeByRef(::cordl_internals::intptr_t fallbackModePtr) ;

/// @brief Method IsMixedLightingModeSupported addr 0x2ba7630 size 0x6c virtual false final false
static bool IsMixedLightingModeSupported(UnityEngine::MixedLightingMode mixedMode) ;

/// @brief Method IsMixedLightingModeSupportedByRef addr 0x2ba769c size 0x108 virtual false final false
...
/// @brief Method IsLightmapBakeTypeSupported addr 0x2ba77a4 size 0x6c virtual false final false
static bool IsLightmapBakeTypeSupported(UnityEngine::LightmapBakeType bakeType) ;

/// @brief Method IsLightmapBakeTypeSupportedByRef addr 0x2ba7810 size 0xf0 virtual false final false
...
/// @brief Method IsLightmapsModeSupportedByRef addr 0x2ba7900 size 0x8c virtual false final false
static void IsLightmapsModeSupportedByRef(UnityEngine::LightmapsMode mode, ::cordl_internals::intptr_t isSupportedPtr) ;

/// @brief Method IsLightmapperSupportedByRef addr 0x2ba798c size 0x84 virtual false final false
static void IsLightmapperSupportedByRef(int32_t lightmapper, ::cordl_internals::intptr_t isSupportedPtr) ;

/// @brief Method IsUIOverlayRenderedBySRP addr 0x2ba7a10 size 0x78 virtual false final false
static void IsUIOverlayRenderedBySRP(::cordl_internals::intptr_t isSupportedPtr) ;

/// @brief Method IsAutoAmbientProbeBakingSupported addr 0x2ba7a88 size 0x78 virtual false final false
static void IsAutoAmbientProbeBakingSupported(::cordl_internals::intptr_t isSupportedPtr) ;

/// @brief Method IsAutoDefaultReflectionProbeBakingSupported addr 0x2ba7b00 size 0x78 virtual false final false
static void IsAutoDefaultReflectionProbeBakingSupported(::cordl_internals::intptr_t isSupportedPtr) ;

/// @brief Method FallbackLightmapperByRef addr 0x2ba7b78 size 0x1c virtual false final false
static void FallbackLightmapperByRef(::cordl_internals::intptr_t lightmapperPtr) ;

// Ctor Parameters []
explicit SupportedRenderingFeatures() ;

/// @brief Method .ctor addr 0x2ba5fec size 0x90 virtual false final false
 void _ctor() ;
