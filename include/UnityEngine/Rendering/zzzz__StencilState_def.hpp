...
/// @brief Method set_enabled addr 0x2ba6efc size 0x6c virtual false final false
 void set_enabled(bool value) ;

/// @brief Method set_readMask addr 0x2ba6f68 size 0x8 virtual false final false
 void set_readMask(uint8_t value) ;

/// @brief Method set_writeMask addr 0x2ba6f70 size 0x8 virtual false final false
 void set_writeMask(uint8_t value) ;

/// @brief Method set_compareFunctionFront addr 0x2ba6f78 size 0x8 virtual false final false
 void set_compareFunctionFront(UnityEngine::Rendering::CompareFunction value) ;

/// @brief Method set_passOperationFront addr 0x2ba6f80 size 0x8 virtual false final false
 void set_passOperationFront(UnityEngine::Rendering::StencilOp value) ;

/// @brief Method set_failOperationFront addr 0x2ba6f88 size 0x8 virtual false final false
 void set_failOperationFront(UnityEngine::Rendering::StencilOp value) ;

/// @brief Method set_zFailOperationFront addr 0x2ba6f90 size 0x8 virtual false final false
 void set_zFailOperationFront(UnityEngine::Rendering::StencilOp value) ;

/// @brief Method set_compareFunctionBack addr 0x2ba6f98 size 0x8 virtual false final false
 void set_compareFunctionBack(UnityEngine::Rendering::CompareFunction value) ;

/// @brief Method set_passOperationBack addr 0x2ba6fa0 size 0x8 virtual false final false
 void set_passOperationBack(UnityEngine::Rendering::StencilOp value) ;

/// @brief Method set_failOperationBack addr 0x2ba6fa8 size 0x8 virtual false final false
 void set_failOperationBack(UnityEngine::Rendering::StencilOp value) ;

/// @brief Method set_zFailOperationBack addr 0x2ba6fb0 size 0x8 virtual false final false
 void set_zFailOperationBack(UnityEngine::Rendering::StencilOp value) ;

/// @brief Method Equals addr 0x2ba6fb8 size 0xb0 virtual true final true
 bool Equals(UnityEngine::Rendering::StencilState other) ;

/// @brief Method Equals addr 0x2ba7068 size 0x7c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2ba70e4 size 0xf0 virtual true final false
 int32_t GetHashCode() ;
