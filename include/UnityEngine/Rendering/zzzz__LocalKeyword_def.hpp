...
/// @brief Method ToString addr 0x2ba7ff4 size 0x8 virtual true final false
 ::StringW ToString() ;

/// @brief Method Equals addr 0x2ba7ffc size 0x8c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method Equals addr 0x2ba8088 size 0x48 virtual true final true
 bool Equals(UnityEngine::Rendering::LocalKeyword rhs) ;

/// @brief Method GetHashCode addr 0x2ba80d8 size 0x50 virtual true final false
 int32_t GetHashCode() ;
