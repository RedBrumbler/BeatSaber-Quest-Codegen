...
/// @brief Method .ctor addr 0x2ba6464 size 0x8 virtual false final false
 void _ctor(::cordl_internals::intptr_t ptr) ;

/// @brief Method GetCameras addr 0x2ba646c size 0x8c virtual false final false
 void GetCameras(System::Collections::Generic::List_1<UnityEngine::Camera> results) ;

/// @brief Method Equals addr 0x2ba7260 size 0x70 virtual true final true
 bool Equals(UnityEngine::Rendering::ScriptableRenderContext other) ;

/// @brief Method Equals addr 0x2ba72d0 size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2ba7348 size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method GetCameras_Internal addr 0x2ba71d4 size 0x8c virtual false final false
 void GetCameras_Internal(System::Type listType, ::bs_hook::Il2CppWrapperType resultList) ;

/// @brief Method GetCameras_Internal_Injected addr 0x2ba7350 size 0x54 virtual false final false
