...
namespace UnityEngine::EventSystems {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13122))}
...
/// @brief Method .ctor addr 0x2c4e3dc size 0x28 virtual false final false
 void _ctor(UnityEngine::EventSystems::EventSystem eventSystem) ;

/// @brief Method get_currentInputModule addr 0x2c4e428 size 0x1c virtual false final false
 UnityEngine::EventSystems::BaseInputModule get_currentInputModule() ;

/// @brief Method get_selectedObject addr 0x2c4e444 size 0x1c virtual false final false
 UnityEngine::GameObject get_selectedObject() ;

/// @brief Method set_selectedObject addr 0x2c4e460 size 0x1c virtual false final false
