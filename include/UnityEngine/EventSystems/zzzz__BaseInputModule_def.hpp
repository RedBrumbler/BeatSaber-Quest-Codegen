...
/// @brief Method get_sendPointerHoverToParent addr 0x2c53838 size 0x8 virtual false final false
 bool get_sendPointerHoverToParent() ;

/// @brief Method set_sendPointerHoverToParent addr 0x2c53840 size 0xc virtual false final false
 void set_sendPointerHoverToParent(bool value) ;

/// @brief Method get_input addr 0x2c5384c size 0x218 virtual false final false
 UnityEngine::EventSystems::BaseInput get_input() ;

/// @brief Method get_inputOverride addr 0x2c53a64 size 0x8 virtual false final false
 UnityEngine::EventSystems::BaseInput get_inputOverride() ;

/// @brief Method set_inputOverride addr 0x2c53a6c size 0x8 virtual false final false
 void set_inputOverride(UnityEngine::EventSystems::BaseInput value) ;

/// @brief Method get_eventSystem addr 0x2c53a74 size 0x8 virtual false final false
 UnityEngine::EventSystems::EventSystem get_eventSystem() ;

/// @brief Method OnEnable addr 0x2c53a7c size 0x58 virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2c53ad4 size 0x18 virtual true final false
 void OnDisable() ;

/// @brief Method Process addr 0x0 size 0xffffffffffffffff virtual true final false
 void Process() ;

/// @brief Method FindFirstRaycast addr 0x2c53aec size 0x114 virtual false final false
...
/// @brief Method DetermineMoveDirection addr 0x2c53c00 size 0x54 virtual false final false
static UnityEngine::EventSystems::MoveDirection DetermineMoveDirection(float_t x, float_t y) ;

/// @brief Method DetermineMoveDirection addr 0x2c53c54 size 0x50 virtual false final false
static UnityEngine::EventSystems::MoveDirection DetermineMoveDirection(float_t x, float_t y, float_t deadZone) ;

/// @brief Method FindCommonRoot addr 0x2c53ca4 size 0x174 virtual false final false
static UnityEngine::GameObject FindCommonRoot(UnityEngine::GameObject g1, UnityEngine::GameObject g2) ;

/// @brief Method HandlePointerExitAndEnter addr 0x2c53e18 size 0xa48 virtual false final false
...
/// @brief Method GetAxisEventData addr 0x2c54860 size 0x100 virtual true final false
 UnityEngine::EventSystems::AxisEventData GetAxisEventData(float_t x, float_t y, float_t moveDeadZone) ;

/// @brief Method GetBaseEventData addr 0x2c54960 size 0x84 virtual true final false
 UnityEngine::EventSystems::BaseEventData GetBaseEventData() ;

/// @brief Method IsPointerOverGameObject addr 0x2c549e4 size 0x8 virtual true final false
 bool IsPointerOverGameObject(int32_t pointerId) ;

/// @brief Method ShouldActivateModule addr 0x2c549ec size 0x40 virtual true final false
 bool ShouldActivateModule() ;

/// @brief Method DeactivateModule addr 0x2c54a2c size 0x4 virtual true final false
 void DeactivateModule() ;

/// @brief Method ActivateModule addr 0x2c54a30 size 0x4 virtual true final false
 void ActivateModule() ;

/// @brief Method UpdateModule addr 0x2c54a34 size 0x4 virtual true final false
 void UpdateModule() ;

/// @brief Method IsModuleSupported addr 0x2c54a38 size 0x8 virtual true final false
 bool IsModuleSupported() ;

/// @brief Method ConvertUIToolkitPointerId addr 0x2c54a40 size 0x7c virtual true final false
 int32_t ConvertUIToolkitPointerId(UnityEngine::EventSystems::PointerEventData sourcePointerData) ;

// Ctor Parameters []
explicit BaseInputModule() ;

/// @brief Method .ctor addr 0x2c54abc size 0x84 virtual false final false
 void _ctor() ;
