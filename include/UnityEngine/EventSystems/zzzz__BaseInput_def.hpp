...
/// @brief Method get_compositionString addr 0x2c53768 size 0x8 virtual true final false
 ::StringW get_compositionString() ;

/// @brief Method get_imeCompositionMode addr 0x2c53770 size 0x8 virtual true final false
 UnityEngine::IMECompositionMode get_imeCompositionMode() ;

/// @brief Method set_imeCompositionMode addr 0x2c53778 size 0xc virtual true final false
 void set_imeCompositionMode(UnityEngine::IMECompositionMode value) ;

/// @brief Method get_compositionCursorPos addr 0x2c53784 size 0x8 virtual true final false
 UnityEngine::Vector2 get_compositionCursorPos() ;

/// @brief Method set_compositionCursorPos addr 0x2c5378c size 0x8 virtual true final false
 void set_compositionCursorPos(UnityEngine::Vector2 value) ;

/// @brief Method get_mousePresent addr 0x2c53794 size 0x8 virtual true final false
 bool get_mousePresent() ;

/// @brief Method GetMouseButtonDown addr 0x2c5379c size 0xc virtual true final false
 bool GetMouseButtonDown(int32_t button) ;

/// @brief Method GetMouseButtonUp addr 0x2c537a8 size 0xc virtual true final false
 bool GetMouseButtonUp(int32_t button) ;

/// @brief Method GetMouseButton addr 0x2c537b4 size 0xc virtual true final false
 bool GetMouseButton(int32_t button) ;

/// @brief Method get_mousePosition addr 0x2c537c0 size 0x8 virtual true final false
 UnityEngine::Vector2 get_mousePosition() ;

/// @brief Method get_mouseScrollDelta addr 0x2c537c8 size 0x8 virtual true final false
 UnityEngine::Vector2 get_mouseScrollDelta() ;

/// @brief Method get_touchSupported addr 0x2c537d0 size 0x8 virtual true final false
 bool get_touchSupported() ;

/// @brief Method get_touchCount addr 0x2c537d8 size 0x8 virtual true final false
 int32_t get_touchCount() ;

/// @brief Method GetTouch addr 0x2c537e0 size 0x38 virtual true final false
 UnityEngine::Touch GetTouch(int32_t index) ;

/// @brief Method GetAxisRaw addr 0x2c53818 size 0xc virtual true final false
 float_t GetAxisRaw(::StringW axisName) ;

/// @brief Method GetButtonDown addr 0x2c53824 size 0xc virtual true final false
 bool GetButtonDown(::StringW buttonName) ;

// Ctor Parameters []
explicit BaseInput() ;

/// @brief Method .ctor addr 0x2c53830 size 0x8 virtual false final false
 void _ctor() ;
