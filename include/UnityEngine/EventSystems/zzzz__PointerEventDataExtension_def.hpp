...
/// @brief Method IsVRPointer addr 0x269be20 size 0x78 virtual false final false
static bool IsVRPointer(UnityEngine::EventSystems::PointerEventData pointerEventData) ;

/// @brief Method GetRay addr 0x269e3e8 size 0x88 virtual false final false
static UnityEngine::Ray GetRay(UnityEngine::EventSystems::PointerEventData pointerEventData) ;

/// @brief Method GetSwipeStart addr 0x269d888 size 0x7c virtual false final false
static UnityEngine::Vector2 GetSwipeStart(UnityEngine::EventSystems::PointerEventData pointerEventData) ;

/// @brief Method SetSwipeStart addr 0x269be98 size 0x8c virtual false final false
