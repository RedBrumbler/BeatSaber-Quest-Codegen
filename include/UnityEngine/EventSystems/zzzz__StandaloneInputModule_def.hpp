...
/// @brief Method .ctor addr 0x2c561b8 size 0xbc virtual false final false
 void _ctor() ;

/// @brief Method get_inputMode addr 0x2c56274 size 0x8 virtual false final false
 UnityEngine::EventSystems::UnityEngine__EventSystems__StandaloneInputModule__InputMode get_inputMode() ;

/// @brief Method get_allowActivationOnMobileDevice addr 0x2c5627c size 0x8 virtual false final false
 bool get_allowActivationOnMobileDevice() ;

/// @brief Method set_allowActivationOnMobileDevice addr 0x2c56284 size 0xc virtual false final false
 void set_allowActivationOnMobileDevice(bool value) ;

/// @brief Method get_forceModuleActive addr 0x2c56290 size 0x8 virtual false final false
 bool get_forceModuleActive() ;

/// @brief Method set_forceModuleActive addr 0x2c56298 size 0xc virtual false final false
 void set_forceModuleActive(bool value) ;

/// @brief Method get_inputActionsPerSecond addr 0x2c562a4 size 0x8 virtual false final false
 float_t get_inputActionsPerSecond() ;

/// @brief Method set_inputActionsPerSecond addr 0x2c562ac size 0x8 virtual false final false
 void set_inputActionsPerSecond(float_t value) ;

/// @brief Method get_repeatDelay addr 0x2c562b4 size 0x8 virtual false final false
 float_t get_repeatDelay() ;

/// @brief Method set_repeatDelay addr 0x2c562bc size 0x8 virtual false final false
 void set_repeatDelay(float_t value) ;

/// @brief Method get_horizontalAxis addr 0x2c562c4 size 0x8 virtual false final false
 ::StringW get_horizontalAxis() ;

/// @brief Method set_horizontalAxis addr 0x2c562cc size 0x8 virtual false final false
 void set_horizontalAxis(::StringW value) ;

/// @brief Method get_verticalAxis addr 0x2c562d4 size 0x8 virtual false final false
 ::StringW get_verticalAxis() ;

/// @brief Method set_verticalAxis addr 0x2c562dc size 0x8 virtual false final false
 void set_verticalAxis(::StringW value) ;

/// @brief Method get_submitButton addr 0x2c562e4 size 0x8 virtual false final false
 ::StringW get_submitButton() ;

/// @brief Method set_submitButton addr 0x2c562ec size 0x8 virtual false final false
 void set_submitButton(::StringW value) ;

/// @brief Method get_cancelButton addr 0x2c562f4 size 0x8 virtual false final false
 ::StringW get_cancelButton() ;

/// @brief Method set_cancelButton addr 0x2c562fc size 0x8 virtual false final false
 void set_cancelButton(::StringW value) ;

/// @brief Method ShouldIgnoreEventsOnNoFocus addr 0x2c56304 size 0x8 virtual false final false
 bool ShouldIgnoreEventsOnNoFocus() ;

/// @brief Method UpdateModule addr 0x2c5630c size 0xd0 virtual true final false
 void UpdateModule() ;

/// @brief Method ReleaseMouse addr 0x2c563dc size 0x36c virtual false final false
 void ReleaseMouse(UnityEngine::EventSystems::PointerEventData pointerEvent, UnityEngine::GameObject currentOverGo) ;

/// @brief Method ShouldActivateModule addr 0x2c56748 size 0x234 virtual true final false
 bool ShouldActivateModule() ;

/// @brief Method ActivateModule addr 0x2c5697c size 0x100 virtual true final false
 void ActivateModule() ;

/// @brief Method DeactivateModule addr 0x2c56a7c size 0x4 virtual true final false
 void DeactivateModule() ;

/// @brief Method Process addr 0x2c56a80 size 0xa4 virtual true final false
 void Process() ;

/// @brief Method ProcessTouchEvents addr 0x2c56c6c size 0x164 virtual false final false
 bool ProcessTouchEvents() ;

/// @brief Method ProcessTouchPress addr 0x2c57248 size 0x664 virtual false final false
 void ProcessTouchPress(UnityEngine::EventSystems::PointerEventData pointerEvent, bool pressed, bool released) ;

/// @brief Method SendSubmitEventToSelectedObject addr 0x2c5703c size 0x20c virtual false final false
 bool SendSubmitEventToSelectedObject() ;

/// @brief Method GetRawMoveVector addr 0x2c578ac size 0x110 virtual false final false
 UnityEngine::Vector2 GetRawMoveVector() ;

/// @brief Method SendMoveEventToSelectedObject addr 0x2c56dd8 size 0x264 virtual false final false
 bool SendMoveEventToSelectedObject() ;

/// @brief Method ProcessMouseEvent addr 0x2c56dd0 size 0x8 virtual false final false
 void ProcessMouseEvent() ;

/// @brief Method ForceAutoSelect addr 0x2c57c64 size 0x8 virtual true final false
 bool ForceAutoSelect() ;

/// @brief Method ProcessMouseEvent addr 0x2c579bc size 0x2a8 virtual false final false
 void ProcessMouseEvent(int32_t id) ;

/// @brief Method SendUpdateEventToSelectedObject addr 0x2c56b24 size 0x148 virtual false final false
 bool SendUpdateEventToSelectedObject() ;

/// @brief Method ProcessMousePress addr 0x2c57c6c size 0x354 virtual false final false
 void ProcessMousePress(UnityEngine::EventSystems::UnityEngine__EventSystems__PointerInputModule__MouseButtonEventData data) ;

/// @brief Method GetCurrentFocusedGameObject addr 0x2c57fc0 size 0x8 virtual false final false
