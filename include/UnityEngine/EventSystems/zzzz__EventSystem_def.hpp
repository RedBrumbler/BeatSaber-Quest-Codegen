...
/// @brief Method .ctor addr 0x2c50a74 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <CreateUIToolkitPanelGameObject>b__0 addr 0x2c51630 size 0x5c virtual false final false
...
/// @brief Method get_current addr 0x2c4f8b8 size 0xc4 virtual false final false
static UnityEngine::EventSystems::EventSystem get_current() ;

/// @brief Method set_current addr 0x2c4f97c size 0x194 virtual false final false
static void set_current(UnityEngine::EventSystems::EventSystem value) ;

/// @brief Method get_sendNavigationEvents addr 0x2c4fb10 size 0x8 virtual false final false
 bool get_sendNavigationEvents() ;

/// @brief Method set_sendNavigationEvents addr 0x2c4fb18 size 0xc virtual false final false
 void set_sendNavigationEvents(bool value) ;

/// @brief Method get_pixelDragThreshold addr 0x2c4fb24 size 0x8 virtual false final false
 int32_t get_pixelDragThreshold() ;

/// @brief Method set_pixelDragThreshold addr 0x2c4fb2c size 0x8 virtual false final false
 void set_pixelDragThreshold(int32_t value) ;

/// @brief Method get_currentInputModule addr 0x2c4fb34 size 0x8 virtual false final false
 UnityEngine::EventSystems::BaseInputModule get_currentInputModule() ;

/// @brief Method get_firstSelectedGameObject addr 0x2c4fb3c size 0x8 virtual false final false
 UnityEngine::GameObject get_firstSelectedGameObject() ;

/// @brief Method set_firstSelectedGameObject addr 0x2c4fb44 size 0x8 virtual false final false
 void set_firstSelectedGameObject(UnityEngine::GameObject value) ;

/// @brief Method get_currentSelectedGameObject addr 0x2c4fb4c size 0x8 virtual false final false
 UnityEngine::GameObject get_currentSelectedGameObject() ;

/// @brief Method get_lastSelectedGameObject addr 0x2c4fb54 size 0x8 virtual false final false
 UnityEngine::GameObject get_lastSelectedGameObject() ;

/// @brief Method get_isFocused addr 0x2c4fb5c size 0x8 virtual false final false
 bool get_isFocused() ;

// Ctor Parameters []
explicit EventSystem() ;

/// @brief Method .ctor addr 0x2c4fb64 size 0x90 virtual false final false
 void _ctor() ;

/// @brief Method UpdateModules addr 0x2c4fbf4 size 0x140 virtual false final false
 void UpdateModules() ;

/// @brief Method get_alreadySelecting addr 0x2c4fd34 size 0x8 virtual false final false
 bool get_alreadySelecting() ;

/// @brief Method SetSelectedGameObject addr 0x2c4e47c size 0x224 virtual false final false
 void SetSelectedGameObject(UnityEngine::GameObject selected, UnityEngine::EventSystems::BaseEventData pointer) ;

/// @brief Method get_baseEventDataCache addr 0x2c4fd3c size 0x70 virtual false final false
 UnityEngine::EventSystems::BaseEventData get_baseEventDataCache() ;

/// @brief Method SetSelectedGameObject addr 0x2c4b9d0 size 0x2c virtual false final false
 void SetSelectedGameObject(UnityEngine::GameObject selected) ;

/// @brief Method RaycastComparer addr 0x2c4fdac size 0x364 virtual false final false
static int32_t RaycastComparer(UnityEngine::EventSystems::RaycastResult lhs, UnityEngine::EventSystems::RaycastResult rhs) ;

/// @brief Method RaycastAll addr 0x2c501c8 size 0x1f0 virtual false final false
...
/// @brief Method IsPointerOverGameObject addr 0x2c503b8 size 0x8 virtual false final false
 bool IsPointerOverGameObject() ;

/// @brief Method IsPointerOverGameObject addr 0x2c503c0 size 0xa4 virtual false final false
 bool IsPointerOverGameObject(int32_t pointerId) ;

/// @brief Method get_isUIToolkitActiveEventSystem addr 0x2c50464 size 0xf0 virtual false final false
 bool get_isUIToolkitActiveEventSystem() ;

/// @brief Method get_sendUIToolkitEvents addr 0x2c50554 size 0x74 virtual false final false
 bool get_sendUIToolkitEvents() ;

/// @brief Method get_createUIToolkitPanelGameObjectsOnStart addr 0x2c505c8 size 0x74 virtual false final false
 bool get_createUIToolkitPanelGameObjectsOnStart() ;

/// @brief Method SetUITookitEventSystemOverride addr 0x2c5063c size 0x19c virtual false final false
...
/// @brief Method CreateUIToolkitPanelGameObject addr 0x2c507d8 size 0x29c virtual false final false
 void CreateUIToolkitPanelGameObject(UnityEngine::UIElements::BaseRuntimePanel panel) ;

/// @brief Method Start addr 0x2c50a7c size 0x23c virtual true final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2c50cbc size 0xa4 virtual true final false
 void OnDestroy() ;

/// @brief Method OnEnable addr 0x2c50d64 size 0x110 virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2c50e74 size 0x108 virtual true final false
 void OnDisable() ;

/// @brief Method TickModules addr 0x2c50f7c size 0x100 virtual false final false
 void TickModules() ;

/// @brief Method OnApplicationFocus addr 0x2c5107c size 0x14 virtual true final false
 void OnApplicationFocus(bool hasFocus) ;

/// @brief Method Update addr 0x2c51090 size 0x260 virtual true final false
 void Update() ;

/// @brief Method ChangeEventModule addr 0x2c512f0 size 0xf8 virtual false final false
 void ChangeEventModule(UnityEngine::EventSystems::BaseInputModule module) ;

/// @brief Method ToString addr 0x2c513e8 size 0x158 virtual true final false
 ::StringW ToString() ;
