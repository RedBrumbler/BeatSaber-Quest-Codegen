...
/// @brief Method get_gameObject addr 0x2c5a3d8 size 0x8 virtual false final false
 UnityEngine::GameObject get_gameObject() ;

/// @brief Method set_gameObject addr 0x2c5a3e0 size 0x8 virtual false final false
 void set_gameObject(UnityEngine::GameObject value) ;

/// @brief Method get_isValid addr 0x2c5a3e8 size 0x98 virtual false final false
 bool get_isValid() ;

/// @brief Method Clear addr 0x2c5a480 size 0xa4 virtual false final false
 void Clear() ;

/// @brief Method ToString addr 0x2c4f1e0 size 0x6d8 virtual true final false
 ::StringW ToString() ;
