...
/// @brief Method .ctor addr 0x2c57fc8 size 0x4 virtual false final false
 void _ctor() ;

/// @brief Method get_allowActivationOnStandalone addr 0x2c57fcc size 0x8 virtual false final false
 bool get_allowActivationOnStandalone() ;

/// @brief Method set_allowActivationOnStandalone addr 0x2c57fd4 size 0xc virtual false final false
 void set_allowActivationOnStandalone(bool value) ;

/// @brief Method get_forceModuleActive addr 0x2c57fe0 size 0x8 virtual false final false
 bool get_forceModuleActive() ;

/// @brief Method set_forceModuleActive addr 0x2c57fe8 size 0xc virtual false final false
 void set_forceModuleActive(bool value) ;

/// @brief Method UpdateModule addr 0x2c57ff4 size 0x150 virtual true final false
 void UpdateModule() ;

/// @brief Method IsModuleSupported addr 0x2c58144 size 0x38 virtual true final false
 bool IsModuleSupported() ;

/// @brief Method ShouldActivateModule addr 0x2c5817c size 0xa4 virtual true final false
 bool ShouldActivateModule() ;

/// @brief Method UseFakeInput addr 0x2c58220 size 0x30 virtual false final false
 bool UseFakeInput() ;

/// @brief Method Process addr 0x2c58250 size 0x28 virtual true final false
 void Process() ;

/// @brief Method FakeTouches addr 0x2c58278 size 0x124 virtual false final false
 void FakeTouches() ;

/// @brief Method ProcessTouchEvents addr 0x2c5839c size 0x148 virtual false final false
 void ProcessTouchEvents() ;

/// @brief Method ProcessTouchPress addr 0x2c584e4 size 0x668 virtual false final false
 void ProcessTouchPress(UnityEngine::EventSystems::PointerEventData pointerEvent, bool pressed, bool released) ;

/// @brief Method DeactivateModule addr 0x2c58b4c size 0x4 virtual true final false
 void DeactivateModule() ;

/// @brief Method ToString addr 0x2c58b50 size 0x250 virtual true final false
 ::StringW ToString() ;
