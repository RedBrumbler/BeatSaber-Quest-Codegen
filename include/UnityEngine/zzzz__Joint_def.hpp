...
/// @brief Method get_connectedBody addr 0x2bd23b0 size 0x3c virtual false final false
 UnityEngine::Rigidbody get_connectedBody() ;

/// @brief Method set_connectedAnchor addr 0x2bd23ec size 0x54 virtual false final false
 void set_connectedAnchor(UnityEngine::Vector3 value) ;

/// @brief Method set_connectedAnchor_Injected addr 0x2bd2440 size 0x44 virtual false final false
