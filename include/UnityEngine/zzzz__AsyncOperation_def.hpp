...
/// @brief Method Finalize addr 0x2b8b4c0 size 0xbc virtual true final false
 void Finalize() ;

/// @brief Method InvokeCompletionEvent addr 0x2b8b5b8 size 0x30 virtual false final false
 void InvokeCompletionEvent() ;

/// @brief Method add_completed addr 0x2b8b5e8 size 0xfc virtual false final false
 void add_completed(System::Action_1<UnityEngine::AsyncOperation> value) ;

/// @brief Method remove_completed addr 0x2b8b720 size 0xa8 virtual false final false
 void remove_completed(System::Action_1<UnityEngine::AsyncOperation> value) ;

/// @brief Method InternalDestroy addr 0x2b8b57c size 0x3c virtual false final false
static void InternalDestroy(::cordl_internals::intptr_t ptr) ;

/// @brief Method get_isDone addr 0x2b8b6e4 size 0x3c virtual false final false
 bool get_isDone() ;

/// @brief Method get_progress addr 0x2b8b7c8 size 0x3c virtual false final false
 float_t get_progress() ;

/// @brief Method set_priority addr 0x2b8b804 size 0x44 virtual false final false
 void set_priority(int32_t value) ;

/// @brief Method get_allowSceneActivation addr 0x2b8b848 size 0x3c virtual false final false
 bool get_allowSceneActivation() ;

/// @brief Method set_allowSceneActivation addr 0x2b8b884 size 0x44 virtual false final false
 void set_allowSceneActivation(bool value) ;

// Ctor Parameters []
explicit AsyncOperation() ;

/// @brief Method .ctor addr 0x2b8b8c8 size 0x8 virtual false final false
 void _ctor() ;
