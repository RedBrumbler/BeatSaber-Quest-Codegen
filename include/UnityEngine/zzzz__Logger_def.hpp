...
/// @brief Method .ctor addr 0x2b5d7a0 size 0x38 virtual false final false
 void _ctor(UnityEngine::ILogHandler logHandler) ;

/// @brief Method get_logHandler addr 0x2b5da28 size 0x8 virtual true final true
 UnityEngine::ILogHandler get_logHandler() ;

/// @brief Method set_logHandler addr 0x2b5da30 size 0x8 virtual true final true
 void set_logHandler(UnityEngine::ILogHandler value) ;

/// @brief Method get_logEnabled addr 0x2b5da38 size 0x8 virtual true final true
 bool get_logEnabled() ;

/// @brief Method set_logEnabled addr 0x2b5da40 size 0xc virtual true final true
 void set_logEnabled(bool value) ;

/// @brief Method get_filterLogType addr 0x2b5da4c size 0x8 virtual true final true
 UnityEngine::LogType get_filterLogType() ;

/// @brief Method set_filterLogType addr 0x2b5da54 size 0x8 virtual true final true
 void set_filterLogType(UnityEngine::LogType value) ;

/// @brief Method IsLogTypeAllowed addr 0x2b5da5c size 0x3c virtual true final true
 bool IsLogTypeAllowed(UnityEngine::LogType logType) ;

/// @brief Method GetString addr 0x2b5da98 size 0x120 virtual false final false
static ::StringW GetString(::bs_hook::Il2CppWrapperType message) ;

/// @brief Method Log addr 0x2b5dbb8 size 0x174 virtual true final true
 void Log(UnityEngine::LogType logType, ::bs_hook::Il2CppWrapperType message) ;

/// @brief Method Log addr 0x2b5dd2c size 0x178 virtual true final true
 void Log(UnityEngine::LogType logType, ::bs_hook::Il2CppWrapperType message, UnityEngine::Object context) ;

/// @brief Method LogError addr 0x2b5dea4 size 0x190 virtual true final true
 void LogError(::StringW tag, ::bs_hook::Il2CppWrapperType message) ;

/// @brief Method LogException addr 0x2b5e034 size 0xd4 virtual true final true
 void LogException(System::Exception exception, UnityEngine::Object context) ;

/// @brief Method LogFormat addr 0x2b5e108 size 0xf8 virtual true final true
 void LogFormat(UnityEngine::LogType logType, ::StringW format, ::ArrayW<::bs_hook::Il2CppWrapperType> args) ;

/// @brief Method LogFormat addr 0x2b5e200 size 0x108 virtual true final true
