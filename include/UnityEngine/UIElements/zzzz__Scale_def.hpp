...
/// @brief Method .ctor addr 0x2d2f9d8 size 0x14 virtual false final false
 void _ctor(UnityEngine::Vector3 scale) ;

/// @brief Method Initial addr 0x2d2f9ec size 0x44 virtual false final false
static UnityEngine::UIElements::Scale Initial() ;

/// @brief Method None addr 0x2d2b008 size 0x18 virtual false final false
static UnityEngine::UIElements::Scale None() ;

/// @brief Method get_value addr 0x2d2fa30 size 0xc virtual false final false
 UnityEngine::Vector3 get_value() ;

/// @brief Method op_Equality addr 0x2d267c8 size 0x54 virtual false final false
static bool op_Equality(UnityEngine::UIElements::Scale lhs, UnityEngine::UIElements::Scale rhs) ;

/// @brief Method op_Inequality addr 0x2d2fa3c size 0x54 virtual false final false
static bool op_Inequality(UnityEngine::UIElements::Scale lhs, UnityEngine::UIElements::Scale rhs) ;

/// @brief Method Equals addr 0x2d2fa90 size 0x4c virtual true final true
 bool Equals(UnityEngine::UIElements::Scale other) ;

/// @brief Method Equals addr 0x2d2fadc size 0xbc virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d26990 size 0x50 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2d2fb98 size 0x8 virtual true final false
 ::StringW ToString() ;
