...
/// @brief Method .ctor addr 0x2d313cc size 0x90 virtual false final false
 void _ctor() ;

/// @brief Method get_profilerMarker addr 0x2d3145c size 0x58 virtual true final false
 Unity::Profiling::ProfilerMarker get_profilerMarker() ;

/// @brief Method get_drawStats addr 0x2d314b4 size 0x8 virtual false final false
 bool get_drawStats() ;

/// @brief Method get_breakBatches addr 0x2d314bc size 0x8 virtual false final false
 bool get_breakBatches() ;

/// @brief Method OnVersionChanged addr 0x2d314c4 size 0xf8 virtual true final false
 void OnVersionChanged(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::VersionChangeType versionChangeType) ;

/// @brief Method Update addr 0x2d315bc size 0xbc virtual true final false
 void Update() ;

/// @brief Method CreateRenderChain addr 0x2d31734 size 0x78 virtual true final false
 UnityEngine::UIElements::UIR::RenderChain CreateRenderChain() ;

/// @brief Method OnGraphicsResourcesRecreate addr 0x2d318b8 size 0x1d0 virtual false final false
static void OnGraphicsResourcesRecreate(bool recreate) ;

/// @brief Method OnPanelChanged addr 0x2d31ad8 size 0x18 virtual false final false
 void OnPanelChanged(UnityEngine::UIElements::BaseVisualElementPanel obj) ;

/// @brief Method AttachToPanel addr 0x2d31c94 size 0x1f4 virtual false final false
 void AttachToPanel() ;

/// @brief Method DetachFromPanel addr 0x2d31af0 size 0x1a4 virtual false final false
 void DetachFromPanel() ;

/// @brief Method InitRenderChain addr 0x2d31678 size 0xbc virtual false final false
 void InitRenderChain() ;

/// @brief Method DestroyRenderChain addr 0x2d31a88 size 0x50 virtual false final false
 void DestroyRenderChain() ;

/// @brief Method OnPanelAtlasChanged addr 0x2d32260 size 0x4 virtual false final false
 void OnPanelAtlasChanged() ;

/// @brief Method OnPanelHierarchyChanged addr 0x2d32264 size 0x38 virtual false final false
...
/// @brief Method OnPanelStandardShaderChanged addr 0x2d31e88 size 0x1a4 virtual false final false
 void OnPanelStandardShaderChanged() ;

/// @brief Method OnPanelStandardWorldSpaceShaderChanged addr 0x2d3202c size 0x1a4 virtual false final false
 void OnPanelStandardWorldSpaceShaderChanged() ;

/// @brief Method ResetAllElementsDataRecursive addr 0x2d321d0 size 0x90 virtual false final false
 void ResetAllElementsDataRecursive(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method get_disposed addr 0x2d3229c size 0x8 virtual false final false
 bool get_disposed() ;

/// @brief Method set_disposed addr 0x2d322a4 size 0xc virtual false final false
 void set_disposed(bool value) ;

/// @brief Method Dispose addr 0x2d322b0 size 0x2c virtual true final false
