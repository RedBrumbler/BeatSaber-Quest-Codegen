...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7271)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7271), inst: 4506 })}
...
/// @brief Method .ctor addr 0x2d02cc0 size 0x48 virtual false final false
 void _ctor() ;
