...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6986))}
...
/// @brief Method .ctor addr 0x2cd3930 size 0x68 virtual false final false
...
/// @brief Method ValidateHierarchyTraversal addr 0x2cd3998 size 0xb0 virtual false final false
 bool ValidateHierarchyTraversal(UnityEngine::UIElements::VisualElement v) ;

/// @brief Method ValidateElement addr 0x2cd3a48 size 0xc4 virtual false final false
 bool ValidateElement(UnityEngine::UIElements::VisualElement v) ;

/// @brief Method Order addr 0x2cd3b0c size 0xec virtual false final false
 int32_t Order(UnityEngine::UIElements::VisualElement a, UnityEngine::UIElements::VisualElement b) ;

/// @brief Method StrictOrder addr 0x2cd3f20 size 0x84 virtual false final false
 int32_t StrictOrder(UnityEngine::UIElements::VisualElement a, UnityEngine::UIElements::VisualElement b) ;

/// @brief Method StrictOrder addr 0x2cd3bf8 size 0x1f4 virtual false final false
 int32_t StrictOrder(UnityEngine::Rect ra, UnityEngine::Rect rb) ;

/// @brief Method TieBreaker addr 0x2cd3dec size 0x134 virtual false final false
 int32_t TieBreaker(UnityEngine::Rect ra, UnityEngine::Rect rb) ;

/// @brief Method GetBestOverall addr 0x2cd3354 size 0x13c virtual false final false
...
/// @brief Method get_focusController addr 0x2cd262c size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x2cd1b14 size 0x84 virtual false final false
 void _ctor(UnityEngine::UIElements::VisualElement root) ;

/// @brief Method GetFocusChangeDirection addr 0x2cd2650 size 0x438 virtual true final true
...
/// @brief Method GetNextFocusable addr 0x2cd2a88 size 0x2b4 virtual true final false
...
/// @brief Method GetNextFocusable2D addr 0x2cd2d3c size 0x590 virtual false final false
...
/// @brief Method IsActive addr 0x2cd34f0 size 0xd8 virtual false final false
static bool IsActive(UnityEngine::UIElements::VisualElement v) ;

/// @brief Method IsFocusable addr 0x2cd35c8 size 0x40 virtual false final false
static bool IsFocusable(UnityEngine::UIElements::Focusable focusable) ;

/// @brief Method IsLeaf addr 0x2cd3608 size 0x40 virtual false final false
static bool IsLeaf(UnityEngine::UIElements::Focusable focusable) ;

/// @brief Method IsFocusRoot addr 0x2cd3648 size 0xb0 virtual false final false
static bool IsFocusRoot(UnityEngine::UIElements::VisualElement focusable) ;

/// @brief Method GetLeafFocusable addr 0x2cd3490 size 0x60 virtual false final false
static UnityEngine::UIElements::VisualElement GetLeafFocusable(UnityEngine::UIElements::VisualElement v) ;

/// @brief Method GetLeafFocusableRecursive addr 0x2cd36f8 size 0x10c virtual false final false
static UnityEngine::UIElements::VisualElement GetLeafFocusableRecursive(UnityEngine::UIElements::VisualElement v) ;

/// @brief Method GetRootFocusable addr 0x2cd32cc size 0x88 virtual false final false
