...
/// @brief Method .ctor addr 0x2c81634 size 0x8 virtual false final false
 void _ctor(UnityEngine::UIElements::VisualElement element) ;

/// @brief Method Add addr 0x2c8163c size 0x1d0 virtual false final false
 void Add(UnityEngine::UIElements::StyleSheet styleSheet) ;

/// @brief Method Remove addr 0x2c8180c size 0x134 virtual false final false
 bool Remove(UnityEngine::UIElements::StyleSheet styleSheet) ;

/// @brief Method Equals addr 0x2c81940 size 0xc virtual true final true
 bool Equals(UnityEngine::UIElements::VisualElementStyleSheetSet other) ;

/// @brief Method Equals addr 0x2c8194c size 0x7c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2c819c8 size 0x18 virtual true final false
 int32_t GetHashCode() ;
