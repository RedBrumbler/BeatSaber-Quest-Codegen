...
/// @brief Method get_MeasuredSizes addr 0x2d0060c size 0x8 virtual true final true
 UnityEngine::Vector2 get_MeasuredSizes() ;

/// @brief Method set_MeasuredSizes addr 0x2d00614 size 0x8 virtual true final true
 void set_MeasuredSizes(UnityEngine::Vector2 value) ;

/// @brief Method get_RoundedSizes addr 0x2d0061c size 0x8 virtual true final true
 UnityEngine::Vector2 get_RoundedSizes() ;

/// @brief Method set_RoundedSizes addr 0x2d00624 size 0x8 virtual true final true
 void set_RoundedSizes(UnityEngine::Vector2 value) ;

/// @brief Method New addr 0x2d0062c size 0xc0 virtual false final false
static UnityEngine::UIElements::ITextHandle New() ;

/// @brief Method get_textInfoMesh addr 0x2d006ec size 0x6c virtual false final false
 UnityEngine::TextCore::Text::TextInfo get_textInfoMesh() ;

/// @brief Method get_textInfoLayout addr 0x2d00758 size 0xc0 virtual false final false
static UnityEngine::TextCore::Text::TextInfo get_textInfoLayout() ;

/// @brief Method IsLegacy addr 0x2d00818 size 0x8 virtual true final true
 bool IsLegacy() ;

/// @brief Method IsDirty addr 0x2d00820 size 0x44 virtual false final false
 bool IsDirty(UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__TextParams parms) ;

/// @brief Method GetCursorPosition addr 0x2d00864 size 0x28 virtual true final true
 UnityEngine::Vector2 GetCursorPosition(UnityEngine::UIElements::CursorPositionStylePainterParameters parms, float_t scaling) ;

/// @brief Method ComputeTextWidth addr 0x2d0088c size 0x34 virtual true final true
...
/// @brief Method ComputeTextHeight addr 0x2d009f0 size 0x34 virtual true final true
...
/// @brief Method GetLineHeight addr 0x2d00a24 size 0x68 virtual true final true
...
/// @brief Method Update addr 0x2d00a8c size 0x208 virtual true final true
...
/// @brief Method UpdatePreferredValues addr 0x2d008c0 size 0x130 virtual false final false
 void UpdatePreferredValues(UnityEngine::UIElements::UnityEngine__UIElements__MeshGenerationContextUtils__TextParams parms) ;

/// @brief Method GetTextOverflowMode addr 0x2d00f40 size 0x3c virtual false final false
...
/// @brief Method UpdateGenerationSettingsCommon addr 0x2d00c94 size 0x2ac virtual false final false
...
/// @brief Method IsElided addr 0x2d0115c size 0x64 virtual true final true
 bool IsElided() ;
