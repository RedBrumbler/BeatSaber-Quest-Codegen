...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7306)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7306), inst: 4992 })}
...
/// @brief Method .ctor addr 0x2d09764 size 0x48 virtual false final false
 void _ctor() ;
