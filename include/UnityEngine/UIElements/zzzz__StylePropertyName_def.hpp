...
/// @brief Method get_id addr 0x2c74164 size 0x8 virtual false final false
 UnityEngine::UIElements::StyleSheets::StylePropertyId get_id() ;

/// @brief Method get_name addr 0x2c7416c size 0x8 virtual false final false
 ::StringW get_name() ;

/// @brief Method StylePropertyIdFromString addr 0x2c74174 size 0xa0 virtual false final false
static UnityEngine::UIElements::StyleSheets::StylePropertyId StylePropertyIdFromString(::StringW name) ;

/// @brief Method .ctor addr 0x2c74214 size 0xac virtual false final false
 void _ctor(UnityEngine::UIElements::StyleSheets::StylePropertyId stylePropertyId) ;

/// @brief Method .ctor addr 0x2c742c0 size 0x34 virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method op_Equality addr 0x2c742f4 size 0xc virtual false final false
static bool op_Equality(UnityEngine::UIElements::StylePropertyName lhs, UnityEngine::UIElements::StylePropertyName rhs) ;

/// @brief Method op_Inequality addr 0x2c74300 size 0xc virtual false final false
static bool op_Inequality(UnityEngine::UIElements::StylePropertyName lhs, UnityEngine::UIElements::StylePropertyName rhs) ;

/// @brief Method op_Implicit addr 0x2c7430c size 0x20 virtual false final false
static UnityEngine::UIElements::StylePropertyName op_Implicit_UnityEngine__UIElements__StylePropertyName(::StringW name) ;

/// @brief Method GetHashCode addr 0x2c7432c size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2c74334 size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method Equals addr 0x2c743ac size 0x10 virtual true final true
 bool Equals(UnityEngine::UIElements::StylePropertyName other) ;

/// @brief Method ToString addr 0x2c743bc size 0x8 virtual true final false
 ::StringW ToString() ;
