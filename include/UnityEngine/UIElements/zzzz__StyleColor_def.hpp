...
/// @brief Method get_value addr 0x2d28d00 size 0x28 virtual true final true
 UnityEngine::Color get_value() ;

/// @brief Method get_keyword addr 0x2d28d28 size 0x8 virtual true final true
 UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method .ctor addr 0x2d28d30 size 0x10 virtual false final false
 void _ctor(UnityEngine::Color v) ;

/// @brief Method .ctor addr 0x2d28d40 size 0x10 virtual false final false
 void _ctor(UnityEngine::Color v, UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method op_Equality addr 0x2d28d50 size 0x64 virtual false final false
static bool op_Equality(UnityEngine::UIElements::StyleColor lhs, UnityEngine::UIElements::StyleColor rhs) ;

/// @brief Method op_Implicit addr 0x2d28db4 size 0x10 virtual false final false
static UnityEngine::UIElements::StyleColor op_Implicit_UnityEngine__UIElements__StyleColor(UnityEngine::Color v) ;

/// @brief Method Equals addr 0x2d28dc4 size 0x64 virtual true final true
 bool Equals(UnityEngine::UIElements::StyleColor other) ;

/// @brief Method Equals addr 0x2d28e28 size 0x90 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d28eb8 size 0x98 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2d28f50 size 0x88 virtual true final false
 ::StringW ToString() ;
