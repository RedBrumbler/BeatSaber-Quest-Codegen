...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6847)), TypeDefinitionIndex(TypeDefinitionIndex(7108)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7108), inst: 5122 }), TypeDefinitionIndex(TypeDefinitionIndex(7084))}
...
/// @brief Method get_uxmlName addr 0x2cc8f4c size 0x40 virtual true final false
 ::StringW get_uxmlName() ;

/// @brief Method get_uxmlQualifiedName addr 0x2cc8f8c size 0x74 virtual true final false
 ::StringW get_uxmlQualifiedName() ;

/// @brief Method Create addr 0x2cc9000 size 0x8 virtual true final false
...
/// @brief Method .ctor addr 0x2cc9008 size 0x48 virtual false final false
 void _ctor() ;
