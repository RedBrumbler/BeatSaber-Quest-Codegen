...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7298), inst: 1639 }), TypeDefinitionIndex(TypeDefinitionIndex(7298)), TypeDefinitionIndex(TypeDefinitionIndex(7306))}
