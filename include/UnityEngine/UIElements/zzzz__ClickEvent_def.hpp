...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7316)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7316), inst: 4685 })}
...
/// @brief Method Init addr 0x2d0b3f0 size 0x54 virtual true final false
 void Init() ;

/// @brief Method LocalInit addr 0x2d0b444 size 0xc virtual false final false
 void LocalInit() ;

// Ctor Parameters []
explicit ClickEvent() ;

/// @brief Method .ctor addr 0x2d0b450 size 0x54 virtual false final false
 void _ctor() ;

/// @brief Method GetPooled addr 0x2d0b4a4 size 0x70 virtual false final false
