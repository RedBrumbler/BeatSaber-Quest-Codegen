...
/// @brief Method Get addr 0x2d05ba8 size 0xc4 virtual false final false
 UnityEngine::UIElements::EventCallbackList Get(UnityEngine::UIElements::EventCallbackList initializer) ;

/// @brief Method Release addr 0x2d05f0c size 0x64 virtual false final false
 void Release(UnityEngine::UIElements::EventCallbackList element) ;

// Ctor Parameters []
explicit EventCallbackListPool() ;

/// @brief Method .ctor addr 0x2d05fdc size 0x7c virtual false final false
 void _ctor() ;
