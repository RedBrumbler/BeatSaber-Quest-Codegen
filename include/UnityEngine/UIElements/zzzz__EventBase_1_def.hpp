...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7298)), TypeDefinitionIndex(TypeDefinitionIndex(7297))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7298), inst: 2 })
