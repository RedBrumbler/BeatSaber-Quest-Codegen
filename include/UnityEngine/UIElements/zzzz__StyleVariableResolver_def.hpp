...
/// @brief Method get_currentSheet addr 0x2d23e88 size 0x8 virtual false final false
 UnityEngine::UIElements::StyleSheet get_currentSheet() ;

/// @brief Method get_currentHandles addr 0x2d23e90 size 0x8 virtual false final false
 ::ArrayW<UnityEngine::UIElements::StyleValueHandle> get_currentHandles() ;

/// @brief Method get_resolvedValues addr 0x2d23e98 size 0x8 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::UIElements::StyleSheets::StylePropertyValue> get_resolvedValues() ;

/// @brief Method get_variableContext addr 0x2d23ea0 size 0x8 virtual false final false
 UnityEngine::UIElements::StyleVariableContext get_variableContext() ;

/// @brief Method set_variableContext addr 0x2d23ea8 size 0x8 virtual false final false
 void set_variableContext(UnityEngine::UIElements::StyleVariableContext value) ;

/// @brief Method Init addr 0x2d23eb0 size 0xb0 virtual false final false
...
/// @brief Method PushContext addr 0x2d23f60 size 0x6c virtual false final false
 void PushContext(UnityEngine::UIElements::StyleSheet sheet, ::ArrayW<UnityEngine::UIElements::StyleValueHandle> handles) ;

/// @brief Method PopContext addr 0x2d23fcc size 0x7c virtual false final false
 void PopContext() ;

/// @brief Method AddValue addr 0x2d24048 size 0xac virtual false final false
 void AddValue(UnityEngine::UIElements::StyleValueHandle handle) ;

/// @brief Method ResolveVarFunction addr 0x2d240f4 size 0xcc virtual false final false
 bool ResolveVarFunction(ByRef<int32_t> index) ;

/// @brief Method ResolveVarFunction addr 0x2d24270 size 0x15c virtual false final false
...
/// @brief Method ValidateResolvedValues addr 0x2d248d0 size 0x170 virtual false final false
 bool ValidateResolvedValues() ;

/// @brief Method ResolveVariable addr 0x2d243cc size 0x278 virtual false final false
 UnityEngine::UIElements::UnityEngine__UIElements__StyleVariableResolver__Result ResolveVariable(::StringW variableName) ;

/// @brief Method ResolveFallback addr 0x2d2464c size 0x284 virtual false final false
 UnityEngine::UIElements::UnityEngine__UIElements__StyleVariableResolver__Result ResolveFallback(ByRef<int32_t> index) ;

/// @brief Method ParseVarFunction addr 0x2d241c0 size 0xb0 virtual false final false
...
/// @brief Method .ctor addr 0x2d24b98 size 0x134 virtual false final false
 void _ctor() ;
