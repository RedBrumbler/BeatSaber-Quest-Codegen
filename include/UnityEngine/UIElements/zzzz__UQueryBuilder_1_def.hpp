...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2638)), TypeDefinitionIndex(TypeDefinitionIndex(7037))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7037), inst: 2 })
