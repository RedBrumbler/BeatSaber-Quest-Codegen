...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7316), inst: 4686 }), TypeDefinitionIndex(TypeDefinitionIndex(7316))}
...
/// @brief Method Init addr 0x2d0af18 size 0x50 virtual true final false
 void Init() ;

/// @brief Method LocalInit addr 0x2d0af68 size 0x104 virtual false final false
 void LocalInit() ;

// Ctor Parameters []
explicit PointerCancelEvent() ;

/// @brief Method .ctor addr 0x2d0b06c size 0x50 virtual false final false
 void _ctor() ;

/// @brief Method PostDispatch addr 0x2d0b0bc size 0x330 virtual true final false
