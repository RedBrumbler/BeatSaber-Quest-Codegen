...
/// @brief Method PropagateEvent addr 0x2d06ba8 size 0x74c virtual false final false
static void PropagateEvent(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method PropagateToIMGUIContainer addr 0x2d07300 size 0x224 virtual false final false
static void PropagateToIMGUIContainer(UnityEngine::UIElements::VisualElement root, UnityEngine::UIElements::EventBase evt) ;

/// @brief Method ExecuteDefaultAction addr 0x2d0e494 size 0x1a8 virtual false final false
