...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7485)), TypeDefinitionIndex(TypeDefinitionIndex(7489)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7489), inst: 5180 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7485), inst: 2 })
