...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7268), inst: 4681 }), TypeDefinitionIndex(TypeDefinitionIndex(7268))}
...
/// @brief Method .ctor addr 0x2d02c78 size 0x48 virtual false final false
 void _ctor() ;
