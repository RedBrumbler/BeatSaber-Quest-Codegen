...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6847)), TypeDefinitionIndex(TypeDefinitionIndex(7108)), TypeDefinitionIndex(TypeDefinitionIndex(7081)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7108), inst: 5121 })}
...
/// @brief Method get_uxmlName addr 0x2cc8b94 size 0x40 virtual true final false
 ::StringW get_uxmlName() ;

/// @brief Method get_uxmlQualifiedName addr 0x2cc8bd4 size 0x74 virtual true final false
 ::StringW get_uxmlQualifiedName() ;

/// @brief Method Create addr 0x2cc8c48 size 0x8 virtual true final false
...
/// @brief Method .ctor addr 0x2cc8c50 size 0x48 virtual false final false
 void _ctor() ;
