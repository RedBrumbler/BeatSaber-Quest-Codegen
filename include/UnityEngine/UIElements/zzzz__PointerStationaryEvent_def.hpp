...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7316), inst: 4692 }), TypeDefinitionIndex(TypeDefinitionIndex(7316))}
...
/// @brief Method Init addr 0x2d0a8a0 size 0x50 virtual true final false
 void Init() ;

/// @brief Method LocalInit addr 0x2d0a8f0 size 0x104 virtual false final false
 void LocalInit() ;

// Ctor Parameters []
explicit PointerStationaryEvent() ;

/// @brief Method .ctor addr 0x2d0a9f4 size 0x50 virtual false final false
 void _ctor() ;
