...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7306)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7306), inst: 4990 })}
...
/// @brief Method .ctor addr 0x2d097ac size 0x48 virtual false final false
 void _ctor() ;
