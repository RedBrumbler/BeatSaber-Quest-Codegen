...
/// @brief Method OnVersionChanged addr 0x2c73b48 size 0x2c virtual true final false
 void OnVersionChanged(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::VersionChangeType versionChangeType) ;

/// @brief Method Update addr 0x2c73d18 size 0x94 virtual true final false
 void Update() ;

/// @brief Method ProcessNewChange addr 0x2c73b74 size 0x84 virtual false final false
 void ProcessNewChange(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method ProcessAddOrMove addr 0x2c73c5c size 0xbc virtual false final false
 void ProcessAddOrMove(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method ProcessRemove addr 0x2c73bf8 size 0x64 virtual false final false
 void ProcessRemove(UnityEngine::UIElements::VisualElement ve) ;

// Ctor Parameters []
explicit BaseVisualTreeHierarchyTrackerUpdater() ;

/// @brief Method .ctor addr 0x2c73dac size 0xc virtual false final false
 void _ctor() ;
