...
/// @brief Method get_profilerMarker addr 0x2c7a580 size 0x58 virtual true final false
 Unity::Profiling::ProfilerMarker get_profilerMarker() ;

/// @brief Method OnVersionChanged addr 0x2c7a5d8 size 0xc8 virtual true final false
 void OnVersionChanged(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::VersionChangeType versionChangeType) ;

/// @brief Method Update addr 0x2c7a720 size 0x30c virtual true final false
 void Update() ;

/// @brief Method ApplyStyles addr 0x2c7aa2c size 0xe0 virtual false final false
 void ApplyStyles() ;

// Ctor Parameters []
explicit VisualTreeStyleUpdater() ;

/// @brief Method .ctor addr 0x2c7ae90 size 0xd4 virtual false final false
 void _ctor() ;
