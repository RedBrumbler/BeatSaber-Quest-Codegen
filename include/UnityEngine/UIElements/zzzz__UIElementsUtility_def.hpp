...
/// @brief Method .ctor addr 0x2cb7588 size 0x60 virtual false final false
 void _ctor() ;

/// @brief Method UnityEngine.UIElements.IUIElementsUtility.MakeCurrentIMGUIContainerDirty addr 0x2cb75e8 size 0xd8 virtual true final true
 bool UnityEngine_UIElements_IUIElementsUtility_MakeCurrentIMGUIContainerDirty() ;

/// @brief Method UnityEngine.UIElements.IUIElementsUtility.TakeCapture addr 0x2cb76d4 size 0x16c virtual true final true
 bool UnityEngine_UIElements_IUIElementsUtility_TakeCapture() ;

/// @brief Method UnityEngine.UIElements.IUIElementsUtility.ReleaseCapture addr 0x2cb7920 size 0x8 virtual true final true
 bool UnityEngine_UIElements_IUIElementsUtility_ReleaseCapture() ;

/// @brief Method UnityEngine.UIElements.IUIElementsUtility.ProcessEvent addr 0x2cb7928 size 0x140 virtual true final true
...
/// @brief Method UnityEngine.UIElements.IUIElementsUtility.CleanupRoots addr 0x2cb80f8 size 0x60 virtual true final true
 bool UnityEngine_UIElements_IUIElementsUtility_CleanupRoots() ;

/// @brief Method UnityEngine.UIElements.IUIElementsUtility.EndContainerGUIFromException addr 0x2cb8158 size 0xc0 virtual true final true
 bool UnityEngine_UIElements_IUIElementsUtility_EndContainerGUIFromException(System::Exception exception) ;

/// @brief Method RegisterCachedPanel addr 0x2cb8218 size 0x90 virtual false final false
static void RegisterCachedPanel(int32_t instanceID, UnityEngine::UIElements::Panel panel) ;

/// @brief Method RemoveCachedPanel addr 0x2cb82a8 size 0x80 virtual false final false
static void RemoveCachedPanel(int32_t instanceID) ;

/// @brief Method TryGetPanel addr 0x2cb8328 size 0x90 virtual false final false
static bool TryGetPanel(int32_t instanceID, ByRef<UnityEngine::UIElements::Panel> panel) ;

/// @brief Method BeginContainerGUI addr 0x2cb83b8 size 0x1cc virtual false final false
...
/// @brief Method EndContainerGUI addr 0x2cb8628 size 0x224 virtual false final false
static void EndContainerGUI(UnityEngine::Event evt, UnityEngine::Rect layoutSize) ;

/// @brief Method CreateEvent addr 0x2cb884c size 0x74 virtual false final false
static UnityEngine::UIElements::EventBase CreateEvent(UnityEngine::Event systemEvent) ;

/// @brief Method CreateEvent addr 0x2cb88c0 size 0x29c virtual false final false
static UnityEngine::UIElements::EventBase CreateEvent(UnityEngine::Event systemEvent, UnityEngine::EventType eventType) ;

/// @brief Method DoDispatch addr 0x2cb7a68 size 0x690 virtual false final false
static bool DoDispatch(UnityEngine::UIElements::BaseVisualElementPanel panel) ;

/// @brief Method GetAllPanels addr 0x2cb8b5c size 0x158 virtual false final false
...
/// @brief Method GetPanelsIterator addr 0x2cb8cb4 size 0xa8 virtual false final false
...
/// @brief Method PixelsPerUnitScaleForElement addr 0x2cb8d5c size 0xa8 virtual false final false
