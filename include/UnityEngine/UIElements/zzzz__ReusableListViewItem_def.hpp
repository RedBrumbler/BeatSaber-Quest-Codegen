...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7491))}
...
/// @brief Method get_rootElement addr 0x2d4254c size 0x18 virtual true final false
 UnityEngine::UIElements::VisualElement get_rootElement() ;

/// @brief Method Init addr 0x2d408ec size 0x10 virtual false final false
 void Init(UnityEngine::UIElements::VisualElement item, bool usesAnimatedDragger) ;

/// @brief Method UpdateHierarchy addr 0x2d4256c size 0x274 virtual false final false
 void UpdateHierarchy(bool usesAnimatedDragger) ;

/// @brief Method UpdateDragHandle addr 0x2d409e8 size 0x13c virtual false final false
 void UpdateDragHandle(bool needsDragHandle) ;

/// @brief Method PreAttachElement addr 0x2d427e0 size 0x8c virtual true final false
 void PreAttachElement() ;

/// @brief Method DetachElement addr 0x2d42928 size 0x8c virtual true final false
 void DetachElement() ;

// Ctor Parameters []
explicit ReusableListViewItem() ;

/// @brief Method .ctor addr 0x2d42aac size 0x4 virtual false final false
 void _ctor() ;
