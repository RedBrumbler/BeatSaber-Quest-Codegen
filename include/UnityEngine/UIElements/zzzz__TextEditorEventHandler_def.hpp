...
/// @brief Method get_editorEngine addr 0x2cee718 size 0x8 virtual false final false
 UnityEngine::UIElements::TextEditorEngine get_editorEngine() ;

/// @brief Method set_editorEngine addr 0x2cee720 size 0x8 virtual false final false
 void set_editorEngine(UnityEngine::UIElements::TextEditorEngine value) ;

/// @brief Method get_textInputField addr 0x2cee728 size 0x8 virtual false final false
 UnityEngine::UIElements::ITextInputField get_textInputField() ;

/// @brief Method set_textInputField addr 0x2cee730 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2cee738 size 0xc0 virtual false final false
 void _ctor(UnityEngine::UIElements::TextEditorEngine editorEngine, UnityEngine::UIElements::ITextInputField textInputField) ;

/// @brief Method ExecuteDefaultActionAtTarget addr 0x2cee7f8 size 0x4 virtual true final false
 void ExecuteDefaultActionAtTarget(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method ExecuteDefaultAction addr 0x2cee7fc size 0x158 virtual true final false
