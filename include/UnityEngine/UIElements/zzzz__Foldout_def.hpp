...
/// @brief Method Init addr 0x2cedd58 size 0x130 virtual true final false
 void Init(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::IUxmlAttributes bag, UnityEngine::UIElements::CreationContext cc) ;

// Ctor Parameters []
explicit UnityEngine__UIElements__Foldout__UxmlTraits() ;

/// @brief Method .ctor addr 0x2cede88 size 0xec virtual false final false
 void _ctor() ;
...
/// @brief Method get_contentContainer addr 0x2ced5cc size 0x8 virtual true final false
 UnityEngine::UIElements::VisualElement get_contentContainer() ;

/// @brief Method get_text addr 0x2ced5d4 size 0x34 virtual false final false
 ::StringW get_text() ;

/// @brief Method set_text addr 0x2ce6d14 size 0x124 virtual false final false
 void set_text(::StringW value) ;

/// @brief Method get_value addr 0x2ced608 size 0x8 virtual true final true
 bool get_value() ;

/// @brief Method set_value addr 0x2ced610 size 0x1e0 virtual true final true
 void set_value(bool value) ;

/// @brief Method SetValueWithoutNotify addr 0x2ced7f0 size 0x120 virtual true final true
 void SetValueWithoutNotify(bool newValue) ;

/// @brief Method OnViewDataReady addr 0x2ced910 size 0x40 virtual true final false
 void OnViewDataReady() ;

// Ctor Parameters []
explicit Foldout() ;

/// @brief Method .ctor addr 0x2ce69e4 size 0x330 virtual false final false
 void _ctor() ;

/// @brief Method OnAttachToPanel addr 0x2ced958 size 0x1c0 virtual false final false
 void OnAttachToPanel(UnityEngine::UIElements::AttachToPanelEvent evt) ;

/// @brief Method <.ctor>b__23_0 addr 0x2cedcc0 size 0x50 virtual false final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7204)), TypeDefinitionIndex(TypeDefinitionIndex(7108)), TypeDefinitionIndex(TypeDefinitionIndex(7203)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7108), inst: 5093 })}
...
/// @brief Method .ctor addr 0x2cedd10 size 0x48 virtual false final false
 void _ctor() ;
