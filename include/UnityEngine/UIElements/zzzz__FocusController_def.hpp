...
/// @brief Method .ctor addr 0x2cb4f28 size 0x98 virtual false final false
 void _ctor(UnityEngine::UIElements::IFocusRing focusRing) ;

/// @brief Method get_focusRing addr 0x2cb4fc0 size 0x8 virtual false final false
 UnityEngine::UIElements::IFocusRing get_focusRing() ;

/// @brief Method get_focusedElement addr 0x2cb4fc8 size 0x44 virtual false final false
 UnityEngine::UIElements::Focusable get_focusedElement() ;

/// @brief Method IsFocused addr 0x2cb524c size 0x174 virtual false final false
 bool IsFocused(UnityEngine::UIElements::Focusable f) ;

/// @brief Method GetRetargetedFocusedElement addr 0x2cb500c size 0x204 virtual false final false
 UnityEngine::UIElements::Focusable GetRetargetedFocusedElement(UnityEngine::UIElements::VisualElement retargetAgainst) ;

/// @brief Method GetLeafFocusedElement addr 0x2cb53c0 size 0xa4 virtual false final false
 UnityEngine::UIElements::Focusable GetLeafFocusedElement() ;

/// @brief Method IsLocalElement addr 0x2cb5210 size 0x3c virtual false final false
 bool IsLocalElement(UnityEngine::UIElements::Focusable f) ;

/// @brief Method IsPendingFocus addr 0x2cb5464 size 0xb0 virtual false final false
 bool IsPendingFocus(UnityEngine::UIElements::Focusable f) ;

/// @brief Method SetFocusToLastFocusedElement addr 0x2cb5514 size 0x88 virtual false final false
 void SetFocusToLastFocusedElement() ;

/// @brief Method BlurLastFocusedElement addr 0x2cb559c size 0x88 virtual false final false
 void BlurLastFocusedElement() ;

/// @brief Method DoFocusChange addr 0x2cb5624 size 0x190 virtual false final false
 void DoFocusChange(UnityEngine::UIElements::Focusable f) ;

/// @brief Method FocusNextInDirection addr 0x2cb57b4 size 0xec virtual false final false
 UnityEngine::UIElements::Focusable FocusNextInDirection(UnityEngine::UIElements::FocusChangeDirection direction) ;

/// @brief Method AboutToReleaseFocus addr 0x2cb58a0 size 0x1c4 virtual false final false
...
/// @brief Method ReleaseFocus addr 0x2cb5a64 size 0x1c4 virtual false final false
...
/// @brief Method AboutToGrabFocus addr 0x2cb5c28 size 0x1c4 virtual false final false
...
/// @brief Method GrabFocus addr 0x2cb5dec size 0x1d0 virtual false final false
...
/// @brief Method Blur addr 0x2cb44fc size 0x58 virtual false final false
...
/// @brief Method SwitchFocus addr 0x2cb440c size 0xb8 virtual false final false
...
/// @brief Method SwitchFocus addr 0x2cb4bc4 size 0x294 virtual false final false
...
/// @brief Method SwitchFocusOnEvent addr 0x2cb4764 size 0x2ec virtual false final false
 UnityEngine::UIElements::Focusable SwitchFocusOnEvent(UnityEngine::UIElements::EventBase e) ;

/// @brief Method ReevaluateFocus addr 0x2cb5fbc size 0xc0 virtual false final false
 void ReevaluateFocus() ;

/// @brief Method GetFocusableParentForPointerEvent addr 0x2cb607c size 0x104 virtual false final false
...
/// @brief Method get_imguiKeyboardControl addr 0x2cb6180 size 0x8 virtual false final false
 int32_t get_imguiKeyboardControl() ;

/// @brief Method set_imguiKeyboardControl addr 0x2cb6188 size 0x8 virtual false final false
 void set_imguiKeyboardControl(int32_t value) ;

/// @brief Method SyncIMGUIFocus addr 0x2cb6190 size 0xcc virtual false final false
