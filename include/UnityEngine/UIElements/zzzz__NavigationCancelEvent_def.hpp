...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7366)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7366), inst: 4566 })}
...
/// @brief Method .ctor addr 0x2d0e04c size 0x48 virtual false final false
 void _ctor() ;
