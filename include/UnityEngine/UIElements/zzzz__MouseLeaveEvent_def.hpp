...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7333)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7333), inst: 4514 })}
...
/// @brief Method Init addr 0x2d0c484 size 0x54 virtual true final false
 void Init() ;

/// @brief Method LocalInit addr 0x2d0c4d8 size 0xc virtual false final false
 void LocalInit() ;

// Ctor Parameters []
explicit MouseLeaveEvent() ;

/// @brief Method .ctor addr 0x2d0c4e4 size 0x54 virtual false final false
 void _ctor() ;
