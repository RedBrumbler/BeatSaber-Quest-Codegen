...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7316), inst: 4691 }), TypeDefinitionIndex(TypeDefinitionIndex(7316))}
...
/// @brief Method .ctor addr 0x2d0b67c size 0x48 virtual false final false
 void _ctor() ;
