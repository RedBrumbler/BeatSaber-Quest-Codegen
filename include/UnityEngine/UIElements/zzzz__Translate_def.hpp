...
/// @brief Method .ctor addr 0x2d2b1ac size 0x10 virtual false final false
 void _ctor(UnityEngine::UIElements::Length x, UnityEngine::UIElements::Length y, float_t z) ;

/// @brief Method None addr 0x2d2b170 size 0x1c virtual false final false
static UnityEngine::UIElements::Translate None() ;

/// @brief Method get_x addr 0x2d2b1bc size 0x8 virtual false final false
 UnityEngine::UIElements::Length get_x() ;

/// @brief Method get_y addr 0x2d2b1c4 size 0x8 virtual false final false
 UnityEngine::UIElements::Length get_y() ;

/// @brief Method get_z addr 0x2d2b1cc size 0x8 virtual false final false
 float_t get_z() ;

/// @brief Method op_Equality addr 0x2d29108 size 0x7c virtual false final false
static bool op_Equality(UnityEngine::UIElements::Translate lhs, UnityEngine::UIElements::Translate rhs) ;

/// @brief Method op_Inequality addr 0x2d2b1d4 size 0x78 virtual false final false
static bool op_Inequality(UnityEngine::UIElements::Translate lhs, UnityEngine::UIElements::Translate rhs) ;

/// @brief Method Equals addr 0x2d2b24c size 0x7c virtual true final true
 bool Equals(UnityEngine::UIElements::Translate other) ;

/// @brief Method Equals addr 0x2d2b2c8 size 0x90 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d292b4 size 0x74 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2d2b358 size 0x1cc virtual true final false
 ::StringW ToString() ;
