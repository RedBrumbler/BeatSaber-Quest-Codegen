...
/// @brief Method get_value addr 0x2d28fd8 size 0x44 virtual true final true
 UnityEngine::UIElements::Translate get_value() ;

/// @brief Method get_keyword addr 0x2d2901c size 0x8 virtual true final true
 UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method .ctor addr 0x2d29024 size 0x28 virtual false final false
 void _ctor(UnityEngine::UIElements::Translate v) ;

/// @brief Method .ctor addr 0x2d29064 size 0x10 virtual false final false
 void _ctor(UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method .ctor addr 0x2d2904c size 0x18 virtual false final false
 void _ctor(UnityEngine::UIElements::Translate v, UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method op_Equality addr 0x2d29074 size 0x94 virtual false final false
static bool op_Equality(UnityEngine::UIElements::StyleTranslate lhs, UnityEngine::UIElements::StyleTranslate rhs) ;

/// @brief Method op_Implicit addr 0x2d29184 size 0x10 virtual false final false
...
/// @brief Method op_Implicit addr 0x2d29194 size 0x18 virtual false final false
...
/// @brief Method Equals addr 0x2d291ac size 0x44 virtual true final true
 bool Equals(UnityEngine::UIElements::StyleTranslate other) ;

/// @brief Method Equals addr 0x2d291f0 size 0xa0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d29290 size 0x24 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2d29328 size 0x88 virtual true final false
 ::StringW ToString() ;
