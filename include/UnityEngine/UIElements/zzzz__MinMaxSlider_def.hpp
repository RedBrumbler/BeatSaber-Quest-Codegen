...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10203)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7246), inst: 393 }), TypeDefinitionIndex(TypeDefinitionIndex(7246))}
...
/// @brief Method Init addr 0x2cf190c size 0x1bc virtual true final false
 void Init(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::IUxmlAttributes bag, UnityEngine::UIElements::CreationContext cc) ;

// Ctor Parameters []
explicit UnityEngine__UIElements__MinMaxSlider__UxmlTraits() ;

/// @brief Method .ctor addr 0x2cf1ac8 size 0x170 virtual false final false
 void _ctor() ;
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7247), inst: 393 }), TypeDefinitionIndex(TypeDefinitionIndex(10203)), TypeDefinitionIndex(TypeDefinitionIndex(7247))}
...
/// @brief Method get_dragElement addr 0x2ceed00 size 0x8 virtual false final false
 UnityEngine::UIElements::VisualElement get_dragElement() ;

/// @brief Method set_dragElement addr 0x2ceed08 size 0x8 virtual false final false
 void set_dragElement(UnityEngine::UIElements::VisualElement value) ;

/// @brief Method get_dragMinThumb addr 0x2ceed10 size 0x8 virtual false final false
 UnityEngine::UIElements::VisualElement get_dragMinThumb() ;

/// @brief Method set_dragMinThumb addr 0x2ceed18 size 0x8 virtual false final false
 void set_dragMinThumb(UnityEngine::UIElements::VisualElement value) ;

/// @brief Method get_dragMaxThumb addr 0x2ceed20 size 0x8 virtual false final false
 UnityEngine::UIElements::VisualElement get_dragMaxThumb() ;

/// @brief Method set_dragMaxThumb addr 0x2ceed28 size 0x8 virtual false final false
 void set_dragMaxThumb(UnityEngine::UIElements::VisualElement value) ;

/// @brief Method get_clampedDragger addr 0x2ceed30 size 0x8 virtual false final false
 UnityEngine::UIElements::ClampedDragger_1<float_t> get_clampedDragger() ;

/// @brief Method set_clampedDragger addr 0x2ceed38 size 0x8 virtual false final false
 void set_clampedDragger(UnityEngine::UIElements::ClampedDragger_1<float_t> value) ;

/// @brief Method get_minValue addr 0x2ceed40 size 0x10 virtual false final false
 float_t get_minValue() ;

/// @brief Method set_minValue addr 0x2ceed50 size 0xa8 virtual false final false
 void set_minValue(float_t value) ;

/// @brief Method get_maxValue addr 0x2ceee30 size 0x20 virtual false final false
 float_t get_maxValue() ;

/// @brief Method set_maxValue addr 0x2ceee50 size 0xa8 virtual false final false
 void set_maxValue(float_t value) ;

/// @brief Method get_value addr 0x2ceeef8 size 0x48 virtual true final false
 UnityEngine::Vector2 get_value() ;

/// @brief Method set_value addr 0x2ceef40 size 0x8c virtual true final false
 void set_value(UnityEngine::Vector2 value) ;

/// @brief Method SetValueWithoutNotify addr 0x2ceefcc size 0x94 virtual true final false
 void SetValueWithoutNotify(UnityEngine::Vector2 newValue) ;

/// @brief Method get_lowLimit addr 0x2cf053c size 0x8 virtual false final false
 float_t get_lowLimit() ;

/// @brief Method set_lowLimit addr 0x2cf0544 size 0x170 virtual false final false
 void set_lowLimit(float_t value) ;

/// @brief Method get_highLimit addr 0x2cf06b4 size 0x8 virtual false final false
 float_t get_highLimit() ;

/// @brief Method set_highLimit addr 0x2cf06bc size 0x170 virtual false final false
 void set_highLimit(float_t value) ;

// Ctor Parameters []
explicit MinMaxSlider() ;

/// @brief Method .ctor addr 0x2cf082c size 0x20 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2cf084c size 0x528 virtual false final false
 void _ctor(::StringW label, float_t minValue, float_t maxValue, float_t minLimit, float_t maxLimit) ;

/// @brief Method ClampValues addr 0x2ceedf8 size 0x38 virtual false final false
 UnityEngine::Vector2 ClampValues(UnityEngine::Vector2 valueToClamp) ;

/// @brief Method UpdateDragElementPosition addr 0x2cf0d74 size 0x94 virtual false final false
 void UpdateDragElementPosition(UnityEngine::UIElements::GeometryChangedEvent evt) ;

/// @brief Method UpdateDragElementPosition addr 0x2cef060 size 0x14dc virtual false final false
 void UpdateDragElementPosition() ;

/// @brief Method SliderLerpUnclamped addr 0x2cf0e18 size 0x10 virtual false final false
 float_t SliderLerpUnclamped(float_t a, float_t b, float_t interpolant) ;

/// @brief Method SliderNormalizeValue addr 0x2cf0e08 size 0x10 virtual false final false
 float_t SliderNormalizeValue(float_t currentValue, float_t lowerValue, float_t higherValue) ;

/// @brief Method ComputeValueFromPosition addr 0x2cf0e28 size 0x1c0 virtual false final false
 float_t ComputeValueFromPosition(float_t positionToConvert) ;

/// @brief Method ExecuteDefaultAction addr 0x2cf0fe8 size 0x10c virtual true final false
 void ExecuteDefaultAction(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method SetSliderValueFromDrag addr 0x2cf10f4 size 0x94 virtual false final false
 void SetSliderValueFromDrag() ;

/// @brief Method SetSliderValueFromClick addr 0x2cf132c size 0x354 virtual false final false
 void SetSliderValueFromClick() ;

/// @brief Method ComputeValueDragStateNoThumb addr 0x2cf1680 size 0xa0 virtual false final false
 void ComputeValueDragStateNoThumb(float_t lowLimitPosition, float_t highLimitPosition, float_t dragElementPos) ;

/// @brief Method ComputeValueFromDraggingThumb addr 0x2cf1188 size 0x1a4 virtual false final false
 void ComputeValueFromDraggingThumb(float_t dragElementStartPos, float_t dragElementEndPos) ;

/// @brief Method UpdateMixedValueContent addr 0x2cf1720 size 0x4 virtual true final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7225)), TypeDefinitionIndex(TypeDefinitionIndex(7223)), TypeDefinitionIndex(TypeDefinitionIndex(7108)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7108), inst: 5101 })}
...
/// @brief Method .ctor addr 0x2cf18c4 size 0x48 virtual false final false
 void _ctor() ;
