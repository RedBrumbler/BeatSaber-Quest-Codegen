...
/// @brief Method get_value addr 0x2d2e350 size 0x18 virtual true final true
 int32_t get_value() ;

/// @brief Method get_keyword addr 0x2d2e368 size 0x8 virtual true final true
 UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method .ctor addr 0x2d30208 size 0x8 virtual false final false
 void _ctor(UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method .ctor addr 0x2d2bac0 size 0x8 virtual false final false
 void _ctor(int32_t v, UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method op_Equality addr 0x2d30210 size 0x20 virtual false final false
static bool op_Equality(UnityEngine::UIElements::StyleInt lhs, UnityEngine::UIElements::StyleInt rhs) ;

/// @brief Method op_Implicit addr 0x2d2bac8 size 0x8 virtual false final false
...
/// @brief Method Equals addr 0x2d30230 size 0x20 virtual true final true
 bool Equals(UnityEngine::UIElements::StyleInt other) ;

/// @brief Method Equals addr 0x2d30250 size 0x84 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d302d4 size 0x14 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2d302e8 size 0x78 virtual true final false
 ::StringW ToString() ;
