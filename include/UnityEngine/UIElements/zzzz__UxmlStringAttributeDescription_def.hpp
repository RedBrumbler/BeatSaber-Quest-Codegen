...
/// @brief Method .ctor addr 0x2cca03c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetValueFromBag>b__3_0 addr 0x2cca044 size 0x8 virtual false final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7092), inst: 380 }), TypeDefinitionIndex(TypeDefinitionIndex(7092))}
...
/// @brief Method .ctor addr 0x2cc9db8 size 0xbc virtual false final false
 void _ctor() ;

/// @brief Method GetValueFromBag addr 0x2cc9e74 size 0x164 virtual true final false
