...
/// @brief Method get_value addr 0x2d26704 size 0x34 virtual true final true
 UnityEngine::UIElements::Scale get_value() ;

/// @brief Method get_keyword addr 0x2d26738 size 0x8 virtual true final true
 UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method .ctor addr 0x2d26740 size 0xc virtual false final false
 void _ctor(UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method .ctor addr 0x2d2674c size 0xc virtual false final false
 void _ctor(UnityEngine::UIElements::Scale v, UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method op_Equality addr 0x2d26758 size 0x70 virtual false final false
static bool op_Equality(UnityEngine::UIElements::StyleScale lhs, UnityEngine::UIElements::StyleScale rhs) ;

/// @brief Method op_Implicit addr 0x2d2681c size 0xc virtual false final false
...
/// @brief Method Equals addr 0x2d26828 size 0x74 virtual true final true
 bool Equals(UnityEngine::UIElements::StyleScale other) ;

/// @brief Method Equals addr 0x2d2689c size 0xd0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d2696c size 0x24 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2d269e0 size 0x88 virtual true final false
 ::StringW ToString() ;
