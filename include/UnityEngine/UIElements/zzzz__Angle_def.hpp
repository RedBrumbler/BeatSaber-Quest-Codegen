...
/// @brief Method None addr 0x2d2b6e4 size 0x8 virtual false final false
static UnityEngine::UIElements::Angle None() ;

/// @brief Method get_value addr 0x2d2b6f8 size 0x8 virtual false final false
 float_t get_value() ;

/// @brief Method .ctor addr 0x2d2b700 size 0xc virtual false final false
 void _ctor(float_t value, UnityEngine::UIElements::AngleUnit unit) ;

/// @brief Method .ctor addr 0x2d2b6ec size 0xc virtual false final false
 void _ctor(float_t value, UnityEngine::UIElements::UnityEngine__UIElements__Angle__Unit unit) ;

/// @brief Method ToDegrees addr 0x2d2a5bc size 0x84 virtual false final false
 float_t ToDegrees() ;

/// @brief Method op_Implicit addr 0x2d2a03c size 0x8 virtual false final false
static UnityEngine::UIElements::Angle op_Implicit_UnityEngine__UIElements__Angle(float_t value) ;

/// @brief Method op_Equality addr 0x2d2a148 size 0x28 virtual false final false
static bool op_Equality(UnityEngine::UIElements::Angle lhs, UnityEngine::UIElements::Angle rhs) ;

/// @brief Method Equals addr 0x2d2b70c size 0x28 virtual true final true
 bool Equals(UnityEngine::UIElements::Angle other) ;

/// @brief Method Equals addr 0x2d2b734 size 0x8c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d2a334 size 0x28 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2d2a3c4 size 0x1d8 virtual true final false
 ::StringW ToString() ;
