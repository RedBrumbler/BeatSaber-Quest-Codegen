...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7268)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7268), inst: 4682 })}
...
/// @brief Method .ctor addr 0x2d02c30 size 0x48 virtual false final false
 void _ctor() ;
