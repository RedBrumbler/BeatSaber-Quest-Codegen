...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7488), inst: 2 })
...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7490)), TypeDefinitionIndex(TypeDefinitionIndex(7489))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7489), inst: 2 })
