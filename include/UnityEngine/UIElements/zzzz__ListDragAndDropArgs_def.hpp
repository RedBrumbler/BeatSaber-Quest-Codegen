...
/// @brief Method set_target addr 0x2cc4204 size 0x8 virtual false final false
 void set_target(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_insertAtIndex addr 0x2cc420c size 0x8 virtual true final true
 int32_t get_insertAtIndex() ;

/// @brief Method set_insertAtIndex addr 0x2cc4214 size 0x8 virtual false final false
 void set_insertAtIndex(int32_t value) ;

/// @brief Method get_dragAndDropPosition addr 0x2cc421c size 0x8 virtual true final true
 UnityEngine::UIElements::DragAndDropPosition get_dragAndDropPosition() ;

/// @brief Method set_dragAndDropPosition addr 0x2cc4224 size 0x8 virtual false final false
 void set_dragAndDropPosition(UnityEngine::UIElements::DragAndDropPosition value) ;

/// @brief Method get_dragAndDropData addr 0x2cc422c size 0x8 virtual true final true
 UnityEngine::UIElements::IDragAndDropData get_dragAndDropData() ;

/// @brief Method set_dragAndDropData addr 0x2cc4234 size 0x8 virtual false final false
