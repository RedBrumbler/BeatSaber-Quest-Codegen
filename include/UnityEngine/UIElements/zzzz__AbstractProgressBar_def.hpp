...
/// @brief Method Init addr 0x2cf30d0 size 0x1e4 virtual true final false
 void Init(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::IUxmlAttributes bag, UnityEngine::UIElements::CreationContext cc) ;

// Ctor Parameters []
explicit UnityEngine__UIElements__AbstractProgressBar__UxmlTraits() ;

/// @brief Method .ctor addr 0x2cf32b4 size 0x164 virtual false final false
 void _ctor() ;
...
/// @brief Method set_title addr 0x2cf2794 size 0x24 virtual false final false
 void set_title(::StringW value) ;

/// @brief Method get_lowValue addr 0x2cf27b8 size 0x8 virtual false final false
 float_t get_lowValue() ;

/// @brief Method set_lowValue addr 0x2cf27c0 size 0x10 virtual false final false
 void set_lowValue(float_t value) ;

/// @brief Method get_highValue addr 0x2cf28f4 size 0x8 virtual false final false
 float_t get_highValue() ;

/// @brief Method set_highValue addr 0x2cf28fc size 0x10 virtual false final false
 void set_highValue(float_t value) ;

// Ctor Parameters []
explicit AbstractProgressBar() ;

/// @brief Method .ctor addr 0x2cf290c size 0x2a0 virtual false final false
 void _ctor() ;

/// @brief Method OnGeometryChanged addr 0x2cf2bac size 0x24 virtual false final false
 void OnGeometryChanged(UnityEngine::UIElements::GeometryChangedEvent e) ;

/// @brief Method get_value addr 0x2cf2bd0 size 0x8 virtual true final false
 float_t get_value() ;

/// @brief Method set_value addr 0x2cf2bd8 size 0x25c virtual true final false
 void set_value(float_t value) ;

/// @brief Method SetValueWithoutNotify addr 0x2cf2e34 size 0x28 virtual true final true
 void SetValueWithoutNotify(float_t newValue) ;

/// @brief Method SetProgress addr 0x2cf27d0 size 0x124 virtual false final false
 void SetProgress(float_t p) ;

/// @brief Method CalculateProgressWidth addr 0x2cf2e5c size 0x104 virtual false final false
