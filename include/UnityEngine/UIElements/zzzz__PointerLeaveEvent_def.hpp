...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7316)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7316), inst: 4689 })}
...
/// @brief Method Init addr 0x2d0b5c8 size 0x54 virtual true final false
 void Init() ;

/// @brief Method LocalInit addr 0x2d0b61c size 0xc virtual false final false
 void LocalInit() ;

// Ctor Parameters []
explicit PointerLeaveEvent() ;

/// @brief Method .ctor addr 0x2d0b628 size 0x54 virtual false final false
 void _ctor() ;
