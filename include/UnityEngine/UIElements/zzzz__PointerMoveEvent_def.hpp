...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7316)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7316), inst: 1653 })}
...
/// @brief Method get_isHandledByDraggable addr 0x2d0a088 size 0x8 virtual false final false
 bool get_isHandledByDraggable() ;

/// @brief Method set_isHandledByDraggable addr 0x2d0a090 size 0xc virtual false final false
 void set_isHandledByDraggable(bool value) ;

/// @brief Method Init addr 0x2d0a09c size 0x50 virtual true final false
 void Init() ;

/// @brief Method LocalInit addr 0x2d0a0ec size 0x10c virtual false final false
 void LocalInit() ;

// Ctor Parameters []
explicit PointerMoveEvent() ;

/// @brief Method .ctor addr 0x2d0a1f8 size 0x50 virtual false final false
 void _ctor() ;

/// @brief Method PostDispatch addr 0x2d0a248 size 0x608 virtual true final false
