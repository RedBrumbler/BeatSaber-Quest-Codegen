...
/// @brief Method get_trickleDownCallbackCount addr 0x2d06058 size 0x8 virtual false final false
 int32_t get_trickleDownCallbackCount() ;

/// @brief Method set_trickleDownCallbackCount addr 0x2d06060 size 0x8 virtual false final false
 void set_trickleDownCallbackCount(int32_t value) ;

/// @brief Method get_bubbleUpCallbackCount addr 0x2d06068 size 0x8 virtual false final false
 int32_t get_bubbleUpCallbackCount() ;

/// @brief Method set_bubbleUpCallbackCount addr 0x2d06070 size 0x8 virtual false final false
 void set_bubbleUpCallbackCount(int32_t value) ;

// Ctor Parameters []
explicit EventCallbackList() ;

/// @brief Method .ctor addr 0x2d05cfc size 0x80 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2d05c6c size 0x90 virtual false final false
 void _ctor(UnityEngine::UIElements::EventCallbackList source) ;

/// @brief Method Contains addr 0x2d06078 size 0x18 virtual false final false
 bool Contains(int64_t eventTypeId, System::Delegate callback, UnityEngine::UIElements::CallbackPhase phase) ;

/// @brief Method Find addr 0x2d06090 size 0xe8 virtual false final false
...
/// @brief Method Remove addr 0x2d06178 size 0x120 virtual false final false
 bool Remove(int64_t eventTypeId, System::Delegate callback, UnityEngine::UIElements::CallbackPhase phase) ;

/// @brief Method Add addr 0x2d06298 size 0xdc virtual false final false
 void Add(UnityEngine::UIElements::EventCallbackFunctorBase item) ;

/// @brief Method AddRange addr 0x2d05d7c size 0x190 virtual false final false
 void AddRange(UnityEngine::UIElements::EventCallbackList list) ;

/// @brief Method get_Count addr 0x2d06374 size 0x48 virtual false final false
 int32_t get_Count() ;

/// @brief Method get_Item addr 0x2d063bc size 0x58 virtual false final false
 UnityEngine::UIElements::EventCallbackFunctorBase get_Item(int32_t i) ;

/// @brief Method Clear addr 0x2d05f70 size 0x6c virtual false final false
 void Clear() ;
