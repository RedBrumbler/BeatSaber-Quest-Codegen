...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7333)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7298), inst: 1634 }), TypeDefinitionIndex(TypeDefinitionIndex(7298))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7333), inst: 2 })
