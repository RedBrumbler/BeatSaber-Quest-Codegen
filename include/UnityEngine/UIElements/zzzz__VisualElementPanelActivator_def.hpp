...
/// @brief Method get_isActive addr 0x2c6b4a0 size 0x8 virtual false final false
 bool get_isActive() ;

/// @brief Method set_isActive addr 0x2c6b4a8 size 0xc virtual false final false
 void set_isActive(bool value) ;

/// @brief Method get_isDetaching addr 0x2c6b4b4 size 0x8 virtual false final false
 bool get_isDetaching() ;

/// @brief Method set_isDetaching addr 0x2c6b4bc size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x2c69684 size 0x28 virtual false final false
 void _ctor(UnityEngine::UIElements::IVisualElementPanelActivatable activatable) ;

/// @brief Method SetActive addr 0x2c69794 size 0x33c virtual false final false
 void SetActive(bool action) ;

/// @brief Method SendActivation addr 0x2c6b4c8 size 0x118 virtual false final false
 void SendActivation() ;

/// @brief Method SendDeactivation addr 0x2c6b5e0 size 0x118 virtual false final false
 void SendDeactivation() ;

/// @brief Method OnEnter addr 0x2c6b6f8 size 0x10 virtual false final false
 void OnEnter(UnityEngine::UIElements::AttachToPanelEvent evt) ;

/// @brief Method OnLeave addr 0x2c6b708 size 0x74 virtual false final false
