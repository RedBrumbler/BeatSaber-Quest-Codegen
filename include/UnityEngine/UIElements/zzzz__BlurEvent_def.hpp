...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7350)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7350), inst: 1904 })}
...
/// @brief Method PreDispatch addr 0x2d0ce34 size 0x7c virtual true final false
 void PreDispatch(UnityEngine::UIElements::IPanel panel) ;

// Ctor Parameters []
explicit BlurEvent() ;

/// @brief Method .ctor addr 0x2d0ceb0 size 0x48 virtual false final false
 void _ctor() ;
