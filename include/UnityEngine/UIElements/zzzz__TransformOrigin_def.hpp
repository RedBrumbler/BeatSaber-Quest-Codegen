...
/// @brief Method .ctor addr 0x2d2f628 size 0xc virtual false final false
 void _ctor(UnityEngine::UIElements::Length x, UnityEngine::UIElements::Length y, float_t z) ;

/// @brief Method Initial addr 0x2d2f634 size 0x18 virtual false final false
static UnityEngine::UIElements::TransformOrigin Initial() ;

/// @brief Method get_x addr 0x2d2f64c size 0x8 virtual false final false
 UnityEngine::UIElements::Length get_x() ;

/// @brief Method get_y addr 0x2d2f654 size 0x8 virtual false final false
 UnityEngine::UIElements::Length get_y() ;

/// @brief Method get_z addr 0x2d2f65c size 0x8 virtual false final false
 float_t get_z() ;

/// @brief Method op_Equality addr 0x2d2f38c size 0x60 virtual false final false
static bool op_Equality(UnityEngine::UIElements::TransformOrigin lhs, UnityEngine::UIElements::TransformOrigin rhs) ;

/// @brief Method op_Inequality addr 0x2d2f664 size 0x6c virtual false final false
static bool op_Inequality(UnityEngine::UIElements::TransformOrigin lhs, UnityEngine::UIElements::TransformOrigin rhs) ;

/// @brief Method Equals addr 0x2d2f6d0 size 0x6c virtual true final true
 bool Equals(UnityEngine::UIElements::TransformOrigin other) ;

/// @brief Method Equals addr 0x2d2f73c size 0xd0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d2f52c size 0x74 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2d2f80c size 0x1cc virtual true final false
 ::StringW ToString() ;
