...
/// @brief Method get_instance addr 0x2d37344 size 0x58 virtual false final false
static UnityEngine::UIElements::TextureRegistry get_instance() ;

/// @brief Method GetTexture addr 0x2d3739c size 0x13c virtual false final false
 UnityEngine::Texture GetTexture(UnityEngine::UIElements::TextureId id) ;

/// @brief Method AllocAndAcquireDynamic addr 0x2d374d8 size 0x1c virtual false final false
 UnityEngine::UIElements::TextureId AllocAndAcquireDynamic() ;

/// @brief Method UpdateDynamic addr 0x2d37754 size 0x1ac virtual false final false
 void UpdateDynamic(UnityEngine::UIElements::TextureId id, UnityEngine::Texture texture) ;

/// @brief Method AllocAndAcquire addr 0x2d374f4 size 0x260 virtual false final false
 UnityEngine::UIElements::TextureId AllocAndAcquire(UnityEngine::Texture texture, bool dynamic) ;

/// @brief Method Acquire addr 0x2d37900 size 0x140 virtual false final false
 UnityEngine::UIElements::TextureId Acquire(UnityEngine::Texture tex) ;

/// @brief Method Release addr 0x2d37a40 size 0x1f0 virtual false final false
 void Release(UnityEngine::UIElements::TextureId id) ;

// Ctor Parameters []
explicit TextureRegistry() ;

/// @brief Method .ctor addr 0x2d37c30 size 0x10c virtual false final false
 void _ctor() ;
