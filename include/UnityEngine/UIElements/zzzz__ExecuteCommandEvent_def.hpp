...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7347)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7347), inst: 995 })}
...
/// @brief Method .ctor addr 0x2d0cd38 size 0x48 virtual false final false
 void _ctor() ;
