...
/// @brief Method .ctor addr 0x2d29f50 size 0x60 virtual false final false
 void _ctor(UnityEngine::UIElements::Angle angle) ;

/// @brief Method Initial addr 0x2d29fb0 size 0x8c virtual false final false
static UnityEngine::UIElements::Rotate Initial() ;

/// @brief Method None addr 0x2d2a044 size 0x70 virtual false final false
static UnityEngine::UIElements::Rotate None() ;

/// @brief Method get_angle addr 0x2d2a0b4 size 0x8 virtual false final false
 UnityEngine::UIElements::Angle get_angle() ;

/// @brief Method set_angle addr 0x2d2a0bc size 0x8 virtual false final false
 void set_angle(UnityEngine::UIElements::Angle value) ;

/// @brief Method op_Equality addr 0x2d2a0c4 size 0x84 virtual false final false
static bool op_Equality(UnityEngine::UIElements::Rotate lhs, UnityEngine::UIElements::Rotate rhs) ;

/// @brief Method op_Inequality addr 0x2d2a170 size 0x48 virtual false final false
static bool op_Inequality(UnityEngine::UIElements::Rotate lhs, UnityEngine::UIElements::Rotate rhs) ;

/// @brief Method Equals addr 0x2d2a1b8 size 0x44 virtual true final true
 bool Equals(UnityEngine::UIElements::Rotate other) ;

/// @brief Method Equals addr 0x2d2a1fc size 0xa0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d2a29c size 0x98 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2d2a35c size 0x68 virtual true final false
 ::StringW ToString() ;

/// @brief Method ToQuaternion addr 0x2d2a59c size 0x20 virtual false final false
