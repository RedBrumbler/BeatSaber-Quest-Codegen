...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7088))}
...
/// @brief Method get_values addr 0x2cc9668 size 0x8 virtual false final false
 System::Collections::Generic::IEnumerable_1<::StringW> get_values() ;

/// @brief Method set_values addr 0x2cc9670 size 0x5c virtual false final false
 void set_values(System::Collections::Generic::IEnumerable_1<::StringW> value) ;

/// @brief Method Equals addr 0x2cc96cc size 0x14c virtual true final false
 bool Equals(UnityEngine::UIElements::UxmlTypeRestriction other) ;

// Ctor Parameters []
explicit UxmlEnumeration() ;

/// @brief Method .ctor addr 0x2cc9818 size 0x7c virtual false final false
 void _ctor() ;
