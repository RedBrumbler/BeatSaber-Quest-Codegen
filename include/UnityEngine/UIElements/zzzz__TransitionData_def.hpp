...
/// @brief Method Copy addr 0x2d3f5f4 size 0x144 virtual true final true
 UnityEngine::UIElements::TransitionData Copy() ;

/// @brief Method CopyFrom addr 0x2d3f738 size 0x160 virtual true final true
 void CopyFrom(ByRef<UnityEngine::UIElements::TransitionData> other) ;

/// @brief Method op_Equality addr 0x2d3f898 size 0x4c virtual false final false
static bool op_Equality(UnityEngine::UIElements::TransitionData lhs, UnityEngine::UIElements::TransitionData rhs) ;

/// @brief Method Equals addr 0x2d3f8e4 size 0x4c virtual true final true
 bool Equals(UnityEngine::UIElements::TransitionData other) ;

/// @brief Method Equals addr 0x2d3f930 size 0xb0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d3f9e0 size 0x9c virtual true final false
 int32_t GetHashCode() ;
