...
/// @brief Method get_hasCurrent addr 0x2caba54 size 0x28 virtual false final false
 bool get_hasCurrent() ;

/// @brief Method get_currentIndex addr 0x2caba7c size 0x8 virtual false final false
 int32_t get_currentIndex() ;

/// @brief Method set_currentIndex addr 0x2caba84 size 0x8 virtual false final false
 void set_currentIndex(int32_t value) ;

/// @brief Method get_matchedVariableCount addr 0x2caba8c size 0x8 virtual false final false
 int32_t get_matchedVariableCount() ;

/// @brief Method set_matchedVariableCount addr 0x2caba94 size 0x8 virtual false final false
 void set_matchedVariableCount(int32_t value) ;

/// @brief Method Initialize addr 0x2caba9c size 0x54 virtual false final false
 void Initialize() ;

/// @brief Method MoveNext addr 0x2cabaf0 size 0x44 virtual false final false
 void MoveNext() ;

/// @brief Method SaveContext addr 0x2cabb34 size 0x54 virtual false final false
 void SaveContext() ;

/// @brief Method RestoreContext addr 0x2cabb88 size 0x58 virtual false final false
 void RestoreContext() ;

/// @brief Method DropContext addr 0x2cabbe0 size 0x50 virtual false final false
 void DropContext() ;

/// @brief Method Match addr 0x2cabc30 size 0xb4 virtual false final false
 bool Match(UnityEngine::UIElements::StyleSheets::Syntax::Expression exp) ;

/// @brief Method MatchExpression addr 0x2cabcec size 0x114 virtual false final false
 bool MatchExpression(UnityEngine::UIElements::StyleSheets::Syntax::Expression exp) ;

/// @brief Method MatchExpressionWithMultiplier addr 0x2cabe00 size 0x14c virtual false final false
 bool MatchExpressionWithMultiplier(UnityEngine::UIElements::StyleSheets::Syntax::Expression exp) ;

/// @brief Method MatchGroup addr 0x2cac114 size 0xb4 virtual false final false
 bool MatchGroup(UnityEngine::UIElements::StyleSheets::Syntax::Expression exp) ;

/// @brief Method MatchCombinator addr 0x2cabf4c size 0xcc virtual false final false
 bool MatchCombinator(UnityEngine::UIElements::StyleSheets::Syntax::Expression exp) ;

/// @brief Method MatchOr addr 0x2cac1c8 size 0xd0 virtual false final false
 bool MatchOr(UnityEngine::UIElements::StyleSheets::Syntax::Expression exp) ;

/// @brief Method MatchOrOr addr 0x2cac298 size 0x18 virtual false final false
 bool MatchOrOr(UnityEngine::UIElements::StyleSheets::Syntax::Expression exp) ;

/// @brief Method MatchAndAnd addr 0x2cac2b0 size 0x30 virtual false final false
 bool MatchAndAnd(UnityEngine::UIElements::StyleSheets::Syntax::Expression exp) ;

/// @brief Method MatchMany addr 0x2cac34c size 0x180 virtual false final false
 int32_t MatchMany(UnityEngine::UIElements::StyleSheets::Syntax::Expression exp) ;

/// @brief Method MatchManyByOrder addr 0x2cac4cc size 0x190 virtual false final false
 int32_t MatchManyByOrder(UnityEngine::UIElements::StyleSheets::Syntax::Expression exp, void* matchOrder) ;

/// @brief Method MatchJuxtaposition addr 0x2cac2e0 size 0x6c virtual false final false
 bool MatchJuxtaposition(UnityEngine::UIElements::StyleSheets::Syntax::Expression exp) ;

/// @brief Method MatchDataType addr 0x2cac018 size 0xfc virtual false final false
 bool MatchDataType(UnityEngine::UIElements::StyleSheets::Syntax::Expression exp) ;

// Ctor Parameters []
explicit BaseStyleMatcher() ;

/// @brief Method .ctor addr 0x2cac65c size 0x7c virtual false final false
 void _ctor() ;
