...
/// @brief Method ReadAsString addr 0x2ca105c size 0x2dc virtual false final false
static ::StringW ReadAsString(UnityEngine::UIElements::StyleSheet sheet, UnityEngine::UIElements::StyleValueHandle handle) ;

/// @brief Method IsVarFunction addr 0x2ca15cc size 0x34 virtual false final false
