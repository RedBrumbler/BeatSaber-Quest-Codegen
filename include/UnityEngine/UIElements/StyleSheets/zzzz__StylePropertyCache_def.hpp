...
/// @brief Method TryGetSyntax addr 0x2caa640 size 0x90 virtual false final false
static bool TryGetSyntax(::StringW name, ByRef<::StringW> syntax) ;

/// @brief Method TryGetNonTerminalValue addr 0x2caa6d0 size 0x90 virtual false final false
