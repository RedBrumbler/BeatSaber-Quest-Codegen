...
/// @brief Method TryGetColor addr 0x2ca2b8c size 0xf4 virtual false final false
static bool TryGetColor(::StringW name, ByRef<UnityEngine::Color> color) ;

/// @brief Method HexToColor32 addr 0x2ca5a94 size 0x14 virtual false final false
