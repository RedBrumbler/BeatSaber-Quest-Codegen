...
/// @brief Method .ctor addr 0x2cb03f8 size 0x10 virtual false final false
 void _ctor(UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType t) ;

/// @brief Method .ctor addr 0x2cb0408 size 0x10 virtual false final false
 void _ctor(UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType type, ::StringW text) ;

/// @brief Method .ctor addr 0x2cb0418 size 0x10 virtual false final false
