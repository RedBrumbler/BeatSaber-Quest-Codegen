...
/// @brief Method get_type addr 0x2cabce4 size 0x8 virtual false final false
 UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplierType get_type() ;

/// @brief Method set_type addr 0x2cb2c60 size 0x4 virtual false final false
 void set_type(UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplierType value) ;

/// @brief Method .ctor addr 0x2cb2ed0 size 0x10 virtual false final false
 void _ctor(UnityEngine::UIElements::StyleSheets::Syntax::ExpressionMultiplierType type) ;

/// @brief Method SetType addr 0x2cb2ee0 size 0x54 virtual false final false
