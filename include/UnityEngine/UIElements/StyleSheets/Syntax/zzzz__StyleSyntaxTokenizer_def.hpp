...
/// @brief Method get_current addr 0x2cb0428 size 0xac virtual false final false
 UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken get_current() ;

/// @brief Method MoveNext addr 0x2cb04d4 size 0x114 virtual false final false
 UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken MoveNext() ;

/// @brief Method PeekNext addr 0x2cb05e8 size 0xb0 virtual false final false
 UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken PeekNext() ;

/// @brief Method Tokenize addr 0x2cb0698 size 0xcf8 virtual false final false
 void Tokenize(::StringW syntax) ;

/// @brief Method IsNextCharacter addr 0x2cb13cc size 0x44 virtual false final false
static bool IsNextCharacter(::StringW s, int32_t index, char16_t c) ;

/// @brief Method IsNextLetterOrDash addr 0x2cb14a8 size 0xc0 virtual false final false
static bool IsNextLetterOrDash(::StringW s, int32_t index) ;

/// @brief Method IsNextNumber addr 0x2cb1410 size 0x98 virtual false final false
static bool IsNextNumber(::StringW s, int32_t index) ;

/// @brief Method GlobCharacter addr 0x2cb1390 size 0x3c virtual false final false
static int32_t GlobCharacter(::StringW s, int32_t index, char16_t c) ;

// Ctor Parameters []
explicit StyleSyntaxTokenizer() ;

/// @brief Method .ctor addr 0x2cb1568 size 0x84 virtual false final false
 void _ctor() ;
