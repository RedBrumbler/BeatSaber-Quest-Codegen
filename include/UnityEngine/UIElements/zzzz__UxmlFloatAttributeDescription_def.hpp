...
/// @brief Method .ctor addr 0x2cca34c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetValueFromBag>b__3_0 addr 0x2cca354 size 0x8 virtual false final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7092), inst: 374 }), TypeDefinitionIndex(TypeDefinitionIndex(7092))}
...
/// @brief Method .ctor addr 0x2cca04c size 0x9c virtual false final false
 void _ctor() ;

/// @brief Method GetValueFromBag addr 0x2cca0e8 size 0x164 virtual true final false
 float_t GetValueFromBag(UnityEngine::UIElements::IUxmlAttributes bag, UnityEngine::UIElements::CreationContext cc) ;

/// @brief Method ConvertValueToFloat addr 0x2cca24c size 0x9c virtual false final false
