...
/// @brief Method .ctor addr 0x2cd4594 size 0x28 virtual false final false
 void _ctor(UnityEngine::UIElements::PanelSettings settings) ;

/// @brief Method get_isInitialized addr 0x2cd48dc size 0x10 virtual false final false
 bool get_isInitialized() ;

/// @brief Method get_panel addr 0x2cd436c size 0x138 virtual false final false
 UnityEngine::UIElements::BaseRuntimePanel get_panel() ;

/// @brief Method DisposePanel addr 0x2cd4880 size 0x20 virtual false final false
 void DisposePanel() ;

/// @brief Method SetTargetTexture addr 0x2cd4150 size 0x28 virtual false final false
 void SetTargetTexture() ;

/// @brief Method SetSortingPriority addr 0x2cd4270 size 0x34 virtual false final false
 void SetSortingPriority() ;

/// @brief Method SetTargetDisplay addr 0x2cd42e0 size 0x28 virtual false final false
 void SetTargetDisplay() ;

/// @brief Method CreateRelatedRuntimePanel addr 0x2cd4c4c size 0xf8 virtual false final false
 UnityEngine::UIElements::BaseRuntimePanel CreateRelatedRuntimePanel() ;

/// @brief Method DisposeRelatedPanel addr 0x2cd4d44 size 0x5c virtual false final false
 void DisposeRelatedPanel() ;

/// @brief Method MarkPotentiallyEmpty addr 0x2cd4bf0 size 0x5c virtual false final false
...
/// @brief Method get_themeStyleSheet addr 0x2cd3fa4 size 0x8 virtual false final false
 UnityEngine::UIElements::ThemeStyleSheet get_themeStyleSheet() ;

/// @brief Method set_themeStyleSheet addr 0x2cd3fac size 0xc virtual false final false
 void set_themeStyleSheet(UnityEngine::UIElements::ThemeStyleSheet value) ;

/// @brief Method get_targetTexture addr 0x2cd4114 size 0x8 virtual false final false
 UnityEngine::RenderTexture get_targetTexture() ;

/// @brief Method set_targetTexture addr 0x2cd411c size 0x34 virtual false final false
 void set_targetTexture(UnityEngine::RenderTexture value) ;

/// @brief Method get_scaleMode addr 0x2cd4178 size 0x8 virtual false final false
 UnityEngine::UIElements::PanelScaleMode get_scaleMode() ;

/// @brief Method set_scaleMode addr 0x2cd4180 size 0x8 virtual false final false
 void set_scaleMode(UnityEngine::UIElements::PanelScaleMode value) ;

/// @brief Method get_scale addr 0x2cd4188 size 0x8 virtual false final false
 float_t get_scale() ;

/// @brief Method set_scale addr 0x2cd4190 size 0x8 virtual false final false
 void set_scale(float_t value) ;

/// @brief Method get_referenceDpi addr 0x2cd4198 size 0x8 virtual false final false
 float_t get_referenceDpi() ;

/// @brief Method set_referenceDpi addr 0x2cd41a0 size 0x2c virtual false final false
 void set_referenceDpi(float_t value) ;

/// @brief Method get_fallbackDpi addr 0x2cd41cc size 0x8 virtual false final false
 float_t get_fallbackDpi() ;

/// @brief Method set_fallbackDpi addr 0x2cd41d4 size 0x2c virtual false final false
 void set_fallbackDpi(float_t value) ;

/// @brief Method get_referenceResolution addr 0x2cd4200 size 0x8 virtual false final false
 UnityEngine::Vector2Int get_referenceResolution() ;

/// @brief Method set_referenceResolution addr 0x2cd4208 size 0x8 virtual false final false
 void set_referenceResolution(UnityEngine::Vector2Int value) ;

/// @brief Method get_screenMatchMode addr 0x2cd4210 size 0x8 virtual false final false
 UnityEngine::UIElements::PanelScreenMatchMode get_screenMatchMode() ;

/// @brief Method set_screenMatchMode addr 0x2cd4218 size 0x8 virtual false final false
 void set_screenMatchMode(UnityEngine::UIElements::PanelScreenMatchMode value) ;

/// @brief Method get_match addr 0x2cd4220 size 0x8 virtual false final false
 float_t get_match() ;

/// @brief Method set_match addr 0x2cd4228 size 0x8 virtual false final false
 void set_match(float_t value) ;

/// @brief Method get_sortingOrder addr 0x2cd4230 size 0x8 virtual false final false
 float_t get_sortingOrder() ;

/// @brief Method set_sortingOrder addr 0x2cd4238 size 0x20 virtual false final false
 void set_sortingOrder(float_t value) ;

/// @brief Method ApplySortingOrder addr 0x2cd4258 size 0x18 virtual false final false
 void ApplySortingOrder() ;

/// @brief Method get_targetDisplay addr 0x2cd42a4 size 0x8 virtual false final false
 int32_t get_targetDisplay() ;

/// @brief Method set_targetDisplay addr 0x2cd42ac size 0x34 virtual false final false
 void set_targetDisplay(int32_t value) ;

/// @brief Method get_clearDepthStencil addr 0x2cd4308 size 0x8 virtual false final false
 bool get_clearDepthStencil() ;

/// @brief Method set_clearDepthStencil addr 0x2cd4310 size 0xc virtual false final false
 void set_clearDepthStencil(bool value) ;

/// @brief Method get_depthClearValue addr 0x2cd431c size 0xc virtual false final false
 float_t get_depthClearValue() ;

/// @brief Method get_clearColor addr 0x2cd4328 size 0x8 virtual false final false
 bool get_clearColor() ;

/// @brief Method set_clearColor addr 0x2cd4330 size 0xc virtual false final false
 void set_clearColor(bool value) ;

/// @brief Method get_colorClearValue addr 0x2cd433c size 0xc virtual false final false
 UnityEngine::Color get_colorClearValue() ;

/// @brief Method set_colorClearValue addr 0x2cd4348 size 0xc virtual false final false
 void set_colorClearValue(UnityEngine::Color value) ;

/// @brief Method get_panel addr 0x2cd4354 size 0x18 virtual false final false
 UnityEngine::UIElements::BaseRuntimePanel get_panel() ;

/// @brief Method get_visualTree addr 0x2cd44a4 size 0x2c virtual false final false
 UnityEngine::UIElements::VisualElement get_visualTree() ;

/// @brief Method get_dynamicAtlasSettings addr 0x2cd44d0 size 0x8 virtual false final false
 UnityEngine::UIElements::DynamicAtlasSettings get_dynamicAtlasSettings() ;

/// @brief Method set_dynamicAtlasSettings addr 0x2cd44d8 size 0x8 virtual false final false
 void set_dynamicAtlasSettings(UnityEngine::UIElements::DynamicAtlasSettings value) ;

// Ctor Parameters []
explicit PanelSettings() ;

/// @brief Method .ctor addr 0x2cd44e0 size 0xb4 virtual false final false
 void _ctor() ;

/// @brief Method Reset addr 0x2cd45bc size 0x4 virtual false final false
 void Reset() ;

/// @brief Method OnEnable addr 0x2cd45c0 size 0x108 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2cd4854 size 0x2c virtual false final false
 void OnDisable() ;

/// @brief Method DisposePanel addr 0x2cd48a0 size 0x2c virtual false final false
 void DisposePanel() ;

/// @brief Method get_ScreenDPI addr 0x2cd48cc size 0x8 virtual false final false
 float_t get_ScreenDPI() ;

/// @brief Method set_ScreenDPI addr 0x2cd48d4 size 0x8 virtual false final false
 void set_ScreenDPI(float_t value) ;

/// @brief Method UpdateScreenDPI addr 0x2cd46c8 size 0x1c virtual false final false
 void UpdateScreenDPI() ;

/// @brief Method ApplyThemeStyleSheet addr 0x2cd3fb8 size 0x15c virtual false final false
 void ApplyThemeStyleSheet(UnityEngine::UIElements::VisualElement root) ;

/// @brief Method InitializeShaders addr 0x2cd46e4 size 0x170 virtual false final false
 void InitializeShaders() ;

/// @brief Method ApplyPanelSettings addr 0x2cd1c18 size 0x5fc virtual false final false
 void ApplyPanelSettings() ;

/// @brief Method SetScreenToPanelSpaceFunction addr 0x2cd4bc0 size 0x30 virtual false final false
 void SetScreenToPanelSpaceFunction(System::Func_2<UnityEngine::Vector2,UnityEngine::Vector2> screentoPanelSpaceFunction) ;

/// @brief Method ResolveScale addr 0x2cd4aa8 size 0x118 virtual false final false
 float_t ResolveScale(UnityEngine::Rect targetRect, float_t screenDpi) ;

/// @brief Method GetDisplayRect addr 0x2cd48ec size 0x1bc virtual false final false
 UnityEngine::Rect GetDisplayRect() ;

/// @brief Method AttachAndInsertUIDocumentToVisualTree addr 0x2cd09a4 size 0x94 virtual false final false
 void AttachAndInsertUIDocumentToVisualTree(UnityEngine::UIElements::UIDocument uiDocument) ;

/// @brief Method DetachUIDocument addr 0x2cd0928 size 0x7c virtual false final false
