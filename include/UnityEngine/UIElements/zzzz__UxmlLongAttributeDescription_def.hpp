...
/// @brief Method .ctor addr 0x2ccaa9c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetValueFromBag>b__3_0 addr 0x2ccaaa4 size 0x40 virtual false final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7092)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7092), inst: 831 })}
...
/// @brief Method .ctor addr 0x2cca7fc size 0x9c virtual false final false
 void _ctor() ;

/// @brief Method GetValueFromBag addr 0x2cca898 size 0x164 virtual true final false
 int64_t GetValueFromBag(UnityEngine::UIElements::IUxmlAttributes bag, UnityEngine::UIElements::CreationContext cc) ;

/// @brief Method ConvertValueToLong addr 0x2cca9fc size 0x3c virtual false final false
