...
/// @brief Method .ctor addr 0x2cc2248 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <.cctor>b__25_0 addr 0x2cc2250 size 0x8 virtual false final false
 bool __cctor_b__25_0() ;

/// @brief Method <.cctor>b__25_1 addr 0x2cc2258 size 0x8 virtual false final false
...
/// @brief Method get_startMs addr 0x2cc1fa0 size 0x8 virtual false final false
 int64_t get_startMs() ;

/// @brief Method set_startMs addr 0x2cc1fa8 size 0x8 virtual false final false
 void set_startMs(int64_t value) ;

/// @brief Method get_delayMs addr 0x2cc1fb0 size 0x8 virtual false final false
 int64_t get_delayMs() ;

/// @brief Method set_delayMs addr 0x2cc1fb8 size 0x8 virtual false final false
 void set_delayMs(int64_t value) ;

/// @brief Method get_intervalMs addr 0x2cc1fc0 size 0x8 virtual false final false
 int64_t get_intervalMs() ;

/// @brief Method set_intervalMs addr 0x2cc1fc8 size 0x8 virtual false final false
 void set_intervalMs(int64_t value) ;

/// @brief Method get_endTimeMs addr 0x2cc1fd0 size 0x8 virtual false final false
 int64_t get_endTimeMs() ;

// Ctor Parameters []
explicit ScheduledItem() ;

/// @brief Method .ctor addr 0x2cc1fd8 size 0x74 virtual false final false
 void _ctor() ;

/// @brief Method ResetStartTime addr 0x2cc204c size 0x5c virtual false final false
 void ResetStartTime() ;
...
/// @brief Method OnItemUnscheduled addr 0x2cc20a8 size 0x4 virtual true final false
 void OnItemUnscheduled() ;

/// @brief Method ShouldUnschedule addr 0x2cc20ac size 0x20 virtual true final false
