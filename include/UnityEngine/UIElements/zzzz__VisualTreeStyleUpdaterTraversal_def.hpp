...
/// @brief Method .ctor addr 0x2c7c984 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ProcessMatchedRules>b__24_0 addr 0x2c7c98c size 0x44 virtual false final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7578))}
...
/// @brief Method get_currentPixelsPerPoint addr 0x2c7b4b0 size 0x8 virtual false final false
 float_t get_currentPixelsPerPoint() ;

/// @brief Method set_currentPixelsPerPoint addr 0x2c7b4b8 size 0x8 virtual false final false
 void set_currentPixelsPerPoint(float_t value) ;

/// @brief Method PrepareTraversal addr 0x2c7ae88 size 0x8 virtual false final false
 void PrepareTraversal(float_t pixelsPerPoint) ;

/// @brief Method AddChangedElement addr 0x2c7a6a0 size 0x80 virtual false final false
...
/// @brief Method Clear addr 0x2c7ab0c size 0xa4 virtual false final false
 void Clear() ;

/// @brief Method PropagateToChildren addr 0x2c7b4c0 size 0xd4 virtual false final false
 void PropagateToChildren(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method PropagateToParents addr 0x2c7b594 size 0xa8 virtual false final false
 void PropagateToParents(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method OnProcessMatchResult addr 0x2c7b63c size 0x30 virtual false final false
...
/// @brief Method TraverseRecursive addr 0x2c7b66c size 0x600 virtual true final false
 void TraverseRecursive(UnityEngine::UIElements::VisualElement element, int32_t depth) ;

/// @brief Method ProcessTransitions addr 0x2c7c4ac size 0xe4 virtual false final false
...
/// @brief Method ForceUpdateTransitions addr 0x2c7c590 size 0x294 virtual false final false
 void ForceUpdateTransitions(UnityEngine::UIElements::VisualElement element) ;

/// @brief Method CancelAnimationsWithNoTransitionProperty addr 0x2c7abb0 size 0x2c8 virtual false final false
...
/// @brief Method ShouldSkipElement addr 0x2c7bc6c size 0x84 virtual false final false
 bool ShouldSkipElement(UnityEngine::UIElements::VisualElement element) ;

/// @brief Method ProcessMatchedRules addr 0x2c7bcf0 size 0x7bc virtual false final false
...
/// @brief Method ProcessMatchedVariables addr 0x2c7c824 size 0xfc virtual false final false
...
/// @brief Method .ctor addr 0x2c7af64 size 0x208 virtual false final false
 void _ctor() ;
