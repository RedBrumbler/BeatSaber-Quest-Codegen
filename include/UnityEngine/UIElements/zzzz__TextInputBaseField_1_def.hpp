...
template<::cordl_internals::il2cpp_reference_type TValueType>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7213)), TypeDefinitionIndex(TypeDefinitionIndex(7094)), TypeDefinitionIndex(TypeDefinitionIndex(7248)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7248), inst: 888 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7213), inst: 2 })
...
template<::cordl_internals::il2cpp_reference_type TValueType>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7214)), TypeDefinitionIndex(TypeDefinitionIndex(6847))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7214), inst: 2 })
...
template<::cordl_internals::il2cpp_reference_type TValueType>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7215)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7247), inst: 890 }), TypeDefinitionIndex(TypeDefinitionIndex(7247))}
