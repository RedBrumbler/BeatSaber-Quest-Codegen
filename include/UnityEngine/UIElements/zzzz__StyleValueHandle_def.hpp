...
/// @brief Method get_valueType addr 0x2d24644 size 0x8 virtual false final false
 UnityEngine::UIElements::StyleValueType get_valueType() ;

/// @brief Method set_valueType addr 0x2d25204 size 0x8 virtual false final false
