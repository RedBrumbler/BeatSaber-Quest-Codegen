...
/// @brief Method GetPointerType addr 0x2d099dc size 0x9c virtual false final false
static ::StringW GetPointerType(int32_t pointerId) ;

/// @brief Method IsDirectManipulationDevice addr 0x2d09a78 size 0x8c virtual false final false
