...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7366)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7366), inst: 4569 })}
...
/// @brief Method set_direction addr 0x2d0def4 size 0x8 virtual false final false
 void set_direction(UnityEngine::UIElements::UnityEngine__UIElements__NavigationTabEvent__Direction value) ;

/// @brief Method DetermineMoveDirection addr 0x2d0defc size 0x1c virtual false final false
...
/// @brief Method GetPooled addr 0x2d0df18 size 0x8c virtual false final false
static UnityEngine::UIElements::NavigationTabEvent GetPooled(int32_t moveValue) ;

/// @brief Method Init addr 0x2d0dfa4 size 0x50 virtual true final false
 void Init() ;

// Ctor Parameters []
explicit NavigationTabEvent() ;

/// @brief Method .ctor addr 0x2d0dff4 size 0x58 virtual false final false
 void _ctor() ;
