...
/// @brief Method .ctor addr 0x2d334a4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_vertexCount addr 0x2d334ac size 0x48 virtual false final false
 int32_t get_vertexCount() ;

/// @brief Method get_indexCount addr 0x2d334f4 size 0x48 virtual false final false
 int32_t get_indexCount() ;

/// @brief Method get_uvRegion addr 0x2d3353c size 0xc virtual false final false
 UnityEngine::Rect get_uvRegion() ;

/// @brief Method SetNextVertex addr 0x2d33548 size 0x9c virtual false final false
 void SetNextVertex(UnityEngine::UIElements::Vertex vertex) ;

/// @brief Method SetNextIndex addr 0x2d335e4 size 0x64 virtual false final false
 void SetNextIndex(uint16_t index) ;

/// @brief Method SetAllVertices addr 0x2d33648 size 0xd8 virtual false final false
 void SetAllVertices(::ArrayW<UnityEngine::UIElements::Vertex> vertices) ;

/// @brief Method SetAllIndices addr 0x2d33720 size 0xd8 virtual false final false
 void SetAllIndices(::ArrayW<uint16_t> indices) ;

/// @brief Method Reset addr 0x2d337f8 size 0x4c virtual false final false
...
/// @brief Method Reset addr 0x2d33844 size 0x18 virtual false final false
