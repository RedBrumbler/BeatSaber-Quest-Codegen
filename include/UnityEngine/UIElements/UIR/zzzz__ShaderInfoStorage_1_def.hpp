...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7500)), TypeDefinitionIndex(TypeDefinitionIndex(7499))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7500), inst: 280 })
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7499)), TypeDefinitionIndex(TypeDefinitionIndex(7500))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7500), inst: 719 })
// CS Name: UnityEngine.UIElements.UIR.ShaderInfoStorage`1
