...
namespace UnityEngine::UIElements::UIR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7518)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7518), inst: 330 })}
...
/// @brief Method .ctor addr 0x2c881e4 size 0x48 virtual false final false
 void _ctor() ;
