...
namespace UnityEngine::UIElements::UIR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7518)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7518), inst: 395 })}
...
/// @brief Method Reset addr 0x2c874ec size 0x10 virtual false final false
 void Reset() ;

// Ctor Parameters []
explicit VectorImageRenderInfo() ;

/// @brief Method .ctor addr 0x2c87484 size 0x48 virtual false final false
 void _ctor() ;
