...
namespace UnityEngine::UIElements::UIR {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7518), inst: 300 }), TypeDefinitionIndex(TypeDefinitionIndex(7518))}
...
/// @brief Method Reset addr 0x2c877a4 size 0x68 virtual false final false
 void Reset() ;

// Ctor Parameters []
explicit GradientRemap() ;

/// @brief Method .ctor addr 0x2c87748 size 0x48 virtual false final false
 void _ctor() ;
