...
namespace UnityEngine::UIElements::UIR {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7518), inst: 366 }), TypeDefinitionIndex(TypeDefinitionIndex(7518))}
...
/// @brief Method Reset addr 0x2c8fb3c size 0x24 virtual false final false
 void Reset() ;

/// @brief Method ExecuteNonDrawMesh addr 0x2c8e2c8 size 0xbbc virtual false final false
...
/// @brief Method Blit addr 0x2c9011c size 0x170 virtual false final false
 void Blit(UnityEngine::Texture source, UnityEngine::RenderTexture destination, float_t depth) ;

/// @brief Method CombineScissorRects addr 0x2c8ff64 size 0x1b8 virtual false final false
static UnityEngine::Rect CombineScissorRects(UnityEngine::Rect r0, UnityEngine::Rect r1) ;

/// @brief Method RectPointsToPixelsAndFlipYAxis addr 0x2c8fb60 size 0x404 virtual false final false
...
/// @brief Method .ctor addr 0x2c9028c size 0x48 virtual false final false
 void _ctor() ;
