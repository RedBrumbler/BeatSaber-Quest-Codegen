...
/// @brief Method get_lastClosingOrLastCommand addr 0x2d4cdb4 size 0x18 virtual false final false
 UnityEngine::UIElements::UIR::RenderChainCommand get_lastClosingOrLastCommand() ;

/// @brief Method AllocatesID addr 0x2d4cdcc size 0x34 virtual false final false
static bool AllocatesID(UnityEngine::UIElements::UIR::BMPAlloc alloc) ;

/// @brief Method InheritsID addr 0x2d4ce00 size 0x30 virtual false final false
