...
/// @brief Method get_disposed addr 0x2d4687c size 0x8 virtual false final false
 bool get_disposed() ;

/// @brief Method set_disposed addr 0x2d46884 size 0xc virtual false final false
 void set_disposed(bool value) ;

/// @brief Method Dispose addr 0x2d38228 size 0x6c virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x2d46890 size 0x7c virtual true final false
 void Dispose(bool disposing) ;

// Ctor Parameters [CppParam { name: "capacity", ty: "int32_t", modifiers: "", def_value: None }]
explicit TextureBlitter(int32_t capacity) ;

/// @brief Method .ctor addr 0x2d37f20 size 0xb4 virtual false final false
 void _ctor(int32_t capacity) ;

/// @brief Method QueueBlit addr 0x2d38614 size 0x1a4 virtual false final false
...
/// @brief Method BlitOneNow addr 0x2d38e98 size 0xe4 virtual false final false
...
/// @brief Method Commit addr 0x2d38c74 size 0xec virtual false final false
 void Commit(UnityEngine::RenderTexture dst) ;

/// @brief Method BeginBlit addr 0x2d46a38 size 0x1fc virtual false final false
 void BeginBlit(UnityEngine::RenderTexture dst) ;

/// @brief Method DoBlit addr 0x2d46c34 size 0x51c virtual false final false
...
/// @brief Method EndBlit addr 0x2d47150 size 0xe0 virtual false final false
 void EndBlit() ;
