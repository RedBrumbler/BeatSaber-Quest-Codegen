...
/// @brief Method Construct addr 0x2d42fa8 size 0x110 virtual false final false
 void Construct(int32_t pageHeight, int32_t entryWidth, int32_t entryHeight) ;

/// @brief Method ForceFirstAlloc addr 0x2d430b8 size 0x1cc virtual false final false
 void ForceFirstAlloc(uint16_t firstPageX, uint16_t firstPageY) ;

/// @brief Method Allocate addr 0x2d43284 size 0x41c virtual false final false
 UnityEngine::UIElements::UIR::BMPAlloc Allocate(UnityEngine::UIElements::UIR::BaseShaderInfoStorage storage) ;

/// @brief Method Free addr 0x2d43704 size 0x144 virtual false final false
 void Free(UnityEngine::UIElements::UIR::BMPAlloc alloc) ;

/// @brief Method get_entryWidth addr 0x2d43848 size 0x8 virtual false final false
 int32_t get_entryWidth() ;

/// @brief Method get_entryHeight addr 0x2d43850 size 0x8 virtual false final false
 int32_t get_entryHeight() ;

/// @brief Method GetAllocPageAtlasLocation addr 0x2d43858 size 0x78 virtual false final false
 void GetAllocPageAtlasLocation(int32_t page, ByRef<uint16_t> x, ByRef<uint16_t> y) ;

/// @brief Method CountTrailingZeroes addr 0x2d436a0 size 0x64 virtual false final false
