...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7520)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7518), inst: 3842 }), TypeDefinitionIndex(TypeDefinitionIndex(7518)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7520), inst: 901 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7520), inst: 2 })
...
template<>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7518), inst: 3842 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7520), inst: 901 }), TypeDefinitionIndex(TypeDefinitionIndex(7518)), TypeDefinitionIndex(TypeDefinitionIndex(7520))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7520), inst: 899 })
// CS Name: UnityEngine.UIElements.UIR.BasicNode`1
