...
/// @brief Method .ctor addr 0x2c8f8e4 size 0x94 virtual false final false
 void _ctor(uint32_t maxSize) ;

/// @brief Method Allocate addr 0x2c8b334 size 0x13c virtual false final false
 UnityEngine::UIElements::UIR::Alloc Allocate(uint32_t size, bool shortLived) ;

/// @brief Method Free addr 0x2c8b470 size 0x84 virtual false final false
 void Free(UnityEngine::UIElements::UIR::Alloc alloc) ;

/// @brief Method get_isEmpty addr 0x2c8f9b0 size 0x3c virtual false final false
 bool get_isEmpty() ;

/// @brief Method HighLowCollide addr 0x2c8f978 size 0x38 virtual false final false
 bool HighLowCollide() ;
