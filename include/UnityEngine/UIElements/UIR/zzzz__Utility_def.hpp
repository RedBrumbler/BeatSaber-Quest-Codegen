...
/// @brief Method add_GraphicsResourcesRecreate addr 0x2d61250 size 0xf0 virtual false final false
static void add_GraphicsResourcesRecreate(System::Action_1<bool> value) ;

/// @brief Method remove_GraphicsResourcesRecreate addr 0x2d61340 size 0xf0 virtual false final false
static void remove_GraphicsResourcesRecreate(System::Action_1<bool> value) ;

/// @brief Method add_EngineUpdate addr 0x2d61430 size 0xdc virtual false final false
static void add_EngineUpdate(System::Action value) ;

/// @brief Method remove_EngineUpdate addr 0x2d6150c size 0xdc virtual false final false
static void remove_EngineUpdate(System::Action value) ;

/// @brief Method add_FlushPendingResources addr 0x2d615e8 size 0xdc virtual false final false
static void add_FlushPendingResources(System::Action value) ;

/// @brief Method remove_FlushPendingResources addr 0x2d616c4 size 0xdc virtual false final false
static void remove_FlushPendingResources(System::Action value) ;

/// @brief Method add_RegisterIntermediateRenderers addr 0x2d617a0 size 0xf4 virtual false final false
static void add_RegisterIntermediateRenderers(System::Action_1<UnityEngine::Camera> value) ;

/// @brief Method remove_RegisterIntermediateRenderers addr 0x2d61894 size 0xf4 virtual false final false
static void remove_RegisterIntermediateRenderers(System::Action_1<UnityEngine::Camera> value) ;

/// @brief Method add_RenderNodeExecute addr 0x2d61988 size 0xf4 virtual false final false
static void add_RenderNodeExecute(System::Action_1<::cordl_internals::intptr_t> value) ;

/// @brief Method remove_RenderNodeExecute addr 0x2d61a7c size 0xf4 virtual false final false
static void remove_RenderNodeExecute(System::Action_1<::cordl_internals::intptr_t> value) ;

/// @brief Method RaiseGraphicsResourcesRecreate addr 0x2d61b70 size 0x7c virtual false final false
static void RaiseGraphicsResourcesRecreate(bool recreate) ;

/// @brief Method RaiseEngineUpdate addr 0x2d61bec size 0x94 virtual false final false
static void RaiseEngineUpdate() ;

/// @brief Method RaiseFlushPendingResources addr 0x2d61c80 size 0x74 virtual false final false
static void RaiseFlushPendingResources() ;

/// @brief Method RaiseRegisterIntermediateRenderers addr 0x2d61cf4 size 0x7c virtual false final false
static void RaiseRegisterIntermediateRenderers(UnityEngine::Camera camera) ;

/// @brief Method RaiseRenderNodeAdd addr 0x2d61d70 size 0x7c virtual false final false
static void RaiseRenderNodeAdd(::cordl_internals::intptr_t userData) ;

/// @brief Method RaiseRenderNodeExecute addr 0x2d61dec size 0x7c virtual false final false
static void RaiseRenderNodeExecute(::cordl_internals::intptr_t userData) ;

/// @brief Method RaiseRenderNodeCleanup addr 0x2d61e68 size 0x7c virtual false final false
static void RaiseRenderNodeCleanup(::cordl_internals::intptr_t userData) ;

/// @brief Method AllocateBuffer addr 0x2d61ee4 size 0x54 virtual false final false
static ::cordl_internals::intptr_t AllocateBuffer(int32_t elementCount, int32_t elementStride, bool vertexBuffer) ;

/// @brief Method FreeBuffer addr 0x2d61f38 size 0x3c virtual false final false
static void FreeBuffer(::cordl_internals::intptr_t buffer) ;

/// @brief Method UpdateBufferRanges addr 0x2d61f74 size 0x6c virtual false final false
...
/// @brief Method SetVectorArray addr 0x2d61fe0 size 0x5c virtual false final false
...
/// @brief Method GetVertexDeclaration addr 0x2d6203c size 0x3c virtual false final false
...
/// @brief Method RegisterIntermediateRenderer addr 0x2d62078 size 0xec virtual false final false
...
/// @brief Method DrawRanges addr 0x2d62224 size 0x74 virtual false final false
...
/// @brief Method SetPropertyBlock addr 0x2d62298 size 0x3c virtual false final false
static void SetPropertyBlock(UnityEngine::MaterialPropertyBlock props) ;

/// @brief Method SetScissorRect addr 0x2d622d4 size 0x80 virtual false final false
static void SetScissorRect(UnityEngine::RectInt scissorRect) ;

/// @brief Method DisableScissor addr 0x2d62390 size 0x28 virtual false final false
static void DisableScissor() ;

/// @brief Method CreateStencilState addr 0x2d623b8 size 0x84 virtual false final false
static ::cordl_internals::intptr_t CreateStencilState(UnityEngine::Rendering::StencilState stencilState) ;

/// @brief Method SetStencilState addr 0x2d62478 size 0x44 virtual false final false
static void SetStencilState(::cordl_internals::intptr_t stencilState, int32_t stencilRef) ;

/// @brief Method HasMappedBufferRange addr 0x2d624bc size 0x28 virtual false final false
static bool HasMappedBufferRange() ;

/// @brief Method InsertCPUFence addr 0x2d624e4 size 0x28 virtual false final false
static uint32_t InsertCPUFence() ;

/// @brief Method CPUFencePassed addr 0x2d6250c size 0x3c virtual false final false
static bool CPUFencePassed(uint32_t fence) ;

/// @brief Method WaitForCPUFencePassed addr 0x2d62548 size 0x3c virtual false final false
static void WaitForCPUFencePassed(uint32_t fence) ;

/// @brief Method SyncRenderThread addr 0x2d62584 size 0x28 virtual false final false
static void SyncRenderThread() ;

/// @brief Method GetActiveViewport addr 0x2d625ac size 0x84 virtual false final false
static UnityEngine::RectInt GetActiveViewport() ;

/// @brief Method ProfileDrawChainBegin addr 0x2d6266c size 0x28 virtual false final false
static void ProfileDrawChainBegin() ;

/// @brief Method ProfileDrawChainEnd addr 0x2d62694 size 0x28 virtual false final false
static void ProfileDrawChainEnd() ;

/// @brief Method NotifyOfUIREvents addr 0x2d626bc size 0x3c virtual false final false
static void NotifyOfUIREvents(bool subscribe) ;

/// @brief Method GetUnityProjectionMatrix addr 0x2d626f8 size 0x9c virtual false final false
static UnityEngine::Matrix4x4 GetUnityProjectionMatrix() ;

/// @brief Method RegisterIntermediateRenderer_Injected addr 0x2d62164 size 0xc0 virtual false final false
...
/// @brief Method SetScissorRect_Injected addr 0x2d62354 size 0x3c virtual false final false
static void SetScissorRect_Injected(ByRef<UnityEngine::RectInt> scissorRect) ;

/// @brief Method CreateStencilState_Injected addr 0x2d6243c size 0x3c virtual false final false
static ::cordl_internals::intptr_t CreateStencilState_Injected(ByRef<UnityEngine::Rendering::StencilState> stencilState) ;

/// @brief Method GetActiveViewport_Injected addr 0x2d62630 size 0x3c virtual false final false
static void GetActiveViewport_Injected(ByRef<UnityEngine::RectInt> ret) ;

/// @brief Method GetUnityProjectionMatrix_Injected addr 0x2d62794 size 0x3c virtual false final false
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15425))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15425), inst: 729 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15425))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15425), inst: 733 })
// CS Name: UnityEngine.UIElements.UIR.Utility::GPUBuffer`1
