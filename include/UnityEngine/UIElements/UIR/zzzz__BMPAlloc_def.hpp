...
/// @brief Method Equals addr 0x2d42e20 size 0x38 virtual false final false
 bool Equals(UnityEngine::UIElements::UIR::BMPAlloc other) ;

/// @brief Method IsValid addr 0x2d42e58 size 0x10 virtual false final false
 bool IsValid() ;

/// @brief Method ToString addr 0x2d42e68 size 0xf4 virtual true final false
 ::StringW ToString() ;
