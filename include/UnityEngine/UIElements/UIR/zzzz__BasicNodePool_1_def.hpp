...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7520), inst: 900 }), TypeDefinitionIndex(TypeDefinitionIndex(7520)), TypeDefinitionIndex(TypeDefinitionIndex(7521)), TypeDefinitionIndex(TypeDefinitionIndex(7519)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7519), inst: 3846 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7521), inst: 2 })
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7519)), TypeDefinitionIndex(TypeDefinitionIndex(7520)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7520), inst: 900 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7519), inst: 3846 }), TypeDefinitionIndex(TypeDefinitionIndex(7521))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7521), inst: 899 })
// CS Name: UnityEngine.UIElements.UIR.BasicNodePool`1
