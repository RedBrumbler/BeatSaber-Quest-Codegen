...
namespace UnityEngine::UIElements::UIR {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7518), inst: 3844 }), TypeDefinitionIndex(TypeDefinitionIndex(7518))}
...
/// @brief Method get_size addr 0x2c8f640 size 0xc virtual false final false
 uint32_t get_size() ;

// Ctor Parameters []
explicit UnityEngine__UIElements__UIR__BestFitAllocator__Block() ;

/// @brief Method .ctor addr 0x2c8f898 size 0x48 virtual false final false
 void _ctor() ;
...
namespace UnityEngine::UIElements::UIR {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7519), inst: 3844 }), TypeDefinitionIndex(TypeDefinitionIndex(7554)), TypeDefinitionIndex(TypeDefinitionIndex(7519))}
...
/// @brief Method CreateBlock addr 0x2c8f840 size 0x58 virtual false final false
static UnityEngine::UIElements::UIR::UnityEngine__UIElements__UIR__BestFitAllocator__Block CreateBlock() ;

/// @brief Method ResetBlock addr 0x2c8f8e0 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x2c8f508 size 0xf0 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2c865d4 size 0xa8 virtual false final false
 void _ctor(uint32_t size) ;

/// @brief Method get_totalSize addr 0x2c8f5f8 size 0x8 virtual false final false
 uint32_t get_totalSize() ;

/// @brief Method get_highWatermark addr 0x2c86ae8 size 0x8 virtual false final false
 uint32_t get_highWatermark() ;

/// @brief Method Allocate addr 0x2c8639c size 0x194 virtual false final false
 UnityEngine::UIElements::UIR::Alloc Allocate(uint32_t size) ;

/// @brief Method Free addr 0x2c8688c size 0x25c virtual false final false
 void Free(UnityEngine::UIElements::UIR::Alloc alloc) ;

/// @brief Method CoalesceBlockWithPrevious addr 0x2c8f738 size 0x108 virtual false final false
...
/// @brief Method BestFitFindAvailableBlock addr 0x2c8f600 size 0x40 virtual false final false
 UnityEngine::UIElements::UIR::UnityEngine__UIElements__UIR__BestFitAllocator__Block BestFitFindAvailableBlock(uint32_t size) ;

/// @brief Method SplitBlock addr 0x2c8f64c size 0xec virtual false final false
