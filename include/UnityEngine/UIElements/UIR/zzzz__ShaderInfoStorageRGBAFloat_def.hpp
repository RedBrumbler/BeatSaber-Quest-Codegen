...
/// @brief Method .ctor addr 0x2d46870 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <.cctor>b__2_0 addr 0x2d46878 size 0x4 virtual false final false
...
namespace UnityEngine::UIElements::UIR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10211)), TypeDefinitionIndex(TypeDefinitionIndex(7500)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7500), inst: 280 })}
...
/// @brief Method .ctor addr 0x2d44264 size 0x94 virtual false final false
