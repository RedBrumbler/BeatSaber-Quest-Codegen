...
/// @brief Method get_pageWidth addr 0x2d438d0 size 0x8 virtual false final false
static int32_t get_pageWidth() ;

/// @brief Method get_pageHeight addr 0x2d438d8 size 0x8 virtual false final false
static int32_t get_pageHeight() ;

/// @brief Method AllocToTexelCoord addr 0x2d438e0 size 0x50 virtual false final false
...
/// @brief Method AllocToConstantBufferIndex addr 0x2d43930 size 0x68 virtual false final false
static int32_t AllocToConstantBufferIndex(UnityEngine::UIElements::UIR::BMPAlloc alloc) ;

/// @brief Method AtlasRectMatchesPage addr 0x2d43998 size 0xf8 virtual false final false
...
/// @brief Method get_transformConstants addr 0x2d43a90 size 0x48 virtual false final false
 Unity::Collections::NativeSlice_1<UnityEngine::UIElements::UIR::Transform3x4> get_transformConstants() ;

/// @brief Method get_clipRectConstants addr 0x2d43ad8 size 0x48 virtual false final false
 Unity::Collections::NativeSlice_1<UnityEngine::Vector4> get_clipRectConstants() ;

/// @brief Method get_atlas addr 0x2d43b20 size 0x90 virtual false final false
 UnityEngine::Texture get_atlas() ;

/// @brief Method Construct addr 0x2d43bb0 size 0x288 virtual false final false
 void Construct() ;

/// @brief Method ReallyCreateStorage addr 0x2d43e38 size 0x42c virtual false final false
 void ReallyCreateStorage() ;

/// @brief Method Dispose addr 0x2d44a08 size 0xd0 virtual false final false
 void Dispose() ;

/// @brief Method IssuePendingStorageChanges addr 0x2d44b44 size 0x18 virtual false final false
 void IssuePendingStorageChanges() ;

/// @brief Method AllocTransform addr 0x2d44b5c size 0xe8 virtual false final false
 UnityEngine::UIElements::UIR::BMPAlloc AllocTransform() ;

/// @brief Method AllocClipRect addr 0x2d44c44 size 0xe8 virtual false final false
 UnityEngine::UIElements::UIR::BMPAlloc AllocClipRect() ;

/// @brief Method AllocOpacity addr 0x2d44d2c size 0x28 virtual false final false
 UnityEngine::UIElements::UIR::BMPAlloc AllocOpacity() ;

/// @brief Method AllocColor addr 0x2d44d54 size 0x28 virtual false final false
 UnityEngine::UIElements::UIR::BMPAlloc AllocColor() ;

/// @brief Method AllocTextCoreSettings addr 0x2d44d7c size 0x28 virtual false final false
 UnityEngine::UIElements::UIR::BMPAlloc AllocTextCoreSettings(UnityEngine::UIElements::UIR::TextCoreSettings settings) ;

/// @brief Method SetTransformValue addr 0x2d4438c size 0x214 virtual false final false
 void SetTransformValue(UnityEngine::UIElements::UIR::BMPAlloc alloc, UnityEngine::Matrix4x4 xform) ;

/// @brief Method SetClipRectValue addr 0x2d445a0 size 0x138 virtual false final false
 void SetClipRectValue(UnityEngine::UIElements::UIR::BMPAlloc alloc, UnityEngine::Vector4 clipRect) ;

/// @brief Method SetOpacityValue addr 0x2d446d8 size 0xdc virtual false final false
 void SetOpacityValue(UnityEngine::UIElements::UIR::BMPAlloc alloc, float_t opacity) ;

/// @brief Method SetColorValue addr 0x2d447b4 size 0xf0 virtual false final false
 void SetColorValue(UnityEngine::UIElements::UIR::BMPAlloc alloc, UnityEngine::Color color) ;

/// @brief Method SetTextCoreSettingValue addr 0x2d448a4 size 0x164 virtual false final false
...
/// @brief Method FreeTransform addr 0x2d44da4 size 0x74 virtual false final false
 void FreeTransform(UnityEngine::UIElements::UIR::BMPAlloc alloc) ;

/// @brief Method FreeClipRect addr 0x2d44e18 size 0x74 virtual false final false
 void FreeClipRect(UnityEngine::UIElements::UIR::BMPAlloc alloc) ;

/// @brief Method FreeOpacity addr 0x2d44e8c size 0x74 virtual false final false
 void FreeOpacity(UnityEngine::UIElements::UIR::BMPAlloc alloc) ;

/// @brief Method FreeColor addr 0x2d44f00 size 0x74 virtual false final false
 void FreeColor(UnityEngine::UIElements::UIR::BMPAlloc alloc) ;

/// @brief Method FreeTextCoreSettings addr 0x2d44f74 size 0x74 virtual false final false
 void FreeTextCoreSettings(UnityEngine::UIElements::UIR::BMPAlloc alloc) ;

/// @brief Method TransformAllocToVertexData addr 0x2d44fe8 size 0x120 virtual false final false
 UnityEngine::Color32 TransformAllocToVertexData(UnityEngine::UIElements::UIR::BMPAlloc alloc) ;

/// @brief Method ClipRectAllocToVertexData addr 0x2d45108 size 0x120 virtual false final false
 UnityEngine::Color32 ClipRectAllocToVertexData(UnityEngine::UIElements::UIR::BMPAlloc alloc) ;

/// @brief Method OpacityAllocToVertexData addr 0x2d45228 size 0xfc virtual false final false
 UnityEngine::Color32 OpacityAllocToVertexData(UnityEngine::UIElements::UIR::BMPAlloc alloc) ;

/// @brief Method ColorAllocToVertexData addr 0x2d45324 size 0xfc virtual false final false
 UnityEngine::Color32 ColorAllocToVertexData(UnityEngine::UIElements::UIR::BMPAlloc alloc) ;

/// @brief Method TextCoreSettingsToVertexData addr 0x2d45420 size 0xfc virtual false final false
