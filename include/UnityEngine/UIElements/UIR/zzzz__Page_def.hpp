...
/// @brief Method .ctor addr 0x2c8b4f4 size 0x14c virtual false final false
 void _ctor(uint32_t vertexMaxCount, uint32_t indexMaxCount, uint32_t maxQueuedFrameCount, bool mockPage) ;

/// @brief Method get_disposed addr 0x2c8f9ec size 0x8 virtual false final false
 bool get_disposed() ;

/// @brief Method set_disposed addr 0x2c8f9f4 size 0xc virtual false final false
 void set_disposed(bool value) ;

/// @brief Method Dispose addr 0x2c8f0b4 size 0x6c virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x2c8fa00 size 0x90 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method get_isEmpty addr 0x2c8b640 size 0x48 virtual false final false
 bool get_isEmpty() ;
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7557), inst: 729 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7557))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7557), inst: 733 })
// CS Name: UnityEngine.UIElements.UIR.Page::DataSet`1
