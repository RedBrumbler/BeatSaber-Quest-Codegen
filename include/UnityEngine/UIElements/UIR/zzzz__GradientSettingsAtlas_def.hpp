...
/// @brief Method WriteRawInt2Packed addr 0x2d45f18 size 0x88 virtual false final false
 void WriteRawInt2Packed(int32_t v0, int32_t v1, int32_t destX, int32_t destY) ;

/// @brief Method WriteRawFloat4Packed addr 0x2d45e70 size 0xa8 virtual false final false
...
/// @brief Method get_length addr 0x2d456e0 size 0x8 virtual false final false
 int32_t get_length() ;

/// @brief Method get_disposed addr 0x2d456e8 size 0x8 virtual false final false
 bool get_disposed() ;

/// @brief Method set_disposed addr 0x2d456f0 size 0xc virtual false final false
 void set_disposed(bool value) ;

/// @brief Method Dispose addr 0x2d456fc size 0x6c virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x2d45768 size 0x78 virtual true final false
...
/// @brief Method .ctor addr 0x2d457e0 size 0x30 virtual false final false
 void _ctor(int32_t length) ;

/// @brief Method Reset addr 0x2d45810 size 0xcc virtual false final false
 void Reset() ;

/// @brief Method get_atlas addr 0x2d458dc size 0x8 virtual false final false
 UnityEngine::Texture2D get_atlas() ;

/// @brief Method Add addr 0x2d458e4 size 0xec virtual false final false
 UnityEngine::UIElements::UIR::Alloc Add(int32_t count) ;

/// @brief Method Write addr 0x2d459d0 size 0x4a0 virtual false final false
...
/// @brief Method get_MustCommit addr 0x2d45fa0 size 0x8 virtual false final false
 bool get_MustCommit() ;

/// @brief Method set_MustCommit addr 0x2d45fa8 size 0xc virtual false final false
 void set_MustCommit(bool value) ;

/// @brief Method Commit addr 0x2d45fb4 size 0x64 virtual false final false
 void Commit() ;

/// @brief Method PrepareAtlas addr 0x2d46018 size 0x168 virtual false final false
 void PrepareAtlas() ;
