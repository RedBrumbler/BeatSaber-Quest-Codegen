...
/// @brief Method get_meshGenerationContext addr 0x2c9a7dc size 0x8 virtual false final false
 UnityEngine::UIElements::MeshGenerationContext get_meshGenerationContext() ;

// Ctor Parameters []
explicit UIRTextUpdatePainter() ;

/// @brief Method .ctor addr 0x2c9a7e4 size 0x70 virtual false final false
 void _ctor() ;

/// @brief Method Begin addr 0x2c9a854 size 0x244 virtual false final false
 void Begin(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::UIR::UIRenderDevice device) ;

/// @brief Method End addr 0x2c9aa98 size 0x8c virtual false final false
 void End() ;

/// @brief Method Dispose addr 0x2c9ab24 size 0xc4 virtual true final true
 void Dispose() ;

/// @brief Method DrawRectangle addr 0x2c9abe8 size 0x4 virtual true final true
...
/// @brief Method DrawImmediate addr 0x2c9abec size 0x4 virtual true final true
 void DrawImmediate(System::Action callback, bool cullingEnabled) ;

/// @brief Method DrawText addr 0x2c9abf0 size 0x368 virtual true final true
