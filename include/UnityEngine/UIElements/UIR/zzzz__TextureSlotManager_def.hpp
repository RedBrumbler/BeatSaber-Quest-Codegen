...
/// @brief Method .ctor addr 0x2d54fdc size 0x168 virtual false final false
 void _ctor() ;

/// @brief Method Reset addr 0x2d55144 size 0x12c virtual false final false
 void Reset() ;

/// @brief Method StartNewBatch addr 0x2d55270 size 0x6c virtual false final false
 void StartNewBatch() ;

/// @brief Method IndexOf addr 0x2d552dc size 0xd4 virtual false final false
 int32_t IndexOf(UnityEngine::UIElements::TextureId id) ;

/// @brief Method MarkUsed addr 0x2d553b0 size 0x58 virtual false final false
 void MarkUsed(int32_t slotIndex) ;

/// @brief Method get_FreeSlots addr 0x2d55408 size 0x8 virtual false final false
 int32_t get_FreeSlots() ;

/// @brief Method set_FreeSlots addr 0x2d55410 size 0x8 virtual false final false
 void set_FreeSlots(int32_t value) ;

/// @brief Method FindOldestSlot addr 0x2d55418 size 0xd0 virtual false final false
 int32_t FindOldestSlot() ;

/// @brief Method Bind addr 0x2d554e8 size 0x218 virtual false final false
