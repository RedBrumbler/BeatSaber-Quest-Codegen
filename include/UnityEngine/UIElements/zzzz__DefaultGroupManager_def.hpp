...
/// @brief Method OnOptionSelectionChanged addr 0x2c819e0 size 0x1d0 virtual true final true
 void OnOptionSelectionChanged(UnityEngine::UIElements::IGroupBoxOption selectedOption) ;

/// @brief Method RegisterOption addr 0x2c81bb0 size 0xd4 virtual true final true
 void RegisterOption(UnityEngine::UIElements::IGroupBoxOption option) ;

/// @brief Method UnregisterOption addr 0x2c81c84 size 0x58 virtual true final true
 void UnregisterOption(UnityEngine::UIElements::IGroupBoxOption option) ;

// Ctor Parameters []
explicit DefaultGroupManager() ;

/// @brief Method .ctor addr 0x2c81cdc size 0x7c virtual false final false
 void _ctor() ;
