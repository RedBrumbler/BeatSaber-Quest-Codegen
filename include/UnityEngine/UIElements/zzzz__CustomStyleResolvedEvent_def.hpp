...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7298), inst: 1641 }), TypeDefinitionIndex(TypeDefinitionIndex(7298))}
...
/// @brief Method get_customStyle addr 0x2d002c4 size 0x88 virtual false final false
 UnityEngine::UIElements::ICustomStyle get_customStyle() ;

// Ctor Parameters []
explicit CustomStyleResolvedEvent() ;

/// @brief Method .ctor addr 0x2d0b70c size 0x6c virtual false final false
 void _ctor() ;
