...
/// @brief Method Schedule addr 0x2cc2260 size 0x1c8 virtual true final true
 void Schedule(UnityEngine::UIElements::ScheduledItem item) ;

/// @brief Method RemovedScheduledItemAt addr 0x2cc2428 size 0x6c virtual false final false
 bool RemovedScheduledItemAt(int32_t index) ;

/// @brief Method Unschedule addr 0x2cc2494 size 0x1a4 virtual true final true
 void Unschedule(UnityEngine::UIElements::ScheduledItem item) ;

/// @brief Method PrivateUnSchedule addr 0x2cc2638 size 0xa0 virtual false final false
 bool PrivateUnSchedule(UnityEngine::UIElements::ScheduledItem sItem) ;

/// @brief Method UpdateScheduledEvents addr 0x2cc26d8 size 0x310 virtual true final true
 void UpdateScheduledEvents() ;

// Ctor Parameters []
explicit TimerEventScheduler() ;

/// @brief Method .ctor addr 0x2cc29e8 size 0xf0 virtual false final false
 void _ctor() ;
