...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7350)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7350), inst: 1905 })}
...
/// @brief Method PreDispatch addr 0x2d0cfac size 0xa8 virtual true final false
 void PreDispatch(UnityEngine::UIElements::IPanel panel) ;

// Ctor Parameters []
explicit FocusEvent() ;

/// @brief Method .ctor addr 0x2d0d054 size 0x48 virtual false final false
 void _ctor() ;
