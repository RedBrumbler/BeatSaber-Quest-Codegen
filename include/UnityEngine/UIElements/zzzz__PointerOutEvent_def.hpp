...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7316), inst: 4690 }), TypeDefinitionIndex(TypeDefinitionIndex(7316))}
...
/// @brief Method .ctor addr 0x2d0b6c4 size 0x48 virtual false final false
 void _ctor() ;
