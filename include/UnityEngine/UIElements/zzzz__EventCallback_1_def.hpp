...
template<::cordl_internals::il2cpp_reference_type TEventType>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2610)), TypeDefinitionIndex(TypeDefinitionIndex(7300))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7300), inst: 2 })
