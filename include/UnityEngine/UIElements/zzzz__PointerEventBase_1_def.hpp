...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7298), inst: 1638 }), TypeDefinitionIndex(TypeDefinitionIndex(7298)), TypeDefinitionIndex(TypeDefinitionIndex(7316))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7316), inst: 2 })
