...
/// @brief Method get_isCursorOverriden addr 0x2c787f0 size 0x8 virtual false final false
 bool get_isCursorOverriden() ;

/// @brief Method set_isCursorOverriden addr 0x2c787f8 size 0xc virtual false final false
 void set_isCursorOverriden(bool value) ;

/// @brief Method SetCursor addr 0x2c78804 size 0xf0 virtual true final true
 void SetCursor(UnityEngine::UIElements::Cursor cursor) ;

/// @brief Method ResetCursor addr 0x2c788f4 size 0x68 virtual true final true
 void ResetCursor() ;

// Ctor Parameters []
explicit CursorManager() ;

/// @brief Method .ctor addr 0x2c7895c size 0x8 virtual false final false
 void _ctor() ;
