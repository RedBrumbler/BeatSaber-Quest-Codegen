...
/// @brief Method ShapeWindingIsClockwise addr 0x2d322dc size 0x8c virtual false final false
static bool ShapeWindingIsClockwise(int32_t maskDepth, int32_t stencilRef) ;

/// @brief Method IsRoundRect addr 0x2d32368 size 0x204 virtual false final false
static bool IsRoundRect(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method IsVectorImageBackground addr 0x2d3256c size 0x90 virtual false final false
static bool IsVectorImageBackground(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method IsElementSelfHidden addr 0x2d325fc size 0xc0 virtual false final false
static bool IsElementSelfHidden(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method Destroy addr 0x2d326bc size 0xa8 virtual false final false
static void Destroy(UnityEngine::Object obj) ;

/// @brief Method GetPrevPow2 addr 0x2d32764 size 0x34 virtual false final false
static int32_t GetPrevPow2(int32_t n) ;

/// @brief Method GetNextPow2 addr 0x2d32798 size 0x1c virtual false final false
static int32_t GetNextPow2(int32_t n) ;

/// @brief Method GetNextPow2Exp addr 0x2d327b4 size 0x30 virtual false final false
