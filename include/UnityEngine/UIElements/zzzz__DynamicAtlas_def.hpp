...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7518), inst: 3845 }), TypeDefinitionIndex(TypeDefinitionIndex(7518))}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(6864))
// CS Name: UnityEngine.UIElements.DynamicAtlas::TextureInfo
class CORDL_TYPE UnityEngine__UIElements__DynamicAtlas__TextureInfo : public UnityEngine::UIElements::UIR::LinkedPoolItem_1<UnityEngine::UIElements::UnityEngine__UIElements__DynamicAtlas__TextureInfo> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x68};

virtual ~UnityEngine__UIElements__DynamicAtlas__TextureInfo() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__DynamicAtlas__TextureInfo", modifiers: " const&", def_value: None }]
constexpr UnityEngine__UIElements__DynamicAtlas__TextureInfo(UnityEngine__UIElements__DynamicAtlas__TextureInfo const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__UIElements__DynamicAtlas__TextureInfo", modifiers: "&&", def_value: None }]
constexpr UnityEngine__UIElements__DynamicAtlas__TextureInfo(UnityEngine__UIElements__DynamicAtlas__TextureInfo&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__UIElements__DynamicAtlas__TextureInfo(void* ptr) noexcept : UnityEngine::UIElements::UIR::LinkedPoolItem_1<UnityEngine::UIElements::UnityEngine__UIElements__DynamicAtlas__TextureInfo>(ptr) {
}


  constexpr UnityEngine__UIElements__DynamicAtlas__TextureInfo& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__UIElements__DynamicAtlas__TextureInfo& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__UIElements__DynamicAtlas__TextureInfo& operator=(UnityEngine__UIElements__DynamicAtlas__TextureInfo&& o) noexcept = default;
  constexpr UnityEngine__UIElements__DynamicAtlas__TextureInfo& operator=(UnityEngine__UIElements__DynamicAtlas__TextureInfo const& o) noexcept = default;
...
constexpr int32_t __get_counter() const;
 ...
 UnityEngine::UIElements::UIR::UnityEngine__UIElements__UIR__Allocator2D__Alloc2D __declspec(property(get=__get_alloc, put=__set_alloc))  alloc;

constexpr void __set_alloc(UnityEngine::UIElements::UIR::UnityEngine__UIElements__UIR__Allocator2D__Alloc2D value) ;

constexpr UnityEngine::UIElements::UIR::UnityEngine__UIElements__UIR__Allocator2D__Alloc2D __get_alloc() const;
...
static UnityEngine::UIElements::UIR::LinkedPool_1<UnityEngine::UIElements::UnityEngine__UIElements__DynamicAtlas__TextureInfo> __declspec(property(get=__get_pool, put=__set_pool))  pool;

static void __set_pool(UnityEngine::UIElements::UIR::LinkedPool_1<UnityEngine::UIElements::UnityEngine__UIElements__DynamicAtlas__TextureInfo> value) ;

static UnityEngine::UIElements::UIR::LinkedPool_1<UnityEngine::UIElements::UnityEngine__UIElements__DynamicAtlas__TextureInfo> __get_pool() ;


// Methods

/// @brief Method Create addr 0x2c6e16c size 0x58 virtual false final false
static UnityEngine::UIElements::UnityEngine__UIElements__DynamicAtlas__TextureInfo Create() ;

/// @brief Method Reset addr 0x2c6e20c size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x2c6e1c4 size 0x48 virtual false final false
 void _ctor() ;
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6861))}
...
public:
// Declarations
using TextureInfo = UnityEngine::UIElements::UnityEngine__UIElements__DynamicAtlas__TextureInfo;
...
// Fields
 ...
 System::Collections::Generic::Dictionary_2<UnityEngine::Texture,UnityEngine::UIElements::UnityEngine__UIElements__DynamicAtlas__TextureInfo> __declspec(property(get=__get_m_Database, put=__set_m_Database))  m_Database;

constexpr void __set_m_Database(System::Collections::Generic::Dictionary_2<UnityEngine::Texture,UnityEngine::UIElements::UnityEngine__UIElements__DynamicAtlas__TextureInfo> value) ;

constexpr System::Collections::Generic::Dictionary_2<UnityEngine::Texture,UnityEngine::UIElements::UnityEngine__UIElements__DynamicAtlas__TextureInfo> __get_m_Database() const;
...
/// @brief Method get_isInitialized addr 0x2c6d5c0 size 0x20 virtual false final false
 bool get_isInitialized() ;

/// @brief Method OnAssignedToPanel addr 0x2c6d5e0 size 0xd0 virtual true final false
 void OnAssignedToPanel(UnityEngine::UIElements::IPanel panel) ;

/// @brief Method OnRemovedFromPanel addr 0x2c6d6b0 size 0x98 virtual true final false
 void OnRemovedFromPanel(UnityEngine::UIElements::IPanel panel) ;

/// @brief Method Reset addr 0x2c6d7c0 size 0xac virtual true final false
 void Reset() ;

/// @brief Method InitPages addr 0x2c6d86c size 0x108 virtual false final false
 void InitPages() ;

/// @brief Method DestroyPages addr 0x2c6d748 size 0x78 virtual false final false
 void DestroyPages() ;

/// @brief Method TryGetAtlas addr 0x2c6d974 size 0x35c virtual true final false
...
/// @brief Method ReturnAtlas addr 0x2c6dcd0 size 0x13c virtual true final false
...
/// @brief Method OnUpdateDynamicTextures addr 0x2c6de0c size 0x68 virtual true final false
 void OnUpdateDynamicTextures(UnityEngine::UIElements::IPanel panel) ;

/// @brief Method IsTextureFormatSupported addr 0x2c6de74 size 0x34 virtual false final false
static bool IsTextureFormatSupported(UnityEngine::TextureFormat format) ;

/// @brief Method IsTextureValid addr 0x2c6dea8 size 0x120 virtual true final false
 bool IsTextureValid(UnityEngine::Texture2D texture, UnityEngine::FilterMode atlasFilterMode) ;

/// @brief Method set_minAtlasSize addr 0x2c6dfd0 size 0x20 virtual false final false
 void set_minAtlasSize(int32_t value) ;

/// @brief Method set_maxAtlasSize addr 0x2c6dff0 size 0x20 virtual false final false
 void set_maxAtlasSize(int32_t value) ;

/// @brief Method get_defaultFilters addr 0x2c6e010 size 0x8 virtual false final false
static UnityEngine::UIElements::DynamicAtlasFilters get_defaultFilters() ;

/// @brief Method set_activeFilters addr 0x2c6e018 size 0x20 virtual false final false
 void set_activeFilters(UnityEngine::UIElements::DynamicAtlasFilters value) ;

/// @brief Method get_maxSubTextureSize addr 0x2c6dfc8 size 0x8 virtual false final false
 int32_t get_maxSubTextureSize() ;

/// @brief Method set_maxSubTextureSize addr 0x2c6e038 size 0x20 virtual false final false
 void set_maxSubTextureSize(int32_t value) ;

/// @brief Method set_customFilter addr 0x2c6e058 size 0x48 virtual false final false
 void set_customFilter(UnityEngine::UIElements::DynamicAtlasCustomFilter value) ;

// Ctor Parameters []
explicit DynamicAtlas() ;

/// @brief Method .ctor addr 0x2c6e0a0 size 0xcc virtual false final false
 void _ctor() ;
...
NEED_NO_BOX(UnityEngine::UIElements::UnityEngine__UIElements__DynamicAtlas__TextureInfo);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::UIElements::UnityEngine__UIElements__DynamicAtlas__TextureInfo, "UnityEngine.UIElements", "DynamicAtlas/TextureInfo");
