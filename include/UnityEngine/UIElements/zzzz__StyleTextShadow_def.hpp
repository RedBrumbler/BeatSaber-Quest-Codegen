...
/// @brief Method get_value addr 0x2d2cc84 size 0x4c virtual true final true
 UnityEngine::UIElements::TextShadow get_value() ;

/// @brief Method get_keyword addr 0x2d2cc7c size 0x8 virtual true final true
 UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method .ctor addr 0x2d2fba0 size 0x18 virtual false final false
 void _ctor(UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method .ctor addr 0x2d2fbb8 size 0x20 virtual false final false
 void _ctor(UnityEngine::UIElements::TextShadow v, UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method op_Equality addr 0x2d2fbd8 size 0x68 virtual false final false
static bool op_Equality(UnityEngine::UIElements::StyleTextShadow lhs, UnityEngine::UIElements::StyleTextShadow rhs) ;

/// @brief Method op_Implicit addr 0x2d2ce44 size 0x18 virtual false final false
...
/// @brief Method Equals addr 0x2d2fc40 size 0x34 virtual true final true
 bool Equals(UnityEngine::UIElements::StyleTextShadow other) ;

/// @brief Method Equals addr 0x2d2fc74 size 0x90 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d2fd04 size 0x48 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2d2fd4c size 0x80 virtual true final false
 ::StringW ToString() ;
