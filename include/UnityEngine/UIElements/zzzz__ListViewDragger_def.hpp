...
/// @brief Method Equals addr 0x2cc58d8 size 0x58 virtual true final true
 bool Equals(UnityEngine::UIElements::UnityEngine__UIElements__ListViewDragger__DragPosition other) ;

/// @brief Method Equals addr 0x2cc64a8 size 0x9c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2cc6544 size 0x48 virtual true final false
 int32_t GetHashCode() ;
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7075))}
...
/// @brief Method get_targetListView addr 0x2cc4244 size 0x7c virtual false final false
 UnityEngine::UIElements::BaseVerticalCollectionView get_targetListView() ;

/// @brief Method get_targetScrollView addr 0x2cc42c0 size 0x1c virtual false final false
 UnityEngine::UIElements::ScrollView get_targetScrollView() ;

/// @brief Method get_dragAndDropController addr 0x2cc42dc size 0x8 virtual false final false
 UnityEngine::UIElements::ICollectionDragAndDropController get_dragAndDropController() ;

/// @brief Method set_dragAndDropController addr 0x2cc42e4 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2cc42ec size 0x4 virtual false final false
 void _ctor(UnityEngine::UIElements::BaseVerticalCollectionView listView) ;

/// @brief Method CanStartDrag addr 0x2cc442c size 0x23c virtual true final false
 bool CanStartDrag(UnityEngine::Vector3 pointerPosition) ;

/// @brief Method StartDrag addr 0x2cc4a00 size 0x1bc virtual true final false
 UnityEngine::UIElements::StartDragArgs StartDrag(UnityEngine::Vector3 pointerPosition) ;

/// @brief Method UpdateDrag addr 0x2cc4bbc size 0x6c virtual true final false
 UnityEngine::UIElements::DragVisualMode UpdateDrag(UnityEngine::Vector3 pointerPosition) ;

/// @brief Method GetVisualMode addr 0x2cc4c28 size 0x164 virtual false final false
...
/// @brief Method OnDrop addr 0x2cc56f8 size 0x1e0 virtual true final false
 void OnDrop(UnityEngine::Vector3 pointerPosition) ;

/// @brief Method HandleDragAndScroll addr 0x2cc536c size 0x23c virtual false final false
 void HandleDragAndScroll(UnityEngine::Vector2 pointerPosition) ;

/// @brief Method ApplyDragAndDropUI addr 0x2cc4d8c size 0x5e0 virtual false final false
 void ApplyDragAndDropUI(UnityEngine::UIElements::UnityEngine__UIElements__ListViewDragger__DragPosition dragPosition) ;

/// @brief Method TryGetDragPosition addr 0x2cc5b70 size 0x340 virtual true final false
...
/// @brief Method MakeDragAndDropArgs addr 0x2cc55a8 size 0x150 virtual false final false
...
/// @brief Method PlaceHoverBarAtElement addr 0x2cc5ab4 size 0xbc virtual false final false
 void PlaceHoverBarAtElement(UnityEngine::UIElements::VisualElement element) ;

/// @brief Method PlaceHoverBarAt addr 0x2cc5930 size 0x184 virtual false final false
 void PlaceHoverBarAt(float_t top) ;

/// @brief Method ClearDragAndDropUI addr 0x2cc5f90 size 0x410 virtual true final false
 void ClearDragAndDropUI() ;

/// @brief Method GetRecycledItem addr 0x2cc4668 size 0x398 virtual false final false
 UnityEngine::UIElements::ReusableCollectionItem GetRecycledItem(UnityEngine::Vector3 pointerPosition) ;

/// @brief Method <ApplyDragAndDropUI>b__22_0 addr 0x2cc63a0 size 0x108 virtual false final false
