...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7489)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7489), inst: 5181 }), TypeDefinitionIndex(TypeDefinitionIndex(7486))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7486), inst: 2 })
