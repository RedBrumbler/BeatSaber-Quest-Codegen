...
/// @brief Method HandleEventAtTargetPhase addr 0x2d086e8 size 0x6c virtual false final false
 void HandleEventAtTargetPhase(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method HandleEvent addr 0x2d0b778 size 0x2c0 virtual true final false
 void HandleEvent(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method HasTrickleDownHandlers addr 0x2d07980 size 0x28 virtual true final true
 bool HasTrickleDownHandlers() ;

/// @brief Method HasBubbleUpHandlers addr 0x2d079a8 size 0x28 virtual true final true
 bool HasBubbleUpHandlers() ;

/// @brief Method ExecuteDefaultActionAtTarget addr 0x2d0ba38 size 0x4 virtual true final false
 void ExecuteDefaultActionAtTarget(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method ExecuteDefaultAction addr 0x2d0ba3c size 0x4 virtual true final false
 void ExecuteDefaultAction(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method ExecuteDefaultActionDisabledAtTarget addr 0x2d0ba40 size 0x4 virtual true final false
 void ExecuteDefaultActionDisabledAtTarget(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method ExecuteDefaultActionDisabled addr 0x2d0ba44 size 0x4 virtual true final false
 void ExecuteDefaultActionDisabled(UnityEngine::UIElements::EventBase evt) ;

// Ctor Parameters []
explicit CallbackEventHandler() ;

/// @brief Method .ctor addr 0x2d0ba48 size 0x8 virtual false final false
 void _ctor() ;
