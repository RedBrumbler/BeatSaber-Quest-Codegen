...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7316), inst: 4688 }), TypeDefinitionIndex(TypeDefinitionIndex(7316))}
...
/// @brief Method Init addr 0x2d0b514 size 0x54 virtual true final false
 void Init() ;

/// @brief Method LocalInit addr 0x2d0b568 size 0xc virtual false final false
 void LocalInit() ;

// Ctor Parameters []
explicit PointerEnterEvent() ;

/// @brief Method .ctor addr 0x2d0b574 size 0x54 virtual false final false
 void _ctor() ;
