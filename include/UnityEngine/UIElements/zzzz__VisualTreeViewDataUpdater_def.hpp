...
/// @brief Method get_profilerMarker addr 0x2cb9014 size 0x58 virtual true final false
 Unity::Profiling::ProfilerMarker get_profilerMarker() ;

/// @brief Method OnVersionChanged addr 0x2cb906c size 0x90 virtual true final false
 void OnVersionChanged(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::VersionChangeType versionChangeType) ;

/// @brief Method Update addr 0x2cb91a4 size 0x144 virtual true final false
 void Update() ;

/// @brief Method ValidateViewDataOnSubTree addr 0x2cb92e8 size 0x150 virtual false final false
 void ValidateViewDataOnSubTree(UnityEngine::UIElements::VisualElement ve, bool enablePersistence) ;

/// @brief Method PropagateToParents addr 0x2cb90fc size 0xa8 virtual false final false
 void PropagateToParents(UnityEngine::UIElements::VisualElement ve) ;

// Ctor Parameters []
explicit VisualTreeViewDataUpdater() ;

/// @brief Method .ctor addr 0x2cb9438 size 0xa0 virtual false final false
 void _ctor() ;
