...
/// @brief Method .ctor addr 0x2ccfd14 size 0xa0 virtual false final false
 void _ctor(System::Type t) ;

/// @brief Method set_elementName addr 0x2ccfdb4 size 0x8 virtual false final false
 void set_elementName(::StringW value) ;

/// @brief Method set_elementNamespace addr 0x2ccfdbc size 0x8 virtual false final false
