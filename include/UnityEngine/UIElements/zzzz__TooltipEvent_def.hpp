...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7298)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7298), inst: 1645 })}
...
/// @brief Method set_tooltip addr 0x2d07dfc size 0x8 virtual false final false
 void set_tooltip(::StringW value) ;

/// @brief Method set_rect addr 0x2d07e04 size 0xc virtual false final false
 void set_rect(UnityEngine::Rect value) ;

/// @brief Method Init addr 0x2d07e10 size 0x90 virtual true final false
 void Init() ;

/// @brief Method LocalInit addr 0x2d07ea0 size 0x5c virtual false final false
 void LocalInit() ;

// Ctor Parameters []
explicit TooltipEvent() ;

/// @brief Method .ctor addr 0x2d07f18 size 0xb4 virtual false final false
 void _ctor() ;
