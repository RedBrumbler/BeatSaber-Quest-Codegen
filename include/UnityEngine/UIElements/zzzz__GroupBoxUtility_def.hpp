...
/// @brief Method OnOptionAttachToPanel addr 0x2cbe3dc size 0x24c virtual false final false
static void OnOptionAttachToPanel(UnityEngine::UIElements::AttachToPanelEvent evt) ;

/// @brief Method OnOptionDetachFromPanel addr 0x2cbea08 size 0x1b4 virtual false final false
static void OnOptionDetachFromPanel(UnityEngine::UIElements::DetachFromPanelEvent evt) ;

/// @brief Method FindOrCreateGroupManager addr 0x2cbe628 size 0x3e0 virtual false final false
static UnityEngine::UIElements::IGroupManager FindOrCreateGroupManager(UnityEngine::UIElements::IGroupBox groupBox) ;

/// @brief Method OnGroupBoxDetachedFromPanel addr 0x2cbebbc size 0xb4 virtual false final false
static void OnGroupBoxDetachedFromPanel(UnityEngine::UIElements::DetachFromPanelEvent evt) ;

/// @brief Method OnPanelDestroyed addr 0x2cbec70 size 0xdc virtual false final false
