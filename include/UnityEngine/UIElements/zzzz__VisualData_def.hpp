...
/// @brief Method Copy addr 0x2d3fa7c size 0x1c virtual true final true
 UnityEngine::UIElements::VisualData Copy() ;

/// @brief Method CopyFrom addr 0x2d3fa98 size 0x14 virtual true final true
 void CopyFrom(ByRef<UnityEngine::UIElements::VisualData> other) ;

/// @brief Method op_Equality addr 0x2d3faac size 0x1ec virtual false final false
static bool op_Equality(UnityEngine::UIElements::VisualData lhs, UnityEngine::UIElements::VisualData rhs) ;

/// @brief Method Equals addr 0x2d3fc98 size 0x4c virtual true final true
 bool Equals(UnityEngine::UIElements::VisualData other) ;

/// @brief Method Equals addr 0x2d3fce4 size 0xa8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d3fd8c size 0x280 virtual true final false
 int32_t GetHashCode() ;
