...
/// @brief Method .ctor addr 0x2cf4838 size 0x58 virtual false final false
 void _ctor() ;
...
/// @brief Method get_clickable addr 0x2cf44e4 size 0x8 virtual false final false
 UnityEngine::UIElements::Clickable get_clickable() ;

/// @brief Method set_clickable addr 0x2cf44ec size 0x64 virtual false final false
 void set_clickable(UnityEngine::UIElements::Clickable value) ;

// Ctor Parameters []
explicit Button() ;

/// @brief Method .ctor addr 0x2cf4550 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2ce73c0 size 0x1c8 virtual false final false
 void _ctor(System::Action clickEvent) ;

/// @brief Method OnNavigationSubmit addr 0x2cf4558 size 0x38 virtual false final false
 void OnNavigationSubmit(UnityEngine::UIElements::NavigationSubmitEvent evt) ;

/// @brief Method OnKeyDown addr 0x2cf4590 size 0x118 virtual false final false
 void OnKeyDown(UnityEngine::UIElements::KeyDownEvent evt) ;

/// @brief Method DoMeasure addr 0x2cf46a8 size 0xbc virtual true final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7108)), TypeDefinitionIndex(TypeDefinitionIndex(7242)), TypeDefinitionIndex(TypeDefinitionIndex(7241)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7108), inst: 5090 })}
...
/// @brief Method .ctor addr 0x2cf47f0 size 0x48 virtual false final false
 void _ctor() ;
