...
/// @brief Method .ctor addr 0x2cbca40 size 0x70 virtual false final false
 void _ctor() ;

/// @brief Method get_uxmlChildElementsDescription addr 0x2cbcab0 size 0x64 virtual true final false
...
/// @brief Method get_onGUIHandler addr 0x2cb95c8 size 0x8 virtual false final false
 System::Action get_onGUIHandler() ;

/// @brief Method set_onGUIHandler addr 0x2cb95d0 size 0x58 virtual false final false
 void set_onGUIHandler(System::Action value) ;

/// @brief Method get_guiState addr 0x2cb8584 size 0xa4 virtual false final false
 UnityEngine::ObjectGUIState get_guiState() ;

/// @brief Method get_lastWorldClip addr 0x2cb9628 size 0x14 virtual false final false
 UnityEngine::Rect get_lastWorldClip() ;

/// @brief Method set_lastWorldClip addr 0x2cb963c size 0x14 virtual false final false
 void set_lastWorldClip(UnityEngine::Rect value) ;

/// @brief Method get_cullingEnabled addr 0x2cb9650 size 0x8 virtual false final false
 bool get_cullingEnabled() ;

/// @brief Method get_cache addr 0x2cb9658 size 0x70 virtual false final false
 UnityEngine::UnityEngine__GUILayoutUtility__LayoutCache get_cache() ;

/// @brief Method get_layoutMeasuredWidth addr 0x2cb96c8 size 0x28 virtual false final false
 float_t get_layoutMeasuredWidth() ;

/// @brief Method get_layoutMeasuredHeight addr 0x2cb96f0 size 0x28 virtual false final false
 float_t get_layoutMeasuredHeight() ;

/// @brief Method get_contextType addr 0x2cb9718 size 0x8 virtual false final false
 UnityEngine::UIElements::ContextType get_contextType() ;

/// @brief Method set_contextType addr 0x2cb9720 size 0x8 virtual false final false
 void set_contextType(UnityEngine::UIElements::ContextType value) ;

/// @brief Method get_focusOnlyIfHasFocusableControls addr 0x2cb9728 size 0x8 virtual false final false
 bool get_focusOnlyIfHasFocusableControls() ;

/// @brief Method get_canGrabFocus addr 0x2cb9730 size 0x20 virtual true final false
 bool get_canGrabFocus() ;

// Ctor Parameters []
explicit IMGUIContainer() ;

/// @brief Method .ctor addr 0x2cb9b1c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2cb9b24 size 0x238 virtual false final false
 void _ctor(System::Action onGUIHandler) ;

/// @brief Method OnGenerateVisualContent addr 0x2cb9d5c size 0x12c virtual false final false
 void OnGenerateVisualContent(UnityEngine::UIElements::MeshGenerationContext mgc) ;

/// @brief Method SaveGlobals addr 0x2cb9e88 size 0x110 virtual false final false
 void SaveGlobals() ;

/// @brief Method RestoreGlobals addr 0x2cb9f98 size 0x118 virtual false final false
 void RestoreGlobals() ;

/// @brief Method DoOnGUI addr 0x2cba0b0 size 0xd1c virtual false final false
...
/// @brief Method MarkDirtyLayout addr 0x2cb76c0 size 0x14 virtual false final false
 void MarkDirtyLayout() ;

/// @brief Method HandleEvent addr 0x2cbadcc size 0x90 virtual true final false
 void HandleEvent(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method DoIMGUIRepaint addr 0x2cbb0f8 size 0x390 virtual false final false
 void DoIMGUIRepaint() ;

/// @brief Method SendEventToIMGUI addr 0x2cbae5c size 0x29c virtual false final false
 bool SendEventToIMGUI(UnityEngine::UIElements::EventBase evt, bool canAffectFocus, bool verifyBounds) ;

/// @brief Method SendEventToIMGUIRaw addr 0x2cbb780 size 0x100 virtual false final false
 bool SendEventToIMGUIRaw(UnityEngine::UIElements::EventBase evt, bool canAffectFocus, bool verifyBounds) ;

/// @brief Method VerifyBounds addr 0x2cbb880 size 0x90 virtual false final false
 bool VerifyBounds(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method IsContainerCapturingTheMouse addr 0x2cbb920 size 0x114 virtual false final false
 bool IsContainerCapturingTheMouse() ;

/// @brief Method IsLocalEvent addr 0x2cbba34 size 0x204 virtual false final false
 bool IsLocalEvent(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method IsEventInsideLocalWindow addr 0x2cbbc38 size 0x180 virtual false final false
 bool IsEventInsideLocalWindow(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method IsDockAreaMouseUp addr 0x2cbbdb8 size 0x124 virtual false final false
static bool IsDockAreaMouseUp(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method HandleIMGUIEvent addr 0x2cbb910 size 0x10 virtual false final false
 bool HandleIMGUIEvent(UnityEngine::Event e, bool canAffectFocus) ;

/// @brief Method HandleIMGUIEvent addr 0x2cbbf48 size 0xcc virtual false final false
 bool HandleIMGUIEvent(UnityEngine::Event e, System::Action onGUIHandler, bool canAffectFocus) ;

/// @brief Method HandleIMGUIEvent addr 0x2cbb488 size 0x2f8 virtual false final false
...
/// @brief Method ExecuteDefaultAction addr 0x2cbc1d8 size 0x2e8 virtual true final false
 void ExecuteDefaultAction(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method SetFoldoutDepthClass addr 0x2cbc4c0 size 0x168 virtual false final false
 void SetFoldoutDepthClass() ;

/// @brief Method DoMeasure addr 0x2cbc70c size 0x258 virtual true final false
...
/// @brief Method GetCurrentClipRect addr 0x2cbbedc size 0x6c virtual false final false
 UnityEngine::Rect GetCurrentClipRect() ;

/// @brief Method GetCurrentTransformAndClip addr 0x2cbc014 size 0x114 virtual false final false
...
/// @brief Method Dispose addr 0x2cbc964 size 0x70 virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x2cbc9d4 size 0x18 virtual true final false
 void Dispose(bool disposeManaged) ;

/// @brief Method <DoOnGUI>b__56_0 addr 0x2cbc9ec size 0xc virtual false final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7015)), TypeDefinitionIndex(TypeDefinitionIndex(7013)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7108), inst: 5096 }), TypeDefinitionIndex(TypeDefinitionIndex(7108))}
...
/// @brief Method .ctor addr 0x2cbc9f8 size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2cbcb14 size 0x44 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2cbcb58 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2cbcb5c size 0x18 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.UIElements.UxmlChildElementDescription>.get_Current addr 0x2cbcb74 size 0x8 virtual true final true
...
/// @brief Method System.Collections.IEnumerator.Reset addr 0x2cbcb7c size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2cbcbbc size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.UIElements.UxmlChildElementDescription>.GetEnumerator addr 0x2cbcbc4 size 0xa0 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2cbcc64 size 0x4 virtual true final true
