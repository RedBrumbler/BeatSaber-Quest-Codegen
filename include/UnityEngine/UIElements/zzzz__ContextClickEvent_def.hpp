...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7333), inst: 4509 }), TypeDefinitionIndex(TypeDefinitionIndex(7333))}
...
/// @brief Method .ctor addr 0x2d0c17c size 0x48 virtual false final false
 void _ctor() ;
