...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7333), inst: 4517 }), TypeDefinitionIndex(TypeDefinitionIndex(7333))}
...
/// @brief Method .ctor addr 0x2d0cae4 size 0x48 virtual false final false
 void _ctor() ;
