...
/// @brief Method get_importedWithErrors addr 0x2d2520c size 0x8 virtual false final false
 bool get_importedWithErrors() ;

/// @brief Method set_importedWithErrors addr 0x2d25214 size 0xc virtual false final false
 void set_importedWithErrors(bool value) ;

/// @brief Method get_importedWithWarnings addr 0x2d25220 size 0x8 virtual false final false
 bool get_importedWithWarnings() ;

/// @brief Method set_importedWithWarnings addr 0x2d25228 size 0xc virtual false final false
 void set_importedWithWarnings(bool value) ;

/// @brief Method get_rules addr 0x2d25234 size 0x8 virtual false final false
 ::ArrayW<UnityEngine::UIElements::StyleRule> get_rules() ;

/// @brief Method set_rules addr 0x2d2523c size 0x8 virtual false final false
 void set_rules(::ArrayW<UnityEngine::UIElements::StyleRule> value) ;

/// @brief Method get_complexSelectors addr 0x2d25784 size 0x8 virtual false final false
 ::ArrayW<UnityEngine::UIElements::StyleComplexSelector> get_complexSelectors() ;

/// @brief Method set_complexSelectors addr 0x2d2578c size 0x8 virtual false final false
 void set_complexSelectors(::ArrayW<UnityEngine::UIElements::StyleComplexSelector> value) ;

/// @brief Method get_flattenedRecursiveImports addr 0x2d25794 size 0x8 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::UIElements::StyleSheet> get_flattenedRecursiveImports() ;

/// @brief Method get_contentHash addr 0x2d2579c size 0x8 virtual false final false
 int32_t get_contentHash() ;

/// @brief Method set_contentHash addr 0x2d257a4 size 0x8 virtual false final false
 void set_contentHash(int32_t value) ;

/// @brief Method get_isDefaultStyleSheet addr 0x2d257ac size 0x8 virtual false final false
 bool get_isDefaultStyleSheet() ;

/// @brief Method set_isDefaultStyleSheet addr 0x2d24f3c size 0x160 virtual false final false
...
/// @brief Method OnEnable addr 0x2d2509c size 0x4 virtual true final false
 void OnEnable() ;

/// @brief Method FlattenImportedStyleSheetsRecursive addr 0x2d257b4 size 0x7c virtual false final false
 void FlattenImportedStyleSheetsRecursive() ;

/// @brief Method FlattenImportedStyleSheetsRecursive addr 0x2d25830 size 0x148 virtual false final false
 void FlattenImportedStyleSheetsRecursive(UnityEngine::UIElements::StyleSheet sheet) ;

/// @brief Method SetupReferences addr 0x2d25244 size 0x540 virtual false final false
 void SetupReferences() ;

/// @brief Method ReadKeyword addr 0x2d25a3c size 0x8 virtual false final false
 UnityEngine::UIElements::StyleValueKeyword ReadKeyword(UnityEngine::UIElements::StyleValueHandle handle) ;

/// @brief Method ReadFloat addr 0x2d24a40 size 0xd4 virtual false final false
 float_t ReadFloat(UnityEngine::UIElements::StyleValueHandle handle) ;

/// @brief Method TryReadFloat addr 0x2d25a44 size 0xf4 virtual false final false
 bool TryReadFloat(UnityEngine::UIElements::StyleValueHandle handle, ByRef<float_t> value) ;

/// @brief Method ReadDimension addr 0x2d25b38 size 0xf0 virtual false final false
 UnityEngine::UIElements::StyleSheets::Dimension ReadDimension(UnityEngine::UIElements::StyleValueHandle handle) ;

/// @brief Method TryReadDimension addr 0x2d25c28 size 0x11c virtual false final false
...
/// @brief Method ReadColor addr 0x2d25d44 size 0x84 virtual false final false
 UnityEngine::Color ReadColor(UnityEngine::UIElements::StyleValueHandle handle) ;

/// @brief Method TryReadColor addr 0x2d25dc8 size 0x8c virtual false final false
 bool TryReadColor(UnityEngine::UIElements::StyleValueHandle handle, ByRef<UnityEngine::Color> value) ;

/// @brief Method ReadString addr 0x2d25e54 size 0x84 virtual false final false
 ::StringW ReadString(UnityEngine::UIElements::StyleValueHandle handle) ;

/// @brief Method TryReadString addr 0x2d25ed8 size 0x8c virtual false final false
 bool TryReadString(UnityEngine::UIElements::StyleValueHandle handle, ByRef<::StringW> value) ;

/// @brief Method ReadEnum addr 0x2d25f64 size 0x84 virtual false final false
 ::StringW ReadEnum(UnityEngine::UIElements::StyleValueHandle handle) ;

/// @brief Method TryReadEnum addr 0x2d25fe8 size 0x8c virtual false final false
 bool TryReadEnum(UnityEngine::UIElements::StyleValueHandle handle, ByRef<::StringW> value) ;

/// @brief Method ReadVariable addr 0x2d24b14 size 0x84 virtual false final false
 ::StringW ReadVariable(UnityEngine::UIElements::StyleValueHandle handle) ;

/// @brief Method TryReadVariable addr 0x2d26074 size 0x8c virtual false final false
 bool TryReadVariable(UnityEngine::UIElements::StyleValueHandle handle, ByRef<::StringW> value) ;

/// @brief Method ReadResourcePath addr 0x2d26100 size 0x84 virtual false final false
 ::StringW ReadResourcePath(UnityEngine::UIElements::StyleValueHandle handle) ;

/// @brief Method TryReadResourcePath addr 0x2d26184 size 0x8c virtual false final false
 bool TryReadResourcePath(UnityEngine::UIElements::StyleValueHandle handle, ByRef<::StringW> value) ;

/// @brief Method ReadAssetReference addr 0x2d26210 size 0x84 virtual false final false
 UnityEngine::Object ReadAssetReference(UnityEngine::UIElements::StyleValueHandle handle) ;

/// @brief Method ReadMissingAssetReferenceUrl addr 0x2d26294 size 0x84 virtual false final false
 ::StringW ReadMissingAssetReferenceUrl(UnityEngine::UIElements::StyleValueHandle handle) ;

/// @brief Method TryReadAssetReference addr 0x2d26318 size 0x8c virtual false final false
 bool TryReadAssetReference(UnityEngine::UIElements::StyleValueHandle handle, ByRef<UnityEngine::Object> value) ;

/// @brief Method ReadFunction addr 0x2d263a4 size 0x8 virtual false final false
 UnityEngine::UIElements::StyleValueFunction ReadFunction(UnityEngine::UIElements::StyleValueHandle handle) ;

/// @brief Method ReadFunctionName addr 0x2d263ac size 0x154 virtual false final false
 ::StringW ReadFunctionName(UnityEngine::UIElements::StyleValueHandle handle) ;

/// @brief Method ReadScalableImage addr 0x2d26500 size 0x84 virtual false final false
 UnityEngine::UIElements::StyleSheets::ScalableImage ReadScalableImage(UnityEngine::UIElements::StyleValueHandle handle) ;

/// @brief Method CustomStartsWith addr 0x2d25978 size 0xc4 virtual false final false
static bool CustomStartsWith(::StringW originalString, ::StringW pattern) ;

// Ctor Parameters []
explicit StyleSheet() ;

/// @brief Method .ctor addr 0x2d250f8 size 0x8 virtual false final false
 void _ctor() ;
