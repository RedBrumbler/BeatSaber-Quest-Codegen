...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7298)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7298), inst: 1644 })}
...
/// @brief Method set_previousData addr 0x2d0db50 size 0x8 virtual false final false
 void set_previousData(::StringW value) ;

/// @brief Method set_newData addr 0x2d0db58 size 0x8 virtual false final false
 void set_newData(::StringW value) ;

/// @brief Method Init addr 0x2d0db60 size 0x58 virtual true final false
 void Init() ;

/// @brief Method LocalInit addr 0x2d0dbb8 size 0x10 virtual false final false
 void LocalInit() ;

/// @brief Method GetPooled addr 0x2d0dbc8 size 0x84 virtual false final false
static UnityEngine::UIElements::InputEvent GetPooled(::StringW previousData, ::StringW newData) ;

// Ctor Parameters []
explicit InputEvent() ;

/// @brief Method .ctor addr 0x2d0dc4c size 0x7c virtual false final false
 void _ctor() ;
