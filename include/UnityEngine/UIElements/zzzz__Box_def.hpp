...
/// @brief Method .ctor addr 0x2ce5a9c size 0x94 virtual false final false
 void _ctor() ;
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7109), inst: 5087 }), TypeDefinitionIndex(TypeDefinitionIndex(7109)), TypeDefinitionIndex(TypeDefinitionIndex(7181))}
...
/// @brief Method .ctor addr 0x2ce5b90 size 0x48 virtual false final false
 void _ctor() ;
