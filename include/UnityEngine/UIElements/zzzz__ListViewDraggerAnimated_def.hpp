...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7065))}
...
/// @brief Method get_isDragging addr 0x2cc658c size 0x10 virtual false final false
 bool get_isDragging() ;

/// @brief Method get_draggedItem addr 0x2cc659c size 0x8 virtual false final false
 UnityEngine::UIElements::ReusableCollectionItem get_draggedItem() ;

/// @brief Method get_supportsDragEvents addr 0x2cc65a4 size 0x8 virtual true final false
...
/// @brief Method .ctor addr 0x2cc65ac size 0x4 virtual false final false
 void _ctor(UnityEngine::UIElements::BaseVerticalCollectionView listView) ;

/// @brief Method StartDrag addr 0x2cc65b0 size 0x6e0 virtual true final false
 UnityEngine::UIElements::StartDragArgs StartDrag(UnityEngine::Vector3 pointerPosition) ;

/// @brief Method UpdateDrag addr 0x2cc6fd0 size 0x894 virtual true final false
 UnityEngine::UIElements::DragVisualMode UpdateDrag(UnityEngine::Vector3 pointerPosition) ;

/// @brief Method Animate addr 0x2cc6c90 size 0x340 virtual false final false
 void Animate(UnityEngine::UIElements::ReusableCollectionItem element, float_t paddingTop) ;

/// @brief Method OnDrop addr 0x2cc7864 size 0x300 virtual true final false
 void OnDrop(UnityEngine::Vector3 pointerPosition) ;

/// @brief Method ClearDragAndDropUI addr 0x2cc7b64 size 0x4 virtual true final false
 void ClearDragAndDropUI() ;

/// @brief Method TryGetDragPosition addr 0x2cc7b68 size 0x20 virtual true final false
