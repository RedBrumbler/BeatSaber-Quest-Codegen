...
/// @brief Method get_value addr 0x2d2a80c size 0x18 virtual true final true
 UnityEngine::UIElements::Length get_value() ;

/// @brief Method get_keyword addr 0x2d2a824 size 0x8 virtual true final true
 UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method .ctor addr 0x2d2a82c size 0x2c virtual false final false
 void _ctor(float_t v) ;

/// @brief Method .ctor addr 0x2d2a8a0 size 0xc virtual false final false
 void _ctor(UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method .ctor addr 0x2d2a880 size 0x20 virtual false final false
 void _ctor(UnityEngine::UIElements::Length v, UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method op_Equality addr 0x2d2a8cc size 0x38 virtual false final false
static bool op_Equality(UnityEngine::UIElements::StyleLength lhs, UnityEngine::UIElements::StyleLength rhs) ;

/// @brief Method op_Implicit addr 0x2d2a92c size 0xc virtual false final false
...
/// @brief Method op_Implicit addr 0x2d2a938 size 0x28 virtual false final false
static UnityEngine::UIElements::StyleLength op_Implicit_UnityEngine__UIElements__StyleLength(float_t v) ;

/// @brief Method Equals addr 0x2d2a960 size 0x40 virtual true final true
 bool Equals(UnityEngine::UIElements::StyleLength other) ;

/// @brief Method Equals addr 0x2d2a9a0 size 0xa4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d2aa44 size 0x30 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2d2aa9c size 0x88 virtual true final false
 ::StringW ToString() ;
