...
/// @brief Method get_fixedPane addr 0x2cf4890 size 0x1c virtual false final false
 UnityEngine::UIElements::VisualElement get_fixedPane() ;

/// @brief Method get_flexedPane addr 0x2cf48ac size 0x1c virtual false final false
 UnityEngine::UIElements::VisualElement get_flexedPane() ;

/// @brief Method get_fixedPaneMinDimension addr 0x2cf48c8 size 0x114 virtual false final false
 float_t get_fixedPaneMinDimension() ;

/// @brief Method get_flexedPaneMinDimension addr 0x2cf49dc size 0x114 virtual false final false
...
/// @brief Method .ctor addr 0x2cf4af0 size 0xd8 virtual false final false
...
/// @brief Method RegisterCallbacksOnTarget addr 0x2cf4bc8 size 0x1cc virtual true final false
 void RegisterCallbacksOnTarget() ;

/// @brief Method UnregisterCallbacksFromTarget addr 0x2cf4d94 size 0x1cc virtual true final false
 void UnregisterCallbacksFromTarget() ;

/// @brief Method ApplyDelta addr 0x2cf4f60 size 0x600 virtual false final false
 void ApplyDelta(float_t delta) ;

/// @brief Method OnPointerDown addr 0x2cf5560 size 0xc8 virtual false final false
 void OnPointerDown(UnityEngine::UIElements::PointerDownEvent e) ;

/// @brief Method OnPointerMove addr 0x2cf5628 size 0xb8 virtual false final false
 void OnPointerMove(UnityEngine::UIElements::PointerMoveEvent e) ;

/// @brief Method OnPointerUp addr 0x2cf56e0 size 0xac virtual false final false
