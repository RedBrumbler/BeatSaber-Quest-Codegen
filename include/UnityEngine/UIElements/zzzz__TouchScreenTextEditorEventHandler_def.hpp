...
/// @brief Method .ctor addr 0x2cf578c size 0x8 virtual false final false
 void _ctor(UnityEngine::UIElements::TextEditorEngine editorEngine, UnityEngine::UIElements::ITextInputField textInputField) ;

/// @brief Method PollTouchScreenKeyboard addr 0x2cf5794 size 0x25c virtual false final false
 void PollTouchScreenKeyboard() ;

/// @brief Method DoPollTouchScreenKeyboard addr 0x2cf59f0 size 0x728 virtual false final false
 void DoPollTouchScreenKeyboard() ;

/// @brief Method ExecuteDefaultActionAtTarget addr 0x2cf6118 size 0x1550 virtual true final false
