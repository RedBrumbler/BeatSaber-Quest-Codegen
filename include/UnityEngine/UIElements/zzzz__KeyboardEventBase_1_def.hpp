...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7298), inst: 1633 }), TypeDefinitionIndex(TypeDefinitionIndex(7298)), TypeDefinitionIndex(TypeDefinitionIndex(7358))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7358), inst: 2 })
