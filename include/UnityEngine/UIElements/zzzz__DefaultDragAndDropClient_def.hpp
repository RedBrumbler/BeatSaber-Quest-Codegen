...
/// @brief Method get_userData addr 0x2cc7b90 size 0x18 virtual true final true
 ::bs_hook::Il2CppWrapperType get_userData() ;

/// @brief Method StartDrag addr 0x2cc7ba8 size 0x8 virtual true final true
 void StartDrag(UnityEngine::UIElements::StartDragArgs args) ;

/// @brief Method get_data addr 0x2cc5ee0 size 0x4 virtual true final true
 UnityEngine::UIElements::IDragAndDropData get_data() ;

// Ctor Parameters []
explicit DefaultDragAndDropClient() ;

/// @brief Method .ctor addr 0x2cc7b88 size 0x8 virtual false final false
 void _ctor() ;
