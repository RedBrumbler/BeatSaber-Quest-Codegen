...
/// @brief Method GetStyleLength addr 0x2d2b7c0 size 0x74 virtual false final false
 UnityEngine::UIElements::StyleLength GetStyleLength(UnityEngine::UIElements::StyleSheets::StylePropertyId id) ;

/// @brief Method GetStyleFloat addr 0x2d2b9f4 size 0x58 virtual false final false
 UnityEngine::UIElements::StyleFloat GetStyleFloat(UnityEngine::UIElements::StyleSheets::StylePropertyId id) ;

/// @brief Method GetStyleInt addr 0x2d2ba4c size 0x74 virtual false final false
 UnityEngine::UIElements::StyleInt GetStyleInt(UnityEngine::UIElements::StyleSheets::StylePropertyId id) ;

/// @brief Method TryGetStyleValue addr 0x2d2b834 size 0x1c0 virtual false final false
...
/// @brief Method SetStyleValue addr 0x2d2bad0 size 0x1fc virtual false final false
 void SetStyleValue(UnityEngine::UIElements::StyleSheets::StyleValue value) ;

// Ctor Parameters []
explicit StyleValueCollection() ;

/// @brief Method .ctor addr 0x2d2bccc size 0x7c virtual false final false
 void _ctor() ;
