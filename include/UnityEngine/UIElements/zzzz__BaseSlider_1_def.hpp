...
template<::cordl_internals::il2cpp_reference_type TValueType>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7247)), TypeDefinitionIndex(TypeDefinitionIndex(7218)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7247), inst: 889 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7218), inst: 2 })
...
template<>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7247), inst: 889 }), TypeDefinitionIndex(TypeDefinitionIndex(7247)), TypeDefinitionIndex(TypeDefinitionIndex(7218))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7218), inst: 92 })
// CS Name: UnityEngine.UIElements.BaseSlider`1
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7247)), TypeDefinitionIndex(TypeDefinitionIndex(7218)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7247), inst: 889 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7218), inst: 374 })
// CS Name: UnityEngine.UIElements.BaseSlider`1
