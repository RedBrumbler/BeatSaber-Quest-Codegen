...
/// @brief Method GetCursorPosition addr 0x2d607c4 size 0x144 virtual false final false
...
/// @brief Method ComputeTextWidth addr 0x2d60970 size 0x108 virtual false final false
static float_t ComputeTextWidth(UnityEngine::UIElements::TextNativeSettings settings) ;

/// @brief Method ComputeTextHeight addr 0x2d60ab4 size 0x108 virtual false final false
static float_t ComputeTextHeight(UnityEngine::UIElements::TextNativeSettings settings) ;

/// @brief Method GetVertices addr 0x2d60bf8 size 0x1f0 virtual false final false
...
/// @brief Method GetOffset addr 0x2d60e44 size 0x130 virtual false final false
static UnityEngine::Vector2 GetOffset(UnityEngine::UIElements::TextNativeSettings settings, UnityEngine::Rect screenRect) ;

/// @brief Method ComputeTextScaling addr 0x2d60fd0 size 0xfc virtual false final false
static float_t ComputeTextScaling(UnityEngine::Matrix4x4 worldMatrix, float_t pixelsPerPoint) ;

/// @brief Method DoComputeTextWidth addr 0x2d60a78 size 0x3c virtual false final false
static float_t DoComputeTextWidth(UnityEngine::UIElements::TextNativeSettings settings) ;

/// @brief Method DoComputeTextHeight addr 0x2d60bbc size 0x3c virtual false final false
static float_t DoComputeTextHeight(UnityEngine::UIElements::TextNativeSettings settings) ;

/// @brief Method DoGetCursorPosition addr 0x2d60908 size 0x68 virtual false final false
...
/// @brief Method GetVertices addr 0x2d60de8 size 0x5c virtual false final false
...
/// @brief Method DoGetOffset addr 0x2d60f74 size 0x5c virtual false final false
static UnityEngine::Vector2 DoGetOffset(UnityEngine::UIElements::TextNativeSettings settings, UnityEngine::Rect rect) ;

/// @brief Method DoComputeTextWidth_Injected addr 0x2d610cc size 0x3c virtual false final false
static float_t DoComputeTextWidth_Injected(ByRef<UnityEngine::UIElements::TextNativeSettings> settings) ;

/// @brief Method DoComputeTextHeight_Injected addr 0x2d61108 size 0x3c virtual false final false
static float_t DoComputeTextHeight_Injected(ByRef<UnityEngine::UIElements::TextNativeSettings> settings) ;

/// @brief Method DoGetCursorPosition_Injected addr 0x2d61144 size 0x5c virtual false final false
...
/// @brief Method GetVertices_Injected addr 0x2d611a0 size 0x5c virtual false final false
...
/// @brief Method DoGetOffset_Injected addr 0x2d611fc size 0x54 virtual false final false
