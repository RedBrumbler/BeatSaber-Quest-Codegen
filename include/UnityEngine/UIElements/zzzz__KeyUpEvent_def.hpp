...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7358)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7358), inst: 3808 })}
...
/// @brief Method .ctor addr 0x2d0da78 size 0x48 virtual false final false
 void _ctor() ;
