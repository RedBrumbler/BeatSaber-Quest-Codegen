...
/// @brief Method get_value addr 0x2d2a640 size 0x18 virtual true final true
 float_t get_value() ;

/// @brief Method get_keyword addr 0x2d2a658 size 0x8 virtual true final true
 UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method .ctor addr 0x2d2a660 size 0xc virtual false final false
 void _ctor(float_t v) ;

/// @brief Method .ctor addr 0x2d2a678 size 0x8 virtual false final false
 void _ctor(UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method .ctor addr 0x2d2a66c size 0xc virtual false final false
 void _ctor(float_t v, UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method op_Equality addr 0x2d2a680 size 0x28 virtual false final false
static bool op_Equality(UnityEngine::UIElements::StyleFloat lhs, UnityEngine::UIElements::StyleFloat rhs) ;

/// @brief Method op_Implicit addr 0x2d2a6a8 size 0x8 virtual false final false
...
/// @brief Method op_Implicit addr 0x2d2a6b0 size 0x8 virtual false final false
static UnityEngine::UIElements::StyleFloat op_Implicit_UnityEngine__UIElements__StyleFloat(float_t v) ;

/// @brief Method Equals addr 0x2d2a6b8 size 0x28 virtual true final true
 bool Equals(UnityEngine::UIElements::StyleFloat other) ;

/// @brief Method Equals addr 0x2d2a6e0 size 0x8c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d2a76c size 0x28 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2d2a794 size 0x78 virtual true final false
 ::StringW ToString() ;
