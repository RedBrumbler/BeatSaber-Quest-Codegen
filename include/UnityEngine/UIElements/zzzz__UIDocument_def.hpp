...
/// @brief Method get_panelSettings addr 0x2cd0684 size 0x8 virtual false final false
 UnityEngine::UIElements::PanelSettings get_panelSettings() ;

/// @brief Method set_panelSettings addr 0x2cd068c size 0x29c virtual false final false
 void set_panelSettings(UnityEngine::UIElements::PanelSettings value) ;

/// @brief Method get_parentUI addr 0x2cd0a38 size 0x8 virtual false final false
 UnityEngine::UIElements::UIDocument get_parentUI() ;

/// @brief Method set_parentUI addr 0x2cd0a40 size 0x8 virtual false final false
 void set_parentUI(UnityEngine::UIElements::UIDocument value) ;

/// @brief Method get_visualTreeAsset addr 0x2cd0a48 size 0x8 virtual false final false
 UnityEngine::UIElements::VisualTreeAsset get_visualTreeAsset() ;

/// @brief Method set_visualTreeAsset addr 0x2cd0a50 size 0x8 virtual false final false
 void set_visualTreeAsset(UnityEngine::UIElements::VisualTreeAsset value) ;

/// @brief Method get_rootVisualElement addr 0x2cd02ac size 0x8 virtual false final false
 UnityEngine::UIElements::VisualElement get_rootVisualElement() ;

/// @brief Method get_firstChildInserIndex addr 0x2cd0e5c size 0x8 virtual false final false
 int32_t get_firstChildInserIndex() ;

/// @brief Method get_sortingOrder addr 0x2cd0e64 size 0x8 virtual false final false
 float_t get_sortingOrder() ;

/// @brief Method set_sortingOrder addr 0x2cd0e6c size 0x18 virtual false final false
 void set_sortingOrder(float_t value) ;

/// @brief Method ApplySortingOrder addr 0x2cd0e84 size 0x4 virtual false final false
 void ApplySortingOrder() ;

// Ctor Parameters []
explicit UIDocument() ;

/// @brief Method .ctor addr 0x2cd0f5c size 0x70 virtual false final false
 void _ctor() ;

/// @brief Method Awake addr 0x2cd0fcc size 0x4 virtual false final false
 void Awake() ;

/// @brief Method OnEnable addr 0x2cd1060 size 0xc0 virtual false final false
 void OnEnable() ;

/// @brief Method SetupFromHierarchy addr 0x2cd0fd0 size 0x90 virtual false final false
 void SetupFromHierarchy() ;

/// @brief Method FindUIDocumentParent addr 0x2cd1130 size 0xd0 virtual false final false
 UnityEngine::UIElements::UIDocument FindUIDocumentParent() ;

/// @brief Method Reset addr 0x2cd1200 size 0x104 virtual false final false
 void Reset() ;

/// @brief Method AddChildAndInsertContentToVisualTree addr 0x2cd1304 size 0x90 virtual false final false
 void AddChildAndInsertContentToVisualTree(UnityEngine::UIElements::UIDocument child) ;

/// @brief Method RemoveChild addr 0x2cd1120 size 0x10 virtual false final false
 void RemoveChild(UnityEngine::UIElements::UIDocument child) ;

/// @brief Method RecreateUI addr 0x2cd0a58 size 0x404 virtual false final false
 void RecreateUI() ;

/// @brief Method SetupRootClassList addr 0x2cd1460 size 0x9c virtual false final false
 void SetupRootClassList() ;

/// @brief Method AddRootVisualElementToTree addr 0x2cd0e88 size 0xd4 virtual false final false
 void AddRootVisualElementToTree() ;

/// @brief Method RemoveFromHierarchy addr 0x2cd1394 size 0xcc virtual false final false
 void RemoveFromHierarchy() ;

/// @brief Method OnDisable addr 0x2cd14fc size 0x20 virtual false final false
 void OnDisable() ;

/// @brief Method OnTransformChildrenChanged addr 0x2cd151c size 0x210 virtual false final false
 void OnTransformChildrenChanged() ;

/// @brief Method OnTransformParentChanged addr 0x2cd17d0 size 0x4 virtual false final false
 void OnTransformParentChanged() ;

/// @brief Method ReactToHierarchyChanged addr 0x2cd172c size 0xa4 virtual false final false
