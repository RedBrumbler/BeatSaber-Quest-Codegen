...
/// @brief Method get_target addr 0x2cb9564 size 0x8 virtual true final true
 UnityEngine::UIElements::VisualElement get_target() ;

/// @brief Method set_target addr 0x2cb956c size 0x54 virtual true final true
 void set_target(UnityEngine::UIElements::VisualElement value) ;

// Ctor Parameters []
explicit Manipulator() ;

/// @brief Method .ctor addr 0x2cb95c0 size 0x8 virtual false final false
 void _ctor() ;
