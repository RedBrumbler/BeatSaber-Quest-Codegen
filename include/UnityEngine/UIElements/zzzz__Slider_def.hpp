...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7248)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7248), inst: 887 }), TypeDefinitionIndex(TypeDefinitionIndex(7096))}
...
/// @brief Method Init addr 0x2cd97ec size 0x2b4 virtual true final false
 void Init(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::IUxmlAttributes bag, UnityEngine::UIElements::CreationContext cc) ;

// Ctor Parameters []
explicit UnityEngine__UIElements__Slider__UxmlTraits() ;

/// @brief Method .ctor addr 0x2cd9aa0 size 0x21c virtual false final false
 void _ctor() ;
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7218), inst: 374 }), TypeDefinitionIndex(TypeDefinitionIndex(7218))}
...
/// @brief Method .ctor addr 0x2cd9020 size 0x18 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2cd9184 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x2cd9038 size 0x14c virtual false final false
 void _ctor(::StringW label, float_t start, float_t end, UnityEngine::UIElements::SliderDirection direction, float_t pageSize) ;

/// @brief Method SliderLerpUnclamped addr 0x2cd9190 size 0x2b0 virtual true final false
 float_t SliderLerpUnclamped(float_t a, float_t b, float_t interpolant) ;

/// @brief Method SliderNormalizeValue addr 0x2cd9440 size 0x10 virtual true final false
 float_t SliderNormalizeValue(float_t currentValue, float_t lowerValue, float_t higherValue) ;

/// @brief Method ParseStringToValue addr 0x2cd9450 size 0xd0 virtual true final false
 float_t ParseStringToValue(::StringW stringValue) ;

/// @brief Method ComputeValueFromKey addr 0x2cd9520 size 0x1fc virtual true final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7108)), TypeDefinitionIndex(TypeDefinitionIndex(7153)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7108), inst: 5109 }), TypeDefinitionIndex(TypeDefinitionIndex(7154))}
...
/// @brief Method .ctor addr 0x2ccc5a8 size 0x48 virtual false final false
 void _ctor() ;
