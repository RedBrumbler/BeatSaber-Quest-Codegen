...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7361), inst: 4672 }), TypeDefinitionIndex(TypeDefinitionIndex(7361))}
...
/// @brief Method .ctor addr 0x2d0db08 size 0x48 virtual false final false
 void _ctor() ;
