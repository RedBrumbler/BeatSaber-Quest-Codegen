...
/// @brief Method Copy addr 0x2d3e4b0 size 0x1c virtual true final true
 UnityEngine::UIElements::InheritedData Copy() ;

/// @brief Method CopyFrom addr 0x2d3e4cc size 0x14 virtual true final true
 void CopyFrom(ByRef<UnityEngine::UIElements::InheritedData> other) ;

/// @brief Method op_Equality addr 0x2d3e4e0 size 0x200 virtual false final false
static bool op_Equality(UnityEngine::UIElements::InheritedData lhs, UnityEngine::UIElements::InheritedData rhs) ;

/// @brief Method Equals addr 0x2d3e6e0 size 0x4c virtual true final true
 bool Equals(UnityEngine::UIElements::InheritedData other) ;

/// @brief Method Equals addr 0x2d3e72c size 0xa8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d3e7d4 size 0x24c virtual true final false
 int32_t GetHashCode() ;
