...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7333)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7333), inst: 4510 })}
...
/// @brief Method get_menu addr 0x2d0cb2c size 0x8 virtual false final false
 UnityEngine::UIElements::DropdownMenu get_menu() ;

/// @brief Method set_menu addr 0x2d0cb34 size 0x8 virtual false final false
 void set_menu(UnityEngine::UIElements::DropdownMenu value) ;

/// @brief Method get_triggerEvent addr 0x2d0cb3c size 0x8 virtual false final false
 UnityEngine::UIElements::EventBase get_triggerEvent() ;

/// @brief Method set_triggerEvent addr 0x2d0cb44 size 0x8 virtual false final false
 void set_triggerEvent(UnityEngine::UIElements::EventBase value) ;

/// @brief Method Init addr 0x2d0cb4c size 0x70 virtual true final false
 void Init() ;

/// @brief Method LocalInit addr 0x2d0cbbc size 0x34 virtual false final false
 void LocalInit() ;

// Ctor Parameters []
explicit ContextualMenuPopulateEvent() ;

/// @brief Method .ctor addr 0x2d0cbf0 size 0x70 virtual false final false
 void _ctor() ;

/// @brief Method PostDispatch addr 0x2d0cc60 size 0x90 virtual true final false
