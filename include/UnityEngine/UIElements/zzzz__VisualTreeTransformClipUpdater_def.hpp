...
/// @brief Method get_profilerMarker addr 0x2c73504 size 0x58 virtual true final false
 Unity::Profiling::ProfilerMarker get_profilerMarker() ;

/// @brief Method OnVersionChanged addr 0x2c7355c size 0xf4 virtual true final false
 void OnVersionChanged(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::VersionChangeType versionChangeType) ;

/// @brief Method DirtyHierarchy addr 0x2c73650 size 0x154 virtual false final false
static void DirtyHierarchy(UnityEngine::UIElements::VisualElement ve, bool mustDirtyWorldTransform, bool mustDirtyWorldClip) ;

/// @brief Method DirtyBoundingBoxHierarchy addr 0x2c737a4 size 0xa8 virtual false final false
static void DirtyBoundingBoxHierarchy(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method Update addr 0x2c7384c size 0x64 virtual true final false
 void Update() ;

// Ctor Parameters []
explicit VisualTreeTransformClipUpdater() ;

/// @brief Method .ctor addr 0x2c73ab0 size 0xc virtual false final false
 void _ctor() ;
