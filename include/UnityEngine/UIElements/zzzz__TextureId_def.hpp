...
/// @brief Method .ctor addr 0x2d3719c size 0xc virtual false final false
 void _ctor(int32_t index) ;

/// @brief Method get_index addr 0x2d371a8 size 0xc virtual false final false
 int32_t get_index() ;

/// @brief Method ConvertToGpu addr 0x2d371b4 size 0x10 virtual false final false
 float_t ConvertToGpu() ;

/// @brief Method Equals addr 0x2d371c4 size 0xa8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d3726c size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x2d3728c size 0xc virtual false final false
static bool op_Equality(UnityEngine::UIElements::TextureId left, UnityEngine::UIElements::TextureId right) ;

/// @brief Method op_Inequality addr 0x2d37298 size 0x64 virtual false final false
