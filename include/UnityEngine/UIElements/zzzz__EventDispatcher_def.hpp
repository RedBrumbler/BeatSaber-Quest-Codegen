...
/// @brief Method get_pointerState addr 0x2cbcf04 size 0x8 virtual false final false
 UnityEngine::UIElements::PointerDispatchState get_pointerState() ;

/// @brief Method CreateForRuntime addr 0x2cbcf0c size 0x60 virtual false final false
...
/// @brief Method .ctor addr 0x2cbcf6c size 0x1ac virtual false final false
 void _ctor(System::Collections::Generic::IList_1<UnityEngine::UIElements::IEventDispatchingStrategy> strategies) ;

/// @brief Method get_dispatchImmediately addr 0x2cbd118 size 0x20 virtual false final false
 bool get_dispatchImmediately() ;

/// @brief Method set_processingEvents addr 0x2cbd138 size 0xc virtual false final false
 void set_processingEvents(bool value) ;

/// @brief Method Dispatch addr 0x2cbd144 size 0x164 virtual false final false
...
/// @brief Method CloseGate addr 0x2cbcdb4 size 0x10 virtual false final false
 void CloseGate() ;

/// @brief Method OpenGate addr 0x2cbcddc size 0x88 virtual false final false
 void OpenGate() ;

/// @brief Method ProcessEventQueue addr 0x2cbd678 size 0x3c8 virtual false final false
 void ProcessEventQueue() ;

/// @brief Method ProcessEvent addr 0x2cbd2a8 size 0x3d0 virtual false final false
 void ProcessEvent(UnityEngine::UIElements::EventBase evt, UnityEngine::UIElements::IPanel panel) ;

/// @brief Method ApplyDispatchingStrategies addr 0x2cbda40 size 0x330 virtual false final false
