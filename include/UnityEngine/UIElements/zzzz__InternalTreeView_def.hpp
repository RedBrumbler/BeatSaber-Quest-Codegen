...
/// @brief Method get_uxmlChildElementsDescription addr 0x2d3d980 size 0x64 virtual true final false
...
/// @brief Method Init addr 0x2d3da28 size 0x260 virtual true final false
 void Init(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::IUxmlAttributes bag, UnityEngine::UIElements::CreationContext cc) ;

// Ctor Parameters []
explicit UnityEngine__UIElements__InternalTreeView__UxmlTraits() ;

/// @brief Method .ctor addr 0x2d3dc88 size 0x20c virtual false final false
 void _ctor() ;
...
/// @brief Method get_unbindItem addr 0x2d3a6d4 size 0x8 virtual false final false
 System::Action_2<UnityEngine::UIElements::VisualElement,UnityEngine::UIElements::ITreeViewItem> get_unbindItem() ;

/// @brief Method set_itemHeight addr 0x2d3a6dc size 0x20 virtual false final false
 void set_itemHeight(int32_t value) ;

/// @brief Method set_showBorder addr 0x2d3a6fc size 0x20 virtual false final false
 void set_showBorder(bool value) ;

/// @brief Method set_selectionType addr 0x2d3a71c size 0x1c virtual false final false
 void set_selectionType(UnityEngine::UIElements::SelectionType value) ;

/// @brief Method set_showAlternatingRowBackgrounds addr 0x2d3a738 size 0x1c virtual false final false
 void set_showAlternatingRowBackgrounds(UnityEngine::UIElements::AlternatingRowBackground value) ;

// Ctor Parameters []
explicit InternalTreeView() ;

/// @brief Method .ctor addr 0x2d3a754 size 0x554 virtual false final false
 void _ctor() ;

/// @brief Method RefreshItems addr 0x2d3aca8 size 0x24 virtual false final false
 void RefreshItems() ;

/// @brief Method Rebuild addr 0x2d3ad70 size 0x24 virtual false final false
 void Rebuild() ;

/// @brief Method OnViewDataReady addr 0x2d3ad94 size 0x3c virtual true final false
 void OnViewDataReady() ;

/// @brief Method GetAllItems addr 0x2d3add0 size 0x64 virtual false final false
...
/// @brief Method OnKeyDown addr 0x2d3ae78 size 0xbc virtual false final false
 void OnKeyDown(UnityEngine::UIElements::KeyDownEvent evt) ;

/// @brief Method ListViewRefresh addr 0x2d3ad54 size 0x1c virtual false final false
 void ListViewRefresh() ;

/// @brief Method OnItemsChosen addr 0x2d3b524 size 0x420 virtual false final false
 void OnItemsChosen(System::Collections::Generic::IEnumerable_1<::bs_hook::Il2CppWrapperType> chosenItems) ;

/// @brief Method OnSelectionChange addr 0x2d3b944 size 0x454 virtual false final false
 void OnSelectionChange(System::Collections::Generic::IEnumerable_1<::bs_hook::Il2CppWrapperType> selectedListItems) ;

/// @brief Method OnTreeViewMouseUp addr 0x2d3bd98 size 0x38 virtual false final false
 void OnTreeViewMouseUp(UnityEngine::UIElements::MouseUpEvent evt) ;

/// @brief Method OnItemMouseUp addr 0x2d3bdd0 size 0x7fc virtual false final false
 void OnItemMouseUp(UnityEngine::UIElements::MouseUpEvent evt) ;

/// @brief Method MakeTreeItem addr 0x2d3c5cc size 0x4e0 virtual false final false
 UnityEngine::UIElements::VisualElement MakeTreeItem() ;

/// @brief Method UnbindTreeItem addr 0x2d3caac size 0x11c virtual false final false
 void UnbindTreeItem(UnityEngine::UIElements::VisualElement element, int32_t index) ;

/// @brief Method BindTreeItem addr 0x2d3cbc8 size 0x35c virtual false final false
 void BindTreeItem(UnityEngine::UIElements::VisualElement element, int32_t index) ;

/// @brief Method GetItemId addr 0x2d3cf24 size 0x74 virtual false final false
 int32_t GetItemId(int32_t index) ;

/// @brief Method IsExpandedByIndex addr 0x2d3af34 size 0x9c virtual false final false
 bool IsExpandedByIndex(int32_t index) ;

/// @brief Method CollapseItemByIndex addr 0x2d3b2d8 size 0x24c virtual false final false
 void CollapseItemByIndex(int32_t index) ;

/// @brief Method ExpandItemByIndex addr 0x2d3afd0 size 0x308 virtual false final false
 void ExpandItemByIndex(int32_t index) ;

/// @brief Method ToggleExpandedState addr 0x2d3d558 size 0x184 virtual false final false
 void ToggleExpandedState(UnityEngine::UIElements::ChangeEvent_1<bool> evt) ;

/// @brief Method CreateWrappers addr 0x2d3d038 size 0x520 virtual false final false
...
/// @brief Method RegenerateWrappers addr 0x2d3accc size 0x88 virtual false final false
 void RegenerateWrappers() ;

/// @brief Method OnCustomStyleResolved addr 0x2d3d6dc size 0x150 virtual false final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7466)), TypeDefinitionIndex(TypeDefinitionIndex(7108)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7108), inst: 5098 }), TypeDefinitionIndex(TypeDefinitionIndex(7469))}
...
/// @brief Method .ctor addr 0x2d3d938 size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2d3d9e4 size 0x44 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2d3de94 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2d3de98 size 0x18 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.UIElements.UxmlChildElementDescription>.get_Current addr 0x2d3deb0 size 0x8 virtual true final true
...
/// @brief Method System.Collections.IEnumerator.Reset addr 0x2d3deb8 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2d3def8 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.UIElements.UxmlChildElementDescription>.GetEnumerator addr 0x2d3df00 size 0xa0 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2d3dfa0 size 0x4 virtual true final true
...
/// @brief Method get_id addr 0x2d3cf98 size 0xa0 virtual false final false
 int32_t get_id() ;
...
/// @brief Method .ctor addr 0x2d3ae34 size 0x44 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2d3dfa4 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2d3dfa8 size 0x3f8 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.UIElements.ITreeViewItem>.get_Current addr 0x2d3e3a0 size 0x8 virtual true final true
...
/// @brief Method System.Collections.IEnumerator.Reset addr 0x2d3e3a8 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2d3e3e8 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.UIElements.ITreeViewItem>.GetEnumerator addr 0x2d3e3f0 size 0xa0 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2d3e490 size 0x4 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;
