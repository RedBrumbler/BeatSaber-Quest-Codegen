...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7298), inst: 1636 }), TypeDefinitionIndex(TypeDefinitionIndex(7361)), TypeDefinitionIndex(TypeDefinitionIndex(7298))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7361), inst: 2 })
