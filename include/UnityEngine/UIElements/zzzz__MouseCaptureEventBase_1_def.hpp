...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7271)), TypeDefinitionIndex(TypeDefinitionIndex(7268)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7268), inst: 4504 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7271), inst: 2 })
