...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7248)), TypeDefinitionIndex(TypeDefinitionIndex(7102)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7248), inst: 885 })}
...
/// @brief Method Init addr 0x2cee560 size 0x118 virtual true final false
 void Init(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::IUxmlAttributes bag, UnityEngine::UIElements::CreationContext cc) ;

// Ctor Parameters []
explicit UnityEngine__UIElements__Toggle__UxmlTraits() ;

/// @brief Method .ctor addr 0x2cee678 size 0xa0 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2ced950 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "label", ty: "::StringW", modifiers: "", def_value: None }]
explicit Toggle(::StringW label) ;

/// @brief Method .ctor addr 0x2cee234 size 0xfc virtual false final false
 void _ctor(::StringW label) ;

/// @brief Method InitLabel addr 0x2cee330 size 0x78 virtual true final false
 void InitLabel() ;
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7108), inst: 5116 }), TypeDefinitionIndex(TypeDefinitionIndex(7108)), TypeDefinitionIndex(TypeDefinitionIndex(7209)), TypeDefinitionIndex(TypeDefinitionIndex(7210))}
...
/// @brief Method .ctor addr 0x2cee518 size 0x48 virtual false final false
 void _ctor() ;
