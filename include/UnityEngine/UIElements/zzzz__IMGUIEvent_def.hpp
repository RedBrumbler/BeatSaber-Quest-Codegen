...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7298), inst: 1643 }), TypeDefinitionIndex(TypeDefinitionIndex(7298))}
...
/// @brief Method GetPooled addr 0x2d0488c size 0x84 virtual false final false
static UnityEngine::UIElements::IMGUIEvent GetPooled(UnityEngine::Event systemEvent) ;

/// @brief Method Init addr 0x2d049c4 size 0x54 virtual true final false
 void Init() ;

/// @brief Method LocalInit addr 0x2d04a18 size 0xc virtual false final false
 void LocalInit() ;

// Ctor Parameters []
explicit IMGUIEvent() ;

/// @brief Method .ctor addr 0x2d04a24 size 0x78 virtual false final false
 void _ctor() ;
