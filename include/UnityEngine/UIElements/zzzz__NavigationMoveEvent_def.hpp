...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7366), inst: 4567 }), TypeDefinitionIndex(TypeDefinitionIndex(7366))}
...
/// @brief Method DetermineMoveDirection addr 0x2d0dcc8 size 0x54 virtual false final false
...
/// @brief Method get_direction addr 0x2d0dd1c size 0x8 virtual false final false
 UnityEngine::UIElements::UnityEngine__UIElements__NavigationMoveEvent__Direction get_direction() ;

/// @brief Method set_direction addr 0x2d0dd24 size 0x8 virtual false final false
 void set_direction(UnityEngine::UIElements::UnityEngine__UIElements__NavigationMoveEvent__Direction value) ;

/// @brief Method set_move addr 0x2d0dd2c size 0x8 virtual false final false
 void set_move(UnityEngine::Vector2 value) ;

/// @brief Method GetPooled addr 0x2d0dd34 size 0xe0 virtual false final false
static UnityEngine::UIElements::NavigationMoveEvent GetPooled(UnityEngine::Vector2 moveVector) ;

/// @brief Method Init addr 0x2d0de14 size 0x88 virtual true final false
 void Init() ;

// Ctor Parameters []
explicit NavigationMoveEvent() ;

/// @brief Method .ctor addr 0x2d0de9c size 0x58 virtual false final false
 void _ctor() ;
