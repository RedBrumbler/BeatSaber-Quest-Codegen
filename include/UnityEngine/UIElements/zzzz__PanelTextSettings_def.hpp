...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13516))}
...
/// @brief Method get_defaultPanelTextSettings addr 0x2d02220 size 0x134 virtual false final false
static UnityEngine::UIElements::PanelTextSettings get_defaultPanelTextSettings() ;

/// @brief Method UpdateLocalizationFontAsset addr 0x2d02708 size 0x4c0 virtual false final false
static void UpdateLocalizationFontAsset() ;

/// @brief Method GetCachedFontAsset addr 0x2d01d18 size 0x8 virtual false final false
 UnityEngine::TextCore::Text::FontAsset GetCachedFontAsset(UnityEngine::Font font) ;

// Ctor Parameters []
explicit PanelTextSettings() ;

/// @brief Method .ctor addr 0x2d02bc8 size 0x8 virtual false final false
 void _ctor() ;
