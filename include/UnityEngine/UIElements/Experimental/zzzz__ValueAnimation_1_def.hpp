...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7577))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7577), inst: 2 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7577))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7577), inst: 5126 })
// CS Name: UnityEngine.UIElements.Experimental.ValueAnimation`1
