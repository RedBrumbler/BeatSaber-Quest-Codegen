...
/// @brief Method Interpolate addr 0x2c9ef74 size 0x10 virtual false final false
static float_t Interpolate(float_t start, float_t end, float_t ratio) ;

/// @brief Method Interpolate addr 0x2c9ef84 size 0x38 virtual false final false
static UnityEngine::Color Interpolate(UnityEngine::Color start, UnityEngine::Color end, float_t ratio) ;

/// @brief Method Interpolate addr 0x2c9efbc size 0x3f0 virtual false final false
