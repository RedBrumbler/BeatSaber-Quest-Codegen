...
/// @brief Method Init addr 0x2ce1b34 size 0x134 virtual true final false
 void Init(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::IUxmlAttributes bag, UnityEngine::UIElements::CreationContext cc) ;

// Ctor Parameters []
explicit UnityEngine__UIElements__RepeatButton__UxmlTraits() ;

/// @brief Method .ctor addr 0x2ce1c68 size 0xc4 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2ce1914 size 0x94 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2ce19a8 size 0x40 virtual false final false
 void _ctor(System::Action clickEvent, int64_t delay, int64_t interval) ;

/// @brief Method SetAction addr 0x2ce19e8 size 0xa4 virtual false final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7108)), TypeDefinitionIndex(TypeDefinitionIndex(7166)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7108), inst: 5106 }), TypeDefinitionIndex(TypeDefinitionIndex(7165))}
...
/// @brief Method .ctor addr 0x2ce1aec size 0x48 virtual false final false
 void _ctor() ;
