...
/// @brief Method .ctor addr 0x2c72180 size 0xd8 virtual false final false
 void _ctor() ;

/// @brief Method Reset addr 0x2c72258 size 0x90 virtual false final false
 void Reset() ;

/// @brief Method GetCapturingElement addr 0x2c711fc size 0x30 virtual false final false
 UnityEngine::UIElements::IEventHandler GetCapturingElement(int32_t pointerId) ;

/// @brief Method HasPointerCapture addr 0x2c70f14 size 0x38 virtual false final false
 bool HasPointerCapture(UnityEngine::UIElements::IEventHandler handler, int32_t pointerId) ;

/// @brief Method CapturePointer addr 0x2c70f84 size 0x13c virtual false final false
 void CapturePointer(UnityEngine::UIElements::IEventHandler handler, int32_t pointerId) ;

/// @brief Method ReleasePointer addr 0x2c712f0 size 0x30 virtual false final false
 void ReleasePointer(int32_t pointerId) ;

/// @brief Method ReleasePointer addr 0x2c710f8 size 0x3c virtual false final false
 void ReleasePointer(UnityEngine::UIElements::IEventHandler handler, int32_t pointerId) ;

/// @brief Method ProcessPointerCapture addr 0x2c71828 size 0x958 virtual false final false
 void ProcessPointerCapture(int32_t pointerId) ;

/// @brief Method ActivateCompatibilityMouseEvents addr 0x2c713e4 size 0x34 virtual false final false
 void ActivateCompatibilityMouseEvents(int32_t pointerId) ;

/// @brief Method PreventCompatibilityMouseEvents addr 0x2c714dc size 0x30 virtual false final false
 void PreventCompatibilityMouseEvents(int32_t pointerId) ;

/// @brief Method ShouldSendCompatibilityMouseEvents addr 0x2c71630 size 0x134 virtual false final false
