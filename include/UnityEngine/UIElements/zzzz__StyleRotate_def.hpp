...
/// @brief Method get_value addr 0x2d2cd10 size 0x44 virtual true final true
 UnityEngine::UIElements::Rotate get_value() ;

/// @brief Method get_keyword addr 0x2d2fdcc size 0x8 virtual true final true
 UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method .ctor addr 0x2d2fdd4 size 0x10 virtual false final false
 void _ctor(UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method .ctor addr 0x2d2fde4 size 0x18 virtual false final false
 void _ctor(UnityEngine::UIElements::Rotate v, UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method op_Equality addr 0x2d2fdfc size 0x5c virtual false final false
static bool op_Equality(UnityEngine::UIElements::StyleRotate lhs, UnityEngine::UIElements::StyleRotate rhs) ;

/// @brief Method op_Implicit addr 0x2d2d168 size 0x10 virtual false final false
...
/// @brief Method Equals addr 0x2d2fe58 size 0x7c virtual true final true
 bool Equals(UnityEngine::UIElements::StyleRotate other) ;

/// @brief Method Equals addr 0x2d2fed4 size 0x90 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d2ff64 size 0x24 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2d2ff88 size 0x88 virtual true final false
 ::StringW ToString() ;
