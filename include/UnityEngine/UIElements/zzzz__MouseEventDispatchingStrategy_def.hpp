...
/// @brief Method CanDispatchEvent addr 0x2d0d09c size 0x54 virtual true final true
 bool CanDispatchEvent(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method DispatchEvent addr 0x2d0d0f0 size 0x108 virtual true final true
 void DispatchEvent(UnityEngine::UIElements::EventBase evt, UnityEngine::UIElements::IPanel iPanel) ;

/// @brief Method SendEventToTarget addr 0x2d0d298 size 0x3c virtual false final false
static bool SendEventToTarget(UnityEngine::UIElements::EventBase evt, UnityEngine::UIElements::BaseVisualElementPanel panel) ;

/// @brief Method SendEventToRegularTarget addr 0x2d0d2d4 size 0x38 virtual false final false
...
/// @brief Method SendEventToIMGUIContainer addr 0x2d0d30c size 0x1d8 virtual false final false
...
/// @brief Method SetBestTargetForEvent addr 0x2d0d1f8 size 0xa0 virtual false final false
...
/// @brief Method UpdateElementUnderMouse addr 0x2d0d52c size 0x2fc virtual false final false
...
/// @brief Method IsDone addr 0x2d0d4e4 size 0x48 virtual false final false
static bool IsDone(UnityEngine::UIElements::EventBase evt) ;

// Ctor Parameters []
explicit MouseEventDispatchingStrategy() ;

/// @brief Method .ctor addr 0x2d0d828 size 0x8 virtual false final false
 void _ctor() ;
