...
/// @brief Method CanDispatchEvent addr 0x2d0983c size 0x54 virtual true final true
 bool CanDispatchEvent(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method DispatchEvent addr 0x2d09890 size 0x144 virtual true final true
 void DispatchEvent(UnityEngine::UIElements::EventBase evt, UnityEngine::UIElements::IPanel panel) ;

// Ctor Parameters []
explicit NavigationEventDispatchingStrategy() ;

/// @brief Method .ctor addr 0x2d099d4 size 0x8 virtual false final false
 void _ctor() ;
