...
/// @brief Method get_id addr 0x2ccd500 size 0x8 virtual false final false
 int32_t get_id() ;

/// @brief Method get_orderInDocument addr 0x2cce410 size 0x8 virtual false final false
 int32_t get_orderInDocument() ;

/// @brief Method get_parentId addr 0x2ccd2d4 size 0x8 virtual false final false
 int32_t get_parentId() ;

/// @brief Method get_ruleIndex addr 0x2cce3cc size 0x8 virtual false final false
 int32_t get_ruleIndex() ;

/// @brief Method get_fullTypeName addr 0x2cce694 size 0x8 virtual false final false
 ::StringW get_fullTypeName() ;

/// @brief Method get_classes addr 0x2cce898 size 0x8 virtual false final false
 ::ArrayW<::StringW> get_classes() ;

/// @brief Method get_stylesheetPaths addr 0x2cce8b0 size 0x80 virtual false final false
 System::Collections::Generic::List_1<::StringW> get_stylesheetPaths() ;

/// @brief Method get_hasStylesheetPaths addr 0x2cce8a0 size 0x10 virtual false final false
 bool get_hasStylesheetPaths() ;

/// @brief Method get_stylesheets addr 0x2cce940 size 0x80 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::UIElements::StyleSheet> get_stylesheets() ;

/// @brief Method get_hasStylesheets addr 0x2cce930 size 0x10 virtual false final false
 bool get_hasStylesheets() ;

/// @brief Method OnBeforeSerialize addr 0x2ccfdc4 size 0x4 virtual true final true
 void OnBeforeSerialize() ;

/// @brief Method OnAfterDeserialize addr 0x2ccfdc8 size 0x188 virtual true final true
 void OnAfterDeserialize() ;

/// @brief Method AddProperty addr 0x2ccff50 size 0x4 virtual false final false
 void AddProperty(::StringW propertyName, ::StringW propertyValue) ;

/// @brief Method SetOrAddProperty addr 0x2ccff54 size 0x210 virtual false final false
 void SetOrAddProperty(::StringW propertyName, ::StringW propertyValue) ;

/// @brief Method TryGetAttributeValue addr 0x2cd0164 size 0xd0 virtual true final true
