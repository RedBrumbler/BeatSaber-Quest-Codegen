...
/// @brief Method get_value addr 0x2d23444 size 0x8 virtual false final false
 ::StringW get_value() ;

/// @brief Method get_type addr 0x2d2343c size 0x8 virtual false final false
 UnityEngine::UIElements::StyleSelectorType get_type() ;

/// @brief Method set_type addr 0x2d23668 size 0x8 virtual false final false
 void set_type(UnityEngine::UIElements::StyleSelectorType value) ;

/// @brief Method ToString addr 0x2d23670 size 0x110 virtual true final false
 ::StringW ToString() ;

/// @brief Method CreateClass addr 0x2d23780 size 0x18 virtual false final false
static UnityEngine::UIElements::StyleSelectorPart CreateClass(::StringW className) ;

/// @brief Method CreateId addr 0x2d23798 size 0x18 virtual false final false
static UnityEngine::UIElements::StyleSelectorPart CreateId(::StringW Id) ;

/// @brief Method CreatePredicate addr 0x2d237b0 size 0x18 virtual false final false
