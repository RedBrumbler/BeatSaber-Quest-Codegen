...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6911)), TypeDefinitionIndex(TypeDefinitionIndex(6893))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6893), inst: 2 })
...
explicit ClampedDragger_1(UnityEngine::UIElements::BaseSlider_1<T> slider, System::Action clickHandler, System::Action dragHandler) ;
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6911)), TypeDefinitionIndex(TypeDefinitionIndex(6893))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6893), inst: 92 })
// CS Name: UnityEngine.UIElements.ClampedDragger`1
class CORDL_TYPE ClampedDragger_1<int32_t> : public UnityEngine::UIElements::Clickable {
public:
// Declarations
using DragDirection = UnityEngine::UIElements::UnityEngine__UIElements__ClampedDragger_1__DragDirection<int32_t>;
...
constexpr System::Action __get_dragging() const;
 ...
 UnityEngine::UIElements::UnityEngine__UIElements__ClampedDragger_1__DragDirection<int32_t> __declspec(property(get=__get__dragDirection_k__BackingField, put=__set__dragDirection_k__BackingField))  _dragDirection_k__BackingField;

constexpr void __set__dragDirection_k__BackingField(UnityEngine::UIElements::UnityEngine__UIElements__ClampedDragger_1__DragDirection<int32_t> value) ;

constexpr UnityEngine::UIElements::UnityEngine__UIElements__ClampedDragger_1__DragDirection<int32_t> __get__dragDirection_k__BackingField() const;

 UnityEngine::UIElements::BaseSlider_1<int32_t> __declspec(property(get=__get__slider_k__BackingField, put=__set__slider_k__BackingField))  _slider_k__BackingField;

constexpr void __set__slider_k__BackingField(UnityEngine::UIElements::BaseSlider_1<int32_t> value) ;

constexpr UnityEngine::UIElements::BaseSlider_1<int32_t> __get__slider_k__BackingField() const;
...
// Properties
 ...
 UnityEngine::UIElements::UnityEngine__UIElements__ClampedDragger_1__DragDirection<int32_t> __declspec(property(get=get_dragDirection, put=set_dragDirection))  dragDirection;

 UnityEngine::UIElements::BaseSlider_1<int32_t> __declspec(property(put=set_slider))  slider;
...
/// @brief Method get_dragDirection addr 0x0 size 0xffffffffffffffff virtual false final false
 UnityEngine::UIElements::UnityEngine__UIElements__ClampedDragger_1__DragDirection<int32_t> get_dragDirection() ;

/// @brief Method set_dragDirection addr 0x0 size 0xffffffffffffffff virtual false final false
 void set_dragDirection(UnityEngine::UIElements::UnityEngine__UIElements__ClampedDragger_1__DragDirection<int32_t> value) ;

/// @brief Method set_slider addr 0x0 size 0xffffffffffffffff virtual false final false
 void set_slider(UnityEngine::UIElements::BaseSlider_1<int32_t> value) ;
...
explicit ClampedDragger_1(UnityEngine::UIElements::BaseSlider_1<int32_t> slider, System::Action clickHandler, System::Action dragHandler) ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(UnityEngine::UIElements::BaseSlider_1<int32_t> slider, System::Action clickHandler, System::Action dragHandler) ;
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6911)), TypeDefinitionIndex(TypeDefinitionIndex(6893))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6893), inst: 374 })
// CS Name: UnityEngine.UIElements.ClampedDragger`1
...
explicit ClampedDragger_1(UnityEngine::UIElements::BaseSlider_1<float_t> slider, System::Action clickHandler, System::Action dragHandler) ;
