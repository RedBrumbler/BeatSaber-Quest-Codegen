...
/// @brief Method CanDispatchEvent addr 0x2d0e0dc size 0x54 virtual true final true
 bool CanDispatchEvent(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method DispatchEvent addr 0x2d0e130 size 0x35c virtual true final true
...
/// @brief Method .ctor addr 0x2d0e48c size 0x8 virtual false final false
 void _ctor() ;
