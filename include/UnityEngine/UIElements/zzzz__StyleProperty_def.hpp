...
/// @brief Method get_name addr 0x2d23650 size 0x8 virtual false final false
 ::StringW get_name() ;

/// @brief Method get_values addr 0x2d23658 size 0x8 virtual false final false
 ::ArrayW<UnityEngine::UIElements::StyleValueHandle> get_values() ;

// Ctor Parameters []
explicit StyleProperty() ;

/// @brief Method .ctor addr 0x2d23660 size 0x8 virtual false final false
 void _ctor() ;
