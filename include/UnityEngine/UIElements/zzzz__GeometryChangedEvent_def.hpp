...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7298)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7298), inst: 1642 })}
...
/// @brief Method GetPooled addr 0x2d0ba50 size 0xc0 virtual false final false
static UnityEngine::UIElements::GeometryChangedEvent GetPooled(UnityEngine::Rect oldRect, UnityEngine::Rect newRect) ;

/// @brief Method Init addr 0x2d0bb10 size 0x50 virtual true final false
 void Init() ;

/// @brief Method LocalInit addr 0x2d0bb60 size 0x34 virtual false final false
 void LocalInit() ;

/// @brief Method get_oldRect addr 0x2d0bb94 size 0xc virtual false final false
 UnityEngine::Rect get_oldRect() ;

/// @brief Method set_oldRect addr 0x2d0bba0 size 0xc virtual false final false
 void set_oldRect(UnityEngine::Rect value) ;

/// @brief Method get_newRect addr 0x2d0bbac size 0xc virtual false final false
 UnityEngine::Rect get_newRect() ;

/// @brief Method set_newRect addr 0x2d0bbb8 size 0xc virtual false final false
 void set_newRect(UnityEngine::Rect value) ;

/// @brief Method get_layoutPass addr 0x2d0bbc4 size 0x8 virtual false final false
 int32_t get_layoutPass() ;

/// @brief Method set_layoutPass addr 0x2d0bbcc size 0x8 virtual false final false
 void set_layoutPass(int32_t value) ;

// Ctor Parameters []
explicit GeometryChangedEvent() ;

/// @brief Method .ctor addr 0x2d0bbd4 size 0x74 virtual false final false
 void _ctor() ;
