...
/// @brief Method get_minAtlasSize addr 0x2cd17d4 size 0x8 virtual false final false
 int32_t get_minAtlasSize() ;

/// @brief Method set_minAtlasSize addr 0x2cd17dc size 0x8 virtual false final false
 void set_minAtlasSize(int32_t value) ;

/// @brief Method get_maxAtlasSize addr 0x2cd17e4 size 0x8 virtual false final false
 int32_t get_maxAtlasSize() ;

/// @brief Method set_maxAtlasSize addr 0x2cd17ec size 0x8 virtual false final false
 void set_maxAtlasSize(int32_t value) ;

/// @brief Method get_maxSubTextureSize addr 0x2cd17f4 size 0x8 virtual false final false
 int32_t get_maxSubTextureSize() ;

/// @brief Method set_maxSubTextureSize addr 0x2cd17fc size 0x8 virtual false final false
 void set_maxSubTextureSize(int32_t value) ;

/// @brief Method get_activeFilters addr 0x2cd1804 size 0x8 virtual false final false
 UnityEngine::UIElements::DynamicAtlasFilters get_activeFilters() ;

/// @brief Method set_activeFilters addr 0x2cd180c size 0x8 virtual false final false
 void set_activeFilters(UnityEngine::UIElements::DynamicAtlasFilters value) ;

/// @brief Method get_defaultFilters addr 0x2cd1814 size 0x8 virtual false final false
static UnityEngine::UIElements::DynamicAtlasFilters get_defaultFilters() ;

/// @brief Method get_customFilter addr 0x2cd181c size 0x8 virtual false final false
 UnityEngine::UIElements::DynamicAtlasCustomFilter get_customFilter() ;

/// @brief Method set_customFilter addr 0x2cd1824 size 0x8 virtual false final false
 void set_customFilter(UnityEngine::UIElements::DynamicAtlasCustomFilter value) ;

/// @brief Method get_defaults addr 0x2cd182c size 0x80 virtual false final false
static UnityEngine::UIElements::DynamicAtlasSettings get_defaults() ;

// Ctor Parameters []
explicit DynamicAtlasSettings() ;

/// @brief Method .ctor addr 0x2cd18ac size 0x8 virtual false final false
 void _ctor() ;
