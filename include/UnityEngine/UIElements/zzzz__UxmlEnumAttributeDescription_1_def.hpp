...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7103))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7103), inst: 4831 })
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7092)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7092), inst: 5048 }), TypeDefinitionIndex(TypeDefinitionIndex(7104))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7104), inst: 4831 })
