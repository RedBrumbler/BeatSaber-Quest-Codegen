...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7397))}
...
/// @brief Method OnEnable addr 0x2d24f20 size 0x1c virtual true final false
 void OnEnable() ;

// Ctor Parameters []
explicit ThemeStyleSheet() ;

/// @brief Method .ctor addr 0x2d250a0 size 0x58 virtual false final false
 void _ctor() ;
