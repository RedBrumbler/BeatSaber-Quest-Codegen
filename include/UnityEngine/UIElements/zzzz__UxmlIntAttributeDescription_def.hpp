...
/// @brief Method .ctor addr 0x2cca774 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetValueFromBag>b__3_0 addr 0x2cca77c size 0x40 virtual false final false
 int32_t _GetValueFromBag_b__3_0(::StringW s, int32_t i) ;

/// @brief Method <TryGetValueFromBag>b__4_0 addr 0x2cca7bc size 0x40 virtual false final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7092), inst: 92 }), TypeDefinitionIndex(TypeDefinitionIndex(7092))}
...
/// @brief Method .ctor addr 0x2cca35c size 0x9c virtual false final false
 void _ctor() ;

/// @brief Method GetValueFromBag addr 0x2cca3f8 size 0x164 virtual true final false
 int32_t GetValueFromBag(UnityEngine::UIElements::IUxmlAttributes bag, UnityEngine::UIElements::CreationContext cc) ;

/// @brief Method TryGetValueFromBag addr 0x2cca55c size 0x178 virtual false final false
...
/// @brief Method ConvertValueToInt addr 0x2cca6d4 size 0x3c virtual false final false
