...
/// @brief Method get_mode addr 0x2d26ec8 size 0x8 virtual false final false
 UnityEngine::UIElements::EasingMode get_mode() ;

/// @brief Method .ctor addr 0x2d26ed0 size 0x8 virtual false final false
 void _ctor(UnityEngine::UIElements::EasingMode mode) ;

/// @brief Method op_Implicit addr 0x2d26ed8 size 0x8 virtual false final false
static UnityEngine::UIElements::EasingFunction op_Implicit_UnityEngine__UIElements__EasingFunction(UnityEngine::UIElements::EasingMode easingMode) ;

/// @brief Method op_Equality addr 0x2d26ee0 size 0xc virtual false final false
static bool op_Equality(UnityEngine::UIElements::EasingFunction lhs, UnityEngine::UIElements::EasingFunction rhs) ;

/// @brief Method Equals addr 0x2d26eec size 0x10 virtual true final true
 bool Equals(UnityEngine::UIElements::EasingFunction other) ;

/// @brief Method Equals addr 0x2d26efc size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method ToString addr 0x2d26f74 size 0x68 virtual true final false
 ::StringW ToString() ;

/// @brief Method GetHashCode addr 0x2d26fdc size 0x8 virtual true final false
 int32_t GetHashCode() ;
