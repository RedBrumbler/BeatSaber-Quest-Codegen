...
/// @brief Method HasMouseCapture addr 0x2cbc128 size 0xb0 virtual false final false
static bool HasMouseCapture(UnityEngine::UIElements::IEventHandler handler) ;

/// @brief Method CaptureMouse addr 0x2cb7840 size 0xe0 virtual false final false
static void CaptureMouse(UnityEngine::UIElements::IEventHandler handler) ;

/// @brief Method ReleaseMouse addr 0x2cbcc68 size 0xe0 virtual false final false
