...
/// @brief Method GetCallbackList addr 0x2d06414 size 0x68 virtual false final false
static UnityEngine::UIElements::EventCallbackList GetCallbackList(UnityEngine::UIElements::EventCallbackList initializer) ;

/// @brief Method ReleaseCallbackList addr 0x2d0647c size 0x68 virtual false final false
static void ReleaseCallbackList(UnityEngine::UIElements::EventCallbackList toRelease) ;

// Ctor Parameters []
explicit EventCallbackRegistry() ;

/// @brief Method .ctor addr 0x2d064e4 size 0x1c virtual false final false
 void _ctor() ;

/// @brief Method GetCallbackListForWriting addr 0x2d06500 size 0xb0 virtual false final false
 UnityEngine::UIElements::EventCallbackList GetCallbackListForWriting() ;

/// @brief Method GetCallbackListForReading addr 0x2d065b0 size 0x1c virtual false final false
 UnityEngine::UIElements::EventCallbackList GetCallbackListForReading() ;

/// @brief Method UnregisterCallback addr 0x2d065cc size 0x54 virtual false final false
...
/// @brief Method InvokeCallbacks addr 0x2d06620 size 0x198 virtual false final false
 void InvokeCallbacks(UnityEngine::UIElements::EventBase evt, UnityEngine::UIElements::PropagationPhase propagationPhase) ;

/// @brief Method HasTrickleDownHandlers addr 0x2d067d0 size 0x20 virtual false final false
 bool HasTrickleDownHandlers() ;

/// @brief Method HasBubbleHandlers addr 0x2d067f0 size 0x20 virtual false final false
