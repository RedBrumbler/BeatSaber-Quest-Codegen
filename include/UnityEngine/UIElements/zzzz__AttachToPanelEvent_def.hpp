...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7361)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7361), inst: 4671 })}
...
/// @brief Method .ctor addr 0x2d0dac0 size 0x48 virtual false final false
 void _ctor() ;
