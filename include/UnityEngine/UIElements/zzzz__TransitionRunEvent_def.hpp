...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7306), inst: 4991 }), TypeDefinitionIndex(TypeDefinitionIndex(7306))}
...
/// @brief Method .ctor addr 0x2d0971c size 0x48 virtual false final false
 void _ctor() ;
