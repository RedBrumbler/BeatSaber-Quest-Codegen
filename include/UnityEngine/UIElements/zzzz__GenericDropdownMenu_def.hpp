...
/// @brief Method .ctor addr 0x2cea77c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_contentContainer addr 0x2ce8e8c size 0x24 virtual false final false
 UnityEngine::UIElements::VisualElement get_contentContainer() ;

// Ctor Parameters []
explicit GenericDropdownMenu() ;

/// @brief Method .ctor addr 0x2ce2a8c size 0x2d4 virtual false final false
 void _ctor() ;

/// @brief Method OnAttachToPanel addr 0x2ce8eb0 size 0x438 virtual false final false
 void OnAttachToPanel(UnityEngine::UIElements::AttachToPanelEvent evt) ;

/// @brief Method OnDetachFromPanel addr 0x2ce92e8 size 0x494 virtual false final false
 void OnDetachFromPanel(UnityEngine::UIElements::DetachFromPanelEvent evt) ;

/// @brief Method Hide addr 0x2ce977c size 0xe8 virtual false final false
 void Hide() ;

/// @brief Method Apply addr 0x2ce9864 size 0x3c virtual false final false
 void Apply(UnityEngine::UIElements::KeyboardNavigationOperation op, UnityEngine::UIElements::EventBase sourceEvent) ;

/// @brief Method Apply addr 0x2ce98a0 size 0x184 virtual false final false
 bool Apply(UnityEngine::UIElements::KeyboardNavigationOperation op) ;

/// @brief Method OnPointerDown addr 0x2ce9c28 size 0x12c virtual false final false
 void OnPointerDown(UnityEngine::UIElements::PointerDownEvent evt) ;

/// @brief Method OnPointerMove addr 0x2ce9e7c size 0x12c virtual false final false
 void OnPointerMove(UnityEngine::UIElements::PointerMoveEvent evt) ;

/// @brief Method OnPointerUp addr 0x2ce9fa8 size 0x13c virtual false final false
 void OnPointerUp(UnityEngine::UIElements::PointerUpEvent evt) ;

/// @brief Method OnFocusOut addr 0x2cea0e4 size 0x148 virtual false final false
 void OnFocusOut(UnityEngine::UIElements::FocusOutEvent evt) ;

/// @brief Method OnParentResized addr 0x2cea22c size 0x4 virtual false final false
 void OnParentResized(UnityEngine::UIElements::GeometryChangedEvent evt) ;

/// @brief Method UpdateSelection addr 0x2ce9d54 size 0x128 virtual false final false
 void UpdateSelection(UnityEngine::UIElements::VisualElement target) ;

/// @brief Method ChangeSelectedIndex addr 0x2cea230 size 0x134 virtual false final false
 void ChangeSelectedIndex(int32_t newIndex, int32_t previousIndex) ;

/// @brief Method GetSelectedIndex addr 0x2ce9a24 size 0xa0 virtual false final false
 int32_t GetSelectedIndex() ;

/// @brief Method AddItem addr 0x2cea364 size 0x28 virtual true final true
 void AddItem(::StringW itemName, bool isChecked, System::Action action) ;

/// @brief Method AddSeparator addr 0x2cea6cc size 0xb0 virtual true final true
 void AddSeparator(::StringW path) ;

/// @brief Method AddItem addr 0x2cea38c size 0x340 virtual false final false
...
/// @brief Method DropDown addr 0x2cea784 size 0x75c virtual true final true
 void DropDown(UnityEngine::Rect position, UnityEngine::UIElements::VisualElement targetElement, bool anchored) ;

/// @brief Method OnTargetElementDetachFromPanel addr 0x2ceb5c4 size 0x4 virtual false final false
 void OnTargetElementDetachFromPanel(UnityEngine::UIElements::DetachFromPanelEvent evt) ;

/// @brief Method OnContainerGeometryChanged addr 0x2ceb5c8 size 0x4 virtual false final false
 void OnContainerGeometryChanged(UnityEngine::UIElements::GeometryChangedEvent evt) ;

/// @brief Method EnsureVisibilityInParent addr 0x2ceaee0 size 0x6e4 virtual false final false
 void EnsureVisibilityInParent() ;

/// @brief Method <Apply>g__UpdateSelectionDown|25_0 addr 0x2ce9b6c size 0xbc virtual false final false
...
/// @brief Method <Apply>g__UpdateSelectionUp|25_1 addr 0x2ce9ac4 size 0xa8 virtual false final false
