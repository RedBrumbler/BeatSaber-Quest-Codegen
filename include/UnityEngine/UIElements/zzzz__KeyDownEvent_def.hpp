...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7358)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7358), inst: 3807 })}
...
/// @brief Method GetEquivalentImguiEvent addr 0x2d0d970 size 0xc0 virtual false final false
 void GetEquivalentImguiEvent(UnityEngine::Event outImguiEvent) ;

// Ctor Parameters []
explicit KeyDownEvent() ;

/// @brief Method .ctor addr 0x2d0da30 size 0x48 virtual false final false
 void _ctor() ;
