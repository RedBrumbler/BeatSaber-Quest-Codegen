...
/// @brief Method .ctor addr 0x2d23424 size 0x10 virtual false final false
...
/// @brief Method .ctor addr 0x2d23628 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ToString>b__20_0 addr 0x2d23630 size 0x20 virtual false final false
...
/// @brief Method get_specificity addr 0x2d22f78 size 0x8 virtual false final false
 int32_t get_specificity() ;

/// @brief Method get_rule addr 0x2d22f80 size 0x8 virtual false final false
 UnityEngine::UIElements::StyleRule get_rule() ;

/// @brief Method set_rule addr 0x2d22f88 size 0x8 virtual false final false
 void set_rule(UnityEngine::UIElements::StyleRule value) ;

/// @brief Method get_selectors addr 0x2d22f90 size 0x8 virtual false final false
 ::ArrayW<UnityEngine::UIElements::StyleSelector> get_selectors() ;

/// @brief Method set_selectors addr 0x2d22f98 size 0x8 virtual false final false
 void set_selectors(::ArrayW<UnityEngine::UIElements::StyleSelector> value) ;

/// @brief Method CachePseudoStateMasks addr 0x2d22fa0 size 0x484 virtual false final false
 void CachePseudoStateMasks() ;

/// @brief Method ToString addr 0x2d2344c size 0x170 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit StyleComplexSelector() ;

/// @brief Method .ctor addr 0x2d235bc size 0x8 virtual false final false
 void _ctor() ;
