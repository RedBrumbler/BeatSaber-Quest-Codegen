...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7298)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7298), inst: 1635 }), TypeDefinitionIndex(TypeDefinitionIndex(7366))}
