...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7350), inst: 1907 }), TypeDefinitionIndex(TypeDefinitionIndex(7350))}
...
/// @brief Method Init addr 0x2d0cd80 size 0x54 virtual true final false
 void Init() ;

/// @brief Method LocalInit addr 0x2d0cdd4 size 0xc virtual false final false
 void LocalInit() ;

// Ctor Parameters []
explicit FocusOutEvent() ;

/// @brief Method .ctor addr 0x2d0cde0 size 0x54 virtual false final false
 void _ctor() ;
