...
/// @brief Method .ctor addr 0x2cc33f8 size 0x30 virtual false final false
 void _ctor(UnityEngine::UIElements::BaseVerticalCollectionView view) ;

/// @brief Method get_enableReordering addr 0x2cc384c size 0x8 virtual true final true
 bool get_enableReordering() ;

/// @brief Method set_enableReordering addr 0x2cc3854 size 0xc virtual true final true
 void set_enableReordering(bool value) ;

/// @brief Method CanStartDrag addr 0x2cc3860 size 0x8 virtual true final false
 bool CanStartDrag(System::Collections::Generic::IEnumerable_1<int32_t> itemIndices) ;

/// @brief Method SetupDragAndDrop addr 0x2cc3868 size 0x5d4 virtual true final false
