...
/// @brief Method Add addr 0x2d2384c size 0x1a0 virtual false final false
 void Add(UnityEngine::UIElements::StyleVariable sv) ;

/// @brief Method AddInitialRange addr 0x2d239ec size 0xf8 virtual false final false
 void AddInitialRange(UnityEngine::UIElements::StyleVariableContext other) ;

/// @brief Method Clear addr 0x2d23ae4 size 0x9c virtual false final false
 void Clear() ;

// Ctor Parameters []
explicit StyleVariableContext() ;

/// @brief Method .ctor addr 0x2d23b80 size 0xc8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2d23c48 size 0xec virtual false final false
 void _ctor(UnityEngine::UIElements::StyleVariableContext other) ;

/// @brief Method TryFindVariable addr 0x2d23d34 size 0xec virtual false final false
 bool TryFindVariable(::StringW name, ByRef<UnityEngine::UIElements::StyleVariable> v) ;

/// @brief Method GetVariableHash addr 0x2d23e20 size 0x8 virtual false final false
