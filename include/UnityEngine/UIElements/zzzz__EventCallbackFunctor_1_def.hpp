...
template<::cordl_internals::il2cpp_reference_type TEventType>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7301)), TypeDefinitionIndex(TypeDefinitionIndex(7302))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7302), inst: 2 })
