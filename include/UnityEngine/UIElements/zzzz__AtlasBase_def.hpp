...
/// @brief Method TryGetAtlas addr 0x2c6d284 size 0x74 virtual true final false
...
/// @brief Method ReturnAtlas addr 0x2c6d2f8 size 0x4 virtual true final false
...
/// @brief Method Reset addr 0x2c6d2fc size 0x4 virtual true final false
 void Reset() ;

/// @brief Method OnAssignedToPanel addr 0x2c6d300 size 0x4 virtual true final false
 void OnAssignedToPanel(UnityEngine::UIElements::IPanel panel) ;

/// @brief Method OnRemovedFromPanel addr 0x2c6d304 size 0x4 virtual true final false
 void OnRemovedFromPanel(UnityEngine::UIElements::IPanel panel) ;

/// @brief Method OnUpdateDynamicTextures addr 0x2c6d308 size 0x4 virtual true final false
 void OnUpdateDynamicTextures(UnityEngine::UIElements::IPanel panel) ;

/// @brief Method InvokeAssignedToPanel addr 0x2c6d30c size 0xc virtual false final false
 void InvokeAssignedToPanel(UnityEngine::UIElements::IPanel panel) ;

/// @brief Method InvokeRemovedFromPanel addr 0x2c6d318 size 0xc virtual false final false
 void InvokeRemovedFromPanel(UnityEngine::UIElements::IPanel panel) ;

/// @brief Method InvokeUpdateDynamicTextures addr 0x2c6d324 size 0xc virtual false final false
 void InvokeUpdateDynamicTextures(UnityEngine::UIElements::IPanel panel) ;

/// @brief Method RepaintTexturedElements addr 0x2c6d330 size 0xec virtual false final false
static void RepaintTexturedElements(UnityEngine::UIElements::IPanel panel) ;

/// @brief Method SetDynamicTexture addr 0x2c6d41c size 0x20 virtual false final false
 void SetDynamicTexture(UnityEngine::UIElements::TextureId id, UnityEngine::Texture texture) ;

// Ctor Parameters []
explicit AtlasBase() ;

/// @brief Method .ctor addr 0x2c6d43c size 0x98 virtual false final false
 void _ctor() ;
