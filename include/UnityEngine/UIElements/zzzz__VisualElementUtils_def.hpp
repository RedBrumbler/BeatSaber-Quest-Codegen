...
/// @brief Method GetUniqueName addr 0x2cbe0cc size 0x114 virtual false final false
static ::StringW GetUniqueName(::StringW nameBase) ;

/// @brief Method GetFoldoutDepth addr 0x2cbc628 size 0xe4 virtual false final false
static int32_t GetFoldoutDepth(UnityEngine::UIElements::VisualElement element) ;

/// @brief Method GetListAndFoldoutDepth addr 0x2cbe1e0 size 0x114 virtual false final false
