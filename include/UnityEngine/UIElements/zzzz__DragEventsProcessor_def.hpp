...
/// @brief Method get_supportsDragEvents addr 0x2cc7bb0 size 0x8 virtual true final false
 bool get_supportsDragEvents() ;

/// @brief Method get_useDragEvents addr 0x2cc5eb0 size 0x30 virtual false final false
 bool get_useDragEvents() ;

/// @brief Method get_isEditorContext addr 0x2cc7bb8 size 0x120 virtual false final false
...
/// @brief Method .ctor addr 0x2cc42f0 size 0x13c virtual false final false
 void _ctor(UnityEngine::UIElements::VisualElement target) ;

/// @brief Method RegisterCallbacksFromTarget addr 0x2cc7f84 size 0x4 virtual false final false
 void RegisterCallbacksFromTarget(UnityEngine::UIElements::AttachToPanelEvent evt) ;

/// @brief Method RegisterCallbacksFromTarget addr 0x2cc7cd8 size 0x2ac virtual false final false
 void RegisterCallbacksFromTarget() ;

/// @brief Method UnregisterCallbacksFromTarget addr 0x2cc7f88 size 0x8 virtual false final false
 void UnregisterCallbacksFromTarget(UnityEngine::UIElements::DetachFromPanelEvent evt) ;

/// @brief Method UnregisterCallbacksFromTarget addr 0x2cc7f90 size 0x398 virtual false final false
...
/// @brief Method OnPointerDownEvent addr 0x2cc8328 size 0x94 virtual false final false
 void OnPointerDownEvent(UnityEngine::UIElements::PointerDownEvent evt) ;

/// @brief Method OnPointerUpEvent addr 0x2cc83bc size 0xc4 virtual false final false
 void OnPointerUpEvent(UnityEngine::UIElements::PointerUpEvent evt) ;

/// @brief Method OnPointerLeaveEvent addr 0x2cc8480 size 0x44 virtual false final false
 void OnPointerLeaveEvent(UnityEngine::UIElements::PointerLeaveEvent evt) ;

/// @brief Method OnPointerCancelEvent addr 0x2cc84c4 size 0x40 virtual false final false
 void OnPointerCancelEvent(UnityEngine::UIElements::PointerCancelEvent evt) ;

/// @brief Method OnPointerMoveEvent addr 0x2cc8504 size 0x244 virtual false final false
