...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7333), inst: 4513 }), TypeDefinitionIndex(TypeDefinitionIndex(7333))}
...
/// @brief Method Init addr 0x2d0c538 size 0x54 virtual true final false
 void Init() ;

/// @brief Method LocalInit addr 0x2d0c58c size 0xc virtual false final false
 void LocalInit() ;

// Ctor Parameters []
explicit MouseEnterWindowEvent() ;

/// @brief Method .ctor addr 0x2d0c598 size 0x54 virtual false final false
 void _ctor() ;

/// @brief Method PostDispatch addr 0x2d0c5ec size 0x15c virtual true final false
