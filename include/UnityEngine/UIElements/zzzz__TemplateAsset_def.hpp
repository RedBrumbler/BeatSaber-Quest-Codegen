...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7125))}
...
/// @brief Method get_attributeOverrides addr 0x2ccb15c size 0x80 virtual false final false
...
/// @brief Method get_slotUsages addr 0x2ccb1dc size 0x8 virtual false final false
