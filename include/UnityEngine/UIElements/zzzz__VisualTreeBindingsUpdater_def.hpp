...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6891))}
...
/// @brief Method get_profilerMarker addr 0x2d38f7c size 0x58 virtual true final false
 Unity::Profiling::ProfilerMarker get_profilerMarker() ;

/// @brief Method GetBindingObjectFromElement addr 0x2d38fd4 size 0x138 virtual false final false
 UnityEngine::UIElements::IBinding GetBindingObjectFromElement(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method StartTracking addr 0x2d39194 size 0x80 virtual false final false
 void StartTracking(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method StopTracking addr 0x2d39214 size 0x80 virtual false final false
 void StopTracking(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method get_temporaryObjectCache addr 0x2d39294 size 0x8 virtual false final false
 System::Collections::Generic::Dictionary_2<::bs_hook::Il2CppWrapperType,::bs_hook::Il2CppWrapperType> get_temporaryObjectCache() ;

/// @brief Method GetAdditionalBinding addr 0x2d3910c size 0x88 virtual false final false
static UnityEngine::UIElements::IBinding GetAdditionalBinding(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method StartTrackingRecursive addr 0x2d3929c size 0x118 virtual false final false
 void StartTrackingRecursive(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method StopTrackingRecursive addr 0x2d393b4 size 0x10c virtual false final false
 void StopTrackingRecursive(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method OnVersionChanged addr 0x2d394c0 size 0xf8 virtual true final false
 void OnVersionChanged(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::VersionChangeType versionChangeType) ;

/// @brief Method OnHierarchyChange addr 0x2d395b8 size 0x18 virtual true final false
 void OnHierarchyChange(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::HierarchyChangeType type) ;

/// @brief Method CurrentTime addr 0x2d395d0 size 0x50 virtual false final false
static int64_t CurrentTime() ;

/// @brief Method PerformTrackingOperations addr 0x2d39620 size 0x284 virtual false final false
 void PerformTrackingOperations() ;

/// @brief Method Update addr 0x2d398a4 size 0x600 virtual true final false
 void Update() ;

/// @brief Method UpdateBindings addr 0x2d39ea4 size 0x534 virtual false final false
 void UpdateBindings() ;

// Ctor Parameters []
explicit VisualTreeBindingsUpdater() ;

/// @brief Method .ctor addr 0x2d3a3d8 size 0x160 virtual false final false
 void _ctor() ;
