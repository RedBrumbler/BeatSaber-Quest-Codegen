...
/// @brief Method Copy addr 0x2d3ea20 size 0x1c virtual true final true
 UnityEngine::UIElements::LayoutData Copy() ;

/// @brief Method CopyFrom addr 0x2d3ea3c size 0x14 virtual true final true
 void CopyFrom(ByRef<UnityEngine::UIElements::LayoutData> other) ;

/// @brief Method op_Equality addr 0x2d3ea50 size 0x280 virtual false final false
static bool op_Equality(UnityEngine::UIElements::LayoutData lhs, UnityEngine::UIElements::LayoutData rhs) ;

/// @brief Method Equals addr 0x2d3ecd0 size 0x4c virtual true final true
 bool Equals(UnityEngine::UIElements::LayoutData other) ;

/// @brief Method Equals addr 0x2d3ed1c size 0xa8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d3edc4 size 0x264 virtual true final false
 int32_t GetHashCode() ;
