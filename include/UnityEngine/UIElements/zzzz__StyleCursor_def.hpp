...
/// @brief Method get_value addr 0x2d293b0 size 0x44 virtual true final true
 UnityEngine::UIElements::Cursor get_value() ;

/// @brief Method get_keyword addr 0x2d293f4 size 0x8 virtual true final true
 UnityEngine::UIElements::StyleKeyword get_keyword() ;

/// @brief Method .ctor addr 0x2d293fc size 0x10 virtual false final false
 void _ctor(UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method .ctor addr 0x2d2940c size 0x18 virtual false final false
 void _ctor(UnityEngine::UIElements::Cursor v, UnityEngine::UIElements::StyleKeyword keyword) ;

/// @brief Method op_Equality addr 0x2d29424 size 0x60 virtual false final false
static bool op_Equality(UnityEngine::UIElements::StyleCursor lhs, UnityEngine::UIElements::StyleCursor rhs) ;

/// @brief Method op_Implicit addr 0x2d29484 size 0x10 virtual false final false
...
/// @brief Method Equals addr 0x2d29494 size 0x80 virtual true final true
 bool Equals(UnityEngine::UIElements::StyleCursor other) ;

/// @brief Method Equals addr 0x2d29514 size 0x88 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d2959c size 0x28 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2d295c4 size 0x80 virtual true final false
 ::StringW ToString() ;
