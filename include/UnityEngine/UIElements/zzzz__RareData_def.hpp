...
/// @brief Method Copy addr 0x2d3f028 size 0x1c virtual true final true
 UnityEngine::UIElements::RareData Copy() ;

/// @brief Method CopyFrom addr 0x2d3f044 size 0x14 virtual true final true
 void CopyFrom(ByRef<UnityEngine::UIElements::RareData> other) ;

/// @brief Method op_Equality addr 0x2d3f058 size 0x120 virtual false final false
static bool op_Equality(UnityEngine::UIElements::RareData lhs, UnityEngine::UIElements::RareData rhs) ;

/// @brief Method Equals addr 0x2d3f178 size 0x44 virtual true final true
 bool Equals(UnityEngine::UIElements::RareData other) ;

/// @brief Method Equals addr 0x2d3f1bc size 0xa0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d3f25c size 0xf8 virtual true final false
 int32_t GetHashCode() ;
