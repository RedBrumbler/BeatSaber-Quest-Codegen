...
/// @brief Method get_isClicking addr 0x2cd9cbc size 0x8 virtual false final false
 bool get_isClicking() ;

/// @brief Method set_isClicking addr 0x2cd9cc4 size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x2cd9cf8 size 0x80 virtual false final false
 void _ctor(UnityEngine::UIElements::TextEditorEngine editorEngine, UnityEngine::UIElements::ITextInputField textInputField) ;

/// @brief Method ExecuteDefaultActionAtTarget addr 0x2cd9d78 size 0x5bc virtual true final false
 void ExecuteDefaultActionAtTarget(UnityEngine::UIElements::EventBase evt) ;

/// @brief Method OnFocus addr 0x2cda334 size 0x190 virtual false final false
 void OnFocus(UnityEngine::UIElements::FocusEvent _) ;

/// @brief Method OnBlur addr 0x2cda4c4 size 0xc virtual false final false
 void OnBlur(UnityEngine::UIElements::BlurEvent _) ;

/// @brief Method OnMouseDown addr 0x2cda4d0 size 0x3f4 virtual false final false
 void OnMouseDown(UnityEngine::UIElements::MouseDownEvent evt) ;

/// @brief Method OnMouseUp addr 0x2cda8c4 size 0x168 virtual false final false
 void OnMouseUp(UnityEngine::UIElements::MouseUpEvent evt) ;

/// @brief Method OnMouseMove addr 0x2cdaa2c size 0x148 virtual false final false
 void OnMouseMove(UnityEngine::UIElements::MouseMoveEvent evt) ;

/// @brief Method ProcessDragMove addr 0x2cdbafc size 0x134 virtual false final false
 void ProcessDragMove(UnityEngine::UIElements::MouseMoveEvent evt) ;

/// @brief Method MoveDistanceQualifiesForDrag addr 0x2cdbad8 size 0x24 virtual false final false
 bool MoveDistanceQualifiesForDrag(UnityEngine::Vector2 start, UnityEngine::Vector2 current) ;

/// @brief Method OnKeyDown addr 0x2cdab74 size 0x608 virtual false final false
 void OnKeyDown(UnityEngine::UIElements::KeyDownEvent evt) ;

/// @brief Method OnValidateCommandEvent addr 0x2cdb17c size 0x364 virtual false final false
 void OnValidateCommandEvent(UnityEngine::UIElements::ValidateCommandEvent evt) ;

/// @brief Method OnExecuteCommandEvent addr 0x2cdb4e0 size 0x5f8 virtual false final false
 void OnExecuteCommandEvent(UnityEngine::UIElements::ExecuteCommandEvent evt) ;

/// @brief Method PreDrawCursor addr 0x2cdbc30 size 0x340 virtual false final false
 void PreDrawCursor(::StringW newText) ;

/// @brief Method PostDrawCursor addr 0x2cdbf70 size 0x24 virtual false final false
 void PostDrawCursor() ;
