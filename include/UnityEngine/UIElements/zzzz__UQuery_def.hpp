...
/// @brief Method .ctor addr 0x2cbf12c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <TraverseRecursive>b__5_0 addr 0x2cbf134 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x2cbeea0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Traverse addr 0x2cbeea8 size 0x8 virtual true final false
 void Traverse(UnityEngine::UIElements::VisualElement element) ;

/// @brief Method OnRuleMatchedElement addr 0x2cbeeb0 size 0x8 virtual true final false
 bool OnRuleMatchedElement(UnityEngine::UIElements::RuleMatcher matcher, UnityEngine::UIElements::VisualElement element) ;

/// @brief Method NoProcessResult addr 0x2cbeeb8 size 0x4 virtual false final false
static void NoProcessResult(UnityEngine::UIElements::VisualElement e, UnityEngine::UIElements::StyleSheets::MatchResultInfo i) ;

/// @brief Method TraverseRecursive addr 0x2cbeebc size 0x1fc virtual true final false
 void TraverseRecursive(UnityEngine::UIElements::VisualElement element, int32_t depth) ;

/// @brief Method Run addr 0x2cbf0b8 size 0x10 virtual true final false
...
/// @brief Method get_match addr 0x2cbf138 size 0x8 virtual false final false
 UnityEngine::UIElements::VisualElement get_match() ;

/// @brief Method set_match addr 0x2cbf140 size 0x8 virtual false final false
 void set_match(UnityEngine::UIElements::VisualElement value) ;

/// @brief Method Run addr 0x2cbf148 size 0x24 virtual true final false
 void Run(UnityEngine::UIElements::VisualElement root, System::Collections::Generic::List_1<UnityEngine::UIElements::RuleMatcher> matchers) ;

/// @brief Method IsInUse addr 0x2cbf16c size 0x10 virtual false final false
 bool IsInUse() ;
...
/// @brief Method .ctor addr 0x2cbf17c size 0x8 virtual false final false
 void _ctor() ;
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7030))}
...
/// @brief Method OnRuleMatchedElement addr 0x2cbf184 size 0x14 virtual true final false
 bool OnRuleMatchedElement(UnityEngine::UIElements::RuleMatcher matcher, UnityEngine::UIElements::VisualElement element) ;

/// @brief Method CreateNew addr 0x2cbf198 size 0x5c virtual true final false
 UnityEngine::UIElements::UnityEngine__UIElements__UQuery__SingleQueryMatcher CreateNew() ;

// Ctor Parameters []
explicit UnityEngine__UIElements__UQuery__FirstQueryMatcher() ;

/// @brief Method .ctor addr 0x2cbf1f4 size 0x8 virtual false final false
 void _ctor() ;
...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7027))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7027), inst: 2 })
