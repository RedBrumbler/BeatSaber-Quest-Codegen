...
/// @brief Method .ctor addr 0x2cc9894 size 0x24 virtual false final false
 void _ctor() ;

/// @brief Method get_name addr 0x2cc98b8 size 0x8 virtual false final false
 ::StringW get_name() ;

/// @brief Method set_name addr 0x2cc98c0 size 0x8 virtual false final false
 void set_name(::StringW value) ;

/// @brief Method set_obsoleteNames addr 0x2cc98c8 size 0x5c virtual false final false
 void set_obsoleteNames(System::Collections::Generic::IEnumerable_1<::StringW> value) ;

/// @brief Method set_type addr 0x2cc9924 size 0x8 virtual false final false
 void set_type(::StringW value) ;

/// @brief Method set_typeNamespace addr 0x2cc992c size 0x8 virtual false final false
 void set_typeNamespace(::StringW value) ;

/// @brief Method set_use addr 0x2cc9934 size 0x8 virtual false final false
 void set_use(UnityEngine::UIElements::UnityEngine__UIElements__UxmlAttributeDescription__Use value) ;

/// @brief Method set_restriction addr 0x2cc993c size 0x8 virtual false final false
 void set_restriction(UnityEngine::UIElements::UxmlTypeRestriction value) ;

/// @brief Method TryGetValueFromBagAsString addr 0x2cc9944 size 0x474 virtual false final false
