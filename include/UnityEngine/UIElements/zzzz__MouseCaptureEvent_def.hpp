...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7271), inst: 4505 }), TypeDefinitionIndex(TypeDefinitionIndex(7271))}
...
/// @brief Method .ctor addr 0x2d02d08 size 0x48 virtual false final false
 void _ctor() ;
