...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7057))}
...
/// @brief Method .ctor addr 0x2cc33c4 size 0x34 virtual false final false
 void _ctor(UnityEngine::UIElements::ListView view) ;

/// @brief Method HandleDragAndDrop addr 0x2cc3428 size 0x19c virtual true final false
 UnityEngine::UIElements::DragVisualMode HandleDragAndDrop(UnityEngine::UIElements::IListDragAndDropArgs args) ;

/// @brief Method OnDrop addr 0x2cc35c4 size 0x288 virtual true final false
