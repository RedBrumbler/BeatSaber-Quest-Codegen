...
/// @brief Method get_currentOffset addr 0x2c81d58 size 0x14 virtual false final false
 UnityEngine::Matrix4x4 get_currentOffset() ;

/// @brief Method get_currentWorldClip addr 0x2c81d6c size 0xc virtual false final false
 UnityEngine::Rect get_currentWorldClip() ;

/// @brief Method get_repaintEvent addr 0x2c81d78 size 0x8 virtual false final false
 UnityEngine::Event get_repaintEvent() ;

/// @brief Method set_repaintEvent addr 0x2c81d80 size 0x8 virtual false final false
 void set_repaintEvent(UnityEngine::Event value) ;

// Ctor Parameters []
explicit RepaintData() ;

/// @brief Method .ctor addr 0x2c81d88 size 0x60 virtual false final false
 void _ctor() ;
