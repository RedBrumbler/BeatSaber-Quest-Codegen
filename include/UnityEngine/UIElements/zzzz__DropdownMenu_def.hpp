...
/// @brief Method MenuItems addr 0x2cc2ebc size 0x8 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::UIElements::DropdownMenuItem> MenuItems() ;

/// @brief Method AppendAction addr 0x2cc2ec4 size 0x104 virtual false final false
...
/// @brief Method InsertSeparator addr 0x2cc2fc8 size 0x140 virtual false final false
 void InsertSeparator(::StringW subMenuPath, int32_t atIndex) ;

/// @brief Method PrepareForDisplay addr 0x2cc3108 size 0x2bc virtual false final false
