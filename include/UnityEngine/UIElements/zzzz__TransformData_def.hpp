...
/// @brief Method Copy addr 0x2d3f354 size 0x1c virtual true final true
 UnityEngine::UIElements::TransformData Copy() ;

/// @brief Method CopyFrom addr 0x2d3f370 size 0x14 virtual true final true
 void CopyFrom(ByRef<UnityEngine::UIElements::TransformData> other) ;

/// @brief Method op_Equality addr 0x2d3f384 size 0x128 virtual false final false
static bool op_Equality(UnityEngine::UIElements::TransformData lhs, UnityEngine::UIElements::TransformData rhs) ;

/// @brief Method Equals addr 0x2d3f4ac size 0x44 virtual true final true
 bool Equals(UnityEngine::UIElements::TransformData other) ;

/// @brief Method Equals addr 0x2d3f4f0 size 0xa0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2d3f590 size 0x64 virtual true final false
 int32_t GetHashCode() ;
