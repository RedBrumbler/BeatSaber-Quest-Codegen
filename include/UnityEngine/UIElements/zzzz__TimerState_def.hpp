...
/// @brief Method get_start addr 0x2cc1e4c size 0x8 virtual false final false
 int64_t get_start() ;

/// @brief Method set_start addr 0x2cc1e54 size 0x8 virtual false final false
 void set_start(int64_t value) ;

/// @brief Method get_now addr 0x2cc1e5c size 0x8 virtual false final false
 int64_t get_now() ;

/// @brief Method set_now addr 0x2cc1e64 size 0x8 virtual false final false
 void set_now(int64_t value) ;

/// @brief Method get_deltaTime addr 0x2cc1e6c size 0xc virtual false final false
 int64_t get_deltaTime() ;

/// @brief Method Equals addr 0x2cc1e78 size 0x88 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2cc1f00 size 0x24 virtual true final true
 bool Equals(UnityEngine::UIElements::TimerState other) ;

/// @brief Method GetHashCode addr 0x2cc1f24 size 0x7c virtual true final false
 int32_t GetHashCode() ;
