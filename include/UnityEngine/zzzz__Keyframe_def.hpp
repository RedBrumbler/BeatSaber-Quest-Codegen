...
/// @brief Method .ctor addr 0x2b5b100 size 0x10 virtual false final false
 void _ctor(float_t time, float_t value) ;

/// @brief Method .ctor addr 0x2b5b110 size 0x14 virtual false final false
 void _ctor(float_t time, float_t value, float_t inTangent, float_t outTangent) ;

/// @brief Method get_time addr 0x2b5b124 size 0x8 virtual false final false
 float_t get_time() ;

/// @brief Method set_time addr 0x2b5b12c size 0x8 virtual false final false
 void set_time(float_t value) ;

/// @brief Method get_value addr 0x2b5b134 size 0x8 virtual false final false
 float_t get_value() ;

/// @brief Method set_value addr 0x2b5b13c size 0x8 virtual false final false
 void set_value(float_t value) ;

/// @brief Method get_inTangent addr 0x2b5b144 size 0x8 virtual false final false
 float_t get_inTangent() ;

/// @brief Method set_inTangent addr 0x2b5b14c size 0x8 virtual false final false
 void set_inTangent(float_t value) ;

/// @brief Method get_outTangent addr 0x2b5b154 size 0x8 virtual false final false
 float_t get_outTangent() ;

/// @brief Method set_outTangent addr 0x2b5b15c size 0x8 virtual false final false
