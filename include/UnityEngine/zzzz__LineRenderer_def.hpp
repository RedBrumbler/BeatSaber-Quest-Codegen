...
/// @brief Method set_startWidth addr 0x2b5fc6c size 0x4c virtual false final false
 void set_startWidth(float_t value) ;

/// @brief Method set_endWidth addr 0x2b5fcb8 size 0x4c virtual false final false
 void set_endWidth(float_t value) ;

/// @brief Method set_useWorldSpace addr 0x2b5fd04 size 0x44 virtual false final false
 void set_useWorldSpace(bool value) ;

/// @brief Method set_startColor addr 0x2b5fd48 size 0x54 virtual false final false
 void set_startColor(UnityEngine::Color value) ;

/// @brief Method set_endColor addr 0x2b5fde0 size 0x54 virtual false final false
 void set_endColor(UnityEngine::Color value) ;

/// @brief Method set_positionCount addr 0x2b5fe78 size 0x44 virtual false final false
 void set_positionCount(int32_t value) ;

/// @brief Method SetPosition addr 0x2b5febc size 0x5c virtual false final false
 void SetPosition(int32_t index, UnityEngine::Vector3 position) ;

/// @brief Method SetPositions addr 0x2b5ff6c size 0x44 virtual false final false
 void SetPositions(::ArrayW<UnityEngine::Vector3> positions) ;

/// @brief Method set_startColor_Injected addr 0x2b5fd9c size 0x44 virtual false final false
 void set_startColor_Injected(ByRef<UnityEngine::Color> value) ;

/// @brief Method set_endColor_Injected addr 0x2b5fe34 size 0x44 virtual false final false
 void set_endColor_Injected(ByRef<UnityEngine::Color> value) ;

/// @brief Method SetPosition_Injected addr 0x2b5ff18 size 0x54 virtual false final false
