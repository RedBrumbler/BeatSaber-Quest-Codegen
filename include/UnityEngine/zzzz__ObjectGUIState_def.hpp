...
/// @brief Method .ctor addr 0x2bbe4cc size 0x48 virtual false final false
 void _ctor() ;

/// @brief Method Dispose addr 0x2bbe53c size 0x60 virtual true final true
 void Dispose() ;

/// @brief Method Finalize addr 0x2bbe63c size 0x94 virtual true final false
 void Finalize() ;

/// @brief Method Destroy addr 0x2bbe59c size 0xa0 virtual false final false
 void Destroy() ;

/// @brief Method Internal_Create addr 0x2bbe514 size 0x28 virtual false final false
static ::cordl_internals::intptr_t Internal_Create() ;

/// @brief Method Internal_Destroy addr 0x2bbe6d0 size 0x3c virtual false final false
