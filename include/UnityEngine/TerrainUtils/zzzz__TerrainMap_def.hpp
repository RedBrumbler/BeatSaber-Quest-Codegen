...
/// @brief Method .ctor addr 0x2bd9b88 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <CreateFromPlacement>b__0 addr 0x2bdaad0 size 0x58 virtual false final false
...
/// @brief Method GetTerrain addr 0x2bd9860 size 0x78 virtual false final false
 UnityEngine::Terrain GetTerrain(int32_t tileX, int32_t tileZ) ;

/// @brief Method CreateFromPlacement addr 0x2bd98d8 size 0x2b0 virtual false final false
...
/// @brief Method CreateFromPlacement addr 0x2bd9b90 size 0x3e0 virtual false final false
...
/// @brief Method get_terrainTiles addr 0x2bda26c size 0x8 virtual false final false
 System::Collections::Generic::Dictionary_2<UnityEngine::TerrainUtils::TerrainTileCoord,UnityEngine::Terrain> get_terrainTiles() ;

// Ctor Parameters []
explicit TerrainMap() ;

/// @brief Method .ctor addr 0x2bd9f70 size 0x84 virtual false final false
 void _ctor() ;

/// @brief Method AddTerrainInternal addr 0x2bda274 size 0x128 virtual false final false
 void AddTerrainInternal(int32_t x, int32_t z, UnityEngine::Terrain terrain) ;

/// @brief Method TryToAddTerrain addr 0x2bd9ff4 size 0x114 virtual false final false
 bool TryToAddTerrain(int32_t tileX, int32_t tileZ, UnityEngine::Terrain terrain) ;

/// @brief Method ValidateTerrain addr 0x2bda39c size 0x734 virtual false final false
 void ValidateTerrain(int32_t tileX, int32_t tileZ) ;

/// @brief Method Validate addr 0x2bda108 size 0x164 virtual false final false
