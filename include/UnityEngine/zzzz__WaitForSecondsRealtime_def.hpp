...
namespace UnityEngine {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10202))}
...
/// @brief Method get_waitTime addr 0x2b8e38c size 0x8 virtual false final false
 float_t get_waitTime() ;

/// @brief Method set_waitTime addr 0x2b8e394 size 0x8 virtual false final false
 void set_waitTime(float_t value) ;

/// @brief Method get_keepWaiting addr 0x2b8e39c size 0x9c virtual true final false
 bool get_keepWaiting() ;

// Ctor Parameters [CppParam { name: "time", ty: "float_t", modifiers: "", def_value: None }]
explicit WaitForSecondsRealtime(float_t time) ;

/// @brief Method .ctor addr 0x2b8e438 size 0x30 virtual false final false
 void _ctor(float_t time) ;

/// @brief Method Reset addr 0x2b8e468 size 0xc virtual true final false
 void Reset() ;
