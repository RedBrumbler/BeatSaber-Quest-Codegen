...
/// @brief Method Create addr 0x2b552f8 size 0x98 virtual false final false
static UnityEngine::Animations::AnimationMixerPlayable Create(UnityEngine::Playables::PlayableGraph graph, int32_t inputCount) ;

/// @brief Method CreateHandle addr 0x2b55390 size 0xe4 virtual false final false
static UnityEngine::Playables::PlayableHandle CreateHandle(UnityEngine::Playables::PlayableGraph graph, int32_t inputCount) ;

/// @brief Method .ctor addr 0x2b55474 size 0xc0 virtual false final false
 void _ctor(UnityEngine::Playables::PlayableHandle handle) ;

/// @brief Method GetHandle addr 0x2b555c0 size 0xc virtual true final true
 UnityEngine::Playables::PlayableHandle GetHandle() ;

/// @brief Method op_Implicit addr 0x2b555cc size 0x30 virtual false final false
...
/// @brief Method Equals addr 0x2b555fc size 0x78 virtual true final true
 bool Equals(UnityEngine::Animations::AnimationMixerPlayable other) ;

/// @brief Method CreateHandleInternal addr 0x2b55534 size 0x8c virtual false final false
...
/// @brief Method CreateHandleInternal_Injected addr 0x2b55674 size 0x44 virtual false final false
