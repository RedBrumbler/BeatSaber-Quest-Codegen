...
/// @brief Method .ctor addr 0x2b53d14 size 0xc0 virtual false final false
 void _ctor(UnityEngine::Playables::PlayableHandle handle) ;

/// @brief Method GetHandle addr 0x2b53dd4 size 0xc virtual true final true
 UnityEngine::Playables::PlayableHandle GetHandle() ;

/// @brief Method Equals addr 0x2b53de0 size 0x78 virtual true final true
