...
/// @brief Method Create addr 0x2b55ab8 size 0x13c virtual false final false
static UnityEngine::Playables::PlayableBinding Create(::StringW name, UnityEngine::Object key) ;

/// @brief Method CreateAnimationOutput addr 0x2b55bf4 size 0x40 virtual false final false
