...
namespace UnityEngine {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15489))}
...
/// @brief Method get_center addr 0x2bd2004 size 0x5c virtual false final false
 UnityEngine::Vector3 get_center() ;

/// @brief Method set_center addr 0x2bd20a4 size 0x54 virtual false final false
 void set_center(UnityEngine::Vector3 value) ;

/// @brief Method get_radius addr 0x2bd213c size 0x3c virtual false final false
 float_t get_radius() ;

/// @brief Method set_radius addr 0x2bd2178 size 0x4c virtual false final false
 void set_radius(float_t value) ;

/// @brief Method get_height addr 0x2bd21c4 size 0x3c virtual false final false
 float_t get_height() ;

/// @brief Method set_height addr 0x2bd2200 size 0x4c virtual false final false
 void set_height(float_t value) ;

/// @brief Method set_direction addr 0x2bd224c size 0x44 virtual false final false
 void set_direction(int32_t value) ;

/// @brief Method get_center_Injected addr 0x2bd2060 size 0x44 virtual false final false
 void get_center_Injected(ByRef<UnityEngine::Vector3> ret) ;

/// @brief Method set_center_Injected addr 0x2bd20f8 size 0x44 virtual false final false
