...
/// @brief Method .ctor addr 0x2d69d38 size 0x58 virtual false final false
 void _ctor() ;

/// @brief Method get_originalPath addr 0x2d69d90 size 0x3c virtual false final false
 ::StringW get_originalPath() ;

/// @brief Method get_frameCount addr 0x2d69dcc size 0x3c virtual false final false
 uint64_t get_frameCount() ;

/// @brief Method get_frameRate addr 0x2d69e08 size 0x3c virtual false final false
 double_t get_frameRate() ;

/// @brief Method get_length addr 0x2d69e44 size 0x3c virtual false final false
 double_t get_length() ;

/// @brief Method get_width addr 0x2d69e80 size 0x3c virtual false final false
 uint32_t get_width() ;

/// @brief Method get_height addr 0x2d69ebc size 0x3c virtual false final false
 uint32_t get_height() ;

/// @brief Method get_pixelAspectRatioNumerator addr 0x2d69ef8 size 0x3c virtual false final false
 uint32_t get_pixelAspectRatioNumerator() ;

/// @brief Method get_pixelAspectRatioDenominator addr 0x2d69f34 size 0x3c virtual false final false
 uint32_t get_pixelAspectRatioDenominator() ;

/// @brief Method get_sRGB addr 0x2d69f70 size 0x3c virtual false final false
 bool get_sRGB() ;

/// @brief Method get_audioTrackCount addr 0x2d69fac size 0x3c virtual false final false
 uint16_t get_audioTrackCount() ;

/// @brief Method GetAudioChannelCount addr 0x2d69fe8 size 0x44 virtual false final false
 uint16_t GetAudioChannelCount(uint16_t audioTrackIdx) ;

/// @brief Method GetAudioSampleRate addr 0x2d6a02c size 0x44 virtual false final false
 uint32_t GetAudioSampleRate(uint16_t audioTrackIdx) ;

/// @brief Method GetAudioLanguage addr 0x2d6a070 size 0x44 virtual false final false
