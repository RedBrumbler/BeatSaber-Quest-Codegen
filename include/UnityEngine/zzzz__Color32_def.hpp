...
/// @brief Method .ctor addr 0x2b94cd4 size 0x14 virtual false final false
 void _ctor(uint8_t r, uint8_t g, uint8_t b, uint8_t a) ;

/// @brief Method op_Implicit addr 0x2b94ce8 size 0x2c4 virtual false final false
static UnityEngine::Color32 op_Implicit_UnityEngine__Color32(UnityEngine::Color c) ;

/// @brief Method op_Implicit addr 0x2b94fac size 0x3c virtual false final false
static UnityEngine::Color op_Implicit_UnityEngine__Color(UnityEngine::Color32 c) ;

/// @brief Method Lerp addr 0x2b94fe8 size 0xdc virtual false final false
static UnityEngine::Color32 Lerp(UnityEngine::Color32 a, UnityEngine::Color32 b, float_t t) ;

/// @brief Method ToString addr 0x2b950c4 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x2b950d0 size 0x1dc virtual true final true
