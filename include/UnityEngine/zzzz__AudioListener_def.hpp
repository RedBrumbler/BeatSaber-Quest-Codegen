...
/// @brief Method GetOutputDataHelper addr 0x2b579cc size 0x44 virtual false final false
static void GetOutputDataHelper(ByRef<::ArrayW<float_t>> samples, int32_t channel) ;

/// @brief Method GetSpectrumDataHelper addr 0x2b57a10 size 0x54 virtual false final false
static void GetSpectrumDataHelper(ByRef<::ArrayW<float_t>> samples, int32_t channel, UnityEngine::FFTWindow window) ;

/// @brief Method get_pause addr 0x2b57a64 size 0x28 virtual false final false
static bool get_pause() ;

/// @brief Method set_pause addr 0x2b57a8c size 0x3c virtual false final false
static void set_pause(bool value) ;

/// @brief Method GetOutputData addr 0x2b57ac8 size 0x44 virtual false final false
static void GetOutputData(::ArrayW<float_t> samples, int32_t channel) ;

/// @brief Method GetSpectrumData addr 0x2b57b0c size 0x54 virtual false final false
