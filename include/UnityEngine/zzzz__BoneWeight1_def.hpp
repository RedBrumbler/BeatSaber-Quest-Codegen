...
/// @brief Method get_weight addr 0x2b7f4b8 size 0x8 virtual false final false
 float_t get_weight() ;

/// @brief Method get_boneIndex addr 0x2b7f4c0 size 0x8 virtual false final false
 int32_t get_boneIndex() ;

/// @brief Method Equals addr 0x2b7f4c8 size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method Equals addr 0x2b7f540 size 0x5c virtual true final true
 bool Equals(UnityEngine::BoneWeight1 other) ;

/// @brief Method GetHashCode addr 0x2b7f59c size 0x48 virtual true final false
 int32_t GetHashCode() ;
