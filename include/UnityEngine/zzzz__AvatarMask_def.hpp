...
/// @brief Method GetHumanoidBodyPartActive addr 0x2b4c2c0 size 0x44 virtual false final false
 bool GetHumanoidBodyPartActive(UnityEngine::AvatarMaskBodyPart index) ;

/// @brief Method get_transformCount addr 0x2b4c304 size 0x3c virtual false final false
 int32_t get_transformCount() ;

/// @brief Method GetTransformPath addr 0x2b4c340 size 0x44 virtual false final false
 ::StringW GetTransformPath(int32_t index) ;

/// @brief Method GetTransformWeight addr 0x2b4c384 size 0x44 virtual false final false
 float_t GetTransformWeight(int32_t index) ;

/// @brief Method GetTransformActive addr 0x2b4c3c8 size 0x54 virtual false final false
