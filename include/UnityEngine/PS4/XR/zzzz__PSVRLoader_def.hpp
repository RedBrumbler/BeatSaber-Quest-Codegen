...
/// @brief Method get_displaySubsystem addr 0x2b393f0 size 0x70 virtual false final false
 UnityEngine::XR::XRDisplaySubsystem get_displaySubsystem() ;

/// @brief Method get_inputSubsystem addr 0x2b39460 size 0x70 virtual false final false
 UnityEngine::XR::XRInputSubsystem get_inputSubsystem() ;

/// @brief Method Initialize addr 0x2b394d0 size 0xd4 virtual true final false
 bool Initialize() ;

/// @brief Method Start addr 0x2b395a4 size 0x78 virtual true final false
 bool Start() ;

/// @brief Method Stop addr 0x2b3961c size 0x78 virtual true final false
 bool Stop() ;

/// @brief Method Deinitialize addr 0x2b39694 size 0x78 virtual true final false
 bool Deinitialize() ;

/// @brief Method DisableVRAndEnable2DReprojection addr 0x2b3970c size 0x98 virtual false final false
 bool DisableVRAndEnable2DReprojection() ;

/// @brief Method EnableVRAndDisable2DReprojection addr 0x2b397a4 size 0xc4 virtual false final false
 bool EnableVRAndDisable2DReprojection() ;

// Ctor Parameters []
explicit PSVRLoader() ;

/// @brief Method .ctor addr 0x2b39868 size 0x8 virtual false final false
 void _ctor() ;
