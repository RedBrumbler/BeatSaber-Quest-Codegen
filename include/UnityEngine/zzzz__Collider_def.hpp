...
/// @brief Method get_enabled addr 0x2bd1918 size 0x3c virtual false final false
 bool get_enabled() ;

/// @brief Method set_enabled addr 0x2bd1954 size 0x44 virtual false final false
 void set_enabled(bool value) ;

/// @brief Method get_attachedRigidbody addr 0x2bd1998 size 0x3c virtual false final false
 UnityEngine::Rigidbody get_attachedRigidbody() ;

/// @brief Method get_isTrigger addr 0x2bd19d4 size 0x3c virtual false final false
 bool get_isTrigger() ;

/// @brief Method set_isTrigger addr 0x2bd1a10 size 0x44 virtual false final false
 void set_isTrigger(bool value) ;

/// @brief Method get_bounds addr 0x2bd1a54 size 0x68 virtual false final false
 UnityEngine::Bounds get_bounds() ;

/// @brief Method Raycast addr 0x2bd1b00 size 0x94 virtual false final false
 UnityEngine::RaycastHit Raycast(UnityEngine::Ray ray, float_t maxDistance, ByRef<bool> hasHit) ;

/// @brief Method Raycast addr 0x2bd1c00 size 0xac virtual false final false
 bool Raycast(UnityEngine::Ray ray, ByRef<UnityEngine::RaycastHit> hitInfo, float_t maxDistance) ;

/// @brief Method Internal_ClosestPointOnBounds addr 0x2bd1cac size 0x6c virtual false final false
 void Internal_ClosestPointOnBounds(UnityEngine::Vector3 point, ByRef<UnityEngine::Vector3> outPos, ByRef<float_t> distance) ;

/// @brief Method ClosestPointOnBounds addr 0x2bd1d74 size 0xa4 virtual false final false
 UnityEngine::Vector3 ClosestPointOnBounds(UnityEngine::Vector3 position) ;

/// @brief Method get_bounds_Injected addr 0x2bd1abc size 0x44 virtual false final false
 void get_bounds_Injected(ByRef<UnityEngine::Bounds> ret) ;

/// @brief Method Raycast_Injected addr 0x2bd1b94 size 0x6c virtual false final false
 void Raycast_Injected(ByRef<UnityEngine::Ray> ray, float_t maxDistance, ByRef<bool> hasHit, ByRef<UnityEngine::RaycastHit> ret) ;

/// @brief Method Internal_ClosestPointOnBounds_Injected addr 0x2bd1d18 size 0x5c virtual false final false
