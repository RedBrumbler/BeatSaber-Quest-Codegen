...
/// @brief Method set_DoesNotContributeToSize addr 0x2bd39ac size 0xc virtual false final false
 void set_DoesNotContributeToSize(bool value) ;

// Ctor Parameters []
explicit IgnoreAttribute() ;

/// @brief Method .ctor addr 0x2bd39b8 size 0x8 virtual false final false
 void _ctor() ;
