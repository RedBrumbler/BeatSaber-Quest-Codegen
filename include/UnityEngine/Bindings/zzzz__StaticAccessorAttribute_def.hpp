...
/// @brief Method set_Name addr 0x2bd3918 size 0x8 virtual false final false
 void set_Name(::StringW value) ;

/// @brief Method set_Type addr 0x2bd3920 size 0x8 virtual false final false
 void set_Type(UnityEngine::Bindings::StaticAccessorType value) ;

// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }]
explicit StaticAccessorAttribute(::StringW name) ;

/// @brief Method .ctor addr 0x2bd3928 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x2bd3950 size 0x30 virtual false final false
