...
/// @brief Method .ctor addr 0x2bd388c size 0x20 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }]
explicit FreeFunctionAttribute(::StringW name) ;

/// @brief Method .ctor addr 0x2bd38ac size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0x2bd38c8 size 0x30 virtual false final false
