...
/// @brief Method set_Name addr 0x2bd3490 size 0x8 virtual true final true
 void set_Name(::StringW value) ;

/// @brief Method set_IsThreadSafe addr 0x2bd3498 size 0xc virtual true final true
 void set_IsThreadSafe(bool value) ;

/// @brief Method set_IsFreeFunction addr 0x2bd34a4 size 0xc virtual true final true
 void set_IsFreeFunction(bool value) ;

/// @brief Method set_ThrowsException addr 0x2bd34b0 size 0xc virtual true final true
 void set_ThrowsException(bool value) ;

/// @brief Method set_HasExplicitThis addr 0x2bd34bc size 0xc virtual true final true
 void set_HasExplicitThis(bool value) ;

// Ctor Parameters []
explicit NativeMethodAttribute() ;

/// @brief Method .ctor addr 0x2bd34c8 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }]
explicit NativeMethodAttribute(::StringW name) ;

/// @brief Method .ctor addr 0x2bd34d0 size 0x104 virtual false final false
...
/// @brief Method .ctor addr 0x2bd35d4 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x2bd35fc size 0x34 virtual false final false
