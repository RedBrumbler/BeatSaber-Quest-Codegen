...
/// @brief Method .ctor addr 0x2bcbd40 size 0x8 virtual false final false
 void _ctor(UnityEngine::ParticleSystem particleSystem) ;

/// @brief Method get_duration addr 0x2bcbf58 size 0x3c virtual false final false
 float_t get_duration() ;

/// @brief Method get_loop addr 0x2bcbfd0 size 0x3c virtual false final false
 bool get_loop() ;

/// @brief Method set_startLifetime addr 0x2bcc048 size 0x44 virtual false final false
 void set_startLifetime(UnityEngine::UnityEngine__ParticleSystem__MinMaxCurve value) ;

/// @brief Method set_startSpeed addr 0x2bcc0d0 size 0x44 virtual false final false
 void set_startSpeed(UnityEngine::UnityEngine__ParticleSystem__MinMaxCurve value) ;

/// @brief Method get_startSpeedMultiplier addr 0x2bcc158 size 0x3c virtual false final false
 float_t get_startSpeedMultiplier() ;

/// @brief Method set_startSpeedMultiplier addr 0x2bcc1d0 size 0x4c virtual false final false
 void set_startSpeedMultiplier(float_t value) ;

/// @brief Method get_startColor addr 0x2bcc268 size 0x78 virtual false final false
 UnityEngine::UnityEngine__ParticleSystem__MinMaxGradient get_startColor() ;

/// @brief Method set_startColor addr 0x2bcc324 size 0x44 virtual false final false
 void set_startColor(UnityEngine::UnityEngine__ParticleSystem__MinMaxGradient value) ;

/// @brief Method set_simulationSpeed addr 0x2bcc3ac size 0x4c virtual false final false
 void set_simulationSpeed(float_t value) ;

/// @brief Method get_maxParticles addr 0x2bcc444 size 0x3c virtual false final false
 int32_t get_maxParticles() ;

/// @brief Method set_maxParticles addr 0x2bcc4bc size 0x44 virtual false final false
 void set_maxParticles(int32_t value) ;

/// @brief Method get_duration_Injected addr 0x2bcbf94 size 0x3c virtual false final false
static float_t get_duration_Injected(ByRef<UnityEngine::UnityEngine__ParticleSystem__MainModule> _unity_self) ;

/// @brief Method get_loop_Injected addr 0x2bcc00c size 0x3c virtual false final false
static bool get_loop_Injected(ByRef<UnityEngine::UnityEngine__ParticleSystem__MainModule> _unity_self) ;

/// @brief Method set_startLifetime_Injected addr 0x2bcc08c size 0x44 virtual false final false
...
/// @brief Method set_startSpeed_Injected addr 0x2bcc114 size 0x44 virtual false final false
...
/// @brief Method get_startSpeedMultiplier_Injected addr 0x2bcc194 size 0x3c virtual false final false
static float_t get_startSpeedMultiplier_Injected(ByRef<UnityEngine::UnityEngine__ParticleSystem__MainModule> _unity_self) ;

/// @brief Method set_startSpeedMultiplier_Injected addr 0x2bcc21c size 0x4c virtual false final false
...
/// @brief Method get_startColor_Injected addr 0x2bcc2e0 size 0x44 virtual false final false
...
/// @brief Method set_startColor_Injected addr 0x2bcc368 size 0x44 virtual false final false
...
/// @brief Method set_simulationSpeed_Injected addr 0x2bcc3f8 size 0x4c virtual false final false
...
/// @brief Method get_maxParticles_Injected addr 0x2bcc480 size 0x3c virtual false final false
static int32_t get_maxParticles_Injected(ByRef<UnityEngine::UnityEngine__ParticleSystem__MainModule> _unity_self) ;

/// @brief Method set_maxParticles_Injected addr 0x2bcc500 size 0x44 virtual false final false
...
/// @brief Method .ctor addr 0x2bcbd4c size 0x8 virtual false final false
 void _ctor(UnityEngine::ParticleSystem particleSystem) ;

/// @brief Method get_enabled addr 0x2bcc544 size 0x3c virtual false final false
 bool get_enabled() ;

/// @brief Method set_enabled addr 0x2bcc5bc size 0x44 virtual false final false
 void set_enabled(bool value) ;

/// @brief Method get_enabled_Injected addr 0x2bcc580 size 0x3c virtual false final false
static bool get_enabled_Injected(ByRef<UnityEngine::UnityEngine__ParticleSystem__EmissionModule> _unity_self) ;

/// @brief Method set_enabled_Injected addr 0x2bcc600 size 0x44 virtual false final false
...
/// @brief Method .ctor addr 0x2bcbd58 size 0x8 virtual false final false
 void _ctor(UnityEngine::ParticleSystem particleSystem) ;

/// @brief Method get_meshRenderer addr 0x2bcc644 size 0x3c virtual false final false
 UnityEngine::MeshRenderer get_meshRenderer() ;

/// @brief Method set_meshRenderer addr 0x2bcc6bc size 0x44 virtual false final false
 void set_meshRenderer(UnityEngine::MeshRenderer value) ;

/// @brief Method set_rotation addr 0x2bcc744 size 0x54 virtual false final false
 void set_rotation(UnityEngine::Vector3 value) ;

/// @brief Method get_meshRenderer_Injected addr 0x2bcc680 size 0x3c virtual false final false
...
/// @brief Method set_meshRenderer_Injected addr 0x2bcc700 size 0x44 virtual false final false
...
/// @brief Method set_rotation_Injected addr 0x2bcc798 size 0x44 virtual false final false
...
/// @brief Method .ctor addr 0x2bcbd64 size 0x8 virtual false final false
 void _ctor(UnityEngine::ParticleSystem particleSystem) ;

/// @brief Method get_subEmittersCount addr 0x2bcc7dc size 0x3c virtual false final false
 int32_t get_subEmittersCount() ;

/// @brief Method GetSubEmitterSystem addr 0x2bcc854 size 0x44 virtual false final false
 UnityEngine::ParticleSystem GetSubEmitterSystem(int32_t index) ;

/// @brief Method get_subEmittersCount_Injected addr 0x2bcc818 size 0x3c virtual false final false
...
/// @brief Method GetSubEmitterSystem_Injected addr 0x2bcc898 size 0x44 virtual false final false
...
/// @brief Method .ctor addr 0x2bcc8dc size 0x14 virtual false final false
 void _ctor(float_t constant) ;

/// @brief Method .ctor addr 0x2bcc8f0 size 0x1c virtual false final false
 void _ctor(float_t min, float_t max) ;

/// @brief Method set_constantMax addr 0x2bcc90c size 0x8 virtual false final false
 void set_constantMax(float_t value) ;

/// @brief Method set_constantMin addr 0x2bcc914 size 0x8 virtual false final false
 void set_constantMin(float_t value) ;

/// @brief Method op_Implicit addr 0x2bcc91c size 0x14 virtual false final false
...
/// @brief Method .ctor addr 0x2bcc930 size 0x1c virtual false final false
 void _ctor(UnityEngine::Color color) ;

/// @brief Method get_color addr 0x2bcc94c size 0xc virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method op_Implicit addr 0x2bcc958 size 0x1c virtual false final false
...
/// @brief Method set_position addr 0x2bcbe70 size 0xc virtual false final false
 void set_position(UnityEngine::Vector3 value) ;

/// @brief Method set_velocity addr 0x2bcbe7c size 0xc virtual false final false
 void set_velocity(UnityEngine::Vector3 value) ;

/// @brief Method set_remainingLifetime addr 0x2bcc974 size 0x8 virtual false final false
 void set_remainingLifetime(float_t value) ;

/// @brief Method set_startLifetime addr 0x2bcbe90 size 0x8 virtual false final false
 void set_startLifetime(float_t value) ;

/// @brief Method set_startColor addr 0x2bcbefc size 0x8 virtual false final false
 void set_startColor(UnityEngine::Color32 value) ;

/// @brief Method set_randomSeed addr 0x2bcbf04 size 0x8 virtual false final false
 void set_randomSeed(uint32_t value) ;

/// @brief Method set_startSize addr 0x2bcbe98 size 0xc virtual false final false
 void set_startSize(float_t value) ;

/// @brief Method set_rotation3D addr 0x2bcbea4 size 0x2c virtual false final false
 void set_rotation3D(UnityEngine::Vector3 value) ;

/// @brief Method set_angularVelocity3D addr 0x2bcbed0 size 0x2c virtual false final false
 void set_angularVelocity3D(UnityEngine::Vector3 value) ;

/// @brief Method set_lifetime addr 0x2bcbe88 size 0x8 virtual false final false
...
/// @brief Method set_position addr 0x2bcc97c size 0x14 virtual false final false
 void set_position(UnityEngine::Vector3 value) ;

/// @brief Method set_applyShapeToPosition addr 0x2bcc990 size 0xc virtual false final false
 void set_applyShapeToPosition(bool value) ;

/// @brief Method set_rotation3D addr 0x2bcc99c size 0x34 virtual false final false
 void set_rotation3D(UnityEngine::Vector3 value) ;

/// @brief Method set_startColor addr 0x2bcc9d0 size 0x10 virtual false final false
 void set_startColor(UnityEngine::Color32 value) ;
...
/// @brief Method get_particleCount addr 0x2bcb5e4 size 0x3c virtual false final false
 int32_t get_particleCount() ;

/// @brief Method get_time addr 0x2bcb620 size 0x3c virtual false final false
 float_t get_time() ;

/// @brief Method set_randomSeed addr 0x2bcb65c size 0x44 virtual false final false
 void set_randomSeed(uint32_t value) ;

/// @brief Method get_useAutoRandomSeed addr 0x2bcb6a0 size 0x3c virtual false final false
 bool get_useAutoRandomSeed() ;

/// @brief Method set_useAutoRandomSeed addr 0x2bcb6dc size 0x44 virtual false final false
 void set_useAutoRandomSeed(bool value) ;

/// @brief Method SetParticles addr 0x2bcb720 size 0x5c virtual false final false
 void SetParticles(ByRef<::ArrayW<UnityEngine::UnityEngine__ParticleSystem__Particle>> particles, int32_t size, int32_t offset) ;

/// @brief Method SetParticles addr 0x2bcb77c size 0x58 virtual false final false
 void SetParticles(ByRef<::ArrayW<UnityEngine::UnityEngine__ParticleSystem__Particle>> particles, int32_t size) ;

/// @brief Method GetParticles addr 0x2bcb7d4 size 0x5c virtual false final false
...
/// @brief Method GetParticles addr 0x2bcb830 size 0x58 virtual false final false
 int32_t GetParticles(ByRef<::ArrayW<UnityEngine::UnityEngine__ParticleSystem__Particle>> particles, int32_t size) ;

/// @brief Method Simulate addr 0x2bcb888 size 0x6c virtual false final false
 void Simulate(float_t t, bool withChildren, bool restart, bool fixedTimeStep) ;

/// @brief Method Simulate addr 0x2bcb8f4 size 0x68 virtual false final false
 void Simulate(float_t t, bool withChildren, bool restart) ;

/// @brief Method Play addr 0x2bcb95c size 0x44 virtual false final false
 void Play(bool withChildren) ;

/// @brief Method Play addr 0x2bcb9a0 size 0x40 virtual false final false
 void Play() ;

/// @brief Method Pause addr 0x2bcb9e0 size 0x44 virtual false final false
 void Pause(bool withChildren) ;

/// @brief Method Pause addr 0x2bcba24 size 0x40 virtual false final false
 void Pause() ;

/// @brief Method Stop addr 0x2bcba64 size 0x54 virtual false final false
 void Stop(bool withChildren, UnityEngine::ParticleSystemStopBehavior stopBehavior) ;

/// @brief Method Stop addr 0x2bcbab8 size 0x48 virtual false final false
 void Stop(bool withChildren) ;

/// @brief Method Stop addr 0x2bcbb00 size 0x44 virtual false final false
 void Stop() ;

/// @brief Method Clear addr 0x2bcbb44 size 0x44 virtual false final false
 void Clear(bool withChildren) ;

/// @brief Method Clear addr 0x2bcbb88 size 0x40 virtual false final false
 void Clear() ;

/// @brief Method Emit addr 0x2bcbbc8 size 0x44 virtual false final false
 void Emit(int32_t count) ;

/// @brief Method Emit_Internal addr 0x2bcbc0c size 0x44 virtual false final false
 void Emit_Internal(int32_t count) ;

/// @brief Method Emit addr 0x2bcbc50 size 0x54 virtual false final false
 void Emit(UnityEngine::UnityEngine__ParticleSystem__EmitParams emitParams, int32_t count) ;

/// @brief Method EmitOld_Internal addr 0x2bcbcf8 size 0x44 virtual false final false
 void EmitOld_Internal(ByRef<UnityEngine::UnityEngine__ParticleSystem__Particle> particle) ;

/// @brief Method get_main addr 0x2bcbd3c size 0x4 virtual false final false
 UnityEngine::UnityEngine__ParticleSystem__MainModule get_main() ;

/// @brief Method get_emission addr 0x2bcbd48 size 0x4 virtual false final false
 UnityEngine::UnityEngine__ParticleSystem__EmissionModule get_emission() ;

/// @brief Method get_shape addr 0x2bcbd54 size 0x4 virtual false final false
 UnityEngine::UnityEngine__ParticleSystem__ShapeModule get_shape() ;

/// @brief Method get_subEmitters addr 0x2bcbd60 size 0x4 virtual false final false
 UnityEngine::UnityEngine__ParticleSystem__SubEmittersModule get_subEmitters() ;

/// @brief Method Emit addr 0x2bcbd6c size 0x104 virtual false final false
...
/// @brief Method Emit addr 0x2bcbf0c size 0x44 virtual false final false
 void Emit(UnityEngine::UnityEngine__ParticleSystem__Particle particle) ;

// Ctor Parameters []
explicit ParticleSystem() ;

/// @brief Method .ctor addr 0x2bcbf50 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Emit_Injected addr 0x2bcbca4 size 0x54 virtual false final false
