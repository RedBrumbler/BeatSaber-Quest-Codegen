...
/// @brief Method get_transform addr 0x2b8e948 size 0x3c virtual false final false
 UnityEngine::Transform get_transform() ;

/// @brief Method get_gameObject addr 0x2b8e984 size 0x3c virtual false final false
 UnityEngine::GameObject get_gameObject() ;

/// @brief Method GetComponent addr 0x2b8e9c0 size 0x78 virtual false final false
 UnityEngine::Component GetComponent(System::Type type) ;

/// @brief Method GetComponentFastPath addr 0x2b8ea38 size 0x54 virtual false final false
...
/// @brief Method GetComponent addr 0x2b8ea8c size 0x44 virtual false final false
 UnityEngine::Component GetComponent(::StringW type) ;

/// @brief Method GetComponentInChildren addr 0x2b8ead0 size 0x88 virtual false final false
...
/// @brief Method GetComponentsInChildren addr 0x2b8eb58 size 0x60 virtual false final false
...
/// @brief Method GetComponentInParent addr 0x2b8ebb8 size 0x88 virtual false final false
...
/// @brief Method GetComponentsInParent addr 0x2b8ec40 size 0x60 virtual false final false
...
/// @brief Method GetComponents addr 0x2b8eca0 size 0x50 virtual false final false
 ::ArrayW<UnityEngine::Component> GetComponents(System::Type type) ;

/// @brief Method GetComponentsForListInternal addr 0x2b8ecf0 size 0x54 virtual false final false
 void GetComponentsForListInternal(System::Type searchType, ::bs_hook::Il2CppWrapperType resultList) ;

/// @brief Method GetComponents addr 0x2b8ed44 size 0x54 virtual false final false
...
/// @brief Method get_tag addr 0x2b8ed98 size 0x70 virtual false final false
 ::StringW get_tag() ;

/// @brief Method set_tag addr 0x2b8ee08 size 0x78 virtual false final false
...
/// @brief Method CompareTag addr 0x2b8ee80 size 0x78 virtual false final false
 bool CompareTag(::StringW tag) ;

/// @brief Method SendMessage addr 0x2b8eef8 size 0x5c virtual false final false
 void SendMessage(::StringW methodName, ::bs_hook::Il2CppWrapperType value, UnityEngine::SendMessageOptions options) ;

/// @brief Method SendMessage addr 0x2b8ef54 size 0x58 virtual false final false
 void SendMessage(::StringW methodName, UnityEngine::SendMessageOptions options) ;

/// @brief Method BroadcastMessage addr 0x2b8efac size 0x5c virtual false final false
 void BroadcastMessage(::StringW methodName, ::bs_hook::Il2CppWrapperType parameter, UnityEngine::SendMessageOptions options) ;

// Ctor Parameters []
explicit Component() ;

/// @brief Method .ctor addr 0x2b880f8 size 0x58 virtual false final false
 void _ctor() ;
