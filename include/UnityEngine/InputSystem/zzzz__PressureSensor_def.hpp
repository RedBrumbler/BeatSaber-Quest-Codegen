...
/// @brief Method get_atmosphericPressure addr 0x29471e4 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_atmosphericPressure() ;

/// @brief Method set_atmosphericPressure addr 0x29471ec size 0x8 virtual false final false
 void set_atmosphericPressure(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_current addr 0x29471f4 size 0x48 virtual false final false
static UnityEngine::InputSystem::PressureSensor get_current() ;

/// @brief Method set_current addr 0x294723c size 0x4c virtual false final false
static void set_current(UnityEngine::InputSystem::PressureSensor value) ;

/// @brief Method MakeCurrent addr 0x2947288 size 0x54 virtual true final false
 void MakeCurrent() ;

/// @brief Method OnRemoved addr 0x29472dc size 0x84 virtual true final false
 void OnRemoved() ;

/// @brief Method FinishSetup addr 0x2947360 size 0x78 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit PressureSensor() ;

/// @brief Method .ctor addr 0x29473d8 size 0x8 virtual false final false
 void _ctor() ;
