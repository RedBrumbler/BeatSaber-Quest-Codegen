...
/// @brief Method get_gravity addr 0x29467f8 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector3Control get_gravity() ;

/// @brief Method set_gravity addr 0x2946800 size 0x8 virtual false final false
 void set_gravity(UnityEngine::InputSystem::Controls::Vector3Control value) ;

/// @brief Method get_current addr 0x2946808 size 0x48 virtual false final false
static UnityEngine::InputSystem::GravitySensor get_current() ;

/// @brief Method set_current addr 0x2946850 size 0x4c virtual false final false
static void set_current(UnityEngine::InputSystem::GravitySensor value) ;

/// @brief Method FinishSetup addr 0x294689c size 0x78 virtual true final false
 void FinishSetup() ;

/// @brief Method MakeCurrent addr 0x2946914 size 0x54 virtual true final false
 void MakeCurrent() ;

/// @brief Method OnRemoved addr 0x2946968 size 0x84 virtual true final false
 void OnRemoved() ;

// Ctor Parameters []
explicit GravitySensor() ;

/// @brief Method .ctor addr 0x29469ec size 0x8 virtual false final false
 void _ctor() ;
