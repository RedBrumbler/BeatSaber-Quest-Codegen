...
/// @brief Method get_leftHand addr 0x29631e4 size 0xa0 virtual false final false
static UnityEngine::InputSystem::XR::XRController get_leftHand() ;

/// @brief Method get_rightHand addr 0x2963284 size 0xa0 virtual false final false
static UnityEngine::InputSystem::XR::XRController get_rightHand() ;

/// @brief Method FinishSetup addr 0x2963324 size 0xf0 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit XRController() ;

/// @brief Method .ctor addr 0x296345c size 0x8 virtual false final false
 void _ctor() ;
