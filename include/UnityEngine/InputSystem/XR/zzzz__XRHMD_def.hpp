...
namespace UnityEngine::InputSystem::XR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6391))}
...
/// @brief Method get_leftEyePosition addr 0x296300c size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector3Control get_leftEyePosition() ;

/// @brief Method set_leftEyePosition addr 0x2963014 size 0x8 virtual false final false
 void set_leftEyePosition(UnityEngine::InputSystem::Controls::Vector3Control value) ;

/// @brief Method get_leftEyeRotation addr 0x296301c size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::QuaternionControl get_leftEyeRotation() ;

/// @brief Method set_leftEyeRotation addr 0x2963024 size 0x8 virtual false final false
 void set_leftEyeRotation(UnityEngine::InputSystem::Controls::QuaternionControl value) ;

/// @brief Method get_rightEyePosition addr 0x296302c size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector3Control get_rightEyePosition() ;

/// @brief Method set_rightEyePosition addr 0x2963034 size 0x8 virtual false final false
 void set_rightEyePosition(UnityEngine::InputSystem::Controls::Vector3Control value) ;

/// @brief Method get_rightEyeRotation addr 0x296303c size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::QuaternionControl get_rightEyeRotation() ;

/// @brief Method set_rightEyeRotation addr 0x2963044 size 0x8 virtual false final false
 void set_rightEyeRotation(UnityEngine::InputSystem::Controls::QuaternionControl value) ;

/// @brief Method get_centerEyePosition addr 0x296304c size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector3Control get_centerEyePosition() ;

/// @brief Method set_centerEyePosition addr 0x2963054 size 0x8 virtual false final false
 void set_centerEyePosition(UnityEngine::InputSystem::Controls::Vector3Control value) ;

/// @brief Method get_centerEyeRotation addr 0x296305c size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::QuaternionControl get_centerEyeRotation() ;

/// @brief Method set_centerEyeRotation addr 0x2963064 size 0x8 virtual false final false
 void set_centerEyeRotation(UnityEngine::InputSystem::Controls::QuaternionControl value) ;

/// @brief Method FinishSetup addr 0x296306c size 0x170 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit XRHMD() ;

/// @brief Method .ctor addr 0x29631dc size 0x8 virtual false final false
 void _ctor() ;
