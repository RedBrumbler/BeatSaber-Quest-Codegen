...
/// @brief Method .ctor addr 0x29670d0 size 0xc virtual false final false
 void _ctor(uint32_t numChannels, uint32_t frequencyHz, uint32_t maxBufferSize) ;

/// @brief Method get_numChannels addr 0x29670dc size 0x8 virtual false final false
 uint32_t get_numChannels() ;

/// @brief Method set_numChannels addr 0x29670e4 size 0x8 virtual false final false
 void set_numChannels(uint32_t value) ;

/// @brief Method get_frequencyHz addr 0x29670ec size 0x8 virtual false final false
 uint32_t get_frequencyHz() ;

/// @brief Method set_frequencyHz addr 0x29670f4 size 0x8 virtual false final false
 void set_frequencyHz(uint32_t value) ;

/// @brief Method get_maxBufferSize addr 0x29670fc size 0x8 virtual false final false
 uint32_t get_maxBufferSize() ;

/// @brief Method set_maxBufferSize addr 0x2967104 size 0x8 virtual false final false
