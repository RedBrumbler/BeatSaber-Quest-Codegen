...
/// @brief Method get_capabilities addr 0x2966c58 size 0x10 virtual false final false
 UnityEngine::InputSystem::XR::Haptics::HapticCapabilities get_capabilities() ;

/// @brief Method set_capabilities addr 0x2966c68 size 0xc virtual false final false
 void set_capabilities(UnityEngine::InputSystem::XR::Haptics::HapticCapabilities value) ;

/// @brief Method get_device addr 0x2966c74 size 0x8 virtual false final false
 UnityEngine::InputSystem::InputDevice get_device() ;

/// @brief Method set_device addr 0x2966c7c size 0x8 virtual false final false
 void set_device(UnityEngine::InputSystem::InputDevice value) ;

/// @brief Method .ctor addr 0x2966c84 size 0xf8 virtual false final false
 void _ctor(UnityEngine::InputSystem::InputDevice device) ;

/// @brief Method EnqueueRumble addr 0x2966de4 size 0xa8 virtual false final false
