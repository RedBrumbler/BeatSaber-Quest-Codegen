...
/// @brief Method .ctor addr 0x2966ff0 size 0x8 virtual false final false
 void _ctor(uint32_t samplesQueued, uint32_t samplesAvailable) ;

/// @brief Method get_samplesQueued addr 0x2966ff8 size 0x8 virtual false final false
 uint32_t get_samplesQueued() ;

/// @brief Method set_samplesQueued addr 0x2967000 size 0x8 virtual false final false
 void set_samplesQueued(uint32_t value) ;

/// @brief Method get_samplesAvailable addr 0x2967008 size 0x8 virtual false final false
 uint32_t get_samplesAvailable() ;

/// @brief Method set_samplesAvailable addr 0x2967010 size 0x8 virtual false final false
