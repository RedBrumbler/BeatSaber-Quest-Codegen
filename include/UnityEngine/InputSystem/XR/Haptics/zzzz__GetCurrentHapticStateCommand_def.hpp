...
/// @brief Method get_Type addr 0x2967018 size 0x30 virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method get_typeStatic addr 0x2967048 size 0x30 virtual true final true
 UnityEngine::InputSystem::Utilities::FourCC get_typeStatic() ;

/// @brief Method get_currentState addr 0x2967078 size 0x8 virtual false final false
 UnityEngine::InputSystem::XR::Haptics::HapticState get_currentState() ;

/// @brief Method Create addr 0x2967080 size 0x50 virtual false final false
