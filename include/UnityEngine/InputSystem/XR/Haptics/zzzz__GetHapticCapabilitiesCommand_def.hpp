...
/// @brief Method get_Type addr 0x296710c size 0x30 virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method get_typeStatic addr 0x296713c size 0x30 virtual true final true
 UnityEngine::InputSystem::Utilities::FourCC get_typeStatic() ;

/// @brief Method get_capabilities addr 0x2966dd8 size 0xc virtual false final false
 UnityEngine::InputSystem::XR::Haptics::HapticCapabilities get_capabilities() ;

/// @brief Method Create addr 0x2966d7c size 0x5c virtual false final false
