...
/// @brief Method get_parentBoneIndex addr 0x2965b64 size 0x8 virtual false final false
 uint32_t get_parentBoneIndex() ;

/// @brief Method set_parentBoneIndex addr 0x2965b6c size 0x8 virtual false final false
 void set_parentBoneIndex(uint32_t value) ;

/// @brief Method get_position addr 0x2965b74 size 0xc virtual false final false
 UnityEngine::Vector3 get_position() ;

/// @brief Method set_position addr 0x2965b80 size 0xc virtual false final false
 void set_position(UnityEngine::Vector3 value) ;

/// @brief Method get_rotation addr 0x2965b8c size 0xc virtual false final false
 UnityEngine::Quaternion get_rotation() ;

/// @brief Method set_rotation addr 0x2965b98 size 0xc virtual false final false
