...
/// @brief Method get_leftEyePosition addr 0x2965ba4 size 0xc virtual false final false
 UnityEngine::Vector3 get_leftEyePosition() ;

/// @brief Method set_leftEyePosition addr 0x2965bb0 size 0xc virtual false final false
 void set_leftEyePosition(UnityEngine::Vector3 value) ;

/// @brief Method get_leftEyeRotation addr 0x2965bbc size 0xc virtual false final false
 UnityEngine::Quaternion get_leftEyeRotation() ;

/// @brief Method set_leftEyeRotation addr 0x2965bc8 size 0xc virtual false final false
 void set_leftEyeRotation(UnityEngine::Quaternion value) ;

/// @brief Method get_rightEyePosition addr 0x2965bd4 size 0xc virtual false final false
 UnityEngine::Vector3 get_rightEyePosition() ;

/// @brief Method set_rightEyePosition addr 0x2965be0 size 0xc virtual false final false
 void set_rightEyePosition(UnityEngine::Vector3 value) ;

/// @brief Method get_rightEyeRotation addr 0x2965bec size 0xc virtual false final false
 UnityEngine::Quaternion get_rightEyeRotation() ;

/// @brief Method set_rightEyeRotation addr 0x2965bf8 size 0xc virtual false final false
 void set_rightEyeRotation(UnityEngine::Quaternion value) ;

/// @brief Method get_fixationPoint addr 0x2965c04 size 0xc virtual false final false
 UnityEngine::Vector3 get_fixationPoint() ;

/// @brief Method set_fixationPoint addr 0x2965c10 size 0xc virtual false final false
 void set_fixationPoint(UnityEngine::Vector3 value) ;

/// @brief Method get_leftEyeOpenAmount addr 0x2965c1c size 0x8 virtual false final false
 float_t get_leftEyeOpenAmount() ;

/// @brief Method set_leftEyeOpenAmount addr 0x2965c24 size 0x8 virtual false final false
 void set_leftEyeOpenAmount(float_t value) ;

/// @brief Method get_rightEyeOpenAmount addr 0x2965c2c size 0x8 virtual false final false
 float_t get_rightEyeOpenAmount() ;

/// @brief Method set_rightEyeOpenAmount addr 0x2965c34 size 0x8 virtual false final false
