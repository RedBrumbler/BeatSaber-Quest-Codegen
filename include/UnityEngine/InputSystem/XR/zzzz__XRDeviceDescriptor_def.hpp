...
/// @brief Method ToJson addr 0x2965b54 size 0x8 virtual false final false
 ::StringW ToJson() ;

/// @brief Method FromJson addr 0x2963414 size 0x48 virtual false final false
static UnityEngine::InputSystem::XR::XRDeviceDescriptor FromJson(::StringW json) ;

// Ctor Parameters []
explicit XRDeviceDescriptor() ;

/// @brief Method .ctor addr 0x2965b5c size 0x8 virtual false final false
 void _ctor() ;
