...
/// @brief Method .ctor addr 0x2964ab4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <OnFindLayoutForDevice>b__0 addr 0x2965b3c size 0x18 virtual false final false
...
/// @brief Method GetSizeOfFeature addr 0x2964488 size 0x78 virtual false final false
static uint32_t GetSizeOfFeature(UnityEngine::InputSystem::XR::XRFeatureDescriptor featureDescriptor) ;

/// @brief Method SanitizeString addr 0x2964500 size 0x160 virtual false final false
static ::StringW SanitizeString(::StringW original, bool allowPaths) ;

/// @brief Method OnFindLayoutForDevice addr 0x2964660 size 0x454 virtual false final false
...
/// @brief Method ConvertPotentialAliasToName addr 0x2964ac4 size 0x17c virtual false final false
static ::StringW ConvertPotentialAliasToName(UnityEngine::InputSystem::Layouts::InputControlLayout layout, ::StringW nameOrAlias) ;

/// @brief Method IsSubControl addr 0x2964c40 size 0x1c virtual false final false
 bool IsSubControl(::StringW name) ;

/// @brief Method GetParentControlName addr 0x2964c5c size 0x38 virtual false final false
 ::StringW GetParentControlName(::StringW name) ;

/// @brief Method IsPoseControl addr 0x2964c94 size 0x154 virtual false final false
...
/// @brief Method Build addr 0x2964de8 size 0xb04 virtual false final false
 UnityEngine::InputSystem::Layouts::InputControlLayout Build() ;

// Ctor Parameters []
explicit XRLayoutBuilder() ;

/// @brief Method .ctor addr 0x2964abc size 0x8 virtual false final false
 void _ctor() ;
