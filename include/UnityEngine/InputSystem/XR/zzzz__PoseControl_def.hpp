...
namespace UnityEngine::InputSystem::XR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6318)), TypeDefinitionIndex(TypeDefinitionIndex(6424)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6318), inst: 3762 })}
...
/// @brief Method get_isTracked addr 0x2962b00 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_isTracked() ;

/// @brief Method set_isTracked addr 0x2962b08 size 0x8 virtual false final false
 void set_isTracked(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_trackingState addr 0x2962b10 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::IntegerControl get_trackingState() ;

/// @brief Method set_trackingState addr 0x2962b18 size 0x8 virtual false final false
 void set_trackingState(UnityEngine::InputSystem::Controls::IntegerControl value) ;

/// @brief Method get_position addr 0x2962b20 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector3Control get_position() ;

/// @brief Method set_position addr 0x2962b28 size 0x8 virtual false final false
 void set_position(UnityEngine::InputSystem::Controls::Vector3Control value) ;

/// @brief Method get_rotation addr 0x2962b30 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::QuaternionControl get_rotation() ;

/// @brief Method set_rotation addr 0x2962b38 size 0x8 virtual false final false
 void set_rotation(UnityEngine::InputSystem::Controls::QuaternionControl value) ;

/// @brief Method get_velocity addr 0x2962b40 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector3Control get_velocity() ;

/// @brief Method set_velocity addr 0x2962b48 size 0x8 virtual false final false
 void set_velocity(UnityEngine::InputSystem::Controls::Vector3Control value) ;

/// @brief Method get_angularVelocity addr 0x2962b50 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector3Control get_angularVelocity() ;

/// @brief Method set_angularVelocity addr 0x2962b58 size 0x8 virtual false final false
 void set_angularVelocity(UnityEngine::InputSystem::Controls::Vector3Control value) ;

// Ctor Parameters []
explicit PoseControl() ;

/// @brief Method .ctor addr 0x2962b60 size 0x7c virtual false final false
 void _ctor() ;

/// @brief Method FinishSetup addr 0x2962bdc size 0x194 virtual true final false
 void FinishSetup() ;

/// @brief Method ReadUnprocessedValueFromState addr 0x2962d70 size 0x174 virtual true final false
 UnityEngine::InputSystem::XR::PoseState ReadUnprocessedValueFromState(void* statePtr) ;

/// @brief Method WriteValueIntoState addr 0x2962ee4 size 0x128 virtual true final false
