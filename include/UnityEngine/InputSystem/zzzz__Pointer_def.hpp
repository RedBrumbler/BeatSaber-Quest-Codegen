...
/// @brief Method get_position addr 0x290f220 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector2Control get_position() ;

/// @brief Method set_position addr 0x290f228 size 0x8 virtual false final false
 void set_position(UnityEngine::InputSystem::Controls::Vector2Control value) ;

/// @brief Method get_delta addr 0x290f230 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::DeltaControl get_delta() ;

/// @brief Method set_delta addr 0x290f238 size 0x8 virtual false final false
 void set_delta(UnityEngine::InputSystem::Controls::DeltaControl value) ;

/// @brief Method get_radius addr 0x290f240 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector2Control get_radius() ;

/// @brief Method set_radius addr 0x290f248 size 0x8 virtual false final false
 void set_radius(UnityEngine::InputSystem::Controls::Vector2Control value) ;

/// @brief Method get_pressure addr 0x290f250 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_pressure() ;

/// @brief Method set_pressure addr 0x290f258 size 0x8 virtual false final false
 void set_pressure(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_press addr 0x290f260 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_press() ;

/// @brief Method set_press addr 0x290f268 size 0x8 virtual false final false
 void set_press(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_current addr 0x290f270 size 0x48 virtual false final false
static UnityEngine::InputSystem::Pointer get_current() ;

/// @brief Method set_current addr 0x290f2b8 size 0x4c virtual false final false
static void set_current(UnityEngine::InputSystem::Pointer value) ;

/// @brief Method MakeCurrent addr 0x290e58c size 0x4c virtual true final false
 void MakeCurrent() ;

/// @brief Method OnRemoved addr 0x290e6b4 size 0x7c virtual true final false
 void OnRemoved() ;

/// @brief Method FinishSetup addr 0x290e978 size 0x164 virtual true final false
 void FinishSetup() ;

/// @brief Method OnNextUpdate addr 0x290eb6c size 0x88 virtual false final false
 void OnNextUpdate() ;

/// @brief Method OnStateEvent addr 0x290ec38 size 0x4c virtual false final false
 void OnStateEvent(UnityEngine::InputSystem::LowLevel::InputEventPtr eventPtr) ;

/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.OnNextUpdate addr 0x290f304 size 0x4 virtual true final true
 void UnityEngine_InputSystem_LowLevel_IInputStateCallbackReceiver_OnNextUpdate() ;

/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.OnStateEvent addr 0x290f308 size 0x4 virtual true final true
...
/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateCallbackReceiver.GetStateOffsetForEvent addr 0x290f30c size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0x290ecb8 size 0x2c virtual false final false
 void _ctor() ;
