...
/// @brief Method SetLength addr 0x2954644 size 0x74 virtual false final false
 void SetLength(int32_t newLength) ;

/// @brief Method SetBit addr 0x2962980 size 0x98 virtual false final false
 void SetBit(int32_t bitIndex) ;

/// @brief Method TestBit addr 0x2962a18 size 0x78 virtual false final false
 bool TestBit(int32_t bitIndex) ;

/// @brief Method ClearBit addr 0x295476c size 0x98 virtual false final false
 void ClearBit(int32_t bitIndex) ;

/// @brief Method BitCountToULongCount addr 0x2962968 size 0x18 virtual false final false
