...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6317))}
...
/// @brief Method get_description addr 0x290a810 size 0x24 virtual false final false
 UnityEngine::InputSystem::Layouts::InputDeviceDescription get_description() ;

/// @brief Method get_enabled addr 0x290a834 size 0x1c virtual false final false
 bool get_enabled() ;

/// @brief Method get_canRunInBackground addr 0x290a8f8 size 0xb8 virtual false final false
 bool get_canRunInBackground() ;

/// @brief Method get_added addr 0x28ffbe8 size 0x10 virtual false final false
 bool get_added() ;

/// @brief Method get_remote addr 0x290a9b0 size 0xc virtual false final false
 bool get_remote() ;

/// @brief Method get_native addr 0x290a9bc size 0xc virtual false final false
 bool get_native() ;

/// @brief Method get_updateBeforeRender addr 0x290a9c8 size 0xc virtual false final false
 bool get_updateBeforeRender() ;

/// @brief Method get_deviceId addr 0x290a9d4 size 0x8 virtual false final false
 int32_t get_deviceId() ;

/// @brief Method get_lastUpdateTime addr 0x290a9dc size 0x54 virtual false final false
 double_t get_lastUpdateTime() ;

/// @brief Method get_wasUpdatedThisFrame addr 0x290aa30 size 0x58 virtual false final false
 bool get_wasUpdatedThisFrame() ;

/// @brief Method get_allControls addr 0x290aa88 size 0x60 virtual false final false
 UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<UnityEngine::InputSystem::InputControl> get_allControls() ;

/// @brief Method get_valueType addr 0x290aae8 size 0x6c virtual true final false
 System::Type get_valueType() ;

/// @brief Method get_valueSizeInBytes addr 0x290ab54 size 0xc virtual true final false
 int32_t get_valueSizeInBytes() ;

/// @brief Method get_all addr 0x290ab60 size 0x4c virtual false final false
static UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<UnityEngine::InputSystem::InputDevice> get_all() ;

// Ctor Parameters []
explicit InputDevice() ;

/// @brief Method .ctor addr 0x290a7e4 size 0x2c virtual false final false
 void _ctor() ;

/// @brief Method ReadValueFromBufferAsObject addr 0x290abac size 0x40 virtual true final false
 ::bs_hook::Il2CppWrapperType ReadValueFromBufferAsObject(void* buffer, int32_t bufferSize) ;

/// @brief Method ReadValueFromStateAsObject addr 0x290abec size 0xc8 virtual true final false
 ::bs_hook::Il2CppWrapperType ReadValueFromStateAsObject(void* statePtr) ;

/// @brief Method ReadValueFromStateIntoBuffer addr 0x290acb4 size 0x184 virtual true final false
 void ReadValueFromStateIntoBuffer(void* statePtr, void* bufferPtr, int32_t bufferSize) ;

/// @brief Method CompareValue addr 0x290ae38 size 0xb4 virtual true final false
 bool CompareValue(void* firstStatePtr, void* secondStatePtr) ;

/// @brief Method NotifyConfigurationChanged addr 0x290aeec size 0x7c virtual false final false
 void NotifyConfigurationChanged() ;

/// @brief Method MakeCurrent addr 0x290a5e4 size 0x4 virtual true final false
 void MakeCurrent() ;

/// @brief Method OnAdded addr 0x290af68 size 0x4 virtual true final false
 void OnAdded() ;

/// @brief Method OnRemoved addr 0x290af6c size 0x4 virtual true final false
 void OnRemoved() ;

/// @brief Method OnConfigurationChanged addr 0x290af70 size 0x4 virtual true final false
...
/// @brief Method ExecuteCommand addr 0x290af74 size 0xd8 virtual true final false
 int64_t ExecuteCommand(void* commandPtr) ;

/// @brief Method QueryEnabledStateFromRuntime addr 0x290a850 size 0xa8 virtual false final false
 bool QueryEnabledStateFromRuntime() ;

/// @brief Method get_disabledInFrontend addr 0x290b04c size 0xc virtual false final false
 bool get_disabledInFrontend() ;

/// @brief Method set_disabledInFrontend addr 0x290b058 size 0x1c virtual false final false
 void set_disabledInFrontend(bool value) ;

/// @brief Method get_disabledInRuntime addr 0x290b074 size 0xc virtual false final false
 bool get_disabledInRuntime() ;

/// @brief Method set_disabledInRuntime addr 0x290b080 size 0x1c virtual false final false
 void set_disabledInRuntime(bool value) ;

/// @brief Method get_disabledWhileInBackground addr 0x290b09c size 0xc virtual false final false
 bool get_disabledWhileInBackground() ;

/// @brief Method set_disabledWhileInBackground addr 0x290b0a8 size 0x1c virtual false final false
 void set_disabledWhileInBackground(bool value) ;

/// @brief Method EncodeStateOffsetToControlMapEntry addr 0x290b0c4 size 0xc virtual false final false
...
/// @brief Method DecodeStateOffsetToControlMapEntry addr 0x29065d4 size 0x1c virtual false final false
...
/// @brief Method get_hasControlsWithDefaultState addr 0x290b0d0 size 0xc virtual false final false
 bool get_hasControlsWithDefaultState() ;

/// @brief Method set_hasControlsWithDefaultState addr 0x2906884 size 0x1c virtual false final false
 void set_hasControlsWithDefaultState(bool value) ;

/// @brief Method get_hasDontResetControls addr 0x290b0dc size 0xc virtual false final false
 bool get_hasDontResetControls() ;

/// @brief Method set_hasDontResetControls addr 0x2906974 size 0x1c virtual false final false
 void set_hasDontResetControls(bool value) ;

/// @brief Method get_hasStateCallbacks addr 0x2904e38 size 0xc virtual false final false
 bool get_hasStateCallbacks() ;

/// @brief Method set_hasStateCallbacks addr 0x290b0e8 size 0x1c virtual false final false
 void set_hasStateCallbacks(bool value) ;

/// @brief Method get_hasEventMerger addr 0x290b104 size 0xc virtual false final false
 bool get_hasEventMerger() ;

/// @brief Method set_hasEventMerger addr 0x290b110 size 0x1c virtual false final false
 void set_hasEventMerger(bool value) ;

/// @brief Method get_hasEventPreProcessor addr 0x290b12c size 0xc virtual false final false
 bool get_hasEventPreProcessor() ;

/// @brief Method set_hasEventPreProcessor addr 0x290b138 size 0x1c virtual false final false
 void set_hasEventPreProcessor(bool value) ;

/// @brief Method AddDeviceUsage addr 0x290b154 size 0xb4 virtual false final false
 void AddDeviceUsage(UnityEngine::InputSystem::Utilities::InternedString usage) ;

/// @brief Method RemoveDeviceUsage addr 0x290b208 size 0xdc virtual false final false
 void RemoveDeviceUsage(UnityEngine::InputSystem::Utilities::InternedString usage) ;

/// @brief Method ClearDeviceUsages addr 0x290b2e4 size 0x60 virtual false final false
 void ClearDeviceUsages() ;

/// @brief Method RequestSync addr 0x28ffbf8 size 0x6c virtual false final false
 bool RequestSync() ;

/// @brief Method RequestReset addr 0x28ffd3c size 0x6c virtual false final false
 bool RequestReset() ;

/// @brief Method ExecuteEnableCommand addr 0x290b344 size 0x6c virtual false final false
 bool ExecuteEnableCommand() ;

/// @brief Method ExecuteDisableCommand addr 0x290b3b0 size 0x6c virtual false final false
 bool ExecuteDisableCommand() ;

/// @brief Method NotifyAdded addr 0x290b41c size 0x10 virtual false final false
 void NotifyAdded() ;

/// @brief Method NotifyRemoved addr 0x290b42c size 0x10 virtual false final false
 void NotifyRemoved() ;
