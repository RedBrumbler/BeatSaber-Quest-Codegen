...
/// @brief Method get_tapTimeOrDefault addr 0x29a7f04 size 0x70 virtual false final false
 float_t get_tapTimeOrDefault() ;

/// @brief Method get_tapDelayOrDefault addr 0x29a7f74 size 0x70 virtual false final false
 float_t get_tapDelayOrDefault() ;

/// @brief Method get_pressPointOrDefault addr 0x29a7fe4 size 0x58 virtual false final false
 float_t get_pressPointOrDefault() ;

/// @brief Method get_releasePointOrDefault addr 0x29a803c size 0x88 virtual false final false
 float_t get_releasePointOrDefault() ;

/// @brief Method Process addr 0x29a80c4 size 0x280 virtual true final true
 void Process(ByRef<UnityEngine::InputSystem::InputInteractionContext> context) ;

/// @brief Method Reset addr 0x29a8344 size 0xc virtual true final true
 void Reset() ;

// Ctor Parameters []
explicit MultiTapInteraction() ;

/// @brief Method .ctor addr 0x29a8350 size 0x10 virtual false final false
 void _ctor() ;
