...
/// @brief Method get_durationOrDefault addr 0x29a8a54 size 0x70 virtual false final false
 float_t get_durationOrDefault() ;

/// @brief Method get_pressPointOrDefault addr 0x29a8ac4 size 0x58 virtual false final false
 float_t get_pressPointOrDefault() ;

/// @brief Method get_releasePointOrDefault addr 0x29a8b1c size 0x88 virtual false final false
 float_t get_releasePointOrDefault() ;

/// @brief Method Process addr 0x29a8ba4 size 0x160 virtual true final true
 void Process(ByRef<UnityEngine::InputSystem::InputInteractionContext> context) ;

/// @brief Method Reset addr 0x29a8d04 size 0x8 virtual true final true
 void Reset() ;

// Ctor Parameters []
explicit TapInteraction() ;

/// @brief Method .ctor addr 0x29a8d0c size 0x8 virtual false final false
 void _ctor() ;
