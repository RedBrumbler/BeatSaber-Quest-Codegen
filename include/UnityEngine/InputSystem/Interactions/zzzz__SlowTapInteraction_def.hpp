...
/// @brief Method get_durationOrDefault addr 0x29a8814 size 0x70 virtual false final false
 float_t get_durationOrDefault() ;

/// @brief Method get_pressPointOrDefault addr 0x29a8884 size 0x58 virtual false final false
 float_t get_pressPointOrDefault() ;

/// @brief Method Process addr 0x29a88dc size 0x168 virtual true final true
 void Process(ByRef<UnityEngine::InputSystem::InputInteractionContext> context) ;

/// @brief Method Reset addr 0x29a8a44 size 0x8 virtual true final true
 void Reset() ;

// Ctor Parameters []
explicit SlowTapInteraction() ;

/// @brief Method .ctor addr 0x29a8a4c size 0x8 virtual false final false
 void _ctor() ;
