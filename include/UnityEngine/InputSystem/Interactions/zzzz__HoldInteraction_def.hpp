...
/// @brief Method get_durationOrDefault addr 0x29a7c88 size 0x70 virtual false final false
 float_t get_durationOrDefault() ;

/// @brief Method get_pressPointOrDefault addr 0x29a7cf8 size 0x58 virtual false final false
 float_t get_pressPointOrDefault() ;

/// @brief Method Process addr 0x29a7d50 size 0x1a4 virtual true final true
 void Process(ByRef<UnityEngine::InputSystem::InputInteractionContext> context) ;

/// @brief Method Reset addr 0x29a7ef4 size 0x8 virtual true final true
 void Reset() ;

// Ctor Parameters []
explicit HoldInteraction() ;

/// @brief Method .ctor addr 0x29a7efc size 0x8 virtual false final false
 void _ctor() ;
