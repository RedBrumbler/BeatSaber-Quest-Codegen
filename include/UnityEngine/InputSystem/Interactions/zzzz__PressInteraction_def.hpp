...
/// @brief Method get_pressPointOrDefault addr 0x29a8360 size 0x58 virtual false final false
 float_t get_pressPointOrDefault() ;

/// @brief Method get_releasePointOrDefault addr 0x29a83b8 size 0x88 virtual false final false
 float_t get_releasePointOrDefault() ;

/// @brief Method Process addr 0x29a8440 size 0x3c4 virtual true final true
 void Process(ByRef<UnityEngine::InputSystem::InputInteractionContext> context) ;

/// @brief Method Reset addr 0x29a8804 size 0x8 virtual true final true
 void Reset() ;

// Ctor Parameters []
explicit PressInteraction() ;

/// @brief Method .ctor addr 0x29a880c size 0x8 virtual false final false
 void _ctor() ;
