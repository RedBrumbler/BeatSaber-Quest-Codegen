...
/// @brief Method get_valueType addr 0x28fbfac size 0x8 virtual true final false
 System::Type get_valueType() ;

/// @brief Method get_valueSizeInBytes addr 0x28fbfb4 size 0x8 virtual true final false
 int32_t get_valueSizeInBytes() ;

/// @brief Method EvaluateMagnitude addr 0x28fbfbc size 0x40 virtual true final false
 float_t EvaluateMagnitude(ByRef<UnityEngine::InputSystem::InputBindingCompositeContext> context) ;

/// @brief Method ReadValue addr 0x28fc0b8 size 0x64 virtual true final false
 void ReadValue(ByRef<UnityEngine::InputSystem::InputBindingCompositeContext> context, void* buffer, int32_t bufferSize) ;

/// @brief Method ModifiersArePressed addr 0x28fbffc size 0xbc virtual false final false
 bool ModifiersArePressed(ByRef<UnityEngine::InputSystem::InputBindingCompositeContext> context) ;

/// @brief Method FinishSetup addr 0x28fc11c size 0xac virtual true final false
 void FinishSetup(ByRef<UnityEngine::InputSystem::InputBindingCompositeContext> context) ;

/// @brief Method ReadValueAsObject addr 0x28fc1c8 size 0x64 virtual true final false
...
/// @brief Method .ctor addr 0x28fc22c size 0x8 virtual false final false
 void _ctor() ;
