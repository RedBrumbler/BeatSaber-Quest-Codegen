...
namespace UnityEngine::InputSystem::Composites {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10203)), TypeDefinitionIndex(TypeDefinitionIndex(6292)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6292), inst: 393 })}
...
/// @brief Method ReadValue addr 0x28fc234 size 0x164 virtual true final false
 UnityEngine::Vector2 ReadValue(ByRef<UnityEngine::InputSystem::InputBindingCompositeContext> context) ;

/// @brief Method EvaluateMagnitude addr 0x28fc398 size 0x70 virtual true final false
 float_t EvaluateMagnitude(ByRef<UnityEngine::InputSystem::InputBindingCompositeContext> context) ;

// Ctor Parameters []
explicit Vector2Composite() ;

/// @brief Method .ctor addr 0x28fc408 size 0x50 virtual false final false
 void _ctor() ;
