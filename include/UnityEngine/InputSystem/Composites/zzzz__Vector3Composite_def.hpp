...
namespace UnityEngine::InputSystem::Composites {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6292)), TypeDefinitionIndex(TypeDefinitionIndex(10209)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6292), inst: 394 })}
...
/// @brief Method ReadValue addr 0x28fc458 size 0x254 virtual true final false
...
/// @brief Method .ctor addr 0x28fc6ac size 0x48 virtual false final false
 void _ctor() ;
