...
namespace UnityEngine::InputSystem::Composites {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6292)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6292), inst: 374 })}
...
/// @brief Method get_midPoint addr 0x28fb2e8 size 0x14 virtual false final false
 float_t get_midPoint() ;

/// @brief Method ReadValue addr 0x28fb2fc size 0x120 virtual true final false
 float_t ReadValue(ByRef<UnityEngine::InputSystem::InputBindingCompositeContext> context) ;

/// @brief Method EvaluateMagnitude addr 0x28fb41c size 0x4c virtual true final false
 float_t EvaluateMagnitude(ByRef<UnityEngine::InputSystem::InputBindingCompositeContext> context) ;

// Ctor Parameters []
explicit AxisComposite() ;

/// @brief Method .ctor addr 0x28fb468 size 0x54 virtual false final false
 void _ctor() ;
