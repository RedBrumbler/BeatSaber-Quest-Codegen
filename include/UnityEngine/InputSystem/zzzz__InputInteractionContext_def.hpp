...
/// @brief Method get_action addr 0x28fd344 size 0x24 virtual false final false
 UnityEngine::InputSystem::InputAction get_action() ;

/// @brief Method get_control addr 0x28fd368 size 0x24 virtual false final false
 UnityEngine::InputSystem::InputControl get_control() ;

/// @brief Method get_phase addr 0x28fd38c size 0x8 virtual false final false
 UnityEngine::InputSystem::InputActionPhase get_phase() ;

/// @brief Method get_time addr 0x28fd394 size 0x8 virtual false final false
 double_t get_time() ;

/// @brief Method get_startTime addr 0x28fd39c size 0x8 virtual false final false
 double_t get_startTime() ;

/// @brief Method get_timerHasExpired addr 0x28fd3a4 size 0xc virtual false final false
 bool get_timerHasExpired() ;

/// @brief Method set_timerHasExpired addr 0x28fd3b0 size 0x1c virtual false final false
 void set_timerHasExpired(bool value) ;

/// @brief Method get_isWaiting addr 0x28fd3cc size 0x10 virtual false final false
 bool get_isWaiting() ;

/// @brief Method get_isStarted addr 0x28fd3dc size 0x10 virtual false final false
 bool get_isStarted() ;

/// @brief Method ComputeMagnitude addr 0x28fd3ec size 0x8 virtual false final false
 float_t ComputeMagnitude() ;

/// @brief Method ControlIsActuated addr 0x28fd3f4 size 0xc virtual false final false
 bool ControlIsActuated(float_t threshold) ;

/// @brief Method Started addr 0x28fd400 size 0x38 virtual false final false
 void Started() ;

/// @brief Method Performed addr 0x28fd438 size 0x40 virtual false final false
 void Performed() ;

/// @brief Method PerformedAndStayStarted addr 0x28fd478 size 0x40 virtual false final false
 void PerformedAndStayStarted() ;

/// @brief Method PerformedAndStayPerformed addr 0x28fd4b8 size 0x40 virtual false final false
 void PerformedAndStayPerformed() ;

/// @brief Method Canceled addr 0x28fd4f8 size 0x40 virtual false final false
 void Canceled() ;

/// @brief Method Waiting addr 0x28fd538 size 0x40 virtual false final false
 void Waiting() ;

/// @brief Method SetTimeout addr 0x28fd578 size 0x24 virtual false final false
 void SetTimeout(float_t seconds) ;

/// @brief Method SetTotalTimeoutCompletionTime addr 0x28fd59c size 0x94 virtual false final false
...
/// @brief Method get_mapIndex addr 0x28fd630 size 0x8 virtual false final false
 int32_t get_mapIndex() ;

/// @brief Method get_controlIndex addr 0x28fd638 size 0xc virtual false final false
 int32_t get_controlIndex() ;

/// @brief Method get_bindingIndex addr 0x28fd644 size 0x8 virtual false final false
 int32_t get_bindingIndex() ;

/// @brief Method get_interactionIndex addr 0x28fd64c size 0xc virtual false final false
