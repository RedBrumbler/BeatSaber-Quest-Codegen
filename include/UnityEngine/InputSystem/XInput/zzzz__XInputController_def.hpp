...
/// @brief Method get_menu addr 0x296722c size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_menu() ;

/// @brief Method set_menu addr 0x2967234 size 0x8 virtual false final false
 void set_menu(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_view addr 0x296723c size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_view() ;

/// @brief Method set_view addr 0x2967244 size 0x8 virtual false final false
 void set_view(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_subType addr 0x296724c size 0x24 virtual false final false
 UnityEngine::InputSystem::XInput::UnityEngine__InputSystem__XInput__XInputController__DeviceSubType get_subType() ;

/// @brief Method get_flags addr 0x29672e0 size 0x24 virtual false final false
 UnityEngine::InputSystem::XInput::UnityEngine__InputSystem__XInput__XInputController__DeviceFlags get_flags() ;

/// @brief Method FinishSetup addr 0x2967304 size 0x20 virtual true final false
 void FinishSetup() ;

/// @brief Method ParseCapabilities addr 0x2967270 size 0x70 virtual false final false
 void ParseCapabilities() ;

// Ctor Parameters []
explicit XInputController() ;

/// @brief Method .ctor addr 0x2967324 size 0x8 virtual false final false
 void _ctor() ;
