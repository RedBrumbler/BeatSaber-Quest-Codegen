...
/// @brief Method get_attitude addr 0x29469f4 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::QuaternionControl get_attitude() ;

/// @brief Method set_attitude addr 0x29469fc size 0x8 virtual false final false
 void set_attitude(UnityEngine::InputSystem::Controls::QuaternionControl value) ;

/// @brief Method get_current addr 0x2946a04 size 0x48 virtual false final false
static UnityEngine::InputSystem::AttitudeSensor get_current() ;

/// @brief Method set_current addr 0x2946a4c size 0x4c virtual false final false
static void set_current(UnityEngine::InputSystem::AttitudeSensor value) ;

/// @brief Method MakeCurrent addr 0x2946a98 size 0x54 virtual true final false
 void MakeCurrent() ;

/// @brief Method OnRemoved addr 0x2946aec size 0x84 virtual true final false
 void OnRemoved() ;

/// @brief Method FinishSetup addr 0x2946b70 size 0x78 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit AttitudeSensor() ;

/// @brief Method .ctor addr 0x2946be8 size 0x8 virtual false final false
 void _ctor() ;
