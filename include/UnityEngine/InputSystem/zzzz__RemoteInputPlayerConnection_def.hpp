...
/// @brief Method Dispose addr 0x294620c size 0x58 virtual true final true
 void Dispose() ;

// Ctor Parameters []
explicit UnityEngine__InputSystem__RemoteInputPlayerConnection__Subscriber() ;

/// @brief Method .ctor addr 0x2945b70 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Bind addr 0x2945218 size 0x6dc virtual false final false
 void Bind(UnityEngine::Networking::PlayerConnection::IEditorPlayerConnection connection, bool isConnected) ;

/// @brief Method Subscribe addr 0x29459d0 size 0x1a0 virtual true final true
...
/// @brief Method OnConnected addr 0x29458f4 size 0xdc virtual false final false
 void OnConnected(int32_t id) ;

/// @brief Method OnDisconnected addr 0x2945c84 size 0xdc virtual false final false
 void OnDisconnected(int32_t id) ;

/// @brief Method OnNewDevice addr 0x2945d60 size 0xc virtual false final false
 void OnNewDevice(UnityEngine::Networking::PlayerConnection::MessageEventArgs args) ;

/// @brief Method OnNewLayout addr 0x2945d6c size 0xc virtual false final false
 void OnNewLayout(UnityEngine::Networking::PlayerConnection::MessageEventArgs args) ;

/// @brief Method OnNewEvents addr 0x2945d78 size 0xc virtual false final false
 void OnNewEvents(UnityEngine::Networking::PlayerConnection::MessageEventArgs args) ;

/// @brief Method OnRemoveDevice addr 0x2945d84 size 0xc virtual false final false
 void OnRemoveDevice(UnityEngine::Networking::PlayerConnection::MessageEventArgs args) ;

/// @brief Method OnChangeUsages addr 0x2945d90 size 0xc virtual false final false
 void OnChangeUsages(UnityEngine::Networking::PlayerConnection::MessageEventArgs args) ;

/// @brief Method OnStartSending addr 0x2945d9c size 0xc virtual false final false
 void OnStartSending(UnityEngine::Networking::PlayerConnection::MessageEventArgs args) ;

/// @brief Method OnStopSending addr 0x2945da8 size 0xc virtual false final false
 void OnStopSending(UnityEngine::Networking::PlayerConnection::MessageEventArgs args) ;

/// @brief Method SendToSubscribers addr 0x2945b78 size 0x10c virtual false final false
...
/// @brief Method System.IObserver<UnityEngine.InputSystem.InputRemoting.Message>.OnNext addr 0x2945db4 size 0x264 virtual true final true
...
/// @brief Method System.IObserver<UnityEngine.InputSystem.InputRemoting.Message>.OnError addr 0x2946018 size 0x4 virtual true final true
 void System_IObserver_UnityEngine_InputSystem_InputRemoting_Message__OnError(System::Exception error) ;

/// @brief Method System.IObserver<UnityEngine.InputSystem.InputRemoting.Message>.OnCompleted addr 0x294601c size 0x4 virtual true final true
 void System_IObserver_UnityEngine_InputSystem_InputRemoting_Message__OnCompleted() ;

// Ctor Parameters []
explicit RemoteInputPlayerConnection() ;

/// @brief Method .ctor addr 0x2946020 size 0x8 virtual false final false
 void _ctor() ;
