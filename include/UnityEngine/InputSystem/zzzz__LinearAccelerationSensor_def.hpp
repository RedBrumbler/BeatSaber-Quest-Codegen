...
/// @brief Method get_acceleration addr 0x2946bf0 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector3Control get_acceleration() ;

/// @brief Method set_acceleration addr 0x2946bf8 size 0x8 virtual false final false
 void set_acceleration(UnityEngine::InputSystem::Controls::Vector3Control value) ;

/// @brief Method get_current addr 0x2946c00 size 0x48 virtual false final false
static UnityEngine::InputSystem::LinearAccelerationSensor get_current() ;

/// @brief Method set_current addr 0x2946c48 size 0x4c virtual false final false
static void set_current(UnityEngine::InputSystem::LinearAccelerationSensor value) ;

/// @brief Method MakeCurrent addr 0x2946c94 size 0x54 virtual true final false
 void MakeCurrent() ;

/// @brief Method OnRemoved addr 0x2946ce8 size 0x84 virtual true final false
 void OnRemoved() ;

/// @brief Method FinishSetup addr 0x2946d6c size 0x78 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit LinearAccelerationSensor() ;

/// @brief Method .ctor addr 0x2946de4 size 0x8 virtual false final false
 void _ctor() ;
