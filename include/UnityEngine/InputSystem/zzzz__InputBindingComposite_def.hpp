...
/// @brief Method .ctor addr 0x28f5940 size 0x34 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x28f5a9c size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x28f5aa0 size 0x1d0 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.String>.get_Current addr 0x28f5c70 size 0x8 virtual true final true
 ::StringW System_Collections_Generic_IEnumerator_System_String__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x28f5c78 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x28f5cb8 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<System.String>.GetEnumerator addr 0x28f5cc0 size 0xa4 virtual true final true
 System::Collections::Generic::IEnumerator_1<::StringW> System_Collections_Generic_IEnumerable_System_String__GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x28f5d64 size 0x4 virtual true final true
...
/// @brief Method EvaluateMagnitude addr 0x28f55dc size 0x8 virtual true final false
 float_t EvaluateMagnitude(ByRef<UnityEngine::InputSystem::InputBindingCompositeContext> context) ;

/// @brief Method FinishSetup addr 0x28f55e4 size 0x4 virtual true final false
 void FinishSetup(ByRef<UnityEngine::InputSystem::InputBindingCompositeContext> context) ;

/// @brief Method CallFinishSetup addr 0x28edc38 size 0xc virtual false final false
 void CallFinishSetup(ByRef<UnityEngine::InputSystem::InputBindingCompositeContext> context) ;

/// @brief Method GetValueType addr 0x28f55e8 size 0x144 virtual false final false
static System::Type GetValueType(::StringW composite) ;

/// @brief Method GetExpectedControlLayoutName addr 0x28f572c size 0x19c virtual false final false
static ::StringW GetExpectedControlLayoutName(::StringW composite, ::StringW part) ;

/// @brief Method GetPartNames addr 0x28f58c8 size 0x78 virtual false final false
static System::Collections::Generic::IEnumerable_1<::StringW> GetPartNames(::StringW composite) ;

/// @brief Method GetDisplayFormatString addr 0x28f5974 size 0x120 virtual false final false
static ::StringW GetDisplayFormatString(::StringW composite) ;

// Ctor Parameters []
explicit InputBindingComposite() ;

/// @brief Method .ctor addr 0x28f5a94 size 0x8 virtual false final false
 void _ctor() ;
