...
/// @brief Method get_asset addr 0x28e765c size 0x8 virtual false final false
 UnityEngine::InputSystem::InputActionAsset get_asset() ;

/// @brief Method get_action addr 0x28e7284 size 0xac virtual false final false
 UnityEngine::InputSystem::InputAction get_action() ;

/// @brief Method Set addr 0x28e7664 size 0x108 virtual false final false
 void Set(UnityEngine::InputSystem::InputAction action) ;

/// @brief Method Set addr 0x28e78e0 size 0x224 virtual false final false
 void Set(UnityEngine::InputSystem::InputActionAsset asset, ::StringW mapName, ::StringW actionName) ;

/// @brief Method SetInternal addr 0x28e776c size 0x174 virtual false final false
 void SetInternal(UnityEngine::InputSystem::InputActionAsset asset, UnityEngine::InputSystem::InputAction action) ;

/// @brief Method ToString addr 0x28e7bc4 size 0x320 virtual true final false
 ::StringW ToString() ;

/// @brief Method GetDisplayName addr 0x28e7b04 size 0xc0 virtual false final false
static ::StringW GetDisplayName(UnityEngine::InputSystem::InputAction action) ;

/// @brief Method ToDisplayName addr 0x28e7ee4 size 0x3c virtual false final false
 ::StringW ToDisplayName() ;

/// @brief Method op_Implicit addr 0x28e7f20 size 0xc virtual false final false
static UnityEngine::InputSystem::InputAction op_Implicit_UnityEngine__InputSystem__InputAction(UnityEngine::InputSystem::InputActionReference reference) ;

/// @brief Method Create addr 0x28e7f2c size 0x6c virtual false final false
static UnityEngine::InputSystem::InputActionReference Create(UnityEngine::InputSystem::InputAction action) ;

/// @brief Method ToInputAction addr 0x28e7f98 size 0x4 virtual false final false
 UnityEngine::InputSystem::InputAction ToInputAction() ;

// Ctor Parameters []
explicit InputActionReference() ;

/// @brief Method .ctor addr 0x28e7f9c size 0x8 virtual false final false
 void _ctor() ;
