...
/// @brief Method get_samplingFrequency addr 0x2946264 size 0xf4 virtual false final false
 float_t get_samplingFrequency() ;

/// @brief Method set_samplingFrequency addr 0x2946358 size 0xa0 virtual false final false
 void set_samplingFrequency(float_t value) ;

// Ctor Parameters []
explicit Sensor() ;

/// @brief Method .ctor addr 0x29463f8 size 0x8 virtual false final false
 void _ctor() ;
