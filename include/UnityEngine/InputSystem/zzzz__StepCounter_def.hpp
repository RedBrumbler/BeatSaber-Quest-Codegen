...
/// @brief Method get_stepCounter addr 0x29479d4 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::IntegerControl get_stepCounter() ;

/// @brief Method set_stepCounter addr 0x29479dc size 0x8 virtual false final false
 void set_stepCounter(UnityEngine::InputSystem::Controls::IntegerControl value) ;

/// @brief Method get_current addr 0x29479e4 size 0x48 virtual false final false
static UnityEngine::InputSystem::StepCounter get_current() ;

/// @brief Method set_current addr 0x2947a2c size 0x4c virtual false final false
static void set_current(UnityEngine::InputSystem::StepCounter value) ;

/// @brief Method MakeCurrent addr 0x2947a78 size 0x54 virtual true final false
 void MakeCurrent() ;

/// @brief Method OnRemoved addr 0x2947acc size 0x84 virtual true final false
 void OnRemoved() ;

/// @brief Method FinishSetup addr 0x2947b50 size 0x78 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit StepCounter() ;

/// @brief Method .ctor addr 0x2947bc8 size 0x8 virtual false final false
 void _ctor() ;
