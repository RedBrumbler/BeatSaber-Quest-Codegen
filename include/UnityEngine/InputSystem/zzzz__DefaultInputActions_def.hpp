...
/// @brief Method .ctor addr 0x2956688 size 0x8 virtual false final false
 void _ctor(UnityEngine::InputSystem::DefaultInputActions wrapper) ;

/// @brief Method get_Move addr 0x2956690 size 0x1c virtual false final false
 UnityEngine::InputSystem::InputAction get_Move() ;

/// @brief Method get_Look addr 0x29566ac size 0x1c virtual false final false
 UnityEngine::InputSystem::InputAction get_Look() ;

/// @brief Method get_Fire addr 0x29566c8 size 0x1c virtual false final false
 UnityEngine::InputSystem::InputAction get_Fire() ;

/// @brief Method Get addr 0x29566e4 size 0x1c virtual false final false
 UnityEngine::InputSystem::InputActionMap Get() ;

/// @brief Method Enable addr 0x2956700 size 0x24 virtual false final false
 void Enable() ;

/// @brief Method Disable addr 0x2956724 size 0x24 virtual false final false
 void Disable() ;

/// @brief Method get_enabled addr 0x2956748 size 0x24 virtual false final false
 bool get_enabled() ;

/// @brief Method op_Implicit addr 0x295676c size 0x18 virtual false final false
...
/// @brief Method SetCallbacks addr 0x2956784 size 0xb14 virtual false final false
...
/// @brief Method .ctor addr 0x2957298 size 0x8 virtual false final false
 void _ctor(UnityEngine::InputSystem::DefaultInputActions wrapper) ;

/// @brief Method get_Navigate addr 0x29572a0 size 0x1c virtual false final false
 UnityEngine::InputSystem::InputAction get_Navigate() ;

/// @brief Method get_Submit addr 0x29572bc size 0x1c virtual false final false
 UnityEngine::InputSystem::InputAction get_Submit() ;

/// @brief Method get_Cancel addr 0x29572d8 size 0x1c virtual false final false
 UnityEngine::InputSystem::InputAction get_Cancel() ;

/// @brief Method get_Point addr 0x29572f4 size 0x1c virtual false final false
 UnityEngine::InputSystem::InputAction get_Point() ;

/// @brief Method get_Click addr 0x2957310 size 0x1c virtual false final false
 UnityEngine::InputSystem::InputAction get_Click() ;

/// @brief Method get_ScrollWheel addr 0x295732c size 0x1c virtual false final false
 UnityEngine::InputSystem::InputAction get_ScrollWheel() ;

/// @brief Method get_MiddleClick addr 0x2957348 size 0x1c virtual false final false
 UnityEngine::InputSystem::InputAction get_MiddleClick() ;

/// @brief Method get_RightClick addr 0x2957364 size 0x1c virtual false final false
 UnityEngine::InputSystem::InputAction get_RightClick() ;

/// @brief Method get_TrackedDevicePosition addr 0x2957380 size 0x1c virtual false final false
 UnityEngine::InputSystem::InputAction get_TrackedDevicePosition() ;

/// @brief Method get_TrackedDeviceOrientation addr 0x295739c size 0x1c virtual false final false
 UnityEngine::InputSystem::InputAction get_TrackedDeviceOrientation() ;

/// @brief Method Get addr 0x29573b8 size 0x1c virtual false final false
 UnityEngine::InputSystem::InputActionMap Get() ;

/// @brief Method Enable addr 0x29573d4 size 0x24 virtual false final false
 void Enable() ;

/// @brief Method Disable addr 0x29573f8 size 0x24 virtual false final false
 void Disable() ;

/// @brief Method get_enabled addr 0x295741c size 0x24 virtual false final false
 bool get_enabled() ;

/// @brief Method op_Implicit addr 0x2957440 size 0x18 virtual false final false
...
/// @brief Method SetCallbacks addr 0x2957458 size 0x2404 virtual false final false
...
/// @brief Method get_asset addr 0x2955ca8 size 0x8 virtual false final false
 UnityEngine::InputSystem::InputActionAsset get_asset() ;

// Ctor Parameters []
explicit DefaultInputActions() ;

/// @brief Method .ctor addr 0x2955cb0 size 0x360 virtual false final false
 void _ctor() ;

/// @brief Method Dispose addr 0x2956010 size 0x5c virtual true final true
 void Dispose() ;

/// @brief Method get_bindingMask addr 0x295606c size 0x28 virtual true final true
 System::Nullable_1<UnityEngine::InputSystem::InputBinding> get_bindingMask() ;

/// @brief Method set_bindingMask addr 0x2956094 size 0x4c virtual true final true
 void set_bindingMask(System::Nullable_1<UnityEngine::InputSystem::InputBinding> value) ;

/// @brief Method get_devices addr 0x29560e0 size 0x40 virtual true final true
 System::Nullable_1<UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<UnityEngine::InputSystem::InputDevice>> get_devices() ;

/// @brief Method set_devices addr 0x2956120 size 0x4c virtual true final true
...
/// @brief Method get_controlSchemes addr 0x295616c size 0x1c virtual true final true
 UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<UnityEngine::InputSystem::InputControlScheme> get_controlSchemes() ;

/// @brief Method Contains addr 0x2956188 size 0x1c virtual true final true
 bool Contains(UnityEngine::InputSystem::InputAction action) ;

/// @brief Method GetEnumerator addr 0x29561a4 size 0x1c virtual true final true
 System::Collections::Generic::IEnumerator_1<UnityEngine::InputSystem::InputAction> GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x29561c0 size 0x1c virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method Enable addr 0x29561dc size 0x1c virtual true final true
 void Enable() ;

/// @brief Method Disable addr 0x29561f8 size 0x1c virtual true final true
 void Disable() ;

/// @brief Method get_bindings addr 0x2956214 size 0x1c virtual true final true
 System::Collections::Generic::IEnumerable_1<UnityEngine::InputSystem::InputBinding> get_bindings() ;

/// @brief Method FindAction addr 0x2956230 size 0x20 virtual true final true
 UnityEngine::InputSystem::InputAction FindAction(::StringW actionNameOrId, bool throwIfNotFound) ;

/// @brief Method FindBinding addr 0x2956250 size 0x5c virtual true final true
 int32_t FindBinding(UnityEngine::InputSystem::InputBinding bindingMask, ByRef<UnityEngine::InputSystem::InputAction> action) ;

/// @brief Method get_Player addr 0x29562ac size 0x4 virtual false final false
 UnityEngine::InputSystem::UnityEngine__InputSystem__DefaultInputActions__PlayerActions get_Player() ;

/// @brief Method get_UI addr 0x29562b0 size 0x4 virtual false final false
 UnityEngine::InputSystem::UnityEngine__InputSystem__DefaultInputActions__UIActions get_UI() ;

/// @brief Method get_KeyboardMouseScheme addr 0x29562b4 size 0xc4 virtual false final false
 UnityEngine::InputSystem::InputControlScheme get_KeyboardMouseScheme() ;

/// @brief Method get_GamepadScheme addr 0x2956378 size 0xc4 virtual false final false
 UnityEngine::InputSystem::InputControlScheme get_GamepadScheme() ;

/// @brief Method get_TouchScheme addr 0x295643c size 0xc4 virtual false final false
 UnityEngine::InputSystem::InputControlScheme get_TouchScheme() ;

/// @brief Method get_JoystickScheme addr 0x2956500 size 0xc4 virtual false final false
 UnityEngine::InputSystem::InputControlScheme get_JoystickScheme() ;

/// @brief Method get_XRScheme addr 0x29565c4 size 0xc4 virtual false final false
