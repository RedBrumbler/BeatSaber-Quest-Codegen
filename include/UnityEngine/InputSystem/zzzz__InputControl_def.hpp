...
/// @brief Method get_name addr 0x2902bb4 size 0x10 virtual false final false
 ::StringW get_name() ;

/// @brief Method get_displayName addr 0x2902bc4 size 0x58 virtual false final false
 ::StringW get_displayName() ;

/// @brief Method set_displayName addr 0x2902c50 size 0x8 virtual false final false
 void set_displayName(::StringW value) ;

/// @brief Method get_shortDisplayName addr 0x2902c58 size 0x44 virtual false final false
 ::StringW get_shortDisplayName() ;

/// @brief Method set_shortDisplayName addr 0x2902c9c size 0x8 virtual false final false
 void set_shortDisplayName(::StringW value) ;

/// @brief Method get_path addr 0x2902ca4 size 0x40 virtual false final false
 ::StringW get_path() ;

/// @brief Method get_layout addr 0x2902dd8 size 0x10 virtual false final false
 ::StringW get_layout() ;

/// @brief Method get_variants addr 0x2902de8 size 0x10 virtual false final false
 ::StringW get_variants() ;

/// @brief Method get_device addr 0x2902df8 size 0x8 virtual false final false
 UnityEngine::InputSystem::InputDevice get_device() ;

/// @brief Method get_parent addr 0x2902e00 size 0x8 virtual false final false
 UnityEngine::InputSystem::InputControl get_parent() ;

/// @brief Method get_children addr 0x2902e08 size 0x70 virtual false final false
 UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<UnityEngine::InputSystem::InputControl> get_children() ;

/// @brief Method get_usages addr 0x2902e78 size 0x70 virtual false final false
 UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<UnityEngine::InputSystem::Utilities::InternedString> get_usages() ;

/// @brief Method get_aliases addr 0x2902ee8 size 0x70 virtual false final false
 UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<UnityEngine::InputSystem::Utilities::InternedString> get_aliases() ;

/// @brief Method get_stateBlock addr 0x2902f58 size 0xc virtual false final false
 UnityEngine::InputSystem::LowLevel::InputStateBlock get_stateBlock() ;

/// @brief Method get_noisy addr 0x2902f64 size 0xc virtual false final false
 bool get_noisy() ;

/// @brief Method set_noisy addr 0x2902f70 size 0xd8 virtual false final false
 void set_noisy(bool value) ;

/// @brief Method get_synthetic addr 0x2903048 size 0xc virtual false final false
 bool get_synthetic() ;

/// @brief Method set_synthetic addr 0x2903054 size 0x1c virtual false final false
 void set_synthetic(bool value) ;

/// @brief Method get_Item addr 0x2903070 size 0x88 virtual false final false
...
/// @brief Method ToString addr 0x2903158 size 0x68 virtual true final false
 ::StringW ToString() ;

/// @brief Method DebuggerDisplay addr 0x29031c0 size 0x124 virtual false final false
 ::StringW DebuggerDisplay() ;

/// @brief Method EvaluateMagnitude addr 0x2903360 size 0x2c virtual false final false
 float_t EvaluateMagnitude() ;

/// @brief Method EvaluateMagnitude addr 0x29033a0 size 0x8 virtual true final false
...
/// @brief Method WriteValueFromBufferIntoState addr 0x29033a8 size 0x68 virtual true final false
 void WriteValueFromBufferIntoState(void* bufferPtr, int32_t bufferSize, void* statePtr) ;

/// @brief Method WriteValueFromObjectIntoState addr 0x2903410 size 0x68 virtual true final false
...
/// @brief Method TryGetChildControl addr 0x2903478 size 0x84 virtual false final false
...
/// @brief Method GetChildControl addr 0x29034fc size 0x11c virtual false final false
...
/// @brief Method .ctor addr 0x29036c4 size 0x20 virtual false final false
 void _ctor() ;

/// @brief Method FinishSetup addr 0x29036e4 size 0x4 virtual true final false
 void FinishSetup() ;

/// @brief Method RefreshConfigurationIfNeeded addr 0x2902c1c size 0x34 virtual false final false
 void RefreshConfigurationIfNeeded() ;

/// @brief Method RefreshConfiguration addr 0x2903710 size 0x4 virtual true final false
 void RefreshConfiguration() ;

/// @brief Method get_currentStatePtr addr 0x290338c size 0x14 virtual false final false
 void* get_currentStatePtr() ;

/// @brief Method get_previousFrameStatePtr addr 0x29038d0 size 0x14 virtual false final false
 void* get_previousFrameStatePtr() ;

/// @brief Method get_defaultStatePtr addr 0x29038e4 size 0x48 virtual false final false
 void* get_defaultStatePtr() ;

/// @brief Method get_noiseMaskPtr addr 0x290392c size 0x48 virtual false final false
 void* get_noiseMaskPtr() ;

/// @brief Method get_stateOffsetRelativeToDeviceRoot addr 0x2903974 size 0x24 virtual false final false
 uint32_t get_stateOffsetRelativeToDeviceRoot() ;

/// @brief Method get_isSetupFinished addr 0x2903998 size 0xc virtual false final false
 bool get_isSetupFinished() ;

/// @brief Method set_isSetupFinished addr 0x29039a4 size 0x1c virtual false final false
 void set_isSetupFinished(bool value) ;

/// @brief Method get_isButton addr 0x29039c0 size 0xc virtual false final false
 bool get_isButton() ;

/// @brief Method set_isButton addr 0x29039cc size 0x1c virtual false final false
 void set_isButton(bool value) ;

/// @brief Method get_isConfigUpToDate addr 0x29036e8 size 0xc virtual false final false
 bool get_isConfigUpToDate() ;

/// @brief Method set_isConfigUpToDate addr 0x29036f4 size 0x1c virtual false final false
 void set_isConfigUpToDate(bool value) ;

/// @brief Method get_dontReset addr 0x29039e8 size 0xc virtual false final false
 bool get_dontReset() ;

/// @brief Method set_dontReset addr 0x29039f4 size 0x1c virtual false final false
 void set_dontReset(bool value) ;

/// @brief Method get_usesStateFromOtherControl addr 0x2903a10 size 0xc virtual false final false
 bool get_usesStateFromOtherControl() ;

/// @brief Method set_usesStateFromOtherControl addr 0x2903a1c size 0x1c virtual false final false
 void set_usesStateFromOtherControl(bool value) ;

/// @brief Method get_hasDefaultState addr 0x2903a38 size 0x20 virtual false final false
 bool get_hasDefaultState() ;

/// @brief Method CallFinishSetupRecursive addr 0x2903a58 size 0xb0 virtual false final false
 void CallFinishSetupRecursive() ;

/// @brief Method MakeChildPath addr 0x2903618 size 0xac virtual false final false
 ::StringW MakeChildPath(::StringW path) ;

/// @brief Method BakeOffsetIntoStateBlockRecursive addr 0x2903b08 size 0xb0 virtual false final false
 void BakeOffsetIntoStateBlockRecursive(uint32_t offset) ;

/// @brief Method GetDeviceIndex addr 0x2903714 size 0x1bc virtual false final false
 int32_t GetDeviceIndex() ;

/// @brief Method IsValueConsideredPressed addr 0x2903bb8 size 0xb8 virtual false final false
 bool IsValueConsideredPressed(float_t value) ;

/// @brief Method AddProcessor addr 0x2903c70 size 0x4 virtual true final false
