...
/// @brief Method Process addr 0x299632c size 0xc virtual true final false
 float_t Process(float_t value, UnityEngine::InputSystem::InputControl control) ;

/// @brief Method ToString addr 0x2996338 size 0x84 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit ScaleProcessor() ;

/// @brief Method .ctor addr 0x29963bc size 0x50 virtual false final false
 void _ctor() ;
