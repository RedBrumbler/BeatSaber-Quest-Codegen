...
namespace UnityEngine::InputSystem::Processors {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6338)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6338), inst: 393 }), TypeDefinitionIndex(TypeDefinitionIndex(10203))}
...
/// @brief Method Process addr 0x299640c size 0x10 virtual true final false
 UnityEngine::Vector2 Process(UnityEngine::Vector2 value, UnityEngine::InputSystem::InputControl control) ;

/// @brief Method ToString addr 0x299641c size 0xa0 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit ScaleVector2Processor() ;

/// @brief Method .ctor addr 0x29964bc size 0x50 virtual false final false
 void _ctor() ;
