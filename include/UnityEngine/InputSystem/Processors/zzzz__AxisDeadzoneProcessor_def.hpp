...
namespace UnityEngine::InputSystem::Processors {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6338), inst: 374 }), TypeDefinitionIndex(TypeDefinitionIndex(6338))}
...
/// @brief Method get_minOrDefault addr 0x299532c size 0x70 virtual false final false
 float_t get_minOrDefault() ;

/// @brief Method get_maxOrDefault addr 0x299539c size 0x70 virtual false final false
 float_t get_maxOrDefault() ;

/// @brief Method Process addr 0x299540c size 0x68 virtual true final false
 float_t Process(float_t value, UnityEngine::InputSystem::InputControl control) ;

/// @brief Method ToString addr 0x2995474 size 0xa8 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit AxisDeadzoneProcessor() ;

/// @brief Method .ctor addr 0x299551c size 0x48 virtual false final false
 void _ctor() ;
