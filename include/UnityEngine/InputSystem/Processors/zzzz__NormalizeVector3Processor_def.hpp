...
namespace UnityEngine::InputSystem::Processors {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6338)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6338), inst: 394 }), TypeDefinitionIndex(TypeDefinitionIndex(10209))}
...
/// @brief Method Process addr 0x29961d4 size 0xd0 virtual true final false
 UnityEngine::Vector3 Process(UnityEngine::Vector3 value, UnityEngine::InputSystem::InputControl control) ;

/// @brief Method ToString addr 0x29962a4 size 0x40 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit NormalizeVector3Processor() ;

/// @brief Method .ctor addr 0x29962e4 size 0x48 virtual false final false
 void _ctor() ;
