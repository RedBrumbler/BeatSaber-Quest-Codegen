...
/// @brief Method Process addr 0x2995c04 size 0x24 virtual true final false
 UnityEngine::Vector2 Process(UnityEngine::Vector2 value, UnityEngine::InputSystem::InputControl control) ;

/// @brief Method ToString addr 0x2995c28 size 0xa0 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit InvertVector2Processor() ;

/// @brief Method .ctor addr 0x2995cc8 size 0x50 virtual false final false
 void _ctor() ;
