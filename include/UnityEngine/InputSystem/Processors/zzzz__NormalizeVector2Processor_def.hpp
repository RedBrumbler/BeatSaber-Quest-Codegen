...
namespace UnityEngine::InputSystem::Processors {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10203)), TypeDefinitionIndex(TypeDefinitionIndex(6338)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6338), inst: 393 })}
...
/// @brief Method Process addr 0x2996098 size 0xb4 virtual true final false
 UnityEngine::Vector2 Process(UnityEngine::Vector2 value, UnityEngine::InputSystem::InputControl control) ;

/// @brief Method ToString addr 0x299614c size 0x40 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit NormalizeVector2Processor() ;

/// @brief Method .ctor addr 0x299618c size 0x48 virtual false final false
 void _ctor() ;
