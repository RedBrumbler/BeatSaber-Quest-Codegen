...
namespace UnityEngine::InputSystem::Processors {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6338)), TypeDefinitionIndex(TypeDefinitionIndex(10209)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6338), inst: 394 })}
...
/// @brief Method Process addr 0x2995d18 size 0x34 virtual true final false
 UnityEngine::Vector3 Process(UnityEngine::Vector3 value, UnityEngine::InputSystem::InputControl control) ;

/// @brief Method ToString addr 0x2995d4c size 0xc4 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit InvertVector3Processor() ;

/// @brief Method .ctor addr 0x2995e10 size 0x58 virtual false final false
 void _ctor() ;
