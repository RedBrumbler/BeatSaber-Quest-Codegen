...
namespace UnityEngine::InputSystem::Processors {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6338)), TypeDefinitionIndex(TypeDefinitionIndex(10203)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6338), inst: 393 })}
...
/// @brief Method get_minOrDefault addr 0x2996640 size 0x70 virtual false final false
 float_t get_minOrDefault() ;

/// @brief Method get_maxOrDefault addr 0x29966b0 size 0x70 virtual false final false
 float_t get_maxOrDefault() ;

/// @brief Method Process addr 0x2996720 size 0xd0 virtual true final false
 UnityEngine::Vector2 Process(UnityEngine::Vector2 value, UnityEngine::InputSystem::InputControl control) ;

/// @brief Method GetDeadZoneAdjustedValue addr 0x29967f0 size 0x68 virtual false final false
 float_t GetDeadZoneAdjustedValue(float_t value) ;

/// @brief Method ToString addr 0x2996858 size 0xa8 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit StickDeadzoneProcessor() ;

/// @brief Method .ctor addr 0x2996900 size 0x48 virtual false final false
 void _ctor() ;
