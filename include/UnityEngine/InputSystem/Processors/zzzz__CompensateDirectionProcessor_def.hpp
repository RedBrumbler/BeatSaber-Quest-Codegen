...
namespace UnityEngine::InputSystem::Processors {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10209)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6338), inst: 394 }), TypeDefinitionIndex(TypeDefinitionIndex(6338))}
...
/// @brief Method Process addr 0x2995664 size 0x1f0 virtual true final false
 UnityEngine::Vector3 Process(UnityEngine::Vector3 value, UnityEngine::InputSystem::InputControl control) ;

/// @brief Method ToString addr 0x2995854 size 0x40 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit CompensateDirectionProcessor() ;

/// @brief Method .ctor addr 0x2995894 size 0x48 virtual false final false
 void _ctor() ;
