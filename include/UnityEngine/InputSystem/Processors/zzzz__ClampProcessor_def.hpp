...
/// @brief Method Process addr 0x2995564 size 0x18 virtual true final false
 float_t Process(float_t value, UnityEngine::InputSystem::InputControl control) ;

/// @brief Method ToString addr 0x299557c size 0xa0 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit ClampProcessor() ;

/// @brief Method .ctor addr 0x299561c size 0x48 virtual false final false
 void _ctor() ;
