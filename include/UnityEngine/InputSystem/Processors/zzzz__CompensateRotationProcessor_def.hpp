...
namespace UnityEngine::InputSystem::Processors {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6338), inst: 3226 }), TypeDefinitionIndex(TypeDefinitionIndex(6338)), TypeDefinitionIndex(TypeDefinitionIndex(10212))}
...
/// @brief Method Process addr 0x29958dc size 0x210 virtual true final false
 UnityEngine::Quaternion Process(UnityEngine::Quaternion value, UnityEngine::InputSystem::InputControl control) ;

/// @brief Method ToString addr 0x2995aec size 0x40 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit CompensateRotationProcessor() ;

/// @brief Method .ctor addr 0x2995b2c size 0x48 virtual false final false
 void _ctor() ;
