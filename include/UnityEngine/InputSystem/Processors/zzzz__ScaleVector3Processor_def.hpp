...
/// @brief Method Process addr 0x299650c size 0x18 virtual true final false
 UnityEngine::Vector3 Process(UnityEngine::Vector3 value, UnityEngine::InputSystem::InputControl control) ;

/// @brief Method ToString addr 0x2996524 size 0xc4 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit ScaleVector3Processor() ;

/// @brief Method .ctor addr 0x29965e8 size 0x58 virtual false final false
 void _ctor() ;
