...
namespace UnityEngine::InputSystem::Processors {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6338)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6338), inst: 374 })}
...
/// @brief Method Process addr 0x2995e68 size 0xc virtual true final false
 float_t Process(float_t value, UnityEngine::InputSystem::InputControl control) ;

/// @brief Method Normalize addr 0x2995e74 size 0xd0 virtual false final false
static float_t Normalize(float_t value, float_t min, float_t max, float_t zero) ;

/// @brief Method Denormalize addr 0x2995f44 size 0x48 virtual false final false
static float_t Denormalize(float_t value, float_t min, float_t max, float_t zero) ;

/// @brief Method ToString addr 0x2995f8c size 0xc4 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit NormalizeProcessor() ;

/// @brief Method .ctor addr 0x2996050 size 0x48 virtual false final false
 void _ctor() ;
