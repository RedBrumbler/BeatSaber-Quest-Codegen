...
/// @brief Method Process addr 0x2995b74 size 0x8 virtual true final false
 float_t Process(float_t value, UnityEngine::InputSystem::InputControl control) ;

/// @brief Method ToString addr 0x2995b7c size 0x40 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit InvertProcessor() ;

/// @brief Method .ctor addr 0x2995bbc size 0x48 virtual false final false
 void _ctor() ;
