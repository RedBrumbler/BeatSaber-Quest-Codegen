...
/// @brief Method IsInProgress addr 0x294950c size 0x10 virtual false final false
static bool IsInProgress(UnityEngine::InputSystem::InputActionPhase phase) ;

/// @brief Method IsEndedOrCanceled addr 0x294951c size 0x10 virtual false final false
static bool IsEndedOrCanceled(UnityEngine::InputSystem::TouchPhase phase) ;

/// @brief Method IsActive addr 0x2948de8 size 0x20 virtual false final false
static bool IsActive(UnityEngine::InputSystem::TouchPhase phase) ;

/// @brief Method IsModifierKey addr 0x294952c size 0x10 virtual false final false
static bool IsModifierKey(UnityEngine::InputSystem::Key key) ;

/// @brief Method IsTextInputKey addr 0x294953c size 0x2c virtual false final false
