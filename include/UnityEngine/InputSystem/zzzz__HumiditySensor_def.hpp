...
/// @brief Method get_relativeHumidity addr 0x29475dc size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_relativeHumidity() ;

/// @brief Method set_relativeHumidity addr 0x29475e4 size 0x8 virtual false final false
 void set_relativeHumidity(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_current addr 0x29475ec size 0x48 virtual false final false
static UnityEngine::InputSystem::HumiditySensor get_current() ;

/// @brief Method set_current addr 0x2947634 size 0x4c virtual false final false
static void set_current(UnityEngine::InputSystem::HumiditySensor value) ;

/// @brief Method MakeCurrent addr 0x2947680 size 0x54 virtual true final false
 void MakeCurrent() ;

/// @brief Method OnRemoved addr 0x29476d4 size 0x84 virtual true final false
 void OnRemoved() ;

/// @brief Method FinishSetup addr 0x2947758 size 0x78 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit HumiditySensor() ;

/// @brief Method .ctor addr 0x29477d0 size 0x8 virtual false final false
 void _ctor() ;
