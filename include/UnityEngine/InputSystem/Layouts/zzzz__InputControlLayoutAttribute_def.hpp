...
/// @brief Method get_stateType addr 0x299fe04 size 0x8 virtual false final false
 System::Type get_stateType() ;

/// @brief Method set_stateType addr 0x299fe0c size 0x8 virtual false final false
 void set_stateType(System::Type value) ;

/// @brief Method get_stateFormat addr 0x299fe14 size 0x8 virtual false final false
 ::StringW get_stateFormat() ;

/// @brief Method set_stateFormat addr 0x299fe1c size 0x8 virtual false final false
 void set_stateFormat(::StringW value) ;

/// @brief Method get_commonUsages addr 0x299fe24 size 0x8 virtual false final false
 ::ArrayW<::StringW> get_commonUsages() ;

/// @brief Method set_commonUsages addr 0x299fe2c size 0x8 virtual false final false
 void set_commonUsages(::ArrayW<::StringW> value) ;

/// @brief Method get_variants addr 0x299fe34 size 0x8 virtual false final false
 ::StringW get_variants() ;

/// @brief Method set_variants addr 0x299fe3c size 0x8 virtual false final false
 void set_variants(::StringW value) ;

/// @brief Method get_isNoisy addr 0x299fe44 size 0x8 virtual false final false
 bool get_isNoisy() ;

/// @brief Method set_isNoisy addr 0x299fe4c size 0xc virtual false final false
 void set_isNoisy(bool value) ;

/// @brief Method get_canRunInBackground addr 0x299fe58 size 0x48 virtual false final false
 bool get_canRunInBackground() ;

/// @brief Method set_canRunInBackground addr 0x299fea0 size 0x68 virtual false final false
 void set_canRunInBackground(bool value) ;

/// @brief Method get_updateBeforeRender addr 0x299ff08 size 0x48 virtual false final false
 bool get_updateBeforeRender() ;

/// @brief Method set_updateBeforeRender addr 0x299ff50 size 0x68 virtual false final false
 void set_updateBeforeRender(bool value) ;

/// @brief Method get_isGenericTypeOfDevice addr 0x299ffb8 size 0x8 virtual false final false
 bool get_isGenericTypeOfDevice() ;

/// @brief Method set_isGenericTypeOfDevice addr 0x299ffc0 size 0xc virtual false final false
 void set_isGenericTypeOfDevice(bool value) ;

/// @brief Method get_displayName addr 0x299ffcc size 0x8 virtual false final false
 ::StringW get_displayName() ;

/// @brief Method set_displayName addr 0x299ffd4 size 0x8 virtual false final false
 void set_displayName(::StringW value) ;

/// @brief Method get_description addr 0x299ffdc size 0x8 virtual false final false
 ::StringW get_description() ;

/// @brief Method set_description addr 0x299ffe4 size 0x8 virtual false final false
 void set_description(::StringW value) ;

/// @brief Method get_hideInUI addr 0x299ffec size 0x8 virtual false final false
 bool get_hideInUI() ;

/// @brief Method set_hideInUI addr 0x299fff4 size 0xc virtual false final false
 void set_hideInUI(bool value) ;

// Ctor Parameters []
explicit InputControlLayoutAttribute() ;

/// @brief Method .ctor addr 0x29a0000 size 0x8 virtual false final false
 void _ctor() ;
