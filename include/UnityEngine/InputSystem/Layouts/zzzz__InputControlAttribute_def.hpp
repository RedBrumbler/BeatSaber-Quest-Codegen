...
/// @brief Method get_layout addr 0x2996948 size 0x8 virtual false final false
 ::StringW get_layout() ;

/// @brief Method set_layout addr 0x2996950 size 0x8 virtual false final false
 void set_layout(::StringW value) ;

/// @brief Method get_variants addr 0x2996958 size 0x8 virtual false final false
 ::StringW get_variants() ;

/// @brief Method set_variants addr 0x2996960 size 0x8 virtual false final false
 void set_variants(::StringW value) ;

/// @brief Method get_name addr 0x2996968 size 0x8 virtual false final false
 ::StringW get_name() ;

/// @brief Method set_name addr 0x2996970 size 0x8 virtual false final false
 void set_name(::StringW value) ;

/// @brief Method get_format addr 0x2996978 size 0x8 virtual false final false
 ::StringW get_format() ;

/// @brief Method set_format addr 0x2996980 size 0x8 virtual false final false
 void set_format(::StringW value) ;

/// @brief Method get_usage addr 0x2996988 size 0x8 virtual false final false
 ::StringW get_usage() ;

/// @brief Method set_usage addr 0x2996990 size 0x8 virtual false final false
 void set_usage(::StringW value) ;

/// @brief Method get_usages addr 0x2996998 size 0x8 virtual false final false
 ::ArrayW<::StringW> get_usages() ;

/// @brief Method set_usages addr 0x29969a0 size 0x8 virtual false final false
 void set_usages(::ArrayW<::StringW> value) ;

/// @brief Method get_parameters addr 0x29969a8 size 0x8 virtual false final false
 ::StringW get_parameters() ;

/// @brief Method set_parameters addr 0x29969b0 size 0x8 virtual false final false
 void set_parameters(::StringW value) ;

/// @brief Method get_processors addr 0x29969b8 size 0x8 virtual false final false
 ::StringW get_processors() ;

/// @brief Method set_processors addr 0x29969c0 size 0x8 virtual false final false
 void set_processors(::StringW value) ;

/// @brief Method get_alias addr 0x29969c8 size 0x8 virtual false final false
 ::StringW get_alias() ;

/// @brief Method set_alias addr 0x29969d0 size 0x8 virtual false final false
 void set_alias(::StringW value) ;

/// @brief Method get_aliases addr 0x29969d8 size 0x8 virtual false final false
 ::ArrayW<::StringW> get_aliases() ;

/// @brief Method set_aliases addr 0x29969e0 size 0x8 virtual false final false
 void set_aliases(::ArrayW<::StringW> value) ;

/// @brief Method get_useStateFrom addr 0x29969e8 size 0x8 virtual false final false
 ::StringW get_useStateFrom() ;

/// @brief Method set_useStateFrom addr 0x29969f0 size 0x8 virtual false final false
 void set_useStateFrom(::StringW value) ;

/// @brief Method get_bit addr 0x29969f8 size 0x8 virtual false final false
 uint32_t get_bit() ;

/// @brief Method set_bit addr 0x2996a00 size 0x8 virtual false final false
 void set_bit(uint32_t value) ;

/// @brief Method get_offset addr 0x2996a08 size 0x8 virtual false final false
 uint32_t get_offset() ;

/// @brief Method set_offset addr 0x2996a10 size 0x8 virtual false final false
 void set_offset(uint32_t value) ;

/// @brief Method get_sizeInBits addr 0x2996a18 size 0x8 virtual false final false
 uint32_t get_sizeInBits() ;

/// @brief Method set_sizeInBits addr 0x2996a20 size 0x8 virtual false final false
 void set_sizeInBits(uint32_t value) ;

/// @brief Method get_arraySize addr 0x2996a28 size 0x8 virtual false final false
 int32_t get_arraySize() ;

/// @brief Method set_arraySize addr 0x2996a30 size 0x8 virtual false final false
 void set_arraySize(int32_t value) ;

/// @brief Method get_displayName addr 0x2996a38 size 0x8 virtual false final false
 ::StringW get_displayName() ;

/// @brief Method set_displayName addr 0x2996a40 size 0x8 virtual false final false
 void set_displayName(::StringW value) ;

/// @brief Method get_shortDisplayName addr 0x2996a48 size 0x8 virtual false final false
 ::StringW get_shortDisplayName() ;

/// @brief Method set_shortDisplayName addr 0x2996a50 size 0x8 virtual false final false
 void set_shortDisplayName(::StringW value) ;

/// @brief Method get_noisy addr 0x2996a58 size 0x8 virtual false final false
 bool get_noisy() ;

/// @brief Method set_noisy addr 0x2996a60 size 0xc virtual false final false
 void set_noisy(bool value) ;

/// @brief Method get_synthetic addr 0x2996a6c size 0x8 virtual false final false
 bool get_synthetic() ;

/// @brief Method set_synthetic addr 0x2996a74 size 0xc virtual false final false
 void set_synthetic(bool value) ;

/// @brief Method get_dontReset addr 0x2996a80 size 0x8 virtual false final false
 bool get_dontReset() ;

/// @brief Method set_dontReset addr 0x2996a88 size 0xc virtual false final false
 void set_dontReset(bool value) ;

/// @brief Method get_defaultState addr 0x2996a94 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_defaultState() ;

/// @brief Method set_defaultState addr 0x2996a9c size 0x8 virtual false final false
 void set_defaultState(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_minValue addr 0x2996aa4 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_minValue() ;

/// @brief Method set_minValue addr 0x2996aac size 0x8 virtual false final false
 void set_minValue(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_maxValue addr 0x2996ab4 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_maxValue() ;

/// @brief Method set_maxValue addr 0x2996abc size 0x8 virtual false final false
 void set_maxValue(::bs_hook::Il2CppWrapperType value) ;

// Ctor Parameters []
explicit InputControlAttribute() ;

/// @brief Method .ctor addr 0x2996ac4 size 0x10 virtual false final false
 void _ctor() ;
