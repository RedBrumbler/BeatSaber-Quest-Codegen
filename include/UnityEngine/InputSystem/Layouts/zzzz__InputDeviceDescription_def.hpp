...
/// @brief Method get_interfaceName addr 0x29a3174 size 0x8 virtual false final false
 ::StringW get_interfaceName() ;

/// @brief Method set_interfaceName addr 0x29a317c size 0x8 virtual false final false
 void set_interfaceName(::StringW value) ;

/// @brief Method get_deviceClass addr 0x29a3184 size 0x8 virtual false final false
 ::StringW get_deviceClass() ;

/// @brief Method set_deviceClass addr 0x29a318c size 0x8 virtual false final false
 void set_deviceClass(::StringW value) ;

/// @brief Method get_manufacturer addr 0x29a3194 size 0x8 virtual false final false
 ::StringW get_manufacturer() ;

/// @brief Method set_manufacturer addr 0x29a319c size 0x8 virtual false final false
 void set_manufacturer(::StringW value) ;

/// @brief Method get_product addr 0x29a31a4 size 0x8 virtual false final false
 ::StringW get_product() ;

/// @brief Method set_product addr 0x29a31ac size 0x8 virtual false final false
 void set_product(::StringW value) ;

/// @brief Method get_serial addr 0x29a31b4 size 0x8 virtual false final false
 ::StringW get_serial() ;

/// @brief Method set_serial addr 0x29a31bc size 0x8 virtual false final false
 void set_serial(::StringW value) ;

/// @brief Method get_version addr 0x29a31c4 size 0x8 virtual false final false
 ::StringW get_version() ;

/// @brief Method set_version addr 0x29a31cc size 0x8 virtual false final false
 void set_version(::StringW value) ;

/// @brief Method get_capabilities addr 0x29a31d4 size 0x8 virtual false final false
 ::StringW get_capabilities() ;

/// @brief Method set_capabilities addr 0x29a31dc size 0x8 virtual false final false
 void set_capabilities(::StringW value) ;

/// @brief Method get_empty addr 0x29a31e4 size 0x84 virtual false final false
 bool get_empty() ;

/// @brief Method ToString addr 0x29a3268 size 0x304 virtual true final false
 ::StringW ToString() ;

/// @brief Method Equals addr 0x29a356c size 0xb0 virtual true final true
 bool Equals(UnityEngine::InputSystem::Layouts::InputDeviceDescription other) ;

/// @brief Method Equals addr 0x29a361c size 0x98 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x29a36b4 size 0x128 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x29a37dc size 0x38 virtual false final false
...
/// @brief Method op_Inequality addr 0x29a3814 size 0x3c virtual false final false
...
/// @brief Method ToJson addr 0x29a3850 size 0x80 virtual false final false
 ::StringW ToJson() ;

/// @brief Method FromJson addr 0x29a38d0 size 0xcc virtual false final false
static UnityEngine::InputSystem::Layouts::InputDeviceDescription FromJson(::StringW json) ;

/// @brief Method ComparePropertyToDeviceDescriptor addr 0x29a399c size 0x90 virtual false final false
