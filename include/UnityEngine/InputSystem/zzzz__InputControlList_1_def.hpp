...
template<::cordl_internals::il2cpp_reference_type TControl>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6327)), TypeDefinitionIndex(TypeDefinitionIndex(2638))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6327), inst: 2 })
...
template<::cordl_internals::il2cpp_reference_type TControl>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2638)), TypeDefinitionIndex(TypeDefinitionIndex(6328))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6328), inst: 2 })
