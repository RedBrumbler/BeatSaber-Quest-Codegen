...
/// @brief Method AlignToMultipleOf addr 0x29b122c size 0x1c virtual false final false
static int32_t AlignToMultipleOf(int32_t number, int32_t alignment) ;

/// @brief Method AlignToMultipleOf addr 0x29b1248 size 0x1c virtual false final false
static int64_t AlignToMultipleOf(int64_t number, int64_t alignment) ;

/// @brief Method AlignToMultipleOf addr 0x29b1264 size 0x1c virtual false final false
static uint32_t AlignToMultipleOf(uint32_t number, uint32_t alignment) ;

/// @brief Method Approximately addr 0x29b1280 size 0x9c virtual false final false
static bool Approximately(double_t a, double_t b) ;

/// @brief Method IntToNormalizedFloat addr 0x29b131c size 0x3c virtual false final false
static float_t IntToNormalizedFloat(int32_t value, int32_t minValue, int32_t maxValue) ;

/// @brief Method NormalizedFloatToInt addr 0x29b1358 size 0x50 virtual false final false
static int32_t NormalizedFloatToInt(float_t value, int32_t intMinValue, int32_t intMaxValue) ;

/// @brief Method UIntToNormalizedFloat addr 0x29b13a8 size 0x3c virtual false final false
static float_t UIntToNormalizedFloat(uint32_t value, uint32_t minValue, uint32_t maxValue) ;

/// @brief Method NormalizedFloatToUInt addr 0x29b13e4 size 0x48 virtual false final false
static uint32_t NormalizedFloatToUInt(float_t value, uint32_t uintMinValue, uint32_t uintMaxValue) ;

/// @brief Method RemapUIntBitsToNormalizeFloatToUIntBits addr 0x29b142c size 0x6c virtual false final false
