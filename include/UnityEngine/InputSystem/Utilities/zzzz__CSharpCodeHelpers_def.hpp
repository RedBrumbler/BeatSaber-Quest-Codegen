...
/// @brief Method IsProperIdentifier addr 0x29aa9d4 size 0x108 virtual false final false
static bool IsProperIdentifier(::StringW name) ;

/// @brief Method IsEmptyOrProperIdentifier addr 0x29aaadc size 0x2c virtual false final false
static bool IsEmptyOrProperIdentifier(::StringW name) ;

/// @brief Method IsEmptyOrProperNamespaceName addr 0x29aab08 size 0xd8 virtual false final false
static bool IsEmptyOrProperNamespaceName(::StringW name) ;

/// @brief Method MakeIdentifier addr 0x29aabe0 size 0x244 virtual false final false
static ::StringW MakeIdentifier(::StringW name, ::StringW suffix) ;

/// @brief Method MakeTypeName addr 0x29aae24 size 0x10c virtual false final false
