...
/// @brief Method .ctor addr 0x29ab2fc size 0x8 virtual false final false
 void _ctor(int32_t code) ;

/// @brief Method .ctor addr 0x29a707c size 0x20 virtual false final false
 void _ctor(char16_t a, char16_t b, char16_t c, char16_t d) ;

/// @brief Method .ctor addr 0x29ab304 size 0x170 virtual false final false
 void _ctor(::StringW str) ;

/// @brief Method op_Implicit addr 0x29ab474 size 0x4 virtual false final false
static int32_t op_Implicit_int32_t(UnityEngine::InputSystem::Utilities::FourCC fourCC) ;

/// @brief Method op_Implicit addr 0x29ab478 size 0x8 virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC op_Implicit_UnityEngine__InputSystem__Utilities__FourCC(int32_t i) ;

/// @brief Method ToString addr 0x29ab480 size 0x1b0 virtual true final false
 ::StringW ToString() ;

/// @brief Method Equals addr 0x29ab630 size 0x10 virtual true final true
 bool Equals(UnityEngine::InputSystem::Utilities::FourCC other) ;

/// @brief Method Equals addr 0x29ab640 size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x29ab6b8 size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x29ab6c0 size 0xc virtual false final false
static bool op_Equality(UnityEngine::InputSystem::Utilities::FourCC left, UnityEngine::InputSystem::Utilities::FourCC right) ;

/// @brief Method op_Inequality addr 0x29ab6cc size 0xc virtual false final false
static bool op_Inequality(UnityEngine::InputSystem::Utilities::FourCC left, UnityEngine::InputSystem::Utilities::FourCC right) ;

/// @brief Method FromInt32 addr 0x29ab6d8 size 0x8 virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC FromInt32(int32_t i) ;

/// @brief Method ToInt32 addr 0x29ab6e0 size 0x4 virtual false final false
