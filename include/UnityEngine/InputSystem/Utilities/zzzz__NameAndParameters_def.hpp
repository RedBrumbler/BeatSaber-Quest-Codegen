...
/// @brief Method .ctor addr 0x29b012c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ToString>b__8_0 addr 0x29b0134 size 0x8 virtual false final false
...
/// @brief Method get_name addr 0x29af610 size 0x8 virtual false final false
 ::StringW get_name() ;

/// @brief Method set_name addr 0x29af618 size 0x8 virtual false final false
 void set_name(::StringW value) ;

/// @brief Method get_parameters addr 0x29af620 size 0xc virtual false final false
 UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<UnityEngine::InputSystem::Utilities::NamedValue> get_parameters() ;

/// @brief Method set_parameters addr 0x29af62c size 0x8 virtual false final false
 void set_parameters(UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<UnityEngine::InputSystem::Utilities::NamedValue> value) ;

/// @brief Method ToString addr 0x29af634 size 0x1e8 virtual true final false
 ::StringW ToString() ;

/// @brief Method ParseMultiple addr 0x29af81c size 0x9c virtual false final false
...
/// @brief Method ParseMultiple addr 0x29af8b8 size 0x1dc virtual false final false
...
/// @brief Method ParseName addr 0x29afe20 size 0x80 virtual false final false
static ::StringW ParseName(::StringW text) ;

/// @brief Method Parse addr 0x29afea0 size 0x90 virtual false final false
static UnityEngine::InputSystem::Utilities::NameAndParameters Parse(::StringW text) ;

/// @brief Method ParseNameAndParameters addr 0x29afa94 size 0x38c virtual false final false
