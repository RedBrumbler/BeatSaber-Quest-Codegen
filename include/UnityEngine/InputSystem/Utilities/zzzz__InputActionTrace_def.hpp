...
/// @brief Method get_action addr 0x29aa3b0 size 0x28 virtual false final false
 UnityEngine::InputSystem::InputAction get_action() ;

/// @brief Method get_phase addr 0x29aa3d8 size 0xc virtual false final false
 UnityEngine::InputSystem::InputActionPhase get_phase() ;

/// @brief Method get_control addr 0x29aa3e4 size 0x40 virtual false final false
 UnityEngine::InputSystem::InputControl get_control() ;

/// @brief Method get_interaction addr 0x29aa424 size 0x58 virtual false final false
 UnityEngine::InputSystem::IInputInteraction get_interaction() ;

/// @brief Method get_time addr 0x29aa47c size 0x1c virtual false final false
 double_t get_time() ;

/// @brief Method get_startTime addr 0x29aa498 size 0xc virtual false final false
 double_t get_startTime() ;

/// @brief Method get_duration addr 0x29aa4a4 size 0x30 virtual false final false
 double_t get_duration() ;

/// @brief Method get_valueSizeInBytes addr 0x29aa4d4 size 0xc virtual false final false
 int32_t get_valueSizeInBytes() ;

/// @brief Method ReadValueAsObject addr 0x29aa4e0 size 0x244 virtual false final false
 ::bs_hook::Il2CppWrapperType ReadValueAsObject() ;

/// @brief Method ReadValue addr 0x29aa724 size 0x104 virtual false final false
...
/// @brief Method ToString addr 0x29a9cfc size 0x2f4 virtual true final false
 ::StringW ToString() ;
...
/// @brief Method .ctor addr 0x29aa008 size 0x48 virtual false final false
 void _ctor(UnityEngine::InputSystem::Utilities::InputActionTrace trace) ;

/// @brief Method MoveNext addr 0x29aa828 size 0x64 virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x29aa88c size 0xc virtual true final true
 void Reset() ;

/// @brief Method Dispose addr 0x29aa898 size 0x4 virtual true final true
 void Dispose() ;

/// @brief Method get_Current addr 0x29aa89c size 0x64 virtual true final true
 UnityEngine::InputSystem::Utilities::UnityEngine__InputSystem__Utilities__InputActionTrace__ActionEventPtr get_Current() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x29aa900 size 0x64 virtual true final true
...
/// @brief Method get_buffer addr 0x29a8d14 size 0x10 virtual false final false
 UnityEngine::InputSystem::LowLevel::InputEventBuffer get_buffer() ;

/// @brief Method get_count addr 0x29a8d24 size 0x8 virtual false final false
 int32_t get_count() ;

// Ctor Parameters []
explicit InputActionTrace() ;

/// @brief Method .ctor addr 0x29a8d2c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x29a8d34 size 0x7c virtual false final false
...
/// @brief Method .ctor addr 0x29a8ee4 size 0x7c virtual false final false
 void _ctor(UnityEngine::InputSystem::InputActionMap actionMap) ;

/// @brief Method SubscribeToAll addr 0x29a9074 size 0xdc virtual false final false
 void SubscribeToAll() ;

/// @brief Method UnsubscribeFromAll addr 0x29a942c size 0xd8 virtual false final false
 void UnsubscribeFromAll() ;

/// @brief Method SubscribeTo addr 0x29a8db0 size 0x134 virtual false final false
 void SubscribeTo(UnityEngine::InputSystem::InputAction action) ;

/// @brief Method SubscribeTo addr 0x29a8f60 size 0x114 virtual false final false
 void SubscribeTo(UnityEngine::InputSystem::InputActionMap actionMap) ;

/// @brief Method UnsubscribeFrom addr 0x29a9214 size 0x11c virtual false final false
 void UnsubscribeFrom(UnityEngine::InputSystem::InputAction action) ;

/// @brief Method UnsubscribeFrom addr 0x29a9330 size 0xfc virtual false final false
 void UnsubscribeFrom(UnityEngine::InputSystem::InputActionMap actionMap) ;

/// @brief Method RecordAction addr 0x29a9570 size 0x1d0 virtual false final false
 void RecordAction(UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext context) ;

/// @brief Method Clear addr 0x29a9740 size 0x54 virtual false final false
 void Clear() ;

/// @brief Method Finalize addr 0x29a9794 size 0x94 virtual true final false
 void Finalize() ;

/// @brief Method ToString addr 0x29a9928 size 0x35c virtual true final false
 ::StringW ToString() ;

/// @brief Method Dispose addr 0x29a9ff0 size 0x18 virtual true final true
 void Dispose() ;

/// @brief Method DisposeInternal addr 0x29a9828 size 0x100 virtual false final false
 void DisposeInternal() ;

/// @brief Method GetEnumerator addr 0x29a9c84 size 0x78 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x29aa050 size 0x4 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method HookOnActionChange addr 0x29a9150 size 0xc4 virtual false final false
 void HookOnActionChange() ;

/// @brief Method UnhookOnActionChange addr 0x29a9504 size 0x6c virtual false final false
 void UnhookOnActionChange() ;

/// @brief Method OnActionChange addr 0x29aa054 size 0x264 virtual false final false
 void OnActionChange(::bs_hook::Il2CppWrapperType actionOrMapOrAsset, UnityEngine::InputSystem::InputActionChange change) ;

/// @brief Method CloneActionStateBeforeBindingsChange addr 0x29aa2b8 size 0xf8 virtual false final false
