...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6792), inst: 80 })
...
template<::cordl_internals::il2cpp_reference_type TSource,::cordl_internals::il2cpp_reference_type TResult>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6793))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6793), inst: 80 })
