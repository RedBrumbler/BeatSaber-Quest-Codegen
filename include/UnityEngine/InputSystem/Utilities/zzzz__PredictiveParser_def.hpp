...
/// @brief Method ExpectSingleChar addr 0x29b189c size 0x108 virtual false final false
 void ExpectSingleChar(System::ReadOnlySpan_1<char16_t> str, char16_t c) ;

/// @brief Method ExpectInt addr 0x29b19a4 size 0x12c virtual false final false
 int32_t ExpectInt(System::ReadOnlySpan_1<char16_t> str) ;

/// @brief Method ExpectString addr 0x29b1ad0 size 0x234 virtual false final false
 System::ReadOnlySpan_1<char16_t> ExpectString(System::ReadOnlySpan_1<char16_t> str) ;

/// @brief Method AcceptSingleChar addr 0x29b1d04 size 0x3c virtual false final false
 bool AcceptSingleChar(System::ReadOnlySpan_1<char16_t> str, char16_t c) ;

/// @brief Method AcceptString addr 0x29b1d40 size 0x130 virtual false final false
 bool AcceptString(System::ReadOnlySpan_1<char16_t> input, ByRef<System::ReadOnlySpan_1<char16_t>> output) ;

/// @brief Method AcceptInt addr 0x29b1e70 size 0x5c virtual false final false
