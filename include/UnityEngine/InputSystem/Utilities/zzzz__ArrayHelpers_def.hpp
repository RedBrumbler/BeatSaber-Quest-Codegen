...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6758), inst: 2 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6758))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6758), inst: 2502 })
// CS Name: UnityEngine.InputSystem.Utilities.ArrayHelpers::<>c__DisplayClass33_0`1
...
template<::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6759))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6759), inst: 2 })
...
template<::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6760))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6760), inst: 2 })
