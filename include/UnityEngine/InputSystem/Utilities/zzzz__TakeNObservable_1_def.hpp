...
template<::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6794))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6794), inst: 2 })
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6795), inst: 2 })
