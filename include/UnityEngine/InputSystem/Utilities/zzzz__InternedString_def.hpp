...
/// @brief Method get_length addr 0x29ab6e4 size 0x18 virtual false final false
 int32_t get_length() ;

/// @brief Method .ctor addr 0x29ab6fc size 0xa8 virtual false final false
 void _ctor(::StringW text) ;

/// @brief Method IsEmpty addr 0x29ab7a4 size 0x10 virtual false final false
 bool IsEmpty() ;

/// @brief Method ToLower addr 0x29ab7b4 size 0x8 virtual false final false
 ::StringW ToLower() ;

/// @brief Method Equals addr 0x29ab7bc size 0x114 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x29ab8d0 size 0x10 virtual true final true
 bool Equals(UnityEngine::InputSystem::Utilities::InternedString other) ;

/// @brief Method CompareTo addr 0x29ab8e0 size 0x14 virtual true final true
 int32_t CompareTo(UnityEngine::InputSystem::Utilities::InternedString other) ;

/// @brief Method GetHashCode addr 0x29ab8f4 size 0x18 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x29a4f1c size 0x54 virtual true final false
 ::StringW ToString() ;

/// @brief Method op_Equality addr 0x29a4a2c size 0xc virtual false final false
...
/// @brief Method op_Inequality addr 0x29ab90c size 0xc virtual false final false
...
/// @brief Method op_Equality addr 0x29ab918 size 0x98 virtual false final false
static bool op_Equality(UnityEngine::InputSystem::Utilities::InternedString a, ::StringW b) ;

/// @brief Method op_Inequality addr 0x29ab9b0 size 0x98 virtual false final false
static bool op_Inequality(UnityEngine::InputSystem::Utilities::InternedString a, ::StringW b) ;

/// @brief Method op_Equality addr 0x29aba48 size 0x94 virtual false final false
static bool op_Equality(::StringW a, UnityEngine::InputSystem::Utilities::InternedString b) ;

/// @brief Method op_Inequality addr 0x29abadc size 0x94 virtual false final false
static bool op_Inequality(::StringW a, UnityEngine::InputSystem::Utilities::InternedString b) ;

/// @brief Method op_LessThan addr 0x29abb70 size 0x24 virtual false final false
...
/// @brief Method op_GreaterThan addr 0x29abb94 size 0x28 virtual false final false
...
/// @brief Method op_Implicit addr 0x29a4a38 size 0x54 virtual false final false
