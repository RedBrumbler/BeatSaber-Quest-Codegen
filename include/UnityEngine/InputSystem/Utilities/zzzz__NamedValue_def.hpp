...
/// @brief Method get_name addr 0x29b01d0 size 0x8 virtual false final false
 ::StringW get_name() ;

/// @brief Method set_name addr 0x29b01d8 size 0x8 virtual false final false
 void set_name(::StringW value) ;

/// @brief Method get_value addr 0x29b01e0 size 0xc virtual false final false
 UnityEngine::InputSystem::Utilities::PrimitiveValue get_value() ;

/// @brief Method set_value addr 0x29b01ec size 0x8 virtual false final false
 void set_value(UnityEngine::InputSystem::Utilities::PrimitiveValue value) ;

/// @brief Method get_type addr 0x29b01f4 size 0x8 virtual false final false
 System::TypeCode get_type() ;

/// @brief Method ConvertTo addr 0x29b01fc size 0x3c virtual false final false
...
/// @brief Method ToString addr 0x29b013c size 0x94 virtual true final false
 ::StringW ToString() ;

/// @brief Method Equals addr 0x29b0430 size 0x5c virtual true final true
 bool Equals(UnityEngine::InputSystem::Utilities::NamedValue other) ;

/// @brief Method Equals addr 0x29b04b8 size 0x90 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x29b0548 size 0x5c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x29b062c size 0x30 virtual false final false
...
/// @brief Method op_Inequality addr 0x29b065c size 0x34 virtual false final false
...
/// @brief Method ParseMultiple addr 0x29aff30 size 0x198 virtual false final false
static ::ArrayW<UnityEngine::InputSystem::Utilities::NamedValue> ParseMultiple(::StringW parameterString) ;

/// @brief Method Parse addr 0x29b0a54 size 0x38 virtual false final false
static UnityEngine::InputSystem::Utilities::NamedValue Parse(::StringW str) ;

/// @brief Method ParseParameter addr 0x29b0700 size 0x354 virtual false final false
static UnityEngine::InputSystem::Utilities::NamedValue ParseParameter(::StringW parameterString, ByRef<int32_t> index) ;

/// @brief Method ApplyToObject addr 0x29b0d94 size 0x2e8 virtual false final false
