...
/// @brief Method OnPointerUp addr 0x29752f4 size 0x4c virtual true final true
 void OnPointerUp(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnPointerDown addr 0x2975340 size 0x4c virtual true final true
 void OnPointerDown(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method get_controlPathInternal addr 0x297538c size 0x8 virtual true final false
 ::StringW get_controlPathInternal() ;

/// @brief Method set_controlPathInternal addr 0x2975394 size 0x8 virtual true final false
 void set_controlPathInternal(::StringW value) ;

// Ctor Parameters []
explicit OnScreenButton() ;

/// @brief Method .ctor addr 0x297539c size 0x8 virtual false final false
 void _ctor() ;
