...
/// @brief Method AddControl addr 0x2975d9c size 0x2c virtual false final false
...
/// @brief Method RemoveControl addr 0x2976114 size 0x110 virtual false final false
...
/// @brief Method Destroy addr 0x2975ce8 size 0xb4 virtual false final false
 void Destroy() ;
...
/// @brief Method get_controlPath addr 0x29753ac size 0xc virtual false final false
 ::StringW get_controlPath() ;

/// @brief Method set_controlPath addr 0x29753b8 size 0x38 virtual false final false
 void set_controlPath(::StringW value) ;

/// @brief Method get_control addr 0x2975ce0 size 0x8 virtual false final false
...
/// @brief Method SetupInputControl addr 0x29753f0 size 0x8f0 virtual false final false
...
/// @brief Method SentDefaultValueToControl addr 0x2975dc8 size 0x134 virtual false final false
 void SentDefaultValueToControl() ;

/// @brief Method OnEnable addr 0x2975efc size 0x4 virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2975f00 size 0x214 virtual true final false
 void OnDisable() ;

// Ctor Parameters []
explicit OnScreenControl() ;

/// @brief Method .ctor addr 0x29753a4 size 0x8 virtual false final false
 void _ctor() ;
