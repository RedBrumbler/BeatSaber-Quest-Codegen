...
namespace UnityEngine::InputSystem::OnScreen {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6490))}
...
/// @brief Method OnPointerDown addr 0x2976224 size 0x124 virtual true final true
 void OnPointerDown(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnDrag addr 0x2976348 size 0x224 virtual true final true
 void OnDrag(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnPointerUp addr 0x297656c size 0xc4 virtual true final true
 void OnPointerUp(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method Start addr 0x2976630 size 0x78 virtual false final false
 void Start() ;

/// @brief Method get_movementRange addr 0x29766a8 size 0x8 virtual false final false
 float_t get_movementRange() ;

/// @brief Method set_movementRange addr 0x29766b0 size 0x8 virtual false final false
 void set_movementRange(float_t value) ;

/// @brief Method get_controlPathInternal addr 0x29766b8 size 0x8 virtual true final false
 ::StringW get_controlPathInternal() ;

/// @brief Method set_controlPathInternal addr 0x29766c0 size 0x8 virtual true final false
 void set_controlPathInternal(::StringW value) ;

// Ctor Parameters []
explicit OnScreenStick() ;

/// @brief Method .ctor addr 0x29766c8 size 0x10 virtual false final false
 void _ctor() ;
