...
/// @brief Method FinishSetup addr 0x29a74c0 size 0xac virtual true final false
 void FinishSetup() ;

/// @brief Method ReadUnprocessedValueFromState addr 0x29a756c size 0x48 virtual true final false
 float_t ReadUnprocessedValueFromState(void* statePtr) ;

/// @brief Method WriteValueIntoState addr 0x29a7748 size 0x40 virtual true final false
 void WriteValueIntoState(float_t value, void* statePtr) ;

// Ctor Parameters []
explicit TouchPressControl() ;

/// @brief Method .ctor addr 0x29a7788 size 0x4 virtual false final false
 void _ctor() ;
