...
namespace UnityEngine::InputSystem::Controls {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6731))}
...
/// @brief Method get_keyCode addr 0x29a68d4 size 0x8 virtual false final false
 UnityEngine::InputSystem::Key get_keyCode() ;

/// @brief Method set_keyCode addr 0x29a68dc size 0x8 virtual false final false
 void set_keyCode(UnityEngine::InputSystem::Key value) ;

/// @brief Method get_scanCode addr 0x29a68e4 size 0x1c virtual false final false
 int32_t get_scanCode() ;

/// @brief Method RefreshConfiguration addr 0x29a6900 size 0x170 virtual true final false
 void RefreshConfiguration() ;

// Ctor Parameters []
explicit KeyControl() ;

/// @brief Method .ctor addr 0x29a6a70 size 0x4 virtual false final false
 void _ctor() ;
