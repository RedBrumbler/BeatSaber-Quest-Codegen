...
/// @brief Method .ctor addr 0x29a51b4 size 0x70 virtual false final false
 void _ctor() ;

/// @brief Method ReadUnprocessedValueFromState addr 0x29a52ac size 0x28 virtual true final false
