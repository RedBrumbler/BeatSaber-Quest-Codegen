...
/// @brief Method FinishSetup addr 0x29a5da8 size 0xac virtual true final false
 void FinishSetup() ;

/// @brief Method ReadUnprocessedValueFromState addr 0x29a5e54 size 0x9c virtual true final false
 float_t ReadUnprocessedValueFromState(void* statePtr) ;

/// @brief Method WriteValueIntoState addr 0x29a5ef4 size 0xe8 virtual true final false
 void WriteValueIntoState(float_t value, void* statePtr) ;

// Ctor Parameters []
explicit DiscreteButtonControl() ;

/// @brief Method .ctor addr 0x29a5fe0 size 0x4 virtual false final false
 void _ctor() ;
