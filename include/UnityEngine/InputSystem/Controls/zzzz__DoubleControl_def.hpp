...
namespace UnityEngine::InputSystem::Controls {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6318)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6318), inst: 2602 })}
...
/// @brief Method .ctor addr 0x29a5fe4 size 0x88 virtual false final false
 void _ctor() ;

/// @brief Method ReadUnprocessedValueFromState addr 0x29a606c size 0xc virtual true final false
 double_t ReadUnprocessedValueFromState(void* statePtr) ;

/// @brief Method WriteValueIntoState addr 0x29a6078 size 0xc virtual true final false
