...
namespace UnityEngine::InputSystem::Controls {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6318)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6318), inst: 92 })}
...
/// @brief Method .ctor addr 0x29a6828 size 0x88 virtual false final false
 void _ctor() ;

/// @brief Method ReadUnprocessedValueFromState addr 0x29a68b0 size 0xc virtual true final false
 int32_t ReadUnprocessedValueFromState(void* statePtr) ;

/// @brief Method WriteValueIntoState addr 0x29a68bc size 0x18 virtual true final false
