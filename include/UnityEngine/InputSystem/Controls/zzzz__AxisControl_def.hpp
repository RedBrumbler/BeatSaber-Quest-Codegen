...
namespace UnityEngine::InputSystem::Controls {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6318)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6318), inst: 374 })}
...
/// @brief Method Preprocess addr 0x29a52d4 size 0xd4 virtual false final false
 float_t Preprocess(float_t value) ;

/// @brief Method Unpreprocess addr 0x29a53a8 size 0x4c virtual false final false
 float_t Unpreprocess(float_t value) ;

// Ctor Parameters []
explicit AxisControl() ;

/// @brief Method .ctor addr 0x29a53f4 size 0x88 virtual false final false
 void _ctor() ;

/// @brief Method FinishSetup addr 0x29a547c size 0xa4 virtual true final false
 void FinishSetup() ;

/// @brief Method ReadUnprocessedValueFromState addr 0x29a5520 size 0x34 virtual true final false
 float_t ReadUnprocessedValueFromState(void* statePtr) ;

/// @brief Method WriteValueIntoState addr 0x29a5554 size 0x40 virtual true final false
 void WriteValueIntoState(float_t value, void* statePtr) ;

/// @brief Method CompareValue addr 0x29a5594 size 0xec virtual true final false
 bool CompareValue(void* firstStatePtr, void* secondStatePtr) ;

/// @brief Method EvaluateMagnitude addr 0x29a5680 size 0xe8 virtual true final false
