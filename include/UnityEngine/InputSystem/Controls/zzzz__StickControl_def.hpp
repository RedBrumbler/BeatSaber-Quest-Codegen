...
/// @brief Method get_up addr 0x29a6db8 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_up() ;

/// @brief Method set_up addr 0x29a6dc0 size 0x8 virtual false final false
 void set_up(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_down addr 0x29a6dc8 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_down() ;

/// @brief Method set_down addr 0x29a6dd0 size 0x8 virtual false final false
 void set_down(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_left addr 0x29a6dd8 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_left() ;

/// @brief Method set_left addr 0x29a6de0 size 0x8 virtual false final false
 void set_left(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_right addr 0x29a6de8 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_right() ;

/// @brief Method set_right addr 0x29a6df0 size 0x8 virtual false final false
 void set_right(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method FinishSetup addr 0x29a6df8 size 0xf8 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit StickControl() ;

/// @brief Method .ctor addr 0x29a6ef0 size 0x4 virtual false final false
 void _ctor() ;
