...
namespace UnityEngine::InputSystem::Controls {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6318), inst: 3764 }), TypeDefinitionIndex(TypeDefinitionIndex(6616)), TypeDefinitionIndex(TypeDefinitionIndex(6318))}
...
/// @brief Method get_press addr 0x29a6ef4 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::TouchPressControl get_press() ;

/// @brief Method set_press addr 0x29a6efc size 0x8 virtual false final false
 void set_press(UnityEngine::InputSystem::Controls::TouchPressControl value) ;

/// @brief Method get_touchId addr 0x29a6f04 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::IntegerControl get_touchId() ;

/// @brief Method set_touchId addr 0x29a6f0c size 0x8 virtual false final false
 void set_touchId(UnityEngine::InputSystem::Controls::IntegerControl value) ;

/// @brief Method get_position addr 0x29a6f14 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector2Control get_position() ;

/// @brief Method set_position addr 0x29a6f1c size 0x8 virtual false final false
 void set_position(UnityEngine::InputSystem::Controls::Vector2Control value) ;

/// @brief Method get_delta addr 0x29a6f24 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::DeltaControl get_delta() ;

/// @brief Method set_delta addr 0x29a6f2c size 0x8 virtual false final false
 void set_delta(UnityEngine::InputSystem::Controls::DeltaControl value) ;

/// @brief Method get_pressure addr 0x29a6f34 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_pressure() ;

/// @brief Method set_pressure addr 0x29a6f3c size 0x8 virtual false final false
 void set_pressure(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_radius addr 0x29a6f44 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector2Control get_radius() ;

/// @brief Method set_radius addr 0x29a6f4c size 0x8 virtual false final false
 void set_radius(UnityEngine::InputSystem::Controls::Vector2Control value) ;

/// @brief Method get_phase addr 0x29a6f54 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::TouchPhaseControl get_phase() ;

/// @brief Method set_phase addr 0x29a6f5c size 0x8 virtual false final false
 void set_phase(UnityEngine::InputSystem::Controls::TouchPhaseControl value) ;

/// @brief Method get_indirectTouch addr 0x29a6f64 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_indirectTouch() ;

/// @brief Method set_indirectTouch addr 0x29a6f6c size 0x8 virtual false final false
 void set_indirectTouch(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_tap addr 0x29a6f74 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_tap() ;

/// @brief Method set_tap addr 0x29a6f7c size 0x8 virtual false final false
 void set_tap(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_tapCount addr 0x29a6f84 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::IntegerControl get_tapCount() ;

/// @brief Method set_tapCount addr 0x29a6f8c size 0x8 virtual false final false
 void set_tapCount(UnityEngine::InputSystem::Controls::IntegerControl value) ;

/// @brief Method get_startTime addr 0x29a6f94 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::DoubleControl get_startTime() ;

/// @brief Method set_startTime addr 0x29a6f9c size 0x8 virtual false final false
 void set_startTime(UnityEngine::InputSystem::Controls::DoubleControl value) ;

/// @brief Method get_startPosition addr 0x29a6fa4 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector2Control get_startPosition() ;

/// @brief Method set_startPosition addr 0x29a6fac size 0x8 virtual false final false
 void set_startPosition(UnityEngine::InputSystem::Controls::Vector2Control value) ;

/// @brief Method get_isInProgress addr 0x29a6fb4 size 0x70 virtual false final false
 bool get_isInProgress() ;

// Ctor Parameters []
explicit TouchControl() ;

/// @brief Method .ctor addr 0x29a7024 size 0x58 virtual false final false
 void _ctor() ;

/// @brief Method FinishSetup addr 0x29a709c size 0x2d4 virtual true final false
 void FinishSetup() ;

/// @brief Method ReadUnprocessedValueFromState addr 0x29a7370 size 0x24 virtual true final false
 UnityEngine::InputSystem::LowLevel::TouchState ReadUnprocessedValueFromState(void* statePtr) ;

/// @brief Method WriteValueIntoState addr 0x29a7394 size 0x70 virtual true final false
