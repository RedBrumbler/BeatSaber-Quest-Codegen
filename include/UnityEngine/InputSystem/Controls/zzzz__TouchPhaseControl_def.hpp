...
namespace UnityEngine::InputSystem::Controls {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6318), inst: 3763 }), TypeDefinitionIndex(TypeDefinitionIndex(6389)), TypeDefinitionIndex(TypeDefinitionIndex(6318))}
...
/// @brief Method .ctor addr 0x29a7404 size 0x88 virtual false final false
 void _ctor() ;

/// @brief Method ReadUnprocessedValueFromState addr 0x29a748c size 0x28 virtual true final false
 UnityEngine::InputSystem::TouchPhase ReadUnprocessedValueFromState(void* statePtr) ;

/// @brief Method WriteValueIntoState addr 0x29a74b4 size 0xc virtual true final false
