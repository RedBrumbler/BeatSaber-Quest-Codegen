...
/// @brief Method get_pressPointOrDefault addr 0x29a578c size 0x58 virtual false final false
 float_t get_pressPointOrDefault() ;

// Ctor Parameters []
explicit ButtonControl() ;

/// @brief Method .ctor addr 0x29a5224 size 0x88 virtual false final false
 void _ctor() ;

/// @brief Method IsValueConsideredPressed addr 0x29a57f8 size 0x6c virtual false final false
 bool IsValueConsideredPressed(float_t value) ;

/// @brief Method get_isPressed addr 0x29a5864 size 0xa0 virtual false final false
 bool get_isPressed() ;

/// @brief Method get_wasPressedThisFrame addr 0x29a5904 size 0x120 virtual false final false
 bool get_wasPressedThisFrame() ;

/// @brief Method get_wasReleasedThisFrame addr 0x29a5a24 size 0x120 virtual false final false
