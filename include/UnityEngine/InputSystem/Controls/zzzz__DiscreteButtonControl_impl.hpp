...
constexpr void UnityEngine::InputSystem::Controls::UnityEngine__InputSystem__Controls__DiscreteButtonControl__WriteMode::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::InputSystem::Controls::UnityEngine__InputSystem__Controls__DiscreteButtonControl__WriteMode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr UnityEngine::InputSystem::Controls::UnityEngine__InputSystem__Controls__DiscreteButtonControl__WriteMode  UnityEngine::InputSystem::Controls::UnityEngine__InputSystem__Controls__DiscreteButtonControl__WriteMode::WriteDisabled{0};
constexpr UnityEngine::InputSystem::Controls::UnityEngine__InputSystem__Controls__DiscreteButtonControl__WriteMode  UnityEngine::InputSystem::Controls::UnityEngine__InputSystem__Controls__DiscreteButtonControl__WriteMode::WriteNullAndMaxValue{1};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::InputSystem::Controls::DiscreteButtonControl::*)()>(&UnityEngine::InputSystem::Controls::DiscreteButtonControl::FinishSetup)> {
  ...
  constexpr static std::size_t addrs = 0x29a5da8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (UnityEngine::InputSystem::Controls::DiscreteButtonControl::*)(void*)>(&UnityEngine::InputSystem::Controls::DiscreteButtonControl::ReadUnprocessedValueFromState)> {
  ...
  constexpr static std::size_t addrs = 0x29a5e54;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::InputSystem::Controls::DiscreteButtonControl::*)(float_t, void*)>(&UnityEngine::InputSystem::Controls::DiscreteButtonControl::WriteValueIntoState)> {
  ...
  constexpr static std::size_t addrs = 0x29a5ef4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::InputSystem::Controls::DiscreteButtonControl::*)()>(&UnityEngine::InputSystem::Controls::DiscreteButtonControl::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x29a5fe0;
...
constexpr void UnityEngine::InputSystem::Controls::DiscreteButtonControl::__set_writeMode(UnityEngine::InputSystem::Controls::UnityEngine__InputSystem__Controls__DiscreteButtonControl__WriteMode value)  {
::cordl_internals::setInstanceField<UnityEngine::InputSystem::Controls::UnityEngine__InputSystem__Controls__DiscreteButtonControl__WriteMode, 0x12c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::InputSystem::Controls::UnityEngine__InputSystem__Controls__DiscreteButtonControl__WriteMode>(value));
}
constexpr UnityEngine::InputSystem::Controls::UnityEngine__InputSystem__Controls__DiscreteButtonControl__WriteMode UnityEngine::InputSystem::Controls::DiscreteButtonControl::__get_writeMode() const {
return ::cordl_internals::getInstanceField<UnityEngine::InputSystem::Controls::UnityEngine__InputSystem__Controls__DiscreteButtonControl__WriteMode, 0x12c>(this->::bs_hook::Il2CppWrapperType::instance);
}
