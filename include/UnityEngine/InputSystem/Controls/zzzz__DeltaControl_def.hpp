...
/// @brief Method get_up addr 0x29a5b44 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_up() ;

/// @brief Method set_up addr 0x29a5b4c size 0x8 virtual false final false
 void set_up(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_down addr 0x29a5b54 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_down() ;

/// @brief Method set_down addr 0x29a5b5c size 0x8 virtual false final false
 void set_down(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_left addr 0x29a5b64 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_left() ;

/// @brief Method set_left addr 0x29a5b6c size 0x8 virtual false final false
 void set_left(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_right addr 0x29a5b74 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_right() ;

/// @brief Method set_right addr 0x29a5b7c size 0x8 virtual false final false
 void set_right(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method FinishSetup addr 0x29a5b84 size 0xf8 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit DeltaControl() ;

/// @brief Method .ctor addr 0x29a5d1c size 0x4 virtual false final false
 void _ctor() ;
