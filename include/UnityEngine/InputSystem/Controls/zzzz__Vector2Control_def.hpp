...
namespace UnityEngine::InputSystem::Controls {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10203)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6318), inst: 393 }), TypeDefinitionIndex(TypeDefinitionIndex(6318))}
...
/// @brief Method get_x addr 0x29a778c size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_x() ;

/// @brief Method set_x addr 0x29a7794 size 0x8 virtual false final false
 void set_x(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_y addr 0x29a779c size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_y() ;

/// @brief Method set_y addr 0x29a77a4 size 0x8 virtual false final false
 void set_y(UnityEngine::InputSystem::Controls::AxisControl value) ;

// Ctor Parameters []
explicit Vector2Control() ;

/// @brief Method .ctor addr 0x29a5d20 size 0x88 virtual false final false
 void _ctor() ;

/// @brief Method FinishSetup addr 0x29a5c7c size 0xa0 virtual true final false
 void FinishSetup() ;

/// @brief Method ReadUnprocessedValueFromState addr 0x29a77ac size 0x68 virtual true final false
 UnityEngine::Vector2 ReadUnprocessedValueFromState(void* statePtr) ;

/// @brief Method WriteValueIntoState addr 0x29a7814 size 0x60 virtual true final false
 void WriteValueIntoState(UnityEngine::Vector2 value, void* statePtr) ;

/// @brief Method EvaluateMagnitude addr 0x29a7874 size 0xb4 virtual true final false
