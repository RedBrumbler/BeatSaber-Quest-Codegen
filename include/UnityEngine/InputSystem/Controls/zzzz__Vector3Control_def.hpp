...
namespace UnityEngine::InputSystem::Controls {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10209)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6318), inst: 394 }), TypeDefinitionIndex(TypeDefinitionIndex(6318))}
...
/// @brief Method get_x addr 0x29a7928 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_x() ;

/// @brief Method set_x addr 0x29a7930 size 0x8 virtual false final false
 void set_x(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_y addr 0x29a7938 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_y() ;

/// @brief Method set_y addr 0x29a7940 size 0x8 virtual false final false
 void set_y(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_z addr 0x29a7948 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_z() ;

/// @brief Method set_z addr 0x29a7950 size 0x8 virtual false final false
 void set_z(UnityEngine::InputSystem::Controls::AxisControl value) ;

// Ctor Parameters []
explicit Vector3Control() ;

/// @brief Method .ctor addr 0x29a7958 size 0x88 virtual false final false
 void _ctor() ;

/// @brief Method FinishSetup addr 0x29a79e0 size 0xd0 virtual true final false
 void FinishSetup() ;

/// @brief Method ReadUnprocessedValueFromState addr 0x29a7ab0 size 0x8c virtual true final false
 UnityEngine::Vector3 ReadUnprocessedValueFromState(void* statePtr) ;

/// @brief Method WriteValueIntoState addr 0x29a7b3c size 0x84 virtual true final false
 void WriteValueIntoState(UnityEngine::Vector3 value, void* statePtr) ;

/// @brief Method EvaluateMagnitude addr 0x29a7bc0 size 0xc8 virtual true final false
