...
/// @brief Method get_customBindings addr 0x296be68 size 0x8 virtual false final false
 ::StringW get_customBindings() ;

/// @brief Method set_customBindings addr 0x296be70 size 0x8 virtual false final false
 void set_customBindings(::StringW value) ;

/// @brief Method get_invertMouseX addr 0x296be78 size 0x8 virtual false final false
 bool get_invertMouseX() ;

/// @brief Method set_invertMouseX addr 0x296be80 size 0xc virtual false final false
 void set_invertMouseX(bool value) ;

/// @brief Method get_invertMouseY addr 0x296be8c size 0x8 virtual false final false
 bool get_invertMouseY() ;

/// @brief Method set_invertMouseY addr 0x296be94 size 0xc virtual false final false
 void set_invertMouseY(bool value) ;

/// @brief Method get_mouseSmoothing addr 0x296bea0 size 0x8 virtual false final false
 System::Nullable_1<float_t> get_mouseSmoothing() ;

/// @brief Method set_mouseSmoothing addr 0x296bea8 size 0x8 virtual false final false
 void set_mouseSmoothing(System::Nullable_1<float_t> value) ;

/// @brief Method get_mouseSensitivity addr 0x296beb0 size 0x8 virtual false final false
 System::Nullable_1<float_t> get_mouseSensitivity() ;

/// @brief Method set_mouseSensitivity addr 0x296beb8 size 0x8 virtual false final false
 void set_mouseSensitivity(System::Nullable_1<float_t> value) ;

/// @brief Method get_invertStickX addr 0x296bec0 size 0x8 virtual false final false
 bool get_invertStickX() ;

/// @brief Method set_invertStickX addr 0x296bec8 size 0xc virtual false final false
 void set_invertStickX(bool value) ;

/// @brief Method get_invertStickY addr 0x296bed4 size 0x8 virtual false final false
 bool get_invertStickY() ;

/// @brief Method set_invertStickY addr 0x296bedc size 0xc virtual false final false
 void set_invertStickY(bool value) ;

/// @brief Method get_swapSticks addr 0x296bee8 size 0x8 virtual false final false
 bool get_swapSticks() ;

/// @brief Method set_swapSticks addr 0x296bef0 size 0xc virtual false final false
 void set_swapSticks(bool value) ;

/// @brief Method get_swapBumpers addr 0x296befc size 0x8 virtual false final false
 bool get_swapBumpers() ;

/// @brief Method set_swapBumpers addr 0x296bf04 size 0xc virtual false final false
 void set_swapBumpers(bool value) ;

/// @brief Method get_swapTriggers addr 0x296bf10 size 0x8 virtual false final false
 bool get_swapTriggers() ;

/// @brief Method set_swapTriggers addr 0x296bf18 size 0xc virtual false final false
 void set_swapTriggers(bool value) ;

/// @brief Method get_swapDpadAndLeftStick addr 0x296bf24 size 0x8 virtual false final false
 bool get_swapDpadAndLeftStick() ;

/// @brief Method set_swapDpadAndLeftStick addr 0x296bf2c size 0xc virtual false final false
 void set_swapDpadAndLeftStick(bool value) ;

/// @brief Method get_vibrationStrength addr 0x296bf38 size 0x8 virtual false final false
 float_t get_vibrationStrength() ;

/// @brief Method set_vibrationStrength addr 0x296bf40 size 0x8 virtual false final false
 void set_vibrationStrength(float_t value) ;

/// @brief Method Apply addr 0x296bf48 size 0x4 virtual true final false
 void Apply(UnityEngine::InputSystem::IInputActionCollection actions) ;

// Ctor Parameters []
explicit InputUserSettings() ;

/// @brief Method .ctor addr 0x296bf4c size 0x8 virtual false final false
 void _ctor() ;
