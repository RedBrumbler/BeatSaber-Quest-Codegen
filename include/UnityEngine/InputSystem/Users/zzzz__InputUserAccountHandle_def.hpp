...
/// @brief Method get_apiName addr 0x296bb64 size 0x8 virtual false final false
 ::StringW get_apiName() ;

/// @brief Method get_handle addr 0x296bb6c size 0x8 virtual false final false
 uint64_t get_handle() ;

/// @brief Method .ctor addr 0x296bb74 size 0x80 virtual false final false
 void _ctor(::StringW apiName, uint64_t handle) ;

/// @brief Method ToString addr 0x296bbf4 size 0xc4 virtual true final false
 ::StringW ToString() ;

/// @brief Method Equals addr 0x296bcb8 size 0xb0 virtual true final true
 bool Equals(UnityEngine::InputSystem::Users::InputUserAccountHandle other) ;

/// @brief Method Equals addr 0x296bd68 size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method op_Equality addr 0x296ba50 size 0x2c virtual false final false
...
/// @brief Method op_Inequality addr 0x296bde0 size 0x30 virtual false final false
...
/// @brief Method GetHashCode addr 0x296be10 size 0x58 virtual true final false
 int32_t GetHashCode() ;
