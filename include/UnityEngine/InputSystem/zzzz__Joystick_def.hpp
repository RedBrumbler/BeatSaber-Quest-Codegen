...
/// @brief Method get_trigger addr 0x290b43c size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_trigger() ;

/// @brief Method set_trigger addr 0x290b444 size 0x8 virtual false final false
 void set_trigger(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_stick addr 0x290b44c size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::StickControl get_stick() ;

/// @brief Method set_stick addr 0x290b454 size 0x8 virtual false final false
 void set_stick(UnityEngine::InputSystem::Controls::StickControl value) ;

/// @brief Method get_twist addr 0x290b45c size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_twist() ;

/// @brief Method set_twist addr 0x290b464 size 0x8 virtual false final false
 void set_twist(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_hatswitch addr 0x290b46c size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector2Control get_hatswitch() ;

/// @brief Method set_hatswitch addr 0x290b474 size 0x8 virtual false final false
 void set_hatswitch(UnityEngine::InputSystem::Controls::Vector2Control value) ;

/// @brief Method get_current addr 0x290b47c size 0x48 virtual false final false
static UnityEngine::InputSystem::Joystick get_current() ;

/// @brief Method set_current addr 0x290b4c4 size 0x4c virtual false final false
static void set_current(UnityEngine::InputSystem::Joystick value) ;

/// @brief Method get_all addr 0x290b510 size 0x80 virtual false final false
static UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<UnityEngine::InputSystem::Joystick> get_all() ;

/// @brief Method FinishSetup addr 0x290b590 size 0x13c virtual true final false
 void FinishSetup() ;

/// @brief Method MakeCurrent addr 0x290b6cc size 0x4c virtual true final false
 void MakeCurrent() ;

/// @brief Method OnAdded addr 0x290b718 size 0x78 virtual true final false
 void OnAdded() ;

/// @brief Method OnRemoved addr 0x290b790 size 0x118 virtual true final false
 void OnRemoved() ;

// Ctor Parameters []
explicit Joystick() ;

/// @brief Method .ctor addr 0x290b8a8 size 0x2c virtual false final false
 void _ctor() ;
