...
/// @brief Method GetValueTypeFromType addr 0x2909e14 size 0xf4 virtual false final false
static System::Type GetValueTypeFromType(System::Type processorType) ;

// Ctor Parameters []
explicit InputProcessor() ;

/// @brief Method .ctor addr 0x2909f08 size 0x8 virtual false final false
 void _ctor() ;
