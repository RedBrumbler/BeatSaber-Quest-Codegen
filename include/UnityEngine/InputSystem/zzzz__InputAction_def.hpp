...
/// @brief Method get_actionIndex addr 0x28d7b48 size 0x8 virtual false final false
 int32_t get_actionIndex() ;

/// @brief Method get_bindingIndex addr 0x28d7b50 size 0x34 virtual false final false
 int32_t get_bindingIndex() ;

/// @brief Method get_controlIndex addr 0x28d7b84 size 0x34 virtual false final false
 int32_t get_controlIndex() ;

/// @brief Method get_interactionIndex addr 0x28d7bb8 size 0x34 virtual false final false
 int32_t get_interactionIndex() ;

/// @brief Method get_phase addr 0x28d7bec size 0x30 virtual false final false
 UnityEngine::InputSystem::InputActionPhase get_phase() ;

/// @brief Method get_started addr 0x28d7c1c size 0x38 virtual false final false
 bool get_started() ;

/// @brief Method get_performed addr 0x28d7c54 size 0x38 virtual false final false
 bool get_performed() ;

/// @brief Method get_canceled addr 0x28d7c8c size 0x38 virtual false final false
 bool get_canceled() ;

/// @brief Method get_action addr 0x28d7cc4 size 0x30 virtual false final false
 UnityEngine::InputSystem::InputAction get_action() ;

/// @brief Method get_control addr 0x28d7cf4 size 0x44 virtual false final false
 UnityEngine::InputSystem::InputControl get_control() ;

/// @brief Method get_interaction addr 0x28d7d38 size 0x58 virtual false final false
 UnityEngine::InputSystem::IInputInteraction get_interaction() ;

/// @brief Method get_time addr 0x28d7d90 size 0x38 virtual false final false
 double_t get_time() ;

/// @brief Method get_startTime addr 0x28d7dc8 size 0x38 virtual false final false
 double_t get_startTime() ;

/// @brief Method get_duration addr 0x28d7e00 size 0x68 virtual false final false
 double_t get_duration() ;

/// @brief Method get_valueType addr 0x28d7e68 size 0x50 virtual false final false
 System::Type get_valueType() ;

/// @brief Method get_valueSizeInBytes addr 0x28d7eb8 size 0x50 virtual false final false
 int32_t get_valueSizeInBytes() ;

/// @brief Method ReadValue addr 0x28d7f08 size 0x1c8 virtual false final false
...
/// @brief Method ReadValueAsButton addr 0x28d80d0 size 0x84 virtual false final false
 bool ReadValueAsButton() ;

/// @brief Method ReadValueAsObject addr 0x28d8154 size 0x88 virtual false final false
 ::bs_hook::Il2CppWrapperType ReadValueAsObject() ;

/// @brief Method ToString addr 0x28d81dc size 0x250 virtual true final false
 ::StringW ToString() ;
...
/// @brief Method get_name addr 0x28d6084 size 0x8 virtual false final false
 ::StringW get_name() ;

/// @brief Method get_type addr 0x28d608c size 0x8 virtual false final false
 UnityEngine::InputSystem::InputActionType get_type() ;

/// @brief Method get_id addr 0x28d6094 size 0x34 virtual false final false
 System::Guid get_id() ;

/// @brief Method get_idDontGenerate addr 0x28d6114 size 0x48 virtual false final false
 System::Guid get_idDontGenerate() ;

/// @brief Method get_expectedControlType addr 0x28d615c size 0x8 virtual false final false
 ::StringW get_expectedControlType() ;

/// @brief Method set_expectedControlType addr 0x28d6164 size 0x8 virtual false final false
 void set_expectedControlType(::StringW value) ;

/// @brief Method get_processors addr 0x28d616c size 0x8 virtual false final false
 ::StringW get_processors() ;

/// @brief Method get_interactions addr 0x28d6174 size 0x8 virtual false final false
 ::StringW get_interactions() ;

/// @brief Method get_actionMap addr 0x28d617c size 0x20 virtual false final false
 UnityEngine::InputSystem::InputActionMap get_actionMap() ;

/// @brief Method get_bindingMask addr 0x28d61bc size 0x10 virtual false final false
 System::Nullable_1<UnityEngine::InputSystem::InputBinding> get_bindingMask() ;

/// @brief Method set_bindingMask addr 0x28d61cc size 0x1f4 virtual false final false
 void set_bindingMask(System::Nullable_1<UnityEngine::InputSystem::InputBinding> value) ;

/// @brief Method get_bindings addr 0x28d6488 size 0x30 virtual false final false
 UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<UnityEngine::InputSystem::InputBinding> get_bindings() ;

/// @brief Method get_controls addr 0x28d6538 size 0x44 virtual false final false
 UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<UnityEngine::InputSystem::InputControl> get_controls() ;

/// @brief Method get_phase addr 0x28d6630 size 0x40 virtual false final false
 UnityEngine::InputSystem::InputActionPhase get_phase() ;

/// @brief Method get_inProgress addr 0x28d66cc size 0x4c virtual false final false
 bool get_inProgress() ;

/// @brief Method get_enabled addr 0x28d6718 size 0x48 virtual false final false
 bool get_enabled() ;

/// @brief Method add_started addr 0x28d6760 size 0x58 virtual false final false
 void add_started(System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> value) ;

/// @brief Method remove_started addr 0x28d67b8 size 0x58 virtual false final false
 void remove_started(System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> value) ;

/// @brief Method add_canceled addr 0x28d6810 size 0x58 virtual false final false
 void add_canceled(System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> value) ;

/// @brief Method remove_canceled addr 0x28d6868 size 0x58 virtual false final false
...
/// @brief Method add_performed addr 0x28d68c0 size 0x58 virtual false final false
 void add_performed(System::Action_1<UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext> value) ;

/// @brief Method remove_performed addr 0x28d6918 size 0x58 virtual false final false
...
/// @brief Method get_triggered addr 0x28d6970 size 0x4 virtual false final false
 bool get_triggered() ;

/// @brief Method get_activeControl addr 0x28d6a14 size 0x8c virtual false final false
 UnityEngine::InputSystem::InputControl get_activeControl() ;

/// @brief Method get_wantsInitialStateCheck addr 0x28d6aa0 size 0x1c virtual false final false
 bool get_wantsInitialStateCheck() ;

/// @brief Method set_wantsInitialStateCheck addr 0x28d6abc size 0x1c virtual false final false
 void set_wantsInitialStateCheck(bool value) ;

// Ctor Parameters []
explicit InputAction() ;

/// @brief Method .ctor addr 0x28d6ad8 size 0x10 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x28d6ae8 size 0x120 virtual false final false
...
/// @brief Method Dispose addr 0x28d6c08 size 0x1c virtual true final true
 void Dispose() ;

/// @brief Method ToString addr 0x28d6c24 size 0x2d0 virtual true final false
 ::StringW ToString() ;

/// @brief Method Enable addr 0x28d6ef4 size 0x88 virtual false final false
 void Enable() ;

/// @brief Method Disable addr 0x28d6f7c size 0x70 virtual false final false
 void Disable() ;

/// @brief Method Clone addr 0x28d6fec size 0xdc virtual false final false
 UnityEngine::InputSystem::InputAction Clone() ;

/// @brief Method System.ICloneable.Clone addr 0x28d70c8 size 0x4 virtual true final true
...
/// @brief Method ReadValueAsObject addr 0x28d70cc size 0x9c virtual false final false
 ::bs_hook::Il2CppWrapperType ReadValueAsObject() ;

/// @brief Method Reset addr 0x28d7168 size 0x9c virtual false final false
 void Reset() ;

/// @brief Method IsPressed addr 0x28d7204 size 0x54 virtual false final false
 bool IsPressed() ;

/// @brief Method IsInProgress addr 0x28d7258 size 0x58 virtual false final false
 bool IsInProgress() ;

/// @brief Method WasPressedThisFrame addr 0x28d72b0 size 0xa0 virtual false final false
 bool WasPressedThisFrame() ;

/// @brief Method WasReleasedThisFrame addr 0x28d7350 size 0xa0 virtual false final false
 bool WasReleasedThisFrame() ;

/// @brief Method WasPerformedThisFrame addr 0x28d6974 size 0xa0 virtual false final false
 bool WasPerformedThisFrame() ;

/// @brief Method GetTimeoutCompletionPercentage addr 0x28d73f0 size 0x134 virtual false final false
 float_t GetTimeoutCompletionPercentage() ;

/// @brief Method get_isSingletonAction addr 0x28d619c size 0x20 virtual false final false
 bool get_isSingletonAction() ;

/// @brief Method get_currentState addr 0x28d6670 size 0x5c virtual false final false
 UnityEngine::InputSystem::UnityEngine__InputSystem__InputActionState__TriggerState get_currentState() ;

/// @brief Method MakeSureIdIsInPlace addr 0x28d60c8 size 0x4c virtual false final false
 ::StringW MakeSureIdIsInPlace() ;

/// @brief Method GenerateId addr 0x28d7524 size 0x34 virtual false final false
 void GenerateId() ;

/// @brief Method GetOrCreateActionMap addr 0x28d63c0 size 0x24 virtual false final false
 UnityEngine::InputSystem::InputActionMap GetOrCreateActionMap() ;

/// @brief Method CreateInternalActionMapForSingletonAction addr 0x28d7558 size 0xd4 virtual false final false
 void CreateInternalActionMapForSingletonAction() ;

/// @brief Method RequestInitialStateCheckOnEnabledAction addr 0x28d763c size 0x40 virtual false final false
 void RequestInitialStateCheckOnEnabledAction() ;

/// @brief Method ActiveControlIsValid addr 0x28d767c size 0xf4 virtual false final false
 bool ActiveControlIsValid(UnityEngine::InputSystem::InputControl control) ;

/// @brief Method FindEffectiveBindingMask addr 0x28d7850 size 0x90 virtual false final false
 System::Nullable_1<UnityEngine::InputSystem::InputBinding> FindEffectiveBindingMask() ;

/// @brief Method BindingIndexOnActionToBindingIndexOnMap addr 0x28d78e0 size 0x1a0 virtual false final false
 int32_t BindingIndexOnActionToBindingIndexOnMap(int32_t indexOfBindingOnAction) ;

/// @brief Method BindingIndexOnMapToBindingIndexOnAction addr 0x28d7a80 size 0xc8 virtual false final false
