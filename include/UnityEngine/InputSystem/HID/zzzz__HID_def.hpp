...
/// @brief Method .ctor addr 0x297b2e0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Build>b__4_0 addr 0x297b2e8 size 0x24 virtual false final false
 bool _Build_b__4_0(UnityEngine::InputSystem::HID::UnityEngine__InputSystem__HID__HID__HIDElementDescriptor element) ;

/// @brief Method <Build>b__4_1 addr 0x297b30c size 0x24 virtual false final false
 bool _Build_b__4_1(UnityEngine::InputSystem::HID::UnityEngine__InputSystem__HID__HID__HIDElementDescriptor element) ;

/// @brief Method <Build>b__4_2 addr 0x297b330 size 0xc virtual false final false
...
/// @brief Method Build addr 0x297960c size 0xcac virtual false final false
 UnityEngine::InputSystem::Layouts::InputControlLayout Build() ;

// Ctor Parameters []
explicit UnityEngine__InputSystem__HID__HID__HIDLayoutBuilder() ;

/// @brief Method .ctor addr 0x29778f8 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_hasNullState addr 0x297b33c size 0xc virtual false final false
 bool get_hasNullState() ;

/// @brief Method get_hasPreferredState addr 0x297b348 size 0x10 virtual false final false
 bool get_hasPreferredState() ;

/// @brief Method get_isArray addr 0x297b358 size 0x10 virtual false final false
 bool get_isArray() ;

/// @brief Method get_isNonLinear addr 0x297b368 size 0xc virtual false final false
 bool get_isNonLinear() ;

/// @brief Method get_isRelative addr 0x297b374 size 0xc virtual false final false
 bool get_isRelative() ;

/// @brief Method get_isConstant addr 0x297b380 size 0xc virtual false final false
 bool get_isConstant() ;

/// @brief Method get_isWrapping addr 0x297b38c size 0xc virtual false final false
 bool get_isWrapping() ;

/// @brief Method get_isSigned addr 0x297a428 size 0xc virtual false final false
 bool get_isSigned() ;

/// @brief Method get_minFloatValue addr 0x297b398 size 0x9c virtual false final false
 float_t get_minFloatValue() ;

/// @brief Method get_maxFloatValue addr 0x297b434 size 0xa4 virtual false final false
 float_t get_maxFloatValue() ;

/// @brief Method Is addr 0x297a56c size 0x24 virtual false final false
 bool Is(UnityEngine::InputSystem::HID::UnityEngine__InputSystem__HID__HID__UsagePage usagePage, int32_t usage) ;

/// @brief Method DetermineName addr 0x297a67c size 0x210 virtual false final false
 ::StringW DetermineName() ;

/// @brief Method DetermineDisplayName addr 0x297a88c size 0xfc virtual false final false
 ::StringW DetermineDisplayName() ;

/// @brief Method IsUsableElement addr 0x29778c0 size 0x38 virtual false final false
 bool IsUsableElement() ;

/// @brief Method DetermineLayout addr 0x297a590 size 0xec virtual false final false
 ::StringW DetermineLayout() ;

/// @brief Method DetermineFormat addr 0x297a988 size 0x108 virtual false final false
 UnityEngine::InputSystem::Utilities::FourCC DetermineFormat() ;

/// @brief Method DetermineUsages addr 0x297aa90 size 0x190 virtual false final false
 ::ArrayW<UnityEngine::InputSystem::Utilities::InternedString> DetermineUsages() ;

/// @brief Method DetermineParameters addr 0x297a2b8 size 0x170 virtual false final false
 ::StringW DetermineParameters() ;

/// @brief Method DetermineAxisNormalizationParameters addr 0x297b4d8 size 0x1c8 virtual false final false
 ::StringW DetermineAxisNormalizationParameters() ;

/// @brief Method DetermineProcessors addr 0x297a4fc size 0x70 virtual false final false
 ::StringW DetermineProcessors() ;

/// @brief Method DetermineDefaultState addr 0x297a434 size 0xc8 virtual false final false
 UnityEngine::InputSystem::Utilities::PrimitiveValue DetermineDefaultState() ;

/// @brief Method AddChildControls addr 0x297ac20 size 0x65c virtual false final false
...
/// @brief Method ToJson addr 0x297946c size 0x70 virtual false final false
 ::StringW ToJson() ;

/// @brief Method FromJson addr 0x2977900 size 0xf28 virtual false final false
...
/// @brief Method .ctor addr 0x297b6a0 size 0x18 virtual false final false
 void _ctor(UnityEngine::InputSystem::HID::UnityEngine__InputSystem__HID__HID__UsagePage usagePage, int32_t usage) ;

/// @brief Method .ctor addr 0x297b6b8 size 0x1c virtual false final false
 void _ctor(UnityEngine::InputSystem::HID::UnityEngine__InputSystem__HID__HID__GenericDesktop usage) ;

/// @brief Method StartReport addr 0x297b6d4 size 0x28 virtual false final false
...
/// @brief Method AddElement addr 0x297b6fc size 0x3d4 virtual false final false
...
/// @brief Method AddElement addr 0x297bad0 size 0x48 virtual false final false
...
/// @brief Method WithPhysicalMinMax addr 0x297bb18 size 0x194 virtual false final false
...
/// @brief Method WithLogicalMinMax addr 0x297bcac size 0x178 virtual false final false
...
/// @brief Method Finish addr 0x297be24 size 0xb0 virtual false final false
...
/// @brief Method .ctor addr 0x2977158 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <OnFindLayoutForDevice>b__0 addr 0x297bed4 size 0x18 virtual false final false
...
/// @brief Method get_QueryHIDReportDescriptorDeviceCommandType addr 0x29766dc size 0x30 virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC get_QueryHIDReportDescriptorDeviceCommandType() ;

/// @brief Method get_QueryHIDReportDescriptorSizeDeviceCommandType addr 0x297670c size 0x30 virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC get_QueryHIDReportDescriptorSizeDeviceCommandType() ;

/// @brief Method get_QueryHIDParsedReportDescriptorDeviceCommandType addr 0x297673c size 0x30 virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC get_QueryHIDParsedReportDescriptorDeviceCommandType() ;

/// @brief Method get_hidDescriptor addr 0x297676c size 0xa4 virtual false final false
 UnityEngine::InputSystem::HID::UnityEngine__InputSystem__HID__HID__HIDDeviceDescriptor get_hidDescriptor() ;

/// @brief Method OnFindLayoutForDevice addr 0x2976810 size 0x948 virtual false final false
...
/// @brief Method ReadHIDDeviceDescriptor addr 0x2977160 size 0x6f8 virtual false final false
...
/// @brief Method UsagePageToString addr 0x29794dc size 0x8c virtual false final false
static ::StringW UsagePageToString(UnityEngine::InputSystem::HID::UnityEngine__InputSystem__HID__HID__UsagePage usagePage) ;

/// @brief Method UsageToString addr 0x2979568 size 0x9c virtual false final false
...
/// @brief Method .ctor addr 0x2979604 size 0x8 virtual false final false
 void _ctor() ;
