...
/// @brief Method .ctor addr 0x29810c8 size 0x34 virtual false final false
 void _ctor(UnityEngine::InputSystem::EnhancedTouch::TouchHistory owner) ;

/// @brief Method MoveNext addr 0x29812e0 size 0x2c virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x298130c size 0xc virtual true final true
 void Reset() ;

/// @brief Method get_Current addr 0x2981318 size 0x40 virtual true final true
 UnityEngine::InputSystem::EnhancedTouch::Touch get_Current() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2981358 size 0x7c virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method Dispose addr 0x29813d4 size 0x4 virtual true final true
 void Dispose() ;
...
/// @brief Method .ctor addr 0x297e63c size 0x3c virtual false final false
...
/// @brief Method GetEnumerator addr 0x2981048 size 0x80 virtual true final true
 System::Collections::Generic::IEnumerator_1<UnityEngine::InputSystem::EnhancedTouch::Touch> GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x29810fc size 0x4 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method get_Count addr 0x2981100 size 0x8 virtual true final true
 int32_t get_Count() ;

/// @brief Method get_Item addr 0x2981108 size 0x13c virtual true final true
 UnityEngine::InputSystem::EnhancedTouch::Touch get_Item(int32_t index) ;

/// @brief Method CheckValid addr 0x2981244 size 0x9c virtual false final false
 void CheckValid() ;
