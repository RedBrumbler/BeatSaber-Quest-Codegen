...
/// @brief Method get_simulatedTouchscreen addr 0x29813d8 size 0x8 virtual false final false
 UnityEngine::InputSystem::Touchscreen get_simulatedTouchscreen() ;

/// @brief Method set_simulatedTouchscreen addr 0x29813e0 size 0x8 virtual false final false
 void set_simulatedTouchscreen(UnityEngine::InputSystem::Touchscreen value) ;

/// @brief Method get_instance addr 0x29813e8 size 0x48 virtual false final false
static UnityEngine::InputSystem::EnhancedTouch::TouchSimulation get_instance() ;

/// @brief Method Enable addr 0x2981430 size 0x19c virtual false final false
static void Enable() ;

/// @brief Method Disable addr 0x29815cc size 0xd8 virtual false final false
static void Disable() ;

/// @brief Method Destroy addr 0x29816a4 size 0xd0 virtual false final false
static void Destroy() ;

/// @brief Method AddPointer addr 0x2981774 size 0x160 virtual false final false
 void AddPointer(UnityEngine::InputSystem::Pointer pointer) ;

/// @brief Method RemovePointer addr 0x29818d4 size 0x1d0 virtual false final false
 void RemovePointer(UnityEngine::InputSystem::Pointer pointer) ;

/// @brief Method OnEvent addr 0x2981e2c size 0x514 virtual false final false
 void OnEvent(UnityEngine::InputSystem::LowLevel::InputEventPtr eventPtr, UnityEngine::InputSystem::InputDevice device) ;

/// @brief Method OnDeviceChange addr 0x29823b8 size 0x144 virtual false final false
 void OnDeviceChange(UnityEngine::InputSystem::InputDevice device, UnityEngine::InputSystem::InputDeviceChange change) ;

/// @brief Method OnEnable addr 0x29824fc size 0x3bc virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2982a38 size 0x164 virtual false final false
 void OnDisable() ;

/// @brief Method UpdateTouch addr 0x2981aa4 size 0x388 virtual false final false
...
/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyControlStateChanged addr 0x2982e90 size 0x4 virtual true final true
...
/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyTimerExpired addr 0x2982e94 size 0x4 virtual true final true
...
/// @brief Method InstallStateChangeMonitors addr 0x2982e98 size 0x4 virtual false final false
 void InstallStateChangeMonitors(int32_t startIndex) ;

/// @brief Method OnSourceControlChangedValue addr 0x2982e9c size 0x4 virtual false final false
...
/// @brief Method UninstallStateChangeMonitors addr 0x2982ea0 size 0x4 virtual false final false
 void UninstallStateChangeMonitors(int32_t startIndex) ;

// Ctor Parameters []
explicit TouchSimulation() ;

/// @brief Method .ctor addr 0x2982ea4 size 0x10 virtual false final false
 void _ctor() ;
