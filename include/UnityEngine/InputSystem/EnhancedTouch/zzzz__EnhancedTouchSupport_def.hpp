...
/// @brief Method get_enabled addr 0x297c9b0 size 0x50 virtual false final false
static bool get_enabled() ;

/// @brief Method Enable addr 0x297ca00 size 0x174 virtual false final false
static void Enable() ;

/// @brief Method Disable addr 0x297cd54 size 0x198 virtual false final false
static void Disable() ;

/// @brief Method Reset addr 0x297d0b0 size 0xa4 virtual false final false
static void Reset() ;

/// @brief Method SetUpState addr 0x297cb74 size 0x1e0 virtual false final false
static void SetUpState() ;

/// @brief Method TearDownState addr 0x297ceec size 0x1c4 virtual false final false
static void TearDownState() ;

/// @brief Method OnDeviceChange addr 0x297d154 size 0x114 virtual false final false
static void OnDeviceChange(UnityEngine::InputSystem::InputDevice device, UnityEngine::InputSystem::InputDeviceChange change) ;

/// @brief Method OnSettingsChange addr 0x297d268 size 0x98 virtual false final false
static void OnSettingsChange() ;

/// @brief Method CheckEnabled addr 0x297d300 size 0x109c virtual false final false
