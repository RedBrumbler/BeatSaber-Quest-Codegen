...
/// @brief Method get_isOpen addr 0x29896b8 size 0x8 virtual false final false
 bool get_isOpen() ;

/// @brief Method get_remainingEventCount addr 0x29896c0 size 0x10 virtual false final false
 int32_t get_remainingEventCount() ;

/// @brief Method get_numEventsRetainedInBuffer addr 0x29896d0 size 0x8 virtual false final false
 int32_t get_numEventsRetainedInBuffer() ;

/// @brief Method get_currentEventPtr addr 0x29896d8 size 0x34 virtual false final false
 void* get_currentEventPtr() ;

/// @brief Method get_numBytesRetainedInBuffer addr 0x298970c size 0x54 virtual false final false
 uint32_t get_numBytesRetainedInBuffer() ;

/// @brief Method .ctor addr 0x2989760 size 0x8c virtual false final false
 void _ctor(ByRef<UnityEngine::InputSystem::LowLevel::InputEventBuffer> eventBuffer, int32_t maxAppendedEvents) ;

/// @brief Method Close addr 0x29897ec size 0x114 virtual false final false
 void Close(ByRef<UnityEngine::InputSystem::LowLevel::InputEventBuffer> eventBuffer) ;

/// @brief Method CleanUpAfterException addr 0x2989900 size 0x90 virtual false final false
 void CleanUpAfterException() ;

/// @brief Method Write addr 0x2989990 size 0x1b0 virtual false final false
 void Write(void* eventPtr) ;

/// @brief Method Advance addr 0x2989b40 size 0xa4 virtual false final false
 void* Advance(bool leaveEventInBuffer) ;

/// @brief Method Peek addr 0x2989be4 size 0x64 virtual false final false
 void* Peek() ;
