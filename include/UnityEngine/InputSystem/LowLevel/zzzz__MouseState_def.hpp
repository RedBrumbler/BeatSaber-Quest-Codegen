...
/// @brief Method get_Format addr 0x2986228 size 0x30 virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC get_Format() ;

/// @brief Method WithButton addr 0x2986258 size 0x2c virtual false final false
 UnityEngine::InputSystem::LowLevel::MouseState WithButton(UnityEngine::InputSystem::LowLevel::MouseButton button, bool state) ;

/// @brief Method get_format addr 0x2986284 size 0x30 virtual true final true
