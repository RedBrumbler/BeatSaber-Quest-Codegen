...
constexpr void UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__JoystickState__Button::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__JoystickState__Button::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__JoystickState__Button  UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__JoystickState__Button::HatSwitchUp{0};
constexpr UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__JoystickState__Button  UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__JoystickState__Button::HatSwitchDown{1};
constexpr UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__JoystickState__Button  UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__JoystickState__Button::HatSwitchLeft{2};
constexpr UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__JoystickState__Button  UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__JoystickState__Button::HatSwitchRight{3};
constexpr UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__JoystickState__Button  UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__JoystickState__Button::Trigger{4};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::InputSystem::Utilities::FourCC (*)()>(&UnityEngine::InputSystem::LowLevel::JoystickState::get_kFormat)> {
  ...
  constexpr static std::size_t addrs = 0x298607c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::InputSystem::Utilities::FourCC (UnityEngine::InputSystem::LowLevel::JoystickState::*)()>(&UnityEngine::InputSystem::LowLevel::JoystickState::get_format)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x29860ac;
