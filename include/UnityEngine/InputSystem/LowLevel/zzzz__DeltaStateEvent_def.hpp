...
/// @brief Method get_deltaStateSizeInBytes addr 0x2986d9c size 0xc virtual false final false
 uint32_t get_deltaStateSizeInBytes() ;

/// @brief Method get_deltaState addr 0x2986da8 size 0x8 virtual false final false
 void* get_deltaState() ;

/// @brief Method get_typeStatic addr 0x2986db0 size 0x20 virtual true final true
 UnityEngine::InputSystem::Utilities::FourCC get_typeStatic() ;

/// @brief Method ToEventPtr addr 0x2986dd0 size 0x4 virtual false final false
 UnityEngine::InputSystem::LowLevel::InputEventPtr ToEventPtr() ;

/// @brief Method From addr 0x2986dd4 size 0x130 virtual false final false
static void* From(UnityEngine::InputSystem::LowLevel::InputEventPtr ptr) ;

/// @brief Method FromUnchecked addr 0x2986f04 size 0x4 virtual false final false
static void* FromUnchecked(UnityEngine::InputSystem::LowLevel::InputEventPtr ptr) ;

/// @brief Method From addr 0x2986f08 size 0x318 virtual false final false
