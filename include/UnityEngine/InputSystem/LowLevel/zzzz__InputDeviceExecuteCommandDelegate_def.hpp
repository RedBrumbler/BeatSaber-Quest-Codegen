...
explicit InputDeviceExecuteCommandDelegate(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method .ctor addr 0x2985088 size 0xd4 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x298515c size 0x14 virtual true final false
 int64_t Invoke(ByRef<UnityEngine::InputSystem::LowLevel::InputDeviceCommand> command) ;

/// @brief Method BeginInvoke addr 0x2985170 size 0x8c virtual true final false
...
/// @brief Method EndInvoke addr 0x29851fc size 0x2c virtual true final false
