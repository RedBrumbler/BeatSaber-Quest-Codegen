...
/// @brief Method get_payloadSizeInBytes addr 0x2985228 size 0xc virtual false final false
 int32_t get_payloadSizeInBytes() ;

/// @brief Method get_payloadPtr addr 0x2985234 size 0x8 virtual false final false
 void* get_payloadPtr() ;

/// @brief Method .ctor addr 0x2984cf8 size 0x8 virtual false final false
 void _ctor(UnityEngine::InputSystem::Utilities::FourCC type, int32_t sizeInBytes) ;

/// @brief Method AllocateNative addr 0x298523c size 0xb0 virtual false final false
...
/// @brief Method get_typeStatic addr 0x29852ec size 0x8 virtual true final true
