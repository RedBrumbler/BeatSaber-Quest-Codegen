...
/// @brief Method get_type addr 0x2987900 size 0x8 virtual false final false
 UnityEngine::InputSystem::Utilities::FourCC get_type() ;

/// @brief Method set_type addr 0x2987908 size 0x8 virtual false final false
 void set_type(UnityEngine::InputSystem::Utilities::FourCC value) ;

/// @brief Method get_sizeInBytes addr 0x2986a60 size 0x8 virtual false final false
 uint32_t get_sizeInBytes() ;

/// @brief Method set_sizeInBytes addr 0x2987910 size 0xa8 virtual false final false
 void set_sizeInBytes(uint32_t value) ;

/// @brief Method get_eventId addr 0x29879b8 size 0xc virtual false final false
 int32_t get_eventId() ;

/// @brief Method set_eventId addr 0x29879c4 size 0x14 virtual false final false
 void set_eventId(int32_t value) ;

/// @brief Method get_deviceId addr 0x29879d8 size 0x8 virtual false final false
 int32_t get_deviceId() ;

/// @brief Method set_deviceId addr 0x29879e0 size 0x8 virtual false final false
 void set_deviceId(int32_t value) ;

/// @brief Method get_time addr 0x29879e8 size 0x54 virtual false final false
 double_t get_time() ;

/// @brief Method set_time addr 0x2987a3c size 0x60 virtual false final false
 void set_time(double_t value) ;

/// @brief Method get_internalTime addr 0x2987a9c size 0x8 virtual false final false
 double_t get_internalTime() ;

/// @brief Method set_internalTime addr 0x2987aa4 size 0x8 virtual false final false
 void set_internalTime(double_t value) ;

/// @brief Method .ctor addr 0x2987230 size 0x104 virtual false final false
 void _ctor(UnityEngine::InputSystem::Utilities::FourCC type, int32_t sizeInBytes, int32_t deviceId, double_t time) ;

/// @brief Method get_handled addr 0x2987aac size 0xc virtual false final false
 bool get_handled() ;

/// @brief Method set_handled addr 0x2987ab8 size 0x1c virtual false final false
 void set_handled(bool value) ;

/// @brief Method ToString addr 0x2987ad4 size 0x264 virtual true final false
 ::StringW ToString() ;

/// @brief Method GetNextInMemory addr 0x2987d38 size 0x20 virtual false final false
static void* GetNextInMemory(void* currentPtr) ;

/// @brief Method GetNextInMemoryChecked addr 0x2987d58 size 0xf0 virtual false final false
static void* GetNextInMemoryChecked(void* currentPtr, ByRef<UnityEngine::InputSystem::LowLevel::InputEventBuffer> buffer) ;

/// @brief Method Equals addr 0x2987ed0 size 0x54 virtual false final false
