...
/// @brief Method .ctor addr 0x299459c size 0x10 virtual false final false
 void _ctor(UnityEngine::InputSystem::LowLevel::InputStateHistory history) ;

/// @brief Method MoveNext addr 0x2994b50 size 0x3c virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x2994b8c size 0xc virtual true final true
 void Reset() ;

/// @brief Method get_Current addr 0x2994b98 size 0x20 virtual true final true
 UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputStateHistory__Record get_Current() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2994bb8 size 0x64 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method Dispose addr 0x2994c1c size 0x4 virtual true final true
 void Dispose() ;
...
/// @brief Method get_statePtrWithControlIndex addr 0x2994534 size 0x8 virtual false final false
 void* get_statePtrWithControlIndex() ;

/// @brief Method get_statePtrWithoutControlIndex addr 0x299452c size 0x8 virtual false final false
...
/// @brief Method get_header addr 0x2994c20 size 0x24 virtual false final false
 void* get_header() ;

/// @brief Method get_recordIndex addr 0x2994c44 size 0xc virtual false final false
 int32_t get_recordIndex() ;

/// @brief Method get_version addr 0x2994c50 size 0x8 virtual false final false
 uint32_t get_version() ;

/// @brief Method get_valid addr 0x2994c58 size 0x48 virtual false final false
 bool get_valid() ;

/// @brief Method get_owner addr 0x2994ca0 size 0x8 virtual false final false
 UnityEngine::InputSystem::LowLevel::InputStateHistory get_owner() ;

/// @brief Method get_index addr 0x2994ca8 size 0x3c virtual false final false
 int32_t get_index() ;

/// @brief Method get_time addr 0x2994d94 size 0x28 virtual false final false
 double_t get_time() ;

/// @brief Method get_control addr 0x2994dbc size 0xb4 virtual false final false
 UnityEngine::InputSystem::InputControl get_control() ;

/// @brief Method get_next addr 0x2994e70 size 0x90 virtual false final false
 UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputStateHistory__Record get_next() ;

/// @brief Method get_previous addr 0x2994f00 size 0x88 virtual false final false
 UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputStateHistory__Record get_previous() ;

/// @brief Method .ctor addr 0x2993330 size 0x28 virtual false final false
...
/// @brief Method ReadValueAsObject addr 0x2994f88 size 0x38 virtual false final false
 ::bs_hook::Il2CppWrapperType ReadValueAsObject() ;

/// @brief Method GetUnsafeMemoryPtr addr 0x2994fc0 size 0x18 virtual false final false
 void* GetUnsafeMemoryPtr() ;

/// @brief Method GetUnsafeMemoryPtrUnchecked addr 0x2994fd8 size 0x80 virtual false final false
 void* GetUnsafeMemoryPtrUnchecked() ;

/// @brief Method GetUnsafeExtraMemoryPtr addr 0x2995058 size 0x18 virtual false final false
 void* GetUnsafeExtraMemoryPtr() ;

/// @brief Method GetUnsafeExtraMemoryPtrUnchecked addr 0x2995070 size 0xd0 virtual false final false
 void* GetUnsafeExtraMemoryPtrUnchecked() ;

/// @brief Method CopyFrom addr 0x2993490 size 0x380 virtual false final false
 void CopyFrom(UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputStateHistory__Record record) ;

/// @brief Method CheckValid addr 0x2994ce4 size 0xb0 virtual false final false
 void CheckValid() ;

/// @brief Method Equals addr 0x2995140 size 0x34 virtual true final true
 bool Equals(UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputStateHistory__Record other) ;

/// @brief Method Equals addr 0x2995174 size 0x98 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x299520c size 0x48 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2995254 size 0xd8 virtual true final false
 ::StringW ToString() ;
...
/// @brief Method get_Count addr 0x2992d5c size 0x8 virtual true final true
 int32_t get_Count() ;

/// @brief Method get_version addr 0x2992d64 size 0x8 virtual false final false
 uint32_t get_version() ;

/// @brief Method get_historyDepth addr 0x2992d6c size 0x8 virtual false final false
 int32_t get_historyDepth() ;

/// @brief Method set_historyDepth addr 0x2992d74 size 0xe4 virtual false final false
 void set_historyDepth(int32_t value) ;

/// @brief Method get_extraMemoryPerRecord addr 0x2992e58 size 0x8 virtual false final false
 int32_t get_extraMemoryPerRecord() ;

/// @brief Method set_extraMemoryPerRecord addr 0x2992e60 size 0xe4 virtual false final false
 void set_extraMemoryPerRecord(int32_t value) ;

/// @brief Method get_updateMask addr 0x2992f44 size 0x94 virtual false final false
 UnityEngine::InputSystem::LowLevel::InputUpdateType get_updateMask() ;

/// @brief Method set_updateMask addr 0x2992fd8 size 0xcc virtual false final false
 void set_updateMask(UnityEngine::InputSystem::LowLevel::InputUpdateType value) ;

/// @brief Method get_controls addr 0x29930a4 size 0x68 virtual false final false
 UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<UnityEngine::InputSystem::InputControl> get_controls() ;

/// @brief Method get_Item addr 0x299310c size 0x114 virtual false final false
 UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputStateHistory__Record get_Item(int32_t index) ;

/// @brief Method set_Item addr 0x2993358 size 0x138 virtual false final false
...
/// @brief Method get_onRecordAdded addr 0x2993810 size 0x8 virtual false final false
...
/// @brief Method set_onRecordAdded addr 0x2993818 size 0x8 virtual false final false
...
/// @brief Method get_onShouldRecordStateChange addr 0x2993820 size 0x8 virtual false final false
...
/// @brief Method set_onShouldRecordStateChange addr 0x2993828 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2993830 size 0xb4 virtual false final false
...
/// @brief Method .ctor addr 0x29938e4 size 0x158 virtual false final false
...
/// @brief Method .ctor addr 0x2993a3c size 0xfc virtual false final false
...
/// @brief Method .ctor addr 0x2993b38 size 0x7c virtual false final false
 void _ctor(System::Collections::Generic::IEnumerable_1<UnityEngine::InputSystem::InputControl> controls) ;

/// @brief Method Finalize addr 0x2993bb4 size 0x94 virtual true final false
 void Finalize() ;

/// @brief Method Clear addr 0x2993cb0 size 0x14 virtual false final false
 void Clear() ;

/// @brief Method AddRecord addr 0x2993cc4 size 0x6c virtual false final false
...
/// @brief Method StartRecording addr 0x2993e50 size 0x15c virtual false final false
 void StartRecording() ;

/// @brief Method StopRecording addr 0x2993fac size 0x158 virtual false final false
 void StopRecording() ;

/// @brief Method RecordStateChange addr 0x2994104 size 0x198 virtual false final false
...
/// @brief Method RecordStateChange addr 0x299429c size 0x290 virtual false final false
...
/// @brief Method GetEnumerator addr 0x299453c size 0x60 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x29945ac size 0x4 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method Dispose addr 0x2993c48 size 0x68 virtual true final true
 void Dispose() ;

/// @brief Method Destroy addr 0x29945b0 size 0x78 virtual false final false
 void Destroy() ;

/// @brief Method Allocate addr 0x2994628 size 0x254 virtual false final false
 void Allocate() ;

/// @brief Method RecordIndexToUserIndex addr 0x29948cc size 0x24 virtual false final false
 int32_t RecordIndexToUserIndex(int32_t index) ;

/// @brief Method UserIndexToRecordIndex addr 0x2993220 size 0x18 virtual false final false
 int32_t UserIndexToRecordIndex(int32_t index) ;

/// @brief Method GetRecord addr 0x2993238 size 0xf8 virtual false final false
 void* GetRecord(int32_t index) ;

/// @brief Method GetRecordUnchecked addr 0x29948f0 size 0xac virtual false final false
 void* GetRecordUnchecked(int32_t index) ;

/// @brief Method AllocateRecord addr 0x2993d30 size 0x120 virtual false final false
...
/// @brief Method ReadValueAsObject addr 0x299499c size 0xd8 virtual false final false
 ::bs_hook::Il2CppWrapperType ReadValueAsObject(void* data) ;

/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyControlStateChanged addr 0x2994a74 size 0xd8 virtual true final true
...
/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyTimerExpired addr 0x2994b4c size 0x4 virtual true final true
...
/// @brief Method get_bytesPerRecord addr 0x299487c size 0x50 virtual false final false
