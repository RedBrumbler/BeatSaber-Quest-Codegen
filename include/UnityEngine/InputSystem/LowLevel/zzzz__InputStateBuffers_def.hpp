...
/// @brief Method get_valid addr 0x2992d24 size 0x10 virtual false final false
 bool get_valid() ;

/// @brief Method SetFrontBuffer addr 0x29928b0 size 0x10 virtual false final false
 void SetFrontBuffer(int32_t deviceIndex, void* ptr) ;

/// @brief Method SetBackBuffer addr 0x29928c0 size 0x14 virtual false final false
 void SetBackBuffer(int32_t deviceIndex, void* ptr) ;

/// @brief Method GetFrontBuffer addr 0x2992650 size 0x10 virtual false final false
 void* GetFrontBuffer(int32_t deviceIndex) ;

/// @brief Method GetBackBuffer addr 0x29926b8 size 0x14 virtual false final false
 void* GetBackBuffer(int32_t deviceIndex) ;

/// @brief Method SwapBuffers addr 0x2992d34 size 0x28 virtual false final false
...
/// @brief Method GetDoubleBuffersFor addr 0x2992524 size 0xd8 virtual false final false
...
/// @brief Method GetFrontBufferForDevice addr 0x29925fc size 0x54 virtual false final false
static void* GetFrontBufferForDevice(int32_t deviceIndex) ;

/// @brief Method GetBackBufferForDevice addr 0x2992660 size 0x58 virtual false final false
static void* GetBackBufferForDevice(int32_t deviceIndex) ;

/// @brief Method SwitchTo addr 0x29926cc size 0x64 virtual false final false
...
/// @brief Method AllocateAll addr 0x2992730 size 0xbc virtual false final false
 void AllocateAll(::ArrayW<UnityEngine::InputSystem::InputDevice> devices, int32_t deviceCount) ;

/// @brief Method SetUpDeviceToBufferMappings addr 0x2992858 size 0x58 virtual false final false
...
/// @brief Method FreeAll addr 0x29928d4 size 0xc0 virtual false final false
 void FreeAll() ;

/// @brief Method MigrateAll addr 0x2992994 size 0x108 virtual false final false
...
/// @brief Method MigrateDoubleBuffer addr 0x2992a9c size 0x118 virtual false final false
...
/// @brief Method MigrateSingleBuffer addr 0x2992bb4 size 0xb8 virtual false final false
...
/// @brief Method ComputeSizeOfSingleStateBuffer addr 0x29927ec size 0x6c virtual false final false
static uint32_t ComputeSizeOfSingleStateBuffer(::ArrayW<UnityEngine::InputSystem::InputDevice> devices, int32_t deviceCount) ;

/// @brief Method NextDeviceOffset addr 0x2992c6c size 0xb8 virtual false final false
