...
/// @brief Method .ctor addr 0x2987830 size 0x24 virtual false final false
 void _ctor(UnityEngine::InputSystem::LowLevel::IMECompositionString compositionString) ;

/// @brief Method MoveNext addr 0x2987858 size 0x34 virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x298788c size 0xc virtual true final true
 void Reset() ;

/// @brief Method Dispose addr 0x2987898 size 0x4 virtual true final true
 void Dispose() ;

/// @brief Method get_Current addr 0x298789c size 0x8 virtual true final true
 char16_t get_Current() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x29878a4 size 0x5c virtual true final true
...
/// @brief Method get_Count addr 0x298770c size 0x8 virtual false final false
 int32_t get_Count() ;

/// @brief Method get_Item addr 0x2987714 size 0x70 virtual false final false
 char16_t get_Item(int32_t index) ;

/// @brief Method .ctor addr 0x298768c size 0x80 virtual false final false
 void _ctor(::StringW characters) ;

/// @brief Method ToString addr 0x2987784 size 0x18 virtual true final false
 ::StringW ToString() ;

/// @brief Method GetEnumerator addr 0x298779c size 0x94 virtual true final true
 System::Collections::Generic::IEnumerator_1<char16_t> GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2987854 size 0x4 virtual true final true
