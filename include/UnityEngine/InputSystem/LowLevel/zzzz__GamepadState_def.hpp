...
/// @brief Method get_Format addr 0x2985ed4 size 0x30 virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC get_Format() ;

/// @brief Method get_format addr 0x2985f04 size 0x30 virtual true final true
 UnityEngine::InputSystem::Utilities::FourCC get_format() ;

/// @brief Method .ctor addr 0x2985f34 size 0xb4 virtual false final false
 void _ctor(::ArrayW<UnityEngine::InputSystem::LowLevel::GamepadButton> buttons) ;

/// @brief Method WithButton addr 0x2985fe8 size 0x34 virtual false final false
