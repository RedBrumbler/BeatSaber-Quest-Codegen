...
/// @brief Method get_Format addr 0x29860dc size 0x30 virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC get_Format() ;

/// @brief Method .ctor addr 0x298610c size 0xc8 virtual false final false
 void _ctor(::ArrayW<UnityEngine::InputSystem::Key> pressedKeys) ;

/// @brief Method Set addr 0x29861d4 size 0xc virtual false final false
 void Set(UnityEngine::InputSystem::Key key, bool state) ;

/// @brief Method Press addr 0x29861e0 size 0xc virtual false final false
 void Press(UnityEngine::InputSystem::Key key) ;

/// @brief Method Release addr 0x29861ec size 0xc virtual false final false
 void Release(UnityEngine::InputSystem::Key key) ;

/// @brief Method get_format addr 0x29861f8 size 0x30 virtual true final true
