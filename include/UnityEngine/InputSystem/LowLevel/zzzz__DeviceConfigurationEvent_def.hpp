...
/// @brief Method get_typeStatic addr 0x2987334 size 0x20 virtual true final true
 UnityEngine::InputSystem::Utilities::FourCC get_typeStatic() ;

/// @brief Method ToEventPtr addr 0x2987354 size 0x4 virtual false final false
 UnityEngine::InputSystem::LowLevel::InputEventPtr ToEventPtr() ;

/// @brief Method Create addr 0x2987358 size 0x90 virtual false final false
