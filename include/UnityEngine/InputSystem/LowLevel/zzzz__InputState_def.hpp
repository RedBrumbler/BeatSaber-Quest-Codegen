...
class CORDL_TYPE UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate() = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate", modifiers: " const&", def_value: None }]
constexpr UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate(UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate", modifiers: "&&", def_value: None }]
constexpr UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate(UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate& operator=(UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate&& o) noexcept = default;
  constexpr UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate& operator=(UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate const& o) noexcept = default;
...
/// @brief Method NotifyControlStateChanged addr 0x298fe78 size 0x24 virtual true final true
...
/// @brief Method NotifyTimerExpired addr 0x298fe9c size 0x1c virtual true final true
...
/// @brief Method .ctor addr 0x298fbb4 size 0x8 virtual false final false
 void _ctor() ;
...
public:
// Declarations
using StateChangeMonitorDelegate = UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate;
...
/// @brief Method get_currentUpdateType addr 0x298f3b8 size 0x48 virtual false final false
static UnityEngine::InputSystem::LowLevel::InputUpdateType get_currentUpdateType() ;

/// @brief Method get_updateCount addr 0x298f400 size 0x48 virtual false final false
static uint32_t get_updateCount() ;

/// @brief Method get_currentTime addr 0x2982d1c size 0xd0 virtual false final false
static double_t get_currentTime() ;

/// @brief Method add_onChange addr 0x298f448 size 0x6c virtual false final false
...
/// @brief Method remove_onChange addr 0x298f4b4 size 0x6c virtual false final false
...
/// @brief Method Change addr 0x298f520 size 0x26c virtual false final false
...
/// @brief Method IsIntegerFormat addr 0x298f78c size 0x1d8 virtual false final false
static bool IsIntegerFormat(UnityEngine::InputSystem::Utilities::FourCC format) ;

/// @brief Method AddChangeMonitor addr 0x298f964 size 0x174 virtual false final false
...
/// @brief Method AddChangeMonitor addr 0x298fad8 size 0xdc virtual false final false
...
/// @brief Method RemoveChangeMonitor addr 0x298fbbc size 0xfc virtual false final false
...
/// @brief Method AddChangeMonitorTimeout addr 0x298fcb8 size 0xec virtual false final false
...
/// @brief Method RemoveChangeMonitorTimeout addr 0x298fda4 size 0xd4 virtual false final false
...
NEED_NO_BOX(UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate);
DEFINE_IL2CPP_ARG_TYPE(UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputState__StateChangeMonitorDelegate, "UnityEngine.InputSystem.LowLevel", "InputState/StateChangeMonitorDelegate");
