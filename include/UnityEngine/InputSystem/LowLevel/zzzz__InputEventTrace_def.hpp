...
/// @brief Method .ctor addr 0x298bb4c size 0x38 virtual false final false
 void _ctor(UnityEngine::InputSystem::LowLevel::InputEventTrace trace) ;

/// @brief Method Dispose addr 0x298c2c4 size 0xc virtual true final true
 void Dispose() ;

/// @brief Method MoveNext addr 0x298c2d0 size 0xd0 virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x298c3a0 size 0x24 virtual true final true
 void Reset() ;

/// @brief Method get_Current addr 0x298c3c4 size 0x8 virtual true final true
 UnityEngine::InputSystem::LowLevel::InputEventPtr get_Current() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x298c3cc size 0x5c virtual true final true
...
/// @brief Method .ctor addr 0x298db28 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <PlayAllEventsAccordingToTimestamps>b__38_0 addr 0x298db30 size 0xc8 virtual false final false
...
/// @brief Method .ctor addr 0x298dabc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ApplyDeviceMapping>b__0 addr 0x298dbf8 size 0x14 virtual false final false
...
/// @brief Method get_trace addr 0x298c428 size 0x8 virtual false final false
 UnityEngine::InputSystem::LowLevel::InputEventTrace get_trace() ;

/// @brief Method get_finished addr 0x298c430 size 0x8 virtual false final false
 bool get_finished() ;

/// @brief Method set_finished addr 0x298c438 size 0xc virtual false final false
 void set_finished(bool value) ;

/// @brief Method get_paused addr 0x298c444 size 0x8 virtual false final false
 bool get_paused() ;

/// @brief Method set_paused addr 0x298c44c size 0xc virtual false final false
 void set_paused(bool value) ;

/// @brief Method get_position addr 0x298c458 size 0x8 virtual false final false
 int32_t get_position() ;

/// @brief Method set_position addr 0x298c460 size 0x8 virtual false final false
 void set_position(int32_t value) ;

/// @brief Method get_createdDevices addr 0x298c468 size 0x64 virtual false final false
...
/// @brief Method .ctor addr 0x298b6b0 size 0x78 virtual false final false
 void _ctor(UnityEngine::InputSystem::LowLevel::InputEventTrace trace) ;

/// @brief Method Dispose addr 0x298c4cc size 0x320 virtual true final true
 void Dispose() ;

/// @brief Method WithDeviceMappedFromTo addr 0x298c7ec size 0x8c virtual false final false
...
/// @brief Method WithDeviceMappedFromTo addr 0x298c878 size 0x184 virtual false final false
...
/// @brief Method WithAllDevicesMappedToNewInstances addr 0x298c9fc size 0xc virtual false final false
...
/// @brief Method OnFinished addr 0x298ca08 size 0x8 virtual false final false
...
/// @brief Method OnEvent addr 0x298ca10 size 0x8 virtual false final false
...
/// @brief Method PlayOneEvent addr 0x298ca18 size 0x88 virtual false final false
 UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputEventTrace__ReplayController PlayOneEvent() ;

/// @brief Method Rewind addr 0x298cffc size 0x18 virtual false final false
 UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputEventTrace__ReplayController Rewind() ;

/// @brief Method PlayAllFramesOneByOne addr 0x298d014 size 0xb0 virtual false final false
...
/// @brief Method PlayAllEvents addr 0x298d0c4 size 0xb8 virtual false final false
 UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputEventTrace__ReplayController PlayAllEvents() ;

/// @brief Method PlayAllEventsAccordingToTimestamps addr 0x298d17c size 0x288 virtual false final false
...
/// @brief Method OnBeginFrame addr 0x298d404 size 0x24c virtual false final false
 void OnBeginFrame() ;

/// @brief Method Finished addr 0x298d650 size 0xd0 virtual false final false
 void Finished() ;

/// @brief Method QueueEvent addr 0x298cdc0 size 0x23c virtual false final false
 void QueueEvent(UnityEngine::InputSystem::LowLevel::InputEventPtr eventPtr) ;

/// @brief Method MoveNext addr 0x298caa0 size 0x320 virtual false final false
 bool MoveNext(bool skipFrameEvents, ByRef<UnityEngine::InputSystem::LowLevel::InputEventPtr> eventPtr) ;

/// @brief Method ApplyDeviceMapping addr 0x298d720 size 0x39c virtual false final false
...
/// @brief Method get_deviceId addr 0x298dc0c size 0x8 virtual false final false
 int32_t get_deviceId() ;

/// @brief Method set_deviceId addr 0x298dc14 size 0x8 virtual false final false
 void set_deviceId(int32_t value) ;

/// @brief Method get_layout addr 0x298dc1c size 0x8 virtual false final false
 ::StringW get_layout() ;

/// @brief Method set_layout addr 0x298dc24 size 0x8 virtual false final false
 void set_layout(::StringW value) ;

/// @brief Method get_stateFormat addr 0x298dc2c size 0x8 virtual false final false
 UnityEngine::InputSystem::Utilities::FourCC get_stateFormat() ;

/// @brief Method set_stateFormat addr 0x298dc34 size 0x8 virtual false final false
 void set_stateFormat(UnityEngine::InputSystem::Utilities::FourCC value) ;

/// @brief Method get_stateSizeInBytes addr 0x298dc3c size 0x8 virtual false final false
 int32_t get_stateSizeInBytes() ;

/// @brief Method set_stateSizeInBytes addr 0x298dc44 size 0x8 virtual false final false
...
/// @brief Method get_FrameMarkerEvent addr 0x2989c48 size 0x30 virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC get_FrameMarkerEvent() ;

/// @brief Method get_deviceId addr 0x2989c78 size 0x8 virtual false final false
 int32_t get_deviceId() ;

/// @brief Method set_deviceId addr 0x2989c80 size 0x8 virtual false final false
 void set_deviceId(int32_t value) ;

/// @brief Method get_enabled addr 0x2989c88 size 0x8 virtual false final false
 bool get_enabled() ;

/// @brief Method get_recordFrameMarkers addr 0x2989c90 size 0x8 virtual false final false
 bool get_recordFrameMarkers() ;

/// @brief Method set_recordFrameMarkers addr 0x2989c98 size 0xf0 virtual false final false
 void set_recordFrameMarkers(bool value) ;

/// @brief Method get_eventCount addr 0x2989d88 size 0x8 virtual false final false
 int64_t get_eventCount() ;

/// @brief Method get_totalEventSizeInBytes addr 0x2989d90 size 0x8 virtual false final false
 int64_t get_totalEventSizeInBytes() ;

/// @brief Method get_allocatedSizeInBytes addr 0x2989d98 size 0x18 virtual false final false
 int64_t get_allocatedSizeInBytes() ;

/// @brief Method get_maxSizeInBytes addr 0x2989db8 size 0x8 virtual false final false
 int64_t get_maxSizeInBytes() ;

/// @brief Method get_deviceInfos addr 0x2989dc0 size 0x48 virtual false final false
...
/// @brief Method get_onFilterEvent addr 0x2989e08 size 0x8 virtual false final false
 System::Func_3<UnityEngine::InputSystem::LowLevel::InputEventPtr,UnityEngine::InputSystem::InputDevice,bool> get_onFilterEvent() ;

/// @brief Method set_onFilterEvent addr 0x2989e10 size 0x8 virtual false final false
...
/// @brief Method add_onEvent addr 0x2989e18 size 0x58 virtual false final false
 void add_onEvent(System::Action_1<UnityEngine::InputSystem::LowLevel::InputEventPtr> value) ;

/// @brief Method remove_onEvent addr 0x2989e70 size 0x58 virtual false final false
...
/// @brief Method .ctor addr 0x2989ec8 size 0xd8 virtual false final false
...
/// @brief Method .ctor addr 0x2989fa0 size 0x70 virtual false final false
 void _ctor(int64_t bufferSizeInBytes, bool growBuffer, int64_t maxBufferSizeInBytes, int64_t growIncrementSizeInBytes) ;

/// @brief Method WriteTo addr 0x298a010 size 0x1d4 virtual false final false
 void WriteTo(::StringW filePath) ;

/// @brief Method WriteTo addr 0x298a1e4 size 0x6bc virtual false final false
 void WriteTo(System::IO::Stream stream) ;

/// @brief Method ReadFrom addr 0x298a930 size 0x1d4 virtual false final false
 void ReadFrom(::StringW filePath) ;

/// @brief Method ReadFrom addr 0x298ab04 size 0x6e4 virtual false final false
 void ReadFrom(System::IO::Stream stream) ;

/// @brief Method LoadFrom addr 0x298b200 size 0x208 virtual false final false
static UnityEngine::InputSystem::LowLevel::InputEventTrace LoadFrom(::StringW filePath) ;

/// @brief Method LoadFrom addr 0x298b408 size 0x128 virtual false final false
static UnityEngine::InputSystem::LowLevel::InputEventTrace LoadFrom(System::IO::Stream stream) ;

/// @brief Method Replay addr 0x298b530 size 0x68 virtual false final false
 UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputEventTrace__ReplayController Replay() ;

/// @brief Method Resize addr 0x298b728 size 0x200 virtual false final false
 bool Resize(int64_t newBufferSize, int64_t newMaxBufferSize) ;

/// @brief Method Clear addr 0x298b9ac size 0x1c virtual false final false
 void Clear() ;

/// @brief Method Enable addr 0x298b9c8 size 0x154 virtual false final false
 void Enable() ;

/// @brief Method Disable addr 0x298b598 size 0x118 virtual false final false
 void Disable() ;

/// @brief Method GetNextEvent addr 0x298b930 size 0x7c virtual false final false
 bool GetNextEvent(ByRef<UnityEngine::InputSystem::LowLevel::InputEventPtr> current) ;

/// @brief Method GetEnumerator addr 0x298a8d0 size 0x60 virtual true final true
 System::Collections::Generic::IEnumerator_1<UnityEngine::InputSystem::LowLevel::InputEventPtr> GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x298bb84 size 0x4 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method Dispose addr 0x298bb88 size 0x18 virtual true final true
 void Dispose() ;

/// @brief Method get_m_EventBuffer addr 0x2989db0 size 0x8 virtual false final false
 void* get_m_EventBuffer() ;

/// @brief Method set_m_EventBuffer addr 0x298b1e8 size 0x8 virtual false final false
 void set_m_EventBuffer(void* value) ;

/// @brief Method get_m_EventBufferHead addr 0x298b928 size 0x8 virtual false final false
 void* get_m_EventBufferHead() ;

/// @brief Method set_m_EventBufferHead addr 0x298b1f0 size 0x8 virtual false final false
 void set_m_EventBufferHead(void* value) ;

/// @brief Method get_m_EventBufferTail addr 0x298bb44 size 0x8 virtual false final false
 void* get_m_EventBufferTail() ;

/// @brief Method set_m_EventBufferTail addr 0x298b1f8 size 0x8 virtual false final false
 void set_m_EventBufferTail(void* value) ;

/// @brief Method Allocate addr 0x298bb1c size 0x28 virtual false final false
 void Allocate() ;

/// @brief Method Release addr 0x298bba0 size 0x40 virtual false final false
 void Release() ;

/// @brief Method OnBeforeUpdate addr 0x298bbe0 size 0x1ac virtual false final false
 void OnBeforeUpdate() ;

/// @brief Method OnInputEvent addr 0x298bd8c size 0x4ec virtual false final false
 void OnInputEvent(UnityEngine::InputSystem::LowLevel::InputEventPtr inputEvent, UnityEngine::InputSystem::InputDevice device) ;

/// @brief Method get_kFileFormat addr 0x298a8a0 size 0x30 virtual false final false
