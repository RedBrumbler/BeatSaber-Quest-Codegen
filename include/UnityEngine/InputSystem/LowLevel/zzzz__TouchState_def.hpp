...
/// @brief Method get_Format addr 0x2986588 size 0x30 virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC get_Format() ;

/// @brief Method get_phase addr 0x29865b8 size 0x8 virtual false final false
 UnityEngine::InputSystem::TouchPhase get_phase() ;

/// @brief Method set_phase addr 0x2980f4c size 0x8 virtual false final false
 void set_phase(UnityEngine::InputSystem::TouchPhase value) ;

/// @brief Method get_isNoneEndedOrCanceled addr 0x29865c0 size 0x20 virtual false final false
 bool get_isNoneEndedOrCanceled() ;

/// @brief Method get_isInProgress addr 0x29865e0 size 0x2c virtual false final false
 bool get_isInProgress() ;

/// @brief Method get_isPrimaryTouch addr 0x2982e68 size 0xc virtual false final false
 bool get_isPrimaryTouch() ;

/// @brief Method set_isPrimaryTouch addr 0x2982e4c size 0x1c virtual false final false
 void set_isPrimaryTouch(bool value) ;

/// @brief Method get_isOrphanedPrimaryTouch addr 0x298660c size 0xc virtual false final false
 bool get_isOrphanedPrimaryTouch() ;

/// @brief Method set_isOrphanedPrimaryTouch addr 0x2986618 size 0x1c virtual false final false
 void set_isOrphanedPrimaryTouch(bool value) ;

/// @brief Method get_isIndirectTouch addr 0x2986634 size 0xc virtual false final false
 bool get_isIndirectTouch() ;

/// @brief Method set_isIndirectTouch addr 0x2986640 size 0x1c virtual false final false
 void set_isIndirectTouch(bool value) ;

/// @brief Method get_isTap addr 0x297f4e0 size 0xc virtual false final false
 bool get_isTap() ;

/// @brief Method set_isTap addr 0x2982e74 size 0x1c virtual false final false
 void set_isTap(bool value) ;

/// @brief Method get_isTapPress addr 0x298665c size 0xc virtual false final false
 bool get_isTapPress() ;

/// @brief Method set_isTapPress addr 0x2986668 size 0x1c virtual false final false
 void set_isTapPress(bool value) ;

/// @brief Method get_isTapRelease addr 0x297eaac size 0xc virtual false final false
 bool get_isTapRelease() ;

/// @brief Method set_isTapRelease addr 0x2986684 size 0x1c virtual false final false
 void set_isTapRelease(bool value) ;

/// @brief Method get_beganInSameFrame addr 0x297ed64 size 0x10 virtual false final false
 bool get_beganInSameFrame() ;

/// @brief Method set_beganInSameFrame addr 0x297ed74 size 0x1c virtual false final false
 void set_beganInSameFrame(bool value) ;

/// @brief Method get_format addr 0x29866a0 size 0x30 virtual true final true
 UnityEngine::InputSystem::Utilities::FourCC get_format() ;

/// @brief Method ToString addr 0x29866d0 size 0x2c0 virtual true final false
 ::StringW ToString() ;
