...
/// @brief Method .ctor addr 0x2988788 size 0x38 virtual false final false
 void _ctor(UnityEngine::InputSystem::LowLevel::InputEventBuffer buffer) ;

/// @brief Method MoveNext addr 0x2988978 size 0x6c virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x29889e4 size 0xc virtual true final true
 void Reset() ;

/// @brief Method Dispose addr 0x29889f0 size 0x4 virtual true final true
 void Dispose() ;

/// @brief Method get_Current addr 0x29889f4 size 0x8 virtual true final true
 UnityEngine::InputSystem::LowLevel::InputEventPtr get_Current() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x29889fc size 0x5c virtual true final true
...
/// @brief Method get_eventCount addr 0x2987f24 size 0x8 virtual false final false
 int32_t get_eventCount() ;

/// @brief Method get_sizeInBytes addr 0x2987f2c size 0x8 virtual false final false
 int64_t get_sizeInBytes() ;

/// @brief Method get_capacityInBytes addr 0x2987f34 size 0x5c virtual false final false
 int64_t get_capacityInBytes() ;

/// @brief Method get_data addr 0x2987f90 size 0xc virtual false final false
 Unity::Collections::NativeArray_1<uint8_t> get_data() ;

/// @brief Method get_bufferPtr addr 0x2987f9c size 0x48 virtual false final false
 UnityEngine::InputSystem::LowLevel::InputEventPtr get_bufferPtr() ;

/// @brief Method .ctor addr 0x2987fe8 size 0x1c0 virtual false final false
 void _ctor(void* eventPtr, int32_t eventCount, int32_t sizeInBytes, int32_t capacityInBytes) ;

/// @brief Method .ctor addr 0x29881a8 size 0x14c virtual false final false
...
/// @brief Method AppendEvent addr 0x29882f4 size 0x80 virtual false final false
 void AppendEvent(void* eventPtr, int32_t capacityIncrementInBytes, Unity::Collections::Allocator allocator) ;

/// @brief Method AllocateEvent addr 0x2988374 size 0x2c8 virtual false final false
 void* AllocateEvent(int32_t sizeInBytes, int32_t capacityIncrementInBytes, Unity::Collections::Allocator allocator) ;

/// @brief Method Contains addr 0x2987e48 size 0x88 virtual false final false
 bool Contains(void* eventPtr) ;

/// @brief Method Reset addr 0x298863c size 0x18 virtual false final false
 void Reset() ;

/// @brief Method AdvanceToNextEvent addr 0x2988654 size 0xc0 virtual false final false
...
/// @brief Method GetEnumerator addr 0x2988714 size 0x74 virtual true final true
 System::Collections::Generic::IEnumerator_1<UnityEngine::InputSystem::LowLevel::InputEventPtr> GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x29887c0 size 0x4 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method Dispose addr 0x29887c4 size 0x60 virtual true final true
 void Dispose() ;

/// @brief Method Clone addr 0x2988824 size 0xe8 virtual false final false
 UnityEngine::InputSystem::LowLevel::InputEventBuffer Clone() ;

/// @brief Method System.ICloneable.Clone addr 0x298890c size 0x68 virtual true final true
