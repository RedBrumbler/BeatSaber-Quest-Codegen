...
template<>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6677)), TypeDefinitionIndex(TypeDefinitionIndex(2638))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6677), inst: 3764 })
...
template<>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2638)), TypeDefinitionIndex(TypeDefinitionIndex(6678))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6678), inst: 3764 })
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6676)), TypeDefinitionIndex(TypeDefinitionIndex(6679))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6679), inst: 3764 })
