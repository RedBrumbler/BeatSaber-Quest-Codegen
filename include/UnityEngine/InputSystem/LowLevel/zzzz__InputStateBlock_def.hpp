...
/// @brief Method GetSizeOfPrimitiveFormatInBits addr 0x298feb8 size 0x3d0 virtual false final false
static int32_t GetSizeOfPrimitiveFormatInBits(UnityEngine::InputSystem::Utilities::FourCC type) ;

/// @brief Method GetPrimitiveFormatFromType addr 0x2990288 size 0x4dc virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC GetPrimitiveFormatFromType(System::Type type) ;

/// @brief Method get_format addr 0x2990764 size 0x8 virtual false final false
 UnityEngine::InputSystem::Utilities::FourCC get_format() ;

/// @brief Method set_format addr 0x299076c size 0x8 virtual false final false
 void set_format(UnityEngine::InputSystem::Utilities::FourCC value) ;

/// @brief Method get_byteOffset addr 0x2990774 size 0x8 virtual false final false
 uint32_t get_byteOffset() ;

/// @brief Method set_byteOffset addr 0x299077c size 0x8 virtual false final false
 void set_byteOffset(uint32_t value) ;

/// @brief Method get_bitOffset addr 0x2990784 size 0x8 virtual false final false
 uint32_t get_bitOffset() ;

/// @brief Method set_bitOffset addr 0x299078c size 0x8 virtual false final false
 void set_bitOffset(uint32_t value) ;

/// @brief Method get_sizeInBits addr 0x2990794 size 0x8 virtual false final false
 uint32_t get_sizeInBits() ;

/// @brief Method set_sizeInBits addr 0x299079c size 0x8 virtual false final false
 void set_sizeInBits(uint32_t value) ;

/// @brief Method get_alignedSizeInBytes addr 0x2987220 size 0x10 virtual false final false
 uint32_t get_alignedSizeInBytes() ;

/// @brief Method get_effectiveByteOffset addr 0x29907a4 size 0xc virtual false final false
 uint32_t get_effectiveByteOffset() ;

/// @brief Method get_effectiveBitOffset addr 0x29907b0 size 0xc virtual false final false
 uint32_t get_effectiveBitOffset() ;

/// @brief Method ReadInt addr 0x29907bc size 0x1d0 virtual false final false
 int32_t ReadInt(void* statePtr) ;

/// @brief Method WriteInt addr 0x299098c size 0x1bc virtual false final false
 void WriteInt(void* statePtr, int32_t value) ;

/// @brief Method ReadFloat addr 0x2990b48 size 0x2fc virtual false final false
 float_t ReadFloat(void* statePtr) ;

/// @brief Method WriteFloat addr 0x2990e44 size 0x400 virtual false final false
 void WriteFloat(void* statePtr, float_t value) ;

/// @brief Method FloatToPrimitiveValue addr 0x2991244 size 0x4a0 virtual false final false
 UnityEngine::InputSystem::Utilities::PrimitiveValue FloatToPrimitiveValue(float_t value) ;

/// @brief Method ReadDouble addr 0x29916e4 size 0x2fc virtual false final false
 double_t ReadDouble(void* statePtr) ;

/// @brief Method WriteDouble addr 0x29919e0 size 0x424 virtual false final false
 void WriteDouble(void* statePtr, double_t value) ;

/// @brief Method Write addr 0x2991e04 size 0x2c0 virtual false final false
 void Write(void* statePtr, UnityEngine::InputSystem::Utilities::PrimitiveValue value) ;

/// @brief Method CopyToFrom addr 0x29920c4 size 0x8c virtual false final false
