...
/// @brief Method get_Type addr 0x29854c4 size 0x30 virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC get_Type() ;

/// @brief Method ReadLayoutName addr 0x29854f4 size 0x10 virtual false final false
 ::StringW ReadLayoutName() ;

/// @brief Method WriteLayoutName addr 0x2985504 size 0x24 virtual false final false
 void WriteLayoutName(::StringW name) ;

/// @brief Method get_typeStatic addr 0x2985528 size 0x30 virtual true final true
 UnityEngine::InputSystem::Utilities::FourCC get_typeStatic() ;

/// @brief Method Create addr 0x2985558 size 0x58 virtual false final false
