...
/// @brief Method get_value addr 0x298e744 size 0x8 virtual false final false
 uint32_t get_value() ;

/// @brief Method set_value addr 0x298e74c size 0x8 virtual false final false
 void set_value(uint32_t value) ;

/// @brief Method OnBeforeUpdate addr 0x298e564 size 0x18 virtual false final false
 void OnBeforeUpdate() ;

/// @brief Method OnUpdate addr 0x298e604 size 0x1c virtual false final false
 void OnUpdate() ;
...
/// @brief Method OnBeforeUpdate addr 0x298e4e4 size 0x80 virtual false final false
static void OnBeforeUpdate(UnityEngine::InputSystem::LowLevel::InputUpdateType type) ;

/// @brief Method OnUpdate addr 0x298e57c size 0x88 virtual false final false
static void OnUpdate(UnityEngine::InputSystem::LowLevel::InputUpdateType type) ;

/// @brief Method Save addr 0x298e620 size 0x64 virtual false final false
static UnityEngine::InputSystem::LowLevel::UnityEngine__InputSystem__LowLevel__InputUpdate__SerializedState Save() ;

/// @brief Method Restore addr 0x298e684 size 0x94 virtual false final false
...
/// @brief Method GetUpdateTypeForPlayer addr 0x298e718 size 0x20 virtual false final false
...
/// @brief Method IsPlayerUpdate addr 0x298e738 size 0xc virtual false final false
