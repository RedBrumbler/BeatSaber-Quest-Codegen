...
/// @brief Method get_Format addr 0x29862b4 size 0x30 virtual false final false
static UnityEngine::InputSystem::Utilities::FourCC get_Format() ;

/// @brief Method WithButton addr 0x29862e4 size 0x34 virtual false final false
 UnityEngine::InputSystem::LowLevel::PenState WithButton(UnityEngine::InputSystem::PenButton button, bool state) ;

/// @brief Method get_format addr 0x2986318 size 0x30 virtual true final true
