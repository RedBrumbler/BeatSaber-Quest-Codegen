...
/// @brief Method get_typeStatic addr 0x298dfc0 size 0x20 virtual true final true
 UnityEngine::InputSystem::Utilities::FourCC get_typeStatic() ;

/// @brief Method From addr 0x298dfe0 size 0x12c virtual false final false
static void* From(UnityEngine::InputSystem::LowLevel::InputEventPtr eventPtr) ;

/// @brief Method Create addr 0x298e10c size 0xa0 virtual false final false
static UnityEngine::InputSystem::LowLevel::TextEvent Create(int32_t deviceId, char16_t character, double_t time) ;

/// @brief Method Create addr 0x298e1ac size 0x9c virtual false final false
