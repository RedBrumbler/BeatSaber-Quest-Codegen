...
namespace UnityEngine::InputSystem::UI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13121))}
...
/// @brief Method .ctor addr 0x296bf64 size 0x8 virtual false final false
 void _ctor(UnityEngine::EventSystems::EventSystem eventSystem) ;

/// @brief Method ToString addr 0x296bf6c size 0xbc virtual true final false
 ::StringW ToString() ;
