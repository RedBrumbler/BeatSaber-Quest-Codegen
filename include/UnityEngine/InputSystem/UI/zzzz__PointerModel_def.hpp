...
/// @brief Method get_isPressed addr 0x29730b8 size 0x8 virtual false final false
 bool get_isPressed() ;

/// @brief Method set_isPressed addr 0x297221c size 0x54 virtual false final false
 void set_isPressed(bool value) ;

/// @brief Method get_ignoreNextClick addr 0x29730c0 size 0x8 virtual false final false
 bool get_ignoreNextClick() ;

/// @brief Method set_ignoreNextClick addr 0x29730c8 size 0xc virtual false final false
 void set_ignoreNextClick(bool value) ;

/// @brief Method get_pressTime addr 0x29730d4 size 0x8 virtual false final false
 float_t get_pressTime() ;

/// @brief Method set_pressTime addr 0x29730dc size 0x8 virtual false final false
 void set_pressTime(float_t value) ;

/// @brief Method get_clickedOnSameGameObject addr 0x29730e4 size 0x8 virtual false final false
 bool get_clickedOnSameGameObject() ;

/// @brief Method set_clickedOnSameGameObject addr 0x29730ec size 0xc virtual false final false
 void set_clickedOnSameGameObject(bool value) ;

/// @brief Method get_wasPressedThisFrame addr 0x296efa0 size 0x10 virtual false final false
 bool get_wasPressedThisFrame() ;

/// @brief Method get_wasReleasedThisFrame addr 0x296e8f8 size 0x14 virtual false final false
 bool get_wasReleasedThisFrame() ;

/// @brief Method CopyPressStateTo addr 0x296da70 size 0xa0 virtual false final false
 void CopyPressStateTo(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method CopyPressStateFrom addr 0x296efb0 size 0x68 virtual false final false
 void CopyPressStateFrom(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnEndFrame addr 0x29730ac size 0xc virtual false final false
 void OnEndFrame() ;
...
/// @brief Method get_pointerType addr 0x296db5c size 0x1c virtual false final false
 UnityEngine::InputSystem::UI::UIPointerType get_pointerType() ;

/// @brief Method get_screenPosition addr 0x2972f94 size 0xc virtual false final false
 UnityEngine::Vector2 get_screenPosition() ;

/// @brief Method set_screenPosition addr 0x2971be4 size 0x40 virtual false final false
 void set_screenPosition(UnityEngine::Vector2 value) ;

/// @brief Method get_worldPosition addr 0x2972fa0 size 0x10 virtual false final false
 UnityEngine::Vector3 get_worldPosition() ;

/// @brief Method set_worldPosition addr 0x2972638 size 0x54 virtual false final false
 void set_worldPosition(UnityEngine::Vector3 value) ;

/// @brief Method get_worldOrientation addr 0x2972fb0 size 0x14 virtual false final false
 UnityEngine::Quaternion get_worldOrientation() ;

/// @brief Method set_worldOrientation addr 0x297255c size 0x58 virtual false final false
 void set_worldOrientation(UnityEngine::Quaternion value) ;

/// @brief Method get_scrollDelta addr 0x2972fc4 size 0xc virtual false final false
 UnityEngine::Vector2 get_scrollDelta() ;

/// @brief Method set_scrollDelta addr 0x2972438 size 0x40 virtual false final false
 void set_scrollDelta(UnityEngine::Vector2 value) ;

/// @brief Method get_pressure addr 0x2972fd0 size 0x8 virtual false final false
 float_t get_pressure() ;

/// @brief Method set_pressure addr 0x2972fd8 size 0x1c virtual false final false
 void set_pressure(float_t value) ;

/// @brief Method get_azimuthAngle addr 0x2972ff4 size 0x8 virtual false final false
 float_t get_azimuthAngle() ;

/// @brief Method set_azimuthAngle addr 0x2972ffc size 0x1c virtual false final false
 void set_azimuthAngle(float_t value) ;

/// @brief Method get_altitudeAngle addr 0x2973018 size 0x8 virtual false final false
 float_t get_altitudeAngle() ;

/// @brief Method set_altitudeAngle addr 0x2973020 size 0x1c virtual false final false
 void set_altitudeAngle(float_t value) ;

/// @brief Method get_twist addr 0x297303c size 0x8 virtual false final false
 float_t get_twist() ;

/// @brief Method set_twist addr 0x2973044 size 0x1c virtual false final false
 void set_twist(float_t value) ;

/// @brief Method get_radius addr 0x2973060 size 0xc virtual false final false
 UnityEngine::Vector2 get_radius() ;

/// @brief Method set_radius addr 0x297306c size 0x40 virtual false final false
 void set_radius(UnityEngine::Vector2 value) ;

/// @brief Method .ctor addr 0x2971c24 size 0x6c virtual false final false
 void _ctor(UnityEngine::InputSystem::UI::ExtendedPointerEventData eventData) ;

/// @brief Method OnFrameFinished addr 0x2972844 size 0x48 virtual false final false
 void OnFrameFinished() ;

/// @brief Method CopyTouchOrPenStateFrom addr 0x297288c size 0xc8 virtual false final false
