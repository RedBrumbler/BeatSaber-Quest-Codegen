...
namespace UnityEngine::InputSystem::UI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13126))}
...
/// @brief Method .ctor addr 0x296c028 size 0x8 virtual false final false
 void _ctor(UnityEngine::EventSystems::EventSystem eventSystem) ;

/// @brief Method get_control addr 0x296c030 size 0x8 virtual false final false
 UnityEngine::InputSystem::InputControl get_control() ;

/// @brief Method set_control addr 0x296c038 size 0x8 virtual false final false
 void set_control(UnityEngine::InputSystem::InputControl value) ;

/// @brief Method get_device addr 0x296c040 size 0x8 virtual false final false
 UnityEngine::InputSystem::InputDevice get_device() ;

/// @brief Method set_device addr 0x296c048 size 0x8 virtual false final false
 void set_device(UnityEngine::InputSystem::InputDevice value) ;

/// @brief Method get_touchId addr 0x296c050 size 0x8 virtual false final false
 int32_t get_touchId() ;

/// @brief Method set_touchId addr 0x296c058 size 0x8 virtual false final false
 void set_touchId(int32_t value) ;

/// @brief Method get_pointerType addr 0x296c060 size 0x8 virtual false final false
 UnityEngine::InputSystem::UI::UIPointerType get_pointerType() ;

/// @brief Method set_pointerType addr 0x296c068 size 0x8 virtual false final false
 void set_pointerType(UnityEngine::InputSystem::UI::UIPointerType value) ;

/// @brief Method get_uiToolkitPointerId addr 0x296c070 size 0x8 virtual false final false
 int32_t get_uiToolkitPointerId() ;

/// @brief Method set_uiToolkitPointerId addr 0x296c078 size 0x8 virtual false final false
 void set_uiToolkitPointerId(int32_t value) ;

/// @brief Method get_trackedDevicePosition addr 0x296c080 size 0x10 virtual false final false
 UnityEngine::Vector3 get_trackedDevicePosition() ;

/// @brief Method set_trackedDevicePosition addr 0x296c090 size 0x10 virtual false final false
 void set_trackedDevicePosition(UnityEngine::Vector3 value) ;

/// @brief Method get_trackedDeviceOrientation addr 0x296c0a0 size 0x14 virtual false final false
 UnityEngine::Quaternion get_trackedDeviceOrientation() ;

/// @brief Method set_trackedDeviceOrientation addr 0x296c0b4 size 0x14 virtual false final false
 void set_trackedDeviceOrientation(UnityEngine::Quaternion value) ;

/// @brief Method ToString addr 0x296c0c8 size 0x3bc virtual true final false
 ::StringW ToString() ;

/// @brief Method MakePointerIdForTouch addr 0x296c484 size 0x8 virtual false final false
static int32_t MakePointerIdForTouch(int32_t deviceId, int32_t touchId) ;

/// @brief Method TouchIdFromPointerId addr 0x296c48c size 0x8 virtual false final false
static int32_t TouchIdFromPointerId(int32_t pointerId) ;

/// @brief Method ReadDeviceState addr 0x296c494 size 0x254 virtual false final false
 void ReadDeviceState() ;

/// @brief Method GetPenPointerId addr 0x296c6e8 size 0x254 virtual false final false
static int32_t GetPenPointerId(UnityEngine::InputSystem::Pen pen) ;

/// @brief Method GetTouchPointerId addr 0x296c93c size 0xf8 virtual false final false
