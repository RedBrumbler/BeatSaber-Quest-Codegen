...
namespace UnityEngine::InputSystem::UI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13149))}
...
/// @brief Method get_playerRoot addr 0x2972d3c size 0x8 virtual false final false
 UnityEngine::GameObject get_playerRoot() ;

/// @brief Method set_playerRoot addr 0x2972d44 size 0x8 virtual false final false
 void set_playerRoot(UnityEngine::GameObject value) ;

/// @brief Method OnEnable addr 0x2972e10 size 0x1c virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2972e2c size 0x8 virtual true final false
 void OnDisable() ;

/// @brief Method InitializePlayerRoot addr 0x2972d4c size 0xc4 virtual false final false
 void InitializePlayerRoot() ;

/// @brief Method Update addr 0x2972e34 size 0x108 virtual true final false
 void Update() ;

// Ctor Parameters []
explicit MultiplayerEventSystem() ;

/// @brief Method .ctor addr 0x2972f3c size 0x58 virtual false final false
 void _ctor() ;
