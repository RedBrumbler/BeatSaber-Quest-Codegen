...
/// @brief Method .ctor addr 0x2973bd8 size 0x14 virtual false final false
...
/// @brief Method get_graphic addr 0x2973cfc size 0x8 virtual false final false
 UnityEngine::UI::Graphic get_graphic() ;

/// @brief Method get_worldHitPosition addr 0x2973d04 size 0xc virtual false final false
 UnityEngine::Vector3 get_worldHitPosition() ;

/// @brief Method get_screenPosition addr 0x2973d10 size 0x8 virtual false final false
 UnityEngine::Vector2 get_screenPosition() ;

/// @brief Method get_distance addr 0x2973d18 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2973d84 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SortedRaycastGraphics>b__25_0 addr 0x2973d8c size 0x54 virtual false final false
...
/// @brief Method get_eventCamera addr 0x29730f8 size 0x94 virtual true final false
 UnityEngine::Camera get_eventCamera() ;

/// @brief Method get_blockingMask addr 0x2973220 size 0x8 virtual false final false
 UnityEngine::LayerMask get_blockingMask() ;

/// @brief Method set_blockingMask addr 0x2973228 size 0x8 virtual false final false
 void set_blockingMask(UnityEngine::LayerMask value) ;

/// @brief Method get_checkFor3DOcclusion addr 0x2973230 size 0x8 virtual false final false
 bool get_checkFor3DOcclusion() ;

/// @brief Method set_checkFor3DOcclusion addr 0x2973238 size 0xc virtual false final false
 void set_checkFor3DOcclusion(bool value) ;

/// @brief Method get_checkFor2DOcclusion addr 0x2973244 size 0x8 virtual false final false
 bool get_checkFor2DOcclusion() ;

/// @brief Method set_checkFor2DOcclusion addr 0x297324c size 0xc virtual false final false
 void set_checkFor2DOcclusion(bool value) ;

/// @brief Method get_ignoreReversedGraphics addr 0x2973258 size 0x8 virtual false final false
 bool get_ignoreReversedGraphics() ;

/// @brief Method set_ignoreReversedGraphics addr 0x2973260 size 0xc virtual false final false
 void set_ignoreReversedGraphics(bool value) ;

/// @brief Method get_maxDistance addr 0x297326c size 0x8 virtual false final false
 float_t get_maxDistance() ;

/// @brief Method set_maxDistance addr 0x2973274 size 0x8 virtual false final false
 void set_maxDistance(float_t value) ;

/// @brief Method OnEnable addr 0x297327c size 0x84 virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2973300 size 0xf4 virtual true final false
 void OnDisable() ;

/// @brief Method Raycast addr 0x29733f4 size 0xb0 virtual true final false
 void Raycast(UnityEngine::EventSystems::PointerEventData eventData, System::Collections::Generic::List_1<UnityEngine::EventSystems::RaycastResult> resultAppendList) ;

/// @brief Method PerformRaycast addr 0x296d0d4 size 0x5e0 virtual false final false
...
/// @brief Method SortedRaycastGraphics addr 0x29734a4 size 0x4dc virtual false final false
...
/// @brief Method RayIntersectsRectTransform addr 0x2973980 size 0x258 virtual false final false
...
/// @brief Method get_canvas addr 0x297318c size 0x94 virtual false final false
 UnityEngine::Canvas get_canvas() ;

// Ctor Parameters []
explicit TrackedDeviceRaycaster() ;

/// @brief Method .ctor addr 0x2973bec size 0x84 virtual false final false
 void _ctor() ;
