...
/// @brief Method get_cursorTransform addr 0x2973de0 size 0x8 virtual false final false
 UnityEngine::RectTransform get_cursorTransform() ;

/// @brief Method set_cursorTransform addr 0x2973de8 size 0x8 virtual false final false
 void set_cursorTransform(UnityEngine::RectTransform value) ;

/// @brief Method get_cursorSpeed addr 0x2973df0 size 0x8 virtual false final false
 float_t get_cursorSpeed() ;

/// @brief Method set_cursorSpeed addr 0x2973df8 size 0x8 virtual false final false
 void set_cursorSpeed(float_t value) ;

/// @brief Method get_cursorMode addr 0x2973e00 size 0x8 virtual false final false
 UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode get_cursorMode() ;

/// @brief Method set_cursorMode addr 0x2973e08 size 0xf8 virtual false final false
 void set_cursorMode(UnityEngine::InputSystem::UI::UnityEngine__InputSystem__UI__VirtualMouseInput__CursorMode value) ;

/// @brief Method get_cursorGraphic addr 0x2974118 size 0x8 virtual false final false
 UnityEngine::UI::Graphic get_cursorGraphic() ;

/// @brief Method set_cursorGraphic addr 0x2974120 size 0x8 virtual false final false
 void set_cursorGraphic(UnityEngine::UI::Graphic value) ;

/// @brief Method get_scrollSpeed addr 0x297417c size 0x8 virtual false final false
 float_t get_scrollSpeed() ;

/// @brief Method set_scrollSpeed addr 0x2974184 size 0x8 virtual false final false
 void set_scrollSpeed(float_t value) ;

/// @brief Method get_virtualMouse addr 0x297418c size 0x8 virtual false final false
 UnityEngine::InputSystem::Mouse get_virtualMouse() ;

/// @brief Method get_stickAction addr 0x2974194 size 0x14 virtual false final false
 UnityEngine::InputSystem::InputActionProperty get_stickAction() ;

/// @brief Method set_stickAction addr 0x29741a8 size 0x30 virtual false final false
 void set_stickAction(UnityEngine::InputSystem::InputActionProperty value) ;

/// @brief Method get_leftButtonAction addr 0x2974300 size 0x14 virtual false final false
 UnityEngine::InputSystem::InputActionProperty get_leftButtonAction() ;

/// @brief Method set_leftButtonAction addr 0x2974314 size 0x90 virtual false final false
 void set_leftButtonAction(UnityEngine::InputSystem::InputActionProperty value) ;

/// @brief Method get_rightButtonAction addr 0x2974414 size 0x14 virtual false final false
 UnityEngine::InputSystem::InputActionProperty get_rightButtonAction() ;

/// @brief Method set_rightButtonAction addr 0x2974428 size 0x90 virtual false final false
 void set_rightButtonAction(UnityEngine::InputSystem::InputActionProperty value) ;

/// @brief Method get_middleButtonAction addr 0x29744b8 size 0x14 virtual false final false
 UnityEngine::InputSystem::InputActionProperty get_middleButtonAction() ;

/// @brief Method set_middleButtonAction addr 0x29744cc size 0x90 virtual false final false
 void set_middleButtonAction(UnityEngine::InputSystem::InputActionProperty value) ;

/// @brief Method get_forwardButtonAction addr 0x297455c size 0x14 virtual false final false
 UnityEngine::InputSystem::InputActionProperty get_forwardButtonAction() ;

/// @brief Method set_forwardButtonAction addr 0x2974570 size 0x90 virtual false final false
 void set_forwardButtonAction(UnityEngine::InputSystem::InputActionProperty value) ;

/// @brief Method get_backButtonAction addr 0x2974600 size 0x14 virtual false final false
 UnityEngine::InputSystem::InputActionProperty get_backButtonAction() ;

/// @brief Method set_backButtonAction addr 0x2974614 size 0x90 virtual false final false
 void set_backButtonAction(UnityEngine::InputSystem::InputActionProperty value) ;

/// @brief Method get_scrollWheelAction addr 0x29746a4 size 0x14 virtual false final false
 UnityEngine::InputSystem::InputActionProperty get_scrollWheelAction() ;

/// @brief Method set_scrollWheelAction addr 0x29746b8 size 0x30 virtual false final false
 void set_scrollWheelAction(UnityEngine::InputSystem::InputActionProperty value) ;

/// @brief Method OnEnable addr 0x29746e8 size 0x40c virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2974af4 size 0x23c virtual false final false
 void OnDisable() ;

/// @brief Method TryFindCanvas addr 0x2974128 size 0x54 virtual false final false
 void TryFindCanvas() ;

/// @brief Method TryEnableHardwareCursor addr 0x2973f00 size 0x218 virtual false final false
 void TryEnableHardwareCursor() ;

/// @brief Method UpdateMotion addr 0x2974d30 size 0x3b8 virtual false final false
 void UpdateMotion() ;

/// @brief Method OnButtonActionTriggered addr 0x29750e8 size 0x1f4 virtual false final false
 void OnButtonActionTriggered(UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext context) ;

/// @brief Method SetActionCallback addr 0x29743a4 size 0x70 virtual false final false
...
/// @brief Method SetAction addr 0x29741d8 size 0x128 virtual false final false
...
/// @brief Method OnAfterInputUpdate addr 0x29752dc size 0x4 virtual false final false
 void OnAfterInputUpdate() ;

// Ctor Parameters []
explicit VirtualMouseInput() ;

/// @brief Method .ctor addr 0x29752e0 size 0x14 virtual false final false
 void _ctor() ;
