...
/// @brief Method get_distance addr 0x29473e0 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_distance() ;

/// @brief Method set_distance addr 0x29473e8 size 0x8 virtual false final false
 void set_distance(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_current addr 0x29473f0 size 0x48 virtual false final false
static UnityEngine::InputSystem::ProximitySensor get_current() ;

/// @brief Method set_current addr 0x2947438 size 0x4c virtual false final false
static void set_current(UnityEngine::InputSystem::ProximitySensor value) ;

/// @brief Method MakeCurrent addr 0x2947484 size 0x54 virtual true final false
 void MakeCurrent() ;

/// @brief Method OnRemoved addr 0x29474d8 size 0x84 virtual true final false
 void OnRemoved() ;

/// @brief Method FinishSetup addr 0x294755c size 0x78 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit ProximitySensor() ;

/// @brief Method .ctor addr 0x29475d4 size 0x8 virtual false final false
 void _ctor() ;
