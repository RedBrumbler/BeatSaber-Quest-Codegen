...
/// @brief Method GetValueType addr 0x28d5cf4 size 0xf4 virtual false final false
static System::Type GetValueType(System::Type interactionType) ;

/// @brief Method GetDisplayName addr 0x28d5de8 size 0x104 virtual false final false
static ::StringW GetDisplayName(::StringW interaction) ;

/// @brief Method GetDisplayName addr 0x28d5eec size 0x198 virtual false final false
