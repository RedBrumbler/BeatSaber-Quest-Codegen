...
/// @brief Method get_totalMapCount addr 0x28f61b0 size 0x8 virtual false final false
 int32_t get_totalMapCount() ;

/// @brief Method get_totalActionCount addr 0x28f61b8 size 0x8 virtual false final false
 int32_t get_totalActionCount() ;

/// @brief Method get_totalBindingCount addr 0x28f61c0 size 0x8 virtual false final false
 int32_t get_totalBindingCount() ;

/// @brief Method get_totalControlCount addr 0x28f61c8 size 0x8 virtual false final false
 int32_t get_totalControlCount() ;

/// @brief Method Dispose addr 0x28f61d0 size 0x48 virtual true final true
 void Dispose() ;

/// @brief Method StartWithPreviousResolve addr 0x28f6218 size 0xe8 virtual false final false
 void StartWithPreviousResolve(UnityEngine::InputSystem::InputActionState state, bool isFullResolve) ;

/// @brief Method AddActionMap addr 0x28f6300 size 0x1610 virtual false final false
...
/// @brief Method InstantiateBindingComposite addr 0x28f7910 size 0x2f4 virtual false final false
...
/// @brief Method ApplyParameters addr 0x28f7e3c size 0x684 virtual false final false
...
/// @brief Method AssignCompositePartIndex addr 0x28f7c04 size 0x238 virtual false final false
