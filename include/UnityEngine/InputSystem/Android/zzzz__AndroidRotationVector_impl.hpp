...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::InputSystem::Android::AndroidRotationVector::*)()>(&UnityEngine::InputSystem::Android::AndroidRotationVector::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2983234;
...
// Ctor Parameters []
 UnityEngine::InputSystem::Android::AndroidRotationVector::AndroidRotationVector()  : UnityEngine::InputSystem::AttitudeSensor(THROW_UNLESS(::il2cpp_utils::New<AndroidRotationVector>())) {}
