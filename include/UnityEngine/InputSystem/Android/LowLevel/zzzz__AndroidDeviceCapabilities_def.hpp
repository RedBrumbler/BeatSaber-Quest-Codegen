...
/// @brief Method .ctor addr 0x29843d0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ToString>b__8_0 addr 0x29843d8 size 0x64 virtual false final false
...
/// @brief Method ToJson addr 0x2983f90 size 0x6c virtual false final false
 ::StringW ToJson() ;

/// @brief Method FromJson addr 0x2983d9c size 0xc0 virtual false final false
static UnityEngine::InputSystem::Android::LowLevel::AndroidDeviceCapabilities FromJson(::StringW json) ;

/// @brief Method ToString addr 0x2983ffc size 0x370 virtual true final false
 ::StringW ToString() ;
