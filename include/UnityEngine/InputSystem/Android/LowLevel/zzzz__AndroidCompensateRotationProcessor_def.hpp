...
namespace UnityEngine::InputSystem::Android::LowLevel {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6685))}
...
/// @brief Method Process addr 0x2984790 size 0x34 virtual true final false
...
/// @brief Method .ctor addr 0x29847c4 size 0x8 virtual false final false
 void _ctor() ;
