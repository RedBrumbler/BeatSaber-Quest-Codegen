...
/// @brief Method ToJson addr 0x298443c size 0x64 virtual false final false
 ::StringW ToJson() ;

/// @brief Method FromJson addr 0x29844a0 size 0xa0 virtual false final false
static UnityEngine::InputSystem::Android::LowLevel::AndroidSensorCapabilities FromJson(::StringW json) ;

/// @brief Method ToString addr 0x2984540 size 0x98 virtual true final false
 ::StringW ToString() ;
