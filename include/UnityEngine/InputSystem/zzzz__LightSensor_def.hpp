...
/// @brief Method get_lightLevel addr 0x2946fe8 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_lightLevel() ;

/// @brief Method set_lightLevel addr 0x2946ff0 size 0x8 virtual false final false
 void set_lightLevel(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_current addr 0x2946ff8 size 0x48 virtual false final false
static UnityEngine::InputSystem::LightSensor get_current() ;

/// @brief Method set_current addr 0x2947040 size 0x4c virtual false final false
static void set_current(UnityEngine::InputSystem::LightSensor value) ;

/// @brief Method MakeCurrent addr 0x294708c size 0x54 virtual true final false
 void MakeCurrent() ;

/// @brief Method OnRemoved addr 0x29470e0 size 0x84 virtual true final false
 void OnRemoved() ;

/// @brief Method FinishSetup addr 0x2947164 size 0x78 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit LightSensor() ;

/// @brief Method .ctor addr 0x29471dc size 0x8 virtual false final false
 void _ctor() ;
