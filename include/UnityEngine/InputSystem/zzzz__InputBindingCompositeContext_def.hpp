...
/// @brief Method get_part addr 0x28f5f30 size 0x8 virtual false final false
 int32_t get_part() ;

/// @brief Method set_part addr 0x28f5f38 size 0x8 virtual false final false
 void set_part(int32_t value) ;

/// @brief Method get_control addr 0x28f5f40 size 0x8 virtual false final false
 UnityEngine::InputSystem::InputControl get_control() ;

/// @brief Method set_control addr 0x28f5f48 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x28f5de4 size 0x34 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x28f5f50 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x28f5f54 size 0x100 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.InputSystem.InputBindingCompositeContext.PartBinding>.get_Current addr 0x28f6054 size 0xc virtual true final true
...
/// @brief Method System.Collections.IEnumerator.Reset addr 0x28f6060 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x28f60a0 size 0x5c virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputBindingCompositeContext.PartBinding>.GetEnumerator addr 0x28f60fc size 0xb0 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x28f61ac size 0x4 virtual true final true
...
/// @brief Method get_controls addr 0x28f5d68 size 0x7c virtual false final false
...
/// @brief Method EvaluateMagnitude addr 0x28f5e18 size 0x24 virtual false final false
...
/// @brief Method ReadValueAsButton addr 0x28f5e3c size 0x88 virtual false final false
 bool ReadValueAsButton(int32_t partNumber) ;

/// @brief Method ReadValue addr 0x28f5ec4 size 0x24 virtual false final false
 void ReadValue(int32_t partNumber, void* buffer, int32_t bufferSize) ;

/// @brief Method ReadValueAsObject addr 0x28f5ee8 size 0x24 virtual false final false
 ::bs_hook::Il2CppWrapperType ReadValueAsObject(int32_t partNumber) ;

/// @brief Method GetPressTime addr 0x28f5f0c size 0x24 virtual false final false
...
template<::cordl_internals::il2cpp_reference_type TValue>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6294)), TypeDefinitionIndex(TypeDefinitionIndex(2638))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6294), inst: 2 })
...
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6294)), TypeDefinitionIndex(TypeDefinitionIndex(2638))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6294), inst: 374 })
// CS Name: UnityEngine.InputSystem.InputBindingCompositeContext::DefaultComparer`1
