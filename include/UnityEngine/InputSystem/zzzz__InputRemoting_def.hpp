...
/// @brief Method Dispose addr 0x2944824 size 0x58 virtual true final true
 void Dispose() ;

// Ctor Parameters []
explicit UnityEngine__InputSystem__InputRemoting__Subscriber() ;

/// @brief Method .ctor addr 0x2943028 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Process addr 0x2942384 size 0x44 virtual false final false
...
/// @brief Method Process addr 0x2942f1c size 0x10 virtual false final false
static void Process(UnityEngine::InputSystem::InputRemoting receiver) ;
...
/// @brief Method Process addr 0x2942f2c size 0x10 virtual false final false
static void Process(UnityEngine::InputSystem::InputRemoting receiver) ;
...
/// @brief Method Process addr 0x29423c8 size 0x94 virtual false final false
...
/// @brief Method Create addr 0x29433a0 size 0x24c virtual false final false
...
/// @brief Method Process addr 0x294245c size 0xf8 virtual false final false
static void Process(UnityEngine::InputSystem::InputRemoting receiver, UnityEngine::InputSystem::UnityEngine__InputSystem__InputRemoting__Message msg) ;
...
/// @brief Method .ctor addr 0x2945024 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Create>b__1_0 addr 0x294502c size 0x24 virtual false final false
...
/// @brief Method Create addr 0x29437dc size 0x200 virtual false final false
...
/// @brief Method Process addr 0x2942554 size 0x538 virtual false final false
static void Process(UnityEngine::InputSystem::InputRemoting receiver, UnityEngine::InputSystem::UnityEngine__InputSystem__InputRemoting__Message msg) ;
...
/// @brief Method CreateResetEvent addr 0x2943ee8 size 0x78 virtual false final false
...
/// @brief Method CreateStateEvent addr 0x29439dc size 0xfc virtual false final false
...
/// @brief Method Create addr 0x2943b3c size 0xd8 virtual false final false
static UnityEngine::InputSystem::UnityEngine__InputSystem__InputRemoting__Message Create(void* events, int32_t eventCount) ;

/// @brief Method Process addr 0x2942a8c size 0xc0 virtual false final false
static void Process(UnityEngine::InputSystem::InputRemoting receiver, UnityEngine::InputSystem::UnityEngine__InputSystem__InputRemoting__Message msg) ;
...
/// @brief Method .ctor addr 0x29451ec size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Create>b__1_0 addr 0x29451f4 size 0x24 virtual false final false
 ::StringW _Create_b__1_0(UnityEngine::InputSystem::Utilities::InternedString x) ;
...
/// @brief Method Create addr 0x2943d44 size 0x1a4 virtual false final false
static UnityEngine::InputSystem::UnityEngine__InputSystem__InputRemoting__Message Create(UnityEngine::InputSystem::InputDevice device) ;

/// @brief Method Process addr 0x2942b4c size 0x310 virtual false final false
static void Process(UnityEngine::InputSystem::InputRemoting receiver, UnityEngine::InputSystem::UnityEngine__InputSystem__InputRemoting__Message msg) ;
...
/// @brief Method Create addr 0x2943cd4 size 0x70 virtual false final false
static UnityEngine::InputSystem::UnityEngine__InputSystem__InputRemoting__Message Create(UnityEngine::InputSystem::InputDevice device) ;

/// @brief Method Process addr 0x2942e5c size 0xc0 virtual false final false
static void Process(UnityEngine::InputSystem::InputRemoting receiver, UnityEngine::InputSystem::UnityEngine__InputSystem__InputRemoting__Message msg) ;
...
/// @brief Method get_sending addr 0x2941d48 size 0xc virtual false final false
 bool get_sending() ;

/// @brief Method set_sending addr 0x2941d54 size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0x2941d70 size 0x8c virtual false final false
 void _ctor(UnityEngine::InputSystem::InputManager manager, bool startSendingOnConnect) ;

/// @brief Method StartSending addr 0x2941dfc size 0x17c virtual false final false
 void StartSending() ;

/// @brief Method StopSending addr 0x2942098 size 0x160 virtual false final false
 void StopSending() ;

/// @brief Method System.IObserver<UnityEngine.InputSystem.InputRemoting.Message>.OnNext addr 0x2942300 size 0x84 virtual true final true
...
/// @brief Method System.IObserver<UnityEngine.InputSystem.InputRemoting.Message>.OnError addr 0x2942f3c size 0x4 virtual true final true
 void System_IObserver_UnityEngine_InputSystem_InputRemoting_Message__OnError(System::Exception error) ;

/// @brief Method System.IObserver<UnityEngine.InputSystem.InputRemoting.Message>.OnCompleted addr 0x2942f40 size 0x4 virtual true final true
 void System_IObserver_UnityEngine_InputSystem_InputRemoting_Message__OnCompleted() ;

/// @brief Method Subscribe addr 0x2942f44 size 0xe4 virtual true final true
...
/// @brief Method SendInitialMessages addr 0x2942080 size 0x18 virtual false final false
 void SendInitialMessages() ;

/// @brief Method SendAllGeneratedLayouts addr 0x2943030 size 0x154 virtual false final false
 void SendAllGeneratedLayouts() ;

/// @brief Method SendLayout addr 0x29432ec size 0xb4 virtual false final false
 void SendLayout(::StringW layoutName) ;

/// @brief Method SendAllDevices addr 0x2943184 size 0x168 virtual false final false
 void SendAllDevices() ;

/// @brief Method SendDevice addr 0x2943758 size 0x84 virtual false final false
 void SendDevice(UnityEngine::InputSystem::InputDevice device) ;

/// @brief Method SendEvent addr 0x2943ad8 size 0x64 virtual false final false
 void SendEvent(UnityEngine::InputSystem::LowLevel::InputEventPtr eventPtr, UnityEngine::InputSystem::InputDevice device) ;

/// @brief Method SendDeviceChange addr 0x2943c14 size 0xc0 virtual false final false
 void SendDeviceChange(UnityEngine::InputSystem::InputDevice device, UnityEngine::InputSystem::InputDeviceChange change) ;

/// @brief Method SendLayoutChange addr 0x2943f60 size 0x104 virtual false final false
 void SendLayoutChange(::StringW layout, UnityEngine::InputSystem::InputControlLayoutChange change) ;

/// @brief Method Send addr 0x29435ec size 0x104 virtual false final false
 void Send(UnityEngine::InputSystem::UnityEngine__InputSystem__InputRemoting__Message msg) ;

/// @brief Method FindOrCreateSenderRecord addr 0x2944064 size 0xa4 virtual false final false
 int32_t FindOrCreateSenderRecord(int32_t senderId) ;

/// @brief Method BuildLayoutNamespace addr 0x2944108 size 0xa0 virtual false final false
static UnityEngine::InputSystem::Utilities::InternedString BuildLayoutNamespace(int32_t senderId) ;

/// @brief Method FindLocalDeviceId addr 0x29441a8 size 0x74 virtual false final false
 int32_t FindLocalDeviceId(int32_t remoteDeviceId, int32_t senderIndex) ;

/// @brief Method TryGetDeviceByRemoteId addr 0x294421c size 0x28 virtual false final false
 UnityEngine::InputSystem::InputDevice TryGetDeviceByRemoteId(int32_t remoteDeviceId, int32_t senderIndex) ;

/// @brief Method get_manager addr 0x29442bc size 0x8 virtual false final false
 UnityEngine::InputSystem::InputManager get_manager() ;

/// @brief Method RemoveRemoteDevices addr 0x29442c4 size 0xfc virtual false final false
