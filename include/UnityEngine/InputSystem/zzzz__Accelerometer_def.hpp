...
/// @brief Method get_acceleration addr 0x2946400 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector3Control get_acceleration() ;

/// @brief Method set_acceleration addr 0x2946408 size 0x8 virtual false final false
 void set_acceleration(UnityEngine::InputSystem::Controls::Vector3Control value) ;

/// @brief Method get_current addr 0x2946410 size 0x48 virtual false final false
static UnityEngine::InputSystem::Accelerometer get_current() ;

/// @brief Method set_current addr 0x2946458 size 0x4c virtual false final false
static void set_current(UnityEngine::InputSystem::Accelerometer value) ;

/// @brief Method MakeCurrent addr 0x29464a4 size 0x54 virtual true final false
 void MakeCurrent() ;

/// @brief Method OnRemoved addr 0x29464f8 size 0x84 virtual true final false
 void OnRemoved() ;

/// @brief Method FinishSetup addr 0x294657c size 0x78 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit Accelerometer() ;

/// @brief Method .ctor addr 0x29465f4 size 0x8 virtual false final false
 void _ctor() ;
