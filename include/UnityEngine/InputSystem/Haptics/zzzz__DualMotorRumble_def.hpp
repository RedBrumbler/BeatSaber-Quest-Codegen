...
/// @brief Method get_lowFrequencyMotorSpeed addr 0x29847cc size 0x8 virtual false final false
 float_t get_lowFrequencyMotorSpeed() ;

/// @brief Method set_lowFrequencyMotorSpeed addr 0x29847d4 size 0x8 virtual false final false
 void set_lowFrequencyMotorSpeed(float_t value) ;

/// @brief Method get_highFrequencyMotorSpeed addr 0x29847dc size 0x8 virtual false final false
 float_t get_highFrequencyMotorSpeed() ;

/// @brief Method set_highFrequencyMotorSpeed addr 0x29847e4 size 0x8 virtual false final false
 void set_highFrequencyMotorSpeed(float_t value) ;

/// @brief Method get_isRumbling addr 0x29847ec size 0xb8 virtual false final false
 bool get_isRumbling() ;

/// @brief Method PauseHaptics addr 0x29848a4 size 0x110 virtual false final false
 void PauseHaptics(UnityEngine::InputSystem::InputDevice device) ;

/// @brief Method ResumeHaptics addr 0x2984a04 size 0x8c virtual false final false
 void ResumeHaptics(UnityEngine::InputSystem::InputDevice device) ;

/// @brief Method ResetHaptics addr 0x2984bd4 size 0x90 virtual false final false
 void ResetHaptics(UnityEngine::InputSystem::InputDevice device) ;

/// @brief Method SetMotorSpeeds addr 0x2984a90 size 0x144 virtual false final false
