...
/// @brief Method get_angularVelocity addr 0x29465fc size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector3Control get_angularVelocity() ;

/// @brief Method set_angularVelocity addr 0x2946604 size 0x8 virtual false final false
 void set_angularVelocity(UnityEngine::InputSystem::Controls::Vector3Control value) ;

/// @brief Method get_current addr 0x294660c size 0x48 virtual false final false
static UnityEngine::InputSystem::Gyroscope get_current() ;

/// @brief Method set_current addr 0x2946654 size 0x4c virtual false final false
static void set_current(UnityEngine::InputSystem::Gyroscope value) ;

/// @brief Method MakeCurrent addr 0x29466a0 size 0x54 virtual true final false
 void MakeCurrent() ;

/// @brief Method OnRemoved addr 0x29466f4 size 0x84 virtual true final false
 void OnRemoved() ;

/// @brief Method FinishSetup addr 0x2946778 size 0x78 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit Gyroscope() ;

/// @brief Method .ctor addr 0x29467f0 size 0x8 virtual false final false
 void _ctor() ;
