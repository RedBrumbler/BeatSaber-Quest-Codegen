...
/// @brief Method get_action addr 0x28e71f0 size 0x94 virtual false final false
 UnityEngine::InputSystem::InputAction get_action() ;

/// @brief Method get_reference addr 0x28e7330 size 0x18 virtual false final false
 UnityEngine::InputSystem::InputActionReference get_reference() ;

/// @brief Method .ctor addr 0x28e7348 size 0xc virtual false final false
 void _ctor(UnityEngine::InputSystem::InputAction action) ;

/// @brief Method .ctor addr 0x28e7354 size 0x10 virtual false final false
 void _ctor(UnityEngine::InputSystem::InputActionReference reference) ;

/// @brief Method Equals addr 0x28e7364 size 0xa4 virtual true final true
 bool Equals(UnityEngine::InputSystem::InputActionProperty other) ;

/// @brief Method Equals addr 0x28e7408 size 0x1c virtual true final true
 bool Equals(UnityEngine::InputSystem::InputAction other) ;

/// @brief Method Equals addr 0x28e7424 size 0x6c virtual true final true
 bool Equals(UnityEngine::InputSystem::InputActionReference other) ;

/// @brief Method Equals addr 0x28e7490 size 0xcc virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x28e755c size 0x9c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x28e75f8 size 0x30 virtual false final false
...
/// @brief Method op_Inequality addr 0x28e7628 size 0x34 virtual false final false
