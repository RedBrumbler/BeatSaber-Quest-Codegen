...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10420), inst: 408 }), TypeDefinitionIndex(TypeDefinitionIndex(10420)), TypeDefinitionIndex(TypeDefinitionIndex(6235))}
...
/// @brief Method get_actionId addr 0x29605b4 size 0x8 virtual false final false
 ::StringW get_actionId() ;

/// @brief Method get_actionName addr 0x29605bc size 0x8 virtual false final false
 ::StringW get_actionName() ;

// Ctor Parameters []
explicit UnityEngine__InputSystem__PlayerInput__ActionEvent() ;

/// @brief Method .ctor addr 0x29605c4 size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x296060c size 0x1dc virtual false final false
...
/// @brief Method .ctor addr 0x29607e8 size 0x74 virtual false final false
...
/// @brief Method get_inputIsActive addr 0x2959944 size 0x8 virtual false final false
 bool get_inputIsActive() ;

/// @brief Method get_active addr 0x295994c size 0x8 virtual false final false
 bool get_active() ;

/// @brief Method get_playerIndex addr 0x2959954 size 0x8 virtual false final false
 int32_t get_playerIndex() ;

/// @brief Method get_splitScreenIndex addr 0x295995c size 0x8 virtual false final false
 int32_t get_splitScreenIndex() ;

/// @brief Method get_actions addr 0x2959964 size 0x44 virtual false final false
 UnityEngine::InputSystem::InputActionAsset get_actions() ;

/// @brief Method set_actions addr 0x2959eb4 size 0xf8 virtual false final false
 void set_actions(UnityEngine::InputSystem::InputActionAsset value) ;

/// @brief Method get_currentControlScheme addr 0x295a9c4 size 0x80 virtual false final false
 ::StringW get_currentControlScheme() ;

/// @brief Method get_defaultControlScheme addr 0x295ab74 size 0x8 virtual false final false
 ::StringW get_defaultControlScheme() ;

/// @brief Method set_defaultControlScheme addr 0x295ab7c size 0x8 virtual false final false
 void set_defaultControlScheme(::StringW value) ;

/// @brief Method get_neverAutoSwitchControlSchemes addr 0x295ab84 size 0x8 virtual false final false
 bool get_neverAutoSwitchControlSchemes() ;

/// @brief Method set_neverAutoSwitchControlSchemes addr 0x295ab8c size 0x38 virtual false final false
 void set_neverAutoSwitchControlSchemes(bool value) ;

/// @brief Method get_currentActionMap addr 0x295ad6c size 0x8 virtual false final false
 UnityEngine::InputSystem::InputActionMap get_currentActionMap() ;

/// @brief Method set_currentActionMap addr 0x295ad74 size 0x4c virtual false final false
 void set_currentActionMap(UnityEngine::InputSystem::InputActionMap value) ;

/// @brief Method get_defaultActionMap addr 0x295adc0 size 0x8 virtual false final false
 ::StringW get_defaultActionMap() ;

/// @brief Method set_defaultActionMap addr 0x295adc8 size 0x8 virtual false final false
 void set_defaultActionMap(::StringW value) ;

/// @brief Method get_notificationBehavior addr 0x295add0 size 0x8 virtual false final false
 UnityEngine::InputSystem::PlayerNotifications get_notificationBehavior() ;

/// @brief Method set_notificationBehavior addr 0x295add8 size 0x58 virtual false final false
 void set_notificationBehavior(UnityEngine::InputSystem::PlayerNotifications value) ;

/// @brief Method get_actionEvents addr 0x295ae30 size 0x48 virtual false final false
...
/// @brief Method set_actionEvents addr 0x295ae78 size 0x7c virtual false final false
...
/// @brief Method get_deviceLostEvent addr 0x295aef4 size 0x68 virtual false final false
 UnityEngine::InputSystem::UnityEngine__InputSystem__PlayerInput__DeviceLostEvent get_deviceLostEvent() ;

/// @brief Method get_deviceRegainedEvent addr 0x295afa4 size 0x68 virtual false final false
 UnityEngine::InputSystem::UnityEngine__InputSystem__PlayerInput__DeviceRegainedEvent get_deviceRegainedEvent() ;

/// @brief Method get_controlsChangedEvent addr 0x295b054 size 0x68 virtual false final false
 UnityEngine::InputSystem::UnityEngine__InputSystem__PlayerInput__ControlsChangedEvent get_controlsChangedEvent() ;

/// @brief Method add_onActionTriggered addr 0x295b104 size 0xa0 virtual false final false
...
/// @brief Method remove_onActionTriggered addr 0x295b1a4 size 0xa0 virtual false final false
...
/// @brief Method add_onDeviceLost addr 0x295b244 size 0xa0 virtual false final false
 void add_onDeviceLost(System::Action_1<UnityEngine::InputSystem::PlayerInput> value) ;

/// @brief Method remove_onDeviceLost addr 0x295b2e4 size 0xa0 virtual false final false
 void remove_onDeviceLost(System::Action_1<UnityEngine::InputSystem::PlayerInput> value) ;

/// @brief Method add_onDeviceRegained addr 0x295b384 size 0xa0 virtual false final false
 void add_onDeviceRegained(System::Action_1<UnityEngine::InputSystem::PlayerInput> value) ;

/// @brief Method remove_onDeviceRegained addr 0x295b424 size 0xa0 virtual false final false
 void remove_onDeviceRegained(System::Action_1<UnityEngine::InputSystem::PlayerInput> value) ;

/// @brief Method add_onControlsChanged addr 0x295b4c4 size 0xa0 virtual false final false
 void add_onControlsChanged(System::Action_1<UnityEngine::InputSystem::PlayerInput> value) ;

/// @brief Method remove_onControlsChanged addr 0x295b564 size 0xa0 virtual false final false
 void remove_onControlsChanged(System::Action_1<UnityEngine::InputSystem::PlayerInput> value) ;

/// @brief Method get_camera addr 0x295b604 size 0x8 virtual false final false
 UnityEngine::Camera get_camera() ;

/// @brief Method set_camera addr 0x295b60c size 0x8 virtual false final false
 void set_camera(UnityEngine::Camera value) ;

/// @brief Method get_uiInputModule addr 0x295b614 size 0x8 virtual false final false
 UnityEngine::InputSystem::UI::InputSystemUIInputModule get_uiInputModule() ;

/// @brief Method set_uiInputModule addr 0x295b61c size 0x158 virtual false final false
 void set_uiInputModule(UnityEngine::InputSystem::UI::InputSystemUIInputModule value) ;

/// @brief Method get_user addr 0x295b774 size 0x8 virtual false final false
 UnityEngine::InputSystem::Users::InputUser get_user() ;

/// @brief Method get_devices addr 0x295b77c size 0x30 virtual false final false
 UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<UnityEngine::InputSystem::InputDevice> get_devices() ;

/// @brief Method get_hasMissingRequiredDevices addr 0x295b858 size 0x48 virtual false final false
 bool get_hasMissingRequiredDevices() ;

/// @brief Method get_all addr 0x295b91c size 0x90 virtual false final false
static UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<UnityEngine::InputSystem::PlayerInput> get_all() ;

/// @brief Method get_isSinglePlayer addr 0x295b9ac size 0x118 virtual false final false
...
/// @brief Method ActivateInput addr 0x295a910 size 0xb4 virtual false final false
 void ActivateInput() ;

/// @brief Method DeactivateInput addr 0x295bc30 size 0x24 virtual false final false
 void DeactivateInput() ;

/// @brief Method PassivateInput addr 0x295bc54 size 0x24 virtual false final false
 void PassivateInput() ;

/// @brief Method SwitchCurrentControlScheme addr 0x295bc78 size 0x1d8 virtual false final false
 bool SwitchCurrentControlScheme(::ArrayW<UnityEngine::InputSystem::InputDevice> devices) ;

/// @brief Method SwitchCurrentControlScheme addr 0x295c244 size 0xe0 virtual false final false
 void SwitchCurrentControlScheme(::StringW controlScheme, ::ArrayW<UnityEngine::InputSystem::InputDevice> devices) ;

/// @brief Method SwitchCurrentActionMap addr 0x295bac4 size 0x16c virtual false final false
 void SwitchCurrentActionMap(::StringW mapNameOrId) ;

/// @brief Method GetPlayerByIndex addr 0x295c3e0 size 0xfc virtual false final false
static UnityEngine::InputSystem::PlayerInput GetPlayerByIndex(int32_t playerIndex) ;

/// @brief Method FindFirstPairedToDevice addr 0x295c4dc size 0x16c virtual false final false
static UnityEngine::InputSystem::PlayerInput FindFirstPairedToDevice(UnityEngine::InputSystem::InputDevice device) ;

/// @brief Method Instantiate addr 0x295c648 size 0x15c virtual false final false
...
/// @brief Method Instantiate addr 0x295cae4 size 0x194 virtual false final false
...
/// @brief Method DoInstantiate addr 0x295c7a4 size 0x340 virtual false final false
static UnityEngine::InputSystem::PlayerInput DoInstantiate(UnityEngine::GameObject prefab) ;

/// @brief Method InitializeActions addr 0x29599a8 size 0x50c virtual false final false
 void InitializeActions() ;

/// @brief Method UninitializeActions addr 0x2959fac size 0x1d4 virtual false final false
 void UninitializeActions() ;

/// @brief Method InstallOnActionTriggeredHook addr 0x295cc78 size 0x1d8 virtual false final false
 void InstallOnActionTriggeredHook() ;

/// @brief Method UninstallOnActionTriggeredHook addr 0x295d21c size 0x18c virtual false final false
 void UninstallOnActionTriggeredHook() ;

/// @brief Method OnActionTriggered addr 0x295d3a8 size 0x1f4 virtual false final false
 void OnActionTriggered(UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext context) ;

/// @brief Method CacheMessageNames addr 0x295ce50 size 0x3cc virtual false final false
 void CacheMessageNames() ;

/// @brief Method ClearCaches addr 0x295a180 size 0x4 virtual false final false
 void ClearCaches() ;

/// @brief Method AssignUserAndDevices addr 0x295a184 size 0x78c virtual false final false
 void AssignUserAndDevices() ;

/// @brief Method HaveBindingForDevice addr 0x295dc2c size 0x108 virtual false final false
 bool HaveBindingForDevice(UnityEngine::InputSystem::InputDevice device) ;

/// @brief Method UnassignUserAndDevices addr 0x295e06c size 0xb8 virtual false final false
 void UnassignUserAndDevices() ;

/// @brief Method TryToActivateControlScheme addr 0x295d9d8 size 0x1e0 virtual false final false
 bool TryToActivateControlScheme(UnityEngine::InputSystem::InputControlScheme controlScheme) ;

/// @brief Method AssignPlayerIndex addr 0x295e400 size 0x208 virtual false final false
 void AssignPlayerIndex() ;

/// @brief Method OnEnable addr 0x295e608 size 0x4c8 virtual false final false
 void OnEnable() ;

/// @brief Method StartListeningForUnpairedDeviceActivity addr 0x295abc4 size 0x138 virtual false final false
 void StartListeningForUnpairedDeviceActivity() ;

/// @brief Method StopListeningForUnpairedDeviceActivity addr 0x295acfc size 0x70 virtual false final false
 void StopListeningForUnpairedDeviceActivity() ;

/// @brief Method StartListeningForDeviceChanges addr 0x295eb88 size 0xc4 virtual false final false
 void StartListeningForDeviceChanges() ;

/// @brief Method StopListeningForDeviceChanges addr 0x295f308 size 0x6c virtual false final false
 void StopListeningForDeviceChanges() ;

/// @brief Method OnDisable addr 0x295f374 size 0x2f4 virtual false final false
 void OnDisable() ;

/// @brief Method DebugLogAction addr 0x295f848 size 0x78 virtual false final false
 void DebugLogAction(UnityEngine::InputSystem::UnityEngine__InputSystem__InputAction__CallbackContext context) ;

/// @brief Method HandleDeviceLost addr 0x295f8c0 size 0x11c virtual false final false
 void HandleDeviceLost() ;

/// @brief Method HandleDeviceRegained addr 0x295f9dc size 0x11c virtual false final false
 void HandleDeviceRegained() ;

/// @brief Method HandleControlsChanged addr 0x295ec4c size 0x11c virtual false final false
 void HandleControlsChanged() ;

/// @brief Method OnUserChange addr 0x295faf8 size 0x168 virtual false final false
...
/// @brief Method OnPreFilterUnpairedDeviceUsed addr 0x295fc6c size 0xf4 virtual false final false
...
/// @brief Method OnUnpairedDeviceUsed addr 0x295fd60 size 0x610 virtual false final false
...
/// @brief Method OnDeviceChange addr 0x2960370 size 0x108 virtual false final false
 void OnDeviceChange(UnityEngine::InputSystem::InputDevice device, UnityEngine::InputSystem::InputDeviceChange change) ;

/// @brief Method SwitchControlSchemeInternal addr 0x295be50 size 0x3f4 virtual false final false
...
/// @brief Method .ctor addr 0x2960554 size 0x14 virtual false final false
 void _ctor() ;
...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10420)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10420), inst: 361 }), TypeDefinitionIndex(TypeDefinitionIndex(6417))}
...
/// @brief Method .ctor addr 0x295af5c size 0x48 virtual false final false
 void _ctor() ;
...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6417)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10420), inst: 361 }), TypeDefinitionIndex(TypeDefinitionIndex(10420))}
...
/// @brief Method .ctor addr 0x295b00c size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x295b0bc size 0x48 virtual false final false
 void _ctor() ;
