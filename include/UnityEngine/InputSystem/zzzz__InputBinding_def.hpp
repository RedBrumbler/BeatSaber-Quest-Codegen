...
/// @brief Method .ctor addr 0x28f55b4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <MaskByGroups>b__45_0 addr 0x28f55bc size 0x20 virtual false final false
...
/// @brief Method get_name addr 0x28f4820 size 0x8 virtual false final false
 ::StringW get_name() ;

/// @brief Method set_name addr 0x28f4828 size 0x8 virtual false final false
 void set_name(::StringW value) ;

/// @brief Method get_id addr 0x28f4830 size 0x48 virtual false final false
 System::Guid get_id() ;

/// @brief Method set_id addr 0x28f4878 size 0x2c virtual false final false
 void set_id(System::Guid value) ;

/// @brief Method get_path addr 0x28f48a4 size 0x8 virtual false final false
 ::StringW get_path() ;

/// @brief Method set_path addr 0x28f48ac size 0x8 virtual false final false
 void set_path(::StringW value) ;

/// @brief Method get_overridePath addr 0x28f48b4 size 0x8 virtual false final false
 ::StringW get_overridePath() ;

/// @brief Method set_overridePath addr 0x28f48bc size 0x8 virtual false final false
 void set_overridePath(::StringW value) ;

/// @brief Method get_interactions addr 0x28f48c4 size 0x8 virtual false final false
 ::StringW get_interactions() ;

/// @brief Method set_interactions addr 0x28f48cc size 0x8 virtual false final false
 void set_interactions(::StringW value) ;

/// @brief Method get_overrideInteractions addr 0x28f48d4 size 0x8 virtual false final false
 ::StringW get_overrideInteractions() ;

/// @brief Method set_overrideInteractions addr 0x28f48dc size 0x8 virtual false final false
 void set_overrideInteractions(::StringW value) ;

/// @brief Method get_processors addr 0x28f48e4 size 0x8 virtual false final false
 ::StringW get_processors() ;

/// @brief Method set_processors addr 0x28f48ec size 0x8 virtual false final false
 void set_processors(::StringW value) ;

/// @brief Method get_overrideProcessors addr 0x28f48f4 size 0x8 virtual false final false
 ::StringW get_overrideProcessors() ;

/// @brief Method set_overrideProcessors addr 0x28f48fc size 0x8 virtual false final false
 void set_overrideProcessors(::StringW value) ;

/// @brief Method get_groups addr 0x28f4904 size 0x8 virtual false final false
 ::StringW get_groups() ;

/// @brief Method set_groups addr 0x28f490c size 0x8 virtual false final false
 void set_groups(::StringW value) ;

/// @brief Method get_action addr 0x28f4914 size 0x8 virtual false final false
 ::StringW get_action() ;

/// @brief Method set_action addr 0x28f491c size 0x8 virtual false final false
 void set_action(::StringW value) ;

/// @brief Method get_isComposite addr 0x28ec120 size 0xc virtual false final false
 bool get_isComposite() ;

/// @brief Method set_isComposite addr 0x28f4924 size 0x1c virtual false final false
 void set_isComposite(bool value) ;

/// @brief Method get_isPartOfComposite addr 0x28ec12c size 0xc virtual false final false
 bool get_isPartOfComposite() ;

/// @brief Method set_isPartOfComposite addr 0x28ec420 size 0x1c virtual false final false
 void set_isPartOfComposite(bool value) ;

/// @brief Method get_hasOverrides addr 0x28f4940 size 0x28 virtual false final false
 bool get_hasOverrides() ;

/// @brief Method .ctor addr 0x28f4968 size 0x20 virtual false final false
 void _ctor(::StringW path, ::StringW action, ::StringW groups, ::StringW processors, ::StringW interactions, ::StringW name) ;

/// @brief Method GetNameOfComposite addr 0x28f4988 size 0x44 virtual false final false
 ::StringW GetNameOfComposite() ;

/// @brief Method GenerateId addr 0x28f49cc size 0x34 virtual false final false
 void GenerateId() ;

/// @brief Method RemoveOverrides addr 0x28f4a00 size 0xc virtual false final false
 void RemoveOverrides() ;

/// @brief Method MaskByGroup addr 0x28f4a0c size 0x18 virtual false final false
static UnityEngine::InputSystem::InputBinding MaskByGroup(::StringW group) ;

/// @brief Method MaskByGroups addr 0x28f4a24 size 0x160 virtual false final false
static UnityEngine::InputSystem::InputBinding MaskByGroups(::ArrayW<::StringW> groups) ;

/// @brief Method get_effectivePath addr 0x28edae8 size 0x18 virtual false final false
 ::StringW get_effectivePath() ;

/// @brief Method get_effectiveInteractions addr 0x28f4b84 size 0x18 virtual false final false
 ::StringW get_effectiveInteractions() ;

/// @brief Method get_effectiveProcessors addr 0x28f4b9c size 0x18 virtual false final false
 ::StringW get_effectiveProcessors() ;

/// @brief Method get_isEmpty addr 0x28f4bb4 size 0x4c virtual false final false
 bool get_isEmpty() ;

/// @brief Method Equals addr 0x28f4c00 size 0xcc virtual true final true
 bool Equals(UnityEngine::InputSystem::InputBinding other) ;

/// @brief Method Equals addr 0x28f4ccc size 0x90 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method op_Equality addr 0x28ecc04 size 0x34 virtual false final false
static bool op_Equality(UnityEngine::InputSystem::InputBinding left, UnityEngine::InputSystem::InputBinding right) ;

/// @brief Method op_Inequality addr 0x28f4d5c size 0x4c virtual false final false
static bool op_Inequality(UnityEngine::InputSystem::InputBinding left, UnityEngine::InputSystem::InputBinding right) ;

/// @brief Method GetHashCode addr 0x28f4da8 size 0xfc virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x28f4ea4 size 0x104 virtual true final false
 ::StringW ToString() ;

/// @brief Method ToDisplayString addr 0x28f4fa8 size 0x2c virtual false final false
...
/// @brief Method ToDisplayString addr 0x28f4fd4 size 0x46c virtual false final false
...
/// @brief Method TriggersAction addr 0x28ec0c8 size 0x58 virtual false final false
 bool TriggersAction(UnityEngine::InputSystem::InputAction action) ;

/// @brief Method Matches addr 0x28f5440 size 0x8 virtual false final false
 bool Matches(UnityEngine::InputSystem::InputBinding binding) ;

/// @brief Method Matches addr 0x28f5448 size 0x108 virtual false final false
