...
/// @brief Method get_updateMode addr 0x2955584 size 0x8 virtual false final false
 UnityEngine::InputSystem::UnityEngine__InputSystem__InputSettings__UpdateMode get_updateMode() ;

/// @brief Method set_updateMode addr 0x295558c size 0x18 virtual false final false
 void set_updateMode(UnityEngine::InputSystem::UnityEngine__InputSystem__InputSettings__UpdateMode value) ;

/// @brief Method get_compensateForScreenOrientation addr 0x2955670 size 0x8 virtual false final false
 bool get_compensateForScreenOrientation() ;

/// @brief Method set_compensateForScreenOrientation addr 0x2955678 size 0x1c virtual false final false
 void set_compensateForScreenOrientation(bool value) ;

/// @brief Method get_filterNoiseOnCurrent addr 0x2955694 size 0x8 virtual false final false
 bool get_filterNoiseOnCurrent() ;

/// @brief Method set_filterNoiseOnCurrent addr 0x295569c size 0x4 virtual false final false
 void set_filterNoiseOnCurrent(bool value) ;

/// @brief Method get_defaultDeadzoneMin addr 0x29556a0 size 0x8 virtual false final false
 float_t get_defaultDeadzoneMin() ;

/// @brief Method set_defaultDeadzoneMin addr 0x29556a8 size 0x18 virtual false final false
 void set_defaultDeadzoneMin(float_t value) ;

/// @brief Method get_defaultDeadzoneMax addr 0x29556c0 size 0x8 virtual false final false
 float_t get_defaultDeadzoneMax() ;

/// @brief Method set_defaultDeadzoneMax addr 0x29556c8 size 0x18 virtual false final false
 void set_defaultDeadzoneMax(float_t value) ;

/// @brief Method get_defaultButtonPressPoint addr 0x29556e0 size 0x8 virtual false final false
 float_t get_defaultButtonPressPoint() ;

/// @brief Method set_defaultButtonPressPoint addr 0x29556e8 size 0x34 virtual false final false
 void set_defaultButtonPressPoint(float_t value) ;

/// @brief Method get_buttonReleaseThreshold addr 0x295571c size 0x8 virtual false final false
 float_t get_buttonReleaseThreshold() ;

/// @brief Method set_buttonReleaseThreshold addr 0x2955724 size 0x18 virtual false final false
 void set_buttonReleaseThreshold(float_t value) ;

/// @brief Method get_defaultTapTime addr 0x295573c size 0x8 virtual false final false
 float_t get_defaultTapTime() ;

/// @brief Method set_defaultTapTime addr 0x2955744 size 0x18 virtual false final false
 void set_defaultTapTime(float_t value) ;

/// @brief Method get_defaultSlowTapTime addr 0x295575c size 0x8 virtual false final false
 float_t get_defaultSlowTapTime() ;

/// @brief Method set_defaultSlowTapTime addr 0x2955764 size 0x18 virtual false final false
 void set_defaultSlowTapTime(float_t value) ;

/// @brief Method get_defaultHoldTime addr 0x295577c size 0x8 virtual false final false
 float_t get_defaultHoldTime() ;

/// @brief Method set_defaultHoldTime addr 0x2955784 size 0x18 virtual false final false
 void set_defaultHoldTime(float_t value) ;

/// @brief Method get_tapRadius addr 0x295579c size 0x8 virtual false final false
 float_t get_tapRadius() ;

/// @brief Method set_tapRadius addr 0x29557a4 size 0x18 virtual false final false
 void set_tapRadius(float_t value) ;

/// @brief Method get_multiTapDelayTime addr 0x29557bc size 0x8 virtual false final false
 float_t get_multiTapDelayTime() ;

/// @brief Method set_multiTapDelayTime addr 0x29557c4 size 0x18 virtual false final false
 void set_multiTapDelayTime(float_t value) ;

/// @brief Method get_backgroundBehavior addr 0x29557dc size 0x8 virtual false final false
 UnityEngine::InputSystem::UnityEngine__InputSystem__InputSettings__BackgroundBehavior get_backgroundBehavior() ;

/// @brief Method set_backgroundBehavior addr 0x29557e4 size 0x18 virtual false final false
 void set_backgroundBehavior(UnityEngine::InputSystem::UnityEngine__InputSystem__InputSettings__BackgroundBehavior value) ;

/// @brief Method get_editorInputBehaviorInPlayMode addr 0x29557fc size 0x8 virtual false final false
...
/// @brief Method set_editorInputBehaviorInPlayMode addr 0x2955804 size 0x18 virtual false final false
...
/// @brief Method get_maxEventBytesPerUpdate addr 0x295581c size 0x8 virtual false final false
 int32_t get_maxEventBytesPerUpdate() ;

/// @brief Method set_maxEventBytesPerUpdate addr 0x2955824 size 0x18 virtual false final false
 void set_maxEventBytesPerUpdate(int32_t value) ;

/// @brief Method get_maxQueuedEventsPerUpdate addr 0x295583c size 0x8 virtual false final false
 int32_t get_maxQueuedEventsPerUpdate() ;

/// @brief Method set_maxQueuedEventsPerUpdate addr 0x2955844 size 0x18 virtual false final false
 void set_maxQueuedEventsPerUpdate(int32_t value) ;

/// @brief Method get_supportedDevices addr 0x295585c size 0x60 virtual false final false
 UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::StringW> get_supportedDevices() ;

/// @brief Method set_supportedDevices addr 0x29558bc size 0x124 virtual false final false
 void set_supportedDevices(UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::StringW> value) ;

/// @brief Method get_disableRedundantEventsMerging addr 0x29559e0 size 0x8 virtual false final false
 bool get_disableRedundantEventsMerging() ;

/// @brief Method set_disableRedundantEventsMerging addr 0x29559e8 size 0x1c virtual false final false
 void set_disableRedundantEventsMerging(bool value) ;

/// @brief Method SetInternalFeatureFlag addr 0x2955a04 size 0x1a0 virtual false final false
 void SetInternalFeatureFlag(::StringW featureName, bool enabled) ;

/// @brief Method IsFeatureEnabled addr 0x2955ba4 size 0xc0 virtual false final false
 bool IsFeatureEnabled(::StringW featureName) ;

/// @brief Method OnChange addr 0x29555a4 size 0xcc virtual false final false
 void OnChange() ;

// Ctor Parameters []
explicit InputSettings() ;

/// @brief Method .ctor addr 0x2955c64 size 0x44 virtual false final false
 void _ctor() ;
