...
/// @brief Method get_collider addr 0x2bd0cd8 size 0xac virtual false final false
 UnityEngine::Collider get_collider() ;

/// @brief Method get_point addr 0x2bd0d84 size 0xc virtual false final false
 UnityEngine::Vector3 get_point() ;

/// @brief Method set_point addr 0x2bd0d90 size 0xc virtual false final false
 void set_point(UnityEngine::Vector3 value) ;

/// @brief Method get_normal addr 0x2bd0d9c size 0xc virtual false final false
 UnityEngine::Vector3 get_normal() ;

/// @brief Method set_normal addr 0x2bd0da8 size 0xc virtual false final false
 void set_normal(UnityEngine::Vector3 value) ;

/// @brief Method get_distance addr 0x2bd0db4 size 0x8 virtual false final false
 float_t get_distance() ;

/// @brief Method set_distance addr 0x2bd0dbc size 0x8 virtual false final false
