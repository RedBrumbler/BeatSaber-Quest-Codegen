...
/// @brief Method .ctor addr 0x2d5fdb4 size 0xc4 virtual false final false
 void _ctor(::cordl_internals::intptr_t ygConfig) ;

// Ctor Parameters []
explicit YogaConfig() ;

/// @brief Method .ctor addr 0x2d5fe78 size 0x44 virtual false final false
 void _ctor() ;

/// @brief Method Finalize addr 0x2d5febc size 0x108 virtual true final false
 void Finalize() ;

/// @brief Method get_Handle addr 0x2d5d9f8 size 0x8 virtual false final false
 ::cordl_internals::intptr_t get_Handle() ;

/// @brief Method get_UseWebDefaults addr 0x2d5ffc4 size 0x3c virtual false final false
 bool get_UseWebDefaults() ;

/// @brief Method set_UseWebDefaults addr 0x2d60000 size 0x44 virtual false final false
 void set_UseWebDefaults(bool value) ;

/// @brief Method set_PointScaleFactor addr 0x2d60044 size 0x4c virtual false final false
