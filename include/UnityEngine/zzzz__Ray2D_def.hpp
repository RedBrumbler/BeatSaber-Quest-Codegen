...
/// @brief Method .ctor addr 0x2b85cdc size 0xc8 virtual false final false
 void _ctor(UnityEngine::Vector2 origin, UnityEngine::Vector2 direction) ;

/// @brief Method get_origin addr 0x2b85da4 size 0x8 virtual false final false
 UnityEngine::Vector2 get_origin() ;

/// @brief Method get_direction addr 0x2b85dac size 0x8 virtual false final false
 UnityEngine::Vector2 get_direction() ;

/// @brief Method GetPoint addr 0x2b85db4 size 0x14 virtual false final false
 UnityEngine::Vector2 GetPoint(float_t distance) ;

/// @brief Method ToString addr 0x2b85dc8 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x2b85dd4 size 0x180 virtual true final true
