...
namespace UnityEngine::XR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15610)), TypeDefinitionIndex(TypeDefinitionIndex(15865)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15865), inst: 3782 })}
...
/// @brief Method .ctor addr 0x2d6c308 size 0x48 virtual false final false
 void _ctor() ;
