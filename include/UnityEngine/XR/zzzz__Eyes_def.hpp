...
/// @brief Method get_deviceId addr 0x2d6b31c size 0x8 virtual false final false
 uint64_t get_deviceId() ;

/// @brief Method get_featureIndex addr 0x2d6b324 size 0x8 virtual false final false
 uint32_t get_featureIndex() ;

/// @brief Method Equals addr 0x2d6b32c size 0x88 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2d6b3b4 size 0x24 virtual true final true
 bool Equals(UnityEngine::XR::Eyes other) ;

/// @brief Method GetHashCode addr 0x2d6b3d8 size 0x4c virtual true final false
 int32_t GetHashCode() ;
