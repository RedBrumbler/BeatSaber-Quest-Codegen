...
/// @brief Method set_uniqueID addr 0x2d6bc24 size 0x8 virtual false final false
 void set_uniqueID(uint64_t value) ;

/// @brief Method get_nodeType addr 0x2d6bc40 size 0x8 virtual false final false
 UnityEngine::XR::XRNode get_nodeType() ;

/// @brief Method set_nodeType addr 0x2d6bc2c size 0x8 virtual false final false
 void set_nodeType(UnityEngine::XR::XRNode value) ;

/// @brief Method set_tracked addr 0x2d6bc34 size 0xc virtual false final false
 void set_tracked(bool value) ;

/// @brief Method TryGetPosition addr 0x2d6bc48 size 0x14 virtual false final false
 bool TryGetPosition(ByRef<UnityEngine::Vector3> position) ;

/// @brief Method TryGetRotation addr 0x2d6bcd8 size 0x14 virtual false final false
 bool TryGetRotation(ByRef<UnityEngine::Quaternion> rotation) ;

/// @brief Method TryGetVelocity addr 0x2d6bd60 size 0x14 virtual false final false
 bool TryGetVelocity(ByRef<UnityEngine::Vector3> velocity) ;

/// @brief Method TryGetAngularVelocity addr 0x2d6bd74 size 0x14 virtual false final false
 bool TryGetAngularVelocity(ByRef<UnityEngine::Vector3> angularVelocity) ;

/// @brief Method TryGetAcceleration addr 0x2d6bd88 size 0x14 virtual false final false
 bool TryGetAcceleration(ByRef<UnityEngine::Vector3> acceleration) ;

/// @brief Method TryGetAngularAcceleration addr 0x2d6bd9c size 0x14 virtual false final false
 bool TryGetAngularAcceleration(ByRef<UnityEngine::Vector3> angularAcceleration) ;

/// @brief Method TryGet addr 0x2d6bc5c size 0x7c virtual false final false
...
/// @brief Method TryGet addr 0x2d6bcec size 0x74 virtual false final false
