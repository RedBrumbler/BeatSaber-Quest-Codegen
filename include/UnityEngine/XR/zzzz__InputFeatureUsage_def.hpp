...
/// @brief Method get_name addr 0x2d6ac94 size 0x8 virtual false final false
 ::StringW get_name() ;

/// @brief Method get_internalType addr 0x2d6ac9c size 0x8 virtual false final false
 UnityEngine::XR::InputFeatureType get_internalType() ;

/// @brief Method Equals addr 0x2d6aca4 size 0x88 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2d6ad2c size 0x40 virtual true final true
 bool Equals(UnityEngine::XR::InputFeatureUsage other) ;

/// @brief Method GetHashCode addr 0x2d6ad6c size 0x50 virtual true final false
 int32_t GetHashCode() ;
