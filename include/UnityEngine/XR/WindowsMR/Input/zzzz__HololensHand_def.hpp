...
/// @brief Method get_deviceVelocity addr 0x28d5704 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector3Control get_deviceVelocity() ;

/// @brief Method set_deviceVelocity addr 0x28d570c size 0x8 virtual false final false
 void set_deviceVelocity(UnityEngine::InputSystem::Controls::Vector3Control value) ;

/// @brief Method get_airTap addr 0x28d5714 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_airTap() ;

/// @brief Method set_airTap addr 0x28d571c size 0x8 virtual false final false
 void set_airTap(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_sourceLossRisk addr 0x28d5724 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_sourceLossRisk() ;

/// @brief Method set_sourceLossRisk addr 0x28d572c size 0x8 virtual false final false
 void set_sourceLossRisk(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_sourceLossMitigationDirection addr 0x28d5734 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector3Control get_sourceLossMitigationDirection() ;

/// @brief Method set_sourceLossMitigationDirection addr 0x28d573c size 0x8 virtual false final false
 void set_sourceLossMitigationDirection(UnityEngine::InputSystem::Controls::Vector3Control value) ;

/// @brief Method FinishSetup addr 0x28d5744 size 0x12c virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit HololensHand() ;

/// @brief Method .ctor addr 0x28d5870 size 0x8 virtual false final false
 void _ctor() ;
