...
/// @brief Method get_userPresence addr 0x28d5670 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_userPresence() ;

/// @brief Method set_userPresence addr 0x28d5678 size 0x8 virtual false final false
 void set_userPresence(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method FinishSetup addr 0x28d5680 size 0x7c virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit WMRHMD() ;

/// @brief Method .ctor addr 0x28d56fc size 0x8 virtual false final false
 void _ctor() ;
