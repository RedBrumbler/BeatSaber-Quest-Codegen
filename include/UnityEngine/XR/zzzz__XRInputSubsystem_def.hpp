...
namespace UnityEngine::XR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15870)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15870), inst: 3784 }), TypeDefinitionIndex(TypeDefinitionIndex(15600))}
...
/// @brief Method TryRecenter addr 0x2d6bdf8 size 0x3c virtual false final false
 bool TryRecenter() ;

/// @brief Method TrySetTrackingOriginMode addr 0x2d6be34 size 0x44 virtual false final false
 bool TrySetTrackingOriginMode(UnityEngine::XR::TrackingOriginModeFlags origin) ;

/// @brief Method add_trackingOriginUpdated addr 0x2d6be78 size 0xb0 virtual false final false
 void add_trackingOriginUpdated(System::Action_1<UnityEngine::XR::XRInputSubsystem> value) ;

/// @brief Method remove_trackingOriginUpdated addr 0x2d6bf28 size 0xb0 virtual false final false
 void remove_trackingOriginUpdated(System::Action_1<UnityEngine::XR::XRInputSubsystem> value) ;

/// @brief Method add_boundaryChanged addr 0x2d6bfd8 size 0xb0 virtual false final false
 void add_boundaryChanged(System::Action_1<UnityEngine::XR::XRInputSubsystem> value) ;

/// @brief Method remove_boundaryChanged addr 0x2d6c088 size 0xb0 virtual false final false
 void remove_boundaryChanged(System::Action_1<UnityEngine::XR::XRInputSubsystem> value) ;

/// @brief Method InvokeTrackingOriginUpdatedEvent addr 0x2d6c138 size 0xc4 virtual false final false
static void InvokeTrackingOriginUpdatedEvent(::cordl_internals::intptr_t internalPtr) ;

/// @brief Method InvokeBoundaryChangedEvent addr 0x2d6c1fc size 0xc4 virtual false final false
static void InvokeBoundaryChangedEvent(::cordl_internals::intptr_t internalPtr) ;

// Ctor Parameters []
explicit XRInputSubsystem() ;

/// @brief Method .ctor addr 0x2d6c2c0 size 0x48 virtual false final false
 void _ctor() ;
