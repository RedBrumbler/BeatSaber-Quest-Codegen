...
namespace UnityEngine::XR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15870)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15870), inst: 3783 }), TypeDefinitionIndex(TypeDefinitionIndex(15611))}
...
/// @brief Method InvokeDisplayFocusChanged addr 0x2d6cb9c size 0x20 virtual false final false
 void InvokeDisplayFocusChanged(bool focus) ;

/// @brief Method MarkTransformLateLatched addr 0x2d6cbbc size 0x54 virtual false final false
...
/// @brief Method TryGetAppGPUTimeLastFrame addr 0x2d6cc10 size 0x44 virtual false final false
 bool TryGetAppGPUTimeLastFrame(ByRef<float_t> gpuTimeLastFrame) ;

/// @brief Method TryGetCompositorGPUTimeLastFrame addr 0x2d6cc54 size 0x44 virtual false final false
 bool TryGetCompositorGPUTimeLastFrame(ByRef<float_t> gpuTimeLastFrameCompositor) ;

/// @brief Method TryGetDisplayRefreshRate addr 0x2d6cc98 size 0x44 virtual false final false
 bool TryGetDisplayRefreshRate(ByRef<float_t> displayRefreshRate) ;

/// @brief Method TryGetMotionToPhoton addr 0x2d6ccdc size 0x44 virtual false final false
 bool TryGetMotionToPhoton(ByRef<float_t> motionToPhoton) ;

// Ctor Parameters []
explicit XRDisplaySubsystem() ;

/// @brief Method .ctor addr 0x2d6cd20 size 0x48 virtual false final false
 void _ctor() ;
