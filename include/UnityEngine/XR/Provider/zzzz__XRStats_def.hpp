...
/// @brief Method TryGetStat addr 0x2d6cd68 size 0x5c virtual false final false
static bool TryGetStat(UnityEngine::IntegratedSubsystem xrSubsystem, ::StringW tag, ByRef<float_t> value) ;

/// @brief Method TryGetStat_Internal addr 0x2d6cdc4 size 0x54 virtual false final false
