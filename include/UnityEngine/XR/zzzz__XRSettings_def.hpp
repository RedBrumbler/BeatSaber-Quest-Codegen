...
/// @brief Method get_showDeviceView addr 0x2d6a948 size 0x28 virtual false final false
static bool get_showDeviceView() ;

/// @brief Method set_showDeviceView addr 0x2d6a970 size 0x3c virtual false final false
static void set_showDeviceView(bool value) ;

/// @brief Method set_eyeTextureResolutionScale addr 0x2d6a9ac size 0x38 virtual false final false
static void set_eyeTextureResolutionScale(float_t value) ;

/// @brief Method get_eyeTextureWidth addr 0x2d6a9e4 size 0x28 virtual false final false
static int32_t get_eyeTextureWidth() ;

/// @brief Method get_eyeTextureHeight addr 0x2d6aa0c size 0x28 virtual false final false
static int32_t get_eyeTextureHeight() ;

/// @brief Method get_renderViewportScale addr 0x2d6aa34 size 0x28 virtual false final false
static float_t get_renderViewportScale() ;

/// @brief Method set_renderViewportScale addr 0x2d6aa84 size 0xb4 virtual false final false
static void set_renderViewportScale(float_t value) ;

/// @brief Method get_renderViewportScaleInternal addr 0x2d6aa5c size 0x28 virtual false final false
static float_t get_renderViewportScaleInternal() ;

/// @brief Method set_renderViewportScaleInternal addr 0x2d6ab38 size 0x38 virtual false final false
static void set_renderViewportScaleInternal(float_t value) ;

/// @brief Method get_loadedDeviceName addr 0x2d6ab70 size 0x28 virtual false final false
