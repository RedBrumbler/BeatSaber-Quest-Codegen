...
/// @brief Method Dispose addr 0x2d6cadc size 0x3c virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x2d6cb18 size 0x3c virtual false final false
...
namespace UnityEngine::XR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15870)), TypeDefinitionIndex(TypeDefinitionIndex(15603)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15870), inst: 3785 })}
...
/// @brief Method InvokeMeshReadyDelegate addr 0x2d6ca3c size 0x58 virtual false final false
...
/// @brief Method .ctor addr 0x2d6ca94 size 0x48 virtual false final false
 void _ctor() ;
