...
/// @brief Method get_displayName addr 0x2b0de1c size 0x8 virtual false final false
 ::StringW get_displayName() ;

/// @brief Method set_displayName addr 0x2b0de24 size 0x8 virtual false final false
 void set_displayName(::StringW value) ;

/// @brief Method get_buildSettingsKey addr 0x2b0de2c size 0x8 virtual false final false
 ::StringW get_buildSettingsKey() ;

/// @brief Method set_buildSettingsKey addr 0x2b0de34 size 0x8 virtual false final false
 void set_buildSettingsKey(::StringW value) ;

// Ctor Parameters []
explicit XRConfigurationDataAttribute() ;

/// @brief Method .ctor addr 0x2b0de3c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2b0de44 size 0x2c virtual false final false
