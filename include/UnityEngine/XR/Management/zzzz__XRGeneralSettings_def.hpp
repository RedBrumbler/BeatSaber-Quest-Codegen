...
/// @brief Method get_Manager addr 0x2b0de70 size 0x8 virtual false final false
 UnityEngine::XR::Management::XRManagerSettings get_Manager() ;

/// @brief Method set_Manager addr 0x2b0de78 size 0x8 virtual false final false
 void set_Manager(UnityEngine::XR::Management::XRManagerSettings value) ;

/// @brief Method get_Instance addr 0x2b0de80 size 0x58 virtual false final false
static UnityEngine::XR::Management::XRGeneralSettings get_Instance() ;

/// @brief Method get_AssignedSettings addr 0x2b0ded8 size 0x8 virtual false final false
 UnityEngine::XR::Management::XRManagerSettings get_AssignedSettings() ;

/// @brief Method get_InitManagerOnStart addr 0x2b0dee0 size 0x8 virtual false final false
 bool get_InitManagerOnStart() ;

/// @brief Method Awake addr 0x2b0dee8 size 0x130 virtual false final false
 void Awake() ;

/// @brief Method Quit addr 0x2b0e018 size 0xdc virtual false final false
static void Quit() ;

/// @brief Method Start addr 0x2b0e1a4 size 0x4 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2b0e258 size 0x4 virtual false final false
 void OnDestroy() ;

/// @brief Method AttemptInitializeXRSDKOnLoad addr 0x2b0e25c size 0xe4 virtual false final false
static void AttemptInitializeXRSDKOnLoad() ;

/// @brief Method AttemptStartXRSDKOnBeforeSplashScreen addr 0x2b0e5b8 size 0xe4 virtual false final false
static void AttemptStartXRSDKOnBeforeSplashScreen() ;

/// @brief Method InitXRSDK addr 0x2b0e340 size 0x278 virtual false final false
 void InitXRSDK() ;

/// @brief Method StartXRSDK addr 0x2b0e1a8 size 0xb0 virtual false final false
 void StartXRSDK() ;

/// @brief Method StopXRSDK addr 0x2b0e9b4 size 0xac virtual false final false
 void StopXRSDK() ;

/// @brief Method DeInitXRSDK addr 0x2b0e0f4 size 0xb0 virtual false final false
 void DeInitXRSDK() ;

// Ctor Parameters []
explicit XRGeneralSettings() ;

/// @brief Method .ctor addr 0x2b0ec20 size 0x10 virtual false final false
 void _ctor() ;
