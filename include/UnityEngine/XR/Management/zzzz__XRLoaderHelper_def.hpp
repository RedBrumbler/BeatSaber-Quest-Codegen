...
namespace UnityEngine::XR::Management {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15912))}
...
/// @brief Method Deinitialize addr 0x2b0ed34 size 0x58 virtual true final false
 bool Deinitialize() ;

// Ctor Parameters []
explicit XRLoaderHelper() ;

/// @brief Method .ctor addr 0x2b0ed8c size 0x7c virtual false final false
 void _ctor() ;
