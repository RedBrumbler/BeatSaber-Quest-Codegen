...
/// @brief Method .ctor addr 0x2d6adbc size 0x10 virtual false final false
 void _ctor(uint64_t deviceId) ;

/// @brief Method get_deviceId addr 0x2d6adcc size 0x18 virtual false final false
 uint64_t get_deviceId() ;

/// @brief Method get_isValid addr 0x2d6ade4 size 0x5c virtual false final false
 bool get_isValid() ;

/// @brief Method get_manufacturer addr 0x2d6ae9c size 0x5c virtual false final false
 ::StringW get_manufacturer() ;

/// @brief Method IsValidId addr 0x2d6ae40 size 0x20 virtual false final false
 bool IsValidId() ;

/// @brief Method SendHapticImpulse addr 0x2d6af34 size 0x100 virtual false final false
 bool SendHapticImpulse(uint32_t channel, float_t amplitude, float_t duration) ;

/// @brief Method StopHaptics addr 0x2d6b090 size 0x58 virtual false final false
 void StopHaptics() ;

/// @brief Method Equals addr 0x2d6b124 size 0x94 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2d6b1b8 size 0x28 virtual true final true
 bool Equals(UnityEngine::XR::InputDevice other) ;

/// @brief Method GetHashCode addr 0x2d6b1e0 size 0x34 virtual true final false
 int32_t GetHashCode() ;
