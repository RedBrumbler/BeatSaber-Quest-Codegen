...
/// @brief Method GetNodeStates addr 0x2d6b658 size 0xb8 virtual false final false
static void GetNodeStates(System::Collections::Generic::List_1<UnityEngine::XR::XRNodeState> nodeStates) ;

/// @brief Method GetNodeStates_Internal addr 0x2d6b710 size 0x3c virtual false final false
static void GetNodeStates_Internal(System::Collections::Generic::List_1<UnityEngine::XR::XRNodeState> nodeStates) ;

/// @brief Method GetDeviceIdAtXRNode addr 0x2d6b570 size 0x3c virtual false final false
static uint64_t GetDeviceIdAtXRNode(UnityEngine::XR::XRNode node) ;

/// @brief Method add_nodeAdded addr 0x2d6b74c size 0xd0 virtual false final false
static void add_nodeAdded(System::Action_1<UnityEngine::XR::XRNodeState> value) ;

/// @brief Method remove_nodeAdded addr 0x2d6b81c size 0xd0 virtual false final false
static void remove_nodeAdded(System::Action_1<UnityEngine::XR::XRNodeState> value) ;

/// @brief Method add_nodeRemoved addr 0x2d6b8ec size 0xd0 virtual false final false
static void add_nodeRemoved(System::Action_1<UnityEngine::XR::XRNodeState> value) ;

/// @brief Method remove_nodeRemoved addr 0x2d6b9bc size 0xd0 virtual false final false
static void remove_nodeRemoved(System::Action_1<UnityEngine::XR::XRNodeState> value) ;

/// @brief Method InvokeTrackingEvent addr 0x2d6ba8c size 0x198 virtual false final false
