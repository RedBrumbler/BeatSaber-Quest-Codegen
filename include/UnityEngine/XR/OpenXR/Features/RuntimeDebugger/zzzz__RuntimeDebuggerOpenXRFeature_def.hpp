...
/// @brief Method HookGetInstanceProcAddr addr 0x2b386a8 size 0xfc virtual true final false
 ::cordl_internals::intptr_t HookGetInstanceProcAddr(::cordl_internals::intptr_t func) ;

/// @brief Method RecvMsg addr 0x2b38900 size 0x210 virtual false final false
 void RecvMsg(UnityEngine::Networking::PlayerConnection::MessageEventArgs args) ;

/// @brief Method Native_HookGetInstanceProcAddr addr 0x2b3886c size 0x94 virtual false final false
...
/// @brief Method Native_GetDataForRead addr 0x2b38ba4 size 0x8c virtual false final false
static bool Native_GetDataForRead(ByRef<::cordl_internals::intptr_t> ptr, ByRef<uint32_t> size) ;

/// @brief Method Native_GetLUTData addr 0x2b38b10 size 0x94 virtual false final false
static void Native_GetLUTData(ByRef<::cordl_internals::intptr_t> ptr, ByRef<uint32_t> size, uint32_t offset) ;

/// @brief Method Native_StartDataAccess addr 0x2b387a4 size 0x64 virtual false final false
static void Native_StartDataAccess() ;

/// @brief Method Native_EndDataAccess addr 0x2b38808 size 0x64 virtual false final false
static void Native_EndDataAccess() ;

// Ctor Parameters []
explicit RuntimeDebuggerOpenXRFeature() ;

/// @brief Method .ctor addr 0x2b38c30 size 0x14 virtual false final false
 void _ctor() ;
