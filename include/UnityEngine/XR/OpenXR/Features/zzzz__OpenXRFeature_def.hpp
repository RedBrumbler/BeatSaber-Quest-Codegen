...
/// @brief Method get_failedInitialization addr 0x2b22134 size 0x8 virtual false final false
 bool get_failedInitialization() ;

/// @brief Method set_failedInitialization addr 0x2b2213c size 0xc virtual false final false
 void set_failedInitialization(bool value) ;

/// @brief Method get_requiredFeatureFailed addr 0x2b22148 size 0x48 virtual false final false
static bool get_requiredFeatureFailed() ;

/// @brief Method set_requiredFeatureFailed addr 0x2b22190 size 0x4c virtual false final false
static void set_requiredFeatureFailed(bool value) ;

/// @brief Method get_enabled addr 0x2b1c470 size 0xec virtual false final false
 bool get_enabled() ;

/// @brief Method set_enabled addr 0x2b221dc size 0x15c virtual false final false
 void set_enabled(bool value) ;

/// @brief Method get_xrGetInstanceProcAddr addr 0x2b22338 size 0x8 virtual false final false
static ::cordl_internals::intptr_t get_xrGetInstanceProcAddr() ;

/// @brief Method HookGetInstanceProcAddr addr 0x2b223bc size 0x8 virtual true final false
 ::cordl_internals::intptr_t HookGetInstanceProcAddr(::cordl_internals::intptr_t func) ;

/// @brief Method OnSubsystemCreate addr 0x2b223c4 size 0x4 virtual true final false
 void OnSubsystemCreate() ;

/// @brief Method OnSubsystemStart addr 0x2b223c8 size 0x4 virtual true final false
 void OnSubsystemStart() ;

/// @brief Method OnSubsystemStop addr 0x2b223cc size 0x4 virtual true final false
 void OnSubsystemStop() ;

/// @brief Method OnSubsystemDestroy addr 0x2b223d0 size 0x4 virtual true final false
 void OnSubsystemDestroy() ;

/// @brief Method OnInstanceCreate addr 0x2b223d4 size 0x8 virtual true final false
 bool OnInstanceCreate(uint64_t xrInstance) ;

/// @brief Method OnSystemChange addr 0x2b223dc size 0x4 virtual true final false
 void OnSystemChange(uint64_t xrSystem) ;

/// @brief Method OnSessionCreate addr 0x2b223e0 size 0x4 virtual true final false
 void OnSessionCreate(uint64_t xrSession) ;

/// @brief Method OnAppSpaceChange addr 0x2b223e4 size 0x4 virtual true final false
 void OnAppSpaceChange(uint64_t xrSpace) ;

/// @brief Method OnSessionStateChange addr 0x2b223e8 size 0x4 virtual true final false
 void OnSessionStateChange(int32_t oldState, int32_t newState) ;

/// @brief Method OnSessionBegin addr 0x2b223ec size 0x4 virtual true final false
 void OnSessionBegin(uint64_t xrSession) ;

/// @brief Method OnSessionEnd addr 0x2b223f0 size 0x4 virtual true final false
 void OnSessionEnd(uint64_t xrSession) ;

/// @brief Method OnSessionExiting addr 0x2b223f4 size 0x4 virtual true final false
 void OnSessionExiting(uint64_t xrSession) ;

/// @brief Method OnSessionDestroy addr 0x2b223f8 size 0x4 virtual true final false
 void OnSessionDestroy(uint64_t xrSession) ;

/// @brief Method OnInstanceDestroy addr 0x2b223fc size 0x4 virtual true final false
 void OnInstanceDestroy(uint64_t xrInstance) ;

/// @brief Method OnSessionLossPending addr 0x2b22400 size 0x4 virtual true final false
 void OnSessionLossPending(uint64_t xrSession) ;

/// @brief Method OnInstanceLossPending addr 0x2b22404 size 0x4 virtual true final false
 void OnInstanceLossPending(uint64_t xrInstance) ;

/// @brief Method OnFormFactorChange addr 0x2b22408 size 0x4 virtual true final false
 void OnFormFactorChange(int32_t xrFormFactor) ;

/// @brief Method OnViewConfigurationTypeChange addr 0x2b2240c size 0x4 virtual true final false
 void OnViewConfigurationTypeChange(int32_t xrViewConfigurationType) ;

/// @brief Method OnEnvironmentBlendModeChange addr 0x2b22410 size 0x4 virtual true final false
 void OnEnvironmentBlendModeChange(UnityEngine::XR::OpenXR::NativeTypes::XrEnvironmentBlendMode xrEnvironmentBlendMode) ;

/// @brief Method OnEnabledChange addr 0x2b22414 size 0x4 virtual true final false
 void OnEnabledChange() ;

/// @brief Method PathToString addr 0x2b22418 size 0x7c virtual false final false
static ::StringW PathToString(uint64_t path) ;

/// @brief Method StringToPath addr 0x2b22520 size 0x24 virtual false final false
static uint64_t StringToPath(::StringW str) ;

/// @brief Method GetCurrentInteractionProfile addr 0x2b225e4 size 0x24 virtual false final false
static uint64_t GetCurrentInteractionProfile(uint64_t userPath) ;

/// @brief Method GetCurrentInteractionProfile addr 0x2b22694 size 0x3c virtual false final false
static uint64_t GetCurrentInteractionProfile(::StringW userPath) ;

/// @brief Method GetCurrentAppSpace addr 0x2b226d0 size 0x24 virtual false final false
static uint64_t GetCurrentAppSpace() ;

/// @brief Method GetViewConfigurationTypeForRenderPass addr 0x2b22778 size 0x4 virtual false final false
static int32_t GetViewConfigurationTypeForRenderPass(int32_t renderPassIndex) ;

/// @brief Method SetEnvironmentBlendMode addr 0x2b227f8 size 0x4 virtual false final false
static void SetEnvironmentBlendMode(UnityEngine::XR::OpenXR::NativeTypes::XrEnvironmentBlendMode xrEnvironmentBlendMode) ;

/// @brief Method GetEnvironmentBlendMode addr 0x2b22878 size 0x4 virtual false final false
...
/// @brief Method OnEnable addr 0x2b228e4 size 0x4 virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2b228e8 size 0x4 virtual true final false
 void OnDisable() ;

/// @brief Method Awake addr 0x2b228ec size 0x4 virtual true final false
 void Awake() ;

/// @brief Method ReceiveLoaderEvent addr 0x2b19f84 size 0x1d4 virtual false final false
...
/// @brief Method ReceiveNativeEvent addr 0x2b1cc6c size 0x300 virtual false final false
...
/// @brief Method Initialize addr 0x2b1917c size 0x120 virtual false final false
static void Initialize() ;

/// @brief Method HookGetInstanceProcAddr addr 0x2b19304 size 0x11c virtual false final false
static void HookGetInstanceProcAddr() ;

/// @brief Method GetAction addr 0x2b22ac0 size 0x58 virtual false final false
 uint64_t GetAction(UnityEngine::InputSystem::InputAction inputAction) ;

/// @brief Method Internal_PathToStringPtr addr 0x2b22494 size 0x8c virtual false final false
static bool Internal_PathToStringPtr(uint64_t pathId, ByRef<::cordl_internals::intptr_t> path) ;

/// @brief Method Internal_StringToPath addr 0x2b22544 size 0xa0 virtual false final false
static bool Internal_StringToPath(::StringW str, ByRef<uint64_t> pathId) ;

/// @brief Method Internal_GetCurrentInteractionProfile addr 0x2b22608 size 0x8c virtual false final false
static bool Internal_GetCurrentInteractionProfile(uint64_t pathId, ByRef<uint64_t> interactionProfile) ;

/// @brief Method Internal_GetFormFactor addr 0x2b228f0 size 0x68 virtual false final false
static int32_t Internal_GetFormFactor() ;

/// @brief Method Internal_GetViewConfigurationType addr 0x2b22958 size 0x68 virtual false final false
static int32_t Internal_GetViewConfigurationType() ;

/// @brief Method Internal_GetViewTypeFromRenderIndex addr 0x2b2277c size 0x7c virtual false final false
static int32_t Internal_GetViewTypeFromRenderIndex(int32_t renderPassIndex) ;

/// @brief Method Internal_GetSessionState addr 0x2b229c0 size 0x84 virtual false final false
static void Internal_GetSessionState(ByRef<int32_t> oldState, ByRef<int32_t> newState) ;

/// @brief Method Internal_GetEnvironmentBlendMode addr 0x2b2287c size 0x68 virtual false final false
static UnityEngine::XR::OpenXR::NativeTypes::XrEnvironmentBlendMode Internal_GetEnvironmentBlendMode() ;

/// @brief Method Internal_SetEnvironmentBlendMode addr 0x2b227fc size 0x7c virtual false final false
...
/// @brief Method Internal_GetAppSpace addr 0x2b226f4 size 0x84 virtual false final false
static bool Internal_GetAppSpace(ByRef<uint64_t> appSpace) ;

/// @brief Method Internal_GetProcAddressPtr addr 0x2b22340 size 0x7c virtual false final false
static ::cordl_internals::intptr_t Internal_GetProcAddressPtr(bool loaderDefault) ;

/// @brief Method Internal_SetProcAddressPtrAndLoadStage1 addr 0x2b22a44 size 0x7c virtual false final false
static void Internal_SetProcAddressPtrAndLoadStage1(::cordl_internals::intptr_t func) ;

// Ctor Parameters []
explicit OpenXRFeature() ;

/// @brief Method .ctor addr 0x2b22b18 size 0x8 virtual false final false
 void _ctor() ;
