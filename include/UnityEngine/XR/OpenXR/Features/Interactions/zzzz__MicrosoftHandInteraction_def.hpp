...
/// @brief Method get_select addr 0x2b2c6e0 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_select() ;

/// @brief Method set_select addr 0x2b2c6e8 size 0x8 virtual false final false
 void set_select(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_selectPressed addr 0x2b2c6f0 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_selectPressed() ;

/// @brief Method set_selectPressed addr 0x2b2c6f8 size 0x8 virtual false final false
 void set_selectPressed(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_squeeze addr 0x2b2c700 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_squeeze() ;

/// @brief Method set_squeeze addr 0x2b2c708 size 0x8 virtual false final false
 void set_squeeze(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_squeezePressed addr 0x2b2c710 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_squeezePressed() ;

/// @brief Method set_squeezePressed addr 0x2b2c718 size 0x8 virtual false final false
 void set_squeezePressed(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_devicePose addr 0x2b2c720 size 0x8 virtual false final false
 UnityEngine::XR::OpenXR::Input::PoseControl get_devicePose() ;

/// @brief Method set_devicePose addr 0x2b2c728 size 0x8 virtual false final false
 void set_devicePose(UnityEngine::XR::OpenXR::Input::PoseControl value) ;

/// @brief Method get_pointer addr 0x2b2c730 size 0x8 virtual false final false
 UnityEngine::XR::OpenXR::Input::PoseControl get_pointer() ;

/// @brief Method set_pointer addr 0x2b2c738 size 0x8 virtual false final false
 void set_pointer(UnityEngine::XR::OpenXR::Input::PoseControl value) ;

/// @brief Method get_isTracked addr 0x2b2c740 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_isTracked() ;

/// @brief Method set_isTracked addr 0x2b2c748 size 0x8 virtual false final false
 void set_isTracked(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_trackingState addr 0x2b2c750 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::IntegerControl get_trackingState() ;

/// @brief Method set_trackingState addr 0x2b2c758 size 0x8 virtual false final false
 void set_trackingState(UnityEngine::InputSystem::Controls::IntegerControl value) ;

/// @brief Method get_devicePosition addr 0x2b2c760 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector3Control get_devicePosition() ;

/// @brief Method set_devicePosition addr 0x2b2c768 size 0x8 virtual false final false
 void set_devicePosition(UnityEngine::InputSystem::Controls::Vector3Control value) ;

/// @brief Method get_deviceRotation addr 0x2b2c770 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::QuaternionControl get_deviceRotation() ;

/// @brief Method set_deviceRotation addr 0x2b2c778 size 0x8 virtual false final false
 void set_deviceRotation(UnityEngine::InputSystem::Controls::QuaternionControl value) ;

/// @brief Method get_pointerPosition addr 0x2b2c780 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector3Control get_pointerPosition() ;

/// @brief Method set_pointerPosition addr 0x2b2c788 size 0x8 virtual false final false
 void set_pointerPosition(UnityEngine::InputSystem::Controls::Vector3Control value) ;

/// @brief Method get_pointerRotation addr 0x2b2c790 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::QuaternionControl get_pointerRotation() ;

/// @brief Method set_pointerRotation addr 0x2b2c798 size 0x8 virtual false final false
 void set_pointerRotation(UnityEngine::InputSystem::Controls::QuaternionControl value) ;

/// @brief Method FinishSetup addr 0x2b2c7a0 size 0x2b0 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit UnityEngine__XR__OpenXR__Features__Interactions__MicrosoftHandInteraction__HoloLensHand() ;

/// @brief Method .ctor addr 0x2b2ca50 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method RegisterDeviceLayout addr 0x2b2b578 size 0x140 virtual true final false
 void RegisterDeviceLayout() ;

/// @brief Method UnregisterDeviceLayout addr 0x2b2b6b8 size 0x68 virtual true final false
 void UnregisterDeviceLayout() ;

/// @brief Method RegisterActionMapsWithRuntime addr 0x2b2b720 size 0xfb8 virtual true final false
 void RegisterActionMapsWithRuntime() ;

// Ctor Parameters []
explicit MicrosoftHandInteraction() ;

/// @brief Method .ctor addr 0x2b2c6d8 size 0x8 virtual false final false
 void _ctor() ;
