...
namespace UnityEngine::XR::OpenXR::Features::Interactions {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14209))}
...
/// @brief Method get_pose addr 0x2b23424 size 0x8 virtual false final false
 UnityEngine::XR::OpenXR::Input::PoseControl get_pose() ;

/// @brief Method set_pose addr 0x2b2342c size 0x8 virtual false final false
 void set_pose(UnityEngine::XR::OpenXR::Input::PoseControl value) ;

/// @brief Method FinishSetup addr 0x2b23434 size 0x78 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit UnityEngine__XR__OpenXR__Features__Interactions__EyeGazeInteraction__EyeGazeDevice() ;

/// @brief Method .ctor addr 0x2b234ac size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method OnInstanceCreate addr 0x2b22cc0 size 0x6c virtual true final false
 bool OnInstanceCreate(uint64_t instance) ;

/// @brief Method RegisterDeviceLayout addr 0x2b22d2c size 0x15c virtual true final false
 void RegisterDeviceLayout() ;

/// @brief Method UnregisterDeviceLayout addr 0x2b22e88 size 0x68 virtual true final false
 void UnregisterDeviceLayout() ;

/// @brief Method RegisterActionMapsWithRuntime addr 0x2b22ef0 size 0x52c virtual true final false
 void RegisterActionMapsWithRuntime() ;

// Ctor Parameters []
explicit EyeGazeInteraction() ;

/// @brief Method .ctor addr 0x2b2341c size 0x8 virtual false final false
 void _ctor() ;
