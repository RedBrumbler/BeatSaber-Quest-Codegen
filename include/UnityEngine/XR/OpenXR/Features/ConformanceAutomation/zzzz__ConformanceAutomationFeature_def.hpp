...
/// @brief Method OnInstanceCreate addr 0x2b3659c size 0xd8 virtual true final false
 bool OnInstanceCreate(uint64_t instance) ;

/// @brief Method OnInstanceDestroy addr 0x2b366f8 size 0x68 virtual true final false
 void OnInstanceDestroy(uint64_t xrInstance) ;

/// @brief Method OnSessionCreate addr 0x2b36760 size 0x64 virtual true final false
 void OnSessionCreate(uint64_t xrSessionId) ;

/// @brief Method OnSessionDestroy addr 0x2b367c4 size 0x68 virtual true final false
 void OnSessionDestroy(uint64_t xrSessionId) ;

/// @brief Method ConformanceAutomationSetActive addr 0x2b3682c size 0x88 virtual false final false
static bool ConformanceAutomationSetActive(::StringW interactionProfile, ::StringW topLevelPath, bool isActive) ;

/// @brief Method ConformanceAutomationSetBool addr 0x2b36958 size 0x88 virtual false final false
static bool ConformanceAutomationSetBool(::StringW topLevelPath, ::StringW inputSourcePath, bool state) ;

/// @brief Method ConformanceAutomationSetFloat addr 0x2b36a84 size 0x90 virtual false final false
static bool ConformanceAutomationSetFloat(::StringW topLevelPath, ::StringW inputSourcePath, float_t state) ;

/// @brief Method ConformanceAutomationSetVec2 addr 0x2b36bc0 size 0xb8 virtual false final false
static bool ConformanceAutomationSetVec2(::StringW topLevelPath, ::StringW inputSourcePath, UnityEngine::Vector2 state) ;

/// @brief Method ConformanceAutomationSetPose addr 0x2b36d2c size 0x128 virtual false final false
...
/// @brief Method ConformanceAutomationSetVelocity addr 0x2b36f18 size 0x12c virtual false final false
...
/// @brief Method initialize addr 0x2b36674 size 0x84 virtual false final false
static void initialize(::cordl_internals::intptr_t xrGetInstanceProcAddr, uint64_t xrInstance) ;

/// @brief Method xrSetInputDeviceActiveEXT addr 0x2b368b4 size 0xa4 virtual false final false
static bool xrSetInputDeviceActiveEXT(uint64_t xrSession, uint64_t interactionProfile, uint64_t topLevelPath, bool isActive) ;

/// @brief Method xrSetInputDeviceStateBoolEXT addr 0x2b369e0 size 0xa4 virtual false final false
static bool xrSetInputDeviceStateBoolEXT(uint64_t xrSession, uint64_t topLevelPath, uint64_t inputSourcePath, bool state) ;

/// @brief Method xrSetInputDeviceStateFloatEXT addr 0x2b36b14 size 0xac virtual false final false
...
/// @brief Method xrSetInputDeviceStateVector2fEXT addr 0x2b36c78 size 0xb4 virtual false final false
...
/// @brief Method xrSetInputDeviceLocationEXT addr 0x2b36e54 size 0xc4 virtual false final false
...
/// @brief Method xrSetInputDeviceVelocityUNITY addr 0x2b37044 size 0xfc virtual false final false
...
/// @brief Method .ctor addr 0x2b37140 size 0x8 virtual false final false
 void _ctor() ;
