...
/// @brief Method get_userPresence addr 0x2b1fa2c size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_userPresence() ;

/// @brief Method set_userPresence addr 0x2b1fa34 size 0x8 virtual false final false
 void set_userPresence(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method FinishSetup addr 0x2b1fa3c size 0x7c virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit OpenXRHmd() ;

/// @brief Method .ctor addr 0x2b1fab8 size 0x8 virtual false final false
 void _ctor() ;
