...
/// @brief Method StartReport addr 0x2b173c0 size 0x64 virtual false final false
static void StartReport() ;

/// @brief Method GetSection addr 0x2b17424 size 0x8c virtual false final false
static uint64_t GetSection(::StringW sectionName) ;

/// @brief Method AddSectionEntry addr 0x2b174b0 size 0xb4 virtual false final false
static void AddSectionEntry(uint64_t sectionHandle, ::StringW sectionEntry, ::StringW sectionBody) ;

/// @brief Method AddSectionBreak addr 0x2b17564 size 0x74 virtual false final false
static void AddSectionBreak(uint64_t sectionHandle) ;

/// @brief Method AddEventEntry addr 0x2b175d8 size 0xa4 virtual false final false
static void AddEventEntry(::StringW eventName, ::StringW eventData) ;

/// @brief Method Internal_DumpReport addr 0x2b1767c size 0x64 virtual false final false
static void Internal_DumpReport() ;

/// @brief Method Internal_DumpReport addr 0x2b176e0 size 0x8c virtual false final false
static void Internal_DumpReport(::StringW reason) ;

/// @brief Method Internal_GenerateReport addr 0x2b1776c size 0x68 virtual false final false
static ::cordl_internals::intptr_t Internal_GenerateReport() ;

/// @brief Method Internal_ReleaseReport addr 0x2b177d4 size 0x7c virtual false final false
static void Internal_ReleaseReport(::cordl_internals::intptr_t report) ;

/// @brief Method GenerateReport addr 0x2b17850 size 0xb4 virtual false final false
static ::StringW GenerateReport() ;

/// @brief Method DumpReport addr 0x2b17904 size 0x4 virtual false final false
static void DumpReport(::StringW reason) ;

// Ctor Parameters []
explicit DiagnosticReport() ;

/// @brief Method .ctor addr 0x2b17908 size 0x8 virtual false final false
 void _ctor() ;
