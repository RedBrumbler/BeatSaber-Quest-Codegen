...
/// @brief Method SetTrackingSpaceType addr 0x2d6ab98 size 0x3c virtual false final false
static bool SetTrackingSpaceType(UnityEngine::XR::TrackingSpaceType trackingSpaceType) ;

/// @brief Method DisableAutoXRCameraTracking addr 0x2d6abd4 size 0x44 virtual false final false
static void DisableAutoXRCameraTracking(UnityEngine::Camera camera, bool disabled) ;

/// @brief Method InvokeDeviceLoaded addr 0x2d6ac18 size 0x6c virtual false final false
