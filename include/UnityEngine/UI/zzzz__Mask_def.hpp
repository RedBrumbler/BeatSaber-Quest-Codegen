...
/// @brief Method get_rectTransform addr 0x2c335c4 size 0x58 virtual false final false
 UnityEngine::RectTransform get_rectTransform() ;

/// @brief Method get_showMaskGraphic addr 0x2c3361c size 0x8 virtual false final false
 bool get_showMaskGraphic() ;

/// @brief Method set_showMaskGraphic addr 0x2c33624 size 0xb0 virtual false final false
 void set_showMaskGraphic(bool value) ;

/// @brief Method get_graphic addr 0x2c336d4 size 0x58 virtual false final false
 UnityEngine::UI::Graphic get_graphic() ;

// Ctor Parameters []
explicit Mask() ;

/// @brief Method .ctor addr 0x2c3372c size 0x10 virtual false final false
 void _ctor() ;

/// @brief Method MaskEnabled addr 0x2c3373c size 0x90 virtual true final false
 bool MaskEnabled() ;

/// @brief Method OnSiblingGraphicEnabledDisabled addr 0x2c337cc size 0x4 virtual true final false
 void OnSiblingGraphicEnabledDisabled() ;

/// @brief Method OnEnable addr 0x2c337d0 size 0x160 virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2c33ba0 size 0x1c4 virtual true final false
 void OnDisable() ;

/// @brief Method IsRaycastLocationValid addr 0x2c33d64 size 0xac virtual true final false
 bool IsRaycastLocationValid(UnityEngine::Vector2 sp, UnityEngine::Camera eventCamera) ;

/// @brief Method GetModifiedMaterial addr 0x2c33e10 size 0x294 virtual true final false
