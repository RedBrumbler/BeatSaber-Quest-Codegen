...
/// @brief Method .ctor addr 0x2c361a4 size 0x50 virtual false final false
 void _ctor() ;

/// @brief Method get_mainTexture addr 0x2c361f4 size 0x158 virtual true final false
 UnityEngine::Texture get_mainTexture() ;

/// @brief Method get_texture addr 0x2c3634c size 0x8 virtual false final false
 UnityEngine::Texture get_texture() ;

/// @brief Method set_texture addr 0x2c36354 size 0xac virtual false final false
 void set_texture(UnityEngine::Texture value) ;

/// @brief Method get_uvRect addr 0x2c36400 size 0xc virtual false final false
 UnityEngine::Rect get_uvRect() ;

/// @brief Method set_uvRect addr 0x2c3640c size 0x80 virtual false final false
 void set_uvRect(UnityEngine::Rect value) ;

/// @brief Method SetNativeSize addr 0x2c3648c size 0x2e0 virtual true final false
 void SetNativeSize() ;

/// @brief Method OnPopulateMesh addr 0x2c3676c size 0xd18 virtual true final false
 void OnPopulateMesh(UnityEngine::UI::VertexHelper vh) ;

/// @brief Method OnDidApplyAnimationProperties addr 0x2c3784c size 0x3c virtual true final false
