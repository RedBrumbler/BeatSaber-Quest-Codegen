...
/// @brief Method .ctor addr 0x2c447fc size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method get_group addr 0x2c44548 size 0x8 virtual false final false
 UnityEngine::UI::ToggleGroup get_group() ;

/// @brief Method set_group addr 0x2c44550 size 0x20 virtual false final false
 void set_group(UnityEngine::UI::ToggleGroup value) ;

// Ctor Parameters []
explicit Toggle() ;

/// @brief Method .ctor addr 0x2c44770 size 0x8c virtual false final false
 void _ctor() ;

/// @brief Method Rebuild addr 0x2c44844 size 0x4 virtual true final false
 void Rebuild(UnityEngine::UI::CanvasUpdate executing) ;

/// @brief Method LayoutComplete addr 0x2c44848 size 0x4 virtual true final false
 void LayoutComplete() ;

/// @brief Method GraphicUpdateComplete addr 0x2c4484c size 0x4 virtual true final false
 void GraphicUpdateComplete() ;

/// @brief Method OnDestroy addr 0x2c44850 size 0x80 virtual true final false
 void OnDestroy() ;

/// @brief Method OnEnable addr 0x2c44cbc size 0x2c virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2c44ce8 size 0x20 virtual true final false
 void OnDisable() ;

/// @brief Method OnDidApplyAnimationProperties addr 0x2c44d08 size 0x124 virtual true final false
 void OnDidApplyAnimationProperties() ;

/// @brief Method SetToggleGroup addr 0x2c44570 size 0x13c virtual false final false
 void SetToggleGroup(UnityEngine::UI::ToggleGroup newGroup, bool setMemberValue) ;

/// @brief Method get_isOn addr 0x2c45210 size 0x8 virtual false final false
 bool get_isOn() ;

/// @brief Method set_isOn addr 0x2c45218 size 0xc virtual false final false
 void set_isOn(bool value) ;

/// @brief Method SetIsOnWithoutNotify addr 0x2c45224 size 0xc virtual false final false
 void SetIsOnWithoutNotify(bool value) ;

/// @brief Method Set addr 0x2c44e2c size 0x174 virtual false final false
 void Set(bool value, bool sendCallback) ;

/// @brief Method PlayEffect addr 0x2c446ac size 0xc4 virtual false final false
 void PlayEffect(bool instant) ;

/// @brief Method Start addr 0x2c4536c size 0x8 virtual true final false
 void Start() ;

/// @brief Method InternalToggle addr 0x2c45374 size 0x54 virtual false final false
 void InternalToggle() ;

/// @brief Method OnPointerClick addr 0x2c453c8 size 0x24 virtual true final false
 void OnPointerClick(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnSubmit addr 0x2c453ec size 0x4 virtual true final false
 void OnSubmit(UnityEngine::EventSystems::BaseEventData eventData) ;

/// @brief Method UnityEngine.UI.ICanvasElement.get_transform addr 0x2c453f0 size 0x8 virtual true final true
