...
/// @brief Method .ctor addr 0x2c458f0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <AnyTogglesOn>b__13_0 addr 0x2c458f8 size 0x18 virtual false final false
 bool _AnyTogglesOn_b__13_0(UnityEngine::UI::Toggle x) ;

/// @brief Method <ActiveToggles>b__14_0 addr 0x2c45910 size 0x18 virtual false final false
...
/// @brief Method get_allowSwitchOff addr 0x2c453f8 size 0x8 virtual false final false
 bool get_allowSwitchOff() ;

/// @brief Method set_allowSwitchOff addr 0x2c45400 size 0xc virtual false final false
 void set_allowSwitchOff(bool value) ;

// Ctor Parameters []
explicit ToggleGroup() ;

/// @brief Method .ctor addr 0x2c4540c size 0x7c virtual false final false
 void _ctor() ;

/// @brief Method Start addr 0x2c45488 size 0x1c virtual true final false
 void Start() ;

/// @brief Method OnEnable addr 0x2c454a4 size 0x1c virtual true final false
 void OnEnable() ;

/// @brief Method ValidateToggleIsInGroup addr 0x2c454c0 size 0x158 virtual false final false
 void ValidateToggleIsInGroup(UnityEngine::UI::Toggle toggle) ;

/// @brief Method NotifyToggleOn addr 0x2c45104 size 0x10c virtual false final false
 void NotifyToggleOn(UnityEngine::UI::Toggle toggle, bool sendCallback) ;

/// @brief Method UnregisterToggle addr 0x2c44fa0 size 0x90 virtual false final false
 void UnregisterToggle(UnityEngine::UI::Toggle toggle) ;

/// @brief Method RegisterToggle addr 0x2c45030 size 0xd4 virtual false final false
 void RegisterToggle(UnityEngine::UI::Toggle toggle) ;

/// @brief Method EnsureValidState addr 0x2c448d0 size 0x3ec virtual false final false
 void EnsureValidState() ;

/// @brief Method AnyTogglesOn addr 0x2c45230 size 0x13c virtual false final false
 bool AnyTogglesOn() ;

/// @brief Method ActiveToggles addr 0x2c45618 size 0xfc virtual false final false
 System::Collections::Generic::IEnumerable_1<UnityEngine::UI::Toggle> ActiveToggles() ;

/// @brief Method GetFirstActiveToggle addr 0x2c45714 size 0x88 virtual false final false
 UnityEngine::UI::Toggle GetFirstActiveToggle() ;

/// @brief Method SetAllTogglesOff addr 0x2c4579c size 0xf0 virtual false final false
