...
/// @brief Method .ctor addr 0x2c19968 size 0x1a8 virtual false final false
 void _ctor() ;

/// @brief Method get_instance addr 0x2c19b10 size 0xa8 virtual false final false
static UnityEngine::UI::GraphicRegistry get_instance() ;

/// @brief Method RegisterGraphicForCanvas addr 0x2c157c0 size 0x1f4 virtual false final false
static void RegisterGraphicForCanvas(UnityEngine::Canvas c, UnityEngine::UI::Graphic graphic) ;

/// @brief Method RegisterRaycastGraphicForCanvas addr 0x2c14c98 size 0x1f4 virtual false final false
static void RegisterRaycastGraphicForCanvas(UnityEngine::Canvas c, UnityEngine::UI::Graphic graphic) ;

/// @brief Method UnregisterGraphicForCanvas addr 0x2c161c4 size 0x1a4 virtual false final false
static void UnregisterGraphicForCanvas(UnityEngine::Canvas c, UnityEngine::UI::Graphic graphic) ;

/// @brief Method UnregisterRaycastGraphicForCanvas addr 0x2c14b1c size 0x17c virtual false final false
static void UnregisterRaycastGraphicForCanvas(UnityEngine::Canvas c, UnityEngine::UI::Graphic graphic) ;

/// @brief Method DisableGraphicForCanvas addr 0x2c1541c size 0x180 virtual false final false
static void DisableGraphicForCanvas(UnityEngine::Canvas c, UnityEngine::UI::Graphic graphic) ;

/// @brief Method DisableRaycastGraphicForCanvas addr 0x2c19bb8 size 0x180 virtual false final false
static void DisableRaycastGraphicForCanvas(UnityEngine::Canvas c, UnityEngine::UI::Graphic graphic) ;

/// @brief Method GetGraphicsForCanvas addr 0x2c19d38 size 0xbc virtual false final false
static System::Collections::Generic::IList_1<UnityEngine::UI::Graphic> GetGraphicsForCanvas(UnityEngine::Canvas canvas) ;

/// @brief Method GetRaycastableGraphicsForCanvas addr 0x2c19130 size 0xbc virtual false final false
