...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::HorizontalLayoutGroup::*)()>(&UnityEngine::UI::HorizontalLayoutGroup::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2c2ef9c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::HorizontalLayoutGroup::*)()>(&UnityEngine::UI::HorizontalLayoutGroup::CalculateLayoutInputHorizontal)> {
  ...
  constexpr static std::size_t addrs = 0x2c2efb4;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(UnityEngine::UI::HorizontalLayoutGroup),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UI::HorizontalLayoutGroup>::get(),
                                  28
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::HorizontalLayoutGroup::*)()>(&UnityEngine::UI::HorizontalLayoutGroup::CalculateLayoutInputVertical)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x2c2f278;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::HorizontalLayoutGroup::*)()>(&UnityEngine::UI::HorizontalLayoutGroup::SetLayoutHorizontal)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x2c2f284;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UI::HorizontalLayoutGroup::*)()>(&UnityEngine::UI::HorizontalLayoutGroup::SetLayoutVertical)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x2c2f8fc;
...
// Ctor Parameters []
 UnityEngine::UI::HorizontalLayoutGroup::HorizontalLayoutGroup()  : UnityEngine::UI::HorizontalOrVerticalLayoutGroup(THROW_UNLESS(::il2cpp_utils::New<HorizontalLayoutGroup>())) {}
 void UnityEngine::UI::HorizontalLayoutGroup::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UI::HorizontalLayoutGroup>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
