...
/// @brief Method .ctor addr 0x2c4b38c size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method get_startValue addr 0x2c4b224 size 0x8 virtual false final false
 float_t get_startValue() ;

/// @brief Method set_startValue addr 0x2c4b22c size 0x8 virtual false final false
 void set_startValue(float_t value) ;

/// @brief Method get_targetValue addr 0x2c4b234 size 0x8 virtual false final false
 float_t get_targetValue() ;

/// @brief Method set_targetValue addr 0x2c4b23c size 0x8 virtual false final false
 void set_targetValue(float_t value) ;

/// @brief Method get_duration addr 0x2c4b244 size 0x8 virtual true final true
 float_t get_duration() ;

/// @brief Method set_duration addr 0x2c4b24c size 0x8 virtual false final false
 void set_duration(float_t value) ;

/// @brief Method get_ignoreTimeScale addr 0x2c4b254 size 0x8 virtual true final true
 bool get_ignoreTimeScale() ;

/// @brief Method set_ignoreTimeScale addr 0x2c4b25c size 0xc virtual false final false
 void set_ignoreTimeScale(bool value) ;

/// @brief Method TweenValue addr 0x2c4b268 size 0x8c virtual true final true
 void TweenValue(float_t floatPercentage) ;

/// @brief Method AddOnChangedCallback addr 0x2c4b304 size 0x88 virtual false final false
 void AddOnChangedCallback(UnityEngine::Events::UnityAction_1<float_t> callback) ;

/// @brief Method GetIgnoreTimescale addr 0x2c4b3d4 size 0x8 virtual false final false
 bool GetIgnoreTimescale() ;

/// @brief Method GetDuration addr 0x2c4b3dc size 0x8 virtual false final false
 float_t GetDuration() ;

/// @brief Method ValidTarget addr 0x2c4b2f4 size 0x10 virtual true final true
 bool ValidTarget() ;
