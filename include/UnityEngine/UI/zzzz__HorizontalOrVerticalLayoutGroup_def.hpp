...
namespace UnityEngine::UI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13049))}
...
/// @brief Method get_spacing addr 0x2c2f908 size 0x8 virtual false final false
 float_t get_spacing() ;

/// @brief Method set_spacing addr 0x2c2f910 size 0x5c virtual false final false
 void set_spacing(float_t value) ;

/// @brief Method get_childForceExpandWidth addr 0x2c2f96c size 0x8 virtual false final false
 bool get_childForceExpandWidth() ;

/// @brief Method set_childForceExpandWidth addr 0x2c2f974 size 0x5c virtual false final false
 void set_childForceExpandWidth(bool value) ;

/// @brief Method get_childForceExpandHeight addr 0x2c2f9d0 size 0x8 virtual false final false
 bool get_childForceExpandHeight() ;

/// @brief Method set_childForceExpandHeight addr 0x2c2f9d8 size 0x5c virtual false final false
 void set_childForceExpandHeight(bool value) ;

/// @brief Method get_childControlWidth addr 0x2c2fa34 size 0x8 virtual false final false
 bool get_childControlWidth() ;

/// @brief Method set_childControlWidth addr 0x2c2fa3c size 0x5c virtual false final false
 void set_childControlWidth(bool value) ;

/// @brief Method get_childControlHeight addr 0x2c2fa98 size 0x8 virtual false final false
 bool get_childControlHeight() ;

/// @brief Method set_childControlHeight addr 0x2c2faa0 size 0x5c virtual false final false
 void set_childControlHeight(bool value) ;

/// @brief Method get_childScaleWidth addr 0x2c2fafc size 0x8 virtual false final false
 bool get_childScaleWidth() ;

/// @brief Method set_childScaleWidth addr 0x2c2fb04 size 0x5c virtual false final false
 void set_childScaleWidth(bool value) ;

/// @brief Method get_childScaleHeight addr 0x2c2fb60 size 0x8 virtual false final false
 bool get_childScaleHeight() ;

/// @brief Method set_childScaleHeight addr 0x2c2fb68 size 0x5c virtual false final false
 void set_childScaleHeight(bool value) ;

/// @brief Method get_reverseArrangement addr 0x2c2fbc4 size 0x8 virtual false final false
 bool get_reverseArrangement() ;

/// @brief Method set_reverseArrangement addr 0x2c2fbcc size 0x5c virtual false final false
 void set_reverseArrangement(bool value) ;

/// @brief Method CalcAlongAxis addr 0x2c2efd4 size 0x2a4 virtual false final false
 void CalcAlongAxis(int32_t axis, bool isVertical) ;

/// @brief Method SetChildrenAlongAxis addr 0x2c2f290 size 0x66c virtual false final false
 void SetChildrenAlongAxis(int32_t axis, bool isVertical) ;

/// @brief Method GetChildSizes addr 0x2c2fc28 size 0x118 virtual false final false
...
/// @brief Method .ctor addr 0x2c2efa8 size 0xc virtual false final false
 void _ctor() ;
