...
/// @brief Method Notify2DMaskStateChanged addr 0x2c35278 size 0x25c virtual false final false
static void Notify2DMaskStateChanged(UnityEngine::Component mask) ;

/// @brief Method NotifyStencilStateChanged addr 0x2c33948 size 0x258 virtual false final false
static void NotifyStencilStateChanged(UnityEngine::Component mask) ;

/// @brief Method FindRootSortOverrideCanvas addr 0x2c340a4 size 0x1a0 virtual false final false
static UnityEngine::Transform FindRootSortOverrideCanvas(UnityEngine::Transform start) ;

/// @brief Method GetStencilDepth addr 0x2c34244 size 0x288 virtual false final false
static int32_t GetStencilDepth(UnityEngine::Transform transform, UnityEngine::Transform stopAfter) ;

/// @brief Method IsDescendantOrSelf addr 0x2c354d4 size 0x150 virtual false final false
static bool IsDescendantOrSelf(UnityEngine::Transform father, UnityEngine::Transform child) ;

/// @brief Method GetRectMaskForClippable addr 0x2c34cc8 size 0x41c virtual false final false
static UnityEngine::UI::RectMask2D GetRectMaskForClippable(UnityEngine::UI::IClippable clippable) ;

/// @brief Method GetRectMasksForClip addr 0x2c35624 size 0x364 virtual false final false
...
/// @brief Method .ctor addr 0x2c35988 size 0x8 virtual false final false
 void _ctor() ;
