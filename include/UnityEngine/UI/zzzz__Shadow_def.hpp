...
namespace UnityEngine::UI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13101))}
...
/// @brief Method .ctor addr 0x2c4a62c size 0x28 virtual false final false
 void _ctor() ;

/// @brief Method get_effectColor addr 0x2c4a654 size 0xc virtual false final false
 UnityEngine::Color get_effectColor() ;

/// @brief Method set_effectColor addr 0x2c4a660 size 0xd4 virtual false final false
 void set_effectColor(UnityEngine::Color value) ;

/// @brief Method get_effectDistance addr 0x2c4a734 size 0x8 virtual false final false
 UnityEngine::Vector2 get_effectDistance() ;

/// @brief Method set_effectDistance addr 0x2c4a73c size 0x104 virtual false final false
 void set_effectDistance(UnityEngine::Vector2 value) ;

/// @brief Method get_useGraphicAlpha addr 0x2c4a840 size 0x8 virtual false final false
 bool get_useGraphicAlpha() ;

/// @brief Method set_useGraphicAlpha addr 0x2c4a848 size 0xb8 virtual false final false
 void set_useGraphicAlpha(bool value) ;

/// @brief Method ApplyShadowZeroAlloc addr 0x2c4a900 size 0x30c virtual false final false
...
/// @brief Method ApplyShadow addr 0x2c4ac0c size 0x8 virtual false final false
...
/// @brief Method ModifyMesh addr 0x2c4ac14 size 0x3e0 virtual true final false
