...
/// @brief Method get_normalColor addr 0x2c0bdf0 size 0xc virtual false final false
 UnityEngine::Color get_normalColor() ;

/// @brief Method set_normalColor addr 0x2c0bdfc size 0xc virtual false final false
 void set_normalColor(UnityEngine::Color value) ;

/// @brief Method get_highlightedColor addr 0x2c0be08 size 0xc virtual false final false
 UnityEngine::Color get_highlightedColor() ;

/// @brief Method set_highlightedColor addr 0x2c0be14 size 0xc virtual false final false
 void set_highlightedColor(UnityEngine::Color value) ;

/// @brief Method get_pressedColor addr 0x2c0be20 size 0xc virtual false final false
 UnityEngine::Color get_pressedColor() ;

/// @brief Method set_pressedColor addr 0x2c0be2c size 0xc virtual false final false
 void set_pressedColor(UnityEngine::Color value) ;

/// @brief Method get_selectedColor addr 0x2c0be38 size 0xc virtual false final false
 UnityEngine::Color get_selectedColor() ;

/// @brief Method set_selectedColor addr 0x2c0be44 size 0xc virtual false final false
 void set_selectedColor(UnityEngine::Color value) ;

/// @brief Method get_disabledColor addr 0x2c0be50 size 0xc virtual false final false
 UnityEngine::Color get_disabledColor() ;

/// @brief Method set_disabledColor addr 0x2c0be5c size 0xc virtual false final false
 void set_disabledColor(UnityEngine::Color value) ;

/// @brief Method get_colorMultiplier addr 0x2c0be68 size 0x8 virtual false final false
 float_t get_colorMultiplier() ;

/// @brief Method set_colorMultiplier addr 0x2c0be70 size 0x8 virtual false final false
 void set_colorMultiplier(float_t value) ;

/// @brief Method get_fadeDuration addr 0x2c0be78 size 0x8 virtual false final false
 float_t get_fadeDuration() ;

/// @brief Method set_fadeDuration addr 0x2c0be80 size 0x8 virtual false final false
 void set_fadeDuration(float_t value) ;

/// @brief Method Equals addr 0x2c0bf04 size 0x90 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2c0bf94 size 0x124 virtual true final true
 bool Equals(UnityEngine::UI::ColorBlock other) ;

/// @brief Method op_Equality addr 0x2c0c0b8 size 0x34 virtual false final false
static bool op_Equality(UnityEngine::UI::ColorBlock point1, UnityEngine::UI::ColorBlock point2) ;

/// @brief Method op_Inequality addr 0x2c0c0ec size 0x38 virtual false final false
static bool op_Inequality(UnityEngine::UI::ColorBlock point1, UnityEngine::UI::ColorBlock point2) ;

/// @brief Method GetHashCode addr 0x2c0c124 size 0x6c virtual true final false
 int32_t GetHashCode() ;
