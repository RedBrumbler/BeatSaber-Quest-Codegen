...
/// @brief Method .ctor addr 0x2c47234 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "m", ty: "UnityEngine::Mesh", modifiers: "", def_value: None }]
explicit VertexHelper(UnityEngine::Mesh m) ;

/// @brief Method .ctor addr 0x2c4723c size 0x238 virtual false final false
 void _ctor(UnityEngine::Mesh m) ;

/// @brief Method InitializeListIfRequired addr 0x2c47474 size 0x190 virtual false final false
 void InitializeListIfRequired() ;

/// @brief Method Dispose addr 0x2c47604 size 0x1b4 virtual true final true
 void Dispose() ;

/// @brief Method Clear addr 0x2c37484 size 0x11c virtual false final false
 void Clear() ;

/// @brief Method get_currentVertCount addr 0x2c477b8 size 0x4c virtual false final false
 int32_t get_currentVertCount() ;

/// @brief Method get_currentIndexCount addr 0x2c47804 size 0x4c virtual false final false
 int32_t get_currentIndexCount() ;

/// @brief Method PopulateUIVertex addr 0x2c47850 size 0x160 virtual false final false
 void PopulateUIVertex(ByRef<UnityEngine::UIVertex> vertex, int32_t i) ;

/// @brief Method SetUIVertex addr 0x2c479b0 size 0x15c virtual false final false
 void SetUIVertex(UnityEngine::UIVertex vertex, int32_t i) ;

/// @brief Method FillMesh addr 0x2c47b0c size 0x164 virtual false final false
 void FillMesh(UnityEngine::Mesh mesh) ;

/// @brief Method AddVert addr 0x2c47c70 size 0x4fc virtual false final false
...
/// @brief Method AddVert addr 0x2c4816c size 0x110 virtual false final false
...
/// @brief Method AddVert addr 0x2c375a0 size 0x130 virtual false final false
 void AddVert(UnityEngine::Vector3 position, UnityEngine::Color32 color, UnityEngine::Vector4 uv0) ;

/// @brief Method AddVert addr 0x2c4827c size 0x94 virtual false final false
 void AddVert(UnityEngine::UIVertex v) ;

/// @brief Method AddTriangle addr 0x2c376d0 size 0x17c virtual false final false
 void AddTriangle(int32_t idx0, int32_t idx1, int32_t idx2) ;

/// @brief Method AddUIVertexQuad addr 0x2c44264 size 0x110 virtual false final false
 void AddUIVertexQuad(::ArrayW<UnityEngine::UIVertex> verts) ;

/// @brief Method AddUIVertexStream addr 0x2c48310 size 0xac virtual false final false
...
/// @brief Method AddUIVertexTriangleStream addr 0x2c483bc size 0x50 virtual false final false
 void AddUIVertexTriangleStream(System::Collections::Generic::List_1<UnityEngine::UIVertex> verts) ;

/// @brief Method GetUIVertexStream addr 0x2c4840c size 0x50 virtual false final false
