...
/// @brief Method get_ignoreLayout addr 0x2c303b8 size 0x8 virtual true final false
 bool get_ignoreLayout() ;

/// @brief Method set_ignoreLayout addr 0x2c303c0 size 0x74 virtual true final false
 void set_ignoreLayout(bool value) ;

/// @brief Method CalculateLayoutInputHorizontal addr 0x2c304ec size 0x4 virtual true final false
 void CalculateLayoutInputHorizontal() ;

/// @brief Method CalculateLayoutInputVertical addr 0x2c304f0 size 0x4 virtual true final false
 void CalculateLayoutInputVertical() ;

/// @brief Method get_minWidth addr 0x2c304f4 size 0x8 virtual true final false
 float_t get_minWidth() ;

/// @brief Method set_minWidth addr 0x2c304fc size 0x74 virtual true final false
 void set_minWidth(float_t value) ;

/// @brief Method get_minHeight addr 0x2c30570 size 0x8 virtual true final false
 float_t get_minHeight() ;

/// @brief Method set_minHeight addr 0x2c30578 size 0x74 virtual true final false
 void set_minHeight(float_t value) ;

/// @brief Method get_preferredWidth addr 0x2c305ec size 0x8 virtual true final false
 float_t get_preferredWidth() ;

/// @brief Method set_preferredWidth addr 0x2c305f4 size 0x74 virtual true final false
 void set_preferredWidth(float_t value) ;

/// @brief Method get_preferredHeight addr 0x2c30668 size 0x8 virtual true final false
 float_t get_preferredHeight() ;

/// @brief Method set_preferredHeight addr 0x2c30670 size 0x74 virtual true final false
 void set_preferredHeight(float_t value) ;

/// @brief Method get_flexibleWidth addr 0x2c306e4 size 0x8 virtual true final false
 float_t get_flexibleWidth() ;

/// @brief Method set_flexibleWidth addr 0x2c306ec size 0x74 virtual true final false
 void set_flexibleWidth(float_t value) ;

/// @brief Method get_flexibleHeight addr 0x2c30760 size 0x8 virtual true final false
 float_t get_flexibleHeight() ;

/// @brief Method set_flexibleHeight addr 0x2c30768 size 0x74 virtual true final false
 void set_flexibleHeight(float_t value) ;

/// @brief Method get_layoutPriority addr 0x2c307dc size 0x8 virtual true final false
 int32_t get_layoutPriority() ;

/// @brief Method set_layoutPriority addr 0x2c307e4 size 0x74 virtual true final false
 void set_layoutPriority(int32_t value) ;

// Ctor Parameters []
explicit LayoutElement() ;

/// @brief Method .ctor addr 0x2c30858 size 0x24 virtual false final false
 void _ctor() ;

/// @brief Method OnEnable addr 0x2c3087c size 0x1c virtual true final false
 void OnEnable() ;

/// @brief Method OnTransformParentChanged addr 0x2c30898 size 0x4 virtual true final false
 void OnTransformParentChanged() ;

/// @brief Method OnDisable addr 0x2c3089c size 0x1c virtual true final false
 void OnDisable() ;

/// @brief Method OnDidApplyAnimationProperties addr 0x2c308b8 size 0x4 virtual true final false
 void OnDidApplyAnimationProperties() ;

/// @brief Method OnBeforeTransformParentChanged addr 0x2c308bc size 0x4 virtual true final false
 void OnBeforeTransformParentChanged() ;

/// @brief Method SetDirty addr 0x2c30434 size 0xb8 virtual false final false
 void SetDirty() ;
