...
/// @brief Method .ctor addr 0x2bb5f88 size 0xdc virtual false final false
 void _ctor(UnityEngine::GUIStyle style, UnityEngine::GUIContent content, ::ArrayW<UnityEngine::GUILayoutOption> options) ;

/// @brief Method CalcWidth addr 0x2bb60e8 size 0x84 virtual true final false
 void CalcWidth() ;

/// @brief Method CalcHeight addr 0x2bb616c size 0x70 virtual true final false
 void CalcHeight() ;
