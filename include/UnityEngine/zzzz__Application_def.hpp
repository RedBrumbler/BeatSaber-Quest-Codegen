...
/// @brief Method .ctor addr 0x2b9a748 size 0xbc virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x2b9a804 size 0x14 virtual true final false
 void Invoke() ;
...
/// @brief Method .ctor addr 0x2b9a818 size 0xd8 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x2b9a8f0 size 0x14 virtual true final false
...
/// @brief Method Quit addr 0x2b997a8 size 0x3c virtual false final false
static void Quit(int32_t exitCode) ;

/// @brief Method Quit addr 0x2b997e4 size 0x30 virtual false final false
static void Quit() ;

/// @brief Method CanStreamedLevelBeLoaded addr 0x2b99814 size 0x68 virtual false final false
static bool CanStreamedLevelBeLoaded(int32_t levelIndex) ;

/// @brief Method CanStreamedLevelBeLoaded addr 0x2b998dc size 0x3c virtual false final false
static bool CanStreamedLevelBeLoaded(::StringW levelName) ;

/// @brief Method get_isPlaying addr 0x2b99918 size 0x28 virtual false final false
static bool get_isPlaying() ;

/// @brief Method get_isFocused addr 0x2b99940 size 0x28 virtual false final false
static bool get_isFocused() ;

/// @brief Method get_runInBackground addr 0x2b99968 size 0x28 virtual false final false
static bool get_runInBackground() ;

/// @brief Method set_runInBackground addr 0x2b99990 size 0x3c virtual false final false
static void set_runInBackground(bool value) ;

/// @brief Method get_isBatchMode addr 0x2b999cc size 0x28 virtual false final false
static bool get_isBatchMode() ;

/// @brief Method get_dataPath addr 0x2b999f4 size 0x28 virtual false final false
static ::StringW get_dataPath() ;

/// @brief Method get_streamingAssetsPath addr 0x2b99a1c size 0x28 virtual false final false
static ::StringW get_streamingAssetsPath() ;

/// @brief Method get_persistentDataPath addr 0x2b99a44 size 0x28 virtual false final false
static ::StringW get_persistentDataPath() ;

/// @brief Method get_temporaryCachePath addr 0x2b99a6c size 0x28 virtual false final false
static ::StringW get_temporaryCachePath() ;

/// @brief Method get_unityVersion addr 0x2b99a94 size 0x28 virtual false final false
static ::StringW get_unityVersion() ;

/// @brief Method get_version addr 0x2b99abc size 0x28 virtual false final false
static ::StringW get_version() ;

/// @brief Method get_identifier addr 0x2b99ae4 size 0x28 virtual false final false
static ::StringW get_identifier() ;

/// @brief Method get_productName addr 0x2b99b0c size 0x28 virtual false final false
static ::StringW get_productName() ;

/// @brief Method get_companyName addr 0x2b99b34 size 0x28 virtual false final false
static ::StringW get_companyName() ;

/// @brief Method OpenURL addr 0x2b99b5c size 0x3c virtual false final false
static void OpenURL(::StringW url) ;

/// @brief Method set_targetFrameRate addr 0x2b99b98 size 0x3c virtual false final false
static void set_targetFrameRate(int32_t value) ;

/// @brief Method SetLogCallbackDefined addr 0x2b99bd4 size 0x3c virtual false final false
static void SetLogCallbackDefined(bool defined) ;

/// @brief Method set_backgroundLoadingPriority addr 0x2b99c10 size 0x3c virtual false final false
static void set_backgroundLoadingPriority(UnityEngine::ThreadPriority value) ;

/// @brief Method get_platform addr 0x2b99c4c size 0x28 virtual false final false
static UnityEngine::RuntimePlatform get_platform() ;

/// @brief Method get_isMobilePlatform addr 0x2b99c74 size 0x6c virtual false final false
static bool get_isMobilePlatform() ;

/// @brief Method get_systemLanguage addr 0x2b99ce0 size 0x28 virtual false final false
static UnityEngine::SystemLanguage get_systemLanguage() ;

/// @brief Method get_internetReachability addr 0x2b99d08 size 0x28 virtual false final false
static UnityEngine::NetworkReachability get_internetReachability() ;

/// @brief Method CallLowMemory addr 0x2b99d30 size 0x64 virtual false final false
static void CallLowMemory() ;

/// @brief Method add_logMessageReceived addr 0x2b99d94 size 0xcc virtual false final false
static void add_logMessageReceived(UnityEngine::UnityEngine__Application__LogCallback value) ;

/// @brief Method remove_logMessageReceived addr 0x2b99e60 size 0xa8 virtual false final false
static void remove_logMessageReceived(UnityEngine::UnityEngine__Application__LogCallback value) ;

/// @brief Method CallLogCallback addr 0x2b99f08 size 0xbc virtual false final false
static void CallLogCallback(::StringW logString, ::StringW stackTrace, UnityEngine::LogType type, bool invokedOnMainThread) ;

/// @brief Method add_onBeforeRender addr 0x2b99fc4 size 0x58 virtual false final false
static void add_onBeforeRender(UnityEngine::Events::UnityAction value) ;

/// @brief Method remove_onBeforeRender addr 0x2b9a01c size 0x58 virtual false final false
static void remove_onBeforeRender(UnityEngine::Events::UnityAction value) ;

/// @brief Method add_focusChanged addr 0x2b9a074 size 0xd0 virtual false final false
static void add_focusChanged(System::Action_1<bool> value) ;

/// @brief Method remove_focusChanged addr 0x2b9a144 size 0xd0 virtual false final false
static void remove_focusChanged(System::Action_1<bool> value) ;

/// @brief Method add_quitting addr 0x2b9a214 size 0xbc virtual false final false
static void add_quitting(System::Action value) ;

/// @brief Method remove_quitting addr 0x2b9a2d0 size 0xbc virtual false final false
static void remove_quitting(System::Action value) ;

/// @brief Method Internal_ApplicationWantsToQuit addr 0x2b9a38c size 0x1c4 virtual false final false
static bool Internal_ApplicationWantsToQuit() ;

/// @brief Method Internal_ApplicationQuit addr 0x2b9a550 size 0x64 virtual false final false
static void Internal_ApplicationQuit() ;

/// @brief Method Internal_ApplicationUnload addr 0x2b9a5b4 size 0x64 virtual false final false
static void Internal_ApplicationUnload() ;

/// @brief Method InvokeOnBeforeRender addr 0x2b9a618 size 0x50 virtual false final false
static void InvokeOnBeforeRender() ;

/// @brief Method InvokeFocusChanged addr 0x2b9a668 size 0x6c virtual false final false
static void InvokeFocusChanged(bool focus) ;

/// @brief Method InvokeDeepLinkActivated addr 0x2b9a6d4 size 0x6c virtual false final false
static void InvokeDeepLinkActivated(::StringW url) ;

/// @brief Method get_isEditor addr 0x2b9a740 size 0x8 virtual false final false
