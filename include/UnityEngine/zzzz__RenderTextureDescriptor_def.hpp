...
/// @brief Method get_width addr 0x2b72a18 size 0x8 virtual false final false
 int32_t get_width() ;

/// @brief Method set_width addr 0x2b72a20 size 0x8 virtual false final false
 void set_width(int32_t value) ;

/// @brief Method get_height addr 0x2b72a28 size 0x8 virtual false final false
 int32_t get_height() ;

/// @brief Method set_height addr 0x2b72a30 size 0x8 virtual false final false
 void set_height(int32_t value) ;

/// @brief Method get_msaaSamples addr 0x2b72a38 size 0x8 virtual false final false
 int32_t get_msaaSamples() ;

/// @brief Method set_msaaSamples addr 0x2b72a40 size 0x8 virtual false final false
 void set_msaaSamples(int32_t value) ;

/// @brief Method get_volumeDepth addr 0x2b72a48 size 0x8 virtual false final false
 int32_t get_volumeDepth() ;

/// @brief Method set_volumeDepth addr 0x2b72a50 size 0x8 virtual false final false
 void set_volumeDepth(int32_t value) ;

/// @brief Method set_mipCount addr 0x2b72a58 size 0x8 virtual false final false
 void set_mipCount(int32_t value) ;

/// @brief Method get_graphicsFormat addr 0x2b70724 size 0x8 virtual false final false
 UnityEngine::Experimental::Rendering::GraphicsFormat get_graphicsFormat() ;

/// @brief Method set_graphicsFormat addr 0x2b72a60 size 0x98 virtual false final false
 void set_graphicsFormat(UnityEngine::Experimental::Rendering::GraphicsFormat value) ;

/// @brief Method get_depthStencilFormat addr 0x2b72b94 size 0x8 virtual false final false
 UnityEngine::Experimental::Rendering::GraphicsFormat get_depthStencilFormat() ;

/// @brief Method set_depthStencilFormat addr 0x2b72b9c size 0x8 virtual false final false
 void set_depthStencilFormat(UnityEngine::Experimental::Rendering::GraphicsFormat value) ;

/// @brief Method get_colorFormat addr 0x2b72ba4 size 0x5c virtual false final false
 UnityEngine::RenderTextureFormat get_colorFormat() ;

/// @brief Method set_colorFormat addr 0x2b72c00 size 0xa8 virtual false final false
 void set_colorFormat(UnityEngine::RenderTextureFormat value) ;

/// @brief Method get_sRGB addr 0x2b72ca8 size 0x5c virtual false final false
 bool get_sRGB() ;

/// @brief Method set_sRGB addr 0x2b72d04 size 0x84 virtual false final false
 void set_sRGB(bool value) ;

/// @brief Method get_depthBufferBits addr 0x2b72b14 size 0x5c virtual false final false
 int32_t get_depthBufferBits() ;

/// @brief Method set_depthBufferBits addr 0x2b72b70 size 0x24 virtual false final false
 void set_depthBufferBits(int32_t value) ;

/// @brief Method get_dimension addr 0x2b72d88 size 0x8 virtual false final false
 UnityEngine::Rendering::TextureDimension get_dimension() ;

/// @brief Method set_dimension addr 0x2b72d90 size 0x8 virtual false final false
 void set_dimension(UnityEngine::Rendering::TextureDimension value) ;

/// @brief Method get_shadowSamplingMode addr 0x2b72d98 size 0x8 virtual false final false
 UnityEngine::Rendering::ShadowSamplingMode get_shadowSamplingMode() ;

/// @brief Method set_shadowSamplingMode addr 0x2b72da0 size 0x8 virtual false final false
 void set_shadowSamplingMode(UnityEngine::Rendering::ShadowSamplingMode value) ;

/// @brief Method set_vrUsage addr 0x2b72da8 size 0x8 virtual false final false
 void set_vrUsage(UnityEngine::VRTextureUsage value) ;

/// @brief Method set_memoryless addr 0x2b72db0 size 0x8 virtual false final false
 void set_memoryless(UnityEngine::RenderTextureMemoryless value) ;

/// @brief Method .ctor addr 0x2b72db8 size 0x90 virtual false final false
 void _ctor(int32_t width, int32_t height, UnityEngine::RenderTextureFormat colorFormat, int32_t depthBufferBits) ;

/// @brief Method .ctor addr 0x2b72e48 size 0xfc virtual false final false
...
/// @brief Method .ctor addr 0x2b72f44 size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x2b70880 size 0xbc virtual false final false
...
/// @brief Method .ctor addr 0x2b72fb8 size 0x5c virtual false final false
...
/// @brief Method SetOrClearRenderTextureCreationFlag addr 0x2b72af8 size 0x1c virtual false final false
 void SetOrClearRenderTextureCreationFlag(bool value, UnityEngine::RenderTextureCreationFlags flag) ;

/// @brief Method set_useMipMap addr 0x2b73014 size 0x1c virtual false final false
 void set_useMipMap(bool value) ;

/// @brief Method set_autoGenerateMips addr 0x2b73030 size 0x1c virtual false final false
 void set_autoGenerateMips(bool value) ;

/// @brief Method set_enableRandomWrite addr 0x2b7304c size 0x1c virtual false final false
 void set_enableRandomWrite(bool value) ;

/// @brief Method set_createdFromScript addr 0x2b707ac size 0x1c virtual false final false
 void set_createdFromScript(bool value) ;

/// @brief Method set_useDynamicScale addr 0x2b7093c size 0x1c virtual false final false
