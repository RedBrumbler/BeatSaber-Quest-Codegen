...
//  Writing Method size for method: UnityEngine::UnityEngine__GUIClip__ParentClipScope._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UnityEngine__GUIClip__ParentClipScope::*)(UnityEngine::Matrix4x4, UnityEngine::Rect)>(&UnityEngine::UnityEngine__GUIClip__ParentClipScope::_ctor)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x2bb8408;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UnityEngine__GUIClip__ParentClipScope>::get(),
                            ".ctor",
...
//  Writing Method size for method: UnityEngine::UnityEngine__GUIClip__ParentClipScope.Dispose
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (UnityEngine::UnityEngine__GUIClip__ParentClipScope::*)()>(&UnityEngine::UnityEngine__GUIClip__ParentClipScope::Dispose)> {
  constexpr static std::size_t size = 0x40;
  constexpr static std::size_t addrs = 0x2bb845c;
...
constexpr  UnityEngine::UnityEngine__GUIClip__ParentClipScope::operator System::IDisposable() const {
...
constexpr UnityEngine::UnityEngine__GUIClip__ParentClipScope::UnityEngine__GUIClip__ParentClipScope(bool m_Disposed) noexcept : ::bs_hook::ValueTypeWrapper() {this->m_Disposed = m_Disposed;
}
constexpr void UnityEngine::UnityEngine__GUIClip__ParentClipScope::__set_m_Disposed(bool value)  {
::cordl_internals::setInstanceField<bool, 0x0>(this->__instance, std::forward<bool>(value));
}
constexpr bool UnityEngine::UnityEngine__GUIClip__ParentClipScope::__get_m_Disposed() const {
return ::cordl_internals::getInstanceField<bool, 0x0>(this->__instance);
}
 void UnityEngine::UnityEngine__GUIClip__ParentClipScope::_ctor(UnityEngine::Matrix4x4 objectTransform, UnityEngine::Rect clipRect)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UnityEngine__GUIClip__ParentClipScope>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(reinterpret_cast<const void*>(__instance.data())), ___internal_method, objectTransform, clipRect);
 ...
 void UnityEngine::UnityEngine__GUIClip__ParentClipScope::Dispose()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::UnityEngine__GUIClip__ParentClipScope>::get(),
                            "Dispose",
                            std::vector<Il2CppClass*>{},
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Rect (*)()>(&UnityEngine::GUIClip::get_visibleRect)> {
  ...
  constexpr static std::size_t addrs = 0x2bb7118;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&UnityEngine::GUIClip::Internal_Pop)> {
  ...
  constexpr static std::size_t addrs = 0x2bb8228;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (*)()>(&UnityEngine::GUIClip::Internal_GetCount)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x2bb8250;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Matrix4x4 (*)()>(&UnityEngine::GUIClip::GetMatrix)> {
  ...
  constexpr static std::size_t addrs = 0x2bb6868;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(UnityEngine::Matrix4x4)>(&UnityEngine::GUIClip::SetMatrix)> {
  ...
  constexpr static std::size_t addrs = 0x2bb6918;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(UnityEngine::Matrix4x4, UnityEngine::Rect)>(&UnityEngine::GUIClip::Internal_PushParentClip)> {
  constexpr static std::size_t size = 0x40;
  constexpr static std::size_t addrs = 0x2bb82f0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(UnityEngine::Matrix4x4, UnityEngine::Matrix4x4, UnityEngine::Rect)>(&UnityEngine::GUIClip::Internal_PushParentClip)> {
  ...
  constexpr static std::size_t addrs = 0x2bb8330;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)()>(&UnityEngine::GUIClip::Internal_PopParentClip)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x2bb83e0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(ByRef<UnityEngine::Rect>)>(&UnityEngine::GUIClip::get_visibleRect_Injected)> {
  constexpr static std::size_t size = 0x3c;
  constexpr static std::size_t addrs = 0x2bb81ec;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(ByRef<UnityEngine::Matrix4x4>)>(&UnityEngine::GUIClip::GetMatrix_Injected)> {
  constexpr static std::size_t size = 0x3c;
  constexpr static std::size_t addrs = 0x2bb8278;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(ByRef<UnityEngine::Matrix4x4>)>(&UnityEngine::GUIClip::SetMatrix_Injected)> {
  constexpr static std::size_t size = 0x3c;
  constexpr static std::size_t addrs = 0x2bb82b4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(ByRef<UnityEngine::Matrix4x4>, ByRef<UnityEngine::Matrix4x4>, ByRef<UnityEngine::Rect>)>(&UnityEngine::GUIClip::Internal_PushParentClip_Injected)> {
  constexpr static std::size_t size = 0x54;
  constexpr static std::size_t addrs = 0x2bb838c;
