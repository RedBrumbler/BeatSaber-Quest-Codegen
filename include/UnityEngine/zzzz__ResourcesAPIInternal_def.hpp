...
/// @brief Method FindObjectsOfTypeAll addr 0x2b98bb8 size 0x3c virtual false final false
static ::ArrayW<UnityEngine::Object> FindObjectsOfTypeAll(System::Type type) ;

/// @brief Method FindShaderByName addr 0x2b98bf4 size 0x3c virtual false final false
static UnityEngine::Shader FindShaderByName(::StringW name) ;

/// @brief Method Load addr 0x2b98c30 size 0x44 virtual false final false
static UnityEngine::Object Load(::StringW path, System::Type systemTypeInstance) ;

/// @brief Method LoadAll addr 0x2b98c74 size 0x44 virtual false final false
static ::ArrayW<UnityEngine::Object> LoadAll(::StringW path, System::Type systemTypeInstance) ;

/// @brief Method LoadAsyncInternal addr 0x2b98cb8 size 0x44 virtual false final false
static UnityEngine::ResourceRequest LoadAsyncInternal(::StringW path, System::Type type) ;

/// @brief Method UnloadAsset addr 0x2b98cfc size 0x3c virtual false final false
