...
/// @brief Method Release addr 0x2d6995c size 0x3c virtual false final false
 void Release() ;

/// @brief Method ValidateCertificate addr 0x2d69998 size 0x8 virtual true final false
 bool ValidateCertificate(::ArrayW<uint8_t> certificateData) ;

/// @brief Method ValidateCertificateNative addr 0x2d699a0 size 0xc virtual false final false
 bool ValidateCertificateNative(::ArrayW<uint8_t> certificateData) ;

/// @brief Method Dispose addr 0x2d67eb8 size 0x94 virtual true final true
 void Dispose() ;
