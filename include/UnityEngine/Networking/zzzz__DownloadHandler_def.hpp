...
/// @brief Method Release addr 0x2d68fdc size 0x3c virtual false final false
 void Release() ;

// Ctor Parameters []
explicit DownloadHandler() ;

/// @brief Method .ctor addr 0x2d69018 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Finalize addr 0x2d69020 size 0x9c virtual true final false
 void Finalize() ;

/// @brief Method Dispose addr 0x2d690bc size 0x94 virtual true final false
 void Dispose() ;

/// @brief Method get_error addr 0x2d69150 size 0x3c virtual false final false
 ::StringW get_error() ;

/// @brief Method GetErrorMsg addr 0x2d6918c size 0x3c virtual false final false
 ::StringW GetErrorMsg() ;

/// @brief Method get_text addr 0x2d691c8 size 0xc virtual false final false
 ::StringW get_text() ;

/// @brief Method GetNativeData addr 0x2d691d4 size 0xc virtual true final false
 Unity::Collections::NativeArray_1<uint8_t> GetNativeData() ;

/// @brief Method GetData addr 0x2d691e0 size 0x4 virtual true final false
 ::ArrayW<uint8_t> GetData() ;

/// @brief Method GetText addr 0x2d69288 size 0xe8 virtual true final false
 ::StringW GetText() ;

/// @brief Method GetTextEncoder addr 0x2d69370 size 0x270 virtual false final false
 System::Text::Encoding GetTextEncoder() ;

/// @brief Method GetContentType addr 0x2d695e0 size 0x3c virtual false final false
 ::StringW GetContentType() ;

/// @brief Method ReceiveContentLengthHeader addr 0x2d6961c size 0xc virtual true final false
 void ReceiveContentLengthHeader(uint64_t contentLength) ;

/// @brief Method ReceiveContentLength addr 0x2d69628 size 0x4 virtual true final false
...
/// @brief Method InternalGetByteArray addr 0x2d6962c size 0x44 virtual false final false
static void* InternalGetByteArray(UnityEngine::Networking::DownloadHandler dh, ByRef<int32_t> length) ;

/// @brief Method InternalGetByteArray addr 0x2d691e4 size 0xa4 virtual false final false
static ::ArrayW<uint8_t> InternalGetByteArray(UnityEngine::Networking::DownloadHandler dh) ;

/// @brief Method InternalGetNativeArray addr 0x2d69670 size 0xbc virtual false final false
...
/// @brief Method DisposeNativeArray addr 0x2d6972c size 0x54 virtual false final false
static void DisposeNativeArray(ByRef<Unity::Collections::NativeArray_1<uint8_t>> data) ;

/// @brief Method CreateNativeArrayForNativeData addr 0x2d69780 size 0x68 virtual false final false
