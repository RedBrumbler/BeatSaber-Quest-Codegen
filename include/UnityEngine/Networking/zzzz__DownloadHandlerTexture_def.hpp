...
/// @brief Method Create addr 0x2d69ad4 size 0x44 virtual false final false
static ::cordl_internals::intptr_t Create(UnityEngine::Networking::DownloadHandlerTexture obj, bool readable) ;

/// @brief Method InternalCreateTexture addr 0x2d69b18 size 0x4c virtual false final false
...
/// @brief Method .ctor addr 0x2d69a74 size 0x60 virtual false final false
 void _ctor(bool readable) ;

/// @brief Method GetNativeData addr 0x2d69b64 size 0xc virtual true final false
 Unity::Collections::NativeArray_1<uint8_t> GetNativeData() ;

/// @brief Method Dispose addr 0x2d69b70 size 0x24 virtual true final false
 void Dispose() ;

/// @brief Method get_texture addr 0x2d69b94 size 0x4 virtual false final false
 UnityEngine::Texture2D get_texture() ;

/// @brief Method InternalGetTexture addr 0x2d69b98 size 0x110 virtual false final false
 UnityEngine::Texture2D InternalGetTexture() ;

/// @brief Method InternalGetTextureNative addr 0x2d69ca8 size 0x3c virtual false final false
 UnityEngine::Texture2D InternalGetTextureNative() ;

/// @brief Method GetContent addr 0x2d69ce4 size 0x54 virtual false final false
