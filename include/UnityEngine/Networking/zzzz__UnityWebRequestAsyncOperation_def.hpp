...
namespace UnityEngine::Networking {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10162))}
...
/// @brief Method get_webRequest addr 0x2d67630 size 0x8 virtual false final false
 UnityEngine::Networking::UnityWebRequest get_webRequest() ;

/// @brief Method set_webRequest addr 0x2d67638 size 0x8 virtual false final false
 void set_webRequest(UnityEngine::Networking::UnityWebRequest value) ;

// Ctor Parameters []
explicit UnityWebRequestAsyncOperation() ;

/// @brief Method .ctor addr 0x2d67640 size 0x8 virtual false final false
 void _ctor() ;
