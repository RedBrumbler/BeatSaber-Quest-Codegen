...
/// @brief Method Create addr 0x2d697e8 size 0x3c virtual false final false
static ::cordl_internals::intptr_t Create(UnityEngine::Networking::DownloadHandlerBuffer obj) ;

/// @brief Method InternalCreateBuffer addr 0x2d69824 size 0x44 virtual false final false
 void InternalCreateBuffer() ;

// Ctor Parameters []
explicit DownloadHandlerBuffer() ;

/// @brief Method .ctor addr 0x2d68e98 size 0x4c virtual false final false
 void _ctor() ;

/// @brief Method GetNativeData addr 0x2d69868 size 0x8 virtual true final false
 Unity::Collections::NativeArray_1<uint8_t> GetNativeData() ;

/// @brief Method Dispose addr 0x2d69870 size 0x1c virtual true final false
 void Dispose() ;
