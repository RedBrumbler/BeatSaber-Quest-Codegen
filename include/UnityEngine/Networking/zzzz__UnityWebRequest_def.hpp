...
/// @brief Method GetWebErrorString addr 0x2d67648 size 0x3c virtual false final false
...
/// @brief Method GetHTTPStatusString addr 0x2d67684 size 0x3c virtual false final false
static ::StringW GetHTTPStatusString(int64_t responseCode) ;

/// @brief Method get_disposeCertificateHandlerOnDispose addr 0x2d676c0 size 0x8 virtual false final false
 bool get_disposeCertificateHandlerOnDispose() ;

/// @brief Method set_disposeCertificateHandlerOnDispose addr 0x2d676c8 size 0xc virtual false final false
 void set_disposeCertificateHandlerOnDispose(bool value) ;

/// @brief Method get_disposeDownloadHandlerOnDispose addr 0x2d676d4 size 0x8 virtual false final false
 bool get_disposeDownloadHandlerOnDispose() ;

/// @brief Method set_disposeDownloadHandlerOnDispose addr 0x2d676dc size 0xc virtual false final false
 void set_disposeDownloadHandlerOnDispose(bool value) ;

/// @brief Method get_disposeUploadHandlerOnDispose addr 0x2d676e8 size 0x8 virtual false final false
 bool get_disposeUploadHandlerOnDispose() ;

/// @brief Method set_disposeUploadHandlerOnDispose addr 0x2d676f0 size 0xc virtual false final false
 void set_disposeUploadHandlerOnDispose(bool value) ;

/// @brief Method Create addr 0x2d676fc size 0x28 virtual false final false
static ::cordl_internals::intptr_t Create() ;

/// @brief Method Release addr 0x2d67724 size 0x3c virtual false final false
 void Release() ;

/// @brief Method InternalDestroy addr 0x2d67760 size 0xbc virtual false final false
 void InternalDestroy() ;

/// @brief Method InternalSetDefaults addr 0x2d67858 size 0x14 virtual false final false
...
/// @brief Method .ctor addr 0x2d6786c size 0xa4 virtual false final false
...
/// @brief Method Finalize addr 0x2d67d3c size 0x9c virtual true final false
 void Finalize() ;

/// @brief Method Dispose addr 0x2d67e38 size 0x68 virtual true final true
 void Dispose() ;

/// @brief Method DisposeHandlers addr 0x2d67dd8 size 0x60 virtual false final false
 void DisposeHandlers() ;

/// @brief Method BeginWebRequest addr 0x2d67f4c size 0x3c virtual false final false
 UnityEngine::Networking::UnityWebRequestAsyncOperation BeginWebRequest() ;

/// @brief Method SendWebRequest addr 0x2d67f88 size 0x48 virtual false final false
 UnityEngine::Networking::UnityWebRequestAsyncOperation SendWebRequest() ;

/// @brief Method Abort addr 0x2d6781c size 0x3c virtual false final false
 void Abort() ;

/// @brief Method SetMethod addr 0x2d67fd0 size 0x44 virtual false final false
...
/// @brief Method InternalSetMethod addr 0x2d68014 size 0x10c virtual false final false
 void InternalSetMethod(UnityEngine::Networking::UnityEngine__Networking__UnityWebRequest__UnityWebRequestMethod methodType) ;

/// @brief Method SetCustomMethod addr 0x2d6815c size 0x44 virtual false final false
...
/// @brief Method InternalSetCustomMethod addr 0x2d681a0 size 0x10c virtual false final false
 void InternalSetCustomMethod(::StringW customMethodName) ;

/// @brief Method GetMethod addr 0x2d682ac size 0x3c virtual false final false
 UnityEngine::Networking::UnityEngine__Networking__UnityWebRequest__UnityWebRequestMethod GetMethod() ;

/// @brief Method GetCustomMethod addr 0x2d682e8 size 0x3c virtual false final false
 ::StringW GetCustomMethod() ;

/// @brief Method get_method addr 0x2d68324 size 0x108 virtual false final false
 ::StringW get_method() ;

/// @brief Method set_method addr 0x2d67998 size 0x184 virtual false final false
 void set_method(::StringW value) ;

/// @brief Method GetError addr 0x2d6842c size 0x3c virtual false final false
 UnityEngine::Networking::UnityEngine__Networking__UnityWebRequest__UnityWebRequestError GetError() ;

/// @brief Method get_error addr 0x2d68468 size 0x1a4 virtual false final false
 ::StringW get_error() ;

/// @brief Method get_url addr 0x2d68684 size 0x3c virtual false final false
 ::StringW get_url() ;

/// @brief Method set_url addr 0x2d67910 size 0x88 virtual false final false
 void set_url(::StringW value) ;

/// @brief Method GetUrl addr 0x2d686c0 size 0x3c virtual false final false
 ::StringW GetUrl() ;

/// @brief Method SetUrl addr 0x2d68808 size 0x44 virtual false final false
 UnityEngine::Networking::UnityEngine__Networking__UnityWebRequest__UnityWebRequestError SetUrl(::StringW url) ;

/// @brief Method InternalSetUrl addr 0x2d686fc size 0x10c virtual false final false
 void InternalSetUrl(::StringW url) ;

/// @brief Method get_responseCode addr 0x2d68648 size 0x3c virtual false final false
 int64_t get_responseCode() ;

/// @brief Method IsExecuting addr 0x2d6884c size 0x3c virtual false final false
 bool IsExecuting() ;

/// @brief Method get_isModifiable addr 0x2d68120 size 0x3c virtual false final false
 bool get_isModifiable() ;

/// @brief Method get_isDone addr 0x2d68888 size 0x48 virtual false final false
 bool get_isDone() ;

/// @brief Method get_result addr 0x2d6860c size 0x3c virtual false final false
 UnityEngine::Networking::UnityEngine__Networking__UnityWebRequest__Result get_result() ;

/// @brief Method GetDownloadProgress addr 0x2d688d0 size 0x3c virtual false final false
 float_t GetDownloadProgress() ;

/// @brief Method get_downloadProgress addr 0x2d6890c size 0xa4 virtual false final false
 float_t get_downloadProgress() ;

/// @brief Method get_downloadedBytes addr 0x2d689b0 size 0x3c virtual false final false
 uint64_t get_downloadedBytes() ;

/// @brief Method SetRedirectLimitFromScripting addr 0x2d689ec size 0x44 virtual false final false
 void SetRedirectLimitFromScripting(int32_t limit) ;

/// @brief Method set_redirectLimit addr 0x2d68a30 size 0x44 virtual false final false
 void set_redirectLimit(int32_t value) ;

/// @brief Method SetUploadHandler addr 0x2d68a74 size 0x44 virtual false final false
...
/// @brief Method get_uploadHandler addr 0x2d67ea8 size 0x8 virtual false final false
 UnityEngine::Networking::UploadHandler get_uploadHandler() ;

/// @brief Method set_uploadHandler addr 0x2d67c2c size 0x110 virtual false final false
 void set_uploadHandler(UnityEngine::Networking::UploadHandler value) ;

/// @brief Method SetDownloadHandler addr 0x2d68ab8 size 0x44 virtual false final false
...
/// @brief Method get_downloadHandler addr 0x2d67ea0 size 0x8 virtual false final false
 UnityEngine::Networking::DownloadHandler get_downloadHandler() ;

/// @brief Method set_downloadHandler addr 0x2d67b1c size 0x110 virtual false final false
 void set_downloadHandler(UnityEngine::Networking::DownloadHandler value) ;

/// @brief Method SetCertificateHandler addr 0x2d68afc size 0x44 virtual false final false
...
/// @brief Method get_certificateHandler addr 0x2d67eb0 size 0x8 virtual false final false
 UnityEngine::Networking::CertificateHandler get_certificateHandler() ;

/// @brief Method set_certificateHandler addr 0x2d68b40 size 0x110 virtual false final false
 void set_certificateHandler(UnityEngine::Networking::CertificateHandler value) ;

/// @brief Method SetTimeoutMsec addr 0x2d68c50 size 0x44 virtual false final false
 UnityEngine::Networking::UnityEngine__Networking__UnityWebRequest__UnityWebRequestError SetTimeoutMsec(int32_t timeout) ;

/// @brief Method set_timeout addr 0x2d68c94 size 0x15c virtual false final false
 void set_timeout(int32_t value) ;

/// @brief Method Get addr 0x2d68df0 size 0xa8 virtual false final false
static UnityEngine::Networking::UnityWebRequest Get(::StringW uri) ;

/// @brief Method EscapeURL addr 0x2d68ee4 size 0x20 virtual false final false
static ::StringW EscapeURL(::StringW s) ;

/// @brief Method EscapeURL addr 0x2d68f04 size 0xd8 virtual false final false
