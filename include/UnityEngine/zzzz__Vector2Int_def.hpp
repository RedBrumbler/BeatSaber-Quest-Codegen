...
/// @brief Method get_x addr 0x2b90580 size 0x8 virtual false final false
 int32_t get_x() ;

/// @brief Method set_x addr 0x2b90588 size 0x8 virtual false final false
 void set_x(int32_t value) ;

/// @brief Method get_y addr 0x2b90590 size 0x8 virtual false final false
 int32_t get_y() ;

/// @brief Method set_y addr 0x2b90598 size 0x8 virtual false final false
 void set_y(int32_t value) ;

/// @brief Method .ctor addr 0x2b905a0 size 0x8 virtual false final false
 void _ctor(int32_t x, int32_t y) ;

/// @brief Method op_Implicit addr 0x2b905a8 size 0x10 virtual false final false
static UnityEngine::Vector2 op_Implicit_UnityEngine__Vector2(UnityEngine::Vector2Int v) ;

/// @brief Method FloorToInt addr 0x2b905b8 size 0xf8 virtual false final false
static UnityEngine::Vector2Int FloorToInt(UnityEngine::Vector2 v) ;

/// @brief Method op_Equality addr 0x2b906b0 size 0x20 virtual false final false
static bool op_Equality(UnityEngine::Vector2Int lhs, UnityEngine::Vector2Int rhs) ;

/// @brief Method Equals addr 0x2b906d0 size 0x88 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method Equals addr 0x2b90758 size 0x28 virtual true final true
 bool Equals(UnityEngine::Vector2Int other) ;

/// @brief Method GetHashCode addr 0x2b90780 size 0x48 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2b907c8 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x2b907d4 size 0x17c virtual true final true
