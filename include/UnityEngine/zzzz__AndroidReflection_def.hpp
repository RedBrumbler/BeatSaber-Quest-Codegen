...
/// @brief Method IsPrimitive addr 0x2b43cc0 size 0x14 virtual false final false
static bool IsPrimitive(System::Type t) ;

/// @brief Method IsAssignableFrom addr 0x2b43cd4 size 0x20 virtual false final false
static bool IsAssignableFrom(System::Type t, System::Type from) ;

/// @brief Method GetStaticMethodID addr 0x2b43cf4 size 0x9c virtual false final false
static ::cordl_internals::intptr_t GetStaticMethodID(::StringW clazz, ::StringW methodName, ::StringW signature) ;

/// @brief Method GetMethodID addr 0x2b43d90 size 0x9c virtual false final false
static ::cordl_internals::intptr_t GetMethodID(::StringW clazz, ::StringW methodName, ::StringW signature) ;

/// @brief Method GetConstructorMember addr 0x2b43e2c size 0x18c virtual false final false
static ::cordl_internals::intptr_t GetConstructorMember(::cordl_internals::intptr_t jclass, ::StringW signature) ;

/// @brief Method GetMethodMember addr 0x2b43fb8 size 0x200 virtual false final false
...
/// @brief Method GetFieldMember addr 0x2b441b8 size 0x200 virtual false final false
...
/// @brief Method GetFieldClass addr 0x2b443b8 size 0x64 virtual false final false
static ::cordl_internals::intptr_t GetFieldClass(::cordl_internals::intptr_t field) ;

/// @brief Method GetFieldSignature addr 0x2b4441c size 0xa8 virtual false final false
static ::StringW GetFieldSignature(::cordl_internals::intptr_t field) ;

/// @brief Method NewProxyInstance addr 0x2b444c4 size 0xd0 virtual false final false
...
/// @brief Method SetNativeExceptionOnProxy addr 0x2b418a0 size 0x10c virtual false final false
