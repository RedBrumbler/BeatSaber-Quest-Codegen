...
/// @brief Method DontStripMeshRenderer addr 0x2b606ec size 0x4 virtual false final false
 void DontStripMeshRenderer() ;

/// @brief Method get_additionalVertexStreams addr 0x2b606f0 size 0x3c virtual false final false
 UnityEngine::Mesh get_additionalVertexStreams() ;

// Ctor Parameters []
explicit MeshRenderer() ;

/// @brief Method .ctor addr 0x2b6072c size 0x8 virtual false final false
 void _ctor() ;
