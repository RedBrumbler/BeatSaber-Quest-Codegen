...
/// @brief Method get_shadows addr 0x2b5eca0 size 0x3c virtual false final false
 UnityEngine::LightShadows get_shadows() ;

/// @brief Method get_cookieSize addr 0x2b5ecdc size 0x3c virtual false final false
 float_t get_cookieSize() ;

/// @brief Method get_cookie addr 0x2b5ed18 size 0x3c virtual false final false
 UnityEngine::Texture get_cookie() ;

/// @brief Method get_type addr 0x2b5ed54 size 0x3c virtual false final false
 UnityEngine::LightType get_type() ;

/// @brief Method get_spotAngle addr 0x2b5ed90 size 0x3c virtual false final false
 float_t get_spotAngle() ;

/// @brief Method get_color addr 0x2b5edcc size 0x58 virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method set_color addr 0x2b5ee68 size 0x54 virtual false final false
 void set_color(UnityEngine::Color value) ;

/// @brief Method get_colorTemperature addr 0x2b5ef00 size 0x3c virtual false final false
 float_t get_colorTemperature() ;

/// @brief Method get_useColorTemperature addr 0x2b5ef3c size 0x3c virtual false final false
 bool get_useColorTemperature() ;

/// @brief Method get_intensity addr 0x2b5ef78 size 0x3c virtual false final false
 float_t get_intensity() ;

/// @brief Method set_intensity addr 0x2b5efb4 size 0x4c virtual false final false
 void set_intensity(float_t value) ;

/// @brief Method get_bounceIntensity addr 0x2b5f000 size 0x3c virtual false final false
 float_t get_bounceIntensity() ;

/// @brief Method get_range addr 0x2b5f03c size 0x3c virtual false final false
 float_t get_range() ;

/// @brief Method get_bakingOutput addr 0x2b5f078 size 0x68 virtual false final false
 UnityEngine::LightBakingOutput get_bakingOutput() ;

/// @brief Method get_color_Injected addr 0x2b5ee24 size 0x44 virtual false final false
 void get_color_Injected(ByRef<UnityEngine::Color> ret) ;

/// @brief Method set_color_Injected addr 0x2b5eebc size 0x44 virtual false final false
 void set_color_Injected(ByRef<UnityEngine::Color> value) ;

/// @brief Method get_bakingOutput_Injected addr 0x2b5f0e0 size 0x44 virtual false final false
