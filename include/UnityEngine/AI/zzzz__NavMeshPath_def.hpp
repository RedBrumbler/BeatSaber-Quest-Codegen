...
/// @brief Method .ctor addr 0x2b3998c size 0x48 virtual false final false
 void _ctor() ;

/// @brief Method Finalize addr 0x2b399fc size 0xf4 virtual true final false
 void Finalize() ;

/// @brief Method InitializeNavMeshPath addr 0x2b399d4 size 0x28 virtual false final false
static ::cordl_internals::intptr_t InitializeNavMeshPath() ;

/// @brief Method DestroyNavMeshPath addr 0x2b39af0 size 0x3c virtual false final false
static void DestroyNavMeshPath(::cordl_internals::intptr_t ptr) ;

/// @brief Method CalculateCornersInternal addr 0x2b39b2c size 0x3c virtual false final false
 ::ArrayW<UnityEngine::Vector3> CalculateCornersInternal() ;

/// @brief Method ClearCornersInternal addr 0x2b39b68 size 0x3c virtual false final false
 void ClearCornersInternal() ;

/// @brief Method ClearCorners addr 0x2b39ba4 size 0x44 virtual false final false
 void ClearCorners() ;

/// @brief Method CalculateCorners addr 0x2b39be8 size 0x4c virtual false final false
 void CalculateCorners() ;

/// @brief Method get_corners addr 0x2b39c34 size 0x4c virtual false final false
 ::ArrayW<UnityEngine::Vector3> get_corners() ;

/// @brief Method get_status addr 0x2b39c80 size 0x3c virtual false final false
