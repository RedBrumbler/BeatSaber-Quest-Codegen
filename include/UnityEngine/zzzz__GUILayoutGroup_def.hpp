...
/// @brief Method get_marginLeft addr 0x2bc3d30 size 0x8 virtual true final false
 int32_t get_marginLeft() ;

/// @brief Method get_marginRight addr 0x2bc3d38 size 0x8 virtual true final false
 int32_t get_marginRight() ;

/// @brief Method get_marginTop addr 0x2bc3d40 size 0x8 virtual true final false
 int32_t get_marginTop() ;

/// @brief Method get_marginBottom addr 0x2bc3d48 size 0x8 virtual true final false
 int32_t get_marginBottom() ;

// Ctor Parameters []
explicit GUILayoutGroup() ;

/// @brief Method .ctor addr 0x2bbbf74 size 0x118 virtual false final false
 void _ctor() ;

/// @brief Method ApplyOptions addr 0x2bc3d50 size 0x120 virtual true final false
 void ApplyOptions(::ArrayW<UnityEngine::GUILayoutOption> options) ;

/// @brief Method ApplyStyleSettings addr 0x2bc3e70 size 0x78 virtual true final false
 void ApplyStyleSettings(UnityEngine::GUIStyle style) ;

/// @brief Method ResetCursor addr 0x2bbc910 size 0x8 virtual false final false
 void ResetCursor() ;

/// @brief Method GetNext addr 0x2bbcd64 size 0x378 virtual false final false
 UnityEngine::GUILayoutEntry GetNext() ;

/// @brief Method Add addr 0x2bbccbc size 0xa8 virtual false final false
 void Add(UnityEngine::GUILayoutEntry e) ;

/// @brief Method CalcWidth addr 0x2bc3ee8 size 0x630 virtual true final false
 void CalcWidth() ;

/// @brief Method SetHorizontal addr 0x2bc4518 size 0x814 virtual true final false
 void SetHorizontal(float_t x, float_t width) ;

/// @brief Method CalcHeight addr 0x2bc4d2c size 0x580 virtual true final false
 void CalcHeight() ;

/// @brief Method SetVertical addr 0x2bc52ac size 0x820 virtual true final false
 void SetVertical(float_t y, float_t height) ;

/// @brief Method ToString addr 0x2bc5acc size 0x420 virtual true final false
 ::StringW ToString() ;
