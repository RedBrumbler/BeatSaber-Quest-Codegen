...
/// @brief Method get_style addr 0x2bb5214 size 0x8 virtual false final false
 UnityEngine::GUIStyle get_style() ;

/// @brief Method set_style addr 0x2bb521c size 0x10 virtual false final false
 void set_style(UnityEngine::GUIStyle value) ;

/// @brief Method get_marginLeft addr 0x2bb522c size 0x28 virtual true final false
 int32_t get_marginLeft() ;

/// @brief Method get_marginRight addr 0x2bb5254 size 0x28 virtual true final false
 int32_t get_marginRight() ;

/// @brief Method get_marginTop addr 0x2bb527c size 0x28 virtual true final false
 int32_t get_marginTop() ;

/// @brief Method get_marginBottom addr 0x2bb52a4 size 0x28 virtual true final false
 int32_t get_marginBottom() ;

/// @brief Method get_marginHorizontal addr 0x2bb52cc size 0x3c virtual false final false
 int32_t get_marginHorizontal() ;

/// @brief Method get_marginVertical addr 0x2bb5308 size 0x3c virtual false final false
...
/// @brief Method .ctor addr 0x2bb5344 size 0x10c virtual false final false
...
/// @brief Method .ctor addr 0x2bb5450 size 0x108 virtual false final false
...
/// @brief Method CalcWidth addr 0x2bb5558 size 0x4 virtual true final false
 void CalcWidth() ;

/// @brief Method CalcHeight addr 0x2bb555c size 0x4 virtual true final false
 void CalcHeight() ;

/// @brief Method SetHorizontal addr 0x2bb5560 size 0x34 virtual true final false
 void SetHorizontal(float_t x, float_t width) ;

/// @brief Method SetVertical addr 0x2bb5594 size 0x34 virtual true final false
 void SetVertical(float_t y, float_t height) ;

/// @brief Method ApplyStyleSettings addr 0x2bb55c8 size 0x8c virtual true final false
 void ApplyStyleSettings(UnityEngine::GUIStyle style) ;

/// @brief Method ApplyOptions addr 0x2bb5654 size 0x2d4 virtual true final false
 void ApplyOptions(::ArrayW<UnityEngine::GUILayoutOption> options) ;

/// @brief Method ToString addr 0x2bb5928 size 0x5e0 virtual true final false
 ::StringW ToString() ;
