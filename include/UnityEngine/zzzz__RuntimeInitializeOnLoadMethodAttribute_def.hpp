...
namespace UnityEngine {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10272))}
...
/// @brief Method .ctor addr 0x2b88a10 size 0x1c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2b88a34 size 0x28 virtual false final false
 void _ctor(UnityEngine::RuntimeInitializeLoadType loadType) ;

/// @brief Method set_loadType addr 0x2b88a2c size 0x8 virtual false final false
