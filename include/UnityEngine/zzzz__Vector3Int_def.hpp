...
/// @brief Method get_x addr 0x2b92dcc size 0x8 virtual false final false
 int32_t get_x() ;

/// @brief Method set_x addr 0x2b92dd4 size 0x8 virtual false final false
 void set_x(int32_t value) ;

/// @brief Method get_y addr 0x2b92ddc size 0x8 virtual false final false
 int32_t get_y() ;

/// @brief Method set_y addr 0x2b92de4 size 0x8 virtual false final false
 void set_y(int32_t value) ;

/// @brief Method get_z addr 0x2b92dec size 0x8 virtual false final false
 int32_t get_z() ;

/// @brief Method set_z addr 0x2b92df4 size 0x8 virtual false final false
 void set_z(int32_t value) ;

/// @brief Method .ctor addr 0x2b92dfc size 0xc virtual false final false
 void _ctor(int32_t x, int32_t y, int32_t z) ;

/// @brief Method get_Item addr 0x2b92e08 size 0xf0 virtual false final false
 int32_t get_Item(int32_t index) ;

/// @brief Method Min addr 0x2b92ef8 size 0x2c virtual false final false
static UnityEngine::Vector3Int Min(UnityEngine::Vector3Int lhs, UnityEngine::Vector3Int rhs) ;

/// @brief Method Max addr 0x2b92f24 size 0x2c virtual false final false
static UnityEngine::Vector3Int Max(UnityEngine::Vector3Int lhs, UnityEngine::Vector3Int rhs) ;

/// @brief Method op_Implicit addr 0x2b92f50 size 0x14 virtual false final false
static UnityEngine::Vector3 op_Implicit_UnityEngine__Vector3(UnityEngine::Vector3Int v) ;

/// @brief Method op_Addition addr 0x2b92f64 size 0x1c virtual false final false
static UnityEngine::Vector3Int op_Addition(UnityEngine::Vector3Int a, UnityEngine::Vector3Int b) ;

/// @brief Method op_Equality addr 0x2b92f80 size 0x30 virtual false final false
static bool op_Equality(UnityEngine::Vector3Int lhs, UnityEngine::Vector3Int rhs) ;

/// @brief Method Equals addr 0x2b92fb0 size 0x9c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method Equals addr 0x2b9304c size 0x38 virtual true final true
 bool Equals(UnityEngine::Vector3Int other) ;

/// @brief Method GetHashCode addr 0x2b93084 size 0x78 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2b930fc size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x2b8667c size 0x1c4 virtual true final true
 ::StringW ToString(::StringW format, System::IFormatProvider formatProvider) ;

/// @brief Method get_one addr 0x2b93108 size 0x4c virtual false final false
