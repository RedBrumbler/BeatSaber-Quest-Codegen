...
/// @brief Method Move addr 0x2bd1e18 size 0x54 virtual false final false
 UnityEngine::CollisionFlags Move(UnityEngine::Vector3 motion) ;

/// @brief Method get_isGrounded addr 0x2bd1eb0 size 0x3c virtual false final false
 bool get_isGrounded() ;

/// @brief Method get_height addr 0x2bd1eec size 0x3c virtual false final false
 float_t get_height() ;

/// @brief Method get_center addr 0x2bd1f28 size 0x5c virtual false final false
 UnityEngine::Vector3 get_center() ;

/// @brief Method get_stepOffset addr 0x2bd1fc8 size 0x3c virtual false final false
 float_t get_stepOffset() ;

/// @brief Method Move_Injected addr 0x2bd1e6c size 0x44 virtual false final false
 UnityEngine::CollisionFlags Move_Injected(ByRef<UnityEngine::Vector3> motion) ;

/// @brief Method get_center_Injected addr 0x2bd1f84 size 0x44 virtual false final false
