...
/// @brief Method SetCursor addr 0x2b5e850 size 0x58 virtual false final false
static void SetCursor(UnityEngine::Texture2D texture, UnityEngine::Vector2 hotspot, UnityEngine::CursorMode cursorMode) ;

/// @brief Method set_visible addr 0x2b5e8fc size 0x3c virtual false final false
static void set_visible(bool value) ;

/// @brief Method get_lockState addr 0x2b5e938 size 0x28 virtual false final false
static UnityEngine::CursorLockMode get_lockState() ;

/// @brief Method set_lockState addr 0x2b5e960 size 0x3c virtual false final false
static void set_lockState(UnityEngine::CursorLockMode value) ;

/// @brief Method SetCursor_Injected addr 0x2b5e8a8 size 0x54 virtual false final false
