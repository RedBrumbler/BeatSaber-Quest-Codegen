...
namespace UnityEngine {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14346))}
...
/// @brief Method .ctor addr 0x28af848 size 0x28 virtual false final false
 void _ctor(::ArrayW<::StringW> allowedLabels) ;

/// @brief Method ValidateAsset addr 0x28af870 size 0x8 virtual true final false
 bool ValidateAsset(UnityEngine::Object obj) ;

/// @brief Method ValidateAsset addr 0x28af878 size 0x8 virtual true final false
 bool ValidateAsset(::StringW path) ;

/// @brief Method ToString addr 0x28af880 size 0xf4 virtual true final false
 ::StringW ToString() ;
