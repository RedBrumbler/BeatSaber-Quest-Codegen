...
/// @brief Method CaptureScreenshot addr 0x2bd2f60 size 0x44 virtual false final false
static void CaptureScreenshot(::StringW filename) ;

/// @brief Method CaptureScreenshot addr 0x2bd2fa4 size 0x54 virtual false final false
