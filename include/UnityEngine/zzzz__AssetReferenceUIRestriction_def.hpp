...
/// @brief Method ValidateAsset addr 0x28af830 size 0x8 virtual true final false
 bool ValidateAsset(UnityEngine::Object obj) ;

/// @brief Method ValidateAsset addr 0x28af838 size 0x8 virtual true final false
 bool ValidateAsset(::StringW path) ;

// Ctor Parameters []
explicit AssetReferenceUIRestriction() ;

/// @brief Method .ctor addr 0x28af840 size 0x8 virtual false final false
 void _ctor() ;
