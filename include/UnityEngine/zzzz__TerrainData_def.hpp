...
/// @brief Method GetBoundaryValue addr 0x2bd7814 size 0x3c virtual false final false
static int32_t GetBoundaryValue(UnityEngine::UnityEngine__TerrainData__BoundaryValueType type) ;

// Ctor Parameters []
explicit TerrainData() ;

/// @brief Method .ctor addr 0x2bd7850 size 0xa4 virtual false final false
 void _ctor() ;

/// @brief Method Internal_Create addr 0x2bd78f4 size 0x3c virtual false final false
static void Internal_Create(UnityEngine::TerrainData terrainData) ;

/// @brief Method get_heightmapResolution addr 0x2bd7930 size 0x3c virtual false final false
 int32_t get_heightmapResolution() ;

/// @brief Method set_heightmapResolution addr 0x2bd79a8 size 0x1a8 virtual false final false
 void set_heightmapResolution(int32_t value) ;

/// @brief Method get_internalHeightmapResolution addr 0x2bd796c size 0x3c virtual false final false
 int32_t get_internalHeightmapResolution() ;

/// @brief Method set_internalHeightmapResolution addr 0x2bd7b50 size 0x44 virtual false final false
 void set_internalHeightmapResolution(int32_t value) ;

/// @brief Method get_size addr 0x2bd7b94 size 0x5c virtual false final false
 UnityEngine::Vector3 get_size() ;

/// @brief Method set_size addr 0x2bd7c34 size 0x54 virtual false final false
 void set_size(UnityEngine::Vector3 value) ;

/// @brief Method GetHeights addr 0x2bd7ccc size 0x134 virtual false final false
...
/// @brief Method Internal_GetHeights addr 0x2bd7e00 size 0x6c virtual false final false
...
/// @brief Method SetHeights addr 0x2bd7e6c size 0x310 virtual false final false
...
/// @brief Method Internal_SetHeights addr 0x2bd817c size 0x74 virtual false final false
...
/// @brief Method SetDetailResolution addr 0x2bd81f0 size 0x438 virtual false final false
 void SetDetailResolution(int32_t detailResolution, int32_t resolutionPerPatch) ;

/// @brief Method Internal_SetDetailResolution addr 0x2bd8628 size 0x54 virtual false final false
 void Internal_SetDetailResolution(int32_t patchCount, int32_t resolutionPerPatch) ;

/// @brief Method get_detailResolutionPerPatch addr 0x2bd867c size 0x3c virtual false final false
 int32_t get_detailResolutionPerPatch() ;

/// @brief Method RefreshPrototypes addr 0x2bd86b8 size 0x3c virtual false final false
 void RefreshPrototypes() ;

/// @brief Method set_detailPrototypes addr 0x2bd86f4 size 0x44 virtual false final false
 void set_detailPrototypes(::ArrayW<UnityEngine::DetailPrototype> value) ;

/// @brief Method SetDetailLayer addr 0x2bd8738 size 0xac virtual false final false
...
/// @brief Method Internal_SetDetailLayer addr 0x2bd87e4 size 0x84 virtual false final false
...
/// @brief Method get_treeInstances addr 0x2bd8868 size 0x3c virtual false final false
 ::ArrayW<UnityEngine::TreeInstance> get_treeInstances() ;

/// @brief Method Internal_GetTreeInstances addr 0x2bd88a4 size 0x3c virtual false final false
 ::ArrayW<UnityEngine::TreeInstance> Internal_GetTreeInstances() ;

/// @brief Method SetTreeInstances addr 0x2bd88e0 size 0x54 virtual false final false
 void SetTreeInstances(::ArrayW<UnityEngine::TreeInstance> instances, bool snapToHeightmap) ;

/// @brief Method get_treePrototypes addr 0x2bd8934 size 0x3c virtual false final false
 ::ArrayW<UnityEngine::TreePrototype> get_treePrototypes() ;

/// @brief Method set_treePrototypes addr 0x2bd8970 size 0x44 virtual false final false
 void set_treePrototypes(::ArrayW<UnityEngine::TreePrototype> value) ;

/// @brief Method get_alphamapLayers addr 0x2bd89b4 size 0x3c virtual false final false
 int32_t get_alphamapLayers() ;

/// @brief Method GetAlphamaps addr 0x2bd89f0 size 0xc8 virtual false final false
...
/// @brief Method Internal_GetAlphamaps addr 0x2bd8ab8 size 0x6c virtual false final false
...
/// @brief Method get_alphamapResolution addr 0x2bd8b24 size 0x3c virtual false final false
 int32_t get_alphamapResolution() ;

/// @brief Method set_alphamapResolution addr 0x2bd8b9c size 0x2f8 virtual false final false
 void set_alphamapResolution(int32_t value) ;

/// @brief Method GetAlphamapResolutionInternal addr 0x2bd8ed8 size 0x3c virtual false final false
 float_t GetAlphamapResolutionInternal() ;

/// @brief Method get_Internal_alphamapResolution addr 0x2bd8b60 size 0x3c virtual false final false
 int32_t get_Internal_alphamapResolution() ;

/// @brief Method set_Internal_alphamapResolution addr 0x2bd8e94 size 0x44 virtual false final false
 void set_Internal_alphamapResolution(int32_t value) ;

/// @brief Method get_alphamapWidth addr 0x2bd8f14 size 0x3c virtual false final false
 int32_t get_alphamapWidth() ;

/// @brief Method get_alphamapHeight addr 0x2bd8f50 size 0x3c virtual false final false
 int32_t get_alphamapHeight() ;

/// @brief Method SetAlphamaps addr 0x2bd8f8c size 0x1a4 virtual false final false
...
/// @brief Method Internal_SetAlphamaps addr 0x2bd9130 size 0x74 virtual false final false
...
/// @brief Method get_terrainLayers addr 0x2bd91a4 size 0x3c virtual false final false
 ::ArrayW<UnityEngine::TerrainLayer> get_terrainLayers() ;

/// @brief Method set_terrainLayers addr 0x2bd91e0 size 0x44 virtual false final false
 void set_terrainLayers(::ArrayW<UnityEngine::TerrainLayer> value) ;

/// @brief Method get_users addr 0x2bd9224 size 0x3c virtual false final false
 ::ArrayW<UnityEngine::Terrain> get_users() ;

/// @brief Method get_size_Injected addr 0x2bd7bf0 size 0x44 virtual false final false
 void get_size_Injected(ByRef<UnityEngine::Vector3> ret) ;

/// @brief Method set_size_Injected addr 0x2bd7c88 size 0x44 virtual false final false
