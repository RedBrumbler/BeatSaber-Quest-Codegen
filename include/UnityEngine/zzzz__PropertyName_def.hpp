...
/// @brief Method .ctor addr 0x2b835dc size 0x5c virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method .ctor addr 0x2b83684 size 0x8 virtual false final false
 void _ctor(UnityEngine::PropertyName other) ;

/// @brief Method IsNullOrEmpty addr 0x2b8368c size 0xc virtual false final false
static bool IsNullOrEmpty(UnityEngine::PropertyName prop) ;

/// @brief Method op_Equality addr 0x2b83698 size 0xc virtual false final false
static bool op_Equality(UnityEngine::PropertyName lhs, UnityEngine::PropertyName rhs) ;

/// @brief Method GetHashCode addr 0x2b836a4 size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2b836ac size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method Equals addr 0x2b83724 size 0x10 virtual true final true
 bool Equals(UnityEngine::PropertyName other) ;

/// @brief Method op_Implicit addr 0x2b83734 size 0x4c virtual false final false
static UnityEngine::PropertyName op_Implicit_UnityEngine__PropertyName(::StringW name) ;

/// @brief Method ToString addr 0x2b83780 size 0x84 virtual true final false
 ::StringW ToString() ;
