...
/// @brief Method .ctor addr 0x2c06eb4 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2c06ebc size 0x14c virtual false final false
 void _ctor(int32_t initialCapacity) ;

/// @brief Method Finalize addr 0x2c07030 size 0x110 virtual true final false
 void Finalize() ;

/// @brief Method System.IDisposable.Dispose addr 0x2c07140 size 0xa0 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method get_characterCountVisible addr 0x2c0721c size 0x44 virtual false final false
 int32_t get_characterCountVisible() ;

/// @brief Method ValidatedSettings addr 0x2c0729c size 0x2b8 virtual false final false
 UnityEngine::TextGenerationSettings ValidatedSettings(UnityEngine::TextGenerationSettings settings) ;

/// @brief Method Invalidate addr 0x2c07590 size 0x8 virtual false final false
 void Invalidate() ;

/// @brief Method GetCharacters addr 0x2c07598 size 0x44 virtual false final false
 void GetCharacters(System::Collections::Generic::List_1<UnityEngine::UICharInfo> characters) ;

/// @brief Method GetLines addr 0x2c07620 size 0x44 virtual false final false
 void GetLines(System::Collections::Generic::List_1<UnityEngine::UILineInfo> lines) ;

/// @brief Method GetVertices addr 0x2c076a8 size 0x44 virtual false final false
 void GetVertices(System::Collections::Generic::List_1<UnityEngine::UIVertex> vertices) ;

/// @brief Method GetPreferredWidth addr 0x2c07730 size 0x74 virtual false final false
 float_t GetPreferredWidth(::StringW str, UnityEngine::TextGenerationSettings settings) ;

/// @brief Method GetPreferredHeight addr 0x2c0784c size 0x70 virtual false final false
 float_t GetPreferredHeight(::StringW str, UnityEngine::TextGenerationSettings settings) ;

/// @brief Method PopulateWithErrors addr 0x2c078bc size 0x1b0 virtual false final false
 bool PopulateWithErrors(::StringW str, UnityEngine::TextGenerationSettings settings, UnityEngine::GameObject context) ;

/// @brief Method Populate addr 0x2c077a4 size 0x50 virtual false final false
 bool Populate(::StringW str, UnityEngine::TextGenerationSettings settings) ;

/// @brief Method PopulateWithError addr 0x2c07a6c size 0x90 virtual false final false
 UnityEngine::TextGenerationError PopulateWithError(::StringW str, UnityEngine::TextGenerationSettings settings) ;

/// @brief Method PopulateAlways addr 0x2c07afc size 0x108 virtual false final false
 UnityEngine::TextGenerationError PopulateAlways(::StringW str, UnityEngine::TextGenerationSettings settings) ;

/// @brief Method get_verts addr 0x2c07db0 size 0x5c virtual false final false
 System::Collections::Generic::IList_1<UnityEngine::UIVertex> get_verts() ;

/// @brief Method get_characters addr 0x2c07e0c size 0x5c virtual false final false
 System::Collections::Generic::IList_1<UnityEngine::UICharInfo> get_characters() ;

/// @brief Method get_lines addr 0x2c07e68 size 0x5c virtual false final false
 System::Collections::Generic::IList_1<UnityEngine::UILineInfo> get_lines() ;

/// @brief Method get_rectExtents addr 0x2c077f4 size 0x58 virtual false final false
 UnityEngine::Rect get_rectExtents() ;

/// @brief Method get_characterCount addr 0x2c07260 size 0x3c virtual false final false
 int32_t get_characterCount() ;

/// @brief Method get_lineCount addr 0x2c07f08 size 0x3c virtual false final false
 int32_t get_lineCount() ;

/// @brief Method Internal_Create addr 0x2c07008 size 0x28 virtual false final false
static ::cordl_internals::intptr_t Internal_Create() ;

/// @brief Method Internal_Destroy addr 0x2c071e0 size 0x3c virtual false final false
static void Internal_Destroy(::cordl_internals::intptr_t ptr) ;

/// @brief Method Populate_Internal addr 0x2c07f44 size 0x14c virtual false final false
...
/// @brief Method Populate_Internal addr 0x2c07c04 size 0x1ac virtual false final false
...
/// @brief Method GetVerticesInternal addr 0x2c076ec size 0x44 virtual false final false
 void GetVerticesInternal(::bs_hook::Il2CppWrapperType vertices) ;

/// @brief Method GetCharactersInternal addr 0x2c075dc size 0x44 virtual false final false
 void GetCharactersInternal(::bs_hook::Il2CppWrapperType characters) ;

/// @brief Method GetLinesInternal addr 0x2c07664 size 0x44 virtual false final false
 void GetLinesInternal(::bs_hook::Il2CppWrapperType lines) ;

/// @brief Method get_rectExtents_Injected addr 0x2c07ec4 size 0x44 virtual false final false
 void get_rectExtents_Injected(ByRef<UnityEngine::Rect> ret) ;

/// @brief Method Populate_Internal_Injected addr 0x2c08090 size 0x130 virtual false final false
