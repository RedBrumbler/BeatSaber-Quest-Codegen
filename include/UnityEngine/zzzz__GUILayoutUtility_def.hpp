...
/// @brief Method set_id addr 0x2bbd204 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2bbbcd0 size 0xd8 virtual false final false
 void _ctor(int32_t instanceID) ;

/// @brief Method ResetCursor addr 0x2bbd20c size 0x2e0 virtual false final false
 void ResetCursor() ;
...
/// @brief Method Internal_GetWindowRect addr 0x2bbbb2c size 0x90 virtual false final false
static UnityEngine::Rect Internal_GetWindowRect(int32_t windowID) ;

/// @brief Method Internal_MoveWindow addr 0x2bbbc00 size 0x8c virtual false final false
static void Internal_MoveWindow(int32_t windowID, UnityEngine::Rect r) ;

/// @brief Method SelectIDList addr 0x2bb74c8 size 0x148 virtual false final false
static UnityEngine::UnityEngine__GUILayoutUtility__LayoutCache SelectIDList(int32_t instanceID, bool isWindow) ;

/// @brief Method Begin addr 0x2bbbda8 size 0x1cc virtual false final false
static void Begin(int32_t instanceID) ;

/// @brief Method BeginContainer addr 0x2bbc08c size 0x15c virtual false final false
static void BeginContainer(UnityEngine::UnityEngine__GUILayoutUtility__LayoutCache cache) ;

/// @brief Method BeginWindow addr 0x2bb7748 size 0x278 virtual false final false
static void BeginWindow(int32_t windowID, UnityEngine::GUIStyle style, ::ArrayW<UnityEngine::GUILayoutOption> options) ;

/// @brief Method Layout addr 0x2bb79c0 size 0x1f8 virtual false final false
static void Layout() ;

/// @brief Method LayoutFromEditorWindow addr 0x2bbc59c size 0x1ec virtual false final false
static void LayoutFromEditorWindow() ;

/// @brief Method LayoutFromContainer addr 0x2bbc788 size 0x188 virtual false final false
static void LayoutFromContainer(float_t w, float_t h) ;

/// @brief Method LayoutFreeGroup addr 0x2bbc210 size 0x1bc virtual false final false
static void LayoutFreeGroup(UnityEngine::GUILayoutGroup toplevel) ;

/// @brief Method LayoutSingleGroup addr 0x2bbc3cc size 0x1d0 virtual false final false
static void LayoutSingleGroup(UnityEngine::GUILayoutGroup i) ;

/// @brief Method GetRect addr 0x2bbc918 size 0x6c virtual false final false
...
/// @brief Method DoGetRect addr 0x2bbc984 size 0x338 virtual false final false
...
/// @brief Method Internal_GetWindowRect_Injected addr 0x2bbbbbc size 0x44 virtual false final false
static void Internal_GetWindowRect_Injected(int32_t windowID, ByRef<UnityEngine::Rect> ret) ;

/// @brief Method Internal_MoveWindow_Injected addr 0x2bbbc8c size 0x44 virtual false final false
