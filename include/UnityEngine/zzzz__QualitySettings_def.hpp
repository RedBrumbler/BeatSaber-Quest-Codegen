...
/// @brief Method set_vSyncCount addr 0x2b72600 size 0x3c virtual false final false
static void set_vSyncCount(int32_t value) ;

/// @brief Method get_antiAliasing addr 0x2b7263c size 0x28 virtual false final false
static int32_t get_antiAliasing() ;

/// @brief Method set_antiAliasing addr 0x2b72664 size 0x3c virtual false final false
static void set_antiAliasing(int32_t value) ;

/// @brief Method get_INTERNAL_renderPipeline addr 0x2b726a0 size 0x28 virtual false final false
static UnityEngine::ScriptableObject get_INTERNAL_renderPipeline() ;

/// @brief Method set_INTERNAL_renderPipeline addr 0x2b726c8 size 0x3c virtual false final false
static void set_INTERNAL_renderPipeline(UnityEngine::ScriptableObject value) ;

/// @brief Method get_renderPipeline addr 0x2b72704 size 0x90 virtual false final false
static UnityEngine::Rendering::RenderPipelineAsset get_renderPipeline() ;

/// @brief Method set_renderPipeline addr 0x2b72794 size 0x3c virtual false final false
static void set_renderPipeline(UnityEngine::Rendering::RenderPipelineAsset value) ;

/// @brief Method set_maxQueuedFrames addr 0x2b727d0 size 0x3c virtual false final false
static void set_maxQueuedFrames(int32_t value) ;

/// @brief Method get_activeColorSpace addr 0x2b7280c size 0x28 virtual false final false
