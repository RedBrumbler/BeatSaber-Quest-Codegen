...
/// @brief Method set_rawImageDataReference addr 0x2ba0048 size 0x8 virtual false final false
 void set_rawImageDataReference(Unity::Collections::NativeArray_1<uint8_t> value) ;

/// @brief Method set_imageFormat addr 0x2ba0050 size 0x8 virtual false final false
 void set_imageFormat(UnityEngine::TextureFormat value) ;

/// @brief Method set_width addr 0x2ba0058 size 0x8 virtual false final false
 void set_width(int32_t value) ;

/// @brief Method set_height addr 0x2ba0060 size 0x8 virtual false final false
