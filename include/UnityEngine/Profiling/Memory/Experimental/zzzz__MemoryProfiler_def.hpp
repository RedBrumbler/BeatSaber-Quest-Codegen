...
/// @brief Method PrepareMetadata addr 0x2b9fc30 size 0x174 virtual false final false
static ::ArrayW<uint8_t> PrepareMetadata() ;

/// @brief Method WriteIntToByteArray addr 0x2b9fda4 size 0x8c virtual false final false
static int32_t WriteIntToByteArray(::ArrayW<uint8_t> array, int32_t offset, int32_t value) ;

/// @brief Method WriteStringToByteArray addr 0x2b9fe30 size 0x98 virtual false final false
static int32_t WriteStringToByteArray(::ArrayW<uint8_t> array, int32_t offset, ::StringW value) ;

/// @brief Method FinalizeSnapshot addr 0x2b9fec8 size 0x84 virtual false final false
static void FinalizeSnapshot(::StringW path, bool result) ;

/// @brief Method SaveScreenshotToDisk addr 0x2b9ff4c size 0xfc virtual false final false
