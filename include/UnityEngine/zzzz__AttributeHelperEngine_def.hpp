...
/// @brief Method GetParentTypeDisallowingMultipleInclusion addr 0x2b88198 size 0x100 virtual false final false
static System::Type GetParentTypeDisallowingMultipleInclusion(System::Type type) ;

/// @brief Method GetRequiredComponents addr 0x2b88298 size 0x43c virtual false final false
static ::ArrayW<System::Type> GetRequiredComponents(System::Type klass) ;

/// @brief Method GetExecuteMode addr 0x2b886d4 size 0x114 virtual false final false
static int32_t GetExecuteMode(System::Type klass) ;

/// @brief Method CheckIsEditorScript addr 0x2b887e8 size 0xe0 virtual false final false
static int32_t CheckIsEditorScript(System::Type klass) ;

/// @brief Method GetDefaultExecutionOrderFor addr 0x2b888c8 size 0x78 virtual false final false
