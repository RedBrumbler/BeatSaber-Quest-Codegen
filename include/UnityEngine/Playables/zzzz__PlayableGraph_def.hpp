...
/// @brief Method GetRootPlayable addr 0x2baf24c size 0x4 virtual false final false
...
/// @brief Method Evaluate addr 0x2baf2ac size 0x40 virtual false final false
 void Evaluate() ;

/// @brief Method IsValid addr 0x2baf338 size 0x3c virtual false final false
 bool IsValid() ;

/// @brief Method IsPlaying addr 0x2baf3b0 size 0x3c virtual false final false
 bool IsPlaying() ;

/// @brief Method Evaluate addr 0x2baf2ec size 0x4c virtual false final false
 void Evaluate(float_t deltaTime) ;

/// @brief Method GetResolver addr 0x2baf474 size 0x3c virtual false final false
 UnityEngine::IExposedPropertyTable GetResolver() ;

/// @brief Method GetPlayableCount addr 0x2baf4ec size 0x3c virtual false final false
 int32_t GetPlayableCount() ;

/// @brief Method GetRootPlayableCount addr 0x2baf564 size 0x3c virtual false final false
 int32_t GetRootPlayableCount() ;

/// @brief Method SynchronizeEvaluation addr 0x2baf5dc size 0x50 virtual false final false
 void SynchronizeEvaluation(UnityEngine::Playables::PlayableGraph playable) ;

/// @brief Method CreatePlayableHandle addr 0x2baecfc size 0x54 virtual false final false
 UnityEngine::Playables::PlayableHandle CreatePlayableHandle() ;

/// @brief Method CreateScriptOutputInternal addr 0x2baeabc size 0x54 virtual false final false
 bool CreateScriptOutputInternal(::StringW name, ByRef<UnityEngine::Playables::PlayableOutputHandle> handle) ;

/// @brief Method GetRootPlayableInternal addr 0x2baf250 size 0x5c virtual false final false
 UnityEngine::Playables::PlayableHandle GetRootPlayableInternal(int32_t index) ;

/// @brief Method IsMatchFrameRateEnabled addr 0x2baf75c size 0x3c virtual false final false
 bool IsMatchFrameRateEnabled() ;

/// @brief Method GetFrameRate addr 0x2baf7d4 size 0x4c virtual false final false
 UnityEngine::Playables::FrameRate GetFrameRate() ;

/// @brief Method ConnectInternal addr 0x2baf864 size 0x74 virtual false final false
...
/// @brief Method IsValid_Injected addr 0x2baf374 size 0x3c virtual false final false
static bool IsValid_Injected(ByRef<UnityEngine::Playables::PlayableGraph> _unity_self) ;

/// @brief Method IsPlaying_Injected addr 0x2baf3ec size 0x3c virtual false final false
static bool IsPlaying_Injected(ByRef<UnityEngine::Playables::PlayableGraph> _unity_self) ;

/// @brief Method Evaluate_Injected addr 0x2baf428 size 0x4c virtual false final false
static void Evaluate_Injected(ByRef<UnityEngine::Playables::PlayableGraph> _unity_self, float_t deltaTime) ;

/// @brief Method GetResolver_Injected addr 0x2baf4b0 size 0x3c virtual false final false
static UnityEngine::IExposedPropertyTable GetResolver_Injected(ByRef<UnityEngine::Playables::PlayableGraph> _unity_self) ;

/// @brief Method GetPlayableCount_Injected addr 0x2baf528 size 0x3c virtual false final false
static int32_t GetPlayableCount_Injected(ByRef<UnityEngine::Playables::PlayableGraph> _unity_self) ;

/// @brief Method GetRootPlayableCount_Injected addr 0x2baf5a0 size 0x3c virtual false final false
static int32_t GetRootPlayableCount_Injected(ByRef<UnityEngine::Playables::PlayableGraph> _unity_self) ;

/// @brief Method SynchronizeEvaluation_Injected addr 0x2baf62c size 0x44 virtual false final false
...
/// @brief Method CreatePlayableHandle_Injected addr 0x2baf670 size 0x44 virtual false final false
...
/// @brief Method CreateScriptOutputInternal_Injected addr 0x2baf6b4 size 0x54 virtual false final false
...
/// @brief Method GetRootPlayableInternal_Injected addr 0x2baf708 size 0x54 virtual false final false
...
/// @brief Method IsMatchFrameRateEnabled_Injected addr 0x2baf798 size 0x3c virtual false final false
static bool IsMatchFrameRateEnabled_Injected(ByRef<UnityEngine::Playables::PlayableGraph> _unity_self) ;

/// @brief Method GetFrameRate_Injected addr 0x2baf820 size 0x44 virtual false final false
...
/// @brief Method ConnectInternal_Injected addr 0x2baf8d8 size 0x6c virtual false final false
