...
/// @brief Method get_Null addr 0x2bae9bc size 0x58 virtual false final false
static UnityEngine::Playables::Playable get_Null() ;

/// @brief Method Create addr 0x2baec8c size 0x70 virtual false final false
static UnityEngine::Playables::Playable Create(UnityEngine::Playables::PlayableGraph graph, int32_t inputCount) ;

/// @brief Method .ctor addr 0x2baed50 size 0x8 virtual false final false
 void _ctor(UnityEngine::Playables::PlayableHandle handle) ;

/// @brief Method GetHandle addr 0x2baed58 size 0xc virtual true final true
...
/// @brief Method GetPlayableType addr 0x2baed64 size 0x24 virtual false final false
 System::Type GetPlayableType() ;

/// @brief Method Equals addr 0x2baedfc size 0x74 virtual true final true
