...
/// @brief Method get_Null addr 0x2bad98c size 0x58 virtual false final false
...
/// @brief Method GetHashCode addr 0x2bad9e4 size 0x34 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x2bada18 size 0x88 virtual false final false
static bool op_Equality(UnityEngine::Playables::PlayableOutputHandle lhs, UnityEngine::Playables::PlayableOutputHandle rhs) ;

/// @brief Method Equals addr 0x2badad4 size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType p) ;

/// @brief Method Equals addr 0x2badb4c size 0x80 virtual true final true
 bool Equals(UnityEngine::Playables::PlayableOutputHandle other) ;

/// @brief Method CompareVersion addr 0x2badaa0 size 0x34 virtual false final false
static bool CompareVersion(UnityEngine::Playables::PlayableOutputHandle lhs, UnityEngine::Playables::PlayableOutputHandle rhs) ;

/// @brief Method IsValid addr 0x2badbcc size 0x74 virtual false final false
 bool IsValid() ;

/// @brief Method GetPlayableOutputType addr 0x2badc7c size 0x74 virtual false final false
 System::Type GetPlayableOutputType() ;

/// @brief Method SetReferenceObject addr 0x2badd2c size 0x84 virtual false final false
 void SetReferenceObject(UnityEngine::Object target) ;

/// @brief Method SetUserData addr 0x2baddf4 size 0x84 virtual false final false
 void SetUserData(UnityEngine::Object target) ;

/// @brief Method GetSourcePlayable addr 0x2badebc size 0x8c virtual false final false
 UnityEngine::Playables::PlayableHandle GetSourcePlayable() ;

/// @brief Method SetSourcePlayable addr 0x2badf8c size 0x98 virtual false final false
 void SetSourcePlayable(UnityEngine::Playables::PlayableHandle target, int32_t port) ;

/// @brief Method GetSourceOutputPort addr 0x2bae078 size 0x74 virtual false final false
 int32_t GetSourceOutputPort() ;

/// @brief Method SetWeight addr 0x2bae128 size 0x84 virtual false final false
 void SetWeight(float_t weight) ;

/// @brief Method PushNotification addr 0x2bae1f8 size 0xa0 virtual false final false
...
/// @brief Method AddNotificationReceiver addr 0x2bae2f4 size 0x84 virtual false final false
 void AddNotificationReceiver(UnityEngine::Playables::INotificationReceiver receiver) ;

/// @brief Method IsValid_Injected addr 0x2badc40 size 0x3c virtual false final false
static bool IsValid_Injected(ByRef<UnityEngine::Playables::PlayableOutputHandle> _unity_self) ;

/// @brief Method GetPlayableOutputType_Injected addr 0x2badcf0 size 0x3c virtual false final false
static System::Type GetPlayableOutputType_Injected(ByRef<UnityEngine::Playables::PlayableOutputHandle> _unity_self) ;

/// @brief Method SetReferenceObject_Injected addr 0x2baddb0 size 0x44 virtual false final false
...
/// @brief Method SetUserData_Injected addr 0x2bade78 size 0x44 virtual false final false
static void SetUserData_Injected(ByRef<UnityEngine::Playables::PlayableOutputHandle> _unity_self, UnityEngine::Object target) ;

/// @brief Method GetSourcePlayable_Injected addr 0x2badf48 size 0x44 virtual false final false
...
/// @brief Method SetSourcePlayable_Injected addr 0x2bae024 size 0x54 virtual false final false
...
/// @brief Method GetSourceOutputPort_Injected addr 0x2bae0ec size 0x3c virtual false final false
static int32_t GetSourceOutputPort_Injected(ByRef<UnityEngine::Playables::PlayableOutputHandle> _unity_self) ;

/// @brief Method SetWeight_Injected addr 0x2bae1ac size 0x4c virtual false final false
static void SetWeight_Injected(ByRef<UnityEngine::Playables::PlayableOutputHandle> _unity_self, float_t weight) ;

/// @brief Method PushNotification_Injected addr 0x2bae298 size 0x5c virtual false final false
...
/// @brief Method AddNotificationReceiver_Injected addr 0x2bae378 size 0x44 virtual false final false
