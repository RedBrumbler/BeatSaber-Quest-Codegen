...
/// @brief Method HasFlags addr 0x2bae404 size 0x10 virtual false final false
 bool HasFlags(UnityEngine::Playables::UnityEngine__Playables__FrameData__Flags flag) ;

/// @brief Method get_deltaTime addr 0x2bae414 size 0xc virtual false final false
 float_t get_deltaTime() ;

/// @brief Method get_effectiveSpeed addr 0x2bae420 size 0x8 virtual false final false
 float_t get_effectiveSpeed() ;

/// @brief Method get_evaluationType addr 0x2bae428 size 0x10 virtual false final false
 UnityEngine::Playables::UnityEngine__Playables__FrameData__EvaluationType get_evaluationType() ;

/// @brief Method get_seekOccurred addr 0x2bae438 size 0xc virtual false final false
 bool get_seekOccurred() ;

/// @brief Method get_timeLooped addr 0x2bae444 size 0xc virtual false final false
 bool get_timeLooped() ;

/// @brief Method get_timeHeld addr 0x2bae450 size 0xc virtual false final false
 bool get_timeHeld() ;

/// @brief Method get_output addr 0x2bae45c size 0xc virtual false final false
 UnityEngine::Playables::PlayableOutput get_output() ;

/// @brief Method get_effectivePlayState addr 0x2bae468 size 0x18 virtual false final false
