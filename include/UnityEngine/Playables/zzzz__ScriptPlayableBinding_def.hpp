...
/// @brief Method Create addr 0x2baf18c size 0xbc virtual false final false
static UnityEngine::Playables::PlayableBinding Create(::StringW name, UnityEngine::Object key, System::Type type) ;

/// @brief Method CreateScriptOutput addr 0x2baf248 size 0x4 virtual false final false
