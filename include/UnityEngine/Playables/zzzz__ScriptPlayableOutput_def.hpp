...
/// @brief Method Create addr 0x2baea44 size 0x78 virtual false final false
static UnityEngine::Playables::ScriptPlayableOutput Create(UnityEngine::Playables::PlayableGraph graph, ::StringW name) ;

/// @brief Method .ctor addr 0x2baeb88 size 0xbc virtual false final false
 void _ctor(UnityEngine::Playables::PlayableOutputHandle handle) ;

/// @brief Method get_Null addr 0x2baeb10 size 0x78 virtual false final false
static UnityEngine::Playables::ScriptPlayableOutput get_Null() ;

/// @brief Method GetHandle addr 0x2baec44 size 0xc virtual true final true
 UnityEngine::Playables::PlayableOutputHandle GetHandle() ;

/// @brief Method op_Implicit addr 0x2baec50 size 0x4 virtual false final false
