...
/// @brief Method get_dropFrame addr 0x2bae480 size 0xc virtual false final false
 bool get_dropFrame() ;

/// @brief Method get_rate addr 0x2bae48c size 0x28 virtual false final false
 double_t get_rate() ;

/// @brief Method .ctor addr 0x2bae4b4 size 0x18 virtual false final false
 void _ctor(uint32_t frameRate, bool drop) ;

/// @brief Method IsValid addr 0x2bae4cc size 0x10 virtual false final false
 bool IsValid() ;

/// @brief Method Equals addr 0x2bae4dc size 0x10 virtual true final true
 bool Equals(UnityEngine::Playables::FrameRate other) ;

/// @brief Method Equals addr 0x2bae4ec size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method op_Equality addr 0x2bae564 size 0xc virtual false final false
static bool op_Equality(UnityEngine::Playables::FrameRate a, UnityEngine::Playables::FrameRate b) ;

/// @brief Method GetHashCode addr 0x2bae570 size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2bae578 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x2bae584 size 0x194 virtual false final false
 ::StringW ToString(::StringW format, System::IFormatProvider formatProvider) ;

/// @brief Method DoubleToFrameRate addr 0x2bae718 size 0xc4 virtual false final false
