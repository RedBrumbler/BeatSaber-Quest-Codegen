...
/// @brief Method RequestAtlas addr 0x2b9f820 size 0xc0 virtual false final false
static bool RequestAtlas(::StringW tag) ;

/// @brief Method add_atlasRegistered addr 0x2b9f8e0 size 0xd0 virtual false final false
static void add_atlasRegistered(System::Action_1<UnityEngine::U2D::SpriteAtlas> value) ;

/// @brief Method remove_atlasRegistered addr 0x2b9f9b0 size 0xd0 virtual false final false
static void remove_atlasRegistered(System::Action_1<UnityEngine::U2D::SpriteAtlas> value) ;

/// @brief Method PostRegisteredAtlas addr 0x2b9fa80 size 0x6c virtual false final false
static void PostRegisteredAtlas(UnityEngine::U2D::SpriteAtlas spriteAtlas) ;

/// @brief Method Register addr 0x2b9faec size 0x3c virtual false final false
