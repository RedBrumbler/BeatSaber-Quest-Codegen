...
/// @brief Method GetMessage addr 0x2ba2910 size 0xec virtual false final false
static ::StringW GetMessage(::StringW failureMessage) ;

/// @brief Method GetMessage addr 0x2ba29fc size 0x158 virtual false final false
static ::StringW GetMessage(::StringW failureMessage, ::StringW expected) ;

/// @brief Method GetEqualityMessage addr 0x2ba257c size 0x1f4 virtual false final false
static ::StringW GetEqualityMessage(::bs_hook::Il2CppWrapperType actual, ::bs_hook::Il2CppWrapperType expected, bool expectEqual) ;

/// @brief Method NullFailureMessage addr 0x2ba221c size 0x168 virtual false final false
static ::StringW NullFailureMessage(::bs_hook::Il2CppWrapperType value, bool expectNull) ;

/// @brief Method BooleanFailureMessage addr 0x2ba1f28 size 0x90 virtual false final false
