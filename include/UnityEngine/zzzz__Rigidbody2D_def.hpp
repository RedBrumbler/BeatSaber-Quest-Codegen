...
/// @brief Method get_position addr 0x2bce3b0 size 0x4c virtual false final false
 UnityEngine::Vector2 get_position() ;

/// @brief Method get_velocity addr 0x2bce440 size 0x4c virtual false final false
 UnityEngine::Vector2 get_velocity() ;

/// @brief Method set_velocity addr 0x2bce4d0 size 0x48 virtual false final false
 void set_velocity(UnityEngine::Vector2 value) ;

/// @brief Method Sleep addr 0x2bce55c size 0x3c virtual false final false
 void Sleep() ;

/// @brief Method get_position_Injected addr 0x2bce3fc size 0x44 virtual false final false
 void get_position_Injected(ByRef<UnityEngine::Vector2> ret) ;

/// @brief Method get_velocity_Injected addr 0x2bce48c size 0x44 virtual false final false
 void get_velocity_Injected(ByRef<UnityEngine::Vector2> ret) ;

/// @brief Method set_velocity_Injected addr 0x2bce518 size 0x44 virtual false final false
