...
/// @brief Method get_Item addr 0x2b8faf8 size 0x6c virtual false final false
 float_t get_Item(int32_t index) ;

/// @brief Method set_Item addr 0x2b8fb64 size 0x6c virtual false final false
 void set_Item(int32_t index, float_t value) ;

/// @brief Method .ctor addr 0x2b8fbd0 size 0x8 virtual false final false
 void _ctor(float_t x, float_t y) ;

/// @brief Method Lerp addr 0x2b8fbd8 size 0x30 virtual false final false
static UnityEngine::Vector2 Lerp(UnityEngine::Vector2 a, UnityEngine::Vector2 b, float_t t) ;

/// @brief Method LerpUnclamped addr 0x2b8fc08 size 0x1c virtual false final false
static UnityEngine::Vector2 LerpUnclamped(UnityEngine::Vector2 a, UnityEngine::Vector2 b, float_t t) ;

/// @brief Method Scale addr 0x2b8fc24 size 0xc virtual false final false
static UnityEngine::Vector2 Scale(UnityEngine::Vector2 a, UnityEngine::Vector2 b) ;

/// @brief Method Scale addr 0x2b8fc30 size 0x14 virtual false final false
 void Scale(UnityEngine::Vector2 scale) ;

/// @brief Method Normalize addr 0x2b8fc44 size 0xc8 virtual false final false
 void Normalize() ;

/// @brief Method get_normalized addr 0x2b8fd0c size 0xb0 virtual false final false
 UnityEngine::Vector2 get_normalized() ;

/// @brief Method ToString addr 0x2b8fdbc size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x2b8fdc8 size 0x8 virtual false final false
 ::StringW ToString(::StringW format) ;

/// @brief Method ToString addr 0x2b85f54 size 0x188 virtual true final true
 ::StringW ToString(::StringW format, System::IFormatProvider formatProvider) ;

/// @brief Method GetHashCode addr 0x2b8fdd0 size 0x34 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2b8fe04 size 0x88 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method Equals addr 0x2b8fe8c size 0x24 virtual true final true
 bool Equals(UnityEngine::Vector2 other) ;

/// @brief Method Perpendicular addr 0x2b8feb0 size 0x14 virtual false final false
static UnityEngine::Vector2 Perpendicular(UnityEngine::Vector2 inDirection) ;

/// @brief Method Dot addr 0x2b8fec4 size 0x10 virtual false final false
static float_t Dot(UnityEngine::Vector2 lhs, UnityEngine::Vector2 rhs) ;

/// @brief Method get_magnitude addr 0x2b8fed4 size 0x6c virtual false final false
 float_t get_magnitude() ;

/// @brief Method get_sqrMagnitude addr 0x2b8ff40 size 0x14 virtual false final false
 float_t get_sqrMagnitude() ;

/// @brief Method Angle addr 0x2b8ff54 size 0xf4 virtual false final false
static float_t Angle(UnityEngine::Vector2 from, UnityEngine::Vector2 to) ;

/// @brief Method SignedAngle addr 0x2b90048 size 0x10c virtual false final false
static float_t SignedAngle(UnityEngine::Vector2 from, UnityEngine::Vector2 to) ;

/// @brief Method Distance addr 0x2b90154 size 0x84 virtual false final false
static float_t Distance(UnityEngine::Vector2 a, UnityEngine::Vector2 b) ;

/// @brief Method ClampMagnitude addr 0x2b901d8 size 0x94 virtual false final false
static UnityEngine::Vector2 ClampMagnitude(UnityEngine::Vector2 vector, float_t maxLength) ;

/// @brief Method SqrMagnitude addr 0x2b9026c size 0x10 virtual false final false
static float_t SqrMagnitude(UnityEngine::Vector2 a) ;

/// @brief Method Min addr 0x2b9027c size 0x14 virtual false final false
static UnityEngine::Vector2 Min(UnityEngine::Vector2 lhs, UnityEngine::Vector2 rhs) ;

/// @brief Method Max addr 0x2b90290 size 0x14 virtual false final false
static UnityEngine::Vector2 Max(UnityEngine::Vector2 lhs, UnityEngine::Vector2 rhs) ;

/// @brief Method op_Addition addr 0x2b902a4 size 0xc virtual false final false
static UnityEngine::Vector2 op_Addition(UnityEngine::Vector2 a, UnityEngine::Vector2 b) ;

/// @brief Method op_Subtraction addr 0x2b902b0 size 0xc virtual false final false
static UnityEngine::Vector2 op_Subtraction(UnityEngine::Vector2 a, UnityEngine::Vector2 b) ;

/// @brief Method op_Multiply addr 0x2b902bc size 0xc virtual false final false
static UnityEngine::Vector2 op_Multiply(UnityEngine::Vector2 a, UnityEngine::Vector2 b) ;

/// @brief Method op_Division addr 0x2b902c8 size 0xc virtual false final false
static UnityEngine::Vector2 op_Division(UnityEngine::Vector2 a, UnityEngine::Vector2 b) ;

/// @brief Method op_UnaryNegation addr 0x2b902d4 size 0xc virtual false final false
static UnityEngine::Vector2 op_UnaryNegation(UnityEngine::Vector2 a) ;

/// @brief Method op_Multiply addr 0x2b902e0 size 0xc virtual false final false
static UnityEngine::Vector2 op_Multiply(UnityEngine::Vector2 a, float_t d) ;

/// @brief Method op_Multiply addr 0x2b902ec size 0x10 virtual false final false
static UnityEngine::Vector2 op_Multiply(float_t d, UnityEngine::Vector2 a) ;

/// @brief Method op_Division addr 0x2b902fc size 0xc virtual false final false
static UnityEngine::Vector2 op_Division(UnityEngine::Vector2 a, float_t d) ;

/// @brief Method op_Equality addr 0x2b90308 size 0x28 virtual false final false
static bool op_Equality(UnityEngine::Vector2 lhs, UnityEngine::Vector2 rhs) ;

/// @brief Method op_Inequality addr 0x2b90330 size 0x28 virtual false final false
static bool op_Inequality(UnityEngine::Vector2 lhs, UnityEngine::Vector2 rhs) ;

/// @brief Method op_Implicit addr 0x2b90358 size 0x4 virtual false final false
static UnityEngine::Vector2 op_Implicit_UnityEngine__Vector2(UnityEngine::Vector3 v) ;

/// @brief Method op_Implicit addr 0x2b9035c size 0x8 virtual false final false
static UnityEngine::Vector3 op_Implicit_UnityEngine__Vector3(UnityEngine::Vector2 v) ;

/// @brief Method get_zero addr 0x2b90364 size 0x48 virtual false final false
static UnityEngine::Vector2 get_zero() ;

/// @brief Method get_one addr 0x2b903ac size 0x48 virtual false final false
static UnityEngine::Vector2 get_one() ;

/// @brief Method get_up addr 0x2b903f4 size 0x48 virtual false final false
static UnityEngine::Vector2 get_up() ;

/// @brief Method get_down addr 0x2b9043c size 0x48 virtual false final false
static UnityEngine::Vector2 get_down() ;

/// @brief Method get_right addr 0x2b90484 size 0x48 virtual false final false
