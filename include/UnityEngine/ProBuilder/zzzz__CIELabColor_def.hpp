...
/// @brief Method .ctor addr 0x29d926c size 0x3c virtual false final false
 void _ctor(float_t L, float_t a, float_t b) ;

/// @brief Method FromXYZ addr 0x29d92a8 size 0x54 virtual false final false
static UnityEngine::ProBuilder::CIELabColor FromXYZ(UnityEngine::ProBuilder::XYZColor xyz) ;

/// @brief Method FromRGB addr 0x29d9460 size 0x8c virtual false final false
static UnityEngine::ProBuilder::CIELabColor FromRGB(UnityEngine::Color col) ;

/// @brief Method ToString addr 0x29d94ec size 0xc4 virtual true final false
 ::StringW ToString() ;
