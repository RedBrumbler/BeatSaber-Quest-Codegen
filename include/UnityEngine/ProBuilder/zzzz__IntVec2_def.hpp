...
/// @brief Method get_x addr 0x29e1f6c size 0x8 virtual false final false
 float_t get_x() ;

/// @brief Method get_y addr 0x29e1f74 size 0x8 virtual false final false
 float_t get_y() ;

/// @brief Method .ctor addr 0x29e1f7c size 0x8 virtual false final false
 void _ctor(UnityEngine::Vector2 vector) ;

/// @brief Method ToString addr 0x29e1f84 size 0xa0 virtual true final false
 ::StringW ToString() ;

/// @brief Method op_Equality addr 0x29e2024 size 0x24 virtual false final false
static bool op_Equality(UnityEngine::ProBuilder::IntVec2 a, UnityEngine::ProBuilder::IntVec2 b) ;

/// @brief Method op_Inequality addr 0x29e20b4 size 0x28 virtual false final false
static bool op_Inequality(UnityEngine::ProBuilder::IntVec2 a, UnityEngine::ProBuilder::IntVec2 b) ;

/// @brief Method Equals addr 0x29e2048 size 0x6c virtual true final true
 bool Equals(UnityEngine::ProBuilder::IntVec2 p) ;

/// @brief Method Equals addr 0x29e2144 size 0x6c virtual false final false
 bool Equals(UnityEngine::Vector2 p) ;

/// @brief Method Equals addr 0x29e21b0 size 0xbc virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType b) ;

/// @brief Method GetHashCode addr 0x29e226c size 0xc virtual true final false
 int32_t GetHashCode() ;

/// @brief Method round addr 0x29e20dc size 0x68 virtual false final false
static int32_t round(float_t v) ;

/// @brief Method op_Implicit addr 0x29e2278 size 0x4 virtual false final false
static UnityEngine::Vector2 op_Implicit_UnityEngine__Vector2(UnityEngine::ProBuilder::IntVec2 p) ;

/// @brief Method op_Implicit addr 0x29e227c size 0x4 virtual false final false
