...
/// @brief Method get_defaultAutoUnwrapSettings addr 0x29d23dc size 0x18 virtual false final false
static UnityEngine::ProBuilder::AutoUnwrapSettings get_defaultAutoUnwrapSettings() ;

/// @brief Method get_useWorldSpace addr 0x29d240c size 0x8 virtual false final false
 bool get_useWorldSpace() ;

/// @brief Method set_useWorldSpace addr 0x29d2414 size 0xc virtual false final false
 void set_useWorldSpace(bool value) ;

/// @brief Method get_flipU addr 0x29d2420 size 0x8 virtual false final false
 bool get_flipU() ;

/// @brief Method set_flipU addr 0x29d2428 size 0xc virtual false final false
 void set_flipU(bool value) ;

/// @brief Method get_flipV addr 0x29d2434 size 0x8 virtual false final false
 bool get_flipV() ;

/// @brief Method set_flipV addr 0x29d243c size 0xc virtual false final false
 void set_flipV(bool value) ;

/// @brief Method get_swapUV addr 0x29d2448 size 0x8 virtual false final false
 bool get_swapUV() ;

/// @brief Method set_swapUV addr 0x29d2450 size 0xc virtual false final false
 void set_swapUV(bool value) ;

/// @brief Method get_fill addr 0x29d245c size 0x8 virtual false final false
 UnityEngine::ProBuilder::UnityEngine__ProBuilder__AutoUnwrapSettings__Fill get_fill() ;

/// @brief Method set_fill addr 0x29d2464 size 0x8 virtual false final false
 void set_fill(UnityEngine::ProBuilder::UnityEngine__ProBuilder__AutoUnwrapSettings__Fill value) ;

/// @brief Method get_scale addr 0x29d246c size 0x8 virtual false final false
 UnityEngine::Vector2 get_scale() ;

/// @brief Method set_scale addr 0x29d2474 size 0x8 virtual false final false
 void set_scale(UnityEngine::Vector2 value) ;

/// @brief Method get_offset addr 0x29d247c size 0x8 virtual false final false
 UnityEngine::Vector2 get_offset() ;

/// @brief Method set_offset addr 0x29d2484 size 0x8 virtual false final false
 void set_offset(UnityEngine::Vector2 value) ;

/// @brief Method get_rotation addr 0x29d248c size 0x8 virtual false final false
 float_t get_rotation() ;

/// @brief Method set_rotation addr 0x29d2494 size 0x8 virtual false final false
 void set_rotation(float_t value) ;

/// @brief Method get_anchor addr 0x29d249c size 0x8 virtual false final false
 UnityEngine::ProBuilder::UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor get_anchor() ;

/// @brief Method set_anchor addr 0x29d24a4 size 0x8 virtual false final false
 void set_anchor(UnityEngine::ProBuilder::UnityEngine__ProBuilder__AutoUnwrapSettings__Anchor value) ;

/// @brief Method .ctor addr 0x29d24ac size 0x5c virtual false final false
 void _ctor(UnityEngine::ProBuilder::AutoUnwrapSettings unwrapSettings) ;

/// @brief Method get_tile addr 0x29d2508 size 0x18 virtual false final false
static UnityEngine::ProBuilder::AutoUnwrapSettings get_tile() ;

/// @brief Method get_fit addr 0x29d2520 size 0x18 virtual false final false
static UnityEngine::ProBuilder::AutoUnwrapSettings get_fit() ;

/// @brief Method get_stretch addr 0x29d2538 size 0x18 virtual false final false
static UnityEngine::ProBuilder::AutoUnwrapSettings get_stretch() ;

/// @brief Method Reset addr 0x29d23f4 size 0x18 virtual false final false
 void Reset() ;

/// @brief Method ToString addr 0x29d2550 size 0x54c virtual true final false
 ::StringW ToString() ;
