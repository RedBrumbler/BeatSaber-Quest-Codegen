...
/// @brief Method get_x addr 0x29e2640 size 0x8 virtual false final false
 float_t get_x() ;

/// @brief Method get_y addr 0x29e2648 size 0x8 virtual false final false
 float_t get_y() ;

/// @brief Method get_z addr 0x29e2650 size 0x8 virtual false final false
 float_t get_z() ;

/// @brief Method get_w addr 0x29e2658 size 0x8 virtual false final false
 float_t get_w() ;

/// @brief Method .ctor addr 0x29e2660 size 0xc virtual false final false
 void _ctor(UnityEngine::Vector4 vector) ;

/// @brief Method ToString addr 0x29e266c size 0x1ac virtual true final false
 ::StringW ToString() ;

/// @brief Method op_Equality addr 0x29e2818 size 0x38 virtual false final false
static bool op_Equality(UnityEngine::ProBuilder::IntVec4 a, UnityEngine::ProBuilder::IntVec4 b) ;

/// @brief Method op_Inequality addr 0x29e2904 size 0x3c virtual false final false
static bool op_Inequality(UnityEngine::ProBuilder::IntVec4 a, UnityEngine::ProBuilder::IntVec4 b) ;

/// @brief Method Equals addr 0x29e2850 size 0xb4 virtual true final true
 bool Equals(UnityEngine::ProBuilder::IntVec4 p) ;

/// @brief Method Equals addr 0x29e29a8 size 0xb4 virtual false final false
 bool Equals(UnityEngine::Vector4 p) ;

/// @brief Method Equals addr 0x29e2a5c size 0xc4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType b) ;

/// @brief Method GetHashCode addr 0x29e2b20 size 0x10 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method round addr 0x29e2940 size 0x68 virtual false final false
static int32_t round(float_t v) ;

/// @brief Method op_Implicit addr 0x29e2b30 size 0x4 virtual false final false
static UnityEngine::Vector4 op_Implicit_UnityEngine__Vector4(UnityEngine::ProBuilder::IntVec4 p) ;

/// @brief Method op_Implicit addr 0x29e2b34 size 0x4 virtual false final false
