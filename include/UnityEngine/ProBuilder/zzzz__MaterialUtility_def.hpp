...
/// @brief Method GetMaterialCount addr 0x29e36f0 size 0xd0 virtual false final false
static int32_t GetMaterialCount(UnityEngine::Renderer renderer) ;

/// @brief Method GetSharedMaterial addr 0x29e37c0 size 0x140 virtual false final false
