...
/// @brief Method .ctor addr 0x29d9ad0 size 0x8 virtual false final false
 void _ctor(int32_t a, int32_t b) ;

/// @brief Method IsValid addr 0x29d9ad8 size 0x2c virtual false final false
 bool IsValid() ;

/// @brief Method ToString addr 0x29d9b04 size 0x1a4 virtual true final false
 ::StringW ToString() ;

/// @brief Method Equals addr 0x29d9ca8 size 0x44 virtual true final true
 bool Equals(UnityEngine::ProBuilder::Edge other) ;

/// @brief Method Equals addr 0x29d9cec size 0xa0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x29d9d8c size 0x24 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Addition addr 0x29d9db0 size 0x18 virtual false final false
static UnityEngine::ProBuilder::Edge op_Addition(UnityEngine::ProBuilder::Edge a, UnityEngine::ProBuilder::Edge b) ;

/// @brief Method op_Subtraction addr 0x29d9dc8 size 0x18 virtual false final false
static UnityEngine::ProBuilder::Edge op_Subtraction(UnityEngine::ProBuilder::Edge a, UnityEngine::ProBuilder::Edge b) ;

/// @brief Method op_Addition addr 0x29d9de0 size 0x14 virtual false final false
static UnityEngine::ProBuilder::Edge op_Addition(UnityEngine::ProBuilder::Edge a, int32_t b) ;

/// @brief Method op_Subtraction addr 0x29d9df4 size 0x14 virtual false final false
static UnityEngine::ProBuilder::Edge op_Subtraction(UnityEngine::ProBuilder::Edge a, int32_t b) ;

/// @brief Method op_Equality addr 0x29d9e08 size 0x38 virtual false final false
static bool op_Equality(UnityEngine::ProBuilder::Edge a, UnityEngine::ProBuilder::Edge b) ;

/// @brief Method op_Inequality addr 0x29d9e40 size 0x90 virtual false final false
static bool op_Inequality(UnityEngine::ProBuilder::Edge a, UnityEngine::ProBuilder::Edge b) ;

/// @brief Method Add addr 0x29d9ed0 size 0x70 virtual false final false
static UnityEngine::ProBuilder::Edge Add(UnityEngine::ProBuilder::Edge a, UnityEngine::ProBuilder::Edge b) ;

/// @brief Method Subtract addr 0x29d9f40 size 0x70 virtual false final false
static UnityEngine::ProBuilder::Edge Subtract(UnityEngine::ProBuilder::Edge a, UnityEngine::ProBuilder::Edge b) ;

/// @brief Method Equals addr 0x29d9fb0 size 0x10c virtual false final false
 bool Equals(UnityEngine::ProBuilder::Edge other, System::Collections::Generic::Dictionary_2<int32_t,int32_t> lookup) ;

/// @brief Method Contains addr 0x29da0bc size 0x24 virtual false final false
 bool Contains(int32_t index) ;

/// @brief Method Contains addr 0x29da0e0 size 0x30 virtual false final false
 bool Contains(UnityEngine::ProBuilder::Edge other) ;

/// @brief Method Contains addr 0x29da110 size 0xa4 virtual false final false
 bool Contains(int32_t index, System::Collections::Generic::Dictionary_2<int32_t,int32_t> lookup) ;

/// @brief Method GetIndices addr 0x29da1b4 size 0x3d8 virtual false final false
