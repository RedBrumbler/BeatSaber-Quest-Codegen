...
namespace UnityEngine::ProBuilder {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12084))}
...
/// @brief Method Initialize addr 0x29d7c90 size 0x10c virtual true final false
 void Initialize() ;

/// @brief Method OnEnterPlayMode addr 0x29d7e80 size 0xb8 virtual true final false
 void OnEnterPlayMode() ;

/// @brief Method OnSceneLoaded addr 0x29d7f38 size 0xb8 virtual true final false
 void OnSceneLoaded(UnityEngine::SceneManagement::Scene scene, UnityEngine::SceneManagement::LoadSceneMode mode) ;

// Ctor Parameters []
explicit ColliderBehaviour() ;

/// @brief Method .ctor addr 0x29d7ff0 size 0x10 virtual false final false
 void _ctor() ;
