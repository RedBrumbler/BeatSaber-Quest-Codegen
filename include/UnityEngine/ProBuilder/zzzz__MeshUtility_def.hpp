...
/// @brief Method .ctor addr 0x29f0264 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <CollapseSharedVertices>b__11_0 addr 0x29f026c size 0x50 virtual false final false
...
/// @brief Method GeneratePerTriangleMesh addr 0x29ec21c size 0x348 virtual false final false
static ::ArrayW<UnityEngine::ProBuilder::Vertex> GeneratePerTriangleMesh(UnityEngine::Mesh mesh) ;

/// @brief Method GenerateTangent addr 0x29ecb34 size 0x534 virtual false final false
static void GenerateTangent(UnityEngine::Mesh mesh) ;

/// @brief Method DeepCopy addr 0x29ed068 size 0x6c virtual false final false
static UnityEngine::Mesh DeepCopy(UnityEngine::Mesh source) ;

/// @brief Method CopyTo addr 0x29ed0d4 size 0x4a0 virtual false final false
...
/// @brief Method Print addr 0x29ed574 size 0xbb8 virtual false final false
static ::StringW Print(UnityEngine::Mesh mesh) ;

/// @brief Method GetIndexCount addr 0x29ee13c size 0xc0 virtual false final false
static uint32_t GetIndexCount(UnityEngine::Mesh mesh) ;

/// @brief Method GetPrimitiveCount addr 0x29ee1fc size 0x114 virtual false final false
static uint32_t GetPrimitiveCount(UnityEngine::Mesh mesh) ;

/// @brief Method Compile addr 0x29ee310 size 0x384 virtual false final false
...
/// @brief Method GetVertices addr 0x29ec564 size 0x5d0 virtual false final false
static ::ArrayW<UnityEngine::ProBuilder::Vertex> GetVertices(UnityEngine::Mesh mesh) ;

/// @brief Method CollapseSharedVertices addr 0x29eecc0 size 0x500 virtual false final false
static void CollapseSharedVertices(UnityEngine::Mesh mesh, ::ArrayW<UnityEngine::ProBuilder::Vertex> vertices) ;

/// @brief Method FitToSize addr 0x29ef1c0 size 0x31c virtual false final false
...
/// @brief Method SanityCheck addr 0x29ef514 size 0x1c virtual false final false
static ::StringW SanityCheck(UnityEngine::ProBuilder::ProBuilderMesh mesh) ;

/// @brief Method SanityCheck addr 0x29ee12c size 0x10 virtual false final false
static ::StringW SanityCheck(UnityEngine::Mesh mesh) ;

/// @brief Method SanityCheck addr 0x29efbec size 0x28c virtual false final false
static ::StringW SanityCheck(System::Collections::Generic::IList_1<UnityEngine::ProBuilder::Vertex> vertices) ;

/// @brief Method IsUsedInParticleSystem addr 0x29efe78 size 0xf0 virtual false final false
static bool IsUsedInParticleSystem(UnityEngine::ProBuilder::ProBuilderMesh pbmesh) ;

/// @brief Method RestoreParticleSystem addr 0x29effdc size 0x98 virtual false final false
static void RestoreParticleSystem(UnityEngine::ProBuilder::ProBuilderMesh pbmesh) ;

/// @brief Method GetBounds addr 0x29f0074 size 0xd0 virtual false final false
