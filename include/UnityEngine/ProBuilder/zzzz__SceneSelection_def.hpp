...
/// @brief Method get_vertexes addr 0x2a0673c size 0x8 virtual false final false
 System::Collections::Generic::List_1<int32_t> get_vertexes() ;

/// @brief Method set_vertexes addr 0x2a06744 size 0x8 virtual false final false
 void set_vertexes(System::Collections::Generic::List_1<int32_t> value) ;

/// @brief Method get_edges addr 0x2a0674c size 0x8 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::ProBuilder::Edge> get_edges() ;

/// @brief Method set_edges addr 0x2a06754 size 0x8 virtual false final false
 void set_edges(System::Collections::Generic::List_1<UnityEngine::ProBuilder::Edge> value) ;

/// @brief Method get_faces addr 0x2a0675c size 0x8 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::ProBuilder::Face> get_faces() ;

/// @brief Method set_faces addr 0x2a06764 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2a0676c size 0x118 virtual false final false
...
/// @brief Method .ctor addr 0x2a06884 size 0xf8 virtual false final false
...
/// @brief Method .ctor addr 0x2a06aa0 size 0xf8 virtual false final false
...
/// @brief Method .ctor addr 0x2a06cbc size 0xf8 virtual false final false
...
/// @brief Method .ctor addr 0x2a0697c size 0x124 virtual false final false
...
/// @brief Method .ctor addr 0x2a06b98 size 0x124 virtual false final false
...
/// @brief Method .ctor addr 0x2a06db4 size 0x124 virtual false final false
...
/// @brief Method SetSingleFace addr 0x2a06ed8 size 0xe0 virtual false final false
 void SetSingleFace(UnityEngine::ProBuilder::Face face) ;

/// @brief Method SetSingleVertex addr 0x2a06fb8 size 0xa8 virtual false final false
 void SetSingleVertex(int32_t vertex) ;

/// @brief Method SetSingleEdge addr 0x2a07060 size 0xa8 virtual false final false
 void SetSingleEdge(UnityEngine::ProBuilder::Edge edge) ;

/// @brief Method Clear addr 0x2a07108 size 0xac virtual false final false
 void Clear() ;

/// @brief Method CopyTo addr 0x2a071b4 size 0x540 virtual false final false
 void CopyTo(UnityEngine::ProBuilder::SceneSelection dst) ;

/// @brief Method ToString addr 0x2a076f4 size 0x260 virtual true final false
 ::StringW ToString() ;

/// @brief Method Equals addr 0x2a07954 size 0xec virtual true final true
 bool Equals(UnityEngine::ProBuilder::SceneSelection other) ;

/// @brief Method Equals addr 0x2a07a40 size 0x10c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2a07b4c size 0x158 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x2a07ca4 size 0x8 virtual false final false
static bool op_Equality(UnityEngine::ProBuilder::SceneSelection left, UnityEngine::ProBuilder::SceneSelection right) ;

/// @brief Method op_Inequality addr 0x2a07cac size 0x1c virtual false final false
