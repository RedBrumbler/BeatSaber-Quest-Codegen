...
/// @brief Method .ctor addr 0x29d2a9c size 0x28 virtual false final false
...
/// @brief Method EnforceTangentMode addr 0x29d2ac4 size 0x318 virtual false final false
...
/// @brief Method SetPosition addr 0x29d2ddc size 0x50 virtual false final false
 void SetPosition(UnityEngine::Vector3 position) ;

/// @brief Method SetTangentIn addr 0x29d2e2c size 0x14 virtual false final false
 void SetTangentIn(UnityEngine::Vector3 tangent, UnityEngine::ProBuilder::BezierTangentMode mode) ;

/// @brief Method SetTangentOut addr 0x29d2e40 size 0x14 virtual false final false
 void SetTangentOut(UnityEngine::Vector3 tangent, UnityEngine::ProBuilder::BezierTangentMode mode) ;

/// @brief Method QuadraticPosition addr 0x29d2e54 size 0x60 virtual false final false
...
/// @brief Method CubicPosition addr 0x29d2eb4 size 0xa0 virtual false final false
...
/// @brief Method GetLookDirection addr 0x29d2f54 size 0x9f8 virtual false final false
