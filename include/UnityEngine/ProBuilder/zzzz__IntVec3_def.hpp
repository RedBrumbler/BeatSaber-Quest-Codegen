...
/// @brief Method get_x addr 0x29e2280 size 0x8 virtual false final false
 float_t get_x() ;

/// @brief Method get_y addr 0x29e2288 size 0x8 virtual false final false
 float_t get_y() ;

/// @brief Method get_z addr 0x29e2290 size 0x8 virtual false final false
 float_t get_z() ;

/// @brief Method .ctor addr 0x29e2298 size 0xc virtual false final false
 void _ctor(UnityEngine::Vector3 vector) ;

/// @brief Method ToString addr 0x29e22a4 size 0xc4 virtual true final false
 ::StringW ToString() ;

/// @brief Method op_Equality addr 0x29e2368 size 0x34 virtual false final false
static bool op_Equality(UnityEngine::ProBuilder::IntVec3 a, UnityEngine::ProBuilder::IntVec3 b) ;

/// @brief Method op_Inequality addr 0x29e2430 size 0x38 virtual false final false
static bool op_Inequality(UnityEngine::ProBuilder::IntVec3 a, UnityEngine::ProBuilder::IntVec3 b) ;

/// @brief Method Equals addr 0x29e239c size 0x94 virtual true final true
 bool Equals(UnityEngine::ProBuilder::IntVec3 p) ;

/// @brief Method Equals addr 0x29e24d0 size 0x94 virtual false final false
 bool Equals(UnityEngine::Vector3 p) ;

/// @brief Method Equals addr 0x29e2564 size 0xc4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType b) ;

/// @brief Method GetHashCode addr 0x29e2628 size 0x10 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method round addr 0x29e2468 size 0x68 virtual false final false
static int32_t round(float_t v) ;

/// @brief Method op_Implicit addr 0x29e2638 size 0x4 virtual false final false
static UnityEngine::Vector3 op_Implicit_UnityEngine__Vector3(UnityEngine::ProBuilder::IntVec3 p) ;

/// @brief Method op_Implicit addr 0x29e263c size 0x4 virtual false final false
