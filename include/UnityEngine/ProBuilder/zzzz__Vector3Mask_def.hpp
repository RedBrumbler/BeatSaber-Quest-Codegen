...
/// @brief Method get_x addr 0x2a1cf70 size 0x18 virtual false final false
 float_t get_x() ;

/// @brief Method get_y addr 0x2a1cf88 size 0x18 virtual false final false
 float_t get_y() ;

/// @brief Method get_z addr 0x2a1cfa0 size 0x18 virtual false final false
 float_t get_z() ;

/// @brief Method .ctor addr 0x2a1cfb8 size 0x34 virtual false final false
 void _ctor(UnityEngine::Vector3 v, float_t epsilon) ;

/// @brief Method .ctor addr 0x2a1cfec size 0x8 virtual false final false
 void _ctor(uint8_t mask) ;

/// @brief Method ToString addr 0x2a1cff4 size 0xec virtual true final false
 ::StringW ToString() ;

/// @brief Method get_active addr 0x2a1d0e0 size 0x1c virtual false final false
 int32_t get_active() ;

/// @brief Method op_Implicit addr 0x2a1d0fc size 0x24 virtual false final false
static UnityEngine::Vector3 op_Implicit_UnityEngine__Vector3(UnityEngine::ProBuilder::Vector3Mask mask) ;

/// @brief Method op_Explicit addr 0x2a1d120 size 0x38 virtual false final false
static UnityEngine::ProBuilder::Vector3Mask op_Explicit_UnityEngine__ProBuilder__Vector3Mask(UnityEngine::Vector3 v) ;

/// @brief Method op_BitwiseOr addr 0x2a1d158 size 0xc virtual false final false
...
/// @brief Method op_BitwiseAnd addr 0x2a1d164 size 0xc virtual false final false
...
/// @brief Method op_ExclusiveOr addr 0x2a1d170 size 0xc virtual false final false
...
/// @brief Method op_Multiply addr 0x2a1d17c size 0x34 virtual false final false
static UnityEngine::Vector3 op_Multiply(UnityEngine::ProBuilder::Vector3Mask mask, float_t value) ;

/// @brief Method op_Multiply addr 0x2a1d1b0 size 0x30 virtual false final false
static UnityEngine::Vector3 op_Multiply(UnityEngine::ProBuilder::Vector3Mask mask, UnityEngine::Vector3 value) ;

/// @brief Method op_Multiply addr 0x2a1d1e0 size 0x13c virtual false final false
static UnityEngine::Vector3 op_Multiply(UnityEngine::Quaternion rotation, UnityEngine::ProBuilder::Vector3Mask mask) ;

/// @brief Method op_Equality addr 0x2a1d31c size 0x10 virtual false final false
static bool op_Equality(UnityEngine::ProBuilder::Vector3Mask left, UnityEngine::ProBuilder::Vector3Mask right) ;

/// @brief Method op_Inequality addr 0x2a1d32c size 0x68 virtual false final false
static bool op_Inequality(UnityEngine::ProBuilder::Vector3Mask left, UnityEngine::ProBuilder::Vector3Mask right) ;

/// @brief Method get_Item addr 0x2a1d394 size 0x60 virtual false final false
 float_t get_Item(int32_t i) ;

/// @brief Method set_Item addr 0x2a1d3f4 size 0x74 virtual false final false
 void set_Item(int32_t i, float_t value) ;

/// @brief Method Equals addr 0x2a1d468 size 0x10 virtual true final true
 bool Equals(UnityEngine::ProBuilder::Vector3Mask other) ;

/// @brief Method Equals addr 0x2a1d478 size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2a1d4f0 size 0x8 virtual true final false
 int32_t GetHashCode() ;
