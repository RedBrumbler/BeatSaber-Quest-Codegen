...
/// @brief Method ClearIntArray addr 0x29f0508 size 0xfc virtual false final false
static void ClearIntArray(int32_t count) ;

/// @brief Method CalculateTangents addr 0x29f0604 size 0x4fc virtual false final false
static void CalculateTangents(UnityEngine::ProBuilder::ProBuilderMesh mesh) ;

/// @brief Method CalculateHardNormals addr 0x29f0b00 size 0x4c8 virtual false final false
static void CalculateHardNormals(UnityEngine::ProBuilder::ProBuilderMesh mesh) ;

/// @brief Method CalculateNormals addr 0x29f0fc8 size 0x5a8 virtual false final false
