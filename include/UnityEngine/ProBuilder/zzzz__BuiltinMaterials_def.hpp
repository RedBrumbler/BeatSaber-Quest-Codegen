...
/// @brief Method Init addr 0x29d61dc size 0x6a0 virtual false final false
static void Init() ;

/// @brief Method get_geometryShadersSupported addr 0x29d6aec size 0x5c virtual false final false
static bool get_geometryShadersSupported() ;

/// @brief Method get_defaultMaterial addr 0x29d6b48 size 0x5c virtual false final false
static UnityEngine::Material get_defaultMaterial() ;

/// @brief Method get_selectionPickerShader addr 0x29d6ba4 size 0x5c virtual false final false
static UnityEngine::Shader get_selectionPickerShader() ;

/// @brief Method get_facePickerMaterial addr 0x29d6c00 size 0x5c virtual false final false
static UnityEngine::Material get_facePickerMaterial() ;

/// @brief Method get_vertexPickerMaterial addr 0x29d6c5c size 0x5c virtual false final false
static UnityEngine::Material get_vertexPickerMaterial() ;

/// @brief Method get_edgePickerMaterial addr 0x29d6cb8 size 0x5c virtual false final false
static UnityEngine::Material get_edgePickerMaterial() ;

/// @brief Method get_triggerMaterial addr 0x29d6d14 size 0x108 virtual false final false
static UnityEngine::Material get_triggerMaterial() ;

/// @brief Method get_colliderMaterial addr 0x29d6e1c size 0x108 virtual false final false
static UnityEngine::Material get_colliderMaterial() ;

/// @brief Method get_noDrawMaterial addr 0x29d6f24 size 0x108 virtual false final false
static UnityEngine::Material get_noDrawMaterial() ;

/// @brief Method GetLegacyDiffuse addr 0x29d702c size 0x2a0 virtual false final false
static UnityEngine::Material GetLegacyDiffuse() ;

/// @brief Method GetDefaultMaterial addr 0x29d687c size 0x1f0 virtual false final false
static UnityEngine::Material GetDefaultMaterial() ;

/// @brief Method get_unlitVertexColor addr 0x29d72cc size 0x5c virtual false final false
static UnityEngine::Material get_unlitVertexColor() ;

/// @brief Method get_ShapePreviewMaterial addr 0x29d7328 size 0x5c virtual false final false
