...
/// @brief Method get_indexes addr 0x2a179a4 size 0x7c virtual false final false
 System::Collections::Generic::IEnumerable_1<int32_t> get_indexes() ;

/// @brief Method set_indexes addr 0x2a17a20 size 0x5c virtual false final false
 void set_indexes(System::Collections::Generic::IEnumerable_1<int32_t> value) ;

/// @brief Method get_topology addr 0x2a17a7c size 0x8 virtual false final false
 UnityEngine::MeshTopology get_topology() ;

/// @brief Method set_topology addr 0x2a17a84 size 0x8 virtual false final false
 void set_topology(UnityEngine::MeshTopology value) ;

/// @brief Method get_submeshIndex addr 0x2a17a8c size 0x8 virtual false final false
 int32_t get_submeshIndex() ;

/// @brief Method set_submeshIndex addr 0x2a17a94 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2a17a9c size 0xc4 virtual false final false
...
/// @brief Method .ctor addr 0x2a17b60 size 0xfc virtual false final false
 void _ctor(UnityEngine::Mesh mesh, int32_t subMeshIndex) ;

/// @brief Method ToString addr 0x2a17c5c size 0x108 virtual true final false
 ::StringW ToString() ;

/// @brief Method GetSubmeshCount addr 0x2a17d64 size 0x60 virtual false final false
static int32_t GetSubmeshCount(UnityEngine::ProBuilder::ProBuilderMesh mesh) ;

/// @brief Method GetSubmeshes addr 0x2a17dc4 size 0x96c virtual false final false
...
/// @brief Method MapFaceMaterialsToSubmeshIndex addr 0x2a18730 size 0x12c virtual false final false
