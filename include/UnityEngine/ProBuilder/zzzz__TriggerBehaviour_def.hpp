...
/// @brief Method Initialize addr 0x2a194f4 size 0x19c virtual true final false
 void Initialize() ;

/// @brief Method OnEnterPlayMode addr 0x2a19690 size 0xb8 virtual true final false
 void OnEnterPlayMode() ;

/// @brief Method OnSceneLoaded addr 0x2a19748 size 0xb8 virtual true final false
 void OnSceneLoaded(UnityEngine::SceneManagement::Scene scene, UnityEngine::SceneManagement::LoadSceneMode mode) ;

// Ctor Parameters []
explicit TriggerBehaviour() ;

/// @brief Method .ctor addr 0x2a19800 size 0x8 virtual false final false
 void _ctor() ;
