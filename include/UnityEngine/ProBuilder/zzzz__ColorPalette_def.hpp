...
/// @brief Method get_current addr 0x29d8010 size 0xc virtual false final false
 UnityEngine::Color get_current() ;

/// @brief Method set_current addr 0x29d801c size 0xc virtual false final false
 void set_current(UnityEngine::Color value) ;

/// @brief Method get_colors addr 0x29d8028 size 0x7c virtual false final false
 System::Collections::ObjectModel::ReadOnlyCollection_1<UnityEngine::Color> get_colors() ;

/// @brief Method SetColors addr 0x29d80a4 size 0xa4 virtual false final false
 void SetColors(System::Collections::Generic::IEnumerable_1<UnityEngine::Color> colors) ;

/// @brief Method SetDefaultValues addr 0x29d8148 size 0x7c8 virtual true final true
 void SetDefaultValues() ;

/// @brief Method get_Item addr 0x29d8910 size 0x58 virtual false final false
 UnityEngine::Color get_Item(int32_t i) ;

/// @brief Method set_Item addr 0x29d8968 size 0x88 virtual false final false
 void set_Item(int32_t i, UnityEngine::Color value) ;

/// @brief Method get_Count addr 0x29d89f0 size 0x48 virtual false final false
 int32_t get_Count() ;

// Ctor Parameters []
explicit ColorPalette() ;

/// @brief Method .ctor addr 0x29d8a38 size 0x8 virtual false final false
 void _ctor() ;
