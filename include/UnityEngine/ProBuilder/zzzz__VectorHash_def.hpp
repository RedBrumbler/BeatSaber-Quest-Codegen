...
/// @brief Method HashFloat addr 0x2a1bc9c size 0x40 virtual false final false
static int32_t HashFloat(float_t f) ;

/// @brief Method GetHashCode addr 0x2a1bcdc size 0x7c virtual false final false
static int32_t GetHashCode(UnityEngine::Vector2 v) ;

/// @brief Method GetHashCode addr 0x2a06608 size 0xb0 virtual false final false
static int32_t GetHashCode(UnityEngine::Vector3 v) ;

/// @brief Method GetHashCode addr 0x2a1bd58 size 0xe0 virtual false final false
