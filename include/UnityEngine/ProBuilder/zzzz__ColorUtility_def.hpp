...
/// @brief Method approx addr 0x29d95b0 size 0x64 virtual false final false
static bool approx(float_t lhs, float_t rhs) ;

/// @brief Method GetColor addr 0x29d9614 size 0xe0 virtual false final false
static UnityEngine::Color GetColor(UnityEngine::Vector3 vec) ;

/// @brief Method RGBToXYZ addr 0x29d8f24 size 0x74 virtual false final false
static UnityEngine::ProBuilder::XYZColor RGBToXYZ(UnityEngine::Color col) ;

/// @brief Method RGBToXYZ addr 0x29d900c size 0x19c virtual false final false
static UnityEngine::ProBuilder::XYZColor RGBToXYZ(float_t r, float_t g, float_t b) ;

/// @brief Method XYZToCIE_Lab addr 0x29d92fc size 0x164 virtual false final false
static UnityEngine::ProBuilder::CIELabColor XYZToCIE_Lab(UnityEngine::ProBuilder::XYZColor xyz) ;

/// @brief Method DeltaE addr 0x29d96f4 size 0x48 virtual false final false
static float_t DeltaE(UnityEngine::ProBuilder::CIELabColor lhs, UnityEngine::ProBuilder::CIELabColor rhs) ;

/// @brief Method HSVtoRGB addr 0x29d973c size 0x7c virtual false final false
static UnityEngine::Color HSVtoRGB(UnityEngine::ProBuilder::HSVColor hsv) ;

/// @brief Method HSVtoRGB addr 0x29d97b8 size 0xe4 virtual false final false
static UnityEngine::Color HSVtoRGB(float_t h, float_t s, float_t v) ;

/// @brief Method RGBtoHSV addr 0x29d8b40 size 0x220 virtual false final false
static UnityEngine::ProBuilder::HSVColor RGBtoHSV(UnityEngine::Color color) ;

/// @brief Method GetColorName addr 0x29d989c size 0x210 virtual false final false
static ::StringW GetColorName(UnityEngine::Color InColor) ;

/// @brief Method CIELabFromRGB addr 0x29d9aac size 0x24 virtual false final false
