...
/// @brief Method get_versionInfo addr 0x29d749c size 0x8 virtual false final false
 UnityEngine::ProBuilder::SemVer get_versionInfo() ;

/// @brief Method get_releaseNotes addr 0x29d74a4 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x29d74ac size 0x2c virtual false final false
 void _ctor(UnityEngine::ProBuilder::SemVer version, ::StringW releaseNotes) ;

/// @brief Method ToString addr 0x29d74d8 size 0x64 virtual true final false
 ::StringW ToString() ;
