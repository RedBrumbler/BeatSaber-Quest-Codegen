...
template<::cordl_internals::il2cpp_reference_type T3>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2638)), TypeDefinitionIndex(TypeDefinitionIndex(12163))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12163), inst: 4829 })
...
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2638)), TypeDefinitionIndex(TypeDefinitionIndex(12163))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12163), inst: 5162 })
// CS Name: UnityEngine.ProBuilder.SimpleTuple`3
