...
/// @brief Method get_isEditing addr 0x29d394c size 0x8 virtual false final false
 bool get_isEditing() ;

/// @brief Method set_isEditing addr 0x29d3954 size 0xc virtual false final false
 void set_isEditing(bool value) ;

/// @brief Method get_mesh addr 0x29d3960 size 0x94 virtual false final false
 UnityEngine::ProBuilder::ProBuilderMesh get_mesh() ;

/// @brief Method set_mesh addr 0x29d39f4 size 0x8 virtual false final false
 void set_mesh(UnityEngine::ProBuilder::ProBuilderMesh value) ;

/// @brief Method Init addr 0x29d39fc size 0x260 virtual false final false
 void Init() ;

/// @brief Method Refresh addr 0x29d3c5c size 0xc0 virtual false final false
 void Refresh() ;

// Ctor Parameters []
explicit BezierShape() ;

/// @brief Method .ctor addr 0x29d3d1c size 0x98 virtual false final false
 void _ctor() ;
