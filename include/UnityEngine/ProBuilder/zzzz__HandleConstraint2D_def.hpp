...
/// @brief Method .ctor addr 0x29ddc6c size 0x2c virtual false final false
 void _ctor(int32_t x, int32_t y) ;

/// @brief Method Inverse addr 0x29ddc98 size 0x80 virtual false final false
 UnityEngine::ProBuilder::HandleConstraint2D Inverse() ;

/// @brief Method Mask addr 0x29ddd18 size 0x18 virtual false final false
 UnityEngine::Vector2 Mask(UnityEngine::Vector2 v) ;

/// @brief Method InverseMask addr 0x29ddd30 size 0x28 virtual false final false
 UnityEngine::Vector2 InverseMask(UnityEngine::Vector2 v) ;

/// @brief Method op_Equality addr 0x29ddd58 size 0x40 virtual false final false
static bool op_Equality(UnityEngine::ProBuilder::HandleConstraint2D a, UnityEngine::ProBuilder::HandleConstraint2D b) ;

/// @brief Method op_Inequality addr 0x29ddd98 size 0x40 virtual false final false
static bool op_Inequality(UnityEngine::ProBuilder::HandleConstraint2D a, UnityEngine::ProBuilder::HandleConstraint2D b) ;

/// @brief Method GetHashCode addr 0x29dddd8 size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x29ddde0 size 0x80 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method ToString addr 0x29dde60 size 0x1a4 virtual true final false
 ::StringW ToString() ;
