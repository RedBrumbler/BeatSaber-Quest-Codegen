...
/// @brief Method SetPivot addr 0x2a56cec size 0xc0 virtual false final false
static void SetPivot(UnityEngine::ProBuilder::ProBuilderMesh mesh, UnityEngine::ProBuilder::PivotLocation pivotLocation) ;

/// @brief Method CenterPivot addr 0x2a524cc size 0x2f8 virtual false final false
static void CenterPivot(UnityEngine::ProBuilder::ProBuilderMesh mesh, ::ArrayW<int32_t> indexes) ;

/// @brief Method SetPivot addr 0x2a56dac size 0x1a4 virtual false final false
static void SetPivot(UnityEngine::ProBuilder::ProBuilderMesh mesh, UnityEngine::Vector3 worldPosition) ;

/// @brief Method FreezeScaleTransform addr 0x2a56f50 size 0x164 virtual false final false
