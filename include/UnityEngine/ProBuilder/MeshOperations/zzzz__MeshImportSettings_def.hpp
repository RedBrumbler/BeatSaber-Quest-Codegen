...
/// @brief Method get_quads addr 0x2a55358 size 0x8 virtual false final false
 bool get_quads() ;

/// @brief Method set_quads addr 0x2a55360 size 0xc virtual false final false
 void set_quads(bool value) ;

/// @brief Method get_smoothing addr 0x2a5536c size 0x8 virtual false final false
 bool get_smoothing() ;

/// @brief Method set_smoothing addr 0x2a55374 size 0xc virtual false final false
 void set_smoothing(bool value) ;

/// @brief Method get_smoothingAngle addr 0x2a55380 size 0x8 virtual false final false
 float_t get_smoothingAngle() ;

/// @brief Method set_smoothingAngle addr 0x2a55388 size 0x8 virtual false final false
 void set_smoothingAngle(float_t value) ;

/// @brief Method ToString addr 0x2a55390 size 0xd8 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit MeshImportSettings() ;

/// @brief Method .ctor addr 0x2a55468 size 0x18 virtual false final false
 void _ctor() ;
