...
/// @brief Method .ctor addr 0x2a53f58 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <CreateMeshWithTransform>b__1_0 addr 0x2a53f60 size 0x18 virtual false final false
 ::ArrayW<UnityEngine::Vector3> _CreateMeshWithTransform_b__1_0(UnityEngine::Mesh x) ;

/// @brief Method <CreateMeshWithTransform>b__1_1 addr 0x2a53f78 size 0x18 virtual false final false
 ::ArrayW<UnityEngine::Color> _CreateMeshWithTransform_b__1_1(UnityEngine::Mesh x) ;

/// @brief Method <CreateMeshWithTransform>b__1_2 addr 0x2a53f90 size 0x18 virtual false final false
 ::ArrayW<UnityEngine::Vector2> _CreateMeshWithTransform_b__1_2(UnityEngine::Mesh x) ;

/// @brief Method <ResetPbObjectWithMeshFilter>b__2_0 addr 0x2a53fa8 size 0x18 virtual false final false
 ::ArrayW<UnityEngine::Vector3> _ResetPbObjectWithMeshFilter_b__2_0(UnityEngine::Mesh x) ;

/// @brief Method <ResetPbObjectWithMeshFilter>b__2_1 addr 0x2a53fc0 size 0x18 virtual false final false
 ::ArrayW<UnityEngine::Color> _ResetPbObjectWithMeshFilter_b__2_1(UnityEngine::Mesh x) ;

/// @brief Method <ResetPbObjectWithMeshFilter>b__2_2 addr 0x2a53fd8 size 0x18 virtual false final false
 ::ArrayW<UnityEngine::Vector2> _ResetPbObjectWithMeshFilter_b__2_2(UnityEngine::Mesh x) ;

/// @brief Method <FilterUnusedSubmeshIndexes>b__3_0 addr 0x2a53ff0 size 0xc virtual false final false
...
/// @brief Method AverageNormalWithIndexes addr 0x2a4fe9c size 0x194 virtual false final false
...
/// @brief Method CreateMeshWithTransform addr 0x2a513d0 size 0x10fc virtual false final false
static UnityEngine::ProBuilder::ProBuilderMesh CreateMeshWithTransform(UnityEngine::Transform t, bool preserveFaces) ;

/// @brief Method ResetPbObjectWithMeshFilter addr 0x2a527c4 size 0x11d8 virtual false final false
static bool ResetPbObjectWithMeshFilter(UnityEngine::ProBuilder::ProBuilderMesh pb, bool preserveFaces) ;

/// @brief Method FilterUnusedSubmeshIndexes addr 0x2a5399c size 0x558 virtual false final false
