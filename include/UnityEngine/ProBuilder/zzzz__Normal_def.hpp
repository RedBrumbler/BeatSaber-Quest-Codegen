...
/// @brief Method get_normal addr 0x29f02bc size 0xc virtual false final false
 UnityEngine::Vector3 get_normal() ;

/// @brief Method set_normal addr 0x29f02c8 size 0xc virtual false final false
 void set_normal(UnityEngine::Vector3 value) ;

/// @brief Method get_tangent addr 0x29f02d4 size 0xc virtual false final false
 UnityEngine::Vector4 get_tangent() ;

/// @brief Method set_tangent addr 0x29f02e0 size 0xc virtual false final false
 void set_tangent(UnityEngine::Vector4 value) ;

/// @brief Method get_bitangent addr 0x29f02ec size 0xc virtual false final false
 UnityEngine::Vector3 get_bitangent() ;

/// @brief Method set_bitangent addr 0x29f02f8 size 0xc virtual false final false
 void set_bitangent(UnityEngine::Vector3 value) ;

/// @brief Method Equals addr 0x29f0304 size 0x90 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x29f042c size 0x64 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x29f0394 size 0x98 virtual true final true
 bool Equals(UnityEngine::ProBuilder::Normal other) ;

/// @brief Method op_Equality addr 0x29f0490 size 0x30 virtual false final false
static bool op_Equality(UnityEngine::ProBuilder::Normal a, UnityEngine::ProBuilder::Normal b) ;

/// @brief Method op_Inequality addr 0x29f04c0 size 0x48 virtual false final false
