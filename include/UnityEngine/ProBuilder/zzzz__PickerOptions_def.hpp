...
/// @brief Method get_depthTest addr 0x2a0280c size 0x8 virtual false final false
 bool get_depthTest() ;

/// @brief Method set_depthTest addr 0x2a02814 size 0xc virtual false final false
 void set_depthTest(bool value) ;

/// @brief Method get_rectSelectMode addr 0x2a02820 size 0x8 virtual false final false
 UnityEngine::ProBuilder::RectSelectMode get_rectSelectMode() ;

/// @brief Method set_rectSelectMode addr 0x2a02828 size 0x8 virtual false final false
 void set_rectSelectMode(UnityEngine::ProBuilder::RectSelectMode value) ;

/// @brief Method get_Default addr 0x2a02830 size 0x58 virtual false final false
static UnityEngine::ProBuilder::PickerOptions get_Default() ;

/// @brief Method Equals addr 0x2a02888 size 0x98 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2a02920 size 0x38 virtual false final false
 bool Equals(UnityEngine::ProBuilder::PickerOptions other) ;

/// @brief Method GetHashCode addr 0x2a02958 size 0x3c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x2a02994 size 0x34 virtual false final false
static bool op_Equality(UnityEngine::ProBuilder::PickerOptions a, UnityEngine::ProBuilder::PickerOptions b) ;

/// @brief Method op_Inequality addr 0x2a029c8 size 0x34 virtual false final false
