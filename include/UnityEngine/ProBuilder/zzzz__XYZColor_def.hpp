...
/// @brief Method .ctor addr 0x29d8e6c size 0x3c virtual false final false
 void _ctor(float_t x, float_t y, float_t z) ;

/// @brief Method FromRGB addr 0x29d8ea8 size 0x7c virtual false final false
static UnityEngine::ProBuilder::XYZColor FromRGB(UnityEngine::Color col) ;

/// @brief Method FromRGB addr 0x29d8f98 size 0x74 virtual false final false
static UnityEngine::ProBuilder::XYZColor FromRGB(float_t R, float_t G, float_t B) ;

/// @brief Method ToString addr 0x29d91a8 size 0xc4 virtual true final false
 ::StringW ToString() ;
