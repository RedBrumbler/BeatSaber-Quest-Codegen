...
/// @brief Method get_entityType addr 0x29db7d8 size 0x8 virtual false final false
 UnityEngine::ProBuilder::EntityType get_entityType() ;

/// @brief Method Awake addr 0x29db7e0 size 0xc8 virtual false final false
 void Awake() ;

/// @brief Method SetEntity addr 0x29db8a8 size 0x8 virtual false final false
 void SetEntity(UnityEngine::ProBuilder::EntityType t) ;

// Ctor Parameters []
explicit Entity() ;

/// @brief Method .ctor addr 0x29db8b0 size 0x8 virtual false final false
 void _ctor() ;
