...
/// @brief Method get_hardAngle addr 0x2a19808 size 0x8 virtual false final false
 float_t get_hardAngle() ;

/// @brief Method set_hardAngle addr 0x2a19810 size 0x8 virtual false final false
 void set_hardAngle(float_t value) ;

/// @brief Method get_packMargin addr 0x2a19818 size 0x8 virtual false final false
 float_t get_packMargin() ;

/// @brief Method set_packMargin addr 0x2a19820 size 0x8 virtual false final false
 void set_packMargin(float_t value) ;

/// @brief Method get_angleError addr 0x2a19828 size 0x8 virtual false final false
 float_t get_angleError() ;

/// @brief Method set_angleError addr 0x2a19830 size 0x8 virtual false final false
 void set_angleError(float_t value) ;

/// @brief Method get_areaError addr 0x2a19838 size 0x8 virtual false final false
 float_t get_areaError() ;

/// @brief Method set_areaError addr 0x2a19840 size 0x8 virtual false final false
 void set_areaError(float_t value) ;

// Ctor Parameters []
explicit UnwrapParameters() ;

/// @brief Method .ctor addr 0x2a11f54 size 0x38 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2a19858 size 0x88 virtual false final false
 void _ctor(UnityEngine::ProBuilder::UnwrapParameters other) ;

/// @brief Method Reset addr 0x2a19848 size 0x10 virtual false final false
 void Reset() ;

/// @brief Method ToString addr 0x2a198e0 size 0x1ac virtual true final false
 ::StringW ToString() ;
