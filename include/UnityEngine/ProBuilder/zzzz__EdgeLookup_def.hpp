...
/// @brief Method .ctor addr 0x29daad8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetEdgeLookup>b__0 addr 0x29dae7c size 0x84 virtual false final false
...
/// @brief Method get_local addr 0x29da5d8 size 0x8 virtual false final false
 UnityEngine::ProBuilder::Edge get_local() ;

/// @brief Method set_local addr 0x29da5e0 size 0x8 virtual false final false
 void set_local(UnityEngine::ProBuilder::Edge value) ;

/// @brief Method get_common addr 0x29da5e8 size 0x8 virtual false final false
 UnityEngine::ProBuilder::Edge get_common() ;

/// @brief Method set_common addr 0x29da5f0 size 0x8 virtual false final false
 void set_common(UnityEngine::ProBuilder::Edge value) ;

/// @brief Method .ctor addr 0x29da5f8 size 0x8 virtual false final false
 void _ctor(UnityEngine::ProBuilder::Edge common, UnityEngine::ProBuilder::Edge local) ;

/// @brief Method .ctor addr 0x29da600 size 0x18 virtual false final false
 void _ctor(int32_t cx, int32_t cy, int32_t x, int32_t y) ;

/// @brief Method Equals addr 0x29da618 size 0x38 virtual true final true
 bool Equals(UnityEngine::ProBuilder::EdgeLookup other) ;

/// @brief Method Equals addr 0x29da650 size 0xa8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x29da6f8 size 0x24 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x29da71c size 0x9c virtual false final false
static bool op_Equality(UnityEngine::ProBuilder::EdgeLookup a, UnityEngine::ProBuilder::EdgeLookup b) ;

/// @brief Method op_Inequality addr 0x29da7b8 size 0xa0 virtual false final false
static bool op_Inequality(UnityEngine::ProBuilder::EdgeLookup a, UnityEngine::ProBuilder::EdgeLookup b) ;

/// @brief Method ToString addr 0x29da858 size 0x1ac virtual true final false
 ::StringW ToString() ;

/// @brief Method GetEdgeLookup addr 0x29daa04 size 0xd4 virtual false final false
...
/// @brief Method GetEdgeLookupHashSet addr 0x29daae0 size 0x39c virtual false final false
