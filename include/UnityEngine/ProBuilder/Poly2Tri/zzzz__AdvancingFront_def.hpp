...
/// @brief Method .ctor addr 0x29cc284 size 0x30 virtual false final false
...
/// @brief Method AddNode addr 0x29cc2b4 size 0x4 virtual false final false
 void AddNode(UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode node) ;

/// @brief Method RemoveNode addr 0x29cc2b8 size 0x4 virtual false final false
 void RemoveNode(UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode node) ;

/// @brief Method ToString addr 0x29cc2bc size 0xe8 virtual true final false
 ::StringW ToString() ;

/// @brief Method FindSearchNode addr 0x29cc3a4 size 0x8 virtual false final false
 UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode FindSearchNode(double_t x) ;

/// @brief Method LocateNode addr 0x29cc3ac size 0x18 virtual false final false
 UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode LocateNode(UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint point) ;

/// @brief Method LocateNode addr 0x29cc3c4 size 0x5c virtual false final false
 UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode LocateNode(double_t x) ;

/// @brief Method LocatePoint addr 0x29cc420 size 0xf4 virtual false final false
