...
/// @brief Method .ctor addr 0x29cc514 size 0x38 virtual false final false
 void _ctor(UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint point) ;

/// @brief Method get_HasNext addr 0x29cc54c size 0x10 virtual false final false
 bool get_HasNext() ;

/// @brief Method get_HasPrev addr 0x29cc55c size 0x10 virtual false final false
 bool get_HasPrev() ;
