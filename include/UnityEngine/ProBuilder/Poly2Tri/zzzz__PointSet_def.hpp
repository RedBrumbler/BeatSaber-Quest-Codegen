...
/// @brief Method .ctor addr 0x29d05ec size 0x90 virtual false final false
 void _ctor(System::Collections::Generic::List_1<UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint> points) ;

/// @brief Method get_TriangulationMode addr 0x29d09f0 size 0x8 virtual true final false
 UnityEngine::ProBuilder::Poly2Tri::TriangulationMode get_TriangulationMode() ;

/// @brief Method AddTriangle addr 0x29d09f8 size 0xac virtual true final true
 void AddTriangle(UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle t) ;

/// @brief Method AddTriangles addr 0x29d0aa4 size 0x35c virtual true final true
 void AddTriangles(System::Collections::Generic::IEnumerable_1<UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle> list) ;

/// @brief Method ClearTriangles addr 0x29d0e00 size 0xa4 virtual true final true
 void ClearTriangles() ;

/// @brief Method Prepare addr 0x29d0828 size 0x1a8 virtual true final false
