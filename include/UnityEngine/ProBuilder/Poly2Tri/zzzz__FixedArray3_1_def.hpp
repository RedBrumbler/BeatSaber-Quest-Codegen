...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15391))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15391), inst: 2 })
...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2638)), TypeDefinitionIndex(TypeDefinitionIndex(15392))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15392), inst: 2 })
