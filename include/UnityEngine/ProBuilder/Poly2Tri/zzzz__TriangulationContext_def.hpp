...
/// @brief Method get_DebugContext addr 0x29d0ea4 size 0x8 virtual false final false
 UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext get_DebugContext() ;

/// @brief Method set_DebugContext addr 0x29d0eac size 0x8 virtual false final false
 void set_DebugContext(UnityEngine::ProBuilder::Poly2Tri::TriangulationDebugContext value) ;

/// @brief Method get_TriangulationMode addr 0x29d0eb4 size 0x8 virtual false final false
 UnityEngine::ProBuilder::Poly2Tri::TriangulationMode get_TriangulationMode() ;

/// @brief Method set_TriangulationMode addr 0x29d0ebc size 0x8 virtual false final false
 void set_TriangulationMode(UnityEngine::ProBuilder::Poly2Tri::TriangulationMode value) ;

/// @brief Method get_Triangulatable addr 0x29d0ec4 size 0x8 virtual false final false
 UnityEngine::ProBuilder::Poly2Tri::Triangulatable get_Triangulatable() ;

/// @brief Method set_Triangulatable addr 0x29d0ecc size 0x8 virtual false final false
 void set_Triangulatable(UnityEngine::ProBuilder::Poly2Tri::Triangulatable value) ;

/// @brief Method get_StepCount addr 0x29d0ed4 size 0x8 virtual false final false
 int32_t get_StepCount() ;

/// @brief Method set_StepCount addr 0x29d0edc size 0x8 virtual false final false
 void set_StepCount(int32_t value) ;

/// @brief Method Done addr 0x29cccd4 size 0x10 virtual false final false
 void Done() ;
...
/// @brief Method PrepareTriangulation addr 0x29d0300 size 0x108 virtual true final false
...
/// @brief Method Update addr 0x29cd04c size 0x4 virtual false final false
 void Update(::StringW message) ;

/// @brief Method Clear addr 0x29cffdc size 0x80 virtual true final false
 void Clear() ;

/// @brief Method get_IsDebugEnabled addr 0x29d0ee4 size 0x8 virtual true final false
 bool get_IsDebugEnabled() ;

/// @brief Method set_IsDebugEnabled addr 0x29d0eec size 0xc virtual true final false
 void set_IsDebugEnabled(bool value) ;

/// @brief Method get_DTDebugContext addr 0x29cce00 size 0x7c virtual false final false
 UnityEngine::ProBuilder::Poly2Tri::DTSweepDebugContext get_DTDebugContext() ;

// Ctor Parameters []
explicit TriangulationContext() ;

/// @brief Method .ctor addr 0x29cfcd4 size 0xc0 virtual false final false
 void _ctor() ;
