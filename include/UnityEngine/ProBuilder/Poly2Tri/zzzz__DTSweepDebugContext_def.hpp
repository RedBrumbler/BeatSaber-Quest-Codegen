...
namespace UnityEngine::ProBuilder::Poly2Tri {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15385))}
...
/// @brief Method get_PrimaryTriangle addr 0x29d0480 size 0x8 virtual false final false
 UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle get_PrimaryTriangle() ;

/// @brief Method set_PrimaryTriangle addr 0x29ce090 size 0x4c virtual false final false
 void set_PrimaryTriangle(UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle value) ;

/// @brief Method get_SecondaryTriangle addr 0x29d0488 size 0x8 virtual false final false
 UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle get_SecondaryTriangle() ;

/// @brief Method set_SecondaryTriangle addr 0x29cf188 size 0x4c virtual false final false
 void set_SecondaryTriangle(UnityEngine::ProBuilder::Poly2Tri::DelaunayTriangle value) ;

/// @brief Method get_ActivePoint addr 0x29d0490 size 0x8 virtual false final false
 UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint get_ActivePoint() ;

/// @brief Method set_ActivePoint addr 0x29d0498 size 0x4c virtual false final false
 void set_ActivePoint(UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint value) ;

/// @brief Method get_ActiveNode addr 0x29d04e4 size 0x8 virtual false final false
 UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode get_ActiveNode() ;

/// @brief Method set_ActiveNode addr 0x29cd898 size 0x4c virtual false final false
 void set_ActiveNode(UnityEngine::ProBuilder::Poly2Tri::AdvancingFrontNode value) ;

/// @brief Method get_ActiveConstraint addr 0x29d04ec size 0x8 virtual false final false
 UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint get_ActiveConstraint() ;

/// @brief Method set_ActiveConstraint addr 0x29cce7c size 0x4c virtual false final false
...
/// @brief Method .ctor addr 0x29cfe18 size 0x28 virtual false final false
 void _ctor(UnityEngine::ProBuilder::Poly2Tri::DTSweepContext tcx) ;

/// @brief Method get_IsDebugContext addr 0x29d051c size 0x8 virtual false final false
 bool get_IsDebugContext() ;

/// @brief Method Clear addr 0x29d0524 size 0x44 virtual true final false
 void Clear() ;
