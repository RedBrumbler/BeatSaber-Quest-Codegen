...
/// @brief Method Triangulate addr 0x29c904c size 0x324 virtual false final false
static void Triangulate(UnityEngine::ProBuilder::Poly2Tri::PolygonSet ps) ;

/// @brief Method Triangulate addr 0x29c9458 size 0x3c virtual false final false
static void Triangulate(UnityEngine::ProBuilder::Poly2Tri::Polygon p) ;

/// @brief Method Triangulate addr 0x29c94d0 size 0x3c virtual false final false
static void Triangulate(UnityEngine::ProBuilder::Poly2Tri::ConstrainedPointSet cps) ;

/// @brief Method Triangulate addr 0x29c950c size 0x3c virtual false final false
static void Triangulate(UnityEngine::ProBuilder::Poly2Tri::PointSet ps) ;

/// @brief Method CreateContext addr 0x29c9370 size 0x58 virtual false final false
...
/// @brief Method Triangulate addr 0x29c9494 size 0x3c virtual false final false
...
/// @brief Method Triangulate addr 0x29c93c8 size 0x90 virtual false final false
static void Triangulate(UnityEngine::ProBuilder::Poly2Tri::TriangulationContext tcx) ;

/// @brief Method Warmup addr 0x29c9674 size 0x4 virtual false final false
static void Warmup() ;
