...
/// @brief Method get_Edges addr 0x29d0ef8 size 0x8 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint> get_Edges() ;

/// @brief Method set_Edges addr 0x29d0f00 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x29ca9c4 size 0x3c virtual false final false
 void _ctor(double_t x, double_t y, int32_t index) ;

/// @brief Method ToString addr 0x29d0f08 size 0x1a4 virtual true final false
 ::StringW ToString() ;

/// @brief Method get_Xf addr 0x29d10ac size 0xc virtual false final false
 float_t get_Xf() ;

/// @brief Method set_Xf addr 0x29d10b8 size 0xc virtual false final false
 void set_Xf(float_t value) ;

/// @brief Method get_Yf addr 0x29d10c4 size 0xc virtual false final false
 float_t get_Yf() ;

/// @brief Method set_Yf addr 0x29d10d0 size 0xc virtual false final false
 void set_Yf(float_t value) ;

/// @brief Method AddEdge addr 0x29cfbb4 size 0xf0 virtual false final false
 void AddEdge(UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint e) ;

/// @brief Method get_HasEdges addr 0x29ccdf0 size 0x10 virtual false final false
 bool get_HasEdges() ;
