...
/// @brief Method get_major addr 0x2a08c80 size 0x8 virtual false final false
 int32_t get_major() ;

/// @brief Method get_minor addr 0x2a08c88 size 0x8 virtual false final false
 int32_t get_minor() ;

/// @brief Method get_patch addr 0x2a08c90 size 0x8 virtual false final false
 int32_t get_patch() ;

/// @brief Method get_build addr 0x2a08c98 size 0x8 virtual false final false
 int32_t get_build() ;

/// @brief Method get_type addr 0x2a08ca0 size 0x50 virtual false final false
 ::StringW get_type() ;

/// @brief Method get_metadata addr 0x2a08cf0 size 0x50 virtual false final false
 ::StringW get_metadata() ;

/// @brief Method get_date addr 0x2a08d40 size 0x50 virtual false final false
 ::StringW get_date() ;

/// @brief Method get_MajorMinorPatch addr 0x2a08d90 size 0x8c virtual false final false
 UnityEngine::ProBuilder::SemVer get_MajorMinorPatch() ;

// Ctor Parameters []
explicit SemVer() ;

/// @brief Method .ctor addr 0x2a08e88 size 0x34 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2a08ebc size 0xa8 virtual false final false
...
/// @brief Method .ctor addr 0x2a08e1c size 0x6c virtual false final false
 void _ctor(int32_t major, int32_t minor, int32_t patch, int32_t build, ::StringW type, ::StringW date, ::StringW metadata) ;

/// @brief Method IsValid addr 0x2a09348 size 0x30 virtual false final false
 bool IsValid() ;

/// @brief Method Equals addr 0x2a09378 size 0x70 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method GetHashCode addr 0x2a095ec size 0x1cc virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2a093e8 size 0x204 virtual true final true
 bool Equals(UnityEngine::ProBuilder::SemVer version) ;

/// @brief Method CompareTo addr 0x2a097b8 size 0x64 virtual true final true
 int32_t CompareTo(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method WrapNoValue addr 0x2a099c8 size 0x10 virtual false final false
static int32_t WrapNoValue(int32_t value) ;

/// @brief Method CompareTo addr 0x2a0981c size 0x1ac virtual true final true
 int32_t CompareTo(UnityEngine::ProBuilder::SemVer version) ;

/// @brief Method op_Equality addr 0x2a099d8 size 0x14 virtual false final false
static bool op_Equality(UnityEngine::ProBuilder::SemVer left, UnityEngine::ProBuilder::SemVer right) ;

/// @brief Method op_Inequality addr 0x2a099ec size 0x28 virtual false final false
static bool op_Inequality(UnityEngine::ProBuilder::SemVer left, UnityEngine::ProBuilder::SemVer right) ;

/// @brief Method op_LessThan addr 0x2a09a14 size 0x24 virtual false final false
static bool op_LessThan(UnityEngine::ProBuilder::SemVer left, UnityEngine::ProBuilder::SemVer right) ;

/// @brief Method op_GreaterThan addr 0x2a09a38 size 0x1c virtual false final false
static bool op_GreaterThan(UnityEngine::ProBuilder::SemVer left, UnityEngine::ProBuilder::SemVer right) ;

/// @brief Method op_LessThanOrEqual addr 0x2a09a54 size 0x40 virtual false final false
static bool op_LessThanOrEqual(UnityEngine::ProBuilder::SemVer left, UnityEngine::ProBuilder::SemVer right) ;

/// @brief Method op_GreaterThanOrEqual addr 0x2a09a94 size 0x54 virtual false final false
static bool op_GreaterThanOrEqual(UnityEngine::ProBuilder::SemVer left, UnityEngine::ProBuilder::SemVer right) ;

/// @brief Method ToString addr 0x2a09ae8 size 0x210 virtual false final false
 ::StringW ToString(::StringW format) ;

/// @brief Method ToString addr 0x2a09cf8 size 0x230 virtual true final false
 ::StringW ToString() ;

/// @brief Method TryGetVersionInfo addr 0x2a08f64 size 0x3e4 virtual false final false
static bool TryGetVersionInfo(::StringW input, ByRef<UnityEngine::ProBuilder::SemVer> version) ;

/// @brief Method GetBuildNumber addr 0x2a09f28 size 0xc8 virtual false final false
