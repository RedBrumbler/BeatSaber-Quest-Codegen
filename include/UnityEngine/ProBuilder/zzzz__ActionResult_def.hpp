...
/// @brief Method get_status addr 0x29d1f1c size 0x8 virtual false final false
 UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status get_status() ;

/// @brief Method set_status addr 0x29d1f24 size 0x8 virtual false final false
 void set_status(UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status value) ;

/// @brief Method get_notification addr 0x29d1f2c size 0x8 virtual false final false
 ::StringW get_notification() ;

/// @brief Method set_notification addr 0x29d1f34 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x29d1f3c size 0x30 virtual false final false
 void _ctor(UnityEngine::ProBuilder::UnityEngine__ProBuilder__ActionResult__Status status, ::StringW notification) ;

/// @brief Method op_Implicit addr 0x29d1f6c size 0x14 virtual false final false
static bool op_Implicit_bool(UnityEngine::ProBuilder::ActionResult res) ;

/// @brief Method ToBool addr 0x29d1f80 size 0x10 virtual false final false
 bool ToBool() ;

/// @brief Method FromBool addr 0x29d1f90 size 0xa0 virtual false final false
static bool FromBool(bool success) ;

/// @brief Method get_Success addr 0x29d2030 size 0x7c virtual false final false
static UnityEngine::ProBuilder::ActionResult get_Success() ;

/// @brief Method get_NoSelection addr 0x29d20ac size 0x80 virtual false final false
static UnityEngine::ProBuilder::ActionResult get_NoSelection() ;

/// @brief Method get_UserCanceled addr 0x29d212c size 0x80 virtual false final false
