...
/// @brief Method get_controlPoints addr 0x29f1650 size 0x7c virtual false final false
 System::Collections::ObjectModel::ReadOnlyCollection_1<UnityEngine::Vector3> get_controlPoints() ;

/// @brief Method SetControlPoints addr 0x29f16cc size 0x5c virtual false final false
 void SetControlPoints(System::Collections::Generic::IList_1<UnityEngine::Vector3> points) ;

/// @brief Method get_extrude addr 0x29f1728 size 0x8 virtual false final false
 float_t get_extrude() ;

/// @brief Method set_extrude addr 0x29f1730 size 0x8 virtual false final false
 void set_extrude(float_t value) ;

/// @brief Method get_polyEditMode addr 0x29f1738 size 0x8 virtual false final false
 UnityEngine::ProBuilder::UnityEngine__ProBuilder__PolyShape__PolyEditMode get_polyEditMode() ;

/// @brief Method set_polyEditMode addr 0x29f1740 size 0x8 virtual false final false
 void set_polyEditMode(UnityEngine::ProBuilder::UnityEngine__ProBuilder__PolyShape__PolyEditMode value) ;

/// @brief Method get_flipNormals addr 0x29f1748 size 0x8 virtual false final false
 bool get_flipNormals() ;

/// @brief Method set_flipNormals addr 0x29f1750 size 0xc virtual false final false
 void set_flipNormals(bool value) ;

/// @brief Method get_mesh addr 0x29f175c size 0x94 virtual false final false
 UnityEngine::ProBuilder::ProBuilderMesh get_mesh() ;

/// @brief Method set_mesh addr 0x29f17f0 size 0x8 virtual false final false
 void set_mesh(UnityEngine::ProBuilder::ProBuilderMesh value) ;

/// @brief Method IsSnapEnabled addr 0x29f17f8 size 0x8 virtual false final false
 bool IsSnapEnabled() ;

// Ctor Parameters []
explicit PolyShape() ;

/// @brief Method .ctor addr 0x29f1800 size 0x84 virtual false final false
 void _ctor() ;
