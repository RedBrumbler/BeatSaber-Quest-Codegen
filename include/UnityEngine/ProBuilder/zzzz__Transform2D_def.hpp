...
/// @brief Method .ctor addr 0x2a1885c size 0x50 virtual false final false
 void _ctor(UnityEngine::Vector2 position, float_t rotation, UnityEngine::Vector2 scale) ;

/// @brief Method TransformPoint addr 0x2a188ac size 0x64 virtual false final false
 UnityEngine::Vector2 TransformPoint(UnityEngine::Vector2 p) ;

/// @brief Method ToString addr 0x2a18910 size 0x1f4 virtual true final false
 ::StringW ToString() ;
