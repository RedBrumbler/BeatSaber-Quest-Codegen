...
/// @brief Method .ctor addr 0x29d8a40 size 0x3c virtual false final false
...
/// @brief Method .ctor addr 0x29d8a7c size 0x48 virtual false final false
 void _ctor(float_t h, float_t s, float_t v, float_t sv_modifier) ;

/// @brief Method FromRGB addr 0x29d8ac4 size 0x7c virtual false final false
static UnityEngine::ProBuilder::HSVColor FromRGB(UnityEngine::Color col) ;

/// @brief Method ToString addr 0x29d8d60 size 0xc4 virtual true final false
 ::StringW ToString() ;

/// @brief Method SqrDistance addr 0x29d8e24 size 0x48 virtual false final false
