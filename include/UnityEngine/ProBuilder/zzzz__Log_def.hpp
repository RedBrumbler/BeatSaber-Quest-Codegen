...
/// @brief Method PushLogLevel addr 0x29e2b38 size 0x90 virtual false final false
static void PushLogLevel(UnityEngine::ProBuilder::LogLevel level) ;

/// @brief Method PopLogLevel addr 0x29e2bc8 size 0x88 virtual false final false
static void PopLogLevel() ;

/// @brief Method SetLogLevel addr 0x29e2c50 size 0x5c virtual false final false
static void SetLogLevel(UnityEngine::ProBuilder::LogLevel level) ;

/// @brief Method SetOutput addr 0x29e2cac size 0x5c virtual false final false
static void SetOutput(UnityEngine::ProBuilder::LogOutput output) ;

/// @brief Method SetLogFile addr 0x29e2d08 size 0x5c virtual false final false
...
/// @brief Method Debug addr 0x29e2d64 size 0x58 virtual false final false
static void Debug(::StringW message) ;

/// @brief Method Debug addr 0x29e2e8c size 0x4 virtual false final false
static void Debug(::StringW format, ::ArrayW<::bs_hook::Il2CppWrapperType> values) ;

/// @brief Method Info addr 0x29e2e90 size 0x78 virtual false final false
static void Info(::StringW format, ::ArrayW<::bs_hook::Il2CppWrapperType> values) ;

/// @brief Method Info addr 0x29e2f08 size 0x80 virtual false final false
static void Info(::StringW message) ;

/// @brief Method Warning addr 0x29e2f88 size 0x78 virtual false final false
static void Warning(::StringW format, ::ArrayW<::bs_hook::Il2CppWrapperType> values) ;

/// @brief Method Warning addr 0x29e3000 size 0x80 virtual false final false
static void Warning(::StringW message) ;

/// @brief Method Error addr 0x29e3080 size 0x78 virtual false final false
static void Error(::StringW format, ::ArrayW<::bs_hook::Il2CppWrapperType> values) ;

/// @brief Method Error addr 0x29d6a6c size 0x80 virtual false final false
...
/// @brief Method DoPrint addr 0x29e2dbc size 0xd0 virtual false final false
static void DoPrint(::StringW message, UnityEngine::LogType type) ;

/// @brief Method PrintToFile addr 0x29e31cc size 0x3d8 virtual false final false
static void PrintToFile(::StringW message, ::StringW path) ;

/// @brief Method ClearLogFile addr 0x29e35a4 size 0x90 virtual false final false
static void ClearLogFile() ;

/// @brief Method PrintToConsole addr 0x29e30f8 size 0xd4 virtual false final false
