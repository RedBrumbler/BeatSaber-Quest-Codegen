...
/// @brief Method CopyShape addr 0x2a23584 size 0x94 virtual true final false
 void CopyShape(UnityEngine::ProBuilder::Shapes::Shape shape) ;

/// @brief Method GetFace addr 0x2a23618 size 0xc4 virtual false final false
 ::ArrayW<UnityEngine::Vector3> GetFace(UnityEngine::Vector2 vertex1, UnityEngine::Vector2 vertex2, float_t depth) ;

/// @brief Method RebuildMesh addr 0x2a236dc size 0xc00 virtual true final false
...
/// @brief Method .ctor addr 0x2a242dc size 0x28 virtual false final false
 void _ctor() ;
