...
/// @brief Method CopyShape addr 0x2a2a488 size 0x84 virtual true final false
 void CopyShape(UnityEngine::ProBuilder::Shapes::Shape shape) ;

/// @brief Method UpdateBounds addr 0x2a2a50c size 0x6c virtual true final false
...
/// @brief Method RebuildMesh addr 0x2a2a578 size 0x8fc virtual true final false
...
/// @brief Method SubdivideIcosahedron addr 0x2a2ae74 size 0x62c virtual false final false
static ::ArrayW<UnityEngine::Vector3> SubdivideIcosahedron(::ArrayW<UnityEngine::Vector3> vertices, float_t radius) ;

// Ctor Parameters []
explicit Sphere() ;

/// @brief Method .ctor addr 0x2a2b4a0 size 0x18 virtual false final false
 void _ctor() ;
