...
/// @brief Method get_shape addr 0x2a293e4 size 0x8 virtual false final false
 UnityEngine::ProBuilder::Shapes::Shape get_shape() ;

/// @brief Method set_shape addr 0x2a293ec size 0x8 virtual false final false
 void set_shape(UnityEngine::ProBuilder::Shapes::Shape value) ;

/// @brief Method get_pivotLocation addr 0x2a293f4 size 0x8 virtual false final false
 UnityEngine::ProBuilder::PivotLocation get_pivotLocation() ;

/// @brief Method set_pivotLocation addr 0x2a293fc size 0x8 virtual false final false
 void set_pivotLocation(UnityEngine::ProBuilder::PivotLocation value) ;

/// @brief Method get_pivotLocalPosition addr 0x2a29404 size 0xc virtual false final false
 UnityEngine::Vector3 get_pivotLocalPosition() ;

/// @brief Method set_pivotLocalPosition addr 0x2a29410 size 0xc virtual false final false
 void set_pivotLocalPosition(UnityEngine::Vector3 value) ;

/// @brief Method get_pivotGlobalPosition addr 0x2a2941c size 0x34 virtual false final false
 UnityEngine::Vector3 get_pivotGlobalPosition() ;

/// @brief Method set_pivotGlobalPosition addr 0x2a29548 size 0x60 virtual false final false
 void set_pivotGlobalPosition(UnityEngine::Vector3 value) ;

/// @brief Method get_size addr 0x2a295a8 size 0xc virtual false final false
 UnityEngine::Vector3 get_size() ;

/// @brief Method set_size addr 0x2a295b4 size 0xbc virtual false final false
 void set_size(UnityEngine::Vector3 value) ;

/// @brief Method get_rotation addr 0x2a29670 size 0xc virtual false final false
 UnityEngine::Quaternion get_rotation() ;

/// @brief Method set_rotation addr 0x2a2967c size 0xc virtual false final false
 void set_rotation(UnityEngine::Quaternion value) ;

/// @brief Method get_editionBounds addr 0x2a29688 size 0xcc virtual false final false
 UnityEngine::Bounds get_editionBounds() ;

/// @brief Method get_shapeBox addr 0x2a29754 size 0x14 virtual false final false
 UnityEngine::Bounds get_shapeBox() ;

/// @brief Method get_isEditable addr 0x2a29768 size 0x28 virtual false final false
 bool get_isEditable() ;

/// @brief Method get_mesh addr 0x2a29450 size 0xf8 virtual false final false
 UnityEngine::ProBuilder::ProBuilderMesh get_mesh() ;

/// @brief Method OnValidate addr 0x2a29790 size 0xa4 virtual false final false
 void OnValidate() ;

/// @brief Method UpdateComponent addr 0x2a29834 size 0x34 virtual false final false
 void UpdateComponent() ;

/// @brief Method UpdateBounds addr 0x2a29c18 size 0xcc virtual false final false
 void UpdateBounds(UnityEngine::Bounds bounds) ;

/// @brief Method Rebuild addr 0x2a29ce4 size 0xec virtual false final false
 void Rebuild(UnityEngine::Bounds bounds, UnityEngine::Quaternion rotation, UnityEngine::Vector3 cornerPivot) ;

/// @brief Method Rebuild addr 0x2a29a84 size 0x194 virtual false final false
 void Rebuild() ;

/// @brief Method SetShape addr 0x2a2a010 size 0x250 virtual false final false
 void SetShape(UnityEngine::ProBuilder::Shapes::Shape shape, UnityEngine::ProBuilder::PivotLocation location) ;

/// @brief Method RotateInsideBounds addr 0x2a2a260 size 0xd4 virtual false final false
 void RotateInsideBounds(UnityEngine::Quaternion deltaRotation) ;

/// @brief Method ResetPivot addr 0x2a29868 size 0x21c virtual false final false
 void ResetPivot(UnityEngine::ProBuilder::ProBuilderMesh mesh, UnityEngine::Vector3 size, UnityEngine::Quaternion rotation) ;

/// @brief Method RebuildPivot addr 0x2a29dd0 size 0x240 virtual false final false
...
/// @brief Method .ctor addr 0x2a2a334 size 0xe0 virtual false final false
 void _ctor() ;
