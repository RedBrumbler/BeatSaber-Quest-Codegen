...
/// @brief Method get_size addr 0x29d3db4 size 0x8 virtual false final false
 UnityEngine::Vector2 get_size() ;

/// @brief Method set_size addr 0x29d3dbc size 0x18 virtual false final false
 void set_size(UnityEngine::Vector2 value) ;

/// @brief Method get_extents addr 0x29d3dd4 size 0x8 virtual false final false
 UnityEngine::Vector2 get_extents() ;

/// @brief Method get_corners addr 0x29d3ddc size 0xc8 virtual false final false
 ::ArrayW<UnityEngine::Vector2> get_corners() ;

// Ctor Parameters []
explicit Bounds2D() ;

/// @brief Method .ctor addr 0x29d3ea4 size 0x70 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x29d3f14 size 0xac virtual false final false
...
/// @brief Method .ctor addr 0x29d3fc0 size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x29d4330 size 0x90 virtual false final false
...
/// @brief Method .ctor addr 0x29d4920 size 0x1c4 virtual false final false
...
/// @brief Method .ctor addr 0x29d4ae4 size 0x14c virtual false final false
 void _ctor(::ArrayW<UnityEngine::Vector2> points, int32_t length) ;

/// @brief Method ContainsPoint addr 0x29d4c30 size 0x54 virtual false final false
 bool ContainsPoint(UnityEngine::Vector2 point) ;

/// @brief Method IntersectsLineSegment addr 0x29d4c84 size 0x198 virtual false final false
 bool IntersectsLineSegment(UnityEngine::Vector2 lineStart, UnityEngine::Vector2 lineEnd) ;

/// @brief Method Intersects addr 0x29d4e94 size 0x64 virtual false final false
 bool Intersects(UnityEngine::ProBuilder::Bounds2D bounds) ;

/// @brief Method Intersects addr 0x29d4ef8 size 0x90 virtual false final false
 bool Intersects(UnityEngine::Rect rect) ;

/// @brief Method SetWithPoints addr 0x29d4040 size 0x2f0 virtual false final false
 void SetWithPoints(System::Collections::Generic::IList_1<UnityEngine::Vector2> points) ;

/// @brief Method SetWithPoints addr 0x29d43c0 size 0x560 virtual false final false
...
/// @brief Method Center addr 0x29d4f88 size 0x2b4 virtual false final false
static UnityEngine::Vector2 Center(System::Collections::Generic::IList_1<UnityEngine::Vector2> points) ;

/// @brief Method Center addr 0x29d523c size 0x458 virtual false final false
...
/// @brief Method Size addr 0x29d5694 size 0x44c virtual false final false
...
/// @brief Method Center addr 0x29d5ae0 size 0x540 virtual false final false
...
/// @brief Method ToString addr 0x29d6020 size 0x1bc virtual true final false
 ::StringW ToString() ;
