...
/// @brief Method get_a addr 0x2a191c8 size 0x8 virtual false final false
 int32_t get_a() ;

/// @brief Method get_b addr 0x2a191d0 size 0x8 virtual false final false
 int32_t get_b() ;

/// @brief Method get_c addr 0x2a191d8 size 0x8 virtual false final false
 int32_t get_c() ;

/// @brief Method get_indices addr 0x2a191e0 size 0x88 virtual false final false
 System::Collections::Generic::IEnumerable_1<int32_t> get_indices() ;

/// @brief Method .ctor addr 0x2a19268 size 0xc virtual false final false
 void _ctor(int32_t a, int32_t b, int32_t c) ;

/// @brief Method Equals addr 0x2a19274 size 0x34 virtual true final true
 bool Equals(UnityEngine::ProBuilder::Triangle other) ;

/// @brief Method Equals addr 0x2a192a8 size 0x98 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2a19340 size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method IsAdjacent addr 0x2a19360 size 0x94 virtual false final false
 bool IsAdjacent(UnityEngine::ProBuilder::Triangle other) ;

/// @brief Method ContainsEdge addr 0x2a193f4 size 0x100 virtual false final false
