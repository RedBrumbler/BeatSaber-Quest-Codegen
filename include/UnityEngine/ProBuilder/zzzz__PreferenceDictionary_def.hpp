...
/// @brief Method OnBeforeSerialize addr 0x29f1884 size 0x314 virtual true final true
 void OnBeforeSerialize() ;

/// @brief Method OnAfterDeserialize addr 0x29f1b98 size 0x3c8 virtual true final true
 void OnAfterDeserialize() ;

/// @brief Method SetDefaultValues addr 0x29f1f60 size 0x104 virtual true final true
 void SetDefaultValues() ;

/// @brief Method HasKey addr 0x29f2064 size 0x144 virtual false final false
...
/// @brief Method DeleteKey addr 0x29f21a8 size 0x234 virtual false final false
...
/// @brief Method GetBool addr 0x29f23dc size 0x88 virtual false final false
 bool GetBool(::StringW key, bool fallback) ;

/// @brief Method GetInt addr 0x29f2464 size 0x7c virtual false final false
 int32_t GetInt(::StringW key, int32_t fallback) ;

/// @brief Method GetFloat addr 0x29f24e0 size 0x7c virtual false final false
 float_t GetFloat(::StringW key, float_t fallback) ;

/// @brief Method GetString addr 0x29f255c size 0x7c virtual false final false
 ::StringW GetString(::StringW key, ::StringW fallback) ;

/// @brief Method GetColor addr 0x29f25d8 size 0xa8 virtual false final false
 UnityEngine::Color GetColor(::StringW key, UnityEngine::Color fallback) ;

/// @brief Method GetMaterial addr 0x29f2680 size 0x7c virtual false final false
 UnityEngine::Material GetMaterial(::StringW key, UnityEngine::Material fallback) ;

/// @brief Method SetBool addr 0x29f26fc size 0xcc virtual false final false
 void SetBool(::StringW key, bool value) ;

/// @brief Method SetInt addr 0x29f27c8 size 0xcc virtual false final false
 void SetInt(::StringW key, int32_t value) ;

/// @brief Method SetFloat addr 0x29f2894 size 0xcc virtual false final false
 void SetFloat(::StringW key, float_t value) ;

/// @brief Method SetString addr 0x29f2960 size 0xcc virtual false final false
 void SetString(::StringW key, ::StringW value) ;

/// @brief Method SetColor addr 0x29f2a2c size 0xfc virtual false final false
 void SetColor(::StringW key, UnityEngine::Color value) ;

/// @brief Method SetMaterial addr 0x29f2b28 size 0xcc virtual false final false
 void SetMaterial(::StringW key, UnityEngine::Material value) ;

/// @brief Method GetBoolDictionary addr 0x29f2bf4 size 0x8 virtual false final false
 System::Collections::Generic::Dictionary_2<::StringW,bool> GetBoolDictionary() ;

/// @brief Method GetIntDictionary addr 0x29f2bfc size 0x8 virtual false final false
 System::Collections::Generic::Dictionary_2<::StringW,int32_t> GetIntDictionary() ;

/// @brief Method GetFloatDictionary addr 0x29f2c04 size 0x8 virtual false final false
 System::Collections::Generic::Dictionary_2<::StringW,float_t> GetFloatDictionary() ;

/// @brief Method GetStringDictionary addr 0x29f2c0c size 0x8 virtual false final false
 System::Collections::Generic::Dictionary_2<::StringW,::StringW> GetStringDictionary() ;

/// @brief Method GetColorDictionary addr 0x29f2c14 size 0x8 virtual false final false
 System::Collections::Generic::Dictionary_2<::StringW,UnityEngine::Color> GetColorDictionary() ;

/// @brief Method GetMaterialDictionary addr 0x29f2c1c size 0x8 virtual false final false
 System::Collections::Generic::Dictionary_2<::StringW,UnityEngine::Material> GetMaterialDictionary() ;

/// @brief Method Clear addr 0x29f2c24 size 0xe0 virtual false final false
 void Clear() ;

// Ctor Parameters []
explicit PreferenceDictionary() ;

/// @brief Method .ctor addr 0x29f2d04 size 0x1d0 virtual false final false
 void _ctor() ;
