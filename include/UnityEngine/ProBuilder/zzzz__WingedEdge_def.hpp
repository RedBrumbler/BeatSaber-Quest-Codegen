...
/// @brief Method .ctor addr 0x2a22b24 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SortCommonIndexesByAdjacency>b__0 addr 0x2a233f4 size 0x84 virtual false final false
...
/// @brief Method .ctor addr 0x2a234dc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SortCommonIndexesByAdjacency>b__32_1 addr 0x2a234e4 size 0x18 virtual false final false
 UnityEngine::ProBuilder::Edge _SortCommonIndexesByAdjacency_b__32_1(UnityEngine::ProBuilder::WingedEdge y) ;

/// @brief Method <SortCommonIndexesByAdjacency>b__32_2 addr 0x2a234fc size 0x8 virtual false final false
...
/// @brief Method get_edge addr 0x2a21954 size 0xc virtual false final false
 UnityEngine::ProBuilder::EdgeLookup get_edge() ;

/// @brief Method set_edge addr 0x2a21960 size 0x8 virtual false final false
 void set_edge(UnityEngine::ProBuilder::EdgeLookup value) ;

/// @brief Method get_face addr 0x2a21968 size 0x8 virtual false final false
 UnityEngine::ProBuilder::Face get_face() ;

/// @brief Method set_face addr 0x2a21970 size 0x8 virtual false final false
 void set_face(UnityEngine::ProBuilder::Face value) ;

/// @brief Method get_next addr 0x2a21978 size 0x8 virtual false final false
 UnityEngine::ProBuilder::WingedEdge get_next() ;

/// @brief Method set_next addr 0x2a21980 size 0x8 virtual false final false
 void set_next(UnityEngine::ProBuilder::WingedEdge value) ;

/// @brief Method get_previous addr 0x2a21988 size 0x8 virtual false final false
 UnityEngine::ProBuilder::WingedEdge get_previous() ;

/// @brief Method set_previous addr 0x2a21990 size 0x8 virtual false final false
 void set_previous(UnityEngine::ProBuilder::WingedEdge value) ;

/// @brief Method get_opposite addr 0x2a21998 size 0x8 virtual false final false
 UnityEngine::ProBuilder::WingedEdge get_opposite() ;

/// @brief Method set_opposite addr 0x2a219a0 size 0x8 virtual false final false
 void set_opposite(UnityEngine::ProBuilder::WingedEdge value) ;

// Ctor Parameters []
explicit WingedEdge() ;

/// @brief Method .ctor addr 0x2a219a8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Equals addr 0x2a219b0 size 0x38 virtual true final true
 bool Equals(UnityEngine::ProBuilder::WingedEdge other) ;

/// @brief Method Equals addr 0x2a219e8 size 0xd4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2a21abc size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Count addr 0x2a21adc size 0x34 virtual false final false
 int32_t Count() ;

/// @brief Method ToString addr 0x2a21b10 size 0x1cc virtual true final false
 ::StringW ToString() ;

/// @brief Method MakeQuad addr 0x2a21cdc size 0x3dc virtual false final false
static ::ArrayW<int32_t> MakeQuad(UnityEngine::ProBuilder::WingedEdge left, UnityEngine::ProBuilder::WingedEdge right) ;

/// @brief Method GetAdjacentEdgeWithCommonIndex addr 0x2a220b8 size 0x84 virtual false final false
 UnityEngine::ProBuilder::WingedEdge GetAdjacentEdgeWithCommonIndex(int32_t common) ;

/// @brief Method SortEdgesByAdjacency addr 0x2a2213c size 0x118 virtual false final false
...
/// @brief Method SortEdgesByAdjacency addr 0x2a22254 size 0x19c virtual false final false
static void SortEdgesByAdjacency(System::Collections::Generic::List_1<UnityEngine::ProBuilder::Edge> edges) ;

/// @brief Method GetSpokes addr 0x2a223f0 size 0x430 virtual false final false
...
/// @brief Method SortCommonIndexesByAdjacency addr 0x2a22820 size 0x304 virtual false final false
...
/// @brief Method GetWingedEdges addr 0x2a22b2c size 0xf8 virtual false final false
...
/// @brief Method GetWingedEdges addr 0x2a22c24 size 0x744 virtual false final false
