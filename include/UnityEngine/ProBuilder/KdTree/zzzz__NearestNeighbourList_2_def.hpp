...
template<::cordl_internals::il2cpp_reference_type TItem,::cordl_internals::il2cpp_reference_type TDistance>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15827))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15827), inst: 80 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15827))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15827), inst: 1555 })
// CS Name: UnityEngine.ProBuilder.KdTree.NearestNeighbourList`2
