...
template<::cordl_internals::il2cpp_reference_type TItem,::cordl_internals::il2cpp_reference_type TPriority>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15829))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15829), inst: 80 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15829))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15829), inst: 1555 })
// CS Name: UnityEngine.ProBuilder.KdTree.PriorityQueue`2
