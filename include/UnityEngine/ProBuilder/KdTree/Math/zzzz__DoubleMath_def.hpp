...
namespace UnityEngine::ProBuilder::KdTree::Math {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15832)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15832), inst: 2602 })}
...
/// @brief Method Compare addr 0x29c8cc4 size 0x20 virtual true final false
 int32_t Compare(double_t a, double_t b) ;

/// @brief Method AreEqual addr 0x29c8ce4 size 0xc virtual true final false
 bool AreEqual(double_t a, double_t b) ;

/// @brief Method get_MinValue addr 0x29c8cf0 size 0xc virtual true final false
 double_t get_MinValue() ;

/// @brief Method get_MaxValue addr 0x29c8cfc size 0xc virtual true final false
 double_t get_MaxValue() ;

/// @brief Method get_Zero addr 0x29c8d08 size 0x8 virtual true final false
 double_t get_Zero() ;

/// @brief Method get_NegativeInfinity addr 0x29c8d10 size 0xc virtual true final false
 double_t get_NegativeInfinity() ;

/// @brief Method get_PositiveInfinity addr 0x29c8d1c size 0xc virtual true final false
 double_t get_PositiveInfinity() ;

/// @brief Method Add addr 0x29c8d28 size 0x8 virtual true final false
 double_t Add(double_t a, double_t b) ;

/// @brief Method Subtract addr 0x29c8d30 size 0x8 virtual true final false
 double_t Subtract(double_t a, double_t b) ;

/// @brief Method Multiply addr 0x29c8d38 size 0x8 virtual true final false
 double_t Multiply(double_t a, double_t b) ;

/// @brief Method DistanceSquaredBetweenPoints addr 0x29c8d40 size 0x100 virtual true final false
 double_t DistanceSquaredBetweenPoints(::ArrayW<double_t> a, ::ArrayW<double_t> b) ;

// Ctor Parameters []
explicit DoubleMath() ;

/// @brief Method .ctor addr 0x29c8e40 size 0x48 virtual false final false
 void _ctor() ;
