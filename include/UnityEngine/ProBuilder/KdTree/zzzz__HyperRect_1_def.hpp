...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15816)), TypeDefinitionIndex(TypeDefinitionIndex(2638))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15816), inst: 2 })
...
template<>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2638)), TypeDefinitionIndex(TypeDefinitionIndex(15816))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15816), inst: 374 })
// CS Name: UnityEngine.ProBuilder.KdTree.HyperRect`1
