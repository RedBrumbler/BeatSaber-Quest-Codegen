...
template<::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15821))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15821), inst: 80 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15821))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15821), inst: 5770 })
// CS Name: UnityEngine.ProBuilder.KdTree.KdTree`2::<>c__DisplayClass33_0
...
template<::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15822))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15822), inst: 80 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15822))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15822), inst: 5770 })
// CS Name: UnityEngine.ProBuilder.KdTree.KdTree`2::<GetEnumerator>d__33
...
template<::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15823))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15823), inst: 80 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15823))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15823), inst: 5770 })
// CS Name: UnityEngine.ProBuilder.KdTree.KdTree`2
