...
template<::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15824))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15824), inst: 80 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15824))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15824), inst: 5770 })
// CS Name: UnityEngine.ProBuilder.KdTree.KdTreeNode`2
