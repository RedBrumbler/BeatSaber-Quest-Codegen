...
/// @brief Method .ctor addr 0x2b5e308 size 0x14 virtual false final false
 void _ctor(UnityEngine::Vector3 position, UnityEngine::Quaternion rotation) ;

/// @brief Method ToString addr 0x2b5e31c size 0xf4 virtual true final false
 ::StringW ToString() ;

/// @brief Method GetTransformedBy addr 0x2b5e410 size 0xe4 virtual false final false
 UnityEngine::Pose GetTransformedBy(UnityEngine::Pose lhs) ;

/// @brief Method get_forward addr 0x2b5e4f4 size 0x70 virtual false final false
 UnityEngine::Vector3 get_forward() ;

/// @brief Method get_identity addr 0x2b5e564 size 0x68 virtual false final false
static UnityEngine::Pose get_identity() ;

/// @brief Method Equals addr 0x2b5e5cc size 0x90 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2b5e65c size 0x84 virtual true final true
 bool Equals(UnityEngine::Pose other) ;

/// @brief Method GetHashCode addr 0x2b5e6e0 size 0xac virtual true final false
 int32_t GetHashCode() ;
