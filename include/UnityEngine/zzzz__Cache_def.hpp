...
/// @brief Method get_handle addr 0x2b814ac size 0x8 virtual false final false
 int32_t get_handle() ;

/// @brief Method GetHashCode addr 0x2b814b4 size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2b814bc size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method Equals addr 0x2b81534 size 0x10 virtual true final true
 bool Equals(UnityEngine::Cache other) ;

/// @brief Method get_valid addr 0x2b811f4 size 0x3c virtual false final false
 bool get_valid() ;

/// @brief Method Cache_IsValid addr 0x2b81544 size 0x3c virtual false final false
static bool Cache_IsValid(int32_t handle) ;

/// @brief Method get_path addr 0x2b81580 size 0x3c virtual false final false
 ::StringW get_path() ;

/// @brief Method Cache_GetPath addr 0x2b815bc size 0x3c virtual false final false
static ::StringW Cache_GetPath(int32_t handle) ;

/// @brief Method set_maximumAvailableStorageSpace addr 0x2b815f8 size 0x44 virtual false final false
 void set_maximumAvailableStorageSpace(int64_t value) ;

/// @brief Method Cache_SetMaximumDiskSpaceAvailable addr 0x2b8163c size 0x44 virtual false final false
static void Cache_SetMaximumDiskSpaceAvailable(int32_t handle, int64_t value) ;

/// @brief Method set_expirationDelay addr 0x2b81680 size 0x44 virtual false final false
 void set_expirationDelay(int32_t value) ;

/// @brief Method Cache_SetExpirationDelay addr 0x2b816c4 size 0x44 virtual false final false
