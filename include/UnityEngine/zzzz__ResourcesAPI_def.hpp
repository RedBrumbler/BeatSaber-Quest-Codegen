...
/// @brief Method get_ActiveAPI addr 0x2b98d38 size 0xa8 virtual false final false
static UnityEngine::ResourcesAPI get_ActiveAPI() ;

/// @brief Method get_overrideAPI addr 0x2b98de0 size 0x58 virtual false final false
static UnityEngine::ResourcesAPI get_overrideAPI() ;

// Ctor Parameters []
explicit ResourcesAPI() ;

/// @brief Method .ctor addr 0x2b98e38 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method FindObjectsOfTypeAll addr 0x2b98e40 size 0x3c virtual true final false
 ::ArrayW<UnityEngine::Object> FindObjectsOfTypeAll(System::Type systemTypeInstance) ;

/// @brief Method FindShaderByName addr 0x2b98e7c size 0x3c virtual true final false
 UnityEngine::Shader FindShaderByName(::StringW name) ;

/// @brief Method Load addr 0x2b98eb8 size 0x44 virtual true final false
 UnityEngine::Object Load(::StringW path, System::Type systemTypeInstance) ;

/// @brief Method LoadAll addr 0x2b98efc size 0x44 virtual true final false
 ::ArrayW<UnityEngine::Object> LoadAll(::StringW path, System::Type systemTypeInstance) ;

/// @brief Method LoadAsync addr 0x2b98f40 size 0x54 virtual true final false
 UnityEngine::ResourceRequest LoadAsync(::StringW path, System::Type systemTypeInstance) ;

/// @brief Method UnloadAsset addr 0x2b98f94 size 0x3c virtual true final false
