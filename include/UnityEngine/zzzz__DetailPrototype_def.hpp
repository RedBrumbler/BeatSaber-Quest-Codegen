...
/// @brief Method set_prototype addr 0x2bd73fc size 0x8 virtual false final false
 void set_prototype(UnityEngine::GameObject value) ;

/// @brief Method set_prototypeTexture addr 0x2bd7404 size 0x8 virtual false final false
 void set_prototypeTexture(UnityEngine::Texture2D value) ;

/// @brief Method get_minWidth addr 0x2bd740c size 0x8 virtual false final false
 float_t get_minWidth() ;

/// @brief Method set_minWidth addr 0x2bd7414 size 0x8 virtual false final false
 void set_minWidth(float_t value) ;

/// @brief Method get_maxWidth addr 0x2bd741c size 0x8 virtual false final false
 float_t get_maxWidth() ;

/// @brief Method set_maxWidth addr 0x2bd7424 size 0x8 virtual false final false
 void set_maxWidth(float_t value) ;

/// @brief Method get_minHeight addr 0x2bd742c size 0x8 virtual false final false
 float_t get_minHeight() ;

/// @brief Method set_minHeight addr 0x2bd7434 size 0x8 virtual false final false
 void set_minHeight(float_t value) ;

/// @brief Method get_maxHeight addr 0x2bd743c size 0x8 virtual false final false
 float_t get_maxHeight() ;

/// @brief Method set_maxHeight addr 0x2bd7444 size 0x8 virtual false final false
 void set_maxHeight(float_t value) ;

/// @brief Method get_noiseSpread addr 0x2bd744c size 0x8 virtual false final false
 float_t get_noiseSpread() ;

/// @brief Method set_noiseSpread addr 0x2bd7454 size 0x8 virtual false final false
 void set_noiseSpread(float_t value) ;

/// @brief Method get_healthyColor addr 0x2bd745c size 0xc virtual false final false
 UnityEngine::Color get_healthyColor() ;

/// @brief Method set_healthyColor addr 0x2bd7468 size 0xc virtual false final false
 void set_healthyColor(UnityEngine::Color value) ;

/// @brief Method get_dryColor addr 0x2bd7474 size 0xc virtual false final false
 UnityEngine::Color get_dryColor() ;

/// @brief Method set_dryColor addr 0x2bd7480 size 0xc virtual false final false
 void set_dryColor(UnityEngine::Color value) ;

/// @brief Method get_renderMode addr 0x2bd748c size 0x8 virtual false final false
 UnityEngine::DetailRenderMode get_renderMode() ;

/// @brief Method set_renderMode addr 0x2bd7494 size 0x8 virtual false final false
 void set_renderMode(UnityEngine::DetailRenderMode value) ;

/// @brief Method set_usePrototypeMesh addr 0x2bd749c size 0x1c virtual false final false
 void set_usePrototypeMesh(bool value) ;

// Ctor Parameters []
explicit DetailPrototype() ;

/// @brief Method .ctor addr 0x2bd74b8 size 0xa0 virtual false final false
 void _ctor() ;

/// @brief Method Equals addr 0x2bd7558 size 0x64 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2bd77a8 size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2bd75bc size 0x1ec virtual false final false
