...
/// @brief Method FindObjectsOfTypeAll addr 0x2b99034 size 0x68 virtual false final false
...
/// @brief Method Load addr 0x2b9909c size 0x84 virtual false final false
...
/// @brief Method Load addr 0x2b98b2c size 0x78 virtual false final false
static UnityEngine::Object Load(::StringW path, System::Type systemTypeInstance) ;

/// @brief Method LoadAsync addr 0x2b99120 size 0x78 virtual false final false
static UnityEngine::ResourceRequest LoadAsync(::StringW path, System::Type type) ;

/// @brief Method LoadAll addr 0x2b99198 size 0x78 virtual false final false
static ::ArrayW<UnityEngine::Object> LoadAll(::StringW path, System::Type systemTypeInstance) ;

/// @brief Method LoadAll addr 0x2b99210 size 0x84 virtual false final false
static ::ArrayW<UnityEngine::Object> LoadAll(::StringW path) ;

/// @brief Method GetBuiltinResource addr 0x2b99294 size 0x44 virtual false final false
...
/// @brief Method UnloadAsset addr 0x2b992d8 size 0x68 virtual false final false
static void UnloadAsset(UnityEngine::Object assetToUnload) ;

/// @brief Method UnloadUnusedAssets addr 0x2b99340 size 0x28 virtual false final false
