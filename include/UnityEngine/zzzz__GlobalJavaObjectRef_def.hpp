...
/// @brief Method .ctor addr 0x2b40274 size 0xb4 virtual false final false
 void _ctor(::cordl_internals::intptr_t jobject) ;

/// @brief Method Finalize addr 0x2b40364 size 0x94 virtual true final false
 void Finalize() ;

/// @brief Method op_Implicit addr 0x2b40474 size 0x18 virtual false final false
static ::cordl_internals::intptr_t op_Implicit___cordl_internals__intptr_t(UnityEngine::GlobalJavaObjectRef obj) ;

/// @brief Method Dispose addr 0x2b403f8 size 0x7c virtual false final false
 void Dispose() ;
