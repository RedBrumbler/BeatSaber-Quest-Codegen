...
/// @brief Method get_prefab addr 0x2bd7288 size 0x8 virtual false final false
 UnityEngine::GameObject get_prefab() ;

/// @brief Method set_prefab addr 0x2bd7290 size 0x8 virtual false final false
 void set_prefab(UnityEngine::GameObject value) ;

/// @brief Method get_bendFactor addr 0x2bd7298 size 0x8 virtual false final false
 float_t get_bendFactor() ;

/// @brief Method set_bendFactor addr 0x2bd72a0 size 0x8 virtual false final false
 void set_bendFactor(float_t value) ;

/// @brief Method get_navMeshLod addr 0x2bd72a8 size 0x8 virtual false final false
 int32_t get_navMeshLod() ;

// Ctor Parameters []
explicit TreePrototype() ;

/// @brief Method .ctor addr 0x2bd72b0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Equals addr 0x2bd72b8 size 0x64 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2bd73f4 size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2bd731c size 0xd8 virtual false final false
