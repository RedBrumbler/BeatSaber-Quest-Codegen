...
/// @brief Method get_normal addr 0x2b84620 size 0xc virtual false final false
 UnityEngine::Vector3 get_normal() ;

/// @brief Method get_distance addr 0x2b8462c size 0x8 virtual false final false
 float_t get_distance() ;

/// @brief Method .ctor addr 0x2b84634 size 0x110 virtual false final false
 void _ctor(UnityEngine::Vector3 inNormal, UnityEngine::Vector3 inPoint) ;

/// @brief Method .ctor addr 0x2b84744 size 0x178 virtual false final false
 void _ctor(UnityEngine::Vector3 a, UnityEngine::Vector3 b, UnityEngine::Vector3 c) ;

/// @brief Method SetNormalAndPosition addr 0x2b848bc size 0x110 virtual false final false
 void SetNormalAndPosition(UnityEngine::Vector3 inNormal, UnityEngine::Vector3 inPoint) ;

/// @brief Method ClosestPointOnPlane addr 0x2b849cc size 0x3c virtual false final false
 UnityEngine::Vector3 ClosestPointOnPlane(UnityEngine::Vector3 point) ;

/// @brief Method GetDistanceToPoint addr 0x2b84a08 size 0x24 virtual false final false
 float_t GetDistanceToPoint(UnityEngine::Vector3 point) ;

/// @brief Method SameSide addr 0x2b84a2c size 0x70 virtual false final false
 bool SameSide(UnityEngine::Vector3 inPt0, UnityEngine::Vector3 inPt1) ;

/// @brief Method Raycast addr 0x2b84a9c size 0x100 virtual false final false
 bool Raycast(UnityEngine::Ray ray, ByRef<float_t> enter) ;

/// @brief Method ToString addr 0x2b84bb4 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x2b84bc0 size 0x188 virtual true final true
