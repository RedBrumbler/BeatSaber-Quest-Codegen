...
/// @brief Method set_updateMode addr 0x2b58c14 size 0x44 virtual false final false
 void set_updateMode(UnityEngine::Audio::AudioMixerUpdateMode value) ;

/// @brief Method SetFloat addr 0x2b58c58 size 0x54 virtual false final false
 bool SetFloat(::StringW name, float_t value) ;

/// @brief Method GetFloat addr 0x2b58cac size 0x54 virtual false final false
