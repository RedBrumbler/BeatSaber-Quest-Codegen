...
/// @brief Method get_text addr 0x2bbe960 size 0x1c virtual false final false
 ::StringW get_text() ;

/// @brief Method set_text addr 0x2bbe97c size 0x78 virtual false final false
 void set_text(::StringW value) ;

/// @brief Method get_position addr 0x2bbea34 size 0xc virtual false final false
 UnityEngine::Rect get_position() ;

/// @brief Method set_position addr 0x2bbea40 size 0xb8 virtual false final false
 void set_position(UnityEngine::Rect value) ;

/// @brief Method get_localPosition addr 0x2bbee9c size 0xc virtual true final false
 UnityEngine::Rect get_localPosition() ;

/// @brief Method get_cursorIndex addr 0x2bbeea8 size 0x8 virtual false final false
 int32_t get_cursorIndex() ;

/// @brief Method set_cursorIndex addr 0x2bbeeb0 size 0x58 virtual false final false
 void set_cursorIndex(int32_t value) ;

/// @brief Method get_selectIndex addr 0x2bbef08 size 0x8 virtual false final false
 int32_t get_selectIndex() ;

/// @brief Method set_selectIndex addr 0x2bbef10 size 0x50 virtual false final false
 void set_selectIndex(int32_t value) ;

/// @brief Method ClearCursorPos addr 0x2bbef60 size 0x10 virtual false final false
 void ClearCursorPos() ;

/// @brief Method get_altCursorPosition addr 0x2bbef70 size 0x8 virtual false final false
 int32_t get_altCursorPosition() ;

// Ctor Parameters []
explicit TextEditor() ;

/// @brief Method .ctor addr 0x2bbef78 size 0xf8 virtual false final false
 void _ctor() ;

/// @brief Method OnFocus addr 0x2bbf070 size 0x44 virtual false final false
 void OnFocus() ;

/// @brief Method OnLostFocus addr 0x2bbf0f8 size 0x54 virtual false final false
 void OnLostFocus() ;

/// @brief Method GrabGraphicalCursorPos addr 0x2bbf14c size 0x84 virtual false final false
 void GrabGraphicalCursorPos() ;

/// @brief Method HandleKeyEvent addr 0x2bbf1d0 size 0x1b4 virtual false final false
 bool HandleKeyEvent(UnityEngine::Event e, bool textIsReadOnly) ;

/// @brief Method DeleteLineBack addr 0x2bc01b8 size 0xb8 virtual false final false
 bool DeleteLineBack() ;

/// @brief Method DeleteWordBack addr 0x2bc038c size 0x90 virtual false final false
 bool DeleteWordBack() ;

/// @brief Method DeleteWordForward addr 0x2bc04e4 size 0x7c virtual false final false
 bool DeleteWordForward() ;

/// @brief Method Delete addr 0x2bc0710 size 0x8c virtual false final false
 bool Delete() ;

/// @brief Method CanPaste addr 0x2bc0860 size 0x44 virtual false final false
 bool CanPaste() ;

/// @brief Method Backspace addr 0x2bc08a4 size 0xa0 virtual false final false
 bool Backspace() ;

/// @brief Method SelectAll addr 0x2bbf0b4 size 0x44 virtual false final false
 void SelectAll() ;

/// @brief Method SelectNone addr 0x2bc0a04 size 0x24 virtual false final false
 void SelectNone() ;

/// @brief Method get_hasSelection addr 0x2bc0270 size 0x10 virtual false final false
 bool get_hasSelection() ;

/// @brief Method get_SelectedText addr 0x2bc0a28 size 0x8c virtual false final false
 ::StringW get_SelectedText() ;

/// @brief Method DeleteSelection addr 0x2bc0280 size 0x10c virtual false final false
 bool DeleteSelection() ;

/// @brief Method ReplaceSelection addr 0x2bc0ab4 size 0x7c virtual false final false
 void ReplaceSelection(::StringW replace) ;

/// @brief Method Insert addr 0x2bc0b30 size 0x34 virtual false final false
 void Insert(char16_t c) ;

/// @brief Method MoveSelectionToAltCursor addr 0x2bc0b64 size 0xbc virtual false final false
 void MoveSelectionToAltCursor() ;

/// @brief Method MoveRight addr 0x2bc0c20 size 0x6c virtual false final false
 void MoveRight() ;

/// @brief Method MoveLeft addr 0x2bc0c98 size 0x58 virtual false final false
 void MoveLeft() ;

/// @brief Method MoveUp addr 0x2bc0cf0 size 0xb0 virtual false final false
 void MoveUp() ;

/// @brief Method MoveDown addr 0x2bc0da0 size 0xe0 virtual false final false
 void MoveDown() ;

/// @brief Method MoveLineStart addr 0x2bc0e80 size 0x74 virtual false final false
 void MoveLineStart() ;

/// @brief Method MoveLineEnd addr 0x2bc0ef4 size 0x90 virtual false final false
 void MoveLineEnd() ;

/// @brief Method MoveGraphicalLineStart addr 0x2bc0f84 size 0x48 virtual false final false
 void MoveGraphicalLineStart() ;

/// @brief Method MoveGraphicalLineEnd addr 0x2bc107c size 0x48 virtual false final false
 void MoveGraphicalLineEnd() ;

/// @brief Method MoveTextStart addr 0x2bc1188 size 0x20 virtual false final false
 void MoveTextStart() ;

/// @brief Method MoveTextEnd addr 0x2bc11a8 size 0x40 virtual false final false
 void MoveTextEnd() ;

/// @brief Method IndexOfEndOfLine addr 0x2bc11e8 size 0x50 virtual false final false
 int32_t IndexOfEndOfLine(int32_t startIndex) ;

/// @brief Method MoveParagraphForward addr 0x2bc1238 size 0x80 virtual false final false
 void MoveParagraphForward() ;

/// @brief Method MoveParagraphBackward addr 0x2bc12b8 size 0x78 virtual false final false
 void MoveParagraphBackward() ;

/// @brief Method MoveCursorToPosition_Internal addr 0x2bc1330 size 0x88 virtual false final false
 void MoveCursorToPosition_Internal(UnityEngine::Vector2 cursorPosition, bool shift) ;

/// @brief Method MoveAltCursorToPosition addr 0x2bc13b8 size 0x88 virtual false final false
 void MoveAltCursorToPosition(UnityEngine::Vector2 cursorPosition) ;

/// @brief Method SelectToPosition addr 0x2bc1440 size 0x1f8 virtual false final false
 void SelectToPosition(UnityEngine::Vector2 cursorPosition) ;

/// @brief Method SelectLeft addr 0x2bc174c size 0x58 virtual false final false
 void SelectLeft() ;

/// @brief Method SelectRight addr 0x2bc17a4 size 0x58 virtual false final false
 void SelectRight() ;

/// @brief Method SelectUp addr 0x2bc17fc size 0x64 virtual false final false
 void SelectUp() ;

/// @brief Method SelectDown addr 0x2bc1860 size 0x80 virtual false final false
 void SelectDown() ;

/// @brief Method SelectTextEnd addr 0x2bc18e0 size 0x24 virtual false final false
 void SelectTextEnd() ;

/// @brief Method SelectTextStart addr 0x2bc1904 size 0x8 virtual false final false
 void SelectTextStart() ;

/// @brief Method MouseDragSelectsWholeWords addr 0x2bc190c size 0x14 virtual false final false
 void MouseDragSelectsWholeWords(bool on) ;

/// @brief Method DblClickSnap addr 0x2bc1920 size 0x8 virtual false final false
 void DblClickSnap(UnityEngine::UnityEngine__TextEditor__DblClickSnapping snapping) ;

/// @brief Method GetGraphicalLineStart addr 0x2bc0fcc size 0xb0 virtual false final false
 int32_t GetGraphicalLineStart(int32_t p) ;

/// @brief Method GetGraphicalLineEnd addr 0x2bc10c4 size 0xc4 virtual false final false
 int32_t GetGraphicalLineEnd(int32_t p) ;

/// @brief Method FindNextSeperator addr 0x2bc1928 size 0x98 virtual false final false
 int32_t FindNextSeperator(int32_t startPos) ;

/// @brief Method FindPrevSeperator addr 0x2bc1aa8 size 0x9c virtual false final false
 int32_t FindPrevSeperator(int32_t startPos) ;

/// @brief Method MoveWordRight addr 0x2bc1b44 size 0x64 virtual false final false
 void MoveWordRight() ;

/// @brief Method MoveToStartOfNextWord addr 0x2bc1ba8 size 0x60 virtual false final false
 void MoveToStartOfNextWord() ;

/// @brief Method MoveToEndOfPreviousWord addr 0x2bc1c08 size 0x60 virtual false final false
 void MoveToEndOfPreviousWord() ;

/// @brief Method SelectToStartOfNextWord addr 0x2bc1c68 size 0x2c virtual false final false
 void SelectToStartOfNextWord() ;

/// @brief Method SelectToEndOfPreviousWord addr 0x2bc1c94 size 0x2c virtual false final false
 void SelectToEndOfPreviousWord() ;

/// @brief Method ClassifyChar addr 0x2bc19c0 size 0xe8 virtual false final false
 UnityEngine::UnityEngine__TextEditor__CharacterType ClassifyChar(int32_t index) ;

/// @brief Method FindStartOfNextWord addr 0x2bc0560 size 0x1b0 virtual false final false
 int32_t FindStartOfNextWord(int32_t p) ;

/// @brief Method FindEndOfPreviousWord addr 0x2bc041c size 0xc8 virtual false final false
 int32_t FindEndOfPreviousWord(int32_t p) ;

/// @brief Method MoveWordLeft addr 0x2bc1cc0 size 0x48 virtual false final false
 void MoveWordLeft() ;

/// @brief Method SelectWordRight addr 0x2bc1d08 size 0x68 virtual false final false
 void SelectWordRight() ;

/// @brief Method SelectWordLeft addr 0x2bc1d70 size 0x68 virtual false final false
 void SelectWordLeft() ;

/// @brief Method ExpandSelectGraphicalLineStart addr 0x2bc1dd8 size 0x64 virtual false final false
 void ExpandSelectGraphicalLineStart() ;

/// @brief Method ExpandSelectGraphicalLineEnd addr 0x2bc1e3c size 0x64 virtual false final false
 void ExpandSelectGraphicalLineEnd() ;

/// @brief Method SelectGraphicalLineStart addr 0x2bc1ea0 size 0x2c virtual false final false
 void SelectGraphicalLineStart() ;

/// @brief Method SelectGraphicalLineEnd addr 0x2bc1ecc size 0x2c virtual false final false
 void SelectGraphicalLineEnd() ;

/// @brief Method SelectParagraphForward addr 0x2bc1ef8 size 0x88 virtual false final false
 void SelectParagraphForward() ;

/// @brief Method SelectParagraphBackward addr 0x2bc1f80 size 0xa4 virtual false final false
 void SelectParagraphBackward() ;

/// @brief Method SelectCurrentWord addr 0x2bc2024 size 0x6c virtual false final false
 void SelectCurrentWord() ;

/// @brief Method FindEndOfClassification addr 0x2bc1638 size 0x114 virtual false final false
 int32_t FindEndOfClassification(int32_t p, UnityEngine::UnityEngine__TextEditor__Direction dir) ;

/// @brief Method SelectCurrentParagraph addr 0x2bc2090 size 0x8c virtual false final false
 void SelectCurrentParagraph() ;

/// @brief Method UpdateScrollOffset addr 0x2bbeaf8 size 0x3a4 virtual false final false
 void UpdateScrollOffset() ;

/// @brief Method PerformOperation addr 0x2bbfde0 size 0x3d8 virtual false final false
 bool PerformOperation(UnityEngine::UnityEngine__TextEditor__TextEditOp operation, bool textIsReadOnly) ;

/// @brief Method SaveBackup addr 0x2bc227c size 0x24 virtual false final false
 void SaveBackup() ;

/// @brief Method Cut addr 0x2bc211c size 0x2c virtual false final false
 bool Cut() ;

/// @brief Method Copy addr 0x2bc2148 size 0x90 virtual false final false
 void Copy() ;

/// @brief Method ReplaceNewlinesWithSpaces addr 0x2bc22a0 size 0x94 virtual false final false
static ::StringW ReplaceNewlinesWithSpaces(::StringW value) ;

/// @brief Method Paste addr 0x2bc21d8 size 0xa4 virtual false final false
 bool Paste() ;

/// @brief Method MapKey addr 0x2bc2334 size 0x8c virtual false final false
static void MapKey(::StringW key, UnityEngine::UnityEngine__TextEditor__TextEditOp action) ;

/// @brief Method InitKeyActions addr 0x2bbf384 size 0xa5c virtual false final false
 void InitKeyActions() ;

/// @brief Method DetectFocusChange addr 0x2bc0c8c size 0xc virtual false final false
 void DetectFocusChange() ;

/// @brief Method OnDetectFocusChange addr 0x2bc23c0 size 0x9c virtual true final false
 void OnDetectFocusChange() ;

/// @brief Method OnCursorIndexChange addr 0x2bc245c size 0x4 virtual true final false
 void OnCursorIndexChange() ;

/// @brief Method OnSelectIndexChange addr 0x2bc2460 size 0x4 virtual true final false
 void OnSelectIndexChange() ;

/// @brief Method ClampTextIndex addr 0x2bc2464 size 0x3c virtual false final false
 void ClampTextIndex(ByRef<int32_t> index) ;

/// @brief Method EnsureValidCodePointIndex addr 0x2bbe9f4 size 0x40 virtual false final false
 void EnsureValidCodePointIndex(ByRef<int32_t> index) ;

/// @brief Method IsValidCodePointIndex addr 0x2bc24a0 size 0xb8 virtual false final false
 bool IsValidCodePointIndex(int32_t index) ;

/// @brief Method PreviousCodePointIndex addr 0x2bc0944 size 0xc0 virtual false final false
 int32_t PreviousCodePointIndex(int32_t index) ;

/// @brief Method NextCodePointIndex addr 0x2bc079c size 0xc4 virtual false final false
