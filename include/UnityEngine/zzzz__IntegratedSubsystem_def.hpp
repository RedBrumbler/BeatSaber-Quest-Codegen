...
/// @brief Method SetHandle addr 0x2bd5298 size 0x44 virtual false final false
 void SetHandle(UnityEngine::IntegratedSubsystem subsystem) ;

/// @brief Method Start addr 0x2bd52dc size 0x3c virtual true final true
 void Start() ;

/// @brief Method Stop addr 0x2bd5318 size 0x3c virtual true final true
 void Stop() ;

/// @brief Method Destroy addr 0x2bd5354 size 0xb0 virtual true final true
 void Destroy() ;

/// @brief Method get_running addr 0x2bd55c4 size 0x54 virtual true final true
 bool get_running() ;

/// @brief Method get_valid addr 0x2bd5618 size 0x54 virtual false final false
 bool get_valid() ;

/// @brief Method IsRunning addr 0x2bd566c size 0x3c virtual false final false
 bool IsRunning() ;

// Ctor Parameters []
explicit IntegratedSubsystem() ;

/// @brief Method .ctor addr 0x2bd56a8 size 0x8 virtual false final false
 void _ctor() ;
