...
/// @brief Method .ctor addr 0x2b5e99c size 0x50 virtual false final false
 void _ctor(::StringW address) ;

/// @brief Method Finalize addr 0x2b5ea28 size 0x94 virtual true final false
 void Finalize() ;

/// @brief Method DestroyPing addr 0x2b5eabc size 0xa0 virtual false final false
 void DestroyPing() ;

/// @brief Method Internal_Destroy addr 0x2b5eb5c size 0x3c virtual false final false
static void Internal_Destroy(::cordl_internals::intptr_t ptr) ;

/// @brief Method Internal_Create addr 0x2b5e9ec size 0x3c virtual false final false
static ::cordl_internals::intptr_t Internal_Create(::StringW address) ;

/// @brief Method get_isDone addr 0x2b5eb98 size 0x90 virtual false final false
 bool get_isDone() ;

/// @brief Method Internal_IsDone addr 0x2b5ec28 size 0x3c virtual false final false
 bool Internal_IsDone() ;

/// @brief Method get_time addr 0x2b5ec64 size 0x3c virtual false final false
 int32_t get_time() ;
