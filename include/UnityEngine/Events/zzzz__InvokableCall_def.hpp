...
namespace UnityEngine::Events {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10405))}
...
/// @brief Method add_Delegate addr 0x2bb1604 size 0x9c virtual false final false
 void add_Delegate(UnityEngine::Events::UnityAction value) ;

/// @brief Method remove_Delegate addr 0x2bb16a0 size 0x9c virtual false final false
...
/// @brief Method .ctor addr 0x2bb173c size 0xe8 virtual false final false
...
/// @brief Method .ctor addr 0x2bb1824 size 0x2c virtual false final false
 void _ctor(UnityEngine::Events::UnityAction action) ;

/// @brief Method Invoke addr 0x2bb1850 size 0x3c virtual true final false
 void Invoke(::ArrayW<::bs_hook::Il2CppWrapperType> args) ;

/// @brief Method Invoke addr 0x2bb188c size 0x3c virtual false final false
 void Invoke() ;

/// @brief Method Find addr 0x2bb18c8 size 0x4c virtual true final false
