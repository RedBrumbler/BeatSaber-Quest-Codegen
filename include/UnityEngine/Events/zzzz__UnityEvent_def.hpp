...
/// @brief Method .ctor addr 0x2bb32bc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method AddListener addr 0x2bb32c4 size 0x2c virtual false final false
 void AddListener(UnityEngine::Events::UnityAction call) ;

/// @brief Method RemoveListener addr 0x2bb335c size 0x44 virtual false final false
 void RemoveListener(UnityEngine::Events::UnityAction call) ;

/// @brief Method FindMethod_Impl addr 0x2bb33a0 size 0x64 virtual true final false
 System::Reflection::MethodInfo FindMethod_Impl(::StringW name, System::Type targetObjType) ;

/// @brief Method GetDelegate addr 0x2bb3404 size 0x70 virtual true final false
...
/// @brief Method GetDelegate addr 0x2bb32f0 size 0x6c virtual false final false
static UnityEngine::Events::BaseInvokableCall GetDelegate(UnityEngine::Events::UnityAction action) ;

/// @brief Method Invoke addr 0x2bb3474 size 0x180 virtual false final false
 void Invoke() ;
