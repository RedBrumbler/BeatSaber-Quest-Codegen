...
/// @brief Method get_unityObjectArgument addr 0x2bb13fc size 0x8 virtual false final false
 UnityEngine::Object get_unityObjectArgument() ;

/// @brief Method get_unityObjectArgumentAssemblyTypeName addr 0x2bb1404 size 0x8 virtual false final false
 ::StringW get_unityObjectArgumentAssemblyTypeName() ;

/// @brief Method get_intArgument addr 0x2bb140c size 0x8 virtual false final false
 int32_t get_intArgument() ;

/// @brief Method get_floatArgument addr 0x2bb1414 size 0x8 virtual false final false
 float_t get_floatArgument() ;

/// @brief Method get_stringArgument addr 0x2bb141c size 0x8 virtual false final false
 ::StringW get_stringArgument() ;

/// @brief Method get_boolArgument addr 0x2bb1424 size 0x8 virtual false final false
 bool get_boolArgument() ;

/// @brief Method OnBeforeSerialize addr 0x2bb142c size 0x1c virtual true final true
 void OnBeforeSerialize() ;

/// @brief Method OnAfterDeserialize addr 0x2bb1448 size 0x1c virtual true final true
 void OnAfterDeserialize() ;

// Ctor Parameters []
explicit ArgumentCache() ;

/// @brief Method .ctor addr 0x2bb1464 size 0x8 virtual false final false
 void _ctor() ;
