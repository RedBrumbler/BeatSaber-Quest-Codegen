...
template<::cordl_internals::il2cpp_reference_type T1>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10405)), TypeDefinitionIndex(TypeDefinitionIndex(10409))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10409), inst: 5160 })
...
template<::cordl_internals::il2cpp_reference_type T1,::cordl_internals::il2cpp_reference_type T2,::cordl_internals::il2cpp_reference_type T3>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10409)), TypeDefinitionIndex(TypeDefinitionIndex(10405))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10409), inst: 5162 })
// CS Name: UnityEngine.Events.InvokableCall`3
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10409)), TypeDefinitionIndex(TypeDefinitionIndex(10405))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10409), inst: 7512 })
// CS Name: UnityEngine.Events.InvokableCall`3
