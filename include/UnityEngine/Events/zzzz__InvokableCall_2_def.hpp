...
template<::cordl_internals::il2cpp_reference_type T1,::cordl_internals::il2cpp_reference_type T2>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10405)), TypeDefinitionIndex(TypeDefinitionIndex(10408))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10408), inst: 80 })
