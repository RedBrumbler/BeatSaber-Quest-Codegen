...
template<::cordl_internals::il2cpp_reference_type T0>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2610)), TypeDefinitionIndex(TypeDefinitionIndex(10421))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10421), inst: 5160 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2610)), TypeDefinitionIndex(TypeDefinitionIndex(10421))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10421), inst: 5162 })
// CS Name: UnityEngine.Events.UnityAction`3
...
template<::cordl_internals::il2cpp_reference_type T0,::cordl_internals::il2cpp_reference_type T2>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10421)), TypeDefinitionIndex(TypeDefinitionIndex(2610))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10421), inst: 7512 })
// CS Name: UnityEngine.Events.UnityAction`3
