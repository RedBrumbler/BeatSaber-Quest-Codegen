...
/// @brief Method AddPersistentInvokableCall addr 0x2bb2600 size 0xac virtual false final false
 void AddPersistentInvokableCall(UnityEngine::Events::BaseInvokableCall call) ;

/// @brief Method AddListener addr 0x2bb26ac size 0xac virtual false final false
 void AddListener(UnityEngine::Events::BaseInvokableCall call) ;

/// @brief Method RemoveListener addr 0x2bb2758 size 0x274 virtual false final false
 void RemoveListener(::bs_hook::Il2CppWrapperType targetObj, System::Reflection::MethodInfo method) ;

/// @brief Method ClearPersistent addr 0x2bb29cc size 0xb8 virtual false final false
 void ClearPersistent() ;

/// @brief Method PrepareInvoke addr 0x2bb2a84 size 0xb4 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::Events::BaseInvokableCall> PrepareInvoke() ;

// Ctor Parameters []
explicit InvokableCallList() ;

/// @brief Method .ctor addr 0x2bb2b38 size 0xc4 virtual false final false
 void _ctor() ;
