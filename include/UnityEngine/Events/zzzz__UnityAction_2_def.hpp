...
template<::cordl_internals::il2cpp_reference_type T0,::cordl_internals::il2cpp_reference_type T1>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2610)), TypeDefinitionIndex(TypeDefinitionIndex(10417))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10417), inst: 80 })
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10417)), TypeDefinitionIndex(TypeDefinitionIndex(2610))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10417), inst: 5062 })
// CS Name: UnityEngine.Events.UnityAction`2
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10417)), TypeDefinitionIndex(TypeDefinitionIndex(2610))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10417), inst: 7545 })
// CS Name: UnityEngine.Events.UnityAction`2
