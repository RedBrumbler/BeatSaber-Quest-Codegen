...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10411)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10407), inst: 3790 }), TypeDefinitionIndex(TypeDefinitionIndex(10407))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10411), inst: 2 })
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10411)), TypeDefinitionIndex(TypeDefinitionIndex(10407)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10407), inst: 3790 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10411), inst: 92 })
// CS Name: UnityEngine.Events.CachedInvokableCall`1
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10411)), TypeDefinitionIndex(TypeDefinitionIndex(10407)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10407), inst: 3790 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10411), inst: 99 })
// CS Name: UnityEngine.Events.CachedInvokableCall`1
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10407)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10407), inst: 3790 }), TypeDefinitionIndex(TypeDefinitionIndex(10411))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10411), inst: 374 })
// CS Name: UnityEngine.Events.CachedInvokableCall`1
