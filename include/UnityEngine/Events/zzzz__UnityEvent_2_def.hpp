...
template<::cordl_internals::il2cpp_reference_type T0,::cordl_internals::il2cpp_reference_type T1>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10418)), TypeDefinitionIndex(TypeDefinitionIndex(10416))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10418), inst: 80 })
