...
/// @brief Method get_point addr 0x2bce2e4 size 0x8 virtual false final false
 UnityEngine::Vector2 get_point() ;

/// @brief Method get_normal addr 0x2bce2ec size 0x8 virtual false final false
 UnityEngine::Vector2 get_normal() ;

/// @brief Method get_distance addr 0x2bce2f4 size 0x8 virtual false final false
 float_t get_distance() ;

/// @brief Method get_fraction addr 0x2bce2fc size 0x8 virtual false final false
 float_t get_fraction() ;

/// @brief Method get_collider addr 0x2bce304 size 0xac virtual false final false
