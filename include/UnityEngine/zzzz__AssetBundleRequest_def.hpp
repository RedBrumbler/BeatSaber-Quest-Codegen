...
namespace UnityEngine {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10222))}
...
/// @brief Method GetResult addr 0x2b564f8 size 0x3c virtual true final false
 UnityEngine::Object GetResult() ;

/// @brief Method get_asset addr 0x2b56534 size 0xc virtual false final false
 UnityEngine::Object get_asset() ;

/// @brief Method get_allAssets addr 0x2b56540 size 0x3c virtual false final false
 ::ArrayW<UnityEngine::Object> get_allAssets() ;

// Ctor Parameters []
explicit AssetBundleRequest() ;

/// @brief Method .ctor addr 0x2b5657c size 0x8 virtual false final false
 void _ctor() ;
