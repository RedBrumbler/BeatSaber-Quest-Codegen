...
/// @brief Method .ctor addr 0x2b4b53c size 0x58 virtual false final false
 void _ctor() ;

/// @brief Method get_animationClips addr 0x2b4c570 size 0x3c virtual false final false
