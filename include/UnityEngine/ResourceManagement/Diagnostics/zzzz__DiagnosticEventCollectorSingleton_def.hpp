...
/// @brief Method .ctor addr 0x2a76d60 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <RegisterEventHandler>b__8_0 addr 0x2a76d68 size 0x8 virtual false final false
 int32_t _RegisterEventHandler_b__8_0(UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent evt) ;

/// @brief Method <Awake>b__11_0 addr 0x2a76d70 size 0x5c virtual false final false
...
namespace UnityEngine::ResourceManagement::Diagnostics {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14267), inst: 1028 }), TypeDefinitionIndex(TypeDefinitionIndex(14267))}
...
/// @brief Method get_PlayerConnectionGuid addr 0x2a75f9c size 0xfc virtual false final false
static System::Guid get_PlayerConnectionGuid() ;

/// @brief Method GetGameObjectName addr 0x2a76098 size 0x40 virtual true final false
 ::StringW GetGameObjectName() ;

/// @brief Method RegisterEventHandler addr 0x2a760d8 size 0xbc virtual false final false
...
/// @brief Method RegisterEventHandler addr 0x2a76194 size 0x4dc virtual false final false
 void RegisterEventHandler(System::Action_1<UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent> handler) ;

/// @brief Method UnregisterEventHandler addr 0x2a76670 size 0xa8 virtual false final false
 void UnregisterEventHandler(System::Action_1<UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent> handler) ;

/// @brief Method PostEvent addr 0x2a76718 size 0x224 virtual false final false
 void PostEvent(UnityEngine::ResourceManagement::Diagnostics::DiagnosticEvent diagnosticEvent) ;

/// @brief Method Awake addr 0x2a7693c size 0xe4 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x2a76a20 size 0x1d8 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit DiagnosticEventCollectorSingleton() ;

/// @brief Method .ctor addr 0x2a76bf8 size 0x104 virtual false final false
 void _ctor() ;
