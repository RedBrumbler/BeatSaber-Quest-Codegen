...
/// @brief Method get_Graph addr 0x2a75e28 size 0x8 virtual false final false
 ::StringW get_Graph() ;

/// @brief Method get_ObjectId addr 0x2a75e30 size 0x8 virtual false final false
 int32_t get_ObjectId() ;

/// @brief Method get_DisplayName addr 0x2a75e38 size 0x8 virtual false final false
 ::StringW get_DisplayName() ;

/// @brief Method get_Dependencies addr 0x2a75e40 size 0x8 virtual false final false
 ::ArrayW<int32_t> get_Dependencies() ;

/// @brief Method get_Stream addr 0x2a75e48 size 0x8 virtual false final false
 int32_t get_Stream() ;

/// @brief Method get_Frame addr 0x2a75e50 size 0x8 virtual false final false
 int32_t get_Frame() ;

/// @brief Method get_Value addr 0x2a75e58 size 0x8 virtual false final false
 int32_t get_Value() ;

/// @brief Method .ctor addr 0x2a75e60 size 0x18 virtual false final false
 void _ctor(::StringW graph, ::StringW name, int32_t id, int32_t stream, int32_t frame, int32_t value, ::ArrayW<int32_t> deps) ;

/// @brief Method Serialize addr 0x2a75e78 size 0x98 virtual false final false
 ::ArrayW<uint8_t> Serialize() ;

/// @brief Method Deserialize addr 0x2a75f10 size 0x8c virtual false final false
