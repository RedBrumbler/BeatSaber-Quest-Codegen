...
namespace UnityEngine::ResourceManagement::ResourceProviders {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14333), inst: 99 }), TypeDefinitionIndex(TypeDefinitionIndex(14333))}
...
/// @brief Method Init addr 0x2a72ab0 size 0x8 virtual false final false
 void Init(System::Func_1<bool> callback) ;

/// @brief Method InvokeWaitForCompletion addr 0x2a72ab8 size 0x70 virtual true final false
 bool InvokeWaitForCompletion() ;

/// @brief Method Execute addr 0x2a72b28 size 0x88 virtual true final false
 void Execute() ;

// Ctor Parameters []
explicit UnityEngine__ResourceManagement__ResourceProviders__ResourceProviderBase__BaseInitAsyncOp() ;

/// @brief Method .ctor addr 0x2a72a60 size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2a72a58 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <InitializeAsync>b__0 addr 0x2a72bb0 size 0x2c virtual false final false
...
/// @brief Method get_ProviderId addr 0x2a727d4 size 0x50 virtual true final false
 ::StringW get_ProviderId() ;

/// @brief Method Initialize addr 0x2a72824 size 0x24 virtual true final false
 bool Initialize(::StringW id, ::StringW data) ;

/// @brief Method CanProvide addr 0x2a72848 size 0x40 virtual true final false
 bool CanProvide(System::Type t, UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation location) ;

/// @brief Method ToString addr 0x2a72888 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method Release addr 0x2a72894 size 0x4 virtual true final false
 void Release(UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation location, ::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetDefaultType addr 0x2a72898 size 0x6c virtual true final false
...
/// @brief Method InitializeAsync addr 0x2a72904 size 0x154 virtual true final false
...
/// @brief Method UnityEngine.ResourceManagement.ResourceProviders.IResourceProvider.get_BehaviourFlags addr 0x2a72aa8 size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0x2a7034c size 0x8 virtual false final false
 void _ctor() ;
