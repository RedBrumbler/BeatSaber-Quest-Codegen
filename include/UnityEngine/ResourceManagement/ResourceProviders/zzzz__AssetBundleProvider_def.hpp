...
/// @brief Method WaitForAllUnloadingBundlesToComplete addr 0x2a700d0 size 0x4 virtual false final false
static void WaitForAllUnloadingBundlesToComplete() ;

/// @brief Method Provide addr 0x2a700d4 size 0x80 virtual true final false
 void Provide(UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle providerInterface) ;

/// @brief Method GetDefaultType addr 0x2a70154 size 0x6c virtual true final false
 System::Type GetDefaultType(UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation location) ;

/// @brief Method Release addr 0x2a701c0 size 0x184 virtual true final false
...
/// @brief Method .ctor addr 0x2a70344 size 0x8 virtual false final false
 void _ctor() ;
