...
/// @brief Method GetPercentComplete addr 0x2a74bf4 size 0x18 virtual false final false
 float_t GetPercentComplete() ;

/// @brief Method Start addr 0x2a74810 size 0x3e4 virtual false final false
...
/// @brief Method WaitForCompletionHandler addr 0x2a74d04 size 0x74 virtual false final false
 bool WaitForCompletionHandler() ;

/// @brief Method RequestOperation_completed addr 0x2a74d78 size 0x1ac virtual false final false
 void RequestOperation_completed(UnityEngine::AsyncOperation op) ;

/// @brief Method CompleteOperation addr 0x2a74f24 size 0xac virtual false final false
 void CompleteOperation(::StringW text, System::Exception exception) ;

/// @brief Method ConvertText addr 0x2a74c0c size 0xf8 virtual false final false
 ::bs_hook::Il2CppWrapperType ConvertText(::StringW text) ;

/// @brief Method SendWebRequest addr 0x2a74fd0 size 0x284 virtual true final false
...
/// @brief Method .ctor addr 0x2a74808 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SendWebRequest>b__13_0 addr 0x2a75254 size 0x98 virtual false final false
...
/// @brief Method get_IgnoreFailures addr 0x2a7475c size 0x8 virtual false final false
 bool get_IgnoreFailures() ;

/// @brief Method set_IgnoreFailures addr 0x2a74764 size 0xc virtual false final false
 void set_IgnoreFailures(bool value) ;

/// @brief Method Convert addr 0x2a74770 size 0x8 virtual true final false
 ::bs_hook::Il2CppWrapperType Convert(System::Type type, ::StringW text) ;

/// @brief Method Provide addr 0x2a74778 size 0x90 virtual true final false
 void Provide(UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle provideHandle) ;

// Ctor Parameters []
explicit TextDataProvider() ;

/// @brief Method .ctor addr 0x2a71f68 size 0x8 virtual false final false
 void _ctor() ;
