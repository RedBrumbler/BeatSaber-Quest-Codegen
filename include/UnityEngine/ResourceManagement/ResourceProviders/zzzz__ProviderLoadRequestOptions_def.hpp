...
/// @brief Method Copy addr 0x2a72bdc size 0x80 virtual false final false
 UnityEngine::ResourceManagement::ResourceProviders::ProviderLoadRequestOptions Copy() ;

/// @brief Method get_IgnoreFailures addr 0x2a72c5c size 0x8 virtual false final false
 bool get_IgnoreFailures() ;

/// @brief Method set_IgnoreFailures addr 0x2a72c64 size 0xc virtual false final false
 void set_IgnoreFailures(bool value) ;

/// @brief Method get_WebRequestTimeout addr 0x2a72c70 size 0x8 virtual false final false
 int32_t get_WebRequestTimeout() ;

/// @brief Method set_WebRequestTimeout addr 0x2a72c78 size 0x8 virtual false final false
 void set_WebRequestTimeout(int32_t value) ;

// Ctor Parameters []
explicit ProviderLoadRequestOptions() ;

/// @brief Method .ctor addr 0x2a72c80 size 0x8 virtual false final false
 void _ctor() ;
