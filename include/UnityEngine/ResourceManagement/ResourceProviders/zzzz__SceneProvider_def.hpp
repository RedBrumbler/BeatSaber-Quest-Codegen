...
namespace UnityEngine::ResourceManagement::ResourceProviders {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14305)), TypeDefinitionIndex(TypeDefinitionIndex(14333)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14333), inst: 773 })}
...
/// @brief Method .ctor addr 0x2a72fe4 size 0x5c virtual false final false
 void _ctor(UnityEngine::ResourceManagement::ResourceManager rm) ;

/// @brief Method GetDownloadStatus addr 0x2a733f0 size 0xdc virtual true final false
...
/// @brief Method Init addr 0x2a73040 size 0xc4 virtual false final false
...
/// @brief Method InvokeWaitForCompletion addr 0x2a734cc size 0x338 virtual true final false
 bool InvokeWaitForCompletion() ;

/// @brief Method GetDependencies addr 0x2a73804 size 0x14c virtual true final false
...
/// @brief Method get_DebugName addr 0x2a73950 size 0xa4 virtual true final false
 ::StringW get_DebugName() ;

/// @brief Method Execute addr 0x2a739f4 size 0x588 virtual true final false
 void Execute() ;

/// @brief Method InternalLoadScene addr 0x2a74024 size 0xd4 virtual false final false
...
/// @brief Method InternalLoad addr 0x2a740f8 size 0x84 virtual false final false
...
/// @brief Method Destroy addr 0x2a7417c size 0x90 virtual true final false
 void Destroy() ;

/// @brief Method get_Progress addr 0x2a7420c size 0xc0 virtual true final false
 float_t get_Progress() ;

/// @brief Method UnityEngine.ResourceManagement.IUpdateReceiver.Update addr 0x2a742cc size 0x128 virtual true final true
...
namespace UnityEngine::ResourceManagement::ResourceProviders {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14333), inst: 773 }), TypeDefinitionIndex(TypeDefinitionIndex(14333)), TypeDefinitionIndex(TypeDefinitionIndex(14305))}
...
/// @brief Method Init addr 0x2a73354 size 0x94 virtual false final false
...
/// @brief Method Execute addr 0x2a743f4 size 0x134 virtual true final false
 void Execute() ;

/// @brief Method InvokeWaitForCompletion addr 0x2a74660 size 0xb4 virtual true final false
 bool InvokeWaitForCompletion() ;

/// @brief Method UnloadSceneCompleted addr 0x2a74598 size 0xc8 virtual false final false
 void UnloadSceneCompleted(UnityEngine::AsyncOperation obj) ;

/// @brief Method UnloadSceneCompletedNoRelease addr 0x2a74528 size 0x70 virtual false final false
 void UnloadSceneCompletedNoRelease(UnityEngine::AsyncOperation obj) ;

/// @brief Method get_Progress addr 0x2a74714 size 0x48 virtual true final false
 float_t get_Progress() ;

// Ctor Parameters []
explicit UnityEngine__ResourceManagement__ResourceProviders__SceneProvider__UnloadSceneOp() ;

/// @brief Method .ctor addr 0x2a7330c size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method ProvideScene addr 0x2a72c88 size 0x35c virtual true final true
...
/// @brief Method ReleaseScene addr 0x2a73104 size 0xe8 virtual true final true
...
/// @brief Method UnityEngine.ResourceManagement.ResourceProviders.ISceneProvider2.ReleaseScene addr 0x2a731ec size 0x120 virtual true final true
...
/// @brief Method .ctor addr 0x2a733e8 size 0x8 virtual false final false
 void _ctor() ;
