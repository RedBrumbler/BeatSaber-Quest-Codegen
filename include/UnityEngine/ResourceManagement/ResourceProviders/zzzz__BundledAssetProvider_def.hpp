...
/// @brief Method Start addr 0x2a70730 size 0x3c8 virtual false final false
 void Start(UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle provideHandle) ;

/// @brief Method BeginAssetLoad addr 0x2a70bb4 size 0x368 virtual false final false
 void BeginAssetLoad() ;

/// @brief Method WaitForCompletionHandler addr 0x2a7115c size 0xf8 virtual false final false
 bool WaitForCompletionHandler() ;

/// @brief Method ActionComplete addr 0x2a70fc8 size 0x194 virtual false final false
 void ActionComplete(UnityEngine::AsyncOperation obj) ;

/// @brief Method GetArrayResult addr 0x2a71254 size 0x30 virtual false final false
 void GetArrayResult(::ArrayW<UnityEngine::Object> allAssets) ;

/// @brief Method GetListResult addr 0x2a71284 size 0x30 virtual false final false
 void GetListResult(::ArrayW<UnityEngine::Object> allAssets) ;

/// @brief Method GetAssetResult addr 0x2a712b4 size 0xc0 virtual false final false
 void GetAssetResult(UnityEngine::Object asset) ;

/// @brief Method GetAssetSubObjectResult addr 0x2a71374 size 0xcc virtual false final false
 void GetAssetSubObjectResult(::ArrayW<UnityEngine::Object> allAssets) ;

/// @brief Method CompleteOperation addr 0x2a71440 size 0xf0 virtual false final false
 void CompleteOperation() ;

/// @brief Method ProgressCallback addr 0x2a71530 size 0x18 virtual false final false
 float_t ProgressCallback() ;

// Ctor Parameters []
explicit UnityEngine__ResourceManagement__ResourceProviders__BundledAssetProvider__InternalOp() ;

/// @brief Method .ctor addr 0x2a70728 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Start>b__7_0 addr 0x2a71548 size 0x4 virtual false final false
...
/// @brief Method Provide addr 0x2a706a8 size 0x80 virtual true final false
 void Provide(UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle provideHandle) ;

// Ctor Parameters []
explicit BundledAssetProvider() ;

/// @brief Method .ctor addr 0x2a70af8 size 0x8 virtual false final false
 void _ctor() ;
