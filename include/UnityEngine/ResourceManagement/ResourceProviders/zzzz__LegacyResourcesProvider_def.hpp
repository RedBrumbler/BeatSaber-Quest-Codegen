...
/// @brief Method Start addr 0x2a72364 size 0x190 virtual false final false
 void Start(UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle provideHandle) ;

/// @brief Method WaitForCompletionHandler addr 0x2a72624 size 0x14 virtual false final false
 bool WaitForCompletionHandler() ;

/// @brief Method AsyncOperationCompleted addr 0x2a72638 size 0x184 virtual false final false
 void AsyncOperationCompleted(UnityEngine::AsyncOperation op) ;

/// @brief Method PercentComplete addr 0x2a727bc size 0x18 virtual false final false
 float_t PercentComplete() ;

// Ctor Parameters []
explicit UnityEngine__ResourceManagement__ResourceProviders__LegacyResourcesProvider__InternalOp() ;

/// @brief Method .ctor addr 0x2a7235c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Provide addr 0x2a71f70 size 0x3ec virtual true final false
 void Provide(UnityEngine::ResourceManagement::ResourceProviders::ProvideHandle pi) ;

/// @brief Method Release addr 0x2a724f4 size 0x128 virtual true final false
...
/// @brief Method .ctor addr 0x2a7261c size 0x8 virtual false final false
 void _ctor() ;
