...
/// @brief Method get_Hash addr 0x2a6e0a8 size 0x8 virtual false final false
 ::StringW get_Hash() ;

/// @brief Method set_Hash addr 0x2a6e0b0 size 0x8 virtual false final false
 void set_Hash(::StringW value) ;

/// @brief Method get_Crc addr 0x2a6e0b8 size 0x8 virtual false final false
 uint32_t get_Crc() ;

/// @brief Method set_Crc addr 0x2a6e0c0 size 0x8 virtual false final false
 void set_Crc(uint32_t value) ;

/// @brief Method get_Timeout addr 0x2a6e0c8 size 0x8 virtual false final false
 int32_t get_Timeout() ;

/// @brief Method set_Timeout addr 0x2a6e0d0 size 0x8 virtual false final false
 void set_Timeout(int32_t value) ;

/// @brief Method get_ChunkedTransfer addr 0x2a6e0d8 size 0x8 virtual false final false
 bool get_ChunkedTransfer() ;

/// @brief Method set_ChunkedTransfer addr 0x2a6e0e0 size 0xc virtual false final false
 void set_ChunkedTransfer(bool value) ;

/// @brief Method get_RedirectLimit addr 0x2a6e0ec size 0x8 virtual false final false
 int32_t get_RedirectLimit() ;

/// @brief Method set_RedirectLimit addr 0x2a6e0f4 size 0x8 virtual false final false
 void set_RedirectLimit(int32_t value) ;

/// @brief Method get_RetryCount addr 0x2a6e0fc size 0x8 virtual false final false
 int32_t get_RetryCount() ;

/// @brief Method set_RetryCount addr 0x2a6e104 size 0x8 virtual false final false
 void set_RetryCount(int32_t value) ;

/// @brief Method get_BundleName addr 0x2a6e10c size 0x8 virtual false final false
 ::StringW get_BundleName() ;

/// @brief Method set_BundleName addr 0x2a6e114 size 0x8 virtual false final false
 void set_BundleName(::StringW value) ;

/// @brief Method get_AssetLoadMode addr 0x2a6e11c size 0x8 virtual false final false
 UnityEngine::ResourceManagement::ResourceProviders::AssetLoadMode get_AssetLoadMode() ;

/// @brief Method set_AssetLoadMode addr 0x2a6e124 size 0x8 virtual false final false
 void set_AssetLoadMode(UnityEngine::ResourceManagement::ResourceProviders::AssetLoadMode value) ;

/// @brief Method get_BundleSize addr 0x2a6e12c size 0x8 virtual false final false
 int64_t get_BundleSize() ;

/// @brief Method set_BundleSize addr 0x2a6e134 size 0x8 virtual false final false
 void set_BundleSize(int64_t value) ;

/// @brief Method get_UseCrcForCachedBundle addr 0x2a6e13c size 0x8 virtual false final false
 bool get_UseCrcForCachedBundle() ;

/// @brief Method set_UseCrcForCachedBundle addr 0x2a6e144 size 0xc virtual false final false
 void set_UseCrcForCachedBundle(bool value) ;

/// @brief Method get_UseUnityWebRequestForLocalBundles addr 0x2a6e150 size 0x8 virtual false final false
 bool get_UseUnityWebRequestForLocalBundles() ;

/// @brief Method set_UseUnityWebRequestForLocalBundles addr 0x2a6e158 size 0xc virtual false final false
 void set_UseUnityWebRequestForLocalBundles(bool value) ;

/// @brief Method get_ClearOtherCachedVersionsWhenLoaded addr 0x2a6e164 size 0x8 virtual false final false
 bool get_ClearOtherCachedVersionsWhenLoaded() ;

/// @brief Method set_ClearOtherCachedVersionsWhenLoaded addr 0x2a6e16c size 0xc virtual false final false
 void set_ClearOtherCachedVersionsWhenLoaded(bool value) ;

/// @brief Method ComputeSize addr 0x2a6e178 size 0x148 virtual true final false
...
/// @brief Method .ctor addr 0x2a6e2c0 size 0x58 virtual false final false
 void _ctor() ;
