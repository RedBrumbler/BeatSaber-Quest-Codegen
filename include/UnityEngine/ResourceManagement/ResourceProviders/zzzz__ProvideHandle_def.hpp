...
/// @brief Method .ctor addr 0x2a719b4 size 0xbc virtual false final false
...
/// @brief Method get_InternalOp addr 0x2a71a70 size 0x104 virtual false final false
 UnityEngine::ResourceManagement::AsyncOperations::IGenericProviderOperation get_InternalOp() ;

/// @brief Method get_ResourceManager addr 0x2a71b74 size 0x8 virtual false final false
 UnityEngine::ResourceManagement::ResourceManager get_ResourceManager() ;

/// @brief Method get_Type addr 0x2a70f1c size 0xac virtual false final false
 System::Type get_Type() ;

/// @brief Method get_Location addr 0x2a6e3b0 size 0xac virtual false final false
 UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation get_Location() ;

/// @brief Method get_DependencyCount addr 0x2a71b7c size 0xac virtual false final false
...
/// @brief Method GetDependencies addr 0x2a70b00 size 0xb4 virtual false final false
 void GetDependencies(System::Collections::Generic::IList_1<::bs_hook::Il2CppWrapperType> list) ;

/// @brief Method SetProgressCallback addr 0x2a6ebfc size 0xb4 virtual false final false
 void SetProgressCallback(System::Func_1<float_t> callback) ;

/// @brief Method SetDownloadProgressCallbacks addr 0x2a6ecb0 size 0xb4 virtual false final false
 void SetDownloadProgressCallbacks(System::Func_1<UnityEngine::ResourceManagement::AsyncOperations::DownloadStatus> callback) ;

/// @brief Method SetWaitForCompletionCallback addr 0x2a6ed64 size 0xb4 virtual false final false
