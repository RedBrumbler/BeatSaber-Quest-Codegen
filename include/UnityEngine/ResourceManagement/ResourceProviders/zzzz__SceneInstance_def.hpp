...
/// @brief Method get_Scene addr 0x2a71c28 size 0x8 virtual false final false
 UnityEngine::SceneManagement::Scene get_Scene() ;

/// @brief Method set_Scene addr 0x2a71c30 size 0x8 virtual false final false
 void set_Scene(UnityEngine::SceneManagement::Scene value) ;

/// @brief Method Activate addr 0x2a71c38 size 0x20 virtual false final false
 void Activate() ;

/// @brief Method ActivateAsync addr 0x2a71c58 size 0x2c virtual false final false
 UnityEngine::AsyncOperation ActivateAsync() ;

/// @brief Method GetHashCode addr 0x2a71c84 size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2a71ca4 size 0xb8 virtual true final false
