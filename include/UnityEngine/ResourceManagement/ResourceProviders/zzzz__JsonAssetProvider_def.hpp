...
namespace UnityEngine::ResourceManagement::ResourceProviders {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14320))}
...
/// @brief Method Convert addr 0x2a71f54 size 0xc virtual true final false
 ::bs_hook::Il2CppWrapperType Convert(System::Type type, ::StringW text) ;

// Ctor Parameters []
explicit JsonAssetProvider() ;

/// @brief Method .ctor addr 0x2a71f60 size 0x8 virtual false final false
 void _ctor() ;
