...
/// @brief Method get_InternalId addr 0x2a752ec size 0x8 virtual true final true
 ::StringW get_InternalId() ;

/// @brief Method get_ProviderId addr 0x2a752f4 size 0x8 virtual true final true
 ::StringW get_ProviderId() ;

/// @brief Method get_Dependencies addr 0x2a752fc size 0x8 virtual true final true
 System::Collections::Generic::IList_1<UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation> get_Dependencies() ;

/// @brief Method get_HasDependencies addr 0x2a75304 size 0x54 virtual true final true
 bool get_HasDependencies() ;

/// @brief Method get_Data addr 0x2a75358 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType get_Data() ;

/// @brief Method set_Data addr 0x2a75360 size 0x8 virtual false final false
 void set_Data(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_PrimaryKey addr 0x2a75368 size 0x8 virtual true final true
 ::StringW get_PrimaryKey() ;

/// @brief Method set_PrimaryKey addr 0x2a75370 size 0x8 virtual false final false
 void set_PrimaryKey(::StringW value) ;

/// @brief Method get_DependencyHashCode addr 0x2a75378 size 0x8 virtual true final true
 int32_t get_DependencyHashCode() ;

/// @brief Method get_ResourceType addr 0x2a75380 size 0x8 virtual true final true
 System::Type get_ResourceType() ;

/// @brief Method Hash addr 0x2a75388 size 0x54 virtual true final true
 int32_t Hash(System::Type t) ;

/// @brief Method ToString addr 0x2a753dc size 0x8 virtual true final false
 ::StringW ToString() ;
...
/// @brief Method .ctor addr 0x2a753e4 size 0x224 virtual false final false
...
/// @brief Method ComputeDependencyHash addr 0x2a75608 size 0x258 virtual false final false
