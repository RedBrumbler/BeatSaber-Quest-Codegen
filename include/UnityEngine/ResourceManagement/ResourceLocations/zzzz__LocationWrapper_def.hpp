...
/// @brief Method .ctor addr 0x2a6e080 size 0x28 virtual false final false
 void _ctor(UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation location) ;

/// @brief Method get_InternalId addr 0x2a75860 size 0xa0 virtual true final true
 ::StringW get_InternalId() ;

/// @brief Method get_ProviderId addr 0x2a75900 size 0xa4 virtual true final true
 ::StringW get_ProviderId() ;

/// @brief Method get_Dependencies addr 0x2a759a4 size 0xa4 virtual true final true
 System::Collections::Generic::IList_1<UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation> get_Dependencies() ;

/// @brief Method get_DependencyHashCode addr 0x2a75a48 size 0xa4 virtual true final true
 int32_t get_DependencyHashCode() ;

/// @brief Method get_HasDependencies addr 0x2a75aec size 0xa4 virtual true final true
 bool get_HasDependencies() ;

/// @brief Method get_Data addr 0x2a75b90 size 0xa4 virtual true final true
 ::bs_hook::Il2CppWrapperType get_Data() ;

/// @brief Method get_PrimaryKey addr 0x2a75c34 size 0xa4 virtual true final true
 ::StringW get_PrimaryKey() ;

/// @brief Method get_ResourceType addr 0x2a75cd8 size 0xa4 virtual true final true
 System::Type get_ResourceType() ;

/// @brief Method Hash addr 0x2a75d7c size 0xac virtual true final true
