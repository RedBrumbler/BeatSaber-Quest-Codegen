...
template<::cordl_internals::il2cpp_reference_type TObject,::cordl_internals::il2cpp_reference_type TObjectDependency>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14333)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14333), inst: 765 }), TypeDefinitionIndex(TypeDefinitionIndex(14250))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14250), inst: 80 })
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14250)), TypeDefinitionIndex(TypeDefinitionIndex(14333)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14333), inst: 765 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14250), inst: 6725 })
// CS Name: UnityEngine.ResourceManagement.ChainOperation`2
