...
namespace UnityEngine::ResourceManagement::AsyncOperations {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14335)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3820), inst: 265 }), TypeDefinitionIndex(TypeDefinitionIndex(3820)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14333), inst: 768 }), TypeDefinitionIndex(TypeDefinitionIndex(14333))}
...
/// @brief Method .ctor addr 0x2a77f10 size 0x138 virtual false final false
 void _ctor() ;

/// @brief Method InvokeWaitForCompletion addr 0x2a78048 size 0x3d8 virtual true final false
 bool InvokeWaitForCompletion() ;

/// @brief Method UnityEngine.ResourceManagement.AsyncOperations.ICachable.get_Key addr 0x2a78420 size 0x8 virtual true final true
 UnityEngine::ResourceManagement::Util::IOperationCacheKey UnityEngine_ResourceManagement_AsyncOperations_ICachable_get_Key() ;

/// @brief Method UnityEngine.ResourceManagement.AsyncOperations.ICachable.set_Key addr 0x2a78428 size 0x8 virtual true final true
...
/// @brief Method GetDependentOps addr 0x2a67a60 size 0x3c virtual false final false
 System::Collections::Generic::IList_1<UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle> GetDependentOps() ;

/// @brief Method GetDependencies addr 0x2a78430 size 0x64 virtual true final false
...
/// @brief Method ReleaseDependencies addr 0x2a78494 size 0x254 virtual true final false
 void ReleaseDependencies() ;

/// @brief Method GetDownloadStatus addr 0x2a786e8 size 0x260 virtual true final false
...
/// @brief Method DependenciesAreUnchanged addr 0x2a78948 size 0x1cc virtual false final false
...
/// @brief Method get_DebugName addr 0x2a78b14 size 0x2d4 virtual true final false
 ::StringW get_DebugName() ;

/// @brief Method Execute addr 0x2a78de8 size 0x218 virtual true final false
 void Execute() ;

/// @brief Method CompleteIfDependenciesComplete addr 0x2a79000 size 0x308 virtual false final false
 void CompleteIfDependenciesComplete() ;

/// @brief Method Destroy addr 0x2a79308 size 0x10 virtual true final false
 void Destroy() ;

/// @brief Method get_Progress addr 0x2a79318 size 0x1f8 virtual true final false
 float_t get_Progress() ;

/// @brief Method Init addr 0x2a67974 size 0xbc virtual false final false
...
/// @brief Method Init addr 0x2a79510 size 0x98 virtual false final false
...
/// @brief Method OnOperationCompleted addr 0x2a795a8 size 0x10 virtual false final false
