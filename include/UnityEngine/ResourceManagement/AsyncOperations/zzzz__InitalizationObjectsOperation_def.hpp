...
/// @brief Method Init addr 0x28af974 size 0x34 virtual false final false
...
/// @brief Method get_DebugName addr 0x28afa44 size 0x40 virtual true final false
 ::StringW get_DebugName() ;

/// @brief Method LogRuntimeWarnings addr 0x28afa84 size 0x1fc virtual false final false
 bool LogRuntimeWarnings(::StringW pathToBuildLogs) ;

/// @brief Method InvokeWaitForCompletion addr 0x28afdb0 size 0x1a0 virtual true final false
 bool InvokeWaitForCompletion() ;

/// @brief Method Execute addr 0x28aff50 size 0x6a0 virtual true final false
 void Execute() ;

// Ctor Parameters []
explicit InitalizationObjectsOperation() ;

/// @brief Method .ctor addr 0x28b06ec size 0x48 virtual false final false
 void _ctor() ;

/// @brief Method <Execute>b__8_0 addr 0x28b0734 size 0x1ac virtual false final false
