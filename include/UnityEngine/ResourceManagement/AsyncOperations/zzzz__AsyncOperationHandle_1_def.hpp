...
template<::cordl_internals::il2cpp_reference_type TObject>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14334)), TypeDefinitionIndex(TypeDefinitionIndex(2638))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14334), inst: 2 })
...
template<>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2638)), TypeDefinitionIndex(TypeDefinitionIndex(14334))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14334), inst: 99 })
// CS Name: UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle`1
...
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2638)), TypeDefinitionIndex(TypeDefinitionIndex(14334))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14334), inst: 773 })
// CS Name: UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle`1
...
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14334)), TypeDefinitionIndex(TypeDefinitionIndex(2638))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14334), inst: 831 })
// CS Name: UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle`1
struct CORDL_TYPE AsyncOperationHandle_1<int64_t> : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to System::Collections::IEnumerator
constexpr operator  System::Collections::IEnumerator() const;
...
constexpr operator  System::IEquatable_1<UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<int64_t>>() const;
...
// Fields
 ...
 UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<int64_t> __declspec(property(get=__get_m_InternalOp, put=__set_m_InternalOp))  m_InternalOp;

constexpr void __set_m_InternalOp(UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<int64_t> value) ;

constexpr UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<int64_t> __get_m_InternalOp() const;
...
// Properties
 ...
 UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<int64_t> __declspec(property(get=get_InternalOp))  InternalOp;
...
/// @brief Method op_Implicit addr 0x0 size 0xffffffffffffffff virtual false final false
static UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle op_Implicit_UnityEngine__ResourceManagement__AsyncOperations__AsyncOperationHandle(UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<int64_t> obj) ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<int64_t> op) ;
...
/// @brief Method Acquire addr 0x0 size 0xffffffffffffffff virtual false final false
 UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<int64_t> Acquire() ;
...
/// @brief Method Equals addr 0x0 size 0xffffffffffffffff virtual true final true
 bool Equals(UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<int64_t> other) ;

/// @brief Method GetHashCode addr 0x0 size 0xffffffffffffffff virtual true final false
 int32_t GetHashCode() ;

/// @brief Method WaitForCompletion addr 0x0 size 0xffffffffffffffff virtual false final false
 int64_t WaitForCompletion() ;

/// @brief Method get_InternalOp addr 0x0 size 0xffffffffffffffff virtual false final false
 UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<int64_t> get_InternalOp() ;
