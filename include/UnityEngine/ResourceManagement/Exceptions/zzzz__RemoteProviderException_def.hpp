...
namespace UnityEngine::ResourceManagement::Exceptions {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14265))}
...
/// @brief Method .ctor addr 0x2a6a9e0 size 0x2c virtual false final false
...
/// @brief Method get_Message addr 0x2a6aa0c size 0xc virtual true final false
 ::StringW get_Message() ;

/// @brief Method get_WebRequestResult addr 0x2a6aa18 size 0x8 virtual false final false
 UnityEngine::ResourceManagement::Util::UnityWebRequestResult get_WebRequestResult() ;

/// @brief Method ToString addr 0x2a6aa20 size 0x174 virtual true final false
 ::StringW ToString() ;
