...
namespace UnityEngine::ResourceManagement::Exceptions {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14264))}
...
/// @brief Method .ctor addr 0x2a6a9b0 size 0x28 virtual false final false
...
/// @brief Method get_Location addr 0x2a6a9d8 size 0x8 virtual false final false
