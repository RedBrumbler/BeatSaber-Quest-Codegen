...
/// @brief Method ExtractKeyAndSubKey addr 0x2a6d304 size 0xe4 virtual false final false
static bool ExtractKeyAndSubKey(::bs_hook::Il2CppWrapperType keyObj, ByRef<::StringW> mainKey, ByRef<::StringW> subKey) ;

/// @brief Method IsPathRemote addr 0x2a6d3e8 size 0x60 virtual false final false
static bool IsPathRemote(::StringW path) ;

/// @brief Method StripQueryParameters addr 0x2a6d448 size 0x44 virtual false final false
static ::StringW StripQueryParameters(::StringW path) ;

/// @brief Method ShouldPathUseWebRequest addr 0x2a6d48c size 0x7c virtual false final false
static bool ShouldPathUseWebRequest(::StringW path) ;

/// @brief Method PlatformCanLoadLocallyFromUrlPath addr 0x2a6d508 size 0x104 virtual false final false
static bool PlatformCanLoadLocallyFromUrlPath() ;

/// @brief Method CreateArrayResult addr 0x2a6d60c size 0x1b8 virtual false final false
...
/// @brief Method CreateListResult addr 0x2a6d7c4 size 0x1cc virtual false final false
