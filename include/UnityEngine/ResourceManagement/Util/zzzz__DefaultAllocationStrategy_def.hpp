...
/// @brief Method New addr 0x2a6c834 size 0xc virtual true final true
 ::bs_hook::Il2CppWrapperType New(System::Type type, int32_t typeHash) ;

/// @brief Method Release addr 0x2a6c840 size 0x4 virtual true final true
 void Release(int32_t typeHash, ::bs_hook::Il2CppWrapperType obj) ;

// Ctor Parameters []
explicit DefaultAllocationStrategy() ;

/// @brief Method .ctor addr 0x2a6c844 size 0x8 virtual false final false
 void _ctor() ;
