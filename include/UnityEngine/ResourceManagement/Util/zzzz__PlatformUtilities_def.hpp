...
/// @brief Method PlatformUsesMultiThreading addr 0x2a6c820 size 0xc virtual false final false
static bool PlatformUsesMultiThreading(UnityEngine::RuntimePlatform platform) ;

// Ctor Parameters []
explicit PlatformUtilities() ;

/// @brief Method .ctor addr 0x2a6c82c size 0x8 virtual false final false
 void _ctor() ;
