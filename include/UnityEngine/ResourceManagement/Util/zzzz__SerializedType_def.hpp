...
/// @brief Method get_AssemblyName addr 0x2a6cc78 size 0x8 virtual false final false
 ::StringW get_AssemblyName() ;

/// @brief Method get_ClassName addr 0x2a6cc80 size 0x8 virtual false final false
 ::StringW get_ClassName() ;

/// @brief Method ToString addr 0x2a6cc88 size 0xb0 virtual true final false
 ::StringW ToString() ;

/// @brief Method get_Value addr 0x2a6cd38 size 0x1f4 virtual false final false
 System::Type get_Value() ;

/// @brief Method set_Value addr 0x2a6cf2c size 0xc0 virtual false final false
 void set_Value(System::Type value) ;

/// @brief Method get_ValueChanged addr 0x2a6cfec size 0x8 virtual false final false
 bool get_ValueChanged() ;

/// @brief Method set_ValueChanged addr 0x2a6cff4 size 0xc virtual false final false
