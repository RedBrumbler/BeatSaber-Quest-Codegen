...
/// @brief Method .ctor addr 0x2a64bec size 0x1d8 virtual false final false
 void _ctor(int32_t poolMaxSize, int32_t poolCapacity, int32_t poolCacheMaxSize, int32_t initialPoolCacheCapacity) ;

/// @brief Method GetPool addr 0x2a6c84c size 0xf0 virtual false final false
 System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType> GetPool() ;

/// @brief Method ReleasePool addr 0x2a6c93c size 0xc0 virtual false final false
 void ReleasePool(System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType> pool) ;

/// @brief Method New addr 0x2a6c9fc size 0x13c virtual true final true
 ::bs_hook::Il2CppWrapperType New(System::Type type, int32_t typeHash) ;

/// @brief Method Release addr 0x2a6cb38 size 0x138 virtual true final true
