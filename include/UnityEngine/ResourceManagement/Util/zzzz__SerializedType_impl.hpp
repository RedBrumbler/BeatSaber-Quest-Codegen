...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (UnityEngine::ResourceManagement::Util::SerializedType::*)()>(&UnityEngine::ResourceManagement::Util::SerializedType::get_AssemblyName)> {
  ...
  constexpr static std::size_t addrs = 0x2a6cc78;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (UnityEngine::ResourceManagement::Util::SerializedType::*)()>(&UnityEngine::ResourceManagement::Util::SerializedType::get_ClassName)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2a6cc80;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (UnityEngine::ResourceManagement::Util::SerializedType::*)()>(&UnityEngine::ResourceManagement::Util::SerializedType::ToString)> {
  ...
  constexpr static std::size_t addrs = 0x2a6cc88;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(UnityEngine::ResourceManagement::Util::SerializedType),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<UnityEngine::ResourceManagement::Util::SerializedType>::get(),
                                  3
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Type (UnityEngine::ResourceManagement::Util::SerializedType::*)()>(&UnityEngine::ResourceManagement::Util::SerializedType::get_Value)> {
  ...
  constexpr static std::size_t addrs = 0x2a6cd38;
...
// Ctor Parameters [CppParam { name: "m_AssemblyName", ty: "::StringW", modifiers: "", def_value: Some("csnull") }, CppParam { name: "m_ClassName", ty: "::StringW", modifiers: "", def_value: Some("csnull") }, CppParam { name: "m_CachedType", ty: "System::Type", modifiers: "", def_value: Some("csnull") }, CppParam { name: "_ValueChanged_k__BackingField", ty: "bool", modifiers: "", def_value: Some("{}") }]
constexpr UnityEngine::ResourceManagement::Util::SerializedType::SerializedType(::StringW m_AssemblyName, ::StringW m_ClassName, System::Type m_CachedType, bool _ValueChanged_k__BackingField) noexcept : ::bs_hook::ValueTypeWrapper() {this->m_AssemblyName = m_AssemblyName;
...
constexpr void UnityEngine::ResourceManagement::Util::SerializedType::__set_m_AssemblyName(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x0>(this->__instance, std::forward<::StringW>(value));
}
constexpr ::StringW UnityEngine::ResourceManagement::Util::SerializedType::__get_m_AssemblyName() const {
return ::cordl_internals::getInstanceField<::StringW, 0x0>(this->__instance);
}
constexpr void UnityEngine::ResourceManagement::Util::SerializedType::__set_m_ClassName(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x8>(this->__instance, std::forward<::StringW>(value));
}
constexpr ::StringW UnityEngine::ResourceManagement::Util::SerializedType::__get_m_ClassName() const {
return ::cordl_internals::getInstanceField<::StringW, 0x8>(this->__instance);
}
constexpr void UnityEngine::ResourceManagement::Util::SerializedType::__set_m_CachedType(System::Type value)  {
::cordl_internals::setInstanceField<System::Type, 0x10>(this->__instance, std::forward<System::Type>(value));
}
constexpr System::Type UnityEngine::ResourceManagement::Util::SerializedType::__get_m_CachedType() const {
return ::cordl_internals::getInstanceField<System::Type, 0x10>(this->__instance);
}
constexpr void UnityEngine::ResourceManagement::Util::SerializedType::__set__ValueChanged_k__BackingField(bool value)  {
::cordl_internals::setInstanceField<bool, 0x18>(this->__instance, std::forward<bool>(value));
}
constexpr bool UnityEngine::ResourceManagement::Util::SerializedType::__get__ValueChanged_k__BackingField() const {
