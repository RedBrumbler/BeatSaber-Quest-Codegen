...
/// @brief Method get_Id addr 0x2a6d000 size 0x8 virtual false final false
 ::StringW get_Id() ;

/// @brief Method get_ObjectType addr 0x2a6d008 size 0x10 virtual false final false
 UnityEngine::ResourceManagement::Util::SerializedType get_ObjectType() ;

/// @brief Method get_Data addr 0x2a6d018 size 0x8 virtual false final false
 ::StringW get_Data() ;

/// @brief Method ToString addr 0x2a6d020 size 0x98 virtual true final false
 ::StringW ToString() ;
...
/// @brief Method GetAsyncInitHandle addr 0x2a6d0b8 size 0x24c virtual false final false
