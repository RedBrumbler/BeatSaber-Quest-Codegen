...
/// @brief Method .ctor addr 0x2a6dac8 size 0x108 virtual false final false
 void _ctor(UnityEngine::Networking::UnityWebRequest request) ;

/// @brief Method ToString addr 0x2a6dbd8 size 0x180 virtual true final false
 ::StringW ToString() ;

/// @brief Method get_Error addr 0x2a6dd58 size 0x8 virtual false final false
 ::StringW get_Error() ;

/// @brief Method set_Error addr 0x2a6dd60 size 0x8 virtual false final false
 void set_Error(::StringW value) ;

/// @brief Method get_ResponseCode addr 0x2a6dd68 size 0x8 virtual false final false
 int64_t get_ResponseCode() ;

/// @brief Method get_Result addr 0x2a6dd70 size 0x8 virtual false final false
 UnityEngine::Networking::UnityEngine__Networking__UnityWebRequest__Result get_Result() ;

/// @brief Method get_Method addr 0x2a6dd78 size 0x8 virtual false final false
 ::StringW get_Method() ;

/// @brief Method get_Url addr 0x2a6dd80 size 0x8 virtual false final false
 ::StringW get_Url() ;

/// @brief Method ShouldRetryDownloadError addr 0x2a6dd88 size 0x2d0 virtual false final false
