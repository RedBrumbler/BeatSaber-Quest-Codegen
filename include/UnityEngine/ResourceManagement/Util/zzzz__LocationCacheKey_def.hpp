...
/// @brief Method .ctor addr 0x2a66420 size 0xf8 virtual false final false
 void _ctor(UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation location, System::Type desiredType) ;

/// @brief Method GetHashCode addr 0x2a6be38 size 0xac virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2a6bee4 size 0x64 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2a6bfa4 size 0x64 virtual true final true
 bool Equals(UnityEngine::ResourceManagement::Util::IOperationCacheKey other) ;

/// @brief Method Equals addr 0x2a6bf48 size 0x5c virtual false final false
