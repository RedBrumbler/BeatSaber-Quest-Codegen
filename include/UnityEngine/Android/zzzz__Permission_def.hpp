...
/// @brief Method GetActivity addr 0x2b49f20 size 0x218 virtual false final false
static UnityEngine::AndroidJavaObject GetActivity() ;

/// @brief Method GetUnityPermissions addr 0x2b4a138 size 0xb8 virtual false final false
static UnityEngine::AndroidJavaObject GetUnityPermissions() ;

/// @brief Method HasUserAuthorizedPermission addr 0x2b4a1f0 size 0x120 virtual false final false
static bool HasUserAuthorizedPermission(::StringW permission) ;

/// @brief Method RequestUserPermission addr 0x2b4a310 size 0xa4 virtual false final false
static void RequestUserPermission(::StringW permission, UnityEngine::Android::PermissionCallbacks callbacks) ;

/// @brief Method RequestUserPermissions addr 0x2b4a3b4 size 0x1138 virtual false final false
