...
/// @brief Method set_minDistance addr 0x2bd2484 size 0x4c virtual false final false
 void set_minDistance(float_t value) ;

/// @brief Method set_maxDistance addr 0x2bd24d0 size 0x4c virtual false final false
