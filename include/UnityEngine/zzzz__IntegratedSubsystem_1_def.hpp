...
template<::cordl_internals::il2cpp_reference_type TSubsystemDescriptor>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15870)), TypeDefinitionIndex(TypeDefinitionIndex(15869))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15870), inst: 2 })
