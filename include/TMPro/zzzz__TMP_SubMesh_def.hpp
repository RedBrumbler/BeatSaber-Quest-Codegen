...
/// @brief Method get_fontAsset addr 0x2adfcb4 size 0x8 virtual false final false
 TMPro::TMP_FontAsset get_fontAsset() ;

/// @brief Method set_fontAsset addr 0x2adfcbc size 0x8 virtual false final false
 void set_fontAsset(TMPro::TMP_FontAsset value) ;

/// @brief Method get_spriteAsset addr 0x2adfcc4 size 0x8 virtual false final false
 TMPro::TMP_SpriteAsset get_spriteAsset() ;

/// @brief Method set_spriteAsset addr 0x2adfccc size 0x8 virtual false final false
 void set_spriteAsset(TMPro::TMP_SpriteAsset value) ;

/// @brief Method get_material addr 0x2adfcd4 size 0x8 virtual false final false
 UnityEngine::Material get_material() ;

/// @brief Method set_material addr 0x2adfe04 size 0x74 virtual false final false
 void set_material(UnityEngine::Material value) ;

/// @brief Method get_sharedMaterial addr 0x2adffa0 size 0x8 virtual false final false
 UnityEngine::Material get_sharedMaterial() ;

/// @brief Method set_sharedMaterial addr 0x2adffa8 size 0x20 virtual false final false
 void set_sharedMaterial(UnityEngine::Material value) ;

/// @brief Method get_fallbackMaterial addr 0x2adffe8 size 0x8 virtual false final false
 UnityEngine::Material get_fallbackMaterial() ;

/// @brief Method set_fallbackMaterial addr 0x2adfff0 size 0x138 virtual false final false
 void set_fallbackMaterial(UnityEngine::Material value) ;

/// @brief Method get_fallbackSourceMaterial addr 0x2ae0128 size 0x8 virtual false final false
 UnityEngine::Material get_fallbackSourceMaterial() ;

/// @brief Method set_fallbackSourceMaterial addr 0x2ae0130 size 0x8 virtual false final false
 void set_fallbackSourceMaterial(UnityEngine::Material value) ;

/// @brief Method get_isDefaultMaterial addr 0x2ae0138 size 0x8 virtual false final false
 bool get_isDefaultMaterial() ;

/// @brief Method set_isDefaultMaterial addr 0x2ae0140 size 0xc virtual false final false
 void set_isDefaultMaterial(bool value) ;

/// @brief Method get_padding addr 0x2ae014c size 0x8 virtual false final false
 float_t get_padding() ;

/// @brief Method set_padding addr 0x2ae0154 size 0x8 virtual false final false
 void set_padding(float_t value) ;

/// @brief Method get_renderer addr 0x2ae015c size 0x94 virtual false final false
 UnityEngine::Renderer get_renderer() ;

/// @brief Method get_meshFilter addr 0x2ae01f0 size 0xfc virtual false final false
 UnityEngine::MeshFilter get_meshFilter() ;

/// @brief Method get_mesh addr 0x2ae02ec size 0xb0 virtual false final false
 UnityEngine::Mesh get_mesh() ;

/// @brief Method set_mesh addr 0x2ae039c size 0x8 virtual false final false
 void set_mesh(UnityEngine::Mesh value) ;

/// @brief Method get_textComponent addr 0x2ae03a4 size 0x94 virtual false final false
 TMPro::TMP_Text get_textComponent() ;

/// @brief Method AddSubTextObject addr 0x2ae0438 size 0x3c4 virtual false final false
static TMPro::TMP_SubMesh AddSubTextObject(TMPro::TextMeshPro textComponent, TMPro::MaterialReference materialReference) ;

/// @brief Method OnEnable addr 0x2ae07fc size 0x12c virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2ae0928 size 0xb4 virtual false final false
 void OnDisable() ;

/// @brief Method OnDestroy addr 0x2ae09dc size 0x148 virtual false final false
 void OnDestroy() ;

/// @brief Method DestroySelf addr 0x2ae0b24 size 0x70 virtual false final false
 void DestroySelf() ;

/// @brief Method GetMaterial addr 0x2adfcdc size 0x128 virtual false final false
 UnityEngine::Material GetMaterial(UnityEngine::Material mat) ;

/// @brief Method CreateMaterialInstance addr 0x2ae0b94 size 0xc0 virtual false final false
 UnityEngine::Material CreateMaterialInstance(UnityEngine::Material source) ;

/// @brief Method GetSharedMaterial addr 0x2ae0c54 size 0xa4 virtual false final false
 UnityEngine::Material GetSharedMaterial() ;

/// @brief Method SetSharedMaterial addr 0x2adffc8 size 0x20 virtual false final false
 void SetSharedMaterial(UnityEngine::Material mat) ;

/// @brief Method GetPaddingForMaterial addr 0x2adfe78 size 0x74 virtual false final false
 float_t GetPaddingForMaterial() ;

/// @brief Method UpdateMeshPadding addr 0x2ae0cf8 size 0x74 virtual false final false
 void UpdateMeshPadding(bool isExtraPadding, bool isUsingBold) ;

/// @brief Method SetVerticesDirty addr 0x2adfeec size 0xb0 virtual false final false
 void SetVerticesDirty() ;

/// @brief Method SetMaterialDirty addr 0x2adff9c size 0x4 virtual false final false
 void SetMaterialDirty() ;

/// @brief Method UpdateMaterial addr 0x2ae0d6c size 0x170 virtual false final false
 void UpdateMaterial() ;

// Ctor Parameters []
explicit TMP_SubMesh() ;

/// @brief Method .ctor addr 0x2ae0edc size 0x8 virtual false final false
 void _ctor() ;
