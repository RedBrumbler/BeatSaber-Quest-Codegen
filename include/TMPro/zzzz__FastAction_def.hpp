...
/// @brief Method Add addr 0x2a88900 size 0xc0 virtual false final false
 void Add(System::Action rhs) ;

/// @brief Method Remove addr 0x2a889c0 size 0xc0 virtual false final false
 void Remove(System::Action rhs) ;

/// @brief Method Call addr 0x2a88a80 size 0x98 virtual false final false
 void Call() ;

// Ctor Parameters []
explicit FastAction() ;

/// @brief Method .ctor addr 0x2a88b18 size 0xc0 virtual false final false
 void _ctor() ;
