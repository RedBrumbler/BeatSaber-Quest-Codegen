...
template<::cordl_internals::il2cpp_reference_type A,::cordl_internals::il2cpp_reference_type B>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12260))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12260), inst: 80 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12260))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12260), inst: 5143 })
// CS Name: TMPro.FastAction`2
