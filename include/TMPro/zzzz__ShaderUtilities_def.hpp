...
/// @brief Method get_ShaderRef_MobileSDF addr 0x2adae68 size 0xfc virtual false final false
static UnityEngine::Shader get_ShaderRef_MobileSDF() ;

/// @brief Method get_ShaderRef_MobileBitmap addr 0x2adaf64 size 0xfc virtual false final false
static UnityEngine::Shader get_ShaderRef_MobileBitmap() ;

/// @brief Method GetShaderPropertyIDs addr 0x2ad46f0 size 0xaec virtual false final false
static void GetShaderPropertyIDs() ;

/// @brief Method UpdateShaderRatios addr 0x2adb1f0 size 0x45c virtual false final false
static void UpdateShaderRatios(UnityEngine::Material mat) ;

/// @brief Method GetFontExtent addr 0x2adb64c size 0x44 virtual false final false
static UnityEngine::Vector4 GetFontExtent(UnityEngine::Material material) ;

/// @brief Method IsMaskingEnabled addr 0x2adb690 size 0x19c virtual false final false
static bool IsMaskingEnabled(UnityEngine::Material material) ;

/// @brief Method GetPadding addr 0x2adb82c size 0x6a8 virtual false final false
static float_t GetPadding(UnityEngine::Material material, bool enableExtraPadding, bool isBold) ;

/// @brief Method GetPadding addr 0x2adbed4 size 0x880 virtual false final false
