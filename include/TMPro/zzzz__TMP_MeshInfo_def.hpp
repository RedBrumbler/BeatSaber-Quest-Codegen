...
/// @brief Method .ctor addr 0x2ad7774 size 0x4f8 virtual false final false
 void _ctor(UnityEngine::Mesh mesh, int32_t size) ;

/// @brief Method .ctor addr 0x2ad7c6c size 0x784 virtual false final false
 void _ctor(UnityEngine::Mesh mesh, int32_t size, bool isVolumetric) ;

/// @brief Method ResizeMeshInfo addr 0x2ad83f0 size 0x474 virtual false final false
 void ResizeMeshInfo(int32_t size) ;

/// @brief Method ResizeMeshInfo addr 0x2ad8864 size 0x8d4 virtual false final false
 void ResizeMeshInfo(int32_t size, bool isVolumetric) ;

/// @brief Method Clear addr 0x2ad9138 size 0xa4 virtual false final false
 void Clear() ;

/// @brief Method Clear addr 0x2ad91dc size 0x138 virtual false final false
 void Clear(bool uploadChanges) ;

/// @brief Method ClearUnusedVertices addr 0x2ad9314 size 0x3c virtual false final false
 void ClearUnusedVertices() ;

/// @brief Method ClearUnusedVertices addr 0x2ad9350 size 0x34 virtual false final false
 void ClearUnusedVertices(int32_t startIndex) ;

/// @brief Method ClearUnusedVertices addr 0x2ad9384 size 0xc4 virtual false final false
 void ClearUnusedVertices(int32_t startIndex, bool updateMesh) ;

/// @brief Method SortGeometry addr 0x2ad9448 size 0x7c virtual false final false
 void SortGeometry(TMPro::VertexSortingOrder order) ;

/// @brief Method SortGeometry addr 0x2ad9a50 size 0x1d4 virtual false final false
 void SortGeometry(System::Collections::Generic::IList_1<int32_t> sortingOrder) ;

/// @brief Method SwapVertexData addr 0x2ad94c4 size 0x58c virtual false final false
