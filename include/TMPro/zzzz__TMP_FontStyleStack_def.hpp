...
/// @brief Method Clear addr 0x2ae3678 size 0xc virtual false final false
 void Clear() ;

/// @brief Method Add addr 0x2ae3684 size 0xfc virtual false final false
 uint8_t Add(TMPro::FontStyles style) ;

/// @brief Method Remove addr 0x2ae3780 size 0x120 virtual false final false
