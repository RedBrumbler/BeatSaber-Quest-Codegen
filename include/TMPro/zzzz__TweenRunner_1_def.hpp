...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12304))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12304), inst: 5030 })
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12305))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12305), inst: 5030 })
