...
/// @brief Method GetTextSettings addr 0x2ad9da8 size 0x110 virtual false final false
static TMPro::TMP_Settings GetTextSettings() ;

/// @brief Method AddFontAsset addr 0x2ad9eb8 size 0x154 virtual false final false
static void AddFontAsset(TMPro::TMP_FontAsset fontAsset) ;

/// @brief Method TryGetFontAsset addr 0x2ada00c size 0x94 virtual false final false
static bool TryGetFontAsset(int32_t hashcode, ByRef<TMPro::TMP_FontAsset> fontAsset) ;

/// @brief Method RebuildFontAssetCache addr 0x2ada0a0 size 0x118 virtual false final false
static void RebuildFontAssetCache(int32_t instanceID) ;

// Ctor Parameters []
explicit TMP_ResourceManager() ;

/// @brief Method .ctor addr 0x2ad9da0 size 0x8 virtual false final false
 void _ctor() ;
