...
/// @brief Method get_firstAdjustmentRecord addr 0x2aaaa60 size 0x14 virtual false final false
 TMPro::TMP_GlyphAdjustmentRecord get_firstAdjustmentRecord() ;

/// @brief Method set_firstAdjustmentRecord addr 0x2aaaa74 size 0x14 virtual false final false
 void set_firstAdjustmentRecord(TMPro::TMP_GlyphAdjustmentRecord value) ;

/// @brief Method get_secondAdjustmentRecord addr 0x2aaaa88 size 0x14 virtual false final false
 TMPro::TMP_GlyphAdjustmentRecord get_secondAdjustmentRecord() ;

/// @brief Method set_secondAdjustmentRecord addr 0x2aaaa9c size 0x14 virtual false final false
 void set_secondAdjustmentRecord(TMPro::TMP_GlyphAdjustmentRecord value) ;

/// @brief Method get_featureLookupFlags addr 0x2aaaab0 size 0x8 virtual false final false
 TMPro::FontFeatureLookupFlags get_featureLookupFlags() ;

/// @brief Method set_featureLookupFlags addr 0x2aaaab8 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2aa8250 size 0x48 virtual false final false
...
/// @brief Method .ctor addr 0x2aa7740 size 0xb4 virtual false final false
