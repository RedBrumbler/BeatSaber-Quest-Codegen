...
/// @brief Method .ctor addr 0x2ae2668 size 0x128 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2ae2790 size 0x12c virtual false final false
...
/// @brief Method .ctor addr 0x2ae28bc size 0x16c virtual false final false
 void _ctor(TMPro::TMP_Text textComponent) ;

/// @brief Method Clear addr 0x2ae2a28 size 0x5c virtual false final false
 void Clear() ;

/// @brief Method ClearAllData addr 0x2ae2a84 size 0x12c virtual false final false
 void ClearAllData() ;

/// @brief Method ClearMeshInfo addr 0x2ae2bb0 size 0x70 virtual false final false
 void ClearMeshInfo(bool updateMesh) ;

/// @brief Method ClearAllMeshInfo addr 0x2ae2c20 size 0x64 virtual false final false
 void ClearAllMeshInfo() ;

/// @brief Method ResetVertexLayout addr 0x2ae2c84 size 0x74 virtual false final false
 void ResetVertexLayout(bool isVolumetric) ;

/// @brief Method ClearUnusedVertices addr 0x2ae2cf8 size 0x64 virtual false final false
 void ClearUnusedVertices(::ArrayW<TMPro::MaterialReference> materials) ;

/// @brief Method ClearLineInfo addr 0x2ae2d5c size 0x180 virtual false final false
 void ClearLineInfo() ;

/// @brief Method ClearPageInfo addr 0x2ae2edc size 0x98 virtual false final false
 void ClearPageInfo() ;

/// @brief Method CopyMeshInfoVertexData addr 0x2ae2f74 size 0x3c8 virtual false final false
