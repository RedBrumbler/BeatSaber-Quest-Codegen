...
/// @brief Method .ctor addr 0x2adad30 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_version addr 0x2ada3f0 size 0x40 virtual false final false
static ::StringW get_version() ;

/// @brief Method get_enableWordWrapping addr 0x2ada430 size 0x1c virtual false final false
static bool get_enableWordWrapping() ;

/// @brief Method get_enableKerning addr 0x2ada518 size 0x1c virtual false final false
static bool get_enableKerning() ;

/// @brief Method get_enableExtraPadding addr 0x2ada534 size 0x1c virtual false final false
static bool get_enableExtraPadding() ;

/// @brief Method get_enableTintAllSprites addr 0x2ada550 size 0x1c virtual false final false
static bool get_enableTintAllSprites() ;

/// @brief Method get_enableParseEscapeCharacters addr 0x2ada56c size 0x1c virtual false final false
static bool get_enableParseEscapeCharacters() ;

/// @brief Method get_enableRaycastTarget addr 0x2ada588 size 0x1c virtual false final false
static bool get_enableRaycastTarget() ;

/// @brief Method get_getFontFeaturesAtRuntime addr 0x2ada5a4 size 0x1c virtual false final false
static bool get_getFontFeaturesAtRuntime() ;

/// @brief Method get_missingGlyphCharacter addr 0x2ada5c0 size 0x1c virtual false final false
static int32_t get_missingGlyphCharacter() ;

/// @brief Method set_missingGlyphCharacter addr 0x2ada5dc size 0x20 virtual false final false
static void set_missingGlyphCharacter(int32_t value) ;

/// @brief Method get_warningsDisabled addr 0x2ada5fc size 0x1c virtual false final false
static bool get_warningsDisabled() ;

/// @brief Method get_defaultFontAsset addr 0x2ada618 size 0x1c virtual false final false
static TMPro::TMP_FontAsset get_defaultFontAsset() ;

/// @brief Method get_defaultFontAssetPath addr 0x2ada634 size 0x1c virtual false final false
static ::StringW get_defaultFontAssetPath() ;

/// @brief Method get_defaultFontSize addr 0x2ada650 size 0x1c virtual false final false
static float_t get_defaultFontSize() ;

/// @brief Method get_defaultTextAutoSizingMinRatio addr 0x2ada66c size 0x1c virtual false final false
static float_t get_defaultTextAutoSizingMinRatio() ;

/// @brief Method get_defaultTextAutoSizingMaxRatio addr 0x2ada688 size 0x1c virtual false final false
static float_t get_defaultTextAutoSizingMaxRatio() ;

/// @brief Method get_defaultTextMeshProTextContainerSize addr 0x2ada6a4 size 0x1c virtual false final false
static UnityEngine::Vector2 get_defaultTextMeshProTextContainerSize() ;

/// @brief Method get_defaultTextMeshProUITextContainerSize addr 0x2ada6c0 size 0x1c virtual false final false
static UnityEngine::Vector2 get_defaultTextMeshProUITextContainerSize() ;

/// @brief Method get_autoSizeTextContainer addr 0x2ada6dc size 0x1c virtual false final false
static bool get_autoSizeTextContainer() ;

/// @brief Method get_isTextObjectScaleStatic addr 0x2ada6f8 size 0x1c virtual false final false
static bool get_isTextObjectScaleStatic() ;

/// @brief Method set_isTextObjectScaleStatic addr 0x2ada714 size 0x24 virtual false final false
static void set_isTextObjectScaleStatic(bool value) ;

/// @brief Method get_fallbackFontAssets addr 0x2ada738 size 0x1c virtual false final false
static System::Collections::Generic::List_1<TMPro::TMP_FontAsset> get_fallbackFontAssets() ;

/// @brief Method get_matchMaterialPreset addr 0x2ada754 size 0x1c virtual false final false
static bool get_matchMaterialPreset() ;

/// @brief Method get_defaultSpriteAsset addr 0x2ada770 size 0x1c virtual false final false
static TMPro::TMP_SpriteAsset get_defaultSpriteAsset() ;

/// @brief Method get_defaultSpriteAssetPath addr 0x2ada78c size 0x1c virtual false final false
static ::StringW get_defaultSpriteAssetPath() ;

/// @brief Method get_enableEmojiSupport addr 0x2ada7a8 size 0x1c virtual false final false
static bool get_enableEmojiSupport() ;

/// @brief Method set_enableEmojiSupport addr 0x2ada7c4 size 0x24 virtual false final false
static void set_enableEmojiSupport(bool value) ;

/// @brief Method get_missingCharacterSpriteUnicode addr 0x2ada7e8 size 0x1c virtual false final false
static uint32_t get_missingCharacterSpriteUnicode() ;

/// @brief Method set_missingCharacterSpriteUnicode addr 0x2ada804 size 0x20 virtual false final false
static void set_missingCharacterSpriteUnicode(uint32_t value) ;

/// @brief Method get_defaultColorGradientPresetsPath addr 0x2ada824 size 0x1c virtual false final false
static ::StringW get_defaultColorGradientPresetsPath() ;

/// @brief Method get_defaultStyleSheet addr 0x2ada840 size 0x1c virtual false final false
static TMPro::TMP_StyleSheet get_defaultStyleSheet() ;

/// @brief Method get_styleSheetsResourcePath addr 0x2ada85c size 0x1c virtual false final false
static ::StringW get_styleSheetsResourcePath() ;

/// @brief Method get_leadingCharacters addr 0x2ada878 size 0x1c virtual false final false
static UnityEngine::TextAsset get_leadingCharacters() ;

/// @brief Method get_followingCharacters addr 0x2ada894 size 0x1c virtual false final false
static UnityEngine::TextAsset get_followingCharacters() ;

/// @brief Method get_linebreakingRules addr 0x2ada8b0 size 0x30 virtual false final false
static TMPro::TMPro__TMP_Settings__LineBreakingTable get_linebreakingRules() ;

/// @brief Method get_useModernHangulLineBreakingRules addr 0x2ada9f0 size 0x1c virtual false final false
static bool get_useModernHangulLineBreakingRules() ;

/// @brief Method set_useModernHangulLineBreakingRules addr 0x2adaa0c size 0x24 virtual false final false
static void set_useModernHangulLineBreakingRules(bool value) ;

/// @brief Method get_instance addr 0x2ada44c size 0xcc virtual false final false
static TMPro::TMP_Settings get_instance() ;

/// @brief Method LoadDefaultSettings addr 0x2adaa30 size 0xf8 virtual false final false
static TMPro::TMP_Settings LoadDefaultSettings() ;

/// @brief Method GetSettings addr 0x2adab28 size 0x7c virtual false final false
static TMPro::TMP_Settings GetSettings() ;

/// @brief Method GetFontAsset addr 0x2adaba4 size 0x84 virtual false final false
static TMPro::TMP_FontAsset GetFontAsset() ;

/// @brief Method GetSpriteAsset addr 0x2adac28 size 0x84 virtual false final false
static TMPro::TMP_SpriteAsset GetSpriteAsset() ;

/// @brief Method GetStyleSheet addr 0x2adacac size 0x84 virtual false final false
static TMPro::TMP_StyleSheet GetStyleSheet() ;

/// @brief Method LoadLinebreakingRules addr 0x2ada8e0 size 0x110 virtual false final false
static void LoadLinebreakingRules() ;

/// @brief Method GetCharacters addr 0x2adad38 size 0x120 virtual false final false
...
/// @brief Method .ctor addr 0x2adae58 size 0x10 virtual false final false
 void _ctor() ;
