...
/// @brief Method get_hasChanged addr 0x2a89a58 size 0x8 virtual false final false
 bool get_hasChanged() ;

/// @brief Method set_hasChanged addr 0x2a89a60 size 0xc virtual false final false
 void set_hasChanged(bool value) ;

/// @brief Method get_pivot addr 0x2a89a6c size 0x8 virtual false final false
 UnityEngine::Vector2 get_pivot() ;

/// @brief Method set_pivot addr 0x2a89a74 size 0x58 virtual false final false
 void set_pivot(UnityEngine::Vector2 value) ;

/// @brief Method get_anchorPosition addr 0x2a89d0c size 0x8 virtual false final false
 TMPro::TextContainerAnchors get_anchorPosition() ;

/// @brief Method set_anchorPosition addr 0x2a89d14 size 0x3c virtual false final false
 void set_anchorPosition(TMPro::TextContainerAnchors value) ;

/// @brief Method get_rect addr 0x2a89dc8 size 0xc virtual false final false
 UnityEngine::Rect get_rect() ;

/// @brief Method set_rect addr 0x2a89dd4 size 0x7c virtual false final false
 void set_rect(UnityEngine::Rect value) ;

/// @brief Method get_size addr 0x2a89e50 size 0x3c virtual false final false
 UnityEngine::Vector2 get_size() ;

/// @brief Method set_size addr 0x2a89e8c size 0xa8 virtual false final false
 void set_size(UnityEngine::Vector2 value) ;

/// @brief Method get_width addr 0x2a89fb4 size 0xc virtual false final false
 float_t get_width() ;

/// @brief Method set_width addr 0x2a89fc0 size 0x48 virtual false final false
 void set_width(float_t value) ;

/// @brief Method get_height addr 0x2a8a008 size 0xc virtual false final false
 float_t get_height() ;

/// @brief Method set_height addr 0x2a8a014 size 0x44 virtual false final false
 void set_height(float_t value) ;

/// @brief Method get_isDefaultWidth addr 0x2a8a058 size 0x8 virtual false final false
 bool get_isDefaultWidth() ;

/// @brief Method get_isDefaultHeight addr 0x2a8a060 size 0x8 virtual false final false
 bool get_isDefaultHeight() ;

/// @brief Method get_isAutoFitting addr 0x2a8a068 size 0x8 virtual false final false
 bool get_isAutoFitting() ;

/// @brief Method set_isAutoFitting addr 0x2a8a070 size 0xc virtual false final false
 void set_isAutoFitting(bool value) ;

/// @brief Method get_corners addr 0x2a8a07c size 0x8 virtual false final false
 ::ArrayW<UnityEngine::Vector3> get_corners() ;

/// @brief Method get_worldCorners addr 0x2a8a084 size 0x8 virtual false final false
 ::ArrayW<UnityEngine::Vector3> get_worldCorners() ;

/// @brief Method get_margins addr 0x2a8a08c size 0xc virtual false final false
 UnityEngine::Vector4 get_margins() ;

/// @brief Method set_margins addr 0x2a8a098 size 0x5c virtual false final false
 void set_margins(UnityEngine::Vector4 value) ;

/// @brief Method get_rectTransform addr 0x2a8a0f4 size 0x94 virtual false final false
 UnityEngine::RectTransform get_rectTransform() ;

/// @brief Method get_textMeshPro addr 0x2a8a188 size 0x94 virtual false final false
 TMPro::TextMeshPro get_textMeshPro() ;

/// @brief Method Awake addr 0x2a8a21c size 0xc8 virtual true final false
 void Awake() ;

/// @brief Method OnEnable addr 0x2a8a2e4 size 0x4 virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2a8a2e8 size 0x4 virtual true final false
 void OnDisable() ;

/// @brief Method OnContainerChanged addr 0x2a89bbc size 0x150 virtual false final false
 void OnContainerChanged() ;

/// @brief Method OnRectTransformDimensionsChange addr 0x2a8a4c4 size 0x160 virtual true final false
 void OnRectTransformDimensionsChange() ;

/// @brief Method SetRect addr 0x2a89f34 size 0x80 virtual false final false
 void SetRect(UnityEngine::Vector2 size) ;

/// @brief Method UpdateCorners addr 0x2a8a2ec size 0x1d8 virtual false final false
 void UpdateCorners() ;

/// @brief Method GetPivot addr 0x2a89d50 size 0x78 virtual false final false
 UnityEngine::Vector2 GetPivot(TMPro::TextContainerAnchors anchor) ;

/// @brief Method GetAnchorPosition addr 0x2a89acc size 0xf0 virtual false final false
 TMPro::TextContainerAnchors GetAnchorPosition(UnityEngine::Vector2 pivot) ;

// Ctor Parameters []
explicit TextContainer() ;

/// @brief Method .ctor addr 0x2a8a624 size 0x70 virtual false final false
 void _ctor() ;
