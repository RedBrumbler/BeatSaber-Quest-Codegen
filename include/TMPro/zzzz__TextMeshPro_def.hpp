...
/// @brief Method get_sortingLayerID addr 0x2a8a6e4 size 0x94 virtual false final false
 int32_t get_sortingLayerID() ;

/// @brief Method set_sortingLayerID addr 0x2a8a80c size 0xb4 virtual false final false
 void set_sortingLayerID(int32_t value) ;

/// @brief Method get_sortingOrder addr 0x2a8a9cc size 0x94 virtual false final false
 int32_t get_sortingOrder() ;

/// @brief Method set_sortingOrder addr 0x2a8aa60 size 0xb4 virtual false final false
 void set_sortingOrder(int32_t value) ;

/// @brief Method get_autoSizeTextContainer addr 0x2a8ac20 size 0x8 virtual true final false
 bool get_autoSizeTextContainer() ;

/// @brief Method set_autoSizeTextContainer addr 0x2a8ac28 size 0xa0 virtual true final false
 void set_autoSizeTextContainer(bool value) ;

/// @brief Method get_textContainer addr 0x2a8acc8 size 0x8 virtual false final false
 TMPro::TextContainer get_textContainer() ;

/// @brief Method get_transform addr 0x2a8acd0 size 0x94 virtual false final false
 UnityEngine::Transform get_transform() ;

/// @brief Method get_renderer addr 0x2a8a778 size 0x94 virtual false final false
 UnityEngine::Renderer get_renderer() ;

/// @brief Method get_mesh addr 0x2a8ad64 size 0xb0 virtual true final false
 UnityEngine::Mesh get_mesh() ;

/// @brief Method get_meshFilter addr 0x2a8ae14 size 0xfc virtual false final false
 UnityEngine::MeshFilter get_meshFilter() ;

/// @brief Method get_maskType addr 0x2a8af10 size 0x8 virtual false final false
 TMPro::MaskingTypes get_maskType() ;

/// @brief Method set_maskType addr 0x2a8af18 size 0x8 virtual false final false
 void set_maskType(TMPro::MaskingTypes value) ;

/// @brief Method SetMask addr 0x2a8b068 size 0x48 virtual false final false
 void SetMask(TMPro::MaskingTypes type, UnityEngine::Vector4 maskCoords) ;

/// @brief Method SetMask addr 0x2a8b150 size 0x60 virtual false final false
 void SetMask(TMPro::MaskingTypes type, UnityEngine::Vector4 maskCoords, float_t softnessX, float_t softnessY) ;

/// @brief Method SetVerticesDirty addr 0x2a8b2a0 size 0xb0 virtual true final false
 void SetVerticesDirty() ;

/// @brief Method SetLayoutDirty addr 0x2a8b350 size 0xd0 virtual true final false
 void SetLayoutDirty() ;

/// @brief Method SetMaterialDirty addr 0x2a8b420 size 0x10 virtual true final false
 void SetMaterialDirty() ;

/// @brief Method SetAllDirty addr 0x2a8b430 size 0x44 virtual true final false
 void SetAllDirty() ;

/// @brief Method Rebuild addr 0x2a8b474 size 0xe8 virtual true final false
 void Rebuild(UnityEngine::UI::CanvasUpdate update) ;

/// @brief Method UpdateMaterial addr 0x2a8b7b8 size 0x134 virtual true final false
 void UpdateMaterial() ;

/// @brief Method UpdateMeshPadding addr 0x2a8b8ec size 0x100 virtual true final false
 void UpdateMeshPadding() ;

/// @brief Method ForceMeshUpdate addr 0x2a8b9ec size 0x14 virtual true final false
 void ForceMeshUpdate(bool ignoreActiveState, bool forceTextReparsing) ;

/// @brief Method GetTextInfo addr 0x2a8ba00 size 0x6c virtual true final false
 TMPro::TMP_TextInfo GetTextInfo(::StringW text) ;

/// @brief Method ClearMesh addr 0x2a8ba6c size 0xc0 virtual true final false
 void ClearMesh(bool updateMesh) ;

/// @brief Method add_OnPreRenderText addr 0x2a8bb2c size 0xb4 virtual true final false
 void add_OnPreRenderText(System::Action_1<TMPro::TMP_TextInfo> value) ;

/// @brief Method remove_OnPreRenderText addr 0x2a8bbe0 size 0xb4 virtual true final false
 void remove_OnPreRenderText(System::Action_1<TMPro::TMP_TextInfo> value) ;

/// @brief Method UpdateGeometry addr 0x2a8bc94 size 0x18 virtual true final false
 void UpdateGeometry(UnityEngine::Mesh mesh, int32_t index) ;

/// @brief Method UpdateVertexData addr 0x2a8bcac size 0x198 virtual true final false
 void UpdateVertexData(TMPro::TMP_VertexDataUpdateFlags flags) ;

/// @brief Method UpdateVertexData addr 0x2a8be44 size 0x198 virtual true final false
 void UpdateVertexData() ;

/// @brief Method UpdateFontAsset addr 0x2a8bfdc size 0x10 virtual false final false
 void UpdateFontAsset() ;

/// @brief Method CalculateLayoutInputHorizontal addr 0x2a8bfec size 0x4 virtual true final true
 void CalculateLayoutInputHorizontal() ;

/// @brief Method CalculateLayoutInputVertical addr 0x2a8bff0 size 0x4 virtual true final true
 void CalculateLayoutInputVertical() ;

/// @brief Method Awake addr 0x2a8bff4 size 0x3a8 virtual true final false
 void Awake() ;

/// @brief Method OnEnable addr 0x2a8c39c size 0xfc virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2a8c498 size 0xac virtual true final false
 void OnDisable() ;

/// @brief Method OnDestroy addr 0x2a8c544 size 0xcc virtual true final false
 void OnDestroy() ;

/// @brief Method LoadFontAsset addr 0x2a8c610 size 0x670 virtual true final false
 void LoadFontAsset() ;

/// @brief Method UpdateEnvMapMatrix addr 0x2a8cc80 size 0x27c virtual false final false
 void UpdateEnvMapMatrix() ;

/// @brief Method SetMask addr 0x2a8af20 size 0x148 virtual false final false
 void SetMask(TMPro::MaskingTypes maskType) ;

/// @brief Method SetMaskCoordinates addr 0x2a8b0b0 size 0xa0 virtual false final false
 void SetMaskCoordinates(UnityEngine::Vector4 coords) ;

/// @brief Method SetMaskCoordinates addr 0x2a8b1b0 size 0xf0 virtual false final false
 void SetMaskCoordinates(UnityEngine::Vector4 coords, float_t softX, float_t softY) ;

/// @brief Method EnableMasking addr 0x2a8cefc size 0xf8 virtual false final false
 void EnableMasking() ;

/// @brief Method DisableMasking addr 0x2a8d074 size 0xf4 virtual false final false
 void DisableMasking() ;

/// @brief Method UpdateMask addr 0x2a8cff4 size 0x80 virtual false final false
 void UpdateMask() ;

/// @brief Method GetMaterial addr 0x2a8d22c size 0x110 virtual true final false
 UnityEngine::Material GetMaterial(UnityEngine::Material mat) ;

/// @brief Method GetMaterials addr 0x2a8d33c size 0x1a8 virtual true final false
 ::ArrayW<UnityEngine::Material> GetMaterials(::ArrayW<UnityEngine::Material> mats) ;

/// @brief Method SetSharedMaterial addr 0x2a8d4e4 size 0x38 virtual true final false
 void SetSharedMaterial(UnityEngine::Material mat) ;

/// @brief Method GetSharedMaterials addr 0x2a8d51c size 0x190 virtual true final false
 ::ArrayW<UnityEngine::Material> GetSharedMaterials() ;

/// @brief Method SetSharedMaterials addr 0x2a8d6ac size 0x368 virtual true final false
 void SetSharedMaterials(::ArrayW<UnityEngine::Material> materials) ;

/// @brief Method SetOutlineThickness addr 0x2a8da14 size 0x12c virtual true final false
 void SetOutlineThickness(float_t thickness) ;

/// @brief Method SetFaceColor addr 0x2a8db40 size 0x128 virtual true final false
 void SetFaceColor(UnityEngine::Color32 color) ;

/// @brief Method SetOutlineColor addr 0x2a8dc68 size 0x128 virtual true final false
 void SetOutlineColor(UnityEngine::Color32 color) ;

/// @brief Method CreateMaterialInstance addr 0x2a8d168 size 0xc4 virtual false final false
 void CreateMaterialInstance() ;

/// @brief Method SetShaderDepth addr 0x2a8dd90 size 0xe8 virtual true final false
 void SetShaderDepth() ;

/// @brief Method SetCulling addr 0x2a8de78 size 0x2a8 virtual true final false
 void SetCulling() ;

/// @brief Method SetPerspectiveCorrection addr 0x2a8e120 size 0x84 virtual false final false
 void SetPerspectiveCorrection() ;

/// @brief Method SetArraySizes addr 0x2a8e1a4 size 0x1ad0 virtual true final false
 int32_t SetArraySizes(::ArrayW<TMPro::TMPro__TMP_Text__UnicodeChar> unicodeChars) ;

/// @brief Method ComputeMarginSize addr 0x2a8fc74 size 0x124 virtual true final false
 void ComputeMarginSize() ;

/// @brief Method OnDidApplyAnimationProperties addr 0x2a8fd98 size 0x1c virtual true final false
 void OnDidApplyAnimationProperties() ;

/// @brief Method OnTransformParentChanged addr 0x2a8fdb4 size 0x30 virtual true final false
 void OnTransformParentChanged() ;

/// @brief Method OnRectTransformDimensionsChange addr 0x2a8fde4 size 0x17c virtual true final false
 void OnRectTransformDimensionsChange() ;

/// @brief Method InternalUpdate addr 0x2a8ff60 size 0x9c virtual true final false
 void InternalUpdate() ;

/// @brief Method OnPreRenderObject addr 0x2a8b55c size 0x25c virtual false final false
 void OnPreRenderObject() ;

/// @brief Method GenerateTextMesh addr 0x2a795b8 size 0x7878 virtual true final false
 void GenerateTextMesh() ;

/// @brief Method GetTextContainerLocalCorners addr 0x2a902ac size 0x9c virtual true final false
 ::ArrayW<UnityEngine::Vector3> GetTextContainerLocalCorners() ;

/// @brief Method SetMeshFilters addr 0x2a90348 size 0x1c0 virtual false final false
 void SetMeshFilters(bool state) ;

/// @brief Method SetActiveSubMeshes addr 0x2a90508 size 0x108 virtual true final false
 void SetActiveSubMeshes(bool state) ;

/// @brief Method SetActiveSubTextObjectRenderers addr 0x2a90180 size 0x12c virtual false final false
 void SetActiveSubTextObjectRenderers(bool state) ;

/// @brief Method DestroySubMeshObjects addr 0x2a90610 size 0xdc virtual true final false
 void DestroySubMeshObjects() ;

/// @brief Method UpdateSubMeshSortingLayerID addr 0x2a8a8c0 size 0x10c virtual false final false
 void UpdateSubMeshSortingLayerID(int32_t id) ;

/// @brief Method UpdateSubMeshSortingOrder addr 0x2a8ab14 size 0x10c virtual false final false
 void UpdateSubMeshSortingOrder(int32_t order) ;

/// @brief Method GetCompoundBounds addr 0x2a906ec size 0x248 virtual true final false
 UnityEngine::Bounds GetCompoundBounds() ;

/// @brief Method UpdateSDFScale addr 0x2a8fffc size 0x184 virtual false final false
 void UpdateSDFScale(float_t scaleDelta) ;

// Ctor Parameters []
explicit TextMeshPro() ;

/// @brief Method .ctor addr 0x2a90934 size 0xc0 virtual false final false
 void _ctor() ;
