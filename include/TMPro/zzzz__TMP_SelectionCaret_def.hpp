...
/// @brief Method Cull addr 0x2ada314 size 0xd0 virtual true final false
 void Cull(UnityEngine::Rect clipRect, bool validRect) ;

/// @brief Method UpdateGeometry addr 0x2ada3e4 size 0x4 virtual true final false
 void UpdateGeometry() ;

// Ctor Parameters []
explicit TMP_SelectionCaret() ;

/// @brief Method .ctor addr 0x2ada3e8 size 0x8 virtual false final false
 void _ctor() ;
