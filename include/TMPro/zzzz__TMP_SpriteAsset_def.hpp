...
/// @brief Method .ctor addr 0x2adf020 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SortGlyphTable>b__40_0 addr 0x2adf028 size 0x18 virtual false final false
 uint32_t _SortGlyphTable_b__40_0(TMPro::TMP_SpriteGlyph item) ;

/// @brief Method <SortCharacterTable>b__41_0 addr 0x2adf040 size 0x18 virtual false final false
...
/// @brief Method get_version addr 0x2add3a0 size 0x8 virtual false final false
 ::StringW get_version() ;

/// @brief Method set_version addr 0x2add3a8 size 0x8 virtual false final false
 void set_version(::StringW value) ;

/// @brief Method get_faceInfo addr 0x2add3b0 size 0x10 virtual false final false
 UnityEngine::TextCore::FaceInfo get_faceInfo() ;

/// @brief Method set_faceInfo addr 0x2add3c0 size 0x18 virtual false final false
 void set_faceInfo(UnityEngine::TextCore::FaceInfo value) ;

/// @brief Method get_spriteCharacterTable addr 0x2add32c size 0x24 virtual false final false
 System::Collections::Generic::List_1<TMPro::TMP_SpriteCharacter> get_spriteCharacterTable() ;

/// @brief Method set_spriteCharacterTable addr 0x2add8fc size 0x8 virtual false final false
 void set_spriteCharacterTable(System::Collections::Generic::List_1<TMPro::TMP_SpriteCharacter> value) ;

/// @brief Method get_spriteCharacterLookupTable addr 0x2add904 size 0x24 virtual false final false
 System::Collections::Generic::Dictionary_2<uint32_t,TMPro::TMP_SpriteCharacter> get_spriteCharacterLookupTable() ;

/// @brief Method set_spriteCharacterLookupTable addr 0x2add928 size 0x8 virtual false final false
 void set_spriteCharacterLookupTable(System::Collections::Generic::Dictionary_2<uint32_t,TMPro::TMP_SpriteCharacter> value) ;

/// @brief Method get_spriteGlyphTable addr 0x2add930 size 0x8 virtual false final false
 System::Collections::Generic::List_1<TMPro::TMP_SpriteGlyph> get_spriteGlyphTable() ;

/// @brief Method set_spriteGlyphTable addr 0x2add938 size 0x8 virtual false final false
 void set_spriteGlyphTable(System::Collections::Generic::List_1<TMPro::TMP_SpriteGlyph> value) ;

/// @brief Method Awake addr 0x2add940 size 0x88 virtual false final false
 void Awake() ;

/// @brief Method GetDefaultSpriteMaterial addr 0x2addf04 size 0xe8 virtual false final false
 UnityEngine::Material GetDefaultSpriteMaterial() ;

/// @brief Method UpdateLookupTables addr 0x2add3d8 size 0x524 virtual false final false
 void UpdateLookupTables() ;

/// @brief Method GetSpriteIndexFromHashcode addr 0x2addfec size 0x88 virtual false final false
 int32_t GetSpriteIndexFromHashcode(int32_t hashCode) ;

/// @brief Method GetSpriteIndexFromUnicode addr 0x2ade074 size 0x94 virtual false final false
 int32_t GetSpriteIndexFromUnicode(uint32_t unicode) ;

/// @brief Method GetSpriteIndexFromName addr 0x2ade108 size 0x74 virtual false final false
 int32_t GetSpriteIndexFromName(::StringW name) ;

/// @brief Method SearchForSpriteByUnicode addr 0x2ade1e8 size 0x228 virtual false final false
...
/// @brief Method SearchForSpriteByUnicodeInternal addr 0x2ade410 size 0x1a0 virtual false final false
...
/// @brief Method SearchForSpriteByUnicodeInternal addr 0x2ade5b0 size 0xb0 virtual false final false
...
/// @brief Method SearchForSpriteByHashCode addr 0x2ade660 size 0x320 virtual false final false
...
/// @brief Method SearchForSpriteByHashCodeInternal addr 0x2ade980 size 0x1a0 virtual false final false
...
/// @brief Method SearchForSpriteByHashCodeInternal addr 0x2adeb20 size 0xb0 virtual false final false
...
/// @brief Method SortGlyphTable addr 0x2adebd0 size 0x138 virtual false final false
 void SortGlyphTable() ;

/// @brief Method SortCharacterTable addr 0x2aded08 size 0x13c virtual false final false
 void SortCharacterTable() ;

/// @brief Method SortGlyphAndCharacterTables addr 0x2adee44 size 0x18 virtual false final false
 void SortGlyphAndCharacterTables() ;

/// @brief Method UpgradeSpriteAsset addr 0x2add9c8 size 0x53c virtual false final false
 void UpgradeSpriteAsset() ;

// Ctor Parameters []
explicit TMP_SpriteAsset() ;

/// @brief Method .ctor addr 0x2adeefc size 0xc0 virtual false final false
 void _ctor() ;
