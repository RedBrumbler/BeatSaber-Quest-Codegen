...
/// @brief Method get_NormalStyle addr 0x2adf350 size 0xbc virtual false final false
static TMPro::TMP_Style get_NormalStyle() ;

/// @brief Method get_name addr 0x2adf49c size 0x8 virtual false final false
 ::StringW get_name() ;

/// @brief Method set_name addr 0x2adf4a4 size 0x38 virtual false final false
 void set_name(::StringW value) ;

/// @brief Method get_hashCode addr 0x2adf4dc size 0x8 virtual false final false
 int32_t get_hashCode() ;

/// @brief Method set_hashCode addr 0x2adf4e4 size 0x14 virtual false final false
 void set_hashCode(int32_t value) ;

/// @brief Method get_styleOpeningDefinition addr 0x2adf4f8 size 0x8 virtual false final false
 ::StringW get_styleOpeningDefinition() ;

/// @brief Method get_styleClosingDefinition addr 0x2adf500 size 0x8 virtual false final false
 ::StringW get_styleClosingDefinition() ;

/// @brief Method get_styleOpeningTagArray addr 0x2adf508 size 0x8 virtual false final false
 ::ArrayW<int32_t> get_styleOpeningTagArray() ;

/// @brief Method get_styleClosingTagArray addr 0x2adf510 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2adf40c size 0x90 virtual false final false
 void _ctor(::StringW styleName, ::StringW styleOpeningDefinition, ::StringW styleClosingDefinition) ;

/// @brief Method RefreshStyle addr 0x2adf5d4 size 0x1f8 virtual false final false
 void RefreshStyle() ;
