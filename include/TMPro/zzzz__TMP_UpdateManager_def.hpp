...
/// @brief Method get_instance addr 0x2ae7640 size 0xa8 virtual false final false
static TMPro::TMP_UpdateManager get_instance() ;

// Ctor Parameters []
explicit TMP_UpdateManager() ;

/// @brief Method .ctor addr 0x2ae76e8 size 0x1cc virtual false final false
 void _ctor() ;

/// @brief Method RegisterTextObjectForUpdate addr 0x2ae78b4 size 0x60 virtual false final false
static void RegisterTextObjectForUpdate(TMPro::TMP_Text textObject) ;

/// @brief Method InternalRegisterTextObjectForUpdate addr 0x2ae7914 size 0x114 virtual false final false
 void InternalRegisterTextObjectForUpdate(TMPro::TMP_Text textObject) ;

/// @brief Method RegisterTextElementForLayoutRebuild addr 0x2ae7a28 size 0x60 virtual false final false
static void RegisterTextElementForLayoutRebuild(TMPro::TMP_Text element) ;

/// @brief Method InternalRegisterTextElementForLayoutRebuild addr 0x2ae7a88 size 0x114 virtual false final false
 void InternalRegisterTextElementForLayoutRebuild(TMPro::TMP_Text element) ;

/// @brief Method RegisterTextElementForGraphicRebuild addr 0x2ae7b9c size 0x60 virtual false final false
static void RegisterTextElementForGraphicRebuild(TMPro::TMP_Text element) ;

/// @brief Method InternalRegisterTextElementForGraphicRebuild addr 0x2ae7bfc size 0x114 virtual false final false
 void InternalRegisterTextElementForGraphicRebuild(TMPro::TMP_Text element) ;

/// @brief Method RegisterTextElementForCullingUpdate addr 0x2ae7d10 size 0x60 virtual false final false
static void RegisterTextElementForCullingUpdate(TMPro::TMP_Text element) ;

/// @brief Method InternalRegisterTextElementForCullingUpdate addr 0x2ae7d70 size 0x114 virtual false final false
 void InternalRegisterTextElementForCullingUpdate(TMPro::TMP_Text element) ;

/// @brief Method OnCameraPreCull addr 0x2ae7e84 size 0x4 virtual false final false
 void OnCameraPreCull() ;

/// @brief Method DoRebuilds addr 0x2ae7e88 size 0x254 virtual false final false
 void DoRebuilds() ;

/// @brief Method UnRegisterTextObjectForUpdate addr 0x2ae80dc size 0x60 virtual false final false
static void UnRegisterTextObjectForUpdate(TMPro::TMP_Text textObject) ;

/// @brief Method UnRegisterTextElementForRebuild addr 0x2ae81d4 size 0x80 virtual false final false
static void UnRegisterTextElementForRebuild(TMPro::TMP_Text element) ;

/// @brief Method InternalUnRegisterTextElementForGraphicRebuild addr 0x2ae8254 size 0x98 virtual false final false
 void InternalUnRegisterTextElementForGraphicRebuild(TMPro::TMP_Text element) ;

/// @brief Method InternalUnRegisterTextElementForLayoutRebuild addr 0x2ae82ec size 0x98 virtual false final false
 void InternalUnRegisterTextElementForLayoutRebuild(TMPro::TMP_Text element) ;

/// @brief Method InternalUnRegisterTextObjectForUpdate addr 0x2ae813c size 0x98 virtual false final false
