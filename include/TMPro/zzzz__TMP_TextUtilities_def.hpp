...
/// @brief Method .ctor addr 0x2ae7630 size 0x10 virtual false final false
...
/// @brief Method GetCursorIndexFromPosition addr 0x2ae38a8 size 0x164 virtual false final false
...
/// @brief Method GetCursorIndexFromPosition addr 0x2ae3f44 size 0x1e0 virtual false final false
...
/// @brief Method FindNearestLine addr 0x2ae4124 size 0x180 virtual false final false
static int32_t FindNearestLine(TMPro::TMP_Text text, UnityEngine::Vector3 position, UnityEngine::Camera camera) ;

/// @brief Method FindNearestCharacterOnLine addr 0x2ae42a4 size 0x378 virtual false final false
...
/// @brief Method IsIntersectingRectTransform addr 0x2ae47a4 size 0x11c virtual false final false
...
/// @brief Method FindIntersectingCharacter addr 0x2ae48c0 size 0x20c virtual false final false
...
/// @brief Method FindNearestCharacter addr 0x2ae3a0c size 0x33c virtual false final false
...
/// @brief Method ScreenPointToWorldPointInRectangle addr 0x2ae3d48 size 0x1fc virtual false final false
...
/// @brief Method IntersectLinePlane addr 0x2ae6058 size 0x16c virtual false final false
...
/// @brief Method DistanceToLine addr 0x2ae46dc size 0xc8 virtual false final false
static float_t DistanceToLine(UnityEngine::Vector3 a, UnityEngine::Vector3 b, UnityEngine::Vector3 point) ;

/// @brief Method ToLowerFast addr 0x2ae61c4 size 0x74 virtual false final false
static char16_t ToLowerFast(char16_t c) ;

/// @brief Method ToUpperFast addr 0x2ae6238 size 0x74 virtual false final false
static char16_t ToUpperFast(char16_t c) ;

/// @brief Method ToUpperASCIIFast addr 0x2ae62ac size 0x74 virtual false final false
static uint32_t ToUpperASCIIFast(uint32_t c) ;

/// @brief Method GetHashCode addr 0x2ae6320 size 0xbc virtual false final false
static int32_t GetHashCode(::StringW s) ;

/// @brief Method GetSimpleHashCode addr 0x2ade17c size 0x6c virtual false final false
static int32_t GetSimpleHashCode(::StringW s) ;

/// @brief Method GetSimpleHashCodeLowercase addr 0x2ae63dc size 0xbc virtual false final false
static uint32_t GetSimpleHashCodeLowercase(::StringW s) ;

/// @brief Method HexToInt addr 0x2ae6498 size 0x2c virtual false final false
static int32_t HexToInt(char16_t hex) ;

/// @brief Method StringHexToInt addr 0x2ae64c4 size 0x104 virtual false final false
