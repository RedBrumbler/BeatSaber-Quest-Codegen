...
/// @brief Method .ctor addr 0x2a9a428 size 0x10 virtual false final false
 void _ctor(UnityEngine::Color32 color, TMPro::TMP_Offset padding) ;

/// @brief Method op_Equality addr 0x2a9a438 size 0xc8 virtual false final false
static bool op_Equality(TMPro::HighlightState lhs, TMPro::HighlightState rhs) ;

/// @brief Method op_Inequality addr 0x2a9a500 size 0x48 virtual false final false
static bool op_Inequality(TMPro::HighlightState lhs, TMPro::HighlightState rhs) ;

/// @brief Method GetHashCode addr 0x2a9a548 size 0x6c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2a9a5b4 size 0x80 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2a9a634 size 0xa4 virtual false final false
