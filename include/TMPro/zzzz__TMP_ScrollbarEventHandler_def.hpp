...
/// @brief Method OnPointerClick addr 0x2ada1b8 size 0x68 virtual true final true
 void OnPointerClick(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnSelect addr 0x2ada220 size 0x78 virtual true final true
 void OnSelect(UnityEngine::EventSystems::BaseEventData eventData) ;

/// @brief Method OnDeselect addr 0x2ada298 size 0x74 virtual true final true
 void OnDeselect(UnityEngine::EventSystems::BaseEventData eventData) ;

// Ctor Parameters []
explicit TMP_ScrollbarEventHandler() ;

/// @brief Method .ctor addr 0x2ada30c size 0x8 virtual false final false
 void _ctor() ;
