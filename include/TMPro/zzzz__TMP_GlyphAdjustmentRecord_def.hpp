...
/// @brief Method get_glyphIndex addr 0x2aaa9e4 size 0x8 virtual false final false
 uint32_t get_glyphIndex() ;

/// @brief Method set_glyphIndex addr 0x2aaa9ec size 0x8 virtual false final false
 void set_glyphIndex(uint32_t value) ;

/// @brief Method get_glyphValueRecord addr 0x2aaa9f4 size 0xc virtual false final false
 TMPro::TMP_GlyphValueRecord get_glyphValueRecord() ;

/// @brief Method set_glyphValueRecord addr 0x2aaaa00 size 0xc virtual false final false
 void set_glyphValueRecord(TMPro::TMP_GlyphValueRecord value) ;

/// @brief Method .ctor addr 0x2aa8240 size 0x10 virtual false final false
 void _ctor(uint32_t glyphIndex, TMPro::TMP_GlyphValueRecord glyphValueRecord) ;

/// @brief Method .ctor addr 0x2aaaa0c size 0x54 virtual false final false
