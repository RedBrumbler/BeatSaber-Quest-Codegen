...
/// @brief Method get_firstGlyph addr 0x2aa8b8c size 0x8 virtual false final false
 uint32_t get_firstGlyph() ;

/// @brief Method set_firstGlyph addr 0x2aa8b94 size 0x8 virtual false final false
 void set_firstGlyph(uint32_t value) ;

/// @brief Method get_firstGlyphAdjustments addr 0x2aa8b9c size 0xc virtual false final false
 TMPro::GlyphValueRecord_Legacy get_firstGlyphAdjustments() ;

/// @brief Method get_secondGlyph addr 0x2aa8ba8 size 0x8 virtual false final false
 uint32_t get_secondGlyph() ;

/// @brief Method set_secondGlyph addr 0x2aa8bb0 size 0x8 virtual false final false
 void set_secondGlyph(uint32_t value) ;

/// @brief Method get_secondGlyphAdjustments addr 0x2aa8bb8 size 0xc virtual false final false
 TMPro::GlyphValueRecord_Legacy get_secondGlyphAdjustments() ;

/// @brief Method get_ignoreSpacingAdjustments addr 0x2aa8bc4 size 0x8 virtual false final false
 bool get_ignoreSpacingAdjustments() ;

// Ctor Parameters []
explicit KerningPair() ;

/// @brief Method .ctor addr 0x2aa8bcc size 0x24 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2aa8bf0 size 0x40 virtual false final false
...
/// @brief Method .ctor addr 0x2aa8c30 size 0x80 virtual false final false
...
/// @brief Method ConvertLegacyKerningData addr 0x2aa8cb0 size 0xc virtual false final false
