...
/// @brief Method get_left addr 0x2a9a08c size 0x8 virtual false final false
 float_t get_left() ;

/// @brief Method set_left addr 0x2a9a094 size 0x8 virtual false final false
 void set_left(float_t value) ;

/// @brief Method get_right addr 0x2a9a09c size 0x8 virtual false final false
 float_t get_right() ;

/// @brief Method set_right addr 0x2a9a0a4 size 0x8 virtual false final false
 void set_right(float_t value) ;

/// @brief Method get_top addr 0x2a9a0ac size 0x8 virtual false final false
 float_t get_top() ;

/// @brief Method set_top addr 0x2a9a0b4 size 0x8 virtual false final false
 void set_top(float_t value) ;

/// @brief Method get_bottom addr 0x2a9a0bc size 0x8 virtual false final false
 float_t get_bottom() ;

/// @brief Method set_bottom addr 0x2a9a0c4 size 0x8 virtual false final false
 void set_bottom(float_t value) ;

/// @brief Method get_horizontal addr 0x2a9a0cc size 0x8 virtual false final false
 float_t get_horizontal() ;

/// @brief Method set_horizontal addr 0x2a9a0d4 size 0x8 virtual false final false
 void set_horizontal(float_t value) ;

/// @brief Method get_vertical addr 0x2a9a0dc size 0x8 virtual false final false
 float_t get_vertical() ;

/// @brief Method set_vertical addr 0x2a9a0e4 size 0x8 virtual false final false
 void set_vertical(float_t value) ;

/// @brief Method get_zero addr 0x2a9a0ec size 0x5c virtual false final false
static TMPro::TMP_Offset get_zero() ;

/// @brief Method .ctor addr 0x2a9a148 size 0xc virtual false final false
 void _ctor(float_t left, float_t right, float_t top, float_t bottom) ;

/// @brief Method .ctor addr 0x2a9a154 size 0xc virtual false final false
 void _ctor(float_t horizontal, float_t vertical) ;

/// @brief Method op_Equality addr 0x2a9a160 size 0x30 virtual false final false
static bool op_Equality(TMPro::TMP_Offset lhs, TMPro::TMP_Offset rhs) ;

/// @brief Method op_Inequality addr 0x2a9a190 size 0xb8 virtual false final false
static bool op_Inequality(TMPro::TMP_Offset lhs, TMPro::TMP_Offset rhs) ;

/// @brief Method op_Multiply addr 0x2a9a248 size 0x14 virtual false final false
static TMPro::TMP_Offset op_Multiply(TMPro::TMP_Offset a, float_t b) ;

/// @brief Method GetHashCode addr 0x2a9a25c size 0x64 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2a9a2c0 size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2a9a338 size 0xa8 virtual false final false
