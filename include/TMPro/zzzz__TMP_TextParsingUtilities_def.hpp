...
/// @brief Method get_instance addr 0x2ae3414 size 0x58 virtual false final false
static TMPro::TMP_TextParsingUtilities get_instance() ;

/// @brief Method GetHashCode addr 0x2adf518 size 0xbc virtual false final false
static int32_t GetHashCode(::StringW s) ;

/// @brief Method GetHashCodeCaseSensitive addr 0x2adf060 size 0x6c virtual false final false
static int32_t GetHashCodeCaseSensitive(::StringW s) ;

/// @brief Method ToLowerASCIIFast addr 0x2ae34e0 size 0x74 virtual false final false
static char16_t ToLowerASCIIFast(char16_t c) ;

/// @brief Method ToUpperASCIIFast addr 0x2ae346c size 0x74 virtual false final false
static char16_t ToUpperASCIIFast(char16_t c) ;

/// @brief Method ToUpperASCIIFast addr 0x2ae3554 size 0x74 virtual false final false
static uint32_t ToUpperASCIIFast(uint32_t c) ;

/// @brief Method ToLowerASCIIFast addr 0x2ae35c8 size 0x74 virtual false final false
static uint32_t ToLowerASCIIFast(uint32_t c) ;

/// @brief Method IsHighSurrogate addr 0x2ae363c size 0x14 virtual false final false
static bool IsHighSurrogate(uint32_t c) ;

/// @brief Method IsLowSurrogate addr 0x2ae3650 size 0x14 virtual false final false
static bool IsLowSurrogate(uint32_t c) ;

/// @brief Method ConvertToUTF32 addr 0x2ae3664 size 0x14 virtual false final false
static uint32_t ConvertToUTF32(uint32_t highSurrogate, uint32_t lowSurrogate) ;

// Ctor Parameters []
explicit TMP_TextParsingUtilities() ;

/// @brief Method .ctor addr 0x2ae340c size 0x8 virtual false final false
 void _ctor() ;
