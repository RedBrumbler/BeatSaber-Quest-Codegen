...
namespace TMPro {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12410))}
...
/// @brief Method Clone addr 0x2aa89b0 size 0x7c virtual false final false
static TMPro::TMP_Glyph Clone(TMPro::TMP_Glyph source) ;

// Ctor Parameters []
explicit TMP_Glyph() ;

/// @brief Method .ctor addr 0x2aa8a2c size 0x8 virtual false final false
 void _ctor() ;
