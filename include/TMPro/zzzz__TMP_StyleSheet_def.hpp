...
/// @brief Method get_styles addr 0x2adf7cc size 0x8 virtual false final false
 System::Collections::Generic::List_1<TMPro::TMP_Style> get_styles() ;

/// @brief Method Reset addr 0x2adf7d4 size 0x4 virtual false final false
 void Reset() ;

/// @brief Method GetStyle addr 0x2adfaf0 size 0x88 virtual false final false
 TMPro::TMP_Style GetStyle(int32_t hashCode) ;

/// @brief Method GetStyle addr 0x2adfb78 size 0xb8 virtual false final false
 TMPro::TMP_Style GetStyle(::StringW name) ;

/// @brief Method RefreshStyles addr 0x2adfc30 size 0x4 virtual false final false
 void RefreshStyles() ;

/// @brief Method LoadStyleDictionaryInternal addr 0x2adf7d8 size 0x318 virtual false final false
 void LoadStyleDictionaryInternal() ;

// Ctor Parameters []
explicit TMP_StyleSheet() ;

/// @brief Method .ctor addr 0x2adfc34 size 0x80 virtual false final false
 void _ctor() ;
