...
/// @brief Method get_xPlacement addr 0x2aaa924 size 0x8 virtual false final false
 float_t get_xPlacement() ;

/// @brief Method set_xPlacement addr 0x2aaa92c size 0x8 virtual false final false
 void set_xPlacement(float_t value) ;

/// @brief Method get_yPlacement addr 0x2aaa934 size 0x8 virtual false final false
 float_t get_yPlacement() ;

/// @brief Method set_yPlacement addr 0x2aaa93c size 0x8 virtual false final false
 void set_yPlacement(float_t value) ;

/// @brief Method get_xAdvance addr 0x2aaa944 size 0x8 virtual false final false
 float_t get_xAdvance() ;

/// @brief Method set_xAdvance addr 0x2aaa94c size 0x8 virtual false final false
 void set_xAdvance(float_t value) ;

/// @brief Method get_yAdvance addr 0x2aaa954 size 0x8 virtual false final false
 float_t get_yAdvance() ;

/// @brief Method set_yAdvance addr 0x2aaa95c size 0x8 virtual false final false
 void set_yAdvance(float_t value) ;

/// @brief Method .ctor addr 0x2aa8234 size 0xc virtual false final false
 void _ctor(float_t xPlacement, float_t yPlacement, float_t xAdvance, float_t yAdvance) ;

/// @brief Method .ctor addr 0x2aaa964 size 0xc virtual false final false
 void _ctor(TMPro::GlyphValueRecord_Legacy valueRecord) ;

/// @brief Method .ctor addr 0x2aaa970 size 0x60 virtual false final false
 void _ctor(UnityEngine::TextCore::LowLevel::GlyphValueRecord valueRecord) ;

/// @brief Method op_Addition addr 0x2aaa9d0 size 0x14 virtual false final false
