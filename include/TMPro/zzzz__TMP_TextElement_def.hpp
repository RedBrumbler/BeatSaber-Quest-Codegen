...
/// @brief Method get_elementType addr 0x2ae2610 size 0x8 virtual false final false
 TMPro::TextElementType get_elementType() ;

/// @brief Method get_unicode addr 0x2ae2618 size 0x8 virtual false final false
 uint32_t get_unicode() ;

/// @brief Method set_unicode addr 0x2ae2620 size 0x8 virtual false final false
 void set_unicode(uint32_t value) ;

/// @brief Method get_textAsset addr 0x2ae2628 size 0x8 virtual false final false
 TMPro::TMP_Asset get_textAsset() ;

/// @brief Method set_textAsset addr 0x2ae2630 size 0x8 virtual false final false
 void set_textAsset(TMPro::TMP_Asset value) ;

/// @brief Method get_glyph addr 0x2ae2638 size 0x8 virtual false final false
 UnityEngine::TextCore::Glyph get_glyph() ;

/// @brief Method set_glyph addr 0x2ae2640 size 0x8 virtual false final false
 void set_glyph(UnityEngine::TextCore::Glyph value) ;

/// @brief Method get_glyphIndex addr 0x2ae2648 size 0x8 virtual false final false
 uint32_t get_glyphIndex() ;

/// @brief Method set_glyphIndex addr 0x2ae2650 size 0x8 virtual false final false
 void set_glyphIndex(uint32_t value) ;

/// @brief Method get_scale addr 0x2ae2658 size 0x8 virtual false final false
 float_t get_scale() ;

/// @brief Method set_scale addr 0x2ae2660 size 0x8 virtual false final false
 void set_scale(float_t value) ;

// Ctor Parameters []
explicit TMP_TextElement() ;

/// @brief Method .ctor addr 0x2adf0d4 size 0x8 virtual false final false
 void _ctor() ;
