...
/// @brief Method ToIntArray addr 0x2a98c78 size 0xb4 virtual false final false
static ::ArrayW<int32_t> ToIntArray(::StringW text) ;

/// @brief Method ArrayToString addr 0x2a98d2c size 0xac virtual false final false
static ::StringW ArrayToString(::ArrayW<char16_t> chars) ;

/// @brief Method IntToString addr 0x2a98dd8 size 0xb0 virtual false final false
static ::StringW IntToString(::ArrayW<int32_t> unicodes) ;

/// @brief Method UintToString addr 0x2a98e88 size 0xd8 virtual false final false
static ::StringW UintToString(System::Collections::Generic::List_1<uint32_t> unicodes) ;

/// @brief Method IntToString addr 0x2a98f60 size 0x118 virtual false final false
...
/// @brief Method Compare addr 0x2a99078 size 0x10 virtual false final false
static bool Compare(UnityEngine::Color32 a, UnityEngine::Color32 b) ;

/// @brief Method CompareRGB addr 0x2a99088 size 0x10 virtual false final false
static bool CompareRGB(UnityEngine::Color32 a, UnityEngine::Color32 b) ;

/// @brief Method Compare addr 0x2a99098 size 0x30 virtual false final false
static bool Compare(UnityEngine::Color a, UnityEngine::Color b) ;

/// @brief Method CompareRGB addr 0x2a990c8 size 0x28 virtual false final false
static bool CompareRGB(UnityEngine::Color a, UnityEngine::Color b) ;

/// @brief Method Multiply addr 0x2a990f0 size 0xc0 virtual false final false
static UnityEngine::Color32 Multiply(UnityEngine::Color32 c1, UnityEngine::Color32 c2) ;

/// @brief Method Tint addr 0x2a991b0 size 0xc0 virtual false final false
static UnityEngine::Color32 Tint(UnityEngine::Color32 c1, UnityEngine::Color32 c2) ;

/// @brief Method Tint addr 0x2a99270 size 0xdc virtual false final false
static UnityEngine::Color32 Tint(UnityEngine::Color32 c1, float_t tint) ;

/// @brief Method MinAlpha addr 0x2a9934c size 0xc virtual false final false
static UnityEngine::Color MinAlpha(UnityEngine::Color c1, UnityEngine::Color c2) ;

/// @brief Method Compare addr 0x2a99358 size 0x94 virtual false final false
static bool Compare(UnityEngine::Vector3 v1, UnityEngine::Vector3 v2, int32_t accuracy) ;

/// @brief Method Compare addr 0x2a993ec size 0xc0 virtual false final false
