...
namespace TMPro {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12409))}
...
/// @brief Method get_name addr 0x2adf058 size 0x8 virtual false final false
 ::StringW get_name() ;

/// @brief Method set_name addr 0x2adee84 size 0x78 virtual false final false
 void set_name(::StringW value) ;

/// @brief Method get_hashCode addr 0x2adf0cc size 0x8 virtual false final false
 int32_t get_hashCode() ;

// Ctor Parameters []
explicit TMP_SpriteCharacter() ;

/// @brief Method .ctor addr 0x2adee64 size 0x20 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2adf0dc size 0x54 virtual false final false
...
/// @brief Method .ctor addr 0x2adf130 size 0x60 virtual false final false
...
/// @brief Method .ctor addr 0x2adf190 size 0x40 virtual false final false
