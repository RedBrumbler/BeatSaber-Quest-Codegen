...
/// @brief Method SetLinkID addr 0x2a9959c size 0xd4 virtual false final false
 void SetLinkID(::ArrayW<char16_t> text, int32_t startIndex, int32_t length) ;

/// @brief Method GetLinkText addr 0x2a99670 size 0xdc virtual false final false
 ::StringW GetLinkText() ;

/// @brief Method GetLinkID addr 0x2a9974c size 0xa8 virtual false final false
 ::StringW GetLinkID() ;
