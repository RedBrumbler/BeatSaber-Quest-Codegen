...
/// @brief Method get_instance addr 0x2ae84e8 size 0x7c virtual false final false
static TMPro::TMP_UpdateRegistry get_instance() ;

// Ctor Parameters []
explicit TMP_UpdateRegistry() ;

/// @brief Method .ctor addr 0x2ae8564 size 0x15c virtual false final false
 void _ctor() ;

/// @brief Method RegisterCanvasElementForLayoutRebuild addr 0x2ae86c0 size 0x20 virtual false final false
static void RegisterCanvasElementForLayoutRebuild(UnityEngine::UI::ICanvasElement element) ;

/// @brief Method InternalRegisterCanvasElementForLayoutRebuild addr 0x2ae86e0 size 0x15c virtual false final false
 bool InternalRegisterCanvasElementForLayoutRebuild(UnityEngine::UI::ICanvasElement element) ;

/// @brief Method RegisterCanvasElementForGraphicRebuild addr 0x2ae883c size 0x20 virtual false final false
static void RegisterCanvasElementForGraphicRebuild(UnityEngine::UI::ICanvasElement element) ;

/// @brief Method InternalRegisterCanvasElementForGraphicRebuild addr 0x2ae885c size 0x15c virtual false final false
 bool InternalRegisterCanvasElementForGraphicRebuild(UnityEngine::UI::ICanvasElement element) ;

/// @brief Method PerformUpdateForCanvasRendererObjects addr 0x2ae89b8 size 0x25c virtual false final false
 void PerformUpdateForCanvasRendererObjects() ;

/// @brief Method PerformUpdateForMeshRendererObjects addr 0x2ae8c14 size 0x68 virtual false final false
 void PerformUpdateForMeshRendererObjects() ;

/// @brief Method UnRegisterCanvasElementForRebuild addr 0x2ae8c7c size 0x30 virtual false final false
static void UnRegisterCanvasElementForRebuild(UnityEngine::UI::ICanvasElement element) ;

/// @brief Method InternalUnRegisterCanvasElementForLayoutRebuild addr 0x2ae8cac size 0xdc virtual false final false
 void InternalUnRegisterCanvasElementForLayoutRebuild(UnityEngine::UI::ICanvasElement element) ;

/// @brief Method InternalUnRegisterCanvasElementForGraphicRebuild addr 0x2ae8d88 size 0xdc virtual false final false
