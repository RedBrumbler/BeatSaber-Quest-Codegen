...
template<::cordl_internals::il2cpp_reference_type A>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12259))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12259), inst: 2 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12259))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12259), inst: 99 })
// CS Name: TMPro.FastAction`1
