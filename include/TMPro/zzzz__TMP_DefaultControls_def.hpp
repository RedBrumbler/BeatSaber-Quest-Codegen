...
/// @brief Method CreateUIElementRoot addr 0x2a9ace4 size 0xa8 virtual false final false
static UnityEngine::GameObject CreateUIElementRoot(::StringW name, UnityEngine::Vector2 size) ;

/// @brief Method CreateUIObject addr 0x2a9ad8c size 0xc0 virtual false final false
static UnityEngine::GameObject CreateUIObject(::StringW name, UnityEngine::GameObject parent) ;

/// @brief Method SetDefaultTextValues addr 0x2a9af4c size 0x88 virtual false final false
static void SetDefaultTextValues(TMPro::TMP_Text lbl) ;

/// @brief Method SetDefaultColorTransitionValues addr 0x2a9afd4 size 0x10 virtual false final false
static void SetDefaultColorTransitionValues(UnityEngine::UI::Selectable slider) ;

/// @brief Method SetParentAndAlign addr 0x2a9ae4c size 0x100 virtual false final false
static void SetParentAndAlign(UnityEngine::GameObject child, UnityEngine::GameObject parent) ;

/// @brief Method SetLayerRecursively addr 0x2a9afe4 size 0xe4 virtual false final false
static void SetLayerRecursively(UnityEngine::GameObject go, int32_t layer) ;

/// @brief Method CreateScrollbar addr 0x2a9b0c8 size 0x2c4 virtual false final false
static UnityEngine::GameObject CreateScrollbar(TMPro::TMPro__TMP_DefaultControls__Resources resources) ;

/// @brief Method CreateButton addr 0x2a9b38c size 0x2c0 virtual false final false
static UnityEngine::GameObject CreateButton(TMPro::TMPro__TMP_DefaultControls__Resources resources) ;

/// @brief Method CreateText addr 0x2a9b64c size 0xa0 virtual false final false
static UnityEngine::GameObject CreateText(TMPro::TMPro__TMP_DefaultControls__Resources resources) ;

/// @brief Method CreateInputField addr 0x2a9b6ec size 0x65c virtual false final false
static UnityEngine::GameObject CreateInputField(TMPro::TMPro__TMP_DefaultControls__Resources resources) ;

/// @brief Method CreateDropdown addr 0x2a9beec size 0xdf4 virtual false final false
