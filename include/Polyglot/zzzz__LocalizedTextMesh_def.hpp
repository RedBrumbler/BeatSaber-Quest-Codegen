...
/// @brief Method get_Key addr 0x26a43e0 size 0x8 virtual false final false
 ::StringW get_Key() ;

/// @brief Method Reset addr 0x26a43e8 size 0x50 virtual false final false
 void Reset() ;

/// @brief Method Start addr 0x26a4438 size 0x20 virtual false final false
 void Start() ;

/// @brief Method OnLocalize addr 0x26a4458 size 0xf8 virtual true final true
 void OnLocalize() ;

/// @brief Method IsOppositeDirection addr 0x26a4550 size 0x2c virtual false final false
 bool IsOppositeDirection(UnityEngine::TextAlignment alignment, Polyglot::LanguageDirection direction) ;

/// @brief Method IsAlignmentRight addr 0x26a457c size 0xc virtual false final false
 bool IsAlignmentRight(UnityEngine::TextAlignment alignment) ;

/// @brief Method IsAlignmentLeft addr 0x26a4588 size 0xc virtual false final false
 bool IsAlignmentLeft(UnityEngine::TextAlignment alignment) ;

// Ctor Parameters []
explicit LocalizedTextMesh() ;

/// @brief Method .ctor addr 0x26a4594 size 0x8 virtual false final false
 void _ctor() ;
