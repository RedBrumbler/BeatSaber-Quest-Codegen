...
/// @brief Method AppendRow addr 0x269fb50 size 0x3b4 virtual false final false
static void AppendRow(::StringW filePath, System::Collections::Generic::List_1<::StringW> row) ;

/// @brief Method AppendElement addr 0x269ffb8 size 0x84 virtual false final false
static void AppendElement(System::Text::StringBuilder buffer, ::StringW element) ;

/// @brief Method HasEscapeChars addr 0x269ff04 size 0xb4 virtual false final false
static bool HasEscapeChars(::StringW element) ;

// Ctor Parameters []
explicit CsvWriter() ;

/// @brief Method .ctor addr 0x26a003c size 0x8 virtual false final false
 void _ctor() ;
