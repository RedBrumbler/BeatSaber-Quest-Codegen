...
/// @brief Method ToSerializedName addr 0x26a0604 size 0x1b0 virtual false final false
static ::StringW ToSerializedName(Polyglot::Language lang) ;

/// @brief Method ToCultureInfoName addr 0x26a07b4 size 0xe8 virtual false final false
static ::StringW ToCultureInfoName(Polyglot::Language lang) ;

/// @brief Method ToLanguage addr 0x26a089c size 0x7e8 virtual false final false
