...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::TextAsset (Polyglot::LocalizationAsset::*)()>(&Polyglot::LocalizationAsset::get_TextAsset)> {
  ...
  constexpr static std::size_t addrs = 0x26a2a14;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Polyglot::GoogleDriveDownloadFormat (Polyglot::LocalizationAsset::*)()>(&Polyglot::LocalizationAsset::get_Format)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x26a2a24;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Polyglot::LocalizationAsset::*)(Polyglot::GoogleDriveDownloadFormat)>(&Polyglot::LocalizationAsset::set_Format)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x26a2a2c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Polyglot::LocalizationAsset::*)()>(&Polyglot::LocalizationAsset::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x26a2a34;
...
constexpr UnityEngine::TextAsset Polyglot::LocalizationAsset::__get_textAsset() const {
...
::cordl_internals::setInstanceField<Polyglot::GoogleDriveDownloadFormat, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<Polyglot::GoogleDriveDownloadFormat>(value));
}
constexpr Polyglot::GoogleDriveDownloadFormat Polyglot::LocalizationAsset::__get_format() const {
return ::cordl_internals::getInstanceField<Polyglot::GoogleDriveDownloadFormat, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
// Ctor Parameters []
 Polyglot::LocalizationAsset::LocalizationAsset()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<LocalizationAsset>())) {}
 void Polyglot::LocalizationAsset::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Polyglot::LocalizationAsset>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
