...
namespace Polyglot {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15562), inst: 4323 }), TypeDefinitionIndex(TypeDefinitionIndex(15562)), TypeDefinitionIndex(TypeDefinitionIndex(12268))}
...
/// @brief Method SetText addr 0x26a459c size 0x2c virtual true final false
 void SetText(TMPro::TextMeshPro text, ::StringW value) ;

/// @brief Method UpdateAlignment addr 0x26a45c8 size 0xf4 virtual true final false
 void UpdateAlignment(TMPro::TextMeshPro text, Polyglot::LanguageDirection direction) ;

/// @brief Method IsOppositeDirection addr 0x26a46bc size 0x58 virtual false final false
 bool IsOppositeDirection(TMPro::TextAlignmentOptions alignment, Polyglot::LanguageDirection direction) ;

/// @brief Method IsAlignmentRight addr 0x26a4714 size 0x28 virtual false final false
 bool IsAlignmentRight(TMPro::TextAlignmentOptions alignment) ;

/// @brief Method IsAlignmentLeft addr 0x26a473c size 0x28 virtual false final false
 bool IsAlignmentLeft(TMPro::TextAlignmentOptions alignment) ;

// Ctor Parameters []
explicit LocalizedTextMeshPro() ;

/// @brief Method .ctor addr 0x26a4764 size 0x48 virtual false final false
 void _ctor() ;
