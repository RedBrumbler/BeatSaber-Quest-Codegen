...
/// @brief Method Start addr 0x26a49bc size 0x50 virtual false final false
 void Start() ;

/// @brief Method OnLocalize addr 0x26a4a0c size 0x28 virtual true final true
 void OnLocalize() ;

// Ctor Parameters []
explicit SaveLanguagePreference() ;

/// @brief Method .ctor addr 0x26a4a34 size 0x1050 virtual false final false
 void _ctor() ;
