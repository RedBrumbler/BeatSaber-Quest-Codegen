...
/// @brief Method Reset addr 0x26a1100 size 0x50 virtual false final false
 void Reset() ;

/// @brief Method Start addr 0x26a1150 size 0x24 virtual false final false
 void Start() ;

/// @brief Method CreateDropdown addr 0x26a1174 size 0x22c virtual false final false
 void CreateDropdown() ;

/// @brief Method OnLocalize addr 0x26a16ec size 0x148 virtual true final true
 void OnLocalize() ;

// Ctor Parameters []
explicit LanguageDropdown() ;

/// @brief Method .ctor addr 0x26a1834 size 0x8 virtual false final false
 void _ctor() ;
