...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10185)), TypeDefinitionIndex(TypeDefinitionIndex(15562))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15562), inst: 2 })
