...
/// @brief Method get_TextAsset addr 0x26a2a3c size 0x8 virtual false final false
 UnityEngine::TextAsset get_TextAsset() ;

/// @brief Method set_TextAsset addr 0x26a2a44 size 0x8 virtual false final false
 void set_TextAsset(UnityEngine::TextAsset value) ;

/// @brief Method get_DocsId addr 0x26a2a4c size 0x8 virtual false final false
 ::StringW get_DocsId() ;

/// @brief Method set_DocsId addr 0x26a2a54 size 0x8 virtual false final false
 void set_DocsId(::StringW value) ;

/// @brief Method get_SheetId addr 0x26a2a5c size 0x8 virtual false final false
 ::StringW get_SheetId() ;

/// @brief Method set_SheetId addr 0x26a2a64 size 0x8 virtual false final false
 void set_SheetId(::StringW value) ;

/// @brief Method get_Format addr 0x26a2a6c size 0x8 virtual false final false
 Polyglot::GoogleDriveDownloadFormat get_Format() ;

/// @brief Method set_Format addr 0x26a2a74 size 0x8 virtual false final false
 void set_Format(Polyglot::GoogleDriveDownloadFormat value) ;

/// @brief Method get_DownloadOnStart addr 0x26a2a7c size 0x8 virtual false final false
 bool get_DownloadOnStart() ;

/// @brief Method set_DownloadOnStart addr 0x26a2a84 size 0xc virtual false final false
 void set_DownloadOnStart(bool value) ;

// Ctor Parameters []
explicit LocalizationDocument() ;

/// @brief Method .ctor addr 0x26a2a90 size 0x8 virtual false final false
 void _ctor() ;
