...
/// @brief Method get_CustomDocument addr 0x26a183c size 0x8 virtual false final false
 Polyglot::LocalizationDocument get_CustomDocument() ;

/// @brief Method get_InputFiles addr 0x26a1844 size 0x8 virtual false final false
 System::Collections::Generic::List_1<Polyglot::LocalizationAsset> get_InputFiles() ;

/// @brief Method get_Instance addr 0x26a13a0 size 0x94 virtual false final false
static Polyglot::Localization get_Instance() ;

/// @brief Method set_Instance addr 0x26a18ec size 0x4c virtual false final false
static void set_Instance(Polyglot::Localization value) ;

/// @brief Method get_HasInstance addr 0x26a184c size 0xa0 virtual false final false
static bool get_HasInstance() ;

/// @brief Method get_SupportedLanguages addr 0x26a1938 size 0x8 virtual false final false
 System::Collections::Generic::List_1<Polyglot::Language> get_SupportedLanguages() ;

/// @brief Method get_SelectedLanguageDirection addr 0x26a1940 size 0x14 virtual false final false
 Polyglot::LanguageDirection get_SelectedLanguageDirection() ;

/// @brief Method GetLanguageDirection addr 0x26a1954 size 0x1c virtual false final false
 Polyglot::LanguageDirection GetLanguageDirection(Polyglot::Language language) ;

/// @brief Method get_SelectedLanguageIndex addr 0x26a1678 size 0x74 virtual false final false
 int32_t get_SelectedLanguageIndex() ;

/// @brief Method get_SelectedCultureInfo addr 0x26a1970 size 0x8 virtual false final false
 System::Globalization::CultureInfo get_SelectedCultureInfo() ;

/// @brief Method get_SelectedLanguage addr 0x26a1978 size 0x8 virtual false final false
 Polyglot::Language get_SelectedLanguage() ;

/// @brief Method set_SelectedLanguage addr 0x26a1980 size 0x104 virtual false final false
 void set_SelectedLanguage(Polyglot::Language value) ;

/// @brief Method IsLanguageSupported addr 0x26a1a84 size 0x78 virtual false final false
 bool IsLanguageSupported(Polyglot::Language language) ;

/// @brief Method InvokeOnLocalize addr 0x26a1ba0 size 0x14 virtual false final false
 void InvokeOnLocalize() ;

/// @brief Method get_EnglishLanguageNames addr 0x26a1608 size 0x70 virtual false final false
 System::Collections::Generic::List_1<::StringW> get_EnglishLanguageNames() ;

/// @brief Method get_LocalizedLanguageNames addr 0x26a1ec4 size 0x70 virtual false final false
 System::Collections::Generic::List_1<::StringW> get_LocalizedLanguageNames() ;

/// @brief Method get_EnglishLanguageName addr 0x26a1f34 size 0x40 virtual false final false
 ::StringW get_EnglishLanguageName() ;

/// @brief Method get_LocalizedLanguageName addr 0x26a1f98 size 0x40 virtual false final false
 ::StringW get_LocalizedLanguageName() ;

/// @brief Method SelectLanguage addr 0x26a1fd8 size 0x78 virtual false final false
 void SelectLanguage(int32_t selected) ;

/// @brief Method SelectLanguage addr 0x26a2050 size 0x4 virtual false final false
 void SelectLanguage(Polyglot::Language selected) ;

/// @brief Method SelectCultureInfo addr 0x26a1afc size 0xa4 virtual false final false
 void SelectCultureInfo() ;

/// @brief Method ConvertSystemLanguage addr 0x26a2054 size 0x38 virtual false final false
 Polyglot::Language ConvertSystemLanguage(UnityEngine::SystemLanguage selected) ;

/// @brief Method AddOnLocalizeEvent addr 0x26a1434 size 0x1d4 virtual false final false
 void AddOnLocalizeEvent(Polyglot::ILocalize localize) ;

/// @brief Method RemoveOnLocalizeEvent addr 0x26a208c size 0xec virtual false final false
 void RemoveOnLocalizeEvent(Polyglot::ILocalize localize) ;

/// @brief Method Get addr 0x26a1f74 size 0x24 virtual false final false
static ::StringW Get(::StringW key) ;

/// @brief Method Get addr 0x26a2178 size 0x3b4 virtual false final false
static ::StringW Get(::StringW key, Polyglot::Language language) ;

/// @brief Method KeyExist addr 0x26a25bc size 0xb0 virtual false final false
static bool KeyExist(::StringW key) ;

/// @brief Method GetKeys addr 0x26a266c size 0x4c virtual false final false
static System::Collections::Generic::List_1<::StringW> GetKeys() ;

/// @brief Method GetFormat addr 0x26a274c size 0x6c virtual false final false
static ::StringW GetFormat(::StringW key, ::ArrayW<::bs_hook::Il2CppWrapperType> arguments) ;

/// @brief Method InputFilesContains addr 0x26a27b8 size 0x1c4 virtual false final false
 bool InputFilesContains(Polyglot::LocalizationDocument doc) ;

// Ctor Parameters []
explicit Localization() ;

/// @brief Method .ctor addr 0x26a297c size 0x98 virtual false final false
 void _ctor() ;
