...
namespace Polyglot {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15562)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15562), inst: 2510 }), TypeDefinitionIndex(TypeDefinitionIndex(13086))}
...
/// @brief Method SetText addr 0x26a40d8 size 0x134 virtual true final false
 void SetText(UnityEngine::UI::Text text, ::StringW value) ;

/// @brief Method UpdateAlignment addr 0x26a420c size 0xe4 virtual true final false
 void UpdateAlignment(UnityEngine::UI::Text text, Polyglot::LanguageDirection direction) ;

/// @brief Method IsOppositeDirection addr 0x26a42f0 size 0x58 virtual false final false
 bool IsOppositeDirection(UnityEngine::TextAnchor alignment, Polyglot::LanguageDirection direction) ;

/// @brief Method IsAlignmentRight addr 0x26a4348 size 0x28 virtual false final false
 bool IsAlignmentRight(UnityEngine::TextAnchor alignment) ;

/// @brief Method IsAlignmentLeft addr 0x26a4370 size 0x28 virtual false final false
 bool IsAlignmentLeft(UnityEngine::TextAnchor alignment) ;

// Ctor Parameters []
explicit LocalizedText() ;

/// @brief Method .ctor addr 0x26a4398 size 0x48 virtual false final false
 void _ctor() ;
