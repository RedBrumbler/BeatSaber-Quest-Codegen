...
template<::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2638)), TypeDefinitionIndex(TypeDefinitionIndex(16002))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(16002), inst: 80 })
