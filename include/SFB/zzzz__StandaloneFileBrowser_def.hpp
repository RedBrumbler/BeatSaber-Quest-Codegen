...
/// @brief Method OpenFilePanel addr 0x220d1d4 size 0x140 virtual false final false
static ::ArrayW<::StringW> OpenFilePanel(::StringW title, ::StringW directory, ::StringW extension, bool multiselect) ;

/// @brief Method OpenFilePanel addr 0x220d314 size 0xf8 virtual false final false
...
/// @brief Method OpenFilePanelAsync addr 0x220d40c size 0x148 virtual false final false
...
/// @brief Method OpenFilePanelAsync addr 0x220d554 size 0x104 virtual false final false
...
/// @brief Method SaveFilePanelAsync addr 0x220dbc4 size 0x104 virtual false final false
...
/// @brief Method .ctor addr 0x220dcc8 size 0x8 virtual false final false
 void _ctor() ;
