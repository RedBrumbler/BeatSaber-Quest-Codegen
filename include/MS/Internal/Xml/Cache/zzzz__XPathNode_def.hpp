...
/// @brief Method get_NodeType addr 0x2789880 size 0xc virtual false final false
 System::Xml::XPath::XPathNodeType get_NodeType() ;

/// @brief Method get_Prefix addr 0x2789978 size 0x1c virtual false final false
 ::StringW get_Prefix() ;

/// @brief Method get_LocalName addr 0x27898c8 size 0x1c virtual false final false
 ::StringW get_LocalName() ;

/// @brief Method get_NamespaceUri addr 0x2789920 size 0x1c virtual false final false
 ::StringW get_NamespaceUri() ;

/// @brief Method get_Document addr 0x27899d8 size 0x1c virtual false final false
 System::Xml::XPath::XPathDocument get_Document() ;

/// @brief Method get_PageInfo addr 0x2789f28 size 0x1c virtual false final false
 MS::Internal::Xml::Cache::XPathNodePageInfo get_PageInfo() ;

/// @brief Method GetParent addr 0x2789db8 size 0x24 virtual false final false
 int32_t GetParent(ByRef<::ArrayW<MS::Internal::Xml::Cache::XPathNode>> pageNode) ;

/// @brief Method GetSibling addr 0x2789c8c size 0x24 virtual false final false
 int32_t GetSibling(ByRef<::ArrayW<MS::Internal::Xml::Cache::XPathNode>> pageNode) ;

/// @brief Method get_IsXmlNamespaceNode addr 0x2789c04 size 0x88 virtual false final false
 bool get_IsXmlNamespaceNode() ;

/// @brief Method get_HasSibling addr 0x2789f44 size 0x10 virtual false final false
 bool get_HasSibling() ;

/// @brief Method get_HasCollapsedText addr 0x2789f54 size 0xc virtual false final false
 bool get_HasCollapsedText() ;

/// @brief Method get_IsText addr 0x2789f60 size 0x60 virtual false final false
 bool get_IsText() ;

/// @brief Method get_HasNamespaceDecls addr 0x2789fc0 size 0xc virtual false final false
 bool get_HasNamespaceDecls() ;

/// @brief Method get_Value addr 0x2789fcc size 0x8 virtual false final false
 ::StringW get_Value() ;
