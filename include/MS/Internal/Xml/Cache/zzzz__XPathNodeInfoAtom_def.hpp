...
/// @brief Method get_PageInfo addr 0x278a050 size 0x8 virtual false final false
 MS::Internal::Xml::Cache::XPathNodePageInfo get_PageInfo() ;

/// @brief Method get_LocalName addr 0x278a058 size 0x8 virtual false final false
 ::StringW get_LocalName() ;

/// @brief Method get_NamespaceUri addr 0x278a060 size 0x8 virtual false final false
 ::StringW get_NamespaceUri() ;

/// @brief Method get_Prefix addr 0x278a068 size 0x8 virtual false final false
 ::StringW get_Prefix() ;

/// @brief Method get_SiblingPage addr 0x278a070 size 0x8 virtual false final false
 ::ArrayW<MS::Internal::Xml::Cache::XPathNode> get_SiblingPage() ;

/// @brief Method get_ParentPage addr 0x278a078 size 0x8 virtual false final false
 ::ArrayW<MS::Internal::Xml::Cache::XPathNode> get_ParentPage() ;

/// @brief Method get_Document addr 0x278a080 size 0x8 virtual false final false
