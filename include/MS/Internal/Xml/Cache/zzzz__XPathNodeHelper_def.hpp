...
/// @brief Method GetLocalNamespaces addr 0x2789ae8 size 0x64 virtual false final false
...
/// @brief Method GetInScopeNamespaces addr 0x2789b4c size 0xb8 virtual false final false
...
/// @brief Method GetParent addr 0x2789e08 size 0x58 virtual false final false
static bool GetParent(ByRef<::ArrayW<MS::Internal::Xml::Cache::XPathNode>> pageNode, ByRef<int32_t> idxNode) ;

/// @brief Method GetLocation addr 0x278a000 size 0x38 virtual false final false
static int32_t GetLocation(::ArrayW<MS::Internal::Xml::Cache::XPathNode> pageNode, int32_t idxNode) ;

/// @brief Method GetTextFollowing addr 0x278966c size 0x160 virtual false final false
...
/// @brief Method GetNonDescendant addr 0x27895ec size 0x80 virtual false final false
