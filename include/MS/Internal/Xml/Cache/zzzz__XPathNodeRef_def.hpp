...
/// @brief Method .ctor addr 0x2789fd4 size 0xc virtual false final false
 void _ctor(::ArrayW<MS::Internal::Xml::Cache::XPathNode> page, int32_t idx) ;

/// @brief Method get_Page addr 0x2789fe0 size 0x8 virtual false final false
 ::ArrayW<MS::Internal::Xml::Cache::XPathNode> get_Page() ;

/// @brief Method get_Index addr 0x2789fe8 size 0x8 virtual false final false
 int32_t get_Index() ;

/// @brief Method GetHashCode addr 0x2789ff0 size 0x10 virtual true final false
 int32_t GetHashCode() ;
