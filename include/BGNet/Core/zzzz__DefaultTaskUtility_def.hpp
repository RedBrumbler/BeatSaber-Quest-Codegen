...
/// @brief Method Delay addr 0xde0bdc size 0x68 virtual true final true
 System::Threading::Tasks::Task Delay(System::TimeSpan timeSpan, System::Threading::CancellationToken cancellationToken) ;

/// @brief Method CancellationTokenWithDelay addr 0xde0c44 size 0x68 virtual true final true
 System::Threading::CancellationToken CancellationTokenWithDelay(System::TimeSpan timeSpan) ;

/// @brief Method Wait addr 0xde0cac size 0x18 virtual true final true
...
/// @brief Method Run addr 0xde0cc4 size 0x68 virtual true final true
 System::Threading::Tasks::Task Run(System::Action action, System::Threading::CancellationToken cancellationToken) ;

/// @brief Method Run addr 0xde0d2c size 0x68 virtual true final true
...
/// @brief Method .ctor addr 0xde0d94 size 0x8 virtual false final false
 void _ctor() ;
