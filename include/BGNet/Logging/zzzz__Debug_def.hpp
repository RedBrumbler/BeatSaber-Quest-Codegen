...
/// @brief Method .ctor addr 0xde52a8 size 0x28 virtual false final false
...
/// @brief Method NoDomainReloadInit addr 0xde5020 size 0x90 virtual false final false
static void NoDomainReloadInit() ;

/// @brief Method AddLogger addr 0xde50b8 size 0x178 virtual false final false
static void AddLogger(BGNet::Logging::BGNet__Logging__Debug__ILogger logger) ;

/// @brief Method RemoveLogger addr 0xde52d0 size 0x24c virtual false final false
static void RemoveLogger(BGNet::Logging::BGNet__Logging__Debug__ILogger logger) ;

/// @brief Method Log addr 0xde551c size 0xf4 virtual false final false
static void Log(::StringW message) ;

/// @brief Method LogError addr 0xde5610 size 0xf8 virtual false final false
static void LogError(::StringW message) ;

/// @brief Method LogException addr 0xde5708 size 0x100 virtual false final false
static void LogException(System::Exception exception, ::StringW message) ;

/// @brief Method LogWarning addr 0xde5808 size 0xf8 virtual false final false
