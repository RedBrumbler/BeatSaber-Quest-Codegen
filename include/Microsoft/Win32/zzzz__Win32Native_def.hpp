...
/// @brief Method GetMessage addr 0x22f85e4 size 0x5c virtual false final false
static ::StringW GetMessage(int32_t hr) ;

/// @brief Method MakeHRFromErrorCode addr 0x22f8640 size 0xc virtual false final false
