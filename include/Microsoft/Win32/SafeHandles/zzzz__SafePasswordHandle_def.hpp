...
/// @brief Method CreateHandle addr 0x22f864c size 0x58 virtual false final false
 ::cordl_internals::intptr_t CreateHandle(::StringW password) ;

/// @brief Method FreeHandle addr 0x22f86a4 size 0x5c virtual false final false
 void FreeHandle() ;

// Ctor Parameters [CppParam { name: "password", ty: "::StringW", modifiers: "", def_value: None }]
explicit SafePasswordHandle(::StringW password) ;

/// @brief Method .ctor addr 0x22f8700 size 0x78 virtual false final false
 void _ctor(::StringW password) ;

/// @brief Method ReleaseHandle addr 0x22f8778 size 0x7c virtual true final false
 bool ReleaseHandle() ;

/// @brief Method Dispose addr 0x22f87f4 size 0x70 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method get_IsInvalid addr 0x22f8864 size 0x28 virtual true final false
 bool get_IsInvalid() ;

/// @brief Method Mono_DangerousGetString addr 0x22f888c size 0x5c virtual false final false
