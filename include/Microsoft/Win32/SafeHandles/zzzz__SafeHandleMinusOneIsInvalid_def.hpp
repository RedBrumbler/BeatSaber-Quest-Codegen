...
explicit SafeHandleMinusOneIsInvalid(bool ownsHandle) ;

/// @brief Method .ctor addr 0x22f8a90 size 0x44 virtual false final false
 void _ctor(bool ownsHandle) ;

/// @brief Method get_IsInvalid addr 0x22f8ad4 size 0x40 virtual true final false
 bool get_IsInvalid() ;
