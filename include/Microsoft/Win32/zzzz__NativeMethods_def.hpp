...
/// @brief Method DuplicateHandle addr 0x26ca09c size 0x204 virtual false final false
...
/// @brief Method DuplicateHandle addr 0x26ca2a0 size 0x150 virtual false final false
...
/// @brief Method GetCurrentProcess addr 0x26ca41c size 0x4 virtual false final false
static ::cordl_internals::intptr_t GetCurrentProcess() ;

/// @brief Method GetExitCodeProcess addr 0x26ca420 size 0x4 virtual false final false
static bool GetExitCodeProcess(::cordl_internals::intptr_t processHandle, ByRef<int32_t> exitCode) ;

/// @brief Method GetExitCodeProcess addr 0x26ca424 size 0xe8 virtual false final false
static bool GetExitCodeProcess(Microsoft::Win32::SafeHandles::SafeProcessHandle processHandle, ByRef<int32_t> exitCode) ;

/// @brief Method GetProcessTimes addr 0x26ca50c size 0x4 virtual false final false
...
/// @brief Method GetProcessTimes addr 0x26ca510 size 0x108 virtual false final false
...
/// @brief Method GetCurrentProcessId addr 0x26ca618 size 0x4 virtual false final false
static int32_t GetCurrentProcessId() ;

/// @brief Method CloseProcess addr 0x26ca61c size 0x4 virtual false final false
