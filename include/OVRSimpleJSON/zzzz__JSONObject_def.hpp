...
/// @brief Method .ctor addr 0x267084c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Remove>b__0 addr 0x2670c88 size 0x48 virtual false final false
...
/// @brief Method .ctor addr 0x26708cc size 0x34 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2670cd0 size 0x1c virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2670cec size 0x1a8 virtual true final true
 bool MoveNext() ;

/// @brief Method <>m__Finally1 addr 0x2670e94 size 0x50 virtual false final false
 void __m__Finally1() ;

/// @brief Method System.Collections.Generic.IEnumerator<OVRSimpleJSON.JSONNode>.get_Current addr 0x2670ee4 size 0x8 virtual true final true
 OVRSimpleJSON::JSONNode System_Collections_Generic_IEnumerator_OVRSimpleJSON_JSONNode__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x2670eec size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2670f2c size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<OVRSimpleJSON.JSONNode>.GetEnumerator addr 0x2670f34 size 0xa4 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2670fd8 size 0x4 virtual true final true
...
/// @brief Method get_Inline addr 0x266fee4 size 0x8 virtual true final false
 bool get_Inline() ;

/// @brief Method set_Inline addr 0x266feec size 0xc virtual true final false
 void set_Inline(bool value) ;

/// @brief Method get_Tag addr 0x266fef8 size 0x8 virtual true final false
 OVRSimpleJSON::JSONNodeType get_Tag() ;

/// @brief Method get_IsObject addr 0x266ff00 size 0x8 virtual true final false
 bool get_IsObject() ;

/// @brief Method GetEnumerator addr 0x266ff08 size 0x88 virtual true final false
 OVRSimpleJSON::OVRSimpleJSON__JSONNode__Enumerator GetEnumerator() ;

/// @brief Method get_Item addr 0x266ff90 size 0xc4 virtual true final false
 OVRSimpleJSON::JSONNode get_Item(::StringW aKey) ;

/// @brief Method set_Item addr 0x2670080 size 0x10c virtual true final false
 void set_Item(::StringW aKey, OVRSimpleJSON::JSONNode value) ;

/// @brief Method get_Item addr 0x267018c size 0xa0 virtual true final false
 OVRSimpleJSON::JSONNode get_Item(int32_t aIndex) ;

/// @brief Method set_Item addr 0x267022c size 0x11c virtual true final false
 void set_Item(int32_t aIndex, OVRSimpleJSON::JSONNode value) ;

/// @brief Method get_Count addr 0x2670348 size 0x50 virtual true final false
 int32_t get_Count() ;

/// @brief Method Add addr 0x2670398 size 0x154 virtual true final false
 void Add(::StringW aKey, OVRSimpleJSON::JSONNode aItem) ;

/// @brief Method Remove addr 0x26704ec size 0xc4 virtual true final false
 OVRSimpleJSON::JSONNode Remove(::StringW aKey) ;

/// @brief Method Remove addr 0x26705b0 size 0xdc virtual true final false
 OVRSimpleJSON::JSONNode Remove(int32_t aIndex) ;

/// @brief Method Remove addr 0x267068c size 0x1c0 virtual true final false
 OVRSimpleJSON::JSONNode Remove(OVRSimpleJSON::JSONNode aNode) ;

/// @brief Method get_Children addr 0x2670854 size 0x78 virtual true final false
 System::Collections::Generic::IEnumerable_1<OVRSimpleJSON::JSONNode> get_Children() ;

/// @brief Method WriteToStringBuilder addr 0x2670900 size 0x30c virtual true final false
...
/// @brief Method .ctor addr 0x2670c0c size 0x7c virtual false final false
 void _ctor() ;
