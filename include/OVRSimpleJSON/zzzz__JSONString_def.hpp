...
/// @brief Method get_Tag addr 0x2670fdc size 0x8 virtual true final false
 OVRSimpleJSON::JSONNodeType get_Tag() ;

/// @brief Method get_IsString addr 0x2670fe4 size 0x8 virtual true final false
 bool get_IsString() ;

/// @brief Method GetEnumerator addr 0x2670fec size 0x14 virtual true final false
 OVRSimpleJSON::OVRSimpleJSON__JSONNode__Enumerator GetEnumerator() ;

/// @brief Method get_Value addr 0x2671000 size 0x8 virtual true final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x2671008 size 0x8 virtual true final false
 void set_Value(::StringW value) ;

// Ctor Parameters [CppParam { name: "aData", ty: "::StringW", modifiers: "", def_value: None }]
explicit JSONString(::StringW aData) ;

/// @brief Method .ctor addr 0x2671010 size 0x28 virtual false final false
 void _ctor(::StringW aData) ;

/// @brief Method WriteToStringBuilder addr 0x2671038 size 0x60 virtual true final false
...
/// @brief Method Equals addr 0x2671098 size 0xfc virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2671194 size 0x20 virtual true final false
 int32_t GetHashCode() ;
