...
/// @brief Method .ctor addr 0x266f9d4 size 0x34 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x266fbec size 0x1c virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x266fc08 size 0x194 virtual true final true
 bool MoveNext() ;

/// @brief Method <>m__Finally1 addr 0x266fd9c size 0x50 virtual false final false
 void __m__Finally1() ;

/// @brief Method System.Collections.Generic.IEnumerator<OVRSimpleJSON.JSONNode>.get_Current addr 0x266fdec size 0x8 virtual true final true
 OVRSimpleJSON::JSONNode System_Collections_Generic_IEnumerator_OVRSimpleJSON_JSONNode__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x266fdf4 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x266fe34 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<OVRSimpleJSON.JSONNode>.GetEnumerator addr 0x266fe3c size 0xa4 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x266fee0 size 0x4 virtual true final true
...
/// @brief Method get_Inline addr 0x266f264 size 0x8 virtual true final false
 bool get_Inline() ;

/// @brief Method set_Inline addr 0x266f26c size 0xc virtual true final false
 void set_Inline(bool value) ;

/// @brief Method get_Tag addr 0x266f278 size 0x8 virtual true final false
 OVRSimpleJSON::JSONNodeType get_Tag() ;

/// @brief Method get_IsArray addr 0x266f280 size 0x8 virtual true final false
 bool get_IsArray() ;

/// @brief Method GetEnumerator addr 0x266f288 size 0x8c virtual true final false
 OVRSimpleJSON::OVRSimpleJSON__JSONNode__Enumerator GetEnumerator() ;

/// @brief Method get_Item addr 0x266f314 size 0xb4 virtual true final false
 OVRSimpleJSON::JSONNode get_Item(int32_t aIndex) ;

/// @brief Method set_Item addr 0x266f3f0 size 0x148 virtual true final false
 void set_Item(int32_t aIndex, OVRSimpleJSON::JSONNode value) ;

/// @brief Method get_Item addr 0x266f5cc size 0x64 virtual true final false
 OVRSimpleJSON::JSONNode get_Item(::StringW aKey) ;

/// @brief Method set_Item addr 0x266f630 size 0xe8 virtual true final false
 void set_Item(::StringW aKey, OVRSimpleJSON::JSONNode value) ;

/// @brief Method get_Count addr 0x266f718 size 0x48 virtual true final false
 int32_t get_Count() ;

/// @brief Method Add addr 0x266f760 size 0xe8 virtual true final false
 void Add(::StringW aKey, OVRSimpleJSON::JSONNode aItem) ;

/// @brief Method Remove addr 0x266f848 size 0xb4 virtual true final false
 OVRSimpleJSON::JSONNode Remove(int32_t aIndex) ;

/// @brief Method Remove addr 0x266f8fc size 0x60 virtual true final false
 OVRSimpleJSON::JSONNode Remove(OVRSimpleJSON::JSONNode aNode) ;

/// @brief Method get_Children addr 0x266f95c size 0x78 virtual true final false
 System::Collections::Generic::IEnumerable_1<OVRSimpleJSON::JSONNode> get_Children() ;

/// @brief Method WriteToStringBuilder addr 0x266fa08 size 0x168 virtual true final false
...
/// @brief Method .ctor addr 0x266fb70 size 0x7c virtual false final false
 void _ctor() ;
