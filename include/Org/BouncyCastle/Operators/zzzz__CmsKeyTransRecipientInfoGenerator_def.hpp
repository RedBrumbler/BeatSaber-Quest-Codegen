...
/// @brief Method .ctor addr 0xeaf5ac size 0x14c virtual false final false
...
/// @brief Method .ctor addr 0xeaf6f8 size 0x74 virtual false final false
 void _ctor(::ArrayW<uint8_t> subjectKeyID, Org::BouncyCastle::Crypto::IKeyWrapper keyWrapper) ;

/// @brief Method get_AlgorithmDetails addr 0xeaf76c size 0xec virtual true final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_AlgorithmDetails() ;

/// @brief Method GenerateWrappedKey addr 0xeaf858 size 0x130 virtual true final false
