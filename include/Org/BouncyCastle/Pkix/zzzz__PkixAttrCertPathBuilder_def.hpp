...
/// @brief Method Build addr 0x106b388 size 0xee0 virtual true final false
 Org::BouncyCastle::Pkix::PkixCertPathBuilderResult Build(Org::BouncyCastle::Pkix::PkixBuilderParameters pkixParams) ;

/// @brief Method Build addr 0x106d280 size 0xc40 virtual false final false
...
/// @brief Method .ctor addr 0x106e818 size 0x8 virtual false final false
 void _ctor() ;
