...
/// @brief Method get_RevocationDate addr 0x106b34c size 0x8 virtual false final false
 Org::BouncyCastle::Utilities::Date::DateTimeObject get_RevocationDate() ;

/// @brief Method set_RevocationDate addr 0x106b354 size 0x8 virtual false final false
 void set_RevocationDate(Org::BouncyCastle::Utilities::Date::DateTimeObject value) ;

/// @brief Method get_Status addr 0x106b35c size 0x8 virtual false final false
 int32_t get_Status() ;

/// @brief Method set_Status addr 0x106b364 size 0x8 virtual false final false
 void set_Status(int32_t value) ;

// Ctor Parameters []
explicit CertStatus() ;

/// @brief Method .ctor addr 0x106b36c size 0x14 virtual false final false
 void _ctor() ;
