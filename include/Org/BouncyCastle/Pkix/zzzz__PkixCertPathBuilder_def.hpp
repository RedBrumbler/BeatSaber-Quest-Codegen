...
/// @brief Method Build addr 0x10755f0 size 0x8dc virtual true final false
 Org::BouncyCastle::Pkix::PkixCertPathBuilderResult Build(Org::BouncyCastle::Pkix::PkixBuilderParameters pkixParams) ;

/// @brief Method Build addr 0x1075ecc size 0xbb4 virtual true final false
...
/// @brief Method .ctor addr 0x1076a88 size 0x8 virtual false final false
 void _ctor() ;
