...
/// @brief Method .ctor addr 0x1076bc0 size 0x4 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit PkixCertPathBuilderException(::StringW message) ;

/// @brief Method .ctor addr 0x106c268 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x106ca74 size 0x4 virtual false final false
