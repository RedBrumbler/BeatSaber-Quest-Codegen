...
/// @brief Method GetInstance addr 0x10724f4 size 0xec virtual false final false
...
/// @brief Method .ctor addr 0x10725e0 size 0x98 virtual false final false
...
/// @brief Method get_MaxPathLength addr 0x1072678 size 0x8 virtual true final false
 int32_t get_MaxPathLength() ;

/// @brief Method set_MaxPathLength addr 0x1072680 size 0x64 virtual true final false
 void set_MaxPathLength(int32_t value) ;

/// @brief Method GetExcludedCerts addr 0x10726e4 size 0x68 virtual true final false
 Org::BouncyCastle::Utilities::Collections::ISet GetExcludedCerts() ;

/// @brief Method SetExcludedCerts addr 0x107274c size 0x80 virtual true final false
 void SetExcludedCerts(Org::BouncyCastle::Utilities::Collections::ISet excludedCerts) ;

/// @brief Method SetParams addr 0x10727cc size 0xc4 virtual true final false
 void SetParams(Org::BouncyCastle::Pkix::PkixParameters parameters) ;

/// @brief Method Clone addr 0x1072890 size 0xb8 virtual true final false
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method ToString addr 0x1072948 size 0x174 virtual true final false
 ::StringW ToString() ;
