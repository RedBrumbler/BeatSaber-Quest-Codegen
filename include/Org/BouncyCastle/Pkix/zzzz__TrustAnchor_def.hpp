...
/// @brief Method .ctor addr 0x109fff4 size 0x88 virtual false final false
...
/// @brief Method .ctor addr 0x10a0138 size 0xcc virtual false final false
...
/// @brief Method .ctor addr 0x10a0204 size 0x148 virtual false final false
 void _ctor(::StringW caName, Org::BouncyCastle::Crypto::AsymmetricKeyParameter pubKey, ::ArrayW<uint8_t> nameConstraints) ;

/// @brief Method get_TrustedCert addr 0x10a034c size 0x8 virtual false final false
 Org::BouncyCastle::X509::X509Certificate get_TrustedCert() ;

/// @brief Method get_CA addr 0x10a0354 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Name get_CA() ;

/// @brief Method get_CAName addr 0x10a035c size 0x8 virtual false final false
 ::StringW get_CAName() ;

/// @brief Method get_CAPublicKey addr 0x10a0364 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::AsymmetricKeyParameter get_CAPublicKey() ;

/// @brief Method setNameConstraints addr 0x10a007c size 0xbc virtual false final false
 void setNameConstraints(::ArrayW<uint8_t> bytes) ;

/// @brief Method get_GetNameConstraints addr 0x10a036c size 0x5c virtual false final false
 ::ArrayW<uint8_t> get_GetNameConstraints() ;

/// @brief Method ToString addr 0x10a03c8 size 0x1e8 virtual true final false
 ::StringW ToString() ;
