...
/// @brief Method .ctor addr 0x106e05c size 0x80 virtual false final false
...
/// @brief Method get_CertPath addr 0x1076e78 size 0x8 virtual false final false
 Org::BouncyCastle::Pkix::PkixCertPath get_CertPath() ;

/// @brief Method ToString addr 0x1076e80 size 0x1a8 virtual true final false
 ::StringW ToString() ;
