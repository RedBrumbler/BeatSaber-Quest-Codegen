...
/// @brief Method Validate addr 0x1077038 size 0x1eec virtual true final false
...
/// @brief Method CheckCertificate addr 0x1079644 size 0x108 virtual false final false
static void CheckCertificate(Org::BouncyCastle::X509::X509Certificate cert) ;

// Ctor Parameters []
explicit PkixCertPathValidator() ;

/// @brief Method .ctor addr 0x1076a80 size 0x8 virtual false final false
 void _ctor() ;
