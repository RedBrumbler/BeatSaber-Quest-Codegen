...
/// @brief Method .ctor addr 0x106f08c size 0x160 virtual false final false
 void _ctor(Org::BouncyCastle::Utilities::Collections::ISet trustAnchors) ;

/// @brief Method get_IsRevocationEnabled addr 0x106f1ec size 0x8 virtual true final false
 bool get_IsRevocationEnabled() ;

/// @brief Method set_IsRevocationEnabled addr 0x106f1f4 size 0xc virtual true final false
 void set_IsRevocationEnabled(bool value) ;

/// @brief Method get_IsExplicitPolicyRequired addr 0x106f200 size 0x8 virtual true final false
 bool get_IsExplicitPolicyRequired() ;

/// @brief Method set_IsExplicitPolicyRequired addr 0x106f208 size 0xc virtual true final false
 void set_IsExplicitPolicyRequired(bool value) ;

/// @brief Method get_IsAnyPolicyInhibited addr 0x106f214 size 0x8 virtual true final false
 bool get_IsAnyPolicyInhibited() ;

/// @brief Method set_IsAnyPolicyInhibited addr 0x106f21c size 0xc virtual true final false
 void set_IsAnyPolicyInhibited(bool value) ;

/// @brief Method get_IsPolicyMappingInhibited addr 0x106f228 size 0x8 virtual true final false
 bool get_IsPolicyMappingInhibited() ;

/// @brief Method set_IsPolicyMappingInhibited addr 0x106f230 size 0xc virtual true final false
 void set_IsPolicyMappingInhibited(bool value) ;

/// @brief Method get_IsPolicyQualifiersRejected addr 0x106f23c size 0x8 virtual true final false
 bool get_IsPolicyQualifiersRejected() ;

/// @brief Method set_IsPolicyQualifiersRejected addr 0x106f244 size 0xc virtual true final false
 void set_IsPolicyQualifiersRejected(bool value) ;

/// @brief Method get_Date addr 0x106f250 size 0x8 virtual true final false
 Org::BouncyCastle::Utilities::Date::DateTimeObject get_Date() ;

/// @brief Method set_Date addr 0x106f258 size 0x8 virtual true final false
 void set_Date(Org::BouncyCastle::Utilities::Date::DateTimeObject value) ;

/// @brief Method GetTrustAnchors addr 0x106f260 size 0x68 virtual true final false
 Org::BouncyCastle::Utilities::Collections::ISet GetTrustAnchors() ;

/// @brief Method SetTrustAnchors addr 0x106f2c8 size 0x4dc virtual true final false
 void SetTrustAnchors(Org::BouncyCastle::Utilities::Collections::ISet tas) ;

/// @brief Method GetTargetCertConstraints addr 0x106f7a4 size 0xf0 virtual true final false
 Org::BouncyCastle::X509::Store::X509CertStoreSelector GetTargetCertConstraints() ;

/// @brief Method SetTargetCertConstraints addr 0x106f894 size 0x108 virtual true final false
 void SetTargetCertConstraints(Org::BouncyCastle::X509::Store::IX509Selector selector) ;

/// @brief Method GetInitialPolicies addr 0x106f99c size 0x84 virtual true final false
 Org::BouncyCastle::Utilities::Collections::ISet GetInitialPolicies() ;

/// @brief Method SetInitialPolicies addr 0x106fa20 size 0x3cc virtual true final false
 void SetInitialPolicies(Org::BouncyCastle::Utilities::Collections::ISet initialPolicies) ;

/// @brief Method SetCertPathCheckers addr 0x106fdec size 0x3fc virtual true final false
 void SetCertPathCheckers(System::Collections::IList checkers) ;

/// @brief Method GetCertPathCheckers addr 0x10701e8 size 0x3f0 virtual true final false
 System::Collections::IList GetCertPathCheckers() ;

/// @brief Method AddCertPathChecker addr 0x10705d8 size 0xd0 virtual true final false
 void AddCertPathChecker(Org::BouncyCastle::Pkix::PkixCertPathChecker checker) ;

/// @brief Method Clone addr 0x10706a8 size 0x94 virtual true final false
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method SetParams addr 0x107073c size 0x394 virtual true final false
 void SetParams(Org::BouncyCastle::Pkix::PkixParameters parameters) ;

/// @brief Method get_IsUseDeltasEnabled addr 0x1070ad0 size 0x8 virtual true final false
 bool get_IsUseDeltasEnabled() ;

/// @brief Method set_IsUseDeltasEnabled addr 0x1070ad8 size 0xc virtual true final false
 void set_IsUseDeltasEnabled(bool value) ;

/// @brief Method get_ValidityModel addr 0x1070ae4 size 0x8 virtual true final false
 int32_t get_ValidityModel() ;

/// @brief Method set_ValidityModel addr 0x1070aec size 0x8 virtual true final false
 void set_ValidityModel(int32_t value) ;

/// @brief Method SetStores addr 0x1070af4 size 0x41c virtual true final false
 void SetStores(System::Collections::IList stores) ;

/// @brief Method AddStore addr 0x1070f10 size 0xbc virtual true final false
 void AddStore(Org::BouncyCastle::X509::Store::IX509Store store) ;

/// @brief Method AddAdditionalStore addr 0x1070fcc size 0xbc virtual true final false
 void AddAdditionalStore(Org::BouncyCastle::X509::Store::IX509Store store) ;

/// @brief Method GetAdditionalStores addr 0x1071088 size 0x5c virtual true final false
 System::Collections::IList GetAdditionalStores() ;

/// @brief Method GetStores addr 0x10710e4 size 0x5c virtual true final false
 System::Collections::IList GetStores() ;

/// @brief Method get_IsAdditionalLocationsEnabled addr 0x1071140 size 0x8 virtual true final false
 bool get_IsAdditionalLocationsEnabled() ;

/// @brief Method SetAdditionalLocationsEnabled addr 0x1071148 size 0xc virtual true final false
 void SetAdditionalLocationsEnabled(bool enabled) ;

/// @brief Method GetTargetConstraints addr 0x1071154 size 0xe0 virtual true final false
 Org::BouncyCastle::X509::Store::IX509Selector GetTargetConstraints() ;

/// @brief Method SetTargetConstraints addr 0x1071234 size 0x108 virtual true final false
 void SetTargetConstraints(Org::BouncyCastle::X509::Store::IX509Selector selector) ;

/// @brief Method GetTrustedACIssuers addr 0x107133c size 0x68 virtual true final false
 Org::BouncyCastle::Utilities::Collections::ISet GetTrustedACIssuers() ;

/// @brief Method SetTrustedACIssuers addr 0x10713a4 size 0x458 virtual true final false
 void SetTrustedACIssuers(Org::BouncyCastle::Utilities::Collections::ISet trustedACIssuers) ;

/// @brief Method GetNecessaryACAttributes addr 0x10717fc size 0x68 virtual true final false
 Org::BouncyCastle::Utilities::Collections::ISet GetNecessaryACAttributes() ;

/// @brief Method SetNecessaryACAttributes addr 0x1071864 size 0x3b4 virtual true final false
 void SetNecessaryACAttributes(Org::BouncyCastle::Utilities::Collections::ISet necessaryACAttributes) ;

/// @brief Method GetProhibitedACAttributes addr 0x1071c18 size 0x68 virtual true final false
 Org::BouncyCastle::Utilities::Collections::ISet GetProhibitedACAttributes() ;

/// @brief Method SetProhibitedACAttributes addr 0x1071c80 size 0x3b4 virtual true final false
 void SetProhibitedACAttributes(Org::BouncyCastle::Utilities::Collections::ISet prohibitedACAttributes) ;

/// @brief Method GetAttrCertCheckers addr 0x1072034 size 0x68 virtual true final false
 Org::BouncyCastle::Utilities::Collections::ISet GetAttrCertCheckers() ;

/// @brief Method SetAttrCertCheckers addr 0x107209c size 0x458 virtual true final false
