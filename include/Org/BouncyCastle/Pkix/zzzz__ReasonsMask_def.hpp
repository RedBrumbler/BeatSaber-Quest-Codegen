...
/// @brief Method .ctor addr 0x1095f6c size 0x28 virtual false final false
 void _ctor(int32_t reasons) ;

// Ctor Parameters []
explicit ReasonsMask() ;

/// @brief Method .ctor addr 0x1095f94 size 0x1c virtual false final false
 void _ctor() ;

/// @brief Method AddReasons addr 0x1095fb0 size 0x48 virtual false final false
 void AddReasons(Org::BouncyCastle::Pkix::ReasonsMask mask) ;

/// @brief Method get_IsAllReasons addr 0x1096060 size 0x74 virtual false final false
 bool get_IsAllReasons() ;

/// @brief Method Intersect addr 0x10960d4 size 0xc8 virtual false final false
 Org::BouncyCastle::Pkix::ReasonsMask Intersect(Org::BouncyCastle::Pkix::ReasonsMask mask) ;

/// @brief Method HasNewReasons addr 0x109619c size 0x54 virtual false final false
 bool HasNewReasons(Org::BouncyCastle::Pkix::ReasonsMask mask) ;

/// @brief Method get_Reasons addr 0x1095ff8 size 0x68 virtual false final false
