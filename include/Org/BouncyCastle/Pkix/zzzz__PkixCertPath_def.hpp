...
/// @brief Method SortCerts addr 0x1072ccc size 0xd94 virtual false final false
...
/// @brief Method .ctor addr 0x106dfb0 size 0xac virtual false final false
...
/// @brief Method .ctor addr 0x1073a60 size 0x58 virtual false final false
...
/// @brief Method .ctor addr 0x1073ab8 size 0x86c virtual false final false
 void _ctor(System::IO::Stream inStream, ::StringW encoding) ;

/// @brief Method get_Encodings addr 0x1074324 size 0x90 virtual true final false
 System::Collections::IEnumerable get_Encodings() ;

/// @brief Method Equals addr 0x10743b4 size 0x41c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x10747d0 size 0x28 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method GetEncoded addr 0x10747f8 size 0x344 virtual true final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method GetEncoded addr 0x1074b3c size 0x88c virtual true final false
 ::ArrayW<uint8_t> GetEncoded(::StringW encoding) ;

/// @brief Method get_Certificates addr 0x10755e4 size 0xc virtual true final false
 System::Collections::IList get_Certificates() ;

/// @brief Method ToAsn1Object addr 0x10753c8 size 0x100 virtual false final false
 Org::BouncyCastle::Asn1::Asn1Object ToAsn1Object(Org::BouncyCastle::X509::X509Certificate cert) ;

/// @brief Method ToDerEncoded addr 0x10754c8 size 0x11c virtual false final false
