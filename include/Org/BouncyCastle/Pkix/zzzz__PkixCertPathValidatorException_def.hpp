...
/// @brief Method .ctor addr 0x10832e0 size 0xc virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit PkixCertPathValidatorException(::StringW message) ;

/// @brief Method .ctor addr 0x10832ec size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x106f060 size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x1078f24 size 0x198 virtual false final false
 void _ctor(::StringW message, System::Exception cause, Org::BouncyCastle::Pkix::PkixCertPath certPath, int32_t index) ;

/// @brief Method get_Message addr 0x10832f8 size 0x34 virtual true final false
 ::StringW get_Message() ;

/// @brief Method get_CertPath addr 0x108332c size 0x8 virtual false final false
 Org::BouncyCastle::Pkix::PkixCertPath get_CertPath() ;

/// @brief Method get_Index addr 0x1083334 size 0x8 virtual false final false
 int32_t get_Index() ;
