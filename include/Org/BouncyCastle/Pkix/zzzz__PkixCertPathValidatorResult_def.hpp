...
/// @brief Method get_PolicyTree addr 0x1076bc4 size 0x8 virtual false final false
 Org::BouncyCastle::Pkix::PkixPolicyNode get_PolicyTree() ;

/// @brief Method get_TrustAnchor addr 0x1076bcc size 0x8 virtual false final false
 Org::BouncyCastle::Pkix::TrustAnchor get_TrustAnchor() ;

/// @brief Method get_SubjectPublicKey addr 0x1076bd4 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x1076bdc size 0xb4 virtual false final false
...
/// @brief Method Clone addr 0x1076c90 size 0x78 virtual false final false
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method ToString addr 0x1076d08 size 0x170 virtual true final false
 ::StringW ToString() ;
