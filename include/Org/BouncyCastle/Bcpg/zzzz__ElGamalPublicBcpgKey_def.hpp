...
/// @brief Method .ctor addr 0x115427c size 0xb0 virtual false final false
...
/// @brief Method .ctor addr 0x115432c size 0xc0 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger p, Org::BouncyCastle::Math::BigInteger g, Org::BouncyCastle::Math::BigInteger y) ;

/// @brief Method get_Format addr 0x11543ec size 0x40 virtual true final true
 ::StringW get_Format() ;

/// @brief Method GetEncoded addr 0x115442c size 0x84 virtual true final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method get_P addr 0x11544b0 size 0x1c virtual false final false
 Org::BouncyCastle::Math::BigInteger get_P() ;

/// @brief Method get_G addr 0x11544cc size 0x1c virtual false final false
 Org::BouncyCastle::Math::BigInteger get_G() ;

/// @brief Method get_Y addr 0x11544e8 size 0x1c virtual false final false
 Org::BouncyCastle::Math::BigInteger get_Y() ;

/// @brief Method Encode addr 0x1154504 size 0x100 virtual true final false
