...
/// @brief Method .ctor addr 0x1149e10 size 0x48 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::SignatureSubpacketTag type, bool critical, bool isLongLength, ::ArrayW<uint8_t> data) ;

/// @brief Method get_SubpacketType addr 0x1149e58 size 0x8 virtual false final false
 Org::BouncyCastle::Bcpg::SignatureSubpacketTag get_SubpacketType() ;

/// @brief Method IsCritical addr 0x1149e60 size 0x8 virtual false final false
 bool IsCritical() ;

/// @brief Method IsLongLength addr 0x1149e68 size 0x8 virtual false final false
 bool IsLongLength() ;

/// @brief Method GetData addr 0x1149e70 size 0x78 virtual false final false
 ::ArrayW<uint8_t> GetData() ;

/// @brief Method Encode addr 0x1149ee8 size 0x144 virtual false final false
