...
/// @brief Method Wrap addr 0x115236c size 0x90 virtual false final false
...
/// @brief Method .ctor addr 0x11522c4 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x11523fc size 0x90 virtual false final false
...
/// @brief Method .ctor addr 0x1152600 size 0x130 virtual false final false
...
/// @brief Method .ctor addr 0x1152730 size 0x9c virtual false final false
...
/// @brief Method .ctor addr 0x11527cc size 0x128 virtual false final false
 void _ctor(System::IO::Stream outStr, Org::BouncyCastle::Bcpg::PacketTag tag, ::ArrayW<uint8_t> buffer) ;

/// @brief Method WriteNewPacketLength addr 0x11528f4 size 0xe0 virtual false final false
 void WriteNewPacketLength(int64_t bodyLen) ;

/// @brief Method WriteHeader addr 0x115248c size 0x174 virtual false final false
 void WriteHeader(Org::BouncyCastle::Bcpg::PacketTag tag, bool oldPackets, bool partial, int64_t bodyLen) ;

/// @brief Method PartialFlush addr 0x11529d4 size 0x80 virtual false final false
 void PartialFlush(bool isLast) ;

/// @brief Method WritePartial addr 0x1152a54 size 0x68 virtual false final false
 void WritePartial(uint8_t b) ;

/// @brief Method WritePartial addr 0x1152abc size 0xec virtual false final false
 void WritePartial(::ArrayW<uint8_t> buffer, int32_t off, int32_t len) ;

/// @brief Method WriteByte addr 0x1152ba8 size 0x34 virtual true final false
 void WriteByte(uint8_t value) ;

/// @brief Method Write addr 0x1152bdc size 0x34 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method WriteShort addr 0x1152c10 size 0x94 virtual true final false
 void WriteShort(int16_t n) ;

/// @brief Method WriteInt addr 0x1152ca4 size 0xb4 virtual true final false
 void WriteInt(int32_t n) ;

/// @brief Method WriteLong addr 0x1152d58 size 0xf4 virtual true final false
 void WriteLong(int64_t n) ;

/// @brief Method WritePacket addr 0x1152e4c size 0x28 virtual false final false
 void WritePacket(Org::BouncyCastle::Bcpg::ContainedPacket p) ;

/// @brief Method WritePacket addr 0x1152e74 size 0x48 virtual false final false
 void WritePacket(Org::BouncyCastle::Bcpg::PacketTag tag, ::ArrayW<uint8_t> body, bool oldFormat) ;

/// @brief Method WriteObject addr 0x115233c size 0x28 virtual false final false
 void WriteObject(Org::BouncyCastle::Bcpg::BcpgObject bcpgObject) ;

/// @brief Method WriteObjects addr 0x1152ebc size 0x6c virtual false final false
 void WriteObjects(::ArrayW<Org::BouncyCastle::Bcpg::BcpgObject> v) ;

/// @brief Method Flush addr 0x1152f28 size 0x24 virtual true final false
 void Flush() ;

/// @brief Method Finish addr 0x1152f4c size 0x40 virtual false final false
 void Finish() ;

/// @brief Method Close addr 0x1152f8c size 0x8c virtual true final false
 void Close() ;
