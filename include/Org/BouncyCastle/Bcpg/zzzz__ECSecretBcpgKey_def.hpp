...
/// @brief Method .ctor addr 0x1154088 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x1154100 size 0x78 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method get_Format addr 0x1154178 size 0x40 virtual true final true
 ::StringW get_Format() ;

/// @brief Method GetEncoded addr 0x11541b8 size 0x84 virtual true final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method Encode addr 0x115423c size 0x24 virtual true final false
 void Encode(Org::BouncyCastle::Bcpg::BcpgOutputStream bcpgOut) ;

/// @brief Method get_X addr 0x1154260 size 0x1c virtual true final false
