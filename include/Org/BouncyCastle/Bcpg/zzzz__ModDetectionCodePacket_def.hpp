...
/// @brief Method .ctor addr 0x1151df4 size 0xb8 virtual false final false
...
/// @brief Method .ctor addr 0x1154940 size 0x100 virtual false final false
 void _ctor(::ArrayW<uint8_t> digest) ;

/// @brief Method GetDigest addr 0x1154a40 size 0x78 virtual false final false
 ::ArrayW<uint8_t> GetDigest() ;

/// @brief Method Encode addr 0x1154ab8 size 0x28 virtual true final false
