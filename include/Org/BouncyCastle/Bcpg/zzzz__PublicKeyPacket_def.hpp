...
/// @brief Method .ctor addr 0x1151408 size 0x298 virtual false final false
...
/// @brief Method .ctor addr 0x11551b0 size 0xb4 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag algorithm, System::DateTime time, Org::BouncyCastle::Bcpg::IBcpgKey key) ;

/// @brief Method get_Version addr 0x1155264 size 0x8 virtual true final false
 int32_t get_Version() ;

/// @brief Method get_Algorithm addr 0x115526c size 0x8 virtual true final false
 Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_Algorithm() ;

/// @brief Method get_ValidDays addr 0x1155274 size 0x8 virtual true final false
 int32_t get_ValidDays() ;

/// @brief Method GetTime addr 0x115527c size 0x60 virtual true final false
 System::DateTime GetTime() ;

/// @brief Method get_Key addr 0x11552dc size 0x8 virtual true final false
 Org::BouncyCastle::Bcpg::IBcpgKey get_Key() ;

/// @brief Method GetEncodedContents addr 0x11552e4 size 0x15c virtual true final false
 ::ArrayW<uint8_t> GetEncodedContents() ;

/// @brief Method Encode addr 0x1155440 size 0x38 virtual true final false
