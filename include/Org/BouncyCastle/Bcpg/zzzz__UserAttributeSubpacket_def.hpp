...
/// @brief Method .ctor addr 0x114979c size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x11497d0 size 0x40 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::UserAttributeSubpacketTag type, bool forceLongLength, ::ArrayW<uint8_t> data) ;

/// @brief Method get_SubpacketType addr 0x1149810 size 0x8 virtual true final false
 Org::BouncyCastle::Bcpg::UserAttributeSubpacketTag get_SubpacketType() ;

/// @brief Method GetData addr 0x1149818 size 0x8 virtual true final false
 ::ArrayW<uint8_t> GetData() ;

/// @brief Method Encode addr 0x1149820 size 0x138 virtual true final false
 void Encode(System::IO::Stream os) ;

/// @brief Method Equals addr 0x1149958 size 0xe8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x1149a40 size 0xa4 virtual true final false
 int32_t GetHashCode() ;
