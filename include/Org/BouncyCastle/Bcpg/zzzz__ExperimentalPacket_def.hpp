...
/// @brief Method .ctor addr 0x1151eac size 0x44 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::PacketTag tag, Org::BouncyCastle::Bcpg::BcpgInputStream bcpgIn) ;

/// @brief Method get_Tag addr 0x11547f8 size 0x8 virtual false final false
 Org::BouncyCastle::Bcpg::PacketTag get_Tag() ;

/// @brief Method GetContents addr 0x1154800 size 0x78 virtual false final false
 ::ArrayW<uint8_t> GetContents() ;

/// @brief Method Encode addr 0x1154878 size 0x28 virtual true final false
