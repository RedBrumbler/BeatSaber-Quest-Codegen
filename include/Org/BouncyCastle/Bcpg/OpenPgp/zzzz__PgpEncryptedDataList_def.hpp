...
/// @brief Method .ctor addr 0x102ea80 size 0x55c virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::BcpgInputStream bcpgInput) ;

/// @brief Method get_Item addr 0x102f00c size 0xf4 virtual false final false
 Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedData get_Item(int32_t index) ;

/// @brief Method Get addr 0x102f100 size 0x4 virtual false final false
 ::bs_hook::Il2CppWrapperType Get(int32_t index) ;

/// @brief Method get_Size addr 0x102f104 size 0xa4 virtual false final false
 int32_t get_Size() ;

/// @brief Method get_Count addr 0x102f1a8 size 0xa4 virtual false final false
 int32_t get_Count() ;

/// @brief Method get_IsEmpty addr 0x102f24c size 0xb0 virtual false final false
 bool get_IsEmpty() ;

/// @brief Method GetEncryptedDataObjects addr 0x102f2fc size 0x68 virtual false final false
