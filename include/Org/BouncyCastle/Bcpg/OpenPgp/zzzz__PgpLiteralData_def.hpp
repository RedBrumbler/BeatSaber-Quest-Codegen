...
/// @brief Method .ctor addr 0x1031b48 size 0x120 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::BcpgInputStream bcpgInput) ;

/// @brief Method get_Format addr 0x1031c68 size 0x1c virtual false final false
 int32_t get_Format() ;

/// @brief Method get_FileName addr 0x1031c84 size 0x1c virtual false final false
 ::StringW get_FileName() ;

/// @brief Method GetRawFileName addr 0x1031ca0 size 0x1c virtual false final false
 ::ArrayW<uint8_t> GetRawFileName() ;

/// @brief Method get_ModificationTime addr 0x1031cbc size 0x68 virtual false final false
 System::DateTime get_ModificationTime() ;

/// @brief Method GetInputStream addr 0x1031d24 size 0x1c virtual false final false
 System::IO::Stream GetInputStream() ;

/// @brief Method GetDataStream addr 0x1031d40 size 0x1c virtual false final false
