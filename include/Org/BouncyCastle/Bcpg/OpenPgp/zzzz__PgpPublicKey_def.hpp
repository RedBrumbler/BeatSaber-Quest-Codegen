...
/// @brief Method CalculateFingerprint addr 0x1034a58 size 0x4e8 virtual false final false
static ::ArrayW<uint8_t> CalculateFingerprint(Org::BouncyCastle::Bcpg::PublicKeyPacket publicPk) ;

/// @brief Method UpdateDigest addr 0x1034f40 size 0xcc virtual false final false
static void UpdateDigest(Org::BouncyCastle::Crypto::IDigest d, Org::BouncyCastle::Math::BigInteger b) ;

/// @brief Method Init addr 0x103500c size 0x320 virtual false final false
 void Init() ;
...
/// @brief Method .ctor addr 0x102f520 size 0x4f0 virtual false final false
...
/// @brief Method .ctor addr 0x103532c size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x1035464 size 0xb4 virtual false final false
...
/// @brief Method .ctor addr 0x103101c size 0xcc virtual false final false
...
/// @brief Method .ctor addr 0x1031614 size 0x508 virtual false final false
...
/// @brief Method .ctor addr 0x1035518 size 0xcc virtual false final false
...
/// @brief Method .ctor addr 0x10353ac size 0xb8 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::PublicKeyPacket publicPk, System::Collections::IList ids, System::Collections::IList idSigs) ;

/// @brief Method get_Version addr 0x10355e4 size 0x20 virtual false final false
 int32_t get_Version() ;

/// @brief Method get_CreationTime addr 0x1031b1c size 0x20 virtual false final false
 System::DateTime get_CreationTime() ;

/// @brief Method get_ValidDays addr 0x1035604 size 0xd4 virtual false final false
 int32_t get_ValidDays() ;

/// @brief Method GetTrustData addr 0x1035810 size 0x7c virtual false final false
 ::ArrayW<uint8_t> GetTrustData() ;

/// @brief Method GetValidSeconds addr 0x10356d8 size 0x138 virtual false final false
 int64_t GetValidSeconds() ;

/// @brief Method GetExpirationTimeFromSig addr 0x10358dc size 0x470 virtual false final false
 int64_t GetExpirationTimeFromSig(bool selfSigned, int32_t signatureType) ;

/// @brief Method get_KeyId addr 0x1036190 size 0x8 virtual false final false
 int64_t get_KeyId() ;

/// @brief Method GetFingerprint addr 0x1036198 size 0x78 virtual false final false
 ::ArrayW<uint8_t> GetFingerprint() ;

/// @brief Method get_IsEncryptionKey addr 0x102be4c size 0x54 virtual false final false
 bool get_IsEncryptionKey() ;

/// @brief Method get_IsMasterKey addr 0x103588c size 0x50 virtual false final false
 bool get_IsMasterKey() ;

/// @brief Method get_Algorithm addr 0x102e17c size 0x20 virtual false final false
 Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_Algorithm() ;

/// @brief Method get_BitStrength addr 0x1036210 size 0x8 virtual false final false
 int32_t get_BitStrength() ;

/// @brief Method GetKey addr 0x102e19c size 0x58c virtual false final false
 Org::BouncyCastle::Crypto::AsymmetricKeyParameter GetKey() ;

/// @brief Method GetECKey addr 0x1036218 size 0x14c virtual false final false
 Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters GetECKey(::StringW algorithm) ;

/// @brief Method GetUserIds addr 0x1036364 size 0x3ec virtual false final false
 System::Collections::IEnumerable GetUserIds() ;

/// @brief Method GetUserAttributes addr 0x1036750 size 0x408 virtual false final false
 System::Collections::IEnumerable GetUserAttributes() ;

/// @brief Method GetSignaturesForId addr 0x1036b58 size 0x284 virtual false final false
 System::Collections::IEnumerable GetSignaturesForId(::StringW id) ;

/// @brief Method GetSignaturesForUserAttribute addr 0x1036ddc size 0x23c virtual false final false
...
/// @brief Method GetSignaturesOfType addr 0x1035d4c size 0x444 virtual false final false
 System::Collections::IEnumerable GetSignaturesOfType(int32_t signatureType) ;

/// @brief Method GetSignatures addr 0x1037018 size 0x3a8 virtual false final false
 System::Collections::IEnumerable GetSignatures() ;

/// @brief Method GetKeySignatures addr 0x10373c0 size 0xa4 virtual false final false
 System::Collections::IEnumerable GetKeySignatures() ;

/// @brief Method get_PublicKeyPacket addr 0x1037464 size 0x8 virtual false final false
 Org::BouncyCastle::Bcpg::PublicKeyPacket get_PublicKeyPacket() ;

/// @brief Method GetEncoded addr 0x103746c size 0x78 virtual false final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method Encode addr 0x10374e4 size 0xd6c virtual false final false
 void Encode(System::IO::Stream outStr) ;

/// @brief Method IsRevoked addr 0x1038250 size 0x2c8 virtual false final false
 bool IsRevoked() ;

/// @brief Method AddCertification addr 0x1038518 size 0x6c virtual false final false
...
/// @brief Method AddCertification addr 0x10389f8 size 0x6c virtual false final false
...
/// @brief Method AddCert addr 0x1038584 size 0x474 virtual false final false
...
/// @brief Method RemoveCertification addr 0x1038a64 size 0x64 virtual false final false
...
/// @brief Method RemoveCertification addr 0x1038da4 size 0x64 virtual false final false
...
/// @brief Method RemoveCert addr 0x1038ac8 size 0x2dc virtual false final false
...
/// @brief Method RemoveCertification addr 0x1038e08 size 0x6c virtual false final false
...
/// @brief Method RemoveCertification addr 0x103917c size 0x6c virtual false final false
...
/// @brief Method RemoveCert addr 0x1038e74 size 0x308 virtual false final false
...
/// @brief Method AddCertification addr 0x10391e8 size 0x1c8 virtual false final false
...
/// @brief Method RemoveCertification addr 0x10393b0 size 0xd94 virtual false final false
