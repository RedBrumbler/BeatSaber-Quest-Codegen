...
/// @brief Method .ctor addr 0x1051efc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method GetAgreementAlgorithm addr 0x1051f04 size 0x174 virtual false final false
static ::StringW GetAgreementAlgorithm(Org::BouncyCastle::Bcpg::PublicKeyPacket pubKeyData) ;

/// @brief Method GetKeyEncryptionOID addr 0x1052078 size 0x128 virtual false final false
...
/// @brief Method GetKeyLength addr 0x10521a0 size 0x98 virtual false final false
static int32_t GetKeyLength(Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag algID) ;

/// @brief Method CreateKey addr 0x103c74c size 0x108 virtual false final false
static ::ArrayW<uint8_t> CreateKey(Org::BouncyCastle::Bcpg::PublicKeyPacket pubKeyData, Org::BouncyCastle::Math::EC::ECPoint s) ;

/// @brief Method CreateUserKeyingMaterial addr 0x1052238 size 0x268 virtual false final false
static ::ArrayW<uint8_t> CreateUserKeyingMaterial(Org::BouncyCastle::Bcpg::PublicKeyPacket pubKeyData) ;

/// @brief Method Kdf addr 0x10524a0 size 0x37c virtual false final false
