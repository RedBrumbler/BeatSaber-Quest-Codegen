...
/// @brief Method Cast addr 0x1033274 size 0xd0 virtual false final false
...
/// @brief Method .ctor addr 0x1032f50 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x1033344 size 0x38 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::OnePassSignaturePacket sigPack) ;

/// @brief Method InitVerify addr 0x103337c size 0x274 virtual false final false
 void InitVerify(Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey pubKey) ;

/// @brief Method Update addr 0x10335f0 size 0xcc virtual false final false
 void Update(uint8_t b) ;

/// @brief Method doCanonicalUpdateByte addr 0x10336bc size 0xe0 virtual false final false
 void doCanonicalUpdateByte(uint8_t b) ;

/// @brief Method doUpdateCRLF addr 0x103379c size 0x110 virtual false final false
 void doUpdateCRLF() ;

/// @brief Method Update addr 0x10338ac size 0x110 virtual false final false
 void Update(::ArrayW<uint8_t> bytes) ;

/// @brief Method Update addr 0x10339bc size 0x114 virtual false final false
 void Update(::ArrayW<uint8_t> bytes, int32_t off, int32_t length) ;

/// @brief Method Verify addr 0x1033ad0 size 0x158 virtual false final false
 bool Verify(Org::BouncyCastle::Bcpg::OpenPgp::PgpSignature pgpSig) ;

/// @brief Method get_KeyId addr 0x1033c28 size 0x1c virtual false final false
 int64_t get_KeyId() ;

/// @brief Method get_SignatureType addr 0x1033c44 size 0x1c virtual false final false
 int32_t get_SignatureType() ;

/// @brief Method get_HashAlgorithm addr 0x1033c60 size 0x1c virtual false final false
 Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm() ;

/// @brief Method get_KeyAlgorithm addr 0x1033c7c size 0x1c virtual false final false
 Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_KeyAlgorithm() ;

/// @brief Method GetEncoded addr 0x1033c98 size 0x78 virtual false final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method Encode addr 0x1033d10 size 0x2c virtual false final false
