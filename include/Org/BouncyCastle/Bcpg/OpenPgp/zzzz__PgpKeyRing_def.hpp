...
/// @brief Method .ctor addr 0x102fb14 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method ReadOptionalTrustPacket addr 0x102fb1c size 0xa0 virtual false final false
static Org::BouncyCastle::Bcpg::TrustPacket ReadOptionalTrustPacket(Org::BouncyCastle::Bcpg::BcpgInputStream bcpgInput) ;

/// @brief Method ReadSignaturesAndTrust addr 0x102fbbc size 0x2c8 virtual false final false
static System::Collections::IList ReadSignaturesAndTrust(Org::BouncyCastle::Bcpg::BcpgInputStream bcpgInput) ;

/// @brief Method ReadUserIDs addr 0x102fe84 size 0x340 virtual false final false
