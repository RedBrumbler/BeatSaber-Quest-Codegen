...
/// @brief Method .ctor addr 0x1050808 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method DsaSigToMpi addr 0x104d524 size 0x260 virtual false final false
static ::ArrayW<Org::BouncyCastle::Bcpg::MPInteger> DsaSigToMpi(::ArrayW<uint8_t> encoding) ;

/// @brief Method RsaSigToMpi addr 0x104d784 size 0xfc virtual false final false
static ::ArrayW<Org::BouncyCastle::Bcpg::MPInteger> RsaSigToMpi(::ArrayW<uint8_t> encoding) ;

/// @brief Method GetDigestName addr 0x103c620 size 0x12c virtual false final false
static ::StringW GetDigestName(Org::BouncyCastle::Bcpg::HashAlgorithmTag hashAlgorithm) ;

/// @brief Method GetSignatureName addr 0x104af2c size 0x180 virtual false final false
...
/// @brief Method GetSymmetricCipherName addr 0x103c47c size 0x1a4 virtual false final false
static ::StringW GetSymmetricCipherName(Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag algorithm) ;

/// @brief Method GetKeySize addr 0x1050810 size 0xa4 virtual false final false
static int32_t GetKeySize(Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag algorithm) ;

/// @brief Method MakeKey addr 0x10508b4 size 0x78 virtual false final false
...
/// @brief Method MakeRandomKey addr 0x105092c size 0x9c virtual false final false
...
/// @brief Method EncodePassPhrase addr 0x10411e0 size 0x50 virtual false final false
static ::ArrayW<uint8_t> EncodePassPhrase(::ArrayW<char16_t> passPhrase, bool utf8) ;

/// @brief Method MakeKeyFromPassPhrase addr 0x10509c8 size 0x3c virtual false final false
...
/// @brief Method MakeKeyFromPassPhraseUtf8 addr 0x1050a04 size 0x38 virtual false final false
...
/// @brief Method MakeKeyFromPassPhraseRaw addr 0x1050a3c size 0x8 virtual false final false
...
/// @brief Method DoMakeKeyFromPassPhrase addr 0x1042838 size 0x970 virtual false final false
...
/// @brief Method WriteFileToLiteralData addr 0x1050a44 size 0xd4 virtual false final false
static void WriteFileToLiteralData(System::IO::Stream output, char16_t fileType, System::IO::FileInfo file) ;

/// @brief Method WriteFileToLiteralData addr 0x1050cf8 size 0xcc virtual false final false
...
/// @brief Method PipeFileContents addr 0x1050b18 size 0x1e0 virtual false final false
static void PipeFileContents(System::IO::FileInfo file, System::IO::Stream pOut, int32_t bufSize) ;

/// @brief Method IsPossiblyBase64 addr 0x1050dc4 size 0x48 virtual false final false
static bool IsPossiblyBase64(int32_t ch) ;

/// @brief Method GetDecoderStream addr 0x1050e0c size 0x410 virtual false final false
static System::IO::Stream GetDecoderStream(System::IO::Stream inputStream) ;

/// @brief Method CreateWrapper addr 0x103c854 size 0x124 virtual false final false
static Org::BouncyCastle::Crypto::IWrapper CreateWrapper(Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag encAlgorithm) ;

/// @brief Method GenerateIV addr 0x1045544 size 0x7c virtual false final false
static ::ArrayW<uint8_t> GenerateIV(int32_t length, Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method GenerateS2k addr 0x10454b4 size 0x90 virtual false final false
