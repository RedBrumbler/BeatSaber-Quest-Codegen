...
/// @brief Method .ctor addr 0x1026ecc size 0x120 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::BcpgInputStream bcpgInput) ;

/// @brief Method get_Algorithm addr 0x1026fec size 0x1c virtual false final false
 Org::BouncyCastle::Bcpg::CompressionAlgorithmTag get_Algorithm() ;

/// @brief Method GetInputStream addr 0x1027008 size 0x1c virtual false final false
 System::IO::Stream GetInputStream() ;

/// @brief Method GetDataStream addr 0x1027024 size 0x178 virtual false final false
