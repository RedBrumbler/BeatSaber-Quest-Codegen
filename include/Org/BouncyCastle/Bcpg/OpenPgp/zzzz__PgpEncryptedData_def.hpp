...
/// @brief Method .ctor addr 0x102b570 size 0xd8 virtual false final false
 void _ctor(System::IO::Stream inStr) ;

/// @brief Method FillBuffer addr 0x102b648 size 0x58 virtual false final false
 int32_t FillBuffer() ;

/// @brief Method ReadByte addr 0x102b6a0 size 0x64 virtual true final false
 int32_t ReadByte() ;

/// @brief Method Read addr 0x102b704 size 0xcc virtual true final false
 int32_t Read(::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method GetLookAhead addr 0x102b4fc size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x102b1dc size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::InputStreamPacket encData) ;

/// @brief Method GetInputStream addr 0x102b204 size 0x1c virtual true final false
 System::IO::Stream GetInputStream() ;

/// @brief Method IsIntegrityProtected addr 0x102b220 size 0x7c virtual false final false
 bool IsIntegrityProtected() ;

/// @brief Method Verify addr 0x102b29c size 0x260 virtual false final false
 bool Verify() ;
