...
/// @brief Method .ctor addr 0x102efdc size 0x30 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::SymmetricKeyEncSessionPacket keyData, Org::BouncyCastle::Bcpg::InputStreamPacket encData) ;

/// @brief Method GetInputStream addr 0x1033fbc size 0x1c virtual true final false
 System::IO::Stream GetInputStream() ;

/// @brief Method GetDataStream addr 0x1033fd8 size 0x2c virtual false final false
 System::IO::Stream GetDataStream(::ArrayW<char16_t> passPhrase) ;

/// @brief Method GetDataStreamUtf8 addr 0x10348d4 size 0x30 virtual false final false
 System::IO::Stream GetDataStreamUtf8(::ArrayW<char16_t> passPhrase) ;

/// @brief Method GetDataStreamRaw addr 0x1034904 size 0x8 virtual false final false
 System::IO::Stream GetDataStreamRaw(::ArrayW<uint8_t> rawPassPhrase) ;

/// @brief Method DoGetDataStream addr 0x1034004 size 0x8d0 virtual false final false
 System::IO::Stream DoGetDataStream(::ArrayW<uint8_t> rawPassPhrase, bool clearPassPhrase) ;

/// @brief Method CreateStreamCipher addr 0x103490c size 0x134 virtual false final false
