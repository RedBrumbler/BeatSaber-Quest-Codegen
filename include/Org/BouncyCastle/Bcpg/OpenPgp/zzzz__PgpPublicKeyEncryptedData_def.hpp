...
/// @brief Method .ctor addr 0x103b1d8 size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::PublicKeyEncSessionPacket keyData, Org::BouncyCastle::Bcpg::InputStreamPacket encData) ;

/// @brief Method GetKeyCipher addr 0x103b204 size 0x248 virtual false final false
static Org::BouncyCastle::Crypto::IBufferedCipher GetKeyCipher(Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag algorithm) ;

/// @brief Method ConfirmCheckSum addr 0x103b44c size 0x98 virtual false final false
 bool ConfirmCheckSum(::ArrayW<uint8_t> sessionInfo) ;

/// @brief Method get_KeyId addr 0x103b4e4 size 0x1c virtual false final false
 int64_t get_KeyId() ;

/// @brief Method GetSymmetricAlgorithm addr 0x103b500 size 0x28 virtual false final false
 Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag GetSymmetricAlgorithm(Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey privKey) ;

/// @brief Method GetDataStream addr 0x103bcf0 size 0x78c virtual false final false
 System::IO::Stream GetDataStream(Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey privKey) ;

/// @brief Method RecoverSessionData addr 0x103b528 size 0x7c8 virtual false final false
 ::ArrayW<uint8_t> RecoverSessionData(Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey privKey) ;

/// @brief Method ProcessEncodedMpi addr 0x103c978 size 0x190 virtual false final false
