...
/// @brief Method .ctor addr 0x1027764 size 0x8 virtual false final false
 void _ctor(System::IO::Stream output) ;

/// @brief Method Close addr 0x1027818 size 0x4 virtual true final false
 void Close() ;
...
/// @brief Method .ctor addr 0x1027758 size 0xc virtual false final false
 void _ctor(System::IO::Stream output, int32_t level, bool nowrap) ;

/// @brief Method Close addr 0x1027880 size 0x30 virtual true final false
 void Close() ;
...
/// @brief Method .ctor addr 0x1027204 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x102720c size 0x124 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::CompressionAlgorithmTag algorithm, int32_t compression) ;

/// @brief Method Open addr 0x1027330 size 0x148 virtual false final false
 System::IO::Stream Open(System::IO::Stream outStr) ;

/// @brief Method Open addr 0x10275e0 size 0x178 virtual false final false
 System::IO::Stream Open(System::IO::Stream outStr, ::ArrayW<uint8_t> buffer) ;

/// @brief Method doOpen addr 0x1027478 size 0x168 virtual false final false
 void doOpen() ;

/// @brief Method Close addr 0x102776c size 0xa4 virtual true final true
 void Close() ;
