...
/// @brief Method .ctor addr 0x1031d5c size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "oldFormat", ty: "bool", modifiers: "", def_value: None }]
explicit PgpLiteralDataGenerator(bool oldFormat) ;

/// @brief Method .ctor addr 0x1031d64 size 0x28 virtual false final false
 void _ctor(bool oldFormat) ;

/// @brief Method WriteHeader addr 0x1031d8c size 0x144 virtual false final false
...
/// @brief Method Open addr 0x1031ed0 size 0x1d4 virtual false final false
...
/// @brief Method Open addr 0x10320a4 size 0x1c0 virtual false final false
...
/// @brief Method Open addr 0x1032264 size 0x84 virtual false final false
 System::IO::Stream Open(System::IO::Stream outStr, char16_t format, System::IO::FileInfo file) ;

/// @brief Method Close addr 0x10322e8 size 0x40 virtual true final true
 void Close() ;
