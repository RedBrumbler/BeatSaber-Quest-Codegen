...
/// @brief Method .ctor addr 0x105121c size 0xd8 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag keyAlgorithm, Org::BouncyCastle::Bcpg::HashAlgorithmTag hashAlgorithm) ;

/// @brief Method InitSign addr 0x10512f4 size 0x8 virtual false final false
 void InitSign(int32_t sigType, Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey key) ;

/// @brief Method InitSign addr 0x10512fc size 0x268 virtual false final false
...
/// @brief Method Update addr 0x1051564 size 0x14 virtual false final false
 void Update(uint8_t b) ;

/// @brief Method doCanonicalUpdateByte addr 0x1051578 size 0x64 virtual false final false
 void doCanonicalUpdateByte(uint8_t b) ;

/// @brief Method doUpdateCRLF addr 0x1051704 size 0x20 virtual false final false
 void doUpdateCRLF() ;

/// @brief Method doUpdateByte addr 0x10515dc size 0x128 virtual false final false
 void doUpdateByte(uint8_t b) ;

/// @brief Method Update addr 0x1051724 size 0x1a4 virtual false final false
 void Update(::ArrayW<uint8_t> b) ;

/// @brief Method Update addr 0x10518c8 size 0x198 virtual false final false
 void Update(::ArrayW<uint8_t> b, int32_t off, int32_t len) ;

/// @brief Method GenerateOnePassVersion addr 0x1051a60 size 0xcc virtual false final false
 Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature GenerateOnePassVersion(bool isNested) ;

/// @brief Method Generate addr 0x1051b2c size 0x3d0 virtual false final false
