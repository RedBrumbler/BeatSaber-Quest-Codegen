...
/// @brief Method .ctor addr 0x102b1d0 size 0x4 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit PgpDataValidationException(::StringW message) ;

/// @brief Method .ctor addr 0x102b1d4 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x102b1d8 size 0x4 virtual false final false
