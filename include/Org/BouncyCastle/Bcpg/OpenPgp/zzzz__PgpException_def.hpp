...
/// @brief Method .ctor addr 0x102b100 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit PgpException(::StringW message) ;

/// @brief Method .ctor addr 0x102719c size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x102b158 size 0x70 virtual false final false
 void _ctor(::StringW message, System::Exception exception) ;

/// @brief Method get_UnderlyingException addr 0x102b1c8 size 0x8 virtual false final false
