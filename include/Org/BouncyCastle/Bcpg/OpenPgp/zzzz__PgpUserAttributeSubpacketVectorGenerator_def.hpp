...
/// @brief Method SetImageAttribute addr 0x105038c size 0x150 virtual true final false
...
/// @brief Method Generate addr 0x10504dc size 0x2c8 virtual true final false
 Org::BouncyCastle::Bcpg::OpenPgp::PgpUserAttributeSubpacketVector Generate() ;

// Ctor Parameters []
explicit PgpUserAttributeSubpacketVectorGenerator() ;

/// @brief Method .ctor addr 0x10507a4 size 0x64 virtual false final false
 void _ctor() ;
