...
/// @brief Method .ctor addr 0x1033e74 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method PadSessionData addr 0x1033e7c size 0x8 virtual false final false
static ::ArrayW<uint8_t> PadSessionData(::ArrayW<uint8_t> sessionInfo) ;

/// @brief Method PadSessionData addr 0x102e728 size 0x108 virtual false final false
static ::ArrayW<uint8_t> PadSessionData(::ArrayW<uint8_t> sessionInfo, bool obfuscate) ;

/// @brief Method UnpadSessionData addr 0x1033e84 size 0x138 virtual false final false
