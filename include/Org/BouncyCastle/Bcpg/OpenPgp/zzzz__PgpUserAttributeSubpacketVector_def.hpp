...
/// @brief Method .ctor addr 0x10500a0 size 0x28 virtual false final false
 void _ctor(::ArrayW<Org::BouncyCastle::Bcpg::UserAttributeSubpacket> packets) ;

/// @brief Method GetSubpacket addr 0x10500c8 size 0xa0 virtual false final false
 Org::BouncyCastle::Bcpg::UserAttributeSubpacket GetSubpacket(Org::BouncyCastle::Bcpg::UserAttributeSubpacketTag type) ;

/// @brief Method GetImageAttribute addr 0x1050168 size 0x80 virtual false final false
 Org::BouncyCastle::Bcpg::Attr::ImageAttrib GetImageAttribute() ;

/// @brief Method ToSubpacketArray addr 0x10501e8 size 0x8 virtual false final false
 ::ArrayW<Org::BouncyCastle::Bcpg::UserAttributeSubpacket> ToSubpacketArray() ;

/// @brief Method Equals addr 0x10501f0 size 0x124 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x1050314 size 0x78 virtual true final false
 int32_t GetHashCode() ;
