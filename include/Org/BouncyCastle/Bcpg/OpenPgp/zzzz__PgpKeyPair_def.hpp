...
/// @brief Method .ctor addr 0x102f42c size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0x102f44c size 0xd4 virtual false final false
...
/// @brief Method .ctor addr 0x102fabc size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey pub, Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey priv) ;

/// @brief Method get_KeyId addr 0x102fae8 size 0x1c virtual false final false
 int64_t get_KeyId() ;

/// @brief Method get_PublicKey addr 0x102fb04 size 0x8 virtual false final false
 Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey get_PublicKey() ;

/// @brief Method get_PrivateKey addr 0x102fb0c size 0x8 virtual false final false
