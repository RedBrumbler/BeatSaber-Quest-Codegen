...
/// @brief Method .ctor addr 0x102d230 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x102bcbc size 0x3c virtual false final false
...
/// @brief Method GetKey addr 0x102d238 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::Parameters::KeyParameter GetKey() ;

/// @brief Method AddSessionInfo addr 0x102d240 size 0x2a0 virtual true final false
 void AddSessionInfo(::ArrayW<uint8_t> si, Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method Encode addr 0x102d4e0 size 0x98 virtual true final false
...
/// @brief Method .ctor addr 0x102bea0 size 0x30 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey pubKey, bool sessionKeyObfuscation) ;

/// @brief Method AddSessionInfo addr 0x102d578 size 0x24 virtual true final false
 void AddSessionInfo(::ArrayW<uint8_t> sessionInfo, Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method EncryptSessionInfo addr 0x102d59c size 0x94c virtual false final false
 ::ArrayW<uint8_t> EncryptSessionInfo(::ArrayW<uint8_t> sessionInfo, Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method ProcessSessionInfo addr 0x102dee8 size 0x294 virtual false final false
 ::ArrayW<::ArrayW<uint8_t>> ProcessSessionInfo(::ArrayW<uint8_t> encryptedSessionInfo) ;

/// @brief Method ConvertToEncodedMpi addr 0x102e830 size 0x1a0 virtual false final false
 ::ArrayW<uint8_t> ConvertToEncodedMpi(::ArrayW<uint8_t> encryptedSessionInfo) ;

/// @brief Method Encode addr 0x102e9d0 size 0xb0 virtual true final false
 void Encode(Org::BouncyCastle::Bcpg::BcpgOutputStream pOut) ;
...
/// @brief Method .ctor addr 0x102b7d0 size 0xac virtual false final false
...
/// @brief Method .ctor addr 0x102b87c size 0xb4 virtual false final false
...
/// @brief Method .ctor addr 0x102b930 size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x102b9b0 size 0x90 virtual false final false
...
/// @brief Method .ctor addr 0x102ba40 size 0x90 virtual false final false
...
/// @brief Method AddMethod addr 0x102bad0 size 0x30 virtual false final false
 void AddMethod(::ArrayW<char16_t> passPhrase) ;

/// @brief Method AddMethod addr 0x102bb00 size 0x3c virtual false final false
 void AddMethod(::ArrayW<char16_t> passPhrase, Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest) ;

/// @brief Method AddMethodUtf8 addr 0x102bc70 size 0x40 virtual false final false
 void AddMethodUtf8(::ArrayW<char16_t> passPhrase, Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest) ;

/// @brief Method AddMethodRaw addr 0x102bcb0 size 0xc virtual false final false
 void AddMethodRaw(::ArrayW<uint8_t> rawPassPhrase, Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest) ;

/// @brief Method DoAddMethod addr 0x102bb3c size 0x134 virtual false final false
 void DoAddMethod(::ArrayW<uint8_t> rawPassPhrase, bool clearPassPhrase, Org::BouncyCastle::Bcpg::HashAlgorithmTag s2kDigest) ;

/// @brief Method AddMethod addr 0x102bcf8 size 0x8 virtual false final false
 void AddMethod(Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey key) ;

/// @brief Method AddMethod addr 0x102bd00 size 0x14c virtual false final false
 void AddMethod(Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey key, bool sessionKeyObfuscation) ;

/// @brief Method AddCheckSum addr 0x102bed0 size 0x90 virtual false final false
 void AddCheckSum(::ArrayW<uint8_t> sessionInfo) ;

/// @brief Method CreateSessionInfo addr 0x102bf60 size 0xa8 virtual false final false
...
/// @brief Method Open addr 0x102c008 size 0xf50 virtual false final false
 System::IO::Stream Open(System::IO::Stream outStr, int64_t length, ::ArrayW<uint8_t> buffer) ;

/// @brief Method Open addr 0x102cf58 size 0x8 virtual false final false
 System::IO::Stream Open(System::IO::Stream outStr, int64_t length) ;

/// @brief Method Open addr 0x102cf60 size 0xc virtual false final false
 System::IO::Stream Open(System::IO::Stream outStr, ::ArrayW<uint8_t> buffer) ;

/// @brief Method Close addr 0x102cf6c size 0x2c4 virtual true final true
 void Close() ;
