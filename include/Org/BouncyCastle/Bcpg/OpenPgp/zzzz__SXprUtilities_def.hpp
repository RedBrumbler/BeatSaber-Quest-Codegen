...
/// @brief Method .ctor addr 0x1052924 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::HashAlgorithmTag algorithm, ::ArrayW<uint8_t> iv, int64_t iterationCount64) ;

/// @brief Method get_IterationCount addr 0x105294c size 0x8 virtual true final false
...
/// @brief Method .ctor addr 0x10528a8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method ReadLength addr 0x10528b0 size 0x74 virtual false final false
static int32_t ReadLength(System::IO::Stream input, int32_t ch) ;

/// @brief Method ReadString addr 0x1045a0c size 0xc8 virtual false final false
static ::StringW ReadString(System::IO::Stream input, int32_t ch) ;

/// @brief Method ReadBytes addr 0x1045b4c size 0x80 virtual false final false
static ::ArrayW<uint8_t> ReadBytes(System::IO::Stream input, int32_t ch) ;

/// @brief Method ParseS2k addr 0x1046340 size 0xfc virtual false final false
static Org::BouncyCastle::Bcpg::S2k ParseS2k(System::IO::Stream input) ;

/// @brief Method SkipOpenParenthesis addr 0x1045994 size 0x78 virtual false final false
static void SkipOpenParenthesis(System::IO::Stream input) ;

/// @brief Method SkipCloseParenthesis addr 0x1045ad4 size 0x78 virtual false final false
