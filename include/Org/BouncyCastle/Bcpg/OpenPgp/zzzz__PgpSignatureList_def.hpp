...
/// @brief Method .ctor addr 0x104dd98 size 0xb8 virtual false final false
...
/// @brief Method .ctor addr 0x104de50 size 0xa8 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::OpenPgp::PgpSignature sig) ;

/// @brief Method get_Item addr 0x104def8 size 0x30 virtual false final false
 Org::BouncyCastle::Bcpg::OpenPgp::PgpSignature get_Item(int32_t index) ;

/// @brief Method Get addr 0x104df28 size 0x4 virtual false final false
 Org::BouncyCastle::Bcpg::OpenPgp::PgpSignature Get(int32_t index) ;

/// @brief Method get_Size addr 0x104df2c size 0x1c virtual false final false
 int32_t get_Size() ;

/// @brief Method get_Count addr 0x104df48 size 0x1c virtual false final false
 int32_t get_Count() ;

/// @brief Method get_IsEmpty addr 0x104df64 size 0x24 virtual false final false
 bool get_IsEmpty() ;
