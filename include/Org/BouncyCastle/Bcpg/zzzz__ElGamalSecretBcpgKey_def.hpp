...
/// @brief Method .ctor addr 0x1154604 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x115467c size 0x78 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method get_Format addr 0x11546f4 size 0x40 virtual true final true
 ::StringW get_Format() ;

/// @brief Method get_X addr 0x1154734 size 0x1c virtual false final false
 Org::BouncyCastle::Math::BigInteger get_X() ;

/// @brief Method GetEncoded addr 0x1154750 size 0x84 virtual true final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method Encode addr 0x11547d4 size 0x24 virtual true final false
