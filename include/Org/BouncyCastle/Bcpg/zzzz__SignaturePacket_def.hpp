...
/// @brief Method .ctor addr 0x1150260 size 0xd7c virtual false final false
...
/// @brief Method .ctor addr 0x1156b60 size 0x40 virtual false final false
...
/// @brief Method .ctor addr 0x1156c38 size 0x6c virtual false final false
...
/// @brief Method .ctor addr 0x1156ba0 size 0x98 virtual false final false
...
/// @brief Method get_Version addr 0x1156d9c size 0x8 virtual false final false
 int32_t get_Version() ;

/// @brief Method get_SignatureType addr 0x1156da4 size 0x8 virtual false final false
 int32_t get_SignatureType() ;

/// @brief Method get_KeyId addr 0x1156dac size 0x8 virtual false final false
 int64_t get_KeyId() ;

/// @brief Method GetSignatureTrailer addr 0x1156db4 size 0x2fc virtual false final false
 ::ArrayW<uint8_t> GetSignatureTrailer() ;

/// @brief Method get_KeyAlgorithm addr 0x11570b0 size 0x8 virtual false final false
 Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_KeyAlgorithm() ;

/// @brief Method get_HashAlgorithm addr 0x11570b8 size 0x8 virtual false final false
 Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm() ;

/// @brief Method GetSignature addr 0x11570c0 size 0x8 virtual false final false
 ::ArrayW<Org::BouncyCastle::Bcpg::MPInteger> GetSignature() ;

/// @brief Method GetSignatureBytes addr 0x11570c8 size 0x21c virtual false final false
 ::ArrayW<uint8_t> GetSignatureBytes() ;

/// @brief Method GetHashedSubPackets addr 0x11572e4 size 0x8 virtual false final false
 ::ArrayW<Org::BouncyCastle::Bcpg::SignatureSubpacket> GetHashedSubPackets() ;

/// @brief Method GetUnhashedSubPackets addr 0x11572ec size 0x8 virtual false final false
 ::ArrayW<Org::BouncyCastle::Bcpg::SignatureSubpacket> GetUnhashedSubPackets() ;

/// @brief Method get_CreationTime addr 0x11572f4 size 0x8 virtual false final false
 int64_t get_CreationTime() ;

/// @brief Method Encode addr 0x11572fc size 0x32c virtual true final false
 void Encode(Org::BouncyCastle::Bcpg::BcpgOutputStream bcpgOut) ;

/// @brief Method EncodeLengthAndData addr 0x11576d8 size 0x54 virtual false final false
static void EncodeLengthAndData(Org::BouncyCastle::Bcpg::BcpgOutputStream pOut, ::ArrayW<uint8_t> data) ;

/// @brief Method GetEncodedSubpackets addr 0x1157628 size 0xb0 virtual false final false
static ::ArrayW<uint8_t> GetEncodedSubpackets(::ArrayW<Org::BouncyCastle::Bcpg::SignatureSubpacket> ps) ;

/// @brief Method setCreationTime addr 0x1156ca4 size 0xf8 virtual false final false
