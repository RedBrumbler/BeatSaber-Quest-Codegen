...
/// @brief Method .ctor addr 0x11517b0 size 0x1bc virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::BcpgInputStream bcpgIn) ;

/// @brief Method get_Format addr 0x11548a0 size 0x8 virtual false final false
 int32_t get_Format() ;

/// @brief Method get_ModificationTime addr 0x11548a8 size 0x8 virtual false final false
 int64_t get_ModificationTime() ;

/// @brief Method get_FileName addr 0x11548b0 size 0xc virtual false final false
 ::StringW get_FileName() ;

/// @brief Method GetRawFileName addr 0x11548bc size 0x5c virtual false final false
