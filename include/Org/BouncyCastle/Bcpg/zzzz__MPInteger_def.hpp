...
/// @brief Method .ctor addr 0x11531c4 size 0x140 virtual false final false
...
/// @brief Method .ctor addr 0x11533e4 size 0xcc virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger val) ;

/// @brief Method get_Value addr 0x1154ae0 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_Value() ;

/// @brief Method Encode addr 0x1154ae8 size 0x70 virtual true final false
 void Encode(Org::BouncyCastle::Bcpg::BcpgOutputStream bcpgOut) ;

/// @brief Method Encode addr 0x1154b58 size 0x6c virtual false final false
