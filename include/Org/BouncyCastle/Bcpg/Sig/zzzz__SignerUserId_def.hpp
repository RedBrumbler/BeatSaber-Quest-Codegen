...
/// @brief Method UserIdToBytes addr 0x114bbec size 0xa4 virtual false final false
...
/// @brief Method .ctor addr 0x114bc90 size 0x48 virtual false final false
...
/// @brief Method .ctor addr 0x114bcd8 size 0x4c virtual false final false
 void _ctor(bool critical, ::StringW userId) ;

/// @brief Method GetId addr 0x114bd24 size 0xb4 virtual false final false
 ::StringW GetId() ;
