...
/// @brief Method .ctor addr 0x114ab04 size 0x48 virtual false final false
...
/// @brief Method .ctor addr 0x114ab4c size 0x54 virtual false final false
 void _ctor(bool critical, bool humanReadable, ::StringW notationName, ::StringW notationValue) ;

/// @brief Method CreateData addr 0x114aba0 size 0x220 virtual false final false
static ::ArrayW<uint8_t> CreateData(bool humanReadable, ::StringW notationName, ::StringW notationValue) ;

/// @brief Method get_IsHumanReadable addr 0x114adc0 size 0x30 virtual false final false
 bool get_IsHumanReadable() ;

/// @brief Method GetNotationName addr 0x114adf0 size 0x6c virtual false final false
 ::StringW GetNotationName() ;

/// @brief Method GetNotationValue addr 0x114ae5c size 0x90 virtual false final false
 ::StringW GetNotationValue() ;

/// @brief Method GetNotationValueBytes addr 0x114aeec size 0xc4 virtual false final false
