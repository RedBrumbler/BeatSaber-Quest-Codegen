...
/// @brief Method FeatureToByteArray addr 0x114a1a4 size 0x64 virtual false final false
...
/// @brief Method .ctor addr 0x114a208 size 0x48 virtual false final false
...
/// @brief Method .ctor addr 0x114a250 size 0x90 virtual false final false
 void _ctor(bool critical, uint8_t feature) ;

/// @brief Method get_SupportsModificationDetection addr 0x114a2e0 size 0x60 virtual false final false
 bool get_SupportsModificationDetection() ;

/// @brief Method SupportsFeature addr 0x114a340 size 0x78 virtual false final false
 bool SupportsFeature(uint8_t feature) ;

/// @brief Method SetSupportsFeature addr 0x114a3b8 size 0x1b4 virtual false final false
