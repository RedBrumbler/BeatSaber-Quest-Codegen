...
/// @brief Method .ctor addr 0x11564e8 size 0x28 virtual false final false
 void _ctor(System::IO::Stream input) ;

/// @brief Method ReadPacket addr 0x1156510 size 0x650 virtual false final false
 Org::BouncyCastle::Bcpg::SignatureSubpacket ReadPacket() ;

/// @brief Method CheckData addr 0x115772c size 0xf0 virtual false final false
