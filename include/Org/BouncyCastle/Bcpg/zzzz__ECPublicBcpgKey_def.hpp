...
/// @brief Method .ctor addr 0x1153904 size 0xc8 virtual false final false
...
/// @brief Method .ctor addr 0x1153b2c size 0xa8 virtual false final false
...
/// @brief Method .ctor addr 0x1153bd4 size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::DerObjectIdentifier oid, Org::BouncyCastle::Math::BigInteger encodedPoint) ;

/// @brief Method get_Format addr 0x1153c00 size 0x40 virtual true final true
 ::StringW get_Format() ;

/// @brief Method GetEncoded addr 0x1153c40 size 0x84 virtual true final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method Encode addr 0x1153cc4 size 0xb0 virtual true final false
 void Encode(Org::BouncyCastle::Bcpg::BcpgOutputStream bcpgOut) ;

/// @brief Method get_EncodedPoint addr 0x1153d74 size 0x8 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_EncodedPoint() ;

/// @brief Method get_CurveOid addr 0x1153d7c size 0x8 virtual true final false
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_CurveOid() ;

/// @brief Method ReadBytesOfEncodedLength addr 0x11539cc size 0x160 virtual false final false
