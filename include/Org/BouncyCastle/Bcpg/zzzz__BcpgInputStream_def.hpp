...
/// @brief Method .ctor addr 0x114fe94 size 0x40 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::BcpgInputStream bcpgIn, bool partial, int32_t dataLength) ;

/// @brief Method ReadByte addr 0x1151f58 size 0xac virtual true final false
 int32_t ReadByte() ;

/// @brief Method Read addr 0x1152134 size 0xe0 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method ReadPartialDataLength addr 0x1152004 size 0x130 virtual false final false
...
/// @brief Method Wrap addr 0x114f494 size 0x98 virtual false final false
...
/// @brief Method .ctor addr 0x114f52c size 0x2c virtual false final false
 void _ctor(System::IO::Stream inputStream) ;

/// @brief Method ReadByte addr 0x114f558 size 0x40 virtual true final false
 int32_t ReadByte() ;

/// @brief Method Read addr 0x114f598 size 0xb4 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method ReadAll addr 0x114f64c size 0x8 virtual false final false
 ::ArrayW<uint8_t> ReadAll() ;

/// @brief Method ReadFully addr 0x114f654 size 0x5c virtual false final false
 void ReadFully(::ArrayW<uint8_t> buffer, int32_t off, int32_t len) ;

/// @brief Method ReadFully addr 0x114f6b0 size 0x1c virtual false final false
 void ReadFully(::ArrayW<uint8_t> buffer) ;

/// @brief Method NextPacketTag addr 0x114f6cc size 0xe0 virtual false final false
 Org::BouncyCastle::Bcpg::PacketTag NextPacketTag() ;

/// @brief Method ReadPacket addr 0x114f7ac size 0x6e8 virtual false final false
 Org::BouncyCastle::Bcpg::Packet ReadPacket() ;

/// @brief Method Close addr 0x1151ef0 size 0x68 virtual true final false
 void Close() ;
