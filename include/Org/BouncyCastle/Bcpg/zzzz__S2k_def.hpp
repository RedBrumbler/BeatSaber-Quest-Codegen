...
/// @brief Method .ctor addr 0x1155d58 size 0x198 virtual false final false
...
/// @brief Method .ctor addr 0x1155ef0 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x1155f20 size 0x3c virtual false final false
...
/// @brief Method .ctor addr 0x1155f5c size 0x4c virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::HashAlgorithmTag algorithm, ::ArrayW<uint8_t> iv, int32_t itCount) ;

/// @brief Method get_Type addr 0x1155fa8 size 0x8 virtual true final false
 int32_t get_Type() ;

/// @brief Method get_HashAlgorithm addr 0x1155fb0 size 0x8 virtual true final false
 Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm() ;

/// @brief Method GetIV addr 0x1155fb8 size 0x5c virtual true final false
 ::ArrayW<uint8_t> GetIV() ;

/// @brief Method GetIterationCount addr 0x1156014 size 0xc virtual false final false
 int64_t GetIterationCount() ;

/// @brief Method get_IterationCount addr 0x1156020 size 0x20 virtual true final false
 int64_t get_IterationCount() ;

/// @brief Method get_ProtectionMode addr 0x1156040 size 0x8 virtual true final false
 int32_t get_ProtectionMode() ;

/// @brief Method Encode addr 0x1156048 size 0xfc virtual true final false
