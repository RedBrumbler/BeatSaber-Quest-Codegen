...
/// @brief Method .ctor addr 0x114c3d4 size 0x14 virtual false final false
 void _ctor() ;

/// @brief Method Update addr 0x114d0a8 size 0x38 virtual false final false
 void Update(int32_t b) ;

/// @brief Method GetValue addr 0x11530e8 size 0x8 virtual false final false
 int32_t GetValue() ;

/// @brief Method get_Value addr 0x11530f0 size 0x8 virtual false final false
 int32_t get_Value() ;

/// @brief Method Reset addr 0x114d098 size 0x10 virtual false final false
 void Reset() ;
