...
/// @brief Method .ctor addr 0x1151a48 size 0x3c virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::BcpgInputStream bcpgIn) ;

// Ctor Parameters [CppParam { name: "id", ty: "::StringW", modifiers: "", def_value: None }]
explicit UserIdPacket(::StringW id) ;

/// @brief Method .ctor addr 0x1157eec size 0x4c virtual false final false
 void _ctor(::StringW id) ;

/// @brief Method GetId addr 0x1157f38 size 0x3c virtual false final false
 ::StringW GetId() ;

/// @brief Method Encode addr 0x1157f74 size 0x28 virtual true final false
