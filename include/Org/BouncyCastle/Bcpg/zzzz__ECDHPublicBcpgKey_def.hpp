...
/// @brief Method .ctor addr 0x1153d84 size 0x128 virtual false final false
...
/// @brief Method .ctor addr 0x1153f7c size 0x3c virtual false final false
...
/// @brief Method get_Reserved addr 0x1153fb8 size 0x8 virtual true final false
 uint8_t get_Reserved() ;

/// @brief Method get_HashAlgorithm addr 0x1153fc0 size 0x8 virtual true final false
 Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm() ;

/// @brief Method get_SymmetricKeyAlgorithm addr 0x1153fc8 size 0x8 virtual true final false
 Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag get_SymmetricKeyAlgorithm() ;

/// @brief Method Encode addr 0x1153fd0 size 0x84 virtual true final false
 void Encode(Org::BouncyCastle::Bcpg::BcpgOutputStream bcpgOut) ;

/// @brief Method VerifyHashAlgorithm addr 0x1153eac size 0x68 virtual false final false
 void VerifyHashAlgorithm() ;

/// @brief Method VerifySymmetricKeyAlgorithm addr 0x1153f14 size 0x68 virtual false final false
