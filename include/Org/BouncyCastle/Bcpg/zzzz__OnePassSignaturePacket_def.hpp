...
/// @brief Method .ctor addr 0x1151090 size 0x198 virtual false final false
...
/// @brief Method .ctor addr 0x1154bc4 size 0x68 virtual false final false
...
/// @brief Method get_SignatureType addr 0x1154c2c size 0x8 virtual false final false
 int32_t get_SignatureType() ;

/// @brief Method get_KeyAlgorithm addr 0x1154c34 size 0x8 virtual false final false
 Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_KeyAlgorithm() ;

/// @brief Method get_HashAlgorithm addr 0x1154c3c size 0x8 virtual false final false
 Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm() ;

/// @brief Method get_KeyId addr 0x1154c44 size 0x8 virtual false final false
 int64_t get_KeyId() ;

/// @brief Method Encode addr 0x1154c4c size 0x16c virtual true final false
