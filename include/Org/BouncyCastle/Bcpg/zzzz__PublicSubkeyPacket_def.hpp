...
/// @brief Method .ctor addr 0x1151da8 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x1155478 size 0x4 virtual false final false
 void _ctor(Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag algorithm, System::DateTime time, Org::BouncyCastle::Bcpg::IBcpgKey key) ;

/// @brief Method Encode addr 0x115547c size 0x38 virtual true final false
