...
/// @brief Method Encode addr 0x114d314 size 0x2f4 virtual false final false
...
/// @brief Method .ctor addr 0x114d608 size 0x12c virtual false final false
...
/// @brief Method .ctor addr 0x114d9e8 size 0x548 virtual false final false
 void _ctor(System::IO::Stream outStream, System::Collections::IDictionary headers) ;

/// @brief Method SetHeader addr 0x114d734 size 0x2b4 virtual false final false
 void SetHeader(::StringW name, ::StringW val) ;

/// @brief Method AddHeader addr 0x114df30 size 0x218 virtual false final false
 void AddHeader(::StringW name, ::StringW val) ;

/// @brief Method ResetHeaders addr 0x114e148 size 0x228 virtual false final false
 void ResetHeaders() ;

/// @brief Method BeginClearText addr 0x114e370 size 0x1dc virtual false final false
 void BeginClearText(Org::BouncyCastle::Bcpg::HashAlgorithmTag hashAlgorithm) ;

/// @brief Method EndClearText addr 0x114e590 size 0x8 virtual false final false
 void EndClearText() ;

/// @brief Method WriteByte addr 0x114e598 size 0xacc virtual true final false
 void WriteByte(uint8_t b) ;

/// @brief Method Close addr 0x114f100 size 0x38 virtual true final false
 void Close() ;

/// @brief Method DoClose addr 0x114f138 size 0x1ac virtual false final false
 void DoClose() ;

/// @brief Method WriteHeaderEntry addr 0x114f064 size 0x9c virtual false final false
 void WriteHeaderEntry(::StringW name, ::StringW v) ;

/// @brief Method DoWrite addr 0x114e54c size 0x44 virtual false final false
