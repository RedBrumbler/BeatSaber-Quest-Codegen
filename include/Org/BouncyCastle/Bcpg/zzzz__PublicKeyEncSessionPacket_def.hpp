...
explicit PublicKeyEncSessionPacket(Org::BouncyCastle::Bcpg::BcpgInputStream bcpgIn) ;

/// @brief Method .ctor addr 0x114fefc size 0x364 virtual false final false
...
explicit PublicKeyEncSessionPacket(int64_t keyId, Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag algorithm, ::ArrayW<::ArrayW<uint8_t>> data) ;

/// @brief Method .ctor addr 0x1154e30 size 0x144 virtual false final false
 void _ctor(int64_t keyId, Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag algorithm, ::ArrayW<::ArrayW<uint8_t>> data) ;

/// @brief Method get_Version addr 0x1154f74 size 0x8 virtual false final false
 int32_t get_Version() ;

/// @brief Method get_KeyId addr 0x1154f7c size 0x8 virtual false final false
 int64_t get_KeyId() ;

/// @brief Method get_Algorithm addr 0x1154f84 size 0x8 virtual false final false
 Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_Algorithm() ;

/// @brief Method GetEncSessionKey addr 0x1154f8c size 0x8 virtual false final false
 ::ArrayW<::ArrayW<uint8_t>> GetEncSessionKey() ;

/// @brief Method Encode addr 0x1154f94 size 0x188 virtual true final false
