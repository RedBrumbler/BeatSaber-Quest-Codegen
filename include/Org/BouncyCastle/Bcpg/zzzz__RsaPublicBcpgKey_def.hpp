...
/// @brief Method .ctor addr 0x115511c size 0x94 virtual false final false
...
/// @brief Method .ctor addr 0x11554b4 size 0x98 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger n, Org::BouncyCastle::Math::BigInteger e) ;

/// @brief Method get_PublicExponent addr 0x115554c size 0x1c virtual false final false
 Org::BouncyCastle::Math::BigInteger get_PublicExponent() ;

/// @brief Method get_Modulus addr 0x1155568 size 0x1c virtual false final false
 Org::BouncyCastle::Math::BigInteger get_Modulus() ;

/// @brief Method get_Format addr 0x1155584 size 0x40 virtual true final true
 ::StringW get_Format() ;

/// @brief Method GetEncoded addr 0x11555c4 size 0x84 virtual true final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method Encode addr 0x1155648 size 0xd4 virtual true final false
