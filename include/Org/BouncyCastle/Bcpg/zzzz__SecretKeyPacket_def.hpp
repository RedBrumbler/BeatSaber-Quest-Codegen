...
/// @brief Method .ctor addr 0x1151228 size 0x1e0 virtual false final false
...
/// @brief Method .ctor addr 0x1156144 size 0xb4 virtual false final false
...
/// @brief Method .ctor addr 0x11561f8 size 0xac virtual false final false
...
/// @brief Method get_EncAlgorithm addr 0x11562a4 size 0x8 virtual false final false
 Org::BouncyCastle::Bcpg::SymmetricKeyAlgorithmTag get_EncAlgorithm() ;

/// @brief Method get_S2kUsage addr 0x11562ac size 0x8 virtual false final false
 int32_t get_S2kUsage() ;

/// @brief Method GetIV addr 0x11562b4 size 0x5c virtual false final false
 ::ArrayW<uint8_t> GetIV() ;

/// @brief Method get_S2k addr 0x1156310 size 0x8 virtual false final false
 Org::BouncyCastle::Bcpg::S2k get_S2k() ;

/// @brief Method get_PublicKeyPacket addr 0x1156318 size 0x8 virtual false final false
 Org::BouncyCastle::Bcpg::PublicKeyPacket get_PublicKeyPacket() ;

/// @brief Method GetSecretKeyData addr 0x1156320 size 0x8 virtual false final false
 ::ArrayW<uint8_t> GetSecretKeyData() ;

/// @brief Method GetEncodedContents addr 0x1156328 size 0x160 virtual false final false
 ::ArrayW<uint8_t> GetEncodedContents() ;

/// @brief Method Encode addr 0x1156488 size 0x2c virtual true final false
