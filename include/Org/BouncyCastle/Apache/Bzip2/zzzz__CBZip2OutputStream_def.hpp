...
/// @brief Method .ctor addr 0x102a700 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Panic addr 0x10278b0 size 0x4 virtual false final false
static void Panic() ;

/// @brief Method MakeMaps addr 0x10278b4 size 0x8c virtual false final false
 void MakeMaps() ;

/// @brief Method HbMakeCodeLengths addr 0x1027940 size 0x62c virtual false final false
...
/// @brief Method .ctor addr 0x1027810 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x1027f6c size 0x20c virtual false final false
 void _ctor(System::IO::Stream inStream, int32_t inBlockSize) ;

/// @brief Method WriteByte addr 0x1028318 size 0x7c virtual true final false
 void WriteByte(uint8_t bv) ;

/// @brief Method WriteRun addr 0x1028394 size 0x23c virtual false final false
 void WriteRun() ;

/// @brief Method Close addr 0x10286b0 size 0x8c virtual true final false
 void Close() ;

/// @brief Method Finish addr 0x102781c size 0x64 virtual false final false
 void Finish() ;

/// @brief Method Flush addr 0x10287b8 size 0x24 virtual true final false
 void Flush() ;

/// @brief Method Initialize addr 0x1028268 size 0x3c virtual false final false
 void Initialize() ;

/// @brief Method InitBlock addr 0x10282a4 size 0x74 virtual false final false
 void InitBlock() ;

/// @brief Method EndBlock addr 0x10285d0 size 0xe0 virtual false final false
 void EndBlock() ;

/// @brief Method EndCompression addr 0x102873c size 0x7c virtual false final false
 void EndCompression() ;

/// @brief Method HbAssignCodes addr 0x1028b14 size 0x88 virtual false final false
 void HbAssignCodes(::ArrayW<int32_t> code, ::ArrayW<char16_t> length, int32_t minLen, int32_t maxLen, int32_t alphaSize) ;

/// @brief Method BsSetStream addr 0x1028178 size 0x10 virtual false final false
 void BsSetStream(System::IO::Stream f) ;

/// @brief Method BsFinishedWithStream addr 0x1028a28 size 0xec virtual false final false
 void BsFinishedWithStream() ;

/// @brief Method BsW addr 0x10288f0 size 0x110 virtual false final false
 void BsW(int32_t n, int32_t v) ;

/// @brief Method BsPutUChar addr 0x10287dc size 0xc virtual false final false
 void BsPutUChar(int32_t c) ;

/// @brief Method BsPutint addr 0x102889c size 0x54 virtual false final false
 void BsPutint(int32_t u) ;

/// @brief Method BsPutIntVS addr 0x1028b9c size 0x4 virtual false final false
 void BsPutIntVS(int32_t numBits, int32_t c) ;

/// @brief Method SendMTFValues addr 0x1028ba0 size 0xcb8 virtual false final false
 void SendMTFValues() ;

/// @brief Method MoveToFrontCodeAndSend addr 0x1028a00 size 0x28 virtual false final false
 void MoveToFrontCodeAndSend() ;

/// @brief Method SimpleSort addr 0x1029bfc size 0x314 virtual false final false
 void SimpleSort(int32_t lo, int32_t hi, int32_t d) ;

/// @brief Method Vswap addr 0x102a224 size 0x68 virtual false final false
 void Vswap(int32_t p1, int32_t p2, int32_t n) ;

/// @brief Method Med3 addr 0x102a28c size 0x2c virtual false final false
 char16_t Med3(char16_t a, char16_t b, char16_t c) ;

/// @brief Method QSort3 addr 0x102a2b8 size 0x448 virtual false final false
 void QSort3(int32_t loSt, int32_t hiSt, int32_t dSt) ;

/// @brief Method MainSort addr 0x102a708 size 0x7f8 virtual false final false
 void MainSort() ;

/// @brief Method RandomiseBlock addr 0x102af00 size 0x138 virtual false final false
 void RandomiseBlock() ;

/// @brief Method DoReversibleTransformation addr 0x10287e8 size 0xb4 virtual false final false
 void DoReversibleTransformation() ;

/// @brief Method FullGtU addr 0x1029f10 size 0x314 virtual false final false
 bool FullGtU(int32_t i1, int32_t i2) ;

/// @brief Method AllocateCompressStructures addr 0x1028188 size 0xe0 virtual false final false
 void AllocateCompressStructures() ;

/// @brief Method GenerateMTFValues addr 0x1029858 size 0x3a4 virtual false final false
 void GenerateMTFValues() ;

/// @brief Method Read addr 0x102b038 size 0x8 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Seek addr 0x102b040 size 0x8 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0x102b048 size 0x4 virtual true final false
 void SetLength(int64_t value) ;

/// @brief Method Write addr 0x102b04c size 0x88 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method get_CanRead addr 0x102b0d4 size 0x8 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanSeek addr 0x102b0dc size 0x8 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_CanWrite addr 0x102b0e4 size 0x8 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_Length addr 0x102b0ec size 0x8 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x102b0f4 size 0x8 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x102b0fc size 0x4 virtual true final false
