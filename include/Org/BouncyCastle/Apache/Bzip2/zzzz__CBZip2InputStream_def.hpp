...
/// @brief Method Cadvise addr 0x110a2c8 size 0x4 virtual false final false
static void Cadvise() ;

/// @brief Method CompressedStreamEOF addr 0x110a2cc size 0x4 virtual false final false
static void CompressedStreamEOF() ;

/// @brief Method MakeMaps addr 0x110a2d0 size 0x8c virtual false final false
 void MakeMaps() ;
...
/// @brief Method .ctor addr 0x110a35c size 0x1bc virtual false final false
 void _ctor(System::IO::Stream zStream) ;

/// @brief Method InitIntArray addr 0x110a538 size 0xec virtual false final false
static ::ArrayW<::ArrayW<int32_t>> InitIntArray(int32_t n1, int32_t n2) ;

/// @brief Method InitCharArray addr 0x110aa58 size 0xec virtual false final false
static ::ArrayW<::ArrayW<char16_t>> InitCharArray(int32_t n1, int32_t n2) ;

/// @brief Method ReadByte addr 0x110ab44 size 0x64 virtual true final false
 int32_t ReadByte() ;

/// @brief Method Initialize addr 0x110a630 size 0xec virtual false final false
 void Initialize() ;

/// @brief Method InitBlock addr 0x110a71c size 0x170 virtual false final false
 void InitBlock() ;

/// @brief Method EndBlock addr 0x110ba48 size 0x2c virtual false final false
 void EndBlock() ;

/// @brief Method Complete addr 0x110afe8 size 0x28 virtual false final false
 void Complete() ;

/// @brief Method BlockOverrun addr 0x110ba84 size 0x4 virtual false final false
static void BlockOverrun() ;

/// @brief Method BadBlockHeader addr 0x110b010 size 0x4 virtual false final false
static void BadBlockHeader() ;

/// @brief Method CrcError addr 0x110ba80 size 0x4 virtual false final false
static void CrcError() ;

/// @brief Method BsFinishedWithStream addr 0x110ae80 size 0xdc virtual false final false
 void BsFinishedWithStream() ;

/// @brief Method BsSetStream addr 0x110a624 size 0xc virtual false final false
 void BsSetStream(System::IO::Stream f) ;

/// @brief Method BsR addr 0x110b018 size 0x108 virtual false final false
 int32_t BsR(int32_t n) ;

/// @brief Method BsGetUChar addr 0x110ae6c size 0x14 virtual false final false
 char16_t BsGetUChar() ;

/// @brief Method BsGetint addr 0x110ba88 size 0x54 virtual false final false
 int32_t BsGetint() ;

/// @brief Method BsGetIntVS addr 0x110badc size 0x4 virtual false final false
 int32_t BsGetIntVS(int32_t numBits) ;

/// @brief Method BsGetInt32 addr 0x110b014 size 0x4 virtual false final false
 int32_t BsGetInt32() ;

/// @brief Method HbCreateDecodeTables addr 0x110bae0 size 0x20c virtual false final false
...
/// @brief Method RecvDecodingTables addr 0x110bcec size 0x4e0 virtual false final false
 void RecvDecodingTables() ;

/// @brief Method GetAndMoveToFrontDecode addr 0x110b120 size 0x91c virtual false final false
 void GetAndMoveToFrontDecode() ;

/// @brief Method SetupBlock addr 0x110a88c size 0x1cc virtual false final false
 void SetupBlock() ;

/// @brief Method SetupRandPartA addr 0x110c1cc size 0x14c virtual false final false
 void SetupRandPartA() ;

/// @brief Method SetupNoRandPartA addr 0x110c318 size 0xa8 virtual false final false
 void SetupNoRandPartA() ;

/// @brief Method SetupRandPartB addr 0x110aba8 size 0x154 virtual false final false
 void SetupRandPartB() ;

/// @brief Method SetupRandPartC addr 0x110acfc size 0x64 virtual false final false
 void SetupRandPartC() ;

/// @brief Method SetupNoRandPartB addr 0x110ad60 size 0xa8 virtual false final false
 void SetupNoRandPartB() ;

/// @brief Method SetupNoRandPartC addr 0x110ae08 size 0x64 virtual false final false
 void SetupNoRandPartC() ;

/// @brief Method SetDecompressStructureSizes addr 0x110af5c size 0x8c virtual false final false
 void SetDecompressStructureSizes(int32_t newSize100k) ;

/// @brief Method Flush addr 0x110c464 size 0x4 virtual true final false
 void Flush() ;

/// @brief Method Read addr 0x110c468 size 0xa4 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Seek addr 0x110c50c size 0x8 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0x110c514 size 0x4 virtual true final false
 void SetLength(int64_t value) ;

/// @brief Method Write addr 0x110c518 size 0x4 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method get_CanRead addr 0x110c51c size 0x8 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanSeek addr 0x110c524 size 0x8 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_CanWrite addr 0x110c52c size 0x8 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_Length addr 0x110c534 size 0x8 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x110c53c size 0x8 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x110c544 size 0x4 virtual true final false
