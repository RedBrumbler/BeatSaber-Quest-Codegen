...
/// @brief Method .ctor addr 0x110a518 size 0x20 virtual false final false
 void _ctor() ;

/// @brief Method InitialiseCRC addr 0x110ba3c size 0xc virtual false final false
 void InitialiseCRC() ;

/// @brief Method GetFinalCRC addr 0x110ba74 size 0xc virtual false final false
 int32_t GetFinalCRC() ;

/// @brief Method GetGlobalCRC addr 0x110c548 size 0x8 virtual false final false
 int32_t GetGlobalCRC() ;

/// @brief Method SetGlobalCRC addr 0x110c550 size 0x8 virtual false final false
 void SetGlobalCRC(int32_t newCrc) ;

/// @brief Method UpdateCRC addr 0x110c3c0 size 0xa4 virtual false final false
