...
/// @brief Method .ctor addr 0x1057bd4 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x1057bfc size 0x38 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::AsymmetricKeyParameter privKey, ::StringW algorithm) ;

/// @brief Method set_SecureRandom addr 0x1057c34 size 0x8 virtual false final false
 void set_SecureRandom(Org::BouncyCastle::Security::SecureRandom value) ;

/// @brief Method set_Password addr 0x1057c3c size 0x8 virtual false final false
 void set_Password(::ArrayW<char16_t> value) ;

/// @brief Method set_IterationCount addr 0x1057c44 size 0x8 virtual false final false
 void set_IterationCount(int32_t value) ;

/// @brief Method Generate addr 0x1057c4c size 0x270 virtual true final true
