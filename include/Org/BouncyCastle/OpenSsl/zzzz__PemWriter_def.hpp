...
/// @brief Method .ctor addr 0x10579d4 size 0x4 virtual false final false
 void _ctor(System::IO::TextWriter writer) ;

/// @brief Method WriteObject addr 0x10579d8 size 0x170 virtual false final false
 void WriteObject(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method WriteObject addr 0x1057b48 size 0x8c virtual false final false
