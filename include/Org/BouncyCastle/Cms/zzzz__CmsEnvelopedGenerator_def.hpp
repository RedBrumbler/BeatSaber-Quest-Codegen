...
/// @brief Method .ctor addr 0x115b2d4 size 0x64 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x115b338 size 0x7c virtual false final false
 void _ctor(Org::BouncyCastle::Security::SecureRandom rand) ;

/// @brief Method get_UnprotectedAttributeGenerator addr 0x115b3b4 size 0x8 virtual false final false
 Org::BouncyCastle::Cms::CmsAttributeTableGenerator get_UnprotectedAttributeGenerator() ;

/// @brief Method set_UnprotectedAttributeGenerator addr 0x115b3bc size 0x8 virtual false final false
 void set_UnprotectedAttributeGenerator(Org::BouncyCastle::Cms::CmsAttributeTableGenerator value) ;

/// @brief Method AddKeyTransRecipient addr 0x115b3c4 size 0xf0 virtual false final false
 void AddKeyTransRecipient(Org::BouncyCastle::X509::X509Certificate cert) ;

/// @brief Method AddKeyTransRecipient addr 0x115b4b4 size 0x128 virtual false final false
 void AddKeyTransRecipient(Org::BouncyCastle::Crypto::AsymmetricKeyParameter pubKey, ::ArrayW<uint8_t> subKeyId) ;

/// @brief Method AddKekRecipient addr 0x115b5dc size 0x94 virtual false final false
...
/// @brief Method AddKekRecipient addr 0x115b670 size 0x104 virtual false final false
...
/// @brief Method AddPasswordRecipient addr 0x115b774 size 0x1c0 virtual false final false
 void AddPasswordRecipient(Org::BouncyCastle::Cms::CmsPbeKey pbeKey, ::StringW kekAlgorithmOid) ;

/// @brief Method AddKeyAgreementRecipient addr 0x115b934 size 0x120 virtual false final false
...
/// @brief Method AddKeyAgreementRecipients addr 0x115ba54 size 0x248 virtual false final false
...
/// @brief Method AddRecipientInfoGenerator addr 0x115bc9c size 0xac virtual false final false
 void AddRecipientInfoGenerator(Org::BouncyCastle::Cms::RecipientInfoGenerator recipientInfoGenerator) ;

/// @brief Method GetAlgorithmIdentifier addr 0x115bd48 size 0x144 virtual true final false
...
/// @brief Method GenerateAsn1Parameters addr 0x115be8c size 0x238 virtual true final false
