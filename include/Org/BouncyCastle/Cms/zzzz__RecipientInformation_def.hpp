...
/// @brief Method .ctor addr 0x1183c84 size 0x88 virtual false final false
...
/// @brief Method GetContentAlgorithmName addr 0x1183d1c size 0xbc virtual false final false
 ::StringW GetContentAlgorithmName() ;

/// @brief Method get_RecipientID addr 0x1183dd8 size 0x8 virtual false final false
 Org::BouncyCastle::Cms::RecipientID get_RecipientID() ;

/// @brief Method get_KeyEncryptionAlgorithmID addr 0x1183de0 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_KeyEncryptionAlgorithmID() ;

/// @brief Method get_KeyEncryptionAlgOid addr 0x1183de8 size 0x2c virtual false final false
 ::StringW get_KeyEncryptionAlgOid() ;

/// @brief Method get_KeyEncryptionAlgParams addr 0x1183e14 size 0x38 virtual false final false
 Org::BouncyCastle::Asn1::Asn1Object get_KeyEncryptionAlgParams() ;

/// @brief Method GetContentFromSessionKey addr 0x1183e4c size 0x22c virtual false final false
 Org::BouncyCastle::Cms::CmsTypedStream GetContentFromSessionKey(Org::BouncyCastle::Crypto::Parameters::KeyParameter sKey) ;

/// @brief Method GetContent addr 0x1184078 size 0x104 virtual false final false
 ::ArrayW<uint8_t> GetContent(Org::BouncyCastle::Crypto::ICipherParameters key) ;

/// @brief Method GetMac addr 0x118417c size 0x168 virtual false final false
