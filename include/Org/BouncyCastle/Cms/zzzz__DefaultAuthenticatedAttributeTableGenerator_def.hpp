...
/// @brief Method .ctor addr 0x1181eac size 0x68 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x1181f14 size 0x80 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Cms::AttributeTable attributeTable) ;

/// @brief Method CreateStandardAttributeTable addr 0x1181f94 size 0x528 virtual true final false
 System::Collections::IDictionary CreateStandardAttributeTable(System::Collections::IDictionary parameters) ;

/// @brief Method GetAttributes addr 0x11824bc size 0x8c virtual true final false
