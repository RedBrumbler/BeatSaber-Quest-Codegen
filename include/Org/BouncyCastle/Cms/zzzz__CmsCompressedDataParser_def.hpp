...
/// @brief Method .ctor addr 0x115fb4c size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x115fbc4 size 0x4 virtual false final false
 void _ctor(System::IO::Stream compressedData) ;

/// @brief Method GetContent addr 0x115fbc8 size 0x300 virtual false final false
