...
/// @brief Method .ctor addr 0x115ebe0 size 0x50 virtual false final false
...
/// @brief Method WriteByte addr 0x115edec size 0x24 virtual true final false
 void WriteByte(uint8_t b) ;

/// @brief Method Write addr 0x115ee10 size 0x24 virtual true final false
 void Write(::ArrayW<uint8_t> bytes, int32_t off, int32_t len) ;

/// @brief Method Close addr 0x115ee34 size 0x138 virtual true final false
 void Close() ;
...
/// @brief Method .ctor addr 0x115dd20 size 0x4 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x115dd24 size 0x4 virtual false final false
 void _ctor(Org::BouncyCastle::Security::SecureRandom rand) ;

/// @brief Method SetBufferSize addr 0x115dd28 size 0x8 virtual false final false
 void SetBufferSize(int32_t bufferSize) ;

/// @brief Method SetBerEncodeRecipients addr 0x115dd30 size 0xc virtual false final false
 void SetBerEncodeRecipients(bool berEncodeRecipientSet) ;

/// @brief Method Open addr 0x115dd3c size 0x5f8 virtual false final false
 System::IO::Stream Open(System::IO::Stream outStr, ::StringW macOid, Org::BouncyCastle::Crypto::CipherKeyGenerator keyGen) ;

/// @brief Method Open addr 0x115e334 size 0x8ac virtual false final false
...
/// @brief Method Open addr 0x115ec30 size 0xdc virtual false final false
 System::IO::Stream Open(System::IO::Stream outStr, ::StringW encryptionOid) ;

/// @brief Method Open addr 0x115ed0c size 0xe0 virtual false final false
