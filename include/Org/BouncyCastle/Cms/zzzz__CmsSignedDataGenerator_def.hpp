...
/// @brief Method .ctor addr 0x116cba8 size 0x14c virtual false final false
...
/// @brief Method .ctor addr 0x116c968 size 0x240 virtual false final false
...
/// @brief Method get_DigestAlgorithmID addr 0x116dbec size 0xd4 virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_DigestAlgorithmID() ;

/// @brief Method get_SignedAttributes addr 0x116f1a0 size 0x8 virtual false final false
 Org::BouncyCastle::Cms::CmsAttributeTableGenerator get_SignedAttributes() ;

/// @brief Method get_UnsignedAttributes addr 0x116f1a8 size 0x8 virtual false final false
 Org::BouncyCastle::Cms::CmsAttributeTableGenerator get_UnsignedAttributes() ;

/// @brief Method ToSignerInfo addr 0x116dcc0 size 0xb58 virtual false final false
...
/// @brief Method .ctor addr 0x116b6dc size 0x84 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x116b760 size 0x94 virtual false final false
 void _ctor(Org::BouncyCastle::Security::SecureRandom rand) ;

/// @brief Method AddSigner addr 0x116b7f4 size 0xa0 virtual false final false
...
/// @brief Method AddSigner addr 0x116bd74 size 0xd8 virtual false final false
...
/// @brief Method AddSigner addr 0x116bfe8 size 0xa0 virtual false final false
 void AddSigner(Org::BouncyCastle::Crypto::AsymmetricKeyParameter privateKey, ::ArrayW<uint8_t> subjectKeyID, ::StringW digestOID) ;

/// @brief Method AddSigner addr 0x116c088 size 0xd8 virtual false final false
...
/// @brief Method AddSigner addr 0x116c160 size 0xb8 virtual false final false
...
/// @brief Method AddSigner addr 0x116c218 size 0x11c virtual false final false
...
/// @brief Method AddSigner addr 0x116c3b4 size 0xb8 virtual false final false
...
/// @brief Method AddSigner addr 0x116c46c size 0x11c virtual false final false
...
/// @brief Method AddSigner addr 0x116c588 size 0xb8 virtual false final false
...
/// @brief Method AddSigner addr 0x116c640 size 0xb4 virtual false final false
...
/// @brief Method AddSigner addr 0x116c6f4 size 0xb8 virtual false final false
...
/// @brief Method AddSigner addr 0x116c7ac size 0xb4 virtual false final false
...
/// @brief Method AddSignerInfoGenerator addr 0x116c860 size 0x108 virtual false final false
 void AddSignerInfoGenerator(Org::BouncyCastle::Cms::SignerInfoGenerator signerInfoGenerator) ;

/// @brief Method doAddSigner addr 0x116beb4 size 0x134 virtual false final false
...
/// @brief Method Generate addr 0x116ccf4 size 0x8 virtual false final false
 Org::BouncyCastle::Cms::CmsSignedData Generate(Org::BouncyCastle::Cms::CmsProcessable content) ;

/// @brief Method Generate addr 0x116cd74 size 0xe78 virtual false final false
...
/// @brief Method Generate addr 0x116ccfc size 0x78 virtual false final false
 Org::BouncyCastle::Cms::CmsSignedData Generate(Org::BouncyCastle::Cms::CmsProcessable content, bool encapsulate) ;

/// @brief Method GenerateCounterSigners addr 0x116eba8 size 0x8c virtual false final false
