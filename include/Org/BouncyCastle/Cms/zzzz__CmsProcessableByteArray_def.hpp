...
/// @brief Method .ctor addr 0x1166c38 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x1166cb0 size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::DerObjectIdentifier type, ::ArrayW<uint8_t> bytes) ;

/// @brief Method get_Type addr 0x1166cdc size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_Type() ;

/// @brief Method GetInputStream addr 0x1166ce4 size 0x6c virtual true final false
 System::IO::Stream GetInputStream() ;

/// @brief Method Write addr 0x1166d50 size 0x38 virtual true final false
 void Write(System::IO::Stream zOut) ;

/// @brief Method GetContent addr 0x1166d88 size 0x1c virtual true final false
