...
/// @brief Method .ctor addr 0x115ae44 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "msg", ty: "::StringW", modifiers: "", def_value: None }]
explicit CmsException(::StringW msg) ;

/// @brief Method .ctor addr 0x115ae9c size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x115af04 size 0x70 virtual false final false
