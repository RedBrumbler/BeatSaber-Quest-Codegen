...
/// @brief Method .ctor addr 0x11605a8 size 0x54 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11605fc size 0x64 virtual false final false
 void _ctor(Org::BouncyCastle::Security::SecureRandom rand) ;

/// @brief Method Generate addr 0x1160660 size 0xbfc virtual false final false
...
/// @brief Method Generate addr 0x116125c size 0x1b4 virtual false final false
 Org::BouncyCastle::Cms::CmsEnvelopedData Generate(Org::BouncyCastle::Cms::CmsProcessable content, ::StringW encryptionOid) ;

/// @brief Method Generate addr 0x1161410 size 0xc80 virtual false final false
...
/// @brief Method Generate addr 0x1162090 size 0x1b0 virtual false final false
