...
/// @brief Method AddEntries addr 0x117f110 size 0x16c virtual false final false
static void AddEntries(Org::BouncyCastle::Asn1::DerObjectIdentifier oid, ::StringW digest, ::StringW encryption) ;

/// @brief Method GetDigestAlgName addr 0x116ed24 size 0x108 virtual false final false
 ::StringW GetDigestAlgName(::StringW digestAlgOid) ;

/// @brief Method GetEncAlgorithmIdentifier addr 0x116f3a0 size 0x13c virtual false final false
...
/// @brief Method GetDigestAliases addr 0x118102c size 0x14c virtual false final false
 ::ArrayW<::StringW> GetDigestAliases(::StringW algName) ;

/// @brief Method GetEncryptionAlgName addr 0x116ee2c size 0x108 virtual false final false
 ::StringW GetEncryptionAlgName(::StringW encryptionAlgOid) ;

/// @brief Method GetDigestInstance addr 0x116f1b0 size 0x1f0 virtual false final false
 Org::BouncyCastle::Crypto::IDigest GetDigestInstance(::StringW algorithm) ;

/// @brief Method GetSignatureInstance addr 0x1174530 size 0x58 virtual false final false
 Org::BouncyCastle::Crypto::ISigner GetSignatureInstance(::StringW algorithm) ;

/// @brief Method CreateAttributeStore addr 0x1167ec0 size 0x654 virtual false final false
 Org::BouncyCastle::X509::Store::IX509Store CreateAttributeStore(::StringW type, Org::BouncyCastle::Asn1::Asn1Set certSet) ;

/// @brief Method CreateCertificateStore addr 0x116859c size 0x1b0 virtual false final false
 Org::BouncyCastle::X509::Store::IX509Store CreateCertificateStore(::StringW type, Org::BouncyCastle::Asn1::Asn1Set certSet) ;

/// @brief Method CreateCrlStore addr 0x11687d4 size 0x1b0 virtual false final false
 Org::BouncyCastle::X509::Store::IX509Store CreateCrlStore(::StringW type, Org::BouncyCastle::Asn1::Asn1Set crlSet) ;

/// @brief Method AddCertsFromSet addr 0x1181178 size 0x4c8 virtual false final false
 void AddCertsFromSet(System::Collections::IList certs, Org::BouncyCastle::Asn1::Asn1Set certSet) ;

/// @brief Method AddCrlsFromSet addr 0x1181640 size 0x478 virtual false final false
 void AddCrlsFromSet(System::Collections::IList crls, Org::BouncyCastle::Asn1::Asn1Set crlSet) ;

/// @brief Method FixAlgID addr 0x11690e4 size 0xd0 virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier FixAlgID(Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier algId) ;

/// @brief Method GetEncOid addr 0x116b894 size 0x4e0 virtual false final false
 ::StringW GetEncOid(Org::BouncyCastle::Crypto::AsymmetricKeyParameter key, ::StringW digestOID) ;

// Ctor Parameters []
explicit CmsSignedHelper() ;

/// @brief Method .ctor addr 0x1181024 size 0x8 virtual false final false
 void _ctor() ;
