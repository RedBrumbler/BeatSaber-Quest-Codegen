...
/// @brief Method .ctor addr 0x1163a00 size 0x50 virtual false final false
...
/// @brief Method WriteByte addr 0x1163a50 size 0x24 virtual true final false
 void WriteByte(uint8_t b) ;

/// @brief Method Write addr 0x1163a74 size 0x24 virtual true final false
 void Write(::ArrayW<uint8_t> bytes, int32_t off, int32_t len) ;

/// @brief Method Close addr 0x1163a98 size 0x1e4 virtual true final false
 void Close() ;
...
/// @brief Method .ctor addr 0x1162870 size 0x58 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11628c8 size 0x68 virtual false final false
 void _ctor(Org::BouncyCastle::Security::SecureRandom rand) ;

/// @brief Method SetBufferSize addr 0x1162930 size 0x8 virtual false final false
 void SetBufferSize(int32_t bufferSize) ;

/// @brief Method SetBerEncodeRecipients addr 0x1162938 size 0xc virtual false final false
 void SetBerEncodeRecipients(bool berEncodeRecipientSet) ;

/// @brief Method get_Version addr 0x1162944 size 0x80 virtual false final false
 Org::BouncyCastle::Asn1::DerInteger get_Version() ;

/// @brief Method Open addr 0x11629c4 size 0x600 virtual false final false
 System::IO::Stream Open(System::IO::Stream outStream, ::StringW encryptionOid, Org::BouncyCastle::Crypto::CipherKeyGenerator keyGen) ;

/// @brief Method Open addr 0x1162fc4 size 0x880 virtual false final false
...
/// @brief Method Open addr 0x1163844 size 0xdc virtual false final false
 System::IO::Stream Open(System::IO::Stream outStream, ::StringW encryptionOid) ;

/// @brief Method Open addr 0x1163920 size 0xe0 virtual false final false
