...
/// @brief Method .ctor addr 0x1160218 size 0x40 virtual false final false
...
/// @brief Method WriteByte addr 0x1160258 size 0x24 virtual true final false
 void WriteByte(uint8_t b) ;

/// @brief Method Write addr 0x116027c size 0x24 virtual true final false
 void Write(::ArrayW<uint8_t> bytes, int32_t off, int32_t len) ;

/// @brief Method Close addr 0x11602a0 size 0xa8 virtual true final false
 void Close() ;
...
/// @brief Method .ctor addr 0x115fec8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method SetBufferSize addr 0x115fed0 size 0x8 virtual false final false
 void SetBufferSize(int32_t bufferSize) ;

/// @brief Method Open addr 0x115fed8 size 0x7c virtual false final false
 System::IO::Stream Open(System::IO::Stream outStream, ::StringW compressionOID) ;

/// @brief Method Open addr 0x115ff54 size 0x2c4 virtual false final false
