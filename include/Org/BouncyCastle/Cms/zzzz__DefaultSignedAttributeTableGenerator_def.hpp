...
/// @brief Method .ctor addr 0x116be4c size 0x68 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x116c334 size 0x80 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Cms::AttributeTable attributeTable) ;

/// @brief Method createStandardAttributeTable addr 0x1182548 size 0x80 virtual true final false
 System::Collections::Hashtable createStandardAttributeTable(System::Collections::IDictionary parameters) ;

/// @brief Method DoCreateStandardAttributeTable addr 0x11825c8 size 0x710 virtual false final false
 void DoCreateStandardAttributeTable(System::Collections::IDictionary parameters, System::Collections::IDictionary std) ;

/// @brief Method GetAttributes addr 0x1182cd8 size 0x8c virtual true final false
