...
/// @brief Method get_MaximumMemory addr 0x1181c30 size 0x8 virtual false final false
static int32_t get_MaximumMemory() ;

/// @brief Method ReadContentInfo addr 0x116745c size 0x64 virtual false final false
static Org::BouncyCastle::Asn1::Cms::ContentInfo ReadContentInfo(::ArrayW<uint8_t> input) ;

/// @brief Method ReadContentInfo addr 0x1167194 size 0x68 virtual false final false
static Org::BouncyCastle::Asn1::Cms::ContentInfo ReadContentInfo(System::IO::Stream input) ;

/// @brief Method ReadContentInfo addr 0x1181c38 size 0x158 virtual false final false
static Org::BouncyCastle::Asn1::Cms::ContentInfo ReadContentInfo(Org::BouncyCastle::Asn1::Asn1InputStream aIn) ;

/// @brief Method StreamToByteArray addr 0x1181d90 size 0x8 virtual false final false
static ::ArrayW<uint8_t> StreamToByteArray(System::IO::Stream inStream) ;

/// @brief Method StreamToByteArray addr 0x1181d98 size 0x8 virtual false final false
static ::ArrayW<uint8_t> StreamToByteArray(System::IO::Stream inStream, int32_t limit) ;

/// @brief Method GetCertificatesFromStore addr 0x11694d8 size 0x5a4 virtual false final false
static System::Collections::IList GetCertificatesFromStore(Org::BouncyCastle::X509::Store::IX509Store certStore) ;

/// @brief Method GetCrlsFromStore addr 0x1169e0c size 0x5a4 virtual false final false
static System::Collections::IList GetCrlsFromStore(Org::BouncyCastle::X509::Store::IX509Store crlStore) ;

/// @brief Method CreateBerSetFromList addr 0x1169a7c size 0x390 virtual false final false
static Org::BouncyCastle::Asn1::Asn1Set CreateBerSetFromList(System::Collections::IList berObjects) ;

/// @brief Method CreateDerSetFromList addr 0x116e818 size 0x390 virtual false final false
static Org::BouncyCastle::Asn1::Asn1Set CreateDerSetFromList(System::Collections::IList derObjects) ;

/// @brief Method CreateBerOctetOutputStream addr 0x1173940 size 0x90 virtual false final false
static System::IO::Stream CreateBerOctetOutputStream(System::IO::Stream s, int32_t tagNo, bool isExplicit, int32_t bufferSize) ;

/// @brief Method GetTbsCertificateStructure addr 0x1181da0 size 0x30 virtual false final false
...
/// @brief Method GetIssuerAndSerialNumber addr 0x116b2d8 size 0x94 virtual false final false
...
/// @brief Method .ctor addr 0x1181dd0 size 0x8 virtual false final false
 void _ctor() ;
