...
/// @brief Method .ctor addr 0x116a428 size 0x64 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x116a48c size 0xa0 virtual false final false
 void _ctor(Org::BouncyCastle::Security::SecureRandom rand) ;

/// @brief Method GetBaseParameters addr 0x116a52c size 0x23c virtual true final false
...
/// @brief Method GetAttributeSet addr 0x116a768 size 0x7c virtual true final false
 Org::BouncyCastle::Asn1::Asn1Set GetAttributeSet(Org::BouncyCastle::Asn1::Cms::AttributeTable attr) ;

/// @brief Method AddCertificates addr 0x116a7e4 size 0x24 virtual false final false
 void AddCertificates(Org::BouncyCastle::X509::Store::IX509Store certStore) ;

/// @brief Method AddCrls addr 0x116a808 size 0x24 virtual false final false
 void AddCrls(Org::BouncyCastle::X509::Store::IX509Store crlStore) ;

/// @brief Method AddAttributeCertificates addr 0x116a82c size 0x5cc virtual false final false
 void AddAttributeCertificates(Org::BouncyCastle::X509::Store::IX509Store store) ;

/// @brief Method AddSigners addr 0x116adf8 size 0x3e4 virtual false final false
 void AddSigners(Org::BouncyCastle::Cms::SignerInformationStore signerStore) ;

/// @brief Method GetGeneratedDigests addr 0x116b1dc size 0x5c virtual false final false
 System::Collections::IDictionary GetGeneratedDigests() ;

/// @brief Method get_UseDerForCerts addr 0x116b238 size 0x8 virtual false final false
 bool get_UseDerForCerts() ;

/// @brief Method set_UseDerForCerts addr 0x116b240 size 0xc virtual false final false
 void set_UseDerForCerts(bool value) ;

/// @brief Method get_UseDerForCrls addr 0x116b24c size 0x8 virtual false final false
 bool get_UseDerForCrls() ;

/// @brief Method set_UseDerForCrls addr 0x116b254 size 0xc virtual false final false
 void set_UseDerForCrls(bool value) ;

/// @brief Method AddSignerCallback addr 0x116b260 size 0x4 virtual true final false
 void AddSignerCallback(Org::BouncyCastle::Cms::SignerInformation si) ;

/// @brief Method GetSignerIdentifier addr 0x116b264 size 0x74 virtual false final false
static Org::BouncyCastle::Asn1::Cms::SignerIdentifier GetSignerIdentifier(Org::BouncyCastle::X509::X509Certificate cert) ;

/// @brief Method GetSignerIdentifier addr 0x116b36c size 0x94 virtual false final false
