...
/// @brief Method GetHashCode addr 0x118836c size 0xa4 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x1188410 size 0x12c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

// Ctor Parameters []
explicit OriginatorID() ;

/// @brief Method .ctor addr 0x1185ce4 size 0x10 virtual false final false
 void _ctor() ;
