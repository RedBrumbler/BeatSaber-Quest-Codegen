...
/// @brief Method .ctor addr 0x115af80 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x115b10c size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x115afa4 size 0x168 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Cms::ContentInfo contentInfo) ;

/// @brief Method GetMac addr 0x115b130 size 0x5c virtual false final false
 ::ArrayW<uint8_t> GetMac() ;

/// @brief Method get_MacAlgorithmID addr 0x115b18c size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_MacAlgorithmID() ;

/// @brief Method get_MacAlgOid addr 0x115b194 size 0x2c virtual false final false
 ::StringW get_MacAlgOid() ;

/// @brief Method GetRecipientInfos addr 0x115b1c0 size 0x8 virtual false final false
 Org::BouncyCastle::Cms::RecipientInformationStore GetRecipientInfos() ;

/// @brief Method get_ContentInfo addr 0x115b1c8 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::Cms::ContentInfo get_ContentInfo() ;

/// @brief Method GetAuthAttrs addr 0x115b1d0 size 0x74 virtual false final false
 Org::BouncyCastle::Asn1::Cms::AttributeTable GetAuthAttrs() ;

/// @brief Method GetUnauthAttrs addr 0x115b244 size 0x74 virtual false final false
 Org::BouncyCastle::Asn1::Cms::AttributeTable GetUnauthAttrs() ;

/// @brief Method GetEncoded addr 0x115b2b8 size 0x1c virtual false final false
