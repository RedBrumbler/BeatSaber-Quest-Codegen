...
/// @brief Method .ctor addr 0x1184688 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method set_KeyAgreementOID addr 0x1184690 size 0x8 virtual false final false
 void set_KeyAgreementOID(Org::BouncyCastle::Asn1::DerObjectIdentifier value) ;

/// @brief Method set_KeyEncryptionOID addr 0x1184698 size 0x8 virtual false final false
 void set_KeyEncryptionOID(Org::BouncyCastle::Asn1::DerObjectIdentifier value) ;

/// @brief Method set_RecipientCerts addr 0x11846a0 size 0x6c virtual false final false
 void set_RecipientCerts(System::Collections::ICollection value) ;

/// @brief Method set_SenderKeyPair addr 0x118470c size 0x8 virtual false final false
 void set_SenderKeyPair(Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair value) ;

/// @brief Method Generate addr 0x1184714 size 0x11f8 virtual true final true
...
/// @brief Method CreateOriginatorPublicKey addr 0x118590c size 0x120 virtual false final false
