...
/// @brief Method GetHashCode addr 0x118a618 size 0xa4 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x118a6bc size 0x12c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

// Ctor Parameters []
explicit SignerID() ;

/// @brief Method .ctor addr 0x118a7e8 size 0x10 virtual false final false
 void _ctor() ;
