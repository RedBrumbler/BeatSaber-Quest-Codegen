...
/// @brief Method .ctor addr 0x1162240 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x11622b8 size 0x2f8 virtual false final false
 void _ctor(System::IO::Stream envelopedData) ;

/// @brief Method get_EncryptionAlgorithmID addr 0x11625b0 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_EncryptionAlgorithmID() ;

/// @brief Method get_EncryptionAlgOid addr 0x11625b8 size 0x2c virtual false final false
 ::StringW get_EncryptionAlgOid() ;

/// @brief Method get_EncryptionAlgParams addr 0x11625e4 size 0x38 virtual false final false
 Org::BouncyCastle::Asn1::Asn1Object get_EncryptionAlgParams() ;

/// @brief Method GetRecipientInfos addr 0x116261c size 0x8 virtual false final false
 Org::BouncyCastle::Cms::RecipientInformationStore GetRecipientInfos() ;

/// @brief Method GetUnprotectedAttributes addr 0x1162624 size 0x24c virtual false final false
