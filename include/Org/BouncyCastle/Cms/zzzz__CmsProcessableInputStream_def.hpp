...
/// @brief Method .ctor addr 0x1166060 size 0x2c virtual false final false
 void _ctor(System::IO::Stream input) ;

/// @brief Method GetInputStream addr 0x1166f24 size 0x20 virtual true final false
 System::IO::Stream GetInputStream() ;

/// @brief Method Write addr 0x1166f44 size 0x88 virtual true final false
 void Write(System::IO::Stream output) ;

/// @brief Method GetContent addr 0x1166fcc size 0xc virtual true final false
 ::bs_hook::Il2CppWrapperType GetContent() ;

/// @brief Method CheckSingleUsage addr 0x1166fd8 size 0xf8 virtual true final false
