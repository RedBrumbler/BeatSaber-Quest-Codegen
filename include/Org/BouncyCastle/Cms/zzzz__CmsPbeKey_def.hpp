...
/// @brief Method .ctor addr 0x1166708 size 0x44 virtual false final false
...
/// @brief Method .ctor addr 0x1166840 size 0x3c virtual false final false
...
/// @brief Method .ctor addr 0x116674c size 0xf4 virtual false final false
...
/// @brief Method .ctor addr 0x116687c size 0x210 virtual false final false
 void _ctor(::ArrayW<char16_t> password, Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier keyDerivationAlgorithm) ;

/// @brief Method Finalize addr 0x1166a8c size 0xac virtual true final false
 void Finalize() ;

/// @brief Method get_Password addr 0x1166b38 size 0x10 virtual false final false
 ::StringW get_Password() ;

/// @brief Method get_Salt addr 0x1166b48 size 0x5c virtual false final false
 ::ArrayW<uint8_t> get_Salt() ;

/// @brief Method GetSalt addr 0x1166ba4 size 0x4 virtual false final false
 ::ArrayW<uint8_t> GetSalt() ;

/// @brief Method get_IterationCount addr 0x1166ba8 size 0x8 virtual false final false
 int32_t get_IterationCount() ;

/// @brief Method get_Algorithm addr 0x1166bb0 size 0x40 virtual false final false
 ::StringW get_Algorithm() ;

/// @brief Method get_Format addr 0x1166bf0 size 0x40 virtual false final false
 ::StringW get_Format() ;

/// @brief Method GetEncoded addr 0x1166c30 size 0x8 virtual false final false
