...
/// @brief Method .ctor addr 0x116f4dc size 0x7c virtual false final false
...
/// @brief Method .ctor addr 0x116f564 size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x116f558 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x116f5e4 size 0x784 virtual false final false
 void _ctor(Org::BouncyCastle::Cms::CmsTypedStream signedContent, System::IO::Stream sigData) ;

/// @brief Method get_Version addr 0x116fdd8 size 0x24 virtual false final false
 int32_t get_Version() ;

/// @brief Method get_DigestOids addr 0x116fdfc size 0x68 virtual false final false
 Org::BouncyCastle::Utilities::Collections::ISet get_DigestOids() ;

/// @brief Method GetSignerInfos addr 0x116fe64 size 0x9b8 virtual false final false
 Org::BouncyCastle::Cms::SignerInformationStore GetSignerInfos() ;

/// @brief Method GetAttributeCertificates addr 0x1170994 size 0x88 virtual false final false
 Org::BouncyCastle::X509::Store::IX509Store GetAttributeCertificates(::StringW type) ;

/// @brief Method GetCertificates addr 0x1170a1c size 0x88 virtual false final false
 Org::BouncyCastle::X509::Store::IX509Store GetCertificates(::StringW type) ;

/// @brief Method GetCrls addr 0x1170aa4 size 0x88 virtual false final false
 Org::BouncyCastle::X509::Store::IX509Store GetCrls(::StringW type) ;

/// @brief Method PopulateCertCrlSets addr 0x117081c size 0x178 virtual false final false
 void PopulateCertCrlSets() ;

/// @brief Method get_SignedContentType addr 0x1170bdc size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_SignedContentType() ;

/// @brief Method GetSignedContent addr 0x1170be4 size 0x464 virtual false final false
 Org::BouncyCastle::Cms::CmsTypedStream GetSignedContent() ;

/// @brief Method ReplaceSigners addr 0x1171048 size 0x19c virtual false final false
...
/// @brief Method ReplaceCertificatesAndCrls addr 0x11712c0 size 0x1a4 virtual false final false
...
/// @brief Method GetAsn1Set addr 0x1170b2c size 0xb0 virtual false final false
