...
/// @brief Method .ctor addr 0x1181ab8 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }]
explicit CmsStreamException(::StringW name) ;

/// @brief Method .ctor addr 0x1181ac0 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x1174e78 size 0x8 virtual false final false
