...
/// @brief Method .ctor addr 0x115af74 size 0x4 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }]
explicit CmsAttributeTableGenerationException(::StringW name) ;

/// @brief Method .ctor addr 0x115af78 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x115af7c size 0x4 virtual false final false
