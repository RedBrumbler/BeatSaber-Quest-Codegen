...
/// @brief Method .ctor addr 0x1186644 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x118664c size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x1186674 size 0x7c virtual false final false
 void _ctor(::ArrayW<uint8_t> subjectKeyIdentifier) ;

/// @brief Method set_RecipientCert addr 0x11866f0 size 0x58 virtual false final false
 void set_RecipientCert(Org::BouncyCastle::X509::X509Certificate value) ;

/// @brief Method set_RecipientPublicKey addr 0x1186748 size 0xdc virtual false final false
 void set_RecipientPublicKey(Org::BouncyCastle::Crypto::AsymmetricKeyParameter value) ;

/// @brief Method set_SubjectKeyIdentifier addr 0x1186824 size 0x8 virtual false final false
 void set_SubjectKeyIdentifier(Org::BouncyCastle::Asn1::Asn1OctetString value) ;

/// @brief Method Generate addr 0x118682c size 0x1c0 virtual true final true
...
/// @brief Method get_AlgorithmDetails addr 0x11869ec size 0x1c virtual true final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_AlgorithmDetails() ;

/// @brief Method GenerateWrappedKey addr 0x1186a08 size 0x1dc virtual true final false
