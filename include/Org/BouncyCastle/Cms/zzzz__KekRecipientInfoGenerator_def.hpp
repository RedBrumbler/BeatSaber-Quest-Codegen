...
/// @brief Method .ctor addr 0x1183478 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method set_KekIdentifier addr 0x1183480 size 0x8 virtual false final false
 void set_KekIdentifier(Org::BouncyCastle::Asn1::Cms::KekIdentifier value) ;

/// @brief Method set_KeyEncryptionKey addr 0x1183488 size 0x74 virtual false final false
 void set_KeyEncryptionKey(Org::BouncyCastle::Crypto::Parameters::KeyParameter value) ;

/// @brief Method set_KeyEncryptionKeyOID addr 0x118397c size 0x8 virtual false final false
 void set_KeyEncryptionKeyOID(::StringW value) ;

/// @brief Method Generate addr 0x1183984 size 0x288 virtual true final true
...
/// @brief Method DetermineKeyEncAlg addr 0x11834fc size 0x480 virtual false final false
