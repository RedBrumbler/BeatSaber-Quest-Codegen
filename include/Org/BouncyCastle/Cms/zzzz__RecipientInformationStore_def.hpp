...
/// @brief Method .ctor addr 0x1164d6c size 0x5a8 virtual false final false
 void _ctor(System::Collections::ICollection recipientInfos) ;

/// @brief Method get_Item addr 0x118a254 size 0x4 virtual false final false
 Org::BouncyCastle::Cms::RecipientInformation get_Item(Org::BouncyCastle::Cms::RecipientID selector) ;

/// @brief Method GetFirstRecipient addr 0x118a258 size 0x190 virtual false final false
 Org::BouncyCastle::Cms::RecipientInformation GetFirstRecipient(Org::BouncyCastle::Cms::RecipientID selector) ;

/// @brief Method get_Count addr 0x118a3e8 size 0xa4 virtual false final false
 int32_t get_Count() ;

/// @brief Method GetRecipients addr 0x118a48c size 0x5c virtual false final false
 System::Collections::ICollection GetRecipients() ;

/// @brief Method GetRecipients addr 0x118a4e8 size 0x130 virtual false final false
