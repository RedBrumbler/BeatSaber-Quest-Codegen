...
/// @brief Method .ctor addr 0x11891a0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method set_KeyDerivationAlgorithm addr 0x11891a8 size 0x8 virtual false final false
 void set_KeyDerivationAlgorithm(Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier value) ;

/// @brief Method set_KeyEncryptionKey addr 0x11891b0 size 0x8 virtual false final false
 void set_KeyEncryptionKey(Org::BouncyCastle::Crypto::Parameters::KeyParameter value) ;

/// @brief Method set_KeyEncryptionKeyOID addr 0x11891b8 size 0x8 virtual false final false
 void set_KeyEncryptionKeyOID(::StringW value) ;

/// @brief Method Generate addr 0x11891c0 size 0x4bc virtual true final true
