...
/// @brief Method .ctor addr 0x1165b60 size 0x90 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Cms::PasswordRecipientInfo info, Org::BouncyCastle::Cms::CmsSecureReadable secureReadable) ;

/// @brief Method get_KeyDerivationAlgorithm addr 0x11896f4 size 0x1c virtual true final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_KeyDerivationAlgorithm() ;

/// @brief Method GetContentStream addr 0x1189710 size 0x574 virtual true final false
