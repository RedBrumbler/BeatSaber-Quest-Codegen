...
/// @brief Method .ctor addr 0x1165314 size 0x21c virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Cms::KeyTransRecipientInfo info, Org::BouncyCastle::Cms::CmsSecureReadable secureReadable) ;

/// @brief Method GetExchangeEncryptionAlgorithmName addr 0x1186c5c size 0x1c4 virtual false final false
 ::StringW GetExchangeEncryptionAlgorithmName(Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier algo) ;

/// @brief Method UnwrapKey addr 0x1186e20 size 0x388 virtual false final false
 Org::BouncyCastle::Crypto::Parameters::KeyParameter UnwrapKey(Org::BouncyCastle::Crypto::ICipherParameters key) ;

/// @brief Method GetContentStream addr 0x11871a8 size 0x1c virtual true final false
