...
/// @brief Method Generate addr 0x117ca44 size 0x6c0 virtual false final false
static Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier Generate(::StringW signatureAlgorithm) ;

/// @brief Method CreatePssParams addr 0x117c918 size 0x12c virtual false final false
...
/// @brief Method Find addr 0x117d104 size 0x54 virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier Find(::StringW sigAlgName) ;

// Ctor Parameters []
explicit DefaultSignatureAlgorithmIdentifierFinder() ;

/// @brief Method .ctor addr 0x117d158 size 0x8 virtual false final false
 void _ctor() ;
