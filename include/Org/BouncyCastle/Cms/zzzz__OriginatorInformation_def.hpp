...
/// @brief Method .ctor addr 0x1188758 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Cms::OriginatorInfo originatorInfo) ;

/// @brief Method GetCertificates addr 0x1188780 size 0x50c virtual true final false
 Org::BouncyCastle::X509::Store::IX509Store GetCertificates() ;

/// @brief Method GetCrls addr 0x1188c8c size 0x50c virtual true final false
 Org::BouncyCastle::X509::Store::IX509Store GetCrls() ;

/// @brief Method ToAsn1Structure addr 0x1189198 size 0x8 virtual true final false
