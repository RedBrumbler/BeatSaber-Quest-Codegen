...
/// @brief Method .ctor addr 0x115d400 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x115d478 size 0x308 virtual false final false
 void _ctor(System::IO::Stream envelopedData) ;

/// @brief Method get_MacAlgorithmID addr 0x115d780 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_MacAlgorithmID() ;

/// @brief Method get_MacAlgOid addr 0x115d788 size 0x2c virtual false final false
 ::StringW get_MacAlgOid() ;

/// @brief Method get_MacAlgParams addr 0x115d7b4 size 0x38 virtual false final false
 Org::BouncyCastle::Asn1::Asn1Object get_MacAlgParams() ;

/// @brief Method GetRecipientInfos addr 0x115d7ec size 0x8 virtual false final false
 Org::BouncyCastle::Cms::RecipientInformationStore GetRecipientInfos() ;

/// @brief Method GetMac addr 0x115d7f4 size 0x94 virtual false final false
 ::ArrayW<uint8_t> GetMac() ;

/// @brief Method GetAuthAttrs addr 0x115d888 size 0x24c virtual false final false
 Org::BouncyCastle::Asn1::Cms::AttributeTable GetAuthAttrs() ;

/// @brief Method GetUnauthAttrs addr 0x115dad4 size 0x24c virtual false final false
