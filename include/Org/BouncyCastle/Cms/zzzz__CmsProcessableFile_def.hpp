...
/// @brief Method .ctor addr 0x1166da4 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x1166dd4 size 0x30 virtual false final false
 void _ctor(System::IO::FileInfo file, int32_t bufSize) ;

/// @brief Method GetInputStream addr 0x1166e04 size 0x94 virtual true final false
 System::IO::Stream GetInputStream() ;

/// @brief Method Write addr 0x1166e98 size 0x84 virtual true final false
 void Write(System::IO::Stream zOut) ;

/// @brief Method GetContent addr 0x1166f1c size 0x8 virtual true final false
