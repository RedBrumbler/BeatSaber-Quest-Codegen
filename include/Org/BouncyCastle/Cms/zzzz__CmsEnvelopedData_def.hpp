...
/// @brief Method .ctor addr 0x1160348 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x11604b0 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x116036c size 0x144 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Cms::ContentInfo contentInfo) ;

/// @brief Method get_EncryptionAlgorithmID addr 0x11604d4 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_EncryptionAlgorithmID() ;

/// @brief Method get_EncryptionAlgOid addr 0x11604dc size 0x2c virtual false final false
 ::StringW get_EncryptionAlgOid() ;

/// @brief Method GetRecipientInfos addr 0x1160508 size 0x8 virtual false final false
 Org::BouncyCastle::Cms::RecipientInformationStore GetRecipientInfos() ;

/// @brief Method get_ContentInfo addr 0x1160510 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::Cms::ContentInfo get_ContentInfo() ;

/// @brief Method GetUnprotectedAttributes addr 0x1160518 size 0x74 virtual false final false
 Org::BouncyCastle::Asn1::Cms::AttributeTable GetUnprotectedAttributes() ;

/// @brief Method GetEncoded addr 0x116058c size 0x1c virtual false final false
