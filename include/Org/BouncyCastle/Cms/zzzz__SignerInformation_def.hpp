...
/// @brief Method .ctor addr 0x1167bc4 size 0x274 virtual false final false
...
/// @brief Method .ctor addr 0x118abf8 size 0x9c virtual false final false
 void _ctor(Org::BouncyCastle::Cms::SignerInformation baseInfo) ;

/// @brief Method get_IsCounterSignature addr 0x118ac94 size 0x8 virtual false final false
 bool get_IsCounterSignature() ;

/// @brief Method get_ContentType addr 0x118ac9c size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_ContentType() ;

/// @brief Method get_SignerID addr 0x118aca4 size 0x8 virtual false final false
 Org::BouncyCastle::Cms::SignerID get_SignerID() ;

/// @brief Method get_Version addr 0x118acac size 0x24 virtual false final false
 int32_t get_Version() ;

/// @brief Method get_DigestAlgorithmID addr 0x118acd0 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_DigestAlgorithmID() ;

/// @brief Method get_DigestAlgOid addr 0x118acd8 size 0x2c virtual false final false
 ::StringW get_DigestAlgOid() ;

/// @brief Method get_DigestAlgParams addr 0x118ad04 size 0x38 virtual false final false
 Org::BouncyCastle::Asn1::Asn1Object get_DigestAlgParams() ;

/// @brief Method GetContentDigest addr 0x118ad3c size 0xc0 virtual false final false
 ::ArrayW<uint8_t> GetContentDigest() ;

/// @brief Method get_EncryptionAlgorithmID addr 0x118adfc size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_EncryptionAlgorithmID() ;

/// @brief Method get_EncryptionAlgOid addr 0x118ae04 size 0x2c virtual false final false
 ::StringW get_EncryptionAlgOid() ;

/// @brief Method get_EncryptionAlgParams addr 0x118ae30 size 0x38 virtual false final false
 Org::BouncyCastle::Asn1::Asn1Object get_EncryptionAlgParams() ;

/// @brief Method get_SignedAttributes addr 0x118ae68 size 0x78 virtual false final false
 Org::BouncyCastle::Asn1::Cms::AttributeTable get_SignedAttributes() ;

/// @brief Method get_UnsignedAttributes addr 0x118aee0 size 0x78 virtual false final false
 Org::BouncyCastle::Asn1::Cms::AttributeTable get_UnsignedAttributes() ;

/// @brief Method GetSignature addr 0x116ec34 size 0x78 virtual false final false
 ::ArrayW<uint8_t> GetSignature() ;

/// @brief Method GetCounterSignatures addr 0x118af58 size 0x88c virtual false final false
 Org::BouncyCastle::Cms::SignerInformationStore GetCounterSignatures() ;

/// @brief Method GetEncodedSignedAttributes addr 0x118b7e4 size 0x5c virtual false final false
 ::ArrayW<uint8_t> GetEncodedSignedAttributes() ;

/// @brief Method DoVerify addr 0x118b840 size 0x12f4 virtual false final false
 bool DoVerify(Org::BouncyCastle::Crypto::AsymmetricKeyParameter key) ;

/// @brief Method IsNull addr 0x118d3d8 size 0x84 virtual false final false
 bool IsNull(Org::BouncyCastle::Asn1::Asn1Encodable o) ;

/// @brief Method DerDecode addr 0x118d45c size 0xf8 virtual false final false
 Org::BouncyCastle::Asn1::X509::DigestInfo DerDecode(::ArrayW<uint8_t> encoding) ;

/// @brief Method VerifyDigest addr 0x118cd34 size 0x6a4 virtual false final false
 bool VerifyDigest(::ArrayW<uint8_t> digest, Org::BouncyCastle::Crypto::AsymmetricKeyParameter key, ::ArrayW<uint8_t> signature) ;

/// @brief Method Verify addr 0x118d554 size 0x98 virtual false final false
 bool Verify(Org::BouncyCastle::Crypto::AsymmetricKeyParameter pubKey) ;

/// @brief Method Verify addr 0x118d72c size 0x70 virtual false final false
 bool Verify(Org::BouncyCastle::X509::X509Certificate cert) ;

/// @brief Method ToSignerInfo addr 0x118d79c size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::Cms::SignerInfo ToSignerInfo() ;

/// @brief Method GetSingleValuedSignedAttribute addr 0x118cb34 size 0x200 virtual false final false
...
/// @brief Method GetSigningTime addr 0x118d5ec size 0x140 virtual false final false
 Org::BouncyCastle::Asn1::Cms::Time GetSigningTime() ;

/// @brief Method ReplaceUnsignedAttributes addr 0x118d7a4 size 0x134 virtual false final false
...
/// @brief Method AddCounterSigners addr 0x118d8d8 size 0x524 virtual false final false
