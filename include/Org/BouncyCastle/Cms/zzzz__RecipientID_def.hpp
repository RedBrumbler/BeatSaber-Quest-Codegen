...
/// @brief Method get_KeyIdentifier addr 0x1189fec size 0x5c virtual false final false
 ::ArrayW<uint8_t> get_KeyIdentifier() ;

/// @brief Method set_KeyIdentifier addr 0x11842e4 size 0x6c virtual false final false
 void set_KeyIdentifier(::ArrayW<uint8_t> value) ;

/// @brief Method GetHashCode addr 0x118a048 size 0xac virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x118a0f4 size 0x160 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

// Ctor Parameters []
explicit RecipientID() ;

/// @brief Method .ctor addr 0x1183d0c size 0x10 virtual false final false
 void _ctor() ;
