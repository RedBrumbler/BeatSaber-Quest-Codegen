...
/// @brief Method .ctor addr 0x118ee74 size 0x18c virtual false final false
...
/// @brief Method .ctor addr 0x118f000 size 0x5a8 virtual false final false
 void _ctor(System::Collections::ICollection signerInfos) ;

/// @brief Method GetFirstSigner addr 0x118f5a8 size 0x190 virtual false final false
 Org::BouncyCastle::Cms::SignerInformation GetFirstSigner(Org::BouncyCastle::Cms::SignerID selector) ;

/// @brief Method get_Count addr 0x118f738 size 0xa4 virtual false final false
 int32_t get_Count() ;

/// @brief Method GetSigners addr 0x118f7dc size 0x5c virtual false final false
 System::Collections::ICollection GetSigners() ;

/// @brief Method GetSigners addr 0x118f838 size 0x130 virtual false final false
