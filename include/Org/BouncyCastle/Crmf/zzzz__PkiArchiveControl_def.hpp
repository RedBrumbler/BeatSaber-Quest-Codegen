...
/// @brief Method .ctor addr 0x118fe7c size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Crmf::PkiArchiveOptions pkiArchiveOptions) ;

/// @brief Method get_Type addr 0x11933e4 size 0x58 virtual true final true
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_Type() ;

/// @brief Method get_Value addr 0x119343c size 0x8 virtual true final true
 Org::BouncyCastle::Asn1::Asn1Encodable get_Value() ;

/// @brief Method get_ArchiveType addr 0x1193444 size 0x20 virtual false final false
 int32_t get_ArchiveType() ;

/// @brief Method get_EnvelopedData addr 0x1193464 size 0x44 virtual false final false
 bool get_EnvelopedData() ;

/// @brief Method GetEnvelopedData addr 0x11934a8 size 0x264 virtual false final false
