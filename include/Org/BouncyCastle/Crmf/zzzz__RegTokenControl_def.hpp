...
/// @brief Method .ctor addr 0x118fea4 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x1194bd4 size 0x7c virtual false final false
 void _ctor(::StringW token) ;

/// @brief Method get_Type addr 0x1194c50 size 0x58 virtual true final true
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_Type() ;

/// @brief Method get_Value addr 0x1194ca8 size 0x8 virtual true final true
