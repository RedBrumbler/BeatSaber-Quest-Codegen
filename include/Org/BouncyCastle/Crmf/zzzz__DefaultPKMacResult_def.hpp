...
/// @brief Method .ctor addr 0x1193bc8 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IMac mac) ;

/// @brief Method Collect addr 0x1193e7c size 0x148 virtual true final true
 ::ArrayW<uint8_t> Collect() ;

/// @brief Method Collect addr 0x1193fc4 size 0x40 virtual true final true
