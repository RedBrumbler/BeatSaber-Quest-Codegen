...
/// @brief Method .ctor addr 0x1193bf0 size 0x7c virtual false final false
 void _ctor(::ArrayW<uint8_t> key, Org::BouncyCastle::Asn1::Cmp::PbmParameter parameters) ;

/// @brief Method get_AlgorithmDetails addr 0x1193c6c size 0x9c virtual true final false
 ::bs_hook::Il2CppWrapperType get_AlgorithmDetails() ;

/// @brief Method CreateCalculator addr 0x1193d08 size 0x174 virtual true final false
