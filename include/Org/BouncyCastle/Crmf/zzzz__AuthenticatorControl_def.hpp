...
/// @brief Method .ctor addr 0x118f998 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x118f9c0 size 0x7c virtual false final false
 void _ctor(::StringW token) ;

/// @brief Method get_Type addr 0x118fa3c size 0x58 virtual true final true
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_Type() ;

/// @brief Method get_Value addr 0x118fa94 size 0x8 virtual true final true
