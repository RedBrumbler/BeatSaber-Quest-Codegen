...
/// @brief Method .ctor addr 0x1193ac0 size 0x7c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IMac mac) ;

/// @brief Method get_Stream addr 0x1193b3c size 0x8 virtual true final true
 System::IO::Stream get_Stream() ;

/// @brief Method GetResult addr 0x1193b44 size 0x84 virtual true final true
