...
/// @brief Method ParseBytes addr 0x118fb14 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x118fb1c size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x118fb40 size 0x54 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Crmf::CertReqMsg certReqMsg) ;

/// @brief Method ToAsn1Structure addr 0x118fb94 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::Crmf::CertReqMsg ToAsn1Structure() ;

/// @brief Method GetCertTemplate addr 0x118fb9c size 0x30 virtual false final false
 Org::BouncyCastle::Asn1::Crmf::CertTemplate GetCertTemplate() ;

/// @brief Method get_HasControls addr 0x118fbcc size 0x10 virtual false final false
 bool get_HasControls() ;

/// @brief Method HasControl addr 0x118fbdc size 0x18 virtual false final false
 bool HasControl(Org::BouncyCastle::Asn1::DerObjectIdentifier objectIdentifier) ;

/// @brief Method GetControl addr 0x118fca4 size 0x1d8 virtual false final false
 Org::BouncyCastle::Crmf::IControl GetControl(Org::BouncyCastle::Asn1::DerObjectIdentifier type) ;

/// @brief Method FindControl addr 0x118fbf4 size 0xb0 virtual false final false
 Org::BouncyCastle::Asn1::Crmf::AttributeTypeAndValue FindControl(Org::BouncyCastle::Asn1::DerObjectIdentifier type) ;

/// @brief Method get_HasProofOfPossession addr 0x118fecc size 0x2c virtual false final false
 bool get_HasProofOfPossession() ;

/// @brief Method get_ProofOfPossession addr 0x118fef8 size 0x30 virtual false final false
 int32_t get_ProofOfPossession() ;

/// @brief Method get_HasSigningKeyProofOfPossessionWithPkMac addr 0x118ff28 size 0xe0 virtual false final false
 bool get_HasSigningKeyProofOfPossessionWithPkMac() ;

/// @brief Method IsValidSigningKeyPop addr 0x1190008 size 0x174 virtual false final false
 bool IsValidSigningKeyPop(Org::BouncyCastle::Crypto::IVerifierFactoryProvider verifierProvider) ;

/// @brief Method verifySignature addr 0x119017c size 0x440 virtual false final false
...
/// @brief Method GetEncoded addr 0x119062c size 0x1c virtual false final false
