...
/// @brief Method .ctor addr 0x1192468 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x1192498 size 0x3c virtual false final false
...
/// @brief Method Build addr 0x11924d4 size 0x30 virtual false final false
 Org::BouncyCastle::Asn1::Crmf::EncryptedValue Build(::ArrayW<char16_t> revocationPassphrase) ;

/// @brief Method Build addr 0x1192cec size 0x144 virtual false final false
 Org::BouncyCastle::Asn1::Crmf::EncryptedValue Build(Org::BouncyCastle::X509::X509Certificate holder) ;

/// @brief Method Build addr 0x1192e30 size 0x5b4 virtual false final false
 Org::BouncyCastle::Asn1::Crmf::EncryptedValue Build(Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo privateKeyInfo) ;

/// @brief Method EncryptData addr 0x11925b8 size 0x734 virtual false final false
 Org::BouncyCastle::Asn1::Crmf::EncryptedValue EncryptData(::ArrayW<uint8_t> data) ;

/// @brief Method PadData addr 0x1192504 size 0xb4 virtual false final false
