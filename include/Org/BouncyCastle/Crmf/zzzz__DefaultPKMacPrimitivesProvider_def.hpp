...
/// @brief Method CreateDigest addr 0x1192370 size 0x78 virtual true final true
 Org::BouncyCastle::Crypto::IDigest CreateDigest(Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier digestAlg) ;

/// @brief Method CreateMac addr 0x11923e8 size 0x78 virtual true final true
...
/// @brief Method .ctor addr 0x1192460 size 0x8 virtual false final false
 void _ctor() ;
