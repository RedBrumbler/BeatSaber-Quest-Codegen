...
/// @brief Method CloneSelector addr 0x10f3fa8 size 0x8c virtual false final false
...
/// @brief Method .ctor addr 0x10f4034 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x10f403c size 0x4c virtual false final false
 void _ctor(Org::BouncyCastle::X509::Store::X509CertPairStoreSelector o) ;

/// @brief Method get_CertPair addr 0x10f4098 size 0x8 virtual false final false
 Org::BouncyCastle::X509::X509CertificatePair get_CertPair() ;

/// @brief Method set_CertPair addr 0x10f40a0 size 0x8 virtual false final false
 void set_CertPair(Org::BouncyCastle::X509::X509CertificatePair value) ;

/// @brief Method get_ForwardSelector addr 0x10f4088 size 0x8 virtual false final false
 Org::BouncyCastle::X509::Store::X509CertStoreSelector get_ForwardSelector() ;

/// @brief Method set_ForwardSelector addr 0x10f40a8 size 0x1c virtual false final false
 void set_ForwardSelector(Org::BouncyCastle::X509::Store::X509CertStoreSelector value) ;

/// @brief Method get_ReverseSelector addr 0x10f4090 size 0x8 virtual false final false
 Org::BouncyCastle::X509::Store::X509CertStoreSelector get_ReverseSelector() ;

/// @brief Method set_ReverseSelector addr 0x10f40c4 size 0x1c virtual false final false
 void set_ReverseSelector(Org::BouncyCastle::X509::Store::X509CertStoreSelector value) ;

/// @brief Method Match addr 0x10f40e0 size 0x12c virtual true final true
 bool Match(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Clone addr 0x10f420c size 0x60 virtual true final true
