...
/// @brief Method .ctor addr 0x10f2cf4 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit X509StoreException(::StringW message) ;

/// @brief Method .ctor addr 0x10f2d4c size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x10f2db4 size 0x70 virtual false final false
