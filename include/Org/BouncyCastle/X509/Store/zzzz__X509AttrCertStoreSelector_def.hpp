...
/// @brief Method .ctor addr 0x10f2e30 size 0x84 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x10f2eb4 size 0xf8 virtual false final false
 void _ctor(Org::BouncyCastle::X509::Store::X509AttrCertStoreSelector o) ;

/// @brief Method Match addr 0x10f2fac size 0x814 virtual true final true
 bool Match(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Clone addr 0x10f37c0 size 0x60 virtual true final true
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method get_AttributeCert addr 0x10f3820 size 0x8 virtual false final false
 Org::BouncyCastle::X509::IX509AttributeCertificate get_AttributeCert() ;

/// @brief Method set_AttributeCert addr 0x10f3828 size 0x8 virtual false final false
 void set_AttributeCert(Org::BouncyCastle::X509::IX509AttributeCertificate value) ;

/// @brief Method get_AttribueCertificateValid addr 0x10f3830 size 0x8 virtual false final false
 Org::BouncyCastle::Utilities::Date::DateTimeObject get_AttribueCertificateValid() ;

/// @brief Method set_AttribueCertificateValid addr 0x10f3838 size 0x8 virtual false final false
 void set_AttribueCertificateValid(Org::BouncyCastle::Utilities::Date::DateTimeObject value) ;

/// @brief Method get_AttributeCertificateValid addr 0x10f3840 size 0x8 virtual false final false
 Org::BouncyCastle::Utilities::Date::DateTimeObject get_AttributeCertificateValid() ;

/// @brief Method set_AttributeCertificateValid addr 0x10f3848 size 0x8 virtual false final false
 void set_AttributeCertificateValid(Org::BouncyCastle::Utilities::Date::DateTimeObject value) ;

/// @brief Method get_Holder addr 0x10f3850 size 0x8 virtual false final false
 Org::BouncyCastle::X509::AttributeCertificateHolder get_Holder() ;

/// @brief Method set_Holder addr 0x10f3858 size 0x8 virtual false final false
 void set_Holder(Org::BouncyCastle::X509::AttributeCertificateHolder value) ;

/// @brief Method get_Issuer addr 0x10f3860 size 0x8 virtual false final false
 Org::BouncyCastle::X509::AttributeCertificateIssuer get_Issuer() ;

/// @brief Method set_Issuer addr 0x10f3868 size 0x8 virtual false final false
 void set_Issuer(Org::BouncyCastle::X509::AttributeCertificateIssuer value) ;

/// @brief Method get_SerialNumber addr 0x10f3870 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_SerialNumber() ;

/// @brief Method set_SerialNumber addr 0x10f3878 size 0x8 virtual false final false
 void set_SerialNumber(Org::BouncyCastle::Math::BigInteger value) ;

/// @brief Method AddTargetName addr 0x10f3880 size 0xa8 virtual false final false
 void AddTargetName(Org::BouncyCastle::Asn1::X509::GeneralName name) ;

/// @brief Method AddTargetName addr 0x10f3928 size 0x2c virtual false final false
 void AddTargetName(::ArrayW<uint8_t> name) ;

/// @brief Method SetTargetNames addr 0x10f3954 size 0x18 virtual false final false
 void SetTargetNames(System::Collections::IEnumerable names) ;

/// @brief Method GetTargetNames addr 0x10f3dec size 0x68 virtual false final false
 System::Collections::IEnumerable GetTargetNames() ;

/// @brief Method AddTargetGroup addr 0x10f3e54 size 0xa8 virtual false final false
 void AddTargetGroup(Org::BouncyCastle::Asn1::X509::GeneralName group) ;

/// @brief Method AddTargetGroup addr 0x10f3efc size 0x2c virtual false final false
 void AddTargetGroup(::ArrayW<uint8_t> name) ;

/// @brief Method SetTargetGroups addr 0x10f3f28 size 0x18 virtual false final false
 void SetTargetGroups(System::Collections::IEnumerable names) ;

/// @brief Method GetTargetGroups addr 0x10f3f40 size 0x68 virtual false final false
 System::Collections::IEnumerable GetTargetGroups() ;

/// @brief Method ExtractGeneralNames addr 0x10f396c size 0x480 virtual false final false
