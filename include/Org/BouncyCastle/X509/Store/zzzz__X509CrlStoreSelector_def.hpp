...
/// @brief Method .ctor addr 0x10f4944 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x10f494c size 0x7c virtual false final false
 void _ctor(Org::BouncyCastle::X509::Store::X509CrlStoreSelector o) ;

/// @brief Method Clone addr 0x10f4a78 size 0x60 virtual true final false
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method get_CertificateChecking addr 0x10f4ad8 size 0x8 virtual false final false
 Org::BouncyCastle::X509::X509Certificate get_CertificateChecking() ;

/// @brief Method set_CertificateChecking addr 0x10f4ae0 size 0x8 virtual false final false
 void set_CertificateChecking(Org::BouncyCastle::X509::X509Certificate value) ;

/// @brief Method get_DateAndTime addr 0x10f4ae8 size 0x8 virtual false final false
 Org::BouncyCastle::Utilities::Date::DateTimeObject get_DateAndTime() ;

/// @brief Method set_DateAndTime addr 0x10f4af0 size 0x8 virtual false final false
 void set_DateAndTime(Org::BouncyCastle::Utilities::Date::DateTimeObject value) ;

/// @brief Method get_Issuers addr 0x10f49c8 size 0x58 virtual false final false
 System::Collections::ICollection get_Issuers() ;

/// @brief Method set_Issuers addr 0x10f4af8 size 0x68 virtual false final false
 void set_Issuers(System::Collections::ICollection value) ;

/// @brief Method get_MaxCrlNumber addr 0x10f4b60 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_MaxCrlNumber() ;

/// @brief Method set_MaxCrlNumber addr 0x10f4b68 size 0x8 virtual false final false
 void set_MaxCrlNumber(Org::BouncyCastle::Math::BigInteger value) ;

/// @brief Method get_MinCrlNumber addr 0x10f4b70 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_MinCrlNumber() ;

/// @brief Method set_MinCrlNumber addr 0x10f4b78 size 0x8 virtual false final false
 void set_MinCrlNumber(Org::BouncyCastle::Math::BigInteger value) ;

/// @brief Method get_AttrCertChecking addr 0x10f4b80 size 0x8 virtual false final false
 Org::BouncyCastle::X509::IX509AttributeCertificate get_AttrCertChecking() ;

/// @brief Method set_AttrCertChecking addr 0x10f4b88 size 0x8 virtual false final false
 void set_AttrCertChecking(Org::BouncyCastle::X509::IX509AttributeCertificate value) ;

/// @brief Method get_CompleteCrlEnabled addr 0x10f4b90 size 0x8 virtual false final false
 bool get_CompleteCrlEnabled() ;

/// @brief Method set_CompleteCrlEnabled addr 0x10f4b98 size 0xc virtual false final false
 void set_CompleteCrlEnabled(bool value) ;

/// @brief Method get_DeltaCrlIndicatorEnabled addr 0x10f4ba4 size 0x8 virtual false final false
 bool get_DeltaCrlIndicatorEnabled() ;

/// @brief Method set_DeltaCrlIndicatorEnabled addr 0x10f4bac size 0xc virtual false final false
 void set_DeltaCrlIndicatorEnabled(bool value) ;

/// @brief Method get_IssuingDistributionPoint addr 0x10f4a20 size 0x58 virtual false final false
 ::ArrayW<uint8_t> get_IssuingDistributionPoint() ;

/// @brief Method set_IssuingDistributionPoint addr 0x10f4bb8 size 0x68 virtual false final false
 void set_IssuingDistributionPoint(::ArrayW<uint8_t> value) ;

/// @brief Method get_IssuingDistributionPointEnabled addr 0x10f4c20 size 0x8 virtual false final false
 bool get_IssuingDistributionPointEnabled() ;

/// @brief Method set_IssuingDistributionPointEnabled addr 0x10f4c28 size 0xc virtual false final false
 void set_IssuingDistributionPointEnabled(bool value) ;

/// @brief Method get_MaxBaseCrlNumber addr 0x10f4c34 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_MaxBaseCrlNumber() ;

/// @brief Method set_MaxBaseCrlNumber addr 0x10f4c3c size 0x8 virtual false final false
 void set_MaxBaseCrlNumber(Org::BouncyCastle::Math::BigInteger value) ;

/// @brief Method Match addr 0x10f4c44 size 0x6d0 virtual true final false
