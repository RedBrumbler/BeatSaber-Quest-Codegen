...
/// @brief Method .ctor addr 0x10f2e24 size 0x4 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit NoSuchStoreException(::StringW message) ;

/// @brief Method .ctor addr 0x10f2e28 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x10f2e2c size 0x4 virtual false final false
