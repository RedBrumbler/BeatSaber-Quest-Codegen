...
/// @brief Method .ctor addr 0x10f4728 size 0xbc virtual false final false
 void _ctor(System::Collections::ICollection collection) ;

/// @brief Method GetCollection addr 0x10f47e4 size 0x58 virtual false final false
 System::Collections::ICollection GetCollection() ;

/// @brief Method ToString addr 0x10f483c size 0x108 virtual true final false
 ::StringW ToString() ;
