...
/// @brief Method .ctor addr 0x11871c4 size 0x10 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11871d4 size 0xa8 virtual false final false
 void _ctor(Org::BouncyCastle::X509::Store::X509CertStoreSelector o) ;

/// @brief Method Clone addr 0x118734c size 0x60 virtual true final false
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method get_AuthorityKeyIdentifier addr 0x118727c size 0x5c virtual false final false
 ::ArrayW<uint8_t> get_AuthorityKeyIdentifier() ;

/// @brief Method set_AuthorityKeyIdentifier addr 0x11873ac size 0x6c virtual false final false
 void set_AuthorityKeyIdentifier(::ArrayW<uint8_t> value) ;

/// @brief Method get_BasicConstraints addr 0x1187418 size 0x8 virtual false final false
 int32_t get_BasicConstraints() ;

/// @brief Method set_BasicConstraints addr 0x1187420 size 0x80 virtual false final false
 void set_BasicConstraints(int32_t value) ;

/// @brief Method get_Certificate addr 0x11874a0 size 0x8 virtual false final false
 Org::BouncyCastle::X509::X509Certificate get_Certificate() ;

/// @brief Method set_Certificate addr 0x11874a8 size 0x8 virtual false final false
 void set_Certificate(Org::BouncyCastle::X509::X509Certificate value) ;

/// @brief Method get_CertificateValid addr 0x11874b0 size 0x8 virtual false final false
 Org::BouncyCastle::Utilities::Date::DateTimeObject get_CertificateValid() ;

/// @brief Method set_CertificateValid addr 0x11874b8 size 0x8 virtual false final false
 void set_CertificateValid(Org::BouncyCastle::Utilities::Date::DateTimeObject value) ;

/// @brief Method get_ExtendedKeyUsage addr 0x11872d8 size 0x8 virtual false final false
 Org::BouncyCastle::Utilities::Collections::ISet get_ExtendedKeyUsage() ;

/// @brief Method set_ExtendedKeyUsage addr 0x1187530 size 0x1c virtual false final false
 void set_ExtendedKeyUsage(Org::BouncyCastle::Utilities::Collections::ISet value) ;

/// @brief Method get_IgnoreX509NameOrdering addr 0x118754c size 0x8 virtual false final false
 bool get_IgnoreX509NameOrdering() ;

/// @brief Method set_IgnoreX509NameOrdering addr 0x1187554 size 0xc virtual false final false
 void set_IgnoreX509NameOrdering(bool value) ;

/// @brief Method get_Issuer addr 0x1187560 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Name get_Issuer() ;

/// @brief Method set_Issuer addr 0x1187568 size 0x8 virtual false final false
 void set_Issuer(Org::BouncyCastle::Asn1::X509::X509Name value) ;

/// @brief Method get_IssuerAsString addr 0x1187570 size 0x18 virtual false final false
 ::StringW get_IssuerAsString() ;

/// @brief Method get_KeyUsage addr 0x11872e0 size 0x8 virtual false final false
 ::ArrayW<bool> get_KeyUsage() ;

/// @brief Method set_KeyUsage addr 0x1187600 size 0x1c virtual false final false
 void set_KeyUsage(::ArrayW<bool> value) ;

/// @brief Method get_Policy addr 0x11872e8 size 0x8 virtual false final false
 Org::BouncyCastle::Utilities::Collections::ISet get_Policy() ;

/// @brief Method set_Policy addr 0x118761c size 0x1c virtual false final false
 void set_Policy(Org::BouncyCastle::Utilities::Collections::ISet value) ;

/// @brief Method get_PrivateKeyValid addr 0x1187638 size 0x8 virtual false final false
 Org::BouncyCastle::Utilities::Date::DateTimeObject get_PrivateKeyValid() ;

/// @brief Method set_PrivateKeyValid addr 0x1187640 size 0x8 virtual false final false
 void set_PrivateKeyValid(Org::BouncyCastle::Utilities::Date::DateTimeObject value) ;

/// @brief Method get_SerialNumber addr 0x1187648 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_SerialNumber() ;

/// @brief Method set_SerialNumber addr 0x1187650 size 0x8 virtual false final false
 void set_SerialNumber(Org::BouncyCastle::Math::BigInteger value) ;

/// @brief Method get_Subject addr 0x1187658 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Name get_Subject() ;

/// @brief Method set_Subject addr 0x1187660 size 0x8 virtual false final false
 void set_Subject(Org::BouncyCastle::Asn1::X509::X509Name value) ;

/// @brief Method get_SubjectAsString addr 0x1187668 size 0x18 virtual false final false
 ::StringW get_SubjectAsString() ;

/// @brief Method get_SubjectKeyIdentifier addr 0x11872f0 size 0x5c virtual false final false
 ::ArrayW<uint8_t> get_SubjectKeyIdentifier() ;

/// @brief Method set_SubjectKeyIdentifier addr 0x1185aa4 size 0x6c virtual false final false
 void set_SubjectKeyIdentifier(::ArrayW<uint8_t> value) ;

/// @brief Method get_SubjectPublicKey addr 0x1187680 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo get_SubjectPublicKey() ;

/// @brief Method set_SubjectPublicKey addr 0x1187688 size 0x8 virtual false final false
 void set_SubjectPublicKey(Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo value) ;

/// @brief Method get_SubjectPublicKeyAlgID addr 0x1187690 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_SubjectPublicKeyAlgID() ;

/// @brief Method set_SubjectPublicKeyAlgID addr 0x1187698 size 0x8 virtual false final false
 void set_SubjectPublicKeyAlgID(Org::BouncyCastle::Asn1::DerObjectIdentifier value) ;

/// @brief Method Match addr 0x11876a0 size 0xbd0 virtual true final false
 bool Match(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method IssuersMatch addr 0x1188350 size 0x1c virtual false final false
static bool IssuersMatch(Org::BouncyCastle::Asn1::X509::X509Name a, Org::BouncyCastle::Asn1::X509::X509Name b) ;

/// @brief Method CopyBoolArray addr 0x1187588 size 0x78 virtual false final false
static ::ArrayW<bool> CopyBoolArray(::ArrayW<bool> b) ;

/// @brief Method CopySet addr 0x11874c0 size 0x70 virtual false final false
static Org::BouncyCastle::Utilities::Collections::ISet CopySet(Org::BouncyCastle::Utilities::Collections::ISet s) ;

/// @brief Method GetSubjectPublicKey addr 0x1188328 size 0x28 virtual false final false
static Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo GetSubjectPublicKey(Org::BouncyCastle::X509::X509Certificate c) ;

/// @brief Method MatchExtension addr 0x1188270 size 0xb8 virtual false final false
