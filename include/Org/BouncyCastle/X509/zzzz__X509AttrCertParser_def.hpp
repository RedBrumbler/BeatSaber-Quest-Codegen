...
/// @brief Method ReadDerCertificate addr 0x10f8d80 size 0x240 virtual false final false
 Org::BouncyCastle::X509::IX509AttributeCertificate ReadDerCertificate(Org::BouncyCastle::Asn1::Asn1InputStream dIn) ;

/// @brief Method GetCertificate addr 0x10f8fc0 size 0x128 virtual false final false
 Org::BouncyCastle::X509::IX509AttributeCertificate GetCertificate() ;

/// @brief Method ReadPemCertificate addr 0x10f9258 size 0xbc virtual false final false
 Org::BouncyCastle::X509::IX509AttributeCertificate ReadPemCertificate(System::IO::Stream inStream) ;

/// @brief Method ReadAttrCert addr 0x10f9314 size 0x78 virtual false final false
 Org::BouncyCastle::X509::IX509AttributeCertificate ReadAttrCert(::ArrayW<uint8_t> input) ;

/// @brief Method ReadAttrCerts addr 0x10f9678 size 0x78 virtual false final false
 System::Collections::ICollection ReadAttrCerts(::ArrayW<uint8_t> input) ;

/// @brief Method ReadAttrCert addr 0x10f938c size 0x2ec virtual false final false
 Org::BouncyCastle::X509::IX509AttributeCertificate ReadAttrCert(System::IO::Stream inStream) ;

/// @brief Method ReadAttrCerts addr 0x10f96f0 size 0x110 virtual false final false
 System::Collections::ICollection ReadAttrCerts(System::IO::Stream inStream) ;

// Ctor Parameters []
explicit X509AttrCertParser() ;

/// @brief Method .ctor addr 0x10f9890 size 0x8 virtual false final false
 void _ctor() ;
