...
/// @brief Method .ctor addr 0x10f9be8 size 0x68 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x10f9c50 size 0x530 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::X509::X509CertificateStructure c) ;

/// @brief Method get_CertificateStructure addr 0x10fa464 size 0x8 virtual true final false
 Org::BouncyCastle::Asn1::X509::X509CertificateStructure get_CertificateStructure() ;

/// @brief Method get_IsValidNow addr 0x10fa46c size 0x6c virtual true final false
 bool get_IsValidNow() ;

/// @brief Method IsValid addr 0x10fa4d8 size 0xd0 virtual true final false
 bool IsValid(System::DateTime time) ;

/// @brief Method CheckValidity addr 0x10fa5a8 size 0x6c virtual true final false
 void CheckValidity() ;

/// @brief Method CheckValidity addr 0x10fa614 size 0x1cc virtual true final false
 void CheckValidity(System::DateTime time) ;

/// @brief Method get_Version addr 0x10fa7e0 size 0x1c virtual true final false
 int32_t get_Version() ;

/// @brief Method get_SerialNumber addr 0x10fa7fc size 0x28 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_SerialNumber() ;

/// @brief Method get_IssuerDN addr 0x10fa824 size 0x1c virtual true final false
 Org::BouncyCastle::Asn1::X509::X509Name get_IssuerDN() ;

/// @brief Method get_SubjectDN addr 0x10fa840 size 0x1c virtual true final false
 Org::BouncyCastle::Asn1::X509::X509Name get_SubjectDN() ;

/// @brief Method get_NotBefore addr 0x10fa85c size 0x28 virtual true final false
 System::DateTime get_NotBefore() ;

/// @brief Method get_NotAfter addr 0x10fa884 size 0x28 virtual true final false
 System::DateTime get_NotAfter() ;

/// @brief Method GetTbsCertificate addr 0x10fa8ac size 0x24 virtual true final false
 ::ArrayW<uint8_t> GetTbsCertificate() ;

/// @brief Method GetSignature addr 0x10fa8d0 size 0x1c virtual true final false
 ::ArrayW<uint8_t> GetSignature() ;

/// @brief Method get_SigAlgName addr 0x10fa8ec size 0x8 virtual true final false
 ::StringW get_SigAlgName() ;

/// @brief Method get_SigAlgOid addr 0x10fa8f4 size 0x34 virtual true final false
 ::StringW get_SigAlgOid() ;

/// @brief Method GetSigAlgParams addr 0x10fa928 size 0x5c virtual true final false
 ::ArrayW<uint8_t> GetSigAlgParams() ;

/// @brief Method get_IssuerUniqueID addr 0x10fa984 size 0x24 virtual true final false
 Org::BouncyCastle::Asn1::DerBitString get_IssuerUniqueID() ;

/// @brief Method get_SubjectUniqueID addr 0x10fa9a8 size 0x24 virtual true final false
 Org::BouncyCastle::Asn1::DerBitString get_SubjectUniqueID() ;

/// @brief Method GetKeyUsage addr 0x10fa9cc size 0x5c virtual true final false
 ::ArrayW<bool> GetKeyUsage() ;

/// @brief Method GetExtendedKeyUsage addr 0x10faa28 size 0x4d4 virtual true final false
 System::Collections::IList GetExtendedKeyUsage() ;

/// @brief Method GetBasicConstraints addr 0x10faefc size 0x68 virtual true final false
 int32_t GetBasicConstraints() ;

/// @brief Method GetSubjectAlternativeNames addr 0x10faf64 size 0x54 virtual true final false
 System::Collections::ICollection GetSubjectAlternativeNames() ;

/// @brief Method GetIssuerAlternativeNames addr 0x10fafb8 size 0x54 virtual true final false
 System::Collections::ICollection GetIssuerAlternativeNames() ;

/// @brief Method GetAlternativeNames addr 0x10fb00c size 0x2dc virtual true final false
 System::Collections::ICollection GetAlternativeNames(::StringW oid) ;

/// @brief Method GetX509Extensions addr 0x10fb2e8 size 0x44 virtual true final false
 Org::BouncyCastle::Asn1::X509::X509Extensions GetX509Extensions() ;

/// @brief Method GetPublicKey addr 0x10fb32c size 0x94 virtual true final false
 Org::BouncyCastle::Crypto::AsymmetricKeyParameter GetPublicKey() ;

/// @brief Method GetEncoded addr 0x10fb3c0 size 0x1c virtual true final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method Equals addr 0x10fb3dc size 0x118 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method GetHashCode addr 0x10fb4f4 size 0x5c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x10fb550 size 0xd48 virtual true final false
 ::StringW ToString() ;

/// @brief Method Verify addr 0x10fc298 size 0x90 virtual true final false
 void Verify(Org::BouncyCastle::Crypto::AsymmetricKeyParameter key) ;

/// @brief Method Verify addr 0x10fc328 size 0xc8 virtual true final false
 void Verify(Org::BouncyCastle::Crypto::IVerifierFactoryProvider verifierProvider) ;

/// @brief Method CheckSignature addr 0x10fc3f0 size 0x3e4 virtual true final false
 void CheckSignature(Org::BouncyCastle::Crypto::IVerifierFactory verifier) ;

/// @brief Method IsAlgIDEqual addr 0x10fc7d4 size 0x14c virtual false final false
