...
/// @brief Method .ctor addr 0x10f6cfc size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x10f6d30 size 0xdc virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::X509::X509Name principal) ;

/// @brief Method GetNames addr 0x10f6e0c size 0x1fc virtual false final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetNames() ;

/// @brief Method GetPrincipals addr 0x10f7008 size 0x1c0 virtual false final false
 ::ArrayW<Org::BouncyCastle::Asn1::X509::X509Name> GetPrincipals() ;

/// @brief Method MatchesDN addr 0x10f71c8 size 0x180 virtual false final false
 bool MatchesDN(Org::BouncyCastle::Asn1::X509::X509Name subject, Org::BouncyCastle::Asn1::X509::GeneralNames targets) ;

/// @brief Method Clone addr 0x10f7348 size 0x80 virtual true final true
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method Match addr 0x10f73c8 size 0x18c virtual false final false
 bool Match(Org::BouncyCastle::X509::X509Certificate x509Cert) ;

/// @brief Method Equals addr 0x10f7554 size 0xa8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x10f75fc size 0x1c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Match addr 0x10f7618 size 0x8c virtual true final true
