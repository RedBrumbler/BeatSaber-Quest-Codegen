...
/// @brief Method .ctor addr 0x1106fc8 size 0x9c virtual false final false
 void _ctor() ;

/// @brief Method Reset addr 0x1107064 size 0x6c virtual false final false
 void Reset() ;

/// @brief Method SetHolder addr 0x11070d0 size 0x24 virtual false final false
 void SetHolder(Org::BouncyCastle::X509::AttributeCertificateHolder holder) ;

/// @brief Method SetIssuer addr 0x11070f4 size 0x2c virtual false final false
 void SetIssuer(Org::BouncyCastle::X509::AttributeCertificateIssuer issuer) ;

/// @brief Method SetSerialNumber addr 0x1107120 size 0x78 virtual false final false
 void SetSerialNumber(Org::BouncyCastle::Math::BigInteger serialNumber) ;

/// @brief Method SetNotBefore addr 0x1107198 size 0x78 virtual false final false
 void SetNotBefore(System::DateTime date) ;

/// @brief Method SetNotAfter addr 0x1107210 size 0x78 virtual false final false
 void SetNotAfter(System::DateTime date) ;

/// @brief Method SetSignatureAlgorithm addr 0x1107288 size 0x15c virtual false final false
 void SetSignatureAlgorithm(::StringW signatureAlgorithm) ;

/// @brief Method AddAttribute addr 0x11073e4 size 0x44 virtual false final false
 void AddAttribute(Org::BouncyCastle::X509::X509Attribute attribute) ;

/// @brief Method SetIssuerUniqueId addr 0x1107428 size 0x44 virtual false final false
 void SetIssuerUniqueId(::ArrayW<bool> iui) ;

/// @brief Method AddExtension addr 0x110746c size 0x98 virtual false final false
 void AddExtension(::StringW oid, bool critical, Org::BouncyCastle::Asn1::Asn1Encodable extensionValue) ;

/// @brief Method AddExtension addr 0x1107504 size 0x98 virtual false final false
 void AddExtension(::StringW oid, bool critical, ::ArrayW<uint8_t> extensionValue) ;

/// @brief Method Generate addr 0x110759c size 0x8 virtual false final false
 Org::BouncyCastle::X509::IX509AttributeCertificate Generate(Org::BouncyCastle::Crypto::AsymmetricKeyParameter privateKey) ;

/// @brief Method Generate addr 0x11075a4 size 0x84 virtual false final false
...
/// @brief Method Generate addr 0x1107628 size 0x57c virtual false final false
...
/// @brief Method get_SignatureAlgNames addr 0x1107ba4 size 0x4c virtual false final false
