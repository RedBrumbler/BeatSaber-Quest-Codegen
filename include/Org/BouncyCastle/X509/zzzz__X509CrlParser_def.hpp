...
/// @brief Method .ctor addr 0x1101100 size 0x1c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "lazyAsn1", ty: "bool", modifiers: "", def_value: None }]
explicit X509CrlParser(bool lazyAsn1) ;

/// @brief Method .ctor addr 0x110111c size 0x28 virtual false final false
 void _ctor(bool lazyAsn1) ;

/// @brief Method ReadPemCrl addr 0x1101144 size 0xa8 virtual false final false
 Org::BouncyCastle::X509::X509Crl ReadPemCrl(System::IO::Stream inStream) ;

/// @brief Method ReadDerCrl addr 0x11011ec size 0x218 virtual false final false
 Org::BouncyCastle::X509::X509Crl ReadDerCrl(Org::BouncyCastle::Asn1::Asn1InputStream dIn) ;

/// @brief Method GetCrl addr 0x1101404 size 0x84 virtual false final false
 Org::BouncyCastle::X509::X509Crl GetCrl() ;

/// @brief Method CreateX509Crl addr 0x1101488 size 0x60 virtual true final false
 Org::BouncyCastle::X509::X509Crl CreateX509Crl(Org::BouncyCastle::Asn1::X509::CertificateList c) ;

/// @brief Method ReadCrl addr 0x11014e8 size 0x78 virtual false final false
 Org::BouncyCastle::X509::X509Crl ReadCrl(::ArrayW<uint8_t> input) ;

/// @brief Method ReadCrls addr 0x11018c0 size 0x78 virtual false final false
 System::Collections::ICollection ReadCrls(::ArrayW<uint8_t> input) ;

/// @brief Method ReadCrl addr 0x1101560 size 0x360 virtual false final false
 Org::BouncyCastle::X509::X509Crl ReadCrl(System::IO::Stream inStream) ;

/// @brief Method ReadCrls addr 0x1101938 size 0x110 virtual false final false
