...
/// @brief Method .ctor addr 0x10fdc44 size 0x1bc virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::X509::CertificateList c) ;

/// @brief Method GetX509Extensions addr 0x10fde00 size 0x44 virtual true final false
 Org::BouncyCastle::Asn1::X509::X509Extensions GetX509Extensions() ;

/// @brief Method GetEncoded addr 0x10fde44 size 0xf8 virtual true final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method Verify addr 0x10fdf3c size 0x80 virtual true final false
 void Verify(Org::BouncyCastle::Crypto::AsymmetricKeyParameter publicKey) ;

/// @brief Method Verify addr 0x10fdfbc size 0xc8 virtual true final false
 void Verify(Org::BouncyCastle::Crypto::IVerifierFactoryProvider verifierProvider) ;

/// @brief Method CheckSignature addr 0x10fe084 size 0x3ec virtual true final false
 void CheckSignature(Org::BouncyCastle::Crypto::IVerifierFactory verifier) ;

/// @brief Method get_Version addr 0x10fe470 size 0x1c virtual true final false
 int32_t get_Version() ;

/// @brief Method get_IssuerDN addr 0x10fe48c size 0x1c virtual true final false
 Org::BouncyCastle::Asn1::X509::X509Name get_IssuerDN() ;

/// @brief Method get_ThisUpdate addr 0x10fe4a8 size 0x28 virtual true final false
 System::DateTime get_ThisUpdate() ;

/// @brief Method get_NextUpdate addr 0x10fe4d0 size 0xa4 virtual true final false
 Org::BouncyCastle::Utilities::Date::DateTimeObject get_NextUpdate() ;

/// @brief Method LoadCrlEntries addr 0x10fe574 size 0x46c virtual false final false
 Org::BouncyCastle::Utilities::Collections::ISet LoadCrlEntries() ;

/// @brief Method GetRevokedCertificate addr 0x10fea2c size 0x438 virtual true final false
 Org::BouncyCastle::X509::X509CrlEntry GetRevokedCertificate(Org::BouncyCastle::Math::BigInteger serialNumber) ;

/// @brief Method GetRevokedCertificates addr 0x10fee64 size 0xb8 virtual true final false
 Org::BouncyCastle::Utilities::Collections::ISet GetRevokedCertificates() ;

/// @brief Method GetTbsCertList addr 0x10fef1c size 0x108 virtual true final false
 ::ArrayW<uint8_t> GetTbsCertList() ;

/// @brief Method GetSignature addr 0x10ff024 size 0x1c virtual true final false
 ::ArrayW<uint8_t> GetSignature() ;

/// @brief Method get_SigAlgName addr 0x10ff040 size 0x8 virtual true final false
 ::StringW get_SigAlgName() ;

/// @brief Method get_SigAlgOid addr 0x10ff048 size 0x34 virtual true final false
 ::StringW get_SigAlgOid() ;

/// @brief Method GetSigAlgParams addr 0x10ff07c size 0x5c virtual true final false
 ::ArrayW<uint8_t> GetSigAlgParams() ;

/// @brief Method Equals addr 0x10ff0d8 size 0x118 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method GetHashCode addr 0x10ff1f0 size 0x5c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x10ff24c size 0xfe0 virtual true final false
 ::StringW ToString() ;

/// @brief Method IsRevoked addr 0x110022c size 0xc4 virtual true final false
 bool IsRevoked(Org::BouncyCastle::X509::X509Certificate cert) ;

/// @brief Method get_IsIndirectCrl addr 0x11002f0 size 0x164 virtual true final false
