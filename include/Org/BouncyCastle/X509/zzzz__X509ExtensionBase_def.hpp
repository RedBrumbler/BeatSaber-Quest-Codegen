...
/// @brief Method GetExtensionOids addr 0x101d414 size 0x3f0 virtual true final false
 Org::BouncyCastle::Utilities::Collections::ISet GetExtensionOids(bool critical) ;

/// @brief Method GetNonCriticalExtensionOids addr 0x101d804 size 0x10 virtual true final false
 Org::BouncyCastle::Utilities::Collections::ISet GetNonCriticalExtensionOids() ;

/// @brief Method GetCriticalExtensionOids addr 0x101d814 size 0x10 virtual true final false
 Org::BouncyCastle::Utilities::Collections::ISet GetCriticalExtensionOids() ;

/// @brief Method GetExtensionValue addr 0x101d824 size 0x7c virtual true final true
 Org::BouncyCastle::Asn1::Asn1OctetString GetExtensionValue(::StringW oid) ;

/// @brief Method GetExtensionValue addr 0x101d8a0 size 0x38 virtual true final false
...
/// @brief Method .ctor addr 0x101d8d8 size 0x8 virtual false final false
 void _ctor() ;
