...
/// @brief Method ReadDerCertificate addr 0x10fcd84 size 0x218 virtual false final false
 Org::BouncyCastle::X509::X509Certificate ReadDerCertificate(Org::BouncyCastle::Asn1::Asn1InputStream dIn) ;

/// @brief Method GetCertificate addr 0x10fcf9c size 0xe4 virtual false final false
 Org::BouncyCastle::X509::X509Certificate GetCertificate() ;

/// @brief Method ReadPemCertificate addr 0x10fd080 size 0xa8 virtual false final false
 Org::BouncyCastle::X509::X509Certificate ReadPemCertificate(System::IO::Stream inStream) ;

/// @brief Method CreateX509Certificate addr 0x10fd128 size 0x60 virtual true final false
 Org::BouncyCastle::X509::X509Certificate CreateX509Certificate(Org::BouncyCastle::Asn1::X509::X509CertificateStructure c) ;

/// @brief Method ReadCertificate addr 0x10fd188 size 0x78 virtual false final false
 Org::BouncyCastle::X509::X509Certificate ReadCertificate(::ArrayW<uint8_t> input) ;

/// @brief Method ReadCertificates addr 0x10fd4e4 size 0x78 virtual false final false
 System::Collections::ICollection ReadCertificates(::ArrayW<uint8_t> input) ;

/// @brief Method ReadCertificate addr 0x10fd200 size 0x2e4 virtual false final false
 Org::BouncyCastle::X509::X509Certificate ReadCertificate(System::IO::Stream inStream) ;

/// @brief Method ReadCertificates addr 0x10fd55c size 0x110 virtual false final false
 System::Collections::ICollection ReadCertificates(System::IO::Stream inStream) ;

// Ctor Parameters []
explicit X509CertificateParser() ;

/// @brief Method .ctor addr 0x10fd6fc size 0x8 virtual false final false
 void _ctor() ;
