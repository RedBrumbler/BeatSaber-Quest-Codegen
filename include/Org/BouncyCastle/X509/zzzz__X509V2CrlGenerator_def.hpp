...
/// @brief Method .ctor addr 0x1107bf0 size 0x9c virtual false final false
 void _ctor() ;

/// @brief Method Reset addr 0x1107c8c size 0x6c virtual false final false
 void Reset() ;

/// @brief Method SetIssuerDN addr 0x1107cf8 size 0x1c virtual false final false
 void SetIssuerDN(Org::BouncyCastle::Asn1::X509::X509Name issuer) ;

/// @brief Method SetThisUpdate addr 0x1107d14 size 0x78 virtual false final false
 void SetThisUpdate(System::DateTime date) ;

/// @brief Method SetNextUpdate addr 0x1107d8c size 0x78 virtual false final false
 void SetNextUpdate(System::DateTime date) ;

/// @brief Method AddCrlEntry addr 0x1107e04 size 0xc8 virtual false final false
 void AddCrlEntry(Org::BouncyCastle::Math::BigInteger userCertificate, System::DateTime revocationDate, int32_t reason) ;

/// @brief Method AddCrlEntry addr 0x1107ecc size 0x100 virtual false final false
...
/// @brief Method AddCrlEntry addr 0x1107fcc size 0xc8 virtual false final false
...
/// @brief Method AddCrl addr 0x1108094 size 0x4a0 virtual false final false
 void AddCrl(Org::BouncyCastle::X509::X509Crl other) ;

/// @brief Method SetSignatureAlgorithm addr 0x1108534 size 0x164 virtual false final false
 void SetSignatureAlgorithm(::StringW signatureAlgorithm) ;

/// @brief Method AddExtension addr 0x1108698 size 0x98 virtual false final false
 void AddExtension(::StringW oid, bool critical, Org::BouncyCastle::Asn1::Asn1Encodable extensionValue) ;

/// @brief Method AddExtension addr 0x1108730 size 0x20 virtual false final false
...
/// @brief Method AddExtension addr 0x1108750 size 0xc8 virtual false final false
 void AddExtension(::StringW oid, bool critical, ::ArrayW<uint8_t> extensionValue) ;

/// @brief Method AddExtension addr 0x1108818 size 0x98 virtual false final false
 void AddExtension(Org::BouncyCastle::Asn1::DerObjectIdentifier oid, bool critical, ::ArrayW<uint8_t> extensionValue) ;

/// @brief Method Generate addr 0x11088b0 size 0x8 virtual false final false
 Org::BouncyCastle::X509::X509Crl Generate(Org::BouncyCastle::Crypto::AsymmetricKeyParameter privateKey) ;

/// @brief Method Generate addr 0x11088b8 size 0x84 virtual false final false
...
/// @brief Method Generate addr 0x110893c size 0x464 virtual false final false
 Org::BouncyCastle::X509::X509Crl Generate(Org::BouncyCastle::Crypto::ISignatureFactory signatureCalculatorFactory) ;

/// @brief Method GenerateCertList addr 0x1108da0 size 0x58 virtual false final false
 Org::BouncyCastle::Asn1::X509::TbsCertificateList GenerateCertList() ;

/// @brief Method GenerateJcaObject addr 0x1108df8 size 0x18c virtual false final false
...
/// @brief Method get_SignatureAlgNames addr 0x1108f84 size 0x4c virtual false final false
