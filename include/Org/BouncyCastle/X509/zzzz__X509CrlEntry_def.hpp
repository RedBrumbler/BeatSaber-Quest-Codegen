...
/// @brief Method .ctor addr 0x1100454 size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x10fe9e0 size 0x4c virtual false final false
...
/// @brief Method loadCertificateIssuer addr 0x1100488 size 0x1a4 virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Name loadCertificateIssuer() ;

/// @brief Method GetCertificateIssuer addr 0x110062c size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Name GetCertificateIssuer() ;

/// @brief Method GetX509Extensions addr 0x1100634 size 0x1c virtual true final false
 Org::BouncyCastle::Asn1::X509::X509Extensions GetX509Extensions() ;

/// @brief Method GetEncoded addr 0x1100650 size 0xf8 virtual false final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method get_SerialNumber addr 0x1100748 size 0x24 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_SerialNumber() ;

/// @brief Method get_RevocationDate addr 0x110076c size 0x24 virtual false final false
 System::DateTime get_RevocationDate() ;

/// @brief Method get_HasExtensions addr 0x1100790 size 0x28 virtual false final false
 bool get_HasExtensions() ;

/// @brief Method Equals addr 0x11007b8 size 0xf4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method GetHashCode addr 0x11008ac size 0x5c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x1100908 size 0x7f8 virtual true final false
 ::StringW ToString() ;
