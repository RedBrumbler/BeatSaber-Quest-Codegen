...
/// @brief Method .ctor addr 0x10f76a4 size 0x118 virtual false final false
 void _ctor(::StringW type) ;

/// @brief Method ReadLine addr 0x10f77bc size 0xd0 virtual false final false
 ::StringW ReadLine(System::IO::Stream inStream) ;

/// @brief Method ReadPemObject addr 0x10f788c size 0x214 virtual false final false
