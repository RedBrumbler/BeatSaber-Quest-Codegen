...
/// @brief Method GetObject addr 0x1105ac4 size 0x124 virtual false final false
...
/// @brief Method .ctor addr 0x1105be8 size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0x1105c08 size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x10f90e8 size 0x170 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::X509::AttributeCertificate cert) ;

/// @brief Method get_Version addr 0x1105c88 size 0x34 virtual true final false
 int32_t get_Version() ;

/// @brief Method get_SerialNumber addr 0x1105cbc size 0x2c virtual true final false
 Org::BouncyCastle::Math::BigInteger get_SerialNumber() ;

/// @brief Method get_Holder addr 0x1105ce8 size 0xe0 virtual true final false
 Org::BouncyCastle::X509::AttributeCertificateHolder get_Holder() ;

/// @brief Method get_Issuer addr 0x1105dc8 size 0x78 virtual true final false
 Org::BouncyCastle::X509::AttributeCertificateIssuer get_Issuer() ;

/// @brief Method get_NotBefore addr 0x1105e40 size 0x8 virtual true final false
 System::DateTime get_NotBefore() ;

/// @brief Method get_NotAfter addr 0x1105e48 size 0x8 virtual true final false
 System::DateTime get_NotAfter() ;

/// @brief Method GetIssuerUniqueID addr 0x1105e50 size 0x110 virtual true final false
 ::ArrayW<bool> GetIssuerUniqueID() ;

/// @brief Method get_IsValidNow addr 0x1105f60 size 0x6c virtual true final false
 bool get_IsValidNow() ;

/// @brief Method IsValid addr 0x1105fcc size 0xd0 virtual true final false
 bool IsValid(System::DateTime date) ;

/// @brief Method CheckValidity addr 0x110609c size 0x6c virtual true final false
 void CheckValidity() ;

/// @brief Method CheckValidity addr 0x1106108 size 0x1c8 virtual true final false
 void CheckValidity(System::DateTime date) ;

/// @brief Method get_SignatureAlgorithm addr 0x11062d0 size 0x1c virtual true final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_SignatureAlgorithm() ;

/// @brief Method GetSignature addr 0x11062ec size 0x1c virtual true final false
 ::ArrayW<uint8_t> GetSignature() ;

/// @brief Method Verify addr 0x1106308 size 0x90 virtual true final false
 void Verify(Org::BouncyCastle::Crypto::AsymmetricKeyParameter key) ;

/// @brief Method Verify addr 0x1106398 size 0xc8 virtual true final false
 void Verify(Org::BouncyCastle::Crypto::IVerifierFactoryProvider verifierProvider) ;

/// @brief Method CheckSignature addr 0x1106460 size 0x4bc virtual true final false
 void CheckSignature(Org::BouncyCastle::Crypto::IVerifierFactory verifier) ;

/// @brief Method GetEncoded addr 0x110691c size 0x1c virtual true final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method GetX509Extensions addr 0x1106938 size 0x24 virtual true final false
 Org::BouncyCastle::Asn1::X509::X509Extensions GetX509Extensions() ;

/// @brief Method GetAttributes addr 0x110695c size 0x168 virtual true final false
 ::ArrayW<Org::BouncyCastle::X509::X509Attribute> GetAttributes() ;

/// @brief Method GetAttributes addr 0x1106ac4 size 0x438 virtual true final false
 ::ArrayW<Org::BouncyCastle::X509::X509Attribute> GetAttributes(::StringW oid) ;

/// @brief Method Equals addr 0x1106efc size 0xb0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x1106fac size 0x1c virtual true final false
 int32_t GetHashCode() ;
