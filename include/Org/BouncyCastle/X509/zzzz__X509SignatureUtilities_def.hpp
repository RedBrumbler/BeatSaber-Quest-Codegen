...
/// @brief Method SetSignatureParameters addr 0x1101b68 size 0x7c virtual false final false
...
/// @brief Method GetSignatureName addr 0x10fa180 size 0x2e4 virtual false final false
static ::StringW GetSignatureName(Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier sigAlgId) ;

/// @brief Method GetDigestAlgName addr 0x1101be4 size 0x370 virtual false final false
static ::StringW GetDigestAlgName(Org::BouncyCastle::Asn1::DerObjectIdentifier digestAlgOID) ;

// Ctor Parameters []
explicit X509SignatureUtilities() ;

/// @brief Method .ctor addr 0x1101fcc size 0x8 virtual false final false
 void _ctor() ;
