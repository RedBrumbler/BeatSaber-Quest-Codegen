...
/// @brief Method ReadDerCrossCertificatePair addr 0x10fd704 size 0xf4 virtual false final false
 Org::BouncyCastle::X509::X509CertificatePair ReadDerCrossCertificatePair(System::IO::Stream inStream) ;

/// @brief Method ReadCertPair addr 0x10fd7f8 size 0x78 virtual false final false
 Org::BouncyCastle::X509::X509CertificatePair ReadCertPair(::ArrayW<uint8_t> input) ;

/// @brief Method ReadCertPairs addr 0x10fdab4 size 0x78 virtual false final false
 System::Collections::ICollection ReadCertPairs(::ArrayW<uint8_t> input) ;

/// @brief Method ReadCertPair addr 0x10fd870 size 0x244 virtual false final false
 Org::BouncyCastle::X509::X509CertificatePair ReadCertPair(System::IO::Stream inStream) ;

/// @brief Method ReadCertPairs addr 0x10fdb2c size 0x110 virtual false final false
 System::Collections::ICollection ReadCertPairs(System::IO::Stream inStream) ;

// Ctor Parameters []
explicit X509CertPairParser() ;

/// @brief Method .ctor addr 0x10fdc3c size 0x8 virtual false final false
 void _ctor() ;
