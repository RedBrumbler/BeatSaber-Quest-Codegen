...
/// @brief Method .ctor addr 0x10f7df0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method CreateSubjectPublicKeyInfo addr 0x10f7df8 size 0xdbc virtual false final false
...
/// @brief Method ExtractBytes addr 0x10f8cc0 size 0xc0 virtual false final false
static void ExtractBytes(::ArrayW<uint8_t> encKey, int32_t offset, Org::BouncyCastle::Math::BigInteger bI) ;

/// @brief Method ExtractBytes addr 0x10f8bb4 size 0x10c virtual false final false
