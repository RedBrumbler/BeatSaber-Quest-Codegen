...
/// @brief Method .ctor addr 0x10fc920 size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x10fc94c size 0xa8 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::X509::CertificatePair pair) ;

/// @brief Method GetEncoded addr 0x10fc9f4 size 0x270 virtual false final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method get_Forward addr 0x10fcc64 size 0x8 virtual false final false
 Org::BouncyCastle::X509::X509Certificate get_Forward() ;

/// @brief Method get_Reverse addr 0x10fcc6c size 0x8 virtual false final false
 Org::BouncyCastle::X509::X509Certificate get_Reverse() ;

/// @brief Method Equals addr 0x10fcc74 size 0xc0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x10fcd34 size 0x50 virtual true final false
 int32_t GetHashCode() ;
