...
/// @brief Method .ctor addr 0x10f5a54 size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x10f5a88 size 0xf4 virtual false final false
...
/// @brief Method .ctor addr 0x10f5c10 size 0x1e4 virtual false final false
...
/// @brief Method .ctor addr 0x10f5df4 size 0x8c virtual false final false
...
/// @brief Method .ctor addr 0x10f5e80 size 0x168 virtual false final false
 void _ctor(int32_t digestedObjectType, ::StringW digestAlgorithm, ::StringW otherObjectTypeID, ::ArrayW<uint8_t> objectDigest) ;

/// @brief Method get_DigestedObjectType addr 0x10f5fe8 size 0x38 virtual false final false
 int32_t get_DigestedObjectType() ;

/// @brief Method get_DigestAlgorithm addr 0x10f6020 size 0x44 virtual false final false
 ::StringW get_DigestAlgorithm() ;

/// @brief Method GetObjectDigest addr 0x10f6064 size 0x3c virtual false final false
 ::ArrayW<uint8_t> GetObjectDigest() ;

/// @brief Method get_OtherObjectTypeID addr 0x10f60a0 size 0x34 virtual false final false
 ::StringW get_OtherObjectTypeID() ;

/// @brief Method GenerateGeneralNames addr 0x10f5b7c size 0x94 virtual false final false
 Org::BouncyCastle::Asn1::X509::GeneralNames GenerateGeneralNames(Org::BouncyCastle::Asn1::X509::X509Name principal) ;

/// @brief Method MatchesDN addr 0x10f60d4 size 0x180 virtual false final false
 bool MatchesDN(Org::BouncyCastle::Asn1::X509::X509Name subject, Org::BouncyCastle::Asn1::X509::GeneralNames targets) ;

/// @brief Method GetNames addr 0x10f6254 size 0x160 virtual false final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetNames(::ArrayW<Org::BouncyCastle::Asn1::X509::GeneralName> names) ;

/// @brief Method GetPrincipals addr 0x10f63b4 size 0x1d0 virtual false final false
 ::ArrayW<Org::BouncyCastle::Asn1::X509::X509Name> GetPrincipals(Org::BouncyCastle::Asn1::X509::GeneralNames names) ;

/// @brief Method GetEntityNames addr 0x10f6584 size 0x2c virtual false final false
 ::ArrayW<Org::BouncyCastle::Asn1::X509::X509Name> GetEntityNames() ;

/// @brief Method GetIssuer addr 0x10f65b0 size 0x30 virtual false final false
 ::ArrayW<Org::BouncyCastle::Asn1::X509::X509Name> GetIssuer() ;

/// @brief Method get_SerialNumber addr 0x10f65e0 size 0x38 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_SerialNumber() ;

/// @brief Method Clone addr 0x10f6618 size 0xdc virtual true final true
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method Match addr 0x10f66f4 size 0x4b8 virtual false final false
 bool Match(Org::BouncyCastle::X509::X509Certificate x509Cert) ;

/// @brief Method Equals addr 0x10f6bac size 0xa8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x10f6c54 size 0x1c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Match addr 0x10f6c70 size 0x8c virtual true final true
