...
/// @brief Method .ctor addr 0x1104f50 size 0x6c virtual false final false
 void _ctor() ;

/// @brief Method Reset addr 0x1104fbc size 0x60 virtual false final false
 void Reset() ;

/// @brief Method SetSerialNumber addr 0x110501c size 0xe0 virtual false final false
 void SetSerialNumber(Org::BouncyCastle::Math::BigInteger serialNumber) ;

/// @brief Method SetIssuerDN addr 0x11050fc size 0x1c virtual false final false
 void SetIssuerDN(Org::BouncyCastle::Asn1::X509::X509Name issuer) ;

/// @brief Method SetNotBefore addr 0x1105118 size 0x78 virtual false final false
 void SetNotBefore(System::DateTime date) ;

/// @brief Method SetNotAfter addr 0x1105190 size 0x78 virtual false final false
 void SetNotAfter(System::DateTime date) ;

/// @brief Method SetSubjectDN addr 0x1105208 size 0x1c virtual false final false
 void SetSubjectDN(Org::BouncyCastle::Asn1::X509::X509Name subject) ;

/// @brief Method SetPublicKey addr 0x1105224 size 0x114 virtual false final false
 void SetPublicKey(Org::BouncyCastle::Crypto::AsymmetricKeyParameter publicKey) ;

/// @brief Method SetSignatureAlgorithm addr 0x1105338 size 0x170 virtual false final false
 void SetSignatureAlgorithm(::StringW signatureAlgorithm) ;

/// @brief Method Generate addr 0x11054a8 size 0x8 virtual false final false
 Org::BouncyCastle::X509::X509Certificate Generate(Org::BouncyCastle::Crypto::AsymmetricKeyParameter privateKey) ;

/// @brief Method Generate addr 0x11054b0 size 0x84 virtual false final false
...
/// @brief Method Generate addr 0x1105534 size 0x46c virtual false final false
 Org::BouncyCastle::X509::X509Certificate Generate(Org::BouncyCastle::Crypto::ISignatureFactory signatureCalculatorFactory) ;

/// @brief Method GenerateJcaObject addr 0x11059a0 size 0xd8 virtual false final false
...
/// @brief Method get_SignatureAlgNames addr 0x1105a78 size 0x4c virtual false final false
