...
/// @brief Method GetEnumValue addr 0x10f038c size 0x1e4 virtual false final false
static ::bs_hook::EnumTypeWrapper GetEnumValue(System::Type enumType, ::StringW s) ;

/// @brief Method GetEnumValues addr 0x10f0590 size 0xd8 virtual false final false
static System::Array GetEnumValues(System::Type enumType) ;

/// @brief Method GetArbitraryValue addr 0x10f0668 size 0xe0 virtual false final false
static ::bs_hook::EnumTypeWrapper GetArbitraryValue(System::Type enumType) ;

/// @brief Method IsEnumType addr 0x10f0570 size 0x20 virtual false final false
static bool IsEnumType(System::Type t) ;

// Ctor Parameters []
explicit Enums() ;

/// @brief Method .ctor addr 0x10f0748 size 0x8 virtual false final false
 void _ctor() ;
