...
/// @brief Method .ctor addr 0x10d3114 size 0x28 virtual false final false
 void _ctor(System::DateTime dt) ;

/// @brief Method get_Value addr 0x10dd330 size 0x8 virtual false final false
 System::DateTime get_Value() ;

/// @brief Method ToString addr 0x10dd338 size 0x20 virtual true final false
 ::StringW ToString() ;
