...
/// @brief Method .ctor addr 0x10dd358 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method DateTimeToUnixMs addr 0x10dd360 size 0x15c virtual false final false
static int64_t DateTimeToUnixMs(System::DateTime dateTime) ;

/// @brief Method UnixMsToDateTime addr 0x10dd4bc size 0x94 virtual false final false
static System::DateTime UnixMsToDateTime(int64_t unixMs) ;

/// @brief Method CurrentUnixMs addr 0x10dd550 size 0x84 virtual false final false
