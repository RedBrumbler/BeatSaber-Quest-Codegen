...
explicit TeeInputStream(System::IO::Stream input, System::IO::Stream tee) ;

/// @brief Method .ctor addr 0x10e1eb8 size 0x2c virtual false final false
 void _ctor(System::IO::Stream input, System::IO::Stream tee) ;

/// @brief Method Close addr 0x10e1ee4 size 0x74 virtual true final false
 void Close() ;

/// @brief Method Read addr 0x10e1f58 size 0x78 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method ReadByte addr 0x10e1fd0 size 0x5c virtual true final false
 int32_t ReadByte() ;
