...
/// @brief Method .ctor addr 0x10e18e4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Drain addr 0x10e18ec size 0x84 virtual false final false
static void Drain(System::IO::Stream inStr) ;

/// @brief Method ReadAll addr 0x10e1970 size 0x78 virtual false final false
static ::ArrayW<uint8_t> ReadAll(System::IO::Stream inStr) ;

/// @brief Method ReadAllLimited addr 0x10e1ac8 size 0x88 virtual false final false
static ::ArrayW<uint8_t> ReadAllLimited(System::IO::Stream inStr, int32_t limit) ;

/// @brief Method ReadFully addr 0x10e1c98 size 0x1c virtual false final false
static int32_t ReadFully(System::IO::Stream inStr, ::ArrayW<uint8_t> buf) ;

/// @brief Method ReadFully addr 0x10e1cb4 size 0x80 virtual false final false
static int32_t ReadFully(System::IO::Stream inStr, ::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method PipeAll addr 0x10e19e8 size 0xe0 virtual false final false
static void PipeAll(System::IO::Stream inStr, System::IO::Stream outStr) ;

/// @brief Method PipeAllLimited addr 0x10e1b50 size 0x148 virtual false final false
static int64_t PipeAllLimited(System::IO::Stream inStr, int64_t limit, System::IO::Stream outStr) ;

/// @brief Method WriteBufTo addr 0x10e1d34 size 0x20 virtual false final false
static void WriteBufTo(System::IO::MemoryStream buf, System::IO::Stream output) ;

/// @brief Method WriteBufTo addr 0x10e1d54 size 0xb4 virtual false final false
static int32_t WriteBufTo(System::IO::MemoryStream buf, ::ArrayW<uint8_t> output, int32_t offset) ;

/// @brief Method WriteZeroes addr 0x10e1e08 size 0xb0 virtual false final false
