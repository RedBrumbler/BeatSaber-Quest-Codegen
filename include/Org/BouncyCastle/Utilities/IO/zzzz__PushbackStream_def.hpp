...
/// @brief Method .ctor addr 0x10e17cc size 0x10 virtual false final false
 void _ctor(System::IO::Stream s) ;

/// @brief Method ReadByte addr 0x10e17dc size 0x24 virtual true final false
 int32_t ReadByte() ;

/// @brief Method Read addr 0x10e1800 size 0x60 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Unread addr 0x10e1860 size 0x6c virtual true final false
