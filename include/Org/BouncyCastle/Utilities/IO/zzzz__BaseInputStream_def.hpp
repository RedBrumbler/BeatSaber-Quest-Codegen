...
/// @brief Method get_CanRead addr 0x1142580 size 0x10 virtual true final true
 bool get_CanRead() ;

/// @brief Method get_CanSeek addr 0x1142590 size 0x8 virtual true final true
 bool get_CanSeek() ;

/// @brief Method get_CanWrite addr 0x1142598 size 0x8 virtual true final true
 bool get_CanWrite() ;

/// @brief Method Close addr 0x11425a0 size 0x10 virtual true final false
 void Close() ;

/// @brief Method Flush addr 0x11425b0 size 0x4 virtual true final true
 void Flush() ;

/// @brief Method get_Length addr 0x11425b4 size 0x40 virtual true final true
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x11425f4 size 0x40 virtual true final true
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x1142634 size 0x40 virtual true final true
 void set_Position(int64_t value) ;

/// @brief Method Read addr 0x1142674 size 0x144 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Seek addr 0x11427b8 size 0x40 virtual true final true
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0x11427f8 size 0x40 virtual true final true
 void SetLength(int64_t value) ;

/// @brief Method Write addr 0x1142838 size 0x40 virtual true final true
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

// Ctor Parameters []
explicit BaseInputStream() ;

/// @brief Method .ctor addr 0x1142878 size 0x58 virtual false final false
 void _ctor() ;
