...
/// @brief Method .ctor addr 0x10541c0 size 0x78 virtual false final false
 void _ctor(System::IO::TextReader reader) ;

/// @brief Method get_Reader addr 0x1054238 size 0x8 virtual false final false
 System::IO::TextReader get_Reader() ;

/// @brief Method ReadPemObject addr 0x1054240 size 0x154 virtual false final false
 Org::BouncyCastle::Utilities::IO::Pem::PemObject ReadPemObject() ;

/// @brief Method LoadObject addr 0x1054394 size 0x3d8 virtual false final false
