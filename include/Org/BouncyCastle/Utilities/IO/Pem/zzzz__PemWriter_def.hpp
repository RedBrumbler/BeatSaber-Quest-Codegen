...
/// @brief Method .ctor addr 0x1056ca4 size 0xfc virtual false final false
 void _ctor(System::IO::TextWriter writer) ;

/// @brief Method get_Writer addr 0x1056da0 size 0x8 virtual false final false
 System::IO::TextWriter get_Writer() ;

/// @brief Method GetOutputSize addr 0x1056da8 size 0x4d8 virtual false final false
 int32_t GetOutputSize(Org::BouncyCastle::Utilities::IO::Pem::PemObject obj) ;

/// @brief Method WriteObject addr 0x1057280 size 0x54c virtual false final false
 void WriteObject(Org::BouncyCastle::Utilities::IO::Pem::PemObjectGenerator objGen) ;

/// @brief Method WriteEncoded addr 0x1057860 size 0xe0 virtual false final false
 void WriteEncoded(::ArrayW<uint8_t> bytes) ;

/// @brief Method WritePreEncapsulationBoundary addr 0x10577cc size 0x94 virtual false final false
 void WritePreEncapsulationBoundary(::StringW type) ;

/// @brief Method WritePostEncapsulationBoundary addr 0x1057940 size 0x94 virtual false final false
