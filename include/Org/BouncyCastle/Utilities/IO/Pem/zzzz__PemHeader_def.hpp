...
/// @brief Method .ctor addr 0x10e1518 size 0x2c virtual false final false
 void _ctor(::StringW name, ::StringW val) ;

/// @brief Method get_Name addr 0x10e1544 size 0x8 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_Value addr 0x10e154c size 0x8 virtual true final false
 ::StringW get_Value() ;

/// @brief Method GetHashCode addr 0x10e1554 size 0x58 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x10e15c4 size 0xb4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x10e15ac size 0x18 virtual false final false
