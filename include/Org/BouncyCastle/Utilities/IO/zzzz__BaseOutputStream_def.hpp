...
/// @brief Method get_CanRead addr 0x1140148 size 0x8 virtual true final true
 bool get_CanRead() ;

/// @brief Method get_CanSeek addr 0x1140150 size 0x8 virtual true final true
 bool get_CanSeek() ;

/// @brief Method get_CanWrite addr 0x1140158 size 0x10 virtual true final true
 bool get_CanWrite() ;

/// @brief Method Close addr 0x1140138 size 0x10 virtual true final false
 void Close() ;

/// @brief Method Flush addr 0x1140168 size 0x4 virtual true final false
 void Flush() ;

/// @brief Method get_Length addr 0x114016c size 0x40 virtual true final true
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x11401ac size 0x40 virtual true final true
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x11401ec size 0x40 virtual true final true
 void set_Position(int64_t value) ;

/// @brief Method Read addr 0x114022c size 0x40 virtual true final true
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Seek addr 0x114026c size 0x40 virtual true final true
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0x11402ac size 0x40 virtual true final true
 void SetLength(int64_t value) ;

/// @brief Method Write addr 0x11402ec size 0x80 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Write addr 0x114036c size 0x28 virtual true final false
 void Write(::ArrayW<uint8_t> buffer) ;

/// @brief Method WriteByte addr 0x1140394 size 0x8c virtual true final false
 void WriteByte(uint8_t b) ;

// Ctor Parameters []
explicit BaseOutputStream() ;

/// @brief Method .ctor addr 0x113ff10 size 0x58 virtual false final false
 void _ctor() ;
