...
/// @brief Method WriteByte addr 0x10e17bc size 0x4 virtual true final false
 void WriteByte(uint8_t b) ;

/// @brief Method Write addr 0x10e17c0 size 0x4 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

// Ctor Parameters []
explicit NullOutputStream() ;

/// @brief Method .ctor addr 0x10e17c4 size 0x8 virtual false final false
 void _ctor() ;
