...
/// @brief Method .ctor addr 0x10e202c size 0x2c virtual false final false
 void _ctor(System::IO::Stream output, System::IO::Stream tee) ;

/// @brief Method Close addr 0x10e2058 size 0x74 virtual true final false
 void Close() ;

/// @brief Method Write addr 0x10e20cc size 0x68 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method WriteByte addr 0x10e2134 size 0x50 virtual true final false
