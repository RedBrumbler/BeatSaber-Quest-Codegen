...
/// @brief Method .ctor addr 0x10dc520 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Add addr 0x10dc528 size 0x40 virtual true final false
 int32_t Add(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method Clear addr 0x10dc568 size 0x40 virtual true final false
 void Clear() ;
...
/// @brief Method Insert addr 0x10dc5a8 size 0x40 virtual true final false
...
/// @brief Method get_IsReadOnly addr 0x10dc5e8 size 0x8 virtual true final false
 bool get_IsReadOnly() ;

/// @brief Method get_IsSynchronized addr 0x0 size 0xffffffffffffffff virtual true final false
 bool get_IsSynchronized() ;

/// @brief Method Remove addr 0x10dc5f0 size 0x40 virtual true final false
 void Remove(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method RemoveAt addr 0x10dc630 size 0x40 virtual true final false
...
/// @brief Method get_Item addr 0x10dc670 size 0x10 virtual true final false
 ::bs_hook::Il2CppWrapperType get_Item(int32_t i) ;

/// @brief Method set_Item addr 0x10dc680 size 0x40 virtual true final false
