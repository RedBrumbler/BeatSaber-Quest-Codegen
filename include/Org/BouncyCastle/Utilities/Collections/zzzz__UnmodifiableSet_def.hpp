...
/// @brief Method .ctor addr 0x10dcca8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Add addr 0x10dccb0 size 0x40 virtual true final false
 void Add(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method AddAll addr 0x10dccf0 size 0x40 virtual true final false
 void AddAll(System::Collections::IEnumerable e) ;

/// @brief Method Clear addr 0x10dcd30 size 0x40 virtual true final false
 void Clear() ;
...
/// @brief Method get_IsReadOnly addr 0x10dcd70 size 0x8 virtual true final false
 bool get_IsReadOnly() ;
...
/// @brief Method Remove addr 0x10dcd78 size 0x40 virtual true final false
 void Remove(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method RemoveAll addr 0x10dcdb8 size 0x40 virtual true final false
