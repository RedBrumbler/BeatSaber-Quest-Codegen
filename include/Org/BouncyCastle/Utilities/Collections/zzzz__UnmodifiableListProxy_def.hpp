...
/// @brief Method .ctor addr 0x10d9170 size 0x28 virtual false final false
 void _ctor(System::Collections::IList l) ;

/// @brief Method Contains addr 0x10dc6c0 size 0xac virtual true final false
 bool Contains(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method CopyTo addr 0x10dc76c size 0xb8 virtual true final false
 void CopyTo(System::Array array, int32_t index) ;

/// @brief Method get_Count addr 0x10dc824 size 0xa4 virtual true final false
 int32_t get_Count() ;

/// @brief Method GetEnumerator addr 0x10dc8c8 size 0xa0 virtual true final false
 System::Collections::IEnumerator GetEnumerator() ;

/// @brief Method IndexOf addr 0x10dc968 size 0xac virtual true final false
 int32_t IndexOf(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method get_IsFixedSize addr 0x10dca14 size 0xa4 virtual true final false
 bool get_IsFixedSize() ;

/// @brief Method get_IsSynchronized addr 0x10dcab8 size 0xa4 virtual true final false
 bool get_IsSynchronized() ;

/// @brief Method get_SyncRoot addr 0x10dcb5c size 0xa4 virtual true final false
 ::bs_hook::Il2CppWrapperType get_SyncRoot() ;

/// @brief Method GetValue addr 0x10dcc00 size 0xa8 virtual true final false
