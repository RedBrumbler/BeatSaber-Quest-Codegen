...
/// @brief Method .ctor addr 0x10d9148 size 0x28 virtual false final false
 void _ctor(System::Collections::IDictionary d) ;

/// @brief Method Contains addr 0x10dbe98 size 0xac virtual true final false
 bool Contains(::bs_hook::Il2CppWrapperType k) ;

/// @brief Method CopyTo addr 0x10dbf44 size 0xb8 virtual true final false
 void CopyTo(System::Array array, int32_t index) ;

/// @brief Method get_Count addr 0x10dbffc size 0xa4 virtual true final false
 int32_t get_Count() ;

/// @brief Method GetEnumerator addr 0x10dc0a0 size 0xa4 virtual true final false
 System::Collections::IDictionaryEnumerator GetEnumerator() ;

/// @brief Method get_IsFixedSize addr 0x10dc144 size 0xa4 virtual true final false
 bool get_IsFixedSize() ;

/// @brief Method get_IsSynchronized addr 0x10dc1e8 size 0xa4 virtual true final false
 bool get_IsSynchronized() ;

/// @brief Method get_SyncRoot addr 0x10dc28c size 0xa4 virtual true final false
 ::bs_hook::Il2CppWrapperType get_SyncRoot() ;

/// @brief Method get_Keys addr 0x10dc330 size 0xa4 virtual true final false
 System::Collections::ICollection get_Keys() ;

/// @brief Method get_Values addr 0x10dc3d4 size 0xa4 virtual true final false
 System::Collections::ICollection get_Values() ;

/// @brief Method GetValue addr 0x10dc478 size 0xa8 virtual true final false
