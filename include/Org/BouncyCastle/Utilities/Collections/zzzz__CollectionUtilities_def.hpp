...
/// @brief Method AddRange addr 0x10d8a74 size 0x35c virtual false final false
static void AddRange(System::Collections::IList to, System::Collections::IEnumerable range) ;

/// @brief Method CheckElementsAreOfType addr 0x10d8dd0 size 0x314 virtual false final false
static bool CheckElementsAreOfType(System::Collections::IEnumerable e, System::Type t) ;

/// @brief Method ReadOnly addr 0x10d90e4 size 0x64 virtual false final false
static System::Collections::IDictionary ReadOnly(System::Collections::IDictionary d) ;

/// @brief Method ReadOnly addr 0x10d7a18 size 0x64 virtual false final false
static System::Collections::IList ReadOnly(System::Collections::IList l) ;

/// @brief Method ReadOnly addr 0x10d79b4 size 0x64 virtual false final false
static Org::BouncyCastle::Utilities::Collections::ISet ReadOnly(Org::BouncyCastle::Utilities::Collections::ISet s) ;

/// @brief Method RequireNext addr 0x10d91c0 size 0x138 virtual false final false
static ::bs_hook::Il2CppWrapperType RequireNext(System::Collections::IEnumerator e) ;

/// @brief Method ToString addr 0x10d92f8 size 0x30c virtual false final false
static ::StringW ToString(System::Collections::IEnumerable c) ;

// Ctor Parameters []
explicit CollectionUtilities() ;

/// @brief Method .ctor addr 0x10d9604 size 0x8 virtual false final false
 void _ctor() ;
