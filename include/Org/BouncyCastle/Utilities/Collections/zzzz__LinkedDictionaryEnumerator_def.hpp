...
/// @brief Method .ctor addr 0x10daf84 size 0x30 virtual false final false
 void _ctor(Org::BouncyCastle::Utilities::Collections::LinkedDictionary parent) ;

/// @brief Method get_Current addr 0x10db88c size 0x6c virtual true final false
 ::bs_hook::Il2CppWrapperType get_Current() ;

/// @brief Method get_Entry addr 0x10db8f8 size 0xe0 virtual true final false
 System::Collections::DictionaryEntry get_Entry() ;

/// @brief Method get_Key addr 0x10dbb54 size 0x4 virtual true final false
 ::bs_hook::Il2CppWrapperType get_Key() ;

/// @brief Method MoveNext addr 0x10dbb58 size 0x14c virtual true final false
 bool MoveNext() ;

/// @brief Method Reset addr 0x10dbca4 size 0xc virtual true final false
 void Reset() ;

/// @brief Method get_Value addr 0x10dbcb0 size 0xb8 virtual true final false
 ::bs_hook::Il2CppWrapperType get_Value() ;

/// @brief Method get_CurrentKey addr 0x10db9d8 size 0x17c virtual false final false
