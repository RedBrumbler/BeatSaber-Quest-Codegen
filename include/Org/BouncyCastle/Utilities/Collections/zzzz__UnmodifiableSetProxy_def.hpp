...
/// @brief Method .ctor addr 0x10d9198 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Utilities::Collections::ISet s) ;

/// @brief Method Contains addr 0x10dcdf8 size 0xac virtual true final false
 bool Contains(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method CopyTo addr 0x10dcea4 size 0xb8 virtual true final false
 void CopyTo(System::Array array, int32_t index) ;

/// @brief Method get_Count addr 0x10dcf5c size 0xa4 virtual true final false
 int32_t get_Count() ;

/// @brief Method GetEnumerator addr 0x10dd000 size 0xa0 virtual true final false
 System::Collections::IEnumerator GetEnumerator() ;

/// @brief Method get_IsEmpty addr 0x10dd0a0 size 0xa4 virtual true final false
 bool get_IsEmpty() ;

/// @brief Method get_IsFixedSize addr 0x10dd144 size 0xa4 virtual true final false
 bool get_IsFixedSize() ;

/// @brief Method get_IsSynchronized addr 0x10dd1e8 size 0xa4 virtual true final false
 bool get_IsSynchronized() ;

/// @brief Method get_SyncRoot addr 0x10dd28c size 0xa4 virtual true final false
