...
/// @brief Method .ctor addr 0x10d7950 size 0x64 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x10d868c size 0x324 virtual false final false
 void _ctor(System::Collections::IEnumerable s) ;

/// @brief Method Add addr 0x10d98b0 size 0xb0 virtual true final false
 void Add(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method AddAll addr 0x10d9960 size 0x2e8 virtual true final false
 void AddAll(System::Collections::IEnumerable e) ;

/// @brief Method Clear addr 0x10d9c48 size 0xa4 virtual true final false
 void Clear() ;

/// @brief Method Contains addr 0x10d9cec size 0xac virtual true final false
 bool Contains(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method CopyTo addr 0x10d9d98 size 0x130 virtual true final false
 void CopyTo(System::Array array, int32_t index) ;

/// @brief Method get_Count addr 0x10d9ec8 size 0xa4 virtual true final false
 int32_t get_Count() ;

/// @brief Method GetEnumerator addr 0x10d9f6c size 0x118 virtual true final false
 System::Collections::IEnumerator GetEnumerator() ;

/// @brief Method get_IsEmpty addr 0x10da084 size 0xb0 virtual true final false
 bool get_IsEmpty() ;

/// @brief Method get_IsFixedSize addr 0x10da134 size 0xa4 virtual true final false
 bool get_IsFixedSize() ;

/// @brief Method get_IsReadOnly addr 0x10da1d8 size 0xa4 virtual true final false
 bool get_IsReadOnly() ;

/// @brief Method get_IsSynchronized addr 0x10da27c size 0xa4 virtual true final false
 bool get_IsSynchronized() ;

/// @brief Method Remove addr 0x10da320 size 0xac virtual true final false
 void Remove(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method RemoveAll addr 0x10da3cc size 0x2e8 virtual true final false
 void RemoveAll(System::Collections::IEnumerable e) ;

/// @brief Method get_SyncRoot addr 0x10da6b4 size 0xa4 virtual true final false
