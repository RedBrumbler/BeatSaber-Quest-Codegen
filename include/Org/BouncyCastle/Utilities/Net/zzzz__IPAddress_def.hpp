...
/// @brief Method IsValid addr 0x10e2184 size 0x28 virtual false final false
static bool IsValid(::StringW address) ;

/// @brief Method IsValidWithNetMask addr 0x10e22f4 size 0x28 virtual false final false
static bool IsValidWithNetMask(::StringW address) ;

/// @brief Method IsValidIPv4 addr 0x10e21ac size 0xa4 virtual false final false
static bool IsValidIPv4(::StringW address) ;

/// @brief Method unsafeIsValidIPv4 addr 0x10e245c size 0xf8 virtual false final false
static bool unsafeIsValidIPv4(::StringW address) ;

/// @brief Method IsValidIPv4WithNetmask addr 0x10e231c size 0xa0 virtual false final false
static bool IsValidIPv4WithNetmask(::StringW address) ;

/// @brief Method IsValidIPv6WithNetmask addr 0x10e23bc size 0xa0 virtual false final false
static bool IsValidIPv6WithNetmask(::StringW address) ;

/// @brief Method IsMaskValue addr 0x10e2554 size 0x2c virtual false final false
static bool IsMaskValue(::StringW component, int32_t size) ;

/// @brief Method IsValidIPv6 addr 0x10e2250 size 0xa4 virtual false final false
static bool IsValidIPv6(::StringW address) ;

/// @brief Method unsafeIsValidIPv6 addr 0x10e2580 size 0x1a8 virtual false final false
static bool unsafeIsValidIPv6(::StringW address) ;

// Ctor Parameters []
explicit IPAddress() ;

/// @brief Method .ctor addr 0x10e2728 size 0x8 virtual false final false
 void _ctor() ;
