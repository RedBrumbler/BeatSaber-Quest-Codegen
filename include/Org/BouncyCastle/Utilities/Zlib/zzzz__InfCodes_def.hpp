...
/// @brief Method .ctor addr 0x10e72b8 size 0xc virtual false final false
 void _ctor() ;

/// @brief Method init addr 0x10e86a8 size 0x24 virtual false final false
...
/// @brief Method proc addr 0x10e8a2c size 0x9cc virtual false final false
 int32_t proc(Org::BouncyCastle::Utilities::Zlib::InfBlocks s, Org::BouncyCastle::Utilities::Zlib::ZStream z, int32_t r) ;

/// @brief Method free addr 0x10e7368 size 0x4 virtual false final false
 void free(Org::BouncyCastle::Utilities::Zlib::ZStream z) ;

/// @brief Method inflate_fast addr 0x10e9534 size 0x860 virtual false final false
