...
/// @brief Method .ctor addr 0x10e7120 size 0x50 virtual false final false
...
/// @brief Method .ctor addr 0x10e3154 size 0x148 virtual false final false
 void _ctor() ;

/// @brief Method lm_init addr 0x10e329c size 0x114 virtual false final false
 void lm_init() ;

/// @brief Method tr_init addr 0x10e33b0 size 0xbc virtual false final false
 void tr_init() ;

/// @brief Method init_block addr 0x10e346c size 0xb4 virtual false final false
 void init_block() ;

/// @brief Method pqdownheap addr 0x10e3520 size 0x1b4 virtual false final false
 void pqdownheap(::ArrayW<int16_t> tree, int32_t k) ;

/// @brief Method smaller addr 0x10e36d4 size 0x8c virtual false final false
static bool smaller(::ArrayW<int16_t> tree, int32_t n, int32_t m, ::ArrayW<uint8_t> depth) ;

/// @brief Method scan_tree addr 0x10e3760 size 0x194 virtual false final false
 void scan_tree(::ArrayW<int16_t> tree, int32_t max_code) ;

/// @brief Method build_bl_tree addr 0x10e38f4 size 0x11c virtual false final false
 int32_t build_bl_tree() ;

/// @brief Method send_all_trees addr 0x10e3a10 size 0x130 virtual false final false
 void send_all_trees(int32_t lcodes, int32_t dcodes, int32_t blcodes) ;

/// @brief Method send_tree addr 0x10e3bf8 size 0x1a0 virtual false final false
 void send_tree(::ArrayW<int16_t> tree, int32_t max_code) ;

/// @brief Method put_byte addr 0x10e3ddc size 0x48 virtual false final false
 void put_byte(::ArrayW<uint8_t> p, int32_t start, int32_t len) ;

/// @brief Method put_byte addr 0x10e3e24 size 0x3c virtual false final false
 void put_byte(uint8_t c) ;

/// @brief Method put_short addr 0x10e3e60 size 0x68 virtual false final false
 void put_short(int32_t w) ;

/// @brief Method putShortMSB addr 0x10e3ec8 size 0x68 virtual false final false
 void putShortMSB(int32_t b) ;

/// @brief Method send_code addr 0x10e3d98 size 0x44 virtual false final false
 void send_code(int32_t c, ::ArrayW<int16_t> tree) ;

/// @brief Method send_bits addr 0x10e3b40 size 0xb8 virtual false final false
 void send_bits(int32_t val, int32_t length) ;

/// @brief Method _tr_align addr 0x10e3f30 size 0xe0 virtual false final false
 void _tr_align() ;

/// @brief Method _tr_tally addr 0x10e40e4 size 0x2a4 virtual false final false
 bool _tr_tally(int32_t dist, int32_t lc) ;

/// @brief Method compress_block addr 0x10e4388 size 0x274 virtual false final false
 void compress_block(::ArrayW<int16_t> ltree, ::ArrayW<int16_t> dtree) ;

/// @brief Method set_data_type addr 0x10e45fc size 0xb0 virtual false final false
 void set_data_type() ;

/// @brief Method bi_flush addr 0x10e4010 size 0xd4 virtual false final false
 void bi_flush() ;

/// @brief Method bi_windup addr 0x10e46ac size 0xb0 virtual false final false
 void bi_windup() ;

/// @brief Method copy_block addr 0x10e475c size 0x80 virtual false final false
 void copy_block(int32_t buf, int32_t len, bool header) ;

/// @brief Method flush_block_only addr 0x10e47dc size 0x4c virtual false final false
 void flush_block_only(bool eof) ;

/// @brief Method deflate_stored addr 0x10e49e0 size 0x164 virtual false final false
 int32_t deflate_stored(int32_t flush) ;

/// @brief Method _tr_stored_block addr 0x10e4d0c size 0x44 virtual false final false
 void _tr_stored_block(int32_t buf, int32_t stored_len, bool eof) ;

/// @brief Method _tr_flush_block addr 0x10e4828 size 0x1b8 virtual false final false
 void _tr_flush_block(int32_t buf, int32_t stored_len, bool eof) ;

/// @brief Method fill_window addr 0x10e4b44 size 0x1c8 virtual false final false
 void fill_window() ;

/// @brief Method deflate_fast addr 0x10e4d50 size 0x31c virtual false final false
 int32_t deflate_fast(int32_t flush) ;

/// @brief Method deflate_slow addr 0x10e5418 size 0x3b4 virtual false final false
 int32_t deflate_slow(int32_t flush) ;

/// @brief Method longest_match addr 0x10e506c size 0x3ac virtual false final false
 int32_t longest_match(int32_t cur_match) ;

/// @brief Method deflateInit addr 0x10e57cc size 0x14 virtual false final false
 int32_t deflateInit(Org::BouncyCastle::Utilities::Zlib::ZStream strm, int32_t level, int32_t bits) ;

/// @brief Method deflateInit addr 0x10e5980 size 0x14 virtual false final false
 int32_t deflateInit(Org::BouncyCastle::Utilities::Zlib::ZStream strm, int32_t level) ;

/// @brief Method deflateInit2 addr 0x10e57e0 size 0x1a0 virtual false final false
...
/// @brief Method deflateReset addr 0x10e5994 size 0x74 virtual false final false
 int32_t deflateReset(Org::BouncyCastle::Utilities::Zlib::ZStream strm) ;

/// @brief Method deflateEnd addr 0x10e5a08 size 0x44 virtual false final false
 int32_t deflateEnd() ;

/// @brief Method deflateParams addr 0x10e5a4c size 0x184 virtual false final false
 int32_t deflateParams(Org::BouncyCastle::Utilities::Zlib::ZStream strm, int32_t _level, int32_t _strategy) ;

/// @brief Method deflateSetDictionary addr 0x10e5bd0 size 0x178 virtual false final false
 int32_t deflateSetDictionary(Org::BouncyCastle::Utilities::Zlib::ZStream strm, ::ArrayW<uint8_t> dictionary, int32_t dictLength) ;

/// @brief Method deflate addr 0x10e5d48 size 0x13d8 virtual false final false
