...
/// @brief Method .ctor addr 0x10ec9d0 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x10ec9d8 size 0x108 virtual false final false
 void _ctor(System::IO::Stream inp, bool nowrap) ;

/// @brief Method get_CanRead addr 0x10ecaec size 0x8 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanSeek addr 0x10ecaf4 size 0x8 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_CanWrite addr 0x10ecafc size 0x8 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_Length addr 0x10ecb04 size 0x8 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x10ecb0c size 0x8 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x10ecb14 size 0x4 virtual true final false
 void set_Position(int64_t value) ;

/// @brief Method Write addr 0x10ecb18 size 0x4 virtual true final false
 void Write(::ArrayW<uint8_t> b, int32_t off, int32_t len) ;

/// @brief Method Seek addr 0x10ecb1c size 0x8 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0x10ecb24 size 0x4 virtual true final false
 void SetLength(int64_t value) ;

/// @brief Method Read addr 0x10ecb28 size 0x19c virtual true final false
 int32_t Read(::ArrayW<uint8_t> b, int32_t off, int32_t len) ;

/// @brief Method Flush addr 0x10ecce0 size 0x24 virtual true final false
 void Flush() ;

/// @brief Method WriteByte addr 0x10ecd04 size 0x4 virtual true final false
 void WriteByte(uint8_t b) ;

/// @brief Method Close addr 0x10ecd08 size 0x78 virtual true final false
 void Close() ;

/// @brief Method ReadByte addr 0x10ecda0 size 0x58 virtual true final false
 int32_t ReadByte() ;
