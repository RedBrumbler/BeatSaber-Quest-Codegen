...
/// @brief Method d_code addr 0x10eb6fc size 0x98 virtual false final false
static int32_t d_code(int32_t dist) ;

/// @brief Method gen_bitlen addr 0x10eb794 size 0x2cc virtual false final false
 void gen_bitlen(Org::BouncyCastle::Utilities::Zlib::Deflate s) ;

/// @brief Method build_tree addr 0x10eba60 size 0x474 virtual false final false
 void build_tree(Org::BouncyCastle::Utilities::Zlib::Deflate s) ;

/// @brief Method gen_codes addr 0x10ebed4 size 0x17c virtual false final false
static void gen_codes(::ArrayW<int16_t> tree, int32_t max_code, ::ArrayW<int16_t> bl_count) ;

/// @brief Method bi_reverse addr 0x10ec050 size 0x28 virtual false final false
static int32_t bi_reverse(int32_t code, int32_t len) ;

// Ctor Parameters []
explicit Tree() ;

/// @brief Method .ctor addr 0x10ec2dc size 0x8 virtual false final false
 void _ctor() ;
