...
/// @brief Method .ctor addr 0x10e7170 size 0x148 virtual false final false
 void _ctor(Org::BouncyCastle::Utilities::Zlib::ZStream z, ::bs_hook::Il2CppWrapperType checkfn, int32_t w) ;

/// @brief Method reset addr 0x10e72d8 size 0x90 virtual false final false
 void reset(Org::BouncyCastle::Utilities::Zlib::ZStream z, ::ArrayW<int64_t> c) ;

/// @brief Method proc addr 0x10e736c size 0x10b0 virtual false final false
 int32_t proc(Org::BouncyCastle::Utilities::Zlib::ZStream z, int32_t r) ;

/// @brief Method free addr 0x10e93f8 size 0x1c virtual false final false
 void free(Org::BouncyCastle::Utilities::Zlib::ZStream z) ;

/// @brief Method set_dictionary addr 0x10e9414 size 0x40 virtual false final false
 void set_dictionary(::ArrayW<uint8_t> d, int32_t start, int32_t n) ;

/// @brief Method sync_point addr 0x10e9454 size 0x10 virtual false final false
 int32_t sync_point() ;

/// @brief Method inflate_flush addr 0x10e841c size 0x180 virtual false final false
