...
/// @brief Method GetDefaultZStream addr 0xf24e40 size 0x70 virtual false final false
...
/// @brief Method .ctor addr 0xf24eb0 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0xf24ee0 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0xf24d28 size 0x114 virtual false final false
...
/// @brief Method .ctor addr 0xf24f10 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xf24f18 size 0x100 virtual false final false
 void _ctor(System::IO::Stream output, int32_t level, bool nowrap) ;

/// @brief Method get_CanRead addr 0xf25018 size 0x8 virtual true final true
 bool get_CanRead() ;

/// @brief Method get_CanSeek addr 0xf25020 size 0x8 virtual true final true
 bool get_CanSeek() ;

/// @brief Method get_CanWrite addr 0xf25028 size 0x10 virtual true final true
 bool get_CanWrite() ;

/// @brief Method Close addr 0xf25038 size 0x2c virtual true final false
 void Close() ;

/// @brief Method DoClose addr 0xf25064 size 0x1a8 virtual false final false
 void DoClose() ;

/// @brief Method End addr 0xf2520c size 0x4c virtual true final false
 void End() ;

/// @brief Method Finish addr 0xf25258 size 0x16c virtual true final false
 void Finish() ;

/// @brief Method Flush addr 0xf253c4 size 0x24 virtual true final false
 void Flush() ;

/// @brief Method get_FlushMode addr 0xf253e8 size 0x8 virtual true final false
 int32_t get_FlushMode() ;

/// @brief Method set_FlushMode addr 0xf253f0 size 0x8 virtual true final false
 void set_FlushMode(int32_t value) ;

/// @brief Method get_Length addr 0xf253f8 size 0x40 virtual true final true
 int64_t get_Length() ;

/// @brief Method get_Position addr 0xf25438 size 0x40 virtual true final true
 int64_t get_Position() ;

/// @brief Method set_Position addr 0xf25478 size 0x40 virtual true final true
 void set_Position(int64_t value) ;

/// @brief Method Read addr 0xf254b8 size 0x40 virtual true final true
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Seek addr 0xf254f8 size 0x40 virtual true final true
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0xf25538 size 0x40 virtual true final true
 void SetLength(int64_t value) ;

/// @brief Method get_TotalIn addr 0xf25578 size 0x1c virtual true final false
 int64_t get_TotalIn() ;

/// @brief Method get_TotalOut addr 0xf25594 size 0x1c virtual true final false
 int64_t get_TotalOut() ;

/// @brief Method Write addr 0xf255b0 size 0x168 virtual true final false
 void Write(::ArrayW<uint8_t> b, int32_t off, int32_t len) ;

/// @brief Method WriteByte addr 0xf25718 size 0x40 virtual true final false
