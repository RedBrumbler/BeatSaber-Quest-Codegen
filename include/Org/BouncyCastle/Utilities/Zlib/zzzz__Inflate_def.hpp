...
/// @brief Method inflateReset addr 0x10e9e28 size 0x54 virtual false final false
 int32_t inflateReset(Org::BouncyCastle::Utilities::Zlib::ZStream z) ;

/// @brief Method inflateEnd addr 0x10e9e7c size 0x38 virtual false final false
 int32_t inflateEnd(Org::BouncyCastle::Utilities::Zlib::ZStream z) ;

/// @brief Method inflateInit addr 0x10e9eb4 size 0xd8 virtual false final false
 int32_t inflateInit(Org::BouncyCastle::Utilities::Zlib::ZStream z, int32_t w) ;

/// @brief Method inflate addr 0x10e9f8c size 0x670 virtual false final false
 int32_t inflate(Org::BouncyCastle::Utilities::Zlib::ZStream z, int32_t f) ;

/// @brief Method inflateSetDictionary addr 0x10ea5fc size 0x104 virtual false final false
 int32_t inflateSetDictionary(Org::BouncyCastle::Utilities::Zlib::ZStream z, ::ArrayW<uint8_t> dictionary, int32_t dictLength) ;

/// @brief Method inflateSync addr 0x10ea700 size 0x1c0 virtual false final false
 int32_t inflateSync(Org::BouncyCastle::Utilities::Zlib::ZStream z) ;

/// @brief Method inflateSyncPoint addr 0x10ea8c0 size 0x2c virtual false final false
 int32_t inflateSyncPoint(Org::BouncyCastle::Utilities::Zlib::ZStream z) ;

// Ctor Parameters []
explicit Inflate() ;

/// @brief Method .ctor addr 0x10ea980 size 0x58 virtual false final false
 void _ctor() ;
