...
/// @brief Method inflateInit addr 0x10ecfe4 size 0xc virtual false final false
 int32_t inflateInit() ;

/// @brief Method inflateInit addr 0x10ecae0 size 0xc virtual false final false
 int32_t inflateInit(bool nowrap) ;

/// @brief Method inflateInit addr 0x10ed5d0 size 0x8 virtual false final false
 int32_t inflateInit(int32_t w) ;

/// @brief Method inflateInit addr 0x10ed5d8 size 0x7c virtual false final false
 int32_t inflateInit(int32_t w, bool nowrap) ;

/// @brief Method inflate addr 0x10eccc4 size 0x1c virtual false final false
 int32_t inflate(int32_t f) ;

/// @brief Method inflateEnd addr 0x10ed654 size 0x50 virtual false final false
 int32_t inflateEnd() ;

/// @brief Method inflateSync addr 0x10ed6a4 size 0x18 virtual false final false
 int32_t inflateSync() ;

/// @brief Method inflateSetDictionary addr 0x10ed6bc size 0x20 virtual false final false
 int32_t inflateSetDictionary(::ArrayW<uint8_t> dictionary, int32_t dictLength) ;

/// @brief Method deflateInit addr 0x10ed6dc size 0xc virtual false final false
 int32_t deflateInit(int32_t level) ;

/// @brief Method deflateInit addr 0x10ec458 size 0xc virtual false final false
 int32_t deflateInit(int32_t level, bool nowrap) ;

/// @brief Method deflateInit addr 0x10ed6e8 size 0x8 virtual false final false
 int32_t deflateInit(int32_t level, int32_t bits) ;

/// @brief Method deflateInit addr 0x10ed6f0 size 0x94 virtual false final false
 int32_t deflateInit(int32_t level, int32_t bits, bool nowrap) ;

/// @brief Method deflate addr 0x10ec5c8 size 0x24 virtual false final false
 int32_t deflate(int32_t flush) ;

/// @brief Method deflateEnd addr 0x10ec7f0 size 0x30 virtual false final false
 int32_t deflateEnd() ;

/// @brief Method deflateParams addr 0x10ed784 size 0x28 virtual false final false
 int32_t deflateParams(int32_t level, int32_t strategy) ;

/// @brief Method deflateSetDictionary addr 0x10ed7ac size 0x28 virtual false final false
 int32_t deflateSetDictionary(::ArrayW<uint8_t> dictionary, int32_t dictLength) ;

/// @brief Method flush_pending addr 0x10ed7d4 size 0xbc virtual false final false
 void flush_pending() ;

/// @brief Method read_buf addr 0x10ed890 size 0xb0 virtual false final false
 int32_t read_buf(::ArrayW<uint8_t> buf, int32_t start, int32_t size) ;

/// @brief Method free addr 0x10ec820 size 0x14 virtual false final false
 void free() ;

// Ctor Parameters []
explicit ZStream() ;

/// @brief Method .ctor addr 0x10ec3f0 size 0x68 virtual false final false
 void _ctor() ;
