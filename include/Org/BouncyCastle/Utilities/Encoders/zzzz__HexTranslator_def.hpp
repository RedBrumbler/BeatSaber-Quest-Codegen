...
/// @brief Method GetEncodedBlockSize addr 0x10e0710 size 0x8 virtual true final true
 int32_t GetEncodedBlockSize() ;

/// @brief Method Encode addr 0x10e0718 size 0x140 virtual true final true
 int32_t Encode(::ArrayW<uint8_t> input, int32_t inOff, int32_t length, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method GetDecodedBlockSize addr 0x10e0858 size 0x8 virtual true final true
 int32_t GetDecodedBlockSize() ;

/// @brief Method Decode addr 0x10e0860 size 0xc8 virtual true final true
...
/// @brief Method .ctor addr 0x10e09bc size 0x8 virtual false final false
 void _ctor() ;
