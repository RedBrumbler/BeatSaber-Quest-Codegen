...
/// @brief Method .ctor addr 0x10df430 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method ToHexString addr 0x10df438 size 0x64 virtual false final false
static ::StringW ToHexString(::ArrayW<uint8_t> data) ;

/// @brief Method ToHexString addr 0x10df49c size 0x74 virtual false final false
static ::StringW ToHexString(::ArrayW<uint8_t> data, int32_t off, int32_t length) ;

/// @brief Method Encode addr 0x10df5d8 size 0x64 virtual false final false
static ::ArrayW<uint8_t> Encode(::ArrayW<uint8_t> data) ;

/// @brief Method Encode addr 0x10df510 size 0xc8 virtual false final false
static ::ArrayW<uint8_t> Encode(::ArrayW<uint8_t> data, int32_t off, int32_t length) ;

/// @brief Method Encode addr 0x10df74c size 0x84 virtual false final false
static int32_t Encode(::ArrayW<uint8_t> data, System::IO::Stream outStream) ;

/// @brief Method Encode addr 0x10df7d0 size 0x90 virtual false final false
static int32_t Encode(::ArrayW<uint8_t> data, int32_t off, int32_t length, System::IO::Stream outStream) ;

/// @brief Method Decode addr 0x10df860 size 0xd0 virtual false final false
static ::ArrayW<uint8_t> Decode(::ArrayW<uint8_t> data) ;

/// @brief Method Decode addr 0x10dfc14 size 0xd0 virtual false final false
static ::ArrayW<uint8_t> Decode(::StringW data) ;

/// @brief Method Decode addr 0x10dffe0 size 0x78 virtual false final false
static int32_t Decode(::StringW data, System::IO::Stream outStream) ;

/// @brief Method DecodeStrict addr 0x10e0058 size 0x74 virtual false final false
static ::ArrayW<uint8_t> DecodeStrict(::StringW str) ;

/// @brief Method DecodeStrict addr 0x10e0314 size 0x80 virtual false final false
