...
/// @brief Method .ctor addr 0x10def68 size 0x13c virtual false final false
 void _ctor(Org::BouncyCastle::Utilities::Encoders::ITranslator translator, int32_t bufferSize) ;

/// @brief Method ProcessByte addr 0x10df0a4 size 0x128 virtual false final false
 int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method ProcessBytes addr 0x10df1cc size 0x264 virtual false final false
