...
/// @brief Method .ctor addr 0x10dd628 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method ToBase64String addr 0x10dd630 size 0x68 virtual false final false
static ::StringW ToBase64String(::ArrayW<uint8_t> data) ;

/// @brief Method ToBase64String addr 0x10dd698 size 0x70 virtual false final false
static ::StringW ToBase64String(::ArrayW<uint8_t> data, int32_t off, int32_t length) ;

/// @brief Method Encode addr 0x10dd708 size 0x1c virtual false final false
static ::ArrayW<uint8_t> Encode(::ArrayW<uint8_t> data) ;

/// @brief Method Encode addr 0x10dd724 size 0x78 virtual false final false
static ::ArrayW<uint8_t> Encode(::ArrayW<uint8_t> data, int32_t off, int32_t length) ;

/// @brief Method Encode addr 0x10dd79c size 0x50 virtual false final false
static int32_t Encode(::ArrayW<uint8_t> data, System::IO::Stream outStream) ;

/// @brief Method Encode addr 0x10dd7ec size 0x50 virtual false final false
static int32_t Encode(::ArrayW<uint8_t> data, int32_t off, int32_t length, System::IO::Stream outStream) ;

/// @brief Method Decode addr 0x10dd83c size 0x6c virtual false final false
static ::ArrayW<uint8_t> Decode(::ArrayW<uint8_t> data) ;

/// @brief Method Decode addr 0x10dd8a8 size 0x58 virtual false final false
static ::ArrayW<uint8_t> Decode(::StringW data) ;

/// @brief Method Decode addr 0x10dd900 size 0x50 virtual false final false
