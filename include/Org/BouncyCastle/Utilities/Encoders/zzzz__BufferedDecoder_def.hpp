...
/// @brief Method .ctor addr 0x10deaa0 size 0x13c virtual false final false
 void _ctor(Org::BouncyCastle::Utilities::Encoders::ITranslator translator, int32_t bufferSize) ;

/// @brief Method ProcessByte addr 0x10debdc size 0x128 virtual false final false
 int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method ProcessBytes addr 0x10ded04 size 0x264 virtual false final false
