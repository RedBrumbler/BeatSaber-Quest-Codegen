...
/// @brief Method InitialiseDecodingTable addr 0x10dd950 size 0xbc virtual false final false
 void InitialiseDecodingTable() ;

// Ctor Parameters []
explicit Base64Encoder() ;

/// @brief Method .ctor addr 0x10dda0c size 0xa4 virtual false final false
 void _ctor() ;

/// @brief Method Encode addr 0x10ddab0 size 0x390 virtual false final false
 int32_t Encode(::ArrayW<uint8_t> inBuf, int32_t inOff, int32_t inLen, ::ArrayW<uint8_t> outBuf, int32_t outOff) ;

/// @brief Method Encode addr 0x10dde40 size 0x12c virtual true final true
 int32_t Encode(::ArrayW<uint8_t> buf, int32_t off, int32_t len, System::IO::Stream outStream) ;

/// @brief Method ignore addr 0x10ddf6c size 0x38 virtual false final false
 bool ignore(char16_t c) ;

/// @brief Method Decode addr 0x10ddfa4 size 0x3f8 virtual true final true
 int32_t Decode(::ArrayW<uint8_t> data, int32_t off, int32_t length, System::IO::Stream outStream) ;

/// @brief Method nextI addr 0x10de39c size 0x74 virtual false final false
 int32_t nextI(::ArrayW<uint8_t> data, int32_t i, int32_t finish) ;

/// @brief Method DecodeString addr 0x10de614 size 0x408 virtual true final true
 int32_t DecodeString(::StringW data, System::IO::Stream outStream) ;

/// @brief Method decodeLastBlock addr 0x10de410 size 0x204 virtual false final false
 int32_t decodeLastBlock(System::IO::Stream outStream, char16_t c1, char16_t c2, char16_t c3, char16_t c4) ;

/// @brief Method nextI addr 0x10dea1c size 0x84 virtual false final false
