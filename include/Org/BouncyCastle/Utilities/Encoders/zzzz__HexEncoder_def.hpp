...
/// @brief Method InitialiseDecodingTable addr 0x10e04a4 size 0x164 virtual false final false
 void InitialiseDecodingTable() ;

// Ctor Parameters []
explicit HexEncoder() ;

/// @brief Method .ctor addr 0x10e0408 size 0x9c virtual false final false
 void _ctor() ;

/// @brief Method Encode addr 0x10e0608 size 0xd0 virtual false final false
 int32_t Encode(::ArrayW<uint8_t> inBuf, int32_t inOff, int32_t inLen, ::ArrayW<uint8_t> outBuf, int32_t outOff) ;

/// @brief Method Encode addr 0x10df63c size 0x110 virtual true final true
 int32_t Encode(::ArrayW<uint8_t> buf, int32_t off, int32_t len, System::IO::Stream outStream) ;

/// @brief Method Ignore addr 0x10e06d8 size 0x38 virtual false final false
static bool Ignore(char16_t c) ;

/// @brief Method Decode addr 0x10df930 size 0x2e4 virtual true final true
 int32_t Decode(::ArrayW<uint8_t> data, int32_t off, int32_t length, System::IO::Stream outStream) ;

/// @brief Method DecodeString addr 0x10dfce4 size 0x2fc virtual true final true
 int32_t DecodeString(::StringW data, System::IO::Stream outStream) ;

/// @brief Method DecodeStrict addr 0x10e00cc size 0x248 virtual false final false
