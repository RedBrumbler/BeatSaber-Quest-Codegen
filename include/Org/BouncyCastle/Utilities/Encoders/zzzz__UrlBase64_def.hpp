...
/// @brief Method Encode addr 0x10e09c4 size 0x22c virtual false final false
static ::ArrayW<uint8_t> Encode(::ArrayW<uint8_t> data) ;

/// @brief Method Encode addr 0x10e0bf0 size 0xf0 virtual false final false
static int32_t Encode(::ArrayW<uint8_t> data, System::IO::Stream outStr) ;

/// @brief Method Decode addr 0x10e0ce0 size 0x230 virtual false final false
static ::ArrayW<uint8_t> Decode(::ArrayW<uint8_t> data) ;

/// @brief Method Decode addr 0x10e0f10 size 0xf4 virtual false final false
static int32_t Decode(::ArrayW<uint8_t> data, System::IO::Stream outStr) ;

/// @brief Method Decode addr 0x10e1004 size 0x210 virtual false final false
static ::ArrayW<uint8_t> Decode(::StringW data) ;

/// @brief Method Decode addr 0x10e1214 size 0xe4 virtual false final false
static int32_t Decode(::StringW data, System::IO::Stream outStr) ;

// Ctor Parameters []
explicit UrlBase64() ;

/// @brief Method .ctor addr 0x10e13e0 size 0x8 virtual false final false
 void _ctor() ;
