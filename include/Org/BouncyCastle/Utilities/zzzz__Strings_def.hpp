...
/// @brief Method ToUpperCase addr 0x10f1304 size 0x7c virtual false final false
static ::StringW ToUpperCase(::StringW original) ;

/// @brief Method IsOneOf addr 0x10f1380 size 0x80 virtual false final false
static bool IsOneOf(::StringW s, ::ArrayW<::StringW> candidates) ;

/// @brief Method FromByteArray addr 0x10f1400 size 0xf0 virtual false final false
static ::StringW FromByteArray(::ArrayW<uint8_t> bs) ;

/// @brief Method ToByteArray addr 0x10f14f0 size 0xe8 virtual false final false
static ::ArrayW<uint8_t> ToByteArray(::ArrayW<char16_t> cs) ;

/// @brief Method ToByteArray addr 0x10f15d8 size 0xec virtual false final false
static ::ArrayW<uint8_t> ToByteArray(::StringW s) ;

/// @brief Method FromAsciiByteArray addr 0x10f16c4 size 0x3c virtual false final false
static ::StringW FromAsciiByteArray(::ArrayW<uint8_t> bytes) ;

/// @brief Method ToAsciiByteArray addr 0x10f1700 size 0x30 virtual false final false
static ::ArrayW<uint8_t> ToAsciiByteArray(::ArrayW<char16_t> cs) ;

/// @brief Method ToAsciiByteArray addr 0x10f1730 size 0x30 virtual false final false
static ::ArrayW<uint8_t> ToAsciiByteArray(::StringW s) ;

/// @brief Method FromUtf8ByteArray addr 0x10f1760 size 0x3c virtual false final false
static ::StringW FromUtf8ByteArray(::ArrayW<uint8_t> bytes) ;

/// @brief Method ToUtf8ByteArray addr 0x10f179c size 0x30 virtual false final false
static ::ArrayW<uint8_t> ToUtf8ByteArray(::ArrayW<char16_t> cs) ;

/// @brief Method ToUtf8ByteArray addr 0x10f17cc size 0x30 virtual false final false
static ::ArrayW<uint8_t> ToUtf8ByteArray(::StringW s) ;

// Ctor Parameters []
explicit Strings() ;

/// @brief Method .ctor addr 0x10f17fc size 0x8 virtual false final false
 void _ctor() ;
