...
/// @brief Method NumberOfLeadingZeros addr 0x10f0750 size 0x7c virtual false final false
static int32_t NumberOfLeadingZeros(int32_t i) ;

/// @brief Method NumberOfTrailingZeros addr 0x10f07cc size 0x34 virtual false final false
static int32_t NumberOfTrailingZeros(int32_t i) ;

/// @brief Method RotateLeft addr 0x10f0800 size 0x14 virtual false final false
static int32_t RotateLeft(int32_t i, int32_t distance) ;

/// @brief Method RotateLeft addr 0x10f0814 size 0x14 virtual false final false
static uint32_t RotateLeft(uint32_t i, int32_t distance) ;

/// @brief Method RotateRight addr 0x10f0828 size 0x14 virtual false final false
static int32_t RotateRight(int32_t i, int32_t distance) ;

/// @brief Method RotateRight addr 0x10f083c size 0x14 virtual false final false
static uint32_t RotateRight(uint32_t i, int32_t distance) ;

// Ctor Parameters []
explicit Integers() ;

/// @brief Method .ctor addr 0x10f0850 size 0x8 virtual false final false
 void _ctor() ;
