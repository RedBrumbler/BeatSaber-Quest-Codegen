...
/// @brief Method AsUnsignedByteArray addr 0x10efe60 size 0x14 virtual false final false
static ::ArrayW<uint8_t> AsUnsignedByteArray(Org::BouncyCastle::Math::BigInteger n) ;

/// @brief Method AsUnsignedByteArray addr 0x10efe74 size 0x10c virtual false final false
static ::ArrayW<uint8_t> AsUnsignedByteArray(int32_t length, Org::BouncyCastle::Math::BigInteger n) ;

/// @brief Method AsUnsignedByteArray addr 0x10eff80 size 0x14c virtual false final false
static void AsUnsignedByteArray(Org::BouncyCastle::Math::BigInteger value, ::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method CreateRandomBigInteger addr 0x10f00cc size 0x74 virtual false final false
...
/// @brief Method CreateRandomInRange addr 0x10f0140 size 0x214 virtual false final false
...
/// @brief Method GetUnsignedByteLength addr 0x10f0354 size 0x30 virtual false final false
static int32_t GetUnsignedByteLength(Org::BouncyCastle::Math::BigInteger n) ;

// Ctor Parameters []
explicit BigIntegers() ;

/// @brief Method .ctor addr 0x10f0384 size 0x8 virtual false final false
 void _ctor() ;
