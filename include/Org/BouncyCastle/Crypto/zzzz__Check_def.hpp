...
/// @brief Method DataLength addr 0xf47348 size 0x50 virtual false final false
static void DataLength(bool condition, ::StringW msg) ;

/// @brief Method DataLength addr 0xf47398 size 0x6c virtual false final false
static void DataLength(::ArrayW<uint8_t> buf, int32_t off, int32_t len, ::StringW msg) ;

/// @brief Method OutputLength addr 0xf47404 size 0x6c virtual false final false
static void OutputLength(::ArrayW<uint8_t> buf, int32_t off, int32_t len, ::StringW msg) ;

// Ctor Parameters []
explicit Check() ;

/// @brief Method .ctor addr 0xf47474 size 0x8 virtual false final false
 void _ctor() ;
