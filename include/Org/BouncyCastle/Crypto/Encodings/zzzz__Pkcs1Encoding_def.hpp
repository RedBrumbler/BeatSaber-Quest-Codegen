...
/// @brief Method get_StrictLengthEnabled addr 0xe37db4 size 0x70 virtual false final false
static bool get_StrictLengthEnabled() ;

/// @brief Method set_StrictLengthEnabled addr 0xe37e24 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0xe37fb4 size 0x84 virtual false final false
...
/// @brief Method .ctor addr 0xe38038 size 0x8c virtual false final false
...
/// @brief Method .ctor addr 0xe380c4 size 0x9c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IAsymmetricBlockCipher cipher, ::ArrayW<uint8_t> fallback) ;

/// @brief Method GetUnderlyingCipher addr 0xe38160 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::IAsymmetricBlockCipher GetUnderlyingCipher() ;

/// @brief Method get_AlgorithmName addr 0xe38168 size 0xc0 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xe38228 size 0x2dc virtual true final true
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetInputBlockSize addr 0xe38504 size 0xb8 virtual true final true
 int32_t GetInputBlockSize() ;

/// @brief Method GetOutputBlockSize addr 0xe385bc size 0xb8 virtual true final true
 int32_t GetOutputBlockSize() ;

/// @brief Method ProcessBlock addr 0xe38674 size 0x10 virtual true final true
 ::ArrayW<uint8_t> ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method EncodeBlock addr 0xe38974 size 0x308 virtual false final false
 ::ArrayW<uint8_t> EncodeBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen) ;

/// @brief Method CheckPkcs1Encoding addr 0xe38c7c size 0xa0 virtual false final false
static int32_t CheckPkcs1Encoding(::ArrayW<uint8_t> encoded, int32_t pLen) ;

/// @brief Method DecodeBlockOrRandom addr 0xe38d1c size 0x2fc virtual false final false
 ::ArrayW<uint8_t> DecodeBlockOrRandom(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen) ;

/// @brief Method DecodeBlock addr 0xe38684 size 0x2f0 virtual false final false
 ::ArrayW<uint8_t> DecodeBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen) ;

/// @brief Method FindStart addr 0xe39018 size 0x98 virtual false final false
