...
/// @brief Method .ctor addr 0xe35cb0 size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IAsymmetricBlockCipher cipher) ;

/// @brief Method get_AlgorithmName addr 0xe35cdc size 0xc0 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method GetUnderlyingCipher addr 0xe35d9c size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::IAsymmetricBlockCipher GetUnderlyingCipher() ;

/// @brief Method Init addr 0xe35da4 size 0x1ac virtual true final true
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetInputBlockSize addr 0xe35f50 size 0xc4 virtual true final true
 int32_t GetInputBlockSize() ;

/// @brief Method GetOutputBlockSize addr 0xe36014 size 0xc4 virtual true final true
 int32_t GetOutputBlockSize() ;

/// @brief Method SetPadBits addr 0xe360d8 size 0x64 virtual false final false
 void SetPadBits(int32_t padBits) ;

/// @brief Method GetPadBits addr 0xe3613c size 0x8 virtual false final false
 int32_t GetPadBits() ;

/// @brief Method ProcessBlock addr 0xe36144 size 0x10 virtual true final true
 ::ArrayW<uint8_t> ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method EncodeBlock addr 0xe36154 size 0x34c virtual false final false
 ::ArrayW<uint8_t> EncodeBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen) ;

/// @brief Method DecodeBlock addr 0xe364a0 size 0x4e0 virtual false final false
