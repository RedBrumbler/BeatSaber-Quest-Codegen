...
/// @brief Method DoFinal addr 0xe93100 size 0x448 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method get_AlgorithmName addr 0xe93548 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetMacSize addr 0xe93588 size 0x8 virtual true final false
 int32_t GetMacSize() ;

/// @brief Method Init addr 0xe93590 size 0x1b0 virtual true final false
 void Init(Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method initKey addr 0xe93740 size 0x1fc virtual false final false
 void initKey(::ArrayW<uint8_t> keyBytes, ::ArrayW<uint8_t> ivBytes) ;

/// @brief Method Reset addr 0xe9393c size 0x9c virtual true final false
 void Reset() ;

/// @brief Method Update addr 0xe939d8 size 0x24c virtual true final false
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0xe93c24 size 0xf4 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len) ;

// Ctor Parameters []
explicit VmpcMac() ;

/// @brief Method .ctor addr 0xe93d18 size 0x14 virtual false final false
 void _ctor() ;
