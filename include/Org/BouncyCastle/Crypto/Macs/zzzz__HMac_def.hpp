...
/// @brief Method .ctor addr 0xe8f908 size 0x15c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method get_AlgorithmName addr 0xe8fa64 size 0xc0 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetUnderlyingDigest addr 0xe8fb24 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::IDigest GetUnderlyingDigest() ;

/// @brief Method Init addr 0xe8fb2c size 0x528 virtual true final false
 void Init(Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetMacSize addr 0xe900a4 size 0x8 virtual true final false
 int32_t GetMacSize() ;

/// @brief Method Update addr 0xe900ac size 0xac virtual true final false
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0xe90158 size 0xc4 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len) ;

/// @brief Method DoFinal addr 0xe9021c size 0x4a8 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe906c4 size 0x120 virtual true final false
 void Reset() ;

/// @brief Method XorPad addr 0xe90054 size 0x50 virtual false final false
