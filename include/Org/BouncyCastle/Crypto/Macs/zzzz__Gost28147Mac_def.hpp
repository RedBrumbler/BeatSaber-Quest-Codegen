...
/// @brief Method .ctor addr 0xe8ec60 size 0xb8 virtual false final false
 void _ctor() ;

/// @brief Method GenerateWorkingKey addr 0xe8ed18 size 0xfc virtual false final false
static ::ArrayW<int32_t> GenerateWorkingKey(::ArrayW<uint8_t> userKey) ;

/// @brief Method Init addr 0xe8ee88 size 0x278 virtual true final true
 void Init(Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe8f138 size 0x40 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method GetMacSize addr 0xe8f178 size 0x8 virtual true final true
 int32_t GetMacSize() ;

/// @brief Method gost28147_mainStep addr 0xe8f180 size 0xe8 virtual false final false
 int32_t gost28147_mainStep(int32_t n1, int32_t key) ;

/// @brief Method gost28147MacFunc addr 0xe8f268 size 0xe4 virtual false final false
 void gost28147MacFunc(::ArrayW<int32_t> workingKey, ::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method bytesToint addr 0xe8ee14 size 0x74 virtual false final false
static int32_t bytesToint(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method intTobytes addr 0xe8f34c size 0x80 virtual false final false
static void intTobytes(int32_t num, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method CM5func addr 0xe8f3cc size 0xe4 virtual false final false
static ::ArrayW<uint8_t> CM5func(::ArrayW<uint8_t> buf, int32_t bufOff, ::ArrayW<uint8_t> mac) ;

/// @brief Method Update addr 0xe8f4b0 size 0x110 virtual true final true
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0xe8f5c0 size 0x200 virtual true final true
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len) ;

/// @brief Method DoFinal addr 0xe8f7c0 size 0x148 virtual true final true
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe8f100 size 0x38 virtual true final true
 void Reset() ;
