...
/// @brief Method .ctor addr 0xe8e120 size 0xf8 virtual false final false
 void _ctor(int32_t blockSizeBits, int32_t q) ;

/// @brief Method Init addr 0xe8e218 size 0x130 virtual true final true
 void Init(Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe8e348 size 0x40 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method GetMacSize addr 0xe8e388 size 0x8 virtual true final true
 int32_t GetMacSize() ;

/// @brief Method Update addr 0xe8e390 size 0x80 virtual true final true
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0xe8e458 size 0x140 virtual true final true
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len) ;

/// @brief Method processBlock addr 0xe8e410 size 0x48 virtual false final false
 void processBlock(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method Xor addr 0xe8e598 size 0x90 virtual false final false
 void Xor(::ArrayW<uint8_t> c, int32_t cOff, ::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> xorResult) ;

/// @brief Method DoFinal addr 0xe8e628 size 0x134 virtual true final true
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe8e75c size 0xd8 virtual true final true
 void Reset() ;
