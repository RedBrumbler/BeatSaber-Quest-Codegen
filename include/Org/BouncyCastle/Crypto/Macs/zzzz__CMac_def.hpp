...
/// @brief Method .ctor addr 0xe8c990 size 0xb4 virtual false final false
...
/// @brief Method .ctor addr 0xe8ca44 size 0x454 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher, int32_t macSizeInBits) ;

/// @brief Method get_AlgorithmName addr 0xe8ce98 size 0xa0 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method ShiftLeft addr 0xe8cf38 size 0x84 virtual false final false
static int32_t ShiftLeft(::ArrayW<uint8_t> block, ::ArrayW<uint8_t> output) ;

/// @brief Method DoubleLu addr 0xe8cfbc size 0xb8 virtual false final false
static ::ArrayW<uint8_t> DoubleLu(::ArrayW<uint8_t> input) ;

/// @brief Method Init addr 0xe8d074 size 0x220 virtual true final true
 void Init(Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetMacSize addr 0xe8d354 size 0x8 virtual true final true
 int32_t GetMacSize() ;

/// @brief Method Update addr 0xe8d35c size 0x118 virtual true final true
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0xe8d474 size 0x294 virtual true final true
 void BlockUpdate(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len) ;

/// @brief Method DoFinal addr 0xe8d708 size 0x220 virtual true final true
 int32_t DoFinal(::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method Reset addr 0xe8d294 size 0xc0 virtual true final true
 void Reset() ;
