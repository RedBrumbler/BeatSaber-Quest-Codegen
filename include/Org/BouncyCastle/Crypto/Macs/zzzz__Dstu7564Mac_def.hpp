...
/// @brief Method get_AlgorithmName addr 0xe8d928 size 0x40 virtual true final true
...
/// @brief Method .ctor addr 0xe8d968 size 0x90 virtual false final false
 void _ctor(int32_t macSizeBits) ;

/// @brief Method Init addr 0xe8d9f8 size 0x17c virtual true final true
 void Init(Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetMacSize addr 0xe8dd28 size 0x8 virtual true final true
 int32_t GetMacSize() ;

/// @brief Method BlockUpdate addr 0xe8dd30 size 0x118 virtual true final true
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len) ;

/// @brief Method Update addr 0xe8de48 size 0x38 virtual true final true
 void Update(uint8_t input) ;

/// @brief Method DoFinal addr 0xe8de80 size 0x12c virtual true final true
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe8e0c4 size 0x5c virtual true final true
 void Reset() ;

/// @brief Method Pad addr 0xe8dfac size 0x118 virtual false final false
 void Pad() ;

/// @brief Method PadKey addr 0xe8db74 size 0x1b4 virtual false final false
