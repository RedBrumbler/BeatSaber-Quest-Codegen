...
/// @brief Method .ctor addr 0xe92b90 size 0x84 virtual false final false
...
/// @brief Method .ctor addr 0xe92c14 size 0x7c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Macs::SkeinMac mac) ;

/// @brief Method get_AlgorithmName addr 0xe92c90 size 0x1b4 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xe92e44 size 0x230 virtual true final true
 void Init(Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetMacSize addr 0xe93074 size 0x1c virtual true final true
 int32_t GetMacSize() ;

/// @brief Method Reset addr 0xe93090 size 0x1c virtual true final true
 void Reset() ;

/// @brief Method Update addr 0xe930ac size 0x1c virtual true final true
 void Update(uint8_t inByte) ;

/// @brief Method BlockUpdate addr 0xe930c8 size 0x1c virtual true final true
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len) ;

/// @brief Method DoFinal addr 0xe930e4 size 0x1c virtual true final true
