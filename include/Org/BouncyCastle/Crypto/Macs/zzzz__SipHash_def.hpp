...
/// @brief Method .ctor addr 0xe92470 size 0x28 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe92498 size 0x30 virtual false final false
 void _ctor(int32_t c, int32_t d) ;

/// @brief Method get_AlgorithmName addr 0xe924c8 size 0x194 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetMacSize addr 0xe9265c size 0x8 virtual true final false
 int32_t GetMacSize() ;

/// @brief Method Init addr 0xe92664 size 0x154 virtual true final false
 void Init(Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method Update addr 0xe927b8 size 0x44 virtual true final false
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0xe927fc size 0x1ac virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t offset, int32_t length) ;

/// @brief Method DoFinal addr 0xe929a8 size 0x9c virtual true final false
 int64_t DoFinal() ;

/// @brief Method DoFinal addr 0xe92a44 size 0x44 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe92a88 size 0x64 virtual true final false
 void Reset() ;

/// @brief Method ProcessMessageWord addr 0xe92aec size 0x4c virtual true final false
 void ProcessMessageWord() ;

/// @brief Method ApplySipRounds addr 0xe92b38 size 0x4c virtual true final false
 void ApplySipRounds(int32_t n) ;

/// @brief Method RotateLeft addr 0xe92b84 size 0xc virtual false final false
