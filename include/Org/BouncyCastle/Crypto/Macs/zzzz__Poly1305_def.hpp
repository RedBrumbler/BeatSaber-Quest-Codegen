...
/// @brief Method .ctor addr 0xe917b4 size 0x74 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe91828 size 0x14c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher) ;

/// @brief Method Init addr 0xe91974 size 0x19c virtual true final true
 void Init(Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method SetKey addr 0xe91b10 size 0x344 virtual false final false
 void SetKey(::ArrayW<uint8_t> key, ::ArrayW<uint8_t> nonce) ;

/// @brief Method get_AlgorithmName addr 0xe91e60 size 0xe8 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method GetMacSize addr 0xe91f48 size 0x8 virtual true final true
 int32_t GetMacSize() ;

/// @brief Method Update addr 0xe91f50 size 0x34 virtual true final true
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0xe91f84 size 0xe8 virtual true final true
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len) ;

/// @brief Method ProcessBlock addr 0xe9206c size 0x21c virtual false final false
 void ProcessBlock() ;

/// @brief Method DoFinal addr 0xe92290 size 0x1e0 virtual true final true
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe91e54 size 0xc virtual true final true
 void Reset() ;

/// @brief Method mul32x32_64 addr 0xe92288 size 0x8 virtual false final false
