...
/// @brief Method .ctor addr 0xe8ba74 size 0x1e0 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher, int32_t bitBlockSize) ;

/// @brief Method Init addr 0xe8bc54 size 0x13c virtual true final true
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe8be4c size 0x104 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe8bf50 size 0x8 virtual true final true
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe8bf58 size 0x8 virtual true final true
 int32_t GetBlockSize() ;

/// @brief Method ProcessBlock addr 0xe8bf60 size 0x258 virtual true final true
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method Reset addr 0xe8bd90 size 0xbc virtual true final true
 void Reset() ;

/// @brief Method GetMacBlock addr 0xe8c1b8 size 0xbc virtual false final false
