...
/// @brief Method .ctor addr 0xeb85a0 size 0x160 virtual false final false
...
/// @brief Method .ctor addr 0xeb8700 size 0x10 virtual false final false
 void _ctor(::ArrayW<uint8_t> ikm, ::ArrayW<uint8_t> salt, ::ArrayW<uint8_t> info) ;

/// @brief Method SkipExtractParameters addr 0xeb8710 size 0x78 virtual false final false
static Org::BouncyCastle::Crypto::Parameters::HkdfParameters SkipExtractParameters(::ArrayW<uint8_t> ikm, ::ArrayW<uint8_t> info) ;

/// @brief Method DefaultParameters addr 0xeb8788 size 0x6c virtual false final false
static Org::BouncyCastle::Crypto::Parameters::HkdfParameters DefaultParameters(::ArrayW<uint8_t> ikm) ;

/// @brief Method GetIkm addr 0xeb87f4 size 0x5c virtual true final false
 ::ArrayW<uint8_t> GetIkm() ;

/// @brief Method get_SkipExtract addr 0xeb8850 size 0x8 virtual true final false
 bool get_SkipExtract() ;

/// @brief Method GetSalt addr 0xeb8858 size 0x5c virtual true final false
 ::ArrayW<uint8_t> GetSalt() ;

/// @brief Method GetInfo addr 0xeb88b4 size 0x5c virtual true final false
