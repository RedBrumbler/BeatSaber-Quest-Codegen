...
/// @brief Method .ctor addr 0xeb99d0 size 0x40 virtual false final false
 void _ctor(bool privateKey, Org::BouncyCastle::Math::BigInteger g, Org::BouncyCastle::Math::BigInteger n, int32_t lowerSigmaBound) ;

/// @brief Method get_G addr 0xeb9a10 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_G() ;

/// @brief Method get_LowerSigmaBound addr 0xeb9a18 size 0x8 virtual false final false
 int32_t get_LowerSigmaBound() ;

/// @brief Method get_Modulus addr 0xeb9a20 size 0x8 virtual false final false
