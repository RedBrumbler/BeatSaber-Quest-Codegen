...
/// @brief Method .ctor addr 0xeb80a0 size 0xdc virtual false final false
...
/// @brief Method .ctor addr 0xeb817c size 0xe4 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger x, Org::BouncyCastle::Asn1::DerObjectIdentifier publicKeyParamSet) ;

/// @brief Method get_X addr 0xeb8260 size 0x8 virtual false final false
