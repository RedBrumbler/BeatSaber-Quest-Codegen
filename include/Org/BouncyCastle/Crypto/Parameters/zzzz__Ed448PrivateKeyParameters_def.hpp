...
/// @brief Method .ctor addr 0xeb6790 size 0xd0 virtual false final false
...
/// @brief Method .ctor addr 0xeb6860 size 0xc0 virtual false final false
...
/// @brief Method .ctor addr 0xeb6920 size 0x10c virtual false final false
 void _ctor(System::IO::Stream input) ;

/// @brief Method Encode addr 0xeb6a2c size 0x84 virtual false final false
 void Encode(::ArrayW<uint8_t> buf, int32_t off) ;

/// @brief Method GetEncoded addr 0xeb6ab0 size 0x5c virtual false final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method GeneratePublicKey addr 0xeb6b0c size 0x174 virtual false final false
 Org::BouncyCastle::Crypto::Parameters::Ed448PublicKeyParameters GeneratePublicKey() ;

/// @brief Method Sign addr 0xeb6d3c size 0x20 virtual false final false
...
/// @brief Method Sign addr 0xeb6d5c size 0x22c virtual false final false
