...
/// @brief Method .ctor addr 0xeb8910 size 0x3c virtual false final false
 void _ctor(::ArrayW<uint8_t> derivation, ::ArrayW<uint8_t> encoding, int32_t macKeySize) ;

/// @brief Method GetDerivationV addr 0xeb894c size 0x8 virtual false final false
 ::ArrayW<uint8_t> GetDerivationV() ;

/// @brief Method GetEncodingV addr 0xeb8954 size 0x8 virtual false final false
 ::ArrayW<uint8_t> GetEncodingV() ;

/// @brief Method get_MacKeySize addr 0xeb895c size 0x8 virtual false final false
