...
/// @brief Method .ctor addr 0xeb784c size 0x84 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger y, Org::BouncyCastle::Crypto::Parameters::ElGamalParameters parameters) ;

/// @brief Method get_Y addr 0xeb78d0 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_Y() ;

/// @brief Method Equals addr 0xeb78d8 size 0x9c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0xeb7974 size 0x58 virtual false final false
 bool Equals(Org::BouncyCastle::Crypto::Parameters::ElGamalPublicKeyParameters other) ;

/// @brief Method GetHashCode addr 0xeb79cc size 0x40 virtual true final false
 int32_t GetHashCode() ;
