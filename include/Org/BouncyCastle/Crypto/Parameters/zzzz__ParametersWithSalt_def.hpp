...
/// @brief Method .ctor addr 0xeb9f34 size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0xeb9f50 size 0x94 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::ICipherParameters parameters, ::ArrayW<uint8_t> salt, int32_t saltOff, int32_t saltLen) ;

/// @brief Method GetSalt addr 0xeb9fe4 size 0x8 virtual false final false
 ::ArrayW<uint8_t> GetSalt() ;

/// @brief Method get_Parameters addr 0xeb9fec size 0x8 virtual false final false
