...
/// @brief Method .ctor addr 0xebc598 size 0xa4 virtual false final false
...
/// @brief Method .ctor addr 0xebc63c size 0xbc virtual false final false
...
/// @brief Method .ctor addr 0xebc6f8 size 0x108 virtual false final false
 void _ctor(System::IO::Stream input) ;

/// @brief Method Encode addr 0xebc800 size 0x84 virtual false final false
 void Encode(::ArrayW<uint8_t> buf, int32_t off) ;

/// @brief Method GetEncoded addr 0xebc884 size 0x5c virtual false final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method GeneratePublicKey addr 0xebc8e0 size 0xac virtual false final false
 Org::BouncyCastle::Crypto::Parameters::X25519PublicKeyParameters GeneratePublicKey() ;

/// @brief Method GenerateSecret addr 0xebca48 size 0xf4 virtual false final false
