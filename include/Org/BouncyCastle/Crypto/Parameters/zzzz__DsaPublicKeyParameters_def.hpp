...
/// @brief Method Validate addr 0xeb3c20 size 0x168 virtual false final false
...
/// @brief Method .ctor addr 0xeb3d88 size 0x90 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger y, Org::BouncyCastle::Crypto::Parameters::DsaParameters parameters) ;

/// @brief Method get_Y addr 0xeb3e18 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_Y() ;

/// @brief Method Equals addr 0xeb3e20 size 0x9c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0xeb3ebc size 0x58 virtual false final false
 bool Equals(Org::BouncyCastle::Crypto::Parameters::DsaPublicKeyParameters other) ;

/// @brief Method GetHashCode addr 0xeb3f14 size 0x40 virtual true final false
 int32_t GetHashCode() ;
