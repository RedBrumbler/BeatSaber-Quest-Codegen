...
/// @brief Method .ctor addr 0xea9f84 size 0x100 virtual false final false
...
/// @brief Method .ctor addr 0xeb1328 size 0x150 virtual false final false
 void _ctor(::ArrayW<uint8_t> key, int32_t keyOff, int32_t keyLen) ;

/// @brief Method GetKey addr 0xea09ec size 0x78 virtual false final false
