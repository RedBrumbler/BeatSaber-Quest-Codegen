...
/// @brief Method .ctor addr 0xeb8268 size 0xc0 virtual false final false
...
/// @brief Method .ctor addr 0xeb8328 size 0xc8 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger y, Org::BouncyCastle::Asn1::DerObjectIdentifier publicKeyParamSet) ;

/// @brief Method get_Y addr 0xeb83f0 size 0x8 virtual false final false
