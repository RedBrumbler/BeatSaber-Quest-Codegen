...
/// @brief Method .ctor addr 0xeb744c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xeb7454 size 0xb4 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger p, Org::BouncyCastle::Math::BigInteger g, int32_t l) ;

/// @brief Method get_P addr 0xeb7508 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_P() ;

/// @brief Method get_G addr 0xeb7510 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_G() ;

/// @brief Method get_L addr 0xeb7518 size 0x8 virtual false final false
 int32_t get_L() ;

/// @brief Method Equals addr 0xeb7520 size 0x9c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0xeb75bc size 0x74 virtual false final false
 bool Equals(Org::BouncyCastle::Crypto::Parameters::ElGamalParameters other) ;

/// @brief Method GetHashCode addr 0xeb7630 size 0x58 virtual true final false
 int32_t GetHashCode() ;
