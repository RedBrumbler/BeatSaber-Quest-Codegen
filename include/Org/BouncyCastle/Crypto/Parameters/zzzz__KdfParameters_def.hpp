...
/// @brief Method .ctor addr 0xeb947c size 0x2c virtual false final false
 void _ctor(::ArrayW<uint8_t> shared, ::ArrayW<uint8_t> iv) ;

/// @brief Method GetSharedSecret addr 0xeb94a8 size 0x8 virtual false final false
 ::ArrayW<uint8_t> GetSharedSecret() ;

/// @brief Method GetIV addr 0xeb94b0 size 0x8 virtual false final false
