...
/// @brief Method .ctor addr 0xeb3700 size 0x4c virtual false final false
...
/// @brief Method .ctor addr 0xeb374c size 0x54 virtual false final false
 void _ctor(int32_t L, int32_t N, int32_t certainty, Org::BouncyCastle::Security::SecureRandom random, int32_t usageIndex) ;

/// @brief Method get_L addr 0xeb37a0 size 0x8 virtual true final false
 int32_t get_L() ;

/// @brief Method get_N addr 0xeb37a8 size 0x8 virtual true final false
 int32_t get_N() ;

/// @brief Method get_UsageIndex addr 0xeb37b0 size 0x8 virtual true final false
 int32_t get_UsageIndex() ;

/// @brief Method get_Certainty addr 0xeb37b8 size 0x8 virtual true final false
 int32_t get_Certainty() ;

/// @brief Method get_Random addr 0xeb37c0 size 0x8 virtual true final false
