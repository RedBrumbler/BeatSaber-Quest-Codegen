...
/// @brief Method .ctor addr 0xeb83f8 size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0xeb8424 size 0x2c virtual false final false
 void _ctor(int64_t x0L, int64_t cL) ;

/// @brief Method get_C addr 0xeb8450 size 0x8 virtual false final false
 int32_t get_C() ;

/// @brief Method get_X0 addr 0xeb8458 size 0x8 virtual false final false
 int32_t get_X0() ;

/// @brief Method get_CL addr 0xeb8460 size 0x8 virtual false final false
 int64_t get_CL() ;

/// @brief Method get_X0L addr 0xeb8468 size 0x8 virtual false final false
 int64_t get_X0L() ;

/// @brief Method Equals addr 0xeb8470 size 0xc8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0xeb8538 size 0x68 virtual true final false
 int32_t GetHashCode() ;
