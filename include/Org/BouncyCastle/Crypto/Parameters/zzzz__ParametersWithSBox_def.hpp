...
/// @brief Method .ctor addr 0xeb9ff4 size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::ICipherParameters parameters, ::ArrayW<uint8_t> sBox) ;

/// @brief Method GetSBox addr 0xeba020 size 0x8 virtual false final false
 ::ArrayW<uint8_t> GetSBox() ;

/// @brief Method get_Parameters addr 0xeba028 size 0x8 virtual false final false
