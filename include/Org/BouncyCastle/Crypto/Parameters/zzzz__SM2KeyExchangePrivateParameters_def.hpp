...
/// @brief Method .ctor addr 0xebc118 size 0x274 virtual false final false
...
/// @brief Method get_IsInitiator addr 0xebc38c size 0x8 virtual true final false
 bool get_IsInitiator() ;

/// @brief Method get_StaticPrivateKey addr 0xebc394 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters get_StaticPrivateKey() ;

/// @brief Method get_StaticPublicPoint addr 0xebc39c size 0x8 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint get_StaticPublicPoint() ;

/// @brief Method get_EphemeralPrivateKey addr 0xebc3a4 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters get_EphemeralPrivateKey() ;

/// @brief Method get_EphemeralPublicPoint addr 0xebc3ac size 0x8 virtual true final false
