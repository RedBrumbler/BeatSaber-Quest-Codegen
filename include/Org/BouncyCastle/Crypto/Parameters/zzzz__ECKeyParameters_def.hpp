...
/// @brief Method .ctor addr 0xeb4e58 size 0xfc virtual false final false
...
/// @brief Method .ctor addr 0xeb5078 size 0x108 virtual false final false
 void _ctor(::StringW algorithm, bool isPrivate, Org::BouncyCastle::Asn1::DerObjectIdentifier publicKeyParamSet) ;

/// @brief Method get_AlgorithmName addr 0xeb5180 size 0x8 virtual false final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_Parameters addr 0xeb5188 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::Parameters::ECDomainParameters get_Parameters() ;

/// @brief Method get_PublicKeyParamSet addr 0xeb5190 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_PublicKeyParamSet() ;

/// @brief Method Equals addr 0xeb5198 size 0xa4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0xeb523c size 0x58 virtual false final false
 bool Equals(Org::BouncyCastle::Crypto::Parameters::ECKeyParameters other) ;

/// @brief Method GetHashCode addr 0xeb5294 size 0x4c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method CreateKeyGenerationParameters addr 0xeb52e0 size 0x94 virtual false final false
...
/// @brief Method VerifyAlgorithmName addr 0xeb4f54 size 0x124 virtual false final false
static ::StringW VerifyAlgorithmName(::StringW algorithm) ;

/// @brief Method LookupParameters addr 0xeb4d38 size 0x110 virtual false final false
