...
/// @brief Method .ctor addr 0xeb42a8 size 0x48 virtual false final false
...
/// @brief Method .ctor addr 0xeb4438 size 0x8c virtual false final false
...
/// @brief Method .ctor addr 0xeb44c4 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xeb42f0 size 0x148 virtual false final false
...
/// @brief Method get_Curve addr 0xeb45fc size 0x8 virtual false final false
 Org::BouncyCastle::Math::EC::ECCurve get_Curve() ;

/// @brief Method get_G addr 0xeb4604 size 0x8 virtual false final false
 Org::BouncyCastle::Math::EC::ECPoint get_G() ;

/// @brief Method get_N addr 0xeb460c size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_N() ;

/// @brief Method get_H addr 0xeb4614 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_H() ;

/// @brief Method get_HInv addr 0xeb461c size 0xc4 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_HInv() ;

/// @brief Method GetSeed addr 0xeb46e0 size 0x5c virtual false final false
 ::ArrayW<uint8_t> GetSeed() ;

/// @brief Method Equals addr 0xeb473c size 0xa4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0xeb47e0 size 0x88 virtual true final false
 bool Equals(Org::BouncyCastle::Crypto::Parameters::ECDomainParameters other) ;

/// @brief Method GetHashCode addr 0xeb4868 size 0x7c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ValidatePrivateScalar addr 0xeb48e4 size 0x138 virtual false final false
 Org::BouncyCastle::Math::BigInteger ValidatePrivateScalar(Org::BouncyCastle::Math::BigInteger d) ;

/// @brief Method ValidatePublicPoint addr 0xeb4a1c size 0x8 virtual false final false
 Org::BouncyCastle::Math::EC::ECPoint ValidatePublicPoint(Org::BouncyCastle::Math::EC::ECPoint q) ;

/// @brief Method ValidatePublicPoint addr 0xeb44cc size 0x130 virtual false final false
