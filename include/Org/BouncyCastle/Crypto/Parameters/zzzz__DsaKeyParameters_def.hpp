...
/// @brief Method .ctor addr 0xeb358c size 0x30 virtual false final false
 void _ctor(bool isPrivate, Org::BouncyCastle::Crypto::Parameters::DsaParameters parameters) ;

/// @brief Method get_Parameters addr 0xeb35bc size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::Parameters::DsaParameters get_Parameters() ;

/// @brief Method Equals addr 0xeb35c4 size 0x9c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0xeb3660 size 0x50 virtual false final false
 bool Equals(Org::BouncyCastle::Crypto::Parameters::DsaKeyParameters other) ;

/// @brief Method GetHashCode addr 0xeb36b0 size 0x50 virtual true final false
 int32_t GetHashCode() ;
