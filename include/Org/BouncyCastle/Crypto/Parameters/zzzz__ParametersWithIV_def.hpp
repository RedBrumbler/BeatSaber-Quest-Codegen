...
/// @brief Method .ctor addr 0xeb9c0c size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0xeb9c28 size 0xe8 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::ICipherParameters parameters, ::ArrayW<uint8_t> iv, int32_t ivOff, int32_t ivLen) ;

/// @brief Method GetIV addr 0xeb9d10 size 0x78 virtual false final false
 ::ArrayW<uint8_t> GetIV() ;

/// @brief Method get_Parameters addr 0xeb9d88 size 0x8 virtual false final false
