...
/// @brief Method .ctor addr 0xeb5c64 size 0xd0 virtual false final false
...
/// @brief Method .ctor addr 0xeb5d34 size 0xc0 virtual false final false
...
/// @brief Method .ctor addr 0xeb5df4 size 0x10c virtual false final false
 void _ctor(System::IO::Stream input) ;

/// @brief Method Encode addr 0xeb5f00 size 0x84 virtual false final false
 void Encode(::ArrayW<uint8_t> buf, int32_t off) ;

/// @brief Method GetEncoded addr 0xeb5f84 size 0x5c virtual false final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method GeneratePublicKey addr 0xeb5fe0 size 0x174 virtual false final false
 Org::BouncyCastle::Crypto::Parameters::Ed25519PublicKeyParameters GeneratePublicKey() ;

/// @brief Method Sign addr 0xeb6210 size 0x20 virtual false final false
...
/// @brief Method Sign addr 0xeb6230 size 0x280 virtual false final false
