...
/// @brief Method .ctor addr 0xeb4c70 size 0x4c virtual false final false
...
/// @brief Method .ctor addr 0xeb4cbc size 0x7c virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::DerObjectIdentifier publicKeyParamSet, Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method get_DomainParameters addr 0xeb4e48 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::Parameters::ECDomainParameters get_DomainParameters() ;

/// @brief Method get_PublicKeyParamSet addr 0xeb4e50 size 0x8 virtual false final false
