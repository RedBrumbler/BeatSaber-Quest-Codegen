...
/// @brief Method .ctor addr 0xeb9d90 size 0xa4 virtual false final false
...
/// @brief Method .ctor addr 0xeb9e34 size 0x70 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetRandom addr 0xeb9f1c size 0x8 virtual false final false
 Org::BouncyCastle::Security::SecureRandom GetRandom() ;

/// @brief Method get_Random addr 0xeb9f24 size 0x8 virtual false final false
 Org::BouncyCastle::Security::SecureRandom get_Random() ;

/// @brief Method get_Parameters addr 0xeb9f2c size 0x8 virtual false final false
