...
/// @brief Method Validate addr 0xeba374 size 0x16c virtual false final false
...
/// @brief Method .ctor addr 0xeba4e0 size 0x1c8 virtual false final false
 void _ctor(bool isPrivate, Org::BouncyCastle::Math::BigInteger modulus, Org::BouncyCastle::Math::BigInteger exponent) ;

/// @brief Method get_Modulus addr 0xeba6a8 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_Modulus() ;

/// @brief Method get_Exponent addr 0xeba6b0 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_Exponent() ;

/// @brief Method Equals addr 0xeba6b8 size 0xe0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0xeba798 size 0x78 virtual true final false
 int32_t GetHashCode() ;
