...
/// @brief Method .ctor addr 0xeb1fa4 size 0x3c virtual false final false
 void _ctor(Org::BouncyCastle::Security::SecureRandom random, Org::BouncyCastle::Crypto::Parameters::DHParameters parameters) ;

/// @brief Method get_Parameters addr 0xeb2014 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::Parameters::DHParameters get_Parameters() ;

/// @brief Method GetStrength addr 0xeb1fe0 size 0x34 virtual false final false
