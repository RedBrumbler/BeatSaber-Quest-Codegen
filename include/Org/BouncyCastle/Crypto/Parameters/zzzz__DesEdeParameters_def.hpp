...
/// @brief Method FixKey addr 0xeb1a10 size 0x1ac virtual false final false
...
/// @brief Method .ctor addr 0xeb1bd8 size 0x7c virtual false final false
...
/// @brief Method .ctor addr 0xeb1c54 size 0x8c virtual false final false
 void _ctor(::ArrayW<uint8_t> key, int32_t keyOff, int32_t keyLen) ;

/// @brief Method IsWeakKey addr 0xeb1ce0 size 0x90 virtual false final false
static bool IsWeakKey(::ArrayW<uint8_t> key, int32_t offset, int32_t length) ;

/// @brief Method IsWeakKey addr 0xeb1d70 size 0x1c virtual false final false
static bool IsWeakKey(::ArrayW<uint8_t> key, int32_t offset) ;

/// @brief Method IsWeakKey addr 0xeb1bbc size 0x1c virtual false final false
static bool IsWeakKey(::ArrayW<uint8_t> key) ;

/// @brief Method IsRealEdeKey addr 0xeb1d8c size 0x28 virtual false final false
static bool IsRealEdeKey(::ArrayW<uint8_t> key, int32_t offset) ;

/// @brief Method IsReal2Key addr 0xeb1e5c size 0x64 virtual false final false
static bool IsReal2Key(::ArrayW<uint8_t> key, int32_t offset) ;

/// @brief Method IsReal3Key addr 0xeb1db4 size 0xa8 virtual false final false
