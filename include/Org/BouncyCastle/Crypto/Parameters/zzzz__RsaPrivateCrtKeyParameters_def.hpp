...
/// @brief Method .ctor addr 0xeba8a4 size 0x22c virtual false final false
...
/// @brief Method .ctor addr 0xebaba0 size 0x38 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Pkcs::RsaPrivateKeyStructure rsaPrivateKey) ;

/// @brief Method get_PublicExponent addr 0xebabd8 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_PublicExponent() ;

/// @brief Method get_P addr 0xebabe0 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_P() ;

/// @brief Method get_Q addr 0xebabe8 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_Q() ;

/// @brief Method get_DP addr 0xebabf0 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_DP() ;

/// @brief Method get_DQ addr 0xebabf8 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_DQ() ;

/// @brief Method get_QInv addr 0xebac00 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_QInv() ;

/// @brief Method Equals addr 0xebac08 size 0x178 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0xebad80 size 0x120 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ValidateValue addr 0xebaad0 size 0xd0 virtual false final false
