...
/// @brief Method .ctor addr 0xeb3208 size 0xfc virtual false final false
 void _ctor(::ArrayW<uint8_t> seed, int32_t counter) ;

/// @brief Method GetSeed addr 0xeb3304 size 0x78 virtual false final false
 ::ArrayW<uint8_t> GetSeed() ;

/// @brief Method get_Counter addr 0xeb337c size 0x8 virtual false final false
 int32_t get_Counter() ;

/// @brief Method Equals addr 0xeb3384 size 0x9c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0xeb3420 size 0x90 virtual false final false
 bool Equals(Org::BouncyCastle::Crypto::Parameters::DHValidationParameters other) ;

/// @brief Method GetHashCode addr 0xeb34b0 size 0x88 virtual true final false
 int32_t GetHashCode() ;
