...
/// @brief Method .ctor addr 0xeb7688 size 0x88 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger x, Org::BouncyCastle::Crypto::Parameters::ElGamalParameters parameters) ;

/// @brief Method get_X addr 0xeb7710 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_X() ;

/// @brief Method Equals addr 0xeb7718 size 0x9c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0xeb77b4 size 0x58 virtual false final false
 bool Equals(Org::BouncyCastle::Crypto::Parameters::ElGamalPrivateKeyParameters other) ;

/// @brief Method GetHashCode addr 0xeb780c size 0x40 virtual true final false
 int32_t GetHashCode() ;
