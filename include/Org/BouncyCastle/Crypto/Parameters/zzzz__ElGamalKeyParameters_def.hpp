...
/// @brief Method .ctor addr 0xeb72d8 size 0x30 virtual false final false
 void _ctor(bool isPrivate, Org::BouncyCastle::Crypto::Parameters::ElGamalParameters parameters) ;

/// @brief Method get_Parameters addr 0xeb7308 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::Parameters::ElGamalParameters get_Parameters() ;

/// @brief Method Equals addr 0xeb7310 size 0x9c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0xeb73ac size 0x50 virtual false final false
 bool Equals(Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters other) ;

/// @brief Method GetHashCode addr 0xeb73fc size 0x50 virtual true final false
 int32_t GetHashCode() ;
