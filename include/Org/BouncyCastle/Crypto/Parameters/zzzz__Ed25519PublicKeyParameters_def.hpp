...
/// @brief Method .ctor addr 0xeb6154 size 0xbc virtual false final false
...
/// @brief Method .ctor addr 0xeb65ac size 0x108 virtual false final false
 void _ctor(System::IO::Stream input) ;

/// @brief Method Encode addr 0xeb64b0 size 0x84 virtual false final false
 void Encode(::ArrayW<uint8_t> buf, int32_t off) ;

/// @brief Method GetEncoded addr 0xeb66b4 size 0x5c virtual false final false
