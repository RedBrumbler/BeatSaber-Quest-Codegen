...
/// @brief Method .ctor addr 0xeb7a0c size 0x4c virtual false final false
...
/// @brief Method .ctor addr 0xeb7a58 size 0x3c virtual false final false
 void _ctor(Org::BouncyCastle::Security::SecureRandom random, Org::BouncyCastle::Asn1::DerObjectIdentifier publicKeyParamSet) ;

/// @brief Method get_Parameters addr 0xeb7c0c size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters get_Parameters() ;

/// @brief Method get_PublicKeyParamSet addr 0xeb7c14 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_PublicKeyParamSet() ;

/// @brief Method LookupParameters addr 0xeb7a94 size 0x178 virtual false final false
