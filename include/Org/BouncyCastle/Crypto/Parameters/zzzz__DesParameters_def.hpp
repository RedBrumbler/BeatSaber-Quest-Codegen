...
/// @brief Method .ctor addr 0xeb1478 size 0xc0 virtual false final false
...
/// @brief Method .ctor addr 0xeb1590 size 0xdc virtual false final false
 void _ctor(::ArrayW<uint8_t> key, int32_t keyOff, int32_t keyLen) ;

/// @brief Method IsWeakKey addr 0xeb166c size 0x154 virtual false final false
static bool IsWeakKey(::ArrayW<uint8_t> key, int32_t offset) ;

/// @brief Method IsWeakKey addr 0xeb1538 size 0x58 virtual false final false
static bool IsWeakKey(::ArrayW<uint8_t> key) ;

/// @brief Method SetOddParity addr 0xeb17c0 size 0x20 virtual false final false
static uint8_t SetOddParity(uint8_t b) ;

/// @brief Method SetOddParity addr 0xeb17e0 size 0xbc virtual false final false
static void SetOddParity(::ArrayW<uint8_t> bytes) ;

/// @brief Method SetOddParity addr 0xeb189c size 0xe0 virtual false final false
