...
/// @brief Method .ctor addr 0xeb3f54 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xeb3f5c size 0x108 virtual false final false
 void _ctor(::ArrayW<uint8_t> seed, int32_t counter, int32_t usageIndex) ;

/// @brief Method GetSeed addr 0xeb4064 size 0x78 virtual true final false
 ::ArrayW<uint8_t> GetSeed() ;

/// @brief Method get_Counter addr 0xeb40dc size 0x8 virtual true final false
 int32_t get_Counter() ;

/// @brief Method get_UsageIndex addr 0xeb40e4 size 0x8 virtual true final false
 int32_t get_UsageIndex() ;

/// @brief Method Equals addr 0xeb40ec size 0xa4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0xeb4190 size 0x90 virtual true final false
 bool Equals(Org::BouncyCastle::Crypto::Parameters::DsaValidationParameters other) ;

/// @brief Method GetHashCode addr 0xeb4220 size 0x88 virtual true final false
 int32_t GetHashCode() ;
