...
/// @brief Method .ctor addr 0xeb94b8 size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0xeb94d4 size 0x90 virtual false final false
 void _ctor(::ArrayW<uint8_t> seed, int32_t off, int32_t len) ;

/// @brief Method GetSeed addr 0xeb9564 size 0x78 virtual false final false
