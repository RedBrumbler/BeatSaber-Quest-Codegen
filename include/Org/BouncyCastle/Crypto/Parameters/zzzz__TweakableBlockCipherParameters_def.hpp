...
/// @brief Method .ctor addr 0xebc4fc size 0x80 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Parameters::KeyParameter key, ::ArrayW<uint8_t> tweak) ;

/// @brief Method get_Key addr 0xebc57c size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::Parameters::KeyParameter get_Key() ;

/// @brief Method get_Tweak addr 0xebc584 size 0x8 virtual false final false
