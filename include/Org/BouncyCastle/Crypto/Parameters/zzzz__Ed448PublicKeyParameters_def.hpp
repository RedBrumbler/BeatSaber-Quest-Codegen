...
/// @brief Method .ctor addr 0xeb6c80 size 0xbc virtual false final false
...
/// @brief Method .ctor addr 0xeb7084 size 0x108 virtual false final false
 void _ctor(System::IO::Stream input) ;

/// @brief Method Encode addr 0xeb6f88 size 0x84 virtual false final false
 void Encode(::ArrayW<uint8_t> buf, int32_t off) ;

/// @brief Method GetEncoded addr 0xeb718c size 0x5c virtual false final false
