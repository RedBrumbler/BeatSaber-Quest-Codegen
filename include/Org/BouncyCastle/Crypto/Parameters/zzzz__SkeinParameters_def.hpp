...
/// @brief Method .ctor addr 0xebb49c size 0x64 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xebb500 size 0x380 virtual false final false
...
/// @brief Method .ctor addr 0xebb880 size 0x390 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Parameters::SkeinParameters parameters) ;

/// @brief Method Set addr 0xebbc10 size 0x178 virtual false final false
...
/// @brief Method SetKey addr 0xebbd88 size 0xc virtual false final false
...
/// @brief Method SetPersonalisation addr 0xebbd94 size 0xc virtual false final false
...
/// @brief Method SetPersonalisation addr 0xebbda0 size 0x2ec virtual false final false
...
/// @brief Method SetPublicKey addr 0xebc08c size 0xc virtual false final false
...
/// @brief Method SetKeyIdentifier addr 0xebc098 size 0xc virtual false final false
...
/// @brief Method SetNonce addr 0xebc0a4 size 0xc virtual false final false
...
/// @brief Method Build addr 0xebc0b0 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0xebaea0 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xebaf0c size 0x28 virtual false final false
 void _ctor(System::Collections::IDictionary parameters) ;

/// @brief Method GetParameters addr 0xebaf34 size 0x8 virtual false final false
 System::Collections::IDictionary GetParameters() ;

/// @brief Method GetKey addr 0xebaf3c size 0x110 virtual false final false
 ::ArrayW<uint8_t> GetKey() ;

/// @brief Method GetPersonalisation addr 0xebb04c size 0x114 virtual false final false
 ::ArrayW<uint8_t> GetPersonalisation() ;

/// @brief Method GetPublicKey addr 0xebb160 size 0x114 virtual false final false
 ::ArrayW<uint8_t> GetPublicKey() ;

/// @brief Method GetKeyIdentifier addr 0xebb274 size 0x114 virtual false final false
 ::ArrayW<uint8_t> GetKeyIdentifier() ;

/// @brief Method GetNonce addr 0xebb388 size 0x114 virtual false final false
