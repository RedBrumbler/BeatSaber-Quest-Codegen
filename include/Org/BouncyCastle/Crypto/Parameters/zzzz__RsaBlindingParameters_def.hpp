...
/// @brief Method .ctor addr 0xeba190 size 0x88 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Parameters::RsaKeyParameters publicKey, Org::BouncyCastle::Math::BigInteger blindingFactor) ;

/// @brief Method get_PublicKey addr 0xeba218 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::Parameters::RsaKeyParameters get_PublicKey() ;

/// @brief Method get_BlindingFactor addr 0xeba220 size 0x8 virtual false final false
