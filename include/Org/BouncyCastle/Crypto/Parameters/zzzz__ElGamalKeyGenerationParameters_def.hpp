...
explicit ElGamalKeyGenerationParameters(Org::BouncyCastle::Security::SecureRandom random, Org::BouncyCastle::Crypto::Parameters::ElGamalParameters parameters) ;

/// @brief Method .ctor addr 0xeb7260 size 0x3c virtual false final false
 void _ctor(Org::BouncyCastle::Security::SecureRandom random, Org::BouncyCastle::Crypto::Parameters::ElGamalParameters parameters) ;

/// @brief Method get_Parameters addr 0xeb72d0 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::Parameters::ElGamalParameters get_Parameters() ;

/// @brief Method GetStrength addr 0xeb729c size 0x34 virtual false final false
