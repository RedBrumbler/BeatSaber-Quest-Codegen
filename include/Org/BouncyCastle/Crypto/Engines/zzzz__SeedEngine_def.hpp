...
/// @brief Method Init addr 0xe63e28 size 0xac virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe6407c size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe640bc size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe640c4 size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method ProcessBlock addr 0xe640cc size 0x1f8 virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> inBuf, int32_t inOff, ::ArrayW<uint8_t> outBuf, int32_t outOff) ;

/// @brief Method Reset addr 0xe643dc size 0x4 virtual true final false
 void Reset() ;

/// @brief Method createWorkingKey addr 0xe63ed4 size 0x1a8 virtual false final false
 ::ArrayW<int32_t> createWorkingKey(::ArrayW<uint8_t> inKey) ;

/// @brief Method extractW1 addr 0xe643e8 size 0x8 virtual false final false
 int32_t extractW1(int64_t lVal) ;

/// @brief Method extractW0 addr 0xe643e0 size 0x8 virtual false final false
 int32_t extractW0(int64_t lVal) ;

/// @brief Method rotateLeft8 addr 0xe644e4 size 0x8 virtual false final false
 int64_t rotateLeft8(int64_t x) ;

/// @brief Method rotateRight8 addr 0xe644dc size 0x8 virtual false final false
 int64_t rotateRight8(int64_t x) ;

/// @brief Method bytesToLong addr 0xe642c4 size 0x5c virtual false final false
 int64_t bytesToLong(::ArrayW<uint8_t> src, int32_t srcOff) ;

/// @brief Method longToBytes addr 0xe64384 size 0x58 virtual false final false
 void longToBytes(::ArrayW<uint8_t> dest, int32_t destOff, int64_t value) ;

/// @brief Method G addr 0xe643f0 size 0xec virtual false final false
 int32_t G(int32_t x) ;

/// @brief Method F addr 0xe64320 size 0x64 virtual false final false
 int64_t F(int32_t ki0, int32_t ki1, int64_t r) ;

/// @brief Method phaseCalc1 addr 0xe6452c size 0x20 virtual false final false
 int32_t phaseCalc1(int32_t r0, int32_t ki0, int32_t r1, int32_t ki1) ;

/// @brief Method phaseCalc2 addr 0xe644ec size 0x40 virtual false final false
 int32_t phaseCalc2(int32_t r0, int32_t ki0, int32_t r1, int32_t ki1) ;

// Ctor Parameters []
explicit SeedEngine() ;

/// @brief Method .ctor addr 0xe646e0 size 0x8 virtual false final false
 void _ctor() ;
