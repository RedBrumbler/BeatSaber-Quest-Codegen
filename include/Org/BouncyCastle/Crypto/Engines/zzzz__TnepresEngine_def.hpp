...
/// @brief Method get_AlgorithmName addr 0xe6ff38 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method MakeWorkingKey addr 0xe6ff78 size 0x15e0 virtual true final false
 ::ArrayW<int32_t> MakeWorkingKey(::ArrayW<uint8_t> key) ;

/// @brief Method EncryptBlock addr 0xe71558 size 0x1540 virtual true final false
 void EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method DecryptBlock addr 0xe72a98 size 0x1738 virtual true final false
 void DecryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

// Ctor Parameters []
explicit TnepresEngine() ;

/// @brief Method .ctor addr 0xe741d0 size 0x58 virtual false final false
 void _ctor() ;
