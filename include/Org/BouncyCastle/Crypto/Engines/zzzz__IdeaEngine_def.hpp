...
/// @brief Method .ctor addr 0xe5627c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0xe56284 size 0x120 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe563cc size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe5640c size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe56414 size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method ProcessBlock addr 0xe5641c size 0x118 virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe567cc size 0x4 virtual true final false
 void Reset() ;

/// @brief Method BytesToWord addr 0xe567d0 size 0x40 virtual false final false
 int32_t BytesToWord(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method WordToBytes addr 0xe56810 size 0x48 virtual false final false
 void WordToBytes(int32_t word, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method Mul addr 0xe56858 size 0xdc virtual false final false
 int32_t Mul(int32_t x, int32_t y) ;

/// @brief Method IdeaFunc addr 0xe56534 size 0x298 virtual false final false
 void IdeaFunc(::ArrayW<int32_t> workingKey, ::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method ExpandKey addr 0xe56934 size 0x1f8 virtual false final false
 ::ArrayW<int32_t> ExpandKey(::ArrayW<uint8_t> uKey) ;

/// @brief Method MulInv addr 0xe56b2c size 0x118 virtual false final false
 int32_t MulInv(int32_t x) ;

/// @brief Method AddInv addr 0xe56c44 size 0x64 virtual false final false
 int32_t AddInv(int32_t x) ;

/// @brief Method InvertKey addr 0xe56ca8 size 0x288 virtual false final false
 ::ArrayW<int32_t> InvertKey(::ArrayW<int32_t> inKey) ;

/// @brief Method GenerateWorkingKey addr 0xe563a4 size 0x28 virtual false final false
