...
/// @brief Method .ctor addr 0xe5ecb8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_AlgorithmName addr 0xe5ecc0 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe5ed00 size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe5ed08 size 0x5c virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method Init addr 0xe5ed64 size 0x140 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method ProcessBlock addr 0xe5f158 size 0x150 virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe5f858 size 0x4 virtual true final false
 void Reset() ;

/// @brief Method SetKey addr 0xe5eea4 size 0x2b4 virtual false final false
 void SetKey(::ArrayW<uint8_t> key) ;

/// @brief Method EncryptBlock addr 0xe5f57c size 0x2dc virtual false final false
 int32_t EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method DecryptBlock addr 0xe5f2a8 size 0x2d4 virtual false final false
 int32_t DecryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method RotateLeft addr 0xe5f85c size 0x80 virtual false final false
 int32_t RotateLeft(int32_t x, int32_t y) ;

/// @brief Method RotateRight addr 0xe5fa4c size 0x80 virtual false final false
 int32_t RotateRight(int32_t x, int32_t y) ;

/// @brief Method BytesToWord addr 0xe5f8dc size 0xb0 virtual false final false
 int32_t BytesToWord(::ArrayW<uint8_t> src, int32_t srcOff) ;

/// @brief Method WordToBytes addr 0xe5f98c size 0xc0 virtual false final false
