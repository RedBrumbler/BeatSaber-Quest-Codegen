...
/// @brief Method get_AlgorithmName addr 0xe75dbc size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xe75dfc size 0x198 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method InitKey addr 0xe75f94 size 0x1fc virtual true final false
 void InitKey(::ArrayW<uint8_t> keyBytes, ::ArrayW<uint8_t> ivBytes) ;

/// @brief Method ProcessBytes addr 0xe76190 size 0x1c0 virtual true final false
 void ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t len, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe76350 size 0x10 virtual true final false
 void Reset() ;

/// @brief Method ReturnByte addr 0xe76360 size 0xc4 virtual true final false
 uint8_t ReturnByte(uint8_t input) ;

// Ctor Parameters []
explicit VmpcEngine() ;

/// @brief Method .ctor addr 0xe76424 size 0x14 virtual false final false
 void _ctor() ;
