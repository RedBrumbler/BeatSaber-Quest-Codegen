...
/// @brief Method F1 addr 0xe54d34 size 0x10 virtual false final false
static uint32_t F1(uint32_t x) ;

/// @brief Method F2 addr 0xe54d4c size 0x10 virtual false final false
static uint32_t F2(uint32_t x) ;

/// @brief Method G1 addr 0xe54d5c size 0x14 virtual false final false
 uint32_t G1(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method G2 addr 0xe54d70 size 0x14 virtual false final false
 uint32_t G2(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method RotateLeft addr 0xe54d84 size 0xc virtual false final false
static uint32_t RotateLeft(uint32_t x, int32_t bits) ;

/// @brief Method RotateRight addr 0xe54d44 size 0x8 virtual false final false
static uint32_t RotateRight(uint32_t x, int32_t bits) ;

/// @brief Method H1 addr 0xe54d90 size 0x4c virtual false final false
 uint32_t H1(uint32_t x) ;

/// @brief Method H2 addr 0xe54ddc size 0x4c virtual false final false
 uint32_t H2(uint32_t x) ;

/// @brief Method Mod1024 addr 0xe54e28 size 0x8 virtual false final false
static uint32_t Mod1024(uint32_t x) ;

/// @brief Method Mod512 addr 0xe54e30 size 0x8 virtual false final false
static uint32_t Mod512(uint32_t x) ;

/// @brief Method Dim addr 0xe54e38 size 0xc virtual false final false
static uint32_t Dim(uint32_t x, uint32_t y) ;

/// @brief Method Step addr 0xe54e44 size 0x1a8 virtual false final false
 uint32_t Step() ;

/// @brief Method Init addr 0xe54fec size 0x300 virtual false final false
 void Init() ;

/// @brief Method get_AlgorithmName addr 0xe552ec size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xe5532c size 0x1d4 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetByte addr 0xe55500 size 0x60 virtual false final false
 uint8_t GetByte() ;

/// @brief Method ProcessBytes addr 0xe55560 size 0x19c virtual true final false
 void ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t len, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe556fc size 0x4 virtual true final false
 void Reset() ;

/// @brief Method ReturnByte addr 0xe55700 size 0x18 virtual true final false
 uint8_t ReturnByte(uint8_t input) ;

// Ctor Parameters []
explicit HC128Engine() ;

/// @brief Method .ctor addr 0xe55718 size 0x9c virtual false final false
 void _ctor() ;
