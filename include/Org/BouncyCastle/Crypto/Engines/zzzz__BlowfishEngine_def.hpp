...
/// @brief Method .ctor addr 0xe40494 size 0xe8 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0xe4057c size 0x144 virtual true final true
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe409c8 size 0x40 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe40a08 size 0x8 virtual true final true
 bool get_IsPartialBlockOkay() ;

/// @brief Method ProcessBlock addr 0xe40a10 size 0x138 virtual true final true
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe40e7c size 0x4 virtual true final true
 void Reset() ;

/// @brief Method GetBlockSize addr 0xe40e80 size 0x8 virtual true final true
 int32_t GetBlockSize() ;

/// @brief Method F addr 0xe40e88 size 0xa0 virtual false final false
 uint32_t F(uint32_t x) ;

/// @brief Method ProcessTable addr 0xe40f28 size 0x1a8 virtual false final false
 void ProcessTable(uint32_t xl, uint32_t xr, ::ArrayW<uint32_t> table) ;

/// @brief Method SetKey addr 0xe406c0 size 0x308 virtual false final false
 void SetKey(::ArrayW<uint8_t> key) ;

/// @brief Method EncryptBlock addr 0xe40b48 size 0x1a4 virtual false final false
 void EncryptBlock(::ArrayW<uint8_t> src, int32_t srcIndex, ::ArrayW<uint8_t> dst, int32_t dstIndex) ;

/// @brief Method DecryptBlock addr 0xe40cec size 0x190 virtual false final false
