...
/// @brief Method get_AlgorithmName addr 0xe76438 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method InitKey addr 0xe76478 size 0x2a4 virtual true final false
 void InitKey(::ArrayW<uint8_t> keyBytes, ::ArrayW<uint8_t> ivBytes) ;

// Ctor Parameters []
explicit VmpcKsa3Engine() ;

/// @brief Method .ctor addr 0xe7671c size 0x14 virtual false final false
 void _ctor() ;
