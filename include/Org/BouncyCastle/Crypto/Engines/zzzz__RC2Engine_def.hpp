...
/// @brief Method GenerateWorkingKey addr 0xe5b2ac size 0x2e0 virtual false final false
 ::ArrayW<int32_t> GenerateWorkingKey(::ArrayW<uint8_t> key, int32_t bits) ;

/// @brief Method Init addr 0xe5b58c size 0x174 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method Reset addr 0xe5b700 size 0x4 virtual true final false
 void Reset() ;

/// @brief Method get_AlgorithmName addr 0xe5b704 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe5b744 size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe5b74c size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method ProcessBlock addr 0xe5b754 size 0x138 virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method RotateWordLeft addr 0xe5c1c4 size 0x1c virtual false final false
 int32_t RotateWordLeft(int32_t x, int32_t y) ;

/// @brief Method EncryptBlock addr 0xe5b88c size 0x4e0 virtual false final false
 void EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method DecryptBlock addr 0xe5bd6c size 0x458 virtual false final false
 void DecryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

// Ctor Parameters []
explicit RC2Engine() ;

/// @brief Method .ctor addr 0xe5c274 size 0x8 virtual false final false
 void _ctor() ;
