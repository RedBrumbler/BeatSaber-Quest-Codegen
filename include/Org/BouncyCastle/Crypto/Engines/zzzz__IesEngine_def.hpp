...
/// @brief Method .ctor addr 0xe56f80 size 0xf4 virtual false final false
...
/// @brief Method .ctor addr 0xe57074 size 0x100 virtual false final false
...
/// @brief Method Init addr 0xe57174 size 0xc8 virtual true final false
...
/// @brief Method DecryptBlock addr 0xe5723c size 0x6ac virtual false final false
 ::ArrayW<uint8_t> DecryptBlock(::ArrayW<uint8_t> in_enc, int32_t inOff, int32_t inLen, ::ArrayW<uint8_t> z) ;

/// @brief Method EncryptBlock addr 0xe57a40 size 0x5ec virtual false final false
 ::ArrayW<uint8_t> EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen, ::ArrayW<uint8_t> z) ;

/// @brief Method GenerateKdfBytes addr 0xe578e8 size 0x158 virtual false final false
 ::ArrayW<uint8_t> GenerateKdfBytes(Org::BouncyCastle::Crypto::Parameters::KdfParameters kParam, int32_t length) ;

/// @brief Method ProcessBlock addr 0xe5802c size 0x284 virtual true final false
