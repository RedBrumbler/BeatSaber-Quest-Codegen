...
/// @brief Method Init addr 0xe582b0 size 0x114 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method ReturnByte addr 0xe587ac size 0x78 virtual true final false
 uint8_t ReturnByte(uint8_t input) ;

/// @brief Method ProcessBytes addr 0xe589a0 size 0x1ec virtual true final false
 void ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t len, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method get_AlgorithmName addr 0xe58b8c size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Reset addr 0xe58bcc size 0x8 virtual true final false
 void Reset() ;

/// @brief Method setKey addr 0xe583c4 size 0x3e8 virtual false final false
 void setKey(::ArrayW<uint8_t> keyBytes) ;

/// @brief Method isaac addr 0xe58824 size 0x17c virtual false final false
 void isaac() ;

/// @brief Method mix addr 0xe58bd4 size 0xfc virtual false final false
 void mix(::ArrayW<uint32_t> x) ;

// Ctor Parameters []
explicit IsaacEngine() ;

/// @brief Method .ctor addr 0xe58d20 size 0x94 virtual false final false
 void _ctor() ;
