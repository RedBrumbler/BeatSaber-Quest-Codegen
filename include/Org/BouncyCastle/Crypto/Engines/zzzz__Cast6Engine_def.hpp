...
/// @brief Method .ctor addr 0xe49c74 size 0xd4 virtual false final false
 void _ctor() ;

/// @brief Method get_AlgorithmName addr 0xe49d48 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Reset addr 0xe49d88 size 0x4 virtual true final false
 void Reset() ;

/// @brief Method GetBlockSize addr 0xe49d8c size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method SetKey addr 0xe49d94 size 0x9b8 virtual true final false
 void SetKey(::ArrayW<uint8_t> key) ;

/// @brief Method EncryptBlock addr 0xe4a74c size 0x174 virtual true final false
 int32_t EncryptBlock(::ArrayW<uint8_t> src, int32_t srcIndex, ::ArrayW<uint8_t> dst, int32_t dstIndex) ;

/// @brief Method DecryptBlock addr 0xe4ac04 size 0x174 virtual true final false
 int32_t DecryptBlock(::ArrayW<uint8_t> src, int32_t srcIndex, ::ArrayW<uint8_t> dst, int32_t dstIndex) ;

/// @brief Method CAST_Encipher addr 0xe4a8c0 size 0x344 virtual false final false
 void CAST_Encipher(uint32_t A, uint32_t B, uint32_t C, uint32_t D, ::ArrayW<uint32_t> result) ;

/// @brief Method CAST_Decipher addr 0xe4ad78 size 0x348 virtual false final false
