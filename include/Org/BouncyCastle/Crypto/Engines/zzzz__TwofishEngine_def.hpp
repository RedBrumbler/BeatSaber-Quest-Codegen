...
/// @brief Method .ctor addr 0xe74228 size 0x2f0 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0xe74574 size 0x164 virtual true final true
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe74ee8 size 0x40 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe74f28 size 0x8 virtual true final true
 bool get_IsPartialBlockOkay() ;

/// @brief Method ProcessBlock addr 0xe74f30 size 0x138 virtual true final true
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe75558 size 0x10 virtual true final true
 void Reset() ;

/// @brief Method GetBlockSize addr 0xe75568 size 0x8 virtual true final true
 int32_t GetBlockSize() ;

/// @brief Method SetKey addr 0xe746d8 size 0x810 virtual false final false
 void SetKey(::ArrayW<uint8_t> key) ;

/// @brief Method EncryptBlock addr 0xe75068 size 0x278 virtual false final false
 void EncryptBlock(::ArrayW<uint8_t> src, int32_t srcIndex, ::ArrayW<uint8_t> dst, int32_t dstIndex) ;

/// @brief Method DecryptBlock addr 0xe752e0 size 0x278 virtual false final false
 void DecryptBlock(::ArrayW<uint8_t> src, int32_t srcIndex, ::ArrayW<uint8_t> dst, int32_t dstIndex) ;

/// @brief Method F32 addr 0xe75680 size 0x458 virtual false final false
 int32_t F32(int32_t x, ::ArrayW<int32_t> k32) ;

/// @brief Method RS_MDS_Encode addr 0xe755e0 size 0xa0 virtual false final false
 int32_t RS_MDS_Encode(int32_t k0, int32_t k1) ;

/// @brief Method RS_rem addr 0xe75c98 size 0x40 virtual false final false
 int32_t RS_rem(int32_t x) ;

/// @brief Method LFSR1 addr 0xe75cd8 size 0x14 virtual false final false
 int32_t LFSR1(int32_t x) ;

/// @brief Method LFSR2 addr 0xe75cec size 0x24 virtual false final false
 int32_t LFSR2(int32_t x) ;

/// @brief Method Mx_X addr 0xe74518 size 0x28 virtual false final false
 int32_t Mx_X(int32_t x) ;

/// @brief Method Mx_Y addr 0xe74540 size 0x34 virtual false final false
 int32_t Mx_Y(int32_t x) ;

/// @brief Method M_b0 addr 0xe75ad8 size 0x8 virtual false final false
 int32_t M_b0(int32_t x) ;

/// @brief Method M_b1 addr 0xe75ae0 size 0x8 virtual false final false
 int32_t M_b1(int32_t x) ;

/// @brief Method M_b2 addr 0xe75ae8 size 0x8 virtual false final false
 int32_t M_b2(int32_t x) ;

/// @brief Method M_b3 addr 0xe75af0 size 0x8 virtual false final false
 int32_t M_b3(int32_t x) ;

/// @brief Method Fe32_0 addr 0xe75af8 size 0x8c virtual false final false
 int32_t Fe32_0(int32_t x) ;

/// @brief Method Fe32_3 addr 0xe75b84 size 0x94 virtual false final false
 int32_t Fe32_3(int32_t x) ;

/// @brief Method BytesTo32Bits addr 0xe75570 size 0x70 virtual false final false
 int32_t BytesTo32Bits(::ArrayW<uint8_t> b, int32_t p) ;

/// @brief Method Bits32ToBytes addr 0xe75c18 size 0x80 virtual false final false
