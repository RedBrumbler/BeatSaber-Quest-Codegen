...
/// @brief Method Init addr 0xe4e714 size 0x39c virtual true final false
 void Init(bool forWrapping, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe4eab0 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Wrap addr 0xe4eaf0 size 0x338 virtual true final false
 ::ArrayW<uint8_t> Wrap(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method Unwrap addr 0xe4f050 size 0x430 virtual true final false
 ::ArrayW<uint8_t> Unwrap(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method CalculateCmsKeyChecksum addr 0xe4ee28 size 0x180 virtual false final false
 ::ArrayW<uint8_t> CalculateCmsKeyChecksum(::ArrayW<uint8_t> key) ;

/// @brief Method CheckCmsKeyChecksum addr 0xe4f480 size 0x80 virtual false final false
 bool CheckCmsKeyChecksum(::ArrayW<uint8_t> key, ::ArrayW<uint8_t> checksum) ;

/// @brief Method reverse addr 0xe4efa8 size 0xa8 virtual false final false
static ::ArrayW<uint8_t> reverse(::ArrayW<uint8_t> bs) ;

// Ctor Parameters []
explicit DesEdeWrapEngine() ;

/// @brief Method .ctor addr 0xe4f594 size 0x8c virtual false final false
 void _ctor() ;
