...
/// @brief Method Init addr 0xe5c27c size 0x2c0 virtual true final false
 void Init(bool forWrapping, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe5c53c size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Wrap addr 0xe5c57c size 0x478 virtual true final false
 ::ArrayW<uint8_t> Wrap(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method Unwrap addr 0xe5cb74 size 0x5c0 virtual true final false
 ::ArrayW<uint8_t> Unwrap(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method CalculateCmsKeyChecksum addr 0xe5c9f4 size 0x180 virtual false final false
 ::ArrayW<uint8_t> CalculateCmsKeyChecksum(::ArrayW<uint8_t> key) ;

/// @brief Method CheckCmsKeyChecksum addr 0xe5d134 size 0x80 virtual false final false
 bool CheckCmsKeyChecksum(::ArrayW<uint8_t> key, ::ArrayW<uint8_t> checksum) ;

// Ctor Parameters []
explicit RC2WrapEngine() ;

/// @brief Method .ctor addr 0xe5d248 size 0x8c virtual false final false
 void _ctor() ;
