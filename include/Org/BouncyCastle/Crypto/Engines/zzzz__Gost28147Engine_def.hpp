...
/// @brief Method AddSBox addr 0xe53b6c size 0x11c virtual false final false
static void AddSBox(::StringW sBoxName, ::ArrayW<uint8_t> sBox) ;

// Ctor Parameters []
explicit Gost28147Engine() ;

/// @brief Method .ctor addr 0xe53c88 size 0x6c virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0xe53cf4 size 0x264 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe5408c size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe540cc size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe540d4 size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method ProcessBlock addr 0xe540dc size 0x118 virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe54438 size 0x4 virtual true final false
 void Reset() ;

/// @brief Method generateWorkingKey addr 0xe53f58 size 0x134 virtual false final false
 ::ArrayW<int32_t> generateWorkingKey(bool forEncryption, ::ArrayW<uint8_t> userKey) ;

/// @brief Method Gost28147_mainStep addr 0xe544b0 size 0xe8 virtual false final false
 int32_t Gost28147_mainStep(int32_t n1, int32_t key) ;

/// @brief Method Gost28147Func addr 0xe541f4 size 0x244 virtual false final false
 void Gost28147Func(::ArrayW<int32_t> workingKey, ::ArrayW<uint8_t> inBytes, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method bytesToint addr 0xe5443c size 0x74 virtual false final false
static int32_t bytesToint(::ArrayW<uint8_t> inBytes, int32_t inOff) ;

/// @brief Method intTobytes addr 0xe54598 size 0x80 virtual false final false
static void intTobytes(int32_t num, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method GetSBox addr 0xe54618 size 0x1c0 virtual false final false
static ::ArrayW<uint8_t> GetSBox(::StringW sBoxName) ;

/// @brief Method GetSBoxName addr 0xe547d8 size 0x55c virtual false final false
