...
/// @brief Method .ctor addr 0xe76a34 size 0x80 virtual false final false
 void _ctor() ;

/// @brief Method get_AlgorithmName addr 0xe76ab4 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe76af4 size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe76afc size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method Init addr 0xe76b04 size 0x148 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method ProcessBlock addr 0xe76d54 size 0x160 virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> inBytes, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method Reset addr 0xe770b8 size 0x4 virtual true final false
 void Reset() ;

/// @brief Method setKey addr 0xe76c4c size 0x108 virtual false final false
 void setKey(::ArrayW<uint8_t> key) ;

/// @brief Method encryptBlock addr 0xe76fb4 size 0x104 virtual false final false
 int32_t encryptBlock(::ArrayW<uint8_t> inBytes, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method decryptBlock addr 0xe76eb4 size 0x100 virtual false final false
