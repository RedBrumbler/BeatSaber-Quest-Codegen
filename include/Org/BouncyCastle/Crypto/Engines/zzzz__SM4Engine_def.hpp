...
/// @brief Method tau addr 0xe6b26c size 0xc8 virtual false final false
static uint32_t tau(uint32_t A) ;

/// @brief Method L_ap addr 0xe6b334 size 0x40 virtual false final false
static uint32_t L_ap(uint32_t B) ;

/// @brief Method T_ap addr 0xe6b374 size 0x84 virtual false final false
 uint32_t T_ap(uint32_t Z) ;

/// @brief Method ExpandKey addr 0xe6b3f8 size 0x568 virtual false final false
 void ExpandKey(bool forEncryption, ::ArrayW<uint8_t> key) ;

/// @brief Method L addr 0xe6b960 size 0x78 virtual false final false
static uint32_t L(uint32_t B) ;

/// @brief Method T addr 0xe6b9d8 size 0x58 virtual false final false
static uint32_t T(uint32_t Z) ;

/// @brief Method Init addr 0xe6ba30 size 0x1c8 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe6bbf8 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe6bc38 size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe6bc40 size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method ProcessBlock addr 0xe6bc48 size 0x2b0 virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe6bef8 size 0x4 virtual true final false
 void Reset() ;

// Ctor Parameters []
explicit SM4Engine() ;

/// @brief Method .ctor addr 0xe6c024 size 0x8 virtual false final false
 void _ctor() ;
