...
/// @brief Method GetWorkingKey addr 0xe4d1a0 size 0x8 virtual true final false
 ::ArrayW<int32_t> GetWorkingKey() ;

/// @brief Method Init addr 0xe4d1a8 size 0x144 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe4d858 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe4d898 size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe4d8a0 size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method ProcessBlock addr 0xe4d8a8 size 0x13c virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe4de18 size 0x4 virtual true final false
 void Reset() ;

/// @brief Method GenerateWorkingKey addr 0xe4d2ec size 0x56c virtual false final false
static ::ArrayW<int32_t> GenerateWorkingKey(bool encrypting, ::ArrayW<uint8_t> key) ;

/// @brief Method DesFunc addr 0xe4d9e4 size 0x434 virtual false final false
static void DesFunc(::ArrayW<int32_t> wKey, ::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

// Ctor Parameters []
explicit DesEngine() ;

/// @brief Method .ctor addr 0xe4e1d4 size 0x8 virtual false final false
 void _ctor() ;
