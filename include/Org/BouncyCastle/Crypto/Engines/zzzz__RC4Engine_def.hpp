...
/// @brief Method Init addr 0xe5d2d4 size 0x108 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe5d584 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method ReturnByte addr 0xe5d5c4 size 0xd4 virtual true final false
 uint8_t ReturnByte(uint8_t input) ;

/// @brief Method ProcessBytes addr 0xe5d698 size 0x1d4 virtual true final false
 void ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t length, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe5d86c size 0x8 virtual true final false
 void Reset() ;

/// @brief Method SetKey addr 0xe5d3dc size 0x1a8 virtual false final false
 void SetKey(::ArrayW<uint8_t> keyBytes) ;

// Ctor Parameters []
explicit RC4Engine() ;

/// @brief Method .ctor addr 0xe5d8c0 size 0x8 virtual false final false
 void _ctor() ;
