...
/// @brief Method .ctor addr 0xe62e98 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe62f04 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IRsa rsa) ;

/// @brief Method get_AlgorithmName addr 0xe62f2c size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xe62f6c size 0x174 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters param) ;

/// @brief Method GetInputBlockSize addr 0xe630e0 size 0xa4 virtual true final false
 int32_t GetInputBlockSize() ;

/// @brief Method GetOutputBlockSize addr 0xe63184 size 0xa4 virtual true final false
 int32_t GetOutputBlockSize() ;

/// @brief Method ProcessBlock addr 0xe63228 size 0x154 virtual true final false
 ::ArrayW<uint8_t> ProcessBlock(::ArrayW<uint8_t> inBuf, int32_t inOff, int32_t inLen) ;

/// @brief Method BlindMessage addr 0xe6337c size 0x64 virtual false final false
 Org::BouncyCastle::Math::BigInteger BlindMessage(Org::BouncyCastle::Math::BigInteger msg) ;

/// @brief Method UnblindMessage addr 0xe633e0 size 0x5c virtual false final false
