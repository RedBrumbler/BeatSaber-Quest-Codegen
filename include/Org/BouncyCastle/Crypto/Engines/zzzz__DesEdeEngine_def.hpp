...
/// @brief Method Init addr 0xe4e1dc size 0x2a4 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe4e480 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetBlockSize addr 0xe4e4c0 size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method ProcessBlock addr 0xe4e4c8 size 0x1f0 virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe4e6b8 size 0x4 virtual true final false
 void Reset() ;

// Ctor Parameters []
explicit DesEdeEngine() ;

/// @brief Method .ctor addr 0xe4e6bc size 0x58 virtual false final false
 void _ctor() ;
