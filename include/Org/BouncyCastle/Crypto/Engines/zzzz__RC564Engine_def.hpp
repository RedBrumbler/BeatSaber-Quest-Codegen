...
/// @brief Method .ctor addr 0xe5e154 size 0x20 virtual false final false
 void _ctor() ;

/// @brief Method get_AlgorithmName addr 0xe5e174 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe5e1b4 size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe5e1bc size 0x5c virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method Init addr 0xe5e218 size 0x1a0 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method ProcessBlock addr 0xe5e688 size 0x10 virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe5e9e8 size 0x4 virtual true final false
 void Reset() ;

/// @brief Method SetKey addr 0xe5e3b8 size 0x2d0 virtual false final false
 void SetKey(::ArrayW<uint8_t> key) ;

/// @brief Method EncryptBlock addr 0xe5e83c size 0x1ac virtual false final false
 int32_t EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method DecryptBlock addr 0xe5e698 size 0x1a4 virtual false final false
 int32_t DecryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method RotateLeft addr 0xe5e9ec size 0x80 virtual false final false
 int64_t RotateLeft(int64_t x, int64_t y) ;

/// @brief Method RotateRight addr 0xe5ebdc size 0x80 virtual false final false
 int64_t RotateRight(int64_t x, int64_t y) ;

/// @brief Method BytesToWord addr 0xe5ea6c size 0xb0 virtual false final false
 int64_t BytesToWord(::ArrayW<uint8_t> src, int32_t srcOff) ;

/// @brief Method WordToBytes addr 0xe5eb1c size 0xc0 virtual false final false
