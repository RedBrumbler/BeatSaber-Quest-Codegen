...
/// @brief Method Step addr 0xe557b4 size 0x274 virtual false final false
 uint32_t Step() ;

/// @brief Method Init addr 0xe55a30 size 0x384 virtual false final false
 void Init() ;

/// @brief Method get_AlgorithmName addr 0xe55db4 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xe55df4 size 0x1d4 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetByte addr 0xe55fc8 size 0x60 virtual false final false
 uint8_t GetByte() ;

/// @brief Method ProcessBytes addr 0xe56028 size 0x19c virtual true final false
 void ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t len, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe561c4 size 0x4 virtual true final false
 void Reset() ;

/// @brief Method ReturnByte addr 0xe561c8 size 0x18 virtual true final false
 uint8_t ReturnByte(uint8_t input) ;

/// @brief Method RotateRight addr 0xe55a28 size 0x8 virtual false final false
static uint32_t RotateRight(uint32_t x, int32_t bits) ;

// Ctor Parameters []
explicit HC256Engine() ;

/// @brief Method .ctor addr 0xe561e0 size 0x9c virtual false final false
 void _ctor() ;
