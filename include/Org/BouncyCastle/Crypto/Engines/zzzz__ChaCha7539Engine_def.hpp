...
/// @brief Method .ctor addr 0xe4c5ec size 0x54 virtual false final false
 void _ctor() ;

/// @brief Method get_AlgorithmName addr 0xe4c640 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_NonceSize addr 0xe4c680 size 0x8 virtual true final false
 int32_t get_NonceSize() ;

/// @brief Method AdvanceCounter addr 0xe4c688 size 0x84 virtual true final false
 void AdvanceCounter() ;

/// @brief Method ResetCounter addr 0xe4c70c size 0x2c virtual true final false
 void ResetCounter() ;

/// @brief Method SetKey addr 0xe4c738 size 0xe8 virtual true final false
 void SetKey(::ArrayW<uint8_t> keyBytes, ::ArrayW<uint8_t> ivBytes) ;

/// @brief Method GenerateKeyStream addr 0xe4c820 size 0x3c virtual true final false
