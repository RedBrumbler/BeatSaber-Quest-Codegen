...
/// @brief Method Mul0x2 addr 0xe6046c size 0xa8 virtual false final false
 uint8_t Mul0x2(int32_t b) ;

/// @brief Method Mul0x3 addr 0xe60514 size 0xa8 virtual false final false
 uint8_t Mul0x3(int32_t b) ;

/// @brief Method Mul0x9 addr 0xe605bc size 0x8c virtual false final false
 uint8_t Mul0x9(int32_t b) ;

/// @brief Method Mul0xb addr 0xe60648 size 0x8c virtual false final false
 uint8_t Mul0xb(int32_t b) ;

/// @brief Method Mul0xd addr 0xe606d4 size 0x8c virtual false final false
 uint8_t Mul0xd(int32_t b) ;

/// @brief Method Mul0xe addr 0xe60760 size 0x8c virtual false final false
 uint8_t Mul0xe(int32_t b) ;

/// @brief Method KeyAddition addr 0xe607ec size 0x78 virtual false final false
 void KeyAddition(::ArrayW<int64_t> rk) ;

/// @brief Method Shift addr 0xe60864 size 0x2c virtual false final false
 int64_t Shift(int64_t r, int32_t shift) ;

/// @brief Method ShiftRow addr 0xe60890 size 0xc0 virtual false final false
 void ShiftRow(::ArrayW<uint8_t> shiftsSC) ;

/// @brief Method ApplyS addr 0xe60950 size 0x68 virtual false final false
 int64_t ApplyS(int64_t r, ::ArrayW<uint8_t> box) ;

/// @brief Method Substitution addr 0xe609b8 size 0x6c virtual false final false
 void Substitution(::ArrayW<uint8_t> box) ;

/// @brief Method MixColumn addr 0xe60a24 size 0x184 virtual false final false
 void MixColumn() ;

/// @brief Method InvMixColumn addr 0xe60ba8 size 0x318 virtual false final false
 void InvMixColumn() ;

/// @brief Method GenerateWorkingKey addr 0xe60ec0 size 0x7a0 virtual false final false
 ::ArrayW<::ArrayW<int64_t>> GenerateWorkingKey(::ArrayW<uint8_t> key) ;

// Ctor Parameters []
explicit RijndaelEngine() ;

/// @brief Method .ctor addr 0xe61660 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "blockBits", ty: "int32_t", modifiers: "", def_value: None }]
explicit RijndaelEngine(int32_t blockBits) ;

/// @brief Method .ctor addr 0xe61668 size 0x2b4 virtual false final false
 void _ctor(int32_t blockBits) ;

/// @brief Method Init addr 0xe6191c size 0x198 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe61ab4 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe61af4 size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe61afc size 0x14 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method ProcessBlock addr 0xe61b10 size 0x15c virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe62070 size 0x4 virtual true final false
 void Reset() ;

/// @brief Method UnPackBlock addr 0xe61c6c size 0x11c virtual false final false
 void UnPackBlock(::ArrayW<uint8_t> bytes, int32_t off) ;

/// @brief Method PackBlock addr 0xe61fb0 size 0xc0 virtual false final false
 void PackBlock(::ArrayW<uint8_t> bytes, int32_t off) ;

/// @brief Method EncryptBlock addr 0xe61d88 size 0xfc virtual false final false
 void EncryptBlock(::ArrayW<::ArrayW<int64_t>> rk) ;

/// @brief Method DecryptBlock addr 0xe61e84 size 0x12c virtual false final false
