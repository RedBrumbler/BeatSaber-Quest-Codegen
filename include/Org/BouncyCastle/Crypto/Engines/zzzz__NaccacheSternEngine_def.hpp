...
/// @brief Method get_AlgorithmName addr 0xe58db4 size 0x40 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xe58df4 size 0x58c virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method set_Debug addr 0xe59380 size 0x4 virtual true final false
 void set_Debug(bool value) ;

/// @brief Method GetInputBlockSize addr 0xe59384 size 0x54 virtual true final false
 int32_t GetInputBlockSize() ;

/// @brief Method GetOutputBlockSize addr 0xe593d8 size 0x54 virtual true final false
 int32_t GetOutputBlockSize() ;

/// @brief Method ProcessBlock addr 0xe5942c size 0x8fc virtual true final false
 ::ArrayW<uint8_t> ProcessBlock(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t length) ;

/// @brief Method Encrypt addr 0xe5a10c size 0xd8 virtual true final false
 ::ArrayW<uint8_t> Encrypt(Org::BouncyCastle::Math::BigInteger plain) ;

/// @brief Method AddCryptedBlocks addr 0xe5a1e4 size 0x204 virtual true final false
 ::ArrayW<uint8_t> AddCryptedBlocks(::ArrayW<uint8_t> block1, ::ArrayW<uint8_t> block2) ;

/// @brief Method ProcessData addr 0xe5a3e8 size 0x218 virtual true final false
 ::ArrayW<uint8_t> ProcessData(::ArrayW<uint8_t> data) ;

/// @brief Method chineseRemainder addr 0xe59d28 size 0x3e4 virtual false final false
...
/// @brief Method .ctor addr 0xe5a600 size 0xc virtual false final false
 void _ctor() ;
