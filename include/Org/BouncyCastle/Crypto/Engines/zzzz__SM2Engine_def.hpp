...
/// @brief Method .ctor addr 0xe69ff8 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe6a064 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method Init addr 0xe6a08c size 0x29c virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters param) ;

/// @brief Method ProcessBlock addr 0xe6a328 size 0x10 virtual true final false
 ::ArrayW<uint8_t> ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen) ;

/// @brief Method CreateBasePointMultiplier addr 0xe6aba8 size 0x5c virtual true final false
 Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier CreateBasePointMultiplier() ;

/// @brief Method Encrypt addr 0xe6a338 size 0x3f8 virtual false final false
 ::ArrayW<uint8_t> Encrypt(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen) ;

/// @brief Method Decrypt addr 0xe6a730 size 0x478 virtual false final false
 ::ArrayW<uint8_t> Decrypt(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen) ;

/// @brief Method NotEncrypted addr 0xe6b0cc size 0x68 virtual false final false
 bool NotEncrypted(::ArrayW<uint8_t> encData, ::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method Kdf addr 0xe6acd4 size 0x3f8 virtual false final false
 void Kdf(Org::BouncyCastle::Crypto::IDigest digest, Org::BouncyCastle::Math::EC::ECPoint c1, ::ArrayW<uint8_t> encData) ;

/// @brief Method Xor addr 0xe6b208 size 0x64 virtual false final false
 void Xor(::ArrayW<uint8_t> data, ::ArrayW<uint8_t> kdfOut, int32_t dOff, int32_t dRemaining) ;

/// @brief Method NextK addr 0xe6ac04 size 0xd0 virtual false final false
 Org::BouncyCastle::Math::BigInteger NextK() ;

/// @brief Method AddFieldElement addr 0xe6b134 size 0xd4 virtual false final false
