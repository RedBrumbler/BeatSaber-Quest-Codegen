...
/// @brief Method .ctor addr 0xe51cd8 size 0x90 virtual false final false
 void _ctor(int32_t blockSizeBits) ;

/// @brief Method get_AlgorithmName addr 0xe51d68 size 0x40 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xe51da8 size 0x11c virtual true final true
 void Init(bool forWrapping, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method Wrap addr 0xe51ec4 size 0x7b4 virtual true final true
 ::ArrayW<uint8_t> Wrap(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method Unwrap addr 0xe52678 size 0x890 virtual true final true
