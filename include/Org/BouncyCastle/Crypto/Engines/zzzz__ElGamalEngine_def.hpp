...
/// @brief Method get_AlgorithmName addr 0xe52f08 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xe52f48 size 0x2b4 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetInputBlockSize addr 0xe531fc size 0x40 virtual true final false
 int32_t GetInputBlockSize() ;

/// @brief Method GetOutputBlockSize addr 0xe5323c size 0x40 virtual true final false
 int32_t GetOutputBlockSize() ;

/// @brief Method ProcessBlock addr 0xe5327c size 0x52c virtual true final false
 ::ArrayW<uint8_t> ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

// Ctor Parameters []
explicit ElGamalEngine() ;

/// @brief Method .ctor addr 0xe537a8 size 0x8 virtual false final false
 void _ctor() ;
