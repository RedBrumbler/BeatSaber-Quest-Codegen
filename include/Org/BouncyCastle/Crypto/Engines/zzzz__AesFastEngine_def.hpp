...
/// @brief Method Shift addr 0xe3b28c size 0x8 virtual false final false
static uint32_t Shift(uint32_t r, int32_t shift) ;

/// @brief Method FFmulX addr 0xe3b294 size 0x20 virtual false final false
static uint32_t FFmulX(uint32_t x) ;

/// @brief Method FFmulX2 addr 0xe3b2b4 size 0x1c virtual false final false
static uint32_t FFmulX2(uint32_t x) ;

/// @brief Method Inv_Mcol addr 0xe3b2d0 size 0x98 virtual false final false
static uint32_t Inv_Mcol(uint32_t x) ;

/// @brief Method SubWord addr 0xe3b368 size 0xc4 virtual false final false
static uint32_t SubWord(uint32_t x) ;

/// @brief Method GenerateWorkingKey addr 0xe3b42c size 0xb18 virtual false final false
 ::ArrayW<::ArrayW<uint32_t>> GenerateWorkingKey(::ArrayW<uint8_t> key, bool forEncryption) ;

// Ctor Parameters []
explicit AesFastEngine() ;

/// @brief Method .ctor addr 0xe3bf44 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0xe3bf4c size 0x124 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe3c070 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe3c0b0 size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe3c0b8 size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method ProcessBlock addr 0xe3c0c0 size 0x138 virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe3d25c size 0x4 virtual true final false
 void Reset() ;

/// @brief Method UnPackBlock addr 0xe3c1f8 size 0x70 virtual false final false
 void UnPackBlock(::ArrayW<uint8_t> bytes, int32_t off) ;

/// @brief Method PackBlock addr 0xe3d1f8 size 0x64 virtual false final false
 void PackBlock(::ArrayW<uint8_t> bytes, int32_t off) ;

/// @brief Method EncryptBlock addr 0xe3c268 size 0x6d0 virtual false final false
 void EncryptBlock(::ArrayW<::ArrayW<uint32_t>> KW) ;

/// @brief Method DecryptBlock addr 0xe3c938 size 0x8c0 virtual false final false
