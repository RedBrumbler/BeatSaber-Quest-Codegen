...
/// @brief Method .ctor addr 0xe5d8c8 size 0x20 virtual false final false
 void _ctor() ;

/// @brief Method get_AlgorithmName addr 0xe5d8e8 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe5d928 size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe5d930 size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method Init addr 0xe5d938 size 0x234 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method ProcessBlock addr 0xe5ddbc size 0x24 virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe5dffc size 0x4 virtual true final false
 void Reset() ;

/// @brief Method SetKey addr 0xe5db6c size 0x250 virtual false final false
 void SetKey(::ArrayW<uint8_t> key) ;

/// @brief Method EncryptBlock addr 0xe5deec size 0x110 virtual false final false
 int32_t EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method DecryptBlock addr 0xe5dde0 size 0x10c virtual false final false
 int32_t DecryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method RotateLeft addr 0xe5e000 size 0xc virtual false final false
 int32_t RotateLeft(int32_t x, int32_t y) ;

/// @brief Method RotateRight addr 0xe5e0fc size 0x8 virtual false final false
 int32_t RotateRight(int32_t x, int32_t y) ;

/// @brief Method BytesToWord addr 0xe5e00c size 0x70 virtual false final false
 int32_t BytesToWord(::ArrayW<uint8_t> src, int32_t srcOff) ;

/// @brief Method WordToBytes addr 0xe5e07c size 0x80 virtual false final false
