...
/// @brief Method get_AlgorithmName addr 0xe76730 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_NonceSize addr 0xe76770 size 0x8 virtual true final false
 int32_t get_NonceSize() ;

/// @brief Method SetKey addr 0xe76778 size 0x264 virtual true final false
 void SetKey(::ArrayW<uint8_t> keyBytes, ::ArrayW<uint8_t> ivBytes) ;

// Ctor Parameters []
explicit XSalsa20Engine() ;

/// @brief Method .ctor addr 0xe769dc size 0x58 virtual false final false
 void _ctor() ;
