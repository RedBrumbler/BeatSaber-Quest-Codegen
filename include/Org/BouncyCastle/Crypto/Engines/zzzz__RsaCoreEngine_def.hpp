...
/// @brief Method CheckInitialised addr 0xe6343c size 0x60 virtual false final false
 void CheckInitialised() ;

/// @brief Method Init addr 0xe6349c size 0x160 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetInputBlockSize addr 0xe635fc size 0x3c virtual true final false
 int32_t GetInputBlockSize() ;

/// @brief Method GetOutputBlockSize addr 0xe63638 size 0x3c virtual true final false
 int32_t GetOutputBlockSize() ;

/// @brief Method ConvertInput addr 0xe63674 size 0x110 virtual true final false
 Org::BouncyCastle::Math::BigInteger ConvertInput(::ArrayW<uint8_t> inBuf, int32_t inOff, int32_t inLen) ;

/// @brief Method ConvertOutput addr 0xe63784 size 0xc4 virtual true final false
 ::ArrayW<uint8_t> ConvertOutput(Org::BouncyCastle::Math::BigInteger result) ;

/// @brief Method ProcessBlock addr 0xe63848 size 0x168 virtual true final false
 Org::BouncyCastle::Math::BigInteger ProcessBlock(Org::BouncyCastle::Math::BigInteger input) ;

// Ctor Parameters []
explicit RsaCoreEngine() ;

/// @brief Method .ctor addr 0xe62668 size 0x8 virtual false final false
 void _ctor() ;
