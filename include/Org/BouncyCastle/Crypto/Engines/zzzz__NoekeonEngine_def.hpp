...
/// @brief Method .ctor addr 0xe5a60c size 0x60 virtual false final false
 void _ctor() ;

/// @brief Method get_AlgorithmName addr 0xe5a66c size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe5a6ac size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe5a6b4 size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method Init addr 0xe5a6bc size 0x268 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method ProcessBlock addr 0xe5a924 size 0x160 virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe5b074 size 0x4 virtual true final false
 void Reset() ;

/// @brief Method EncryptBlock addr 0xe5ad9c size 0x2d8 virtual false final false
 int32_t EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method DecryptBlock addr 0xe5aa84 size 0x318 virtual false final false
