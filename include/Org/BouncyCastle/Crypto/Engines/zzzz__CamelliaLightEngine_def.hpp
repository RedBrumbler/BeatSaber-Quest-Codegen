...
/// @brief Method rightRotate addr 0xe43548 size 0x14 virtual false final false
static uint32_t rightRotate(uint32_t x, int32_t s) ;

/// @brief Method leftRotate addr 0xe4355c size 0x14 virtual false final false
static uint32_t leftRotate(uint32_t x, int32_t s) ;

/// @brief Method roldq addr 0xe43570 size 0x128 virtual false final false
static void roldq(int32_t rot, ::ArrayW<uint32_t> ki, int32_t ioff, ::ArrayW<uint32_t> ko, int32_t ooff) ;

/// @brief Method decroldq addr 0xe43698 size 0x128 virtual false final false
static void decroldq(int32_t rot, ::ArrayW<uint32_t> ki, int32_t ioff, ::ArrayW<uint32_t> ko, int32_t ooff) ;

/// @brief Method roldqo32 addr 0xe437c0 size 0x128 virtual false final false
static void roldqo32(int32_t rot, ::ArrayW<uint32_t> ki, int32_t ioff, ::ArrayW<uint32_t> ko, int32_t ooff) ;

/// @brief Method decroldqo32 addr 0xe438e8 size 0x128 virtual false final false
static void decroldqo32(int32_t rot, ::ArrayW<uint32_t> ki, int32_t ioff, ::ArrayW<uint32_t> ko, int32_t ooff) ;

/// @brief Method bytes2uint addr 0xe43a10 size 0x60 virtual false final false
static uint32_t bytes2uint(::ArrayW<uint8_t> src, int32_t offset) ;

/// @brief Method uint2bytes addr 0xe43a70 size 0x48 virtual false final false
static void uint2bytes(uint32_t word, ::ArrayW<uint8_t> dst, int32_t offset) ;

/// @brief Method lRot8 addr 0xe43ab8 size 0x1c virtual false final false
 uint8_t lRot8(uint8_t v, int32_t rot) ;

/// @brief Method sbox2 addr 0xe43ad4 size 0x88 virtual false final false
 uint32_t sbox2(int32_t x) ;

/// @brief Method sbox3 addr 0xe43b5c size 0x88 virtual false final false
 uint32_t sbox3(int32_t x) ;

/// @brief Method sbox4 addr 0xe43be4 size 0x88 virtual false final false
 uint32_t sbox4(int32_t x) ;

/// @brief Method camelliaF2 addr 0xe43c6c size 0x2e8 virtual false final false
 void camelliaF2(::ArrayW<uint32_t> s, ::ArrayW<uint32_t> skey, int32_t keyoff) ;

/// @brief Method camelliaFLs addr 0xe43f54 size 0x134 virtual false final false
 void camelliaFLs(::ArrayW<uint32_t> s, ::ArrayW<uint32_t> fkey, int32_t keyoff) ;

/// @brief Method setKey addr 0xe44088 size 0xf0c virtual false final false
 void setKey(bool forEncryption, ::ArrayW<uint8_t> key) ;

/// @brief Method processBlock128 addr 0xe44f94 size 0x2b0 virtual false final false
 int32_t processBlock128(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method processBlock192or256 addr 0xe45244 size 0x2ec virtual false final false
 int32_t processBlock192or256(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

// Ctor Parameters []
explicit CamelliaLightEngine() ;

/// @brief Method .ctor addr 0xe45530 size 0x90 virtual false final false
 void _ctor() ;

/// @brief Method get_AlgorithmName addr 0xe455c0 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe45600 size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe45608 size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method Init addr 0xe45610 size 0xf0 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method ProcessBlock addr 0xe45700 size 0x138 virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe45838 size 0x4 virtual true final false
 void Reset() ;
