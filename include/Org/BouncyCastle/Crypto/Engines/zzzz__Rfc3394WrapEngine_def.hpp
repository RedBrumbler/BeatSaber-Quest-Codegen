...
/// @brief Method .ctor addr 0xe3f910 size 0x90 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher engine) ;

/// @brief Method Init addr 0xe3f9a0 size 0x214 virtual true final false
 void Init(bool forWrapping, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe3fbb4 size 0xa0 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Wrap addr 0xe3fc54 size 0x3a0 virtual true final false
 ::ArrayW<uint8_t> Wrap(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen) ;

/// @brief Method Unwrap addr 0xe3fff4 size 0x438 virtual true final false
