...
/// @brief Method .ctor addr 0xe64750 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0xe64758 size 0x184 virtual true final false
 void Init(bool encrypting, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe648dc size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe6491c size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe64924 size 0x58 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method ProcessBlock addr 0xe6497c size 0x1b0 virtual true final true
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe64b2c size 0x4 virtual true final false
 void Reset() ;

/// @brief Method RotateLeft addr 0xe64b30 size 0xc virtual false final false
static int32_t RotateLeft(int32_t x, int32_t bits) ;

/// @brief Method RotateRight addr 0xe64b3c size 0x8 virtual false final false
static int32_t RotateRight(int32_t x, int32_t bits) ;

/// @brief Method Sb0 addr 0xe64b44 size 0x40 virtual false final false
 void Sb0(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method Ib0 addr 0xe64b84 size 0x44 virtual false final false
 void Ib0(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method Sb1 addr 0xe64bc8 size 0x40 virtual false final false
 void Sb1(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method Ib1 addr 0xe64c08 size 0x40 virtual false final false
 void Ib1(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method Sb2 addr 0xe64c48 size 0x48 virtual false final false
 void Sb2(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method Ib2 addr 0xe64c90 size 0x44 virtual false final false
 void Ib2(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method Sb3 addr 0xe64cd4 size 0x4c virtual false final false
 void Sb3(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method Ib3 addr 0xe64d20 size 0x48 virtual false final false
 void Ib3(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method Sb4 addr 0xe64d68 size 0x44 virtual false final false
 void Sb4(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method Ib4 addr 0xe64dac size 0x44 virtual false final false
 void Ib4(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method Sb5 addr 0xe64df0 size 0x48 virtual false final false
 void Sb5(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method Ib5 addr 0xe64e38 size 0x48 virtual false final false
 void Ib5(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method Sb6 addr 0xe64e80 size 0x40 virtual false final false
 void Sb6(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method Ib6 addr 0xe64ec0 size 0x44 virtual false final false
 void Ib6(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method Sb7 addr 0xe64f04 size 0x48 virtual false final false
 void Sb7(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method Ib7 addr 0xe64f4c size 0x4c virtual false final false
 void Ib7(int32_t a, int32_t b, int32_t c, int32_t d) ;

/// @brief Method LT addr 0xe64f98 size 0x9c virtual false final false
 void LT() ;

/// @brief Method InverseLT addr 0xe65034 size 0x8c virtual false final false
 void InverseLT() ;
