...
/// @brief Method PackTauOrSigma addr 0xe4b0c0 size 0x134 virtual false final false
 void PackTauOrSigma(int32_t keyLength, ::ArrayW<uint32_t> state, int32_t stateOffset) ;

// Ctor Parameters []
explicit Salsa20Engine() ;

/// @brief Method .ctor addr 0xe4b1f4 size 0x60 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "rounds", ty: "int32_t", modifiers: "", def_value: None }]
explicit Salsa20Engine(int32_t rounds) ;

/// @brief Method .ctor addr 0xe4b254 size 0x100 virtual false final false
 void _ctor(int32_t rounds) ;

/// @brief Method Init addr 0xe4b354 size 0x3bc virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_NonceSize addr 0xe4b710 size 0x8 virtual true final false
 int32_t get_NonceSize() ;

/// @brief Method get_AlgorithmName addr 0xe4b718 size 0xe0 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method ReturnByte addr 0xe4b7f8 size 0x104 virtual true final false
 uint8_t ReturnByte(uint8_t input) ;

/// @brief Method AdvanceCounter addr 0xe4b938 size 0x4c virtual true final false
 void AdvanceCounter() ;

/// @brief Method ProcessBytes addr 0xe4b984 size 0x274 virtual true final false
 void ProcessBytes(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method Reset addr 0xe4bc34 size 0x1c virtual true final false
 void Reset() ;

/// @brief Method ResetCounter addr 0xe4bc5c size 0x2c virtual true final false
 void ResetCounter() ;

/// @brief Method SetKey addr 0xe4bc88 size 0x204 virtual true final false
 void SetKey(::ArrayW<uint8_t> keyBytes, ::ArrayW<uint8_t> ivBytes) ;

/// @brief Method GenerateKeyStream addr 0xe4be8c size 0x84 virtual true final false
 void GenerateKeyStream(::ArrayW<uint8_t> output) ;

/// @brief Method SalsaCore addr 0xe4bf10 size 0x5f4 virtual false final false
static void SalsaCore(int32_t rounds, ::ArrayW<uint32_t> input, ::ArrayW<uint32_t> x) ;

/// @brief Method ResetLimitCounter addr 0xe4bc50 size 0xc virtual false final false
 void ResetLimitCounter() ;

/// @brief Method LimitExceeded addr 0xe4b8fc size 0x3c virtual false final false
 bool LimitExceeded() ;

/// @brief Method LimitExceeded addr 0xe4bbf8 size 0x3c virtual false final false
