...
/// @brief Method .ctor addr 0xe4598c size 0xb8 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0xe45a44 size 0x180 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe45bc4 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe45c04 size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method ProcessBlock addr 0xe45c0c size 0x16c virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe45d78 size 0x4 virtual true final false
 void Reset() ;

/// @brief Method GetBlockSize addr 0xe45d7c size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method SetKey addr 0xe45d84 size 0x3234 virtual true final false
 void SetKey(::ArrayW<uint8_t> key) ;

/// @brief Method EncryptBlock addr 0xe490a8 size 0xfc virtual true final false
 int32_t EncryptBlock(::ArrayW<uint8_t> src, int32_t srcIndex, ::ArrayW<uint8_t> dst, int32_t dstIndex) ;

/// @brief Method DecryptBlock addr 0xe493c0 size 0xfc virtual true final false
 int32_t DecryptBlock(::ArrayW<uint8_t> src, int32_t srcIndex, ::ArrayW<uint8_t> dst, int32_t dstIndex) ;

/// @brief Method F1 addr 0xe49700 size 0x108 virtual false final false
static uint32_t F1(uint32_t D, uint32_t Kmi, int32_t Kri) ;

/// @brief Method F2 addr 0xe49808 size 0x108 virtual false final false
static uint32_t F2(uint32_t D, uint32_t Kmi, int32_t Kri) ;

/// @brief Method F3 addr 0xe49910 size 0x108 virtual false final false
static uint32_t F3(uint32_t D, uint32_t Kmi, int32_t Kri) ;

/// @brief Method CAST_Encipher addr 0xe491a4 size 0x21c virtual false final false
 void CAST_Encipher(uint32_t L0, uint32_t R0, ::ArrayW<uint32_t> result) ;

/// @brief Method CAST_Decipher addr 0xe494bc size 0x244 virtual false final false
 void CAST_Decipher(uint32_t L16, uint32_t R16, ::ArrayW<uint32_t> result) ;

/// @brief Method Bits32ToInts addr 0xe49030 size 0x78 virtual false final false
static void Bits32ToInts(uint32_t inData, ::ArrayW<int32_t> b, int32_t offset) ;

/// @brief Method IntsTo32bits addr 0xe48fb8 size 0x78 virtual false final false
