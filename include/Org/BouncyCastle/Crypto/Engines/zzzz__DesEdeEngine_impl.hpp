...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Crypto::Engines::DesEdeEngine::*)(bool, Org::BouncyCastle::Crypto::ICipherParameters)>(&Org::BouncyCastle::Crypto::Engines::DesEdeEngine::Init)> {
  ...
  constexpr static std::size_t addrs = 0xe4e1dc;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(Org::BouncyCastle::Crypto::Engines::DesEdeEngine),
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (Org::BouncyCastle::Crypto::Engines::DesEdeEngine::*)()>(&Org::BouncyCastle::Crypto::Engines::DesEdeEngine::GetBlockSize)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0xe4e4c0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (Org::BouncyCastle::Crypto::Engines::DesEdeEngine::*)(::ArrayW<uint8_t>, int32_t, ::ArrayW<uint8_t>, int32_t)>(&Org::BouncyCastle::Crypto::Engines::DesEdeEngine::ProcessBlock)> {
  constexpr static std::size_t size = 0x1f0;
  constexpr static std::size_t addrs = 0xe4e4c8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Crypto::Engines::DesEdeEngine::*)()>(&Org::BouncyCastle::Crypto::Engines::DesEdeEngine::Reset)> {
  ...
  constexpr static std::size_t addrs = 0xe4e6b8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Crypto::Engines::DesEdeEngine::*)()>(&Org::BouncyCastle::Crypto::Engines::DesEdeEngine::_ctor)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0xe4e6bc;
...
constexpr void Org::BouncyCastle::Crypto::Engines::DesEdeEngine::__set_workingKey1(::ArrayW<int32_t> value)  {
...
constexpr ::ArrayW<int32_t> Org::BouncyCastle::Crypto::Engines::DesEdeEngine::__get_workingKey1() const {
return ::cordl_internals::getInstanceField<::ArrayW<int32_t>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void Org::BouncyCastle::Crypto::Engines::DesEdeEngine::__set_workingKey2(::ArrayW<int32_t> value)  {
...
constexpr ::ArrayW<int32_t> Org::BouncyCastle::Crypto::Engines::DesEdeEngine::__get_workingKey2() const {
return ::cordl_internals::getInstanceField<::ArrayW<int32_t>, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void Org::BouncyCastle::Crypto::Engines::DesEdeEngine::__set_workingKey3(::ArrayW<int32_t> value)  {
...
constexpr ::ArrayW<int32_t> Org::BouncyCastle::Crypto::Engines::DesEdeEngine::__get_workingKey3() const {
...
constexpr bool Org::BouncyCastle::Crypto::Engines::DesEdeEngine::__get_forEncryption() const {
...
return ::cordl_internals::RunMethodRethrow<::StringW, false>(const_cast<void*>(instance), ___internal_method);
 ...
 int32_t Org::BouncyCastle::Crypto::Engines::DesEdeEngine::GetBlockSize()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Engines::DesEdeEngine>::get(),
                            "GetBlockSize",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<int32_t, false>(const_cast<void*>(instance), ___internal_method);
 ...
 int32_t Org::BouncyCastle::Crypto::Engines::DesEdeEngine::ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Engines::DesEdeEngine>::get(),
                            "ProcessBlock",
                            std::vector<Il2CppClass*>{},
...
// Ctor Parameters []
 Org::BouncyCastle::Crypto::Engines::DesEdeEngine::DesEdeEngine()  : Org::BouncyCastle::Crypto::Engines::DesEngine(THROW_UNLESS(::il2cpp_utils::New<DesEdeEngine>())) {}
 void Org::BouncyCastle::Crypto::Engines::DesEdeEngine::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Engines::DesEdeEngine>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
