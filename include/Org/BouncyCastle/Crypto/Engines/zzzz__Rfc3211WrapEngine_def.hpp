...
/// @brief Method .ctor addr 0xe5fb2c size 0x7c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher engine) ;

/// @brief Method Init addr 0xe5fba8 size 0x1b8 virtual true final false
 void Init(bool forWrapping, Org::BouncyCastle::Crypto::ICipherParameters param) ;

/// @brief Method get_AlgorithmName addr 0xe5fd60 size 0xc8 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Wrap addr 0xe5fe28 size 0x284 virtual true final false
 ::ArrayW<uint8_t> Wrap(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t inLen) ;

/// @brief Method Unwrap addr 0xe600ac size 0x3c0 virtual true final false
