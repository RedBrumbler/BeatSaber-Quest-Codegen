...
/// @brief Method .ctor addr 0xe4cea4 size 0x54 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "rounds", ty: "int32_t", modifiers: "", def_value: None }]
explicit ChaChaEngine(int32_t rounds) ;

/// @brief Method .ctor addr 0xe4cef8 size 0x64 virtual false final false
 void _ctor(int32_t rounds) ;

/// @brief Method get_AlgorithmName addr 0xe4cf5c size 0x84 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method AdvanceCounter addr 0xe4cfe0 size 0x4c virtual true final false
 void AdvanceCounter() ;

/// @brief Method ResetCounter addr 0xe4d02c size 0x2c virtual true final false
 void ResetCounter() ;

/// @brief Method SetKey addr 0xe4d058 size 0x10c virtual true final false
 void SetKey(::ArrayW<uint8_t> keyBytes, ::ArrayW<uint8_t> ivBytes) ;

/// @brief Method GenerateKeyStream addr 0xe4d164 size 0x3c virtual true final false
 void GenerateKeyStream(::ArrayW<uint8_t> output) ;

/// @brief Method ChachaCore addr 0xe4c85c size 0x648 virtual false final false
