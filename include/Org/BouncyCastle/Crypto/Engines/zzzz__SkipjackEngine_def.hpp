...
/// @brief Method Init addr 0xe6936c size 0x304 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe69670 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe696b0 size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xe696b8 size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method ProcessBlock addr 0xe696c0 size 0x134 virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe697f4 size 0x4 virtual true final false
 void Reset() ;

/// @brief Method G addr 0xe697f8 size 0x15c virtual false final false
 int32_t G(int32_t k, int32_t w) ;

/// @brief Method EncryptBlock addr 0xe69954 size 0x24c virtual true final false
 int32_t EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method H addr 0xe69ba0 size 0x15c virtual false final false
 int32_t H(int32_t k, int32_t w) ;

/// @brief Method DecryptBlock addr 0xe69cfc size 0x260 virtual true final false
 int32_t DecryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

// Ctor Parameters []
explicit SkipjackEngine() ;

/// @brief Method .ctor addr 0xe69ff0 size 0x8 virtual false final false
 void _ctor() ;
