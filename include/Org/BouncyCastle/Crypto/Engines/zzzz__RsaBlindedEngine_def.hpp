...
/// @brief Method .ctor addr 0xe625fc size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe62670 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IRsa rsa) ;

/// @brief Method get_AlgorithmName addr 0xe62698 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xe626d8 size 0x25c virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters param) ;

/// @brief Method GetInputBlockSize addr 0xe62934 size 0xa4 virtual true final false
 int32_t GetInputBlockSize() ;

/// @brief Method GetOutputBlockSize addr 0xe629d8 size 0xa4 virtual true final false
 int32_t GetOutputBlockSize() ;

/// @brief Method ProcessBlock addr 0xe62a7c size 0x41c virtual true final false
