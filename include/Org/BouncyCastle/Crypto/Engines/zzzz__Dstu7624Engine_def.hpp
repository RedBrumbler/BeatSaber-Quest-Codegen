...
/// @brief Method .ctor addr 0xe4f620 size 0xc8 virtual false final false
 void _ctor(int32_t blockSizeBits) ;

/// @brief Method Init addr 0xe4f6e8 size 0x324 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method WorkingKeyExpandKT addr 0xe4fa0c size 0x270 virtual false final false
 void WorkingKeyExpandKT(::ArrayW<uint64_t> workingKey, ::ArrayW<uint64_t> tempKeys) ;

/// @brief Method WorkingKeyExpandEven addr 0xe4fc7c size 0x494 virtual false final false
 void WorkingKeyExpandEven(::ArrayW<uint64_t> workingKey, ::ArrayW<uint64_t> tempKey) ;

/// @brief Method WorkingKeyExpandOdd addr 0xe50110 size 0x74 virtual false final false
 void WorkingKeyExpandOdd() ;

/// @brief Method ProcessBlock addr 0xe503b0 size 0x24c virtual true final false
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method EncryptionRound addr 0xe50184 size 0x20 virtual false final false
 void EncryptionRound() ;

/// @brief Method DecryptionRound addr 0xe50e20 size 0x20 virtual false final false
 void DecryptionRound() ;

/// @brief Method DecryptBlock_128 addr 0xe50a50 size 0x348 virtual false final false
 void DecryptBlock_128(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method EncryptBlock_128 addr 0xe505fc size 0x344 virtual false final false
 void EncryptBlock_128(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method SubBytes addr 0xe50e40 size 0x1ac virtual false final false
 void SubBytes() ;

/// @brief Method InvSubBytes addr 0xe5160c size 0x1ac virtual false final false
 void InvSubBytes() ;

/// @brief Method ShiftRows addr 0xe50fec size 0x254 virtual false final false
 void ShiftRows() ;

/// @brief Method InvShiftRows addr 0xe513b8 size 0x254 virtual false final false
 void InvShiftRows() ;

/// @brief Method AddRoundKey addr 0xe50940 size 0x88 virtual false final false
 void AddRoundKey(int32_t round) ;

/// @brief Method SubRoundKey addr 0xe50d98 size 0x88 virtual false final false
 void SubRoundKey(int32_t round) ;

/// @brief Method XorRoundKey addr 0xe509c8 size 0x88 virtual false final false
 void XorRoundKey(int32_t round) ;

/// @brief Method MixColumn addr 0xe51908 size 0xb4 virtual false final false
static uint64_t MixColumn(uint64_t c) ;

/// @brief Method MixColumns addr 0xe51240 size 0xbc virtual false final false
 void MixColumns() ;

/// @brief Method MixColumnInv addr 0xe517b8 size 0x150 virtual false final false
static uint64_t MixColumnInv(uint64_t c) ;

/// @brief Method MixColumnsInv addr 0xe512fc size 0xbc virtual false final false
 void MixColumnsInv() ;

/// @brief Method MulX addr 0xe519bc size 0x20 virtual false final false
static uint64_t MulX(uint64_t n) ;

/// @brief Method MulX2 addr 0xe519e4 size 0x2c virtual false final false
static uint64_t MulX2(uint64_t n) ;

/// @brief Method Rotate addr 0xe519dc size 0x8 virtual false final false
static uint64_t Rotate(int32_t n, uint64_t x) ;

/// @brief Method RotateLeft addr 0xe501a4 size 0x20c virtual false final false
 void RotateLeft(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> z) ;

/// @brief Method get_AlgorithmName addr 0xe51a10 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetBlockSize addr 0xe51a50 size 0xc virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method get_IsPartialBlockOkay addr 0xe51a5c size 0x8 virtual true final false
 bool get_IsPartialBlockOkay() ;

/// @brief Method Reset addr 0xe51a64 size 0x24 virtual true final false
 void Reset() ;
