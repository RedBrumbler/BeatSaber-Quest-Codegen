...
/// @brief Method MakeWorkingKey addr 0xe6510c size 0x1590 virtual true final false
 ::ArrayW<int32_t> MakeWorkingKey(::ArrayW<uint8_t> key) ;

/// @brief Method EncryptBlock addr 0xe6669c size 0x1544 virtual true final false
 void EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method DecryptBlock addr 0xe67be0 size 0x1734 virtual true final false
 void DecryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

// Ctor Parameters []
explicit SerpentEngine() ;

/// @brief Method .ctor addr 0xe69314 size 0x58 virtual false final false
 void _ctor() ;
