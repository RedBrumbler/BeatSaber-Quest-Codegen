...
/// @brief Method .ctor addr 0xe9bc54 size 0x58 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe9bcac size 0x158 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher) ;

/// @brief Method get_AlgorithmName addr 0xe9be04 size 0xa0 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xe9bea4 size 0x120 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetBlockSize addr 0xe9bfc4 size 0xa4 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method GetUpdateOutputSize addr 0xe9c068 size 0x2c virtual true final false
 int32_t GetUpdateOutputSize(int32_t length) ;

/// @brief Method GetOutputSize addr 0xe9c094 size 0xc virtual true final false
 int32_t GetOutputSize(int32_t length) ;

/// @brief Method ProcessByte addr 0xe9c0a0 size 0x184 virtual true final false
 int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method ProcessByte addr 0xe9c224 size 0xf0 virtual true final false
 ::ArrayW<uint8_t> ProcessByte(uint8_t input) ;

/// @brief Method ProcessBytes addr 0xe9c314 size 0x168 virtual true final false
 ::ArrayW<uint8_t> ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method ProcessBytes addr 0xe9c47c size 0x358 virtual true final false
 int32_t ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t length, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method DoFinal addr 0xe9c7d4 size 0x120 virtual true final false
 ::ArrayW<uint8_t> DoFinal() ;

/// @brief Method DoFinal addr 0xe9c8f4 size 0x1d0 virtual true final false
 ::ArrayW<uint8_t> DoFinal(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen) ;

/// @brief Method DoFinal addr 0xe9cac4 size 0x258 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe9cd1c size 0xc0 virtual true final false
 void Reset() ;
