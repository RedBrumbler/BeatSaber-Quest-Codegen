...
/// @brief Method GetRecoveredMessage addr 0xecf9b4 size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0xecf9bc size 0x194 virtual false final false
...
/// @brief Method .ctor addr 0xecfe28 size 0x8 virtual false final false
...
/// @brief Method get_AlgorithmName addr 0xecfe30 size 0xc0 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xecfef0 size 0x404 virtual true final false
 void Init(bool forSigning, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method IsSameAs addr 0xed02f4 size 0x80 virtual false final false
 bool IsSameAs(::ArrayW<uint8_t> a, ::ArrayW<uint8_t> b) ;

/// @brief Method ClearBlock addr 0xed0374 size 0x24 virtual false final false
 void ClearBlock(::ArrayW<uint8_t> block) ;

/// @brief Method UpdateWithRecoveredMessage addr 0xed0398 size 0x474 virtual true final false
 void UpdateWithRecoveredMessage(::ArrayW<uint8_t> signature) ;

/// @brief Method Update addr 0xed0c60 size 0xf4 virtual true final false
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0xed0d54 size 0x148 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method Reset addr 0xed0e9c size 0xe4 virtual true final false
 void Reset() ;

/// @brief Method GenerateSignature addr 0xed0f80 size 0x6d0 virtual true final false
 ::ArrayW<uint8_t> GenerateSignature() ;

/// @brief Method VerifySignature addr 0xed16e4 size 0x66c virtual true final false
 bool VerifySignature(::ArrayW<uint8_t> signature) ;

/// @brief Method HasFullMessage addr 0xed1d50 size 0x8 virtual true final false
 bool HasFullMessage() ;

/// @brief Method ItoOSP addr 0xed1d58 size 0x54 virtual false final false
 void ItoOSP(int32_t i, ::ArrayW<uint8_t> sp) ;

/// @brief Method LtoOSP addr 0xed1650 size 0x94 virtual false final false
 void LtoOSP(int64_t l, ::ArrayW<uint8_t> sp) ;

/// @brief Method MaskGeneratorFunction1 addr 0xed080c size 0x454 virtual false final false
