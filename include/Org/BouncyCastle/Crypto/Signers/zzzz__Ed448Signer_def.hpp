...
/// @brief Method GenerateSignature addr 0xeccb08 size 0x190 virtual false final false
...
/// @brief Method VerifySignature addr 0xeccd18 size 0x1c0 virtual false final false
...
/// @brief Method Reset addr 0xeccef0 size 0xf0 virtual false final false
 void Reset() ;

// Ctor Parameters []
explicit Org__BouncyCastle__Crypto__Signers__Ed448Signer__Buffer() ;

/// @brief Method .ctor addr 0xecc91c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xecc870 size 0xac virtual false final false
 void _ctor(::ArrayW<uint8_t> context) ;

/// @brief Method get_AlgorithmName addr 0xecc924 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xecc964 size 0xe0 virtual true final false
 void Init(bool forSigning, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method Update addr 0xecca44 size 0x24 virtual true final false
 void Update(uint8_t b) ;

/// @brief Method BlockUpdate addr 0xecca68 size 0x24 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method GenerateSignature addr 0xecca8c size 0x7c virtual true final false
 ::ArrayW<uint8_t> GenerateSignature() ;

/// @brief Method VerifySignature addr 0xeccc98 size 0x80 virtual true final false
 bool VerifySignature(::ArrayW<uint8_t> signature) ;

/// @brief Method Reset addr 0xecced8 size 0x18 virtual true final false
 void Reset() ;
