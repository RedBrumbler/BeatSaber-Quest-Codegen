...
/// @brief Method get_IsDeterministic addr 0xed5ad4 size 0x8 virtual true final false
 bool get_IsDeterministic() ;

/// @brief Method Init addr 0xed5adc size 0x8 virtual true final false
 void Init(Org::BouncyCastle::Math::BigInteger n, Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method Init addr 0xed5ae4 size 0x50 virtual true final false
 void Init(Org::BouncyCastle::Math::BigInteger n, Org::BouncyCastle::Math::BigInteger d, ::ArrayW<uint8_t> message) ;

/// @brief Method NextK addr 0xed5b34 size 0xc4 virtual true final false
 Org::BouncyCastle::Math::BigInteger NextK() ;

// Ctor Parameters []
explicit RandomDsaKCalculator() ;

/// @brief Method .ctor addr 0xed5bf8 size 0x8 virtual false final false
 void _ctor() ;
