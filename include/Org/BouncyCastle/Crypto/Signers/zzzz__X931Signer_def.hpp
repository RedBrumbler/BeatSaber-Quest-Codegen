...
/// @brief Method .ctor addr 0xed92e4 size 0x110 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IAsymmetricBlockCipher cipher, Org::BouncyCastle::Crypto::IDigest digest, bool isImplicit) ;

/// @brief Method get_AlgorithmName addr 0xed93f4 size 0x160 virtual true final false
...
/// @brief Method .ctor addr 0xed9554 size 0x8 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IAsymmetricBlockCipher cipher, Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method Init addr 0xed955c size 0x1a0 virtual true final false
 void Init(bool forSigning, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method ClearBlock addr 0xed96fc size 0x24 virtual false final false
 void ClearBlock(::ArrayW<uint8_t> block) ;

/// @brief Method Update addr 0xed9720 size 0xac virtual true final false
 void Update(uint8_t b) ;

/// @brief Method BlockUpdate addr 0xed97cc size 0xc4 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t off, int32_t len) ;

/// @brief Method Reset addr 0xed9890 size 0xa4 virtual true final false
 void Reset() ;

/// @brief Method GenerateSignature addr 0xed9934 size 0x160 virtual true final false
 ::ArrayW<uint8_t> GenerateSignature() ;

/// @brief Method CreateSignatureBlock addr 0xed9a94 size 0x280 virtual false final false
 void CreateSignatureBlock() ;

/// @brief Method VerifySignature addr 0xed9d14 size 0x24c virtual true final false
