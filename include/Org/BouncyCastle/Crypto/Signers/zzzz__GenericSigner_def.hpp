...
/// @brief Method .ctor addr 0xeccfe0 size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IAsymmetricBlockCipher engine, Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method get_AlgorithmName addr 0xecd00c size 0x274 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xecd280 size 0x228 virtual true final false
 void Init(bool forSigning, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method Update addr 0xecd4a8 size 0xac virtual true final false
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0xecd554 size 0xc4 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method GenerateSignature addr 0xecd618 size 0x220 virtual true final false
 ::ArrayW<uint8_t> GenerateSignature() ;

/// @brief Method VerifySignature addr 0xecd838 size 0x360 virtual true final false
 bool VerifySignature(::ArrayW<uint8_t> signature) ;

/// @brief Method Reset addr 0xecdb98 size 0xa4 virtual true final false
 void Reset() ;
