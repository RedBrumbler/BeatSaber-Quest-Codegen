...
/// @brief Method GenerateSignature addr 0xecbc04 size 0x184 virtual false final false
 ::ArrayW<uint8_t> GenerateSignature(Org::BouncyCastle::Crypto::Parameters::Ed25519PrivateKeyParameters privateKey) ;

/// @brief Method VerifySignature addr 0xecbe00 size 0x1b0 virtual false final false
 bool VerifySignature(Org::BouncyCastle::Crypto::Parameters::Ed25519PublicKeyParameters publicKey, ::ArrayW<uint8_t> signature) ;

/// @brief Method Reset addr 0xecbfc8 size 0xf0 virtual false final false
 void Reset() ;

// Ctor Parameters []
explicit Org__BouncyCastle__Crypto__Signers__Ed25519Signer__Buffer() ;

/// @brief Method .ctor addr 0xecba20 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xecb9b8 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method get_AlgorithmName addr 0xecba28 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xecba68 size 0xe0 virtual true final false
 void Init(bool forSigning, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method Update addr 0xecbb48 size 0x24 virtual true final false
 void Update(uint8_t b) ;

/// @brief Method BlockUpdate addr 0xecbb6c size 0x24 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method GenerateSignature addr 0xecbb90 size 0x74 virtual true final false
 ::ArrayW<uint8_t> GenerateSignature() ;

/// @brief Method VerifySignature addr 0xecbd88 size 0x78 virtual true final false
 bool VerifySignature(::ArrayW<uint8_t> signature) ;

/// @brief Method Reset addr 0xecbfb0 size 0x18 virtual true final false
 void Reset() ;
