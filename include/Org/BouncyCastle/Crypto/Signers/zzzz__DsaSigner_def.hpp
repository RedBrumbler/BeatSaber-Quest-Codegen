...
/// @brief Method .ctor addr 0xec7f6c size 0x70 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xec7fdc size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Signers::IDsaKCalculator kCalculator) ;

/// @brief Method get_AlgorithmName addr 0xec8008 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xec8048 size 0x28c virtual true final false
 void Init(bool forSigning, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_Order addr 0xec82d4 size 0x24 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_Order() ;

/// @brief Method GenerateSignature addr 0xec82f8 size 0x3b8 virtual true final false
 ::ArrayW<Org::BouncyCastle::Math::BigInteger> GenerateSignature(::ArrayW<uint8_t> message) ;

/// @brief Method VerifySignature addr 0xec86b0 size 0x21c virtual true final false
 bool VerifySignature(::ArrayW<uint8_t> message, Org::BouncyCastle::Math::BigInteger r, Org::BouncyCastle::Math::BigInteger s) ;

/// @brief Method CalculateE addr 0xec88cc size 0xe0 virtual true final false
 Org::BouncyCastle::Math::BigInteger CalculateE(Org::BouncyCastle::Math::BigInteger n, ::ArrayW<uint8_t> message) ;

/// @brief Method InitSecureRandom addr 0xec89ac size 0x70 virtual true final false
