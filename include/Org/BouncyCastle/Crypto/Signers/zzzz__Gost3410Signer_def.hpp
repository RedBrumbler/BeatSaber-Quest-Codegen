...
/// @brief Method get_AlgorithmName addr 0xece9a0 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xece9e0 size 0x1ec virtual true final false
 void Init(bool forSigning, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_Order addr 0xecebcc size 0x24 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_Order() ;

/// @brief Method GenerateSignature addr 0xecebf0 size 0x270 virtual true final false
 ::ArrayW<Org::BouncyCastle::Math::BigInteger> GenerateSignature(::ArrayW<uint8_t> message) ;

/// @brief Method VerifySignature addr 0xecee60 size 0x2a4 virtual true final false
...
/// @brief Method .ctor addr 0xecf104 size 0x8 virtual false final false
 void _ctor() ;
