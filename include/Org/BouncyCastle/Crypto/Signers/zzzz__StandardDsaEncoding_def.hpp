...
/// @brief Method Decode addr 0xed8ce8 size 0x244 virtual true final false
 ::ArrayW<Org::BouncyCastle::Math::BigInteger> Decode(Org::BouncyCastle::Math::BigInteger n, ::ArrayW<uint8_t> encoding) ;

/// @brief Method Encode addr 0xed8f2c size 0x158 virtual true final false
...
/// @brief Method CheckValue addr 0xed9084 size 0xa0 virtual true final false
 Org::BouncyCastle::Math::BigInteger CheckValue(Org::BouncyCastle::Math::BigInteger n, Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method DecodeValue addr 0xed9124 size 0xc0 virtual true final false
...
/// @brief Method EncodeValue addr 0xed91e4 size 0x94 virtual true final false
...
/// @brief Method .ctor addr 0xed92dc size 0x8 virtual false final false
 void _ctor() ;
