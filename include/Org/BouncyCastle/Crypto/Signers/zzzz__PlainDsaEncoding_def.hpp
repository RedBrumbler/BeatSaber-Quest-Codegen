...
/// @brief Method Decode addr 0xed3c80 size 0x198 virtual true final false
 ::ArrayW<Org::BouncyCastle::Math::BigInteger> Decode(Org::BouncyCastle::Math::BigInteger n, ::ArrayW<uint8_t> encoding) ;

/// @brief Method Encode addr 0xed3e18 size 0xcc virtual true final false
...
/// @brief Method CheckValue addr 0xed3ee4 size 0x9c virtual true final false
 Org::BouncyCastle::Math::BigInteger CheckValue(Org::BouncyCastle::Math::BigInteger n, Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method DecodeValue addr 0xed3f80 size 0xa0 virtual true final false
...
/// @brief Method EncodeValue addr 0xed4020 size 0x124 virtual true final false
...
/// @brief Method .ctor addr 0xed41a8 size 0x8 virtual false final false
 void _ctor() ;
