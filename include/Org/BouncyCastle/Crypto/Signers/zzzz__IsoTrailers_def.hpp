...
/// @brief Method CreateTrailerMap addr 0xed35b8 size 0x674 virtual false final false
static System::Collections::IDictionary CreateTrailerMap() ;

/// @brief Method GetTrailer addr 0xecfca4 size 0x184 virtual false final false
static int32_t GetTrailer(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method NoTrailerAvailable addr 0xecfb50 size 0x154 virtual false final false
static bool NoTrailerAvailable(Org::BouncyCastle::Crypto::IDigest digest) ;

// Ctor Parameters []
explicit IsoTrailers() ;

/// @brief Method .ctor addr 0xed3c78 size 0x8 virtual false final false
 void _ctor() ;
