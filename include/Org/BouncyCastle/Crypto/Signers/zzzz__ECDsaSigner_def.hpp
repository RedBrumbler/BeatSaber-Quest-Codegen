...
/// @brief Method .ctor addr 0xec8a1c size 0x70 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xec8a8c size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Signers::IDsaKCalculator kCalculator) ;

/// @brief Method get_AlgorithmName addr 0xec8ab8 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xec8af8 size 0x28c virtual true final false
 void Init(bool forSigning, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_Order addr 0xec8d84 size 0x24 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_Order() ;

/// @brief Method GenerateSignature addr 0xec8da8 size 0x480 virtual true final false
 ::ArrayW<Org::BouncyCastle::Math::BigInteger> GenerateSignature(::ArrayW<uint8_t> message) ;

/// @brief Method VerifySignature addr 0xec9228 size 0x388 virtual true final false
 bool VerifySignature(::ArrayW<uint8_t> message, Org::BouncyCastle::Math::BigInteger r, Org::BouncyCastle::Math::BigInteger s) ;

/// @brief Method CalculateE addr 0xec95b0 size 0xc0 virtual true final false
 Org::BouncyCastle::Math::BigInteger CalculateE(Org::BouncyCastle::Math::BigInteger n, ::ArrayW<uint8_t> message) ;

/// @brief Method CreateBasePointMultiplier addr 0xec9670 size 0x5c virtual true final false
 Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier CreateBasePointMultiplier() ;

/// @brief Method GetDenominator addr 0xec96cc size 0x94 virtual true final false
 Org::BouncyCastle::Math::EC::ECFieldElement GetDenominator(int32_t coordinateSystem, Org::BouncyCastle::Math::EC::ECPoint p) ;

/// @brief Method InitSecureRandom addr 0xec9760 size 0x70 virtual true final false
