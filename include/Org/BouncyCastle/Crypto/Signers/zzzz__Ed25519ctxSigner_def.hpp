...
/// @brief Method GenerateSignature addr 0xecad28 size 0x190 virtual false final false
...
/// @brief Method VerifySignature addr 0xecaf38 size 0x1c0 virtual false final false
...
/// @brief Method Reset addr 0xecb110 size 0xf0 virtual false final false
 void Reset() ;

// Ctor Parameters []
explicit Org__BouncyCastle__Crypto__Signers__Ed25519ctxSigner__Buffer() ;

/// @brief Method .ctor addr 0xecab3c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xecaa90 size 0xac virtual false final false
 void _ctor(::ArrayW<uint8_t> context) ;

/// @brief Method get_AlgorithmName addr 0xecab44 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xecab84 size 0xe0 virtual true final false
 void Init(bool forSigning, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method Update addr 0xecac64 size 0x24 virtual true final false
 void Update(uint8_t b) ;

/// @brief Method BlockUpdate addr 0xecac88 size 0x24 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method GenerateSignature addr 0xecacac size 0x7c virtual true final false
 ::ArrayW<uint8_t> GenerateSignature() ;

/// @brief Method VerifySignature addr 0xecaeb8 size 0x80 virtual true final false
 bool VerifySignature(::ArrayW<uint8_t> signature) ;

/// @brief Method Reset addr 0xecb0f8 size 0x18 virtual true final false
 void Reset() ;
