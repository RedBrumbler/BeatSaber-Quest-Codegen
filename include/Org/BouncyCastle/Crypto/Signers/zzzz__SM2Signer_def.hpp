...
/// @brief Method .ctor addr 0xed7440 size 0x98 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xed7558 size 0x70 virtual false final false
...
/// @brief Method .ctor addr 0xed75c8 size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0xed74d8 size 0x80 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Signers::IDsaEncoding encoding, Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method get_AlgorithmName addr 0xed763c size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xed767c size 0x654 virtual true final false
 void Init(bool forSigning, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method Update addr 0xed7e40 size 0xac virtual true final false
 void Update(uint8_t b) ;

/// @brief Method BlockUpdate addr 0xed7eec size 0xc4 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method VerifySignature addr 0xed7fb0 size 0x184 virtual true final false
 bool VerifySignature(::ArrayW<uint8_t> signature) ;

/// @brief Method Reset addr 0xed8398 size 0x134 virtual true final false
 void Reset() ;

/// @brief Method GenerateSignature addr 0xed84cc size 0x4fc virtual true final false
 ::ArrayW<uint8_t> GenerateSignature() ;

/// @brief Method VerifySignature addr 0xed8134 size 0x264 virtual false final false
 bool VerifySignature(Org::BouncyCastle::Math::BigInteger r, Org::BouncyCastle::Math::BigInteger s) ;

/// @brief Method GetZ addr 0xed7cd0 size 0x170 virtual false final false
 ::ArrayW<uint8_t> GetZ(::ArrayW<uint8_t> userID) ;

/// @brief Method AddUserID addr 0xed89c8 size 0x188 virtual false final false
 void AddUserID(Org::BouncyCastle::Crypto::IDigest digest, ::ArrayW<uint8_t> userID) ;

/// @brief Method AddFieldElement addr 0xed8b50 size 0xd4 virtual false final false
 void AddFieldElement(Org::BouncyCastle::Crypto::IDigest digest, Org::BouncyCastle::Math::EC::ECFieldElement v) ;

/// @brief Method CalculateE addr 0xed8c24 size 0x68 virtual true final false
 Org::BouncyCastle::Math::BigInteger CalculateE(Org::BouncyCastle::Math::BigInteger n, ::ArrayW<uint8_t> message) ;

/// @brief Method CreateBasePointMultiplier addr 0xed8c8c size 0x5c virtual true final false
