...
/// @brief Method .ctor addr 0xecf10c size 0xe8 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method get_IsDeterministic addr 0xecf1f4 size 0x8 virtual true final false
 bool get_IsDeterministic() ;

/// @brief Method Init addr 0xecf1fc size 0x50 virtual true final false
 void Init(Org::BouncyCastle::Math::BigInteger n, Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method Init addr 0xecf24c size 0x424 virtual true final true
 void Init(Org::BouncyCastle::Math::BigInteger n, Org::BouncyCastle::Math::BigInteger d, ::ArrayW<uint8_t> message) ;

/// @brief Method NextK addr 0xecf738 size 0x27c virtual true final false
 Org::BouncyCastle::Math::BigInteger NextK() ;

/// @brief Method BitsToInt addr 0xecf670 size 0xc8 virtual false final false
