...
/// @brief Method get_AlgorithmName addr 0xec9848 size 0x1c virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xec9864 size 0x1f4 virtual true final false
 void Init(bool forSigning, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_Order addr 0xec9a58 size 0x24 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_Order() ;

/// @brief Method GenerateSignature addr 0xec9a7c size 0x3a4 virtual true final false
 ::ArrayW<Org::BouncyCastle::Math::BigInteger> GenerateSignature(::ArrayW<uint8_t> message) ;

/// @brief Method VerifySignature addr 0xec9e20 size 0x304 virtual true final false
 bool VerifySignature(::ArrayW<uint8_t> message, Org::BouncyCastle::Math::BigInteger r, Org::BouncyCastle::Math::BigInteger s) ;

/// @brief Method CreateBasePointMultiplier addr 0xeca124 size 0x5c virtual true final false
 Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier CreateBasePointMultiplier() ;

// Ctor Parameters []
explicit ECGost3410Signer() ;

/// @brief Method .ctor addr 0xeca180 size 0x8 virtual false final false
 void _ctor() ;
