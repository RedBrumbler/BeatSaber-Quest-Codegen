...
/// @brief Method GetRecoveredMessage addr 0xed1dac size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0xed1db4 size 0x108 virtual false final false
...
/// @brief Method .ctor addr 0xed1ebc size 0x8 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IAsymmetricBlockCipher cipher, Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method get_AlgorithmName addr 0xed1ec4 size 0xc0 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xed1f84 size 0x218 virtual true final false
 void Init(bool forSigning, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method IsSameAs addr 0xed219c size 0xb0 virtual false final false
 bool IsSameAs(::ArrayW<uint8_t> a, ::ArrayW<uint8_t> b) ;

/// @brief Method ClearBlock addr 0xed224c size 0x24 virtual false final false
 void ClearBlock(::ArrayW<uint8_t> block) ;

/// @brief Method UpdateWithRecoveredMessage addr 0xed2270 size 0x490 virtual true final false
 void UpdateWithRecoveredMessage(::ArrayW<uint8_t> signature) ;

/// @brief Method Update addr 0xed2700 size 0xe8 virtual true final false
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0xed27e8 size 0x134 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method Reset addr 0xed291c size 0xe0 virtual true final false
 void Reset() ;

/// @brief Method GenerateSignature addr 0xed29fc size 0x3e8 virtual true final false
 ::ArrayW<uint8_t> GenerateSignature() ;

/// @brief Method VerifySignature addr 0xed2de4 size 0x7a4 virtual true final false
 bool VerifySignature(::ArrayW<uint8_t> signature) ;

/// @brief Method ReturnFalse addr 0xed3588 size 0x28 virtual false final false
 bool ReturnFalse(::ArrayW<uint8_t> block) ;

/// @brief Method HasFullMessage addr 0xed35b0 size 0x8 virtual true final false
 bool HasFullMessage() ;
