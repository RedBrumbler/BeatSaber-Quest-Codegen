...
/// @brief Method .ctor addr 0xf45fe0 size 0x6c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IAsymmetricBlockCipher cipher) ;

/// @brief Method GetBufferPosition addr 0xf4604c size 0x8 virtual false final false
 int32_t GetBufferPosition() ;

/// @brief Method get_AlgorithmName addr 0xf46054 size 0xa0 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetBlockSize addr 0xf460f4 size 0xa4 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method GetOutputSize addr 0xf46198 size 0xa4 virtual true final false
 int32_t GetOutputSize(int32_t length) ;

/// @brief Method GetUpdateOutputSize addr 0xf4623c size 0x8 virtual true final false
 int32_t GetUpdateOutputSize(int32_t length) ;

/// @brief Method Init addr 0xf46244 size 0x16c virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method ProcessByte addr 0xf463b0 size 0x90 virtual true final false
 ::ArrayW<uint8_t> ProcessByte(uint8_t input) ;

/// @brief Method ProcessBytes addr 0xf46444 size 0xf0 virtual true final false
 ::ArrayW<uint8_t> ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method DoFinal addr 0xf46534 size 0x11c virtual true final false
 ::ArrayW<uint8_t> DoFinal() ;

/// @brief Method DoFinal addr 0xf46650 size 0x30 virtual true final false
 ::ArrayW<uint8_t> DoFinal(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method Reset addr 0xf46680 size 0x2c virtual true final false
 void Reset() ;
