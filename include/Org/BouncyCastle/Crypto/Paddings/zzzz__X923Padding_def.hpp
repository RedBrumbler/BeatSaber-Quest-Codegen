...
/// @brief Method Init addr 0xeb0fb8 size 0x8 virtual true final true
 void Init(Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method get_PaddingName addr 0xeb0fc0 size 0x40 virtual true final true
 ::StringW get_PaddingName() ;

/// @brief Method AddPadding addr 0xeb1000 size 0xcc virtual true final true
 int32_t AddPadding(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method PadCount addr 0xeb10cc size 0x84 virtual true final true
 int32_t PadCount(::ArrayW<uint8_t> input) ;

// Ctor Parameters []
explicit X923Padding() ;

/// @brief Method .ctor addr 0xeb1150 size 0x8 virtual false final false
 void _ctor() ;
