...
/// @brief Method get_PaddingName addr 0xeb0e88 size 0x40 virtual true final true
 ::StringW get_PaddingName() ;

/// @brief Method Init addr 0xeb0ec8 size 0x4 virtual true final false
 void Init(Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method AddPadding addr 0xeb0ecc size 0x88 virtual true final false
 int32_t AddPadding(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method PadCount addr 0xeb0f54 size 0x5c virtual true final false
 int32_t PadCount(::ArrayW<uint8_t> input) ;

// Ctor Parameters []
explicit TbcPadding() ;

/// @brief Method .ctor addr 0xeb0fb0 size 0x8 virtual false final false
 void _ctor() ;
