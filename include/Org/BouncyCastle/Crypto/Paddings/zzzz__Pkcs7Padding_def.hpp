...
/// @brief Method Init addr 0xeb0d38 size 0x4 virtual true final true
 void Init(Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method get_PaddingName addr 0xeb0d3c size 0x40 virtual true final true
 ::StringW get_PaddingName() ;

/// @brief Method AddPadding addr 0xeb0d7c size 0x4c virtual true final true
 int32_t AddPadding(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method PadCount addr 0xeb0dc8 size 0xc0 virtual true final true
 int32_t PadCount(::ArrayW<uint8_t> input) ;

// Ctor Parameters []
explicit Pkcs7Padding() ;

/// @brief Method .ctor addr 0xeb0248 size 0x8 virtual false final false
 void _ctor() ;
