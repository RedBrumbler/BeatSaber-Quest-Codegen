...
/// @brief Method Init addr 0xeafd98 size 0x6c virtual true final true
 void Init(Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method get_PaddingName addr 0xeafe04 size 0x40 virtual true final true
 ::StringW get_PaddingName() ;

/// @brief Method AddPadding addr 0xeafe44 size 0xb4 virtual true final true
 int32_t AddPadding(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method PadCount addr 0xeafef8 size 0x84 virtual true final true
 int32_t PadCount(::ArrayW<uint8_t> input) ;

// Ctor Parameters []
explicit ISO10126d2Padding() ;

/// @brief Method .ctor addr 0xeaff7c size 0x8 virtual false final false
 void _ctor() ;
