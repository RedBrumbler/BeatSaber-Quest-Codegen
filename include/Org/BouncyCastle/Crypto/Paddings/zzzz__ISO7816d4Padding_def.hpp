...
/// @brief Method Init addr 0xeaff84 size 0x4 virtual true final true
 void Init(Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method get_PaddingName addr 0xeaff88 size 0x40 virtual true final true
 ::StringW get_PaddingName() ;

/// @brief Method AddPadding addr 0xeaffc8 size 0x64 virtual true final true
 int32_t AddPadding(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method PadCount addr 0xeb002c size 0xb0 virtual true final true
 int32_t PadCount(::ArrayW<uint8_t> input) ;

// Ctor Parameters []
explicit ISO7816d4Padding() ;

/// @brief Method .ctor addr 0xeb00dc size 0x8 virtual false final false
 void _ctor() ;
