...
/// @brief Method .ctor addr 0xeb00e4 size 0xf0 virtual false final false
...
/// @brief Method .ctor addr 0xeb01d4 size 0x74 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher) ;

/// @brief Method Init addr 0xeb0250 size 0x1a4 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetOutputSize addr 0xeb03f4 size 0x4c virtual true final false
 int32_t GetOutputSize(int32_t length) ;

/// @brief Method GetUpdateOutputSize addr 0xeb0440 size 0x38 virtual true final false
 int32_t GetUpdateOutputSize(int32_t length) ;

/// @brief Method ProcessByte addr 0xeb0478 size 0x128 virtual true final false
 int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method ProcessBytes addr 0xeb05a0 size 0x2b4 virtual true final false
 int32_t ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t length, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method DoFinal addr 0xeb0854 size 0x4e4 virtual true final false
