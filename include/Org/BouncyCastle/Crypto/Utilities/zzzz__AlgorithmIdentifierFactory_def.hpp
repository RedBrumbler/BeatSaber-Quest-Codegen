...
/// @brief Method GenerateEncryptionAlgID addr 0xf41d2c size 0x55c virtual false final false
...
/// @brief Method .ctor addr 0xf423ac size 0x8 virtual false final false
 void _ctor() ;
