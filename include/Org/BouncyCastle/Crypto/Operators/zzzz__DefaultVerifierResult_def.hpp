...
/// @brief Method .ctor addr 0xeafbac size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::ISigner signer) ;

/// @brief Method IsVerified addr 0xeafbd4 size 0xac virtual true final true
 bool IsVerified(::ArrayW<uint8_t> signature) ;

/// @brief Method IsVerified addr 0xeafc80 size 0x88 virtual true final true
