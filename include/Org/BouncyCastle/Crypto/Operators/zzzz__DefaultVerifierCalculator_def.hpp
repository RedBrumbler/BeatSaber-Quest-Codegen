...
/// @brief Method .ctor addr 0xeaec68 size 0x7c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::ISigner signer) ;

/// @brief Method get_Stream addr 0xeafb20 size 0x8 virtual true final true
 System::IO::Stream get_Stream() ;

/// @brief Method GetResult addr 0xeafb28 size 0x84 virtual true final true
