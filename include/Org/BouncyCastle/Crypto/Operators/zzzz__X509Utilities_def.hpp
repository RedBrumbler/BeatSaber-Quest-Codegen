...
/// @brief Method GetDigestAlgName addr 0xeadac0 size 0x370 virtual false final false
static ::StringW GetDigestAlgName(Org::BouncyCastle::Asn1::DerObjectIdentifier digestAlgOID) ;

/// @brief Method GetSignatureName addr 0xeade30 size 0x298 virtual false final false
static ::StringW GetSignatureName(Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier sigAlgId) ;

/// @brief Method CreatePssParams addr 0xead994 size 0x12c virtual false final false
...
/// @brief Method GetAlgorithmOid addr 0xeae0c8 size 0x20c virtual false final false
static Org::BouncyCastle::Asn1::DerObjectIdentifier GetAlgorithmOid(::StringW algorithmName) ;

/// @brief Method GetSigAlgID addr 0xeae2d4 size 0x330 virtual false final false
...
/// @brief Method GetAlgNames addr 0xeae604 size 0x10c virtual false final false
static System::Collections::IEnumerable GetAlgNames() ;

// Ctor Parameters []
explicit X509Utilities() ;

/// @brief Method .ctor addr 0xeae710 size 0x8 virtual false final false
 void _ctor() ;
