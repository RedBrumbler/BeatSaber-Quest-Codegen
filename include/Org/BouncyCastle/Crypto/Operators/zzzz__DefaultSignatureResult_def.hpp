...
/// @brief Method .ctor addr 0xeafa14 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::ISigner signer) ;

/// @brief Method Collect addr 0xeafa3c size 0xa4 virtual true final true
 ::ArrayW<uint8_t> Collect() ;

/// @brief Method Collect addr 0xeafae0 size 0x40 virtual true final true
