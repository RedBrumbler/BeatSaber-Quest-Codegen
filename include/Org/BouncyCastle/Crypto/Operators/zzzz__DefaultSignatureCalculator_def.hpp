...
/// @brief Method .ctor addr 0xeae934 size 0x7c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::ISigner signer) ;

/// @brief Method get_Stream addr 0xeaf988 size 0x8 virtual true final true
 System::IO::Stream get_Stream() ;

/// @brief Method GetResult addr 0xeaf990 size 0x84 virtual true final true
