...
/// @brief Method .ctor addr 0xeaaf60 size 0x2a0 virtual false final false
...
/// @brief Method get_AlgorithmDetails addr 0xeab200 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType get_AlgorithmDetails() ;

/// @brief Method Unwrap addr 0xeab208 size 0x104 virtual true final true
 Org::BouncyCastle::Crypto::IBlockResult Unwrap(::ArrayW<uint8_t> cipherText, int32_t offset, int32_t length) ;

/// @brief Method Wrap addr 0xeab30c size 0x104 virtual true final true
