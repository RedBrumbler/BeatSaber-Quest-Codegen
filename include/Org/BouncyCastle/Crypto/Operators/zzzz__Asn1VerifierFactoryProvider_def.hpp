...
/// @brief Method .ctor addr 0xeaece4 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::AsymmetricKeyParameter publicKey) ;

/// @brief Method CreateVerifierFactory addr 0xeaed0c size 0xc4 virtual true final true
 Org::BouncyCastle::Crypto::IVerifierFactory CreateVerifierFactory(::bs_hook::Il2CppWrapperType algorithmDetails) ;

/// @brief Method get_SignatureAlgNames addr 0xeaedd0 size 0x4c virtual false final false
