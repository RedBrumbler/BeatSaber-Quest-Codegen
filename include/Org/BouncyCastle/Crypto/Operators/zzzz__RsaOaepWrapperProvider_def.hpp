...
/// @brief Method .ctor addr 0xeaacf8 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::DerObjectIdentifier digestOid) ;

/// @brief Method Org.BouncyCastle.Crypto.Operators.WrapperProvider.CreateWrapper addr 0xeab410 size 0x7c virtual true final true
