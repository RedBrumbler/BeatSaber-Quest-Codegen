...
/// @brief Method .ctor addr 0xea9e64 size 0x120 virtual false final false
...
/// @brief Method get_AlgorithmDetails addr 0xeaa084 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType get_AlgorithmDetails() ;

/// @brief Method GetMaxOutputSize addr 0xeaa08c size 0x40 virtual true final true
 int32_t GetMaxOutputSize(int32_t inputLen) ;

/// @brief Method BuildCipher addr 0xeaa0cc size 0x198 virtual true final true
 Org::BouncyCastle::Crypto::ICipher BuildCipher(System::IO::Stream stream) ;

/// @brief Method get_Key addr 0xeaa2f0 size 0x8 virtual true final true
