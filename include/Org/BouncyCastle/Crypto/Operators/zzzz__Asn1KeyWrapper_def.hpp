...
/// @brief Method .ctor addr 0xeaa458 size 0xa4 virtual false final false
 void _ctor(::StringW algorithm, Org::BouncyCastle::X509::X509Certificate cert) ;

/// @brief Method get_AlgorithmDetails addr 0xeaa734 size 0xa0 virtual true final true
 ::bs_hook::Il2CppWrapperType get_AlgorithmDetails() ;

/// @brief Method Wrap addr 0xeaa7d4 size 0xac virtual true final true
