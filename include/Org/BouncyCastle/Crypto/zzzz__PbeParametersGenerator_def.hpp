...
/// @brief Method .ctor addr 0xe844f4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0xe844fc size 0x100 virtual true final false
 void Init(::ArrayW<uint8_t> password, ::ArrayW<uint8_t> salt, int32_t iterationCount) ;

/// @brief Method get_Password addr 0xe845fc size 0x5c virtual true final false
 ::ArrayW<uint8_t> get_Password() ;

/// @brief Method GetPassword addr 0xe84658 size 0xc virtual false final false
 ::ArrayW<uint8_t> GetPassword() ;

/// @brief Method get_Salt addr 0xe84664 size 0x5c virtual true final false
 ::ArrayW<uint8_t> get_Salt() ;

/// @brief Method GetSalt addr 0xe846c0 size 0xc virtual false final false
 ::ArrayW<uint8_t> GetSalt() ;

/// @brief Method get_IterationCount addr 0xe846cc size 0x8 virtual true final false
...
/// @brief Method Pkcs5PasswordToBytes addr 0xe846d4 size 0x60 virtual false final false
static ::ArrayW<uint8_t> Pkcs5PasswordToBytes(::ArrayW<char16_t> password) ;

/// @brief Method Pkcs5PasswordToBytes addr 0xe84734 size 0x60 virtual false final false
static ::ArrayW<uint8_t> Pkcs5PasswordToBytes(::StringW password) ;

/// @brief Method Pkcs5PasswordToUtf8Bytes addr 0xe84794 size 0x78 virtual false final false
static ::ArrayW<uint8_t> Pkcs5PasswordToUtf8Bytes(::ArrayW<char16_t> password) ;

/// @brief Method Pkcs5PasswordToUtf8Bytes addr 0xe8480c size 0x78 virtual false final false
static ::ArrayW<uint8_t> Pkcs5PasswordToUtf8Bytes(::StringW password) ;

/// @brief Method Pkcs12PasswordToBytes addr 0xe84884 size 0x8 virtual false final false
static ::ArrayW<uint8_t> Pkcs12PasswordToBytes(::ArrayW<char16_t> password) ;

/// @brief Method Pkcs12PasswordToBytes addr 0xe8488c size 0xbc virtual false final false
