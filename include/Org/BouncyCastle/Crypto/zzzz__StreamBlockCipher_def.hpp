...
/// @brief Method .ctor addr 0xf47cac size 0x180 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher) ;

/// @brief Method Init addr 0xf47e2c size 0xbc virtual true final true
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xf47ee8 size 0xa0 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method ReturnByte addr 0xf47f88 size 0xec virtual true final true
 uint8_t ReturnByte(uint8_t input) ;

/// @brief Method ProcessBytes addr 0xf48074 size 0x164 virtual true final true
 void ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t length, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xf481d8 size 0xa4 virtual true final true
 void Reset() ;
