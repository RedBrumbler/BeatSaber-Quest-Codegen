...
/// @brief Method .ctor addr 0xeb1ec0 size 0xd4 virtual false final false
 void _ctor(Org::BouncyCastle::Security::SecureRandom random, int32_t strength) ;

/// @brief Method get_Random addr 0xeb1f94 size 0x8 virtual false final false
 Org::BouncyCastle::Security::SecureRandom get_Random() ;

/// @brief Method get_Strength addr 0xeb1f9c size 0x8 virtual false final false
