...
/// @brief Method .ctor addr 0xe89f08 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IMac mac) ;

/// @brief Method get_Mac addr 0xe89f30 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::IMac get_Mac() ;

/// @brief Method WriteByte addr 0xe89f38 size 0xac virtual true final false
 void WriteByte(uint8_t b) ;

/// @brief Method Write addr 0xe89fe4 size 0xdc virtual true final false
