...
/// @brief Method .ctor addr 0xe8a66c size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::ISigner signer) ;

/// @brief Method get_Signer addr 0xe8a694 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::ISigner get_Signer() ;

/// @brief Method WriteByte addr 0xe8a69c size 0xac virtual true final false
 void WriteByte(uint8_t b) ;

/// @brief Method Write addr 0xe8a748 size 0xdc virtual true final false
