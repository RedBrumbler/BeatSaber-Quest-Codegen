...
/// @brief Method .ctor addr 0xe88d94 size 0x90 virtual false final false
...
/// @brief Method get_ReadCipher addr 0xe88e24 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::IBufferedCipher get_ReadCipher() ;

/// @brief Method get_WriteCipher addr 0xe88e2c size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::IBufferedCipher get_WriteCipher() ;

/// @brief Method ReadByte addr 0xe88e34 size 0x9c virtual true final false
 int32_t ReadByte() ;

/// @brief Method Read addr 0xe88f14 size 0x14c virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method FillInBuf addr 0xe88ed0 size 0x44 virtual false final false
 bool FillInBuf() ;

/// @brief Method ReadAndProcessBlock addr 0xe89060 size 0x218 virtual false final false
 ::ArrayW<uint8_t> ReadAndProcessBlock() ;

/// @brief Method Write addr 0xe89278 size 0x118 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method WriteByte addr 0xe89390 size 0x104 virtual true final false
 void WriteByte(uint8_t b) ;

/// @brief Method get_CanRead addr 0xe89494 size 0x40 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanWrite addr 0xe894d4 size 0x40 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_CanSeek addr 0xe89514 size 0x8 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_Length addr 0xe8951c size 0x40 virtual true final true
 int64_t get_Length() ;

/// @brief Method get_Position addr 0xe8955c size 0x40 virtual true final true
 int64_t get_Position() ;

/// @brief Method set_Position addr 0xe8959c size 0x40 virtual true final true
 void set_Position(int64_t value) ;

/// @brief Method Close addr 0xe895dc size 0x124 virtual true final false
 void Close() ;

/// @brief Method Flush addr 0xe89700 size 0x24 virtual true final false
 void Flush() ;

/// @brief Method Seek addr 0xe89724 size 0x40 virtual true final true
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0xe89764 size 0x40 virtual true final true
