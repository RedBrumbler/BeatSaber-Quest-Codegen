...
/// @brief Method .ctor addr 0xe8a824 size 0x80 virtual false final false
...
/// @brief Method ReadSigner addr 0xe8a8a4 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::ISigner ReadSigner() ;

/// @brief Method WriteSigner addr 0xe8a8ac size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::ISigner WriteSigner() ;

/// @brief Method Read addr 0xe8a8b4 size 0xfc virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method ReadByte addr 0xe8a9b0 size 0xd0 virtual true final false
 int32_t ReadByte() ;

/// @brief Method Write addr 0xe8aa80 size 0xf0 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method WriteByte addr 0xe8ab70 size 0xc8 virtual true final false
 void WriteByte(uint8_t b) ;

/// @brief Method get_CanRead addr 0xe8ac38 size 0x20 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanWrite addr 0xe8ac58 size 0x20 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_CanSeek addr 0xe8ac78 size 0x20 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_Length addr 0xe8ac98 size 0x20 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0xe8acb8 size 0x20 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0xe8acd8 size 0x24 virtual true final false
 void set_Position(int64_t value) ;

/// @brief Method Close addr 0xe8acfc size 0x68 virtual true final false
 void Close() ;

/// @brief Method Flush addr 0xe8ad64 size 0x24 virtual true final false
 void Flush() ;

/// @brief Method Seek addr 0xe8ad88 size 0x24 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0xe8adac size 0x24 virtual true final false
