...
/// @brief Method Init addr 0xe94050 size 0x68 virtual true final true
 void Init(::ArrayW<uint8_t> H) ;

/// @brief Method MultiplyH addr 0xe940b8 size 0x80 virtual true final true
 void MultiplyH(::ArrayW<uint8_t> x) ;

// Ctor Parameters []
explicit BasicGcmMultiplier() ;

/// @brief Method .ctor addr 0xe94138 size 0x8 virtual false final false
 void _ctor() ;
