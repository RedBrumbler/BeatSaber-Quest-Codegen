...
/// @brief Method Init addr 0xe95f54 size 0x85c virtual true final true
 void Init(::ArrayW<uint8_t> H) ;

/// @brief Method MultiplyH addr 0xe967b0 size 0x1e4 virtual true final true
 void MultiplyH(::ArrayW<uint8_t> x) ;

// Ctor Parameters []
explicit Tables8kGcmMultiplier() ;

/// @brief Method .ctor addr 0xe96994 size 0x8 virtual false final false
 void _ctor() ;
