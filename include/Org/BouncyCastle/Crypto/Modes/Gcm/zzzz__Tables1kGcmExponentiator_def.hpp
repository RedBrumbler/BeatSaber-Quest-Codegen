...
/// @brief Method Init addr 0xe951bc size 0x20c virtual true final true
 void Init(::ArrayW<uint8_t> x) ;

/// @brief Method ExponentiateX addr 0xe953c8 size 0x1b0 virtual true final true
 void ExponentiateX(int64_t pow, ::ArrayW<uint8_t> output) ;

/// @brief Method EnsureAvailable addr 0xe95578 size 0x268 virtual false final false
 void EnsureAvailable(int32_t bit) ;

// Ctor Parameters []
explicit Tables1kGcmExponentiator() ;

/// @brief Method .ctor addr 0xe957e0 size 0x8 virtual false final false
 void _ctor() ;
