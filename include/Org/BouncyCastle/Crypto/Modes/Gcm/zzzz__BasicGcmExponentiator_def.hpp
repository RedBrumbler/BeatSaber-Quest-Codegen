...
/// @brief Method Init addr 0xe93d2c size 0x68 virtual true final true
 void Init(::ArrayW<uint8_t> x) ;

/// @brief Method ExponentiateX addr 0xe93dfc size 0x110 virtual true final true
 void ExponentiateX(int64_t pow, ::ArrayW<uint8_t> output) ;

// Ctor Parameters []
explicit BasicGcmExponentiator() ;

/// @brief Method .ctor addr 0xe94048 size 0x8 virtual false final false
 void _ctor() ;
