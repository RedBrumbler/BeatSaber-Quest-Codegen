...
/// @brief Method .ctor addr 0xea5388 size 0x228 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher) ;

/// @brief Method GetUnderlyingCipher addr 0xea55b0 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::IBlockCipher GetUnderlyingCipher() ;

/// @brief Method Init addr 0xea55b8 size 0x1b4 virtual true final true
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xea58a0 size 0xc0 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xea5960 size 0x8 virtual true final true
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xea5968 size 0xa4 virtual true final true
 int32_t GetBlockSize() ;

/// @brief Method ReturnByte addr 0xea5a0c size 0x4 virtual true final true
 uint8_t ReturnByte(uint8_t input) ;

/// @brief Method ProcessBytes addr 0xea5b60 size 0x140 virtual true final true
 void ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t len, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method CalculateByte addr 0xea5a10 size 0x150 virtual false final false
 uint8_t CalculateByte(uint8_t b) ;

/// @brief Method ProcessBlock addr 0xea5ce8 size 0x100 virtual true final true
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xea576c size 0x134 virtual true final true
 void Reset() ;

/// @brief Method incrementCounterAt addr 0xea5ca0 size 0x44 virtual false final false
 void incrementCounterAt(int32_t pos) ;

/// @brief Method checkCounter addr 0xea5ce4 size 0x4 virtual false final false
 void checkCounter() ;
