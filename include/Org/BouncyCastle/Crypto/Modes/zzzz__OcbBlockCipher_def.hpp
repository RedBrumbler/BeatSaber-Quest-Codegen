...
/// @brief Method .ctor addr 0xea5de8 size 0x3e4 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher hashCipher, Org::BouncyCastle::Crypto::IBlockCipher mainCipher) ;

/// @brief Method GetUnderlyingCipher addr 0xea61cc size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::IBlockCipher GetUnderlyingCipher() ;

/// @brief Method get_AlgorithmName addr 0xea61d4 size 0xc0 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xea6294 size 0x6dc virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method ProcessNonce addr 0xea6a08 size 0x238 virtual true final false
 int32_t ProcessNonce(::ArrayW<uint8_t> N) ;

/// @brief Method GetBlockSize addr 0xea6c40 size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method GetMac addr 0xea6c48 size 0x88 virtual true final false
 ::ArrayW<uint8_t> GetMac() ;

/// @brief Method GetOutputSize addr 0xea6cd0 size 0x28 virtual true final false
 int32_t GetOutputSize(int32_t len) ;

/// @brief Method GetUpdateOutputSize addr 0xea6cf8 size 0x38 virtual true final false
 int32_t GetUpdateOutputSize(int32_t len) ;

/// @brief Method ProcessAadByte addr 0xea6d30 size 0x68 virtual true final false
 void ProcessAadByte(uint8_t input) ;

/// @brief Method ProcessAadBytes addr 0xea6d98 size 0xb4 virtual true final false
 void ProcessAadBytes(::ArrayW<uint8_t> input, int32_t off, int32_t len) ;

/// @brief Method ProcessByte addr 0xea6e4c size 0x7c virtual true final false
 int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method ProcessBytes addr 0xea6ec8 size 0xe0 virtual true final false
 int32_t ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t len, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method DoFinal addr 0xea6fa8 size 0x40c virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xea746c size 0x14 virtual true final false
 void Reset() ;

/// @brief Method Clear addr 0xea7480 size 0x1c virtual true final false
 void Clear(::ArrayW<uint8_t> bs) ;

/// @brief Method GetLSub addr 0xea749c size 0x2cc virtual true final false
 ::ArrayW<uint8_t> GetLSub(int32_t n) ;

/// @brief Method ProcessHashBlock addr 0xea7768 size 0x70 virtual true final false
 void ProcessHashBlock() ;

/// @brief Method ProcessMainBlock addr 0xea780c size 0x1d0 virtual true final false
 void ProcessMainBlock(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xea79dc size 0x1ec virtual true final false
 void Reset(bool clearMac) ;

/// @brief Method UpdateHASH addr 0xea7bc8 size 0xe0 virtual true final false
 void UpdateHASH(::ArrayW<uint8_t> LSub) ;

/// @brief Method OCB_double addr 0xea6970 size 0x98 virtual false final false
static ::ArrayW<uint8_t> OCB_double(::ArrayW<uint8_t> block) ;

/// @brief Method OCB_extend addr 0xea73b4 size 0x60 virtual false final false
static void OCB_extend(::ArrayW<uint8_t> block, int32_t pos) ;

/// @brief Method OCB_ntz addr 0xea77d8 size 0x34 virtual false final false
static int32_t OCB_ntz(int64_t x) ;

/// @brief Method ShiftLeft addr 0xea7ca8 size 0x60 virtual false final false
static int32_t ShiftLeft(::ArrayW<uint8_t> block, ::ArrayW<uint8_t> output) ;

/// @brief Method Xor addr 0xea7414 size 0x58 virtual false final false
