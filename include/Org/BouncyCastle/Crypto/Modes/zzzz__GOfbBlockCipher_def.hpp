...
/// @brief Method .ctor addr 0xea1fbc size 0x284 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher) ;

/// @brief Method GetUnderlyingCipher addr 0xea2240 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::IBlockCipher GetUnderlyingCipher() ;

/// @brief Method Init addr 0xea2248 size 0x1c8 virtual true final true
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xea24d4 size 0xc0 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xea2594 size 0x8 virtual true final true
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xea259c size 0x8 virtual true final true
 int32_t GetBlockSize() ;

/// @brief Method ProcessBlock addr 0xea25a4 size 0x34c virtual true final true
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xea2410 size 0xc4 virtual true final true
 void Reset() ;

/// @brief Method bytesToint addr 0xea28f0 size 0x74 virtual false final false
 int32_t bytesToint(::ArrayW<uint8_t> inBytes, int32_t inOff) ;

/// @brief Method intTobytes addr 0xea2964 size 0x80 virtual false final false
