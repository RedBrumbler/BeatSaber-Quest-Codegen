...
/// @brief Method .ctor addr 0xe9da00 size 0x24c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher) ;

/// @brief Method get_AlgorithmName addr 0xe9dc4c size 0xd4 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetUnderlyingCipher addr 0xe9dd20 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::IBlockCipher GetUnderlyingCipher() ;

/// @brief Method GetBlockSize addr 0xe9dd28 size 0x24 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method Init addr 0xe9dd4c size 0x490 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method InitCipher addr 0xe9e1dc size 0x198 virtual false final false
 void InitCipher() ;

/// @brief Method CalculateMac addr 0xe9e374 size 0x158 virtual false final false
 void CalculateMac() ;

/// @brief Method Reset addr 0xe9e4cc size 0x8 virtual true final false
 void Reset() ;

/// @brief Method Reset addr 0xe9e4d4 size 0x1f8 virtual false final false
 void Reset(bool clearMac) ;

/// @brief Method ProcessAadByte addr 0xe9e6cc size 0x100 virtual true final false
 void ProcessAadByte(uint8_t input) ;

/// @brief Method ProcessAadBytes addr 0xe9e7cc size 0x118 virtual true final false
 void ProcessAadBytes(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len) ;

/// @brief Method ProcessByte addr 0xe9e8e4 size 0x40 virtual true final false
 int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method ProcessBytes addr 0xe9eb80 size 0x94 virtual true final false
 int32_t ProcessBytes(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method DoFinal addr 0xe9ec14 size 0x350 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method GetMac addr 0xe9eff8 size 0x74 virtual true final false
 ::ArrayW<uint8_t> GetMac() ;

/// @brief Method GetUpdateOutputSize addr 0xe9f06c size 0x34 virtual true final false
 int32_t GetUpdateOutputSize(int32_t len) ;

/// @brief Method GetOutputSize addr 0xe9f0a0 size 0x1028 virtual true final false
 int32_t GetOutputSize(int32_t len) ;

/// @brief Method Process addr 0xe9e924 size 0x25c virtual false final false
 int32_t Process(uint8_t b, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method VerifyMac addr 0xe9ef64 size 0x94 virtual false final false
