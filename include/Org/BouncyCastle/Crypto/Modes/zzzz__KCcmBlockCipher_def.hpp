...
/// @brief Method setNb addr 0xea29e4 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0xea2a5c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xea2a64 size 0x4b8 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher engine, int32_t Nb) ;

/// @brief Method Init addr 0xea2f1c size 0x408 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xea3324 size 0xc0 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetBlockSize addr 0xea33e4 size 0xa4 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method GetUnderlyingCipher addr 0xea3488 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::IBlockCipher GetUnderlyingCipher() ;

/// @brief Method ProcessAadByte addr 0xea3490 size 0x24 virtual true final false
 void ProcessAadByte(uint8_t input) ;

/// @brief Method ProcessAadBytes addr 0xea34b4 size 0x24 virtual true final false
 void ProcessAadBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t len) ;

/// @brief Method ProcessAAD addr 0xea34d8 size 0x8b0 virtual false final false
 void ProcessAAD(::ArrayW<uint8_t> assocText, int32_t assocOff, int32_t assocLen, int32_t dataLen) ;

/// @brief Method ProcessByte addr 0xea404c size 0x2c virtual true final false
 int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method ProcessBytes addr 0xea4078 size 0xa0 virtual true final false
 int32_t ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method ProcessPacket addr 0xea4118 size 0xb60 virtual false final false
 int32_t ProcessPacket(::ArrayW<uint8_t> input, int32_t inOff, int32_t len, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method ProcessBlock addr 0xea4f00 size 0x218 virtual false final false
 void ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, int32_t len, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method CalculateMac addr 0xea4c78 size 0x288 virtual false final false
 void CalculateMac(::ArrayW<uint8_t> authText, int32_t authOff, int32_t len) ;

/// @brief Method DoFinal addr 0xea5118 size 0x98 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method GetMac addr 0xea51b0 size 0x5c virtual true final false
 ::ArrayW<uint8_t> GetMac() ;

/// @brief Method GetUpdateOutputSize addr 0xea520c size 0x8 virtual true final false
 int32_t GetUpdateOutputSize(int32_t len) ;

/// @brief Method GetOutputSize addr 0xea5214 size 0xc virtual true final false
 int32_t GetOutputSize(int32_t len) ;

/// @brief Method Reset addr 0xea5220 size 0x118 virtual true final false
 void Reset() ;

/// @brief Method intToBytes addr 0xea3d88 size 0x80 virtual false final false
 void intToBytes(int32_t num, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method getFlag addr 0xea3e08 size 0x244 virtual false final false
