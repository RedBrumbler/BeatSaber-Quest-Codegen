...
/// @brief Method .ctor addr 0xea00c8 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xea00d0 size 0x190 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher c, Org::BouncyCastle::Crypto::Modes::Gcm::IGcmMultiplier m) ;

/// @brief Method get_AlgorithmName addr 0xea0260 size 0xc0 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetUnderlyingCipher addr 0xea0320 size 0x8 virtual true final true
 Org::BouncyCastle::Crypto::IBlockCipher GetUnderlyingCipher() ;

/// @brief Method GetBlockSize addr 0xea0328 size 0x8 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method Init addr 0xea0330 size 0x6bc virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetMac addr 0xea0c04 size 0x88 virtual true final false
 ::ArrayW<uint8_t> GetMac() ;

/// @brief Method GetOutputSize addr 0xea0c8c size 0x28 virtual true final false
 int32_t GetOutputSize(int32_t len) ;

/// @brief Method GetUpdateOutputSize addr 0xea0cb4 size 0x38 virtual true final false
 int32_t GetUpdateOutputSize(int32_t len) ;

/// @brief Method ProcessAadByte addr 0xea0cec size 0x7c virtual true final false
 void ProcessAadByte(uint8_t input) ;

/// @brief Method ProcessAadBytes addr 0xea0de8 size 0xc0 virtual true final false
 void ProcessAadBytes(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len) ;

/// @brief Method InitCipher addr 0xea0ea8 size 0x94 virtual false final false
 void InitCipher() ;

/// @brief Method ProcessByte addr 0xea1040 size 0xc8 virtual true final false
 int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method ProcessBytes addr 0xea1280 size 0x24c virtual true final false
 int32_t ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t len, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method DoFinal addr 0xea14cc size 0x52c virtual true final true
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xea1d14 size 0x8 virtual true final false
 void Reset() ;

/// @brief Method Reset addr 0xea1b50 size 0x1c4 virtual false final false
 void Reset(bool clearMac) ;

/// @brief Method ProcessBlock addr 0xea1108 size 0x178 virtual false final false
 void ProcessBlock(::ArrayW<uint8_t> buf, int32_t bufOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method ProcessPartial addr 0xea19f8 size 0x158 virtual false final false
 void ProcessPartial(::ArrayW<uint8_t> buf, int32_t off, int32_t len, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method gHASH addr 0xea0a64 size 0xb4 virtual false final false
 void gHASH(::ArrayW<uint8_t> Y, ::ArrayW<uint8_t> b, int32_t len) ;

/// @brief Method gHASHBlock addr 0xea0b18 size 0xec virtual false final false
 void gHASHBlock(::ArrayW<uint8_t> Y, ::ArrayW<uint8_t> b) ;

/// @brief Method gHASHBlock addr 0xea1ec0 size 0xfc virtual false final false
 void gHASHBlock(::ArrayW<uint8_t> Y, ::ArrayW<uint8_t> b, int32_t off) ;

/// @brief Method gHASHPartial addr 0xea0f3c size 0x104 virtual false final false
 void gHASHPartial(::ArrayW<uint8_t> Y, ::ArrayW<uint8_t> b, int32_t off, int32_t len) ;

/// @brief Method GetNextCtrBlock addr 0xea1d1c size 0x1a4 virtual false final false
 void GetNextCtrBlock(::ArrayW<uint8_t> block) ;

/// @brief Method CheckStatus addr 0xea0d68 size 0x80 virtual false final false
 void CheckStatus() ;
