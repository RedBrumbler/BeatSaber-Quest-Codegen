...
/// @brief Method .ctor addr 0xe9718c size 0x22c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher) ;

/// @brief Method GetUnderlyingCipher addr 0xe973b8 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::IBlockCipher GetUnderlyingCipher() ;

/// @brief Method Init addr 0xe973c0 size 0x1d8 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method get_AlgorithmName addr 0xe97608 size 0xc0 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetBlockSize addr 0xe976c8 size 0xa4 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method ProcessAadByte addr 0xe9776c size 0x24 virtual true final false
 void ProcessAadByte(uint8_t input) ;

/// @brief Method ProcessAadBytes addr 0xe97790 size 0x24 virtual true final false
 void ProcessAadBytes(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len) ;

/// @brief Method ProcessByte addr 0xe977b4 size 0x2c virtual true final false
 int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method ProcessBytes addr 0xe977e0 size 0xa0 virtual true final false
 int32_t ProcessBytes(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t inLen, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method DoFinal addr 0xe97880 size 0xa4 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method Reset addr 0xe97924 size 0xdc virtual true final false
 void Reset() ;

/// @brief Method GetMac addr 0xe97a00 size 0x68 virtual true final false
 ::ArrayW<uint8_t> GetMac() ;

/// @brief Method GetUpdateOutputSize addr 0xe97a68 size 0x8 virtual true final false
 int32_t GetUpdateOutputSize(int32_t len) ;

/// @brief Method GetOutputSize addr 0xe97a70 size 0x54 virtual true final false
 int32_t GetOutputSize(int32_t len) ;

/// @brief Method ProcessPacket addr 0xe97ac4 size 0xfc virtual true final false
 ::ArrayW<uint8_t> ProcessPacket(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen) ;

/// @brief Method ProcessPacket addr 0xe97bc0 size 0x8cc virtual true final false
 int32_t ProcessPacket(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method CalculateMac addr 0xe9848c size 0x88c virtual false final false
 int32_t CalculateMac(::ArrayW<uint8_t> data, int32_t dataOff, int32_t dataLen, ::ArrayW<uint8_t> macBlock) ;

/// @brief Method GetMacSize addr 0xe97598 size 0x70 virtual false final false
 int32_t GetMacSize(bool forEncryption, int32_t requestedMacBits) ;

/// @brief Method GetAssociatedTextLength addr 0xe98d30 size 0x38 virtual false final false
 int32_t GetAssociatedTextLength() ;

/// @brief Method HasAssociatedText addr 0xe98d18 size 0x18 virtual false final false
