...
/// @brief Method .ctor addr 0xea84dc size 0x100 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBlockCipher cipher) ;

/// @brief Method GetUnderlyingCipher addr 0xea85dc size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::IBlockCipher GetUnderlyingCipher() ;

/// @brief Method get_AlgorithmName addr 0xea85e4 size 0xc0 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method get_IsPartialBlockOkay addr 0xea86a4 size 0x8 virtual true final true
 bool get_IsPartialBlockOkay() ;

/// @brief Method GetBlockSize addr 0xea86ac size 0xa4 virtual true final true
 int32_t GetBlockSize() ;

/// @brief Method ProcessBlock addr 0xea8750 size 0x10 virtual true final true
 int32_t ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xea93ac size 0xc8 virtual true final true
 void Reset() ;

/// @brief Method Init addr 0xea9474 size 0x1a8 virtual true final true
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method EncryptByte addr 0xea961c size 0x34 virtual false final false
 uint8_t EncryptByte(uint8_t data, int32_t blockOff) ;

/// @brief Method EncryptBlock addr 0xea8dac size 0x600 virtual false final false
 int32_t EncryptBlock(::ArrayW<uint8_t> input, int32_t inOff, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method DecryptBlock addr 0xea8760 size 0x64c virtual false final false
