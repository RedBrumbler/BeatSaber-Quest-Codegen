...
/// @brief Method .ctor addr 0xe99860 size 0x60 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe998c0 size 0x1e4 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IMac poly1305) ;

/// @brief Method get_AlgorithmName addr 0xe99aa4 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xe99ae4 size 0x464 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetOutputSize addr 0xe9a088 size 0xf8 virtual true final false
 int32_t GetOutputSize(int32_t len) ;

/// @brief Method GetUpdateOutputSize addr 0xe9a180 size 0xfc virtual true final false
 int32_t GetUpdateOutputSize(int32_t len) ;

/// @brief Method ProcessAadByte addr 0xe9a27c size 0xc8 virtual true final false
 void ProcessAadByte(uint8_t input) ;

/// @brief Method ProcessAadBytes addr 0xe9a464 size 0x1f8 virtual true final false
 void ProcessAadBytes(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len) ;

/// @brief Method ProcessByte addr 0xe9a65c size 0x288 virtual true final false
 int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method ProcessBytes addr 0xe9aa80 size 0x508 virtual true final false
 int32_t ProcessBytes(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method DoFinal addr 0xe9af88 size 0x3d0 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method GetMac addr 0xe9b4e8 size 0x5c virtual true final false
 ::ArrayW<uint8_t> GetMac() ;

/// @brief Method Reset addr 0xe9b544 size 0xc virtual true final false
 void Reset() ;

/// @brief Method CheckAad addr 0xe9a344 size 0xb8 virtual false final false
 void CheckAad() ;

/// @brief Method CheckData addr 0xe9a8e4 size 0xd4 virtual false final false
 void CheckData() ;

/// @brief Method FinishAad addr 0xe9b550 size 0x2c virtual false final false
 void FinishAad(Org::BouncyCastle::Crypto::Modes::Org__BouncyCastle__Crypto__Modes__ChaCha20Poly1305__State nextState) ;

/// @brief Method FinishData addr 0xe9b358 size 0x190 virtual false final false
 void FinishData(Org::BouncyCastle::Crypto::Modes::Org__BouncyCastle__Crypto__Modes__ChaCha20Poly1305__State nextState) ;

/// @brief Method IncrementCount addr 0xe9a3fc size 0x68 virtual false final false
 uint64_t IncrementCount(uint64_t count, uint32_t increment, uint64_t limit) ;

/// @brief Method InitMac addr 0xe9b67c size 0x1d4 virtual false final false
 void InitMac() ;

/// @brief Method PadMac addr 0xe9b57c size 0x100 virtual false final false
 void PadMac(uint64_t count) ;

/// @brief Method ProcessData addr 0xe9a9b8 size 0xc8 virtual false final false
 void ProcessData(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t inLen, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method Reset addr 0xe99f48 size 0x140 virtual false final false
