...
/// @brief Method ProcessByte addr 0xe9b8b8 size 0xb4 virtual true final false
 int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method ProcessBytes addr 0xe9b96c size 0x28 virtual true final false
...
/// @brief Method ProcessBytes addr 0xe9b994 size 0x30 virtual true final false
 int32_t ProcessBytes(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method ProcessBytes addr 0xe9b9c4 size 0xb4 virtual true final false
...
/// @brief Method DoFinal addr 0xe9ba78 size 0x28 virtual true final false
 ::ArrayW<uint8_t> DoFinal(::ArrayW<uint8_t> input) ;

/// @brief Method DoFinal addr 0x0 size 0xffffffffffffffff virtual true final false
 ::ArrayW<uint8_t> DoFinal(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method DoFinal addr 0xe9baa0 size 0xb8 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method DoFinal addr 0xe9bb58 size 0x30 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method DoFinal addr 0xe9bb88 size 0x5c virtual true final false
...
// Ctor Parameters []
explicit BufferedCipherBase() ;

/// @brief Method .ctor addr 0xe9bc4c size 0x8 virtual false final false
 void _ctor() ;
