...
/// @brief Method .ctor addr 0xf44878 size 0xbc virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher cipher) ;

/// @brief Method get_AlgorithmName addr 0xf44934 size 0xa0 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xf449d4 size 0x104 virtual true final false
 void Init(bool forEncryption, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetBlockSize addr 0xf44ad8 size 0xa0 virtual true final false
 int32_t GetBlockSize() ;

/// @brief Method GetUpdateOutputSize addr 0xf44b78 size 0xac virtual true final false
 int32_t GetUpdateOutputSize(int32_t length) ;

/// @brief Method GetOutputSize addr 0xf44c24 size 0xac virtual true final false
 int32_t GetOutputSize(int32_t length) ;

/// @brief Method ProcessByte addr 0xf44cd0 size 0xc4 virtual true final false
 int32_t ProcessByte(uint8_t input, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method ProcessByte addr 0xf44d94 size 0xf0 virtual true final false
 ::ArrayW<uint8_t> ProcessByte(uint8_t input) ;

/// @brief Method ProcessBytes addr 0xf44e84 size 0x168 virtual true final false
 ::ArrayW<uint8_t> ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method ProcessBytes addr 0xf44fec size 0xdc virtual true final false
 int32_t ProcessBytes(::ArrayW<uint8_t> input, int32_t inOff, int32_t length, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method DoFinal addr 0xf450c8 size 0xd4 virtual true final false
 ::ArrayW<uint8_t> DoFinal() ;

/// @brief Method DoFinal addr 0xf4519c size 0x17c virtual true final false
 ::ArrayW<uint8_t> DoFinal(::ArrayW<uint8_t> input, int32_t inOff, int32_t inLen) ;

/// @brief Method DoFinal addr 0xf45318 size 0xbc virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xf453d4 size 0xa4 virtual true final false
 void Reset() ;
