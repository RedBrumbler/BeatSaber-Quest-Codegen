...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator::*)()>(&Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0xe7b5b8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator::*)(::StringW)>(&Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0xe7b600;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator::*)(Org::BouncyCastle::Crypto::KeyGenerationParameters)>(&Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator::Init)> {
  ...
  constexpr static std::size_t addrs = 0xe7b6c0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier (Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator::*)()>(&Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator::CreateBasePointMultiplier)> {
  ...
  constexpr static std::size_t addrs = 0xe7bcf0;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator>::get(),
                                  6
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Asn1::X9::X9ECParameters (*)(Org::BouncyCastle::Asn1::DerObjectIdentifier)>(&Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator::FindECCurveByOid)> {
  ...
  constexpr static std::size_t addrs = 0xe7b968;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters (*)(Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters)>(&Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator::GetCorrespondingPublicKey)> {
  ...
  constexpr static std::size_t addrs = 0xe7bd4c;
...
constexpr  Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator::operator Org::BouncyCastle::Crypto::IAsymmetricCipherKeyPairGenerator() const noexcept {
...
constexpr ::StringW Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator::__get_algorithm() const {
...
::cordl_internals::setInstanceField<Org::BouncyCastle::Crypto::Parameters::ECDomainParameters, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<Org::BouncyCastle::Crypto::Parameters::ECDomainParameters>(value));
}
constexpr Org::BouncyCastle::Crypto::Parameters::ECDomainParameters Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator::__get_parameters() const {
return ::cordl_internals::getInstanceField<Org::BouncyCastle::Crypto::Parameters::ECDomainParameters, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr Org::BouncyCastle::Asn1::DerObjectIdentifier Org::BouncyCastle::Crypto::Generators::ECKeyPairGenerator::__get_publicKeyParamSet() const {
