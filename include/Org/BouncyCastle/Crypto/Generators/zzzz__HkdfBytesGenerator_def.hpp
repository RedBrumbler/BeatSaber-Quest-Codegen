...
/// @brief Method .ctor addr 0xe7e868 size 0xf4 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest hash) ;

/// @brief Method Init addr 0xe7e95c size 0x1d8 virtual true final false
 void Init(Org::BouncyCastle::Crypto::IDerivationParameters parameters) ;

/// @brief Method Extract addr 0xe7eb34 size 0x170 virtual false final false
 Org::BouncyCastle::Crypto::Parameters::KeyParameter Extract(::ArrayW<uint8_t> salt, ::ArrayW<uint8_t> ikm) ;

/// @brief Method ExpandNext addr 0xe7eca4 size 0x104 virtual false final false
 void ExpandNext() ;

/// @brief Method get_Digest addr 0xe7eda8 size 0x20 virtual true final false
 Org::BouncyCastle::Crypto::IDigest get_Digest() ;

/// @brief Method GenerateBytes addr 0xe7edc8 size 0x1bc virtual true final false
