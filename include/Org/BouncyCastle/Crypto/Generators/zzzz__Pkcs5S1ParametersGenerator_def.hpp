...
/// @brief Method .ctor addr 0xe85c60 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method GenerateDerivedKey addr 0xe85c88 size 0x34c virtual false final false
 ::ArrayW<uint8_t> GenerateDerivedKey() ;

/// @brief Method GenerateDerivedParameters addr 0xe85fd4 size 0xc virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(int32_t keySize) ;

/// @brief Method GenerateDerivedParameters addr 0xe85fe0 size 0x1a8 virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(::StringW algorithm, int32_t keySize) ;

/// @brief Method GenerateDerivedParameters addr 0xe86188 size 0x204 virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(int32_t keySize, int32_t ivSize) ;

/// @brief Method GenerateDerivedParameters addr 0xe8638c size 0x214 virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(::StringW algorithm, int32_t keySize, int32_t ivSize) ;

/// @brief Method GenerateDerivedMacParameters addr 0xe865a0 size 0x1a8 virtual true final false
