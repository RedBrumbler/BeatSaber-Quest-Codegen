...
/// @brief Method .ctor addr 0xe7efe0 size 0xe0 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IMac prf) ;

/// @brief Method Init addr 0xe7f0c0 size 0x2a4 virtual true final true
 void Init(Org::BouncyCastle::Crypto::IDerivationParameters param) ;

/// @brief Method GetMac addr 0xe7f364 size 0x8 virtual true final true
 Org::BouncyCastle::Crypto::IMac GetMac() ;

/// @brief Method get_Digest addr 0xe7f36c size 0x88 virtual true final true
 Org::BouncyCastle::Crypto::IDigest get_Digest() ;

/// @brief Method GenerateBytes addr 0xe7f3f4 size 0x208 virtual true final true
 int32_t GenerateBytes(::ArrayW<uint8_t> output, int32_t outOff, int32_t length) ;

/// @brief Method generateNext addr 0xe7f5fc size 0x338 virtual false final false
 void generateNext() ;
