...
/// @brief Method .ctor addr 0xe77738 size 0x6c virtual false final false
 void _ctor() ;

/// @brief Method F addr 0xe777a4 size 0x84 virtual false final false
 uint32_t F(uint32_t x) ;

/// @brief Method ProcessTable addr 0xe77828 size 0x134 virtual false final false
 void ProcessTable(uint32_t xl, uint32_t xr, ::ArrayW<uint32_t> table) ;

/// @brief Method InitState addr 0xe7795c size 0x100 virtual false final false
 void InitState() ;

/// @brief Method CyclicXorKey addr 0xe77a5c size 0x88 virtual false final false
 void CyclicXorKey(::ArrayW<uint8_t> key) ;

/// @brief Method EncryptMagicString addr 0xe77ae4 size 0x2d0 virtual false final false
 ::ArrayW<uint8_t> EncryptMagicString() ;

/// @brief Method ProcessTableWithSalt addr 0xe77db4 size 0x25c virtual false final false
 void ProcessTableWithSalt(::ArrayW<uint32_t> table, ::ArrayW<uint32_t> salt32Bit, uint32_t iv1, uint32_t iv2) ;

/// @brief Method DeriveRawKey addr 0xe78010 size 0x320 virtual false final false
 ::ArrayW<uint8_t> DeriveRawKey(int32_t cost, ::ArrayW<uint8_t> salt, ::ArrayW<uint8_t> psw) ;

/// @brief Method PasswordToByteArray addr 0xe78330 size 0x70 virtual false final false
static ::ArrayW<uint8_t> PasswordToByteArray(::ArrayW<char16_t> password) ;

/// @brief Method Generate addr 0xe783a0 size 0x1c8 virtual false final false
