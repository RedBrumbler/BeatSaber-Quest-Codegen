...
/// @brief Method .ctor addr 0xe80fd4 size 0xbc virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method Init addr 0xe81090 size 0x148 virtual true final true
 void Init(Org::BouncyCastle::Crypto::IDerivationParameters parameters) ;

/// @brief Method get_Digest addr 0xe811d8 size 0x8 virtual true final true
 Org::BouncyCastle::Crypto::IDigest get_Digest() ;

/// @brief Method ItoOSP addr 0xe811e0 size 0x54 virtual false final false
 void ItoOSP(int32_t i, ::ArrayW<uint8_t> sp) ;

/// @brief Method GenerateBytes addr 0xe81234 size 0x4c0 virtual true final true
