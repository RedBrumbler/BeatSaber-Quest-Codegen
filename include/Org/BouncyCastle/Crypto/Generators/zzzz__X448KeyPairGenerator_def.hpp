...
/// @brief Method Init addr 0xe88cc0 size 0x1c virtual true final false
 void Init(Org::BouncyCastle::Crypto::KeyGenerationParameters parameters) ;

/// @brief Method GenerateKeyPair addr 0xe88cdc size 0xb0 virtual true final false
 Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair GenerateKeyPair() ;

// Ctor Parameters []
explicit X448KeyPairGenerator() ;

/// @brief Method .ctor addr 0xe88d8c size 0x8 virtual false final false
 void _ctor() ;
