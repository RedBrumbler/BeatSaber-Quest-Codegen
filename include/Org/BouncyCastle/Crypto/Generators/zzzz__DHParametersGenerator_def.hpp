...
/// @brief Method Init addr 0xe7951c size 0xc virtual true final false
 void Init(int32_t size, int32_t certainty, Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method GenerateParameters addr 0xe79528 size 0x118 virtual true final false
 Org::BouncyCastle::Crypto::Parameters::DHParameters GenerateParameters() ;

// Ctor Parameters []
explicit DHParametersGenerator() ;

/// @brief Method .ctor addr 0xe79c0c size 0x8 virtual false final false
 void _ctor() ;
