...
/// @brief Method .ctor addr 0xe78bd0 size 0x10 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe78be0 size 0x4 virtual false final false
 void _ctor(int32_t defaultStrength) ;

/// @brief Method engineInit addr 0xe78be4 size 0x230 virtual true final false
 void engineInit(Org::BouncyCastle::Crypto::KeyGenerationParameters parameters) ;

/// @brief Method engineGenerateKey addr 0xe78e14 size 0xdc virtual true final false
