...
/// @brief Method Init addr 0xe7bff0 size 0xa4 virtual true final true
 void Init(Org::BouncyCastle::Crypto::KeyGenerationParameters parameters) ;

/// @brief Method GenerateKeyPair addr 0xe7c094 size 0x198 virtual true final true
 Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair GenerateKeyPair() ;

// Ctor Parameters []
explicit ElGamalKeyPairGenerator() ;

/// @brief Method .ctor addr 0xe7c22c size 0x8 virtual false final false
 void _ctor() ;
