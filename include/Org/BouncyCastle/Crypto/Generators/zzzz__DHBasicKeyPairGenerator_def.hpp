...
/// @brief Method Init addr 0xe78ef0 size 0xa4 virtual true final false
 void Init(Org::BouncyCastle::Crypto::KeyGenerationParameters parameters) ;

/// @brief Method GenerateKeyPair addr 0xe78f94 size 0x13c virtual true final false
 Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair GenerateKeyPair() ;

// Ctor Parameters []
explicit DHBasicKeyPairGenerator() ;

/// @brief Method .ctor addr 0xe792c0 size 0x8 virtual false final false
 void _ctor() ;
