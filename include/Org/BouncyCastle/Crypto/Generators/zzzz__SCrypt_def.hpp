...
/// @brief Method Generate addr 0xe87fb8 size 0x334 virtual false final false
static ::ArrayW<uint8_t> Generate(::ArrayW<uint8_t> P, ::ArrayW<uint8_t> S, int32_t N, int32_t r, int32_t p, int32_t dkLen) ;

/// @brief Method MFcrypt addr 0xe882fc size 0x1e8 virtual false final false
static ::ArrayW<uint8_t> MFcrypt(::ArrayW<uint8_t> P, ::ArrayW<uint8_t> S, int32_t N, int32_t r, int32_t p, int32_t dkLen) ;

/// @brief Method SingleIterationPBKDF2 addr 0xe884e4 size 0x114 virtual false final false
static ::ArrayW<uint8_t> SingleIterationPBKDF2(::ArrayW<uint8_t> P, ::ArrayW<uint8_t> S, int32_t dkLen) ;

/// @brief Method SMix addr 0xe885f8 size 0x3c4 virtual false final false
static void SMix(::ArrayW<uint32_t> B, int32_t BOff, int32_t N, int32_t d, int32_t r) ;

/// @brief Method BlockMix addr 0xe889bc size 0x11c virtual false final false
static void BlockMix(::ArrayW<uint32_t> B, ::ArrayW<uint32_t> X1, ::ArrayW<uint32_t> X2, ::ArrayW<uint32_t> Y, int32_t r) ;

/// @brief Method Xor addr 0xe88ad8 size 0x80 virtual false final false
static void Xor(::ArrayW<uint32_t> a, ::ArrayW<uint32_t> b, int32_t bOff, ::ArrayW<uint32_t> output) ;

/// @brief Method Clear addr 0xe88b58 size 0x30 virtual false final false
static void Clear(System::Array array) ;

/// @brief Method ClearAll addr 0xe88b88 size 0x5c virtual false final false
static void ClearAll(::ArrayW<System::Array> arrays) ;

/// @brief Method IsPowerOf2 addr 0xe882ec size 0x10 virtual false final false
static bool IsPowerOf2(int32_t x) ;

// Ctor Parameters []
explicit SCrypt() ;

/// @brief Method .ctor addr 0xe88be4 size 0x8 virtual false final false
 void _ctor() ;
