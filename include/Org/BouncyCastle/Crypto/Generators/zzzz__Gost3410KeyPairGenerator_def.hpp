...
/// @brief Method Init addr 0xe7c324 size 0x120 virtual true final true
 void Init(Org::BouncyCastle::Crypto::KeyGenerationParameters parameters) ;

/// @brief Method GenerateKeyPair addr 0xe7c444 size 0x224 virtual true final true
 Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair GenerateKeyPair() ;

// Ctor Parameters []
explicit Gost3410KeyPairGenerator() ;

/// @brief Method .ctor addr 0xe7c668 size 0x8 virtual false final false
 void _ctor() ;
