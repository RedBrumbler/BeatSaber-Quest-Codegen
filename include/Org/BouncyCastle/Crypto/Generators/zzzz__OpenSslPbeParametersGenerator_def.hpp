...
/// @brief Method .ctor addr 0xe84948 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0xe849b0 size 0x8 virtual true final false
 void Init(::ArrayW<uint8_t> password, ::ArrayW<uint8_t> salt, int32_t iterationCount) ;

/// @brief Method Init addr 0xe849b8 size 0x8 virtual true final false
 void Init(::ArrayW<uint8_t> password, ::ArrayW<uint8_t> salt) ;

/// @brief Method GenerateDerivedKey addr 0xe849c0 size 0x384 virtual false final false
 ::ArrayW<uint8_t> GenerateDerivedKey(int32_t bytesNeeded) ;

/// @brief Method GenerateDerivedParameters addr 0xe84d44 size 0xc virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(int32_t keySize) ;

/// @brief Method GenerateDerivedParameters addr 0xe84d50 size 0x98 virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(::StringW algorithm, int32_t keySize) ;

/// @brief Method GenerateDerivedParameters addr 0xe84de8 size 0xf4 virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(int32_t keySize, int32_t ivSize) ;

/// @brief Method GenerateDerivedParameters addr 0xe84edc size 0x104 virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(::StringW algorithm, int32_t keySize, int32_t ivSize) ;

/// @brief Method GenerateDerivedMacParameters addr 0xe84fe0 size 0x9c virtual true final false
