...
/// @brief Method .ctor addr 0xe80584 size 0xe0 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IMac prf) ;

/// @brief Method Init addr 0xe80664 size 0x2bc virtual true final true
 void Init(Org::BouncyCastle::Crypto::IDerivationParameters parameters) ;

/// @brief Method get_Digest addr 0xe80920 size 0x88 virtual true final true
 Org::BouncyCastle::Crypto::IDigest get_Digest() ;

/// @brief Method GenerateBytes addr 0xe809a8 size 0x208 virtual true final true
 int32_t GenerateBytes(::ArrayW<uint8_t> output, int32_t outOff, int32_t length) ;

/// @brief Method generateNext addr 0xe80bb0 size 0x38c virtual false final false
 void generateNext() ;

/// @brief Method GetMac addr 0xe80f3c size 0x8 virtual true final true
