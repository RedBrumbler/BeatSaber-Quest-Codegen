...
/// @brief Method Init addr 0xe79dd4 size 0xec virtual true final true
 void Init(Org::BouncyCastle::Crypto::KeyGenerationParameters parameters) ;

/// @brief Method GenerateKeyPair addr 0xe79ec0 size 0x148 virtual true final true
 Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair GenerateKeyPair() ;

/// @brief Method GeneratePrivateKey addr 0xe7a008 size 0xf0 virtual false final false
...
/// @brief Method CalculatePublicKey addr 0xe7a0f8 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0xe7a194 size 0x8 virtual false final false
 void _ctor() ;
