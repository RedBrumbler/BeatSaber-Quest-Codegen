...
/// @brief Method Init addr 0xe79334 size 0xa4 virtual true final false
 void Init(Org::BouncyCastle::Crypto::KeyGenerationParameters parameters) ;

/// @brief Method GenerateKeyPair addr 0xe793d8 size 0x13c virtual true final false
 Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair GenerateKeyPair() ;

// Ctor Parameters []
explicit DHKeyPairGenerator() ;

/// @brief Method .ctor addr 0xe79514 size 0x8 virtual false final false
 void _ctor() ;
