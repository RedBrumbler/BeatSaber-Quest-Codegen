...
/// @brief Method .ctor addr 0xe78a0c size 0x10 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe78a1c size 0x4 virtual false final false
 void _ctor(int32_t defaultStrength) ;

/// @brief Method engineInit addr 0xe78a20 size 0xfc virtual true final false
 void engineInit(Org::BouncyCastle::Crypto::KeyGenerationParameters parameters) ;

/// @brief Method engineGenerateKey addr 0xe78b1c size 0xb4 virtual true final false
