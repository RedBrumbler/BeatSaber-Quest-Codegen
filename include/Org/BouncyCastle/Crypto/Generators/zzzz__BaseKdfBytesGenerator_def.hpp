...
/// @brief Method .ctor addr 0xe770bc size 0x30 virtual false final false
 void _ctor(int32_t counterStart, Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method Init addr 0xe770ec size 0x110 virtual true final false
 void Init(Org::BouncyCastle::Crypto::IDerivationParameters parameters) ;

/// @brief Method get_Digest addr 0xe771fc size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::IDigest get_Digest() ;

/// @brief Method GenerateBytes addr 0xe77204 size 0x534 virtual true final false
