...
/// @brief Method .ctor addr 0xe83184 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method CreateBcryptString addr 0xe8318c size 0x2e4 virtual false final false
static ::StringW CreateBcryptString(::StringW version, ::ArrayW<uint8_t> password, ::ArrayW<uint8_t> salt, int32_t cost) ;

/// @brief Method Generate addr 0xe837cc size 0x78 virtual false final false
static ::StringW Generate(::ArrayW<char16_t> password, ::ArrayW<uint8_t> salt, int32_t cost) ;

/// @brief Method Generate addr 0xe83844 size 0x3b4 virtual false final false
static ::StringW Generate(::StringW version, ::ArrayW<char16_t> password, ::ArrayW<uint8_t> salt, int32_t cost) ;

/// @brief Method CheckPassword addr 0xe83bf8 size 0x528 virtual false final false
static bool CheckPassword(::StringW bcryptString, ::ArrayW<char16_t> password) ;

/// @brief Method EncodeData addr 0xe83470 size 0x35c virtual false final false
static ::StringW EncodeData(::ArrayW<uint8_t> data) ;

/// @brief Method DecodeSaltString addr 0xe84120 size 0x3d4 virtual false final false
