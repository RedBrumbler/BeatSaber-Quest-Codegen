...
/// @brief Method .ctor addr 0xe8507c size 0x11c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method Adjust addr 0xe85198 size 0xd4 virtual false final false
 void Adjust(::ArrayW<uint8_t> a, int32_t aOff, ::ArrayW<uint8_t> b) ;

/// @brief Method GenerateDerivedKey addr 0xe8526c size 0x5f0 virtual false final false
 ::ArrayW<uint8_t> GenerateDerivedKey(int32_t idByte, int32_t n) ;

/// @brief Method GenerateDerivedParameters addr 0xe8585c size 0xa0 virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(int32_t keySize) ;

/// @brief Method GenerateDerivedParameters addr 0xe858fc size 0x9c virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(::StringW algorithm, int32_t keySize) ;

/// @brief Method GenerateDerivedParameters addr 0xe85998 size 0x10c virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(int32_t keySize, int32_t ivSize) ;

/// @brief Method GenerateDerivedParameters addr 0xe85aa4 size 0x11c virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(::StringW algorithm, int32_t keySize, int32_t ivSize) ;

/// @brief Method GenerateDerivedMacParameters addr 0xe85bc0 size 0xa0 virtual true final false
