...
/// @brief Method engineInit addr 0xe871e4 size 0x24 virtual true final false
 void engineInit(Org::BouncyCastle::Crypto::KeyGenerationParameters param) ;

/// @brief Method engineGenerateKey addr 0xe87208 size 0x1c virtual true final false
 ::ArrayW<uint8_t> engineGenerateKey() ;

/// @brief Method Clamp addr 0xe87224 size 0xc0 virtual false final false
static void Clamp(::ArrayW<uint8_t> key) ;

/// @brief Method CheckKey addr 0xe872e4 size 0x10c virtual false final false
static void CheckKey(::ArrayW<uint8_t> key) ;

/// @brief Method CheckMask addr 0xe873f0 size 0x60 virtual false final false
static void CheckMask(uint8_t b, uint8_t mask) ;

// Ctor Parameters []
explicit Poly1305KeyGenerator() ;

/// @brief Method .ctor addr 0xe87450 size 0x10 virtual false final false
 void _ctor() ;
