...
/// @brief Method .ctor addr 0xe7b5b8 size 0x48 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "algorithm", ty: "::StringW", modifiers: "", def_value: None }]
explicit ECKeyPairGenerator(::StringW algorithm) ;

/// @brief Method .ctor addr 0xe7b600 size 0xc0 virtual false final false
 void _ctor(::StringW algorithm) ;

/// @brief Method Init addr 0xe7b6c0 size 0x2a8 virtual true final true
 void Init(Org::BouncyCastle::Crypto::KeyGenerationParameters parameters) ;

/// @brief Method GenerateKeyPair addr 0xe7b9dc size 0x314 virtual true final true
 Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair GenerateKeyPair() ;

/// @brief Method CreateBasePointMultiplier addr 0xe7bcf0 size 0x5c virtual true final false
 Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier CreateBasePointMultiplier() ;

/// @brief Method FindECCurveByOid addr 0xe7b968 size 0x74 virtual false final false
static Org::BouncyCastle::Asn1::X9::X9ECParameters FindECCurveByOid(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetCorrespondingPublicKey addr 0xe7bd4c size 0xfc virtual false final false
