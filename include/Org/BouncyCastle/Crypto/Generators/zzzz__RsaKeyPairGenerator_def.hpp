...
/// @brief Method Init addr 0xe877c8 size 0x114 virtual true final false
 void Init(Org::BouncyCastle::Crypto::KeyGenerationParameters parameters) ;

/// @brief Method GenerateKeyPair addr 0xe878dc size 0x36c virtual true final false
 Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair GenerateKeyPair() ;

/// @brief Method ChooseRandomPrime addr 0xe87c48 size 0x230 virtual true final false
...
/// @brief Method .ctor addr 0xe87fb0 size 0x8 virtual false final false
 void _ctor() ;
