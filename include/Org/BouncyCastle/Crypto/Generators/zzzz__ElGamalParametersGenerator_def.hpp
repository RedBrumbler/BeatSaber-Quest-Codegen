...
/// @brief Method Init addr 0xe7c234 size 0xc virtual false final false
 void Init(int32_t size, int32_t certainty, Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method GenerateParameters addr 0xe7c240 size 0xdc virtual false final false
 Org::BouncyCastle::Crypto::Parameters::ElGamalParameters GenerateParameters() ;

// Ctor Parameters []
explicit ElGamalParametersGenerator() ;

/// @brief Method .ctor addr 0xe7c31c size 0x8 virtual false final false
 void _ctor() ;
