...
/// @brief Method .ctor addr 0xe7a19c size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe7a208 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method Init addr 0xe7a230 size 0x9c virtual true final false
 void Init(int32_t size, int32_t certainty, Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method Init addr 0xe7a2fc size 0x29c virtual true final false
 void Init(Org::BouncyCastle::Crypto::Parameters::DsaParameterGenerationParameters parameters) ;

/// @brief Method GenerateParameters addr 0xe7a598 size 0x1c virtual true final false
 Org::BouncyCastle::Crypto::Parameters::DsaParameters GenerateParameters() ;

/// @brief Method GenerateParameters_FIPS186_2 addr 0xe7a5b4 size 0x538 virtual true final false
 Org::BouncyCastle::Crypto::Parameters::DsaParameters GenerateParameters_FIPS186_2() ;

/// @brief Method CalculateGenerator_FIPS186_2 addr 0xe7ac5c size 0x114 virtual true final false
...
/// @brief Method GenerateParameters_FIPS186_3 addr 0xe7ad70 size 0x58c virtual true final false
 Org::BouncyCastle::Crypto::Parameters::DsaParameters GenerateParameters_FIPS186_3() ;

/// @brief Method CalculateGenerator_FIPS186_3_Unverifiable addr 0xe7b2fc size 0xc virtual true final false
...
/// @brief Method CalculateGenerator_FIPS186_3_Verifiable addr 0xe7b308 size 0x2b0 virtual true final false
...
/// @brief Method IsValidDsaStrength addr 0xe7a2cc size 0x1c virtual false final false
static bool IsValidDsaStrength(int32_t strength) ;

/// @brief Method Hash addr 0xe7aaec size 0x128 virtual false final false
static void Hash(Org::BouncyCastle::Crypto::IDigest d, ::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output) ;

/// @brief Method GetDefaultN addr 0xe7a2e8 size 0x14 virtual false final false
static int32_t GetDefaultN(int32_t L) ;

/// @brief Method Inc addr 0xe7ac14 size 0x48 virtual false final false
