...
/// @brief Method .ctor addr 0xe86748 size 0x64 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe867ac size 0x114 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method F addr 0xe868c0 size 0x3c4 virtual false final false
 void F(::ArrayW<uint8_t> S, int32_t c, ::ArrayW<uint8_t> iBuf, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method GenerateDerivedKey addr 0xe86c84 size 0x228 virtual false final false
 ::ArrayW<uint8_t> GenerateDerivedKey(int32_t dkLen) ;

/// @brief Method GenerateDerivedParameters addr 0xe86eac size 0xc virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(int32_t keySize) ;

/// @brief Method GenerateDerivedParameters addr 0xe86eb8 size 0x98 virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(::StringW algorithm, int32_t keySize) ;

/// @brief Method GenerateDerivedParameters addr 0xe86f50 size 0xf4 virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(int32_t keySize, int32_t ivSize) ;

/// @brief Method GenerateDerivedParameters addr 0xe87044 size 0x104 virtual true final false
 Org::BouncyCastle::Crypto::ICipherParameters GenerateDerivedParameters(::StringW algorithm, int32_t keySize, int32_t ivSize) ;

/// @brief Method GenerateDerivedMacParameters addr 0xe87148 size 0x9c virtual true final false
