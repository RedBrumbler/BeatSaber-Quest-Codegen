...
/// @brief Method .ctor addr 0xe78738 size 0x10 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe78748 size 0x98 virtual false final false
 void _ctor(int32_t defaultStrength) ;

/// @brief Method get_DefaultStrength addr 0xe787e0 size 0x8 virtual false final false
 int32_t get_DefaultStrength() ;

/// @brief Method Init addr 0xe787e8 size 0x68 virtual false final false
 void Init(Org::BouncyCastle::Crypto::KeyGenerationParameters parameters) ;

/// @brief Method engineInit addr 0xe78850 size 0x38 virtual true final false
 void engineInit(Org::BouncyCastle::Crypto::KeyGenerationParameters parameters) ;

/// @brief Method GenerateKey addr 0xe78888 size 0x120 virtual false final false
 ::ArrayW<uint8_t> GenerateKey() ;

/// @brief Method engineGenerateKey addr 0xe789a8 size 0x64 virtual true final false
