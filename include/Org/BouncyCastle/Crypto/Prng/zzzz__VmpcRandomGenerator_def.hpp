...
/// @brief Method .ctor addr 0xec5c54 size 0x90 virtual false final false
 void _ctor() ;

/// @brief Method AddSeedMaterial addr 0xec5ce4 size 0xd0 virtual true final false
 void AddSeedMaterial(::ArrayW<uint8_t> seed) ;

/// @brief Method AddSeedMaterial addr 0xec5db4 size 0x2c virtual true final false
 void AddSeedMaterial(int64_t seed) ;

/// @brief Method NextBytes addr 0xec5de0 size 0x24 virtual true final false
 void NextBytes(::ArrayW<uint8_t> bytes) ;

/// @brief Method NextBytes addr 0xec5e04 size 0x210 virtual true final false
