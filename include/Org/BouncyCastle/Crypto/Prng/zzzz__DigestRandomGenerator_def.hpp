...
/// @brief Method .ctor addr 0xec2cb8 size 0x168 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method AddSeedMaterial addr 0xec2e20 size 0xc8 virtual true final true
 void AddSeedMaterial(::ArrayW<uint8_t> inSeed) ;

/// @brief Method AddSeedMaterial addr 0xec3054 size 0xc8 virtual true final true
 void AddSeedMaterial(int64_t rSeed) ;

/// @brief Method NextBytes addr 0xec3214 size 0x1c virtual true final true
 void NextBytes(::ArrayW<uint8_t> bytes) ;

/// @brief Method NextBytes addr 0xec3230 size 0x168 virtual true final true
 void NextBytes(::ArrayW<uint8_t> bytes, int32_t start, int32_t len) ;

/// @brief Method CycleSeed addr 0xec340c size 0x34 virtual false final false
 void CycleSeed() ;

/// @brief Method GenerateState addr 0xec3398 size 0x74 virtual false final false
 void GenerateState() ;

/// @brief Method DigestAddCounter addr 0xec311c size 0xf8 virtual false final false
 void DigestAddCounter(int64_t seedVal) ;

/// @brief Method DigestUpdate addr 0xec2ee8 size 0xbc virtual false final false
 void DigestUpdate(::ArrayW<uint8_t> inSeed) ;

/// @brief Method DigestDoFinal addr 0xec2fa4 size 0xb0 virtual false final false
