...
/// @brief Method .ctor addr 0xec69b8 size 0x80 virtual false final false
...
/// @brief Method SetSeed addr 0xec6a38 size 0xb4 virtual true final false
 void SetSeed(::ArrayW<uint8_t> seed) ;

/// @brief Method SetSeed addr 0xec6aec size 0xb4 virtual true final false
 void SetSeed(int64_t seed) ;

/// @brief Method NextBytes addr 0xec6ba0 size 0xf0 virtual true final false
 void NextBytes(::ArrayW<uint8_t> bytes) ;

/// @brief Method NextBytes addr 0xec6c90 size 0x98 virtual true final false
 void NextBytes(::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method GenerateSeed addr 0xec6d28 size 0x1c virtual true final false
