...
/// @brief Method .ctor addr 0xec4914 size 0x88 virtual false final false
...
/// @brief Method SetSeed addr 0xec499c size 0xb4 virtual true final false
 void SetSeed(::ArrayW<uint8_t> seed) ;

/// @brief Method SetSeed addr 0xec4a50 size 0xb4 virtual true final false
 void SetSeed(int64_t seed) ;

/// @brief Method NextBytes addr 0xec4b04 size 0x2e0 virtual true final false
 void NextBytes(::ArrayW<uint8_t> bytes) ;

/// @brief Method NextBytes addr 0xec4de4 size 0x98 virtual true final false
 void NextBytes(::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method GenerateSeed addr 0xec4e7c size 0x8 virtual true final false
 ::ArrayW<uint8_t> GenerateSeed(int32_t numBytes) ;

/// @brief Method Reseed addr 0xec4e84 size 0x1d4 virtual true final false
