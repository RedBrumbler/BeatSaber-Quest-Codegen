...
/// @brief Method .ctor addr 0xec2ac4 size 0x34 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xec2af8 size 0x28 virtual false final false
 void _ctor(System::Security::Cryptography::RandomNumberGenerator rng) ;

/// @brief Method AddSeedMaterial addr 0xec2b20 size 0x4 virtual true final false
 void AddSeedMaterial(::ArrayW<uint8_t> seed) ;

/// @brief Method AddSeedMaterial addr 0xec2b24 size 0x4 virtual true final false
 void AddSeedMaterial(int64_t seed) ;

/// @brief Method NextBytes addr 0xec2b28 size 0x20 virtual true final false
 void NextBytes(::ArrayW<uint8_t> bytes) ;

/// @brief Method NextBytes addr 0xec2b48 size 0x170 virtual true final false
