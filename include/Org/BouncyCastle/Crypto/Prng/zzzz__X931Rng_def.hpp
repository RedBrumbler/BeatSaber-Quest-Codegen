...
/// @brief Method .ctor addr 0xec6014 size 0x1f8 virtual false final false
...
/// @brief Method Generate addr 0xec620c size 0x488 virtual false final false
 int32_t Generate(::ArrayW<uint8_t> output, bool predictionResistant) ;

/// @brief Method Reseed addr 0xec6824 size 0x18c virtual false final false
 void Reseed() ;

/// @brief Method get_EntropySource addr 0xec69b0 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::IEntropySource get_EntropySource() ;

/// @brief Method Process addr 0xec66a8 size 0x134 virtual false final false
 void Process(::ArrayW<uint8_t> res, ::ArrayW<uint8_t> a, ::ArrayW<uint8_t> b) ;

/// @brief Method Increment addr 0xec67dc size 0x48 virtual false final false
 void Increment(::ArrayW<uint8_t> val) ;

/// @brief Method IsTooLarge addr 0xec6694 size 0x14 virtual false final false
