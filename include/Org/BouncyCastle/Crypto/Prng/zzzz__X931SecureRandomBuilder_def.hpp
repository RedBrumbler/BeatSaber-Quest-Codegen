...
/// @brief Method .ctor addr 0xec6d44 size 0x64 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xec6da8 size 0x8c virtual false final false
...
/// @brief Method .ctor addr 0xec6e34 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IEntropySourceProvider entropySourceProvider) ;

/// @brief Method SetDateTimeVector addr 0xec6e5c size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::Prng::X931SecureRandomBuilder SetDateTimeVector(::ArrayW<uint8_t> dateTimeVector) ;

/// @brief Method Build addr 0xec6e64 size 0x2e4 virtual false final false
