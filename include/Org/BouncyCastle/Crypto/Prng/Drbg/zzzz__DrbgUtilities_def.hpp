...
/// @brief Method GetMaxSecurityStrength addr 0xebf8ec size 0x184 virtual false final false
static int32_t GetMaxSecurityStrength(Org::BouncyCastle::Crypto::IDigest d) ;

/// @brief Method GetMaxSecurityStrength addr 0xebfa70 size 0x1cc virtual false final false
static int32_t GetMaxSecurityStrength(Org::BouncyCastle::Crypto::IMac m) ;

/// @brief Method HashDF addr 0xebfc3c size 0x514 virtual false final false
static ::ArrayW<uint8_t> HashDF(Org::BouncyCastle::Crypto::IDigest digest, ::ArrayW<uint8_t> seedMaterial, int32_t seedLength) ;

/// @brief Method IsTooLarge addr 0xebf064 size 0x14 virtual false final false
static bool IsTooLarge(::ArrayW<uint8_t> bytes, int32_t maxBytes) ;

// Ctor Parameters []
explicit DrbgUtilities() ;

/// @brief Method .ctor addr 0xec0150 size 0x8 virtual false final false
 void _ctor() ;
