...
/// @brief Method .ctor addr 0xec06e0 size 0x470 virtual false final false
...
/// @brief Method get_BlockSize addr 0xec0c68 size 0xac virtual true final true
 int32_t get_BlockSize() ;

/// @brief Method Generate addr 0xec0d14 size 0x354 virtual true final true
 int32_t Generate(::ArrayW<uint8_t> output, ::ArrayW<uint8_t> additionalInput, bool predictionResistant) ;

/// @brief Method GetEntropy addr 0xec0b50 size 0x118 virtual false final false
 ::ArrayW<uint8_t> GetEntropy() ;

/// @brief Method AddTo addr 0xec139c size 0xcc virtual false final false
 void AddTo(::ArrayW<uint8_t> longer, ::ArrayW<uint8_t> shorter) ;

/// @brief Method Reseed addr 0xec1068 size 0x244 virtual true final true
 void Reseed(::ArrayW<uint8_t> additionalInput) ;

/// @brief Method Hash addr 0xec12ac size 0xf0 virtual false final false
 ::ArrayW<uint8_t> Hash(::ArrayW<uint8_t> input) ;

/// @brief Method DoHash addr 0xec16a8 size 0x13c virtual false final false
 void DoHash(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output) ;

/// @brief Method hashgen addr 0xec1468 size 0x240 virtual false final false
