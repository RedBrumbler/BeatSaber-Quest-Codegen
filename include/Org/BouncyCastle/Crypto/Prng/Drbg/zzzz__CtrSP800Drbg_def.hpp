...
/// @brief Method .ctor addr 0xebd5ec size 0x254 virtual false final false
...
/// @brief Method CTR_DRBG_Instantiate_algorithm addr 0xebdb94 size 0x21c virtual false final false
 void CTR_DRBG_Instantiate_algorithm(::ArrayW<uint8_t> entropy, ::ArrayW<uint8_t> nonce, ::ArrayW<uint8_t> personalisationString) ;

/// @brief Method CTR_DRBG_Update addr 0xebe288 size 0x348 virtual false final false
 void CTR_DRBG_Update(::ArrayW<uint8_t> seed, ::ArrayW<uint8_t> key, ::ArrayW<uint8_t> v) ;

/// @brief Method CTR_DRBG_Reseed_algorithm addr 0xebe770 size 0xa4 virtual false final false
 void CTR_DRBG_Reseed_algorithm(::ArrayW<uint8_t> additionalInput) ;

/// @brief Method XOR addr 0xebe6dc size 0x94 virtual false final false
 void XOR(::ArrayW<uint8_t> output, ::ArrayW<uint8_t> a, ::ArrayW<uint8_t> b, int32_t bOff) ;

/// @brief Method AddOneTo addr 0xebe674 size 0x68 virtual false final false
 void AddOneTo(::ArrayW<uint8_t> longer) ;

/// @brief Method GetEntropy addr 0xebda7c size 0x118 virtual false final false
 ::ArrayW<uint8_t> GetEntropy() ;

/// @brief Method Block_Cipher_df addr 0xebddb0 size 0x4d8 virtual false final false
 ::ArrayW<uint8_t> Block_Cipher_df(::ArrayW<uint8_t> inputString, int32_t bitLength) ;

/// @brief Method BCC addr 0xebe894 size 0x30c virtual false final false
 void BCC(::ArrayW<uint8_t> bccOut, ::ArrayW<uint8_t> k, ::ArrayW<uint8_t> iV, ::ArrayW<uint8_t> data) ;

/// @brief Method copyIntToByteArray addr 0xebe814 size 0x80 virtual false final false
 void copyIntToByteArray(::ArrayW<uint8_t> buf, int32_t value, int32_t offSet) ;

/// @brief Method get_BlockSize addr 0xebeba0 size 0x20 virtual true final true
 int32_t get_BlockSize() ;

/// @brief Method Generate addr 0xebebc0 size 0x4a4 virtual true final true
 int32_t Generate(::ArrayW<uint8_t> output, ::ArrayW<uint8_t> additionalInput, bool predictionResistant) ;

/// @brief Method Reseed addr 0xebf078 size 0x4 virtual true final true
 void Reseed(::ArrayW<uint8_t> additionalInput) ;

/// @brief Method IsTdea addr 0xebd92c size 0x150 virtual false final false
 bool IsTdea(Org::BouncyCastle::Crypto::IBlockCipher cipher) ;

/// @brief Method GetMaxSecurityStrength addr 0xebd840 size 0xec virtual false final false
 int32_t GetMaxSecurityStrength(Org::BouncyCastle::Crypto::IBlockCipher cipher, int32_t keySizeInBits) ;

/// @brief Method ExpandKey addr 0xebe5d0 size 0xa4 virtual false final false
 ::ArrayW<uint8_t> ExpandKey(::ArrayW<uint8_t> key) ;

/// @brief Method PadKey addr 0xebf07c size 0x290 virtual false final false
