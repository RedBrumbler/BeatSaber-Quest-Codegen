...
/// @brief Method .ctor addr 0xec17e4 size 0x354 virtual false final false
...
/// @brief Method hmac_DRBG_Update addr 0xec1c50 size 0x40 virtual false final false
 void hmac_DRBG_Update(::ArrayW<uint8_t> seedMaterial) ;

/// @brief Method hmac_DRBG_Update_Func addr 0xec1c90 size 0x434 virtual false final false
 void hmac_DRBG_Update_Func(::ArrayW<uint8_t> seedMaterial, uint8_t vValue) ;

/// @brief Method get_BlockSize addr 0xec20c4 size 0x20 virtual true final true
 int32_t get_BlockSize() ;

/// @brief Method Generate addr 0xec20e4 size 0x510 virtual true final true
 int32_t Generate(::ArrayW<uint8_t> output, ::ArrayW<uint8_t> additionalInput, bool predictionResistant) ;

/// @brief Method Reseed addr 0xec25f4 size 0x90 virtual true final true
 void Reseed(::ArrayW<uint8_t> additionalInput) ;

/// @brief Method GetEntropy addr 0xec1b38 size 0x118 virtual false final false
