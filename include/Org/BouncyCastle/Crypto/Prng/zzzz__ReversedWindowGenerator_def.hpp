...
/// @brief Method .ctor addr 0xec35a4 size 0x114 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Prng::IRandomGenerator generator, int32_t windowSize) ;

/// @brief Method AddSeedMaterial addr 0xec36b8 size 0x134 virtual true final false
 void AddSeedMaterial(::ArrayW<uint8_t> seed) ;

/// @brief Method AddSeedMaterial addr 0xec37ec size 0x138 virtual true final false
 void AddSeedMaterial(int64_t seed) ;

/// @brief Method NextBytes addr 0xec3924 size 0x1c virtual true final false
 void NextBytes(::ArrayW<uint8_t> bytes) ;

/// @brief Method NextBytes addr 0xec3b60 size 0x4 virtual true final false
 void NextBytes(::ArrayW<uint8_t> bytes, int32_t start, int32_t len) ;

/// @brief Method doNextBytes addr 0xec3940 size 0x220 virtual false final false
