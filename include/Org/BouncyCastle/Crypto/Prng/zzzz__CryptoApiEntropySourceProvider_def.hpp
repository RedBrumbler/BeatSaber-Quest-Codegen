...
/// @brief Method .ctor addr 0xec29ec size 0x40 virtual false final false
 void _ctor(System::Security::Cryptography::RandomNumberGenerator rng, bool predictionResistant, int32_t entropySize) ;

/// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_IsPredictionResistant addr 0xec2a2c size 0x8 virtual true final true
 bool Org_BouncyCastle_Crypto_IEntropySource_get_IsPredictionResistant() ;

/// @brief Method Org.BouncyCastle.Crypto.IEntropySource.GetEntropy addr 0xec2a34 size 0x88 virtual true final true
 ::ArrayW<uint8_t> Org_BouncyCastle_Crypto_IEntropySource_GetEntropy() ;

/// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_EntropySize addr 0xec2abc size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0xec28c4 size 0x24 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xec28e8 size 0x84 virtual false final false
 void _ctor(System::Security::Cryptography::RandomNumberGenerator rng, bool isPredictionResistant) ;

/// @brief Method Get addr 0xec296c size 0x80 virtual true final true
