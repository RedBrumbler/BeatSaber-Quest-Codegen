...
/// @brief Method .ctor addr 0xec2788 size 0x40 virtual false final false
 void _ctor(Org::BouncyCastle::Security::SecureRandom secureRandom, bool predictionResistant, int32_t entropySize) ;

/// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_IsPredictionResistant addr 0xec27c8 size 0x8 virtual true final true
 bool Org_BouncyCastle_Crypto_IEntropySource_get_IsPredictionResistant() ;

/// @brief Method Org.BouncyCastle.Crypto.IEntropySource.GetEntropy addr 0xec27d0 size 0x70 virtual true final true
 ::ArrayW<uint8_t> Org_BouncyCastle_Crypto_IEntropySource_GetEntropy() ;

/// @brief Method Org.BouncyCastle.Crypto.IEntropySource.get_EntropySize addr 0xec28bc size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0xec26d8 size 0x30 virtual false final false
 void _ctor(Org::BouncyCastle::Security::SecureRandom secureRandom, bool isPredictionResistant) ;

/// @brief Method Get addr 0xec2708 size 0x80 virtual true final true
