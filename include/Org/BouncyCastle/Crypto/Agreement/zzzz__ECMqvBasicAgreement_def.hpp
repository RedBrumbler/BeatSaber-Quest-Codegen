...
/// @brief Method Init addr 0x119ca9c size 0xec virtual true final false
 void Init(Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetFieldSize addr 0x119cb88 size 0x58 virtual true final false
 int32_t GetFieldSize() ;

/// @brief Method CalculateAgreement addr 0x119cbe0 size 0x20c virtual true final false
 Org::BouncyCastle::Math::BigInteger CalculateAgreement(Org::BouncyCastle::Crypto::ICipherParameters pubKey) ;

/// @brief Method CalculateMqvAgreement addr 0x119cdec size 0x254 virtual false final false
...
/// @brief Method .ctor addr 0x119d040 size 0x8 virtual false final false
 void _ctor() ;
