...
/// @brief Method .ctor addr 0x11960ac size 0x120 virtual false final false
...
/// @brief Method get_ParticipantId addr 0x11977a0 size 0x8 virtual true final false
 ::StringW get_ParticipantId() ;

/// @brief Method get_A addr 0x11977a8 size 0x8 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_A() ;

/// @brief Method get_KnowledgeProofForX2s addr 0x11977b0 size 0x7c virtual true final false
