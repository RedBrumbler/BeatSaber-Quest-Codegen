...
/// @brief Method .ctor addr 0x1195620 size 0x19c virtual false final false
...
/// @brief Method get_ParticipantId addr 0x1197690 size 0x8 virtual true final false
 ::StringW get_ParticipantId() ;

/// @brief Method get_Gx1 addr 0x1197698 size 0x8 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_Gx1() ;

/// @brief Method get_Gx2 addr 0x11976a0 size 0x8 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_Gx2() ;

/// @brief Method get_KnowledgeProofForX1 addr 0x11976a8 size 0x7c virtual true final false
 ::ArrayW<Org::BouncyCastle::Math::BigInteger> get_KnowledgeProofForX1() ;

/// @brief Method get_KnowledgeProofForX2 addr 0x1197724 size 0x7c virtual true final false
