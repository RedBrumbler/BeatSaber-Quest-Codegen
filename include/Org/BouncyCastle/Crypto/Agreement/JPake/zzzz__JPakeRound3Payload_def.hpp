...
/// @brief Method .ctor addr 0x1196ca0 size 0x2c virtual false final false
 void _ctor(::StringW participantId, Org::BouncyCastle::Math::BigInteger magTag) ;

/// @brief Method get_ParticipantId addr 0x119782c size 0x8 virtual true final false
 ::StringW get_ParticipantId() ;

/// @brief Method get_MacTag addr 0x1197834 size 0x8 virtual true final false
