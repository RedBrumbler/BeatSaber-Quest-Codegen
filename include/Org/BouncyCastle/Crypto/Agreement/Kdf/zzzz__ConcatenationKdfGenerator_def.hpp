...
/// @brief Method .ctor addr 0x1198204 size 0xbc virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method Init addr 0x11982c0 size 0xcc virtual true final false
 void Init(Org::BouncyCastle::Crypto::IDerivationParameters param) ;

/// @brief Method get_Digest addr 0x119838c size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::IDigest get_Digest() ;

/// @brief Method GenerateBytes addr 0x1198394 size 0x5d8 virtual true final false
