...
/// @brief Method .ctor addr 0x119896c size 0x40 virtual false final false
...
/// @brief Method .ctor addr 0x11989ac size 0x44 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::DerObjectIdentifier algorithm, int32_t keySize, ::ArrayW<uint8_t> z, ::ArrayW<uint8_t> extraInfo) ;

/// @brief Method get_Algorithm addr 0x11989f0 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_Algorithm() ;

/// @brief Method get_KeySize addr 0x11989f8 size 0x8 virtual false final false
 int32_t get_KeySize() ;

/// @brief Method GetZ addr 0x1198a00 size 0x8 virtual false final false
 ::ArrayW<uint8_t> GetZ() ;

/// @brief Method GetExtraInfo addr 0x1198a08 size 0x8 virtual false final false
