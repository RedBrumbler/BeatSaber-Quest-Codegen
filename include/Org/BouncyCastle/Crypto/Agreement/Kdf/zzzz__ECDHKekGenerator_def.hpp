...
/// @brief Method .ctor addr 0x1199188 size 0x7c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method Init addr 0x1199204 size 0x98 virtual true final false
 void Init(Org::BouncyCastle::Crypto::IDerivationParameters param) ;

/// @brief Method get_Digest addr 0x119929c size 0xa4 virtual true final false
 Org::BouncyCastle::Crypto::IDigest get_Digest() ;

/// @brief Method GenerateBytes addr 0x1199340 size 0x318 virtual true final false
