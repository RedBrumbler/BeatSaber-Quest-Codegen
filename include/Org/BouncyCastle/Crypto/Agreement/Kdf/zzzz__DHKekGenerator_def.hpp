...
/// @brief Method .ctor addr 0x1198a10 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method Init addr 0x1198a38 size 0x98 virtual true final false
 void Init(Org::BouncyCastle::Crypto::IDerivationParameters param) ;

/// @brief Method get_Digest addr 0x1198ad0 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::IDigest get_Digest() ;

/// @brief Method GenerateBytes addr 0x1198ad8 size 0x6b0 virtual true final false
