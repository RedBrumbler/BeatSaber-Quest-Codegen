...
/// @brief Method .ctor addr 0x119a1fc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0x119a204 size 0x10 virtual true final false
...
/// @brief Method Init addr 0x119a214 size 0x30 virtual true final false
...
/// @brief Method GenerateServerCredentials addr 0x119a244 size 0xb0 virtual true final false
 Org::BouncyCastle::Math::BigInteger GenerateServerCredentials() ;

/// @brief Method CalculateSecret addr 0x119a2f4 size 0x44 virtual true final false
 Org::BouncyCastle::Math::BigInteger CalculateSecret(Org::BouncyCastle::Math::BigInteger clientA) ;

/// @brief Method SelectPrivateValue addr 0x119a394 size 0xc virtual true final false
 Org::BouncyCastle::Math::BigInteger SelectPrivateValue() ;

/// @brief Method CalculateS addr 0x119a338 size 0x5c virtual false final false
 Org::BouncyCastle::Math::BigInteger CalculateS() ;

/// @brief Method VerifyClientEvidenceMessage addr 0x119a3a0 size 0xb8 virtual true final false
 bool VerifyClientEvidenceMessage(Org::BouncyCastle::Math::BigInteger clientM1) ;

/// @brief Method CalculateServerEvidenceMessage addr 0x119a458 size 0x84 virtual true final false
 Org::BouncyCastle::Math::BigInteger CalculateServerEvidenceMessage() ;

/// @brief Method CalculateSessionKey addr 0x119a4dc size 0x84 virtual true final false
