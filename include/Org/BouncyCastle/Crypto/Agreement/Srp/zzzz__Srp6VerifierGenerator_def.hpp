...
/// @brief Method .ctor addr 0x119aef8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0x119af00 size 0xc virtual true final false
 void Init(Org::BouncyCastle::Math::BigInteger N, Org::BouncyCastle::Math::BigInteger g, Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method Init addr 0x119af0c size 0x28 virtual true final false
 void Init(Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters group, Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method GenerateVerifier addr 0x119af34 size 0x40 virtual true final false
