...
/// @brief Method .ctor addr 0x1199658 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0x1199660 size 0xc virtual true final false
...
/// @brief Method Init addr 0x119966c size 0x2c virtual true final false
...
/// @brief Method GenerateClientCredentials addr 0x1199698 size 0x60 virtual true final false
...
/// @brief Method CalculateSecret addr 0x1199b00 size 0x44 virtual true final false
 Org::BouncyCastle::Math::BigInteger CalculateSecret(Org::BouncyCastle::Math::BigInteger serverB) ;

/// @brief Method SelectPrivateValue addr 0x1199d00 size 0xc virtual true final false
 Org::BouncyCastle::Math::BigInteger SelectPrivateValue() ;

/// @brief Method CalculateS addr 0x1199c30 size 0xd0 virtual false final false
 Org::BouncyCastle::Math::BigInteger CalculateS() ;

/// @brief Method CalculateClientEvidenceMessage addr 0x1199e1c size 0x84 virtual true final false
 Org::BouncyCastle::Math::BigInteger CalculateClientEvidenceMessage() ;

/// @brief Method VerifyServerEvidenceMessage addr 0x1199ea4 size 0xb8 virtual true final false
 bool VerifyServerEvidenceMessage(Org::BouncyCastle::Math::BigInteger serverM2) ;

/// @brief Method CalculateSessionKey addr 0x1199f60 size 0x84 virtual true final false
