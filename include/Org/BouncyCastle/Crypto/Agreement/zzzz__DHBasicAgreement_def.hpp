...
/// @brief Method Init addr 0x119b560 size 0x13c virtual true final false
 void Init(Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetFieldSize addr 0x119b69c size 0x44 virtual true final false
 int32_t GetFieldSize() ;

/// @brief Method CalculateAgreement addr 0x119b6e0 size 0x27c virtual true final false
 Org::BouncyCastle::Math::BigInteger CalculateAgreement(Org::BouncyCastle::Crypto::ICipherParameters pubKey) ;

// Ctor Parameters []
explicit DHBasicAgreement() ;

/// @brief Method .ctor addr 0x119b95c size 0x8 virtual false final false
 void _ctor() ;
