...
/// @brief Method .ctor addr 0x119c750 size 0xa4 virtual false final false
 void _ctor(::StringW algorithm, Org::BouncyCastle::Crypto::IDerivationFunction kdf) ;

/// @brief Method CalculateAgreement addr 0x119c7f4 size 0x26c virtual true final false
 Org::BouncyCastle::Math::BigInteger CalculateAgreement(Org::BouncyCastle::Crypto::ICipherParameters pubKey) ;

/// @brief Method BigIntToBytes addr 0x119ca60 size 0x3c virtual false final false
