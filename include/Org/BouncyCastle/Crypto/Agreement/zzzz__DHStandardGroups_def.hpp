...
/// @brief Method FromHex addr 0x119b964 size 0xa0 virtual false final false
static Org::BouncyCastle::Math::BigInteger FromHex(::StringW hex) ;

/// @brief Method FromPG addr 0x119ba04 size 0xb4 virtual false final false
static Org::BouncyCastle::Crypto::Parameters::DHParameters FromPG(::StringW hexP, ::StringW hexG) ;

/// @brief Method SafePrimeGen2 addr 0x119bab8 size 0x58 virtual false final false
static Org::BouncyCastle::Crypto::Parameters::DHParameters SafePrimeGen2(::StringW hexP) ;

/// @brief Method SafePrimeGen2 addr 0x119bb10 size 0xd0 virtual false final false
static Org::BouncyCastle::Crypto::Parameters::DHParameters SafePrimeGen2(::StringW hexP, int32_t l) ;

// Ctor Parameters []
explicit DHStandardGroups() ;

/// @brief Method .ctor addr 0x119c074 size 0x8 virtual false final false
 void _ctor() ;
