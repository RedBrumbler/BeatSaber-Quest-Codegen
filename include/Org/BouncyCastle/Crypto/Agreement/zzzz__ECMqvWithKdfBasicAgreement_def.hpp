...
/// @brief Method .ctor addr 0x119d048 size 0xa4 virtual false final false
 void _ctor(::StringW algorithm, Org::BouncyCastle::Crypto::IDerivationFunction kdf) ;

/// @brief Method CalculateAgreement addr 0x119d0ec size 0x26c virtual true final false
 Org::BouncyCastle::Math::BigInteger CalculateAgreement(Org::BouncyCastle::Crypto::ICipherParameters pubKey) ;

/// @brief Method BigIntToBytes addr 0x119d358 size 0x4c virtual false final false
