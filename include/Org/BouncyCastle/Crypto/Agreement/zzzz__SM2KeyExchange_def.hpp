...
/// @brief Method .ctor addr 0x119d3a4 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x119d410 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method Init addr 0x119d438 size 0x1d4 virtual true final false
 void Init(Org::BouncyCastle::Crypto::ICipherParameters privParam) ;

/// @brief Method CalculateKey addr 0x119d60c size 0x1c4 virtual true final false
 ::ArrayW<uint8_t> CalculateKey(int32_t kLen, Org::BouncyCastle::Crypto::ICipherParameters pubParam) ;

/// @brief Method CalculateKeyWithConfirmation addr 0x119d930 size 0x4b0 virtual true final false
...
/// @brief Method S2 addr 0x119e164 size 0x174 virtual false final false
 ::ArrayW<uint8_t> S2(Org::BouncyCastle::Crypto::IDigest digest, Org::BouncyCastle::Math::EC::ECPoint u, ::ArrayW<uint8_t> inner) ;

/// @brief Method GetZ addr 0x119d7d0 size 0x160 virtual false final false
...
/// @brief Method AddUserID addr 0x119ec7c size 0x188 virtual false final false
 void AddUserID(Org::BouncyCastle::Crypto::IDigest digest, ::ArrayW<uint8_t> userID) ;

/// @brief Method AddFieldElement addr 0x119eba8 size 0xd4 virtual false final false
