...
/// @brief Method .ctor addr 0xeb201c size 0x28 virtual false final false
 void _ctor(bool privateKey) ;

/// @brief Method get_IsPrivate addr 0xeb2044 size 0x8 virtual false final false
 bool get_IsPrivate() ;

/// @brief Method Equals addr 0xeb204c size 0x98 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0xeb20e4 size 0x24 virtual false final false
 bool Equals(Org::BouncyCastle::Crypto::AsymmetricKeyParameter other) ;

/// @brief Method GetHashCode addr 0xeb2108 size 0x20 virtual true final false
 int32_t GetHashCode() ;
