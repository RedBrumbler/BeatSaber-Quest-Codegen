...
/// @brief Method .ctor addr 0xf4747c size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit CryptoException(::StringW message) ;

/// @brief Method .ctor addr 0xf474d4 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0xf4753c size 0x70 virtual false final false
