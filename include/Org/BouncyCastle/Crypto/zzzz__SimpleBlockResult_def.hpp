...
/// @brief Method .ctor addr 0xf47c20 size 0x28 virtual false final false
 void _ctor(::ArrayW<uint8_t> result) ;

/// @brief Method get_Length addr 0xf47c48 size 0x1c virtual false final false
 int32_t get_Length() ;

/// @brief Method Collect addr 0xf47c64 size 0x8 virtual true final true
 ::ArrayW<uint8_t> Collect() ;

/// @brief Method Collect addr 0xf47c6c size 0x40 virtual true final true
