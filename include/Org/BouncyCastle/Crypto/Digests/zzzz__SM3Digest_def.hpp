...
/// @brief Method .ctor addr 0xe2c774 size 0x8c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe2c800 size 0x94 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::SM3Digest t) ;

/// @brief Method CopyIn addr 0xe2c894 size 0x6c virtual false final false
 void CopyIn(Org::BouncyCastle::Crypto::Digests::SM3Digest t) ;

/// @brief Method get_AlgorithmName addr 0xe2c900 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0xe2c940 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method Copy addr 0xe2c948 size 0x60 virtual true final false
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0xe2c9a8 size 0x94 virtual true final false
 void Reset(Org::BouncyCastle::Utilities::IMemoable other) ;

/// @brief Method Reset addr 0xe2ca3c size 0xcc virtual true final false
 void Reset() ;

/// @brief Method DoFinal addr 0xe2cb08 size 0x54 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method ProcessWord addr 0xe2cb5c size 0x74 virtual true final false
 void ProcessWord(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method ProcessLength addr 0xe2cbd0 size 0xf8 virtual true final false
 void ProcessLength(int64_t bitLength) ;

/// @brief Method P0 addr 0xe2ccc8 size 0xc virtual false final false
 uint32_t P0(uint32_t x) ;

/// @brief Method P1 addr 0xe2ccd4 size 0xc virtual false final false
 uint32_t P1(uint32_t x) ;

/// @brief Method FF0 addr 0xe2cce0 size 0xc virtual false final false
 uint32_t FF0(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method FF1 addr 0xe2ccec size 0x14 virtual false final false
 uint32_t FF1(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method GG0 addr 0xe2cd00 size 0xc virtual false final false
 uint32_t GG0(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method GG1 addr 0xe2cd0c size 0x10 virtual false final false
 uint32_t GG1(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method ProcessBlock addr 0xe2cd1c size 0x414 virtual true final false
 void ProcessBlock() ;
