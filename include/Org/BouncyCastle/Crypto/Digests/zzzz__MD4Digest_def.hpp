...
/// @brief Method .ctor addr 0x11a9834 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11a98a0 size 0x74 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::MD4Digest t) ;

/// @brief Method CopyIn addr 0x11a9914 size 0x5c virtual false final false
 void CopyIn(Org::BouncyCastle::Crypto::Digests::MD4Digest t) ;

/// @brief Method get_AlgorithmName addr 0x11a9970 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0x11a99b0 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method ProcessWord addr 0x11a99b8 size 0xbc virtual true final false
 void ProcessWord(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method ProcessLength addr 0x11a9a74 size 0x6c virtual true final false
 void ProcessLength(int64_t bitLength) ;

/// @brief Method UnpackWord addr 0x11a9ae0 size 0x80 virtual false final false
 void UnpackWord(int32_t word, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method DoFinal addr 0x11a9b60 size 0x80 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0x11a9be0 size 0x60 virtual true final false
 void Reset() ;

/// @brief Method RotateLeft addr 0x11a9c40 size 0xc virtual false final false
 int32_t RotateLeft(int32_t x, int32_t n) ;

/// @brief Method F addr 0x11a9c4c size 0x10 virtual false final false
 int32_t F(int32_t u, int32_t v, int32_t w) ;

/// @brief Method G addr 0x11a9c5c size 0x14 virtual false final false
 int32_t G(int32_t u, int32_t v, int32_t w) ;

/// @brief Method H addr 0x11a9c70 size 0xc virtual false final false
 int32_t H(int32_t u, int32_t v, int32_t w) ;

/// @brief Method ProcessBlock addr 0x11a9c7c size 0x648 virtual true final false
 void ProcessBlock() ;

/// @brief Method Copy addr 0x11aa2c4 size 0x60 virtual true final false
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0x11aa324 size 0x84 virtual true final false
