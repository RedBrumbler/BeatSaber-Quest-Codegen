...
/// @brief Method .ctor addr 0x11ab450 size 0x78 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest baseDigest) ;

/// @brief Method get_AlgorithmName addr 0x11ab4c8 size 0xa0 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0x11ab568 size 0xa4 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method Update addr 0x11ab60c size 0xac virtual true final false
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0x11ab6b8 size 0xc4 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len) ;

/// @brief Method DoFinal addr 0x11ab77c size 0xbc virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0x11ab838 size 0xa4 virtual true final false
 void Reset() ;

/// @brief Method GetByteLength addr 0x11ab8dc size 0xa4 virtual true final false
