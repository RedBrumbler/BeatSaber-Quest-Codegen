...
/// @brief Method .ctor addr 0x11a8340 size 0xa0 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11a83e0 size 0xac virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::LongDigest t) ;

/// @brief Method CopyIn addr 0x11a848c size 0x9c virtual false final false
 void CopyIn(Org::BouncyCastle::Crypto::Digests::LongDigest t) ;

/// @brief Method Update addr 0x11a8528 size 0x74 virtual true final true
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0x11a8610 size 0x110 virtual true final true
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method Finish addr 0x11a8720 size 0x6c virtual false final false
 void Finish() ;

/// @brief Method Reset addr 0x11a8d9c size 0x6c virtual true final false
 void Reset() ;

/// @brief Method ProcessWord addr 0x11a859c size 0x74 virtual false final false
 void ProcessWord(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method AdjustByteCounts addr 0x11a878c size 0x24 virtual false final false
 void AdjustByteCounts() ;

/// @brief Method ProcessLength addr 0x11a87b0 size 0x60 virtual false final false
 void ProcessLength(int64_t lowW, int64_t hiW) ;

/// @brief Method ProcessBlock addr 0x11a8810 size 0x58c virtual false final false
 void ProcessBlock() ;

/// @brief Method Ch addr 0x11a8e38 size 0x10 virtual false final false
static uint64_t Ch(uint64_t x, uint64_t y, uint64_t z) ;

/// @brief Method Maj addr 0x11a8e58 size 0x14 virtual false final false
static uint64_t Maj(uint64_t x, uint64_t y, uint64_t z) ;

/// @brief Method Sum0 addr 0x11a8e48 size 0x10 virtual false final false
static uint64_t Sum0(uint64_t x) ;

/// @brief Method Sum1 addr 0x11a8e28 size 0x10 virtual false final false
static uint64_t Sum1(uint64_t x) ;

/// @brief Method Sigma0 addr 0x11a8e18 size 0x10 virtual false final false
static uint64_t Sigma0(uint64_t x) ;

/// @brief Method Sigma1 addr 0x11a8e08 size 0x10 virtual false final false
static uint64_t Sigma1(uint64_t x) ;

/// @brief Method GetByteLength addr 0x11a8e6c size 0x8 virtual true final true
