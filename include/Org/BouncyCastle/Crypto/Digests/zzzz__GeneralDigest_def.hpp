...
/// @brief Method .ctor addr 0x11a3144 size 0x5c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11a31a0 size 0x78 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::GeneralDigest t) ;

/// @brief Method CopyIn addr 0x11a3218 size 0x54 virtual false final false
 void CopyIn(Org::BouncyCastle::Crypto::Digests::GeneralDigest t) ;

/// @brief Method Update addr 0x11a326c size 0x80 virtual true final true
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0x11a32ec size 0x1c0 virtual true final true
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method Finish addr 0x11a34ac size 0x64 virtual false final false
 void Finish() ;

/// @brief Method Reset addr 0x11a3510 size 0x30 virtual true final false
 void Reset() ;

/// @brief Method GetByteLength addr 0x11a3540 size 0x8 virtual true final true
