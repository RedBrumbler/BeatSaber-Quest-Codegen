...
/// @brief Method .ctor addr 0xe2e7f4 size 0x2b0 virtual false final false
 void _ctor() ;

/// @brief Method packIntoLong addr 0xe2e7c0 size 0x34 virtual false final false
static int64_t packIntoLong(int32_t b7, int32_t b6, int32_t b5, int32_t b4, int32_t b3, int32_t b2, int32_t b1, int32_t b0) ;

/// @brief Method maskWithReductionPolynomial addr 0xe2e7ac size 0x14 virtual false final false
...
/// @brief Method .ctor addr 0xe2eaa4 size 0x110 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::WhirlpoolDigest originalDigest) ;

/// @brief Method get_AlgorithmName addr 0xe2ed1c size 0x40 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0xe2ed5c size 0x8 virtual true final true
 int32_t GetDigestSize() ;

/// @brief Method DoFinal addr 0xe2ed64 size 0xc4 virtual true final true
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe2ef54 size 0xbc virtual true final true
 void Reset() ;

/// @brief Method processFilledBuffer addr 0xe2f010 size 0xe0 virtual false final false
 void processFilledBuffer() ;

/// @brief Method bytesToLongFromBuffer addr 0xe2f0f0 size 0xd4 virtual false final false
static int64_t bytesToLongFromBuffer(::ArrayW<uint8_t> buffer, int32_t startPos) ;

/// @brief Method convertLongToByteArray addr 0xe2eefc size 0x58 virtual false final false
static void convertLongToByteArray(int64_t inputLong, ::ArrayW<uint8_t> outputArray, int32_t offSet) ;

/// @brief Method processBlock addr 0xe2f1c4 size 0x6b0 virtual false final false
 void processBlock() ;

/// @brief Method Update addr 0xe2f874 size 0x64 virtual true final true
 void Update(uint8_t input) ;

/// @brief Method increment addr 0xe2f8d8 size 0xf4 virtual false final false
 void increment() ;

/// @brief Method BlockUpdate addr 0xe2f9cc size 0x6c virtual true final true
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method finish addr 0xe2ee28 size 0xd4 virtual false final false
 void finish() ;

/// @brief Method copyBitLength addr 0xe2fa38 size 0xa8 virtual false final false
 ::ArrayW<uint8_t> copyBitLength() ;

/// @brief Method GetByteLength addr 0xe2fae0 size 0x8 virtual true final true
 int32_t GetByteLength() ;

/// @brief Method Copy addr 0xe2fae8 size 0x60 virtual true final true
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0xe2ebb4 size 0x168 virtual true final true
