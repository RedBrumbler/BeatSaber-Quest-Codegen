...
/// @brief Method get_AlgorithmName addr 0xe22b70 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0xe22bb0 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

// Ctor Parameters []
explicit RipeMD256Digest() ;

/// @brief Method .ctor addr 0xe22bb8 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe22c24 size 0x74 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::RipeMD256Digest t) ;

/// @brief Method CopyIn addr 0xe22c98 size 0x64 virtual false final false
 void CopyIn(Org::BouncyCastle::Crypto::Digests::RipeMD256Digest t) ;

/// @brief Method ProcessWord addr 0xe22cfc size 0xbc virtual true final false
 void ProcessWord(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method ProcessLength addr 0xe22db8 size 0x6c virtual true final false
 void ProcessLength(int64_t bitLength) ;

/// @brief Method UnpackWord addr 0xe22e24 size 0x80 virtual false final false
 void UnpackWord(int32_t word, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method DoFinal addr 0xe22ea4 size 0xc0 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe22f64 size 0x6c virtual true final false
 void Reset() ;

/// @brief Method RL addr 0xe22fd0 size 0xc virtual false final false
 int32_t RL(int32_t x, int32_t n) ;

/// @brief Method F1 addr 0xe22fdc size 0xc virtual false final false
 int32_t F1(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F2 addr 0xe22fe8 size 0x10 virtual false final false
 int32_t F2(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F3 addr 0xe22ff8 size 0xc virtual false final false
 int32_t F3(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F4 addr 0xe23004 size 0x10 virtual false final false
 int32_t F4(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F1 addr 0xe23014 size 0x1c virtual false final false
 int32_t F1(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method F2 addr 0xe23030 size 0x2c virtual false final false
 int32_t F2(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method F3 addr 0xe2305c size 0x28 virtual false final false
 int32_t F3(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method F4 addr 0xe23084 size 0x2c virtual false final false
 int32_t F4(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method FF1 addr 0xe230b0 size 0x1c virtual false final false
 int32_t FF1(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method FF2 addr 0xe230cc size 0x2c virtual false final false
 int32_t FF2(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method FF3 addr 0xe230f8 size 0x28 virtual false final false
 int32_t FF3(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method FF4 addr 0xe23120 size 0x2c virtual false final false
 int32_t FF4(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method ProcessBlock addr 0xe2314c size 0xf60 virtual true final false
 void ProcessBlock() ;

/// @brief Method Copy addr 0xe240ac size 0x60 virtual true final false
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0xe2410c size 0x84 virtual true final false
