...
/// @brief Method MakeC addr 0x11a3548 size 0xd0 virtual false final false
static ::ArrayW<::ArrayW<uint8_t>> MakeC() ;

// Ctor Parameters []
explicit Gost3411Digest() ;

/// @brief Method .ctor addr 0x11a3618 size 0x290 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11a3a08 size 0x294 virtual false final false
...
/// @brief Method .ctor addr 0x11a3c9c size 0x1a4 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::Gost3411Digest t) ;

/// @brief Method get_AlgorithmName addr 0x11a4118 size 0x40 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0x11a4158 size 0x8 virtual true final true
 int32_t GetDigestSize() ;

/// @brief Method Update addr 0x11a4160 size 0x80 virtual true final true
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0x11a457c size 0x130 virtual true final true
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method P addr 0x11a46ac size 0x110 virtual false final false
 ::ArrayW<uint8_t> P(::ArrayW<uint8_t> input) ;

/// @brief Method A addr 0x11a47bc size 0xc0 virtual false final false
 ::ArrayW<uint8_t> A(::ArrayW<uint8_t> input) ;

/// @brief Method E addr 0x11a487c size 0x17c virtual false final false
 void E(::ArrayW<uint8_t> key, ::ArrayW<uint8_t> s, int32_t sOff, ::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method fw addr 0x11a49f8 size 0x10c virtual false final false
 void fw(::ArrayW<uint8_t> input) ;

/// @brief Method processBlock addr 0x11a4258 size 0x324 virtual false final false
 void processBlock(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method finish addr 0x11a4c2c size 0x58 virtual false final false
 void finish() ;

/// @brief Method DoFinal addr 0x11a4c84 size 0x4c virtual true final true
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0x11a38a8 size 0x160 virtual true final true
 void Reset() ;

/// @brief Method sumByteArray addr 0x11a41e0 size 0x78 virtual false final false
 void sumByteArray(::ArrayW<uint8_t> input) ;

/// @brief Method cpyBytesToShort addr 0x11a4b04 size 0x8c virtual false final false
static void cpyBytesToShort(::ArrayW<uint8_t> S, ::ArrayW<int16_t> wS) ;

/// @brief Method cpyShortToBytes addr 0x11a4b90 size 0x9c virtual false final false
static void cpyShortToBytes(::ArrayW<int16_t> wS, ::ArrayW<uint8_t> S) ;

/// @brief Method GetByteLength addr 0x11a4cd0 size 0x8 virtual true final true
 int32_t GetByteLength() ;

/// @brief Method Copy addr 0x11a4cd8 size 0x60 virtual true final true
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0x11a3e40 size 0x2d8 virtual true final true
