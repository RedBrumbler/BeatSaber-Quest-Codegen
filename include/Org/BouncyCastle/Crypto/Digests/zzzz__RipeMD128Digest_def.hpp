...
/// @brief Method .ctor addr 0x11abb88 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11abbf4 size 0x74 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::RipeMD128Digest t) ;

/// @brief Method CopyIn addr 0x11abc68 size 0x5c virtual false final false
 void CopyIn(Org::BouncyCastle::Crypto::Digests::RipeMD128Digest t) ;

/// @brief Method get_AlgorithmName addr 0x11abcc4 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0x11abd04 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method ProcessWord addr 0x11abd0c size 0xbc virtual true final false
 void ProcessWord(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method ProcessLength addr 0x11abdc8 size 0x6c virtual true final false
 void ProcessLength(int64_t bitLength) ;

/// @brief Method UnpackWord addr 0x11abe34 size 0x80 virtual false final false
 void UnpackWord(int32_t word, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method DoFinal addr 0x11abeb4 size 0x80 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0x11abf34 size 0x60 virtual true final false
 void Reset() ;

/// @brief Method RL addr 0x11abf94 size 0xc virtual false final false
 int32_t RL(int32_t x, int32_t n) ;

/// @brief Method F1 addr 0x11abfa0 size 0xc virtual false final false
 int32_t F1(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F2 addr 0x11abfac size 0x10 virtual false final false
 int32_t F2(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F3 addr 0x11abfbc size 0xc virtual false final false
 int32_t F3(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F4 addr 0x11abfc8 size 0x10 virtual false final false
 int32_t F4(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F1 addr 0x11abfd8 size 0x1c virtual false final false
 int32_t F1(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method F2 addr 0x11abff4 size 0x2c virtual false final false
 int32_t F2(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method F3 addr 0x11ac020 size 0x28 virtual false final false
 int32_t F3(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method F4 addr 0x11ac048 size 0x2c virtual false final false
 int32_t F4(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method FF1 addr 0x11ac074 size 0x1c virtual false final false
 int32_t FF1(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method FF2 addr 0x11ac090 size 0x2c virtual false final false
 int32_t FF2(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method FF3 addr 0x11ac0bc size 0x28 virtual false final false
 int32_t FF3(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method FF4 addr 0x11ac0e4 size 0x2c virtual false final false
 int32_t FF4(int32_t a, int32_t b, int32_t c, int32_t d, int32_t x, int32_t s) ;

/// @brief Method ProcessBlock addr 0x11ac110 size 0xedc virtual true final false
 void ProcessBlock() ;

/// @brief Method Copy addr 0x11acfec size 0x60 virtual true final false
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0x11ad04c size 0x84 virtual true final false
