...
/// @brief Method .ctor addr 0xe288d0 size 0x168 virtual false final false
...
/// @brief Method .ctor addr 0xe28bc0 size 0x90 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::Sha512tDigest t) ;

/// @brief Method get_AlgorithmName addr 0xe28c50 size 0x88 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0xe28cd8 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method DoFinal addr 0xe28ce0 size 0xfc virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe28e40 size 0x38 virtual true final false
 void Reset() ;

/// @brief Method tIvGenerate addr 0xe28a38 size 0x188 virtual false final false
 void tIvGenerate(int32_t bitLength) ;

/// @brief Method UInt64_To_BE addr 0xe28ddc size 0x64 virtual false final false
static void UInt64_To_BE(uint64_t n, ::ArrayW<uint8_t> bs, int32_t off, int32_t max) ;

/// @brief Method UInt32_To_BE addr 0xe28e78 size 0xc0 virtual false final false
static void UInt32_To_BE(uint32_t n, ::ArrayW<uint8_t> bs, int32_t off, int32_t max) ;

/// @brief Method Copy addr 0xe28f38 size 0x60 virtual true final false
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0xe28f98 size 0x10c virtual true final false
