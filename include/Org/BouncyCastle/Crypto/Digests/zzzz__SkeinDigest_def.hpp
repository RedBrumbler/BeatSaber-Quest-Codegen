...
/// @brief Method .ctor addr 0xe29d0c size 0x88 virtual false final false
...
/// @brief Method .ctor addr 0xe29f3c size 0x78 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::SkeinDigest digest) ;

/// @brief Method Reset addr 0xe2a00c size 0x8c virtual true final true
 void Reset(Org::BouncyCastle::Utilities::IMemoable other) ;

/// @brief Method Copy addr 0xe2a1bc size 0x60 virtual true final true
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method get_AlgorithmName addr 0xe2a21c size 0x1c4 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0xe2a404 size 0x1c virtual true final true
 int32_t GetDigestSize() ;

/// @brief Method GetByteLength addr 0xe2a420 size 0x2c virtual true final true
 int32_t GetByteLength() ;

/// @brief Method Init addr 0xe29f24 size 0x18 virtual false final false
 void Init(Org::BouncyCastle::Crypto::Parameters::SkeinParameters parameters) ;

/// @brief Method Reset addr 0xe2a504 size 0x18 virtual true final true
 void Reset() ;

/// @brief Method Update addr 0xe2a55c size 0x18 virtual true final true
 void Update(uint8_t inByte) ;

/// @brief Method BlockUpdate addr 0xe2a5a8 size 0x18 virtual true final true
 void BlockUpdate(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len) ;

/// @brief Method DoFinal addr 0xe2a60c size 0x18 virtual true final true
