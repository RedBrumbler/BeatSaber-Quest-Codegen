...
/// @brief Method .ctor addr 0x11a1d40 size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::Dstu7564Digest digest) ;

/// @brief Method CopyIn addr 0x11a1d6c size 0x130 virtual false final false
...
/// @brief Method .ctor addr 0x11a1e9c size 0x14c virtual false final false
 void _ctor(int32_t hashSizeBits) ;

/// @brief Method get_AlgorithmName addr 0x11a1fe8 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0x11a2028 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method GetByteLength addr 0x11a2030 size 0x8 virtual true final false
 int32_t GetByteLength() ;

/// @brief Method Update addr 0x11a2038 size 0x7c virtual true final false
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0x11a20b4 size 0x128 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method DoFinal addr 0x11a21dc size 0x260 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0x11a24f0 size 0x50 virtual true final false
 void Reset() ;

/// @brief Method ProcessBlock addr 0x11a2540 size 0x150 virtual true final false
 void ProcessBlock(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method P addr 0x11a243c size 0xb4 virtual false final false
 void P(::ArrayW<uint64_t> s) ;

/// @brief Method Q addr 0x11a2690 size 0xd0 virtual false final false
 void Q(::ArrayW<uint64_t> s) ;

/// @brief Method MixColumn addr 0x11a2e44 size 0xb8 virtual false final false
static uint64_t MixColumn(uint64_t c) ;

/// @brief Method MixColumns addr 0x11a2d88 size 0xbc virtual false final false
 void MixColumns(::ArrayW<uint64_t> s) ;

/// @brief Method Rotate addr 0x11a2efc size 0x8 virtual false final false
static uint64_t Rotate(int32_t n, uint64_t x) ;

/// @brief Method ShiftRows addr 0x11a2760 size 0x480 virtual false final false
 void ShiftRows(::ArrayW<uint64_t> s) ;

/// @brief Method SubBytes addr 0x11a2be0 size 0x1a8 virtual false final false
 void SubBytes(::ArrayW<uint64_t> s) ;

/// @brief Method Copy addr 0x11a2f04 size 0x6c virtual true final false
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0x11a2f70 size 0x84 virtual true final false
