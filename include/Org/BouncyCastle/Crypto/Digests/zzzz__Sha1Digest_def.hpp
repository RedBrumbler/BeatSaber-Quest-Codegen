...
/// @brief Method .ctor addr 0xe25f74 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe25fe0 size 0x74 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::Sha1Digest t) ;

/// @brief Method CopyIn addr 0xe26054 size 0x64 virtual false final false
 void CopyIn(Org::BouncyCastle::Crypto::Digests::Sha1Digest t) ;

/// @brief Method get_AlgorithmName addr 0xe260b8 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0xe260f8 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method ProcessWord addr 0xe26100 size 0x80 virtual true final false
 void ProcessWord(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method ProcessLength addr 0xe26180 size 0x6c virtual true final false
 void ProcessLength(int64_t bitLength) ;

/// @brief Method DoFinal addr 0xe261ec size 0xa4 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe26290 size 0x4c virtual true final false
 void Reset() ;

/// @brief Method F addr 0xe262dc size 0x10 virtual false final false
static uint32_t F(uint32_t u, uint32_t v, uint32_t w) ;

/// @brief Method H addr 0xe262ec size 0xc virtual false final false
static uint32_t H(uint32_t u, uint32_t v, uint32_t w) ;

/// @brief Method G addr 0xe262f8 size 0x14 virtual false final false
static uint32_t G(uint32_t u, uint32_t v, uint32_t w) ;

/// @brief Method ProcessBlock addr 0xe2630c size 0x53c virtual true final false
 void ProcessBlock() ;

/// @brief Method Copy addr 0xe26848 size 0x60 virtual true final false
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0xe268a8 size 0x84 virtual true final false
