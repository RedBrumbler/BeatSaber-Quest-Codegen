...
/// @brief Method .ctor addr 0x11ad0d0 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11ad13c size 0x74 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::RipeMD160Digest t) ;

/// @brief Method CopyIn addr 0x11ad1b0 size 0x64 virtual false final false
 void CopyIn(Org::BouncyCastle::Crypto::Digests::RipeMD160Digest t) ;

/// @brief Method get_AlgorithmName addr 0x11ad214 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0x11ad254 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method ProcessWord addr 0x11ad25c size 0xbc virtual true final false
 void ProcessWord(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method ProcessLength addr 0x11ad318 size 0x6c virtual true final false
 void ProcessLength(int64_t bitLength) ;

/// @brief Method UnpackWord addr 0x11ad384 size 0x80 virtual false final false
 void UnpackWord(int32_t word, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method DoFinal addr 0x11ad404 size 0x90 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0x11ad494 size 0x6c virtual true final false
 void Reset() ;

/// @brief Method RL addr 0x11ad500 size 0xc virtual false final false
 int32_t RL(int32_t x, int32_t n) ;

/// @brief Method F1 addr 0x11ad50c size 0xc virtual false final false
 int32_t F1(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F2 addr 0x11ad518 size 0x10 virtual false final false
 int32_t F2(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F3 addr 0x11ad528 size 0xc virtual false final false
 int32_t F3(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F4 addr 0x11ad534 size 0x10 virtual false final false
 int32_t F4(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F5 addr 0x11ad544 size 0xc virtual false final false
 int32_t F5(int32_t x, int32_t y, int32_t z) ;

/// @brief Method ProcessBlock addr 0x11ad550 size 0x1780 virtual true final false
 void ProcessBlock() ;

/// @brief Method Copy addr 0x11aecd0 size 0x60 virtual true final false
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0x11aed30 size 0x1084 virtual true final false
