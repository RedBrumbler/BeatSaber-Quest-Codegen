...
/// @brief Method .ctor addr 0x11a07dc size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11a08fc size 0x110 virtual false final false
...
/// @brief Method .ctor addr 0x11a07e4 size 0x118 virtual false final false
...
/// @brief Method .ctor addr 0x11a0c9c size 0x160 virtual false final false
...
/// @brief Method .ctor addr 0x11a0dfc size 0x264 virtual false final false
 void _ctor(::ArrayW<uint8_t> key, int32_t digestBytes, ::ArrayW<uint8_t> salt, ::ArrayW<uint8_t> personalization) ;

/// @brief Method Init addr 0x11a0a0c size 0x290 virtual false final false
 void Init() ;

/// @brief Method InitializeInternalState addr 0x11a1060 size 0x13c virtual false final false
 void InitializeInternalState() ;

/// @brief Method Update addr 0x11a119c size 0xb8 virtual true final false
 void Update(uint8_t b) ;

/// @brief Method BlockUpdate addr 0x11a17e0 size 0x140 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> message, int32_t offset, int32_t len) ;

/// @brief Method DoFinal addr 0x11a1920 size 0x130 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOffset) ;

/// @brief Method Reset addr 0x11a1a50 size 0x64 virtual true final false
 void Reset() ;

/// @brief Method Compress addr 0x11a1254 size 0x58c virtual false final false
 void Compress(::ArrayW<uint8_t> message, int32_t messagePos) ;

/// @brief Method G addr 0x11a1ab4 size 0xcc virtual false final false
 void G(uint32_t m1, uint32_t m2, int32_t posA, int32_t posB, int32_t posC, int32_t posD) ;

/// @brief Method rotr32 addr 0x11a1b80 size 0x8 virtual false final false
 uint32_t rotr32(uint32_t x, int32_t rot) ;

/// @brief Method get_AlgorithmName addr 0x11a1b88 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0x11a1bc8 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method GetByteLength addr 0x11a1bd0 size 0x8 virtual true final false
 int32_t GetByteLength() ;

/// @brief Method ClearKey addr 0x11a1bd8 size 0x48 virtual true final false
 void ClearKey() ;

/// @brief Method ClearSalt addr 0x11a1c20 size 0x1c virtual true final false
 void ClearSalt() ;
