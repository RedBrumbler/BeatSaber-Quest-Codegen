...
/// @brief Method get_AlgorithmName addr 0xe24190 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0xe241d0 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

// Ctor Parameters []
explicit RipeMD320Digest() ;

/// @brief Method .ctor addr 0xe241d8 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe24244 size 0x74 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::RipeMD320Digest t) ;

/// @brief Method CopyIn addr 0xe242b8 size 0x74 virtual false final false
 void CopyIn(Org::BouncyCastle::Crypto::Digests::RipeMD320Digest t) ;

/// @brief Method ProcessWord addr 0xe2432c size 0xbc virtual true final false
 void ProcessWord(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method ProcessLength addr 0xe243e8 size 0x6c virtual true final false
 void ProcessLength(int64_t bitLength) ;

/// @brief Method UnpackWord addr 0xe24454 size 0x80 virtual false final false
 void UnpackWord(int32_t word, ::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method DoFinal addr 0xe244d4 size 0xe0 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe245b4 size 0x80 virtual true final false
 void Reset() ;

/// @brief Method RL addr 0xe24634 size 0xc virtual false final false
 int32_t RL(int32_t x, int32_t n) ;

/// @brief Method F1 addr 0xe24640 size 0xc virtual false final false
 int32_t F1(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F2 addr 0xe2464c size 0x10 virtual false final false
 int32_t F2(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F3 addr 0xe2465c size 0xc virtual false final false
 int32_t F3(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F4 addr 0xe24668 size 0x10 virtual false final false
 int32_t F4(int32_t x, int32_t y, int32_t z) ;

/// @brief Method F5 addr 0xe24678 size 0xc virtual false final false
 int32_t F5(int32_t x, int32_t y, int32_t z) ;

/// @brief Method ProcessBlock addr 0xe24684 size 0x180c virtual true final false
 void ProcessBlock() ;

/// @brief Method Copy addr 0xe25e90 size 0x60 virtual true final false
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0xe25ef0 size 0x84 virtual true final false
