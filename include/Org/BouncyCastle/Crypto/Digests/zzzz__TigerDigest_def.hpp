...
/// @brief Method .ctor addr 0xe2d130 size 0x8c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe2d260 size 0x94 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::TigerDigest t) ;

/// @brief Method get_AlgorithmName addr 0xe2d3dc size 0x40 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0xe2d41c size 0x8 virtual true final true
 int32_t GetDigestSize() ;

/// @brief Method GetByteLength addr 0xe2d424 size 0x8 virtual true final true
 int32_t GetByteLength() ;

/// @brief Method ProcessWord addr 0xe2d42c size 0x11c virtual false final false
 void ProcessWord(::ArrayW<uint8_t> b, int32_t off) ;

/// @brief Method Update addr 0xe2d92c size 0x70 virtual true final true
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0xe2d99c size 0x110 virtual true final true
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method RoundABC addr 0xe2daac size 0x184 virtual false final false
 void RoundABC(int64_t x, int64_t mul) ;

/// @brief Method RoundBCA addr 0xe2dc30 size 0x180 virtual false final false
 void RoundBCA(int64_t x, int64_t mul) ;

/// @brief Method RoundCAB addr 0xe2ddb0 size 0x180 virtual false final false
 void RoundCAB(int64_t x, int64_t mul) ;

/// @brief Method KeySchedule addr 0xe2df30 size 0xdc virtual false final false
 void KeySchedule() ;

/// @brief Method ProcessBlock addr 0xe2d548 size 0x3e4 virtual false final false
 void ProcessBlock() ;

/// @brief Method UnpackWord addr 0xe2e00c size 0xf0 virtual false final false
 void UnpackWord(int64_t r, ::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method ProcessLength addr 0xe2e0fc size 0x2c virtual false final false
 void ProcessLength(int64_t bitLength) ;

/// @brief Method Finish addr 0xe2e128 size 0x4c virtual false final false
 void Finish() ;

/// @brief Method DoFinal addr 0xe2e174 size 0x60 virtual true final true
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe2d1bc size 0xa4 virtual true final true
 void Reset() ;

/// @brief Method Copy addr 0xe2e1d4 size 0x60 virtual true final true
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0xe2d2f4 size 0xe8 virtual true final true
