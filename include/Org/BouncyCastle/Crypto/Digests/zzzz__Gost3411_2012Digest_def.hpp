...
/// @brief Method .ctor addr 0x11a4dcc size 0x104 virtual false final false
...
/// @brief Method DoFinal addr 0x11a4ed0 size 0x178 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method GetByteLength addr 0x11a52bc size 0x8 virtual true final true
...
/// @brief Method Reset addr 0x11a5218 size 0xa4 virtual true final true
 void Reset() ;

/// @brief Method Reset addr 0x11a52c4 size 0x14c virtual true final true
 void Reset(Org::BouncyCastle::Utilities::IMemoable other) ;

/// @brief Method Update addr 0x11a5410 size 0x7c virtual true final true
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0x11a548c size 0x140 virtual true final true
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len) ;

/// @brief Method F addr 0x11a55cc size 0xb54 virtual false final false
 void F(::ArrayW<uint8_t> V) ;

/// @brief Method xor512 addr 0x11a6120 size 0x5c virtual false final false
 void xor512(::ArrayW<uint8_t> A, ::ArrayW<uint8_t> B) ;

/// @brief Method E addr 0x11a617c size 0x11c virtual false final false
 void E(::ArrayW<uint8_t> K, ::ArrayW<uint8_t> m) ;

/// @brief Method g_N addr 0x11a5048 size 0x80 virtual false final false
 void g_N(::ArrayW<uint8_t> h, ::ArrayW<uint8_t> N, ::ArrayW<uint8_t> m) ;

/// @brief Method addMod512 addr 0x11a50c8 size 0x80 virtual false final false
 void addMod512(::ArrayW<uint8_t> A, int32_t num) ;

/// @brief Method addMod512 addr 0x11a5148 size 0x60 virtual false final false
 void addMod512(::ArrayW<uint8_t> A, ::ArrayW<uint8_t> B) ;

/// @brief Method reverse addr 0x11a51a8 size 0x70 virtual false final false
