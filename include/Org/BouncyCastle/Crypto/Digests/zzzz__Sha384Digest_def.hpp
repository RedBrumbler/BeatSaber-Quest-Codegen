...
/// @brief Method .ctor addr 0xe27f14 size 0x58 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe27f6c size 0x68 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::Sha384Digest t) ;

/// @brief Method get_AlgorithmName addr 0xe27fd4 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0xe28014 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method DoFinal addr 0xe2801c size 0xb8 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe280d4 size 0x48 virtual true final false
 void Reset() ;

/// @brief Method Copy addr 0xe2811c size 0x60 virtual true final false
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0xe2817c size 0x88 virtual true final false
