...
/// @brief Method get_AlgorithmName addr 0x11a6a78 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

// Ctor Parameters []
explicit Gost3411_2012_256Digest() ;

/// @brief Method .ctor addr 0x11a6ab8 size 0x8c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11a6b44 size 0xa4 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::Gost3411_2012_256Digest other) ;

/// @brief Method GetDigestSize addr 0x11a6be8 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method DoFinal addr 0x11a6bf0 size 0x90 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Copy addr 0x11a6c80 size 0x60 virtual true final false
