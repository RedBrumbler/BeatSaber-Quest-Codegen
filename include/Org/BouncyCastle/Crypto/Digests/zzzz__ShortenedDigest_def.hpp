...
/// @brief Method .ctor addr 0xe29598 size 0x150 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest baseDigest, int32_t length) ;

/// @brief Method get_AlgorithmName addr 0xe296e8 size 0x1f0 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0xe298d8 size 0x8 virtual true final true
 int32_t GetDigestSize() ;

/// @brief Method Update addr 0xe298e0 size 0xac virtual true final true
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0xe2998c size 0xc4 virtual true final true
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method DoFinal addr 0xe29a50 size 0x174 virtual true final true
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe29bc4 size 0xa4 virtual true final true
 void Reset() ;

/// @brief Method GetByteLength addr 0xe29c68 size 0xa4 virtual true final true
