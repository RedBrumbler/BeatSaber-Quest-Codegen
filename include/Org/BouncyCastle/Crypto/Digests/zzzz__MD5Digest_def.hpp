...
/// @brief Method .ctor addr 0x11aa3a8 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11aa414 size 0x74 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::MD5Digest t) ;

/// @brief Method CopyIn addr 0x11aa488 size 0x5c virtual false final false
 void CopyIn(Org::BouncyCastle::Crypto::Digests::MD5Digest t) ;

/// @brief Method get_AlgorithmName addr 0x11aa4e4 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0x11aa524 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method ProcessWord addr 0x11aa52c size 0x80 virtual true final false
 void ProcessWord(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method ProcessLength addr 0x11aa5ac size 0xb8 virtual true final false
 void ProcessLength(int64_t bitLength) ;

/// @brief Method DoFinal addr 0x11aa664 size 0x90 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0x11aa6f4 size 0x60 virtual true final false
 void Reset() ;

/// @brief Method RotateLeft addr 0x11aa754 size 0xc virtual false final false
static uint32_t RotateLeft(uint32_t x, int32_t n) ;

/// @brief Method F addr 0x11aa760 size 0x10 virtual false final false
static uint32_t F(uint32_t u, uint32_t v, uint32_t w) ;

/// @brief Method G addr 0x11aa770 size 0x10 virtual false final false
static uint32_t G(uint32_t u, uint32_t v, uint32_t w) ;

/// @brief Method H addr 0x11aa780 size 0xc virtual false final false
static uint32_t H(uint32_t u, uint32_t v, uint32_t w) ;

/// @brief Method K addr 0x11aa78c size 0xc virtual false final false
static uint32_t K(uint32_t u, uint32_t v, uint32_t w) ;

/// @brief Method ProcessBlock addr 0x11aa798 size 0xb68 virtual true final false
 void ProcessBlock() ;

/// @brief Method Copy addr 0x11ab300 size 0x60 virtual true final false
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0x11ab360 size 0x84 virtual true final false
