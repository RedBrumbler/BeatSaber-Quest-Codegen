...
/// @brief Method .ctor addr 0xe2b970 size 0x148 virtual false final false
 void _ctor(int64_t outputSizeBits) ;

/// @brief Method get_Bytes addr 0xe2bf20 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xe2b8f0 size 0x30 virtual false final false
 void _ctor(int32_t type, ::ArrayW<uint8_t> value) ;

/// @brief Method get_Type addr 0xe2bf28 size 0x8 virtual false final false
 int32_t get_Type() ;

/// @brief Method get_Value addr 0xe2bf30 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xe2bf38 size 0x60 virtual false final false
 void _ctor() ;

/// @brief Method Reset addr 0xe2bfd4 size 0x88 virtual false final false
 void Reset(Org::BouncyCastle::Crypto::Digests::Org__BouncyCastle__Crypto__Digests__SkeinEngine__UbiTweak tweak) ;

/// @brief Method Reset addr 0xe2bf98 size 0x3c virtual false final false
 void Reset() ;

/// @brief Method get_Type addr 0xe2c09c size 0x30 virtual false final false
 uint32_t get_Type() ;

/// @brief Method set_Type addr 0xe2c0cc size 0x3c virtual false final false
 void set_Type(uint32_t value) ;

/// @brief Method get_First addr 0xe2c108 size 0x30 virtual false final false
 bool get_First() ;

/// @brief Method set_First addr 0xe2c05c size 0x40 virtual false final false
 void set_First(bool value) ;

/// @brief Method get_Final addr 0xe2c138 size 0x30 virtual false final false
 bool get_Final() ;

/// @brief Method set_Final addr 0xe2c168 size 0x40 virtual false final false
 void set_Final(bool value) ;

/// @brief Method AdvancePosition addr 0xe2c1a8 size 0x160 virtual false final false
 void AdvancePosition(int32_t advance) ;

/// @brief Method GetWords addr 0xe2c308 size 0x8 virtual false final false
 ::ArrayW<uint64_t> GetWords() ;

/// @brief Method ToString addr 0xe2c310 size 0x208 virtual true final false
 ::StringW ToString() ;
...
/// @brief Method .ctor addr 0xe2ac18 size 0xd8 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::SkeinEngine engine, int32_t blockSize) ;

/// @brief Method Reset addr 0xe2adf4 size 0xac virtual false final false
 void Reset(Org::BouncyCastle::Crypto::Digests::Org__BouncyCastle__Crypto__Digests__SkeinEngine__UBI ubi) ;

/// @brief Method Reset addr 0xe2bc00 size 0x40 virtual false final false
 void Reset(int32_t type) ;

/// @brief Method Update addr 0xe2bab8 size 0x128 virtual false final false
 void Update(::ArrayW<uint8_t> value, int32_t offset, int32_t len, ::ArrayW<uint64_t> output) ;

/// @brief Method ProcessBlock addr 0xe2c518 size 0x170 virtual false final false
 void ProcessBlock(::ArrayW<uint64_t> output) ;

/// @brief Method DoFinal addr 0xe2bc40 size 0x70 virtual false final false
...
/// @brief Method InitialState addr 0xe2aad0 size 0x140 virtual false final false
static void InitialState(int32_t blockSize, int32_t outputSize, ::ArrayW<uint64_t> state) ;

/// @brief Method VariantIdentifier addr 0xe2ac10 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xe29d94 size 0x190 virtual false final false
...
/// @brief Method .ctor addr 0xe29fb4 size 0x58 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::SkeinEngine engine) ;

/// @brief Method CopyIn addr 0xe2acf0 size 0x104 virtual false final false
 void CopyIn(Org::BouncyCastle::Crypto::Digests::SkeinEngine engine) ;

/// @brief Method Clone addr 0xe2aea0 size 0xa0 virtual false final false
...
/// @brief Method Copy addr 0xe2af40 size 0x60 virtual true final true
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0xe2a098 size 0x124 virtual true final true
 void Reset(Org::BouncyCastle::Utilities::IMemoable other) ;

/// @brief Method get_OutputSize addr 0xe2afa0 size 0x8 virtual false final false
 int32_t get_OutputSize() ;

/// @brief Method get_BlockSize addr 0xe2a3e0 size 0x24 virtual false final false
 int32_t get_BlockSize() ;

/// @brief Method Init addr 0xe2a44c size 0xb8 virtual false final false
 void Init(Org::BouncyCastle::Crypto::Parameters::SkeinParameters parameters) ;

/// @brief Method InitParams addr 0xe2afa8 size 0x678 virtual false final false
 void InitParams(System::Collections::IDictionary parameters) ;

/// @brief Method CreateInitialState addr 0xe2b620 size 0x2b8 virtual false final false
 void CreateInitialState() ;

/// @brief Method Reset addr 0xe2a51c size 0x40 virtual false final false
 void Reset() ;

/// @brief Method UbiComplete addr 0xe2b920 size 0x50 virtual false final false
 void UbiComplete(int32_t type, ::ArrayW<uint8_t> value) ;

/// @brief Method UbiInit addr 0xe2b8d8 size 0x18 virtual false final false
 void UbiInit(int32_t type) ;

/// @brief Method UbiFinal addr 0xe2bbe0 size 0x20 virtual false final false
 void UbiFinal() ;

/// @brief Method CheckInitialised addr 0xe2bcb0 size 0x60 virtual false final false
 void CheckInitialised() ;

/// @brief Method Update addr 0xe2a574 size 0x34 virtual false final false
 void Update(uint8_t inByte) ;

/// @brief Method Update addr 0xe2a5c0 size 0x4c virtual false final false
 void Update(::ArrayW<uint8_t> inBytes, int32_t inOff, int32_t len) ;

/// @brief Method DoFinal addr 0xe2a624 size 0x1c8 virtual false final false
 int32_t DoFinal(::ArrayW<uint8_t> outBytes, int32_t outOff) ;

/// @brief Method Output addr 0xe2bd10 size 0x210 virtual false final false
