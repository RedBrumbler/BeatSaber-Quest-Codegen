...
/// @brief Method .ctor addr 0x11a6fb4 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "bitLength", ty: "int32_t", modifiers: "", def_value: None }]
explicit KeccakDigest(int32_t bitLength) ;

/// @brief Method .ctor addr 0x11a6fbc size 0x94 virtual false final false
...
/// @brief Method .ctor addr 0x11a7100 size 0x94 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::KeccakDigest source) ;

/// @brief Method CopyIn addr 0x11a7194 size 0x7c virtual false final false
 void CopyIn(Org::BouncyCastle::Crypto::Digests::KeccakDigest source) ;

/// @brief Method get_AlgorithmName addr 0x11a7210 size 0x84 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0x11a7294 size 0xc virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method Update addr 0x11a72a0 size 0x4 virtual true final false
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0x11a7388 size 0x4 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len) ;

/// @brief Method DoFinal addr 0x11a7500 size 0x3c virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method DoFinal addr 0x11a7680 size 0x70 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff, uint8_t partialByte, int32_t partialBits) ;

/// @brief Method Reset addr 0x11a7820 size 0x8 virtual true final false
 void Reset() ;

/// @brief Method GetByteLength addr 0x11a7828 size 0xc virtual true final false
 int32_t GetByteLength() ;

/// @brief Method Init addr 0x11a7050 size 0xb0 virtual false final false
 void Init(int32_t bitLength) ;

/// @brief Method InitSponge addr 0x11a7834 size 0xfc virtual false final false
 void InitSponge(int32_t rate) ;

/// @brief Method Absorb addr 0x11a72a4 size 0xe4 virtual false final false
 void Absorb(uint8_t data) ;

/// @brief Method Absorb addr 0x11a738c size 0x174 virtual false final false
 void Absorb(::ArrayW<uint8_t> data, int32_t off, int32_t len) ;

/// @brief Method AbsorbBits addr 0x11a76f0 size 0x130 virtual false final false
 void AbsorbBits(int32_t data, int32_t bits) ;

/// @brief Method PadAndSwitchToSqueezingPhase addr 0x11a79dc size 0x19c virtual false final false
 void PadAndSwitchToSqueezingPhase() ;

/// @brief Method Squeeze addr 0x11a753c size 0x144 virtual false final false
 void Squeeze(::ArrayW<uint8_t> output, int32_t offset, int64_t outputLength) ;

/// @brief Method KeccakAbsorb addr 0x11a7930 size 0xac virtual false final false
 void KeccakAbsorb(::ArrayW<uint8_t> data, int32_t off) ;

/// @brief Method KeccakExtract addr 0x11a7b78 size 0x38 virtual false final false
 void KeccakExtract() ;

/// @brief Method KeccakPermutation addr 0x11a7bb0 size 0x618 virtual false final false
 void KeccakPermutation() ;

/// @brief Method Copy addr 0x11a81c8 size 0x60 virtual true final false
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0x11a8228 size 0x84 virtual true final false
