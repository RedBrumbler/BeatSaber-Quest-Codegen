...
/// @brief Method get_AlgorithmName addr 0x11a6d74 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

// Ctor Parameters []
explicit Gost3411_2012_512Digest() ;

/// @brief Method .ctor addr 0x11a6db4 size 0x8c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11a6e40 size 0xa4 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::Gost3411_2012_512Digest other) ;

/// @brief Method GetDigestSize addr 0x11a6ee4 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method Copy addr 0x11a6eec size 0x60 virtual true final false
