...
/// @brief Method .ctor addr 0xe285b8 size 0x58 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe28610 size 0x68 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::Sha512Digest t) ;

/// @brief Method get_AlgorithmName addr 0xe28678 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0xe286b8 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method DoFinal addr 0xe286c0 size 0xe0 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe287a0 size 0x48 virtual true final false
 void Reset() ;

/// @brief Method Copy addr 0xe287e8 size 0x60 virtual true final false
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0xe28848 size 0x88 virtual true final false
