...
/// @brief Method .ctor addr 0xe2692c size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe26998 size 0x74 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::Sha224Digest t) ;

/// @brief Method CopyIn addr 0xe26a0c size 0x64 virtual false final false
 void CopyIn(Org::BouncyCastle::Crypto::Digests::Sha224Digest t) ;

/// @brief Method get_AlgorithmName addr 0xe26a70 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0xe26ab0 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method ProcessWord addr 0xe26ab8 size 0x80 virtual true final false
 void ProcessWord(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method ProcessLength addr 0xe26b38 size 0x6c virtual true final false
 void ProcessLength(int64_t bitLength) ;

/// @brief Method DoFinal addr 0xe26ba4 size 0xcc virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe26c70 size 0x4c virtual true final false
 void Reset() ;

/// @brief Method ProcessBlock addr 0xe26cbc size 0x56c virtual true final false
 void ProcessBlock() ;

/// @brief Method Ch addr 0xe27258 size 0x10 virtual false final false
static uint32_t Ch(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method Maj addr 0xe27278 size 0x14 virtual false final false
static uint32_t Maj(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method Sum0 addr 0xe27268 size 0x10 virtual false final false
static uint32_t Sum0(uint32_t x) ;

/// @brief Method Sum1 addr 0xe27248 size 0x10 virtual false final false
static uint32_t Sum1(uint32_t x) ;

/// @brief Method Theta0 addr 0xe27238 size 0x10 virtual false final false
static uint32_t Theta0(uint32_t x) ;

/// @brief Method Theta1 addr 0xe27228 size 0x10 virtual false final false
static uint32_t Theta1(uint32_t x) ;

/// @brief Method Copy addr 0xe2728c size 0x60 virtual true final false
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0xe272ec size 0x84 virtual true final false
