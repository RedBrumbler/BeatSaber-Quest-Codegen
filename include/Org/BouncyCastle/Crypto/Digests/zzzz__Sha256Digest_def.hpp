...
/// @brief Method .ctor addr 0xe27404 size 0x74 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xe27494 size 0x74 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Digests::Sha256Digest t) ;

/// @brief Method CopyIn addr 0xe27508 size 0x64 virtual false final false
 void CopyIn(Org::BouncyCastle::Crypto::Digests::Sha256Digest t) ;

/// @brief Method get_AlgorithmName addr 0xe2756c size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0xe275ac size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method ProcessWord addr 0xe275b4 size 0x80 virtual true final false
 void ProcessWord(::ArrayW<uint8_t> input, int32_t inOff) ;

/// @brief Method ProcessLength addr 0xe27634 size 0x6c virtual true final false
 void ProcessLength(int64_t bitLength) ;

/// @brief Method DoFinal addr 0xe276a0 size 0xe0 virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xe27780 size 0x4c virtual true final false
 void Reset() ;

/// @brief Method initHs addr 0xe27478 size 0x1c virtual false final false
 void initHs() ;

/// @brief Method ProcessBlock addr 0xe277cc size 0x56c virtual true final false
 void ProcessBlock() ;

/// @brief Method Sum1Ch addr 0xe27d58 size 0x20 virtual false final false
static uint32_t Sum1Ch(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method Sum0Maj addr 0xe27d78 size 0x24 virtual false final false
static uint32_t Sum0Maj(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method Theta0 addr 0xe27d48 size 0x10 virtual false final false
static uint32_t Theta0(uint32_t x) ;

/// @brief Method Theta1 addr 0xe27d38 size 0x10 virtual false final false
static uint32_t Theta1(uint32_t x) ;

/// @brief Method Copy addr 0xe27d9c size 0x60 virtual true final false
 Org::BouncyCastle::Utilities::IMemoable Copy() ;

/// @brief Method Reset addr 0xe27dfc size 0x84 virtual true final false
