...
/// @brief Method .ctor addr 0x119f0c4 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x119f1e8 size 0x134 virtual false final false
...
/// @brief Method .ctor addr 0x119f0cc size 0x11c virtual false final false
...
/// @brief Method .ctor addr 0x119f5c8 size 0x164 virtual false final false
...
/// @brief Method .ctor addr 0x119f72c size 0x268 virtual false final false
 void _ctor(::ArrayW<uint8_t> key, int32_t digestLength, ::ArrayW<uint8_t> salt, ::ArrayW<uint8_t> personalization) ;

/// @brief Method Init addr 0x119f31c size 0x2ac virtual false final false
 void Init() ;

/// @brief Method InitializeInternalState addr 0x119f994 size 0x148 virtual false final false
 void InitializeInternalState() ;

/// @brief Method Update addr 0x119fadc size 0xb8 virtual true final false
 void Update(uint8_t b) ;

/// @brief Method BlockUpdate addr 0x11a0120 size 0x140 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> message, int32_t offset, int32_t len) ;

/// @brief Method DoFinal addr 0x11a0260 size 0x14c virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOffset) ;

/// @brief Method Reset addr 0x11a03ac size 0x68 virtual true final false
 void Reset() ;

/// @brief Method Compress addr 0x119fb94 size 0x58c virtual false final false
 void Compress(::ArrayW<uint8_t> message, int32_t messagePos) ;

/// @brief Method G addr 0x11a0414 size 0x208 virtual false final false
 void G(uint64_t m1, uint64_t m2, int32_t posA, int32_t posB, int32_t posC, int32_t posD) ;

/// @brief Method Rotr64 addr 0x11a061c size 0x8 virtual false final false
static uint64_t Rotr64(uint64_t x, int32_t rot) ;

/// @brief Method get_AlgorithmName addr 0x11a0624 size 0x40 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method GetDigestSize addr 0x11a0664 size 0x8 virtual true final false
 int32_t GetDigestSize() ;

/// @brief Method GetByteLength addr 0x11a066c size 0x8 virtual true final false
 int32_t GetByteLength() ;

/// @brief Method ClearKey addr 0x11a0674 size 0x48 virtual true final false
 void ClearKey() ;

/// @brief Method ClearSalt addr 0x11a06bc size 0x1c virtual true final false
 void ClearSalt() ;
