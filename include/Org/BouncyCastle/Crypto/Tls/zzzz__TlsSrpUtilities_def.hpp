...
/// @brief Method AddSrpExtension addr 0xf3a6a0 size 0xf0 virtual false final false
static void AddSrpExtension(System::Collections::IDictionary extensions, ::ArrayW<uint8_t> identity) ;

/// @brief Method GetSrpExtension addr 0xf3a824 size 0x6c virtual false final false
static ::ArrayW<uint8_t> GetSrpExtension(System::Collections::IDictionary extensions) ;

/// @brief Method CreateSrpExtension addr 0xf3a790 size 0x94 virtual false final false
static ::ArrayW<uint8_t> CreateSrpExtension(::ArrayW<uint8_t> identity) ;

/// @brief Method ReadSrpExtension addr 0xf3a890 size 0xf4 virtual false final false
static ::ArrayW<uint8_t> ReadSrpExtension(::ArrayW<uint8_t> extensionData) ;

/// @brief Method ReadSrpParameter addr 0xf3a2c8 size 0x9c virtual false final false
static Org::BouncyCastle::Math::BigInteger ReadSrpParameter(System::IO::Stream input) ;

/// @brief Method WriteSrpParameter addr 0xf3a07c size 0x78 virtual false final false
static void WriteSrpParameter(Org::BouncyCastle::Math::BigInteger x, System::IO::Stream output) ;

/// @brief Method IsSrpCipherSuite addr 0xf3aa14 size 0x14 virtual false final false
static bool IsSrpCipherSuite(int32_t cipherSuite) ;

// Ctor Parameters []
explicit TlsSrpUtilities() ;

/// @brief Method .ctor addr 0xf3aa28 size 0x8 virtual false final false
 void _ctor() ;
