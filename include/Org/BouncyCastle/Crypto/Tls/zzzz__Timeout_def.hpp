...
/// @brief Method .ctor addr 0xf1a4b0 size 0x70 virtual false final false
...
/// @brief Method .ctor addr 0xf1a520 size 0x94 virtual false final false
 void _ctor(int64_t durationMillis, int64_t currentTimeMillis) ;

/// @brief Method RemainingMillis addr 0xf1a5b4 size 0x64 virtual false final false
 int64_t RemainingMillis(int64_t currentTimeMillis) ;

/// @brief Method ConstrainWaitMillis addr 0xf1a618 size 0xc8 virtual false final false
...
/// @brief Method ForWaitMillis addr 0xf1a714 size 0x60 virtual false final false
static Org::BouncyCastle::Crypto::Tls::Timeout ForWaitMillis(int32_t waitMillis) ;

/// @brief Method ForWaitMillis addr 0xf1a774 size 0xd8 virtual false final false
static Org::BouncyCastle::Crypto::Tls::Timeout ForWaitMillis(int32_t waitMillis, int64_t currentTimeMillis) ;

/// @brief Method GetWaitMillis addr 0xf1a6e0 size 0x34 virtual false final false
static int32_t GetWaitMillis(Org::BouncyCastle::Crypto::Tls::Timeout timeout, int64_t currentTimeMillis) ;

/// @brief Method HasExpired addr 0xf1a84c size 0x1c virtual false final false
