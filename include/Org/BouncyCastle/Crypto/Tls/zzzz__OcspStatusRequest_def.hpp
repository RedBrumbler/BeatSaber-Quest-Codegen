...
/// @brief Method .ctor addr 0xf13cd8 size 0x2c virtual false final false
 void _ctor(System::Collections::IList responderIDList, Org::BouncyCastle::Asn1::X509::X509Extensions requestExtensions) ;

/// @brief Method get_ResponderIDList addr 0xf13d04 size 0x8 virtual true final false
 System::Collections::IList get_ResponderIDList() ;

/// @brief Method get_RequestExtensions addr 0xf13d0c size 0x8 virtual true final false
 Org::BouncyCastle::Asn1::X509::X509Extensions get_RequestExtensions() ;

/// @brief Method Encode addr 0xf13d14 size 0x3c0 virtual true final false
 void Encode(System::IO::Stream output) ;

/// @brief Method Parse addr 0xf140d4 size 0x2a8 virtual false final false
