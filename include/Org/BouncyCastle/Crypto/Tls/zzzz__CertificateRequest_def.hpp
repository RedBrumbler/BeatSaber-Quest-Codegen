...
/// @brief Method .ctor addr 0xedebf0 size 0x3c virtual false final false
...
/// @brief Method get_CertificateTypes addr 0xedec2c size 0x8 virtual true final false
 ::ArrayW<uint8_t> get_CertificateTypes() ;

/// @brief Method get_SupportedSignatureAlgorithms addr 0xedec34 size 0x8 virtual true final false
 System::Collections::IList get_SupportedSignatureAlgorithms() ;

/// @brief Method get_CertificateAuthorities addr 0xedec3c size 0x8 virtual true final false
 System::Collections::IList get_CertificateAuthorities() ;

/// @brief Method Encode addr 0xedec44 size 0x920 virtual true final false
 void Encode(System::IO::Stream output) ;

/// @brief Method Parse addr 0xedf564 size 0x304 virtual false final false
