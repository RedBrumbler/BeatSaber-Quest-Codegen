...
/// @brief Method GetName addr 0xedcc08 size 0xa8 virtual false final false
static ::StringW GetName(uint8_t alertDescription) ;

/// @brief Method GetText addr 0xedccb0 size 0x17c virtual false final false
static ::StringW GetText(uint8_t alertDescription) ;

// Ctor Parameters []
explicit AlertLevel() ;

/// @brief Method .ctor addr 0xedce2c size 0x8 virtual false final false
 void _ctor() ;
