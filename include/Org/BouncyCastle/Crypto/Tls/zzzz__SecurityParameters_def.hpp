...
/// @brief Method Clear addr 0xf168d4 size 0x6c virtual true final false
 void Clear() ;

/// @brief Method get_Entity addr 0xf16940 size 0x8 virtual true final false
 int32_t get_Entity() ;

/// @brief Method get_CipherSuite addr 0xf16948 size 0x8 virtual true final false
 int32_t get_CipherSuite() ;

/// @brief Method get_CompressionAlgorithm addr 0xf16950 size 0x8 virtual true final false
 uint8_t get_CompressionAlgorithm() ;

/// @brief Method get_PrfAlgorithm addr 0xf16958 size 0x8 virtual true final false
 int32_t get_PrfAlgorithm() ;

/// @brief Method get_VerifyDataLength addr 0xf16960 size 0x8 virtual true final false
 int32_t get_VerifyDataLength() ;

/// @brief Method get_MasterSecret addr 0xf16968 size 0x8 virtual true final false
 ::ArrayW<uint8_t> get_MasterSecret() ;

/// @brief Method get_ClientRandom addr 0xf16970 size 0x8 virtual true final false
 ::ArrayW<uint8_t> get_ClientRandom() ;

/// @brief Method get_ServerRandom addr 0xf16978 size 0x8 virtual true final false
 ::ArrayW<uint8_t> get_ServerRandom() ;

/// @brief Method get_SessionHash addr 0xf16980 size 0x8 virtual true final false
 ::ArrayW<uint8_t> get_SessionHash() ;

/// @brief Method get_PskIdentity addr 0xf16988 size 0x8 virtual true final false
 ::ArrayW<uint8_t> get_PskIdentity() ;

/// @brief Method get_SrpIdentity addr 0xf16990 size 0x8 virtual true final false
 ::ArrayW<uint8_t> get_SrpIdentity() ;

/// @brief Method get_IsExtendedMasterSecret addr 0xf16998 size 0x8 virtual true final false
 bool get_IsExtendedMasterSecret() ;

// Ctor Parameters []
explicit SecurityParameters() ;

/// @brief Method .ctor addr 0xf169a0 size 0x34 virtual false final false
 void _ctor() ;
