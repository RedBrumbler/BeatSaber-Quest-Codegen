...
/// @brief Method .ctor addr 0xee0ae0 size 0x324 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Tls::TlsContext context) ;

/// @brief Method GetPlaintextLimit addr 0xee0e04 size 0x8 virtual true final false
 int32_t GetPlaintextLimit(int32_t ciphertextLimit) ;

/// @brief Method EncodePlaintext addr 0xee0e0c size 0x13c virtual true final false
 ::ArrayW<uint8_t> EncodePlaintext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> plaintext, int32_t offset, int32_t len) ;

/// @brief Method DecodeCiphertext addr 0xee0f48 size 0x1f0 virtual true final false
 ::ArrayW<uint8_t> DecodeCiphertext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> ciphertext, int32_t offset, int32_t len) ;

/// @brief Method InitRecord addr 0xee1138 size 0x130 virtual true final false
...
/// @brief Method CalculateNonce addr 0xee1268 size 0xec virtual true final false
 ::ArrayW<uint8_t> CalculateNonce(int64_t seqNo, ::ArrayW<uint8_t> iv) ;

/// @brief Method GenerateRecordMacKey addr 0xee1354 size 0x15c virtual true final false
 Org::BouncyCastle::Crypto::Parameters::KeyParameter GenerateRecordMacKey(Org::BouncyCastle::Crypto::IStreamCipher cipher) ;

/// @brief Method CalculateRecordMac addr 0xee14b0 size 0x1a8 virtual true final false
...
/// @brief Method UpdateRecordMacLength addr 0xee1658 size 0xc8 virtual true final false
 void UpdateRecordMacLength(Org::BouncyCastle::Crypto::IMac mac, int32_t len) ;

/// @brief Method UpdateRecordMacText addr 0xee1720 size 0x188 virtual true final false
 void UpdateRecordMacText(Org::BouncyCastle::Crypto::IMac mac, ::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method GetAdditionalData addr 0xee18a8 size 0x160 virtual true final false
