...
/// @brief Method .ctor addr 0xf1a868 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xf1a870 size 0x4c8 virtual false final false
...
/// @brief Method GetPlaintextLimit addr 0xf1ad38 size 0x10 virtual true final false
 int32_t GetPlaintextLimit(int32_t ciphertextLimit) ;

/// @brief Method EncodePlaintext addr 0xf1ad48 size 0x574 virtual true final false
 ::ArrayW<uint8_t> EncodePlaintext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> plaintext, int32_t offset, int32_t len) ;

/// @brief Method DecodeCiphertext addr 0xf1b2bc size 0x568 virtual true final false
 ::ArrayW<uint8_t> DecodeCiphertext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> ciphertext, int32_t offset, int32_t len) ;

/// @brief Method GetAdditionalData addr 0xf1b824 size 0x160 virtual true final false
