...
/// @brief Method IsValidPublicKey addr 0xf2d8a0 size 0x78 virtual true final false
 bool IsValidPublicKey(Org::BouncyCastle::Crypto::AsymmetricKeyParameter publicKey) ;

/// @brief Method CreateDsaImpl addr 0xf2d918 size 0xc8 virtual true final false
 Org::BouncyCastle::Crypto::IDsa CreateDsaImpl(uint8_t hashAlgorithm) ;

/// @brief Method get_SignatureAlgorithm addr 0xf2dbb8 size 0x8 virtual true final false
 uint8_t get_SignatureAlgorithm() ;

// Ctor Parameters []
explicit TlsECDsaSigner() ;

/// @brief Method .ctor addr 0xf2bc8c size 0x8 virtual false final false
 void _ctor() ;
