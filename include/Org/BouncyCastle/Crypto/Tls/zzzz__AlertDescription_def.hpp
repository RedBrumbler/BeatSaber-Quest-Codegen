...
/// @brief Method GetName addr 0xedc690 size 0x3f4 virtual false final false
static ::StringW GetName(uint8_t alertDescription) ;

/// @brief Method GetText addr 0xedca84 size 0x17c virtual false final false
static ::StringW GetText(uint8_t alertDescription) ;

// Ctor Parameters []
explicit AlertDescription() ;

/// @brief Method .ctor addr 0xedcc00 size 0x8 virtual false final false
 void _ctor() ;
