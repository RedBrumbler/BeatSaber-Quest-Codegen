...
/// @brief Method .ctor addr 0xede0d8 size 0x78 virtual false final false
 void _ctor(::ArrayW<Org::BouncyCastle::Asn1::X509::X509CertificateStructure> certificateList) ;

/// @brief Method GetCertificateList addr 0xede150 size 0xc virtual true final false
 ::ArrayW<Org::BouncyCastle::Asn1::X509::X509CertificateStructure> GetCertificateList() ;

/// @brief Method GetCertificateAt addr 0xede15c size 0x30 virtual true final false
 Org::BouncyCastle::Asn1::X509::X509CertificateStructure GetCertificateAt(int32_t index) ;

/// @brief Method get_Length addr 0xede18c size 0x1c virtual true final false
 int32_t get_Length() ;

/// @brief Method get_IsEmpty addr 0xede1a8 size 0x24 virtual true final false
 bool get_IsEmpty() ;

/// @brief Method Encode addr 0xede1cc size 0x4c4 virtual true final false
 void Encode(System::IO::Stream output) ;

/// @brief Method Parse addr 0xede690 size 0x45c virtual false final false
static Org::BouncyCastle::Crypto::Tls::Certificate Parse(System::IO::Stream input) ;

/// @brief Method CloneCertificateList addr 0xedeaec size 0x78 virtual true final false
