...
/// @brief Method ShouldDiscard addr 0xeef4e0 size 0x44 virtual false final false
 bool ShouldDiscard(int64_t seq) ;

/// @brief Method ReportAuthenticated addr 0xeef52c size 0xcc virtual false final false
 void ReportAuthenticated(int64_t seq) ;

/// @brief Method Reset addr 0xef0f48 size 0x10 virtual false final false
 void Reset() ;

// Ctor Parameters []
explicit DtlsReplayWindow() ;

/// @brief Method .ctor addr 0xeed178 size 0x14 virtual false final false
 void _ctor() ;
