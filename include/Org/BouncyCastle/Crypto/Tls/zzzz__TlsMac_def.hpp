...
/// @brief Method .ctor addr 0xf2fc7c size 0x404 virtual false final false
...
/// @brief Method get_MacSecret addr 0xf3012c size 0x8 virtual true final false
 ::ArrayW<uint8_t> get_MacSecret() ;

/// @brief Method get_Size addr 0xf30134 size 0x8 virtual true final false
 int32_t get_Size() ;

/// @brief Method CalculateMac addr 0xf3013c size 0x2f4 virtual true final false
 ::ArrayW<uint8_t> CalculateMac(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> message, int32_t offset, int32_t length) ;

/// @brief Method CalculateMacConstantTime addr 0xf30604 size 0x284 virtual true final false
...
/// @brief Method GetDigestBlockCount addr 0xf30888 size 0x10 virtual true final false
 int32_t GetDigestBlockCount(int32_t inputLength) ;

/// @brief Method Truncate addr 0xf30898 size 0x88 virtual true final false
