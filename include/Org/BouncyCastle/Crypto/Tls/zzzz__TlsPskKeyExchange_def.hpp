...
/// @brief Method .ctor addr 0xf312b0 size 0xcc virtual false final false
...
/// @brief Method .ctor addr 0xf3137c size 0xcc virtual false final false
...
/// @brief Method SkipServerCredentials addr 0xf31448 size 0x54 virtual true final false
 void SkipServerCredentials() ;

/// @brief Method ProcessServerCredentials addr 0xf3149c size 0x168 virtual true final false
 void ProcessServerCredentials(Org::BouncyCastle::Crypto::Tls::TlsCredentials serverCredentials) ;

/// @brief Method GenerateServerKeyExchange addr 0xf31604 size 0x338 virtual true final false
 ::ArrayW<uint8_t> GenerateServerKeyExchange() ;

/// @brief Method ProcessServerCertificate addr 0xf319c4 size 0x26c virtual true final false
 void ProcessServerCertificate(Org::BouncyCastle::Crypto::Tls::Certificate serverCertificate) ;

/// @brief Method get_RequiresServerKeyExchange addr 0xf31c30 size 0x20 virtual true final false
 bool get_RequiresServerKeyExchange() ;

/// @brief Method ProcessServerKeyExchange addr 0xf31c50 size 0x190 virtual true final false
 void ProcessServerKeyExchange(System::IO::Stream input) ;

/// @brief Method ValidateCertificateRequest addr 0xf31e6c size 0x40 virtual true final false
 void ValidateCertificateRequest(Org::BouncyCastle::Crypto::Tls::CertificateRequest certificateRequest) ;

/// @brief Method ProcessClientCredentials addr 0xf31eac size 0x40 virtual true final false
 void ProcessClientCredentials(Org::BouncyCastle::Crypto::Tls::TlsCredentials clientCredentials) ;

/// @brief Method GenerateClientKeyExchange addr 0xf31eec size 0x480 virtual true final false
 void GenerateClientKeyExchange(System::IO::Stream output) ;

/// @brief Method ProcessClientKeyExchange addr 0xf32760 size 0x37c virtual true final false
 void ProcessClientKeyExchange(System::IO::Stream input) ;

/// @brief Method GeneratePremasterSecret addr 0xf32adc size 0x12c virtual true final false
 ::ArrayW<uint8_t> GeneratePremasterSecret() ;

/// @brief Method GenerateOtherSecret addr 0xf32c08 size 0x144 virtual true final false
 ::ArrayW<uint8_t> GenerateOtherSecret(int32_t pskLength) ;

/// @brief Method ValidateRsaPublicKey addr 0xf32d4c size 0x70 virtual true final false
