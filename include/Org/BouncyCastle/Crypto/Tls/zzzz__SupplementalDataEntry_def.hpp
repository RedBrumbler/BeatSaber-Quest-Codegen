...
/// @brief Method .ctor addr 0xf1a468 size 0x30 virtual false final false
 void _ctor(int32_t dataType, ::ArrayW<uint8_t> data) ;

/// @brief Method get_DataType addr 0xf1a498 size 0x8 virtual true final false
 int32_t get_DataType() ;

/// @brief Method get_Data addr 0xf1a4a0 size 0x8 virtual true final false
