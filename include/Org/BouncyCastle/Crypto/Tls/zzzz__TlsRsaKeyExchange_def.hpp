...
/// @brief Method .ctor addr 0xf32dbc size 0x18 virtual false final false
 void _ctor(System::Collections::IList supportedSignatureAlgorithms) ;

/// @brief Method SkipServerCredentials addr 0xf32dd4 size 0x40 virtual true final false
 void SkipServerCredentials() ;

/// @brief Method ProcessServerCredentials addr 0xf32e14 size 0x168 virtual true final false
 void ProcessServerCredentials(Org::BouncyCastle::Crypto::Tls::TlsCredentials serverCredentials) ;

/// @brief Method ProcessServerCertificate addr 0xf32f7c size 0x240 virtual true final false
 void ProcessServerCertificate(Org::BouncyCastle::Crypto::Tls::Certificate serverCertificate) ;

/// @brief Method ValidateCertificateRequest addr 0xf331bc size 0x9c virtual true final false
 void ValidateCertificateRequest(Org::BouncyCastle::Crypto::Tls::CertificateRequest certificateRequest) ;

/// @brief Method ProcessClientCredentials addr 0xf33258 size 0x8c virtual true final false
 void ProcessClientCredentials(Org::BouncyCastle::Crypto::Tls::TlsCredentials clientCredentials) ;

/// @brief Method GenerateClientKeyExchange addr 0xf332e4 size 0x28 virtual true final false
 void GenerateClientKeyExchange(System::IO::Stream output) ;

/// @brief Method ProcessClientKeyExchange addr 0xf3330c size 0x118 virtual true final false
 void ProcessClientKeyExchange(System::IO::Stream input) ;

/// @brief Method GeneratePremasterSecret addr 0xf33424 size 0x58 virtual true final false
 ::ArrayW<uint8_t> GeneratePremasterSecret() ;

/// @brief Method ValidateRsaPublicKey addr 0xf3347c size 0x70 virtual true final false
