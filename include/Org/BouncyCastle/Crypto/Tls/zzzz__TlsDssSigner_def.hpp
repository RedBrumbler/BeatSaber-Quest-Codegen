...
/// @brief Method IsValidPublicKey addr 0xf28b54 size 0x78 virtual true final false
 bool IsValidPublicKey(Org::BouncyCastle::Crypto::AsymmetricKeyParameter publicKey) ;

/// @brief Method CreateDsaImpl addr 0xf28bcc size 0xcc virtual true final false
 Org::BouncyCastle::Crypto::IDsa CreateDsaImpl(uint8_t hashAlgorithm) ;

/// @brief Method get_SignatureAlgorithm addr 0xf28c98 size 0x8 virtual true final false
 uint8_t get_SignatureAlgorithm() ;

// Ctor Parameters []
explicit TlsDssSigner() ;

/// @brief Method .ctor addr 0xf25920 size 0x8 virtual false final false
 void _ctor() ;
