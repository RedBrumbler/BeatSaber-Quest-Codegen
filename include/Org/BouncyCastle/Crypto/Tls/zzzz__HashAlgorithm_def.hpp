...
/// @brief Method GetName addr 0xf130c4 size 0xb8 virtual false final false
static ::StringW GetName(uint8_t hashAlgorithm) ;

/// @brief Method GetText addr 0xf1317c size 0x17c virtual false final false
static ::StringW GetText(uint8_t hashAlgorithm) ;

/// @brief Method IsPrivate addr 0xf132f8 size 0x10 virtual false final false
static bool IsPrivate(uint8_t hashAlgorithm) ;

/// @brief Method IsRecognized addr 0xf13308 size 0x14 virtual false final false
static bool IsRecognized(uint8_t hashAlgorithm) ;

// Ctor Parameters []
explicit HashAlgorithm() ;

/// @brief Method .ctor addr 0xf1331c size 0x8 virtual false final false
 void _ctor() ;
