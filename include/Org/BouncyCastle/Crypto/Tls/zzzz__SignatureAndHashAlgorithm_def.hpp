...
/// @brief Method .ctor addr 0xf18280 size 0x164 virtual false final false
 void _ctor(uint8_t hash, uint8_t signature) ;

/// @brief Method get_Hash addr 0xf183e4 size 0x8 virtual true final false
 uint8_t get_Hash() ;

/// @brief Method get_Signature addr 0xf183ec size 0x8 virtual true final false
 uint8_t get_Signature() ;

/// @brief Method Equals addr 0xf183f4 size 0xd0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0xf184c4 size 0x44 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Encode addr 0xf18508 size 0x9c virtual true final false
 void Encode(System::IO::Stream output) ;

/// @brief Method Parse addr 0xf185a4 size 0xac virtual false final false
