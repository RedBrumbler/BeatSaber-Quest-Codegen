...
/// @brief Method SendDatagram addr 0xeedc28 size 0xc0 virtual false final false
...
/// @brief Method .ctor addr 0xee921c size 0x13c virtual false final false
...
/// @brief Method get_IsClosed addr 0xeedce8 size 0x18 virtual false final false
 bool get_IsClosed() ;

/// @brief Method SetPlaintextLimit addr 0xeedd00 size 0x24 virtual true final false
 void SetPlaintextLimit(int32_t plaintextLimit) ;

/// @brief Method get_ReadEpoch addr 0xeedd24 size 0x1c virtual true final false
 int32_t get_ReadEpoch() ;

/// @brief Method get_ReadVersion addr 0xeedd40 size 0x18 virtual true final false
 Org::BouncyCastle::Crypto::Tls::ProtocolVersion get_ReadVersion() ;

/// @brief Method set_ReadVersion addr 0xeedd58 size 0x24 virtual true final false
 void set_ReadVersion(Org::BouncyCastle::Crypto::Tls::ProtocolVersion value) ;

/// @brief Method SetWriteVersion addr 0xeedd7c size 0x24 virtual true final false
 void SetWriteVersion(Org::BouncyCastle::Crypto::Tls::ProtocolVersion writeVersion) ;

/// @brief Method InitPendingEpoch addr 0xeedda0 size 0xc0 virtual true final false
 void InitPendingEpoch(Org::BouncyCastle::Crypto::Tls::TlsCipher pendingCipher) ;

/// @brief Method HandshakeSuccessful addr 0xeede60 size 0xdc virtual true final false
 void HandshakeSuccessful(Org::BouncyCastle::Crypto::Tls::DtlsHandshakeRetransmit retransmit) ;

/// @brief Method ResetWriteEpoch addr 0xeedf3c size 0x14 virtual true final false
 void ResetWriteEpoch() ;

/// @brief Method GetReceiveLimit addr 0xeedf50 size 0x170 virtual true final false
 int32_t GetReceiveLimit() ;

/// @brief Method GetSendLimit addr 0xeee0c0 size 0x174 virtual true final false
 int32_t GetSendLimit() ;

/// @brief Method Receive addr 0xeee234 size 0x1c4 virtual true final false
 int32_t Receive(::ArrayW<uint8_t> buf, int32_t off, int32_t len, int32_t waitMillis) ;

/// @brief Method Send addr 0xeeeb28 size 0x178 virtual true final false
 void Send(::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method Close addr 0xeeef20 size 0x84 virtual true final false
 void Close() ;

/// @brief Method Failed addr 0xeef100 size 0x40 virtual true final false
 void Failed() ;

/// @brief Method Fail addr 0xeef140 size 0xcc virtual true final false
 void Fail(uint8_t alertDescription) ;

/// @brief Method Warn addr 0xeef338 size 0x14 virtual true final false
 void Warn(uint8_t alertDescription, ::StringW message) ;

/// @brief Method CloseTransport addr 0xeeefa4 size 0x15c virtual false final false
 void CloseTransport() ;

/// @brief Method RaiseAlert addr 0xeef20c size 0x12c virtual false final false
 void RaiseAlert(uint8_t alertLevel, uint8_t alertDescription, ::StringW message, System::Exception cause) ;

/// @brief Method ReceiveDatagram addr 0xeef34c size 0x194 virtual false final false
 int32_t ReceiveDatagram(::ArrayW<uint8_t> buf, int32_t off, int32_t len, int32_t waitMillis) ;

/// @brief Method ProcessRecord addr 0xeee5c8 size 0x560 virtual false final false
 int32_t ProcessRecord(int32_t received, ::ArrayW<uint8_t> record, ::ArrayW<uint8_t> buf, int32_t off) ;

/// @brief Method ReceiveRecord addr 0xeee3f8 size 0x1d0 virtual false final false
 int32_t ReceiveRecord(::ArrayW<uint8_t> buf, int32_t off, int32_t len, int32_t waitMillis) ;

/// @brief Method SendRecord addr 0xeeeca0 size 0x280 virtual false final false
 void SendRecord(uint8_t contentType, ::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method GetMacSequenceNumber addr 0xeef524 size 0x8 virtual false final false
