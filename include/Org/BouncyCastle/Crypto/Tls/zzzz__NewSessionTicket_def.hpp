...
/// @brief Method .ctor addr 0xf13b74 size 0x2c virtual false final false
 void _ctor(int64_t ticketLifetimeHint, ::ArrayW<uint8_t> ticket) ;

/// @brief Method get_TicketLifetimeHint addr 0xf13ba0 size 0x8 virtual true final false
 int64_t get_TicketLifetimeHint() ;

/// @brief Method get_Ticket addr 0xf13ba8 size 0x8 virtual true final false
 ::ArrayW<uint8_t> get_Ticket() ;

/// @brief Method Encode addr 0xf13bb0 size 0x7c virtual true final false
 void Encode(System::IO::Stream output) ;

/// @brief Method Parse addr 0xf13c2c size 0xac virtual false final false
