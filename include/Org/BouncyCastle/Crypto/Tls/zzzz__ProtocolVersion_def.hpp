...
/// @brief Method .ctor addr 0xf14384 size 0x34 virtual false final false
 void _ctor(int32_t v, ::StringW name) ;

/// @brief Method get_FullVersion addr 0xf143b8 size 0x8 virtual false final false
 int32_t get_FullVersion() ;

/// @brief Method get_MajorVersion addr 0xf143c0 size 0xc virtual false final false
 int32_t get_MajorVersion() ;

/// @brief Method get_MinorVersion addr 0xf143cc size 0x8 virtual false final false
 int32_t get_MinorVersion() ;

/// @brief Method get_IsDtls addr 0xf143d4 size 0x14 virtual false final false
 bool get_IsDtls() ;

/// @brief Method get_IsSsl addr 0xf143e8 size 0x64 virtual false final false
 bool get_IsSsl() ;

/// @brief Method get_IsTls addr 0xf1444c size 0x14 virtual false final false
 bool get_IsTls() ;

/// @brief Method GetEquivalentTLSVersion addr 0xf14460 size 0x98 virtual false final false
 Org::BouncyCastle::Crypto::Tls::ProtocolVersion GetEquivalentTLSVersion() ;

/// @brief Method IsEqualOrEarlierVersionOf addr 0xf144f8 size 0x58 virtual false final false
 bool IsEqualOrEarlierVersionOf(Org::BouncyCastle::Crypto::Tls::ProtocolVersion version) ;

/// @brief Method IsLaterVersionOf addr 0xf14550 size 0x54 virtual false final false
 bool IsLaterVersionOf(Org::BouncyCastle::Crypto::Tls::ProtocolVersion version) ;

/// @brief Method Equals addr 0xf145a4 size 0x80 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method Equals addr 0xf14624 size 0x20 virtual false final false
 bool Equals(Org::BouncyCastle::Crypto::Tls::ProtocolVersion other) ;

/// @brief Method GetHashCode addr 0xf14644 size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Get addr 0xf1464c size 0x1f8 virtual false final false
static Org::BouncyCastle::Crypto::Tls::ProtocolVersion Get(int32_t major, int32_t minor) ;

/// @brief Method ToString addr 0xf149ac size 0x8 virtual true final false
 ::StringW ToString() ;

/// @brief Method GetUnknownVersion addr 0xf14844 size 0x168 virtual false final false
