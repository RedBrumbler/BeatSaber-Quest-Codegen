...
/// @brief Method .ctor addr 0xf21a90 size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0xf21ab0 size 0x18 virtual false final false
...
/// @brief Method .ctor addr 0xf21ac8 size 0x18 virtual false final false
 void _ctor(Org::BouncyCastle::Security::SecureRandom secureRandom) ;

/// @brief Method Connect addr 0xf21ae0 size 0x478 virtual true final false
 void Connect(Org::BouncyCastle::Crypto::Tls::TlsClient tlsClient) ;

/// @brief Method CleanupHandshake addr 0xf21f58 size 0x24 virtual true final false
 void CleanupHandshake() ;

/// @brief Method get_Context addr 0xf21f7c size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::TlsContext get_Context() ;

/// @brief Method get_ContextAdmin addr 0xf21f84 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::AbstractTlsContext get_ContextAdmin() ;

/// @brief Method get_Peer addr 0xf21f8c size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::TlsPeer get_Peer() ;

/// @brief Method HandleHandshakeMessage addr 0xf21f94 size 0x1260 virtual true final false
 void HandleHandshakeMessage(uint8_t type, System::IO::MemoryStream buf) ;

/// @brief Method HandleSupplementalData addr 0xf231f4 size 0x1b0 virtual true final false
 void HandleSupplementalData(System::Collections::IList serverSupplementalData) ;

/// @brief Method ReceiveNewSessionTicketMessage addr 0xf233a4 size 0xc0 virtual true final false
 void ReceiveNewSessionTicketMessage(System::IO::MemoryStream buf) ;

/// @brief Method ReceiveServerHelloMessage addr 0xf23464 size 0xea4 virtual true final false
 void ReceiveServerHelloMessage(System::IO::MemoryStream buf) ;

/// @brief Method SendCertificateVerifyMessage addr 0xf24308 size 0x8c virtual true final false
 void SendCertificateVerifyMessage(Org::BouncyCastle::Crypto::Tls::DigitallySigned certificateVerify) ;

/// @brief Method SendClientHelloMessage addr 0xf24394 size 0x6a0 virtual true final false
 void SendClientHelloMessage() ;

/// @brief Method SendClientKeyExchangeMessage addr 0xf24a34 size 0xe4 virtual true final false
