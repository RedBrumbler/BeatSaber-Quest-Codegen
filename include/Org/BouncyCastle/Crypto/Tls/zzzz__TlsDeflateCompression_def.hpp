...
/// @brief Method .ctor addr 0xf24c60 size 0x38 virtual false final false
 void _ctor(System::IO::Stream output, Org::BouncyCastle::Utilities::Zlib::ZStream z, bool compress) ;

/// @brief Method Flush addr 0xf24e3c size 0x4 virtual true final false
 void Flush() ;
...
/// @brief Method .ctor addr 0xf24b18 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "level", ty: "int32_t", modifiers: "", def_value: None }]
explicit TlsDeflateCompression(int32_t level) ;

/// @brief Method .ctor addr 0xf24b20 size 0xac virtual false final false
 void _ctor(int32_t level) ;

/// @brief Method Compress addr 0xf24bcc size 0x94 virtual true final false
 System::IO::Stream Compress(System::IO::Stream output) ;

/// @brief Method Decompress addr 0xf24c98 size 0x90 virtual true final false
