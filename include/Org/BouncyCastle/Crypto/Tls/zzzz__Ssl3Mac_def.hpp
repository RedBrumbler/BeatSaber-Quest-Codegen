...
/// @brief Method .ctor addr 0xf1999c size 0xcc virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method get_AlgorithmName addr 0xf19a68 size 0xc0 virtual true final false
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xf19b28 size 0xd8 virtual true final false
 void Init(Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method GetMacSize addr 0xf19c00 size 0xa4 virtual true final false
 int32_t GetMacSize() ;

/// @brief Method Update addr 0xf19ca4 size 0xac virtual true final false
 void Update(uint8_t input) ;

/// @brief Method BlockUpdate addr 0xf19d50 size 0xc4 virtual true final false
 void BlockUpdate(::ArrayW<uint8_t> input, int32_t inOff, int32_t len) ;

/// @brief Method DoFinal addr 0xf19e14 size 0x37c virtual true final false
 int32_t DoFinal(::ArrayW<uint8_t> output, int32_t outOff) ;

/// @brief Method Reset addr 0xf1a190 size 0x1d4 virtual true final false
 void Reset() ;

/// @brief Method GenPad addr 0xf1a364 size 0x98 virtual false final false
