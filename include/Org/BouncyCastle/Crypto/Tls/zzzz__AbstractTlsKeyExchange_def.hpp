...
/// @brief Method .ctor addr 0xedb1c4 size 0x30 virtual false final false
 void _ctor(int32_t keyExchange, System::Collections::IList supportedSignatureAlgorithms) ;

/// @brief Method ParseSignature addr 0xedb1f4 size 0x98 virtual true final false
 Org::BouncyCastle::Crypto::Tls::DigitallySigned ParseSignature(System::IO::Stream input) ;

/// @brief Method Init addr 0xedb368 size 0x218 virtual true final false
...
/// @brief Method ProcessServerCertificate addr 0xedb580 size 0x4 virtual true final false
 void ProcessServerCertificate(Org::BouncyCastle::Crypto::Tls::Certificate serverCertificate) ;

/// @brief Method ProcessServerCredentials addr 0xedb584 size 0xb8 virtual true final false
 void ProcessServerCredentials(Org::BouncyCastle::Crypto::Tls::TlsCredentials serverCredentials) ;

/// @brief Method get_RequiresServerKeyExchange addr 0xedb63c size 0x8 virtual true final false
 bool get_RequiresServerKeyExchange() ;

/// @brief Method GenerateServerKeyExchange addr 0xedb644 size 0x64 virtual true final false
 ::ArrayW<uint8_t> GenerateServerKeyExchange() ;

/// @brief Method SkipServerKeyExchange addr 0xedb6a8 size 0x60 virtual true final false
 void SkipServerKeyExchange() ;

/// @brief Method ProcessServerKeyExchange addr 0xedb708 size 0x60 virtual true final false
...
/// @brief Method SkipClientCredentials addr 0xedb768 size 0x4 virtual true final false
...
/// @brief Method ProcessClientCertificate addr 0xedb76c size 0x4 virtual true final false
...
/// @brief Method ProcessClientKeyExchange addr 0xedb770 size 0x44 virtual true final false
