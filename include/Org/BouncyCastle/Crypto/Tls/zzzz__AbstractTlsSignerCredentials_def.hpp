...
/// @brief Method get_SignatureAndHashAlgorithm addr 0xedc638 size 0x50 virtual true final false
 Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm get_SignatureAndHashAlgorithm() ;

// Ctor Parameters []
explicit AbstractTlsSignerCredentials() ;

/// @brief Method .ctor addr 0xedc688 size 0x8 virtual false final false
 void _ctor() ;
