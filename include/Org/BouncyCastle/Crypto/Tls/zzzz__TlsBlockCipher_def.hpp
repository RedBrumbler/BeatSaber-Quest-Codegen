...
/// @brief Method get_WriteMac addr 0xf1b984 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::TlsMac get_WriteMac() ;

/// @brief Method get_ReadMac addr 0xf1b98c size 0x8 virtual true final false
...
/// @brief Method .ctor addr 0xf1b994 size 0xb9c virtual false final false
...
/// @brief Method GetPlaintextLimit addr 0xf1c530 size 0x100 virtual true final false
 int32_t GetPlaintextLimit(int32_t ciphertextLimit) ;

/// @brief Method EncodePlaintext addr 0xf1c630 size 0x654 virtual true final false
 ::ArrayW<uint8_t> EncodePlaintext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> plaintext, int32_t offset, int32_t len) ;

/// @brief Method DecodeCiphertext addr 0xf1cc84 size 0x4b0 virtual true final false
 ::ArrayW<uint8_t> DecodeCiphertext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> ciphertext, int32_t offset, int32_t len) ;

/// @brief Method CheckPaddingConstantTime addr 0xf1d134 size 0x16c virtual true final false
 int32_t CheckPaddingConstantTime(::ArrayW<uint8_t> buf, int32_t off, int32_t len, int32_t blockSize, int32_t macSize) ;

/// @brief Method ChooseExtraPadBlocks addr 0xf1d2a0 size 0xa8 virtual true final false
 int32_t ChooseExtraPadBlocks(Org::BouncyCastle::Security::SecureRandom r, int32_t max) ;

/// @brief Method LowestBitSet addr 0xf1d348 size 0x28 virtual true final false
