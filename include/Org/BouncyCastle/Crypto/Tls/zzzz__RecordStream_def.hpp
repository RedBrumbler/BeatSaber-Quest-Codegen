...
/// @brief Method .ctor addr 0xf15484 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Tls::RecordStream mOuter) ;

/// @brief Method Write addr 0xf16808 size 0xcc virtual true final false
...
/// @brief Method NextValue addr 0xf16060 size 0x7c virtual false final false
 int64_t NextValue(uint8_t alertDescription) ;

// Ctor Parameters []
explicit Org__BouncyCastle__Crypto__Tls__RecordStream__SequenceNumber() ;

/// @brief Method .ctor addr 0xf15474 size 0x10 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xf15308 size 0x16c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Tls::TlsProtocol handler, System::IO::Stream input, System::IO::Stream output) ;

/// @brief Method Init addr 0xf154ac size 0x120 virtual true final false
 void Init(Org::BouncyCastle::Crypto::Tls::TlsContext context) ;

/// @brief Method GetPlaintextLimit addr 0xf155cc size 0x8 virtual true final false
 int32_t GetPlaintextLimit() ;

/// @brief Method SetPlaintextLimit addr 0xf155d4 size 0x1c virtual true final false
 void SetPlaintextLimit(int32_t plaintextLimit) ;

/// @brief Method get_ReadVersion addr 0xf155f0 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::ProtocolVersion get_ReadVersion() ;

/// @brief Method set_ReadVersion addr 0xf155f8 size 0x8 virtual true final false
 void set_ReadVersion(Org::BouncyCastle::Crypto::Tls::ProtocolVersion value) ;

/// @brief Method SetWriteVersion addr 0xf15600 size 0x8 virtual true final false
 void SetWriteVersion(Org::BouncyCastle::Crypto::Tls::ProtocolVersion writeVersion) ;

/// @brief Method SetRestrictReadVersion addr 0xf15608 size 0xc virtual true final false
 void SetRestrictReadVersion(bool enabled) ;

/// @brief Method SetPendingConnectionState addr 0xf15614 size 0xc virtual true final false
...
/// @brief Method SentWriteCipherSpec addr 0xf15620 size 0xc0 virtual true final false
 void SentWriteCipherSpec() ;

/// @brief Method ReceivedReadCipherSpec addr 0xf156e0 size 0xc0 virtual true final false
 void ReceivedReadCipherSpec() ;

/// @brief Method FinaliseHandshake addr 0xf157a0 size 0x84 virtual true final false
 void FinaliseHandshake() ;

/// @brief Method CheckRecordHeader addr 0xf15824 size 0x134 virtual true final false
 void CheckRecordHeader(::ArrayW<uint8_t> recordHeader) ;

/// @brief Method ReadRecord addr 0xf15a0c size 0x1b4 virtual true final false
 bool ReadRecord() ;

/// @brief Method DecodeAndVerify addr 0xf15dd4 size 0x28c virtual true final false
 ::ArrayW<uint8_t> DecodeAndVerify(uint8_t type, System::IO::Stream input, int32_t len) ;

/// @brief Method WriteRecord addr 0xf16130 size 0x3e8 virtual true final false
 void WriteRecord(uint8_t type, ::ArrayW<uint8_t> plaintext, int32_t plaintextOffset, int32_t plaintextLength) ;

/// @brief Method NotifyHelloComplete addr 0xf16518 size 0xac virtual true final false
 void NotifyHelloComplete() ;

/// @brief Method get_HandshakeHash addr 0xf165c4 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash get_HandshakeHash() ;

/// @brief Method get_HandshakeHashUpdater addr 0xf165cc size 0x8 virtual true final false
 System::IO::Stream get_HandshakeHashUpdater() ;

/// @brief Method PrepareToFinish addr 0xf165d4 size 0xb0 virtual true final false
 Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash PrepareToFinish() ;

/// @brief Method SafeClose addr 0xf16684 size 0x160 virtual true final false
 void SafeClose() ;

/// @brief Method Flush addr 0xf167e4 size 0x24 virtual true final false
 void Flush() ;

/// @brief Method GetBufferContents addr 0xf160dc size 0x54 virtual false final false
 ::ArrayW<uint8_t> GetBufferContents() ;

/// @brief Method CheckType addr 0xf15958 size 0x5c virtual false final false
static void CheckType(uint8_t type, uint8_t alertDescription) ;

/// @brief Method CheckLength addr 0xf159b4 size 0x58 virtual false final false
