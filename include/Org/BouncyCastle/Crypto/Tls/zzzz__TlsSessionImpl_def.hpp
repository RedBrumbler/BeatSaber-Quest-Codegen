...
/// @brief Method .ctor addr 0xf389ac size 0x140 virtual false final false
 void _ctor(::ArrayW<uint8_t> sessionID, Org::BouncyCastle::Crypto::Tls::SessionParameters sessionParameters) ;

/// @brief Method ExportSessionParameters addr 0xf38aec size 0xb4 virtual true final false
 Org::BouncyCastle::Crypto::Tls::SessionParameters ExportSessionParameters() ;

/// @brief Method get_SessionID addr 0xf38ba0 size 0x34 virtual true final false
 ::ArrayW<uint8_t> get_SessionID() ;

/// @brief Method Invalidate addr 0xf38bd4 size 0x24 virtual true final false
 void Invalidate() ;

/// @brief Method get_IsResumable addr 0xf38bf8 size 0x34 virtual true final false
