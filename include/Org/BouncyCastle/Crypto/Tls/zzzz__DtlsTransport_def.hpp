...
/// @brief Method .ctor addr 0xf12838 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer recordLayer) ;

/// @brief Method GetReceiveLimit addr 0xf12860 size 0x24 virtual true final false
 int32_t GetReceiveLimit() ;

/// @brief Method GetSendLimit addr 0xf12884 size 0x24 virtual true final false
 int32_t GetSendLimit() ;

/// @brief Method Receive addr 0xf128a8 size 0x39c virtual true final false
 int32_t Receive(::ArrayW<uint8_t> buf, int32_t off, int32_t len, int32_t waitMillis) ;

/// @brief Method Send addr 0xf12c44 size 0x348 virtual true final false
 void Send(::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method Close addr 0xf12f8c size 0x24 virtual true final false
 void Close() ;
