...
/// @brief Method .ctor addr 0xedce34 size 0x8c virtual false final false
...
/// @brief Method .ctor addr 0xedcec0 size 0x8c virtual false final false
 void _ctor(::StringW identity, ::ArrayW<uint8_t> psk) ;

/// @brief Method SkipIdentityHint addr 0xedcf4c size 0x4 virtual true final false
 void SkipIdentityHint() ;

/// @brief Method NotifyIdentityHint addr 0xedcf50 size 0x4 virtual true final false
 void NotifyIdentityHint(::ArrayW<uint8_t> psk_identity_hint) ;

/// @brief Method GetPskIdentity addr 0xedcf54 size 0x8 virtual true final false
 ::ArrayW<uint8_t> GetPskIdentity() ;

/// @brief Method GetPsk addr 0xedcf5c size 0x5c virtual true final false
