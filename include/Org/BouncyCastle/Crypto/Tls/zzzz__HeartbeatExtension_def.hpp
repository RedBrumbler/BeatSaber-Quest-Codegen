...
/// @brief Method .ctor addr 0xf13324 size 0x98 virtual false final false
 void _ctor(uint8_t mode) ;

/// @brief Method get_Mode addr 0xf133d0 size 0x8 virtual true final false
 uint8_t get_Mode() ;

/// @brief Method Encode addr 0xf133d8 size 0x6c virtual true final false
 void Encode(System::IO::Stream output) ;

/// @brief Method Parse addr 0xf13444 size 0xe4 virtual false final false
