...
/// @brief Method .ctor addr 0xee2968 size 0x2d4 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Tls::Certificate certificate, Org::BouncyCastle::Crypto::AsymmetricKeyParameter privateKey) ;

/// @brief Method get_Certificate addr 0xee2c3c size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::Certificate get_Certificate() ;

/// @brief Method GenerateAgreement addr 0xee2c44 size 0x1b0 virtual true final false
