...
/// @brief Method Compress addr 0xf31280 size 0x8 virtual true final false
 System::IO::Stream Compress(System::IO::Stream output) ;

/// @brief Method Decompress addr 0xf31288 size 0x8 virtual true final false
 System::IO::Stream Decompress(System::IO::Stream output) ;

// Ctor Parameters []
explicit TlsNullCompression() ;

/// @brief Method .ctor addr 0xf31290 size 0x8 virtual false final false
 void _ctor() ;
