...
/// @brief Method CreateSigner addr 0xf38c2c size 0xfc virtual false final false
...
/// @brief Method .ctor addr 0xf38d28 size 0x94 virtual false final false
...
/// @brief Method .ctor addr 0xf38dbc size 0xc4 virtual false final false
...
/// @brief Method .ctor addr 0xf38e80 size 0xf8 virtual false final false
...
/// @brief Method Init addr 0xf38f78 size 0xc0 virtual true final false
 void Init(Org::BouncyCastle::Crypto::Tls::TlsContext context) ;

/// @brief Method SkipServerCredentials addr 0xf39038 size 0x50 virtual true final false
 void SkipServerCredentials() ;

/// @brief Method ProcessServerCertificate addr 0xf39088 size 0x278 virtual true final false
 void ProcessServerCertificate(Org::BouncyCastle::Crypto::Tls::Certificate serverCertificate) ;

/// @brief Method ProcessServerCredentials addr 0xf39300 size 0x174 virtual true final false
 void ProcessServerCredentials(Org::BouncyCastle::Crypto::Tls::TlsCredentials serverCredentials) ;

/// @brief Method get_RequiresServerKeyExchange addr 0xf39474 size 0x8 virtual true final false
 bool get_RequiresServerKeyExchange() ;

/// @brief Method GenerateServerKeyExchange addr 0xf3947c size 0x534 virtual true final false
 ::ArrayW<uint8_t> GenerateServerKeyExchange() ;

/// @brief Method ProcessServerKeyExchange addr 0xf399b0 size 0x538 virtual true final false
 void ProcessServerKeyExchange(System::IO::Stream input) ;

/// @brief Method ValidateCertificateRequest addr 0xf39ee8 size 0x40 virtual true final false
 void ValidateCertificateRequest(Org::BouncyCastle::Crypto::Tls::CertificateRequest certificateRequest) ;

/// @brief Method ProcessClientCredentials addr 0xf39f28 size 0x40 virtual true final false
 void ProcessClientCredentials(Org::BouncyCastle::Crypto::Tls::TlsCredentials clientCredentials) ;

/// @brief Method GenerateClientKeyExchange addr 0xf39f68 size 0x114 virtual true final false
 void GenerateClientKeyExchange(System::IO::Stream output) ;

/// @brief Method ProcessClientKeyExchange addr 0xf3a0f4 size 0x1d4 virtual true final false
 void ProcessClientKeyExchange(System::IO::Stream input) ;

/// @brief Method GeneratePremasterSecret addr 0xf3a364 size 0x118 virtual true final false
 ::ArrayW<uint8_t> GeneratePremasterSecret() ;

/// @brief Method InitVerifyer addr 0xf3a47c size 0x1d0 virtual true final false
