...
/// @brief Method .ctor addr 0xf3096c size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0xf30998 size 0x458 virtual false final false
...
/// @brief Method GetPlaintextLimit addr 0xf30f90 size 0x2c virtual true final false
 int32_t GetPlaintextLimit(int32_t ciphertextLimit) ;

/// @brief Method EncodePlaintext addr 0xf30fbc size 0x130 virtual true final false
 ::ArrayW<uint8_t> EncodePlaintext(int64_t seqNo, uint8_t type, ::ArrayW<uint8_t> plaintext, int32_t offset, int32_t len) ;

/// @brief Method DecodeCiphertext addr 0xf310ec size 0x194 virtual true final false
