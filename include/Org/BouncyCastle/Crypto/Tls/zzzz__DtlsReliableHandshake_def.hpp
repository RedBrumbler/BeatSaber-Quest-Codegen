...
/// @brief Method .ctor addr 0xeef988 size 0x40 virtual false final false
 void _ctor(int32_t message_seq, uint8_t msg_type, ::ArrayW<uint8_t> body) ;

/// @brief Method get_Seq addr 0xef0f04 size 0x8 virtual false final false
 int32_t get_Seq() ;

/// @brief Method get_Type addr 0xef0f0c size 0x8 virtual false final false
 uint8_t get_Type() ;

/// @brief Method get_Body addr 0xef0f14 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xef0e48 size 0x8 virtual false final false
 void _ctor(int32_t size) ;

/// @brief Method SendToRecordLayer addr 0xef0e50 size 0xb4 virtual false final false
...
/// @brief Method .ctor addr 0xef0544 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Tls::DtlsReliableHandshake outer) ;

/// @brief Method ReceivedHandshakeRecord addr 0xef0f1c size 0x2c virtual true final true
...
/// @brief Method .ctor addr 0xeea738 size 0x14c virtual false final false
...
/// @brief Method NotifyHelloComplete addr 0xeeaf1c size 0xac virtual false final false
 void NotifyHelloComplete() ;

/// @brief Method get_HandshakeHash addr 0xeef5f8 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash get_HandshakeHash() ;

/// @brief Method PrepareToFinish addr 0xeeb0d8 size 0xb0 virtual false final false
 Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash PrepareToFinish() ;

/// @brief Method SendMessage addr 0xeea884 size 0x1d0 virtual false final false
 void SendMessage(uint8_t msg_type, ::ArrayW<uint8_t> body) ;

/// @brief Method ReceiveMessageBody addr 0xeeafc8 size 0x6c virtual false final false
 ::ArrayW<uint8_t> ReceiveMessageBody(uint8_t msg_type) ;

/// @brief Method ReceiveMessage addr 0xeeaa54 size 0x2f4 virtual false final false
 Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsReliableHandshake__Message ReceiveMessage() ;

/// @brief Method Finish addr 0xeeb034 size 0xa4 virtual false final false
 void Finish() ;

/// @brief Method ResetHandshakeMessagesDigest addr 0xeeae78 size 0xa4 virtual false final false
 void ResetHandshakeMessagesDigest() ;

/// @brief Method BackOff addr 0xef056c size 0x5c virtual false final false
 int32_t BackOff(int32_t timeoutMillis) ;

/// @brief Method CheckInboundFlight addr 0xeef600 size 0x388 virtual false final false
 void CheckInboundFlight() ;

/// @brief Method GetPendingMessage addr 0xeefd18 size 0x19c virtual false final false
 Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsReliableHandshake__Message GetPendingMessage() ;

/// @brief Method PrepareInboundFlight addr 0xeefcec size 0x2c virtual false final false
 void PrepareInboundFlight(System::Collections::IDictionary nextFlight) ;

/// @brief Method ProcessRecord addr 0xef00b4 size 0x490 virtual false final false
 void ProcessRecord(int32_t windowSize, int32_t epoch, ::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method ResendOutboundFlight addr 0xeefeb4 size 0x200 virtual false final false
 void ResendOutboundFlight() ;

/// @brief Method UpdateHandshakeMessagesDigest addr 0xeefadc size 0x210 virtual false final false
...
/// @brief Method WriteMessage addr 0xeef9c8 size 0x114 virtual false final false
 void WriteMessage(Org::BouncyCastle::Crypto::Tls::Org__BouncyCastle__Crypto__Tls__DtlsReliableHandshake__Message message) ;

/// @brief Method WriteHandshakeFragment addr 0xef0d20 size 0x128 virtual false final false
...
/// @brief Method CheckAll addr 0xef0964 size 0x3bc virtual false final false
static bool CheckAll(System::Collections::IDictionary inboundFlight) ;

/// @brief Method ResetAll addr 0xef05c8 size 0x39c virtual false final false
