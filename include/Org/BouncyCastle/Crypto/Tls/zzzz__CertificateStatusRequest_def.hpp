...
/// @brief Method .ctor addr 0xedfd38 size 0xa0 virtual false final false
 void _ctor(uint8_t statusType, ::bs_hook::Il2CppWrapperType request) ;

/// @brief Method get_StatusType addr 0xedfec0 size 0x8 virtual true final false
 uint8_t get_StatusType() ;

/// @brief Method get_Request addr 0xedfec8 size 0x8 virtual true final false
 ::bs_hook::Il2CppWrapperType get_Request() ;

/// @brief Method GetOcspStatusRequest addr 0xedfed0 size 0xd4 virtual true final false
 Org::BouncyCastle::Crypto::Tls::OcspStatusRequest GetOcspStatusRequest() ;

/// @brief Method Encode addr 0xedffa4 size 0x13c virtual true final false
 void Encode(System::IO::Stream output) ;

/// @brief Method Parse addr 0xee00e0 size 0xf4 virtual false final false
static Org::BouncyCastle::Crypto::Tls::CertificateStatusRequest Parse(System::IO::Stream input) ;

/// @brief Method IsCorrectType addr 0xedfdd8 size 0xe8 virtual false final false
