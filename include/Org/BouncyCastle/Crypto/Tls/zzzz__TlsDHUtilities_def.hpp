...
/// @brief Method FromHex addr 0xf2756c size 0xa0 virtual false final false
static Org::BouncyCastle::Math::BigInteger FromHex(::StringW hex) ;

/// @brief Method FromSafeP addr 0xf2760c size 0xc8 virtual false final false
static Org::BouncyCastle::Crypto::Parameters::DHParameters FromSafeP(::StringW hexP) ;

/// @brief Method AddNegotiatedDheGroupsClientExtension addr 0xf276d4 size 0x14c virtual false final false
static void AddNegotiatedDheGroupsClientExtension(System::Collections::IDictionary extensions, ::ArrayW<uint8_t> dheGroups) ;

/// @brief Method AddNegotiatedDheGroupsServerExtension addr 0xf278cc size 0x14c virtual false final false
static void AddNegotiatedDheGroupsServerExtension(System::Collections::IDictionary extensions, uint8_t dheGroup) ;

/// @brief Method GetNegotiatedDheGroupsClientExtension addr 0xf27a70 size 0xd0 virtual false final false
static ::ArrayW<uint8_t> GetNegotiatedDheGroupsClientExtension(System::Collections::IDictionary extensions) ;

/// @brief Method GetNegotiatedDheGroupsServerExtension addr 0xf27bf0 size 0xd4 virtual false final false
static int16_t GetNegotiatedDheGroupsServerExtension(System::Collections::IDictionary extensions) ;

/// @brief Method CreateNegotiatedDheGroupsClientExtension addr 0xf27820 size 0xac virtual false final false
static ::ArrayW<uint8_t> CreateNegotiatedDheGroupsClientExtension(::ArrayW<uint8_t> dheGroups) ;

/// @brief Method CreateNegotiatedDheGroupsServerExtension addr 0xf27a18 size 0x58 virtual false final false
static ::ArrayW<uint8_t> CreateNegotiatedDheGroupsServerExtension(uint8_t dheGroup) ;

/// @brief Method ReadNegotiatedDheGroupsClientExtension addr 0xf27b40 size 0xb0 virtual false final false
static ::ArrayW<uint8_t> ReadNegotiatedDheGroupsClientExtension(::ArrayW<uint8_t> extensionData) ;

/// @brief Method ReadNegotiatedDheGroupsServerExtension addr 0xf27cc4 size 0x58 virtual false final false
static uint8_t ReadNegotiatedDheGroupsServerExtension(::ArrayW<uint8_t> extensionData) ;

/// @brief Method GetParametersForDHEGroup addr 0xf27d1c size 0xfc virtual false final false
static Org::BouncyCastle::Crypto::Parameters::DHParameters GetParametersForDHEGroup(int16_t dheGroup) ;

/// @brief Method ContainsDheCipherSuites addr 0xf27e18 size 0xb0 virtual false final false
static bool ContainsDheCipherSuites(::ArrayW<int32_t> cipherSuites) ;

/// @brief Method IsDheCipherSuite addr 0xf27ec8 size 0x13c virtual false final false
static bool IsDheCipherSuite(int32_t cipherSuite) ;

/// @brief Method AreCompatibleParameters addr 0xf28004 size 0x90 virtual false final false
...
/// @brief Method CalculateDHBasicAgreement addr 0xf269e0 size 0x94 virtual false final false
...
/// @brief Method GenerateDHKeyPair addr 0xf28094 size 0xbc virtual false final false
...
/// @brief Method GenerateEphemeralClientKeyExchange addr 0xf26690 size 0x11c virtual false final false
...
/// @brief Method GenerateEphemeralServerKeyExchange addr 0xf25f88 size 0x144 virtual false final false
...
/// @brief Method ReadDHParameter addr 0xf2630c size 0xa0 virtual false final false
static Org::BouncyCastle::Math::BigInteger ReadDHParameter(System::IO::Stream input) ;

/// @brief Method ReadDHParameters addr 0xf28240 size 0xa8 virtual false final false
static Org::BouncyCastle::Crypto::Parameters::DHParameters ReadDHParameters(System::IO::Stream input) ;

/// @brief Method ReceiveDHParameters addr 0xf261e4 size 0x128 virtual false final false
...
/// @brief Method WriteDHParameter addr 0xf28150 size 0x7c virtual false final false
static void WriteDHParameter(Org::BouncyCastle::Math::BigInteger x, System::IO::Stream output) ;

/// @brief Method WriteDHParameters addr 0xf281cc size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0xf28454 size 0x8 virtual false final false
 void _ctor() ;
