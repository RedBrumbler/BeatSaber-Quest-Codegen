...
/// @brief Method .ctor addr 0xf3aff4 size 0x6c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Tls::TlsProtocol handler) ;

/// @brief Method get_CanRead addr 0xf3b060 size 0x30 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanSeek addr 0xf3b090 size 0x8 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_CanWrite addr 0xf3b098 size 0x30 virtual true final false
 bool get_CanWrite() ;

/// @brief Method Close addr 0xf3b0c8 size 0x34 virtual true final false
 void Close() ;

/// @brief Method Flush addr 0xf3b0fc size 0x24 virtual true final false
 void Flush() ;

/// @brief Method get_Length addr 0xf3b120 size 0x40 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0xf3b160 size 0x40 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0xf3b1a0 size 0x40 virtual true final false
 void set_Position(int64_t value) ;

/// @brief Method Read addr 0xf3b1e0 size 0x24 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method ReadByte addr 0xf3b204 size 0x98 virtual true final false
 int32_t ReadByte() ;

/// @brief Method Seek addr 0xf3b29c size 0x40 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0xf3b2dc size 0x40 virtual true final false
 void SetLength(int64_t value) ;

/// @brief Method Write addr 0xf3b31c size 0x24 virtual true final false
 void Write(::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method WriteByte addr 0xf3b340 size 0x94 virtual true final false
