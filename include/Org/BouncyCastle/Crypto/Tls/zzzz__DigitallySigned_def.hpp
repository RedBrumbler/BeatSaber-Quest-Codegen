...
/// @brief Method .ctor addr 0xee8548 size 0x7c virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm algorithm, ::ArrayW<uint8_t> signature) ;

/// @brief Method get_Algorithm addr 0xee85c4 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::SignatureAndHashAlgorithm get_Algorithm() ;

/// @brief Method get_Signature addr 0xee85cc size 0x8 virtual true final false
 ::ArrayW<uint8_t> get_Signature() ;

/// @brief Method Encode addr 0xee85d4 size 0x7c virtual true final false
 void Encode(System::IO::Stream output) ;

/// @brief Method Parse addr 0xedb28c size 0xdc virtual false final false
