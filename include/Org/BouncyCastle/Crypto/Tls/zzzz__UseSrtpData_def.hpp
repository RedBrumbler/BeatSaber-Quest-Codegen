...
/// @brief Method .ctor addr 0xf3aeb4 size 0x138 virtual false final false
 void _ctor(::ArrayW<int32_t> protectionProfiles, ::ArrayW<uint8_t> mki) ;

/// @brief Method get_ProtectionProfiles addr 0xf41d1c size 0x8 virtual true final false
 ::ArrayW<int32_t> get_ProtectionProfiles() ;

/// @brief Method get_Mki addr 0xf41d24 size 0x8 virtual true final false
