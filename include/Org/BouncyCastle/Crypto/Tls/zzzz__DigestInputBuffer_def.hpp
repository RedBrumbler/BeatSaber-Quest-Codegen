...
/// @brief Method .ctor addr 0xee83b0 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IDigest d) ;

/// @brief Method WriteByte addr 0xee83d8 size 0xac virtual true final false
 void WriteByte(uint8_t b) ;

/// @brief Method Write addr 0xee8484 size 0xc4 virtual true final false
...
/// @brief Method UpdateDigest addr 0xee692c size 0x78 virtual false final false
 void UpdateDigest(Org::BouncyCastle::Crypto::IDigest d) ;

// Ctor Parameters []
explicit DigestInputBuffer() ;

/// @brief Method .ctor addr 0xee6664 size 0x8 virtual false final false
 void _ctor() ;
