...
/// @brief Method .ctor addr 0xee6120 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xee618c size 0x28 virtual false final false
 void _ctor(System::Collections::IList groups) ;

/// @brief Method Accept addr 0xee61b4 size 0x358 virtual true final false
 bool Accept(Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters group) ;

/// @brief Method AreGroupsEqual addr 0xee650c size 0x78 virtual true final false
...
/// @brief Method AreParametersEqual addr 0xee6584 size 0x3c virtual true final false
