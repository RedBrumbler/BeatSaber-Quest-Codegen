...
/// @brief Method .ctor addr 0xedb7b4 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xedb820 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Tls::TlsCipherFactory cipherFactory) ;

/// @brief Method get_AllowEncryptThenMac addr 0xedb848 size 0x8 virtual true final false
 bool get_AllowEncryptThenMac() ;

/// @brief Method get_AllowTruncatedHMac addr 0xedb850 size 0x8 virtual true final false
 bool get_AllowTruncatedHMac() ;

/// @brief Method CheckServerExtensions addr 0xedb858 size 0x20 virtual true final false
...
/// @brief Method GetCompressionMethods addr 0xedb878 size 0x44 virtual false final false
 ::ArrayW<uint8_t> GetCompressionMethods() ;

/// @brief Method get_MaximumVersion addr 0xedb8bc size 0x58 virtual true final false
 Org::BouncyCastle::Crypto::Tls::ProtocolVersion get_MaximumVersion() ;

/// @brief Method get_MinimumVersion addr 0xedb914 size 0x58 virtual true final false
 Org::BouncyCastle::Crypto::Tls::ProtocolVersion get_MinimumVersion() ;

/// @brief Method SupportsClientEccCapabilities addr 0xedb96c size 0xf4 virtual true final false
 bool SupportsClientEccCapabilities(::ArrayW<int32_t> namedCurves, ::ArrayW<uint8_t> ecPointFormats) ;

/// @brief Method Init addr 0xedba60 size 0x8 virtual true final false
 void Init(Org::BouncyCastle::Crypto::Tls::TlsServerContext context) ;

/// @brief Method NotifyClientVersion addr 0xedba68 size 0x8 virtual true final false
 void NotifyClientVersion(Org::BouncyCastle::Crypto::Tls::ProtocolVersion clientVersion) ;

/// @brief Method NotifyFallback addr 0xedba70 size 0x7c virtual true final false
 void NotifyFallback(bool isFallback) ;

/// @brief Method NotifyOfferedCipherSuites addr 0xedbaec size 0x74 virtual true final false
 void NotifyOfferedCipherSuites(::ArrayW<int32_t> offeredCipherSuites) ;

/// @brief Method NotifyOfferedCompressionMethods addr 0xedbb60 size 0x8 virtual true final false
 void NotifyOfferedCompressionMethods(::ArrayW<uint8_t> offeredCompressionMethods) ;

/// @brief Method ProcessClientExtensions addr 0xedbb68 size 0x168 virtual true final false
 void ProcessClientExtensions(System::Collections::IDictionary clientExtensions) ;

/// @brief Method GetServerVersion addr 0xedbcd0 size 0xe0 virtual true final false
 Org::BouncyCastle::Crypto::Tls::ProtocolVersion GetServerVersion() ;

/// @brief Method GetSelectedCipherSuite addr 0xedbdb0 size 0x200 virtual true final false
 int32_t GetSelectedCipherSuite() ;

/// @brief Method GetSelectedCompressionMethod addr 0xedbfb0 size 0x118 virtual true final false
 uint8_t GetSelectedCompressionMethod() ;

/// @brief Method GetServerExtensions addr 0xedc0c8 size 0x20c virtual true final false
 System::Collections::IDictionary GetServerExtensions() ;

/// @brief Method GetServerSupplementalData addr 0xedc2d4 size 0x8 virtual true final false
...
/// @brief Method GetCertificateStatus addr 0xedc2dc size 0x8 virtual true final false
...
/// @brief Method GetCertificateRequest addr 0xedc2e4 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::CertificateRequest GetCertificateRequest() ;

/// @brief Method ProcessClientSupplementalData addr 0xedc2ec size 0x4c virtual true final false
 void ProcessClientSupplementalData(System::Collections::IList clientSupplementalData) ;

/// @brief Method NotifyClientCertificate addr 0xedc338 size 0x44 virtual true final false
 void NotifyClientCertificate(Org::BouncyCastle::Crypto::Tls::Certificate clientCertificate) ;

/// @brief Method GetCompression addr 0xedc37c size 0xa8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::TlsCompression GetCompression() ;

/// @brief Method GetCipher addr 0xedc424 size 0x104 virtual true final false
 Org::BouncyCastle::Crypto::Tls::TlsCipher GetCipher() ;

/// @brief Method GetNewSessionTicket addr 0xedc528 size 0x94 virtual true final false
