...
/// @brief Method .ctor addr 0xedf868 size 0xa0 virtual false final false
 void _ctor(uint8_t statusType, ::bs_hook::Il2CppWrapperType response) ;

/// @brief Method get_StatusType addr 0xedf9f0 size 0x8 virtual true final false
 uint8_t get_StatusType() ;

/// @brief Method get_Response addr 0xedf9f8 size 0x8 virtual true final false
 ::bs_hook::Il2CppWrapperType get_Response() ;

/// @brief Method GetOcspResponse addr 0xedfa00 size 0xd4 virtual true final false
 Org::BouncyCastle::Asn1::Ocsp::OcspResponse GetOcspResponse() ;

/// @brief Method Encode addr 0xedfad4 size 0x150 virtual true final false
 void Encode(System::IO::Stream output) ;

/// @brief Method Parse addr 0xedfc24 size 0x114 virtual false final false
static Org::BouncyCastle::Crypto::Tls::CertificateStatus Parse(System::IO::Stream input) ;

/// @brief Method IsCorrectType addr 0xedf908 size 0xe8 virtual false final false
