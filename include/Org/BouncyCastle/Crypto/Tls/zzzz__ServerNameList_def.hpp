...
/// @brief Method .ctor addr 0xf16e64 size 0x78 virtual false final false
 void _ctor(System::Collections::IList serverNameList) ;

/// @brief Method get_ServerNames addr 0xf16edc size 0x8 virtual true final false
 System::Collections::IList get_ServerNames() ;

/// @brief Method Encode addr 0xf16ee4 size 0x4bc virtual true final false
 void Encode(System::IO::Stream output) ;

/// @brief Method Parse addr 0xf1743c size 0x29c virtual false final false
static Org::BouncyCastle::Crypto::Tls::ServerNameList Parse(System::IO::Stream input) ;

/// @brief Method CheckNameType addr 0xf173a0 size 0x9c virtual false final false
