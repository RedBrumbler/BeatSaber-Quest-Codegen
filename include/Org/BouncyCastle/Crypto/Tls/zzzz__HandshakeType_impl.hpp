...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Org::BouncyCastle::Crypto::Tls::HandshakeType::*)()>(&Org::BouncyCastle::Crypto::Tls::HandshakeType::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0xf130bc;
...
// Ctor Parameters []
 Org::BouncyCastle::Crypto::Tls::HandshakeType::HandshakeType()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<HandshakeType>())) {}
