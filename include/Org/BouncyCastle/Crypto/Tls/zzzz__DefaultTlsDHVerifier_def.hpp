...
/// @brief Method AddDefaultGroup addr 0xee450c size 0xd4 virtual false final false
static void AddDefaultGroup(Org::BouncyCastle::Crypto::Parameters::DHParameters dhParameters) ;

// Ctor Parameters []
explicit DefaultTlsDHVerifier() ;

/// @brief Method .ctor addr 0xee4058 size 0x60 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xee4734 size 0x7c virtual false final false
...
/// @brief Method .ctor addr 0xee47b0 size 0x30 virtual false final false
 void _ctor(System::Collections::IList groups, int32_t minimumPrimeBits) ;

/// @brief Method Accept addr 0xee47e0 size 0x4c virtual true final false
 bool Accept(Org::BouncyCastle::Crypto::Parameters::DHParameters dhParameters) ;

/// @brief Method get_MinimumPrimeBits addr 0xee482c size 0x8 virtual true final false
 int32_t get_MinimumPrimeBits() ;

/// @brief Method AreGroupsEqual addr 0xee4834 size 0x78 virtual true final false
 bool AreGroupsEqual(Org::BouncyCastle::Crypto::Parameters::DHParameters a, Org::BouncyCastle::Crypto::Parameters::DHParameters b) ;

/// @brief Method AreParametersEqual addr 0xee48ac size 0x3c virtual true final false
 bool AreParametersEqual(Org::BouncyCastle::Math::BigInteger a, Org::BouncyCastle::Math::BigInteger b) ;

/// @brief Method CheckGroup addr 0xee48e8 size 0x374 virtual true final false
 bool CheckGroup(Org::BouncyCastle::Crypto::Parameters::DHParameters dhParameters) ;

/// @brief Method CheckMinimumPrimeBits addr 0xee4c5c size 0x4c virtual true final false
