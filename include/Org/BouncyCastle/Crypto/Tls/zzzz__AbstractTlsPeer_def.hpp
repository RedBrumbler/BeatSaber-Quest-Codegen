...
/// @brief Method Cancel addr 0xed9fbc size 0xac virtual true final false
 void Cancel() ;

/// @brief Method NotifyCloseHandle addr 0xeda068 size 0x24 virtual true final false
 void NotifyCloseHandle(Org::BouncyCastle::Crypto::Tls::TlsCloseable closeHandle) ;

/// @brief Method GetHandshakeTimeoutMillis addr 0xeda08c size 0x8 virtual true final false
 int32_t GetHandshakeTimeoutMillis() ;

/// @brief Method RequiresExtendedMasterSecret addr 0xeda094 size 0x8 virtual true final false
 bool RequiresExtendedMasterSecret() ;

/// @brief Method ShouldUseGmtUnixTime addr 0xeda09c size 0x8 virtual true final false
 bool ShouldUseGmtUnixTime() ;

/// @brief Method NotifySecureRenegotiation addr 0xeda0a4 size 0x4c virtual true final false
...
/// @brief Method NotifyAlertRaised addr 0xeda0f0 size 0x4 virtual true final false
 void NotifyAlertRaised(uint8_t alertLevel, uint8_t alertDescription, ::StringW message, System::Exception cause) ;

/// @brief Method NotifyAlertReceived addr 0xeda0f4 size 0x4 virtual true final false
 void NotifyAlertReceived(uint8_t alertLevel, uint8_t alertDescription) ;

/// @brief Method NotifyHandshakeComplete addr 0xeda0f8 size 0x4 virtual true final false
 void NotifyHandshakeComplete() ;

// Ctor Parameters []
explicit AbstractTlsPeer() ;

/// @brief Method .ctor addr 0xeda0fc size 0x8 virtual false final false
 void _ctor() ;
