...
/// @brief Method .ctor addr 0xf186c8 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::ISigner s) ;

/// @brief Method WriteByte addr 0xf186f8 size 0xac virtual true final false
 void WriteByte(uint8_t b) ;

/// @brief Method Write addr 0xf187a4 size 0xc4 virtual true final false
...
/// @brief Method UpdateSigner addr 0xf18650 size 0x78 virtual false final false
 void UpdateSigner(Org::BouncyCastle::Crypto::ISigner s) ;

// Ctor Parameters []
explicit SignerInputBuffer() ;

/// @brief Method .ctor addr 0xf186f0 size 0x8 virtual false final false
 void _ctor() ;
