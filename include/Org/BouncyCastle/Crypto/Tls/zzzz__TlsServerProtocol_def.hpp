...
/// @brief Method .ctor addr 0xf3446c size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0xf34490 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0xf344b4 size 0x24 virtual false final false
 void _ctor(Org::BouncyCastle::Security::SecureRandom secureRandom) ;

/// @brief Method Accept addr 0xf344d8 size 0x308 virtual true final false
 void Accept(Org::BouncyCastle::Crypto::Tls::TlsServer tlsServer) ;

/// @brief Method CleanupHandshake addr 0xf347e0 size 0x24 virtual true final false
 void CleanupHandshake() ;

/// @brief Method get_Context addr 0xf34804 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::TlsContext get_Context() ;

/// @brief Method get_ContextAdmin addr 0xf3480c size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::AbstractTlsContext get_ContextAdmin() ;

/// @brief Method get_Peer addr 0xf34814 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::TlsPeer get_Peer() ;

/// @brief Method HandleHandshakeMessage addr 0xf3481c size 0xcdc virtual true final false
 void HandleHandshakeMessage(uint8_t type, System::IO::MemoryStream buf) ;

/// @brief Method HandleAlertWarningMessage addr 0xf358c4 size 0x174 virtual true final false
 void HandleAlertWarningMessage(uint8_t alertDescription) ;

/// @brief Method NotifyClientCertificate addr 0xf35a38 size 0x2cc virtual true final false
 void NotifyClientCertificate(Org::BouncyCastle::Crypto::Tls::Certificate clientCertificate) ;

/// @brief Method ReceiveCertificateMessage addr 0xf36040 size 0x8c virtual true final false
 void ReceiveCertificateMessage(System::IO::MemoryStream buf) ;

/// @brief Method ReceiveCertificateVerifyMessage addr 0xf360cc size 0x4fc virtual true final false
 void ReceiveCertificateVerifyMessage(System::IO::MemoryStream buf) ;

/// @brief Method ReceiveClientHelloMessage addr 0xf36cc4 size 0x658 virtual true final false
 void ReceiveClientHelloMessage(System::IO::MemoryStream buf) ;

/// @brief Method ReceiveClientKeyExchangeMessage addr 0xf37764 size 0x2dc virtual true final false
 void ReceiveClientKeyExchangeMessage(System::IO::MemoryStream buf) ;

/// @brief Method SendCertificateRequestMessage addr 0xf37a40 size 0x90 virtual true final false
 void SendCertificateRequestMessage(Org::BouncyCastle::Crypto::Tls::CertificateRequest certificateRequest) ;

/// @brief Method SendCertificateStatusMessage addr 0xf37ad0 size 0x90 virtual true final false
 void SendCertificateStatusMessage(Org::BouncyCastle::Crypto::Tls::CertificateStatus certificateStatus) ;

/// @brief Method SendNewSessionTicketMessage addr 0xf37b60 size 0xc4 virtual true final false
 void SendNewSessionTicketMessage(Org::BouncyCastle::Crypto::Tls::NewSessionTicket newSessionTicket) ;

/// @brief Method SendServerHelloMessage addr 0xf37c24 size 0x874 virtual true final false
 void SendServerHelloMessage() ;

/// @brief Method SendServerHelloDoneMessage addr 0xf38754 size 0xc8 virtual true final false
 void SendServerHelloDoneMessage() ;

/// @brief Method SendServerKeyExchangeMessage addr 0xf38880 size 0x88 virtual true final false
 void SendServerKeyExchangeMessage(::ArrayW<uint8_t> serverKeyExchange) ;

/// @brief Method ExpectCertificateVerifyMessage addr 0xf38908 size 0x80 virtual true final false
