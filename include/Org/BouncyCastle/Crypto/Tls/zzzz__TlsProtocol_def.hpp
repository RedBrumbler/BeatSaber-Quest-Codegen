...
/// @brief Method .ctor addr 0xf20184 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xf20478 size 0x8c virtual false final false
 void _ctor(uint8_t handshakeType, int32_t length) ;

/// @brief Method Write addr 0xf21a68 size 0x28 virtual false final false
 void Write(::ArrayW<uint8_t> data) ;

/// @brief Method WriteToRecordStream addr 0xf2018c size 0x124 virtual false final false
...
/// @brief Method .ctor addr 0xf1d3e8 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0xf1d3f4 size 0x154 virtual false final false
...
/// @brief Method .ctor addr 0xf1d548 size 0x1a0 virtual false final false
...
/// @brief Method HandleAlertMessage addr 0xf1d6e8 size 0x13c virtual true final false
 void HandleAlertMessage(uint8_t alertLevel, uint8_t alertDescription) ;

/// @brief Method HandleAlertWarningMessage addr 0xf1d824 size 0x88 virtual true final false
 void HandleAlertWarningMessage(uint8_t alertDescription) ;

/// @brief Method HandleChangeCipherSpecMessage addr 0xf1d8ac size 0x4 virtual true final false
 void HandleChangeCipherSpecMessage() ;

/// @brief Method HandleClose addr 0xf1d8b0 size 0xfc virtual true final false
 void HandleClose(bool user_canceled) ;

/// @brief Method HandleException addr 0xf1d9ac size 0x78 virtual true final false
 void HandleException(uint8_t alertDescription, ::StringW message, System::Exception cause) ;

/// @brief Method HandleFailure addr 0xf1da24 size 0x84 virtual true final false
 void HandleFailure() ;
...
/// @brief Method ApplyMaxFragmentLengthExtension addr 0xf1daa8 size 0x98 virtual true final false
 void ApplyMaxFragmentLengthExtension() ;

/// @brief Method CheckReceivedChangeCipherSpec addr 0xf1db40 size 0x5c virtual true final false
 void CheckReceivedChangeCipherSpec(bool expected) ;

/// @brief Method CleanupHandshake addr 0xf1db9c size 0x9c virtual true final false
 void CleanupHandshake() ;

/// @brief Method BlockForHandshake addr 0xf1dc38 size 0x90 virtual true final false
 void BlockForHandshake() ;

/// @brief Method CompleteHandshake addr 0xf1dcc8 size 0x52c virtual true final false
 void CompleteHandshake() ;

/// @brief Method ProcessRecord addr 0xf15bc0 size 0x214 virtual false final false
 void ProcessRecord(uint8_t protocol, ::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method ProcessHandshakeQueue addr 0xf1e3c8 size 0x2dc virtual false final false
 void ProcessHandshakeQueue(Org::BouncyCastle::Crypto::Tls::ByteQueue queue) ;

/// @brief Method ProcessApplicationDataQueue addr 0xf1e264 size 0x4 virtual false final false
 void ProcessApplicationDataQueue() ;

/// @brief Method ProcessAlertQueue addr 0xf1e1f4 size 0x70 virtual false final false
 void ProcessAlertQueue() ;

/// @brief Method ProcessChangeCipherSpec addr 0xf1e268 size 0x160 virtual false final false
 void ProcessChangeCipherSpec(::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method ApplicationDataAvailable addr 0xf1e6a4 size 0x1c virtual true final false
 int32_t ApplicationDataAvailable() ;

/// @brief Method ReadApplicationData addr 0xf1e6c0 size 0x190 virtual true final false
 int32_t ReadApplicationData(::ArrayW<uint8_t> buf, int32_t offset, int32_t len) ;

/// @brief Method SafeCheckRecordHeader addr 0xf1e850 size 0x1d4 virtual true final false
 void SafeCheckRecordHeader(::ArrayW<uint8_t> recordHeader) ;

/// @brief Method SafeReadRecord addr 0xf1ea24 size 0x298 virtual true final false
 void SafeReadRecord() ;

/// @brief Method SafeWriteRecord addr 0xf1ecbc size 0x1d4 virtual true final false
 void SafeWriteRecord(uint8_t type, ::ArrayW<uint8_t> buf, int32_t offset, int32_t len) ;

/// @brief Method WriteData addr 0xf1ee90 size 0x1e8 virtual true final false
 void WriteData(::ArrayW<uint8_t> buf, int32_t offset, int32_t len) ;

/// @brief Method SetAppDataSplitMode addr 0xf1f078 size 0xb4 virtual true final false
 void SetAppDataSplitMode(int32_t appDataSplitMode) ;

/// @brief Method WriteHandshakeMessage addr 0xf1f12c size 0x190 virtual true final false
 void WriteHandshakeMessage(::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method get_Stream addr 0xf1f2bc size 0x64 virtual true final false
 System::IO::Stream get_Stream() ;

/// @brief Method CloseInput addr 0xf1f320 size 0x124 virtual true final false
 void CloseInput() ;

/// @brief Method OfferInput addr 0xf1f444 size 0x28 virtual true final false
 void OfferInput(::ArrayW<uint8_t> input) ;

/// @brief Method OfferInput addr 0xf1f46c size 0x244 virtual true final false
 void OfferInput(::ArrayW<uint8_t> input, int32_t inputOff, int32_t inputLen) ;

/// @brief Method GetAvailableInputBytes addr 0xf1f6b0 size 0x6c virtual true final false
 int32_t GetAvailableInputBytes() ;

/// @brief Method ReadInput addr 0xf1f71c size 0x100 virtual true final false
 int32_t ReadInput(::ArrayW<uint8_t> buffer, int32_t offset, int32_t length) ;

/// @brief Method OfferOutput addr 0xf1f81c size 0xe0 virtual true final false
 void OfferOutput(::ArrayW<uint8_t> buffer, int32_t offset, int32_t length) ;

/// @brief Method GetAvailableOutputBytes addr 0xf1f8fc size 0x78 virtual true final false
 int32_t GetAvailableOutputBytes() ;

/// @brief Method ReadOutput addr 0xf1f974 size 0x78 virtual true final false
 int32_t ReadOutput(::ArrayW<uint8_t> buffer, int32_t offset, int32_t length) ;

/// @brief Method InvalidateSession addr 0xf1f9ec size 0xb8 virtual true final false
 void InvalidateSession() ;

/// @brief Method ProcessFinishedMessage addr 0xf1faa4 size 0x11c virtual true final false
 void ProcessFinishedMessage(System::IO::MemoryStream buf) ;

/// @brief Method RaiseAlertFatal addr 0xf1fc48 size 0x1d0 virtual true final false
 void RaiseAlertFatal(uint8_t alertDescription, ::StringW message, System::Exception cause) ;

/// @brief Method RaiseAlertWarning addr 0xf1fe18 size 0x13c virtual true final false
 void RaiseAlertWarning(uint8_t alertDescription, ::StringW message) ;

/// @brief Method SendCertificateMessage addr 0xf1ff54 size 0x230 virtual true final false
 void SendCertificateMessage(Org::BouncyCastle::Crypto::Tls::Certificate certificate) ;

/// @brief Method SendChangeCipherSpecMessage addr 0xf202b0 size 0x98 virtual true final false
 void SendChangeCipherSpecMessage() ;

/// @brief Method SendFinishedMessage addr 0xf20348 size 0x130 virtual true final false
 void SendFinishedMessage() ;

/// @brief Method SendSupplementalDataMessage addr 0xf20504 size 0x80 virtual true final false
 void SendSupplementalDataMessage(System::Collections::IList supplementalData) ;

/// @brief Method CreateVerifyData addr 0xf209a4 size 0x120 virtual true final false
 ::ArrayW<uint8_t> CreateVerifyData(bool isServer) ;

/// @brief Method Close addr 0xf20c64 size 0x10 virtual true final false
 void Close() ;

/// @brief Method Flush addr 0xf20c74 size 0x24 virtual true final false
 void Flush() ;

/// @brief Method get_IsClosed addr 0xf20c98 size 0x18 virtual true final false
 bool get_IsClosed() ;

/// @brief Method ProcessMaxFragmentLengthExtension addr 0xf20cb0 size 0xb0 virtual true final false
...
/// @brief Method RefuseRenegotiation addr 0xf20d60 size 0xe4 virtual true final false
 void RefuseRenegotiation() ;

/// @brief Method AssertEmpty addr 0xf1fbc0 size 0x88 virtual false final false
static void AssertEmpty(System::IO::MemoryStream buf) ;

/// @brief Method CreateRandomBlock addr 0xf20e44 size 0x114 virtual false final false
...
/// @brief Method CreateRenegotiationInfo addr 0xf20f58 size 0x58 virtual false final false
static ::ArrayW<uint8_t> CreateRenegotiationInfo(::ArrayW<uint8_t> renegotiated_connection) ;

/// @brief Method EstablishMasterSecret addr 0xf20fb0 size 0x230 virtual false final false
...
/// @brief Method GetCurrentPrfHash addr 0xf20ac4 size 0x1a0 virtual false final false
...
/// @brief Method ReadExtensions addr 0xf17bdc size 0x308 virtual false final false
static System::Collections::IDictionary ReadExtensions(System::IO::MemoryStream input) ;

/// @brief Method ReadSupplementalDataMessage addr 0xf211e0 size 0x224 virtual false final false
static System::Collections::IList ReadSupplementalDataMessage(System::IO::MemoryStream input) ;

/// @brief Method WriteExtensions addr 0xf181a4 size 0xd4 virtual false final false
static void WriteExtensions(System::IO::Stream output, System::Collections::IDictionary extensions) ;

/// @brief Method WriteSelectedExtensions addr 0xf21404 size 0x4fc virtual false final false
static void WriteSelectedExtensions(System::IO::Stream output, System::Collections::IDictionary extensions, bool selectEmpty) ;

/// @brief Method WriteSupplementalData addr 0xf20584 size 0x420 virtual false final false
static void WriteSupplementalData(System::IO::Stream output, System::Collections::IList supplementalData) ;

/// @brief Method GetPrfAlgorithm addr 0xf21900 size 0x168 virtual false final false
