...
/// @brief Method ToTruncatedByteArray addr 0xf13a38 size 0xa8 virtual false final false
...
/// @brief Method .ctor addr 0xf13a30 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xf13528 size 0x130 virtual false final false
 void _ctor(uint8_t type, ::ArrayW<uint8_t> payload, int32_t paddingLength) ;

/// @brief Method Encode addr 0xf1366c size 0x1fc virtual true final false
 void Encode(Org::BouncyCastle::Crypto::Tls::TlsContext context, System::IO::Stream output) ;

/// @brief Method Parse addr 0xf13868 size 0x1c8 virtual false final false
