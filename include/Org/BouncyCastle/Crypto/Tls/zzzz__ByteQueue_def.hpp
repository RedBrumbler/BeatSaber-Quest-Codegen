...
/// @brief Method NextTwoPow addr 0xedcfc0 size 0x1c virtual false final false
static int32_t NextTwoPow(int32_t i) ;

// Ctor Parameters []
explicit ByteQueue() ;

/// @brief Method .ctor addr 0xedcfdc size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "capacity", ty: "int32_t", modifiers: "", def_value: None }]
explicit ByteQueue(int32_t capacity) ;

/// @brief Method .ctor addr 0xedcfe4 size 0xa0 virtual false final false
...
/// @brief Method .ctor addr 0xedd084 size 0x4c virtual false final false
 void _ctor(::ArrayW<uint8_t> buf, int32_t off, int32_t len) ;

/// @brief Method AddData addr 0xedd0d0 size 0x16c virtual false final false
 void AddData(::ArrayW<uint8_t> data, int32_t offset, int32_t len) ;

/// @brief Method get_Available addr 0xedd23c size 0x8 virtual false final false
 int32_t get_Available() ;

/// @brief Method CopyTo addr 0xedd244 size 0x1bc virtual false final false
 void CopyTo(System::IO::Stream output, int32_t length) ;

/// @brief Method Read addr 0xedd400 size 0x25c virtual false final false
 void Read(::ArrayW<uint8_t> buf, int32_t offset, int32_t len, int32_t skip) ;

/// @brief Method ReadFrom addr 0xedd65c size 0x200 virtual false final false
 System::IO::MemoryStream ReadFrom(int32_t length) ;

/// @brief Method RemoveData addr 0xedd85c size 0x1a4 virtual false final false
 void RemoveData(int32_t i) ;

/// @brief Method RemoveData addr 0xedda00 size 0x2c virtual false final false
 void RemoveData(::ArrayW<uint8_t> buf, int32_t off, int32_t len, int32_t skip) ;

/// @brief Method RemoveData addr 0xedda2c size 0x88 virtual false final false
 ::ArrayW<uint8_t> RemoveData(int32_t len, int32_t skip) ;

/// @brief Method Shrink addr 0xeddab4 size 0xe8 virtual false final false
 void Shrink() ;
