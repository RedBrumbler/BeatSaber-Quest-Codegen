...
/// @brief Method NextCounterValue addr 0xedaaa8 size 0x58 virtual false final false
...
/// @brief Method .ctor addr 0xedab00 size 0x324 virtual false final false
...
/// @brief Method get_NonceRandomGenerator addr 0xedae24 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Prng::IRandomGenerator get_NonceRandomGenerator() ;

/// @brief Method get_SecureRandom addr 0xedae2c size 0x8 virtual true final false
 Org::BouncyCastle::Security::SecureRandom get_SecureRandom() ;

/// @brief Method get_SecurityParameters addr 0xedae34 size 0x8 virtual true final false
...
/// @brief Method get_ClientVersion addr 0xedae3c size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::ProtocolVersion get_ClientVersion() ;

/// @brief Method SetClientVersion addr 0xedae44 size 0x8 virtual true final false
 void SetClientVersion(Org::BouncyCastle::Crypto::Tls::ProtocolVersion clientVersion) ;

/// @brief Method get_ServerVersion addr 0xedae4c size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::ProtocolVersion get_ServerVersion() ;

/// @brief Method SetServerVersion addr 0xedae54 size 0x8 virtual true final false
 void SetServerVersion(Org::BouncyCastle::Crypto::Tls::ProtocolVersion serverVersion) ;

/// @brief Method get_ResumableSession addr 0xedae5c size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::TlsSession get_ResumableSession() ;

/// @brief Method SetResumableSession addr 0xedae64 size 0x8 virtual true final false
 void SetResumableSession(Org::BouncyCastle::Crypto::Tls::TlsSession session) ;

/// @brief Method get_UserObject addr 0xedae6c size 0x8 virtual true final false
 ::bs_hook::Il2CppWrapperType get_UserObject() ;

/// @brief Method set_UserObject addr 0xedae74 size 0x8 virtual true final false
 void set_UserObject(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method ExportKeyingMaterial addr 0xedae7c size 0x2cc virtual true final false
