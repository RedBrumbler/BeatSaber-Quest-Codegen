...
/// @brief Method IsValid addr 0xf13b1c size 0x28 virtual false final false
static bool IsValid(int32_t namedCurve) ;

/// @brief Method RefersToASpecificNamedCurve addr 0xf13b44 size 0x14 virtual false final false
static bool RefersToASpecificNamedCurve(int32_t namedCurve) ;

// Ctor Parameters []
explicit NamedCurve() ;

/// @brief Method .ctor addr 0xf13b58 size 0x8 virtual false final false
 void _ctor() ;
