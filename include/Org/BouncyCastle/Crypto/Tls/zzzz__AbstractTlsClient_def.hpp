...
/// @brief Method .ctor addr 0xeda104 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xeda178 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::Tls::TlsCipherFactory cipherFactory) ;

/// @brief Method AllowUnexpectedServerExtension addr 0xeda1a0 size 0xb8 virtual true final false
 bool AllowUnexpectedServerExtension(int32_t extensionType, ::ArrayW<uint8_t> extensionData) ;

/// @brief Method CheckForUnexpectedServerExtension addr 0xeda258 size 0xd4 virtual true final false
 void CheckForUnexpectedServerExtension(System::Collections::IDictionary serverExtensions, int32_t extensionType) ;

/// @brief Method Init addr 0xeda32c size 0x8 virtual true final false
 void Init(Org::BouncyCastle::Crypto::Tls::TlsClientContext context) ;

/// @brief Method GetSessionToResume addr 0xeda334 size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::TlsSession GetSessionToResume() ;

/// @brief Method get_ClientHelloRecordLayerVersion addr 0xeda33c size 0x10 virtual true final false
 Org::BouncyCastle::Crypto::Tls::ProtocolVersion get_ClientHelloRecordLayerVersion() ;

/// @brief Method get_ClientVersion addr 0xeda34c size 0x58 virtual true final false
 Org::BouncyCastle::Crypto::Tls::ProtocolVersion get_ClientVersion() ;

/// @brief Method get_IsFallback addr 0xeda3a4 size 0x8 virtual true final false
 bool get_IsFallback() ;

/// @brief Method GetClientExtensions addr 0xeda3ac size 0x25c virtual true final false
 System::Collections::IDictionary GetClientExtensions() ;

/// @brief Method get_MinimumVersion addr 0xeda608 size 0x58 virtual true final false
 Org::BouncyCastle::Crypto::Tls::ProtocolVersion get_MinimumVersion() ;

/// @brief Method NotifyServerVersion addr 0xeda660 size 0x7c virtual true final false
...
/// @brief Method GetCompressionMethods addr 0xeda6dc size 0x44 virtual true final false
 ::ArrayW<uint8_t> GetCompressionMethods() ;

/// @brief Method NotifySessionID addr 0xeda720 size 0x4 virtual true final false
 void NotifySessionID(::ArrayW<uint8_t> sessionID) ;

/// @brief Method NotifySelectedCipherSuite addr 0xeda724 size 0x8 virtual true final false
 void NotifySelectedCipherSuite(int32_t selectedCipherSuite) ;

/// @brief Method NotifySelectedCompressionMethod addr 0xeda72c size 0xc virtual true final false
 void NotifySelectedCompressionMethod(uint8_t selectedCompressionMethod) ;

/// @brief Method ProcessServerExtensions addr 0xeda738 size 0x114 virtual true final false
 void ProcessServerExtensions(System::Collections::IDictionary serverExtensions) ;

/// @brief Method ProcessServerSupplementalData addr 0xeda84c size 0x4c virtual true final false
...
/// @brief Method GetClientSupplementalData addr 0xeda898 size 0x8 virtual true final false
 System::Collections::IList GetClientSupplementalData() ;

/// @brief Method GetCompression addr 0xeda8a0 size 0x100 virtual true final false
 Org::BouncyCastle::Crypto::Tls::TlsCompression GetCompression() ;

/// @brief Method GetCipher addr 0xeda9a0 size 0x104 virtual true final false
 Org::BouncyCastle::Crypto::Tls::TlsCipher GetCipher() ;

/// @brief Method NotifyNewSessionTicket addr 0xedaaa4 size 0x4 virtual true final false
