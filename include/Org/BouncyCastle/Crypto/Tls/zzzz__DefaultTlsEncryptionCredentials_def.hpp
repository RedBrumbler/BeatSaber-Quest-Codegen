...
/// @brief Method .ctor addr 0xee4ca8 size 0x234 virtual false final false
...
/// @brief Method get_Certificate addr 0xee4edc size 0x8 virtual true final false
 Org::BouncyCastle::Crypto::Tls::Certificate get_Certificate() ;

/// @brief Method DecryptPreMasterSecret addr 0xee4ee4 size 0x90 virtual true final false
