...
/// @brief Method .ctor addr 0xee0704 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method EncodeTo addr 0xee076c size 0xe4 virtual false final false
...
/// @brief Method .ctor addr 0xee01e4 size 0x16c virtual false final false
 void _ctor(uint8_t type, System::Collections::IList urlAndHashList) ;

/// @brief Method get_Type addr 0xee0350 size 0x8 virtual true final false
 uint8_t get_Type() ;

/// @brief Method get_UrlAndHashList addr 0xee0358 size 0x8 virtual true final false
 System::Collections::IList get_UrlAndHashList() ;

/// @brief Method Encode addr 0xee0360 size 0x3a4 virtual true final false
 void Encode(System::IO::Stream output) ;

/// @brief Method parse addr 0xee0850 size 0x290 virtual false final false
