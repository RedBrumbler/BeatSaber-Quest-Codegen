...
/// @brief Method .ctor addr 0xeed044 size 0x134 virtual false final false
 void _ctor(int32_t epoch, Org::BouncyCastle::Crypto::Tls::TlsCipher cipher) ;

/// @brief Method AllocateSequenceNumber addr 0xeed18c size 0xf4 virtual false final false
 int64_t AllocateSequenceNumber() ;

/// @brief Method get_Cipher addr 0xeed280 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::Tls::TlsCipher get_Cipher() ;

/// @brief Method get_Epoch addr 0xeed288 size 0x8 virtual false final false
 int32_t get_Epoch() ;

/// @brief Method get_ReplayWindow addr 0xeed290 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::Tls::DtlsReplayWindow get_ReplayWindow() ;

/// @brief Method get_SequenceNumber addr 0xeed298 size 0x34 virtual false final false
