...
/// @brief Method .ctor addr 0xf2cb58 size 0x8 virtual false final false
...
/// @brief Method ProcessServerCredentials addr 0xf2cb60 size 0x168 virtual true final false
 void ProcessServerCredentials(Org::BouncyCastle::Crypto::Tls::TlsCredentials serverCredentials) ;

/// @brief Method GenerateServerKeyExchange addr 0xf2ccc8 size 0x404 virtual true final false
 ::ArrayW<uint8_t> GenerateServerKeyExchange() ;

/// @brief Method ProcessServerKeyExchange addr 0xf2d2a4 size 0x304 virtual true final false
 void ProcessServerKeyExchange(System::IO::Stream input) ;

/// @brief Method ValidateCertificateRequest addr 0xf2d5a8 size 0x9c virtual true final false
 void ValidateCertificateRequest(Org::BouncyCastle::Crypto::Tls::CertificateRequest certificateRequest) ;

/// @brief Method ProcessClientCredentials addr 0xf2d644 size 0x8c virtual true final false
 void ProcessClientCredentials(Org::BouncyCastle::Crypto::Tls::TlsCredentials clientCredentials) ;

/// @brief Method InitVerifyer addr 0xf2d6d0 size 0x1d0 virtual true final false
