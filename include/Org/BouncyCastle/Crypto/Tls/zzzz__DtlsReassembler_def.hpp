...
/// @brief Method .ctor addr 0xeed418 size 0x2c virtual false final false
 void _ctor(int32_t start, int32_t end) ;

/// @brief Method get_Start addr 0xeedc08 size 0x8 virtual false final false
 int32_t get_Start() ;

/// @brief Method set_Start addr 0xeedc10 size 0x8 virtual false final false
 void set_Start(int32_t value) ;

/// @brief Method get_End addr 0xeedc18 size 0x8 virtual false final false
 int32_t get_End() ;

/// @brief Method set_End addr 0xeedc20 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xeed2cc size 0x14c virtual false final false
 void _ctor(uint8_t msg_type, int32_t length) ;

/// @brief Method get_MsgType addr 0xeed444 size 0x8 virtual false final false
 uint8_t get_MsgType() ;

/// @brief Method GetBodyIfComplete addr 0xeed44c size 0xb8 virtual false final false
 ::ArrayW<uint8_t> GetBodyIfComplete() ;

/// @brief Method ContributeFragment addr 0xeed504 size 0x5b4 virtual false final false
...
/// @brief Method Reset addr 0xeedab8 size 0x150 virtual false final false
 void Reset() ;
