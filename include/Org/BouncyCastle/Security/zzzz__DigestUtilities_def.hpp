...
/// @brief Method .ctor addr 0x10a6e44 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method GetObjectIdentifier addr 0x10aa88c size 0x25c virtual false final false
static Org::BouncyCastle::Asn1::DerObjectIdentifier GetObjectIdentifier(::StringW mechanism) ;

/// @brief Method get_Algorithms addr 0x10aaae8 size 0xcc virtual false final false
static System::Collections::ICollection get_Algorithms() ;

/// @brief Method GetDigest addr 0x10aabb4 size 0x60 virtual false final false
static Org::BouncyCastle::Crypto::IDigest GetDigest(Org::BouncyCastle::Asn1::DerObjectIdentifier id) ;

/// @brief Method GetDigest addr 0x10aac14 size 0xc04 virtual false final false
static Org::BouncyCastle::Crypto::IDigest GetDigest(::StringW algorithm) ;

/// @brief Method GetAlgorithmName addr 0x10ab818 size 0x108 virtual false final false
static ::StringW GetAlgorithmName(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method CalculateDigest addr 0x10ab920 size 0x68 virtual false final false
static ::ArrayW<uint8_t> CalculateDigest(Org::BouncyCastle::Asn1::DerObjectIdentifier id, ::ArrayW<uint8_t> input) ;

/// @brief Method CalculateDigest addr 0x10ab988 size 0xf8 virtual false final false
static ::ArrayW<uint8_t> CalculateDigest(::StringW algorithm, ::ArrayW<uint8_t> input) ;

/// @brief Method DoFinal addr 0x10aba80 size 0x134 virtual false final false
static ::ArrayW<uint8_t> DoFinal(Org::BouncyCastle::Crypto::IDigest digest) ;

/// @brief Method DoFinal addr 0x10abbb4 size 0xec virtual false final false
