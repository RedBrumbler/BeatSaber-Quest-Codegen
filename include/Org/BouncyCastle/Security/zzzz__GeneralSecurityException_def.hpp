...
/// @brief Method .ctor addr 0x1076a90 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit GeneralSecurityException(::StringW message) ;

/// @brief Method .ctor addr 0x1076ae8 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x1076b50 size 0x70 virtual false final false
