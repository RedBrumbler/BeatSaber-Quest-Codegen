...
/// @brief Method .ctor addr 0x10c2c00 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method GetObjectIdentifier addr 0x10cdd0c size 0x25c virtual false final false
static Org::BouncyCastle::Asn1::DerObjectIdentifier GetObjectIdentifier(::StringW mechanism) ;

/// @brief Method get_Algorithms addr 0x10cdf68 size 0xcc virtual false final false
static System::Collections::ICollection get_Algorithms() ;

/// @brief Method GetDefaultX509Parameters addr 0x10ce034 size 0x60 virtual false final false
static Org::BouncyCastle::Asn1::Asn1Encodable GetDefaultX509Parameters(Org::BouncyCastle::Asn1::DerObjectIdentifier id) ;

/// @brief Method GetDefaultX509Parameters addr 0x10ce094 size 0x2a8 virtual false final false
static Org::BouncyCastle::Asn1::Asn1Encodable GetDefaultX509Parameters(::StringW algorithm) ;

/// @brief Method GetPssX509Parameters addr 0x10ce33c size 0x244 virtual false final false
static Org::BouncyCastle::Asn1::Asn1Encodable GetPssX509Parameters(::StringW digestName) ;

/// @brief Method GetSigner addr 0x10ce580 size 0x60 virtual false final false
static Org::BouncyCastle::Crypto::ISigner GetSigner(Org::BouncyCastle::Asn1::DerObjectIdentifier id) ;

/// @brief Method GetSigner addr 0x10ce5e0 size 0x103c virtual false final false
static Org::BouncyCastle::Crypto::ISigner GetSigner(::StringW algorithm) ;

/// @brief Method GetEncodingName addr 0x10cf61c size 0x108 virtual false final false
static ::StringW GetEncodingName(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method InitSigner addr 0x10cf724 size 0x80 virtual false final false
...
/// @brief Method InitSigner addr 0x10cf7a4 size 0x138 virtual false final false
