...
/// @brief Method .ctor addr 0x10b4768 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method AddAlgorithm addr 0x10b6018 size 0x1c4 virtual false final false
static void AddAlgorithm(::StringW canonicalName, ::ArrayW<::bs_hook::Il2CppWrapperType> aliases) ;

/// @brief Method AddBasicIVSizeEntries addr 0x10b61dc size 0x164 virtual false final false
static void AddBasicIVSizeEntries(int32_t size, ::ArrayW<::StringW> algorithms) ;

/// @brief Method GetCanonicalAlgorithmName addr 0x10b6340 size 0x138 virtual false final false
static ::StringW GetCanonicalAlgorithmName(::StringW algorithm) ;

/// @brief Method CreateKeyParameter addr 0x10b6478 size 0x74 virtual false final false
...
/// @brief Method CreateKeyParameter addr 0x10b67b4 size 0x6c virtual false final false
static Org::BouncyCastle::Crypto::Parameters::KeyParameter CreateKeyParameter(::StringW algorithm, ::ArrayW<uint8_t> keyBytes) ;

/// @brief Method CreateKeyParameter addr 0x10b6820 size 0x80 virtual false final false
...
/// @brief Method CreateKeyParameter addr 0x10b64ec size 0x2c8 virtual false final false
...
/// @brief Method GetCipherParameters addr 0x10b68a0 size 0x78 virtual false final false
...
/// @brief Method GetCipherParameters addr 0x10b6918 size 0x45c virtual false final false
...
/// @brief Method GenerateParameters addr 0x10b6f18 size 0x68 virtual false final false
...
/// @brief Method GenerateParameters addr 0x10b6f80 size 0x304 virtual false final false
...
/// @brief Method WithRandom addr 0x10b7394 size 0x74 virtual false final false
...
/// @brief Method CreateIVOctetString addr 0x10b7284 size 0xa8 virtual false final false
...
/// @brief Method CreateIV addr 0x10b732c size 0x68 virtual false final false
static ::ArrayW<uint8_t> CreateIV(Org::BouncyCastle::Security::SecureRandom random, int32_t ivLength) ;

/// @brief Method FindBasicIVSize addr 0x10b6d74 size 0x1a4 virtual false final false
