...
/// @brief Method .ctor addr 0x10b1a88 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit KeyException(::StringW message) ;

/// @brief Method .ctor addr 0x10b1a90 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x10b1a98 size 0x8 virtual false final false
