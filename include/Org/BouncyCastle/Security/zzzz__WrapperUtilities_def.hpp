...
/// @brief Method .ctor addr 0x10d06b4 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::IBufferedCipher cipher) ;

/// @brief Method get_AlgorithmName addr 0x10d07e4 size 0xa0 virtual true final true
 ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0x10d0884 size 0xc4 virtual true final true
 void Init(bool forWrapping, Org::BouncyCastle::Crypto::ICipherParameters parameters) ;

/// @brief Method Wrap addr 0x10d0948 size 0x118 virtual true final true
 ::ArrayW<uint8_t> Wrap(::ArrayW<uint8_t> input, int32_t inOff, int32_t length) ;

/// @brief Method Unwrap addr 0x10d0a60 size 0x118 virtual true final true
...
/// @brief Method .ctor addr 0x10cf8dc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method GetWrapper addr 0x10d009c size 0x60 virtual false final false
static Org::BouncyCastle::Crypto::IWrapper GetWrapper(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetWrapper addr 0x10d00fc size 0x5b8 virtual false final false
static Org::BouncyCastle::Crypto::IWrapper GetWrapper(::StringW algorithm) ;

/// @brief Method GetAlgorithmName addr 0x10d06dc size 0x108 virtual false final false
