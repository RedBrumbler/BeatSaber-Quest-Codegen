...
/// @brief Method .ctor addr 0x10c11f8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method CreateKey addr 0x10c1200 size 0x1c virtual false final false
static Org::BouncyCastle::Crypto::AsymmetricKeyParameter CreateKey(::ArrayW<uint8_t> keyInfoData) ;

/// @brief Method CreateKey addr 0x10c27a0 size 0x1c virtual false final false
static Org::BouncyCastle::Crypto::AsymmetricKeyParameter CreateKey(System::IO::Stream inStr) ;

/// @brief Method CreateKey addr 0x10c121c size 0x1584 virtual false final false
static Org::BouncyCastle::Crypto::AsymmetricKeyParameter CreateKey(Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo keyInfo) ;

/// @brief Method GetRawKey addr 0x10c2a34 size 0x84 virtual false final false
static ::ArrayW<uint8_t> GetRawKey(Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo keyInfo, int32_t expectedSize) ;

/// @brief Method IsPkcsDHParam addr 0x10c27bc size 0x140 virtual false final false
static bool IsPkcsDHParam(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;

/// @brief Method ReadPkcsDHParam addr 0x10c28fc size 0x138 virtual false final false
