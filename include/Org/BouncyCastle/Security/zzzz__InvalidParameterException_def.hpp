...
/// @brief Method .ctor addr 0x10b1ab8 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit InvalidParameterException(::StringW message) ;

/// @brief Method .ctor addr 0x10b1ac0 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x10b1ac8 size 0x8 virtual false final false
