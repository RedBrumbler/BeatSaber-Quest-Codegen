...
// Ctor Parameters []
explicit SecurityUtilityException() ;

/// @brief Method .ctor addr 0x10c2b20 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit SecurityUtilityException(::StringW message) ;

/// @brief Method .ctor addr 0x10c2ab8 size 0x68 virtual false final false
...
explicit SecurityUtilityException(::StringW message, System::Exception exception) ;

/// @brief Method .ctor addr 0x10c2b78 size 0x70 virtual false final false
