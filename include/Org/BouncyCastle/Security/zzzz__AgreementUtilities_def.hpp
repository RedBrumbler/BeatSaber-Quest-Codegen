...
/// @brief Method .ctor addr 0x10a0640 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method GetBasicAgreement addr 0x10a0a48 size 0x60 virtual false final false
static Org::BouncyCastle::Crypto::IBasicAgreement GetBasicAgreement(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetBasicAgreement addr 0x10a0aa8 size 0x280 virtual false final false
static Org::BouncyCastle::Crypto::IBasicAgreement GetBasicAgreement(::StringW algorithm) ;

/// @brief Method GetBasicAgreementWithKdf addr 0x10a0e68 size 0x68 virtual false final false
...
/// @brief Method GetBasicAgreementWithKdf addr 0x10a0ed0 size 0x254 virtual false final false
static Org::BouncyCastle::Crypto::IBasicAgreement GetBasicAgreementWithKdf(::StringW agreeAlgorithm, ::StringW wrapAlgorithm) ;

/// @brief Method GetRawAgreement addr 0x10a1124 size 0x60 virtual false final false
static Org::BouncyCastle::Crypto::IRawAgreement GetRawAgreement(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetRawAgreement addr 0x10a1184 size 0x180 virtual false final false
static Org::BouncyCastle::Crypto::IRawAgreement GetRawAgreement(::StringW algorithm) ;

/// @brief Method GetAlgorithmName addr 0x10a1304 size 0x108 virtual false final false
static ::StringW GetAlgorithmName(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetMechanism addr 0x10a0d28 size 0x140 virtual false final false
