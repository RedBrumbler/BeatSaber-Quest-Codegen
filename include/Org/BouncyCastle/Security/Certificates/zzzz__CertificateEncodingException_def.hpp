...
/// @brief Method .ctor addr 0x10a05c8 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "msg", ty: "::StringW", modifiers: "", def_value: None }]
explicit CertificateEncodingException(::StringW msg) ;

/// @brief Method .ctor addr 0x10a05d0 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x10a05d8 size 0x8 virtual false final false
