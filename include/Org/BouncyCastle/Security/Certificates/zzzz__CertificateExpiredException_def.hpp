...
/// @brief Method .ctor addr 0x10a05e0 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit CertificateExpiredException(::StringW message) ;

/// @brief Method .ctor addr 0x10a05e8 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x10a05f0 size 0x8 virtual false final false
