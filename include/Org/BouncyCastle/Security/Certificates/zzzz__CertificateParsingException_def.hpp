...
/// @brief Method .ctor addr 0x10a0610 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit CertificateParsingException(::StringW message) ;

/// @brief Method .ctor addr 0x10a0618 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x10a0620 size 0x8 virtual false final false
