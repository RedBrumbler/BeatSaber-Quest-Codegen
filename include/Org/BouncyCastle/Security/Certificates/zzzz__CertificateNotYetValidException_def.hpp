...
/// @brief Method .ctor addr 0x10a05f8 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit CertificateNotYetValidException(::StringW message) ;

/// @brief Method .ctor addr 0x10a0600 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x10a0608 size 0x8 virtual false final false
