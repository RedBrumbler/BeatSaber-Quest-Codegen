...
// Ctor Parameters []
explicit CertificateException() ;

/// @brief Method .ctor addr 0x10a05b0 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit CertificateException(::StringW message) ;

/// @brief Method .ctor addr 0x10a05b8 size 0x8 virtual false final false
...
explicit CertificateException(::StringW message, System::Exception exception) ;

/// @brief Method .ctor addr 0x10a05c0 size 0x8 virtual false final false
