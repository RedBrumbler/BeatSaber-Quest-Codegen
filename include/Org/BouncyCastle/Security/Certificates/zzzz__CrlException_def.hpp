...
/// @brief Method .ctor addr 0x10a0628 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "msg", ty: "::StringW", modifiers: "", def_value: None }]
explicit CrlException(::StringW msg) ;

/// @brief Method .ctor addr 0x10a0630 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x10a0638 size 0x8 virtual false final false
