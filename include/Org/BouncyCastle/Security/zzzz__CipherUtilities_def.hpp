...
/// @brief Method .ctor addr 0x10a4194 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method GetObjectIdentifier addr 0x10a419c size 0x25c virtual false final false
static Org::BouncyCastle::Asn1::DerObjectIdentifier GetObjectIdentifier(::StringW mechanism) ;

/// @brief Method get_Algorithms addr 0x10a43f8 size 0xcc virtual false final false
static System::Collections::ICollection get_Algorithms() ;

/// @brief Method GetCipher addr 0x10a44c4 size 0x60 virtual false final false
static Org::BouncyCastle::Crypto::IBufferedCipher GetCipher(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetCipher addr 0x10a4524 size 0x21cc virtual false final false
static Org::BouncyCastle::Crypto::IBufferedCipher GetCipher(::StringW algorithm) ;

/// @brief Method GetAlgorithmName addr 0x10a6d3c size 0x108 virtual false final false
static ::StringW GetAlgorithmName(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetDigitIndex addr 0x10a66f0 size 0xb0 virtual false final false
static int32_t GetDigitIndex(::StringW s) ;

/// @brief Method CreateBlockCipher addr 0x10a67a0 size 0x59c virtual false final false
