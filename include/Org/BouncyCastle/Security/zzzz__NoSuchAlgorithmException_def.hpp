...
/// @brief Method .ctor addr 0x10b4750 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit NoSuchAlgorithmException(::StringW message) ;

/// @brief Method .ctor addr 0x10b4758 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x10b4760 size 0x8 virtual false final false
