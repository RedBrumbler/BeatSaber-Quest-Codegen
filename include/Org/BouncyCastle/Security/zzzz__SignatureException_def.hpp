...
/// @brief Method .ctor addr 0x10c2be8 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit SignatureException(::StringW message) ;

/// @brief Method .ctor addr 0x10c2bf0 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x10c2bf8 size 0x8 virtual false final false
