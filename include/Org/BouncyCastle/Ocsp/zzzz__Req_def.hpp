...
/// @brief Method .ctor addr 0x1021758 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Ocsp::Request req) ;

/// @brief Method GetCertID addr 0x10266b8 size 0x6c virtual false final false
 Org::BouncyCastle::Ocsp::CertificateID GetCertID() ;

/// @brief Method get_SingleRequestExtensions addr 0x1026724 size 0x1c virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Extensions get_SingleRequestExtensions() ;

/// @brief Method GetX509Extensions addr 0x1026740 size 0x1c virtual true final false
