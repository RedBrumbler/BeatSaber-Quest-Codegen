...
/// @brief Method .ctor addr 0x101dc90 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Ocsp::SingleResponse resp) ;

/// @brief Method GetCertID addr 0x1026c50 size 0x6c virtual false final false
 Org::BouncyCastle::Ocsp::CertificateID GetCertID() ;

/// @brief Method GetCertStatus addr 0x1026cbc size 0xc8 virtual false final false
 ::bs_hook::Il2CppWrapperType GetCertStatus() ;

/// @brief Method get_ThisUpdate addr 0x1026ddc size 0x24 virtual false final false
 System::DateTime get_ThisUpdate() ;

/// @brief Method get_NextUpdate addr 0x1026e00 size 0x8c virtual false final false
 Org::BouncyCastle::Utilities::Date::DateTimeObject get_NextUpdate() ;

/// @brief Method get_SingleExtensions addr 0x1026e8c size 0x1c virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Extensions get_SingleExtensions() ;

/// @brief Method GetX509Extensions addr 0x1026ea8 size 0x1c virtual true final false
