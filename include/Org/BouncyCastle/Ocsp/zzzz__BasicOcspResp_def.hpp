...
/// @brief Method .ctor addr 0x101d8e0 size 0x38 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Ocsp::BasicOcspResponse resp) ;

/// @brief Method GetTbsResponseData addr 0x101d918 size 0xe8 virtual false final false
 ::ArrayW<uint8_t> GetTbsResponseData() ;

/// @brief Method get_Version addr 0x101da70 size 0x2c virtual false final false
 int32_t get_Version() ;

/// @brief Method get_ResponderId addr 0x101da9c size 0x70 virtual false final false
 Org::BouncyCastle::Ocsp::RespID get_ResponderId() ;

/// @brief Method get_ProducedAt addr 0x101db34 size 0x24 virtual false final false
 System::DateTime get_ProducedAt() ;

/// @brief Method get_Responses addr 0x101db58 size 0x138 virtual false final false
 ::ArrayW<Org::BouncyCastle::Ocsp::SingleResp> get_Responses() ;

/// @brief Method get_ResponseExtensions addr 0x101dcb8 size 0x1c virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Extensions get_ResponseExtensions() ;

/// @brief Method GetX509Extensions addr 0x101dcd4 size 0x1c virtual true final false
 Org::BouncyCastle::Asn1::X509::X509Extensions GetX509Extensions() ;

/// @brief Method get_SignatureAlgName addr 0x101dcf0 size 0x7c virtual false final false
 ::StringW get_SignatureAlgName() ;

/// @brief Method get_SignatureAlgOid addr 0x101df04 size 0x34 virtual false final false
 ::StringW get_SignatureAlgOid() ;

/// @brief Method GetResponseData addr 0x101df38 size 0x68 virtual false final false
 Org::BouncyCastle::Ocsp::RespData GetResponseData() ;

/// @brief Method GetSignature addr 0x101dfc8 size 0x1c virtual false final false
 ::ArrayW<uint8_t> GetSignature() ;

/// @brief Method GetCertList addr 0x101dfe4 size 0x558 virtual false final false
 System::Collections::IList GetCertList() ;

/// @brief Method GetCerts addr 0x101e53c size 0x284 virtual false final false
 ::ArrayW<Org::BouncyCastle::X509::X509Certificate> GetCerts() ;

/// @brief Method GetCertificates addr 0x101e7c0 size 0x17c virtual false final false
 Org::BouncyCastle::X509::Store::IX509Store GetCertificates(::StringW type) ;

/// @brief Method Verify addr 0x101e93c size 0x2e8 virtual false final false
 bool Verify(Org::BouncyCastle::Crypto::AsymmetricKeyParameter publicKey) ;

/// @brief Method GetEncoded addr 0x101ec24 size 0x1c virtual false final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method Equals addr 0x101ec40 size 0xb0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x101ecf0 size 0x1c virtual true final false
 int32_t GetHashCode() ;
