...
/// @brief Method .ctor addr 0x10211a4 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit OcspException(::StringW message) ;

/// @brief Method .ctor addr 0x10211fc size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x101da00 size 0x70 virtual false final false
