...
/// @brief Method .ctor addr 0x10225d4 size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Ocsp::CertificateID certId, Org::BouncyCastle::Asn1::X509::X509Extensions extensions) ;

/// @brief Method ToRequest addr 0x102343c size 0x78 virtual false final false
...
/// @brief Method AddRequest addr 0x10224f0 size 0xe4 virtual false final false
 void AddRequest(Org::BouncyCastle::Ocsp::CertificateID certId) ;

/// @brief Method AddRequest addr 0x1022600 size 0xe8 virtual false final false
...
/// @brief Method SetRequestorName addr 0x10226e8 size 0x138 virtual false final false
 void SetRequestorName(Org::BouncyCastle::Asn1::X509::X509Name requestorName) ;

/// @brief Method SetRequestorName addr 0x1022820 size 0x8 virtual false final false
 void SetRequestorName(Org::BouncyCastle::Asn1::X509::GeneralName requestorName) ;

/// @brief Method SetRequestExtensions addr 0x1022828 size 0x8 virtual false final false
 void SetRequestExtensions(Org::BouncyCastle::Asn1::X509::X509Extensions requestExtensions) ;

/// @brief Method GenerateRequest addr 0x1022830 size 0xc0c virtual false final false
...
/// @brief Method Generate addr 0x10234b4 size 0x14 virtual false final false
 Org::BouncyCastle::Ocsp::OcspReq Generate() ;

/// @brief Method Generate addr 0x10234c8 size 0x8 virtual false final false
...
/// @brief Method Generate addr 0x10234d0 size 0x1b0 virtual false final false
...
/// @brief Method get_SignatureAlgNames addr 0x102388c size 0x4c virtual false final false
 System::Collections::IEnumerable get_SignatureAlgNames() ;

// Ctor Parameters []
explicit OcspReqGenerator() ;

/// @brief Method .ctor addr 0x10238d8 size 0x68 virtual false final false
 void _ctor() ;
