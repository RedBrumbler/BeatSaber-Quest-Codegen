...
/// @brief Method .ctor addr 0x1020a08 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x1020a80 size 0x130 virtual false final false
...
/// @brief Method get_HashAlgOid addr 0x1020e74 size 0x34 virtual false final false
 ::StringW get_HashAlgOid() ;

/// @brief Method GetIssuerNameHash addr 0x1020ea8 size 0x28 virtual false final false
 ::ArrayW<uint8_t> GetIssuerNameHash() ;

/// @brief Method GetIssuerKeyHash addr 0x1020ed0 size 0x28 virtual false final false
 ::ArrayW<uint8_t> GetIssuerKeyHash() ;

/// @brief Method get_SerialNumber addr 0x1020ef8 size 0x24 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_SerialNumber() ;

/// @brief Method MatchesIssuer addr 0x1020f1c size 0x34 virtual false final false
 bool MatchesIssuer(Org::BouncyCastle::X509::X509Certificate issuerCert) ;

/// @brief Method ToAsn1Object addr 0x1020f50 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::Ocsp::CertID ToAsn1Object() ;

/// @brief Method Equals addr 0x1020f58 size 0xdc virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x1021034 size 0x2c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method DeriveCertificateID addr 0x1021060 size 0xf4 virtual false final false
...
/// @brief Method CreateCertID addr 0x1020bb0 size 0x2c4 virtual false final false
