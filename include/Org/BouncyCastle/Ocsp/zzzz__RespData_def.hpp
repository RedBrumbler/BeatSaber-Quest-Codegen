...
/// @brief Method .ctor addr 0x101dfa0 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Ocsp::ResponseData data) ;

/// @brief Method get_Version addr 0x102675c size 0x2c virtual false final false
 int32_t get_Version() ;

/// @brief Method GetResponderId addr 0x1026788 size 0x70 virtual false final false
 Org::BouncyCastle::Ocsp::RespID GetResponderId() ;

/// @brief Method get_ProducedAt addr 0x10267f8 size 0x24 virtual false final false
 System::DateTime get_ProducedAt() ;

/// @brief Method GetResponses addr 0x102681c size 0x138 virtual false final false
 ::ArrayW<Org::BouncyCastle::Ocsp::SingleResp> GetResponses() ;

/// @brief Method get_ResponseExtensions addr 0x1026954 size 0x1c virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Extensions get_ResponseExtensions() ;

/// @brief Method GetX509Extensions addr 0x1026970 size 0x1c virtual true final false
