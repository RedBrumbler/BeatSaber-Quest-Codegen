...
/// @brief Method GetAlgorithmOid addr 0x1023680 size 0x20c virtual false final false
static Org::BouncyCastle::Asn1::DerObjectIdentifier GetAlgorithmOid(::StringW algorithmName) ;

/// @brief Method GetAlgorithmName addr 0x101dd6c size 0x198 virtual false final false
static ::StringW GetAlgorithmName(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetSigAlgID addr 0x10202dc size 0x16c virtual false final false
static Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier GetSigAlgID(Org::BouncyCastle::Asn1::DerObjectIdentifier sigOid) ;

/// @brief Method get_AlgNames addr 0x10205e0 size 0x10c virtual false final false
static System::Collections::IEnumerable get_AlgNames() ;

// Ctor Parameters []
explicit OcspUtilities() ;

/// @brief Method .ctor addr 0x10266b0 size 0x8 virtual false final false
 void _ctor() ;
