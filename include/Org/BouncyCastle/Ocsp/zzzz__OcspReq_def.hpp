...
/// @brief Method .ctor addr 0x1021264 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x102128c size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x1021450 size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x1021300 size 0x150 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1InputStream aIn) ;

/// @brief Method GetTbsRequest addr 0x10214c4 size 0xf8 virtual false final false
 ::ArrayW<uint8_t> GetTbsRequest() ;

/// @brief Method get_Version addr 0x10215bc size 0x34 virtual false final false
 int32_t get_Version() ;

/// @brief Method get_RequestorName addr 0x10215f0 size 0x28 virtual false final false
 Org::BouncyCastle::Asn1::X509::GeneralName get_RequestorName() ;

/// @brief Method GetRequestList addr 0x1021618 size 0x140 virtual false final false
 ::ArrayW<Org::BouncyCastle::Ocsp::Req> GetRequestList() ;

/// @brief Method get_RequestExtensions addr 0x1021780 size 0x70 virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Extensions get_RequestExtensions() ;

/// @brief Method GetX509Extensions addr 0x10217f0 size 0x4 virtual true final false
 Org::BouncyCastle::Asn1::X509::X509Extensions GetX509Extensions() ;

/// @brief Method get_SignatureAlgOid addr 0x10217f4 size 0x44 virtual false final false
 ::StringW get_SignatureAlgOid() ;

/// @brief Method GetSignature addr 0x102185c size 0x2c virtual false final false
 ::ArrayW<uint8_t> GetSignature() ;

/// @brief Method GetCertList addr 0x1021888 size 0x4d8 virtual false final false
 System::Collections::IList GetCertList() ;

/// @brief Method GetCerts addr 0x1021d60 size 0x29c virtual false final false
 ::ArrayW<Org::BouncyCastle::X509::X509Certificate> GetCerts() ;

/// @brief Method GetCertificates addr 0x1021ffc size 0x190 virtual false final false
 Org::BouncyCastle::X509::Store::IX509Store GetCertificates(::StringW type) ;

/// @brief Method get_IsSigned addr 0x1021838 size 0x24 virtual false final false
 bool get_IsSigned() ;

/// @brief Method Verify addr 0x102218c size 0x348 virtual false final false
 bool Verify(Org::BouncyCastle::Crypto::AsymmetricKeyParameter publicKey) ;

/// @brief Method GetEncoded addr 0x10224d4 size 0x1c virtual false final false
