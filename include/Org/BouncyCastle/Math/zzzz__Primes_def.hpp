...
/// @brief Method ProbablyPrime addr 0x101d228 size 0x64 virtual false final false
static Org::BouncyCastle::Math::Org__BouncyCastle__Math__Primes__MROutput ProbablyPrime() ;

/// @brief Method ProvablyCompositeWithFactor addr 0x101d2bc size 0x6c virtual false final false
...
/// @brief Method ProvablyCompositeNotPrimePower addr 0x101d328 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x101d28c size 0x30 virtual false final false
 void _ctor(bool provablyComposite, Org::BouncyCastle::Math::BigInteger factor) ;

/// @brief Method get_Factor addr 0x101d390 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_Factor() ;

/// @brief Method get_IsProvablyComposite addr 0x101d398 size 0x8 virtual false final false
 bool get_IsProvablyComposite() ;

/// @brief Method get_IsNotPrimePower addr 0x101d3a0 size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0x101d3c0 size 0x3c virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger prime, ::ArrayW<uint8_t> primeSeed, int32_t primeGenCounter) ;

/// @brief Method get_Prime addr 0x101d3fc size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_Prime() ;

/// @brief Method get_PrimeSeed addr 0x101d404 size 0x8 virtual false final false
 ::ArrayW<uint8_t> get_PrimeSeed() ;

/// @brief Method get_PrimeGenCounter addr 0x101d40c size 0x8 virtual false final false
...
/// @brief Method GenerateSTRandomPrime addr 0x101b0c8 size 0x1ac virtual false final false
...
/// @brief Method EnhancedMRProbablePrimeTest addr 0x101b8a8 size 0x48c virtual false final false
...
/// @brief Method HasAnySmallFactors addr 0x101bdb8 size 0x74 virtual false final false
static bool HasAnySmallFactors(Org::BouncyCastle::Math::BigInteger candidate) ;

/// @brief Method IsMRProbablePrime addr 0x101c710 size 0x234 virtual false final false
...
/// @brief Method IsMRProbablePrimeToBase addr 0x101cab0 size 0x1bc virtual false final false
...
/// @brief Method CheckCandidate addr 0x101bd34 size 0x84 virtual false final false
static void CheckCandidate(Org::BouncyCastle::Math::BigInteger n, ::StringW name) ;

/// @brief Method ImplHasAnySmallFactors addr 0x101be2c size 0x8e4 virtual false final false
static bool ImplHasAnySmallFactors(Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method ImplMRProbablePrimeToBase addr 0x101c944 size 0x16c virtual false final false
...
/// @brief Method ImplSTRandomPrime addr 0x101b274 size 0x634 virtual false final false
...
/// @brief Method Extract32 addr 0x101cdf8 size 0xc0 virtual false final false
static uint32_t Extract32(::ArrayW<uint8_t> bs) ;

/// @brief Method Hash addr 0x101cc6c size 0x134 virtual false final false
static void Hash(Org::BouncyCastle::Crypto::IDigest d, ::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output, int32_t outPos) ;

/// @brief Method HashGen addr 0x101d010 size 0x180 virtual false final false
static Org::BouncyCastle::Math::BigInteger HashGen(Org::BouncyCastle::Crypto::IDigest d, ::ArrayW<uint8_t> seed, int32_t count) ;

/// @brief Method Inc addr 0x101cda0 size 0x58 virtual false final false
static void Inc(::ArrayW<uint8_t> seed, int32_t c) ;

/// @brief Method IsPrime32 addr 0x101ceb8 size 0x158 virtual false final false
static bool IsPrime32(uint32_t x) ;

// Ctor Parameters []
explicit Primes() ;

/// @brief Method .ctor addr 0x101d220 size 0x8 virtual false final false
 void _ctor() ;
