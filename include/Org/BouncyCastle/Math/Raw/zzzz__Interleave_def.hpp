...
/// @brief Method Expand8to16 addr 0xfdd808 size 0x20 virtual false final false
static uint32_t Expand8to16(uint32_t x) ;

/// @brief Method Expand16to32 addr 0xfdd828 size 0x28 virtual false final false
static uint32_t Expand16to32(uint32_t x) ;

/// @brief Method Expand32to64 addr 0xfdd850 size 0x58 virtual false final false
static uint64_t Expand32to64(uint32_t x) ;

/// @brief Method Expand64To128 addr 0xfdd8a8 size 0xa8 virtual false final false
static void Expand64To128(uint64_t x, ::ArrayW<uint64_t> z, int32_t zOff) ;

/// @brief Method Expand64To128Rev addr 0xfdd950 size 0xa8 virtual false final false
static void Expand64To128Rev(uint64_t x, ::ArrayW<uint64_t> z, int32_t zOff) ;

/// @brief Method Shuffle addr 0xfdd9f8 size 0x48 virtual false final false
static uint32_t Shuffle(uint32_t x) ;

/// @brief Method Shuffle addr 0xfdda40 size 0x5c virtual false final false
static uint64_t Shuffle(uint64_t x) ;

/// @brief Method Shuffle2 addr 0xfdda9c size 0x54 virtual false final false
static uint32_t Shuffle2(uint32_t x) ;

/// @brief Method Unshuffle addr 0xfddaf0 size 0x48 virtual false final false
static uint32_t Unshuffle(uint32_t x) ;

/// @brief Method Unshuffle addr 0xfddb38 size 0x5c virtual false final false
static uint64_t Unshuffle(uint64_t x) ;

/// @brief Method Unshuffle2 addr 0xfddb94 size 0x54 virtual false final false
static uint32_t Unshuffle2(uint32_t x) ;

// Ctor Parameters []
explicit Interleave() ;

/// @brief Method .ctor addr 0xfddbe8 size 0x8 virtual false final false
 void _ctor() ;
