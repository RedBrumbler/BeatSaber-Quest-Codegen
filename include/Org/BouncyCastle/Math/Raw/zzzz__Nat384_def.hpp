...
/// @brief Method Mul addr 0x1010168 size 0x16c virtual false final false
static void Mul(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> y, ::ArrayW<uint32_t> zz) ;

/// @brief Method Square addr 0x10102d4 size 0x114 virtual false final false
static void Square(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> zz) ;

// Ctor Parameters []
explicit Nat384() ;

/// @brief Method .ctor addr 0x10103e8 size 0x8 virtual false final false
 void _ctor() ;
