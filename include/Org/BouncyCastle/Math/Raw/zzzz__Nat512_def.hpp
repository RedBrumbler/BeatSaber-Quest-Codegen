...
/// @brief Method Mul addr 0x1010988 size 0x140 virtual false final false
static void Mul(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> y, ::ArrayW<uint32_t> zz) ;

/// @brief Method Square addr 0x1010ac8 size 0xf0 virtual false final false
static void Square(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> zz) ;

// Ctor Parameters []
explicit Nat512() ;

/// @brief Method .ctor addr 0x1010bb8 size 0x8 virtual false final false
 void _ctor() ;
