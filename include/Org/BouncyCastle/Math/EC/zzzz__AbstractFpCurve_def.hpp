...
/// @brief Method .ctor addr 0xf4d8c4 size 0x84 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger q) ;

/// @brief Method IsValidFieldElement addr 0xf4d948 size 0xe4 virtual true final false
 bool IsValidFieldElement(Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method RandomFieldElement addr 0xf4da2c size 0x120 virtual true final false
 Org::BouncyCastle::Math::EC::ECFieldElement RandomFieldElement(Org::BouncyCastle::Security::SecureRandom r) ;

/// @brief Method RandomFieldElementMult addr 0xf4dba4 size 0x120 virtual true final false
 Org::BouncyCastle::Math::EC::ECFieldElement RandomFieldElementMult(Org::BouncyCastle::Security::SecureRandom r) ;

/// @brief Method DecompressPoint addr 0xf4dd4c size 0x180 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint DecompressPoint(int32_t yTilde, Org::BouncyCastle::Math::BigInteger X1) ;

/// @brief Method ImplRandomFieldElement addr 0xf4db4c size 0x58 virtual false final false
...
/// @brief Method ImplRandomFieldElementMult addr 0xf4dcc4 size 0x88 virtual false final false
