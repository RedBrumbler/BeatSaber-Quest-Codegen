...
/// @brief Method get_PreComp addr 0xfbca0c size 0x8 virtual true final false
 ::ArrayW<Org::BouncyCastle::Math::EC::AbstractF2mPoint> get_PreComp() ;

/// @brief Method set_PreComp addr 0xfbca14 size 0x8 virtual true final false
 void set_PreComp(::ArrayW<Org::BouncyCastle::Math::EC::AbstractF2mPoint> value) ;

// Ctor Parameters []
explicit WTauNafPreCompInfo() ;

/// @brief Method .ctor addr 0xfbca04 size 0x8 virtual false final false
 void _ctor() ;
