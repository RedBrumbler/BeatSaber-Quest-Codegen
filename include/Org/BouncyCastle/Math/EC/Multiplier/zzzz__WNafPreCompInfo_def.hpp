...
/// @brief Method DecrementPromotionCountdown addr 0xfb9b14 size 0x38 virtual false final false
 int32_t DecrementPromotionCountdown() ;

/// @brief Method get_PromotionCountdown addr 0xfb9b4c size 0x18 virtual false final false
 int32_t get_PromotionCountdown() ;

/// @brief Method set_PromotionCountdown addr 0xfb9b64 size 0x24 virtual false final false
 void set_PromotionCountdown(int32_t value) ;

/// @brief Method get_IsPromoted addr 0xfb9b88 size 0x1c virtual true final false
 bool get_IsPromoted() ;

/// @brief Method get_ConfWidth addr 0xfb9ba4 size 0x8 virtual true final false
 int32_t get_ConfWidth() ;

/// @brief Method set_ConfWidth addr 0xfb9bac size 0x8 virtual true final false
 void set_ConfWidth(int32_t value) ;

/// @brief Method get_PreComp addr 0xfb9bb4 size 0x8 virtual true final false
 ::ArrayW<Org::BouncyCastle::Math::EC::ECPoint> get_PreComp() ;

/// @brief Method set_PreComp addr 0xfb9bbc size 0x8 virtual true final false
 void set_PreComp(::ArrayW<Org::BouncyCastle::Math::EC::ECPoint> value) ;

/// @brief Method get_PreCompNeg addr 0xfb9bc4 size 0x8 virtual true final false
 ::ArrayW<Org::BouncyCastle::Math::EC::ECPoint> get_PreCompNeg() ;

/// @brief Method set_PreCompNeg addr 0xfb9bcc size 0x8 virtual true final false
 void set_PreCompNeg(::ArrayW<Org::BouncyCastle::Math::EC::ECPoint> value) ;

/// @brief Method get_Twice addr 0xfb9bd4 size 0x8 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint get_Twice() ;

/// @brief Method set_Twice addr 0xfb9bdc size 0x8 virtual true final false
 void set_Twice(Org::BouncyCastle::Math::EC::ECPoint value) ;

/// @brief Method get_Width addr 0xfb9be4 size 0x8 virtual true final false
 int32_t get_Width() ;

/// @brief Method set_Width addr 0xfb9bec size 0x8 virtual true final false
 void set_Width(int32_t value) ;

// Ctor Parameters []
explicit WNafPreCompInfo() ;

/// @brief Method .ctor addr 0xfb9bf4 size 0x38 virtual false final false
 void _ctor() ;
