...
/// @brief Method .ctor addr 0xfb9dac size 0x30 virtual false final false
 void _ctor(Org::BouncyCastle::Math::EC::ECCurve curve, int32_t confWidth) ;

/// @brief Method Precompute addr 0xfbadf8 size 0x1b8 virtual true final true
...
/// @brief Method .ctor addr 0xfbaa74 size 0x40 virtual false final false
...
/// @brief Method Precompute addr 0xfbafb0 size 0x378 virtual true final true
 Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo Precompute(Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo existing) ;
...
/// @brief Method .ctor addr 0xfbaab4 size 0x40 virtual false final false
 void _ctor(Org::BouncyCastle::Math::EC::ECPoint p, int32_t minWidth, bool includeNegated) ;

/// @brief Method Precompute addr 0xfbb328 size 0x7e4 virtual true final true
 Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo Precompute(Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo existing) ;

/// @brief Method CheckExisting addr 0xfbbb0c size 0x108 virtual false final false
...
/// @brief Method CheckTable addr 0xfbbc14 size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0xfbac34 size 0x44 virtual false final false
...
/// @brief Method Precompute addr 0xfbbc30 size 0x408 virtual true final true
 Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo Precompute(Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo existing) ;

/// @brief Method CheckExisting addr 0xfbc038 size 0x9c virtual false final false
 bool CheckExisting(Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo existingWNaf, int32_t width, int32_t reqPreCompLen, bool includeNegated) ;

/// @brief Method CheckTable addr 0xfbc0d4 size 0x1c virtual false final false
 bool CheckTable(::ArrayW<Org::BouncyCastle::Math::EC::ECPoint> table, int32_t reqLen) ;
...
/// @brief Method ConfigureBasepoint addr 0xfb9c2c size 0x180 virtual false final false
static void ConfigureBasepoint(Org::BouncyCastle::Math::EC::ECPoint p) ;

/// @brief Method GenerateCompactNaf addr 0xfb8a48 size 0x274 virtual false final false
static ::ArrayW<int32_t> GenerateCompactNaf(Org::BouncyCastle::Math::BigInteger k) ;

/// @brief Method GenerateCompactWindowNaf addr 0xfb9800 size 0x30c virtual false final false
static ::ArrayW<int32_t> GenerateCompactWindowNaf(int32_t width, Org::BouncyCastle::Math::BigInteger k) ;

/// @brief Method GenerateJsf addr 0xfb9e60 size 0x298 virtual false final false
static ::ArrayW<uint8_t> GenerateJsf(Org::BouncyCastle::Math::BigInteger g, Org::BouncyCastle::Math::BigInteger h) ;

/// @brief Method GenerateNaf addr 0xfba17c size 0x188 virtual false final false
static ::ArrayW<uint8_t> GenerateNaf(Org::BouncyCastle::Math::BigInteger k) ;

/// @brief Method GenerateWindowNaf addr 0xfba304 size 0x2d8 virtual false final false
static ::ArrayW<uint8_t> GenerateWindowNaf(int32_t width, Org::BouncyCastle::Math::BigInteger k) ;

/// @brief Method GetNafWeight addr 0xfba5dc size 0x64 virtual false final false
static int32_t GetNafWeight(Org::BouncyCastle::Math::BigInteger k) ;

/// @brief Method GetWNafPreCompInfo addr 0xfba640 size 0x98 virtual false final false
static Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo GetWNafPreCompInfo(Org::BouncyCastle::Math::EC::ECPoint p) ;

/// @brief Method GetWNafPreCompInfo addr 0xfba6d8 size 0x78 virtual false final false
...
/// @brief Method GetWindowSize addr 0xfb9660 size 0x64 virtual false final false
static int32_t GetWindowSize(int32_t bits) ;

/// @brief Method GetWindowSize addr 0xfba808 size 0x70 virtual false final false
static int32_t GetWindowSize(int32_t bits, int32_t maxWidth) ;

/// @brief Method GetWindowSize addr 0xfba878 size 0x70 virtual false final false
static int32_t GetWindowSize(int32_t bits, ::ArrayW<int32_t> windowSizeCutoffs) ;

/// @brief Method GetWindowSize addr 0xfba750 size 0xb8 virtual false final false
static int32_t GetWindowSize(int32_t bits, ::ArrayW<int32_t> windowSizeCutoffs, int32_t maxWidth) ;

/// @brief Method MapPointWithPrecomp addr 0xfba8e8 size 0x18c virtual false final false
...
/// @brief Method Precompute addr 0xfb96c4 size 0x13c virtual false final false
...
/// @brief Method PrecomputeWithPointMap addr 0xfbaaf4 size 0x140 virtual false final false
...
/// @brief Method Trim addr 0xfba0f8 size 0x84 virtual false final false
static ::ArrayW<uint8_t> Trim(::ArrayW<uint8_t> a, int32_t length) ;

/// @brief Method Trim addr 0xfb9ddc size 0x84 virtual false final false
static ::ArrayW<int32_t> Trim(::ArrayW<int32_t> a, int32_t length) ;

/// @brief Method ResizeTable addr 0xfbac78 size 0x84 virtual false final false
...
/// @brief Method .ctor addr 0xfbadf0 size 0x8 virtual false final false
 void _ctor() ;
