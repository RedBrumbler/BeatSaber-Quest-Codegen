...
/// @brief Method Multiply addr 0xfb77cc size 0xdc virtual true final false
...
/// @brief Method CheckResult addr 0xfb78a8 size 0xc virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint CheckResult(Org::BouncyCastle::Math::EC::ECPoint p) ;

// Ctor Parameters []
explicit AbstractECMultiplier() ;

/// @brief Method .ctor addr 0xfb78b4 size 0x8 virtual false final false
 void _ctor() ;
