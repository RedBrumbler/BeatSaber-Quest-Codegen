...
/// @brief Method get_LookupTable addr 0xfb7e94 size 0x8 virtual true final false
 Org::BouncyCastle::Math::EC::ECLookupTable get_LookupTable() ;

/// @brief Method set_LookupTable addr 0xfb7e9c size 0x8 virtual true final false
 void set_LookupTable(Org::BouncyCastle::Math::EC::ECLookupTable value) ;

/// @brief Method get_Offset addr 0xfb7ea4 size 0x8 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint get_Offset() ;

/// @brief Method set_Offset addr 0xfb7eac size 0x8 virtual true final false
 void set_Offset(Org::BouncyCastle::Math::EC::ECPoint value) ;

/// @brief Method get_Width addr 0xfb7eb4 size 0x8 virtual true final false
 int32_t get_Width() ;

/// @brief Method set_Width addr 0xfb7ebc size 0x8 virtual true final false
 void set_Width(int32_t value) ;

// Ctor Parameters []
explicit FixedPointPreCompInfo() ;

/// @brief Method .ctor addr 0xfb7ec4 size 0x14 virtual false final false
 void _ctor() ;
