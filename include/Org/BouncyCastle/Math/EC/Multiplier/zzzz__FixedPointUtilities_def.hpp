...
/// @brief Method .ctor addr 0xfb7f50 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Math::EC::ECPoint p) ;

/// @brief Method Precompute addr 0xfb7fe0 size 0x434 virtual true final true
 Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo Precompute(Org::BouncyCastle::Math::EC::Multiplier::PreCompInfo existing) ;

/// @brief Method CheckExisting addr 0xfb8414 size 0x38 virtual false final false
 bool CheckExisting(Org::BouncyCastle::Math::EC::Multiplier::FixedPointPreCompInfo existingFP, int32_t n) ;

/// @brief Method CheckTable addr 0xfb844c size 0xb0 virtual false final false
...
/// @brief Method GetCombSize addr 0xfb7d20 size 0x4c virtual false final false
static int32_t GetCombSize(Org::BouncyCastle::Math::EC::ECCurve c) ;

/// @brief Method GetFixedPointPreCompInfo addr 0xfb7ed8 size 0x78 virtual false final false
...
/// @brief Method Precompute addr 0xfb7d6c size 0x120 virtual false final false
...
/// @brief Method .ctor addr 0xfb7fd8 size 0x8 virtual false final false
 void _ctor() ;
