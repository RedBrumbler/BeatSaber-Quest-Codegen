...
/// @brief Method .ctor addr 0xfb8810 size 0x24 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xfb8834 size 0x2c virtual false final false
 void _ctor(int32_t additionCoord, int32_t doublingCoord) ;

/// @brief Method MultiplyPositive addr 0xfb8860 size 0x1e8 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint MultiplyPositive(Org::BouncyCastle::Math::EC::ECPoint p, Org::BouncyCastle::Math::BigInteger k) ;

/// @brief Method ConfigureCurve addr 0xfb8cbc size 0x134 virtual true final false
