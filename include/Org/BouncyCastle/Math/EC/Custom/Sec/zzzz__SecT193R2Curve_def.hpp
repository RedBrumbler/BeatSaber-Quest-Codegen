...
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
class Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable;
}
namespace Org::BouncyCastle::Math::EC::Custom::Sec {
...
class CORDL_TYPE Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable : public Org::BouncyCastle::Math::EC::AbstractECLookupTable {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable() = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable", modifiers: " const&", def_value: None }]
constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable(Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable", modifiers: "&&", def_value: None }]
constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable(Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable(void* ptr) noexcept : Org::BouncyCastle::Math::EC::AbstractECLookupTable(ptr) {
}


  constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable& operator=(Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable&& o) noexcept = default;
  constexpr Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable& operator=(Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable const& o) noexcept = default;
...
explicit Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable(Org::BouncyCastle::Math::EC::Custom::Sec::SecT193R2Curve outer, ::ArrayW<uint64_t> table, int32_t size) ;

/// @brief Method .ctor addr 0xf99e38 size 0x3c virtual false final false
 void _ctor(Org::BouncyCastle::Math::EC::Custom::Sec::SecT193R2Curve outer, ::ArrayW<uint64_t> table, int32_t size) ;

/// @brief Method get_Size addr 0xf99f80 size 0x8 virtual true final false
 int32_t get_Size() ;

/// @brief Method Lookup addr 0xf99f88 size 0x118 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint Lookup(int32_t index) ;

/// @brief Method LookupVar addr 0xf9a180 size 0xc8 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint LookupVar(int32_t index) ;

/// @brief Method CreatePoint addr 0xf9a0a0 size 0xe0 virtual false final false
...
public:
// Declarations
using SecT193R2LookupTable = Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable;
...
/// @brief Method .ctor addr 0xf997d4 size 0x200 virtual false final false
 void _ctor() ;

/// @brief Method CloneCurve addr 0xf999dc size 0x58 virtual true final false
 Org::BouncyCastle::Math::EC::ECCurve CloneCurve() ;

/// @brief Method SupportsCoordinateSystem addr 0xf99a34 size 0xc virtual true final false
 bool SupportsCoordinateSystem(int32_t coord) ;

/// @brief Method get_Infinity addr 0xf99a40 size 0x8 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint get_Infinity() ;

/// @brief Method get_FieldSize addr 0xf99a48 size 0x8 virtual true final false
 int32_t get_FieldSize() ;

/// @brief Method FromBigInteger addr 0xf99a50 size 0x60 virtual true final false
 Org::BouncyCastle::Math::EC::ECFieldElement FromBigInteger(Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method CreateRawPoint addr 0xf99ab0 size 0x88 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint CreateRawPoint(Org::BouncyCastle::Math::EC::ECFieldElement x, Org::BouncyCastle::Math::EC::ECFieldElement y, bool withCompression) ;

/// @brief Method CreateRawPoint addr 0xf99bc4 size 0x94 virtual true final false
...
/// @brief Method get_IsKoblitz addr 0xf99c64 size 0x8 virtual true final false
 bool get_IsKoblitz() ;

/// @brief Method get_M addr 0xf99c6c size 0x8 virtual true final false
 int32_t get_M() ;

/// @brief Method get_IsTrinomial addr 0xf99c74 size 0x8 virtual true final false
 bool get_IsTrinomial() ;

/// @brief Method get_K1 addr 0xf99c7c size 0x8 virtual true final false
 int32_t get_K1() ;

/// @brief Method get_K2 addr 0xf99c84 size 0x8 virtual true final false
 int32_t get_K2() ;

/// @brief Method get_K3 addr 0xf99c8c size 0x8 virtual true final false
 int32_t get_K3() ;

/// @brief Method CreateCacheSafeLookupTable addr 0xf99c94 size 0x1a4 virtual true final false
...
NEED_NO_BOX(Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable);
DEFINE_IL2CPP_ARG_TYPE(Org::BouncyCastle::Math::EC::Custom::Sec::Org__BouncyCastle__Math__EC__Custom__Sec__SecT193R2Curve__SecT193R2LookupTable, "Org.BouncyCastle.Math.EC.Custom.Sec", "SecT193R2Curve/SecT193R2LookupTable");
