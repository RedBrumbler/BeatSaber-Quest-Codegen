...
/// @brief Method Add addr 0xfb0e00 size 0x70 virtual false final false
static void Add(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> y, ::ArrayW<uint64_t> z) ;

/// @brief Method Add addr 0xfb0e70 size 0x94 virtual false final false
static void Add(::ArrayW<uint64_t> x, int32_t xOff, ::ArrayW<uint64_t> y, int32_t yOff, ::ArrayW<uint64_t> z, int32_t zOff) ;

/// @brief Method AddBothTo addr 0xfb0f04 size 0x9c virtual false final false
static void AddBothTo(::ArrayW<uint64_t> x, int32_t xOff, ::ArrayW<uint64_t> y, int32_t yOff, ::ArrayW<uint64_t> z, int32_t zOff) ;

/// @brief Method AddExt addr 0xfb0fa0 size 0x70 virtual false final false
static void AddExt(::ArrayW<uint64_t> xx, ::ArrayW<uint64_t> yy, ::ArrayW<uint64_t> zz) ;

/// @brief Method AddOne addr 0xfb1010 size 0x74 virtual false final false
static void AddOne(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> z) ;

/// @brief Method AddTo addr 0xfb1084 size 0x5c virtual false final false
static void AddTo(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> z) ;

/// @brief Method FromBigInteger addr 0xfb10e0 size 0x10 virtual false final false
static ::ArrayW<uint64_t> FromBigInteger(Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method HalfTrace addr 0xfb10f0 size 0xc4 virtual false final false
static void HalfTrace(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> z) ;

/// @brief Method Invert addr 0xfb1438 size 0x250 virtual false final false
static void Invert(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> z) ;

/// @brief Method Multiply addr 0xfb1708 size 0x88 virtual false final false
static void Multiply(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> y, ::ArrayW<uint64_t> z) ;

/// @brief Method MultiplyAddToExt addr 0xfb1ad8 size 0x8c virtual false final false
static void MultiplyAddToExt(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> y, ::ArrayW<uint64_t> zz) ;

/// @brief Method Reduce addr 0xfb12f0 size 0x148 virtual false final false
static void Reduce(::ArrayW<uint64_t> xx, ::ArrayW<uint64_t> z) ;

/// @brief Method Reduce5 addr 0xfb1b64 size 0x6c virtual false final false
static void Reduce5(::ArrayW<uint64_t> z, int32_t zOff) ;

/// @brief Method Sqrt addr 0xfb1bd0 size 0x198 virtual false final false
static void Sqrt(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> z) ;

/// @brief Method Square addr 0xfb1688 size 0x80 virtual false final false
static void Square(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> z) ;

/// @brief Method SquareAddToExt addr 0xfb1d68 size 0x84 virtual false final false
static void SquareAddToExt(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> zz) ;

/// @brief Method SquareN addr 0xfb1790 size 0xc8 virtual false final false
static void SquareN(::ArrayW<uint64_t> x, int32_t n, ::ArrayW<uint64_t> z) ;

/// @brief Method Trace addr 0xfb1dec size 0x44 virtual false final false
static uint32_t Trace(::ArrayW<uint64_t> x) ;

/// @brief Method ImplMultiply addr 0xfb1858 size 0x280 virtual false final false
static void ImplMultiply(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> y, ::ArrayW<uint64_t> zz) ;

/// @brief Method ImplMulwAcc addr 0xfb1e30 size 0x1dc virtual false final false
static void ImplMulwAcc(::ArrayW<uint64_t> xs, uint64_t y, ::ArrayW<uint64_t> z, int32_t zOff) ;

/// @brief Method ImplSquare addr 0xfb11b4 size 0x13c virtual false final false
static void ImplSquare(::ArrayW<uint64_t> x, ::ArrayW<uint64_t> zz) ;

// Ctor Parameters []
explicit SecT571Field() ;

/// @brief Method .ctor addr 0xfb20a0 size 0x8 virtual false final false
 void _ctor() ;
