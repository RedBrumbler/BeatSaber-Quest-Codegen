...
/// @brief Method .ctor addr 0xf547a0 size 0x3c virtual false final false
 void _ctor(Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve outer, ::ArrayW<uint32_t> table, int32_t size) ;

/// @brief Method get_Size addr 0xf54bc4 size 0x8 virtual true final false
 int32_t get_Size() ;

/// @brief Method Lookup addr 0xf54bcc size 0x118 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint Lookup(int32_t index) ;

/// @brief Method LookupVar addr 0xf54dc4 size 0xc4 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint LookupVar(int32_t index) ;

/// @brief Method CreatePoint addr 0xf54ce4 size 0xe0 virtual false final false
...
/// @brief Method .ctor addr 0xf53f94 size 0x218 virtual false final false
 void _ctor() ;

/// @brief Method CloneCurve addr 0xf541b4 size 0x58 virtual true final false
 Org::BouncyCastle::Math::EC::ECCurve CloneCurve() ;

/// @brief Method SupportsCoordinateSystem addr 0xf5420c size 0xc virtual true final false
 bool SupportsCoordinateSystem(int32_t coord) ;

/// @brief Method get_Q addr 0xf54218 size 0x58 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_Q() ;

/// @brief Method get_Infinity addr 0xf54270 size 0x8 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint get_Infinity() ;

/// @brief Method get_FieldSize addr 0xf54278 size 0x64 virtual true final false
 int32_t get_FieldSize() ;

/// @brief Method FromBigInteger addr 0xf542dc size 0x60 virtual true final false
 Org::BouncyCastle::Math::EC::ECFieldElement FromBigInteger(Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method CreateRawPoint addr 0xf54454 size 0x88 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint CreateRawPoint(Org::BouncyCastle::Math::EC::ECFieldElement x, Org::BouncyCastle::Math::EC::ECFieldElement y, bool withCompression) ;

/// @brief Method CreateRawPoint addr 0xf54564 size 0x90 virtual true final false
...
/// @brief Method CreateCacheSafeLookupTable addr 0xf545fc size 0x1a4 virtual true final false
...
/// @brief Method RandomFieldElement addr 0xf547dc size 0xa4 virtual true final false
 Org::BouncyCastle::Math::EC::ECFieldElement RandomFieldElement(Org::BouncyCastle::Security::SecureRandom r) ;

/// @brief Method RandomFieldElementMult addr 0xf54980 size 0xa4 virtual true final false
