...
/// @brief Method CalculateAgreement addr 0xfbf964 size 0xb4 virtual false final false
static bool CalculateAgreement(::ArrayW<uint8_t> k, int32_t kOff, ::ArrayW<uint8_t> u, int32_t uOff, ::ArrayW<uint8_t> r, int32_t rOff) ;

/// @brief Method Decode32 addr 0xfbfd10 size 0x68 virtual false final false
static uint32_t Decode32(::ArrayW<uint8_t> bs, int32_t off) ;

/// @brief Method DecodeScalar addr 0xfbfd78 size 0x8c virtual false final false
static void DecodeScalar(::ArrayW<uint8_t> k, int32_t kOff, ::ArrayW<uint32_t> n) ;

/// @brief Method GeneratePrivateKey addr 0xfbfe04 size 0x54 virtual false final false
static void GeneratePrivateKey(Org::BouncyCastle::Security::SecureRandom random, ::ArrayW<uint8_t> k) ;

/// @brief Method GeneratePublicKey addr 0xfbfe58 size 0x4 virtual false final false
static void GeneratePublicKey(::ArrayW<uint8_t> k, int32_t kOff, ::ArrayW<uint8_t> r, int32_t rOff) ;

/// @brief Method PointDouble addr 0xfbff40 size 0xb8 virtual false final false
static void PointDouble(::ArrayW<uint32_t> x, ::ArrayW<uint32_t> z) ;

/// @brief Method Precompute addr 0xfc14cc size 0x50 virtual false final false
static void Precompute() ;

/// @brief Method ScalarMult addr 0xfbfa18 size 0x2f8 virtual false final false
static void ScalarMult(::ArrayW<uint8_t> k, int32_t kOff, ::ArrayW<uint8_t> u, int32_t uOff, ::ArrayW<uint8_t> r, int32_t rOff) ;

/// @brief Method ScalarMultBase addr 0xfbfe5c size 0xe4 virtual false final false
static void ScalarMultBase(::ArrayW<uint8_t> k, int32_t kOff, ::ArrayW<uint8_t> r, int32_t rOff) ;

// Ctor Parameters []
explicit X448() ;

/// @brief Method .ctor addr 0xfc17d0 size 0x8 virtual false final false
 void _ctor() ;
