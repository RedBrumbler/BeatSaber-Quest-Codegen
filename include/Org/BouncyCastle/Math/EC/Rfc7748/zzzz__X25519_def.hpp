...
/// @brief Method CalculateAgreement addr 0xfbcc4c size 0xb4 virtual false final false
static bool CalculateAgreement(::ArrayW<uint8_t> k, int32_t kOff, ::ArrayW<uint8_t> u, int32_t uOff, ::ArrayW<uint8_t> r, int32_t rOff) ;

/// @brief Method Decode32 addr 0xfbd024 size 0x68 virtual false final false
static uint32_t Decode32(::ArrayW<uint8_t> bs, int32_t off) ;

/// @brief Method DecodeScalar addr 0xfbd08c size 0x90 virtual false final false
static void DecodeScalar(::ArrayW<uint8_t> k, int32_t kOff, ::ArrayW<uint32_t> n) ;

/// @brief Method GeneratePrivateKey addr 0xfbd11c size 0x58 virtual false final false
static void GeneratePrivateKey(Org::BouncyCastle::Security::SecureRandom random, ::ArrayW<uint8_t> k) ;

/// @brief Method GeneratePublicKey addr 0xfbd174 size 0x4 virtual false final false
static void GeneratePublicKey(::ArrayW<uint8_t> k, int32_t kOff, ::ArrayW<uint8_t> r, int32_t rOff) ;

/// @brief Method PointDouble addr 0xfbd274 size 0xe8 virtual false final false
static void PointDouble(::ArrayW<int32_t> x, ::ArrayW<int32_t> z) ;

/// @brief Method Precompute addr 0xfbdf34 size 0x4c virtual false final false
static void Precompute() ;

/// @brief Method ScalarMult addr 0xfbcd00 size 0x324 virtual false final false
static void ScalarMult(::ArrayW<uint8_t> k, int32_t kOff, ::ArrayW<uint8_t> u, int32_t uOff, ::ArrayW<uint8_t> r, int32_t rOff) ;

/// @brief Method ScalarMultBase addr 0xfbd178 size 0xfc virtual false final false
static void ScalarMultBase(::ArrayW<uint8_t> k, int32_t kOff, ::ArrayW<uint8_t> r, int32_t rOff) ;

// Ctor Parameters []
explicit X25519() ;

/// @brief Method .ctor addr 0xfbec28 size 0x8 virtual false final false
 void _ctor() ;
