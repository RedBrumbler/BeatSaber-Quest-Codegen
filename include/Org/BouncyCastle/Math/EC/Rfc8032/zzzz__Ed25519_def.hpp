...
/// @brief Method .ctor addr 0xfc6c80 size 0x94 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xfc6d14 size 0x88 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xfc6d9c size 0x7c virtual false final false
 void _ctor() ;
...
/// @brief Method CalculateS addr 0xfc2284 size 0x194 virtual false final false
static ::ArrayW<uint8_t> CalculateS(::ArrayW<uint8_t> r, ::ArrayW<uint8_t> k, ::ArrayW<uint8_t> s) ;

/// @brief Method CheckContextVar addr 0xfc29a0 size 0x2c virtual false final false
static bool CheckContextVar(::ArrayW<uint8_t> ctx, uint8_t phflag) ;

/// @brief Method CheckPoint addr 0xfc29cc size 0x114 virtual false final false
static int32_t CheckPoint(::ArrayW<int32_t> x, ::ArrayW<int32_t> y) ;

/// @brief Method CheckPoint addr 0xfc2ae0 size 0x158 virtual false final false
static int32_t CheckPoint(::ArrayW<int32_t> x, ::ArrayW<int32_t> y, ::ArrayW<int32_t> z) ;

/// @brief Method CheckPointVar addr 0xfc2c38 size 0xdc virtual false final false
static bool CheckPointVar(::ArrayW<uint8_t> p) ;

/// @brief Method CheckScalarVar addr 0xfc2de4 size 0xb0 virtual false final false
static bool CheckScalarVar(::ArrayW<uint8_t> s) ;

/// @brief Method CreateDigest addr 0xfc2e94 size 0x5c virtual false final false
static Org::BouncyCastle::Crypto::IDigest CreateDigest() ;

/// @brief Method CreatePrehash addr 0xfc2ef0 size 0x4c virtual false final false
static Org::BouncyCastle::Crypto::IDigest CreatePrehash() ;

/// @brief Method Decode24 addr 0xfc2f3c size 0x54 virtual false final false
static uint32_t Decode24(::ArrayW<uint8_t> bs, int32_t off) ;

/// @brief Method Decode32 addr 0xfc2f90 size 0x68 virtual false final false
static uint32_t Decode32(::ArrayW<uint8_t> bs, int32_t off) ;

/// @brief Method Decode32 addr 0xfc2d14 size 0xd0 virtual false final false
static void Decode32(::ArrayW<uint8_t> bs, int32_t bsOff, ::ArrayW<uint32_t> n, int32_t nOff, int32_t nLen) ;

/// @brief Method DecodePointVar addr 0xfc2ff8 size 0x234 virtual false final false
...
/// @brief Method DecodeScalar addr 0xfc2418 size 0x74 virtual false final false
static void DecodeScalar(::ArrayW<uint8_t> k, int32_t kOff, ::ArrayW<uint32_t> n) ;

/// @brief Method Dom2 addr 0xfc3298 size 0x244 virtual false final false
static void Dom2(Org::BouncyCastle::Crypto::IDigest d, uint8_t phflag, ::ArrayW<uint8_t> ctx) ;

/// @brief Method Encode24 addr 0xfc34dc size 0x64 virtual false final false
static void Encode24(uint32_t n, ::ArrayW<uint8_t> bs, int32_t off) ;

/// @brief Method Encode32 addr 0xfc248c size 0x80 virtual false final false
static void Encode32(uint32_t n, ::ArrayW<uint8_t> bs, int32_t off) ;

/// @brief Method Encode56 addr 0xfc3540 size 0x7c virtual false final false
static void Encode56(uint64_t n, ::ArrayW<uint8_t> bs, int32_t off) ;

/// @brief Method EncodePoint addr 0xfc35bc size 0x140 virtual false final false
...
/// @brief Method GeneratePrivateKey addr 0xfc36fc size 0x1c virtual false final false
static void GeneratePrivateKey(Org::BouncyCastle::Security::SecureRandom random, ::ArrayW<uint8_t> k) ;

/// @brief Method GeneratePublicKey addr 0xfc3718 size 0x220 virtual false final false
static void GeneratePublicKey(::ArrayW<uint8_t> sk, int32_t skOff, ::ArrayW<uint8_t> pk, int32_t pkOff) ;

/// @brief Method GetWnafVar addr 0xfc3a7c size 0x1b8 virtual false final false
static ::ArrayW<int8_t> GetWnafVar(::ArrayW<uint32_t> n, int32_t width) ;

/// @brief Method ImplSign addr 0xfc3c34 size 0x450 virtual false final false
...
/// @brief Method ImplSign addr 0xfc4084 size 0x31c virtual false final false
...
/// @brief Method ImplSign addr 0xfc43a0 size 0x328 virtual false final false
...
/// @brief Method ImplVerify addr 0xfc46c8 size 0x584 virtual false final false
...
/// @brief Method PointAddVar addr 0xfc4e08 size 0x220 virtual false final false
...
/// @brief Method PointAddVar addr 0xfc5028 size 0x22c virtual false final false
...
/// @brief Method PointAddPrecomp addr 0xfc5254 size 0x154 virtual false final false
...
/// @brief Method PointCopy addr 0xfc53a8 size 0xe0 virtual false final false
...
/// @brief Method PointCopy addr 0xfc5488 size 0xe8 virtual false final false
...
/// @brief Method PointPrecompVar addr 0xfc587c size 0x1c0 virtual false final false
...
/// @brief Method PointSetNeutral addr 0xfc5a3c size 0x80 virtual false final false
static void PointSetNeutral(Org::BouncyCastle::Math::EC::Rfc8032::Org__BouncyCastle__Math__EC__Rfc8032__Ed25519__PointAccum p) ;

/// @brief Method PointSetNeutral addr 0xfc5abc size 0x78 virtual false final false
static void PointSetNeutral(Org::BouncyCastle::Math::EC::Rfc8032::Org__BouncyCastle__Math__EC__Rfc8032__Ed25519__PointExt p) ;

/// @brief Method Precompute addr 0xfbdf80 size 0x804 virtual false final false
static void Precompute() ;

/// @brief Method PruneScalar addr 0xfc3938 size 0x58 virtual false final false
static void PruneScalar(::ArrayW<uint8_t> n, int32_t nOff, ::ArrayW<uint8_t> r) ;

/// @brief Method ReduceScalar addr 0xfc250c size 0x494 virtual false final false
static ::ArrayW<uint8_t> ReduceScalar(::ArrayW<uint8_t> n) ;

/// @brief Method ScalarMultBase addr 0xfc5b34 size 0x254 virtual false final false
...
/// @brief Method ScalarMultBaseEncoded addr 0xfc3990 size 0xec virtual false final false
static void ScalarMultBaseEncoded(::ArrayW<uint8_t> k, ::ArrayW<uint8_t> r, int32_t rOff) ;

/// @brief Method ScalarMultBaseYZ addr 0xfbeab0 size 0x178 virtual false final false
static void ScalarMultBaseYZ(::ArrayW<uint8_t> k, int32_t kOff, ::ArrayW<int32_t> y, ::ArrayW<int32_t> z) ;

/// @brief Method ScalarMultStrausVar addr 0xfc4c4c size 0x1bc virtual false final false
...
/// @brief Method Sign addr 0xfc5d88 size 0xb0 virtual false final false
...
/// @brief Method Sign addr 0xfc5e38 size 0xc8 virtual false final false
...
/// @brief Method Sign addr 0xfc5f00 size 0xbc virtual false final false
...
/// @brief Method Sign addr 0xfc5fbc size 0xcc virtual false final false
...
/// @brief Method SignPrehash addr 0xfc6088 size 0xb8 virtual false final false
...
/// @brief Method SignPrehash addr 0xfc6140 size 0xd4 virtual false final false
...
/// @brief Method SignPrehash addr 0xfc6214 size 0x1cc virtual false final false
...
/// @brief Method SignPrehash addr 0xfc63e0 size 0x1e8 virtual false final false
...
/// @brief Method Verify addr 0xfc65c8 size 0xb4 virtual false final false
...
/// @brief Method Verify addr 0xfc667c size 0xc0 virtual false final false
...
/// @brief Method VerifyPrehash addr 0xfc673c size 0xc0 virtual false final false
...
/// @brief Method VerifyPrehash addr 0xfc67fc size 0x1d4 virtual false final false
...
/// @brief Method .ctor addr 0xfc6c78 size 0x8 virtual false final false
 void _ctor() ;
