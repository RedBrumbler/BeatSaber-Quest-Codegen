...
/// @brief Method HalfTrace addr 0xf826ec size 0x140 virtual true final false
 Org::BouncyCastle::Math::EC::ECFieldElement HalfTrace() ;

/// @brief Method get_HasFastTrace addr 0xf8282c size 0x8 virtual true final false
 bool get_HasFastTrace() ;

/// @brief Method Trace addr 0xf82834 size 0x14c virtual true final false
 int32_t Trace() ;

// Ctor Parameters []
explicit AbstractF2mFieldElement() ;

/// @brief Method .ctor addr 0xf82980 size 0x8 virtual false final false
 void _ctor() ;
