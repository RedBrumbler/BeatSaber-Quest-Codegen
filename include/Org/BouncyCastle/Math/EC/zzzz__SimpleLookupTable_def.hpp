...
/// @brief Method Copy addr 0xfdcb18 size 0xec virtual false final false
...
/// @brief Method .ctor addr 0xfdcc04 size 0x48 virtual false final false
 void _ctor(::ArrayW<Org::BouncyCastle::Math::EC::ECPoint> points, int32_t off, int32_t len) ;

/// @brief Method get_Size addr 0xfdcc4c size 0x1c virtual true final false
 int32_t get_Size() ;

/// @brief Method Lookup addr 0xfdcc68 size 0x50 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint Lookup(int32_t index) ;

/// @brief Method LookupVar addr 0xfdccb8 size 0x30 virtual true final false
