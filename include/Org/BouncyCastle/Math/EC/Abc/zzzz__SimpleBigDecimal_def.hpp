...
/// @brief Method GetInstance addr 0xf4827c size 0x84 virtual false final false
...
/// @brief Method .ctor addr 0xf48300 size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0xf48380 size 0x3c virtual false final false
 void _ctor(Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal limBigDec) ;

/// @brief Method CheckScale addr 0xf483bc size 0x70 virtual false final false
 void CheckScale(Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal b) ;

/// @brief Method AdjustScale addr 0xf4842c size 0xe0 virtual false final false
 Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal AdjustScale(int32_t newScale) ;

/// @brief Method Add addr 0xf4850c size 0x98 virtual false final false
 Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal Add(Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal b) ;

/// @brief Method Add addr 0xf485a4 size 0xa0 virtual false final false
 Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal Add(Org::BouncyCastle::Math::BigInteger b) ;

/// @brief Method Negate addr 0xf48644 size 0x80 virtual false final false
 Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal Negate() ;

/// @brief Method Subtract addr 0xf486c4 size 0x28 virtual false final false
 Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal Subtract(Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal b) ;

/// @brief Method Subtract addr 0xf486ec size 0xa0 virtual false final false
 Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal Subtract(Org::BouncyCastle::Math::BigInteger b) ;

/// @brief Method Multiply addr 0xf4878c size 0x98 virtual false final false
 Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal Multiply(Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal b) ;

/// @brief Method Multiply addr 0xf48824 size 0x88 virtual false final false
 Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal Multiply(Org::BouncyCastle::Math::BigInteger b) ;

/// @brief Method Divide addr 0xf488ac size 0xa8 virtual false final false
 Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal Divide(Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal b) ;

/// @brief Method Divide addr 0xf48954 size 0x88 virtual false final false
 Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal Divide(Org::BouncyCastle::Math::BigInteger b) ;

/// @brief Method ShiftLeft addr 0xf489dc size 0x88 virtual false final false
 Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal ShiftLeft(int32_t n) ;

/// @brief Method CompareTo addr 0xf48a64 size 0x38 virtual false final false
 int32_t CompareTo(Org::BouncyCastle::Math::EC::Abc::SimpleBigDecimal val) ;

/// @brief Method CompareTo addr 0xf48a9c size 0x3c virtual false final false
 int32_t CompareTo(Org::BouncyCastle::Math::BigInteger val) ;

/// @brief Method Floor addr 0xf48ad8 size 0x24 virtual false final false
 Org::BouncyCastle::Math::BigInteger Floor() ;

/// @brief Method Round addr 0xf48afc size 0xbc virtual false final false
 Org::BouncyCastle::Math::BigInteger Round() ;

/// @brief Method get_IntValue addr 0xf48bb8 size 0x1c virtual false final false
 int32_t get_IntValue() ;

/// @brief Method get_LongValue addr 0xf48bd4 size 0x1c virtual false final false
 int64_t get_LongValue() ;

/// @brief Method get_Scale addr 0xf48bf0 size 0x8 virtual false final false
 int32_t get_Scale() ;

/// @brief Method ToString addr 0xf48bf8 size 0x2fc virtual true final false
 ::StringW ToString() ;

/// @brief Method Equals addr 0xf48ef4 size 0xc4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0xf48fb8 size 0x30 virtual true final false
 int32_t GetHashCode() ;
