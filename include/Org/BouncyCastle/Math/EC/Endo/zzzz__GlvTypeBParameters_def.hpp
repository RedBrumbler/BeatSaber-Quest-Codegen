...
/// @brief Method .ctor addr 0xfb72c8 size 0xbc virtual false final false
...
/// @brief Method .ctor addr 0xfb7480 size 0x3c virtual false final false
...
/// @brief Method get_Beta addr 0xfb74bc size 0x8 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_Beta() ;

/// @brief Method get_Lambda addr 0xfb74c4 size 0x8 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_Lambda() ;

/// @brief Method get_SplitParams addr 0xfb74cc size 0x8 virtual true final false
 Org::BouncyCastle::Math::EC::Endo::ScalarSplitParameters get_SplitParams() ;

/// @brief Method get_V1 addr 0xfb74d4 size 0xec virtual true final false
 ::ArrayW<Org::BouncyCastle::Math::BigInteger> get_V1() ;

/// @brief Method get_V2 addr 0xfb75c0 size 0xec virtual true final false
 ::ArrayW<Org::BouncyCastle::Math::BigInteger> get_V2() ;

/// @brief Method get_G1 addr 0xfb76ac size 0x20 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_G1() ;

/// @brief Method get_G2 addr 0xfb76cc size 0x20 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_G2() ;

/// @brief Method get_Bits addr 0xfb76ec size 0x20 virtual true final false
 int32_t get_Bits() ;
