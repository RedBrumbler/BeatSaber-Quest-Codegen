...
/// @brief Method CheckVector addr 0xfb770c size 0x88 virtual false final false
...
/// @brief Method .ctor addr 0xfb7384 size 0xfc virtual false final false
...
/// @brief Method get_V1A addr 0xfb7794 size 0x8 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_V1A() ;

/// @brief Method get_V1B addr 0xfb779c size 0x8 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_V1B() ;

/// @brief Method get_V2A addr 0xfb77a4 size 0x8 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_V2A() ;

/// @brief Method get_V2B addr 0xfb77ac size 0x8 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_V2B() ;

/// @brief Method get_G1 addr 0xfb77b4 size 0x8 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_G1() ;

/// @brief Method get_G2 addr 0xfb77bc size 0x8 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_G2() ;

/// @brief Method get_Bits addr 0xfb77c4 size 0x8 virtual true final false
 int32_t get_Bits() ;
