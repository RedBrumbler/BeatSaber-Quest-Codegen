...
/// @brief Method .ctor addr 0xfb7184 size 0xb8 virtual false final false
 void _ctor(Org::BouncyCastle::Math::EC::ECCurve curve, Org::BouncyCastle::Math::EC::Endo::GlvTypeBParameters parameters) ;

/// @brief Method DecomposeScalar addr 0xfb723c size 0x7c virtual true final false
 ::ArrayW<Org::BouncyCastle::Math::BigInteger> DecomposeScalar(Org::BouncyCastle::Math::BigInteger k) ;

/// @brief Method get_PointMap addr 0xfb72b8 size 0x8 virtual true final false
 Org::BouncyCastle::Math::EC::ECPointMap get_PointMap() ;

/// @brief Method get_HasEfficientPointMap addr 0xfb72c0 size 0x8 virtual true final false
