...
/// @brief Method .ctor addr 0xfb6fec size 0xb8 virtual false final false
 void _ctor(Org::BouncyCastle::Math::EC::ECCurve curve, Org::BouncyCastle::Math::EC::Endo::GlvTypeAParameters parameters) ;

/// @brief Method DecomposeScalar addr 0xfb70a4 size 0x7c virtual true final false
 ::ArrayW<Org::BouncyCastle::Math::BigInteger> DecomposeScalar(Org::BouncyCastle::Math::BigInteger k) ;

/// @brief Method get_PointMap addr 0xfb7120 size 0x8 virtual true final false
 Org::BouncyCastle::Math::EC::ECPointMap get_PointMap() ;

/// @brief Method get_HasEfficientPointMap addr 0xfb7128 size 0x8 virtual true final false
