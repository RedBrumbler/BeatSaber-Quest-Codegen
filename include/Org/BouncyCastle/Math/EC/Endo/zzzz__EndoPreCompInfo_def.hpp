...
/// @brief Method get_Endomorphism addr 0xfb6884 size 0x8 virtual true final false
 Org::BouncyCastle::Math::EC::Endo::ECEndomorphism get_Endomorphism() ;

/// @brief Method set_Endomorphism addr 0xfb688c size 0x8 virtual true final false
 void set_Endomorphism(Org::BouncyCastle::Math::EC::Endo::ECEndomorphism value) ;

/// @brief Method get_MappedPoint addr 0xfb6894 size 0x8 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint get_MappedPoint() ;

/// @brief Method set_MappedPoint addr 0xfb689c size 0x8 virtual true final false
 void set_MappedPoint(Org::BouncyCastle::Math::EC::ECPoint value) ;

// Ctor Parameters []
explicit EndoPreCompInfo() ;

/// @brief Method .ctor addr 0xfb68a4 size 0x8 virtual false final false
 void _ctor() ;
