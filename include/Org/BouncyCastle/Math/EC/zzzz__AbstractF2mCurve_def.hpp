...
/// @brief Method Inverse addr 0xf834ac size 0x8c virtual false final false
static Org::BouncyCastle::Math::BigInteger Inverse(int32_t m, ::ArrayW<int32_t> ks, Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method BuildField addr 0xf83538 size 0x1e0 virtual false final false
...
/// @brief Method .ctor addr 0xf83718 size 0x34 virtual false final false
 void _ctor(int32_t m, int32_t k1, int32_t k2, int32_t k3) ;

/// @brief Method CreatePoint addr 0xf8374c size 0x160 virtual true final false
...
/// @brief Method IsValidFieldElement addr 0xf838ac size 0x54 virtual true final false
 bool IsValidFieldElement(Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method RandomFieldElement addr 0xf83900 size 0x48 virtual true final false
 Org::BouncyCastle::Math::EC::ECFieldElement RandomFieldElement(Org::BouncyCastle::Security::SecureRandom r) ;

/// @brief Method RandomFieldElementMult addr 0xf83948 size 0x94 virtual true final false
 Org::BouncyCastle::Math::EC::ECFieldElement RandomFieldElementMult(Org::BouncyCastle::Security::SecureRandom r) ;

/// @brief Method DecompressPoint addr 0xf83a1c size 0x214 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint DecompressPoint(int32_t yTilde, Org::BouncyCastle::Math::BigInteger X1) ;

/// @brief Method SolveQuadraticEquation addr 0xf83c30 size 0x2ec virtual false final false
 Org::BouncyCastle::Math::EC::ECFieldElement SolveQuadraticEquation(Org::BouncyCastle::Math::EC::ECFieldElement beta) ;

/// @brief Method GetSi addr 0xf83f1c size 0xf4 virtual true final false
 ::ArrayW<Org::BouncyCastle::Math::BigInteger> GetSi() ;

/// @brief Method get_IsKoblitz addr 0xf84010 size 0x84 virtual true final false
 bool get_IsKoblitz() ;

/// @brief Method ImplRandomFieldElementMult addr 0xf839dc size 0x40 virtual false final false
