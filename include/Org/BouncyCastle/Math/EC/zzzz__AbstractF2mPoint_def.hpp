...
/// @brief Method .ctor addr 0xf84b14 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0xf84b20 size 0xc virtual false final false
...
/// @brief Method SatisfiesCurveEquation addr 0xf84b2c size 0x458 virtual true final false
 bool SatisfiesCurveEquation() ;

/// @brief Method SatisfiesOrder addr 0xf84f84 size 0x308 virtual true final false
 bool SatisfiesOrder() ;

/// @brief Method ScaleX addr 0xf8528c size 0x298 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint ScaleX(Org::BouncyCastle::Math::EC::ECFieldElement scale) ;

/// @brief Method ScaleXNegateY addr 0xf85524 size 0x10 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint ScaleXNegateY(Org::BouncyCastle::Math::EC::ECFieldElement scale) ;

/// @brief Method ScaleY addr 0xf85534 size 0xe8 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint ScaleY(Org::BouncyCastle::Math::EC::ECFieldElement scale) ;

/// @brief Method ScaleYNegateX addr 0xf8561c size 0x10 virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint ScaleYNegateX(Org::BouncyCastle::Math::EC::ECFieldElement scale) ;

/// @brief Method Subtract addr 0xf8562c size 0x6c virtual true final false
 Org::BouncyCastle::Math::EC::ECPoint Subtract(Org::BouncyCastle::Math::EC::ECPoint b) ;

/// @brief Method Tau addr 0xf85698 size 0x288 virtual true final false
 Org::BouncyCastle::Math::EC::AbstractF2mPoint Tau() ;

/// @brief Method TauPow addr 0xf85920 size 0x2a8 virtual true final false
