...
/// @brief Method GetBinaryExtensionField addr 0xfdcce8 size 0x194 virtual false final false
static Org::BouncyCastle::Math::Field::IPolynomialExtensionField GetBinaryExtensionField(::ArrayW<int32_t> exponents) ;

/// @brief Method GetPrimeField addr 0xfdcf20 size 0x180 virtual false final false
...
/// @brief Method .ctor addr 0xfdd1c0 size 0x8 virtual false final false
 void _ctor() ;
