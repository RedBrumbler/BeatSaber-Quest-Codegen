...
/// @brief Method .ctor addr 0xfdcef4 size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Math::Field::IFiniteField subfield, Org::BouncyCastle::Math::Field::IPolynomial polynomial) ;

/// @brief Method get_Characteristic addr 0xfdd1c8 size 0xa0 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_Characteristic() ;

/// @brief Method get_Dimension addr 0xfdd268 size 0x124 virtual true final false
 int32_t get_Dimension() ;

/// @brief Method get_Subfield addr 0xfdd38c size 0x8 virtual true final false
 Org::BouncyCastle::Math::Field::IFiniteField get_Subfield() ;

/// @brief Method get_Degree addr 0xfdd394 size 0xa0 virtual true final false
 int32_t get_Degree() ;

/// @brief Method get_MinimalPolynomial addr 0xfdd434 size 0x8 virtual true final false
 Org::BouncyCastle::Math::Field::IPolynomial get_MinimalPolynomial() ;

/// @brief Method Equals addr 0xfdd43c size 0xd0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0xfdd50c size 0x54 virtual true final false
 int32_t GetHashCode() ;
