...
/// @brief Method .ctor addr 0xfdce7c size 0x78 virtual false final false
 void _ctor(::ArrayW<int32_t> exponents) ;

/// @brief Method get_Degree addr 0xfdd560 size 0x34 virtual true final false
 int32_t get_Degree() ;

/// @brief Method GetExponentsPresent addr 0xfdd594 size 0x5c virtual true final false
 ::ArrayW<int32_t> GetExponentsPresent() ;

/// @brief Method Equals addr 0xfdd5f0 size 0xd8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0xfdd6c8 size 0x5c virtual true final false
 int32_t GetHashCode() ;
