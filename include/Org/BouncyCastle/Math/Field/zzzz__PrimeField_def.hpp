...
/// @brief Method .ctor addr 0xfdd0a0 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger characteristic) ;

/// @brief Method get_Characteristic addr 0xfdd724 size 0x8 virtual true final false
 Org::BouncyCastle::Math::BigInteger get_Characteristic() ;

/// @brief Method get_Dimension addr 0xfdd72c size 0x8 virtual true final false
 int32_t get_Dimension() ;

/// @brief Method Equals addr 0xfdd734 size 0xb4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0xfdd7e8 size 0x20 virtual true final false
 int32_t GetHashCode() ;
