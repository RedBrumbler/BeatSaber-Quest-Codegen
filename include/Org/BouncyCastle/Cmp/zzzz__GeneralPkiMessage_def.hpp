...
/// @brief Method ParseBytes addr 0x1158c2c size 0x18 virtual false final false
...
/// @brief Method .ctor addr 0x1158c44 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x1158c6c size 0x40 virtual false final false
 void _ctor(::ArrayW<uint8_t> encoding) ;

/// @brief Method get_Header addr 0x1158cac size 0x20 virtual false final false
 Org::BouncyCastle::Asn1::Cmp::PkiHeader get_Header() ;

/// @brief Method get_Body addr 0x1158ccc size 0x20 virtual false final false
 Org::BouncyCastle::Asn1::Cmp::PkiBody get_Body() ;

/// @brief Method get_HasProtection addr 0x1158cec size 0x2c virtual false final false
 bool get_HasProtection() ;

/// @brief Method ToAsn1Structure addr 0x1158d18 size 0x8 virtual false final false
