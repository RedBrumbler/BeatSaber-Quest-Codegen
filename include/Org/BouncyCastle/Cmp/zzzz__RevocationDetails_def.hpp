...
/// @brief Method .ctor addr 0x115aab8 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Cmp::RevDetails revDetails) ;

/// @brief Method get_Subject addr 0x115aae0 size 0x30 virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Name get_Subject() ;

/// @brief Method get_Issuer addr 0x115ab10 size 0x30 virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Name get_Issuer() ;

/// @brief Method get_SerialNumber addr 0x115ab40 size 0x3c virtual false final false
 Org::BouncyCastle::Math::BigInteger get_SerialNumber() ;

/// @brief Method ToASN1Structure addr 0x115ab7c size 0x8 virtual false final false
