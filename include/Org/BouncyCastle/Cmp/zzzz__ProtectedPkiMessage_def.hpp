...
/// @brief Method .ctor addr 0x1158d20 size 0x98 virtual false final false
...
/// @brief Method .ctor addr 0x1158db8 size 0xa0 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Cmp::PkiMessage pkiMessage) ;

/// @brief Method get_Header addr 0x1158e58 size 0x20 virtual false final false
 Org::BouncyCastle::Asn1::Cmp::PkiHeader get_Header() ;

/// @brief Method get_Body addr 0x1158e78 size 0x20 virtual false final false
 Org::BouncyCastle::Asn1::Cmp::PkiBody get_Body() ;

/// @brief Method ToAsn1Message addr 0x1158e98 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::Cmp::PkiMessage ToAsn1Message() ;

/// @brief Method get_HasPasswordBasedMacProtected addr 0x1158ea0 size 0xa8 virtual false final false
 bool get_HasPasswordBasedMacProtected() ;

/// @brief Method GetCertificates addr 0x1158f48 size 0x168 virtual false final false
 ::ArrayW<Org::BouncyCastle::X509::X509Certificate> GetCertificates() ;

/// @brief Method Verify addr 0x11590b0 size 0x180 virtual false final false
 bool Verify(Org::BouncyCastle::Crypto::IVerifierFactory verifierFactory) ;

/// @brief Method Process addr 0x1159230 size 0x2d8 virtual false final false
 ::bs_hook::Il2CppWrapperType Process(Org::BouncyCastle::Crypto::IStreamCalculator streamCalculator) ;

/// @brief Method Verify addr 0x1159508 size 0x2e8 virtual false final false
