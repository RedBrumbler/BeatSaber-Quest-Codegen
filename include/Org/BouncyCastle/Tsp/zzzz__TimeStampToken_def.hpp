...
/// @brief Method .ctor addr 0x10d4774 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x10d479c size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Ess::EssCertIDv2 certID) ;

/// @brief Method GetHashAlgorithmName addr 0x10d4ecc size 0xf8 virtual false final false
 ::StringW GetHashAlgorithmName() ;

/// @brief Method GetHashAlgorithm addr 0x10d5414 size 0xac virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier GetHashAlgorithm() ;

/// @brief Method GetCertHash addr 0x10d4fc4 size 0x34 virtual false final false
 ::ArrayW<uint8_t> GetCertHash() ;

/// @brief Method get_IssuerSerial addr 0x10d4ff8 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x10d23ec size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x10d3db0 size 0x890 virtual false final false
 void _ctor(Org::BouncyCastle::Cms::CmsSignedData signedData) ;

/// @brief Method get_TimeStampInfo addr 0x10d47c4 size 0x8 virtual false final false
 Org::BouncyCastle::Tsp::TimeStampTokenInfo get_TimeStampInfo() ;

/// @brief Method get_SignerID addr 0x10d47cc size 0x1c virtual false final false
 Org::BouncyCastle::Cms::SignerID get_SignerID() ;

/// @brief Method get_SignedAttributes addr 0x10d2c74 size 0x1c virtual false final false
 Org::BouncyCastle::Asn1::Cms::AttributeTable get_SignedAttributes() ;

/// @brief Method get_UnsignedAttributes addr 0x10d47e8 size 0x1c virtual false final false
 Org::BouncyCastle::Asn1::Cms::AttributeTable get_UnsignedAttributes() ;

/// @brief Method GetCertificates addr 0x10d4804 size 0x1c virtual false final false
 Org::BouncyCastle::X509::Store::IX509Store GetCertificates(::StringW type) ;

/// @brief Method GetCrls addr 0x10d4820 size 0x1c virtual false final false
 Org::BouncyCastle::X509::Store::IX509Store GetCrls(::StringW type) ;

/// @brief Method GetAttributeCertificates addr 0x10d483c size 0x1c virtual false final false
 Org::BouncyCastle::X509::Store::IX509Store GetAttributeCertificates(::StringW type) ;

/// @brief Method Validate addr 0x10d4858 size 0x674 virtual false final false
 void Validate(Org::BouncyCastle::X509::X509Certificate cert) ;

/// @brief Method ToCmsSignedData addr 0x10d539c size 0x8 virtual false final false
 Org::BouncyCastle::Cms::CmsSignedData ToCmsSignedData() ;

/// @brief Method GetEncoded addr 0x10d53a4 size 0x54 virtual false final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method GetEncoded addr 0x10d53f8 size 0x1c virtual false final false
