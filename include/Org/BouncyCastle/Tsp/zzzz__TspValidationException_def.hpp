...
/// @brief Method .ctor addr 0x10d2bf8 size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0x10d177c size 0x24 virtual false final false
 void _ctor(::StringW message, int32_t failureCode) ;

/// @brief Method get_FailureCode addr 0x10d8a6c size 0x8 virtual false final false
