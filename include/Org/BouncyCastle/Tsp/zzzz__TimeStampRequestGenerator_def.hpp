...
/// @brief Method SetReqPolicy addr 0x10d1b04 size 0x70 virtual false final false
 void SetReqPolicy(::StringW reqPolicy) ;

/// @brief Method SetCertReq addr 0x10d1b74 size 0x6c virtual false final false
 void SetCertReq(bool certReq) ;

/// @brief Method AddExtension addr 0x10d1be0 size 0x44 virtual false final false
 void AddExtension(::StringW oid, bool critical, Org::BouncyCastle::Asn1::Asn1Encodable value) ;

/// @brief Method AddExtension addr 0x10d1c24 size 0x1d8 virtual false final false
 void AddExtension(::StringW oid, bool critical, ::ArrayW<uint8_t> value) ;

/// @brief Method AddExtension addr 0x10d1dfc size 0x4c virtual true final false
...
/// @brief Method AddExtension addr 0x10d1e48 size 0x1a8 virtual true final false
 void AddExtension(Org::BouncyCastle::Asn1::DerObjectIdentifier oid, bool critical, ::ArrayW<uint8_t> extValue) ;

/// @brief Method Generate addr 0x10d1ff0 size 0x8 virtual false final false
 Org::BouncyCastle::Tsp::TimeStampRequest Generate(::StringW digestAlgorithm, ::ArrayW<uint8_t> digest) ;

/// @brief Method Generate addr 0x10d1ff8 size 0x2d0 virtual false final false
...
/// @brief Method Generate addr 0x10d22c8 size 0x1c virtual true final false
...
/// @brief Method Generate addr 0x10d22e4 size 0x18 virtual true final false
...
/// @brief Method .ctor addr 0x10d22fc size 0x70 virtual false final false
 void _ctor() ;
