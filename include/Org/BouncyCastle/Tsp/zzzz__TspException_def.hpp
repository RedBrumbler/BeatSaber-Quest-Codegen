...
/// @brief Method .ctor addr 0x10d6160 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit TspException(::StringW message) ;

/// @brief Method .ctor addr 0x10d5950 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x10d2674 size 0x70 virtual false final false
