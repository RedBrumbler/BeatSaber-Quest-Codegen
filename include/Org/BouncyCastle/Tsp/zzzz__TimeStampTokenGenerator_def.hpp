...
/// @brief Method .ctor addr 0x10d54c0 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x10d54cc size 0x448 virtual false final false
...
/// @brief Method SetCertificates addr 0x10d5914 size 0x8 virtual false final false
 void SetCertificates(Org::BouncyCastle::X509::Store::IX509Store certificates) ;

/// @brief Method SetCrls addr 0x10d591c size 0x8 virtual false final false
 void SetCrls(Org::BouncyCastle::X509::Store::IX509Store crls) ;

/// @brief Method SetAccuracySeconds addr 0x10d5924 size 0x8 virtual false final false
 void SetAccuracySeconds(int32_t accuracySeconds) ;

/// @brief Method SetAccuracyMillis addr 0x10d592c size 0x8 virtual false final false
 void SetAccuracyMillis(int32_t accuracyMillis) ;

/// @brief Method SetAccuracyMicros addr 0x10d5934 size 0x8 virtual false final false
 void SetAccuracyMicros(int32_t accuracyMicros) ;

/// @brief Method SetOrdering addr 0x10d593c size 0xc virtual false final false
 void SetOrdering(bool ordering) ;

/// @brief Method SetTsa addr 0x10d5948 size 0x8 virtual false final false
 void SetTsa(Org::BouncyCastle::Asn1::X509::GeneralName tsa) ;

/// @brief Method Generate addr 0x10d356c size 0x6a8 virtual false final false
