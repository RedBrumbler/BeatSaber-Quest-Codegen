...
/// @brief Method .ctor addr 0x10d0b78 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Tsp::Accuracy accuracy) ;

/// @brief Method get_Seconds addr 0x10d0ba0 size 0x2c virtual false final false
 int32_t get_Seconds() ;

/// @brief Method get_Millis addr 0x10d0be4 size 0x2c virtual false final false
 int32_t get_Millis() ;

/// @brief Method get_Micros addr 0x10d0c10 size 0x2c virtual false final false
 int32_t get_Micros() ;

/// @brief Method GetTimeComponent addr 0x10d0bcc size 0x18 virtual false final false
 int32_t GetTimeComponent(Org::BouncyCastle::Asn1::DerInteger time) ;

/// @brief Method ToString addr 0x10d0c3c size 0x1bc virtual true final false
 ::StringW ToString() ;
