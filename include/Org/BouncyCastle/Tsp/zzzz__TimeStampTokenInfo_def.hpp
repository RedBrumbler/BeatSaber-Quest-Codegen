...
/// @brief Method .ctor addr 0x10d4640 size 0x134 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Tsp::TstInfo tstInfo) ;

/// @brief Method get_IsOrdered addr 0x10d59b8 size 0x24 virtual false final false
 bool get_IsOrdered() ;

/// @brief Method get_Accuracy addr 0x10d59dc size 0x1c virtual false final false
 Org::BouncyCastle::Asn1::Tsp::Accuracy get_Accuracy() ;

/// @brief Method get_GenTime addr 0x10d59f8 size 0x8 virtual false final false
 System::DateTime get_GenTime() ;

/// @brief Method get_GenTimeAccuracy addr 0x10d5a00 size 0x7c virtual false final false
 Org::BouncyCastle::Tsp::GenTimeAccuracy get_GenTimeAccuracy() ;

/// @brief Method get_Policy addr 0x10d2c90 size 0x24 virtual false final false
 ::StringW get_Policy() ;

/// @brief Method get_SerialNumber addr 0x10d5a7c size 0x24 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_SerialNumber() ;

/// @brief Method get_Tsa addr 0x10d5aa0 size 0x1c virtual false final false
 Org::BouncyCastle::Asn1::X509::GeneralName get_Tsa() ;

/// @brief Method get_Nonce addr 0x10d2bcc size 0x2c virtual false final false
 Org::BouncyCastle::Math::BigInteger get_Nonce() ;

/// @brief Method get_HashAlgorithm addr 0x10d5abc size 0x24 virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_HashAlgorithm() ;

/// @brief Method get_MessageImprintAlgOid addr 0x10d2c38 size 0x3c virtual false final false
 ::StringW get_MessageImprintAlgOid() ;

/// @brief Method GetMessageImprintDigest addr 0x10d2c14 size 0x24 virtual false final false
 ::ArrayW<uint8_t> GetMessageImprintDigest() ;

/// @brief Method GetEncoded addr 0x10d5ae0 size 0x1c virtual false final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method get_TstInfo addr 0x10d5afc size 0x8 virtual false final false
