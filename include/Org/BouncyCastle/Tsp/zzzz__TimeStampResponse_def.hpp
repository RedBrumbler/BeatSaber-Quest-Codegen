...
/// @brief Method .ctor addr 0x10d236c size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x10d2460 size 0x7c virtual false final false
...
/// @brief Method .ctor addr 0x10d25f8 size 0x7c virtual false final false
 void _ctor(System::IO::Stream input) ;

/// @brief Method readTimeStampResp addr 0x10d24dc size 0x11c virtual false final false
static Org::BouncyCastle::Asn1::Tsp::TimeStampResp readTimeStampResp(Org::BouncyCastle::Asn1::Asn1InputStream input) ;

/// @brief Method get_Status addr 0x10d26e4 size 0x30 virtual false final false
 int32_t get_Status() ;

/// @brief Method GetStatusString addr 0x10d2714 size 0x100 virtual false final false
 ::StringW GetStatusString() ;

/// @brief Method GetFailInfo addr 0x10d2814 size 0x84 virtual false final false
 Org::BouncyCastle::Asn1::Cmp::PkiFailureInfo GetFailInfo() ;

/// @brief Method get_TimeStampToken addr 0x10d2898 size 0x8 virtual false final false
 Org::BouncyCastle::Tsp::TimeStampToken get_TimeStampToken() ;

/// @brief Method Validate addr 0x10d28a0 size 0x32c virtual false final false
 void Validate(Org::BouncyCastle::Tsp::TimeStampRequest request) ;

/// @brief Method GetEncoded addr 0x10d2cb4 size 0x1c virtual false final false
