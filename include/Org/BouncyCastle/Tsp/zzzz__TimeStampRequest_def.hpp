...
/// @brief Method .ctor addr 0x10d0df8 size 0x38 virtual false final false
...
/// @brief Method .ctor addr 0x10d0e30 size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x10d0fd8 size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x10d0ea4 size 0x134 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1InputStream str) ;

/// @brief Method get_Version addr 0x10d104c size 0x24 virtual false final false
 int32_t get_Version() ;

/// @brief Method get_MessageImprintAlgOid addr 0x10d1070 size 0x3c virtual false final false
 ::StringW get_MessageImprintAlgOid() ;

/// @brief Method GetMessageImprintDigest addr 0x10d10ac size 0x24 virtual false final false
 ::ArrayW<uint8_t> GetMessageImprintDigest() ;

/// @brief Method get_ReqPolicy addr 0x10d10d0 size 0x2c virtual false final false
 ::StringW get_ReqPolicy() ;

/// @brief Method get_Nonce addr 0x10d10fc size 0x2c virtual false final false
 Org::BouncyCastle::Math::BigInteger get_Nonce() ;

/// @brief Method get_CertReq addr 0x10d1128 size 0x2c virtual false final false
 bool get_CertReq() ;

/// @brief Method Validate addr 0x10d1154 size 0x628 virtual false final false
 void Validate(System::Collections::IList algorithms, System::Collections::IList policies, System::Collections::IList extensions) ;

/// @brief Method GetEncoded addr 0x10d19a0 size 0x1c virtual false final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method get_Extensions addr 0x10d17a0 size 0x1c virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Extensions get_Extensions() ;

/// @brief Method get_HasExtensions addr 0x10d19bc size 0x10 virtual true final false
 bool get_HasExtensions() ;

/// @brief Method GetExtension addr 0x10d19cc size 0x14 virtual true final false
 Org::BouncyCastle::Asn1::X509::X509Extension GetExtension(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetExtensionOids addr 0x10d19e0 size 0x58 virtual true final false
 System::Collections::IList GetExtensionOids() ;

/// @brief Method GetX509Extensions addr 0x10d1ae8 size 0x1c virtual true final false
