...
/// @brief Method GetSignatureTimestamps addr 0x10d7a7c size 0x9c8 virtual false final false
static System::Collections::ICollection GetSignatureTimestamps(Org::BouncyCastle::Cms::SignerInformation signerInfo) ;

/// @brief Method ValidateCertificate addr 0x10d5028 size 0x374 virtual false final false
static void ValidateCertificate(Org::BouncyCastle::X509::X509Certificate cert) ;

/// @brief Method GetDigestAlgName addr 0x10d8444 size 0x108 virtual false final false
static ::StringW GetDigestAlgName(::StringW digestAlgOID) ;

/// @brief Method GetDigestLength addr 0x10d17bc size 0x1e4 virtual false final false
static int32_t GetDigestLength(::StringW digestAlgOID) ;

/// @brief Method CreateDigestInstance addr 0x10d854c size 0x8c virtual false final false
static Org::BouncyCastle::Crypto::IDigest CreateDigestInstance(::StringW digestAlgOID) ;

/// @brief Method GetCriticalExtensionOids addr 0x10d85d8 size 0xb4 virtual false final false
...
/// @brief Method GetNonCriticalExtensionOids addr 0x10d89b0 size 0xb4 virtual false final false
...
/// @brief Method GetExtensionOids addr 0x10d1a38 size 0xb0 virtual false final false
static System::Collections::IList GetExtensionOids(Org::BouncyCastle::Asn1::X509::X509Extensions extensions) ;

// Ctor Parameters []
explicit TspUtil() ;

/// @brief Method .ctor addr 0x10d8a64 size 0x8 virtual false final false
 void _ctor() ;
