...
/// @brief Method .ctor addr 0x10681b0 size 0x44 virtual false final false
...
/// @brief Method .ctor addr 0x10681f4 size 0x28 virtual false final false
 void _ctor(::ArrayW<uint8_t> id) ;

/// @brief Method get_Id addr 0x106821c size 0x8 virtual false final false
 ::ArrayW<uint8_t> get_Id() ;

/// @brief Method GetHashCode addr 0x1068224 size 0x5c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x1068280 size 0xd8 virtual true final false
...
/// @brief Method Clear addr 0x1068358 size 0x108 virtual false final false
 void Clear() ;

/// @brief Method GetEnumerator addr 0x1068460 size 0xa4 virtual true final true
 System::Collections::IEnumerator GetEnumerator() ;

/// @brief Method get_Keys addr 0x1068504 size 0xa4 virtual false final false
 System::Collections::ICollection get_Keys() ;

/// @brief Method Remove addr 0x10685a8 size 0x260 virtual false final false
 ::bs_hook::Il2CppWrapperType Remove(::StringW alias) ;

/// @brief Method get_Item addr 0x1068808 size 0x18c virtual false final false
 ::bs_hook::Il2CppWrapperType get_Item(::StringW alias) ;

/// @brief Method set_Item addr 0x1068994 size 0x264 virtual false final false
 void set_Item(::StringW alias, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_Values addr 0x1068bf8 size 0xa4 virtual false final false
 System::Collections::ICollection get_Values() ;

/// @brief Method get_Count addr 0x1068c9c size 0xa4 virtual false final false
 int32_t get_Count() ;

// Ctor Parameters []
explicit Org__BouncyCastle__Pkcs__Pkcs12Store__IgnoresCaseHashtable() ;

/// @brief Method .ctor addr 0x1068d40 size 0x70 virtual false final false
 void _ctor() ;
...
/// @brief Method CreateSubjectKeyID addr 0x105e1e4 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x105e25c size 0x100 virtual false final false
...
/// @brief Method .ctor addr 0x105e35c size 0x110 virtual false final false
...
/// @brief Method .ctor addr 0x105e46c size 0x68 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x105e4d4 size 0x30 virtual false final false
 void _ctor(System::IO::Stream input, ::ArrayW<char16_t> password) ;

/// @brief Method LoadKeyBag addr 0x105ff70 size 0x8f0 virtual true final false
 void LoadKeyBag(Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo privKeyInfo, Org::BouncyCastle::Asn1::Asn1Set bagAttributes) ;

/// @brief Method LoadPkcs8ShroudedKeyBag addr 0x1060860 size 0x4c virtual true final false
...
/// @brief Method Load addr 0x105e504 size 0x1a6c virtual false final false
 void Load(System::IO::Stream input, ::ArrayW<char16_t> password) ;

/// @brief Method GetKey addr 0x1060c84 size 0xe0 virtual false final false
 Org::BouncyCastle::Pkcs::AsymmetricKeyEntry GetKey(::StringW alias) ;

/// @brief Method IsCertificateEntry addr 0x1060d64 size 0xa0 virtual false final false
 bool IsCertificateEntry(::StringW alias) ;

/// @brief Method IsKeyEntry addr 0x1060e04 size 0x78 virtual false final false
 bool IsKeyEntry(::StringW alias) ;

/// @brief Method GetAliasesTable addr 0x1060e7c size 0x78c virtual false final false
 System::Collections::IDictionary GetAliasesTable() ;

/// @brief Method get_Aliases addr 0x1061608 size 0xec virtual false final false
 System::Collections::IEnumerable get_Aliases() ;

/// @brief Method ContainsAlias addr 0x10616f4 size 0x58 virtual false final false
 bool ContainsAlias(::StringW alias) ;

/// @brief Method GetCertificate addr 0x106174c size 0x250 virtual false final false
 Org::BouncyCastle::Pkcs::X509CertificateEntry GetCertificate(::StringW alias) ;

/// @brief Method GetCertificateAlias addr 0x106199c size 0x76c virtual false final false
 ::StringW GetCertificateAlias(Org::BouncyCastle::X509::X509Certificate cert) ;

/// @brief Method GetCertificateChain addr 0x1062108 size 0xabc virtual false final false
 ::ArrayW<Org::BouncyCastle::Pkcs::X509CertificateEntry> GetCertificateChain(::StringW alias) ;

/// @brief Method SetCertificateEntry addr 0x1062bc4 size 0x228 virtual false final false
 void SetCertificateEntry(::StringW alias, Org::BouncyCastle::Pkcs::X509CertificateEntry certEntry) ;

/// @brief Method SetKeyEntry addr 0x1062dec size 0x28c virtual false final false
...
/// @brief Method DeleteEntry addr 0x1063078 size 0x574 virtual false final false
 void DeleteEntry(::StringW alias) ;

/// @brief Method IsEntryOfType addr 0x10635ec size 0x118 virtual false final false
 bool IsEntryOfType(::StringW alias, System::Type entryType) ;

/// @brief Method Size addr 0x1063704 size 0x4 virtual false final false
 int32_t Size() ;

/// @brief Method get_Count addr 0x1063708 size 0xac virtual false final false
 int32_t get_Count() ;

/// @brief Method Save addr 0x10637b4 size 0x49fc virtual false final false
 void Save(System::IO::Stream stream, ::ArrayW<char16_t> password, Org::BouncyCastle::Security::SecureRandom random) ;

/// @brief Method CalculatePbeMac addr 0x10608ac size 0x184 virtual false final false
...
/// @brief Method CryptPbeData addr 0x1060a30 size 0x254 virtual false final false
