...
/// @brief Method .ctor addr 0x1068db0 size 0x78 virtual false final false
 void _ctor() ;

/// @brief Method Build addr 0x1068e28 size 0x94 virtual false final false
 Org::BouncyCastle::Pkcs::Pkcs12Store Build() ;

/// @brief Method SetCertAlgorithm addr 0x1068ebc size 0x8 virtual false final false
 Org::BouncyCastle::Pkcs::Pkcs12StoreBuilder SetCertAlgorithm(Org::BouncyCastle::Asn1::DerObjectIdentifier certAlgorithm) ;

/// @brief Method SetKeyAlgorithm addr 0x1068ec4 size 0x8 virtual false final false
 Org::BouncyCastle::Pkcs::Pkcs12StoreBuilder SetKeyAlgorithm(Org::BouncyCastle::Asn1::DerObjectIdentifier keyAlgorithm) ;

/// @brief Method SetKeyAlgorithm addr 0x1068ecc size 0xc virtual false final false
...
/// @brief Method SetUseDerEncoding addr 0x1068ed8 size 0xc virtual false final false
