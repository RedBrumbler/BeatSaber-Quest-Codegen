...
/// @brief Method parseBytes addr 0x10693f4 size 0x120 virtual false final false
...
/// @brief Method .ctor addr 0x106951c size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x1069544 size 0x34 virtual false final false
 void _ctor(::ArrayW<uint8_t> encryptedPrivateKeyInfo) ;

/// @brief Method ToAsn1Structure addr 0x1069578 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::Pkcs::EncryptedPrivateKeyInfo ToAsn1Structure() ;

/// @brief Method GetEncryptedData addr 0x1069580 size 0x1c virtual false final false
 ::ArrayW<uint8_t> GetEncryptedData() ;

/// @brief Method GetEncoded addr 0x106959c size 0x1c virtual false final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method DecryptPrivateKeyInfo addr 0x10695b8 size 0x3c4 virtual false final false
