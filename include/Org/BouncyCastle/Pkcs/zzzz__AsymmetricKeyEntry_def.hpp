...
/// @brief Method .ctor addr 0x1058b14 size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x1058b88 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x1058bb0 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Crypto::AsymmetricKeyParameter key, System::Collections::IDictionary attributes) ;

/// @brief Method get_Key addr 0x1058bd8 size 0x8 virtual false final false
 Org::BouncyCastle::Crypto::AsymmetricKeyParameter get_Key() ;

/// @brief Method Equals addr 0x1058be0 size 0xa4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x1058c84 size 0x28 virtual true final false
 int32_t GetHashCode() ;
