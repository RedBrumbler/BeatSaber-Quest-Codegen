...
/// @brief Method .ctor addr 0x10699ec size 0x38 virtual false final false
...
/// @brief Method .ctor addr 0x1069a24 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo privateKeyInfo) ;

/// @brief Method Build addr 0x1069a4c size 0x400 virtual false final false
