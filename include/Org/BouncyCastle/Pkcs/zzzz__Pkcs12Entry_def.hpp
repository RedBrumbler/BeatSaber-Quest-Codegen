...
/// @brief Method .ctor addr 0x1057fec size 0x54c virtual false final false
 void _ctor(System::Collections::IDictionary attributes) ;

/// @brief Method GetBagAttribute addr 0x1058538 size 0xfc virtual false final false
 Org::BouncyCastle::Asn1::Asn1Encodable GetBagAttribute(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetBagAttribute addr 0x1058634 size 0xf4 virtual false final false
 Org::BouncyCastle::Asn1::Asn1Encodable GetBagAttribute(::StringW oid) ;

/// @brief Method GetBagAttributeKeys addr 0x1058728 size 0x118 virtual false final false
 System::Collections::IEnumerator GetBagAttributeKeys() ;

/// @brief Method get_Item addr 0x1058840 size 0xfc virtual false final false
 Org::BouncyCastle::Asn1::Asn1Encodable get_Item(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method get_Item addr 0x105893c size 0xf4 virtual false final false
 Org::BouncyCastle::Asn1::Asn1Encodable get_Item(::StringW oid) ;

/// @brief Method get_BagAttributeKeys addr 0x1058a30 size 0xe4 virtual false final false
