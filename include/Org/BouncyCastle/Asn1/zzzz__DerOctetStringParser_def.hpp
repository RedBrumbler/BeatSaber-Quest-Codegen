...
/// @brief Method .ctor addr 0x113d00c size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::DefiniteLengthInputStream stream) ;

/// @brief Method GetOctetStream addr 0x1146328 size 0x8 virtual true final true
 System::IO::Stream GetOctetStream() ;

/// @brief Method ToAsn1Object addr 0x1146330 size 0x16c virtual true final true
