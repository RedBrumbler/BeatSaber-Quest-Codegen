...
/// @brief Method AllowUnsafe addr 0xe0b7c8 size 0xb0 virtual false final false
static bool AllowUnsafe() ;

/// @brief Method GetInstance addr 0xe05280 size 0xf0 virtual false final false
static Org::BouncyCastle::Asn1::DerInteger GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetInstance addr 0xe07eb0 size 0x124 virtual false final false
...
/// @brief Method .ctor addr 0xe041d4 size 0x8c virtual false final false
...
/// @brief Method .ctor addr 0xe0b880 size 0x8c virtual false final false
...
/// @brief Method .ctor addr 0xe0b90c size 0x88 virtual false final false
...
/// @brief Method .ctor addr 0xe0b878 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xe0b994 size 0x104 virtual false final false
 void _ctor(::ArrayW<uint8_t> bytes, bool clone) ;

/// @brief Method get_PositiveValue addr 0xe0bb78 size 0x6c virtual false final false
 Org::BouncyCastle::Math::BigInteger get_PositiveValue() ;

/// @brief Method get_Value addr 0xe0bbe4 size 0x68 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_Value() ;

/// @brief Method HasValue addr 0xe0bc4c size 0x74 virtual false final false
 bool HasValue(Org::BouncyCastle::Math::BigInteger x) ;

/// @brief Method get_IntPositiveValueExact addr 0xe0bd94 size 0x9c virtual false final false
 int32_t get_IntPositiveValueExact() ;

/// @brief Method get_IntValueExact addr 0xe08090 size 0x80 virtual false final false
 int32_t get_IntValueExact() ;

/// @brief Method get_LongValueExact addr 0xe0be30 size 0x80 virtual false final false
 int64_t get_LongValueExact() ;

/// @brief Method Encode addr 0xe0bf88 size 0x28 virtual true final false
 void Encode(Org::BouncyCastle::Asn1::DerOutputStream derOut) ;

/// @brief Method Asn1GetHashCode addr 0xe0bfb0 size 0x5c virtual true final false
 int32_t Asn1GetHashCode() ;

/// @brief Method Asn1Equals addr 0xe0c00c size 0xc8 virtual true final false
 bool Asn1Equals(Org::BouncyCastle::Asn1::Asn1Object asn1Object) ;

/// @brief Method ToString addr 0xe0c0d4 size 0x20 virtual true final false
 ::StringW ToString() ;

/// @brief Method IntValue addr 0xe0bcc0 size 0xd4 virtual false final false
static int32_t IntValue(::ArrayW<uint8_t> bytes, int32_t start, int32_t signExt) ;

/// @brief Method LongValue addr 0xe0beb0 size 0xd8 virtual false final false
static int64_t LongValue(::ArrayW<uint8_t> bytes, int32_t start, int32_t signExt) ;

/// @brief Method IsMalformed addr 0xe0ba98 size 0x7c virtual false final false
static bool IsMalformed(::ArrayW<uint8_t> bytes) ;

/// @brief Method SignBytesToSkip addr 0xe0bb14 size 0x64 virtual false final false
