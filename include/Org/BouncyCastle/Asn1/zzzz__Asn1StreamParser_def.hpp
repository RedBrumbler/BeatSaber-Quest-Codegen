...
/// @brief Method .ctor addr 0x11377e4 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x1138f40 size 0xf0 virtual false final false
...
/// @brief Method .ctor addr 0x113cae8 size 0x80 virtual false final false
 void _ctor(::ArrayW<uint8_t> encoding) ;

/// @brief Method ReadIndef addr 0x113cb68 size 0x18c virtual false final false
 Org::BouncyCastle::Asn1::IAsn1Convertible ReadIndef(int32_t tagValue) ;

/// @brief Method ReadImplicit addr 0x113ccf4 size 0x2c8 virtual false final false
 Org::BouncyCastle::Asn1::IAsn1Convertible ReadImplicit(bool constructed, int32_t tag) ;

/// @brief Method ReadTaggedObject addr 0x1137814 size 0x23c virtual false final false
 Org::BouncyCastle::Asn1::Asn1Object ReadTaggedObject(bool constructed, int32_t tag) ;

/// @brief Method ReadObject addr 0x113d1f0 size 0x5dc virtual true final false
 Org::BouncyCastle::Asn1::IAsn1Convertible ReadObject() ;

/// @brief Method Set00Check addr 0x113d7cc size 0x90 virtual false final false
 void Set00Check(bool enabled) ;

/// @brief Method ReadVector addr 0x113d034 size 0x128 virtual false final false
