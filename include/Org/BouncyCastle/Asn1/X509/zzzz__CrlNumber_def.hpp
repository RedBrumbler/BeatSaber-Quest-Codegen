...
/// @brief Method .ctor addr 0x110dc1c size 0x8 virtual false final false
 void _ctor(Org::BouncyCastle::Math::BigInteger number) ;

/// @brief Method get_Number addr 0x110dc24 size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_Number() ;

/// @brief Method ToString addr 0x110dc2c size 0x5c virtual true final false
 ::StringW ToString() ;
