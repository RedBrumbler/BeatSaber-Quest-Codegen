...
/// @brief Method .ctor addr 0x111f798 size 0xa0 virtual false final false
 void _ctor() ;

/// @brief Method SetSerialNumber addr 0x111f838 size 0x8 virtual false final false
 void SetSerialNumber(Org::BouncyCastle::Asn1::DerInteger serialNumber) ;

/// @brief Method SetSignature addr 0x111f840 size 0x8 virtual false final false
 void SetSignature(Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier signature) ;

/// @brief Method SetIssuer addr 0x111f848 size 0x8 virtual false final false
 void SetIssuer(Org::BouncyCastle::Asn1::X509::X509Name issuer) ;

/// @brief Method SetStartDate addr 0x111f850 size 0x6c virtual false final false
 void SetStartDate(Org::BouncyCastle::Asn1::DerUtcTime startDate) ;

/// @brief Method SetStartDate addr 0x111f8bc size 0x8 virtual false final false
 void SetStartDate(Org::BouncyCastle::Asn1::X509::Time startDate) ;

/// @brief Method SetEndDate addr 0x111f8c4 size 0x6c virtual false final false
 void SetEndDate(Org::BouncyCastle::Asn1::DerUtcTime endDate) ;

/// @brief Method SetEndDate addr 0x111f930 size 0x8 virtual false final false
 void SetEndDate(Org::BouncyCastle::Asn1::X509::Time endDate) ;

/// @brief Method SetSubject addr 0x111f938 size 0x8 virtual false final false
 void SetSubject(Org::BouncyCastle::Asn1::X509::X509Name subject) ;

/// @brief Method SetIssuerUniqueID addr 0x111f940 size 0x8 virtual false final false
 void SetIssuerUniqueID(Org::BouncyCastle::Asn1::DerBitString uniqueID) ;

/// @brief Method SetSubjectUniqueID addr 0x111f948 size 0x8 virtual false final false
 void SetSubjectUniqueID(Org::BouncyCastle::Asn1::DerBitString uniqueID) ;

/// @brief Method SetSubjectPublicKeyInfo addr 0x111f950 size 0x8 virtual false final false
 void SetSubjectPublicKeyInfo(Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo pubKeyInfo) ;

/// @brief Method SetExtensions addr 0x111f958 size 0x84 virtual false final false
 void SetExtensions(Org::BouncyCastle::Asn1::X509::X509Extensions extensions) ;

/// @brief Method GenerateTbsCertificate addr 0x111fad0 size 0x3ec virtual false final false
