...
/// @brief Method .ctor addr 0x111e368 size 0x6c virtual false final false
 void _ctor() ;

/// @brief Method SetSignature addr 0x111e3d4 size 0x8 virtual false final false
 void SetSignature(Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier signature) ;

/// @brief Method SetIssuer addr 0x111e3dc size 0x8 virtual false final false
 void SetIssuer(Org::BouncyCastle::Asn1::X509::X509Name issuer) ;

/// @brief Method SetThisUpdate addr 0x111e3e4 size 0x6c virtual false final false
 void SetThisUpdate(Org::BouncyCastle::Asn1::DerUtcTime thisUpdate) ;

/// @brief Method SetNextUpdate addr 0x111e450 size 0x74 virtual false final false
 void SetNextUpdate(Org::BouncyCastle::Asn1::DerUtcTime nextUpdate) ;

/// @brief Method SetThisUpdate addr 0x111e4c4 size 0x8 virtual false final false
 void SetThisUpdate(Org::BouncyCastle::Asn1::X509::Time thisUpdate) ;

/// @brief Method SetNextUpdate addr 0x111e4cc size 0x8 virtual false final false
 void SetNextUpdate(Org::BouncyCastle::Asn1::X509::Time nextUpdate) ;

/// @brief Method AddCrlEntry addr 0x111e4d4 size 0xe4 virtual false final false
 void AddCrlEntry(Org::BouncyCastle::Asn1::Asn1Sequence crlEntry) ;

/// @brief Method AddCrlEntry addr 0x111e5b8 size 0x8c virtual false final false
...
/// @brief Method AddCrlEntry addr 0x111e644 size 0x8 virtual false final false
...
/// @brief Method AddCrlEntry addr 0x111e64c size 0x5e4 virtual false final false
...
/// @brief Method AddCrlEntry addr 0x111f15c size 0x14c virtual false final false
...
/// @brief Method SetExtensions addr 0x111f2a8 size 0x8 virtual false final false
 void SetExtensions(Org::BouncyCastle::Asn1::X509::X509Extensions extensions) ;

/// @brief Method GenerateTbsCertList addr 0x111f2b0 size 0x4e8 virtual false final false
