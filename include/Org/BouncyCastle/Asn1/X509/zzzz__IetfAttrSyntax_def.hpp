...
/// @brief Method .ctor addr 0x11130a4 size 0x67c virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;

/// @brief Method get_PolicyAuthority addr 0x1113720 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::GeneralNames get_PolicyAuthority() ;

/// @brief Method get_ValueType addr 0x1113728 size 0x8 virtual false final false
 int32_t get_ValueType() ;

/// @brief Method GetValues addr 0x1113730 size 0x348 virtual false final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetValues() ;

/// @brief Method ToAsn1Object addr 0x1113a78 size 0xe0 virtual true final false
