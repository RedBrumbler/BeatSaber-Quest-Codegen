...
/// @brief Method GetInstance addr 0x1008144 size 0x18 virtual false final false
...
/// @brief Method GetInstance addr 0x100815c size 0xf0 virtual false final false
static Org::BouncyCastle::Asn1::X509::BasicConstraints GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method FromExtensions addr 0x1008408 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x100824c size 0x1bc virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;

// Ctor Parameters [CppParam { name: "cA", ty: "bool", modifiers: "", def_value: None }]
explicit BasicConstraints(bool cA) ;

/// @brief Method .ctor addr 0x1008470 size 0x74 virtual false final false
 void _ctor(bool cA) ;
...
/// @brief Method .ctor addr 0x10084e4 size 0xb0 virtual false final false
 void _ctor(int32_t pathLenConstraint) ;

/// @brief Method IsCA addr 0x1008594 size 0x14 virtual false final false
 bool IsCA() ;

/// @brief Method get_PathLenConstraint addr 0x10085a8 size 0x14 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_PathLenConstraint() ;

/// @brief Method ToAsn1Object addr 0x10085bc size 0x138 virtual true final false
 Org::BouncyCastle::Asn1::Asn1Object ToAsn1Object() ;

/// @brief Method ToString addr 0x10086f4 size 0x204 virtual true final false
 ::StringW ToString() ;
