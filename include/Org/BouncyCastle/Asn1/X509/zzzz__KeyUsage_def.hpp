...
/// @brief Method GetInstance addr 0x1114ed8 size 0x114 virtual false final false
static Org::BouncyCastle::Asn1::X509::KeyUsage GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method FromExtensions addr 0x1115080 size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x11150f4 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x1114fec size 0x94 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::DerBitString usage) ;

/// @brief Method ToString addr 0x111515c size 0xc0 virtual true final false
 ::StringW ToString() ;
