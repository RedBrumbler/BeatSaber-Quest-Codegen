...
/// @brief Method GetInstance addr 0xff5c20 size 0x188 virtual false final false
...
/// @brief Method .ctor addr 0xff5da8 size 0x15c virtual false final false
...
/// @brief Method .ctor addr 0xff60dc size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::DerObjectIdentifier attrType, Org::BouncyCastle::Asn1::Asn1Set attrValues) ;

/// @brief Method get_AttrType addr 0xff6108 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_AttrType() ;

/// @brief Method GetAttributeValues addr 0xff6110 size 0x24 virtual false final false
 ::ArrayW<Org::BouncyCastle::Asn1::Asn1Encodable> GetAttributeValues() ;

/// @brief Method get_AttrValues addr 0xff6134 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::Asn1Set get_AttrValues() ;

/// @brief Method ToAsn1Object addr 0xff613c size 0xf0 virtual true final false
