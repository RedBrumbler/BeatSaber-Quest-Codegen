...
/// @brief Method .ctor addr 0x111d9a4 size 0xa0 virtual false final false
 void _ctor() ;

/// @brief Method SetHolder addr 0x111da44 size 0x8 virtual false final false
 void SetHolder(Org::BouncyCastle::Asn1::X509::Holder holder) ;

/// @brief Method AddAttribute addr 0x111da4c size 0xe8 virtual false final false
 void AddAttribute(::StringW oid, Org::BouncyCastle::Asn1::Asn1Encodable value) ;

/// @brief Method AddAttribute addr 0x111db34 size 0x1c virtual false final false
 void AddAttribute(Org::BouncyCastle::Asn1::X509::AttributeX509 attribute) ;

/// @brief Method SetSerialNumber addr 0x111db50 size 0x8 virtual false final false
 void SetSerialNumber(Org::BouncyCastle::Asn1::DerInteger serialNumber) ;

/// @brief Method SetSignature addr 0x111db58 size 0x8 virtual false final false
 void SetSignature(Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier signature) ;

/// @brief Method SetIssuer addr 0x111db60 size 0x8 virtual false final false
 void SetIssuer(Org::BouncyCastle::Asn1::X509::AttCertIssuer issuer) ;

/// @brief Method SetStartDate addr 0x111db68 size 0x8 virtual false final false
 void SetStartDate(Org::BouncyCastle::Asn1::DerGeneralizedTime startDate) ;

/// @brief Method SetEndDate addr 0x111db70 size 0x8 virtual false final false
 void SetEndDate(Org::BouncyCastle::Asn1::DerGeneralizedTime endDate) ;

/// @brief Method SetIssuerUniqueID addr 0x111db78 size 0x8 virtual false final false
 void SetIssuerUniqueID(Org::BouncyCastle::Asn1::DerBitString issuerUniqueID) ;

/// @brief Method SetExtensions addr 0x111db80 size 0x8 virtual false final false
 void SetExtensions(Org::BouncyCastle::Asn1::X509::X509Extensions extensions) ;

/// @brief Method GenerateAttributeCertificateInfo addr 0x111db88 size 0x2dc virtual false final false
