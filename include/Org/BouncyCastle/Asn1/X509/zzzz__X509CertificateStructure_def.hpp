...
/// @brief Method GetInstance addr 0x111ff54 size 0x18 virtual false final false
...
/// @brief Method GetInstance addr 0x111ff6c size 0xa4 virtual false final false
...
/// @brief Method .ctor addr 0x112015c size 0xdc virtual false final false
...
/// @brief Method .ctor addr 0x1120010 size 0x14c virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;

/// @brief Method get_TbsCertificate addr 0x1120238 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::TbsCertificateStructure get_TbsCertificate() ;

/// @brief Method get_Version addr 0x1120240 size 0x18 virtual false final false
 int32_t get_Version() ;

/// @brief Method get_SerialNumber addr 0x1120258 size 0x1c virtual false final false
 Org::BouncyCastle::Asn1::DerInteger get_SerialNumber() ;

/// @brief Method get_Issuer addr 0x1120274 size 0x1c virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Name get_Issuer() ;

/// @brief Method get_StartDate addr 0x1120290 size 0x1c virtual false final false
 Org::BouncyCastle::Asn1::X509::Time get_StartDate() ;

/// @brief Method get_EndDate addr 0x11202ac size 0x1c virtual false final false
 Org::BouncyCastle::Asn1::X509::Time get_EndDate() ;

/// @brief Method get_Subject addr 0x11202c8 size 0x1c virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Name get_Subject() ;

/// @brief Method get_SubjectPublicKeyInfo addr 0x11202e4 size 0x1c virtual false final false
 Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo get_SubjectPublicKeyInfo() ;

/// @brief Method get_SignatureAlgorithm addr 0x1120300 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_SignatureAlgorithm() ;

/// @brief Method get_Signature addr 0x1120308 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerBitString get_Signature() ;

/// @brief Method GetSignatureOctets addr 0x1120310 size 0x20 virtual false final false
 ::ArrayW<uint8_t> GetSignatureOctets() ;

/// @brief Method ToAsn1Object addr 0x1120330 size 0x11c virtual true final false
