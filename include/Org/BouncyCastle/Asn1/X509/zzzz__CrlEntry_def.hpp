...
/// @brief Method .ctor addr 0x111bcb4 size 0x138 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;

/// @brief Method get_UserCertificate addr 0x111bdec size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerInteger get_UserCertificate() ;

/// @brief Method get_RevocationDate addr 0x111bdf4 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::Time get_RevocationDate() ;

/// @brief Method get_Extensions addr 0x111bdfc size 0xb0 virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Extensions get_Extensions() ;

/// @brief Method ToAsn1Object addr 0x111beac size 0x8 virtual true final false
