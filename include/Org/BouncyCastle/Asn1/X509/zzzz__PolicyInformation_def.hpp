...
/// @brief Method .ctor addr 0x1116d9c size 0x1a4 virtual false final false
...
/// @brief Method .ctor addr 0x1116f40 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x1116f68 size 0x2c virtual false final false
...
/// @brief Method GetInstance addr 0x1116f94 size 0xa4 virtual false final false
static Org::BouncyCastle::Asn1::X509::PolicyInformation GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method get_PolicyIdentifier addr 0x1117038 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_PolicyIdentifier() ;

/// @brief Method get_PolicyQualifiers addr 0x1117040 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::Asn1Sequence get_PolicyQualifiers() ;

/// @brief Method ToAsn1Object addr 0x1117048 size 0x148 virtual true final false
