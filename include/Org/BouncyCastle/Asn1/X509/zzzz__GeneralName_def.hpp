...
/// @brief Method .ctor addr 0x11109cc size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x11109fc size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x1110a2c size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x1110a5c size 0x23c virtual false final false
 void _ctor(int32_t tag, ::StringW name) ;

/// @brief Method GetInstance addr 0x1110f24 size 0x428 virtual false final false
static Org::BouncyCastle::Asn1::X509::GeneralName GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetInstance addr 0x11113c4 size 0x18 virtual false final false
static Org::BouncyCastle::Asn1::X509::GeneralName GetInstance(Org::BouncyCastle::Asn1::Asn1TaggedObject tagObj, bool explicitly) ;

/// @brief Method get_TagNo addr 0x11113dc size 0x8 virtual false final false
 int32_t get_TagNo() ;

/// @brief Method get_Name addr 0x11113e4 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::Asn1Encodable get_Name() ;

/// @brief Method ToString addr 0x11113ec size 0x12c virtual true final false
 ::StringW ToString() ;

/// @brief Method toGeneralNameEncoding addr 0x1110d10 size 0x214 virtual false final false
 ::ArrayW<uint8_t> toGeneralNameEncoding(::StringW ip) ;

/// @brief Method parseIPv4Mask addr 0x1111c34 size 0x84 virtual false final false
 void parseIPv4Mask(::StringW mask, ::ArrayW<uint8_t> addr, int32_t offset) ;

/// @brief Method parseIPv4 addr 0x1111b34 size 0x100 virtual false final false
 void parseIPv4(::StringW ip, ::ArrayW<uint8_t> addr, int32_t offset) ;

/// @brief Method parseMask addr 0x1111a7c size 0xb8 virtual false final false
 ::ArrayW<int32_t> parseMask(::StringW mask) ;

/// @brief Method copyInts addr 0x11119f0 size 0x8c virtual false final false
 void copyInts(::ArrayW<int32_t> parsedIp, ::ArrayW<uint8_t> addr, int32_t offSet) ;

/// @brief Method parseIPv6 addr 0x11115bc size 0x434 virtual false final false
 ::ArrayW<int32_t> parseIPv6(::StringW ip) ;

/// @brief Method ToAsn1Object addr 0x1111cb8 size 0x78 virtual true final false
