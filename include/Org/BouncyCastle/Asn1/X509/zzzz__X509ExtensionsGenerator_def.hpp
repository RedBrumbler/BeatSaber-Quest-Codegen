...
/// @brief Method Reset addr 0x1123cc4 size 0x68 virtual false final false
 void Reset() ;

/// @brief Method AddExtension addr 0x1123d2c size 0x114 virtual false final false
...
/// @brief Method AddExtension addr 0x1123e40 size 0x28c virtual false final false
 void AddExtension(Org::BouncyCastle::Asn1::DerObjectIdentifier oid, bool critical, ::ArrayW<uint8_t> extValue) ;

/// @brief Method get_IsEmpty addr 0x11240cc size 0xb0 virtual false final false
 bool get_IsEmpty() ;

/// @brief Method Generate addr 0x112417c size 0x68 virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Extensions Generate() ;

// Ctor Parameters []
explicit X509ExtensionsGenerator() ;

/// @brief Method .ctor addr 0x11241e4 size 0x70 virtual false final false
 void _ctor() ;
