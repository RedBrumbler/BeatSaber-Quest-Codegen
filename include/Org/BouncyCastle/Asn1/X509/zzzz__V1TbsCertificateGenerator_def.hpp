...
/// @brief Method .ctor addr 0x111d520 size 0xa0 virtual false final false
 void _ctor() ;

/// @brief Method SetSerialNumber addr 0x111d5c0 size 0x8 virtual false final false
 void SetSerialNumber(Org::BouncyCastle::Asn1::DerInteger serialNumber) ;

/// @brief Method SetSignature addr 0x111d5c8 size 0x8 virtual false final false
 void SetSignature(Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier signature) ;

/// @brief Method SetIssuer addr 0x111d5d0 size 0x8 virtual false final false
 void SetIssuer(Org::BouncyCastle::Asn1::X509::X509Name issuer) ;

/// @brief Method SetStartDate addr 0x111d5d8 size 0x8 virtual false final false
 void SetStartDate(Org::BouncyCastle::Asn1::X509::Time startDate) ;

/// @brief Method SetStartDate addr 0x111d5e0 size 0x6c virtual false final false
 void SetStartDate(Org::BouncyCastle::Asn1::DerUtcTime startDate) ;

/// @brief Method SetEndDate addr 0x111d64c size 0x8 virtual false final false
 void SetEndDate(Org::BouncyCastle::Asn1::X509::Time endDate) ;

/// @brief Method SetEndDate addr 0x111d654 size 0x6c virtual false final false
 void SetEndDate(Org::BouncyCastle::Asn1::DerUtcTime endDate) ;

/// @brief Method SetSubject addr 0x111d6c0 size 0x8 virtual false final false
 void SetSubject(Org::BouncyCastle::Asn1::X509::X509Name subject) ;

/// @brief Method SetSubjectPublicKeyInfo addr 0x111d6c8 size 0x8 virtual false final false
 void SetSubjectPublicKeyInfo(Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo pubKeyInfo) ;

/// @brief Method GenerateTbsCertificate addr 0x111d6d0 size 0x2d4 virtual false final false
