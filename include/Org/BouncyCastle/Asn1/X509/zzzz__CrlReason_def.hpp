...
/// @brief Method .ctor addr 0x110dc88 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x110dcf0 size 0x74 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::DerEnumerated reason) ;

/// @brief Method ToString addr 0x110dd64 size 0xcc virtual true final false
 ::StringW ToString() ;
