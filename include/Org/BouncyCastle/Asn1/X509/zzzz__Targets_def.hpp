...
/// @brief Method GetInstance addr 0x111ad6c size 0x18c virtual false final false
...
/// @brief Method .ctor addr 0x111b068 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x111afe4 size 0x7c virtual false final false
 void _ctor(::ArrayW<Org::BouncyCastle::Asn1::X509::Target> targets) ;

/// @brief Method GetTargets addr 0x111b090 size 0x110 virtual true final false
 ::ArrayW<Org::BouncyCastle::Asn1::X509::Target> GetTargets() ;

/// @brief Method ToAsn1Object addr 0x111b1a0 size 0x8 virtual true final false
