...
virtual ~TbsCertificateStructure() = default;

// Ctor Parameters [CppParam { name: "", ty: "TbsCertificateStructure", modifiers: " const&", def_value: None }]
constexpr TbsCertificateStructure(TbsCertificateStructure const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "TbsCertificateStructure", modifiers: "&&", def_value: None }]
constexpr TbsCertificateStructure(TbsCertificateStructure&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit TbsCertificateStructure(void* ptr) noexcept : Org::BouncyCastle::Asn1::Asn1Encodable(ptr) {
}


  constexpr TbsCertificateStructure& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr TbsCertificateStructure& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr TbsCertificateStructure& operator=(TbsCertificateStructure&& o) noexcept = default;
  constexpr TbsCertificateStructure& operator=(TbsCertificateStructure const& o) noexcept = default;
...
/// @brief Method GetInstance addr 0x111b1a8 size 0x18 virtual false final false
static Org::BouncyCastle::Asn1::X509::TbsCertificateStructure GetInstance(Org::BouncyCastle::Asn1::Asn1TaggedObject obj, bool explicitly) ;

/// @brief Method GetInstance addr 0x111b1c0 size 0xa4 virtual false final false
static Org::BouncyCastle::Asn1::X509::TbsCertificateStructure GetInstance(::bs_hook::Il2CppWrapperType obj) ;

// Ctor Parameters [CppParam { name: "seq", ty: "Org::BouncyCastle::Asn1::Asn1Sequence", modifiers: "", def_value: None }]
explicit TbsCertificateStructure(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;

/// @brief Method .ctor addr 0x111b264 size 0x620 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;

/// @brief Method get_Version addr 0x111bc30 size 0x24 virtual false final false
 int32_t get_Version() ;

/// @brief Method get_VersionNumber addr 0x111bc54 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerInteger get_VersionNumber() ;

/// @brief Method get_SerialNumber addr 0x111bc5c size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerInteger get_SerialNumber() ;

/// @brief Method get_Signature addr 0x111bc64 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_Signature() ;

/// @brief Method get_Issuer addr 0x111bc6c size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Name get_Issuer() ;

/// @brief Method get_StartDate addr 0x111bc74 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::Time get_StartDate() ;

/// @brief Method get_EndDate addr 0x111bc7c size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::Time get_EndDate() ;

/// @brief Method get_Subject addr 0x111bc84 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Name get_Subject() ;

/// @brief Method get_SubjectPublicKeyInfo addr 0x111bc8c size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo get_SubjectPublicKeyInfo() ;

/// @brief Method get_IssuerUniqueID addr 0x111bc94 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerBitString get_IssuerUniqueID() ;

/// @brief Method get_SubjectUniqueID addr 0x111bc9c size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerBitString get_SubjectUniqueID() ;

/// @brief Method get_Extensions addr 0x111bca4 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::X509Extensions get_Extensions() ;

/// @brief Method ToAsn1Object addr 0x111bcac size 0x8 virtual true final false
