...
/// @brief Method .ctor addr 0x100195c size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1Set values) ;

/// @brief Method GetInstance addr 0x1001984 size 0xa8 virtual false final false
...
/// @brief Method .ctor addr 0x1001a2c size 0x134 virtual false final false
...
/// @brief Method .ctor addr 0x1001b60 size 0x7c virtual false final false
...
/// @brief Method .ctor addr 0x1001bdc size 0x7c virtual false final false
 void _ctor(::ArrayW<Org::BouncyCastle::Asn1::X500::AttributeTypeAndValue> aAndVs) ;

/// @brief Method get_IsMultiValued addr 0x1001c58 size 0x2c virtual true final false
 bool get_IsMultiValued() ;

/// @brief Method get_Count addr 0x1001c84 size 0x20 virtual true final false
 int32_t get_Count() ;

/// @brief Method GetFirst addr 0x1001ca4 size 0x50 virtual true final false
 Org::BouncyCastle::Asn1::X500::AttributeTypeAndValue GetFirst() ;

/// @brief Method GetTypesAndValues addr 0x1001cf4 size 0xf4 virtual true final false
 ::ArrayW<Org::BouncyCastle::Asn1::X500::AttributeTypeAndValue> GetTypesAndValues() ;

/// @brief Method ToAsn1Object addr 0x1001de8 size 0x8 virtual true final false
