...
/// @brief Method FromByteArray addr 0xdedf3c size 0x20c virtual false final false
static Org::BouncyCastle::Asn1::Asn1Object FromByteArray(::ArrayW<uint8_t> data) ;

/// @brief Method FromStream addr 0xdee148 size 0x12c virtual false final false
static Org::BouncyCastle::Asn1::Asn1Object FromStream(System::IO::Stream inStr) ;

/// @brief Method ToAsn1Object addr 0xdee274 size 0x4 virtual true final true
...
/// @brief Method CallAsn1Equals addr 0xde7210 size 0xc virtual false final false
 bool CallAsn1Equals(Org::BouncyCastle::Asn1::Asn1Object obj) ;

/// @brief Method CallAsn1GetHashCode addr 0xde70fc size 0xc virtual false final false
 int32_t CallAsn1GetHashCode() ;

// Ctor Parameters []
explicit Asn1Object() ;

/// @brief Method .ctor addr 0xdee278 size 0x8 virtual false final false
 void _ctor() ;
