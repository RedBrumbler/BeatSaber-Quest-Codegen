...
/// @brief Method .ctor addr 0x113ea48 size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x113ea74 size 0x4c virtual false final false
 void _ctor(System::IO::Stream outStream, int32_t tagNo, bool isExplicit) ;

/// @brief Method AddObject addr 0x113eac0 size 0x80 virtual true final false
 void AddObject(Org::BouncyCastle::Asn1::Asn1Encodable obj) ;

/// @brief Method GetRawOutputStream addr 0x113eb44 size 0x8 virtual true final false
 System::IO::Stream GetRawOutputStream() ;

/// @brief Method Close addr 0x113eb4c size 0x4 virtual true final false
 void Close() ;

/// @brief Method WriteHdr addr 0x113ebe8 size 0x44 virtual false final false
 void WriteHdr(int32_t tag) ;

/// @brief Method WriteBerHeader addr 0x113ec2c size 0x58 virtual false final false
 void WriteBerHeader(int32_t tag) ;

/// @brief Method WriteBerBody addr 0x113ec84 size 0x14 virtual false final false
 void WriteBerBody(System::IO::Stream contentStream) ;

/// @brief Method WriteBerEnd addr 0x113eb50 size 0x98 virtual false final false
 void WriteBerEnd() ;
