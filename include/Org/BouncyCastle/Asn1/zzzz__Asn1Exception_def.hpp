...
/// @brief Method .ctor addr 0x1136978 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit Asn1Exception(::StringW message) ;

/// @brief Method .ctor addr 0x1136980 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x1136988 size 0x8 virtual false final false
