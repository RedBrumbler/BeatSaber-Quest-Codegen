...
/// @brief Method GetInstance addr 0xe08be8 size 0x1a0 virtual false final false
...
/// @brief Method .ctor addr 0xe08d88 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0xe08db0 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Crmf::EncryptedValue encryptedValue) ;

/// @brief Method get_IsEncryptedValue addr 0xe08e7c size 0x10 virtual true final false
 bool get_IsEncryptedValue() ;

/// @brief Method get_Value addr 0xe08e8c size 0x1c virtual true final false
 Org::BouncyCastle::Asn1::Asn1Encodable get_Value() ;

/// @brief Method ToAsn1Object addr 0xe08ea8 size 0x8c virtual true final false
