...
/// @brief Method .ctor addr 0x114912c size 0x68 virtual false final false
 void _ctor(::ArrayW<uint8_t> encoded) ;

/// @brief Method Parse addr 0x1149438 size 0x168 virtual false final false
 void Parse() ;

/// @brief Method get_Item addr 0x11495a0 size 0x28 virtual true final false
 Org::BouncyCastle::Asn1::Asn1Encodable get_Item(int32_t index) ;

/// @brief Method GetEnumerator addr 0x11495c8 size 0x24 virtual true final false
 System::Collections::IEnumerator GetEnumerator() ;

/// @brief Method get_Count addr 0x11495ec size 0x24 virtual true final false
 int32_t get_Count() ;

/// @brief Method Encode addr 0x1149610 size 0xcc virtual true final false
