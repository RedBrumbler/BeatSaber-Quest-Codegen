...
/// @brief Method GetInstance addr 0x1146e1c size 0xf0 virtual false final false
static Org::BouncyCastle::Asn1::DerT61String GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetInstance addr 0x1146f0c size 0xe8 virtual false final false
...
/// @brief Method .ctor addr 0x1139f78 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x1146ff4 size 0x78 virtual false final false
 void _ctor(::StringW str) ;

/// @brief Method GetString addr 0x114706c size 0x8 virtual true final false
 ::StringW GetString() ;

/// @brief Method Encode addr 0x1147074 size 0x30 virtual true final false
 void Encode(Org::BouncyCastle::Asn1::DerOutputStream derOut) ;

/// @brief Method GetOctets addr 0x11470a4 size 0xc virtual false final false
 ::ArrayW<uint8_t> GetOctets() ;

/// @brief Method Asn1Equals addr 0x11470b0 size 0xa0 virtual true final false
