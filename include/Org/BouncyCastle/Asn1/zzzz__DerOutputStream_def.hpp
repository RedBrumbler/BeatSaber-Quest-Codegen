...
/// @brief Method .ctor addr 0x113a650 size 0x4 virtual false final false
 void _ctor(System::IO::Stream os) ;

/// @brief Method WriteLength addr 0x113a654 size 0xa0 virtual false final false
 void WriteLength(int32_t length) ;

/// @brief Method WriteEncoded addr 0x113a6f4 size 0x5c virtual false final false
 void WriteEncoded(int32_t tag, ::ArrayW<uint8_t> bytes) ;

/// @brief Method WriteEncoded addr 0x113a750 size 0x7c virtual false final false
 void WriteEncoded(int32_t tag, uint8_t first, ::ArrayW<uint8_t> bytes) ;

/// @brief Method WriteEncoded addr 0x113a7cc size 0x64 virtual false final false
 void WriteEncoded(int32_t tag, ::ArrayW<uint8_t> bytes, int32_t offset, int32_t length) ;

/// @brief Method WriteTag addr 0x113a830 size 0x124 virtual false final false
 void WriteTag(int32_t flags, int32_t tagNo) ;

/// @brief Method WriteEncoded addr 0x113a954 size 0x50 virtual false final false
 void WriteEncoded(int32_t flags, int32_t tagNo, ::ArrayW<uint8_t> bytes) ;

/// @brief Method WriteNull addr 0x113a9a4 size 0x38 virtual false final false
 void WriteNull() ;

/// @brief Method WriteObject addr 0x113a9dc size 0x15c virtual true final false
 void WriteObject(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method WriteObject addr 0x113ab38 size 0x70 virtual true final false
 void WriteObject(Org::BouncyCastle::Asn1::Asn1Encodable obj) ;

/// @brief Method WriteObject addr 0x113aba8 size 0x58 virtual true final false
