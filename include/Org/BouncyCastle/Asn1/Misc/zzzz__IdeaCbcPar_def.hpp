...
/// @brief Method GetInstance addr 0xefceac size 0x148 virtual false final false
...
/// @brief Method .ctor addr 0xefd0d8 size 0x7c virtual false final false
 void _ctor(::ArrayW<uint8_t> iv) ;

// Ctor Parameters [CppParam { name: "seq", ty: "Org::BouncyCastle::Asn1::Asn1Sequence", modifiers: "", def_value: None }]
explicit IdeaCbcPar(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;

/// @brief Method .ctor addr 0xefcff4 size 0xe4 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;

/// @brief Method GetIV addr 0xefd154 size 0x18 virtual false final false
 ::ArrayW<uint8_t> GetIV() ;

/// @brief Method ToAsn1Object addr 0xefd16c size 0x108 virtual true final false
