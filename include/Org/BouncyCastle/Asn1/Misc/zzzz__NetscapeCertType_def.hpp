...
/// @brief Method .ctor addr 0xefdbd0 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0xefdc38 size 0x94 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::DerBitString usage) ;

/// @brief Method ToString addr 0xefdccc size 0xa8 virtual true final false
 ::StringW ToString() ;
