...
/// @brief Method GetInstance addr 0x1144330 size 0x100 virtual false final false
static Org::BouncyCastle::Asn1::DerGeneralizedTime GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetInstance addr 0x1144430 size 0x140 virtual false final false
...
/// @brief Method .ctor addr 0x1144570 size 0x118 virtual false final false
...
/// @brief Method .ctor addr 0x1144908 size 0x6c virtual false final false
...
/// @brief Method .ctor addr 0x1139e58 size 0x34 virtual false final false
 void _ctor(::ArrayW<uint8_t> bytes) ;

/// @brief Method get_TimeString addr 0x1144974 size 0x8 virtual false final false
 ::StringW get_TimeString() ;

/// @brief Method GetTime addr 0x114497c size 0x31c virtual false final false
 ::StringW GetTime() ;

/// @brief Method CalculateGmtOffset addr 0x1144c98 size 0x280 virtual false final false
 ::StringW CalculateGmtOffset() ;

/// @brief Method Convert addr 0x1144f18 size 0x94 virtual false final false
static ::StringW Convert(int32_t time) ;

/// @brief Method ToDateTime addr 0x1144688 size 0x280 virtual false final false
 System::DateTime ToDateTime() ;

/// @brief Method FString addr 0x1144fd8 size 0x84 virtual false final false
 ::StringW FString(int32_t count) ;

/// @brief Method ParseDateString addr 0x114505c size 0x24c virtual false final false
 System::DateTime ParseDateString(::StringW s, ::StringW format, bool makeUniversal) ;

/// @brief Method get_HasFractionalSeconds addr 0x1144fac size 0x2c virtual false final false
 bool get_HasFractionalSeconds() ;

/// @brief Method GetOctets addr 0x11452a8 size 0xc virtual false final false
 ::ArrayW<uint8_t> GetOctets() ;

/// @brief Method Encode addr 0x11452b4 size 0x30 virtual true final false
 void Encode(Org::BouncyCastle::Asn1::DerOutputStream derOut) ;

/// @brief Method Asn1Equals addr 0x11452e4 size 0xa0 virtual true final false
 bool Asn1Equals(Org::BouncyCastle::Asn1::Asn1Object asn1Object) ;

/// @brief Method Asn1GetHashCode addr 0x1145384 size 0x1c virtual true final false
