...
/// @brief Method .ctor addr 0x113ee4c size 0x54 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "dummy", ty: "int32_t", modifiers: "", def_value: None }]
explicit BerNull(int32_t dummy) ;

/// @brief Method .ctor addr 0x113eea0 size 0x54 virtual false final false
 void _ctor(int32_t dummy) ;

/// @brief Method Encode addr 0x113eef4 size 0xd0 virtual true final false
