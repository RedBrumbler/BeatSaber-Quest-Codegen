...
/// @brief Method .ctor addr 0xffcd2c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method AsString addr 0xffcd34 size 0x2664 virtual false final false
static void AsString(::StringW indent, bool verbose, Org::BouncyCastle::Asn1::Asn1Object obj, System::Text::StringBuilder buf) ;

/// @brief Method outputApplicationSpecific addr 0xfff600 size 0x8d4 virtual false final false
...
/// @brief Method DumpAsString addr 0xfffed4 size 0x184 virtual false final false
static ::StringW DumpAsString(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method DumpAsString addr 0x1000058 size 0x58 virtual false final false
static ::StringW DumpAsString(Org::BouncyCastle::Asn1::Asn1Encodable obj) ;

/// @brief Method DumpAsString addr 0x10000b0 size 0xd8 virtual false final false
static ::StringW DumpAsString(Org::BouncyCastle::Asn1::Asn1Encodable obj, bool verbose) ;

/// @brief Method dumpBinaryDataAsString addr 0xfff398 size 0x268 virtual false final false
static ::StringW dumpBinaryDataAsString(::StringW indent, ::ArrayW<uint8_t> bytes) ;

/// @brief Method calculateAscString addr 0x1000188 size 0xb8 virtual false final false
