...
/// @brief Method .ctor addr 0x1139030 size 0x30 virtual false final false
 void _ctor(int32_t tag, Org::BouncyCastle::Asn1::Asn1StreamParser parser) ;

/// @brief Method ReadObject addr 0x113e7ac size 0x20 virtual true final true
 Org::BouncyCastle::Asn1::IAsn1Convertible ReadObject() ;

/// @brief Method ToAsn1Object addr 0x1139060 size 0x7c virtual true final true
