...
/// @brief Method .ctor addr 0x1142cd0 size 0x2c virtual false final false
 void _ctor(System::IO::Stream inStream, int32_t limit) ;

/// @brief Method get_Limit addr 0x1142cfc size 0x8 virtual true final false
 int32_t get_Limit() ;

/// @brief Method SetParentEofDetect addr 0x1142d04 size 0x90 virtual true final false
