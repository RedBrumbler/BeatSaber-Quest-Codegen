...
/// @brief Method .ctor addr 0xefe390 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method DefineCurveAlias addr 0xefe398 size 0x198 virtual false final false
static void DefineCurveAlias(::StringW name, Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetByName addr 0xefe850 size 0x80 virtual false final false
static Org::BouncyCastle::Asn1::X9::X9ECParameters GetByName(::StringW name) ;

/// @brief Method GetByOid addr 0xefea24 size 0x58 virtual false final false
static Org::BouncyCastle::Asn1::X9::X9ECParameters GetByOid(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetOid addr 0xefe8d0 size 0x154 virtual false final false
static Org::BouncyCastle::Asn1::DerObjectIdentifier GetOid(::StringW name) ;

/// @brief Method GetName addr 0xefea7c size 0x100 virtual false final false
static ::StringW GetName(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method get_Names addr 0xefeb7c size 0x10c virtual false final false
