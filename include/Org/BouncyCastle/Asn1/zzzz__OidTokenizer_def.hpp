...
/// @brief Method .ctor addr 0x11496dc size 0x28 virtual false final false
 void _ctor(::StringW oid) ;

/// @brief Method get_HasMoreTokens addr 0x1149704 size 0x10 virtual false final false
 bool get_HasMoreTokens() ;

/// @brief Method NextToken addr 0x1149714 size 0x88 virtual false final false
 ::StringW NextToken() ;
