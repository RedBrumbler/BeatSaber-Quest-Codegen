...
/// @brief Method .ctor addr 0x11394e4 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1StreamParser parser) ;

/// @brief Method ReadObject addr 0x114429c size 0x20 virtual false final false
 Org::BouncyCastle::Asn1::IAsn1Convertible ReadObject() ;

/// @brief Method ToAsn1Object addr 0x11442bc size 0x74 virtual true final false
