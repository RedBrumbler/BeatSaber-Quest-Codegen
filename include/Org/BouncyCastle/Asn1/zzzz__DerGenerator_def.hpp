...
/// @brief Method .ctor addr 0x114572c size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x1145758 size 0x4c virtual false final false
 void _ctor(System::IO::Stream outStream, int32_t tagNo, bool isExplicit) ;

/// @brief Method WriteLength addr 0x11457a4 size 0xac virtual false final false
static void WriteLength(System::IO::Stream outStr, int32_t length) ;

/// @brief Method WriteDerEncoded addr 0x1145850 size 0x60 virtual false final false
static void WriteDerEncoded(System::IO::Stream outStream, int32_t tag, ::ArrayW<uint8_t> bytes) ;

/// @brief Method WriteDerEncoded addr 0x11458b0 size 0xe0 virtual false final false
 void WriteDerEncoded(int32_t tag, ::ArrayW<uint8_t> bytes) ;

/// @brief Method WriteDerEncoded addr 0x1145990 size 0x34 virtual false final false
