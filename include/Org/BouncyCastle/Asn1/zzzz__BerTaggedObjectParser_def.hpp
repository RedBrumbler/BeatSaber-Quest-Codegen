...
/// @brief Method .ctor addr 0x1142434 size 0xa4 virtual false final false
...
/// @brief Method .ctor addr 0x11390dc size 0x40 virtual false final false
 void _ctor(bool constructed, int32_t tagNumber, Org::BouncyCastle::Asn1::Asn1StreamParser parser) ;

/// @brief Method get_IsConstructed addr 0x11424d8 size 0x8 virtual false final false
 bool get_IsConstructed() ;

/// @brief Method get_TagNo addr 0x11424e0 size 0x8 virtual true final true
 int32_t get_TagNo() ;

/// @brief Method GetObjectParser addr 0x11424e8 size 0x98 virtual true final true
 Org::BouncyCastle::Asn1::IAsn1Convertible GetObjectParser(int32_t tag, bool isExplicit) ;

/// @brief Method ToAsn1Object addr 0x113911c size 0xfc virtual true final true
