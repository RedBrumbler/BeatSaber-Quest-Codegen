...
/// @brief Method GetInstance addr 0x11453a0 size 0xf0 virtual false final false
static Org::BouncyCastle::Asn1::DerGeneralString GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetInstance addr 0x1145490 size 0x140 virtual false final false
...
/// @brief Method .ctor addr 0x1139e8c size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x11455d0 size 0x78 virtual false final false
 void _ctor(::StringW str) ;

/// @brief Method GetString addr 0x1145648 size 0x8 virtual true final false
 ::StringW GetString() ;

/// @brief Method GetOctets addr 0x1145650 size 0xc virtual false final false
 ::ArrayW<uint8_t> GetOctets() ;

/// @brief Method Encode addr 0x114565c size 0x30 virtual true final false
 void Encode(Org::BouncyCastle::Asn1::DerOutputStream derOut) ;

/// @brief Method Asn1Equals addr 0x114568c size 0xa0 virtual true final false
