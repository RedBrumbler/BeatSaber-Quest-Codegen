...
/// @brief Method GetInstance addr 0x1147150 size 0xf0 virtual false final false
static Org::BouncyCastle::Asn1::DerUniversalString GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetInstance addr 0x1147240 size 0xfc virtual false final false
...
/// @brief Method .ctor addr 0x1139f9c size 0x78 virtual false final false
 void _ctor(::ArrayW<uint8_t> str) ;

/// @brief Method GetString addr 0x114733c size 0x16c virtual true final false
 ::StringW GetString() ;

/// @brief Method GetOctets addr 0x11474a8 size 0x78 virtual false final false
 ::ArrayW<uint8_t> GetOctets() ;

/// @brief Method Encode addr 0x1147520 size 0x24 virtual true final false
 void Encode(Org::BouncyCastle::Asn1::DerOutputStream derOut) ;

/// @brief Method Asn1Equals addr 0x1147544 size 0xc8 virtual true final false
