...
/// @brief Method .ctor addr 0x113fe84 size 0x8c virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::BerOctetStringGenerator gen, ::ArrayW<uint8_t> buf) ;

/// @brief Method WriteByte addr 0x113ff68 size 0x68 virtual true final false
 void WriteByte(uint8_t b) ;

/// @brief Method Write addr 0x113ffd0 size 0x120 virtual true final false
 void Write(::ArrayW<uint8_t> buf, int32_t offset, int32_t len) ;

/// @brief Method Close addr 0x11400f0 size 0x48 virtual true final false
 void Close() ;
...
/// @brief Method .ctor addr 0x113fcc8 size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x113fcfc size 0x54 virtual false final false
 void _ctor(System::IO::Stream outStream, int32_t tagNo, bool isExplicit) ;

/// @brief Method GetOctetOutputStream addr 0x113fd50 size 0x54 virtual false final false
 System::IO::Stream GetOctetOutputStream() ;

/// @brief Method GetOctetOutputStream addr 0x113fe14 size 0x70 virtual false final false
 System::IO::Stream GetOctetOutputStream(int32_t bufSize) ;

/// @brief Method GetOctetOutputStream addr 0x113fda4 size 0x70 virtual false final false
