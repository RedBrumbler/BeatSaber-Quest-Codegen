...
/// @brief Method .ctor addr 0x113ec98 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "dummy", ty: "int32_t", modifiers: "", def_value: None }]
explicit DerNull(int32_t dummy) ;

/// @brief Method .ctor addr 0x113ecf0 size 0x58 virtual false final false
 void _ctor(int32_t dummy) ;

/// @brief Method Encode addr 0x113ed48 size 0x24 virtual true final false
 void Encode(Org::BouncyCastle::Asn1::DerOutputStream derOut) ;

/// @brief Method Asn1Equals addr 0x113ed6c size 0x78 virtual true final false
 bool Asn1Equals(Org::BouncyCastle::Asn1::Asn1Object asn1Object) ;

/// @brief Method Asn1GetHashCode addr 0x113ede4 size 0x8 virtual true final false
