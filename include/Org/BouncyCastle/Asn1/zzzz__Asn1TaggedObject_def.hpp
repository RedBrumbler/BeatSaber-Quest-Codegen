...
/// @brief Method IsConstructed addr 0x113d870 size 0x130 virtual false final false
static bool IsConstructed(bool isExplicit, Org::BouncyCastle::Asn1::Asn1Object obj) ;

/// @brief Method GetInstance addr 0x113d9a0 size 0x78 virtual false final false
static Org::BouncyCastle::Asn1::Asn1TaggedObject GetInstance(Org::BouncyCastle::Asn1::Asn1TaggedObject obj, bool explicitly) ;

/// @brief Method GetInstance addr 0x113da18 size 0x100 virtual false final false
...
/// @brief Method .ctor addr 0x113db18 size 0x44 virtual false final false
...
/// @brief Method .ctor addr 0x113db5c size 0x8c virtual false final false
 void _ctor(bool explicitly, int32_t tagNo, Org::BouncyCastle::Asn1::Asn1Encodable obj) ;

/// @brief Method Asn1Equals addr 0x113dbe8 size 0xf8 virtual true final false
 bool Asn1Equals(Org::BouncyCastle::Asn1::Asn1Object asn1Object) ;

/// @brief Method Asn1GetHashCode addr 0x113dce0 size 0x3c virtual true final false
 int32_t Asn1GetHashCode() ;

/// @brief Method get_TagNo addr 0x113dd1c size 0x8 virtual true final true
 int32_t get_TagNo() ;

/// @brief Method IsExplicit addr 0x113dd24 size 0x8 virtual false final false
 bool IsExplicit() ;

/// @brief Method IsEmpty addr 0x113dd2c size 0x8 virtual false final false
 bool IsEmpty() ;

/// @brief Method GetObject addr 0x112d7cc size 0x18 virtual false final false
 Org::BouncyCastle::Asn1::Asn1Object GetObject() ;

/// @brief Method GetObjectParser addr 0x113dd34 size 0x130 virtual true final true
 Org::BouncyCastle::Asn1::IAsn1Convertible GetObjectParser(int32_t tag, bool isExplicit) ;

/// @brief Method ToString addr 0x113de64 size 0x178 virtual true final false
 ::StringW ToString() ;
