...
/// @brief Method .ctor addr 0xdee280 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method GetString addr 0x0 size 0xffffffffffffffff virtual true final false
 ::StringW GetString() ;

/// @brief Method ToString addr 0xdee288 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method Asn1GetHashCode addr 0xdee294 size 0x24 virtual true final false
