...
/// @brief Method GetInstance addr 0xe1df20 size 0x190 virtual false final false
...
/// @brief Method .ctor addr 0xe1e0b0 size 0x154 virtual false final false
...
/// @brief Method .ctor addr 0xe1e204 size 0x7c virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Ess::OtherCertID otherCertID) ;

/// @brief Method GetCerts addr 0xe1e280 size 0x110 virtual false final false
 ::ArrayW<Org::BouncyCastle::Asn1::Ess::OtherCertID> GetCerts() ;

/// @brief Method GetPolicies addr 0xe1e390 size 0x118 virtual false final false
 ::ArrayW<Org::BouncyCastle::Asn1::X509::PolicyInformation> GetPolicies() ;

/// @brief Method ToAsn1Object addr 0xe1e4a8 size 0x148 virtual true final false
