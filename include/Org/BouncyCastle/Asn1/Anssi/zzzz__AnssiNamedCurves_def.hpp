...
/// @brief Method .ctor addr 0xde64c4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method CreateParameters addr 0xde64d4 size 0x1d4 virtual true final false
...
/// @brief Method ConfigureBasepoint addr 0xde5a3c size 0xf0 virtual false final false
static Org::BouncyCastle::Asn1::X9::X9ECPoint ConfigureBasepoint(Org::BouncyCastle::Math::EC::ECCurve curve, ::StringW encoding) ;

/// @brief Method ConfigureCurve addr 0xde5b2c size 0x4 virtual false final false
static Org::BouncyCastle::Math::EC::ECCurve ConfigureCurve(Org::BouncyCastle::Math::EC::ECCurve curve) ;

/// @brief Method FromHex addr 0xde5b30 size 0xa0 virtual false final false
static Org::BouncyCastle::Math::BigInteger FromHex(::StringW hex) ;

/// @brief Method DefineCurve addr 0xde5bd0 size 0x210 virtual false final false
...
/// @brief Method GetByName addr 0xde5efc size 0x80 virtual false final false
static Org::BouncyCastle::Asn1::X9::X9ECParameters GetByName(::StringW name) ;

/// @brief Method GetByOid addr 0xde60d0 size 0x128 virtual false final false
static Org::BouncyCastle::Asn1::X9::X9ECParameters GetByOid(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetOid addr 0xde5f7c size 0x154 virtual false final false
static Org::BouncyCastle::Asn1::DerObjectIdentifier GetOid(::StringW name) ;

/// @brief Method GetName addr 0xde62b0 size 0x100 virtual false final false
static ::StringW GetName(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method get_Names addr 0xde63b0 size 0x10c virtual false final false
static System::Collections::IEnumerable get_Names() ;

// Ctor Parameters []
explicit AnssiNamedCurves() ;

/// @brief Method .ctor addr 0xde64bc size 0x8 virtual false final false
 void _ctor() ;
