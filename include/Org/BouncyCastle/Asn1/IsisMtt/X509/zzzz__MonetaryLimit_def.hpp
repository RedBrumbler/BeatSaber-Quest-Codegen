...
/// @brief Method GetInstance addr 0xef9144 size 0x168 virtual false final false
...
/// @brief Method .ctor addr 0xef92ac size 0x130 virtual false final false
...
/// @brief Method .ctor addr 0xef93dc size 0xe4 virtual false final false
 void _ctor(::StringW currency, int32_t amount, int32_t exponent) ;

/// @brief Method get_Currency addr 0xef94c0 size 0x20 virtual true final false
 ::StringW get_Currency() ;

/// @brief Method get_Amount addr 0xef94e0 size 0x1c virtual true final false
 Org::BouncyCastle::Math::BigInteger get_Amount() ;

/// @brief Method get_Exponent addr 0xef94fc size 0x1c virtual true final false
 Org::BouncyCastle::Math::BigInteger get_Exponent() ;

/// @brief Method ToAsn1Object addr 0xef9518 size 0x11c virtual true final false
