...
/// @brief Method GetInstance addr 0xffab10 size 0xa4 virtual false final false
...
/// @brief Method .ctor addr 0xffabb4 size 0xf8 virtual false final false
...
/// @brief Method .ctor addr 0xffacac size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier hashAlgorithm, ::ArrayW<uint8_t> hashedMessage) ;

/// @brief Method get_HashAlgorithm addr 0xffacd8 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_HashAlgorithm() ;

/// @brief Method GetHashedMessage addr 0xfface0 size 0x8 virtual false final false
 ::ArrayW<uint8_t> GetHashedMessage() ;

/// @brief Method ToAsn1Object addr 0xfface8 size 0x11c virtual true final false
