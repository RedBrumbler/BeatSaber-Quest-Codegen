...
/// @brief Method GetInstance addr 0xff4f78 size 0x240 virtual false final false
...
/// @brief Method .ctor addr 0xff51b8 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;

/// @brief Method GetCapabilities addr 0xff51e0 size 0x7c virtual false final false
 System::Collections::ArrayList GetCapabilities(Org::BouncyCastle::Asn1::DerObjectIdentifier capability) ;

/// @brief Method GetCapabilitiesForOid addr 0xff589c size 0x7c virtual false final false
 System::Collections::IList GetCapabilitiesForOid(Org::BouncyCastle::Asn1::DerObjectIdentifier capability) ;

/// @brief Method DoGetCapabilitiesForOid addr 0xff525c size 0x640 virtual false final false
 void DoGetCapabilitiesForOid(Org::BouncyCastle::Asn1::DerObjectIdentifier capability, System::Collections::IList list) ;

/// @brief Method ToAsn1Object addr 0xff5a60 size 0x8 virtual true final false
