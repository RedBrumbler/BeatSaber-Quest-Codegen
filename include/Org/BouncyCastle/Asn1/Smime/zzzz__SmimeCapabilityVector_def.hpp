...
/// @brief Method AddCapability addr 0xff670c size 0x80 virtual false final false
 void AddCapability(Org::BouncyCastle::Asn1::DerObjectIdentifier capability) ;

/// @brief Method AddCapability addr 0xff678c size 0x134 virtual false final false
 void AddCapability(Org::BouncyCastle::Asn1::DerObjectIdentifier capability, int32_t value) ;

/// @brief Method AddCapability addr 0xff68c0 size 0x108 virtual false final false
 void AddCapability(Org::BouncyCastle::Asn1::DerObjectIdentifier capability, Org::BouncyCastle::Asn1::Asn1Encodable parameters) ;

/// @brief Method ToAsn1EncodableVector addr 0xff69c8 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::Asn1EncodableVector ToAsn1EncodableVector() ;

// Ctor Parameters []
explicit SmimeCapabilityVector() ;

/// @brief Method .ctor addr 0xff69d0 size 0x68 virtual false final false
 void _ctor() ;
