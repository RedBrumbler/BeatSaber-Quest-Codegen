...
/// @brief Method GetInstance addr 0x11484e8 size 0x220 virtual false final false
static Org::BouncyCastle::Asn1::DerVideotexString GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetInstance addr 0x1148708 size 0x130 virtual false final false
...
/// @brief Method .ctor addr 0x113a09c size 0x78 virtual false final false
 void _ctor(::ArrayW<uint8_t> encoding) ;

/// @brief Method GetString addr 0x1148838 size 0xc virtual true final false
 ::StringW GetString() ;

/// @brief Method GetOctets addr 0x1148844 size 0x5c virtual false final false
 ::ArrayW<uint8_t> GetOctets() ;

/// @brief Method Encode addr 0x11488a0 size 0x24 virtual true final false
 void Encode(Org::BouncyCastle::Asn1::DerOutputStream derOut) ;

/// @brief Method Asn1GetHashCode addr 0x11488c4 size 0x5c virtual true final false
 int32_t Asn1GetHashCode() ;

/// @brief Method Asn1Equals addr 0x1148920 size 0xc8 virtual true final false
