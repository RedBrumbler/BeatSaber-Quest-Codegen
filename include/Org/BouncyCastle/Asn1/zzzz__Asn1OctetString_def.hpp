...
/// @brief Method GetInstance addr 0x113a180 size 0xd4 virtual false final false
static Org::BouncyCastle::Asn1::Asn1OctetString GetInstance(Org::BouncyCastle::Asn1::Asn1TaggedObject obj, bool isExplicit) ;

/// @brief Method GetInstance addr 0x11333bc size 0x2b8 virtual false final false
...
/// @brief Method .ctor addr 0x113a380 size 0x78 virtual false final false
 void _ctor(::ArrayW<uint8_t> str) ;

/// @brief Method GetOctetStream addr 0x113a3f8 size 0x6c virtual true final true
 System::IO::Stream GetOctetStream() ;

/// @brief Method get_Parser addr 0x113a464 size 0x4 virtual false final false
 Org::BouncyCastle::Asn1::Asn1OctetStringParser get_Parser() ;

/// @brief Method GetOctets addr 0x113a468 size 0x8 virtual true final false
 ::ArrayW<uint8_t> GetOctets() ;

/// @brief Method Asn1GetHashCode addr 0x113a470 size 0x70 virtual true final false
 int32_t Asn1GetHashCode() ;

/// @brief Method Asn1Equals addr 0x113a4e0 size 0xec virtual true final false
 bool Asn1Equals(Org::BouncyCastle::Asn1::Asn1Object asn1Object) ;

/// @brief Method ToString addr 0x113a5cc size 0x84 virtual true final false
 ::StringW ToString() ;
