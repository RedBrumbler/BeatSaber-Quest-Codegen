...
/// @brief Method GetInstance addr 0xff5f04 size 0x1d8 virtual false final false
static Org::BouncyCastle::Asn1::DerObjectIdentifier GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetInstance addr 0x1009bfc size 0xe8 virtual false final false
...
/// @brief Method .ctor addr 0xfec6a0 size 0x138 virtual false final false
...
/// @brief Method .ctor addr 0x1009d9c size 0x138 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::DerObjectIdentifier oid, ::StringW branchID) ;

/// @brief Method get_Id addr 0x1009fc4 size 0x8 virtual false final false
 ::StringW get_Id() ;

/// @brief Method Branch addr 0x1009fcc size 0x70 virtual true final false
 Org::BouncyCastle::Asn1::DerObjectIdentifier Branch(::StringW branchID) ;

/// @brief Method On addr 0x100a03c size 0xb0 virtual true final false
...
/// @brief Method .ctor addr 0x100a0ec size 0xac virtual false final false
 void _ctor(::ArrayW<uint8_t> bytes) ;

/// @brief Method WriteField addr 0x100a3f0 size 0xe0 virtual false final false
 void WriteField(System::IO::Stream outputStream, int64_t fieldValue) ;

/// @brief Method WriteField addr 0x100a4d0 size 0x17c virtual false final false
 void WriteField(System::IO::Stream outputStream, Org::BouncyCastle::Math::BigInteger fieldValue) ;

/// @brief Method DoOutput addr 0x100a64c size 0x1b4 virtual false final false
 void DoOutput(System::IO::MemoryStream bOut) ;

/// @brief Method GetBody addr 0x100a800 size 0x114 virtual false final false
 ::ArrayW<uint8_t> GetBody() ;

/// @brief Method Encode addr 0x100a914 size 0x2c virtual true final false
 void Encode(Org::BouncyCastle::Asn1::DerOutputStream derOut) ;

/// @brief Method Asn1GetHashCode addr 0x100a940 size 0x1c virtual true final false
 int32_t Asn1GetHashCode() ;

/// @brief Method Asn1Equals addr 0x100a95c size 0xa0 virtual true final false
 bool Asn1Equals(Org::BouncyCastle::Asn1::Asn1Object asn1Object) ;

/// @brief Method ToString addr 0x100a9fc size 0x8 virtual true final false
 ::StringW ToString() ;

/// @brief Method IsValidBranchID addr 0x1009ed4 size 0xf0 virtual false final false
static bool IsValidBranchID(::StringW branchID, int32_t start) ;

/// @brief Method IsValidIdentifier addr 0x1009ce4 size 0xb8 virtual false final false
static bool IsValidIdentifier(::StringW identifier) ;

/// @brief Method MakeOidStringFromBytes addr 0x100a198 size 0x258 virtual false final false
static ::StringW MakeOidStringFromBytes(::ArrayW<uint8_t> bytes) ;

/// @brief Method FromOctetString addr 0x10099c4 size 0x238 virtual false final false
