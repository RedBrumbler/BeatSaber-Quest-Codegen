...
/// @brief Method .ctor addr 0xe0f9ac size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method GetByOid addr 0xe10108 size 0x11c virtual false final false
static Org::BouncyCastle::Asn1::CryptoPro::Gost3410ParamSetParameters GetByOid(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method get_Names addr 0xe10224 size 0x10c virtual false final false
static System::Collections::IEnumerable get_Names() ;

/// @brief Method GetByName addr 0xe10330 size 0x1ec virtual false final false
static Org::BouncyCastle::Asn1::CryptoPro::Gost3410ParamSetParameters GetByName(::StringW name) ;

/// @brief Method GetOid addr 0xe1051c size 0x11c virtual false final false
