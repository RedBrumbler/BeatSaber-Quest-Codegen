...
/// @brief Method ConfigureBasepoint addr 0xe0c720 size 0x98 virtual false final false
...
/// @brief Method ConfigureCurve addr 0xe0c7b8 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0xe0c7bc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method GetByOid addr 0xe0e6cc size 0x11c virtual false final false
static Org::BouncyCastle::Crypto::Parameters::ECDomainParameters GetByOid(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetByOidX9 addr 0xe0e7e8 size 0x1cc virtual false final false
static Org::BouncyCastle::Asn1::X9::X9ECParameters GetByOidX9(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method get_Names addr 0xe0e9b4 size 0x10c virtual false final false
static System::Collections::IEnumerable get_Names() ;

/// @brief Method GetByName addr 0xe0eac0 size 0x1ec virtual false final false
static Org::BouncyCastle::Crypto::Parameters::ECDomainParameters GetByName(::StringW name) ;

/// @brief Method GetByNameX9 addr 0xe0ecac size 0x144 virtual false final false
static Org::BouncyCastle::Asn1::X9::X9ECParameters GetByNameX9(::StringW name) ;

/// @brief Method GetName addr 0xe0edf0 size 0x100 virtual false final false
static ::StringW GetName(Org::BouncyCastle::Asn1::DerObjectIdentifier oid) ;

/// @brief Method GetOid addr 0xe0eef0 size 0x11c virtual false final false
