...
/// @brief Method GetInstance addr 0xdfc758 size 0x188 virtual false final false
...
/// @brief Method .ctor addr 0xdff3f4 size 0xe0 virtual false final false
...
/// @brief Method .ctor addr 0xdff4d4 size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::DerObjectIdentifier keyAttrId, Org::BouncyCastle::Asn1::Asn1Encodable keyAttr) ;

/// @brief Method get_KeyAttrId addr 0xdff500 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_KeyAttrId() ;

/// @brief Method get_KeyAttr addr 0xdff508 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::Asn1Encodable get_KeyAttr() ;

/// @brief Method ToAsn1Object addr 0xdff510 size 0xf0 virtual true final false
