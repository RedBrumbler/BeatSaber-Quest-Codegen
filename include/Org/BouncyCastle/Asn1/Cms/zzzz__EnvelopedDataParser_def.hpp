...
/// @brief Method .ctor addr 0xdfb5dc size 0x124 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1SequenceParser seq) ;

/// @brief Method get_Version addr 0xdfb700 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerInteger get_Version() ;

/// @brief Method GetOriginatorInfo addr 0xdfb708 size 0x2e0 virtual false final false
 Org::BouncyCastle::Asn1::Cms::OriginatorInfo GetOriginatorInfo() ;

/// @brief Method GetRecipientInfos addr 0xdfb9e8 size 0x100 virtual false final false
 Org::BouncyCastle::Asn1::Asn1SetParser GetRecipientInfos() ;

/// @brief Method GetEncryptedContentInfo addr 0xdfbae8 size 0x120 virtual false final false
 Org::BouncyCastle::Asn1::Cms::EncryptedContentInfoParser GetEncryptedContentInfo() ;

/// @brief Method GetUnprotectedAttrs addr 0xdfbc08 size 0x1ac virtual false final false
