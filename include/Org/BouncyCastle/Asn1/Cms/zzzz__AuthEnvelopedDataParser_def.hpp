...
/// @brief Method .ctor addr 0xdf8414 size 0x124 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1SequenceParser seq) ;

/// @brief Method get_Version addr 0xdf8538 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerInteger get_Version() ;

/// @brief Method GetOriginatorInfo addr 0xdf8540 size 0x2e0 virtual false final false
 Org::BouncyCastle::Asn1::Cms::OriginatorInfo GetOriginatorInfo() ;

/// @brief Method GetRecipientInfos addr 0xdf8820 size 0x100 virtual false final false
 Org::BouncyCastle::Asn1::Asn1SetParser GetRecipientInfos() ;

/// @brief Method GetAuthEncryptedContentInfo addr 0xdf8920 size 0x120 virtual false final false
 Org::BouncyCastle::Asn1::Cms::EncryptedContentInfoParser GetAuthEncryptedContentInfo() ;

/// @brief Method GetAuthAttrs addr 0xdf8cf8 size 0x1b8 virtual false final false
 Org::BouncyCastle::Asn1::Asn1SetParser GetAuthAttrs() ;

/// @brief Method GetMac addr 0xdf8eb0 size 0x130 virtual false final false
 Org::BouncyCastle::Asn1::Asn1OctetString GetMac() ;

/// @brief Method GetUnauthAttrs addr 0xdf8fe0 size 0x1ac virtual false final false
