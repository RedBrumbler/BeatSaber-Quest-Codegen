...
/// @brief Method .ctor addr 0xdf8a40 size 0x2b8 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1SequenceParser seq) ;

/// @brief Method get_ContentType addr 0xdfa304 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_ContentType() ;

/// @brief Method get_ContentEncryptionAlgorithm addr 0xdfa30c size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier get_ContentEncryptionAlgorithm() ;

/// @brief Method GetEncryptedContent addr 0xdfa314 size 0xb0 virtual false final false
