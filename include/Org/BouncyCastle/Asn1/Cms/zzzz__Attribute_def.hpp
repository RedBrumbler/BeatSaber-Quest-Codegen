...
/// @brief Method GetInstance addr 0xdf37f0 size 0x188 virtual false final false
...
/// @brief Method .ctor addr 0xdf3978 size 0x14c virtual false final false
...
/// @brief Method .ctor addr 0xdf3ac4 size 0x2c virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::DerObjectIdentifier attrType, Org::BouncyCastle::Asn1::Asn1Set attrValues) ;

/// @brief Method get_AttrType addr 0xdf3af0 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_AttrType() ;

/// @brief Method get_AttrValues addr 0xdf3af8 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::Asn1Set get_AttrValues() ;

/// @brief Method ToAsn1Object addr 0xdf3b00 size 0xf0 virtual true final false
