...
/// @brief Method .ctor addr 0xdf7500 size 0x1e0 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1SequenceParser seq) ;

/// @brief Method get_ContentType addr 0xdf9f0c size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::DerObjectIdentifier get_ContentType() ;

/// @brief Method GetContent addr 0xdf9f14 size 0xbc virtual false final false
