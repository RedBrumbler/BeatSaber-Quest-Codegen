...
/// @brief Method GetInstance addr 0xe04578 size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0xe04754 size 0x140 virtual false final false
...
/// @brief Method .ctor addr 0xe04894 size 0x168 virtual false final false
 void _ctor(System::DateTime date) ;

/// @brief Method GetInstance addr 0xe04594 size 0x1c0 virtual false final false
static Org::BouncyCastle::Asn1::Cms::Time GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method get_TimeString addr 0xe049fc size 0xf0 virtual false final false
 ::StringW get_TimeString() ;

/// @brief Method get_Date addr 0xe04aec size 0x1e4 virtual false final false
 System::DateTime get_Date() ;

/// @brief Method ToAsn1Object addr 0xe04cd0 size 0x8 virtual true final false
