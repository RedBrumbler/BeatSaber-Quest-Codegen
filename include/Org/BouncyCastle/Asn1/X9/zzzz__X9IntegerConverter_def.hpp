...
/// @brief Method GetByteLength addr 0x1134ec4 size 0x34 virtual false final false
static int32_t GetByteLength(Org::BouncyCastle::Math::EC::ECFieldElement fe) ;

/// @brief Method GetByteLength addr 0x11351f8 size 0x34 virtual false final false
static int32_t GetByteLength(Org::BouncyCastle::Math::EC::ECCurve c) ;

/// @brief Method IntegerToBytes addr 0x1134ef8 size 0xdc virtual false final false
static ::ArrayW<uint8_t> IntegerToBytes(Org::BouncyCastle::Math::BigInteger s, int32_t qLength) ;

// Ctor Parameters []
explicit X9IntegerConverter() ;

/// @brief Method .ctor addr 0x113522c size 0x8 virtual false final false
 void _ctor() ;
