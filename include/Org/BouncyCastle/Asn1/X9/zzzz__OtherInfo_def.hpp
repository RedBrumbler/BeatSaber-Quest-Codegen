...
/// @brief Method .ctor addr 0x112d3e8 size 0x3c virtual false final false
...
/// @brief Method .ctor addr 0x112d424 size 0x3a8 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;

/// @brief Method get_KeyInfo addr 0x112d7e4 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X9::KeySpecificInfo get_KeyInfo() ;

/// @brief Method get_PartyAInfo addr 0x112d7ec size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::Asn1OctetString get_PartyAInfo() ;

/// @brief Method get_SuppPubInfo addr 0x112d7f4 size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::Asn1OctetString get_SuppPubInfo() ;

/// @brief Method ToAsn1Object addr 0x112d7fc size 0x168 virtual true final false
