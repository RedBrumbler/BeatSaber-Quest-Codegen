...
/// @brief Method .ctor addr 0xdeef1c size 0x64 virtual false final false
...
/// @brief Method .ctor addr 0xdeef80 size 0x90 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::DerBitString info) ;

/// @brief Method ToString addr 0xdef010 size 0x98 virtual true final false
 ::StringW ToString() ;
