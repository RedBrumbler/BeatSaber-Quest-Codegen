...
/// @brief Method GetInstance addr 0xdef0a8 size 0x18 virtual false final false
static Org::BouncyCastle::Asn1::Cmp::PkiFreeText GetInstance(Org::BouncyCastle::Asn1::Asn1TaggedObject obj, bool isExplicit) ;

/// @brief Method GetInstance addr 0xdeacf4 size 0x188 virtual false final false
...
/// @brief Method .ctor addr 0xdef0c0 size 0x334 virtual false final false
...
/// @brief Method .ctor addr 0xdef3f4 size 0x7c virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::DerUtf8String p) ;

/// @brief Method get_Size addr 0xdef470 size 0x24 virtual false final false
 int32_t get_Size() ;

/// @brief Method get_Count addr 0xdef494 size 0x24 virtual false final false
 int32_t get_Count() ;

/// @brief Method get_Item addr 0xdef4b8 size 0x94 virtual false final false
 Org::BouncyCastle::Asn1::DerUtf8String get_Item(int32_t index) ;

/// @brief Method GetStringAt addr 0xdef54c size 0x4 virtual false final false
 Org::BouncyCastle::Asn1::DerUtf8String GetStringAt(int32_t index) ;

/// @brief Method ToAsn1Object addr 0xdef550 size 0x8 virtual true final false
