...
/// @brief Method Add addr 0xdf2df0 size 0x28 virtual true final false
 Org::BouncyCastle::Asn1::Cmp::RevRepContentBuilder Add(Org::BouncyCastle::Asn1::Cmp::PkiStatusInfo status) ;

/// @brief Method Add addr 0xdf2e18 size 0xac virtual true final false
...
/// @brief Method AddCrl addr 0xdf2ec4 size 0x28 virtual true final false
 Org::BouncyCastle::Asn1::Cmp::RevRepContentBuilder AddCrl(Org::BouncyCastle::Asn1::X509::CertificateList crl) ;

/// @brief Method Build addr 0xdf2eec size 0x1a4 virtual true final false
 Org::BouncyCastle::Asn1::Cmp::RevRepContent Build() ;

// Ctor Parameters []
explicit RevRepContentBuilder() ;

/// @brief Method .ctor addr 0xdf3090 size 0xa0 virtual false final false
 void _ctor() ;
