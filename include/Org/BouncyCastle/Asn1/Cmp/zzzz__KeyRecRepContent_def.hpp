...
/// @brief Method .ctor addr 0xdebc7c size 0x19c virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;

/// @brief Method GetInstance addr 0xdebe18 size 0x188 virtual false final false
static Org::BouncyCastle::Asn1::Cmp::KeyRecRepContent GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method get_Status addr 0xdebfa0 size 0x8 virtual true final false
 Org::BouncyCastle::Asn1::Cmp::PkiStatusInfo get_Status() ;

/// @brief Method get_NewSigCert addr 0xdebfa8 size 0x8 virtual true final false
 Org::BouncyCastle::Asn1::Cmp::CmpCertificate get_NewSigCert() ;

/// @brief Method GetCACerts addr 0xdebfb0 size 0xfc virtual true final false
 ::ArrayW<Org::BouncyCastle::Asn1::Cmp::CmpCertificate> GetCACerts() ;

/// @brief Method GetKeyPairHist addr 0xdec0ac size 0xfc virtual true final false
 ::ArrayW<Org::BouncyCastle::Asn1::Cmp::CertifiedKeyPair> GetKeyPairHist() ;

/// @brief Method ToAsn1Object addr 0xdec1a8 size 0x144 virtual true final false
