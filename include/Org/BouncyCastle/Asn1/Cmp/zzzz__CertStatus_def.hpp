...
/// @brief Method .ctor addr 0xde99cc size 0xa4 virtual false final false
...
/// @brief Method .ctor addr 0xde9a70 size 0xb4 virtual false final false
...
/// @brief Method .ctor addr 0xde9b24 size 0xc0 virtual false final false
...
/// @brief Method GetInstance addr 0xde82e0 size 0x188 virtual false final false
static Org::BouncyCastle::Asn1::Cmp::CertStatus GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method get_CertHash addr 0xde9be4 size 0x8 virtual true final false
 Org::BouncyCastle::Asn1::Asn1OctetString get_CertHash() ;

/// @brief Method get_CertReqID addr 0xde9bec size 0x8 virtual true final false
 Org::BouncyCastle::Asn1::DerInteger get_CertReqID() ;

/// @brief Method get_StatusInfo addr 0xde9bf4 size 0x8 virtual true final false
 Org::BouncyCastle::Asn1::Cmp::PkiStatusInfo get_StatusInfo() ;

/// @brief Method ToAsn1Object addr 0xde9bfc size 0x174 virtual true final false
