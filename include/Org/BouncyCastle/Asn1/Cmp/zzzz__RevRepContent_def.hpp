...
/// @brief Method .ctor addr 0xdf28f0 size 0xe0 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;

/// @brief Method GetInstance addr 0xded558 size 0x188 virtual false final false
static Org::BouncyCastle::Asn1::Cmp::RevRepContent GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetStatus addr 0xdf29d0 size 0xf4 virtual true final false
 ::ArrayW<Org::BouncyCastle::Asn1::Cmp::PkiStatusInfo> GetStatus() ;

/// @brief Method GetRevCerts addr 0xdf2ac4 size 0x100 virtual true final false
 ::ArrayW<Org::BouncyCastle::Asn1::Crmf::CertId> GetRevCerts() ;

/// @brief Method GetCrls addr 0xdf2bc4 size 0x100 virtual true final false
 ::ArrayW<Org::BouncyCastle::Asn1::X509::CertificateList> GetCrls() ;

/// @brief Method ToAsn1Object addr 0xdf2cc4 size 0x12c virtual true final false
