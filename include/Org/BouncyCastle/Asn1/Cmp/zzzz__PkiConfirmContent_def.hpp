...
/// @brief Method GetInstance addr 0xded868 size 0x150 virtual false final false
static Org::BouncyCastle::Asn1::Cmp::PkiConfirmContent GetInstance(::bs_hook::Il2CppWrapperType obj) ;

// Ctor Parameters []
explicit PkiConfirmContent() ;

/// @brief Method .ctor addr 0xdededc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method ToAsn1Object addr 0xdedee4 size 0x58 virtual true final false
