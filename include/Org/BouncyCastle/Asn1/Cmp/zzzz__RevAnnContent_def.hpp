...
/// @brief Method .ctor addr 0xdf2198 size 0x15c virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;

/// @brief Method GetInstance addr 0xded6e0 size 0x188 virtual false final false
static Org::BouncyCastle::Asn1::Cmp::RevAnnContent GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method get_Status addr 0xdf22f4 size 0x8 virtual true final false
 Org::BouncyCastle::Asn1::Cmp::PkiStatusEncodable get_Status() ;

/// @brief Method get_CertID addr 0xdf22fc size 0x8 virtual true final false
 Org::BouncyCastle::Asn1::Crmf::CertId get_CertID() ;

/// @brief Method get_WillBeRevokedAt addr 0xdf2304 size 0x8 virtual true final false
 Org::BouncyCastle::Asn1::DerGeneralizedTime get_WillBeRevokedAt() ;

/// @brief Method get_BadSinceDate addr 0xdf230c size 0x8 virtual true final false
 Org::BouncyCastle::Asn1::DerGeneralizedTime get_BadSinceDate() ;

/// @brief Method get_CrlDetails addr 0xdf2314 size 0x8 virtual true final false
 Org::BouncyCastle::Asn1::X509::X509Extensions get_CrlDetails() ;

/// @brief Method ToAsn1Object addr 0xdf231c size 0x1cc virtual true final false
