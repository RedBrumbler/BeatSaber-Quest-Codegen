...
/// @brief Method .ctor addr 0x1138efc size 0x44 virtual false final false
 void _ctor(System::IO::Stream inStream, int32_t limit) ;

/// @brief Method SetEofOn00 addr 0x113d85c size 0x14 virtual false final false
 void SetEofOn00(bool eofOn00) ;

/// @brief Method CheckForEof addr 0x1148db8 size 0xa4 virtual false final false
 bool CheckForEof() ;

/// @brief Method Read addr 0x1148e5c size 0x104 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method ReadByte addr 0x1148f60 size 0x48 virtual true final false
 int32_t ReadByte() ;

/// @brief Method RequireByte addr 0x1148d50 size 0x68 virtual false final false
 int32_t RequireByte() ;
