...
/// @brief Method .ctor addr 0xef6550 size 0xa0 virtual false final false
...
/// @brief Method .ctor addr 0xef65f0 size 0xe8 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1Sequence seq) ;

/// @brief Method GetInstance addr 0xef60a8 size 0xa4 virtual false final false
static Org::BouncyCastle::Asn1::Icao::LdsVersionInfo GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetLdsVersion addr 0xef66d8 size 0x20 virtual true final false
 ::StringW GetLdsVersion() ;

/// @brief Method GetUnicodeVersion addr 0xef66f8 size 0x20 virtual true final false
 ::StringW GetUnicodeVersion() ;

/// @brief Method ToAsn1Object addr 0xef6718 size 0xf0 virtual true final false
