...
/// @brief Method GetInstance addr 0x11476a0 size 0xf0 virtual false final false
static Org::BouncyCastle::Asn1::DerUtcTime GetInstance(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetInstance addr 0x1147790 size 0x140 virtual false final false
...
/// @brief Method .ctor addr 0x11478d0 size 0x168 virtual false final false
...
/// @brief Method .ctor addr 0x1147a88 size 0xbc virtual false final false
...
/// @brief Method .ctor addr 0x113a014 size 0x34 virtual false final false
 void _ctor(::ArrayW<uint8_t> bytes) ;

/// @brief Method ToDateTime addr 0x1147a38 size 0x50 virtual false final false
 System::DateTime ToDateTime() ;

/// @brief Method ToAdjustedDateTime addr 0x1147fd0 size 0x50 virtual false final false
 System::DateTime ToAdjustedDateTime() ;

/// @brief Method ParseDateString addr 0x1147f18 size 0xb8 virtual false final false
 System::DateTime ParseDateString(::StringW dateStr, ::StringW formatStr) ;

/// @brief Method get_TimeString addr 0x1147b44 size 0x3d4 virtual false final false
 ::StringW get_TimeString() ;

/// @brief Method get_AdjustedTime addr 0x11480ac size 0x4 virtual false final false
 ::StringW get_AdjustedTime() ;

/// @brief Method get_AdjustedTimeString addr 0x1148020 size 0x8c virtual false final false
 ::StringW get_AdjustedTimeString() ;

/// @brief Method GetOctets addr 0x11480b0 size 0xc virtual false final false
 ::ArrayW<uint8_t> GetOctets() ;

/// @brief Method Encode addr 0x11480bc size 0x30 virtual true final false
 void Encode(Org::BouncyCastle::Asn1::DerOutputStream derOut) ;

/// @brief Method Asn1Equals addr 0x11480ec size 0xa0 virtual true final false
 bool Asn1Equals(Org::BouncyCastle::Asn1::Asn1Object asn1Object) ;

/// @brief Method Asn1GetHashCode addr 0x114818c size 0x1c virtual true final false
 int32_t Asn1GetHashCode() ;

/// @brief Method ToString addr 0x11481a8 size 0x8 virtual true final false
 ::StringW ToString() ;
