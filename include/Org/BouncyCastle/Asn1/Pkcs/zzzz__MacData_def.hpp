...
/// @brief Method GetInstance addr 0xf09b2c size 0x188 virtual false final false
...
/// @brief Method .ctor addr 0xf09cb4 size 0x1ac virtual false final false
...
/// @brief Method .ctor addr 0xf09e60 size 0xec virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::X509::DigestInfo digInfo, ::ArrayW<uint8_t> salt, int32_t iterationCount) ;

/// @brief Method get_Mac addr 0xf09f4c size 0x8 virtual false final false
 Org::BouncyCastle::Asn1::X509::DigestInfo get_Mac() ;

/// @brief Method GetSalt addr 0xf09f54 size 0x78 virtual false final false
 ::ArrayW<uint8_t> GetSalt() ;

/// @brief Method get_IterationCount addr 0xf09fcc size 0x8 virtual false final false
 Org::BouncyCastle::Math::BigInteger get_IterationCount() ;

/// @brief Method ToAsn1Object addr 0xf09fd4 size 0x1e4 virtual true final false
