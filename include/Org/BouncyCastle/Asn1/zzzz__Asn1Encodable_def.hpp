...
/// @brief Method GetEncoded addr 0xde6e6c size 0xb4 virtual false final false
 ::ArrayW<uint8_t> GetEncoded() ;

/// @brief Method GetEncoded addr 0xde6f20 size 0xf4 virtual false final false
 ::ArrayW<uint8_t> GetEncoded(::StringW encoding) ;

/// @brief Method GetDerEncoded addr 0xde7014 size 0xc0 virtual false final false
 ::ArrayW<uint8_t> GetDerEncoded() ;

/// @brief Method GetHashCode addr 0xde70d4 size 0x28 virtual true final true
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0xde7108 size 0x108 virtual true final true
...
/// @brief Method .ctor addr 0xde721c size 0x8 virtual false final false
 void _ctor() ;
