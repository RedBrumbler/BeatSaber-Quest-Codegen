...
/// @brief Method .ctor addr 0x1139218 size 0x28 virtual false final false
 void _ctor(Org::BouncyCastle::Asn1::Asn1StreamParser parser) ;

/// @brief Method GetOctetStream addr 0x1140420 size 0x6c virtual true final true
 System::IO::Stream GetOctetStream() ;

/// @brief Method ToAsn1Object addr 0x1139240 size 0x168 virtual true final true
