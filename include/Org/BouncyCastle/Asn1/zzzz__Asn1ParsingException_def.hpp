...
/// @brief Method .ctor addr 0x113ad60 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit Asn1ParsingException(::StringW message) ;

/// @brief Method .ctor addr 0x113ad68 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x113ad70 size 0x8 virtual false final false
