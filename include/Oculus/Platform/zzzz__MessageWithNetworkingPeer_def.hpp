...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 949 }), TypeDefinitionIndex(TypeDefinitionIndex(13473))}
...
/// @brief Method .ctor addr 0x25af3a4 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetNetworkingPeer addr 0x25b422c size 0x3c virtual true final false
 Oculus::Platform::Models::NetworkingPeer GetNetworkingPeer() ;

/// @brief Method GetDataFromMessage addr 0x25b4268 size 0xb0 virtual true final false
