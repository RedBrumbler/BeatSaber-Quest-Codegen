...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4461 }), TypeDefinitionIndex(TypeDefinitionIndex(13455)), TypeDefinitionIndex(TypeDefinitionIndex(13222))}
...
/// @brief Method .ctor addr 0x25b1f24 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetLivestreamingVideoStats addr 0x25b1f7c size 0x3c virtual true final false
 Oculus::Platform::Models::LivestreamingVideoStats GetLivestreamingVideoStats() ;

/// @brief Method GetDataFromMessage addr 0x25b1fb8 size 0x9c virtual true final false
