...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13449)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 945 })}
...
/// @brief Method .ctor addr 0x25ae744 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetLeaderboardEntryList addr 0x25b19e4 size 0x3c virtual true final false
 Oculus::Platform::Models::LeaderboardEntryList GetLeaderboardEntryList() ;

/// @brief Method GetDataFromMessage addr 0x25b1a20 size 0x9c virtual true final false
