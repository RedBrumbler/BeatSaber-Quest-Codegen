...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13367)), TypeDefinitionIndex(TypeDefinitionIndex(13366))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13366), inst: 2 })
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13366)), TypeDefinitionIndex(TypeDefinitionIndex(13367))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13366), inst: 99 })
// CS Name: Oculus.Platform.Request`1
