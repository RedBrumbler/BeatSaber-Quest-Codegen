...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4451 }), TypeDefinitionIndex(TypeDefinitionIndex(13437))}
...
/// @brief Method .ctor addr 0x25b1274 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetInstalledApplicationList addr 0x25b12cc size 0x3c virtual true final false
 Oculus::Platform::Models::InstalledApplicationList GetInstalledApplicationList() ;

/// @brief Method GetDataFromMessage addr 0x25b1308 size 0x9c virtual true final false
