...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13464)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4466 })}
...
/// @brief Method .ctor addr 0x25ae9ac size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetMatchmakingStats addr 0x25b22dc size 0x3c virtual true final false
 Oculus::Platform::Models::MatchmakingStats GetMatchmakingStats() ;

/// @brief Method GetDataFromMessage addr 0x25b2318 size 0x9c virtual true final false
