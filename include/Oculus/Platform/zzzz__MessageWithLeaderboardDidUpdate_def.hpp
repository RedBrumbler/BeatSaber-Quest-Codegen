...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 99 })}
...
/// @brief Method .ctor addr 0x25ae79c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetLeaderboardDidUpdate addr 0x25b4468 size 0x3c virtual true final false
 bool GetLeaderboardDidUpdate() ;

/// @brief Method GetDataFromMessage addr 0x25b44a4 size 0x5c virtual true final false
