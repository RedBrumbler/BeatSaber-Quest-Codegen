...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13402)), TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4431 })}
...
/// @brief Method .ctor addr 0x25adbec size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetAchievementProgressList addr 0x25afafc size 0x3c virtual true final false
 Oculus::Platform::Models::AchievementProgressList GetAchievementProgressList() ;

/// @brief Method GetDataFromMessage addr 0x25afb38 size 0x9c virtual true final false
