...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13420)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 1135 })}
...
/// @brief Method .ctor addr 0x25ae0bc size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetChallenge addr 0x25b07fc size 0x3c virtual true final false
 Oculus::Platform::Models::Challenge GetChallenge() ;

/// @brief Method GetDataFromMessage addr 0x25b0838 size 0x9c virtual true final false
