...
/// @brief Method Clear addr 0x25c69d0 size 0x148 virtual false final false
static Oculus::Platform::Request Clear() ;

/// @brief Method GetDestinations addr 0x25c6b18 size 0x15c virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::DestinationList> GetDestinations() ;

/// @brief Method Set addr 0x25c6c74 size 0x190 virtual false final false
static Oculus::Platform::Request Set(Oculus::Platform::RichPresenceOptions richPresenceOptions) ;

/// @brief Method GetNextDestinationListPage addr 0x25c6e5c size 0x1e0 virtual false final false
