...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13504)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4483 })}
...
/// @brief Method .ctor addr 0x25af29c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetUserCapabilityList addr 0x25b3e74 size 0x3c virtual true final false
 Oculus::Platform::Models::UserCapabilityList GetUserCapabilityList() ;

/// @brief Method GetDataFromMessage addr 0x25b3eb0 size 0x9c virtual true final false
