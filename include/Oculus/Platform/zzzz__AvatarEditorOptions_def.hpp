...
/// @brief Method .ctor addr 0x25835dc size 0x64 virtual false final false
 void _ctor() ;

/// @brief Method SetSourceOverride addr 0x25836a8 size 0x68 virtual false final false
 void SetSourceOverride(::StringW value) ;

/// @brief Method op_Explicit addr 0x25837b0 size 0x58 virtual false final false
static ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(Oculus::Platform::AvatarEditorOptions options) ;

/// @brief Method Finalize addr 0x2583808 size 0xd4 virtual true final false
 void Finalize() ;
