...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 948 }), TypeDefinitionIndex(TypeDefinitionIndex(13469))}
...
/// @brief Method .ctor addr 0x25aeab4 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetNetSyncSessionsChangedNotification addr 0x25b2694 size 0x3c virtual true final false
 Oculus::Platform::Models::NetSyncSessionsChangedNotification GetNetSyncSessionsChangedNotification() ;

/// @brief Method GetDataFromMessage addr 0x25b26d0 size 0x9c virtual true final false
