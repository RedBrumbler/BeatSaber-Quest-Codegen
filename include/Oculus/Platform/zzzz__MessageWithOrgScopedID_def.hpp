...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13474)), TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4471 })}
...
/// @brief Method .ctor addr 0x25aeb0c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetOrgScopedID addr 0x25b29cc size 0x3c virtual true final false
 Oculus::Platform::Models::OrgScopedID GetOrgScopedID() ;

/// @brief Method GetDataFromMessage addr 0x25b2a08 size 0x9c virtual true final false
