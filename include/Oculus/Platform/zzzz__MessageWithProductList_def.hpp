...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13483)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4476 })}
...
/// @brief Method .ctor addr 0x25aec6c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetProductList addr 0x25b2f8c size 0x3c virtual true final false
 Oculus::Platform::Models::ProductList GetProductList() ;

/// @brief Method GetDataFromMessage addr 0x25b2fc8 size 0x9c virtual true final false
