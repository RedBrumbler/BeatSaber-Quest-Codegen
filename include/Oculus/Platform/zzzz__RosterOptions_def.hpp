...
/// @brief Method .ctor addr 0x25c9b68 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method AddSuggestedUser addr 0x25c9bd0 size 0x6c virtual false final false
 void AddSuggestedUser(uint64_t userID) ;

/// @brief Method ClearSuggestedUsers addr 0x25c9c3c size 0x5c virtual false final false
 void ClearSuggestedUsers() ;

/// @brief Method op_Explicit addr 0x25c45e0 size 0x58 virtual false final false
static ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(Oculus::Platform::RosterOptions options) ;

/// @brief Method Finalize addr 0x25c9c98 size 0xd8 virtual true final false
 void Finalize() ;
