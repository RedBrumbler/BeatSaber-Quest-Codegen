...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::UserDataStoreUpdateResponse (Oculus::Platform::MessageWithUserDataStoreUpdateResponse::*)()>(&Oculus::Platform::MessageWithUserDataStoreUpdateResponse::GetUserDataStoreUpdateResponse)> {
  ...
  constexpr static std::size_t addrs = 0x25b3f4c;
...
// Ctor Parameters [CppParam { name: "c_message", ty: "::cordl_internals::intptr_t", modifiers: "", def_value: None }]
 Oculus::Platform::MessageWithUserDataStoreUpdateResponse::MessageWithUserDataStoreUpdateResponse(::cordl_internals::intptr_t c_message)  : Oculus::Platform::Message_1<Oculus::Platform::Models::UserDataStoreUpdateResponse>(THROW_UNLESS(::il2cpp_utils::New<MessageWithUserDataStoreUpdateResponse>(c_message))) {}
