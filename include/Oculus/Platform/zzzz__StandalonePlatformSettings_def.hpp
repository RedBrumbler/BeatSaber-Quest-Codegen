...
/// @brief Method get_OculusPlatformTestUserEmail addr 0x25ca164 size 0x48 virtual false final false
static ::StringW get_OculusPlatformTestUserEmail() ;

/// @brief Method set_OculusPlatformTestUserEmail addr 0x25ca1ac size 0x4 virtual false final false
static void set_OculusPlatformTestUserEmail(::StringW value) ;

/// @brief Method get_OculusPlatformTestUserPassword addr 0x25ca1b0 size 0x48 virtual false final false
static ::StringW get_OculusPlatformTestUserPassword() ;

/// @brief Method set_OculusPlatformTestUserPassword addr 0x25ca1f8 size 0x4 virtual false final false
static void set_OculusPlatformTestUserPassword(::StringW value) ;

/// @brief Method get_OculusPlatformTestUserAccessToken addr 0x25ca1fc size 0x48 virtual false final false
static ::StringW get_OculusPlatformTestUserAccessToken() ;

/// @brief Method set_OculusPlatformTestUserAccessToken addr 0x25ca244 size 0x4 virtual false final false
static void set_OculusPlatformTestUserAccessToken(::StringW value) ;

// Ctor Parameters []
explicit StandalonePlatformSettings() ;

/// @brief Method .ctor addr 0x25ca248 size 0x8 virtual false final false
 void _ctor() ;
