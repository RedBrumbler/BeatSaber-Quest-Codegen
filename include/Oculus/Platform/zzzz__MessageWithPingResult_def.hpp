...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 951 }), TypeDefinitionIndex(TypeDefinitionIndex(13480))}
...
/// @brief Method .ctor addr 0x25af3fc size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetPingResult addr 0x25b4318 size 0x3c virtual true final false
 Oculus::Platform::Models::PingResult GetPingResult() ;

/// @brief Method GetDataFromMessage addr 0x25b4354 size 0x114 virtual true final false
