...
/// @brief Method .ctor addr 0x25c9100 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method SetApiName addr 0x25c9168 size 0x6c virtual false final false
 void SetApiName(::StringW value) ;

/// @brief Method SetCurrentCapacity addr 0x25c91d4 size 0x6c virtual false final false
 void SetCurrentCapacity(uint32_t value) ;

/// @brief Method SetDeeplinkMessageOverride addr 0x25c9240 size 0x6c virtual false final false
 void SetDeeplinkMessageOverride(::StringW value) ;

/// @brief Method SetEndTime addr 0x25c92ac size 0x6c virtual false final false
 void SetEndTime(System::DateTime value) ;

/// @brief Method SetExtraContext addr 0x25c9318 size 0x6c virtual false final false
 void SetExtraContext(Oculus::Platform::RichPresenceExtraContext value) ;

/// @brief Method SetInstanceId addr 0x25c9384 size 0x6c virtual false final false
 void SetInstanceId(::StringW value) ;

/// @brief Method SetIsIdle addr 0x25c93f0 size 0x6c virtual false final false
 void SetIsIdle(bool value) ;

/// @brief Method SetIsJoinable addr 0x25c945c size 0x6c virtual false final false
 void SetIsJoinable(bool value) ;

/// @brief Method SetMaxCapacity addr 0x25c94c8 size 0x6c virtual false final false
 void SetMaxCapacity(uint32_t value) ;

/// @brief Method SetStartTime addr 0x25c9534 size 0x6c virtual false final false
 void SetStartTime(System::DateTime value) ;

/// @brief Method op_Explicit addr 0x25c6e04 size 0x58 virtual false final false
static ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(Oculus::Platform::RichPresenceOptions options) ;

/// @brief Method Finalize addr 0x25c95a0 size 0xd8 virtual true final false
 void Finalize() ;
