...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4452 }), TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13438))}
...
/// @brief Method .ctor addr 0x25ae534 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetInvitePanelResultInfo addr 0x25b13a4 size 0x3c virtual true final false
 Oculus::Platform::Models::InvitePanelResultInfo GetInvitePanelResultInfo() ;

/// @brief Method GetDataFromMessage addr 0x25b13e0 size 0x9c virtual true final false
