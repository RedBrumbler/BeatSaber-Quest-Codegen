...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4446 }), TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13424))}
...
/// @brief Method .ctor addr 0x25ae1c4 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetCloudStorageConflictMetadata addr 0x25b0a84 size 0x3c virtual true final false
 Oculus::Platform::Models::CloudStorageConflictMetadata GetCloudStorageConflictMetadata() ;

/// @brief Method GetDataFromMessage addr 0x25b0ac0 size 0x9c virtual true final false
