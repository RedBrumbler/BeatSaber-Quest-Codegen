...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 941 }), TypeDefinitionIndex(TypeDefinitionIndex(13433))}
...
/// @brief Method .ctor addr 0x25ae484 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetGroupPresenceJoinIntent addr 0x25b10c4 size 0x3c virtual true final false
 Oculus::Platform::Models::GroupPresenceJoinIntent GetGroupPresenceJoinIntent() ;

/// @brief Method GetDataFromMessage addr 0x25b1100 size 0x9c virtual true final false
