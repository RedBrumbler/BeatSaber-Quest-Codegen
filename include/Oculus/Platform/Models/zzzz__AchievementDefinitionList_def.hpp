...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13429), inst: 1129 }), TypeDefinitionIndex(TypeDefinitionIndex(13399)), TypeDefinitionIndex(TypeDefinitionIndex(13429))}
...
/// @brief Method .ctor addr 0x25cbb14 size 0x25c virtual false final false
