...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13430)), TypeDefinitionIndex(TypeDefinitionIndex(13429)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13429), inst: 1138 })}
...
/// @brief Method .ctor addr 0x25ce6b8 size 0x25c virtual false final false
