...
/// @brief Method .ctor addr 0x25d1948 size 0x30 virtual false final false
 void _ctor(uint64_t id, Oculus::Platform::PeerConnectionState state) ;

/// @brief Method get_ID addr 0x25d1978 size 0x8 virtual false final false
 uint64_t get_ID() ;

/// @brief Method set_ID addr 0x25d1980 size 0x8 virtual false final false
 void set_ID(uint64_t value) ;

/// @brief Method get_State addr 0x25d1988 size 0x8 virtual false final false
 Oculus::Platform::PeerConnectionState get_State() ;

/// @brief Method set_State addr 0x25d1990 size 0x8 virtual false final false
