...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::AchievementProgress::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::AchievementProgress::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x25cbd70;
...
constexpr ::StringW Oculus::Platform::Models::AchievementProgress::__get_Bitfield() const {
...
constexpr uint64_t Oculus::Platform::Models::AchievementProgress::__get_Count() const {
...
constexpr bool Oculus::Platform::Models::AchievementProgress::__get_IsUnlocked() const {
...
constexpr ::StringW Oculus::Platform::Models::AchievementProgress::__get_Name() const {
