...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13429)), TypeDefinitionIndex(TypeDefinitionIndex(13404)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13429), inst: 1131 })}
...
/// @brief Method .ctor addr 0x25cc490 size 0x25c virtual false final false
