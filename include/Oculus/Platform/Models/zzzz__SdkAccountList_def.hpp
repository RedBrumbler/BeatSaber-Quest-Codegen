...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13491)), TypeDefinitionIndex(TypeDefinitionIndex(13429)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13429), inst: 1150 })}
...
/// @brief Method .ctor addr 0x25d2e68 size 0x23c virtual false final false
