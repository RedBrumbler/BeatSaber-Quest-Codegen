...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Oculus::Platform::Models::Destination::*)(::cordl_internals::intptr_t)>(&Oculus::Platform::Models::Destination::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x25cc2d0;
...
// Ctor Parameters [CppParam { name: "o", ty: "::cordl_internals::intptr_t", modifiers: "", def_value: None }]
 Oculus::Platform::Models::Destination::Destination(::cordl_internals::intptr_t o)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<Destination>(o))) {}
