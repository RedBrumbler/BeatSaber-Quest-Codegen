...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13429)), TypeDefinitionIndex(TypeDefinitionIndex(13460)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13429), inst: 1144 })}
...
/// @brief Method .ctor addr 0x25d0940 size 0x23c virtual false final false
