...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13503)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13429), inst: 1154 }), TypeDefinitionIndex(TypeDefinitionIndex(13429))}
...
/// @brief Method .ctor addr 0x25d3788 size 0x25c virtual false final false
