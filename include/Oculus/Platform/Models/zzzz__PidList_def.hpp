...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13429)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13429), inst: 1147 }), TypeDefinitionIndex(TypeDefinitionIndex(13478))}
...
/// @brief Method .ctor addr 0x25d1e4c size 0x23c virtual false final false
