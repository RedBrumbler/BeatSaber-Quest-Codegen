...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13429), inst: 1153 }), TypeDefinitionIndex(TypeDefinitionIndex(13501)), TypeDefinitionIndex(TypeDefinitionIndex(13429))}
...
/// @brief Method .ctor addr 0x25d3480 size 0x25c virtual false final false
