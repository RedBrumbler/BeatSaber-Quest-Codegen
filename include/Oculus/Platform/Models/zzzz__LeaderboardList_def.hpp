...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13446)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13429), inst: 1140 }), TypeDefinitionIndex(TypeDefinitionIndex(13429))}
...
/// @brief Method .ctor addr 0x25cf394 size 0x25c virtual false final false
