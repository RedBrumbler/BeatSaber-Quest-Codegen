...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13429)), TypeDefinitionIndex(TypeDefinitionIndex(13497)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13429), inst: 1151 })}
...
/// @brief Method .ctor addr 0x25d28a0 size 0x23c virtual false final false
