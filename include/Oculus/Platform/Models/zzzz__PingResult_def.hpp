...
/// @brief Method .ctor addr 0x25d2088 size 0x3c virtual false final false
 void _ctor(uint64_t id, System::Nullable_1<uint64_t> pingTimeUsec) ;

/// @brief Method get_ID addr 0x25d20c4 size 0x8 virtual false final false
 uint64_t get_ID() ;

/// @brief Method set_ID addr 0x25d20cc size 0x8 virtual false final false
 void set_ID(uint64_t value) ;

/// @brief Method get_PingTimeUsec addr 0x25d20d4 size 0x6c virtual false final false
 uint64_t get_PingTimeUsec() ;

/// @brief Method get_IsTimeout addr 0x25d2140 size 0x44 virtual false final false
 bool get_IsTimeout() ;
