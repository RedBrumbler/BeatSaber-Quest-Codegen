...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13420)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13429), inst: 1135 }), TypeDefinitionIndex(TypeDefinitionIndex(13429))}
...
/// @brief Method .ctor addr 0x25cdb3c size 0x27c virtual false final false
