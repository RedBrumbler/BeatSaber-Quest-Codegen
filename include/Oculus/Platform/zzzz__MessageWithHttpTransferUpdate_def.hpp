...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 943 }), TypeDefinitionIndex(TypeDefinitionIndex(13435))}
...
/// @brief Method .ctor addr 0x25af4ac size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetHttpTransferUpdate addr 0x25b4704 size 0x3c virtual true final false
 Oculus::Platform::Models::HttpTransferUpdate GetHttpTransferUpdate() ;

/// @brief Method GetDataFromMessage addr 0x25b4740 size 0x9c virtual true final false
