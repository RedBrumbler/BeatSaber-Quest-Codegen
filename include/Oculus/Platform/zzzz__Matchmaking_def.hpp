...
/// @brief Method .ctor addr 0x25b9d0c size 0x10 virtual false final false
...
/// @brief Method ToUnmanaged addr 0x25b83d4 size 0x31c virtual false final false
 ::cordl_internals::intptr_t ToUnmanaged() ;

// Ctor Parameters []
explicit Oculus__Platform__Matchmaking__CustomQuery() ;

/// @brief Method .ctor addr 0x25b9d04 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method ReportResultsInsecure addr 0x25b7d9c size 0x31c virtual false final false
...
/// @brief Method GetStats addr 0x25b80b8 size 0x178 virtual false final false
...
/// @brief Method Browse addr 0x25b8230 size 0x1a4 virtual false final false
...
/// @brief Method Browse2 addr 0x25b86f0 size 0x1b0 virtual false final false
...
/// @brief Method Cancel addr 0x25b88a0 size 0x15c virtual false final false
static Oculus::Platform::Request Cancel(::StringW pool, ::StringW requestHash) ;

/// @brief Method Cancel addr 0x25b89fc size 0x144 virtual false final false
static Oculus::Platform::Request Cancel() ;

/// @brief Method CreateAndEnqueueRoom addr 0x25b8b40 size 0x1bc virtual false final false
...
/// @brief Method CreateAndEnqueueRoom2 addr 0x25b8cfc size 0x1b0 virtual false final false
...
/// @brief Method CreateRoom addr 0x25b8eac size 0x178 virtual false final false
...
/// @brief Method CreateRoom2 addr 0x25b9024 size 0x1b0 virtual false final false
...
/// @brief Method Enqueue addr 0x25b91d4 size 0x1a4 virtual false final false
...
/// @brief Method Enqueue2 addr 0x25b9378 size 0x1b0 virtual false final false
...
/// @brief Method EnqueueRoom addr 0x25b9528 size 0x1a4 virtual false final false
...
/// @brief Method EnqueueRoom2 addr 0x25b96cc size 0x1b0 virtual false final false
...
/// @brief Method GetAdminSnapshot addr 0x25b987c size 0x158 virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::MatchmakingAdminSnapshot> GetAdminSnapshot() ;

/// @brief Method JoinRoom addr 0x25b99d4 size 0x170 virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::Room> JoinRoom(uint64_t roomID, bool subscribeToUpdates) ;

/// @brief Method StartMatch addr 0x25b9b44 size 0x14c virtual false final false
static Oculus::Platform::Request StartMatch(uint64_t roomID) ;

/// @brief Method SetMatchFoundNotificationCallback addr 0x25b9c90 size 0x74 virtual false final false
