...
/// @brief Method .ctor addr 0x2582258 size 0x64 virtual false final false
 void _ctor() ;

/// @brief Method SetDeveloperDefinedContext addr 0x2582324 size 0x70 virtual false final false
 void SetDeveloperDefinedContext(::StringW key, ::StringW value) ;

/// @brief Method ClearDeveloperDefinedContext addr 0x2582454 size 0x58 virtual false final false
 void ClearDeveloperDefinedContext() ;

/// @brief Method SetObjectType addr 0x2582528 size 0x68 virtual false final false
 void SetObjectType(::StringW value) ;

/// @brief Method SetReportType addr 0x2582630 size 0x68 virtual false final false
 void SetReportType(Oculus::Platform::AbuseReportType value) ;

/// @brief Method AddSuggestedUser addr 0x258271c size 0x68 virtual false final false
 void AddSuggestedUser(uint64_t userID) ;

/// @brief Method ClearSuggestedUsers addr 0x2582808 size 0x58 virtual false final false
 void ClearSuggestedUsers() ;

/// @brief Method SetVideoMode addr 0x25828dc size 0x68 virtual false final false
 void SetVideoMode(Oculus::Platform::AbuseReportVideoMode value) ;

/// @brief Method op_Explicit addr 0x25829c8 size 0x58 virtual false final false
...
/// @brief Method Finalize addr 0x2582a20 size 0xd4 virtual true final false
 void Finalize() ;
