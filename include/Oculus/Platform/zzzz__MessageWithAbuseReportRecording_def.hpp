...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4429 }), TypeDefinitionIndex(TypeDefinitionIndex(13398)), TypeDefinitionIndex(TypeDefinitionIndex(13222))}
...
/// @brief Method .ctor addr 0x25af8f4 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetAbuseReportRecording addr 0x25af94c size 0x3c virtual true final false
 Oculus::Platform::Models::AbuseReportRecording GetAbuseReportRecording() ;

/// @brief Method GetDataFromMessage addr 0x25af988 size 0x9c virtual true final false
