...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 1152 }), TypeDefinitionIndex(TypeDefinitionIndex(13499)), TypeDefinitionIndex(TypeDefinitionIndex(13222))}
...
/// @brief Method .ctor addr 0x25af194 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetUser addr 0x25b3bec size 0x3c virtual true final false
 Oculus::Platform::Models::User GetUser() ;

/// @brief Method GetDataFromMessage addr 0x25b3c28 size 0x9c virtual true final false
