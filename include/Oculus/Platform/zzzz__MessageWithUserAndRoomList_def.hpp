...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13502)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 956 })}
...
/// @brief Method .ctor addr 0x25af1ec size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetUserAndRoomList addr 0x25b3cc4 size 0x3c virtual true final false
 Oculus::Platform::Models::UserAndRoomList GetUserAndRoomList() ;

/// @brief Method GetDataFromMessage addr 0x25b3d00 size 0x9c virtual true final false
