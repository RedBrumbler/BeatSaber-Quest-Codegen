...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4458 }), TypeDefinitionIndex(TypeDefinitionIndex(13451)), TypeDefinitionIndex(TypeDefinitionIndex(13222))}
...
/// @brief Method .ctor addr 0x25b1abc size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetLinkedAccountList addr 0x25b1b14 size 0x3c virtual true final false
 Oculus::Platform::Models::LinkedAccountList GetLinkedAccountList() ;

/// @brief Method GetDataFromMessage addr 0x25b1b50 size 0x9c virtual true final false
