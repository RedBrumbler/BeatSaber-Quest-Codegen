...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4462 }), TypeDefinitionIndex(TypeDefinitionIndex(13456)), TypeDefinitionIndex(TypeDefinitionIndex(13222))}
...
/// @brief Method .ctor addr 0x25ae84c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetMatchmakingAdminSnapshot addr 0x25b2054 size 0x3c virtual true final false
 Oculus::Platform::Models::MatchmakingAdminSnapshot GetMatchmakingAdminSnapshot() ;

/// @brief Method GetDataFromMessage addr 0x25b2090 size 0x9c virtual true final false
