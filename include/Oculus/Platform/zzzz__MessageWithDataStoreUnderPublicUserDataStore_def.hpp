...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4428 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3809), inst: 586 }), TypeDefinitionIndex(TypeDefinitionIndex(3809))}
...
/// @brief Method .ctor addr 0x25ae3d4 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetDataStore addr 0x25b0f54 size 0x3c virtual true final false
 System::Collections::Generic::Dictionary_2<::StringW,::StringW> GetDataStore() ;

/// @brief Method GetDataFromMessage addr 0x25b0f90 size 0x5c virtual true final false
