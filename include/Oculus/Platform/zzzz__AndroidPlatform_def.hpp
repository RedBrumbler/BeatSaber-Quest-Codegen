...
/// @brief Method Initialize addr 0x2582b70 size 0xb0 virtual false final false
 bool Initialize(::StringW appId) ;

/// @brief Method AsyncInitialize addr 0x2582cb8 size 0x108 virtual false final false
...
/// @brief Method .ctor addr 0x2582e54 size 0x8 virtual false final false
 void _ctor() ;
