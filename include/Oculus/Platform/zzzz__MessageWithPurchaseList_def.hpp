...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 952 }), TypeDefinitionIndex(TypeDefinitionIndex(13485))}
...
/// @brief Method .ctor addr 0x25aed1c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetPurchaseList addr 0x25b313c size 0x3c virtual true final false
 Oculus::Platform::Models::PurchaseList GetPurchaseList() ;

/// @brief Method GetDataFromMessage addr 0x25b3178 size 0x9c virtual true final false
