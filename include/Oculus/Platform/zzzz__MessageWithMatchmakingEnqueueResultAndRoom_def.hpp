...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13463)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4465 })}
...
/// @brief Method .ctor addr 0x25ae954 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetMatchmakingEnqueueResultAndRoom addr 0x25b2204 size 0x3c virtual true final false
 Oculus::Platform::Models::MatchmakingEnqueueResultAndRoom GetMatchmakingEnqueueResultAndRoom() ;

/// @brief Method GetDataFromMessage addr 0x25b2240 size 0x9c virtual true final false
