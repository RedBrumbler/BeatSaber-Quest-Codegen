...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4436 }), TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13409))}
...
/// @brief Method .ctor addr 0x25addfc size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetAssetFileDeleteResult addr 0x25b000c size 0x3c virtual true final false
 Oculus::Platform::Models::AssetFileDeleteResult GetAssetFileDeleteResult() ;

/// @brief Method GetDataFromMessage addr 0x25b0048 size 0x9c virtual true final false
