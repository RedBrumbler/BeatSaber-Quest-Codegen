...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4439 }), TypeDefinitionIndex(TypeDefinitionIndex(13413))}
...
/// @brief Method .ctor addr 0x25adf5c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetAvatarEditorResult addr 0x25b036c size 0x3c virtual true final false
 Oculus::Platform::Models::AvatarEditorResult GetAvatarEditorResult() ;

/// @brief Method GetDataFromMessage addr 0x25b03a8 size 0x9c virtual true final false
