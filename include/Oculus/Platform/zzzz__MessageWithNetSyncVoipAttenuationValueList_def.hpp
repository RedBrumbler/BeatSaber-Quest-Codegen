...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13472)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4470 }), TypeDefinitionIndex(TypeDefinitionIndex(13222))}
...
/// @brief Method .ctor addr 0x25b289c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetNetSyncVoipAttenuationValueList addr 0x25b28f4 size 0x3c virtual true final false
 Oculus::Platform::Models::NetSyncVoipAttenuationValueList GetNetSyncVoipAttenuationValueList() ;

/// @brief Method GetDataFromMessage addr 0x25b2930 size 0x9c virtual true final false
