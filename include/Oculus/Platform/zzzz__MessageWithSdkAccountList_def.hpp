...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4480 }), TypeDefinitionIndex(TypeDefinitionIndex(13492))}
...
/// @brief Method .ctor addr 0x25aefdc size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetSdkAccountList addr 0x25b37fc size 0x3c virtual true final false
 Oculus::Platform::Models::SdkAccountList GetSdkAccountList() ;

/// @brief Method GetDataFromMessage addr 0x25b3838 size 0x9c virtual true final false
