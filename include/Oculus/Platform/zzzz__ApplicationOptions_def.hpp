...
/// @brief Method .ctor addr 0x2582e5c size 0x64 virtual false final false
 void _ctor() ;

/// @brief Method SetDeeplinkMessage addr 0x2582f28 size 0x68 virtual false final false
 void SetDeeplinkMessage(::StringW value) ;

/// @brief Method SetDestinationApiName addr 0x2583030 size 0x68 virtual false final false
 void SetDestinationApiName(::StringW value) ;

/// @brief Method SetLobbySessionId addr 0x2583138 size 0x68 virtual false final false
 void SetLobbySessionId(::StringW value) ;

/// @brief Method SetMatchSessionId addr 0x2583240 size 0x68 virtual false final false
 void SetMatchSessionId(::StringW value) ;

/// @brief Method SetRoomId addr 0x2583348 size 0x68 virtual false final false
 void SetRoomId(uint64_t value) ;

/// @brief Method op_Explicit addr 0x2583434 size 0x58 virtual false final false
static ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(Oculus::Platform::ApplicationOptions options) ;

/// @brief Method Finalize addr 0x258348c size 0xd4 virtual true final false
 void Finalize() ;
