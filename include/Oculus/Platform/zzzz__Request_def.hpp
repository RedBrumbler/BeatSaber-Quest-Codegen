...
/// @brief Method .ctor addr 0x25c3bb4 size 0x28 virtual false final false
 void _ctor(uint64_t requestID) ;

/// @brief Method get_RequestID addr 0x25c8fa4 size 0x8 virtual false final false
 uint64_t get_RequestID() ;

/// @brief Method set_RequestID addr 0x25c8fac size 0x8 virtual false final false
 void set_RequestID(uint64_t value) ;

/// @brief Method OnComplete addr 0x25c8fb4 size 0x70 virtual false final false
 Oculus::Platform::Request OnComplete(Oculus::Platform::Oculus__Platform__Message__Callback callback) ;

/// @brief Method HandleMessage addr 0x25c9024 size 0x6c virtual true final false
 void HandleMessage(Oculus::Platform::Message msg) ;

/// @brief Method RunCallbacks addr 0x25c9090 size 0x70 virtual false final false
