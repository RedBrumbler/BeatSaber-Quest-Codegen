...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13412)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 940 }), TypeDefinitionIndex(TypeDefinitionIndex(13222))}
...
/// @brief Method .ctor addr 0x25adf04 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetAssetFileDownloadUpdate addr 0x25b0294 size 0x3c virtual true final false
 Oculus::Platform::Models::AssetFileDownloadUpdate GetAssetFileDownloadUpdate() ;

/// @brief Method GetDataFromMessage addr 0x25b02d0 size 0x9c virtual true final false
