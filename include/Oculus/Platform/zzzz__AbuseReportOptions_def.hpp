...
// Ctor Parameters []
explicit AbuseReportOptions() ;

/// @brief Method .ctor addr 0x2581e0c size 0x64 virtual false final false
 void _ctor() ;

/// @brief Method SetPreventPeopleChooser addr 0x2581ed8 size 0x68 virtual false final false
 void SetPreventPeopleChooser(bool value) ;

/// @brief Method SetReportType addr 0x2581fc4 size 0x68 virtual false final false
 void SetReportType(Oculus::Platform::AbuseReportType value) ;

/// @brief Method op_Explicit addr 0x25820b0 size 0x58 virtual false final false
static ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(Oculus::Platform::AbuseReportOptions options) ;

/// @brief Method Finalize addr 0x2582108 size 0xd4 virtual true final false
 void Finalize() ;
