...
/// @brief Method .ctor addr 0x25b4d74 size 0xb0 virtual false final false
 void _ctor(::cordl_internals::intptr_t packetHandle) ;

/// @brief Method ReadBytes addr 0x25b4e24 size 0x144 virtual false final false
 uint64_t ReadBytes(::ArrayW<uint8_t> destination) ;

/// @brief Method get_SenderID addr 0x25b4f68 size 0x58 virtual false final false
 uint64_t get_SenderID() ;

/// @brief Method get_Size addr 0x25b4fc0 size 0x8 virtual false final false
 uint64_t get_Size() ;

/// @brief Method get_Policy addr 0x25b4fc8 size 0x58 virtual false final false
 Oculus::Platform::SendPolicy get_Policy() ;

/// @brief Method Finalize addr 0x25b5020 size 0x94 virtual true final false
 void Finalize() ;

/// @brief Method Dispose addr 0x25b50b4 size 0x88 virtual true final true
 void Dispose() ;
