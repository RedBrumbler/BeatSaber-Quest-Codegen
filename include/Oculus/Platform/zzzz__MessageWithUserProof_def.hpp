...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13506)), TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4485 })}
...
/// @brief Method .ctor addr 0x25af34c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetUserProof addr 0x25b4024 size 0x3c virtual true final false
 Oculus::Platform::Models::UserProof GetUserProof() ;

/// @brief Method GetDataFromMessage addr 0x25b4060 size 0x9c virtual true final false
