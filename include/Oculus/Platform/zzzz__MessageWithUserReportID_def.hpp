...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4486 }), TypeDefinitionIndex(TypeDefinitionIndex(13507))}
...
/// @brief Method .ctor addr 0x25b40fc size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetUserReportID addr 0x25b4154 size 0x3c virtual true final false
 Oculus::Platform::Models::UserReportID GetUserReportID() ;

/// @brief Method GetDataFromMessage addr 0x25b4190 size 0x9c virtual true final false
