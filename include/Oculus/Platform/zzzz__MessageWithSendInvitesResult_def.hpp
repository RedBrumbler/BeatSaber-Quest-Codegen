...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4481 }), TypeDefinitionIndex(TypeDefinitionIndex(13493))}
...
/// @brief Method .ctor addr 0x25af034 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetSendInvitesResult addr 0x25b38d4 size 0x3c virtual true final false
 Oculus::Platform::Models::SendInvitesResult GetSendInvitesResult() ;

/// @brief Method GetDataFromMessage addr 0x25b3910 size 0x9c virtual true final false
