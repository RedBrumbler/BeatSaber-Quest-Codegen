...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4477 }), TypeDefinitionIndex(TypeDefinitionIndex(13486)), TypeDefinitionIndex(TypeDefinitionIndex(13222))}
...
/// @brief Method .ctor addr 0x25aed74 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetRejoinDialogResult addr 0x25b3214 size 0x3c virtual true final false
 Oculus::Platform::Models::RejoinDialogResult GetRejoinDialogResult() ;

/// @brief Method GetDataFromMessage addr 0x25b3250 size 0x9c virtual true final false
