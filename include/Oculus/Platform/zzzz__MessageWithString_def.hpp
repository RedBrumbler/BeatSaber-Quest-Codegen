...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 380 }), TypeDefinitionIndex(TypeDefinitionIndex(13222))}
...
/// @brief Method .ctor addr 0x25af0e4 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetString addr 0x25b3a84 size 0x3c virtual true final false
 ::StringW GetString() ;

/// @brief Method GetDataFromMessage addr 0x25b3ac0 size 0x54 virtual true final false
