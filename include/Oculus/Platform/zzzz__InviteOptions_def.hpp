...
/// @brief Method .ctor addr 0x25aacf4 size 0x64 virtual false final false
 void _ctor() ;

/// @brief Method AddSuggestedUser addr 0x25aad58 size 0x68 virtual false final false
 void AddSuggestedUser(uint64_t userID) ;

/// @brief Method ClearSuggestedUsers addr 0x25aadc0 size 0x58 virtual false final false
 void ClearSuggestedUsers() ;

/// @brief Method op_Explicit addr 0x25aae18 size 0x58 virtual false final false
static ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(Oculus::Platform::InviteOptions options) ;

/// @brief Method Finalize addr 0x25aae70 size 0xd4 virtual true final false
 void Finalize() ;
