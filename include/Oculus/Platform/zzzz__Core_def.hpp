...
/// @brief Method IsInitialized addr 0x25b513c size 0x58 virtual false final false
static bool IsInitialized() ;

/// @brief Method ForceInitialized addr 0x25b5194 size 0x5c virtual false final false
static void ForceInitialized() ;

/// @brief Method getAppID addr 0x25b51f0 size 0x1a4 virtual false final false
static ::StringW getAppID(::StringW appId) ;

/// @brief Method AsyncInitialize addr 0x25b53c0 size 0x2cc virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::PlatformInitialize> AsyncInitialize(::StringW appId) ;

/// @brief Method AsyncInitialize addr 0x25b568c size 0x260 virtual false final false
...
/// @brief Method Initialize addr 0x25b58ec size 0x30c virtual false final false
static void Initialize(::StringW appId) ;

/// @brief Method GetAppIDFromConfig addr 0x25b5394 size 0x2c virtual false final false
static ::StringW GetAppIDFromConfig() ;

// Ctor Parameters []
explicit Core() ;

/// @brief Method .ctor addr 0x25b5bf8 size 0x8 virtual false final false
 void _ctor() ;
