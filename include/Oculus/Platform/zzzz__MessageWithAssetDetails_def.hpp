...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 1132 }), TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13407))}
...
/// @brief Method .ctor addr 0x25add4c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetAssetDetails addr 0x25afe5c size 0x3c virtual true final false
 Oculus::Platform::Models::AssetDetails GetAssetDetails() ;

/// @brief Method GetDataFromMessage addr 0x25afe98 size 0x9c virtual true final false
