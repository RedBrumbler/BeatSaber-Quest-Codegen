...
/// @brief Method .ctor addr 0x25b4aac size 0x64 virtual false final false
 void _ctor() ;

/// @brief Method SetVoipGroup addr 0x25b4b10 size 0x68 virtual false final false
 void SetVoipGroup(::StringW value) ;

/// @brief Method SetVoipStreamDefault addr 0x25b4b78 size 0x68 virtual false final false
 void SetVoipStreamDefault(Oculus::Platform::NetSyncVoipStreamMode value) ;

/// @brief Method SetZoneId addr 0x25b4be0 size 0x68 virtual false final false
 void SetZoneId(::StringW value) ;

/// @brief Method op_Explicit addr 0x25b4c48 size 0x58 virtual false final false
static ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(Oculus::Platform::NetSyncOptions options) ;

/// @brief Method Finalize addr 0x25b4ca0 size 0xd4 virtual true final false
 void Finalize() ;
