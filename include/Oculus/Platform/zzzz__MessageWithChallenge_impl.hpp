...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Oculus::Platform::Models::Challenge (Oculus::Platform::MessageWithChallenge::*)()>(&Oculus::Platform::MessageWithChallenge::GetChallenge)> {
  ...
  constexpr static std::size_t addrs = 0x25b07fc;
...
// Ctor Parameters [CppParam { name: "c_message", ty: "::cordl_internals::intptr_t", modifiers: "", def_value: None }]
 Oculus::Platform::MessageWithChallenge::MessageWithChallenge(::cordl_internals::intptr_t c_message)  : Oculus::Platform::Message_1<Oculus::Platform::Models::Challenge>(THROW_UNLESS(::il2cpp_utils::New<MessageWithChallenge>(c_message))) {}
