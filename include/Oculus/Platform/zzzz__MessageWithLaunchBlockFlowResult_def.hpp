...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4453 }), TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13440))}
...
/// @brief Method .ctor addr 0x25ae58c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetLaunchBlockFlowResult addr 0x25b147c size 0x3c virtual true final false
 Oculus::Platform::Models::LaunchBlockFlowResult GetLaunchBlockFlowResult() ;

/// @brief Method GetDataFromMessage addr 0x25b14b8 size 0x9c virtual true final false
