...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4479 }), TypeDefinitionIndex(TypeDefinitionIndex(13488))}
...
/// @brief Method .ctor addr 0x25aeed4 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetRoomList addr 0x25b3574 size 0x3c virtual true final false
 Oculus::Platform::Models::RoomList GetRoomList() ;

/// @brief Method GetDataFromMessage addr 0x25b35b0 size 0x9c virtual true final false
