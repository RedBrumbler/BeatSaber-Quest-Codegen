...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 1149 }), TypeDefinitionIndex(TypeDefinitionIndex(13484))}
...
/// @brief Method .ctor addr 0x25aecc4 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetPurchase addr 0x25b3064 size 0x3c virtual true final false
 Oculus::Platform::Models::Purchase GetPurchase() ;

/// @brief Method GetDataFromMessage addr 0x25b30a0 size 0x9c virtual true final false
