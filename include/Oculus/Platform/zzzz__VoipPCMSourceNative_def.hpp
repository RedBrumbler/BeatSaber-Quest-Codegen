...
/// @brief Method GetPCM addr 0x25cb3c4 size 0xb4 virtual true final true
 int32_t GetPCM(::ArrayW<float_t> dest, int32_t length) ;

/// @brief Method SetSenderID addr 0x25cb478 size 0x8 virtual true final true
 void SetSenderID(uint64_t senderID) ;

/// @brief Method PeekSizeElements addr 0x25cb480 size 0x94 virtual true final true
 int32_t PeekSizeElements() ;

/// @brief Method Update addr 0x25cb514 size 0x4 virtual true final true
 void Update() ;

// Ctor Parameters []
explicit VoipPCMSourceNative() ;

/// @brief Method .ctor addr 0x25ca868 size 0x8 virtual false final false
 void _ctor() ;
