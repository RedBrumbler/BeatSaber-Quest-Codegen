...
/// @brief Method GetLaunchDetails addr 0x25b5c64 size 0x90 virtual false final false
static Oculus::Platform::Models::LaunchDetails GetLaunchDetails() ;

/// @brief Method LogDeeplinkResult addr 0x25b5cf4 size 0x64 virtual false final false
static void LogDeeplinkResult(::StringW trackingID, Oculus::Platform::LaunchResult result) ;

/// @brief Method SetLaunchIntentChangedNotificationCallback addr 0x25b5d58 size 0x74 virtual false final false
