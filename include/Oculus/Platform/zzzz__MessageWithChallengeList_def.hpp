...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13421)), TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4445 })}
...
/// @brief Method .ctor addr 0x25ae114 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetChallengeList addr 0x25b08d4 size 0x3c virtual true final false
 Oculus::Platform::Models::ChallengeList GetChallengeList() ;

/// @brief Method GetDataFromMessage addr 0x25b0910 size 0x9c virtual true final false
