...
/// @brief Method .ctor addr 0x25b48b4 size 0x64 virtual false final false
 void _ctor() ;

/// @brief Method SetErrorKey addr 0x25b4918 size 0x68 virtual false final false
 void SetErrorKey(Oculus::Platform::MultiplayerErrorErrorKey value) ;

/// @brief Method op_Explicit addr 0x25b4980 size 0x58 virtual false final false
static ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(Oculus::Platform::MultiplayerErrorOptions options) ;

/// @brief Method Finalize addr 0x25b49d8 size 0xd4 virtual true final false
 void Finalize() ;
