...
/// @brief Method get_AppID addr 0x25c8d24 size 0x1c virtual false final false
static ::StringW get_AppID() ;

/// @brief Method set_AppID addr 0x25c8e64 size 0x20 virtual false final false
static void set_AppID(::StringW value) ;

/// @brief Method get_MobileAppID addr 0x25c8e84 size 0x1c virtual false final false
static ::StringW get_MobileAppID() ;

/// @brief Method set_MobileAppID addr 0x25c8ea0 size 0x20 virtual false final false
static void set_MobileAppID(::StringW value) ;

/// @brief Method get_UseStandalonePlatform addr 0x25c8ec0 size 0x1c virtual false final false
static bool get_UseStandalonePlatform() ;

/// @brief Method set_UseStandalonePlatform addr 0x25c8edc size 0x24 virtual false final false
static void set_UseStandalonePlatform(bool value) ;

/// @brief Method get_Instance addr 0x25c8d40 size 0x124 virtual false final false
static Oculus::Platform::PlatformSettings get_Instance() ;

/// @brief Method set_Instance addr 0x25c8f00 size 0x4c virtual false final false
static void set_Instance(Oculus::Platform::PlatformSettings value) ;

// Ctor Parameters []
explicit PlatformSettings() ;

/// @brief Method .ctor addr 0x25c8f4c size 0x58 virtual false final false
 void _ctor() ;
