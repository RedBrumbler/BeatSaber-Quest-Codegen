...
/// @brief Method .ctor addr 0x25aa3bc size 0x64 virtual false final false
 void _ctor() ;

/// @brief Method SetDescription addr 0x25aa420 size 0x68 virtual false final false
 void SetDescription(::StringW value) ;

/// @brief Method SetEndDate addr 0x25aa488 size 0x68 virtual false final false
 void SetEndDate(System::DateTime value) ;

/// @brief Method SetIncludeActiveChallenges addr 0x25aa4f0 size 0x68 virtual false final false
 void SetIncludeActiveChallenges(bool value) ;

/// @brief Method SetIncludeFutureChallenges addr 0x25aa558 size 0x68 virtual false final false
 void SetIncludeFutureChallenges(bool value) ;

/// @brief Method SetIncludePastChallenges addr 0x25aa5c0 size 0x68 virtual false final false
 void SetIncludePastChallenges(bool value) ;

/// @brief Method SetLeaderboardName addr 0x25aa628 size 0x68 virtual false final false
 void SetLeaderboardName(::StringW value) ;

/// @brief Method SetStartDate addr 0x25aa690 size 0x68 virtual false final false
 void SetStartDate(System::DateTime value) ;

/// @brief Method SetTitle addr 0x25aa6f8 size 0x68 virtual false final false
 void SetTitle(::StringW value) ;

/// @brief Method SetViewerFilter addr 0x25aa760 size 0x68 virtual false final false
 void SetViewerFilter(Oculus::Platform::ChallengeViewerFilter value) ;

/// @brief Method SetVisibility addr 0x25aa7c8 size 0x68 virtual false final false
 void SetVisibility(Oculus::Platform::ChallengeVisibility value) ;

/// @brief Method op_Explicit addr 0x25aa830 size 0x58 virtual false final false
static ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(Oculus::Platform::ChallengeOptions options) ;

/// @brief Method Finalize addr 0x25aa888 size 0xd4 virtual true final false
 void Finalize() ;
