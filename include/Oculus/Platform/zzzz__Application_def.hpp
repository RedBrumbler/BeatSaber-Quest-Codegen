...
/// @brief Method GetVersion addr 0x25c032c size 0x158 virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::ApplicationVersion> GetVersion() ;

/// @brief Method LaunchOtherApp addr 0x25c0484 size 0x1b0 virtual false final false
