...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13477)), TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 950 })}
...
/// @brief Method .ctor addr 0x25aebbc size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetPartyUpdateNotification addr 0x25b2ddc size 0x3c virtual true final false
 Oculus::Platform::Models::PartyUpdateNotification GetPartyUpdateNotification() ;

/// @brief Method GetDataFromMessage addr 0x25b2e18 size 0x9c virtual true final false
