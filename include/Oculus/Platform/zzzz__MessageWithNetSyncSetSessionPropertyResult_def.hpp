...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13470)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4469 })}
...
/// @brief Method .ctor addr 0x25b276c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetNetSyncSetSessionPropertyResult addr 0x25b27c4 size 0x3c virtual true final false
 Oculus::Platform::Models::NetSyncSetSessionPropertyResult GetNetSyncSetSessionPropertyResult() ;

/// @brief Method GetDataFromMessage addr 0x25b2800 size 0x9c virtual true final false
