...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13447)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4457 })}
...
/// @brief Method .ctor addr 0x25ae6ec size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetLeaderboardList addr 0x25b190c size 0x3c virtual true final false
 Oculus::Platform::Models::LeaderboardList GetLeaderboardList() ;

/// @brief Method GetDataFromMessage addr 0x25b1948 size 0x9c virtual true final false
