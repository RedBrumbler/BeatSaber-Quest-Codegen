...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 942 }), TypeDefinitionIndex(TypeDefinitionIndex(13434)), TypeDefinitionIndex(TypeDefinitionIndex(13222))}
...
/// @brief Method .ctor addr 0x25ae4dc size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetGroupPresenceLeaveIntent addr 0x25b119c size 0x3c virtual true final false
 Oculus::Platform::Models::GroupPresenceLeaveIntent GetGroupPresenceLeaveIntent() ;

/// @brief Method GetDataFromMessage addr 0x25b11d8 size 0x9c virtual true final false
