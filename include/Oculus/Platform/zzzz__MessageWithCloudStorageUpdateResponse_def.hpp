...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13428)), TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4449 })}
...
/// @brief Method .ctor addr 0x25ae324 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetCloudStorageUpdateResponse addr 0x25b0de4 size 0x3c virtual true final false
 Oculus::Platform::Models::CloudStorageUpdateResponse GetCloudStorageUpdateResponse() ;

/// @brief Method GetDataFromMessage addr 0x25b0e20 size 0x9c virtual true final false
