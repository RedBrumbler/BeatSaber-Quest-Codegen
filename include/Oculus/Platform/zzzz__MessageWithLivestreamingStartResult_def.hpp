...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4460 }), TypeDefinitionIndex(TypeDefinitionIndex(13453))}
...
/// @brief Method .ctor addr 0x25b1d1c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetLivestreamingStartResult addr 0x25b1d74 size 0x3c virtual true final false
 Oculus::Platform::Models::LivestreamingStartResult GetLivestreamingStartResult() ;

/// @brief Method GetDataFromMessage addr 0x25b1db0 size 0x9c virtual true final false
