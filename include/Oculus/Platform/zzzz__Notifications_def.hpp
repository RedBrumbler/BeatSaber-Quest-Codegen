...
/// @brief Method GetRoomInviteNotifications addr 0x25c6374 size 0x15c virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::RoomInviteNotificationList> GetRoomInviteNotifications() ;

/// @brief Method MarkAsRead addr 0x25c64d0 size 0x150 virtual false final false
static Oculus::Platform::Request MarkAsRead(uint64_t notificationID) ;

/// @brief Method GetNextRoomInviteNotificationListPage addr 0x25c6620 size 0x1e0 virtual false final false
