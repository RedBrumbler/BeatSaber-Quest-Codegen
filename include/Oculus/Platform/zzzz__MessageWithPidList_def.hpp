...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4474 }), TypeDefinitionIndex(TypeDefinitionIndex(13479)), TypeDefinitionIndex(TypeDefinitionIndex(13222))}
...
/// @brief Method .ctor addr 0x25aec14 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetPidList addr 0x25b2eb4 size 0x3c virtual true final false
 Oculus::Platform::Models::PidList GetPidList() ;

/// @brief Method GetDataFromMessage addr 0x25b2ef0 size 0x9c virtual true final false
