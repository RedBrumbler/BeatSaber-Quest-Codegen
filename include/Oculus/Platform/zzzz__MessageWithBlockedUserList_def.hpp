...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4440 }), TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13415))}
...
/// @brief Method .ctor addr 0x25adfb4 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetBlockedUserList addr 0x25b0444 size 0x3c virtual true final false
 Oculus::Platform::Models::BlockedUserList GetBlockedUserList() ;

/// @brief Method GetDataFromMessage addr 0x25b0480 size 0x9c virtual true final false
