...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4455 }), TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13444))}
...
/// @brief Method .ctor addr 0x25b1704 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetLaunchReportFlowResult addr 0x25b175c size 0x3c virtual true final false
 Oculus::Platform::Models::LaunchReportFlowResult GetLaunchReportFlowResult() ;

/// @brief Method GetDataFromMessage addr 0x25b1798 size 0x9c virtual true final false
