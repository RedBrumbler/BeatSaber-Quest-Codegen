...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13505)), TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4484 })}
...
/// @brief Method .ctor addr 0x25af2f4 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetUserDataStoreUpdateResponse addr 0x25b3f4c size 0x3c virtual true final false
 Oculus::Platform::Models::UserDataStoreUpdateResponse GetUserDataStoreUpdateResponse() ;

/// @brief Method GetDataFromMessage addr 0x25b3f88 size 0x9c virtual true final false
