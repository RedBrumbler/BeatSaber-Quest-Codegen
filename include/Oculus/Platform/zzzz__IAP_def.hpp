...
/// @brief Method ConsumePurchase addr 0x25c52e0 size 0x150 virtual false final false
static Oculus::Platform::Request ConsumePurchase(::StringW sku) ;

/// @brief Method GetProductsBySKU addr 0x25c5430 size 0x178 virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::ProductList> GetProductsBySKU(::ArrayW<::StringW> skus) ;

/// @brief Method GetViewerPurchases addr 0x25c55a8 size 0x15c virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::PurchaseList> GetViewerPurchases() ;

/// @brief Method GetViewerPurchasesDurableCache addr 0x25c5704 size 0x15c virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::PurchaseList> GetViewerPurchasesDurableCache() ;

/// @brief Method LaunchCheckoutFlow addr 0x25c5860 size 0x1bc virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::Purchase> LaunchCheckoutFlow(::StringW sku) ;

/// @brief Method GetNextProductListPage addr 0x25c5a1c size 0x1e0 virtual false final false
...
/// @brief Method GetNextPurchaseListPage addr 0x25c5bfc size 0x1e0 virtual false final false
