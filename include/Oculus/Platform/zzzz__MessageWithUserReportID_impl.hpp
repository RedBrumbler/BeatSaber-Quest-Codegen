...
// Ctor Parameters [CppParam { name: "c_message", ty: "::cordl_internals::intptr_t", modifiers: "", def_value: None }]
 Oculus::Platform::MessageWithUserReportID::MessageWithUserReportID(::cordl_internals::intptr_t c_message)  : Oculus::Platform::Message_1<Oculus::Platform::Models::UserReportID>(THROW_UNLESS(::il2cpp_utils::New<MessageWithUserReportID>(c_message))) {}
