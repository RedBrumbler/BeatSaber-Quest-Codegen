...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4478 }), TypeDefinitionIndex(TypeDefinitionIndex(13490)), TypeDefinitionIndex(TypeDefinitionIndex(13222))}
...
/// @brief Method .ctor addr 0x25aef84 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetRoomInviteNotificationList addr 0x25b3724 size 0x3c virtual true final false
 Oculus::Platform::Models::RoomInviteNotificationList GetRoomInviteNotificationList() ;

/// @brief Method GetDataFromMessage addr 0x25b3760 size 0x9c virtual true final false
