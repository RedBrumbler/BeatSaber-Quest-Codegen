...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13466)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 947 }), TypeDefinitionIndex(TypeDefinitionIndex(13222))}
...
/// @brief Method .ctor addr 0x25aea5c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetNetSyncConnection addr 0x25b248c size 0x3c virtual true final false
 Oculus::Platform::Models::NetSyncConnection GetNetSyncConnection() ;

/// @brief Method GetDataFromMessage addr 0x25b24c8 size 0x9c virtual true final false
