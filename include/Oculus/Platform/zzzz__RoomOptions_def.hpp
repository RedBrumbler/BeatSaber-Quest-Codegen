...
/// @brief Method .ctor addr 0x25c9678 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method SetDataStore addr 0x25c96e0 size 0x74 virtual false final false
 void SetDataStore(::StringW key, ::StringW value) ;

/// @brief Method ClearDataStore addr 0x25c9754 size 0x5c virtual false final false
 void ClearDataStore() ;

/// @brief Method SetExcludeRecentlyMet addr 0x25c97b0 size 0x6c virtual false final false
 void SetExcludeRecentlyMet(bool value) ;

/// @brief Method SetMaxUserResults addr 0x25c981c size 0x6c virtual false final false
 void SetMaxUserResults(uint32_t value) ;

/// @brief Method SetOrdering addr 0x25c9888 size 0x6c virtual false final false
 void SetOrdering(Oculus::Platform::UserOrdering value) ;

/// @brief Method SetRecentlyMetTimeWindow addr 0x25c98f4 size 0x6c virtual false final false
 void SetRecentlyMetTimeWindow(Oculus::Platform::TimeWindow value) ;

/// @brief Method SetRoomId addr 0x25c9960 size 0x6c virtual false final false
 void SetRoomId(uint64_t value) ;

/// @brief Method SetTurnOffUpdates addr 0x25c99cc size 0x6c virtual false final false
 void SetTurnOffUpdates(bool value) ;

/// @brief Method op_Explicit addr 0x25c9a38 size 0x58 virtual false final false
static ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(Oculus::Platform::RoomOptions options) ;

/// @brief Method Finalize addr 0x25c9a90 size 0xd8 virtual true final false
 void Finalize() ;
