...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13423)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4444 }), TypeDefinitionIndex(TypeDefinitionIndex(13222))}
...
/// @brief Method .ctor addr 0x25ae16c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetChallengeEntryList addr 0x25b09ac size 0x3c virtual true final false
 Oculus::Platform::Models::ChallengeEntryList GetChallengeEntryList() ;

/// @brief Method GetDataFromMessage addr 0x25b09e8 size 0x9c virtual true final false
