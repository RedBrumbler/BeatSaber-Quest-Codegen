...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13445)), TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4456 })}
...
/// @brief Method .ctor addr 0x25ae694 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetLaunchUnblockFlowResult addr 0x25b1834 size 0x3c virtual true final false
 Oculus::Platform::Models::LaunchUnblockFlowResult GetLaunchUnblockFlowResult() ;

/// @brief Method GetDataFromMessage addr 0x25b1870 size 0x9c virtual true final false
