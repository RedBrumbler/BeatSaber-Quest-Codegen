...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13411)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4438 })}
...
/// @brief Method .ctor addr 0x25adeac size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetAssetFileDownloadResult addr 0x25b01bc size 0x3c virtual true final false
 Oculus::Platform::Models::AssetFileDownloadResult GetAssetFileDownloadResult() ;

/// @brief Method GetDataFromMessage addr 0x25b01f8 size 0x9c virtual true final false
