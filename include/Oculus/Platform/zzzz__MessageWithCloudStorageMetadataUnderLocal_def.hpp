...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 1137 }), TypeDefinitionIndex(TypeDefinitionIndex(13426))}
...
/// @brief Method .ctor addr 0x25ae274 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetCloudStorageMetadata addr 0x25b0c34 size 0x3c virtual true final false
 Oculus::Platform::Models::CloudStorageMetadata GetCloudStorageMetadata() ;

/// @brief Method GetDataFromMessage addr 0x25b0c70 size 0x9c virtual true final false
