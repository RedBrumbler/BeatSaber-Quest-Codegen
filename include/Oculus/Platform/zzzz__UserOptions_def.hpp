...
/// @brief Method .ctor addr 0x25c8bf8 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method SetMaxUsers addr 0x25ca250 size 0x6c virtual false final false
 void SetMaxUsers(uint32_t value) ;

/// @brief Method AddServiceProvider addr 0x25c8c60 size 0x6c virtual false final false
 void AddServiceProvider(Oculus::Platform::ServiceProvider value) ;

/// @brief Method ClearServiceProviders addr 0x25ca2bc size 0x5c virtual false final false
 void ClearServiceProviders() ;

/// @brief Method SetTimeWindow addr 0x25ca318 size 0x6c virtual false final false
 void SetTimeWindow(Oculus::Platform::TimeWindow value) ;

/// @brief Method op_Explicit addr 0x25c8ccc size 0x58 virtual false final false
static ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(Oculus::Platform::UserOptions options) ;

/// @brief Method Finalize addr 0x25ca384 size 0xd8 virtual true final false
 void Finalize() ;
