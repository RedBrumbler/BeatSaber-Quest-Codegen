...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4441 }), TypeDefinitionIndex(TypeDefinitionIndex(13416))}
...
/// @brief Method .ctor addr 0x25ae00c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetCalApplicationFinalized addr 0x25b051c size 0x3c virtual true final false
 Oculus::Platform::Models::CalApplicationFinalized GetCalApplicationFinalized() ;

/// @brief Method GetDataFromMessage addr 0x25b0558 size 0x9c virtual true final false
