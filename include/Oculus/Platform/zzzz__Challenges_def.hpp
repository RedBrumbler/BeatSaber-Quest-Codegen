...
/// @brief Method GetNextEntries addr 0x25bb62c size 0x17c virtual false final false
...
/// @brief Method GetPreviousEntries addr 0x25bb7a8 size 0x17c virtual false final false
...
/// @brief Method GetNextChallenges addr 0x25bb924 size 0x17c virtual false final false
...
/// @brief Method GetPreviousChallenges addr 0x25bbaa0 size 0x17c virtual false final false
...
/// @brief Method Create addr 0x25bbc1c size 0x1b0 virtual false final false
...
/// @brief Method DeclineInvite addr 0x25bbdcc size 0x160 virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::Challenge> DeclineInvite(uint64_t challengeID) ;

/// @brief Method Delete addr 0x25bbf2c size 0x14c virtual false final false
static Oculus::Platform::Request Delete(uint64_t challengeID) ;

/// @brief Method Get addr 0x25bc078 size 0x160 virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::Challenge> Get(uint64_t challengeID) ;

/// @brief Method GetEntries addr 0x25bc1d8 size 0x188 virtual false final false
...
/// @brief Method GetEntriesAfterRank addr 0x25bc360 size 0x178 virtual false final false
...
/// @brief Method GetEntriesByIds addr 0x25bc4d8 size 0x19c virtual false final false
...
/// @brief Method GetList addr 0x25bc674 size 0x1b0 virtual false final false
...
/// @brief Method Join addr 0x25bc824 size 0x160 virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::Challenge> Join(uint64_t challengeID) ;

/// @brief Method Leave addr 0x25bc984 size 0x160 virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::Challenge> Leave(uint64_t challengeID) ;

/// @brief Method UpdateInfo addr 0x25bcae4 size 0x1b0 virtual false final false
