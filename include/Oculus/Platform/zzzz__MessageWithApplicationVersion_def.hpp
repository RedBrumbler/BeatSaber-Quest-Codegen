...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13406)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4434 })}
...
/// @brief Method .ctor addr 0x25adcf4 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetApplicationVersion addr 0x25afd84 size 0x3c virtual true final false
 Oculus::Platform::Models::ApplicationVersion GetApplicationVersion() ;

/// @brief Method GetDataFromMessage addr 0x25afdc0 size 0x9c virtual true final false
