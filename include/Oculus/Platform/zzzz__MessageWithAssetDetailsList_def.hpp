...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13408)), TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4435 })}
...
/// @brief Method .ctor addr 0x25adda4 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetAssetDetailsList addr 0x25aff34 size 0x3c virtual true final false
 Oculus::Platform::Models::AssetDetailsList GetAssetDetailsList() ;

/// @brief Method GetDataFromMessage addr 0x25aff70 size 0x9c virtual true final false
