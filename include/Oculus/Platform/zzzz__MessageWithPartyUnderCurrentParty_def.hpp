...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13475)), TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4472 })}
...
/// @brief Method .ctor addr 0x25aeb64 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetParty addr 0x25b2bd4 size 0x3c virtual true final false
 Oculus::Platform::Models::Party GetParty() ;

/// @brief Method GetDataFromMessage addr 0x25b2c10 size 0x9c virtual true final false
