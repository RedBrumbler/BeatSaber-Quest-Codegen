...
/// @brief Method ReportRequestHandled addr 0x25bf3dc size 0x14c virtual false final false
static Oculus::Platform::Request ReportRequestHandled(Oculus::Platform::ReportRequestResponse response) ;

/// @brief Method SetReportButtonPressedNotificationCallback addr 0x25bf528 size 0x74 virtual false final false
