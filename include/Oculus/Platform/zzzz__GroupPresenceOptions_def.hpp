...
/// @brief Method .ctor addr 0x25aa95c size 0x64 virtual false final false
 void _ctor() ;

/// @brief Method SetDeeplinkMessageOverride addr 0x25aa9c0 size 0x68 virtual false final false
 void SetDeeplinkMessageOverride(::StringW value) ;

/// @brief Method SetDestinationApiName addr 0x25aaa28 size 0x68 virtual false final false
 void SetDestinationApiName(::StringW value) ;

/// @brief Method SetIsJoinable addr 0x25aaa90 size 0x68 virtual false final false
 void SetIsJoinable(bool value) ;

/// @brief Method SetLobbySessionId addr 0x25aaaf8 size 0x68 virtual false final false
 void SetLobbySessionId(::StringW value) ;

/// @brief Method SetMatchSessionId addr 0x25aab60 size 0x68 virtual false final false
 void SetMatchSessionId(::StringW value) ;

/// @brief Method op_Explicit addr 0x25aabc8 size 0x58 virtual false final false
static ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(Oculus::Platform::GroupPresenceOptions options) ;

/// @brief Method Finalize addr 0x25aac20 size 0xd4 virtual true final false
 void Finalize() ;
