...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13462)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4464 })}
...
/// @brief Method .ctor addr 0x25ae8fc size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetMatchmakingEnqueueResult addr 0x25b212c size 0x3c virtual true final false
 Oculus::Platform::Models::MatchmakingEnqueueResult GetMatchmakingEnqueueResult() ;

/// @brief Method GetDataFromMessage addr 0x25b2168 size 0x9c virtual true final false
