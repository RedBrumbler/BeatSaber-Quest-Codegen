...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13454)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 946 })}
...
/// @brief Method .ctor addr 0x25ae7f4 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetLivestreamingStatus addr 0x25b1e4c size 0x3c virtual true final false
 Oculus::Platform::Models::LivestreamingStatus GetLivestreamingStatus() ;

/// @brief Method GetDataFromMessage addr 0x25b1e88 size 0x9c virtual true final false
