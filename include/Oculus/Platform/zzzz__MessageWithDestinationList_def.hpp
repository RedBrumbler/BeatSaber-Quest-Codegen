...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4450 }), TypeDefinitionIndex(TypeDefinitionIndex(13431))}
...
/// @brief Method .ctor addr 0x25ae42c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetDestinationList addr 0x25b0fec size 0x3c virtual true final false
 Oculus::Platform::Models::DestinationList GetDestinationList() ;

/// @brief Method GetDataFromMessage addr 0x25b1028 size 0x9c virtual true final false
