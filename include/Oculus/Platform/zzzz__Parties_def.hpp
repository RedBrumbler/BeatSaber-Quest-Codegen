...
/// @brief Method GetCurrent addr 0x25c6800 size 0x15c virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::Party> GetCurrent() ;

/// @brief Method SetPartyUpdateNotificationCallback addr 0x25c695c size 0x74 virtual false final false
