...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 957 }), TypeDefinitionIndex(TypeDefinitionIndex(13222)), TypeDefinitionIndex(TypeDefinitionIndex(13500))}
...
/// @brief Method .ctor addr 0x25af244 size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetUserList addr 0x25b3d9c size 0x3c virtual true final false
 Oculus::Platform::Models::UserList GetUserList() ;

/// @brief Method GetDataFromMessage addr 0x25b3dd8 size 0x9c virtual true final false
