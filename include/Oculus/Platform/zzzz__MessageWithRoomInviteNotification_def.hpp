...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 954 }), TypeDefinitionIndex(TypeDefinitionIndex(13489))}
...
/// @brief Method .ctor addr 0x25aef2c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetRoomInviteNotification addr 0x25b364c size 0x3c virtual true final false
 Oculus::Platform::Models::RoomInviteNotification GetRoomInviteNotification() ;

/// @brief Method GetDataFromMessage addr 0x25b3688 size 0x9c virtual true final false
