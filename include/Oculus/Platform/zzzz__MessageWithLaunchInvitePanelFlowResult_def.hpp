...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13222)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 944 }), TypeDefinitionIndex(TypeDefinitionIndex(13443))}
...
/// @brief Method .ctor addr 0x25ae63c size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetLaunchInvitePanelFlowResult addr 0x25b162c size 0x3c virtual true final false
 Oculus::Platform::Models::LaunchInvitePanelFlowResult GetLaunchInvitePanelFlowResult() ;

/// @brief Method GetDataFromMessage addr 0x25b1668 size 0x9c virtual true final false
