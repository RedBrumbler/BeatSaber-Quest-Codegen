...
/// @brief Method Clear addr 0x25c3bdc size 0x148 virtual false final false
static Oculus::Platform::Request Clear() ;

/// @brief Method GetInvitableUsers addr 0x25c3d24 size 0x178 virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::UserList> GetInvitableUsers(Oculus::Platform::InviteOptions options) ;

/// @brief Method GetSentInvites addr 0x25c3e9c size 0x15c virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::ApplicationInviteList> GetSentInvites() ;

/// @brief Method LaunchInvitePanel addr 0x25c3ff8 size 0x178 virtual false final false
...
/// @brief Method LaunchMultiplayerErrorDialog addr 0x25c4170 size 0x164 virtual false final false
static Oculus::Platform::Request LaunchMultiplayerErrorDialog(Oculus::Platform::MultiplayerErrorOptions options) ;

/// @brief Method LaunchRejoinDialog addr 0x25c42d4 size 0x17c virtual false final false
...
/// @brief Method LaunchRosterPanel addr 0x25c4450 size 0x190 virtual false final false
static Oculus::Platform::Request LaunchRosterPanel(Oculus::Platform::RosterOptions options) ;

/// @brief Method SendInvites addr 0x25c4638 size 0x178 virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::SendInvitesResult> SendInvites(::ArrayW<uint64_t> userIDs) ;

/// @brief Method Set addr 0x25c47b0 size 0x164 virtual false final false
static Oculus::Platform::Request Set(Oculus::Platform::GroupPresenceOptions groupPresenceOptions) ;

/// @brief Method SetDeeplinkMessageOverride addr 0x25c4914 size 0x150 virtual false final false
static Oculus::Platform::Request SetDeeplinkMessageOverride(::StringW deeplink_message) ;

/// @brief Method SetDestination addr 0x25c4a64 size 0x150 virtual false final false
static Oculus::Platform::Request SetDestination(::StringW api_name) ;

/// @brief Method SetIsJoinable addr 0x25c4bb4 size 0x150 virtual false final false
static Oculus::Platform::Request SetIsJoinable(bool is_joinable) ;

/// @brief Method SetLobbySession addr 0x25c4d04 size 0x150 virtual false final false
static Oculus::Platform::Request SetLobbySession(::StringW id) ;

/// @brief Method SetMatchSession addr 0x25c4e54 size 0x150 virtual false final false
static Oculus::Platform::Request SetMatchSession(::StringW id) ;

/// @brief Method SetInvitationsSentNotificationCallback addr 0x25c4fa4 size 0x74 virtual false final false
...
/// @brief Method SetJoinIntentReceivedNotificationCallback addr 0x25c5018 size 0x74 virtual false final false
...
/// @brief Method SetLeaveIntentReceivedNotificationCallback addr 0x25c508c size 0x74 virtual false final false
...
/// @brief Method GetNextApplicationInviteListPage addr 0x25c5100 size 0x1e0 virtual false final false
