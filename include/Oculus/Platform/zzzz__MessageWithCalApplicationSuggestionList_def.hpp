...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13222), inst: 4443 }), TypeDefinitionIndex(TypeDefinitionIndex(13419)), TypeDefinitionIndex(TypeDefinitionIndex(13222))}
...
/// @brief Method .ctor addr 0x25b06cc size 0x58 virtual false final false
 void _ctor(::cordl_internals::intptr_t c_message) ;

/// @brief Method GetCalApplicationSuggestionList addr 0x25b0724 size 0x3c virtual true final false
 Oculus::Platform::Models::CalApplicationSuggestionList GetCalApplicationSuggestionList() ;

/// @brief Method GetDataFromMessage addr 0x25b0760 size 0x9c virtual true final false
