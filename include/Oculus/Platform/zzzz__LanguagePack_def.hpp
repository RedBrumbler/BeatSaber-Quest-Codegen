...
/// @brief Method GetCurrent addr 0x25c5ddc size 0x15c virtual false final false
static Oculus::Platform::Request_1<Oculus::Platform::Models::AssetDetails> GetCurrent() ;

/// @brief Method SetCurrent addr 0x25c5f38 size 0x164 virtual false final false
