...
/// @brief Method .ctor addr 0x28ae998 size 0x40 virtual false final false
...
/// @brief Method .ctor addr 0x28ae9d8 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x28adfbc size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_uxmlChildElementsDescription addr 0x28aea88 size 0x70 virtual true final false
...
/// @brief Method Init addr 0x28aeb2c size 0x1a8 virtual true final false
 void Init(UnityEngine::UIElements::VisualElement ve, UnityEngine::UIElements::IUxmlAttributes bag, UnityEngine::UIElements::CreationContext cc) ;

// Ctor Parameters []
explicit UIToolkitUtilities__Controls__Table__UxmlTraits() ;

/// @brief Method .ctor addr 0x28aecd4 size 0x170 virtual false final false
 void _ctor() ;
...
/// @brief Method get_showHeader addr 0x28adba4 size 0x8 virtual false final false
 bool get_showHeader() ;

/// @brief Method set_showHeader addr 0x28adbac size 0xc virtual false final false
 void set_showHeader(bool value) ;

/// @brief Method get_showFooter addr 0x28adbb8 size 0x8 virtual false final false
 bool get_showFooter() ;

/// @brief Method set_showFooter addr 0x28adbc0 size 0xc virtual false final false
 void set_showFooter(bool value) ;

/// @brief Method get_numRows addr 0x28adbcc size 0x8 virtual false final false
 int32_t get_numRows() ;

/// @brief Method set_numRows addr 0x28adbd4 size 0x8 virtual false final false
 void set_numRows(int32_t value) ;

/// @brief Method get_initialized addr 0x28adbdc size 0x8 virtual false final false
 bool get_initialized() ;

/// @brief Method set_initialized addr 0x28adbe4 size 0xc virtual false final false
 void set_initialized(bool value) ;

// Ctor Parameters []
explicit Table() ;

/// @brief Method .ctor addr 0x28adbf0 size 0x1e4 virtual false final false
 void _ctor() ;

/// @brief Method Initialize addr 0x28addd4 size 0x1e8 virtual false final false
...
/// @brief Method BuildTable addr 0x28adfc4 size 0x80 virtual true final false
 void BuildTable() ;

/// @brief Method ClearTable addr 0x28ae2f4 size 0x14 virtual false final false
 void ClearTable() ;

/// @brief Method CreateRowSkeleton addr 0x28ae308 size 0x480 virtual false final false
 UnityEngine::UIElements::VisualElement CreateRowSkeleton() ;

/// @brief Method CreateHeaderRow addr 0x28ae788 size 0x210 virtual true final false
 UnityEngine::UIElements::VisualElement CreateHeaderRow() ;

/// @brief Method CreateRow addr 0x28ae044 size 0x17c virtual false final false
 UnityEngine::UIElements::VisualElement CreateRow(int32_t rowIndex) ;

/// @brief Method CreateFooterRow addr 0x28ae1c0 size 0x134 virtual false final false
...
namespace UIToolkitUtilities::Controls {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15967)), TypeDefinitionIndex(TypeDefinitionIndex(15968)), TypeDefinitionIndex(TypeDefinitionIndex(7108)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7108), inst: 5111 })}
...
/// @brief Method .ctor addr 0x28aea40 size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x28aeaf8 size 0x34 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x28aee44 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x28aee48 size 0x18 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.UIElements.UxmlChildElementDescription>.get_Current addr 0x28aee60 size 0x8 virtual true final true
...
/// @brief Method System.Collections.IEnumerator.Reset addr 0x28aee68 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x28aeea8 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.UIElements.UxmlChildElementDescription>.GetEnumerator addr 0x28aeeb0 size 0x98 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x28aef48 size 0x4 virtual true final true
