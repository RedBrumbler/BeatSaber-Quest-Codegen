...
namespace Zenject {
template<typename TParam1,typename TParam2,typename TValue>
class Zenject__PlaceholderFactory_3___get_ParamTypes_d__2;
}
namespace Zenject {
...
namespace Zenject {
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TValue>
class Zenject__PlaceholderFactory_3___get_ParamTypes_d__2<TParam1,System::Int32Enum,TValue>;
}
namespace Zenject {
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TValue>
class Zenject__PlaceholderFactory_3___get_ParamTypes_d__2<TParam1,TParam2,TValue>;
}
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10968), inst: 5162 })
// CS Name: Zenject.PlaceholderFactory`3::<get_ParamTypes>d__2
class CORDL_TYPE Zenject__PlaceholderFactory_3___get_ParamTypes_d__2<TParam1,TParam2,TValue> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~Zenject__PlaceholderFactory_3___get_ParamTypes_d__2() = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__PlaceholderFactory_3___get_ParamTypes_d__2", modifiers: " const&", def_value: None }]
constexpr Zenject__PlaceholderFactory_3___get_ParamTypes_d__2(Zenject__PlaceholderFactory_3___get_ParamTypes_d__2 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__PlaceholderFactory_3___get_ParamTypes_d__2", modifiers: "&&", def_value: None }]
constexpr Zenject__PlaceholderFactory_3___get_ParamTypes_d__2(Zenject__PlaceholderFactory_3___get_ParamTypes_d__2&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Zenject__PlaceholderFactory_3___get_ParamTypes_d__2(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr Zenject__PlaceholderFactory_3___get_ParamTypes_d__2& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Zenject__PlaceholderFactory_3___get_ParamTypes_d__2& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Zenject__PlaceholderFactory_3___get_ParamTypes_d__2& operator=(Zenject__PlaceholderFactory_3___get_ParamTypes_d__2&& o) noexcept = default;
  constexpr Zenject__PlaceholderFactory_3___get_ParamTypes_d__2& operator=(Zenject__PlaceholderFactory_3___get_ParamTypes_d__2 const& o) noexcept = default;
...
explicit Zenject__PlaceholderFactory_3___get_ParamTypes_d__2(int32_t __1__state) ;
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10968))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10968), inst: 5963 })
// CS Name: Zenject.PlaceholderFactory`3::<get_ParamTypes>d__2
class CORDL_TYPE Zenject__PlaceholderFactory_3___get_ParamTypes_d__2<TParam1,System::Int32Enum,TValue> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief Convert operator to System::Collections::Generic::IEnumerable_1<System::Type>
constexpr operator  System::Collections::Generic::IEnumerable_1<System::Type>() const noexcept;
...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10987), inst: 4675 }), TypeDefinitionIndex(TypeDefinitionIndex(10969)), TypeDefinitionIndex(TypeDefinitionIndex(10987))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10969), inst: 5162 })
...
public:
// Declarations
using _get_ParamTypes_d__2 = Zenject::Zenject__PlaceholderFactory_3___get_ParamTypes_d__2<TParam1, TParam2, TValue>;
...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10969)), TypeDefinitionIndex(TypeDefinitionIndex(10987)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10987), inst: 4675 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10969), inst: 5963 })
// CS Name: Zenject.PlaceholderFactory`3
class CORDL_TYPE PlaceholderFactory_3<TParam1,System::Int32Enum,TValue> : public Zenject::PlaceholderFactoryBase_1<TValue> {
public:
// Declarations
using _get_ParamTypes_d__2 = Zenject::Zenject__PlaceholderFactory_3___get_ParamTypes_d__2<TParam1, System::Int32Enum, TValue>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(Zenject::Zenject__PlaceholderFactory_3___get_ParamTypes_d__2, "Zenject", "PlaceholderFactory`3/<get_ParamTypes>d__2");
