...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11019)), TypeDefinitionIndex(TypeDefinitionIndex(11001)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11001), inst: 3382 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11019), inst: 5162 })
