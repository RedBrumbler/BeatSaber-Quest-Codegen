...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TParam4,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10717)), TypeDefinitionIndex(TypeDefinitionIndex(10814)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10717), inst: 1749 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10814), inst: 5946 })
