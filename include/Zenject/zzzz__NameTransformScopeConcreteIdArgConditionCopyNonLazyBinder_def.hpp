...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10880))}
...
/// @brief Method .ctor addr 0x2d850b0 size 0x28 virtual false final false
 void _ctor(Zenject::BindInfo bindInfo, Zenject::GameObjectCreationParameters gameObjectInfo) ;

/// @brief Method WithGameObjectName addr 0x2d92d50 size 0x1c virtual false final false
