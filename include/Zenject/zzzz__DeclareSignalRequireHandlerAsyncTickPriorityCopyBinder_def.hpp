...
/// @brief Method .ctor addr 0x2d7b010 size 0x24 virtual false final false
 void _ctor(Zenject::SignalDeclarationBindInfo signalBindInfo) ;

/// @brief Method RequireSubscriber addr 0x2d7b050 size 0x20 virtual false final false
 Zenject::DeclareSignalAsyncTickPriorityCopyBinder RequireSubscriber() ;

/// @brief Method OptionalSubscriber addr 0x2d7b070 size 0x1c virtual false final false
 Zenject::DeclareSignalAsyncTickPriorityCopyBinder OptionalSubscriber() ;

/// @brief Method OptionalSubscriberWithWarning addr 0x2d7b08c size 0x20 virtual false final false
