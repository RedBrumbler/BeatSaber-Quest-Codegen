...
/// @brief Method .ctor addr 0x2d7cf38 size 0xc virtual false final false
 void _ctor(Zenject::BindingId signalId, ::bs_hook::Il2CppWrapperType callback) ;

/// @brief Method get_SignalId addr 0x2d7cf44 size 0xc virtual false final false
 Zenject::BindingId get_SignalId() ;

/// @brief Method get_Callback addr 0x2d7cf50 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_Callback() ;

/// @brief Method GetHashCode addr 0x2d7cf58 size 0x48 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2d7cfa0 size 0x90 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType that) ;

/// @brief Method Equals addr 0x2d7d030 size 0xb0 virtual true final true
 bool Equals(Zenject::SignalSubscriptionId that) ;

/// @brief Method op_Equality addr 0x2d7d0e0 size 0x30 virtual false final false
static bool op_Equality(Zenject::SignalSubscriptionId left, Zenject::SignalSubscriptionId right) ;

/// @brief Method op_Inequality addr 0x2d7d110 size 0x34 virtual false final false
