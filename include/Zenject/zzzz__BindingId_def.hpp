...
/// @brief Method .ctor addr 0x2d9e0b8 size 0x8 virtual false final false
 void _ctor(System::Type type, ::bs_hook::Il2CppWrapperType identifier) ;

/// @brief Method get_Type addr 0x2daeeac size 0x8 virtual false final false
 System::Type get_Type() ;

/// @brief Method set_Type addr 0x2daeeb4 size 0x8 virtual false final false
 void set_Type(System::Type value) ;

/// @brief Method get_Identifier addr 0x2daeebc size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_Identifier() ;

/// @brief Method set_Identifier addr 0x2daeec4 size 0x8 virtual false final false
 void set_Identifier(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method ToString addr 0x2daeecc size 0x120 virtual true final false
 ::StringW ToString() ;

/// @brief Method GetHashCode addr 0x2daefec size 0x50 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2daf03c size 0x84 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method Equals addr 0x2daf164 size 0x18 virtual true final true
 bool Equals(Zenject::BindingId that) ;

/// @brief Method op_Equality addr 0x2daf0c0 size 0xa4 virtual false final false
static bool op_Equality(Zenject::BindingId left, Zenject::BindingId right) ;

/// @brief Method op_Inequality addr 0x2daf17c size 0x18 virtual false final false
