...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11174), inst: 5162 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11174))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11174), inst: 5963 })
// CS Name: Zenject.MethodProviderWithContainer`3
