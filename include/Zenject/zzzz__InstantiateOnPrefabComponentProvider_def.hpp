...
/// @brief Method .ctor addr 0x2dc0094 size 0x2c virtual false final false
 void _ctor(System::Type componentType, Zenject::IPrefabInstantiator prefabInstantiator) ;

/// @brief Method get_IsCached addr 0x2dc00c0 size 0x8 virtual true final true
 bool get_IsCached() ;

/// @brief Method get_TypeVariesBasedOnMemberType addr 0x2dc00c8 size 0x8 virtual true final true
 bool get_TypeVariesBasedOnMemberType() ;

/// @brief Method GetInstanceType addr 0x2dc00d0 size 0x8 virtual true final true
 System::Type GetInstanceType(Zenject::InjectContext context) ;

/// @brief Method GetAllInstancesWithInjectSplit addr 0x2dc00d8 size 0x16c virtual true final true
