...
namespace Zenject {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11093), inst: 3774 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3828), inst: 1615 }), TypeDefinitionIndex(TypeDefinitionIndex(2493)), TypeDefinitionIndex(TypeDefinitionIndex(3828)), TypeDefinitionIndex(TypeDefinitionIndex(11093))}
...
/// @brief Method .ctor addr 0x2dd6d08 size 0x5c virtual false final false
 void _ctor(System::Collections::Generic::List_1<System::Type> typeOrder) ;

/// @brief Method InstallBindings addr 0x2dd6d64 size 0x164 virtual true final false
 void InstallBindings() ;

/// @brief Method __zenCreate addr 0x2dd6ec8 size 0xc4 virtual false final false
static ::bs_hook::Il2CppWrapperType __zenCreate(::ArrayW<::bs_hook::Il2CppWrapperType> P_0) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2dd6f8c size 0x274 virtual false final false
