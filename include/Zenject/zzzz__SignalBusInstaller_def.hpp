...
namespace Zenject {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11092), inst: 3771 }), TypeDefinitionIndex(TypeDefinitionIndex(11092))}
...
/// @brief Method InstallBindings addr 0x2d7ea88 size 0x180 virtual true final false
 void InstallBindings() ;

// Ctor Parameters []
explicit SignalBusInstaller() ;

/// @brief Method .ctor addr 0x2d7ec24 size 0x48 virtual false final false
 void _ctor() ;

/// @brief Method __zenCreate addr 0x2d7ec6c size 0x58 virtual false final false
static ::bs_hook::Il2CppWrapperType __zenCreate(::ArrayW<::bs_hook::Il2CppWrapperType> P_0) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2d7ecc4 size 0x1c0 virtual false final false
