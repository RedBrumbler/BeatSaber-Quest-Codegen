...
/// @brief Method .ctor addr 0x2d98328 size 0x2c virtual false final false
 void _ctor() ;

/// @brief Method get_ShowExpandWarning addr 0x2d98354 size 0x8 virtual false final false
 bool get_ShowExpandWarning() ;

/// @brief Method set_ShowExpandWarning addr 0x2d9835c size 0xc virtual false final false
 void set_ShowExpandWarning(bool value) ;

/// @brief Method get_ExpandMethod addr 0x2d98368 size 0x8 virtual false final false
 Zenject::PoolExpandMethods get_ExpandMethod() ;

/// @brief Method set_ExpandMethod addr 0x2d98370 size 0x8 virtual false final false
 void set_ExpandMethod(Zenject::PoolExpandMethods value) ;

/// @brief Method get_InitialSize addr 0x2d98378 size 0x8 virtual false final false
 int32_t get_InitialSize() ;

/// @brief Method set_InitialSize addr 0x2d98380 size 0x8 virtual false final false
 void set_InitialSize(int32_t value) ;

/// @brief Method get_MaxSize addr 0x2d98388 size 0x8 virtual false final false
 int32_t get_MaxSize() ;

/// @brief Method set_MaxSize addr 0x2d98390 size 0x8 virtual false final false
