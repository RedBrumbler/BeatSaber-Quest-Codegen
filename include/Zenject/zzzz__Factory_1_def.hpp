...
template<::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10964)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10963), inst: 3354 }), TypeDefinitionIndex(TypeDefinitionIndex(10963))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10964), inst: 2 })
