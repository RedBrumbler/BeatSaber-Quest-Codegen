...
/// @brief Method .ctor addr 0x2dbdf34 size 0x28 virtual false final false
 void _ctor(Zenject::IProvider creator) ;

/// @brief Method get_IsCached addr 0x2dbe50c size 0x8 virtual true final true
 bool get_IsCached() ;

/// @brief Method get_TypeVariesBasedOnMemberType addr 0x2dbe514 size 0x28 virtual true final true
 bool get_TypeVariesBasedOnMemberType() ;

/// @brief Method get_NumInstances addr 0x2dbe2a4 size 0x4c virtual false final false
 int32_t get_NumInstances() ;

/// @brief Method ClearCache addr 0x2dbe53c size 0x8 virtual false final false
 void ClearCache() ;

/// @brief Method GetInstanceType addr 0x2dbe544 size 0xac virtual true final true
 System::Type GetInstanceType(Zenject::InjectContext context) ;

/// @brief Method GetAllInstancesWithInjectSplit addr 0x2dbdf5c size 0x288 virtual true final true
