...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11224), inst: 5162 })
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11225), inst: 5162 })
