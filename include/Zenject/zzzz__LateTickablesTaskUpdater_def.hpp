...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11298)), TypeDefinitionIndex(TypeDefinitionIndex(15697)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11298), inst: 4066 })}
...
/// @brief Method UpdateItem addr 0x2dd1d78 size 0x9c virtual true final false
 void UpdateItem(Zenject::ILateTickable task) ;

// Ctor Parameters []
explicit LateTickablesTaskUpdater() ;

/// @brief Method .ctor addr 0x2dd1e14 size 0x48 virtual false final false
 void _ctor() ;

/// @brief Method __zenCreate addr 0x2dd1e5c size 0x58 virtual false final false
static ::bs_hook::Il2CppWrapperType __zenCreate(::ArrayW<::bs_hook::Il2CppWrapperType> P_0) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2dd1eb4 size 0x1c0 virtual false final false
