...
template<::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10999)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10999), inst: 2655 }), TypeDefinitionIndex(TypeDefinitionIndex(11026))}
