...
/// @brief Method .ctor addr 0x2dc2428 size 0x28 virtual false final false
 void _ctor(Zenject::IPrefabInstantiator subInstantiator) ;

/// @brief Method get_ExtraArguments addr 0x2dc2450 size 0xa4 virtual true final true
 System::Collections::Generic::List_1<Zenject::TypeValuePair> get_ExtraArguments() ;

/// @brief Method get_ArgumentTarget addr 0x2dc24f4 size 0xa0 virtual true final true
 System::Type get_ArgumentTarget() ;

/// @brief Method get_GameObjectCreationParameters addr 0x2dc2594 size 0xa4 virtual true final true
 Zenject::GameObjectCreationParameters get_GameObjectCreationParameters() ;

/// @brief Method GetPrefab addr 0x2dc2638 size 0xa4 virtual true final true
 UnityEngine::Object GetPrefab() ;

/// @brief Method Instantiate addr 0x2dc26dc size 0x17c virtual true final true
