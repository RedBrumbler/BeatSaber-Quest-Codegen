...
template<::cordl_internals::il2cpp_reference_type TSignal>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10601)), TypeDefinitionIndex(TypeDefinitionIndex(10608)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10608), inst: 930 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10601), inst: 2 })
