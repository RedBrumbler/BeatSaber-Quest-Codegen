...
/// @brief Method get_SceneContexts addr 0x2dcf074 size 0x50 virtual false final false
 System::Collections::Generic::IEnumerable_1<Zenject::SceneContext> get_SceneContexts() ;

/// @brief Method Add addr 0x2dd0dd0 size 0xd0 virtual false final false
 void Add(Zenject::SceneContext context) ;

/// @brief Method GetSceneContextForScene addr 0x2dd0ea0 size 0xb0 virtual false final false
 Zenject::SceneContext GetSceneContextForScene(::StringW name) ;

/// @brief Method GetSceneContextForScene addr 0x2dd0f50 size 0x58 virtual false final false
 Zenject::SceneContext GetSceneContextForScene(UnityEngine::SceneManagement::Scene scene) ;

/// @brief Method TryGetSceneContextForScene addr 0x2dd0fa8 size 0xb0 virtual false final false
 Zenject::SceneContext TryGetSceneContextForScene(::StringW name) ;

/// @brief Method TryGetSceneContextForScene addr 0x2dd1058 size 0x78 virtual false final false
 Zenject::SceneContext TryGetSceneContextForScene(UnityEngine::SceneManagement::Scene scene) ;

/// @brief Method GetContainerForScene addr 0x2dd10d0 size 0xa4 virtual false final false
 Zenject::DiContainer GetContainerForScene(UnityEngine::SceneManagement::Scene scene) ;

/// @brief Method TryGetContainerForScene addr 0x2dd1174 size 0xec virtual false final false
 Zenject::DiContainer TryGetContainerForScene(UnityEngine::SceneManagement::Scene scene) ;

/// @brief Method Remove addr 0x2dd1260 size 0xfc virtual false final false
 void Remove(Zenject::SceneContext context) ;

// Ctor Parameters []
explicit SceneContextRegistry() ;

/// @brief Method .ctor addr 0x2dd135c size 0x7c virtual false final false
 void _ctor() ;

/// @brief Method __zenCreate addr 0x2dd13d8 size 0x58 virtual false final false
static ::bs_hook::Il2CppWrapperType __zenCreate(::ArrayW<::bs_hook::Il2CppWrapperType> P_0) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2dd1430 size 0x1c0 virtual false final false
