...
namespace Zenject {
template<>
class IFactoryProviderBase_1<GlobalNamespace::GlobalNamespace__GraphyController__InitData>;
}
namespace Zenject {
template<>
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11155), inst: 2 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11155))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11155), inst: 374 })
// CS Name: Zenject.IFactoryProviderBase`1
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11155))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11155), inst: 4831 })
// CS Name: Zenject.IFactoryProviderBase`1
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11155))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11155), inst: 5961 })
// CS Name: Zenject.IFactoryProviderBase`1
class CORDL_TYPE IFactoryProviderBase_1<GlobalNamespace::GlobalNamespace__GraphyController__InitData> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief Convert operator to Zenject::IProvider
constexpr operator  Zenject::IProvider() const noexcept;
