...
namespace Zenject {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11093), inst: 3775 }), TypeDefinitionIndex(TypeDefinitionIndex(11093)), TypeDefinitionIndex(TypeDefinitionIndex(15073))}
...
/// @brief Method .ctor addr 0x2dc72a8 size 0x5c virtual false final false
 void _ctor(UnityEngine::Animator animator) ;

/// @brief Method InstallBindings addr 0x2dc7304 size 0xb8 virtual true final false
 void InstallBindings() ;

/// @brief Method __zenCreate addr 0x2dc73bc size 0xc4 virtual false final false
static ::bs_hook::Il2CppWrapperType __zenCreate(::ArrayW<::bs_hook::Il2CppWrapperType> P_0) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2dc7480 size 0x274 virtual false final false
