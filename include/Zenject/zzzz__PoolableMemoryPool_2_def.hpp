...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11000), inst: 3370 }), TypeDefinitionIndex(TypeDefinitionIndex(11000)), TypeDefinitionIndex(TypeDefinitionIndex(11027))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11027), inst: 80 })
