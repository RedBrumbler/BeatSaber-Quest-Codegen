...
/// @brief Method InstallBindings addr 0x2dbd908 size 0x4 virtual true final false
 void InstallBindings(Zenject::DiContainer container) ;

/// @brief Method PostInstall addr 0x2dbd90c size 0x4 virtual true final false
 void PostInstall(Zenject::DiContainer container) ;

// Ctor Parameters []
explicit NoTransitionInstaller() ;

/// @brief Method .ctor addr 0x2dbd910 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2dbd918 size 0x178 virtual false final false
