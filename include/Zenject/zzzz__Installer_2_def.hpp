...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TDerived>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11098)), TypeDefinitionIndex(TypeDefinitionIndex(11093))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11093), inst: 80 })
