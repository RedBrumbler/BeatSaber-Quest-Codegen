...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TParam4,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10976)), TypeDefinitionIndex(TypeDefinitionIndex(10975)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10975), inst: 3400 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10976), inst: 5946 })
