...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TParam4,::cordl_internals::il2cpp_reference_type TParam5>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11207)), TypeDefinitionIndex(TypeDefinitionIndex(11213))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11213), inst: 5946 })
...
explicit SubContainerCreatorByMethod_5(Zenject::DiContainer container, Zenject::SubContainerCreatorBindInfo containerBindInfo, System::Action_6<Zenject::DiContainer,TParam1,TParam2,TParam3,TParam4,TParam5> installMethod) ;
