...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10633))}
...
/// @brief Method .ctor addr 0x2d80044 size 0x34 virtual false final false
 void _ctor(Zenject::DiContainer bindContainer, Zenject::BindInfo bindInfo, Zenject::BindStatement bindStatement) ;

/// @brief Method WithId addr 0x2d80078 size 0x1c virtual false final false
