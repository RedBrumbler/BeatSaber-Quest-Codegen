...
/// @brief Method .ctor addr 0x2dd7200 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2dd7208 size 0x8 virtual false final false
 void _ctor(::StringW sampleName) ;

/// @brief Method get_ProfilePattern addr 0x2dd7210 size 0x48 virtual false final false
static System::Text::RegularExpressions::Regex get_ProfilePattern() ;

/// @brief Method set_ProfilePattern addr 0x2dd7258 size 0x4c virtual false final false
static void set_ProfilePattern(System::Text::RegularExpressions::Regex value) ;

/// @brief Method Start addr 0x2dd72a4 size 0x8 virtual false final false
static Zenject::ProfileBlock Start() ;

/// @brief Method Start addr 0x2dd72ac size 0x8 virtual false final false
static Zenject::ProfileBlock Start(::StringW sampleNameFormat, ::bs_hook::Il2CppWrapperType obj1, ::bs_hook::Il2CppWrapperType obj2) ;

/// @brief Method Start addr 0x2dd72b4 size 0x8 virtual false final false
static Zenject::ProfileBlock Start(::StringW sampleNameFormat, ::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Start addr 0x2dd72bc size 0x8 virtual false final false
static Zenject::ProfileBlock Start(::StringW sampleName) ;

/// @brief Method Dispose addr 0x2dd72c4 size 0x4 virtual true final true
 void Dispose() ;
