...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10970)), TypeDefinitionIndex(TypeDefinitionIndex(10969)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10969), inst: 3379 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10970), inst: 5162 })
