...
template<::cordl_internals::il2cpp_reference_type TBase,::cordl_internals::il2cpp_reference_type TKey>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10956)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10956), inst: 3810 }), TypeDefinitionIndex(TypeDefinitionIndex(10957))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10957), inst: 80 })
