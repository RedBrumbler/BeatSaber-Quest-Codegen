...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11049), inst: 3505 }), TypeDefinitionIndex(TypeDefinitionIndex(11049)), TypeDefinitionIndex(TypeDefinitionIndex(11039))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11039), inst: 5162 })
