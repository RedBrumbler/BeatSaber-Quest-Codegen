...
template<::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10664)), TypeDefinitionIndex(TypeDefinitionIndex(10817)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10664), inst: 1690 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10817), inst: 2 })
