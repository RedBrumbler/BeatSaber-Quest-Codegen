...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TDerived>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11112)), TypeDefinitionIndex(TypeDefinitionIndex(11115))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11112), inst: 5945 })
