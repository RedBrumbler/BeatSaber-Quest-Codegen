...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10665), inst: 1694 }), TypeDefinitionIndex(TypeDefinitionIndex(10665)), TypeDefinitionIndex(TypeDefinitionIndex(10818))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10818), inst: 80 })
...
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10665), inst: 1694 }), TypeDefinitionIndex(TypeDefinitionIndex(10665)), TypeDefinitionIndex(TypeDefinitionIndex(10818))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10818), inst: 1538 })
// CS Name: Zenject.FactoryToChoiceIdBinder`2
