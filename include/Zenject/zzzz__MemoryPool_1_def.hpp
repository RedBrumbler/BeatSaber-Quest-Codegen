...
template<::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11010), inst: 2652 }), TypeDefinitionIndex(TypeDefinitionIndex(11010)), TypeDefinitionIndex(TypeDefinitionIndex(10999))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10999), inst: 2 })
