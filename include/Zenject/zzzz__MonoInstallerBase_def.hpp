...
/// @brief Method get_Container addr 0x2dadda4 size 0x8 virtual false final false
 Zenject::DiContainer get_Container() ;

/// @brief Method set_Container addr 0x2daddac size 0x8 virtual false final false
 void set_Container(Zenject::DiContainer value) ;

/// @brief Method get_IsEnabled addr 0x2daddb4 size 0x8 virtual true final false
 bool get_IsEnabled() ;

/// @brief Method Start addr 0x2daddbc size 0x4 virtual true final false
 void Start() ;

/// @brief Method InstallBindings addr 0x2daddc0 size 0x40 virtual true final false
 void InstallBindings() ;

// Ctor Parameters []
explicit MonoInstallerBase() ;

/// @brief Method .ctor addr 0x2dadc24 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method __zenPropertySetter0 addr 0x2dade00 size 0xd0 virtual false final false
static void __zenPropertySetter0(::bs_hook::Il2CppWrapperType P_0, ::bs_hook::Il2CppWrapperType P_1) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2daded0 size 0x2b0 virtual false final false
