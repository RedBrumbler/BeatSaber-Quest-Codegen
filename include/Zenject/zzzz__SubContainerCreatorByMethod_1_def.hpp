...
template<::cordl_internals::il2cpp_reference_type TParam1>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11209)), TypeDefinitionIndex(TypeDefinitionIndex(11207))}
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11209)), TypeDefinitionIndex(TypeDefinitionIndex(11207))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11209), inst: 4831 })
// CS Name: Zenject.SubContainerCreatorByMethod`1
