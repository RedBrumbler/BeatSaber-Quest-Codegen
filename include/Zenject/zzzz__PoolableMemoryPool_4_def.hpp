...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11002), inst: 3395 }), TypeDefinitionIndex(TypeDefinitionIndex(11002)), TypeDefinitionIndex(TypeDefinitionIndex(11029))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11029), inst: 5945 })
