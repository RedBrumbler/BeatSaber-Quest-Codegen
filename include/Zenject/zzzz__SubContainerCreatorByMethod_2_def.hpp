...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11207)), TypeDefinitionIndex(TypeDefinitionIndex(11210))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11210), inst: 80 })
...
template<::cordl_internals::il2cpp_reference_type TParam1>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11210)), TypeDefinitionIndex(TypeDefinitionIndex(11207))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11210), inst: 1551 })
// CS Name: Zenject.SubContainerCreatorByMethod`2
