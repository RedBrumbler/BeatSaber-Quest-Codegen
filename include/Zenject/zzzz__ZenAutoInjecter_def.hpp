...
/// @brief Method get_ContainerSource addr 0x2dd88c4 size 0x8 virtual false final false
 Zenject::Zenject__ZenAutoInjecter__ContainerSources get_ContainerSource() ;

/// @brief Method set_ContainerSource addr 0x2dd88cc size 0x8 virtual false final false
 void set_ContainerSource(Zenject::Zenject__ZenAutoInjecter__ContainerSources value) ;

/// @brief Method Construct addr 0x2dd88d4 size 0x44 virtual false final false
 void Construct() ;

/// @brief Method Awake addr 0x2dd8918 size 0x48 virtual false final false
 void Awake() ;

/// @brief Method LookupContainer addr 0x2dd8960 size 0x158 virtual false final false
 Zenject::DiContainer LookupContainer() ;

/// @brief Method GetContainerForCurrentScene addr 0x2dd8ab8 size 0x90 virtual false final false
 Zenject::DiContainer GetContainerForCurrentScene() ;

// Ctor Parameters []
explicit ZenAutoInjecter() ;

/// @brief Method .ctor addr 0x2dd8b48 size 0x10 virtual false final false
 void _ctor() ;

/// @brief Method __zenInjectMethod0 addr 0x2dd8b58 size 0x80 virtual false final false
static void __zenInjectMethod0(::bs_hook::Il2CppWrapperType P_0, ::ArrayW<::bs_hook::Il2CppWrapperType> P_1) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2dd8bd8 size 0x254 virtual false final false
