...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14616)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14616), inst: 2480 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11047), inst: 2703 }), TypeDefinitionIndex(TypeDefinitionIndex(11057)), TypeDefinitionIndex(TypeDefinitionIndex(11047))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11057), inst: 2 })
