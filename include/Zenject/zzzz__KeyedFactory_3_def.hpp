...
template<::cordl_internals::il2cpp_reference_type TBase,::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TParam1>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10956)), TypeDefinitionIndex(TypeDefinitionIndex(10958)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10956), inst: 3811 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10958), inst: 5162 })
