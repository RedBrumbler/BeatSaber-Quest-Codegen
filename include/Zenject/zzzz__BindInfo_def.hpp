...
/// @brief Method .ctor addr 0x2d9761c size 0xec virtual false final false
 void _ctor() ;

/// @brief Method Dispose addr 0x2d97804 size 0x58 virtual true final true
 void Dispose() ;

/// @brief Method SetContextInfo addr 0x2d9785c size 0x8 virtual false final false
 void SetContextInfo(::StringW contextInfo) ;

/// @brief Method Reset addr 0x2d97708 size 0xfc virtual false final false
 void Reset() ;
