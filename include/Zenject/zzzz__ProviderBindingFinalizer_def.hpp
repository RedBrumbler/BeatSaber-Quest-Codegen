...
/// @brief Method .ctor addr 0x2d9e96c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetScope>b__7_0 addr 0x2d9e974 size 0x58 virtual false final false
 ::StringW _GetScope_b__7_0(System::Type x) ;

/// @brief Method <FinalizeBinding>b__8_0 addr 0x2d9e9cc size 0x58 virtual false final false
 ::StringW _FinalizeBinding_b__8_0(System::Type x) ;

/// @brief Method __zenCreate addr 0x2d9ea24 size 0x5c virtual false final false
static ::bs_hook::Il2CppWrapperType __zenCreate(::ArrayW<::bs_hook::Il2CppWrapperType> P_0) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2d9ea80 size 0x1c0 virtual false final false
...
/// @brief Method .ctor addr 0x2d9ac04 size 0x28 virtual false final false
 void _ctor(Zenject::BindInfo bindInfo) ;

/// @brief Method get_BindingInheritanceMethod addr 0x2d9dac0 size 0x1c virtual true final true
 Zenject::BindingInheritanceMethods get_BindingInheritanceMethod() ;

/// @brief Method get_BindInfo addr 0x2d9dadc size 0x8 virtual false final false
 Zenject::BindInfo get_BindInfo() ;

/// @brief Method set_BindInfo addr 0x2d9dae4 size 0x8 virtual false final false
 void set_BindInfo(Zenject::BindInfo value) ;

/// @brief Method GetScope addr 0x2d9b31c size 0x24c virtual false final false
 Zenject::ScopeTypes GetScope() ;

/// @brief Method FinalizeBinding addr 0x2d9daec size 0x370 virtual true final true
...
/// @brief Method RegisterProvider addr 0x2d9de5c size 0x254 virtual false final false
 void RegisterProvider(Zenject::DiContainer container, System::Type contractType, Zenject::IProvider provider) ;

/// @brief Method RegisterProviderPerContract addr 0x2d9bb14 size 0x214 virtual false final false
...
/// @brief Method RegisterProviderForAllContracts addr 0x2d9e274 size 0x1e8 virtual false final false
 void RegisterProviderForAllContracts(Zenject::DiContainer container, Zenject::IProvider provider) ;

/// @brief Method RegisterProvidersPerContractAndConcreteType addr 0x2d9e45c size 0x2cc virtual false final false
...
/// @brief Method ValidateBindTypes addr 0x2d9e728 size 0x1e0 virtual false final false
 bool ValidateBindTypes(System::Type concreteType, System::Type contractType) ;

/// @brief Method RegisterProvidersForAllContractsPerConcreteType addr 0x2d9b568 size 0x59c virtual false final false
