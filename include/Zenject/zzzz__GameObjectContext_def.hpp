...
/// @brief Method add_PreInstall addr 0x2da6c88 size 0x9c virtual false final false
 void add_PreInstall(System::Action value) ;

/// @brief Method remove_PreInstall addr 0x2da6d24 size 0x9c virtual false final false
 void remove_PreInstall(System::Action value) ;

/// @brief Method add_PostInstall addr 0x2da6dc0 size 0x9c virtual false final false
 void add_PostInstall(System::Action value) ;

/// @brief Method remove_PostInstall addr 0x2da6e5c size 0x9c virtual false final false
 void remove_PostInstall(System::Action value) ;

/// @brief Method add_PreResolve addr 0x2da6ef8 size 0x9c virtual false final false
 void add_PreResolve(System::Action value) ;

/// @brief Method remove_PreResolve addr 0x2da6f94 size 0x9c virtual false final false
 void remove_PreResolve(System::Action value) ;

/// @brief Method add_PostResolve addr 0x2da7030 size 0x9c virtual false final false
 void add_PostResolve(System::Action value) ;

/// @brief Method remove_PostResolve addr 0x2da70cc size 0x9c virtual false final false
 void remove_PostResolve(System::Action value) ;

/// @brief Method get_Container addr 0x2da7168 size 0x8 virtual true final false
 Zenject::DiContainer get_Container() ;

/// @brief Method GetRootGameObjects addr 0x2da7170 size 0xa0 virtual true final false
 System::Collections::Generic::IEnumerable_1<UnityEngine::GameObject> GetRootGameObjects() ;

/// @brief Method Construct addr 0x2da7210 size 0x44 virtual false final false
 void Construct(Zenject::DiContainer parentContainer) ;

/// @brief Method RunInternal addr 0x2da72f0 size 0x3b4 virtual true final false
 void RunInternal() ;

/// @brief Method GetInjectableMonoBehaviours addr 0x2da792c size 0x244 virtual true final false
 void GetInjectableMonoBehaviours(System::Collections::Generic::List_1<UnityEngine::MonoBehaviour> monoBehaviours) ;

/// @brief Method InstallBindings addr 0x2da76c0 size 0x1f8 virtual false final false
...
/// @brief Method .ctor addr 0x2da7b80 size 0x5c virtual false final false
 void _ctor() ;

/// @brief Method __zenInjectMethod0 addr 0x2da7be8 size 0xe8 virtual false final false
static void __zenInjectMethod0(::bs_hook::Il2CppWrapperType P_0, ::ArrayW<::bs_hook::Il2CppWrapperType> P_1) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2da7cd0 size 0x2f8 virtual false final false
