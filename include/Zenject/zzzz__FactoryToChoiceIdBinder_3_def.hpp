...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10820)), TypeDefinitionIndex(TypeDefinitionIndex(10667)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10667), inst: 1695 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10820), inst: 5162 })
...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10820)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10667), inst: 1695 }), TypeDefinitionIndex(TypeDefinitionIndex(10667))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10820), inst: 5963 })
// CS Name: Zenject.FactoryToChoiceIdBinder`3
