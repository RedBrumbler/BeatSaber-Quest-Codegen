...
/// @brief Method .ctor addr 0x2d7b170 size 0x80 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2d7b1f0 size 0xf8 virtual false final false
 void _ctor(Zenject::BindInfo bindInfo) ;

/// @brief Method AddCopyBindInfo addr 0x2d7b2e8 size 0xa8 virtual false final false
 void AddCopyBindInfo(Zenject::BindInfo bindInfo) ;

/// @brief Method CopyIntoAllSubContainers addr 0x2d7b390 size 0x8 virtual false final false
 void CopyIntoAllSubContainers() ;

/// @brief Method CopyIntoDirectSubContainers addr 0x2d7b42c size 0x8 virtual false final false
 void CopyIntoDirectSubContainers() ;

/// @brief Method MoveIntoAllSubContainers addr 0x2d7b434 size 0x8 virtual false final false
 void MoveIntoAllSubContainers() ;

/// @brief Method MoveIntoDirectSubContainers addr 0x2d7b43c size 0x8 virtual false final false
 void MoveIntoDirectSubContainers() ;

/// @brief Method SetInheritanceMethod addr 0x2d7b398 size 0x94 virtual false final false
