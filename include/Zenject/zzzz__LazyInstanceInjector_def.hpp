...
/// @brief Method .ctor addr 0x2dbcdb0 size 0x90 virtual false final false
 void _ctor(Zenject::DiContainer container) ;

/// @brief Method get_Instances addr 0x2dbce40 size 0x8 virtual false final false
 System::Collections::Generic::IEnumerable_1<::bs_hook::Il2CppWrapperType> get_Instances() ;

/// @brief Method AddInstance addr 0x2dbce48 size 0x58 virtual false final false
 void AddInstance(::bs_hook::Il2CppWrapperType instance) ;

/// @brief Method AddInstances addr 0x2dbcea0 size 0x58 virtual false final false
 void AddInstances(System::Collections::Generic::IEnumerable_1<::bs_hook::Il2CppWrapperType> instances) ;

/// @brief Method LazyInject addr 0x2dbcef8 size 0x7c virtual false final false
 void LazyInject(::bs_hook::Il2CppWrapperType instance) ;

/// @brief Method LazyInjectAll addr 0x2dbcf74 size 0x21c virtual false final false
 void LazyInjectAll() ;
