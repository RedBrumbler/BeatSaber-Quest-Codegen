...
template<::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11047), inst: 2656 }), TypeDefinitionIndex(TypeDefinitionIndex(11037)), TypeDefinitionIndex(TypeDefinitionIndex(11047))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11037), inst: 2 })
