...
/// @brief Method get_UseSceneContext addr 0x2dae884 size 0x8 virtual false final false
 bool get_UseSceneContext() ;

/// @brief Method get_IfNotBound addr 0x2dae88c size 0x8 virtual false final false
 bool get_IfNotBound() ;

/// @brief Method get_Context addr 0x2dae894 size 0x8 virtual false final false
 Zenject::Context get_Context() ;

/// @brief Method set_Context addr 0x2dae89c size 0x8 virtual false final false
 void set_Context(Zenject::Context value) ;

/// @brief Method get_Components addr 0x2dae8a4 size 0x8 virtual false final false
 ::ArrayW<UnityEngine::Component> get_Components() ;

/// @brief Method get_Identifier addr 0x2dae8ac size 0x8 virtual false final false
 ::StringW get_Identifier() ;

/// @brief Method get_BindType addr 0x2dae8b4 size 0x8 virtual false final false
 Zenject::Zenject__ZenjectBinding__BindTypes get_BindType() ;

/// @brief Method Start addr 0x2dae8bc size 0x4 virtual false final false
 void Start() ;

// Ctor Parameters []
explicit ZenjectBinding() ;

/// @brief Method .ctor addr 0x2dae8c0 size 0x58 virtual false final false
 void _ctor() ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2dae918 size 0x178 virtual false final false
