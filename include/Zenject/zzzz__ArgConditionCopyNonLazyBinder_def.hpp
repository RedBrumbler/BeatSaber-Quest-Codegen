...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10885))}
...
/// @brief Method .ctor addr 0x2d7f3d4 size 0x8 virtual false final false
...
/// @brief Method WithArguments addr 0x2d7f3dc size 0x18c virtual false final false
 Zenject::InstantiateCallbackConditionCopyNonLazyBinder WithArguments(::ArrayW<::bs_hook::Il2CppWrapperType> args) ;

/// @brief Method WithArgumentsExplicit addr 0x2d7f568 size 0x3a8 virtual false final false
