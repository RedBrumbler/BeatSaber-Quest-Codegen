...
template<::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10962))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10962), inst: 2 })
...
template<::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10987)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10987), inst: 3355 }), TypeDefinitionIndex(TypeDefinitionIndex(10963))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10963), inst: 2 })
