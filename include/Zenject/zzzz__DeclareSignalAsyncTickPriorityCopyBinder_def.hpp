...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10618))}
...
/// @brief Method .ctor addr 0x2d7af68 size 0x24 virtual false final false
 void _ctor(Zenject::SignalDeclarationBindInfo signalBindInfo) ;

/// @brief Method RunAsync addr 0x2d7afb0 size 0x20 virtual false final false
 Zenject::SignalTickPriorityCopyBinder RunAsync() ;

/// @brief Method RunSync addr 0x2d7afd0 size 0x1c virtual false final false
