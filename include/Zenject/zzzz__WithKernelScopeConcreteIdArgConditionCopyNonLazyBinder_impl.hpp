...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Zenject::WithKernelScopeConcreteIdArgConditionCopyNonLazyBinder::*)(Zenject::SubContainerCreatorBindInfo, Zenject::BindInfo)>(&Zenject::WithKernelScopeConcreteIdArgConditionCopyNonLazyBinder::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2d975d0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder (Zenject::WithKernelScopeConcreteIdArgConditionCopyNonLazyBinder::*)()>(&Zenject::WithKernelScopeConcreteIdArgConditionCopyNonLazyBinder::WithKernel)> {
  ...
  constexpr static std::size_t addrs = 0x2d975fc;
...
// Ctor Parameters [CppParam { name: "subContainerBindInfo", ty: "Zenject::SubContainerCreatorBindInfo", modifiers: "", def_value: None }, CppParam { name: "bindInfo", ty: "Zenject::BindInfo", modifiers: "", def_value: None }]
 Zenject::WithKernelScopeConcreteIdArgConditionCopyNonLazyBinder::WithKernelScopeConcreteIdArgConditionCopyNonLazyBinder(Zenject::SubContainerCreatorBindInfo subContainerBindInfo, Zenject::BindInfo bindInfo)  : Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder(THROW_UNLESS(::il2cpp_utils::New<WithKernelScopeConcreteIdArgConditionCopyNonLazyBinder>(subContainerBindInfo, bindInfo))) {}
