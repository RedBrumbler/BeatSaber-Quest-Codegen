...
/// @brief Method .ctor addr 0x2dd15f0 size 0x2c virtual false final false
 void _ctor(Zenject::SceneContext sceneContext, Zenject::SceneContextRegistry registry) ;

/// @brief Method Initialize addr 0x2dd161c size 0x20 virtual true final true
 void Initialize() ;

/// @brief Method Dispose addr 0x2dd163c size 0x20 virtual true final true
 void Dispose() ;

/// @brief Method __zenCreate addr 0x2dd165c size 0x11c virtual false final false
static ::bs_hook::Il2CppWrapperType __zenCreate(::ArrayW<::bs_hook::Il2CppWrapperType> P_0) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2dd1778 size 0x304 virtual false final false
