...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11295), inst: 2 })
...
template<::cordl_internals::il2cpp_reference_type TTask>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11296))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11296), inst: 2 })
...
template<::cordl_internals::il2cpp_reference_type TTask>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11297))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11297), inst: 2 })
...
template<::cordl_internals::il2cpp_reference_type TTask>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11298))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11298), inst: 2 })
