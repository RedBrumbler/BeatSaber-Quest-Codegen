...
template<::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10999)), TypeDefinitionIndex(TypeDefinitionIndex(11011)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10999), inst: 2653 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 2 })
