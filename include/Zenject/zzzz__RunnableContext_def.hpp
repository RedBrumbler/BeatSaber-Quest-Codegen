...
/// @brief Method get_Initialized addr 0x2daa00c size 0x8 virtual false final false
 bool get_Initialized() ;

/// @brief Method set_Initialized addr 0x2daa014 size 0xc virtual false final false
 void set_Initialized(bool value) ;

/// @brief Method Initialize addr 0x2da725c size 0x94 virtual false final false
 void Initialize() ;

/// @brief Method Run addr 0x2daa020 size 0x70 virtual false final false
 void Run() ;
...
/// @brief Method .ctor addr 0x2da7bdc size 0xc virtual false final false
 void _ctor() ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2daa0dc size 0x178 virtual false final false
