...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10877))}
...
/// @brief Method .ctor addr 0x2d7f910 size 0x34 virtual false final false
 void _ctor(Zenject::DiContainer bindContainer, Zenject::BindInfo bindInfo, Zenject::BindStatement bindStatement) ;

/// @brief Method ToSelf addr 0x2d7f974 size 0x124 virtual false final false
...
/// @brief Method To addr 0x2d7fab4 size 0x4 virtual false final false
 Zenject::FromBinderNonGeneric To(::ArrayW<System::Type> concreteTypes) ;

/// @brief Method To addr 0x2d7fab8 size 0x10c virtual false final false
 Zenject::FromBinderNonGeneric To(System::Collections::Generic::IEnumerable_1<System::Type> concreteTypes) ;

/// @brief Method To addr 0x2d7fbc4 size 0x144 virtual false final false
 Zenject::FromBinderNonGeneric To(System::Action_1<Zenject::ConventionSelectTypesBinder> generator) ;

/// @brief Method <ToSelf>b__1_0 addr 0x2d7ffa0 size 0xa4 virtual false final false
