...
/// @brief Method get_IsDestroyed addr 0x2dce2e4 size 0x8 virtual false final false
 bool get_IsDestroyed() ;

/// @brief Method Start addr 0x2dce2ec size 0x4 virtual true final false
 void Start() ;

/// @brief Method Initialize addr 0x2dce2f0 size 0x34 virtual false final false
 void Initialize() ;

/// @brief Method Update addr 0x2dce324 size 0x10 virtual true final false
 void Update() ;

/// @brief Method FixedUpdate addr 0x2dce334 size 0x10 virtual true final false
 void FixedUpdate() ;

/// @brief Method LateUpdate addr 0x2dce344 size 0x10 virtual true final false
 void LateUpdate() ;

/// @brief Method OnDestroy addr 0x2dce354 size 0x54 virtual true final false
 void OnDestroy() ;

// Ctor Parameters []
explicit MonoKernel() ;

/// @brief Method .ctor addr 0x2dcd674 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method __zenFieldSetter0 addr 0x2dce3a8 size 0x134 virtual false final false
static void __zenFieldSetter0(::bs_hook::Il2CppWrapperType P_0, ::bs_hook::Il2CppWrapperType P_1) ;

/// @brief Method __zenFieldSetter1 addr 0x2dce4dc size 0x134 virtual false final false
static void __zenFieldSetter1(::bs_hook::Il2CppWrapperType P_0, ::bs_hook::Il2CppWrapperType P_1) ;

/// @brief Method __zenFieldSetter2 addr 0x2dce610 size 0x134 virtual false final false
static void __zenFieldSetter2(::bs_hook::Il2CppWrapperType P_0, ::bs_hook::Il2CppWrapperType P_1) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2dce744 size 0x480 virtual false final false
