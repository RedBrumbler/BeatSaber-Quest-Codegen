...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10810), inst: 1828 }), TypeDefinitionIndex(TypeDefinitionIndex(10665)), TypeDefinitionIndex(TypeDefinitionIndex(10810))}
...
template<::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10810)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10810), inst: 1828 }), TypeDefinitionIndex(TypeDefinitionIndex(10665))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10665), inst: 1538 })
// CS Name: Zenject.FactoryArgumentsToChoiceBinder`2
