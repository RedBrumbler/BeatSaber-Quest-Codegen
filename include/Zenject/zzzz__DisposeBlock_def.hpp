...
/// @brief Method OnSpawned addr 0x2dd6520 size 0x2c virtual false final false
static void OnSpawned(Zenject::DisposeBlock that) ;

/// @brief Method OnDespawned addr 0x2dd654c size 0x360 virtual false final false
static void OnDespawned(Zenject::DisposeBlock that) ;

/// @brief Method LazyInitializeDisposableList addr 0x2dd68ac size 0xf4 virtual false final false
...
/// @brief Method Add addr 0x2dd69a0 size 0xe8 virtual false final false
 void Add(System::IDisposable disposable) ;

/// @brief Method Remove addr 0x2dd6a88 size 0x64 virtual false final false
...
/// @brief Method Spawn addr 0x2dd6aec size 0x78 virtual false final false
static Zenject::DisposeBlock Spawn() ;

/// @brief Method Dispose addr 0x2dd6b64 size 0x80 virtual true final true
 void Dispose() ;

// Ctor Parameters []
explicit DisposeBlock() ;

/// @brief Method .ctor addr 0x2dd6be4 size 0x8 virtual false final false
 void _ctor() ;
