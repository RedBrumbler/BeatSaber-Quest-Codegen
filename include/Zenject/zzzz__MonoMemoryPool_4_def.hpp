...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11002), inst: 3392 }), TypeDefinitionIndex(TypeDefinitionIndex(11014)), TypeDefinitionIndex(TypeDefinitionIndex(11002))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11014), inst: 5945 })
...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11014)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11002), inst: 3392 }), TypeDefinitionIndex(TypeDefinitionIndex(11002))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11014), inst: 7485 })
// CS Name: Zenject.MonoMemoryPool`4
