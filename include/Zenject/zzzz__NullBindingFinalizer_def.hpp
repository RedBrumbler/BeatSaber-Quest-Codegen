...
/// @brief Method get_BindingInheritanceMethod addr 0x2d9abb0 size 0x8 virtual true final true
 Zenject::BindingInheritanceMethods get_BindingInheritanceMethod() ;

/// @brief Method FinalizeBinding addr 0x2d9abb8 size 0x4 virtual true final true
 void FinalizeBinding(Zenject::DiContainer container) ;

// Ctor Parameters []
explicit NullBindingFinalizer() ;

/// @brief Method .ctor addr 0x2d9abbc size 0x8 virtual false final false
 void _ctor() ;
