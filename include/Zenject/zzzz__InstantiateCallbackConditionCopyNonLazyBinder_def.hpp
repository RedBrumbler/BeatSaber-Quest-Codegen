...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10642))}
...
/// @brief Method .ctor addr 0x2d93e98 size 0x8 virtual false final false
 void _ctor(Zenject::BindInfo bindInfo) ;

/// @brief Method OnInstantiated addr 0x2d93ea0 size 0x1c virtual false final false
...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10884))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10884), inst: 2 })
