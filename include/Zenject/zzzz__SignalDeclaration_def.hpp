...
/// @brief Method .ctor addr 0x2d7b51c size 0x188 virtual false final false
 void _ctor(Zenject::SignalDeclarationBindInfo bindInfo, Zenject::ZenjectSettings zenjectSettings) ;

/// @brief Method get_TickPriority addr 0x2d7b6a4 size 0x8 virtual false final false
 int32_t get_TickPriority() ;

/// @brief Method set_TickPriority addr 0x2d7b6ac size 0x8 virtual false final false
 void set_TickPriority(int32_t value) ;

/// @brief Method get_IsAsync addr 0x2d7b6b4 size 0x8 virtual false final false
 bool get_IsAsync() ;

/// @brief Method get_BindingId addr 0x2d7b6bc size 0xc virtual false final false
 Zenject::BindingId get_BindingId() ;

/// @brief Method Dispose addr 0x2d7b6c8 size 0x154 virtual true final true
 void Dispose() ;

/// @brief Method Fire addr 0x2d7b824 size 0x2dc virtual false final false
 void Fire(::bs_hook::Il2CppWrapperType signal) ;

/// @brief Method FireInternal addr 0x2d7bb00 size 0x23c virtual false final false
...
/// @brief Method Tick addr 0x2d7bd60 size 0x320 virtual true final true
 void Tick() ;

/// @brief Method Add addr 0x2d7c080 size 0xdc virtual false final false
 void Add(Zenject::SignalSubscription subscription) ;

/// @brief Method Remove addr 0x2d7c15c size 0x58 virtual false final false
 void Remove(Zenject::SignalSubscription subscription) ;

/// @brief Method __zenCreate addr 0x2d7c1b4 size 0x11c virtual false final false
static ::bs_hook::Il2CppWrapperType __zenCreate(::ArrayW<::bs_hook::Il2CppWrapperType> P_0) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2d7c2d0 size 0x304 virtual false final false
...
namespace Zenject {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10966), inst: 3377 }), TypeDefinitionIndex(TypeDefinitionIndex(10966)), TypeDefinitionIndex(TypeDefinitionIndex(10615)), TypeDefinitionIndex(TypeDefinitionIndex(10620))}
...
/// @brief Method .ctor addr 0x2d7c5d4 size 0x48 virtual false final false
 void _ctor() ;

/// @brief Method __zenCreate addr 0x2d7c61c size 0x58 virtual false final false
static ::bs_hook::Il2CppWrapperType __zenCreate(::ArrayW<::bs_hook::Il2CppWrapperType> P_0) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2d7c674 size 0x1c0 virtual false final false
static Zenject::InjectTypeInfo __zenCreateInjectTypeInfo() ;
