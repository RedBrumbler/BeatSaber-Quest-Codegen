...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15671))}
...
// Ctor Parameters []
explicit InjectLocalAttribute() ;

/// @brief Method .ctor addr 0x2d7249c size 0x20 virtual false final false
 void _ctor() ;
