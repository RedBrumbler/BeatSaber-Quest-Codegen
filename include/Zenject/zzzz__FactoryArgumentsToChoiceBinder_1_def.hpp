...
template<::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10664)), TypeDefinitionIndex(TypeDefinitionIndex(10809)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10809), inst: 1826 })}
