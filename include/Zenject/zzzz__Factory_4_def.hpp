...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10972)), TypeDefinitionIndex(TypeDefinitionIndex(10973)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10972), inst: 3390 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10973), inst: 5945 })
