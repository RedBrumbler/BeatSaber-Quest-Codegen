...
/// @brief Method get_LateInstallers addr 0x2dad080 size 0x8 virtual false final false
 System::Collections::Generic::IEnumerable_1<Zenject::MonoInstaller> get_LateInstallers() ;

/// @brief Method set_LateInstallers addr 0x2dad088 size 0x90 virtual false final false
 void set_LateInstallers(System::Collections::Generic::IEnumerable_1<Zenject::MonoInstaller> value) ;

/// @brief Method get_LateInstallerPrefabs addr 0x2dad118 size 0x8 virtual false final false
 System::Collections::Generic::IEnumerable_1<Zenject::MonoInstaller> get_LateInstallerPrefabs() ;

/// @brief Method set_LateInstallerPrefabs addr 0x2dad120 size 0x90 virtual false final false
 void set_LateInstallerPrefabs(System::Collections::Generic::IEnumerable_1<Zenject::MonoInstaller> value) ;

/// @brief Method get_LateScriptableObjectInstallers addr 0x2dad1b0 size 0x8 virtual false final false
 System::Collections::Generic::IEnumerable_1<Zenject::ScriptableObjectInstaller> get_LateScriptableObjectInstallers() ;

/// @brief Method set_LateScriptableObjectInstallers addr 0x2dad1b8 size 0x90 virtual false final false
 void set_LateScriptableObjectInstallers(System::Collections::Generic::IEnumerable_1<Zenject::ScriptableObjectInstaller> value) ;

/// @brief Method get_DecoratedContractName addr 0x2dad248 size 0x8 virtual false final false
 ::StringW get_DecoratedContractName() ;

/// @brief Method get_Container addr 0x2dad250 size 0x20 virtual true final false
 Zenject::DiContainer get_Container() ;

/// @brief Method GetRootGameObjects addr 0x2dad270 size 0x28 virtual true final false
 System::Collections::Generic::IEnumerable_1<UnityEngine::GameObject> GetRootGameObjects() ;

/// @brief Method Initialize addr 0x2dab93c size 0x1b4 virtual false final false
 void Initialize(Zenject::DiContainer container) ;

/// @brief Method InstallDecoratorSceneBindings addr 0x2dac1fc size 0x80 virtual false final false
 void InstallDecoratorSceneBindings() ;

/// @brief Method InstallDecoratorInstallers addr 0x2dac27c size 0x10 virtual false final false
 void InstallDecoratorInstallers() ;

/// @brief Method GetInjectableMonoBehaviours addr 0x2dad298 size 0x4c virtual true final false
 void GetInjectableMonoBehaviours(System::Collections::Generic::List_1<UnityEngine::MonoBehaviour> monoBehaviours) ;

/// @brief Method InstallLateDecoratorInstallers addr 0x2dac28c size 0xc4 virtual false final false
 void InstallLateDecoratorInstallers() ;

// Ctor Parameters []
explicit SceneDecoratorContext() ;

/// @brief Method .ctor addr 0x2dad2e4 size 0x124 virtual false final false
 void _ctor() ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2dad408 size 0x178 virtual false final false
