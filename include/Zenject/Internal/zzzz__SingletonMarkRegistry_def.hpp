...
/// @brief Method MarkNonSingleton addr 0x2dda108 size 0xac virtual false final false
 void MarkNonSingleton(System::Type type) ;

/// @brief Method MarkSingleton addr 0x2dda1b4 size 0xd4 virtual false final false
 void MarkSingleton(System::Type type) ;

// Ctor Parameters []
explicit SingletonMarkRegistry() ;

/// @brief Method .ctor addr 0x2dda288 size 0xa0 virtual false final false
 void _ctor() ;
