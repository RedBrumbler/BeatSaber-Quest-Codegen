...
template<::cordl_internals::il2cpp_reference_type TDerived>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11108)), TypeDefinitionIndex(TypeDefinitionIndex(11109))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11109), inst: 2 })
