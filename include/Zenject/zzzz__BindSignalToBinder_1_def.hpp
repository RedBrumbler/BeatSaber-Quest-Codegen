...
template<::cordl_internals::il2cpp_reference_type TSignal>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10602))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10602), inst: 2 })
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10603), inst: 2 })
...
template<::cordl_internals::il2cpp_reference_type TSignal,::cordl_internals::il2cpp_reference_type TObject>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10604))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10604), inst: 80 })
...
template<::cordl_internals::il2cpp_reference_type TSignal,::cordl_internals::il2cpp_reference_type TObject>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10605))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10605), inst: 80 })
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10606), inst: 80 })
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10607), inst: 80 })
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10608), inst: 2 })
