...
/// @brief Method .ctor addr 0x2d8471c size 0x2c virtual false final false
 void _ctor(Zenject::SubContainerCreatorBindInfo subContainerBindInfo, Zenject::BindInfo bindInfo) ;

/// @brief Method get_SubContainerCreatorBindInfo addr 0x2d84748 size 0x8 virtual false final false
 Zenject::SubContainerCreatorBindInfo get_SubContainerCreatorBindInfo() ;

/// @brief Method set_SubContainerCreatorBindInfo addr 0x2d84750 size 0x8 virtual false final false
 void set_SubContainerCreatorBindInfo(Zenject::SubContainerCreatorBindInfo value) ;

/// @brief Method WithDefaultGameObjectParent addr 0x2d84758 size 0x1c virtual false final false
