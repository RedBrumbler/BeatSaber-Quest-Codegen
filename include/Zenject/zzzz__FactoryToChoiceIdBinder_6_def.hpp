...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TParam4,::cordl_internals::il2cpp_reference_type TParam5,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10823)), TypeDefinitionIndex(TypeDefinitionIndex(10670)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10670), inst: 1698 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10823), inst: 5947 })
