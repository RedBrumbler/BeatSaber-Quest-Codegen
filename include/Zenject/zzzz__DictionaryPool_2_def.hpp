...
template<::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11047), inst: 2702 }), TypeDefinitionIndex(TypeDefinitionIndex(11047)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3809), inst: 1155 }), TypeDefinitionIndex(TypeDefinitionIndex(11056)), TypeDefinitionIndex(TypeDefinitionIndex(3809))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11056), inst: 80 })
