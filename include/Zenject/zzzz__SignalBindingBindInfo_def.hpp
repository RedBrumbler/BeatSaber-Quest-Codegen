...
/// @brief Method .ctor addr 0x2d7b0ac size 0x28 virtual false final false
 void _ctor(System::Type signalType) ;

/// @brief Method get_Identifier addr 0x2d7b0d4 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_Identifier() ;

/// @brief Method set_Identifier addr 0x2d7b0dc size 0x8 virtual false final false
 void set_Identifier(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_SignalType addr 0x2d7b0e4 size 0x8 virtual false final false
 System::Type get_SignalType() ;

/// @brief Method set_SignalType addr 0x2d7b0ec size 0x8 virtual false final false
