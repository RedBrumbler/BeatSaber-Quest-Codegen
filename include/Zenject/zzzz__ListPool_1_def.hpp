...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11058)), TypeDefinitionIndex(TypeDefinitionIndex(3828)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3828), inst: 3853 }), TypeDefinitionIndex(TypeDefinitionIndex(11047)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11047), inst: 2704 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11058), inst: 2 })
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11058)), TypeDefinitionIndex(TypeDefinitionIndex(11047)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3828), inst: 3853 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11047), inst: 2704 }), TypeDefinitionIndex(TypeDefinitionIndex(3828))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11058), inst: 3026 })
// CS Name: Zenject.ListPool`1
...
template<>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11047), inst: 2704 }), TypeDefinitionIndex(TypeDefinitionIndex(11047)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3828), inst: 3853 }), TypeDefinitionIndex(TypeDefinitionIndex(11058)), TypeDefinitionIndex(TypeDefinitionIndex(3828))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11058), inst: 4216 })
// CS Name: Zenject.ListPool`1
