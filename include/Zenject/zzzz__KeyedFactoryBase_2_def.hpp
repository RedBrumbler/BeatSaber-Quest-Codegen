...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10955), inst: 80 })
...
template<::cordl_internals::il2cpp_reference_type TBase,::cordl_internals::il2cpp_reference_type TKey>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10956))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10956), inst: 80 })
