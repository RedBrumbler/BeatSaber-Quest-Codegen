...
namespace Zenject {
template<typename TObject,typename TSignal>
class Zenject__BindSignalFromBinder_2____c;
}
namespace Zenject {
template<typename TObject,typename TSignal>
class Zenject__BindSignalFromBinder_2____c__DisplayClass8_0;
}
namespace Zenject {
...
namespace Zenject {
template<::cordl_internals::il2cpp_reference_type TObject,::cordl_internals::il2cpp_reference_type TSignal>
class Zenject__BindSignalFromBinder_2____c<TObject,TSignal>;
}
namespace Zenject {
template<::cordl_internals::il2cpp_reference_type TObject,::cordl_internals::il2cpp_reference_type TSignal>
class Zenject__BindSignalFromBinder_2____c__DisplayClass8_0<TObject,TSignal>;
}
// Type: ::<>c
...
template<::cordl_internals::il2cpp_reference_type TObject,::cordl_internals::il2cpp_reference_type TSignal>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10598))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10598), inst: 80 })
// CS Name: Zenject.BindSignalFromBinder`2::<>c
class CORDL_TYPE Zenject__BindSignalFromBinder_2____c<TObject,TSignal> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~Zenject__BindSignalFromBinder_2____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__BindSignalFromBinder_2____c", modifiers: " const&", def_value: None }]
constexpr Zenject__BindSignalFromBinder_2____c(Zenject__BindSignalFromBinder_2____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__BindSignalFromBinder_2____c", modifiers: "&&", def_value: None }]
constexpr Zenject__BindSignalFromBinder_2____c(Zenject__BindSignalFromBinder_2____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Zenject__BindSignalFromBinder_2____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr Zenject__BindSignalFromBinder_2____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Zenject__BindSignalFromBinder_2____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Zenject__BindSignalFromBinder_2____c& operator=(Zenject__BindSignalFromBinder_2____c&& o) noexcept = default;
  constexpr Zenject__BindSignalFromBinder_2____c& operator=(Zenject__BindSignalFromBinder_2____c const& o) noexcept = default;
                


// Fields

static Zenject::Zenject__BindSignalFromBinder_2____c<TObject,TSignal> __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(Zenject::Zenject__BindSignalFromBinder_2____c<TObject,TSignal> value) ;

static Zenject::Zenject__BindSignalFromBinder_2____c<TObject,TSignal> __get___9() ;
...
// Ctor Parameters []
explicit Zenject__BindSignalFromBinder_2____c() ;
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10599), inst: 80 })
// CS Name: Zenject.BindSignalFromBinder`2::<>c__DisplayClass8_0
class CORDL_TYPE Zenject__BindSignalFromBinder_2____c__DisplayClass8_0<TObject,TSignal> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~Zenject__BindSignalFromBinder_2____c__DisplayClass8_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__BindSignalFromBinder_2____c__DisplayClass8_0", modifiers: " const&", def_value: None }]
constexpr Zenject__BindSignalFromBinder_2____c__DisplayClass8_0(Zenject__BindSignalFromBinder_2____c__DisplayClass8_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__BindSignalFromBinder_2____c__DisplayClass8_0", modifiers: "&&", def_value: None }]
constexpr Zenject__BindSignalFromBinder_2____c__DisplayClass8_0(Zenject__BindSignalFromBinder_2____c__DisplayClass8_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Zenject__BindSignalFromBinder_2____c__DisplayClass8_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr Zenject__BindSignalFromBinder_2____c__DisplayClass8_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Zenject__BindSignalFromBinder_2____c__DisplayClass8_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Zenject__BindSignalFromBinder_2____c__DisplayClass8_0& operator=(Zenject__BindSignalFromBinder_2____c__DisplayClass8_0&& o) noexcept = default;
  constexpr Zenject__BindSignalFromBinder_2____c__DisplayClass8_0& operator=(Zenject__BindSignalFromBinder_2____c__DisplayClass8_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit Zenject__BindSignalFromBinder_2____c__DisplayClass8_0() ;
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10600), inst: 80 })
...
public:
// Declarations
using __c__DisplayClass8_0 = Zenject::Zenject__BindSignalFromBinder_2____c__DisplayClass8_0<TObject, TSignal>;

using __c = Zenject::Zenject__BindSignalFromBinder_2____c<TObject, TSignal>;
...
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(Zenject::Zenject__BindSignalFromBinder_2____c, "Zenject", "BindSignalFromBinder`2/<>c");
DEFINE_IL2CPP_ARG_TYPE_GENERIC_CLASS(Zenject::Zenject__BindSignalFromBinder_2____c__DisplayClass8_0, "Zenject", "BindSignalFromBinder`2/<>c__DisplayClass8_0");
