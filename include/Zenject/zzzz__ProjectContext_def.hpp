...
/// @brief Method add_PreInstall addr 0x2da7fc8 size 0x9c virtual false final false
 void add_PreInstall(System::Action value) ;

/// @brief Method remove_PreInstall addr 0x2da8064 size 0x9c virtual false final false
 void remove_PreInstall(System::Action value) ;

/// @brief Method add_PostInstall addr 0x2da8100 size 0x9c virtual false final false
 void add_PostInstall(System::Action value) ;

/// @brief Method remove_PostInstall addr 0x2da819c size 0x9c virtual false final false
 void remove_PostInstall(System::Action value) ;

/// @brief Method add_PreResolve addr 0x2da8238 size 0x9c virtual false final false
 void add_PreResolve(System::Action value) ;

/// @brief Method remove_PreResolve addr 0x2da82d4 size 0x9c virtual false final false
 void remove_PreResolve(System::Action value) ;

/// @brief Method add_PostResolve addr 0x2da8370 size 0x9c virtual false final false
 void add_PostResolve(System::Action value) ;

/// @brief Method remove_PostResolve addr 0x2da840c size 0x9c virtual false final false
 void remove_PostResolve(System::Action value) ;

/// @brief Method get_Container addr 0x2da84a8 size 0x8 virtual true final false
 Zenject::DiContainer get_Container() ;

/// @brief Method get_HasInstance addr 0x2da84b0 size 0x78 virtual false final false
static bool get_HasInstance() ;

/// @brief Method get_Instance addr 0x2da8528 size 0xa4 virtual false final false
static Zenject::ProjectContext get_Instance() ;

/// @brief Method get_ValidateOnNextRun addr 0x2da8870 size 0x48 virtual false final false
static bool get_ValidateOnNextRun() ;

/// @brief Method set_ValidateOnNextRun addr 0x2da88b8 size 0x4c virtual false final false
static void set_ValidateOnNextRun(bool value) ;

/// @brief Method GetRootGameObjects addr 0x2da8904 size 0xa0 virtual true final false
 System::Collections::Generic::IEnumerable_1<UnityEngine::GameObject> GetRootGameObjects() ;

/// @brief Method TryGetPrefab addr 0x2da89a4 size 0x18c virtual false final false
static UnityEngine::GameObject TryGetPrefab() ;

/// @brief Method InstantiateAndInitialize addr 0x2da85cc size 0x2a4 virtual false final false
static void InstantiateAndInitialize() ;

/// @brief Method get_ParentNewObjectsUnderContext addr 0x2da8f50 size 0x8 virtual false final false
 bool get_ParentNewObjectsUnderContext() ;

/// @brief Method set_ParentNewObjectsUnderContext addr 0x2da8f58 size 0xc virtual false final false
 void set_ParentNewObjectsUnderContext(bool value) ;

/// @brief Method EnsureIsInitialized addr 0x2da8f64 size 0x4 virtual false final false
 void EnsureIsInitialized() ;

/// @brief Method Awake addr 0x2da8f68 size 0x84 virtual false final false
 void Awake() ;

/// @brief Method Initialize addr 0x2da8b30 size 0x420 virtual false final false
 void Initialize() ;

/// @brief Method GetInjectableMonoBehaviours addr 0x2da9dc8 size 0x40 virtual true final false
 void GetInjectableMonoBehaviours(System::Collections::Generic::List_1<UnityEngine::MonoBehaviour> monoBehaviours) ;

/// @brief Method InstallBindings addr 0x2da9a8c size 0x33c virtual false final false
...
/// @brief Method .ctor addr 0x2da9e88 size 0xc virtual false final false
 void _ctor() ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2da9e94 size 0x178 virtual false final false
