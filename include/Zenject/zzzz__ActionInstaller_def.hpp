...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11092)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11092), inst: 3770 })}
...
/// @brief Method .ctor addr 0x2dc4764 size 0x5c virtual false final false
 void _ctor(System::Action_1<Zenject::DiContainer> installMethod) ;

/// @brief Method InstallBindings addr 0x2dd596c size 0x28 virtual true final false
 void InstallBindings() ;

/// @brief Method __zenCreate addr 0x2dd5994 size 0xb4 virtual false final false
static ::bs_hook::Il2CppWrapperType __zenCreate(::ArrayW<::bs_hook::Il2CppWrapperType> P_0) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2dd5a48 size 0x274 virtual false final false
