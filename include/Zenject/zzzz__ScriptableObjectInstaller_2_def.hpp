...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TDerived>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11110)), TypeDefinitionIndex(TypeDefinitionIndex(11115))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11110), inst: 80 })
