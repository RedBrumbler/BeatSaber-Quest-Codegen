...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15695)), TypeDefinitionIndex(TypeDefinitionIndex(11298)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11298), inst: 2994 })}
...
/// @brief Method UpdateItem addr 0x2dd1a7c size 0x9c virtual true final false
 void UpdateItem(Zenject::ITickable task) ;

// Ctor Parameters []
explicit TickablesTaskUpdater() ;

/// @brief Method .ctor addr 0x2dd1b18 size 0x48 virtual false final false
 void _ctor() ;

/// @brief Method __zenCreate addr 0x2dd1b60 size 0x58 virtual false final false
static ::bs_hook::Il2CppWrapperType __zenCreate(::ArrayW<::bs_hook::Il2CppWrapperType> P_0) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2dd1bb8 size 0x1c0 virtual false final false
