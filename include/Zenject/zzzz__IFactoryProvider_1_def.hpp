...
namespace Zenject {
template<>
class IFactoryProvider_1<GlobalNamespace::GlobalNamespace__GraphyController__InitData>;
}
namespace Zenject {
template<>
...
template<::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11155), inst: 3342 }), TypeDefinitionIndex(TypeDefinitionIndex(11156)), TypeDefinitionIndex(TypeDefinitionIndex(11155))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11156), inst: 2 })
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11156)), TypeDefinitionIndex(TypeDefinitionIndex(11155)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11155), inst: 3342 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11156), inst: 374 })
// CS Name: Zenject.IFactoryProvider`1
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11156)), TypeDefinitionIndex(TypeDefinitionIndex(11155)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11155), inst: 3342 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11156), inst: 4831 })
// CS Name: Zenject.IFactoryProvider`1
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11155)), TypeDefinitionIndex(TypeDefinitionIndex(11156)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11155), inst: 3342 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11156), inst: 5961 })
// CS Name: Zenject.IFactoryProvider`1
class CORDL_TYPE IFactoryProvider_1<GlobalNamespace::GlobalNamespace__GraphyController__InitData> : public Zenject::IFactoryProviderBase_1<GlobalNamespace::GlobalNamespace__GraphyController__InitData> {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};
...
// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit IFactoryProvider_1(void* ptr) noexcept : Zenject::IFactoryProviderBase_1<GlobalNamespace::GlobalNamespace__GraphyController__InitData>(ptr) {
}
