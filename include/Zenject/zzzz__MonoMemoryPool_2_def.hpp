...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11012)), TypeDefinitionIndex(TypeDefinitionIndex(11000)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11000), inst: 3366 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11012), inst: 80 })
