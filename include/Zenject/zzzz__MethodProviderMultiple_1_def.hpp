...
namespace Zenject {
template<>
class MethodProviderMultiple_1<GlobalNamespace::GlobalNamespace__GraphyController__InitData>;
}
namespace Zenject {
template<>
...
template<::cordl_internals::il2cpp_reference_type TReturn>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11169))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11169), inst: 2 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11169))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11169), inst: 374 })
// CS Name: Zenject.MethodProviderMultiple`1
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11169))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11169), inst: 4831 })
// CS Name: Zenject.MethodProviderMultiple`1
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11169))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11169), inst: 5961 })
// CS Name: Zenject.MethodProviderMultiple`1
class CORDL_TYPE MethodProviderMultiple_1<GlobalNamespace::GlobalNamespace__GraphyController__InitData> : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief Convert operator to Zenject::IProvider
constexpr operator  Zenject::IProvider() const noexcept;
...
constexpr Zenject::DiContainer __get__container() const;
 ...
 System::Func_2<Zenject::InjectContext,System::Collections::Generic::IEnumerable_1<GlobalNamespace::GlobalNamespace__GraphyController__InitData>> __declspec(property(get=__get__method, put=__set__method))  _method;

constexpr void __set__method(System::Func_2<Zenject::InjectContext,System::Collections::Generic::IEnumerable_1<GlobalNamespace::GlobalNamespace__GraphyController__InitData>> value) ;

constexpr System::Func_2<Zenject::InjectContext,System::Collections::Generic::IEnumerable_1<GlobalNamespace::GlobalNamespace__GraphyController__InitData>> __get__method() const;
...
explicit MethodProviderMultiple_1(System::Func_2<Zenject::InjectContext,System::Collections::Generic::IEnumerable_1<GlobalNamespace::GlobalNamespace__GraphyController__InitData>> method, Zenject::DiContainer container) ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
 void _ctor(System::Func_2<Zenject::InjectContext,System::Collections::Generic::IEnumerable_1<GlobalNamespace::GlobalNamespace__GraphyController__InitData>> method, Zenject::DiContainer container) ;
