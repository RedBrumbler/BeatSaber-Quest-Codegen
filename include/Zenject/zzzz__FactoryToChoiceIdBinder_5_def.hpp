...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TParam4,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10669)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10669), inst: 1697 }), TypeDefinitionIndex(TypeDefinitionIndex(10822))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10822), inst: 5946 })
