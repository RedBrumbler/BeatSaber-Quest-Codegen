...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10686), inst: 1722 }), TypeDefinitionIndex(TypeDefinitionIndex(10810)), TypeDefinitionIndex(TypeDefinitionIndex(10686))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10810), inst: 80 })
...
template<::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10810)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10686), inst: 1722 }), TypeDefinitionIndex(TypeDefinitionIndex(10686))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10810), inst: 1538 })
// CS Name: Zenject.FactoryToChoiceBinder`2
