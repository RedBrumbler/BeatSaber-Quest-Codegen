...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10813)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10708), inst: 1740 }), TypeDefinitionIndex(TypeDefinitionIndex(10708))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10813), inst: 5945 })
