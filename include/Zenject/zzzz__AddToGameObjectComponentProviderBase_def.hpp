...
namespace Zenject {
class Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0;
}
...
class CORDL_TYPE Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x40};

virtual ~Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0", modifiers: " const&", def_value: None }]
constexpr Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0(Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0", modifiers: "&&", def_value: None }]
constexpr Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0(Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0& operator=(Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0&& o) noexcept = default;
  constexpr Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0& operator=(Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0 const& o) noexcept = default;
...
// Ctor Parameters []
explicit Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0() ;

/// @brief Method .ctor addr 0x2dbf3b4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetAllInstancesWithInjectSplit>b__0 addr 0x2dbf3bc size 0x244 virtual false final false
 void _GetAllInstancesWithInjectSplit_b__0() ;

/// @brief Method __zenCreate addr 0x2dbf600 size 0x5c virtual false final false
static ::bs_hook::Il2CppWrapperType __zenCreate(::ArrayW<::bs_hook::Il2CppWrapperType> P_0) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2dbf65c size 0x1c0 virtual false final false
...
public:
// Declarations
using __c__DisplayClass17_0 = Zenject::Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0;
...
/// @brief Method .ctor addr 0x2dbef18 size 0xe0 virtual false final false
...
/// @brief Method get_IsCached addr 0x2dbf0c0 size 0x8 virtual true final true
 bool get_IsCached() ;

/// @brief Method get_TypeVariesBasedOnMemberType addr 0x2dbf0c8 size 0x8 virtual true final true
 bool get_TypeVariesBasedOnMemberType() ;

/// @brief Method get_Container addr 0x2dbf0d0 size 0x8 virtual false final false
 Zenject::DiContainer get_Container() ;

/// @brief Method get_ComponentType addr 0x2dbf0d8 size 0x8 virtual false final false
...
/// @brief Method GetInstanceType addr 0x2dbf0e0 size 0x8 virtual true final true
 System::Type GetInstanceType(Zenject::InjectContext context) ;

/// @brief Method GetAllInstancesWithInjectSplit addr 0x2dbf0e8 size 0x2cc virtual true final true
...
NEED_NO_BOX(Zenject::Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0);
DEFINE_IL2CPP_ARG_TYPE(Zenject::Zenject__AddToGameObjectComponentProviderBase____c__DisplayClass17_0, "Zenject", "AddToGameObjectComponentProviderBase/<>c__DisplayClass17_0");
