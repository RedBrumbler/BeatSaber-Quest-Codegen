...
/// @brief Method .ctor addr 0x2d97864 size 0x84 virtual false final false
 void _ctor() ;

/// @brief Method get_BindingInheritanceMethod addr 0x2d97a24 size 0xa8 virtual false final false
 Zenject::BindingInheritanceMethods get_BindingInheritanceMethod() ;

/// @brief Method get_HasFinalizer addr 0x2d97b10 size 0x10 virtual false final false
 bool get_HasFinalizer() ;

/// @brief Method SetFinalizer addr 0x2d97b20 size 0x8 virtual false final false
 void SetFinalizer(Zenject::IBindingFinalizer bindingFinalizer) ;

/// @brief Method AssertHasFinalizer addr 0x2d97acc size 0x44 virtual false final false
 void AssertHasFinalizer() ;

/// @brief Method AddDisposable addr 0x2d97b28 size 0xa8 virtual false final false
 void AddDisposable(System::IDisposable disposable) ;

/// @brief Method SpawnBindInfo addr 0x2d97bd0 size 0x6c virtual false final false
 Zenject::BindInfo SpawnBindInfo() ;

/// @brief Method FinalizeBinding addr 0x2d97c3c size 0xb4 virtual false final false
 void FinalizeBinding(Zenject::DiContainer container) ;

/// @brief Method Reset addr 0x2d978e8 size 0x13c virtual false final false
 void Reset() ;

/// @brief Method Dispose addr 0x2d97cf0 size 0x58 virtual true final true
 void Dispose() ;
