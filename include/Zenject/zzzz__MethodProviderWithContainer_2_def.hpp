...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11173))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11173), inst: 80 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11173))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11173), inst: 1538 })
// CS Name: Zenject.MethodProviderWithContainer`2
