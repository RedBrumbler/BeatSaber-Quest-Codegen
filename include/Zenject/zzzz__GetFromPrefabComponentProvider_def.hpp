...
/// @brief Method .ctor addr 0x2dbfd3c size 0x3c virtual false final false
 void _ctor(System::Type componentType, Zenject::IPrefabInstantiator prefabInstantiator, bool matchSingle) ;

/// @brief Method get_IsCached addr 0x2dbfd78 size 0x8 virtual true final true
 bool get_IsCached() ;

/// @brief Method get_TypeVariesBasedOnMemberType addr 0x2dbfd80 size 0x8 virtual true final true
 bool get_TypeVariesBasedOnMemberType() ;

/// @brief Method GetInstanceType addr 0x2dbfd88 size 0x8 virtual true final true
 System::Type GetInstanceType(Zenject::InjectContext context) ;

/// @brief Method GetAllInstancesWithInjectSplit addr 0x2dbfd90 size 0x304 virtual true final true
