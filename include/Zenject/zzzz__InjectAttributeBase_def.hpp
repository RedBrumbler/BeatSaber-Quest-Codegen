...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15670))}
...
/// @brief Method get_Optional addr 0x2d72458 size 0x8 virtual false final false
 bool get_Optional() ;

/// @brief Method set_Optional addr 0x2d72460 size 0xc virtual false final false
 void set_Optional(bool value) ;

/// @brief Method get_Id addr 0x2d7246c size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_Id() ;

/// @brief Method set_Id addr 0x2d72474 size 0x8 virtual false final false
 void set_Id(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_Source addr 0x2d7247c size 0x8 virtual false final false
 Zenject::InjectSources get_Source() ;

/// @brief Method set_Source addr 0x2d72484 size 0x8 virtual false final false
 void set_Source(Zenject::InjectSources value) ;

// Ctor Parameters []
explicit InjectAttributeBase() ;

/// @brief Method .ctor addr 0x2d7248c size 0x8 virtual false final false
 void _ctor() ;
