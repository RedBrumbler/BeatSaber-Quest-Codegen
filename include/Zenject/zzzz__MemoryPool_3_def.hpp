...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11001)), TypeDefinitionIndex(TypeDefinitionIndex(11010)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11010), inst: 2665 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11001), inst: 5162 })
