...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11055)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11045), inst: 2705 }), TypeDefinitionIndex(TypeDefinitionIndex(11045))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11055), inst: 2 })
