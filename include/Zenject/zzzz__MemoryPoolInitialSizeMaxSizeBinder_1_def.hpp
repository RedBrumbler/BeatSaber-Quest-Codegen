...
template<::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10829)), TypeDefinitionIndex(TypeDefinitionIndex(10828)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10828), inst: 1692 })}
