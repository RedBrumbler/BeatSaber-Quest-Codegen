...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TContract,::cordl_internals::il2cpp_reference_type TMemoryPool>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11180)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11180), inst: 4694 }), TypeDefinitionIndex(TypeDefinitionIndex(11182))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11182), inst: 5162 })
