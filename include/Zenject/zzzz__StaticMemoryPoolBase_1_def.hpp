...
template<::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11045), inst: 151 }), TypeDefinitionIndex(TypeDefinitionIndex(11046)), TypeDefinitionIndex(TypeDefinitionIndex(11045))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11046), inst: 2 })
