...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Zenject::InstanceProvider::*)(System::Type, ::bs_hook::Il2CppWrapperType, Zenject::DiContainer)>(&Zenject::InstanceProvider::_ctor)> {
  constexpr static std::size_t size = 0x3c;
  constexpr static std::size_t addrs = 0x2dc05e8;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<System::Type>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::bs_hook::Il2CppWrapperType>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<Zenject::DiContainer>::get()}
                        )));
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Zenject::InstanceProvider::*)()>(&Zenject::InstanceProvider::get_IsCached)> {
  ...
  constexpr static std::size_t addrs = 0x2dc0624;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (Zenject::InstanceProvider::*)()>(&Zenject::InstanceProvider::get_TypeVariesBasedOnMemberType)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2dc062c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Type (Zenject::InstanceProvider::*)(Zenject::InjectContext)>(&Zenject::InstanceProvider::GetInstanceType)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2dc0634;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Zenject::InstanceProvider::*)(Zenject::InjectContext, System::Collections::Generic::List_1<Zenject::TypeValuePair>, ByRef<System::Action>, System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType>)>(&Zenject::InstanceProvider::GetAllInstancesWithInjectSplit)> {
  constexpr static std::size_t size = 0x1a4;
  constexpr static std::size_t addrs = 0x2dc063c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (Zenject::InstanceProvider::*)()>(&Zenject::InstanceProvider::_GetAllInstancesWithInjectSplit_b__9_0)> {
  ...
  constexpr static std::size_t addrs = 0x2dc07e0;
...
constexpr  Zenject::InstanceProvider::operator Zenject::IProvider() const noexcept {
return Zenject::IProvider(::bs_hook::Il2CppWrapperType::instance);
}
constexpr void Zenject::InstanceProvider::__set__instance(::bs_hook::Il2CppWrapperType value)  {
...
constexpr ::bs_hook::Il2CppWrapperType Zenject::InstanceProvider::__get__instance() const {
...
constexpr System::Type Zenject::InstanceProvider::__get__instanceType() const {
...
constexpr Zenject::DiContainer Zenject::InstanceProvider::__get__container() const {
...
// Ctor Parameters [CppParam { name: "instanceType", ty: "System::Type", modifiers: "", def_value: None }, CppParam { name: "instance", ty: "::bs_hook::Il2CppWrapperType", modifiers: "", def_value: None }, CppParam { name: "container", ty: "Zenject::DiContainer", modifiers: "", def_value: None }]
 Zenject::InstanceProvider::InstanceProvider(System::Type instanceType, ::bs_hook::Il2CppWrapperType instance, Zenject::DiContainer container)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<InstanceProvider>(instanceType, instance, container))) {}
 void Zenject::InstanceProvider::_ctor(System::Type instanceType, ::bs_hook::Il2CppWrapperType instance, Zenject::DiContainer container)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::InstanceProvider>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, instanceType, instance, container);
}
...
return ::cordl_internals::RunMethodRethrow<System::Type, false>(const_cast<void*>(instance), ___internal_method, context);
 ...
 void Zenject::InstanceProvider::GetAllInstancesWithInjectSplit(Zenject::InjectContext context, System::Collections::Generic::List_1<Zenject::TypeValuePair> args, ByRef<System::Action> injectAction, System::Collections::Generic::List_1<::bs_hook::Il2CppWrapperType> buffer)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::InstanceProvider>::get(),
                            "GetAllInstancesWithInjectSplit",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, context, args, injectAction, buffer);
 ...
 void Zenject::InstanceProvider::_GetAllInstancesWithInjectSplit_b__9_0()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<Zenject::InstanceProvider>::get(),
                            "<GetAllInstancesWithInjectSplit>b__9_0",
                            std::vector<Il2CppClass*>{},
