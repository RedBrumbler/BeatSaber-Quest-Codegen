...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11155)), TypeDefinitionIndex(TypeDefinitionIndex(11157)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11155), inst: 3343 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11157), inst: 80 })
