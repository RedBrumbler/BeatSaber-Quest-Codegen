...
template<::cordl_internals::il2cpp_reference_type TParam1,::cordl_internals::il2cpp_reference_type TParam2,::cordl_internals::il2cpp_reference_type TParam3,::cordl_internals::il2cpp_reference_type TParam4,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11041)), TypeDefinitionIndex(TypeDefinitionIndex(11051)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11051), inst: 3509 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11041), inst: 5946 })
