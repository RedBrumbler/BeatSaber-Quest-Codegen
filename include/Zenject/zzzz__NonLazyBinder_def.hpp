...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10883))}
...
/// @brief Method .ctor addr 0x2d93ebc size 0x28 virtual false final false
 void _ctor(Zenject::BindInfo bindInfo) ;

/// @brief Method NonLazy addr 0x2d93ee4 size 0x20 virtual false final false
 Zenject::IfNotBoundBinder NonLazy() ;

/// @brief Method Lazy addr 0x2d93f04 size 0x1c virtual false final false
