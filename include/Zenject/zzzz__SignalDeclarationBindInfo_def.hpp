...
/// @brief Method .ctor addr 0x2d7b0f4 size 0x28 virtual false final false
 void _ctor(System::Type signalType) ;

/// @brief Method get_Identifier addr 0x2d7b11c size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_Identifier() ;

/// @brief Method set_Identifier addr 0x2d7b124 size 0x8 virtual false final false
 void set_Identifier(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_SignalType addr 0x2d7b12c size 0x8 virtual false final false
 System::Type get_SignalType() ;

/// @brief Method set_SignalType addr 0x2d7b134 size 0x8 virtual false final false
 void set_SignalType(System::Type value) ;

/// @brief Method get_RunAsync addr 0x2d7b13c size 0x8 virtual false final false
 bool get_RunAsync() ;

/// @brief Method set_RunAsync addr 0x2d7b144 size 0xc virtual false final false
 void set_RunAsync(bool value) ;

/// @brief Method get_TickPriority addr 0x2d7b150 size 0x8 virtual false final false
 int32_t get_TickPriority() ;

/// @brief Method set_TickPriority addr 0x2d7b158 size 0x8 virtual false final false
 void set_TickPriority(int32_t value) ;

/// @brief Method get_MissingHandlerResponse addr 0x2d7b160 size 0x8 virtual false final false
 Zenject::SignalMissingHandlerResponses get_MissingHandlerResponse() ;

/// @brief Method set_MissingHandlerResponse addr 0x2d7b168 size 0x8 virtual false final false
