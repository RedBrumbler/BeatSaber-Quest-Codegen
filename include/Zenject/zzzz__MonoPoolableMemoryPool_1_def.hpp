...
template<::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11017)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10999), inst: 2654 }), TypeDefinitionIndex(TypeDefinitionIndex(10999))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11017), inst: 2 })
