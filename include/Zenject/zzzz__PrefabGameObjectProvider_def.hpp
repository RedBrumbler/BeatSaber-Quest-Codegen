...
/// @brief Method .ctor addr 0x2dc03f4 size 0x28 virtual false final false
 void _ctor(Zenject::IPrefabInstantiator prefabCreator) ;

/// @brief Method get_IsCached addr 0x2dc041c size 0x8 virtual true final true
 bool get_IsCached() ;

/// @brief Method get_TypeVariesBasedOnMemberType addr 0x2dc0424 size 0x8 virtual true final true
 bool get_TypeVariesBasedOnMemberType() ;

/// @brief Method GetInstanceType addr 0x2dc042c size 0x6c virtual true final true
 System::Type GetInstanceType(Zenject::InjectContext context) ;

/// @brief Method GetAllInstancesWithInjectSplit addr 0x2dc0498 size 0x150 virtual true final true
