...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10678), inst: 80 })
...
template<::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10680))}
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10681), inst: 80 })
...
template<::cordl_internals::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10682))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10682), inst: 2 })
