...
/// @brief Method ComputeHash addr 0xf475d4 size 0x164 virtual false final false
static ::StringW ComputeHash(::StringW text, ::StringW salt) ;

/// @brief Method Decrypt addr 0xf47738 size 0x108 virtual false final false
static ::StringW Decrypt(::StringW cipherText, ::StringW key, ::StringW iv) ;

/// @brief Method Encrypt addr 0xf47a60 size 0xf4 virtual false final false
static ::StringW Encrypt(::StringW plainText, ::StringW key, ::StringW iv) ;

/// @brief Method GenerateText addr 0xf47b54 size 0xc4 virtual false final false
static ::StringW GenerateText(int32_t size) ;

/// @brief Method CreateCipher addr 0xf47840 size 0x220 virtual false final false
static Org::BouncyCastle::Crypto::IBufferedCipher CreateCipher(bool isEncryption, ::StringW key, ::StringW iv) ;

// Ctor Parameters []
explicit Security() ;

/// @brief Method .ctor addr 0xf47c18 size 0x8 virtual false final false
 void _ctor() ;
