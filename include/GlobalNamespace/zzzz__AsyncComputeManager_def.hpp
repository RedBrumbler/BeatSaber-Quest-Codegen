...
/// @brief Method .ctor addr 0xdaae7c size 0x140 virtual false final false
 void _ctor() ;

/// @brief Method Dispose addr 0xdaafbc size 0x68 virtual true final true
 void Dispose() ;

/// @brief Method BeginOperation addr 0xdab024 size 0x58 virtual true final true
...
/// @brief Method ComputeThreadRun addr 0xdab07c size 0x160 virtual false final false
