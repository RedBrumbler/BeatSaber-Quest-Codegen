...
/// @brief Method Update addr 0x21df05c size 0x1c virtual false final false
 void Update() ;

/// @brief Method Init addr 0x21dd238 size 0x26c virtual false final false
...
/// @brief Method StartPlayback addr 0x21dd8dc size 0xe8 virtual false final false
 void StartPlayback() ;

/// @brief Method PlaybackTick addr 0x21df078 size 0x3a0 virtual false final false
 void PlaybackTick(float_t time) ;

/// @brief Method StopPlayback addr 0x21dd854 size 0xc virtual false final false
 void StopPlayback() ;

// Ctor Parameters []
explicit PosesPlayback() ;

/// @brief Method .ctor addr 0x21df418 size 0x8 virtual false final false
 void _ctor() ;
