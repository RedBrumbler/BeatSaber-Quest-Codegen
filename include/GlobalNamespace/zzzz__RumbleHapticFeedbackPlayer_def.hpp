...
/// @brief Method .ctor addr 0x1fc6a4c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Awake addr 0x1fc62bc size 0xe0 virtual false final false
 void Awake() ;

/// @brief Method PlayHapticFeedback addr 0x1fc639c size 0xc8 virtual true final true
 void PlayHapticFeedback(UnityEngine::XR::XRNode node, Libraries::HM::HMLib::VR::HapticPresetSO hapticPreset) ;

/// @brief Method CanPlayHapticPreset addr 0x1fc6584 size 0x40 virtual true final true
 bool CanPlayHapticPreset(Libraries::HM::HMLib::VR::HapticPresetSO hapticPreset) ;

/// @brief Method LateUpdate addr 0x1fc65c4 size 0x4 virtual false final false
 void LateUpdate() ;

/// @brief Method UpdateRumbles addr 0x1fc65c8 size 0x484 virtual false final false
 void UpdateRumbles() ;

/// @brief Method GetRumble addr 0x1fc6464 size 0x120 virtual false final false
...
/// @brief Method .ctor addr 0x1fc6a54 size 0x7c virtual false final false
 void _ctor() ;
