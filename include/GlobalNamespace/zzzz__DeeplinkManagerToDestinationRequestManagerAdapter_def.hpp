...
/// @brief Method add_didSendMenuDestinationRequestEvent addr 0x21f2490 size 0xb0 virtual true final true
 void add_didSendMenuDestinationRequestEvent(System::Action_1<GlobalNamespace::MenuDestination> value) ;

/// @brief Method remove_didSendMenuDestinationRequestEvent addr 0x21f2540 size 0xb0 virtual true final true
 void remove_didSendMenuDestinationRequestEvent(System::Action_1<GlobalNamespace::MenuDestination> value) ;

/// @brief Method get_currentMenuDestinationRequest addr 0x21f25f0 size 0x8 virtual true final true
 GlobalNamespace::MenuDestination get_currentMenuDestinationRequest() ;

/// @brief Method set_currentMenuDestinationRequest addr 0x21f25f8 size 0x20 virtual true final true
 void set_currentMenuDestinationRequest(GlobalNamespace::MenuDestination value) ;

/// @brief Method Init addr 0x21f2618 size 0x1cc virtual false final false
 void Init(GlobalNamespace::IDeeplinkManager deeplinkManager) ;

/// @brief Method Clear addr 0x21f2da8 size 0x8 virtual true final true
 void Clear() ;

/// @brief Method HandleDeeplinkManagerDidReceiveDeeplink addr 0x21f27e4 size 0x5c4 virtual false final false
...
/// @brief Method .ctor addr 0x21f2fd4 size 0x8 virtual false final false
 void _ctor() ;
