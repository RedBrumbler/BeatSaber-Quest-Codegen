...
/// @brief Method Init addr 0x20ec270 size 0x384 virtual false final false
 void Init() ;

/// @brief Method PreInstall addr 0x20ec700 size 0x8 virtual false final false
 void PreInstall(GlobalNamespace::MockPlayersModel mockPlayersModel) ;

/// @brief Method InstallBindings addr 0x20ec708 size 0x1a24 virtual false final false
 void InstallBindings(Zenject::DiContainer container, bool isRunningFromTests) ;

/// @brief Method InstallHapticsController addr 0x20ee4a0 size 0x1c0 virtual false final false
 void InstallHapticsController(Zenject::DiContainer container) ;

/// @brief Method InstallRichPresence addr 0x20ee224 size 0xf0 virtual false final false
 void InstallRichPresence(Zenject::DiContainer container, bool isRunningFromTests) ;

/// @brief Method InstallOculusDestinationBindings addr 0x20ee12c size 0xf8 virtual false final false
 void InstallOculusDestinationBindings(Zenject::DiContainer container) ;

/// @brief Method InstallPlatformLeaderboardsModel addr 0x20ee314 size 0x18c virtual false final false
 void InstallPlatformLeaderboardsModel(Zenject::DiContainer container) ;

/// @brief Method InstallPS5Bindings addr 0x20ee660 size 0x4 virtual false final false
 void InstallPS5Bindings(Zenject::DiContainer container) ;

/// @brief Method InstallPS4Bindings addr 0x20ee664 size 0x4 virtual false final false
 void InstallPS4Bindings(Zenject::DiContainer container) ;

// Ctor Parameters []
explicit MainSystemInit() ;

/// @brief Method .ctor addr 0x20ee668 size 0x74 virtual false final false
 void _ctor() ;
