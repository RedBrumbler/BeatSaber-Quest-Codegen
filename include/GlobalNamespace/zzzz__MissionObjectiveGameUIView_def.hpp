...
/// @brief Method SetMissionObjectiveChecker addr 0x22af8f8 size 0x27c virtual false final false
 void SetMissionObjectiveChecker(GlobalNamespace::MissionObjectiveChecker missionObjectiveChecker) ;

/// @brief Method HandleMissionObjectiveStatusDidChange addr 0x22afcd0 size 0x4 virtual false final false
 void HandleMissionObjectiveStatusDidChange(GlobalNamespace::MissionObjectiveChecker missionObjectiveChecker) ;

/// @brief Method HandleMissionObjectiveCheckedValueDidChange addr 0x22afcd4 size 0x4 virtual false final false
 void HandleMissionObjectiveCheckedValueDidChange(GlobalNamespace::MissionObjectiveChecker missionObjectiveChecker) ;

/// @brief Method RefreshIcon addr 0x22afb74 size 0x104 virtual false final false
 void RefreshIcon() ;

/// @brief Method RefreshValue addr 0x22afc78 size 0x58 virtual false final false
 void RefreshValue() ;

// Ctor Parameters []
explicit MissionObjectiveGameUIView() ;

/// @brief Method .ctor addr 0x22afcd8 size 0x10 virtual false final false
 void _ctor() ;
