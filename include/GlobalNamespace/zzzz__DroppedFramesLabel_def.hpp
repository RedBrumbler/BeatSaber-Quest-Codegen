...
/// @brief Method Start addr 0x1faf654 size 0x74 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x1faf6c8 size 0x90 virtual false final false
 void Update() ;

/// @brief Method RefreshText addr 0x1faf758 size 0x168 virtual false final false
 void RefreshText() ;

// Ctor Parameters []
explicit DroppedFramesLabel() ;

/// @brief Method .ctor addr 0x1faf8c0 size 0x14 virtual false final false
 void _ctor() ;
