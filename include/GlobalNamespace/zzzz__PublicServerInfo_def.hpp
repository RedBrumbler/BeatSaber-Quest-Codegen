...
/// @brief Method .ctor addr 0xdd7014 size 0xc virtual false final false
 void _ctor(::StringW code, int32_t currentPlayerCount) ;

/// @brief Method Serialize addr 0xdd7020 size 0x40 virtual false final false
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0xdd7060 size 0x40 virtual false final false
