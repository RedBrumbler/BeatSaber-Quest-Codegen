...
/// @brief Method add_didChangeLanguageEvent addr 0x21b7dbc size 0x9c virtual false final false
 void add_didChangeLanguageEvent(System::Action value) ;

/// @brief Method remove_didChangeLanguageEvent addr 0x21b7e58 size 0x9c virtual false final false
 void remove_didChangeLanguageEvent(System::Action value) ;

/// @brief Method add_didPressContinueButtonEvent addr 0x21b7ef4 size 0x9c virtual false final false
 void add_didPressContinueButtonEvent(System::Action value) ;

/// @brief Method remove_didPressContinueButtonEvent addr 0x21b7f90 size 0x9c virtual false final false
 void remove_didPressContinueButtonEvent(System::Action value) ;

/// @brief Method DidActivate addr 0x21b802c size 0x100 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method OnDestroy addr 0x21b812c size 0xe0 virtual true final false
 void OnDestroy() ;

/// @brief Method HandleLanguageSettingsControllerOndropDownValueDidChange addr 0x21b820c size 0x1c virtual false final false
 void HandleLanguageSettingsControllerOndropDownValueDidChange() ;

// Ctor Parameters []
explicit SelectLanguageViewController() ;

/// @brief Method .ctor addr 0x21b8228 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__8_0 addr 0x21b8230 size 0x1c virtual false final false
