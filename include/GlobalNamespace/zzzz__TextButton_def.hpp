...
/// @brief Method get_text addr 0x215f488 size 0x8 virtual false final false
 UnityEngine::UI::Text get_text() ;

/// @brief Method get_button addr 0x215f490 size 0x8 virtual false final false
 UnityEngine::UI::Button get_button() ;

// Ctor Parameters []
explicit TextButton() ;

/// @brief Method .ctor addr 0x215f498 size 0x8 virtual false final false
 void _ctor() ;
