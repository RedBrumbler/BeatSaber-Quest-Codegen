...
/// @brief Method get_Handle addr 0x263c954 size 0x8 virtual false final false
 uint64_t get_Handle() ;

/// @brief Method TryGetUuid addr 0x263c95c size 0x6c virtual false final false
 bool TryGetUuid(ByRef<System::Guid> uuid) ;

/// @brief Method get_Valid addr 0x2632b1c size 0x10 virtual false final false
 bool get_Valid() ;

/// @brief Method .ctor addr 0x263c9c8 size 0x8 virtual false final false
 void _ctor(uint64_t handle) ;

/// @brief Method ToString addr 0x263c9d0 size 0x84 virtual true final false
 ::StringW ToString() ;

/// @brief Method Equals addr 0x263ca54 size 0x10 virtual true final true
 bool Equals(GlobalNamespace::OVRSpace other) ;

/// @brief Method Equals addr 0x263ca64 size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x263cadc size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x263cafc size 0xc virtual false final false
static bool op_Equality(GlobalNamespace::OVRSpace lhs, GlobalNamespace::OVRSpace rhs) ;

/// @brief Method op_Inequality addr 0x263cb08 size 0xc virtual false final false
static bool op_Inequality(GlobalNamespace::OVRSpace lhs, GlobalNamespace::OVRSpace rhs) ;

/// @brief Method op_Implicit addr 0x26386bc size 0x4 virtual false final false
static GlobalNamespace::OVRSpace op_Implicit_GlobalNamespace__OVRSpace(uint64_t handle) ;

/// @brief Method op_Implicit addr 0x26327a0 size 0x4 virtual false final false
