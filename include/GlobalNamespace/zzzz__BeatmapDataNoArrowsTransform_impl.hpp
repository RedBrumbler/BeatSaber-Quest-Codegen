...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::IReadonlyBeatmapData (*)(GlobalNamespace::IReadonlyBeatmapData)>(&GlobalNamespace::BeatmapDataNoArrowsTransform::CreateTransformedData)> {
  ...
  constexpr static std::size_t addrs = 0x21f0458;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::BeatmapDataItem (*)(GlobalNamespace::BeatmapDataItem)>(&GlobalNamespace::BeatmapDataNoArrowsTransform::_CreateTransformedData_g__ProcessData_0_0)> {
  ...
  constexpr static std::size_t addrs = 0x21f0544;
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::IReadonlyBeatmapData, false>(nullptr, ___internal_method, beatmapData);
 ...
 GlobalNamespace::BeatmapDataItem GlobalNamespace::BeatmapDataNoArrowsTransform::_CreateTransformedData_g__ProcessData_0_0(GlobalNamespace::BeatmapDataItem beatmapDataItem)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::BeatmapDataNoArrowsTransform>::get(),
                            "<CreateTransformedData>g__ProcessData|0_0",
                            std::vector<Il2CppClass*>{},
