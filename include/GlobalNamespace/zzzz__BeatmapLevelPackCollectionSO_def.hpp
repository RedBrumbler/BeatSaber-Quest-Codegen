...
/// @brief Method get_previewBeatmapLevelPack addr 0x221d2ac size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::PreviewBeatmapLevelPackSO> get_previewBeatmapLevelPack() ;

/// @brief Method set_previewBeatmapLevelPack addr 0x221d2b4 size 0x8 virtual false final false
 void set_previewBeatmapLevelPack(::ArrayW<GlobalNamespace::PreviewBeatmapLevelPackSO> value) ;

/// @brief Method get_beatmapLevelPacks addr 0x221d2bc size 0x24 virtual true final true
 ::ArrayW<GlobalNamespace::IBeatmapLevelPack> get_beatmapLevelPacks() ;

/// @brief Method set_beatmapLevelPacks addr 0x221d4c4 size 0x8 virtual false final false
 void set_beatmapLevelPacks(::ArrayW<GlobalNamespace::IBeatmapLevelPack> value) ;

/// @brief Method LoadAllBeatmapLevelPacks addr 0x221d2e0 size 0x1e4 virtual false final false
 void LoadAllBeatmapLevelPacks() ;

// Ctor Parameters []
explicit BeatmapLevelPackCollectionSO() ;

/// @brief Method .ctor addr 0x221d4cc size 0x8 virtual false final false
 void _ctor() ;
