...
/// @brief Method set_rank addr 0x215cb60 size 0x48 virtual false final false
 void set_rank(int32_t value) ;

/// @brief Method set_playerName addr 0x215cba8 size 0x24 virtual false final false
 void set_playerName(::StringW value) ;

/// @brief Method set_score addr 0x215cbcc size 0xa0 virtual false final false
 void set_score(int32_t value) ;

/// @brief Method set_showSeparator addr 0x215cc6c size 0x20 virtual false final false
 void set_showSeparator(bool value) ;

/// @brief Method set_showFullCombo addr 0x215cc8c size 0x20 virtual false final false
 void set_showFullCombo(bool value) ;

/// @brief Method set_specialScore addr 0x215ccac size 0xf8 virtual false final false
 void set_specialScore(bool value) ;

// Ctor Parameters []
explicit LeaderboardTableCell() ;

/// @brief Method .ctor addr 0x215cda4 size 0x8 virtual false final false
 void _ctor() ;
