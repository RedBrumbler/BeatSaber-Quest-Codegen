...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5025))}
...
/// @brief Method .ctor addr 0x2297e3c size 0xc8 virtual false final false
...
/// @brief Method GetColor addr 0x2297f04 size 0x4c virtual true final false
