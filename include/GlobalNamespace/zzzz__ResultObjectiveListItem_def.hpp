...
/// @brief Method set_iconColor addr 0x21c5cf0 size 0x24 virtual false final false
 void set_iconColor(UnityEngine::Color value) ;

/// @brief Method set_icon addr 0x21c5d14 size 0x1c virtual false final false
 void set_icon(UnityEngine::Sprite value) ;

/// @brief Method set_iconGlow addr 0x21c5d30 size 0x1c virtual false final false
 void set_iconGlow(UnityEngine::Sprite value) ;

/// @brief Method set_title addr 0x21c5d4c size 0x24 virtual false final false
 void set_title(::StringW value) ;

/// @brief Method set_conditionText addr 0x21c5d70 size 0x24 virtual false final false
 void set_conditionText(::StringW value) ;

/// @brief Method set_hideConditionText addr 0x21c5d94 size 0x34 virtual false final false
 void set_hideConditionText(bool value) ;

/// @brief Method set_valueText addr 0x21c5dc8 size 0x24 virtual false final false
 void set_valueText(::StringW value) ;

/// @brief Method set_hideValueText addr 0x21c5dec size 0x34 virtual false final false
 void set_hideValueText(bool value) ;

// Ctor Parameters []
explicit ResultObjectiveListItem() ;

/// @brief Method .ctor addr 0x21c5e20 size 0x8 virtual false final false
 void _ctor() ;
