...
/// @brief Method Start addr 0x2295e24 size 0xa8 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2295ecc size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleBeatmapEvent addr 0x2295ee8 size 0x18 virtual false final false
 void HandleBeatmapEvent(GlobalNamespace::ColorBoostBeatmapEventData basicBeatmapEventData) ;

/// @brief Method ToggleObjects addr 0x2295f00 size 0xc4 virtual false final false
 void ToggleObjects(bool isBoostOn) ;

// Ctor Parameters []
explicit GameObjectSwitchEventEffect() ;

/// @brief Method .ctor addr 0x2295fc4 size 0x8 virtual false final false
 void _ctor() ;
