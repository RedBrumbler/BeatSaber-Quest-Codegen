...
/// @brief Method .ctor addr 0x21abb40 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SongPlayerCrossfadeToLevelAsync>b__0 addr 0x21abb48 size 0x2c virtual false final false
...
/// @brief Method MoveNext addr 0x21abb74 size 0x49c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x21ac010 size 0xc virtual true final true
...
/// @brief Method add_didSelectMissionLevelEvent addr 0x21ab5fc size 0xb0 virtual false final false
...
/// @brief Method remove_didSelectMissionLevelEvent addr 0x21ab6ac size 0xb0 virtual false final false
...
/// @brief Method get_animatedUpdateIsRequired addr 0x21ab75c size 0x1c virtual false final false
 bool get_animatedUpdateIsRequired() ;

/// @brief Method DidActivate addr 0x21ab778 size 0x144 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x21ab8bc size 0x130 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method HandleMissionNodeSelectionManagerDidSelectMissionNode addr 0x21ab9ec size 0x6c virtual false final false
...
/// @brief Method SongPlayerCrossfadeToLevelAsync addr 0x21aba58 size 0xa0 virtual false final false
 void SongPlayerCrossfadeToLevelAsync(GlobalNamespace::IPreviewBeatmapLevel level) ;

/// @brief Method ShowMissionClearedAnimation addr 0x21abaf8 size 0x24 virtual false final false
 void ShowMissionClearedAnimation(System::Action finishCallback) ;

/// @brief Method DeselectSelectedNode addr 0x21abb1c size 0x1c virtual false final false
 void DeselectSelectedNode() ;

// Ctor Parameters []
explicit MissionSelectionMapViewController() ;

/// @brief Method .ctor addr 0x21abb38 size 0x8 virtual false final false
 void _ctor() ;
