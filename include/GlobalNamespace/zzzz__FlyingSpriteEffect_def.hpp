...
/// @brief Method InitAndPresent addr 0x228ac50 size 0xb8 virtual false final false
...
/// @brief Method ManualUpdate addr 0x228ad08 size 0x5c virtual true final false
 void ManualUpdate(float_t t) ;

// Ctor Parameters []
explicit FlyingSpriteEffect() ;

/// @brief Method .ctor addr 0x228ad64 size 0x30 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11011)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 2712 }), TypeDefinitionIndex(TypeDefinitionIndex(4974))}
...
/// @brief Method .ctor addr 0x228ad94 size 0x48 virtual false final false
 void _ctor() ;
