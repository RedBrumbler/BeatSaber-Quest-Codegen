...
/// @brief Method get_badgeDirector addr 0x2138d3c size 0x8 virtual false final false
 UnityEngine::Playables::PlayableDirector get_badgeDirector() ;

/// @brief Method Awake addr 0x2138d44 size 0x20 virtual false final false
 void Awake() ;

/// @brief Method Setup addr 0x2138854 size 0x464 virtual false final false
 void Setup(GlobalNamespace::MultiplayerPlayerResultsData resultData, int32_t position, int32_t playerCount) ;

/// @brief Method SetupBadgeTimeline addr 0x2136320 size 0x57c virtual false final false
...
/// @brief Method .ctor addr 0x2138d64 size 0x102c virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5339)), TypeDefinitionIndex(TypeDefinitionIndex(10966)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10966), inst: 3373 }), TypeDefinitionIndex(TypeDefinitionIndex(12739))}
...
/// @brief Method .ctor addr 0x2139d90 size 0x48 virtual false final false
 void _ctor() ;
