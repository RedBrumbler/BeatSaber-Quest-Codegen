...
/// @brief Method Start addr 0x229d18c size 0x154 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x229d2e0 size 0xe8 virtual false final false
 void Update() ;

/// @brief Method OnDestroy addr 0x229d3c8 size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleBeatmapEvent addr 0x229d3e4 size 0x124 virtual false final false
 void HandleBeatmapEvent(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

// Ctor Parameters []
explicit LightRotationEventEffect() ;

/// @brief Method .ctor addr 0x229d508 size 0x64 virtual false final false
 void _ctor() ;
