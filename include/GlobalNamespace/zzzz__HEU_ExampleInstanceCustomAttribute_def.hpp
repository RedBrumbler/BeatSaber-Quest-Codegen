...
/// @brief Method InstancerCallback addr 0x2012838 size 0x3ac virtual false final false
...
/// @brief Method LogAttr addr 0x2012be4 size 0x154 virtual false final false
static void LogAttr(HoudiniEngineUnity::HEU_OutputAttribute outAttr) ;

// Ctor Parameters []
explicit HEU_ExampleInstanceCustomAttribute() ;

/// @brief Method .ctor addr 0x2012d38 size 0x8 virtual false final false
 void _ctor() ;
