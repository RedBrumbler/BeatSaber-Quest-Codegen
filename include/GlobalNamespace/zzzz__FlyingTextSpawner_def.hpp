...
/// @brief Method SpawnText addr 0x2292b4c size 0x1e0 virtual false final false
...
/// @brief Method HandleFlyingObjectEffectDidFinish addr 0x2292d2c size 0x11c virtual true final true
 void HandleFlyingObjectEffectDidFinish(GlobalNamespace::FlyingObjectEffect flyingObjectEffect) ;

// Ctor Parameters []
explicit FlyingTextSpawner() ;

/// @brief Method .ctor addr 0x2292e48 size 0x28 virtual false final false
 void _ctor() ;
