...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5549)), TypeDefinitionIndex(TypeDefinitionIndex(5550))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5550), inst: 2 })
