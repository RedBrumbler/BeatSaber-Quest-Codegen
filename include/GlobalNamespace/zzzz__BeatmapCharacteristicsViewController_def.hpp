...
/// @brief Method add_didSelectBeatmapCharacteristicEvent addr 0x2197aec size 0xb0 virtual false final false
 void add_didSelectBeatmapCharacteristicEvent(System::Action_1<GlobalNamespace::BeatmapCharacteristicSO> value) ;

/// @brief Method remove_didSelectBeatmapCharacteristicEvent addr 0x2197b9c size 0xb0 virtual false final false
 void remove_didSelectBeatmapCharacteristicEvent(System::Action_1<GlobalNamespace::BeatmapCharacteristicSO> value) ;

/// @brief Method get_beatmapCharacteristicCollection addr 0x2197c4c size 0x8 virtual false final false
 GlobalNamespace::BeatmapCharacteristicCollection get_beatmapCharacteristicCollection() ;

/// @brief Method get_selectedBeatmapCharacteristic addr 0x2197c54 size 0xbc virtual false final false
 GlobalNamespace::BeatmapCharacteristicSO get_selectedBeatmapCharacteristic() ;

/// @brief Method DidActivate addr 0x2197d10 size 0xb4 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x2197dc4 size 0xa0 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method SetData addr 0x2197e64 size 0x64 virtual false final false
...
/// @brief Method HandleBeatmapCharacteristicsTableViewDidSelecteCharacteristic addr 0x2197ec8 size 0x1c0 virtual false final false
...
/// @brief Method .ctor addr 0x2198088 size 0x8 virtual false final false
 void _ctor() ;
