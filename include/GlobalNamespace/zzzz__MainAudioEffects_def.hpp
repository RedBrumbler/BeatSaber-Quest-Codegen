...
/// @brief Method Start addr 0x20f322c size 0x34 virtual false final false
 void Start() ;

/// @brief Method LateUpdate addr 0x20f3260 size 0xbc virtual false final false
 void LateUpdate() ;

/// @brief Method ResumeNormalSound addr 0x20f331c size 0x28 virtual false final false
 void ResumeNormalSound() ;

/// @brief Method TriggerLowPass addr 0x20f3344 size 0x3c virtual false final false
 void TriggerLowPass() ;

// Ctor Parameters []
explicit MainAudioEffects() ;

/// @brief Method .ctor addr 0x20f3380 size 0x10 virtual false final false
 void _ctor() ;
