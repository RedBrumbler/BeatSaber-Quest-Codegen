...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15334))}
...
/// @brief Method get_hasPostProcessEffect addr 0x26a84c0 size 0x8 virtual true final false
 bool get_hasPostProcessEffect() ;

/// @brief Method OnEnable addr 0x26a84c8 size 0x1c virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x26a8608 size 0x30 virtual false final false
 void OnDisable() ;

/// @brief Method LazyInitializeMaterials addr 0x26a84e4 size 0x124 virtual false final false
 void LazyInitializeMaterials() ;

/// @brief Method PreRender addr 0x26a8638 size 0x64 virtual true final false
 void PreRender() ;

/// @brief Method Render addr 0x26a869c size 0x274 virtual true final false
 void Render(UnityEngine::RenderTexture src, UnityEngine::RenderTexture dest, float_t fade) ;

// Ctor Parameters []
explicit PyramidBloomMainEffectSO() ;

/// @brief Method .ctor addr 0x26a8910 size 0x3c virtual false final false
 void _ctor() ;
