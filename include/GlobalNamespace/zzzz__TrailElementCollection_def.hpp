...
/// @brief Method .ctor addr 0x228f858 size 0x1b0 virtual false final false
 void _ctor(int32_t capacity, UnityEngine::Vector3 defaultStartPosition, UnityEngine::Vector3 defaultEndPosition, float_t time) ;

/// @brief Method InitSnapshots addr 0x228fb60 size 0x90 virtual false final false
 void InitSnapshots(UnityEngine::Vector3 defaultStartPosition, UnityEngine::Vector3 defaultEndPosition, float_t time) ;

/// @brief Method SetHeadData addr 0x228ffd4 size 0xb4 virtual false final false
 void SetHeadData(UnityEngine::Vector3 start, UnityEngine::Vector3 end, float_t time) ;

/// @brief Method MoveTailToHead addr 0x2290088 size 0x9c virtual false final false
 void MoveTailToHead() ;

/// @brief Method UpdateDistances addr 0x2290124 size 0x7c virtual false final false
 void UpdateDistances() ;

/// @brief Method Interpolate addr 0x2290fe8 size 0x294 virtual false final false
...
/// @brief Method UpdateLerpState addr 0x22915b0 size 0x110 virtual false final false
...
/// @brief Method GetElement addr 0x22916c0 size 0x44 virtual false final false
