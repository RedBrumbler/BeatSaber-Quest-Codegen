...
/// @brief Method add_didFinishEvent addr 0x20f17e8 size 0xb0 virtual false final false
 void add_didFinishEvent(System::Action_1<GlobalNamespace::BombCutSoundEffect> value) ;

/// @brief Method remove_didFinishEvent addr 0x20f1898 size 0xb0 virtual false final false
 void remove_didFinishEvent(System::Action_1<GlobalNamespace::BombCutSoundEffect> value) ;

/// @brief Method Init addr 0x20f1948 size 0x74 virtual false final false
 void Init(UnityEngine::AudioClip audioClip, GlobalNamespace::Saber saber, float_t volume) ;

/// @brief Method LateUpdate addr 0x20f19bc size 0x90 virtual false final false
 void LateUpdate() ;

/// @brief Method StopPlayingAndFinish addr 0x20f1a4c size 0x50 virtual false final false
 void StopPlayingAndFinish() ;

// Ctor Parameters []
explicit BombCutSoundEffect() ;

/// @brief Method .ctor addr 0x20f1a9c size 0x8 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11011)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 274 }), TypeDefinitionIndex(TypeDefinitionIndex(4043))}
...
/// @brief Method .ctor addr 0x20f1aa4 size 0x48 virtual false final false
 void _ctor() ;
