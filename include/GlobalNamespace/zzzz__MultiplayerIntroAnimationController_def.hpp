...
/// @brief Method OnValidate addr 0x212f374 size 0x57c virtual false final false
 void OnValidate() ;

/// @brief Method SetBeforeIntroValue addr 0x212dc30 size 0x480 virtual false final false
 void SetBeforeIntroValue() ;

/// @brief Method PlayIntroAnimation addr 0x212b578 size 0x114 virtual false final false
 void PlayIntroAnimation(float_t maxDesiredIntroAnimationDuration, System::Action onCompleted) ;

/// @brief Method GetFullIntroAnimationTime addr 0x212b19c size 0x3dc virtual false final false
 float_t GetFullIntroAnimationTime() ;

/// @brief Method BindTimeline addr 0x212f8f0 size 0x788 virtual false final false
 void BindTimeline() ;

/// @brief Method BindRingsAndSetTiming addr 0x2130604 size 0x7f4 virtual false final false
...
/// @brief Method TransitionToAfterIntroAnimationState addr 0x212b68c size 0xd0 virtual false final false
 void TransitionToAfterIntroAnimationState() ;

/// @brief Method CalculatePlayerIndexSequence addr 0x2130078 size 0x58c virtual false final false
...
/// @brief Method SetTimelineMock addr 0x2130df8 size 0x12c virtual false final false
 void SetTimelineMock(GlobalNamespace::MultiplayerTimelineMock multiplayerIntroTimelineMock, bool isDuel) ;

/// @brief Method Completed addr 0x2130f24 size 0x38 virtual false final false
 void Completed() ;

// Ctor Parameters []
explicit MultiplayerIntroAnimationController() ;

/// @brief Method .ctor addr 0x2130f5c size 0x5c virtual false final false
 void _ctor() ;
