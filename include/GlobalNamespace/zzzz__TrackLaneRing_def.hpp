...
/// @brief Method get_destRotZ addr 0x22a655c size 0x8 virtual false final false
 float_t get_destRotZ() ;

/// @brief Method Init addr 0x22a6564 size 0x78 virtual false final false
 void Init(UnityEngine::Vector3 position, UnityEngine::Vector3 positionOffset) ;

/// @brief Method FixedUpdateRing addr 0x22a65dc size 0x74 virtual false final false
 void FixedUpdateRing(float_t fixedDeltaTime) ;

/// @brief Method LateUpdateRing addr 0x22a6650 size 0x68 virtual false final false
 void LateUpdateRing(float_t interpolationFactor) ;

/// @brief Method SetDestRotation addr 0x22a66b8 size 0x8 virtual false final false
 void SetDestRotation(float_t destRotZ, float_t rotateSpeed) ;

/// @brief Method GetRotation addr 0x22a66c0 size 0x8 virtual false final false
 float_t GetRotation() ;

/// @brief Method GetDestinationRotation addr 0x22a66c8 size 0x8 virtual false final false
 float_t GetDestinationRotation() ;

/// @brief Method SetPosition addr 0x22a66d0 size 0x8 virtual false final false
 void SetPosition(float_t destPosZ, float_t moveSpeed) ;

// Ctor Parameters []
explicit TrackLaneRing() ;

/// @brief Method .ctor addr 0x22a66d8 size 0x8 virtual false final false
 void _ctor() ;
