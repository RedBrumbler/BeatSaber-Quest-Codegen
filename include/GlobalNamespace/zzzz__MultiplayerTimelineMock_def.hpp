...
/// @brief Method get_connectedPlayerIntroAnimators addr 0x21e9adc size 0x8 virtual false final false
 ::ArrayW<UnityEngine::GameObject> get_connectedPlayerIntroAnimators() ;

/// @brief Method get_connectedPlayerScoreRings addr 0x21e9ae4 size 0x8 virtual false final false
 ::ArrayW<UnityEngine::GameObject> get_connectedPlayerScoreRings() ;

/// @brief Method get_connectedPlayerOutroAnimators addr 0x21e9aec size 0x8 virtual false final false
 ::ArrayW<UnityEngine::GameObject> get_connectedPlayerOutroAnimators() ;

/// @brief Method get_localPlayerIntroAnimator addr 0x21e9af4 size 0x8 virtual false final false
 UnityEngine::GameObject get_localPlayerIntroAnimator() ;

/// @brief Method get_localPlayerScoreRingItem addr 0x21e9afc size 0x8 virtual false final false
 UnityEngine::GameObject get_localPlayerScoreRingItem() ;

/// @brief Method get_localPlayerOutroAnimator addr 0x21e9b04 size 0x8 virtual false final false
 UnityEngine::GameObject get_localPlayerOutroAnimator() ;

/// @brief Method get_connectedDuelIntroAnimator addr 0x21e9b0c size 0x8 virtual false final false
 UnityEngine::GameObject get_connectedDuelIntroAnimator() ;

/// @brief Method get_connectedDuelOutroAnimator addr 0x21e9b14 size 0x8 virtual false final false
 UnityEngine::GameObject get_connectedDuelOutroAnimator() ;

/// @brief Method get_localDuelIntroAnimator addr 0x21e9b1c size 0x8 virtual false final false
 UnityEngine::GameObject get_localDuelIntroAnimator() ;

/// @brief Method get_localDuelOutroAnimator addr 0x21e9b24 size 0x8 virtual false final false
 UnityEngine::GameObject get_localDuelOutroAnimator() ;

/// @brief Method get_resultAvatars addr 0x21e9b2c size 0x8 virtual false final false
 ::ArrayW<UnityEngine::GameObject> get_resultAvatars() ;

/// @brief Method get_badgeTimelines addr 0x21e9b34 size 0x8 virtual false final false
 ::ArrayW<UnityEngine::GameObject> get_badgeTimelines() ;

/// @brief Method get_resultsMocks addr 0x21e9b3c size 0x8 virtual false final false
 UnityEngine::GameObject get_resultsMocks() ;

/// @brief Method HandleActivations addr 0x21e9b44 size 0x60 virtual false final false
 void HandleActivations(bool isDuel) ;

// Ctor Parameters []
explicit MultiplayerTimelineMock() ;

/// @brief Method .ctor addr 0x21e9ba4 size 0x8 virtual false final false
 void _ctor() ;
