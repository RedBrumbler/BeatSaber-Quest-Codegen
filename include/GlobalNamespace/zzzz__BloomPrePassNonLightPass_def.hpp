...
/// @brief Method get_executionTimeType addr 0x1fd04c0 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__BloomPrePassNonLightPass__ExecutionTimeType get_executionTimeType() ;

/// @brief Method get_bloomPrePassAfterBlurList addr 0x1fd04c8 size 0x58 virtual false final false
static System::Collections::Generic::List_1<GlobalNamespace::BloomPrePassNonLightPass> get_bloomPrePassAfterBlurList() ;

/// @brief Method get_bloomPrePassBeforeBlurList addr 0x1fd0520 size 0x58 virtual false final false
static System::Collections::Generic::List_1<GlobalNamespace::BloomPrePassNonLightPass> get_bloomPrePassBeforeBlurList() ;

/// @brief Method OnEnable addr 0x1fcef58 size 0x4 virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fd0578 size 0x4 virtual true final false
 void OnDisable() ;

/// @brief Method Register addr 0x1fcedec size 0x124 virtual false final false
 void Register() ;

/// @brief Method Unregister addr 0x1fced30 size 0xbc virtual false final false
 void Unregister() ;

/// @brief Method OnValidate addr 0x1fcf924 size 0x2c virtual true final false
 void OnValidate() ;
...
/// @brief Method .ctor addr 0x1fcd6c0 size 0x8 virtual false final false
 void _ctor() ;
