...
/// @brief Method Start addr 0x21169d8 size 0xf0 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2116ac8 size 0x108 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleBeatmapObjectEventManagerConnectedPlayerBeatmapObjectWasCut addr 0x2116bd0 size 0x1f8 virtual false final false
...
/// @brief Method .ctor addr 0x2116dc8 size 0x8 virtual false final false
 void _ctor() ;
