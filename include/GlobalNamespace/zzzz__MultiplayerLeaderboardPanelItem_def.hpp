...
/// @brief Method SetData addr 0x22b04d8 size 0x2d0 virtual false final false
 void SetData(int32_t position, ::StringW playerName, int32_t score, bool failed, int32_t numberOfPlayers) ;

/// @brief Method set_hide addr 0x22b0264 size 0x2c virtual false final false
 void set_hide(bool value) ;

// Ctor Parameters []
explicit MultiplayerLeaderboardPanelItem() ;

/// @brief Method .ctor addr 0x22b07b0 size 0x14 virtual false final false
 void _ctor() ;
