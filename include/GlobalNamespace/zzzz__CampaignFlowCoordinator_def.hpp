...
/// @brief Method .ctor addr 0x2169190 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <HandleMissionHelpViewControllerDidFinish>b__0 addr 0x2169658 size 0x50 virtual false final false
...
/// @brief Method .ctor addr 0x2169300 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <HandleMissionResultsViewControllerRetryButtonPressed>b__0 addr 0x21696a8 size 0x50 virtual false final false
...
/// @brief Method add_didFinishEvent addr 0x2168790 size 0xb4 virtual false final false
 void add_didFinishEvent(System::Action_1<GlobalNamespace::CampaignFlowCoordinator> value) ;

/// @brief Method remove_didFinishEvent addr 0x2168844 size 0xb4 virtual false final false
 void remove_didFinishEvent(System::Action_1<GlobalNamespace::CampaignFlowCoordinator> value) ;

/// @brief Method DidActivate addr 0x21688f8 size 0x254 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x2168b4c size 0x1b8 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method TopViewControllerWillChange addr 0x2168d04 size 0xf8 virtual true final false
...
/// @brief Method HandleMissionSelectionNavigationControllerDidPressPlayButton addr 0x2168dfc size 0x120 virtual false final false
...
/// @brief Method HandleMissionHelpViewControllerDidFinish addr 0x21690d4 size 0xbc virtual false final false
 void HandleMissionHelpViewControllerDidFinish(GlobalNamespace::MissionHelpViewController viewController) ;

/// @brief Method HandleMissionResultsViewControllerContinueButtonPressed addr 0x2169198 size 0xac virtual false final false
 void HandleMissionResultsViewControllerContinueButtonPressed(GlobalNamespace::MissionResultsViewController viewController) ;

/// @brief Method HandleMissionResultsViewControllerRetryButtonPressed addr 0x2169244 size 0xbc virtual false final false
 void HandleMissionResultsViewControllerRetryButtonPressed(GlobalNamespace::MissionResultsViewController viewController) ;

/// @brief Method StartLevel addr 0x2168f1c size 0x1b8 virtual false final false
 void StartLevel(System::Action beforeSceneSwitchCallback) ;

/// @brief Method HandleMissionLevelSceneDidFinish addr 0x2169308 size 0xe0 virtual false final false
...
/// @brief Method HandleMissionLevelSceneRestarted addr 0x21694b0 size 0x3c virtual false final false
...
/// @brief Method UpdatePlayerStatistics addr 0x21693e8 size 0xc8 virtual false final false
...
/// @brief Method BackButtonWasPressed addr 0x21694ec size 0xa0 virtual true final false
 void BackButtonWasPressed(HMUI::ViewController topViewController) ;

// Ctor Parameters []
explicit CampaignFlowCoordinator() ;

/// @brief Method .ctor addr 0x216958c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <HandleMissionResultsViewControllerContinueButtonPressed>b__21_0 addr 0x2169594 size 0x8c virtual false final false
 void _HandleMissionResultsViewControllerContinueButtonPressed_b__21_0() ;

/// @brief Method <HandleMissionResultsViewControllerContinueButtonPressed>b__21_1 addr 0x2169620 size 0x38 virtual false final false
