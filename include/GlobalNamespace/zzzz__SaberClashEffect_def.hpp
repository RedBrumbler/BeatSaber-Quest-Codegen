...
/// @brief Method Start addr 0x22a0f80 size 0x1b0 virtual false final false
 void Start() ;

/// @brief Method OnDisable addr 0x22a1130 size 0x10 virtual false final false
 void OnDisable() ;

/// @brief Method LateUpdate addr 0x22a1140 size 0xfc virtual false final false
 void LateUpdate() ;

// Ctor Parameters []
explicit SaberClashEffect() ;

/// @brief Method .ctor addr 0x22a123c size 0x8 virtual false final false
 void _ctor() ;
