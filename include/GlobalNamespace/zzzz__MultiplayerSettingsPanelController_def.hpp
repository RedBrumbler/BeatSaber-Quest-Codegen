...
/// @brief Method add_playerActiveStateChangedEvent addr 0x2194454 size 0xb0 virtual false final false
 void add_playerActiveStateChangedEvent(System::Action_1<bool> value) ;

/// @brief Method remove_playerActiveStateChangedEvent addr 0x2194504 size 0xb0 virtual false final false
 void remove_playerActiveStateChangedEvent(System::Action_1<bool> value) ;

/// @brief Method SetLobbyPlayerDataModel addr 0x21945b4 size 0xc virtual false final false
 void SetLobbyPlayerDataModel(GlobalNamespace::ILobbyPlayerData lobbyPlayerData) ;

/// @brief Method HideConnectionSettings addr 0x21946cc size 0x24 virtual false final false
 void HideConnectionSettings(bool hide) ;

/// @brief Method HideSpectateSettings addr 0x21946f0 size 0x24 virtual false final false
 void HideSpectateSettings(bool hide) ;

/// @brief Method SetLobbyCode addr 0x2194714 size 0x1c virtual false final false
 void SetLobbyCode(::StringW code) ;

/// @brief Method Awake addr 0x2194730 size 0xc4 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x21947f4 size 0x14 virtual false final false
 void OnDestroy() ;

/// @brief Method UpdateLocalPlayerIsActiveState addr 0x2194808 size 0x24 virtual false final false
 void UpdateLocalPlayerIsActiveState(bool isActive) ;

/// @brief Method Refresh addr 0x21945c0 size 0x10c virtual true final true
 void Refresh() ;

// Ctor Parameters []
explicit MultiplayerSettingsPanelController() ;

/// @brief Method .ctor addr 0x219482c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__14_0 addr 0x2194834 size 0x24 virtual false final false
