...
/// @brief Method .ctor addr 0x21661c0 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2166460 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2166464 size 0x160 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x21665c4 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x21665cc size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x216660c size 0x8 virtual true final true
...
/// @brief Method add_textDidChangeEvent addr 0x2165ad8 size 0xb0 virtual false final false
 void add_textDidChangeEvent(System::Action_1<::StringW> value) ;

/// @brief Method remove_textDidChangeEvent addr 0x2165b88 size 0xb0 virtual false final false
 void remove_textDidChangeEvent(System::Action_1<::StringW> value) ;

/// @brief Method add_okButtonWasPressedEvent addr 0x2165c38 size 0x9c virtual false final false
 void add_okButtonWasPressedEvent(System::Action value) ;

/// @brief Method remove_okButtonWasPressedEvent addr 0x2165cd4 size 0x9c virtual false final false
 void remove_okButtonWasPressedEvent(System::Action value) ;

/// @brief Method add_cancelButtonWasPressedEvent addr 0x2165d70 size 0x9c virtual false final false
 void add_cancelButtonWasPressedEvent(System::Action value) ;

/// @brief Method remove_cancelButtonWasPressedEvent addr 0x2165e0c size 0x9c virtual false final false
 void remove_cancelButtonWasPressedEvent(System::Action value) ;

/// @brief Method set_hideCancelButton addr 0x2165ea8 size 0x1c virtual false final false
 void set_hideCancelButton(bool value) ;

/// @brief Method get_text addr 0x2165ec4 size 0x24 virtual false final false
 ::StringW get_text() ;

/// @brief Method set_text addr 0x2165ee8 size 0xb4 virtual false final false
 void set_text(::StringW value) ;

/// @brief Method Awake addr 0x2165f9c size 0x18c virtual false final false
 void Awake() ;

/// @brief Method OnEnable addr 0x2166128 size 0x24 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x21661b4 size 0xc virtual false final false
 void OnDisable() ;

/// @brief Method BlinkCursor addr 0x216614c size 0x68 virtual false final false
 System::Collections::IEnumerator BlinkCursor() ;

/// @brief Method HandleUIKeyboardTextKeyWasPressed addr 0x21661e8 size 0xfc virtual false final false
 void HandleUIKeyboardTextKeyWasPressed(char16_t key) ;

/// @brief Method HandleUIKeyboardDeleteButtonWasPressed addr 0x21662e4 size 0x134 virtual false final false
 void HandleUIKeyboardDeleteButtonWasPressed() ;

// Ctor Parameters []
explicit VRTextEntryController() ;

/// @brief Method .ctor addr 0x2166418 size 0x10 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__20_0 addr 0x2166428 size 0x1c virtual false final false
 void _Awake_b__20_0() ;

/// @brief Method <Awake>b__20_1 addr 0x2166444 size 0x1c virtual false final false
 void _Awake_b__20_1() ;
