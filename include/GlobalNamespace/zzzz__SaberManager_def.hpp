...
/// @brief Method .ctor addr 0x2144c78 size 0x30 virtual false final false
...
/// @brief Method get_leftSaber addr 0x2144a18 size 0x8 virtual false final false
 GlobalNamespace::Saber get_leftSaber() ;

/// @brief Method get_rightSaber addr 0x2144a20 size 0x8 virtual false final false
 GlobalNamespace::Saber get_rightSaber() ;

/// @brief Method add_didUpdateSaberPositionsEvent addr 0x21433b0 size 0xb0 virtual false final false
 void add_didUpdateSaberPositionsEvent(System::Action_2<GlobalNamespace::Saber,GlobalNamespace::Saber> value) ;

/// @brief Method remove_didUpdateSaberPositionsEvent addr 0x21434e8 size 0xb0 virtual false final false
 void remove_didUpdateSaberPositionsEvent(System::Action_2<GlobalNamespace::Saber,GlobalNamespace::Saber> value) ;

/// @brief Method set_disableSabers addr 0x2144a28 size 0x10 virtual false final false
 void set_disableSabers(bool value) ;

/// @brief Method Start addr 0x2144a38 size 0x1c virtual false final false
 void Start() ;

/// @brief Method OnDisable addr 0x2144b78 size 0x4 virtual false final false
 void OnDisable() ;

/// @brief Method OnEnable addr 0x2144b7c size 0x10 virtual false final false
 void OnEnable() ;

/// @brief Method Update addr 0x2144b8c size 0x94 virtual false final false
 void Update() ;

/// @brief Method SaberForType addr 0x2144c20 size 0x50 virtual false final false
 GlobalNamespace::Saber SaberForType(GlobalNamespace::SaberType saberType) ;

/// @brief Method RefreshSabers addr 0x2144a54 size 0x124 virtual false final false
 void RefreshSabers() ;

// Ctor Parameters []
explicit SaberManager() ;

/// @brief Method .ctor addr 0x2144c70 size 0x8 virtual false final false
 void _ctor() ;
