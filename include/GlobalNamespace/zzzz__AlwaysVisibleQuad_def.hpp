...
/// @brief Method OnEnable addr 0x26a5a84 size 0x224 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x26a5ca8 size 0xc virtual false final false
 void OnDisable() ;

// Ctor Parameters []
explicit AlwaysVisibleQuad() ;

/// @brief Method .ctor addr 0x26a5cb4 size 0x8 virtual false final false
 void _ctor() ;
