...
/// @brief Method get_test1GroupSize addr 0x21c7a34 size 0x8 virtual false final false
 float_t get_test1GroupSize() ;

/// @brief Method get_test2GroupSize addr 0x21c7a3c size 0x8 virtual false final false
 float_t get_test2GroupSize() ;

/// @brief Method get_experimentName addr 0x21c7a44 size 0x8 virtual false final false
 ::StringW get_experimentName() ;

/// @brief Method get_currentUserTreatmentGroup addr 0x21c7a4c size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__AbTestExperimentDefinitionSO__Group get_currentUserTreatmentGroup() ;

/// @brief Method OnValidate addr 0x21c7a54 size 0x2c virtual false final false
 void OnValidate() ;

/// @brief Method ComputeCurrentUserTreatment addr 0x21c7a80 size 0x18 virtual false final false
 void ComputeCurrentUserTreatment(::StringW userId) ;

/// @brief Method ForceSetTreatmentGroup addr 0x21c7d20 size 0x8 virtual false final false
 void ForceSetTreatmentGroup(GlobalNamespace::GlobalNamespace__AbTestExperimentDefinitionSO__Group group) ;

/// @brief Method AbSplit addr 0x21c7a98 size 0x288 virtual false final false
...
/// @brief Method .ctor addr 0x21c7d28 size 0x18 virtual false final false
 void _ctor() ;
