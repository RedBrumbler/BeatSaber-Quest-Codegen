...
/// @brief Method .ctor addr 0x22b38a8 size 0x17c virtual false final false
 void _ctor(GlobalNamespace::IMultiplayerSessionManager msm) ;

/// @brief Method Dispose addr 0x22b3a50 size 0xc8 virtual true final true
 void Dispose() ;

/// @brief Method SendScore addr 0x22b6dbc size 0x224 virtual false final false
...
/// @brief Method HandleScoreSyncStateUpdate addr 0x22b92f4 size 0x4 virtual false final false
