...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Sprite (GlobalNamespace::AvatarSpritePartSO::*)()>(&GlobalNamespace::AvatarSpritePartSO::get_sprite)> {
  ...
  constexpr static std::size_t addrs = 0x2264278;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::AvatarSpritePartSO::*)()>(&GlobalNamespace::AvatarSpritePartSO::_ctor)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x22642b4;
