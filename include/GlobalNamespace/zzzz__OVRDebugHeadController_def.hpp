...
/// @brief Method Awake addr 0x25ddd88 size 0xf0 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x25dde78 size 0x4 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x25dde7c size 0x524 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit OVRDebugHeadController() ;

/// @brief Method .ctor addr 0x25de3a0 size 0x24 virtual false final false
 void _ctor() ;
