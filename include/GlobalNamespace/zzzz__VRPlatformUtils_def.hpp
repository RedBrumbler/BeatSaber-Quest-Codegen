...
/// @brief Method TriggerValueDefaultImplementation addr 0x1fc09dc size 0x80 virtual false final false
static float_t TriggerValueDefaultImplementation(UnityEngine::XR::XRNode node) ;

/// @brief Method GetMenuButtonDefaultImplementation addr 0x1fc0378 size 0x78 virtual false final false
static bool GetMenuButtonDefaultImplementation() ;

/// @brief Method GetMenuButtonDownDefaultImplementation addr 0x1fc03f4 size 0x78 virtual false final false
static bool GetMenuButtonDownDefaultImplementation() ;

/// @brief Method GetAnyJoystickMaxAxisDefaultImplementation addr 0x1fc0a5c size 0x154 virtual false final false
static UnityEngine::Vector2 GetAnyJoystickMaxAxisDefaultImplementation(GlobalNamespace::IVRPlatformHelper vrPlatformHelper) ;

/// @brief Method StopXR addr 0x1fc0bb0 size 0xe8 virtual false final false
