...
/// @brief Method .ctor addr 0x228b488 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Animate>b__0 addr 0x228b75c size 0x18 virtual false final false
 void _Animate_b__0(float_t val) ;

/// @brief Method <Animate>b__1 addr 0x228b774 size 0x2c virtual false final false
 void _Animate_b__1(float_t val) ;

/// @brief Method <Animate>b__2 addr 0x228b7a0 size 0x50 virtual false final false
 void _Animate_b__2(UnityEngine::Vector3 pos) ;

/// @brief Method <Animate>b__3 addr 0x228b7f0 size 0x40 virtual false final false
...
/// @brief Method .ctor addr 0x228b508 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x228b830 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x228b834 size 0xfc virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x228b930 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x228b938 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x228b978 size 0x8 virtual true final true
...
/// @brief Method OnDestroy addr 0x228af30 size 0x88 virtual true final false
 void OnDestroy() ;

/// @brief Method Awake addr 0x228afb8 size 0x10 virtual false final false
 void Awake() ;

/// @brief Method Init addr 0x228afc8 size 0x88 virtual false final false
 void Init() ;

/// @brief Method Animate addr 0x228b0d4 size 0x3b4 virtual false final false
 void Animate(GlobalNamespace::GlobalNamespace__GhostDuplicationEffect__GhostEffectParams ghostEffectParams) ;

/// @brief Method HideRedundantWithDelay addr 0x228b490 size 0x78 virtual false final false
 System::Collections::IEnumerator HideRedundantWithDelay(float_t delay) ;

/// @brief Method SetDistances addr 0x228b530 size 0xec virtual false final false
 void SetDistances(float_t distance, UnityEngine::Vector3 direction) ;

/// @brief Method set_hide addr 0x228b61c size 0x2c virtual false final false
 void set_hide(bool value) ;

/// @brief Method set_size addr 0x228b648 size 0x84 virtual false final false
 void set_size(float_t value) ;

/// @brief Method get_size addr 0x228b6cc size 0x48 virtual false final false
 float_t get_size() ;

/// @brief Method set_alpha addr 0x228b050 size 0x84 virtual false final false
 void set_alpha(float_t value) ;

/// @brief Method get_alpha addr 0x228b714 size 0x40 virtual false final false
 float_t get_alpha() ;

// Ctor Parameters []
explicit GhostDuplicationEffect() ;

/// @brief Method .ctor addr 0x228b754 size 0x8 virtual false final false
 void _ctor() ;
