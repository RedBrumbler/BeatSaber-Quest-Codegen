...
/// @brief Method Start addr 0x264a2e4 size 0x9c virtual false final false
 void Start() ;

/// @brief Method Update addr 0x264a380 size 0xf0 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit OVRChromaticAberration() ;

/// @brief Method .ctor addr 0x264a470 size 0x10 virtual false final false
 void _ctor() ;
