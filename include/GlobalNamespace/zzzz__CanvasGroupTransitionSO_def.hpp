...
/// @brief Method get_normalAlpha addr 0x215fd98 size 0x8 virtual false final false
 float_t get_normalAlpha() ;

/// @brief Method get_highlightedAlpha addr 0x215fda0 size 0x8 virtual false final false
 float_t get_highlightedAlpha() ;

/// @brief Method get_pressedAlpha addr 0x215fda8 size 0x8 virtual false final false
 float_t get_pressedAlpha() ;

/// @brief Method get_disabledAlpha addr 0x215fdb0 size 0x8 virtual false final false
 float_t get_disabledAlpha() ;

/// @brief Method get_selectedAlpha addr 0x215fdb8 size 0x8 virtual false final false
 float_t get_selectedAlpha() ;

/// @brief Method get_selectedAndHighlightedAlpha addr 0x215fdc0 size 0x8 virtual false final false
 float_t get_selectedAndHighlightedAlpha() ;

// Ctor Parameters []
explicit CanvasGroupTransitionSO() ;

/// @brief Method .ctor addr 0x215fdc8 size 0x8 virtual false final false
 void _ctor() ;
