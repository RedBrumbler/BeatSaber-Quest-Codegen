...
/// @brief Method .ctor addr 0x21bfe04 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x21bfe30 size 0xb8 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x21bfee8 size 0x2b0 virtual true final true
 bool MoveNext() ;

/// @brief Method <>m__Finally1 addr 0x21c01e8 size 0x50 virtual false final false
 void __m__Finally1() ;

/// @brief Method <>m__Finally2 addr 0x21c0198 size 0x50 virtual false final false
 void __m__Finally2() ;

/// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.MonoBehaviour>.get_Current addr 0x21c0238 size 0x8 virtual true final true
 UnityEngine::MonoBehaviour System_Collections_Generic_IEnumerator_UnityEngine_MonoBehaviour__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x21c0240 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x21c0280 size 0x8 virtual true final true
...
/// @brief Method GetEnumerator addr 0x21bfd9c size 0x68 virtual true final true
 System::Collections::Generic::IEnumerator_1<UnityEngine::MonoBehaviour> GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x21bfe2c size 0x4 virtual true final true
...
/// @brief Method .ctor addr 0x21bf458 size 0x28 virtual false final false
...
/// @brief Method get_dataSource addr 0x21bf398 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__GridView__IDataSource get_dataSource() ;

/// @brief Method get_cellsEnumerator addr 0x21bf3a0 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__GridView__GridViewCellsEnumerator get_cellsEnumerator() ;

/// @brief Method set_cellsEnumerator addr 0x21bf3a8 size 0x8 virtual false final false
 void set_cellsEnumerator(GlobalNamespace::GlobalNamespace__GridView__GridViewCellsEnumerator value) ;

/// @brief Method get_rowCount addr 0x21bf3b0 size 0x8 virtual false final false
 int32_t get_rowCount() ;

/// @brief Method get_columnCount addr 0x21bf3b8 size 0x8 virtual false final false
 int32_t get_columnCount() ;

/// @brief Method SetDataSource addr 0x21bf3c0 size 0x98 virtual false final false
 void SetDataSource(GlobalNamespace::GlobalNamespace__GridView__IDataSource newDataSource, bool reloadData) ;

/// @brief Method ReloadData addr 0x21bf480 size 0x774 virtual false final false
 void ReloadData() ;

/// @brief Method GetActiveCellsForIdentifier addr 0x21bfbf4 size 0xe8 virtual false final false
...
/// @brief Method .ctor addr 0x21bfcdc size 0xc0 virtual false final false
 void _ctor() ;
