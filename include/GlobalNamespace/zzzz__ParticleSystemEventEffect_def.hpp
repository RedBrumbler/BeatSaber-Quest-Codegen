...
/// @brief Method Start addr 0x22a013c size 0x1d8 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x22a06d4 size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x22a06f0 size 0xcc virtual false final false
 void Update() ;

/// @brief Method HandleBeatmapEvent addr 0x22a07bc size 0x1cc virtual false final false
 void HandleBeatmapEvent(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

/// @brief Method RefreshParticles addr 0x22a0314 size 0x3c0 virtual false final false
 void RefreshParticles() ;

// Ctor Parameters []
explicit ParticleSystemEventEffect() ;

/// @brief Method .ctor addr 0x22a0988 size 0x18 virtual false final false
 void _ctor() ;
