...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13923), inst: 3261 }), TypeDefinitionIndex(TypeDefinitionIndex(13923)), TypeDefinitionIndex(TypeDefinitionIndex(10204))}
...
/// @brief Method .ctor addr 0x1fbf548 size 0x48 virtual false final false
 void _ctor() ;
