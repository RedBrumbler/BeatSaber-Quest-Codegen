...
/// @brief Method Start addr 0x213ce68 size 0xac virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x213cf24 size 0xd4 virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x213cff8 size 0x7e4 virtual false final false
 void Update() ;

/// @brief Method HandleStateChanged addr 0x213cf14 size 0x10 virtual false final false
...
/// @brief Method .ctor addr 0x213d7dc size 0xe0 virtual false final false
 void _ctor() ;
