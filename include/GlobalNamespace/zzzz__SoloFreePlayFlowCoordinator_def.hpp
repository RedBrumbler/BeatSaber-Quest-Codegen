...
/// @brief Method .ctor addr 0x217d24c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <HandleResultsViewControllerRestartButtonPressed>b__0 addr 0x217d574 size 0x50 virtual false final false
...
/// @brief Method get_gameMode addr 0x217cc04 size 0x40 virtual true final false
 ::StringW get_gameMode() ;

/// @brief Method get_leaderboardViewController addr 0x217cc44 size 0x8 virtual true final false
 GlobalNamespace::LeaderboardViewController get_leaderboardViewController() ;

/// @brief Method get_showBackButtonForMainViewController addr 0x217cc4c size 0x8 virtual true final false
 bool get_showBackButtonForMainViewController() ;

/// @brief Method get_mainTitle addr 0x217cc54 size 0x44 virtual true final false
 ::StringW get_mainTitle() ;

/// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidActivate addr 0x217cc98 size 0x17c virtual true final false
 void SinglePlayerLevelSelectionFlowCoordinatorDidActivate(bool firstActivation, bool addedToHierarchy) ;

/// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate addr 0x217ce14 size 0x134 virtual true final false
 void SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate(bool removedFromHierarchy) ;

/// @brief Method ProcessLevelCompletionResultsAfterLevelDidFinish addr 0x217cf48 size 0x198 virtual true final false
...
/// @brief Method IsNewHighScore addr 0x217d0e0 size 0x28 virtual false final false
...
/// @brief Method Refresh addr 0x217d108 size 0x40 virtual true final false
 void Refresh() ;

/// @brief Method HandleResultsViewControllerContinueButtonPressed addr 0x217d148 size 0x3c virtual false final false
 void HandleResultsViewControllerContinueButtonPressed(GlobalNamespace::ResultsViewController viewController) ;

/// @brief Method HandleResultsViewControllerRestartButtonPressed addr 0x217d184 size 0xc8 virtual false final false
 void HandleResultsViewControllerRestartButtonPressed(GlobalNamespace::ResultsViewController resultsViewController) ;

/// @brief Method __SetupFromDestination addr 0x217d254 size 0x318 virtual false final false
...
/// @brief Method .ctor addr 0x217d56c size 0x8 virtual false final false
 void _ctor() ;
