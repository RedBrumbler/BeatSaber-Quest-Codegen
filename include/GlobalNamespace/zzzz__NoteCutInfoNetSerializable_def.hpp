...
/// @brief Method Obtain addr 0x1223ff0 size 0x64 virtual false final false
static GlobalNamespace::NoteCutInfoNetSerializable Obtain() ;

/// @brief Method Deserialize addr 0x1224054 size 0x118 virtual true final false
 void Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method Serialize addr 0x1224234 size 0x104 virtual true final false
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

// Ctor Parameters []
explicit NoteCutInfoNetSerializable() ;

/// @brief Method .ctor addr 0x12243e0 size 0x58 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0x1224440 size 0xe4 virtual false final false
...
/// @brief Method Init addr 0x1224524 size 0x224 virtual false final false
