...
/// @brief Method get_color addr 0x1fda6c8 size 0xc virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method Awake addr 0x1fda6d4 size 0x80 virtual false final false
 void Awake() ;

/// @brief Method ColorWasSet addr 0x1fda754 size 0x188 virtual true final false
 void ColorWasSet(UnityEngine::Color color) ;

// Ctor Parameters []
explicit MaterialLightWithId() ;

/// @brief Method .ctor addr 0x1fda8dc size 0x64 virtual false final false
 void _ctor() ;
