...
/// @brief Method get_nextScenesTransitionSetupData addr 0x2208220 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2208228 size 0x28 virtual false final false
