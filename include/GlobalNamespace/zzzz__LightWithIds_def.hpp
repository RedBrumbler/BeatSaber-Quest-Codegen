...
/// @brief Method get_lightId addr 0x1fda690 size 0x8 virtual true final true
 int32_t get_lightId() ;

/// @brief Method get_color addr 0x1fda698 size 0xc virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method get_isRegistered addr 0x1fda6a4 size 0x8 virtual true final true
 bool get_isRegistered() ;

/// @brief Method __SetIsRegistered addr 0x1fda6ac size 0xc virtual true final true
 void __SetIsRegistered() ;

/// @brief Method __SetIsUnRegistered addr 0x1fda6b8 size 0x8 virtual true final true
 void __SetIsUnRegistered() ;

// Ctor Parameters []
explicit GlobalNamespace__LightWithIds__LightWithId() ;

/// @brief Method .ctor addr 0x1fd87a0 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x1fd80e0 size 0x28 virtual false final false
 void _ctor(int32_t lightId) ;

/// @brief Method __SetParentLightWithIds addr 0x1fda6c0 size 0x8 virtual false final false
 void __SetParentLightWithIds(GlobalNamespace::LightWithIds parentLightWithIds) ;

/// @brief Method ColorWasSet addr 0x1fd8150 size 0x28 virtual true final false
...
/// @brief Method get_lightWithIds addr 0x1fd9ecc size 0x8 virtual false final false
 System::Collections::Generic::IEnumerable_1<GlobalNamespace::GlobalNamespace__LightWithIds__LightWithId> get_lightWithIds() ;

/// @brief Method Awake addr 0x1fd8834 size 0x38 virtual true final false
 void Awake() ;

/// @brief Method Start addr 0x1fd9efc size 0x4 virtual false final false
 void Start() ;

/// @brief Method OnEnable addr 0x1fd7c20 size 0x4 virtual true final false
 void OnEnable() ;

/// @brief Method MarkChildrenColorAsSet addr 0x1fda2c8 size 0xc virtual false final false
 void MarkChildrenColorAsSet() ;

/// @brief Method SetNewLightsWithIds addr 0x1fd9ed4 size 0x28 virtual false final false
...
/// @brief Method RegisterForColorChanges addr 0x1fd9f00 size 0x3c8 virtual false final false
 void RegisterForColorChanges() ;

/// @brief Method UnregisterFromColorChanges addr 0x1fda2d4 size 0x39c virtual false final false
 void UnregisterFromColorChanges() ;

/// @brief Method OnDisable addr 0x1fda670 size 0x4 virtual false final false
 void OnDisable() ;

/// @brief Method HandleLightManagerDidChangeSomeColorsThisFrame addr 0x1fda674 size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0x1fd80a8 size 0x8 virtual false final false
 void _ctor() ;
