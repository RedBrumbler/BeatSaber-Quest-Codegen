...
/// @brief Method GetEscapedURLForFilePath addr 0x1fac85c size 0x5c virtual false final false
static ::StringW GetEscapedURLForFilePath(::StringW filePath) ;

/// @brief Method GetUniqueDirectoryNameByAppendingNumber addr 0x1fac8b8 size 0xa8 virtual false final false
static ::StringW GetUniqueDirectoryNameByAppendingNumber(::StringW dirName) ;

/// @brief Method GetFilePaths addr 0x1fac960 size 0x234 virtual false final false
static ::ArrayW<::StringW> GetFilePaths(::StringW directoryPath, System::Collections::Generic::HashSet_1<::StringW> extensions) ;

/// @brief Method GetFileNamesFromFilePaths addr 0x1facb94 size 0x174 virtual false final false
static ::ArrayW<::StringW> GetFileNamesFromFilePaths(::ArrayW<::StringW> filePaths) ;

/// @brief Method SaveToJSONFile addr 0x1facd08 size 0x14c virtual false final false
...
/// @brief Method SaveToJSONFile addr 0x1face54 size 0x18c virtual false final false
...
/// @brief Method LoadJSONFile addr 0x1facfe0 size 0xc8 virtual false final false
