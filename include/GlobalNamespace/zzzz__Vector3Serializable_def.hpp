...
/// @brief Method Serialize addr 0x1224338 size 0x54 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0x122416c size 0x64 virtual true final true
 void Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method Equals addr 0x1226810 size 0x34 virtual true final true
 bool Equals(GlobalNamespace::Vector3Serializable other) ;

/// @brief Method Approximately addr 0x1226844 size 0x60 virtual false final false
 bool Approximately(GlobalNamespace::Vector3Serializable other) ;

/// @brief Method Equals addr 0x12268a4 size 0x98 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x122693c size 0x28 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x1226964 size 0x1fc virtual true final false
 ::StringW ToString() ;

/// @brief Method GetSize addr 0x1226b60 size 0x54 virtual false final false
 int32_t GetSize() ;

/// @brief Method .ctor addr 0x1226bd8 size 0x288 virtual false final false
 void _ctor(UnityEngine::Vector3 v) ;

/// @brief Method .ctor addr 0x1226e60 size 0xc virtual false final false
 void _ctor(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method op_Implicit addr 0x1226e6c size 0x28 virtual false final false
static UnityEngine::Vector3 op_Implicit_UnityEngine__Vector3(GlobalNamespace::Vector3Serializable v) ;

/// @brief Method op_Implicit addr 0x1224748 size 0x2c virtual false final false
static GlobalNamespace::Vector3Serializable op_Implicit_GlobalNamespace__Vector3Serializable(UnityEngine::Vector3 v) ;

/// @brief Method op_Addition addr 0x1226e94 size 0x1c virtual false final false
...
/// @brief Method op_Subtraction addr 0x1226eb0 size 0x1c virtual false final false
