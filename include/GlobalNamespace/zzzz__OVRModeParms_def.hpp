...
/// @brief Method Start addr 0x265ac40 size 0x9c virtual false final false
 void Start() ;

/// @brief Method Update addr 0x265acdc size 0xac virtual false final false
 void Update() ;

/// @brief Method TestPowerStateMode addr 0x265ad88 size 0xa4 virtual false final false
 void TestPowerStateMode() ;

// Ctor Parameters []
explicit OVRModeParms() ;

/// @brief Method .ctor addr 0x265ae2c size 0x10 virtual false final false
 void _ctor() ;
