...
/// @brief Method get_enableMixedReality addr 0x1fc0c98 size 0x8 virtual true final true
 bool get_enableMixedReality() ;

/// @brief Method set_enableMixedReality addr 0x1fc0ca0 size 0xc virtual true final true
 void set_enableMixedReality(bool value) ;

/// @brief Method get_extraHiddenLayers addr 0x1fc0cac size 0x8 virtual true final true
 UnityEngine::LayerMask get_extraHiddenLayers() ;

/// @brief Method set_extraHiddenLayers addr 0x1fc0cb4 size 0x8 virtual true final true
 void set_extraHiddenLayers(UnityEngine::LayerMask value) ;

/// @brief Method get_extraVisibleLayers addr 0x1fc0cbc size 0x8 virtual true final true
 UnityEngine::LayerMask get_extraVisibleLayers() ;

/// @brief Method set_extraVisibleLayers addr 0x1fc0cc4 size 0x8 virtual true final true
 void set_extraVisibleLayers(UnityEngine::LayerMask value) ;

/// @brief Method get_dynamicCullingMask addr 0x1fc0ccc size 0x8 virtual true final true
 bool get_dynamicCullingMask() ;

/// @brief Method set_dynamicCullingMask addr 0x1fc0cd4 size 0xc virtual true final true
 void set_dynamicCullingMask(bool value) ;

/// @brief Method get_compositionMethod addr 0x1fc0ce0 size 0x8 virtual true final true
 GlobalNamespace::GlobalNamespace__OVRManager__CompositionMethod get_compositionMethod() ;

/// @brief Method set_compositionMethod addr 0x1fc0ce8 size 0x8 virtual true final true
 void set_compositionMethod(GlobalNamespace::GlobalNamespace__OVRManager__CompositionMethod value) ;

/// @brief Method get_externalCompositionBackdropColorRift addr 0x1fc0cf0 size 0xc virtual true final true
 UnityEngine::Color get_externalCompositionBackdropColorRift() ;

/// @brief Method set_externalCompositionBackdropColorRift addr 0x1fc0cfc size 0xc virtual true final true
 void set_externalCompositionBackdropColorRift(UnityEngine::Color value) ;

/// @brief Method get_externalCompositionBackdropColorQuest addr 0x1fc0d08 size 0xc virtual true final true
 UnityEngine::Color get_externalCompositionBackdropColorQuest() ;

/// @brief Method set_externalCompositionBackdropColorQuest addr 0x1fc0d14 size 0xc virtual true final true
 void set_externalCompositionBackdropColorQuest(UnityEngine::Color value) ;

/// @brief Method get_capturingCameraDevice addr 0x1fc0d20 size 0x8 virtual true final true
 GlobalNamespace::GlobalNamespace__OVRManager__CameraDevice get_capturingCameraDevice() ;

/// @brief Method set_capturingCameraDevice addr 0x1fc0d28 size 0x8 virtual true final true
 void set_capturingCameraDevice(GlobalNamespace::GlobalNamespace__OVRManager__CameraDevice value) ;

/// @brief Method get_flipCameraFrameHorizontally addr 0x1fc0d30 size 0x8 virtual true final true
 bool get_flipCameraFrameHorizontally() ;

/// @brief Method set_flipCameraFrameHorizontally addr 0x1fc0d38 size 0xc virtual true final true
 void set_flipCameraFrameHorizontally(bool value) ;

/// @brief Method get_flipCameraFrameVertically addr 0x1fc0d44 size 0x8 virtual true final true
 bool get_flipCameraFrameVertically() ;

/// @brief Method set_flipCameraFrameVertically addr 0x1fc0d4c size 0xc virtual true final true
 void set_flipCameraFrameVertically(bool value) ;

/// @brief Method get_handPoseStateLatency addr 0x1fc0d58 size 0x8 virtual true final true
 float_t get_handPoseStateLatency() ;

/// @brief Method set_handPoseStateLatency addr 0x1fc0d60 size 0x8 virtual true final true
 void set_handPoseStateLatency(float_t value) ;

/// @brief Method get_sandwichCompositionRenderLatency addr 0x1fc0d68 size 0x8 virtual true final true
 float_t get_sandwichCompositionRenderLatency() ;

/// @brief Method set_sandwichCompositionRenderLatency addr 0x1fc0d70 size 0x8 virtual true final true
 void set_sandwichCompositionRenderLatency(float_t value) ;

/// @brief Method get_sandwichCompositionBufferedFrames addr 0x1fc0d78 size 0x8 virtual true final true
 int32_t get_sandwichCompositionBufferedFrames() ;

/// @brief Method set_sandwichCompositionBufferedFrames addr 0x1fc0d80 size 0x8 virtual true final true
 void set_sandwichCompositionBufferedFrames(int32_t value) ;

/// @brief Method get_chromaKeyColor addr 0x1fc0d88 size 0xc virtual true final true
 UnityEngine::Color get_chromaKeyColor() ;

/// @brief Method set_chromaKeyColor addr 0x1fc0d94 size 0xc virtual true final true
 void set_chromaKeyColor(UnityEngine::Color value) ;

/// @brief Method get_chromaKeySimilarity addr 0x1fc0da0 size 0x8 virtual true final true
 float_t get_chromaKeySimilarity() ;

/// @brief Method set_chromaKeySimilarity addr 0x1fc0da8 size 0x8 virtual true final true
 void set_chromaKeySimilarity(float_t value) ;

/// @brief Method get_chromaKeySmoothRange addr 0x1fc0db0 size 0x8 virtual true final true
 float_t get_chromaKeySmoothRange() ;

/// @brief Method set_chromaKeySmoothRange addr 0x1fc0db8 size 0x8 virtual true final true
 void set_chromaKeySmoothRange(float_t value) ;

/// @brief Method get_chromaKeySpillRange addr 0x1fc0dc0 size 0x8 virtual true final true
 float_t get_chromaKeySpillRange() ;

/// @brief Method set_chromaKeySpillRange addr 0x1fc0dc8 size 0x8 virtual true final true
 void set_chromaKeySpillRange(float_t value) ;

/// @brief Method get_useDynamicLighting addr 0x1fc0dd0 size 0x8 virtual true final true
 bool get_useDynamicLighting() ;

/// @brief Method set_useDynamicLighting addr 0x1fc0dd8 size 0xc virtual true final true
 void set_useDynamicLighting(bool value) ;

/// @brief Method get_depthQuality addr 0x1fc0de4 size 0x8 virtual true final true
 GlobalNamespace::GlobalNamespace__OVRManager__DepthQuality get_depthQuality() ;

/// @brief Method set_depthQuality addr 0x1fc0dec size 0x8 virtual true final true
 void set_depthQuality(GlobalNamespace::GlobalNamespace__OVRManager__DepthQuality value) ;

/// @brief Method get_dynamicLightingSmoothFactor addr 0x1fc0df4 size 0x8 virtual true final true
 float_t get_dynamicLightingSmoothFactor() ;

/// @brief Method set_dynamicLightingSmoothFactor addr 0x1fc0dfc size 0x8 virtual true final true
 void set_dynamicLightingSmoothFactor(float_t value) ;

/// @brief Method get_dynamicLightingDepthVariationClampingValue addr 0x1fc0e04 size 0x8 virtual true final true
 float_t get_dynamicLightingDepthVariationClampingValue() ;

/// @brief Method set_dynamicLightingDepthVariationClampingValue addr 0x1fc0e0c size 0x8 virtual true final true
 void set_dynamicLightingDepthVariationClampingValue(float_t value) ;

/// @brief Method get_virtualGreenScreenType addr 0x1fc0e14 size 0x8 virtual true final true
 GlobalNamespace::GlobalNamespace__OVRManager__VirtualGreenScreenType get_virtualGreenScreenType() ;

/// @brief Method set_virtualGreenScreenType addr 0x1fc0e1c size 0x8 virtual true final true
 void set_virtualGreenScreenType(GlobalNamespace::GlobalNamespace__OVRManager__VirtualGreenScreenType value) ;

/// @brief Method get_virtualGreenScreenTopY addr 0x1fc0e24 size 0x8 virtual true final true
 float_t get_virtualGreenScreenTopY() ;

/// @brief Method set_virtualGreenScreenTopY addr 0x1fc0e2c size 0x8 virtual true final true
 void set_virtualGreenScreenTopY(float_t value) ;

/// @brief Method get_virtualGreenScreenBottomY addr 0x1fc0e34 size 0x8 virtual true final true
 float_t get_virtualGreenScreenBottomY() ;

/// @brief Method set_virtualGreenScreenBottomY addr 0x1fc0e3c size 0x8 virtual true final true
 void set_virtualGreenScreenBottomY(float_t value) ;

/// @brief Method get_virtualGreenScreenApplyDepthCulling addr 0x1fc0e44 size 0x8 virtual true final true
 bool get_virtualGreenScreenApplyDepthCulling() ;

/// @brief Method set_virtualGreenScreenApplyDepthCulling addr 0x1fc0e4c size 0xc virtual true final true
 void set_virtualGreenScreenApplyDepthCulling(bool value) ;

/// @brief Method get_virtualGreenScreenDepthTolerance addr 0x1fc0e58 size 0x8 virtual true final true
 float_t get_virtualGreenScreenDepthTolerance() ;

/// @brief Method set_virtualGreenScreenDepthTolerance addr 0x1fc0e60 size 0x8 virtual true final true
 void set_virtualGreenScreenDepthTolerance(float_t value) ;

/// @brief Method get_mrcActivationMode addr 0x1fc0e68 size 0x8 virtual true final true
 GlobalNamespace::GlobalNamespace__OVRManager__MrcActivationMode get_mrcActivationMode() ;

/// @brief Method set_mrcActivationMode addr 0x1fc0e70 size 0x8 virtual true final true
 void set_mrcActivationMode(GlobalNamespace::GlobalNamespace__OVRManager__MrcActivationMode value) ;

/// @brief Method get_instantiateMixedRealityCameraGameObject addr 0x1fc0e78 size 0x88 virtual true final true
 GlobalNamespace::GlobalNamespace__OVRManager__InstantiateMrcCameraDelegate get_instantiateMixedRealityCameraGameObject() ;

/// @brief Method set_instantiateMixedRealityCameraGameObject addr 0x1fc0f00 size 0x4 virtual true final true
...
/// @brief Method Update addr 0x1fc0f04 size 0xb0 virtual false final false
 void Update() ;

/// @brief Method OnDestroy addr 0x1fc0fb4 size 0x58 virtual false final false
 void OnDestroy() ;

/// @brief Method Init addr 0x1fc100c size 0x16c virtual false final false
...
/// @brief Method InstantiateMixedRealityCameraGameObject addr 0x1fc1178 size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x1fc11ac size 0x80 virtual false final false
 void _ctor() ;
