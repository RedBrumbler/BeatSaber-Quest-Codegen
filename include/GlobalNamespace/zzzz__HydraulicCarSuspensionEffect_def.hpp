...
/// @brief Method Start addr 0x20e5310 size 0x220 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x20e5530 size 0x40 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleContractBeatmapEvent addr 0x20e5570 size 0xa4 virtual false final false
 void HandleContractBeatmapEvent(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

/// @brief Method HandleExpandBeatmapEvent addr 0x20e5614 size 0xa4 virtual false final false
...
/// @brief Method .ctor addr 0x20e56b8 size 0x14 virtual false final false
 void _ctor() ;
