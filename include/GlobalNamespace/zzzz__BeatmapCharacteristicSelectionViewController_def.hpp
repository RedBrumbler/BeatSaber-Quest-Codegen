...
/// @brief Method add_didSelectBeatmapCharacteristicEvent addr 0x218d040 size 0xb0 virtual false final false
...
/// @brief Method remove_didSelectBeatmapCharacteristicEvent addr 0x218d0f0 size 0xb0 virtual false final false
...
/// @brief Method get_selectedBeatmapCharacteristic addr 0x218d1a0 size 0x8 virtual false final false
 GlobalNamespace::BeatmapCharacteristicSO get_selectedBeatmapCharacteristic() ;

/// @brief Method Init addr 0x218d1a8 size 0xc8 virtual false final false
 void Init() ;

/// @brief Method DidActivate addr 0x218d270 size 0x2f4 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x218d564 size 0xa0 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method HandleBeatmapCharacteristicSegmentedControlDidSelectCell addr 0x218d604 size 0xec virtual false final false
...
/// @brief Method .ctor addr 0x218d6f0 size 0x8 virtual false final false
 void _ctor() ;
