...
template<::cordl_internals::il2cpp_reference_type T0,::cordl_internals::il2cpp_reference_type T1,::cordl_internals::il2cpp_reference_type T2,::cordl_internals::il2cpp_reference_type T3>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12898)), TypeDefinitionIndex(TypeDefinitionIndex(12894))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12898), inst: 5945 })
