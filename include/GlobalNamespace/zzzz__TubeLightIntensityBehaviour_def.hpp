...
/// @brief Method ProcessFrame addr 0x21ec3cc size 0x370 virtual true final false
...
/// @brief Method EnableObjects addr 0x21ec73c size 0xd4 virtual false final false
 void EnableObjects(bool on) ;

/// @brief Method OnPlayableDestroy addr 0x21ec810 size 0xcc virtual true final false
 void OnPlayableDestroy(UnityEngine::Playables::Playable playable) ;

// Ctor Parameters []
explicit TubeLightIntensityBehaviour() ;

/// @brief Method .ctor addr 0x21ec8dc size 0x8 virtual false final false
 void _ctor() ;
