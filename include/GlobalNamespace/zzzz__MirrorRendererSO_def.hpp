...
/// @brief Method .ctor addr 0x26a98c4 size 0x1c virtual false final false
 void _ctor(UnityEngine::Vector3 position, UnityEngine::Quaternion rotation, float_t fov, bool stereoEnabled) ;

/// @brief Method Equals addr 0x26aa3a4 size 0x100 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x26aa4a4 size 0x120 virtual true final false
 int32_t GetHashCode() ;
...
/// @brief Method OnValidate addr 0x26a9830 size 0x4 virtual false final false
 void OnValidate() ;

/// @brief Method Awake addr 0x26a98a8 size 0x4 virtual false final false
 void Awake() ;

/// @brief Method ValidateParams addr 0x26a9834 size 0x74 virtual false final false
 void ValidateParams() ;

/// @brief Method Init addr 0x26a98ac size 0x18 virtual false final false
...
/// @brief Method PrepareForNextFrame addr 0x26a8bb0 size 0x18c virtual false final false
 void PrepareForNextFrame() ;

/// @brief Method GetMirrorTexture addr 0x26a8fd0 size 0x7f0 virtual false final false
 UnityEngine::Texture GetMirrorTexture(UnityEngine::Vector3 reflectionPlanePos, UnityEngine::Vector3 reflectionPlaneNormal) ;

/// @brief Method RenderMirror addr 0x26a9ca8 size 0x270 virtual false final false
...
/// @brief Method OnDisable addr 0x26aa044 size 0x224 virtual false final false
 void OnDisable() ;

/// @brief Method CreateOrUpdateMirrorCamera addr 0x26a98e0 size 0x2b4 virtual false final false
 void CreateOrUpdateMirrorCamera(UnityEngine::Camera currentCamera, UnityEngine::RenderTexture renderTexture) ;

/// @brief Method Plane addr 0x26a9b94 size 0x2c virtual false final false
static UnityEngine::Vector4 Plane(UnityEngine::Vector3 pos, UnityEngine::Vector3 normal) ;

/// @brief Method CameraSpacePlane addr 0x26a9f18 size 0x12c virtual false final false
...
/// @brief Method CalculateReflectionMatrix addr 0x26a9bc0 size 0xe8 virtual false final false
static UnityEngine::Matrix4x4 CalculateReflectionMatrix(UnityEngine::Vector4 plane) ;

// Ctor Parameters []
explicit MirrorRendererSO() ;

/// @brief Method .ctor addr 0x26aa268 size 0x13c virtual false final false
 void _ctor() ;
