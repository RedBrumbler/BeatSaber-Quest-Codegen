...
/// @brief Method add_didInitEvent addr 0x227c3b4 size 0x9c virtual false final false
 void add_didInitEvent(System::Action value) ;

/// @brief Method remove_didInitEvent addr 0x227c450 size 0x9c virtual false final false
 void remove_didInitEvent(System::Action value) ;

/// @brief Method add_noteDidStartJumpEvent addr 0x22782bc size 0x9c virtual false final false
 void add_noteDidStartJumpEvent(System::Action value) ;

/// @brief Method remove_noteDidStartJumpEvent addr 0x2278540 size 0x9c virtual false final false
 void remove_noteDidStartJumpEvent(System::Action value) ;

/// @brief Method add_noteDidFinishJumpEvent addr 0x2278220 size 0x9c virtual false final false
 void add_noteDidFinishJumpEvent(System::Action value) ;

/// @brief Method remove_noteDidFinishJumpEvent addr 0x22784a4 size 0x9c virtual false final false
 void remove_noteDidFinishJumpEvent(System::Action value) ;

/// @brief Method add_noteDidPassMissedMarkerEvent addr 0x2278408 size 0x9c virtual false final false
 void add_noteDidPassMissedMarkerEvent(System::Action value) ;

/// @brief Method remove_noteDidPassMissedMarkerEvent addr 0x227868c size 0x9c virtual false final false
 void remove_noteDidPassMissedMarkerEvent(System::Action value) ;

/// @brief Method add_noteDidPassHalfJumpEvent addr 0x227c4ec size 0x9c virtual false final false
 void add_noteDidPassHalfJumpEvent(System::Action value) ;

/// @brief Method remove_noteDidPassHalfJumpEvent addr 0x227c588 size 0x9c virtual false final false
 void remove_noteDidPassHalfJumpEvent(System::Action value) ;

/// @brief Method add_noteDidPassJumpThreeQuartersEvent addr 0x2278358 size 0xb0 virtual false final false
 void add_noteDidPassJumpThreeQuartersEvent(System::Action_1<GlobalNamespace::NoteMovement> value) ;

/// @brief Method remove_noteDidPassJumpThreeQuartersEvent addr 0x22785dc size 0xb0 virtual false final false
 void remove_noteDidPassJumpThreeQuartersEvent(System::Action_1<GlobalNamespace::NoteMovement> value) ;

/// @brief Method add_noteDidMoveInJumpPhaseEvent addr 0x227c624 size 0x9c virtual false final false
 void add_noteDidMoveInJumpPhaseEvent(System::Action value) ;

/// @brief Method remove_noteDidMoveInJumpPhaseEvent addr 0x227c6c0 size 0x9c virtual false final false
 void remove_noteDidMoveInJumpPhaseEvent(System::Action value) ;

/// @brief Method get_movementPhase addr 0x227c75c size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__NoteMovement__MovementPhase get_movementPhase() ;

/// @brief Method set_movementPhase addr 0x227c764 size 0x8 virtual false final false
 void set_movementPhase(GlobalNamespace::GlobalNamespace__NoteMovement__MovementPhase value) ;

/// @brief Method get_position addr 0x227c76c size 0xc virtual false final false
 UnityEngine::Vector3 get_position() ;

/// @brief Method get_prevPosition addr 0x227c778 size 0xc virtual false final false
 UnityEngine::Vector3 get_prevPosition() ;

/// @brief Method get_localPosition addr 0x227c784 size 0xc virtual false final false
 UnityEngine::Vector3 get_localPosition() ;

/// @brief Method get_prevLocalPosition addr 0x227c790 size 0xc virtual false final false
 UnityEngine::Vector3 get_prevLocalPosition() ;

/// @brief Method get_worldRotation addr 0x2277fb4 size 0x20 virtual false final false
 UnityEngine::Quaternion get_worldRotation() ;

/// @brief Method get_inverseWorldRotation addr 0x2277fd4 size 0x20 virtual false final false
 UnityEngine::Quaternion get_inverseWorldRotation() ;

/// @brief Method get_moveEndPos addr 0x2278180 size 0x20 virtual false final false
 UnityEngine::Vector3 get_moveEndPos() ;

/// @brief Method get_moveStartTime addr 0x2278018 size 0x1c virtual false final false
 float_t get_moveStartTime() ;

/// @brief Method get_moveDuration addr 0x2278058 size 0x1c virtual false final false
 float_t get_moveDuration() ;

/// @brief Method get_beatPos addr 0x2278114 size 0x44 virtual false final false
 UnityEngine::Vector3 get_beatPos() ;

/// @brief Method get_jumpDuration addr 0x2278098 size 0x1c virtual false final false
 float_t get_jumpDuration() ;

/// @brief Method get_jumpMoveVec addr 0x22780dc size 0x20 virtual false final false
 UnityEngine::Vector3 get_jumpMoveVec() ;

/// @brief Method get_distanceToPlayer addr 0x227c79c size 0x34 virtual false final false
 float_t get_distanceToPlayer() ;

/// @brief Method Init addr 0x2278df0 size 0x1a4 virtual false final false
...
/// @brief Method Awake addr 0x227c7d0 size 0x1c8 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x227c998 size 0x230 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleFloorMovementDidFinish addr 0x227cbc8 size 0x64 virtual false final false
 void HandleFloorMovementDidFinish() ;

/// @brief Method HandleNoteJumpDidFinish addr 0x227cc2c size 0x20 virtual false final false
 void HandleNoteJumpDidFinish() ;

/// @brief Method HandleNoteJumpDidPassMissedMark addr 0x227cc4c size 0x1c virtual false final false
 void HandleNoteJumpDidPassMissedMark() ;

/// @brief Method HandleNoteJumpDidPassThreeQuarters addr 0x227cc68 size 0x20 virtual false final false
 void HandleNoteJumpDidPassThreeQuarters(GlobalNamespace::NoteJump noteJump) ;

/// @brief Method HandleNoteJumpNoteJumpDidPassHalf addr 0x227cc88 size 0x1c virtual false final false
 void HandleNoteJumpNoteJumpDidPassHalf() ;

/// @brief Method ManualUpdate addr 0x2278750 size 0xb8 virtual false final false
 void ManualUpdate() ;

// Ctor Parameters []
explicit NoteMovement() ;

/// @brief Method .ctor addr 0x227cca4 size 0x8 virtual false final false
 void _ctor() ;
