...
/// @brief Method Start addr 0x22a349c size 0xdc virtual false final false
 void Start() ;

/// @brief Method FixedUpdate addr 0x22a3578 size 0x178 virtual false final false
 void FixedUpdate() ;

/// @brief Method LateUpdate addr 0x22a36f0 size 0x88 virtual false final false
 void LateUpdate() ;

// Ctor Parameters []
explicit FlyingGameHUDRotation() ;

/// @brief Method .ctor addr 0x22a3778 size 0x10 virtual false final false
 void _ctor() ;
