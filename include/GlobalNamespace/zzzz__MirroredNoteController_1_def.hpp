...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4875)), TypeDefinitionIndex(TypeDefinitionIndex(4889))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4875), inst: 2 })
