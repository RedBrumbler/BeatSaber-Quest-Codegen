...
/// @brief Method SetScale addr 0x21386b0 size 0x38 virtual false final false
 void SetScale(float_t scale) ;

/// @brief Method Setup addr 0x21386e8 size 0x134 virtual false final false
 void Setup(GlobalNamespace::IConnectedPlayer connectedPlayer) ;

// Ctor Parameters []
explicit MultiplayerResultsAvatarController() ;

/// @brief Method .ctor addr 0x213881c size 0x8 virtual false final false
 void _ctor() ;
