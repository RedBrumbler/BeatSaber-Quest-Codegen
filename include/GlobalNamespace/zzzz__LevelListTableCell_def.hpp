...
/// @brief Method MoveNext addr 0x215d02c size 0xa50 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x215da7c size 0xc virtual true final true
...
/// @brief Method MoveNext addr 0x215da88 size 0x3f8 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x215de80 size 0xc virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method SetDataFromLevelAsync addr 0x215cdac size 0xc0 virtual false final false
 void SetDataFromLevelAsync(GlobalNamespace::IPreviewBeatmapLevel level, bool isFavorite, bool isPromoted, bool isUpdated) ;

/// @brief Method SelectionDidChange addr 0x215ce6c size 0x4 virtual true final false
 void SelectionDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method HighlightDidChange addr 0x215cf34 size 0x4 virtual true final false
 void HighlightDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method RefreshVisuals addr 0x215ce70 size 0xc4 virtual false final false
 void RefreshVisuals() ;

/// @brief Method WasPreparedForReuse addr 0x215cf38 size 0x4 virtual true final false
 void WasPreparedForReuse() ;

/// @brief Method RefreshAvailabilityAsync addr 0x215cf74 size 0xa8 virtual false final false
 void RefreshAvailabilityAsync(GlobalNamespace::AdditionalContentModel contentModel, ::StringW levelID) ;

/// @brief Method CancelAsyncOperations addr 0x215cf3c size 0x38 virtual false final false
 void CancelAsyncOperations() ;

// Ctor Parameters []
explicit LevelListTableCell() ;

/// @brief Method .ctor addr 0x215d01c size 0x10 virtual false final false
 void _ctor() ;
