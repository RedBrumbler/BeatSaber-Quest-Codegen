...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4937))}
...
/// @brief Method Start addr 0x2285bd8 size 0x98 virtual true final false
 void Start() ;

/// @brief Method Update addr 0x2285d44 size 0x6c virtual false final false
 void Update() ;

/// @brief Method SetPSStartColor addr 0x2285c70 size 0xd4 virtual false final false
 void SetPSStartColor(UnityEngine::Color color) ;

/// @brief Method StartEffect addr 0x2285db0 size 0xb8 virtual true final false
 void StartEffect(float_t saberInteractionParam) ;

/// @brief Method EndEffect addr 0x2285e68 size 0x94 virtual true final false
 void EndEffect() ;

// Ctor Parameters []
explicit SliderParticleInteractionEffect() ;

/// @brief Method .ctor addr 0x2285efc size 0x8 virtual false final false
 void _ctor() ;
