...
/// @brief Method <LogEvent>b__3_0 addr 0x20eb53c size 0x8c virtual false final false
...
/// @brief Method get_supportsOpenDataPrivacyPage addr 0x20eafb0 size 0x8 virtual true final true
 bool get_supportsOpenDataPrivacyPage() ;

/// @brief Method OpenDataPrivacyPage addr 0x20eafb8 size 0x4 virtual true final true
 void OpenDataPrivacyPage() ;

/// @brief Method LogEvent addr 0x20eafbc size 0x18c virtual true final true
 void LogEvent(::StringW eventType, System::Collections::Generic::Dictionary_2<::StringW,::StringW> eventData) ;

/// @brief Method LogEditAvatarEvent addr 0x20eb148 size 0xe0 virtual true final true
 void LogEditAvatarEvent(::StringW eventType, System::Collections::Generic::Dictionary_2<::StringW,::StringW> avatarEventData) ;

/// @brief Method LogClick addr 0x20eb228 size 0xe0 virtual true final true
 void LogClick(::StringW clickType, System::Collections::Generic::Dictionary_2<::StringW,::StringW> clickData) ;

/// @brief Method LogImpression addr 0x20eb308 size 0xe0 virtual true final true
 void LogImpression(::StringW impressionType, System::Collections::Generic::Dictionary_2<::StringW,::StringW> impressionData) ;

/// @brief Method LogExposure addr 0x20eb3e8 size 0xe0 virtual true final true
...
/// @brief Method .ctor addr 0x20eb4c8 size 0x8 virtual false final false
 void _ctor() ;
