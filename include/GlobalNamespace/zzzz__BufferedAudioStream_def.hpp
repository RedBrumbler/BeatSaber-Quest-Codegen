...
/// @brief Method .ctor addr 0x2581a18 size 0xc4 virtual false final false
 void _ctor(UnityEngine::AudioSource audio) ;

/// @brief Method Update addr 0x2581b20 size 0x1d0 virtual false final false
 void Update() ;

/// @brief Method Stop addr 0x2581adc size 0x44 virtual false final false
 void Stop() ;

/// @brief Method AddData addr 0x2581cf0 size 0x11c virtual false final false
