...
/// @brief Method add_finishedMovementEvent addr 0x227e3a4 size 0xb0 virtual false final false
 void add_finishedMovementEvent(System::Action_1<GlobalNamespace::ObstacleController> value) ;

/// @brief Method remove_finishedMovementEvent addr 0x227e454 size 0xb0 virtual false final false
 void remove_finishedMovementEvent(System::Action_1<GlobalNamespace::ObstacleController> value) ;

/// @brief Method add_passedThreeQuartersOfMove2Event addr 0x227e504 size 0xb0 virtual false final false
 void add_passedThreeQuartersOfMove2Event(System::Action_1<GlobalNamespace::ObstacleController> value) ;

/// @brief Method remove_passedThreeQuartersOfMove2Event addr 0x227e5b4 size 0xb0 virtual false final false
 void remove_passedThreeQuartersOfMove2Event(System::Action_1<GlobalNamespace::ObstacleController> value) ;

/// @brief Method add_passedAvoidedMarkEvent addr 0x227e664 size 0xb0 virtual false final false
 void add_passedAvoidedMarkEvent(System::Action_1<GlobalNamespace::ObstacleController> value) ;

/// @brief Method remove_passedAvoidedMarkEvent addr 0x227e714 size 0xb0 virtual false final false
 void remove_passedAvoidedMarkEvent(System::Action_1<GlobalNamespace::ObstacleController> value) ;

/// @brief Method add_didDissolveEvent addr 0x227e7c4 size 0xb0 virtual false final false
 void add_didDissolveEvent(System::Action_1<GlobalNamespace::ObstacleController> value) ;

/// @brief Method remove_didDissolveEvent addr 0x227e874 size 0xb0 virtual false final false
 void remove_didDissolveEvent(System::Action_1<GlobalNamespace::ObstacleController> value) ;

/// @brief Method add_didUpdateProgress addr 0x227e924 size 0xb0 virtual false final false
 void add_didUpdateProgress(System::Action_2<GlobalNamespace::ObstacleController,float_t> value) ;

/// @brief Method remove_didUpdateProgress addr 0x227e9d4 size 0xb0 virtual false final false
 void remove_didUpdateProgress(System::Action_2<GlobalNamespace::ObstacleController,float_t> value) ;

/// @brief Method get_bounds addr 0x227ea84 size 0x14 virtual false final false
 UnityEngine::Bounds get_bounds() ;

/// @brief Method get_obstacleData addr 0x227ea98 size 0x8 virtual false final false
 GlobalNamespace::ObstacleData get_obstacleData() ;

/// @brief Method get_hasPassedAvoidedMark addr 0x227eaa0 size 0x8 virtual false final false
 bool get_hasPassedAvoidedMark() ;

/// @brief Method get_move1Duration addr 0x227eaa8 size 0x8 virtual false final false
 float_t get_move1Duration() ;

/// @brief Method get_move2Duration addr 0x227eab0 size 0x8 virtual false final false
 float_t get_move2Duration() ;

/// @brief Method get_width addr 0x227eab8 size 0x8 virtual false final false
 float_t get_width() ;

/// @brief Method get_height addr 0x227eac0 size 0x8 virtual false final false
 float_t get_height() ;

/// @brief Method get_length addr 0x227eac8 size 0x8 virtual false final false
 float_t get_length() ;

/// @brief Method get_color addr 0x227ead0 size 0xc virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method Init addr 0x227eadc size 0x2d4 virtual true final false
...
/// @brief Method Update addr 0x227edb0 size 0xc virtual false final false
 void Update() ;

/// @brief Method ManualUpdate addr 0x227edbc size 0x1ec virtual true final false
 void ManualUpdate() ;

/// @brief Method GetPosForTime addr 0x227efa8 size 0x124 virtual false final false
 UnityEngine::Vector3 GetPosForTime(float_t time) ;

/// @brief Method DissolveCoroutine addr 0x227f0cc size 0x78 virtual false final false
 System::Collections::IEnumerator DissolveCoroutine(float_t duration) ;

/// @brief Method Dissolve addr 0x227f16c size 0x38 virtual true final true
 void Dissolve(float_t duration) ;

/// @brief Method Hide addr 0x227f1a4 size 0x6c virtual true final true
 void Hide(bool hide) ;

/// @brief Method Pause addr 0x227f210 size 0x10 virtual true final true
 void Pause(bool pause) ;

// Ctor Parameters []
explicit ObstacleController() ;

/// @brief Method .ctor addr 0x227f220 size 0x10 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4911)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 356 }), TypeDefinitionIndex(TypeDefinitionIndex(11011))}
...
/// @brief Method .ctor addr 0x227f230 size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x227f144 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x227f278 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x227f27c size 0xe8 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x227f364 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x227f36c size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x227f3ac size 0x8 virtual true final true
