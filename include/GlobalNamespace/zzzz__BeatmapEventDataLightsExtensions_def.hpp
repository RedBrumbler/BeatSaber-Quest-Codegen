...
/// @brief Method LightColorTypeFromEventDataValue addr 0xda0640 size 0x18 virtual false final false
...
/// @brief Method GetLightColorTypeFromEventDataValue addr 0xda0658 size 0x2c virtual false final false
static GlobalNamespace::EnvironmentColorType GetLightColorTypeFromEventDataValue(int32_t beatmapEventValue) ;

/// @brief Method HasLightFadeEventDataValue addr 0xda0684 size 0x34 virtual false final false
static bool HasLightFadeEventDataValue(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

/// @brief Method HasFixedDurationLightSwitchEventDataValue addr 0xda06b8 size 0x4c virtual false final false
static bool HasFixedDurationLightSwitchEventDataValue(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

/// @brief Method HasFixedDurationLightSwitchEventDataValue addr 0xda0704 size 0x3c virtual false final false
