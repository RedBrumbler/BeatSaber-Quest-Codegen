...
/// @brief Method get_beatmapLevelData addr 0x22220cc size 0x8 virtual true final true
 GlobalNamespace::IBeatmapLevelData get_beatmapLevelData() ;

/// @brief Method get_songAudioClipPath addr 0x22220d4 size 0x4 virtual true final true
...
/// @brief Method .ctor addr 0x2222148 size 0xc0 virtual false final false
 void _ctor(GlobalNamespace::CustomPreviewBeatmapLevel customPreviewBeatmapLevel) ;

/// @brief Method SetBeatmapLevelData addr 0x22222ec size 0x8 virtual false final false
 void SetBeatmapLevelData(GlobalNamespace::BeatmapLevelData beatmapLevelData) ;

/// @brief Method GetBeatmapLevelColorScheme addr 0x22222f4 size 0x44 virtual false final false
