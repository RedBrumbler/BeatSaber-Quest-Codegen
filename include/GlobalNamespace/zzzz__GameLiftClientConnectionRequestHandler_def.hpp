...
/// @brief Method get_playerSessionId addr 0xdb8a20 size 0x8 virtual false final false
 ::StringW get_playerSessionId() ;

/// @brief Method set_playerSessionId addr 0xdb8a28 size 0x8 virtual false final false
 void set_playerSessionId(::StringW value) ;

/// @brief Method GetConnectionMessage addr 0xdb8a30 size 0x70 virtual true final true
 void GetConnectionMessage(LiteNetLib::Utils::NetDataWriter writer, ::StringW userId, ::StringW userName, bool isConnectionOwner) ;

/// @brief Method ValidateConnectionMessage addr 0xdb8aa0 size 0x14 virtual true final true
...
/// @brief Method .ctor addr 0xdb8ab4 size 0x8 virtual false final false
 void _ctor() ;
