...
/// @brief Method add_movementDidFinishEvent addr 0x2281c10 size 0x9c virtual false final false
 void add_movementDidFinishEvent(System::Action value) ;

/// @brief Method remove_movementDidFinishEvent addr 0x2282278 size 0x9c virtual false final false
 void remove_movementDidFinishEvent(System::Action value) ;

/// @brief Method add_movementDidMoveEvent addr 0x2285a50 size 0xb0 virtual false final false
 void add_movementDidMoveEvent(System::Action_1<float_t> value) ;

/// @brief Method remove_movementDidMoveEvent addr 0x2285b00 size 0xb0 virtual false final false
 void remove_movementDidMoveEvent(System::Action_1<float_t> value) ;

/// @brief Method add_headDidMovePastCutMarkEvent addr 0x2281cac size 0x9c virtual false final false
 void add_headDidMovePastCutMarkEvent(System::Action value) ;

/// @brief Method remove_headDidMovePastCutMarkEvent addr 0x2282314 size 0x9c virtual false final false
 void remove_headDidMovePastCutMarkEvent(System::Action value) ;

/// @brief Method add_tailDidMovePastCutMarkEvent addr 0x2281d48 size 0x9c virtual false final false
 void add_tailDidMovePastCutMarkEvent(System::Action value) ;

/// @brief Method remove_tailDidMovePastCutMarkEvent addr 0x22823b0 size 0x9c virtual false final false
 void remove_tailDidMovePastCutMarkEvent(System::Action value) ;

/// @brief Method get_jumpDuration addr 0x2285bb0 size 0x8 virtual false final false
 float_t get_jumpDuration() ;

/// @brief Method get_headNoteGravity addr 0x2285bb8 size 0x8 virtual false final false
 float_t get_headNoteGravity() ;

/// @brief Method get_tailNoteGravity addr 0x2285bc0 size 0x8 virtual false final false
 float_t get_tailNoteGravity() ;

/// @brief Method get_timeSinceHeadNoteJump addr 0x2285bc8 size 0x8 virtual false final false
 float_t get_timeSinceHeadNoteJump() ;

/// @brief Method Init addr 0x2280f50 size 0xf0 virtual false final false
...
/// @brief Method StartMovement addr 0x2281a88 size 0x28 virtual false final false
 void StartMovement() ;

/// @brief Method ManualUpdate addr 0x22825b8 size 0x20c virtual false final false
 void ManualUpdate() ;

// Ctor Parameters []
explicit SliderMovement() ;

/// @brief Method .ctor addr 0x2285bd0 size 0x8 virtual false final false
 void _ctor() ;
