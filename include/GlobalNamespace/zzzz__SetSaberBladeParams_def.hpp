...
/// @brief Method .ctor addr 0x2145508 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Start addr 0x21453fc size 0x104 virtual false final false
 void Start() ;

// Ctor Parameters []
explicit SetSaberBladeParams() ;

/// @brief Method .ctor addr 0x2145500 size 0x8 virtual false final false
 void _ctor() ;
