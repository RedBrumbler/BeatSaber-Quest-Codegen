...
/// @brief Method OnDestroy addr 0x210e148 size 0xd4 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleTotalDistanceDidChange addr 0x210e21c size 0x60 virtual false final false
 void HandleTotalDistanceDidChange(float_t distance) ;

/// @brief Method Init addr 0x210e27c size 0x108 virtual true final false
 void Init() ;
