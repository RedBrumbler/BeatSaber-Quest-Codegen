...
/// @brief Method get_pool addr 0xddcb0c size 0x40 virtual false final false
static GlobalNamespace::PacketPool_1<GlobalNamespace::NodePoseSyncStateNetSerializable> get_pool() ;

/// @brief Method get_id addr 0xddcb4c size 0x8 virtual true final true
 GlobalNamespace::SyncStateId get_id() ;

/// @brief Method set_id addr 0xddcb54 size 0x8 virtual true final true
 void set_id(GlobalNamespace::SyncStateId value) ;

/// @brief Method get_time addr 0xddcb5c size 0x8 virtual true final true
 float_t get_time() ;

/// @brief Method set_time addr 0xddcb64 size 0x8 virtual true final true
 void set_time(float_t value) ;

/// @brief Method get_state addr 0xddcb6c size 0x10 virtual true final true
 GlobalNamespace::NodePoseSyncState get_state() ;

/// @brief Method set_state addr 0xddcb7c size 0x18 virtual true final true
 void set_state(GlobalNamespace::NodePoseSyncState value) ;

/// @brief Method Serialize addr 0xddcb94 size 0x4c virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0xddcc04 size 0x4c virtual true final true
 void Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method Release addr 0xddcc70 size 0x54 virtual true final true
 void Release() ;

// Ctor Parameters []
explicit NodePoseSyncStateNetSerializable() ;

/// @brief Method .ctor addr 0xddccc4 size 0x8 virtual false final false
 void _ctor() ;
