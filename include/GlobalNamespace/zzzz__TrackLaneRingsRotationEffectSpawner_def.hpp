...
/// @brief Method Start addr 0x22a75a0 size 0x124 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x22a76c4 size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleBeatmapEvent addr 0x22a76e0 size 0xcc virtual false final false
 void HandleBeatmapEvent(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

// Ctor Parameters []
explicit TrackLaneRingsRotationEffectSpawner() ;

/// @brief Method .ctor addr 0x22a77ac size 0x24 virtual false final false
 void _ctor() ;
