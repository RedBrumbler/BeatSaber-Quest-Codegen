...
template<::cordl_internals::il2cpp_reference_type TBase>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14981)), TypeDefinitionIndex(TypeDefinitionIndex(14980)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14981), inst: 4834 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14980), inst: 2 })
