...
/// @brief Method .ctor addr 0x26ab5a4 size 0xcc virtual false final false
 void _ctor() ;

/// @brief Method FilterTexture addr 0x26ab670 size 0x180 virtual false final false
 UnityEngine::RenderTexture FilterTexture(UnityEngine::RenderTexture src) ;

/// @brief Method CreateRenderTexturesIfNeeded addr 0x26ab7f0 size 0x28c virtual false final false
