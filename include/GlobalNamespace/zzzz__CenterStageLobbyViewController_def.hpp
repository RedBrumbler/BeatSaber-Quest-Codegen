...
/// @brief Method SetLevelGameplaySetupData addr 0x21acb64 size 0x13c virtual false final false
...
/// @brief Method .ctor addr 0x21acca0 size 0x8 virtual false final false
 void _ctor() ;
