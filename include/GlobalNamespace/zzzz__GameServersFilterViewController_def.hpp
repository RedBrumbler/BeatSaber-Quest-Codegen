...
/// @brief Method get_gameServersFilter addr 0x21ad644 size 0xf4 virtual false final false
 GlobalNamespace::GameServersFilter get_gameServersFilter() ;

/// @brief Method SetupGameServersFilter addr 0x21ad738 size 0x4 virtual false final false
 void SetupGameServersFilter(GlobalNamespace::GameServersFilter gameServersFilter) ;

/// @brief Method DidActivate addr 0x21ad844 size 0x15c virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method OnDestroy addr 0x21ad9a0 size 0x28 virtual true final false
 void OnDestroy() ;

/// @brief Method Refresh addr 0x21ad73c size 0x108 virtual false final false
 void Refresh(GlobalNamespace::GameServersFilter currentFilter) ;

// Ctor Parameters []
explicit GameServersFilterViewController() ;

/// @brief Method .ctor addr 0x21ad9c8 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__16_0 addr 0x21ada30 size 0x20 virtual false final false
 void _DidActivate_b__16_0(bool isOn) ;

/// @brief Method <DidActivate>b__16_1 addr 0x21ada50 size 0x20 virtual false final false
 void _DidActivate_b__16_1(bool isOn) ;

/// @brief Method <DidActivate>b__16_2 addr 0x21ada70 size 0x20 virtual false final false
