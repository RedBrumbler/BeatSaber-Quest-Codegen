...
/// @brief Method Start addr 0x2294540 size 0xc4 virtual false final false
 void Start() ;

/// @brief Method SpawnDebris addr 0x22939f0 size 0x890 virtual false final false
...
/// @brief Method HandleNoteDebrisDidFinish addr 0x2294710 size 0xbc virtual true final true
 void HandleNoteDebrisDidFinish(GlobalNamespace::NoteDebris noteDebris) ;

/// @brief Method SpawnNoteDebris addr 0x2294604 size 0x10c virtual false final false
...
/// @brief Method DespawnNoteDebris addr 0x22947cc size 0xa4 virtual false final false
 void DespawnNoteDebris(GlobalNamespace::NoteDebris noteDebris) ;

// Ctor Parameters []
explicit NoteDebrisSpawner() ;

/// @brief Method .ctor addr 0x2294870 size 0x88 virtual false final false
 void _ctor() ;
