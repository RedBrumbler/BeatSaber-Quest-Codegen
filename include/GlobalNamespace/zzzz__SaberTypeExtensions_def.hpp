...
/// @brief Method MatchesColorType addr 0x1223cf8 size 0x28 virtual false final false
static bool MatchesColorType(GlobalNamespace::SaberType saberType, GlobalNamespace::ColorType colorType) ;

/// @brief Method Node addr 0x122647c size 0x10 virtual false final false
static UnityEngine::XR::XRNode Node(GlobalNamespace::SaberType saberType) ;

/// @brief Method MainSaber addr 0x122648c size 0xc virtual false final false
static GlobalNamespace::SaberType MainSaber(bool leftHanded) ;

/// @brief Method ToSaberType addr 0x1226498 size 0x88 virtual false final false
