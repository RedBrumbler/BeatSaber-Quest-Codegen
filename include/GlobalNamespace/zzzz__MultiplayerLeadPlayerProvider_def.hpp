...
/// @brief Method add_newLeaderWasSelectedEvent addr 0x212f1dc size 0xb0 virtual false final false
 void add_newLeaderWasSelectedEvent(System::Action_1<::StringW> value) ;

/// @brief Method remove_newLeaderWasSelectedEvent addr 0x212f12c size 0xb0 virtual false final false
 void remove_newLeaderWasSelectedEvent(System::Action_1<::StringW> value) ;

/// @brief Method Start addr 0x21321e4 size 0xb0 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x21322a4 size 0x164 virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x2132408 size 0x98 virtual false final false
 void Update() ;

/// @brief Method StopProviding addr 0x21324a0 size 0x9c virtual false final false
 void StopProviding() ;

/// @brief Method StartProviding addr 0x213253c size 0xa0 virtual false final false
 void StartProviding() ;

/// @brief Method HandleStateChanged addr 0x2132294 size 0x10 virtual false final false
 void HandleStateChanged(GlobalNamespace::GlobalNamespace__MultiplayerController__State state) ;

/// @brief Method HandleFirstPlayerDidChange addr 0x21325dc size 0xf4 virtual false final false
...
/// @brief Method .ctor addr 0x21326d0 size 0x14 virtual false final false
 void _ctor() ;
