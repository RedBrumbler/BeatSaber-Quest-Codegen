...
constexpr GlobalNamespace::GlobalNamespace__TrackLaneRingsRotationEffectSpawner__RotationStepType::GlobalNamespace__TrackLaneRingsRotationEffectSpawner__RotationStepType(int32_t value__) noexcept : ::bs_hook::EnumTypeWrapper() {this->value__ = value__;
}
constexpr void GlobalNamespace::GlobalNamespace__TrackLaneRingsRotationEffectSpawner__RotationStepType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__TrackLaneRingsRotationEffectSpawner__RotationStepType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr GlobalNamespace::GlobalNamespace__TrackLaneRingsRotationEffectSpawner__RotationStepType  GlobalNamespace::GlobalNamespace__TrackLaneRingsRotationEffectSpawner__RotationStepType::Range0ToMax{0};
constexpr GlobalNamespace::GlobalNamespace__TrackLaneRingsRotationEffectSpawner__RotationStepType  GlobalNamespace::GlobalNamespace__TrackLaneRingsRotationEffectSpawner__RotationStepType::Range{1};
constexpr GlobalNamespace::GlobalNamespace__TrackLaneRingsRotationEffectSpawner__RotationStepType  GlobalNamespace::GlobalNamespace__TrackLaneRingsRotationEffectSpawner__RotationStepType::MaxOr0{2};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrackLaneRingsRotationEffectSpawner::*)()>(&GlobalNamespace::TrackLaneRingsRotationEffectSpawner::Start)> {
  ...
  constexpr static std::size_t addrs = 0x22a75a0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrackLaneRingsRotationEffectSpawner::*)()>(&GlobalNamespace::TrackLaneRingsRotationEffectSpawner::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x22a76c4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrackLaneRingsRotationEffectSpawner::*)(GlobalNamespace::BasicBeatmapEventData)>(&GlobalNamespace::TrackLaneRingsRotationEffectSpawner::HandleBeatmapEvent)> {
  ...
  constexpr static std::size_t addrs = 0x22a76e0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrackLaneRingsRotationEffectSpawner::*)()>(&GlobalNamespace::TrackLaneRingsRotationEffectSpawner::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x22a77ac;
...
constexpr void GlobalNamespace::TrackLaneRingsRotationEffectSpawner::__set__rotationStepType(GlobalNamespace::GlobalNamespace__TrackLaneRingsRotationEffectSpawner__RotationStepType value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__TrackLaneRingsRotationEffectSpawner__RotationStepType, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__TrackLaneRingsRotationEffectSpawner__RotationStepType>(value));
}
constexpr GlobalNamespace::GlobalNamespace__TrackLaneRingsRotationEffectSpawner__RotationStepType GlobalNamespace::TrackLaneRingsRotationEffectSpawner::__get__rotationStepType() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__TrackLaneRingsRotationEffectSpawner__RotationStepType, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance);
}
