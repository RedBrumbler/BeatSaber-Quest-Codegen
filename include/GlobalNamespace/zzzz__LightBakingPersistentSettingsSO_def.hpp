...
/// @brief Method get_reflectionsCount addr 0x21d4fa8 size 0x8 virtual false final false
 int32_t get_reflectionsCount() ;

/// @brief Method set_reflectionsCount addr 0x21d4fb0 size 0x8 virtual false final false
 void set_reflectionsCount(int32_t value) ;

/// @brief Method get_colorFromSchemeAlpha addr 0x21d4fb8 size 0x8 virtual false final false
 float_t get_colorFromSchemeAlpha() ;

/// @brief Method set_colorFromSchemeAlpha addr 0x21d4fc0 size 0x8 virtual false final false
 void set_colorFromSchemeAlpha(float_t value) ;

/// @brief Method get_bakedLightEditorColors addr 0x21d4fc8 size 0x8 virtual false final false
 ::ArrayW<UnityEngine::Color> get_bakedLightEditorColors() ;

/// @brief Method get_defaultDepthOnlyWriteMaterialForFakeMirror addr 0x21d4fd0 size 0x8 virtual false final false
 UnityEngine::Material get_defaultDepthOnlyWriteMaterialForFakeMirror() ;

/// @brief Method get_mainEffectForBakingIsOn addr 0x21d4fd8 size 0x70 virtual false final false
 bool get_mainEffectForBakingIsOn() ;

/// @brief Method set_mainEffectForBakingIsOn addr 0x21d5048 size 0xb0 virtual false final false
 void set_mainEffectForBakingIsOn(bool value) ;

/// @brief Method get_bakedLightDataLoaderPrefab addr 0x21d50f8 size 0x8 virtual false final false
 GlobalNamespace::BakedLightDataLoader get_bakedLightDataLoaderPrefab() ;

/// @brief Method get_bakedReflectionProbePrefab addr 0x21d5100 size 0x8 virtual false final false
 GlobalNamespace::BakedReflectionProbe get_bakedReflectionProbePrefab() ;

/// @brief Method get_lightmapLightsWithIds addr 0x21d5108 size 0x8 virtual false final false
 GlobalNamespace::LightmapLightsWithIds get_lightmapLightsWithIds() ;

/// @brief Method get_fakeMirrorObjectsInstallerPrefab addr 0x21d5110 size 0x8 virtual false final false
 GlobalNamespace::FakeMirrorObjectsInstaller get_fakeMirrorObjectsInstallerPrefab() ;

/// @brief Method get_fakeMirrorSettingsPrefab addr 0x21d5118 size 0x8 virtual false final false
 GlobalNamespace::FakeMirrorSettings get_fakeMirrorSettingsPrefab() ;

/// @brief Method SetGraphicsSettingsForBaking addr 0x21d5120 size 0x254 virtual false final false
 void SetGraphicsSettingsForBaking() ;

/// @brief Method SetPlatformGraphics addr 0x21d5424 size 0x2c4 virtual false final false
 void SetPlatformGraphics() ;

/// @brief Method SetToneMappingOn addr 0x21d5374 size 0xb0 virtual false final false
 void SetToneMappingOn(bool isOn) ;

/// @brief Method IsToneMappingOn addr 0x21d56e8 size 0x34 virtual false final false
 bool IsToneMappingOn() ;

// Ctor Parameters []
explicit LightBakingPersistentSettingsSO() ;

/// @brief Method .ctor addr 0x21d571c size 0x10c0 virtual false final false
 void _ctor() ;
