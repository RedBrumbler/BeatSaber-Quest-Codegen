...
template<::cordl_internals::il2cpp_reference_type T0,::cordl_internals::il2cpp_reference_type T1,::cordl_internals::il2cpp_reference_type T2>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12894)), TypeDefinitionIndex(TypeDefinitionIndex(12897))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12897), inst: 5162 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12894)), TypeDefinitionIndex(TypeDefinitionIndex(12897))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12897), inst: 6124 })
// CS Name: RemoteProcedureCall`3
