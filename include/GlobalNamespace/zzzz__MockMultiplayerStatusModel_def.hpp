...
/// @brief Method GetMultiplayerStatusAsync addr 0x2122d7c size 0x70 virtual true final true
...
/// @brief Method .ctor addr 0x2122dec size 0x8 virtual false final false
 void _ctor() ;
