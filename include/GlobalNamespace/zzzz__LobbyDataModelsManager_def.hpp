...
/// @brief Method Activate addr 0x222cacc size 0x218 virtual false final false
 void Activate() ;

/// @brief Method Deactivate addr 0x222cdd4 size 0x1a0 virtual false final false
 void Deactivate() ;

// Ctor Parameters []
explicit LobbyDataModelsManager() ;

/// @brief Method .ctor addr 0x222d064 size 0x8 virtual false final false
 void _ctor() ;
