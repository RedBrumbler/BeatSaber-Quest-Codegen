...
/// @brief Method .ctor addr 0x22b15cc size 0x10 virtual false final false
 void _ctor(UnityEngine::Vector3 position, UnityEngine::Vector3 rotation) ;

/// @brief Method ToString addr 0x22b15dc size 0x1a4 virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x22b1780 size 0x1b0 virtual false final false
 ::StringW ToString(::StringW format) ;

/// @brief Method get_identity addr 0x22b1930 size 0x68 virtual false final false
static GlobalNamespace::EulerPose get_identity() ;

/// @brief Method op_Addition addr 0x22b1998 size 0x28 virtual false final false
static GlobalNamespace::EulerPose op_Addition(GlobalNamespace::EulerPose left, GlobalNamespace::EulerPose right) ;

/// @brief Method op_Subtraction addr 0x22b19c0 size 0x28 virtual false final false
static GlobalNamespace::EulerPose op_Subtraction(GlobalNamespace::EulerPose left, GlobalNamespace::EulerPose right) ;

/// @brief Method MirrorOnYZPlane addr 0x22b19e8 size 0x2c virtual false final false
 GlobalNamespace::EulerPose MirrorOnYZPlane() ;

/// @brief Method Equals addr 0x22b1a28 size 0x90 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x22b1ab8 size 0x124 virtual false final false
 bool Equals(GlobalNamespace::EulerPose other) ;

/// @brief Method GetHashCode addr 0x22b1bdc size 0x88 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x22b1c64 size 0x30 virtual false final false
static bool op_Equality(GlobalNamespace::EulerPose a, GlobalNamespace::EulerPose b) ;

/// @brief Method op_Inequality addr 0x22b1c94 size 0xb8 virtual false final false
static bool op_Inequality(GlobalNamespace::EulerPose a, GlobalNamespace::EulerPose b) ;

/// @brief Method ToPose addr 0x22b1d4c size 0x88 virtual false final false
