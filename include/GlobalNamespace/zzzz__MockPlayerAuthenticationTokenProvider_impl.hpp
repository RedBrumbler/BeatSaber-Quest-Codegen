...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (GlobalNamespace::MockPlayerAuthenticationTokenProvider::*)()>(&GlobalNamespace::MockPlayerAuthenticationTokenProvider::get_userName)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x22b3568;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::GlobalNamespace__AuthenticationToken__Platform (GlobalNamespace::MockPlayerAuthenticationTokenProvider::*)()>(&GlobalNamespace::MockPlayerAuthenticationTokenProvider::get_platform)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x22b3570;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MockPlayerAuthenticationTokenProvider::*)(::StringW, ::StringW, ::StringW)>(&GlobalNamespace::MockPlayerAuthenticationTokenProvider::_ctor)> {
  constexpr static std::size_t size = 0x98;
  constexpr static std::size_t addrs = 0x22b3578;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Threading::Tasks::Task_1<GlobalNamespace::AuthenticationToken> (GlobalNamespace::MockPlayerAuthenticationTokenProvider::*)()>(&GlobalNamespace::MockPlayerAuthenticationTokenProvider::GetAuthenticationToken)> {
  ...
  constexpr static std::size_t addrs = 0x22b3610;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::GlobalNamespace__AuthenticationToken__Platform (GlobalNamespace::MockPlayerAuthenticationTokenProvider::*)(GlobalNamespace::PlatformEnvironment)>(&GlobalNamespace::MockPlayerAuthenticationTokenProvider::GetTokenPlatform)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x22b36b0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Threading::Tasks::Task_1<GlobalNamespace::XPlatformAccessTokenData> (GlobalNamespace::MockPlayerAuthenticationTokenProvider::*)(System::Threading::CancellationToken, bool)>(&GlobalNamespace::MockPlayerAuthenticationTokenProvider::GetXPlatformAccessToken)> {
  constexpr static std::size_t size = 0xb4;
  constexpr static std::size_t addrs = 0x22b36b8;
...
constexpr  GlobalNamespace::MockPlayerAuthenticationTokenProvider::operator GlobalNamespace::IAuthenticationTokenProvider() const noexcept {
...
constexpr ::StringW GlobalNamespace::MockPlayerAuthenticationTokenProvider::__get__userId() const {
...
constexpr ::StringW GlobalNamespace::MockPlayerAuthenticationTokenProvider::__get__password() const {
...
constexpr ::StringW GlobalNamespace::MockPlayerAuthenticationTokenProvider::__get__hashedUserId_k__BackingField() const {
...
constexpr ::StringW GlobalNamespace::MockPlayerAuthenticationTokenProvider::__get__userName_k__BackingField() const {
return ::cordl_internals::getInstanceField<::StringW, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::MockPlayerAuthenticationTokenProvider::__set__platform_k__BackingField(GlobalNamespace::GlobalNamespace__AuthenticationToken__Platform value)  {
...
constexpr GlobalNamespace::GlobalNamespace__AuthenticationToken__Platform GlobalNamespace::MockPlayerAuthenticationTokenProvider::__get__platform_k__BackingField() const {
...
return ::cordl_internals::RunMethodRethrow<::StringW, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::GlobalNamespace__AuthenticationToken__Platform GlobalNamespace::MockPlayerAuthenticationTokenProvider::get_platform()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::MockPlayerAuthenticationTokenProvider>::get(),
                            "get_platform",
                            std::vector<Il2CppClass*>{},
...
// Ctor Parameters [CppParam { name: "userId", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "userName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "password", ty: "::StringW", modifiers: "", def_value: None }]
 GlobalNamespace::MockPlayerAuthenticationTokenProvider::MockPlayerAuthenticationTokenProvider(::StringW userId, ::StringW userName, ::StringW password)  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<MockPlayerAuthenticationTokenProvider>(userId, userName, password))) {}
 void GlobalNamespace::MockPlayerAuthenticationTokenProvider::_ctor(::StringW userId, ::StringW userName, ::StringW password)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::MockPlayerAuthenticationTokenProvider>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, userId, userName, password);
}
...
return ::cordl_internals::RunMethodRethrow<System::Threading::Tasks::Task_1<GlobalNamespace::AuthenticationToken>, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::GlobalNamespace__AuthenticationToken__Platform GlobalNamespace::MockPlayerAuthenticationTokenProvider::GetTokenPlatform(GlobalNamespace::PlatformEnvironment tokenPlatformEnvironment)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::MockPlayerAuthenticationTokenProvider>::get(),
                            "GetTokenPlatform",
                            std::vector<Il2CppClass*>{},
...
/// @param skipCache: bool (default: false)
 System::Threading::Tasks::Task_1<GlobalNamespace::XPlatformAccessTokenData> GlobalNamespace::MockPlayerAuthenticationTokenProvider::GetXPlatformAccessToken(System::Threading::CancellationToken cancellationToken, bool skipCache)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::MockPlayerAuthenticationTokenProvider>::get(),
                            "GetXPlatformAccessToken",
                            std::vector<Il2CppClass*>{},
