...
/// @brief Method .ctor addr 0x122945c size 0x64 virtual false final false
 void _ctor(::StringW packId) ;

/// @brief Method .ctor addr 0x12294c0 size 0x8 virtual false final false
 void _ctor(GlobalNamespace::BitMask128 bloomFilter) ;

/// @brief Method .ctor addr 0x12294c8 size 0x64 virtual false final false
 void _ctor(System::Collections::Generic::IEnumerable_1<::StringW> packs) ;

/// @brief Method get_all addr 0x122952c size 0xc virtual false final false
static GlobalNamespace::SongPackMask get_all() ;

/// @brief Method op_BitwiseOr addr 0x1229538 size 0xc virtual false final false
static GlobalNamespace::SongPackMask op_BitwiseOr(GlobalNamespace::SongPackMask a, GlobalNamespace::SongPackMask b) ;

/// @brief Method op_BitwiseAnd addr 0x1229544 size 0xc virtual false final false
static GlobalNamespace::SongPackMask op_BitwiseAnd(GlobalNamespace::SongPackMask a, GlobalNamespace::SongPackMask b) ;

/// @brief Method op_Equality addr 0x1229550 size 0x18 virtual false final false
static bool op_Equality(GlobalNamespace::SongPackMask a, GlobalNamespace::SongPackMask b) ;

/// @brief Method op_Inequality addr 0x1229568 size 0x18 virtual false final false
static bool op_Inequality(GlobalNamespace::SongPackMask a, GlobalNamespace::SongPackMask b) ;

/// @brief Method op_Implicit addr 0x1229580 size 0x28 virtual false final false
static GlobalNamespace::SongPackMask op_Implicit_GlobalNamespace__SongPackMask(::StringW id) ;

/// @brief Method Contains addr 0x12295a8 size 0x1c virtual false final false
 bool Contains(GlobalNamespace::SongPackMask other) ;

/// @brief Method DifferenceFrom addr 0x12295c4 size 0x60 virtual false final false
 int32_t DifferenceFrom(GlobalNamespace::SongPackMask other) ;

/// @brief Method Serialize addr 0x1229624 size 0x4 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method CreateFromSerializedData addr 0x1229628 size 0x8 virtual true final true
 GlobalNamespace::SongPackMask CreateFromSerializedData(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method Deserialize addr 0x1229630 size 0x4 virtual false final false
static GlobalNamespace::SongPackMask Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method ToString addr 0x1229634 size 0x78 virtual true final false
 ::StringW ToString() ;

/// @brief Method ToShortString addr 0x12296ac size 0x48 virtual false final false
 ::StringW ToShortString() ;

/// @brief Method ToBytes addr 0x12296f4 size 0x48 virtual false final false
 ::ArrayW<uint8_t> ToBytes() ;

/// @brief Method GetHashCode addr 0x122973c size 0x48 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x1229784 size 0x24 virtual true final true
 bool Equals(GlobalNamespace::SongPackMask other) ;

/// @brief Method Equals addr 0x12297a8 size 0x84 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method TryParse addr 0x122982c size 0x128 virtual false final false
static bool TryParse(::StringW stringSerializedMask, ByRef<GlobalNamespace::SongPackMask> songPackMask) ;

/// @brief Method Parse addr 0x1229954 size 0x90 virtual false final false
static GlobalNamespace::SongPackMask Parse(::StringW stringSerializedMask) ;

/// @brief Method FromBytes addr 0x12299e4 size 0x58 virtual false final false
