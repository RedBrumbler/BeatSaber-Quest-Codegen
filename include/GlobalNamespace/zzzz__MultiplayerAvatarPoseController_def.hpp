...
/// @brief Method set_connectedPlayer addr 0x20fae00 size 0x8 virtual false final false
 void set_connectedPlayer(GlobalNamespace::IConnectedPlayer value) ;

/// @brief Method Start addr 0x20fae08 size 0x18 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x20fae20 size 0x3b8 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit MultiplayerAvatarPoseController() ;

/// @brief Method .ctor addr 0x20fb1d8 size 0x8 virtual false final false
 void _ctor() ;
