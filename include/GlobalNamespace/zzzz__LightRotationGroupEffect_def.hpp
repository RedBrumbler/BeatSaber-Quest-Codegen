...
class CORDL_TYPE GlobalNamespace__LightRotationGroupEffect__InitData : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~GlobalNamespace__LightRotationGroupEffect__InitData() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__LightRotationGroupEffect__InitData", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__LightRotationGroupEffect__InitData(GlobalNamespace__LightRotationGroupEffect__InitData const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__LightRotationGroupEffect__InitData", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__LightRotationGroupEffect__InitData(GlobalNamespace__LightRotationGroupEffect__InitData&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__LightRotationGroupEffect__InitData(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__LightRotationGroupEffect__InitData& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__LightRotationGroupEffect__InitData& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__LightRotationGroupEffect__InitData& operator=(GlobalNamespace__LightRotationGroupEffect__InitData&& o) noexcept = default;
  constexpr GlobalNamespace__LightRotationGroupEffect__InitData& operator=(GlobalNamespace__LightRotationGroupEffect__InitData const& o) noexcept = default;
...
/// @brief Method .ctor addr 0x2298c54 size 0x54 virtual false final false
...
public:
// Declarations
using InitData = GlobalNamespace::GlobalNamespace__LightRotationGroupEffect__InitData;
...
/// @brief Method .ctor addr 0x2298658 size 0x220 virtual false final false
...
/// @brief Method Cleanup addr 0x2298878 size 0x9c virtual false final false
 void Cleanup() ;

/// @brief Method HandleRotationChangeBeatmapEvent addr 0x2298914 size 0x184 virtual false final false
 void HandleRotationChangeBeatmapEvent(GlobalNamespace::LightRotationBeatmapEventData currentEventData) ;

/// @brief Method SetRotation addr 0x2298a98 size 0xd8 virtual false final false
 void SetRotation(float_t rotation) ;

/// @brief Method ComputeTargetAngle addr 0x2298b70 size 0xe4 virtual false final false
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__LightRotationGroupEffect__InitData);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__LightRotationGroupEffect__InitData, "", "LightRotationGroupEffect/InitData");
