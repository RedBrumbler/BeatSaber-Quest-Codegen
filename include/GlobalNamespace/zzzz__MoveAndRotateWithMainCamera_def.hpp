...
/// @brief Method Awake addr 0x21dc5d8 size 0x4c virtual false final false
 void Awake() ;

/// @brief Method LateUpdate addr 0x21dc624 size 0x10c virtual false final false
 void LateUpdate() ;

// Ctor Parameters []
explicit MoveAndRotateWithMainCamera() ;

/// @brief Method .ctor addr 0x21dc730 size 0x8 virtual false final false
 void _ctor() ;
