...
/// @brief Method get_colorType addr 0x2284ab8 size 0x8 virtual false final false
 GlobalNamespace::ColorType get_colorType() ;

/// @brief Method get_saberInteractionParam addr 0x2284ac0 size 0x8 virtual false final false
 float_t get_saberInteractionParam() ;

/// @brief Method set_saberInteractionParam addr 0x2284ac8 size 0x8 virtual false final false
 void set_saberInteractionParam(float_t value) ;

/// @brief Method add_sliderWasAddedToActiveSlidersEvent addr 0x228471c size 0xb0 virtual false final false
 void add_sliderWasAddedToActiveSlidersEvent(System::Action_1<float_t> value) ;

/// @brief Method remove_sliderWasAddedToActiveSlidersEvent addr 0x2284954 size 0xb0 virtual false final false
 void remove_sliderWasAddedToActiveSlidersEvent(System::Action_1<float_t> value) ;

/// @brief Method add_allSliderWereRemovedFromActiveSlidersEvent addr 0x22847cc size 0x9c virtual false final false
 void add_allSliderWereRemovedFromActiveSlidersEvent(System::Action value) ;

/// @brief Method remove_allSliderWereRemovedFromActiveSlidersEvent addr 0x2284a04 size 0x9c virtual false final false
 void remove_allSliderWereRemovedFromActiveSlidersEvent(System::Action value) ;

/// @brief Method Start addr 0x2284ad0 size 0xe0 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2284bb0 size 0xf0 virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x2284ca0 size 0x164 virtual false final false
 void Update() ;

/// @brief Method AddActiveSlider addr 0x2284e04 size 0x220 virtual false final false
 void AddActiveSlider(GlobalNamespace::SliderController newSliderController) ;

/// @brief Method RemoveActiveSlider addr 0x2285024 size 0x98 virtual false final false
 void RemoveActiveSlider(GlobalNamespace::SliderController sliderController) ;

/// @brief Method HandleSliderWasSpawned addr 0x22850bc size 0x34 virtual false final false
 void HandleSliderWasSpawned(GlobalNamespace::SliderController sliderController) ;

/// @brief Method HandleSliderWasDespawned addr 0x22850f0 size 0x34 virtual false final false
 void HandleSliderWasDespawned(GlobalNamespace::SliderController sliderController) ;

// Ctor Parameters []
explicit SliderInteractionManager() ;

/// @brief Method .ctor addr 0x2285124 size 0x7c virtual false final false
 void _ctor() ;
