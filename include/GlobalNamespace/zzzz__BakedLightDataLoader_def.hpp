...
/// @brief Method get_lightmapData addr 0x21d2d1c size 0x8 virtual false final false
 GlobalNamespace::LightmapDataSO get_lightmapData() ;

/// @brief Method set_lightmapData addr 0x21d2d24 size 0x8 virtual false final false
 void set_lightmapData(GlobalNamespace::LightmapDataSO value) ;

/// @brief Method Start addr 0x21d2d2c size 0xb8 virtual false final false
 void Start() ;

/// @brief Method SetTextureDataToShaders addr 0x21d2de4 size 0x13c virtual false final false
 void SetTextureDataToShaders() ;

// Ctor Parameters []
explicit BakedLightDataLoader() ;

/// @brief Method .ctor addr 0x21d2f20 size 0x8 virtual false final false
 void _ctor() ;
