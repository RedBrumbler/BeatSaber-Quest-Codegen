...
/// @brief Method Start addr 0x229e180 size 0x124 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x229e2a4 size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleBeatmapEvent addr 0x229e2c0 size 0x20 virtual false final false
 void HandleBeatmapEvent(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

/// @brief Method ToggleObjects addr 0x229e2e0 size 0xc4 virtual false final false
 void ToggleObjects(bool isBoostOn) ;

// Ctor Parameters []
explicit MeshRendererSwitchEventEffect() ;

/// @brief Method .ctor addr 0x229e3a4 size 0x8 virtual false final false
 void _ctor() ;
