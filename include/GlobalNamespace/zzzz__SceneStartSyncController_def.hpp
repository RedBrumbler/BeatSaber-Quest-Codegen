...
/// @brief Method add_syncStartDidSuccessEvent addr 0x224af9c size 0xb0 virtual false final false
 void add_syncStartDidSuccessEvent(System::Action_1<::StringW> value) ;

/// @brief Method remove_syncStartDidSuccessEvent addr 0x224b04c size 0xb0 virtual false final false
 void remove_syncStartDidSuccessEvent(System::Action_1<::StringW> value) ;

/// @brief Method add_syncStartDidReceiveTooLateEvent addr 0x224b0fc size 0xb0 virtual false final false
 void add_syncStartDidReceiveTooLateEvent(System::Action_1<::StringW> value) ;

/// @brief Method remove_syncStartDidReceiveTooLateEvent addr 0x224b1ac size 0xb0 virtual false final false
 void remove_syncStartDidReceiveTooLateEvent(System::Action_1<::StringW> value) ;

/// @brief Method add_syncStartDidFailEvent addr 0x224b25c size 0x9c virtual false final false
 void add_syncStartDidFailEvent(System::Action value) ;

/// @brief Method remove_syncStartDidFailEvent addr 0x224b2f8 size 0x9c virtual false final false
 void remove_syncStartDidFailEvent(System::Action value) ;

/// @brief Method Start addr 0x224b394 size 0x18 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x224b3ac size 0x58 virtual false final false
 void Update() ;

/// @brief Method OnDestroy addr 0x224b404 size 0x100 virtual false final false
 void OnDestroy() ;

/// @brief Method StartSceneLoadSync addr 0x224b504 size 0x160 virtual false final false
 void StartSceneLoadSync(GlobalNamespace::PlayersSpecificSettingsAtGameStartModel playersAtGameStartModel) ;

/// @brief Method HandleSceneSetupDidFinish addr 0x224b664 size 0x4c virtual false final false
 void HandleSceneSetupDidFinish(::StringW sessionGameId) ;

/// @brief Method HandleSceneSetupDidReceiveTooLate addr 0x224b6b0 size 0x4c virtual false final false
 void HandleSceneSetupDidReceiveTooLate(::StringW sessionGameId) ;

// Ctor Parameters []
explicit SceneStartSyncController() ;

/// @brief Method .ctor addr 0x224b6fc size 0x8 virtual false final false
 void _ctor() ;
