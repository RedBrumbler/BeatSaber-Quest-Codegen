...
/// @brief Method Update addr 0x264e9f0 size 0xa8 virtual false final false
 void Update() ;

/// @brief Method TriggerCubemapCapture addr 0x264ea98 size 0x2b0 virtual false final false
static void TriggerCubemapCapture(UnityEngine::Vector3 capturePos, int32_t cubemapSize, ::StringW pathName) ;

/// @brief Method RenderIntoCubemap addr 0x264ed48 size 0x580 virtual false final false
static void RenderIntoCubemap(UnityEngine::Camera ownerCamera, UnityEngine::Cubemap outCubemap) ;

/// @brief Method SaveCubemapCapture addr 0x264f2c8 size 0x774 virtual false final false
static bool SaveCubemapCapture(UnityEngine::Cubemap cubemap, ::StringW pathName) ;

// Ctor Parameters []
explicit OVRCubemapCapture() ;

/// @brief Method .ctor addr 0x264fa3c size 0x28 virtual false final false
 void _ctor() ;
