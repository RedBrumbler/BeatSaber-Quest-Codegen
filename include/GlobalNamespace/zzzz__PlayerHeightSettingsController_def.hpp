...
/// @brief Method add_valueDidChangeEvent addr 0x218b128 size 0xb0 virtual false final false
 void add_valueDidChangeEvent(System::Action_1<float_t> value) ;

/// @brief Method remove_valueDidChangeEvent addr 0x218b1d8 size 0xb0 virtual false final false
 void remove_valueDidChangeEvent(System::Action_1<float_t> value) ;

/// @brief Method get_value addr 0x218b288 size 0x8 virtual false final false
 float_t get_value() ;

/// @brief Method Awake addr 0x218b290 size 0xc4 virtual false final false
 void Awake() ;

/// @brief Method Init addr 0x218b354 size 0x8 virtual false final false
 void Init(float_t playerHeight) ;

/// @brief Method AutoSetHeight addr 0x218b404 size 0x120 virtual false final false
 void AutoSetHeight() ;

/// @brief Method RefreshUI addr 0x218b35c size 0xa8 virtual false final false
 void RefreshUI() ;

// Ctor Parameters []
explicit PlayerHeightSettingsController() ;

/// @brief Method .ctor addr 0x218b524 size 0x8 virtual false final false
 void _ctor() ;
