...
/// @brief Method get_playerDataFileManager addr 0x2261234 size 0x8 virtual false final false
 GlobalNamespace::PlayerDataFileManagerSO get_playerDataFileManager() ;

/// @brief Method get_playerData addr 0x226123c size 0x8 virtual false final false
 GlobalNamespace::PlayerData get_playerData() ;

/// @brief Method OnEnable addr 0x2261244 size 0x4 virtual false final false
 void OnEnable() ;

/// @brief Method OnApplicationPause addr 0x2261270 size 0xc virtual false final false
 void OnApplicationPause(bool pauseStatus) ;

/// @brief Method OnDisable addr 0x226129c size 0x4 virtual false final false
 void OnDisable() ;

/// @brief Method ResetData addr 0x22612a0 size 0x24 virtual false final false
 void ResetData() ;

/// @brief Method Save addr 0x226127c size 0x20 virtual false final false
 void Save() ;

/// @brief Method Load addr 0x2261248 size 0x28 virtual false final false
 void Load() ;

// Ctor Parameters []
explicit PlayerDataModel() ;

/// @brief Method .ctor addr 0x22612c4 size 0x8 virtual false final false
 void _ctor() ;
