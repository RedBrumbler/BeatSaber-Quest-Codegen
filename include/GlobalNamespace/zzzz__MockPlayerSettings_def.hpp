...
/// @brief Method get_userName addr 0x21271c0 size 0x8 virtual false final false
 ::StringW get_userName() ;

/// @brief Method set_userName addr 0x21271c8 size 0x8 virtual false final false
 void set_userName(::StringW value) ;

/// @brief Method get_userId addr 0x21271d0 size 0x8 virtual false final false
 ::StringW get_userId() ;

/// @brief Method set_userId addr 0x21271d8 size 0x8 virtual false final false
 void set_userId(::StringW value) ;

/// @brief Method get_sortIndex addr 0x21271e0 size 0x8 virtual false final false
 int32_t get_sortIndex() ;

/// @brief Method set_sortIndex addr 0x21271e8 size 0x8 virtual false final false
 void set_sortIndex(int32_t value) ;

/// @brief Method get_latency addr 0x21271f0 size 0x8 virtual false final false
 float_t get_latency() ;

/// @brief Method set_latency addr 0x21271f8 size 0x8 virtual false final false
 void set_latency(float_t value) ;

/// @brief Method get_autoConnect addr 0x2127200 size 0x8 virtual false final false
 bool get_autoConnect() ;

/// @brief Method set_autoConnect addr 0x2127208 size 0xc virtual false final false
 void set_autoConnect(bool value) ;

/// @brief Method get_inactiveByDefault addr 0x2127214 size 0x8 virtual false final false
 bool get_inactiveByDefault() ;

/// @brief Method set_inactiveByDefault addr 0x212721c size 0xc virtual false final false
 void set_inactiveByDefault(bool value) ;

/// @brief Method get_movementType addr 0x2127228 size 0x8 virtual false final false
 GlobalNamespace::MockPlayerMovementType get_movementType() ;

/// @brief Method set_movementType addr 0x2127230 size 0x8 virtual false final false
 void set_movementType(GlobalNamespace::MockPlayerMovementType value) ;

/// @brief Method get_recodingFile addr 0x2127238 size 0x8 virtual false final false
 ::StringW get_recodingFile() ;

/// @brief Method set_recodingFile addr 0x2127240 size 0x8 virtual false final false
 void set_recodingFile(::StringW value) ;

/// @brief Method get_aiCubeHitChance addr 0x2127248 size 0x8 virtual false final false
 float_t get_aiCubeHitChance() ;

/// @brief Method set_aiCubeHitChance addr 0x2127250 size 0x8 virtual false final false
 void set_aiCubeHitChance(float_t value) ;

/// @brief Method get_leftHanded addr 0x2127258 size 0x8 virtual false final false
 bool get_leftHanded() ;

/// @brief Method set_leftHanded addr 0x2127260 size 0xc virtual false final false
 void set_leftHanded(bool value) ;

/// @brief Method get_saberAColor addr 0x212726c size 0xc virtual false final false
 UnityEngine::Color get_saberAColor() ;

/// @brief Method set_saberAColor addr 0x2127278 size 0xc virtual false final false
 void set_saberAColor(UnityEngine::Color value) ;

/// @brief Method get_saberBColor addr 0x2127284 size 0xc virtual false final false
 UnityEngine::Color get_saberBColor() ;

/// @brief Method set_saberBColor addr 0x2127290 size 0xc virtual false final false
 void set_saberBColor(UnityEngine::Color value) ;

/// @brief Method get_obstaclesColor addr 0x212729c size 0xc virtual false final false
 UnityEngine::Color get_obstaclesColor() ;

/// @brief Method set_obstaclesColor addr 0x21272a8 size 0xc virtual false final false
 void set_obstaclesColor(UnityEngine::Color value) ;

// Ctor Parameters []
explicit MockPlayerSettings() ;

/// @brief Method .ctor addr 0x21272b4 size 0x8 virtual false final false
 void _ctor() ;
