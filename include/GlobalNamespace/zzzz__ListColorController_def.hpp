...
/// @brief Method OnEnable addr 0x215df5c size 0x34 virtual false final false
 void OnEnable() ;

/// @brief Method RefreshUI addr 0x215df90 size 0x50 virtual false final false
 void RefreshUI() ;

/// @brief Method Refresh addr 0x215dfe0 size 0x5c virtual false final false
 void Refresh(bool applyValue) ;

/// @brief Method IncButtonPressed addr 0x215e03c size 0x40 virtual true final false
 void IncButtonPressed() ;

/// @brief Method DecButtonPressed addr 0x215e07c size 0x38 virtual true final false
 void DecButtonPressed() ;

// Ctor Parameters []
explicit ListColorController() ;

/// @brief Method .ctor addr 0x215e0b4 size 0x8 virtual false final false
 void _ctor() ;
