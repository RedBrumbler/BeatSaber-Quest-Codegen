...
/// @brief Method get_UseXPlatformAuth addr 0xde0bc0 size 0x8 virtual false final false
 bool get_UseXPlatformAuth() ;

/// @brief Method set_UseXPlatformAuth addr 0xde0bc8 size 0xc virtual false final false
 void set_UseXPlatformAuth(bool value) ;

// Ctor Parameters []
explicit XPlatformAuthFeatureFlag() ;

/// @brief Method .ctor addr 0xde0bd4 size 0x8 virtual false final false
 void _ctor() ;
