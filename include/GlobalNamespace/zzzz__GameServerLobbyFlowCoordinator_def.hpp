...
/// @brief Method .ctor addr 0x2173334 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Finish>b__0 addr 0x2175e14 size 0x70 virtual false final false
 void _Finish_b__0() ;
...
/// @brief Method .ctor addr 0x2174634 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <HandleServerPlayerListViewControllerKickPlayer>b__0 addr 0x2175e84 size 0xd8 virtual false final false
...
/// @brief Method get_isPartyOwner addr 0x216ea98 size 0x1c virtual false final false
 bool get_isPartyOwner() ;

/// @brief Method get_isPublicGame addr 0x216eab4 size 0xc0 virtual false final false
 bool get_isPublicGame() ;

/// @brief Method get_isManaged addr 0x216eb74 size 0xc0 virtual false final false
 bool get_isManaged() ;

/// @brief Method get_isQuickStartServer addr 0x216ec34 size 0xc0 virtual false final false
 bool get_isQuickStartServer() ;

/// @brief Method get_isQuickPlayServer addr 0x216ecf4 size 0xc0 virtual false final false
 bool get_isQuickPlayServer() ;

/// @brief Method add_willFinishEvent addr 0x216edb4 size 0xa0 virtual false final false
 void add_willFinishEvent(System::Action value) ;

/// @brief Method remove_willFinishEvent addr 0x216ee54 size 0xa0 virtual false final false
 void remove_willFinishEvent(System::Action value) ;

/// @brief Method add_didFinishEvent addr 0x216eef4 size 0xa0 virtual false final false
 void add_didFinishEvent(System::Action value) ;

/// @brief Method remove_didFinishEvent addr 0x216ef94 size 0xa0 virtual false final false
 void remove_didFinishEvent(System::Action value) ;

/// @brief Method add_startGameOrReadyEvent addr 0x216f034 size 0xa0 virtual false final false
 void add_startGameOrReadyEvent(System::Action value) ;

/// @brief Method remove_startGameOrReadyEvent addr 0x216f0d4 size 0xa0 virtual false final false
 void remove_startGameOrReadyEvent(System::Action value) ;

/// @brief Method add_didSetupEvent addr 0x216f174 size 0xa0 virtual false final false
 void add_didSetupEvent(System::Action value) ;

/// @brief Method remove_didSetupEvent addr 0x216f214 size 0xa0 virtual false final false
 void remove_didSetupEvent(System::Action value) ;

/// @brief Method add_didOpenInvitePanelEvent addr 0x216f2b4 size 0xa0 virtual false final false
 void add_didOpenInvitePanelEvent(System::Action value) ;

/// @brief Method remove_didOpenInvitePanelEvent addr 0x216f354 size 0xa0 virtual false final false
 void remove_didOpenInvitePanelEvent(System::Action value) ;

/// @brief Method get_rejoinQuickPlay addr 0x216f3f4 size 0x8 virtual false final false
 bool get_rejoinQuickPlay() ;

/// @brief Method set_rejoinQuickPlay addr 0x216f3fc size 0xc virtual false final false
 void set_rejoinQuickPlay(bool value) ;

/// @brief Method GetLobbyType addr 0x216f408 size 0x50 virtual false final false
 GlobalNamespace::GlobalNamespace__GameServerLobbyFlowCoordinator__LobbyType GetLobbyType() ;

/// @brief Method DidActivate addr 0x216f458 size 0x1170 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x2170dd0 size 0xe58 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method InitialViewControllerWasPresented addr 0x2171d74 size 0xdc virtual true final false
 void InitialViewControllerWasPresented() ;

/// @brief Method TransitionDidStart addr 0x2171f98 size 0x1d8 virtual true final false
 void TransitionDidStart() ;

/// @brief Method TransitionDidFinish addr 0x2172170 size 0x584 virtual true final false
 void TransitionDidFinish() ;

/// @brief Method TopViewControllerWillChange addr 0x2172b34 size 0xa8 virtual true final false
...
/// @brief Method BackButtonWasPressed addr 0x2172d78 size 0x168 virtual true final false
 void BackButtonWasPressed(HMUI::ViewController topViewController) ;

/// @brief Method PresentBackButtonConfirmationDialog addr 0x2172ee0 size 0x260 virtual false final false
 void PresentBackButtonConfirmationDialog() ;

/// @brief Method Finish addr 0x2173140 size 0x1f4 virtual false final false
 void Finish(System::Action finishedCallback, bool withFadeOut) ;

/// @brief Method GetInitialGameState addr 0x2171e50 size 0x148 virtual false final false
 void GetInitialGameState() ;

/// @brief Method HandleLobbyPlayersDataModelDidChange addr 0x2173434 size 0x4 virtual false final false
 void HandleLobbyPlayersDataModelDidChange(::StringW userId) ;

/// @brief Method HandleServerPlayerListViewControllerDidOpenInvitePanel addr 0x2173438 size 0x1c virtual false final false
 void HandleServerPlayerListViewControllerDidOpenInvitePanel() ;

/// @brief Method HandleLobbySetupViewControllerSelectBeatmap addr 0x2173454 size 0x1c8 virtual false final false
 void HandleLobbySetupViewControllerSelectBeatmap() ;

/// @brief Method HandleMultiplayerSettingsPanelControllerPlayerActiveStateChanged addr 0x2173638 size 0x230 virtual false final false
 void HandleMultiplayerSettingsPanelControllerPlayerActiveStateChanged(bool isActive) ;

/// @brief Method HandleLobbyGameStateControllerLobbyDisconnected addr 0x2173a88 size 0xb0 virtual false final false
 void HandleLobbyGameStateControllerLobbyDisconnected() ;

/// @brief Method HandleMultiplayerLevelSelectionFlowCoordinatorDidSelectLevel addr 0x2173b38 size 0x304 virtual false final false
...
/// @brief Method HandleMultiplayerLevelSelectionFlowCoordinatorCancelSelectLevel addr 0x2173e3c size 0x38 virtual false final false
 void HandleMultiplayerLevelSelectionFlowCoordinatorCancelSelectLevel() ;

/// @brief Method HandleLobbySetupViewControllerSelectModifiers addr 0x2173e74 size 0x1f8 virtual false final false
 void HandleLobbySetupViewControllerSelectModifiers() ;

/// @brief Method HandleLobbySetupViewControllerClearSelectedBeatmap addr 0x217406c size 0xa4 virtual false final false
 void HandleLobbySetupViewControllerClearSelectedBeatmap() ;

/// @brief Method HandleLobbySetupViewControllerClearSelectedModifiers addr 0x2174110 size 0xa4 virtual false final false
 void HandleLobbySetupViewControllerClearSelectedModifiers() ;

/// @brief Method HandleLobbyGameStateControllerGameStateChanged addr 0x21741b4 size 0x1c virtual false final false
 void HandleLobbyGameStateControllerGameStateChanged(GlobalNamespace::MultiplayerLobbyState state) ;

/// @brief Method HandleServerPlayerListViewControllerSelectSuggestedBeatmap addr 0x21741d0 size 0xac virtual false final false
 void HandleServerPlayerListViewControllerSelectSuggestedBeatmap(GlobalNamespace::PreviewDifficultyBeatmap beatmapLevel) ;

/// @brief Method HandleServerPlayerListViewControllerSelectSuggestedGameplayModifiers addr 0x217427c size 0xac virtual false final false
 void HandleServerPlayerListViewControllerSelectSuggestedGameplayModifiers(GlobalNamespace::GameplayModifiers modifiers) ;

/// @brief Method HandleServerPlayerListViewControllerKickPlayer addr 0x2174328 size 0x30c virtual false final false
 void HandleServerPlayerListViewControllerKickPlayer(::StringW userId) ;

/// @brief Method HandleLobbyGameStateControllerCountdownStarted addr 0x217463c size 0x1ec virtual false final false
 void HandleLobbyGameStateControllerCountdownStarted() ;

/// @brief Method HandleLobbyGameStateControllerCountdownCancelled addr 0x2174828 size 0x38 virtual false final false
 void HandleLobbyGameStateControllerCountdownCancelled() ;

/// @brief Method HandleLobbyGameStateControllerGameStarted addr 0x2174860 size 0x2a4 virtual false final false
 void HandleLobbyGameStateControllerGameStarted(GlobalNamespace::ILevelGameplaySetupData levelGameplaySetupData) ;

/// @brief Method HandleLobbyGameStateControllerStartTimeChanged addr 0x2174b04 size 0x1bc virtual false final false
 void HandleLobbyGameStateControllerStartTimeChanged() ;

/// @brief Method HandleLobbyGameStateControllerSongStillDownloading addr 0x2174cc0 size 0x4 virtual false final false
 void HandleLobbyGameStateControllerSongStillDownloading() ;

/// @brief Method HandleLobbySetupViewControllerStartGameOrReady addr 0x2174cc4 size 0x314 virtual false final false
 void HandleLobbySetupViewControllerStartGameOrReady() ;

/// @brief Method HandleLobbySetupViewControllerCancelGameOrUnready addr 0x2174fd8 size 0x174 virtual false final false
 void HandleLobbySetupViewControllerCancelGameOrUnready() ;

/// @brief Method HandleLobbyGameStateControllerCancelStartTime addr 0x217514c size 0x38 virtual false final false
 void HandleLobbyGameStateControllerCancelStartTime() ;

/// @brief Method HandleLobbyGameStateControllerGameStartedPresentView addr 0x2175184 size 0xac virtual false final false
 void HandleLobbyGameStateControllerGameStartedPresentView(GlobalNamespace::ILevelGameplaySetupData levelGameplaySetupData) ;

/// @brief Method HandleLobbyGameStateControllerLevelFinished addr 0x2175230 size 0x348 virtual false final false
...
/// @brief Method HandleLobbyGameStateControllerLevelDidGetDisconnected addr 0x2175578 size 0x4 virtual false final false
 void HandleLobbyGameStateControllerLevelDidGetDisconnected(GlobalNamespace::DisconnectedReason disconnectedReason) ;

/// @brief Method HandleMultiplayerResultsViewControllerBackToLobbyPressed addr 0x217557c size 0x14c virtual false final false
...
/// @brief Method HandleMultiplayerResultsViewControllerBackToMenuPressed addr 0x21756c8 size 0xc virtual false final false
...
/// @brief Method SetupLobbyWithPermissions addr 0x2170918 size 0x4b8 virtual false final false
 void SetupLobbyWithPermissions() ;

/// @brief Method SetLobbyPlayerDataToViews addr 0x2170714 size 0x204 virtual false final false
 void SetLobbyPlayerDataToViews(::StringW userId) ;

/// @brief Method ShowSideViewControllers addr 0x2172bdc size 0x64 virtual false final false
 void ShowSideViewControllers(bool showSideViewControllers, HMUI::HMUI__ViewController__AnimationType animationType) ;

/// @brief Method ShowBackButton addr 0x2172c40 size 0xc virtual false final false
 void ShowBackButton(bool show) ;

/// @brief Method GetLocalizedTitle addr 0x21756d4 size 0x8c virtual false final false
 ::StringW GetLocalizedTitle() ;

/// @brief Method SetTitle addr 0x2172c4c size 0x12c virtual false final false
 void SetTitle(HMUI::ViewController newViewController, HMUI::HMUI__ViewController__AnimationType animationType) ;

/// @brief Method ShowDisconnectDialogAndFinish addr 0x21726f4 size 0x440 virtual false final false
 void ShowDisconnectDialogAndFinish(GlobalNamespace::DisconnectedReason disconnectedReason) ;

/// @brief Method UpdateLocalPlayerIsActiveState addr 0x2173868 size 0x220 virtual false final false
 void UpdateLocalPlayerIsActiveState(bool isActive) ;

/// @brief Method HandleLobbyGameBeforeSceneSwitchCallback addr 0x2175760 size 0x1f4 virtual false final false
 void HandleLobbyGameBeforeSceneSwitchCallback() ;

/// @brief Method HandleLobbyGameStateStartButtonEnabled addr 0x2175954 size 0x34 virtual false final false
 void HandleLobbyGameStateStartButtonEnabled(GlobalNamespace::CannotStartGameReason cannotStartGameReason) ;

/// @brief Method HandleMenuRpcManagerSetPlayersMissingEntitlementsToLevel addr 0x2175988 size 0x2cc virtual false final false
...
/// @brief Method HandleLobbyPlayerPermissionsModelPermissionsChanged addr 0x2175c54 size 0x4 virtual false final false
 void HandleLobbyPlayerPermissionsModelPermissionsChanged() ;

/// @brief Method DismissViewControllersAndCoordinators addr 0x217333c size 0xf8 virtual false final false
 void DismissViewControllersAndCoordinators() ;

// Ctor Parameters []
explicit GameServerLobbyFlowCoordinator() ;

/// @brief Method .ctor addr 0x2175c58 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method <PresentBackButtonConfirmationDialog>b__69_0 addr 0x2175cc0 size 0x148 virtual false final false
 void _PresentBackButtonConfirmationDialog_b__69_0(int32_t btnIndex) ;

/// @brief Method <ShowDisconnectDialogAndFinish>b__105_0 addr 0x2175e08 size 0xc virtual false final false
