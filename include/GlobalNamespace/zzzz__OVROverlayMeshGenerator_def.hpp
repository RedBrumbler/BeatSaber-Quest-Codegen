...
/// @brief Method Awake addr 0x26053d0 size 0x174 virtual false final false
 void Awake() ;

/// @brief Method SetOverlay addr 0x2605544 size 0x8 virtual false final false
 void SetOverlay(GlobalNamespace::OVROverlay overlay) ;

/// @brief Method GetBoundingRect addr 0x260554c size 0x144 virtual false final false
 UnityEngine::Rect GetBoundingRect(UnityEngine::Rect a, UnityEngine::Rect b) ;

/// @brief Method OnEnable addr 0x2605690 size 0x4 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2605694 size 0x4 virtual false final false
 void OnDisable() ;

/// @brief Method Update addr 0x2605698 size 0x624 virtual false final false
 void Update() ;

/// @brief Method UpdateMesh addr 0x2605cbc size 0x2e0 virtual false final false
...
/// @brief Method GenerateMesh addr 0x2605f9c size 0x338 virtual false final false
...
/// @brief Method GetSphereUV addr 0x2607d3c size 0x38 virtual false final false
static UnityEngine::Vector2 GetSphereUV(float_t theta, float_t phi, float_t expand_coef) ;

/// @brief Method GetSphereVert addr 0x2607d74 size 0x54 virtual false final false
static UnityEngine::Vector3 GetSphereVert(float_t theta, float_t phi) ;

/// @brief Method BuildSphere addr 0x26062d4 size 0x784 virtual false final false
...
/// @brief Method GetCubeUV addr 0x2607dc8 size 0x140 virtual false final false
...
/// @brief Method GetCubeVert addr 0x2607f08 size 0x10c virtual false final false
...
/// @brief Method BuildCube addr 0x2606a58 size 0x564 virtual false final false
...
/// @brief Method BuildQuad addr 0x2606fbc size 0x720 virtual false final false
...
/// @brief Method BuildHemicylinder addr 0x26076dc size 0x660 virtual false final false
...
/// @brief Method .ctor addr 0x2608014 size 0x104 virtual false final false
 void _ctor() ;
