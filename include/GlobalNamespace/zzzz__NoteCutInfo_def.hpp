...
/// @brief Method get_allIsOK addr 0x1223d20 size 0x30 virtual false final false
 bool get_allIsOK() ;

/// @brief Method get_allExceptSaberTypeIsOK addr 0x1223d50 size 0x28 virtual false final false
 bool get_allExceptSaberTypeIsOK() ;

/// @brief Method get_failReason addr 0x1223d78 size 0x44 virtual false final false
 GlobalNamespace::GlobalNamespace__NoteCutInfo__FailReason get_failReason() ;

/// @brief Method .ctor addr 0x1223dbc size 0x234 virtual false final false
