...
/// @brief Method Start addr 0x22a3398 size 0x44 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x22a3420 size 0x60 virtual false final false
 void Update() ;

/// @brief Method UpdatePos addr 0x22a33dc size 0x44 virtual false final false
 void UpdatePos() ;

// Ctor Parameters []
explicit FlyingCar() ;

/// @brief Method .ctor addr 0x22a3480 size 0x1c virtual false final false
 void _ctor() ;
