...
/// @brief Method ToJSON addr 0x266794c size 0x734 virtual false final false
 ::StringW ToJSON() ;

/// @brief Method LoadFromJSON addr 0x2668080 size 0x948 virtual false final false
 bool LoadFromJSON(::StringW json) ;

// Ctor Parameters []
explicit GlobalNamespace__OVRSystemPerfMetrics__PerfMetrics() ;

/// @brief Method .ctor addr 0x2669164 size 0xb8 virtual false final false
 void _ctor() ;
...
/// @brief Method OnEnable addr 0x266921c size 0x110 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x266932c size 0x9c virtual false final false
 void OnDisable() ;

/// @brief Method Update addr 0x26693c8 size 0x7c virtual false final false
 void Update() ;

/// @brief Method GatherPerfMetrics addr 0x2669444 size 0x300 virtual false final false
...
/// @brief Method .ctor addr 0x2669744 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2667944 size 0x8 virtual false final false
 void _ctor() ;
