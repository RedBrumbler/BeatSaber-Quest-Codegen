...
/// @brief Method get_apiName addr 0x2264dec size 0x8 virtual true final true
 ::StringW get_apiName() ;

/// @brief Method set_apiName addr 0x2264df4 size 0x8 virtual false final false
 void set_apiName(::StringW value) ;

/// @brief Method get_localizedDescription addr 0x2264dfc size 0x8 virtual true final true
 ::StringW get_localizedDescription() ;

/// @brief Method set_localizedDescription addr 0x2264e04 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2264e0c size 0x40 virtual false final false
 void _ctor(GlobalNamespace::IDifficultyBeatmap difficultyBeatmap) ;

/// @brief Method GetDestinationLocalizedString addr 0x2264e4c size 0x46c virtual false final false
