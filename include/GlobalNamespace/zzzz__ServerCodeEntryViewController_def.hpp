...
/// @brief Method add_didFinishEvent addr 0x21b027c size 0xb0 virtual false final false
 void add_didFinishEvent(System::Action_2<bool,::StringW> value) ;

/// @brief Method remove_didFinishEvent addr 0x21b032c size 0xb0 virtual false final false
 void remove_didFinishEvent(System::Action_2<bool,::StringW> value) ;

/// @brief Method DidActivate addr 0x21b03dc size 0x1b0 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x21b058c size 0x30 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method HandleInputFieldChanged addr 0x21b05bc size 0x38 virtual false final false
 void HandleInputFieldChanged(HMUI::InputFieldView obj) ;

/// @brief Method OnDestroy addr 0x21b05f4 size 0x28 virtual true final false
 void OnDestroy() ;

/// @brief Method HandleJoinButtonPressed addr 0x21b061c size 0x3c virtual false final false
 void HandleJoinButtonPressed() ;

/// @brief Method HandleCancelButtonPressed addr 0x21b0658 size 0x24 virtual false final false
 void HandleCancelButtonPressed() ;

// Ctor Parameters []
explicit ServerCodeEntryViewController() ;

/// @brief Method .ctor addr 0x21b067c size 0x68 virtual false final false
 void _ctor() ;
