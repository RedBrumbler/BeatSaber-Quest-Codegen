...
/// @brief Method get_executionOrder addr 0x2145fe4 size 0x1c virtual false final false
 int32_t get_executionOrder() ;

/// @brief Method get_maxPossibleCutScore addr 0x2146000 size 0x1c virtual true final true
 int32_t get_maxPossibleCutScore() ;

/// @brief Method get_isFinished addr 0x214601c size 0x8 virtual true final true
 bool get_isFinished() ;

/// @brief Method get_cutScore addr 0x2146024 size 0x30 virtual true final true
 int32_t get_cutScore() ;

/// @brief Method get_beforeCutScore addr 0x2146054 size 0x8 virtual true final true
 int32_t get_beforeCutScore() ;

/// @brief Method get_centerDistanceCutScore addr 0x214605c size 0x8 virtual true final true
 int32_t get_centerDistanceCutScore() ;

/// @brief Method get_afterCutScore addr 0x2146064 size 0x8 virtual true final true
 int32_t get_afterCutScore() ;

/// @brief Method get_noteScoreDefinition addr 0x214606c size 0x8 virtual true final true
 GlobalNamespace::GlobalNamespace__ScoreModel__NoteScoreDefinition get_noteScoreDefinition() ;

/// @brief Method get_noteCutInfo addr 0x2146074 size 0x10 virtual true final true
 GlobalNamespace::NoteCutInfo get_noteCutInfo() ;

/// @brief Method get_beforeCutSwingRating addr 0x2146084 size 0x1c virtual true final true
 float_t get_beforeCutSwingRating() ;

/// @brief Method get_afterCutSwingRating addr 0x21460a0 size 0x1c virtual true final true
 float_t get_afterCutSwingRating() ;

/// @brief Method RegisterDidChangeReceiver addr 0x21460bc size 0x58 virtual true final true
 void RegisterDidChangeReceiver(GlobalNamespace::ICutScoreBufferDidChangeReceiver receiver) ;

/// @brief Method RegisterDidFinishReceiver addr 0x2146114 size 0x58 virtual true final true
 void RegisterDidFinishReceiver(GlobalNamespace::ICutScoreBufferDidFinishReceiver receiver) ;

/// @brief Method UnregisterDidChangeReceiver addr 0x214616c size 0x58 virtual true final true
 void UnregisterDidChangeReceiver(GlobalNamespace::ICutScoreBufferDidChangeReceiver receiver) ;

/// @brief Method UnregisterDidFinishReceiver addr 0x21461c4 size 0x58 virtual true final true
 void UnregisterDidFinishReceiver(GlobalNamespace::ICutScoreBufferDidFinishReceiver receiver) ;

/// @brief Method Init addr 0x214621c size 0x264 virtual false final false
 bool Init(ByRef<GlobalNamespace::NoteCutInfo> noteCutInfo) ;

/// @brief Method RefreshScores addr 0x2146480 size 0x208 virtual false final false
 void RefreshScores() ;

/// @brief Method HandleSaberSwingRatingCounterDidChange addr 0x2146688 size 0x1d4 virtual true final true
 void HandleSaberSwingRatingCounterDidChange(GlobalNamespace::ISaberSwingRatingCounter swingRatingCounter, float_t rating) ;

/// @brief Method HandleSaberSwingRatingCounterDidFinish addr 0x214685c size 0x2b8 virtual true final true
...
/// @brief Method .ctor addr 0x2146b14 size 0xf0 virtual false final false
 void _ctor() ;
