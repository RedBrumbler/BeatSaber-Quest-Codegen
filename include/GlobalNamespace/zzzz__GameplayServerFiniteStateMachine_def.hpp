...
/// @brief Method .ctor addr 0xdbde84 size 0x2c virtual false final false
...
/// @brief Method get_taskUtility addr 0xdbddd4 size 0x8 virtual false final false
 BGNet::Core::ITaskUtility get_taskUtility() ;

/// @brief Method set_taskUtility addr 0xdbdddc size 0x8 virtual false final false
 void set_taskUtility(BGNet::Core::ITaskUtility value) ;

/// @brief Method get_multiplayerSessionManager addr 0xdbdde4 size 0x8 virtual false final false
 GlobalNamespace::IMultiplayerSessionManager get_multiplayerSessionManager() ;

/// @brief Method set_multiplayerSessionManager addr 0xdbddec size 0x8 virtual false final false
 void set_multiplayerSessionManager(GlobalNamespace::IMultiplayerSessionManager value) ;

/// @brief Method get_ownerUserId addr 0xdbddf4 size 0x8 virtual false final false
 ::StringW get_ownerUserId() ;

/// @brief Method set_ownerUserId addr 0xdbddfc size 0x8 virtual false final false
 void set_ownerUserId(::StringW value) ;

/// @brief Method get_selectionMask addr 0xdbde04 size 0x14 virtual false final false
 GlobalNamespace::BeatmapLevelSelectionMask get_selectionMask() ;

/// @brief Method set_selectionMask addr 0xdbde18 size 0x14 virtual false final false
 void set_selectionMask(GlobalNamespace::BeatmapLevelSelectionMask value) ;

/// @brief Method get_configuration addr 0xdbde2c size 0x14 virtual false final false
 GlobalNamespace::GameplayServerConfiguration get_configuration() ;

/// @brief Method set_configuration addr 0xdbde40 size 0x14 virtual false final false
 void set_configuration(GlobalNamespace::GameplayServerConfiguration value) ;

/// @brief Method get_beatmapProvider addr 0xdbde54 size 0x8 virtual false final false
 GlobalNamespace::IServerBeatmapProvider get_beatmapProvider() ;

/// @brief Method set_beatmapProvider addr 0xdbde5c size 0x8 virtual false final false
 void set_beatmapProvider(GlobalNamespace::IServerBeatmapProvider value) ;

/// @brief Method get_menuRpcManager addr 0xdbde64 size 0x8 virtual false final false
 GlobalNamespace::MenuRpcManager get_menuRpcManager() ;

/// @brief Method set_menuRpcManager addr 0xdbde6c size 0x8 virtual false final false
 void set_menuRpcManager(GlobalNamespace::MenuRpcManager value) ;

/// @brief Method get_gameplayRpcManager addr 0xdbde74 size 0x8 virtual false final false
 GlobalNamespace::GameplayRpcManager get_gameplayRpcManager() ;

/// @brief Method set_gameplayRpcManager addr 0xdbde7c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xdbdcb8 size 0x11c virtual false final false
