...
/// @brief Method .ctor addr 0x210b6b4 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x210b684 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x210b6dc size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x210b6e0 size 0x174 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x210b9e8 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x210b9f0 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x210ba30 size 0x8 virtual true final true
...
/// @brief Method Start addr 0x210b408 size 0xec virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x210b4f4 size 0x108 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleLevelFailed addr 0x210b5fc size 0x20 virtual false final false
 void HandleLevelFailed() ;

/// @brief Method LevelFailedCoroutine addr 0x210b61c size 0x68 virtual false final false
 System::Collections::IEnumerator LevelFailedCoroutine() ;

// Ctor Parameters []
explicit MissionLevelFailedController() ;

/// @brief Method .ctor addr 0x210b6ac size 0x8 virtual false final false
 void _ctor() ;
