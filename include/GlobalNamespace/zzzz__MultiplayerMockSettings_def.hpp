...
/// @brief Method get_quickplayServer addr 0x2127344 size 0x8 virtual false final false
 GlobalNamespace::MockServerSettings get_quickplayServer() ;

/// @brief Method get_localPlayer addr 0x212734c size 0xac virtual false final false
 GlobalNamespace::MockPlayerSettings get_localPlayer() ;

/// @brief Method get_quickPlaySetupData addr 0x21273f8 size 0x8 virtual false final false
 GlobalNamespace::QuickPlaySetupData get_quickPlaySetupData() ;

/// @brief Method set_quickPlaySetupData addr 0x2127400 size 0x8 virtual false final false
 void set_quickPlaySetupData(GlobalNamespace::QuickPlaySetupData value) ;

/// @brief Method get_multiplayerStatusData addr 0x2127408 size 0x8 virtual false final false
 GlobalNamespace::MultiplayerStatusData get_multiplayerStatusData() ;

/// @brief Method set_multiplayerStatusData addr 0x2127410 size 0x8 virtual false final false
 void set_multiplayerStatusData(GlobalNamespace::MultiplayerStatusData value) ;

/// @brief Method get_otherPlayers addr 0x2127418 size 0x8 virtual false final false
 System::Collections::Generic::List_1<GlobalNamespace::MockPlayerSettings> get_otherPlayers() ;

/// @brief Method get_isEnabled addr 0x2127420 size 0x8 virtual false final false
 bool get_isEnabled() ;

/// @brief Method set_isEnabled addr 0x2127428 size 0xc virtual false final false
 void set_isEnabled(bool value) ;

/// @brief Method SharedSettings addr 0x2127434 size 0x8 virtual false final false
static GlobalNamespace::MultiplayerMockSettings SharedSettings() ;

// Ctor Parameters []
explicit MultiplayerMockSettings() ;

/// @brief Method .ctor addr 0x212743c size 0x7c virtual false final false
 void _ctor() ;
