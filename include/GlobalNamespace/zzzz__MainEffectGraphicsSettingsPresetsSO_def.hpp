...
/// @brief Method .ctor addr 0x2227da4 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_presets addr 0x2227d8c size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::GlobalNamespace__MainEffectGraphicsSettingsPresetsSO__Preset> get_presets() ;

/// @brief Method get_namedPresets addr 0x2227d94 size 0x8 virtual true final false
 ::ArrayW<GlobalNamespace::NamedPreset> get_namedPresets() ;

// Ctor Parameters []
explicit MainEffectGraphicsSettingsPresetsSO() ;

/// @brief Method .ctor addr 0x2227d9c size 0x8 virtual false final false
 void _ctor() ;
