...
/// @brief Method .ctor addr 0x229261c size 0x28 virtual false final false
...
/// @brief Method Init addr 0x2291f3c size 0x84 virtual false final false
 void Init(GlobalNamespace::GlobalNamespace__BeatEffect__Pool beatEffectPool) ;

/// @brief Method Start addr 0x2291fc0 size 0x8c virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x229204c size 0x98 virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x22920e4 size 0x184 virtual false final false
 void Update() ;

/// @brief Method HandleNoteDidStartJump addr 0x2292268 size 0x2c0 virtual false final false
 void HandleNoteDidStartJump(GlobalNamespace::NoteController noteController) ;

/// @brief Method HandleBeatEffectDidFinish addr 0x2292528 size 0xd8 virtual true final true
 void HandleBeatEffectDidFinish(GlobalNamespace::BeatEffect beatEffect) ;

// Ctor Parameters []
explicit BeatEffectSpawner() ;

/// @brief Method .ctor addr 0x2292600 size 0x1c virtual false final false
 void _ctor() ;
