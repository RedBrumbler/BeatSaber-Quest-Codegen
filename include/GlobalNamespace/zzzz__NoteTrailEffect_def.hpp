...
/// @brief Method Awake addr 0x229e548 size 0x100 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x229e648 size 0x12c virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x229e774 size 0x64 virtual false final false
 void Update() ;

/// @brief Method HandleNoteMovementDidInit addr 0x229e7d8 size 0xc virtual false final false
 void HandleNoteMovementDidInit() ;

/// @brief Method HandleNoteDidStartJump addr 0x229e7e4 size 0xc virtual false final false
 void HandleNoteDidStartJump() ;

// Ctor Parameters []
explicit NoteTrailEffect() ;

/// @brief Method .ctor addr 0x229e7f0 size 0x14 virtual false final false
 void _ctor() ;
