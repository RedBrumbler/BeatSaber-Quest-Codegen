...
/// @brief Method .ctor addr 0x22b0bf8 size 0x28 virtual false final false
...
/// @brief Method Init addr 0x22b0afc size 0x80 virtual false final false
 void Init() ;

/// @brief Method Update addr 0x22b0b7c size 0x6c virtual false final false
 void Update() ;

// Ctor Parameters []
explicit RecordingUIController() ;

/// @brief Method .ctor addr 0x22b0be8 size 0x10 virtual false final false
 void _ctor() ;
