...
/// @brief Method get_time addr 0x22b3508 size 0x8 virtual false final false
 float_t get_time() ;

/// @brief Method set_time addr 0x22b3510 size 0x8 virtual false final false
 void set_time(float_t value) ;

/// @brief Method get_lineIndex addr 0x22b3518 size 0x8 virtual false final false
 int32_t get_lineIndex() ;

/// @brief Method set_lineIndex addr 0x22b3520 size 0x8 virtual false final false
 void set_lineIndex(int32_t value) ;

/// @brief Method get_lineLayer addr 0x22b3528 size 0x8 virtual false final false
 GlobalNamespace::NoteLineLayer get_lineLayer() ;

/// @brief Method set_lineLayer addr 0x22b3530 size 0x8 virtual false final false
 void set_lineLayer(GlobalNamespace::NoteLineLayer value) ;

/// @brief Method get_duration addr 0x22b3538 size 0x8 virtual false final false
 float_t get_duration() ;

/// @brief Method set_duration addr 0x22b3540 size 0x8 virtual false final false
 void set_duration(float_t value) ;

/// @brief Method get_width addr 0x22b3548 size 0x8 virtual false final false
 int32_t get_width() ;

/// @brief Method set_width addr 0x22b3550 size 0x8 virtual false final false
 void set_width(int32_t value) ;

// Ctor Parameters []
explicit MockObstacleData() ;

/// @brief Method .ctor addr 0x22b3558 size 0x8 virtual false final false
 void _ctor() ;
