...
/// @brief Method get_maxCombo addr 0x21458d8 size 0x8 virtual false final false
 int32_t get_maxCombo() ;

/// @brief Method add_comboDidChangeEvent addr 0x21458e0 size 0xb0 virtual true final true
 void add_comboDidChangeEvent(System::Action_1<int32_t> value) ;

/// @brief Method remove_comboDidChangeEvent addr 0x2145990 size 0xb0 virtual true final true
 void remove_comboDidChangeEvent(System::Action_1<int32_t> value) ;

/// @brief Method add_comboBreakingEventHappenedEvent addr 0x2145a40 size 0x9c virtual true final true
 void add_comboBreakingEventHappenedEvent(System::Action value) ;

/// @brief Method remove_comboBreakingEventHappenedEvent addr 0x2145adc size 0x9c virtual true final true
 void remove_comboBreakingEventHappenedEvent(System::Action value) ;

/// @brief Method Start addr 0x2145b78 size 0x150 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2145cc8 size 0x19c virtual false final false
 void OnDestroy() ;

/// @brief Method HandlePlayerHeadDidEnterObstacles addr 0x2145e64 size 0x58 virtual false final false
 void HandlePlayerHeadDidEnterObstacles() ;

/// @brief Method HandleNoteWasCut addr 0x2145ebc size 0x9c virtual false final false
 void HandleNoteWasCut(GlobalNamespace::NoteController noteController, ByRef<GlobalNamespace::NoteCutInfo> noteCutInfo) ;

/// @brief Method HandleNoteWasMissed addr 0x2145f58 size 0x84 virtual false final false
 void HandleNoteWasMissed(GlobalNamespace::NoteController noteController) ;

// Ctor Parameters []
explicit ComboController() ;

/// @brief Method .ctor addr 0x2145fdc size 0x8 virtual false final false
 void _ctor() ;
