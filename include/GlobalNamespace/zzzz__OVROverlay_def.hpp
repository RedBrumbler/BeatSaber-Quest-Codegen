...
/// @brief Method .ctor addr 0x26052d4 size 0xbc virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x2605390 size 0x14 virtual true final false
 void Invoke() ;

/// @brief Method BeginInvoke addr 0x26053a4 size 0x20 virtual true final false
 System::IAsyncResult BeginInvoke(System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType object) ;

/// @brief Method EndInvoke addr 0x26053c4 size 0xc virtual true final false
...
/// @brief Method get_previewInEditor addr 0x2600044 size 0x8 virtual false final false
 bool get_previewInEditor() ;

/// @brief Method set_previewInEditor addr 0x260004c size 0x18 virtual false final false
 void set_previewInEditor(bool value) ;

/// @brief Method OverrideOverlayTextureInfo addr 0x2600068 size 0xbc virtual false final false
...
/// @brief Method get_layerId addr 0x2600124 size 0x8 virtual false final false
 int32_t get_layerId() ;

/// @brief Method set_layerId addr 0x260012c size 0x8 virtual false final false
 void set_layerId(int32_t value) ;

/// @brief Method get_layout addr 0x2600134 size 0xcc virtual false final false
 GlobalNamespace::GlobalNamespace__OVRPlugin__LayerLayout get_layout() ;

/// @brief Method get_texturesPerStage addr 0x2600200 size 0x1c virtual false final false
 int32_t get_texturesPerStage() ;

/// @brief Method NeedsTexturesForShape addr 0x260021c size 0x60 virtual false final false
static bool NeedsTexturesForShape(GlobalNamespace::GlobalNamespace__OVROverlay__OverlayShape shape) ;

/// @brief Method CreateLayer addr 0x26002f4 size 0x3f8 virtual false final false
...
/// @brief Method CreateLayerTextures addr 0x2600b88 size 0x540 virtual false final false
 bool CreateLayerTextures(bool useMipmaps, GlobalNamespace::GlobalNamespace__OVRPlugin__Sizei size, bool isHdr) ;

/// @brief Method DestroyLayerTextures addr 0x26012f8 size 0x124 virtual false final false
 void DestroyLayerTextures() ;

/// @brief Method DestroyLayer addr 0x260141c size 0x2c0 virtual false final false
 void DestroyLayer() ;

/// @brief Method SetSrcDestRects addr 0x2601d14 size 0x1c virtual false final false
...
/// @brief Method UpdateTextureRectMatrix addr 0x2601d30 size 0x414 virtual false final false
 void UpdateTextureRectMatrix() ;

/// @brief Method SetPerLayerColorScaleAndOffset addr 0x2602144 size 0x14 virtual false final false
 void SetPerLayerColorScaleAndOffset(UnityEngine::Vector4 scale, UnityEngine::Vector4 offset) ;

/// @brief Method LatchLayerTextures addr 0x2602158 size 0x46c virtual false final false
 bool LatchLayerTextures() ;

/// @brief Method GetCurrentLayerDesc addr 0x26025c4 size 0x4f8 virtual false final false
 GlobalNamespace::GlobalNamespace__OVRPlugin__LayerDesc GetCurrentLayerDesc() ;

/// @brief Method GetBlitRect addr 0x2602abc size 0x16c virtual false final false
 UnityEngine::Rect GetBlitRect(int32_t eyeId) ;

/// @brief Method BlitSubImage addr 0x2602c28 size 0x404 virtual false final false
 void BlitSubImage(UnityEngine::Texture src, UnityEngine::RenderTexture dst, UnityEngine::Material mat, UnityEngine::Rect rect) ;

/// @brief Method PopulateLayer addr 0x260302c size 0x648 virtual false final false
...
/// @brief Method SubmitLayer addr 0x2603810 size 0x388 virtual false final false
...
/// @brief Method SetupEditorPreview addr 0x2600064 size 0x4 virtual false final false
 void SetupEditorPreview() ;

/// @brief Method IsPassthroughShape addr 0x260027c size 0x78 virtual false final false
static bool IsPassthroughShape(GlobalNamespace::GlobalNamespace__OVROverlay__OverlayShape shape) ;

/// @brief Method Awake addr 0x2603bc8 size 0x2f0 virtual false final false
 void Awake() ;

/// @brief Method get_OpenVROverlayKey addr 0x2603eb8 size 0x7c virtual false final false
static ::StringW get_OpenVROverlayKey() ;

/// @brief Method OnEnable addr 0x2603f34 size 0x70 virtual false final false
 void OnEnable() ;

/// @brief Method InitOVROverlay addr 0x2603fa4 size 0x194 virtual false final false
 void InitOVROverlay() ;

/// @brief Method OnDisable addr 0x2604138 size 0x124 virtual false final false
 void OnDisable() ;

/// @brief Method OnDestroy addr 0x260425c size 0x18 virtual false final false
 void OnDestroy() ;

/// @brief Method ComputePoseAndScale addr 0x2604274 size 0x388 virtual false final false
...
/// @brief Method ComputeSubmit addr 0x26045fc size 0x298 virtual false final false
...
/// @brief Method OpenVROverlayUpdate addr 0x2604894 size 0x300 virtual false final false
 void OpenVROverlayUpdate(UnityEngine::Vector3 scale, GlobalNamespace::OVRPose pose) ;

/// @brief Method LateUpdate addr 0x2604b94 size 0x524 virtual false final false
 void LateUpdate() ;

// Ctor Parameters []
explicit OVROverlay() ;

/// @brief Method .ctor addr 0x26050b8 size 0x1b4 virtual false final false
 void _ctor() ;
