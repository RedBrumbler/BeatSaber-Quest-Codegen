...
/// @brief Method SetData addr 0x2291478 size 0x40 virtual false final false
 void SetData(UnityEngine::Vector3 start, UnityEngine::Vector3 end, float_t time) ;

/// @brief Method CopyFrom addr 0x22914b8 size 0x40 virtual false final false
 void CopyFrom(GlobalNamespace::TrailElement other) ;

/// @brief Method SetDistance addr 0x22914f8 size 0x8 virtual false final false
 void SetDistance(float_t value) ;

/// @brief Method UpdateLocalDistance addr 0x2291500 size 0xa8 virtual false final false
 void UpdateLocalDistance(GlobalNamespace::TrailElement prev) ;

// Ctor Parameters []
explicit TrailElement() ;

/// @brief Method .ctor addr 0x22915a8 size 0x8 virtual false final false
 void _ctor() ;
