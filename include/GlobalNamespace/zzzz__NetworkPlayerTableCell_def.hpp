...
/// @brief Method get_showSeparator addr 0x2188ae4 size 0x1c virtual false final false
 bool get_showSeparator() ;

/// @brief Method set_showSeparator addr 0x2187edc size 0x2c virtual false final false
 void set_showSeparator(bool value) ;

/// @brief Method SetData addr 0x2187e40 size 0x9c virtual false final false
 void SetData(::StringW userName, bool isOpenParty, bool wantsToPlayNextLevel, bool isMyPartyOwner, bool isMe) ;

/// @brief Method SelectionDidChange addr 0x2188d14 size 0x4 virtual true final false
 void SelectionDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method HighlightDidChange addr 0x2188d18 size 0x4 virtual true final false
 void HighlightDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method RefreshVisuals addr 0x2188b00 size 0x214 virtual false final false
 void RefreshVisuals() ;

/// @brief Method get_activeColor addr 0x2188d1c size 0x5c virtual false final false
 UnityEngine::Color get_activeColor() ;

// Ctor Parameters []
explicit NetworkPlayerTableCell() ;

/// @brief Method .ctor addr 0x2188d78 size 0x1c virtual false final false
 void _ctor() ;
