...
/// @brief Method Awake addr 0x228739c size 0x2c virtual false final false
 void Awake() ;

/// @brief Method SpawnExplosion addr 0x22873c8 size 0xbc virtual false final false
 void SpawnExplosion(UnityEngine::Vector3 pos) ;

// Ctor Parameters []
explicit BombExplosionEffect() ;

/// @brief Method .ctor addr 0x2287484 size 0x14 virtual false final false
 void _ctor() ;
