...
/// @brief Method .ctor addr 0x21dfb6c size 0x80 virtual false final false
 void _ctor(GlobalNamespace::IBeatSaberLogger logger) ;

/// @brief Method SaveInfoFile addr 0x21dfc14 size 0x104 virtual false final false
static void SaveInfoFile(::StringW filePath, GlobalNamespace::PosesRecordingData data) ;

/// @brief Method SaveDataFile addr 0x21dfd18 size 0x368 virtual false final false
static void SaveDataFile(::StringW filePath, GlobalNamespace::PosesRecordingData data) ;

/// @brief Method SaveRecordingIntoDirectory addr 0x21e0080 size 0x2a0 virtual false final false
 void SaveRecordingIntoDirectory(::StringW path, GlobalNamespace::PosesRecordingData data) ;

/// @brief Method LoadInfoFile addr 0x21e0320 size 0x1a4 virtual false final false
 GlobalNamespace::PosesRecordingInfoSaveData LoadInfoFile(::StringW filePath) ;

/// @brief Method LoadDataFile addr 0x21e04c4 size 0x5fc virtual false final false
...
/// @brief Method LoadRecordingFromDirectory addr 0x21e0ac0 size 0x308 virtual false final false
 GlobalNamespace::PosesRecordingData LoadRecordingFromDirectory(::StringW path) ;

/// @brief Method SaveToOldFormat addr 0x21e0dc8 size 0x18 virtual true final true
 void SaveToOldFormat(::StringW path, GlobalNamespace::PosesRecordingData data) ;

/// @brief Method SaveRecording addr 0x21e0ecc size 0x3c virtual true final true
 void SaveRecording(::StringW path, GlobalNamespace::PosesRecordingData data, bool saveToOldFormat) ;

/// @brief Method LoadRecording addr 0x21e0f08 size 0x118 virtual true final true
 GlobalNamespace::PosesRecordingData LoadRecording(::StringW path) ;

/// @brief Method RecordingExists addr 0x21e1020 size 0x340 virtual true final true
 bool RecordingExists(::StringW path) ;

/// @brief Method RecordingCanBeCreated addr 0x21e1360 size 0x4d4 virtual true final true
