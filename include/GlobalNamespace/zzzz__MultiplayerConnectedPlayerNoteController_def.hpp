...
/// @brief Method HiddenStateDidChange addr 0x2119c50 size 0x24 virtual true final false
 void HiddenStateDidChange(bool hide) ;

/// @brief Method Pause addr 0x2119c74 size 0x10 virtual true final false
 void Pause(bool pause) ;

// Ctor Parameters []
explicit MultiplayerConnectedPlayerNoteController() ;

/// @brief Method .ctor addr 0x21199c4 size 0x8 virtual false final false
 void _ctor() ;
