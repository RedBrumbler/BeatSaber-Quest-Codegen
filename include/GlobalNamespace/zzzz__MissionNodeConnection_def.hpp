...
/// @brief Method get_parentMissionNode addr 0x217f9fc size 0x8 virtual false final false
 GlobalNamespace::MissionNodeVisualController get_parentMissionNode() ;

/// @brief Method get_childMissionNode addr 0x217fa04 size 0x8 virtual false final false
 GlobalNamespace::MissionNodeVisualController get_childMissionNode() ;

/// @brief Method get_isActive addr 0x217fa0c size 0x8 virtual false final false
 bool get_isActive() ;

/// @brief Method Setup addr 0x217e554 size 0x8 virtual false final false
...
/// @brief Method UpdateConnectionRectTransform addr 0x217fa14 size 0x278 virtual false final false
 void UpdateConnectionRectTransform() ;

/// @brief Method SetActive addr 0x217f7dc size 0xcc virtual false final false
 void SetActive(bool animated) ;

/// @brief Method MissionConnectionEnabledDidFinish addr 0x217fc8c size 0x20 virtual false final false
 void MissionConnectionEnabledDidFinish() ;

// Ctor Parameters []
explicit MissionNodeConnection() ;

/// @brief Method .ctor addr 0x217fcac size 0x14 virtual false final false
 void _ctor() ;
