...
/// @brief Method add_menuButtonTriggeredEvent addr 0x2105cac size 0x9c virtual true final true
 void add_menuButtonTriggeredEvent(System::Action value) ;

/// @brief Method remove_menuButtonTriggeredEvent addr 0x2105d48 size 0x9c virtual true final true
 void remove_menuButtonTriggeredEvent(System::Action value) ;

/// @brief Method Tick addr 0x2105de4 size 0x110 virtual true final true
 void Tick() ;

// Ctor Parameters []
explicit DelayedMenuButtonTrigger() ;

/// @brief Method .ctor addr 0x2105ef4 size 0x14 virtual false final false
 void _ctor() ;
