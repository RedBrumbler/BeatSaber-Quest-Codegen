...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::PlayerData (GlobalNamespace::PlayerDataModel::*)()>(&GlobalNamespace::PlayerDataModel::get_playerData)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x226123c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::PlayerDataModel::*)()>(&GlobalNamespace::PlayerDataModel::OnEnable)> {
  ...
  constexpr static std::size_t addrs = 0x2261244;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::PlayerDataModel::*)(bool)>(&GlobalNamespace::PlayerDataModel::OnApplicationPause)> {
  ...
  constexpr static std::size_t addrs = 0x2261270;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::PlayerDataModel::*)()>(&GlobalNamespace::PlayerDataModel::OnDisable)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x226129c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::PlayerDataModel::*)()>(&GlobalNamespace::PlayerDataModel::ResetData)> {
  ...
  constexpr static std::size_t addrs = 0x22612a0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::PlayerDataModel::*)()>(&GlobalNamespace::PlayerDataModel::Save)> {
  ...
  constexpr static std::size_t addrs = 0x226127c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::PlayerDataModel::*)()>(&GlobalNamespace::PlayerDataModel::Load)> {
  ...
  constexpr static std::size_t addrs = 0x2261248;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::PlayerDataModel::*)()>(&GlobalNamespace::PlayerDataModel::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x22612c4;
...
constexpr void GlobalNamespace::PlayerDataModel::__set__playerDataFileManager(GlobalNamespace::PlayerDataFileManagerSO value)  {
::cordl_internals::setInstanceField<GlobalNamespace::PlayerDataFileManagerSO, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::PlayerDataFileManagerSO>(value));
}
constexpr GlobalNamespace::PlayerDataFileManagerSO GlobalNamespace::PlayerDataModel::__get__playerDataFileManager() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::PlayerDataFileManagerSO, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::PlayerDataModel::__set__playerData(GlobalNamespace::PlayerData value)  {
::cordl_internals::setInstanceField<GlobalNamespace::PlayerData, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::PlayerData>(value));
}
constexpr GlobalNamespace::PlayerData GlobalNamespace::PlayerDataModel::__get__playerData() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::PlayerData, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::PlayerDataModel::__set__saveData(GlobalNamespace::ISaveData value)  {
...
constexpr GlobalNamespace::ISaveData GlobalNamespace::PlayerDataModel::__get__saveData() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::ISaveData, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::PlayerDataModel::__set__beatmapCharacteristicCollection(GlobalNamespace::BeatmapCharacteristicCollection value)  {
::cordl_internals::setInstanceField<GlobalNamespace::BeatmapCharacteristicCollection, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::BeatmapCharacteristicCollection>(value));
}
constexpr GlobalNamespace::BeatmapCharacteristicCollection GlobalNamespace::PlayerDataModel::__get__beatmapCharacteristicCollection() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::BeatmapCharacteristicCollection, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::PlayerDataFileManagerSO, false>(const_cast<void*>(instance), ___internal_method);
}
...
// Ctor Parameters []
 GlobalNamespace::PlayerDataModel::PlayerDataModel()  : UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<PlayerDataModel>())) {}
 void GlobalNamespace::PlayerDataModel::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::PlayerDataModel>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
