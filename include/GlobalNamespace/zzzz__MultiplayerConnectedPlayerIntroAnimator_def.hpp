...
/// @brief Method SetBeforeIntroValues addr 0x211873c size 0x1c virtual false final false
 void SetBeforeIntroValues() ;

// Ctor Parameters []
explicit MultiplayerConnectedPlayerIntroAnimator() ;

/// @brief Method .ctor addr 0x2118758 size 0x8 virtual false final false
 void _ctor() ;
