...
/// @brief Method Start addr 0x20f6fd0 size 0x88 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x20f7108 size 0xd0 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleMultiplayerAvatarPoseControllerDidUpdatePose addr 0x20f7288 size 0x54 virtual false final false
 void HandleMultiplayerAvatarPoseControllerDidUpdatePose(UnityEngine::Vector3 headLocalPosition) ;

// Ctor Parameters []
explicit AvatarHeadOffset() ;

/// @brief Method .ctor addr 0x20f72dc size 0x18 virtual false final false
 void _ctor() ;
