...
/// @brief Method Save addr 0x214dbe8 size 0x3a8 virtual false final false
static void Save(::StringW filepath, UnityEngine::AudioClip clip, float_t start, float_t duration) ;

/// @brief Method GetWav addr 0x214df90 size 0x40 virtual false final false
static ::ArrayW<uint8_t> GetWav(UnityEngine::AudioClip clip, ByRef<uint32_t> length, float_t start, float_t duration) ;

/// @brief Method ConvertAndWrite addr 0x214dfd0 size 0x268 virtual false final false
...
/// @brief Method AddDataToBuffer addr 0x214e4e8 size 0x70 virtual false final false
static void AddDataToBuffer(::ArrayW<uint8_t> buffer, ByRef<uint32_t> offset, ::ArrayW<uint8_t> addBytes) ;

/// @brief Method WriteHeader addr 0x214e238 size 0x2b0 virtual false final false
