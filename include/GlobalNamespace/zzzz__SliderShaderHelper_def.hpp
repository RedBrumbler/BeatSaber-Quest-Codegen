...
/// @brief Method SetTimeSinceHeadNoteJump addr 0x2285f04 size 0x7c virtual false final false
static void SetTimeSinceHeadNoteJump(UnityEngine::MaterialPropertyBlock materialPropertyBlock, float_t time) ;

/// @brief Method SetTailHeadNoteJumpOffsetDifference addr 0x2285f80 size 0x7c virtual false final false
...
/// @brief Method SetSaberAttractionPoint addr 0x2285ffc size 0x98 virtual false final false
...
/// @brief Method EnableSaberAttraction addr 0x2277a6c size 0x88 virtual false final false
static void EnableSaberAttraction(UnityEngine::MaterialPropertyBlock materialPropertyBlock, bool enableSaberAttraction) ;

/// @brief Method SetColor addr 0x2286094 size 0x9c virtual false final false
static void SetColor(UnityEngine::MaterialPropertyBlock materialPropertyBlock, UnityEngine::Color color) ;

/// @brief Method SetInitialProperties addr 0x2286130 size 0x260 virtual false final false
...
/// @brief Method SetInitialProperties addr 0x2277914 size 0x158 virtual false final false
...
/// @brief Method UpdateMaterialPropertyBlock addr 0x2277af4 size 0x160 virtual false final false
