...
/// @brief Method .ctor addr 0x2296790 size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x2296030 size 0x348 virtual false final false
...
/// @brief Method Cleanup addr 0x2296378 size 0x11c virtual false final false
 void Cleanup() ;

/// @brief Method HandleColorBoostBeatmapEvent addr 0x2296494 size 0x1c virtual false final false
 void HandleColorBoostBeatmapEvent(GlobalNamespace::ColorBoostBeatmapEventData colorBoost) ;

/// @brief Method HandleColorChangeBeatmapEvent addr 0x22964b0 size 0xdc virtual false final false
 void HandleColorChangeBeatmapEvent(GlobalNamespace::LightColorBeatmapEventData currentEvent) ;

/// @brief Method HandleBeatmapCallbacksControllerDidProcessAllCallbacksThisFrame addr 0x229658c size 0x108 virtual false final false
 void HandleBeatmapCallbacksControllerDidProcessAllCallbacksThisFrame() ;

/// @brief Method GetColor addr 0x2296694 size 0x34 virtual true final false
