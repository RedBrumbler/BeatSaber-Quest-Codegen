...
/// @brief Method get_isFinished addr 0x22679b4 size 0x50 virtual false final false
 bool get_isFinished() ;

/// @brief Method get_rotation addr 0x2267a04 size 0x8 virtual false final false
 float_t get_rotation() ;

/// @brief Method Init addr 0x2267a0c size 0xcc virtual false final false
 void Init(UnityEngine::Vector3 position, float_t rotation) ;

/// @brief Method ColorWasSet addr 0x2267ad8 size 0xc virtual true final false
 void ColorWasSet(UnityEngine::Color color) ;

/// @brief Method AddHighlight addr 0x2267ae4 size 0xdc virtual false final false
 void AddHighlight(float_t startTime, float_t arriveDuration, float_t jumpDuration) ;

/// @brief Method ManualUpdate addr 0x2267bc0 size 0x14c virtual false final false
 void ManualUpdate(float_t songTime) ;

// Ctor Parameters []
explicit BeatLine() ;

/// @brief Method .ctor addr 0x2267d0c size 0xcc virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4819)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 2709 }), TypeDefinitionIndex(TypeDefinitionIndex(11011))}
...
/// @brief Method .ctor addr 0x2267dd8 size 0x48 virtual false final false
 void _ctor() ;
