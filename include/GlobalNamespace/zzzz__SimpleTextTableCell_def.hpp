...
/// @brief Method set_text addr 0x1fddd50 size 0x24 virtual false final false
 void set_text(::StringW value) ;

/// @brief Method get_text addr 0x1fddd74 size 0x24 virtual false final false
 ::StringW get_text() ;

// Ctor Parameters []
explicit SimpleTextTableCell() ;

/// @brief Method .ctor addr 0x1fddd98 size 0x8 virtual false final false
 void _ctor() ;
