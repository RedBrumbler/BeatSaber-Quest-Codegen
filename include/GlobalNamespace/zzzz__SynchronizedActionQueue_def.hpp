...
/// @brief Method .ctor addr 0xddc228 size 0xc virtual false final false
...
/// @brief Method Clear addr 0xddc0fc size 0x70 virtual false final false
 void Clear() ;

/// @brief Method EnqueueAction addr 0xddc16c size 0xbc virtual false final false
 void EnqueueAction(float_t time, System::Action action) ;

/// @brief Method Update addr 0xddc234 size 0x114 virtual false final false
 void Update(float_t time) ;

// Ctor Parameters []
explicit SynchronizedActionQueue() ;

/// @brief Method .ctor addr 0xddc348 size 0x7c virtual false final false
 void _ctor() ;
