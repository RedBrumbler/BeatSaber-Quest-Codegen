...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13900)), TypeDefinitionIndex(TypeDefinitionIndex(11127)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13900), inst: 288 })}
...
/// @brief Method .ctor addr 0x1fbe820 size 0x48 virtual false final false
 void _ctor() ;
