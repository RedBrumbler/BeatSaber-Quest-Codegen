...
/// @brief Method get_bladeSpeed addr 0x21f67c8 size 0x8 virtual true final true
 float_t get_bladeSpeed() ;

/// @brief Method get_lastAddedData addr 0x21f67d0 size 0x5c virtual true final true
 GlobalNamespace::BladeMovementDataElement get_lastAddedData() ;

/// @brief Method get_prevAddedData addr 0x21f682c size 0x5c virtual true final true
 GlobalNamespace::BladeMovementDataElement get_prevAddedData() ;

// Ctor Parameters []
explicit SaberMovementData() ;

/// @brief Method .ctor addr 0x21f6888 size 0xa8 virtual false final false
 void _ctor() ;

/// @brief Method AddDataProcessor addr 0x21f6930 size 0x58 virtual true final true
 void AddDataProcessor(GlobalNamespace::ISaberMovementDataProcessor dataProcessor) ;

/// @brief Method RemoveDataProcessor addr 0x21f6988 size 0x58 virtual true final true
 void RemoveDataProcessor(GlobalNamespace::ISaberMovementDataProcessor dataProcessor) ;

/// @brief Method RequestLastDataProcessing addr 0x21f69e0 size 0x188 virtual true final true
 void RequestLastDataProcessing(GlobalNamespace::ISaberMovementDataProcessor dataProcessor) ;

/// @brief Method AddNewData addr 0x21f6b68 size 0x4d0 virtual false final false
 void AddNewData(UnityEngine::Vector3 topPos, UnityEngine::Vector3 bottomPos, float_t time) ;

/// @brief Method ComputeAdditionalData addr 0x21f7038 size 0x230 virtual false final false
...
/// @brief Method ComputePlaneNormal addr 0x21f7268 size 0x13c virtual false final false
...
/// @brief Method ComputeCutPlaneNormal addr 0x21f73a4 size 0xa0 virtual false final false
 UnityEngine::Vector3 ComputeCutPlaneNormal() ;

/// @brief Method ComputeSwingRating addr 0x21f7444 size 0x8 virtual true final true
 float_t ComputeSwingRating(float_t overrideSegmentAngle) ;

/// @brief Method ComputeSwingRating addr 0x21f7710 size 0xc virtual true final true
 float_t ComputeSwingRating() ;

/// @brief Method ComputeSwingRating addr 0x21f744c size 0x2c4 virtual false final false
