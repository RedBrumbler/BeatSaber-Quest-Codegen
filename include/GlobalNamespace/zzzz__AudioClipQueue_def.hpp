...
/// @brief Method Awake addr 0x20efdcc size 0x20 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x20efdec size 0x140 virtual false final false
 void Update() ;

/// @brief Method PlayAudioClipWithDelay addr 0x20eff2c size 0xcc virtual false final false
 void PlayAudioClipWithDelay(UnityEngine::AudioClip audioClip, float_t delay) ;

// Ctor Parameters []
explicit AudioClipQueue() ;

/// @brief Method .ctor addr 0x20efff8 size 0x7c virtual false final false
 void _ctor() ;
