...
/// @brief Method get_length addr 0x21e8314 size 0x8 virtual false final false
 float_t get_length() ;
...
/// @brief Method .ctor addr 0x21e7da4 size 0xe4 virtual false final false
 void _ctor(int32_t numberOfPathSegments) ;

/// @brief Method UpdateByBezierPath addr 0x21e7e88 size 0x46c virtual false final false
 void UpdateByBezierPath(GlobalNamespace::BezierPath bezierPath) ;

/// @brief Method TimeAtPoint addr 0x21e8880 size 0x38 virtual false final false
 float_t TimeAtPoint(int32_t pointIndex) ;

/// @brief Method GetVertex addr 0x21e88b8 size 0x60 virtual false final false
...
/// @brief Method GetPoint addr 0x21e8918 size 0x38 virtual false final false
 UnityEngine::Vector3 GetPoint(int32_t index) ;

/// @brief Method SplitBezierPathIntoFixNumberOfSegments addr 0x21e831c size 0x564 virtual false final false
 void SplitBezierPathIntoFixNumberOfSegments(GlobalNamespace::BezierPath bezierPath, int32_t numberOfVertexSegments) ;

/// @brief Method AddVertex addr 0x21e8950 size 0x40c virtual false final false
