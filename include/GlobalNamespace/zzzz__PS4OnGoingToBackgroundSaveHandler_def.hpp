...
/// @brief Method Subscribe addr 0x2253de4 size 0x88 virtual true final false
 void Subscribe() ;

/// @brief Method Unsubscribe addr 0x2253e6c size 0x94 virtual true final false
 void Unsubscribe() ;

// Ctor Parameters []
explicit PS4OnGoingToBackgroundSaveHandler() ;

/// @brief Method .ctor addr 0x2253f00 size 0x8 virtual false final false
 void _ctor() ;
