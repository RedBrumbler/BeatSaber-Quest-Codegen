...
/// @brief Method get_reflectionProbeData addr 0x21d3d40 size 0x8 virtual false final false
 GlobalNamespace::ReflectionProbeDataSO get_reflectionProbeData() ;

/// @brief Method set_reflectionProbeData addr 0x21d3d48 size 0x8 virtual false final false
 void set_reflectionProbeData(GlobalNamespace::ReflectionProbeDataSO value) ;

/// @brief Method get_position addr 0x21d3d50 size 0x20 virtual false final false
 UnityEngine::Vector3 get_position() ;

/// @brief Method get_resolutionBeforeDownsample addr 0x21d3d70 size 0x8 virtual false final false
 int32_t get_resolutionBeforeDownsample() ;

/// @brief Method get_downsampleByHalfCount addr 0x21d3d78 size 0x8 virtual false final false
 int32_t get_downsampleByHalfCount() ;

/// @brief Method Start addr 0x21d3d80 size 0xb8 virtual false final false
 void Start() ;

/// @brief Method SendDataToShaders addr 0x21d3e38 size 0x22c virtual false final false
 void SendDataToShaders() ;

// Ctor Parameters []
explicit BakedReflectionProbe() ;

/// @brief Method .ctor addr 0x21d4064 size 0x14 virtual false final false
 void _ctor() ;
