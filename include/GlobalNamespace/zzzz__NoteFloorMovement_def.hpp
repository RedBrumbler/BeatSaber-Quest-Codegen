...
/// @brief Method add_floorMovementDidFinishEvent addr 0x227a334 size 0x9c virtual false final false
 void add_floorMovementDidFinishEvent(System::Action value) ;

/// @brief Method remove_floorMovementDidFinishEvent addr 0x227a3d0 size 0x9c virtual false final false
 void remove_floorMovementDidFinishEvent(System::Action value) ;

/// @brief Method get_distanceToPlayer addr 0x227a46c size 0x40 virtual false final false
 float_t get_distanceToPlayer() ;

/// @brief Method get_startPos addr 0x227a4ac size 0xc virtual false final false
 UnityEngine::Vector3 get_startPos() ;

/// @brief Method get_endPos addr 0x227a4b8 size 0xc virtual false final false
 UnityEngine::Vector3 get_endPos() ;

/// @brief Method get_startTime addr 0x227a4c4 size 0x8 virtual false final false
 float_t get_startTime() ;

/// @brief Method get_moveDuration addr 0x227a4cc size 0x8 virtual false final false
 float_t get_moveDuration() ;

/// @brief Method get_worldRotation addr 0x227a4d4 size 0xc virtual false final false
 UnityEngine::Quaternion get_worldRotation() ;

/// @brief Method get_inverseWorldRotation addr 0x227a4e0 size 0xc virtual false final false
 UnityEngine::Quaternion get_inverseWorldRotation() ;

/// @brief Method get_localPosition addr 0x227a4ec size 0xc virtual false final false
 UnityEngine::Vector3 get_localPosition() ;

/// @brief Method Init addr 0x227a4f8 size 0xb8 virtual false final false
...
/// @brief Method SetToStart addr 0x227a5b0 size 0xf4 virtual false final false
 UnityEngine::Vector3 SetToStart() ;

/// @brief Method ManualUpdate addr 0x227a6a4 size 0x180 virtual false final false
 UnityEngine::Vector3 ManualUpdate() ;

// Ctor Parameters []
explicit NoteFloorMovement() ;

/// @brief Method .ctor addr 0x227a824 size 0x8 virtual false final false
 void _ctor() ;
