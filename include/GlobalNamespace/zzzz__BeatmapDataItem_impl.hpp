...
constexpr void GlobalNamespace::GlobalNamespace__BeatmapDataItem__BeatmapDataItemType::__set_value__(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__BeatmapDataItem__BeatmapDataItemType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr GlobalNamespace::GlobalNamespace__BeatmapDataItem__BeatmapDataItemType  GlobalNamespace::GlobalNamespace__BeatmapDataItem__BeatmapDataItemType::BeatmapObject{0};
constexpr GlobalNamespace::GlobalNamespace__BeatmapDataItem__BeatmapDataItemType  GlobalNamespace::GlobalNamespace__BeatmapDataItem__BeatmapDataItemType::BeatmapEvent{1};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (GlobalNamespace::BeatmapDataItem::*)()>(&GlobalNamespace::BeatmapDataItem::get_time)> {
  ...
  constexpr static std::size_t addrs = 0xd9fc4c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (GlobalNamespace::BeatmapDataItem::*)()>(&GlobalNamespace::BeatmapDataItem::get_executionOrder)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0xd9fc54;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (GlobalNamespace::BeatmapDataItem::*)()>(&GlobalNamespace::BeatmapDataItem::get_subtypeGroupIdentifier)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0xd9fc5c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::BeatmapDataItem::*)(float_t, int32_t, int32_t, GlobalNamespace::GlobalNamespace__BeatmapDataItem__BeatmapDataItemType)>(&GlobalNamespace::BeatmapDataItem::_ctor)> {
  constexpr static std::size_t size = 0x4c;
  constexpr static std::size_t addrs = 0xd9fc64;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::GlobalNamespace__BeatmapDataItem__BeatmapDataItemType>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (GlobalNamespace::BeatmapDataItem::*)(GlobalNamespace::BeatmapDataItem)>(&GlobalNamespace::BeatmapDataItem::CompareTo)> {
  constexpr static std::size_t size = 0x4c;
  constexpr static std::size_t addrs = 0xd9fcb0;
...
constexpr void GlobalNamespace::BeatmapDataItem::__set_type(GlobalNamespace::GlobalNamespace__BeatmapDataItem__BeatmapDataItemType value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__BeatmapDataItem__BeatmapDataItemType, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__BeatmapDataItem__BeatmapDataItemType>(value));
}
constexpr GlobalNamespace::GlobalNamespace__BeatmapDataItem__BeatmapDataItemType GlobalNamespace::BeatmapDataItem::__get_type() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__BeatmapDataItem__BeatmapDataItemType, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance);
}
