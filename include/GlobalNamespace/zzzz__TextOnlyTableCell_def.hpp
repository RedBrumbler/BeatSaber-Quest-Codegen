...
/// @brief Method get_text addr 0x215f4b8 size 0x24 virtual false final false
 ::StringW get_text() ;

/// @brief Method set_text addr 0x215f4dc size 0x24 virtual false final false
 void set_text(::StringW value) ;

/// @brief Method SelectionDidChange addr 0x215f500 size 0x4 virtual true final false
 void SelectionDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method HighlightDidChange addr 0x215f5d0 size 0x4 virtual true final false
 void HighlightDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method RefreshVisuals addr 0x215f504 size 0xcc virtual false final false
 void RefreshVisuals() ;

// Ctor Parameters []
explicit TextOnlyTableCell() ;

/// @brief Method .ctor addr 0x215f5d4 size 0x14 virtual false final false
 void _ctor() ;
