...
/// @brief Method Start addr 0x210cfd4 size 0xf0 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x210d0c4 size 0x108 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleLevelFinished addr 0x210d1cc size 0x4 virtual false final false
 void HandleLevelFinished() ;

/// @brief Method StartLevelFinished addr 0x210d1d0 size 0x40 virtual false final false
 void StartLevelFinished() ;

// Ctor Parameters []
explicit StandardLevelFinishedController() ;

/// @brief Method .ctor addr 0x210d210 size 0x8 virtual false final false
 void _ctor() ;
