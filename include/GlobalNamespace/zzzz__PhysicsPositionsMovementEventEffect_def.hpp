...
/// @brief Method Start addr 0x22a09a0 size 0x248 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x22a0be8 size 0x154 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleSongTimeFixedUpdate addr 0x22a0d3c size 0xdc virtual false final false
 void HandleSongTimeFixedUpdate(float_t fixedDeltaTime) ;

/// @brief Method HandleSongTimeUpdate addr 0x22a0e18 size 0x70 virtual false final false
 void HandleSongTimeUpdate() ;

/// @brief Method HandleBeatmapEvent addr 0x22a0e88 size 0x7c virtual false final false
 void HandleBeatmapEvent(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

// Ctor Parameters []
explicit PhysicsPositionsMovementEventEffect() ;

/// @brief Method .ctor addr 0x22a0f04 size 0x7c virtual false final false
 void _ctor() ;
