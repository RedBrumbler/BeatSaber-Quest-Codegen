...
/// @brief Method set_alpha addr 0x2149e44 size 0x1c virtual false final false
 void set_alpha(float_t value) ;

/// @brief Method get_fullyActivated addr 0x2149c00 size 0x24 virtual false final false
 bool get_fullyActivated() ;

/// @brief Method get_saberType addr 0x2149ff0 size 0x8 virtual false final false
 GlobalNamespace::SaberType get_saberType() ;

/// @brief Method set_saberType addr 0x2149ff8 size 0x8 virtual false final false
 void set_saberType(GlobalNamespace::SaberType value) ;

/// @brief Method Start addr 0x214a000 size 0x8c virtual false final false
 void Start() ;

/// @brief Method OnEnable addr 0x214a08c size 0x50 virtual false final false
 void OnEnable() ;

/// @brief Method Update addr 0x214a0dc size 0x11c virtual false final false
 void Update() ;

/// @brief Method SetProgressImagesfillAmount addr 0x214a1f8 size 0x70 virtual false final false
 void SetProgressImagesfillAmount(float_t fillAmount) ;

/// @brief Method OnTriggerEnter addr 0x214a268 size 0x108 virtual false final false
 void OnTriggerEnter(UnityEngine::Collider other) ;

/// @brief Method OnTriggerExit addr 0x214a370 size 0x108 virtual false final false
 void OnTriggerExit(UnityEngine::Collider other) ;

/// @brief Method OnTriggerStay addr 0x214a478 size 0x108 virtual false final false
 void OnTriggerStay(UnityEngine::Collider other) ;

// Ctor Parameters []
explicit IntroTutorialRing() ;

/// @brief Method .ctor addr 0x214a580 size 0x88 virtual false final false
 void _ctor() ;
