...
/// @brief Method GetConfigured addr 0x25d569c size 0x98 virtual false final false
 bool GetConfigured() ;

/// @brief Method TestNode addr 0x25d94a4 size 0xc4 virtual false final false
...
/// @brief Method TestPoint addr 0x25d9570 size 0xe8 virtual false final false
...
/// @brief Method GetGeometry addr 0x25d5734 size 0x43c virtual false final false
 ::ArrayW<UnityEngine::Vector3> GetGeometry(GlobalNamespace::GlobalNamespace__OVRBoundary__BoundaryType boundaryType) ;

/// @brief Method GetDimensions addr 0x25d9700 size 0xd0 virtual false final false
 UnityEngine::Vector3 GetDimensions(GlobalNamespace::GlobalNamespace__OVRBoundary__BoundaryType boundaryType) ;

/// @brief Method GetVisible addr 0x25d97d4 size 0x98 virtual false final false
 bool GetVisible() ;

/// @brief Method SetVisible addr 0x25d986c size 0x9c virtual false final false
 void SetVisible(bool value) ;

// Ctor Parameters []
explicit OVRBoundary() ;

/// @brief Method .ctor addr 0x25d9908 size 0x7c virtual false final false
 void _ctor() ;
