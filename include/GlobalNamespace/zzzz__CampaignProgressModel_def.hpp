...
/// @brief Method get_numberOfClearedMissions addr 0x222a104 size 0x28 virtual false final false
 int32_t get_numberOfClearedMissions() ;

/// @brief Method Awake addr 0x222a2c4 size 0x74 virtual false final false
 void Awake() ;

/// @brief Method IsMissionRegistered addr 0x222a338 size 0x58 virtual false final false
 bool IsMissionRegistered(::StringW missionId) ;

/// @brief Method RegisterMissionId addr 0x222a390 size 0x64 virtual false final false
 void RegisterMissionId(::StringW missionId) ;

/// @brief Method IsMissionCleared addr 0x222a3f4 size 0x30 virtual false final false
 bool IsMissionCleared(::StringW missionId) ;

/// @brief Method IsMissionFinal addr 0x222a424 size 0xc virtual false final false
 bool IsMissionFinal(::StringW missionId) ;

/// @brief Method SetFinalMissionId addr 0x222a430 size 0x8 virtual false final false
 void SetFinalMissionId(::StringW missionId) ;

/// @brief Method WillFinishGameAfterThisMission addr 0x222a438 size 0x48 virtual false final false
 bool WillFinishGameAfterThisMission(::StringW missionId) ;

/// @brief Method SetMissionCleared addr 0x222a480 size 0x8 virtual false final false
 void SetMissionCleared(::StringW missionId) ;

/// @brief Method __SetMissionCleared addr 0x222a488 size 0x4c virtual false final false
 void __SetMissionCleared(::StringW missionId, bool cleared) ;

/// @brief Method UpdateNumberOfClearedMissions addr 0x222a12c size 0x198 virtual false final false
 int32_t UpdateNumberOfClearedMissions() ;

// Ctor Parameters []
explicit CampaignProgressModel() ;

/// @brief Method .ctor addr 0x222a4d4 size 0x10 virtual false final false
 void _ctor() ;
