...
/// @brief Method CreateTransformedData addr 0x21ef900 size 0x320 virtual false final false
static GlobalNamespace::IReadonlyBeatmapData CreateTransformedData(GlobalNamespace::IReadonlyBeatmapData beatmapData) ;

/// @brief Method FindNextSameColorTypeNote addr 0x21effec size 0x1ec virtual false final false
...
/// @brief Method .ctor addr 0x21f01d8 size 0x8 virtual false final false
 void _ctor() ;
