...
/// @brief Method add_selectSuggestedBeatmapEvent addr 0x21b0a44 size 0xb0 virtual false final false
 void add_selectSuggestedBeatmapEvent(System::Action_1<GlobalNamespace::PreviewDifficultyBeatmap> value) ;

/// @brief Method remove_selectSuggestedBeatmapEvent addr 0x21b0af4 size 0xb0 virtual false final false
 void remove_selectSuggestedBeatmapEvent(System::Action_1<GlobalNamespace::PreviewDifficultyBeatmap> value) ;

/// @brief Method add_selectSuggestedGameplayModifiersEvent addr 0x21b0ba4 size 0xb0 virtual false final false
 void add_selectSuggestedGameplayModifiersEvent(System::Action_1<GlobalNamespace::GameplayModifiers> value) ;

/// @brief Method remove_selectSuggestedGameplayModifiersEvent addr 0x21b0c54 size 0xb0 virtual false final false
 void remove_selectSuggestedGameplayModifiersEvent(System::Action_1<GlobalNamespace::GameplayModifiers> value) ;

/// @brief Method add_kickPlayerEvent addr 0x21b0d04 size 0xb0 virtual false final false
 void add_kickPlayerEvent(System::Action_1<::StringW> value) ;

/// @brief Method remove_kickPlayerEvent addr 0x21b0db4 size 0xb0 virtual false final false
 void remove_kickPlayerEvent(System::Action_1<::StringW> value) ;

/// @brief Method add_didOpenInvitePanelEvent addr 0x21b0e64 size 0x9c virtual false final false
 void add_didOpenInvitePanelEvent(System::Action value) ;

/// @brief Method remove_didOpenInvitePanelEvent addr 0x21b0f00 size 0x9c virtual false final false
 void remove_didOpenInvitePanelEvent(System::Action value) ;

/// @brief Method DidActivate addr 0x21b0f9c size 0x384 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x21b1a28 size 0x32c virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method HandleLobbyPlayersDataDidChange addr 0x21b1f64 size 0x4 virtual false final false
 void HandleLobbyPlayersDataDidChange(::StringW userId) ;

/// @brief Method HandleLobbyGameStateControllerLobbyStateChanged addr 0x21b1f68 size 0x4 virtual false final false
 void HandleLobbyGameStateControllerLobbyStateChanged(GlobalNamespace::MultiplayerLobbyState _) ;

/// @brief Method HandleLobbyPlayerPermissionChanged addr 0x21b1f6c size 0x4 virtual false final false
 void HandleLobbyPlayerPermissionChanged() ;

/// @brief Method SetDataToTable addr 0x21b1828 size 0x200 virtual false final false
 void SetDataToTable() ;

/// @brief Method HandleSelectSuggestedLevel addr 0x21b202c size 0x1c virtual false final false
 void HandleSelectSuggestedLevel(GlobalNamespace::PreviewDifficultyBeatmap beatmapLevel) ;

/// @brief Method HandleSelectSuggestedGameplayModifiers addr 0x21b2048 size 0x1c virtual false final false
 void HandleSelectSuggestedGameplayModifiers(GlobalNamespace::GameplayModifiers gameplayModifiers) ;

/// @brief Method HandleKickPlayer addr 0x21b2064 size 0x1c virtual false final false
 void HandleKickPlayer(::StringW userId) ;

/// @brief Method HandleOpenPlatformInvitePanel addr 0x21b2080 size 0xc8 virtual false final false
 void HandleOpenPlatformInvitePanel() ;

/// @brief Method TrySetInviteButtonEnabled addr 0x21b1530 size 0x2f8 virtual false final false
 void TrySetInviteButtonEnabled() ;

// Ctor Parameters []
explicit ServerPlayerListViewController() ;

/// @brief Method .ctor addr 0x21b2148 size 0x68 virtual false final false
 void _ctor() ;
