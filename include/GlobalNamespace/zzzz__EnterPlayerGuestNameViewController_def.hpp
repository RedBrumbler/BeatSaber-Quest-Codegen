...
/// @brief Method .ctor addr 0x219115c size 0x130 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x219128c size 0x14 virtual true final false
 void Invoke(GlobalNamespace::EnterPlayerGuestNameViewController viewController, ::StringW playerName) ;

/// @brief Method BeginInvoke addr 0x21912a0 size 0x28 virtual true final false
...
/// @brief Method EndInvoke addr 0x21912c8 size 0xc virtual true final false
...
/// @brief Method .ctor addr 0x2190fbc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__0 addr 0x21912d4 size 0x10c virtual false final false
...
/// @brief Method .ctor addr 0x21913e0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__1 addr 0x21913e8 size 0x34 virtual false final false
...
/// @brief Method Init addr 0x2190d80 size 0x8 virtual false final false
 void Init(GlobalNamespace::GlobalNamespace__EnterPlayerGuestNameViewController__FinishDelegate didFinishCallback) ;

/// @brief Method DidActivate addr 0x2190d88 size 0x234 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x2190fc4 size 0xb0 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method OkButtonPressed addr 0x2191074 size 0xe0 virtual false final false
 void OkButtonPressed() ;

// Ctor Parameters []
explicit EnterPlayerGuestNameViewController() ;

/// @brief Method .ctor addr 0x2191154 size 0x8 virtual false final false
 void _ctor() ;
