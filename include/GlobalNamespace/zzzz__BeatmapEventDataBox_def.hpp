...
/// @brief Method get_indexFilter addr 0x2212254 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x221225c size 0x94 virtual false final false
...
/// @brief Method GetBeatStep addr 0x22122f0 size 0x64 virtual false final false
 float_t GetBeatStep(float_t lastBaseEventRelativeBeat) ;

/// @brief Method GetDistribution addr 0x2212374 size 0x2c virtual false final false
 float_t GetDistribution(bool isFirstBaseDataEvent, int32_t distributionOrderIndex) ;

/// @brief Method BeatDistributionParamToStep addr 0x2212354 size 0x20 virtual false final false
...
/// @brief Method EventDistributionParamToStep addr 0x22123a0 size 0x6c virtual false final false
