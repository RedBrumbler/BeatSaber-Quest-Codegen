...
/// @brief Method .ctor addr 0x1228874 size 0x8 virtual false final false
 void _ctor(UnityEngine::Color32 color) ;

/// @brief Method Serialize addr 0x1223274 size 0x60 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0x12234b8 size 0x64 virtual true final true
 void Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method op_Implicit addr 0x122887c size 0x8 virtual false final false
static UnityEngine::Color32 op_Implicit_UnityEngine__Color32(GlobalNamespace::Color32Serializable c) ;

/// @brief Method op_Implicit addr 0x122326c size 0x8 virtual false final false
static GlobalNamespace::Color32Serializable op_Implicit_GlobalNamespace__Color32Serializable(UnityEngine::Color32 c) ;

/// @brief Method Equals addr 0x1228884 size 0x48 virtual true final true
 bool Equals(GlobalNamespace::Color32Serializable other) ;

/// @brief Method Equals addr 0x12288cc size 0xa8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x1228974 size 0x68 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x12289dc size 0x8 virtual true final false
 ::StringW ToString() ;
