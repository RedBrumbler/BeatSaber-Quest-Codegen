...
/// @brief Method get_FaceExpressions addr 0x2651250 size 0x8 virtual false final false
 GlobalNamespace::OVRFaceExpressions get_FaceExpressions() ;

/// @brief Method set_FaceExpressions addr 0x2651258 size 0x8 virtual false final false
 void set_FaceExpressions(GlobalNamespace::OVRFaceExpressions value) ;

/// @brief Method get_BlendShapeStrengthMultiplier addr 0x2651260 size 0x8 virtual false final false
 float_t get_BlendShapeStrengthMultiplier() ;

/// @brief Method set_BlendShapeStrengthMultiplier addr 0x2651268 size 0x8 virtual false final false
 void set_BlendShapeStrengthMultiplier(float_t value) ;

/// @brief Method Start addr 0x264fa80 size 0x50 virtual true final false
 void Start() ;

/// @brief Method Update addr 0x2651270 size 0xd8 virtual true final false
 void Update() ;

/// @brief Method GetFaceExpression addr 0x2651348 size 0x8 virtual true final false
 GlobalNamespace::GlobalNamespace__OVRFaceExpressions__FaceExpression GetFaceExpression(int32_t blendShapeIndex) ;

// Ctor Parameters []
explicit OVRFace() ;

/// @brief Method .ctor addr 0x264fb10 size 0x10 virtual false final false
 void _ctor() ;
