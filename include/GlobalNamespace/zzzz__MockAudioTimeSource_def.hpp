...
/// @brief Method get_songTime addr 0x20f3390 size 0x8 virtual true final true
 float_t get_songTime() ;

/// @brief Method set_songTime addr 0x20f3398 size 0x8 virtual false final false
 void set_songTime(float_t value) ;

/// @brief Method get_lastFrameDeltaSongTime addr 0x20f33a0 size 0x8 virtual true final true
 float_t get_lastFrameDeltaSongTime() ;

/// @brief Method set_lastFrameDeltaSongTime addr 0x20f33a8 size 0x8 virtual false final false
 void set_lastFrameDeltaSongTime(float_t value) ;

/// @brief Method get_songEndTime addr 0x20f33b0 size 0xc virtual true final true
 float_t get_songEndTime() ;

/// @brief Method get_songLength addr 0x20f33bc size 0xc virtual true final true
 float_t get_songLength() ;

/// @brief Method get_isReady addr 0x20f33c8 size 0x8 virtual true final true
 bool get_isReady() ;

/// @brief Method Update addr 0x20f33d0 size 0x38 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit MockAudioTimeSource() ;

/// @brief Method .ctor addr 0x20f3408 size 0x8 virtual false final false
 void _ctor() ;
