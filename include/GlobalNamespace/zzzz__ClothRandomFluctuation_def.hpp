...
/// @brief Method .ctor addr 0x20e6c78 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Update addr 0x20e69f4 size 0x8 virtual false final false
 void Update() ;

/// @brief Method FluctuateCloth addr 0x20e69fc size 0x170 virtual false final false
 void FluctuateCloth(UnityEngine::Cloth cloth) ;

/// @brief Method GetNoise addr 0x20e6b6c size 0x104 virtual false final false
 float_t GetNoise(float_t time, float_t offset) ;

// Ctor Parameters []
explicit ClothRandomFluctuation() ;

/// @brief Method .ctor addr 0x20e6c70 size 0x8 virtual false final false
 void _ctor() ;
