...
/// @brief Method add_scoreDidChangeEvent addr 0x2146ea4 size 0xb0 virtual true final true
 void add_scoreDidChangeEvent(System::Action_2<int32_t,int32_t> value) ;

/// @brief Method remove_scoreDidChangeEvent addr 0x2146f54 size 0xb0 virtual true final true
 void remove_scoreDidChangeEvent(System::Action_2<int32_t,int32_t> value) ;

/// @brief Method add_multiplierDidChangeEvent addr 0x2147004 size 0xb0 virtual true final true
 void add_multiplierDidChangeEvent(System::Action_2<int32_t,float_t> value) ;

/// @brief Method remove_multiplierDidChangeEvent addr 0x21470b4 size 0xb0 virtual true final true
 void remove_multiplierDidChangeEvent(System::Action_2<int32_t,float_t> value) ;

/// @brief Method add_scoringForNoteStartedEvent addr 0x2147164 size 0xb0 virtual true final true
 void add_scoringForNoteStartedEvent(System::Action_1<GlobalNamespace::ScoringElement> value) ;

/// @brief Method remove_scoringForNoteStartedEvent addr 0x2147214 size 0xb0 virtual true final true
 void remove_scoringForNoteStartedEvent(System::Action_1<GlobalNamespace::ScoringElement> value) ;

/// @brief Method add_scoringForNoteFinishedEvent addr 0x21472c4 size 0xb0 virtual true final true
 void add_scoringForNoteFinishedEvent(System::Action_1<GlobalNamespace::ScoringElement> value) ;

/// @brief Method remove_scoringForNoteFinishedEvent addr 0x2147374 size 0xb0 virtual true final true
 void remove_scoringForNoteFinishedEvent(System::Action_1<GlobalNamespace::ScoringElement> value) ;

/// @brief Method get_multipliedScore addr 0x2147424 size 0x8 virtual true final true
 int32_t get_multipliedScore() ;

/// @brief Method get_modifiedScore addr 0x214742c size 0x8 virtual true final true
 int32_t get_modifiedScore() ;

/// @brief Method get_immediateMaxPossibleMultipliedScore addr 0x2147434 size 0x8 virtual true final true
 int32_t get_immediateMaxPossibleMultipliedScore() ;

/// @brief Method get_immediateMaxPossibleModifiedScore addr 0x214743c size 0x8 virtual true final true
 int32_t get_immediateMaxPossibleModifiedScore() ;

/// @brief Method SetEnabled addr 0x2147444 size 0xc virtual true final true
 void SetEnabled(bool enabled) ;

/// @brief Method Start addr 0x2147450 size 0x24c virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x214769c size 0x1e8 virtual false final false
 void OnDestroy() ;

/// @brief Method LateUpdate addr 0x2147884 size 0x7ac virtual false final false
 void LateUpdate() ;

/// @brief Method HandleNoteWasSpawned addr 0x2148300 size 0xd4 virtual false final false
 void HandleNoteWasSpawned(GlobalNamespace::NoteController noteController) ;

/// @brief Method HandleNoteWasCut addr 0x21483d4 size 0x1ac virtual false final false
 void HandleNoteWasCut(GlobalNamespace::NoteController noteController, ByRef<GlobalNamespace::NoteCutInfo> noteCutInfo) ;

/// @brief Method HandleNoteWasMissed addr 0x214863c size 0x134 virtual false final false
 void HandleNoteWasMissed(GlobalNamespace::NoteController noteController) ;

/// @brief Method HandlePlayerHeadDidEnterObstacles addr 0x21487bc size 0x88 virtual false final false
 void HandlePlayerHeadDidEnterObstacles() ;

/// @brief Method DespawnScoringElement addr 0x2148178 size 0x188 virtual false final false
 void DespawnScoringElement(GlobalNamespace::ScoringElement scoringElement) ;

// Ctor Parameters []
explicit ScoreController() ;

/// @brief Method .ctor addr 0x2148844 size 0x174 virtual false final false
 void _ctor() ;
