...
/// @brief Method Awake addr 0x20dca14 size 0x1c virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x20dca30 size 0x184 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x20dcf74 size 0x108 virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x20dd07c size 0x190 virtual false final false
 void Update() ;

/// @brief Method SetupAndRun addr 0x20dcbb4 size 0x3c0 virtual false final false
 void SetupAndRun() ;

/// @brief Method BuildAnimationCurvePath addr 0x20dd20c size 0x584 virtual false final false
 bool BuildAnimationCurvePath() ;

/// @brief Method AdjustPositionWithOffsetDirection addr 0x20dd850 size 0x2f0 virtual false final false
...
/// @brief Method HandleBeatmapObjectSpawnControllerDidInit addr 0x20de3a0 size 0x4 virtual false final false
 void HandleBeatmapObjectSpawnControllerDidInit() ;

// Ctor Parameters []
explicit BeatmapObjectsAvoidance() ;

/// @brief Method .ctor addr 0x20de3a4 size 0x14 virtual false final false
 void _ctor() ;
