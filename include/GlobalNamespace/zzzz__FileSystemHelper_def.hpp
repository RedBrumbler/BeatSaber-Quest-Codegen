...
/// @brief Method FindFirstExistedParentPath addr 0x21c956c size 0x90 virtual false final false
static ::StringW FindFirstExistedParentPath(::StringW path) ;

/// @brief Method HasWritePermission addr 0x21c95fc size 0x398 virtual false final false
static bool HasWritePermission(System::Security::AccessControl::FileSystemSecurity accessControlList) ;

/// @brief Method HasWritePermissionOnDirectory addr 0x21c9994 size 0x14 virtual false final false
static bool HasWritePermissionOnDirectory(::StringW path) ;

/// @brief Method HasWritePermissionOnFile addr 0x21c99a8 size 0x14 virtual false final false
static bool HasWritePermissionOnFile(::StringW path) ;

/// @brief Method IsFileWritable addr 0x21c99bc size 0x74 virtual false final false
