...
/// @brief Method GetInitValues addr 0x218a4e8 size 0xd8 virtual true final false
 bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements) ;

/// @brief Method ApplyValue addr 0x218a5c0 size 0x58 virtual true final false
 void ApplyValue(int32_t idx) ;

/// @brief Method TextForValue addr 0x218a618 size 0x50 virtual true final false
 ::StringW TextForValue(int32_t idx) ;

// Ctor Parameters []
explicit PresetsSettingsController() ;

/// @brief Method .ctor addr 0x218a668 size 0x8 virtual false final false
 void _ctor() ;
