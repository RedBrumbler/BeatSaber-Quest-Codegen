...
/// @brief Method get_achievementsIds addr 0x20fd14c size 0x8 virtual false final false
 System::Collections::Generic::List_1<GlobalNamespace::AchievementSO> get_achievementsIds() ;

// Ctor Parameters []
explicit AchievementIdsModelSO() ;

/// @brief Method .ctor addr 0x20fd154 size 0x7c virtual false final false
 void _ctor() ;
