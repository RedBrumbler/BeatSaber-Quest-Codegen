...
/// @brief Method Start addr 0x2659e04 size 0xb0 virtual false final false
 void Start() ;

/// @brief Method Initialize addr 0x2659eb4 size 0x224 virtual false final false
 void Initialize() ;

/// @brief Method UpdateDefaultExternalCamera addr 0x265a0d8 size 0x428 virtual false final false
 void UpdateDefaultExternalCamera() ;

/// @brief Method Update addr 0x265a500 size 0x738 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit OVRMixedRealityCaptureTest() ;

/// @brief Method .ctor addr 0x265ac38 size 0x8 virtual false final false
 void _ctor() ;
