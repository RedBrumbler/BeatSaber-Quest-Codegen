...
/// @brief Method .ctor addr 0x2181998 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <InitStages>b__6_0 addr 0x21819a0 size 0x18 virtual false final false
...
/// @brief Method get_firstLockedMissionStage addr 0x21817e0 size 0x8 virtual false final false
 GlobalNamespace::MissionStage get_firstLockedMissionStage() ;

/// @brief Method UpdateFirtsLockedMissionStage addr 0x2180f10 size 0x7c virtual false final false
 void UpdateFirtsLockedMissionStage(int32_t numberOfClearedMissions) ;

/// @brief Method InitStages addr 0x21817e8 size 0x144 virtual false final false
 void InitStages() ;

/// @brief Method UpdateStageLockPosition addr 0x218118c size 0xc virtual false final false
 void UpdateStageLockPosition() ;

/// @brief Method UpdateStageLockPositionAnimated addr 0x217f144 size 0xf0 virtual false final false
 void UpdateStageLockPositionAnimated(bool animated, float_t animationDuration) ;

/// @brief Method UpdateStageLockText addr 0x2180f8c size 0xb8 virtual false final false
 void UpdateStageLockText(int32_t numberOfClearedMissions) ;

// Ctor Parameters []
explicit MissionStagesManager() ;

/// @brief Method .ctor addr 0x218192c size 0x8 virtual false final false
 void _ctor() ;
