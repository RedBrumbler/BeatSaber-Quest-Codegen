...
/// @brief Method Start addr 0x1faba30 size 0x210 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x1fabc80 size 0x1a4 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleInputFocusCaptured addr 0x1fabc40 size 0x40 virtual false final false
 void HandleInputFocusCaptured() ;

/// @brief Method HandleInputFocusReleased addr 0x1fabe24 size 0x24 virtual false final false
