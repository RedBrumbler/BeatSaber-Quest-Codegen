...
/// @brief Method get_renderer addr 0x1fbef54 size 0x8 virtual false final false
 UnityEngine::Renderer get_renderer() ;

/// @brief Method Reset addr 0x1fbef5c size 0x50 virtual false final false
 void Reset() ;

// Ctor Parameters []
explicit SortingLayer() ;

/// @brief Method .ctor addr 0x1fbefac size 0x8 virtual false final false
 void _ctor() ;
