...
/// @brief Method get_lights addr 0x1fd44c4 size 0x58 virtual false final false
static System::Collections::Generic::List_1<GlobalNamespace::DirectionalLight> get_lights() ;

/// @brief Method OnEnable addr 0x1fd451c size 0xd0 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fd45ec size 0x80 virtual false final false
 void OnDisable() ;

// Ctor Parameters []
explicit DirectionalLight() ;

/// @brief Method .ctor addr 0x1fd466c size 0x10 virtual false final false
 void _ctor() ;
