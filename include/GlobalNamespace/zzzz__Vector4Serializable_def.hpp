...
/// @brief Method Serialize addr 0x1226ecc size 0x68 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0x1226f34 size 0x7c virtual true final true
 void Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method Equals addr 0x1226fb0 size 0x44 virtual true final true
 bool Equals(GlobalNamespace::Vector4Serializable other) ;

/// @brief Method Approximately addr 0x1226ff4 size 0x74 virtual false final false
 bool Approximately(GlobalNamespace::Vector4Serializable other) ;

/// @brief Method Equals addr 0x1227068 size 0xa8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x1227110 size 0x1c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x122712c size 0x25c virtual true final false
 ::StringW ToString() ;

/// @brief Method GetSize addr 0x1227388 size 0x6c virtual false final false
 int32_t GetSize() ;

/// @brief Method .ctor addr 0x12273f4 size 0x34c virtual false final false
 void _ctor(UnityEngine::Vector4 v) ;

/// @brief Method .ctor addr 0x1227740 size 0x8 virtual false final false
 void _ctor(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method op_Implicit addr 0x1227748 size 0x34 virtual false final false
static UnityEngine::Vector4 op_Implicit_UnityEngine__Vector4(GlobalNamespace::Vector4Serializable v) ;

/// @brief Method op_Implicit addr 0x122777c size 0x24 virtual false final false
static GlobalNamespace::Vector4Serializable op_Implicit_GlobalNamespace__Vector4Serializable(UnityEngine::Vector4 v) ;

/// @brief Method op_Addition addr 0x12277a0 size 0x2c virtual false final false
...
/// @brief Method op_Subtraction addr 0x12277cc size 0x2c virtual false final false
