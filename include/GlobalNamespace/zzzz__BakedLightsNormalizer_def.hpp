...
/// @brief Method get_lightmapLightDict addr 0x1fd75b4 size 0x8 virtual false final false
...
/// @brief Method get_maxTotalIntensity addr 0x1fd75bc size 0x8 virtual false final false
 float_t get_maxTotalIntensity() ;

/// @brief Method LateUpdate addr 0x1fd75c4 size 0x3c virtual false final false
 void LateUpdate() ;

/// @brief Method GetLightmapLights addr 0x1fd7824 size 0x10c virtual false final false
 void GetLightmapLights() ;

/// @brief Method UpdateGrayscaleTotal addr 0x1fd7600 size 0x224 virtual false final false
 void UpdateGrayscaleTotal() ;

/// @brief Method GetNormalizationMultiplier addr 0x1fd7930 size 0x48 virtual false final false
 float_t GetNormalizationMultiplier() ;

// Ctor Parameters []
explicit BakedLightsNormalizer() ;

/// @brief Method .ctor addr 0x1fd7978 size 0x94 virtual false final false
 void _ctor() ;
