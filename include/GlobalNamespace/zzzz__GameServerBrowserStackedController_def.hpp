...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13666))}
...
/// @brief Method DidActivate addr 0x21ad62c size 0x4 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x21ad630 size 0x4 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

// Ctor Parameters []
explicit GameServerBrowserStackedController() ;

/// @brief Method .ctor addr 0x21ad634 size 0x8 virtual false final false
 void _ctor() ;
