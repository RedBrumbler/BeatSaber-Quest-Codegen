...
/// @brief Method get_previousSameTypeEventData addr 0xda0764 size 0x8 virtual false final false
 GlobalNamespace::BeatmapEventData get_previousSameTypeEventData() ;

/// @brief Method set_previousSameTypeEventData addr 0xda076c size 0x8 virtual false final false
 void set_previousSameTypeEventData(GlobalNamespace::BeatmapEventData value) ;

/// @brief Method get_nextSameTypeEventData addr 0xda0774 size 0x8 virtual false final false
 GlobalNamespace::BeatmapEventData get_nextSameTypeEventData() ;

/// @brief Method set_nextSameTypeEventData addr 0xda077c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xda03ac size 0x44 virtual false final false
 void _ctor(float_t time, int32_t executionOrder, int32_t subtypeIdentifier) ;

/// @brief Method __ConnectWithPreviousSameTypeEventData addr 0xda0784 size 0x10 virtual false final false
 void __ConnectWithPreviousSameTypeEventData(GlobalNamespace::BeatmapEventData newPreviousSameTypeEvent) ;

/// @brief Method __ConnectWithNextSameTypeEventData addr 0xda0794 size 0x10 virtual false final false
 void __ConnectWithNextSameTypeEventData(GlobalNamespace::BeatmapEventData newNextSameTypeEvent) ;

/// @brief Method __ResetConnections addr 0xda07a4 size 0x8 virtual false final false
...
/// @brief Method GetDefault addr 0xda07ac size 0x2c virtual false final false
