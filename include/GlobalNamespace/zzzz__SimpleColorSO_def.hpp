...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(16059))}
...
/// @brief Method get_color addr 0x11b04d8 size 0xc virtual true final false
 UnityEngine::Color get_color() ;

/// @brief Method SetColor addr 0x11b04e4 size 0xc virtual false final false
 void SetColor(UnityEngine::Color c) ;

// Ctor Parameters []
explicit SimpleColorSO() ;

/// @brief Method .ctor addr 0x11b04f0 size 0x8 virtual false final false
 void _ctor() ;
