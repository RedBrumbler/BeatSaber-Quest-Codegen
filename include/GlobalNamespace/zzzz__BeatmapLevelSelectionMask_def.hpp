...
/// @brief Method .ctor addr 0xdab8c8 size 0x10 virtual false final false
...
/// @brief Method Equals addr 0xdab8d8 size 0x90 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0xdab968 size 0xf8 virtual true final true
 bool Equals(GlobalNamespace::BeatmapLevelSelectionMask other) ;

/// @brief Method GetHashCode addr 0xdaba60 size 0x2c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Serialize addr 0xdaba8c size 0x50 virtual false final false
 void Serialize(LiteNetLib::Utils::NetDataWriter writer, uint32_t version) ;

/// @brief Method Deserialize addr 0xdabadc size 0x64 virtual false final false
static GlobalNamespace::BeatmapLevelSelectionMask Deserialize(LiteNetLib::Utils::NetDataReader reader, uint32_t version) ;

/// @brief Method op_Equality addr 0xdabb40 size 0x40 virtual false final false
static bool op_Equality(GlobalNamespace::BeatmapLevelSelectionMask l, GlobalNamespace::BeatmapLevelSelectionMask r) ;

/// @brief Method op_Inequality addr 0xdabb80 size 0x40 virtual false final false
