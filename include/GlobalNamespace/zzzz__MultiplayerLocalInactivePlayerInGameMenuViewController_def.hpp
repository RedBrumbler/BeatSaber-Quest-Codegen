...
/// @brief Method OnEnable addr 0x2107efc size 0x150 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x210804c size 0xac virtual false final false
 void OnDisable() ;

/// @brief Method Start addr 0x21080f8 size 0x14c virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2108244 size 0x12c virtual false final false
 void OnDestroy() ;

/// @brief Method DisconnectButtonPressed addr 0x2108370 size 0x34 virtual false final false
 void DisconnectButtonPressed() ;

/// @brief Method DetailsToggleValueChanged addr 0x21083a4 size 0x20 virtual false final false
 void DetailsToggleValueChanged(bool isOn) ;

/// @brief Method HandleDisconnectPromptViewDidViewFinish addr 0x21083c4 size 0xc4 virtual false final false
 void HandleDisconnectPromptViewDidViewFinish(bool disconnect) ;

/// @brief Method HandleStateChanged addr 0x2108488 size 0x1c4 virtual false final false
...
/// @brief Method .ctor addr 0x210864c size 0x98 virtual false final false
 void _ctor() ;

/// @brief Method <HandleDisconnectPromptViewDidViewFinish>b__22_0 addr 0x21086e4 size 0x20 virtual false final false
 void _HandleDisconnectPromptViewDidViewFinish_b__22_0() ;

/// @brief Method <HandleStateChanged>b__23_0 addr 0x2108704 size 0x1c virtual false final false
 void _HandleStateChanged_b__23_0(float_t val) ;

/// @brief Method <HandleStateChanged>b__23_1 addr 0x2108720 size 0x24 virtual false final false
