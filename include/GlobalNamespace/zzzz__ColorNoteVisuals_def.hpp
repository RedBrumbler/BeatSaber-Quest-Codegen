...
/// @brief Method add_didInitEvent addr 0x2274920 size 0xb0 virtual false final false
 void add_didInitEvent(System::Action_2<GlobalNamespace::ColorNoteVisuals,GlobalNamespace::NoteControllerBase> value) ;

/// @brief Method remove_didInitEvent addr 0x22749d0 size 0xb0 virtual false final false
 void remove_didInitEvent(System::Action_2<GlobalNamespace::ColorNoteVisuals,GlobalNamespace::NoteControllerBase> value) ;

/// @brief Method set_showArrow addr 0x2274a80 size 0x68 virtual false final false
 void set_showArrow(bool value) ;

/// @brief Method set_showCircle addr 0x2274ae8 size 0x68 virtual false final false
 void set_showCircle(bool value) ;

/// @brief Method Awake addr 0x2274b50 size 0x1d0 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x2274d20 size 0x220 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleNoteControllerDidInit addr 0x2274f40 size 0x178 virtual true final true
 void HandleNoteControllerDidInit(GlobalNamespace::NoteControllerBase noteController) ;

/// @brief Method HandleNoteControllerNoteDidPassJumpThreeQuarters addr 0x22750b8 size 0x20 virtual true final true
 void HandleNoteControllerNoteDidPassJumpThreeQuarters(GlobalNamespace::NoteControllerBase noteController) ;

/// @brief Method HandleNoteControllerNoteDidStartDissolving addr 0x22750d8 size 0x20 virtual true final true
...
/// @brief Method .ctor addr 0x22750f8 size 0x10 virtual false final false
 void _ctor() ;
