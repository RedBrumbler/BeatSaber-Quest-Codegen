...
/// @brief Method add_joinServerButtonWasPressedEvent addr 0x215ac20 size 0x9c virtual false final false
 void add_joinServerButtonWasPressedEvent(System::Action value) ;

/// @brief Method remove_joinServerButtonWasPressedEvent addr 0x215acbc size 0x9c virtual false final false
 void remove_joinServerButtonWasPressedEvent(System::Action value) ;

/// @brief Method Start addr 0x215ad58 size 0xa8 virtual true final false
 void Start() ;

// Ctor Parameters []
explicit GameServerListDetailTableCell() ;

/// @brief Method .ctor addr 0x215ae00 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method <Start>b__5_0 addr 0x215ae68 size 0x1c virtual false final false
 void _Start_b__5_0() ;
