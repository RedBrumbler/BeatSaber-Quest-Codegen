...
/// @brief Method Init addr 0x2148d14 size 0x1a8 virtual false final false
...
/// @brief Method OnEnable addr 0x2148ebc size 0x20 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2148edc size 0x20 virtual false final false
 void OnDisable() ;

/// @brief Method LateUpdate addr 0x2148efc size 0x1f4 virtual false final false
 void LateUpdate() ;

// Ctor Parameters []
explicit SmoothCamera() ;

/// @brief Method .ctor addr 0x21490f0 size 0x8 virtual false final false
 void _ctor() ;
