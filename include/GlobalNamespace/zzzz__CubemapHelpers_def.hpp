...
/// @brief Method get_cubemapHelpersMaterial addr 0x21d41a8 size 0x128 virtual false final false
static UnityEngine::Material get_cubemapHelpersMaterial() ;

/// @brief Method Downsample addr 0x21d42d0 size 0x12c virtual false final false
static void Downsample(UnityEngine::Texture src, UnityEngine::RenderTexture dest) ;

/// @brief Method CreateDownsampledCubemap addr 0x21d45ac size 0x1ec virtual false final false
static UnityEngine::RenderTexture CreateDownsampledCubemap(UnityEngine::RenderTexture src, int32_t count) ;

/// @brief Method Create2DTextureFromCubemap addr 0x21d4798 size 0x170 virtual false final false
static UnityEngine::RenderTexture Create2DTextureFromCubemap(UnityEngine::RenderTexture src) ;

/// @brief Method DrawCubemapFace addr 0x21d43fc size 0x1b0 virtual false final false
