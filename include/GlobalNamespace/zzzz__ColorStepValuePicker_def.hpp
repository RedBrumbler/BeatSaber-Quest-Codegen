...
/// @brief Method add_decButtonWasPressedEvent addr 0x215a2c0 size 0x9c virtual false final false
 void add_decButtonWasPressedEvent(System::Action value) ;

/// @brief Method remove_decButtonWasPressedEvent addr 0x215a35c size 0x9c virtual false final false
 void remove_decButtonWasPressedEvent(System::Action value) ;

/// @brief Method add_incButtonWasPressedEvent addr 0x215a3f8 size 0x9c virtual false final false
 void add_incButtonWasPressedEvent(System::Action value) ;

/// @brief Method remove_incButtonWasPressedEvent addr 0x215a494 size 0x9c virtual false final false
 void remove_incButtonWasPressedEvent(System::Action value) ;

/// @brief Method get_color addr 0x215a530 size 0x24 virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method set_color addr 0x215a554 size 0x24 virtual false final false
 void set_color(UnityEngine::Color value) ;

/// @brief Method set_decButtonInteractable addr 0x215a578 size 0x20 virtual false final false
 void set_decButtonInteractable(bool value) ;

/// @brief Method set_incButtonInteractable addr 0x215a598 size 0x20 virtual false final false
 void set_incButtonInteractable(bool value) ;

/// @brief Method OnEnable addr 0x215a5b8 size 0xf0 virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x215a6a8 size 0xf0 virtual false final false
 void OnDisable() ;

/// @brief Method IncButtonPressed addr 0x215a798 size 0x1c virtual false final false
 void IncButtonPressed() ;

/// @brief Method DecButtonPressed addr 0x215a7b4 size 0x1c virtual false final false
 void DecButtonPressed() ;

// Ctor Parameters []
explicit ColorStepValuePicker() ;

/// @brief Method .ctor addr 0x215a7d0 size 0x8 virtual false final false
 void _ctor() ;
