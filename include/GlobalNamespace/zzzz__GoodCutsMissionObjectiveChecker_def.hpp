...
/// @brief Method Init addr 0x210ded0 size 0x14c virtual true final false
 void Init() ;

/// @brief Method OnDestroy addr 0x210e01c size 0x98 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleNoteWasCut addr 0x210e0b4 size 0x8c virtual false final false
 void HandleNoteWasCut(GlobalNamespace::NoteController noteController, ByRef<GlobalNamespace::NoteCutInfo> noteCutInfo) ;

// Ctor Parameters []
explicit GoodCutsMissionObjectiveChecker() ;

/// @brief Method .ctor addr 0x210e140 size 0x8 virtual false final false
 void _ctor() ;
