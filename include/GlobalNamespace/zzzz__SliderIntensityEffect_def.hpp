...
/// @brief Method .ctor addr 0x2284070 size 0x6c virtual false final false
...
/// @brief Method .ctor addr 0x2283f08 size 0x44 virtual false final false
...
/// @brief Method .ctor addr 0x22840dc size 0xc4 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x22841a0 size 0x14 virtual true final false
 float_t Invoke(float_t timeSinceLastSection, float_t timeSinceHeadNoteJump) ;

/// @brief Method BeginInvoke addr 0x22841b4 size 0x98 virtual true final false
...
/// @brief Method EndInvoke addr 0x228424c size 0x28 virtual true final false
...
/// @brief Method .ctor addr 0x2283fc0 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2284274 size 0x1c virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2284290 size 0x38c virtual true final true
 bool MoveNext() ;

/// @brief Method <>m__Finally1 addr 0x228461c size 0xb0 virtual false final false
 void __m__Finally1() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x22846cc size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x22846d4 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2284714 size 0x8 virtual true final true
...
/// @brief Method add_fadeInDidStartEvent addr 0x2281f34 size 0x9c virtual false final false
 void add_fadeInDidStartEvent(System::Action value) ;

/// @brief Method remove_fadeInDidStartEvent addr 0x228244c size 0x9c virtual false final false
 void remove_fadeInDidStartEvent(System::Action value) ;

/// @brief Method get_intensity addr 0x2280b04 size 0x28 virtual false final false
 float_t get_intensity() ;

/// @brief Method get_colorIntensity addr 0x2283bb8 size 0x28 virtual false final false
 float_t get_colorIntensity() ;

/// @brief Method Awake addr 0x2283be0 size 0x328 virtual false final false
 void Awake() ;

/// @brief Method Init addr 0x2281040 size 0xfc virtual false final false
 void Init(float_t sliderDuration, float_t halfJumpDuration, bool startVisible) ;

/// @brief Method ManualUpdate addr 0x22827c4 size 0x3c virtual false final false
 void ManualUpdate(float_t timeSinceHeadNoteJump) ;

/// @brief Method ProcessEffectCoroutine addr 0x2283f4c size 0x74 virtual false final false
...
/// @brief Method StartIntensityDipEffect addr 0x2283044 size 0x30 virtual false final false
 void StartIntensityDipEffect() ;

/// @brief Method StartIntensityFadeInEffect addr 0x2282de8 size 0x30 virtual false final false
 void StartIntensityFadeInEffect() ;

/// @brief Method StartFlashEffect addr 0x2283fe8 size 0x30 virtual false final false
 void StartFlashEffect() ;

// Ctor Parameters []
explicit SliderIntensityEffect() ;

/// @brief Method .ctor addr 0x2284018 size 0x20 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__29_0 addr 0x2284038 size 0x1c virtual false final false
 void _Awake_b__29_0() ;

/// @brief Method <Awake>b__29_1 addr 0x2284054 size 0x1c virtual false final false
 void _Awake_b__29_1() ;
