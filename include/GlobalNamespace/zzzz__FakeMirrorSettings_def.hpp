...
/// @brief Method get_fakeMirrorTransparency addr 0x26a72c4 size 0x8 virtual false final false
 float_t get_fakeMirrorTransparency() ;

/// @brief Method set_fakeMirrorTransparency addr 0x26a72cc size 0x8 virtual false final false
 void set_fakeMirrorTransparency(float_t value) ;

/// @brief Method Start addr 0x26a72d4 size 0x4 virtual false final false
 void Start() ;

/// @brief Method OnEnable addr 0x26a73e8 size 0x4 virtual false final false
 void OnEnable() ;

/// @brief Method OnValidate addr 0x26a73ec size 0x4 virtual false final false
 void OnValidate() ;

/// @brief Method SetGlobalParameters addr 0x26a72d8 size 0x110 virtual false final false
 void SetGlobalParameters() ;

// Ctor Parameters []
explicit FakeMirrorSettings() ;

/// @brief Method .ctor addr 0x26a73f0 size 0x30 virtual false final false
 void _ctor() ;
