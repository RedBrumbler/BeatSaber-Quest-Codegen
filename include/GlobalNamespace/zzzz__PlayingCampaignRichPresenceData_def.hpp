...
/// @brief Method get_apiName addr 0x2264c94 size 0x40 virtual true final true
 ::StringW get_apiName() ;

/// @brief Method get_localizedDescription addr 0x2264cd4 size 0x8 virtual true final true
 ::StringW get_localizedDescription() ;

/// @brief Method set_localizedDescription addr 0x2264cdc size 0x8 virtual false final false
 void set_localizedDescription(::StringW value) ;

// Ctor Parameters []
explicit PlayingCampaignRichPresenceData() ;

/// @brief Method .ctor addr 0x2264ce4 size 0x5c virtual false final false
 void _ctor() ;
