...
/// @brief Method .ctor addr 0x21a0b20 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__1 addr 0x21a11bc size 0x2c virtual false final false
 void _DidActivate_b__1() ;

/// @brief Method <DidActivate>b__2 addr 0x21a11e8 size 0x2c virtual false final false
...
/// @brief Method MoveNext addr 0x21a1214 size 0x428 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x21a163c size 0xc virtual true final true
...
/// @brief Method MoveNext addr 0x21a1648 size 0x388 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x21a19d0 size 0xc virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method SetData addr 0x219c150 size 0x3cc virtual false final false
 void SetData(GlobalNamespace::IBeatmapLevelPack pack) ;

/// @brief Method DidActivate addr 0x21a0934 size 0x1ec virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x21a0b28 size 0xa8 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method OnDestroy addr 0x21a0bd0 size 0x108 virtual true final false
 void OnDestroy() ;

/// @brief Method RefreshAvailabilityAsync addr 0x21a08a0 size 0x94 virtual false final false
 void RefreshAvailabilityAsync() ;

/// @brief Method BuyPackButtonWasPressed addr 0x21a0cd8 size 0x10c virtual false final false
 void BuyPackButtonWasPressed() ;

/// @brief Method OpenLevelPackProductStoreAsync addr 0x21a0de4 size 0x94 virtual false final false
 void OpenLevelPackProductStoreAsync() ;

/// @brief Method ShowContent addr 0x21a0e78 size 0x2d4 virtual false final false
...
/// @brief Method HandleAdditionalContentModelDidInvalidateData addr 0x21a114c size 0x4 virtual false final false
 void HandleAdditionalContentModelDidInvalidateData() ;

// Ctor Parameters []
explicit LevelPackDetailViewController() ;

/// @brief Method .ctor addr 0x21a1150 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__16_0 addr 0x21a11b8 size 0x4 virtual false final false
