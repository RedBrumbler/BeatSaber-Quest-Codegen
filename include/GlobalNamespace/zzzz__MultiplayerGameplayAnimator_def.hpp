...
/// @brief Method Start addr 0x212f098 size 0x94 virtual true final false
 void Start() ;

/// @brief Method OnDestroy addr 0x211de74 size 0x18c virtual true final false
 void OnDestroy() ;
...
/// @brief Method HandleStateChanged addr 0x211e274 size 0x164 virtual true final false
 void HandleStateChanged(GlobalNamespace::GlobalNamespace__MultiplayerController__State state) ;

/// @brief Method HandleNewLeaderWasSelected addr 0x212f28c size 0xe8 virtual false final false
 void HandleNewLeaderWasSelected(::StringW userId) ;

// Ctor Parameters []
explicit MultiplayerGameplayAnimator() ;

/// @brief Method .ctor addr 0x211e5c0 size 0x14 virtual false final false
 void _ctor() ;
