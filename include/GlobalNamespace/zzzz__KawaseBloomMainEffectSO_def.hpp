...
/// @brief Method get_hasPostProcessEffect addr 0x26a7690 size 0x8 virtual true final false
 bool get_hasPostProcessEffect() ;

/// @brief Method OnEnable addr 0x26a7698 size 0x1c virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x26a7770 size 0x20 virtual false final false
 void OnDisable() ;

/// @brief Method LazyInitializeMaterials addr 0x26a76b4 size 0xbc virtual false final false
 void LazyInitializeMaterials() ;

/// @brief Method PreRender addr 0x26a7790 size 0x64 virtual true final false
 void PreRender() ;

/// @brief Method Render addr 0x26a787c size 0x210 virtual true final false
 void Render(UnityEngine::RenderTexture src, UnityEngine::RenderTexture dest, float_t fade) ;

// Ctor Parameters []
explicit KawaseBloomMainEffectSO() ;

/// @brief Method .ctor addr 0x26a7a8c size 0x28 virtual false final false
 void _ctor() ;
