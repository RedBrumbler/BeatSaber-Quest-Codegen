...
/// @brief Method Start addr 0x2267588 size 0xa4 virtual false final false
 void Start() ;

/// @brief Method HandleSpawnCenterDistanceWasFound addr 0x226762c size 0x68 virtual false final false
 void HandleSpawnCenterDistanceWasFound(float_t distance) ;

// Ctor Parameters []
explicit OffsetByBeatmapObjectSpawnCenter() ;

/// @brief Method .ctor addr 0x2267744 size 0x8 virtual false final false
 void _ctor() ;
