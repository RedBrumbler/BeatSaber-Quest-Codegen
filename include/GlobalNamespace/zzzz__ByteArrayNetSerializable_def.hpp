...
/// @brief Method get_length addr 0xdabbc0 size 0x8 virtual false final false
 int32_t get_length() ;

/// @brief Method get_data addr 0xdabbc8 size 0x8 virtual false final false
 ::ArrayW<uint8_t> get_data() ;

/// @brief Method set_data addr 0xdabcac size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0xdabcd8 size 0x48 virtual false final false
...
/// @brief Method .ctor addr 0xdabd20 size 0x44 virtual false final false
 void _ctor(::StringW name, int32_t size, bool allowEmpty) ;

/// @brief Method SetData addr 0xdabcb0 size 0x28 virtual false final false
 void SetData(::ArrayW<uint8_t> value) ;

/// @brief Method SetData addr 0xdabd64 size 0x220 virtual false final false
 void SetData(::ArrayW<uint8_t> value, int32_t offset, int32_t length) ;

/// @brief Method GetData addr 0xdabbd0 size 0xdc virtual false final false
 ::ArrayW<uint8_t> GetData(bool emptyAsNull) ;

/// @brief Method Serialize addr 0xdac0b4 size 0xf0 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0xdac1a4 size 0x244 virtual true final true
 void Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method Clear addr 0xdabf84 size 0x70 virtual false final false
 void Clear() ;

/// @brief Method Resize addr 0xdabff4 size 0xa4 virtual false final false
 void Resize(int32_t length) ;

/// @brief Method op_Implicit addr 0xdac3e8 size 0x14 virtual false final false
static ::ArrayW<uint8_t> op_Implicit___ArrayW_uint8_t_(GlobalNamespace::ByteArrayNetSerializable byteArrayNetSerializable) ;

/// @brief Method CopyTo addr 0xdac098 size 0x1c virtual false final false
 void CopyTo(::ArrayW<uint8_t> destination) ;

/// @brief Method CopyTo addr 0xdac3fc size 0x3c virtual false final false
