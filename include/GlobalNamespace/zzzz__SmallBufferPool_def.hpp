...
/// @brief Method GetBuffer addr 0xdd9960 size 0x270 virtual false final false
 ::ArrayW<uint8_t> GetBuffer(int32_t length) ;

/// @brief Method ReleaseBuffer addr 0xdd9bd0 size 0x4 virtual false final false
 void ReleaseBuffer(::ArrayW<uint8_t> buffer) ;

/// @brief Method ReleaseBuffer addr 0xdd9d98 size 0x1c virtual false final false
 void ReleaseBuffer(ByRef<::ArrayW<uint8_t>> buffer) ;

/// @brief Method ReleaseBufferInternal addr 0xdd9bd4 size 0x1c4 virtual false final false
 void ReleaseBufferInternal(::ArrayW<uint8_t> buffer) ;

// Ctor Parameters []
explicit SmallBufferPool() ;

/// @brief Method .ctor addr 0xdd9db4 size 0xe8 virtual false final false
 void _ctor() ;
