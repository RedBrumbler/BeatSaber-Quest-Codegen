...
/// @brief Method .ctor addr 0x21852a0 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x21851d4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SelectCellWithSerializedName>b__0 addr 0x218534c size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x21853d4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <LazyInit>b__15_2 addr 0x21853dc size 0x198 virtual false final false
...
/// @brief Method <LazyInit>b__15_4 addr 0x2185574 size 0x3c virtual false final false
...
/// @brief Method <LazyInit>b__15_3 addr 0x21855b0 size 0x18 virtual false final false
...
/// @brief Method add_didSelectCellWithIdxEvent addr 0x2184978 size 0xb0 virtual false final false
 void add_didSelectCellWithIdxEvent(System::Action_1<int32_t> value) ;

/// @brief Method remove_didSelectCellWithIdxEvent addr 0x2184a28 size 0xb0 virtual false final false
 void remove_didSelectCellWithIdxEvent(System::Action_1<int32_t> value) ;

/// @brief Method Start addr 0x2184ad8 size 0x8c virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2184b64 size 0xd4 virtual false final false
 void OnDestroy() ;

/// @brief Method SetOverrideSongPacks addr 0x2184c38 size 0x8 virtual false final false
...
/// @brief Method GetSelectedSerializedName addr 0x2184c40 size 0x70 virtual false final false
 ::StringW GetSelectedSerializedName() ;

/// @brief Method SelectCellWithSerializedName addr 0x2185084 size 0x150 virtual false final false
 void SelectCellWithSerializedName(::StringW serializedName) ;

/// @brief Method HandleSimpleTextDropdownDidSelectCellWithIdx addr 0x21851dc size 0x24 virtual false final false
 void HandleSimpleTextDropdownDidSelectCellWithIdx(HMUI::DropdownWithTableView dropdownWithTableView, int32_t idx) ;

/// @brief Method LazyInit addr 0x2184cb0 size 0x3d4 virtual false final false
 void LazyInit() ;

// Ctor Parameters []
explicit QuickPlaySongPacksDropdown() ;

/// @brief Method .ctor addr 0x2185200 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <LazyInit>b__15_0 addr 0x2185208 size 0x98 virtual false final false
 GlobalNamespace::GlobalNamespace__QuickPlaySongPacksDropdown__SongPackMaskItem _LazyInit_b__15_0(::StringW serializedName) ;

/// @brief Method <LazyInit>b__15_1 addr 0x21852a8 size 0xa4 virtual false final false
