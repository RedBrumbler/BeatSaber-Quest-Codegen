...
/// @brief Method Start addr 0x20e5ffc size 0x28 virtual true final false
 void Start() ;

/// @brief Method Update addr 0x20e60cc size 0x4 virtual false final false
 void Update() ;

/// @brief Method HandleColorChangeBeatmapEvent addr 0x20e6278 size 0x13c virtual true final false
 void HandleColorChangeBeatmapEvent(GlobalNamespace::LightColorBeatmapEventData e) ;

/// @brief Method SetInitialValues addr 0x20e6024 size 0xa8 virtual false final false
 void SetInitialValues() ;

/// @brief Method StartEffect addr 0x20e63d8 size 0xe0 virtual false final false
 void StartEffect(float_t startTime, float_t endTime) ;

/// @brief Method EndEffect addr 0x20e63b4 size 0x24 virtual false final false
 void EndEffect() ;

/// @brief Method UpdateEffect addr 0x20e60d0 size 0x1a8 virtual false final false
 void UpdateEffect() ;

/// @brief Method UpdateRenderers addr 0x20e64b8 size 0x15c virtual false final false
 void UpdateRenderers(float_t flipBookAlpha, float_t bloomAlpha) ;

// Ctor Parameters []
explicit ContinuousFireEffect() ;

/// @brief Method .ctor addr 0x20e6614 size 0x8c virtual false final false
 void _ctor() ;
