...
/// @brief Method get_IsMissionComplete addr 0x222a070 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x222a0d8 size 0x2c virtual false final false
