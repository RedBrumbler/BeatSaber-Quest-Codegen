...
/// @brief Method Awake addr 0x1fcbe88 size 0x4 virtual false final false
 void Awake() ;

/// @brief Method LazyInit addr 0x1fcbe8c size 0xc8 virtual false final false
 void LazyInit() ;

/// @brief Method OnDestroy addr 0x1fcc0a0 size 0xac virtual false final false
 void OnDestroy() ;

/// @brief Method OnPreRender addr 0x1fcc14c size 0x24c virtual false final false
 void OnPreRender() ;

/// @brief Method OnPostRender addr 0x1fcd294 size 0x94 virtual false final false
 void OnPostRender() ;

/// @brief Method SetMode addr 0x1fcd344 size 0x8 virtual false final false
 void SetMode(GlobalNamespace::GlobalNamespace__BloomPrePass__Mode mode) ;

// Ctor Parameters []
explicit BloomPrePass() ;

/// @brief Method .ctor addr 0x1fcd34c size 0x8 virtual false final false
 void _ctor() ;
