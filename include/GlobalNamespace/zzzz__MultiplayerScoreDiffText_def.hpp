...
/// @brief Method Start addr 0x2119210 size 0x158 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2119368 size 0x110 virtual false final false
 void OnDestroy() ;

/// @brief Method SetHorizontalPositionRelativeToLocalPlayer addr 0x2119478 size 0xd8 virtual false final false
...
/// @brief Method AnimateScoreDiff addr 0x2119550 size 0x1b0 virtual false final false
 void AnimateScoreDiff(int32_t scoreDiff) ;

/// @brief Method AnimateHide addr 0x2119700 size 0xf0 virtual false final false
 void AnimateHide() ;

/// @brief Method AnimateIsLeadPlayer addr 0x21197f0 size 0x54 virtual false final false
 void AnimateIsLeadPlayer(bool isLeader) ;

/// @brief Method HandleNewLeaderWasSelected addr 0x2119844 size 0xc0 virtual false final false
 void HandleNewLeaderWasSelected(::StringW userId) ;

// Ctor Parameters []
explicit MultiplayerScoreDiffText() ;

/// @brief Method .ctor addr 0x2119904 size 0x20 virtual false final false
 void _ctor() ;

/// @brief Method <Start>b__14_0 addr 0x2119924 size 0x5c virtual false final false
 void _Start_b__14_0(float_t val) ;

/// @brief Method <AnimateScoreDiff>b__17_0 addr 0x2119980 size 0xc virtual false final false
 void _AnimateScoreDiff_b__17_0() ;

/// @brief Method <AnimateHide>b__18_0 addr 0x211998c size 0x30 virtual false final false
