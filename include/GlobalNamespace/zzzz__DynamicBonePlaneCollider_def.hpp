...
/// @brief Method OnValidate addr 0x11b3420 size 0x4 virtual false final false
 void OnValidate() ;

/// @brief Method Collide addr 0x11b3424 size 0x188 virtual true final false
 void Collide(ByRef<UnityEngine::Vector3> particlePosition, float_t particleRadius) ;

/// @brief Method OnDrawGizmosSelected addr 0x11b35ac size 0x160 virtual false final false
 void OnDrawGizmosSelected() ;

// Ctor Parameters []
explicit DynamicBonePlaneCollider() ;

/// @brief Method .ctor addr 0x11b370c size 0x4 virtual false final false
 void _ctor() ;
