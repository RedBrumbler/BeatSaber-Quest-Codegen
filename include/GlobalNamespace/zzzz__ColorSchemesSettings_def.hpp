...
/// @brief Method set_selectedColorSchemeId addr 0x22592fc size 0x8 virtual false final false
 void set_selectedColorSchemeId(::StringW value) ;

/// @brief Method get_selectedColorSchemeId addr 0x2259304 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x225930c size 0x160 virtual false final false
...
/// @brief Method .ctor addr 0x225946c size 0x20 virtual false final false
 void _ctor(::ArrayW<GlobalNamespace::ColorSchemeSO> colorSchemeSOs) ;

/// @brief Method ConvertColorSchemeSOs addr 0x225948c size 0x114 virtual false final false
static ::ArrayW<GlobalNamespace::ColorScheme> ConvertColorSchemeSOs(::ArrayW<GlobalNamespace::ColorSchemeSO> colorSchemeSOs) ;

/// @brief Method GetNumberOfColorSchemes addr 0x22595a0 size 0x48 virtual false final false
 int32_t GetNumberOfColorSchemes() ;

/// @brief Method GetColorSchemeForIdx addr 0x22595e8 size 0x58 virtual false final false
 GlobalNamespace::ColorScheme GetColorSchemeForIdx(int32_t idx) ;

/// @brief Method GetColorSchemeForId addr 0x2259640 size 0x58 virtual false final false
 GlobalNamespace::ColorScheme GetColorSchemeForId(::StringW id) ;

/// @brief Method SetColorSchemeForId addr 0x2259698 size 0x110 virtual false final false
 void SetColorSchemeForId(GlobalNamespace::ColorScheme colorScheme) ;

/// @brief Method GetSelectedColorScheme addr 0x22597a8 size 0x54 virtual false final false
 GlobalNamespace::ColorScheme GetSelectedColorScheme() ;

/// @brief Method GetSelectedColorSchemeIdx addr 0x22597fc size 0xa0 virtual false final false
 int32_t GetSelectedColorSchemeIdx() ;

/// @brief Method GetOverrideColorScheme addr 0x225989c size 0x14 virtual false final false
