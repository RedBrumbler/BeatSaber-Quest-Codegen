...
/// @brief Method get_headWorldPos addr 0x21418e4 size 0xc virtual false final false
 UnityEngine::Vector3 get_headWorldPos() ;

/// @brief Method get_headWorldRot addr 0x21418f0 size 0xc virtual false final false
 UnityEngine::Quaternion get_headWorldRot() ;

/// @brief Method get_headPseudoLocalPos addr 0x21418fc size 0xc virtual false final false
 UnityEngine::Vector3 get_headPseudoLocalPos() ;

/// @brief Method get_headPseudoLocalRot addr 0x2141908 size 0xc virtual false final false
 UnityEngine::Quaternion get_headPseudoLocalRot() ;

/// @brief Method get_leftHandPseudoLocalPos addr 0x2141914 size 0xc virtual false final false
 UnityEngine::Vector3 get_leftHandPseudoLocalPos() ;

/// @brief Method get_leftHandPseudoLocalRot addr 0x2141920 size 0xc virtual false final false
 UnityEngine::Quaternion get_leftHandPseudoLocalRot() ;

/// @brief Method get_rightHandPseudoLocalPos addr 0x214192c size 0xc virtual false final false
 UnityEngine::Vector3 get_rightHandPseudoLocalPos() ;

/// @brief Method get_rightHandPseudoLocalRot addr 0x2141938 size 0xc virtual false final false
 UnityEngine::Quaternion get_rightHandPseudoLocalRot() ;

/// @brief Method Awake addr 0x2141944 size 0x84 virtual false final false
 void Awake() ;

/// @brief Method OverrideHeadPos addr 0x21419c8 size 0x1c virtual false final false
 void OverrideHeadPos(UnityEngine::Vector3 pos) ;

/// @brief Method Update addr 0x21419e4 size 0x1d8 virtual false final false
 void Update() ;

/// @brief Method MoveTowardsHead addr 0x2141bbc size 0x74 virtual false final false
 float_t MoveTowardsHead(float_t start, float_t end, UnityEngine::Quaternion noteInverseWorldRotation, float_t t) ;

/// @brief Method GetZPosOffsetByHeadPosAtTime addr 0x2141c78 size 0x2c virtual false final false
 float_t GetZPosOffsetByHeadPosAtTime(float_t start, float_t end, float_t t) ;

/// @brief Method GetZPos addr 0x2141c50 size 0x28 virtual false final false
 float_t GetZPos(float_t start, float_t end, float_t headOffsetZ, float_t t) ;

/// @brief Method HeadOffsetZ addr 0x2141c30 size 0x20 virtual false final false
 float_t HeadOffsetZ(UnityEngine::Quaternion noteInverseWorldRotation) ;

// Ctor Parameters []
explicit PlayerTransforms() ;

/// @brief Method .ctor addr 0x2141ca4 size 0x8 virtual false final false
 void _ctor() ;
