...
/// @brief Method get_playerCount addr 0x22704f0 size 0x8 virtual false final false
 int32_t get_playerCount() ;

/// @brief Method get_distance addr 0x22704f8 size 0x8 virtual false final false
 float_t get_distance() ;

// Ctor Parameters []
explicit GlobalNamespace__BeatmapObjectSpawnCenter__PlayerCountToDistance() ;

/// @brief Method .ctor addr 0x2270500 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_spawnCenterDistance addr 0x22702a0 size 0x8 virtual false final false
 float_t get_spawnCenterDistance() ;

/// @brief Method get_spawnCenterDistanceWasFound addr 0x22702a8 size 0x8 virtual false final false
 bool get_spawnCenterDistanceWasFound() ;

/// @brief Method add_spawnCenterDistanceWasFoundEvent addr 0x2267694 size 0xb0 virtual false final false
 void add_spawnCenterDistanceWasFoundEvent(System::Action_1<float_t> value) ;

/// @brief Method remove_spawnCenterDistanceWasFoundEvent addr 0x22702b0 size 0xb0 virtual false final false
 void remove_spawnCenterDistanceWasFoundEvent(System::Action_1<float_t> value) ;

/// @brief Method CalculateSpawnCenterPosition addr 0x2270360 size 0x158 virtual false final false
 float_t CalculateSpawnCenterPosition(int32_t numberOfPlayers) ;

/// @brief Method ReportAndSaveSpawnCenterDistance addr 0x22704b8 size 0x28 virtual false final false
 void ReportAndSaveSpawnCenterDistance(float_t distance) ;

// Ctor Parameters []
explicit BeatmapObjectSpawnCenter() ;

/// @brief Method .ctor addr 0x22704e0 size 0x10 virtual false final false
 void _ctor() ;
