...
/// @brief Method Start addr 0x211ab70 size 0x6e0 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x211b250 size 0x434 virtual false final false
 void OnDestroy() ;

/// @brief Method LateUpdate addr 0x211b684 size 0x348 virtual false final false
 void LateUpdate() ;

/// @brief Method HandleNoteWasAdded addr 0x211b9cc size 0x160 virtual false final false
...
/// @brief Method HandleObstacleWasAdded addr 0x211bb2c size 0x140 virtual false final false
...
/// @brief Method HandleSliderWasAdded addr 0x211bc6c size 0x1d4 virtual false final false
...
/// @brief Method HandleNoteWasMissed addr 0x211be40 size 0xfc virtual false final false
 void HandleNoteWasMissed(GlobalNamespace::NoteController noteController) ;

/// @brief Method HandleNoteWasCut addr 0x211bf3c size 0x1c4 virtual false final false
 void HandleNoteWasCut(GlobalNamespace::NoteController noteController, ByRef<GlobalNamespace::NoteCutInfo> noteCutInfo) ;

/// @brief Method HandleComboDidChange addr 0x211c100 size 0xcc virtual false final false
 void HandleComboDidChange(int32_t combo) ;

/// @brief Method HandleMultiplierDidChange addr 0x211c1cc size 0xcc virtual false final false
 void HandleMultiplierDidChange(int32_t multiplier, float_t multiplierProgress) ;

/// @brief Method HandleScoreDidChange addr 0x211c298 size 0x254 virtual false final false
 void HandleScoreDidChange(int32_t multipliedScore, int32_t modifiedScore) ;

// Ctor Parameters []
explicit MultiplayerLocalActiveClient() ;

/// @brief Method .ctor addr 0x211c4ec size 0x8 virtual false final false
 void _ctor() ;
