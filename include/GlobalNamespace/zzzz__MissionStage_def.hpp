...
/// @brief Method get_minimumMissionsToUnlock addr 0x222a9ec size 0x8 virtual false final false
 int32_t get_minimumMissionsToUnlock() ;

/// @brief Method get_position addr 0x222a9f4 size 0x1c virtual false final false
 UnityEngine::Vector2 get_position() ;

// Ctor Parameters []
explicit MissionStage() ;

/// @brief Method .ctor addr 0x222aa10 size 0x8 virtual false final false
 void _ctor() ;
