...
/// @brief Method get_averagingValueRecorer addr 0x2143b08 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2143b10 size 0x9c virtual false final false
 void _ctor(float_t averageWindowDuration, float_t historyValuesPerSecond, float_t increaseSpeed, float_t decreaseSpeed) ;

/// @brief Method AddMovement addr 0x2143bac size 0x24 virtual false final false
 void AddMovement(float_t distance) ;

/// @brief Method ManualUpdate addr 0x2143bd0 size 0x3c virtual false final false
