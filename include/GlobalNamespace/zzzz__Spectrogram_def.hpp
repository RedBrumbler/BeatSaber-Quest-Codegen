...
/// @brief Method get_materialPropertyBlock addr 0x22a5b14 size 0xb4 virtual false final false
 UnityEngine::MaterialPropertyBlock get_materialPropertyBlock() ;

/// @brief Method Awake addr 0x22a5bc8 size 0xe8 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x22a5cb0 size 0x15c virtual false final false
 void Update() ;

// Ctor Parameters []
explicit Spectrogram() ;

/// @brief Method .ctor addr 0x22a5e0c size 0x8 virtual false final false
 void _ctor() ;
