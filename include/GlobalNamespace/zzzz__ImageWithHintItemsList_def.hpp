...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13744), inst: 5051 }), TypeDefinitionIndex(TypeDefinitionIndex(13744)), TypeDefinitionIndex(TypeDefinitionIndex(13698))}
...
/// @brief Method .ctor addr 0x215c8d8 size 0x48 virtual false final false
 void _ctor() ;
