...
/// @brief Method MoveNext addr 0x2207be4 size 0x1c8 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2207dac size 0xc virtual true final true
...
/// @brief Method MoveNext addr 0x2207db8 size 0x410 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x22081c8 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method get_transformedBeatmapData addr 0x220799c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x22079a4 size 0x88 virtual false final false
...
/// @brief Method LoadTransformedBeatmapDataAsync addr 0x2207a2c size 0xc8 virtual false final false
 System::Threading::Tasks::Task LoadTransformedBeatmapDataAsync() ;

/// @brief Method GetTransformedBeatmapDataAsync addr 0x2207af4 size 0xf0 virtual false final false
