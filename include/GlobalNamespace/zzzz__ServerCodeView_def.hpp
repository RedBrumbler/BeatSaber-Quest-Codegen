...
/// @brief Method SetCode addr 0x21c64bc size 0xc virtual false final false
 void SetCode(::StringW serverCode) ;

/// @brief Method OnEnable addr 0x21c6568 size 0x98 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x21c6600 size 0x1c virtual false final false
 void OnDisable() ;

/// @brief Method HandleShowServerCodeButtonPressed addr 0x21c661c size 0x10 virtual false final false
 void HandleShowServerCodeButtonPressed() ;

/// @brief Method RefreshText addr 0x21c64c8 size 0xa0 virtual false final false
 void RefreshText(bool showCode) ;

// Ctor Parameters []
explicit ServerCodeView() ;

/// @brief Method .ctor addr 0x21c662c size 0x68 virtual false final false
 void _ctor() ;
