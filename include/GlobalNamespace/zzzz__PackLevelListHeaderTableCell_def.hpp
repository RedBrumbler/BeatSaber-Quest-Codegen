...
/// @brief Method set_text addr 0x215ea40 size 0x24 virtual false final false
 void set_text(::StringW value) ;

/// @brief Method get_text addr 0x215ea64 size 0x24 virtual false final false
 ::StringW get_text() ;

/// @brief Method SelectionDidChange addr 0x215ea88 size 0x4 virtual true final false
 void SelectionDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method HighlightDidChange addr 0x215eb14 size 0x4 virtual true final false
 void HighlightDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method RefreshVisuals addr 0x215ea8c size 0x88 virtual false final false
 void RefreshVisuals() ;

// Ctor Parameters []
explicit PackLevelListHeaderTableCell() ;

/// @brief Method .ctor addr 0x215eb18 size 0x14 virtual false final false
 void _ctor() ;
