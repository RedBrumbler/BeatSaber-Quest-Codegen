...
/// @brief Method add_didSelectRow addr 0x21bcc14 size 0xb0 virtual false final false
 void add_didSelectRow(System::Action_2<GlobalNamespace::DifficultyTableView,int32_t> value) ;

/// @brief Method remove_didSelectRow addr 0x21bccc4 size 0xb0 virtual false final false
 void remove_didSelectRow(System::Action_2<GlobalNamespace::DifficultyTableView,int32_t> value) ;

/// @brief Method Init addr 0x21bcd74 size 0xec virtual false final false
 void Init(::ArrayW<GlobalNamespace::IDifficultyBeatmap> difficultyBeatmaps) ;

/// @brief Method SetDifficultyBeatmaps addr 0x21bce60 size 0x28 virtual false final false
 void SetDifficultyBeatmaps(::ArrayW<GlobalNamespace::IDifficultyBeatmap> difficultyBeatmaps) ;

/// @brief Method CellSize addr 0x21bce88 size 0x8 virtual true final true
 float_t CellSize() ;

/// @brief Method NumberOfCells addr 0x21bce90 size 0x20 virtual true final true
 int32_t NumberOfCells() ;

/// @brief Method CellForIdx addr 0x21bceb0 size 0x354 virtual true final true
 HMUI::TableCell CellForIdx(HMUI::TableView tableView, int32_t row) ;

/// @brief Method HandleDidSelectRowEvent addr 0x21bd204 size 0x54 virtual false final false
 void HandleDidSelectRowEvent(HMUI::TableView tableView, int32_t row) ;

/// @brief Method SelectRow addr 0x21bd258 size 0x20 virtual false final false
 void SelectRow(int32_t row, bool callbackTable) ;

/// @brief Method SelectRow addr 0x21bd278 size 0x84 virtual false final false
 void SelectRow(GlobalNamespace::IDifficultyBeatmap difficultyBeatmap, bool callbackTable) ;

/// @brief Method ClearSelection addr 0x21bd2fc size 0x1c virtual false final false
 void ClearSelection() ;

// Ctor Parameters []
explicit DifficultyTableView() ;

/// @brief Method .ctor addr 0x21bd318 size 0x10 virtual false final false
 void _ctor() ;
