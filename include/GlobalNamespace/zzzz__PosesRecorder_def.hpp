...
/// @brief Method .ctor addr 0x21df7ec size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Init>b__6_0 addr 0x21df7f4 size 0x18 virtual false final false
 UnityEngine::Transform _Init_b__6_0(GlobalNamespace::PoseObject ro) ;

/// @brief Method <Init>b__6_1 addr 0x21df80c size 0x20 virtual false final false
...
/// @brief Method get_data addr 0x21df420 size 0x8 virtual false final false
 GlobalNamespace::PosesRecordingData get_data() ;

/// @brief Method LateUpdate addr 0x21df428 size 0x1c virtual false final false
 void LateUpdate() ;

/// @brief Method Init addr 0x21dcf1c size 0x238 virtual false final false
...
/// @brief Method StartRecording addr 0x21dd8d0 size 0xc virtual false final false
 void StartRecording() ;

/// @brief Method RecordTick addr 0x21df444 size 0x1c8 virtual false final false
 void RecordTick(float_t time) ;

/// @brief Method StopRecording addr 0x21dd848 size 0xc virtual false final false
 void StopRecording() ;

// Ctor Parameters []
explicit PosesRecorder() ;

/// @brief Method .ctor addr 0x21df780 size 0x8 virtual false final false
 void _ctor() ;
