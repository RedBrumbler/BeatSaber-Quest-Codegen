...
/// @brief Method .ctor addr 0x215e7cc size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method add_valueChangedEvent addr 0x215e520 size 0xb0 virtual true final true
 void add_valueChangedEvent(System::Action_1<int32_t> value) ;

/// @brief Method remove_valueChangedEvent addr 0x215e5d0 size 0xb0 virtual true final true
 void remove_valueChangedEvent(System::Action_1<int32_t> value) ;

/// @brief Method Init addr 0x215e680 size 0x3c virtual false final false
 void Init(::ArrayW<GlobalNamespace::GlobalNamespace__NamedColorListController__ColorValuePair> values, int32_t value) ;

/// @brief Method SetValue addr 0x215e6bc size 0x38 virtual false final false
 void SetValue(int32_t value) ;

/// @brief Method GetInitValues addr 0x215e6f4 size 0x74 virtual true final false
 bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements) ;

/// @brief Method ApplyValue addr 0x215e768 size 0x20 virtual true final false
 void ApplyValue(int32_t idx) ;

/// @brief Method ColorForValue addr 0x215e788 size 0x3c virtual true final false
 UnityEngine::Color ColorForValue(int32_t idx) ;

// Ctor Parameters []
explicit NamedColorListController() ;

/// @brief Method .ctor addr 0x215e7c4 size 0x8 virtual false final false
 void _ctor() ;
