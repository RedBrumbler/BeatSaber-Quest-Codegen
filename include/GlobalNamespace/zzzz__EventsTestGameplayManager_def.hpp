...
/// @brief Method .ctor addr 0x22a78e8 size 0x28 virtual false final false
 void _ctor(float_t bpm) ;

/// @brief Method ConvertBeatToTime addr 0x22aa580 size 0x18 virtual true final true
...
/// @brief Method .ctor addr 0x22a9f0c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <AddEventsForLightGroup>b__0 addr 0x22aa598 size 0x30 virtual false final false
...
/// @brief Method <AddInstantToggleEventsForLightGroup>b__0 addr 0x22aa5c8 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x22a9f1c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <AddToggleEventsForLightGroup>b__0 addr 0x22aa5f8 size 0x30 virtual false final false
...
/// @brief Method Start addr 0x22a77d0 size 0x118 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x22a7910 size 0x87c virtual false final false
 void Update() ;

/// @brief Method AddEventsForLightGroup addr 0x22a818c size 0x930 virtual false final false
 void AddEventsForLightGroup(int32_t lightGroupId) ;

/// @brief Method AddInstantToggleEventsForLightGroup addr 0x22a9058 size 0x470 virtual false final false
 void AddInstantToggleEventsForLightGroup(int32_t lightGroupId) ;

/// @brief Method AddToggleEventsForLightGroup addr 0x22a8abc size 0x59c virtual false final false
 void AddToggleEventsForLightGroup(int32_t lightGroupId, GlobalNamespace::EnvironmentColorType color) ;

/// @brief Method AddTestBox addr 0x22a94c8 size 0xa44 virtual false final false
 void AddTestBox() ;

// Ctor Parameters []
explicit EventsTestGameplayManager() ;

/// @brief Method .ctor addr 0x22a9f24 size 0x65c virtual false final false
 void _ctor() ;
