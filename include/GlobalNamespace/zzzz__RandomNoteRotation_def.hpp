...
/// @brief Method Awake addr 0x227cf8c size 0xb8 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x227d044 size 0x100 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleNoteControllerDidInit addr 0x227d144 size 0x28 virtual true final true
 void HandleNoteControllerDidInit(GlobalNamespace::NoteControllerBase noteController) ;

// Ctor Parameters []
explicit RandomNoteRotation() ;

/// @brief Method .ctor addr 0x227d16c size 0x8 virtual false final false
 void _ctor() ;
