...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LeaderboardTableCell::*)(int32_t)>(&GlobalNamespace::LeaderboardTableCell::set_rank)> {
  ...
  constexpr static std::size_t addrs = 0x215cb60;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LeaderboardTableCell::*)(::StringW)>(&GlobalNamespace::LeaderboardTableCell::set_playerName)> {
  ...
  constexpr static std::size_t addrs = 0x215cba8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LeaderboardTableCell::*)(bool)>(&GlobalNamespace::LeaderboardTableCell::set_showSeparator)> {
  ...
  constexpr static std::size_t addrs = 0x215cc6c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LeaderboardTableCell::*)(bool)>(&GlobalNamespace::LeaderboardTableCell::set_showFullCombo)> {
  constexpr static std::size_t size = 0x20;
  constexpr static std::size_t addrs = 0x215cc8c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LeaderboardTableCell::*)(bool)>(&GlobalNamespace::LeaderboardTableCell::set_specialScore)> {
  ...
  constexpr static std::size_t addrs = 0x215ccac;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LeaderboardTableCell::*)()>(&GlobalNamespace::LeaderboardTableCell::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x215cda4;
...
constexpr TMPro::TextMeshProUGUI GlobalNamespace::LeaderboardTableCell::__get__rankText() const {
...
constexpr TMPro::TextMeshProUGUI GlobalNamespace::LeaderboardTableCell::__get__playerNameText() const {
...
constexpr TMPro::TextMeshProUGUI GlobalNamespace::LeaderboardTableCell::__get__scoreText() const {
...
constexpr TMPro::TextMeshProUGUI GlobalNamespace::LeaderboardTableCell::__get__fullComboText() const {
...
constexpr UnityEngine::Color GlobalNamespace::LeaderboardTableCell::__get__normalColor() const {
...
constexpr UnityEngine::Color GlobalNamespace::LeaderboardTableCell::__get__specialScoreColor() const {
...
::cordl_internals::setInstanceField<UnityEngine::UI::Image, 0x98>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::UI::Image>(value));
}
constexpr UnityEngine::UI::Image GlobalNamespace::LeaderboardTableCell::__get__separatorImage() const {
return ::cordl_internals::getInstanceField<UnityEngine::UI::Image, 0x98>(this->::bs_hook::Il2CppWrapperType::instance);
}
 void GlobalNamespace::LeaderboardTableCell::set_rank(int32_t value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::LeaderboardTableCell>::get(),
                            "set_rank",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 void GlobalNamespace::LeaderboardTableCell::set_score(int32_t value)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::LeaderboardTableCell>::get(),
                            "set_score",
                            std::vector<Il2CppClass*>{},
