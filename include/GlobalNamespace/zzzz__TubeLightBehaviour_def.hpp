...
struct CORDL_TYPE GlobalNamespace__TubeLightBehaviour__ParameterType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr GlobalNamespace__TubeLightBehaviour__ParameterType(int32_t value__) noexcept;


                    constexpr GlobalNamespace__TubeLightBehaviour__ParameterType(GlobalNamespace__TubeLightBehaviour__ParameterType const&) = default;
                    constexpr GlobalNamespace__TubeLightBehaviour__ParameterType(GlobalNamespace__TubeLightBehaviour__ParameterType&&) = default;
                    constexpr GlobalNamespace__TubeLightBehaviour__ParameterType& operator=(GlobalNamespace__TubeLightBehaviour__ParameterType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__TubeLightBehaviour__ParameterType& operator=(GlobalNamespace__TubeLightBehaviour__ParameterType&& o) noexcept {
...
constexpr explicit GlobalNamespace__TubeLightBehaviour__ParameterType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __GlobalNamespace__TubeLightBehaviour__ParameterType_Unwrapped : int32_t {
__Values = 0,
__References = 1,
};
...
static GlobalNamespace::GlobalNamespace__TubeLightBehaviour__ParameterType const Values;

/// @brief Field References offset 0
static GlobalNamespace::GlobalNamespace__TubeLightBehaviour__ParameterType const References;
...
public:
// Declarations
using ParameterType = GlobalNamespace::GlobalNamespace__TubeLightBehaviour__ParameterType;
...
/// @brief Method ProcessFrame addr 0x21ebe38 size 0x408 virtual true final false
...
/// @brief Method OnPlayableDestroy addr 0x21ec240 size 0xcc virtual true final false
 void OnPlayableDestroy(UnityEngine::Playables::Playable playable) ;

// Ctor Parameters []
explicit TubeLightBehaviour() ;

/// @brief Method .ctor addr 0x21ec30c size 0x8 virtual false final false
 void _ctor() ;
...
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__TubeLightBehaviour__ParameterType, "", "TubeLightBehaviour/ParameterType");
