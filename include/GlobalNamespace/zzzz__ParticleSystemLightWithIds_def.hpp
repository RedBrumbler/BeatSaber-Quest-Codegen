...
/// @brief Method Awake addr 0x1fdb0b4 size 0x80 virtual true final false
 void Awake() ;

/// @brief Method ColorWasSet addr 0x1fdb134 size 0x460 virtual true final false
 void ColorWasSet(UnityEngine::Color color) ;

// Ctor Parameters []
explicit ParticleSystemLightWithIds() ;

/// @brief Method .ctor addr 0x1fdb594 size 0x18 virtual false final false
 void _ctor() ;
