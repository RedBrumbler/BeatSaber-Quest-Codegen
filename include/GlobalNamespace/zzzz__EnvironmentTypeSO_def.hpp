...
/// @brief Method get_typeNameLocalizationKey addr 0x21f603c size 0x8 virtual false final false
 ::StringW get_typeNameLocalizationKey() ;

// Ctor Parameters []
explicit EnvironmentTypeSO() ;

/// @brief Method .ctor addr 0x21f6044 size 0x8 virtual false final false
 void _ctor() ;
