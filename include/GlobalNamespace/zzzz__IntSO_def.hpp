...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13923), inst: 92 }), TypeDefinitionIndex(TypeDefinitionIndex(13923))}
...
/// @brief Method .ctor addr 0x1fbf4a0 size 0x48 virtual false final false
 void _ctor() ;
