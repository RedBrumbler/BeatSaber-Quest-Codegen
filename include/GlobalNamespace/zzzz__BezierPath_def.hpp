...
/// @brief Method get_controlPointMode addr 0x21e59f8 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__BezierPath__ControlMode get_controlPointMode() ;

/// @brief Method set_controlPointMode addr 0x21e5a00 size 0x4c virtual false final false
 void set_controlPointMode(GlobalNamespace::GlobalNamespace__BezierPath__ControlMode value) ;

/// @brief Method add_bezierPathWasModifiedEvent addr 0x21e5ae8 size 0x9c virtual false final false
 void add_bezierPathWasModifiedEvent(System::Action value) ;

/// @brief Method remove_bezierPathWasModifiedEvent addr 0x21e5b84 size 0x9c virtual false final false
 void remove_bezierPathWasModifiedEvent(System::Action value) ;

/// @brief Method get_pointsCount addr 0x21e5c20 size 0x48 virtual false final false
 int32_t get_pointsCount() ;

/// @brief Method get_anchorPointsCount addr 0x21e5c68 size 0x64 virtual false final false
 int32_t get_anchorPointsCount() ;

/// @brief Method get_segmentsCount addr 0x21e5ccc size 0x60 virtual false final false
...
/// @brief Method .ctor addr 0x21e5d2c size 0x544 virtual false final false
 void _ctor(UnityEngine::Vector3 centre, bool initTwoSegments) ;

/// @brief Method UpdateByAnchorPoints addr 0x21e6270 size 0x608 virtual false final false
 void UpdateByAnchorPoints(System::Collections::Generic::IReadOnlyList_1<UnityEngine::Vector3> points) ;

/// @brief Method UpdateControlPoints addr 0x21e6d88 size 0x278 virtual false final false
 void UpdateControlPoints(System::Collections::Generic::IReadOnlyList_1<UnityEngine::Vector3> points) ;

/// @brief Method get_Item addr 0x21e70c0 size 0x4 virtual false final false
 UnityEngine::Vector3 get_Item(int32_t i) ;

/// @brief Method GetPoint addr 0x21e70c4 size 0x58 virtual false final false
 UnityEngine::Vector3 GetPoint(int32_t i) ;

/// @brief Method SetPoint addr 0x21e7000 size 0xc0 virtual false final false
 void SetPoint(int32_t i, UnityEngine::Vector3 localPosition, bool suppressPathModified) ;

/// @brief Method AddSegmentToEnd addr 0x21e6878 size 0x510 virtual false final false
 void AddSegmentToEnd(UnityEngine::Vector3 anchorPos) ;

/// @brief Method GetPointsInSegment addr 0x21e71a8 size 0x98 virtual false final false
 void GetPointsInSegment(int32_t segmentIndex, ByRef<::ArrayW<UnityEngine::Vector3>> points) ;

/// @brief Method GetPointsInSegment addr 0x21e7240 size 0xf8 virtual false final false
...
/// @brief Method GetAnchorNormalAngle addr 0x21e7338 size 0x64 virtual false final false
 float_t GetAnchorNormalAngle(int32_t anchorIndex) ;

/// @brief Method SetAnchorNormalAngle addr 0x21e739c size 0x13c virtual false final false
 void SetAnchorNormalAngle(int32_t anchorIndex, float_t angle) ;

/// @brief Method AutoSetAllAffectedControlPoints addr 0x21e711c size 0x8c virtual false final false
 void AutoSetAllAffectedControlPoints(int32_t updatedAnchorIndex) ;

/// @brief Method AutoSetAllControlPoints addr 0x21e5a4c size 0x80 virtual false final false
 void AutoSetAllControlPoints() ;

/// @brief Method AutoSetAnchorControlPoints addr 0x21e7530 size 0x4f0 virtual false final false
 void AutoSetAnchorControlPoints(int32_t anchorIndex) ;

/// @brief Method AutoSetStartAndEndControls addr 0x21e7a20 size 0x250 virtual false final false
 void AutoSetStartAndEndControls() ;

/// @brief Method LoopIndex addr 0x21e74d8 size 0x58 virtual false final false
 int32_t LoopIndex(int32_t i) ;

/// @brief Method NotifyPathModified addr 0x21e5acc size 0x1c virtual false final false
