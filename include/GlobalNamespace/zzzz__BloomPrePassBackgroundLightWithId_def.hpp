...
/// @brief Method get_color addr 0x1fd7bb8 size 0x20 virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method ColorWasSet addr 0x1fd7bd8 size 0x20 virtual true final false
 void ColorWasSet(UnityEngine::Color newColor) ;

// Ctor Parameters []
explicit BloomPrePassBackgroundLightWithId() ;

/// @brief Method .ctor addr 0x1fd7bf8 size 0x10 virtual false final false
 void _ctor() ;
