...
/// @brief Method .ctor addr 0x20f1440 size 0x4c virtual false final false
...
/// @brief Method get_state addr 0x20f0898 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__AudioTimeSyncController__State get_state() ;

/// @brief Method get_songTime addr 0x20f08a0 size 0x8 virtual true final true
 float_t get_songTime() ;

/// @brief Method get_lastFrameDeltaSongTime addr 0x20f08a8 size 0x8 virtual true final true
 float_t get_lastFrameDeltaSongTime() ;

/// @brief Method get_songLength addr 0x20f08b0 size 0x98 virtual true final true
 float_t get_songLength() ;

/// @brief Method get_isAudioLoaded addr 0x20f0948 size 0x30 virtual false final false
 bool get_isAudioLoaded() ;

/// @brief Method get_songEndTime addr 0x20f0978 size 0x6c virtual true final true
 float_t get_songEndTime() ;

/// @brief Method get_timeScale addr 0x20f09e4 size 0x8 virtual false final false
 float_t get_timeScale() ;

/// @brief Method get_dspTimeOffset addr 0x20f09ec size 0x8 virtual false final false
 double_t get_dspTimeOffset() ;

/// @brief Method get_waitUntilAudioIsLoaded addr 0x20f09f4 size 0xac virtual false final false
 UnityEngine::WaitUntil get_waitUntilAudioIsLoaded() ;

/// @brief Method get_isReady addr 0x20f0aa0 size 0x8 virtual true final true
 bool get_isReady() ;

/// @brief Method get_songTimeOffset addr 0x20f0aa8 size 0x8 virtual false final false
 float_t get_songTimeOffset() ;

/// @brief Method get_forceNoAudioSyncOrAudioSyncErrorFixing addr 0x20f0ab0 size 0x8 virtual false final false
 bool get_forceNoAudioSyncOrAudioSyncErrorFixing() ;

/// @brief Method set_forceNoAudioSyncOrAudioSyncErrorFixing addr 0x20f0ab8 size 0xc virtual false final false
 void set_forceNoAudioSyncOrAudioSyncErrorFixing(bool value) ;

/// @brief Method add_stateChangedEvent addr 0x20f0ac4 size 0x9c virtual false final false
 void add_stateChangedEvent(System::Action value) ;

/// @brief Method remove_stateChangedEvent addr 0x20f0b60 size 0x9c virtual false final false
 void remove_stateChangedEvent(System::Action value) ;

/// @brief Method get_timeSinceStart addr 0x20f0bfc size 0x20 virtual false final false
 float_t get_timeSinceStart() ;

/// @brief Method Awake addr 0x20f0c1c size 0x48 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x20f0c64 size 0xd8 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x20f0d3c size 0x358 virtual false final false
 void Update() ;

/// @brief Method StartSong addr 0x20f1094 size 0x44 virtual false final false
 void StartSong(float_t startTimeOffset) ;

/// @brief Method SeekTo addr 0x20f10d8 size 0x180 virtual false final false
 void SeekTo(float_t startTimeOffset) ;

/// @brief Method StopSong addr 0x20f1258 size 0x48 virtual false final false
 void StopSong() ;

/// @brief Method Pause addr 0x20f12a0 size 0x58 virtual false final false
 void Pause() ;

/// @brief Method Resume addr 0x20f12f8 size 0x50 virtual false final false
 void Resume() ;

/// @brief Method SetSongTimeIntoAudioTime addr 0x20f1348 size 0xe0 virtual false final false
 void SetSongTimeIntoAudioTime() ;

// Ctor Parameters []
explicit AudioTimeSyncController() ;

/// @brief Method .ctor addr 0x20f1428 size 0x14 virtual false final false
 void _ctor() ;

/// @brief Method <get_waitUntilAudioIsLoaded>b__27_0 addr 0x20f143c size 0x4 virtual false final false
