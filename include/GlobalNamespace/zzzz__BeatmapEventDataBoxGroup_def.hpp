...
/// @brief Method get_next addr 0x22131c4 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__BeatmapEventDataBoxGroup__ElementData get_next() ;

/// @brief Method get_previous addr 0x22131cc size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2212c08 size 0x8c virtual false final false
...
/// @brief Method ResetConnections addr 0x22131d4 size 0x8 virtual false final false
 void ResetConnections() ;

/// @brief Method ConnectWithPrevious addr 0x22131dc size 0x10 virtual false final false
 void ConnectWithPrevious(GlobalNamespace::GlobalNamespace__BeatmapEventDataBoxGroup__ElementData prevElementData) ;

/// @brief Method ConnectWithNext addr 0x22131ec size 0x10 virtual false final false
...
/// @brief Method get_elementDataDict addr 0x221240c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2212414 size 0x78c virtual false final false
...
/// @brief Method GetCopyWithNewBeat addr 0x2212c94 size 0x74 virtual false final false
 GlobalNamespace::BeatmapEventDataBoxGroup GetCopyWithNewBeat(float_t newBeat) ;

/// @brief Method RemoveBeatmapEventDataFromBeatmapData addr 0x2212d08 size 0x194 virtual false final false
 void RemoveBeatmapEventDataFromBeatmapData(GlobalNamespace::BeatmapData beatmapData) ;

/// @brief Method SyncWithBeatmapData addr 0x2212e9c size 0x2f8 virtual false final false
...
/// @brief Method CompareTo addr 0x2213194 size 0x30 virtual true final true
