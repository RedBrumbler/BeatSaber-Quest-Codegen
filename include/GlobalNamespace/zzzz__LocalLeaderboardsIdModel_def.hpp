...
/// @brief Method GetLocalLeaderboardID addr 0x21fa458 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x21fa460 size 0x8 virtual false final false
 void _ctor() ;
