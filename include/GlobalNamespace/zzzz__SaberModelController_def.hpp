...
/// @brief Method .ctor addr 0x21450ac size 0x20 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x21450cc size 0x40 virtual false final false
...
/// @brief Method Init addr 0x2144d2c size 0x2f0 virtual false final false
 void Init(UnityEngine::Transform parent, GlobalNamespace::Saber saber) ;

// Ctor Parameters []
explicit SaberModelController() ;

/// @brief Method .ctor addr 0x214503c size 0x70 virtual false final false
 void _ctor() ;
