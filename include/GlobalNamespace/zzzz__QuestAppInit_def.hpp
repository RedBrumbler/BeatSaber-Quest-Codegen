...
/// @brief Method AppStartAndMultiSceneEditorSetup addr 0x20ef9b4 size 0x18 virtual true final false
 void AppStartAndMultiSceneEditorSetup() ;

/// @brief Method RepeatableSetup addr 0x20ef9cc size 0x84 virtual true final false
 void RepeatableSetup() ;

/// @brief Method TransitionToNextScene addr 0x20efa50 size 0x30 virtual true final false
 void TransitionToNextScene() ;

/// @brief Method InstallBindings addr 0x20efa80 size 0x33c virtual true final false
 void InstallBindings() ;

// Ctor Parameters []
explicit QuestAppInit() ;

/// @brief Method .ctor addr 0x20efdbc size 0x4 virtual false final false
 void _ctor() ;
