...
/// @brief Method get_directory addr 0x1fb5cd8 size 0x8 virtual false final false
 ::StringW get_directory() ;

/// @brief Method set_directory addr 0x1fb5ce0 size 0x8 virtual false final false
 void set_directory(::StringW value) ;

/// @brief Method OnEnable addr 0x1fb5ce8 size 0x178 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fb5e60 size 0xc4 virtual false final false
 void OnDisable() ;

/// @brief Method LateUpdate addr 0x1fb5f24 size 0xc0 virtual false final false
 void LateUpdate() ;

/// @brief Method OnApplicationFocus addr 0x1fb6068 size 0x18 virtual false final false
 void OnApplicationFocus(bool hasFocus) ;

/// @brief Method SaveCameraScreenshot addr 0x1fb5fe4 size 0x84 virtual false final false
 void SaveCameraScreenshot() ;

/// @brief Method SaveTextureScreenshot addr 0x1fb619c size 0x140 virtual false final false
 void SaveTextureScreenshot(UnityEngine::Texture2D tex) ;

/// @brief Method ConvertRenderTexture addr 0x1fb6080 size 0x11c virtual false final false
 UnityEngine::Texture2D ConvertRenderTexture(UnityEngine::RenderTexture renderTexture) ;

// Ctor Parameters []
explicit ScreenshotRecorder() ;

/// @brief Method .ctor addr 0x1fb62dc size 0x80 virtual false final false
 void _ctor() ;
