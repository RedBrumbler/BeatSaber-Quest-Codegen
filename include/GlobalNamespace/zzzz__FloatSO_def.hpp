...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13923)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13923), inst: 374 })}
...
/// @brief Method .ctor addr 0x1fbf458 size 0x48 virtual false final false
 void _ctor() ;
