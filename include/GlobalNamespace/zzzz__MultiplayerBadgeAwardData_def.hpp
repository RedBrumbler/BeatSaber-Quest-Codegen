...
/// @brief Method get_awardedPlayer addr 0x2111bbc size 0x8 virtual false final false
 GlobalNamespace::IConnectedPlayer get_awardedPlayer() ;

/// @brief Method get_titleLocalizationKey addr 0x2111bc4 size 0x1c virtual false final false
 ::StringW get_titleLocalizationKey() ;

/// @brief Method get_title addr 0x2111be0 size 0x8 virtual false final false
 ::StringW get_title() ;

/// @brief Method get_subtitle addr 0x2111be8 size 0x8 virtual false final false
 ::StringW get_subtitle() ;

/// @brief Method get_icon addr 0x2111bf0 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x210fe8c size 0x60 virtual false final false
...
/// @brief Method CompareTo addr 0x2111bf8 size 0xf0 virtual true final true
