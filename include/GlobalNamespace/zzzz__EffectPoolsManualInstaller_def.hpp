...
/// @brief Method ManualInstallBindings addr 0x214f260 size 0x248 virtual false final false
 void ManualInstallBindings(Zenject::DiContainer container, bool shortBeatEffect) ;

// Ctor Parameters []
explicit EffectPoolsManualInstaller() ;

/// @brief Method .ctor addr 0x214f4a8 size 0x8 virtual false final false
 void _ctor() ;
