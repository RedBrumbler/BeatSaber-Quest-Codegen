...
/// @brief Method Start addr 0x25d8d80 size 0xc virtual false final false
 void Start() ;

/// @brief Method OnAudioFilterRead addr 0x25d8d8c size 0x18 virtual false final false
 void OnAudioFilterRead(::ArrayW<float_t> data, int32_t channels) ;

// Ctor Parameters []
explicit OVRMRAudioFilter() ;

/// @brief Method .ctor addr 0x25d8da4 size 0x8 virtual false final false
 void _ctor() ;
