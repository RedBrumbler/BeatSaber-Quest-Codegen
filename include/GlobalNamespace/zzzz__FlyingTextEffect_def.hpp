...
/// @brief Method InitAndPresent addr 0x228addc size 0x78 virtual false final false
...
/// @brief Method ManualUpdate addr 0x228ae54 size 0x64 virtual true final false
 void ManualUpdate(float_t t) ;

// Ctor Parameters []
explicit FlyingTextEffect() ;

/// @brief Method .ctor addr 0x228aeb8 size 0x30 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11011)), TypeDefinitionIndex(TypeDefinitionIndex(4976)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 2713 })}
...
/// @brief Method .ctor addr 0x228aee8 size 0x48 virtual false final false
 void _ctor() ;
