...
/// @brief Method Init addr 0x210d2f8 size 0x14c virtual true final false
 void Init() ;

/// @brief Method OnDestroy addr 0x210d480 size 0x98 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleNoteWasCut addr 0x210d518 size 0x8c virtual false final false
 void HandleNoteWasCut(GlobalNamespace::NoteController noteController, ByRef<GlobalNamespace::NoteCutInfo> noteCutInfo) ;

// Ctor Parameters []
explicit BadCutsMissionObjectiveChecker() ;

/// @brief Method .ctor addr 0x210d6e4 size 0x8 virtual false final false
 void _ctor() ;
