...
struct CORDL_TYPE GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__33 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__33(int32_t __1__state, System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<GlobalNamespace::IBeatmapDataBasicInfo> __t__builder, GlobalNamespace::CustomDifficultyBeatmap __4__this, System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::IBeatmapDataBasicInfo> __u__1) noexcept;


                    constexpr GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__33(GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__33 const&) = default;
                    constexpr GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__33(GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__33&&) = default;
                    constexpr GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__33& operator=(GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__33 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__33& operator=(GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__33&& o) noexcept {
...
constexpr explicit GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__33(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
/// @brief Method MoveNext addr 0x2221adc size 0x220 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2221cfc size 0x58 virtual true final true
...
class CORDL_TYPE GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x38};

virtual ~GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0(GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0(GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0& operator=(GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0&& o) noexcept = default;
  constexpr GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0& operator=(GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0 const& o) noexcept = default;
...
/// @brief Method .ctor addr 0x2221d54 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetBeatmapDataAsync>b__0 addr 0x2221d5c size 0x78 virtual false final false
...
struct CORDL_TYPE GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__34 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<GlobalNamespace::IReadonlyBeatmapData>", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "GlobalNamespace::CustomDifficultyBeatmap", modifiers: "", def_value: None }, CppParam { name: "environmentInfo", ty: "GlobalNamespace::EnvironmentInfoSO", modifiers: "", def_value: None }, CppParam { name: "playerSpecificSettings", ty: "GlobalNamespace::PlayerSpecificSettings", modifiers: "", def_value: None }, CppParam { name: "__8__1", ty: "GlobalNamespace::GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
constexpr GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__34(int32_t __1__state, System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<GlobalNamespace::IReadonlyBeatmapData> __t__builder, GlobalNamespace::CustomDifficultyBeatmap __4__this, GlobalNamespace::EnvironmentInfoSO environmentInfo, GlobalNamespace::PlayerSpecificSettings playerSpecificSettings, GlobalNamespace::GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0 __8__1, System::Runtime::CompilerServices::TaskAwaiter __u__1) noexcept;


                    constexpr GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__34(GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__34 const&) = default;
                    constexpr GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__34(GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__34&&) = default;
                    constexpr GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__34& operator=(GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__34 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__34& operator=(GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__34&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__34(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr GlobalNamespace::PlayerSpecificSettings __get_playerSpecificSettings() const;
 ...
 GlobalNamespace::GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0 __declspec(property(get=__get___8__1, put=__set___8__1))  __8__1;

constexpr void __set___8__1(GlobalNamespace::GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0 value) ;

constexpr GlobalNamespace::GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0 __get___8__1() const;
...
/// @brief Method MoveNext addr 0x2221dd4 size 0x2a0 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2222074 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
public:
// Declarations
using _GetBeatmapDataAsync_d__34 = GlobalNamespace::GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__34;

using __c__DisplayClass34_0 = GlobalNamespace::GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0;

using _GetBeatmapDataBasicInfoAsync_d__33 = GlobalNamespace::GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__33;
...
/// @brief Method get_level addr 0x22217f8 size 0x8 virtual true final true
 GlobalNamespace::IBeatmapLevel get_level() ;

/// @brief Method get_parentDifficultyBeatmapSet addr 0x2221800 size 0x8 virtual true final true
 GlobalNamespace::IDifficultyBeatmapSet get_parentDifficultyBeatmapSet() ;

/// @brief Method get_difficulty addr 0x2221808 size 0x8 virtual true final true
 GlobalNamespace::BeatmapDifficulty get_difficulty() ;

/// @brief Method get_difficultyRank addr 0x2221810 size 0x8 virtual true final true
 int32_t get_difficultyRank() ;

/// @brief Method get_noteJumpMovementSpeed addr 0x2221818 size 0x8 virtual true final true
 float_t get_noteJumpMovementSpeed() ;

/// @brief Method get_noteJumpStartBeatOffset addr 0x2221820 size 0x8 virtual true final true
 float_t get_noteJumpStartBeatOffset() ;

/// @brief Method get_beatmapDataBasicInfo addr 0x2221828 size 0x8 virtual false final false
 GlobalNamespace::IBeatmapDataBasicInfo get_beatmapDataBasicInfo() ;

/// @brief Method get_beatmapColorSchemeIdx addr 0x2221830 size 0x8 virtual false final false
 int32_t get_beatmapColorSchemeIdx() ;

/// @brief Method get_beatsPerMinute addr 0x2221838 size 0x8 virtual false final false
 float_t get_beatsPerMinute() ;

/// @brief Method get_environmentNameIdx addr 0x2221840 size 0x8 virtual true final true
 int32_t get_environmentNameIdx() ;

/// @brief Method get_beatmapSaveData addr 0x2221848 size 0x8 virtual false final false
 BeatmapSaveDataVersion3::BeatmapSaveData get_beatmapSaveData() ;

/// @brief Method GetBeatmapDataBasicInfoAsync addr 0x2221850 size 0xf0 virtual true final true
 System::Threading::Tasks::Task_1<GlobalNamespace::IBeatmapDataBasicInfo> GetBeatmapDataBasicInfoAsync() ;

/// @brief Method GetBeatmapDataAsync addr 0x2221940 size 0x108 virtual true final true
...
/// @brief Method .ctor addr 0x2221a48 size 0x94 virtual false final false
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__CustomDifficultyBeatmap____c__DisplayClass34_0, "", "CustomDifficultyBeatmap/<>c__DisplayClass34_0");
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataAsync_d__34, "", "CustomDifficultyBeatmap/<GetBeatmapDataAsync>d__34");
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__CustomDifficultyBeatmap___GetBeatmapDataBasicInfoAsync_d__33, "", "CustomDifficultyBeatmap/<GetBeatmapDataBasicInfoAsync>d__33");
