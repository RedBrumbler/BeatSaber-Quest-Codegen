...
/// @brief Method add_sparkleEffectDidStartEvent addr 0x22948f8 size 0xb0 virtual false final false
 void add_sparkleEffectDidStartEvent(System::Action_1<GlobalNamespace::SaberType> value) ;

/// @brief Method remove_sparkleEffectDidStartEvent addr 0x22949a8 size 0xb0 virtual false final false
 void remove_sparkleEffectDidStartEvent(System::Action_1<GlobalNamespace::SaberType> value) ;

/// @brief Method add_sparkleEffectDidEndEvent addr 0x2294a58 size 0xb0 virtual false final false
 void add_sparkleEffectDidEndEvent(System::Action_1<GlobalNamespace::SaberType> value) ;

/// @brief Method remove_sparkleEffectDidEndEvent addr 0x2294b08 size 0xb0 virtual false final false
 void remove_sparkleEffectDidEndEvent(System::Action_1<GlobalNamespace::SaberType> value) ;

/// @brief Method Start addr 0x2294bb8 size 0x2b0 virtual false final false
 void Start() ;

/// @brief Method OnDisable addr 0x2294e68 size 0xa4 virtual false final false
 void OnDisable() ;

/// @brief Method Update addr 0x2294f0c size 0x618 virtual false final false
 void Update() ;

/// @brief Method GetEffectRotation addr 0x22957ac size 0x124 virtual false final false
...
/// @brief Method BurnMarkPosForSaberType addr 0x22958d0 size 0x8c virtual false final false
 UnityEngine::Vector3 BurnMarkPosForSaberType(GlobalNamespace::SaberType saberType) ;

/// @brief Method GetBurnMarkPos addr 0x2295524 size 0x288 virtual false final false
...
/// @brief Method .ctor addr 0x229595c size 0x8 virtual false final false
 void _ctor() ;
