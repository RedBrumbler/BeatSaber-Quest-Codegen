...
/// @brief Method .ctor addr 0x2667670 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x266783c size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2667840 size 0xb4 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x26678f4 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x26678fc size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x266793c size 0x8 virtual true final true
...
/// @brief Method Awake addr 0x2666ad4 size 0x3c virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x2666b10 size 0xb0 virtual false final false
 void Start() ;

/// @brief Method Initialize addr 0x2666bc0 size 0x228 virtual false final false
 void Initialize() ;

/// @brief Method UpdateDefaultExternalCamera addr 0x2666de8 size 0x428 virtual false final false
 void UpdateDefaultExternalCamera() ;

/// @brief Method UpdateSpectatorCameraStatus addr 0x2667210 size 0x364 virtual false final false
 void UpdateSpectatorCameraStatus() ;

/// @brief Method SpectatorCameraDomePosition addr 0x26675dc size 0x94 virtual false final false
...
/// @brief Method TimerCoroutine addr 0x2667574 size 0x68 virtual false final false
 System::Collections::IEnumerator TimerCoroutine() ;

/// @brief Method Update addr 0x2667698 size 0x140 virtual false final false
 void Update() ;

/// @brief Method OnApplicationPause addr 0x26677d8 size 0x20 virtual false final false
 void OnApplicationPause() ;

/// @brief Method OnApplicationQuit addr 0x26677f8 size 0x20 virtual false final false
 void OnApplicationQuit() ;

// Ctor Parameters []
explicit OVRSpectatorModeDomeTest() ;

/// @brief Method .ctor addr 0x2667818 size 0x24 virtual false final false
 void _ctor() ;
