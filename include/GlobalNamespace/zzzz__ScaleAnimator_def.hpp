...
/// @brief Method OnDestroy addr 0x213d8bc size 0x88 virtual false final false
 void OnDestroy() ;

/// @brief Method InitIfNeeded addr 0x213d944 size 0x254 virtual false final false
 void InitIfNeeded() ;

/// @brief Method SetPositionAndRotation addr 0x213db98 size 0x78 virtual false final false
 void SetPositionAndRotation(UnityEngine::Vector3 position, UnityEngine::Quaternion rotation) ;

/// @brief Method HideInstant addr 0x213dc10 size 0xa8 virtual false final false
 void HideInstant() ;

/// @brief Method ShowInstant addr 0x213dcb8 size 0x70 virtual false final false
 void ShowInstant() ;

/// @brief Method Animate addr 0x213dd28 size 0xfc virtual false final false
 void Animate(bool show, float_t duration, GlobalNamespace::EaseType easeType, float_t delay) ;

// Ctor Parameters []
explicit ScaleAnimator() ;

/// @brief Method .ctor addr 0x213de24 size 0x10 virtual false final false
 void _ctor() ;

/// @brief Method <InitIfNeeded>b__7_0 addr 0x213de34 size 0x24 virtual false final false
 void _InitIfNeeded_b__7_0(float_t val) ;

/// @brief Method <InitIfNeeded>b__7_2 addr 0x213de58 size 0x2c virtual false final false
 void _InitIfNeeded_b__7_2() ;

/// @brief Method <InitIfNeeded>b__7_1 addr 0x213de84 size 0x24 virtual false final false
 void _InitIfNeeded_b__7_1(float_t val) ;

/// @brief Method <InitIfNeeded>b__7_3 addr 0x213dea8 size 0x2c virtual false final false
