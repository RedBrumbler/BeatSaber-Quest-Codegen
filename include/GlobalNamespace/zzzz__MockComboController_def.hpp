...
/// @brief Method add_comboDidChangeEvent addr 0x2146c04 size 0xb0 virtual true final true
 void add_comboDidChangeEvent(System::Action_1<int32_t> value) ;

/// @brief Method remove_comboDidChangeEvent addr 0x2146cb4 size 0xb0 virtual true final true
 void remove_comboDidChangeEvent(System::Action_1<int32_t> value) ;

/// @brief Method add_comboBreakingEventHappenedEvent addr 0x2146d64 size 0x9c virtual true final true
 void add_comboBreakingEventHappenedEvent(System::Action value) ;

/// @brief Method remove_comboBreakingEventHappenedEvent addr 0x2146e00 size 0x9c virtual true final true
 void remove_comboBreakingEventHappenedEvent(System::Action value) ;

// Ctor Parameters []
explicit MockComboController() ;

/// @brief Method .ctor addr 0x2146e9c size 0x8 virtual false final false
 void _ctor() ;
