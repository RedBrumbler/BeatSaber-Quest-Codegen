...
/// @brief Method StartQuery addr 0x2010ce8 size 0x274 virtual false final false
static void StartQuery() ;

/// @brief Method QueryHoudiniAsset addr 0x2010f5c size 0x1c0 virtual false final false
static HoudiniEngineUnity::HEU_HoudiniAsset QueryHoudiniAsset(UnityEngine::GameObject rootGO) ;

/// @brief Method CookAsset addr 0x201111c size 0x10 virtual false final false
static void CookAsset(HoudiniEngineUnity::HEU_HoudiniAsset houdiniAsset) ;

/// @brief Method ChangeParmsAndCook addr 0x201112c size 0x390 virtual false final false
static void ChangeParmsAndCook(HoudiniEngineUnity::HEU_HoudiniAsset houdiniAsset) ;

/// @brief Method QueryObjects addr 0x20114bc size 0x2dc virtual false final false
static void QueryObjects(HoudiniEngineUnity::HEU_HoudiniAsset houdiniAsset) ;

/// @brief Method QueryGeoParts addr 0x2011d3c size 0x42c virtual false final false
static void QueryGeoParts(HoudiniEngineUnity::HEU_SessionBase session, ByRef<HoudiniEngineUnity::HAPI_GeoInfo> geoInfo) ;

/// @brief Method QueryPartAttributeByOwner addr 0x2012168 size 0x284 virtual false final false
...
/// @brief Method QueryAttributeByStorageType addr 0x20123ec size 0x1d0 virtual false final false
...
/// @brief Method QueryAttribute addr 0x2011798 size 0x444 virtual false final false
...
/// @brief Method .ctor addr 0x2012830 size 0x8 virtual false final false
 void _ctor() ;
