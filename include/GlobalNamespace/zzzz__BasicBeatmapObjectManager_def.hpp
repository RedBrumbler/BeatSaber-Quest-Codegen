...
/// @brief Method .ctor addr 0x226a66c size 0x44 virtual false final false
...
/// @brief Method get_activeObstacleControllers addr 0x226883c size 0x50 virtual true final false
 System::Collections::Generic::List_1<GlobalNamespace::ObstacleController> get_activeObstacleControllers() ;

/// @brief Method Init addr 0x226888c size 0x5c0 virtual false final false
...
/// @brief Method ProcessObstacleData addr 0x2268e4c size 0xf4 virtual true final false
...
/// @brief Method DespawnInternal addr 0x22690d8 size 0x58 virtual true final false
 void DespawnInternal(GlobalNamespace::ObstacleController obstacleController) ;

/// @brief Method ProcessNoteData addr 0x2269130 size 0x3f8 virtual true final false
...
/// @brief Method DespawnInternal addr 0x2269a50 size 0x1f4 virtual true final false
 void DespawnInternal(GlobalNamespace::NoteController noteController) ;

/// @brief Method ProcessSliderData addr 0x2269c44 size 0x244 virtual true final false
...
/// @brief Method DespawnInternal addr 0x226a550 size 0x9c virtual true final false
 void DespawnInternal(GlobalNamespace::SliderController sliderNoteController) ;

// Ctor Parameters []
explicit BasicBeatmapObjectManager() ;

/// @brief Method .ctor addr 0x226a5ec size 0x4 virtual false final false
 void _ctor() ;
