...
/// @brief Method MoveNext addr 0x2222d7c size 0x220 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2222f9c size 0x58 virtual true final true
...
/// @brief Method MoveNext addr 0x2222ff4 size 0x220 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2223214 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method get_level addr 0x2222ac0 size 0x8 virtual true final true
 GlobalNamespace::IBeatmapLevel get_level() ;

/// @brief Method get_parentDifficultyBeatmapSet addr 0x2222ac8 size 0x8 virtual true final true
 GlobalNamespace::IDifficultyBeatmapSet get_parentDifficultyBeatmapSet() ;

/// @brief Method get_difficulty addr 0x2222ad0 size 0x8 virtual true final true
 GlobalNamespace::BeatmapDifficulty get_difficulty() ;

/// @brief Method get_difficultyRank addr 0x2222ad8 size 0x8 virtual true final true
 int32_t get_difficultyRank() ;

/// @brief Method get_noteJumpMovementSpeed addr 0x2222ae0 size 0x8 virtual true final true
 float_t get_noteJumpMovementSpeed() ;

/// @brief Method get_noteJumpStartBeatOffset addr 0x2222ae8 size 0x8 virtual true final true
 float_t get_noteJumpStartBeatOffset() ;

/// @brief Method get_environmentNameIdx addr 0x2222af0 size 0x8 virtual true final true
 int32_t get_environmentNameIdx() ;

/// @brief Method get_beatmapDataBasicInfo addr 0x2222af8 size 0x8 virtual false final false
 GlobalNamespace::IBeatmapDataBasicInfo get_beatmapDataBasicInfo() ;

/// @brief Method GetBeatmapDataBasicInfoAsync addr 0x2222b00 size 0xf0 virtual true final true
 System::Threading::Tasks::Task_1<GlobalNamespace::IBeatmapDataBasicInfo> GetBeatmapDataBasicInfoAsync() ;

/// @brief Method GetBeatmapDataAsync addr 0x2222bf0 size 0xf0 virtual true final true
...
/// @brief Method .ctor addr 0x2222ce0 size 0x9c virtual false final false
 void _ctor() ;
