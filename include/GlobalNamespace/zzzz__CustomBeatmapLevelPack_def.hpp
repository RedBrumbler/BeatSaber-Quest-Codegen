...
/// @brief Method get_packID addr 0x22216f4 size 0x8 virtual true final true
 ::StringW get_packID() ;

/// @brief Method get_packName addr 0x22216fc size 0x8 virtual true final true
 ::StringW get_packName() ;

/// @brief Method get_shortPackName addr 0x2221704 size 0x8 virtual true final true
 ::StringW get_shortPackName() ;

/// @brief Method get_collectionName addr 0x222170c size 0x8 virtual true final true
 ::StringW get_collectionName() ;

/// @brief Method get_coverImage addr 0x2221714 size 0x8 virtual true final true
 UnityEngine::Sprite get_coverImage() ;

/// @brief Method get_smallCoverImage addr 0x222171c size 0x8 virtual true final true
 UnityEngine::Sprite get_smallCoverImage() ;

/// @brief Method get_beatmapLevelCollection addr 0x2221724 size 0x8 virtual true final true
 GlobalNamespace::IBeatmapLevelCollection get_beatmapLevelCollection() ;

/// @brief Method get_isPackAlwaysOwned addr 0x222172c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2221734 size 0x54 virtual false final false
