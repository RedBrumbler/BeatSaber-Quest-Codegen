...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13915))}
...
/// @brief Method OnEnable addr 0x1fbf3a4 size 0x68 virtual true final false
 void OnEnable() ;

// Ctor Parameters []
explicit BoolWithDefaultValueSO() ;

/// @brief Method .ctor addr 0x1fbf40c size 0x4 virtual false final false
 void _ctor() ;
