...
/// @brief Method Awake addr 0x2661f68 size 0x194 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x26620fc size 0xe8 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x26621e4 size 0xd4 virtual false final false
 void Update() ;

/// @brief Method UpdateVisionMode addr 0x2662368 size 0xbc virtual false final false
 void UpdateVisionMode() ;

/// @brief Method UpdateSpeedAndRotationScaleMultiplier addr 0x2662424 size 0xc4 virtual false final false
 void UpdateSpeedAndRotationScaleMultiplier() ;

/// @brief Method UpdateRecenterPose addr 0x26622b8 size 0xb0 virtual false final false
 void UpdateRecenterPose() ;

// Ctor Parameters []
explicit OVRSceneSampleController() ;

/// @brief Method .ctor addr 0x26624e8 size 0x6c virtual false final false
 void _ctor() ;
