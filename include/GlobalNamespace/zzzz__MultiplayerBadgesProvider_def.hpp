...
/// @brief Method .ctor addr 0x21131f8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SelectBadgesAndPutThemIntoResults>b__7_0 addr 0x2113200 size 0x20 virtual false final false
 bool _SelectBadgesAndPutThemIntoResults_b__7_0(GlobalNamespace::MultiplayerPlayerResultsData result) ;

/// @brief Method <SelectBadgesAndPutThemIntoResults>b__7_1 addr 0x2113220 size 0x28 virtual false final false
...
/// @brief Method SelectBadgesAndPutThemIntoResults addr 0x2111ce8 size 0x14a4 virtual false final false
