...
/// @brief Method .ctor addr 0x2217210 size 0xc virtual false final false
...
/// @brief Method get_beatmapCharacteristic addr 0x22181cc size 0x8 virtual true final true
 GlobalNamespace::BeatmapCharacteristicSO get_beatmapCharacteristic() ;

/// @brief Method get_difficultyBeatmaps addr 0x22181d4 size 0x1c virtual true final true
...
/// @brief Method .ctor addr 0x2218158 size 0x74 virtual false final false
...
/// @brief Method get_audioClip addr 0x2218148 size 0x8 virtual true final true
 UnityEngine::AudioClip get_audioClip() ;

/// @brief Method get_difficultyBeatmapSets addr 0x2218150 size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0x2217f84 size 0x1c4 virtual false final false
...
/// @brief Method MoveNext addr 0x22181f8 size 0x268 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2218460 size 0x58 virtual true final true
...
/// @brief Method get_levelID addr 0x221721c size 0xa0 virtual true final true
 ::StringW get_levelID() ;

/// @brief Method get_songName addr 0x22172bc size 0xa4 virtual true final true
 ::StringW get_songName() ;

/// @brief Method get_songSubName addr 0x2217360 size 0xa4 virtual true final true
 ::StringW get_songSubName() ;

/// @brief Method get_songAuthorName addr 0x2217404 size 0xa4 virtual true final true
 ::StringW get_songAuthorName() ;

/// @brief Method get_levelAuthorName addr 0x22174a8 size 0xa4 virtual true final true
 ::StringW get_levelAuthorName() ;

/// @brief Method get_beatsPerMinute addr 0x221754c size 0xa4 virtual true final true
 float_t get_beatsPerMinute() ;

/// @brief Method get_songTimeOffset addr 0x22175f0 size 0xa4 virtual true final true
 float_t get_songTimeOffset() ;

/// @brief Method get_songDuration addr 0x2217694 size 0xa4 virtual true final true
 float_t get_songDuration() ;

/// @brief Method get_shuffle addr 0x2217738 size 0xa4 virtual true final true
 float_t get_shuffle() ;

/// @brief Method get_shufflePeriod addr 0x22177dc size 0xa4 virtual true final true
 float_t get_shufflePeriod() ;

/// @brief Method get_previewStartTime addr 0x2217880 size 0xa4 virtual true final true
 float_t get_previewStartTime() ;

/// @brief Method get_previewDuration addr 0x2217924 size 0xa4 virtual true final true
 float_t get_previewDuration() ;

/// @brief Method get_environmentInfo addr 0x22179c8 size 0xa4 virtual true final true
 GlobalNamespace::EnvironmentInfoSO get_environmentInfo() ;

/// @brief Method get_allDirectionsEnvironmentInfo addr 0x2217a6c size 0xa4 virtual true final true
 GlobalNamespace::EnvironmentInfoSO get_allDirectionsEnvironmentInfo() ;

/// @brief Method get_environmentInfos addr 0x2217b10 size 0xa4 virtual true final true
 ::ArrayW<GlobalNamespace::EnvironmentInfoSO> get_environmentInfos() ;

/// @brief Method get_previewDifficultyBeatmapSets addr 0x2217bb4 size 0xa4 virtual true final true
 System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::PreviewDifficultyBeatmapSet> get_previewDifficultyBeatmapSets() ;

/// @brief Method get_beatmapLevelData addr 0x2217c58 size 0x8 virtual true final true
 GlobalNamespace::IBeatmapLevelData get_beatmapLevelData() ;

/// @brief Method get_songPreviewAudioClip addr 0x2217c60 size 0xb4 virtual true final true
 UnityEngine::AudioClip get_songPreviewAudioClip() ;

/// @brief Method get_songPreviewAudioClipPath addr 0x2217d14 size 0xd4 virtual true final true
 ::StringW get_songPreviewAudioClipPath() ;

/// @brief Method GetCoverImageAsync addr 0x2217de8 size 0xfc virtual true final true
...
/// @brief Method .ctor addr 0x2217ee4 size 0x28 virtual false final false
 void _ctor(GlobalNamespace::IPreviewBeatmapLevel previewLevel) ;

/// @brief Method LoadData addr 0x2217f0c size 0x78 virtual false final false
...
/// @brief Method MoveNext addr 0x22184b8 size 0x36c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2218824 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method MoveNext addr 0x221887c size 0x38c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2218c08 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method .ctor addr 0x2218c60 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <LoadBeatmapLevelDataAsync>b__0 addr 0x2218c68 size 0x1b8 virtual false final false
...
/// @brief Method .ctor addr 0x2218e20 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <LoadBeatmapLevelDataAsync>b__1 addr 0x2218e28 size 0x134 virtual false final false
...
/// @brief Method MoveNext addr 0x2218f5c size 0x300 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x221925c size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method .ctor addr 0x2216dcc size 0x120 virtual false final false
 void _ctor(GlobalNamespace::BeatmapCharacteristicCollection allBeatmapCharacteristicCollection) ;

/// @brief Method LoadBeatmapLevelFormAssetBundleAsync addr 0x2216eec size 0x120 virtual false final false
...
/// @brief Method Dispose addr 0x221700c size 0xc virtual true final true
 void Dispose() ;

/// @brief Method LoadBeatmapLevelAsync addr 0x2217018 size 0xfc virtual false final false
 System::Threading::Tasks::Task_1<GlobalNamespace::IBeatmapLevel> LoadBeatmapLevelAsync(::StringW levelID) ;

/// @brief Method LoadBeatmapLevelDataAsync addr 0x2217114 size 0xfc virtual false final false
