...
/// @brief Method Awake addr 0x228cb84 size 0x10 virtual false final false
 void Awake() ;

/// @brief Method Emit addr 0x228cb94 size 0x110 virtual false final false
 void Emit(UnityEngine::Vector3 startPos, UnityEngine::Vector3 endPos, int32_t count) ;

// Ctor Parameters []
explicit NoteTrailParticleSystem() ;

/// @brief Method .ctor addr 0x228cca4 size 0x8 virtual false final false
 void _ctor() ;
