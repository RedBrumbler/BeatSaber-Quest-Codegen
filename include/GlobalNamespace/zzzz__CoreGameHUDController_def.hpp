...
/// @brief Method .ctor addr 0x22ae92c size 0x40 virtual false final false
...
/// @brief Method get_songProgressPanelGO addr 0x22ae858 size 0x8 virtual false final false
 UnityEngine::GameObject get_songProgressPanelGO() ;

/// @brief Method get_relativeScoreGo addr 0x22ae860 size 0x8 virtual false final false
 UnityEngine::GameObject get_relativeScoreGo() ;

/// @brief Method get_immediateRankGo addr 0x22ae868 size 0x8 virtual false final false
 UnityEngine::GameObject get_immediateRankGo() ;

/// @brief Method get_energyPanelGo addr 0x22ae870 size 0x8 virtual false final false
 UnityEngine::GameObject get_energyPanelGo() ;

/// @brief Method set_alpha addr 0x22ae878 size 0x1c virtual false final false
 void set_alpha(float_t value) ;

/// @brief Method Initialize addr 0x22ae894 size 0x90 virtual false final false
 void Initialize(GlobalNamespace::GlobalNamespace__CoreGameHUDController__InitData initData) ;

// Ctor Parameters []
explicit CoreGameHUDController() ;

/// @brief Method .ctor addr 0x22ae924 size 0x8 virtual false final false
 void _ctor() ;
