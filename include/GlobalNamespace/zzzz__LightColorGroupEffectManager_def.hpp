...
/// @brief Method get_lightGroups addr 0x2297780 size 0x8 virtual false final false
 System::Collections::Generic::IReadOnlyCollection_1<GlobalNamespace::LightGroup> get_lightGroups() ;

/// @brief Method Start addr 0x2297788 size 0x2a0 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2297a28 size 0x15c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleColorBoostBeatmapEvent addr 0x2297b84 size 0x15c virtual false final false
...
/// @brief Method .ctor addr 0x2297ce0 size 0x7c virtual false final false
 void _ctor() ;
