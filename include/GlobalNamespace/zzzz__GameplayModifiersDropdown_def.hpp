...
/// @brief Method .ctor addr 0x21848ec size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Start>b__8_0 addr 0x21848f4 size 0x44 virtual false final false
...
/// @brief Method add_didSelectCellWithIdxEvent addr 0x2183ee4 size 0xb0 virtual false final false
 void add_didSelectCellWithIdxEvent(System::Action_1<int32_t> value) ;

/// @brief Method remove_didSelectCellWithIdxEvent addr 0x2183f94 size 0xb0 virtual false final false
 void remove_didSelectCellWithIdxEvent(System::Action_1<int32_t> value) ;

/// @brief Method get_gameplayModifiersData addr 0x2184044 size 0x1c0 virtual false final false
...
/// @brief Method Start addr 0x2184204 size 0x1a0 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x21843a4 size 0xd4 virtual false final false
 void OnDestroy() ;

/// @brief Method GetSelectedGameplayModifierMask addr 0x2184478 size 0xd0 virtual false final false
 GlobalNamespace::GameplayModifierMask GetSelectedGameplayModifierMask() ;

/// @brief Method SelectCellWithGameplayModifierMask addr 0x2184548 size 0x30 virtual false final false
 void SelectCellWithGameplayModifierMask(GlobalNamespace::GameplayModifierMask gameplayModifierMask) ;

/// @brief Method GetIdxForGameplayModifierMask addr 0x2184578 size 0x184 virtual false final false
 int32_t GetIdxForGameplayModifierMask(GlobalNamespace::GameplayModifierMask gameplayModifierMask) ;

/// @brief Method HandleSimpleTextDropdownDidSelectCellWithIdx addr 0x21846fc size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x2184720 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <get_gameplayModifiersData>b__7_0 addr 0x2184728 size 0x160 virtual false final false
