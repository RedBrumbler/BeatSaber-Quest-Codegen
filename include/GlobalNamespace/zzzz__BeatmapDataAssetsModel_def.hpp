...
/// @brief Method BeatmapLevelDataAssetNameForBeatmapLevel addr 0x2216d6c size 0x4c virtual false final false
static ::StringW BeatmapLevelDataAssetNameForBeatmapLevel(::StringW levelID) ;

/// @brief Method AssetBundleNameForBeatmapLevel addr 0x2216db8 size 0x14 virtual false final false
