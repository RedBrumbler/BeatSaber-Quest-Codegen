...
/// @brief Method .ctor addr 0x2226d94 size 0xfc virtual false final false
 void _ctor(GlobalNamespace::PerceivedLoudnessPerLevelSO loudnessPerLeveData) ;

/// @brief Method ContainsLevelId addr 0x2226e90 size 0x58 virtual false final false
 bool ContainsLevelId(::StringW levelId) ;

/// @brief Method GetLoudnessCorrectionByLevelId addr 0x2226ee8 size 0x20 virtual false final false
 float_t GetLoudnessCorrectionByLevelId(::StringW levelId) ;

/// @brief Method GetMaxSfxVolumeByLevelId addr 0x2226f84 size 0x18 virtual false final false
 float_t GetMaxSfxVolumeByLevelId(::StringW levelId) ;

/// @brief Method GetLoudnessByLevelId addr 0x2226f08 size 0x7c virtual false final false
