...
/// @brief Method Start addr 0x22a4094 size 0x138 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x22a41cc size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleSpawnRotationBeatmapEvent addr 0x22a41e8 size 0x9c virtual false final false
 void HandleSpawnRotationBeatmapEvent(GlobalNamespace::SpawnRotationBeatmapEventData beatmapEventData) ;

/// @brief Method FixedUpdate addr 0x22a4284 size 0x90 virtual false final false
 void FixedUpdate() ;

/// @brief Method LateUpdate addr 0x22a4314 size 0xc0 virtual false final false
 void LateUpdate() ;
