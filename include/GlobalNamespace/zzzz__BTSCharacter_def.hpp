...
/// @brief Method get_characterName addr 0x20de3b8 size 0x8 virtual false final false
 ::StringW get_characterName() ;

/// @brief Method get_materialPropertyBlockController addr 0x20de3c0 size 0x8 virtual false final false
 GlobalNamespace::MaterialPropertyBlockController get_materialPropertyBlockController() ;

/// @brief Method get_animator addr 0x20de3c8 size 0x8 virtual false final false
 UnityEngine::Animator get_animator() ;

/// @brief Method get_headTransform addr 0x20de3d0 size 0x8 virtual false final false
 UnityEngine::Transform get_headTransform() ;

/// @brief Method SetAlternativeAnimationAndMaterial addr 0x20de3d8 size 0x1f4 virtual false final false
...
/// @brief Method .ctor addr 0x20de820 size 0x8 virtual false final false
 void _ctor() ;
