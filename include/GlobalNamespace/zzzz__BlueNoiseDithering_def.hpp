...
/// @brief Method SetBlueNoiseShaderParams addr 0x1fd3f78 size 0xec virtual false final false
 void SetBlueNoiseShaderParams(int32_t cameraPixelWidth, int32_t cameraPixelHeight) ;

// Ctor Parameters []
explicit BlueNoiseDithering() ;

/// @brief Method .ctor addr 0x1fd4064 size 0x8 virtual false final false
 void _ctor() ;
