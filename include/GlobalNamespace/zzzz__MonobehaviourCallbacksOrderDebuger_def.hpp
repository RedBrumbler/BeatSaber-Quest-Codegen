...
/// @brief Method Awake addr 0x1fb455c size 0xa4 virtual false final false
 void Awake() ;

/// @brief Method OnEnable addr 0x1fb4600 size 0xa4 virtual false final false
 void OnEnable() ;

/// @brief Method Start addr 0x1fb46a4 size 0xa4 virtual false final false
 void Start() ;

// Ctor Parameters []
explicit MonobehaviourCallbacksOrderDebuger() ;

/// @brief Method .ctor addr 0x1fb4748 size 0x8 virtual false final false
 void _ctor() ;
