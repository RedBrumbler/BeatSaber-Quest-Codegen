...
/// @brief Method MoveNext addr 0x2179218 size 0xae8 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2179d00 size 0xc virtual true final true
...
/// @brief Method MoveNext addr 0x2179d0c size 0x390 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x217a09c size 0xc virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method add_didFinishEvent addr 0x216ca48 size 0xb4 virtual false final false
 void add_didFinishEvent(System::Action_1<GlobalNamespace::MultiplayerModeSelectionFlowCoordinator> value) ;

/// @brief Method remove_didFinishEvent addr 0x216d1c4 size 0xb4 virtual false final false
 void remove_didFinishEvent(System::Action_1<GlobalNamespace::MultiplayerModeSelectionFlowCoordinator> value) ;

/// @brief Method Setup addr 0x2175f5c size 0x8 virtual false final false
 void Setup(GlobalNamespace::SelectMultiplayerLobbyDestination lobbyDestination) ;

/// @brief Method DidActivate addr 0x2175f64 size 0x4d8 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x21764d4 size 0x404 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method BackButtonWasPressed addr 0x21768d8 size 0xcc virtual true final false
 void BackButtonWasPressed(HMUI::ViewController topViewController) ;

/// @brief Method TopViewControllerWillChange addr 0x21769a4 size 0x24c virtual true final false
...
/// @brief Method TransitionDidStart addr 0x2176bf0 size 0x160 virtual true final false
 void TransitionDidStart() ;

/// @brief Method TransitionDidFinish addr 0x2176d50 size 0x284 virtual true final false
 void TransitionDidFinish() ;

/// @brief Method HandleMultiplayerLobbyConnectionControllerConnectionSuccessActivateModel addr 0x21775cc size 0x1c virtual false final false
 void HandleMultiplayerLobbyConnectionControllerConnectionSuccessActivateModel() ;

/// @brief Method HandleMultiplayerLobbyConnectionControllerConnectionSuccess addr 0x21775e8 size 0x4 virtual false final false
 void HandleMultiplayerLobbyConnectionControllerConnectionSuccess() ;

/// @brief Method HandleMultiplayerLobbyConnectionControllerConnectionFailed addr 0x21775ec size 0xc4 virtual false final false
...
/// @brief Method HandleMultiplayerLobbyControllerDidFinish addr 0x21776b0 size 0x5e0 virtual false final false
...
/// @brief Method HandleGameServerBrowserFlowCoordinatorDidFinish addr 0x2177c90 size 0x14 virtual false final false
 void HandleGameServerBrowserFlowCoordinatorDidFinish(GlobalNamespace::GameServerBrowserFlowCoordinator flowCoordinator) ;

/// @brief Method HandleJoiningLobbyViewControllerDidCancel addr 0x2177ca4 size 0xc4 virtual false final false
 void HandleJoiningLobbyViewControllerDidCancel() ;

/// @brief Method HandleJoinQuickPlayViewControllerDidFinish addr 0x2177d68 size 0x3ec virtual false final false
 void HandleJoinQuickPlayViewControllerDidFinish(bool success) ;

/// @brief Method HandleServerCodeEntryViewControllerDidFinish addr 0x2178154 size 0x124 virtual false final false
 void HandleServerCodeEntryViewControllerDidFinish(bool success, ::StringW code) ;

/// @brief Method HandleCreateServerViewControllerDidFinish addr 0x2178278 size 0x3c0 virtual false final false
 void HandleCreateServerViewControllerDidFinish(bool success, GlobalNamespace::CreateServerFormData data) ;

/// @brief Method HandleGameServerLobbyFlowCoordinatorDidFinish addr 0x2178638 size 0x258 virtual false final false
 void HandleGameServerLobbyFlowCoordinatorDidFinish() ;

/// @brief Method HandleGameServerLobbyFlowCoordinatorWillFinish addr 0x2178890 size 0x98 virtual false final false
 void HandleGameServerLobbyFlowCoordinatorWillFinish() ;

/// @brief Method HandleConnectedPlayerManagerCreated addr 0x2178928 size 0x1e8 virtual false final false
 void HandleConnectedPlayerManagerCreated(GlobalNamespace::INetworkPlayerModel networkPlayerModel) ;

/// @brief Method TryShowModeSelection addr 0x217643c size 0x98 virtual false final false
 void TryShowModeSelection(bool shouldProvideInitialViewControllers) ;

/// @brief Method ResolveAndPresentNextFlowCoordinator addr 0x2176fd4 size 0x94 virtual false final false
 void ResolveAndPresentNextFlowCoordinator() ;

/// @brief Method PresentConnectionErrorDialog addr 0x2177068 size 0x564 virtual false final false
...
/// @brief Method PresentMasterServerUnavailableErrorDialog addr 0x2178b10 size 0x44c virtual false final false
...
/// @brief Method ProcessDeeplinkingToLobby addr 0x2178f5c size 0xf4 virtual false final false
 void ProcessDeeplinkingToLobby() ;

// Ctor Parameters []
explicit MultiplayerModeSelectionFlowCoordinator() ;

/// @brief Method .ctor addr 0x2179050 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ResolveAndPresentNextFlowCoordinator>b__52_0 addr 0x2179058 size 0x170 virtual false final false
 void _ResolveAndPresentNextFlowCoordinator_b__52_0() ;

/// @brief Method <PresentConnectionErrorDialog>b__53_0 addr 0x21791c8 size 0x18 virtual false final false
 void _PresentConnectionErrorDialog_b__53_0(int32_t btnId) ;

/// @brief Method <PresentConnectionErrorDialog>b__53_1 addr 0x21791e0 size 0x18 virtual false final false
 void _PresentConnectionErrorDialog_b__53_1(int32_t btnId) ;

/// @brief Method <PresentMasterServerUnavailableErrorDialog>b__54_0 addr 0x21791f8 size 0x20 virtual false final false
