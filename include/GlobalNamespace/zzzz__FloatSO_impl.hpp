...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::FloatSO::*)()>(&GlobalNamespace::FloatSO::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x1fbf458;
...
// Ctor Parameters []
 GlobalNamespace::FloatSO::FloatSO()  : GlobalNamespace::ObservableVariableSO_1<float_t>(THROW_UNLESS(::il2cpp_utils::New<FloatSO>())) {}
