...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObstacleSaberSoundEffect::*)()>(&GlobalNamespace::ObstacleSaberSoundEffect::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x20f4a48;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ObstacleSaberSoundEffect>::get(),
                            "Awake",
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObstacleSaberSoundEffect::*)()>(&GlobalNamespace::ObstacleSaberSoundEffect::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x20f4b4c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObstacleSaberSoundEffect::*)()>(&GlobalNamespace::ObstacleSaberSoundEffect::LateUpdate)> {
  constexpr static std::size_t size = 0x104;
  constexpr static std::size_t addrs = 0x20f4c78;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObstacleSaberSoundEffect::*)(GlobalNamespace::SaberType)>(&GlobalNamespace::ObstacleSaberSoundEffect::HandleSparkleEffectDidStart)> {
  ...
  constexpr static std::size_t addrs = 0x20f4d7c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObstacleSaberSoundEffect::*)(GlobalNamespace::SaberType)>(&GlobalNamespace::ObstacleSaberSoundEffect::HandleSparkleEffecDidEnd)> {
  ...
  constexpr static std::size_t addrs = 0x20f4e44;

  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ObstacleSaberSoundEffect>::get(),
                            "HandleSparkleEffecDidEnd",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::SaberType>::get()}
                        )));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObstacleSaberSoundEffect::*)()>(&GlobalNamespace::ObstacleSaberSoundEffect::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x20f4e58;
...
::cordl_internals::setInstanceField<GlobalNamespace::ObstacleSaberSparkleEffectManager, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::ObstacleSaberSparkleEffectManager>(value));
}
constexpr GlobalNamespace::ObstacleSaberSparkleEffectManager GlobalNamespace::ObstacleSaberSoundEffect::__get__obstacleSaberSparkleEffectManager() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::ObstacleSaberSparkleEffectManager, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr GlobalNamespace::SaberType GlobalNamespace::ObstacleSaberSoundEffect::__get__saberType() const {
...
constexpr UnityEngine::AudioSource GlobalNamespace::ObstacleSaberSoundEffect::__get__audioSource() const {
...
constexpr float_t GlobalNamespace::ObstacleSaberSoundEffect::__get__volume() const {
...
constexpr float_t GlobalNamespace::ObstacleSaberSoundEffect::__get__targetVolume() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, saberType);
}
...
// Ctor Parameters []
 GlobalNamespace::ObstacleSaberSoundEffect::ObstacleSaberSoundEffect()  : UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<ObstacleSaberSoundEffect>())) {}
 void GlobalNamespace::ObstacleSaberSoundEffect::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ObstacleSaberSoundEffect>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
