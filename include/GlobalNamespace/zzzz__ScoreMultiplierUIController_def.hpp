...
/// @brief Method Start addr 0x22b10e8 size 0xe4 virtual false final false
 void Start() ;

/// @brief Method OnEnable addr 0x22b1368 size 0x4 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x22b136c size 0x4 virtual false final false
 void OnDisable() ;

/// @brief Method RegisterForEvents addr 0x22b11cc size 0x19c virtual false final false
 void RegisterForEvents() ;

/// @brief Method UnregisterFromEvents addr 0x22b1370 size 0x108 virtual false final false
 void UnregisterFromEvents() ;

/// @brief Method Update addr 0x22b1478 size 0x80 virtual false final false
 void Update() ;

/// @brief Method HandleMultiplierDidChange addr 0x22b14f8 size 0xcc virtual false final false
 void HandleMultiplierDidChange(int32_t multiplier, float_t progress) ;

// Ctor Parameters []
explicit ScoreMultiplierUIController() ;

/// @brief Method .ctor addr 0x22b15c4 size 0x8 virtual false final false
 void _ctor() ;
