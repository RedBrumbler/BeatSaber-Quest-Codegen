...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5242))}
...
/// @brief Method add_cubeNoteControllerDidInitEvent addr 0x2119a88 size 0xb0 virtual true final true
...
/// @brief Method remove_cubeNoteControllerDidInitEvent addr 0x2119b38 size 0xb0 virtual true final true
...
/// @brief Method get_noteMovement addr 0x2119be8 size 0x8 virtual true final true
 GlobalNamespace::NoteMovement get_noteMovement() ;

/// @brief Method get_gameplayType addr 0x2119bf0 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__NoteData__GameplayType get_gameplayType() ;

/// @brief Method get_noteVisualModifierType addr 0x2119bf8 size 0x8 virtual true final true
 GlobalNamespace::NoteVisualModifierType get_noteVisualModifierType() ;

/// @brief Method Init addr 0x2115adc size 0x118 virtual false final false
...
/// @brief Method .ctor addr 0x2119c00 size 0x8 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11011)), TypeDefinitionIndex(TypeDefinitionIndex(5241)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 340 })}
...
/// @brief Method .ctor addr 0x2119c08 size 0x48 virtual false final false
 void _ctor() ;
