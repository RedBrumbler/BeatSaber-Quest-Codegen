...
/// @brief Method Awake addr 0x2139e34 size 0x1b0 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x2139fe4 size 0x88 virtual false final false
 void OnDestroy() ;

/// @brief Method SetPositionAndRotation addr 0x213a06c size 0x78 virtual false final false
 void SetPositionAndRotation(UnityEngine::Vector3 position, UnityEngine::Quaternion rotation) ;

/// @brief Method AnimateColors addr 0x213a0e4 size 0x114 virtual false final false
...
/// @brief Method SetName addr 0x213a1f8 size 0x24 virtual false final false
 void SetName(::StringW text) ;

/// @brief Method SetScore addr 0x213a21c size 0x24 virtual false final false
 void SetScore(::StringW text) ;

// Ctor Parameters []
explicit MultiplayerScoreItem() ;

/// @brief Method .ctor addr 0x213a240 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__5_0 addr 0x213a248 size 0x24 virtual false final false
 void _Awake_b__5_0(UnityEngine::Color val) ;

/// @brief Method <Awake>b__5_1 addr 0x213a26c size 0x24 virtual false final false
