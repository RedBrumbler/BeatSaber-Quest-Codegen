...
/// @brief Method SetPagesCount addr 0x21c56cc size 0x3d0 virtual false final false
 void SetPagesCount(int32_t pagesCount) ;

/// @brief Method SetSelectedPageIndex addr 0x21c5b00 size 0xc8 virtual false final false
 void SetSelectedPageIndex(int32_t page) ;

/// @brief Method SetVisible addr 0x21c5bc8 size 0x30 virtual false final false
 void SetVisible(bool isVisible) ;

// Ctor Parameters []
explicit PageControl() ;

/// @brief Method .ctor addr 0x21c5bf8 size 0xd0 virtual false final false
 void _ctor() ;
