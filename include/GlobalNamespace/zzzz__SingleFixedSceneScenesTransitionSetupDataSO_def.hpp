...
/// @brief Method get_sceneInfo addr 0x1fbe788 size 0x8 virtual false final false
 GlobalNamespace::SceneInfo get_sceneInfo() ;

/// @brief Method Init addr 0x1fbe12c size 0xf0 virtual false final false
 void Init(GlobalNamespace::SceneSetupData sceneSetupData) ;

// Ctor Parameters []
explicit SingleFixedSceneScenesTransitionSetupDataSO() ;

/// @brief Method .ctor addr 0x1fbe224 size 0x8 virtual false final false
 void _ctor() ;
