...
/// @brief Method get_maxPartySize addr 0xdb436c size 0x8 virtual true final true
 int32_t get_maxPartySize() ;

/// @brief Method get_discoveryPort addr 0xdb4374 size 0x8 virtual true final true
 int32_t get_discoveryPort() ;

/// @brief Method get_partyPort addr 0xdb437c size 0x8 virtual true final true
 int32_t get_partyPort() ;

/// @brief Method get_multiplayerPort addr 0xdb4384 size 0x8 virtual true final true
 int32_t get_multiplayerPort() ;

/// @brief Method get_masterServerEndPoint addr 0xdb438c size 0x8 virtual true final true
 GlobalNamespace::DnsEndPoint get_masterServerEndPoint() ;

/// @brief Method get_multiplayerStatusUrl addr 0xdb4394 size 0x8 virtual true final true
 ::StringW get_multiplayerStatusUrl() ;

/// @brief Method get_quickPlaySetupUrl addr 0xdb439c size 0x48 virtual true final true
 ::StringW get_quickPlaySetupUrl() ;

/// @brief Method get_graphUrl addr 0xdb43e4 size 0x8 virtual true final true
 ::StringW get_graphUrl() ;

/// @brief Method get_graphAccessToken addr 0xdb43ec size 0x8 virtual true final true
 ::StringW get_graphAccessToken() ;

/// @brief Method get_forceGameLift addr 0xdb43f4 size 0x8 virtual true final true
 bool get_forceGameLift() ;

/// @brief Method get_serviceEnvironment addr 0xdb43fc size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0xdb4404 size 0x4a0 virtual false final false
