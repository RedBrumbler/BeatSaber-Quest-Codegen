...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14655))}
...
/// @brief Method add_didRefreshEvent addr 0x1fd2c88 size 0x9c virtual false final false
 void add_didRefreshEvent(System::Action value) ;

/// @brief Method remove_didRefreshEvent addr 0x1fd2d24 size 0x9c virtual false final false
 void remove_didRefreshEvent(System::Action value) ;

/// @brief Method get_colorAlphaMultiplier addr 0x1fd2dc0 size 0x8 virtual false final false
 float_t get_colorAlphaMultiplier() ;

/// @brief Method get_center addr 0x1fd2dc8 size 0x8 virtual false final false
 float_t get_center() ;

/// @brief Method get_isDirty addr 0x1fd2dd0 size 0x20 virtual true final false
 bool get_isDirty() ;

/// @brief Method MarkDirty addr 0x1fd2df0 size 0xc virtual false final false
 void MarkDirty() ;

/// @brief Method get_length addr 0x1fd2dfc size 0x8 virtual false final false
 float_t get_length() ;

/// @brief Method set_length addr 0x1fd2e04 size 0x10 virtual false final false
 void set_length(float_t value) ;

/// @brief Method get_width addr 0x1fd2e14 size 0x8 virtual false final false
 float_t get_width() ;

/// @brief Method set_width addr 0x1fd2e1c size 0x10 virtual false final false
 void set_width(float_t value) ;

/// @brief Method get_lightWidthMultiplier addr 0x1fd2e2c size 0x8 virtual false final false
 float_t get_lightWidthMultiplier() ;

/// @brief Method set_lightWidthMultiplier addr 0x1fd2e34 size 0x8 virtual false final false
 void set_lightWidthMultiplier(float_t value) ;

/// @brief Method get_bloomFogIntensityMultiplier addr 0x1fd2e3c size 0x8 virtual false final false
 float_t get_bloomFogIntensityMultiplier() ;

/// @brief Method set_bloomFogIntensityMultiplier addr 0x1fd2e44 size 0x8 virtual false final false
 void set_bloomFogIntensityMultiplier(float_t value) ;

/// @brief Method set_color addr 0x1fd2e4c size 0x118 virtual false final false
 void set_color(UnityEngine::Color value) ;

/// @brief Method get_color addr 0x1fd2f64 size 0xc virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method OnEnable addr 0x1fd2f70 size 0x20 virtual true final false
 void OnEnable() ;

/// @brief Method DidRegisterLight addr 0x1fd2f90 size 0x1c virtual true final false
 void DidRegisterLight() ;

/// @brief Method Refresh addr 0x1fd2fac size 0x33c virtual true final false
 void Refresh() ;

/// @brief Method FillMeshData addr 0x1fd32e8 size 0x9e8 virtual true final false
...
/// @brief Method ClipPoints addr 0x1fd3cd0 size 0x94 virtual false final false
...
/// @brief Method OnDrawGizmos addr 0x1fd3d64 size 0x13c virtual false final false
 void OnDrawGizmos() ;

// Ctor Parameters []
explicit TubeBloomPrePassLight() ;

/// @brief Method .ctor addr 0x1fd3ea0 size 0xd8 virtual false final false
 void _ctor() ;
