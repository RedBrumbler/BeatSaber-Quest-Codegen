...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4861)), TypeDefinitionIndex(TypeDefinitionIndex(10185))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4861), inst: 2 })
