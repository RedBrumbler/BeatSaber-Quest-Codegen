...
/// @brief Method .ctor addr 0x21aa83c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <RefreshContent>b__0 addr 0x21aa84c size 0x7c virtual false final false
...
/// @brief Method Setup addr 0x21aa67c size 0x2c virtual false final false
 void Setup(GlobalNamespace::GameplayModifiers gameplayModifiers) ;

/// @brief Method DidActivate addr 0x21aa838 size 0x4 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method RefreshContent addr 0x21aa6a8 size 0x190 virtual false final false
 void RefreshContent() ;

// Ctor Parameters []
explicit MissionLevelModifiersViewController() ;

/// @brief Method .ctor addr 0x21aa844 size 0x8 virtual false final false
 void _ctor() ;
