...
/// @brief Method SaveConfig addr 0x1fb0bc0 size 0x430 virtual false final false
static void SaveConfig(::bs_hook::Il2CppWrapperType config, ::StringW filePath) ;

/// @brief Method LoadConfig addr 0x1fb0ff0 size 0x560 virtual false final false
static bool LoadConfig(::bs_hook::Il2CppWrapperType config, ::StringW filePath) ;

// Ctor Parameters []
explicit ConfigSerializer() ;

/// @brief Method .ctor addr 0x1fb1550 size 0x8 virtual false final false
 void _ctor() ;
