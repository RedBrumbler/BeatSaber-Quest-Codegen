...
/// @brief Method get_offsetSyncTime addr 0xdb5930 size 0x8 virtual true final true
 float_t get_offsetSyncTime() ;

/// @brief Method get_isFailed addr 0xdb5938 size 0x8 virtual false final false
 bool get_isFailed() ;

/// @brief Method get_isMe addr 0xdb5940 size 0x8 virtual true final true
 bool get_isMe() ;

/// @brief Method get_userId addr 0xdb5948 size 0x8 virtual true final true
 ::StringW get_userId() ;

/// @brief Method set_userId addr 0xdb5950 size 0x8 virtual false final false
 void set_userId(::StringW value) ;

/// @brief Method get_userName addr 0xdb5958 size 0x8 virtual true final true
 ::StringW get_userName() ;

/// @brief Method set_userName addr 0xdb5960 size 0x8 virtual false final false
 void set_userName(::StringW value) ;

/// @brief Method get_hasValidLatency addr 0xdb5968 size 0x8 virtual true final true
 bool get_hasValidLatency() ;

/// @brief Method get_currentLatency addr 0xdb5970 size 0x8 virtual true final true
 float_t get_currentLatency() ;

/// @brief Method get_isConnected addr 0xdb5978 size 0x8 virtual true final true
 bool get_isConnected() ;

/// @brief Method get_disconnectedReason addr 0xdb5980 size 0x8 virtual true final true
 GlobalNamespace::DisconnectedReason get_disconnectedReason() ;

/// @brief Method get_isConnectionOwner addr 0xdb5988 size 0x8 virtual true final true
 bool get_isConnectionOwner() ;

/// @brief Method get_sortIndex addr 0xdb5990 size 0x8 virtual true final true
 int32_t get_sortIndex() ;

/// @brief Method get_multiplayerAvatarData addr 0xdb5998 size 0x10 virtual true final true
 GlobalNamespace::MultiplayerAvatarData get_multiplayerAvatarData() ;

/// @brief Method get_isKicked addr 0xdb59a8 size 0x8 virtual true final true
 bool get_isKicked() ;

/// @brief Method HasState addr 0xdb59b0 size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0xdb59b8 size 0x5c virtual false final false
