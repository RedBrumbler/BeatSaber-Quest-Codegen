...
/// @brief Method add_didFinishEvent addr 0x21add28 size 0xb0 virtual false final false
 void add_didFinishEvent(System::Action_1<bool> value) ;

/// @brief Method remove_didFinishEvent addr 0x21addd8 size 0xb0 virtual false final false
 void remove_didFinishEvent(System::Action_1<bool> value) ;

/// @brief Method get_multiplayerModeSettings addr 0x21ade88 size 0x8 virtual false final false
 GlobalNamespace::MultiplayerModeSettings get_multiplayerModeSettings() ;

/// @brief Method Setup addr 0x21ade90 size 0x90 virtual false final false
...
/// @brief Method DidActivate addr 0x21adf20 size 0x128 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method ButtonPressed addr 0x21ae048 size 0x8c virtual false final false
 void ButtonPressed(bool success) ;

// Ctor Parameters []
explicit JoinQuickPlayViewController() ;

/// @brief Method .ctor addr 0x21ae0d4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__12_0 addr 0x21ae0dc size 0x8 virtual false final false
 void _DidActivate_b__12_0() ;

/// @brief Method <DidActivate>b__12_1 addr 0x21ae0e4 size 0x8 virtual false final false
