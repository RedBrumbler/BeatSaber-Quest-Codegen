...
struct CORDL_TYPE GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "LeftHandTransform", ty: "UnityEngine::Transform", modifiers: "", def_value: None }, CppParam { name: "LeftPresenceTransform", ty: "UnityEngine::Transform", modifiers: "", def_value: None }, CppParam { name: "RightHandTransform", ty: "UnityEngine::Transform", modifiers: "", def_value: None }, CppParam { name: "RightPresenceTransform", ty: "UnityEngine::Transform", modifiers: "", def_value: None }, CppParam { name: "BoneName", ty: "GlobalNamespace::GlobalNamespace__OVRSkeleton__BoneId", modifiers: "", def_value: None }, CppParam { name: "HandPresenceLeftBoneName", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "HandPresenceRightBoneName", ty: "::StringW", modifiers: "", def_value: None }]
constexpr GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping(UnityEngine::Transform LeftHandTransform, UnityEngine::Transform LeftPresenceTransform, UnityEngine::Transform RightHandTransform, UnityEngine::Transform RightPresenceTransform, GlobalNamespace::GlobalNamespace__OVRSkeleton__BoneId BoneName, ::StringW HandPresenceLeftBoneName, ::StringW HandPresenceRightBoneName) noexcept;


                    constexpr GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping(GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping const&) = default;
                    constexpr GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping(GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping&&) = default;
                    constexpr GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping& operator=(GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping& operator=(GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping&& o) noexcept {
...
constexpr explicit GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr UnityEngine::Transform __get_RightPresenceTransform() const;
 ...
 GlobalNamespace::GlobalNamespace__OVRSkeleton__BoneId __declspec(property(get=__get_BoneName, put=__set_BoneName))  BoneName;

constexpr void __set_BoneName(GlobalNamespace::GlobalNamespace__OVRSkeleton__BoneId value) ;

constexpr GlobalNamespace::GlobalNamespace__OVRSkeleton__BoneId __get_BoneName() const;
...
struct CORDL_TYPE GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent(bool leftVisible, bool rightVisible) noexcept;


                    constexpr GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent(GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent const&) = default;
                    constexpr GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent(GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent&&) = default;
                    constexpr GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent& operator=(GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent& operator=(GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
public:
// Declarations
using TrackedKeyboardHandsVisibilityChangedEvent = GlobalNamespace::GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent;

using HandBoneMapping = GlobalNamespace::GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping;
...
static float_t __get_minimumModelHandsDistance_() ;
 ...
 System::Nullable_1<GlobalNamespace::GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent> __declspec(property(get=__get_lastVisibilityEvent_, put=__set_lastVisibilityEvent_))  lastVisibilityEvent_;

constexpr void __set_lastVisibilityEvent_(System::Nullable_1<GlobalNamespace::GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent> value) ;

constexpr System::Nullable_1<GlobalNamespace::GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent> __get_lastVisibilityEvent_() const;

 ::ArrayW<GlobalNamespace::GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping> __declspec(property(get=__get_boneMappings_, put=__set_boneMappings_))  boneMappings_;

constexpr void __set_boneMappings_(::ArrayW<GlobalNamespace::GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping> value) ;

constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping> __get_boneMappings_() const;
...
/// @brief Method get_RightHandOverKeyboard addr 0x2646edc size 0x8 virtual false final false
 bool get_RightHandOverKeyboard() ;

/// @brief Method set_RightHandOverKeyboard addr 0x2646ee4 size 0xc virtual false final false
 void set_RightHandOverKeyboard(bool value) ;

/// @brief Method get_LeftHandOverKeyboard addr 0x2646ef0 size 0x8 virtual false final false
 bool get_LeftHandOverKeyboard() ;

/// @brief Method set_LeftHandOverKeyboard addr 0x2646ef8 size 0xc virtual false final false
 void set_LeftHandOverKeyboard(bool value) ;

/// @brief Method Awake addr 0x2646f04 size 0x1e4 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x26470e8 size 0x290 virtual false final false
 void Start() ;

/// @brief Method get_AreControllersActive addr 0x26474e8 size 0x3c virtual false final false
 bool get_AreControllersActive() ;

/// @brief Method LateUpdate addr 0x2647524 size 0x7e0 virtual false final false
 void LateUpdate() ;

/// @brief Method ShouldEnablePassthrough addr 0x26480cc size 0x6c virtual false final false
 bool ShouldEnablePassthrough(float_t distance) ;

/// @brief Method ShouldEnableModel addr 0x2648138 size 0x6c virtual false final false
 bool ShouldEnableModel(float_t distance) ;

/// @brief Method GetHandDistanceToKeyboard addr 0x2647df0 size 0x2dc virtual false final false
 float_t GetHandDistanceToKeyboard(GlobalNamespace::OVRSkeleton handSkeleton) ;

/// @brief Method ComputeOpacity addr 0x26483ac size 0x24 virtual false final false
 float_t ComputeOpacity(float_t distance, float_t innerThreshold, float_t outerThreshold) ;

/// @brief Method SetHandModelsEnabled addr 0x26481a4 size 0x208 virtual false final false
 void SetHandModelsEnabled(bool enableLeftModel, bool enableRightModel) ;

/// @brief Method RetargetHandTrackingToHandPresence addr 0x2647378 size 0x170 virtual false final false
 void RetargetHandTrackingToHandPresence() ;

/// @brief Method StopHandPresence addr 0x26483d0 size 0x30 virtual false final false
 void StopHandPresence() ;

/// @brief Method DisableHandObjects addr 0x2647d04 size 0xec virtual false final false
 void DisableHandObjects() ;

/// @brief Method TrackedKeyboardActiveUpdated addr 0x2648400 size 0xc virtual false final false
 void TrackedKeyboardActiveUpdated(GlobalNamespace::GlobalNamespace__OVRTrackedKeyboard__TrackedKeyboardSetActiveEvent e) ;

/// @brief Method TrackedKeyboardVisibilityChanged addr 0x264840c size 0x1b0 virtual false final false
...
/// @brief Method .ctor addr 0x26485bc size 0x750 virtual false final false
 void _ctor() ;
...
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OVRTrackedKeyboardHands__HandBoneMapping, "", "OVRTrackedKeyboardHands/HandBoneMapping");
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__OVRTrackedKeyboardHands__TrackedKeyboardHandsVisibilityChangedEvent, "", "OVRTrackedKeyboardHands/TrackedKeyboardHandsVisibilityChangedEvent");
