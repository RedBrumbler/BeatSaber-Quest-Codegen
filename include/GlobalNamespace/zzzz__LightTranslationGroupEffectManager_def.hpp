...
/// @brief Method Start addr 0x229a76c size 0x3f4 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x229ab60 size 0x148 virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit LightTranslationGroupEffectManager() ;

/// @brief Method .ctor addr 0x229aca8 size 0x7c virtual false final false
 void _ctor() ;
