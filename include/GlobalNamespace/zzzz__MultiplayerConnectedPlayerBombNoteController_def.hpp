...
/// @brief Method Init addr 0x2115a84 size 0x58 virtual false final false
...
/// @brief Method .ctor addr 0x21199bc size 0x8 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 2719 }), TypeDefinitionIndex(TypeDefinitionIndex(5238)), TypeDefinitionIndex(TypeDefinitionIndex(11011))}
...
/// @brief Method .ctor addr 0x21199cc size 0x48 virtual false final false
 void _ctor() ;
