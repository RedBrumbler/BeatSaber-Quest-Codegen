...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13757))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13757), inst: 2 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13757))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13757), inst: 394 })
// CS Name: FixedUpdateSmoothValue`1
