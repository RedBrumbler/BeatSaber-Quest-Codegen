...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4560)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4560), inst: 3703 }), TypeDefinitionIndex(TypeDefinitionIndex(4562))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4562), inst: 4987 })
...
template<>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4560), inst: 3703 }), TypeDefinitionIndex(TypeDefinitionIndex(4562)), TypeDefinitionIndex(TypeDefinitionIndex(4560))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4562), inst: 4988 })
// CS Name: RemoteMultiplayerSyncState`3
