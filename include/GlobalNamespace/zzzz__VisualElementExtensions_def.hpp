...
/// @brief Method RemoveAllChildren addr 0x28ad564 size 0x50 virtual false final false
static void RemoveAllChildren(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method GetChildren addr 0x28ad5b4 size 0x144 virtual false final false
...
/// @brief Method IsHidden addr 0x28ad6f8 size 0xfc virtual false final false
static bool IsHidden(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method Hide addr 0x28ad7f4 size 0xdc virtual false final false
static void Hide(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method Show addr 0x28ad8d0 size 0xdc virtual false final false
static void Show(UnityEngine::UIElements::VisualElement ve) ;

/// @brief Method ToggleDisplay addr 0x28ad9ac size 0x124 virtual false final false
