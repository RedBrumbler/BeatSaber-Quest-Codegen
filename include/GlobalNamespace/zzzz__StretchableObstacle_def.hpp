...
/// @brief Method get_bounds addr 0x2280910 size 0x14 virtual false final false
 UnityEngine::Bounds get_bounds() ;

/// @brief Method SetSizeAndColor addr 0x227de60 size 0x3e4 virtual false final false
 void SetSizeAndColor(float_t width, float_t height, float_t length, UnityEngine::Color color) ;

/// @brief Method OnValidate addr 0x2280924 size 0x6c virtual false final false
 void OnValidate() ;

// Ctor Parameters []
explicit StretchableObstacle() ;

/// @brief Method .ctor addr 0x2280990 size 0x34 virtual false final false
 void _ctor() ;
