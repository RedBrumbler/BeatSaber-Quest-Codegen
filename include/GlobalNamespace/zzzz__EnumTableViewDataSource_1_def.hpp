...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4803)), TypeDefinitionIndex(TypeDefinitionIndex(10185))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4803), inst: 2 })
