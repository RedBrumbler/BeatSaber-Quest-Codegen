...
/// @brief Method SetRandomValueToShaders addr 0x1fd43b8 size 0x8c virtual false final false
 void SetRandomValueToShaders() ;

// Ctor Parameters []
explicit RandomValueToShader() ;

/// @brief Method .ctor addr 0x1fd444c size 0x10 virtual false final false
 void _ctor() ;
