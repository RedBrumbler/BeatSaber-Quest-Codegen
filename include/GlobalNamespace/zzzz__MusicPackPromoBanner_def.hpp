...
/// @brief Method get_currentPromoBeatmapLevel addr 0x21c54d8 size 0x8 virtual false final false
 GlobalNamespace::IPreviewBeatmapLevel get_currentPromoBeatmapLevel() ;

/// @brief Method get_currentPromoMusicPack addr 0x21c54e0 size 0x8 virtual false final false
 GlobalNamespace::IBeatmapLevelPack get_currentPromoMusicPack() ;

/// @brief Method get_promoButtonText addr 0x21c54e8 size 0x8 virtual false final false
 ::StringW get_promoButtonText() ;

/// @brief Method Setup addr 0x21c54f0 size 0x108 virtual false final false
...
/// @brief Method .ctor addr 0x21c55f8 size 0x8 virtual false final false
 void _ctor() ;
