...
/// @brief Method get_musicVolumeMultiplier addr 0x20f1788 size 0x8 virtual false final false
 float_t get_musicVolumeMultiplier() ;

/// @brief Method get_threshold addr 0x20f1790 size 0x8 virtual false final false
 float_t get_threshold() ;

/// @brief Method get_impact addr 0x20f1798 size 0x8 virtual false final false
 float_t get_impact() ;

/// @brief Method get_attackTime addr 0x20f17a0 size 0x8 virtual false final false
 float_t get_attackTime() ;

/// @brief Method get_releaseTime addr 0x20f17a8 size 0x8 virtual false final false
 float_t get_releaseTime() ;

/// @brief Method get_minVolume addr 0x20f17b0 size 0x8 virtual false final false
 float_t get_minVolume() ;

/// @brief Method get_maxVolume addr 0x20f17b8 size 0x8 virtual false final false
 float_t get_maxVolume() ;

/// @brief Method get_volumeSmooth addr 0x20f17c0 size 0x8 virtual false final false
 float_t get_volumeSmooth() ;

// Ctor Parameters []
explicit AutomaticSFXVolumeParamsSO() ;

/// @brief Method .ctor addr 0x20f17c8 size 0x20 virtual false final false
 void _ctor() ;
