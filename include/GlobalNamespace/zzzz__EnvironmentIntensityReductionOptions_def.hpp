...
/// @brief Method get_compressExpand addr 0x21f5794 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__EnvironmentIntensityReductionOptions__CompressExpandReductionType get_compressExpand() ;

/// @brief Method get_rotateRings addr 0x21f579c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x21f57a4 size 0x8 virtual false final false
 void _ctor() ;
