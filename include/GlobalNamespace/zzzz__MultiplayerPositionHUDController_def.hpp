...
/// @brief Method set_alpha addr 0x22b07c4 size 0x1c virtual false final false
 void set_alpha(float_t value) ;

/// @brief Method Start addr 0x22b07e0 size 0x15c virtual false final false
 void Start() ;

/// @brief Method Update addr 0x22b093c size 0x1b0 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit MultiplayerPositionHUDController() ;

/// @brief Method .ctor addr 0x22b0aec size 0x10 virtual false final false
 void _ctor() ;
