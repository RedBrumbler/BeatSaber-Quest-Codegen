...
/// @brief Method Start addr 0x20f64a0 size 0x210 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x20f66f4 size 0x1a4 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleInputFocusCaptured addr 0x20f66b0 size 0x44 virtual false final false
 void HandleInputFocusCaptured() ;

/// @brief Method HandleInputFocusReleased addr 0x20f6898 size 0x44 virtual false final false
 void HandleInputFocusReleased() ;

// Ctor Parameters []
explicit SongPreviewPlayerPauseOnInputFocusLost() ;

/// @brief Method .ctor addr 0x20f68dc size 0x8 virtual false final false
 void _ctor() ;
