...
/// @brief Method get_intensity addr 0x1fd8df0 size 0x8 virtual false final false
 float_t get_intensity() ;

/// @brief Method get_probeHighlightsIntensityMultiplier addr 0x1fd8df8 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x1fd8e00 size 0x44 virtual false final false
...
/// @brief Method get_intensity addr 0x1fd87a8 size 0x8 virtual false final false
 float_t get_intensity() ;

/// @brief Method set_intensity addr 0x1fd87b0 size 0x8 virtual false final false
 void set_intensity(float_t value) ;

/// @brief Method get_normalizerWeight addr 0x1fd87b8 size 0x8 virtual false final false
 float_t get_normalizerWeight() ;

/// @brief Method set_normalizerWeight addr 0x1fd87c0 size 0x8 virtual false final false
 void set_normalizerWeight(float_t value) ;

/// @brief Method get_calculatedColorPreNormalization addr 0x1fd87c8 size 0xc virtual false final false
 UnityEngine::Color get_calculatedColorPreNormalization() ;

/// @brief Method get_bakeId addr 0x1fd87d4 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__LightConstants__BakeId get_bakeId() ;

/// @brief Method Awake addr 0x1fd87dc size 0x58 virtual true final false
 void Awake() ;

/// @brief Method ProcessNewColorData addr 0x1fd8a34 size 0x39c virtual true final false
 void ProcessNewColorData() ;

/// @brief Method GetLightWithIds addr 0x1fd8dd0 size 0x8 virtual true final false
 System::Collections::Generic::IEnumerable_1<GlobalNamespace::GlobalNamespace__LightWithIds__LightWithId> GetLightWithIds() ;

/// @brief Method SetDataToShaders addr 0x1fd89e0 size 0x54 virtual false final false
 void SetDataToShaders(UnityEngine::Color lightmapColor, UnityEngine::Color probeColor) ;

/// @brief Method SetShaderProperties addr 0x1fd88f8 size 0xe8 virtual false final false
 void SetShaderProperties() ;

/// @brief Method GetBakedLightsNormalizer addr 0x1fd886c size 0x8c virtual false final false
 void GetBakedLightsNormalizer() ;

// Ctor Parameters []
explicit LightmapLightWithIds() ;

/// @brief Method .ctor addr 0x1fd8dd8 size 0x18 virtual false final false
 void _ctor() ;
