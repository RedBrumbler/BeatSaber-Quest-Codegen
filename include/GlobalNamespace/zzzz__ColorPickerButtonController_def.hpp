...
/// @brief Method get_button addr 0x215a288 size 0x8 virtual false final false
 UnityEngine::UI::Button get_button() ;

/// @brief Method SetColor addr 0x215a290 size 0x28 virtual false final false
 void SetColor(UnityEngine::Color color) ;

// Ctor Parameters []
explicit ColorPickerButtonController() ;

/// @brief Method .ctor addr 0x215a2b8 size 0x8 virtual false final false
 void _ctor() ;
