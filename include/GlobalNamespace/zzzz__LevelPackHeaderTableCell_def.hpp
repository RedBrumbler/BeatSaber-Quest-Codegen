...
/// @brief Method SetData addr 0x215de8c size 0x24 virtual false final false
 void SetData(::StringW headerText) ;

/// @brief Method SelectionDidChange addr 0x215deb0 size 0x4 virtual true final false
 void SelectionDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method HighlightDidChange addr 0x215df50 size 0x4 virtual true final false
 void HighlightDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method RefreshVisuals addr 0x215deb4 size 0x9c virtual false final false
 void RefreshVisuals() ;

// Ctor Parameters []
explicit LevelPackHeaderTableCell() ;

/// @brief Method .ctor addr 0x215df54 size 0x8 virtual false final false
 void _ctor() ;
