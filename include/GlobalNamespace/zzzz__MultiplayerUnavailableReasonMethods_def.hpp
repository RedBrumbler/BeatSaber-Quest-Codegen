...
/// @brief Method LocalizedKey addr 0x2239a40 size 0x84 virtual false final false
static ::StringW LocalizedKey(GlobalNamespace::MultiplayerUnavailableReason multiplayerUnavailableReason) ;

/// @brief Method ErrorCode addr 0x2239ac4 size 0x80 virtual false final false
static ::StringW ErrorCode(GlobalNamespace::MultiplayerUnavailableReason multiplayerUnavailableReason) ;

/// @brief Method TryGetMultiplayerUnavailableReason addr 0x2239b44 size 0x108 virtual false final false
...
/// @brief Method GetLocalizedMessage addr 0x2239e54 size 0xb0 virtual false final false
static ::StringW GetLocalizedMessage(GlobalNamespace::MultiplayerStatusData data, Polyglot::Language language) ;

/// @brief Method VersionLessThan addr 0x2239c4c size 0x208 virtual false final false
