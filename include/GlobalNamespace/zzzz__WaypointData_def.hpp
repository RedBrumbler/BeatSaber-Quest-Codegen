...
/// @brief Method get_offsetDirection addr 0xda3f50 size 0x8 virtual false final false
 GlobalNamespace::OffsetDirection get_offsetDirection() ;

/// @brief Method set_offsetDirection addr 0xda3f58 size 0x8 virtual false final false
 void set_offsetDirection(GlobalNamespace::OffsetDirection value) ;

/// @brief Method get_lineIndex addr 0xda3f60 size 0x8 virtual false final false
 int32_t get_lineIndex() ;

/// @brief Method set_lineIndex addr 0xda3f68 size 0x8 virtual false final false
 void set_lineIndex(int32_t value) ;

/// @brief Method get_lineLayer addr 0xda3f70 size 0x8 virtual false final false
 GlobalNamespace::NoteLineLayer get_lineLayer() ;

/// @brief Method set_lineLayer addr 0xda3f78 size 0x8 virtual false final false
 void set_lineLayer(GlobalNamespace::NoteLineLayer value) ;

/// @brief Method GetCopy addr 0xda3f80 size 0x90 virtual true final false
...
/// @brief Method .ctor addr 0xda4010 size 0x58 virtual false final false
...
/// @brief Method Mirror addr 0xda4068 size 0x14 virtual true final false
 void Mirror(int32_t lineCount) ;

/// @brief Method MirrorTransformOffsetDirection addr 0xda407c size 0x24 virtual false final false
