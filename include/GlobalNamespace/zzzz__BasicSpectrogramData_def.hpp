...
/// @brief Method get_Samples addr 0x22a5740 size 0x98 virtual false final false
 ::ArrayW<float_t> get_Samples() ;

/// @brief Method get_ProcessedSamples addr 0x22a57d8 size 0x3c virtual false final false
 System::Collections::Generic::List_1<float_t> get_ProcessedSamples() ;

/// @brief Method Awake addr 0x22a59a4 size 0xb0 virtual false final false
 void Awake() ;

/// @brief Method LateUpdate addr 0x22a5a54 size 0x8 virtual false final false
 void LateUpdate() ;

/// @brief Method ProcessSamples addr 0x22a5814 size 0x190 virtual false final false
...
/// @brief Method .ctor addr 0x22a5a5c size 0xb8 virtual false final false
 void _ctor() ;
