...
/// @brief Method get_playerId addr 0x21fa30c size 0x8 virtual false final false
 ::StringW get_playerId() ;

/// @brief Method set_playerId addr 0x21fa314 size 0x8 virtual false final false
 void set_playerId(::StringW value) ;

/// @brief Method get_playerName addr 0x21fa31c size 0x8 virtual false final false
 ::StringW get_playerName() ;

/// @brief Method set_playerName addr 0x21fa324 size 0x8 virtual false final false
 void set_playerName(::StringW value) ;

/// @brief Method get_playerKey addr 0x21fa32c size 0x8 virtual false final false
 ::StringW get_playerKey() ;

/// @brief Method set_playerKey addr 0x21fa334 size 0x8 virtual false final false
 void set_playerKey(::StringW value) ;

/// @brief Method get_authType addr 0x21fa33c size 0x8 virtual false final false
 ::StringW get_authType() ;

/// @brief Method set_authType addr 0x21fa344 size 0x8 virtual false final false
 void set_authType(::StringW value) ;

/// @brief Method get_playerFriends addr 0x21fa34c size 0x8 virtual false final false
 ::StringW get_playerFriends() ;

/// @brief Method set_playerFriends addr 0x21fa354 size 0x8 virtual false final false
 void set_playerFriends(::StringW value) ;

/// @brief Method get_succeeded addr 0x21fa35c size 0x8 virtual false final false
 bool get_succeeded() ;

/// @brief Method set_succeeded addr 0x21fa364 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x21fa370 size 0x5c virtual false final false
