...
/// @brief Method get_energyType addr 0x12220c4 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType get_energyType() ;

/// @brief Method get_noFailOn0Energy addr 0x12220cc size 0x8 virtual false final false
 bool get_noFailOn0Energy() ;

/// @brief Method get_instaFail addr 0x12220d4 size 0x8 virtual false final false
 bool get_instaFail() ;

/// @brief Method get_failOnSaberClash addr 0x12220dc size 0x8 virtual false final false
 bool get_failOnSaberClash() ;

/// @brief Method get_enabledObstacleType addr 0x12220e4 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__GameplayModifiers__EnabledObstacleType get_enabledObstacleType() ;

/// @brief Method get_fastNotes addr 0x12220ec size 0x8 virtual false final false
 bool get_fastNotes() ;

/// @brief Method get_strictAngles addr 0x12220f4 size 0x8 virtual false final false
 bool get_strictAngles() ;

/// @brief Method get_disappearingArrows addr 0x12220fc size 0x8 virtual false final false
 bool get_disappearingArrows() ;

/// @brief Method get_ghostNotes addr 0x1222104 size 0x8 virtual false final false
 bool get_ghostNotes() ;

/// @brief Method get_noBombs addr 0x122210c size 0x8 virtual false final false
 bool get_noBombs() ;

/// @brief Method get_songSpeed addr 0x1222114 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__GameplayModifiers__SongSpeed get_songSpeed() ;

/// @brief Method get_noArrows addr 0x122211c size 0x8 virtual false final false
 bool get_noArrows() ;

/// @brief Method get_proMode addr 0x1222124 size 0x8 virtual false final false
 bool get_proMode() ;

/// @brief Method get_zenMode addr 0x122212c size 0x8 virtual false final false
 bool get_zenMode() ;

/// @brief Method get_smallCubes addr 0x1222134 size 0x8 virtual false final false
 bool get_smallCubes() ;

/// @brief Method get_songSpeedMul addr 0x122213c size 0x24 virtual false final false
 float_t get_songSpeedMul() ;

/// @brief Method get_cutAngleTolerance addr 0x1222160 size 0x20 virtual false final false
 float_t get_cutAngleTolerance() ;

/// @brief Method get_notesUniformScale addr 0x1222180 size 0x18 virtual false final false
 float_t get_notesUniformScale() ;

// Ctor Parameters []
explicit GameplayModifiers() ;

/// @brief Method .ctor addr 0x1222198 size 0x2c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x1221f18 size 0xf4 virtual false final false
 void _ctor(GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType energyType, bool noFailOn0Energy, bool instaFail, bool failOnSaberClash, GlobalNamespace::GlobalNamespace__GameplayModifiers__EnabledObstacleType enabledObstacleType, bool noBombs, bool fastNotes, bool strictAngles, bool disappearingArrows, GlobalNamespace::GlobalNamespace__GameplayModifiers__SongSpeed songSpeed, bool noArrows, bool ghostNotes, bool proMode, bool zenMode, bool smallCubes) ;

/// @brief Method CopyWith addr 0x12221c4 size 0x32c virtual false final false
...
/// @brief Method IsWithoutModifiers addr 0x12224f0 size 0x88 virtual false final false
 bool IsWithoutModifiers() ;

/// @brief Method Serialize addr 0x1222578 size 0xa0 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method LiteNetLib.Utils.INetImmutableSerializable<GameplayModifiers>.CreateFromSerializedData addr 0x1222618 size 0x54 virtual true final true
...
/// @brief Method CreateFromSerializedData addr 0x122266c size 0x144 virtual false final false
