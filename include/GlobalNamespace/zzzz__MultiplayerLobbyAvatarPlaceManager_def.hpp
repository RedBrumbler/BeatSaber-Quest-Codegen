...
/// @brief Method Activate addr 0x20fca0c size 0x8 virtual false final false
 void Activate(float_t innerCircleRadius, float_t minOuterCircleRadius) ;

/// @brief Method Deactivate addr 0x20fce8c size 0x4 virtual false final false
 void Deactivate() ;

/// @brief Method OnDestroy addr 0x20fcfdc size 0x4 virtual false final false
 void OnDestroy() ;

/// @brief Method SpawnAllPlaces addr 0x20fca14 size 0x478 virtual false final false
 void SpawnAllPlaces() ;

/// @brief Method DespawnAllPlaces addr 0x20fce90 size 0x14c virtual false final false
 void DespawnAllPlaces() ;

// Ctor Parameters []
explicit MultiplayerLobbyAvatarPlaceManager() ;

/// @brief Method .ctor addr 0x20fcfe0 size 0x7c virtual false final false
 void _ctor() ;
