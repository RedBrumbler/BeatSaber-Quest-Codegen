...
/// @brief Method InitializeModules addr 0x20ef190 size 0x68 virtual false final false
static int32_t InitializeModules() ;

/// @brief Method AppStartAndMultiSceneEditorSetup addr 0x20ef1f8 size 0x68 virtual true final false
 void AppStartAndMultiSceneEditorSetup() ;

/// @brief Method RepeatableSetup addr 0x20ef260 size 0x84 virtual true final false
 void RepeatableSetup() ;

/// @brief Method TransitionToNextScene addr 0x20ef2e4 size 0x30 virtual true final false
 void TransitionToNextScene() ;

/// @brief Method InstallBindings addr 0x20ef314 size 0x2b0 virtual true final false
 void InstallBindings() ;

// Ctor Parameters []
explicit PS4AppInit() ;

/// @brief Method .ctor addr 0x20ef5c4 size 0x4 virtual false final false
 void _ctor() ;
