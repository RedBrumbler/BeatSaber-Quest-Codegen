...
/// @brief Method get_positionActionReference addr 0x1fc6ed4 size 0x8 virtual false final false
 UnityEngine::InputSystem::InputActionReference get_positionActionReference() ;

/// @brief Method set_positionActionReference addr 0x1fc6edc size 0x8 virtual false final false
 void set_positionActionReference(UnityEngine::InputSystem::InputActionReference value) ;

/// @brief Method get_orientationActionReference addr 0x1fc6ee4 size 0x8 virtual false final false
 UnityEngine::InputSystem::InputActionReference get_orientationActionReference() ;

/// @brief Method set_orientationActionReference addr 0x1fc6eec size 0x8 virtual false final false
 void set_orientationActionReference(UnityEngine::InputSystem::InputActionReference value) ;

/// @brief Method get_thumbstickActionReference addr 0x1fc6ef4 size 0x8 virtual false final false
 UnityEngine::InputSystem::InputActionReference get_thumbstickActionReference() ;

/// @brief Method set_thumbstickActionReference addr 0x1fc6efc size 0x8 virtual false final false
 void set_thumbstickActionReference(UnityEngine::InputSystem::InputActionReference value) ;

/// @brief Method CreateController addr 0x1fc43e8 size 0xc0 virtual false final false
...
/// @brief Method .ctor addr 0x1fc6f04 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_hapticsHandler addr 0x1fc6ad0 size 0x8 virtual false final false
 GlobalNamespace::IUnityXRHapticsHandler get_hapticsHandler() ;

/// @brief Method get_manufacturerName addr 0x1fc6ad8 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__UnityXRHelper__VRControllerManufacturerName get_manufacturerName() ;

/// @brief Method set_manufacturerName addr 0x1fc6ae0 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x1fc6ae8 size 0xd0 virtual false final false
...
/// @brief Method SetupController addr 0x1fc6bb8 size 0x34 virtual false final false
 bool SetupController(UnityEngine::XR::InputDevice device, UnityEngine::MonoBehaviour coroutineRunner) ;

/// @brief Method UpdateHapticsHandler addr 0x1fc6d3c size 0x190 virtual false final false
 void UpdateHapticsHandler(UnityEngine::MonoBehaviour coroutineRunner) ;

/// @brief Method TryToUpdateManufacturerName addr 0x1fc6bec size 0x150 virtual false final false
 bool TryToUpdateManufacturerName(UnityEngine::XR::InputDevice device) ;

/// @brief Method ResetManufacturerName addr 0x1fc6ecc size 0x8 virtual false final false
