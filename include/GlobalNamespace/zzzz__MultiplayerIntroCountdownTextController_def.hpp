...
/// @brief Method SetText addr 0x2132098 size 0x70 virtual false final false
 void SetText(::StringW text) ;

/// @brief Method SetDistances addr 0x2131a7c size 0x88 virtual false final false
 void SetDistances(float_t distance) ;

/// @brief Method set_hide addr 0x2131014 size 0x2c virtual false final false
 void set_hide(bool value) ;

/// @brief Method set_fontSize addr 0x21318f8 size 0x70 virtual false final false
 void set_fontSize(float_t value) ;

/// @brief Method get_fontSize addr 0x2131040 size 0x38 virtual false final false
 float_t get_fontSize() ;

/// @brief Method set_alpha addr 0x2131980 size 0x84 virtual false final false
 void set_alpha(float_t value) ;

/// @brief Method get_alpha addr 0x2131078 size 0x40 virtual false final false
 float_t get_alpha() ;

// Ctor Parameters []
explicit MultiplayerIntroCountdownTextController() ;

/// @brief Method .ctor addr 0x2132158 size 0x8 virtual false final false
 void _ctor() ;
