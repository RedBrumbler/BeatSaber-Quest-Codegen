...
/// @brief Method .ctor addr 0x211a3ec size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x211a41c size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x211a420 size 0x108 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x211a528 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x211a530 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x211a570 size 0x8 virtual true final true
...
/// @brief Method Awake addr 0x211a094 size 0xe0 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x211a174 size 0x88 virtual false final false
 void OnDestroy() ;

/// @brief Method AnimateToColor addr 0x211758c size 0xfc virtual false final false
 void AnimateToColor(UnityEngine::Color color, float_t duration, GlobalNamespace::EaseType easeType) ;

/// @brief Method SetColor addr 0x211a1fc size 0x58 virtual false final false
 void SetColor(UnityEngine::Color color) ;

/// @brief Method SetLightsColor addr 0x211a254 size 0xe8 virtual false final false
 void SetLightsColor(UnityEngine::Color color) ;

/// @brief Method SetLightsWidth addr 0x21179fc size 0x70 virtual false final false
 void SetLightsWidth(float_t width) ;

/// @brief Method DisableDirectionalLights addr 0x211a33c size 0x38 virtual false final false
 void DisableDirectionalLights(float_t delay) ;

/// @brief Method DisableDirectionalLightsCoroutine addr 0x211a374 size 0x78 virtual false final false
 System::Collections::IEnumerator DisableDirectionalLightsCoroutine(float_t delay) ;

// Ctor Parameters []
explicit LightsAnimator() ;

/// @brief Method .ctor addr 0x211a414 size 0x8 virtual false final false
 void _ctor() ;
