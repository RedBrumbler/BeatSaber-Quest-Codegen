...
/// @brief Method get_isValid addr 0xdb84b0 size 0x18 virtual true final true
 bool get_isValid() ;

/// @brief Method EncryptData addr 0xdb84c8 size 0x84 virtual true final true
 void EncryptData(::ArrayW<uint8_t> data, ByRef<int32_t> offset, ByRef<int32_t> length, int32_t extraPrefixBytes) ;

/// @brief Method TryDecryptData addr 0xdb854c size 0x7c virtual true final true
 bool TryDecryptData(::ArrayW<uint8_t> data, ByRef<int32_t> offset, ByRef<int32_t> length) ;

/// @brief Method ComputeSendMac addr 0xdb6ca0 size 0x248 virtual false final false
 ::ArrayW<uint8_t> ComputeSendMac(::ArrayW<uint8_t> data, int32_t offset, int32_t count) ;

/// @brief Method ComputeReceiveMac addr 0xdb791c size 0x248 virtual false final false
 ::ArrayW<uint8_t> ComputeReceiveMac(::ArrayW<uint8_t> data, int32_t offset, int32_t count) ;

/// @brief Method IsValidSequenceNum addr 0xdb77f0 size 0x12c virtual false final false
 bool IsValidSequenceNum(uint32_t sequenceNum) ;

/// @brief Method PutSequenceNum addr 0xdb7b64 size 0x204 virtual false final false
 bool PutSequenceNum(uint32_t sequenceNum) ;

/// @brief Method GetNextSentSequenceNum addr 0xdb6c94 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0xdb622c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <CreateEncryptionStateAsync>b__0 addr 0xdb8994 size 0x8c virtual false final false
...
/// @brief Method CreateEncryptionState addr 0xdb5f44 size 0x88 virtual false final false
...
/// @brief Method CreateEncryptionStateAsync addr 0xdb3b80 size 0x16c virtual false final false
...
/// @brief Method IsValidLength addr 0xdb6234 size 0x20 virtual false final false
static bool IsValidLength(int32_t length) ;

/// @brief Method EncryptData addr 0xdb6254 size 0xa40 virtual false final false
...
/// @brief Method TryDecryptData addr 0xdb6ee8 size 0x908 virtual false final false
...
/// @brief Method FastCopyBlock addr 0xdb7d68 size 0x314 virtual false final false
static void FastCopyBlock(::ArrayW<uint8_t> inArr, int32_t inOff, ::ArrayW<uint8_t> outArr, int32_t outOff) ;

/// @brief Method FastCopyMac addr 0xdb807c size 0x1f4 virtual false final false
static void FastCopyMac(::ArrayW<uint8_t> inArr, int32_t inOff, ::ArrayW<uint8_t> outArr, int32_t outOff) ;

/// @brief Method Log addr 0xdb8270 size 0x8c virtual false final false
static void Log(::StringW message) ;

/// @brief Method LogV addr 0xdb82fc size 0x8c virtual false final false
