...
/// @brief Method .ctor addr 0x20dfbd0 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x20dfc00 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x20dfc04 size 0xc8 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x20dfccc size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x20dfcd4 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x20dfd14 size 0x8 virtual true final true
...
/// @brief Method get_isCharacterVisible addr 0x20df174 size 0x18 virtual false final false
 bool get_isCharacterVisible() ;

/// @brief Method get_isSpawned addr 0x20df18c size 0x8 virtual false final false
 bool get_isSpawned() ;

/// @brief Method Start addr 0x20df194 size 0x338 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x20df57c size 0x3a0 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleStartCharacterAnimation addr 0x20df9cc size 0xc8 virtual false final false
 void HandleStartCharacterAnimation(GlobalNamespace::BTSCharacter btsCharacter) ;

/// @brief Method HandleGamePauseDidPause addr 0x20dfafc size 0x40 virtual false final false
 void HandleGamePauseDidPause() ;

/// @brief Method HandleGamePauseWillResume addr 0x20dfb3c size 0x44 virtual false final false
 void HandleGamePauseWillResume() ;

/// @brief Method HandleGamePauseDidResume addr 0x20dfb80 size 0x28 virtual false final false
 void HandleGamePauseDidResume() ;

/// @brief Method HandleLevelEndActionsLevelFailed addr 0x20dfba8 size 0x28 virtual false final false
 void HandleLevelEndActionsLevelFailed() ;

/// @brief Method TimelineStoppedDelayed addr 0x20dfa94 size 0x68 virtual false final false
 System::Collections::IEnumerator TimelineStoppedDelayed() ;

// Ctor Parameters []
explicit BTSCharacterSpawnController() ;

/// @brief Method .ctor addr 0x20dfbf8 size 0x8 virtual false final false
 void _ctor() ;
