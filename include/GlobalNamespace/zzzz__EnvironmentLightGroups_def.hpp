...
/// @brief Method .ctor addr 0x21f5cf0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Sort>b__6_0 addr 0x21f5cf8 size 0x18 virtual false final false
...
/// @brief Method get_lightGroupSOList addr 0x21f5910 size 0x8 virtual false final false
 System::Collections::Generic::List_1<GlobalNamespace::LightGroupSO> get_lightGroupSOList() ;

/// @brief Method GetDataForGroup addr 0x21f5918 size 0x24c virtual false final false
 GlobalNamespace::LightGroupSO GetDataForGroup(int32_t groupId) ;

/// @brief Method Sort addr 0x21f5b64 size 0x120 virtual false final false
 void Sort() ;

// Ctor Parameters []
explicit EnvironmentLightGroups() ;

/// @brief Method .ctor addr 0x21f5c84 size 0x8 virtual false final false
 void _ctor() ;
