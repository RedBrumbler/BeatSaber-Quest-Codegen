...
/// @brief Method add_TransformUpdated addr 0x265d684 size 0xb0 virtual false final false
 void add_TransformUpdated(System::Action_1<UnityEngine::Transform> value) ;

/// @brief Method remove_TransformUpdated addr 0x265d734 size 0xb0 virtual false final false
 void remove_TransformUpdated(System::Action_1<UnityEngine::Transform> value) ;

/// @brief Method add_CameraUpdated addr 0x265d7e4 size 0x9c virtual false final false
 void add_CameraUpdated(System::Action value) ;

/// @brief Method remove_CameraUpdated addr 0x265d880 size 0x9c virtual false final false
 void remove_CameraUpdated(System::Action value) ;

/// @brief Method add_PreCharacterMove addr 0x265d91c size 0x9c virtual false final false
 void add_PreCharacterMove(System::Action value) ;

/// @brief Method remove_PreCharacterMove addr 0x265d9b8 size 0x9c virtual false final false
 void remove_PreCharacterMove(System::Action value) ;

/// @brief Method get_InitialYRotation addr 0x265da54 size 0x8 virtual false final false
 float_t get_InitialYRotation() ;

/// @brief Method set_InitialYRotation addr 0x265da5c size 0x8 virtual false final false
 void set_InitialYRotation(float_t value) ;

/// @brief Method Start addr 0x265da64 size 0xc4 virtual false final false
 void Start() ;

/// @brief Method Awake addr 0x265db28 size 0x1c8 virtual false final false
 void Awake() ;

/// @brief Method OnEnable addr 0x265dcf0 size 0x4 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x265dcf4 size 0x19c virtual false final false
 void OnDisable() ;

/// @brief Method Update addr 0x265de90 size 0x1fc virtual false final false
 void Update() ;

/// @brief Method UpdateController addr 0x265e08c size 0x6f0 virtual true final false
 void UpdateController() ;

/// @brief Method UpdateMovement addr 0x265e77c size 0xc94 virtual true final false
 void UpdateMovement() ;

/// @brief Method UpdateTransform addr 0x265f410 size 0x188 virtual false final false
 void UpdateTransform(GlobalNamespace::OVRCameraRig rig) ;

/// @brief Method Jump addr 0x265f598 size 0x80 virtual false final false
 bool Jump() ;

/// @brief Method Stop addr 0x265f618 size 0xa4 virtual false final false
 void Stop() ;

/// @brief Method GetMoveScaleMultiplier addr 0x265f6bc size 0xc virtual false final false
 void GetMoveScaleMultiplier(ByRef<float_t> moveScaleMultiplier) ;

/// @brief Method SetMoveScaleMultiplier addr 0x265f6c8 size 0x8 virtual false final false
 void SetMoveScaleMultiplier(float_t moveScaleMultiplier) ;

/// @brief Method GetRotationScaleMultiplier addr 0x265f6d0 size 0xc virtual false final false
 void GetRotationScaleMultiplier(ByRef<float_t> rotationScaleMultiplier) ;

/// @brief Method SetRotationScaleMultiplier addr 0x265f6dc size 0x8 virtual false final false
 void SetRotationScaleMultiplier(float_t rotationScaleMultiplier) ;

/// @brief Method GetSkipMouseRotation addr 0x265f6e4 size 0xc virtual false final false
 void GetSkipMouseRotation(ByRef<bool> skipMouseRotation) ;

/// @brief Method SetSkipMouseRotation addr 0x265f6f0 size 0xc virtual false final false
 void SetSkipMouseRotation(bool skipMouseRotation) ;

/// @brief Method GetHaltUpdateMovement addr 0x265f6fc size 0xc virtual false final false
 void GetHaltUpdateMovement(ByRef<bool> haltUpdateMovement) ;

/// @brief Method SetHaltUpdateMovement addr 0x265f708 size 0xc virtual false final false
 void SetHaltUpdateMovement(bool haltUpdateMovement) ;

/// @brief Method ResetOrientation addr 0x265f714 size 0xc4 virtual false final false
 void ResetOrientation() ;

// Ctor Parameters []
explicit OVRPlayerController() ;

/// @brief Method .ctor addr 0x265f7d8 size 0xb4 virtual false final false
 void _ctor() ;
