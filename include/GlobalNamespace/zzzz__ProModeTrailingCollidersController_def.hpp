...
/// @brief Method Start addr 0x227ccac size 0x98 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x227cd44 size 0xd0 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleNoteDidMoveInJumpPhase addr 0x227ce14 size 0x170 virtual false final false
 void HandleNoteDidMoveInJumpPhase() ;

// Ctor Parameters []
explicit ProModeTrailingCollidersController() ;

/// @brief Method .ctor addr 0x227cf84 size 0x8 virtual false final false
 void _ctor() ;
