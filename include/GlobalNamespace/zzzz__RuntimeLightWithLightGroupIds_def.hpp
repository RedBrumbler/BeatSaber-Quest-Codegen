...
/// @brief Method get_intensity addr 0x1fdbb3c size 0x8 virtual false final false
 float_t get_intensity() ;

/// @brief Method set_intensity addr 0x1fdbb44 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x1fdb9a0 size 0x38 virtual false final false
...
/// @brief Method Awake addr 0x1fdb7e0 size 0x1c0 virtual true final false
 void Awake() ;

/// @brief Method ProcessNewColorData addr 0x1fdb9d8 size 0x13c virtual true final false
 void ProcessNewColorData() ;

/// @brief Method GetLightWithIds addr 0x1fdbb34 size 0x8 virtual true final false
 System::Collections::Generic::IEnumerable_1<GlobalNamespace::GlobalNamespace__LightWithIds__LightWithId> GetLightWithIds() ;

/// @brief Method ProcessColor addr 0x1fdbb14 size 0x20 virtual false final false
 UnityEngine::Color ProcessColor(UnityEngine::Color color, float_t intensity) ;

// Ctor Parameters []
explicit RuntimeLightWithLightGroupIds() ;

/// @brief Method .ctor addr 0x1fd82dc size 0x18 virtual false final false
 void _ctor() ;
