...
/// @brief Method get_jumpOffsetY addr 0x21421a8 size 0x8 virtual true final true
 float_t get_jumpOffsetY() ;

/// @brief Method Initialize addr 0x21421b0 size 0xf8 virtual true final true
 void Initialize() ;

/// @brief Method Dispose addr 0x2142314 size 0xd0 virtual true final true
 void Dispose() ;

/// @brief Method HandlePlayerHeightDidChange addr 0x21422dc size 0x38 virtual false final false
 void HandlePlayerHeightDidChange(float_t playerHeight) ;

/// @brief Method JumpOffsetYForPlayerHeight addr 0x21422a8 size 0x34 virtual false final false
static float_t JumpOffsetYForPlayerHeight(float_t playerHeight) ;

// Ctor Parameters []
explicit PlayerHeightToJumpOffsetYProvider() ;

/// @brief Method .ctor addr 0x21423e4 size 0x8 virtual false final false
 void _ctor() ;
