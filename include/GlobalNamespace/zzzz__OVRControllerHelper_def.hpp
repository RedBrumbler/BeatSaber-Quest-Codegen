...
/// @brief Method Start addr 0x264a480 size 0x70 virtual false final false
 void Start() ;

/// @brief Method InitializeControllerModels addr 0x264a4f0 size 0x420 virtual false final false
 void InitializeControllerModels() ;

/// @brief Method Update addr 0x264a910 size 0x6a4 virtual false final false
 void Update() ;

/// @brief Method InputFocusAquired addr 0x264afb4 size 0xc virtual false final false
 void InputFocusAquired() ;

/// @brief Method InputFocusLost addr 0x264afc0 size 0x8 virtual false final false
 void InputFocusLost() ;

// Ctor Parameters []
explicit OVRControllerHelper() ;

/// @brief Method .ctor addr 0x264afc8 size 0x18 virtual false final false
 void _ctor() ;
