...
/// @brief Method SetPositionAndRotation addr 0x20fc944 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x20fc9bc size 0x8 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11011)), TypeDefinitionIndex(TypeDefinitionIndex(4104)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 2721 })}
...
/// @brief Method .ctor addr 0x20fc9c4 size 0x48 virtual false final false
 void _ctor() ;
