...
/// @brief Method get_apiName addr 0x2264d40 size 0x40 virtual true final true
 ::StringW get_apiName() ;

/// @brief Method get_localizedDescription addr 0x2264d80 size 0x8 virtual true final true
 ::StringW get_localizedDescription() ;

/// @brief Method set_localizedDescription addr 0x2264d88 size 0x8 virtual false final false
 void set_localizedDescription(::StringW value) ;

// Ctor Parameters []
explicit PlayingTutorialPresenceData() ;

/// @brief Method .ctor addr 0x2264d90 size 0x5c virtual false final false
 void _ctor() ;
