...
/// @brief Method add_didFinishEvent addr 0x2194858 size 0xb0 virtual false final false
 void add_didFinishEvent(System::Action_1<HMUI::ViewController> value) ;

/// @brief Method remove_didFinishEvent addr 0x2194908 size 0xb0 virtual false final false
 void remove_didFinishEvent(System::Action_1<HMUI::ViewController> value) ;

/// @brief Method DidActivate addr 0x21949b8 size 0xfc virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x2194dcc size 0xb0 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

// Ctor Parameters []
explicit PlayerOptionsViewController() ;

/// @brief Method .ctor addr 0x2194e7c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__6_0 addr 0x2194e84 size 0x20 virtual false final false
