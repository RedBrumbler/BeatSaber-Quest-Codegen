...
/// @brief Method GetInitValues addr 0x218b92c size 0x214 virtual true final false
 bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements) ;

/// @brief Method ApplyValue addr 0x218bb40 size 0x74 virtual true final false
 void ApplyValue(int32_t idx) ;

/// @brief Method TextForValue addr 0x218bbb4 size 0xcc virtual true final false
 ::StringW TextForValue(int32_t idx) ;

// Ctor Parameters []
explicit WindowResolutionSettingsController() ;

/// @brief Method .ctor addr 0x218bc80 size 0x8 virtual false final false
 void _ctor() ;
