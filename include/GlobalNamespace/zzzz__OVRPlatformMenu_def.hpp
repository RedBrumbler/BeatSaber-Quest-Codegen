...
/// @brief Method HandleBackButtonState addr 0x260cb08 size 0x68 virtual false final false
 GlobalNamespace::GlobalNamespace__OVRPlatformMenu__eBackButtonAction HandleBackButtonState() ;

/// @brief Method Awake addr 0x260cb70 size 0x170 virtual false final false
 void Awake() ;

/// @brief Method ShowConfirmQuitMenu addr 0x260cce0 size 0xd4 virtual false final false
 void ShowConfirmQuitMenu() ;

/// @brief Method RetreatOneLevel addr 0x260cdb4 size 0xf8 virtual false final false
static bool RetreatOneLevel() ;

/// @brief Method Update addr 0x260ceac size 0x40 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit OVRPlatformMenu() ;

/// @brief Method .ctor addr 0x260ceec size 0x10 virtual false final false
 void _ctor() ;
