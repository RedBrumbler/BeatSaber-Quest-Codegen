...
/// @brief Method .ctor addr 0x1fc0628 size 0x28 virtual false final false
 void _ctor(UnityEngine::XR::XRNode node) ;

/// @brief Method Destroy addr 0x1fc0650 size 0x4 virtual false final false
 void Destroy() ;

/// @brief Method TriggerHapticPulse addr 0x1fc0654 size 0x4c virtual true final true
 void TriggerHapticPulse(float_t strength, float_t duration) ;

/// @brief Method StopHaptics addr 0x1fc06a0 size 0x30 virtual true final true
 void StopHaptics() ;

/// @brief Method Dispose addr 0x1fc06d0 size 0x4 virtual true final true
 void Dispose() ;
