...
/// @brief Method .ctor addr 0x226738c size 0x28 virtual false final false
...
/// @brief Method Start addr 0x22672b8 size 0xcc virtual false final false
 void Start() ;

// Ctor Parameters []
explicit EnvironmentBrandingManager() ;

/// @brief Method .ctor addr 0x2267384 size 0x8 virtual false final false
 void _ctor() ;
