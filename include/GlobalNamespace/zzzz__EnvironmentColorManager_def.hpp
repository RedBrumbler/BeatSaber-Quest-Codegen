...
/// @brief Method get_environmentColor0 addr 0x21c8c70 size 0x20 virtual false final false
 UnityEngine::Color get_environmentColor0() ;

/// @brief Method get_environmentColor1 addr 0x21c8c90 size 0x20 virtual false final false
 UnityEngine::Color get_environmentColor1() ;

/// @brief Method get_environmentColor0Boost addr 0x21c8cb0 size 0x54 virtual false final false
 UnityEngine::Color get_environmentColor0Boost() ;

/// @brief Method get_environmentColor1Boost addr 0x21c8d04 size 0x54 virtual false final false
 UnityEngine::Color get_environmentColor1Boost() ;

/// @brief Method Awake addr 0x21c9474 size 0x28 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x21c949c size 0x4 virtual false final false
 void Start() ;

/// @brief Method SetColorScheme addr 0x21c955c size 0x8 virtual false final false
 void SetColorScheme(GlobalNamespace::ColorScheme colorScheme) ;

/// @brief Method InitColors addr 0x21c94a0 size 0xbc virtual false final false
 void InitColors() ;

// Ctor Parameters []
explicit EnvironmentColorManager() ;

/// @brief Method .ctor addr 0x21c9564 size 0x8 virtual false final false
 void _ctor() ;
