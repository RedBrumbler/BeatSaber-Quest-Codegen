...
/// @brief Method add_selectBeatmapEvent addr 0x21ae0ec size 0x9c virtual false final false
 void add_selectBeatmapEvent(System::Action value) ;

/// @brief Method remove_selectBeatmapEvent addr 0x21ae188 size 0x9c virtual false final false
 void remove_selectBeatmapEvent(System::Action value) ;

/// @brief Method add_selectModifiersEvent addr 0x21ae224 size 0x9c virtual false final false
 void add_selectModifiersEvent(System::Action value) ;

/// @brief Method remove_selectModifiersEvent addr 0x21ae2c0 size 0x9c virtual false final false
 void remove_selectModifiersEvent(System::Action value) ;

/// @brief Method add_startGameOrReadyEvent addr 0x21ae35c size 0x9c virtual false final false
 void add_startGameOrReadyEvent(System::Action value) ;

/// @brief Method remove_startGameOrReadyEvent addr 0x21ae3f8 size 0x9c virtual false final false
 void remove_startGameOrReadyEvent(System::Action value) ;

/// @brief Method add_cancelGameOrUnreadyEvent addr 0x21ae494 size 0x9c virtual false final false
 void add_cancelGameOrUnreadyEvent(System::Action value) ;

/// @brief Method remove_cancelGameOrUnreadyEvent addr 0x21ae530 size 0x9c virtual false final false
 void remove_cancelGameOrUnreadyEvent(System::Action value) ;

/// @brief Method add_clearSuggestedBeatmapEvent addr 0x21ae5cc size 0x9c virtual false final false
 void add_clearSuggestedBeatmapEvent(System::Action value) ;

/// @brief Method remove_clearSuggestedBeatmapEvent addr 0x21ae668 size 0x9c virtual false final false
 void remove_clearSuggestedBeatmapEvent(System::Action value) ;

/// @brief Method add_clearSuggestedModifiersEvent addr 0x21ae704 size 0xa0 virtual false final false
 void add_clearSuggestedModifiersEvent(System::Action value) ;

/// @brief Method remove_clearSuggestedModifiersEvent addr 0x21ae7a4 size 0xa0 virtual false final false
 void remove_clearSuggestedModifiersEvent(System::Action value) ;

/// @brief Method Setup addr 0x21ae844 size 0x1f4 virtual false final false
...
/// @brief Method SetLobbyPlayerData addr 0x21aeaa0 size 0x3bc virtual false final false
 void SetLobbyPlayerData(GlobalNamespace::ILobbyPlayerData lobbyPlayerData) ;

/// @brief Method SetPlayersMissingLevelText addr 0x21aee80 size 0x58 virtual false final false
 void SetPlayersMissingLevelText(::StringW playersMissingLevelText) ;

/// @brief Method SetPlayerActiveState addr 0x21aee5c size 0x24 virtual false final false
 void SetPlayerActiveState(bool isActive) ;

/// @brief Method SetStartGameEnabled addr 0x21aeed8 size 0x68 virtual false final false
 void SetStartGameEnabled(GlobalNamespace::CannotStartGameReason cannotStartGameReason) ;

/// @brief Method SetLobbyState addr 0x21aef40 size 0xe0 virtual false final false
 void SetLobbyState(GlobalNamespace::MultiplayerLobbyState lobbyState) ;

/// @brief Method DidActivate addr 0x21af0e0 size 0x298 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method OnDestroy addr 0x21af378 size 0x1c virtual true final false
 void OnDestroy() ;

// Ctor Parameters []
explicit LobbySetupViewController() ;

/// @brief Method .ctor addr 0x21af394 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__44_0 addr 0x21af3fc size 0x1c virtual false final false
 void _DidActivate_b__44_0() ;

/// @brief Method <DidActivate>b__44_1 addr 0x21af418 size 0x1c virtual false final false
 void _DidActivate_b__44_1() ;

/// @brief Method <DidActivate>b__44_2 addr 0x21af434 size 0x1c virtual false final false
 void _DidActivate_b__44_2() ;

/// @brief Method <DidActivate>b__44_3 addr 0x21af450 size 0x1c virtual false final false
 void _DidActivate_b__44_3() ;

/// @brief Method <DidActivate>b__44_4 addr 0x21af46c size 0x1c virtual false final false
 void _DidActivate_b__44_4() ;

/// @brief Method <DidActivate>b__44_5 addr 0x21af488 size 0x1c virtual false final false
