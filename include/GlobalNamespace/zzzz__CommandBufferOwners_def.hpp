...
/// @brief Method AddOwner addr 0x26a6cc4 size 0xa0 virtual false final false
 void AddOwner(UnityEngine::Object owner) ;

/// @brief Method RemoveOwner addr 0x26a6a10 size 0x60 virtual false final false
 void RemoveOwner(UnityEngine::Object owner) ;

/// @brief Method ContainsOwner addr 0x26a6c6c size 0x58 virtual false final false
 bool ContainsOwner(UnityEngine::Object owner) ;

/// @brief Method get_NumberOfOwners addr 0x26a6a70 size 0x48 virtual false final false
 int32_t get_NumberOfOwners() ;

// Ctor Parameters []
explicit CommandBufferOwners() ;

/// @brief Method .ctor addr 0x26a6d64 size 0x8 virtual false final false
 void _ctor() ;
