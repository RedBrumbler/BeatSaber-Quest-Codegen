...
/// @brief Method .ctor addr 0x215c168 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SetData>b__0 addr 0x215c41c size 0x78 virtual false final false
...
/// @brief Method MoveNext addr 0x215c494 size 0x438 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x215c8cc size 0xc virtual true final true
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13575))}
...
/// @brief Method add_kickPlayerEvent addr 0x215b214 size 0xb0 virtual false final false
 void add_kickPlayerEvent(System::Action_1<int32_t> value) ;

/// @brief Method remove_kickPlayerEvent addr 0x215b2c4 size 0xb0 virtual false final false
 void remove_kickPlayerEvent(System::Action_1<int32_t> value) ;

/// @brief Method add_useBeatmapEvent addr 0x215b374 size 0xb4 virtual false final false
 void add_useBeatmapEvent(System::Action_1<int32_t> value) ;

/// @brief Method remove_useBeatmapEvent addr 0x215b428 size 0xb4 virtual false final false
 void remove_useBeatmapEvent(System::Action_1<int32_t> value) ;

/// @brief Method add_useModifiersEvent addr 0x215b4dc size 0xb4 virtual false final false
 void add_useModifiersEvent(System::Action_1<int32_t> value) ;

/// @brief Method remove_useModifiersEvent addr 0x215b590 size 0xb4 virtual false final false
 void remove_useModifiersEvent(System::Action_1<int32_t> value) ;

/// @brief Method SetData addr 0x215b644 size 0xb24 virtual false final false
...
/// @brief Method Awake addr 0x215c210 size 0x144 virtual false final false
 void Awake() ;

/// @brief Method HandleKickPlayerButtonPressed addr 0x215c354 size 0x20 virtual false final false
 void HandleKickPlayerButtonPressed() ;

/// @brief Method HandleUseBeatmapButtonPressed addr 0x215c374 size 0x20 virtual false final false
 void HandleUseBeatmapButtonPressed() ;

/// @brief Method HandleUseModifiersButtonPressed addr 0x215c394 size 0x20 virtual false final false
 void HandleUseModifiersButtonPressed() ;

/// @brief Method SetBeatmapUseButtonEnabledAsync addr 0x215c170 size 0xa0 virtual false final false
...
/// @brief Method .ctor addr 0x215c3b4 size 0x68 virtual false final false
 void _ctor() ;
