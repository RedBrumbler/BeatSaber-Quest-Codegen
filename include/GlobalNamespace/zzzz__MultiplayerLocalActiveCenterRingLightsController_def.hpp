...
/// @brief Method Start addr 0x211a578 size 0x198 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x211a740 size 0x154 virtual false final false
 void OnDestroy() ;

/// @brief Method TryResize addr 0x211a894 size 0x18 virtual false final false
 void TryResize() ;

/// @brief Method Resize addr 0x211a8ac size 0x2bc virtual false final false
 void Resize() ;

/// @brief Method HandleSpawnCenterDistanceWasFound addr 0x211a728 size 0x18 virtual false final false
 void HandleSpawnCenterDistanceWasFound(float_t spawnCenterDistance) ;

/// @brief Method HandleEdgeDistanceFromCenterWasCalculated addr 0x211a710 size 0x18 virtual false final false
...
/// @brief Method .ctor addr 0x211ab68 size 0x8 virtual false final false
 void _ctor() ;
