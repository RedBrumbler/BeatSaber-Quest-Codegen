...
/// @brief Method get_sfxLatency addr 0x20f0248 size 0x60 virtual false final false
 float_t get_sfxLatency() ;

/// @brief Method Init addr 0x20ec5f4 size 0xa8 virtual false final false
 void Init() ;

/// @brief Method set_mainVolume addr 0x20ec69c size 0x64 virtual false final false
 void set_mainVolume(float_t value) ;

/// @brief Method set_musicVolume addr 0x20f02a8 size 0x68 virtual false final false
 void set_musicVolume(float_t value) ;

/// @brief Method get_sfxVolume addr 0x20f0310 size 0x18 virtual false final false
 float_t get_sfxVolume() ;

/// @brief Method set_sfxVolume addr 0x20f0328 size 0x84 virtual false final false
 void set_sfxVolume(float_t value) ;

/// @brief Method get_sfxEnabled addr 0x20f03ac size 0x8 virtual false final false
 bool get_sfxEnabled() ;

/// @brief Method set_sfxEnabled addr 0x20f03b4 size 0x20 virtual false final false
 void set_sfxEnabled(bool value) ;

/// @brief Method set_musicPitch addr 0x20f03d4 size 0x100 virtual false final false
 void set_musicPitch(float_t value) ;

/// @brief Method set_musicSpeed addr 0x20f04d4 size 0x64 virtual false final false
 void set_musicSpeed(float_t value) ;

// Ctor Parameters []
explicit AudioManagerSO() ;

/// @brief Method .ctor addr 0x20f0538 size 0x24 virtual false final false
 void _ctor() ;
