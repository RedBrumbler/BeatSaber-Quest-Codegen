...
/// @brief Method .ctor addr 0x20f4a18 size 0x30 virtual false final false
...
/// @brief Method get_handleWrongSaberTypeAsGood addr 0x20f3ddc size 0x8 virtual false final false
 bool get_handleWrongSaberTypeAsGood() ;

/// @brief Method set_handleWrongSaberTypeAsGood addr 0x20f3de4 size 0xc virtual false final false
 void set_handleWrongSaberTypeAsGood(bool value) ;

/// @brief Method Start addr 0x20f3df0 size 0x260 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x20f4050 size 0x104 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleNoteWasSpawned addr 0x20f4154 size 0x580 virtual false final false
 void HandleNoteWasSpawned(GlobalNamespace::NoteController noteController) ;

/// @brief Method HandleNoteWasCut addr 0x20f4710 size 0x1b0 virtual false final false
 void HandleNoteWasCut(GlobalNamespace::NoteController noteController, ByRef<GlobalNamespace::NoteCutInfo> noteCutInfo) ;

/// @brief Method HandleNoteCutSoundEffectDidFinish addr 0x20f48c0 size 0xd8 virtual true final true
 void HandleNoteCutSoundEffectDidFinish(GlobalNamespace::NoteCutSoundEffect noteCutSoundEffect) ;

/// @brief Method IsSupportedNote addr 0x20f46d4 size 0x3c virtual false final false
 bool IsSupportedNote(GlobalNamespace::NoteData noteData) ;

// Ctor Parameters []
explicit NoteCutSoundEffectManager() ;

/// @brief Method .ctor addr 0x20f4998 size 0x80 virtual false final false
 void _ctor() ;
