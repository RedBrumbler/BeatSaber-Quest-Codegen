...
/// @brief Method .ctor addr 0x218cf0c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SetData>b__10_0 addr 0x218cf14 size 0x12c virtual false final false
...
/// @brief Method add_didSelectBeatmapCharacteristicEvent addr 0x218c59c size 0xb0 virtual false final false
...
/// @brief Method remove_didSelectBeatmapCharacteristicEvent addr 0x218c64c size 0xb0 virtual false final false
...
/// @brief Method get_selectedBeatmapCharacteristic addr 0x218c6fc size 0x8 virtual false final false
 GlobalNamespace::BeatmapCharacteristicSO get_selectedBeatmapCharacteristic() ;

/// @brief Method Awake addr 0x218c704 size 0x8c virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x218c790 size 0xd4 virtual false final false
 void OnDestroy() ;

/// @brief Method SetData addr 0x218c864 size 0x53c virtual false final false
...
/// @brief Method HandleDifficultySegmentedControlDidSelectCell addr 0x218cda0 size 0x88 virtual false final false
...
/// @brief Method .ctor addr 0x218ce28 size 0x80 virtual false final false
 void _ctor() ;
