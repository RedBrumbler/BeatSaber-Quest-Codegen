...
/// @brief Method DidActivate addr 0x2191fe0 size 0x108 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method Update addr 0x21920e8 size 0x240 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit FloorAdjustViewController() ;

/// @brief Method .ctor addr 0x2192328 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__9_0 addr 0x2192330 size 0x7c virtual false final false
 void _DidActivate_b__9_0() ;

/// @brief Method <DidActivate>b__9_1 addr 0x21923ac size 0x7c virtual false final false
