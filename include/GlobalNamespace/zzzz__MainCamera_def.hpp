...
/// @brief Method get_camera addr 0x21d8a38 size 0x8 virtual false final false
 UnityEngine::Camera get_camera() ;

/// @brief Method set_enableCamera addr 0x21d8a40 size 0x28 virtual false final false
 void set_enableCamera(bool value) ;

/// @brief Method get_position addr 0x21d8a68 size 0x1c virtual false final false
 UnityEngine::Vector3 get_position() ;

/// @brief Method get_rotation addr 0x21d8a84 size 0x1c virtual false final false
 UnityEngine::Quaternion get_rotation() ;

/// @brief Method Awake addr 0x21d8aa0 size 0x60 virtual false final false
 void Awake() ;

// Ctor Parameters []
explicit MainCamera() ;

/// @brief Method .ctor addr 0x21d8b00 size 0x8 virtual false final false
 void _ctor() ;
