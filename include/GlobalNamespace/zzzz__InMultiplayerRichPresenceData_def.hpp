...
/// @brief Method get_apiName addr 0x226451c size 0x8 virtual true final true
 ::StringW get_apiName() ;

/// @brief Method set_apiName addr 0x2264524 size 0x8 virtual false final false
 void set_apiName(::StringW value) ;

/// @brief Method get_localizedDescription addr 0x226452c size 0x8 virtual true final true
 ::StringW get_localizedDescription() ;

/// @brief Method set_localizedDescription addr 0x2264534 size 0x8 virtual false final false
 void set_localizedDescription(::StringW value) ;

/// @brief Method get_multiplayerSecret addr 0x226453c size 0x8 virtual true final true
 ::StringW get_multiplayerSecret() ;

/// @brief Method set_multiplayerSecret addr 0x2264544 size 0x8 virtual true final true
 void set_multiplayerSecret(::StringW value) ;

/// @brief Method get_atMaxPartySize addr 0x226454c size 0x8 virtual true final true
 bool get_atMaxPartySize() ;

/// @brief Method set_atMaxPartySize addr 0x2264554 size 0xc virtual true final true
 void set_atMaxPartySize(bool value) ;

/// @brief Method get_canInvite addr 0x2264560 size 0x8 virtual true final true
 bool get_canInvite() ;

/// @brief Method set_canInvite addr 0x2264568 size 0xc virtual true final true
 void set_canInvite(bool value) ;

/// @brief Method get_isJoinable addr 0x2264574 size 0x38 virtual true final true
 bool get_isJoinable() ;
...
/// @brief Method .ctor addr 0x22645ac size 0xa4 virtual false final false
