...
/// @brief Method .ctor addr 0xdc0ad8 size 0x10 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12749))}
...
/// @brief Method .ctor addr 0xdc0ae8 size 0x10 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xdbaa5c size 0x10 virtual false final false
 void _ctor() ;
...
/// @brief Method get_userId addr 0xdc0af8 size 0x8 virtual true final true
 ::StringW get_userId() ;

/// @brief Method set_userId addr 0xdc0b00 size 0x8 virtual false final false
 void set_userId(::StringW value) ;

/// @brief Method get_userName addr 0xdc0b08 size 0x8 virtual true final true
 ::StringW get_userName() ;

/// @brief Method set_userName addr 0xdc0b10 size 0x8 virtual false final false
 void set_userName(::StringW value) ;

/// @brief Method get_isConnectionOwner addr 0xdc0b18 size 0x8 virtual true final true
 bool get_isConnectionOwner() ;

/// @brief Method set_isConnectionOwner addr 0xdc0b20 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0xdc01dc size 0x58 virtual false final false
...
/// @brief Method Send addr 0xdc0b2c size 0x28 virtual true final true
 void Send(LiteNetLib::Utils::NetDataWriter writer, BGNet::Core::DeliveryMethod deliveryMethod) ;

/// @brief Method Disconnect addr 0xdc0b54 size 0x24 virtual true final true
 void Disconnect() ;
...
/// @brief Method .ctor addr 0xdc0b78 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <DisposeAsync>b__0 addr 0xdc0b80 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xdc0b88 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <DisposeAsync>b__1 addr 0xdc0b90 size 0x8 virtual false final false
...
/// @brief Method MoveNext addr 0xdc0b98 size 0x3dc virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0xdc0f74 size 0xc virtual true final true
...
/// @brief Method MoveNext addr 0xdc0f80 size 0x3e0 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0xdc1360 size 0xc virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method add_onInitializedEvent addr 0xdbe8cc size 0x9c virtual true final true
 void add_onInitializedEvent(System::Action value) ;

/// @brief Method remove_onInitializedEvent addr 0xdbe968 size 0x9c virtual true final true
 void remove_onInitializedEvent(System::Action value) ;

/// @brief Method add_onConnectedEvent addr 0xdbea04 size 0x9c virtual true final true
 void add_onConnectedEvent(System::Action value) ;

/// @brief Method remove_onConnectedEvent addr 0xdbeaa0 size 0x9c virtual true final true
 void remove_onConnectedEvent(System::Action value) ;

/// @brief Method add_onDisconnectedEvent addr 0xdbeb3c size 0xb0 virtual true final true
 void add_onDisconnectedEvent(System::Action_1<GlobalNamespace::DisconnectedReason> value) ;

/// @brief Method remove_onDisconnectedEvent addr 0xdbebec size 0xb0 virtual true final true
 void remove_onDisconnectedEvent(System::Action_1<GlobalNamespace::DisconnectedReason> value) ;

/// @brief Method add_onConnectionFailedEvent addr 0xdbec9c size 0xb0 virtual true final true
 void add_onConnectionFailedEvent(System::Action_1<GlobalNamespace::ConnectionFailedReason> value) ;

/// @brief Method remove_onConnectionFailedEvent addr 0xdbed4c size 0xb0 virtual true final true
 void remove_onConnectionFailedEvent(System::Action_1<GlobalNamespace::ConnectionFailedReason> value) ;

/// @brief Method add_onConnectionConnectedEvent addr 0xdbedfc size 0xb0 virtual true final true
 void add_onConnectionConnectedEvent(System::Action_1<GlobalNamespace::IConnection> value) ;

/// @brief Method remove_onConnectionConnectedEvent addr 0xdbeeac size 0xb0 virtual true final true
 void remove_onConnectionConnectedEvent(System::Action_1<GlobalNamespace::IConnection> value) ;

/// @brief Method add_onConnectionDisconnectedEvent addr 0xdbef5c size 0xb0 virtual true final true
...
/// @brief Method remove_onConnectionDisconnectedEvent addr 0xdbf00c size 0xb0 virtual true final true
...
/// @brief Method add_onReceivedDataEvent addr 0xdbf0bc size 0xb0 virtual true final true
...
/// @brief Method remove_onReceivedDataEvent addr 0xdbf16c size 0xb0 virtual true final true
...
/// @brief Method get_userId addr 0xdbf21c size 0x8 virtual true final true
 ::StringW get_userId() ;

/// @brief Method set_userId addr 0xdbf224 size 0x8 virtual false final false
 void set_userId(::StringW value) ;

/// @brief Method get_userName addr 0xdbf22c size 0x8 virtual true final true
 ::StringW get_userName() ;

/// @brief Method set_userName addr 0xdbf234 size 0x8 virtual false final false
 void set_userName(::StringW value) ;

/// @brief Method get_isConnected addr 0xdbf23c size 0x10 virtual true final true
 bool get_isConnected() ;

/// @brief Method get_isConnecting addr 0xdbf24c size 0x10 virtual true final true
 bool get_isConnecting() ;

/// @brief Method get_isDisconnecting addr 0xdbf25c size 0x10 virtual true final true
 bool get_isDisconnecting() ;

/// @brief Method get_connectionCount addr 0xdbf26c size 0x48 virtual true final true
 int32_t get_connectionCount() ;

/// @brief Method get_isConnectionOwner addr 0xdbf2b4 size 0x10 virtual true final true
 bool get_isConnectionOwner() ;

/// @brief Method get_isDisposed addr 0xdbf2c4 size 0x10 virtual true final true
 bool get_isDisposed() ;

/// @brief Method get_serverUserId addr 0xdbf2d4 size 0x8 virtual false final false
 ::StringW get_serverUserId() ;

/// @brief Method set_serverUserId addr 0xdbf2dc size 0x8 virtual false final false
 void set_serverUserId(::StringW value) ;

/// @brief Method get_serverUserName addr 0xdbf2e4 size 0x8 virtual false final false
 ::StringW get_serverUserName() ;

/// @brief Method set_serverUserName addr 0xdbf2ec size 0x8 virtual false final false
 void set_serverUserName(::StringW value) ;

// Ctor Parameters []
explicit IgnoranceConnectionManager() ;

/// @brief Method .ctor addr 0xdb9b8c size 0xac virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xdbf2f4 size 0x1b0 virtual false final false
...
/// @brief Method PollUpdate addr 0xdbf4a4 size 0xf0 virtual true final true
 void PollUpdate() ;

/// @brief Method DisposeAsync addr 0xdbfbcc size 0xc8 virtual true final true
 System::Threading::Tasks::Task DisposeAsync() ;

/// @brief Method Dispose addr 0xdbfc94 size 0x34 virtual true final true
 void Dispose() ;

/// @brief Method HandleConnectionEvents addr 0xdbf5b8 size 0x278 virtual false final false
 void HandleConnectionEvents() ;

/// @brief Method HandleIncomingEvents addr 0xdbf830 size 0x2d8 virtual false final false
 void HandleIncomingEvents() ;

/// @brief Method HandleDisconnectionEvents addr 0xdbfb08 size 0xc4 virtual false final false
 void HandleDisconnectionEvents() ;

/// @brief Method GetConnectionMessage addr 0xdbffe4 size 0x110 virtual false final false
 LiteNetLib::Utils::NetDataWriter GetConnectionMessage() ;

/// @brief Method TryParseConnectionMessage addr 0xdc0234 size 0x134 virtual false final false
...
/// @brief Method Send addr 0xdc00f4 size 0xe8 virtual false final false
 void Send(uint32_t peerId, LiteNetLib::Utils::NetDataWriter writer, BGNet::Core::DeliveryMethod deliveryMethod) ;

/// @brief Method DisconnectPeer addr 0xdc0368 size 0xf0 virtual false final false
 void DisconnectPeer(uint32_t peerId, GlobalNamespace::DisconnectedReason disconnectedReason) ;

/// @brief Method TryGetConnection addr 0xdc0458 size 0xdc virtual false final false
...
/// @brief Method SendToAll addr 0xdc0550 size 0xb8 virtual true final true
 void SendToAll(LiteNetLib::Utils::NetDataWriter writer, BGNet::Core::DeliveryMethod deliveryMethod) ;

/// @brief Method SendToAll addr 0xdc0608 size 0xe0 virtual true final true
...
/// @brief Method Disconnect addr 0xdbfcc8 size 0x1b4 virtual true final true
 void Disconnect(GlobalNamespace::DisconnectedReason disconnectedReason) ;

/// @brief Method GetConnection addr 0xdc06e8 size 0x58 virtual true final true
 GlobalNamespace::IConnection GetConnection(int32_t index) ;

/// @brief Method ToDeliveryMethod addr 0xdc0534 size 0xc virtual false final false
static BGNet::Core::DeliveryMethod ToDeliveryMethod(uint8_t channel) ;

/// @brief Method ToChannel addr 0xdc0540 size 0x10 virtual false final false
static uint8_t ToChannel(BGNet::Core::DeliveryMethod deliveryMethod) ;

/// @brief Method WaitForClientShutdown addr 0xdbfe7c size 0xb4 virtual false final false
static void WaitForClientShutdown(IgnoranceCore::IgnoranceClient client) ;

/// @brief Method WaitForServerShutdown addr 0xdbff30 size 0xb4 virtual false final false
static void WaitForServerShutdown(IgnoranceCore::IgnoranceServer server) ;

/// @brief Method Log addr 0xdc07cc size 0x8c virtual false final false
static void Log(::StringW msg) ;

/// @brief Method LogError addr 0xdc0740 size 0x8c virtual false final false
static void LogError(::StringW msg) ;

/// @brief Method StartBackgroundSentry addr 0xdc0858 size 0x1b4 virtual false final false
 void StartBackgroundSentry() ;

/// @brief Method CheckSentryState addr 0xdbf594 size 0x24 virtual false final false
 void CheckSentryState() ;

/// @brief Method BackgroundDisconnectSentry addr 0xdc0a0c size 0xcc virtual false final false
