...
/// @brief Method get_mainEffect addr 0x26a7b84 size 0x8 virtual false final false
 GlobalNamespace::MainEffectSO get_mainEffect() ;

/// @brief Method OnEnable addr 0x26a7b8c size 0x78 virtual true final false
 void OnEnable() ;

/// @brief Method Init addr 0x26a7c04 size 0x74 virtual false final false
 void Init(GlobalNamespace::MainEffectSO mainEffect) ;

// Ctor Parameters []
explicit MainEffectContainerSO() ;

/// @brief Method .ctor addr 0x26a7c78 size 0x8 virtual false final false
 void _ctor() ;
