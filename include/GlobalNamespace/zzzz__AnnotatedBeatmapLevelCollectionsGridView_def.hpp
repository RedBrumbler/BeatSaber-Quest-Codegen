...
/// @brief Method add_didOpenAnnotatedBeatmapLevelCollectionEvent addr 0x21b96d4 size 0x9c virtual false final false
 void add_didOpenAnnotatedBeatmapLevelCollectionEvent(System::Action value) ;

/// @brief Method remove_didOpenAnnotatedBeatmapLevelCollectionEvent addr 0x21b9770 size 0x9c virtual false final false
 void remove_didOpenAnnotatedBeatmapLevelCollectionEvent(System::Action value) ;

/// @brief Method add_didCloseAnnotatedBeatmapLevelCollectionEvent addr 0x21b980c size 0x9c virtual false final false
 void add_didCloseAnnotatedBeatmapLevelCollectionEvent(System::Action value) ;

/// @brief Method remove_didCloseAnnotatedBeatmapLevelCollectionEvent addr 0x21b98a8 size 0x9c virtual false final false
 void remove_didCloseAnnotatedBeatmapLevelCollectionEvent(System::Action value) ;

/// @brief Method add_didSelectAnnotatedBeatmapLevelCollectionEvent addr 0x21b9944 size 0xb0 virtual false final false
...
/// @brief Method remove_didSelectAnnotatedBeatmapLevelCollectionEvent addr 0x21b99f4 size 0xb0 virtual false final false
...
/// @brief Method SetData addr 0x21b9aa4 size 0x8c virtual false final false
...
/// @brief Method OnEnable addr 0x21b9be0 size 0x140 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x21b9d20 size 0x144 virtual false final false
 void OnDisable() ;

/// @brief Method Show addr 0x21b9e64 size 0x24 virtual false final false
 void Show() ;

/// @brief Method Hide addr 0x21b9e88 size 0x24 virtual false final false
 void Hide() ;

/// @brief Method CancelAsyncOperations addr 0x21b9eac size 0x188 virtual false final false
 void CancelAsyncOperations() ;

/// @brief Method RefreshAvailability addr 0x21ba034 size 0x2cc virtual false final false
 void RefreshAvailability() ;

/// @brief Method SelectAndScrollToCellWithIdx addr 0x21ba300 size 0x324 virtual false final false
 void SelectAndScrollToCellWithIdx(int32_t idx) ;

/// @brief Method OnPointerEnter addr 0x21ba680 size 0x54 virtual true final true
 void OnPointerEnter(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnPointerExit addr 0x21baa08 size 0x68 virtual true final true
 void OnPointerExit(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method HandleAdditionalContentModelDidInvalidateData addr 0x21bad78 size 0x60 virtual false final false
 void HandleAdditionalContentModelDidInvalidateData() ;

/// @brief Method HandleVRPlatformHelperInputFocusCaptured addr 0x21bae84 size 0x4c virtual false final false
 void HandleVRPlatformHelperInputFocusCaptured() ;

/// @brief Method HandleCellSelectionDidChange addr 0x21baed0 size 0x4c4 virtual false final false
...
/// @brief Method GetNumberOfCells addr 0x21badd8 size 0xac virtual true final true
 int32_t GetNumberOfCells() ;

/// @brief Method GetCellWidth addr 0x21bb394 size 0x8 virtual true final true
 float_t GetCellWidth() ;

/// @brief Method GetCellHeight addr 0x21bb39c size 0x8 virtual true final true
 float_t GetCellHeight() ;

/// @brief Method CellForIdx addr 0x21bb3a4 size 0x294 virtual true final true
...
/// @brief Method .ctor addr 0x21bb638 size 0x8 virtual false final false
 void _ctor() ;
