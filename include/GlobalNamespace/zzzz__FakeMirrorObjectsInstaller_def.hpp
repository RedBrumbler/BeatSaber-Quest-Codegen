...
/// @brief Method .ctor addr 0x214faa4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <InstallBindings>b__11_0 addr 0x214faac size 0x94 virtual false final false
...
/// @brief Method get_mirroredGameNoteControllerPrefab addr 0x214f4b0 size 0x8 virtual false final false
 GlobalNamespace::MirroredGameNoteController get_mirroredGameNoteControllerPrefab() ;

/// @brief Method InstallBindings addr 0x214f4b8 size 0x580 virtual true final false
 void InstallBindings() ;

// Ctor Parameters []
explicit FakeMirrorObjectsInstaller() ;

/// @brief Method .ctor addr 0x214fa38 size 0x8 virtual false final false
 void _ctor() ;
