...
/// @brief Method .ctor addr 0x228bf50 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x228c3d4 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x228c3d8 size 0xcc virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x228c4a4 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x228c4ac size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x228c4ec size 0x8 virtual true final true
...
/// @brief Method Start addr 0x228bee8 size 0x68 virtual false final false
 System::Collections::IEnumerator Start() ;

/// @brief Method Update addr 0x228bf78 size 0x40 virtual false final false
 void Update() ;

/// @brief Method IsColorVeryCloseToColor addr 0x228c11c size 0x44 virtual false final false
 bool IsColorVeryCloseToColor(UnityEngine::Color color0, UnityEngine::Color color1) ;

/// @brief Method SetColor addr 0x228c160 size 0x1c virtual false final false
 void SetColor(int32_t lightId, UnityEngine::Color color) ;

/// @brief Method CurrentColorForID addr 0x228c17c size 0x20 virtual false final false
 UnityEngine::Color CurrentColorForID(int32_t lightId) ;

/// @brief Method SetColorsFromPreset addr 0x228bfb8 size 0x164 virtual false final false
 bool SetColorsFromPreset(GlobalNamespace::MenuLightsPresetSO preset, float_t interpolationFactor) ;

/// @brief Method RefreshLightsDictForPreset addr 0x228c19c size 0xe0 virtual false final false
 void RefreshLightsDictForPreset(GlobalNamespace::MenuLightsPresetSO preset) ;

/// @brief Method SetColorPreset addr 0x228c27c size 0xbc virtual false final false
 void SetColorPreset(GlobalNamespace::MenuLightsPresetSO preset, bool animated) ;

/// @brief Method RefreshColors addr 0x228c338 size 0x8c virtual false final false
 void RefreshColors() ;

// Ctor Parameters []
explicit MenuLightsManager() ;

/// @brief Method .ctor addr 0x228c3c4 size 0x10 virtual false final false
 void _ctor() ;
