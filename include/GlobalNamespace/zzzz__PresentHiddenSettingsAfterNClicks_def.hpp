...
/// @brief Method OnEnable addr 0x218b52c size 0x9c virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x218b5c8 size 0x1c virtual false final false
 void OnDisable() ;

// Ctor Parameters []
explicit PresentHiddenSettingsAfterNClicks() ;

/// @brief Method .ctor addr 0x218b5e4 size 0x70 virtual false final false
 void _ctor() ;

/// @brief Method <OnEnable>b__6_0 addr 0x218b654 size 0x44 virtual false final false
