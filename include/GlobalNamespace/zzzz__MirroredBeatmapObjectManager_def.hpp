...
/// @brief Method Init addr 0x2271c28 size 0x438 virtual false final false
...
/// @brief Method Finalize addr 0x2272060 size 0x360 virtual true final false
 void Finalize() ;

/// @brief Method HandleNoteWasSpawned addr 0x22723c0 size 0x22c virtual false final false
 void HandleNoteWasSpawned(GlobalNamespace::NoteController noteController) ;

/// @brief Method HandleNoteWasDespawned addr 0x22725ec size 0x17c virtual false final false
 void HandleNoteWasDespawned(GlobalNamespace::NoteController noteController) ;

/// @brief Method HandleObstacleWasSpawned addr 0x2272768 size 0x9c virtual false final false
 void HandleObstacleWasSpawned(GlobalNamespace::ObstacleController obstacleController) ;

/// @brief Method HandleObstacleWasDespawned addr 0x2272804 size 0xc0 virtual false final false
 void HandleObstacleWasDespawned(GlobalNamespace::ObstacleController obstacleController) ;

/// @brief Method HandleSliderWasSpawned addr 0x22728c4 size 0x9c virtual false final false
 void HandleSliderWasSpawned(GlobalNamespace::SliderController sliderController) ;

/// @brief Method HandleSliderWasDespawned addr 0x2272960 size 0xc0 virtual false final false
 void HandleSliderWasDespawned(GlobalNamespace::SliderController sliderController) ;

/// @brief Method HandleDidHideAllBeatmapObjects addr 0x2272a20 size 0x7cc virtual false final false
 void HandleDidHideAllBeatmapObjects(bool hide) ;

// Ctor Parameters []
explicit MirroredBeatmapObjectManager() ;

/// @brief Method .ctor addr 0x22731ec size 0x148 virtual false final false
 void _ctor() ;
