...
/// @brief Method .ctor addr 0x215ede0 size 0x28 virtual false final false
...
/// @brief Method Start addr 0x215eb2c size 0x64 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x215eb90 size 0x1ec virtual false final false
 void Update() ;

// Ctor Parameters []
explicit SafeAreaRectChecker() ;

/// @brief Method .ctor addr 0x215ed7c size 0x64 virtual false final false
 void _ctor() ;
