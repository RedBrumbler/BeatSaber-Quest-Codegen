...
/// @brief Method get_didFinishEvent addr 0x2289e98 size 0x8 virtual false final false
 GlobalNamespace::ILazyCopyHashSet_1<GlobalNamespace::IFlyingObjectEffectDidFinishEvent> get_didFinishEvent() ;

/// @brief Method InitAndPresent addr 0x2289ea0 size 0xe8 virtual false final false
 void InitAndPresent(float_t duration, UnityEngine::Vector3 targetPos, UnityEngine::Quaternion rotation, bool shake) ;

/// @brief Method Update addr 0x2289f88 size 0x3b8 virtual false final false
 void Update() ;
...
/// @brief Method .ctor addr 0x228a340 size 0xcc virtual false final false
 void _ctor() ;
