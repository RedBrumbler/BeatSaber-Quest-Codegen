...
/// @brief Method Start addr 0x22af614 size 0xc4 virtual false final false
 void Start() ;

/// @brief Method HandleRelativeScoreAndImmediateRankCounterRelativeScoreOrImmediateRankDidChange addr 0x22af8e0 size 0x4 virtual false final false
 void HandleRelativeScoreAndImmediateRankCounterRelativeScoreOrImmediateRankDidChange() ;

/// @brief Method RefreshUI addr 0x22af6d8 size 0x16c virtual false final false
 void RefreshUI() ;

// Ctor Parameters []
explicit ImmediateRankUIPanel() ;

/// @brief Method .ctor addr 0x22af8e4 size 0x14 virtual false final false
 void _ctor() ;
