...
/// @brief Method get_multiplier addr 0x21489d0 size 0x8 virtual false final false
 int32_t get_multiplier() ;

/// @brief Method get_normalizedProgress addr 0x21480f0 size 0x14 virtual false final false
 float_t get_normalizedProgress() ;

/// @brief Method Reset addr 0x21489d8 size 0x18 virtual false final false
 void Reset() ;

/// @brief Method ProcessMultiplierEvent addr 0x214804c size 0x9c virtual false final false
...
/// @brief Method .ctor addr 0x21489b8 size 0x18 virtual false final false
 void _ctor() ;
