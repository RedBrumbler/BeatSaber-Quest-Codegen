...
/// @brief Method .ctor addr 0x21407d8 size 0x48 virtual false final false
...
/// @brief Method add_didInitEvent addr 0x213fb78 size 0x9c virtual true final true
 void add_didInitEvent(System::Action value) ;

/// @brief Method remove_didInitEvent addr 0x213fc14 size 0x9c virtual true final true
 void remove_didInitEvent(System::Action value) ;

/// @brief Method add_gameEnergyDidReach0Event addr 0x213fcb0 size 0x9c virtual true final true
 void add_gameEnergyDidReach0Event(System::Action value) ;

/// @brief Method remove_gameEnergyDidReach0Event addr 0x213fd4c size 0x9c virtual true final true
 void remove_gameEnergyDidReach0Event(System::Action value) ;

/// @brief Method add_gameEnergyDidChangeEvent addr 0x213fde8 size 0xb0 virtual true final true
 void add_gameEnergyDidChangeEvent(System::Action_1<float_t> value) ;

/// @brief Method remove_gameEnergyDidChangeEvent addr 0x213fe98 size 0xb0 virtual true final true
 void remove_gameEnergyDidChangeEvent(System::Action_1<float_t> value) ;

/// @brief Method get_isInitialized addr 0x213ff48 size 0x8 virtual true final true
 bool get_isInitialized() ;

/// @brief Method get_energy addr 0x213ff50 size 0x8 virtual true final true
 float_t get_energy() ;

/// @brief Method set_energy addr 0x213ff58 size 0x8 virtual false final false
 void set_energy(float_t value) ;

/// @brief Method get_batteryEnergy addr 0x213ff60 size 0x80 virtual true final true
 int32_t get_batteryEnergy() ;

/// @brief Method get_batteryLives addr 0x213ffe0 size 0x8 virtual true final true
 int32_t get_batteryLives() ;

/// @brief Method get_energyType addr 0x213ffe8 size 0x8 virtual true final true
 GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType get_energyType() ;

/// @brief Method set_energyType addr 0x213fff0 size 0x8 virtual false final false
 void set_energyType(GlobalNamespace::GlobalNamespace__GameplayModifiers__EnergyType value) ;

/// @brief Method get_noFail addr 0x213fff8 size 0x8 virtual true final true
 bool get_noFail() ;

/// @brief Method set_noFail addr 0x2140000 size 0xc virtual false final false
 void set_noFail(bool value) ;

/// @brief Method get_instaFail addr 0x214000c size 0x8 virtual true final true
 bool get_instaFail() ;

/// @brief Method set_instaFail addr 0x2140014 size 0xc virtual false final false
 void set_instaFail(bool value) ;

/// @brief Method get_failOnSaberClash addr 0x2140020 size 0x8 virtual true final true
 bool get_failOnSaberClash() ;

/// @brief Method set_failOnSaberClash addr 0x2140028 size 0xc virtual false final false
 void set_failOnSaberClash(bool value) ;

/// @brief Method Start addr 0x2140034 size 0x194 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x21401c8 size 0x104 virtual false final false
 void OnDestroy() ;

/// @brief Method LateUpdate addr 0x21402cc size 0x108 virtual false final false
 void LateUpdate() ;

/// @brief Method HandleNoteWasCut addr 0x2140678 size 0xe4 virtual false final false
 void HandleNoteWasCut(GlobalNamespace::NoteController noteController, ByRef<GlobalNamespace::NoteCutInfo> noteCutInfo) ;

/// @brief Method HandleNoteWasMissed addr 0x214075c size 0x64 virtual false final false
 void HandleNoteWasMissed(GlobalNamespace::NoteController noteController) ;

/// @brief Method ProcessEnergyChange addr 0x2140424 size 0xf0 virtual false final false
 void ProcessEnergyChange(float_t energyChange) ;

// Ctor Parameters []
explicit GameEnergyCounter() ;

/// @brief Method .ctor addr 0x21407c0 size 0x18 virtual false final false
 void _ctor() ;
