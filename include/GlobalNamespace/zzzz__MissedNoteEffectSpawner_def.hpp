...
/// @brief Method Start addr 0x2292e70 size 0xd4 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2292f44 size 0x98 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleNoteWasMissed addr 0x2292fdc size 0x18c virtual false final false
 void HandleNoteWasMissed(GlobalNamespace::NoteController noteController) ;

// Ctor Parameters []
explicit MissedNoteEffectSpawner() ;

/// @brief Method .ctor addr 0x2293168 size 0x8 virtual false final false
 void _ctor() ;
