...
/// @brief Method OnEnable addr 0x1fd470c size 0xec virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fd47f8 size 0xec virtual false final false
 void OnDisable() ;

/// @brief Method OnCameraPreRender addr 0x1fd48e4 size 0x560 virtual false final false
 void OnCameraPreRender(UnityEngine::Camera camera) ;

/// @brief Method OnDestroy addr 0x1fd4e44 size 0x4 virtual false final false
 void OnDestroy() ;

/// @brief Method ResetColors addr 0x1fd4e48 size 0xe4 virtual false final false
 void ResetColors() ;

// Ctor Parameters []
explicit LightManager() ;

/// @brief Method .ctor addr 0x1fd4f2c size 0xcc virtual false final false
 void _ctor() ;
