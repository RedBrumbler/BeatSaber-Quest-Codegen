...
/// @brief Method get_countdownShown addr 0x21acca8 size 0x8 virtual false final false
 bool get_countdownShown() ;

/// @brief Method set_countdownShown addr 0x21accb0 size 0xc virtual false final false
 void set_countdownShown(bool value) ;

/// @brief Method Setup addr 0x21accbc size 0x30 virtual false final false
 void Setup(bool showModifiers) ;

/// @brief Method Show addr 0x21accec size 0x18c virtual false final false
 void Show() ;

/// @brief Method Hide addr 0x21acfe0 size 0x130 virtual false final false
 void Hide() ;

/// @brief Method ShowCountdown addr 0x21ad154 size 0x3c virtual false final false
 void ShowCountdown(float_t countdownEndTime) ;

/// @brief Method HideCountdown addr 0x21ad110 size 0x44 virtual false final false
 void HideCountdown(bool instant) ;

/// @brief Method SetCountdownEndTime addr 0x21ad190 size 0x58 virtual false final false
 void SetCountdownEndTime(float_t countdownEndTime) ;

/// @brief Method ShowCountdownColorPreset addr 0x21ad1e8 size 0x2c virtual false final false
 void ShowCountdownColorPreset(bool animated) ;

/// @brief Method ShowLobbyColorPreset addr 0x21ace78 size 0x2c virtual false final false
 void ShowLobbyColorPreset(bool animated) ;

/// @brief Method HandleLobbyGameStateControllerSelectedLevelGameplaySetupDataChanged addr 0x21ad214 size 0x4 virtual false final false
...
/// @brief Method SetNextGameplaySetupData addr 0x21acea4 size 0x13c virtual false final false
...
/// @brief Method .ctor addr 0x21ad218 size 0x8 virtual false final false
 void _ctor() ;
