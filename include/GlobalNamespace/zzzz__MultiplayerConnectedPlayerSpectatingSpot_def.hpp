...
/// @brief Method add_hasBeenRemovedEvent addr 0x213ded4 size 0xb0 virtual true final true
 void add_hasBeenRemovedEvent(System::Action_1<GlobalNamespace::IMultiplayerSpectatingSpot> value) ;

/// @brief Method remove_hasBeenRemovedEvent addr 0x213df84 size 0xb0 virtual true final true
 void remove_hasBeenRemovedEvent(System::Action_1<GlobalNamespace::IMultiplayerSpectatingSpot> value) ;

/// @brief Method add_isObservedChangedEvent addr 0x213e034 size 0xb0 virtual false final false
 void add_isObservedChangedEvent(System::Action_1<bool> value) ;

/// @brief Method remove_isObservedChangedEvent addr 0x213e0e4 size 0xb0 virtual false final false
 void remove_isObservedChangedEvent(System::Action_1<bool> value) ;

/// @brief Method get_observable addr 0x213e194 size 0x8 virtual true final true
 GlobalNamespace::IMultiplayerObservable get_observable() ;

/// @brief Method set_observable addr 0x213e19c size 0x8 virtual false final false
 void set_observable(GlobalNamespace::IMultiplayerObservable value) ;

/// @brief Method get_spotName addr 0x213e1a4 size 0xa4 virtual true final true
 ::StringW get_spotName() ;

/// @brief Method get_isMain addr 0x213e248 size 0x8 virtual true final true
 bool get_isMain() ;

/// @brief Method Start addr 0x213e250 size 0x1f4 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x213e5a8 size 0x1a4 virtual false final false
 void OnDestroy() ;

/// @brief Method SetIsObserved addr 0x213e74c size 0x20 virtual true final true
 void SetIsObserved(bool isObserved) ;

/// @brief Method ReloadBasedOnPlayerCurrentState addr 0x213e76c size 0x174 virtual false final false
 void ReloadBasedOnPlayerCurrentState(GlobalNamespace::IConnectedPlayer connectedPlayer) ;

/// @brief Method HandlePlayerStateChanged addr 0x213e8e0 size 0x4 virtual false final false
 void HandlePlayerStateChanged(GlobalNamespace::IConnectedPlayer connectedPlayer) ;

/// @brief Method HandlePlayerDisconnected addr 0x213e8e4 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x213e8e8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method IMultiplayerSpectatingSpot.get_transform addr 0x213e8f0 size 0x8 virtual true final true
