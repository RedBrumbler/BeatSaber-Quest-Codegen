...
/// @brief Method .ctor addr 0x21257dc size 0x8 virtual false final false
 void _ctor(GlobalNamespace::IMultiplayerSessionManager multiplayerSessionManager) ;

/// @brief Method Init addr 0x21270f0 size 0x68 virtual true final false
 void Init() ;

/// @brief Method Tick addr 0x2127158 size 0x68 virtual true final false
 void Tick() ;
