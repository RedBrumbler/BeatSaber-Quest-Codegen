...
/// @brief Method .ctor addr 0x20e721c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Start addr 0x20e6c80 size 0x30 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x20e6cb0 size 0x120 virtual false final false
 void Update() ;

/// @brief Method GetNoiseVec3 addr 0x20e6dd0 size 0x7c virtual false final false
 UnityEngine::Vector3 GetNoiseVec3(float_t time) ;

/// @brief Method GetNoise addr 0x20e710c size 0xf4 virtual false final false
 float_t GetNoise(float_t time, float_t offset) ;

/// @brief Method UpdateTiltTransform addr 0x20e6e4c size 0x2c0 virtual false final false
 void UpdateTiltTransform() ;

// Ctor Parameters []
explicit DroneHover() ;

/// @brief Method .ctor addr 0x20e7200 size 0x1c virtual false final false
 void _ctor() ;
