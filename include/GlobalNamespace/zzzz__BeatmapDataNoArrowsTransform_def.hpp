...
/// @brief Method CreateTransformedData addr 0x21f0458 size 0xec virtual false final false
static GlobalNamespace::IReadonlyBeatmapData CreateTransformedData(GlobalNamespace::IReadonlyBeatmapData beatmapData) ;

/// @brief Method <CreateTransformedData>g__ProcessData|0_0 addr 0x21f0544 size 0xe4 virtual false final false
