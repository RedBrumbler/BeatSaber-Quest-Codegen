...
/// @brief Method get_beatmapLevelPackCollection addr 0x221d29c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x221d2a4 size 0x8 virtual false final false
 void _ctor() ;
