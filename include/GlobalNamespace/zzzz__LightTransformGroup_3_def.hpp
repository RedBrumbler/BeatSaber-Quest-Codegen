...
template<::cordl_internals::il2cpp_reference_type TX,::cordl_internals::il2cpp_reference_type TY,::cordl_internals::il2cpp_reference_type TZ>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5047)), TypeDefinitionIndex(TypeDefinitionIndex(5039))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5047), inst: 5162 })
