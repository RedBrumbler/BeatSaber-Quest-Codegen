...
/// @brief Method MoveNext addr 0x222648c size 0x64c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2226ad8 size 0x58 virtual true final true
...
/// @brief Method MoveNext addr 0x2226b30 size 0x20c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2226d3c size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method add_levelDataAssetDownloadUpdateEvent addr 0x2226124 size 0xb0 virtual true final true
 void add_levelDataAssetDownloadUpdateEvent(System::Action_1<GlobalNamespace::LevelDataAssetDownloadUpdate> value) ;

/// @brief Method remove_levelDataAssetDownloadUpdateEvent addr 0x22261d4 size 0xb0 virtual true final true
 void remove_levelDataAssetDownloadUpdateEvent(System::Action_1<GlobalNamespace::LevelDataAssetDownloadUpdate> value) ;

/// @brief Method GetAssetBundleFileForPreviewLevelAsync addr 0x2226284 size 0x114 virtual true final true
...
/// @brief Method TryDeleteAssetBundleFileForPreviewLevelAsync addr 0x2226398 size 0xec virtual true final true
...
/// @brief Method .ctor addr 0x2226484 size 0x8 virtual false final false
 void _ctor() ;
