...
/// @brief Method GetHexDigit addr 0x1222828 size 0x50 virtual false final false
static uint32_t GetHexDigit(char16_t c) ;

/// @brief Method GetBase64Digit addr 0x1222878 size 0x70 virtual false final false
static uint32_t GetBase64Digit(char16_t c) ;

/// @brief Method GetBase64Char addr 0x12228e8 size 0x44 virtual false final false
