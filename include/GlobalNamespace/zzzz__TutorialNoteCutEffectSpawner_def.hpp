...
/// @brief Method Start addr 0x214b280 size 0x8c virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x214b30c size 0x98 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleNoteWasCut addr 0x214b3a4 size 0x268 virtual false final false
 void HandleNoteWasCut(GlobalNamespace::NoteController noteController, ByRef<GlobalNamespace::NoteCutInfo> noteCutInfo) ;

// Ctor Parameters []
explicit TutorialNoteCutEffectSpawner() ;

/// @brief Method .ctor addr 0x214b60c size 0x8 virtual false final false
 void _ctor() ;
