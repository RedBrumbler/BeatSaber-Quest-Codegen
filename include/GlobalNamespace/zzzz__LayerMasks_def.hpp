...
/// @brief Method GetLayerMask addr 0x11b05bc size 0x30 virtual false final false
static UnityEngine::LayerMask GetLayerMask(::StringW layerName) ;

/// @brief Method GetLayerMask addr 0x11b05ec size 0x28 virtual false final false
static UnityEngine::LayerMask GetLayerMask(int32_t layerNum) ;

/// @brief Method GetLayer addr 0x11b0614 size 0x8 virtual false final false
static int32_t GetLayer(::StringW layerName) ;

// Ctor Parameters []
explicit LayerMasks() ;

/// @brief Method .ctor addr 0x11b061c size 0x8 virtual false final false
 void _ctor() ;
