...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5867))}
...
/// @brief Method get_editButton addr 0x21bd78c size 0x8 virtual false final false
 UnityEngine::UI::Button get_editButton() ;

/// @brief Method get_clearButton addr 0x21bd794 size 0x8 virtual false final false
 UnityEngine::UI::Button get_clearButton() ;

/// @brief Method get_interactable addr 0x21bd79c size 0x8 virtual false final false
 bool get_interactable() ;

/// @brief Method set_interactable addr 0x21af020 size 0x60 virtual false final false
 void set_interactable(bool value) ;

/// @brief Method get_showClearButton addr 0x21bd7a4 size 0x8 virtual false final false
 bool get_showClearButton() ;

/// @brief Method set_showClearButton addr 0x21bd7ac size 0xc virtual false final false
 void set_showClearButton(bool value) ;

/// @brief Method SetVisibility addr 0x21aea44 size 0x28 virtual false final false
 void SetVisibility(bool visible) ;

/// @brief Method Setup addr 0x21aea38 size 0xc virtual false final false
 void Setup(bool showClearButton) ;

/// @brief Method SetBeatmap addr 0x21bd7b8 size 0x68 virtual true final false
 void SetBeatmap(GlobalNamespace::PreviewDifficultyBeatmap beatmapLevel) ;

// Ctor Parameters []
explicit EditableBeatmapSelectionView() ;

/// @brief Method .ctor addr 0x21bd820 size 0x10 virtual false final false
 void _ctor() ;
