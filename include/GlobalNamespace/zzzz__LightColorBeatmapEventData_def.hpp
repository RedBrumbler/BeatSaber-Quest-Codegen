...
/// @brief Method get_colorType addr 0xda0a60 size 0x8 virtual false final false
 GlobalNamespace::EnvironmentColorType get_colorType() ;

/// @brief Method set_colorType addr 0xda0a68 size 0x8 virtual false final false
 void set_colorType(GlobalNamespace::EnvironmentColorType value) ;

/// @brief Method get_brightness addr 0xda0a70 size 0x8 virtual false final false
 float_t get_brightness() ;

/// @brief Method set_brightness addr 0xda0a78 size 0x8 virtual false final false
 void set_brightness(float_t value) ;

/// @brief Method get_strobeBeatFrequency addr 0xda0a80 size 0x8 virtual false final false
 int32_t get_strobeBeatFrequency() ;

/// @brief Method set_strobeBeatFrequency addr 0xda0a88 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xda0a90 size 0xc4 virtual false final false
...
/// @brief Method CopyColorDataFrom addr 0xda0b60 size 0x24 virtual false final false
 void CopyColorDataFrom(GlobalNamespace::LightColorBeatmapEventData lightColorBeatmapEventData) ;

/// @brief Method DisableStrobe addr 0xda0b84 size 0x8 virtual false final false
 void DisableStrobe() ;

/// @brief Method GetCopy addr 0xda0b8c size 0xa4 virtual true final false
 GlobalNamespace::BeatmapDataItem GetCopy() ;

/// @brief Method SubtypeIdentifier addr 0xda0b54 size 0xc virtual false final false
static int32_t SubtypeIdentifier(int32_t groupId, int32_t elementId) ;

/// @brief Method GetDefault addr 0xda0c30 size 0x128 virtual true final false
