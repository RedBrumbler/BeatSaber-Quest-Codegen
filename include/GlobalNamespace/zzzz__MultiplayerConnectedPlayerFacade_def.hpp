...
/// @brief Method get_introAnimator addr 0x2116dd0 size 0x8 virtual false final false
 GlobalNamespace::MultiplayerConnectedPlayerIntroAnimator get_introAnimator() ;

/// @brief Method get_outroAnimator addr 0x2116dd8 size 0x8 virtual false final false
 UnityEngine::GameObject get_outroAnimator() ;

/// @brief Method get_scoreDiffText addr 0x2116de0 size 0x8 virtual false final false
 GlobalNamespace::MultiplayerScoreDiffText get_scoreDiffText() ;

/// @brief Method SetSongStartSyncTime addr 0x2116de8 size 0x18 virtual false final false
 void SetSongStartSyncTime(float_t songStartSyncTime) ;

/// @brief Method PauseSpawning addr 0x2116f24 size 0xa4 virtual false final false
 void PauseSpawning() ;

/// @brief Method ResumeSpawning addr 0x2116fc8 size 0xa4 virtual false final false
 void ResumeSpawning() ;

/// @brief Method __ForceStopSong addr 0x211706c size 0x34 virtual false final false
 void __ForceStopSong() ;

/// @brief Method HideBigAvatar addr 0x21170ac size 0x90 virtual false final false
 void HideBigAvatar() ;

/// @brief Method __GetPlayerAvatar addr 0x211713c size 0x4c virtual false final false
 GlobalNamespace::AvatarPoseController __GetPlayerAvatar() ;

// Ctor Parameters []
explicit MultiplayerConnectedPlayerFacade() ;

/// @brief Method .ctor addr 0x2117188 size 0x14 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5332)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10969), inst: 3387 }), TypeDefinitionIndex(TypeDefinitionIndex(12739)), TypeDefinitionIndex(TypeDefinitionIndex(5226)), TypeDefinitionIndex(TypeDefinitionIndex(10969))}
...
/// @brief Method .ctor addr 0x211719c size 0x48 virtual false final false
 void _ctor() ;
