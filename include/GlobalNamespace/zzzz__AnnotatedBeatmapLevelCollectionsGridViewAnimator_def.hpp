...
/// @brief Method Init addr 0x21b9b30 size 0xb0 virtual false final false
 void Init(float_t rowHeight, int32_t rowCount) ;

/// @brief Method OnDestroy addr 0x21bb66c size 0x4 virtual false final false
 void OnDestroy() ;

/// @brief Method ScrollToRowIdxInstant addr 0x21ba624 size 0x5c virtual false final false
 void ScrollToRowIdxInstant(int32_t selectedRow) ;

/// @brief Method AnimateOpen addr 0x21ba6d4 size 0x334 virtual false final false
 void AnimateOpen(bool animated) ;

/// @brief Method AnimateClose addr 0x21baa70 size 0x308 virtual false final false
 void AnimateClose(int32_t selectedRow, bool animated) ;

/// @brief Method DespawnAllActiveTweens addr 0x21bb670 size 0xc8 virtual false final false
 void DespawnAllActiveTweens() ;

/// @brief Method GetContentYOffset addr 0x21bb640 size 0x2c virtual false final false
 float_t GetContentYOffset() ;

// Ctor Parameters []
explicit AnnotatedBeatmapLevelCollectionsGridViewAnimator() ;

/// @brief Method .ctor addr 0x21bb738 size 0x18 virtual false final false
 void _ctor() ;

/// @brief Method <AnimateOpen>b__13_0 addr 0x21bb750 size 0x1c virtual false final false
 void _AnimateOpen_b__13_0(UnityEngine::Vector2 size) ;

/// @brief Method <AnimateOpen>b__13_1 addr 0x21bb76c size 0x88 virtual false final false
 void _AnimateOpen_b__13_1() ;

/// @brief Method <AnimateOpen>b__13_2 addr 0x21bb7f4 size 0x1c virtual false final false
 void _AnimateOpen_b__13_2(UnityEngine::Vector2 pos) ;

/// @brief Method <AnimateOpen>b__13_3 addr 0x21bb810 size 0x88 virtual false final false
 void _AnimateOpen_b__13_3() ;

/// @brief Method <AnimateClose>b__14_0 addr 0x21bb898 size 0x1c virtual false final false
 void _AnimateClose_b__14_0(UnityEngine::Vector2 size) ;

/// @brief Method <AnimateClose>b__14_1 addr 0x21bb8b4 size 0x88 virtual false final false
 void _AnimateClose_b__14_1() ;

/// @brief Method <AnimateClose>b__14_2 addr 0x21bb93c size 0x1c virtual false final false
 void _AnimateClose_b__14_2(UnityEngine::Vector2 pos) ;

/// @brief Method <AnimateClose>b__14_3 addr 0x21bb958 size 0x88 virtual false final false
