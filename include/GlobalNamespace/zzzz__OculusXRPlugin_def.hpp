...
/// @brief Method SetColorScale addr 0x2649c24 size 0x98 virtual false final false
static void SetColorScale(float_t x, float_t y, float_t z, float_t w) ;

/// @brief Method SetColorOffset addr 0x2649cbc size 0x94 virtual false final false
static void SetColorOffset(float_t x, float_t y, float_t z, float_t w) ;

/// @brief Method SetSpaceWarp addr 0x2649d50 size 0x7c virtual false final false
static void SetSpaceWarp(GlobalNamespace::GlobalNamespace__OVRPlugin__Bool on) ;

/// @brief Method SetAppSpacePosition addr 0x2649dcc size 0x90 virtual false final false
static void SetAppSpacePosition(float_t x, float_t y, float_t z) ;

/// @brief Method SetAppSpaceRotation addr 0x2649e5c size 0x98 virtual false final false
