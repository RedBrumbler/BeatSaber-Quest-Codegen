...
/// @brief Method Start addr 0x22ae2b4 size 0x88 virtual false final false
 void Start() ;

/// @brief Method OnEnable addr 0x22ae60c size 0x4 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x22ae610 size 0x4 virtual false final false
 void OnDisable() ;

/// @brief Method RegisterForEvents addr 0x22ae33c size 0x2d0 virtual false final false
 void RegisterForEvents() ;

/// @brief Method UnregisterFromEvents addr 0x22ae614 size 0x1b8 virtual false final false
 void UnregisterFromEvents() ;

/// @brief Method HandleComboDidChange addr 0x22ae7cc size 0x48 virtual false final false
 void HandleComboDidChange(int32_t combo) ;

/// @brief Method HandleComboBreakingEventHappened addr 0x22ae814 size 0x3c virtual false final false
 void HandleComboBreakingEventHappened() ;

// Ctor Parameters []
explicit ComboUIController() ;

/// @brief Method .ctor addr 0x22ae850 size 0x8 virtual false final false
 void _ctor() ;
