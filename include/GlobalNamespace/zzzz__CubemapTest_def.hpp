...
/// @brief Method Start addr 0x21d4ae4 size 0x7c virtual false final false
 void Start() ;

/// @brief Method Update addr 0x21d4b60 size 0x210 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit CubemapTest() ;

/// @brief Method .ctor addr 0x21d4d70 size 0x8 virtual false final false
 void _ctor() ;
