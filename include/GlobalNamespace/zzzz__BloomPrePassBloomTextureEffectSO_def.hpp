...
/// @brief Method get_toneMapping addr 0x26aba7c size 0x20 virtual true final false
 GlobalNamespace::ToneMapping get_toneMapping() ;

/// @brief Method Render addr 0x26aba9c size 0x64 virtual true final false
 void Render(UnityEngine::RenderTexture src, UnityEngine::RenderTexture dest) ;

// Ctor Parameters []
explicit BloomPrePassBloomTextureEffectSO() ;

/// @brief Method .ctor addr 0x26abb00 size 0x3c virtual false final false
 void _ctor() ;
