...
/// @brief Method get_reflectionProbeCubemap1 addr 0x21d6b84 size 0x8 virtual false final false
 UnityEngine::Cubemap get_reflectionProbeCubemap1() ;

/// @brief Method set_reflectionProbeCubemap1 addr 0x21d6b8c size 0x8 virtual false final false
 void set_reflectionProbeCubemap1(UnityEngine::Cubemap value) ;

/// @brief Method get_reflectionProbeCubemap2 addr 0x21d6b94 size 0x8 virtual false final false
 UnityEngine::Cubemap get_reflectionProbeCubemap2() ;

/// @brief Method set_reflectionProbeCubemap2 addr 0x21d6b9c size 0x8 virtual false final false
 void set_reflectionProbeCubemap2(UnityEngine::Cubemap value) ;

// Ctor Parameters []
explicit ReflectionProbeDataSO() ;

/// @brief Method .ctor addr 0x21d6ba4 size 0x8 virtual false final false
 void _ctor() ;
