...
/// @brief Method get_keyboard addr 0x2165208 size 0x8 virtual false final false
 HMUI::UIKeyboard get_keyboard() ;

/// @brief Method Start addr 0x2165210 size 0x8c virtual false final false
 void Start() ;

/// @brief Method OnEnable addr 0x216529c size 0x8c virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2165328 size 0x8c virtual false final false
 void OnDisable() ;

/// @brief Method OnDestroy addr 0x21653b4 size 0xd0 virtual false final false
 void OnDestroy() ;

/// @brief Method OpenKeyboardFor addr 0x2165484 size 0x200 virtual false final false
 void OpenKeyboardFor(HMUI::InputFieldView input) ;

/// @brief Method CloseKeyboard addr 0x2165684 size 0x98 virtual false final false
 void CloseKeyboard() ;

/// @brief Method TransferKeyboardTo addr 0x216571c size 0x94 virtual false final false
 void TransferKeyboardTo(HMUI::InputFieldView nextInput) ;

/// @brief Method ShouldCloseKeyboard addr 0x21657b0 size 0x58 virtual false final false
 bool ShouldCloseKeyboard(UnityEngine::GameObject root) ;

/// @brief Method ProcessMousePress addr 0x2165808 size 0x168 virtual false final false
 void ProcessMousePress(UnityEngine::GameObject currentOverGo) ;

/// @brief Method HandleKeyboardOkButton addr 0x2165970 size 0x160 virtual false final false
 void HandleKeyboardOkButton() ;

// Ctor Parameters []
explicit UIKeyboardManager() ;

/// @brief Method .ctor addr 0x2165ad0 size 0x8 virtual false final false
 void _ctor() ;
