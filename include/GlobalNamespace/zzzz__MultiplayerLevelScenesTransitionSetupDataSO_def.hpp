...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6142))}
...
/// @brief Method add_didFinishEvent addr 0x2208ea8 size 0xb0 virtual false final false
...
/// @brief Method remove_didFinishEvent addr 0x220929c size 0xb0 virtual false final false
...
/// @brief Method add_didDisconnectEvent addr 0x220a040 size 0xb0 virtual false final false
...
/// @brief Method remove_didDisconnectEvent addr 0x2209968 size 0xb0 virtual false final false
...
/// @brief Method get_gameMode addr 0x220b544 size 0x8 virtual false final false
 ::StringW get_gameMode() ;

/// @brief Method set_gameMode addr 0x220b54c size 0x8 virtual false final false
 void set_gameMode(::StringW value) ;

/// @brief Method get_previewBeatmapLevel addr 0x220b554 size 0x8 virtual false final false
 GlobalNamespace::IPreviewBeatmapLevel get_previewBeatmapLevel() ;

/// @brief Method set_previewBeatmapLevel addr 0x220b55c size 0x8 virtual false final false
 void set_previewBeatmapLevel(GlobalNamespace::IPreviewBeatmapLevel value) ;

/// @brief Method get_beatmapDifficulty addr 0x220b564 size 0x8 virtual false final false
 GlobalNamespace::BeatmapDifficulty get_beatmapDifficulty() ;

/// @brief Method set_beatmapDifficulty addr 0x220b56c size 0x8 virtual false final false
 void set_beatmapDifficulty(GlobalNamespace::BeatmapDifficulty value) ;

/// @brief Method get_difficultyBeatmap addr 0x220b574 size 0x8 virtual false final false
 GlobalNamespace::IDifficultyBeatmap get_difficultyBeatmap() ;

/// @brief Method set_difficultyBeatmap addr 0x220b57c size 0x8 virtual false final false
 void set_difficultyBeatmap(GlobalNamespace::IDifficultyBeatmap value) ;

/// @brief Method get_beatmapCharacteristic addr 0x220b584 size 0x8 virtual false final false
 GlobalNamespace::BeatmapCharacteristicSO get_beatmapCharacteristic() ;

/// @brief Method set_beatmapCharacteristic addr 0x220b58c size 0x8 virtual false final false
 void set_beatmapCharacteristic(GlobalNamespace::BeatmapCharacteristicSO value) ;

/// @brief Method get_usingOverrideColorScheme addr 0x220b594 size 0x8 virtual false final false
 bool get_usingOverrideColorScheme() ;

/// @brief Method set_usingOverrideColorScheme addr 0x220b59c size 0xc virtual false final false
 void set_usingOverrideColorScheme(bool value) ;

/// @brief Method get_colorScheme addr 0x220b5a8 size 0x8 virtual false final false
 GlobalNamespace::ColorScheme get_colorScheme() ;

/// @brief Method set_colorScheme addr 0x220b5b0 size 0x8 virtual false final false
 void set_colorScheme(GlobalNamespace::ColorScheme value) ;

/// @brief Method Init addr 0x220a0f0 size 0x378 virtual false final false
...
/// @brief Method Finish addr 0x220b5b8 size 0x28 virtual false final false
 void Finish(GlobalNamespace::MultiplayerResultsData resultsData) ;

/// @brief Method FinishWithDisconnect addr 0x220b5e0 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x220b608 size 0x8 virtual false final false
 void _ctor() ;
