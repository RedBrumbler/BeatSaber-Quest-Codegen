...
/// @brief Method add__event addr 0x1fbea58 size 0x9c virtual false final false
 void add__event(System::Action value) ;

/// @brief Method remove__event addr 0x1fbeaf4 size 0x9c virtual false final false
 void remove__event(System::Action value) ;

/// @brief Method Raise addr 0x1fbeb90 size 0x1c virtual true final false
 void Raise() ;

/// @brief Method Subscribe addr 0x1fbebac size 0x28 virtual false final false
 void Subscribe(System::Action foo) ;

/// @brief Method Unsubscribe addr 0x1fbebd4 size 0x4 virtual false final false
 void Unsubscribe(System::Action foo) ;

// Ctor Parameters []
explicit Signal() ;

/// @brief Method .ctor addr 0x1fbebd8 size 0x8 virtual false final false
 void _ctor() ;
