...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5565)), TypeDefinitionIndex(TypeDefinitionIndex(5564))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5565), inst: 2 })
