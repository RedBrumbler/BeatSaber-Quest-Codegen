...
/// @brief Method SetTargetTransform addr 0x20fd05c size 0x8 virtual false final false
 void SetTargetTransform(UnityEngine::Transform target) ;

/// @brief Method Update addr 0x20fd064 size 0xe0 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit ShadowFollowController() ;

/// @brief Method .ctor addr 0x20fd144 size 0x8 virtual false final false
 void _ctor() ;
