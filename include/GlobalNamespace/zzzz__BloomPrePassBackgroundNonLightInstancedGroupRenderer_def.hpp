...
/// @brief Method .ctor addr 0x1fced10 size 0x8 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14659))}
...
/// @brief Method Awake addr 0x1fcdf4c size 0x4 virtual false final false
 void Awake() ;

/// @brief Method InitIfNeeded addr 0x1fcdf50 size 0x258 virtual false final false
 void InitIfNeeded() ;

/// @brief Method Render addr 0x1fce1d8 size 0x6c4 virtual true final false
 void Render(UnityEngine::RenderTexture dest, UnityEngine::Matrix4x4 viewMatrix, UnityEngine::Matrix4x4 projectionMatrix) ;

/// @brief Method GetCachedMatrixArray addr 0x1fce89c size 0xdc virtual false final false
 ::ArrayW<UnityEngine::Matrix4x4> GetCachedMatrixArray(::StringW propertyName) ;

/// @brief Method GetCachedFloatArray addr 0x1fcea54 size 0xdc virtual false final false
 ::ArrayW<float_t> GetCachedFloatArray(::StringW propertyName) ;

/// @brief Method GetCachedVectorArray addr 0x1fce978 size 0xdc virtual false final false
 ::ArrayW<UnityEngine::Vector4> GetCachedVectorArray(::StringW propertyName) ;

/// @brief Method AutoFillRenderers addr 0x1fceb30 size 0x50 virtual false final false
 void AutoFillRenderers() ;

// Ctor Parameters []
explicit BloomPrePassBackgroundNonLightInstancedGroupRenderer() ;

/// @brief Method .ctor addr 0x1fceb80 size 0x128 virtual false final false
 void _ctor() ;
