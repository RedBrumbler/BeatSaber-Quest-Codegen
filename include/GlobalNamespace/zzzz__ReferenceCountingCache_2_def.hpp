...
template<::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6020))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6020), inst: 80 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6020))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6020), inst: 1534 })
// CS Name: ReferenceCountingCache`2
