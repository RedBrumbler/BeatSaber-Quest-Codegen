...
/// @brief Method LateUpdate addr 0x226c7bc size 0x124 virtual false final false
 void LateUpdate() ;

/// @brief Method Pause addr 0x226c8e0 size 0xc virtual false final false
 void Pause() ;

/// @brief Method Resume addr 0x226c8ec size 0xc virtual false final false
 void Resume() ;

// Ctor Parameters []
explicit BeatmapCallbacksUpdater() ;

/// @brief Method .ctor addr 0x226c8f8 size 0x8 virtual false final false
 void _ctor() ;
