...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4640)), TypeDefinitionIndex(TypeDefinitionIndex(4690)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4690), inst: 4832 })}
...
/// @brief Method GetLevelProductsModel addr 0x2253f10 size 0x8 virtual true final false
 GlobalNamespace::PS4LevelProductsModelSO GetLevelProductsModel() ;

// Ctor Parameters []
explicit PS4PlatformAdditionalContentModel() ;

/// @brief Method .ctor addr 0x2253f18 size 0x48 virtual false final false
 void _ctor() ;
