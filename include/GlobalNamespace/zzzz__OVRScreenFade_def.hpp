...
/// @brief Method .ctor addr 0x2662ecc size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2662f20 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2662f24 size 0x11c virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x2663040 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x2663048 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2663088 size 0x8 virtual true final true
...
/// @brief Method get_instance addr 0x2662554 size 0x48 virtual false final false
static GlobalNamespace::OVRScreenFade get_instance() ;

/// @brief Method set_instance addr 0x266259c size 0x4c virtual false final false
static void set_instance(GlobalNamespace::OVRScreenFade value) ;

/// @brief Method get_currentAlpha addr 0x26625e8 size 0xbc virtual false final false
 float_t get_currentAlpha() ;

/// @brief Method Start addr 0x26626a4 size 0x49c virtual false final false
 void Start() ;

/// @brief Method FadeIn addr 0x2662b40 size 0x28 virtual false final false
 void FadeIn() ;

/// @brief Method FadeOut addr 0x2662be4 size 0x28 virtual false final false
 void FadeOut() ;

/// @brief Method OnLevelFinishedLoading addr 0x2662c0c size 0x28 virtual false final false
 void OnLevelFinishedLoading(int32_t level) ;

/// @brief Method OnEnable addr 0x2662c34 size 0x18 virtual false final false
 void OnEnable() ;

/// @brief Method OnDestroy addr 0x2662c4c size 0x154 virtual false final false
 void OnDestroy() ;

/// @brief Method SetUIFade addr 0x2662da0 size 0x1c virtual false final false
 void SetUIFade(float_t level) ;

/// @brief Method SetExplicitFade addr 0x2662ec4 size 0x8 virtual false final false
 void SetExplicitFade(float_t level) ;

/// @brief Method Fade addr 0x2662b68 size 0x7c virtual false final false
 System::Collections::IEnumerator Fade(float_t startAlpha, float_t endAlpha) ;

/// @brief Method SetMaterialAlpha addr 0x2662dbc size 0x108 virtual false final false
 void SetMaterialAlpha() ;

// Ctor Parameters []
explicit OVRScreenFade() ;

/// @brief Method .ctor addr 0x2662ef4 size 0x2c virtual false final false
 void _ctor() ;
