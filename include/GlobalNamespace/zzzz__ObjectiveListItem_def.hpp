...
/// @brief Method set_title addr 0x21c5600 size 0x24 virtual false final false
 void set_title(::StringW value) ;

/// @brief Method set_conditionText addr 0x21c5624 size 0x24 virtual false final false
 void set_conditionText(::StringW value) ;

/// @brief Method set_hideCondition addr 0x21c5648 size 0x34 virtual false final false
 void set_hideCondition(bool value) ;

// Ctor Parameters []
explicit ObjectiveListItem() ;

/// @brief Method .ctor addr 0x21c567c size 0x8 virtual false final false
 void _ctor() ;
