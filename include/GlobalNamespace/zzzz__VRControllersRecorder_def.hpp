...
/// @brief Method BindToType addr 0x21d03ec size 0x84 virtual true final false
...
/// @brief Method .ctor addr 0x21cf74c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x21d0470 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x21cebfc size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_leftControllerPose addr 0x21d0478 size 0x28 virtual false final false
 UnityEngine::Pose get_leftControllerPose() ;

/// @brief Method get_rightControllerPose addr 0x21d04a0 size 0x28 virtual false final false
 UnityEngine::Pose get_rightControllerPose() ;

/// @brief Method get_headPose addr 0x21d04c8 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x21ce78c size 0x70 virtual false final false
...
/// @brief Method .ctor addr 0x21d04f0 size 0xb4 virtual false final false
...
/// @brief Method ToSerializable addr 0x21cec04 size 0x98 virtual false final false
 GlobalNamespace::GlobalNamespace__VRControllersRecorder__SavedData__KeyframeSerializable ToSerializable() ;

/// @brief Method FromSerializable addr 0x21d05a4 size 0x164 virtual false final false
...
/// @brief Method WriteTo addr 0x21d0708 size 0xb0 virtual false final false
 void WriteTo(System::IO::BinaryWriter writer) ;

/// @brief Method ReadFrom addr 0x21d07b8 size 0x184 virtual false final false
static GlobalNamespace::GlobalNamespace__VRControllersRecorder__Keyframe ReadFrom(System::IO::BinaryReader reader) ;

/// @brief Method ToConstructorString addr 0x21d093c size 0x1e0 virtual true final true
 ::StringW ToConstructorString() ;

/// @brief Method Equals addr 0x21d0b1c size 0x1e0 virtual true final true
 bool Equals(GlobalNamespace::GlobalNamespace__VRControllersRecorder__Keyframe other) ;

/// @brief Method Equals addr 0x21d0cfc size 0x9c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x21d0d98 size 0x11c virtual true final false
 int32_t GetHashCode() ;
...
static System::Action_2<System::IO::BinaryWriter,GlobalNamespace::GlobalNamespace__VRControllersRecorder__Keyframe> __declspec(property(get=__get___9__12_0, put=__set___9__12_0))  __9__12_0;

static void __set___9__12_0(System::Action_2<System::IO::BinaryWriter,GlobalNamespace::GlobalNamespace__VRControllersRecorder__Keyframe> value) ;

static System::Action_2<System::IO::BinaryWriter,GlobalNamespace::GlobalNamespace__VRControllersRecorder__Keyframe> __get___9__12_0() ;
...
/// @brief Method .ctor addr 0x21d11c4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <WriteTo>b__12_0 addr 0x21d11cc size 0x14 virtual false final false
 void _WriteTo_b__12_0(System::IO::BinaryWriter binaryWriter, GlobalNamespace::GlobalNamespace__VRControllersRecorder__Keyframe keyframe) ;
...
constexpr System::Collections::Generic::List_1<GlobalNamespace::GlobalNamespace__VRControllersRecorder__Keyframe> __get__keyframes() const;
 ...
 UnityEngine::Pose __declspec(property(get=__get_leftControllerOffset, put=__set_leftControllerOffset))  leftControllerOffset;

constexpr void __set_leftControllerOffset(UnityEngine::Pose value) ;

constexpr UnityEngine::Pose __get_leftControllerOffset() const;

 UnityEngine::Pose __declspec(property(get=__get_rightControllerOffset, put=__set_rightControllerOffset))  rightControllerOffset;

constexpr void __set_rightControllerOffset(UnityEngine::Pose value) ;

constexpr UnityEngine::Pose __get_rightControllerOffset() const;
...
/// @brief Method .ctor addr 0x21d0eb4 size 0xf0 virtual false final false
...
/// @brief Method .ctor addr 0x21d1010 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x21d0fa4 size 0x6c virtual false final false
...
// Ctor Parameters []
explicit GlobalNamespace__VRControllersRecorder__State() ;

/// @brief Method .ctor addr 0x21cd388 size 0x80 virtual false final false
 void _ctor() ;

/// @brief Method get_keyframes addr 0x21d1088 size 0x8 virtual false final false
...
/// @brief Method get_version addr 0x21d1090 size 0x8 virtual false final false
 uint32_t get_version() ;

/// @brief Method WriteTo addr 0x21cecdc size 0x158 virtual false final false
 void WriteTo(System::IO::BinaryWriter writer) ;

/// @brief Method ReadFrom addr 0x21cf574 size 0x14c virtual false final false
static GlobalNamespace::GlobalNamespace__VRControllersRecorder__State ReadFrom(System::IO::BinaryReader reader) ;

/// @brief Method FromSavedData addr 0x21cf3ac size 0x1c8 virtual false final false
...
/// @brief Method Upgrade addr 0x21d1098 size 0xc8 virtual false final false
...
/// @brief Method AddKeyframe addr 0x21ce7fc size 0xa8 virtual false final false
...
/// @brief Method set_mode addr 0x21cc538 size 0x8 virtual false final false
 void set_mode(GlobalNamespace::GlobalNamespace__VRControllersRecorder__Mode value) ;

/// @brief Method get_mode addr 0x21cc540 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__VRControllersRecorder__Mode get_mode() ;

/// @brief Method set_recordingTextAsset addr 0x21cc548 size 0x8 virtual false final false
 void set_recordingTextAsset(UnityEngine::TextAsset value) ;

/// @brief Method get_recordingTextAsset addr 0x21cc550 size 0x8 virtual false final false
 UnityEngine::TextAsset get_recordingTextAsset() ;

/// @brief Method set_recordingFileName addr 0x21cc558 size 0x8 virtual false final false
 void set_recordingFileName(::StringW value) ;

/// @brief Method get_recordingFileName addr 0x21cc560 size 0x8 virtual false final false
 ::StringW get_recordingFileName() ;

/// @brief Method set_changeToNonVRCamera addr 0x21cc568 size 0xc virtual false final false
 void set_changeToNonVRCamera(bool value) ;

/// @brief Method get_changeToNonVRCamera addr 0x21cc574 size 0x8 virtual false final false
 bool get_changeToNonVRCamera() ;

/// @brief Method Start addr 0x21cc57c size 0x65c virtual false final false
 void Start() ;

/// @brief Method HandleControllerAnchorUpdate addr 0x21cd408 size 0x194 virtual false final false
 void HandleControllerAnchorUpdate(GlobalNamespace::VRController controller, UnityEngine::Pose poseOffset) ;

/// @brief Method CheckNodes addr 0x21ccbd8 size 0x258 virtual false final false
 void CheckNodes() ;

/// @brief Method OnDestroy addr 0x21cd59c size 0xec virtual false final false
 void OnDestroy() ;

/// @brief Method SetDefaultSettings addr 0x21cda30 size 0x84 virtual false final false
 void SetDefaultSettings() ;

/// @brief Method SetInGamePlaybackDefaultSettings addr 0x21cdab4 size 0x84 virtual false final false
 void SetInGamePlaybackDefaultSettings() ;

/// @brief Method PlaybackTick addr 0x21cdb38 size 0x7c8 virtual false final false
 void PlaybackTick() ;

/// @brief Method SetPositionAndRotation addr 0x21ce300 size 0x104 virtual false final false
...
/// @brief Method RecordTick addr 0x21ce404 size 0x388 virtual false final false
 void RecordTick() ;

/// @brief Method Update addr 0x21ce8a4 size 0xe4 virtual false final false
 void Update() ;

/// @brief Method LateUpdate addr 0x21ce988 size 0x10 virtual false final false
 void LateUpdate() ;

/// @brief Method Save addr 0x21cd688 size 0x3a8 virtual false final false
 void Save() ;

/// @brief Method GetSavedData addr 0x21ce9c8 size 0x234 virtual false final false
...
/// @brief Method WriteTo addr 0x21ce998 size 0x30 virtual false final false
static void WriteTo(System::IO::BinaryWriter writer, GlobalNamespace::GlobalNamespace__VRControllersRecorder__State state) ;

/// @brief Method WriteHeader addr 0x21cec9c size 0x40 virtual false final false
static void WriteHeader(System::IO::BinaryWriter writer) ;

/// @brief Method ReadHeader addr 0x21cee34 size 0x4c virtual false final false
static uint32_t ReadHeader(System::IO::BinaryReader reader) ;

/// @brief Method Load addr 0x21cce30 size 0x558 virtual false final false
 bool Load() ;

/// @brief Method get_path addr 0x21cef18 size 0xb4 virtual false final false
 ::StringW get_path() ;

/// @brief Method LoadState addr 0x21cee80 size 0x98 virtual false final false
 GlobalNamespace::GlobalNamespace__VRControllersRecorder__State LoadState(System::IO::Stream stream) ;

/// @brief Method LoadStateWithDefaultOffset addr 0x21cf27c size 0xa0 virtual false final false
static GlobalNamespace::GlobalNamespace__VRControllersRecorder__State LoadStateWithDefaultOffset(System::IO::Stream stream) ;

/// @brief Method LoadState addr 0x21cefcc size 0x2b0 virtual false final false
...
/// @brief Method GetBinaryFormatter addr 0x21cf6c0 size 0x8c virtual false final false
static System::Runtime::Serialization::Formatters::Binary::BinaryFormatter GetBinaryFormatter() ;

/// @brief Method LoadSavedData addr 0x21cf31c size 0x90 virtual false final false
static GlobalNamespace::GlobalNamespace__VRControllersRecorder__SavedData LoadSavedData(System::IO::Stream dataStream) ;

/// @brief Method SerializeSavedData addr 0x21cf754 size 0x34 virtual false final false
...
/// @brief Method CreateAnimationClipFromRecording addr 0x21cf788 size 0xbf8 virtual false final false
...
/// @brief Method .ctor addr 0x21d0380 size 0x6c virtual false final false
 void _ctor() ;
