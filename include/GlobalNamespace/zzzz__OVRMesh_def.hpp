...
/// @brief Method get_IsInitialized addr 0x2655eb8 size 0x8 virtual false final false
 bool get_IsInitialized() ;

/// @brief Method set_IsInitialized addr 0x2655ec0 size 0xc virtual false final false
 void set_IsInitialized(bool value) ;

/// @brief Method get_Mesh addr 0x2655ecc size 0x8 virtual false final false
 UnityEngine::Mesh get_Mesh() ;

/// @brief Method Awake addr 0x2655ed4 size 0xf4 virtual false final false
 void Awake() ;

/// @brief Method ShouldInitialize addr 0x2655fc8 size 0x20 virtual false final false
 bool ShouldInitialize() ;

/// @brief Method Initialize addr 0x2655fe8 size 0xbc virtual false final false
 void Initialize(GlobalNamespace::GlobalNamespace__OVRMesh__MeshType meshType) ;

/// @brief Method TransformOvrpMesh addr 0x26560a4 size 0xab4 virtual false final false
 void TransformOvrpMesh(GlobalNamespace::GlobalNamespace__OVRPlugin__Mesh ovrpMesh, UnityEngine::Mesh mesh) ;

// Ctor Parameters []
explicit OVRMesh() ;

/// @brief Method .ctor addr 0x2656b58 size 0x10 virtual false final false
 void _ctor() ;
