...
/// @brief Method get_lobbyActivated addr 0x21863ec size 0x8 virtual false final false
 bool get_lobbyActivated() ;

/// @brief Method set_lobbyActivated addr 0x21863f4 size 0xc virtual false final false
 void set_lobbyActivated(bool value) ;

/// @brief Method ActivateMultiplayerLobby addr 0x2186400 size 0x94 virtual false final false
 void ActivateMultiplayerLobby() ;

/// @brief Method DeactivateMultiplayerLobby addr 0x2186494 size 0x70 virtual false final false
 void DeactivateMultiplayerLobby() ;

// Ctor Parameters []
explicit MultiplayerLobbyController() ;

/// @brief Method .ctor addr 0x2186504 size 0x14 virtual false final false
 void _ctor() ;
