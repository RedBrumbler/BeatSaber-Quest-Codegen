...
/// @brief Method MurmurHash2 addr 0x1221be0 size 0x174 virtual false final false
...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15106))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15106), inst: 2 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15106))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15106), inst: 2535 })
// CS Name: BloomFilterUtil::<>c__DisplayClass2_0`1
