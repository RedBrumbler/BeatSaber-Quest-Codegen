...
/// @brief Method Awake addr 0x22a1708 size 0x11c virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x22a1824 size 0x124 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x22a1948 size 0x9c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleBeatmapEvent addr 0x22a19e4 size 0xdc virtual false final false
 void HandleBeatmapEvent(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

/// @brief Method GetPositionForValue addr 0x22a1ac0 size 0x5c virtual false final false
 UnityEngine::Vector3 GetPositionForValue(int32_t value) ;

/// @brief Method SetPosition addr 0x22a1b1c size 0x8c virtual false final false
 void SetPosition(UnityEngine::Vector3 position) ;

// Ctor Parameters []
explicit SmoothStepPositionGroupEventEffect() ;

/// @brief Method .ctor addr 0x22a1ba8 size 0xac virtual false final false
 void _ctor() ;
