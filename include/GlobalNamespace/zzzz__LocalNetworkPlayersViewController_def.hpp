...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5828))}
...
/// @brief Method get_myPartyTitle addr 0x21a8a2c size 0x40 virtual true final false
 ::StringW get_myPartyTitle() ;

/// @brief Method get_otherPlayersTitle addr 0x21a8a6c size 0x40 virtual true final false
 ::StringW get_otherPlayersTitle() ;

/// @brief Method get_networkPlayerModel addr 0x21a8aac size 0x8 virtual true final false
 GlobalNamespace::INetworkPlayerModel get_networkPlayerModel() ;

/// @brief Method NetworkPlayersViewControllerDidActivate addr 0x21a8ab4 size 0x150 virtual true final false
 void NetworkPlayersViewControllerDidActivate(bool firstActivation, bool addedToHierarchy) ;

/// @brief Method DidDeactivate addr 0x21a8dac size 0x10 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method OnDestroy addr 0x21a8dbc size 0x28 virtual true final false
 void OnDestroy() ;

/// @brief Method HandleNetworkingToggleChanged addr 0x21a8dec size 0x10 virtual false final false
 void HandleNetworkingToggleChanged(bool enabled) ;

/// @brief Method HandleOpenPartyToggleChanged addr 0x21a8dfc size 0x10 virtual false final false
 void HandleOpenPartyToggleChanged(bool openParty) ;

/// @brief Method RefreshParty addr 0x21a8c04 size 0x1a8 virtual false final false
 void RefreshParty(bool overrideHide) ;

// Ctor Parameters []
explicit LocalNetworkPlayersViewController() ;

/// @brief Method .ctor addr 0x21a8e0c size 0x8 virtual false final false
 void _ctor() ;
