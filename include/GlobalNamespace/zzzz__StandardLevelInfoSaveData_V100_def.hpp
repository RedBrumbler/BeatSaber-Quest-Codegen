...
/// @brief Method get_difficulty addr 0x2227cdc size 0x8 virtual false final false
 ::StringW get_difficulty() ;

/// @brief Method get_difficultyRank addr 0x2227ce4 size 0x8 virtual false final false
 int32_t get_difficultyRank() ;

/// @brief Method get_beatmapFilename addr 0x2227cec size 0x8 virtual false final false
 ::StringW get_beatmapFilename() ;

/// @brief Method get_noteJumpMovementSpeed addr 0x2227cf4 size 0x8 virtual false final false
 float_t get_noteJumpMovementSpeed() ;

/// @brief Method get_noteJumpStartBeatOffset addr 0x2227cfc size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2227d04 size 0x58 virtual false final false
...
/// @brief Method get_version addr 0x2227d5c size 0x8 virtual false final false
 ::StringW get_version() ;

// Ctor Parameters []
explicit GlobalNamespace__StandardLevelInfoSaveData_V100__VersionCheck() ;

/// @brief Method .ctor addr 0x2227d64 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_version addr 0x222799c size 0x8 virtual false final false
 ::StringW get_version() ;

/// @brief Method get_songName addr 0x22279a4 size 0x8 virtual false final false
 ::StringW get_songName() ;

/// @brief Method get_songSubName addr 0x22279ac size 0x8 virtual false final false
 ::StringW get_songSubName() ;

/// @brief Method get_songAuthorName addr 0x22279b4 size 0x8 virtual false final false
 ::StringW get_songAuthorName() ;

/// @brief Method get_levelAuthorName addr 0x22279bc size 0x8 virtual false final false
 ::StringW get_levelAuthorName() ;

/// @brief Method get_beatsPerMinute addr 0x22279c4 size 0x8 virtual false final false
 float_t get_beatsPerMinute() ;

/// @brief Method get_songTimeOffset addr 0x22279cc size 0x8 virtual false final false
 float_t get_songTimeOffset() ;

/// @brief Method get_shuffle addr 0x22279d4 size 0x8 virtual false final false
 float_t get_shuffle() ;

/// @brief Method get_shufflePeriod addr 0x22279dc size 0x8 virtual false final false
 float_t get_shufflePeriod() ;

/// @brief Method get_previewStartTime addr 0x22279e4 size 0x8 virtual false final false
 float_t get_previewStartTime() ;

/// @brief Method get_previewDuration addr 0x22279ec size 0x8 virtual false final false
 float_t get_previewDuration() ;

/// @brief Method get_songFilename addr 0x22279f4 size 0x8 virtual false final false
 ::StringW get_songFilename() ;

/// @brief Method get_coverImageFilename addr 0x22279fc size 0x8 virtual false final false
 ::StringW get_coverImageFilename() ;

/// @brief Method get_environmentName addr 0x2227a04 size 0x8 virtual false final false
 ::StringW get_environmentName() ;

/// @brief Method get_difficultyBeatmaps addr 0x2227a0c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2227a14 size 0xdc virtual false final false
 void _ctor(::StringW songName, ::StringW songSubName, ::StringW songAuthorName, ::StringW levelAuthorName, float_t beatsPerMinute, float_t songTimeOffset, float_t shuffle, float_t shufflePeriod, float_t previewStartTime, float_t previewDuration, ::StringW songFilename, ::StringW coverImageFilename, ::ArrayW<GlobalNamespace::GlobalNamespace__StandardLevelInfoSaveData_V100__DifficultyBeatmap> difficultyBeatmaps) ;

/// @brief Method get_hasAllData addr 0x2227af0 size 0x64 virtual false final false
 bool get_hasAllData() ;

/// @brief Method SetSongFilename addr 0x2227b54 size 0x8 virtual false final false
 void SetSongFilename(::StringW songFilename) ;

/// @brief Method SerializeToJSONString addr 0x2227b5c size 0x8 virtual false final false
 ::StringW SerializeToJSONString() ;

/// @brief Method DeserializeFromJSONString addr 0x2227b64 size 0x178 virtual false final false
