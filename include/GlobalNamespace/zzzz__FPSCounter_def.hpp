...
/// @brief Method get_currentFPS addr 0x214d5d0 size 0x8 virtual false final false
 int32_t get_currentFPS() ;

/// @brief Method set_currentFPS addr 0x214d5d8 size 0x8 virtual false final false
 void set_currentFPS(int32_t value) ;

/// @brief Method get_lowestFPS addr 0x214d5e0 size 0x8 virtual false final false
 int32_t get_lowestFPS() ;

/// @brief Method set_lowestFPS addr 0x214d5e8 size 0x8 virtual false final false
 void set_lowestFPS(int32_t value) ;

/// @brief Method get_highestFPS addr 0x214d5f0 size 0x8 virtual false final false
 int32_t get_highestFPS() ;

/// @brief Method set_highestFPS addr 0x214d5f8 size 0x8 virtual false final false
 void set_highestFPS(int32_t value) ;

/// @brief Method get_droppedFrames addr 0x214d600 size 0x8 virtual false final false
 int32_t get_droppedFrames() ;

/// @brief Method set_droppedFrames addr 0x214d608 size 0x8 virtual false final false
 void set_droppedFrames(int32_t value) ;

/// @brief Method Awake addr 0x214d610 size 0x10 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x214d620 size 0xac virtual false final false
 void Update() ;

// Ctor Parameters []
explicit FPSCounter() ;

/// @brief Method .ctor addr 0x214d6cc size 0x10 virtual false final false
 void _ctor() ;
