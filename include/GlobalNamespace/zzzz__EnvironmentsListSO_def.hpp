...
/// @brief Method get_environmentInfos addr 0x21f5d30 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::EnvironmentInfoSO> get_environmentInfos() ;

/// @brief Method GetEnvironmentInfoBySerializedName addr 0x21f5d38 size 0x80 virtual false final false
 GlobalNamespace::EnvironmentInfoSO GetEnvironmentInfoBySerializedName(::StringW environmentSerializedName) ;

/// @brief Method GetAllEnvironmentInfosWithType addr 0x21f5db8 size 0x178 virtual false final false
...
/// @brief Method GetFirstEnvironmentInfoWithType addr 0x21f5f30 size 0x84 virtual false final false
 GlobalNamespace::EnvironmentInfoSO GetFirstEnvironmentInfoWithType(GlobalNamespace::EnvironmentTypeSO environmentType) ;

/// @brief Method GetLastEnvironmentInfoWithType addr 0x21f5fb4 size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x21f6034 size 0x8 virtual false final false
 void _ctor() ;
