...
/// @brief Method get_time addr 0x22b3438 size 0x8 virtual false final false
 float_t get_time() ;

/// @brief Method set_time addr 0x22b3440 size 0x8 virtual false final false
 void set_time(float_t value) ;

/// @brief Method get_lineIndex addr 0x22b3448 size 0x8 virtual false final false
 int32_t get_lineIndex() ;

/// @brief Method set_lineIndex addr 0x22b3450 size 0x8 virtual false final false
 void set_lineIndex(int32_t value) ;

/// @brief Method get_gameplayType addr 0x22b3458 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__NoteData__GameplayType get_gameplayType() ;

/// @brief Method set_gameplayType addr 0x22b3460 size 0x8 virtual false final false
 void set_gameplayType(GlobalNamespace::GlobalNamespace__NoteData__GameplayType value) ;

/// @brief Method get_colorType addr 0x22b3468 size 0x8 virtual false final false
 GlobalNamespace::ColorType get_colorType() ;

/// @brief Method set_colorType addr 0x22b3470 size 0x8 virtual false final false
 void set_colorType(GlobalNamespace::ColorType value) ;

/// @brief Method get_cutDirection addr 0x22b3478 size 0x8 virtual false final false
 GlobalNamespace::NoteCutDirection get_cutDirection() ;

/// @brief Method set_cutDirection addr 0x22b3480 size 0x8 virtual false final false
 void set_cutDirection(GlobalNamespace::NoteCutDirection value) ;

/// @brief Method get_noteLineLayer addr 0x22b3488 size 0x8 virtual false final false
 GlobalNamespace::NoteLineLayer get_noteLineLayer() ;

/// @brief Method set_noteLineLayer addr 0x22b3490 size 0x8 virtual false final false
 void set_noteLineLayer(GlobalNamespace::NoteLineLayer value) ;

/// @brief Method get_duration addr 0x22b3498 size 0x8 virtual false final false
 float_t get_duration() ;

/// @brief Method set_duration addr 0x22b34a0 size 0x8 virtual false final false
 void set_duration(float_t value) ;

/// @brief Method Mirror addr 0x22b34a8 size 0x58 virtual true final false
 void Mirror(int32_t lineCount) ;

// Ctor Parameters []
explicit MockNoteData() ;

/// @brief Method .ctor addr 0x22b3500 size 0x8 virtual false final false
 void _ctor() ;
