...
/// @brief Method get_RequestId addr 0x1fb3f70 size 0x8 virtual false final false
 uint64_t get_RequestId() ;

// Ctor Parameters []
explicit HMAutoincrementedRequestId() ;

/// @brief Method .ctor addr 0x1fb3da0 size 0x64 virtual false final false
 void _ctor() ;

/// @brief Method Equals addr 0x1fb3f78 size 0x20 virtual true final true
 bool Equals(GlobalNamespace::HMAutoincrementedRequestId obj) ;

/// @brief Method Equals addr 0x1fb3f98 size 0xb8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x1fb4050 size 0x28 virtual true final false
 int32_t GetHashCode() ;
