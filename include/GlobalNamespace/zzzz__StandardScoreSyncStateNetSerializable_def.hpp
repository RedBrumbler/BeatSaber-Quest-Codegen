...
/// @brief Method get_pool addr 0xddd75c size 0x40 virtual false final false
static GlobalNamespace::PacketPool_1<GlobalNamespace::StandardScoreSyncStateNetSerializable> get_pool() ;

/// @brief Method get_id addr 0xddd79c size 0x8 virtual true final true
 GlobalNamespace::SyncStateId get_id() ;

/// @brief Method set_id addr 0xddd7a4 size 0x8 virtual true final true
 void set_id(GlobalNamespace::SyncStateId value) ;

/// @brief Method get_time addr 0xddd7ac size 0x8 virtual true final true
 float_t get_time() ;

/// @brief Method set_time addr 0xddd7b4 size 0x8 virtual true final true
 void set_time(float_t value) ;

/// @brief Method get_state addr 0xddd7bc size 0x14 virtual true final true
 GlobalNamespace::StandardScoreSyncState get_state() ;

/// @brief Method set_state addr 0xddd7d0 size 0x14 virtual true final true
 void set_state(GlobalNamespace::StandardScoreSyncState value) ;

/// @brief Method Serialize addr 0xddd7e4 size 0x4c virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0xddd830 size 0x4c virtual true final true
 void Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method Release addr 0xddd87c size 0x54 virtual true final true
 void Release() ;

// Ctor Parameters []
explicit StandardScoreSyncStateNetSerializable() ;

/// @brief Method .ctor addr 0xddd8d0 size 0x8 virtual false final false
 void _ctor() ;
