...
/// @brief Method set_tickerColor addr 0x21541ac size 0x24 virtual false final false
 void set_tickerColor(UnityEngine::Color value) ;

/// @brief Method set_movingTickerColor addr 0x21541d0 size 0x24 virtual false final false
 void set_movingTickerColor(UnityEngine::Color value) ;

/// @brief Method set_zeroOffset addr 0x21541f4 size 0x10 virtual false final false
 void set_zeroOffset(float_t value) ;

/// @brief Method get_zeroOffset addr 0x2154204 size 0x8 virtual false final false
 float_t get_zeroOffset() ;

/// @brief Method Awake addr 0x215420c size 0x98 virtual false final false
 void Awake() ;

/// @brief Method OnEnable addr 0x21542a4 size 0x48 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x21542ec size 0x48 virtual false final false
 void OnDisable() ;

/// @brief Method Update addr 0x2154334 size 0x150 virtual false final false
 void Update() ;

/// @brief Method SetMovingTickerNormalizedPosition addr 0x2154484 size 0xc8 virtual false final false
 void SetMovingTickerNormalizedPosition(float_t t) ;

// Ctor Parameters []
explicit VisualMetronome() ;

/// @brief Method .ctor addr 0x215454c size 0x3c virtual false final false
 void _ctor() ;
