...
/// @brief Method SaveToOldFormat addr 0x21dc7f0 size 0x4 virtual true final true
 void SaveToOldFormat(::StringW path, GlobalNamespace::PosesRecordingData data) ;

/// @brief Method SaveRecording addr 0x21dc7f4 size 0x4 virtual true final true
 void SaveRecording(::StringW path, GlobalNamespace::PosesRecordingData data, bool saveToOldFormat) ;

/// @brief Method LoadRecording addr 0x21dc7f8 size 0x8 virtual true final true
 GlobalNamespace::PosesRecordingData LoadRecording(::StringW path) ;

/// @brief Method RecordingExists addr 0x21dc800 size 0x8 virtual true final true
 bool RecordingExists(::StringW path) ;

/// @brief Method RecordingCanBeCreated addr 0x21dc808 size 0x8 virtual true final true
 bool RecordingCanBeCreated(::StringW path) ;

// Ctor Parameters []
explicit EmptyPosesSerializer() ;

/// @brief Method .ctor addr 0x21dc810 size 0x8 virtual false final false
 void _ctor() ;
