...
/// @brief Method get_color addr 0x1fdbce0 size 0x20 virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method ColorWasSet addr 0x1fdbd00 size 0x58 virtual true final false
 void ColorWasSet(UnityEngine::Color color) ;

// Ctor Parameters []
explicit TubeBloomPrePassLightWithId() ;

/// @brief Method .ctor addr 0x1fdbd58 size 0x8 virtual false final false
 void _ctor() ;
