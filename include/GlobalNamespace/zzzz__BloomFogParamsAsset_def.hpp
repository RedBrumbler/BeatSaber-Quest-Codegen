...
/// @brief Method get_clipCaps addr 0x21ea628 size 0x8 virtual true final true
 UnityEngine::Timeline::ClipCaps get_clipCaps() ;

/// @brief Method CreatePlayable addr 0x21ea630 size 0xa8 virtual true final false
 UnityEngine::Playables::Playable CreatePlayable(UnityEngine::Playables::PlayableGraph graph, UnityEngine::GameObject go) ;

// Ctor Parameters []
explicit BloomFogParamsAsset() ;

/// @brief Method .ctor addr 0x21ea6d8 size 0x8 virtual false final false
 void _ctor() ;
