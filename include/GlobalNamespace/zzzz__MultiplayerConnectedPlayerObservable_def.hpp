...
/// @brief Method .ctor addr 0x2128f48 size 0x28 virtual false final false
 void _ctor(GlobalNamespace::IConnectedPlayer connectedPlayer) ;

/// @brief Method get_offsetSyncTime addr 0x2128f70 size 0xa4 virtual true final true
 float_t get_offsetSyncTime() ;

/// @brief Method get_isFailed addr 0x2129014 size 0xc virtual true final true
 bool get_isFailed() ;
