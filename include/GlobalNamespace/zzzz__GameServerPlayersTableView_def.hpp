...
/// @brief Method add_selectSuggestedLevelEvent addr 0x21b1320 size 0xb0 virtual false final false
 void add_selectSuggestedLevelEvent(System::Action_1<GlobalNamespace::PreviewDifficultyBeatmap> value) ;

/// @brief Method remove_selectSuggestedLevelEvent addr 0x21b1d54 size 0xb0 virtual false final false
 void remove_selectSuggestedLevelEvent(System::Action_1<GlobalNamespace::PreviewDifficultyBeatmap> value) ;

/// @brief Method add_selectSuggestedGameplayModifiersEvent addr 0x21b13d0 size 0xb0 virtual false final false
 void add_selectSuggestedGameplayModifiersEvent(System::Action_1<GlobalNamespace::GameplayModifiers> value) ;

/// @brief Method remove_selectSuggestedGameplayModifiersEvent addr 0x21b1e04 size 0xb0 virtual false final false
 void remove_selectSuggestedGameplayModifiersEvent(System::Action_1<GlobalNamespace::GameplayModifiers> value) ;

/// @brief Method add_kickPlayerEvent addr 0x21b1480 size 0xb0 virtual false final false
 void add_kickPlayerEvent(System::Action_1<::StringW> value) ;

/// @brief Method remove_kickPlayerEvent addr 0x21b1eb4 size 0xb0 virtual false final false
 void remove_kickPlayerEvent(System::Action_1<::StringW> value) ;

/// @brief Method CellSize addr 0x21bd8d0 size 0xc virtual true final true
 float_t CellSize() ;

/// @brief Method NumberOfCells addr 0x21bd8dc size 0x48 virtual true final true
 int32_t NumberOfCells() ;

/// @brief Method get_currentCellId addr 0x21bd924 size 0x84 virtual false final false
 ::StringW get_currentCellId() ;

/// @brief Method GetCurrentPrefab addr 0x21bd9a8 size 0x9c virtual false final false
 GlobalNamespace::GameServerPlayerTableCell GetCurrentPrefab() ;

/// @brief Method CellForIdx addr 0x21bda44 size 0x500 virtual true final true
 HMUI::TableCell CellForIdx(HMUI::TableView tableView, int32_t idx) ;

/// @brief Method TryGetLobbyPlayerData addr 0x21bdf44 size 0x164 virtual false final false
...
/// @brief Method HandleCellUseBeatmap addr 0x21be0a8 size 0x268 virtual false final false
 void HandleCellUseBeatmap(int32_t idx) ;

/// @brief Method HandleCellUseModifiers addr 0x21be310 size 0x254 virtual false final false
 void HandleCellUseModifiers(int32_t idx) ;

/// @brief Method HandleCellKickPlayer addr 0x21be564 size 0xfc virtual false final false
 void HandleCellKickPlayer(int32_t idx) ;

/// @brief Method SetData addr 0x21b1f70 size 0xbc virtual false final false
...
/// @brief Method Init addr 0x21be660 size 0x3c virtual false final false
 void Init() ;

// Ctor Parameters []
explicit GameServerPlayersTableView() ;

/// @brief Method .ctor addr 0x21be69c size 0x18 virtual false final false
 void _ctor() ;
