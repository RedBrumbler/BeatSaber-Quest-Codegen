...
/// @brief Method IsEmpty addr 0x216716c size 0x20 virtual false final false
 bool IsEmpty() ;

/// @brief Method ToString addr 0x216718c size 0xc4 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit GlobalNamespace__CreditsData__Text() ;

/// @brief Method .ctor addr 0x2167250 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method HasTitle addr 0x2167258 size 0x10 virtual false final false
 bool HasTitle() ;

/// @brief Method HasText addr 0x2167268 size 0x10 virtual false final false
 bool HasText() ;

/// @brief Method HasRowItems addr 0x2167278 size 0x20 virtual false final false
 bool HasRowItems() ;

// Ctor Parameters []
explicit GlobalNamespace__CreditsData__RootCreditsItem() ;

/// @brief Method .ctor addr 0x2167298 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method HasTitle addr 0x21672a0 size 0x10 virtual false final false
 bool HasTitle() ;

/// @brief Method HasText addr 0x21672b0 size 0x10 virtual false final false
 bool HasText() ;

// Ctor Parameters []
explicit GlobalNamespace__CreditsData__ChildCreditsItem() ;

/// @brief Method .ctor addr 0x21672c0 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Deserialize addr 0x2167060 size 0x104 virtual false final false
static GlobalNamespace::CreditsData Deserialize(::StringW text) ;

// Ctor Parameters []
explicit CreditsData() ;

/// @brief Method .ctor addr 0x2167164 size 0x8 virtual false final false
 void _ctor() ;
