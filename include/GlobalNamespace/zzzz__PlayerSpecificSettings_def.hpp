...
constexpr GlobalNamespace::EnvironmentEffectsFilterPreset __get__environmentEffectsFilterExpertPlusPreset() const;
 ...
 float_t __declspec(property(get=__get__headsetHapticIntensity, put=__set__headsetHapticIntensity))  _headsetHapticIntensity;

constexpr void __set__headsetHapticIntensity(float_t value) ;

constexpr float_t __get__headsetHapticIntensity() const;
...
// Properties
 ...
 float_t __declspec(property(get=get_headsetHapticIntensity))  headsetHapticIntensity;


// Methods

/// @brief Method get_leftHanded addr 0x2261868 size 0x8 virtual false final false
 bool get_leftHanded() ;

/// @brief Method get_playerHeight addr 0x2261870 size 0x8 virtual false final false
 float_t get_playerHeight() ;

/// @brief Method get_automaticPlayerHeight addr 0x2261878 size 0x8 virtual false final false
 bool get_automaticPlayerHeight() ;

/// @brief Method get_sfxVolume addr 0x2261880 size 0x8 virtual false final false
 float_t get_sfxVolume() ;

/// @brief Method get_reduceDebris addr 0x2261888 size 0x8 virtual false final false
 bool get_reduceDebris() ;

/// @brief Method get_noTextsAndHuds addr 0x2261890 size 0x8 virtual false final false
 bool get_noTextsAndHuds() ;

/// @brief Method get_noFailEffects addr 0x2261898 size 0x8 virtual false final false
 bool get_noFailEffects() ;

/// @brief Method get_advancedHud addr 0x22618a0 size 0x8 virtual false final false
 bool get_advancedHud() ;

/// @brief Method get_autoRestart addr 0x22618a8 size 0x8 virtual false final false
 bool get_autoRestart() ;

/// @brief Method get_saberTrailIntensity addr 0x22618b0 size 0x8 virtual false final false
 float_t get_saberTrailIntensity() ;

/// @brief Method get_noteJumpDurationTypeSettings addr 0x22618b8 size 0x8 virtual false final false
 GlobalNamespace::NoteJumpDurationTypeSettings get_noteJumpDurationTypeSettings() ;

/// @brief Method get_noteJumpFixedDuration addr 0x22618c0 size 0x8 virtual false final false
 float_t get_noteJumpFixedDuration() ;

/// @brief Method get_noteJumpStartBeatOffset addr 0x22618c8 size 0x8 virtual false final false
 float_t get_noteJumpStartBeatOffset() ;

/// @brief Method get_hideNoteSpawnEffect addr 0x22618d0 size 0x8 virtual false final false
 bool get_hideNoteSpawnEffect() ;

/// @brief Method get_adaptiveSfx addr 0x22618d8 size 0x8 virtual false final false
 bool get_adaptiveSfx() ;

/// @brief Method get_arcsHapticFeedback addr 0x22618e0 size 0x8 virtual false final false
 bool get_arcsHapticFeedback() ;

/// @brief Method get_arcVisibility addr 0x22618e8 size 0x8 virtual false final false
 GlobalNamespace::ArcVisibilityType get_arcVisibility() ;

/// @brief Method get_environmentEffectsFilterDefaultPreset addr 0x22618f0 size 0x8 virtual false final false
 GlobalNamespace::EnvironmentEffectsFilterPreset get_environmentEffectsFilterDefaultPreset() ;

/// @brief Method get_environmentEffectsFilterExpertPlusPreset addr 0x22618f8 size 0x8 virtual false final false
 GlobalNamespace::EnvironmentEffectsFilterPreset get_environmentEffectsFilterExpertPlusPreset() ;

/// @brief Method get_headsetHapticIntensity addr 0x2261900 size 0x8 virtual false final false
 float_t get_headsetHapticIntensity() ;

// Ctor Parameters []
explicit PlayerSpecificSettings() ;

/// @brief Method .ctor addr 0x226071c size 0x78 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x22602f8 size 0x128 virtual false final false
...
/// @brief Method CopyWith addr 0x2260794 size 0x3d4 virtual false final false
...
/// @brief Method GetEnvironmentEffectsFilterPreset addr 0x2261908 size 0x18 virtual false final false
