...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5892))}
...
/// @brief Method get_editButton addr 0x21bd830 size 0x8 virtual false final false
 UnityEngine::UI::Button get_editButton() ;

/// @brief Method get_clearButton addr 0x21bd838 size 0x8 virtual false final false
 UnityEngine::UI::Button get_clearButton() ;

/// @brief Method get_interactable addr 0x21bd840 size 0x8 virtual false final false
 bool get_interactable() ;

/// @brief Method set_interactable addr 0x21af080 size 0x60 virtual false final false
 void set_interactable(bool value) ;

/// @brief Method get_showClearButton addr 0x21bd848 size 0x8 virtual false final false
 bool get_showClearButton() ;

/// @brief Method set_showClearButton addr 0x21bd850 size 0xc virtual false final false
 void set_showClearButton(bool value) ;

/// @brief Method SetVisibility addr 0x21aea78 size 0x28 virtual false final false
 void SetVisibility(bool visible) ;

/// @brief Method Setup addr 0x21aea6c size 0xc virtual false final false
 void Setup(bool showClearButton) ;

/// @brief Method SetGameplayModifiers addr 0x21bd85c size 0x64 virtual true final false
 void SetGameplayModifiers(GlobalNamespace::GameplayModifiers gameplayModifiers) ;

// Ctor Parameters []
explicit EditableModifiersSelectionView() ;

/// @brief Method .ctor addr 0x21bd8c0 size 0x10 virtual false final false
 void _ctor() ;
