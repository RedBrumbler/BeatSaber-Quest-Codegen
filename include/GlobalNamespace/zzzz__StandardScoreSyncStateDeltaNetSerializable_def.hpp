...
/// @brief Method get_pool addr 0xddd510 size 0x40 virtual false final false
static GlobalNamespace::IPacketPool_1<GlobalNamespace::StandardScoreSyncStateDeltaNetSerializable> get_pool() ;

/// @brief Method get_baseId addr 0xddd550 size 0x8 virtual true final true
 GlobalNamespace::SyncStateId get_baseId() ;

/// @brief Method set_baseId addr 0xddd558 size 0x8 virtual true final true
 void set_baseId(GlobalNamespace::SyncStateId value) ;

/// @brief Method get_timeOffsetMs addr 0xddd560 size 0x8 virtual true final true
 int32_t get_timeOffsetMs() ;

/// @brief Method set_timeOffsetMs addr 0xddd568 size 0x8 virtual true final true
 void set_timeOffsetMs(int32_t value) ;

/// @brief Method get_delta addr 0xddd570 size 0x14 virtual true final true
 GlobalNamespace::StandardScoreSyncState get_delta() ;

/// @brief Method set_delta addr 0xddd584 size 0x14 virtual true final true
 void set_delta(GlobalNamespace::StandardScoreSyncState value) ;

/// @brief Method Serialize addr 0xddd598 size 0xb0 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0xddd648 size 0x60 virtual true final true
 void Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method Release addr 0xddd6a8 size 0xac virtual true final true
 void Release() ;

// Ctor Parameters []
explicit StandardScoreSyncStateDeltaNetSerializable() ;

/// @brief Method .ctor addr 0xddd754 size 0x8 virtual false final false
 void _ctor() ;
