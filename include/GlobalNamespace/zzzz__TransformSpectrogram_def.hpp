...
/// @brief Method Awake addr 0x22a60b4 size 0x188 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x22a623c size 0x268 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit TransformSpectrogram() ;

/// @brief Method .ctor addr 0x22a64a4 size 0x1c virtual false final false
 void _ctor() ;
