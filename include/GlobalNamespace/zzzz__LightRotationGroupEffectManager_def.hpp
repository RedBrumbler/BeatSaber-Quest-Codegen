...
/// @brief Method Start addr 0x2298ca8 size 0x564 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x229920c size 0x148 virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit LightRotationGroupEffectManager() ;

/// @brief Method .ctor addr 0x2299354 size 0x7c virtual false final false
 void _ctor() ;
