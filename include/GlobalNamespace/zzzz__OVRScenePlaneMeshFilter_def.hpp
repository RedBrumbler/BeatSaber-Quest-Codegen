...
/// @brief Method get_Count addr 0x263bda4 size 0x8 virtual false final false
 int32_t get_Count() ;

/// @brief Method set_Count addr 0x263bdac size 0x8 virtual false final false
 void set_Count(int32_t value) ;

/// @brief Method .ctor addr 0x263bbc4 size 0xa4 virtual false final false
 void _ctor(int32_t capacity, Unity::Collections::Allocator allocator) ;

/// @brief Method RemoveAt addr 0x263bd68 size 0x3c virtual false final false
 void RemoveAt(int32_t index) ;

/// @brief Method GetAt addr 0x263bc74 size 0x3c virtual false final false
 int32_t GetAt(int32_t index) ;

/// @brief Method get_Item addr 0x263bc68 size 0xc virtual false final false
 int32_t get_Item(int32_t index) ;

/// @brief Method Dispose addr 0x263bdb4 size 0x48 virtual true final true
 void Dispose() ;
...
/// @brief Method Execute addr 0x263b830 size 0x394 virtual true final true
 void Execute() ;

/// @brief Method Cross addr 0x263bcb0 size 0x10 virtual false final false
static float_t Cross(UnityEngine::Vector2 a, UnityEngine::Vector2 b) ;

/// @brief Method PointInTriangle addr 0x263bcc0 size 0xa8 virtual false final false
...
/// @brief Method Start addr 0x263a8f0 size 0x1ac virtual false final false
 void Start() ;

/// @brief Method ScheduleMeshGeneration addr 0x263aa9c size 0x5c8 virtual false final false
 void ScheduleMeshGeneration() ;

/// @brief Method Update addr 0x263b064 size 0x734 virtual false final false
 void Update() ;

/// @brief Method RequestMeshGeneration addr 0x263a538 size 0x30 virtual false final false
 void RequestMeshGeneration() ;

/// @brief Method OnDisable addr 0x263b798 size 0x90 virtual false final false
 void OnDisable() ;

// Ctor Parameters []
explicit OVRScenePlaneMeshFilter() ;

/// @brief Method .ctor addr 0x263b828 size 0x8 virtual false final false
 void _ctor() ;
