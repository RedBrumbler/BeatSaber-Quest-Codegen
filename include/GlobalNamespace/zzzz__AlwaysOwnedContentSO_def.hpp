...
/// @brief Method get_alwaysOwnedPacks addr 0x20ff9fc size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::BeatmapLevelPackSO> get_alwaysOwnedPacks() ;

/// @brief Method get_alwaysOwnedBeatmapLevels addr 0x20ffa04 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::BeatmapLevelSO> get_alwaysOwnedBeatmapLevels() ;

// Ctor Parameters []
explicit AlwaysOwnedContentSO() ;

/// @brief Method .ctor addr 0x20ffa0c size 0x8 virtual false final false
 void _ctor() ;
