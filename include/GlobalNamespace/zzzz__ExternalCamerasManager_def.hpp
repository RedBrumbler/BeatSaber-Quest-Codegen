...
/// @brief Method OnEnable addr 0x26a6d74 size 0xcc virtual false final false
 void OnEnable() ;

/// @brief Method InstantiateMixedRealityBackgroundCameraGameObject addr 0x26a6e40 size 0x80 virtual false final false
 UnityEngine::GameObject InstantiateMixedRealityBackgroundCameraGameObject(UnityEngine::GameObject mainCameraGameObject) ;

/// @brief Method InstantiateMixedRealityForegroundCameraGameObject addr 0x26a6ec0 size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x26a6f40 size 0x8 virtual false final false
 void _ctor() ;
