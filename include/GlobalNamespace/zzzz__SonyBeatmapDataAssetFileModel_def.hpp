...
/// @brief Method MoveNext addr 0x2254f54 size 0x238 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x225518c size 0x58 virtual true final true
...
/// @brief Method add_levelDataAssetDownloadUpdateEvent addr 0x2254c98 size 0xb0 virtual true final true
 void add_levelDataAssetDownloadUpdateEvent(System::Action_1<GlobalNamespace::LevelDataAssetDownloadUpdate> value) ;

/// @brief Method remove_levelDataAssetDownloadUpdateEvent addr 0x2254d48 size 0xb0 virtual true final true
 void remove_levelDataAssetDownloadUpdateEvent(System::Action_1<GlobalNamespace::LevelDataAssetDownloadUpdate> value) ;

/// @brief Method GetAssetBundleFileForPreviewLevelAsync addr 0x2254df8 size 0xec virtual true final true
...
/// @brief Method TryDeleteAssetBundleFileForPreviewLevelAsync addr 0x2254ee4 size 0x68 virtual true final true
...
/// @brief Method .ctor addr 0x2254f4c size 0x8 virtual false final false
 void _ctor() ;
