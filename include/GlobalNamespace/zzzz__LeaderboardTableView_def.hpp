...
/// @brief Method get_score addr 0x21c050c size 0x8 virtual false final false
 int32_t get_score() ;

/// @brief Method set_score addr 0x21c0514 size 0x8 virtual false final false
 void set_score(int32_t value) ;

/// @brief Method get_playerName addr 0x21c051c size 0x8 virtual false final false
 ::StringW get_playerName() ;

/// @brief Method set_playerName addr 0x21c0524 size 0x8 virtual false final false
 void set_playerName(::StringW value) ;

/// @brief Method get_rank addr 0x21c052c size 0x8 virtual false final false
 int32_t get_rank() ;

/// @brief Method set_rank addr 0x21c0534 size 0x8 virtual false final false
 void set_rank(int32_t value) ;

/// @brief Method get_fullCombo addr 0x21c053c size 0x8 virtual false final false
 bool get_fullCombo() ;

/// @brief Method set_fullCombo addr 0x21c0544 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x21c0550 size 0x4c virtual false final false
...
/// @brief Method CellSize addr 0x21c0288 size 0x8 virtual true final true
 float_t CellSize() ;

/// @brief Method NumberOfCells addr 0x21c0290 size 0x4c virtual true final true
 int32_t NumberOfCells() ;

/// @brief Method CellForIdx addr 0x21c02dc size 0x1f0 virtual true final true
 HMUI::TableCell CellForIdx(HMUI::TableView tableView, int32_t row) ;

/// @brief Method SetScores addr 0x21c04cc size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x21c04fc size 0x10 virtual false final false
 void _ctor() ;
