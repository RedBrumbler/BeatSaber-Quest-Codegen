...
/// @brief Method get_isSupported addr 0x222c7e4 size 0x8 virtual true final true
 bool get_isSupported() ;

/// @brief Method OpenInvitePanel addr 0x222c7ec size 0x60 virtual true final true
 void OpenInvitePanel() ;

// Ctor Parameters []
explicit OculusInvitePlatformHandler() ;

/// @brief Method .ctor addr 0x222c84c size 0x8 virtual false final false
 void _ctor() ;
