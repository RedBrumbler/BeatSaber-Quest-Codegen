...
/// @brief Method get_normalColor addr 0x215fe04 size 0xc virtual false final false
 UnityEngine::Color get_normalColor() ;

/// @brief Method get_highlightedColor addr 0x2160074 size 0xc virtual false final false
 UnityEngine::Color get_highlightedColor() ;

/// @brief Method get_pressedColor addr 0x21600ac size 0xc virtual false final false
 UnityEngine::Color get_pressedColor() ;

/// @brief Method get_disabledColor addr 0x21600e4 size 0xc virtual false final false
 UnityEngine::Color get_disabledColor() ;

/// @brief Method get_selectedColor addr 0x216011c size 0xc virtual false final false
 UnityEngine::Color get_selectedColor() ;

/// @brief Method get_selectedAndHighlightedColor addr 0x2160154 size 0xc virtual false final false
 UnityEngine::Color get_selectedAndHighlightedColor() ;

// Ctor Parameters []
explicit ColorTransitionSO() ;

/// @brief Method .ctor addr 0x2160960 size 0x8 virtual false final false
 void _ctor() ;
