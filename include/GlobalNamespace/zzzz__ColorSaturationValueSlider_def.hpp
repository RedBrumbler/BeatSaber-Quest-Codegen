...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13631))}
...
/// @brief Method add_colorSaturationOrValueDidChangeEvent addr 0x2154924 size 0xb4 virtual false final false
...
/// @brief Method remove_colorSaturationOrValueDidChangeEvent addr 0x21549d8 size 0xb4 virtual false final false
...
/// @brief Method Awake addr 0x2154a8c size 0x90 virtual true final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x2154b1c size 0x90 virtual true final false
 void OnDestroy() ;

/// @brief Method SetHue addr 0x2154bac size 0x14 virtual false final false
 void SetHue(float_t hue) ;

/// @brief Method UpdateVisuals addr 0x2154bc0 size 0x138 virtual true final false
 void UpdateVisuals() ;

/// @brief Method HandleNormalizedValueDidChange addr 0x2154cf8 size 0x24 virtual false final false
 void HandleNormalizedValueDidChange(HMUI::Slider2D slider, UnityEngine::Vector2 normalizedValue) ;

/// @brief Method OnPointerUp addr 0x2154d1c size 0x44 virtual true final false
 void OnPointerUp(UnityEngine::EventSystems::PointerEventData eventData) ;

// Ctor Parameters []
explicit ColorSaturationValueSlider() ;

/// @brief Method .ctor addr 0x2154d60 size 0x8 virtual false final false
 void _ctor() ;
