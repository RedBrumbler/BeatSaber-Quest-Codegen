...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (GlobalNamespace::EnabledTransitionSO::*)()>(&GlobalNamespace::EnabledTransitionSO::get_normalState)> {
  ...
  constexpr static std::size_t addrs = 0x2160968;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (GlobalNamespace::EnabledTransitionSO::*)()>(&GlobalNamespace::EnabledTransitionSO::get_highlightedState)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2160970;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (GlobalNamespace::EnabledTransitionSO::*)()>(&GlobalNamespace::EnabledTransitionSO::get_pressedState)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2160978;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (GlobalNamespace::EnabledTransitionSO::*)()>(&GlobalNamespace::EnabledTransitionSO::get_disabledState)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2160980;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (GlobalNamespace::EnabledTransitionSO::*)()>(&GlobalNamespace::EnabledTransitionSO::get_selectedState)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2160988;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (GlobalNamespace::EnabledTransitionSO::*)()>(&GlobalNamespace::EnabledTransitionSO::get_selectedAndHighlightedState)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2160990;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::EnabledTransitionSO::*)()>(&GlobalNamespace::EnabledTransitionSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2160998;
...
constexpr bool GlobalNamespace::EnabledTransitionSO::__get__normalState() const {
...
constexpr bool GlobalNamespace::EnabledTransitionSO::__get__highlightedState() const {
...
constexpr bool GlobalNamespace::EnabledTransitionSO::__get__pressedState() const {
...
constexpr bool GlobalNamespace::EnabledTransitionSO::__get__disabledState() const {
...
constexpr bool GlobalNamespace::EnabledTransitionSO::__get__selectedState() const {
...
constexpr bool GlobalNamespace::EnabledTransitionSO::__get__selectedAndHighlightedState() const {
...
// Ctor Parameters []
 GlobalNamespace::EnabledTransitionSO::EnabledTransitionSO()  : GlobalNamespace::BaseTransitionSO(THROW_UNLESS(::il2cpp_utils::New<EnabledTransitionSO>())) {}
 void GlobalNamespace::EnabledTransitionSO::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::EnabledTransitionSO>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
