...
/// @brief Method get_logString addr 0x21c9230 size 0x8 virtual false final false
 ::StringW get_logString() ;

/// @brief Method get_stackTrace addr 0x21c9238 size 0x8 virtual false final false
 ::StringW get_stackTrace() ;

/// @brief Method StartCatchingExceptions addr 0x21c9240 size 0x80 virtual false final false
 void StartCatchingExceptions() ;

/// @brief Method OnDisable addr 0x21c92c0 size 0x80 virtual false final false
 void OnDisable() ;

/// @brief Method HandleLog addr 0x21c9340 size 0xa0 virtual false final false
 void HandleLog(::StringW logString, ::StringW stackTrace, UnityEngine::LogType type) ;

// Ctor Parameters []
explicit CrashManagerSO() ;

/// @brief Method .ctor addr 0x21c93e0 size 0x8 virtual false final false
 void _ctor() ;
