...
/// @brief Method get_clip addr 0x20f1f54 size 0x1c virtual false final false
 UnityEngine::AudioClip get_clip() ;

/// @brief Method set_clip addr 0x20f1f70 size 0x40 virtual false final false
 void set_clip(UnityEngine::AudioClip value) ;

/// @brief Method set_pitch addr 0x20f1fb0 size 0x40 virtual false final false
 void set_pitch(float_t value) ;

/// @brief Method set_time addr 0x20f1ff0 size 0x40 virtual false final false
 void set_time(float_t value) ;

/// @brief Method get_isPlaying addr 0x20f2030 size 0x1c virtual false final false
 bool get_isPlaying() ;

/// @brief Method Awake addr 0x20f204c size 0x15c virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x20f21a8 size 0x88 virtual false final false
 void OnDestroy() ;

/// @brief Method PlayPitchGainEffect addr 0x20f2230 size 0x20 virtual false final false
 void PlayPitchGainEffect(float_t volumeScale) ;

/// @brief Method InterruptLastPitchGainEffect addr 0x20f2250 size 0x1c virtual false final false
 void InterruptLastPitchGainEffect() ;

/// @brief Method CrossFade addr 0x20f226c size 0x1c8 virtual false final false
 void CrossFade(float_t toSongTime, float_t toVolume) ;

/// @brief Method Play addr 0x20f2434 size 0x1c virtual false final false
 void Play() ;

/// @brief Method Stop addr 0x20f2450 size 0x50 virtual false final false
 void Stop() ;

// Ctor Parameters []
explicit CrossFadeAudioSource() ;

/// @brief Method .ctor addr 0x20f24a0 size 0x14 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__21_0 addr 0x20f24b4 size 0x1c virtual false final false
 void _Awake_b__21_0(float_t val) ;

/// @brief Method <Awake>b__21_1 addr 0x20f24d0 size 0x1c virtual false final false
 void _Awake_b__21_1(float_t val) ;

/// @brief Method <CrossFade>b__25_0 addr 0x20f24ec size 0x1c virtual false final false
 void _CrossFade_b__25_0(float_t val) ;

/// @brief Method <CrossFade>b__25_1 addr 0x20f2508 size 0x1c virtual false final false
 void _CrossFade_b__25_1(float_t val) ;

/// @brief Method <CrossFade>b__25_2 addr 0x20f2524 size 0x30 virtual false final false
