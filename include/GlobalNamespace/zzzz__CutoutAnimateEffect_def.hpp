...
/// @brief Method .ctor addr 0x22875ac size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x22876cc size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x22876d0 size 0xf8 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x22877c8 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x22877d0 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2287810 size 0x8 virtual true final true
...
/// @brief Method get_animating addr 0x2287498 size 0x8 virtual false final false
 bool get_animating() ;

/// @brief Method set_animating addr 0x22874a0 size 0xc virtual false final false
 void set_animating(bool value) ;

/// @brief Method Start addr 0x22874ac size 0x8 virtual false final false
 void Start() ;

/// @brief Method AnimateToCutoutCoroutine addr 0x2287520 size 0x8c virtual false final false
 System::Collections::IEnumerator AnimateToCutoutCoroutine(float_t cutoutStart, float_t cutoutEnd, float_t duration) ;

/// @brief Method SetCutout addr 0x22874b4 size 0x6c virtual false final false
 void SetCutout(float_t cutout) ;

/// @brief Method ResetEffect addr 0x22778d4 size 0x24 virtual false final false
 void ResetEffect() ;

/// @brief Method AnimateCutout addr 0x227f788 size 0x54 virtual false final false
 void AnimateCutout(float_t cutoutStart, float_t cutoutEnd, float_t duration) ;

// Ctor Parameters []
explicit CutoutAnimateEffect() ;

/// @brief Method .ctor addr 0x2287698 size 0x34 virtual false final false
 void _ctor() ;
