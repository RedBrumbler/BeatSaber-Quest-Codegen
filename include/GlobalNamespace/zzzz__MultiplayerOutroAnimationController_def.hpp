...
/// @brief Method Start addr 0x2133fd4 size 0xa0 virtual false final false
 void Start() ;

/// @brief Method OnValidate addr 0x2134134 size 0x7a4 virtual false final false
 void OnValidate() ;

/// @brief Method OnDestroy addr 0x21348d8 size 0xd0 virtual false final false
 void OnDestroy() ;

/// @brief Method AnimateOutro addr 0x212c5b0 size 0x1c4 virtual false final false
 void AnimateOutro(GlobalNamespace::MultiplayerResultsData multiplayerResultsData, System::Action onCompleted) ;

/// @brief Method BindOutroTimeline addr 0x2134a44 size 0x6b4 virtual false final false
 void BindOutroTimeline() ;

/// @brief Method BindRingsAndAudio addr 0x21350f8 size 0x97c virtual false final false
...
/// @brief Method SetTimelineMock addr 0x2136088 size 0x298 virtual false final false
 void SetTimelineMock(GlobalNamespace::MultiplayerTimelineMock multiplayerIntroTimelineMock, bool isDuel) ;

/// @brief Method Completed addr 0x213689c size 0x24 virtual false final false
 void Completed() ;

/// @brief Method HandlePlayerSpawningDidFinish addr 0x2134074 size 0x24 virtual false final false
 void HandlePlayerSpawningDidFinish() ;

// Ctor Parameters []
explicit MultiplayerOutroAnimationController() ;

/// @brief Method .ctor addr 0x2136cc0 size 0x8 virtual false final false
 void _ctor() ;
