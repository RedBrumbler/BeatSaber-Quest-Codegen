...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13626))}
...
/// @brief Method add_colorHueDidChangeEvent addr 0x2154588 size 0xb4 virtual false final false
...
/// @brief Method remove_colorHueDidChangeEvent addr 0x215463c size 0xb4 virtual false final false
...
/// @brief Method Awake addr 0x21546f0 size 0x90 virtual true final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x2154780 size 0x90 virtual true final false
 void OnDestroy() ;

/// @brief Method UpdateVisuals addr 0x2154810 size 0xa8 virtual true final false
 void UpdateVisuals() ;

/// @brief Method HandleNormalizedValueDidChange addr 0x21548b8 size 0x24 virtual false final false
 void HandleNormalizedValueDidChange(HMUI::CircleSlider slider, float_t normalizedValue) ;

/// @brief Method OnPointerUp addr 0x21548dc size 0x40 virtual true final false
 void OnPointerUp(UnityEngine::EventSystems::PointerEventData eventData) ;

// Ctor Parameters []
explicit ColorHueSlider() ;

/// @brief Method .ctor addr 0x215491c size 0x8 virtual false final false
 void _ctor() ;
