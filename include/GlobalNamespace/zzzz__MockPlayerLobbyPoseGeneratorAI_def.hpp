...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15519))}
...
/// @brief Method .ctor addr 0x22b7bf0 size 0x4 virtual false final false
 void _ctor(GlobalNamespace::IMultiplayerSessionManager multiplayerSessionManager) ;

/// @brief Method Init addr 0x22b864c size 0x2d0 virtual true final false
 void Init() ;

/// @brief Method Tick addr 0x22b891c size 0x9d8 virtual true final false
 void Tick() ;
