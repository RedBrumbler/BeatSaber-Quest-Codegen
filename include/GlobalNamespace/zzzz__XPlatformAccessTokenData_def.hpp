...
/// @brief Method get_token addr 0xdd49f8 size 0x8 virtual false final false
 ::StringW get_token() ;

/// @brief Method set_token addr 0xdd4a00 size 0x8 virtual false final false
 void set_token(::StringW value) ;

/// @brief Method get_platformEnvironment addr 0xdd4a08 size 0x8 virtual false final false
 GlobalNamespace::PlatformEnvironment get_platformEnvironment() ;

/// @brief Method set_platformEnvironment addr 0xdd4a10 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xdd4a18 size 0x30 virtual false final false
