...
/// @brief Method get_StorageLocation addr 0x2641aac size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__OVRSpace__StorageLocation get_StorageLocation() ;

/// @brief Method set_StorageLocation addr 0x2641ab4 size 0x8 virtual false final false
 void set_StorageLocation(GlobalNamespace::GlobalNamespace__OVRSpace__StorageLocation value) ;

/// @brief Method get_MaxAnchorCount addr 0x2641abc size 0x8 virtual false final false
 int32_t get_MaxAnchorCount() ;

/// @brief Method set_MaxAnchorCount addr 0x2641ac4 size 0x8 virtual false final false
 void set_MaxAnchorCount(int32_t value) ;

/// @brief Method get_Timeout addr 0x2641acc size 0x8 virtual false final false
 double_t get_Timeout() ;

/// @brief Method set_Timeout addr 0x2641ad4 size 0x8 virtual false final false
 void set_Timeout(double_t value) ;

/// @brief Method get_Uuids addr 0x2641adc size 0x8 virtual false final false
 System::Collections::Generic::IReadOnlyList_1<System::Guid> get_Uuids() ;

/// @brief Method set_Uuids addr 0x2641ae4 size 0x184 virtual false final false
 void set_Uuids(System::Collections::Generic::IReadOnlyList_1<System::Guid> value) ;

/// @brief Method ToQueryOptions addr 0x2640fd0 size 0x110 virtual false final false
...
/// @brief Method get_Uuid addr 0x2641c68 size 0xc virtual false final false
 System::Guid get_Uuid() ;

/// @brief Method get_Localized addr 0x2641c74 size 0x88 virtual false final false
 bool get_Localized() ;

/// @brief Method get_Localizing addr 0x2641cfc size 0x94 virtual false final false
 bool get_Localizing() ;

/// @brief Method get_Pose addr 0x2641d90 size 0x124 virtual false final false
 UnityEngine::Pose get_Pose() ;

/// @brief Method Localize addr 0x2641eb4 size 0x2c0 virtual false final false
...
/// @brief Method BindTo addr 0x2642174 size 0x340 virtual false final false
 void BindTo(GlobalNamespace::OVRSpatialAnchor spatialAnchor) ;

/// @brief Method .ctor addr 0x2641858 size 0xc virtual false final false
...
/// @brief Method Log addr 0x26424b4 size 0x8c virtual false final false
static void Log(::StringW message) ;

/// @brief Method LogWarning addr 0x2642540 size 0x8c virtual false final false
static void LogWarning(::StringW message) ;

/// @brief Method LogError addr 0x26425cc size 0x8c virtual false final false
static void LogError(::StringW message) ;

/// @brief Method LogRequest addr 0x2642658 size 0x4 virtual false final false
static void LogRequest(uint64_t requestId, ::StringW message) ;

/// @brief Method LogRequestResult addr 0x264265c size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x26426c4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetListToStoreTheShareRequest>b__34_0 addr 0x26426cc size 0x3c virtual false final false
...
/// @brief Method add_OnLocalize addr 0x263cc44 size 0xb0 virtual false final false
 void add_OnLocalize(System::Action_1<GlobalNamespace::GlobalNamespace__OVRSpatialAnchor__OperationResult> value) ;

/// @brief Method remove_OnLocalize addr 0x263ccf4 size 0xb0 virtual false final false
 void remove_OnLocalize(System::Action_1<GlobalNamespace::GlobalNamespace__OVRSpatialAnchor__OperationResult> value) ;

/// @brief Method get_Space addr 0x263cda4 size 0x8 virtual false final false
 GlobalNamespace::OVRSpace get_Space() ;

/// @brief Method set_Space addr 0x263cdac size 0x8 virtual false final false
 void set_Space(GlobalNamespace::OVRSpace value) ;

/// @brief Method get_Uuid addr 0x263cdb4 size 0xc virtual false final false
 System::Guid get_Uuid() ;

/// @brief Method set_Uuid addr 0x263cdc0 size 0x8 virtual false final false
 void set_Uuid(System::Guid value) ;

/// @brief Method get_Created addr 0x263cdc8 size 0x10 virtual false final false
 bool get_Created() ;

/// @brief Method get_PendingCreation addr 0x263cdd8 size 0x10 virtual false final false
 bool get_PendingCreation() ;

/// @brief Method get_Localized addr 0x263cde8 size 0x90 virtual false final false
 bool get_Localized() ;

/// @brief Method InitializeFromExisting addr 0x263ce78 size 0x20c virtual false final false
 void InitializeFromExisting(GlobalNamespace::OVRSpace space, System::Guid uuid) ;

/// @brief Method Save addr 0x263d2ec size 0x10 virtual false final false
 void Save(System::Action_2<GlobalNamespace::OVRSpatialAnchor,bool> onComplete) ;

/// @brief Method ToNativeArray addr 0x263d42c size 0x568 virtual false final false
...
/// @brief Method Save addr 0x263d2fc size 0x130 virtual false final false
...
/// @brief Method Save addr 0x263d994 size 0x250 virtual false final false
...
/// @brief Method CopyAnchorListIntoListFromPool addr 0x263dbe4 size 0xac virtual false final false
...
/// @brief Method Share addr 0x263dc90 size 0xdc virtual false final false
...
/// @brief Method Share addr 0x263de74 size 0x140 virtual false final false
...
/// @brief Method Share addr 0x263dfb4 size 0x19c virtual false final false
...
/// @brief Method Share addr 0x263e150 size 0x200 virtual false final false
...
/// @brief Method Share addr 0x263e350 size 0x398 virtual false final false
...
/// @brief Method Share addr 0x263e6e8 size 0x634 virtual false final false
...
/// @brief Method ShareInternal addr 0x263dd6c size 0x108 virtual false final false
...
/// @brief Method GetListToStoreTheShareRequest addr 0x263ed1c size 0x37c virtual false final false
...
/// @brief Method AreSortedUserListsEqual addr 0x263f098 size 0x284 virtual false final false
...
/// @brief Method Erase addr 0x263f398 size 0x10 virtual false final false
 void Erase(System::Action_2<GlobalNamespace::OVRSpatialAnchor,bool> onComplete) ;

/// @brief Method Erase addr 0x263f3a8 size 0x120 virtual false final false
...
/// @brief Method ThrowIfBound addr 0x263d084 size 0x130 virtual false final false
static void ThrowIfBound(System::Guid uuid) ;

/// @brief Method InitializeUnchecked addr 0x263d1b4 size 0x138 virtual false final false
 void InitializeUnchecked(GlobalNamespace::OVRSpace space, System::Guid uuid) ;

/// @brief Method Start addr 0x263f56c size 0x18 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x263f6f0 size 0x10 virtual false final false
 void Update() ;

/// @brief Method LateUpdate addr 0x263f700 size 0x50 virtual false final false
 void LateUpdate() ;

/// @brief Method SaveBatchAnchors addr 0x263f750 size 0x1ec virtual false final false
static void SaveBatchAnchors() ;

/// @brief Method ShareBatchAnchors addr 0x263f93c size 0x26c virtual false final false
static void ShareBatchAnchors() ;

/// @brief Method OnDestroy addr 0x263fba8 size 0xb8 virtual false final false
 void OnDestroy() ;

/// @brief Method GetTrackingSpacePose addr 0x263fc60 size 0xc8 virtual false final false
 GlobalNamespace::OVRPose GetTrackingSpacePose() ;

/// @brief Method CreateSpatialAnchor addr 0x263f584 size 0x16c virtual false final false
 void CreateSpatialAnchor() ;

/// @brief Method TryGetPose addr 0x263fd28 size 0x190 virtual false final false
static bool TryGetPose(GlobalNamespace::OVRSpace space, ByRef<GlobalNamespace::OVRPose> pose) ;

/// @brief Method UpdateTransform addr 0x263f4c8 size 0xa4 virtual false final false
...
/// @brief Method InitializeOnLoad addr 0x263feb8 size 0x174 virtual false final false
static void InitializeOnLoad() ;

/// @brief Method InvokeSingleAnchorDelegate addr 0x26406d8 size 0xc0 virtual false final false
static void InvokeSingleAnchorDelegate(uint64_t requestId, bool result) ;

/// @brief Method InvokeMultiAnchorDelegate addr 0x2640798 size 0x47c virtual false final false
...
/// @brief Method OnSpatialAnchorCreateComplete addr 0x2640c14 size 0x19c virtual false final false
...
/// @brief Method OnSpaceSaveComplete addr 0x2640db0 size 0x64 virtual false final false
static void OnSpaceSaveComplete(uint64_t requestId, GlobalNamespace::OVRSpace space, bool result, System::Guid uuid) ;

/// @brief Method OnSpaceEraseComplete addr 0x2640e14 size 0x64 virtual false final false
...
/// @brief Method LoadUnboundAnchors addr 0x2640e78 size 0x158 virtual false final false
...
/// @brief Method OnSpaceQueryComplete addr 0x26410e0 size 0x778 virtual false final false
static void OnSpaceQueryComplete(uint64_t requestId, bool queryResult) ;

/// @brief Method OnSpaceSetComponentStatusComplete addr 0x2641864 size 0x16c virtual false final false
...
/// @brief Method OnSpaceListSaveComplete addr 0x26419d0 size 0x68 virtual false final false
...
/// @brief Method OnShareSpacesComplete addr 0x2641a38 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x2641aa0 size 0xc virtual false final false
 void _ctor() ;
