...
/// @brief Method get_MaxResults addr 0x263cb14 size 0x8 virtual false final false
 int32_t get_MaxResults() ;

/// @brief Method set_MaxResults addr 0x263cb1c size 0x8 virtual false final false
 void set_MaxResults(int32_t value) ;

/// @brief Method get_Timeout addr 0x263cb24 size 0x8 virtual false final false
 double_t get_Timeout() ;

/// @brief Method set_Timeout addr 0x263cb2c size 0x8 virtual false final false
 void set_Timeout(double_t value) ;

/// @brief Method get_Location addr 0x263cb34 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__OVRSpace__StorageLocation get_Location() ;

/// @brief Method set_Location addr 0x263cb3c size 0x8 virtual false final false
 void set_Location(GlobalNamespace::GlobalNamespace__OVRSpace__StorageLocation value) ;

/// @brief Method get_QueryType addr 0x263cb44 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__OVRPlugin__SpaceQueryType get_QueryType() ;

/// @brief Method set_QueryType addr 0x263cb4c size 0x8 virtual false final false
 void set_QueryType(GlobalNamespace::GlobalNamespace__OVRPlugin__SpaceQueryType value) ;

/// @brief Method get_ActionType addr 0x263cb54 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__OVRPlugin__SpaceQueryActionType get_ActionType() ;

/// @brief Method set_ActionType addr 0x263cb5c size 0x8 virtual false final false
 void set_ActionType(GlobalNamespace::GlobalNamespace__OVRPlugin__SpaceQueryActionType value) ;

/// @brief Method get_ComponentFilter addr 0x263cb64 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__OVRSpaceQuery__ComponentType get_ComponentFilter() ;

/// @brief Method set_ComponentFilter addr 0x2636200 size 0x104 virtual false final false
 void set_ComponentFilter(GlobalNamespace::GlobalNamespace__OVRSpaceQuery__ComponentType value) ;

/// @brief Method get_UuidFilter addr 0x263cb6c size 0x8 virtual false final false
 System::Collections::Generic::IEnumerable_1<System::Guid> get_UuidFilter() ;

/// @brief Method set_UuidFilter addr 0x2635ffc size 0x204 virtual false final false
 void set_UuidFilter(System::Collections::Generic::IEnumerable_1<System::Guid> value) ;

/// @brief Method .ctor addr 0x263cb74 size 0x34 virtual false final false
 void _ctor(GlobalNamespace::GlobalNamespace__OVRSpaceQuery__Options other) ;

/// @brief Method TryQuerySpaces addr 0x2636304 size 0x968 virtual false final false
