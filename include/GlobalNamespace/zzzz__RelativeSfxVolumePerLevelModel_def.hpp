...
/// @brief Method .ctor addr 0x2226f9c size 0x114 virtual false final false
 void _ctor(GlobalNamespace::RelativeSfxVolumePerLevelSO relativeSfxVolumePerLevelData) ;

/// @brief Method GetRelativeSfxVolume addr 0x22270b0 size 0x7c virtual false final false
