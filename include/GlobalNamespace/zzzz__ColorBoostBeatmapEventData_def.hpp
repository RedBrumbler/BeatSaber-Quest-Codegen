...
/// @brief Method .ctor addr 0xda08b0 size 0x4c virtual false final false
 void _ctor(float_t time, bool boostColorsAreOn) ;

/// @brief Method GetCopy addr 0xda08fc size 0x8c virtual true final false
 GlobalNamespace::BeatmapDataItem GetCopy() ;

/// @brief Method GetDefault addr 0xda0988 size 0x58 virtual true final false
