...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Cubemap (GlobalNamespace::ReflectionProbeDataSO::*)()>(&GlobalNamespace::ReflectionProbeDataSO::get_reflectionProbeCubemap1)> {
  ...
  constexpr static std::size_t addrs = 0x21d6b84;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ReflectionProbeDataSO::*)(UnityEngine::Cubemap)>(&GlobalNamespace::ReflectionProbeDataSO::set_reflectionProbeCubemap1)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21d6b8c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Cubemap (GlobalNamespace::ReflectionProbeDataSO::*)()>(&GlobalNamespace::ReflectionProbeDataSO::get_reflectionProbeCubemap2)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21d6b94;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ReflectionProbeDataSO::*)(UnityEngine::Cubemap)>(&GlobalNamespace::ReflectionProbeDataSO::set_reflectionProbeCubemap2)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21d6b9c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ReflectionProbeDataSO::*)()>(&GlobalNamespace::ReflectionProbeDataSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21d6ba4;
...
::cordl_internals::setInstanceField<UnityEngine::Cubemap, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::Cubemap>(value));
}
constexpr UnityEngine::Cubemap GlobalNamespace::ReflectionProbeDataSO::__get__reflectionProbeCubemap1() const {
return ::cordl_internals::getInstanceField<UnityEngine::Cubemap, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::ReflectionProbeDataSO::__set__reflectionProbeCubemap2(UnityEngine::Cubemap value)  {
::cordl_internals::setInstanceField<UnityEngine::Cubemap, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::Cubemap>(value));
}
constexpr UnityEngine::Cubemap GlobalNamespace::ReflectionProbeDataSO::__get__reflectionProbeCubemap2() const {
return ::cordl_internals::getInstanceField<UnityEngine::Cubemap, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<UnityEngine::Cubemap, false>(const_cast<void*>(instance), ___internal_method);
}
