...
/// @brief Method get_supportsOpenDataPrivacyPage addr 0x20ea498 size 0x8 virtual true final true
 bool get_supportsOpenDataPrivacyPage() ;

/// @brief Method OpenDataPrivacyPage addr 0x20ea4a0 size 0x4 virtual true final true
 void OpenDataPrivacyPage() ;

/// @brief Method LogEvent addr 0x20ea4a4 size 0xf8 virtual true final true
 void LogEvent(::StringW eventType, System::Collections::Generic::Dictionary_2<::StringW,::StringW> eventData) ;

/// @brief Method LogEditAvatarEvent addr 0x20ea59c size 0xf8 virtual true final true
 void LogEditAvatarEvent(::StringW eventType, System::Collections::Generic::Dictionary_2<::StringW,::StringW> eventData) ;

/// @brief Method LogClick addr 0x20ea694 size 0x90 virtual true final true
 void LogClick(::StringW clickType, System::Collections::Generic::Dictionary_2<::StringW,::StringW> clickData) ;

/// @brief Method LogImpression addr 0x20ea724 size 0x90 virtual true final true
 void LogImpression(::StringW impressionType, System::Collections::Generic::Dictionary_2<::StringW,::StringW> impressionData) ;

/// @brief Method LogExposure addr 0x20ea7b4 size 0x90 virtual true final true
...
/// @brief Method .ctor addr 0x20ea844 size 0x8 virtual false final false
 void _ctor() ;
