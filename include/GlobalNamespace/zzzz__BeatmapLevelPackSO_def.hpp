...
/// @brief Method get_packID addr 0x221d4d4 size 0x8 virtual true final true
 ::StringW get_packID() ;

/// @brief Method get_packName addr 0x221d4dc size 0x8 virtual true final true
 ::StringW get_packName() ;

/// @brief Method get_shortPackName addr 0x221d4e4 size 0x8 virtual true final true
 ::StringW get_shortPackName() ;

/// @brief Method get_collectionName addr 0x221d4ec size 0x8 virtual true final true
 ::StringW get_collectionName() ;

/// @brief Method get_coverImage addr 0x221d4f4 size 0x8 virtual true final true
 UnityEngine::Sprite get_coverImage() ;

/// @brief Method get_smallCoverImage addr 0x221d4fc size 0x8 virtual true final true
 UnityEngine::Sprite get_smallCoverImage() ;

/// @brief Method get_beatmapLevelCollection addr 0x221d504 size 0x8 virtual true final true
 GlobalNamespace::IBeatmapLevelCollection get_beatmapLevelCollection() ;

// Ctor Parameters []
explicit BeatmapLevelPackSO() ;

/// @brief Method .ctor addr 0x221d50c size 0x8 virtual false final false
 void _ctor() ;
