...
/// @brief Method Init addr 0x2182d68 size 0x8 virtual false final false
 void Init(float_t innerCircleRadius, float_t minOuterCircleRadius) ;

/// @brief Method ActivateCenterStageManager addr 0x2182d70 size 0x24 virtual false final false
 void ActivateCenterStageManager() ;

/// @brief Method DeactivateCenterStageManager addr 0x2182e8c size 0x24 virtual false final false
 void DeactivateCenterStageManager() ;

/// @brief Method RecalculateCenterPosition addr 0x2182d94 size 0xf8 virtual false final false
 void RecalculateCenterPosition() ;

// Ctor Parameters []
explicit MultiplayerLobbyCenterStageManager() ;

/// @brief Method .ctor addr 0x2182eb0 size 0x14 virtual false final false
 void _ctor() ;
