...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10211)), TypeDefinitionIndex(TypeDefinitionIndex(13900)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13900), inst: 280 })}
...
/// @brief Method .ctor addr 0x1fbe7d8 size 0x48 virtual false final false
 void _ctor() ;
