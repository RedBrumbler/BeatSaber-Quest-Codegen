...
/// @brief Method .ctor addr 0x217ace8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ProcessLevelCompletionResultsAfterLevelDidFinish>b__0 addr 0x217b1fc size 0xc8 virtual false final false
...
/// @brief Method .ctor addr 0x217af40 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <HandleResultsViewControllerRestartButtonPressed>b__0 addr 0x217b2c4 size 0x50 virtual false final false
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5621))}
...
/// @brief Method get_gameMode addr 0x217a6cc size 0x40 virtual true final false
 ::StringW get_gameMode() ;

/// @brief Method get_leaderboardViewController addr 0x217a70c size 0x8 virtual true final false
 GlobalNamespace::LeaderboardViewController get_leaderboardViewController() ;

/// @brief Method get_showBackButtonForMainViewController addr 0x217a714 size 0x8 virtual true final false
 bool get_showBackButtonForMainViewController() ;

/// @brief Method get_mainTitle addr 0x217a71c size 0x44 virtual true final false
 ::StringW get_mainTitle() ;

/// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidActivate addr 0x217a760 size 0x1c8 virtual true final false
 void SinglePlayerLevelSelectionFlowCoordinatorDidActivate(bool firstActivation, bool addedToHierarchy) ;

/// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate addr 0x217a958 size 0x14c virtual true final false
 void SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate(bool removedFromHierarchy) ;

/// @brief Method ProcessLevelCompletionResultsAfterLevelDidFinish addr 0x217aaa4 size 0x244 virtual true final false
...
/// @brief Method WillScoreGoToLeaderboard addr 0x217ad14 size 0x50 virtual false final false
...
/// @brief Method IsNewHighScore addr 0x217ad64 size 0x44 virtual false final false
 bool IsNewHighScore(GlobalNamespace::LevelCompletionResults levelCompletionResults, ::StringW leaderboardId) ;

/// @brief Method ProcessScore addr 0x217ada8 size 0x94 virtual false final false
 void ProcessScore(GlobalNamespace::LevelCompletionResults levelCompletionResults, ::StringW leaderboardId, ::StringW playerName) ;

/// @brief Method HandleResultsViewControllerContinueButtonPressed addr 0x217ae3c size 0x3c virtual false final false
 void HandleResultsViewControllerContinueButtonPressed(GlobalNamespace::ResultsViewController resultsViewController) ;

/// @brief Method HandleResultsViewControllerRestartButtonPressed addr 0x217ae78 size 0xc8 virtual false final false
...
/// @brief Method .ctor addr 0x217b1ec size 0x8 virtual false final false
 void _ctor() ;
