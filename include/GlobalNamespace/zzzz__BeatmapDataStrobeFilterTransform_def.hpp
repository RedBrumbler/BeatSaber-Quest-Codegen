...
/// @brief Method StartPotentialStrobe addr 0x21f178c size 0x98 virtual false final false
 void StartPotentialStrobe(GlobalNamespace::BasicBeatmapEventData startBasicBeatmapEventData) ;

/// @brief Method AddStrobeData addr 0x21f16b4 size 0x94 virtual false final false
...
/// @brief Method .ctor addr 0x21f1628 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method CreateTransformedData addr 0x21f0d0c size 0x91c virtual false final false
...
/// @brief Method GetOnEventDataValue addr 0x21f1748 size 0x24 virtual false final false
static int32_t GetOnEventDataValue(GlobalNamespace::EnvironmentColorType lightColorType) ;

/// @brief Method GetFlashAndFadeToBlackEventDataValue addr 0x21f176c size 0x20 virtual false final false
