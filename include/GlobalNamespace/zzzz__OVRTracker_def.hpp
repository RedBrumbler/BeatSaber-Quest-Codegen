...
/// @brief Method get_isPresent addr 0x2649480 size 0x90 virtual false final false
 bool get_isPresent() ;

/// @brief Method get_isPositionTracked addr 0x2649510 size 0x50 virtual false final false
 bool get_isPositionTracked() ;

/// @brief Method get_isEnabled addr 0x2649560 size 0x90 virtual false final false
 bool get_isEnabled() ;

/// @brief Method set_isEnabled addr 0x26495f0 size 0x94 virtual false final false
 void set_isEnabled(bool value) ;

/// @brief Method get_count addr 0x2649684 size 0x3c virtual false final false
 int32_t get_count() ;

/// @brief Method GetFrustum addr 0x26497c4 size 0xa4 virtual false final false
 GlobalNamespace::GlobalNamespace__OVRTracker__Frustum GetFrustum(int32_t tracker) ;

/// @brief Method GetPose addr 0x2649868 size 0x2b0 virtual false final false
 GlobalNamespace::OVRPose GetPose(int32_t tracker) ;

/// @brief Method GetPoseValid addr 0x2649b18 size 0x104 virtual false final false
 bool GetPoseValid(int32_t tracker) ;

/// @brief Method GetPresent addr 0x26496c0 size 0x104 virtual false final false
 bool GetPresent(int32_t tracker) ;

// Ctor Parameters []
explicit OVRTracker() ;

/// @brief Method .ctor addr 0x2649c1c size 0x8 virtual false final false
 void _ctor() ;
