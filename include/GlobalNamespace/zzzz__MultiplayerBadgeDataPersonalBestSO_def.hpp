...
/// @brief Method CalculateBadgeData addr 0x21115a4 size 0x550 virtual true final false
...
/// @brief Method .ctor addr 0x2111af4 size 0x10 virtual false final false
 void _ctor() ;
