...
/// @brief Method get_previousSameTypeEventData addr 0xda0210 size 0x78 virtual false final false
 GlobalNamespace::BasicBeatmapEventData get_previousSameTypeEventData() ;

/// @brief Method get_nextSameTypeEventData addr 0xda0288 size 0x78 virtual false final false
 GlobalNamespace::BasicBeatmapEventData get_nextSameTypeEventData() ;

/// @brief Method get_sameTypeIndex addr 0xda0300 size 0x8 virtual false final false
 int32_t get_sameTypeIndex() ;

/// @brief Method set_sameTypeIndex addr 0xda0308 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xda0310 size 0x98 virtual false final false
 void _ctor(float_t time, GlobalNamespace::BasicBeatmapEventType basicBeatmapEventType, int32_t value, float_t floatValue) ;

/// @brief Method GetCopy addr 0xda03f0 size 0x88 virtual true final false
 GlobalNamespace::BeatmapDataItem GetCopy() ;

/// @brief Method SubtypeIdentifier addr 0xda03a8 size 0x4 virtual false final false
static int32_t SubtypeIdentifier(GlobalNamespace::BasicBeatmapEventType type) ;

/// @brief Method SetFirstSameTypeIndex addr 0xda0478 size 0xc virtual false final false
 void SetFirstSameTypeIndex() ;

/// @brief Method RecalculateSameTypeIndexFromPreviousEvent addr 0xda0484 size 0x20 virtual false final false
 void RecalculateSameTypeIndexFromPreviousEvent(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

/// @brief Method GetDefault addr 0xda04a4 size 0x110 virtual true final false
