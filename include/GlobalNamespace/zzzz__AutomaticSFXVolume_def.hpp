...
/// @brief Method .ctor addr 0x20f174c size 0x3c virtual false final false
...
/// @brief Method Start addr 0x20f148c size 0x4 virtual false final false
 void Start() ;

/// @brief Method OnDisable addr 0x20f1508 size 0x88 virtual false final false
 void OnDisable() ;

/// @brief Method OnValidate addr 0x20f1590 size 0x4 virtual false final false
 void OnValidate() ;

/// @brief Method RecalculateParams addr 0x20f1490 size 0x78 virtual false final false
 void RecalculateParams() ;

/// @brief Method OnAudioFilterRead addr 0x20f1594 size 0x154 virtual false final false
 void OnAudioFilterRead(::ArrayW<float_t> data, int32_t channels) ;

/// @brief Method Update addr 0x20f16e8 size 0x50 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit AutomaticSFXVolume() ;

/// @brief Method .ctor addr 0x20f1738 size 0x14 virtual false final false
 void _ctor() ;
