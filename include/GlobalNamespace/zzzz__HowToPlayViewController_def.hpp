...
/// @brief Method add_didFinishEvent addr 0x2196c20 size 0xb0 virtual false final false
 void add_didFinishEvent(System::Action_1<GlobalNamespace::GlobalNamespace__HowToPlayViewController__HowToPlayOptions> value) ;

/// @brief Method remove_didFinishEvent addr 0x2196cd0 size 0xb0 virtual false final false
...
/// @brief Method Setup addr 0x2196d80 size 0x30 virtual false final false
 void Setup(bool showTutorialButton) ;

/// @brief Method DidActivate addr 0x2196db0 size 0x108 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

// Ctor Parameters []
explicit HowToPlayViewController() ;

/// @brief Method .ctor addr 0x2196eb8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__7_0 addr 0x2196ec0 size 0x20 virtual false final false
 void _DidActivate_b__7_0() ;

/// @brief Method <DidActivate>b__7_1 addr 0x2196ee0 size 0x20 virtual false final false
