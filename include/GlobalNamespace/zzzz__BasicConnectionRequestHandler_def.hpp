...
/// @brief Method get_secret addr 0xdab784 size 0x8 virtual false final false
 ::StringW get_secret() ;

/// @brief Method set_secret addr 0xdab78c size 0x8 virtual false final false
 void set_secret(::StringW value) ;

/// @brief Method GetConnectionMessage addr 0xdab794 size 0x70 virtual true final true
 void GetConnectionMessage(LiteNetLib::Utils::NetDataWriter writer, ::StringW userId, ::StringW userName, bool isConnectionOwner) ;

/// @brief Method ValidateConnectionMessage addr 0xdab804 size 0xbc virtual true final true
...
/// @brief Method .ctor addr 0xdab8c0 size 0x8 virtual false final false
 void _ctor() ;
