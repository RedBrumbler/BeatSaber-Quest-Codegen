...
/// @brief Method MoveNext addr 0x21bc400 size 0x808 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x21bcc08 size 0xc virtual true final true
...
/// @brief Method OnDestroy addr 0x21bc2b4 size 0xa4 virtual false final false
 void OnDestroy() ;

/// @brief Method SetTextureAsync addr 0x21bc358 size 0xa0 virtual false final false
 void SetTextureAsync(GlobalNamespace::IPreviewBeatmapLevel level) ;

// Ctor Parameters []
explicit BlurredCoverImageView() ;

/// @brief Method .ctor addr 0x21bc3f8 size 0x8 virtual false final false
 void _ctor() ;
