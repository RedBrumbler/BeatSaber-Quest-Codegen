...
/// @brief Method set_transition addr 0x1fcb598 size 0x18 virtual false final false
 void set_transition(float_t value) ;

/// @brief Method get_transition addr 0x1fcbc4c size 0x8 virtual false final false
 float_t get_transition() ;

/// @brief Method get_defaultForParams addr 0x1fcbc54 size 0x8 virtual false final false
 GlobalNamespace::BloomFogEnvironmentParams get_defaultForParams() ;

/// @brief Method set_defaultForParams addr 0x1fcba74 size 0x9c virtual false final false
 void set_defaultForParams(GlobalNamespace::BloomFogEnvironmentParams value) ;

/// @brief Method get_transitionFogParams addr 0x1fcbc5c size 0x8 virtual false final false
 GlobalNamespace::BloomFogEnvironmentParams get_transitionFogParams() ;

/// @brief Method set_transitionFogParams addr 0x1fcb8b4 size 0x98 virtual false final false
 void set_transitionFogParams(GlobalNamespace::BloomFogEnvironmentParams value) ;

/// @brief Method set_bloomFogEnabled addr 0x1fcb600 size 0x78 virtual false final false
 void set_bloomFogEnabled(bool value) ;

/// @brief Method get_bloomFogEnabled addr 0x1fcbc64 size 0x8 virtual false final false
 bool get_bloomFogEnabled() ;

/// @brief Method get_autoExposureLimit addr 0x1fcbc6c size 0x8 virtual false final false
 float_t get_autoExposureLimit() ;

/// @brief Method get_noteSpawnIntensity addr 0x1fcbc74 size 0x8 virtual false final false
 float_t get_noteSpawnIntensity() ;

/// @brief Method Setup addr 0x1fcb5b0 size 0x8 virtual false final false
 void Setup(GlobalNamespace::BloomFogEnvironmentParams defaultFogParams) ;

/// @brief Method OnEnable addr 0x1fcbc7c size 0x1c virtual true final false
 void OnEnable() ;

/// @brief Method UpdateShaderParams addr 0x1fcb678 size 0x198 virtual false final false
 void UpdateShaderParams() ;

/// @brief Method SetParams addr 0x1fcbc98 size 0xe4 virtual false final false
...
/// @brief Method .ctor addr 0x1fcbd7c size 0x10 virtual false final false
 void _ctor() ;
