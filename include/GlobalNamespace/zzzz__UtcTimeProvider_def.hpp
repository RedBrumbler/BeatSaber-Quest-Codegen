...
/// @brief Method GetTimeMs addr 0xddda28 size 0x2c virtual true final true
 int64_t GetTimeMs() ;

/// @brief Method GetTicks addr 0xdcc660 size 0xb4 virtual true final true
 int64_t GetTicks() ;

// Ctor Parameters []
explicit UtcTimeProvider() ;

/// @brief Method .ctor addr 0xddda54 size 0x8 virtual false final false
 void _ctor() ;
