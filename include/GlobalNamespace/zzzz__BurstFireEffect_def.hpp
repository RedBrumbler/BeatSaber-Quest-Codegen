...
/// @brief Method Awake addr 0x20e56cc size 0x124 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x20e57f0 size 0x18 virtual true final false
 void Start() ;

/// @brief Method OnDestroy addr 0x20e59d8 size 0x9c virtual true final false
 void OnDestroy() ;

/// @brief Method HandleColorChangeBeatmapEvent addr 0x20e5a90 size 0x134 virtual true final false
 void HandleColorChangeBeatmapEvent(GlobalNamespace::LightColorBeatmapEventData e) ;

/// @brief Method StartEffect addr 0x20e5bf0 size 0xd4 virtual false final false
 void StartEffect(float_t time) ;

/// @brief Method EndEffect addr 0x20e5bc4 size 0x2c virtual false final false
 void EndEffect() ;

/// @brief Method SetInitialValues addr 0x20e5928 size 0xb0 virtual false final false
 void SetInitialValues() ;

/// @brief Method UpdateFadeOutProgress addr 0x20e5d50 size 0x194 virtual false final false
 void UpdateFadeOutProgress(float_t fadeOutProgress) ;

// Ctor Parameters []
explicit BurstFireEffect() ;

/// @brief Method .ctor addr 0x20e5f54 size 0x84 virtual false final false
 void _ctor() ;
