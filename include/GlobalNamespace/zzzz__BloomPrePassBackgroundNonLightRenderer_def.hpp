...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14646))}
...
/// @brief Method get_renderer addr 0x1fced18 size 0x8 virtual true final false
 UnityEngine::Renderer get_renderer() ;

/// @brief Method get_meshFilter addr 0x1fced20 size 0x8 virtual false final false
 UnityEngine::MeshFilter get_meshFilter() ;

/// @brief Method get_cachedTransform addr 0x1fced28 size 0x8 virtual false final false
 UnityEngine::Transform get_cachedTransform() ;

/// @brief Method set_isPartOfInstancedRendering addr 0x1fce1a8 size 0x30 virtual false final false
 void set_isPartOfInstancedRendering(bool value) ;

/// @brief Method Awake addr 0x1fcef10 size 0x2c virtual true final false
 void Awake() ;

/// @brief Method OnEnable addr 0x1fcef48 size 0x10 virtual true final false
 void OnEnable() ;

/// @brief Method OnValidate addr 0x1fcef5c size 0x34 virtual true final false
 void OnValidate() ;

/// @brief Method InitIfNeeded addr 0x1fcef90 size 0xc8 virtual true final false
 void InitIfNeeded() ;

// Ctor Parameters []
explicit BloomPrePassBackgroundNonLightRenderer() ;

/// @brief Method .ctor addr 0x1fcf10c size 0x54 virtual false final false
 void _ctor() ;
