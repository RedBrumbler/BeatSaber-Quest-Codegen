...
/// @brief Method get_nextScenesTransitionSetupData addr 0x2208304 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x220830c size 0x28 virtual false final false
