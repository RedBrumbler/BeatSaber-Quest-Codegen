...
/// @brief Method Update addr 0x2653c14 size 0x4 virtual false final false
 void Update() ;

/// @brief Method SetOVRCameraController addr 0x2653e2c size 0xc virtual false final false
 void SetOVRCameraController(ByRef<GlobalNamespace::OVRCameraRig> cameraController) ;

/// @brief Method UpdateCubeGrid addr 0x2653c18 size 0x214 virtual false final false
 void UpdateCubeGrid() ;

/// @brief Method CreateCubeGrid addr 0x2653e38 size 0x3a8 virtual false final false
 void CreateCubeGrid() ;

/// @brief Method CubeGridSwitchColor addr 0x26541e0 size 0x188 virtual false final false
 void CubeGridSwitchColor(bool CubeSwitchColor) ;

// Ctor Parameters []
explicit OVRGridCube() ;

/// @brief Method .ctor addr 0x2654368 size 0x30 virtual false final false
 void _ctor() ;
