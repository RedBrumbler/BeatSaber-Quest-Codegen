...
/// @brief Method get_recordingToolEnabled addr 0x21e4ac0 size 0x8 virtual false final false
 bool get_recordingToolEnabled() ;

/// @brief Method get_showRecordingToolScene addr 0x21e4ac8 size 0x8 virtual false final false
 bool get_showRecordingToolScene() ;

/// @brief Method get_configJsonData addr 0x21e4ad0 size 0x8 virtual false final false
 ::StringW get_configJsonData() ;

/// @brief Method get_recordingToolSettings addr 0x21e4ad8 size 0x8 virtual false final false
 GlobalNamespace::RecordingToolSettings get_recordingToolSettings() ;

/// @brief Method get_objectsMovementRecorderInitData addr 0x21e4ae0 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__ObjectsMovementRecorder__InitData get_objectsMovementRecorderInitData() ;

/// @brief Method get_menuDestination addr 0x21e4ae8 size 0x8 virtual false final false
 GlobalNamespace::MenuDestination get_menuDestination() ;

/// @brief Method get_listLogger addr 0x21e4af0 size 0x8 virtual false final false
 GlobalNamespace::ListLogger get_listLogger() ;

/// @brief Method get_logger addr 0x21e4af8 size 0x8 virtual false final false
 GlobalNamespace::IBeatSaberLogger get_logger() ;

/// @brief Method get_posesSerializer addr 0x21e4b00 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x21e4804 size 0x2b4 virtual false final false
