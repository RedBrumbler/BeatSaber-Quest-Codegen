...
/// @brief Method NormalizedVolumeToDB addr 0x1fab374 size 0x74 virtual false final false
static float_t NormalizedVolumeToDB(float_t normalizedVolume) ;

/// @brief Method DBToNormalizedVolume addr 0x1fab3e8 size 0x18 virtual false final false
