...
/// @brief Method get_Space addr 0x26326dc size 0x8 virtual false final false
 GlobalNamespace::OVRSpace get_Space() ;

/// @brief Method set_Space addr 0x26326e4 size 0x8 virtual false final false
 void set_Space(GlobalNamespace::OVRSpace value) ;

/// @brief Method get_Uuid addr 0x26326ec size 0xc virtual false final false
 System::Guid get_Uuid() ;

/// @brief Method set_Uuid addr 0x26326f8 size 0x8 virtual false final false
 void set_Uuid(System::Guid value) ;

/// @brief Method get_IsTracked addr 0x2632700 size 0x8 virtual false final false
 bool get_IsTracked() ;

/// @brief Method set_IsTracked addr 0x2632708 size 0xc virtual false final false
 void set_IsTracked(bool value) ;

/// @brief Method IsComponentEnabled addr 0x2632714 size 0x8c virtual false final false
...
/// @brief Method ClearPoseCache addr 0x26327a4 size 0x10 virtual false final false
 void ClearPoseCache() ;

/// @brief Method Initialize addr 0x26327b4 size 0x368 virtual false final false
 void Initialize(GlobalNamespace::OVRSpace space, System::Guid uuid) ;

/// @brief Method InitializeFrom addr 0x2632df0 size 0xd0 virtual false final false
 void InitializeFrom(GlobalNamespace::OVRSceneAnchor other) ;

/// @brief Method GetSceneAnchors addr 0x2632ec0 size 0xf8 virtual false final false
static void GetSceneAnchors(System::Collections::Generic::List_1<GlobalNamespace::OVRSceneAnchor> anchors) ;

/// @brief Method TryUpdateTransform addr 0x2632b2c size 0x2c4 virtual false final false
 bool TryUpdateTransform(bool useCache) ;

/// @brief Method OnDestroy addr 0x2632fb8 size 0x1e0 virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit OVRSceneAnchor() ;

/// @brief Method .ctor addr 0x2633198 size 0x8 virtual false final false
 void _ctor() ;
