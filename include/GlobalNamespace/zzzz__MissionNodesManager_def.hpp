...
/// @brief Method get_rootMissionNode addr 0x2180a54 size 0x8 virtual false final false
 GlobalNamespace::MissionNode get_rootMissionNode() ;

/// @brief Method get_finalMissionNode addr 0x2180a5c size 0x8 virtual false final false
 GlobalNamespace::MissionNode get_finalMissionNode() ;

/// @brief Method get_missionStagesManager addr 0x2180a64 size 0x8 virtual false final false
 GlobalNamespace::MissionStagesManager get_missionStagesManager() ;

/// @brief Method get_missionProgressModel addr 0x2180a6c size 0x8 virtual false final false
 GlobalNamespace::CampaignProgressModel get_missionProgressModel() ;

/// @brief Method get_allMissionNodes addr 0x2180a74 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::MissionNode> get_allMissionNodes() ;

/// @brief Method get_IsInitialized addr 0x2180a7c size 0x8 virtual false final false
 bool get_IsInitialized() ;

/// @brief Method Awake addr 0x2180a84 size 0x2c virtual false final false
 void Awake() ;

/// @brief Method SetupNodeMap addr 0x217e988 size 0x3c virtual false final false
 void SetupNodeMap() ;

/// @brief Method MissionWasCleared addr 0x2180ea4 size 0x6c virtual false final false
 bool MissionWasCleared(GlobalNamespace::MissionNode missionNode) ;

/// @brief Method GetMissionNodeWithModelClearedStateInconsistency addr 0x217e5d8 size 0xb0 virtual false final false
 GlobalNamespace::MissionNode GetMissionNodeWithModelClearedStateInconsistency() ;

/// @brief Method DidFirstLockedMissionStageChange addr 0x217f0a8 size 0x9c virtual false final false
 bool DidFirstLockedMissionStageChange() ;

/// @brief Method UpdateStageLockText addr 0x217f074 size 0x34 virtual false final false
 void UpdateStageLockText() ;

/// @brief Method GetTopMostNotClearedMissionNode addr 0x217e754 size 0x14c virtual false final false
 GlobalNamespace::MissionNode GetTopMostNotClearedMissionNode() ;

/// @brief Method GetAllMissionNodes addr 0x2180ab0 size 0xac virtual false final false
 void GetAllMissionNodes() ;

/// @brief Method GetAllMissionNodes addr 0x2181044 size 0xe4 virtual false final false
...
/// @brief Method GetNewEnabledConnection addr 0x217f668 size 0x174 virtual false final false
 ::ArrayW<GlobalNamespace::MissionNodeConnection> GetNewEnabledConnection() ;

/// @brief Method ResetAllNodes addr 0x2180c1c size 0x4c virtual false final false
 void ResetAllNodes() ;

/// @brief Method SetupStages addr 0x2180c68 size 0x64 virtual false final false
 void SetupStages() ;

/// @brief Method RegisterAllNodes addr 0x2180b5c size 0xc0 virtual false final false
 void RegisterAllNodes() ;

/// @brief Method SetupNodeTree addr 0x2180ccc size 0x118 virtual false final false
 void SetupNodeTree(GlobalNamespace::MissionNodeVisualController node, bool parentCleared) ;

/// @brief Method IsNodeInteractable addr 0x2181128 size 0x5c virtual false final false
 bool IsNodeInteractable(GlobalNamespace::MissionNodeVisualController node, bool parentCleared) ;

/// @brief Method SetupNodeConnections addr 0x2180de4 size 0xc0 virtual false final false
 void SetupNodeConnections() ;

// Ctor Parameters []
explicit MissionNodesManager() ;

/// @brief Method .ctor addr 0x21811b4 size 0x8 virtual false final false
 void _ctor() ;
