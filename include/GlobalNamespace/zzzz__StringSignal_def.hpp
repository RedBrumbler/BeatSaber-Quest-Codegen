...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13900)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13900), inst: 380 })}
...
/// @brief Method .ctor addr 0x1fbef04 size 0x48 virtual false final false
 void _ctor() ;
