...
/// @brief Method Subscribe addr 0x2254010 size 0x4 virtual true final false
 void Subscribe() ;

/// @brief Method Unsubscribe addr 0x2254014 size 0x4 virtual true final false
 void Unsubscribe() ;

// Ctor Parameters []
explicit PS5OnGoingToBackgroundSaveHandler() ;

/// @brief Method .ctor addr 0x2254018 size 0x8 virtual false final false
 void _ctor() ;
