...
/// @brief Method add_didFinishEvent addr 0x21ad220 size 0xb0 virtual false final false
 void add_didFinishEvent(System::Action_2<bool,GlobalNamespace::CreateServerFormData> value) ;

/// @brief Method remove_didFinishEvent addr 0x21ad2d0 size 0xb0 virtual false final false
 void remove_didFinishEvent(System::Action_2<bool,GlobalNamespace::CreateServerFormData> value) ;

/// @brief Method get_multiplayerModeSettings addr 0x21ad380 size 0x8 virtual false final false
 GlobalNamespace::MultiplayerModeSettings get_multiplayerModeSettings() ;

/// @brief Method Setup addr 0x21ad388 size 0x44 virtual false final false
 void Setup(GlobalNamespace::MultiplayerModeSettings multiplayerModeSettings) ;

/// @brief Method DidActivate addr 0x21ad3cc size 0x108 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method ApplyAndGetData addr 0x21ad4d4 size 0xb8 virtual false final false
 GlobalNamespace::CreateServerFormData ApplyAndGetData() ;

// Ctor Parameters []
explicit CreateServerViewController() ;

/// @brief Method .ctor addr 0x21ad58c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__10_0 addr 0x21ad594 size 0x4c virtual false final false
 void _DidActivate_b__10_0() ;

/// @brief Method <DidActivate>b__10_1 addr 0x21ad5e0 size 0x4c virtual false final false
