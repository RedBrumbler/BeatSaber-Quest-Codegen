...
/// @brief Method Start addr 0x22ae96c size 0x184 virtual false final false
 void Start() ;

/// @brief Method Init addr 0x22aeaf0 size 0x3a0 virtual false final false
 void Init() ;

/// @brief Method OnDestroy addr 0x22af444 size 0x1b8 virtual false final false
 void OnDestroy() ;

/// @brief Method CreateUIForBatteryEnergyType addr 0x22aee90 size 0x2e4 virtual false final false
 void CreateUIForBatteryEnergyType(int32_t batteryLives) ;

/// @brief Method RefreshEnergyUI addr 0x22af174 size 0x2d0 virtual false final false
 void RefreshEnergyUI(float_t energy) ;

/// @brief Method HandleGameEnergyCounterDidInit addr 0x22af5fc size 0x4 virtual false final false
 void HandleGameEnergyCounterDidInit() ;

/// @brief Method HandleGameEnergyDidChange addr 0x22af600 size 0x4 virtual false final false
 void HandleGameEnergyDidChange(float_t energy) ;

// Ctor Parameters []
explicit GameEnergyUIPanel() ;

/// @brief Method .ctor addr 0x22af604 size 0x10 virtual false final false
 void _ctor() ;
