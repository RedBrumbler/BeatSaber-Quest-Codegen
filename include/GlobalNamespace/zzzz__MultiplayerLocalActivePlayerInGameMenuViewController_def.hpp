...
/// @brief Method add_didPressDisconnectButtonEvent addr 0x2106e88 size 0x9c virtual false final false
 void add_didPressDisconnectButtonEvent(System::Action value) ;

/// @brief Method remove_didPressDisconnectButtonEvent addr 0x21073b0 size 0x9c virtual false final false
 void remove_didPressDisconnectButtonEvent(System::Action value) ;

/// @brief Method add_didPressGiveUpButtonEvent addr 0x2106fc0 size 0x9c virtual false final false
 void add_didPressGiveUpButtonEvent(System::Action value) ;

/// @brief Method remove_didPressGiveUpButtonEvent addr 0x21074e8 size 0x9c virtual false final false
 void remove_didPressGiveUpButtonEvent(System::Action value) ;

/// @brief Method add_didPressResumeButtonEvent addr 0x2106f24 size 0x9c virtual false final false
 void add_didPressResumeButtonEvent(System::Action value) ;

/// @brief Method remove_didPressResumeButtonEvent addr 0x210744c size 0x9c virtual false final false
 void remove_didPressResumeButtonEvent(System::Action value) ;

/// @brief Method Awake addr 0x2107970 size 0x1cc virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x2107b3c size 0x8c virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2107bc8 size 0x9c virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x2107c64 size 0xe8 virtual false final false
 void Update() ;

/// @brief Method ShowMenu addr 0x2107690 size 0x50 virtual false final false
 void ShowMenu() ;

/// @brief Method HideMenu addr 0x21076e0 size 0x44 virtual false final false
 void HideMenu() ;

/// @brief Method DisconnectButtonPressed addr 0x2107d84 size 0x34 virtual false final false
 void DisconnectButtonPressed() ;

/// @brief Method HandleDisconnectPromptViewDidViewFinish addr 0x2107db8 size 0xd0 virtual false final false
 void HandleDisconnectPromptViewDidViewFinish(bool disconnect) ;

/// @brief Method GiveUpButtonPressed addr 0x2107e88 size 0x4c virtual false final false
 void GiveUpButtonPressed() ;

/// @brief Method ResumeButtonPressed addr 0x2107d4c size 0x38 virtual false final false
 void ResumeButtonPressed() ;

// Ctor Parameters []
explicit MultiplayerLocalActivePlayerInGameMenuViewController() ;

/// @brief Method .ctor addr 0x2107ed4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <HandleDisconnectPromptViewDidViewFinish>b__32_0 addr 0x2107edc size 0x20 virtual false final false
