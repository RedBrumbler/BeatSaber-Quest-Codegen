...
/// @brief Method get_rotation addr 0xda0de4 size 0x8 virtual false final false
 float_t get_rotation() ;

/// @brief Method set_rotation addr 0xda0dec size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xda0df4 size 0xe4 virtual false final false
...
/// @brief Method ChangeRotation addr 0xda0ef0 size 0x8 virtual false final false
 void ChangeRotation(float_t rotation) ;

/// @brief Method GetCopy addr 0xda0ef8 size 0xc4 virtual true final false
 GlobalNamespace::BeatmapDataItem GetCopy() ;

/// @brief Method SubtypeIdentifier addr 0xda0ed8 size 0x18 virtual false final false
static int32_t SubtypeIdentifier(int32_t groupId, int32_t elementId, GlobalNamespace::LightAxis axis) ;

/// @brief Method GetDefault addr 0xda0fbc size 0x164 virtual true final false
