...
/// @brief Method get_ringPositionStep addr 0x22a66e0 size 0x8 virtual false final false
 float_t get_ringPositionStep() ;

/// @brief Method get_Rings addr 0x22a66e8 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::TrackLaneRing> get_Rings() ;

/// @brief Method Start addr 0x22a66f0 size 0x2b0 virtual false final false
 void Start() ;

/// @brief Method FixedUpdate addr 0x22a69a0 size 0x9c virtual false final false
 void FixedUpdate() ;

/// @brief Method LateUpdate addr 0x22a6a3c size 0x9c virtual false final false
 void LateUpdate() ;

/// @brief Method OnDrawGizmosSelected addr 0x22a6ad8 size 0x284 virtual false final false
 void OnDrawGizmosSelected() ;

// Ctor Parameters []
explicit TrackLaneRingsManager() ;

/// @brief Method .ctor addr 0x22a6d5c size 0x14 virtual false final false
 void _ctor() ;
