...
/// @brief Method get_majorVersion addr 0x2255ca4 size 0x8 virtual false final false
 uint32_t get_majorVersion() ;

/// @brief Method get_minorVersion addr 0x2255cac size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2255cb4 size 0x2c virtual false final false
 void _ctor(uint32_t majorVersion, uint32_t minorVersion) ;

/// @brief Method GetFromString addr 0x2255ce0 size 0x550 virtual false final false
static GlobalNamespace::SonyVersion GetFromString(::StringW versionString) ;

/// @brief Method IsVersionFormatValid addr 0x2256230 size 0x90 virtual false final false
static bool IsVersionFormatValid(::StringW versionString) ;

/// @brief Method Get addr 0x22562c0 size 0x200 virtual false final false
