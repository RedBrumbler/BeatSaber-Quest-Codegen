...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14944), inst: 920 }), TypeDefinitionIndex(TypeDefinitionIndex(14935)), TypeDefinitionIndex(TypeDefinitionIndex(14944))}
...
/// @brief Method .ctor addr 0xda1c00 size 0x48 virtual false final false
 void _ctor() ;
