...
/// @brief Method Init addr 0x22906b8 size 0x174 virtual true final false
 void Init(float_t trailWidth, float_t trailDuration, int32_t granularity, float_t whiteSectionMaxDuration) ;

/// @brief Method OnDestroy addr 0x2290984 size 0xc virtual false final false
 void OnDestroy() ;

/// @brief Method OnValidate addr 0x2290990 size 0xd8 virtual false final false
 void OnValidate() ;

/// @brief Method OnEnable addr 0x2290a68 size 0x84 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2290aec size 0x84 virtual false final false
 void OnDisable() ;

/// @brief Method SetTrailWidth addr 0x2290b70 size 0x8 virtual false final false
 void SetTrailWidth(float_t width) ;

/// @brief Method UpdateMesh addr 0x22901a0 size 0x134 virtual false final false
 void UpdateMesh(GlobalNamespace::TrailElementCollection trailElementCollection, UnityEngine::Color color) ;

/// @brief Method UpdateVertices addr 0x2290b78 size 0x470 virtual true final false
 void UpdateVertices(GlobalNamespace::TrailElementCollection trailElementCollection, UnityEngine::Color color) ;

/// @brief Method UpdateIndices addr 0x229082c size 0x158 virtual false final false
 void UpdateIndices() ;

// Ctor Parameters []
explicit SaberTrailRenderer() ;

/// @brief Method .ctor addr 0x229127c size 0x8 virtual false final false
 void _ctor() ;
