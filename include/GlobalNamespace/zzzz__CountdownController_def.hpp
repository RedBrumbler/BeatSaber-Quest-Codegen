...
/// @brief Method Awake addr 0x2182390 size 0x18 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x21823a8 size 0x1c8 virtual false final false
 void Update() ;

/// @brief Method StartCountdown addr 0x21825d4 size 0xf4 virtual false final false
 void StartCountdown(float_t countdownEndTime) ;

/// @brief Method UpdateCountdown addr 0x21826ec size 0x68 virtual false final false
 void UpdateCountdown(float_t countdownEndTime) ;

/// @brief Method StopCountdown addr 0x2182754 size 0x78 virtual false final false
 void StopCountdown() ;

// Ctor Parameters []
explicit CountdownController() ;

/// @brief Method .ctor addr 0x21827cc size 0x84 virtual false final false
 void _ctor() ;
