...
/// @brief Method Init addr 0x21c9cb4 size 0x6c virtual false final false
 void Init(UnityEngine::Transform character, UnityEngine::Transform camera) ;

/// @brief Method SetRotations addr 0x21ca8cc size 0x14 virtual false final false
 void SetRotations(UnityEngine::Quaternion characterRotation, UnityEngine::Quaternion cameraRotation) ;

/// @brief Method LookRotation addr 0x21ca358 size 0x35c virtual false final false
 void LookRotation(UnityEngine::Transform character, UnityEngine::Transform camera) ;

/// @brief Method SetCursorLock addr 0x21c9d20 size 0x34 virtual false final false
 void SetCursorLock(bool value) ;

/// @brief Method UpdateCursorLock addr 0x21ca944 size 0x10 virtual false final false
 void UpdateCursorLock() ;

/// @brief Method InternalLockUpdate addr 0x21ca954 size 0x78 virtual false final false
 void InternalLockUpdate() ;

/// @brief Method ClampRotationAroundXAxis addr 0x21ca8e0 size 0x64 virtual false final false
 UnityEngine::Quaternion ClampRotationAroundXAxis(UnityEngine::Quaternion q) ;

// Ctor Parameters []
explicit MouseLook() ;

/// @brief Method .ctor addr 0x21ca898 size 0x34 virtual false final false
 void _ctor() ;
