...
/// @brief Method .ctor addr 0x1fcdbd8 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_elements addr 0x1fcd730 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::GlobalNamespace__BloomPrePassBackgroundColorsGradient__Element> get_elements() ;

/// @brief Method UpdatePixels addr 0x1fcd738 size 0x30c virtual true final false
 void UpdatePixels(Unity::Collections::NativeArray_1<UnityEngine::Color32> pixels, int32_t numberOfPixels) ;

/// @brief Method EvaluateColor addr 0x1fcda44 size 0xe0 virtual false final false
 UnityEngine::Color EvaluateColor(float_t t) ;

// Ctor Parameters []
explicit BloomPrePassBackgroundColorsGradient() ;

/// @brief Method .ctor addr 0x1fcdb24 size 0x54 virtual false final false
 void _ctor() ;
