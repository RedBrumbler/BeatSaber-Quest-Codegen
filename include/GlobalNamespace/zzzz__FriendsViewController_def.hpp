...
/// @brief Method get_myPartyTitle addr 0x2192428 size 0x40 virtual true final false
 ::StringW get_myPartyTitle() ;

/// @brief Method get_otherPlayersTitle addr 0x2192468 size 0x40 virtual true final false
 ::StringW get_otherPlayersTitle() ;

/// @brief Method get_networkPlayerModel addr 0x21924a8 size 0x8 virtual true final false
 GlobalNamespace::INetworkPlayerModel get_networkPlayerModel() ;

/// @brief Method NetworkPlayersViewControllerDidActivate addr 0x21924b0 size 0x10c virtual true final false
 void NetworkPlayersViewControllerDidActivate(bool firstActivation, bool addedToHierarchy) ;

/// @brief Method DidDeactivate addr 0x219273c size 0x44 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method OnDestroy addr 0x2192780 size 0x28 virtual true final false
 void OnDestroy() ;

/// @brief Method HandleOpenPartyToggleChanged addr 0x21927a8 size 0x10 virtual false final false
 void HandleOpenPartyToggleChanged(bool openParty) ;

/// @brief Method RefreshParty addr 0x21925bc size 0x180 virtual false final false
 void RefreshParty(bool overrideHide) ;

// Ctor Parameters []
explicit FriendsViewController() ;

/// @brief Method .ctor addr 0x21927b8 size 0x8 virtual false final false
 void _ctor() ;
