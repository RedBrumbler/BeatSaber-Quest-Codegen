...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObstacleSaberSparkleEffect::*)()>(&GlobalNamespace::ObstacleSaberSparkleEffect::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x229e900;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObstacleSaberSparkleEffect::*)()>(&GlobalNamespace::ObstacleSaberSparkleEffect::StartEmission)> {
  ...
  constexpr static std::size_t addrs = 0x229e9d4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObstacleSaberSparkleEffect::*)()>(&GlobalNamespace::ObstacleSaberSparkleEffect::StopEmission)> {
  ...
  constexpr static std::size_t addrs = 0x229ea28;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ObstacleSaberSparkleEffect::*)()>(&GlobalNamespace::ObstacleSaberSparkleEffect::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x229ea90;
...
constexpr UnityEngine::ParticleSystem GlobalNamespace::ObstacleSaberSparkleEffect::__get__sparkleParticleSystem() const {
...
constexpr UnityEngine::ParticleSystem GlobalNamespace::ObstacleSaberSparkleEffect::__get__burnParticleSystem() const {
return ::cordl_internals::getInstanceField<UnityEngine::ParticleSystem, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::ObstacleSaberSparkleEffect::__set__sparkleParticleSystemEmissionModule(UnityEngine::UnityEngine__ParticleSystem__EmissionModule value)  {
::cordl_internals::setInstanceField<UnityEngine::UnityEngine__ParticleSystem__EmissionModule, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::UnityEngine__ParticleSystem__EmissionModule>(value));
}
constexpr UnityEngine::UnityEngine__ParticleSystem__EmissionModule GlobalNamespace::ObstacleSaberSparkleEffect::__get__sparkleParticleSystemEmissionModule() const {
return ::cordl_internals::getInstanceField<UnityEngine::UnityEngine__ParticleSystem__EmissionModule, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::ObstacleSaberSparkleEffect::__set__burnParticleSystemEmissionModule(UnityEngine::UnityEngine__ParticleSystem__EmissionModule value)  {
::cordl_internals::setInstanceField<UnityEngine::UnityEngine__ParticleSystem__EmissionModule, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::UnityEngine__ParticleSystem__EmissionModule>(value));
}
constexpr UnityEngine::UnityEngine__ParticleSystem__EmissionModule GlobalNamespace::ObstacleSaberSparkleEffect::__get__burnParticleSystemEmissionModule() const {
return ::cordl_internals::getInstanceField<UnityEngine::UnityEngine__ParticleSystem__EmissionModule, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
