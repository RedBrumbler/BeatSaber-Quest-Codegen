...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12944)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12943), inst: 3700 }), TypeDefinitionIndex(TypeDefinitionIndex(12943))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12944), inst: 4987 })
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12943)), TypeDefinitionIndex(TypeDefinitionIndex(12944)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12943), inst: 3700 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12944), inst: 4988 })
// CS Name: LocalStateBuffer`3
