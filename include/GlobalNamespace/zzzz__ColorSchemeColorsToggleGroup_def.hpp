...
/// @brief Method add_selectedColorDidChangeEvent addr 0x2154d68 size 0xb0 virtual false final false
 void add_selectedColorDidChangeEvent(System::Action_1<UnityEngine::Color> value) ;

/// @brief Method remove_selectedColorDidChangeEvent addr 0x2154e18 size 0xb0 virtual false final false
 void remove_selectedColorDidChangeEvent(System::Action_1<UnityEngine::Color> value) ;

/// @brief Method get_color addr 0x2154ec8 size 0x18 virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method set_color addr 0x2154f18 size 0x18 virtual false final false
 void set_color(UnityEngine::Color value) ;

/// @brief Method SetColorScheme addr 0x2154fc8 size 0xe0 virtual false final false
 void SetColorScheme(GlobalNamespace::ColorScheme colorScheme) ;

/// @brief Method Awake addr 0x21550a8 size 0x314 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x21553bc size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleToggleWasSelected addr 0x21553d8 size 0x40 virtual false final false
 void HandleToggleWasSelected(GlobalNamespace::ColorSchemeColorToggleController toggleController, bool isOn) ;

/// @brief Method CreateColorSchemeFromEditedColors addr 0x2155418 size 0x1d0 virtual false final false
 GlobalNamespace::ColorScheme CreateColorSchemeFromEditedColors() ;

// Ctor Parameters []
explicit ColorSchemeColorsToggleGroup() ;

/// @brief Method .ctor addr 0x21555e8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__17_0 addr 0x21555f0 size 0x10 virtual false final false
 void _Awake_b__17_0(bool isOn) ;

/// @brief Method <Awake>b__17_1 addr 0x2155600 size 0x10 virtual false final false
 void _Awake_b__17_1(bool isOn) ;

/// @brief Method <Awake>b__17_2 addr 0x2155610 size 0x10 virtual false final false
 void _Awake_b__17_2(bool isOn) ;

/// @brief Method <Awake>b__17_3 addr 0x2155620 size 0x10 virtual false final false
 void _Awake_b__17_3(bool isOn) ;

/// @brief Method <Awake>b__17_4 addr 0x2155630 size 0x10 virtual false final false
 void _Awake_b__17_4(bool isOn) ;

/// @brief Method <Awake>b__17_5 addr 0x2155640 size 0x10 virtual false final false
 void _Awake_b__17_5(bool isOn) ;

/// @brief Method <Awake>b__17_6 addr 0x2155650 size 0x10 virtual false final false
