...
/// @brief Method get_didFinishEvent addr 0x20f3410 size 0x8 virtual false final false
 GlobalNamespace::ILazyCopyHashSet_1<GlobalNamespace::INoteCutSoundEffectDidFinishEvent> get_didFinishEvent() ;

/// @brief Method set_volumeMultiplier addr 0x20f3418 size 0x8 virtual false final false
 void set_volumeMultiplier(float_t value) ;

/// @brief Method get_volumeMultiplier addr 0x20f3420 size 0x8 virtual false final false
 float_t get_volumeMultiplier() ;

/// @brief Method get_time addr 0x20f3428 size 0x2c virtual false final false
 float_t get_time() ;

/// @brief Method Awake addr 0x20f3454 size 0x84 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x20f34d8 size 0x20 virtual false final false
 void Start() ;

/// @brief Method Init addr 0x20f34f8 size 0x1b0 virtual false final false
...
/// @brief Method ComputeDSPTimes addr 0x20f36a8 size 0xac virtual false final false
 void ComputeDSPTimes(double_t noteDSPTime, float_t aheadTime, float_t timeToPrevNote, float_t timeToNextNote) ;

/// @brief Method LateUpdate addr 0x20f3754 size 0x1c0 virtual false final false
 void LateUpdate() ;

/// @brief Method StopPlayingAndFinish addr 0x20f3914 size 0x1f0 virtual false final false
 void StopPlayingAndFinish() ;

/// @brief Method NoteWasCut addr 0x20f3b04 size 0x20c virtual false final false
...
/// @brief Method .ctor addr 0x20f3d10 size 0x84 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4055)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 2723 }), TypeDefinitionIndex(TypeDefinitionIndex(11011))}
...
/// @brief Method .ctor addr 0x20f3d94 size 0x48 virtual false final false
 void _ctor() ;
