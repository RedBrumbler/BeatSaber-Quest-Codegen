...
/// @brief Method add_playerDidFailEvent addr 0x21178e0 size 0x9c virtual false final false
 void add_playerDidFailEvent(System::Action value) ;

/// @brief Method remove_playerDidFailEvent addr 0x21173fc size 0x9c virtual false final false
 void remove_playerDidFailEvent(System::Action value) ;

/// @brief Method Start addr 0x2118760 size 0x1a8 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2118908 size 0x1a4 virtual false final false
 void OnDestroy() ;

/// @brief Method CheckIfPlayerFailed addr 0x2118aac size 0x1ec virtual false final false
 void CheckIfPlayerFailed(GlobalNamespace::IConnectedPlayer player) ;

/// @brief Method HandlePlayerDisconnected addr 0x2118c98 size 0x4 virtual false final false
 void HandlePlayerDisconnected(GlobalNamespace::IConnectedPlayer player) ;

/// @brief Method HandlePlayerStateChanged addr 0x2118c9c size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x2118ca0 size 0x8 virtual false final false
 void _ctor() ;
