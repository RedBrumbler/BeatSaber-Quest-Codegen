...
/// @brief Method get_userId addr 0x1225308 size 0x8 virtual false final false
 ::StringW get_userId() ;

/// @brief Method get_isServerOwner addr 0x1225310 size 0x8 virtual false final false
 bool get_isServerOwner() ;

/// @brief Method get_hasRecommendBeatmapsPermission addr 0x1225318 size 0x8 virtual false final false
 bool get_hasRecommendBeatmapsPermission() ;

/// @brief Method get_hasRecommendGameplayModifiersPermission addr 0x1225320 size 0x8 virtual false final false
 bool get_hasRecommendGameplayModifiersPermission() ;

/// @brief Method get_hasKickVotePermission addr 0x1225328 size 0x8 virtual false final false
 bool get_hasKickVotePermission() ;

/// @brief Method get_hasInvitePermission addr 0x1225330 size 0x8 virtual false final false
 bool get_hasInvitePermission() ;

/// @brief Method Obtain addr 0x1225338 size 0x64 virtual false final false
static GlobalNamespace::PlayerLobbyPermissionConfigurationNetSerializable Obtain() ;

/// @brief Method Init addr 0x122539c size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x12253cc size 0x58 virtual false final false
 void _ctor() ;

/// @brief Method Serialize addr 0x1225424 size 0x60 virtual true final false
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0x1225484 size 0x6c virtual true final false
