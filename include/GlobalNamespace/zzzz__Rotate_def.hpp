...
/// @brief Method Awake addr 0x1fb56c8 size 0xc8 virtual false final false
 void Awake() ;

/// @brief Method OnBecameVisible addr 0x1fb5790 size 0x20 virtual false final false
 void OnBecameVisible() ;

/// @brief Method OnBecameInvisible addr 0x1fb5818 size 0xc virtual false final false
 void OnBecameInvisible() ;

/// @brief Method Update addr 0x1fb5824 size 0xbc virtual false final false
 void Update() ;

/// @brief Method Randomize addr 0x1fb57b0 size 0x68 virtual false final false
 void Randomize() ;

// Ctor Parameters []
explicit Rotate() ;

/// @brief Method .ctor addr 0x1fb58e0 size 0x80 virtual false final false
 void _ctor() ;
