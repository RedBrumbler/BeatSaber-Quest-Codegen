...
/// @brief Method get_allBeatmapCharacteristics addr 0x21fff6c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x21fff74 size 0x8 virtual false final false
 void _ctor() ;
