...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4861), inst: 340 }), TypeDefinitionIndex(TypeDefinitionIndex(4861)), TypeDefinitionIndex(TypeDefinitionIndex(5241))}
...
/// @brief Method get_gameNoteController addr 0x2119a14 size 0x8 virtual true final false
...
/// @brief Method .ctor addr 0x2119a1c size 0x6c virtual false final false
 void _ctor() ;
