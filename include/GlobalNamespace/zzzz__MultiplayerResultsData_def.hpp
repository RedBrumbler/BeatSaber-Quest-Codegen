...
/// @brief Method get_gameId addr 0x2138824 size 0x8 virtual false final false
 ::StringW get_gameId() ;

/// @brief Method get_localPlayerResultData addr 0x213882c size 0x8 virtual false final false
 GlobalNamespace::MultiplayerPlayerResultsData get_localPlayerResultData() ;

/// @brief Method get_otherPlayersData addr 0x2138834 size 0x8 virtual false final false
 System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::MultiplayerPlayerResultsData> get_otherPlayersData() ;

/// @brief Method get_allPlayersSortedData addr 0x213883c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x212a374 size 0x54c virtual false final false
