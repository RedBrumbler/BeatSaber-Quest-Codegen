...
/// @brief Method .ctor addr 0x21050d8 size 0x28 virtual false final false
...
/// @brief Method Start addr 0x2104acc size 0x78 virtual false final false
 void Start() ;

/// @brief Method OnEnable addr 0x2104ebc size 0x4 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2104ec0 size 0x4 virtual false final false
 void OnDisable() ;

/// @brief Method RegisterForEvents addr 0x2104b44 size 0x198 virtual false final false
 void RegisterForEvents() ;

/// @brief Method UnregisterFromEvents addr 0x2104ec4 size 0x108 virtual false final false
 void UnregisterFromEvents() ;

/// @brief Method HandleScoreDidChangeRealtime addr 0x2104fcc size 0x4 virtual false final false
 void HandleScoreDidChangeRealtime(int32_t multipliedScore, int32_t modifiedScore) ;

/// @brief Method UpdateScore addr 0x2104cdc size 0x1e0 virtual false final false
 void UpdateScore(int32_t multipliedScore, int32_t modifiedScore) ;

/// @brief Method Append000Number addr 0x2104fd0 size 0x98 virtual false final false
static void Append000Number(System::Text::StringBuilder stringBuilder, int32_t number) ;

// Ctor Parameters []
explicit ScoreUIController() ;

/// @brief Method .ctor addr 0x2105068 size 0x70 virtual false final false
 void _ctor() ;
