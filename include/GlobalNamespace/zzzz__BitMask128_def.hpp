...
/// @brief Method get_bitCount addr 0x12206e4 size 0x8 virtual true final true
 int32_t get_bitCount() ;

/// @brief Method get_maxValue addr 0x12206ec size 0xc virtual false final false
static GlobalNamespace::BitMask128 get_maxValue() ;

/// @brief Method .ctor addr 0x12206f8 size 0x8 virtual false final false
 void _ctor(uint64_t d0, uint64_t d1) ;

/// @brief Method .ctor addr 0x1220700 size 0x8 virtual false final false
 void _ctor(uint64_t value) ;

/// @brief Method SetBits addr 0x1220708 size 0x68 virtual true final true
 GlobalNamespace::BitMask128 SetBits(int32_t offset, uint64_t bits) ;

/// @brief Method GetBits addr 0x1220770 size 0xbc virtual true final true
 uint64_t GetBits(int32_t offset, int32_t count) ;

/// @brief Method op_BitwiseOr addr 0x122082c size 0x14 virtual false final false
static GlobalNamespace::BitMask128 op_BitwiseOr(ByRef<GlobalNamespace::BitMask128> a, ByRef<GlobalNamespace::BitMask128> b) ;

/// @brief Method op_BitwiseAnd addr 0x1220840 size 0x14 virtual false final false
static GlobalNamespace::BitMask128 op_BitwiseAnd(ByRef<GlobalNamespace::BitMask128> a, ByRef<GlobalNamespace::BitMask128> b) ;

/// @brief Method op_ExclusiveOr addr 0x1220854 size 0x14 virtual false final false
static GlobalNamespace::BitMask128 op_ExclusiveOr(ByRef<GlobalNamespace::BitMask128> a, ByRef<GlobalNamespace::BitMask128> b) ;

/// @brief Method op_LeftShift addr 0x1220868 size 0x34 virtual false final false
static GlobalNamespace::BitMask128 op_LeftShift(ByRef<GlobalNamespace::BitMask128> a, int32_t bits) ;

/// @brief Method op_RightShift addr 0x122089c size 0x34 virtual false final false
static GlobalNamespace::BitMask128 op_RightShift(ByRef<GlobalNamespace::BitMask128> a, int32_t bits) ;

/// @brief Method op_Equality addr 0x12208d0 size 0x2c virtual false final false
static bool op_Equality(ByRef<GlobalNamespace::BitMask128> a, ByRef<GlobalNamespace::BitMask128> b) ;

/// @brief Method op_Inequality addr 0x12208fc size 0x2c virtual false final false
static bool op_Inequality(ByRef<GlobalNamespace::BitMask128> a, ByRef<GlobalNamespace::BitMask128> b) ;

/// @brief Method op_Implicit addr 0x1220928 size 0xc virtual false final false
static GlobalNamespace::BitMask128 op_Implicit_GlobalNamespace__BitMask128(uint64_t value) ;

/// @brief Method Serialize addr 0x1220934 size 0x40 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method CreateFromSerializedData addr 0x1220974 size 0x8 virtual true final true
 GlobalNamespace::BitMask128 CreateFromSerializedData(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method Deserialize addr 0x122097c size 0x40 virtual false final false
static GlobalNamespace::BitMask128 Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method ToString addr 0x12209bc size 0x8c virtual true final false
 ::StringW ToString() ;

/// @brief Method Equals addr 0x1220a48 size 0x24 virtual true final true
 bool Equals(GlobalNamespace::BitMask128 other) ;

/// @brief Method Equals addr 0x1220a6c size 0x88 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x1220af4 size 0x48 virtual true final false
 int32_t GetHashCode() ;
