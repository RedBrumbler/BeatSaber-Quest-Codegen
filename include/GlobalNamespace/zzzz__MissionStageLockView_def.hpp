...
/// @brief Method UpdateLocalPositionY addr 0x2181680 size 0x64 virtual false final false
 void UpdateLocalPositionY(float_t dstPosY, bool animated, float_t animationDuration) ;

/// @brief Method Update addr 0x21816e4 size 0xd0 virtual false final false
 void Update() ;

/// @brief Method UpdateStageLockText addr 0x21817b4 size 0x24 virtual false final false
 void UpdateStageLockText(::StringW text) ;

// Ctor Parameters []
explicit MissionStageLockView() ;

/// @brief Method .ctor addr 0x21817d8 size 0x8 virtual false final false
 void _ctor() ;
