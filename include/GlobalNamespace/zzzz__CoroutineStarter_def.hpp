...
/// @brief Method ICoroutineStarter.StartCoroutine addr 0x1fb1ca4 size 0xd4 virtual true final true
 UnityEngine::Coroutine ICoroutineStarter_StartCoroutine(System::Collections::IEnumerator routine) ;

/// @brief Method ICoroutineStarter.StopCoroutine addr 0x1fb1d78 size 0xcc virtual true final true
 void ICoroutineStarter_StopCoroutine(UnityEngine::Coroutine routine) ;

// Ctor Parameters []
explicit CoroutineStarter() ;

/// @brief Method .ctor addr 0x1fb1e44 size 0x8 virtual false final false
 void _ctor() ;
