...
/// @brief Method get_BoundingCollider addr 0x20109e4 size 0x48 virtual false final false
 UnityEngine::Collider get_BoundingCollider() ;

/// @brief Method GetAllIntersectingObjects addr 0x2010a2c size 0x2b4 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::GameObject> GetAllIntersectingObjects() ;

// Ctor Parameters []
explicit HEU_BoundingVolume() ;

/// @brief Method .ctor addr 0x2010ce0 size 0x8 virtual false final false
 void _ctor() ;
