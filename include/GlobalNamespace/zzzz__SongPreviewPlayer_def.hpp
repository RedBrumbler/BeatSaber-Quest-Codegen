...
/// @brief Method .ctor addr 0x20f6334 size 0x28 virtual false final false
...
/// @brief Method get_position addr 0x20f635c size 0xc virtual false final false
 UnityEngine::Vector3 get_position() ;

/// @brief Method get_reverbZoneMix addr 0x20f6368 size 0x8 virtual false final false
 float_t get_reverbZoneMix() ;

/// @brief Method get_spatialBlend addr 0x20f6370 size 0x8 virtual false final false
 float_t get_spatialBlend() ;

/// @brief Method get_spread addr 0x20f6378 size 0x8 virtual false final false
 float_t get_spread() ;

// Ctor Parameters []
explicit GlobalNamespace__SongPreviewPlayer__AudioSourceParams() ;

/// @brief Method .ctor addr 0x20f6380 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method set_volume addr 0x20f5bdc size 0x34 virtual false final false
 void set_volume(float_t value) ;

/// @brief Method get_volume addr 0x20f6388 size 0x8 virtual false final false
 float_t get_volume() ;

/// @brief Method get_maxVolume addr 0x20f6390 size 0x8 virtual false final false
 float_t get_maxVolume() ;

/// @brief Method set_maxVolume addr 0x20f6398 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x20f57b4 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x20f5970 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x20f63a0 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x20f63a4 size 0xac virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x20f6450 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x20f6458 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x20f6498 size 0x8 virtual true final true
...
/// @brief Method get_activeAudioClip addr 0x20f558c size 0x54 virtual true final false
 UnityEngine::AudioClip get_activeAudioClip() ;

/// @brief Method Awake addr 0x20f55e0 size 0x1d4 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x20f57e4 size 0x20 virtual false final false
 void Start() ;

/// @brief Method OnEnable addr 0x20f5804 size 0xf4 virtual false final false
 void OnEnable() ;

/// @brief Method CrossFadeAfterDelayCoroutine addr 0x20f58f8 size 0x78 virtual false final false
 System::Collections::IEnumerator CrossFadeAfterDelayCoroutine(float_t delay) ;

/// @brief Method OnDisable addr 0x20f5998 size 0xd4 virtual false final false
 void OnDisable() ;

/// @brief Method Update addr 0x20f5a6c size 0x170 virtual false final false
 void Update() ;

/// @brief Method CrossfadeToDefault addr 0x20f5f40 size 0x170 virtual false final false
 void CrossfadeToDefault() ;

/// @brief Method CrossfadeToNewDefault addr 0x20f60b0 size 0xe0 virtual false final false
 void CrossfadeToNewDefault(UnityEngine::AudioClip audioClip) ;

/// @brief Method CrossfadeTo addr 0x20f6190 size 0xc virtual false final false
...
/// @brief Method CrossfadeTo addr 0x20f5cc0 size 0x280 virtual false final false
...
/// @brief Method PauseCurrentChannel addr 0x20f619c size 0x74 virtual true final false
 void PauseCurrentChannel() ;

/// @brief Method UnPauseCurrentChannel addr 0x20f6210 size 0x70 virtual true final false
 void UnPauseCurrentChannel() ;

/// @brief Method FadeOut addr 0x20f6280 size 0x1c virtual true final false
 void FadeOut(float_t duration) ;

/// @brief Method ReportChannelDidFadeOut addr 0x20f5c10 size 0xb0 virtual false final false
 void ReportChannelDidFadeOut(int32_t channel) ;

// Ctor Parameters []
explicit SongPreviewPlayer() ;

/// @brief Method .ctor addr 0x20f629c size 0x98 virtual false final false
 void _ctor() ;
