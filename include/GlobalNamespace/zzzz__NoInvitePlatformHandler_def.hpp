...
/// @brief Method get_isSupported addr 0x222c794 size 0x8 virtual true final true
 bool get_isSupported() ;

/// @brief Method OpenInvitePanel addr 0x222c79c size 0x40 virtual true final true
 void OpenInvitePanel() ;

// Ctor Parameters []
explicit NoInvitePlatformHandler() ;

/// @brief Method .ctor addr 0x222c7dc size 0x8 virtual false final false
 void _ctor() ;
