...
/// @brief Method get_targetTexture addr 0x26aa5c4 size 0x8 virtual false final false
 UnityEngine::RenderTexture get_targetTexture() ;

/// @brief Method Awake addr 0x26aa5cc size 0x50 virtual false final false
 void Awake() ;

/// @brief Method OnRenderImage addr 0x26aa61c size 0x1f8 virtual false final false
 void OnRenderImage(UnityEngine::RenderTexture src, UnityEngine::RenderTexture dst) ;

// Ctor Parameters []
explicit RenderTextureFromPostEffect() ;

/// @brief Method .ctor addr 0x26aa814 size 0x8 virtual false final false
 void _ctor() ;
