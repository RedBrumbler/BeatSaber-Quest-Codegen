...
/// @brief Method MoveNext addr 0x2224c00 size 0x230 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2224e30 size 0x58 virtual true final true
...
/// @brief Method MoveNext addr 0x2224e88 size 0x230 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x22250b8 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method get_levelID addr 0x222491c size 0x8 virtual true final true
 ::StringW get_levelID() ;

/// @brief Method get_songName addr 0x2224924 size 0x8 virtual true final true
 ::StringW get_songName() ;

/// @brief Method get_songSubName addr 0x222492c size 0x8 virtual true final true
 ::StringW get_songSubName() ;

/// @brief Method get_songAuthorName addr 0x2224934 size 0x8 virtual true final true
 ::StringW get_songAuthorName() ;

/// @brief Method get_levelAuthorName addr 0x222493c size 0x8 virtual true final true
 ::StringW get_levelAuthorName() ;

/// @brief Method get_beatsPerMinute addr 0x2224944 size 0x8 virtual true final true
 float_t get_beatsPerMinute() ;

/// @brief Method get_songTimeOffset addr 0x222494c size 0x8 virtual true final true
 float_t get_songTimeOffset() ;

/// @brief Method get_songDuration addr 0x2224954 size 0x8 virtual true final true
 float_t get_songDuration() ;

/// @brief Method get_shuffle addr 0x222495c size 0x8 virtual true final true
 float_t get_shuffle() ;

/// @brief Method get_shufflePeriod addr 0x2224964 size 0x8 virtual true final true
 float_t get_shufflePeriod() ;

/// @brief Method get_previewStartTime addr 0x222496c size 0x8 virtual true final true
 float_t get_previewStartTime() ;

/// @brief Method get_previewDuration addr 0x2224974 size 0x8 virtual true final true
 float_t get_previewDuration() ;

/// @brief Method get_environmentInfo addr 0x222497c size 0x8 virtual true final true
 GlobalNamespace::EnvironmentInfoSO get_environmentInfo() ;

/// @brief Method get_allDirectionsEnvironmentInfo addr 0x2224984 size 0x8 virtual true final true
 GlobalNamespace::EnvironmentInfoSO get_allDirectionsEnvironmentInfo() ;

/// @brief Method get_environmentInfos addr 0x222498c size 0x8 virtual true final true
 ::ArrayW<GlobalNamespace::EnvironmentInfoSO> get_environmentInfos() ;

/// @brief Method get_songPreviewAudioClip addr 0x2224994 size 0x8 virtual true final true
 UnityEngine::AudioClip get_songPreviewAudioClip() ;

/// @brief Method get_previewDifficultyBeatmapSets addr 0x222499c size 0x1c virtual true final true
 System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::PreviewDifficultyBeatmapSet> get_previewDifficultyBeatmapSets() ;

/// @brief Method OnEnable addr 0x22249b8 size 0x28 virtual true final false
 void OnEnable() ;

/// @brief Method InitData addr 0x22249e0 size 0x20 virtual false final false
 void InitData() ;

/// @brief Method GetPreviewAudioClipAsync addr 0x2224a00 size 0xfc virtual false final false
...
/// @brief Method GetCoverImageAsync addr 0x2224afc size 0xfc virtual true final true
...
/// @brief Method .ctor addr 0x2224bf8 size 0x8 virtual false final false
 void _ctor() ;
