...
/// @brief Method Start addr 0x20f1aec size 0xe4 virtual false final false
 void Start() ;

/// @brief Method HandleNoteWasCut addr 0x20f1bd0 size 0x220 virtual false final false
 void HandleNoteWasCut(GlobalNamespace::NoteController noteController, ByRef<GlobalNamespace::NoteCutInfo> noteCutInfo) ;

/// @brief Method OnDestroy addr 0x20f1df0 size 0x98 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleBombCutSoundEffectDidFinish addr 0x20f1e88 size 0xb8 virtual false final false
...
/// @brief Method .ctor addr 0x20f1f40 size 0x14 virtual false final false
 void _ctor() ;
