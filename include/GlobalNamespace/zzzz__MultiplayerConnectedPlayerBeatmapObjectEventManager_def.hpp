...
/// @brief Method .ctor addr 0x2114e40 size 0xc virtual false final false
...
/// @brief Method add_connectedPlayerNoteWasSpawnedEvent addr 0x2113c80 size 0xb0 virtual true final true
 void add_connectedPlayerNoteWasSpawnedEvent(System::Action_1<GlobalNamespace::NoteSpawnInfoNetSerializable> value) ;

/// @brief Method remove_connectedPlayerNoteWasSpawnedEvent addr 0x2113d30 size 0xb0 virtual true final true
 void remove_connectedPlayerNoteWasSpawnedEvent(System::Action_1<GlobalNamespace::NoteSpawnInfoNetSerializable> value) ;

/// @brief Method add_connectedPlayerObstacleWasSpawnedEvent addr 0x2113de0 size 0xb0 virtual true final true
 void add_connectedPlayerObstacleWasSpawnedEvent(System::Action_1<GlobalNamespace::ObstacleSpawnInfoNetSerializable> value) ;

/// @brief Method remove_connectedPlayerObstacleWasSpawnedEvent addr 0x2113e90 size 0xb0 virtual true final true
...
/// @brief Method add_connectedPlayerSliderWasSpawnedEvent addr 0x2113f40 size 0xb0 virtual true final true
 void add_connectedPlayerSliderWasSpawnedEvent(System::Action_1<GlobalNamespace::SliderSpawnInfoNetSerializable> value) ;

/// @brief Method remove_connectedPlayerSliderWasSpawnedEvent addr 0x2113ff0 size 0xb0 virtual true final true
 void remove_connectedPlayerSliderWasSpawnedEvent(System::Action_1<GlobalNamespace::SliderSpawnInfoNetSerializable> value) ;

/// @brief Method add_connectedPlayerNoteWasCutEvent addr 0x21140a0 size 0xb0 virtual true final true
 void add_connectedPlayerNoteWasCutEvent(System::Action_1<GlobalNamespace::NoteCutInfoNetSerializable> value) ;

/// @brief Method remove_connectedPlayerNoteWasCutEvent addr 0x2114150 size 0xb0 virtual true final true
 void remove_connectedPlayerNoteWasCutEvent(System::Action_1<GlobalNamespace::NoteCutInfoNetSerializable> value) ;

/// @brief Method add_connectedPlayerNoteWasMissedEvent addr 0x2114200 size 0xb0 virtual true final true
 void add_connectedPlayerNoteWasMissedEvent(System::Action_1<GlobalNamespace::NoteMissInfoNetSerializable> value) ;

/// @brief Method remove_connectedPlayerNoteWasMissedEvent addr 0x21142b0 size 0xb0 virtual true final true
 void remove_connectedPlayerNoteWasMissedEvent(System::Action_1<GlobalNamespace::NoteMissInfoNetSerializable> value) ;

/// @brief Method Start addr 0x2114360 size 0x3b8 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2114718 size 0x3c8 virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x2114ae0 size 0xc0 virtual false final false
 void Update() ;

/// @brief Method Pause addr 0x2114db0 size 0xc virtual true final true
 void Pause() ;

/// @brief Method Resume addr 0x2114dbc size 0x8 virtual true final true
 void Resume() ;
...
/// @brief Method InvokeCallback addr 0x2114ba0 size 0x210 virtual false final false
...
/// @brief Method .ctor addr 0x2114dc4 size 0x7c virtual false final false
 void _ctor() ;
