...
/// @brief Method get_ps4TrophyId addr 0x2254c88 size 0x8 virtual false final false
 int32_t get_ps4TrophyId() ;

/// @brief Method get_achievementId addr 0x2254a2c size 0x1c virtual false final false
 ::StringW get_achievementId() ;

// Ctor Parameters []
explicit GlobalNamespace__SonyAchievementIdsModelSO__AchievementIdData() ;

/// @brief Method .ctor addr 0x2254c90 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_achievementsIds addr 0x22547e4 size 0x8 virtual false final false
...
/// @brief Method OnEnable addr 0x22547ec size 0x240 virtual true final false
 void OnEnable() ;

/// @brief Method GetTrophyId addr 0x2254a48 size 0x68 virtual false final false
 bool GetTrophyId(::StringW achievementId, ByRef<int32_t> trophyId) ;

/// @brief Method GetTrophyIds addr 0x2254ab0 size 0x6c virtual false final false
 ::ArrayW<int32_t> GetTrophyIds() ;

/// @brief Method GetAchievementId addr 0x2254b1c size 0x68 virtual false final false
 bool GetAchievementId(int32_t trophyId, ByRef<::StringW> achievementId) ;

// Ctor Parameters []
explicit SonyAchievementIdsModelSO() ;

/// @brief Method .ctor addr 0x2254b84 size 0x104 virtual false final false
 void _ctor() ;
