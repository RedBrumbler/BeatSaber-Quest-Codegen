...
/// @brief Method .ctor addr 0x218367c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Start>b__5_0 addr 0x2183684 size 0x1c virtual false final false
...
/// @brief Method add_didSelectCellWithIdxEvent addr 0x2182ff0 size 0xb0 virtual false final false
 void add_didSelectCellWithIdxEvent(System::Action_1<GlobalNamespace::BeatmapCharacteristicSO> value) ;

/// @brief Method remove_didSelectCellWithIdxEvent addr 0x21830a0 size 0xb0 virtual false final false
 void remove_didSelectCellWithIdxEvent(System::Action_1<GlobalNamespace::BeatmapCharacteristicSO> value) ;

/// @brief Method Start addr 0x2183150 size 0x1b0 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2183300 size 0xd4 virtual false final false
 void OnDestroy() ;

/// @brief Method GetSelectedBeatmapCharacteristic addr 0x21833d4 size 0xb8 virtual false final false
 GlobalNamespace::BeatmapCharacteristicSO GetSelectedBeatmapCharacteristic() ;

/// @brief Method SelectCellWithBeatmapCharacteristic addr 0x218348c size 0xa8 virtual false final false
 void SelectCellWithBeatmapCharacteristic(GlobalNamespace::BeatmapCharacteristicSO beatmapCharacteristic) ;

/// @brief Method HandleSimpleTextDropdownDidSelectCellWithIdx addr 0x2183534 size 0xdc virtual false final false
...
/// @brief Method .ctor addr 0x2183610 size 0x8 virtual false final false
 void _ctor() ;
