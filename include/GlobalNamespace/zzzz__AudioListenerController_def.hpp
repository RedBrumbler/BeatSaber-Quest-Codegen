...
/// @brief Method get_isPaused addr 0x20f01f4 size 0x8 virtual false final false
 bool get_isPaused() ;

/// @brief Method Awake addr 0x20f01fc size 0x20 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x20f021c size 0xc virtual false final false
 void OnDestroy() ;

/// @brief Method Pause addr 0x20f0228 size 0xc virtual false final false
 void Pause() ;

/// @brief Method Resume addr 0x20f0234 size 0xc virtual false final false
 void Resume() ;

// Ctor Parameters []
explicit AudioListenerController() ;

/// @brief Method .ctor addr 0x20f0240 size 0x8 virtual false final false
 void _ctor() ;
