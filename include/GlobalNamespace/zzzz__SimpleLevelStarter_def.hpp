...
/// @brief Method Awake addr 0x220b95c size 0xc4 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x220ba20 size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method StartLevel addr 0x220ba3c size 0x2b4 virtual false final false
 void StartLevel() ;

/// @brief Method InstallEarlyBindings addr 0x220bcf0 size 0x128 virtual false final false
...
/// @brief Method ButtonPressed addr 0x220be18 size 0x4 virtual false final false
 void ButtonPressed() ;

/// @brief Method HandleLevelDidFinish addr 0x220be1c size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x220be44 size 0xd8 virtual false final false
 void _ctor() ;

/// @brief Method <StartLevel>g__AfterSceneSwitchCallback|15_0 addr 0x220bf1c size 0x13c virtual false final false
