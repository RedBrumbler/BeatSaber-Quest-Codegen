...
/// @brief Method GetTriangleCount addr 0x26697b0 size 0x24 virtual false final false
 int32_t GetTriangleCount() ;

/// @brief Method BuildMeshes addr 0x26697d4 size 0x688 virtual false final false
 void BuildMeshes() ;

/// @brief Method BuildMaterials addr 0x2669e5c size 0x3a8 virtual false final false
 void BuildMaterials() ;

/// @brief Method OnEnable addr 0x266a204 size 0xa4 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x266a2a8 size 0xac virtual false final false
 void OnDisable() ;

/// @brief Method Awake addr 0x266a38c size 0x314 virtual false final false
 void Awake() ;

/// @brief Method GetTanFovAndOffsetForStereoEye addr 0x266a6a0 size 0x1f8 virtual false final false
...
/// @brief Method GetTanFovAndOffsetForMonoEye addr 0x266a898 size 0x8c virtual false final false
...
/// @brief Method VisibilityTest addr 0x266a924 size 0x34 virtual false final false
 bool VisibilityTest(float_t scaleX, float_t scaleY, float_t offsetX, float_t offsetY) ;

/// @brief Method Update addr 0x266a958 size 0x370 virtual false final false
 void Update() ;

/// @brief Method EnableRenderers addr 0x266acc8 size 0x38 virtual false final false
 void EnableRenderers() ;

/// @brief Method DisableRenderers addr 0x266a354 size 0x38 virtual false final false
 void DisableRenderers() ;

/// @brief Method OnPreCull addr 0x266ad00 size 0x4 virtual false final false
 void OnPreCull() ;

/// @brief Method OnPostRender addr 0x266ad04 size 0x4 virtual false final false
 void OnPostRender() ;

/// @brief Method OnBeginCameraRendering addr 0x266ad08 size 0x8c virtual false final false
...
/// @brief Method .ctor addr 0x266ad94 size 0xa4 virtual false final false
 void _ctor() ;
