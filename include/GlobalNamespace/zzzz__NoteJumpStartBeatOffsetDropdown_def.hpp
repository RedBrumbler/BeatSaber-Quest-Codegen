...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5700)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5700), inst: 374 })}
...
/// @brief Method GetNamedValues addr 0x218af48 size 0x198 virtual true final false
...
/// @brief Method .ctor addr 0x218b0e0 size 0x48 virtual false final false
 void _ctor() ;
