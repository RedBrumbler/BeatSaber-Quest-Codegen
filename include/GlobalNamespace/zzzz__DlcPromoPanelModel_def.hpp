...
/// @brief Method MoveNext addr 0x21f510c size 0x46c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x21f5578 size 0xc virtual true final true
...
/// @brief Method InitAfterPlatformWasInitialized addr 0x21f4394 size 0xec virtual false final false
 void InitAfterPlatformWasInitialized(bool force) ;

/// @brief Method GetPackDataForMainMenuPromoBanner addr 0x21f4518 size 0x268 virtual false final false
...
/// @brief Method MainMenuDlcPromoBannerWasShown addr 0x21f4780 size 0x184 virtual false final false
 void MainMenuDlcPromoBannerWasShown(GlobalNamespace::IBeatmapLevelPack promoPack, ::StringW customText) ;

/// @brief Method MainMenuDlcPromoBannerWasPressed addr 0x21f4a24 size 0x16c virtual false final false
 void MainMenuDlcPromoBannerWasPressed(GlobalNamespace::IBeatmapLevelPack promoPack, ::StringW customText) ;

/// @brief Method BuyLevelButtonWasPressed addr 0x21f4b90 size 0x15c virtual false final false
 void BuyLevelButtonWasPressed(GlobalNamespace::IPreviewBeatmapLevel level, ::StringW page, ::StringW customText) ;

/// @brief Method BuyLevelButtonWasShown addr 0x21f4cec size 0x15c virtual false final false
 void BuyLevelButtonWasShown(GlobalNamespace::IPreviewBeatmapLevel level, ::StringW page, ::StringW customText) ;

/// @brief Method BuyPackButtonWasPressed addr 0x21f4e48 size 0x15c virtual false final false
 void BuyPackButtonWasPressed(GlobalNamespace::IBeatmapLevelPack pack, ::StringW page, ::StringW customText) ;

/// @brief Method BuyPackButtonWasShown addr 0x21f4fa4 size 0x15c virtual false final false
 void BuyPackButtonWasShown(GlobalNamespace::IBeatmapLevelPack pack, ::StringW page, ::StringW customText) ;

/// @brief Method GetExperimentEventData addr 0x21f4904 size 0x120 virtual false final false
...
/// @brief Method UpdateNotOwnedPacksAsync addr 0x21f4480 size 0x98 virtual false final false
 void UpdateNotOwnedPacksAsync() ;

/// @brief Method HandleAdditionalContentModelDidInvalidateData addr 0x21f5100 size 0x4 virtual false final false
 void HandleAdditionalContentModelDidInvalidateData() ;

// Ctor Parameters []
explicit DlcPromoPanelModel() ;

/// @brief Method .ctor addr 0x21f5104 size 0x8 virtual false final false
 void _ctor() ;
