...
/// @brief Method add_selectionDidChangeEvent addr 0x21812b8 size 0xb0 virtual false final false
 void add_selectionDidChangeEvent(System::Action_1<GlobalNamespace::MissionToggle> value) ;

/// @brief Method remove_selectionDidChangeEvent addr 0x21814a0 size 0xb0 virtual false final false
 void remove_selectionDidChangeEvent(System::Action_1<GlobalNamespace::MissionToggle> value) ;

/// @brief Method set_missionCleared addr 0x21819b8 size 0xc virtual false final false
 void set_missionCleared(bool value) ;

/// @brief Method get_selected addr 0x21819c4 size 0x8 virtual false final false
 bool get_selected() ;

/// @brief Method set_selected addr 0x21811ec size 0x10 virtual false final false
 void set_selected(bool value) ;

/// @brief Method get_interactable addr 0x21819cc size 0x8 virtual false final false
 bool get_interactable() ;

/// @brief Method set_interactable addr 0x2181368 size 0xc virtual false final false
 void set_interactable(bool value) ;

/// @brief Method get_highlighted addr 0x2181c7c size 0x8 virtual false final false
 bool get_highlighted() ;

/// @brief Method Start addr 0x2181c84 size 0x1c virtual true final false
 void Start() ;

/// @brief Method ChangeSelection addr 0x21815d4 size 0x64 virtual false final false
 void ChangeSelection(bool value, bool callSelectionDidChange, bool ignoreCurrentValue) ;

/// @brief Method ChangeHighlight addr 0x2181ca0 size 0x20 virtual false final false
 void ChangeHighlight(bool value, bool ignoreCurrentValue) ;

/// @brief Method SetText addr 0x2181550 size 0x24 virtual false final false
 void SetText(::StringW text) ;

/// @brief Method InternalToggle addr 0x2181cc0 size 0x30 virtual false final false
 void InternalToggle() ;

/// @brief Method RefreshUI addr 0x21819d4 size 0x2a8 virtual false final false
 void RefreshUI() ;

/// @brief Method OnPointerClick addr 0x2181cf0 size 0xa8 virtual true final false
 void OnPointerClick(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnSubmit addr 0x2181d98 size 0x98 virtual true final false
 void OnSubmit(UnityEngine::EventSystems::BaseEventData eventData) ;

/// @brief Method OnPointerEnter addr 0x2181e30 size 0x24 virtual true final false
 void OnPointerEnter(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnPointerExit addr 0x2181e54 size 0x1c virtual true final false
 void OnPointerExit(UnityEngine::EventSystems::PointerEventData eventData) ;

// Ctor Parameters []
explicit MissionToggle() ;

/// @brief Method .ctor addr 0x2181e70 size 0x2c virtual false final false
 void _ctor() ;
