...
/// @brief Method OnDestroy addr 0x1fb6bf8 size 0x4c virtual false final false
 void OnDestroy() ;

/// @brief Method Log addr 0x1fb68bc size 0xa8 virtual false final false
 void Log(::StringW text) ;

/// @brief Method Clear addr 0x1fb6818 size 0x84 virtual false final false
 void Clear() ;

// Ctor Parameters []
explicit GlobalNamespace__SimpleFileLogger__MonoLogger() ;

/// @brief Method .ctor addr 0x1fb6c44 size 0x7c virtual false final false
 void _ctor() ;
...
/// @brief Method get_monoLogger addr 0x1fb6704 size 0x114 virtual false final false
static GlobalNamespace::GlobalNamespace__SimpleFileLogger__MonoLogger get_monoLogger() ;

/// @brief Method Log addr 0x1fb689c size 0x20 virtual false final false
static void Log(::StringW text) ;

/// @brief Method LogVector addr 0x1fb6964 size 0x274 virtual false final false
static void LogVector(::StringW description, UnityEngine::Vector3 vec) ;

/// @brief Method Clear addr 0x1fb6bd8 size 0x18 virtual false final false
static void Clear() ;

// Ctor Parameters []
explicit SimpleFileLogger() ;

/// @brief Method .ctor addr 0x1fb6bf0 size 0x8 virtual false final false
 void _ctor() ;
