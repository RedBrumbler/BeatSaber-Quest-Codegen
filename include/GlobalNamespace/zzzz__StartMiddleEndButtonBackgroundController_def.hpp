...
/// @brief Method SetStartSprite addr 0x215ee08 size 0x24 virtual false final false
 void SetStartSprite() ;

/// @brief Method SetMiddleSprite addr 0x215ee2c size 0x24 virtual false final false
 void SetMiddleSprite() ;

/// @brief Method SetEndSprite addr 0x215ee50 size 0x24 virtual false final false
 void SetEndSprite() ;

// Ctor Parameters []
explicit StartMiddleEndButtonBackgroundController() ;

/// @brief Method .ctor addr 0x215ee74 size 0x8 virtual false final false
 void _ctor() ;
