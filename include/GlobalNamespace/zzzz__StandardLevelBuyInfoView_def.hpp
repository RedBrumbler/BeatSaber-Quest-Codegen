...
/// @brief Method get_buyLevelButton addr 0x21c6694 size 0x8 virtual false final false
 UnityEngine::UI::Button get_buyLevelButton() ;

/// @brief Method get_openPackButton addr 0x21c669c size 0x8 virtual false final false
 UnityEngine::UI::Button get_openPackButton() ;

/// @brief Method get_buyPackButton addr 0x21c66a4 size 0x8 virtual false final false
 UnityEngine::UI::Button get_buyPackButton() ;

/// @brief Method RefreshView addr 0x21c66ac size 0x78 virtual false final false
 void RefreshView(::StringW infoText, bool canBuyPack) ;

// Ctor Parameters []
explicit StandardLevelBuyInfoView() ;

/// @brief Method .ctor addr 0x21c6724 size 0x8 virtual false final false
 void _ctor() ;
