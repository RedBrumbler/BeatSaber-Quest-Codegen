...
/// @brief Method GetBeatmapCharacteristics addr 0x21fffd4 size 0xec virtual false final false
...
/// @brief Method GetPreviewDifficultyBeatmapSetWithout360Movement addr 0x22000c0 size 0x144 virtual false final false
