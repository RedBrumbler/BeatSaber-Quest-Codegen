...
/// @brief Method .ctor addr 0x21206dc size 0x4c virtual false final false
...
/// @brief Method get_waitUntilIsReadyToStartTheSong addr 0x2120774 size 0xac virtual true final true
 UnityEngine::WaitUntil get_waitUntilIsReadyToStartTheSong() ;

/// @brief Method get_isAudioLoaded addr 0x2120820 size 0x9c virtual false final false
 bool get_isAudioLoaded() ;

/// @brief Method Awake addr 0x21208bc size 0x118 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x21209d4 size 0xf0 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2120ac4 size 0x108 virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x2120bcc size 0x278 virtual false final false
 void Update() ;

/// @brief Method StartSong addr 0x2120f70 size 0xec virtual true final true
 void StartSong(float_t offsetTime) ;

/// @brief Method FollowOffsetSyncTime addr 0x21211bc size 0x1e0 virtual false final false
 void FollowOffsetSyncTime(GlobalNamespace::IMultiplayerObservable observable, bool crossFade, bool forceUpdate) ;

/// @brief Method UpdateOffsetSyncTime addr 0x2120e44 size 0x12c virtual false final false
 void UpdateOffsetSyncTime(float_t offsetSyncTime, bool crossFade, bool forceUpdate) ;

/// @brief Method SeekTo addr 0x212139c size 0xc virtual true final true
 void SeekTo(float_t offsetTime) ;

/// @brief Method SeekTo addr 0x212105c size 0x160 virtual false final false
 void SeekTo(float_t offsetTime, bool crossFade, float_t toVolume) ;

/// @brief Method HandleVrFocusWasReleased addr 0x21213a8 size 0x4 virtual false final false
 void HandleVrFocusWasReleased() ;

// Ctor Parameters []
explicit MultiplayerLocalInactivePlayerSongSyncController() ;

/// @brief Method .ctor addr 0x21213ac size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <get_waitUntilIsReadyToStartTheSong>b__7_0 addr 0x21213b4 size 0x4 virtual false final false
