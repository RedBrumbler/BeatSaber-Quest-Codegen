...
/// @brief Method get_worldToPlayerSpaceRotation addr 0x2141898 size 0xc virtual false final false
 UnityEngine::Quaternion get_worldToPlayerSpaceRotation() ;

/// @brief Method Start addr 0x21418a4 size 0x38 virtual false final false
 void Start() ;

// Ctor Parameters []
explicit PlayerSpaceConvertor() ;

/// @brief Method .ctor addr 0x21418dc size 0x8 virtual false final false
 void _ctor() ;
