...
/// @brief Method get_type addr 0x222a650 size 0x8 virtual false final false
 GlobalNamespace::MissionObjectiveTypeSO get_type() ;

/// @brief Method get_referenceValueComparisonType addr 0x222a658 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__MissionObjective__ReferenceValueComparisonType get_referenceValueComparisonType() ;

/// @brief Method get_referenceValue addr 0x222a660 size 0x8 virtual false final false
 int32_t get_referenceValue() ;

/// @brief Method op_Equality addr 0x222a668 size 0xbc virtual false final false
static bool op_Equality(GlobalNamespace::MissionObjective obj1, GlobalNamespace::MissionObjective obj2) ;

/// @brief Method op_Inequality addr 0x222a724 size 0x18 virtual false final false
static bool op_Inequality(GlobalNamespace::MissionObjective obj1, GlobalNamespace::MissionObjective obj2) ;

/// @brief Method Equals addr 0x222a73c size 0x10c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x222a848 size 0x64 virtual true final false
 int32_t GetHashCode() ;

// Ctor Parameters []
explicit MissionObjective() ;

/// @brief Method .ctor addr 0x222a8ac size 0x8 virtual false final false
 void _ctor() ;
