...
/// @brief Method get_environmentInfos addr 0x2167fe0 size 0x8 virtual false final false
 System::Collections::Generic::List_1<GlobalNamespace::EnvironmentInfoSO> get_environmentInfos() ;

/// @brief Method set_environmentInfos addr 0x2167fe8 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2167ff0 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x216805c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SetData>b__12_0 addr 0x2168064 size 0x18 virtual false final false
...
/// @brief Method get_overrideEnvironmentSettings addr 0x2167554 size 0x8 virtual false final false
 GlobalNamespace::OverrideEnvironmentSettings get_overrideEnvironmentSettings() ;

/// @brief Method SetData addr 0x216755c size 0x2b0 virtual false final false
 void SetData(GlobalNamespace::OverrideEnvironmentSettings overrideEnvironmentSettings) ;

/// @brief Method OnDestroy addr 0x216780c size 0x19c virtual false final false
 void OnDestroy() ;

/// @brief Method Refresh addr 0x21679a8 size 0x154 virtual true final true
 void Refresh() ;

/// @brief Method HandleDropDownDidSelectCellWithIdx addr 0x2167afc size 0x290 virtual false final false
 void HandleDropDownDidSelectCellWithIdx(HMUI::DropdownWithTableView dropDownWithTableView, int32_t idx) ;

/// @brief Method HandleOverrideEnvironmentsToggleValueChanged addr 0x2167d8c size 0x22c virtual false final false
 void HandleOverrideEnvironmentsToggleValueChanged(bool isOn) ;

// Ctor Parameters []
explicit EnvironmentOverrideSettingsPanelController() ;

/// @brief Method .ctor addr 0x2167fb8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <HandleOverrideEnvironmentsToggleValueChanged>b__16_0 addr 0x2167fc0 size 0x20 virtual false final false
