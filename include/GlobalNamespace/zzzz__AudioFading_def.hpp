...
/// @brief Method Start addr 0x20f0074 size 0x5c virtual false final false
 void Start() ;

/// @brief Method Update addr 0x20f00f4 size 0xd0 virtual false final false
 void Update() ;

/// @brief Method FadeOut addr 0x20f01c4 size 0x20 virtual false final false
 void FadeOut() ;

/// @brief Method FadeIn addr 0x20f00d0 size 0x24 virtual false final false
 void FadeIn() ;

// Ctor Parameters []
explicit AudioFading() ;

/// @brief Method .ctor addr 0x20f01e4 size 0x10 virtual false final false
 void _ctor() ;
