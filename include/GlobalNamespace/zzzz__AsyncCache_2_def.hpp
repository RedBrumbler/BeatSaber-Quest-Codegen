...
template<::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6012))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6012), inst: 80 })
...
template<::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6013))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6013), inst: 80 })
