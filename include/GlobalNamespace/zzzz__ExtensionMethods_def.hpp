...
/// @brief Method ContainsLayer addr 0x1fb2638 size 0x38 virtual false final false
static bool ContainsLayer(UnityEngine::LayerMask layerMask, int32_t layer) ;

/// @brief Method StartUniqueCoroutine addr 0x1fb2670 size 0x7c virtual false final false
...
/// @brief Method StopUniqueCoroutine addr 0x1fb26ec size 0x44 virtual false final false
...
/// @brief Method IsDescendantOf addr 0x1fb2730 size 0xcc virtual false final false
static bool IsDescendantOf(UnityEngine::Transform transform, UnityEngine::Transform parent) ;

/// @brief Method SetLocalPositionAndRotation addr 0x1fb27fc size 0x58 virtual false final false
static void SetLocalPositionAndRotation(UnityEngine::Transform tr, UnityEngine::Vector3 pos, UnityEngine::Quaternion rot) ;

/// @brief Method GetPath addr 0x1fb2854 size 0x100 virtual false final false
static ::StringW GetPath(UnityEngine::Transform current) ;

/// @brief Method Reflect addr 0x1fb2954 size 0x164 virtual false final false
static UnityEngine::Quaternion Reflect(UnityEngine::Quaternion source, UnityEngine::Vector3 normal) ;

/// @brief Method CreateTexture2D addr 0x1fb2ab8 size 0x148 virtual false final false
...
/// @brief Method Rotate addr 0x1fb2c00 size 0x48 virtual false final false
