...
/// @brief Method get_normalTextPrefab addr 0x2166614 size 0x8 virtual false final false
 UnityEngine::GameObject get_normalTextPrefab() ;

/// @brief Method get_normalLocalizedTextPrefab addr 0x216661c size 0x8 virtual false final false
 UnityEngine::GameObject get_normalLocalizedTextPrefab() ;

/// @brief Method get_titleTextPrefab addr 0x2166624 size 0x8 virtual false final false
 UnityEngine::GameObject get_titleTextPrefab() ;

/// @brief Method get_titleLocalizedTextPrefab addr 0x216662c size 0x8 virtual false final false
 UnityEngine::GameObject get_titleLocalizedTextPrefab() ;

/// @brief Method get_headerTextPrefab addr 0x2166634 size 0x8 virtual false final false
 UnityEngine::GameObject get_headerTextPrefab() ;

/// @brief Method get_headerLocalizedTextPrefab addr 0x216663c size 0x8 virtual false final false
 UnityEngine::GameObject get_headerLocalizedTextPrefab() ;

/// @brief Method get_columnCount addr 0x2166644 size 0x8 virtual false final false
 int32_t get_columnCount() ;

/// @brief Method get_spaceHeight addr 0x216664c size 0x8 virtual false final false
 float_t get_spaceHeight() ;

/// @brief Method get_titleHeight addr 0x2166654 size 0x8 virtual false final false
 float_t get_titleHeight() ;

/// @brief Method get_contentRoot addr 0x216665c size 0x8 virtual false final false
 UnityEngine::Transform get_contentRoot() ;

/// @brief Method get_rootRectTransform addr 0x2166664 size 0x8 virtual false final false
 UnityEngine::RectTransform get_rootRectTransform() ;

/// @brief Method get_creditsContentTextAsset addr 0x216666c size 0x8 virtual false final false
 UnityEngine::TextAsset get_creditsContentTextAsset() ;

// Ctor Parameters []
explicit CreditsContent() ;

/// @brief Method .ctor addr 0x2166674 size 0x1c virtual false final false
 void _ctor() ;
