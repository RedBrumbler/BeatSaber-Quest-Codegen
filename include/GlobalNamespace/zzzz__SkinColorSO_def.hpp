...
/// @brief Method get_id addr 0x226430c size 0x8 virtual false final false
 ::StringW get_id() ;

/// @brief Method get_Color addr 0x2264314 size 0xc virtual false final false
 UnityEngine::Color get_Color() ;

// Ctor Parameters []
explicit SkinColorSO() ;

/// @brief Method .ctor addr 0x2264320 size 0x8 virtual false final false
 void _ctor() ;
