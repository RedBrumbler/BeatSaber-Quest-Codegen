...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8458))}
...
/// @brief Method CompositionMethod addr 0x25d6000 size 0x8 virtual true final false
...
/// @brief Method .ctor addr 0x25d6008 size 0x4bc virtual false final false
...
/// @brief Method RefreshCameraObjects addr 0x25d64c4 size 0xbf4 virtual false final false
...
/// @brief Method RefreshAudioFilter addr 0x25d70b8 size 0x5b0 virtual false final false
 void RefreshAudioFilter(UnityEngine::Camera mainCamera) ;

/// @brief Method CastMrcFrame addr 0x25d779c size 0x200 virtual false final false
 int32_t CastMrcFrame(int32_t castTextureIndex) ;

/// @brief Method SetCameraTargetTexture addr 0x25d7b78 size 0x1e0 virtual false final false
 void SetCameraTargetTexture(int32_t drawTextureIndex) ;

/// @brief Method Update addr 0x25d7d58 size 0xc90 virtual true final false
...
/// @brief Method CleanupAudioFilter addr 0x25d7668 size 0x134 virtual false final false
 void CleanupAudioFilter() ;

/// @brief Method Cleanup addr 0x25d8afc size 0x14c virtual true final false
 void Cleanup() ;

/// @brief Method CacheAudioData addr 0x25d8c48 size 0x138 virtual false final false
 void CacheAudioData(::ArrayW<float_t> data, int32_t channels) ;

/// @brief Method GetAndResetAudioData addr 0x25d799c size 0x1dc virtual false final false
