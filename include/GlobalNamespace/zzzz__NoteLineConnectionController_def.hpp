...
/// @brief Method add_didFinishEvent addr 0x227bf40 size 0xb0 virtual false final false
 void add_didFinishEvent(System::Action_1<GlobalNamespace::NoteLineConnectionController> value) ;

/// @brief Method remove_didFinishEvent addr 0x227bff0 size 0xb0 virtual false final false
 void remove_didFinishEvent(System::Action_1<GlobalNamespace::NoteLineConnectionController> value) ;

/// @brief Method Setup addr 0x227c0a0 size 0xa4 virtual false final false
...
/// @brief Method Update addr 0x227c300 size 0x64 virtual false final false
 void Update() ;

/// @brief Method UpdatePositionsAndColors addr 0x227c144 size 0x1bc virtual false final false
 void UpdatePositionsAndColors() ;

// Ctor Parameters []
explicit NoteLineConnectionController() ;

/// @brief Method .ctor addr 0x227c364 size 0x8 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11011)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 350 }), TypeDefinitionIndex(TypeDefinitionIndex(4900))}
...
/// @brief Method .ctor addr 0x227c36c size 0x48 virtual false final false
 void _ctor() ;
