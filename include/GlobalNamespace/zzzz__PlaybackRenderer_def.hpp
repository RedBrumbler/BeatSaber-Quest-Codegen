...
/// @brief Method get_name addr 0x21deb50 size 0x8 virtual false final false
 ::StringW get_name() ;

/// @brief Method get_texture addr 0x21deb58 size 0x8 virtual false final false
 UnityEngine::RenderTexture get_texture() ;

/// @brief Method get_layerMask addr 0x21deb60 size 0x8 virtual false final false
 UnityEngine::LayerMask get_layerMask() ;

/// @brief Method get_type addr 0x21deb68 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot__Type get_type() ;

/// @brief Method get_path addr 0x21deb70 size 0x8 virtual false final false
 ::StringW get_path() ;

/// @brief Method set_path addr 0x21deb78 size 0x8 virtual false final false
 void set_path(::StringW value) ;

/// @brief Method get_backgroundColor addr 0x21deb80 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x21deb8c size 0x68 virtual false final false
...
/// @brief Method CreateTexture addr 0x21de320 size 0xc4 virtual false final false
...
/// @brief Method add_texturesReadyEvent addr 0x21ddddc size 0x9c virtual false final false
 void add_texturesReadyEvent(System::Action value) ;

/// @brief Method remove_texturesReadyEvent addr 0x21dde78 size 0x9c virtual false final false
 void remove_texturesReadyEvent(System::Action value) ;

/// @brief Method get_screenshots addr 0x21ddf14 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot> get_screenshots() ;

/// @brief Method Setup addr 0x21dd4a4 size 0x88 virtual false final false
...
/// @brief Method CreateClipQuad addr 0x21de02c size 0x280 virtual false final false
 void CreateClipQuad() ;

/// @brief Method InitCamera addr 0x21ddf1c size 0x110 virtual false final false
...
/// @brief Method CreateTextures addr 0x21de2ac size 0x74 virtual false final false
 void CreateTextures(int32_t width, int32_t height) ;

/// @brief Method GetDistanceToHMD addr 0x21de3e4 size 0x26c virtual false final false
 float_t GetDistanceToHMD() ;

/// @brief Method OrientClipQuad addr 0x21de650 size 0x140 virtual false final false
 void OrientClipQuad() ;

/// @brief Method RenderForeground addr 0x21de790 size 0x1c0 virtual false final false
 void RenderForeground(GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot screenshot) ;

/// @brief Method RenderBackground addr 0x21de950 size 0x154 virtual false final false
 void RenderBackground(GlobalNamespace::GlobalNamespace__PlaybackRenderer__PlaybackScreenshot screenshot) ;

/// @brief Method LateUpdate addr 0x21deaa4 size 0xa4 virtual false final false
 void LateUpdate() ;

// Ctor Parameters []
explicit PlaybackRenderer() ;

/// @brief Method .ctor addr 0x21deb48 size 0x8 virtual false final false
 void _ctor() ;
