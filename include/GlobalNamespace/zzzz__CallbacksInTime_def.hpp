...
/// @brief Method get_isEmpty addr 0x226b734 size 0x8c virtual false final false
 bool get_isEmpty() ;

// Ctor Parameters [CppParam { name: "aheadTime", ty: "float_t", modifiers: "", def_value: None }]
explicit CallbacksInTime(float_t aheadTime) ;

/// @brief Method .ctor addr 0x226c940 size 0xd4 virtual false final false
 void _ctor(float_t aheadTime) ;

/// @brief Method AddCallback addr 0x226ca14 size 0x308 virtual false final false
 void AddCallback(GlobalNamespace::BeatmapDataCallbackWrapper callbackWrapper) ;

/// @brief Method RemoveCallback addr 0x226b550 size 0x1e4 virtual false final false
 void RemoveCallback(GlobalNamespace::BeatmapDataCallbackWrapper callbackWrapper) ;

/// @brief Method CallCallbacks addr 0x226b920 size 0xd4 virtual false final false
 void CallCallbacks(GlobalNamespace::BeatmapDataItem beatmapDataItem) ;

/// @brief Method CallCallbacks addr 0x226cd1c size 0x2cc virtual false final false
