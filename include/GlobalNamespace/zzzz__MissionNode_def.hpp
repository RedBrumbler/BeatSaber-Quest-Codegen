...
/// @brief Method get_missionData addr 0x217f904 size 0x8 virtual false final false
 GlobalNamespace::MissionDataSO get_missionData() ;

/// @brief Method get_childNodes addr 0x217f90c size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::MissionNode> get_childNodes() ;

/// @brief Method get_missionNodeVisualController addr 0x217f914 size 0x8 virtual false final false
 GlobalNamespace::MissionNodeVisualController get_missionNodeVisualController() ;

/// @brief Method get_letterPartName addr 0x217f91c size 0x8 virtual false final false
 ::StringW get_letterPartName() ;

/// @brief Method get_numberPartName addr 0x217f924 size 0x8 virtual false final false
 int32_t get_numberPartName() ;

/// @brief Method get_missionId addr 0x217e530 size 0x24 virtual false final false
 ::StringW get_missionId() ;

/// @brief Method get_formattedMissionNodeName addr 0x217f92c size 0x88 virtual false final false
 ::StringW get_formattedMissionNodeName() ;

/// @brief Method get_position addr 0x217f314 size 0x1c virtual false final false
 UnityEngine::Vector2 get_position() ;

/// @brief Method get_radius addr 0x217f9b4 size 0x40 virtual false final false
 float_t get_radius() ;

// Ctor Parameters []
explicit MissionNode() ;

/// @brief Method .ctor addr 0x217f9f4 size 0x8 virtual false final false
 void _ctor() ;
