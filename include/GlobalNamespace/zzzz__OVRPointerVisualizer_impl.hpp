...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::OVRPointerVisualizer::*)()>(&GlobalNamespace::OVRPointerVisualizer::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2631f9c;
...
// Ctor Parameters []
 GlobalNamespace::OVRPointerVisualizer::OVRPointerVisualizer()  : UnityEngine::MonoBehaviour(THROW_UNLESS(::il2cpp_utils::New<OVRPointerVisualizer>())) {}
