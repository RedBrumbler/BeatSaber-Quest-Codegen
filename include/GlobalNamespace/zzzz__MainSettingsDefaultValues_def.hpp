...
/// @brief Method SetFixedDefaultValues addr 0x2227f08 size 0x154 virtual false final false
...
/// @brief Method .ctor addr 0x222805c size 0x8 virtual false final false
 void _ctor() ;
