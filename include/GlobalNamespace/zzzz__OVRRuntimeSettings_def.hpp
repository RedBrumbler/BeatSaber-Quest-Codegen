...
/// @brief Method GetRuntimeSettings addr 0x26325b8 size 0x114 virtual false final false
static GlobalNamespace::OVRRuntimeSettings GetRuntimeSettings() ;

// Ctor Parameters []
explicit OVRRuntimeSettings() ;

/// @brief Method .ctor addr 0x26326cc size 0x10 virtual false final false
 void _ctor() ;
