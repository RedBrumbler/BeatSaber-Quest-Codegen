...
/// @brief Method .ctor addr 0x22018a0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetBeatmapDataBasicInfoAsync>b__0 addr 0x22018a8 size 0x1c virtual false final false
...
/// @brief Method MoveNext addr 0x2201b78 size 0x360 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2201ed8 size 0x58 virtual true final true
...
/// @brief Method .ctor addr 0x2201f30 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetBeatmapDataAsync>b__0 addr 0x2201f38 size 0x2c virtual false final false
...
/// @brief Method MoveNext addr 0x2202110 size 0x378 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2202488 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method .ctor addr 0x22024e0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <LoadBeatmapSaveDataAsync>b__0 addr 0x22024e8 size 0x70 virtual false final false
...
/// @brief Method MoveNext addr 0x2202558 size 0x254 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x22027ac size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method .ctor addr 0x2202804 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <RunTaskAndLogException>b__0 addr 0x220280c size 0xc0 virtual false final false
...
/// @brief Method MoveNext addr 0x22028cc size 0x230 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2202afc size 0xc virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method GetBeatmapDataBasicInfoAsync addr 0x22014b0 size 0xf0 virtual false final false
 System::Threading::Tasks::Task_1<GlobalNamespace::IBeatmapDataBasicInfo> GetBeatmapDataBasicInfoAsync() ;

/// @brief Method GetBeatmapDataAsync addr 0x22015a0 size 0x134 virtual false final false
...
/// @brief Method SetJsonData addr 0x22016d4 size 0x8 virtual false final false
 void SetJsonData(::StringW jsonData) ;

/// @brief Method LoadBeatmapSaveDataAsync addr 0x22016dc size 0xf4 virtual false final false
 System::Threading::Tasks::Task_1<BeatmapSaveDataVersion3::BeatmapSaveData> LoadBeatmapSaveDataAsync() ;

/// @brief Method RunTaskAndLogException addr 0x22017d0 size 0xc8 virtual false final false
 System::Threading::Tasks::Task RunTaskAndLogException(System::Action action) ;

// Ctor Parameters []
explicit BeatmapDataSO() ;

/// @brief Method .ctor addr 0x2201898 size 0x8 virtual false final false
 void _ctor() ;
