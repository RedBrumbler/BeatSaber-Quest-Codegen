...
/// @brief Method get_p0 addr 0x1fdbdd8 size 0xc virtual false final false
 UnityEngine::Vector3 get_p0() ;

/// @brief Method get_p1 addr 0x1fdbde4 size 0xc virtual false final false
 UnityEngine::Vector3 get_p1() ;

/// @brief Method get_color addr 0x1fdbdf0 size 0xc virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method get_lineLights addr 0x1fdbdfc size 0x58 virtual false final false
static System::Collections::Generic::List_1<GlobalNamespace::LineLight> get_lineLights() ;

/// @brief Method OnEnable addr 0x1fdbe54 size 0xd0 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fdbf24 size 0x80 virtual false final false
 void OnDisable() ;

/// @brief Method OnDrawGizmos addr 0x1fdbfa4 size 0x88 virtual false final false
 void OnDrawGizmos() ;

// Ctor Parameters []
explicit LineLight() ;

/// @brief Method .ctor addr 0x1fdc02c size 0x8 virtual false final false
 void _ctor() ;
