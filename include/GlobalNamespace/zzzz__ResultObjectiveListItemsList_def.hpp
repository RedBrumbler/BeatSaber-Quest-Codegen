...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13744)), TypeDefinitionIndex(TypeDefinitionIndex(5904)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13744), inst: 5053 })}
...
/// @brief Method .ctor addr 0x21c5e28 size 0x48 virtual false final false
 void _ctor() ;
