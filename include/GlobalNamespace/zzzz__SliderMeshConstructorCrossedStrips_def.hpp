...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4939))}
...
/// @brief Method CreateSliderMeshInternal addr 0x22853f8 size 0x3bc virtual true final false
 void CreateSliderMeshInternal(GlobalNamespace::VertexPath path) ;

/// @brief Method GetVertexCount addr 0x22857b4 size 0x1c virtual true final false
 int32_t GetVertexCount(GlobalNamespace::VertexPath path) ;

/// @brief Method GetTrianglesCount addr 0x22857d0 size 0x24 virtual true final false
 int32_t GetTrianglesCount(GlobalNamespace::VertexPath path) ;

// Ctor Parameters []
explicit SliderMeshConstructorCrossedStrips() ;

/// @brief Method .ctor addr 0x22857f4 size 0x84 virtual false final false
 void _ctor() ;
