...
/// @brief Method Awake addr 0x22a5e7c size 0xa8 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x22a5f24 size 0x120 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit SpectrogramRow() ;

/// @brief Method .ctor addr 0x22a6044 size 0x8 virtual false final false
 void _ctor() ;
