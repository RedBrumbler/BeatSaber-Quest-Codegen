...
/// @brief Method get_isActive addr 0x2295e08 size 0x8 virtual false final false
 bool get_isActive() ;

/// @brief Method set_isActive addr 0x2295e10 size 0xc virtual false final false
 void set_isActive(bool value) ;

/// @brief Method SetActive addr 0x2295d84 size 0x7c virtual false final false
 void SetActive(bool active) ;

// Ctor Parameters []
explicit GlobalNamespace__GameObjectIntSwitchEventEffect__GameObjectValueList() ;

/// @brief Method .ctor addr 0x2295e1c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Start addr 0x2295a80 size 0x194 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2295c14 size 0x2c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleBasicBeatmapEventData addr 0x2295c40 size 0x144 virtual false final false
 void HandleBasicBeatmapEventData(GlobalNamespace::BasicBeatmapEventData data) ;

// Ctor Parameters []
explicit GameObjectIntSwitchEventEffect() ;

/// @brief Method .ctor addr 0x2295e00 size 0x8 virtual false final false
 void _ctor() ;
