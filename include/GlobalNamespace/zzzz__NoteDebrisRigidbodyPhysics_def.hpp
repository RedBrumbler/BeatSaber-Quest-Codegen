...
/// @brief Method get_position addr 0x2279f6c size 0x1c virtual true final false
 UnityEngine::Vector3 get_position() ;

/// @brief Method FixedUpdate addr 0x2279f88 size 0x48 virtual false final false
 void FixedUpdate() ;

/// @brief Method Init addr 0x2279fd0 size 0xc4 virtual true final false
 void Init(UnityEngine::Vector3 force, UnityEngine::Vector3 torque) ;

/// @brief Method AddVelocity addr 0x227a094 size 0x60 virtual true final false
 void AddVelocity(UnityEngine::Vector3 force) ;

// Ctor Parameters []
explicit NoteDebrisRigidbodyPhysics() ;

/// @brief Method .ctor addr 0x227a0f4 size 0x8 virtual false final false
 void _ctor() ;
