...
/// @brief Method get_localizedText addr 0x215ea24 size 0xc virtual false final false
 ::StringW get_localizedText() ;

// Ctor Parameters []
explicit GlobalNamespace__NamedIntListController__TextValuePair() ;

/// @brief Method .ctor addr 0x215ea38 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method add_valueChangedEvent addr 0x215e7d4 size 0xb0 virtual true final true
 void add_valueChangedEvent(System::Action_1<int32_t> value) ;

/// @brief Method remove_valueChangedEvent addr 0x215e884 size 0xb0 virtual true final true
 void remove_valueChangedEvent(System::Action_1<int32_t> value) ;

/// @brief Method InitValues addr 0x215e934 size 0x10 virtual false final false
 void InitValues(::ArrayW<GlobalNamespace::GlobalNamespace__NamedIntListController__TextValuePair> values) ;

/// @brief Method SetValue addr 0x215e944 size 0x10 virtual false final false
 void SetValue(int32_t value) ;

/// @brief Method GetInitValues addr 0x215e954 size 0x74 virtual true final false
 bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements) ;

/// @brief Method ApplyValue addr 0x215e9c8 size 0x20 virtual true final false
 void ApplyValue(int32_t idx) ;

/// @brief Method TextForValue addr 0x215e9e8 size 0x3c virtual true final false
 ::StringW TextForValue(int32_t idx) ;

// Ctor Parameters []
explicit NamedIntListController() ;

/// @brief Method .ctor addr 0x215ea30 size 0x8 virtual false final false
 void _ctor() ;
