...
/// @brief Method add_didSelectSettingsSubMenuEvent addr 0x21a9874 size 0xb0 virtual false final false
 void add_didSelectSettingsSubMenuEvent(System::Action_2<GlobalNamespace::SettingsSubMenuInfo,int32_t> value) ;

/// @brief Method remove_didSelectSettingsSubMenuEvent addr 0x21a9924 size 0xb0 virtual false final false
 void remove_didSelectSettingsSubMenuEvent(System::Action_2<GlobalNamespace::SettingsSubMenuInfo,int32_t> value) ;

/// @brief Method get_numberOfSubMenus addr 0x21a99d4 size 0x1c virtual false final false
 int32_t get_numberOfSubMenus() ;

/// @brief Method get_selectedSubMenuInfo addr 0x21a99f0 size 0x8 virtual false final false
 GlobalNamespace::SettingsSubMenuInfo get_selectedSubMenuInfo() ;

/// @brief Method Init addr 0x21a99f8 size 0x38 virtual false final false
 void Init(int32_t selectedSubMenuInfoIdx) ;

/// @brief Method DidActivate addr 0x21a9a30 size 0x1f0 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method HandleSettingsMenuSegmentedControlDidSelectCell addr 0x21a9c20 size 0x54 virtual false final false
...
/// @brief Method .ctor addr 0x21a9c74 size 0x8 virtual false final false
 void _ctor() ;
