...
/// @brief Method add_afterImageEffectEvent addr 0x26a7c80 size 0xb0 virtual false final false
 void add_afterImageEffectEvent(System::Action_1<UnityEngine::RenderTexture> value) ;

/// @brief Method remove_afterImageEffectEvent addr 0x26a7d30 size 0xb0 virtual false final false
 void remove_afterImageEffectEvent(System::Action_1<UnityEngine::RenderTexture> value) ;

/// @brief Method OnEnable addr 0x26a7de0 size 0x28 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x26a7f5c size 0x88 virtual false final false
 void OnDisable() ;

/// @brief Method OnValidate addr 0x26a7fe4 size 0x50 virtual false final false
 void OnValidate() ;

/// @brief Method LazySetupImageEffectController addr 0x26a7e08 size 0x154 virtual false final false
 void LazySetupImageEffectController() ;

/// @brief Method ImageEffectControllerCallback addr 0x26a8034 size 0xa4 virtual false final false
 void ImageEffectControllerCallback(UnityEngine::RenderTexture src, UnityEngine::RenderTexture dest) ;

/// @brief Method OnPreRender addr 0x26a80d8 size 0xbc virtual false final false
 void OnPreRender() ;

/// @brief Method OnPostRender addr 0x26a8194 size 0x6c virtual false final false
 void OnPostRender() ;

// Ctor Parameters []
explicit MainEffectController() ;

/// @brief Method .ctor addr 0x26a8200 size 0x8 virtual false final false
 void _ctor() ;
