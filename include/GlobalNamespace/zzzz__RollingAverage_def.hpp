...
/// @brief Method get_currentAverage addr 0xdd7250 size 0x8 virtual false final false
 float_t get_currentAverage() ;

/// @brief Method get_hasValue addr 0xdd7258 size 0x10 virtual false final false
 bool get_hasValue() ;

// Ctor Parameters [CppParam { name: "window", ty: "int32_t", modifiers: "", def_value: None }]
explicit RollingAverage(int32_t window) ;

/// @brief Method .ctor addr 0xdd7268 size 0x68 virtual false final false
 void _ctor(int32_t window) ;

/// @brief Method Update addr 0xdd72d0 size 0x120 virtual false final false
 void Update(float_t value) ;

/// @brief Method Reset addr 0xdd73f0 size 0x10 virtual false final false
 void Reset() ;
