...
/// @brief Method .ctor addr 0x121ff4c size 0x68 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "level", ty: "::StringW", modifiers: "", def_value: None }]
explicit BeatmapLevelMask(::StringW level) ;

/// @brief Method .ctor addr 0x1220044 size 0xa0 virtual false final false
...
/// @brief Method .ctor addr 0x12200e4 size 0x198 virtual false final false
 void _ctor(System::Collections::Generic::HashSet_1<::StringW> levelSet) ;

/// @brief Method Contains addr 0x122027c size 0x60 virtual false final false
 bool Contains(::StringW state) ;

/// @brief Method AddLevel addr 0x12202dc size 0x60 virtual false final false
 void AddLevel(::StringW state) ;

/// @brief Method Serialize addr 0x122033c size 0x18 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0x12204e8 size 0x18 virtual true final true
 void Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method ToString addr 0x1220594 size 0x84 virtual true final false
 ::StringW ToString() ;

/// @brief Method GetHashCode addr 0x1220618 size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x1220638 size 0x20 virtual true final true
 bool Equals(GlobalNamespace::BeatmapLevelMask other) ;

/// @brief Method Equals addr 0x1220658 size 0x8c virtual true final false
