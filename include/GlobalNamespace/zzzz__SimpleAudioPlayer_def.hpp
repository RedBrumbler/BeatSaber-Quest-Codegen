...
/// @brief Method get_activeAudioClip addr 0x20f5348 size 0x8 virtual true final false
 UnityEngine::AudioClip get_activeAudioClip() ;

/// @brief Method Start addr 0x20f5350 size 0x80 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x20f540c size 0x100 virtual false final false
 void Update() ;

/// @brief Method FadeIn addr 0x20f53d0 size 0x3c virtual false final false
 void FadeIn(float_t duration) ;

/// @brief Method FadeOut addr 0x20f550c size 0x38 virtual true final false
 void FadeOut(float_t duration) ;

/// @brief Method PauseCurrentChannel addr 0x20f5544 size 0x1c virtual true final false
 void PauseCurrentChannel() ;

/// @brief Method UnPauseCurrentChannel addr 0x20f5560 size 0x1c virtual true final false
 void UnPauseCurrentChannel() ;

// Ctor Parameters []
explicit SimpleAudioPlayer() ;

/// @brief Method .ctor addr 0x20f557c size 0x10 virtual false final false
 void _ctor() ;
