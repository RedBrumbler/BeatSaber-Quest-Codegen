...
/// @brief Method get_isPartyOwner addr 0x22323d0 size 0x8 virtual true final true
 bool get_isPartyOwner() ;

/// @brief Method set_isPartyOwner addr 0x22323d8 size 0xc virtual true final true
 void set_isPartyOwner(bool value) ;

/// @brief Method get_isActive addr 0x22323e4 size 0x8 virtual true final true
 bool get_isActive() ;

/// @brief Method set_isActive addr 0x22323ec size 0xc virtual true final true
 void set_isActive(bool value) ;

/// @brief Method get_isReady addr 0x22323f8 size 0x8 virtual true final true
 bool get_isReady() ;

/// @brief Method set_isReady addr 0x2232400 size 0xc virtual true final true
 void set_isReady(bool value) ;

/// @brief Method get_isInLobby addr 0x223240c size 0x8 virtual true final true
 bool get_isInLobby() ;

/// @brief Method set_isInLobby addr 0x2232414 size 0xc virtual true final true
 void set_isInLobby(bool value) ;

// Ctor Parameters []
explicit LobbyPlayerData() ;

/// @brief Method .ctor addr 0x2232420 size 0x4 virtual false final false
 void _ctor() ;
