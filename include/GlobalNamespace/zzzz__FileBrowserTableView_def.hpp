...
/// @brief Method add_didSelectRow addr 0x21681b0 size 0xb0 virtual false final false
 void add_didSelectRow(System::Action_2<GlobalNamespace::FileBrowserTableView,GlobalNamespace::FileBrowserItem> value) ;

/// @brief Method remove_didSelectRow addr 0x2168260 size 0xb0 virtual false final false
 void remove_didSelectRow(System::Action_2<GlobalNamespace::FileBrowserTableView,GlobalNamespace::FileBrowserItem> value) ;

/// @brief Method Init addr 0x2168310 size 0x108 virtual false final false
 void Init(::ArrayW<GlobalNamespace::FileBrowserItem> items) ;

/// @brief Method SetItems addr 0x2168418 size 0x44 virtual false final false
 void SetItems(::ArrayW<GlobalNamespace::FileBrowserItem> items) ;

/// @brief Method SelectAndScrollRowToItemWithPath addr 0x216845c size 0x94 virtual false final false
 bool SelectAndScrollRowToItemWithPath(::StringW folderPath) ;

/// @brief Method CellSize addr 0x216853c size 0x8 virtual true final true
 float_t CellSize() ;

/// @brief Method NumberOfCells addr 0x2168544 size 0x18 virtual true final true
 int32_t NumberOfCells() ;

/// @brief Method CellForIdx addr 0x216855c size 0x178 virtual true final true
 HMUI::TableCell CellForIdx(HMUI::TableView tableView, int32_t row) ;

/// @brief Method HandleDidSelectRowEvent addr 0x21686d4 size 0x50 virtual false final false
 void HandleDidSelectRowEvent(HMUI::TableView tableView, int32_t row) ;

/// @brief Method SelectAndScrollRow addr 0x21684f0 size 0x4c virtual false final false
 void SelectAndScrollRow(int32_t row) ;

/// @brief Method ClearSelection addr 0x2168724 size 0x5c virtual false final false
 void ClearSelection(bool animated, bool scrollToRow0) ;

// Ctor Parameters []
explicit FileBrowserTableView() ;

/// @brief Method .ctor addr 0x2168780 size 0x10 virtual false final false
 void _ctor() ;
