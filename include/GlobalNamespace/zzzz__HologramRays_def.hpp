...
/// @brief Method .ctor addr 0x2113928 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2113aa4 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2113aa8 size 0x188 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x2113c30 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x2113c38 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2113c78 size 0x8 virtual true final true
...
/// @brief Method RuntimeInit addr 0x2113248 size 0x58 virtual false final false
static void RuntimeInit() ;

/// @brief Method Awake addr 0x21132a0 size 0x13c virtual false final false
 void Awake() ;

/// @brief Method OnDisable addr 0x21133dc size 0x20 virtual false final false
 void OnDisable() ;

/// @brief Method OnValidate addr 0x21133fc size 0x7c virtual false final false
 void OnValidate() ;

/// @brief Method Update addr 0x21136ec size 0x4 virtual false final false
 void Update() ;

/// @brief Method Refresh addr 0x2113478 size 0x274 virtual false final false
 void Refresh() ;

/// @brief Method Animate addr 0x21136f0 size 0xc8 virtual false final false
 void Animate(bool turningOn, float_t duration, GlobalNamespace::EaseType easeType) ;

/// @brief Method FadingCoroutine addr 0x21137b8 size 0x94 virtual false final false
 System::Collections::IEnumerator FadingCoroutine(bool turningOn, float_t duration, GlobalNamespace::EaseType easeType) ;

/// @brief Method UpdateBounds addr 0x211384c size 0xdc virtual false final false
 void UpdateBounds() ;

// Ctor Parameters []
explicit HologramRays() ;

/// @brief Method .ctor addr 0x2113950 size 0x20 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__22_0 addr 0x2113a3c size 0x68 virtual false final false
