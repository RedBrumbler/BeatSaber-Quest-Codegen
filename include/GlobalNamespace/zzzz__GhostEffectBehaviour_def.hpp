...
struct CORDL_TYPE GlobalNamespace__GhostEffectBehaviour__EndBehavior : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr GlobalNamespace__GhostEffectBehaviour__EndBehavior(int32_t value__) noexcept;


                    constexpr GlobalNamespace__GhostEffectBehaviour__EndBehavior(GlobalNamespace__GhostEffectBehaviour__EndBehavior const&) = default;
                    constexpr GlobalNamespace__GhostEffectBehaviour__EndBehavior(GlobalNamespace__GhostEffectBehaviour__EndBehavior&&) = default;
                    constexpr GlobalNamespace__GhostEffectBehaviour__EndBehavior& operator=(GlobalNamespace__GhostEffectBehaviour__EndBehavior const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__GhostEffectBehaviour__EndBehavior& operator=(GlobalNamespace__GhostEffectBehaviour__EndBehavior&& o) noexcept {
...
constexpr explicit GlobalNamespace__GhostEffectBehaviour__EndBehavior(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __GlobalNamespace__GhostEffectBehaviour__EndBehavior_Unwrapped : int32_t {
__DisableAll = 0,
__DisableCopies = 1,
__Nothing = 2,
};
...
static GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__EndBehavior const DisableAll;

/// @brief Field DisableCopies offset 0
static GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__EndBehavior const DisableCopies;

/// @brief Field Nothing offset 0
static GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__EndBehavior const Nothing;
...
struct CORDL_TYPE GlobalNamespace__GhostEffectBehaviour__GhostEffectType : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr GlobalNamespace__GhostEffectBehaviour__GhostEffectType(int32_t value__) noexcept;


                    constexpr GlobalNamespace__GhostEffectBehaviour__GhostEffectType(GlobalNamespace__GhostEffectBehaviour__GhostEffectType const&) = default;
                    constexpr GlobalNamespace__GhostEffectBehaviour__GhostEffectType(GlobalNamespace__GhostEffectBehaviour__GhostEffectType&&) = default;
                    constexpr GlobalNamespace__GhostEffectBehaviour__GhostEffectType& operator=(GlobalNamespace__GhostEffectBehaviour__GhostEffectType const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__GhostEffectBehaviour__GhostEffectType& operator=(GlobalNamespace__GhostEffectBehaviour__GhostEffectType&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__GhostEffectBehaviour__GhostEffectType(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __GlobalNamespace__GhostEffectBehaviour__GhostEffectType_Unwrapped : int32_t {
__TextMeshPro = 0,
__Canvas = 1,
};
...
static GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__GhostEffectType const TextMeshPro;

/// @brief Field Canvas offset 0
static GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__GhostEffectType const Canvas;
...
public:
// Declarations
using GhostEffectType = GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__GhostEffectType;

using EndBehavior = GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__EndBehavior;
...
constexpr GlobalNamespace::EaseType __get__positionEasing() const;
 ...
 GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__EndBehavior __declspec(property(get=__get__endBehavior, put=__set__endBehavior))  _endBehavior;

constexpr void __set__endBehavior(GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__EndBehavior value) ;

constexpr GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__EndBehavior __get__endBehavior() const;
...
/// @brief Method OnBehaviourPlay addr 0x21eb3f8 size 0x190 virtual true final false
 void OnBehaviourPlay(UnityEngine::Playables::Playable playable, UnityEngine::Playables::FrameData info) ;

/// @brief Method ProcessFrame addr 0x21eb69c size 0x438 virtual true final false
...
/// @brief Method EnableObjects addr 0x21eb588 size 0x114 virtual false final false
 void EnableObjects(bool on) ;

// Ctor Parameters []
explicit GhostEffectBehaviour() ;

/// @brief Method .ctor addr 0x21ebad4 size 0xd0 virtual false final false
 void _ctor() ;
...
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__EndBehavior, "", "GhostEffectBehaviour/EndBehavior");
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__GhostEffectBehaviour__GhostEffectType, "", "GhostEffectBehaviour/GhostEffectType");
