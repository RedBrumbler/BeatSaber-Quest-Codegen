...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4776)), TypeDefinitionIndex(TypeDefinitionIndex(13835))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4776), inst: 2 })
