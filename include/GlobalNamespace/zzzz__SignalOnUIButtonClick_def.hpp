...
/// @brief Method OnReset addr 0x1fbed48 size 0x50 virtual false final false
 void OnReset() ;

/// @brief Method Start addr 0x1fbed98 size 0x8c virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x1fbee24 size 0xd0 virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit SignalOnUIButtonClick() ;

/// @brief Method .ctor addr 0x1fbeef4 size 0x8 virtual false final false
 void _ctor() ;
