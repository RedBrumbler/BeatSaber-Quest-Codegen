...
/// @brief Method IsEmployee addr 0x21f6074 size 0x68 virtual true final true
 System::Threading::Tasks::Task_1<bool> IsEmployee() ;

/// @brief Method IsInTest addr 0x21f60dc size 0x68 virtual true final true
 System::Threading::Tasks::Task_1<bool> IsInTest(GlobalNamespace::IExperimentData data) ;

// Ctor Parameters []
explicit NoExperimentModel() ;

/// @brief Method .ctor addr 0x21f6144 size 0x8 virtual false final false
 void _ctor() ;
