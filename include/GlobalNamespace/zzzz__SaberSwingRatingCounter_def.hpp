...
/// @brief Method get_beforeCutRating addr 0x21f77c0 size 0x8 virtual true final true
 float_t get_beforeCutRating() ;

/// @brief Method get_afterCutRating addr 0x21f77c8 size 0x8 virtual true final true
 float_t get_afterCutRating() ;

/// @brief Method RegisterDidChangeReceiver addr 0x21f77d0 size 0x58 virtual true final true
 void RegisterDidChangeReceiver(GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver receiver) ;

/// @brief Method RegisterDidFinishReceiver addr 0x21f7828 size 0x58 virtual true final true
 void RegisterDidFinishReceiver(GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver receiver) ;

/// @brief Method UnregisterDidChangeReceiver addr 0x21f7880 size 0x58 virtual true final true
 void UnregisterDidChangeReceiver(GlobalNamespace::ISaberSwingRatingCounterDidChangeReceiver receiver) ;

/// @brief Method UnregisterDidFinishReceiver addr 0x21f78d8 size 0x58 virtual true final true
 void UnregisterDidFinishReceiver(GlobalNamespace::ISaberSwingRatingCounterDidFinishReceiver receiver) ;

/// @brief Method Init addr 0x21f7930 size 0x364 virtual false final false
...
/// @brief Method ProcessNewData addr 0x21f7c94 size 0x780 virtual true final true
...
/// @brief Method Finish addr 0x21f8414 size 0x1ac virtual false final false
 void Finish() ;

/// @brief Method DrawGizmos addr 0x21f85c0 size 0x384 virtual false final false
 void DrawGizmos() ;

// Ctor Parameters []
explicit SaberSwingRatingCounter() ;

/// @brief Method .ctor addr 0x21f8944 size 0xc0 virtual false final false
 void _ctor() ;
