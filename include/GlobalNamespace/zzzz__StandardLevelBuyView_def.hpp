...
/// @brief Method get_buyButton addr 0x21c672c size 0x8 virtual false final false
 UnityEngine::UI::Button get_buyButton() ;

/// @brief Method SetContent addr 0x21c6734 size 0x20 virtual false final false
 void SetContent(GlobalNamespace::IPreviewBeatmapLevel previewBeatmapLevel) ;

// Ctor Parameters []
explicit StandardLevelBuyView() ;

/// @brief Method .ctor addr 0x21c6754 size 0x8 virtual false final false
 void _ctor() ;
