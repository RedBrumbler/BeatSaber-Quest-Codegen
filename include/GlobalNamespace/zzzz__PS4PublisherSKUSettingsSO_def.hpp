...
/// @brief Method get_masterVersion addr 0x2253fa0 size 0x8 virtual false final false
 ::StringW get_masterVersion() ;

/// @brief Method get_applicationVersion addr 0x2253fa8 size 0x8 virtual false final false
 ::StringW get_applicationVersion() ;

// Ctor Parameters []
explicit GlobalNamespace__PS4PublisherSKUSettingsSO__PS4BuildVersion() ;

/// @brief Method .ctor addr 0x2253fb0 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_buildVersion addr 0x2253f60 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__PS4PublisherSKUSettingsSO__PS4BuildVersion get_buildVersion() ;

/// @brief Method get_latestBuildVersion addr 0x2253f68 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__PS4PublisherSKUSettingsSO__PS4BuildVersion get_latestBuildVersion() ;

/// @brief Method get_parentalLockLevel addr 0x2253f70 size 0x8 virtual false final false
 int32_t get_parentalLockLevel() ;

/// @brief Method get_npTitleFilenamePath addr 0x2253f78 size 0x8 virtual false final false
 ::StringW get_npTitleFilenamePath() ;

/// @brief Method get_defaultAgeRestriction addr 0x2253f80 size 0x8 virtual false final false
 int32_t get_defaultAgeRestriction() ;

/// @brief Method get_applicationCategory addr 0x2253f88 size 0x8 virtual false final false
 GlobalNamespace::PS4ApplicationCategory get_applicationCategory() ;

// Ctor Parameters []
explicit PS4PublisherSKUSettingsSO() ;

/// @brief Method .ctor addr 0x2253f90 size 0x8 virtual false final false
 void _ctor() ;
