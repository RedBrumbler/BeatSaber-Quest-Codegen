...
/// @brief Method .ctor addr 0x21b96a8 size 0x2c virtual false final false
...
/// @brief Method set_sizeToFit addr 0x21b925c size 0x20 virtual false final false
 void set_sizeToFit(bool value) ;

/// @brief Method get_sizeToFit addr 0x21b927c size 0x1c virtual false final false
 bool get_sizeToFit() ;

/// @brief Method get_selectedCellNumber addr 0x21b9298 size 0x1c virtual false final false
 int32_t get_selectedCellNumber() ;

/// @brief Method Setup addr 0x21b92b4 size 0x18c virtual false final false
 void Setup(::ArrayW<GlobalNamespace::GlobalNamespace__TabBarViewController__TabBarItem> items) ;

/// @brief Method SelectItem addr 0x21b9440 size 0x1c virtual false final false
 void SelectItem(int32_t index) ;

/// @brief Method Clear addr 0x21b945c size 0x54 virtual false final false
 void Clear() ;

/// @brief Method DidActivate addr 0x21b94b0 size 0xc4 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method OnDestroy addr 0x21b9574 size 0xdc virtual true final false
 void OnDestroy() ;

/// @brief Method HandleDidSelectCell addr 0x21b9650 size 0x50 virtual false final false
 void HandleDidSelectCell(HMUI::SegmentedControl segmentedControl, int32_t cellNumber) ;

// Ctor Parameters []
explicit TabBarViewController() ;

/// @brief Method .ctor addr 0x21b96a0 size 0x8 virtual false final false
 void _ctor() ;
