...
/// @brief Method get_pathLength addr 0x2285878 size 0x24 virtual false final false
 float_t get_pathLength() ;

/// @brief Method get_mesh addr 0x22778f8 size 0x1c virtual false final false
 UnityEngine::Mesh get_mesh() ;

/// @brief Method get_pathsHolder addr 0x228589c size 0x8 virtual false final false
 GlobalNamespace::PathsHolder get_pathsHolder() ;

/// @brief Method CreateBezierPathAndMesh addr 0x228113c size 0x758 virtual false final false
...
/// @brief Method CutDirectionToControlPointPosition addr 0x22858a4 size 0xdc virtual false final false
...
/// @brief Method .ctor addr 0x2285980 size 0xd0 virtual false final false
 void _ctor() ;
