...
/// @brief Method .ctor addr 0x212a938 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x212c9ec size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x212c9f0 size 0x834 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x212e0b0 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x212e0b8 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x212e0f8 size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0x212b194 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <HandleSongStartSyncControllerSyncStartSuccess>b__0 addr 0x212e100 size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0x212e184 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <EndGameplay>b__47_0 addr 0x212e18c size 0x20 virtual false final false
...
/// @brief Method get_state addr 0x2129020 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__MultiplayerController__State get_state() ;

/// @brief Method add_stateChangedEvent addr 0x2129028 size 0xb0 virtual false final false
 void add_stateChangedEvent(System::Action_1<GlobalNamespace::GlobalNamespace__MultiplayerController__State> value) ;

/// @brief Method remove_stateChangedEvent addr 0x21290d8 size 0xb0 virtual false final false
 void remove_stateChangedEvent(System::Action_1<GlobalNamespace::GlobalNamespace__MultiplayerController__State> value) ;

/// @brief Method Start addr 0x2129188 size 0x384 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2129984 size 0x5e8 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleSetMultiplayerGameState addr 0x212a008 size 0x1f4 virtual false final false
 void HandleSetMultiplayerGameState(::StringW userId, GlobalNamespace::MultiplayerGameState gameState) ;

/// @brief Method CreateAndBindPlayersSpecificSettingsAtGameStartModel addr 0x212950c size 0x458 virtual false final false
 void CreateAndBindPlayersSpecificSettingsAtGameStartModel() ;

/// @brief Method StartSceneLoadSync addr 0x212a1fc size 0x178 virtual false final false
 void StartSceneLoadSync() ;

/// @brief Method PerformSongStartSync addr 0x212a8c0 size 0x78 virtual false final false
 System::Collections::IEnumerator PerformSongStartSync(GlobalNamespace::MultiplayerPlayerStartState localPlayerSyncState) ;

/// @brief Method HandleDidSwitchPlayerToInactive addr 0x212a960 size 0x168 virtual false final false
 void HandleDidSwitchPlayerToInactive() ;

/// @brief Method HandleSceneStartSyncControllerSyncStartDidSuccess addr 0x212abb8 size 0x28 virtual false final false
 void HandleSceneStartSyncControllerSyncStartDidSuccess(::StringW sessionGameId) ;

/// @brief Method HandleSceneStartSyncControllerSyncStartDidReceiveTooLate addr 0x212abe0 size 0x28 virtual false final false
 void HandleSceneStartSyncControllerSyncStartDidReceiveTooLate(::StringW sessionGameId) ;

/// @brief Method HandleSceneStartSyncControllerSyncStartDidFail addr 0x212ac08 size 0x9c virtual false final false
 void HandleSceneStartSyncControllerSyncStartDidFail() ;

/// @brief Method HandleSongStartSyncControllerSyncStartSuccess addr 0x212af30 size 0x264 virtual false final false
 void HandleSongStartSyncControllerSyncStartSuccess(float_t introAnimationStartSyncTime) ;

/// @brief Method HandleSongStartSyncControllerSyncResume addr 0x212bfc8 size 0x4e0 virtual false final false
 void HandleSongStartSyncControllerSyncResume(float_t introAnimationStartSyncTime) ;

/// @brief Method HandleSongStartSyncControllerSyncStartFailed addr 0x212c510 size 0x9c virtual false final false
 void HandleSongStartSyncControllerSyncStartFailed() ;

/// @brief Method StartGameplay addr 0x212b75c size 0x86c virtual false final false
 void StartGameplay(float_t introAnimationStartSyncTime) ;

/// @brief Method HandleAllResultsCollected addr 0x212c5ac size 0x4 virtual false final false
...
/// @brief Method EndGameplay addr 0x212acc0 size 0x270 virtual false final false
...
/// @brief Method HandleOutroAnimationDidFinish addr 0x212c774 size 0x48 virtual false final false
 void HandleOutroAnimationDidFinish() ;

/// @brief Method HandleRpcReturnToMenu addr 0x212c7bc size 0x184 virtual false final false
 void HandleRpcReturnToMenu(::StringW userId) ;

/// @brief Method HandleDisconnected addr 0x212c940 size 0x54 virtual false final false
 void HandleDisconnected(GlobalNamespace::DisconnectedReason disconnectedReason) ;

/// @brief Method ChangeState addr 0x2129964 size 0x20 virtual false final false
 void ChangeState(GlobalNamespace::GlobalNamespace__MultiplayerController__State newState) ;

/// @brief Method GetCurrentSongTime addr 0x212ab00 size 0xb8 virtual false final false
 float_t GetCurrentSongTime(float_t songStartSyncTime) ;

/// @brief Method GetSongStartSyncTime addr 0x212aac8 size 0x38 virtual false final false
 float_t GetSongStartSyncTime(float_t introAnimationStartSyncTime) ;

// Ctor Parameters []
explicit MultiplayerController() ;

/// @brief Method .ctor addr 0x212c994 size 0x58 virtual false final false
 void _ctor() ;
