...
/// @brief Method get_name addr 0x1fb8b40 size 0x8 virtual false final false
 ::StringW get_name() ;

/// @brief Method get_particleSystems addr 0x1fb8b48 size 0x8 virtual false final false
 ::ArrayW<UnityEngine::ParticleSystem> get_particleSystems() ;

// Ctor Parameters []
explicit GlobalNamespace__VFXAnimationEvents__VFXAnimationEvent() ;

/// @brief Method .ctor addr 0x1fb8b50 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method add_animationDidPauseEvent addr 0x1fb810c size 0x9c virtual false final false
 void add_animationDidPauseEvent(System::Action value) ;

/// @brief Method remove_animationDidPauseEvent addr 0x1fb81a8 size 0x9c virtual false final false
 void remove_animationDidPauseEvent(System::Action value) ;

/// @brief Method add_spawnCharacterEvent addr 0x1fb8244 size 0x9c virtual false final false
 void add_spawnCharacterEvent(System::Action value) ;

/// @brief Method remove_spawnCharacterEvent addr 0x1fb82e0 size 0x9c virtual false final false
 void remove_spawnCharacterEvent(System::Action value) ;

/// @brief Method add_despawnCharacterEvent addr 0x1fb837c size 0x9c virtual false final false
 void add_despawnCharacterEvent(System::Action value) ;

/// @brief Method remove_despawnCharacterEvent addr 0x1fb8418 size 0x9c virtual false final false
 void remove_despawnCharacterEvent(System::Action value) ;

/// @brief Method PlayEvent addr 0x1fb84b4 size 0xc4 virtual false final false
 void PlayEvent(::StringW eventName) ;

/// @brief Method PauseAnimation addr 0x1fb8578 size 0x2cc virtual false final false
 void PauseAnimation() ;

/// @brief Method SpawnCharacterEvent addr 0x1fb8844 size 0x1c virtual false final false
 void SpawnCharacterEvent() ;

/// @brief Method DeSpawnCharacterEvent addr 0x1fb8860 size 0x1c virtual false final false
 void DeSpawnCharacterEvent() ;

/// @brief Method ResumeAnimation addr 0x1fb887c size 0x2bc virtual false final false
 void ResumeAnimation() ;

// Ctor Parameters []
explicit VFXAnimationEvents() ;

/// @brief Method .ctor addr 0x1fb8b38 size 0x8 virtual false final false
 void _ctor() ;
