...
/// @brief Method Start addr 0x22967bc size 0x1b8 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2296974 size 0x5c virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit BufferedLightColorGroupEffectManager() ;

/// @brief Method .ctor addr 0x22969d0 size 0x8 virtual false final false
 void _ctor() ;
