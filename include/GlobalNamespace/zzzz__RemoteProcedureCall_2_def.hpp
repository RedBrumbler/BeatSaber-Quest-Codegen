...
template<::cordl_internals::il2cpp_reference_type T0,::cordl_internals::il2cpp_reference_type T1>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12894)), TypeDefinitionIndex(TypeDefinitionIndex(12896))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12896), inst: 80 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12894)), TypeDefinitionIndex(TypeDefinitionIndex(12896))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12896), inst: 1550 })
// CS Name: RemoteProcedureCall`2
...
template<::cordl_internals::il2cpp_reference_type T1>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12896)), TypeDefinitionIndex(TypeDefinitionIndex(12894))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12896), inst: 1570 })
// CS Name: RemoteProcedureCall`2
