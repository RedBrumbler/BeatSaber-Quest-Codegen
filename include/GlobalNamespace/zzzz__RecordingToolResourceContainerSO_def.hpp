...
/// @brief Method get_beatmapLevelPacks addr 0x21e4b08 size 0x8 virtual false final false
 System::Collections::Generic::List_1<GlobalNamespace::IBeatmapLevelPack> get_beatmapLevelPacks() ;

/// @brief Method get_environmentsList addr 0x21e4b10 size 0x8 virtual false final false
 GlobalNamespace::EnvironmentsListSO get_environmentsList() ;

/// @brief Method OnEnable addr 0x21e4b18 size 0xcc virtual true final false
 void OnEnable() ;

// Ctor Parameters []
explicit RecordingToolResourceContainerSO() ;

/// @brief Method .ctor addr 0x21e4be4 size 0x8 virtual false final false
 void _ctor() ;
