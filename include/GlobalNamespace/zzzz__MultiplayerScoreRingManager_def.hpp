...
/// @brief Method Start addr 0x213b318 size 0x1b8 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x213b9f4 size 0x35c virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x213bd50 size 0xd4 virtual false final false
 void Update() ;

/// @brief Method UpdateScore addr 0x213be24 size 0x1f4 virtual false final false
 void UpdateScore(GlobalNamespace::IConnectedPlayer playerToUpdate) ;

/// @brief Method AnimateColorsForPlayer addr 0x213c018 size 0x180 virtual false final false
...
/// @brief Method GetScoreRingItem addr 0x213c198 size 0x104 virtual false final false
 GlobalNamespace::MultiplayerScoreRingItem GetScoreRingItem(::StringW userId) ;

/// @brief Method GetScoreRingItems addr 0x213c29c size 0x220 virtual false final false
 ::ArrayW<UnityEngine::GameObject> GetScoreRingItems() ;

/// @brief Method AnimateColorsForAllPlayers addr 0x213c4bc size 0x1c8 virtual false final false
...
/// @brief Method SetPlayerToFailedState addr 0x213c684 size 0x120 virtual false final false
 void SetPlayerToFailedState(GlobalNamespace::IConnectedPlayer player) ;

/// @brief Method TrySpawnTexts addr 0x213c7a4 size 0x18 virtual false final false
 void TrySpawnTexts() ;

/// @brief Method SpawnTexts addr 0x213c7bc size 0x5e0 virtual false final false
 void SpawnTexts() ;

/// @brief Method HandleStateChanged addr 0x213b500 size 0x4f4 virtual false final false
 void HandleStateChanged(GlobalNamespace::GlobalNamespace__MultiplayerController__State state) ;

/// @brief Method HandleSpawnCenterDistanceWasFound addr 0x213b4d0 size 0x18 virtual false final false
 void HandleSpawnCenterDistanceWasFound(float_t spawnCenterDistance) ;

/// @brief Method HandlePlayerSpawningDidFinish addr 0x213b4e8 size 0x18 virtual false final false
 void HandlePlayerSpawningDidFinish() ;

/// @brief Method HandlePlayerStateChanged addr 0x213cd9c size 0x40 virtual false final false
 void HandlePlayerStateChanged(GlobalNamespace::IConnectedPlayer player) ;

/// @brief Method HandlePlayerDisconnected addr 0x213cddc size 0x4 virtual false final false
 void HandlePlayerDisconnected(GlobalNamespace::IConnectedPlayer player) ;

// Ctor Parameters []
explicit MultiplayerScoreRingManager() ;

/// @brief Method .ctor addr 0x213cde0 size 0x88 virtual false final false
 void _ctor() ;
