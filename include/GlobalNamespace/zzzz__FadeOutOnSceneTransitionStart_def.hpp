...
/// @brief Method Start addr 0x26a7140 size 0x8c virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x26a71cc size 0xd4 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleGameScenesManagerTransitionDidStart addr 0x26a72a0 size 0x1c virtual false final false
 void HandleGameScenesManagerTransitionDidStart(float_t duration) ;

// Ctor Parameters []
explicit FadeOutOnSceneTransitionStart() ;

/// @brief Method .ctor addr 0x26a72bc size 0x8 virtual false final false
 void _ctor() ;
