...
/// @brief Method GetInitValues addr 0x2189984 size 0xe0 virtual true final false
 bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements) ;

/// @brief Method ApplyValue addr 0x2189a64 size 0x74 virtual true final false
 void ApplyValue(int32_t idx) ;

/// @brief Method TextForValue addr 0x2189ad8 size 0xdc virtual true final false
 ::StringW TextForValue(int32_t idx) ;

// Ctor Parameters []
explicit FormattedFloatListSettingsValueController() ;

/// @brief Method .ctor addr 0x2189bb4 size 0x5c virtual false final false
 void _ctor() ;
