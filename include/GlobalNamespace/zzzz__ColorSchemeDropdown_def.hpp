...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13694))}
...
/// @brief Method LazyInit addr 0x2155670 size 0xb0 virtual false final false
 void LazyInit() ;

/// @brief Method OnDestroy addr 0x2155720 size 0x90 virtual true final false
 void OnDestroy() ;

/// @brief Method Init addr 0x21557b0 size 0x40 virtual false final false
 void Init(HMUI::HMUI__TableView__IDataSource initTableViewDataSource) ;

/// @brief Method SetData addr 0x21557f0 size 0x158 virtual false final false
 void SetData(System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::ColorScheme> colorSchemes) ;

/// @brief Method CellSize addr 0x2155a3c size 0x8 virtual true final true
 float_t CellSize() ;

/// @brief Method NumberOfCells addr 0x2155a44 size 0xac virtual true final true
 int32_t NumberOfCells() ;

/// @brief Method CellForIdx addr 0x2155af0 size 0x294 virtual true final true
 HMUI::TableCell CellForIdx(HMUI::TableView tableView, int32_t idx) ;

/// @brief Method SelectCellWithIdx addr 0x2155e40 size 0xc4 virtual true final false
 void SelectCellWithIdx(int32_t idx) ;

/// @brief Method HandleDidSelectCellWithIdx addr 0x2155f04 size 0x138 virtual false final false
 void HandleDidSelectCellWithIdx(HMUI::DropdownWithTableView dropdownWithTableView, int32_t idx) ;

/// @brief Method RefreshUI addr 0x2155948 size 0xf4 virtual false final false
 void RefreshUI(GlobalNamespace::ColorScheme colorScheme) ;

// Ctor Parameters []
explicit ColorSchemeDropdown() ;

/// @brief Method .ctor addr 0x21561f4 size 0x58 virtual false final false
 void _ctor() ;
