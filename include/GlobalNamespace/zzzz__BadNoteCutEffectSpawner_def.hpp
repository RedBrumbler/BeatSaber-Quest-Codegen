...
/// @brief Method Start addr 0x2291ad8 size 0xb4 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2291b8c size 0x98 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleNoteWasCut addr 0x2291c24 size 0x118 virtual false final false
 void HandleNoteWasCut(GlobalNamespace::NoteController noteController, ByRef<GlobalNamespace::NoteCutInfo> noteCutInfo) ;

// Ctor Parameters []
explicit BadNoteCutEffectSpawner() ;

/// @brief Method .ctor addr 0x2291f34 size 0x8 virtual false final false
 void _ctor() ;
