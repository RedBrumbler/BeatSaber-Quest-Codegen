...
/// @brief Method get_grabbedObject addr 0x265253c size 0x8 virtual false final false
 GlobalNamespace::OVRGrabbable get_grabbedObject() ;

/// @brief Method ForceRelease addr 0x265247c size 0xb0 virtual false final false
 void ForceRelease(GlobalNamespace::OVRGrabbable grabbable) ;

/// @brief Method Awake addr 0x26527ac size 0x144 virtual true final false
 void Awake() ;

/// @brief Method Start addr 0x26528f0 size 0xe0 virtual true final false
 void Start() ;

/// @brief Method Update addr 0x2652b48 size 0x10 virtual true final false
 void Update() ;

/// @brief Method OnUpdatedAnchors addr 0x2652b58 size 0x224 virtual false final false
 void OnUpdatedAnchors() ;

/// @brief Method OnDestroy addr 0x2652dbc size 0x78 virtual false final false
 void OnDestroy() ;

/// @brief Method OnTriggerEnter addr 0x2652e34 size 0x128 virtual false final false
 void OnTriggerEnter(UnityEngine::Collider otherCollider) ;

/// @brief Method OnTriggerExit addr 0x2652f5c size 0x15c virtual false final false
 void OnTriggerExit(UnityEngine::Collider otherCollider) ;

/// @brief Method CheckForGrabOrRelease addr 0x2652d7c size 0x40 virtual false final false
 void CheckForGrabOrRelease(float_t prevFlex) ;

/// @brief Method GrabBegin addr 0x26530b8 size 0x6b0 virtual true final false
 void GrabBegin() ;

/// @brief Method MoveGrabbedObject addr 0x2653768 size 0x234 virtual true final false
 void MoveGrabbedObject(UnityEngine::Vector3 pos, UnityEngine::Quaternion rot, bool forceTeleport) ;

/// @brief Method GrabEnd addr 0x2652544 size 0x268 virtual false final false
 void GrabEnd() ;

/// @brief Method GrabbableRelease addr 0x265399c size 0x54 virtual false final false
 void GrabbableRelease(UnityEngine::Vector3 linearVelocity, UnityEngine::Vector3 angularVelocity) ;

/// @brief Method GrabVolumeEnable addr 0x26539f0 size 0xc0 virtual true final false
 void GrabVolumeEnable(bool enabled) ;

/// @brief Method OffhandGrabbed addr 0x2653ab0 size 0xcc virtual true final false
 void OffhandGrabbed(GlobalNamespace::OVRGrabbable grabbable) ;

/// @brief Method SetPlayerIgnoreCollision addr 0x26529d0 size 0x178 virtual false final false
 void SetPlayerIgnoreCollision(UnityEngine::GameObject grabbable, bool ignore) ;

// Ctor Parameters []
explicit OVRGrabber() ;

/// @brief Method .ctor addr 0x2653b7c size 0x94 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__23_0 addr 0x2653c10 size 0x4 virtual false final false
