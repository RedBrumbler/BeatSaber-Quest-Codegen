...
/// @brief Method Awake addr 0x265f894 size 0x20 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x265f8b4 size 0x6c virtual false final false
 void Update() ;

// Ctor Parameters []
explicit OVRProgressIndicator() ;

/// @brief Method .ctor addr 0x265f920 size 0x14 virtual false final false
 void _ctor() ;
