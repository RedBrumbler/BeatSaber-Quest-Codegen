...
/// @brief Method get_marked addr 0x1fb44c0 size 0x8 virtual false final false
 bool get_marked() ;

/// @brief Method set_marked addr 0x1fb44c8 size 0x2c virtual false final false
 void set_marked(bool value) ;

/// @brief Method Awake addr 0x1fb44f4 size 0x50 virtual false final false
 void Awake() ;

/// @brief Method ToggleMarked addr 0x1fb4544 size 0x10 virtual false final false
 void ToggleMarked() ;

// Ctor Parameters []
explicit MarkableUIButton() ;

/// @brief Method .ctor addr 0x1fb4554 size 0x8 virtual false final false
 void _ctor() ;
