...
/// @brief Method .ctor addr 0xdd5c6c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SaveFromNetSerializable>b__0 addr 0xdd5c74 size 0x11c virtual false final false
...
/// @brief Method get_playersAtGameStart addr 0xdd541c size 0x18 virtual false final false
 System::Collections::Generic::List_1<GlobalNamespace::IConnectedPlayer> get_playersAtGameStart() ;

/// @brief Method get_localPlayerSpecificSettings addr 0xdd5434 size 0x8 virtual false final false
 GlobalNamespace::PlayerSpecificSettingsNetSerializable get_localPlayerSpecificSettings() ;

/// @brief Method set_localPlayerSpecificSettings addr 0xdd543c size 0x8 virtual false final false
 void set_localPlayerSpecificSettings(GlobalNamespace::PlayerSpecificSettingsNetSerializable value) ;

/// @brief Method get_playersAtGameStartNetSerializable addr 0xdd5444 size 0x8 virtual false final false
 GlobalNamespace::PlayerSpecificSettingsAtStartNetSerializable get_playersAtGameStartNetSerializable() ;

/// @brief Method set_playersAtGameStartNetSerializable addr 0xdd544c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xdd5454 size 0x84 virtual false final false
...
/// @brief Method GetPlayerSpecificSettingsForUserId addr 0xdd54d8 size 0x3a8 virtual false final false
 GlobalNamespace::PlayerSpecificSettingsNetSerializable GetPlayerSpecificSettingsForUserId(::StringW userId) ;

/// @brief Method SaveFromNetSerializable addr 0xdd5880 size 0x3ec virtual false final false
