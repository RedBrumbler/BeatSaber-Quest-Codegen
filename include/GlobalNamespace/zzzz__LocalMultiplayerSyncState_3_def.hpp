...
template<>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4560), inst: 3699 }), TypeDefinitionIndex(TypeDefinitionIndex(4561)), TypeDefinitionIndex(TypeDefinitionIndex(4560))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4561), inst: 4987 })
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4560)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4560), inst: 3699 }), TypeDefinitionIndex(TypeDefinitionIndex(4561))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4561), inst: 4988 })
// CS Name: LocalMultiplayerSyncState`3
