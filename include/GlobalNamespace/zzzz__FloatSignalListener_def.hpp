...
/// @brief Method OnEnable addr 0x1fbe8b0 size 0xa0 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fbe950 size 0xa0 virtual false final false
 void OnDisable() ;

/// @brief Method HandleEvent addr 0x1fbe9f0 size 0x60 virtual false final false
 void HandleEvent(float_t f) ;

// Ctor Parameters []
explicit FloatSignalListener() ;

/// @brief Method .ctor addr 0x1fbea50 size 0x8 virtual false final false
 void _ctor() ;
