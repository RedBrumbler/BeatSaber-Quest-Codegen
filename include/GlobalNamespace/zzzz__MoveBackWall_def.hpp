...
/// @brief Method Start addr 0x2140820 size 0x54 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x2140874 size 0xbc virtual false final false
 void Update() ;

// Ctor Parameters []
explicit MoveBackWall() ;

/// @brief Method .ctor addr 0x2140930 size 0x10 virtual false final false
 void _ctor() ;
