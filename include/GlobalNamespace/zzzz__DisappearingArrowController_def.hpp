...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4863)), TypeDefinitionIndex(TypeDefinitionIndex(4861)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4861), inst: 297 })}
...
/// @brief Method get_gameNoteController addr 0x2275170 size 0x8 virtual true final false
 GlobalNamespace::GameNoteController get_gameNoteController() ;

// Ctor Parameters []
explicit DisappearingArrowController() ;

/// @brief Method .ctor addr 0x2275178 size 0x6c virtual false final false
 void _ctor() ;
