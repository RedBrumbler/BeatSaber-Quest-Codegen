...
/// @brief Method NumberOfSetBits addr 0xda7408 size 0x64 virtual false final false
static uint32_t NumberOfSetBits(uint64_t i) ;

/// @brief Method NumberOfSetBits addr 0xda0180 size 0x34 virtual false final false
static uint32_t NumberOfSetBits(uint32_t i) ;

/// @brief Method ShiftLeft addr 0xda746c size 0x48 virtual false final false
static uint64_t ShiftLeft(ByRef<uint64_t> value, ByRef<int32_t> shift) ;

/// @brief Method ShiftRight addr 0xda74b4 size 0x60 virtual false final false
