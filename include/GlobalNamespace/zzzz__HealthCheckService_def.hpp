...
/// @brief Method .ctor addr 0xdbe1f8 size 0x104 virtual false final false
 void _ctor(int32_t port) ;

/// @brief Method Dispose addr 0xdbe2fc size 0xa4 virtual true final true
 void Dispose() ;

/// @brief Method PollUpdate addr 0xdbe3a0 size 0x94 virtual true final true
 void PollUpdate() ;

/// @brief Method Run addr 0xdbe434 size 0x498 virtual false final false
 void Run() ;
