...
/// @brief Method set_notesPerSecond addr 0x21c2fb0 size 0x80 virtual false final false
 void set_notesPerSecond(float_t value) ;

/// @brief Method set_notesCount addr 0x21c3030 size 0x48 virtual false final false
 void set_notesCount(int32_t value) ;

/// @brief Method set_obstaclesCount addr 0x21c3078 size 0x48 virtual false final false
 void set_obstaclesCount(int32_t value) ;

/// @brief Method set_bombsCount addr 0x21c30c0 size 0x48 virtual false final false
 void set_bombsCount(int32_t value) ;

// Ctor Parameters []
explicit LevelParamsPanel() ;

/// @brief Method .ctor addr 0x21c3108 size 0x8 virtual false final false
 void _ctor() ;
