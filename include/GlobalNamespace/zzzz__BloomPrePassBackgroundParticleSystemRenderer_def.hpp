...
/// @brief Method get_renderer addr 0x1fcf468 size 0x8 virtual true final false
 UnityEngine::Renderer get_renderer() ;

/// @brief Method Awake addr 0x1fcf470 size 0x64 virtual true final false
 void Awake() ;

// Ctor Parameters []
explicit BloomPrePassBackgroundParticleSystemRenderer() ;

/// @brief Method .ctor addr 0x1fcf4d4 size 0x54 virtual false final false
 void _ctor() ;
