...
/// @brief Method Start addr 0x2649ef4 size 0x100 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x2649ff4 size 0x1bc virtual false final false
 void Update() ;

// Ctor Parameters []
explicit OVRAudioSourceTest() ;

/// @brief Method .ctor addr 0x264a1b0 size 0x10 virtual false final false
 void _ctor() ;
