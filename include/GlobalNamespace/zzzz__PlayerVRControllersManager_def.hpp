...
/// @brief Method get_leftHandVRController addr 0x2141cac size 0x8 virtual false final false
 GlobalNamespace::VRController get_leftHandVRController() ;

/// @brief Method get_rightHandVRController addr 0x2141cb4 size 0x8 virtual false final false
 GlobalNamespace::VRController get_rightHandVRController() ;

/// @brief Method DisableAllVRControllers addr 0x2141cbc size 0x38 virtual false final false
 void DisableAllVRControllers() ;

// Ctor Parameters []
explicit PlayerVRControllersManager() ;

/// @brief Method .ctor addr 0x2141cf4 size 0x8 virtual false final false
 void _ctor() ;
