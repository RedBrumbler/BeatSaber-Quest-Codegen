...
/// @brief Method Start addr 0x20f308c size 0x8c virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x20f3118 size 0xd4 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleGameScenesManagerTransitionDidStart addr 0x20f31ec size 0x38 virtual false final false
 void HandleGameScenesManagerTransitionDidStart(float_t duration) ;

// Ctor Parameters []
explicit FadeOutSongPreviewPlayerOnSceneTransitionStart() ;

/// @brief Method .ctor addr 0x20f3224 size 0x8 virtual false final false
 void _ctor() ;
