...
/// @brief Method get_bitCount addr 0x1221278 size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0x1221280 size 0x7c virtual false final false
 void _ctor(int32_t bitCount) ;

/// @brief Method Equals addr 0x12212fc size 0x64 virtual true final true
 bool Equals(GlobalNamespace::BitMaskArray other) ;

/// @brief Method SetBits addr 0x1221360 size 0xfc virtual true final true
 GlobalNamespace::BitMaskArray SetBits(int32_t offset, uint64_t bits) ;

/// @brief Method GetBits addr 0x122145c size 0x11c virtual true final true
 uint64_t GetBits(int32_t offset, int32_t count) ;

/// @brief Method ToString addr 0x1221578 size 0xf8 virtual true final false
 ::StringW ToString() ;

/// @brief Method Serialize addr 0x1221670 size 0x15c virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0x12217cc size 0xcc virtual true final true
