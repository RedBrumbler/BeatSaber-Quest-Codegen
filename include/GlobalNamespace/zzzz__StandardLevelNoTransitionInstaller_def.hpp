...
/// @brief Method get_standardLevelNoTransitionInstallerData addr 0x2206d38 size 0x8 virtual false final false
 GlobalNamespace::StandardLevelNoTransitionInstallerData get_standardLevelNoTransitionInstallerData() ;

/// @brief Method InstallBindings addr 0x2206d40 size 0x150 virtual true final false
 void InstallBindings(Zenject::DiContainer container) ;

// Ctor Parameters []
explicit StandardLevelNoTransitionInstaller() ;

/// @brief Method .ctor addr 0x2207498 size 0x8 virtual false final false
 void _ctor() ;
