...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LevelPackHeaderTableCell::*)(::StringW)>(&GlobalNamespace::LevelPackHeaderTableCell::SetData)> {
  ...
  constexpr static std::size_t addrs = 0x215de8c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LevelPackHeaderTableCell::*)(HMUI::HMUI__SelectableCell__TransitionType)>(&GlobalNamespace::LevelPackHeaderTableCell::SelectionDidChange)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x215deb0;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(GlobalNamespace::LevelPackHeaderTableCell),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::LevelPackHeaderTableCell>::get(),
                                  10
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LevelPackHeaderTableCell::*)(HMUI::HMUI__SelectableCell__TransitionType)>(&GlobalNamespace::LevelPackHeaderTableCell::HighlightDidChange)> {
  constexpr static std::size_t size = 0x4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LevelPackHeaderTableCell::*)()>(&GlobalNamespace::LevelPackHeaderTableCell::RefreshVisuals)> {
  ...
  constexpr static std::size_t addrs = 0x215deb4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LevelPackHeaderTableCell::*)()>(&GlobalNamespace::LevelPackHeaderTableCell::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x215df54;
...
constexpr TMPro::TextMeshProUGUI GlobalNamespace::LevelPackHeaderTableCell::__get__nameText() const {
...
constexpr UnityEngine::UI::Image GlobalNamespace::LevelPackHeaderTableCell::__get__backgroundImage() const {
...
constexpr UnityEngine::Color GlobalNamespace::LevelPackHeaderTableCell::__get__highlightBackgroundColor() const {
...
constexpr UnityEngine::Color GlobalNamespace::LevelPackHeaderTableCell::__get__selectedBackgroundColor() const {
...
constexpr UnityEngine::Color GlobalNamespace::LevelPackHeaderTableCell::__get__selectedAndHighlightedBackgroundColor() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, headerText);
}
 void GlobalNamespace::LevelPackHeaderTableCell::SelectionDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::LevelPackHeaderTableCell>::get(),
                            "SelectionDidChange",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, transitionType);
 ...
 void GlobalNamespace::LevelPackHeaderTableCell::HighlightDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::LevelPackHeaderTableCell>::get(),
                            "HighlightDidChange",
                            std::vector<Il2CppClass*>{},
...
// Ctor Parameters []
 GlobalNamespace::LevelPackHeaderTableCell::LevelPackHeaderTableCell()  : HMUI::TableCell(THROW_UNLESS(::il2cpp_utils::New<LevelPackHeaderTableCell>())) {}
 void GlobalNamespace::LevelPackHeaderTableCell::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::LevelPackHeaderTableCell>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
