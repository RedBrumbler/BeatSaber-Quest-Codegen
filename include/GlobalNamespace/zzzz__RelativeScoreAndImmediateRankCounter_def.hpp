...
/// @brief Method add_relativeScoreOrImmediateRankDidChangeEvent addr 0x22af844 size 0x9c virtual false final false
 void add_relativeScoreOrImmediateRankDidChangeEvent(System::Action value) ;

/// @brief Method remove_relativeScoreOrImmediateRankDidChangeEvent addr 0x22b0c20 size 0x9c virtual false final false
 void remove_relativeScoreOrImmediateRankDidChangeEvent(System::Action value) ;

/// @brief Method get_relativeScore addr 0x22b0cbc size 0x8 virtual false final false
 float_t get_relativeScore() ;

/// @brief Method set_relativeScore addr 0x22b0cc4 size 0x8 virtual false final false
 void set_relativeScore(float_t value) ;

/// @brief Method get_immediateRank addr 0x22b0ccc size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__RankModel__Rank get_immediateRank() ;

/// @brief Method set_immediateRank addr 0x22b0cd4 size 0x8 virtual false final false
 void set_immediateRank(GlobalNamespace::GlobalNamespace__RankModel__Rank value) ;

/// @brief Method Start addr 0x22b0cdc size 0x138 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x22b0e14 size 0x108 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleScoreDidChange addr 0x22b0f1c size 0x13c virtual false final false
 void HandleScoreDidChange(int32_t scoreWithoutModifiers, int32_t scoreWithModifiers) ;

/// @brief Method UpdateRelativeScoreAndImmediateRank addr 0x22b1058 size 0x88 virtual false final false
...
/// @brief Method .ctor addr 0x22b10e0 size 0x8 virtual false final false
 void _ctor() ;
