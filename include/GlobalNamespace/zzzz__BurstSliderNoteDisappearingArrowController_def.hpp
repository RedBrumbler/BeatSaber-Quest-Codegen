...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4857)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4861), inst: 275 }), TypeDefinitionIndex(TypeDefinitionIndex(4861))}
...
/// @brief Method get_gameNoteController addr 0x22748ac size 0x8 virtual true final false
 GlobalNamespace::BurstSliderGameNoteController get_gameNoteController() ;

// Ctor Parameters []
explicit BurstSliderNoteDisappearingArrowController() ;

/// @brief Method .ctor addr 0x22748b4 size 0x6c virtual false final false
 void _ctor() ;
