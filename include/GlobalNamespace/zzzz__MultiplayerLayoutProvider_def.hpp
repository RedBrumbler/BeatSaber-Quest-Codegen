...
/// @brief Method get_layout addr 0x2132160 size 0x8 virtual false final false
 GlobalNamespace::MultiplayerPlayerLayout get_layout() ;

/// @brief Method set_layout addr 0x2132168 size 0x8 virtual false final false
 void set_layout(GlobalNamespace::MultiplayerPlayerLayout value) ;

/// @brief Method get_activePlayerSpotsCount addr 0x2132170 size 0x8 virtual false final false
 int32_t get_activePlayerSpotsCount() ;

/// @brief Method set_activePlayerSpotsCount addr 0x2132178 size 0x8 virtual false final false
 void set_activePlayerSpotsCount(int32_t value) ;

/// @brief Method add_playersLayoutWasCalculatedEvent addr 0x2128368 size 0xb0 virtual false final false
 void add_playersLayoutWasCalculatedEvent(System::Action_2<GlobalNamespace::MultiplayerPlayerLayout,int32_t> value) ;

/// @brief Method remove_playersLayoutWasCalculatedEvent addr 0x21284ac size 0xb0 virtual false final false
 void remove_playersLayoutWasCalculatedEvent(System::Action_2<GlobalNamespace::MultiplayerPlayerLayout,int32_t> value) ;

/// @brief Method CalculateLayout addr 0x2132180 size 0x5c virtual false final false
 GlobalNamespace::MultiplayerPlayerLayout CalculateLayout(int32_t activePlayersCount) ;

// Ctor Parameters []
explicit MultiplayerLayoutProvider() ;

/// @brief Method .ctor addr 0x21321dc size 0x8 virtual false final false
 void _ctor() ;
