...
/// @brief Method get_colorSchemesSettings addr 0x2156280 size 0x8 virtual false final false
 GlobalNamespace::ColorSchemesSettings get_colorSchemesSettings() ;

/// @brief Method SetData addr 0x2156288 size 0x268 virtual false final false
 void SetData(GlobalNamespace::ColorSchemesSettings colorSchemesSettings) ;

/// @brief Method OnDestroy addr 0x215663c size 0x23c virtual false final false
 void OnDestroy() ;

/// @brief Method OnDisable addr 0x21569c4 size 0x24 virtual false final false
 void OnDisable() ;

/// @brief Method Refresh addr 0x21569e8 size 0x1e0 virtual true final true
 void Refresh() ;

/// @brief Method HandleDropDownDidSelectCellWithIdx addr 0x2156bc8 size 0x18c virtual false final false
 void HandleDropDownDidSelectCellWithIdx(HMUI::DropdownWithTableView dropDownWithTableView, int32_t idx) ;

/// @brief Method HandleOverrideColorsToggleValueChanged addr 0x2156d54 size 0x22c virtual false final false
 void HandleOverrideColorsToggleValueChanged(bool isOn) ;

/// @brief Method HandleEditColorSchemeButtonWasPressed addr 0x2156f80 size 0x7c virtual false final false
 void HandleEditColorSchemeButtonWasPressed() ;

/// @brief Method HandleEditColorSchemeControllerDidFinish addr 0x2157014 size 0x50 virtual false final false
 void HandleEditColorSchemeControllerDidFinish() ;

/// @brief Method HandleEditColorSchemeControllerDidChangeColorScheme addr 0x2157064 size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0x2157080 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <HandleOverrideColorsToggleValueChanged>b__19_0 addr 0x2157088 size 0x20 virtual false final false
