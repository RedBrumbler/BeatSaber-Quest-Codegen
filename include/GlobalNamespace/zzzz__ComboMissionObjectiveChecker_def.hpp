...
/// @brief Method Init addr 0x210d6f4 size 0x14c virtual true final false
 void Init() ;

/// @brief Method OnDestroy addr 0x210d840 size 0xd4 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleComboDidChange addr 0x210d914 size 0x50 virtual false final false
 void HandleComboDidChange(int32_t combo) ;

// Ctor Parameters []
explicit ComboMissionObjectiveChecker() ;

/// @brief Method .ctor addr 0x210d964 size 0x8 virtual false final false
 void _ctor() ;
