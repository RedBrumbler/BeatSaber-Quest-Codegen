...
/// @brief Method .ctor addr 0x22715e0 size 0x58 virtual false final false
...
/// @brief Method get_noteLinesCount addr 0x2270508 size 0x1c virtual true final true
 int32_t get_noteLinesCount() ;

/// @brief Method get_jumpOffsetY addr 0x2270524 size 0x18 virtual true final true
 float_t get_jumpOffsetY() ;

/// @brief Method get_moveDuration addr 0x22705dc size 0x1c virtual true final true
 float_t get_moveDuration() ;

/// @brief Method get_jumpDuration addr 0x22705f8 size 0x1c virtual true final true
 float_t get_jumpDuration() ;

/// @brief Method get_jumpDistance addr 0x2270614 size 0x1c virtual true final true
 float_t get_jumpDistance() ;

/// @brief Method get_verticalLayerDistance addr 0x2270630 size 0x20 virtual true final true
 float_t get_verticalLayerDistance() ;

/// @brief Method get_noteJumpMovementSpeed addr 0x227065c size 0x1c virtual true final true
 float_t get_noteJumpMovementSpeed() ;

/// @brief Method get_noteLinesDistance addr 0x2270678 size 0x20 virtual true final true
 float_t get_noteLinesDistance() ;

/// @brief Method get_beatmapObjectSpawnMovementData addr 0x22706a4 size 0x8 virtual true final true
 GlobalNamespace::BeatmapObjectSpawnMovementData get_beatmapObjectSpawnMovementData() ;

/// @brief Method get_isInitialized addr 0x22706ac size 0x8 virtual true final true
 bool get_isInitialized() ;

/// @brief Method add_didInitEvent addr 0x22706b4 size 0x9c virtual true final true
 void add_didInitEvent(System::Action value) ;

/// @brief Method remove_didInitEvent addr 0x2270750 size 0x9c virtual true final true
 void remove_didInitEvent(System::Action value) ;

/// @brief Method Start addr 0x22707ec size 0x384 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2270cc0 size 0x58 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleObstacleDataCallback addr 0x2270d18 size 0x110 virtual false final false
 void HandleObstacleDataCallback(GlobalNamespace::ObstacleData obstacleData) ;

/// @brief Method HandleNoteDataCallback addr 0x2270f98 size 0x108 virtual false final false
 void HandleNoteDataCallback(GlobalNamespace::NoteData noteData) ;

/// @brief Method HandleSliderDataCallback addr 0x2271198 size 0x118 virtual false final false
 void HandleSliderDataCallback(GlobalNamespace::SliderData sliderNoteData) ;

/// @brief Method HandleSpawnRotationCallback addr 0x2271438 size 0x1c virtual false final false
 void HandleSpawnRotationCallback(GlobalNamespace::SpawnRotationBeatmapEventData beatmapEventData) ;

/// @brief Method StopSpawning addr 0x2271454 size 0xc virtual false final false
 void StopSpawning() ;

/// @brief Method Get2DNoteOffset addr 0x2271460 size 0x24 virtual true final true
 UnityEngine::Vector2 Get2DNoteOffset(int32_t noteLineIndex, GlobalNamespace::NoteLineLayer noteLineLayer) ;

/// @brief Method JumpPosYForLineLayerAtDistanceFromPlayerWithoutJumpOffset addr 0x2271498 size 0x18 virtual true final true
...
/// @brief Method .ctor addr 0x2271520 size 0x90 virtual false final false
 void _ctor() ;
