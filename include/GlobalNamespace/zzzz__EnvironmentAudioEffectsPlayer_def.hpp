...
/// @brief Method get_audioSource addr 0x20f255c size 0x8 virtual false final false
 UnityEngine::AudioSource get_audioSource() ;

/// @brief Method PlayEffect addr 0x20f2564 size 0x64 virtual false final false
 void PlayEffect(UnityEngine::AudioClip clip, float_t volume) ;

// Ctor Parameters []
explicit EnvironmentAudioEffectsPlayer() ;

/// @brief Method .ctor addr 0x20f25c8 size 0x8 virtual false final false
 void _ctor() ;
