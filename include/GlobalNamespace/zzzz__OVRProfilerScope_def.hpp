...
/// @brief Method .ctor addr 0x265f88c size 0x4 virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method System.IDisposable.Dispose addr 0x265f890 size 0x4 virtual true final true
