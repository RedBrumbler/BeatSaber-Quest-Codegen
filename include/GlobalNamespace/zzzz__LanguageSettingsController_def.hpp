...
/// @brief Method GetInitValues addr 0x218ac68 size 0xa8 virtual true final false
 bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements) ;

/// @brief Method ApplyValue addr 0x218ad10 size 0x90 virtual true final false
 void ApplyValue(int32_t idx) ;

/// @brief Method TextForValue addr 0x218ada0 size 0x64 virtual true final false
 ::StringW TextForValue(int32_t idx) ;

// Ctor Parameters []
explicit LanguageSettingsController() ;

/// @brief Method .ctor addr 0x218ae04 size 0x8 virtual false final false
 void _ctor() ;
