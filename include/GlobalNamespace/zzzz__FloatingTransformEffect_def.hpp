...
/// @brief Method Start addr 0x2289b04 size 0x38 virtual false final false
 void Start() ;

/// @brief Method Tick addr 0x2289c14 size 0x150 virtual true final true
 void Tick() ;

/// @brief Method Refresh addr 0x2289b3c size 0xd8 virtual false final false
 void Refresh() ;

/// @brief Method GetPoint addr 0x2289d64 size 0x8c virtual false final false
 UnityEngine::Vector3 GetPoint(float_t time) ;

// Ctor Parameters []
explicit FloatingTransformEffect() ;

/// @brief Method .ctor addr 0x2289df0 size 0xa8 virtual false final false
 void _ctor() ;
