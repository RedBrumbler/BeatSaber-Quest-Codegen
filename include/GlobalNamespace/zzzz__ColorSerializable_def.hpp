...
/// @brief Method .ctor addr 0x1228558 size 0xc virtual false final false
 void _ctor(UnityEngine::Color color) ;

/// @brief Method Serialize addr 0x1228564 size 0x60 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0x12285c4 size 0x64 virtual true final true
 void Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method op_Implicit addr 0x1228628 size 0x4 virtual false final false
static UnityEngine::Color op_Implicit_UnityEngine__Color(GlobalNamespace::ColorSerializable c) ;

/// @brief Method op_Implicit addr 0x122862c size 0x4 virtual false final false
static GlobalNamespace::ColorSerializable op_Implicit_GlobalNamespace__ColorSerializable(UnityEngine::Color c) ;

/// @brief Method Equals addr 0x1228630 size 0x13c virtual true final true
 bool Equals(GlobalNamespace::ColorSerializable other) ;

/// @brief Method Equals addr 0x122876c size 0x7c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x12287e8 size 0x84 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x122886c size 0x8 virtual true final false
 ::StringW ToString() ;
