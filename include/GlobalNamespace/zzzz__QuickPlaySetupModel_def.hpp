...
/// @brief Method .ctor addr 0x222bb7c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method MoveNext addr 0x222bb84 size 0x7fc virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x222c380 size 0x58 virtual true final true
...
/// @brief Method GetQuickPlaySetupAsync addr 0x222b7fc size 0x64 virtual true final true
...
/// @brief Method Init addr 0x222b9c0 size 0x4 virtual false final false
 void Init() ;

/// @brief Method StartRequest addr 0x222b958 size 0x68 virtual false final false
 void StartRequest() ;

/// @brief Method GetQuickPlaySetupInternal addr 0x222b9c4 size 0xf4 virtual false final false
 System::Threading::Tasks::Task_1<GlobalNamespace::QuickPlaySetupData> GetQuickPlaySetupInternal() ;

/// @brief Method IsQuickPlaySetupTaskValid addr 0x222b860 size 0xf8 virtual false final false
 bool IsQuickPlaySetupTaskValid() ;

/// @brief Method IsUrlValid addr 0x222bab8 size 0x5c virtual false final false
 bool IsUrlValid(::StringW url) ;

// Ctor Parameters []
explicit QuickPlaySetupModel() ;

/// @brief Method .ctor addr 0x222bb14 size 0x68 virtual false final false
 void _ctor() ;
