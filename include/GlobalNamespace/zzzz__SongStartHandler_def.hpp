...
/// @brief Method get_songStartSyncTime addr 0xdd9efc size 0x8 virtual false final false
 float_t get_songStartSyncTime() ;

/// @brief Method add_setSongStartSyncTimeEvent addr 0xdd9f04 size 0xb0 virtual false final false
 void add_setSongStartSyncTimeEvent(System::Action_1<float_t> value) ;

/// @brief Method remove_setSongStartSyncTimeEvent addr 0xdd9fb4 size 0xb0 virtual false final false
...
/// @brief Method .ctor addr 0xdda064 size 0xa4 virtual false final false
...
/// @brief Method GetLevelStartTimeOffset addr 0xdda108 size 0x4f0 virtual false final false
 void GetLevelStartTimeOffset() ;

/// @brief Method Dispose addr 0xdda5f8 size 0x244 virtual true final true
 void Dispose() ;

/// @brief Method ForceStart addr 0xdda83c size 0x6c0 virtual false final false
 void ForceStart(::StringW sessionGameId) ;

/// @brief Method StartSong addr 0xddaefc size 0x2a8 virtual false final false
 void StartSong() ;

/// @brief Method HandleSetGameplaySongReady addr 0xddb1a4 size 0x2bc virtual false final false
 void HandleSetGameplaySongReady(::StringW user) ;

/// @brief Method HandleGetGameplaySongReady addr 0xddb460 size 0xa4 virtual false final false
 void HandleGetGameplaySongReady(::StringW user) ;

/// @brief Method HandleSetSongStartTime addr 0xddb504 size 0x28 virtual false final false
 void HandleSetSongStartTime(::StringW user, float_t time) ;

/// @brief Method Log addr 0xddb52c size 0x58 virtual false final false
