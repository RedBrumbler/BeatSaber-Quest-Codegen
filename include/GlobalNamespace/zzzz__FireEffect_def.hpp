...
/// @brief Method Start addr 0x20e5808 size 0x120 virtual true final false
 void Start() ;

/// @brief Method OnDestroy addr 0x20e5a74 size 0x1c virtual true final false
 void OnDestroy() ;
...
/// @brief Method SetRenderersEnabled addr 0x20e5cc4 size 0x8c virtual false final false
 void SetRenderersEnabled(bool enabled) ;

/// @brief Method NotifyAlphaWasChanged addr 0x20e5ee4 size 0x70 virtual false final false
 void NotifyAlphaWasChanged(float_t currentAlpha) ;

// Ctor Parameters []
explicit FireEffect() ;

/// @brief Method .ctor addr 0x20e5fd8 size 0x24 virtual false final false
 void _ctor() ;
