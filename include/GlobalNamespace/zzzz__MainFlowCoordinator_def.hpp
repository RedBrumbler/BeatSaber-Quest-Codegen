...
/// @brief Method .ctor addr 0x216e3f4 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x216e9e4 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x216e9e8 size 0x54 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x216ea3c size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x216ea44 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x216ea84 size 0x8 virtual true final true
...
/// @brief Method DidActivate addr 0x216c5a0 size 0x4a8 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method TopViewControllerWillChange addr 0x216cb70 size 0x194 virtual true final false
...
/// @brief Method InitialViewControllerWasPresented addr 0x216cd04 size 0x78 virtual true final false
 void InitialViewControllerWasPresented() ;

/// @brief Method DidDeactivate addr 0x216cd7c size 0x448 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method PresentFlowCoordinatorOrAskForTutorial addr 0x216d278 size 0x1d0 virtual false final false
 void PresentFlowCoordinatorOrAskForTutorial(HMUI::FlowCoordinator flowCoordinator) ;

/// @brief Method HandleMainMenuViewControllerDidFinish addr 0x216d448 size 0x52c virtual false final false
...
/// @brief Method HandleOptionsViewControllerDidFinish addr 0x216d974 size 0xd0 virtual false final false
...
/// @brief Method HandlePlayerOptionsViewControllerDidFinish addr 0x216da44 size 0x14 virtual false final false
 void HandlePlayerOptionsViewControllerDidFinish(HMUI::ViewController viewController) ;

/// @brief Method HandleHowToPlayViewControllerDidFinish addr 0x216da58 size 0x78 virtual false final false
...
/// @brief Method HandleCampaignFlowCoordinatorDidFinish addr 0x216dad0 size 0x14 virtual false final false
 void HandleCampaignFlowCoordinatorDidFinish(GlobalNamespace::CampaignFlowCoordinator flowCoordinator) ;

/// @brief Method HandleEditAvatarFlowCoordinatorDidFinish addr 0x216dae4 size 0x228 virtual false final false
...
/// @brief Method HandleSoloFreePlayFlowCoordinatorDidFinish addr 0x216dd0c size 0x14 virtual false final false
 void HandleSoloFreePlayFlowCoordinatorDidFinish(GlobalNamespace::LevelSelectionFlowCoordinator flowCoordinator) ;

/// @brief Method HandlePartyFreePlayFlowCoordinatorDidFinish addr 0x216dd20 size 0x14 virtual false final false
 void HandlePartyFreePlayFlowCoordinatorDidFinish(GlobalNamespace::LevelSelectionFlowCoordinator flowCoordinator) ;

/// @brief Method HandleSettingsFlowCoordinatorDidFinish addr 0x216dd34 size 0x94 virtual false final false
...
/// @brief Method HandleHelpFlowCoordinatorDidFinish addr 0x216ddc8 size 0x14 virtual false final false
 void HandleHelpFlowCoordinatorDidFinish(GlobalNamespace::HelpFlowCoordinator helpFlowCoordinator) ;

/// @brief Method HandleMultiplayerModeSelectionFlowCoordinatorDidFinish addr 0x216dddc size 0x14 virtual false final false
...
/// @brief Method HandleMainMenuViewControllerMusicPackPromoButtonWasPressed addr 0x216ddf0 size 0xac virtual false final false
...
/// @brief Method ProcessMenuDestinationRequest addr 0x216de9c size 0x388 virtual false final false
 void ProcessMenuDestinationRequest(GlobalNamespace::MenuDestination destination) ;

/// @brief Method PresentMultiplayerModeSelectionFlowCoordinatorWithDisclaimerAndAvatarCreator addr 0x216e224 size 0x1d0 virtual false final false
 void PresentMultiplayerModeSelectionFlowCoordinatorWithDisclaimerAndAvatarCreator() ;

/// @brief Method ProcessMenuDestinationRequestAfterFrameCoroutine addr 0x216cafc size 0x74 virtual false final false
...
/// @brief Method BackButtonWasPressed addr 0x216e41c size 0x9c virtual true final false
 void BackButtonWasPressed(HMUI::ViewController topViewController) ;

// Ctor Parameters []
explicit MainFlowCoordinator() ;

/// @brief Method .ctor addr 0x216e4b8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <PresentFlowCoordinatorOrAskForTutorial>b__26_0 addr 0x216e4c0 size 0xe0 virtual false final false
 void _PresentFlowCoordinatorOrAskForTutorial_b__26_0(int32_t buttonNumber) ;

/// @brief Method <PresentFlowCoordinatorOrAskForTutorial>b__26_1 addr 0x216e5a0 size 0x18 virtual false final false
 void _PresentFlowCoordinatorOrAskForTutorial_b__26_1() ;

/// @brief Method <HandleMainMenuViewControllerDidFinish>b__27_0 addr 0x216e5b8 size 0x1c virtual false final false
 void _HandleMainMenuViewControllerDidFinish_b__27_0() ;

/// @brief Method <HandleMainMenuViewControllerDidFinish>b__27_1 addr 0x216e5d4 size 0x364 virtual false final false
 void _HandleMainMenuViewControllerDidFinish_b__27_1(int32_t buttonNumber) ;

/// @brief Method <PresentMultiplayerModeSelectionFlowCoordinatorWithDisclaimerAndAvatarCreator>b__40_0 addr 0x216e938 size 0xac virtual false final false
