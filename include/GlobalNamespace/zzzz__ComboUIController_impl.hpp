...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ComboUIController::*)()>(&GlobalNamespace::ComboUIController::Start)> {
  ...
  constexpr static std::size_t addrs = 0x22ae2b4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ComboUIController::*)()>(&GlobalNamespace::ComboUIController::OnEnable)> {
  ...
  constexpr static std::size_t addrs = 0x22ae60c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ComboUIController::*)()>(&GlobalNamespace::ComboUIController::OnDisable)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x22ae610;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ComboUIController::*)()>(&GlobalNamespace::ComboUIController::RegisterForEvents)> {
  ...
  constexpr static std::size_t addrs = 0x22ae33c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ComboUIController::*)()>(&GlobalNamespace::ComboUIController::UnregisterFromEvents)> {
  ...
  constexpr static std::size_t addrs = 0x22ae614;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ComboUIController::*)(int32_t)>(&GlobalNamespace::ComboUIController::HandleComboDidChange)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x22ae7cc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::ComboUIController::*)()>(&GlobalNamespace::ComboUIController::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x22ae850;
...
constexpr void GlobalNamespace::ComboUIController::__set__comboText(TMPro::TextMeshProUGUI value)  {
...
constexpr TMPro::TextMeshProUGUI GlobalNamespace::ComboUIController::__get__comboText() const {
return ::cordl_internals::getInstanceField<TMPro::TextMeshProUGUI, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::ComboUIController::__set__animator(UnityEngine::Animator value)  {
...
constexpr UnityEngine::Animator GlobalNamespace::ComboUIController::__get__animator() const {
return ::cordl_internals::getInstanceField<UnityEngine::Animator, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::ComboUIController::__set__comboController(GlobalNamespace::IComboController value)  {
::cordl_internals::setInstanceField<GlobalNamespace::IComboController, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::IComboController>(value));
}
constexpr GlobalNamespace::IComboController GlobalNamespace::ComboUIController::__get__comboController() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::IComboController, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::ComboUIController::__set__comboLostId(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::ComboUIController::__get__comboLostId() const {
return ::cordl_internals::getInstanceField<int32_t, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::ComboUIController::__set__fullComboLost(bool value)  {
::cordl_internals::setInstanceField<bool, 0x34>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<bool>(value));
}
constexpr bool GlobalNamespace::ComboUIController::__get__fullComboLost() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void GlobalNamespace::ComboUIController::HandleComboDidChange(int32_t combo)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::ComboUIController>::get(),
                            "HandleComboDidChange",
                            std::vector<Il2CppClass*>{},
