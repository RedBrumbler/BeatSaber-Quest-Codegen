...
/// @brief Method get_objectiveName addr 0x222a9c0 size 0x8 virtual false final false
 ::StringW get_objectiveName() ;

/// @brief Method get_objectiveNameLocalized addr 0x222a9c8 size 0xc virtual false final false
 ::StringW get_objectiveNameLocalized() ;

/// @brief Method get_noConditionValue addr 0x222a9d4 size 0x8 virtual false final false
 bool get_noConditionValue() ;

/// @brief Method get_objectiveValueFormater addr 0x222a9dc size 0x8 virtual false final false
 GlobalNamespace::ObjectiveValueFormatterSO get_objectiveValueFormater() ;

// Ctor Parameters []
explicit MissionObjectiveTypeSO() ;

/// @brief Method .ctor addr 0x222a9e4 size 0x8 virtual false final false
 void _ctor() ;
