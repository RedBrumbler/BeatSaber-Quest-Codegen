...
/// @brief Method .ctor addr 0x2121ee0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ToMockBeatmapData>b__0_0 addr 0x2121ee8 size 0x20 virtual false final false
 bool _ToMockBeatmapData_b__0_0(GlobalNamespace::NoteData nd) ;

/// @brief Method <ToMockBeatmapData>b__0_1 addr 0x2121f08 size 0x8 virtual false final false
 GlobalNamespace::MockNoteData _ToMockBeatmapData_b__0_1(GlobalNamespace::NoteData nd) ;

/// @brief Method <ToMockBeatmapData>b__0_2 addr 0x2121f10 size 0x20 virtual false final false
 bool _ToMockBeatmapData_b__0_2(GlobalNamespace::NoteData nd) ;

/// @brief Method <ToMockBeatmapData>b__0_3 addr 0x2121f30 size 0x8 virtual false final false
 GlobalNamespace::MockNoteData _ToMockBeatmapData_b__0_3(GlobalNamespace::NoteData nd) ;

/// @brief Method <ToMockBeatmapData>b__0_4 addr 0x2121f38 size 0x20 virtual false final false
 bool _ToMockBeatmapData_b__0_4(GlobalNamespace::NoteData nd) ;

/// @brief Method <ToMockBeatmapData>b__0_5 addr 0x2121f58 size 0x8 virtual false final false
 GlobalNamespace::MockNoteData _ToMockBeatmapData_b__0_5(GlobalNamespace::NoteData nd) ;

/// @brief Method <ToMockBeatmapData>b__0_6 addr 0x2121f60 size 0x8 virtual false final false
...
/// @brief Method ToMockBeatmapData addr 0x2121490 size 0x8f4 virtual false final false
static GlobalNamespace::MockBeatmapData ToMockBeatmapData(GlobalNamespace::IReadonlyBeatmapData beatmapData) ;

/// @brief Method ToMockNoteData addr 0x2121d84 size 0x84 virtual false final false
static GlobalNamespace::MockNoteData ToMockNoteData(GlobalNamespace::NoteData noteData) ;

/// @brief Method ToMockObstacleData addr 0x2121e08 size 0x74 virtual false final false
