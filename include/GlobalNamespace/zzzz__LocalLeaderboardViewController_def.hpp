...
/// @brief Method get_leaderboardsModel addr 0x21a7fc8 size 0x8 virtual false final false
 GlobalNamespace::LocalLeaderboardsModel get_leaderboardsModel() ;

/// @brief Method OnEnable addr 0x21a7fd0 size 0x24 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x21a7ff4 size 0x24 virtual false final false
 void OnDisable() ;

/// @brief Method Setup addr 0x21a8018 size 0xc virtual false final false
 void Setup(bool enableClear) ;

/// @brief Method SetData addr 0x21a8024 size 0x2c virtual true final false
 void SetData(GlobalNamespace::IDifficultyBeatmap difficultyBeatmap) ;

/// @brief Method DidActivate addr 0x21a80b4 size 0x1e0 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x21a8698 size 0x10c virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method OnDestroy addr 0x21a87a4 size 0x98 virtual true final false
 void OnDestroy() ;

/// @brief Method RefreshScopeSegmentedControl addr 0x21a8294 size 0x2d4 virtual false final false
 void RefreshScopeSegmentedControl() ;

/// @brief Method HandleScopeSegmentedControlDidSelectCell addr 0x21a8568 size 0x130 virtual false final false
 void HandleScopeSegmentedControlDidSelectCell(HMUI::SegmentedControl segmentedControl, int32_t cellNumber) ;

/// @brief Method ClearLeaderboards addr 0x21a883c size 0x60 virtual false final false
 void ClearLeaderboards() ;

/// @brief Method SetContent addr 0x21a889c size 0x78 virtual false final false
...
/// @brief Method HandleNewScoreWasAddedToLeaderboard addr 0x21a8914 size 0xa8 virtual false final false
...
/// @brief Method Refresh addr 0x21a8050 size 0x64 virtual false final false
 void Refresh() ;

// Ctor Parameters []
explicit LocalLeaderboardViewController() ;

/// @brief Method .ctor addr 0x21a89bc size 0x10 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__21_0 addr 0x21a89cc size 0x60 virtual false final false
