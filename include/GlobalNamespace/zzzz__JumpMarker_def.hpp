...
/// @brief Method get_id addr 0x1fbefbc size 0x8 virtual true final true
 UnityEngine::PropertyName get_id() ;

/// @brief Method get_jumpDestination addr 0x1fbefc4 size 0x8 virtual false final false
 GlobalNamespace::JumpDestinationMarker get_jumpDestination() ;

// Ctor Parameters []
explicit JumpMarker() ;

/// @brief Method .ctor addr 0x1fbefcc size 0x8 virtual false final false
 void _ctor() ;
