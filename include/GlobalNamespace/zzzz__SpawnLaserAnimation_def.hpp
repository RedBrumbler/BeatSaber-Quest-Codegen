...
/// @brief Method InitIfNeeded addr 0x22918fc size 0xc0 virtual false final false
 void InitIfNeeded() ;

/// @brief Method LateUpdate addr 0x22919bc size 0x108 virtual false final false
 void LateUpdate() ;

// Ctor Parameters []
explicit SpawnLaserAnimation() ;

/// @brief Method .ctor addr 0x2291ac4 size 0x14 virtual false final false
 void _ctor() ;
