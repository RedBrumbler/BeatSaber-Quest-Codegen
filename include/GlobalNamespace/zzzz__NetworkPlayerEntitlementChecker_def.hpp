...
/// @brief Method MoveNext addr 0x2242a18 size 0x260 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2242c78 size 0xc virtual true final true
...
/// @brief Method MoveNext addr 0x2242c84 size 0x204 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2242e88 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method Start addr 0x2242540 size 0xf0 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2242630 size 0x1a4 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleDataInvalidated addr 0x22427d4 size 0xa4 virtual false final false
 void HandleDataInvalidated() ;

/// @brief Method HandleGetIsEntitledToLevel addr 0x2242878 size 0x9c virtual false final false
 void HandleGetIsEntitledToLevel(::StringW userId, ::StringW levelId) ;

/// @brief Method GetEntitlementStatus addr 0x2242914 size 0xfc virtual false final false
...
/// @brief Method .ctor addr 0x2242a10 size 0x8 virtual false final false
 void _ctor() ;
