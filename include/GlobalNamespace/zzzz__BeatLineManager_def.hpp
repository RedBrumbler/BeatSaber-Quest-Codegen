...
/// @brief Method get_isMidRotationValid addr 0x2267e20 size 0x8 virtual false final false
 bool get_isMidRotationValid() ;

/// @brief Method get_midRotation addr 0x2267e28 size 0x8 virtual false final false
 float_t get_midRotation() ;

/// @brief Method get_rotationRange addr 0x2267e30 size 0x8 virtual false final false
 float_t get_rotationRange() ;

/// @brief Method Start addr 0x2267e38 size 0x88 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2267f70 size 0x88 virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x22680a8 size 0x52c virtual false final false
 void Update() ;

/// @brief Method HandleNoteWasSpawned addr 0x22685d4 size 0x1a0 virtual false final false
 void HandleNoteWasSpawned(GlobalNamespace::NoteController noteController) ;

// Ctor Parameters []
explicit BeatLineManager() ;

/// @brief Method .ctor addr 0x2268774 size 0xc8 virtual false final false
 void _ctor() ;
