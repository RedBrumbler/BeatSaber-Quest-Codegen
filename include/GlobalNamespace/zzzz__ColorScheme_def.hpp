...
/// @brief Method get_colorSchemeId addr 0x11afdb4 size 0x8 virtual false final false
 ::StringW get_colorSchemeId() ;

/// @brief Method get_colorSchemeNameLocalizationKey addr 0x11afdbc size 0x8 virtual false final false
 ::StringW get_colorSchemeNameLocalizationKey() ;

/// @brief Method get_nonLocalizedName addr 0x11afdc4 size 0x8 virtual false final false
 ::StringW get_nonLocalizedName() ;

/// @brief Method get_useNonLocalizedName addr 0x11afdcc size 0x8 virtual false final false
 bool get_useNonLocalizedName() ;

/// @brief Method get_isEditable addr 0x11afdd4 size 0x8 virtual false final false
 bool get_isEditable() ;

/// @brief Method get_saberAColor addr 0x11afddc size 0xc virtual false final false
 UnityEngine::Color get_saberAColor() ;

/// @brief Method get_saberBColor addr 0x11afde8 size 0xc virtual false final false
 UnityEngine::Color get_saberBColor() ;

/// @brief Method get_environmentColor0 addr 0x11afdf4 size 0xc virtual false final false
 UnityEngine::Color get_environmentColor0() ;

/// @brief Method get_environmentColor1 addr 0x11afe00 size 0xc virtual false final false
 UnityEngine::Color get_environmentColor1() ;

/// @brief Method get_environmentColorW addr 0x11afe0c size 0xc virtual false final false
 UnityEngine::Color get_environmentColorW() ;

/// @brief Method get_supportsEnvironmentColorBoost addr 0x11afe18 size 0x8 virtual false final false
 bool get_supportsEnvironmentColorBoost() ;

/// @brief Method get_environmentColor0Boost addr 0x11afe20 size 0xc virtual false final false
 UnityEngine::Color get_environmentColor0Boost() ;

/// @brief Method get_environmentColor1Boost addr 0x11afe2c size 0xc virtual false final false
 UnityEngine::Color get_environmentColor1Boost() ;

/// @brief Method get_environmentColorWBoost addr 0x11afe38 size 0xc virtual false final false
 UnityEngine::Color get_environmentColorWBoost() ;

/// @brief Method get_obstaclesColor addr 0x11afe44 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x11afe50 size 0x110 virtual false final false
...
/// @brief Method .ctor addr 0x11aff60 size 0x90 virtual false final false
...
/// @brief Method .ctor addr 0x11afff0 size 0xb0 virtual false final false
...
/// @brief Method .ctor addr 0x11b00a0 size 0x18 virtual false final false
