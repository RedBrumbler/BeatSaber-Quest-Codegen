...
/// @brief Method AppStartAndMultiSceneEditorSetup addr 0x20ef5c8 size 0x68 virtual true final false
 void AppStartAndMultiSceneEditorSetup() ;

/// @brief Method RepeatableSetup addr 0x20ef630 size 0x84 virtual true final false
 void RepeatableSetup() ;

/// @brief Method TransitionToNextScene addr 0x20ef6b4 size 0x4 virtual true final false
 void TransitionToNextScene() ;

/// @brief Method TransitionToNextSceneInternal addr 0x20ef6b8 size 0x50 virtual false final false
 void TransitionToNextSceneInternal() ;

/// @brief Method InstallBindings addr 0x20ef708 size 0x2a8 virtual true final false
 void InstallBindings() ;

// Ctor Parameters []
explicit PS5AppInit() ;

/// @brief Method .ctor addr 0x20ef9b0 size 0x4 virtual false final false
 void _ctor() ;
