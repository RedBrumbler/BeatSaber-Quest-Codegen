...
/// @brief Method get_packID addr 0x22248dc size 0x8 virtual true final true
 ::StringW get_packID() ;

/// @brief Method get_packName addr 0x22248e4 size 0x8 virtual true final true
 ::StringW get_packName() ;

/// @brief Method get_shortPackName addr 0x22248ec size 0x8 virtual true final true
 ::StringW get_shortPackName() ;

/// @brief Method get_collectionName addr 0x22248f4 size 0x8 virtual true final true
 ::StringW get_collectionName() ;

/// @brief Method get_coverImage addr 0x22248fc size 0x8 virtual true final true
 UnityEngine::Sprite get_coverImage() ;

/// @brief Method get_smallCoverImage addr 0x2224904 size 0x8 virtual true final true
 UnityEngine::Sprite get_smallCoverImage() ;

/// @brief Method get_beatmapLevelCollection addr 0x222490c size 0x8 virtual true final true
 GlobalNamespace::IBeatmapLevelCollection get_beatmapLevelCollection() ;

// Ctor Parameters []
explicit PreviewBeatmapLevelPackSO() ;

/// @brief Method .ctor addr 0x2224914 size 0x8 virtual false final false
 void _ctor() ;
