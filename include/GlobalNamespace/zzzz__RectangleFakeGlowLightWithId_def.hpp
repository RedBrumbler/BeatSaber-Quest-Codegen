...
/// @brief Method get_color addr 0x22a4038 size 0x20 virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method ColorWasSet addr 0x22a4058 size 0x2c virtual true final false
 void ColorWasSet(UnityEngine::Color color) ;

// Ctor Parameters []
explicit RectangleFakeGlowLightWithId() ;

/// @brief Method .ctor addr 0x22a4084 size 0x10 virtual false final false
 void _ctor() ;
