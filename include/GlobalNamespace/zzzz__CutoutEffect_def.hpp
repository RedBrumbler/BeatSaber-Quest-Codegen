...
/// @brief Method get_useRandomCutoutOffset addr 0x2287818 size 0x48 virtual false final false
 bool get_useRandomCutoutOffset() ;

/// @brief Method Start addr 0x2287860 size 0x3c virtual false final false
 void Start() ;

/// @brief Method SetCutout addr 0x22875d4 size 0xc4 virtual false final false
 void SetCutout(float_t cutout) ;

/// @brief Method SetCutout addr 0x228789c size 0xe4 virtual false final false
 void SetCutout(float_t cutout, UnityEngine::Vector3 cutoutOffset) ;

// Ctor Parameters []
explicit CutoutEffect() ;

/// @brief Method .ctor addr 0x2287980 size 0x8 virtual false final false
 void _ctor() ;
