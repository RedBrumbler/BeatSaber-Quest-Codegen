...
/// @brief Method get_masterVersion addr 0x22540cc size 0x8 virtual false final false
 ::StringW get_masterVersion() ;

/// @brief Method get_contentVersion addr 0x22540d4 size 0x8 virtual false final false
 ::StringW get_contentVersion() ;

// Ctor Parameters []
explicit GlobalNamespace__PS5SharedPackageSKUsSO__PS5BuildVersion() ;

/// @brief Method .ctor addr 0x22540dc size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_availableSKUs addr 0x2254078 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::PS5PublisherSKUSettingsSO> get_availableSKUs() ;

/// @brief Method get_conceptId addr 0x2254080 size 0x8 virtual false final false
 ::StringW get_conceptId() ;

/// @brief Method get_buildType addr 0x2254088 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__PS5SharedPackageSKUsSO__BuildType get_buildType() ;

/// @brief Method get_buildVersion addr 0x2254090 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__PS5SharedPackageSKUsSO__PS5BuildVersion get_buildVersion() ;

/// @brief Method get_latestBuildVersion addr 0x2254098 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__PS5SharedPackageSKUsSO__PS5BuildVersion get_latestBuildVersion() ;

/// @brief Method GetPrimarySKU addr 0x22540a0 size 0x24 virtual false final false
 GlobalNamespace::PS5PublisherSKUSettingsSO GetPrimarySKU() ;

// Ctor Parameters []
explicit PS5SharedPackageSKUsSO() ;

/// @brief Method .ctor addr 0x22540c4 size 0x8 virtual false final false
 void _ctor() ;
