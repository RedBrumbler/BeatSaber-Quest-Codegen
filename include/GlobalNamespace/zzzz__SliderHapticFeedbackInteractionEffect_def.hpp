...
/// @brief Method Start addr 0x22838dc size 0x40 virtual true final false
 void Start() ;

/// @brief Method Update addr 0x2283a24 size 0xd4 virtual false final false
 void Update() ;

/// @brief Method StartEffect addr 0x2283b54 size 0x48 virtual true final false
 void StartEffect(float_t saberInteractionParam) ;

/// @brief Method EndEffect addr 0x2283b9c size 0xc virtual true final false
 void EndEffect() ;

/// @brief Method Vibrate addr 0x2283b14 size 0x40 virtual false final false
 void Vibrate() ;

// Ctor Parameters []
explicit SliderHapticFeedbackInteractionEffect() ;

/// @brief Method .ctor addr 0x2283ba8 size 0x8 virtual false final false
 void _ctor() ;
