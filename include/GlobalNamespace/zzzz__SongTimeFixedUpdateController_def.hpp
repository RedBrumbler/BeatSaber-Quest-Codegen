...
/// @brief Method add_songControllerFixedTimeDidUpdateEvent addr 0x20f68e4 size 0xb0 virtual false final false
 void add_songControllerFixedTimeDidUpdateEvent(System::Action_1<float_t> value) ;

/// @brief Method remove_songControllerFixedTimeDidUpdateEvent addr 0x20f6994 size 0xb0 virtual false final false
 void remove_songControllerFixedTimeDidUpdateEvent(System::Action_1<float_t> value) ;

/// @brief Method add_songControllerTimeDidUpdateEvent addr 0x20f6a44 size 0x9c virtual false final false
 void add_songControllerTimeDidUpdateEvent(System::Action value) ;

/// @brief Method remove_songControllerTimeDidUpdateEvent addr 0x20f6ae0 size 0x9c virtual false final false
 void remove_songControllerTimeDidUpdateEvent(System::Action value) ;

/// @brief Method get_fixedDeltaTime addr 0x20f6b7c size 0xc virtual false final false
 float_t get_fixedDeltaTime() ;

/// @brief Method get_interpolationFactor addr 0x20f6b88 size 0x8 virtual false final false
 float_t get_interpolationFactor() ;

/// @brief Method Update addr 0x20f6b90 size 0x140 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit SongTimeFixedUpdateController() ;

/// @brief Method .ctor addr 0x20f6cd0 size 0x8 virtual false final false
 void _ctor() ;
