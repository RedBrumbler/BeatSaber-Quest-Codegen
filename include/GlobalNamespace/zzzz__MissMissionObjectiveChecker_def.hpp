...
/// @brief Method Init addr 0x210f424 size 0x14c virtual true final false
 void Init() ;

/// @brief Method OnDestroy addr 0x210f570 size 0x98 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleNoteWasMissed addr 0x210f608 size 0x70 virtual false final false
 void HandleNoteWasMissed(GlobalNamespace::NoteController noteController) ;

// Ctor Parameters []
explicit MissMissionObjectiveChecker() ;

/// @brief Method .ctor addr 0x210f678 size 0x8 virtual false final false
 void _ctor() ;
