...
/// @brief Method Start addr 0x2291704 size 0x11c virtual false final false
 void Start() ;

/// @brief Method SpawnShockwave addr 0x2291820 size 0xd4 virtual false final false
 void SpawnShockwave(UnityEngine::Vector3 pos) ;

// Ctor Parameters []
explicit ShockwaveEffect() ;

/// @brief Method .ctor addr 0x22918f4 size 0x8 virtual false final false
 void _ctor() ;
