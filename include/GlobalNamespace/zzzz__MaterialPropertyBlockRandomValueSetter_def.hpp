...
/// @brief Method Start addr 0x1fdcd98 size 0x4 virtual false final false
 void Start() ;

/// @brief Method OnValidate addr 0x1fdcfa4 size 0x24 virtual false final false
 void OnValidate() ;

/// @brief Method RefreshPropertyId addr 0x1fdcfc8 size 0x20 virtual false final false
 void RefreshPropertyId() ;

/// @brief Method ApplyParams addr 0x1fdcd9c size 0x208 virtual false final false
 void ApplyParams() ;

// Ctor Parameters []
explicit MaterialPropertyBlockRandomValueSetter() ;

/// @brief Method .ctor addr 0x1fdcfe8 size 0x10 virtual false final false
 void _ctor() ;
