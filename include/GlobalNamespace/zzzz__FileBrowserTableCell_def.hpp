...
/// @brief Method set_text addr 0x216807c size 0x24 virtual false final false
 void set_text(::StringW value) ;

/// @brief Method get_text addr 0x21680a0 size 0x24 virtual false final false
 ::StringW get_text() ;

/// @brief Method SelectionDidChange addr 0x21680c4 size 0xa4 virtual true final false
 void SelectionDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method HighlightDidChange addr 0x2168168 size 0x40 virtual true final false
 void HighlightDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

// Ctor Parameters []
explicit FileBrowserTableCell() ;

/// @brief Method .ctor addr 0x21681a8 size 0x8 virtual false final false
 void _ctor() ;
