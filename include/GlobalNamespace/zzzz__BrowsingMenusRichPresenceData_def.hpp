...
/// @brief Method get_apiName addr 0x2264be8 size 0x40 virtual true final true
 ::StringW get_apiName() ;

/// @brief Method get_localizedDescription addr 0x2264c28 size 0x8 virtual true final true
 ::StringW get_localizedDescription() ;

/// @brief Method set_localizedDescription addr 0x2264c30 size 0x8 virtual false final false
 void set_localizedDescription(::StringW value) ;

// Ctor Parameters []
explicit BrowsingMenusRichPresenceData() ;

/// @brief Method .ctor addr 0x2264c38 size 0x5c virtual false final false
 void _ctor() ;
