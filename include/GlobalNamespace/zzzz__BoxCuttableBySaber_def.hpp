...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5380))}
...
/// @brief Method get_radius addr 0x2142d80 size 0x8 virtual true final false
 float_t get_radius() ;

/// @brief Method set_canBeCut addr 0x2142d88 size 0x38 virtual true final false
 void set_canBeCut(bool value) ;

/// @brief Method get_canBeCut addr 0x2142dc0 size 0x8 virtual true final false
 bool get_canBeCut() ;

/// @brief Method set_colliderSize addr 0x2142dc8 size 0x28 virtual false final false
 void set_colliderSize(UnityEngine::Vector3 value) ;

/// @brief Method get_colliderSize addr 0x2142e58 size 0x1c virtual false final false
 UnityEngine::Vector3 get_colliderSize() ;

/// @brief Method set_colliderCenter addr 0x2142e74 size 0x1c virtual false final false
 void set_colliderCenter(UnityEngine::Vector3 value) ;

/// @brief Method get_colliderCenter addr 0x2142e90 size 0x1c virtual false final false
 UnityEngine::Vector3 get_colliderCenter() ;

/// @brief Method Awake addr 0x2142eac size 0x30 virtual false final false
 void Awake() ;

/// @brief Method Cut addr 0x2142edc size 0x34 virtual true final false
...
/// @brief Method SetColliderCenterAndSize addr 0x2142f3c size 0x58 virtual false final false
 void SetColliderCenterAndSize(UnityEngine::Vector3 center, UnityEngine::Vector3 size) ;

/// @brief Method RefreshRadius addr 0x2142df0 size 0x68 virtual false final false
 void RefreshRadius() ;

// Ctor Parameters []
explicit BoxCuttableBySaber() ;

/// @brief Method .ctor addr 0x2142f94 size 0x8 virtual false final false
 void _ctor() ;
