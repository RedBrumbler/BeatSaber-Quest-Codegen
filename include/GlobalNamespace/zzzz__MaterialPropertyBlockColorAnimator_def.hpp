...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14743))}
...
/// @brief Method get_color addr 0x1fdc988 size 0xc virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method set_color addr 0x1fdc994 size 0xc virtual false final false
 void set_color(UnityEngine::Color value) ;

/// @brief Method SetProperty addr 0x1fdc9a0 size 0x34 virtual true final false
 void SetProperty() ;

// Ctor Parameters []
explicit MaterialPropertyBlockColorAnimator() ;

/// @brief Method .ctor addr 0x1fdca40 size 0x14 virtual false final false
 void _ctor() ;
