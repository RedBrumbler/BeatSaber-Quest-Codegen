...
/// @brief Method get_easeType addr 0x215f8f0 size 0x1c virtual false final false
 GlobalNamespace::EaseType get_easeType() ;

/// @brief Method get_easeDuration addr 0x215f90c size 0x1c virtual false final false
 float_t get_easeDuration() ;

// Ctor Parameters []
explicit BaseTransitionSO() ;

/// @brief Method .ctor addr 0x215f928 size 0x8 virtual false final false
 void _ctor() ;
