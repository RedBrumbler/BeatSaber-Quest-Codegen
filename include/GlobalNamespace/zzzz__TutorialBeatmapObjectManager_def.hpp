...
/// @brief Method .ctor addr 0x2286ddc size 0x28 virtual false final false
...
/// @brief Method get_activeObstacleControllers addr 0x228687c size 0x50 virtual true final false
 System::Collections::Generic::List_1<GlobalNamespace::ObstacleController> get_activeObstacleControllers() ;

/// @brief Method Init addr 0x22868cc size 0x12c virtual false final false
...
/// @brief Method ProcessObstacleData addr 0x22869f8 size 0xf8 virtual true final false
...
/// @brief Method ProcessNoteData addr 0x2286af0 size 0x180 virtual true final false
...
/// @brief Method ProcessSliderData addr 0x2286c70 size 0x4 virtual true final false
...
/// @brief Method DespawnInternal addr 0x2286c74 size 0x104 virtual true final false
 void DespawnInternal(GlobalNamespace::NoteController noteController) ;

/// @brief Method DespawnInternal addr 0x2286d78 size 0x58 virtual true final false
 void DespawnInternal(GlobalNamespace::ObstacleController obstacleController) ;

/// @brief Method DespawnInternal addr 0x2286dd0 size 0x4 virtual true final false
 void DespawnInternal(GlobalNamespace::SliderController sliderNoteController) ;

// Ctor Parameters []
explicit TutorialBeatmapObjectManager() ;

/// @brief Method .ctor addr 0x2286dd4 size 0x8 virtual false final false
 void _ctor() ;
