...
/// @brief Method get_isSupported addr 0x222c854 size 0x8 virtual true final true
 bool get_isSupported() ;

/// @brief Method OpenInvitePanel addr 0x222c85c size 0x68 virtual true final true
 void OpenInvitePanel() ;

// Ctor Parameters []
explicit TestInvitePlatformHandler() ;

/// @brief Method .ctor addr 0x222c8c4 size 0x8 virtual false final false
 void _ctor() ;
