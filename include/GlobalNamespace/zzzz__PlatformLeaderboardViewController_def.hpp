...
class CORDL_TYPE GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31(GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31(GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31& operator=(GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31&& o) noexcept = default;
  constexpr GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31& operator=(GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31 const& o) noexcept = default;
...
/// @brief Method .ctor addr 0x21b3ee0 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x21b3f88 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x21b3f8c size 0x258 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x21b41e4 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x21b41ec size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x21b422c size 0x8 virtual true final true
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5752))}
...
public:
// Declarations
using _RefreshDelayed_d__31 = GlobalNamespace::GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31;
...
static GlobalNamespace::GlobalNamespace__PlatformLeaderboardsModel__ScoresScope __declspec(property(get=__get__scoresScope, put=__set__scoresScope))  _scoresScope;

static void __set__scoresScope(GlobalNamespace::GlobalNamespace__PlatformLeaderboardsModel__ScoresScope value) ;

static GlobalNamespace::GlobalNamespace__PlatformLeaderboardsModel__ScoresScope __get__scoresScope() ;
...
constexpr bool __get__hasScoresData() const;
 ...
 ::ArrayW<GlobalNamespace::GlobalNamespace__PlatformLeaderboardsModel__ScoresScope> __declspec(property(get=__get__scoreScopes, put=__set__scoreScopes))  _scoreScopes;

constexpr void __set__scoreScopes(::ArrayW<GlobalNamespace::GlobalNamespace__PlatformLeaderboardsModel__ScoresScope> value) ;

constexpr ::ArrayW<GlobalNamespace::GlobalNamespace__PlatformLeaderboardsModel__ScoresScope> __get__scoreScopes() const;
...
/// @brief Method get_leaderboardsModel addr 0x21b2f4c size 0x8 virtual false final false
 GlobalNamespace::PlatformLeaderboardsModel get_leaderboardsModel() ;

/// @brief Method SetData addr 0x21b2f54 size 0x58 virtual true final false
 void SetData(GlobalNamespace::IDifficultyBeatmap difficultyBeatmap) ;

/// @brief Method RefreshLevelStats addr 0x21b3180 size 0x30 virtual true final false
 void RefreshLevelStats() ;

/// @brief Method DidActivate addr 0x21b31b0 size 0x53c virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x21b3780 size 0x120 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method OnDestroy addr 0x21b38a0 size 0x1cc virtual true final false
 void OnDestroy() ;

/// @brief Method ScoreScopeToScoreScopeIndex addr 0x21b36ec size 0x94 virtual false final false
 int32_t ScoreScopeToScoreScopeIndex(GlobalNamespace::GlobalNamespace__PlatformLeaderboardsModel__ScoresScope scoresScope) ;

/// @brief Method ScopeScopeIndexToScoreScope addr 0x21b3a6c size 0x3c virtual false final false
 GlobalNamespace::GlobalNamespace__PlatformLeaderboardsModel__ScoresScope ScopeScopeIndexToScoreScope(int32_t scoreScopeIndex) ;

/// @brief Method HandleDidPressRefreshButton addr 0x21b3aa8 size 0xc virtual false final false
 void HandleDidPressRefreshButton() ;

/// @brief Method HandleLeaderboardsResultsReturned addr 0x21b3ab4 size 0x26c virtual false final false
 void HandleLeaderboardsResultsReturned(GlobalNamespace::GlobalNamespace__PlatformLeaderboardsModel__GetScoresResult result, ::ArrayW<GlobalNamespace::GlobalNamespace__PlatformLeaderboardsModel__LeaderboardScore> scores, int32_t playerScoreIndex) ;

/// @brief Method HandleScopeSegmentedControlDidSelectCell addr 0x21b3d20 size 0x70 virtual false final false
 void HandleScopeSegmentedControlDidSelectCell(HMUI::SegmentedControl segmentedControl, int32_t cellNumber) ;

/// @brief Method HandlePlatformLeaderboardsModelAllScoresDidUpload addr 0x21b3d90 size 0xc virtual false final false
 void HandlePlatformLeaderboardsModelAllScoresDidUpload() ;

/// @brief Method Refresh addr 0x21b2fac size 0x1d4 virtual false final false
 void Refresh(bool showLoadingIndicator, bool clear) ;

/// @brief Method RefreshDelayed addr 0x21b3e58 size 0x88 virtual false final false
 System::Collections::IEnumerator RefreshDelayed(bool showLoadingIndicator, bool clear) ;

/// @brief Method ClearContent addr 0x21b3d9c size 0xbc virtual false final false
 void ClearContent() ;

// Ctor Parameters []
explicit PlatformLeaderboardViewController() ;

/// @brief Method .ctor addr 0x21b3f08 size 0x80 virtual false final false
 void _ctor() ;
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__PlatformLeaderboardViewController___RefreshDelayed_d__31, "", "PlatformLeaderboardViewController/<RefreshDelayed>d__31");
