...
/// @brief Method .ctor addr 0x213f1c4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <get_defaultSpot>b__3_0 addr 0x213f1cc size 0xa0 virtual false final false
...
/// @brief Method get_spectatingSpots addr 0x213eb74 size 0x8 virtual false final false
 System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::IMultiplayerSpectatingSpot> get_spectatingSpots() ;

/// @brief Method get_defaultSpot addr 0x213eb7c size 0x158 virtual false final false
 GlobalNamespace::IMultiplayerSpectatingSpot get_defaultSpot() ;

/// @brief Method RegisterSpectatingSpot addr 0x213e444 size 0x164 virtual false final false
 void RegisterSpectatingSpot(GlobalNamespace::IMultiplayerSpectatingSpot spectatingSpot) ;

/// @brief Method GetAdjacentSpot addr 0x213ee48 size 0xb4 virtual false final false
...
/// @brief Method GetIndexBySpot addr 0x213eefc size 0x84 virtual false final false
 int32_t GetIndexBySpot(GlobalNamespace::IMultiplayerSpectatingSpot spectatingSpot) ;

/// @brief Method UpdateIndexBySpotDictionary addr 0x213ecd4 size 0x174 virtual false final false
 void UpdateIndexBySpotDictionary() ;

/// @brief Method SpotOnHasBeenRemoved addr 0x213ef80 size 0x120 virtual false final false
...
/// @brief Method .ctor addr 0x213f0a0 size 0xc0 virtual false final false
 void _ctor() ;
