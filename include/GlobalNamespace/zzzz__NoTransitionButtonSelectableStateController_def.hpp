...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13693)), TypeDefinitionIndex(TypeDefinitionIndex(5565)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5565), inst: 4814 })}
...
/// @brief Method OnEnable addr 0x21632a4 size 0xa4 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2163400 size 0x8c virtual false final false
 void OnDisable() ;

/// @brief Method HandleNoTransitionButtonSelectionStateDidChange addr 0x216348c size 0x8 virtual false final false
 void HandleNoTransitionButtonSelectionStateDidChange(HMUI::HMUI__NoTransitionsButton__SelectionState state) ;

/// @brief Method ResolveSelectionState addr 0x2163348 size 0xb8 virtual false final false
...
/// @brief Method .ctor addr 0x2163494 size 0x48 virtual false final false
 void _ctor() ;
