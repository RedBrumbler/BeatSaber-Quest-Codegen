...
/// @brief Method add_didFinishEvent addr 0x21564f0 size 0x9c virtual false final false
 void add_didFinishEvent(System::Action value) ;

/// @brief Method remove_didFinishEvent addr 0x2156878 size 0x9c virtual false final false
 void remove_didFinishEvent(System::Action value) ;

/// @brief Method add_didChangeColorSchemeEvent addr 0x215658c size 0xb0 virtual false final false
 void add_didChangeColorSchemeEvent(System::Action_1<GlobalNamespace::ColorScheme> value) ;

/// @brief Method remove_didChangeColorSchemeEvent addr 0x2156914 size 0xb0 virtual false final false
 void remove_didChangeColorSchemeEvent(System::Action_1<GlobalNamespace::ColorScheme> value) ;

/// @brief Method SetColorScheme addr 0x2156ffc size 0x18 virtual false final false
 void SetColorScheme(GlobalNamespace::ColorScheme colorScheme) ;

/// @brief Method Start addr 0x2157c18 size 0x278 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2157f60 size 0x1d0 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleColorSchemeColorsToggleGroupSelectedColorDidChange addr 0x21581e0 size 0x74 virtual false final false
 void HandleColorSchemeColorsToggleGroupSelectedColorDidChange(UnityEngine::Color color) ;

/// @brief Method HandleRGBPanelControllerColorDidChange addr 0x2158254 size 0xcc virtual false final false
...
/// @brief Method HandleHSVPanelControllerColorDidChange addr 0x2158320 size 0xcc virtual false final false
...
/// @brief Method HandlePreviousColorPanelControllerColorWasSelected addr 0x21583ec size 0xb4 virtual false final false
 void HandlePreviousColorPanelControllerColorWasSelected(UnityEngine::Color color) ;

// Ctor Parameters []
explicit EditColorSchemeController() ;

/// @brief Method .ctor addr 0x21584a0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Start>b__13_0 addr 0x21584a8 size 0x1c virtual false final false
 void _Start_b__13_0() ;
