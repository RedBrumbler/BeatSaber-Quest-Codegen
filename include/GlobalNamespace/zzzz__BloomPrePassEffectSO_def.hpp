...
/// @brief Method get_textureEffect addr 0x1fcfc1c size 0x4 virtual true final true
 GlobalNamespace::TextureEffectSO get_textureEffect() ;

/// @brief Method get_textureWidth addr 0x1fcfc20 size 0x8 virtual true final true
 int32_t get_textureWidth() ;

/// @brief Method get_textureHeight addr 0x1fcfc28 size 0x8 virtual true final true
 int32_t get_textureHeight() ;

/// @brief Method get_fov addr 0x1fcfc30 size 0x8 virtual true final true
 UnityEngine::Vector2 get_fov() ;

/// @brief Method get_linesWidth addr 0x1fcfc38 size 0x8 virtual true final true
 float_t get_linesWidth() ;

/// @brief Method get_toneMapping addr 0x1fcfc40 size 0x8 virtual true final false
 GlobalNamespace::ToneMapping get_toneMapping() ;

// Ctor Parameters []
explicit BloomPrePassEffectSO() ;

/// @brief Method .ctor addr 0x1fcfc48 size 0x20 virtual false final false
 void _ctor() ;
