...
/// @brief Method get_toggle addr 0x2155660 size 0x8 virtual false final false
 UnityEngine::UI::Toggle get_toggle() ;

/// @brief Method get_color addr 0x2154ee0 size 0x38 virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method set_color addr 0x2154f30 size 0x98 virtual false final false
 void set_color(UnityEngine::Color value) ;

// Ctor Parameters []
explicit ColorSchemeColorToggleController() ;

/// @brief Method .ctor addr 0x2155668 size 0x8 virtual false final false
 void _ctor() ;
