...
/// @brief Method .ctor addr 0x20e3e98 size 0x14 virtual false final false
 void _ctor(float_t solution1) ;

/// @brief Method .ctor addr 0x20e3eac size 0x14 virtual false final false
 void _ctor(float_t solution1, float_t solution2) ;

/// @brief Method .ctor addr 0x20e3ec0 size 0x14 virtual false final false
...
/// @brief Method .ctor addr 0x20de36c size 0x34 virtual false final false
 void _ctor(GlobalNamespace::BezierSpline spline) ;

/// @brief Method EvaluatePosition addr 0x20dc06c size 0x18 virtual false final false
 UnityEngine::Vector3 EvaluatePosition(float_t time) ;

/// @brief Method Evaluate addr 0x20e3428 size 0x14c virtual false final false
 UnityEngine::Vector3 Evaluate(float_t t) ;

/// @brief Method EvaluateFirstDerivation addr 0x20e3574 size 0x15c virtual false final false
 UnityEngine::Vector3 EvaluateFirstDerivation(float_t t) ;

/// @brief Method EvaluateSecondDerivation addr 0x20e36d0 size 0x14c virtual false final false
 UnityEngine::Vector3 EvaluateSecondDerivation(float_t t) ;

/// @brief Method OffsetSegmentAndGetT addr 0x20e32d8 size 0x150 virtual false final false
 float_t OffsetSegmentAndGetT(float_t time) ;

/// @brief Method GetTForSegment addr 0x20e393c size 0x14c virtual false final false
 float_t GetTForSegment(int32_t segmentIndex, float_t time) ;

/// @brief Method GetTimeValuesForSegment addr 0x20e3dac size 0xb8 virtual false final false
 void GetTimeValuesForSegment(int32_t segmentIndex, ByRef<float_t> t0Value, ByRef<float_t> t1Value) ;

/// @brief Method OffsetStartIndexToDistance addr 0x20e381c size 0x120 virtual false final false
 void OffsetStartIndexToDistance(float_t time) ;

/// @brief Method CubeRoot addr 0x20e3e64 size 0x34 virtual false final false
static float_t CubeRoot(float_t x) ;

/// @brief Method SolveCubic addr 0x20e3a88 size 0x324 virtual false final false
