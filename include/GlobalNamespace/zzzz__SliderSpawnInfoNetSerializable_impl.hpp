...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::SliderSpawnInfoNetSerializable (*)()>(&GlobalNamespace::SliderSpawnInfoNetSerializable::Obtain)> {
  ...
  constexpr static std::size_t addrs = 0x1228cb0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::SliderSpawnInfoNetSerializable (GlobalNamespace::SliderSpawnInfoNetSerializable::*)(GlobalNamespace::ColorType, GlobalNamespace::GlobalNamespace__SliderData__Type, bool, float_t, int32_t, GlobalNamespace::NoteLineLayer, GlobalNamespace::NoteLineLayer, float_t, GlobalNamespace::NoteCutDirection, float_t, bool, float_t, int32_t, GlobalNamespace::NoteLineLayer, GlobalNamespace::NoteLineLayer, float_t, GlobalNamespace::NoteCutDirection, float_t, GlobalNamespace::SliderMidAnchorMode, int32_t, float_t, UnityEngine::Vector3, UnityEngine::Vector3, UnityEngine::Vector3, float_t, UnityEngine::Vector3, UnityEngine::Vector3, UnityEngine::Vector3, float_t, float_t, float_t, float_t)>(&GlobalNamespace::SliderSpawnInfoNetSerializable::Init)> {
  constexpr static std::size_t size = 0x244;
  constexpr static std::size_t addrs = 0x1228d14;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::SliderSpawnInfoNetSerializable::*)()>(&GlobalNamespace::SliderSpawnInfoNetSerializable::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x1228f58;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::SliderSpawnInfoNetSerializable::*)(LiteNetLib::Utils::NetDataWriter)>(&GlobalNamespace::SliderSpawnInfoNetSerializable::Serialize)> {
  ...
  constexpr static std::size_t addrs = 0x1228fb0;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(GlobalNamespace::SliderSpawnInfoNetSerializable),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::SliderSpawnInfoNetSerializable>::get(),
                                  10
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::SliderSpawnInfoNetSerializable::*)(LiteNetLib::Utils::NetDataReader)>(&GlobalNamespace::SliderSpawnInfoNetSerializable::Deserialize)> {
  ...
  constexpr static std::size_t addrs = 0x12291e8;
...
constexpr GlobalNamespace::ColorType GlobalNamespace::SliderSpawnInfoNetSerializable::__get_colorType() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::ColorType, 0x14>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::SliderSpawnInfoNetSerializable::__set_sliderType(GlobalNamespace::GlobalNamespace__SliderData__Type value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__SliderData__Type, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__SliderData__Type>(value));
}
constexpr GlobalNamespace::GlobalNamespace__SliderData__Type GlobalNamespace::SliderSpawnInfoNetSerializable::__get_sliderType() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__SliderData__Type, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr bool GlobalNamespace::SliderSpawnInfoNetSerializable::__get_hasHeadNote() const {
...
constexpr float_t GlobalNamespace::SliderSpawnInfoNetSerializable::__get_headTime() const {
...
constexpr int32_t GlobalNamespace::SliderSpawnInfoNetSerializable::__get_headLineIndex() const {
...
::cordl_internals::setInstanceField<GlobalNamespace::NoteLineLayer, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::NoteLineLayer>(value));
}
constexpr GlobalNamespace::NoteLineLayer GlobalNamespace::SliderSpawnInfoNetSerializable::__get_headLineLayer() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::NoteLineLayer, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
::cordl_internals::setInstanceField<GlobalNamespace::NoteLineLayer, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::NoteLineLayer>(value));
}
constexpr GlobalNamespace::NoteLineLayer GlobalNamespace::SliderSpawnInfoNetSerializable::__get_headBeforeJumpLineLayer() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::NoteLineLayer, 0x2c>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr float_t GlobalNamespace::SliderSpawnInfoNetSerializable::__get_headControlPointLengthMultiplier() const {
...
::cordl_internals::setInstanceField<GlobalNamespace::NoteCutDirection, 0x34>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::NoteCutDirection>(value));
}
constexpr GlobalNamespace::NoteCutDirection GlobalNamespace::SliderSpawnInfoNetSerializable::__get_headCutDirection() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::NoteCutDirection, 0x34>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr float_t GlobalNamespace::SliderSpawnInfoNetSerializable::__get_headCutDirectionAngleOffset() const {
...
constexpr bool GlobalNamespace::SliderSpawnInfoNetSerializable::__get_hasTailNote() const {
...
constexpr float_t GlobalNamespace::SliderSpawnInfoNetSerializable::__get_tailTime() const {
...
constexpr int32_t GlobalNamespace::SliderSpawnInfoNetSerializable::__get_tailLineIndex() const {
...
::cordl_internals::setInstanceField<GlobalNamespace::NoteLineLayer, 0x48>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::NoteLineLayer>(value));
}
constexpr GlobalNamespace::NoteLineLayer GlobalNamespace::SliderSpawnInfoNetSerializable::__get_tailLineLayer() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::NoteLineLayer, 0x48>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
::cordl_internals::setInstanceField<GlobalNamespace::NoteLineLayer, 0x4c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::NoteLineLayer>(value));
}
constexpr GlobalNamespace::NoteLineLayer GlobalNamespace::SliderSpawnInfoNetSerializable::__get_tailBeforeJumpLineLayer() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::NoteLineLayer, 0x4c>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr float_t GlobalNamespace::SliderSpawnInfoNetSerializable::__get_tailControlPointLengthMultiplier() const {
...
::cordl_internals::setInstanceField<GlobalNamespace::NoteCutDirection, 0x54>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::NoteCutDirection>(value));
}
constexpr GlobalNamespace::NoteCutDirection GlobalNamespace::SliderSpawnInfoNetSerializable::__get_tailCutDirection() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::NoteCutDirection, 0x54>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr float_t GlobalNamespace::SliderSpawnInfoNetSerializable::__get_tailCutDirectionAngleOffset() const {
...
::cordl_internals::setInstanceField<GlobalNamespace::SliderMidAnchorMode, 0x5c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::SliderMidAnchorMode>(value));
}
constexpr GlobalNamespace::SliderMidAnchorMode GlobalNamespace::SliderSpawnInfoNetSerializable::__get_midAnchorMode() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::SliderMidAnchorMode, 0x5c>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr int32_t GlobalNamespace::SliderSpawnInfoNetSerializable::__get_sliceCount() const {
...
constexpr float_t GlobalNamespace::SliderSpawnInfoNetSerializable::__get_squishAmount() const {
...
::cordl_internals::setInstanceField<GlobalNamespace::Vector3Serializable, 0x68>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::Vector3Serializable>(value));
}
constexpr GlobalNamespace::Vector3Serializable GlobalNamespace::SliderSpawnInfoNetSerializable::__get_headMoveStartPos() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::Vector3Serializable, 0x68>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
::cordl_internals::setInstanceField<GlobalNamespace::Vector3Serializable, 0x74>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::Vector3Serializable>(value));
}
constexpr GlobalNamespace::Vector3Serializable GlobalNamespace::SliderSpawnInfoNetSerializable::__get_headJumpStartPos() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::Vector3Serializable, 0x74>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
::cordl_internals::setInstanceField<GlobalNamespace::Vector3Serializable, 0x80>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::Vector3Serializable>(value));
}
constexpr GlobalNamespace::Vector3Serializable GlobalNamespace::SliderSpawnInfoNetSerializable::__get_headJumpEndPos() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::Vector3Serializable, 0x80>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr float_t GlobalNamespace::SliderSpawnInfoNetSerializable::__get_headJumpGravity() const {
...
::cordl_internals::setInstanceField<GlobalNamespace::Vector3Serializable, 0x90>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::Vector3Serializable>(value));
}
constexpr GlobalNamespace::Vector3Serializable GlobalNamespace::SliderSpawnInfoNetSerializable::__get_tailMoveStartPos() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::Vector3Serializable, 0x90>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
::cordl_internals::setInstanceField<GlobalNamespace::Vector3Serializable, 0x9c>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::Vector3Serializable>(value));
}
constexpr GlobalNamespace::Vector3Serializable GlobalNamespace::SliderSpawnInfoNetSerializable::__get_tailJumpStartPos() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::Vector3Serializable, 0x9c>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
::cordl_internals::setInstanceField<GlobalNamespace::Vector3Serializable, 0xa8>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::Vector3Serializable>(value));
}
constexpr GlobalNamespace::Vector3Serializable GlobalNamespace::SliderSpawnInfoNetSerializable::__get_tailJumpEndPos() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::Vector3Serializable, 0xa8>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr float_t GlobalNamespace::SliderSpawnInfoNetSerializable::__get_tailJumpGravity() const {
...
constexpr float_t GlobalNamespace::SliderSpawnInfoNetSerializable::__get_moveDuration() const {
...
constexpr float_t GlobalNamespace::SliderSpawnInfoNetSerializable::__get_jumpDuration() const {
...
constexpr float_t GlobalNamespace::SliderSpawnInfoNetSerializable::__get_rotation() const {
