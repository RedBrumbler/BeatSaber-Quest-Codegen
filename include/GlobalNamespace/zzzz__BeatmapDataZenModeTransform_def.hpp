...
/// @brief Method CreateTransformedData addr 0x21f19bc size 0xec virtual false final false
static GlobalNamespace::IReadonlyBeatmapData CreateTransformedData(GlobalNamespace::IReadonlyBeatmapData beatmapData) ;

/// @brief Method <CreateTransformedData>g__ProcessData|0_0 addr 0x21f1d14 size 0xb0 virtual false final false
