...
/// @brief Method SerializedName addr 0xd9fcfc size 0xa4 virtual false final false
static ::StringW SerializedName(GlobalNamespace::BeatmapDifficulty difficulty) ;

/// @brief Method BeatmapDifficultyFromSerializedName addr 0xd9fda0 size 0x164 virtual false final false
