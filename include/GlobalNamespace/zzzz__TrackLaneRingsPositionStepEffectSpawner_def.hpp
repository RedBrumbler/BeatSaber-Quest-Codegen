...
/// @brief Method Start addr 0x22a6d70 size 0x124 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x22a6e94 size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleBeatmapEvent addr 0x22a6eb0 size 0x78 virtual false final false
 void HandleBeatmapEvent(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

// Ctor Parameters []
explicit TrackLaneRingsPositionStepEffectSpawner() ;

/// @brief Method .ctor addr 0x22a6f28 size 0x1c virtual false final false
 void _ctor() ;
