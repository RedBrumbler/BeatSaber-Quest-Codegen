...
/// @brief Method get_id addr 0x22456b0 size 0x8 virtual false final false
 uint64_t get_id() ;

/// @brief Method get_userId addr 0x22456b8 size 0x8 virtual true final true
 ::StringW get_userId() ;

/// @brief Method get_userName addr 0x22456c0 size 0x8 virtual true final true
 ::StringW get_userName() ;

/// @brief Method get_isConnectionOwner addr 0x22456c8 size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0x22456d0 size 0xac virtual false final false
 void _ctor(uint64_t id, ::StringW userName, bool isConnectionOwner) ;

/// @brief Method Send addr 0x224577c size 0x144 virtual true final true
 void Send(LiteNetLib::Utils::NetDataWriter writer, BGNet::Core::DeliveryMethod deliveryMethod) ;

/// @brief Method Disconnect addr 0x22458c0 size 0xc virtual true final true
 void Disconnect() ;

/// @brief Method Equals addr 0x22458cc size 0x30 virtual true final true
 bool Equals(GlobalNamespace::GlobalNamespace__OculusConnectionManager__OculusConnection other) ;

/// @brief Method Equals addr 0x22458fc size 0x110 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2245a0c size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2245a2c size 0x88 virtual true final false
 ::StringW ToString() ;
...
/// @brief Method .ctor addr 0x2245ab4 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2245abc size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method MoveNext addr 0x2245ac4 size 0x2e4 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2245f7c size 0xc virtual true final true
...
/// @brief Method add_onInitializedEvent addr 0x2243028 size 0x9c virtual true final true
 void add_onInitializedEvent(System::Action value) ;

/// @brief Method remove_onInitializedEvent addr 0x22430c4 size 0x9c virtual true final true
 void remove_onInitializedEvent(System::Action value) ;

/// @brief Method add_onConnectedEvent addr 0x2243160 size 0x9c virtual true final true
 void add_onConnectedEvent(System::Action value) ;

/// @brief Method remove_onConnectedEvent addr 0x22431fc size 0x9c virtual true final true
 void remove_onConnectedEvent(System::Action value) ;

/// @brief Method add_onDisconnectedEvent addr 0x2243298 size 0xb0 virtual true final true
 void add_onDisconnectedEvent(System::Action_1<GlobalNamespace::DisconnectedReason> value) ;

/// @brief Method remove_onDisconnectedEvent addr 0x2243348 size 0xb0 virtual true final true
 void remove_onDisconnectedEvent(System::Action_1<GlobalNamespace::DisconnectedReason> value) ;

/// @brief Method add_onConnectionFailedEvent addr 0x22433f8 size 0xb0 virtual true final true
 void add_onConnectionFailedEvent(System::Action_1<GlobalNamespace::ConnectionFailedReason> value) ;

/// @brief Method remove_onConnectionFailedEvent addr 0x22434a8 size 0xb0 virtual true final true
 void remove_onConnectionFailedEvent(System::Action_1<GlobalNamespace::ConnectionFailedReason> value) ;

/// @brief Method add_onConnectionConnectedEvent addr 0x2243558 size 0xb0 virtual true final true
 void add_onConnectionConnectedEvent(System::Action_1<GlobalNamespace::IConnection> value) ;

/// @brief Method remove_onConnectionConnectedEvent addr 0x2243608 size 0xb0 virtual true final true
 void remove_onConnectionConnectedEvent(System::Action_1<GlobalNamespace::IConnection> value) ;

/// @brief Method add_onConnectionDisconnectedEvent addr 0x22436b8 size 0xb0 virtual true final true
...
/// @brief Method remove_onConnectionDisconnectedEvent addr 0x2243768 size 0xb0 virtual true final true
...
/// @brief Method add_onReceivedDataEvent addr 0x2243818 size 0xb0 virtual true final true
...
/// @brief Method remove_onReceivedDataEvent addr 0x22438c8 size 0xb0 virtual true final true
...
/// @brief Method get_userId addr 0x2243978 size 0xa8 virtual true final true
 ::StringW get_userId() ;

/// @brief Method get_userName addr 0x2243a20 size 0xac virtual true final true
 ::StringW get_userName() ;

/// @brief Method get_isConnected addr 0x2243acc size 0x34 virtual true final true
 bool get_isConnected() ;

/// @brief Method get_isConnecting addr 0x2243b00 size 0x24 virtual true final true
 bool get_isConnecting() ;

/// @brief Method get_isDisconnecting addr 0x2243b24 size 0x8 virtual true final true
 bool get_isDisconnecting() ;

/// @brief Method set_isDisconnecting addr 0x2243b2c size 0xc virtual false final false
 void set_isDisconnecting(bool value) ;

/// @brief Method get_isDisposed addr 0x2243b38 size 0x10 virtual true final true
 bool get_isDisposed() ;

/// @brief Method get_isConnectionOwner addr 0x2243b48 size 0x10 virtual true final true
 bool get_isConnectionOwner() ;

/// @brief Method get_isServer addr 0x2243b58 size 0x10 virtual false final false
 bool get_isServer() ;

/// @brief Method get_isClient addr 0x2243b68 size 0x10 virtual false final false
 bool get_isClient() ;

/// @brief Method get_connectionCount addr 0x2243b78 size 0x48 virtual true final true
 int32_t get_connectionCount() ;

/// @brief Method SendToAll addr 0x2243bc0 size 0x8 virtual true final true
 void SendToAll(LiteNetLib::Utils::NetDataWriter writer, BGNet::Core::DeliveryMethod deliveryMethod) ;

/// @brief Method SendToAll addr 0x2243bc8 size 0xd4 virtual true final true
...
/// @brief Method PollUpdate addr 0x2243c9c size 0xf8 virtual true final true
 void PollUpdate() ;
...
/// @brief Method Disconnect addr 0x2243fc8 size 0x8 virtual true final true
 void Disconnect(GlobalNamespace::DisconnectedReason disconnectedReason) ;

/// @brief Method DisconnectInternal addr 0x2243fd0 size 0x22c virtual false final false
...
/// @brief Method Dispose addr 0x22441fc size 0xc virtual true final true
 void Dispose() ;

/// @brief Method DisposeAsync addr 0x2244208 size 0x9c virtual true final true
 System::Threading::Tasks::Task DisposeAsync() ;

/// @brief Method GetConnection addr 0x22442a4 size 0x58 virtual true final true
 GlobalNamespace::IConnection GetConnection(int32_t index) ;

/// @brief Method HandlePeerConnectionRequest addr 0x22442fc size 0x9c virtual false final false
 void HandlePeerConnectionRequest(Oculus::Platform::Message_1<Oculus::Platform::Models::NetworkingPeer> message) ;

/// @brief Method HandleConnectionStateChanged addr 0x2244398 size 0x100 virtual false final false
 void HandleConnectionStateChanged(Oculus::Platform::Message_1<Oculus::Platform::Models::NetworkingPeer> message) ;

/// @brief Method GetConnection addr 0x2243d94 size 0x1b8 virtual false final false
 GlobalNamespace::GlobalNamespace__OculusConnectionManager__OculusConnection GetConnection(uint64_t user) ;

/// @brief Method RemoveConnection addr 0x2244498 size 0x134 virtual false final false
 void RemoveConnection(uint64_t id, GlobalNamespace::DisconnectedReason reason) ;

/// @brief Method AcquireBuffer addr 0x2243f4c size 0x6c virtual false final false
 ::ArrayW<uint8_t> AcquireBuffer(int32_t size) ;

/// @brief Method ReleaseBuffer addr 0x2243fc4 size 0x4 virtual false final false
 void ReleaseBuffer(::ArrayW<uint8_t> buffer) ;

/// @brief Method DeliveryMethodToSendPolicy addr 0x22445cc size 0x10 virtual false final false
static Oculus::Platform::SendPolicy DeliveryMethodToSendPolicy(BGNet::Core::DeliveryMethod deliveryMethod) ;

/// @brief Method SendPolicyToDeliveryMethod addr 0x2243fb8 size 0xc virtual false final false
static BGNet::Core::DeliveryMethod SendPolicyToDeliveryMethod(Oculus::Platform::SendPolicy sendPolicy) ;

/// @brief Method VoidHandler addr 0x22445dc size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x22445e0 size 0x10d0 virtual false final false
 void _ctor() ;
