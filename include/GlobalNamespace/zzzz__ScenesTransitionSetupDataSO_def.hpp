...
/// @brief Method MoveNext addr 0x1fbe3a0 size 0x250 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x1fbe5f0 size 0xc virtual true final true
...
/// @brief Method MoveNext addr 0x1fbe5fc size 0x180 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x1fbe77c size 0xc virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method get_scenes addr 0x1fbe22c size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::SceneInfo> get_scenes() ;

/// @brief Method set_scenes addr 0x1fbe234 size 0x8 virtual false final false
 void set_scenes(::ArrayW<GlobalNamespace::SceneInfo> value) ;

/// @brief Method get_beforeScenesWillBeActivatedTaskIsComplete addr 0x1fbe23c size 0x8 virtual false final false
 bool get_beforeScenesWillBeActivatedTaskIsComplete() ;

/// @brief Method set_beforeScenesWillBeActivatedTaskIsComplete addr 0x1fbe244 size 0xc virtual false final false
 void set_beforeScenesWillBeActivatedTaskIsComplete(bool value) ;

/// @brief Method Init addr 0x1fbe108 size 0xc virtual false final false
 void Init(::ArrayW<GlobalNamespace::SceneInfo> scenes, ::ArrayW<GlobalNamespace::SceneSetupData> sceneSetupData) ;

/// @brief Method BeforeScenesWillBeActivated addr 0x1fbdeec size 0xa0 virtual false final false
 void BeforeScenesWillBeActivated(bool runAsync) ;

/// @brief Method BeforeScenesWillBeActivatedAsync addr 0x1fbe250 size 0x88 virtual true final false
 System::Threading::Tasks::Task BeforeScenesWillBeActivatedAsync() ;

/// @brief Method InstallBindings addr 0x1fbc714 size 0x12c virtual false final false
 void InstallBindings(Zenject::DiContainer container) ;

// Ctor Parameters []
explicit ScenesTransitionSetupDataSO() ;

/// @brief Method .ctor addr 0x1fbe11c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <BeforeScenesWillBeActivated>b__10_0 addr 0x1fbe2d8 size 0xc8 virtual false final false
