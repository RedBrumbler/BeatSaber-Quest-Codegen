...
/// @brief Method CreateMultiplayerAvatarData addr 0x226244c size 0x1710 virtual false final false
static GlobalNamespace::MultiplayerAvatarData CreateMultiplayerAvatarData(GlobalNamespace::AvatarData avatarData) ;

/// @brief Method CreateAvatarData addr 0x2263b5c size 0x300 virtual false final false
