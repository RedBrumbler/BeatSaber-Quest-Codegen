...
/// @brief Method get_color addr 0x1fdab64 size 0x5c virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method Awake addr 0x1fdabc0 size 0x78 virtual false final false
 void Awake() ;

/// @brief Method ColorWasSet addr 0x1fdac38 size 0x464 virtual true final false
 void ColorWasSet(UnityEngine::Color color) ;

// Ctor Parameters []
explicit ParticleSystemLightWithId() ;

/// @brief Method .ctor addr 0x1fdb09c size 0x18 virtual false final false
 void _ctor() ;
