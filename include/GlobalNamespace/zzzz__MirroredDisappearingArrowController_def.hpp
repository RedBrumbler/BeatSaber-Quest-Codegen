...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4861)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4861), inst: 332 }), TypeDefinitionIndex(TypeDefinitionIndex(4874))}
...
/// @brief Method get_gameNoteController addr 0x2276e48 size 0x8 virtual true final false
 GlobalNamespace::MirroredGameNoteController get_gameNoteController() ;

// Ctor Parameters []
explicit MirroredDisappearingArrowController() ;

/// @brief Method .ctor addr 0x2276e50 size 0x6c virtual false final false
 void _ctor() ;
