...
/// @brief Method get_SampleRateHz addr 0x25e9988 size 0x58 virtual false final false
static int32_t get_SampleRateHz() ;

/// @brief Method set_SampleRateHz addr 0x25e99e0 size 0x5c virtual false final false
static void set_SampleRateHz(int32_t value) ;

/// @brief Method get_SampleSizeInBytes addr 0x25e9a3c size 0x58 virtual false final false
static int32_t get_SampleSizeInBytes() ;

/// @brief Method set_SampleSizeInBytes addr 0x25e9a94 size 0x5c virtual false final false
static void set_SampleSizeInBytes(int32_t value) ;

/// @brief Method get_MinimumSafeSamplesQueued addr 0x25e9af0 size 0x58 virtual false final false
static int32_t get_MinimumSafeSamplesQueued() ;

/// @brief Method set_MinimumSafeSamplesQueued addr 0x25e9b48 size 0x5c virtual false final false
static void set_MinimumSafeSamplesQueued(int32_t value) ;

/// @brief Method get_MinimumBufferSamplesCount addr 0x25e9ba4 size 0x58 virtual false final false
static int32_t get_MinimumBufferSamplesCount() ;

/// @brief Method set_MinimumBufferSamplesCount addr 0x25e9bfc size 0x5c virtual false final false
static void set_MinimumBufferSamplesCount(int32_t value) ;

/// @brief Method get_OptimalBufferSamplesCount addr 0x25e9c58 size 0x58 virtual false final false
static int32_t get_OptimalBufferSamplesCount() ;

/// @brief Method set_OptimalBufferSamplesCount addr 0x25e9cb0 size 0x5c virtual false final false
static void set_OptimalBufferSamplesCount(int32_t value) ;

/// @brief Method get_MaximumBufferSamplesCount addr 0x25e9d0c size 0x58 virtual false final false
static int32_t get_MaximumBufferSamplesCount() ;

/// @brief Method set_MaximumBufferSamplesCount addr 0x25e9d64 size 0x5c virtual false final false
static void set_MaximumBufferSamplesCount(int32_t value) ;

/// @brief Method Load addr 0x25e8a04 size 0x200 virtual false final false
static void Load() ;
...
/// @brief Method .ctor addr 0x25e8da8 size 0x98 virtual false final false
 void _ctor(uint32_t outputIndex) ;

/// @brief Method Preempt addr 0x25e9dc4 size 0x18 virtual false final false
 void Preempt(GlobalNamespace::OVRHapticsClip clip) ;

/// @brief Method Queue addr 0x25e9efc size 0x18 virtual false final false
 void Queue(GlobalNamespace::OVRHapticsClip clip) ;

/// @brief Method Mix addr 0x25e9ffc size 0x18 virtual false final false
 void Mix(GlobalNamespace::OVRHapticsClip clip) ;

/// @brief Method Clear addr 0x25ea4cc size 0x18 virtual false final false
 void Clear() ;
...
/// @brief Method get_ReadCount addr 0x25ea884 size 0x8 virtual false final false
 int32_t get_ReadCount() ;

/// @brief Method set_ReadCount addr 0x25ea88c size 0x8 virtual false final false
 void set_ReadCount(int32_t value) ;

/// @brief Method get_Clip addr 0x25ea894 size 0x8 virtual false final false
 GlobalNamespace::OVRHapticsClip get_Clip() ;

/// @brief Method set_Clip addr 0x25ea89c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x25ea654 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x25e8c04 size 0x1a4 virtual false final false
 void _ctor(uint32_t controller) ;

/// @brief Method Process addr 0x25e8f1c size 0xa6c virtual false final false
 void Process() ;

/// @brief Method Preempt addr 0x25e9ddc size 0x120 virtual false final false
 void Preempt(GlobalNamespace::OVRHapticsClip clip) ;

/// @brief Method Queue addr 0x25e9f14 size 0xe8 virtual false final false
 void Queue(GlobalNamespace::OVRHapticsClip clip) ;

/// @brief Method Mix addr 0x25ea014 size 0x4b8 virtual false final false
 void Mix(GlobalNamespace::OVRHapticsClip clip) ;

/// @brief Method Clear addr 0x25ea4e4 size 0x70 virtual false final false
 void Clear() ;
...
/// @brief Method Process addr 0x25e8e40 size 0xdc virtual false final false
static void Process() ;
