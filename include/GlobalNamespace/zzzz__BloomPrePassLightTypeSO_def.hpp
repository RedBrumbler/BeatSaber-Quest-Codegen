...
/// @brief Method get_renderingPriority addr 0x1fd04a8 size 0x8 virtual false final false
 int32_t get_renderingPriority() ;

/// @brief Method get_material addr 0x1fd04b0 size 0x8 virtual false final false
 UnityEngine::Material get_material() ;

// Ctor Parameters []
explicit BloomPrePassLightTypeSO() ;

/// @brief Method .ctor addr 0x1fd04b8 size 0x8 virtual false final false
 void _ctor() ;
