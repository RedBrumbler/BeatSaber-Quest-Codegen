...
/// @brief Method .ctor addr 0x213b2c8 size 0x8 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11011)), TypeDefinitionIndex(TypeDefinitionIndex(5347)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 2722 })}
...
/// @brief Method .ctor addr 0x213b2d0 size 0x48 virtual false final false
 void _ctor() ;
