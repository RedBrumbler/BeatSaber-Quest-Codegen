...
namespace GlobalNamespace {
struct GlobalNamespace__BeatmapLevelFilterModel___GetAllBeatmapLevelsAsync_d__3;
}
...
/// @brief Method .ctor addr 0x221b904 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <FilerBeatmapLevelPackCollectionAsync>b__0 addr 0x221b90c size 0x748 virtual false final false
...
/// @brief Method MoveNext addr 0x221c054 size 0x454 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x221c4a8 size 0x58 virtual true final true
...
// Type: ::<GetAllBeatmapLevelsAsync>d__3
namespace GlobalNamespace {
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2638))}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(4368))
// CS Name: BeatmapLevelFilterModel::<GetAllBeatmapLevelsAsync>d__3
struct CORDL_TYPE GlobalNamespace__BeatmapLevelFilterModel___GetAllBeatmapLevelsAsync_d__3 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  System::Runtime::CompilerServices::IAsyncStateMachine() const;
...
constexpr GlobalNamespace__BeatmapLevelFilterModel___GetAllBeatmapLevelsAsync_d__3(int32_t __1__state, System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<System::Collections::Generic::List_1<GlobalNamespace::IPreviewBeatmapLevel>> __t__builder, ::ArrayW<GlobalNamespace::IBeatmapLevelPack> beatmapLevelPacks, GlobalNamespace::SongPackMask songPackMask, bool onlyOwned, GlobalNamespace::AdditionalContentModel additionalContentModel, System::Threading::CancellationToken cancellationToken, bool onlyNotOwned, System::Collections::Generic::List_1<GlobalNamespace::IPreviewBeatmapLevel> _levels_5__2, ::ArrayW<GlobalNamespace::IBeatmapLevelPack> __7__wrap2, int32_t __7__wrap3, System::Collections::Generic::IEnumerator_1<GlobalNamespace::IPreviewBeatmapLevel> __7__wrap4, GlobalNamespace::IPreviewBeatmapLevel _beatmapLevel_5__6, System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::GlobalNamespace__AdditionalContentModel__EntitlementStatus> __u__1) noexcept;


                    constexpr GlobalNamespace__BeatmapLevelFilterModel___GetAllBeatmapLevelsAsync_d__3(GlobalNamespace__BeatmapLevelFilterModel___GetAllBeatmapLevelsAsync_d__3 const&) = default;
                    constexpr GlobalNamespace__BeatmapLevelFilterModel___GetAllBeatmapLevelsAsync_d__3(GlobalNamespace__BeatmapLevelFilterModel___GetAllBeatmapLevelsAsync_d__3&&) = default;
                    constexpr GlobalNamespace__BeatmapLevelFilterModel___GetAllBeatmapLevelsAsync_d__3& operator=(GlobalNamespace__BeatmapLevelFilterModel___GetAllBeatmapLevelsAsync_d__3 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__BeatmapLevelFilterModel___GetAllBeatmapLevelsAsync_d__3& operator=(GlobalNamespace__BeatmapLevelFilterModel___GetAllBeatmapLevelsAsync_d__3&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__BeatmapLevelFilterModel___GetAllBeatmapLevelsAsync_d__3(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
/// @brief Method MoveNext addr 0x221c500 size 0x98c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x221ce8c size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
public:
// Declarations
using _GetAllBeatmapLevelsAsync_d__3 = GlobalNamespace::GlobalNamespace__BeatmapLevelFilterModel___GetAllBeatmapLevelsAsync_d__3;
...
/// @brief Method FilerBeatmapLevelPackCollectionAsync addr 0x221aedc size 0x120 virtual false final false
...
/// @brief Method SearchWithCache addr 0x221affc size 0xf0 virtual false final false
static System::Collections::Generic::List_1<GlobalNamespace::IPreviewBeatmapLevel> SearchWithCache(System::Collections::Generic::List_1<GlobalNamespace::IPreviewBeatmapLevel> levels, ::StringW searchText, GlobalNamespace::LevelFilterParams levelFilterParams) ;

/// @brief Method FindMatchingSongNames addr 0x221b0ec size 0x9c virtual false final false
static System::Collections::Generic::List_1<GlobalNamespace::IPreviewBeatmapLevel> FindMatchingSongNames(System::Collections::Generic::IEnumerable_1<GlobalNamespace::IPreviewBeatmapLevel> beatmapLevels, ::StringW searchTerm) ;

/// @brief Method GetAllBeatmapLevelsAsync addr 0x221b7d0 size 0x134 virtual false final false
...
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__BeatmapLevelFilterModel___GetAllBeatmapLevelsAsync_d__3, "", "BeatmapLevelFilterModel/<GetAllBeatmapLevelsAsync>d__3");
