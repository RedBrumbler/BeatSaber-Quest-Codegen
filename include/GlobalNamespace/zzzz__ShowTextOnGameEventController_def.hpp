...
/// @brief Method Init addr 0x2141664 size 0x9c virtual false final false
 void Init(GlobalNamespace::TextFadeTransitions textFadeTransitions) ;

/// @brief Method Deinit addr 0x214175c size 0x8c virtual false final false
 void Deinit() ;

/// @brief Method HandleGameEvent addr 0x21417f0 size 0x2c virtual false final false
 void HandleGameEvent() ;

// Ctor Parameters []
explicit GlobalNamespace__ShowTextOnGameEventController__EventTextBinding() ;

/// @brief Method .ctor addr 0x2141890 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Awake addr 0x2141600 size 0x64 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x2141700 size 0x5c virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit ShowTextOnGameEventController() ;

/// @brief Method .ctor addr 0x21417e8 size 0x8 virtual false final false
 void _ctor() ;
