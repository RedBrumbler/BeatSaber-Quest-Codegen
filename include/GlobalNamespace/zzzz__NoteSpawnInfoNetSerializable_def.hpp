...
/// @brief Method Obtain addr 0x12249bc size 0x64 virtual false final false
static GlobalNamespace::NoteSpawnInfoNetSerializable Obtain() ;

/// @brief Method Init addr 0x1224a20 size 0x140 virtual false final false
...
/// @brief Method .ctor addr 0x1224b60 size 0x58 virtual false final false
 void _ctor() ;

/// @brief Method Serialize addr 0x1224bb8 size 0x1a4 virtual true final false
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0x1224d5c size 0x1b4 virtual true final false
