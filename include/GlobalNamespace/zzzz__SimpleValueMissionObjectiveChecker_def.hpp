...
/// @brief Method CheckAndUpdateStatus addr 0x210d5e0 size 0x104 virtual false final false
 void CheckAndUpdateStatus() ;

// Ctor Parameters []
explicit SimpleValueMissionObjectiveChecker() ;

/// @brief Method .ctor addr 0x210d6ec size 0x8 virtual false final false
 void _ctor() ;
