...
/// @brief Method get_allowOffhandGrab addr 0x2652030 size 0x8 virtual false final false
 bool get_allowOffhandGrab() ;

/// @brief Method get_isGrabbed addr 0x2652038 size 0x60 virtual false final false
 bool get_isGrabbed() ;

/// @brief Method get_snapPosition addr 0x2652098 size 0x8 virtual false final false
 bool get_snapPosition() ;

/// @brief Method get_snapOrientation addr 0x26520a0 size 0x8 virtual false final false
 bool get_snapOrientation() ;

/// @brief Method get_snapOffset addr 0x26520a8 size 0x8 virtual false final false
 UnityEngine::Transform get_snapOffset() ;

/// @brief Method get_grabbedBy addr 0x26520b0 size 0x8 virtual false final false
 GlobalNamespace::OVRGrabber get_grabbedBy() ;

/// @brief Method get_grabbedTransform addr 0x26520b8 size 0x1c virtual false final false
 UnityEngine::Transform get_grabbedTransform() ;

/// @brief Method get_grabbedRigidbody addr 0x26520d4 size 0x1c virtual false final false
 UnityEngine::Rigidbody get_grabbedRigidbody() ;

/// @brief Method get_grabPoints addr 0x26520f0 size 0x8 virtual false final false
 ::ArrayW<UnityEngine::Collider> get_grabPoints() ;

/// @brief Method GrabBegin addr 0x26520f8 size 0x7c virtual true final false
 void GrabBegin(GlobalNamespace::OVRGrabber hand, UnityEngine::Collider grabPoint) ;

/// @brief Method GrabEnd addr 0x2652174 size 0xd4 virtual true final false
 void GrabEnd(UnityEngine::Vector3 linearVelocity, UnityEngine::Vector3 angularVelocity) ;

/// @brief Method Awake addr 0x2652248 size 0x14c virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x2652394 size 0x64 virtual true final false
 void Start() ;

/// @brief Method OnDestroy addr 0x26523f8 size 0x84 virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit OVRGrabbable() ;

/// @brief Method .ctor addr 0x265252c size 0x10 virtual false final false
 void _ctor() ;
