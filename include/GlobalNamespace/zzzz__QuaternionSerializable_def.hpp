...
/// @brief Method get_identity addr 0x12277f8 size 0x64 virtual false final false
static GlobalNamespace::QuaternionSerializable get_identity() ;

/// @brief Method ToSmallest addr 0x12279c0 size 0x3e8 virtual false final false
static void ToSmallest(UnityEngine::Quaternion q, ByRef<int32_t> sa, ByRef<int32_t> sb, ByRef<int32_t> sc) ;

/// @brief Method FromSmallest addr 0x1227da8 size 0xd0 virtual false final false
static UnityEngine::Quaternion FromSmallest(int32_t sa, int32_t sb, int32_t sc) ;

/// @brief Method Serialize addr 0x122438c size 0x54 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0x12241d0 size 0x64 virtual true final true
 void Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method Equals addr 0x1227e78 size 0x34 virtual true final true
 bool Equals(GlobalNamespace::QuaternionSerializable other) ;

/// @brief Method Equals addr 0x1227eac size 0x98 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Approximately addr 0x1227f44 size 0x80 virtual false final false
 bool Approximately(GlobalNamespace::QuaternionSerializable other) ;

/// @brief Method GetHashCode addr 0x1227fd4 size 0x18 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method GetSize addr 0x1227fec size 0x54 virtual false final false
 int32_t GetSize() ;

/// @brief Method .ctor addr 0x122785c size 0x164 virtual false final false
 void _ctor(UnityEngine::Quaternion q) ;

/// @brief Method .ctor addr 0x1228040 size 0xc virtual false final false
 void _ctor(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method ToString addr 0x122804c size 0x38 virtual true final false
 ::StringW ToString() ;

/// @brief Method op_Implicit addr 0x1227fc4 size 0x10 virtual false final false
static UnityEngine::Quaternion op_Implicit_UnityEngine__Quaternion(GlobalNamespace::QuaternionSerializable q) ;

/// @brief Method op_Implicit addr 0x1224774 size 0x2c virtual false final false
...
/// @brief Method op_Addition addr 0x1228084 size 0x1c virtual false final false
...
/// @brief Method op_Subtraction addr 0x12280a0 size 0x1c virtual false final false
