...
/// @brief Method LateUpdate addr 0x211fa70 size 0x348 virtual false final false
 void LateUpdate() ;

// Ctor Parameters []
explicit MultiplayerLocalInactiveClient() ;

/// @brief Method .ctor addr 0x211fdb8 size 0x8 virtual false final false
 void _ctor() ;
