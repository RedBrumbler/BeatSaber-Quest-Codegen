...
/// @brief Method add_didReceiveDeeplinkEvent addr 0x21f3db0 size 0xb0 virtual true final true
 void add_didReceiveDeeplinkEvent(System::Action_1<GlobalNamespace::Deeplink> value) ;

/// @brief Method remove_didReceiveDeeplinkEvent addr 0x21f3e60 size 0xb0 virtual true final true
 void remove_didReceiveDeeplinkEvent(System::Action_1<GlobalNamespace::Deeplink> value) ;

/// @brief Method get_currentDeeplink addr 0x21f3f10 size 0x8 virtual true final true
 GlobalNamespace::Deeplink get_currentDeeplink() ;

/// @brief Method Init addr 0x21f3f18 size 0x80 virtual false final false
 void Init() ;

/// @brief Method OculusPlatformWasInitialized addr 0x21f3f98 size 0x18 virtual false final false
 void OculusPlatformWasInitialized() ;

/// @brief Method SetJoinIntentReceivedNotificationCallback addr 0x21f3fb0 size 0xb0 virtual false final false
...
/// @brief Method UpdateDeeplinkMessage addr 0x21f40b8 size 0x260 virtual false final false
...
/// @brief Method IsAtLeastOneFieldPopulated addr 0x21f4318 size 0x74 virtual false final false
 bool IsAtLeastOneFieldPopulated(GlobalNamespace::Deeplink deeplink) ;

/// @brief Method Log addr 0x21f4060 size 0x58 virtual false final false
static void Log(::StringW message) ;

// Ctor Parameters []
explicit OculusDeeplinkManager() ;

/// @brief Method .ctor addr 0x21f438c size 0x8 virtual false final false
 void _ctor() ;
