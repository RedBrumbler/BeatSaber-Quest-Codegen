...
/// @brief Method .ctor addr 0x210c510 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x210c670 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x210c674 size 0x4a0 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x210cb14 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x210cb1c size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x210cb5c size 0x8 virtual true final true
...
/// @brief Method add_allResultsCollectedEvent addr 0x210be5c size 0xb0 virtual false final false
...
/// @brief Method remove_allResultsCollectedEvent addr 0x210bf0c size 0xb0 virtual false final false
...
/// @brief Method get_gameResultsReady addr 0x210bfbc size 0x8 virtual false final false
 bool get_gameResultsReady() ;

/// @brief Method get_otherPlayersCompletionResults addr 0x210bfc4 size 0x8 virtual false final false
...
/// @brief Method get_localPlayerResults addr 0x210bfcc size 0x8 virtual false final false
 GlobalNamespace::MultiplayerLevelCompletionResults get_localPlayerResults() ;

/// @brief Method Start addr 0x210bfd4 size 0x260 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x210c234 size 0x268 virtual false final false
 void OnDestroy() ;

/// @brief Method StartLevelFinished addr 0x210c49c size 0x74 virtual false final false
 System::Collections::IEnumerator StartLevelFinished(GlobalNamespace::MultiplayerLevelCompletionResults localPlayerResults) ;

/// @brief Method HandlePlayerDidFinish addr 0x210c538 size 0x20 virtual false final false
 void HandlePlayerDidFinish(GlobalNamespace::MultiplayerLevelCompletionResults levelCompletionResults) ;

/// @brief Method HandlePlayerNetworkDidFailed addr 0x210c558 size 0x34 virtual false final false
 void HandlePlayerNetworkDidFailed(GlobalNamespace::MultiplayerLevelCompletionResults levelCompletionResults) ;

/// @brief Method HandleRpcLevelFinished addr 0x210c58c size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x210c5f4 size 0x7c virtual false final false
 void _ctor() ;
