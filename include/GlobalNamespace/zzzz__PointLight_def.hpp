...
/// @brief Method get_lights addr 0x1fd5154 size 0x58 virtual false final false
static System::Collections::Generic::List_1<GlobalNamespace::PointLight> get_lights() ;

/// @brief Method OnEnable addr 0x1fd51ac size 0xd0 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fd527c size 0x80 virtual false final false
 void OnDisable() ;

// Ctor Parameters []
explicit PointLight() ;

/// @brief Method .ctor addr 0x1fd52fc size 0x8 virtual false final false
 void _ctor() ;
