...
/// @brief Method get_maxCutScore addr 0x2266d10 size 0x1c virtual false final false
 int32_t get_maxCutScore() ;

/// @brief Method get_executionOrder addr 0x2267104 size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0x22670b0 size 0x54 virtual false final false
...
/// @brief Method .ctor addr 0x2266c8c size 0x84 virtual false final false
 void _ctor(GlobalNamespace::GlobalNamespace__NoteData__ScoringType scoringType, float_t time) ;

/// @brief Method CompareTo addr 0x2267120 size 0x90 virtual true final true
...
/// @brief Method GetNoteScoreDefinition addr 0x22661a4 size 0x80 virtual false final false
...
/// @brief Method ComputeMaxMultipliedScoreForBeatmap addr 0x2266224 size 0xa68 virtual false final false
static int32_t ComputeMaxMultipliedScoreForBeatmap(GlobalNamespace::IReadonlyBeatmapData beatmapData) ;

/// @brief Method GetModifiedScoreForGameplayModifiersScoreMultiplier addr 0x2266d2c size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x2266da0 size 0x8 virtual false final false
 void _ctor() ;
