...
/// @brief Method get_icon addr 0x21fff7c size 0x8 virtual false final false
 UnityEngine::Sprite get_icon() ;

/// @brief Method get_descriptionLocalizationKey addr 0x21fff84 size 0x8 virtual false final false
 ::StringW get_descriptionLocalizationKey() ;

/// @brief Method get_characteristicNameLocalizationKey addr 0x21fff8c size 0x8 virtual false final false
 ::StringW get_characteristicNameLocalizationKey() ;

/// @brief Method get_serializedName addr 0x21fff94 size 0x8 virtual false final false
 ::StringW get_serializedName() ;

/// @brief Method get_compoundIdPartName addr 0x21fff9c size 0x8 virtual false final false
 ::StringW get_compoundIdPartName() ;

/// @brief Method get_sortingOrder addr 0x21fffa4 size 0x8 virtual false final false
 int32_t get_sortingOrder() ;

/// @brief Method get_containsRotationEvents addr 0x21fffac size 0x8 virtual false final false
 bool get_containsRotationEvents() ;

/// @brief Method get_requires360Movement addr 0x21fffb4 size 0x8 virtual false final false
 bool get_requires360Movement() ;

/// @brief Method get_numberOfColors addr 0x21fffbc size 0x8 virtual false final false
 int32_t get_numberOfColors() ;

// Ctor Parameters []
explicit BeatmapCharacteristicSO() ;

/// @brief Method .ctor addr 0x21fffc4 size 0x10 virtual false final false
 void _ctor() ;
