...
/// @brief Method set_icon addr 0x1fddda0 size 0x8 virtual false final false
 void set_icon(UnityEngine::UI::Image value) ;

/// @brief Method get_icon addr 0x1fddda8 size 0x8 virtual false final false
 UnityEngine::UI::Image get_icon() ;

/// @brief Method set_text addr 0x1fdddb0 size 0x24 virtual false final false
 void set_text(::StringW value) ;

/// @brief Method get_text addr 0x1fdddd4 size 0x24 virtual false final false
 ::StringW get_text() ;

// Ctor Parameters []
explicit SimpleTextWithIconTableCell() ;

/// @brief Method .ctor addr 0x1fdddf8 size 0x8 virtual false final false
 void _ctor() ;
