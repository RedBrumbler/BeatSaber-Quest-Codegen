...
/// @brief Method .ctor addr 0x22929e8 size 0x28 virtual false final false
...
/// @brief Method SpawnFlyingScore addr 0x2292644 size 0x280 virtual false final false
 void SpawnFlyingScore(GlobalNamespace::IReadonlyCutScoreBuffer cutScoreBuffer, UnityEngine::Color color) ;

/// @brief Method HandleFlyingObjectEffectDidFinish addr 0x22928c4 size 0x11c virtual true final true
 void HandleFlyingObjectEffectDidFinish(GlobalNamespace::FlyingObjectEffect flyingObjectEffect) ;

// Ctor Parameters []
explicit FlyingScoreSpawner() ;

/// @brief Method .ctor addr 0x22929e0 size 0x8 virtual false final false
 void _ctor() ;
