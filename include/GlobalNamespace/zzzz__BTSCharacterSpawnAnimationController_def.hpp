...
/// @brief Method get_isCharacterVisible addr 0x20de9b0 size 0x28 virtual false final false
 bool get_isCharacterVisible() ;

/// @brief Method get_duration addr 0x20de9d8 size 0x38 virtual false final false
 float_t get_duration() ;

/// @brief Method get_characterActivationTrack addr 0x20dea10 size 0x410 virtual false final false
 UnityEngine::Timeline::ActivationTrack get_characterActivationTrack() ;

/// @brief Method PlayAnimation addr 0x20dee20 size 0xcc virtual false final false
 void PlayAnimation() ;

/// @brief Method EndEarlyAnimation addr 0x20deeec size 0x74 virtual false final false
 void EndEarlyAnimation() ;

/// @brief Method StopAnimation addr 0x20def60 size 0x1c virtual false final false
 void StopAnimation() ;

/// @brief Method SetCharacter addr 0x20def7c size 0x94 virtual false final false
 void SetCharacter(GlobalNamespace::BTSCharacter btsCharacter) ;

/// @brief Method WillResumeAnimation addr 0x20df010 size 0x60 virtual false final false
 void WillResumeAnimation() ;

/// @brief Method ResumeAnimation addr 0x20df070 size 0x60 virtual false final false
 void ResumeAnimation() ;

/// @brief Method PauseAnimation addr 0x20df0d0 size 0x9c virtual false final false
 void PauseAnimation() ;

// Ctor Parameters []
explicit BTSCharacterSpawnAnimationController() ;

/// @brief Method .ctor addr 0x20df16c size 0x8 virtual false final false
 void _ctor() ;
