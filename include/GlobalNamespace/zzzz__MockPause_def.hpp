...
/// @brief Method get_isPaused addr 0x2106114 size 0x8 virtual true final true
 bool get_isPaused() ;

/// @brief Method add_didPauseEvent addr 0x210611c size 0x9c virtual true final true
 void add_didPauseEvent(System::Action value) ;

/// @brief Method remove_didPauseEvent addr 0x21061b8 size 0x9c virtual true final true
 void remove_didPauseEvent(System::Action value) ;

/// @brief Method add_willResumeEvent addr 0x2106254 size 0x9c virtual true final true
 void add_willResumeEvent(System::Action value) ;

/// @brief Method remove_willResumeEvent addr 0x21062f0 size 0x9c virtual true final true
 void remove_willResumeEvent(System::Action value) ;

/// @brief Method add_didResumeEvent addr 0x210638c size 0x9c virtual true final true
 void add_didResumeEvent(System::Action value) ;

/// @brief Method remove_didResumeEvent addr 0x2106428 size 0x9c virtual true final true
 void remove_didResumeEvent(System::Action value) ;

/// @brief Method Pause addr 0x21064c4 size 0x40 virtual true final true
 void Pause() ;

/// @brief Method WillResume addr 0x2106504 size 0x40 virtual true final true
 void WillResume() ;

/// @brief Method Resume addr 0x2106544 size 0x40 virtual true final true
 void Resume() ;

// Ctor Parameters []
explicit MockPause() ;

/// @brief Method .ctor addr 0x2106584 size 0x8 virtual false final false
 void _ctor() ;
