...
/// @brief Method Start addr 0x22b0204 size 0x60 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x22b0290 size 0x248 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit MultiplayerLeaderboardPanelController() ;

/// @brief Method .ctor addr 0x22b07a8 size 0x8 virtual false final false
 void _ctor() ;
