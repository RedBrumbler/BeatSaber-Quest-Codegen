...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::*)(System::Action_1<GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>)>(&GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::add_cubeNoteControllerDidInitEvent)> {
  ...
  constexpr static std::size_t addrs = 0x2119a88;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::*)(System::Action_1<GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>)>(&GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::remove_cubeNoteControllerDidInitEvent)> {
  constexpr static std::size_t size = 0xb0;
  constexpr static std::size_t addrs = 0x2119b38;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::GlobalNamespace__NoteData__GameplayType (GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::*)()>(&GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::get_gameplayType)> {
  constexpr static std::size_t size = 0x8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::NoteVisualModifierType (GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::*)()>(&GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::get_noteVisualModifierType)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2119bf8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::*)(GlobalNamespace::NoteData, float_t, UnityEngine::Vector3, UnityEngine::Vector3, UnityEngine::Vector3, float_t, float_t, float_t, GlobalNamespace::NoteVisualModifierType, float_t)>(&GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::Init)> {
  ...
  constexpr static std::size_t addrs = 0x2115adc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::*)()>(&GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2119c00;
...
constexpr  GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::operator GlobalNamespace::ICubeNoteControllerInitializable_1<GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>() const noexcept {
return GlobalNamespace::ICubeNoteControllerInitializable_1<GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>(::bs_hook::Il2CppWrapperType::instance);
}
/// @brief Convert operator to GlobalNamespace::INoteVisualModifierTypeProvider
constexpr  GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::operator GlobalNamespace::INoteVisualModifierTypeProvider() const noexcept {
...
constexpr  GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::operator GlobalNamespace::INoteMovementProvider() const noexcept {
...
::cordl_internals::setInstanceField<System::Action_1<GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>, 0x88>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Action_1<GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>>(value));
}
constexpr System::Action_1<GlobalNamespace::MultiplayerConnectedPlayerGameNoteController> GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::__get_cubeNoteControllerDidInitEvent() const {
return ::cordl_internals::getInstanceField<System::Action_1<GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>, 0x88>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
::cordl_internals::setInstanceField<GlobalNamespace::NoteVisualModifierType, 0x90>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::NoteVisualModifierType>(value));
}
constexpr GlobalNamespace::NoteVisualModifierType GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::__get__noteVisualModifierType() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::NoteVisualModifierType, 0x90>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::__set__gameplayType(GlobalNamespace::GlobalNamespace__NoteData__GameplayType value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GlobalNamespace__NoteData__GameplayType, 0x94>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GlobalNamespace__NoteData__GameplayType>(value));
}
constexpr GlobalNamespace::GlobalNamespace__NoteData__GameplayType GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::__get__gameplayType() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GlobalNamespace__NoteData__GameplayType, 0x94>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::NoteMovement, false>(const_cast<void*>(instance), ___internal_method);
 ...
 GlobalNamespace::GlobalNamespace__NoteData__GameplayType GlobalNamespace::MultiplayerConnectedPlayerGameNoteController::get_gameplayType()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::MultiplayerConnectedPlayerGameNoteController>::get(),
                            "get_gameplayType",
                            std::vector<Il2CppClass*>{},
...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__MultiplayerConnectedPlayerGameNoteController__Pool._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__MultiplayerConnectedPlayerGameNoteController__Pool::*)()>(&GlobalNamespace::GlobalNamespace__MultiplayerConnectedPlayerGameNoteController__Pool::_ctor)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x2119c08;
