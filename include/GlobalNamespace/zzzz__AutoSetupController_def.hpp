...
/// @brief Method add_didFinishEvent addr 0x2181e9c size 0xb0 virtual false final false
 void add_didFinishEvent(System::Action_1<GlobalNamespace::AutoSetupData> value) ;

/// @brief Method remove_didFinishEvent addr 0x2181f4c size 0xb0 virtual false final false
 void remove_didFinishEvent(System::Action_1<GlobalNamespace::AutoSetupData> value) ;

/// @brief Method Setup addr 0x2181ffc size 0x8 virtual false final false
 void Setup(GlobalNamespace::AutoSetupData autoSetupData) ;

/// @brief Method OnEnable addr 0x2182004 size 0x200 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2182204 size 0x1c virtual false final false
 void OnDisable() ;

// Ctor Parameters []
explicit AutoSetupController() ;

/// @brief Method .ctor addr 0x2182220 size 0xc8 virtual false final false
 void _ctor() ;

/// @brief Method <OnEnable>b__12_0 addr 0x21822f0 size 0x20 virtual false final false
 void _OnEnable_b__12_0() ;

/// @brief Method <OnEnable>b__12_1 addr 0x2182310 size 0x20 virtual false final false
 void _OnEnable_b__12_1(bool isOn) ;

/// @brief Method <OnEnable>b__12_2 addr 0x2182330 size 0x20 virtual false final false
 void _OnEnable_b__12_2(bool isOn) ;

/// @brief Method <OnEnable>b__12_3 addr 0x2182350 size 0x20 virtual false final false
 void _OnEnable_b__12_3(bool isOn) ;

/// @brief Method <OnEnable>b__12_4 addr 0x2182370 size 0x20 virtual false final false
