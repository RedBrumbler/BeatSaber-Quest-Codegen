...
/// @brief Method set_nameText addr 0x217d97c size 0x24 virtual false final false
 void set_nameText(::StringW value) ;

/// @brief Method set_buttonPressed addr 0x217d9a0 size 0x8 virtual false final false
 void set_buttonPressed(System::Action value) ;

/// @brief Method Awake addr 0x217d9a8 size 0x94 virtual false final false
 void Awake() ;

// Ctor Parameters []
explicit GuestNameButtonsListItem() ;

/// @brief Method .ctor addr 0x217da3c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__7_0 addr 0x217da44 size 0x1c virtual false final false
 void _Awake_b__7_0() ;
