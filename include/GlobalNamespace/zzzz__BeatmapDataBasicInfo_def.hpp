...
/// @brief Method get_numberOfLines addr 0x2201438 size 0x8 virtual true final true
 int32_t get_numberOfLines() ;

/// @brief Method get_cuttableNotesCount addr 0x2201440 size 0x8 virtual true final true
 int32_t get_cuttableNotesCount() ;

/// @brief Method get_obstaclesCount addr 0x2201448 size 0x8 virtual true final true
 int32_t get_obstaclesCount() ;

/// @brief Method get_bombsCount addr 0x2201450 size 0x8 virtual true final true
 int32_t get_bombsCount() ;

/// @brief Method get_specialBasicBeatmapEventKeywords addr 0x2201458 size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0x2201460 size 0x50 virtual false final false
