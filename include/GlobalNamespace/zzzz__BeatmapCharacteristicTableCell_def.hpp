...
/// @brief Method SetData addr 0x215a188 size 0x60 virtual false final false
 void SetData(GlobalNamespace::BeatmapCharacteristicSO beatmapCharacteristic) ;

/// @brief Method SelectionDidChange addr 0x215a1e8 size 0x4 virtual true final false
 void SelectionDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method HighlightDidChange addr 0x215a268 size 0x4 virtual true final false
 void HighlightDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method RefreshVisuals addr 0x215a1ec size 0x7c virtual false final false
 void RefreshVisuals() ;

// Ctor Parameters []
explicit BeatmapCharacteristicTableCell() ;

/// @brief Method .ctor addr 0x215a26c size 0x1c virtual false final false
 void _ctor() ;
