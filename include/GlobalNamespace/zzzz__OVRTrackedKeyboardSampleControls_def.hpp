...
/// @brief Method .ctor addr 0x2649228 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x26492f8 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x26492fc size 0x134 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x2649430 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x2649438 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2649478 size 0x8 virtual true final true
...
/// @brief Method Start addr 0x2648d5c size 0x120 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x2648e7c size 0x248 virtual false final false
 void Update() ;

/// @brief Method SetPresentationOpaque addr 0x26490c4 size 0x20 virtual false final false
 void SetPresentationOpaque() ;

/// @brief Method SetPresentationKeyLabels addr 0x26490e4 size 0x20 virtual false final false
 void SetPresentationKeyLabels() ;

/// @brief Method SetUnlitShader addr 0x2649104 size 0x58 virtual false final false
 void SetUnlitShader() ;

/// @brief Method SetDiffuseShader addr 0x26491d0 size 0x58 virtual false final false
 void SetDiffuseShader() ;

/// @brief Method SetShaderCoroutine addr 0x264915c size 0x74 virtual false final false
 System::Collections::IEnumerator SetShaderCoroutine(::StringW shaderName) ;

/// @brief Method LaunchKeyboardSelection addr 0x2649250 size 0x48 virtual false final false
 void LaunchKeyboardSelection() ;

/// @brief Method SetTrackingEnabled addr 0x2649298 size 0x20 virtual false final false
 void SetTrackingEnabled(bool value) ;

// Ctor Parameters []
explicit OVRTrackedKeyboardSampleControls() ;

/// @brief Method .ctor addr 0x26492b8 size 0x1c virtual false final false
 void _ctor() ;

/// @brief Method <SetShaderCoroutine>b__19_0 addr 0x26492d4 size 0x24 virtual false final false
