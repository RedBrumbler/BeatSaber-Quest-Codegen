...
/// @brief Method .ctor addr 0x2106a50 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <get_canShowInGameMenu>b__0 addr 0x2107960 size 0x10 virtual false final false
...
/// @brief Method add_didGiveUpEvent addr 0x210658c size 0x9c virtual false final false
 void add_didGiveUpEvent(System::Action value) ;

/// @brief Method remove_didGiveUpEvent addr 0x2106628 size 0x9c virtual false final false
 void remove_didGiveUpEvent(System::Action value) ;

/// @brief Method add_canShowInGameMenuEvent addr 0x21066c4 size 0xb0 virtual false final false
 void add_canShowInGameMenuEvent(System::Action_1<System::Action_1<bool>> value) ;

/// @brief Method remove_canShowInGameMenuEvent addr 0x2106774 size 0xb0 virtual false final false
 void remove_canShowInGameMenuEvent(System::Action_1<System::Action_1<bool>> value) ;

/// @brief Method add_requestsDisconnectEvent addr 0x2106824 size 0x9c virtual false final false
 void add_requestsDisconnectEvent(System::Action value) ;

/// @brief Method remove_requestsDisconnectEvent addr 0x21068c0 size 0x9c virtual false final false
 void remove_requestsDisconnectEvent(System::Action value) ;

/// @brief Method get_gameMenuIsShown addr 0x210695c size 0x8 virtual false final false
 bool get_gameMenuIsShown() ;

/// @brief Method get_canShowInGameMenu addr 0x2106964 size 0xec virtual false final false
 bool get_canShowInGameMenu() ;

/// @brief Method Start addr 0x2106a58 size 0x2e0 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x210705c size 0x354 virtual false final false
 void OnDestroy() ;

/// @brief Method OnApplicationPause addr 0x2107584 size 0xc virtual false final false
 void OnApplicationPause(bool pauseStatus) ;

/// @brief Method ShowInGameMenu addr 0x2107590 size 0x100 virtual false final false
 void ShowInGameMenu() ;

/// @brief Method HideInGameMenu addr 0x2106d38 size 0x150 virtual false final false
 void HideInGameMenu() ;

/// @brief Method HandleMenuButtonTriggered addr 0x2107724 size 0x4 virtual false final false
 void HandleMenuButtonTriggered() ;

/// @brief Method HandleInputFocusWasCaptured addr 0x2107728 size 0x4 virtual false final false
 void HandleInputFocusWasCaptured() ;

/// @brief Method HandleInGameMenuViewControllerDidPressResumeButton addr 0x210772c size 0x4 virtual false final false
 void HandleInGameMenuViewControllerDidPressResumeButton() ;

/// @brief Method HandleInGameMenuViewControllerDidPressGiveUpButton addr 0x2107730 size 0x3c virtual false final false
 void HandleInGameMenuViewControllerDidPressGiveUpButton() ;

/// @brief Method HandleInGameMenuViewControllerDidPressDisconnectButton addr 0x210776c size 0x1c virtual false final false
 void HandleInGameMenuViewControllerDidPressDisconnectButton() ;

/// @brief Method HandleStateChanged addr 0x2107788 size 0x1d0 virtual false final false
...
/// @brief Method .ctor addr 0x2107958 size 0x8 virtual false final false
 void _ctor() ;
