...
/// @brief Method Start addr 0x20fe898 size 0x8c virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x20fe924 size 0x8c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleTutorialFinished addr 0x20fe9b0 size 0x20 virtual false final false
 void HandleTutorialFinished() ;

// Ctor Parameters []
explicit FinishTutorialAchievementHandler() ;

/// @brief Method .ctor addr 0x20fe9d0 size 0x8 virtual false final false
 void _ctor() ;
