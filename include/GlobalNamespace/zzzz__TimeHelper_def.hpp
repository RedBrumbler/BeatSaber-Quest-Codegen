...
/// @brief Method get_time addr 0x1fafa28 size 0x48 virtual false final false
static float_t get_time() ;

/// @brief Method set_time addr 0x1fafa70 size 0x54 virtual false final false
static void set_time(float_t value) ;

/// @brief Method get_deltaTime addr 0x1fafac4 size 0x48 virtual false final false
static float_t get_deltaTime() ;

/// @brief Method set_deltaTime addr 0x1fafb0c size 0x54 virtual false final false
static void set_deltaTime(float_t value) ;

/// @brief Method get_fixedDeltaTime addr 0x1fafb60 size 0x48 virtual false final false
static float_t get_fixedDeltaTime() ;

/// @brief Method set_fixedDeltaTime addr 0x1fafba8 size 0x54 virtual false final false
static void set_fixedDeltaTime(float_t value) ;

/// @brief Method get_interpolationFactor addr 0x1fafbfc size 0x48 virtual false final false
static float_t get_interpolationFactor() ;

/// @brief Method set_interpolationFactor addr 0x1fafc44 size 0x54 virtual false final false
static void set_interpolationFactor(float_t value) ;

/// @brief Method Awake addr 0x1fafc98 size 0x94 virtual false final false
 void Awake() ;

/// @brief Method FixedUpdate addr 0x1fafd2c size 0x94 virtual false final false
 void FixedUpdate() ;

/// @brief Method Update addr 0x1fafdc0 size 0x174 virtual false final false
 void Update() ;

/// @brief Method __SetTime addr 0x1faff34 size 0x4c virtual false final false
static void __SetTime(float_t time) ;

// Ctor Parameters []
explicit TimeHelper() ;

/// @brief Method .ctor addr 0x1faff80 size 0x8 virtual false final false
 void _ctor() ;
