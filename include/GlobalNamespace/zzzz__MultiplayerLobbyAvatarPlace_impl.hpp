...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerLobbyAvatarPlace::*)(UnityEngine::Vector3, UnityEngine::Quaternion)>(&GlobalNamespace::MultiplayerLobbyAvatarPlace::SetPositionAndRotation)> {
  ...
  constexpr static std::size_t addrs = 0x20fc944;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::MultiplayerLobbyAvatarPlace::*)()>(&GlobalNamespace::MultiplayerLobbyAvatarPlace::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x20fc9bc;
...
//  Writing Method size for method: GlobalNamespace::GlobalNamespace__MultiplayerLobbyAvatarPlace__Pool._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::GlobalNamespace__MultiplayerLobbyAvatarPlace__Pool::*)()>(&GlobalNamespace::GlobalNamespace__MultiplayerLobbyAvatarPlace__Pool::_ctor)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x20fc9c4;
