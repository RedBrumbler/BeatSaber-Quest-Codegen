...
/// @brief Method get_color addr 0x1fdbd60 size 0x1c virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method ColorWasSet addr 0x1fdbd7c size 0x4c virtual true final false
 void ColorWasSet(UnityEngine::Color color) ;

// Ctor Parameters []
explicit UnityLightWithId() ;

/// @brief Method .ctor addr 0x1fdbdc8 size 0x10 virtual false final false
 void _ctor() ;
