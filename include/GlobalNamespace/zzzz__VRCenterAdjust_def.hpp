...
/// @brief Method Awake addr 0x21e9bac size 0xc virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x21e9bb8 size 0x150 virtual false final false
 void Start() ;

/// @brief Method OnEnable addr 0x21e9d8c size 0x108 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x21e9e94 size 0x108 virtual false final false
 void OnDisable() ;

/// @brief Method HandleRoomCenterDidChange addr 0x21e9f9c size 0x70 virtual false final false
 void HandleRoomCenterDidChange() ;

/// @brief Method HandleRoomRotationDidChange addr 0x21ea00c size 0x7c virtual false final false
 void HandleRoomRotationDidChange() ;

/// @brief Method Update addr 0x21ea088 size 0x2c virtual false final false
 void Update() ;

/// @brief Method ResetRoom addr 0x21e9d08 size 0x84 virtual false final false
 void ResetRoom() ;

// Ctor Parameters []
explicit VRCenterAdjust() ;

/// @brief Method .ctor addr 0x21ea0b4 size 0x8 virtual false final false
 void _ctor() ;
