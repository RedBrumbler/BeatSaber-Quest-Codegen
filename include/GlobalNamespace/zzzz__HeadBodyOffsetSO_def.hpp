...
/// @brief Method get_headNeckOffset addr 0x20fa784 size 0xc virtual false final false
 UnityEngine::Vector3 get_headNeckOffset() ;

/// @brief Method get_verticalOffset addr 0x20fa790 size 0x8 virtual false final false
 float_t get_verticalOffset() ;

// Ctor Parameters []
explicit HeadBodyOffsetSO() ;

/// @brief Method .ctor addr 0x20fa798 size 0x14 virtual false final false
 void _ctor() ;
