...
/// @brief Method get_alwaysOwnedBeatmapLevelIds addr 0x20ff140 size 0x24 virtual false final false
 System::Collections::Generic::HashSet_1<::StringW> get_alwaysOwnedBeatmapLevelIds() ;

/// @brief Method get_alwaysOwnedPacksIds addr 0x20ff414 size 0x24 virtual false final false
 System::Collections::Generic::HashSet_1<::StringW> get_alwaysOwnedPacksIds() ;

/// @brief Method OnEnable addr 0x20ff9d8 size 0x1c virtual true final false
 void OnEnable() ;

/// @brief Method InitAlwaysOwnedItems addr 0x20ff490 size 0x548 virtual false final false
 void InitAlwaysOwnedItems() ;

// Ctor Parameters []
explicit AlwaysOwnedContentContainerSO() ;

/// @brief Method .ctor addr 0x20ff9f4 size 0x8 virtual false final false
 void _ctor() ;
