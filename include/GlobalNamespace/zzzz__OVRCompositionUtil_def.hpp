...
/// @brief Method SafeDestroy addr 0x25d5320 size 0x78 virtual false final false
static void SafeDestroy(UnityEngine::GameObject obj) ;

/// @brief Method SafeDestroy addr 0x25d5398 size 0x74 virtual false final false
static void SafeDestroy(ByRef<UnityEngine::GameObject> obj) ;

/// @brief Method GetWorldPosition addr 0x25d540c size 0x3c virtual false final false
static UnityEngine::Vector3 GetWorldPosition(UnityEngine::Vector3 trackingSpacePosition) ;

/// @brief Method GetWorldPosition addr 0x25d5448 size 0x94 virtual false final false
static UnityEngine::Vector3 GetWorldPosition(UnityEngine::Camera camera, UnityEngine::Vector3 trackingSpacePosition) ;

/// @brief Method GetMaximumBoundaryDistance addr 0x25d54dc size 0x1c0 virtual false final false
...
/// @brief Method BuildBoundaryMesh addr 0x25d5b70 size 0x480 virtual false final false
...
/// @brief Method .ctor addr 0x25d5ff0 size 0x8 virtual false final false
 void _ctor() ;
