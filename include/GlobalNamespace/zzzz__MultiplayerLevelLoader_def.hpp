...
/// @brief Method add_stillDownloadingSongEvent addr 0x2185c7c size 0x9c virtual false final false
 void add_stillDownloadingSongEvent(System::Action value) ;

/// @brief Method remove_stillDownloadingSongEvent addr 0x2185d18 size 0x9c virtual false final false
 void remove_stillDownloadingSongEvent(System::Action value) ;

/// @brief Method add_countdownFinishedEvent addr 0x2185db4 size 0xb0 virtual false final false
...
/// @brief Method remove_countdownFinishedEvent addr 0x2185e64 size 0xb0 virtual false final false
...
/// @brief Method LoadLevel addr 0x2185f14 size 0x1a8 virtual false final false
 void LoadLevel(GlobalNamespace::ILevelGameplaySetupData gameplaySetupData, float_t initialStartTime) ;

/// @brief Method SetNewStartTime addr 0x21860bc size 0x8 virtual false final false
 void SetNewStartTime(float_t newStartTime) ;

/// @brief Method ClearLoading addr 0x21860c4 size 0x34 virtual false final false
 void ClearLoading() ;

/// @brief Method Tick addr 0x21860f8 size 0x2ec virtual true final true
 void Tick() ;

// Ctor Parameters []
explicit MultiplayerLevelLoader() ;

/// @brief Method .ctor addr 0x21863e4 size 0x8 virtual false final false
 void _ctor() ;
