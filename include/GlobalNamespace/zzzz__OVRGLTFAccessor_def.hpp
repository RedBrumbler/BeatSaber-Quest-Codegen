...
/// @brief Method .ctor addr 0x25e067c size 0x340 virtual false final false
 void _ctor(OVRSimpleJSON::JSONNode node, OVRSimpleJSON::JSONNode root, bool bufferViewOnly) ;

/// @brief Method GetDataCount addr 0x25e0b20 size 0x8 virtual false final false
 int32_t GetDataCount() ;

/// @brief Method ToOVRType addr 0x25e09bc size 0x164 virtual false final false
static GlobalNamespace::OVRGLTFType ToOVRType(::StringW type) ;

/// @brief Method ReadAsInt addr 0x25e0b28 size 0x214 virtual false final false
 void ReadAsInt(GlobalNamespace::OVRBinaryChunk chunk, ByRef<::ArrayW<int32_t>> data, int32_t offset) ;

/// @brief Method ReadAsFloat addr 0x25e0f54 size 0x210 virtual false final false
 void ReadAsFloat(GlobalNamespace::OVRBinaryChunk chunk, ByRef<::ArrayW<float_t>> data, int32_t offset) ;

/// @brief Method ReadAsVector2 addr 0x25e11cc size 0x25c virtual false final false
 void ReadAsVector2(GlobalNamespace::OVRBinaryChunk chunk, ByRef<::ArrayW<UnityEngine::Vector2>> data, int32_t offset) ;

/// @brief Method ReadAsVector3 addr 0x25e1428 size 0x398 virtual false final false
...
/// @brief Method ReadAsVector4 addr 0x25e17c0 size 0x3f4 virtual false final false
...
/// @brief Method ReadAsColor addr 0x25e1bb4 size 0x488 virtual false final false
 void ReadAsColor(GlobalNamespace::OVRBinaryChunk chunk, ByRef<::ArrayW<UnityEngine::Color>> data, int32_t offset) ;

/// @brief Method ReadAsMatrix4x4 addr 0x25e2064 size 0x36c virtual false final false
...
/// @brief Method ReadAsKtxTexture addr 0x25e23d0 size 0x110 virtual false final false
 ::ArrayW<uint8_t> ReadAsKtxTexture(GlobalNamespace::OVRBinaryChunk chunk) ;

/// @brief Method ReadAsBoneWeights addr 0x25e24e0 size 0x398 virtual false final false
 void ReadAsBoneWeights(GlobalNamespace::OVRBinaryChunk chunk, ByRef<::ArrayW<UnityEngine::Vector4>> data, int32_t offset) ;

/// @brief Method GetStrideForType addr 0x25e0d3c size 0x28 virtual false final false
 int32_t GetStrideForType(GlobalNamespace::OVRGLTFComponentType type) ;

/// @brief Method GetMaxValueForType addr 0x25e203c size 0x28 virtual false final false
 float_t GetMaxValueForType(GlobalNamespace::OVRGLTFComponentType type) ;

/// @brief Method ReadElementAsUint addr 0x25e0d64 size 0x1f0 virtual false final false
 uint32_t ReadElementAsUint(::ArrayW<uint8_t> data, int32_t index, GlobalNamespace::OVRGLTFComponentType type) ;

/// @brief Method ReadElementAsFloat addr 0x25e1164 size 0x68 virtual false final false
