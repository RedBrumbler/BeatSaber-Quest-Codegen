...
/// @brief Method get_localization addr 0x269f188 size 0x8 virtual false final false
 Polyglot::Localization get_localization() ;

/// @brief Method get_Instance addr 0x269f190 size 0x94 virtual false final false
static GlobalNamespace::LocalizationProvider get_Instance() ;

/// @brief Method set_Instance addr 0x269f30c size 0x4c virtual false final false
static void set_Instance(GlobalNamespace::LocalizationProvider value) ;

/// @brief Method get_HasInstance addr 0x269f224 size 0xe8 virtual false final false
static bool get_HasInstance() ;

// Ctor Parameters []
explicit LocalizationProvider() ;

/// @brief Method .ctor addr 0x269f358 size 0x8 virtual false final false
 void _ctor() ;
