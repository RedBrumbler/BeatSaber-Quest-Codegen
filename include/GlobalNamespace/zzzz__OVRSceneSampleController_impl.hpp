...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::OVRSceneSampleController::*)()>(&GlobalNamespace::OVRSceneSampleController::Start)> {
  ...
  constexpr static std::size_t addrs = 0x26620fc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::OVRSceneSampleController::*)()>(&GlobalNamespace::OVRSceneSampleController::UpdateVisionMode)> {
  ...
  constexpr static std::size_t addrs = 0x2662368;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::OVRSceneSampleController::*)()>(&GlobalNamespace::OVRSceneSampleController::UpdateSpeedAndRotationScaleMultiplier)> {
  ...
  constexpr static std::size_t addrs = 0x2662424;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::OVRSceneSampleController::*)()>(&GlobalNamespace::OVRSceneSampleController::UpdateRecenterPose)> {
  ...
  constexpr static std::size_t addrs = 0x26622b8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::OVRSceneSampleController::*)()>(&GlobalNamespace::OVRSceneSampleController::_ctor)> {
...
constexpr UnityEngine::KeyCode GlobalNamespace::OVRSceneSampleController::__get_quitKey() const {
...
::cordl_internals::setInstanceField<UnityEngine::Texture, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<UnityEngine::Texture>(value));
}
constexpr UnityEngine::Texture GlobalNamespace::OVRSceneSampleController::__get_fadeInTexture() const {
return ::cordl_internals::getInstanceField<UnityEngine::Texture, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::OVRSceneSampleController::__set_speedRotationIncrement(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<float_t>(value));
}
constexpr float_t GlobalNamespace::OVRSceneSampleController::__get_speedRotationIncrement() const {
...
::cordl_internals::setInstanceField<GlobalNamespace::OVRPlayerController, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::OVRPlayerController>(value));
}
constexpr GlobalNamespace::OVRPlayerController GlobalNamespace::OVRSceneSampleController::__get_playerController() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::OVRPlayerController, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::OVRSceneSampleController::__set_cameraController(GlobalNamespace::OVRCameraRig value)  {
::cordl_internals::setInstanceField<GlobalNamespace::OVRCameraRig, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::OVRCameraRig>(value));
}
constexpr GlobalNamespace::OVRCameraRig GlobalNamespace::OVRSceneSampleController::__get_cameraController() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::OVRCameraRig, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr ::StringW GlobalNamespace::OVRSceneSampleController::__get_layerName() const {
...
constexpr bool GlobalNamespace::OVRSceneSampleController::__get_visionMode() const {
...
::cordl_internals::setInstanceField<GlobalNamespace::OVRGridCube, 0x50>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::OVRGridCube>(value));
}
constexpr GlobalNamespace::OVRGridCube GlobalNamespace::OVRSceneSampleController::__get_gridCube() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::OVRGridCube, 0x50>(this->::bs_hook::Il2CppWrapperType::instance);
}
