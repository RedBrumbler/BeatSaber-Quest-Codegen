...
/// @brief Method .ctor addr 0x214263c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_color addr 0x21423ec size 0xc virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method set_color addr 0x21423f8 size 0xc virtual false final false
 void set_color(UnityEngine::Color value) ;

/// @brief Method Start addr 0x2142404 size 0x238 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x21427a8 size 0x458 virtual false final false
 void Update() ;

/// @brief Method SetUpElement addr 0x2142644 size 0x164 virtual false final false
 void SetUpElement(GlobalNamespace::GlobalNamespace__BlocksBlade__Element element, float_t velocity, UnityEngine::Color color) ;

/// @brief Method RandomPointOnCircle addr 0x2142c00 size 0x4c virtual false final false
 UnityEngine::Vector2 RandomPointOnCircle(float_t radius) ;

// Ctor Parameters []
explicit BlocksBlade() ;

/// @brief Method .ctor addr 0x2142c4c size 0x38 virtual false final false
 void _ctor() ;
