...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4776), inst: 753 }), TypeDefinitionIndex(TypeDefinitionIndex(4776)), TypeDefinitionIndex(TypeDefinitionIndex(10246))}
...
/// @brief Method get_sprite addr 0x2264278 size 0x3c virtual false final false
 UnityEngine::Sprite get_sprite() ;

// Ctor Parameters []
explicit AvatarSpritePartSO() ;

/// @brief Method .ctor addr 0x22642b4 size 0x48 virtual false final false
 void _ctor() ;
