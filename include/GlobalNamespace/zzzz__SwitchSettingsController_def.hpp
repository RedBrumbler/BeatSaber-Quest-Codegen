...
/// @brief Method Awake addr 0x218a670 size 0xa8 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x218a718 size 0xa8 virtual false final false
 void OnDestroy() ;

/// @brief Method OnEnable addr 0x218a7c0 size 0x3c virtual false final false
 void OnEnable() ;

/// @brief Method RefreshUI addr 0x218a7fc size 0x24 virtual false final false
 void RefreshUI() ;

/// @brief Method HandleToggleValueDidChange addr 0x218a820 size 0x10 virtual false final false
 void HandleToggleValueDidChange(bool value) ;

// Ctor Parameters []
explicit SwitchSettingsController() ;

/// @brief Method .ctor addr 0x2188fe8 size 0x8 virtual false final false
 void _ctor() ;
