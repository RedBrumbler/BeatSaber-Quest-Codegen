...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5697))}
...
/// @brief Method GetInitValue addr 0x2188f40 size 0x48 virtual true final false
 bool GetInitValue() ;

/// @brief Method ApplyValue addr 0x2188f88 size 0x58 virtual true final false
 void ApplyValue(bool value) ;

// Ctor Parameters []
explicit BoolSettingsController() ;

/// @brief Method .ctor addr 0x2188fe0 size 0x8 virtual false final false
 void _ctor() ;
