...
/// @brief Method Awake addr 0x1fb07bc size 0x1c virtual false final false
 void Awake() ;

/// @brief Method OnWillRenderObject addr 0x1fb07d8 size 0xd0 virtual false final false
 void OnWillRenderObject() ;

// Ctor Parameters []
explicit Billboard() ;

/// @brief Method .ctor addr 0x1fb08a8 size 0x8 virtual false final false
 void _ctor() ;
