...
/// @brief Method get_lightmap1 addr 0x21d67dc size 0x8 virtual false final false
 UnityEngine::Texture2D get_lightmap1() ;

/// @brief Method set_lightmap1 addr 0x21d67e4 size 0x8 virtual false final false
 void set_lightmap1(UnityEngine::Texture2D value) ;

/// @brief Method get_lightmap2 addr 0x21d67ec size 0x8 virtual false final false
 UnityEngine::Texture2D get_lightmap2() ;

/// @brief Method set_lightmap2 addr 0x21d67f4 size 0x8 virtual false final false
 void set_lightmap2(UnityEngine::Texture2D value) ;

// Ctor Parameters []
explicit LightmapDataSO() ;

/// @brief Method .ctor addr 0x21d67fc size 0x8 virtual false final false
 void _ctor() ;
