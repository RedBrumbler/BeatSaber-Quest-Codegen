...
/// @brief Method add_didCancelEvent addr 0x21ada90 size 0x9c virtual false final false
 void add_didCancelEvent(System::Action value) ;

/// @brief Method remove_didCancelEvent addr 0x21adb2c size 0x9c virtual false final false
 void remove_didCancelEvent(System::Action value) ;

/// @brief Method Init addr 0x21adbc8 size 0x34 virtual false final false
 void Init(::StringW text) ;

/// @brief Method HideLoading addr 0x21adbfc size 0x40 virtual false final false
 void HideLoading() ;

/// @brief Method DidActivate addr 0x21adc3c size 0xc8 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

// Ctor Parameters []
explicit JoiningLobbyViewController() ;

/// @brief Method .ctor addr 0x21add04 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__8_0 addr 0x21add0c size 0x1c virtual false final false
