...
/// @brief Method Init addr 0x2144784 size 0x1c virtual false final false
 void Init(GlobalNamespace::SaberManager saberManager) ;

/// @brief Method AreSabersClashing addr 0x2140514 size 0x164 virtual false final false
 bool AreSabersClashing(ByRef<UnityEngine::Vector3> clashingPoint) ;

/// @brief Method SegmentToSegmentDist addr 0x21447a0 size 0x268 virtual false final false
...
/// @brief Method .ctor addr 0x2144a08 size 0x10 virtual false final false
 void _ctor() ;
