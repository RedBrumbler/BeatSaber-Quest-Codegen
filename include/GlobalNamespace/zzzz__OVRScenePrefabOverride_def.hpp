...
/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize addr 0x263bdfc size 0x4 virtual true final true
 void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize addr 0x263be00 size 0x154 virtual true final true
 void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize() ;

// Ctor Parameters []
explicit OVRScenePrefabOverride() ;

/// @brief Method .ctor addr 0x263c268 size 0x50 virtual false final false
 void _ctor() ;

/// @brief Method <UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize>g__IndexOf|4_0 addr 0x263bf54 size 0x314 virtual false final false
