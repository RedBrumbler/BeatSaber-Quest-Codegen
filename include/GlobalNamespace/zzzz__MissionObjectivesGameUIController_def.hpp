...
/// @brief Method Start addr 0x22afce8 size 0x94 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x22b011c size 0xd4 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleMissionObjectiveCheckersManagerObjectivesListDidChange addr 0x22b01f0 size 0x4 virtual false final false
 void HandleMissionObjectiveCheckersManagerObjectivesListDidChange() ;

/// @brief Method CreateUIElements addr 0x22afd7c size 0x3a0 virtual false final false
 void CreateUIElements() ;

// Ctor Parameters []
explicit MissionObjectivesGameUIController() ;

/// @brief Method .ctor addr 0x22b01f4 size 0x10 virtual false final false
 void _ctor() ;
