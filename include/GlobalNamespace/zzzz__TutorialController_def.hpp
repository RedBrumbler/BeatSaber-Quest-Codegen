...
/// @brief Method .ctor addr 0x214b0a4 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x214b120 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x214b124 size 0x10c virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x214b230 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x214b238 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x214b278 size 0x8 virtual true final true
...
/// @brief Method add_levelWillStartIntroEvent addr 0x214a86c size 0x9c virtual true final true
 void add_levelWillStartIntroEvent(System::Action value) ;

/// @brief Method remove_levelWillStartIntroEvent addr 0x214a908 size 0x9c virtual true final true
 void remove_levelWillStartIntroEvent(System::Action value) ;

/// @brief Method add_levelDidStartEvent addr 0x214a9a4 size 0x9c virtual true final true
 void add_levelDidStartEvent(System::Action value) ;

/// @brief Method remove_levelDidStartEvent addr 0x214aa40 size 0x9c virtual true final true
 void remove_levelDidStartEvent(System::Action value) ;

/// @brief Method Start addr 0x214aadc size 0x23c virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x214ad18 size 0x26c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleIntroTutorialDidFinishEvent addr 0x214af84 size 0x1c virtual false final false
 void HandleIntroTutorialDidFinishEvent() ;

/// @brief Method HandleTutorialSongControllerSongDidFinishEvent addr 0x214affc size 0x40 virtual false final false
 void HandleTutorialSongControllerSongDidFinishEvent() ;

/// @brief Method OutroCoroutine addr 0x214b03c size 0x68 virtual false final false
 System::Collections::IEnumerator OutroCoroutine() ;

/// @brief Method HandlePauseControllerCanPause addr 0x214b0cc size 0x38 virtual false final false
 void HandlePauseControllerCanPause(System::Action_1<bool> canPause) ;

/// @brief Method HandlePauseControllerDidPause addr 0x214b104 size 0xc virtual false final false
 void HandlePauseControllerDidPause() ;

/// @brief Method HandlePauseControllerDidResume addr 0x214b110 size 0x8 virtual false final false
 void HandlePauseControllerDidResume() ;

// Ctor Parameters []
explicit TutorialController() ;

/// @brief Method .ctor addr 0x214b118 size 0x8 virtual false final false
 void _ctor() ;
