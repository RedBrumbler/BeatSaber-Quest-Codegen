...
/// @brief Method OnEnable addr 0x1fd4108 size 0x164 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fd426c size 0xec virtual false final false
 void OnDisable() ;

/// @brief Method HandleCameraPreRender addr 0x1fd4358 size 0x60 virtual false final false
 void HandleCameraPreRender(UnityEngine::Camera camera) ;

// Ctor Parameters []
explicit BlueNoiseDitheringUpdater() ;

/// @brief Method .ctor addr 0x1fd4444 size 0x8 virtual false final false
 void _ctor() ;
