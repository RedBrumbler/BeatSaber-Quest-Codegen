...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10031)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4776), inst: 884 }), TypeDefinitionIndex(TypeDefinitionIndex(4776))}
...
/// @brief Method get_mesh addr 0x2263e5c size 0x3c virtual false final false
 UnityEngine::Mesh get_mesh() ;

// Ctor Parameters []
explicit AvatarMeshPartSO() ;

/// @brief Method .ctor addr 0x2263e98 size 0x48 virtual false final false
 void _ctor() ;
