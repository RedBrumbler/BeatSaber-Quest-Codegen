...
/// @brief Method add_didGoToBackgroundExecutionEvent addr 0x2253988 size 0x9c virtual false final false
 void add_didGoToBackgroundExecutionEvent(System::Action value) ;

/// @brief Method remove_didGoToBackgroundExecutionEvent addr 0x2253a24 size 0x9c virtual false final false
 void remove_didGoToBackgroundExecutionEvent(System::Action value) ;

/// @brief Method add_didGoToForegroundExecutionEvent addr 0x2253ac0 size 0x9c virtual false final false
 void add_didGoToForegroundExecutionEvent(System::Action value) ;

/// @brief Method remove_didGoToForegroundExecutionEvent addr 0x2253b5c size 0x9c virtual false final false
 void remove_didGoToForegroundExecutionEvent(System::Action value) ;

/// @brief Method Tick addr 0x2253bf8 size 0x28 virtual true final true
 void Tick() ;

// Ctor Parameters []
explicit PS4Helper() ;

/// @brief Method .ctor addr 0x2253c20 size 0x8 virtual false final false
 void _ctor() ;
