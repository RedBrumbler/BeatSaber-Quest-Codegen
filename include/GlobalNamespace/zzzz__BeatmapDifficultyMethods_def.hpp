...
/// @brief Method Name addr 0x2219b2c size 0x9c virtual false final false
static ::StringW Name(GlobalNamespace::BeatmapDifficulty difficulty) ;

/// @brief Method ShortName addr 0x2219bc8 size 0x9c virtual false final false
static ::StringW ShortName(GlobalNamespace::BeatmapDifficulty difficulty) ;

/// @brief Method DefaultRating addr 0x2219c64 size 0x28 virtual false final false
static int32_t DefaultRating(GlobalNamespace::BeatmapDifficulty difficulty) ;

/// @brief Method NoteJumpMovementSpeed addr 0x2219c8c size 0x28 virtual false final false
