...
/// @brief Method get_bitCount addr 0x1220b3c size 0x8 virtual true final true
 int32_t get_bitCount() ;

/// @brief Method get_maxValue addr 0x1220b44 size 0xc virtual false final false
static GlobalNamespace::BitMask256 get_maxValue() ;

/// @brief Method .ctor addr 0x1220b50 size 0xc virtual false final false
 void _ctor(uint64_t d0, uint64_t d1, uint64_t d2, uint64_t d3) ;

/// @brief Method .ctor addr 0x1220b5c size 0xc virtual false final false
 void _ctor(uint64_t value) ;

/// @brief Method SetBits addr 0x1220b68 size 0xcc virtual true final true
 GlobalNamespace::BitMask256 SetBits(int32_t offset, uint64_t bits) ;

/// @brief Method GetBits addr 0x1220c34 size 0x160 virtual true final true
 uint64_t GetBits(int32_t offset, int32_t count) ;

/// @brief Method op_BitwiseOr addr 0x1220d94 size 0x18 virtual false final false
static GlobalNamespace::BitMask256 op_BitwiseOr(ByRef<GlobalNamespace::BitMask256> a, ByRef<GlobalNamespace::BitMask256> b) ;

/// @brief Method op_BitwiseAnd addr 0x1220dac size 0x18 virtual false final false
static GlobalNamespace::BitMask256 op_BitwiseAnd(ByRef<GlobalNamespace::BitMask256> a, ByRef<GlobalNamespace::BitMask256> b) ;

/// @brief Method op_ExclusiveOr addr 0x1220dc4 size 0x18 virtual false final false
static GlobalNamespace::BitMask256 op_ExclusiveOr(ByRef<GlobalNamespace::BitMask256> a, ByRef<GlobalNamespace::BitMask256> b) ;

/// @brief Method op_LeftShift addr 0x1220ddc size 0x58 virtual false final false
static GlobalNamespace::BitMask256 op_LeftShift(ByRef<GlobalNamespace::BitMask256> a, int32_t bits) ;

/// @brief Method op_RightShift addr 0x1220e34 size 0x58 virtual false final false
static GlobalNamespace::BitMask256 op_RightShift(ByRef<GlobalNamespace::BitMask256> a, int32_t bits) ;

/// @brief Method op_Equality addr 0x1220e8c size 0x4c virtual false final false
static bool op_Equality(ByRef<GlobalNamespace::BitMask256> a, ByRef<GlobalNamespace::BitMask256> b) ;

/// @brief Method op_Inequality addr 0x1220ed8 size 0x4c virtual false final false
static bool op_Inequality(ByRef<GlobalNamespace::BitMask256> a, ByRef<GlobalNamespace::BitMask256> b) ;

/// @brief Method op_Implicit addr 0x1220f24 size 0xc virtual false final false
static GlobalNamespace::BitMask256 op_Implicit_GlobalNamespace__BitMask256(uint64_t value) ;

/// @brief Method Serialize addr 0x1220f30 size 0x60 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method CreateFromSerializedData addr 0x1220f90 size 0x2c virtual true final true
 GlobalNamespace::BitMask256 CreateFromSerializedData(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method Deserialize addr 0x1220fbc size 0x6c virtual false final false
static GlobalNamespace::BitMask256 Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method ToString addr 0x1221028 size 0xd4 virtual true final false
 ::StringW ToString() ;

/// @brief Method Equals addr 0x12210fc size 0x4c virtual true final true
 bool Equals(GlobalNamespace::BitMask256 other) ;

/// @brief Method Equals addr 0x1221148 size 0xa8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x12211f0 size 0x88 virtual true final false
 int32_t GetHashCode() ;
