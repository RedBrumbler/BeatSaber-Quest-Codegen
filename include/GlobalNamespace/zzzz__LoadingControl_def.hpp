...
/// @brief Method add_didPressRefreshButtonEvent addr 0x215e0bc size 0x9c virtual false final false
 void add_didPressRefreshButtonEvent(System::Action value) ;

/// @brief Method remove_didPressRefreshButtonEvent addr 0x215e158 size 0x9c virtual false final false
 void remove_didPressRefreshButtonEvent(System::Action value) ;

/// @brief Method get_isLoading addr 0x215e1f4 size 0x1c virtual false final false
 bool get_isLoading() ;

/// @brief Method Awake addr 0x215e210 size 0xc4 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x215e2d4 size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method ShowLoading addr 0x215e2f0 size 0x8c virtual false final false
 void ShowLoading(::StringW text) ;

/// @brief Method ShowText addr 0x215e37c size 0xb0 virtual false final false
 void ShowText(::StringW text, bool showRefreshButton) ;

/// @brief Method ShowDownloadingProgress addr 0x215e42c size 0xac virtual false final false
 void ShowDownloadingProgress(::StringW text, float_t downloadingProgress) ;

/// @brief Method Hide addr 0x215e4d8 size 0x24 virtual false final false
 void Hide() ;

// Ctor Parameters []
explicit LoadingControl() ;

/// @brief Method .ctor addr 0x215e4fc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__14_0 addr 0x215e504 size 0x1c virtual false final false
 void _Awake_b__14_0() ;
