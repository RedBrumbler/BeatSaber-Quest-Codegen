...
/// @brief Method Awake addr 0x22a1244 size 0x110 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x22a1354 size 0x124 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x22a1478 size 0x9c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleBeatmapEvent addr 0x22a1514 size 0xdc virtual false final false
 void HandleBeatmapEvent(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

/// @brief Method GetPositionForValue addr 0x22a15f0 size 0x60 virtual false final false
 UnityEngine::Vector3 GetPositionForValue(int32_t value) ;

/// @brief Method SetPosition addr 0x22a1650 size 0x48 virtual false final false
 void SetPosition(UnityEngine::Vector3 position) ;

// Ctor Parameters []
explicit SmoothStepPositionEventEffect() ;

/// @brief Method .ctor addr 0x22a1698 size 0x70 virtual false final false
 void _ctor() ;
