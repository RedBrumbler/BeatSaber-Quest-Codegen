...
/// @brief Method get_mirror addr 0x21d4de0 size 0x8 virtual false final false
 GlobalNamespace::Mirror get_mirror() ;

/// @brief Method set_mirror addr 0x21d4de8 size 0x8 virtual false final false
 void set_mirror(GlobalNamespace::Mirror value) ;

/// @brief Method Start addr 0x21d4df0 size 0xa0 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x21d4ebc size 0xd4 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleMirrorDidChangeEnabledState addr 0x21d4e90 size 0x2c virtual false final false
 void HandleMirrorDidChangeEnabledState(bool isEnabled) ;

// Ctor Parameters []
explicit DisableWhenMirrorIsEnabled() ;

/// @brief Method .ctor addr 0x21d4f90 size 0x8 virtual false final false
 void _ctor() ;
