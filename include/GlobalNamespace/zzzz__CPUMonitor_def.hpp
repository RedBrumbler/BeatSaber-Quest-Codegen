...
/// @brief Method PollUpdate addr 0xdb41c8 size 0xf8 virtual true final true
 void PollUpdate() ;

/// @brief Method get_utilization addr 0xdb42c0 size 0x28 virtual true final true
 float_t get_utilization() ;

// Ctor Parameters []
explicit CPUMonitor() ;

/// @brief Method .ctor addr 0xdb42e8 size 0x84 virtual false final false
 void _ctor() ;
