...
/// @brief Method get_menuEnvironmentType addr 0x2267544 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__MenuEnvironmentManager__MenuEnvironmentType get_menuEnvironmentType() ;

/// @brief Method get_wrapper addr 0x226754c size 0x8 virtual false final false
 UnityEngine::GameObject get_wrapper() ;

// Ctor Parameters []
explicit GlobalNamespace__MenuEnvironmentManager__MenuEnvironmentObjects() ;

/// @brief Method .ctor addr 0x2267554 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Start addr 0x22673b4 size 0x8 virtual false final false
 void Start() ;

/// @brief Method ShowEnvironmentType addr 0x22673bc size 0x180 virtual false final false
...
/// @brief Method .ctor addr 0x226753c size 0x8 virtual false final false
 void _ctor() ;
