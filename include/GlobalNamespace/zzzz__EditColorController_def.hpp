...
/// @brief Method add_didChangeColorEvent addr 0x21570a8 size 0xb0 virtual false final false
 void add_didChangeColorEvent(System::Action_1<UnityEngine::Color> value) ;

/// @brief Method remove_didChangeColorEvent addr 0x2157158 size 0xb0 virtual false final false
 void remove_didChangeColorEvent(System::Action_1<UnityEngine::Color> value) ;

/// @brief Method add_didFinishEvent addr 0x2157208 size 0xb0 virtual false final false
 void add_didFinishEvent(System::Action_1<bool> value) ;

/// @brief Method remove_didFinishEvent addr 0x21572b8 size 0xb0 virtual false final false
 void remove_didFinishEvent(System::Action_1<bool> value) ;

/// @brief Method SetColorCallback addr 0x2157368 size 0x8 virtual false final false
 void SetColorCallback(System::Action_1<UnityEngine::Color> colorCallback) ;

/// @brief Method SetColor addr 0x2157370 size 0x60 virtual false final false
 void SetColor(UnityEngine::Color color) ;

/// @brief Method DidActivate addr 0x21574c0 size 0x1b8 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x21577d8 size 0xec virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method HandleHSVPanelControllerColorDidChange addr 0x2157a24 size 0x6c virtual false final false
...
/// @brief Method HandlePreviousColorPanelControllerColorWasSelected addr 0x2157b24 size 0x68 virtual false final false
 void HandlePreviousColorPanelControllerColorWasSelected(UnityEngine::Color color) ;

/// @brief Method HandleCancelButtonWasPressed addr 0x2157b98 size 0x58 virtual false final false
 void HandleCancelButtonWasPressed() ;

/// @brief Method HandleApplyButtonWasPressed addr 0x2157bf0 size 0x20 virtual false final false
 void HandleApplyButtonWasPressed() ;

/// @brief Method ChangeColor addr 0x2157a90 size 0x94 virtual false final false
 void ChangeColor(UnityEngine::Color color) ;

// Ctor Parameters []
explicit EditColorController() ;

/// @brief Method .ctor addr 0x2157c10 size 0x8 virtual false final false
 void _ctor() ;
