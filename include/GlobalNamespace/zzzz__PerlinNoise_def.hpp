...
/// @brief Method OctavePerlin3D addr 0x1fb4854 size 0xdc virtual false final false
static float_t OctavePerlin3D(float_t x, float_t y, float_t z, int32_t octaves, float_t persistence, int32_t repeat) ;

/// @brief Method Perlin3D addr 0x1fb4930 size 0x538 virtual false final false
static float_t Perlin3D(float_t x, float_t y, float_t z, int32_t repeat) ;

/// @brief Method Inc addr 0x1fb4e94 size 0x18 virtual false final false
static int32_t Inc(int32_t num, int32_t repeat) ;

/// @brief Method Grad3D addr 0x1fb4eac size 0x74 virtual false final false
static float_t Grad3D(int32_t hash, float_t x, float_t y, float_t z) ;

/// @brief Method Fade addr 0x1fb4e68 size 0x2c virtual false final false
static float_t Fade(float_t t) ;

/// @brief Method Lerp addr 0x1fb4f20 size 0x10 virtual false final false
static float_t Lerp(float_t a, float_t b, float_t x) ;

// Ctor Parameters []
explicit PerlinNoise() ;

/// @brief Method .ctor addr 0x1fb4f30 size 0x8 virtual false final false
 void _ctor() ;
