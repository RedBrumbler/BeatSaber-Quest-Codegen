...
/// @brief Method .ctor addr 0x2149db0 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2149e68 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2149e6c size 0x134 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x2149fa0 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x2149fa8 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2149fe8 size 0x8 virtual true final true
...
/// @brief Method add_introTutorialDidFinishEvent addr 0x21496fc size 0x9c virtual false final false
 void add_introTutorialDidFinishEvent(System::Action value) ;

/// @brief Method remove_introTutorialDidFinishEvent addr 0x2149798 size 0x9c virtual false final false
 void remove_introTutorialDidFinishEvent(System::Action value) ;

/// @brief Method Start addr 0x2149834 size 0x194 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x21499c8 size 0x4 virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x2149b70 size 0x90 virtual false final false
 void Update() ;

/// @brief Method CleanUp addr 0x21499cc size 0x1a4 virtual false final false
 void CleanUp() ;

/// @brief Method HandleGameDidPause addr 0x2149ca0 size 0x70 virtual false final false
 void HandleGameDidPause() ;

/// @brief Method HandlegameDidResume addr 0x2149d10 size 0x38 virtual false final false
 void HandlegameDidResume() ;

/// @brief Method ShowFinishAnimation addr 0x2149c24 size 0x7c virtual false final false
 void ShowFinishAnimation() ;

/// @brief Method ShowFinishAnimationCoroutine addr 0x2149d48 size 0x68 virtual false final false
 System::Collections::IEnumerator ShowFinishAnimationCoroutine() ;

/// @brief Method SetFinishAnimationParams addr 0x2149dd8 size 0x6c virtual false final false
 void SetFinishAnimationParams(float_t progress) ;

// Ctor Parameters []
explicit IntroTutorialController() ;

/// @brief Method .ctor addr 0x2149e60 size 0x8 virtual false final false
 void _ctor() ;
