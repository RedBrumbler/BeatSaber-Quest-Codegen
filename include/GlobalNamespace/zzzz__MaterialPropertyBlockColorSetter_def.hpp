...
/// @brief Method get_color addr 0x1fdca54 size 0x2c virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method get_materialPropertyBlockController addr 0x1fdca80 size 0x8 virtual false final false
 GlobalNamespace::MaterialPropertyBlockController get_materialPropertyBlockController() ;

/// @brief Method set_materialPropertyBlockController addr 0x1fdca88 size 0x8 virtual false final false
 void set_materialPropertyBlockController(GlobalNamespace::MaterialPropertyBlockController value) ;

/// @brief Method Awake addr 0x1fdca90 size 0x30 virtual false final false
 void Awake() ;

/// @brief Method InitIfNeeded addr 0x1fdcac0 size 0x30 virtual false final false
 void InitIfNeeded() ;

/// @brief Method SetColor addr 0x1fdcaf0 size 0xac virtual true final false
 void SetColor(UnityEngine::Color color) ;

/// @brief Method OnValidate addr 0x1fdcb9c size 0x40 virtual false final false
 void OnValidate() ;

// Ctor Parameters []
explicit MaterialPropertyBlockColorSetter() ;

/// @brief Method .ctor addr 0x1fdcbdc size 0x10 virtual false final false
 void _ctor() ;
