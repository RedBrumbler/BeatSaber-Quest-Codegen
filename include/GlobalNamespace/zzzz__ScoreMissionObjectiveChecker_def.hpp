...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5202))}
...
/// @brief Method OnDestroy addr 0x210f680 size 0x108 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleScoreDidChange addr 0x210f788 size 0x48 virtual false final false
 void HandleScoreDidChange(int32_t multipliedScore, int32_t modifiedScore) ;

/// @brief Method Init addr 0x210f7d0 size 0x208 virtual true final false
 void Init() ;

// Ctor Parameters []
explicit ScoreMissionObjectiveChecker() ;

/// @brief Method .ctor addr 0x210f9d8 size 0x8 virtual false final false
 void _ctor() ;
