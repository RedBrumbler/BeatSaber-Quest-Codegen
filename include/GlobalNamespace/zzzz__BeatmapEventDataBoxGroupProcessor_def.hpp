...
/// @brief Method get_dirtyBoxGroups addr 0x22148f8 size 0x8 virtual false final false
 System::Collections::Generic::IReadOnlyCollection_1<GlobalNamespace::BeatmapEventDataBoxGroup> get_dirtyBoxGroups() ;

/// @brief Method ProcessInsertedData addr 0x2214900 size 0x5fc virtual true final true
...
/// @brief Method ProcessBeforeDeleteData addr 0x2214efc size 0x374 virtual true final true
...
/// @brief Method ClearDirtyData addr 0x2213ec0 size 0x50 virtual false final false
 void ClearDirtyData() ;

// Ctor Parameters []
explicit BeatmapEventDataBoxGroupProcessor() ;

/// @brief Method .ctor addr 0x2213a80 size 0x7c virtual false final false
 void _ctor() ;
