...
/// @brief Method .ctor addr 0x2192a8c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__0 addr 0x2192f14 size 0x208 virtual false final false
...
/// @brief Method add_didChangeGameplayModifiersEvent addr 0x21927c0 size 0x9c virtual false final false
 void add_didChangeGameplayModifiersEvent(System::Action value) ;

/// @brief Method remove_didChangeGameplayModifiersEvent addr 0x219285c size 0x9c virtual false final false
 void remove_didChangeGameplayModifiersEvent(System::Action value) ;

/// @brief Method get_gameplayModifiers addr 0x21928f8 size 0x8 virtual false final false
 GlobalNamespace::GameplayModifiers get_gameplayModifiers() ;

/// @brief Method SetData addr 0x2192900 size 0x8 virtual false final false
 void SetData(GlobalNamespace::GameplayModifiers newGameplayModifiers) ;

/// @brief Method Awake addr 0x2192908 size 0x184 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x2192a94 size 0x14 virtual false final false
 void OnDestroy() ;

/// @brief Method SetToggleValueWithGameplayModifierParams addr 0x2192aa8 size 0x88 virtual false final false
 void SetToggleValueWithGameplayModifierParams(GlobalNamespace::GameplayModifierParamsSO gameplayModifierParams, bool value) ;

/// @brief Method GetToggleValueWithGameplayModifierParams addr 0x2192b30 size 0x8c virtual false final false
 bool GetToggleValueWithGameplayModifierParams(GlobalNamespace::GameplayModifierParamsSO gameplayModifierParams) ;

/// @brief Method RefreshTotalMultiplierAndRankUI addr 0x2192bbc size 0x1d4 virtual false final false
 void RefreshTotalMultiplierAndRankUI() ;

/// @brief Method IRefreshable.Refresh addr 0x2192d90 size 0x104 virtual true final true
 void IRefreshable_Refresh() ;

// Ctor Parameters []
explicit GameplayModifiersPanelController() ;

/// @brief Method .ctor addr 0x2192e94 size 0x80 virtual false final false
 void _ctor() ;
