...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10209)), TypeDefinitionIndex(TypeDefinitionIndex(13923)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13923), inst: 394 })}
...
/// @brief Method .ctor addr 0x1fbf590 size 0x48 virtual false final false
 void _ctor() ;
