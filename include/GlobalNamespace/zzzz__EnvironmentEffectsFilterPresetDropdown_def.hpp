...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4734)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5700), inst: 4602 }), TypeDefinitionIndex(TypeDefinitionIndex(5700))}
...
/// @brief Method GetNamedValues addr 0x218a8c8 size 0x128 virtual true final false
...
/// @brief Method .ctor addr 0x218a9f0 size 0x48 virtual false final false
 void _ctor() ;
