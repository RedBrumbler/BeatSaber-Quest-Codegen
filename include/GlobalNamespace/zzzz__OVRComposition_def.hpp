...
/// @brief Method .ctor addr 0x25d4b7c size 0x34 virtual false final false
...
/// @brief Method RecenterPose addr 0x25d4d68 size 0x4 virtual true final false
 void RecenterPose() ;

/// @brief Method RefreshCameraRig addr 0x25d4bb0 size 0x1b8 virtual false final false
 void RefreshCameraRig(UnityEngine::GameObject parentObject, UnityEngine::Camera mainCamera) ;

/// @brief Method ComputeCameraWorldSpacePose addr 0x25d4d6c size 0x68 virtual false final false
...
/// @brief Method ComputeCameraTrackingSpacePose addr 0x25d4dd4 size 0x288 virtual false final false
