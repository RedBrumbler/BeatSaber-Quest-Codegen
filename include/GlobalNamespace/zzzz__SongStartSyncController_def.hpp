...
/// @brief Method get_isSongStarted addr 0x224b888 size 0x8 virtual false final false
 bool get_isSongStarted() ;

/// @brief Method get_songStartSyncTime addr 0x224b890 size 0x1c virtual false final false
 float_t get_songStartSyncTime() ;

/// @brief Method add_syncStartFailedEvent addr 0x224b8ac size 0x9c virtual false final false
 void add_syncStartFailedEvent(System::Action value) ;

/// @brief Method remove_syncStartFailedEvent addr 0x224b948 size 0x9c virtual false final false
 void remove_syncStartFailedEvent(System::Action value) ;

/// @brief Method add_syncStartSuccessEvent addr 0x224b9e4 size 0xb0 virtual false final false
 void add_syncStartSuccessEvent(System::Action_1<float_t> value) ;

/// @brief Method remove_syncStartSuccessEvent addr 0x224ba94 size 0xb0 virtual false final false
 void remove_syncStartSuccessEvent(System::Action_1<float_t> value) ;

/// @brief Method add_syncResumeEvent addr 0x224bb44 size 0xb0 virtual false final false
 void add_syncResumeEvent(System::Action_1<float_t> value) ;

/// @brief Method remove_syncResumeEvent addr 0x224bbf4 size 0xb0 virtual false final false
 void remove_syncResumeEvent(System::Action_1<float_t> value) ;

/// @brief Method Start addr 0x224bca4 size 0xc virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x224bcb0 size 0x14 virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x224bcc4 size 0x60 virtual false final false
 void Update() ;

/// @brief Method OnApplicationPause addr 0x224bd24 size 0x44 virtual false final false
 void OnApplicationPause(bool pauseStatus) ;

/// @brief Method StartSong addr 0x224bd68 size 0x15c virtual false final false
...
/// @brief Method HandleSetSongStartSyncTime addr 0x224bec4 size 0x2c virtual false final false
 void HandleSetSongStartSyncTime(float_t songStartSyncTime) ;

// Ctor Parameters []
explicit SongStartSyncController() ;

/// @brief Method .ctor addr 0x224bef0 size 0x8 virtual false final false
 void _ctor() ;
