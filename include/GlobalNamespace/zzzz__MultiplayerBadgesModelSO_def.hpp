...
/// @brief Method get_positiveBadges addr 0x2111ba4 size 0x8 virtual false final false
 System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::MultiplayerBadgeDataSO> get_positiveBadges() ;

/// @brief Method get_negativeBadges addr 0x2111bac size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2111bb4 size 0x8 virtual false final false
 void _ctor() ;
