...
/// @brief Method Awake addr 0x2273358 size 0x144 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x227349c size 0x190 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleNoteControllerDidInit addr 0x227362c size 0x1c virtual true final true
 void HandleNoteControllerDidInit(GlobalNamespace::NoteControllerBase noteController) ;

/// @brief Method HandleNoteControllerNoteDidStartDissolving addr 0x2273648 size 0x10 virtual true final true
 void HandleNoteControllerNoteDidStartDissolving(GlobalNamespace::NoteControllerBase noteController, float_t duration) ;

/// @brief Method AnimateCutout addr 0x2273658 size 0x2c virtual false final false
 void AnimateCutout(float_t cutoutStart, float_t cutoutEnd, float_t duration) ;

// Ctor Parameters []
explicit BaseNoteVisuals() ;

/// @brief Method .ctor addr 0x2273684 size 0x8 virtual false final false
 void _ctor() ;
