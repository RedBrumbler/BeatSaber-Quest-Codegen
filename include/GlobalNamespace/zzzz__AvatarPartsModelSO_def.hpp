...
/// @brief Method get_headTops addr 0x2264238 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::AvatarMeshPartSO> get_headTops() ;

/// @brief Method get_Eyes addr 0x2264240 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::AvatarSpritePartSO> get_Eyes() ;

/// @brief Method get_Mouths addr 0x2264248 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::AvatarSpritePartSO> get_Mouths() ;

/// @brief Method get_Glasses addr 0x2264250 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::AvatarMeshPartSO> get_Glasses() ;

/// @brief Method get_FacialHair addr 0x2264258 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::AvatarMeshPartSO> get_FacialHair() ;

/// @brief Method get_Hands addr 0x2264260 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::AvatarMeshPartSO> get_Hands() ;

/// @brief Method get_Clothes addr 0x2264268 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::AvatarMeshPartSO> get_Clothes() ;

// Ctor Parameters []
explicit AvatarPartsModelSO() ;

/// @brief Method .ctor addr 0x2264270 size 0x8 virtual false final false
 void _ctor() ;
