...
template<>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12943), inst: 3704 }), TypeDefinitionIndex(TypeDefinitionIndex(12943)), TypeDefinitionIndex(TypeDefinitionIndex(12945))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12945), inst: 4987 })
...
template<>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12943), inst: 3704 }), TypeDefinitionIndex(TypeDefinitionIndex(12945)), TypeDefinitionIndex(TypeDefinitionIndex(12943))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12945), inst: 4988 })
// CS Name: RemoteStateBuffer`3
