...
/// @brief Method Bind addr 0x1fb2da4 size 0xcc virtual false final false
 void Bind(System::Action subscribe, System::Action unsubscribe) ;

/// @brief Method ClearAllBindings addr 0x1fb2e70 size 0x18c virtual false final false
 void ClearAllBindings() ;

// Ctor Parameters []
explicit EventBinder() ;

/// @brief Method .ctor addr 0x1fb2ffc size 0x7c virtual false final false
 void _ctor() ;
