...
/// @brief Method SetGlobalShaderValues addr 0x26a77f4 size 0x88 virtual false final false
static void SetGlobalShaderValues(float_t baseColorBoost, float_t baseColorBoostThreshold) ;

// Ctor Parameters []
explicit MainEffectCore() ;

/// @brief Method .ctor addr 0x26a8208 size 0x8 virtual false final false
 void _ctor() ;
