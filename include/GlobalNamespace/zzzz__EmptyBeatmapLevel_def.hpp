...
/// @brief Method get_levelID addr 0x22228c0 size 0x8 virtual true final true
 ::StringW get_levelID() ;

/// @brief Method get_songName addr 0x22228c8 size 0x8 virtual true final true
 ::StringW get_songName() ;

/// @brief Method get_songSubName addr 0x22228d0 size 0x8 virtual true final true
 ::StringW get_songSubName() ;

/// @brief Method get_songAuthorName addr 0x22228d8 size 0x8 virtual true final true
 ::StringW get_songAuthorName() ;

/// @brief Method get_levelAuthorName addr 0x22228e0 size 0x8 virtual true final true
 ::StringW get_levelAuthorName() ;

/// @brief Method get_beatsPerMinute addr 0x22228e8 size 0x8 virtual true final true
 float_t get_beatsPerMinute() ;

/// @brief Method get_songTimeOffset addr 0x22228f0 size 0x8 virtual true final true
 float_t get_songTimeOffset() ;

/// @brief Method get_shuffle addr 0x22228f8 size 0x8 virtual true final true
 float_t get_shuffle() ;

/// @brief Method get_shufflePeriod addr 0x2222900 size 0x8 virtual true final true
 float_t get_shufflePeriod() ;

/// @brief Method get_previewStartTime addr 0x2222908 size 0x8 virtual true final true
 float_t get_previewStartTime() ;

/// @brief Method get_previewDuration addr 0x2222910 size 0x8 virtual true final true
 float_t get_previewDuration() ;

/// @brief Method get_songDuration addr 0x2222918 size 0x8 virtual true final true
 float_t get_songDuration() ;

/// @brief Method get_environmentInfo addr 0x2222920 size 0x8 virtual true final true
 GlobalNamespace::EnvironmentInfoSO get_environmentInfo() ;

/// @brief Method get_allDirectionsEnvironmentInfo addr 0x2222928 size 0x8 virtual true final true
 GlobalNamespace::EnvironmentInfoSO get_allDirectionsEnvironmentInfo() ;

/// @brief Method get_environmentInfos addr 0x2222930 size 0x7c virtual true final true
 ::ArrayW<GlobalNamespace::EnvironmentInfoSO> get_environmentInfos() ;

/// @brief Method get_previewDifficultyBeatmapSets addr 0x22229ac size 0x8 virtual true final true
 System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::PreviewDifficultyBeatmapSet> get_previewDifficultyBeatmapSets() ;

/// @brief Method GetPreviewAudioClipAsync addr 0x22229b4 size 0x40 virtual false final false
...
/// @brief Method GetCoverImageAsync addr 0x22229f4 size 0x40 virtual true final true
 System::Threading::Tasks::Task_1<UnityEngine::Sprite> GetCoverImageAsync(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method get_beatmapLevelData addr 0x2222a34 size 0x8 virtual true final true
 GlobalNamespace::IBeatmapLevelData get_beatmapLevelData() ;

// Ctor Parameters []
explicit EmptyBeatmapLevel() ;

/// @brief Method .ctor addr 0x2222a3c size 0x6c virtual false final false
 void _ctor() ;
