...
/// @brief Method get_viewController addr 0x21a9858 size 0x8 virtual false final false
 HMUI::ViewController get_viewController() ;

/// @brief Method get_localizedMenuName addr 0x21a9860 size 0xc virtual false final false
 ::StringW get_localizedMenuName() ;

// Ctor Parameters []
explicit SettingsSubMenuInfo() ;

/// @brief Method .ctor addr 0x21a986c size 0x8 virtual false final false
 void _ctor() ;
