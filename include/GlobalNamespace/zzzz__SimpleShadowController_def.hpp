...
/// @brief Method Start addr 0x1fb6cc0 size 0x1c virtual false final false
 void Start() ;

/// @brief Method LateUpdate addr 0x1fb6cdc size 0xf8 virtual false final false
 void LateUpdate() ;

// Ctor Parameters []
explicit SimpleShadowController() ;

/// @brief Method .ctor addr 0x1fb6dd4 size 0x10 virtual false final false
 void _ctor() ;
