...
/// @brief Method .ctor addr 0x260c8cc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <BuildPermissionCallbacks>b__12_0 addr 0x260c8d4 size 0xa4 virtual false final false
 void _BuildPermissionCallbacks_b__12_0(::StringW permissionId) ;

/// @brief Method <BuildPermissionCallbacks>b__12_1 addr 0x260c978 size 0xa4 virtual false final false
 void _BuildPermissionCallbacks_b__12_1(::StringW permissionId) ;

/// @brief Method <BuildPermissionCallbacks>b__12_2 addr 0x260ca1c size 0xec virtual false final false
...
/// @brief Method add_PermissionGranted addr 0x260bb54 size 0xcc virtual false final false
static void add_PermissionGranted(System::Action_1<::StringW> value) ;

/// @brief Method remove_PermissionGranted addr 0x260bc20 size 0xcc virtual false final false
static void remove_PermissionGranted(System::Action_1<::StringW> value) ;

/// @brief Method GetPermissionId addr 0x260bcec size 0xd8 virtual false final false
static ::StringW GetPermissionId(GlobalNamespace::GlobalNamespace__OVRPermissionsRequester__Permission permission) ;

/// @brief Method IsPermissionSupportedByPlatform addr 0x260bdc4 size 0x10c virtual false final false
...
/// @brief Method IsPermissionGranted addr 0x260c140 size 0x14 virtual false final false
static bool IsPermissionGranted(GlobalNamespace::GlobalNamespace__OVRPermissionsRequester__Permission permission) ;

/// @brief Method Request addr 0x260c154 size 0x3f4 virtual false final false
...
/// @brief Method ShouldRequestPermission addr 0x260c548 size 0xfc virtual false final false
static bool ShouldRequestPermission(GlobalNamespace::GlobalNamespace__OVRPermissionsRequester__Permission permission) ;

/// @brief Method BuildPermissionCallbacks addr 0x260c644 size 0x224 virtual false final false
