...
/// @brief Method Start addr 0x229ea98 size 0x124 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x229ebbc size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleBeatmapEvent addr 0x229ebd8 size 0x20 virtual false final false
 void HandleBeatmapEvent(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

/// @brief Method ToggleEmitting addr 0x229ebf8 size 0xb4 virtual false final false
 void ToggleEmitting(bool shouldPlay) ;

// Ctor Parameters []
explicit ParticleSystemContinuousEventEffect() ;

/// @brief Method .ctor addr 0x229ecac size 0x8 virtual false final false
 void _ctor() ;
