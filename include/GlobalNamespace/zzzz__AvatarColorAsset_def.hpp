...
/// @brief Method get_clipCaps addr 0x21ea210 size 0x8 virtual true final true
 UnityEngine::Timeline::ClipCaps get_clipCaps() ;

/// @brief Method CreatePlayable addr 0x21ea218 size 0xa8 virtual true final false
 UnityEngine::Playables::Playable CreatePlayable(UnityEngine::Playables::PlayableGraph graph, UnityEngine::GameObject go) ;

// Ctor Parameters []
explicit AvatarColorAsset() ;

/// @brief Method .ctor addr 0x21ea2c0 size 0x8 virtual false final false
 void _ctor() ;
