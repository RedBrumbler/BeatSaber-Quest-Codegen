...
/// @brief Method get_beatmapObjectExecutionRatings addr 0x226cfe8 size 0x8 virtual false final false
 System::Collections::Generic::List_1<GlobalNamespace::BeatmapObjectExecutionRating> get_beatmapObjectExecutionRatings() ;

/// @brief Method Start addr 0x226cff0 size 0x1a0 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x226d240 size 0x1ec virtual false final false
 void OnDestroy() ;

/// @brief Method HandleScoringForNoteDidFinish addr 0x226d4dc size 0x474 virtual false final false
 void HandleScoringForNoteDidFinish(GlobalNamespace::ScoringElement scoringElement) ;

/// @brief Method HandlePlayerHeadDidEnterObstacle addr 0x226d950 size 0x120 virtual false final false
 void HandlePlayerHeadDidEnterObstacle(GlobalNamespace::ObstacleController obstacleController) ;

/// @brief Method HandleObstacleDidPassAvoidedMark addr 0x226da70 size 0x15c virtual false final false
...
/// @brief Method .ctor addr 0x226dbcc size 0xc4 virtual false final false
 void _ctor() ;
