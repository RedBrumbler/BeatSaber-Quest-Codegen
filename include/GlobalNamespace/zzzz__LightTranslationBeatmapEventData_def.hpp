...
/// @brief Method get_translation addr 0xda11ac size 0x8 virtual false final false
 float_t get_translation() ;

/// @brief Method set_translation addr 0xda11b4 size 0x8 virtual false final false
 void set_translation(float_t value) ;

/// @brief Method get_distribution addr 0xda11bc size 0x8 virtual false final false
 float_t get_distribution() ;

/// @brief Method set_distribution addr 0xda11c4 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xda11cc size 0xdc virtual false final false
...
/// @brief Method ChangeTranslation addr 0xda12c0 size 0x8 virtual false final false
 void ChangeTranslation(float_t translation, float_t distribution) ;

/// @brief Method GetCopy addr 0xda12c8 size 0xb4 virtual true final false
 GlobalNamespace::BeatmapDataItem GetCopy() ;

/// @brief Method SubtypeIdentifier addr 0xda12a8 size 0x18 virtual false final false
static int32_t SubtypeIdentifier(int32_t groupId, int32_t elementId, GlobalNamespace::LightAxis axis) ;

/// @brief Method GetDefault addr 0xda137c size 0x160 virtual true final false
