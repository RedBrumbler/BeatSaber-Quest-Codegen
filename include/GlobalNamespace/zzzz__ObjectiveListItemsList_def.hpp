...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13744)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13744), inst: 5052 }), TypeDefinitionIndex(TypeDefinitionIndex(5900))}
...
/// @brief Method .ctor addr 0x21c5684 size 0x48 virtual false final false
 void _ctor() ;
