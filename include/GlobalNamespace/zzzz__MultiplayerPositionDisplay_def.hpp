...
/// @brief Method Start addr 0x2138104 size 0x10c virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2138210 size 0xe4 virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x2138370 size 0x44 virtual false final false
 void Update() ;

/// @brief Method UpdateColors addr 0x21383b4 size 0x94 virtual false final false
 void UpdateColors() ;

/// @brief Method UpdatePosition addr 0x2138448 size 0x174 virtual false final false
 void UpdatePosition() ;

/// @brief Method HandlePlayerFailed addr 0x21385bc size 0x18 virtual false final false
 void HandlePlayerFailed() ;

/// @brief Method HandleFirstPlayerDidChange addr 0x21385d4 size 0xb0 virtual false final false
 void HandleFirstPlayerDidChange(GlobalNamespace::GlobalNamespace__MultiplayerScoreProvider__RankedPlayer obj) ;

/// @brief Method ChangeColor addr 0x21382f4 size 0x7c virtual false final false
 void ChangeColor(UnityEngine::Color toColor, float_t duration) ;

// Ctor Parameters []
explicit MultiplayerPositionDisplay() ;

/// @brief Method .ctor addr 0x2138684 size 0x24 virtual false final false
 void _ctor() ;
