...
constexpr bool __get_enableFPSCounter() const;
 ...
 bool __declspec(property(get=__get_enableFPSRecorder, put=__set_enableFPSRecorder))  enableFPSRecorder;

constexpr void __set_enableFPSRecorder(bool value) ;

constexpr bool __get_enableFPSRecorder() const;

 bool __declspec(property(get=__get_enableMemoryTracker, put=__set_enableMemoryTracker))  enableMemoryTracker;

constexpr void __set_enableMemoryTracker(bool value) ;

constexpr bool __get_enableMemoryTracker() const;
...
/// @brief Method .ctor addr 0x2229e74 size 0x12c virtual false final false
 void _ctor() ;
...
constexpr GlobalNamespace::BoolSO __get_enableFPSCounter() const;
 ...
 GlobalNamespace::BoolSO __declspec(property(get=__get_enableFPSRecorder, put=__set_enableFPSRecorder))  enableFPSRecorder;

constexpr void __set_enableFPSRecorder(GlobalNamespace::BoolSO value) ;

constexpr GlobalNamespace::BoolSO __get_enableFPSRecorder() const;

 GlobalNamespace::BoolSO __declspec(property(get=__get_enableMemoryTracker, put=__set_enableMemoryTracker))  enableMemoryTracker;

constexpr void __set_enableMemoryTracker(GlobalNamespace::BoolSO value) ;

constexpr GlobalNamespace::BoolSO __get_enableMemoryTracker() const;
...
/// @brief Method get_createScreenshotDuringTheGame addr 0x22280e0 size 0x8 virtual false final false
 bool get_createScreenshotDuringTheGame() ;

/// @brief Method set_createScreenshotDuringTheGame addr 0x22280e8 size 0xc virtual false final false
 void set_createScreenshotDuringTheGame(bool value) ;

/// @brief Method get_playingForTheFirstTime addr 0x22280f4 size 0x8 virtual false final false
 bool get_playingForTheFirstTime() ;

/// @brief Method set_playingForTheFirstTime addr 0x22280fc size 0xc virtual false final false
 void set_playingForTheFirstTime(bool value) ;

/// @brief Method Initialize addr 0x2228108 size 0x100 virtual false final false
 void Initialize(GlobalNamespace::ISaveData saveData) ;

/// @brief Method Save addr 0x2228888 size 0x4a4 virtual false final false
 void Save(GlobalNamespace::ISaveData saveData) ;

/// @brief Method Load addr 0x2228208 size 0x680 virtual false final false
 void Load(GlobalNamespace::ISaveData saveData, bool forced) ;

/// @brief Method __DeleteSettingsFiles addr 0x2228d2c size 0x140 virtual false final false
 void __DeleteSettingsFiles() ;

// Ctor Parameters []
explicit MainSettingsModelSO() ;

/// @brief Method .ctor addr 0x2228e6c size 0x1008 virtual false final false
 void _ctor() ;
