...
/// @brief Method GetRankName addr 0x12262f8 size 0xbc virtual false final false
static ::StringW GetRankName(GlobalNamespace::GlobalNamespace__RankModel__Rank rank) ;

/// @brief Method GetRankForScore addr 0x12263b4 size 0xc8 virtual false final false
