...
/// @brief Method SetCharacter addr 0x20de920 size 0x68 virtual false final false
 void SetCharacter(GlobalNamespace::BTSCharacter btsCharacter) ;

/// @brief Method StopAnimation addr 0x20de988 size 0x20 virtual false final false
 void StopAnimation() ;

// Ctor Parameters []
explicit BTSCharacterResultAnimationController() ;

/// @brief Method .ctor addr 0x20de9a8 size 0x8 virtual false final false
 void _ctor() ;
