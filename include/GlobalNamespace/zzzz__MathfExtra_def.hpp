...
/// @brief Method Mod addr 0x22b1e5c size 0x14 virtual false final false
static float_t Mod(float_t value, float_t mod) ;

/// @brief Method Round addr 0x22b1e70 size 0x118 virtual false final false
static float_t Round(float_t value, int32_t decimals) ;

/// @brief Method MaxAbs addr 0x22b1f88 size 0x14 virtual false final false
