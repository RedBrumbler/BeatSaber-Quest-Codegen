...
/// @brief Method Start addr 0x214510c size 0x2c virtual false final false
 void Start() ;

/// @brief Method Update addr 0x2145138 size 0x1cc virtual false final false
 void Update() ;

// Ctor Parameters []
explicit SaberSound() ;

/// @brief Method .ctor addr 0x2145304 size 0x14 virtual false final false
 void _ctor() ;
