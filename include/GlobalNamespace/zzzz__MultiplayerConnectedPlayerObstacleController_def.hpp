...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4911))}
...
/// @brief Method Init addr 0x2119e74 size 0x1d0 virtual true final false
...
/// @brief Method .ctor addr 0x211a044 size 0x8 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 2720 }), TypeDefinitionIndex(TypeDefinitionIndex(5246)), TypeDefinitionIndex(TypeDefinitionIndex(11011))}
...
/// @brief Method .ctor addr 0x211a04c size 0x48 virtual false final false
 void _ctor() ;
