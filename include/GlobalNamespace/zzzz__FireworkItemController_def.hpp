...
/// @brief Method .ctor addr 0x228922c size 0x10 virtual false final false
 void _ctor() ;
...
/// @brief Method set_directionalLight addr 0x2287a48 size 0x8 virtual false final false
 void set_directionalLight(GlobalNamespace::DirectionalLight value) ;

/// @brief Method set_directionalLightIntensity addr 0x2287a50 size 0x8 virtual false final false
 void set_directionalLightIntensity(float_t value) ;

/// @brief Method add_didFinishEvent addr 0x2287a58 size 0xb0 virtual false final false
 void add_didFinishEvent(System::Action_1<GlobalNamespace::FireworkItemController> value) ;

/// @brief Method remove_didFinishEvent addr 0x2287b08 size 0xb0 virtual false final false
 void remove_didFinishEvent(System::Action_1<GlobalNamespace::FireworkItemController> value) ;

/// @brief Method Awake addr 0x2287bb8 size 0x84 virtual false final false
 void Awake() ;

/// @brief Method OnDisable addr 0x2287c3c size 0x58 virtual false final false
 void OnDisable() ;

/// @brief Method Fire addr 0x2287d94 size 0x20 virtual false final false
 void Fire() ;

/// @brief Method FireCoroutine addr 0x2287db4 size 0x68 virtual false final false
 System::Collections::IEnumerator FireCoroutine() ;

/// @brief Method SetLightsColor addr 0x2287c94 size 0x100 virtual false final false
 void SetLightsColor(float_t intensity) ;

/// @brief Method PlayExplosionSound addr 0x2287e1c size 0xdc virtual false final false
 void PlayExplosionSound() ;

/// @brief Method InitializeParticleSystem addr 0x2287ef8 size 0x314 virtual false final false
 void InitializeParticleSystem() ;

// Ctor Parameters []
explicit FireworkItemController() ;

/// @brief Method .ctor addr 0x228820c size 0x1020 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11011)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 294 }), TypeDefinitionIndex(TypeDefinitionIndex(4964))}
...
/// @brief Method .ctor addr 0x228923c size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2289284 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x22892ac size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x22892b0 size 0x244 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x22894f4 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x22894fc size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x228953c size 0x8 virtual true final true
