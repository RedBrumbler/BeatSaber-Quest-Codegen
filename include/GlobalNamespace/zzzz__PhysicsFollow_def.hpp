...
/// @brief Method Start addr 0x1fb4f64 size 0x98 virtual false final false
 void Start() ;

/// @brief Method FixedUpdate addr 0x1fb4ffc size 0xd8 virtual false final false
 void FixedUpdate() ;

// Ctor Parameters []
explicit PhysicsFollow() ;

/// @brief Method .ctor addr 0x1fb50d4 size 0x14 virtual false final false
 void _ctor() ;
