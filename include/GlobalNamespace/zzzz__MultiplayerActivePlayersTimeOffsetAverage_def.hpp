...
/// @brief Method get_offsetSyncTime addr 0x21274b8 size 0x214 virtual true final true
 float_t get_offsetSyncTime() ;

/// @brief Method get_isFailed addr 0x21276cc size 0x148 virtual true final true
 bool get_isFailed() ;

// Ctor Parameters []
explicit MultiplayerActivePlayersTimeOffsetAverage() ;

/// @brief Method .ctor addr 0x2127814 size 0x8 virtual false final false
 void _ctor() ;
