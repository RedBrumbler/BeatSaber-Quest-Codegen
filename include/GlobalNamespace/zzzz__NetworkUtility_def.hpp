...
/// @brief Method Init addr 0xdcfef4 size 0xe0 virtual false final false
static void Init() ;

/// @brief Method GetHashedUserId addr 0xdcffd4 size 0xcc virtual false final false
static ::StringW GetHashedUserId(::StringW userId, GlobalNamespace::GlobalNamespace__AuthenticationToken__Platform platform) ;

/// @brief Method EncryptName addr 0xdd02ac size 0x420 virtual false final false
static ::StringW EncryptName(::StringW text) ;

/// @brief Method DecryptName addr 0xdd06cc size 0x424 virtual false final false
static ::StringW DecryptName(::StringW text) ;

/// @brief Method GenerateId addr 0xdd0af0 size 0x98 virtual false final false
static ::StringW GenerateId() ;

/// @brief Method GetHashBase64 addr 0xdd00a0 size 0x20c virtual false final false
