...
/// @brief Method Initialize addr 0x2255a10 size 0x68 virtual false final false
 void Initialize() ;

/// @brief Method OnDestroy addr 0x2255a78 size 0xc virtual false final false
 void OnDestroy() ;
...
/// @brief Method HandlePlatformHelperDidGoToBackgroundExecution addr 0x2255a84 size 0x48 virtual false final false
 void HandlePlatformHelperDidGoToBackgroundExecution() ;

// Ctor Parameters []
explicit SonyOnGoingToBackgroundSaveHandler() ;

/// @brief Method .ctor addr 0x2253f08 size 0x8 virtual false final false
 void _ctor() ;
