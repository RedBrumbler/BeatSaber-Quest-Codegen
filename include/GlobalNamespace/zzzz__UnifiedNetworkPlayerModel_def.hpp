...
/// @brief Method .ctor addr 0x224e610 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x224e344 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x224e1c8 size 0x34 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x224ed70 size 0x54 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x224edc4 size 0x6dc virtual true final true
 bool MoveNext() ;

/// @brief Method <>m__Finally1 addr 0x224f4a0 size 0xb0 virtual false final false
 void __m__Finally1() ;

/// @brief Method <>m__Finally2 addr 0x224f550 size 0xb0 virtual false final false
 void __m__Finally2() ;

/// @brief Method <>m__Finally3 addr 0x224f600 size 0xb0 virtual false final false
 void __m__Finally3() ;

/// @brief Method System.Collections.Generic.IEnumerator<INetworkPlayer>.get_Current addr 0x224f6b0 size 0x8 virtual true final true
 GlobalNamespace::INetworkPlayer System_Collections_Generic_IEnumerator_INetworkPlayer__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x224f6b8 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x224f6f8 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<INetworkPlayer>.GetEnumerator addr 0x224f700 size 0xa4 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x224f7a4 size 0x4 virtual true final true
...
/// @brief Method add_connectedPlayerManagerCreatedEvent addr 0x224bf00 size 0xb0 virtual true final true
 void add_connectedPlayerManagerCreatedEvent(System::Action_1<GlobalNamespace::INetworkPlayerModel> value) ;

/// @brief Method remove_connectedPlayerManagerCreatedEvent addr 0x224bfb0 size 0xb0 virtual true final true
 void remove_connectedPlayerManagerCreatedEvent(System::Action_1<GlobalNamespace::INetworkPlayerModel> value) ;

/// @brief Method add_connectedPlayerManagerDestroyedEvent addr 0x224c060 size 0xb0 virtual true final true
 void add_connectedPlayerManagerDestroyedEvent(System::Action_1<GlobalNamespace::INetworkPlayerModel> value) ;

/// @brief Method remove_connectedPlayerManagerDestroyedEvent addr 0x224c110 size 0xb0 virtual true final true
 void remove_connectedPlayerManagerDestroyedEvent(System::Action_1<GlobalNamespace::INetworkPlayerModel> value) ;

/// @brief Method add_partySizeChangedEvent addr 0x224c1c0 size 0xb0 virtual true final true
 void add_partySizeChangedEvent(System::Action_1<int32_t> value) ;

/// @brief Method remove_partySizeChangedEvent addr 0x224c270 size 0xb0 virtual true final true
 void remove_partySizeChangedEvent(System::Action_1<int32_t> value) ;

/// @brief Method add_partyRefreshingEvent addr 0x224c320 size 0x9c virtual true final true
 void add_partyRefreshingEvent(System::Action value) ;

/// @brief Method remove_partyRefreshingEvent addr 0x224c3bc size 0x9c virtual true final true
 void remove_partyRefreshingEvent(System::Action value) ;

/// @brief Method add_partyChangedEvent addr 0x224c458 size 0xb0 virtual true final true
 void add_partyChangedEvent(System::Action_1<GlobalNamespace::INetworkPlayerModel> value) ;

/// @brief Method remove_partyChangedEvent addr 0x224c508 size 0xb0 virtual true final true
 void remove_partyChangedEvent(System::Action_1<GlobalNamespace::INetworkPlayerModel> value) ;

/// @brief Method add_joinRequestedEvent addr 0x224c5b8 size 0xb0 virtual true final true
 void add_joinRequestedEvent(System::Action_1<GlobalNamespace::INetworkPlayer> value) ;

/// @brief Method remove_joinRequestedEvent addr 0x224c668 size 0xb0 virtual true final true
 void remove_joinRequestedEvent(System::Action_1<GlobalNamespace::INetworkPlayer> value) ;

/// @brief Method add_inviteRequestedEvent addr 0x224c718 size 0xb0 virtual true final true
 void add_inviteRequestedEvent(System::Action_1<GlobalNamespace::INetworkPlayer> value) ;

/// @brief Method remove_inviteRequestedEvent addr 0x224c7c8 size 0xb0 virtual true final true
 void remove_inviteRequestedEvent(System::Action_1<GlobalNamespace::INetworkPlayer> value) ;

/// @brief Method get_activeNetworkPlayerModel addr 0x224c878 size 0x3c virtual false final false
 GlobalNamespace::INetworkPlayerModel get_activeNetworkPlayerModel() ;

/// @brief Method get_activeNetworkPlayerModelType addr 0x224c8b4 size 0x8 virtual false final false
...
/// @brief Method get_localPlayerIsPartyOwner addr 0x224c8bc size 0xdc virtual true final true
 bool get_localPlayerIsPartyOwner() ;

/// @brief Method get_hasNetworkingFailed addr 0x224c998 size 0xdc virtual true final true
 bool get_hasNetworkingFailed() ;

/// @brief Method get_currentPartySize addr 0x224ca74 size 0xd0 virtual true final true
 int32_t get_currentPartySize() ;

/// @brief Method get_selectionMask addr 0x224cb44 size 0xf4 virtual true final true
 GlobalNamespace::BeatmapLevelSelectionMask get_selectionMask() ;

/// @brief Method get_configuration addr 0x224cc38 size 0xf4 virtual true final true
 GlobalNamespace::GameplayServerConfiguration get_configuration() ;

/// @brief Method get_secret addr 0x224cd2c size 0x24 virtual true final true
 ::StringW get_secret() ;

/// @brief Method get_code addr 0x224cd50 size 0x24 virtual true final true
 ::StringW get_code() ;

/// @brief Method get_connectedPlayerManager addr 0x224cd74 size 0xd0 virtual true final true
 GlobalNamespace::ConnectedPlayerManager get_connectedPlayerManager() ;

/// @brief Method get_publicServers addr 0x224ce44 size 0x48 virtual true final true
 System::Collections::Generic::IEnumerable_1<GlobalNamespace::INetworkPlayer> get_publicServers() ;

/// @brief Method get_friends addr 0x224ce8c size 0x24 virtual false final false
 System::Collections::Generic::IEnumerable_1<GlobalNamespace::INetworkPlayer> get_friends() ;

/// @brief Method get_localNetworkPlayers addr 0x224ceb0 size 0x1c virtual true final true
 System::Collections::Generic::IEnumerable_1<GlobalNamespace::INetworkPlayer> get_localNetworkPlayers() ;

/// @brief Method get_discoveryEnabled addr 0x224cecc size 0xcc virtual true final true
 bool get_discoveryEnabled() ;

/// @brief Method set_discoveryEnabled addr 0x224cf98 size 0xd8 virtual true final true
 void set_discoveryEnabled(bool value) ;

/// @brief Method get_enableFriends addr 0x224d070 size 0x24 virtual false final false
 bool get_enableFriends() ;

/// @brief Method set_enableFriends addr 0x224d094 size 0x34 virtual false final false
 void set_enableFriends(bool value) ;

/// @brief Method get_enableLocalNetwork addr 0x224d480 size 0x24 virtual true final true
 bool get_enableLocalNetwork() ;

/// @brief Method set_enableLocalNetwork addr 0x224d4a4 size 0x34 virtual true final true
 void set_enableLocalNetwork(bool value) ;

/// @brief Method Initialize addr 0x224d4d8 size 0x5d4 virtual true final true
 void Initialize() ;

/// @brief Method Dispose addr 0x224daac size 0x5d4 virtual true final true
 void Dispose() ;

/// @brief Method get_partyPlayers addr 0x224e080 size 0xd0 virtual true final true
 System::Collections::Generic::IEnumerable_1<GlobalNamespace::INetworkPlayer> get_partyPlayers() ;

/// @brief Method get_otherPlayers addr 0x224e150 size 0x78 virtual true final true
 System::Collections::Generic::IEnumerable_1<GlobalNamespace::INetworkPlayer> get_otherPlayers() ;

/// @brief Method SetServerFilter addr 0x224e1fc size 0x148 virtual true final true
...
/// @brief Method RefreshAlternateDiscoveryModels addr 0x224d0c8 size 0x3b8 virtual false final false
 void RefreshAlternateDiscoveryModels() ;

/// @brief Method HandlePlayersChanged addr 0x224e34c size 0x68 virtual false final false
 void HandlePlayersChanged() ;

/// @brief Method HandleInviteRequested addr 0x224e3b4 size 0x1c virtual false final false
 void HandleInviteRequested(GlobalNamespace::INetworkPlayer player) ;

/// @brief Method HandleJoinRequested addr 0x224e3d0 size 0x1c virtual false final false
 void HandleJoinRequested(GlobalNamespace::INetworkPlayer player) ;

/// @brief Method HandlePartyChanged addr 0x224e3ec size 0x20 virtual false final false
 void HandlePartyChanged(GlobalNamespace::INetworkPlayerModel playerModel) ;

/// @brief Method HandlePartySizeChanged addr 0x224e40c size 0x34 virtual false final false
 void HandlePartySizeChanged(int32_t size) ;

/// @brief Method HandlePartyRefreshing addr 0x224e440 size 0x1c virtual false final false
 void HandlePartyRefreshing() ;

/// @brief Method HandleLocalPlayerConnected addr 0x224e45c size 0x64 virtual false final false
 void HandleLocalPlayerConnected(GlobalNamespace::IConnectedPlayer player) ;

/// @brief Method HandleFriendConnected addr 0x224e4c0 size 0x64 virtual false final false
 void HandleFriendConnected(GlobalNamespace::IConnectedPlayer player) ;

/// @brief Method HandleLocalPlayerConnectToMasterServer addr 0x224e524 size 0xec virtual false final false
 void HandleLocalPlayerConnectToMasterServer(::StringW secret) ;

/// @brief Method HandleFriendConnectToMasterServer addr 0x224e618 size 0xec virtual false final false
 void HandleFriendConnectToMasterServer(::StringW secret) ;

/// @brief Method HandleConnectedPlayerManagerCreated addr 0x224e704 size 0x438 virtual false final false
 void HandleConnectedPlayerManagerCreated(GlobalNamespace::INetworkPlayerModel networkPlayerModel) ;

/// @brief Method HandleConnectedPlayerManagerDestroyed addr 0x224eb3c size 0xd0 virtual false final false
 void HandleConnectedPlayerManagerDestroyed(GlobalNamespace::INetworkPlayerModel networkPlayerModel) ;

/// @brief Method ResetMasterServerReachability addr 0x224ec0c size 0x50 virtual true final true
...
/// @brief Method DestroyPartyConnection addr 0x224ec5c size 0xd0 virtual true final true
 void DestroyPartyConnection() ;

/// @brief Method SetActiveNetworkPlayerModelType addr 0x224ed2c size 0x3c virtual true final true
...
/// @brief Method .ctor addr 0x224ed68 size 0x8 virtual false final false
 void _ctor() ;
