...
/// @brief Method Awake addr 0x20e7224 size 0x108 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x20e732c size 0x108 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleGameScenesManagerInstallEarlyBindings addr 0x20e7434 size 0x14c virtual false final false
...
/// @brief Method HandlePlayerNameWasEntered addr 0x20e7580 size 0x8c virtual false final false
 void HandlePlayerNameWasEntered(::StringW playerName) ;

// Ctor Parameters []
explicit VRsenalLogger() ;

/// @brief Method .ctor addr 0x20e760c size 0x8 virtual false final false
 void _ctor() ;
