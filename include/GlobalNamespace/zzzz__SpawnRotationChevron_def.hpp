...
/// @brief Method ColorWasSet addr 0x22a4468 size 0xc virtual true final false
 void ColorWasSet(UnityEngine::Color color) ;

/// @brief Method SetLightAmount addr 0x22a44e4 size 0x8 virtual false final false
 void SetLightAmount(float_t amount) ;

/// @brief Method UpdateLights addr 0x22a4474 size 0x70 virtual false final false
 void UpdateLights() ;

// Ctor Parameters []
explicit SpawnRotationChevron() ;

/// @brief Method .ctor addr 0x22a44ec size 0x8 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11011)), TypeDefinitionIndex(TypeDefinitionIndex(5099)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 2727 })}
...
/// @brief Method .ctor addr 0x22a44f4 size 0x48 virtual false final false
 void _ctor() ;
