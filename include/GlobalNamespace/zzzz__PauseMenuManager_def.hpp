...
/// @brief Method .ctor addr 0x210b3ac size 0x5c virtual false final false
...
/// @brief Method add_didPressContinueButtonEvent addr 0x2109e84 size 0x9c virtual false final false
 void add_didPressContinueButtonEvent(System::Action value) ;

/// @brief Method remove_didPressContinueButtonEvent addr 0x210a6a0 size 0x9c virtual false final false
 void remove_didPressContinueButtonEvent(System::Action value) ;

/// @brief Method add_didPressMenuButtonEvent addr 0x2109fbc size 0x9c virtual false final false
 void add_didPressMenuButtonEvent(System::Action value) ;

/// @brief Method remove_didPressMenuButtonEvent addr 0x210a7d8 size 0x9c virtual false final false
 void remove_didPressMenuButtonEvent(System::Action value) ;

/// @brief Method add_didPressRestartButtonEvent addr 0x2109f20 size 0x9c virtual false final false
 void add_didPressRestartButtonEvent(System::Action value) ;

/// @brief Method remove_didPressRestartButtonEvent addr 0x210a73c size 0x9c virtual false final false
 void remove_didPressRestartButtonEvent(System::Action value) ;

/// @brief Method add_didFinishResumeAnimationEvent addr 0x2109de8 size 0x9c virtual false final false
 void add_didFinishResumeAnimationEvent(System::Action value) ;

/// @brief Method remove_didFinishResumeAnimationEvent addr 0x210a604 size 0x9c virtual false final false
 void remove_didFinishResumeAnimationEvent(System::Action value) ;

/// @brief Method Awake addr 0x210add0 size 0x1c4 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x210af94 size 0x128 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x210b0bc size 0xe0 virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x210b19c size 0x130 virtual false final false
 void Update() ;

/// @brief Method ShowMenu addr 0x210a990 size 0x58 virtual false final false
 void ShowMenu() ;

/// @brief Method StartResumeAnimation addr 0x210ac10 size 0x28 virtual false final false
 void StartResumeAnimation() ;

/// @brief Method HandleResumeFromPauseAnimationDidFinish addr 0x210b388 size 0x1c virtual false final false
 void HandleResumeFromPauseAnimationDidFinish() ;

/// @brief Method MenuButtonPressed addr 0x210b350 size 0x38 virtual false final false
 void MenuButtonPressed() ;

/// @brief Method RestartButtonPressed addr 0x210b304 size 0x4c virtual false final false
 void RestartButtonPressed() ;

/// @brief Method ContinueButtonPressed addr 0x210b2cc size 0x38 virtual false final false
 void ContinueButtonPressed() ;

// Ctor Parameters []
explicit PauseMenuManager() ;

/// @brief Method .ctor addr 0x210b3a4 size 0x8 virtual false final false
 void _ctor() ;
