...
/// @brief Method add_totalDistanceDidChangeEvent addr 0x21440fc size 0xb0 virtual false final false
 void add_totalDistanceDidChangeEvent(System::Action_1<float_t> value) ;

/// @brief Method remove_totalDistanceDidChangeEvent addr 0x21441ac size 0xb0 virtual false final false
 void remove_totalDistanceDidChangeEvent(System::Action_1<float_t> value) ;

/// @brief Method get_leftSaberMovementDistance addr 0x214425c size 0x8 virtual false final false
 float_t get_leftSaberMovementDistance() ;

/// @brief Method get_rightSaberMovementDistance addr 0x2144264 size 0x8 virtual false final false
 float_t get_rightSaberMovementDistance() ;

/// @brief Method get_leftHandMovementDistance addr 0x214426c size 0x8 virtual false final false
 float_t get_leftHandMovementDistance() ;

/// @brief Method get_rightHandMovementDistance addr 0x2144274 size 0x8 virtual false final false
 float_t get_rightHandMovementDistance() ;

/// @brief Method get_saberMovementAveragingValueRecorder addr 0x21415c0 size 0x1c virtual false final false
 GlobalNamespace::AveragingValueRecorder get_saberMovementAveragingValueRecorder() ;

/// @brief Method get_handMovementAveragingValueRecorder addr 0x21415dc size 0x1c virtual false final false
 GlobalNamespace::AveragingValueRecorder get_handMovementAveragingValueRecorder() ;

/// @brief Method Awake addr 0x214427c size 0xb4 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x2144330 size 0x20 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x2144350 size 0x414 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit SaberActivityCounter() ;

/// @brief Method .ctor addr 0x2144764 size 0x20 virtual false final false
 void _ctor() ;
