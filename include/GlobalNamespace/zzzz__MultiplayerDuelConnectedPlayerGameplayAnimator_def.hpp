...
/// @brief Method OnDestroy addr 0x2118e68 size 0xdc virtual true final false
 void OnDestroy() ;

/// @brief Method TransitionIntoFailedState addr 0x2118f44 size 0xd4 virtual false final false
 void TransitionIntoFailedState() ;

/// @brief Method AnimateNewLeaderSelected addr 0x2119018 size 0xdc virtual true final false
 void AnimateNewLeaderSelected(bool isLeading) ;

/// @brief Method HandleStateChanged addr 0x21190f4 size 0x110 virtual true final false
 void HandleStateChanged(GlobalNamespace::GlobalNamespace__MultiplayerController__State state) ;

/// @brief Method HandlePlayerDidFail addr 0x2119204 size 0x4 virtual false final false
 void HandlePlayerDidFail() ;

// Ctor Parameters []
explicit MultiplayerDuelConnectedPlayerGameplayAnimator() ;

/// @brief Method .ctor addr 0x2119208 size 0x8 virtual false final false
 void _ctor() ;
