...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13923)), TypeDefinitionIndex(TypeDefinitionIndex(15551)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13923), inst: 3722 })}
...
/// @brief Method .ctor addr 0x21d11e0 size 0x48 virtual false final false
 void _ctor() ;
