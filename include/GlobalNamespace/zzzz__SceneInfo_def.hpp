...
/// @brief Method get_sceneName addr 0x1fbe0d8 size 0x8 virtual false final false
 ::StringW get_sceneName() ;

/// @brief Method get_disabledRootObjects addr 0x1fbe0e0 size 0x8 virtual false final false
 bool get_disabledRootObjects() ;

// Ctor Parameters []
explicit SceneInfo() ;

/// @brief Method .ctor addr 0x1fbe0e8 size 0x8 virtual false final false
 void _ctor() ;
