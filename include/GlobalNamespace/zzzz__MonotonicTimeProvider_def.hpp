...
/// @brief Method .ctor addr 0xdcc57c size 0xe4 virtual false final false
 void _ctor() ;

/// @brief Method GetTimeMs addr 0xdcc714 size 0x2c virtual true final true
 int64_t GetTimeMs() ;

/// @brief Method GetTicks addr 0xdcc740 size 0x58 virtual true final true
 int64_t GetTicks() ;
