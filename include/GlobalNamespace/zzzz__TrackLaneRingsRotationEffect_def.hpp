...
/// @brief Method .ctor addr 0x22a70c4 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Awake addr 0x22a6f44 size 0x180 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x22a70cc size 0x10 virtual false final false
 void Start() ;

/// @brief Method FixedUpdate addr 0x22a71c0 size 0x164 virtual false final false
 void FixedUpdate() ;

/// @brief Method AddRingRotationEffect addr 0x22a70dc size 0xe4 virtual false final false
 void AddRingRotationEffect(float_t angle, float_t step, int32_t propagationSpeed, float_t flexySpeed) ;

/// @brief Method GetFirstRingRotationAngle addr 0x22a74a0 size 0x38 virtual false final false
 float_t GetFirstRingRotationAngle() ;

/// @brief Method GetFirstRingDestinationRotationAngle addr 0x22a74d8 size 0x38 virtual false final false
 float_t GetFirstRingDestinationRotationAngle() ;

/// @brief Method SpawnRingRotationEffect addr 0x22a73cc size 0xd4 virtual false final false
 GlobalNamespace::GlobalNamespace__TrackLaneRingsRotationEffect__RingRotationEffect SpawnRingRotationEffect() ;

/// @brief Method RecycleRingRotationEffect addr 0x22a7324 size 0xa8 virtual false final false
...
/// @brief Method .ctor addr 0x22a7510 size 0x90 virtual false final false
 void _ctor() ;
