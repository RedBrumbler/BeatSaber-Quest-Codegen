...
/// @brief Method add_didSelectLevelEvent addr 0x21c0ff8 size 0xb0 virtual false final false
...
/// @brief Method remove_didSelectLevelEvent addr 0x21c10a8 size 0xb0 virtual false final false
...
/// @brief Method add_didSelectHeaderEvent addr 0x21c1158 size 0xb0 virtual false final false
 void add_didSelectHeaderEvent(System::Action_1<GlobalNamespace::LevelCollectionTableView> value) ;

/// @brief Method remove_didSelectHeaderEvent addr 0x21c1208 size 0xb0 virtual false final false
 void remove_didSelectHeaderEvent(System::Action_1<GlobalNamespace::LevelCollectionTableView> value) ;

/// @brief Method Init addr 0x21c12b8 size 0x40 virtual false final false
 void Init(::StringW headerText, UnityEngine::Sprite headerSprite) ;

/// @brief Method Init addr 0x21c12f8 size 0xc0 virtual false final false
 void Init() ;

/// @brief Method SetData addr 0x21c13b8 size 0x240 virtual false final false
 void SetData(System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::IPreviewBeatmapLevel> previewBeatmapLevels, System::Collections::Generic::HashSet_1<::StringW> favoriteLevelIds, bool beatmapLevelsAreSorted, bool sortPreviewBeatmapLevels) ;

/// @brief Method RefreshFavorites addr 0x21c15f8 size 0x140 virtual false final false
 void RefreshFavorites(System::Collections::Generic::HashSet_1<::StringW> favoriteLevelIds) ;

/// @brief Method OnEnable addr 0x21c1738 size 0x8c virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x21c17c4 size 0x8c virtual false final false
 void OnDisable() ;

/// @brief Method OnDestroy addr 0x21c1850 size 0xd4 virtual false final false
 void OnDestroy() ;

/// @brief Method CellSize addr 0x21c1924 size 0x8 virtual true final true
 float_t CellSize() ;

/// @brief Method NumberOfCells addr 0x21c192c size 0xb0 virtual true final true
 int32_t NumberOfCells() ;

/// @brief Method CellForIdx addr 0x21c19dc size 0x3f8 virtual true final true
 HMUI::TableCell CellForIdx(HMUI::TableView tableView, int32_t row) ;

/// @brief Method HandleDidSelectRowEvent addr 0x21c21c4 size 0x114 virtual false final false
 void HandleDidSelectRowEvent(HMUI::TableView tableView, int32_t row) ;

/// @brief Method HandleAdditionalContentModelDidInvalidateData addr 0x21c22d8 size 0xa4 virtual false final false
 void HandleAdditionalContentModelDidInvalidateData() ;

/// @brief Method CancelAsyncOperations addr 0x21c237c size 0x37c virtual false final false
 void CancelAsyncOperations() ;

/// @brief Method RefreshLevelsAvailability addr 0x21c26f8 size 0x548 virtual false final false
 void RefreshLevelsAvailability() ;

/// @brief Method SelectLevelPackHeaderCell addr 0x21c2c40 size 0x2c virtual false final false
 void SelectLevelPackHeaderCell() ;

/// @brief Method ClearSelection addr 0x21c2c6c size 0x30 virtual false final false
 void ClearSelection() ;

/// @brief Method SelectLevel addr 0x21c2c9c size 0x288 virtual false final false
 void SelectLevel(GlobalNamespace::IPreviewBeatmapLevel beatmapLevel) ;

// Ctor Parameters []
explicit LevelCollectionTableView() ;

/// @brief Method .ctor addr 0x21c2f24 size 0x8c virtual false final false
 void _ctor() ;
