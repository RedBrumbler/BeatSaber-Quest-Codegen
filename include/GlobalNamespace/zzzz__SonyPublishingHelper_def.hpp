...
/// @brief Method GetServiceId addr 0x2255aec size 0x28 virtual false final false
static ::StringW GetServiceId(GlobalNamespace::SonyPublisherSKUSettingsSO sonyPublisherSKUSettings) ;

/// @brief Method GetContentId addr 0x2255b34 size 0x20 virtual false final false
static ::StringW GetContentId(GlobalNamespace::SonyPublisherSKUSettingsSO sonyPublisherSKUSettings) ;

/// @brief Method GetContentId addr 0x2255b88 size 0x5c virtual false final false
static ::StringW GetContentId(::StringW serviceId, ::StringW productLabel) ;

/// @brief Method GetContentIdFromTitleId addr 0x2255b54 size 0x34 virtual false final false
static ::StringW GetContentIdFromTitleId(::StringW serviceIdPrefix, ::StringW titleId, ::StringW productLabel) ;

/// @brief Method GetContentIdFromNpTitleId addr 0x2255be4 size 0x18 virtual false final false
static ::StringW GetContentIdFromNpTitleId(::StringW serviceIdPrefix, ::StringW npTitleId, ::StringW productLabel) ;

/// @brief Method GetNpTitleId addr 0x2255c58 size 0x4c virtual false final false
static ::StringW GetNpTitleId(::StringW titleId) ;

/// @brief Method GetServiceIdFromTitleId addr 0x2255b14 size 0x20 virtual false final false
static ::StringW GetServiceIdFromTitleId(::StringW serviceIdPrefix, ::StringW titleId) ;

/// @brief Method GetServiceIdFromNpTitleId addr 0x2255bfc size 0x5c virtual false final false
