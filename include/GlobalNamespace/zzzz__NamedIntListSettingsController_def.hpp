...
/// @brief Method get_localizedText addr 0x218a4cc size 0xc virtual false final false
 ::StringW get_localizedText() ;

// Ctor Parameters []
explicit GlobalNamespace__NamedIntListSettingsController__TextValuePair() ;

/// @brief Method .ctor addr 0x218a4e0 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method GetInitValues addr 0x218a34c size 0xc8 virtual true final false
 bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements) ;

/// @brief Method ApplyValue addr 0x218a414 size 0x7c virtual true final false
 void ApplyValue(int32_t idx) ;

/// @brief Method TextForValue addr 0x218a490 size 0x3c virtual true final false
 ::StringW TextForValue(int32_t idx) ;

// Ctor Parameters []
explicit NamedIntListSettingsController() ;

/// @brief Method .ctor addr 0x218a4d8 size 0x8 virtual false final false
 void _ctor() ;
