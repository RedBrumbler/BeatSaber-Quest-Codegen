...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8978))}
...
/// @brief Method get_CustomBones addr 0x264fb20 size 0x8 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::Transform> get_CustomBones() ;

/// @brief Method GetBoneTransform addr 0x264fb28 size 0x58 virtual true final false
 UnityEngine::Transform GetBoneTransform(GlobalNamespace::GlobalNamespace__OVRSkeleton__BoneId boneId) ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnBeforeSerialize addr 0x264fb80 size 0x4 virtual true final true
 void UnityEngine_ISerializationCallbackReceiver_OnBeforeSerialize() ;

/// @brief Method UnityEngine.ISerializationCallbackReceiver.OnAfterDeserialize addr 0x264fb84 size 0x4 virtual true final true
 void UnityEngine_ISerializationCallbackReceiver_OnAfterDeserialize() ;

/// @brief Method AllocateBones addr 0x264fb88 size 0xc8 virtual false final false
 void AllocateBones() ;

/// @brief Method SetSkeletonType addr 0x264fc50 size 0x88 virtual false final false
 void SetSkeletonType(GlobalNamespace::GlobalNamespace__OVRSkeleton__SkeletonType skeletonType) ;

// Ctor Parameters []
explicit OVRCustomSkeleton() ;

/// @brief Method .ctor addr 0x264fcd8 size 0x8 virtual false final false
 void _ctor() ;
