...
/// @brief Method OnEnable addr 0x1fdd530 size 0x3f8 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fdd928 size 0x30 virtual false final false
 void OnDisable() ;

// Ctor Parameters []
explicit OnWillRenderObjectTrigger() ;

/// @brief Method .ctor addr 0x1fdd958 size 0x8 virtual false final false
 void _ctor() ;
