...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::PreviewDifficultyBeatmap (GlobalNamespace::LevelGameplaySetupData::*)()>(&GlobalNamespace::LevelGameplaySetupData::get_beatmapLevel)> {
  ...
  constexpr static std::size_t addrs = 0x222c8cc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::GameplayModifiers (GlobalNamespace::LevelGameplaySetupData::*)()>(&GlobalNamespace::LevelGameplaySetupData::get_gameplayModifiers)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x222c8d4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LevelGameplaySetupData::*)()>(&GlobalNamespace::LevelGameplaySetupData::_ctor)> {
  constexpr static std::size_t size = 0x68;
  constexpr static std::size_t addrs = 0x222c8dc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LevelGameplaySetupData::*)(GlobalNamespace::PreviewDifficultyBeatmap, GlobalNamespace::GameplayModifiers)>(&GlobalNamespace::LevelGameplaySetupData::_ctor)> {
  constexpr static std::size_t size = 0xa4;
  constexpr static std::size_t addrs = 0x222c944;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::PreviewDifficultyBeatmap>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<GlobalNamespace::GameplayModifiers>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LevelGameplaySetupData::*)()>(&GlobalNamespace::LevelGameplaySetupData::ClearGameplaySetupData)> {
  ...
  constexpr static std::size_t addrs = 0x222c9e8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LevelGameplaySetupData::*)(GlobalNamespace::PreviewDifficultyBeatmap)>(&GlobalNamespace::LevelGameplaySetupData::SetBeatmapLevel)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x222ca4c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::LevelGameplaySetupData::*)(GlobalNamespace::GameplayModifiers)>(&GlobalNamespace::LevelGameplaySetupData::SetGameplayModifiers)> {
  ...
  constexpr static std::size_t addrs = 0x222ca54;
...
constexpr  GlobalNamespace::LevelGameplaySetupData::operator GlobalNamespace::ILevelGameplaySetupData() const noexcept {
...
::cordl_internals::setInstanceField<GlobalNamespace::PreviewDifficultyBeatmap, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::PreviewDifficultyBeatmap>(value));
}
constexpr GlobalNamespace::PreviewDifficultyBeatmap GlobalNamespace::LevelGameplaySetupData::__get__beatmapLevel() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::PreviewDifficultyBeatmap, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void GlobalNamespace::LevelGameplaySetupData::__set__gameplayModifiers(GlobalNamespace::GameplayModifiers value)  {
::cordl_internals::setInstanceField<GlobalNamespace::GameplayModifiers, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<GlobalNamespace::GameplayModifiers>(value));
}
constexpr GlobalNamespace::GameplayModifiers GlobalNamespace::LevelGameplaySetupData::__get__gameplayModifiers() const {
return ::cordl_internals::getInstanceField<GlobalNamespace::GameplayModifiers, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, beatmapLevel, gameplayModifiers);
}
