...
/// @brief Method MoveNext addr 0x1fb061c size 0x194 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x1fb07b0 size 0xc virtual true final true
...
/// @brief Method .ctor addr 0x1fb054c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <RunSync>b__0 addr 0x1fb0554 size 0xc8 virtual false final false
...
/// @brief Method RunSync addr 0x1fb044c size 0x100 virtual false final false
...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13788)), TypeDefinitionIndex(TypeDefinitionIndex(2638))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13788), inst: 2 })
...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13789))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13789), inst: 2 })
