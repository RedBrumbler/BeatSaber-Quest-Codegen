...
/// @brief Method Awake addr 0x227f7e4 size 0x94 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x227f994 size 0x138 virtual false final false
 void OnDestroy() ;

/// @brief Method UpdateScale addr 0x227f878 size 0x11c virtual false final false
 void UpdateScale(float_t progress) ;

/// @brief Method HandleObstacleControllerDidUpdateProgress addr 0x227facc size 0x28 virtual false final false
 void HandleObstacleControllerDidUpdateProgress(GlobalNamespace::ObstacleController obstacleController, float_t time) ;

/// @brief Method HandleObstacleControllerDidInit addr 0x227faf4 size 0xd0 virtual false final false
 void HandleObstacleControllerDidInit(GlobalNamespace::ObstacleControllerBase obstacleController) ;

// Ctor Parameters []
explicit ObstacleScaleUp() ;

/// @brief Method .ctor addr 0x227fbc4 size 0x10 virtual false final false
 void _ctor() ;
