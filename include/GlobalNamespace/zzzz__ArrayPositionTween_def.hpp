...
/// @brief Method get_clipCaps addr 0x21ea0bc size 0x8 virtual true final true
 UnityEngine::Timeline::ClipCaps get_clipCaps() ;

/// @brief Method CreatePlayable addr 0x21ea0c4 size 0x144 virtual true final false
 UnityEngine::Playables::Playable CreatePlayable(UnityEngine::Playables::PlayableGraph graph, UnityEngine::GameObject go) ;

// Ctor Parameters []
explicit ArrayPositionTween() ;

/// @brief Method .ctor addr 0x21ea208 size 0x8 virtual false final false
 void _ctor() ;
