...
/// @brief Method get_renderers addr 0x1fdcbec size 0x8 virtual false final false
 ::ArrayW<UnityEngine::Renderer> get_renderers() ;

/// @brief Method get_materialPropertyBlock addr 0x1fdc9d4 size 0x6c virtual false final false
 UnityEngine::MaterialPropertyBlock get_materialPropertyBlock() ;

/// @brief Method ApplyChanges addr 0x1fdc770 size 0x1f0 virtual false final false
 void ApplyChanges() ;

// Ctor Parameters []
explicit MaterialPropertyBlockController() ;

/// @brief Method .ctor addr 0x1fdcbf4 size 0x8 virtual false final false
 void _ctor() ;
