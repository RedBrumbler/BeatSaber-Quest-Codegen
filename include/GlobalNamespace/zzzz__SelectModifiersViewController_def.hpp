...
/// @brief Method get_gameplayModifiers addr 0x21b019c size 0x1c virtual false final false
 GlobalNamespace::GameplayModifiers get_gameplayModifiers() ;

/// @brief Method Setup addr 0x21b01b8 size 0x1c virtual false final false
 void Setup(GlobalNamespace::GameplayModifiers gameplayModifiers) ;

/// @brief Method DidActivate addr 0x21b01d4 size 0xa0 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

// Ctor Parameters []
explicit SelectModifiersViewController() ;

/// @brief Method .ctor addr 0x21b0274 size 0x8 virtual false final false
 void _ctor() ;
