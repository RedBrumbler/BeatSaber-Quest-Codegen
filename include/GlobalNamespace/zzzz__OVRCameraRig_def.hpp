...
/// @brief Method get_leftEyeCamera addr 0x25d9b2c size 0x1c virtual false final false
 UnityEngine::Camera get_leftEyeCamera() ;

/// @brief Method get_rightEyeCamera addr 0x25d9b48 size 0x1c virtual false final false
 UnityEngine::Camera get_rightEyeCamera() ;

/// @brief Method get_trackingSpace addr 0x25d9b64 size 0x8 virtual false final false
 UnityEngine::Transform get_trackingSpace() ;

/// @brief Method set_trackingSpace addr 0x25d9b6c size 0x8 virtual false final false
 void set_trackingSpace(UnityEngine::Transform value) ;

/// @brief Method get_leftEyeAnchor addr 0x25d9b74 size 0x8 virtual false final false
 UnityEngine::Transform get_leftEyeAnchor() ;

/// @brief Method set_leftEyeAnchor addr 0x25d9b7c size 0x8 virtual false final false
 void set_leftEyeAnchor(UnityEngine::Transform value) ;

/// @brief Method get_centerEyeAnchor addr 0x25d9b84 size 0x8 virtual false final false
 UnityEngine::Transform get_centerEyeAnchor() ;

/// @brief Method set_centerEyeAnchor addr 0x25d9b8c size 0x8 virtual false final false
 void set_centerEyeAnchor(UnityEngine::Transform value) ;

/// @brief Method get_rightEyeAnchor addr 0x25d9b94 size 0x8 virtual false final false
 UnityEngine::Transform get_rightEyeAnchor() ;

/// @brief Method set_rightEyeAnchor addr 0x25d9b9c size 0x8 virtual false final false
 void set_rightEyeAnchor(UnityEngine::Transform value) ;

/// @brief Method get_leftHandAnchor addr 0x25d9ba4 size 0x8 virtual false final false
 UnityEngine::Transform get_leftHandAnchor() ;

/// @brief Method set_leftHandAnchor addr 0x25d9bac size 0x8 virtual false final false
 void set_leftHandAnchor(UnityEngine::Transform value) ;

/// @brief Method get_rightHandAnchor addr 0x25d9bb4 size 0x8 virtual false final false
 UnityEngine::Transform get_rightHandAnchor() ;

/// @brief Method set_rightHandAnchor addr 0x25d9bbc size 0x8 virtual false final false
 void set_rightHandAnchor(UnityEngine::Transform value) ;

/// @brief Method get_leftControllerAnchor addr 0x25d9bc4 size 0x8 virtual false final false
 UnityEngine::Transform get_leftControllerAnchor() ;

/// @brief Method set_leftControllerAnchor addr 0x25d9bcc size 0x8 virtual false final false
 void set_leftControllerAnchor(UnityEngine::Transform value) ;

/// @brief Method get_rightControllerAnchor addr 0x25d9bd4 size 0x8 virtual false final false
 UnityEngine::Transform get_rightControllerAnchor() ;

/// @brief Method set_rightControllerAnchor addr 0x25d9bdc size 0x8 virtual false final false
 void set_rightControllerAnchor(UnityEngine::Transform value) ;

/// @brief Method get_trackerAnchor addr 0x25d9be4 size 0x8 virtual false final false
 UnityEngine::Transform get_trackerAnchor() ;

/// @brief Method set_trackerAnchor addr 0x25d9bec size 0x8 virtual false final false
 void set_trackerAnchor(UnityEngine::Transform value) ;

/// @brief Method add_UpdatedAnchors addr 0x25d9bf4 size 0xb0 virtual false final false
 void add_UpdatedAnchors(System::Action_1<GlobalNamespace::OVRCameraRig> value) ;

/// @brief Method remove_UpdatedAnchors addr 0x25d9ca4 size 0xb0 virtual false final false
 void remove_UpdatedAnchors(System::Action_1<GlobalNamespace::OVRCameraRig> value) ;

/// @brief Method add_TrackingSpaceChanged addr 0x25d9d54 size 0xb0 virtual false final false
 void add_TrackingSpaceChanged(System::Action_1<UnityEngine::Transform> value) ;

/// @brief Method remove_TrackingSpaceChanged addr 0x25d9e04 size 0xb0 virtual false final false
 void remove_TrackingSpaceChanged(System::Action_1<UnityEngine::Transform> value) ;

/// @brief Method Awake addr 0x25d9eb4 size 0x18 virtual true final false
 void Awake() ;

/// @brief Method Start addr 0x25d9ecc size 0x88 virtual true final false
 void Start() ;

/// @brief Method FixedUpdate addr 0x25d9f54 size 0x20 virtual true final false
 void FixedUpdate() ;

/// @brief Method Update addr 0x25d9f74 size 0x24 virtual true final false
 void Update() ;

/// @brief Method OnDestroy addr 0x25d9f98 size 0x74 virtual true final false
 void OnDestroy() ;

/// @brief Method UpdateAnchors addr 0x25da00c size 0xe14 virtual true final false
 void UpdateAnchors(bool updateEyeAnchors, bool updateHandAnchors) ;

/// @brief Method OnBeforeRenderCallback addr 0x25db41c size 0xd4 virtual true final false
 void OnBeforeRenderCallback() ;

/// @brief Method CheckForTrackingSpaceChangesAndRaiseEvent addr 0x25db4f0 size 0x27c virtual true final false
 void CheckForTrackingSpaceChangesAndRaiseEvent() ;

/// @brief Method RaiseUpdatedAnchorsEvent addr 0x25db76c size 0x20 virtual true final false
 void RaiseUpdatedAnchorsEvent() ;

/// @brief Method EnsureGameObjectIntegrity addr 0x25db78c size 0x80c virtual true final false
 void EnsureGameObjectIntegrity() ;

/// @brief Method ConfigureAnchor addr 0x25dbf98 size 0x25c virtual true final false
 UnityEngine::Transform ConfigureAnchor(UnityEngine::Transform root, ::StringW name) ;

/// @brief Method ComputeTrackReferenceMatrix addr 0x25dc1f4 size 0x2d4 virtual true final false
 UnityEngine::Matrix4x4 ComputeTrackReferenceMatrix() ;

/// @brief Method CheckForAnchorsInParent addr 0x25dc4c8 size 0xe0 virtual false final false
 void CheckForAnchorsInParent() ;

// Ctor Parameters []
explicit OVRCameraRig() ;

/// @brief Method .ctor addr 0x25dc5a8 size 0x150 virtual false final false
 void _ctor() ;
