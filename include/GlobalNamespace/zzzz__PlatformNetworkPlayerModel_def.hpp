...
/// @brief Method .ctor addr 0x224af84 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_friends addr 0x224af74 size 0x10 virtual false final false
 System::Collections::Generic::IEnumerable_1<GlobalNamespace::INetworkPlayer> get_friends() ;

/// @brief Method DestroyPartyConnection addr 0x22476d4 size 0x20 virtual true final false
 void DestroyPartyConnection() ;

// Ctor Parameters []
explicit PlatformNetworkPlayerModel() ;

/// @brief Method .ctor addr 0x2247ca4 size 0x8 virtual false final false
 void _ctor() ;
