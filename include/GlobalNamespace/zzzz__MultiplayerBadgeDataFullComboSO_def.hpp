...
/// @brief Method CalculateBadgeData addr 0x210fa28 size 0x464 virtual true final false
...
/// @brief Method .ctor addr 0x210feec size 0x10 virtual false final false
 void _ctor() ;
