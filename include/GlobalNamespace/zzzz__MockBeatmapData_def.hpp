...
/// @brief Method get_numberOfLines addr 0x22b2f58 size 0x8 virtual false final false
 int32_t get_numberOfLines() ;

/// @brief Method set_numberOfLines addr 0x22b2f60 size 0x8 virtual false final false
 void set_numberOfLines(int32_t value) ;

/// @brief Method get_songEndTime addr 0x22b2f68 size 0x8 virtual false final false
 float_t get_songEndTime() ;

/// @brief Method set_songEndTime addr 0x22b2f70 size 0x8 virtual false final false
 void set_songEndTime(float_t value) ;

/// @brief Method get_leftNotes addr 0x22b2f78 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::MockNoteData> get_leftNotes() ;

/// @brief Method set_leftNotes addr 0x22b2f80 size 0x8 virtual false final false
 void set_leftNotes(::ArrayW<GlobalNamespace::MockNoteData> value) ;

/// @brief Method get_rightNotes addr 0x22b2f88 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::MockNoteData> get_rightNotes() ;

/// @brief Method set_rightNotes addr 0x22b2f90 size 0x8 virtual false final false
 void set_rightNotes(::ArrayW<GlobalNamespace::MockNoteData> value) ;

/// @brief Method get_bombNotes addr 0x22b2f98 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::MockNoteData> get_bombNotes() ;

/// @brief Method set_bombNotes addr 0x22b2fa0 size 0x8 virtual false final false
 void set_bombNotes(::ArrayW<GlobalNamespace::MockNoteData> value) ;

/// @brief Method get_obstacles addr 0x22b2fa8 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::MockObstacleData> get_obstacles() ;

/// @brief Method set_obstacles addr 0x22b2fb0 size 0x8 virtual false final false
 void set_obstacles(::ArrayW<GlobalNamespace::MockObstacleData> value) ;

// Ctor Parameters []
explicit MockBeatmapData() ;

/// @brief Method .ctor addr 0x22b2fb8 size 0x8 virtual false final false
 void _ctor() ;
