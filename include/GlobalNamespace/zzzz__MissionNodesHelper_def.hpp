...
/// @brief Method GetAllNodesFromRoot addr 0x2180580 size 0x80 virtual false final false
...
/// @brief Method VisitAllTree addr 0x2180600 size 0xd8 virtual false final false
...
/// @brief Method CycleDetection addr 0x21806d8 size 0x7c virtual false final false
static bool CycleDetection(GlobalNamespace::MissionNode node) ;

/// @brief Method CycleDetection addr 0x2180754 size 0x154 virtual false final false
...
/// @brief Method FinalNodeIsFinal addr 0x21808a8 size 0x88 virtual false final false
static bool FinalNodeIsFinal(GlobalNamespace::MissionNode finalNode, GlobalNamespace::MissionNode rootNode) ;

/// @brief Method FinalNodeIsFinal addr 0x2180930 size 0x11c virtual false final false
...
/// @brief Method .ctor addr 0x2180a4c size 0x8 virtual false final false
 void _ctor() ;
