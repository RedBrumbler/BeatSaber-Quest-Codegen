...
/// @brief Method get_hidden addr 0x2651350 size 0x8 virtual false final false
 bool get_hidden() ;

/// @brief Method set_hidden addr 0x2651358 size 0xc virtual false final false
 void set_hidden(bool value) ;

/// @brief Method get_currentScale addr 0x2651364 size 0x8 virtual false final false
 float_t get_currentScale() ;

/// @brief Method set_currentScale addr 0x265136c size 0x8 virtual false final false
 void set_currentScale(float_t value) ;

/// @brief Method get_instance addr 0x2651374 size 0x214 virtual false final false
static GlobalNamespace::OVRGazePointer get_instance() ;

/// @brief Method get_visibilityStrength addr 0x2651588 size 0x9c virtual false final false
 float_t get_visibilityStrength() ;

/// @brief Method get_SelectionProgress addr 0x2651624 size 0x78 virtual false final false
 float_t get_SelectionProgress() ;

/// @brief Method set_SelectionProgress addr 0x265169c size 0x80 virtual false final false
 void set_SelectionProgress(float_t value) ;

/// @brief Method Awake addr 0x265171c size 0x170 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x265188c size 0x194 virtual false final false
 void Update() ;

/// @brief Method SetCursorStartDest addr 0x2651c54 size 0x1e0 virtual true final false
 void SetCursorStartDest(UnityEngine::Vector3 _, UnityEngine::Vector3 pos, UnityEngine::Vector3 normal) ;

/// @brief Method SetCursorRay addr 0x2651e54 size 0x4 virtual true final false
 void SetCursorRay(UnityEngine::Transform ray) ;

/// @brief Method LateUpdate addr 0x2651e58 size 0x178 virtual false final false
 void LateUpdate() ;

/// @brief Method RequestHide addr 0x2651fd0 size 0x2c virtual false final false
 void RequestHide() ;

/// @brief Method RequestShow addr 0x2651e34 size 0x20 virtual false final false
 void RequestShow() ;

/// @brief Method Hide addr 0x2651a20 size 0x11c virtual false final false
 void Hide() ;

/// @brief Method Show addr 0x2651b3c size 0x118 virtual false final false
 void Show() ;

// Ctor Parameters []
explicit OVRGazePointer() ;

/// @brief Method .ctor addr 0x2651ffc size 0x2c virtual false final false
 void _ctor() ;
