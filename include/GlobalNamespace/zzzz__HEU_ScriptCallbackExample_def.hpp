...
/// @brief Method AssetCallbackWithMsg addr 0x2012d40 size 0x98 virtual false final false
 void AssetCallbackWithMsg(::StringW msg) ;

/// @brief Method AssetCallbackNoMsg addr 0x2012dd8 size 0x68 virtual false final false
 void AssetCallbackNoMsg() ;

// Ctor Parameters []
explicit HEU_ScriptCallbackExample() ;

/// @brief Method .ctor addr 0x2012e40 size 0x8 virtual false final false
 void _ctor() ;
