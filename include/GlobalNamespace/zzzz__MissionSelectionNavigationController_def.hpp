...
/// @brief Method .ctor addr 0x21ac5bc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <PresentMissionClearedIfNeeded>b__0 addr 0x21ac5cc size 0xbc virtual false final false
 void _PresentMissionClearedIfNeeded_b__0() ;

/// @brief Method <PresentMissionClearedIfNeeded>b__1 addr 0x21ac688 size 0x20 virtual false final false
...
/// @brief Method add_didPressPlayButtonEvent addr 0x21ac01c size 0xb0 virtual false final false
 void add_didPressPlayButtonEvent(System::Action_1<GlobalNamespace::MissionSelectionNavigationController> value) ;

/// @brief Method remove_didPressPlayButtonEvent addr 0x21ac0cc size 0xb0 virtual false final false
 void remove_didPressPlayButtonEvent(System::Action_1<GlobalNamespace::MissionSelectionNavigationController> value) ;

/// @brief Method get_selectedMissionNode addr 0x21ac17c size 0x1c virtual false final false
 GlobalNamespace::MissionNode get_selectedMissionNode() ;

/// @brief Method DidActivate addr 0x21ac198 size 0x174 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x21ac30c size 0x104 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method HandleMissionSelectionMapViewControllerDidSelectMissionLevel addr 0x21ac410 size 0x74 virtual false final false
...
/// @brief Method HandleMissionLevelDetailViewControllerDidPressPlayButton addr 0x21ac484 size 0x20 virtual false final false
...
/// @brief Method PresentMissionClearedIfNeeded addr 0x21ac4a4 size 0x118 virtual false final false
 void PresentMissionClearedIfNeeded(System::Action_1<bool> finishedCallback) ;

// Ctor Parameters []
explicit MissionSelectionNavigationController() ;

/// @brief Method .ctor addr 0x21ac5c4 size 0x8 virtual false final false
 void _ctor() ;
