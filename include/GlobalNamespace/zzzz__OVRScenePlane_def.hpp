...
/// @brief Method Execute addr 0x263a700 size 0x84 virtual true final true
 void Execute() ;
...
/// @brief Method HasBoundaryChanged addr 0x263a784 size 0xb0 virtual false final false
 bool HasBoundaryChanged() ;

/// @brief Method SetNaN addr 0x263a834 size 0x14 virtual false final false
static void SetNaN(Unity::Collections::NativeArray_1<UnityEngine::Vector2> array) ;

/// @brief Method Execute addr 0x263a848 size 0xa8 virtual true final true
 void Execute() ;
...
/// @brief Method get_Width addr 0x26399d4 size 0x8 virtual false final false
 float_t get_Width() ;

/// @brief Method set_Width addr 0x26399dc size 0x8 virtual false final false
 void set_Width(float_t value) ;

/// @brief Method get_Height addr 0x26399e4 size 0x8 virtual false final false
 float_t get_Height() ;

/// @brief Method set_Height addr 0x26399ec size 0x8 virtual false final false
 void set_Height(float_t value) ;

/// @brief Method get_Dimensions addr 0x26399f4 size 0x8 virtual false final false
 UnityEngine::Vector2 get_Dimensions() ;

/// @brief Method get_Boundary addr 0x26399fc size 0x8 virtual false final false
 System::Collections::Generic::IReadOnlyList_1<UnityEngine::Vector2> get_Boundary() ;

/// @brief Method get_ScaleChildren addr 0x2639a04 size 0x8 virtual false final false
 bool get_ScaleChildren() ;

/// @brief Method set_ScaleChildren addr 0x2639a0c size 0x48 virtual false final false
 void set_ScaleChildren(bool value) ;

/// @brief Method SetChildScale addr 0x2639a54 size 0x90 virtual false final false
static void SetChildScale(UnityEngine::Transform parentTransform, float_t width, float_t height) ;

/// @brief Method Awake addr 0x2639ae4 size 0xd4 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x2639bb8 size 0x4 virtual false final false
 void Start() ;

/// @brief Method IOVRSceneComponent.Initialize addr 0x2639bec size 0x120 virtual true final true
 void IOVRSceneComponent_Initialize() ;

/// @brief Method ScheduleGetLengthJob addr 0x2639d0c size 0x188 virtual false final false
 void ScheduleGetLengthJob() ;

/// @brief Method RequestBoundary addr 0x2639bbc size 0x30 virtual false final false
 void RequestBoundary() ;

/// @brief Method Update addr 0x2639e94 size 0x6a4 virtual false final false
 void Update() ;

/// @brief Method OnDisable addr 0x263a568 size 0x114 virtual false final false
 void OnDisable() ;

// Ctor Parameters []
explicit OVRScenePlane() ;

/// @brief Method .ctor addr 0x263a67c size 0x84 virtual false final false
 void _ctor() ;
