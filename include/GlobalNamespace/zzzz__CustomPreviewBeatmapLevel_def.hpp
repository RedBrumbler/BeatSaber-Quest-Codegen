...
/// @brief Method MoveNext addr 0x22224dc size 0x38c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2222868 size 0x58 virtual true final true
...
/// @brief Method get_spriteAsyncLoader addr 0x2222338 size 0x8 virtual false final false
 GlobalNamespace::ISpriteAsyncLoader get_spriteAsyncLoader() ;

/// @brief Method get_standardLevelInfoSaveData addr 0x2222340 size 0x8 virtual false final false
 GlobalNamespace::StandardLevelInfoSaveData get_standardLevelInfoSaveData() ;

/// @brief Method get_customLevelPath addr 0x2222348 size 0x8 virtual false final false
 ::StringW get_customLevelPath() ;

/// @brief Method get_levelID addr 0x2222350 size 0x8 virtual true final true
 ::StringW get_levelID() ;

/// @brief Method get_songName addr 0x2222358 size 0x8 virtual true final true
 ::StringW get_songName() ;

/// @brief Method get_songSubName addr 0x2222360 size 0x8 virtual true final true
 ::StringW get_songSubName() ;

/// @brief Method get_songAuthorName addr 0x2222368 size 0x8 virtual true final true
 ::StringW get_songAuthorName() ;

/// @brief Method get_levelAuthorName addr 0x2222370 size 0x8 virtual true final true
 ::StringW get_levelAuthorName() ;

/// @brief Method get_beatsPerMinute addr 0x2222378 size 0x8 virtual true final true
 float_t get_beatsPerMinute() ;

/// @brief Method get_songTimeOffset addr 0x2222380 size 0x8 virtual true final true
 float_t get_songTimeOffset() ;

/// @brief Method get_songDuration addr 0x2222388 size 0x8 virtual true final true
 float_t get_songDuration() ;

/// @brief Method get_shuffle addr 0x2222390 size 0x8 virtual true final true
 float_t get_shuffle() ;

/// @brief Method get_shufflePeriod addr 0x2222398 size 0x8 virtual true final true
 float_t get_shufflePeriod() ;

/// @brief Method get_previewStartTime addr 0x22223a0 size 0x8 virtual true final true
 float_t get_previewStartTime() ;

/// @brief Method get_previewDuration addr 0x22223a8 size 0x8 virtual true final true
 float_t get_previewDuration() ;

/// @brief Method get_environmentInfo addr 0x22223b0 size 0x8 virtual true final true
 GlobalNamespace::EnvironmentInfoSO get_environmentInfo() ;

/// @brief Method get_allDirectionsEnvironmentInfo addr 0x22223b8 size 0x8 virtual true final true
 GlobalNamespace::EnvironmentInfoSO get_allDirectionsEnvironmentInfo() ;

/// @brief Method get_environmentInfos addr 0x22223c0 size 0x8 virtual true final true
 ::ArrayW<GlobalNamespace::EnvironmentInfoSO> get_environmentInfos() ;

/// @brief Method get_defaultCoverImage addr 0x22223c8 size 0x8 virtual false final false
 UnityEngine::Sprite get_defaultCoverImage() ;

/// @brief Method get_previewDifficultyBeatmapSets addr 0x22223d0 size 0x8 virtual true final true
 System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::PreviewDifficultyBeatmapSet> get_previewDifficultyBeatmapSets() ;

/// @brief Method get_songPreviewAudioClipPath addr 0x22220d8 size 0x70 virtual true final true
 ::StringW get_songPreviewAudioClipPath() ;

/// @brief Method get_beatmapOverrideColorSchemes addr 0x22223d8 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::ColorScheme> get_beatmapOverrideColorSchemes() ;

/// @brief Method GetCoverImageAsync addr 0x22223e0 size 0xfc virtual true final true
...
/// @brief Method .ctor addr 0x2222208 size 0xe4 virtual false final false
