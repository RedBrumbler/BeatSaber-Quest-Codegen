...
/// @brief Method GetInitValues addr 0x218b698 size 0x114 virtual true final false
 bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements) ;

/// @brief Method ApplyValue addr 0x218b7ac size 0xac virtual true final false
 void ApplyValue(int32_t idx) ;

/// @brief Method TextForValue addr 0x218b858 size 0xcc virtual true final false
 ::StringW TextForValue(int32_t idx) ;

// Ctor Parameters []
explicit SmoothCameraSmoothnessSettingsController() ;

/// @brief Method .ctor addr 0x218b924 size 0x8 virtual false final false
 void _ctor() ;
