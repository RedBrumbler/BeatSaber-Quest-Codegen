...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14944)), TypeDefinitionIndex(TypeDefinitionIndex(14938)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14944), inst: 922 })}
...
/// @brief Method ProcessInsertedEventDataInternal addr 0xda1ec0 size 0x110 virtual true final false
...
/// @brief Method ProcessBeforeDeleteEventDataInternal addr 0xda1fd0 size 0xfc virtual true final false
...
/// @brief Method .ctor addr 0xda20cc size 0x48 virtual false final false
 void _ctor() ;
