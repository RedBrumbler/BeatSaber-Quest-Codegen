...
/// @brief Method get_renderer addr 0x20de878 size 0x8 virtual false final false
 UnityEngine::Renderer get_renderer() ;

/// @brief Method get_materialPairs addr 0x20de880 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x20de888 size 0x90 virtual false final false
...
/// @brief Method .ctor addr 0x20de918 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method SwapMaterials addr 0x20de5cc size 0x254 virtual false final false
 void SwapMaterials(bool alternative) ;

// Ctor Parameters []
explicit BTSCharacterMaterialSwitcher() ;

/// @brief Method .ctor addr 0x20de870 size 0x8 virtual false final false
 void _ctor() ;
