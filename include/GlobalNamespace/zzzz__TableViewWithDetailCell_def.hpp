...
/// @brief Method add_didSelectContentCellEvent addr 0x1fddeec size 0xb0 virtual false final false
 void add_didSelectContentCellEvent(System::Action_2<GlobalNamespace::TableViewWithDetailCell,int32_t> value) ;

/// @brief Method remove_didSelectContentCellEvent addr 0x1fddf9c size 0xb0 virtual false final false
 void remove_didSelectContentCellEvent(System::Action_2<GlobalNamespace::TableViewWithDetailCell,int32_t> value) ;

/// @brief Method add_didDeselectContentCellEvent addr 0x1fde04c size 0xb0 virtual false final false
 void add_didDeselectContentCellEvent(System::Action_2<GlobalNamespace::TableViewWithDetailCell,int32_t> value) ;

/// @brief Method remove_didDeselectContentCellEvent addr 0x1fde0fc size 0xb0 virtual false final false
 void remove_didDeselectContentCellEvent(System::Action_2<GlobalNamespace::TableViewWithDetailCell,int32_t> value) ;

/// @brief Method get_dataSource addr 0x1fde1ac size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__TableViewWithDetailCell__IDataSource get_dataSource() ;

/// @brief Method set_dataSource addr 0x1fde1b4 size 0x24 virtual false final false
 void set_dataSource(GlobalNamespace::GlobalNamespace__TableViewWithDetailCell__IDataSource value) ;

/// @brief Method CellSize addr 0x1fde1d8 size 0xa0 virtual true final true
 float_t CellSize() ;

/// @brief Method NumberOfCells addr 0x1fde278 size 0xb4 virtual true final true
 int32_t NumberOfCells() ;

/// @brief Method CellForIdx addr 0x1fde32c size 0x1e0 virtual true final true
 HMUI::TableCell CellForIdx(HMUI::TableView tableView, int32_t idx) ;

/// @brief Method ReloadData addr 0x1fde50c size 0x28 virtual true final false
 void ReloadData() ;

/// @brief Method ReloadData addr 0x1fde534 size 0x3c virtual false final false
 void ReloadData(int32_t currentNewIndex) ;

/// @brief Method DidSelectCellWithIdx addr 0x1fde570 size 0x130 virtual true final false
 void DidSelectCellWithIdx(int32_t idx) ;

// Ctor Parameters []
explicit TableViewWithDetailCell() ;

/// @brief Method .ctor addr 0x1fde6a0 size 0x10 virtual false final false
 void _ctor() ;
