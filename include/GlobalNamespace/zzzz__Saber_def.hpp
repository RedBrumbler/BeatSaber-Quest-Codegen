...
/// @brief Method get_saberType addr 0x2143e78 size 0x1c virtual false final false
 GlobalNamespace::SaberType get_saberType() ;

/// @brief Method get_saberBladeTopPos addr 0x2143e94 size 0xc virtual false final false
 UnityEngine::Vector3 get_saberBladeTopPos() ;

/// @brief Method get_saberBladeBottomPos addr 0x2143ea0 size 0xc virtual false final false
 UnityEngine::Vector3 get_saberBladeBottomPos() ;

/// @brief Method get_handlePos addr 0x2143eac size 0xc virtual false final false
 UnityEngine::Vector3 get_handlePos() ;

/// @brief Method get_handleRot addr 0x2143eb8 size 0xc virtual false final false
 UnityEngine::Quaternion get_handleRot() ;

/// @brief Method get_bladeSpeed addr 0x2143ec4 size 0x1c virtual false final false
 float_t get_bladeSpeed() ;

/// @brief Method get_movementData addr 0x2143ee0 size 0x8 virtual false final false
 GlobalNamespace::SaberMovementData get_movementData() ;

/// @brief Method ManualUpdate addr 0x2143ee8 size 0x134 virtual false final false
 void ManualUpdate() ;

/// @brief Method OverridePositionAndRotation addr 0x214401c size 0x78 virtual false final false
 void OverridePositionAndRotation(UnityEngine::Vector3 pos, UnityEngine::Quaternion rot) ;

// Ctor Parameters []
explicit Saber() ;

/// @brief Method .ctor addr 0x2144094 size 0x68 virtual false final false
 void _ctor() ;
