...
/// @brief Method add_edgeDistanceFromCenterWasCalculatedEvent addr 0x21280c8 size 0xb0 virtual false final false
 void add_edgeDistanceFromCenterWasCalculatedEvent(System::Action_1<float_t> value) ;

/// @brief Method remove_edgeDistanceFromCenterWasCalculatedEvent addr 0x2128178 size 0xb0 virtual false final false
 void remove_edgeDistanceFromCenterWasCalculatedEvent(System::Action_1<float_t> value) ;

/// @brief Method get_isEdgeDistanceFromCenterCalculated addr 0x2128228 size 0x8 virtual false final false
 bool get_isEdgeDistanceFromCenterCalculated() ;

/// @brief Method set_isEdgeDistanceFromCenterCalculated addr 0x2128230 size 0xc virtual false final false
 void set_isEdgeDistanceFromCenterCalculated(bool value) ;

/// @brief Method get_edgeDistanceFromCenter addr 0x212823c size 0x8 virtual false final false
 float_t get_edgeDistanceFromCenter() ;

/// @brief Method set_edgeDistanceFromCenter addr 0x2128244 size 0x8 virtual false final false
 void set_edgeDistanceFromCenter(float_t value) ;

/// @brief Method Start addr 0x212824c size 0xa4 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2128418 size 0x94 virtual false final false
 void OnDestroy() ;

/// @brief Method HandlePlayersLayoutWasCalculated addr 0x21282f0 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x212855c size 0x8 virtual false final false
 void _ctor() ;
