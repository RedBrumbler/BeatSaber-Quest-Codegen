...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11108))}
...
/// @brief Method InstallBindings addr 0x2152a2c size 0x234 virtual true final false
 void InstallBindings() ;

// Ctor Parameters []
explicit NoteDebrisPoolInstaller() ;

/// @brief Method .ctor addr 0x2152c60 size 0x8 virtual false final false
 void _ctor() ;
