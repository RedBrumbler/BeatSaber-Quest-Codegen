...
/// @brief Method OnDestroy addr 0x211dd64 size 0x110 virtual true final false
 void OnDestroy() ;

/// @brief Method InitializeIfNeeded addr 0x211e000 size 0xd0 virtual false final false
 void InitializeIfNeeded() ;

/// @brief Method HandleStateChanged addr 0x211e0d0 size 0x1a4 virtual true final false
 void HandleStateChanged(GlobalNamespace::GlobalNamespace__MultiplayerController__State state) ;

/// @brief Method AnimateNewLeaderSelected addr 0x211e48c size 0xec virtual true final false
 void AnimateNewLeaderSelected(bool isLeading) ;

/// @brief Method TransitionIntoFailedState addr 0x211e3d8 size 0xb4 virtual false final false
 void TransitionIntoFailedState() ;

/// @brief Method HandlePlayerDidFinish addr 0x211e578 size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x211e5ac size 0x14 virtual false final false
 void _ctor() ;

/// @brief Method <InitializeIfNeeded>b__6_0 addr 0x211e5d4 size 0x40 virtual false final false
