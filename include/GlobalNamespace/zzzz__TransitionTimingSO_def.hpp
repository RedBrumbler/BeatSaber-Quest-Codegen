...
/// @brief Method get_easeType addr 0x2163d14 size 0x8 virtual false final false
 GlobalNamespace::EaseType get_easeType() ;

/// @brief Method get_easeDuration addr 0x2163d1c size 0x8 virtual false final false
 float_t get_easeDuration() ;

// Ctor Parameters []
explicit TransitionTimingSO() ;

/// @brief Method .ctor addr 0x2163d24 size 0x8 virtual false final false
 void _ctor() ;
