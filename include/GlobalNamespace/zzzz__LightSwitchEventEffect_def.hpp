...
/// @brief Method get_lightsId addr 0x229d56c size 0x8 virtual false final false
 int32_t get_lightsId() ;

/// @brief Method get_eventType addr 0x229d574 size 0x8 virtual false final false
 GlobalNamespace::BasicBeatmapEventType get_eventType() ;

/// @brief Method Awake addr 0x229d57c size 0x1cc virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x229d780 size 0x1c0 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x229d940 size 0xb0 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleColorChangeBeatmapEvent addr 0x229d9f0 size 0x348 virtual false final false
 void HandleColorChangeBeatmapEvent(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

/// @brief Method HandleColorBoostBeatmapEvent addr 0x229e0ac size 0xcc virtual false final false
 void HandleColorBoostBeatmapEvent(GlobalNamespace::ColorBoostBeatmapEventData eventData) ;

/// @brief Method SetupTweenAndSaveOtherColors addr 0x229d748 size 0x38 virtual false final false
...
/// @brief Method CheckNextEventForFade addr 0x229dd5c size 0x218 virtual false final false
 void CheckNextEventForFade(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

/// @brief Method GetNormalColor addr 0x229df74 size 0x9c virtual false final false
 UnityEngine::Color GetNormalColor(int32_t beatmapEventValue, bool colorBoost) ;

/// @brief Method GetHighlightColor addr 0x229e010 size 0x9c virtual false final false
 UnityEngine::Color GetHighlightColor(int32_t beatmapEventValue, bool colorBoost) ;

/// @brief Method SetColor addr 0x229dd38 size 0x24 virtual false final false
 void SetColor(UnityEngine::Color color) ;

// Ctor Parameters []
explicit LightSwitchEventEffect() ;

/// @brief Method .ctor addr 0x229e178 size 0x8 virtual false final false
 void _ctor() ;
