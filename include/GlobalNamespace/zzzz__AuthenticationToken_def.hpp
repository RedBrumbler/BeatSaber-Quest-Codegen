...
/// @brief Method .ctor addr 0xdab318 size 0x10 virtual false final false
...
/// @brief Method Serialize addr 0xdab328 size 0x94 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method CreateFromSerializedData addr 0xdab4d4 size 0x2c virtual true final true
 GlobalNamespace::AuthenticationToken CreateFromSerializedData(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method Deserialize addr 0xdab500 size 0xf0 virtual false final false
static GlobalNamespace::AuthenticationToken Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method FromHex addr 0xdab3ec size 0xe8 virtual false final false
static ::ArrayW<uint8_t> FromHex(::StringW str) ;

/// @brief Method GetHexVal addr 0xdab6b8 size 0xcc virtual false final false
static uint8_t GetHexVal(char16_t c) ;

/// @brief Method FromUtf8 addr 0xdab3bc size 0x30 virtual false final false
static ::ArrayW<uint8_t> FromUtf8(::StringW str) ;

/// @brief Method ToHex addr 0xdab620 size 0x98 virtual false final false
static ::StringW ToHex(::ArrayW<uint8_t> bytes) ;

/// @brief Method ToUtf8 addr 0xdab5f0 size 0x30 virtual false final false
