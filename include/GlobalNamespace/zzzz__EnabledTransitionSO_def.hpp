...
/// @brief Method get_normalState addr 0x2160968 size 0x8 virtual false final false
 bool get_normalState() ;

/// @brief Method get_highlightedState addr 0x2160970 size 0x8 virtual false final false
 bool get_highlightedState() ;

/// @brief Method get_pressedState addr 0x2160978 size 0x8 virtual false final false
 bool get_pressedState() ;

/// @brief Method get_disabledState addr 0x2160980 size 0x8 virtual false final false
 bool get_disabledState() ;

/// @brief Method get_selectedState addr 0x2160988 size 0x8 virtual false final false
 bool get_selectedState() ;

/// @brief Method get_selectedAndHighlightedState addr 0x2160990 size 0x8 virtual false final false
 bool get_selectedAndHighlightedState() ;

// Ctor Parameters []
explicit EnabledTransitionSO() ;

/// @brief Method .ctor addr 0x2160998 size 0x8 virtual false final false
 void _ctor() ;
