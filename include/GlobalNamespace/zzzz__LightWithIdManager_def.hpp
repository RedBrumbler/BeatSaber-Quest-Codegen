...
/// @brief Method add_didChangeSomeColorsThisFrameEvent addr 0x1fd8f04 size 0x9c virtual false final false
 void add_didChangeSomeColorsThisFrameEvent(System::Action value) ;

/// @brief Method remove_didChangeSomeColorsThisFrameEvent addr 0x1fd8fa0 size 0x9c virtual false final false
 void remove_didChangeSomeColorsThisFrameEvent(System::Action value) ;

/// @brief Method LateUpdate addr 0x1fd903c size 0x290 virtual false final false
 void LateUpdate() ;

/// @brief Method RegisterLight addr 0x1fd92cc size 0x430 virtual false final false
 void RegisterLight(GlobalNamespace::ILightWithId lightWithId) ;

/// @brief Method UnregisterLight addr 0x1fd96fc size 0x204 virtual false final false
 void UnregisterLight(GlobalNamespace::ILightWithId lightWithId) ;

/// @brief Method SetColorForId addr 0x1fd9900 size 0x23c virtual false final false
 void SetColorForId(int32_t lightId, UnityEngine::Color color) ;

/// @brief Method GetColorForId addr 0x1fd9b3c size 0xe4 virtual false final false
 UnityEngine::Color GetColorForId(int32_t lightId, bool initializeIfNull) ;

// Ctor Parameters []
explicit LightWithIdManager() ;

/// @brief Method .ctor addr 0x1fd9c20 size 0xd0 virtual false final false
 void _ctor() ;
