...
/// @brief Method .ctor addr 0x25de3c4 size 0x78 virtual false final false
 void _ctor() ;

/// @brief Method Update addr 0x25de45c size 0x184 virtual false final false
 void Update() ;

/// @brief Method add_RecenteredPose addr 0x25de5e0 size 0x9c virtual false final false
 void add_RecenteredPose(System::Action value) ;

/// @brief Method remove_RecenteredPose addr 0x25de67c size 0x9c virtual false final false
 void remove_RecenteredPose(System::Action value) ;

/// @brief Method RecenterPose addr 0x25de718 size 0x78 virtual false final false
 void RecenterPose() ;

/// @brief Method get_acceleration addr 0x25de790 size 0x124 virtual false final false
 UnityEngine::Vector3 get_acceleration() ;

/// @brief Method get_angularAcceleration addr 0x25de8b4 size 0x124 virtual false final false
 UnityEngine::Vector3 get_angularAcceleration() ;

/// @brief Method get_velocity addr 0x25de9d8 size 0x124 virtual false final false
 UnityEngine::Vector3 get_velocity() ;

/// @brief Method get_angularVelocity addr 0x25deafc size 0x124 virtual false final false
 UnityEngine::Vector3 get_angularVelocity() ;

/// @brief Method GetEyeRenderDesc addr 0x25dec20 size 0x38 virtual false final false
 GlobalNamespace::GlobalNamespace__OVRDisplay__EyeRenderDesc GetEyeRenderDesc(UnityEngine::XR::XRNode eye) ;

/// @brief Method get_latency addr 0x25dec58 size 0x1d0 virtual false final false
 GlobalNamespace::GlobalNamespace__OVRDisplay__LatencyData get_latency() ;

/// @brief Method get_appFramerate addr 0x25dee28 size 0x90 virtual false final false
 float_t get_appFramerate() ;

/// @brief Method get_recommendedMSAALevel addr 0x25deeb8 size 0x5c virtual false final false
 int32_t get_recommendedMSAALevel() ;

/// @brief Method get_displayFrequenciesAvailable addr 0x25def14 size 0x50 virtual false final false
 ::ArrayW<float_t> get_displayFrequenciesAvailable() ;

/// @brief Method get_displayFrequency addr 0x25def64 size 0x50 virtual false final false
 float_t get_displayFrequency() ;

/// @brief Method set_displayFrequency addr 0x25defb4 size 0x60 virtual false final false
 void set_displayFrequency(float_t value) ;

/// @brief Method UpdateTextures addr 0x25de43c size 0x20 virtual false final false
 void UpdateTextures() ;

/// @brief Method ConfigureEyeDesc addr 0x25df014 size 0x254 virtual false final false
