...
/// @brief Method .ctor addr 0xdac60c size 0x180 virtual false final false
...
/// @brief Method Serialize addr 0xdac78c size 0x80 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0xdac80c size 0x80 virtual true final true
