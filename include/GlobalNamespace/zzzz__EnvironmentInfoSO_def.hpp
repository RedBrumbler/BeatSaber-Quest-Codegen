...
/// @brief Method get_sceneInfo addr 0x21f56ec size 0x8 virtual false final false
 GlobalNamespace::SceneInfo get_sceneInfo() ;

/// @brief Method get_environmentName addr 0x21f56f4 size 0x8 virtual false final false
 ::StringW get_environmentName() ;

/// @brief Method get_colorScheme addr 0x21f56fc size 0x8 virtual false final false
 GlobalNamespace::ColorSchemeSO get_colorScheme() ;

/// @brief Method get_serializedName addr 0x21f5704 size 0x8 virtual false final false
 ::StringW get_serializedName() ;

/// @brief Method get_environmentAssetDirectory addr 0x21f570c size 0x8 virtual false final false
 ::StringW get_environmentAssetDirectory() ;

/// @brief Method get_environmentType addr 0x21f5714 size 0x8 virtual false final false
 GlobalNamespace::EnvironmentTypeSO get_environmentType() ;

/// @brief Method get_environmentSizeData addr 0x21f571c size 0x8 virtual false final false
 GlobalNamespace::EnvironmentSizeData get_environmentSizeData() ;

/// @brief Method get_environmentIntensityReductionOptions addr 0x21f5724 size 0x8 virtual false final false
 GlobalNamespace::EnvironmentIntensityReductionOptions get_environmentIntensityReductionOptions() ;

/// @brief Method get_environmentKeywords addr 0x21f572c size 0x8 virtual false final false
 System::Collections::Generic::IReadOnlyList_1<::StringW> get_environmentKeywords() ;

/// @brief Method get_lightGroups addr 0x21f5734 size 0x8 virtual false final false
 GlobalNamespace::EnvironmentLightGroups get_lightGroups() ;

/// @brief Method get_defaultEnvironmentEvents addr 0x21f573c size 0x8 virtual false final false
 GlobalNamespace::DefaultEnvironmentEvents get_defaultEnvironmentEvents() ;

// Ctor Parameters []
explicit EnvironmentInfoSO() ;

/// @brief Method .ctor addr 0x21f5744 size 0x50 virtual false final false
 void _ctor() ;
