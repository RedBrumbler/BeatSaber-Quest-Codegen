...
/// @brief Method .ctor addr 0x20f060c size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x20f06b8 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x20f06bc size 0x184 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x20f0840 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x20f0848 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x20f0888 size 0x8 virtual true final true
...
/// @brief Method Start addr 0x20f055c size 0x28 virtual false final false
 void Start() ;

/// @brief Method StartEffectCoroutine addr 0x20f0584 size 0x88 virtual false final false
 System::Collections::IEnumerator StartEffectCoroutine(float_t volumeScale, System::Action finishCallback) ;

/// @brief Method StartEffect addr 0x20f0634 size 0x28 virtual false final false
 void StartEffect(float_t volumeScale, System::Action finishCallback) ;

/// @brief Method InterruptEffect addr 0x20f065c size 0x40 virtual false final false
 void InterruptEffect() ;

/// @brief Method SetAudioSource addr 0x20f069c size 0x8 virtual false final false
 void SetAudioSource(UnityEngine::AudioSource audioSource) ;

// Ctor Parameters []
explicit AudioPitchGainEffect() ;

/// @brief Method .ctor addr 0x20f06a4 size 0x14 virtual false final false
 void _ctor() ;
