...
/// @brief Method get_presetNameLocalizationKey addr 0x222a00c size 0x8 virtual false final false
 ::StringW get_presetNameLocalizationKey() ;

// Ctor Parameters []
explicit NamedPreset() ;

/// @brief Method .ctor addr 0x222a004 size 0x8 virtual false final false
 void _ctor() ;
