...
/// @brief Method HandleInputFieldDidChange addr 0x218a830 size 0x90 virtual true final false
 void HandleInputFieldDidChange(HMUI::InputFieldView inputFieldView) ;

// Ctor Parameters []
explicit UrlInputFieldSettingsController() ;

/// @brief Method .ctor addr 0x218a8c0 size 0x8 virtual false final false
 void _ctor() ;
