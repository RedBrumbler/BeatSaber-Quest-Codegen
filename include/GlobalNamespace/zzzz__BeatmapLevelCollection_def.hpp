...
/// @brief Method get_beatmapLevels addr 0x221a640 size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0x221a648 size 0x28 virtual false final false
 void _ctor(System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::IPreviewBeatmapLevel> levels) ;

/// @brief Method CreateBeatmapLevelCollectionByUsingBeatmapCharacteristicFiltering addr 0x221a670 size 0x7cc virtual false final false
