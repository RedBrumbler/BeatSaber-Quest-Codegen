...
/// @brief Method .ctor addr 0x221ed20 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x221ed48 size 0x10 virtual false final false
...
/// @brief Method .ctor addr 0x221eafc size 0x10 virtual false final false
...
/// @brief Method MoveNext addr 0x221ed58 size 0x20c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x221ef64 size 0x58 virtual true final true
...
/// @brief Method .ctor addr 0x221e7a4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetLevelPreviewForLevelId>b__1 addr 0x221efbc size 0xac virtual false final false
...
/// @brief Method .ctor addr 0x221f0cc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetLevelPreviewForLevelId>b__36_0 addr 0x221f0d4 size 0x114 virtual false final false
...
/// @brief Method MoveNext addr 0x221f1e8 size 0x6b0 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x221f898 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method add_levelDownloadingUpdateEvent addr 0x221d514 size 0xb0 virtual false final false
...
/// @brief Method remove_levelDownloadingUpdateEvent addr 0x221d5c4 size 0xb0 virtual false final false
...
/// @brief Method get_ostAndExtrasPackCollection addr 0x221d674 size 0x8 virtual false final false
 GlobalNamespace::BeatmapLevelPackCollectionSO get_ostAndExtrasPackCollection() ;

/// @brief Method get_dlcBeatmapLevelPackCollection addr 0x221d67c size 0x1c virtual false final false
 GlobalNamespace::IBeatmapLevelPackCollection get_dlcBeatmapLevelPackCollection() ;

/// @brief Method get_allLoadedBeatmapLevelPackCollection addr 0x221d698 size 0x8 virtual false final false
 GlobalNamespace::IBeatmapLevelPackCollection get_allLoadedBeatmapLevelPackCollection() ;

/// @brief Method get_allLoadedBeatmapLevelWithoutCustomLevelPackCollection addr 0x221d6a0 size 0x8 virtual false final false
 GlobalNamespace::IBeatmapLevelPackCollection get_allLoadedBeatmapLevelWithoutCustomLevelPackCollection() ;

/// @brief Method get_customLevelPackCollection addr 0x221d6a8 size 0x8 virtual false final false
 GlobalNamespace::IBeatmapLevelPackCollection get_customLevelPackCollection() ;

/// @brief Method Init addr 0x221d6b0 size 0x13c virtual false final false
 void Init(GlobalNamespace::GlobalNamespace__BeatmapLevelsModel__InitData initData) ;

/// @brief Method Start addr 0x221dd50 size 0xec virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x221de3c size 0x16c virtual false final false
 void OnDestroy() ;

/// @brief Method ClearLoadedBeatmapLevelsCaches addr 0x221dfa8 size 0x50 virtual false final false
 void ClearLoadedBeatmapLevelsCaches() ;

/// @brief Method ReloadCustomLevelPackCollectionAsync addr 0x221dff8 size 0xe4 virtual false final false
...
/// @brief Method GetLevelPackForLevelId addr 0x221e0dc size 0x554 virtual false final false
 GlobalNamespace::IBeatmapLevelPack GetLevelPackForLevelId(::StringW levelId) ;

/// @brief Method GetLevelPack addr 0x221e630 size 0x174 virtual false final false
 GlobalNamespace::IBeatmapLevelPack GetLevelPack(::StringW levePacklId) ;

/// @brief Method GetLevelPreviewForLevelId addr 0x221a2ac size 0x220 virtual false final false
 GlobalNamespace::IPreviewBeatmapLevel GetLevelPreviewForLevelId(::StringW levelId) ;

/// @brief Method IsBeatmapLevelLoaded addr 0x221e7ac size 0xdc virtual false final false
 bool IsBeatmapLevelLoaded(::StringW levelId) ;

/// @brief Method GetBeatmapLevelIfLoaded addr 0x221e888 size 0x110 virtual false final false
 GlobalNamespace::IBeatmapLevel GetBeatmapLevelIfLoaded(::StringW levelId) ;

/// @brief Method GetBeatmapLevelAsync addr 0x221e998 size 0x114 virtual false final false
...
/// @brief Method HandleLevelDataAssetDownloadUpdate addr 0x221eaac size 0x50 virtual false final false
 void HandleLevelDataAssetDownloadUpdate(GlobalNamespace::LevelDataAssetDownloadUpdate update) ;

/// @brief Method HandleItemWillBeRemovedFromCache addr 0x221eb0c size 0x1c virtual false final false
 void HandleItemWillBeRemovedFromCache(GlobalNamespace::IBeatmapLevel beatmapLevel) ;

/// @brief Method UpdateLoadedPreviewLevels addr 0x221d7ec size 0x564 virtual false final false
 void UpdateLoadedPreviewLevels() ;

/// @brief Method UpdateAllLoadedBeatmapLevelPacks addr 0x221eb28 size 0x174 virtual false final false
 void UpdateAllLoadedBeatmapLevelPacks() ;

// Ctor Parameters []
explicit BeatmapLevelsModel() ;

/// @brief Method .ctor addr 0x221ec9c size 0x84 virtual false final false
 void _ctor() ;
