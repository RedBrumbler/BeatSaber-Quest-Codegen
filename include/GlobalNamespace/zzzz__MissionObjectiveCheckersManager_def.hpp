...
/// @brief Method .ctor addr 0x210f3fc size 0x28 virtual false final false
...
/// @brief Method add_objectiveDidFailEvent addr 0x210e690 size 0x9c virtual false final false
 void add_objectiveDidFailEvent(System::Action value) ;

/// @brief Method remove_objectiveDidFailEvent addr 0x210e72c size 0x9c virtual false final false
 void remove_objectiveDidFailEvent(System::Action value) ;

/// @brief Method add_objectiveWasClearedEvent addr 0x210e7c8 size 0x9c virtual false final false
 void add_objectiveWasClearedEvent(System::Action value) ;

/// @brief Method remove_objectiveWasClearedEvent addr 0x210e864 size 0x9c virtual false final false
 void remove_objectiveWasClearedEvent(System::Action value) ;

/// @brief Method add_objectivesListDidChangeEvent addr 0x210e900 size 0x9c virtual false final false
 void add_objectivesListDidChangeEvent(System::Action value) ;

/// @brief Method remove_objectivesListDidChangeEvent addr 0x210e99c size 0x9c virtual false final false
 void remove_objectivesListDidChangeEvent(System::Action value) ;

/// @brief Method get_activeMissionObjectiveCheckers addr 0x210ea38 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::MissionObjectiveChecker> get_activeMissionObjectiveCheckers() ;

/// @brief Method Start addr 0x210ea40 size 0x5cc virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x210f00c size 0x1a4 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleMissionObjectiveCheckerStatusDidChange addr 0x210f1b0 size 0x4c virtual false final false
 void HandleMissionObjectiveCheckerStatusDidChange(GlobalNamespace::MissionObjectiveChecker missionObjectiveChecker) ;

/// @brief Method GetMissionObjectiveChecker addr 0x210f1fc size 0xc8 virtual false final false
...
/// @brief Method GetResults addr 0x210b854 size 0x194 virtual false final false
 ::ArrayW<GlobalNamespace::MissionObjectiveResult> GetResults() ;

/// @brief Method HandleLevelFailed addr 0x210f2c4 size 0x4 virtual false final false
 void HandleLevelFailed() ;

/// @brief Method HandleLevelFinished addr 0x210f3a0 size 0x4 virtual false final false
 void HandleLevelFinished() ;

/// @brief Method StopChecking addr 0x210f2c8 size 0xd8 virtual false final false
 void StopChecking() ;

// Ctor Parameters []
explicit MissionObjectiveCheckersManager() ;

/// @brief Method .ctor addr 0x210f3a4 size 0x58 virtual false final false
 void _ctor() ;
