...
/// @brief Method set_fillAmount addr 0x215a858 size 0x44 virtual false final false
 void set_fillAmount(float_t value) ;

/// @brief Method get_fillAmount addr 0x215a988 size 0x1c virtual false final false
 float_t get_fillAmount() ;

// Ctor Parameters []
explicit FillIndicator() ;

/// @brief Method .ctor addr 0x215a9a4 size 0x8 virtual false final false
 void _ctor() ;
