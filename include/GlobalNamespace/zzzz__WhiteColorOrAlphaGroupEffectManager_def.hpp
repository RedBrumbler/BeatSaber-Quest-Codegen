...
/// @brief Method Start addr 0x2297f50 size 0x280 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x22981d0 size 0x148 virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit WhiteColorOrAlphaGroupEffectManager() ;

/// @brief Method .ctor addr 0x2298318 size 0x7c virtual false final false
 void _ctor() ;
