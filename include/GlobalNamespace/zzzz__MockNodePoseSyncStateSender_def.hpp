...
/// @brief Method .ctor addr 0x22b2fc0 size 0x17c virtual false final false
 void _ctor(GlobalNamespace::IMultiplayerSessionManager msm) ;

/// @brief Method Dispose addr 0x22b313c size 0xc8 virtual true final true
 void Dispose() ;

/// @brief Method SendPose addr 0x22b3204 size 0x230 virtual false final false
...
/// @brief Method HandleNodePoseSyncStateUpdate addr 0x22b3434 size 0x4 virtual false final false
