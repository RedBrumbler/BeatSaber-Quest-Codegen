...
/// @brief Method Start addr 0x20e504c size 0x170 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x20e51bc size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleBeatmapEvent addr 0x20e51d8 size 0x11c virtual false final false
 void HandleBeatmapEvent(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

// Ctor Parameters []
explicit HydraulicCarJumpEffect() ;

/// @brief Method .ctor addr 0x20e52f4 size 0x1c virtual false final false
 void _ctor() ;
