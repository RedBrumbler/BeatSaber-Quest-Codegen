...
/// @brief Method get_hasPostProcessEffect addr 0x26a82c0 size 0x8 virtual true final false
 bool get_hasPostProcessEffect() ;

/// @brief Method OnEnable addr 0x26a82c8 size 0x80 virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x26a8348 size 0xc virtual false final false
 void OnDisable() ;

/// @brief Method PreRender addr 0x26a8354 size 0x64 virtual true final false
 void PreRender() ;

/// @brief Method PostRender addr 0x26a83b8 size 0xc virtual true final false
 void PostRender(float_t fade) ;

/// @brief Method DrawFadeQuad addr 0x26a83c4 size 0xec virtual false final false
 void DrawFadeQuad(float_t alpha) ;

// Ctor Parameters []
explicit NoPostProcessMainEffectSO() ;

/// @brief Method .ctor addr 0x26a84b0 size 0x10 virtual false final false
 void _ctor() ;
