...
/// @brief Method add_playerActiveStateChangedEvent addr 0x21ac6a8 size 0xb0 virtual false final false
 void add_playerActiveStateChangedEvent(System::Action_1<bool> value) ;

/// @brief Method remove_playerActiveStateChangedEvent addr 0x21ac758 size 0xb0 virtual false final false
 void remove_playerActiveStateChangedEvent(System::Action_1<bool> value) ;

/// @brief Method SetLevelGameplaySetupData addr 0x21ac808 size 0x13c virtual false final false
 void SetLevelGameplaySetupData(GlobalNamespace::ILevelGameplaySetupData levelGameplaySetupData) ;

/// @brief Method SetLobbyPlayerData addr 0x21ac944 size 0xc0 virtual true final false
 void SetLobbyPlayerData(GlobalNamespace::ILobbyPlayerData lobbyPlayerData) ;

/// @brief Method DidActivate addr 0x21aca04 size 0x9c virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x21acaa0 size 0x1c virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method OnDestroy addr 0x21acabc size 0x1c virtual true final false
 void OnDestroy() ;

// Ctor Parameters []
explicit BaseMultiplayerStartGameCountdownViewController() ;

/// @brief Method .ctor addr 0x21acad8 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__9_0 addr 0x21acb40 size 0x24 virtual false final false
