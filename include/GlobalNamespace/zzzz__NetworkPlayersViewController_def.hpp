...
/// @brief Method add_onJoinRequestEvent addr 0x21b21b0 size 0xb0 virtual false final false
 void add_onJoinRequestEvent(System::Action_1<GlobalNamespace::INetworkPlayer> value) ;

/// @brief Method remove_onJoinRequestEvent addr 0x21b2260 size 0xb0 virtual false final false
 void remove_onJoinRequestEvent(System::Action_1<GlobalNamespace::INetworkPlayer> value) ;

/// @brief Method add_onInviteRequestEvent addr 0x21b2310 size 0xb0 virtual false final false
 void add_onInviteRequestEvent(System::Action_1<GlobalNamespace::INetworkPlayer> value) ;

/// @brief Method remove_onInviteRequestEvent addr 0x21b23c0 size 0xb0 virtual false final false
 void remove_onInviteRequestEvent(System::Action_1<GlobalNamespace::INetworkPlayer> value) ;

/// @brief Method DidActivate addr 0x21b2470 size 0x2e8 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method NetworkPlayersViewControllerDidActivate addr 0x21b28e8 size 0x4 virtual true final false
 void NetworkPlayersViewControllerDidActivate(bool firstActivation, bool addedToHierarchy) ;

/// @brief Method DidDeactivate addr 0x21b28ec size 0x2b4 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method NetworkPlayersViewControllerDidDeactivate addr 0x21b2ba0 size 0x4 virtual true final false
 void NetworkPlayersViewControllerDidDeactivate(bool removedFromHierarchy) ;

/// @brief Method OnDestroy addr 0x21a8de4 size 0x8 virtual true final false
 void OnDestroy() ;

/// @brief Method HandlePartyChanged addr 0x21b2ba4 size 0x18 virtual false final false
 void HandlePartyChanged(GlobalNamespace::INetworkPlayerModel playerModel) ;

/// @brief Method HandleJoinRequest addr 0x21b2bbc size 0x1c virtual false final false
 void HandleJoinRequest(GlobalNamespace::INetworkPlayer player) ;

/// @brief Method HandleInviteRequest addr 0x21b2bd8 size 0x1c virtual false final false
 void HandleInviteRequest(GlobalNamespace::INetworkPlayer player) ;

/// @brief Method Refresh addr 0x21b2758 size 0x190 virtual false final false
 void Refresh() ;

// Ctor Parameters []
explicit NetworkPlayersViewController() ;

/// @brief Method .ctor addr 0x21a8e14 size 0x8 virtual false final false
 void _ctor() ;
