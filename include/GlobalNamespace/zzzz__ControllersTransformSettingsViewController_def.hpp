...
/// @brief Method DidActivate addr 0x218e3c0 size 0x570 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x218e930 size 0xac virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method OnDestroy addr 0x218e9dc size 0x338 virtual true final false
 void OnDestroy() ;

/// @brief Method HandlePositionSliderValueDidChange addr 0x218ed14 size 0x120 virtual false final false
 void HandlePositionSliderValueDidChange(HMUI::RangeValuesTextSlider slider, float_t value) ;

/// @brief Method HandleRotationSliderValueDidChange addr 0x218ee34 size 0x118 virtual false final false
...
/// @brief Method .ctor addr 0x218ef4c size 0x8 virtual false final false
 void _ctor() ;
