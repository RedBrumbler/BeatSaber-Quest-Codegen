...
/// @brief Method Start addr 0x21e5740 size 0xcc virtual false final false
 void Start() ;

/// @brief Method Update addr 0x21e580c size 0x80 virtual false final false
 void Update() ;

/// @brief Method OnDestroy addr 0x21e588c size 0xcc virtual false final false
 void OnDestroy() ;

/// @brief Method HandleTextDidChange addr 0x21e5958 size 0x90 virtual false final false
 void HandleTextDidChange(UnityEngine::Object textMeshPro) ;

// Ctor Parameters []
explicit ResizableTextMeshPro() ;

/// @brief Method .ctor addr 0x21e59e8 size 0x10 virtual false final false
 void _ctor() ;
