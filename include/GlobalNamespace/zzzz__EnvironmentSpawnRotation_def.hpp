...
/// @brief Method get_targetRotation addr 0x22a2a24 size 0x8 virtual false final false
 float_t get_targetRotation() ;

/// @brief Method OnEnable addr 0x22a2a2c size 0x60 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x22a2a8c size 0x60 virtual false final false
 void OnDisable() ;

/// @brief Method Start addr 0x22a2aec size 0x164 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x22a2c50 size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleSpawnRotationBeatmapEvent addr 0x22a2c6c size 0x104 virtual false final false
 void HandleSpawnRotationBeatmapEvent(GlobalNamespace::SpawnRotationBeatmapEventData beatmapEventData) ;

/// @brief Method FixedUpdate addr 0x22a2d70 size 0x90 virtual false final false
 void FixedUpdate() ;

/// @brief Method LateUpdate addr 0x22a2e00 size 0x128 virtual false final false
 void LateUpdate() ;

// Ctor Parameters []
explicit EnvironmentSpawnRotation() ;

/// @brief Method .ctor addr 0x22a2f28 size 0x8 virtual false final false
 void _ctor() ;
