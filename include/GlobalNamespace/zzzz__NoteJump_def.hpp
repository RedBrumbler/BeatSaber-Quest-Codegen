...
/// @brief Method add_noteJumpDidFinishEvent addr 0x227a82c size 0x9c virtual false final false
 void add_noteJumpDidFinishEvent(System::Action value) ;

/// @brief Method remove_noteJumpDidFinishEvent addr 0x227a8c8 size 0x9c virtual false final false
 void remove_noteJumpDidFinishEvent(System::Action value) ;

/// @brief Method add_noteJumpDidPassMissedMarkerEvent addr 0x227a964 size 0x9c virtual false final false
 void add_noteJumpDidPassMissedMarkerEvent(System::Action value) ;

/// @brief Method remove_noteJumpDidPassMissedMarkerEvent addr 0x227aa00 size 0x9c virtual false final false
 void remove_noteJumpDidPassMissedMarkerEvent(System::Action value) ;

/// @brief Method add_noteJumpDidPassThreeQuartersEvent addr 0x227aa9c size 0xb0 virtual false final false
 void add_noteJumpDidPassThreeQuartersEvent(System::Action_1<GlobalNamespace::NoteJump> value) ;

/// @brief Method remove_noteJumpDidPassThreeQuartersEvent addr 0x227ab4c size 0xb0 virtual false final false
 void remove_noteJumpDidPassThreeQuartersEvent(System::Action_1<GlobalNamespace::NoteJump> value) ;

/// @brief Method add_noteJumpDidPassHalfEvent addr 0x227abfc size 0x9c virtual false final false
 void add_noteJumpDidPassHalfEvent(System::Action value) ;

/// @brief Method remove_noteJumpDidPassHalfEvent addr 0x227ac98 size 0x9c virtual false final false
 void remove_noteJumpDidPassHalfEvent(System::Action value) ;

/// @brief Method add_noteJumpDidUpdateProgressEvent addr 0x227ad34 size 0xb0 virtual false final false
 void add_noteJumpDidUpdateProgressEvent(System::Action_1<float_t> value) ;

/// @brief Method remove_noteJumpDidUpdateProgressEvent addr 0x227ade4 size 0xb0 virtual false final false
 void remove_noteJumpDidUpdateProgressEvent(System::Action_1<float_t> value) ;

/// @brief Method get_distanceToPlayer addr 0x227ae94 size 0x48 virtual false final false
 float_t get_distanceToPlayer() ;

/// @brief Method get_beatPos addr 0x227aedc size 0x30 virtual false final false
 UnityEngine::Vector3 get_beatPos() ;

/// @brief Method get_jumpDuration addr 0x227af0c size 0x8 virtual false final false
 float_t get_jumpDuration() ;

/// @brief Method get_moveVec addr 0x227af14 size 0xc virtual false final false
 UnityEngine::Vector3 get_moveVec() ;

/// @brief Method get_localPosition addr 0x227af20 size 0xc virtual false final false
 UnityEngine::Vector3 get_localPosition() ;

/// @brief Method Init addr 0x227af2c size 0x394 virtual false final false
...
/// @brief Method ManualUpdate addr 0x227b2c0 size 0x640 virtual false final false
 UnityEngine::Vector3 ManualUpdate() ;

// Ctor Parameters []
explicit NoteJump() ;

/// @brief Method .ctor addr 0x227b900 size 0x1b8 virtual false final false
 void _ctor() ;
