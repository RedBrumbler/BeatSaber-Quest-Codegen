...
/// @brief Method get_resultAvatarDirectors addr 0x2138844 size 0x8 virtual false final false
 ::ArrayW<UnityEngine::GameObject> get_resultAvatarDirectors() ;

/// @brief Method get_badgeTimelines addr 0x213884c size 0x8 virtual false final false
 ::ArrayW<UnityEngine::GameObject> get_badgeTimelines() ;

/// @brief Method PrespawnAvatars addr 0x21368c0 size 0x400 virtual false final false
 void PrespawnAvatars(System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::IConnectedPlayer> activePlayers) ;

/// @brief Method SetupResults addr 0x2135a74 size 0x614 virtual false final false
...
/// @brief Method .ctor addr 0x2138cb8 size 0x84 virtual false final false
 void _ctor() ;
