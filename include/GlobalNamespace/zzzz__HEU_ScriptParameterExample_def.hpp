...
/// @brief Method Start addr 0x2013738 size 0x288 virtual false final false
 void Start() ;

/// @brief Method UpdateGravity addr 0x20139c0 size 0xe4 virtual false final false
 void UpdateGravity() ;

// Ctor Parameters []
explicit HEU_ScriptParameterExample() ;

/// @brief Method .ctor addr 0x2013aa4 size 0x14 virtual false final false
 void _ctor() ;
