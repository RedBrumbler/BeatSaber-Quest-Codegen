...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4893))}
...
/// @brief Method get_position addr 0x227a0fc size 0x1c virtual true final false
 UnityEngine::Vector3 get_position() ;

/// @brief Method Start addr 0x227a118 size 0x2c virtual false final false
 void Start() ;

/// @brief Method LateUpdate addr 0x227a144 size 0x19c virtual false final false
 void LateUpdate() ;

/// @brief Method Init addr 0x227a2e0 size 0x2c virtual true final false
 void Init(UnityEngine::Vector3 force, UnityEngine::Vector3 torque) ;

/// @brief Method AddVelocity addr 0x227a30c size 0x20 virtual true final false
 void AddVelocity(UnityEngine::Vector3 force) ;

// Ctor Parameters []
explicit NoteDebrisSimplePhysics() ;

/// @brief Method .ctor addr 0x227a32c size 0x8 virtual false final false
 void _ctor() ;
