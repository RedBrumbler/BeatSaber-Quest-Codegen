...
/// @brief Method .ctor addr 0x2661d1c size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2661df4 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2661df8 size 0x120 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x2661f18 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x2661f20 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2661f60 size 0x8 virtual true final true
...
/// @brief Method Start addr 0x26612cc size 0x184 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x266161c size 0x10c virtual false final false
 void Update() ;

/// @brief Method IsModelSupported addr 0x2661450 size 0x164 virtual false final false
 bool IsModelSupported(::StringW modelPath) ;

/// @brief Method LoadControllerModel addr 0x2661a5c size 0x2c0 virtual false final false
 bool LoadControllerModel(::StringW modelPath) ;

/// @brief Method UpdateControllerModel addr 0x26615b4 size 0x68 virtual false final false
 System::Collections::IEnumerator UpdateControllerModel() ;

/// @brief Method UpdateControllerAnimation addr 0x2661728 size 0x334 virtual false final false
 void UpdateControllerAnimation() ;

/// @brief Method InputFocusAquired addr 0x2661d44 size 0xc virtual false final false
 void InputFocusAquired() ;

/// @brief Method InputFocusLost addr 0x2661d50 size 0x8 virtual false final false
 void InputFocusLost() ;

// Ctor Parameters []
explicit OVRRuntimeController() ;

/// @brief Method .ctor addr 0x2661d58 size 0x10 virtual false final false
 void _ctor() ;
