...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4831)), TypeDefinitionIndex(TypeDefinitionIndex(4830))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4831), inst: 2 })
