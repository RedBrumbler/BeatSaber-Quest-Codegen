...
/// @brief Method .ctor addr 0x214217c size 0x2c virtual false final false
...
/// @brief Method add_playerHeightDidChangeEvent addr 0x2141cfc size 0xb0 virtual false final false
 void add_playerHeightDidChangeEvent(System::Action_1<float_t> value) ;

/// @brief Method remove_playerHeightDidChangeEvent addr 0x2141dac size 0xb0 virtual false final false
 void remove_playerHeightDidChangeEvent(System::Action_1<float_t> value) ;

/// @brief Method get_playerHeight addr 0x2141e5c size 0x8 virtual false final false
 float_t get_playerHeight() ;

/// @brief Method Start addr 0x2141e64 size 0xe4 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2141f48 size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method LateUpdate addr 0x2141f64 size 0x1cc virtual false final false
 void LateUpdate() ;

/// @brief Method BeatmapObjectSpawnCallback addr 0x2142130 size 0x44 virtual false final false
 void BeatmapObjectSpawnCallback(GlobalNamespace::ObstacleData obstacleData) ;

// Ctor Parameters []
explicit PlayerHeightDetector() ;

/// @brief Method .ctor addr 0x2142174 size 0x8 virtual false final false
 void _ctor() ;
