...
/// @brief Method get_Valid addr 0x2642708 size 0x28 virtual false final false
 bool get_Valid() ;

/// @brief Method .ctor addr 0x2642730 size 0x68 virtual false final false
 void _ctor(uint64_t spaceUserId) ;

/// @brief Method get_Id addr 0x263f31c size 0x7c virtual false final false
 uint64_t get_Id() ;

/// @brief Method Dispose addr 0x2642798 size 0x64 virtual true final true
 void Dispose() ;
