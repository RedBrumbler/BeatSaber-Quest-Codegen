...
/// @brief Method get_leftController addr 0x217dcb0 size 0x8 virtual false final false
 GlobalNamespace::VRController get_leftController() ;

/// @brief Method get_rightController addr 0x217dcb8 size 0x8 virtual false final false
 GlobalNamespace::VRController get_rightController() ;

/// @brief Method get_headPos addr 0x217dcc0 size 0x1c virtual false final false
 UnityEngine::Vector3 get_headPos() ;

/// @brief Method get_headRot addr 0x217dcdc size 0x1c virtual false final false
 UnityEngine::Quaternion get_headRot() ;

// Ctor Parameters []
explicit MenuPlayerController() ;

/// @brief Method .ctor addr 0x217dcf8 size 0x8 virtual false final false
 void _ctor() ;
