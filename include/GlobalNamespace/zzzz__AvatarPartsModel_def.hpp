...
/// @brief Method get_headTopCollection addr 0x2263ee0 size 0x8 virtual false final false
 GlobalNamespace::AvatarPartCollection_1<GlobalNamespace::AvatarMeshPartSO> get_headTopCollection() ;

/// @brief Method get_eyesCollection addr 0x2263ee8 size 0x8 virtual false final false
 GlobalNamespace::AvatarPartCollection_1<GlobalNamespace::AvatarSpritePartSO> get_eyesCollection() ;

/// @brief Method get_mouthCollection addr 0x2263ef0 size 0x8 virtual false final false
 GlobalNamespace::AvatarPartCollection_1<GlobalNamespace::AvatarSpritePartSO> get_mouthCollection() ;

/// @brief Method get_glassesCollection addr 0x2263ef8 size 0x8 virtual false final false
 GlobalNamespace::AvatarPartCollection_1<GlobalNamespace::AvatarMeshPartSO> get_glassesCollection() ;

/// @brief Method get_facialHairCollection addr 0x2263f00 size 0x8 virtual false final false
 GlobalNamespace::AvatarPartCollection_1<GlobalNamespace::AvatarMeshPartSO> get_facialHairCollection() ;

/// @brief Method get_handsCollection addr 0x2263f08 size 0x8 virtual false final false
 GlobalNamespace::AvatarPartCollection_1<GlobalNamespace::AvatarMeshPartSO> get_handsCollection() ;

/// @brief Method get_clothesCollection addr 0x2263f10 size 0x8 virtual false final false
 GlobalNamespace::AvatarPartCollection_1<GlobalNamespace::AvatarMeshPartSO> get_clothesCollection() ;

/// @brief Method get_skinColors addr 0x2263f18 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2263f20 size 0x260 virtual false final false
 void _ctor(GlobalNamespace::AvatarPartsModelSO avatarPartData, GlobalNamespace::SkinColorSetSO skinColorSet) ;

/// @brief Method GetColorIndexById addr 0x2264180 size 0x84 virtual false final false
 int32_t GetColorIndexById(::StringW id) ;

/// @brief Method GetSkinColorById addr 0x2264204 size 0x34 virtual false final false
 GlobalNamespace::SkinColorSO GetSkinColorById(::StringW id) ;

/// @brief Method GetRandomColor addr 0x2262404 size 0x40 virtual false final false
