...
/// @brief Method CreateCommandBuffer addr 0x26a5ec8 size 0x1ec virtual true final false
 UnityEngine::Rendering::CommandBuffer CreateCommandBuffer(UnityEngine::Camera camera) ;

/// @brief Method CamerasDict addr 0x26a60b4 size 0x58 virtual true final false
 System::Collections::Generic::Dictionary_2<UnityEngine::Camera,GlobalNamespace::CommandBufferOwners> CamerasDict() ;

/// @brief Method CommandBufferCameraEvent addr 0x26a610c size 0x8 virtual true final false
 UnityEngine::Rendering::CameraEvent CommandBufferCameraEvent() ;

// Ctor Parameters []
explicit CommandBufferGrabPass() ;

/// @brief Method .ctor addr 0x26a6114 size 0x58 virtual false final false
 void _ctor() ;
