...
/// @brief Method SetState addr 0xddd224 size 0x48 virtual true final true
 void SetState(GlobalNamespace::GlobalNamespace__StandardScoreSyncState__Score s, int32_t value) ;

/// @brief Method GetDelta addr 0xddd26c size 0x24 virtual false final false
 GlobalNamespace::StandardScoreSyncState GetDelta(ByRef<GlobalNamespace::StandardScoreSyncState> stateTable) ;

/// @brief Method ApplyDelta addr 0xddd290 size 0x24 virtual false final false
 GlobalNamespace::StandardScoreSyncState ApplyDelta(ByRef<GlobalNamespace::StandardScoreSyncState> delta) ;

/// @brief Method GetState addr 0xddd2b4 size 0x50 virtual true final true
 int32_t GetState(GlobalNamespace::GlobalNamespace__StandardScoreSyncState__Score s) ;

/// @brief Method Serialize addr 0xddd304 size 0x6c virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0xddd370 size 0x6c virtual true final true
 void Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method Equals addr 0xddd3dc size 0x5c virtual false final false
 bool Equals(ByRef<GlobalNamespace::StandardScoreSyncState> other) ;

/// @brief Method GetSize addr 0xddd438 size 0x8c virtual true final true
 int32_t GetSize() ;

/// @brief Method IStateTable<StandardScoreSyncState,StandardScoreSyncState.Score,System.Int32>.GetDelta addr 0xddd4c4 size 0x24 virtual true final true
...
/// @brief Method IStateTable<StandardScoreSyncState,StandardScoreSyncState.Score,System.Int32>.ApplyDelta addr 0xddd4e8 size 0x24 virtual true final true
...
/// @brief Method IEquatableByReference<StandardScoreSyncState>.Equals addr 0xddd50c size 0x4 virtual true final true
