...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4970))}
...
/// @brief Method InitAndPresent addr 0x228a40c size 0x4e4 virtual false final false
...
/// @brief Method ManualUpdate addr 0x228a978 size 0x88 virtual true final false
 void ManualUpdate(float_t t) ;

/// @brief Method HandleCutScoreBufferDidChange addr 0x228aa00 size 0x4c virtual true final true
 void HandleCutScoreBufferDidChange(GlobalNamespace::CutScoreBuffer cutScoreBuffer) ;

/// @brief Method RefreshScore addr 0x228a8f0 size 0x88 virtual false final false
 void RefreshScore(int32_t score, int32_t maxPossibleCutScore) ;

/// @brief Method HandleCutScoreBufferDidFinish addr 0x228aa4c size 0x4 virtual true final true
 void HandleCutScoreBufferDidFinish(GlobalNamespace::CutScoreBuffer cutScoreBuffer) ;

/// @brief Method UnregisterCallbacksIfNeeded addr 0x228aa50 size 0x128 virtual false final false
 void UnregisterCallbacksIfNeeded() ;

// Ctor Parameters []
explicit FlyingScoreEffect() ;

/// @brief Method .ctor addr 0x228ab78 size 0x30 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 2711 }), TypeDefinitionIndex(TypeDefinitionIndex(4972)), TypeDefinitionIndex(TypeDefinitionIndex(11011))}
...
/// @brief Method OnDespawned addr 0x228aba8 size 0x60 virtual true final false
 void OnDespawned(GlobalNamespace::FlyingScoreEffect item) ;

// Ctor Parameters []
explicit GlobalNamespace__FlyingScoreEffect__Pool() ;

/// @brief Method .ctor addr 0x228ac08 size 0x48 virtual false final false
 void _ctor() ;
