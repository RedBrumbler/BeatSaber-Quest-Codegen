...
/// @brief Method get_modifierNameLocalizationKey addr 0x21f8a04 size 0x8 virtual false final false
 ::StringW get_modifierNameLocalizationKey() ;

/// @brief Method get_descriptionLocalizationKey addr 0x21f8a0c size 0x8 virtual false final false
 ::StringW get_descriptionLocalizationKey() ;

/// @brief Method get_multiplier addr 0x21f8a14 size 0x8 virtual false final false
 float_t get_multiplier() ;

/// @brief Method get_multiplierConditionallyValid addr 0x21f8a1c size 0x8 virtual false final false
 bool get_multiplierConditionallyValid() ;

/// @brief Method get_icon addr 0x21f8a24 size 0x8 virtual false final false
 UnityEngine::Sprite get_icon() ;

/// @brief Method get_mutuallyExclusives addr 0x21f8a2c size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::GameplayModifierParamsSO> get_mutuallyExclusives() ;

/// @brief Method get_requires addr 0x21f8a34 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::GameplayModifierParamsSO> get_requires() ;

/// @brief Method get_requiredBy addr 0x21f8a3c size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::GameplayModifierParamsSO> get_requiredBy() ;

/// @brief Method get_isInBeta addr 0x21f8a44 size 0x8 virtual false final false
 bool get_isInBeta() ;

// Ctor Parameters []
explicit GameplayModifierParamsSO() ;

/// @brief Method .ctor addr 0x21f8a4c size 0x8 virtual false final false
 void _ctor() ;
