...
/// @brief Method .ctor addr 0x2297744 size 0x3c virtual false final false
...
/// @brief Method .ctor addr 0x2296a5c size 0x36c virtual false final false
...
/// @brief Method Cleanup addr 0x2296dc8 size 0x9c virtual false final false
 void Cleanup() ;

/// @brief Method HandleColorChangeBeatmapEvent addr 0x2296e64 size 0x470 virtual false final false
 void HandleColorChangeBeatmapEvent(GlobalNamespace::LightColorBeatmapEventData currentEventData) ;

/// @brief Method UseBoostColors addr 0x22973e0 size 0x178 virtual false final false
 void UseBoostColors(bool useBoostColors) ;

/// @brief Method GetColor addr 0x2297558 size 0x34 virtual true final false
 UnityEngine::Color GetColor(GlobalNamespace::EnvironmentColorType colorType, bool colorBoost, float_t brightness) ;

/// @brief Method SetData addr 0x229758c size 0x170 virtual false final false
...
/// @brief Method SetColor addr 0x22972d4 size 0x10c virtual false final false
