...
/// @brief Method Save addr 0x225ce38 size 0x1118 virtual false final false
 void Save(GlobalNamespace::ISaveData saveData, GlobalNamespace::PlayerData playerData) ;

/// @brief Method Load addr 0x225e2b0 size 0x104 virtual false final false
...
/// @brief Method LoadFromJSONString addr 0x225e3b4 size 0x1cc virtual false final false
...
/// @brief Method LoadFromCurrentVersion addr 0x225f1b8 size 0x1108 virtual false final false
...
/// @brief Method LoadFromVersionV1_0_1 addr 0x225e674 size 0xb44 virtual false final false
...
/// @brief Method CreateDefaultPlayerData addr 0x225e580 size 0xf4 virtual false final false
 GlobalNamespace::PlayerData CreateDefaultPlayerData() ;

/// @brief Method GetLevelIdFromV_1_0_1LevelId addr 0x2260ffc size 0x68 virtual false final false
...
/// @brief Method GetBeatmapCharacteristicFromV_1_0_1LevelId addr 0x2260c5c size 0x3a0 virtual false final false
...
/// @brief Method CreateDefaultOverrideEnvironmentSettings addr 0x22605f0 size 0xbc virtual false final false
 GlobalNamespace::OverrideEnvironmentSettings CreateDefaultOverrideEnvironmentSettings() ;

/// @brief Method GetEnvironmentInfoBySerializedName addr 0x226109c size 0x1c virtual false final false
 GlobalNamespace::EnvironmentInfoSO GetEnvironmentInfoBySerializedName(::StringW environmentName) ;

/// @brief Method LoadCorrectedSongPackMask addr 0x22606ac size 0x70 virtual false final false
 ::StringW LoadCorrectedSongPackMask(::ArrayW<uint8_t> songMaskPackBytes) ;

// Ctor Parameters []
explicit PlayerDataFileManagerSO() ;

/// @brief Method .ctor addr 0x22610b8 size 0x74 virtual false final false
 void _ctor() ;
