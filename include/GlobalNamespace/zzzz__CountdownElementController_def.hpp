...
/// @brief Method SetTextAndRunAnimation addr 0x2182570 size 0x64 virtual false final false
 void SetTextAndRunAnimation(::StringW text) ;

/// @brief Method StopAndHide addr 0x21826c8 size 0x24 virtual false final false
 void StopAndHide() ;

// Ctor Parameters []
explicit CountdownElementController() ;

/// @brief Method .ctor addr 0x2182850 size 0x8 virtual false final false
 void _ctor() ;
