...
/// @brief Method .ctor addr 0x21ffb08 size 0x464 virtual false final false
 void _ctor(GlobalNamespace::BeatmapCharacteristicCollectionSO collection, GlobalNamespace::AppStaticSettingsSO appSettings) ;

/// @brief Method GetBeatmapCharacteristicBySerializedName addr 0x21f2db0 size 0x90 virtual false final false
