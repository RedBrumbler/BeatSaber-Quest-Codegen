...
/// @brief Method set_localPosition addr 0x1fd2904 size 0x48 virtual false final false
 void set_localPosition(UnityEngine::Vector3 value) ;

/// @brief Method Awake addr 0x1fd294c size 0x20 virtual false final false
 void Awake() ;

/// @brief Method OnEnable addr 0x1fd296c size 0x28 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fd2ab0 size 0x20 virtual false final false
 void OnDisable() ;

/// @brief Method Refresh addr 0x1fd2994 size 0x11c virtual false final false
 void Refresh() ;

// Ctor Parameters []
explicit ParametricBoxFrameController() ;

/// @brief Method .ctor addr 0x1fd2ad0 size 0x14 virtual false final false
 void _ctor() ;
