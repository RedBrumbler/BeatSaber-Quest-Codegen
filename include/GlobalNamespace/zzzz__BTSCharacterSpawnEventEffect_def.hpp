...
/// @brief Method add_startCharacterAnimationEvent addr 0x20df4cc size 0xb0 virtual false final false
 void add_startCharacterAnimationEvent(System::Action_1<GlobalNamespace::BTSCharacter> value) ;

/// @brief Method remove_startCharacterAnimationEvent addr 0x20df91c size 0xb0 virtual false final false
 void remove_startCharacterAnimationEvent(System::Action_1<GlobalNamespace::BTSCharacter> value) ;

/// @brief Method get_isInitialized addr 0x20dfd1c size 0x8 virtual false final false
 bool get_isInitialized() ;

/// @brief Method Start addr 0x20dfd24 size 0x5a8 virtual false final false
 void Start() ;

/// @brief Method LoadAddressables addr 0x20e02cc size 0x86c virtual false final false
 void LoadAddressables() ;

/// @brief Method CleanupAddressables addr 0x20e0cb8 size 0x154 virtual false final false
 void CleanupAddressables() ;

/// @brief Method OnDestroy addr 0x20e0e0c size 0x28 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleBeatmapEvent addr 0x20e0e34 size 0x144 virtual false final false
 void HandleBeatmapEvent(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

/// @brief Method GetCharacterWithAnimationClip addr 0x20e0b48 size 0x170 virtual false final false
...
/// @brief Method .ctor addr 0x20e0f80 size 0x130 virtual false final false
 void _ctor() ;
