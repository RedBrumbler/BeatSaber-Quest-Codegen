...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4930))}
...
/// @brief Method get_sliderDidFinishJumpEvent addr 0x2280a8c size 0x8 virtual false final false
 GlobalNamespace::ILazyCopyHashSet_1<GlobalNamespace::ISliderDidFinishJumpEvent> get_sliderDidFinishJumpEvent() ;

/// @brief Method get_sliderDidStartDissolvingEvent addr 0x2280a94 size 0x8 virtual false final false
 GlobalNamespace::ILazyCopyHashSet_1<GlobalNamespace::ISliderDidStartDissolvingEvent> get_sliderDidStartDissolvingEvent() ;

/// @brief Method get_sliderDidDissolveEvent addr 0x2280a9c size 0x8 virtual false final false
 GlobalNamespace::ILazyCopyHashSet_1<GlobalNamespace::ISliderDidDissolveEvent> get_sliderDidDissolveEvent() ;

/// @brief Method get_sliderHeadDidMovePastCutMark addr 0x2280aa4 size 0x8 virtual false final false
 GlobalNamespace::ILazyCopyHashSet_1<GlobalNamespace::ISliderHeadDidMovePastCutMarkEvent> get_sliderHeadDidMovePastCutMark() ;

/// @brief Method get_sliderTailDidMovePastCutMark addr 0x2280aac size 0x8 virtual false final false
 GlobalNamespace::ILazyCopyHashSet_1<GlobalNamespace::ISliderTailDidMovePastCutMarkEvent> get_sliderTailDidMovePastCutMark() ;

/// @brief Method get_lengthType addr 0x2280ab4 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__SliderController__LengthType get_lengthType() ;

/// @brief Method get_sliderData addr 0x2280abc size 0x8 virtual false final false
 GlobalNamespace::SliderData get_sliderData() ;

/// @brief Method get_saberInteractionParam addr 0x2280ac4 size 0x40 virtual false final false
 float_t get_saberInteractionParam() ;

/// @brief Method get_sliderMeshController addr 0x2280b2c size 0x8 virtual false final false
 GlobalNamespace::SliderMeshController get_sliderMeshController() ;

/// @brief Method get_sliderMovement addr 0x2280b34 size 0x8 virtual false final false
 GlobalNamespace::SliderMovement get_sliderMovement() ;

/// @brief Method get_initColor addr 0x2280b3c size 0xc virtual false final false
 UnityEngine::Color get_initColor() ;

/// @brief Method get_randomValue addr 0x2280b48 size 0x8 virtual false final false
 float_t get_randomValue() ;

/// @brief Method get_zDistanceBetweenNotes addr 0x2280b50 size 0x8 virtual false final false
 float_t get_zDistanceBetweenNotes() ;

/// @brief Method get_jumpDistance addr 0x2280b58 size 0x8 virtual false final false
 float_t get_jumpDistance() ;

/// @brief Method get_headJumpOffsetY addr 0x2280b60 size 0x8 virtual false final false
 float_t get_headJumpOffsetY() ;

/// @brief Method get_sliderDuration addr 0x2280b68 size 0x8 virtual false final false
 float_t get_sliderDuration() ;

/// @brief Method get_closeSmoothedSaberInteractionPos addr 0x2280b70 size 0x8 virtual false final false
 GlobalNamespace::FixedUpdateVector3SmoothValue get_closeSmoothedSaberInteractionPos() ;

/// @brief Method get_sliderIntensityEffect addr 0x2280b78 size 0x8 virtual false final false
 GlobalNamespace::SliderIntensityEffect get_sliderIntensityEffect() ;

/// @brief Method Init addr 0x2280b80 size 0x3d0 virtual false final false
...
/// @brief Method Awake addr 0x2281ab0 size 0x160 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x2281de4 size 0x150 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2281fd0 size 0x2a8 virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x22824e8 size 0x4 virtual false final false
 void Update() ;

/// @brief Method FixedUpdate addr 0x2282560 size 0x58 virtual false final false
 void FixedUpdate() ;

/// @brief Method ManualUpdate addr 0x22824ec size 0x74 virtual false final false
 void ManualUpdate() ;

/// @brief Method UpdateMaterialPropertyBlock addr 0x2281970 size 0x118 virtual false final false
 void UpdateMaterialPropertyBlock(float_t timeSinceHeadNoteJump) ;

/// @brief Method DissolveCoroutine addr 0x2282800 size 0x78 virtual false final false
 System::Collections::IEnumerator DissolveCoroutine(float_t duration) ;

/// @brief Method Dissolve addr 0x22828a0 size 0x60 virtual true final true
 void Dissolve(float_t duration) ;

/// @brief Method Hide addr 0x2282900 size 0x2c virtual true final true
 void Hide(bool hide) ;

/// @brief Method Pause addr 0x228292c size 0x10 virtual true final true
 void Pause(bool pause) ;

/// @brief Method IsNoteStartOfThisSlider addr 0x228293c size 0xe8 virtual false final false
 bool IsNoteStartOfThisSlider(GlobalNamespace::NoteData noteData) ;

/// @brief Method HandleMovementDidFinish addr 0x2282a24 size 0x1d4 virtual false final false
 void HandleMovementDidFinish() ;

/// @brief Method HandleHeadDidMovePastCutMark addr 0x2282bf8 size 0x1f0 virtual false final false
 void HandleHeadDidMovePastCutMark() ;

/// @brief Method HandleTailDidMovePastCutMark addr 0x2282e18 size 0x1e0 virtual false final false
 void HandleTailDidMovePastCutMark() ;

/// @brief Method HandleNoteWasMissed addr 0x2282ff8 size 0x4c virtual false final false
 void HandleNoteWasMissed(GlobalNamespace::NoteController noteController) ;

/// @brief Method HandleNoteWasCut addr 0x2283074 size 0x80 virtual false final false
 void HandleNoteWasCut(GlobalNamespace::NoteController noteController, ByRef<GlobalNamespace::NoteCutInfo> noteCutInfo) ;

/// @brief Method HandleFadeInDidStart addr 0x22830f4 size 0x8 virtual false final false
 void HandleFadeInDidStart() ;

/// @brief Method SetSaberAttraction addr 0x2281894 size 0x88 virtual false final false
 void SetSaberAttraction(bool saberAttraction) ;

/// @brief Method GetSaberInteractionPoint addr 0x228191c size 0x54 virtual false final false
static UnityEngine::Vector3 GetSaberInteractionPoint(GlobalNamespace::Saber saber) ;

// Ctor Parameters []
explicit SliderController() ;

/// @brief Method .ctor addr 0x22830fc size 0x194 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 376 }), TypeDefinitionIndex(TypeDefinitionIndex(11011)), TypeDefinitionIndex(TypeDefinitionIndex(4929))}
...
/// @brief Method .ctor addr 0x22833c4 size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x228340c size 0x48 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11011)), TypeDefinitionIndex(TypeDefinitionIndex(4929)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 376 })}
...
/// @brief Method .ctor addr 0x2283454 size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2283290 size 0x3c virtual false final false
...
/// @brief Method GetPool addr 0x22832cc size 0xa0 virtual false final false
...
/// @brief Method GetLengthFromSliderData addr 0x228336c size 0x58 virtual false final false
...
/// @brief Method .ctor addr 0x2282878 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x228349c size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x22834a0 size 0x3ec virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x228388c size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x2283894 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x22838d4 size 0x8 virtual true final true
