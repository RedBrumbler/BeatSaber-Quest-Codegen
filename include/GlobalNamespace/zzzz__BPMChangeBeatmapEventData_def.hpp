...
/// @brief Method .ctor addr 0xda07d8 size 0x44 virtual false final false
 void _ctor(float_t time, float_t bpm) ;

/// @brief Method GetCopy addr 0xda081c size 0x8c virtual true final false
 GlobalNamespace::BeatmapDataItem GetCopy() ;

/// @brief Method GetDefault addr 0xda08a8 size 0x8 virtual true final false
