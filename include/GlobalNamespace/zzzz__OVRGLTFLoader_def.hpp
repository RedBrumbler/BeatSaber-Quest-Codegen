...
/// @brief Method .ctor addr 0x25e87c0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ProcessMesh>b__0 addr 0x25e87c8 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x25e4500 size 0x38 virtual false final false
...
/// @brief Method .ctor addr 0x25e4538 size 0x88 virtual false final false
 void _ctor(::ArrayW<uint8_t> data) ;

/// @brief Method LoadGLB addr 0x25e45c0 size 0x554 virtual false final false
 GlobalNamespace::OVRGLTFScene LoadGLB(bool supportAnimation, bool loadMips) ;

/// @brief Method SetModelShader addr 0x25e5300 size 0x8 virtual false final false
 void SetModelShader(UnityEngine::Shader shader) ;

/// @brief Method SetModelAlphaBlendShader addr 0x25e5308 size 0x8 virtual false final false
 void SetModelAlphaBlendShader(UnityEngine::Shader shader) ;

/// @brief Method SetTextureQualityFiltering addr 0x25e5310 size 0x8 virtual false final false
 void SetTextureQualityFiltering(GlobalNamespace::OVRTextureQualityFiltering loadedTexturesQuality) ;

/// @brief Method SetMipMapBias addr 0x25e5318 size 0x1c virtual false final false
 void SetMipMapBias(float_t loadedTexturesMipmapBiasing) ;

/// @brief Method DetectTextureQuality addr 0x25e5334 size 0xc0 virtual false final false
static GlobalNamespace::OVRTextureQualityFiltering DetectTextureQuality(ByRef<UnityEngine::Texture2D> srcTexture) ;

/// @brief Method ApplyTextureQuality addr 0x25e53f4 size 0x174 virtual false final false
...
/// @brief Method ValidateGLB addr 0x25e4b14 size 0x208 virtual false final false
 bool ValidateGLB(System::IO::Stream glbStream) ;

/// @brief Method ReadChunk addr 0x25e4d1c size 0xac virtual false final false
 ::ArrayW<uint8_t> ReadChunk(System::IO::Stream glbStream, GlobalNamespace::OVRChunkType type) ;

/// @brief Method ValidateChunk addr 0x25e4dc8 size 0x148 virtual false final false
 bool ValidateChunk(System::IO::Stream glbStream, GlobalNamespace::OVRChunkType type, ByRef<uint32_t> chunkLength) ;

/// @brief Method LoadGLTF addr 0x25e4f10 size 0x3f0 virtual false final false
 int32_t LoadGLTF(bool supportAnimation, bool loadMips) ;

/// @brief Method ProcessNode addr 0x25e5568 size 0x8ac virtual false final false
 void ProcessNode(OVRSimpleJSON::JSONNode node, int32_t nodeId, bool loadMips) ;

/// @brief Method ProcessMesh addr 0x25e62b4 size 0x143c virtual false final false
 GlobalNamespace::OVRMeshData ProcessMesh(OVRSimpleJSON::JSONNode meshNode, bool loadMips) ;

/// @brief Method FlipTraingleIndices addr 0x25e8134 size 0x6c virtual false final false
static void FlipTraingleIndices(ByRef<::ArrayW<int32_t>> indices) ;

/// @brief Method ProcessSkin addr 0x25e76f0 size 0x410 virtual false final false
 void ProcessSkin(OVRSimpleJSON::JSONNode skinNode, UnityEngine::SkinnedMeshRenderer renderer) ;

/// @brief Method ProcessMaterial addr 0x25e7b00 size 0x264 virtual false final false
 GlobalNamespace::OVRMaterialData ProcessMaterial(int32_t matId) ;

/// @brief Method ProcessTexture addr 0x25e7d64 size 0x3d0 virtual false final false
 GlobalNamespace::OVRTextureData ProcessTexture(int32_t textureId) ;

/// @brief Method TranscodeTexture addr 0x25e8330 size 0x90 virtual false final false
 void TranscodeTexture(ByRef<GlobalNamespace::OVRTextureData> textureData) ;

/// @brief Method CreateUnityMaterial addr 0x25e81a0 size 0x190 virtual false final false
 UnityEngine::Material CreateUnityMaterial(GlobalNamespace::OVRMaterialData matData, bool loadMips) ;

/// @brief Method GetInputNodeType addr 0x25e83c0 size 0x1c4 virtual false final false
 GlobalNamespace::OVRGLTFInputNode GetInputNodeType(::StringW name) ;

/// @brief Method ProcessAnimations addr 0x25e5e14 size 0x4a0 virtual false final false
