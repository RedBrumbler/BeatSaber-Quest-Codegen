...
/// @brief Method get_packID addr 0x221cee4 size 0x8 virtual true final true
 ::StringW get_packID() ;

/// @brief Method get_packName addr 0x221ceec size 0x8 virtual true final true
 ::StringW get_packName() ;

/// @brief Method get_shortPackName addr 0x221cef4 size 0x8 virtual true final true
 ::StringW get_shortPackName() ;

/// @brief Method get_collectionName addr 0x221cefc size 0x8 virtual true final true
 ::StringW get_collectionName() ;

/// @brief Method get_coverImage addr 0x221cf04 size 0x8 virtual true final true
 UnityEngine::Sprite get_coverImage() ;

/// @brief Method get_smallCoverImage addr 0x221cf0c size 0x8 virtual true final true
 UnityEngine::Sprite get_smallCoverImage() ;

/// @brief Method get_beatmapLevelCollection addr 0x221cf14 size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0x221cf1c size 0x54 virtual false final false
...
/// @brief Method CreateBeatmapLevelPackByUsingBeatmapCharacteristicFiltering addr 0x221cf70 size 0x2fc virtual false final false
