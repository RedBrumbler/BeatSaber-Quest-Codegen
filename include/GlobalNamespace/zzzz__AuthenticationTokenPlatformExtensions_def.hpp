...
/// @brief Method ToAuthenticationTokenPlatform addr 0x223b0a0 size 0x28 virtual false final false
...
/// @brief Method ToUserInfoPlatform addr 0x223b0c8 size 0x2c virtual false final false
