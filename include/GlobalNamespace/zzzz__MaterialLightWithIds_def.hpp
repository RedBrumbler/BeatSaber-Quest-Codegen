...
/// @brief Method Awake addr 0x1fda940 size 0x84 virtual true final false
 void Awake() ;

/// @brief Method ColorWasSet addr 0x1fda9c4 size 0x140 virtual true final false
 void ColorWasSet(UnityEngine::Color color) ;

// Ctor Parameters []
explicit MaterialLightWithIds() ;

/// @brief Method .ctor addr 0x1fdab04 size 0x60 virtual false final false
 void _ctor() ;
