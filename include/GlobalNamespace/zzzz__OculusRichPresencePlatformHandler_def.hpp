...
/// @brief Method SetPresence addr 0x226483c size 0x308 virtual true final true
 void SetPresence(GlobalNamespace::IRichPresenceData richPresenceData) ;

/// @brief Method Clear addr 0x2264b44 size 0x9c virtual true final true
 void Clear() ;

// Ctor Parameters []
explicit OculusRichPresencePlatformHandler() ;

/// @brief Method .ctor addr 0x2264be0 size 0x8 virtual false final false
 void _ctor() ;
