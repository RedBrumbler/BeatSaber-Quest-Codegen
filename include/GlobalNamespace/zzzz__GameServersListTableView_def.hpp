...
/// @brief Method add_joinButtonPressedEvent addr 0x21beb60 size 0xb0 virtual false final false
 void add_joinButtonPressedEvent(System::Action_1<GlobalNamespace::INetworkPlayer> value) ;

/// @brief Method remove_joinButtonPressedEvent addr 0x21bec10 size 0xb0 virtual false final false
 void remove_joinButtonPressedEvent(System::Action_1<GlobalNamespace::INetworkPlayer> value) ;

/// @brief Method CellSize addr 0x21becc0 size 0xc virtual true final true
 float_t CellSize() ;

/// @brief Method NumberOfCells addr 0x21beccc size 0x18 virtual true final true
 int32_t NumberOfCells() ;

/// @brief Method Init addr 0x21bece4 size 0x114 virtual false final false
 void Init() ;

/// @brief Method CellForContent addr 0x21bedf8 size 0x164 virtual true final true
 HMUI::TableCell CellForContent(GlobalNamespace::TableViewWithDetailCell tableView, int32_t idx, bool detailOpened) ;

/// @brief Method CellForDetail addr 0x21bef5c size 0x1bc virtual true final true
 HMUI::TableCell CellForDetail(GlobalNamespace::TableViewWithDetailCell tableView, int32_t contentIdx) ;

/// @brief Method SetData addr 0x21bf118 size 0x124 virtual false final false
 void SetData(System::Collections::Generic::IEnumerable_1<GlobalNamespace::INetworkPlayer> servers, bool clearSelection) ;

/// @brief Method HandleGameServerListDetailTableCellJoinServerButtonWasPressed addr 0x21bf23c size 0x24 virtual false final false
 void HandleGameServerListDetailTableCellJoinServerButtonWasPressed() ;

/// @brief Method HandleTableViewDidSelectCellWithIdx addr 0x21bf260 size 0x34 virtual false final false
 void HandleTableViewDidSelectCellWithIdx(HMUI::TableView tableView, int32_t id) ;

/// @brief Method HandleTableViewDidDeselectCellWithIdx addr 0x21bf294 size 0x8 virtual false final false
 void HandleTableViewDidDeselectCellWithIdx(GlobalNamespace::TableViewWithDetailCell arg1, int32_t arg2) ;

/// @brief Method OnDestroy addr 0x21bf29c size 0xf4 virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit GameServersListTableView() ;

/// @brief Method .ctor addr 0x21bf390 size 0x8 virtual false final false
 void _ctor() ;
