...
/// @brief Method Start addr 0x20f7b94 size 0xd0 virtual false final false
 void Start() ;

/// @brief Method HandleAvatarPoseControllerPositionsWillBeSet addr 0x20f7c64 size 0x30 virtual false final false
...
/// @brief Method HandleAvatarPoseControllerRotationsWillBeSet addr 0x20f7c9c size 0x3c virtual false final false
...
/// @brief Method MirrorRotation addr 0x20f7cd8 size 0xc virtual false final false
static UnityEngine::Quaternion MirrorRotation(UnityEngine::Quaternion rotation) ;

/// @brief Method MirrorPosition addr 0x20f7c94 size 0x8 virtual false final false
static UnityEngine::Vector3 MirrorPosition(UnityEngine::Vector3 position) ;

// Ctor Parameters []
explicit AvatarPoseMirror() ;

/// @brief Method .ctor addr 0x20f7ce4 size 0x8 virtual false final false
 void _ctor() ;
