...
/// @brief Method MoveNext addr 0x21c74a4 size 0x584 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x21c7a28 size 0xc virtual true final true
...
/// @brief Method add_didChangeDifficultyBeatmapEvent addr 0x21c675c size 0xb0 virtual false final false
...
/// @brief Method remove_didChangeDifficultyBeatmapEvent addr 0x21c680c size 0xb0 virtual false final false
...
/// @brief Method add_didFavoriteToggleChangeEvent addr 0x21c68bc size 0xb0 virtual false final false
...
/// @brief Method remove_didFavoriteToggleChangeEvent addr 0x21c696c size 0xb0 virtual false final false
...
/// @brief Method get_selectedDifficultyBeatmap addr 0x21c6a1c size 0x8 virtual false final false
 GlobalNamespace::IDifficultyBeatmap get_selectedDifficultyBeatmap() ;

/// @brief Method get_actionButton addr 0x21c6a24 size 0x8 virtual false final false
 UnityEngine::UI::Button get_actionButton() ;

/// @brief Method set_actionButtonText addr 0x21c6a2c size 0x24 virtual false final false
 void set_actionButtonText(::StringW value) ;

/// @brief Method get_practiceButton addr 0x21c6a50 size 0x8 virtual false final false
 UnityEngine::UI::Button get_practiceButton() ;

/// @brief Method set_hidePracticeButton addr 0x21c6a58 size 0x34 virtual false final false
 void set_hidePracticeButton(bool value) ;

/// @brief Method SetContent addr 0x21c6a8c size 0x308 virtual false final false
...
/// @brief Method Awake addr 0x21c6f1c size 0x184 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x21c70a0 size 0x178 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleBeatmapDifficultySegmentedControlControllerDidSelectDifficulty addr 0x21c7218 size 0x38 virtual false final false
...
/// @brief Method HandleBeatmapCharacteristicSegmentedControlControllerDidSelectBeatmapCharacteristic addr 0x21c7250 size 0x184 virtual false final false
...
/// @brief Method RefreshContent addr 0x21c6d94 size 0x188 virtual false final false
 void RefreshContent() ;

/// @brief Method SetContentForBeatmapDataAsync addr 0x21c73d4 size 0x9c virtual false final false
 void SetContentForBeatmapDataAsync(GlobalNamespace::IDifficultyBeatmap selectedDifficultyBeatmap) ;

/// @brief Method ClearContent addr 0x21c7470 size 0x8 virtual false final false
 void ClearContent() ;

// Ctor Parameters []
explicit StandardLevelDetailView() ;

/// @brief Method .ctor addr 0x21c7478 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__29_0 addr 0x21c7480 size 0x24 virtual false final false
