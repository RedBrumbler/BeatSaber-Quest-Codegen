...
/// @brief Method set_localPosition addr 0x1fd2678 size 0x48 virtual false final false
 void set_localPosition(UnityEngine::Vector3 value) ;

/// @brief Method Awake addr 0x1fd26c0 size 0x20 virtual false final false
 void Awake() ;

/// @brief Method OnEnable addr 0x1fd26e0 size 0x28 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fd282c size 0x20 virtual false final false
 void OnDisable() ;

/// @brief Method Refresh addr 0x1fd2708 size 0x124 virtual false final false
 void Refresh() ;

// Ctor Parameters []
explicit ParametricBoxFakeGlowController() ;

/// @brief Method .ctor addr 0x1fd284c size 0x1c virtual false final false
 void _ctor() ;
