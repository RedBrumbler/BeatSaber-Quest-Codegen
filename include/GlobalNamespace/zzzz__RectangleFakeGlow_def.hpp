...
/// @brief Method set_color addr 0x22a3c48 size 0xc4 virtual false final false
 void set_color(UnityEngine::Color value) ;

/// @brief Method get_color addr 0x22a3d0c size 0xc virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method Awake addr 0x22a3d18 size 0x6c virtual false final false
 void Awake() ;

/// @brief Method OnEnable addr 0x22a3d84 size 0x74 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x22a3f0c size 0x6c virtual false final false
 void OnDisable() ;

/// @brief Method Refresh addr 0x22a3df8 size 0x114 virtual false final false
 void Refresh() ;

// Ctor Parameters []
explicit RectangleFakeGlow() ;

/// @brief Method .ctor addr 0x22a3f78 size 0x24 virtual false final false
 void _ctor() ;
