...
/// @brief Method get_BoneIndex addr 0x2665508 size 0x8 virtual false final false
 int16_t get_BoneIndex() ;

/// @brief Method set_BoneIndex addr 0x2665510 size 0x8 virtual false final false
 void set_BoneIndex(int16_t value) ;

/// @brief Method get_CapsuleRigidbody addr 0x2665518 size 0x8 virtual false final false
 UnityEngine::Rigidbody get_CapsuleRigidbody() ;

/// @brief Method set_CapsuleRigidbody addr 0x2665520 size 0x8 virtual false final false
 void set_CapsuleRigidbody(UnityEngine::Rigidbody value) ;

/// @brief Method get_CapsuleCollider addr 0x2665528 size 0x8 virtual false final false
 UnityEngine::CapsuleCollider get_CapsuleCollider() ;

/// @brief Method set_CapsuleCollider addr 0x2665530 size 0x8 virtual false final false
 void set_CapsuleCollider(UnityEngine::CapsuleCollider value) ;

// Ctor Parameters []
explicit OVRBoneCapsule() ;

/// @brief Method .ctor addr 0x2664c74 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2665538 size 0x3c virtual false final false
