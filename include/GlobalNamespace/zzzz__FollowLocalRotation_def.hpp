...
/// @brief Method Awake addr 0x1fb385c size 0x1c virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x1fb3878 size 0x34 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit FollowLocalRotation() ;

/// @brief Method .ctor addr 0x1fb38ac size 0x8 virtual false final false
 void _ctor() ;
