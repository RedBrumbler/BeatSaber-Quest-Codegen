...
/// @brief Method ProcessFrame addr 0x21ea6e0 size 0x158 virtual true final false
...
/// @brief Method OnPlayableDestroy addr 0x21ea838 size 0x90 virtual true final false
 void OnPlayableDestroy(UnityEngine::Playables::Playable playable) ;

// Ctor Parameters []
explicit BloomFogParamsBehaviour() ;

/// @brief Method .ctor addr 0x21ea8c8 size 0x8 virtual false final false
 void _ctor() ;
