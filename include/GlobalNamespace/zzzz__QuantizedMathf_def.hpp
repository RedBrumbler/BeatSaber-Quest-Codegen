...
/// @brief Method Approximately addr 0x1226520 size 0xd4 virtual false final false
static bool Approximately(UnityEngine::Quaternion a, UnityEngine::Quaternion b) ;

/// @brief Method Approximately addr 0x12265f4 size 0x10 virtual false final false
static bool Approximately(float_t a, float_t b, float_t epsilon) ;

/// @brief Method Approximately addr 0x1226604 size 0x74 virtual false final false
static bool Approximately(int32_t a, int32_t b, int32_t epsilon) ;

/// @brief Method Approximately addr 0x1226678 size 0x38 virtual false final false
static bool Approximately(UnityEngine::Vector3 a, UnityEngine::Vector3 b) ;

/// @brief Method Approximately addr 0x12266b0 size 0x60 virtual false final false
static bool Approximately(UnityEngine::Pose a, UnityEngine::Pose b) ;

/// @brief Method QuantizedVectorComponentToString addr 0x1226710 size 0x100 virtual false final false
