...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13959))}
...
/// @brief Method get_positionOffset addr 0x22671c8 size 0x4c virtual true final false
 UnityEngine::Vector3 get_positionOffset() ;

/// @brief Method get_rotationOffset addr 0x2267214 size 0x4c virtual true final false
 UnityEngine::Vector3 get_rotationOffset() ;

// Ctor Parameters []
explicit VRControllersValueSOOffsets() ;

/// @brief Method .ctor addr 0x2267260 size 0x8 virtual false final false
 void _ctor() ;
