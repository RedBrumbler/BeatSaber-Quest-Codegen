...
/// @brief Method add_didInitEvent addr 0x227f3b4 size 0xb0 virtual false final false
 void add_didInitEvent(System::Action_1<GlobalNamespace::ObstacleControllerBase> value) ;

/// @brief Method remove_didInitEvent addr 0x227f464 size 0xb0 virtual false final false
 void remove_didInitEvent(System::Action_1<GlobalNamespace::ObstacleControllerBase> value) ;

/// @brief Method add_didStartDissolvingEvent addr 0x227e244 size 0xb0 virtual false final false
 void add_didStartDissolvingEvent(System::Action_2<GlobalNamespace::ObstacleControllerBase,float_t> value) ;

/// @brief Method remove_didStartDissolvingEvent addr 0x227dcb8 size 0xb0 virtual false final false
 void remove_didStartDissolvingEvent(System::Action_2<GlobalNamespace::ObstacleControllerBase,float_t> value) ;

/// @brief Method InvokeDidInitEvent addr 0x227e2f4 size 0x1c virtual false final false
 void InvokeDidInitEvent(GlobalNamespace::ObstacleControllerBase obstacleController) ;

/// @brief Method InvokeDidStartDissolvingEvent addr 0x227e330 size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0x227e354 size 0x8 virtual false final false
 void _ctor() ;
