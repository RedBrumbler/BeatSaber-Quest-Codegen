...
/// @brief Method .ctor addr 0x210ad98 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x2109874 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <get_canPause>b__0 addr 0x210adc0 size 0x10 virtual false final false
...
/// @brief Method add_didPauseEvent addr 0x2109278 size 0x9c virtual false final false
 void add_didPauseEvent(System::Action value) ;

/// @brief Method remove_didPauseEvent addr 0x2109314 size 0x9c virtual false final false
 void remove_didPauseEvent(System::Action value) ;

/// @brief Method add_didResumeEvent addr 0x21093b0 size 0x9c virtual false final false
 void add_didResumeEvent(System::Action value) ;

/// @brief Method remove_didResumeEvent addr 0x210944c size 0x9c virtual false final false
 void remove_didResumeEvent(System::Action value) ;

/// @brief Method add_canPauseEvent addr 0x21094e8 size 0xb0 virtual false final false
 void add_canPauseEvent(System::Action_1<System::Action_1<bool>> value) ;

/// @brief Method remove_canPauseEvent addr 0x2109598 size 0xb0 virtual false final false
 void remove_canPauseEvent(System::Action_1<System::Action_1<bool>> value) ;

/// @brief Method add_didReturnToMenuEvent addr 0x2109648 size 0x9c virtual false final false
 void add_didReturnToMenuEvent(System::Action value) ;

/// @brief Method remove_didReturnToMenuEvent addr 0x21096e4 size 0x9c virtual false final false
 void remove_didReturnToMenuEvent(System::Action value) ;

/// @brief Method get_wantsToPause addr 0x2109780 size 0x8 virtual false final false
 bool get_wantsToPause() ;

/// @brief Method get_canPause addr 0x2109788 size 0xec virtual false final false
 bool get_canPause() ;

/// @brief Method Start addr 0x210987c size 0x56c virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x210a108 size 0x4fc virtual false final false
 void OnDestroy() ;

/// @brief Method OnApplicationPause addr 0x210a874 size 0xc virtual false final false
 void OnApplicationPause(bool pauseStatus) ;

/// @brief Method Pause addr 0x210a880 size 0x110 virtual false final false
 void Pause() ;

/// @brief Method PauseGameOnStartupIfItShouldBePaused addr 0x210a9e8 size 0x4c virtual false final false
 void PauseGameOnStartupIfItShouldBePaused() ;

/// @brief Method HandleLevelDidStart addr 0x210aa34 size 0x4 virtual false final false
 void HandleLevelDidStart() ;

/// @brief Method HandleLevelWillStartIntro addr 0x210aa38 size 0x4 virtual false final false
 void HandleLevelWillStartIntro() ;

/// @brief Method HandleMenuButtonTriggered addr 0x210aa3c size 0x4 virtual false final false
 void HandleMenuButtonTriggered() ;

/// @brief Method HandleInputFocusWasCaptured addr 0x210aa40 size 0x4 virtual false final false
 void HandleInputFocusWasCaptured() ;

/// @brief Method HandleHMDUnmounted addr 0x210aa44 size 0x4 virtual false final false
 void HandleHMDUnmounted() ;

/// @brief Method HandleControllersDidDisconnectEvent addr 0x210aa48 size 0x4 virtual false final false
 void HandleControllersDidDisconnectEvent() ;

/// @brief Method HandlePauseMenuManagerDidFinishResumeAnimation addr 0x210aa4c size 0xec virtual false final false
 void HandlePauseMenuManagerDidFinishResumeAnimation() ;

/// @brief Method HandlePauseMenuManagerDidPressContinueButton addr 0x210ab38 size 0xd8 virtual false final false
 void HandlePauseMenuManagerDidPressContinueButton() ;

/// @brief Method HandlePauseMenuManagerDidPressRestartButton addr 0x210ac38 size 0xa0 virtual false final false
 void HandlePauseMenuManagerDidPressRestartButton() ;

/// @brief Method HandlePauseMenuManagerDidPressMenuButton addr 0x210acd8 size 0xb8 virtual false final false
 void HandlePauseMenuManagerDidPressMenuButton() ;

/// @brief Method GetDefaultPausedState addr 0x210a058 size 0xb0 virtual false final false
 bool GetDefaultPausedState() ;

// Ctor Parameters []
explicit PauseController() ;

/// @brief Method .ctor addr 0x210ad90 size 0x8 virtual false final false
 void _ctor() ;
