...
/// @brief Method get_beatmapLevelPacks addr 0x221d26c size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0x221d274 size 0x28 virtual false final false
