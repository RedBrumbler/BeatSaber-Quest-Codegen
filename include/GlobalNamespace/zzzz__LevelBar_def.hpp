...
/// @brief Method MoveNext addr 0x21c06ac size 0x940 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x21c0fec size 0xc virtual true final true
...
/// @brief Method set_hide addr 0x21c059c size 0x2c virtual false final false
 void set_hide(bool value) ;

/// @brief Method Setup addr 0x21c05c8 size 0xc virtual false final false
 void Setup(GlobalNamespace::IPreviewBeatmapLevel previewBeatmapLevel) ;

/// @brief Method Setup addr 0x21c05d4 size 0xbc virtual false final false
...
/// @brief Method OnDestroy addr 0x21c0690 size 0x14 virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit LevelBar() ;

/// @brief Method .ctor addr 0x21c06a4 size 0x8 virtual false final false
 void _ctor() ;
