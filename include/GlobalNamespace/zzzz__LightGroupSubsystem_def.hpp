...
/// @brief Method get_groupId addr 0x2298574 size 0x1c virtual false final false
 int32_t get_groupId() ;

/// @brief Method get_lightGroup addr 0x2298590 size 0x8 virtual false final false
 GlobalNamespace::LightGroup get_lightGroup() ;

/// @brief Method OnEnable addr 0x2298598 size 0x60 virtual false final false
 void OnEnable() ;

// Ctor Parameters []
explicit LightGroupSubsystem() ;

/// @brief Method .ctor addr 0x2296a54 size 0x8 virtual false final false
 void _ctor() ;
