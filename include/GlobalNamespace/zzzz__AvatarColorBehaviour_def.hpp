...
/// @brief Method OnGraphStart addr 0x21ea2c8 size 0x74 virtual true final false
 void OnGraphStart(UnityEngine::Playables::Playable playable) ;

/// @brief Method ProcessFrame addr 0x21ea33c size 0x1e8 virtual true final false
...
/// @brief Method OnPlayableDestroy addr 0x21ea524 size 0x8c virtual true final false
 void OnPlayableDestroy(UnityEngine::Playables::Playable playable) ;

// Ctor Parameters []
explicit AvatarColorBehaviour() ;

/// @brief Method .ctor addr 0x21ea5b0 size 0x20 virtual false final false
 void _ctor() ;
