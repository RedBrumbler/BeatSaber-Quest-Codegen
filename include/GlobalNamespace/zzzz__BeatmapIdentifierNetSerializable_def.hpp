...
/// @brief Method get_levelID addr 0x121fbb4 size 0x8 virtual false final false
 ::StringW get_levelID() ;

/// @brief Method set_levelID addr 0x121fbbc size 0x8 virtual false final false
 void set_levelID(::StringW value) ;

/// @brief Method get_beatmapCharacteristicSerializedName addr 0x121fbc4 size 0x8 virtual false final false
 ::StringW get_beatmapCharacteristicSerializedName() ;

/// @brief Method set_beatmapCharacteristicSerializedName addr 0x121fbcc size 0x8 virtual false final false
 void set_beatmapCharacteristicSerializedName(::StringW value) ;

/// @brief Method get_difficulty addr 0x121fbd4 size 0x8 virtual false final false
 GlobalNamespace::BeatmapDifficulty get_difficulty() ;

/// @brief Method set_difficulty addr 0x121fbdc size 0x8 virtual false final false
 void set_difficulty(GlobalNamespace::BeatmapDifficulty value) ;

// Ctor Parameters []
explicit BeatmapIdentifierNetSerializable() ;

/// @brief Method .ctor addr 0x121fbe4 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x121fbec size 0x3c virtual false final false
 void _ctor(::StringW levelID, ::StringW beatmapCharacteristicSerializedName, GlobalNamespace::BeatmapDifficulty difficulty) ;

/// @brief Method LiteNetLib.Utils.INetSerializable.Deserialize addr 0x121fc28 size 0x50 virtual true final true
 void LiteNetLib_Utils_INetSerializable_Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method LiteNetLib.Utils.INetSerializable.Serialize addr 0x121fc88 size 0x4c virtual true final true
 void LiteNetLib_Utils_INetSerializable_Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Equals addr 0x121fcdc size 0x70 virtual true final true
 bool Equals(GlobalNamespace::BeatmapIdentifierNetSerializable other) ;

/// @brief Method Equals addr 0x121fd4c size 0x10c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x121fe58 size 0x64 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x121febc size 0x90 virtual true final false
 ::StringW ToString() ;
