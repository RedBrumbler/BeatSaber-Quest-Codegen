...
/// @brief Method Save addr 0x1fb91e0 size 0x10 virtual true final true
 void Save(::StringW key, ::StringW value) ;

/// @brief Method Load addr 0x1fb91f0 size 0x80 virtual true final true
 bool Load(::StringW key, ByRef<::StringW> value) ;

/// @brief Method Save addr 0x1fb9270 size 0x78 virtual true final true
 void Save(::StringW key, ::StringW value, ::StringW tempKey, ::StringW backupKey) ;

/// @brief Method Load addr 0x1fb92e8 size 0x168 virtual true final true
 bool Load(::StringW key, ByRef<::StringW> value, ::StringW backupKey) ;

/// @brief Method Delete addr 0x1fb9450 size 0xc virtual true final true
 void Delete(::StringW key) ;

/// @brief Method HasKey addr 0x1fb945c size 0xc virtual true final true
 bool HasKey(::StringW key) ;

// Ctor Parameters []
explicit FileSaveData() ;

/// @brief Method .ctor addr 0x1fb9468 size 0x8 virtual false final false
 void _ctor() ;
