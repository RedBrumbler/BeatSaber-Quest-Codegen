...
/// @brief Method SetBeforeIntroValues addr 0x211fa04 size 0x1c virtual false final false
 void SetBeforeIntroValues() ;

/// @brief Method SetAfterIntroValues addr 0x211fa20 size 0x48 virtual false final false
 void SetAfterIntroValues() ;

// Ctor Parameters []
explicit MultiplayerLocalActivePlayerIntroAnimator() ;

/// @brief Method .ctor addr 0x211fa68 size 0x8 virtual false final false
 void _ctor() ;
