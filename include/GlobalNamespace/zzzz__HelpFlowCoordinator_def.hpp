...
constexpr GlobalNamespace::EulaDisplayViewController __get__eulaDisplayViewController() const;
 ...
 GlobalNamespace::LicensesDisplayViewController __declspec(property(get=__get__licensesDisplayViewController, put=__set__licensesDisplayViewController))  _licensesDisplayViewController;

constexpr void __set__licensesDisplayViewController(GlobalNamespace::LicensesDisplayViewController value) ;

constexpr GlobalNamespace::LicensesDisplayViewController __get__licensesDisplayViewController() const;
...
/// @brief Field kLicensesMenu offset 0
...
/// @brief Method add_didFinishEvent addr 0x216ae48 size 0xb0 virtual false final false
 void add_didFinishEvent(System::Action_1<GlobalNamespace::HelpFlowCoordinator> value) ;

/// @brief Method remove_didFinishEvent addr 0x216aef8 size 0xb0 virtual false final false
 void remove_didFinishEvent(System::Action_1<GlobalNamespace::HelpFlowCoordinator> value) ;

/// @brief Method DidActivate addr 0x216afa8 size 0x50c virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x216b4b4 size 0x10c virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method HandleDidSelectHelpSubMenu addr 0x216b5c0 size 0x64 virtual false final false
 void HandleDidSelectHelpSubMenu(int32_t idx) ;

/// @brief Method ReplaceViewController addr 0x216b624 size 0x104 virtual false final false
 void ReplaceViewController(HMUI::ViewController viewController) ;

/// @brief Method HandleHowToPlayViewControllerDidFinish addr 0x216b728 size 0x78 virtual false final false
...
/// @brief Method BackButtonWasPressed addr 0x216b7a0 size 0x20 virtual true final false
 void BackButtonWasPressed(HMUI::ViewController topViewController) ;

// Ctor Parameters []
explicit HelpFlowCoordinator() ;

/// @brief Method .ctor addr 0x216b7c0 size 0x8 virtual false final false
 void _ctor() ;
