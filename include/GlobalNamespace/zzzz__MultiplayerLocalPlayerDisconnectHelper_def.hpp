...
/// @brief Method Disconnect addr 0x211f430 size 0x210 virtual false final false
...
/// @brief Method ResolveDisconnectButtonString addr 0x21213b8 size 0x70 virtual false final false
 ::StringW ResolveDisconnectButtonString() ;

// Ctor Parameters []
explicit MultiplayerLocalPlayerDisconnectHelper() ;

/// @brief Method .ctor addr 0x2121428 size 0x8 virtual false final false
 void _ctor() ;
