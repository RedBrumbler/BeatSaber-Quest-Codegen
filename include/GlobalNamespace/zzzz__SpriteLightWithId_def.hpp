...
/// @brief Method get_color addr 0x1fdbb5c size 0x1c virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method ColorWasSet addr 0x1fdbb78 size 0x144 virtual true final false
 void ColorWasSet(UnityEngine::Color color) ;

// Ctor Parameters []
explicit SpriteLightWithId() ;

/// @brief Method .ctor addr 0x1fdbcbc size 0x24 virtual false final false
 void _ctor() ;
