...
/// @brief Method get_displayName addr 0x21f6694 size 0x8 virtual false final false
 ::StringW get_displayName() ;

/// @brief Method set_displayName addr 0x21f669c size 0x8 virtual false final false
 void set_displayName(::StringW value) ;

/// @brief Method get_fullPath addr 0x21f66a4 size 0x8 virtual false final false
 ::StringW get_fullPath() ;

/// @brief Method set_fullPath addr 0x21f66ac size 0x8 virtual false final false
 void set_fullPath(::StringW value) ;

/// @brief Method get_isDirectory addr 0x21f66b4 size 0x8 virtual false final false
 bool get_isDirectory() ;

/// @brief Method set_isDirectory addr 0x21f66bc size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x21f23c8 size 0x40 virtual false final false
