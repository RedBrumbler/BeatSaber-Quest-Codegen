...
/// @brief Method Start addr 0x2128e48 size 0xa0 virtual false final false
 void Start() ;

/// @brief Method HandlePlayersLayoutWasCalculated addr 0x2128ee8 size 0x58 virtual false final false
...
/// @brief Method .ctor addr 0x2128f40 size 0x8 virtual false final false
 void _ctor() ;
