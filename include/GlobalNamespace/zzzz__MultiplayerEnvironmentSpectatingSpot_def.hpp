...
/// @brief Method add_hasBeenRemovedEvent addr 0x213e8f8 size 0xb0 virtual true final true
 void add_hasBeenRemovedEvent(System::Action_1<GlobalNamespace::IMultiplayerSpectatingSpot> value) ;

/// @brief Method remove_hasBeenRemovedEvent addr 0x213e9a8 size 0xb0 virtual true final true
 void remove_hasBeenRemovedEvent(System::Action_1<GlobalNamespace::IMultiplayerSpectatingSpot> value) ;

/// @brief Method get_observable addr 0x213ea58 size 0x8 virtual true final true
 GlobalNamespace::IMultiplayerObservable get_observable() ;

/// @brief Method get_spotName addr 0x213ea60 size 0xbc virtual true final true
 ::StringW get_spotName() ;

/// @brief Method get_isMain addr 0x213eb1c size 0x8 virtual true final true
 bool get_isMain() ;

/// @brief Method Start addr 0x213eb24 size 0x1c virtual false final false
 void Start() ;

/// @brief Method OnDisable addr 0x213eb40 size 0x20 virtual false final false
 void OnDisable() ;

/// @brief Method SetIsObserved addr 0x213eb60 size 0x4 virtual true final true
 void SetIsObserved(bool isObserved) ;

// Ctor Parameters []
explicit MultiplayerEnvironmentSpectatingSpot() ;

/// @brief Method .ctor addr 0x213eb64 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method IMultiplayerSpectatingSpot.get_transform addr 0x213eb6c size 0x8 virtual true final true
