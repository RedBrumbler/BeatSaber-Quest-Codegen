...
/// @brief Method OnEnable addr 0x1fde6b0 size 0xbc virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fde79c size 0xa8 virtual false final false
 void OnDisable() ;

/// @brief Method HandleToggleValueChanged addr 0x1fde844 size 0x8 virtual false final false
 void HandleToggleValueChanged(bool isOn) ;

/// @brief Method SetCanvasGroupData addr 0x1fde76c size 0x30 virtual false final false
 void SetCanvasGroupData(bool isOn) ;

// Ctor Parameters []
explicit ToggleableCanvasGroup() ;

/// @brief Method .ctor addr 0x1fde84c size 0x8 virtual false final false
 void _ctor() ;
