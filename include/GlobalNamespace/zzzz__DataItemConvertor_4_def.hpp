...
template<::cordl_internals::il2cpp_reference_type TBase,::cordl_internals::il2cpp_reference_type TIn,::cordl_internals::il2cpp_reference_type TOut,::cordl_internals::il2cpp_reference_type TParam>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4319)), TypeDefinitionIndex(TypeDefinitionIndex(4318)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4318), inst: 1119 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4319), inst: 5945 })
