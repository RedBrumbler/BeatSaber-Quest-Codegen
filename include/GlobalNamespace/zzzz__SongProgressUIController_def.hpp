...
/// @brief Method Start addr 0x2105150 size 0x1a4 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x21052f4 size 0x2e8 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit SongProgressUIController() ;

/// @brief Method .ctor addr 0x21055dc size 0x10 virtual false final false
 void _ctor() ;
