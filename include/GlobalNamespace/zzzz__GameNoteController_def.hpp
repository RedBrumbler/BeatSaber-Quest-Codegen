...
/// @brief Method add_cubeNoteControllerDidInitEvent addr 0x22751e4 size 0xb0 virtual true final true
 void add_cubeNoteControllerDidInitEvent(System::Action_1<GlobalNamespace::GameNoteController> value) ;

/// @brief Method remove_cubeNoteControllerDidInitEvent addr 0x2275294 size 0xb0 virtual true final true
 void remove_cubeNoteControllerDidInitEvent(System::Action_1<GlobalNamespace::GameNoteController> value) ;

/// @brief Method get_noteMovement addr 0x2275344 size 0x8 virtual true final true
 GlobalNamespace::NoteMovement get_noteMovement() ;

/// @brief Method get_noteVisualModifierType addr 0x227534c size 0x8 virtual true final true
 GlobalNamespace::NoteVisualModifierType get_noteVisualModifierType() ;

/// @brief Method get_gameplayType addr 0x2275354 size 0x8 virtual true final true
 GlobalNamespace::GlobalNamespace__NoteData__GameplayType get_gameplayType() ;

/// @brief Method Init addr 0x227535c size 0x2b8 virtual false final false
...
/// @brief Method Awake addr 0x2275968 size 0x160 virtual true final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x2275c44 size 0x1cc virtual true final false
 void OnDestroy() ;

/// @brief Method NoteDidPassMissedMarker addr 0x2275fd8 size 0xbc virtual true final false
 void NoteDidPassMissedMarker() ;

/// @brief Method NoteDidStartDissolving addr 0x2276260 size 0xb8 virtual true final false
 void NoteDidStartDissolving() ;

/// @brief Method HandleBigWasCutBySaber addr 0x2276318 size 0x18 virtual false final false
...
/// @brief Method HandleSmallWasCutBySaber addr 0x22767e4 size 0x18 virtual false final false
...
/// @brief Method HandleCut addr 0x2276330 size 0x4b4 virtual false final false
...
/// @brief Method NoteDidStartJump addr 0x2276a28 size 0xb8 virtual true final false
 void NoteDidStartJump() ;

/// @brief Method HiddenStateDidChange addr 0x2276ae0 size 0x24 virtual true final false
 void HiddenStateDidChange(bool hide) ;

/// @brief Method Pause addr 0x2276b04 size 0x10 virtual true final false
 void Pause(bool pause) ;

// Ctor Parameters []
explicit GameNoteController() ;

/// @brief Method .ctor addr 0x2276b14 size 0x4 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11011)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 297 }), TypeDefinitionIndex(TypeDefinitionIndex(4863))}
...
/// @brief Method .ctor addr 0x2276d70 size 0x48 virtual false final false
 void _ctor() ;
