...
/// @brief Method add_didFinishEvent addr 0x22085cc size 0xb0 virtual false final false
 void add_didFinishEvent(System::Action_1<GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO> value) ;

/// @brief Method remove_didFinishEvent addr 0x220867c size 0xb0 virtual false final false
 void remove_didFinishEvent(System::Action_1<GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO> value) ;

/// @brief Method get_goStraightToEditor addr 0x220872c size 0x8 virtual false final false
 bool get_goStraightToEditor() ;

/// @brief Method set_goStraightToEditor addr 0x2208734 size 0xc virtual false final false
 void set_goStraightToEditor(bool value) ;

/// @brief Method Init addr 0x2208740 size 0x80 virtual false final false
 void Init(bool goStraightToEditor) ;

/// @brief Method Finish addr 0x22087c0 size 0x20 virtual false final false
 void Finish() ;

// Ctor Parameters []
explicit BeatmapEditorScenesTransitionSetupDataSO() ;

/// @brief Method .ctor addr 0x22087e0 size 0x8 virtual false final false
 void _ctor() ;
