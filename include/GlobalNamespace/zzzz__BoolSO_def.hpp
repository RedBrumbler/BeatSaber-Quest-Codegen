...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13923)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13923), inst: 99 })}
...
/// @brief Method .ctor addr 0x1fbf35c size 0x48 virtual false final false
 void _ctor() ;
