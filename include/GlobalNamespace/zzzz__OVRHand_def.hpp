...
/// @brief Method get_IsDataValid addr 0x2654398 size 0x8 virtual false final false
 bool get_IsDataValid() ;

/// @brief Method set_IsDataValid addr 0x26543a0 size 0xc virtual false final false
 void set_IsDataValid(bool value) ;

/// @brief Method get_IsDataHighConfidence addr 0x26543ac size 0x8 virtual false final false
 bool get_IsDataHighConfidence() ;

/// @brief Method set_IsDataHighConfidence addr 0x26543b4 size 0xc virtual false final false
 void set_IsDataHighConfidence(bool value) ;

/// @brief Method get_IsTracked addr 0x26543c0 size 0x8 virtual false final false
 bool get_IsTracked() ;

/// @brief Method set_IsTracked addr 0x26543c8 size 0xc virtual false final false
 void set_IsTracked(bool value) ;

/// @brief Method get_IsSystemGestureInProgress addr 0x26543d4 size 0x8 virtual false final false
 bool get_IsSystemGestureInProgress() ;

/// @brief Method set_IsSystemGestureInProgress addr 0x26543dc size 0xc virtual false final false
 void set_IsSystemGestureInProgress(bool value) ;

/// @brief Method get_IsPointerPoseValid addr 0x26543e8 size 0x8 virtual false final false
 bool get_IsPointerPoseValid() ;

/// @brief Method set_IsPointerPoseValid addr 0x26543f0 size 0xc virtual false final false
 void set_IsPointerPoseValid(bool value) ;

/// @brief Method get_PointerPose addr 0x26543fc size 0x8 virtual false final false
 UnityEngine::Transform get_PointerPose() ;

/// @brief Method set_PointerPose addr 0x2654404 size 0x8 virtual false final false
 void set_PointerPose(UnityEngine::Transform value) ;

/// @brief Method get_HandScale addr 0x265440c size 0x8 virtual false final false
 float_t get_HandScale() ;

/// @brief Method set_HandScale addr 0x2654414 size 0x8 virtual false final false
 void set_HandScale(float_t value) ;

/// @brief Method get_HandConfidence addr 0x265441c size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__OVRHand__TrackingConfidence get_HandConfidence() ;

/// @brief Method set_HandConfidence addr 0x2654424 size 0x8 virtual false final false
 void set_HandConfidence(GlobalNamespace::GlobalNamespace__OVRHand__TrackingConfidence value) ;

/// @brief Method get_IsDominantHand addr 0x265442c size 0x8 virtual false final false
 bool get_IsDominantHand() ;

/// @brief Method set_IsDominantHand addr 0x2654434 size 0xc virtual false final false
 void set_IsDominantHand(bool value) ;

/// @brief Method Awake addr 0x2654440 size 0xcc virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x26546dc size 0x8 virtual false final false
 void Update() ;

/// @brief Method FixedUpdate addr 0x26546e4 size 0x74 virtual false final false
 void FixedUpdate() ;

/// @brief Method GetHandState addr 0x265450c size 0x1d0 virtual false final false
 void GetHandState(GlobalNamespace::GlobalNamespace__OVRPlugin__Step step) ;

/// @brief Method GetFingerIsPinching addr 0x2654758 size 0x28 virtual false final false
 bool GetFingerIsPinching(GlobalNamespace::GlobalNamespace__OVRHand__HandFinger finger) ;

/// @brief Method GetFingerPinchStrength addr 0x2654780 size 0x40 virtual false final false
 float_t GetFingerPinchStrength(GlobalNamespace::GlobalNamespace__OVRHand__HandFinger finger) ;

/// @brief Method GetFingerConfidence addr 0x26547c0 size 0x44 virtual false final false
...
/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonType addr 0x2654804 size 0x18 virtual true final true
 GlobalNamespace::GlobalNamespace__OVRSkeleton__SkeletonType OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonType() ;

/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonPoseData addr 0x265481c size 0x6c virtual true final true
 GlobalNamespace::GlobalNamespace__OVRSkeleton__SkeletonPoseData OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonPoseData() ;

/// @brief Method OVRSkeletonRenderer.IOVRSkeletonRendererDataProvider.GetSkeletonRendererData addr 0x2654888 size 0x4c virtual true final true
...
/// @brief Method OVRMesh.IOVRMeshDataProvider.GetMeshType addr 0x26548d4 size 0x18 virtual true final true
 GlobalNamespace::GlobalNamespace__OVRMesh__MeshType OVRMesh_IOVRMeshDataProvider_GetMeshType() ;

/// @brief Method OVRMeshRenderer.IOVRMeshRendererDataProvider.GetMeshRendererData addr 0x26548ec size 0x50 virtual true final true
...
/// @brief Method .ctor addr 0x265493c size 0x10 virtual false final false
 void _ctor() ;

/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.get_enabled addr 0x265494c size 0x8 virtual true final true
