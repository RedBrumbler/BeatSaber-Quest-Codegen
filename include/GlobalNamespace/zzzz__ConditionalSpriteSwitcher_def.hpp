...
/// @brief Method get_falseSprite addr 0x214d14c size 0x8 virtual false final false
 UnityEngine::Sprite get_falseSprite() ;

/// @brief Method set_falseSprite addr 0x214d154 size 0x8 virtual false final false
 void set_falseSprite(UnityEngine::Sprite value) ;

/// @brief Method get_trueSprite addr 0x214d15c size 0x8 virtual false final false
 UnityEngine::Sprite get_trueSprite() ;

/// @brief Method set_trueSprite addr 0x214d164 size 0x8 virtual false final false
 void set_trueSprite(UnityEngine::Sprite value) ;

/// @brief Method Awake addr 0x214d16c size 0x4 virtual false final false
 void Awake() ;

/// @brief Method Apply addr 0x214d170 size 0xa4 virtual false final false
 void Apply() ;

// Ctor Parameters []
explicit ConditionalSpriteSwitcher() ;

/// @brief Method .ctor addr 0x214d214 size 0x8 virtual false final false
 void _ctor() ;
