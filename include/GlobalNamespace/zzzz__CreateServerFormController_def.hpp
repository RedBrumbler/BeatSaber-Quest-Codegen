...
/// @brief Method get_formData addr 0x2182ec4 size 0xb0 virtual false final false
 GlobalNamespace::CreateServerFormData get_formData() ;

/// @brief Method Setup addr 0x2182f74 size 0x60 virtual false final false
 void Setup(int32_t selectedNumberOfPlayers, bool netDiscoverable) ;

// Ctor Parameters []
explicit CreateServerFormController() ;

/// @brief Method .ctor addr 0x2182fe8 size 0x8 virtual false final false
 void _ctor() ;
