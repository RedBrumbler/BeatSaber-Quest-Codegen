...
/// @brief Method add_didFinishEvent addr 0x219141c size 0xb0 virtual false final false
 void add_didFinishEvent(System::Action_2<GlobalNamespace::EnterTextViewController,::StringW> value) ;

/// @brief Method remove_didFinishEvent addr 0x21914cc size 0xb0 virtual false final false
 void remove_didFinishEvent(System::Action_2<GlobalNamespace::EnterTextViewController,::StringW> value) ;

/// @brief Method Init addr 0x219157c size 0x24 virtual false final false
 void Init(::StringW titleText) ;

/// @brief Method DidActivate addr 0x21915a0 size 0xe4 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method OkButtonPressed addr 0x2191684 size 0x98 virtual false final false
 void OkButtonPressed() ;

// Ctor Parameters []
explicit EnterTextViewController() ;

/// @brief Method .ctor addr 0x219171c size 0x8 virtual false final false
 void _ctor() ;
