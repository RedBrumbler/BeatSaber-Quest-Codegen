...
/// @brief Method Awake addr 0x20e7ffc size 0x154 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x20e8150 size 0x1c8 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleEditAvatarFlowCoordinatorWasSetup addr 0x20e8318 size 0xd8 virtual false final false
...
/// @brief Method HandleEditAvatarViewControllerDidFinish addr 0x20e8668 size 0xf8 virtual false final false
...
/// @brief Method HandleEditAvatarViewControllerRandomizeAllButtonWasPressed addr 0x20e8760 size 0xd0 virtual false final false
 void HandleEditAvatarViewControllerRandomizeAllButtonWasPressed() ;

/// @brief Method CreateEditAvatarEventData addr 0x20e83f0 size 0x278 virtual false final false
 System::Collections::Generic::Dictionary_2<::StringW,::StringW> CreateEditAvatarEventData() ;

// Ctor Parameters []
explicit EditAvatarAnalytics() ;

/// @brief Method .ctor addr 0x20e8830 size 0x8 virtual false final false
 void _ctor() ;
