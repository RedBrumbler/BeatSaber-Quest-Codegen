...
/// @brief Method add_valueDidChangeEvent addr 0x2189498 size 0xb0 virtual false final false
 void add_valueDidChangeEvent(System::Action_2<GlobalNamespace::FormattedFloatListSettingsController,float_t> value) ;

/// @brief Method remove_valueDidChangeEvent addr 0x2189548 size 0xb0 virtual false final false
 void remove_valueDidChangeEvent(System::Action_2<GlobalNamespace::FormattedFloatListSettingsController,float_t> value) ;

/// @brief Method get_value addr 0x21895f8 size 0x8 virtual false final false
 float_t get_value() ;

/// @brief Method get_values addr 0x2189600 size 0x8 virtual false final false
 ::ArrayW<float_t> get_values() ;

/// @brief Method set_values addr 0x2189608 size 0x38 virtual false final false
 void set_values(::ArrayW<float_t> value) ;

/// @brief Method SetValue addr 0x2182fd4 size 0x14 virtual false final false
 void SetValue(float_t value, bool callCallback) ;

/// @brief Method GetInitValues addr 0x218969c size 0x150 virtual true final false
 bool GetInitValues(ByRef<int32_t> idx, ByRef<int32_t> numberOfElements) ;

/// @brief Method ApplyValue addr 0x21897ec size 0x58 virtual true final false
 void ApplyValue(int32_t idx) ;

/// @brief Method TextForValue addr 0x2189844 size 0xdc virtual true final false
 ::StringW TextForValue(int32_t idx) ;

// Ctor Parameters []
explicit FormattedFloatListSettingsController() ;

/// @brief Method .ctor addr 0x2189920 size 0x5c virtual false final false
 void _ctor() ;
