...
/// @brief Method Awake addr 0x22652b8 size 0x29c virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x2265554 size 0x264 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleLobbyGameStateModelDidChange addr 0x22657b8 size 0x1c virtual false final false
 void HandleLobbyGameStateModelDidChange(GlobalNamespace::MultiplayerGameState newGameState) ;

/// @brief Method SetMenuPresence addr 0x22657d4 size 0x22c virtual false final false
 void SetMenuPresence() ;

/// @brief Method HandleGameScenesManagerTransitionDidFinish addr 0x2265aac size 0x324 virtual false final false
...
/// @brief Method HandleMultiplayerPartySizeChanged addr 0x2265e78 size 0x1d0 virtual false final false
 void HandleMultiplayerPartySizeChanged(int32_t currentPartySize) ;

/// @brief Method HandleLobbyPlayerPermissionChanged addr 0x2266048 size 0x154 virtual false final false
 void HandleLobbyPlayerPermissionChanged() ;

/// @brief Method SetPresence addr 0x2265a00 size 0xac virtual false final false
 void SetPresence(GlobalNamespace::IRichPresenceData presenceData) ;

/// @brief Method Clear addr 0x2265dd0 size 0xa8 virtual false final false
 void Clear() ;

// Ctor Parameters []
explicit RichPresenceManager() ;

/// @brief Method .ctor addr 0x226619c size 0x8 virtual false final false
 void _ctor() ;
