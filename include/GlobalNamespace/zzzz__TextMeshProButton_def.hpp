...
/// @brief Method get_text addr 0x215f4a0 size 0x8 virtual false final false
 TMPro::TextMeshProUGUI get_text() ;

/// @brief Method get_button addr 0x215f4a8 size 0x8 virtual false final false
 UnityEngine::UI::Button get_button() ;

// Ctor Parameters []
explicit TextMeshProButton() ;

/// @brief Method .ctor addr 0x215f4b0 size 0x8 virtual false final false
 void _ctor() ;
