...
/// @brief Method get_hashedUserId addr 0x22b3560 size 0x8 virtual true final true
 ::StringW get_hashedUserId() ;

/// @brief Method get_userName addr 0x22b3568 size 0x8 virtual true final true
 ::StringW get_userName() ;

/// @brief Method get_platform addr 0x22b3570 size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0x22b3578 size 0x98 virtual false final false
 void _ctor(::StringW userId, ::StringW userName, ::StringW password) ;

/// @brief Method GetAuthenticationToken addr 0x22b3610 size 0xa0 virtual true final true
 System::Threading::Tasks::Task_1<GlobalNamespace::AuthenticationToken> GetAuthenticationToken() ;

/// @brief Method GetTokenPlatform addr 0x22b36b0 size 0x8 virtual true final true
...
/// @brief Method GetXPlatformAccessToken addr 0x22b36b8 size 0xb4 virtual true final true
