...
/// @brief Method get_fogParams addr 0x1fcb550 size 0x8 virtual false final false
 GlobalNamespace::BloomFogEnvironmentParams get_fogParams() ;

/// @brief Method OnEnable addr 0x1fcb558 size 0x40 virtual false final false
 void OnEnable() ;

/// @brief Method OnValidate addr 0x1fcb5b8 size 0x48 virtual false final false
 void OnValidate() ;

// Ctor Parameters []
explicit BloomFogEnvironment() ;

/// @brief Method .ctor addr 0x1fcb810 size 0x8 virtual false final false
 void _ctor() ;
