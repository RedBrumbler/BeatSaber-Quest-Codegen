...
/// @brief Method add_didFinishEvent addr 0x2208df8 size 0xb0 virtual false final false
...
/// @brief Method remove_didFinishEvent addr 0x22091ec size 0xb0 virtual false final false
...
/// @brief Method get_gameMode addr 0x220b628 size 0x8 virtual false final false
 ::StringW get_gameMode() ;

/// @brief Method set_gameMode addr 0x220b630 size 0x8 virtual false final false
 void set_gameMode(::StringW value) ;

/// @brief Method get_difficultyBeatmap addr 0x220b638 size 0x8 virtual false final false
 GlobalNamespace::IDifficultyBeatmap get_difficultyBeatmap() ;

/// @brief Method set_difficultyBeatmap addr 0x220b640 size 0x8 virtual false final false
 void set_difficultyBeatmap(GlobalNamespace::IDifficultyBeatmap value) ;

/// @brief Method get_practiceSettings addr 0x220b648 size 0x8 virtual false final false
 GlobalNamespace::PracticeSettings get_practiceSettings() ;

/// @brief Method set_practiceSettings addr 0x220b650 size 0x8 virtual false final false
 void set_practiceSettings(GlobalNamespace::PracticeSettings value) ;

/// @brief Method get_usingOverrideColorScheme addr 0x220b658 size 0x8 virtual false final false
 bool get_usingOverrideColorScheme() ;

/// @brief Method set_usingOverrideColorScheme addr 0x220b660 size 0xc virtual false final false
 void set_usingOverrideColorScheme(bool value) ;

/// @brief Method get_colorScheme addr 0x220b66c size 0x8 virtual false final false
 GlobalNamespace::ColorScheme get_colorScheme() ;

/// @brief Method set_colorScheme addr 0x220b674 size 0x8 virtual false final false
 void set_colorScheme(GlobalNamespace::ColorScheme value) ;

/// @brief Method get_usingOverrideEnvironment addr 0x220b67c size 0x8 virtual false final false
 bool get_usingOverrideEnvironment() ;

/// @brief Method set_usingOverrideEnvironment addr 0x220b684 size 0xc virtual false final false
 void set_usingOverrideEnvironment(bool value) ;

/// @brief Method get_environmentInfo addr 0x220b690 size 0x8 virtual false final false
 GlobalNamespace::EnvironmentInfoSO get_environmentInfo() ;

/// @brief Method set_environmentInfo addr 0x220b698 size 0x8 virtual false final false
 void set_environmentInfo(GlobalNamespace::EnvironmentInfoSO value) ;

/// @brief Method get_gameplayModifiers addr 0x220b6a0 size 0x8 virtual false final false
 GlobalNamespace::GameplayModifiers get_gameplayModifiers() ;

/// @brief Method set_gameplayModifiers addr 0x220b6a8 size 0x8 virtual false final false
 void set_gameplayModifiers(GlobalNamespace::GameplayModifiers value) ;

/// @brief Method Init addr 0x2206e90 size 0x608 virtual false final false
...
/// @brief Method Finish addr 0x220b6b0 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x220b6d8 size 0x8 virtual false final false
 void _ctor() ;
