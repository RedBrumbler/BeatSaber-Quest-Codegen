...
/// @brief Method get_isPaused addr 0x21055ec size 0x8 virtual true final true
 bool get_isPaused() ;

/// @brief Method add_didPauseEvent addr 0x21055f4 size 0x9c virtual true final true
 void add_didPauseEvent(System::Action value) ;

/// @brief Method remove_didPauseEvent addr 0x2105690 size 0x9c virtual true final true
 void remove_didPauseEvent(System::Action value) ;

/// @brief Method add_willResumeEvent addr 0x210572c size 0x9c virtual true final true
 void add_willResumeEvent(System::Action value) ;

/// @brief Method remove_willResumeEvent addr 0x21057c8 size 0x9c virtual true final true
 void remove_willResumeEvent(System::Action value) ;

/// @brief Method add_didResumeEvent addr 0x2105864 size 0x9c virtual true final true
 void add_didResumeEvent(System::Action value) ;

/// @brief Method remove_didResumeEvent addr 0x2105900 size 0x9c virtual true final true
 void remove_didResumeEvent(System::Action value) ;

/// @brief Method Pause addr 0x210599c size 0x150 virtual true final true
 void Pause() ;

/// @brief Method WillResume addr 0x2105aec size 0x24 virtual true final true
 void WillResume() ;

/// @brief Method Resume addr 0x2105b10 size 0x14c virtual true final true
 void Resume() ;

// Ctor Parameters []
explicit GamePause() ;

/// @brief Method .ctor addr 0x2105c5c size 0x8 virtual false final false
 void _ctor() ;
