...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13757), inst: 394 }), TypeDefinitionIndex(TypeDefinitionIndex(13757)), TypeDefinitionIndex(TypeDefinitionIndex(10209))}
...
/// @brief Method .ctor addr 0x1fad638 size 0x58 virtual false final false
 void _ctor(float_t smooth) ;

/// @brief Method Interpolate addr 0x1fad690 size 0x28 virtual true final false
