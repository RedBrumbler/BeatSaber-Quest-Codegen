...
/// @brief Method set_enableDec addr 0x215c920 size 0x28 virtual false final false
 void set_enableDec(bool value) ;

/// @brief Method set_enableInc addr 0x215c948 size 0x28 virtual false final false
 void set_enableInc(bool value) ;

/// @brief Method set_color addr 0x215c970 size 0x2c virtual false final false
 void set_color(UnityEngine::Color value) ;

/// @brief Method Awake addr 0x215c99c size 0xb8 virtual true final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x215ca54 size 0x104 virtual false final false
 void OnDestroy() ;
...
/// @brief Method .ctor addr 0x215cb58 size 0x8 virtual false final false
 void _ctor() ;
