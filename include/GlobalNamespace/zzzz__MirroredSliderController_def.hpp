...
/// @brief Method set_hide addr 0x22773b4 size 0x2c virtual false final false
 void set_hide(bool value) ;

/// @brief Method Awake addr 0x22773e0 size 0x1c virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x22773fc size 0xb0 virtual false final false
 void Update() ;

/// @brief Method OnDestroy addr 0x22775c8 size 0x4 virtual false final false
 void OnDestroy() ;

/// @brief Method Mirror addr 0x22776c0 size 0x214 virtual false final false
 void Mirror(GlobalNamespace::SliderController sliderController) ;

/// @brief Method UpdateMaterialPropertyBlock addr 0x22774ac size 0x11c virtual false final false
 void UpdateMaterialPropertyBlock(float_t timeSinceHeadNoteJump) ;

/// @brief Method RemoveListeners addr 0x22775cc size 0xf4 virtual false final false
 void RemoveListeners() ;

/// @brief Method HandleSliderDidStartDissolving addr 0x2277c54 size 0x24 virtual true final true
 void HandleSliderDidStartDissolving(GlobalNamespace::SliderController sliderController, float_t duration) ;

/// @brief Method Dissolve addr 0x2277c78 size 0x24 virtual false final false
 void Dissolve(float_t duration) ;

// Ctor Parameters []
explicit MirroredSliderController() ;

/// @brief Method .ctor addr 0x2277cc4 size 0x8 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11011)), TypeDefinitionIndex(TypeDefinitionIndex(4877)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 2717 })}
...
/// @brief Method .ctor addr 0x2277cd4 size 0x48 virtual false final false
 void _ctor() ;
