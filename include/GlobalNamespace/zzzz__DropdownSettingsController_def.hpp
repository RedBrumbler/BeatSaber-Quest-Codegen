...
/// @brief Method add_dropDownValueDidChangeEvent addr 0x2188ff0 size 0x9c virtual false final false
 void add_dropDownValueDidChangeEvent(System::Action value) ;

/// @brief Method remove_dropDownValueDidChangeEvent addr 0x218908c size 0x9c virtual false final false
...
/// @brief Method OnEnable addr 0x2189128 size 0xbc virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2189324 size 0xd0 virtual false final false
 void OnDisable() ;

/// @brief Method HandleDropdownValueDidChange addr 0x21893f4 size 0x40 virtual false final false
 void HandleDropdownValueDidChange(HMUI::DropdownWithTableView dropdownWithTableView, int32_t idx) ;

/// @brief Method RefreshUI addr 0x21891e4 size 0x140 virtual false final false
 void RefreshUI() ;

/// @brief Method Refresh addr 0x2189434 size 0x5c virtual false final false
 void Refresh(bool applyValue) ;

// Ctor Parameters []
explicit DropdownSettingsController() ;

/// @brief Method .ctor addr 0x2189490 size 0x8 virtual false final false
 void _ctor() ;
