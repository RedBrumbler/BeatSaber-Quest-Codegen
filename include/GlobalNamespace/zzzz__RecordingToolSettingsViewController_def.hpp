...
/// @brief Method add_didFinishEvent addr 0x21b5f50 size 0x9c virtual false final false
 void add_didFinishEvent(System::Action value) ;

/// @brief Method remove_didFinishEvent addr 0x21b5fec size 0x9c virtual false final false
 void remove_didFinishEvent(System::Action value) ;

/// @brief Method DidActivate addr 0x21b6088 size 0x120 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

// Ctor Parameters []
explicit RecordingToolSettingsViewController() ;

/// @brief Method .ctor addr 0x21b61a8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__6_0 addr 0x21b61b0 size 0x1c virtual false final false
