...
/// @brief Method get_colorScheme addr 0x11b00c8 size 0x8 virtual false final false
 GlobalNamespace::ColorScheme get_colorScheme() ;

/// @brief Method LogColorScheme addr 0x11b00d0 size 0x2a4 virtual false final false
 void LogColorScheme() ;

// Ctor Parameters []
explicit ColorSchemeSO() ;

/// @brief Method .ctor addr 0x11b0374 size 0x8 virtual false final false
 void _ctor() ;
