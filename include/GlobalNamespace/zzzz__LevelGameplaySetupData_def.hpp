...
/// @brief Method get_beatmapLevel addr 0x222c8cc size 0x8 virtual true final true
 GlobalNamespace::PreviewDifficultyBeatmap get_beatmapLevel() ;

/// @brief Method get_gameplayModifiers addr 0x222c8d4 size 0x8 virtual true final true
 GlobalNamespace::GameplayModifiers get_gameplayModifiers() ;

// Ctor Parameters []
explicit LevelGameplaySetupData() ;

/// @brief Method .ctor addr 0x222c8dc size 0x68 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x222c944 size 0xa4 virtual false final false
 void _ctor(GlobalNamespace::PreviewDifficultyBeatmap beatmapLevel, GlobalNamespace::GameplayModifiers gameplayModifiers) ;

/// @brief Method ClearGameplaySetupData addr 0x222c9e8 size 0x64 virtual false final false
 void ClearGameplaySetupData() ;

/// @brief Method SetBeatmapLevel addr 0x222ca4c size 0x8 virtual false final false
 void SetBeatmapLevel(GlobalNamespace::PreviewDifficultyBeatmap beatmapLevel) ;

/// @brief Method SetGameplayModifiers addr 0x222ca54 size 0x78 virtual false final false
