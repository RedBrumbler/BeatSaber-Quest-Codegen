...
/// @brief Method PlayHapticFeedback addr 0x1fc2874 size 0x4 virtual true final true
 void PlayHapticFeedback(UnityEngine::XR::XRNode node, Libraries::HM::HMLib::VR::HapticPresetSO hapticPreset) ;

/// @brief Method CanPlayHapticPreset addr 0x1fc2878 size 0x8 virtual true final true
 bool CanPlayHapticPreset(Libraries::HM::HMLib::VR::HapticPresetSO hapticPreset) ;

// Ctor Parameters []
explicit EmptyAdvancedHapticsPlayer() ;

/// @brief Method .ctor addr 0x1fc2880 size 0x8 virtual false final false
 void _ctor() ;
