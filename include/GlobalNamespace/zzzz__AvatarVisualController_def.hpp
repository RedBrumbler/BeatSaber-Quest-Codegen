...
/// @brief Method .ctor addr 0x20f9c14 size 0xc4 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x20fa5d8 size 0x18 virtual true final false
 void Invoke(bool highlighted, int32_t uvSegmentNumber) ;

/// @brief Method BeginInvoke addr 0x20fa5f0 size 0xbc virtual true final false
...
/// @brief Method EndInvoke addr 0x20fa6ac size 0xc virtual true final false
...
/// @brief Method get_lightColor addr 0x20f997c size 0xc virtual false final false
 UnityEngine::Color get_lightColor() ;

/// @brief Method Awake addr 0x20f9988 size 0x28c virtual false final false
 void Awake() ;

/// @brief Method UpdateAvatarVisual addr 0x20f9cd8 size 0x354 virtual false final false
 void UpdateAvatarVisual(GlobalNamespace::AvatarData avatarData) ;

/// @brief Method SetLightColor addr 0x20fa2c4 size 0xc virtual false final false
 void SetLightColor(UnityEngine::Color color) ;

/// @brief Method UpdateAvatarColors addr 0x20fa02c size 0x298 virtual false final false
 void UpdateAvatarColors() ;

/// @brief Method HighlightEditedPart addr 0x20fa4a0 size 0x9c virtual false final false
...
/// @brief Method DisableEditedPartHighlight addr 0x20fa53c size 0x34 virtual false final false
 void DisableEditedPartHighlight() ;

/// @brief Method SetHandsHighlight addr 0x20fa570 size 0x48 virtual false final false
 void SetHandsHighlight(bool highlighted, int32_t uvSegment) ;

// Ctor Parameters []
explicit AvatarVisualController() ;

/// @brief Method .ctor addr 0x20fa5c8 size 0x10 virtual false final false
 void _ctor() ;
