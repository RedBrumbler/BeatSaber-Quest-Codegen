...
/// @brief Method get_normalState addr 0x2163d2c size 0xc virtual false final false
 UnityEngine::Vector3 get_normalState() ;

/// @brief Method get_highlightedState addr 0x2163d38 size 0xc virtual false final false
 UnityEngine::Vector3 get_highlightedState() ;

/// @brief Method get_pressedState addr 0x2163d44 size 0xc virtual false final false
 UnityEngine::Vector3 get_pressedState() ;

/// @brief Method get_disabledState addr 0x2163d50 size 0xc virtual false final false
 UnityEngine::Vector3 get_disabledState() ;

/// @brief Method get_selectedState addr 0x2163d5c size 0xc virtual false final false
 UnityEngine::Vector3 get_selectedState() ;

/// @brief Method get_selectedAndHighlightedState addr 0x2163d68 size 0xc virtual false final false
 UnityEngine::Vector3 get_selectedAndHighlightedState() ;

// Ctor Parameters []
explicit Vector3TransitionSO() ;

/// @brief Method .ctor addr 0x2163d74 size 0x8 virtual false final false
 void _ctor() ;
