...
/// @brief Method Awake addr 0x1fd1874 size 0x164 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x1fd1d44 size 0x70 virtual false final false
 void Start() ;

/// @brief Method OnEnable addr 0x1fd1db4 size 0x2c virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fd2004 size 0x20 virtual false final false
 void OnDisable() ;

/// @brief Method OnDestroy addr 0x1fd2024 size 0xc4 virtual false final false
 void OnDestroy() ;

/// @brief Method Init addr 0x1fd19d8 size 0x84 virtual false final false
 void Init() ;

/// @brief Method CreateMesh addr 0x1fd1a5c size 0x2e8 virtual false final false
 UnityEngine::Mesh CreateMesh() ;

/// @brief Method Refresh addr 0x1fd1de0 size 0x224 virtual false final false
 void Refresh() ;

// Ctor Parameters []
explicit Parametric3SliceSpriteController() ;

/// @brief Method .ctor addr 0x1fd20e8 size 0x24 virtual false final false
 void _ctor() ;
