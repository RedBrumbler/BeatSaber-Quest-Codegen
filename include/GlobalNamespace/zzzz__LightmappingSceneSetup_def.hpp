...
struct CORDL_TYPE GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0____InstallBindings_b__0_d : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "GlobalNamespace::GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::IReadonlyBeatmapData>", modifiers: "", def_value: None }]
constexpr GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0____InstallBindings_b__0_d(int32_t __1__state, System::Runtime::CompilerServices::AsyncTaskMethodBuilder __t__builder, GlobalNamespace::GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0 __4__this, System::Runtime::CompilerServices::TaskAwaiter_1<GlobalNamespace::IReadonlyBeatmapData> __u__1) noexcept;


                    constexpr GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0____InstallBindings_b__0_d(GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0____InstallBindings_b__0_d const&) = default;
                    constexpr GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0____InstallBindings_b__0_d(GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0____InstallBindings_b__0_d&&) = default;
                    constexpr GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0____InstallBindings_b__0_d& operator=(GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0____InstallBindings_b__0_d const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0____InstallBindings_b__0_d& operator=(GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0____InstallBindings_b__0_d&& o) noexcept {
...
constexpr explicit GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0____InstallBindings_b__0_d(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr System::Runtime::CompilerServices::AsyncTaskMethodBuilder __get___t__builder() const;
 ...
 GlobalNamespace::GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0 __declspec(property(get=__get___4__this, put=__set___4__this))  __4__this;

constexpr void __set___4__this(GlobalNamespace::GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0 value) ;

constexpr GlobalNamespace::GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0 __get___4__this() const;
...
/// @brief Method MoveNext addr 0x2206274 size 0x2ac virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2206520 size 0xc virtual true final true
...
class CORDL_TYPE GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
using __InstallBindings_b__0_d = GlobalNamespace::GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0____InstallBindings_b__0_d;

/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0(GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0(GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0& operator=(GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0&& o) noexcept = default;
  constexpr GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0& operator=(GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0 const& o) noexcept = default;
...
/// @brief Method .ctor addr 0x22061a4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <InstallBindings>b__0 addr 0x22061ac size 0xc8 virtual false final false
...
public:
// Declarations
using __c__DisplayClass8_0 = GlobalNamespace::GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0;
...
/// @brief Method get_colorScheme addr 0x21edee4 size 0x8 virtual false final false
 GlobalNamespace::ColorSchemeSO get_colorScheme() ;

/// @brief Method set_colorScheme addr 0x21edeec size 0x8 virtual false final false
 void set_colorScheme(GlobalNamespace::ColorSchemeSO value) ;

/// @brief Method InstallBindings addr 0x21edef4 size 0xd10 virtual true final false
 void InstallBindings() ;

// Ctor Parameters []
explicit LightmappingSceneSetup() ;

/// @brief Method .ctor addr 0x21eec04 size 0x8 virtual false final false
 void _ctor() ;
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0, "", "LightmappingSceneSetup/<>c__DisplayClass8_0");
...
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__LightmappingSceneSetup____c__DisplayClass8_0____InstallBindings_b__0_d, "", "LightmappingSceneSetup/<>c__DisplayClass8_0/<<InstallBindings>b__0>d");
