...
/// @brief Method .ctor addr 0xdd3f40 size 0xc4 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0xdd4004 size 0x50 virtual true final false
...
/// @brief Method BeginInvoke addr 0xdd4054 size 0xc0 virtual true final false
...
/// @brief Method EndInvoke addr 0xdd4114 size 0xc virtual true final false
...
/// @brief Method .ctor addr 0xdd4120 size 0xd4 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0xdd41f4 size 0x14 virtual true final false
 void Invoke(::StringW secret) ;

/// @brief Method BeginInvoke addr 0xdd4208 size 0x20 virtual true final false
 System::IAsyncResult BeginInvoke(::StringW secret, System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType object) ;

/// @brief Method EndInvoke addr 0xdd4228 size 0xc virtual true final false
 void EndInvoke(System::IAsyncResult result) ;
...
/// @brief Method get_pool addr 0xdd3c7c size 0x40 virtual false final false
...
/// @brief Method Init addr 0xdd3ea4 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__PartyMessageHandler__ConnectToMasterServerMessage Init(::StringW secret) ;

/// @brief Method Serialize addr 0xdd4234 size 0x24 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0xdd4258 size 0x28 virtual true final true
 void Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method Release addr 0xdd3eec size 0x54 virtual true final true
 void Release() ;

// Ctor Parameters []
explicit GlobalNamespace__PartyMessageHandler__ConnectToMasterServerMessage() ;

/// @brief Method .ctor addr 0xdd4280 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0xdd3b14 size 0x168 virtual false final false
 void _ctor(GlobalNamespace::ConnectedPlayerManager connectedPlayerManager) ;

/// @brief Method Dispose addr 0xdd3cbc size 0x28 virtual true final true
 void Dispose() ;

/// @brief Method add_connectToMasterServerEvent addr 0xdd3ce4 size 0x9c virtual false final false
...
/// @brief Method remove_connectToMasterServerEvent addr 0xdd3d80 size 0x9c virtual false final false
...
/// @brief Method ConnectToMasterServer addr 0xdd3e1c size 0x88 virtual false final false
 void ConnectToMasterServer(::StringW secret) ;

/// @brief Method HandleConnectToMasterServer addr 0xdd3eac size 0x40 virtual false final false
