...
/// @brief Method get_loggerPrefix addr 0x1fabe50 size 0x40 virtual true final true
 ::StringW get_loggerPrefix() ;

/// @brief Method Init addr 0x1fabe90 size 0x8 virtual false final false
 void Init(GlobalNamespace::IVRPlatformHelper vrPlatformHelper) ;

/// @brief Method OnEnable addr 0x1fac0b0 size 0x4 virtual false final false
 void OnEnable() ;

/// @brief Method Setup addr 0x1fabe98 size 0x218 virtual false final false
 void Setup() ;

/// @brief Method OnDestroy addr 0x1fac258 size 0x1a4 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleInputFocusCaptured addr 0x1fac3fc size 0x15c virtual false final false
 void HandleInputFocusCaptured() ;

/// @brief Method HandleInputFocusReleased addr 0x1fac558 size 0x15c virtual false final false
 void HandleInputFocusReleased() ;

/// @brief Method ActivateGameObject addr 0x1fac6b4 size 0x1a0 virtual false final false
 void ActivateGameObject() ;

/// @brief Method DeactivateGameObject addr 0x1fac0b4 size 0x1a4 virtual false final false
 void DeactivateGameObject() ;

// Ctor Parameters []
explicit DeactivateOnInputFocusCapture() ;

/// @brief Method .ctor addr 0x1fac854 size 0x8 virtual false final false
 void _ctor() ;
