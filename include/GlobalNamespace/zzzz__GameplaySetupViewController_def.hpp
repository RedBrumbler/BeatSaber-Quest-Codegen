...
/// @brief Method .ctor addr 0x2194410 size 0x3c virtual false final false
...
/// @brief Method add_didChangeGameplayModifiersEvent addr 0x219311c size 0x9c virtual false final false
 void add_didChangeGameplayModifiersEvent(System::Action value) ;

/// @brief Method remove_didChangeGameplayModifiersEvent addr 0x21931b8 size 0x9c virtual false final false
 void remove_didChangeGameplayModifiersEvent(System::Action value) ;

/// @brief Method get_playerSettings addr 0x2193254 size 0x18 virtual false final false
 GlobalNamespace::PlayerSpecificSettings get_playerSettings() ;

/// @brief Method get_gameplayModifiers addr 0x2193624 size 0x1c virtual false final false
 GlobalNamespace::GameplayModifiers get_gameplayModifiers() ;

/// @brief Method get_environmentOverrideSettings addr 0x2193640 size 0x24 virtual false final false
 GlobalNamespace::OverrideEnvironmentSettings get_environmentOverrideSettings() ;

/// @brief Method get_colorSchemesSettings addr 0x2193664 size 0x24 virtual false final false
 GlobalNamespace::ColorSchemesSettings get_colorSchemesSettings() ;

/// @brief Method Setup addr 0x2193688 size 0x8c virtual false final false
...
/// @brief Method Init addr 0x2193714 size 0xa0 virtual false final false
 void Init() ;

/// @brief Method DidActivate addr 0x2193f10 size 0x174 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method OnDisable addr 0x2194120 size 0xd4 virtual false final false
 void OnDisable() ;

/// @brief Method HandleSelectionSegmentedControlDidSelectCell addr 0x21941f4 size 0x8 virtual false final false
 void HandleSelectionSegmentedControlDidSelectCell(HMUI::SegmentedControl segmentedControl, int32_t cellIdx) ;

/// @brief Method HandlePlayerSettingsPanelControllerDidChangePlayerSettings addr 0x21942ac size 0x38 virtual false final false
 void HandlePlayerSettingsPanelControllerDidChangePlayerSettings() ;

/// @brief Method HandleGameplayModifiersPanelControllerDidChangeGameplayModifiers addr 0x21942e4 size 0x54 virtual false final false
 void HandleGameplayModifiersPanelControllerDidChangeGameplayModifiers() ;

/// @brief Method SetActivePanel addr 0x21941fc size 0xb0 virtual false final false
 void SetActivePanel(int32_t panelIdx) ;

/// @brief Method RefreshContent addr 0x21937d8 size 0x72c virtual false final false
 void RefreshContent() ;

/// @brief Method RefreshActivePanel addr 0x2194338 size 0xd8 virtual false final false
 void RefreshActivePanel() ;

// Ctor Parameters []
explicit GameplaySetupViewController() ;

/// @brief Method .ctor addr 0x219444c size 0x8 virtual false final false
 void _ctor() ;
