...
/// @brief Method OnEnable addr 0x26ac1c0 size 0xf0 virtual false final false
 void OnEnable() ;

/// @brief Method Start addr 0x26ac538 size 0x4 virtual false final false
 void Start() ;

/// @brief Method SetupOculus addr 0x26ac2b0 size 0x288 virtual false final false
 void SetupOculus() ;

// Ctor Parameters []
explicit VRRenderingParamsSetup() ;

/// @brief Method .ctor addr 0x26ac53c size 0x8 virtual false final false
 void _ctor() ;
