...
/// @brief Method get_localPositionOffset addr 0x22a3c34 size 0xc virtual false final false
 UnityEngine::Vector3 get_localPositionOffset() ;

// Ctor Parameters []
explicit GlobalNamespace__MovementBeatmapEventEffect__MovementData() ;

/// @brief Method .ctor addr 0x22a3c40 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Start addr 0x22a3788 size 0x1f8 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x22a3a3c size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method FixedUpdate addr 0x22a3a58 size 0x110 virtual false final false
 void FixedUpdate() ;

/// @brief Method LateUpdate addr 0x22a3b68 size 0x8c virtual false final false
 void LateUpdate() ;

/// @brief Method HandleBeatmapEvent addr 0x22a3bf4 size 0x38 virtual false final false
 void HandleBeatmapEvent(GlobalNamespace::BasicBeatmapEventData basicBeatmapEventData) ;

/// @brief Method SetLocalPositionOffsetsForAllObjects addr 0x22a3980 size 0xbc virtual false final false
 void SetLocalPositionOffsetsForAllObjects(UnityEngine::Vector3 localPositionOffset) ;

// Ctor Parameters []
explicit MovementBeatmapEventEffect() ;

/// @brief Method .ctor addr 0x22a3c2c size 0x8 virtual false final false
 void _ctor() ;
