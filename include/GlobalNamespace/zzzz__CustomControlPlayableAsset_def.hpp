...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14105))}
...
/// @brief Method get_clipCaps addr 0x21ea8d0 size 0x8 virtual true final true
 UnityEngine::Timeline::ClipCaps get_clipCaps() ;

// Ctor Parameters []
explicit CustomControlPlayableAsset() ;

/// @brief Method .ctor addr 0x21ea8d8 size 0x58 virtual false final false
 void _ctor() ;
