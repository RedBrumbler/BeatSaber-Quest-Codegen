...
/// @brief Method Serialize addr 0xddc3c4 size 0x40 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0xddc404 size 0x40 virtual true final true
 void Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method SetState addr 0xddc444 size 0x50 virtual true final true
...
/// @brief Method GetState addr 0xddc494 size 0x4c virtual true final true
 GlobalNamespace::PoseSerializable GetState(GlobalNamespace::GlobalNamespace__NodePoseSyncState__NodePose nodePose) ;

/// @brief Method Equals addr 0xddc4e0 size 0x94 virtual false final false
 bool Equals(ByRef<GlobalNamespace::NodePoseSyncState> other) ;

/// @brief Method GetDelta addr 0xddc574 size 0x128 virtual false final false
 GlobalNamespace::NodePoseSyncState GetDelta(ByRef<GlobalNamespace::NodePoseSyncState> latest) ;

/// @brief Method ApplyDelta addr 0xddc69c size 0x128 virtual false final false
 GlobalNamespace::NodePoseSyncState ApplyDelta(ByRef<GlobalNamespace::NodePoseSyncState> delta) ;

/// @brief Method GetSize addr 0xddc7c4 size 0x48 virtual true final true
 int32_t GetSize() ;

/// @brief Method IStateTable<NodePoseSyncState,NodePoseSyncState.NodePose,PoseSerializable>.GetDelta addr 0xddc80c size 0x30 virtual true final true
...
/// @brief Method IStateTable<NodePoseSyncState,NodePoseSyncState.NodePose,PoseSerializable>.ApplyDelta addr 0xddc83c size 0x30 virtual true final true
...
/// @brief Method IEquatableByReference<NodePoseSyncState>.Equals addr 0xddc86c size 0x4 virtual true final true
