...
/// @brief Method Awake addr 0x227fbd4 size 0x70 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x227fd88 size 0xc virtual false final false
 void OnDestroy() ;

/// @brief Method CreateBox addr 0x227fc44 size 0x144 virtual false final false
 UnityEngine::Mesh CreateBox() ;

/// @brief Method RecalculateUVs addr 0x227fd94 size 0x1e4 virtual false final false
 void RecalculateUVs(::ArrayW<UnityEngine::Vector2> uvs) ;

/// @brief Method RefreshUVs addr 0x227ff78 size 0x94 virtual false final false
 void RefreshUVs() ;

// Ctor Parameters []
explicit StretchableCube() ;

/// @brief Method .ctor addr 0x228000c size 0x8 virtual false final false
 void _ctor() ;
