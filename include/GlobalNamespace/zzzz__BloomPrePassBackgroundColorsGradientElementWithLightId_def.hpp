...
/// @brief Method .ctor addr 0x1fd7ad8 size 0x10 virtual false final false
 void _ctor() ;
...
/// @brief Method ColorWasSet addr 0x1fd7a0c size 0xac virtual true final false
 void ColorWasSet(UnityEngine::Color color) ;

// Ctor Parameters []
explicit BloomPrePassBackgroundColorsGradientElementWithLightId() ;

/// @brief Method .ctor addr 0x1fd7ab8 size 0x10 virtual false final false
 void _ctor() ;
