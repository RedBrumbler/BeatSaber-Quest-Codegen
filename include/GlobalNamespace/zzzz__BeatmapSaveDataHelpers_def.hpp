...
/// @brief Method get_v addr 0xda73d0 size 0x30 virtual false final false
 ::StringW get_v() ;

// Ctor Parameters []
explicit GlobalNamespace__BeatmapSaveDataHelpers__VersionSerializedData() ;

/// @brief Method .ctor addr 0xda7400 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method GetVersion addr 0xda7324 size 0xac virtual false final false
