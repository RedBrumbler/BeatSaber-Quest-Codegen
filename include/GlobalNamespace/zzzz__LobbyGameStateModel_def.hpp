...
/// @brief Method get_gameState addr 0x2232090 size 0x8 virtual false final false
 GlobalNamespace::MultiplayerGameState get_gameState() ;

/// @brief Method add_gameStateDidChangeEvent addr 0x2232098 size 0xb0 virtual false final false
 void add_gameStateDidChangeEvent(System::Action_1<GlobalNamespace::MultiplayerGameState> value) ;

/// @brief Method remove_gameStateDidChangeEvent addr 0x2232148 size 0xb0 virtual false final false
 void remove_gameStateDidChangeEvent(System::Action_1<GlobalNamespace::MultiplayerGameState> value) ;

/// @brief Method add_gameStateDidChangeAlwaysSentEvent addr 0x22321f8 size 0xb0 virtual false final false
 void add_gameStateDidChangeAlwaysSentEvent(System::Action_1<GlobalNamespace::MultiplayerGameState> value) ;

/// @brief Method remove_gameStateDidChangeAlwaysSentEvent addr 0x22322a8 size 0xb0 virtual false final false
 void remove_gameStateDidChangeAlwaysSentEvent(System::Action_1<GlobalNamespace::MultiplayerGameState> value) ;

/// @brief Method SetGameState addr 0x22314bc size 0x8 virtual false final false
 void SetGameState(GlobalNamespace::MultiplayerGameState newGameState) ;

/// @brief Method SetGameStateWithoutNotification addr 0x222f548 size 0x2c virtual false final false
 void SetGameStateWithoutNotification(GlobalNamespace::MultiplayerGameState newGameState) ;

/// @brief Method SetGameState addr 0x2232358 size 0x70 virtual false final false
 void SetGameState(GlobalNamespace::MultiplayerGameState newGameState, bool sendNotification) ;

// Ctor Parameters []
explicit LobbyGameStateModel() ;

/// @brief Method .ctor addr 0x22323c8 size 0x8 virtual false final false
 void _ctor() ;
