...
/// @brief Method PreRender addr 0x26a82ac size 0x4 virtual true final false
 void PreRender() ;

/// @brief Method Render addr 0x26a82b0 size 0x4 virtual true final false
 void Render(UnityEngine::RenderTexture src, UnityEngine::RenderTexture dest, float_t fade) ;

/// @brief Method PostRender addr 0x26a82b4 size 0x4 virtual true final false
 void PostRender(float_t fade) ;

/// @brief Method get_hasPostProcessEffect addr 0x26a82b8 size 0x8 virtual true final false
 bool get_hasPostProcessEffect() ;

// Ctor Parameters []
explicit MainEffectSO() ;

/// @brief Method .ctor addr 0x26a7ab4 size 0x8 virtual false final false
 void _ctor() ;
