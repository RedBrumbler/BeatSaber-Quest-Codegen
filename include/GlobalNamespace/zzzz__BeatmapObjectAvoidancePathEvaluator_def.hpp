...
/// @brief Method .ctor addr 0x20dbef0 size 0x78 virtual false final false
...
/// @brief Method GetCurrentPathPosition addr 0x20dbf68 size 0x104 virtual false final false
