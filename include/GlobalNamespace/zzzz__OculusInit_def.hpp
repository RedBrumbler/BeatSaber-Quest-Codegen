...
/// @brief Method .ctor addr 0x20eec00 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <InitCallback>b__6_0 addr 0x20eec08 size 0xe4 virtual false final false
...
/// @brief Method NoDomainReloadInit addr 0x20ee6dc size 0x5c virtual false final false
static void NoDomainReloadInit() ;

/// @brief Method Init addr 0x20ee738 size 0xb4 virtual false final false
 void Init() ;

/// @brief Method TryToInitialize addr 0x20ee7ec size 0x1a0 virtual false final false
 void TryToInitialize() ;

/// @brief Method InitCallback addr 0x20ee98c size 0x1bc virtual false final false
 void InitCallback(Oculus::Platform::Message_1<Oculus::Platform::Models::PlatformInitialize> msg) ;

// Ctor Parameters []
explicit OculusInit() ;

/// @brief Method .ctor addr 0x20eeb48 size 0x8 virtual false final false
 void _ctor() ;
