...
/// @brief Method get_beatmapLevel addr 0x2225110 size 0x8 virtual false final false
 GlobalNamespace::IPreviewBeatmapLevel get_beatmapLevel() ;

/// @brief Method set_beatmapLevel addr 0x2225118 size 0x8 virtual false final false
 void set_beatmapLevel(GlobalNamespace::IPreviewBeatmapLevel value) ;

/// @brief Method get_beatmapCharacteristic addr 0x2225120 size 0x8 virtual false final false
 GlobalNamespace::BeatmapCharacteristicSO get_beatmapCharacteristic() ;

/// @brief Method set_beatmapCharacteristic addr 0x2225128 size 0x8 virtual false final false
 void set_beatmapCharacteristic(GlobalNamespace::BeatmapCharacteristicSO value) ;

/// @brief Method get_beatmapDifficulty addr 0x2225130 size 0x8 virtual false final false
 GlobalNamespace::BeatmapDifficulty get_beatmapDifficulty() ;

/// @brief Method set_beatmapDifficulty addr 0x2225138 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x221a4cc size 0x3c virtual false final false
...
/// @brief Method Equals addr 0x2225140 size 0xb4 virtual true final true
 bool Equals(GlobalNamespace::PreviewDifficultyBeatmap other) ;

/// @brief Method Equals addr 0x22251f4 size 0x10c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x2225300 size 0xc0 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x221a628 size 0x18 virtual false final false
static bool op_Equality(GlobalNamespace::PreviewDifficultyBeatmap a, GlobalNamespace::PreviewDifficultyBeatmap b) ;

/// @brief Method op_Inequality addr 0x22253c0 size 0x34 virtual false final false
