...
/// @brief Method get_pool addr 0xddc870 size 0x40 virtual false final false
static GlobalNamespace::IPacketPool_1<GlobalNamespace::NodePoseSyncStateDeltaNetSerializable> get_pool() ;

/// @brief Method get_baseId addr 0xddc8b0 size 0x8 virtual true final true
 GlobalNamespace::SyncStateId get_baseId() ;

/// @brief Method set_baseId addr 0xddc8b8 size 0x8 virtual true final true
 void set_baseId(GlobalNamespace::SyncStateId value) ;

/// @brief Method get_timeOffsetMs addr 0xddc8c0 size 0x8 virtual true final true
 int32_t get_timeOffsetMs() ;

/// @brief Method set_timeOffsetMs addr 0xddc8c8 size 0x8 virtual true final true
 void set_timeOffsetMs(int32_t value) ;

/// @brief Method get_delta addr 0xddc8d0 size 0x10 virtual true final true
 GlobalNamespace::NodePoseSyncState get_delta() ;

/// @brief Method set_delta addr 0xddc8e0 size 0x18 virtual true final true
 void set_delta(GlobalNamespace::NodePoseSyncState value) ;

/// @brief Method Serialize addr 0xddc8f8 size 0x98 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0xddc9c4 size 0x68 virtual true final true
 void Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method Release addr 0xddca58 size 0xac virtual true final true
 void Release() ;

// Ctor Parameters []
explicit NodePoseSyncStateDeltaNetSerializable() ;

/// @brief Method .ctor addr 0xddcb04 size 0x8 virtual false final false
 void _ctor() ;
