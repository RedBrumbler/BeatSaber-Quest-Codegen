...
/// @brief Method get_normalColor1 addr 0x2160bc0 size 0xc virtual false final false
 UnityEngine::Color get_normalColor1() ;

/// @brief Method get_normalColor2 addr 0x2160bcc size 0xc virtual false final false
 UnityEngine::Color get_normalColor2() ;

/// @brief Method get_highlightColor1 addr 0x2160e64 size 0xc virtual false final false
 UnityEngine::Color get_highlightColor1() ;

/// @brief Method get_highlightColor2 addr 0x2160e70 size 0xc virtual false final false
 UnityEngine::Color get_highlightColor2() ;

/// @brief Method get_pressedColor1 addr 0x2160efc size 0xc virtual false final false
 UnityEngine::Color get_pressedColor1() ;

/// @brief Method get_pressedColor2 addr 0x2160f08 size 0xc virtual false final false
 UnityEngine::Color get_pressedColor2() ;

/// @brief Method get_disabledColor1 addr 0x2160f94 size 0xc virtual false final false
 UnityEngine::Color get_disabledColor1() ;

/// @brief Method get_disabledColor2 addr 0x2160fa0 size 0xc virtual false final false
 UnityEngine::Color get_disabledColor2() ;

/// @brief Method get_selectedColor1 addr 0x216102c size 0xc virtual false final false
 UnityEngine::Color get_selectedColor1() ;

/// @brief Method get_selectedColor2 addr 0x2161038 size 0xc virtual false final false
 UnityEngine::Color get_selectedColor2() ;

/// @brief Method get_selectedAndHighlightedColor1 addr 0x21610c4 size 0xc virtual false final false
 UnityEngine::Color get_selectedAndHighlightedColor1() ;

/// @brief Method get_selectedAndHighlightedColor2 addr 0x21610d0 size 0xc virtual false final false
 UnityEngine::Color get_selectedAndHighlightedColor2() ;

// Ctor Parameters []
explicit GradientTransitionSO() ;

/// @brief Method .ctor addr 0x2161760 size 0x8 virtual false final false
 void _ctor() ;
