...
/// @brief Method .ctor addr 0x2165124 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__4 addr 0x21651b8 size 0x50 virtual false final false
 void _Awake_b__4() ;
...
/// @brief Method add_textKeyWasPressedEvent addr 0x2163d7c size 0xb0 virtual false final false
 void add_textKeyWasPressedEvent(System::Action_1<char16_t> value) ;

/// @brief Method remove_textKeyWasPressedEvent addr 0x2163e2c size 0xb0 virtual false final false
 void remove_textKeyWasPressedEvent(System::Action_1<char16_t> value) ;

/// @brief Method add_deleteButtonWasPressedEvent addr 0x2163edc size 0x9c virtual false final false
 void add_deleteButtonWasPressedEvent(System::Action value) ;

/// @brief Method remove_deleteButtonWasPressedEvent addr 0x2163f78 size 0x9c virtual false final false
 void remove_deleteButtonWasPressedEvent(System::Action value) ;

/// @brief Method add_okButtonWasPressedEvent addr 0x2164014 size 0x9c virtual false final false
 void add_okButtonWasPressedEvent(System::Action value) ;

/// @brief Method remove_okButtonWasPressedEvent addr 0x21640b0 size 0x9c virtual false final false
 void remove_okButtonWasPressedEvent(System::Action value) ;

/// @brief Method add_cancelButtonWasPressedEvent addr 0x216414c size 0x9c virtual false final false
 void add_cancelButtonWasPressedEvent(System::Action value) ;

/// @brief Method remove_cancelButtonWasPressedEvent addr 0x21641e8 size 0x9c virtual false final false
 void remove_cancelButtonWasPressedEvent(System::Action value) ;

/// @brief Method set_enableOkButtonInteractivity addr 0x2164284 size 0xa0 virtual false final false
 void set_enableOkButtonInteractivity(bool value) ;

/// @brief Method set_hideCancelButton addr 0x2164324 size 0xb0 virtual false final false
 void set_hideCancelButton(bool value) ;

/// @brief Method Awake addr 0x21643d4 size 0xd50 virtual false final false
 void Awake() ;

// Ctor Parameters []
explicit UIKeyboard() ;

/// @brief Method .ctor addr 0x216512c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__21_0 addr 0x2165134 size 0x1c virtual false final false
 void _Awake_b__21_0() ;

/// @brief Method <Awake>b__21_1 addr 0x2165150 size 0x24 virtual false final false
 void _Awake_b__21_1() ;

/// @brief Method <Awake>b__21_2 addr 0x2165174 size 0x24 virtual false final false
 void _Awake_b__21_2() ;

/// @brief Method <Awake>b__21_3 addr 0x2165198 size 0x20 virtual false final false
 void _Awake_b__21_3() ;
