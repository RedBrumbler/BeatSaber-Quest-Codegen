...
/// @brief Method Awake addr 0x20f4a48 size 0x104 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x20f4b4c size 0x12c virtual false final false
 void OnDestroy() ;

/// @brief Method LateUpdate addr 0x20f4c78 size 0x104 virtual false final false
 void LateUpdate() ;

/// @brief Method HandleSparkleEffectDidStart addr 0x20f4d7c size 0xc8 virtual false final false
 void HandleSparkleEffectDidStart(GlobalNamespace::SaberType saberType) ;

/// @brief Method HandleSparkleEffecDidEnd addr 0x20f4e44 size 0x14 virtual false final false
 void HandleSparkleEffecDidEnd(GlobalNamespace::SaberType saberType) ;

// Ctor Parameters []
explicit ObstacleSaberSoundEffect() ;

/// @brief Method .ctor addr 0x20f4e58 size 0x8 virtual false final false
 void _ctor() ;
