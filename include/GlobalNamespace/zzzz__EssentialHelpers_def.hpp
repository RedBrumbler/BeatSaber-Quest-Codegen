...
/// @brief Method get_CurrentTimeStamp addr 0x1fb2c48 size 0xb4 virtual false final false
static double_t get_CurrentTimeStamp() ;

/// @brief Method SafeDestroy addr 0x1fb2cfc size 0xa8 virtual false final false
