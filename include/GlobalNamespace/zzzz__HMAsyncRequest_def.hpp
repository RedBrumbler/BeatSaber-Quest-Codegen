...
/// @brief Method .ctor addr 0x1fb3e04 size 0x12c virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x1fb3f30 size 0x14 virtual true final false
 void Invoke(GlobalNamespace::HMAsyncRequest request) ;

/// @brief Method BeginInvoke addr 0x1fb3f44 size 0x20 virtual true final false
...
/// @brief Method EndInvoke addr 0x1fb3f64 size 0xc virtual true final false
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13825))}
...
/// @brief Method get_CancelHandler addr 0x1fb3d5c size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__HMAsyncRequest__CancelHander get_CancelHandler() ;

/// @brief Method set_CancelHandler addr 0x1fb3d64 size 0x8 virtual false final false
 void set_CancelHandler(GlobalNamespace::GlobalNamespace__HMAsyncRequest__CancelHander value) ;

/// @brief Method get_cancelled addr 0x1fb3d6c size 0x8 virtual false final false
 bool get_cancelled() ;

/// @brief Method Cancel addr 0x1fb3d74 size 0x28 virtual true final false
 void Cancel() ;

// Ctor Parameters []
explicit HMAsyncRequest() ;

/// @brief Method .ctor addr 0x1fb3d9c size 0x4 virtual false final false
 void _ctor() ;
