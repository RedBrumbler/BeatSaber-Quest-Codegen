...
/// @brief Method get_cutScore addr 0x2148ca0 size 0x8 virtual true final false
 int32_t get_cutScore() ;

/// @brief Method get_wouldBeCorrectCutBestPossibleMultiplierEventType addr 0x2148ca8 size 0x8 virtual true final false
...
/// @brief Method get_multiplierEventType addr 0x2148cb0 size 0x8 virtual true final false
 GlobalNamespace::GlobalNamespace__ScoreMultiplierCounter__MultiplierEventType get_multiplierEventType() ;

/// @brief Method get_executionOrder addr 0x2148cb8 size 0xc virtual true final false
 int32_t get_executionOrder() ;

/// @brief Method Init addr 0x2148770 size 0x4c virtual false final false
 void Init(GlobalNamespace::NoteData noteData) ;

// Ctor Parameters []
explicit MissScoringElement() ;

/// @brief Method .ctor addr 0x2148cc4 size 0x8 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5416)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5416), inst: 2718 }), TypeDefinitionIndex(TypeDefinitionIndex(5423))}
...
/// @brief Method .ctor addr 0x2148ccc size 0x48 virtual false final false
 void _ctor() ;
