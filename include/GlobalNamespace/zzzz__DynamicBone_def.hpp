...
/// @brief Method .ctor addr 0x11b2a1c size 0xdc virtual false final false
 void _ctor() ;
...
/// @brief Method Start addr 0x11b07b0 size 0x4 virtual false final false
 void Start() ;

/// @brief Method FixedUpdate addr 0x11b0920 size 0x30 virtual false final false
 void FixedUpdate() ;

/// @brief Method Update addr 0x11b0974 size 0x30 virtual false final false
 void Update() ;

/// @brief Method LateUpdate addr 0x11b09a4 size 0x50 virtual false final false
 void LateUpdate() ;

/// @brief Method PreUpdate addr 0x11b0950 size 0x24 virtual false final false
 void PreUpdate() ;

/// @brief Method CheckDistance addr 0x11b09f4 size 0x178 virtual false final false
 void CheckDistance() ;

/// @brief Method OnEnable addr 0x11b0f7c size 0x4 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x11b0f80 size 0x4 virtual false final false
 void OnDisable() ;

/// @brief Method OnValidate addr 0x11b0f84 size 0xac virtual false final false
 void OnValidate() ;

/// @brief Method OnDrawGizmosSelected addr 0x11b1030 size 0x190 virtual false final false
 void OnDrawGizmosSelected() ;

/// @brief Method SetWeight addr 0x11b11c0 size 0x50 virtual false final false
 void SetWeight(float_t w) ;

/// @brief Method GetWeight addr 0x11b1210 size 0x8 virtual false final false
 float_t GetWeight() ;

/// @brief Method UpdateDynamicBones addr 0x11b0b6c size 0x1c4 virtual false final false
 void UpdateDynamicBones(float_t t) ;

/// @brief Method SetupParticles addr 0x11b07b4 size 0x16c virtual false final false
 void SetupParticles() ;

/// @brief Method AppendParticles addr 0x11b2198 size 0x5c8 virtual false final false
 void AppendParticles(UnityEngine::Transform b, int32_t parentIndex, float_t boneLength) ;

/// @brief Method UpdateParameters addr 0x11b2760 size 0x2bc virtual false final false
 void UpdateParameters() ;

/// @brief Method InitTransforms addr 0x11b0d30 size 0x104 virtual false final false
 void InitTransforms() ;

/// @brief Method ResetParticlesPosition addr 0x11b0e34 size 0x148 virtual false final false
 void ResetParticlesPosition() ;

/// @brief Method UpdateParticles1 addr 0x11b1218 size 0x264 virtual false final false
 void UpdateParticles1() ;

/// @brief Method UpdateParticles2 addr 0x11b147c size 0x61c virtual false final false
 void UpdateParticles2() ;

/// @brief Method SkipUpdateParticles addr 0x11b1a98 size 0x4a4 virtual false final false
 void SkipUpdateParticles() ;

/// @brief Method MirrorVector addr 0x11b2af8 size 0x34 virtual false final false
static UnityEngine::Vector3 MirrorVector(UnityEngine::Vector3 v, UnityEngine::Vector3 axis) ;

/// @brief Method ApplyParticlesToTransforms addr 0x11b1f3c size 0x25c virtual false final false
 void ApplyParticlesToTransforms() ;

// Ctor Parameters []
explicit DynamicBone() ;

/// @brief Method .ctor addr 0x11b2b2c size 0x150 virtual false final false
 void _ctor() ;
