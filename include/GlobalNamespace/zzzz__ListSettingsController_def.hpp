...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5690))}
...
/// @brief Method OnEnable addr 0x218a22c size 0x34 virtual false final false
 void OnEnable() ;

/// @brief Method RefreshUI addr 0x218a260 size 0x74 virtual false final false
 void RefreshUI() ;

/// @brief Method Refresh addr 0x2189640 size 0x5c virtual false final false
 void Refresh(bool applyValue) ;

/// @brief Method IncButtonPressed addr 0x218a2d4 size 0x40 virtual true final false
 void IncButtonPressed() ;

/// @brief Method DecButtonPressed addr 0x218a314 size 0x38 virtual true final false
 void DecButtonPressed() ;

// Ctor Parameters []
explicit ListSettingsController() ;

/// @brief Method .ctor addr 0x218997c size 0x8 virtual false final false
 void _ctor() ;
