...
constexpr GlobalNamespace::GlobalNamespace__TrailElementCollection__InterpolationState::GlobalNamespace__TrailElementCollection__InterpolationState(int32_t segmentIndex, float_t segmentLerp) noexcept : ::bs_hook::ValueTypeWrapper() {this->segmentIndex = segmentIndex;
this->segmentLerp = segmentLerp;
}
constexpr void GlobalNamespace::GlobalNamespace__TrailElementCollection__InterpolationState::__set_segmentIndex(int32_t value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->__instance, std::forward<int32_t>(value));
}
constexpr int32_t GlobalNamespace::GlobalNamespace__TrailElementCollection__InterpolationState::__get_segmentIndex() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->__instance);
}
constexpr void GlobalNamespace::GlobalNamespace__TrailElementCollection__InterpolationState::__set_segmentLerp(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x4>(this->__instance, std::forward<float_t>(value));
}
constexpr float_t GlobalNamespace::GlobalNamespace__TrailElementCollection__InterpolationState::__get_segmentLerp() const {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrailElementCollection::*)(int32_t, UnityEngine::Vector3, UnityEngine::Vector3, float_t)>(&GlobalNamespace::TrailElementCollection::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x228f858;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrailElementCollection::*)(UnityEngine::Vector3, UnityEngine::Vector3, float_t)>(&GlobalNamespace::TrailElementCollection::InitSnapshots)> {
  ...
  constexpr static std::size_t addrs = 0x228fb60;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrailElementCollection::*)(UnityEngine::Vector3, UnityEngine::Vector3, float_t)>(&GlobalNamespace::TrailElementCollection::SetHeadData)> {
  ...
  constexpr static std::size_t addrs = 0x228ffd4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrailElementCollection::*)()>(&GlobalNamespace::TrailElementCollection::MoveTailToHead)> {
  ...
  constexpr static std::size_t addrs = 0x2290088;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrailElementCollection::*)()>(&GlobalNamespace::TrailElementCollection::UpdateDistances)> {
  ...
  constexpr static std::size_t addrs = 0x2290124;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrailElementCollection::*)(float_t, ByRef<GlobalNamespace::GlobalNamespace__TrailElementCollection__InterpolationState>, ByRef<UnityEngine::Vector3>, ByRef<UnityEngine::Vector3>, ByRef<float_t>)>(&GlobalNamespace::TrailElementCollection::Interpolate)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "Interpolate",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<GlobalNamespace::GlobalNamespace__TrailElementCollection__InterpolationState>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<UnityEngine::Vector3>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<UnityEngine::Vector3>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<float_t>>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::TrailElementCollection::*)(float_t, ByRef<GlobalNamespace::GlobalNamespace__TrailElementCollection__InterpolationState>)>(&GlobalNamespace::TrailElementCollection::UpdateLerpState)> {
  constexpr static std::size_t size = 0x110;
  constexpr static std::size_t addrs = 0x22915b0;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "UpdateLerpState",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<GlobalNamespace::GlobalNamespace__TrailElementCollection__InterpolationState>>::get()}
                        )));
    return ___internal_method;
  }
};
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void GlobalNamespace::TrailElementCollection::Interpolate(float_t t, ByRef<GlobalNamespace::GlobalNamespace__TrailElementCollection__InterpolationState> lerpState, ByRef<UnityEngine::Vector3> position, ByRef<UnityEngine::Vector3> normal, ByRef<float_t> time)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::TrailElementCollection>::get(),
                            "Interpolate",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, t, lerpState, position, normal, time);
 ...
 void GlobalNamespace::TrailElementCollection::UpdateLerpState(float_t t, ByRef<GlobalNamespace::GlobalNamespace__TrailElementCollection__InterpolationState> interpolationState)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<GlobalNamespace::TrailElementCollection>::get(),
                            "UpdateLerpState",
                            std::vector<Il2CppClass*>{},
