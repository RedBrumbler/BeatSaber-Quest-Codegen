...
/// @brief Method get_mirrorMaterial addr 0x26a8a14 size 0x8 virtual false final false
 UnityEngine::Material get_mirrorMaterial() ;

/// @brief Method get_noMirrorMaterial addr 0x26a8a1c size 0x8 virtual false final false
 UnityEngine::Material get_noMirrorMaterial() ;

/// @brief Method get_isEnabled addr 0x26a8a24 size 0x8 virtual false final false
 bool get_isEnabled() ;

/// @brief Method set_isEnabled addr 0x26a8a2c size 0xc virtual false final false
 void set_isEnabled(bool value) ;

/// @brief Method add_mirrorDidChangeEnabledStateEvent addr 0x26a8a38 size 0xb0 virtual false final false
 void add_mirrorDidChangeEnabledStateEvent(System::Action_1<bool> value) ;

/// @brief Method remove_mirrorDidChangeEnabledStateEvent addr 0x26a8ae8 size 0xb0 virtual false final false
 void remove_mirrorDidChangeEnabledStateEvent(System::Action_1<bool> value) ;

/// @brief Method Update addr 0x26a8b98 size 0x18 virtual false final false
 void Update() ;

/// @brief Method OnWillRenderObject addr 0x26a8d3c size 0x25c virtual false final false
 void OnWillRenderObject() ;

/// @brief Method ChangeMirrorEnabledState addr 0x26a8f98 size 0x38 virtual false final false
 void ChangeMirrorEnabledState(bool newIsEnabled) ;

// Ctor Parameters []
explicit Mirror() ;

/// @brief Method .ctor addr 0x26a97c0 size 0x8 virtual false final false
 void _ctor() ;
