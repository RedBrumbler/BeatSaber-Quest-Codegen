...
/// @brief Method get_beatmapCharacteristic addr 0x2220698 size 0x8 virtual true final true
 GlobalNamespace::BeatmapCharacteristicSO get_beatmapCharacteristic() ;

/// @brief Method get_difficultyBeatmaps addr 0x22206a0 size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0x22206a8 size 0x2c virtual false final false
...
/// @brief Method SetParentLevel addr 0x221fb10 size 0x44 virtual false final false
...
/// @brief Method MoveNext addr 0x2220964 size 0x1ec virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2220b50 size 0x58 virtual true final true
...
/// @brief Method MoveNext addr 0x2220ba8 size 0x2e0 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2220e88 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method get_difficulty addr 0x22206d4 size 0x8 virtual true final true
 GlobalNamespace::BeatmapDifficulty get_difficulty() ;

/// @brief Method get_difficultyRank addr 0x22206dc size 0x8 virtual true final true
 int32_t get_difficultyRank() ;

/// @brief Method get_noteJumpMovementSpeed addr 0x22206e4 size 0x8 virtual true final true
 float_t get_noteJumpMovementSpeed() ;

/// @brief Method get_noteJumpStartBeatOffset addr 0x22206ec size 0x8 virtual true final true
 float_t get_noteJumpStartBeatOffset() ;

/// @brief Method get_environmentNameIdx addr 0x22206f4 size 0x8 virtual true final true
 int32_t get_environmentNameIdx() ;

/// @brief Method GetBeatmapDataBasicInfoAsync addr 0x22206fc size 0xf0 virtual true final true
 System::Threading::Tasks::Task_1<GlobalNamespace::IBeatmapDataBasicInfo> GetBeatmapDataBasicInfoAsync() ;

/// @brief Method GetBeatmapDataAsync addr 0x22207ec size 0x104 virtual true final true
...
/// @brief Method get_level addr 0x22208f0 size 0x8 virtual true final true
 GlobalNamespace::IBeatmapLevel get_level() ;

/// @brief Method get_parentDifficultyBeatmapSet addr 0x22208f8 size 0x8 virtual true final true
 GlobalNamespace::IDifficultyBeatmapSet get_parentDifficultyBeatmapSet() ;

/// @brief Method SetParents addr 0x22181f0 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2220900 size 0x64 virtual false final false
...
/// @brief Method .ctor addr 0x2220ee0 size 0xc virtual false final false
...
/// @brief Method MoveNext addr 0x2220eec size 0x230 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x222111c size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method MoveNext addr 0x2221174 size 0x230 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x22213a4 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method MoveNext addr 0x22213fc size 0x2a0 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x222169c size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method get_levelID addr 0x221f8f0 size 0x8 virtual true final true
 ::StringW get_levelID() ;

/// @brief Method get_songName addr 0x221f8f8 size 0x8 virtual true final true
 ::StringW get_songName() ;

/// @brief Method get_songSubName addr 0x221f900 size 0x8 virtual true final true
 ::StringW get_songSubName() ;

/// @brief Method get_songAuthorName addr 0x221f908 size 0x8 virtual true final true
 ::StringW get_songAuthorName() ;

/// @brief Method get_levelAuthorName addr 0x221f910 size 0x8 virtual true final true
 ::StringW get_levelAuthorName() ;

/// @brief Method get_beatsPerMinute addr 0x221f918 size 0x8 virtual true final true
 float_t get_beatsPerMinute() ;

/// @brief Method get_songTimeOffset addr 0x221f920 size 0x8 virtual true final true
 float_t get_songTimeOffset() ;

/// @brief Method get_shuffle addr 0x221f928 size 0x8 virtual true final true
 float_t get_shuffle() ;

/// @brief Method get_shufflePeriod addr 0x221f930 size 0x8 virtual true final true
 float_t get_shufflePeriod() ;

/// @brief Method get_previewStartTime addr 0x221f938 size 0x8 virtual true final true
 float_t get_previewStartTime() ;

/// @brief Method get_previewDuration addr 0x221f940 size 0x8 virtual true final true
 float_t get_previewDuration() ;

/// @brief Method get_coverImage addr 0x221f948 size 0x8 virtual false final false
 UnityEngine::Sprite get_coverImage() ;

/// @brief Method get_environmentInfo addr 0x221f950 size 0x8 virtual true final true
 GlobalNamespace::EnvironmentInfoSO get_environmentInfo() ;

/// @brief Method get_allDirectionsEnvironmentInfo addr 0x221f958 size 0x8 virtual true final true
 GlobalNamespace::EnvironmentInfoSO get_allDirectionsEnvironmentInfo() ;

/// @brief Method get_environmentInfos addr 0x221f960 size 0x8 virtual true final true
 ::ArrayW<GlobalNamespace::EnvironmentInfoSO> get_environmentInfos() ;

/// @brief Method get_difficultyBeatmapSets addr 0x221f968 size 0x1c virtual false final false
 System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::IDifficultyBeatmapSet> get_difficultyBeatmapSets() ;

/// @brief Method get_songDuration addr 0x221f984 size 0x1c virtual true final true
 float_t get_songDuration() ;

/// @brief Method get_previewDifficultyBeatmapSets addr 0x221f9a0 size 0x1c virtual true final true
 System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::PreviewDifficultyBeatmapSet> get_previewDifficultyBeatmapSets() ;

/// @brief Method get_songPreviewAudioClip addr 0x221f9bc size 0x8 virtual true final true
 UnityEngine::AudioClip get_songPreviewAudioClip() ;

/// @brief Method get_songAudioClip addr 0x221f9c4 size 0x8 virtual true final true
 UnityEngine::AudioClip get_songAudioClip() ;

/// @brief Method OnEnable addr 0x221f9cc size 0x1c virtual true final false
 void OnEnable() ;

/// @brief Method InitData addr 0x221f9e8 size 0x128 virtual false final false
 void InitData() ;

/// @brief Method GetPreviewAudioClipAsync addr 0x221fb54 size 0xfc virtual false final false
...
/// @brief Method GetCoverImageAsync addr 0x221fc50 size 0xfc virtual true final true
 System::Threading::Tasks::Task_1<UnityEngine::Sprite> GetCoverImageAsync(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method get_beatmapLevelData addr 0x221fd4c size 0x80 virtual true final true
 GlobalNamespace::IBeatmapLevelData get_beatmapLevelData() ;

/// @brief Method GetBeatmapLevelDataAsync addr 0x221fdcc size 0xf8 virtual false final false
...
/// @brief Method GetDifficultyBeatmap addr 0x221fec4 size 0x79c virtual false final false
...
/// @brief Method InitFull addr 0x2220660 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x2220690 size 0x8 virtual false final false
 void _ctor() ;
