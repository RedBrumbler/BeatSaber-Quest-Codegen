...
/// @brief Method .ctor addr 0x2200e74 size 0x28 virtual false final false
 void _ctor(System::Collections::Generic::LinkedListNode_1<GlobalNamespace::BeatmapDataItem> node) ;

/// @brief Method CompareTo addr 0x2201388 size 0xb0 virtual true final true
...
/// @brief Method get_updateAllBeatmapDataOnInsert addr 0x2200204 size 0x8 virtual false final false
 bool get_updateAllBeatmapDataOnInsert() ;

/// @brief Method set_updateAllBeatmapDataOnInsert addr 0x220020c size 0xc virtual false final false
 void set_updateAllBeatmapDataOnInsert(bool value) ;

/// @brief Method get_allBeatmapDataItems addr 0x2200218 size 0xa4 virtual true final true
 System::Collections::Generic::LinkedList_1<GlobalNamespace::BeatmapDataItem> get_allBeatmapDataItems() ;

/// @brief Method get_numberOfLines addr 0x22002bc size 0x8 virtual true final true
 int32_t get_numberOfLines() ;

/// @brief Method get_cuttableNotesCount addr 0x22002c4 size 0x8 virtual true final true
 int32_t get_cuttableNotesCount() ;

/// @brief Method set_cuttableNotesCount addr 0x22002cc size 0x8 virtual false final false
 void set_cuttableNotesCount(int32_t value) ;

/// @brief Method get_obstaclesCount addr 0x22002d4 size 0x8 virtual true final true
 int32_t get_obstaclesCount() ;

/// @brief Method set_obstaclesCount addr 0x22002dc size 0x8 virtual false final false
 void set_obstaclesCount(int32_t value) ;

/// @brief Method get_bombsCount addr 0x22002e4 size 0x8 virtual true final true
 int32_t get_bombsCount() ;

/// @brief Method set_bombsCount addr 0x22002ec size 0x8 virtual false final false
 void set_bombsCount(int32_t value) ;

/// @brief Method get_spawnRotationEventsCount addr 0x22002f4 size 0x4c virtual true final true
 int32_t get_spawnRotationEventsCount() ;

/// @brief Method get_specialBasicBeatmapEventKeywords addr 0x2200340 size 0x8 virtual true final true
 System::Collections::Generic::IEnumerable_1<::StringW> get_specialBasicBeatmapEventKeywords() ;

/// @brief Method add_beatmapEventDataWasInsertedEvent addr 0x2200348 size 0xb0 virtual true final true
...
/// @brief Method remove_beatmapEventDataWasInsertedEvent addr 0x22003f8 size 0xb0 virtual true final true
...
/// @brief Method add_beatmapEventDataWillBeRemovedEvent addr 0x22004a8 size 0xb0 virtual true final true
...
/// @brief Method remove_beatmapEventDataWillBeRemovedEvent addr 0x2200558 size 0xb0 virtual true final true
...
/// @brief Method add_beatmapEventDataWasRemovedEvent addr 0x2200608 size 0xb0 virtual true final true
 void add_beatmapEventDataWasRemovedEvent(System::Action_1<GlobalNamespace::BeatmapEventData> value) ;

/// @brief Method remove_beatmapEventDataWasRemovedEvent addr 0x22006b8 size 0xb0 virtual true final true
...
/// @brief Method .ctor addr 0x21efc20 size 0x194 virtual false final false
...
/// @brief Method AddBeatmapObjectData addr 0x21efe50 size 0x19c virtual false final false
 void AddBeatmapObjectData(GlobalNamespace::BeatmapObjectData beatmapObjectData) ;

/// @brief Method AddBeatmapObjectDataInOrder addr 0x21f1688 size 0x2c virtual false final false
 void AddBeatmapObjectDataInOrder(GlobalNamespace::BeatmapObjectData beatmapObjectData) ;

/// @brief Method InsertBeatmapEventData addr 0x21efdb4 size 0x9c virtual false final false
 void InsertBeatmapEventData(GlobalNamespace::BeatmapEventData beatmapEventData) ;

/// @brief Method InsertBeatmapEventDataInOrder addr 0x21f1630 size 0x58 virtual false final false
 void InsertBeatmapEventDataInOrder(GlobalNamespace::BeatmapEventData beatmapEventData) ;

/// @brief Method RemoveBeatmapEventData addr 0x220093c size 0x17c virtual false final false
 void RemoveBeatmapEventData(GlobalNamespace::BeatmapEventData beatmapEventData) ;

/// @brief Method AddSpecialBasicBeatmapEventKeyword addr 0x2200ab8 size 0x58 virtual false final false
 void AddSpecialBasicBeatmapEventKeyword(::StringW specialBasicBeatmapEventKeyword) ;

/// @brief Method ProcessRemainingData addr 0x2200b10 size 0x1c virtual false final false
 void ProcessRemainingData() ;

/// @brief Method ProcessAndSortBeatmapData addr 0x2200b2c size 0x348 virtual false final false
 void ProcessAndSortBeatmapData() ;

/// @brief Method GetCopy addr 0x2200e9c size 0x25c virtual true final true
 GlobalNamespace::BeatmapData GetCopy() ;

/// @brief Method GetFilteredCopy addr 0x22010f8 size 0x290 virtual true final true
...
/// @brief Method InsertToAllBeatmapData addr 0x2200768 size 0x1d4 virtual false final false
