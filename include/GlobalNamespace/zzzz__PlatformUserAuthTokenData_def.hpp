...
/// @brief Method get_token addr 0x2256528 size 0x8 virtual false final false
 ::StringW get_token() ;

/// @brief Method set_token addr 0x2256530 size 0x8 virtual false final false
 void set_token(::StringW value) ;

/// @brief Method get_validPlatformEnvironment addr 0x2256538 size 0x8 virtual false final false
 GlobalNamespace::PlatformEnvironment get_validPlatformEnvironment() ;

/// @brief Method set_validPlatformEnvironment addr 0x2256540 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2256548 size 0x30 virtual false final false
