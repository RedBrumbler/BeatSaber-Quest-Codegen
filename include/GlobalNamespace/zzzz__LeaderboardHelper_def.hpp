...
/// @brief Method MoveNext addr 0x21d21c8 size 0xb48 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x21d2d10 size 0xc virtual true final true
...
/// @brief Method CreateOculusLeaderboards addr 0x21d1228 size 0xe7c virtual false final false
...
/// @brief Method CreateOculusLeaderboard addr 0x21d20a4 size 0xa4 virtual false final false
 void CreateOculusLeaderboard(::StringW leaderboardID, ::StringW appToken) ;

// Ctor Parameters []
explicit LeaderboardHelper() ;

/// @brief Method .ctor addr 0x21d2148 size 0x80 virtual false final false
 void _ctor() ;
