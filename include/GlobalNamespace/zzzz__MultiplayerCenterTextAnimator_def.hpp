...
/// @brief Method Awake addr 0x2128564 size 0x408 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x212896c size 0x88 virtual false final false
 void OnDestroy() ;

/// @brief Method AnimateTextColor addr 0x21289f4 size 0x98 virtual false final false
 void AnimateTextColor(UnityEngine::Color color, float_t duration, GlobalNamespace::EaseType easeType) ;

/// @brief Method AnimateFontSize addr 0x2128a8c size 0x44 virtual false final false
 void AnimateFontSize(float_t fontSize, float_t duration, GlobalNamespace::EaseType easeType) ;

/// @brief Method AnimatePositionOffsetSize addr 0x2128ad0 size 0x8c virtual false final false
 void AnimatePositionOffsetSize(UnityEngine::Vector3 offset, float_t duration, GlobalNamespace::EaseType easeType) ;

/// @brief Method AnimateEnabled addr 0x2128b5c size 0x148 virtual false final false
 void AnimateEnabled(bool isEnabled, float_t duration, GlobalNamespace::EaseType easeType) ;

/// @brief Method SetText addr 0x2128ca4 size 0x24 virtual false final false
 void SetText(::StringW text) ;

// Ctor Parameters []
explicit MultiplayerCenterTextAnimator() ;

/// @brief Method .ctor addr 0x2128cc8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__8_0 addr 0x2128cd0 size 0x78 virtual false final false
 void _Awake_b__8_0(float_t val) ;

/// @brief Method <Awake>b__8_1 addr 0x2128d48 size 0x78 virtual false final false
 void _Awake_b__8_1(float_t val) ;

/// @brief Method <Awake>b__8_5 addr 0x2128dc0 size 0x2c virtual false final false
 void _Awake_b__8_5() ;

/// @brief Method <Awake>b__8_2 addr 0x2128dec size 0x1c virtual false final false
 void _Awake_b__8_2(float_t val) ;

/// @brief Method <Awake>b__8_3 addr 0x2128e08 size 0x24 virtual false final false
 void _Awake_b__8_3(UnityEngine::Color val) ;

/// @brief Method <Awake>b__8_4 addr 0x2128e2c size 0x1c virtual false final false
