...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12640)), TypeDefinitionIndex(TypeDefinitionIndex(12641))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12641), inst: 2 })
