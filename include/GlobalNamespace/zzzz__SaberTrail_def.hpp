...
/// @brief Method Awake addr 0x228f48c size 0x12c virtual false final false
 void Awake() ;

/// @brief Method Setup addr 0x228f5b8 size 0x20 virtual false final false
 void Setup(UnityEngine::Color color, GlobalNamespace::IBladeMovementData movementData) ;

/// @brief Method Init addr 0x228f5d8 size 0x280 virtual false final false
 void Init() ;

/// @brief Method ResetTrailData addr 0x228fa8c size 0xd4 virtual false final false
 void ResetTrailData() ;

/// @brief Method LateUpdate addr 0x228fbf0 size 0x3e4 virtual false final false
 void LateUpdate() ;

/// @brief Method OnEnable addr 0x22902d4 size 0xac virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2290380 size 0x84 virtual false final false
 void OnDisable() ;

/// @brief Method OnDestroy addr 0x2290404 size 0xa8 virtual false final false
 void OnDestroy() ;

/// @brief Method GetTrailWidth addr 0x228fa08 size 0x84 virtual false final false
 float_t GetTrailWidth(GlobalNamespace::BladeMovementDataElement lastAddedData) ;

/// @brief Method OnDrawGizmosSelected addr 0x22904ac size 0x1d4 virtual false final false
 void OnDrawGizmosSelected() ;

// Ctor Parameters []
explicit SaberTrail() ;

/// @brief Method .ctor addr 0x2290680 size 0x38 virtual false final false
 void _ctor() ;
