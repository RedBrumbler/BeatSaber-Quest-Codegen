...
/// @brief Method .ctor addr 0x22363c4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SetOwnedSongPacks>b__43_0 addr 0x22363cc size 0x9c virtual false final false
...
/// @brief Method MoveNext addr 0x2236468 size 0x68c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2236af4 size 0xc virtual true final true
...
/// @brief Method .ctor addr 0x2236074 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2236b00 size 0x1c virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2236b1c size 0x1e4 virtual true final true
 bool MoveNext() ;

/// @brief Method <>m__Finally1 addr 0x2236d00 size 0x50 virtual false final false
 void __m__Finally1() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Collections.Generic.KeyValuePair<System.String,ILobbyPlayerData>>.get_Current addr 0x2236d50 size 0xc virtual true final true
...
/// @brief Method System.Collections.IEnumerator.Reset addr 0x2236d5c size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2236d9c size 0x5c virtual true final true
...
/// @brief Method get_localUserId addr 0x2232874 size 0x140 virtual true final true
 ::StringW get_localUserId() ;

/// @brief Method get_partyOwnerId addr 0x22329b4 size 0x8 virtual true final true
 ::StringW get_partyOwnerId() ;

/// @brief Method set_partyOwnerId addr 0x22329bc size 0x8 virtual false final false
 void set_partyOwnerId(::StringW value) ;

/// @brief Method add_didChangeEvent addr 0x22329c4 size 0xb0 virtual true final true
 void add_didChangeEvent(System::Action_1<::StringW> value) ;

/// @brief Method remove_didChangeEvent addr 0x2232a74 size 0xb0 virtual true final true
 void remove_didChangeEvent(System::Action_1<::StringW> value) ;

/// @brief Method get_Item addr 0x2232b24 size 0x80 virtual true final true
 GlobalNamespace::ILobbyPlayerData get_Item(::StringW userId) ;

/// @brief Method GetOrCreateLobbyPlayerDataModel addr 0x2232ba4 size 0xdc virtual false final false
 GlobalNamespace::LobbyPlayerData GetOrCreateLobbyPlayerDataModel(::StringW userId, ByRef<bool> alreadyExists) ;

/// @brief Method SetPlayerBeatmapLevel addr 0x2232c80 size 0x84 virtual false final false
 void SetPlayerBeatmapLevel(::StringW userId, GlobalNamespace::PreviewDifficultyBeatmap beatmapLevel) ;

/// @brief Method SetPlayerGameplayModifiers addr 0x2232d20 size 0x7c virtual false final false
 void SetPlayerGameplayModifiers(::StringW userId, GlobalNamespace::GameplayModifiers modifiers) ;

/// @brief Method SetPlayerIsActive addr 0x2232d9c size 0x8c virtual false final false
 void SetPlayerIsActive(::StringW userId, bool isActive, bool notifyChange) ;

/// @brief Method SetPlayerIsReady addr 0x2232e28 size 0x8c virtual false final false
 void SetPlayerIsReady(::StringW userId, bool isReady, bool notifyChange) ;

/// @brief Method SetPlayerIsInLobby addr 0x2232eb4 size 0x8c virtual false final false
 void SetPlayerIsInLobby(::StringW userId, bool isInLobby, bool notifyChange) ;

/// @brief Method SetPlayerIsPartyOwner addr 0x2232f40 size 0x94 virtual false final false
 void SetPlayerIsPartyOwner(::StringW userId, bool isPartyOwner, bool notifyChange) ;

/// @brief Method SetLocalPlayerBeatmapLevel addr 0x2232fd4 size 0x154 virtual true final true
 void SetLocalPlayerBeatmapLevel(GlobalNamespace::PreviewDifficultyBeatmap beatmapLevel) ;

/// @brief Method ClearLocalPlayerBeatmapLevel addr 0x2233128 size 0xbc virtual true final true
 void ClearLocalPlayerBeatmapLevel() ;

/// @brief Method SetLocalPlayerGameplayModifiers addr 0x22331e4 size 0x11c virtual true final true
 void SetLocalPlayerGameplayModifiers(GlobalNamespace::GameplayModifiers modifiers) ;

/// @brief Method ClearLocalPlayerGameplayModifiers addr 0x2233300 size 0xbc virtual true final true
 void ClearLocalPlayerGameplayModifiers() ;

/// @brief Method SetLocalPlayerIsActive addr 0x22333bc size 0xc virtual true final true
 void SetLocalPlayerIsActive(bool isActive) ;

/// @brief Method SetLocalPlayerIsActive addr 0x22333c8 size 0xf4 virtual false final false
 void SetLocalPlayerIsActive(bool isActive, bool notifyChange) ;

/// @brief Method SetLocalPlayerIsReady addr 0x22334bc size 0xc virtual true final true
 void SetLocalPlayerIsReady(bool isReady) ;

/// @brief Method SetLocalPlayerIsReady addr 0x22334c8 size 0xd8 virtual false final false
 void SetLocalPlayerIsReady(bool isReady, bool notifyChange) ;

/// @brief Method SetLocalPlayerIsInLobby addr 0x22335a0 size 0xc virtual true final true
 void SetLocalPlayerIsInLobby(bool isInLobby) ;

/// @brief Method SetLocalPlayerIsInLobby addr 0x22335ac size 0xd8 virtual false final false
 void SetLocalPlayerIsInLobby(bool isInLobby, bool notifyChange) ;

/// @brief Method RequestKickPlayer addr 0x2233684 size 0xc8 virtual true final true
 void RequestKickPlayer(::StringW userId) ;

/// @brief Method ClearData addr 0x223374c size 0x80 virtual true final true
 void ClearData() ;

/// @brief Method ClearRecommendations addr 0x22337cc size 0x158 virtual true final true
 void ClearRecommendations() ;

/// @brief Method Activate addr 0x2233924 size 0x106c virtual true final true
 void Activate() ;

/// @brief Method Deactivate addr 0x2234a24 size 0xa18 virtual true final true
 void Deactivate() ;

/// @brief Method Dispose addr 0x223543c size 0x4 virtual true final true
 void Dispose() ;

/// @brief Method SetOwnedSongPacks addr 0x2234990 size 0x94 virtual false final false
 void SetOwnedSongPacks() ;

/// @brief Method HandleMenuRpcManagerGetRecommendedBeatmap addr 0x2235440 size 0x198 virtual false final false
 void HandleMenuRpcManagerGetRecommendedBeatmap(::StringW userId) ;

/// @brief Method HandleMenuRpcManagerGetRecommendedGameplayModifiers addr 0x22355d8 size 0x194 virtual false final false
 void HandleMenuRpcManagerGetRecommendedGameplayModifiers(::StringW userId) ;

/// @brief Method HandleMenuRpcManagerGetIsInLobby addr 0x223576c size 0x138 virtual false final false
 void HandleMenuRpcManagerGetIsInLobby(::StringW userId) ;

/// @brief Method HandleMenuRpcManagerGetIsReady addr 0x22358a4 size 0x138 virtual false final false
 void HandleMenuRpcManagerGetIsReady(::StringW userId) ;

/// @brief Method HandleMenuRpcManagerRecommendBeatmap addr 0x22359dc size 0x40 virtual false final false
 void HandleMenuRpcManagerRecommendBeatmap(::StringW userId, GlobalNamespace::BeatmapIdentifierNetSerializable beatmapId) ;

/// @brief Method HandleMenuRpcManagerRecommendGameplayModifiers addr 0x2235a1c size 0x4 virtual false final false
 void HandleMenuRpcManagerRecommendGameplayModifiers(::StringW userId, GlobalNamespace::GameplayModifiers gameplayModifiers) ;

/// @brief Method HandleMenuRpcManagerClearRecommendedGameplayModifiers addr 0x2235a20 size 0x8 virtual false final false
 void HandleMenuRpcManagerClearRecommendedGameplayModifiers(::StringW userId) ;

/// @brief Method HandleMenuRpcManagerClearBeatmap addr 0x2235a28 size 0x8 virtual false final false
 void HandleMenuRpcManagerClearBeatmap(::StringW userId) ;

/// @brief Method HandleMenuRpcManagerSetIsReady addr 0x2235a30 size 0xc virtual false final false
 void HandleMenuRpcManagerSetIsReady(::StringW userId, bool isReady) ;

/// @brief Method HandleMenuRpcManagerSetIsInLobby addr 0x2235a3c size 0xc virtual false final false
 void HandleMenuRpcManagerSetIsInLobby(::StringW userId, bool isInLobby) ;

/// @brief Method HandleMultiplayerSessionManagerPlayerStateChanged addr 0x2235a48 size 0xc8 virtual false final false
 void HandleMultiplayerSessionManagerPlayerStateChanged(GlobalNamespace::IConnectedPlayer connectedPlayer) ;

/// @brief Method HandleMultiplayerSessionManagerPlayerConnected addr 0x2235b10 size 0x238 virtual false final false
 void HandleMultiplayerSessionManagerPlayerConnected(GlobalNamespace::IConnectedPlayer connectedPlayer) ;

/// @brief Method HandleMultiplayerSessionManagerPlayerDisconnected addr 0x2235d48 size 0x160 virtual false final false
 void HandleMultiplayerSessionManagerPlayerDisconnected(GlobalNamespace::IConnectedPlayer connectedPlayer) ;

/// @brief Method NotifyModelChange addr 0x2232d04 size 0x1c virtual false final false
 void NotifyModelChange(::StringW userId) ;

/// @brief Method HandleMenuRpcManagerGetOwnedSongPacks addr 0x2235ea8 size 0x4 virtual false final false
 void HandleMenuRpcManagerGetOwnedSongPacks(::StringW userId) ;

/// @brief Method HandleMenuRpcManagerSetPlayersPermissionConfiguration addr 0x2235eac size 0x160 virtual false final false
...
/// @brief Method GetEnumerator addr 0x223600c size 0x68 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x223609c size 0x4 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method get_Count addr 0x22360a0 size 0x50 virtual true final true
 int32_t get_Count() ;

/// @brief Method ContainsKey addr 0x22360f0 size 0x58 virtual true final true
 bool ContainsKey(::StringW key) ;

/// @brief Method TryGetValue addr 0x2236148 size 0x7c virtual true final true
 bool TryGetValue(::StringW key, ByRef<GlobalNamespace::ILobbyPlayerData> value) ;

/// @brief Method get_Keys addr 0x22361c4 size 0x50 virtual true final true
 System::Collections::Generic::IEnumerable_1<::StringW> get_Keys() ;

/// @brief Method get_Values addr 0x2236214 size 0x50 virtual true final true
 System::Collections::Generic::IEnumerable_1<GlobalNamespace::ILobbyPlayerData> get_Values() ;

// Ctor Parameters []
explicit LobbyPlayersDataModel() ;

/// @brief Method .ctor addr 0x2236264 size 0xfc virtual false final false
 void _ctor() ;
