...
/// @brief Method Obtain addr 0x1228cb0 size 0x64 virtual false final false
static GlobalNamespace::SliderSpawnInfoNetSerializable Obtain() ;

/// @brief Method Init addr 0x1228d14 size 0x244 virtual false final false
...
/// @brief Method .ctor addr 0x1228f58 size 0x58 virtual false final false
 void _ctor() ;

/// @brief Method Serialize addr 0x1228fb0 size 0x238 virtual true final false
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0x12291e8 size 0x274 virtual true final false
