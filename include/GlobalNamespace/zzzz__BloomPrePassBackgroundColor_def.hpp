...
/// @brief Method get_color addr 0x1fcd354 size 0xc virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method set_color addr 0x1fcd360 size 0xc virtual false final false
 void set_color(UnityEngine::Color value) ;

/// @brief Method get_bgColor addr 0x1fcd36c size 0x90 virtual false final false
 UnityEngine::Color get_bgColor() ;

/// @brief Method InitIfNeeded addr 0x1fcd3fc size 0x184 virtual false final false
 void InitIfNeeded() ;

/// @brief Method Render addr 0x1fcd580 size 0xd4 virtual true final false
...
/// @brief Method .ctor addr 0x1fcd654 size 0x6c virtual false final false
 void _ctor() ;
