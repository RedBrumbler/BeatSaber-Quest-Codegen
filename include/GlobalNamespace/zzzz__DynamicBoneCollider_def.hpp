...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15926))}
...
/// @brief Method OnValidate addr 0x11b2c7c size 0x18 virtual false final false
 void OnValidate() ;

/// @brief Method Collide addr 0x11b2c94 size 0x1f4 virtual true final false
 void Collide(ByRef<UnityEngine::Vector3> particlePosition, float_t particleRadius) ;

/// @brief Method OutsideSphere addr 0x11b2e88 size 0x60 virtual false final false
...
/// @brief Method InsideSphere addr 0x11b2ee8 size 0x58 virtual false final false
...
/// @brief Method OutsideCapsule addr 0x11b2f40 size 0x174 virtual false final false
...
/// @brief Method InsideCapsule addr 0x11b30b4 size 0x15c virtual false final false
...
/// @brief Method OnDrawGizmosSelected addr 0x11b3210 size 0x19c virtual false final false
 void OnDrawGizmosSelected() ;

// Ctor Parameters []
explicit DynamicBoneCollider() ;

/// @brief Method .ctor addr 0x11b33ac size 0xc virtual false final false
 void _ctor() ;
