...
/// @brief Method get_maxPartySize addr 0x2242368 size 0x8 virtual true final true
 int32_t get_maxPartySize() ;

/// @brief Method get_discoveryPort addr 0x2242370 size 0x8 virtual true final true
 int32_t get_discoveryPort() ;

/// @brief Method get_partyPort addr 0x2242378 size 0x8 virtual true final true
 int32_t get_partyPort() ;

/// @brief Method get_multiplayerPort addr 0x2242380 size 0x8 virtual true final true
 int32_t get_multiplayerPort() ;

/// @brief Method get_masterServerEndPoint addr 0x2242388 size 0x70 virtual true final true
 GlobalNamespace::DnsEndPoint get_masterServerEndPoint() ;

/// @brief Method get_multiplayerStatusUrl addr 0x22423f8 size 0x8 virtual true final true
 ::StringW get_multiplayerStatusUrl() ;

/// @brief Method get_quickPlaySetupUrl addr 0x2242400 size 0x8 virtual true final true
 ::StringW get_quickPlaySetupUrl() ;

/// @brief Method get_graphUrl addr 0x2242408 size 0x8 virtual true final true
 ::StringW get_graphUrl() ;

/// @brief Method get_graphAccessToken addr 0x2242410 size 0x68 virtual true final true
 ::StringW get_graphAccessToken() ;

/// @brief Method get_forceGameLift addr 0x22424a4 size 0x8 virtual true final true
 bool get_forceGameLift() ;

/// @brief Method get_serviceEnvironment addr 0x22424ac size 0x8 virtual true final true
 GlobalNamespace::ServiceEnvironment get_serviceEnvironment() ;

/// @brief Method GetAppId addr 0x2242478 size 0x2c virtual false final false
 ::StringW GetAppId() ;

// Ctor Parameters []
explicit NetworkConfigSO() ;

/// @brief Method .ctor addr 0x22424b4 size 0x8c virtual false final false
 void _ctor() ;
