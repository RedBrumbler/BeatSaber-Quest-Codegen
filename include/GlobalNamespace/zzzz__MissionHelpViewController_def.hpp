...
/// @brief Method .ctor addr 0x21a9fac size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method add_didFinishEvent addr 0x21a9c7c size 0xb0 virtual false final false
 void add_didFinishEvent(System::Action_1<GlobalNamespace::MissionHelpViewController> value) ;

/// @brief Method remove_didFinishEvent addr 0x21a9d2c size 0xb0 virtual false final false
 void remove_didFinishEvent(System::Action_1<GlobalNamespace::MissionHelpViewController> value) ;

/// @brief Method Setup addr 0x21a9ddc size 0x2c virtual false final false
 void Setup(GlobalNamespace::MissionHelpSO missionHelp) ;

/// @brief Method DidActivate addr 0x21a9ed8 size 0xac virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method RefreshContent addr 0x21a9e08 size 0xd0 virtual false final false
 void RefreshContent() ;

/// @brief Method OkButtonPressed addr 0x21a9f84 size 0x20 virtual false final false
 void OkButtonPressed() ;

// Ctor Parameters []
explicit MissionHelpViewController() ;

/// @brief Method .ctor addr 0x21a9fa4 size 0x8 virtual false final false
 void _ctor() ;
