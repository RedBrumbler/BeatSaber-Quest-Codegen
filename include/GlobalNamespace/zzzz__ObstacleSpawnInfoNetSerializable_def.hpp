...
/// @brief Method Obtain addr 0x1224f10 size 0x64 virtual false final false
static GlobalNamespace::ObstacleSpawnInfoNetSerializable Obtain() ;

/// @brief Method Init addr 0x1224f74 size 0x120 virtual false final false
...
/// @brief Method .ctor addr 0x1225094 size 0x58 virtual false final false
 void _ctor() ;

/// @brief Method Serialize addr 0x12250ec size 0x104 virtual true final false
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Deserialize addr 0x12251f0 size 0x118 virtual true final false
