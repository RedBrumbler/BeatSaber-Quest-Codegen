...
/// @brief Method GetBytes addr 0xdd9480 size 0xb8 virtual false final false
 void GetBytes(::ArrayW<uint8_t> buffer, int32_t offset, int32_t length) ;

/// @brief Method GetByte addr 0xdd9598 size 0xa8 virtual false final false
 uint8_t GetByte() ;

/// @brief Method FillBuffer addr 0xdd984c size 0x114 virtual false final false
 void FillBuffer() ;

// Ctor Parameters []
explicit GlobalNamespace__SecureRandomProvider__SecureRandomState() ;

/// @brief Method .ctor addr 0xdd97a8 size 0xa4 virtual false final false
 void _ctor() ;
...
/// @brief Method GetBytes addr 0xdd93d8 size 0xa8 virtual false final false
static ::ArrayW<uint8_t> GetBytes(int32_t length) ;

/// @brief Method GetByte addr 0xdd9538 size 0x60 virtual false final false
static uint8_t GetByte() ;

/// @brief Method GetBytes addr 0xdd9640 size 0x80 virtual false final false
static void GetBytes(::ArrayW<uint8_t> buffer, int32_t offset, int32_t length) ;

/// @brief Method GetBytes addr 0xdd96c0 size 0x74 virtual false final false
