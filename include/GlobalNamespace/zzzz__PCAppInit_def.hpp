...
/// @brief Method AppStartAndMultiSceneEditorSetup addr 0x20eecec size 0x7c virtual true final false
 void AppStartAndMultiSceneEditorSetup() ;

/// @brief Method RepeatableSetup addr 0x20eed68 size 0x84 virtual true final false
 void RepeatableSetup() ;

/// @brief Method TransitionToNextScene addr 0x20eedec size 0xc0 virtual true final false
 void TransitionToNextScene() ;

/// @brief Method InstallBindings addr 0x20eeeac size 0x2e0 virtual true final false
 void InstallBindings() ;

// Ctor Parameters []
explicit PCAppInit() ;

/// @brief Method .ctor addr 0x20ef18c size 0x4 virtual false final false
 void _ctor() ;
