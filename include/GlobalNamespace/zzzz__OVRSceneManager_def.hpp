...
/// @brief Method get_List addr 0x2638950 size 0x58 virtual false final false
...
/// @brief Method .ctor addr 0x2635f80 size 0x7c virtual false final false
 void _ctor() ;
...
/// @brief Method Log addr 0x2636c6c size 0xb4 virtual false final false
 void Log(::StringW context, ::StringW message) ;

/// @brief Method LogWarning addr 0x2636d20 size 0xb4 virtual false final false
 void LogWarning(::StringW context, ::StringW message) ;

/// @brief Method LogError addr 0x2634e88 size 0xb4 virtual false final false
...
/// @brief Method Log addr 0x2638d68 size 0xb4 virtual false final false
static void Log(::StringW context, ::StringW message) ;

/// @brief Method LogWarning addr 0x2638e1c size 0xb4 virtual false final false
static void LogWarning(::StringW context, ::StringW message) ;

/// @brief Method LogError addr 0x2638ed0 size 0xb4 virtual false final false
...
/// @brief Method .ctor addr 0x2638f84 size 0x34 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2638fb8 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2638fbc size 0x21c virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.String>.get_Current addr 0x26391d8 size 0x8 virtual true final true
 ::StringW System_Collections_Generic_IEnumerator_System_String__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x26391e0 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2639220 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<System.String>.GetEnumerator addr 0x2639228 size 0xa4 virtual true final true
 System::Collections::Generic::IEnumerator_1<::StringW> System_Collections_Generic_IEnumerable_System_String__GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x26392cc size 0x4 virtual true final true
...
/// @brief Method .ctor addr 0x263863c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ProcessQueryResult>g__EnabledComponents|0 addr 0x2638644 size 0x78 virtual false final false
...
/// @brief Method get_Verbose addr 0x2634ca8 size 0x68 virtual false final false
 System::Nullable_1<GlobalNamespace::GlobalNamespace__OVRSceneManager__LogForwarder> get_Verbose() ;

/// @brief Method Awake addr 0x2634d10 size 0x178 virtual false final false
 void Awake() ;

/// @brief Method OnTrackingSpaceChanged addr 0x2634f3c size 0x4 virtual false final false
static void OnTrackingSpaceChanged(UnityEngine::Transform trackingSpace) ;

/// @brief Method Update addr 0x26350d4 size 0x4 virtual false final false
 void Update() ;

/// @brief Method UpdateAllSceneAnchors addr 0x2634f40 size 0x194 virtual false final false
static void UpdateAllSceneAnchors() ;

/// @brief Method UpdateSomeSceneAnchors addr 0x26350d8 size 0x130 virtual false final false
 void UpdateSomeSceneAnchors() ;

/// @brief Method LoadSceneModel addr 0x2635208 size 0xc virtual false final false
 bool LoadSceneModel() ;

/// @brief Method RequestSceneCapture addr 0x2635608 size 0x48 virtual false final false
 bool RequestSceneCapture() ;

/// @brief Method RequestSceneCapture addr 0x26356bc size 0x2d8 virtual false final false
 bool RequestSceneCapture(System::Collections::Generic::IEnumerable_1<::StringW> requestedAnchorClassifications) ;

/// @brief Method RequestSceneCapture addr 0x2635650 size 0x6c virtual false final false
 bool RequestSceneCapture(::StringW requestString) ;

/// @brief Method OnEnable addr 0x2635994 size 0x324 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2635cb8 size 0x2c8 virtual false final false
 void OnDisable() ;

/// @brief Method LoadSpatialEntities addr 0x2635214 size 0x3f4 virtual false final false
 bool LoadSpatialEntities() ;

/// @brief Method EnableComponentIfNecessary addr 0x2636dd4 size 0x338 virtual false final false
...
/// @brief Method OVRManager_SceneCaptureComplete addr 0x263710c size 0x114 virtual false final false
 void OVRManager_SceneCaptureComplete(uint64_t requestId, bool result) ;

/// @brief Method IsComponentEnabled addr 0x2637220 size 0x88 virtual false final false
...
/// @brief Method InstantiateSceneAnchor addr 0x26372a8 size 0x6c0 virtual false final false
...
/// @brief Method OVRManager_SpaceQueryComplete addr 0x2637968 size 0x294 virtual false final false
 void OVRManager_SpaceQueryComplete(uint64_t requestId, bool result) ;

/// @brief Method CheckForCompletion addr 0x2638488 size 0xcc virtual false final false
 void CheckForCompletion() ;

/// @brief Method OVRManager_SpaceSetComponentStatusComplete addr 0x2638554 size 0xe8 virtual false final false
...
/// @brief Method ProcessQueryResult addr 0x2637bfc size 0x88c virtual false final false
 void ProcessQueryResult(GlobalNamespace::GlobalNamespace__OVRPlugin__SpaceQueryResult queryResult) ;

// Ctor Parameters []
explicit OVRSceneManager() ;

/// @brief Method .ctor addr 0x26386c0 size 0x19c virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__28_0 addr 0x263885c size 0x60 virtual false final false
 int32_t _Awake_b__28_0(GlobalNamespace::OVRScenePlane planeA, GlobalNamespace::OVRScenePlane planeB) ;

/// @brief Method <Awake>g__TryGetUuid|28_1 addr 0x26388bc size 0x94 virtual false final false
