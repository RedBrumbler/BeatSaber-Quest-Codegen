...
/// @brief Method Swap addr 0x1fb70a0 size 0xac virtual false final false
static void Swap(System::Text::StringBuilder sb, int32_t startIndex, int32_t endIndex) ;

/// @brief Method AppendNumber addr 0x1fb714c size 0x128 virtual false final false
static void AppendNumber(System::Text::StringBuilder sb, int32_t number) ;

/// @brief Method AppendNumber addr 0x1fb7274 size 0x104 virtual false final false
