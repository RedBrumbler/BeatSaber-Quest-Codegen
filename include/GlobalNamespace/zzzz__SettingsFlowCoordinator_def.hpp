...
/// @brief Method add_didFinishEvent addr 0x217b544 size 0xb0 virtual false final false
...
/// @brief Method remove_didFinishEvent addr 0x217b5f4 size 0xb0 virtual false final false
...
/// @brief Method DidActivate addr 0x217b6a4 size 0x2b0 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x217b954 size 0x10c virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method ShowSecretViewController addr 0x217ba60 size 0x4 virtual false final false
 void ShowSecretViewController(HMUI::ViewController viewController) ;

/// @brief Method HandleDidSelectSettingsSubMenu addr 0x217baf8 size 0x6c virtual false final false
 void HandleDidSelectSettingsSubMenu(GlobalNamespace::SettingsSubMenuInfo settingsSubMenuInfo, int32_t idx) ;

/// @brief Method ReplaceViewController addr 0x217ba64 size 0x94 virtual false final false
 void ReplaceViewController(HMUI::ViewController viewController) ;

/// @brief Method HandleSettingsNavigationControllerDidFinish addr 0x217bb64 size 0x9c virtual false final false
...
/// @brief Method ApplySettings addr 0x217bc00 size 0x3c virtual false final false
 void ApplySettings() ;

/// @brief Method CancelSettings addr 0x217bc3c size 0x28 virtual false final false
 void CancelSettings() ;

// Ctor Parameters []
explicit SettingsFlowCoordinator() ;

/// @brief Method .ctor addr 0x217bc64 size 0x8 virtual false final false
 void _ctor() ;
