...
/// @brief Method .ctor addr 0x21aa3e0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <RefreshContent>b__0 addr 0x21aa410 size 0x1f0 virtual false final false
 void _RefreshContent_b__0(int32_t idx, GlobalNamespace::ObjectiveListItem objectiveListItem) ;

/// @brief Method <RefreshContent>b__1 addr 0x21aa600 size 0x7c virtual false final false
...
/// @brief Method add_didPressPlayButtonEvent addr 0x21a9fb4 size 0xb0 virtual false final false
 void add_didPressPlayButtonEvent(System::Action_1<GlobalNamespace::MissionLevelDetailViewController> value) ;

/// @brief Method remove_didPressPlayButtonEvent addr 0x21aa064 size 0xb0 virtual false final false
 void remove_didPressPlayButtonEvent(System::Action_1<GlobalNamespace::MissionLevelDetailViewController> value) ;

/// @brief Method get_missionNode addr 0x21aa114 size 0x8 virtual false final false
 GlobalNamespace::MissionNode get_missionNode() ;

/// @brief Method Setup addr 0x21aa11c size 0x2c virtual false final false
 void Setup(GlobalNamespace::MissionNode missionNode) ;

/// @brief Method DidActivate addr 0x21aa334 size 0xac virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method RefreshContent addr 0x21aa148 size 0x1ec virtual false final false
 void RefreshContent() ;

/// @brief Method PlayButtonPressed addr 0x21aa3e8 size 0x20 virtual false final false
 void PlayButtonPressed() ;

// Ctor Parameters []
explicit MissionLevelDetailViewController() ;

/// @brief Method .ctor addr 0x21aa408 size 0x8 virtual false final false
 void _ctor() ;
