...
/// @brief Method get_clipCaps addr 0x21eb2ac size 0x8 virtual true final true
 UnityEngine::Timeline::ClipCaps get_clipCaps() ;

/// @brief Method CreatePlayable addr 0x21eb2b4 size 0x13c virtual true final false
 UnityEngine::Playables::Playable CreatePlayable(UnityEngine::Playables::PlayableGraph graph, UnityEngine::GameObject go) ;

// Ctor Parameters []
explicit GhostEffectAsset() ;

/// @brief Method .ctor addr 0x21eb3f0 size 0x8 virtual false final false
 void _ctor() ;
