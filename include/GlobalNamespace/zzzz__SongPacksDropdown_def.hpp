...
/// @brief Method .ctor addr 0x2185c68 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <LazyInit>b__7_0 addr 0x2185c70 size 0xc virtual false final false
...
/// @brief Method add_didSelectCellWithIdxEvent addr 0x21855c8 size 0xb0 virtual false final false
 void add_didSelectCellWithIdxEvent(System::Action_1<int32_t> value) ;

/// @brief Method remove_didSelectCellWithIdxEvent addr 0x2185678 size 0xb0 virtual false final false
 void remove_didSelectCellWithIdxEvent(System::Action_1<int32_t> value) ;

/// @brief Method LazyInit addr 0x2185728 size 0x164 virtual false final false
 void LazyInit() ;

/// @brief Method Start addr 0x218588c size 0x94 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x2185920 size 0xd4 virtual false final false
 void OnDestroy() ;

/// @brief Method SetOverrideSongPacks addr 0x21859f4 size 0x8 virtual false final false
 void SetOverrideSongPacks(System::Collections::Generic::List_1<::StringW> songPackSerializedNames) ;

/// @brief Method GetSelectedSongPackMask addr 0x21859fc size 0x7c virtual false final false
 GlobalNamespace::SongPackMask GetSelectedSongPackMask() ;

/// @brief Method SelectCellWithSongPackMask addr 0x2185a78 size 0xb0 virtual false final false
 void SelectCellWithSongPackMask(GlobalNamespace::SongPackMask songPackMask) ;

/// @brief Method GetIdxForSongPackMask addr 0x2185b28 size 0xb0 virtual false final false
 int32_t GetIdxForSongPackMask(GlobalNamespace::SongPackMask songPackMask) ;

/// @brief Method HandleSimpleTextDropdownDidSelectCellWithIdx addr 0x2185bd8 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x2185bfc size 0x8 virtual false final false
 void _ctor() ;
