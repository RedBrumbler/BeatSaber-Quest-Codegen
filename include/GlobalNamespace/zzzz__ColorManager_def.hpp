...
/// @brief Method get_obstaclesColor addr 0x21c8d58 size 0x20 virtual false final false
 UnityEngine::Color get_obstaclesColor() ;

/// @brief Method SetColorScheme addr 0x21c8d78 size 0x8 virtual false final false
 void SetColorScheme(GlobalNamespace::ColorScheme colorScheme) ;

/// @brief Method ColorForType addr 0x21c8d80 size 0xe8 virtual false final false
 UnityEngine::Color ColorForType(GlobalNamespace::EnvironmentColorType type, bool boost) ;

/// @brief Method ColorForType addr 0x21c8e68 size 0x74 virtual false final false
 UnityEngine::Color ColorForType(GlobalNamespace::ColorType type) ;

/// @brief Method ColorForSaberType addr 0x21c8edc size 0x54 virtual false final false
 UnityEngine::Color ColorForSaberType(GlobalNamespace::SaberType type) ;

/// @brief Method EffectsColorForSaberType addr 0x21c8f30 size 0x90 virtual false final false
 UnityEngine::Color EffectsColorForSaberType(GlobalNamespace::SaberType type) ;

/// @brief Method GetObstacleEffectColor addr 0x21c8fc0 size 0x5c virtual false final false
 UnityEngine::Color GetObstacleEffectColor() ;

// Ctor Parameters []
explicit ColorManager() ;

/// @brief Method .ctor addr 0x21c901c size 0x8 virtual false final false
 void _ctor() ;
