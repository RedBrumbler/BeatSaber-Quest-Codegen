...
/// @brief Method get_bloomPrePassEffect addr 0x1fcfc04 size 0x8 virtual false final false
 GlobalNamespace::BloomPrePassEffectSO get_bloomPrePassEffect() ;

/// @brief Method Init addr 0x1fcfc0c size 0x8 virtual false final false
 void Init(GlobalNamespace::BloomPrePassEffectSO bloomPrePassEffect) ;

// Ctor Parameters []
explicit BloomPrePassEffectContainerSO() ;

/// @brief Method .ctor addr 0x1fcfc14 size 0x8 virtual false final false
 void _ctor() ;
