...
/// @brief Method get_EyeTrackingEnabled addr 0x25df268 size 0x50 virtual false final false
 bool get_EyeTrackingEnabled() ;

/// @brief Method get_Confidence addr 0x25df2b8 size 0x8 virtual false final false
 float_t get_Confidence() ;

/// @brief Method set_Confidence addr 0x25df2c0 size 0x8 virtual false final false
 void set_Confidence(float_t value) ;

/// @brief Method Awake addr 0x25df2c8 size 0x7c virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x25df344 size 0x4 virtual false final false
 void Start() ;

/// @brief Method OnEnable addr 0x25df5cc size 0x78 virtual false final false
 void OnEnable() ;

/// @brief Method OnPermissionGranted addr 0x25df71c size 0x60 virtual false final false
 void OnPermissionGranted(::StringW permissionId) ;

/// @brief Method StartEyeTracking addr 0x25df644 size 0xd8 virtual false final false
 bool StartEyeTracking() ;

/// @brief Method OnDisable addr 0x25df77c size 0x88 virtual false final false
 void OnDisable() ;

/// @brief Method OnDestroy addr 0x25df804 size 0xc virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x25df810 size 0x200 virtual false final false
 void Update() ;

/// @brief Method CalculateEyeRotation addr 0x25dfa10 size 0x1c0 virtual false final false
 UnityEngine::Quaternion CalculateEyeRotation(UnityEngine::Quaternion eyeRotation) ;

/// @brief Method PrepareHeadDirection addr 0x25df348 size 0x284 virtual false final false
 void PrepareHeadDirection() ;

// Ctor Parameters []
explicit OVREyeGaze() ;

/// @brief Method .ctor addr 0x25dfbd0 size 0x18 virtual false final false
 void _ctor() ;
