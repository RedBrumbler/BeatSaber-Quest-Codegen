...
/// @brief Method .ctor addr 0x22dd7d8 size 0x68 virtual false final false
 void _ctor(int32_t errno) ;

/// @brief Method .ctor addr 0x22dd844 size 0xc virtual false final false
 void _ctor(GlobalNamespace::GlobalNamespace__Interop__Error error) ;

/// @brief Method get_Error addr 0x22dd850 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__Interop__Error get_Error() ;

/// @brief Method get_RawErrno addr 0x22dd6a0 size 0x6c virtual false final false
 int32_t get_RawErrno() ;

/// @brief Method GetErrorMessage addr 0x22dd70c size 0x64 virtual false final false
 ::StringW GetErrorMessage() ;

/// @brief Method ToString addr 0x22dd9d0 size 0xd4 virtual true final false
 ::StringW ToString() ;
...
/// @brief Method GetName addr 0x22de3e0 size 0x164 virtual false final false
...
/// @brief Method GetLastErrorInfo addr 0x22dd51c size 0x68 virtual false final false
static GlobalNamespace::GlobalNamespace__Interop__ErrorInfo GetLastErrorInfo() ;

/// @brief Method StrError addr 0x22dd8d4 size 0xfc virtual false final false
static ::StringW StrError(int32_t platformErrno) ;

/// @brief Method ConvertErrorPlatformToPal addr 0x22dd840 size 0x4 virtual false final false
static GlobalNamespace::GlobalNamespace__Interop__Error ConvertErrorPlatformToPal(int32_t platformErrno) ;

/// @brief Method ConvertErrorPalToPlatform addr 0x22dd858 size 0x7c virtual false final false
static int32_t ConvertErrorPalToPlatform(GlobalNamespace::GlobalNamespace__Interop__Error error) ;

/// @brief Method StrErrorR addr 0x22ddaa4 size 0x4 virtual false final false
static void* StrErrorR(int32_t platformErrno, void* buffer, int32_t bufferSize) ;

/// @brief Method GetNonCryptographicallySecureRandomBytes addr 0x22dd7d4 size 0x4 virtual false final false
static void GetNonCryptographicallySecureRandomBytes(void* buffer, int32_t length) ;

/// @brief Method OpenDir addr 0x22ddaa8 size 0x34 virtual false final false
static ::cordl_internals::intptr_t OpenDir(::StringW path) ;

/// @brief Method GetReadDirRBufferSize addr 0x22ddadc size 0x4 virtual false final false
static int32_t GetReadDirRBufferSize() ;

/// @brief Method ReadDirR addr 0x22ddae0 size 0x4 virtual false final false
...
/// @brief Method CloseDir addr 0x22ddae4 size 0x1c virtual false final false
static int32_t CloseDir(::cordl_internals::intptr_t dir) ;

/// @brief Method ReadLink addr 0x22ddb00 size 0x4c virtual false final false
static int32_t ReadLink(::StringW path, ::ArrayW<uint8_t> buffer, int32_t bufferSize) ;

/// @brief Method ReadLink addr 0x22ddb4c size 0x218 virtual false final false
static ::StringW ReadLink(::StringW path) ;

/// @brief Method Stat addr 0x22ddd64 size 0x3c virtual false final false
static int32_t Stat(::StringW path, ByRef<GlobalNamespace::GlobalNamespace__Interop__Sys__FileStatus> output) ;

/// @brief Method LStat addr 0x22ddda0 size 0x3c virtual false final false
static int32_t LStat(::StringW path, ByRef<GlobalNamespace::GlobalNamespace__Interop__Sys__FileStatus> output) ;

/// @brief Method Symlink addr 0x22ddddc size 0xb8 virtual false final false
static int32_t Symlink(::StringW target, ::StringW linkPath) ;

/// @brief Method CopyFile addr 0x22dde94 size 0xb4 virtual false final false
...
/// @brief Method GetEGid addr 0x22ddf48 size 0x4 virtual false final false
static uint32_t GetEGid() ;

/// @brief Method GetEUid addr 0x22ddf4c size 0x4 virtual false final false
static uint32_t GetEUid() ;

/// @brief Method LChflagsCanSetHiddenFlag addr 0x22ddf50 size 0x4 virtual false final false
static int32_t LChflagsCanSetHiddenFlag() ;

/// @brief Method Link addr 0x22ddf54 size 0x54 virtual false final false
static int32_t Link(::StringW source, ::StringW link) ;

/// @brief Method MkDir addr 0x22ddfa8 size 0x3c virtual false final false
static int32_t MkDir(::StringW path, int32_t mode) ;

/// @brief Method Rename addr 0x22ddfe4 size 0x54 virtual false final false
static int32_t Rename(::StringW oldPath, ::StringW newPath) ;

/// @brief Method RmDir addr 0x22de038 size 0x34 virtual false final false
static int32_t RmDir(::StringW path) ;

/// @brief Method Stat addr 0x22de06c size 0x1c virtual false final false
static int32_t Stat(ByRef<uint8_t> path, ByRef<GlobalNamespace::GlobalNamespace__Interop__Sys__FileStatus> output) ;

/// @brief Method Stat addr 0x22de088 size 0x158 virtual false final false
...
/// @brief Method LStat addr 0x22de1e0 size 0x1c virtual false final false
static int32_t LStat(ByRef<uint8_t> path, ByRef<GlobalNamespace::GlobalNamespace__Interop__Sys__FileStatus> output) ;

/// @brief Method LStat addr 0x22de1fc size 0x158 virtual false final false
...
/// @brief Method Unlink addr 0x22de354 size 0x34 virtual false final false
static int32_t Unlink(::StringW pathname) ;

/// @brief Method DoubleToString addr 0x22de388 size 0x4 virtual false final false
...
/// @brief Method ThrowExceptionForIoErrno addr 0x22dcf54 size 0x58 virtual false final false
...
/// @brief Method CheckIo addr 0x22dd4a4 size 0x78 virtual false final false
...
/// @brief Method CheckIo addr 0x22dd584 size 0x20 virtual false final false
...
/// @brief Method GetExceptionForIoErrno addr 0x22dcfac size 0x4f8 virtual false final false
...
/// @brief Method GetIOException addr 0x22dd614 size 0x8c virtual false final false
static System::Exception GetIOException(GlobalNamespace::GlobalNamespace__Interop__ErrorInfo errorInfo) ;

/// @brief Method GetRandomBytes addr 0x22dd770 size 0x64 virtual false final false
