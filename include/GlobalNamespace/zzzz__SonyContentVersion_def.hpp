...
/// @brief Method get_majorVersion addr 0x22540e4 size 0x8 virtual false final false
 uint32_t get_majorVersion() ;

/// @brief Method get_minorVersion addr 0x22540ec size 0x8 virtual false final false
 uint32_t get_minorVersion() ;

/// @brief Method get_revision addr 0x22540f4 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x22540fc size 0x3c virtual false final false
 void _ctor(uint32_t majorVersion, uint32_t minorVersion, uint32_t revision) ;

/// @brief Method GetFromString addr 0x2254138 size 0x33c virtual false final false
static GlobalNamespace::SonyContentVersion GetFromString(::StringW versionString) ;

/// @brief Method IsVersionFormatValid addr 0x2254474 size 0x90 virtual false final false
static bool IsVersionFormatValid(::StringW versionString) ;

/// @brief Method Get addr 0x2254504 size 0x178 virtual false final false
