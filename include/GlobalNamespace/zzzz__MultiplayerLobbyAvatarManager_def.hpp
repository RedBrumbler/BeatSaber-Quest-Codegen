...
/// @brief Method .ctor addr 0x20fc6dc size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x20fc7d0 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x20fc7d4 size 0x120 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x20fc8f4 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x20fc8fc size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x20fc93c size 0x8 virtual true final true
...
/// @brief Method Init addr 0x20fb990 size 0x8 virtual false final false
 void Init(float_t innerCircleRadius, float_t minOuterCircleRadius) ;

/// @brief Method ActivateMultiplayerLobbyAvatarManager addr 0x20fb998 size 0x2f4 virtual false final false
 void ActivateMultiplayerLobbyAvatarManager() ;

/// @brief Method DeactivateMultiplayerLobbyAvatarManager addr 0x20fc0d0 size 0x424 virtual false final false
 void DeactivateMultiplayerLobbyAvatarManager() ;

/// @brief Method HandleLobbyStateDataModelPlayerConnected addr 0x20fc4f4 size 0x4 virtual false final false
 void HandleLobbyStateDataModelPlayerConnected(GlobalNamespace::IConnectedPlayer connectedPlayer) ;

/// @brief Method HandleLobbyStateDataModelPlayerDisconnected addr 0x20fc4f8 size 0x4 virtual false final false
 void HandleLobbyStateDataModelPlayerDisconnected(GlobalNamespace::IConnectedPlayer connectedPlayer) ;

/// @brief Method AddPlayer addr 0x20fbc8c size 0x444 virtual false final false
 void AddPlayer(GlobalNamespace::IConnectedPlayer connectedPlayer) ;

/// @brief Method RemovePlayer addr 0x20fc4fc size 0x164 virtual false final false
 void RemovePlayer(GlobalNamespace::IConnectedPlayer connectedPlayer) ;

/// @brief Method RemovePlayerAndDestroy addr 0x20fc660 size 0x7c virtual false final false
...
/// @brief Method .ctor addr 0x20fc704 size 0xcc virtual false final false
 void _ctor() ;
