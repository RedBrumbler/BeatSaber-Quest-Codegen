...
/// @brief Method .ctor addr 0x21186f8 size 0x3c virtual false final false
...
/// @brief Method get_songTime addr 0x2118ca8 size 0x8 virtual true final true
 float_t get_songTime() ;

/// @brief Method set_songTime addr 0x2118cb0 size 0x8 virtual false final false
 void set_songTime(float_t value) ;

/// @brief Method get_lastFrameDeltaSongTime addr 0x2118cb8 size 0x8 virtual true final true
 float_t get_lastFrameDeltaSongTime() ;

/// @brief Method set_lastFrameDeltaSongTime addr 0x2118cc0 size 0x8 virtual false final false
 void set_lastFrameDeltaSongTime(float_t value) ;

/// @brief Method get_songEndTime addr 0x2118cc8 size 0xc virtual true final true
 float_t get_songEndTime() ;

/// @brief Method get_songLength addr 0x2118cd4 size 0xc virtual true final true
 float_t get_songLength() ;

/// @brief Method get_isReady addr 0x2118ce0 size 0x8 virtual true final true
 bool get_isReady() ;

/// @brief Method Start addr 0x2118ce8 size 0xc virtual false final false
 void Start() ;

/// @brief Method Update addr 0x2118cf4 size 0x14c virtual false final false
 void Update() ;

/// @brief Method StartSong addr 0x2116e00 size 0x124 virtual false final false
 void StartSong(float_t songStartSyncTime) ;

/// @brief Method SetConnectedPlayerSongTime addr 0x2118e40 size 0x14 virtual false final false
 void SetConnectedPlayerSongTime(float_t syncTime, float_t songTime) ;

/// @brief Method StopSong addr 0x21170a0 size 0xc virtual false final false
 void StopSong() ;

// Ctor Parameters []
explicit MultiplayerConnectedPlayerSongTimeSyncController() ;

/// @brief Method .ctor addr 0x2118e54 size 0x14 virtual false final false
 void _ctor() ;
