...
/// @brief Method add_menuButtonTriggeredEvent addr 0x2105f08 size 0x9c virtual true final true
 void add_menuButtonTriggeredEvent(System::Action value) ;

/// @brief Method remove_menuButtonTriggeredEvent addr 0x2105fa4 size 0x9c virtual true final true
 void remove_menuButtonTriggeredEvent(System::Action value) ;

/// @brief Method Tick addr 0x2106040 size 0xcc virtual true final true
 void Tick() ;

// Ctor Parameters []
explicit InstantMenuButtonTrigger() ;

/// @brief Method .ctor addr 0x210610c size 0x8 virtual false final false
 void _ctor() ;
