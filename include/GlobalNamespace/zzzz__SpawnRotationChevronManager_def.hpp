...
/// @brief Method .ctor addr 0x22a56ac size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Start addr 0x22a453c size 0x170 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x22a47f0 size 0xa64 virtual false final false
 void Update() ;

/// @brief Method OnDestroy addr 0x22a5254 size 0xfc virtual false final false
 void OnDestroy() ;

/// @brief Method HandleBeatmapObjectCallback addr 0x22a5350 size 0x35c virtual false final false
 void HandleBeatmapObjectCallback(GlobalNamespace::BeatmapObjectData beatmapObjectData) ;

/// @brief Method HandleSpawnRotationBeatmapEvent addr 0x22a56b4 size 0x1c virtual false final false
 void HandleSpawnRotationBeatmapEvent(GlobalNamespace::SpawnRotationBeatmapEventData beatmapEventData) ;

/// @brief Method HandleBeatmapObjectSpawnControllerDidInit addr 0x22a46ac size 0x144 virtual false final false
 void HandleBeatmapObjectSpawnControllerDidInit() ;

/// @brief Method ComputeAheadTime addr 0x22a56d0 size 0x5c virtual false final false
 float_t ComputeAheadTime() ;

// Ctor Parameters []
explicit SpawnRotationChevronManager() ;

/// @brief Method .ctor addr 0x22a572c size 0x14 virtual false final false
 void _ctor() ;
