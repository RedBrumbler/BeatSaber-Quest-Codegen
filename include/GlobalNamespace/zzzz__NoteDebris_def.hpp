...
/// @brief Method get_didFinishEvent addr 0x22794f0 size 0x8 virtual false final false
 GlobalNamespace::ILazyCopyHashSet_1<GlobalNamespace::INoteDebrisDidFinishEvent> get_didFinishEvent() ;

/// @brief Method Awake addr 0x22794f8 size 0x98 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x2279590 size 0x27c virtual false final false
 void Update() ;

/// @brief Method Init addr 0x227980c size 0x570 virtual false final false
...
/// @brief Method .ctor addr 0x2279d7c size 0xa4 virtual false final false
 void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 2724 }), TypeDefinitionIndex(TypeDefinitionIndex(11011)), TypeDefinitionIndex(TypeDefinitionIndex(4892))}
...
/// @brief Method .ctor addr 0x2279f1c size 0x48 virtual false final false
 void _ctor() ;
