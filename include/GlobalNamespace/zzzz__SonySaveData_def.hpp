...
/// @brief Method RegisterForTicking addr 0x1fb9470 size 0x20 virtual false final false
 void RegisterForTicking(Zenject::TickableManager tickableManager) ;

/// @brief Method Initialize addr 0x1fb9490 size 0x4 virtual false final false
static void Initialize() ;

/// @brief Method Save addr 0x1fb9494 size 0x28 virtual true final true
 void Save(::StringW key, ::StringW value) ;

/// @brief Method Load addr 0x1fb94bc size 0x80 virtual true final true
 bool Load(::StringW key, ByRef<::StringW> value) ;

/// @brief Method Save addr 0x1fb953c size 0x28 virtual true final true
 void Save(::StringW key, ::StringW value, ::StringW tempKey, ::StringW backupKey) ;

/// @brief Method Load addr 0x1fb9564 size 0x4 virtual true final true
 bool Load(::StringW key, ByRef<::StringW> value, ::StringW backupKey) ;

/// @brief Method Delete addr 0x1fb9568 size 0x24 virtual true final true
 void Delete(::StringW key) ;

/// @brief Method HasKey addr 0x1fb958c size 0xc virtual true final true
 bool HasKey(::StringW key) ;

/// @brief Method Tick addr 0x1fb9598 size 0x18 virtual true final true
 void Tick() ;

// Ctor Parameters []
explicit SonySaveData() ;

/// @brief Method .ctor addr 0x1fb95b0 size 0x8 virtual false final false
 void _ctor() ;
