...
/// @brief Method get_defaultColor addr 0x20fab70 size 0xc virtual false final false
 UnityEngine::Color get_defaultColor() ;

/// @brief Method get_darkerColorMultiplier addr 0x20fab7c size 0x8 virtual false final false
 float_t get_darkerColorMultiplier() ;

/// @brief Method get_whiteBoost addr 0x20fab84 size 0x8 virtual false final false
 float_t get_whiteBoost() ;

// Ctor Parameters []
explicit GlobalNamespace__MulticolorAvatarPartPropertyBlockSetter__ColorData() ;

/// @brief Method .ctor addr 0x20fab8c size 0x24 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x20fac14 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <OnValidate>b__10_0 addr 0x20fac1c size 0x1c virtual false final false
...
/// @brief Method OnValidate addr 0x20fa808 size 0x188 virtual false final false
 void OnValidate() ;

/// @brief Method SetColors addr 0x20fa2d0 size 0x1d0 virtual false final false
 void SetColors(::ArrayW<UnityEngine::Color> colors) ;

/// @brief Method SetHighlight addr 0x20fa5b8 size 0x10 virtual false final false
 void SetHighlight(bool highlighted, int32_t uvSegment) ;

/// @brief Method UpdateRenderer addr 0x20fa990 size 0x178 virtual false final false
 void UpdateRenderer() ;

// Ctor Parameters []
explicit MulticolorAvatarPartPropertyBlockSetter() ;

/// @brief Method .ctor addr 0x20fab08 size 0x68 virtual false final false
 void _ctor() ;
