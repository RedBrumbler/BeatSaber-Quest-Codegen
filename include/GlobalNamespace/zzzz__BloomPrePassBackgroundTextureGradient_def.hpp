...
/// @brief Method get_tintColor addr 0x1fcf584 size 0xc virtual false final false
 UnityEngine::Color get_tintColor() ;

/// @brief Method set_tintColor addr 0x1fcf590 size 0xc virtual false final false
 void set_tintColor(UnityEngine::Color value) ;

/// @brief Method InitIfNeeded addr 0x1fcf59c size 0x22c virtual false final false
 void InitIfNeeded() ;

/// @brief Method Start addr 0x1fcf7c8 size 0x4 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x1fcf858 size 0x24 virtual false final false
 void OnDestroy() ;
...
/// @brief Method OnValidate addr 0x1fcf87c size 0xa8 virtual true final false
 void OnValidate() ;

/// @brief Method UpdateGradientTexture addr 0x1fcf7cc size 0x8c virtual false final false
 void UpdateGradientTexture() ;

/// @brief Method Render addr 0x1fcf950 size 0x1b8 virtual true final false
...
/// @brief Method .ctor addr 0x1fcdb78 size 0x60 virtual false final false
 void _ctor() ;
