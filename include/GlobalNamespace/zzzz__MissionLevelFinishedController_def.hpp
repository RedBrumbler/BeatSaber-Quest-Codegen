...
/// @brief Method Start addr 0x210ba38 size 0xf0 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x210bb28 size 0x108 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleLevelFinished addr 0x210bc30 size 0x4 virtual false final false
 void HandleLevelFinished() ;

/// @brief Method StartLevelFinished addr 0x210bc34 size 0xb0 virtual false final false
 void StartLevelFinished() ;

// Ctor Parameters []
explicit MissionLevelFinishedController() ;

/// @brief Method .ctor addr 0x210bce4 size 0x8 virtual false final false
 void _ctor() ;
