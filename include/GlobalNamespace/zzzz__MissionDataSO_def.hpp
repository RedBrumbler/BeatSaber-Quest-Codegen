...
/// @brief Method get_missionObjectives addr 0x222a574 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::MissionObjective> get_missionObjectives() ;

/// @brief Method get_level addr 0x222a57c size 0x8 virtual false final false
 GlobalNamespace::BeatmapLevelSO get_level() ;

/// @brief Method get_beatmapCharacteristic addr 0x222a584 size 0x8 virtual false final false
 GlobalNamespace::BeatmapCharacteristicSO get_beatmapCharacteristic() ;

/// @brief Method get_beatmapDifficulty addr 0x222a58c size 0x8 virtual false final false
 GlobalNamespace::BeatmapDifficulty get_beatmapDifficulty() ;

/// @brief Method get_gameplayModifiers addr 0x222a594 size 0x8 virtual false final false
 GlobalNamespace::GameplayModifiers get_gameplayModifiers() ;

/// @brief Method get_missionHelp addr 0x222a59c size 0x8 virtual false final false
 GlobalNamespace::MissionHelpSO get_missionHelp() ;

/// @brief Method OnValidate addr 0x222a5a4 size 0x94 virtual false final false
 void OnValidate() ;

// Ctor Parameters []
explicit MissionDataSO() ;

/// @brief Method .ctor addr 0x222a638 size 0x8 virtual false final false
 void _ctor() ;
