...
/// @brief Method Awake addr 0x264fce0 size 0x1e4 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x264fec4 size 0xb8 virtual false final false
 void Update() ;

/// @brief Method OnDestroy addr 0x26505cc size 0x8 virtual false final false
 void OnDestroy() ;

/// @brief Method InitUIComponents addr 0x264ff7c size 0x3b4 virtual false final false
 void InitUIComponents() ;

/// @brief Method UpdateVariable addr 0x2650364 size 0x38 virtual false final false
 void UpdateVariable() ;

/// @brief Method UpdateStrings addr 0x265039c size 0x230 virtual false final false
 void UpdateStrings() ;

/// @brief Method RiftPresentGUI addr 0x2650d7c size 0x184 virtual false final false
 void RiftPresentGUI(UnityEngine::GameObject guiMainOBj) ;

/// @brief Method UpdateDeviceDetection addr 0x2650330 size 0x34 virtual false final false
 void UpdateDeviceDetection() ;

/// @brief Method VariableObjectManager addr 0x26505d4 size 0x1ac virtual false final false
...
/// @brief Method ComponentComposition addr 0x2650f00 size 0x338 virtual false final false
 UnityEngine::GameObject ComponentComposition(UnityEngine::GameObject GO) ;

/// @brief Method UpdateIPD addr 0x2650780 size 0xcc virtual false final false
 void UpdateIPD() ;

/// @brief Method UpdateEyeHeightOffset addr 0x265084c size 0xc0 virtual false final false
 void UpdateEyeHeightOffset() ;

/// @brief Method UpdateEyeDepthOffset addr 0x265090c size 0xc0 virtual false final false
 void UpdateEyeDepthOffset() ;

/// @brief Method UpdateFOV addr 0x26509cc size 0x100 virtual false final false
 void UpdateFOV() ;

/// @brief Method UpdateResolutionEyeTexture addr 0x2650acc size 0x1cc virtual false final false
 void UpdateResolutionEyeTexture() ;

/// @brief Method UpdateLatencyValues addr 0x2650c98 size 0x4 virtual false final false
 void UpdateLatencyValues() ;

/// @brief Method UpdateFPS addr 0x2650c9c size 0xe0 virtual false final false
 void UpdateFPS() ;

// Ctor Parameters []
explicit OVRDebugInfo() ;

/// @brief Method .ctor addr 0x2651238 size 0x18 virtual false final false
 void _ctor() ;
