...
/// @brief Method get_progressActivities addr 0x2253fe8 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::ProgressActivitySO> get_progressActivities() ;

/// @brief Method get_competetiveActivities addr 0x2253ff0 size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::CompetetiveActivitySO> get_competetiveActivities() ;

// Ctor Parameters []
explicit PS5ActivityIdsModelSO() ;

/// @brief Method .ctor addr 0x2253ff8 size 0x8 virtual false final false
 void _ctor() ;
