...
/// @brief Method Write addr 0x214cb40 size 0x88 virtual false final false
static void Write(System::IO::BinaryWriter binaryWriter, UnityEngine::Color color) ;

/// @brief Method ReadColor addr 0x214cbc8 size 0x90 virtual false final false
static UnityEngine::Color ReadColor(System::IO::BinaryReader binaryReader) ;

/// @brief Method Write addr 0x214cc58 size 0x64 virtual false final false
static void Write(System::IO::BinaryWriter binaryWriter, UnityEngine::Vector3 vector) ;

/// @brief Method ReadVector3 addr 0x214ccbc size 0x6c virtual false final false
static UnityEngine::Vector3 ReadVector3(System::IO::BinaryReader binaryReader) ;

/// @brief Method Write addr 0x214cd28 size 0x88 virtual false final false
static void Write(System::IO::BinaryWriter binaryWriter, UnityEngine::Quaternion quaternion) ;

/// @brief Method ReadQuaternion addr 0x214cdb0 size 0x90 virtual false final false
static UnityEngine::Quaternion ReadQuaternion(System::IO::BinaryReader binaryReader) ;

/// @brief Method Write addr 0x214ce40 size 0x34 virtual false final false
static void Write(System::IO::BinaryWriter binaryWriter, UnityEngine::Pose pose) ;

/// @brief Method ReadPose addr 0x214ce74 size 0x84 virtual false final false
