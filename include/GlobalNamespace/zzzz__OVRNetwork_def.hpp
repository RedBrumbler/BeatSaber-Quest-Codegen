...
/// @brief Method ToBytes addr 0x265af44 size 0x120 virtual false final false
 ::ArrayW<uint8_t> ToBytes() ;

/// @brief Method FromBytes addr 0x265b064 size 0x130 virtual false final false
...
/// @brief Method StartListening addr 0x265b194 size 0x528 virtual false final false
 void StartListening(int32_t listeningPort) ;

/// @brief Method StopListening addr 0x265b6bc size 0x1c0 virtual false final false
 void StopListening() ;

/// @brief Method DoAcceptTcpClientCallback addr 0x265b87c size 0x54c virtual false final false
 void DoAcceptTcpClientCallback(System::IAsyncResult ar) ;

/// @brief Method HasConnectedClient addr 0x265bdc8 size 0x254 virtual false final false
 bool HasConnectedClient() ;

/// @brief Method Broadcast addr 0x265c01c size 0x5b0 virtual false final false
 void Broadcast(int32_t payloadType, ::ArrayW<uint8_t> payload) ;

/// @brief Method DoWriteDataCallback addr 0x265c5cc size 0xf4 virtual false final false
 void DoWriteDataCallback(System::IAsyncResult ar) ;

// Ctor Parameters []
explicit GlobalNamespace__OVRNetwork__OVRNetworkTcpServer() ;

/// @brief Method .ctor addr 0x265c6c0 size 0xac virtual false final false
 void _ctor() ;
...
/// @brief Method get_connectionState addr 0x265c76c size 0x28 virtual false final false
 GlobalNamespace::GlobalNamespace__OVRNetwork__OVRNetworkTcpClient__ConnectionState get_connectionState() ;

/// @brief Method get_Connected addr 0x265c794 size 0x14 virtual false final false
 bool get_Connected() ;

/// @brief Method Connect addr 0x265c7a8 size 0x17c virtual false final false
 void Connect(int32_t listeningPort) ;

/// @brief Method ConnectCallback addr 0x265c924 size 0x300 virtual false final false
 void ConnectCallback(System::IAsyncResult ar) ;

/// @brief Method Disconnect addr 0x265cc24 size 0x238 virtual false final false
 void Disconnect() ;

/// @brief Method Tick addr 0x265ce5c size 0x218 virtual false final false
 void Tick() ;

/// @brief Method OnReadDataCallback addr 0x265d074 size 0x4dc virtual false final false
 void OnReadDataCallback(System::IAsyncResult ar) ;

// Ctor Parameters []
explicit GlobalNamespace__OVRNetwork__OVRNetworkTcpClient() ;

/// @brief Method .ctor addr 0x265d550 size 0x134 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x265af3c size 0x8 virtual false final false
 void _ctor() ;
