...
/// @brief Method CellSize addr 0x21c6204 size 0x8 virtual true final true
 float_t CellSize() ;

/// @brief Method NumberOfCells addr 0x21c620c size 0xa0 virtual true final true
 int32_t NumberOfCells() ;

/// @brief Method CellForIdx addr 0x21c62ac size 0x1d0 virtual true final true
 HMUI::TableCell CellForIdx(HMUI::TableView tableView, int32_t idx) ;

/// @brief Method SetData addr 0x21c647c size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x21c64a8 size 0x14 virtual false final false
 void _ctor() ;
