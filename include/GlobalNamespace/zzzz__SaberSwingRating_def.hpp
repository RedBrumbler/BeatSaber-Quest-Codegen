...
/// @brief Method NormalRating addr 0x21f7758 size 0x2c virtual false final false
static float_t NormalRating(float_t normalDiff) ;

/// @brief Method BeforeCutStepRating addr 0x21f771c size 0x3c virtual false final false
static float_t BeforeCutStepRating(float_t angleDiff, float_t normalDiff) ;

/// @brief Method AfterCutStepRating addr 0x21f7784 size 0x3c virtual false final false
