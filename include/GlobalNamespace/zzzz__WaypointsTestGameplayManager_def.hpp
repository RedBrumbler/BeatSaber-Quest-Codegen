...
/// @brief Method Start addr 0x22ac6cc size 0x34 virtual false final false
 void Start() ;

/// @brief Method LateUpdate addr 0x22ac700 size 0x1200 virtual false final false
 void LateUpdate() ;

/// @brief Method OnDestroy addr 0x22adb70 size 0x550 virtual false final false
 void OnDestroy() ;

/// @brief Method GetBar addr 0x22ad900 size 0x270 virtual false final false
 ::StringW GetBar(float_t songTime) ;

/// @brief Method OnDrawGizmos addr 0x22ae0c0 size 0x1d4 virtual false final false
 void OnDrawGizmos() ;

// Ctor Parameters []
explicit WaypointsTestGameplayManager() ;

/// @brief Method .ctor addr 0x22ae294 size 0x20 virtual false final false
 void _ctor() ;
