...
/// @brief Method FillLevelCompletionResults addr 0x2141370 size 0x250 virtual false final false
...
/// @brief Method .ctor addr 0x21415f8 size 0x8 virtual false final false
 void _ctor() ;
