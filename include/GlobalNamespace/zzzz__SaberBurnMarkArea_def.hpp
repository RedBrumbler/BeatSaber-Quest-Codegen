...
/// @brief Method Start addr 0x228cd18 size 0x8b8 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x228d5d0 size 0x224 virtual false final false
 void OnDestroy() ;

/// @brief Method OnEnable addr 0x228d7f4 size 0x120 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x228d914 size 0x120 virtual false final false
 void OnDisable() ;

/// @brief Method GetBurnMarkPos addr 0x228da34 size 0x244 virtual false final false
...
/// @brief Method WorldToCameraBurnMarkPos addr 0x228dc78 size 0x100 virtual false final false
 UnityEngine::Vector3 WorldToCameraBurnMarkPos(UnityEngine::Vector3 pos) ;

/// @brief Method LateUpdate addr 0x228dd78 size 0x6c0 virtual false final false
 void LateUpdate() ;

// Ctor Parameters []
explicit SaberBurnMarkArea() ;

/// @brief Method .ctor addr 0x228e438 size 0x7c virtual false final false
 void _ctor() ;
