...
/// @brief Method .ctor addr 0x2125210 size 0x28 virtual false final false
...
/// @brief Method Init addr 0x2126f84 size 0x4 virtual true final false
 void Init() ;

/// @brief Method Tick addr 0x2126f88 size 0x168 virtual true final false
 void Tick() ;
