...
/// @brief Method Awake addr 0x2277d1c size 0xd0 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x2277dec size 0x104 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleNoteControllerDidInit addr 0x2277ef0 size 0x74 virtual true final true
 void HandleNoteControllerDidInit(GlobalNamespace::NoteControllerBase noteController) ;

// Ctor Parameters []
explicit NoteBigCuttableColliderSize() ;

/// @brief Method .ctor addr 0x2277f64 size 0x8 virtual false final false
 void _ctor() ;
