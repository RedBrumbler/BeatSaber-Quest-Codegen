...
/// @brief Method Awake addr 0x227f514 size 0xec virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x227f600 size 0x134 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleObstacleDidInitEvent addr 0x227f734 size 0x30 virtual false final false
 void HandleObstacleDidInitEvent(GlobalNamespace::ObstacleControllerBase obstacleController) ;

/// @brief Method HandleObcstacleDidStartDissolvingEvent addr 0x227f764 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x227f7dc size 0x8 virtual false final false
 void _ctor() ;
