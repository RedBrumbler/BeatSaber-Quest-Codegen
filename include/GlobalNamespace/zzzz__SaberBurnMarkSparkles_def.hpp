...
/// @brief Method Start addr 0x228e4b4 size 0x494 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x228e948 size 0xe8 virtual false final false
 void OnDestroy() ;

/// @brief Method OnEnable addr 0x228ea30 size 0xd4 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x228eb04 size 0xd4 virtual false final false
 void OnDisable() ;

/// @brief Method GetBurnMarkPos addr 0x228ebd8 size 0x20c virtual false final false
...
/// @brief Method LateUpdate addr 0x228ede4 size 0x6a0 virtual false final false
 void LateUpdate() ;

// Ctor Parameters []
explicit SaberBurnMarkSparkles() ;

/// @brief Method .ctor addr 0x228f484 size 0x8 virtual false final false
 void _ctor() ;
