...
/// @brief Method .ctor addr 0x25e0490 size 0x24 virtual false final false
 void _ctor(::ArrayW<float_t> array) ;

/// @brief Method MoveNext addr 0x25e05bc size 0x1c virtual true final true
 bool MoveNext() ;

/// @brief Method get_Current addr 0x25e05d8 size 0x34 virtual true final true
 float_t get_Current() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x25e060c size 0x60 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method Reset addr 0x25e066c size 0xc virtual true final true
 void Reset() ;

/// @brief Method Dispose addr 0x25e0678 size 0x4 virtual true final true
 void Dispose() ;
...
/// @brief Method get_FaceTrackingEnabled addr 0x25dfbe8 size 0x50 virtual false final false
 bool get_FaceTrackingEnabled() ;

/// @brief Method get_ValidExpressions addr 0x25dfc38 size 0x8 virtual false final false
 bool get_ValidExpressions() ;

/// @brief Method set_ValidExpressions addr 0x25dfc40 size 0xc virtual false final false
 void set_ValidExpressions(bool value) ;

/// @brief Method get_EyeFollowingBlendshapesValid addr 0x25dfc4c size 0x8 virtual false final false
 bool get_EyeFollowingBlendshapesValid() ;

/// @brief Method set_EyeFollowingBlendshapesValid addr 0x25dfc54 size 0xc virtual false final false
 void set_EyeFollowingBlendshapesValid(bool value) ;

/// @brief Method Awake addr 0x25dfc60 size 0x7c virtual false final false
 void Awake() ;

/// @brief Method OnEnable addr 0x25dfcdc size 0x78 virtual false final false
 void OnEnable() ;

/// @brief Method OnPermissionGranted addr 0x25dfe2c size 0x60 virtual false final false
 void OnPermissionGranted(::StringW permissionId) ;

/// @brief Method StartFaceTracking addr 0x25dfd54 size 0xd8 virtual false final false
 bool StartFaceTracking() ;

/// @brief Method OnDisable addr 0x25dfe8c size 0x88 virtual false final false
 void OnDisable() ;

/// @brief Method OnDestroy addr 0x25dff14 size 0xc virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x25dff20 size 0x94 virtual false final false
 void Update() ;

/// @brief Method get_Item addr 0x25dffb4 size 0x100 virtual false final false
 float_t get_Item(GlobalNamespace::GlobalNamespace__OVRFaceExpressions__FaceExpression expression) ;

/// @brief Method TryGetFaceExpressionWeight addr 0x25e0114 size 0x54 virtual false final false
...
/// @brief Method TryGetWeightConfidence addr 0x25e0168 size 0x54 virtual false final false
...
/// @brief Method CheckValidity addr 0x25e00b4 size 0x60 virtual false final false
 void CheckValidity() ;

/// @brief Method CopyTo addr 0x25e01bc size 0x250 virtual false final false
 void CopyTo(::ArrayW<float_t> array, int32_t startIndex) ;

/// @brief Method ToArray addr 0x25e040c size 0x64 virtual false final false
 ::ArrayW<float_t> ToArray() ;

/// @brief Method GetEnumerator addr 0x25e0470 size 0x20 virtual false final false
 GlobalNamespace::GlobalNamespace__OVRFaceExpressions__FaceExpressionsEnumerator GetEnumerator() ;

/// @brief Method System.Collections.Generic.IEnumerable<System.Single>.GetEnumerator addr 0x25e04b4 size 0x74 virtual true final true
 System::Collections::Generic::IEnumerator_1<float_t> System_Collections_Generic_IEnumerable_System_Single__GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x25e0528 size 0x74 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method get_Count addr 0x25e059c size 0x18 virtual true final true
 int32_t get_Count() ;

// Ctor Parameters []
explicit OVRFaceExpressions() ;

/// @brief Method .ctor addr 0x25e05b4 size 0x8 virtual false final false
 void _ctor() ;
