...
/// @brief Method .ctor addr 0x222aafc size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x222aaf4 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get__minimumAppVersion addr 0x222aa94 size 0x8 virtual false final false
 ::StringW get__minimumAppVersion() ;

/// @brief Method set__minimumAppVersion addr 0x222aa9c size 0x8 virtual false final false
 void set__minimumAppVersion(::StringW value) ;

/// @brief Method get__maintenanceStartTime addr 0x222aaa4 size 0x8 virtual false final false
 int64_t get__maintenanceStartTime() ;

/// @brief Method set__maintenanceStartTime addr 0x222aaac size 0x8 virtual false final false
 void set__maintenanceStartTime(int64_t value) ;

/// @brief Method get__userMessage addr 0x222aab4 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__MultiplayerStatusData__UserMessage get__userMessage() ;

/// @brief Method set__userMessage addr 0x222aabc size 0x8 virtual false final false
 void set__userMessage(GlobalNamespace::GlobalNamespace__MultiplayerStatusData__UserMessage value) ;

/// @brief Method get__useGamelift addr 0x222aac4 size 0x8 virtual false final false
 bool get__useGamelift() ;

/// @brief Method set__useGamelift addr 0x222aacc size 0xc virtual false final false
 void set__useGamelift(bool value) ;

/// @brief Method get__useXPlatformAuth addr 0x222aad8 size 0x8 virtual false final false
 bool get__useXPlatformAuth() ;

/// @brief Method set__useXPlatformAuth addr 0x222aae0 size 0xc virtual false final false
