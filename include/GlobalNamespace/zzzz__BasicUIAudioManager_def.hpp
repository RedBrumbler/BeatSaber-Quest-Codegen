...
/// @brief Method Start addr 0x2153e8c size 0x98 virtual false final false
 void Start() ;

/// @brief Method OnEnable addr 0x2153f24 size 0xd4 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x2153ff8 size 0xd4 virtual false final false
 void OnDisable() ;

/// @brief Method HandleButtonClickEvent addr 0x21540cc size 0xd0 virtual false final false
 void HandleButtonClickEvent() ;

// Ctor Parameters []
explicit BasicUIAudioManager() ;

/// @brief Method .ctor addr 0x215419c size 0x10 virtual false final false
 void _ctor() ;
