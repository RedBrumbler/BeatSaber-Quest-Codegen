...
/// @brief Method OnTriggerEnter addr 0x1fb7ce4 size 0x1c virtual false final false
 void OnTriggerEnter(UnityEngine::Collider other) ;

/// @brief Method OnTriggerExit addr 0x1fb7d00 size 0x1c virtual false final false
 void OnTriggerExit(UnityEngine::Collider other) ;

/// @brief Method OnTriggerStay addr 0x1fb7d1c size 0x1c virtual false final false
 void OnTriggerStay(UnityEngine::Collider other) ;

// Ctor Parameters []
explicit TriggerChecker() ;

/// @brief Method .ctor addr 0x1fb7d38 size 0x8 virtual false final false
 void _ctor() ;
