...
/// @brief Method get_endPoint addr 0xdb5a14 size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0xdb48a4 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0xdb5a88 size 0xb4 virtual false final false
 void _ctor(System::Net::IPEndPoint endPoint) ;

/// @brief Method GetEndPointAsync addr 0xdb5b3c size 0x120 virtual false final false
 System::Threading::Tasks::Task_1<System::Net::IPEndPoint> GetEndPointAsync(BGNet::Core::ITaskUtility taskUtility) ;

/// @brief Method GetEndPoint addr 0xdb5c5c size 0x94 virtual false final false
 System::Net::IPEndPoint GetEndPoint() ;

/// @brief Method GetEndPointInternal addr 0xdb5cf0 size 0xb0 virtual false final false
 System::Net::IPEndPoint GetEndPointInternal() ;

/// @brief Method ToString addr 0xdb5da0 size 0x8c virtual true final false
 ::StringW ToString() ;

/// @brief Method Equals addr 0xdb5e2c size 0xa0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0xdb5ecc size 0x4c virtual true final true
 bool Equals(GlobalNamespace::DnsEndPoint other) ;

/// @brief Method GetHashCode addr 0xdb5f18 size 0x2c virtual true final false
 int32_t GetHashCode() ;
