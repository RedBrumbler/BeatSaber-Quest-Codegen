...
/// @brief Method get_clipCaps addr 0x21ebba4 size 0x8 virtual true final true
 UnityEngine::Timeline::ClipCaps get_clipCaps() ;

/// @brief Method CreatePlayable addr 0x21ebbac size 0x1c4 virtual true final false
 UnityEngine::Playables::Playable CreatePlayable(UnityEngine::Playables::PlayableGraph graph, UnityEngine::GameObject go) ;

// Ctor Parameters []
explicit SinglePositionTween() ;

/// @brief Method .ctor addr 0x21ebd70 size 0x8 virtual false final false
 void _ctor() ;
