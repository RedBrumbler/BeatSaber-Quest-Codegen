...
/// @brief Method Start addr 0x20f25d0 size 0x478 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x20f2a48 size 0x254 virtual false final false
 void OnDestroy() ;

/// @brief Method Update addr 0x20f2c9c size 0x2a8 virtual false final false
 void Update() ;

/// @brief Method LevelWillFinishWithinAheadTime addr 0x20f2f44 size 0x5c virtual false final false
 void LevelWillFinishWithinAheadTime() ;

/// @brief Method HandleLevelFailed addr 0x20f2fa0 size 0x90 virtual false final false
 void HandleLevelFailed() ;

/// @brief Method HandleGamePauseDidResume addr 0x20f3030 size 0x24 virtual false final false
 void HandleGamePauseDidResume() ;

/// @brief Method HandleGamePauseDidPause addr 0x20f3054 size 0x24 virtual false final false
 void HandleGamePauseDidPause() ;

// Ctor Parameters []
explicit EnvironmentStartEndSongAudioEffect() ;

/// @brief Method .ctor addr 0x20f3078 size 0x14 virtual false final false
 void _ctor() ;
