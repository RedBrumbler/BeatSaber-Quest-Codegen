...
/// @brief Method .ctor addr 0x21c38f8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SetGameplayModifiers>b__0 addr 0x21c3908 size 0x7c virtual false final false
...
/// @brief Method SetGameplayModifiers addr 0x21c378c size 0x16c virtual true final false
 void SetGameplayModifiers(GlobalNamespace::GameplayModifiers gameplayModifiers) ;

// Ctor Parameters []
explicit ModifiersSelectionView() ;

/// @brief Method .ctor addr 0x21c3900 size 0x8 virtual false final false
 void _ctor() ;
