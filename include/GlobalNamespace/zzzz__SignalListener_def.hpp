...
/// @brief Method OnEnable addr 0x1fbebe0 size 0x94 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fbec74 size 0x88 virtual false final false
 void OnDisable() ;

/// @brief Method HandleEvent addr 0x1fbecfc size 0x1c virtual false final false
 void HandleEvent() ;

// Ctor Parameters []
explicit SignalListener() ;

/// @brief Method .ctor addr 0x1fbed18 size 0x8 virtual false final false
 void _ctor() ;
