...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5550), inst: 898 }), TypeDefinitionIndex(TypeDefinitionIndex(12407)), TypeDefinitionIndex(TypeDefinitionIndex(5550))}
...
/// @brief Method get_transition addr 0x21603bc size 0x8 virtual true final false
 GlobalNamespace::BaseTransitionSO get_transition() ;

/// @brief Method TransitionToNormalState addr 0x21603c4 size 0x2c virtual true final false
 void TransitionToNormalState() ;

/// @brief Method TransitionToHighlightedState addr 0x2160628 size 0x2c virtual true final false
 void TransitionToHighlightedState() ;

/// @brief Method TransitionToPressedState addr 0x2160654 size 0x2c virtual true final false
 void TransitionToPressedState() ;

/// @brief Method TransitionToDisabledState addr 0x2160680 size 0x2c virtual true final false
 void TransitionToDisabledState() ;

/// @brief Method TransitionToSelectedState addr 0x21606ac size 0x2c virtual true final false
 void TransitionToSelectedState() ;

/// @brief Method TransitionToSelectedAndHighlightedState addr 0x21606d8 size 0x2c virtual true final false
 void TransitionToSelectedAndHighlightedState() ;

/// @brief Method SetNormalState addr 0x2160704 size 0x3c virtual true final false
 void SetNormalState() ;

/// @brief Method SetHighlightedState addr 0x2160740 size 0x3c virtual true final false
 void SetHighlightedState() ;

/// @brief Method SetPressedState addr 0x216077c size 0x3c virtual true final false
 void SetPressedState() ;

/// @brief Method SetDisabledState addr 0x21607b8 size 0x3c virtual true final false
 void SetDisabledState() ;

/// @brief Method SetSelectedState addr 0x21607f4 size 0x3c virtual true final false
 void SetSelectedState() ;

/// @brief Method SetSelectedAndHighlightedState addr 0x2160830 size 0x3c virtual true final false
 void SetSelectedAndHighlightedState() ;

/// @brief Method StartTween addr 0x21603f0 size 0x238 virtual false final false
 void StartTween(UnityEngine::Color endColor) ;

// Ctor Parameters []
explicit ColorTMPTextStateTransition() ;

/// @brief Method .ctor addr 0x216086c size 0x48 virtual false final false
 void _ctor() ;

/// @brief Method <StartTween>b__16_0 addr 0x21608b4 size 0x24 virtual false final false
 void _StartTween_b__16_0(UnityEngine::Color color) ;

/// @brief Method <StartTween>b__16_1 addr 0x21608d8 size 0x88 virtual false final false
