...
class CORDL_TYPE GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x20};

virtual ~GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0(GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0(GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0& operator=(GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0&& o) noexcept = default;
  constexpr GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0& operator=(GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0 const& o) noexcept = default;
...
/// @brief Method .ctor addr 0x219d484 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SongPlayerCrossfadeToLevelAsync>b__0 addr 0x219d48c size 0x2c virtual false final false
...
struct CORDL_TYPE GlobalNamespace__LevelCollectionViewController___SongPlayerCrossfadeToLevelAsync_d__24 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "GlobalNamespace::LevelCollectionViewController", modifiers: "", def_value: None }, CppParam { name: "level", ty: "GlobalNamespace::IPreviewBeatmapLevel", modifiers: "", def_value: None }, CppParam { name: "__8__1", ty: "GlobalNamespace::GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "System::Runtime::CompilerServices::TaskAwaiter_1<UnityEngine::AudioClip>", modifiers: "", def_value: None }]
constexpr GlobalNamespace__LevelCollectionViewController___SongPlayerCrossfadeToLevelAsync_d__24(int32_t __1__state, System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, GlobalNamespace::LevelCollectionViewController __4__this, GlobalNamespace::IPreviewBeatmapLevel level, GlobalNamespace::GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0 __8__1, System::Runtime::CompilerServices::TaskAwaiter_1<UnityEngine::AudioClip> __u__1) noexcept;


                    constexpr GlobalNamespace__LevelCollectionViewController___SongPlayerCrossfadeToLevelAsync_d__24(GlobalNamespace__LevelCollectionViewController___SongPlayerCrossfadeToLevelAsync_d__24 const&) = default;
                    constexpr GlobalNamespace__LevelCollectionViewController___SongPlayerCrossfadeToLevelAsync_d__24(GlobalNamespace__LevelCollectionViewController___SongPlayerCrossfadeToLevelAsync_d__24&&) = default;
                    constexpr GlobalNamespace__LevelCollectionViewController___SongPlayerCrossfadeToLevelAsync_d__24& operator=(GlobalNamespace__LevelCollectionViewController___SongPlayerCrossfadeToLevelAsync_d__24 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__LevelCollectionViewController___SongPlayerCrossfadeToLevelAsync_d__24& operator=(GlobalNamespace__LevelCollectionViewController___SongPlayerCrossfadeToLevelAsync_d__24&& o) noexcept {
...
constexpr explicit GlobalNamespace__LevelCollectionViewController___SongPlayerCrossfadeToLevelAsync_d__24(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
constexpr GlobalNamespace::IPreviewBeatmapLevel __get_level() const;
 ...
 GlobalNamespace::GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0 __declspec(property(get=__get___8__1, put=__set___8__1))  __8__1;

constexpr void __set___8__1(GlobalNamespace::GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0 value) ;

constexpr GlobalNamespace::GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0 __get___8__1() const;
...
/// @brief Method MoveNext addr 0x219d4b8 size 0x768 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x219dc20 size 0xc virtual true final true
...
public:
// Declarations
using _SongPlayerCrossfadeToLevelAsync_d__24 = GlobalNamespace::GlobalNamespace__LevelCollectionViewController___SongPlayerCrossfadeToLevelAsync_d__24;

using __c__DisplayClass24_0 = GlobalNamespace::GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0;
...
/// @brief Method add_didSelectLevelEvent addr 0x219af70 size 0xb0 virtual false final false
...
/// @brief Method remove_didSelectLevelEvent addr 0x219b828 size 0xb0 virtual false final false
...
/// @brief Method add_didSelectHeaderEvent addr 0x219b020 size 0xb0 virtual false final false
 void add_didSelectHeaderEvent(System::Action_1<GlobalNamespace::LevelCollectionViewController> value) ;

/// @brief Method remove_didSelectHeaderEvent addr 0x219b8d8 size 0xb0 virtual false final false
 void remove_didSelectHeaderEvent(System::Action_1<GlobalNamespace::LevelCollectionViewController> value) ;

/// @brief Method SetData addr 0x219bda8 size 0x3a8 virtual false final false
 void SetData(GlobalNamespace::IBeatmapLevelCollection beatmapLevelCollection, ::StringW headerText, UnityEngine::Sprite headerSprite, bool sortLevels, bool sortPreviewBeatmapLevels, UnityEngine::GameObject noDataInfoPrefab) ;

/// @brief Method SelectLevel addr 0x219a8a8 size 0x34 virtual false final false
 void SelectLevel(GlobalNamespace::IPreviewBeatmapLevel beatmapLevel) ;

/// @brief Method RefreshFavorites addr 0x219cedc size 0x30 virtual false final false
 void RefreshFavorites() ;

/// @brief Method DidActivate addr 0x219cff8 size 0x1b0 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x219d1a8 size 0x17c virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method HandleLevelCollectionTableViewDidSelectLevel addr 0x219d324 size 0x50 virtual false final false
...
/// @brief Method SongPlayerCrossfadeToLevelAsync addr 0x219d374 size 0xa0 virtual false final false
 void SongPlayerCrossfadeToLevelAsync(GlobalNamespace::IPreviewBeatmapLevel level) ;

/// @brief Method HandleLevelCollectionTableViewDidSelectPack addr 0x219d414 size 0x44 virtual false final false
 void HandleLevelCollectionTableViewDidSelectPack(GlobalNamespace::LevelCollectionTableView tableView) ;

/// @brief Method HandleAdditionalContentModelDidInvalidateData addr 0x219d458 size 0x1c virtual false final false
 void HandleAdditionalContentModelDidInvalidateData() ;

// Ctor Parameters []
explicit LevelCollectionViewController() ;

/// @brief Method .ctor addr 0x219d474 size 0x10 virtual false final false
 void _ctor() ;
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__LevelCollectionViewController____c__DisplayClass24_0, "", "LevelCollectionViewController/<>c__DisplayClass24_0");
...
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__LevelCollectionViewController___SongPlayerCrossfadeToLevelAsync_d__24, "", "LevelCollectionViewController/<SongPlayerCrossfadeToLevelAsync>d__24");
