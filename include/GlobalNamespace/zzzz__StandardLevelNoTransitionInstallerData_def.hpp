...
/// @brief Method get_beatmapLevel addr 0x22074a0 size 0x8 virtual false final false
 GlobalNamespace::BeatmapLevelSO get_beatmapLevel() ;

/// @brief Method set_beatmapLevel addr 0x22074a8 size 0x8 virtual false final false
 void set_beatmapLevel(GlobalNamespace::BeatmapLevelSO value) ;

/// @brief Method get_beatmapCharacteristic addr 0x22074b0 size 0x8 virtual false final false
 GlobalNamespace::BeatmapCharacteristicSO get_beatmapCharacteristic() ;

/// @brief Method set_beatmapCharacteristic addr 0x22074b8 size 0x8 virtual false final false
 void set_beatmapCharacteristic(GlobalNamespace::BeatmapCharacteristicSO value) ;

/// @brief Method get_beatmapDifficulty addr 0x22074c0 size 0x8 virtual false final false
 GlobalNamespace::BeatmapDifficulty get_beatmapDifficulty() ;

/// @brief Method set_beatmapDifficulty addr 0x22074c8 size 0x8 virtual false final false
 void set_beatmapDifficulty(GlobalNamespace::BeatmapDifficulty value) ;

/// @brief Method get_colorScheme addr 0x22074d0 size 0x8 virtual false final false
 GlobalNamespace::ColorSchemeSO get_colorScheme() ;

/// @brief Method set_colorScheme addr 0x22074d8 size 0x8 virtual false final false
 void set_colorScheme(GlobalNamespace::ColorSchemeSO value) ;

/// @brief Method get_environmentInfo addr 0x22074e0 size 0x8 virtual false final false
 GlobalNamespace::EnvironmentInfoSO get_environmentInfo() ;

/// @brief Method set_environmentInfo addr 0x22074e8 size 0x8 virtual false final false
 void set_environmentInfo(GlobalNamespace::EnvironmentInfoSO value) ;

/// @brief Method get_gameplayModifiers addr 0x22074f0 size 0x8 virtual false final false
 GlobalNamespace::GameplayModifiers get_gameplayModifiers() ;

/// @brief Method set_gameplayModifiers addr 0x22074f8 size 0x8 virtual false final false
 void set_gameplayModifiers(GlobalNamespace::GameplayModifiers value) ;

/// @brief Method get_playerSpecificSettings addr 0x2207500 size 0x8 virtual false final false
 GlobalNamespace::PlayerSpecificSettings get_playerSpecificSettings() ;

/// @brief Method set_playerSpecificSettings addr 0x2207508 size 0x8 virtual false final false
 void set_playerSpecificSettings(GlobalNamespace::PlayerSpecificSettings value) ;

/// @brief Method get_practiceSettings addr 0x2207510 size 0x8 virtual false final false
 GlobalNamespace::PracticeSettings get_practiceSettings() ;

/// @brief Method set_practiceSettings addr 0x2207518 size 0x8 virtual false final false
 void set_practiceSettings(GlobalNamespace::PracticeSettings value) ;

/// @brief Method get_backButtonText addr 0x2207520 size 0x8 virtual false final false
 ::StringW get_backButtonText() ;

/// @brief Method set_backButtonText addr 0x2207528 size 0x8 virtual false final false
 void set_backButtonText(::StringW value) ;

/// @brief Method get_useTestNoteCutSoundEffects addr 0x2207530 size 0x8 virtual false final false
 bool get_useTestNoteCutSoundEffects() ;

/// @brief Method set_useTestNoteCutSoundEffects addr 0x2207538 size 0xc virtual false final false
 void set_useTestNoteCutSoundEffects(bool value) ;

// Ctor Parameters []
explicit StandardLevelNoTransitionInstallerData() ;

/// @brief Method .ctor addr 0x2207544 size 0x8 virtual false final false
 void _ctor() ;
