...
/// @brief Method add_levelFailedEvent addr 0x22ab578 size 0x9c virtual true final true
 void add_levelFailedEvent(System::Action value) ;

/// @brief Method remove_levelFailedEvent addr 0x22ab614 size 0x9c virtual true final true
 void remove_levelFailedEvent(System::Action value) ;

/// @brief Method add_levelFinishedEvent addr 0x22ab6b0 size 0x9c virtual true final true
 void add_levelFinishedEvent(System::Action value) ;

/// @brief Method remove_levelFinishedEvent addr 0x22ab74c size 0x9c virtual true final true
 void remove_levelFinishedEvent(System::Action value) ;

// Ctor Parameters []
explicit MockLevelEndActions() ;

/// @brief Method .ctor addr 0x22ab7e8 size 0x8 virtual false final false
 void _ctor() ;
