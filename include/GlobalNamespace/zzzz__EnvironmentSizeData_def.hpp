...
/// @brief Method get_floorType addr 0x21f5d10 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__EnvironmentSizeData__FloorType get_floorType() ;

/// @brief Method get_ceilingType addr 0x21f5d18 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__EnvironmentSizeData__CeilingType get_ceilingType() ;

/// @brief Method get_trackLaneType addr 0x21f5d20 size 0x8 virtual false final false
 GlobalNamespace::GlobalNamespace__EnvironmentSizeData__TrackLaneType get_trackLaneType() ;

// Ctor Parameters []
explicit EnvironmentSizeData() ;

/// @brief Method .ctor addr 0x21f5d28 size 0x8 virtual false final false
 void _ctor() ;
