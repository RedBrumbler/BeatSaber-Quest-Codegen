...
/// @brief Method add_headDidEnterObstaclesEvent addr 0x2140cc8 size 0x9c virtual false final false
 void add_headDidEnterObstaclesEvent(System::Action value) ;

/// @brief Method remove_headDidEnterObstaclesEvent addr 0x2140d64 size 0x9c virtual false final false
 void remove_headDidEnterObstaclesEvent(System::Action value) ;

/// @brief Method add_headDidEnterObstacleEvent addr 0x2140e00 size 0xb0 virtual false final false
 void add_headDidEnterObstacleEvent(System::Action_1<GlobalNamespace::ObstacleController> value) ;

/// @brief Method remove_headDidEnterObstacleEvent addr 0x2140eb0 size 0xb0 virtual false final false
 void remove_headDidEnterObstacleEvent(System::Action_1<GlobalNamespace::ObstacleController> value) ;

/// @brief Method get_playerHeadIsInObstacle addr 0x21403d4 size 0x50 virtual false final false
 bool get_playerHeadIsInObstacle() ;

/// @brief Method RefreshIntersectingObstacles addr 0x2140f60 size 0x300 virtual false final false
 void RefreshIntersectingObstacles(UnityEngine::Vector3 worldPos) ;

/// @brief Method Update addr 0x2141260 size 0x8c virtual false final false
 void Update() ;

// Ctor Parameters []
explicit PlayerHeadAndObstacleInteraction() ;

/// @brief Method .ctor addr 0x21412ec size 0x84 virtual false final false
 void _ctor() ;
