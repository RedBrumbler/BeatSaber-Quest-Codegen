...
/// @brief Method Init addr 0x210dcb4 size 0x104 virtual true final false
 void Init() ;

/// @brief Method OnDestroy addr 0x210ddb8 size 0xd4 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleComboBreakingEventHappened addr 0x210de8c size 0x3c virtual false final false
 void HandleComboBreakingEventHappened() ;

// Ctor Parameters []
explicit FullComboMissionObjectiveChecker() ;

/// @brief Method .ctor addr 0x210dec8 size 0x8 virtual false final false
 void _ctor() ;
