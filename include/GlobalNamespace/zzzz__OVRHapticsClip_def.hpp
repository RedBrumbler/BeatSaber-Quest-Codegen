...
/// @brief Method get_Count addr 0x25ea8a4 size 0x8 virtual false final false
 int32_t get_Count() ;

/// @brief Method set_Count addr 0x25ea8ac size 0x8 virtual false final false
 void set_Count(int32_t value) ;

/// @brief Method get_Capacity addr 0x25ea8b4 size 0x8 virtual false final false
 int32_t get_Capacity() ;

/// @brief Method set_Capacity addr 0x25ea8bc size 0x8 virtual false final false
 void set_Capacity(int32_t value) ;

/// @brief Method get_Samples addr 0x25ea8c4 size 0x8 virtual false final false
 ::ArrayW<uint8_t> get_Samples() ;

/// @brief Method set_Samples addr 0x25ea8cc size 0x8 virtual false final false
 void set_Samples(::ArrayW<uint8_t> value) ;

// Ctor Parameters []
explicit OVRHapticsClip() ;

/// @brief Method .ctor addr 0x25ea554 size 0x100 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "capacity", ty: "int32_t", modifiers: "", def_value: None }]
explicit OVRHapticsClip(int32_t capacity) ;

/// @brief Method .ctor addr 0x25ea67c size 0xd8 virtual false final false
...
/// @brief Method .ctor addr 0x25ea8d4 size 0xc4 virtual false final false
...
/// @brief Method .ctor addr 0x25ea998 size 0x20c virtual false final false
...
/// @brief Method .ctor addr 0x25eaba4 size 0xd8 virtual false final false
 void _ctor(UnityEngine::AudioClip audioClip, int32_t channel) ;

/// @brief Method WriteSample addr 0x25ea754 size 0x130 virtual false final false
 void WriteSample(uint8_t sample) ;

/// @brief Method Reset addr 0x25eafa8 size 0x8 virtual false final false
 void Reset() ;

/// @brief Method InitializeFromAudioFloatTrack addr 0x25eac7c size 0x32c virtual false final false
