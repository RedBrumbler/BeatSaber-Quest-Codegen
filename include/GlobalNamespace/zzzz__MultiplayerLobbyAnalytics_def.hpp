...
/// @brief Method Awake addr 0x20e9b38 size 0x178 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x20e9cb0 size 0x1c4 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleGameServerLobbyFlowCoordinatorDidSetupEvent addr 0x20e9e74 size 0x16c virtual false final false
 void HandleGameServerLobbyFlowCoordinatorDidSetupEvent() ;

/// @brief Method HandleGameServerLobbyFlowCoordinatorDidFinish addr 0x20ea060 size 0x114 virtual false final false
 void HandleGameServerLobbyFlowCoordinatorDidFinish() ;

/// @brief Method HandleGameServerLobbyFlowCoordinatorStartGameOrReady addr 0x20ea240 size 0x114 virtual false final false
 void HandleGameServerLobbyFlowCoordinatorStartGameOrReady() ;

/// @brief Method HandleGameServerLobbyFlowCoordinatorDidOpenInvitePanel addr 0x20ea354 size 0x114 virtual false final false
 void HandleGameServerLobbyFlowCoordinatorDidOpenInvitePanel() ;

/// @brief Method LogClick addr 0x20ea174 size 0xcc virtual false final false
 void LogClick(System::Collections::Generic::Dictionary_2<::StringW,::StringW> clickData) ;

/// @brief Method GetEventTypeFromLobbyType addr 0x20e9fe0 size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x20ea468 size 0x8 virtual false final false
 void _ctor() ;
