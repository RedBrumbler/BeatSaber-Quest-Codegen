...
/// @brief Method get_value addr 0x21cc518 size 0x8 virtual false final false
 float_t get_value() ;

/// @brief Method set_value addr 0x21cc520 size 0x8 virtual false final false
 void set_value(float_t value) ;

/// @brief Method get_time addr 0x21cc528 size 0x8 virtual false final false
 float_t get_time() ;

/// @brief Method set_time addr 0x21cc530 size 0x8 virtual false final false
 void set_time(float_t value) ;

/// @brief Method .ctor addr 0x21cc4f8 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x21cc0e4 size 0x154 virtual false final false
 void _ctor(float_t averageWindowDuration, float_t historyWindowDuration, float_t historyValuesPerSecond) ;

/// @brief Method Update addr 0x21cc238 size 0x2c0 virtual false final false
 void Update(float_t value, float_t deltaTime) ;

/// @brief Method GetAverageValue addr 0x21cc500 size 0x8 virtual false final false
 float_t GetAverageValue() ;

/// @brief Method GetLastValue addr 0x21cc508 size 0x8 virtual false final false
 float_t GetLastValue() ;

/// @brief Method GetHistoryValues addr 0x21cc510 size 0x8 virtual false final false
