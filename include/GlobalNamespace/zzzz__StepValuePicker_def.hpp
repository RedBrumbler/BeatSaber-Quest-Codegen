...
/// @brief Method add_decButtonWasPressedEvent addr 0x215ef70 size 0x9c virtual false final false
 void add_decButtonWasPressedEvent(System::Action value) ;

/// @brief Method remove_decButtonWasPressedEvent addr 0x215f00c size 0x9c virtual false final false
 void remove_decButtonWasPressedEvent(System::Action value) ;

/// @brief Method add_incButtonWasPressedEvent addr 0x215f0a8 size 0x9c virtual false final false
 void add_incButtonWasPressedEvent(System::Action value) ;

/// @brief Method remove_incButtonWasPressedEvent addr 0x215f144 size 0x9c virtual false final false
 void remove_incButtonWasPressedEvent(System::Action value) ;

/// @brief Method get_text addr 0x215f1e0 size 0x24 virtual false final false
 ::StringW get_text() ;

/// @brief Method set_text addr 0x215f204 size 0x24 virtual false final false
 void set_text(::StringW value) ;

/// @brief Method set_decButtonInteractable addr 0x215f228 size 0x20 virtual false final false
 void set_decButtonInteractable(bool value) ;

/// @brief Method set_incButtonInteractable addr 0x215f248 size 0x20 virtual false final false
 void set_incButtonInteractable(bool value) ;

/// @brief Method OnEnable addr 0x215f268 size 0xf0 virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x215f358 size 0xf0 virtual false final false
 void OnDisable() ;

/// @brief Method IncButtonPressed addr 0x215f448 size 0x1c virtual false final false
 void IncButtonPressed() ;

/// @brief Method DecButtonPressed addr 0x215f464 size 0x1c virtual false final false
 void DecButtonPressed() ;

// Ctor Parameters []
explicit StepValuePicker() ;

/// @brief Method .ctor addr 0x215f480 size 0x8 virtual false final false
 void _ctor() ;
