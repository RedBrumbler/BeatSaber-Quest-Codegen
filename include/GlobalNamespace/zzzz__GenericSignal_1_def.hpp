...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13900)), TypeDefinitionIndex(TypeDefinitionIndex(13901))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13900), inst: 2 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13900)), TypeDefinitionIndex(TypeDefinitionIndex(13901))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13900), inst: 99 })
// CS Name: GenericSignal`1
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13901)), TypeDefinitionIndex(TypeDefinitionIndex(13900))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13900), inst: 280 })
// CS Name: GenericSignal`1
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13900)), TypeDefinitionIndex(TypeDefinitionIndex(13901))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13900), inst: 374 })
// CS Name: GenericSignal`1
