...
/// @brief Method get_materialPropertyBlockController addr 0x1fdc600 size 0x8 virtual false final false
 GlobalNamespace::MaterialPropertyBlockController get_materialPropertyBlockController() ;

/// @brief Method set_materialPropertyBlockController addr 0x1fdc608 size 0x7c virtual false final false
 void set_materialPropertyBlockController(GlobalNamespace::MaterialPropertyBlockController value) ;

/// @brief Method SetProperty addr 0x1fdc684 size 0x4 virtual true final false
 void SetProperty() ;

/// @brief Method Awake addr 0x1fdc688 size 0x90 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x1fdc748 size 0x28 virtual false final false
 void Update() ;

/// @brief Method LazyInit addr 0x1fdc718 size 0x30 virtual false final false
 void LazyInit() ;

/// @brief Method RefreshProperty addr 0x1fdc960 size 0x20 virtual false final false
 void RefreshProperty() ;

// Ctor Parameters []
explicit MaterialPropertyBlockAnimator() ;

/// @brief Method .ctor addr 0x1fdc980 size 0x8 virtual false final false
 void _ctor() ;
