...
/// @brief Method DidActivate addr 0x21b764c size 0x30c virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method Move addr 0x21b7b70 size 0x94 virtual false final false
 void Move(UnityEngine::Vector3 move) ;

/// @brief Method Rotate addr 0x21b7c04 size 0x88 virtual false final false
 void Rotate(float_t rotation) ;

/// @brief Method ResetRoom addr 0x21b7c8c size 0x8c virtual false final false
 void ResetRoom() ;

/// @brief Method RefreshTexts addr 0x21b7958 size 0x218 virtual false final false
 void RefreshTexts() ;

// Ctor Parameters []
explicit RoomAdjustSettingsViewController() ;

/// @brief Method .ctor addr 0x21b7d18 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__10_0 addr 0x21b7d20 size 0x14 virtual false final false
 void _DidActivate_b__10_0() ;

/// @brief Method <DidActivate>b__10_1 addr 0x21b7d34 size 0x14 virtual false final false
 void _DidActivate_b__10_1() ;

/// @brief Method <DidActivate>b__10_2 addr 0x21b7d48 size 0x14 virtual false final false
 void _DidActivate_b__10_2() ;

/// @brief Method <DidActivate>b__10_3 addr 0x21b7d5c size 0x14 virtual false final false
 void _DidActivate_b__10_3() ;

/// @brief Method <DidActivate>b__10_4 addr 0x21b7d70 size 0x14 virtual false final false
 void _DidActivate_b__10_4() ;

/// @brief Method <DidActivate>b__10_5 addr 0x21b7d84 size 0x14 virtual false final false
 void _DidActivate_b__10_5() ;

/// @brief Method <DidActivate>b__10_6 addr 0x21b7d98 size 0x8 virtual false final false
 void _DidActivate_b__10_6() ;

/// @brief Method <DidActivate>b__10_7 addr 0x21b7da0 size 0x8 virtual false final false
 void _DidActivate_b__10_7() ;

/// @brief Method <DidActivate>b__10_8 addr 0x21b7da8 size 0x4 virtual false final false
