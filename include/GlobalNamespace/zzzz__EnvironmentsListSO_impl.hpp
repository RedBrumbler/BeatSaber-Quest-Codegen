...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<GlobalNamespace::EnvironmentInfoSO> (GlobalNamespace::EnvironmentsListSO::*)()>(&GlobalNamespace::EnvironmentsListSO::get_environmentInfos)> {
  ...
  constexpr static std::size_t addrs = 0x21f5d30;
...
//  Writing Method size for method: GlobalNamespace::EnvironmentsListSO.GetEnvironmentInfoBySerializedName
template<>
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::EnvironmentInfoSO (GlobalNamespace::EnvironmentsListSO::*)(::StringW)>(&GlobalNamespace::EnvironmentsListSO::GetEnvironmentInfoBySerializedName)> {
  ...
  constexpr static std::size_t addrs = 0x21f5d38;
...
//  Writing Method size for method: GlobalNamespace::EnvironmentsListSO.GetAllEnvironmentInfosWithType
template<>
...
//  Writing Method size for method: GlobalNamespace::EnvironmentsListSO.GetFirstEnvironmentInfoWithType
template<>
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::EnvironmentInfoSO (GlobalNamespace::EnvironmentsListSO::*)(GlobalNamespace::EnvironmentTypeSO)>(&GlobalNamespace::EnvironmentsListSO::GetFirstEnvironmentInfoWithType)> {
  ...
  constexpr static std::size_t addrs = 0x21f5f30;
...
//  Writing Method size for method: GlobalNamespace::EnvironmentsListSO.GetLastEnvironmentInfoWithType
template<>
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<GlobalNamespace::EnvironmentInfoSO (GlobalNamespace::EnvironmentsListSO::*)(GlobalNamespace::EnvironmentTypeSO)>(&GlobalNamespace::EnvironmentsListSO::GetLastEnvironmentInfoWithType)> {
  constexpr static std::size_t size = 0x80;
  constexpr static std::size_t addrs = 0x21f5fb4;
...
//  Writing Method size for method: GlobalNamespace::EnvironmentsListSO._ctor
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (GlobalNamespace::EnvironmentsListSO::*)()>(&GlobalNamespace::EnvironmentsListSO::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x21f6034;
...
constexpr void GlobalNamespace::EnvironmentsListSO::__set__environmentInfos(::ArrayW<GlobalNamespace::EnvironmentInfoSO> value)  {
::cordl_internals::setInstanceField<::ArrayW<GlobalNamespace::EnvironmentInfoSO>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<GlobalNamespace::EnvironmentInfoSO>>(value));
}
constexpr ::ArrayW<GlobalNamespace::EnvironmentInfoSO> GlobalNamespace::EnvironmentsListSO::__get__environmentInfos() const {
return ::cordl_internals::getInstanceField<::ArrayW<GlobalNamespace::EnvironmentInfoSO>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
return ::cordl_internals::RunMethodRethrow<GlobalNamespace::EnvironmentInfoSO, false>(const_cast<void*>(instance), ___internal_method, environmentSerializedName);
}
...
return ::cordl_internals::RunMethodRethrow<System::Collections::Generic::List_1<GlobalNamespace::EnvironmentInfoSO>, false>(const_cast<void*>(instance), ___internal_method, environmentType);
}
