...
/// @brief Method add_didSelectCharacteristic addr 0x21bba64 size 0xb0 virtual false final false
 void add_didSelectCharacteristic(System::Action_1<GlobalNamespace::BeatmapCharacteristicSO> value) ;

/// @brief Method remove_didSelectCharacteristic addr 0x21bbb14 size 0xb0 virtual false final false
 void remove_didSelectCharacteristic(System::Action_1<GlobalNamespace::BeatmapCharacteristicSO> value) ;

/// @brief Method Init addr 0x21bbbc4 size 0xc0 virtual false final false
 void Init() ;

/// @brief Method SetData addr 0x21bbc84 size 0x54 virtual false final false
 void SetData(GlobalNamespace::BeatmapCharacteristicCollection beatmapCharacteristicCollection) ;

/// @brief Method OnDestroy addr 0x21bbcd8 size 0x8c virtual false final false
 void OnDestroy() ;

/// @brief Method CellSize addr 0x21bbd64 size 0x8 virtual true final true
 float_t CellSize() ;

/// @brief Method NumberOfCells addr 0x21bbd6c size 0xb8 virtual true final true
 int32_t NumberOfCells() ;

/// @brief Method CellForIdx addr 0x21bbe24 size 0x1b4 virtual true final true
 HMUI::TableCell CellForIdx(HMUI::TableView tableView, int32_t idx) ;

/// @brief Method HandleDidSelectColumnEvent addr 0x21bbfd8 size 0xe0 virtual false final false
 void HandleDidSelectColumnEvent(HMUI::TableView tableView, int32_t column) ;

/// @brief Method HandleAdditionalContentModelDidInvalidateData addr 0x21bc0b8 size 0xa8 virtual false final false
 void HandleAdditionalContentModelDidInvalidateData() ;

/// @brief Method SelectCellWithIdx addr 0x21bc160 size 0x20 virtual false final false
 void SelectCellWithIdx(int32_t idx) ;

// Ctor Parameters []
explicit BeatmapCharacteristicsTableView() ;

/// @brief Method .ctor addr 0x21bc180 size 0x58 virtual false final false
 void _ctor() ;
