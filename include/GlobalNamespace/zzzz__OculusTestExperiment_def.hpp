...
/// @brief Method get_experimentPlatformKey addr 0x21f61e8 size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0x21f61f0 size 0x28 virtual false final false
...
/// @brief Method MoveNext addr 0x21f6218 size 0x470 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x21f6688 size 0xc virtual true final true
...
/// @brief Method Init addr 0x21f614c size 0x94 virtual false final false
 void Init() ;

// Ctor Parameters []
explicit OculusTestExperiment() ;

/// @brief Method .ctor addr 0x21f61e0 size 0x8 virtual false final false
 void _ctor() ;
