...
/// @brief Method .ctor addr 0x223af6c size 0x78 virtual false final false
 void _ctor(GlobalNamespace::SongPackMaskModelSO songPackMasks) ;

/// @brief Method GetAllSongsMask addr 0x223afe4 size 0xc virtual false final false
 GlobalNamespace::SongPackMask GetAllSongsMask() ;

/// @brief Method GetSongPackMaskText addr 0x223aff0 size 0x18 virtual false final false
 ::StringW GetSongPackMaskText(ByRef<GlobalNamespace::SongPackMask> songPackMask) ;

/// @brief Method GetSongPackMaskText addr 0x223b008 size 0x98 virtual false final false
