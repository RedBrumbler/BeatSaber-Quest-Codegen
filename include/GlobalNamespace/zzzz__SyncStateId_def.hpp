...
/// @brief Method .ctor addr 0xddd8d8 size 0x8 virtual false final false
 void _ctor(uint8_t id) ;

/// @brief Method Equals addr 0xddd8e0 size 0x10 virtual true final true
 bool Equals(GlobalNamespace::SyncStateId other) ;

/// @brief Method Equals addr 0xddd8f0 size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0xddd968 size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0xddd988 size 0x20 virtual true final false
 ::StringW ToString() ;

/// @brief Method op_Equality addr 0xddd9a8 size 0x10 virtual false final false
static bool op_Equality(GlobalNamespace::SyncStateId a, GlobalNamespace::SyncStateId b) ;

/// @brief Method op_Inequality addr 0xddd9b8 size 0x10 virtual false final false
static bool op_Inequality(GlobalNamespace::SyncStateId a, GlobalNamespace::SyncStateId b) ;

/// @brief Method Increment addr 0xddd9c8 size 0x10 virtual false final false
 GlobalNamespace::SyncStateId Increment() ;

/// @brief Method Before addr 0xddd9d8 size 0x2c virtual false final false
 bool Before(GlobalNamespace::SyncStateId other) ;

/// @brief Method Serialize addr 0xddcbe0 size 0x24 virtual true final true
 void Serialize(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method SerializeWithFlag addr 0xddc990 size 0x34 virtual false final false
 void SerializeWithFlag(LiteNetLib::Utils::NetDataWriter writer, bool flag) ;

/// @brief Method Deserialize addr 0xddcc50 size 0x20 virtual false final false
static GlobalNamespace::SyncStateId Deserialize(LiteNetLib::Utils::NetDataReader reader) ;

/// @brief Method DeserializeWithFlag addr 0xddca2c size 0x2c virtual false final false
static GlobalNamespace::SyncStateId DeserializeWithFlag(LiteNetLib::Utils::NetDataReader reader, ByRef<bool> flag) ;

/// @brief Method CreateFromSerializedData addr 0xddda04 size 0x24 virtual true final true
