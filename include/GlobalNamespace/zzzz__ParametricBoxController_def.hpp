...
/// @brief Method Awake addr 0x1fd226c size 0x20 virtual false final false
 void Awake() ;

/// @brief Method OnEnable addr 0x1fd228c size 0x28 virtual false final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fd250c size 0x20 virtual false final false
 void OnDisable() ;

/// @brief Method Refresh addr 0x1fd22b4 size 0x258 virtual false final false
 void Refresh() ;

// Ctor Parameters []
explicit ParametricBoxController() ;

/// @brief Method .ctor addr 0x1fd252c size 0x24 virtual false final false
 void _ctor() ;
