...
class CORDL_TYPE GlobalNamespace__PingUtility____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~GlobalNamespace__PingUtility____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__PingUtility____c", modifiers: " const&", def_value: None }]
constexpr GlobalNamespace__PingUtility____c(GlobalNamespace__PingUtility____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "GlobalNamespace__PingUtility____c", modifiers: "&&", def_value: None }]
constexpr GlobalNamespace__PingUtility____c(GlobalNamespace__PingUtility____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit GlobalNamespace__PingUtility____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr GlobalNamespace__PingUtility____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr GlobalNamespace__PingUtility____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr GlobalNamespace__PingUtility____c& operator=(GlobalNamespace__PingUtility____c&& o) noexcept = default;
  constexpr GlobalNamespace__PingUtility____c& operator=(GlobalNamespace__PingUtility____c const& o) noexcept = default;
                


// Fields

static GlobalNamespace::GlobalNamespace__PingUtility____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(GlobalNamespace::GlobalNamespace__PingUtility____c value) ;

static GlobalNamespace::GlobalNamespace__PingUtility____c __get___9() ;
...
/// @brief Method .ctor addr 0xdd43ec size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <PingAsync>b__0_0 addr 0xdd43f4 size 0x80 virtual false final false
...
struct CORDL_TYPE GlobalNamespace__PingUtility___PingAsync_d__0 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr GlobalNamespace__PingUtility___PingAsync_d__0(int32_t __1__state, System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<int64_t> __t__builder, ::StringW url, ::ArrayW<UnityEngine::Ping> _pings_5__2, int64_t _ping_5__3, bool _found_5__4, System::Runtime::CompilerServices::TaskAwaiter_1<::ArrayW<System::Net::IPAddress>> __u__1, int32_t _t_5__5, System::Runtime::CompilerServices::TaskAwaiter __u__2) noexcept;


                    constexpr GlobalNamespace__PingUtility___PingAsync_d__0(GlobalNamespace__PingUtility___PingAsync_d__0 const&) = default;
                    constexpr GlobalNamespace__PingUtility___PingAsync_d__0(GlobalNamespace__PingUtility___PingAsync_d__0&&) = default;
                    constexpr GlobalNamespace__PingUtility___PingAsync_d__0& operator=(GlobalNamespace__PingUtility___PingAsync_d__0 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr GlobalNamespace__PingUtility___PingAsync_d__0& operator=(GlobalNamespace__PingUtility___PingAsync_d__0&& o) noexcept {
...
constexpr explicit GlobalNamespace__PingUtility___PingAsync_d__0(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
/// @brief Method MoveNext addr 0xdd4474 size 0x52c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0xdd49a0 size 0x58 virtual true final true
...
public:
// Declarations
using _PingAsync_d__0 = GlobalNamespace::GlobalNamespace__PingUtility___PingAsync_d__0;

using __c = GlobalNamespace::GlobalNamespace__PingUtility____c;
...
/// @brief Method PingAsync addr 0xdd4288 size 0x100 virtual false final false
...
NEED_NO_BOX(GlobalNamespace::GlobalNamespace__PingUtility____c);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__PingUtility____c, "", "PingUtility/<>c");
NEED_NO_BOX(GlobalNamespace::PingUtility);
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::PingUtility, "", "PingUtility");
DEFINE_IL2CPP_ARG_TYPE(GlobalNamespace::GlobalNamespace__PingUtility___PingAsync_d__0, "", "PingUtility/<PingAsync>d__0");
