...
/// @brief Method GetQuickPlaySetupAsync addr 0x21272c4 size 0x70 virtual true final true
...
/// @brief Method .ctor addr 0x2127334 size 0x8 virtual false final false
 void _ctor() ;
