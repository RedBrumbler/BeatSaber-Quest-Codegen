...
/// @brief Method .ctor addr 0x1fad960 size 0xb8 virtual false final false
 void _ctor(::StringW processName) ;

/// @brief Method Dispose addr 0x1fada18 size 0xc8 virtual true final true
 void Dispose() ;
...
/// @brief Method Format addr 0x1fad6b8 size 0xec virtual false final false
static ::StringW Format(GlobalNamespace::IVerboseLogger logger, ::StringW message) ;

/// @brief Method Log addr 0x1fad7a4 size 0x78 virtual false final false
...
/// @brief Method LogWithTimestamp addr 0x1fad81c size 0x144 virtual false final false
