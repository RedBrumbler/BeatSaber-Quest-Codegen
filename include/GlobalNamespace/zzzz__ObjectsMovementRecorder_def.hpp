...
/// @brief Method .ctor addr 0x21dd9d4 size 0xa4 virtual false final false
...
/// @brief Method Init addr 0x21dc818 size 0x704 virtual false final false
 void Init() ;

/// @brief Method OnDestroy addr 0x21dd620 size 0x228 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleGameStateChanged addr 0x21dd860 size 0x70 virtual false final false
 void HandleGameStateChanged() ;

// Ctor Parameters []
explicit ObjectsMovementRecorder() ;

/// @brief Method .ctor addr 0x21dd9c4 size 0x10 virtual false final false
 void _ctor() ;
