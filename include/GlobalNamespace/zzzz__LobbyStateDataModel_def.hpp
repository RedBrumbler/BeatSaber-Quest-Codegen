...
/// @brief Method add_playerConnectedEvent addr 0x2236df8 size 0xb0 virtual true final true
 void add_playerConnectedEvent(System::Action_1<GlobalNamespace::IConnectedPlayer> value) ;

/// @brief Method remove_playerConnectedEvent addr 0x2236ea8 size 0xb0 virtual true final true
 void remove_playerConnectedEvent(System::Action_1<GlobalNamespace::IConnectedPlayer> value) ;

/// @brief Method add_playerDisconnectedEvent addr 0x2236f58 size 0xb0 virtual true final true
 void add_playerDisconnectedEvent(System::Action_1<GlobalNamespace::IConnectedPlayer> value) ;

/// @brief Method remove_playerDisconnectedEvent addr 0x2237008 size 0xb0 virtual true final true
 void remove_playerDisconnectedEvent(System::Action_1<GlobalNamespace::IConnectedPlayer> value) ;

/// @brief Method get_isConnected addr 0x22370b8 size 0xa4 virtual true final true
 bool get_isConnected() ;

/// @brief Method get_localPlayer addr 0x223715c size 0xa0 virtual true final true
 GlobalNamespace::IConnectedPlayer get_localPlayer() ;

/// @brief Method get_connectedPlayers addr 0x22371fc size 0x8 virtual true final true
 System::Collections::Generic::List_1<GlobalNamespace::IConnectedPlayer> get_connectedPlayers() ;

/// @brief Method get_rawConnectedPlayers addr 0x2237204 size 0xa4 virtual true final true
 System::Collections::Generic::IReadOnlyList_1<GlobalNamespace::IConnectedPlayer> get_rawConnectedPlayers() ;

/// @brief Method get_configuration addr 0x22372a8 size 0x14 virtual true final true
 GlobalNamespace::GameplayServerConfiguration get_configuration() ;

/// @brief Method Activate addr 0x22372bc size 0x7f0 virtual true final true
 void Activate() ;

/// @brief Method Deactivate addr 0x2237aac size 0x194 virtual true final true
 void Deactivate() ;

/// @brief Method Dispose addr 0x2237c40 size 0x4 virtual true final true
 void Dispose() ;

/// @brief Method GetPlayerById addr 0x2237c44 size 0x94 virtual true final true
 GlobalNamespace::IConnectedPlayer GetPlayerById(::StringW userId) ;

/// @brief Method HandleMultiplayerSessionManagerPlayerConnected addr 0x2237cd8 size 0x170 virtual false final false
 void HandleMultiplayerSessionManagerPlayerConnected(GlobalNamespace::IConnectedPlayer player) ;

/// @brief Method HandleMultiplayerSessionManagerPlayerDisconnected addr 0x2237e48 size 0x120 virtual false final false
...
/// @brief Method .ctor addr 0x2237f68 size 0x8 virtual false final false
 void _ctor() ;
