...
/// @brief Method set_duration addr 0x21bb9e0 size 0x34 virtual false final false
 void set_duration(float_t value) ;

/// @brief Method set_bpm addr 0x21bba14 size 0x48 virtual false final false
 void set_bpm(float_t value) ;

// Ctor Parameters []
explicit BasicLevelParamsPanel() ;

/// @brief Method .ctor addr 0x21bba5c size 0x8 virtual false final false
 void _ctor() ;
