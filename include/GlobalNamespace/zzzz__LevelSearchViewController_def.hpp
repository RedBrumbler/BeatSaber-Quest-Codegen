...
/// @brief Method get_collectionName addr 0x21a2608 size 0x8 virtual true final true
 ::StringW get_collectionName() ;

/// @brief Method get_coverImage addr 0x21a2610 size 0x8 virtual true final true
 UnityEngine::Sprite get_coverImage() ;

/// @brief Method get_smallCoverImage addr 0x21a2618 size 0x8 virtual true final true
 UnityEngine::Sprite get_smallCoverImage() ;

/// @brief Method get_beatmapLevelCollection addr 0x21a2620 size 0x8 virtual true final true
 GlobalNamespace::IBeatmapLevelCollection get_beatmapLevelCollection() ;

/// @brief Method set_beatmapLevelCollection addr 0x21a2628 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x21a2630 size 0x28 virtual false final false
...
/// @brief Method MoveNext addr 0x21a2658 size 0x590 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x21a2be8 size 0xc virtual true final true
...
constexpr System::Action_2<GlobalNamespace::LevelSearchViewController,GlobalNamespace::LevelFilterParams> __get_didPressSearchButtonEvent() const;
 ...
 System::Action_3<GlobalNamespace::IAnnotatedBeatmapLevelCollection,GlobalNamespace::BeatmapCharacteristicSO,bool> __declspec(property(get=__get_didFilterBeatmapLevelCollectionEvent, put=__set_didFilterBeatmapLevelCollectionEvent))  didFilterBeatmapLevelCollectionEvent;
...
constexpr System::Action_3<GlobalNamespace::IAnnotatedBeatmapLevelCollection,GlobalNamespace::BeatmapCharacteristicSO,bool> __get_didFilterBeatmapLevelCollectionEvent() const;
...
/// @brief Method add_didPressSearchButtonEvent addr 0x21a19dc size 0xb0 virtual false final false
...
/// @brief Method remove_didPressSearchButtonEvent addr 0x21a1a8c size 0xb0 virtual false final false
...
/// @brief Method add_didFilterBeatmapLevelCollectionEvent addr 0x219f0dc size 0xb0 virtual false final false
 void add_didFilterBeatmapLevelCollectionEvent(System::Action_3<GlobalNamespace::IAnnotatedBeatmapLevelCollection,GlobalNamespace::BeatmapCharacteristicSO,bool> value) ;

/// @brief Method remove_didFilterBeatmapLevelCollectionEvent addr 0x219f7b8 size 0xb0 virtual false final false
 void remove_didFilterBeatmapLevelCollectionEvent(System::Action_3<GlobalNamespace::IAnnotatedBeatmapLevelCollection,GlobalNamespace::BeatmapCharacteristicSO,bool> value) ;

/// @brief Method add_didStartLoadingEvent addr 0x219f18c size 0xb0 virtual false final false
 void add_didStartLoadingEvent(System::Action_1<GlobalNamespace::LevelSearchViewController> value) ;

/// @brief Method remove_didStartLoadingEvent addr 0x219f868 size 0xb0 virtual false final false
 void remove_didStartLoadingEvent(System::Action_1<GlobalNamespace::LevelSearchViewController> value) ;

/// @brief Method Setup addr 0x219ec44 size 0xc virtual false final false
 void Setup(::ArrayW<GlobalNamespace::IBeatmapLevelPack> beatmapLevelPacks) ;

/// @brief Method ResetFilterParams addr 0x219fb7c size 0x38 virtual false final false
 void ResetFilterParams(bool onlyFavorites) ;

/// @brief Method UpdateSearchLevelFilterParams addr 0x21a1d2c size 0x8 virtual false final false
 void UpdateSearchLevelFilterParams(GlobalNamespace::LevelFilterParams levelFilterParams) ;

/// @brief Method DidActivate addr 0x21a1d38 size 0x200 virtual true final false
 void DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x21a1f38 size 0xc4 virtual true final false
 void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method ResetCurrentFilterParams addr 0x21a1b3c size 0x118 virtual false final false
 void ResetCurrentFilterParams() ;

/// @brief Method UpdateBeatmapLevelPackCollectionAsync addr 0x21a1c98 size 0x94 virtual false final false
 void UpdateBeatmapLevelPackCollectionAsync() ;

/// @brief Method SearchTextInputFieldViewOnValueChanged addr 0x21a1ffc size 0x24 virtual false final false
 void SearchTextInputFieldViewOnValueChanged(HMUI::InputFieldView inputFieldView) ;

/// @brief Method UpdateCurrentFilterParams addr 0x21a1c54 size 0x44 virtual false final false
 void UpdateCurrentFilterParams() ;

/// @brief Method RefreshAfterIncreaseNumberOfGameplay addr 0x219fd60 size 0x28 virtual false final false
 void RefreshAfterIncreaseNumberOfGameplay() ;

/// @brief Method Refresh addr 0x21a1d34 size 0x4 virtual false final false
 void Refresh() ;

/// @brief Method LocalizedLevelFilterParamsDescription addr 0x21a2020 size 0x5a4 virtual false final false
...
/// @brief Method .ctor addr 0x21a25c4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <DidActivate>b__27_0 addr 0x21a25cc size 0x24 virtual false final false
 void _DidActivate_b__27_0() ;

/// @brief Method <DidActivate>b__27_1 addr 0x21a25f0 size 0x18 virtual false final false
