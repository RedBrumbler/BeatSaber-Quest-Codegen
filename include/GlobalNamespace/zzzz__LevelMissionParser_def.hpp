...
/// @brief Method .ctor addr 0x21ff960 size 0xd8 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x21ffa38 size 0x14 virtual true final false
 bool Invoke(::ArrayW<float_t> functionParams, int32_t paramCount) ;

/// @brief Method BeginInvoke addr 0x21ffa4c size 0x94 virtual true final false
...
/// @brief Method EndInvoke addr 0x21ffae0 size 0x28 virtual true final false
...
/// @brief Method .ctor addr 0x21ff29c size 0x84 virtual false final false
 void _ctor() ;

/// @brief Method AddFunction addr 0x21ff320 size 0x68 virtual false final false
 void AddFunction(::StringW name, GlobalNamespace::GlobalNamespace__LevelMissionParser__ParserFunction function) ;

/// @brief Method Parse addr 0x21ff388 size 0x1c virtual false final false
 bool Parse(::StringW s) ;

/// @brief Method Parse addr 0x21ff3a4 size 0x2c8 virtual false final false
 bool Parse(::StringW s, int32_t start, int32_t length) ;

/// @brief Method ParseFunction addr 0x21ff66c size 0x2f4 virtual false final false
