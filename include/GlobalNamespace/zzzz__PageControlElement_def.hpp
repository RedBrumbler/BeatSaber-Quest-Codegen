...
/// @brief Method get_rectTransform addr 0x21c5cc8 size 0x8 virtual false final false
 UnityEngine::RectTransform get_rectTransform() ;

/// @brief Method SetSelected addr 0x21c5a9c size 0x64 virtual false final false
 void SetSelected(bool isSelected) ;

// Ctor Parameters []
explicit PageControlElement() ;

/// @brief Method .ctor addr 0x21c5cd0 size 0x20 virtual false final false
 void _ctor() ;
