...
/// @brief Method get_environmentKeywords addr 0x21f57ac size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x21f57b4 size 0x104 virtual false final false
 void _ctor(System::Collections::Generic::IReadOnlyList_1<::StringW> environmentKeywords) ;

/// @brief Method HasKeyword addr 0x21f58b8 size 0x58 virtual false final false
