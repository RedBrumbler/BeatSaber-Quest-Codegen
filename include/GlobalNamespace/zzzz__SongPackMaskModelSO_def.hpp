...
/// @brief Method .ctor addr 0x223ace8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <get_songPackMask>b__11_0 addr 0x223acf0 size 0x9c virtual false final false
 ::StringW _get_songPackMask_b__11_0(GlobalNamespace::IBeatmapLevelPack pack) ;

/// @brief Method <get_songPackMask>b__11_1 addr 0x223ad8c size 0x18 virtual false final false
 ::StringW _get_songPackMask_b__11_1(GlobalNamespace::BeatmapLevelPackSO pack) ;

/// @brief Method <get_songPackMask>b__11_2 addr 0x223ada4 size 0x18 virtual false final false
 ::StringW _get_songPackMask_b__11_2(GlobalNamespace::PreviewBeatmapLevelPackSO pack) ;

/// @brief Method <get_songPackMask>b__11_3 addr 0x223adbc size 0x114 virtual false final false
...
/// @brief Method <get_songPackMask>b__11_4 addr 0x223aed0 size 0x9c virtual false final false
...
/// @brief Method get_serializedName addr 0x223a878 size 0x40 virtual false final false
 ::StringW get_serializedName() ;

/// @brief Method get_songPackMask addr 0x223a8b8 size 0x3a0 virtual false final false
 GlobalNamespace::SongPackMask get_songPackMask() ;

/// @brief Method get_containsMultiplePacks addr 0x223ac58 size 0x1c virtual false final false
 bool get_containsMultiplePacks() ;

// Ctor Parameters []
explicit GlobalNamespace__SongPackMaskModelSO__SongPackMaskItem() ;

/// @brief Method .ctor addr 0x223ac7c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_defaultSongPackMaskItems addr 0x2239f04 size 0x8 virtual false final false
 System::Collections::Generic::List_1<::StringW> get_defaultSongPackMaskItems() ;

/// @brief Method get_customSongPackMaskItems addr 0x2239f0c size 0x8 virtual false final false
 ::ArrayW<GlobalNamespace::GlobalNamespace__SongPackMaskModelSO__SongPackMaskItem> get_customSongPackMaskItems() ;

/// @brief Method get_ostAndExtrasCollection addr 0x2239f14 size 0x8 virtual false final false
 GlobalNamespace::BeatmapLevelPackCollectionSO get_ostAndExtrasCollection() ;

/// @brief Method get_dlcCollection addr 0x2239f1c size 0x8 virtual false final false
 GlobalNamespace::BeatmapLevelPackCollectionSO get_dlcCollection() ;

/// @brief Method ToLocalizedName addr 0x2239f24 size 0x18 virtual false final false
 ::StringW ToLocalizedName(::StringW serializedName) ;

/// @brief Method ToLocalizedName addr 0x2239f3c size 0xbc virtual false final false
 ::StringW ToLocalizedName(::StringW serializedName, ByRef<bool> plural) ;

/// @brief Method ToSongPackMask addr 0x223a6dc size 0x70 virtual false final false
 bool ToSongPackMask(::StringW serializedName, ByRef<GlobalNamespace::SongPackMask> songPackMask) ;

/// @brief Method ToSongPackMask addr 0x223a74c size 0x34 virtual false final false
 GlobalNamespace::SongPackMask ToSongPackMask(::StringW serializedName) ;

/// @brief Method ToSerializedName addr 0x223a780 size 0x78 virtual false final false
 bool ToSerializedName(GlobalNamespace::SongPackMask songPackMask, ByRef<::StringW> serializedName) ;

/// @brief Method ToSerializedName addr 0x223a7f8 size 0x80 virtual false final false
 ::StringW ToSerializedName(GlobalNamespace::SongPackMask songPackMask) ;

/// @brief Method LazyInit addr 0x2239ff8 size 0x6e4 virtual false final false
 void LazyInit() ;

// Ctor Parameters []
explicit SongPackMaskModelSO() ;

/// @brief Method .ctor addr 0x223ac74 size 0x8 virtual false final false
 void _ctor() ;
