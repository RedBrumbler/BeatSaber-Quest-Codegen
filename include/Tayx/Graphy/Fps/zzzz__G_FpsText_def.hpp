...
/// @brief Method Awake addr 0x28a8468 size 0x4 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x28a8570 size 0x30c virtual false final false
 void Update() ;

/// @brief Method UpdateParameters addr 0x28a7e4c size 0x20 virtual false final false
 void UpdateParameters() ;

/// @brief Method SetFpsRelatedTextColor addr 0x28a887c size 0x7c virtual false final false
 void SetFpsRelatedTextColor(UnityEngine::UI::Text text, float_t fps) ;

/// @brief Method Init addr 0x28a846c size 0x104 virtual false final false
 void Init() ;

// Ctor Parameters []
explicit G_FpsText() ;

/// @brief Method .ctor addr 0x28a88f8 size 0x10 virtual false final false
 void _ctor() ;
