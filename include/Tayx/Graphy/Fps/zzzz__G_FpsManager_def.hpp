...
/// @brief Method Awake addr 0x28a791c size 0x4 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x28a7dc4 size 0x4 virtual false final false
 void Start() ;

/// @brief Method SetPosition addr 0x28a138c size 0x2e8 virtual true final true
 void SetPosition(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition newModulePosition) ;

/// @brief Method SetState addr 0x28a1c88 size 0x1b0 virtual true final true
 void SetState(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState state, bool silentUpdate) ;

/// @brief Method RestorePreviousState addr 0x28a4050 size 0xc virtual false final false
 void RestorePreviousState() ;

/// @brief Method UpdateParameters addr 0x28a1e68 size 0x1fc virtual false final false
 void UpdateParameters() ;

/// @brief Method RefreshParameters addr 0x28a46c8 size 0x1f4 virtual false final false
 void RefreshParameters() ;

/// @brief Method Init addr 0x28a7920 size 0x4a4 virtual false final false
 void Init() ;

/// @brief Method SetGraphActive addr 0x28a7dc8 size 0x44 virtual false final false
 void SetGraphActive(bool active) ;

// Ctor Parameters []
explicit G_FpsManager() ;

/// @brief Method .ctor addr 0x28a7e6c size 0xe4 virtual false final false
 void _ctor() ;
