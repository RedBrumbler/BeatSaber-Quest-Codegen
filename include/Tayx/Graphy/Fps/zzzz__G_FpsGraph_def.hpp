...
/// @brief Method Update addr 0x28a739c size 0xc virtual false final false
 void Update() ;

/// @brief Method UpdateParameters addr 0x28a73a8 size 0x100 virtual false final false
 void UpdateParameters() ;

/// @brief Method UpdateGraph addr 0x28a74a8 size 0x244 virtual true final false
 void UpdateGraph() ;

/// @brief Method CreatePoints addr 0x28a77c0 size 0x14c virtual true final false
 void CreatePoints() ;

/// @brief Method Init addr 0x28a76ec size 0xd4 virtual false final false
 void Init() ;

// Ctor Parameters []
explicit G_FpsGraph() ;

/// @brief Method .ctor addr 0x28a790c size 0x10 virtual false final false
 void _ctor() ;
