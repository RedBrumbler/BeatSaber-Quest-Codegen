...
/// @brief Method .ctor addr 0x28a8440 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Update>b__25_0 addr 0x28a8448 size 0x20 virtual false final false
...
/// @brief Method get_CurrentFPS addr 0x28a7f50 size 0x8 virtual false final false
 int16_t get_CurrentFPS() ;

/// @brief Method set_CurrentFPS addr 0x28a7f58 size 0x8 virtual false final false
 void set_CurrentFPS(int16_t value) ;

/// @brief Method get_AverageFPS addr 0x28a7f60 size 0x8 virtual false final false
 int16_t get_AverageFPS() ;

/// @brief Method set_AverageFPS addr 0x28a7f68 size 0x8 virtual false final false
 void set_AverageFPS(int16_t value) ;

/// @brief Method get_OnePercentFPS addr 0x28a7f70 size 0x8 virtual false final false
 int16_t get_OnePercentFPS() ;

/// @brief Method set_OnePercentFPS addr 0x28a7f78 size 0x8 virtual false final false
 void set_OnePercentFPS(int16_t value) ;

/// @brief Method get_Zero1PercentFps addr 0x28a7f80 size 0x8 virtual false final false
 int16_t get_Zero1PercentFps() ;

/// @brief Method set_Zero1PercentFps addr 0x28a7f88 size 0x8 virtual false final false
 void set_Zero1PercentFps(int16_t value) ;

/// @brief Method Awake addr 0x28a7f90 size 0x4 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x28a8030 size 0x390 virtual false final false
 void Update() ;

/// @brief Method UpdateParameters addr 0x28a7e0c size 0x40 virtual false final false
 void UpdateParameters() ;

/// @brief Method Init addr 0x28a7f94 size 0x9c virtual false final false
 void Init() ;

// Ctor Parameters []
explicit G_FpsMonitor() ;

/// @brief Method .ctor addr 0x28a83c0 size 0x1c virtual false final false
 void _ctor() ;
