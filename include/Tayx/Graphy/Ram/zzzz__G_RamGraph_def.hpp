...
/// @brief Method Update addr 0x28a61b0 size 0xc virtual false final false
 void Update() ;

/// @brief Method UpdateParameters addr 0x28a61bc size 0x258 virtual false final false
 void UpdateParameters() ;

/// @brief Method UpdateGraph addr 0x28a6414 size 0x268 virtual true final false
 void UpdateGraph() ;

/// @brief Method CreatePoints addr 0x28a67a0 size 0x2ec virtual true final false
 void CreatePoints() ;

/// @brief Method Init addr 0x28a667c size 0x124 virtual false final false
 void Init() ;

// Ctor Parameters []
explicit G_RamGraph() ;

/// @brief Method .ctor addr 0x28a6a8c size 0x10 virtual false final false
 void _ctor() ;
