...
/// @brief Method Awake addr 0x28a7164 size 0x4 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x28a722c size 0x160 virtual false final false
 void Update() ;

/// @brief Method UpdateParameters addr 0x28a6f70 size 0xa0 virtual false final false
 void UpdateParameters() ;

/// @brief Method Init addr 0x28a7168 size 0xc4 virtual false final false
 void Init() ;

// Ctor Parameters []
explicit G_RamText() ;

/// @brief Method .ctor addr 0x28a738c size 0x10 virtual false final false
 void _ctor() ;
