...
/// @brief Method get_AllocatedRam addr 0x28a70d0 size 0x8 virtual false final false
 float_t get_AllocatedRam() ;

/// @brief Method set_AllocatedRam addr 0x28a70d8 size 0x8 virtual false final false
 void set_AllocatedRam(float_t value) ;

/// @brief Method get_ReservedRam addr 0x28a70e0 size 0x8 virtual false final false
 float_t get_ReservedRam() ;

/// @brief Method set_ReservedRam addr 0x28a70e8 size 0x8 virtual false final false
 void set_ReservedRam(float_t value) ;

/// @brief Method get_MonoRam addr 0x28a70f0 size 0x8 virtual false final false
 float_t get_MonoRam() ;

/// @brief Method set_MonoRam addr 0x28a70f8 size 0x8 virtual false final false
 void set_MonoRam(float_t value) ;

/// @brief Method Update addr 0x28a7100 size 0x5c virtual false final false
 void Update() ;

// Ctor Parameters []
explicit G_RamMonitor() ;

/// @brief Method .ctor addr 0x28a715c size 0x8 virtual false final false
 void _ctor() ;
