...
/// @brief Method InitializeShader addr 0x28a4d9c size 0x17c virtual false final false
 void InitializeShader() ;

/// @brief Method UpdateArray addr 0x28a4f18 size 0x44 virtual false final false
 void UpdateArray() ;

/// @brief Method UpdateAverage addr 0x28a4f5c size 0x3c virtual false final false
 void UpdateAverage() ;

/// @brief Method UpdateThresholds addr 0x28a4f98 size 0x68 virtual false final false
 void UpdateThresholds() ;

/// @brief Method UpdateColors addr 0x28a5000 size 0xa0 virtual false final false
 void UpdateColors() ;

/// @brief Method UpdatePoints addr 0x28a50a0 size 0x3c virtual false final false
 void UpdatePoints() ;

// Ctor Parameters []
explicit G_GraphShader() ;

/// @brief Method .ctor addr 0x28a50dc size 0x88 virtual false final false
 void _ctor() ;
