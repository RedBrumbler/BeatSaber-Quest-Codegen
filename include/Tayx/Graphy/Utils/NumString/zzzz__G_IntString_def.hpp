...
/// @brief Method get_MinValue addr 0x28a5cc0 size 0x6c virtual false final false
static int32_t get_MinValue() ;

/// @brief Method get_MaxValue addr 0x28a5d2c size 0x64 virtual false final false
static int32_t get_MaxValue() ;

/// @brief Method Init addr 0x28a5d90 size 0x280 virtual false final false
static void Init(int32_t minNegativeValue, int32_t maxPositiveValue) ;

/// @brief Method Dispose addr 0x28a37ac size 0x98 virtual false final false
static void Dispose() ;

/// @brief Method ToStringNonAlloc addr 0x28a6010 size 0x120 virtual false final false
