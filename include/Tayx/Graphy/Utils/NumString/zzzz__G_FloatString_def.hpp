...
/// @brief Method get_MinValue addr 0x28a54f8 size 0x70 virtual false final false
static float_t get_MinValue() ;

/// @brief Method get_MaxValue addr 0x28a55cc size 0x68 virtual false final false
static float_t get_MaxValue() ;

/// @brief Method Init addr 0x28a5634 size 0x298 virtual false final false
static void Init(float_t minNegativeValue, float_t maxPositiveValue) ;

/// @brief Method Dispose addr 0x28a3844 size 0x98 virtual false final false
static void Dispose() ;

/// @brief Method ToStringNonAlloc addr 0x28a598c size 0x140 virtual false final false
static ::StringW ToStringNonAlloc(float_t value) ;

/// @brief Method ToStringNonAlloc addr 0x28a5acc size 0x140 virtual false final false
static ::StringW ToStringNonAlloc(float_t value, ::StringW format) ;

/// @brief Method ToInt addr 0x28a5c0c size 0x1c virtual false final false
static int32_t ToInt(float_t f) ;

/// @brief Method ToFloat addr 0x28a5c28 size 0x8 virtual false final false
static float_t ToFloat(int32_t i) ;

/// @brief Method ToIndex addr 0x28a58cc size 0xc0 virtual false final false
static int32_t ToIndex(float_t f) ;

/// @brief Method FromIndex addr 0x28a5568 size 0x64 virtual false final false
