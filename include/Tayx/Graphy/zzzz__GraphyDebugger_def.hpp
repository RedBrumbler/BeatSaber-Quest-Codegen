...
/// @brief Method get_Check addr 0x28a1094 size 0x8 virtual false final false
 bool get_Check() ;

/// @brief Method Update addr 0x28a0994 size 0x5c virtual false final false
 void Update() ;

/// @brief Method Executed addr 0x28a1088 size 0xc virtual false final false
 void Executed() ;

// Ctor Parameters []
explicit Tayx__Graphy__GraphyDebugger__DebugPacket() ;

/// @brief Method .ctor addr 0x289ff7c size 0x11c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x28a0464 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetFirstDebugPacketWithId>b__0 addr 0x28a109c size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x28a0548 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetAllDebugPacketsWithId>b__0 addr 0x28a10c0 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x28a06c8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <RemoveAllDebugPacketsWithId>b__0 addr 0x28a10e4 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x28a116c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <CheckDebugPackets>b__24_0 addr 0x28a1174 size 0xc virtual false final false
...
namespace Tayx::Graphy {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15213), inst: 2454 }), TypeDefinitionIndex(TypeDefinitionIndex(15213))}
...
/// @brief Method .ctor addr 0x289f7bc size 0xbc virtual false final false
 void _ctor() ;

/// @brief Method Start addr 0x289f878 size 0xa0 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x289f918 size 0x4 virtual false final false
 void Update() ;

/// @brief Method AddNewDebugPacket addr 0x289fd38 size 0xa8 virtual false final false
 void AddNewDebugPacket(Tayx::Graphy::Tayx__Graphy__GraphyDebugger__DebugPacket newDebugPacket) ;

/// @brief Method AddNewDebugPacket addr 0x289fde0 size 0x19c virtual false final false
...
/// @brief Method AddNewDebugPacket addr 0x28a0098 size 0x118 virtual false final false
...
/// @brief Method AddNewDebugPacket addr 0x28a01b0 size 0x130 virtual false final false
...
/// @brief Method AddNewDebugPacket addr 0x28a02e0 size 0xac virtual false final false
...
/// @brief Method GetFirstDebugPacketWithId addr 0x28a038c size 0xd8 virtual false final false
 Tayx::Graphy::Tayx__Graphy__GraphyDebugger__DebugPacket GetFirstDebugPacketWithId(int32_t packetId) ;

/// @brief Method GetAllDebugPacketsWithId addr 0x28a046c size 0xdc virtual false final false
...
/// @brief Method RemoveFirstDebugPacketWithId addr 0x28a0550 size 0x8c virtual false final false
 void RemoveFirstDebugPacketWithId(int32_t packetId) ;

/// @brief Method RemoveAllDebugPacketsWithId addr 0x28a05dc size 0xec virtual false final false
 void RemoveAllDebugPacketsWithId(int32_t packetId) ;

/// @brief Method AddCallbackToFirstDebugPacketWithId addr 0x28a06d0 size 0xd8 virtual false final false
 void AddCallbackToFirstDebugPacketWithId(System::Action callback, int32_t id) ;

/// @brief Method AddCallbackToAllDebugPacketWithId addr 0x28a07a8 size 0x1ec virtual false final false
 void AddCallbackToAllDebugPacketWithId(System::Action callback, int32_t id) ;

/// @brief Method CheckDebugPackets addr 0x289f91c size 0x41c virtual false final false
 void CheckDebugPackets() ;

/// @brief Method CheckIfConditionIsMet addr 0x28a09f0 size 0x110 virtual false final false
 bool CheckIfConditionIsMet(Tayx::Graphy::Tayx__Graphy__GraphyDebugger__DebugCondition debugCondition) ;

/// @brief Method GetRequestedValueFromDebugVariable addr 0x28a0ebc size 0x1cc virtual false final false
 float_t GetRequestedValueFromDebugVariable(Tayx::Graphy::Tayx__Graphy__GraphyDebugger__DebugVariable debugVariable) ;

/// @brief Method ExecuteOperationsInDebugPacket addr 0x28a0b00 size 0x3bc virtual false final false
