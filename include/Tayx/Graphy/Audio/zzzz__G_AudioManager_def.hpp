...
/// @brief Method Awake addr 0x28a93d0 size 0x4 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x28a9878 size 0x4 virtual false final false
 void Start() ;

/// @brief Method SetPosition addr 0x28a195c size 0x300 virtual true final true
 void SetPosition(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition newModulePosition) ;

/// @brief Method SetState addr 0x28a266c size 0x150 virtual true final true
 void SetState(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState state, bool silentUpdate) ;

/// @brief Method RestorePreviousState addr 0x28a4068 size 0xc virtual false final false
 void RestorePreviousState() ;

/// @brief Method UpdateParameters addr 0x28a27e4 size 0x1c4 virtual false final false
 void UpdateParameters() ;

/// @brief Method RefreshParameters addr 0x28a4a50 size 0x1bc virtual false final false
 void RefreshParameters() ;

/// @brief Method Init addr 0x28a93d4 size 0x4a4 virtual false final false
 void Init() ;

/// @brief Method SetGraphActive addr 0x28a987c size 0x44 virtual false final false
 void SetGraphActive(bool active) ;

// Ctor Parameters []
explicit G_AudioManager() ;

/// @brief Method .ctor addr 0x28a99b0 size 0xc0 virtual false final false
 void _ctor() ;
