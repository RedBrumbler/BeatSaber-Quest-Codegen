...
/// @brief Method get_Spectrum addr 0x28a9a70 size 0x8 virtual false final false
 ::ArrayW<float_t> get_Spectrum() ;

/// @brief Method set_Spectrum addr 0x28a9a78 size 0x8 virtual false final false
 void set_Spectrum(::ArrayW<float_t> value) ;

/// @brief Method get_SpectrumHighestValues addr 0x28a9a80 size 0x8 virtual false final false
 ::ArrayW<float_t> get_SpectrumHighestValues() ;

/// @brief Method set_SpectrumHighestValues addr 0x28a9a88 size 0x8 virtual false final false
 void set_SpectrumHighestValues(::ArrayW<float_t> value) ;

/// @brief Method get_MaxDB addr 0x28a9a90 size 0x8 virtual false final false
 float_t get_MaxDB() ;

/// @brief Method set_MaxDB addr 0x28a9a98 size 0x8 virtual false final false
 void set_MaxDB(float_t value) ;

/// @brief Method get_SpectrumDataAvailable addr 0x28a8990 size 0x60 virtual false final false
 bool get_SpectrumDataAvailable() ;

/// @brief Method Awake addr 0x28a9aa0 size 0x4 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x28a9b8c size 0x1ec virtual false final false
 void Update() ;

/// @brief Method OnDestroy addr 0x28a9e2c size 0xa4 virtual false final false
 void OnDestroy() ;

/// @brief Method UpdateParameters addr 0x28a98c0 size 0xd0 virtual false final false
 void UpdateParameters() ;

/// @brief Method lin2dB addr 0x28a9168 size 0x30 virtual false final false
 float_t lin2dB(float_t linear) ;

/// @brief Method dBNormalized addr 0x28a9198 size 0x14 virtual false final false
 float_t dBNormalized(float_t db) ;

/// @brief Method FindAudioListener addr 0x28a9d78 size 0xb4 virtual false final false
 UnityEngine::AudioListener FindAudioListener() ;

/// @brief Method OnSceneLoaded addr 0x28a9ed0 size 0x24 virtual false final false
 void OnSceneLoaded(UnityEngine::SceneManagement::Scene scene, UnityEngine::SceneManagement::LoadSceneMode loadSceneMode) ;

/// @brief Method Init addr 0x28a9aa4 size 0xe8 virtual false final false
 void Init() ;

// Ctor Parameters []
explicit G_AudioMonitor() ;

/// @brief Method .ctor addr 0x28a9ef4 size 0x1c virtual false final false
 void _ctor() ;
