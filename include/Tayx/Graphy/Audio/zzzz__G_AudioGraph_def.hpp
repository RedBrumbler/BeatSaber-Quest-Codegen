...
namespace Tayx::Graphy::Audio {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15222))}
...
/// @brief Method OnEnable addr 0x28a8908 size 0x50 virtual false final false
 void OnEnable() ;

/// @brief Method Update addr 0x28a8958 size 0x38 virtual false final false
 void Update() ;

/// @brief Method UpdateParameters addr 0x28a89f0 size 0x1ac virtual false final false
 void UpdateParameters() ;

/// @brief Method UpdateGraph addr 0x28a8b9c size 0x4d8 virtual true final false
 void UpdateGraph() ;

/// @brief Method CreatePoints addr 0x28a91ac size 0x214 virtual true final false
 void CreatePoints() ;

/// @brief Method Init addr 0x28a9074 size 0xf4 virtual false final false
 void Init() ;

// Ctor Parameters []
explicit G_AudioGraph() ;

/// @brief Method .ctor addr 0x28a93c0 size 0x10 virtual false final false
 void _ctor() ;
