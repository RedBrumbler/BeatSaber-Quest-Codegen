...
/// @brief Method Awake addr 0x28a9f10 size 0x4 virtual false final false
 void Awake() ;

/// @brief Method Update addr 0x28a9fe4 size 0x100 virtual false final false
 void Update() ;

/// @brief Method UpdateParameters addr 0x28a9990 size 0x20 virtual false final false
 void UpdateParameters() ;

/// @brief Method Init addr 0x28a9f14 size 0xd0 virtual false final false
 void Init() ;

// Ctor Parameters []
explicit G_AudioText() ;

/// @brief Method .ctor addr 0x28aa0e4 size 0x10 virtual false final false
 void _ctor() ;
