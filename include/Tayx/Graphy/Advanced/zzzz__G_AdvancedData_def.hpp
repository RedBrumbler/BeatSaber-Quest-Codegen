...
/// @brief Method OnEnable addr 0x28aa0f4 size 0x4 virtual false final false
 void OnEnable() ;

/// @brief Method Update addr 0x28aaf70 size 0x284 virtual false final false
 void Update() ;

/// @brief Method SetPosition addr 0x28a2ba4 size 0x660 virtual true final true
 void SetPosition(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModulePosition newModulePosition) ;

/// @brief Method SetState addr 0x28a2b04 size 0x78 virtual true final true
 void SetState(Tayx::Graphy::Tayx__Graphy__GraphyManager__ModuleState state, bool silentUpdate) ;

/// @brief Method RestorePreviousState addr 0x28a4074 size 0xc virtual false final false
 void RestorePreviousState() ;

/// @brief Method UpdateParameters addr 0x28a4530 size 0x198 virtual false final false
 void UpdateParameters() ;

/// @brief Method RefreshParameters addr 0x28a4c0c size 0x190 virtual false final false
 void RefreshParameters() ;

/// @brief Method Init addr 0x28aa0f8 size 0xe78 virtual false final false
 void Init() ;

// Ctor Parameters []
explicit G_AdvancedData() ;

/// @brief Method .ctor addr 0x28ab1f4 size 0x23c virtual false final false
 void _ctor() ;
