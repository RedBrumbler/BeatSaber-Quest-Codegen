...
/// @brief Method .ctor addr 0x20b48b8 size 0x8 virtual false final false
 void _ctor(int64_t value) ;

/// @brief Method ReadUnfenced addr 0x20b48c0 size 0x8 virtual false final false
 int64_t ReadUnfenced() ;

/// @brief Method ReadAcquireFence addr 0x20b48c8 size 0x1c virtual false final false
 int64_t ReadAcquireFence() ;

/// @brief Method ReadFullFence addr 0x20b48e4 size 0x1c virtual false final false
 int64_t ReadFullFence() ;

/// @brief Method ReadCompilerOnlyFence addr 0x20b4900 size 0x24 virtual false final false
 int64_t ReadCompilerOnlyFence() ;

/// @brief Method WriteReleaseFence addr 0x20b4924 size 0x28 virtual false final false
 void WriteReleaseFence(int64_t newValue) ;

/// @brief Method WriteFullFence addr 0x20b494c size 0x28 virtual false final false
 void WriteFullFence(int64_t newValue) ;

/// @brief Method WriteCompilerOnlyFence addr 0x20b4974 size 0x2c virtual false final false
 void WriteCompilerOnlyFence(int64_t newValue) ;

/// @brief Method WriteUnfenced addr 0x20b49a0 size 0x8 virtual false final false
 void WriteUnfenced(int64_t newValue) ;

/// @brief Method AtomicCompareExchange addr 0x20b49a8 size 0x24 virtual false final false
 bool AtomicCompareExchange(int64_t newValue, int64_t comparand) ;

/// @brief Method AtomicExchange addr 0x20b49cc size 0xc virtual false final false
 int64_t AtomicExchange(int64_t newValue) ;

/// @brief Method AtomicAddAndGet addr 0x20b49d8 size 0xc virtual false final false
 int64_t AtomicAddAndGet(int64_t delta) ;

/// @brief Method AtomicIncrementAndGet addr 0x20b49e4 size 0xc virtual false final false
 int64_t AtomicIncrementAndGet() ;

/// @brief Method AtomicDecrementAndGet addr 0x20b49f0 size 0xc virtual false final false
 int64_t AtomicDecrementAndGet() ;

/// @brief Method ToString addr 0x20b49fc size 0x34 virtual true final false
 ::StringW ToString() ;
