...
/// @brief Method GetUserPlatformFromSerializedName addr 0x220eeb4 size 0x11c virtual false final false
static BeatSaberAPI::DataTransferObjects::UserPlatform GetUserPlatformFromSerializedName(::StringW name) ;

/// @brief Method GetUserPlatformSerializedName addr 0x220efd0 size 0xa8 virtual false final false
