...
/// @brief Method get_proof addr 0x220ee7c size 0x8 virtual false final false
 ::StringW get_proof() ;

/// @brief Method set_proof addr 0x220ee84 size 0x8 virtual false final false
 void set_proof(::StringW value) ;

// Ctor Parameters []
explicit ResultProof() ;

/// @brief Method .ctor addr 0x220ee8c size 0x8 virtual false final false
 void _ctor() ;
