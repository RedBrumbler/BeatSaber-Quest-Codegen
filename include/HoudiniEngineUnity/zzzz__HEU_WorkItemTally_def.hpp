...
/// @brief Method ZeroAll addr 0x2061674 size 0xc virtual false final false
 void ZeroAll() ;

/// @brief Method AreAllWorkItemsComplete addr 0x2062720 size 0x38 virtual false final false
 bool AreAllWorkItemsComplete() ;

/// @brief Method AnyWorkItemsFailed addr 0x2062758 size 0x10 virtual false final false
 bool AnyWorkItemsFailed() ;

/// @brief Method AnyWorkItemsPending addr 0x20627c0 size 0x44 virtual false final false
 bool AnyWorkItemsPending() ;

/// @brief Method ProgressRatio addr 0x2062804 size 0xac virtual false final false
 ::StringW ProgressRatio() ;

// Ctor Parameters []
explicit HEU_WorkItemTally() ;

/// @brief Method .ctor addr 0x20625ac size 0x8 virtual false final false
 void _ctor() ;
