...
/// @brief Method .ctor addr 0x20a9fc4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ToTestObject>b__1_0 addr 0x20a9fcc size 0x64 virtual false final false
 HoudiniEngineUnity::Test_Material _ToTestObject_b__1_0(UnityEngine::Material lod) ;

/// @brief Method <ToTestObject>b__2_0 addr 0x20aa030 size 0x64 virtual false final false
...
/// @brief Method ToTestObject addr 0x20a9cd8 size 0x64 virtual false final false
static HoudiniEngineUnity::Test_Material ToTestObject(UnityEngine::Material self) ;

/// @brief Method ToTestObject addr 0x20a9d3c size 0x128 virtual false final false
static ::ArrayW<HoudiniEngineUnity::Test_Material> ToTestObject(::ArrayW<UnityEngine::Material> self) ;

/// @brief Method ToTestObject addr 0x20a9e64 size 0xfc virtual false final false
