...
/// @brief Method get_HandleName addr 0x2055bf8 size 0x8 virtual false final false
 ::StringW get_HandleName() ;

/// @brief Method get_HandleType addr 0x2055c00 size 0x8 virtual false final false
 HoudiniEngineUnity::HoudiniEngineUnity__HEU_Handle__HEU_HandleType get_HandleType() ;

/// @brief Method get_RSTOrder addr 0x2055c08 size 0x8 virtual false final false
 HoudiniEngineUnity::HAPI_RSTOrder get_RSTOrder() ;

/// @brief Method get_XYZOrder addr 0x2055c10 size 0x8 virtual false final false
 HoudiniEngineUnity::HAPI_XYZOrder get_XYZOrder() ;

/// @brief Method get_ConvertedTransformEuler addr 0x2055c18 size 0x14 virtual false final false
 HoudiniEngineUnity::HAPI_TransformEuler get_ConvertedTransformEuler() ;

/// @brief Method HasTranslateHandle addr 0x2055c2c size 0x10 virtual false final false
 bool HasTranslateHandle() ;

/// @brief Method HasRotateHandle addr 0x2055c3c size 0x10 virtual false final false
 bool HasRotateHandle() ;

/// @brief Method HasScaleHandle addr 0x2055c4c size 0x10 virtual false final false
 bool HasScaleHandle() ;

/// @brief Method IsTranslateHandleDisabled addr 0x2055c5c size 0x20 virtual false final false
 bool IsTranslateHandleDisabled() ;

/// @brief Method IsRotateHandleDisabled addr 0x2055c7c size 0x20 virtual false final false
 bool IsRotateHandleDisabled() ;

/// @brief Method IsScaleHandleDisabled addr 0x2055c9c size 0x20 virtual false final false
 bool IsScaleHandleDisabled() ;

/// @brief Method GetTranslateBinding addr 0x2055cbc size 0x8 virtual false final false
 HoudiniEngineUnity::HEU_HandleParamBinding GetTranslateBinding() ;

/// @brief Method GetRotateBinding addr 0x2055cc4 size 0x8 virtual false final false
 HoudiniEngineUnity::HEU_HandleParamBinding GetRotateBinding() ;

/// @brief Method GetScaleBinding addr 0x2055ccc size 0x8 virtual false final false
 HoudiniEngineUnity::HEU_HandleParamBinding GetScaleBinding() ;

/// @brief Method get_HandlePosition addr 0x2055cd4 size 0xc virtual false final false
 UnityEngine::Vector3 get_HandlePosition() ;

/// @brief Method get_HandleRotation addr 0x2055ce0 size 0xc virtual false final false
 UnityEngine::Quaternion get_HandleRotation() ;

/// @brief Method get_HandleScale addr 0x2055cec size 0xc virtual false final false
 UnityEngine::Vector3 get_HandleScale() ;

/// @brief Method SetupHandle addr 0x2055cf8 size 0x7cc virtual false final false
...
/// @brief Method CleanUp addr 0x2056bf8 size 0xc virtual false final false
 void CleanUp() ;

/// @brief Method GenerateTransform addr 0x205670c size 0x4ec virtual false final false
 void GenerateTransform(HoudiniEngineUnity::HEU_SessionBase session, HoudiniEngineUnity::HEU_Parameters parameters) ;

/// @brief Method GetUpdatedPosition addr 0x2056c1c size 0x160 virtual false final false
 bool GetUpdatedPosition(HoudiniEngineUnity::HEU_HoudiniAsset asset, ByRef<UnityEngine::Vector3> inPosition) ;

/// @brief Method GetUpdatedRotation addr 0x2056d7c size 0x1fc virtual false final false
 bool GetUpdatedRotation(HoudiniEngineUnity::HEU_HoudiniAsset asset, ByRef<UnityEngine::Quaternion> inRotation) ;

/// @brief Method IsSpecialRSTOrder addr 0x2056c04 size 0x18 virtual false final false
static bool IsSpecialRSTOrder(HoudiniEngineUnity::HAPI_RSTOrder rstOrder) ;

/// @brief Method IsEquivalentTo addr 0x2056f78 size 0x4fc virtual true final true
 bool IsEquivalentTo(HoudiniEngineUnity::HEU_Handle other) ;

// Ctor Parameters []
explicit HEU_Handle() ;

/// @brief Method .ctor addr 0x2057474 size 0xd4 virtual false final false
 void _ctor() ;
