...
/// @brief Method .ctor addr 0x20aca84 size 0x28 virtual false final false
 void _ctor(UnityEngine::Texture2D self) ;

/// @brief Method IsNull addr 0x20acaac size 0x60 virtual true final true
 bool IsNull() ;

/// @brief Method IsEquivalentTo addr 0x20acb0c size 0x108 virtual true final true
