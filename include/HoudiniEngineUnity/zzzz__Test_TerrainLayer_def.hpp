...
/// @brief Method .ctor addr 0x20ac1a8 size 0x28 virtual false final false
 void _ctor(UnityEngine::TerrainLayer self) ;

/// @brief Method IsNull addr 0x20ac1d0 size 0x60 virtual true final true
 bool IsNull() ;

/// @brief Method IsEquivalentTo addr 0x20ac230 size 0x464 virtual true final true
