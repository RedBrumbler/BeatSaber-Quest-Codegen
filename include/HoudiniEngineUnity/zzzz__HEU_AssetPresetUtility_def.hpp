...
/// @brief Method SaveAssetPresetToFile addr 0x2014724 size 0x640 virtual false final false
static void SaveAssetPresetToFile(HoudiniEngineUnity::HEU_HoudiniAsset asset, ::StringW filePath) ;

/// @brief Method LoadPresetFileIntoAssetAndCook addr 0x2015550 size 0x668 virtual false final false
