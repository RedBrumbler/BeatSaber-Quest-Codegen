...
/// @brief Method .ctor addr 0x20adf00 size 0x28 virtual false final false
 void _ctor(UnityEngine::Terrain self) ;

/// @brief Method IsNull addr 0x20adf28 size 0x60 virtual true final true
 bool IsNull() ;

/// @brief Method IsEquivalentTo addr 0x20adf88 size 0x15c virtual true final true
