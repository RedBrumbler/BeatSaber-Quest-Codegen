...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(9815)), TypeDefinitionIndex(TypeDefinitionIndex(9626)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9815), inst: 2478 })}
...
/// @brief Method .ctor addr 0x2049758 size 0x48 virtual false final false
 void _ctor() ;
