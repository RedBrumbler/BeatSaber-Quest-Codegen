...
/// @brief Method get_Tag addr 0x20a0c34 size 0x8 virtual true final false
 HoudiniEngineUnity::JSONNodeType get_Tag() ;

/// @brief Method get_IsBoolean addr 0x20a0c3c size 0x8 virtual true final false
 bool get_IsBoolean() ;

/// @brief Method GetEnumerator addr 0x20a0c44 size 0x14 virtual true final false
 HoudiniEngineUnity::HoudiniEngineUnity__JSONNode__Enumerator GetEnumerator() ;

/// @brief Method get_Value addr 0x20a0c58 size 0xc virtual true final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x20a0c64 size 0x7c virtual true final false
 void set_Value(::StringW value) ;

/// @brief Method get_AsBool addr 0x20a0ce0 size 0x8 virtual true final false
 bool get_AsBool() ;

/// @brief Method set_AsBool addr 0x20a0ce8 size 0xc virtual true final false
...
/// @brief Method .ctor addr 0x209ac34 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x20a0cf4 size 0x34 virtual false final false
 void _ctor(::StringW aData) ;

/// @brief Method WriteToStringBuilder addr 0x20a0d28 size 0x78 virtual true final false
...
/// @brief Method Equals addr 0x20a0da0 size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x20a0e18 size 0xc virtual true final false
 int32_t GetHashCode() ;
