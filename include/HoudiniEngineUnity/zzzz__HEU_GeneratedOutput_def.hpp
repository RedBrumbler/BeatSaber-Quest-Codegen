...
/// @brief Method get_IsInstancer addr 0x201ba90 size 0x8 virtual false final false
 bool get_IsInstancer() ;

/// @brief Method set_IsInstancer addr 0x201ba98 size 0xc virtual false final false
 void set_IsInstancer(bool value) ;

/// @brief Method ResetMaterialOverrides addr 0x201baa4 size 0x15c virtual false final false
static void ResetMaterialOverrides(HoudiniEngineUnity::HEU_GeneratedOutput output) ;

/// @brief Method ResetMaterialOverrides addr 0x201bc54 size 0xac virtual false final false
static void ResetMaterialOverrides(HoudiniEngineUnity::HEU_GeneratedOutputData outputData) ;

/// @brief Method GetGeneratedMaterialsForGameObject addr 0x201bd00 size 0x1ec virtual false final false
...
/// @brief Method HasLODGroup addr 0x201bc00 size 0x54 virtual false final false
static bool HasLODGroup(HoudiniEngineUnity::HEU_GeneratedOutput output) ;

/// @brief Method IsOutputUsingMaterial addr 0x201beec size 0x160 virtual false final false
static bool IsOutputUsingMaterial(UnityEngine::Material checkMaterial, HoudiniEngineUnity::HEU_GeneratedOutput output) ;

/// @brief Method IsOutputDataUsingMaterial addr 0x201c04c size 0x1b4 virtual false final false
...
/// @brief Method ClearGeneratedMaterialReferences addr 0x201c200 size 0x18 virtual false final false
static void ClearGeneratedMaterialReferences(HoudiniEngineUnity::HEU_GeneratedOutputData generatedOutputData) ;

/// @brief Method DestroyAllGeneratedColliders addr 0x201c218 size 0x238 virtual false final false
static void DestroyAllGeneratedColliders(HoudiniEngineUnity::HEU_GeneratedOutputData outputData) ;

/// @brief Method DestroyGeneratedOutput addr 0x201c450 size 0x180 virtual false final false
static void DestroyGeneratedOutput(HoudiniEngineUnity::HEU_GeneratedOutput generatedOutput) ;

/// @brief Method DestroyGeneratedOutputChildren addr 0x201c5d0 size 0x174 virtual false final false
static void DestroyGeneratedOutputChildren(HoudiniEngineUnity::HEU_GeneratedOutput generatedOutput) ;

/// @brief Method DestroyGeneratedOutputData addr 0x201c744 size 0x4c virtual false final false
...
/// @brief Method ClearMaterialsNoLongerUsed addr 0x201c790 size 0x114 virtual false final false
...
/// @brief Method CopyMaterialOverrides addr 0x201c8a4 size 0x290 virtual false final false
...
/// @brief Method WriteOutputToAssetCache addr 0x201cb34 size 0x5c virtual false final false
 void WriteOutputToAssetCache(UnityEngine::GameObject parentObject, ::StringW outputPath, bool bIsInstancer) ;

/// @brief Method BakeGameObjectComponents addr 0x201cb90 size 0x128 virtual false final false
...
/// @brief Method IsEquivalentTo addr 0x201ccb8 size 0x1a8 virtual true final true
 bool IsEquivalentTo(HoudiniEngineUnity::HEU_GeneratedOutput other) ;

// Ctor Parameters []
explicit HEU_GeneratedOutput() ;

/// @brief Method .ctor addr 0x2013688 size 0xa8 virtual false final false
 void _ctor() ;
