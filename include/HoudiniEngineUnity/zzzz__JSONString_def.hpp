...
/// @brief Method get_Tag addr 0x20a05cc size 0x8 virtual true final false
 HoudiniEngineUnity::JSONNodeType get_Tag() ;

/// @brief Method get_IsString addr 0x20a05d4 size 0x8 virtual true final false
 bool get_IsString() ;

/// @brief Method GetEnumerator addr 0x20a05dc size 0x14 virtual true final false
 HoudiniEngineUnity::HoudiniEngineUnity__JSONNode__Enumerator GetEnumerator() ;

/// @brief Method get_Value addr 0x20a05f0 size 0x8 virtual true final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x20a05f8 size 0x8 virtual true final false
 void set_Value(::StringW value) ;

// Ctor Parameters [CppParam { name: "aData", ty: "::StringW", modifiers: "", def_value: None }]
explicit JSONString(::StringW aData) ;

/// @brief Method .ctor addr 0x209a6d0 size 0x28 virtual false final false
 void _ctor(::StringW aData) ;

/// @brief Method WriteToStringBuilder addr 0x20a0600 size 0x5c virtual true final false
...
/// @brief Method Equals addr 0x20a065c size 0xec virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x20a0748 size 0x20 virtual true final false
 int32_t GetHashCode() ;
