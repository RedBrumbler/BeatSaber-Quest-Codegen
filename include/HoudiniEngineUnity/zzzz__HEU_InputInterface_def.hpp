...
/// @brief Method get_Priority addr 0x208bff4 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x208bffc size 0x28 virtual false final false
 void _ctor(int32_t priority) ;

/// @brief Method RegisterInterface addr 0x208c024 size 0x58 virtual false final false
