...
/// @brief Method .ctor addr 0x20ac9b4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ToTestObject>b__1_0 addr 0x20ac9bc size 0x64 virtual false final false
 HoudiniEngineUnity::Test_TerrainLayer _ToTestObject_b__1_0(UnityEngine::TerrainLayer lod) ;

/// @brief Method <ToTestObject>b__2_0 addr 0x20aca20 size 0x64 virtual false final false
...
/// @brief Method ToTestObject addr 0x20ac6f8 size 0x64 virtual false final false
static HoudiniEngineUnity::Test_TerrainLayer ToTestObject(UnityEngine::TerrainLayer self) ;

/// @brief Method ToTestObject addr 0x20ac75c size 0xf8 virtual false final false
static ::ArrayW<HoudiniEngineUnity::Test_TerrainLayer> ToTestObject(::ArrayW<UnityEngine::TerrainLayer> self) ;

/// @brief Method ToTestObject addr 0x20ac854 size 0xfc virtual false final false
