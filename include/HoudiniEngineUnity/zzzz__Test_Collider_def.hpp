...
/// @brief Method .ctor addr 0x20aa094 size 0x28 virtual false final false
 void _ctor(UnityEngine::Collider self) ;

/// @brief Method IsNull addr 0x20aa0bc size 0x60 virtual true final true
 bool IsNull() ;

/// @brief Method IsEquivalentTo addr 0x20aa11c size 0x8 virtual true final true
