...
/// @brief Method CopyTo addr 0x20371e4 size 0x24 virtual false final false
 void CopyTo(HoudiniEngineUnity::HEU_InstanceInputUIState dest) ;

/// @brief Method IsEquivalentTo addr 0x2037208 size 0x1e4 virtual true final true
 bool IsEquivalentTo(HoudiniEngineUnity::HEU_InstanceInputUIState other) ;

// Ctor Parameters []
explicit HEU_InstanceInputUIState() ;

/// @brief Method .ctor addr 0x20373ec size 0x18 virtual false final false
 void _ctor() ;
