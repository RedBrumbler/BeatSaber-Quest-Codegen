...
/// @brief Method CreateOrGet addr 0x209b1bc size 0x94 virtual false final false
static HoudiniEngineUnity::JSONNull CreateOrGet() ;

// Ctor Parameters []
explicit JSONNull() ;

/// @brief Method .ctor addr 0x20a0e24 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_Tag addr 0x20a0e2c size 0x8 virtual true final false
 HoudiniEngineUnity::JSONNodeType get_Tag() ;

/// @brief Method get_IsNull addr 0x20a0e34 size 0x8 virtual true final false
 bool get_IsNull() ;

/// @brief Method GetEnumerator addr 0x20a0e3c size 0x14 virtual true final false
 HoudiniEngineUnity::HoudiniEngineUnity__JSONNode__Enumerator GetEnumerator() ;

/// @brief Method get_Value addr 0x20a0e50 size 0x40 virtual true final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x20a0e90 size 0x4 virtual true final false
 void set_Value(::StringW value) ;

/// @brief Method get_AsBool addr 0x20a0e94 size 0x8 virtual true final false
 bool get_AsBool() ;

/// @brief Method set_AsBool addr 0x20a0e9c size 0x4 virtual true final false
 void set_AsBool(bool value) ;

/// @brief Method Equals addr 0x20a0ea0 size 0x8c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x20a0f2c size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method WriteToStringBuilder addr 0x20a0f34 size 0x54 virtual true final false
