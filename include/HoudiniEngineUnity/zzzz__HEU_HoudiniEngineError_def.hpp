...
/// @brief Method .ctor addr 0x204f11c size 0x7c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x204f198 size 0x88 virtual false final false
 void _ctor(::StringW errorMsg) ;

/// @brief Method ToString addr 0x204f220 size 0x8 virtual true final false
 ::StringW ToString() ;
