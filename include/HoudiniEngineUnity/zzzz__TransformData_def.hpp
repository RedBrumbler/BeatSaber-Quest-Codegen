...
/// @brief Method .ctor addr 0x207a0e8 size 0x98 virtual false final false
 void _ctor(UnityEngine::Transform other) ;

/// @brief Method CopyTo addr 0x207a180 size 0x80 virtual false final false
 void CopyTo(UnityEngine::Transform other, bool copyParent) ;

/// @brief Method CopyToLocal addr 0x207a200 size 0x80 virtual false final false
