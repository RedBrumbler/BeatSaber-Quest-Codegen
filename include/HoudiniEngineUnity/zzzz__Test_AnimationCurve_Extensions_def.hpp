...
/// @brief Method .ctor addr 0x20ac0d8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ToTestObject>b__1_0 addr 0x20ac0e0 size 0x64 virtual false final false
 HoudiniEngineUnity::Test_AnimationCurve _ToTestObject_b__1_0(UnityEngine::AnimationCurve lod) ;

/// @brief Method <ToTestObject>b__2_0 addr 0x20ac144 size 0x64 virtual false final false
...
/// @brief Method ToTestObject addr 0x20abe1c size 0x64 virtual false final false
static HoudiniEngineUnity::Test_AnimationCurve ToTestObject(UnityEngine::AnimationCurve self) ;

/// @brief Method ToTestObject addr 0x20abe80 size 0xf8 virtual false final false
static ::ArrayW<HoudiniEngineUnity::Test_AnimationCurve> ToTestObject(::ArrayW<UnityEngine::AnimationCurve> self) ;

/// @brief Method ToTestObject addr 0x20abf78 size 0xfc virtual false final false
