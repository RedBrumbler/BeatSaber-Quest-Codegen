...
/// @brief Method .ctor addr 0x206b5ec size 0x12c virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x206b718 size 0x14 virtual true final false
 void Invoke(HoudiniEngineUnity::HEU_AssetSync assetSync) ;

/// @brief Method BeginInvoke addr 0x206b72c size 0x20 virtual true final false
...
/// @brief Method EndInvoke addr 0x206b74c size 0xc virtual true final false
...
/// @brief Method OnEnable addr 0x206b168 size 0x4 virtual false final false
 void OnEnable() ;

/// @brief Method OnDestroy addr 0x206b16c size 0xc virtual false final false
 void OnDestroy() ;

/// @brief Method InitializeAsset addr 0x206b178 size 0xf8 virtual false final false
...
/// @brief Method CreateThreadedTask addr 0x206b270 size 0x68 virtual false final false
 HoudiniEngineUnity::HEU_ThreadedTaskLoadGeo CreateThreadedTask() ;

/// @brief Method SetLoadCallback addr 0x206b2dc size 0x38 virtual false final false
 void SetLoadCallback(HoudiniEngineUnity::HoudiniEngineUnity__HEU_ThreadedTaskLoadGeo__HEU_LoadCallback callback) ;

/// @brief Method SetupLoadTask addr 0x206b314 size 0x60 virtual true final false
 void SetupLoadTask(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method OnLoadComplete addr 0x206b388 size 0x34 virtual true final false
 void OnLoadComplete(HoudiniEngineUnity::HoudiniEngineUnity__HEU_ThreadedTaskLoadGeo__HEU_LoadData loadData) ;

/// @brief Method Resync addr 0x206b440 size 0x38 virtual true final false
 void Resync() ;

// Ctor Parameters []
explicit HEU_AssetSync() ;

/// @brief Method .ctor addr 0x206b478 size 0x4 virtual false final false
 void _ctor() ;
