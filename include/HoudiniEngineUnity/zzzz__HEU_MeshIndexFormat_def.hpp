...
/// @brief Method CalculateIndexFormat addr 0x2095f20 size 0x78 virtual false final false
 void CalculateIndexFormat(int32_t numVertices) ;

/// @brief Method SetFormatForMesh addr 0x2095f98 size 0x24 virtual false final false
 void SetFormatForMesh(UnityEngine::Mesh mesh) ;

// Ctor Parameters []
explicit HEU_MeshIndexFormat() ;

/// @brief Method .ctor addr 0x2095fbc size 0x8 virtual false final false
 void _ctor() ;
