...
/// @brief Method .ctor addr 0x209f0d0 size 0x34 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x209f26c size 0x1c virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x209f288 size 0x194 virtual true final true
 bool MoveNext() ;

/// @brief Method <>m__Finally1 addr 0x209f41c size 0x50 virtual false final false
 void __m__Finally1() ;

/// @brief Method System.Collections.Generic.IEnumerator<HoudiniEngineUnity.JSONNode>.get_Current addr 0x209f46c size 0x8 virtual true final true
 HoudiniEngineUnity::JSONNode System_Collections_Generic_IEnumerator_HoudiniEngineUnity_JSONNode__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x209f474 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x209f4b4 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<HoudiniEngineUnity.JSONNode>.GetEnumerator addr 0x209f4bc size 0xa4 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x209f560 size 0x4 virtual true final true
...
/// @brief Method get_Inline addr 0x209ea00 size 0x8 virtual true final false
 bool get_Inline() ;

/// @brief Method set_Inline addr 0x209ea08 size 0xc virtual true final false
 void set_Inline(bool value) ;

/// @brief Method get_Tag addr 0x209ea14 size 0x8 virtual true final false
 HoudiniEngineUnity::JSONNodeType get_Tag() ;

/// @brief Method get_IsArray addr 0x209ea1c size 0x8 virtual true final false
 bool get_IsArray() ;

/// @brief Method GetEnumerator addr 0x209ea24 size 0x8c virtual true final false
 HoudiniEngineUnity::HoudiniEngineUnity__JSONNode__Enumerator GetEnumerator() ;

/// @brief Method get_Item addr 0x209eab0 size 0xb4 virtual true final false
 HoudiniEngineUnity::JSONNode get_Item(int32_t aIndex) ;

/// @brief Method set_Item addr 0x209eb8c size 0x144 virtual true final false
 void set_Item(int32_t aIndex, HoudiniEngineUnity::JSONNode value) ;

/// @brief Method get_Item addr 0x209ecd0 size 0x64 virtual true final false
 HoudiniEngineUnity::JSONNode get_Item(::StringW aKey) ;

/// @brief Method set_Item addr 0x209ed34 size 0xe4 virtual true final false
 void set_Item(::StringW aKey, HoudiniEngineUnity::JSONNode value) ;

/// @brief Method get_Count addr 0x209ee18 size 0x48 virtual true final false
 int32_t get_Count() ;

/// @brief Method Add addr 0x209ee60 size 0xe4 virtual true final false
 void Add(::StringW aKey, HoudiniEngineUnity::JSONNode aItem) ;

/// @brief Method Remove addr 0x209ef44 size 0xb4 virtual true final false
 HoudiniEngineUnity::JSONNode Remove(int32_t aIndex) ;

/// @brief Method Remove addr 0x209eff8 size 0x60 virtual true final false
 HoudiniEngineUnity::JSONNode Remove(HoudiniEngineUnity::JSONNode aNode) ;

/// @brief Method get_Children addr 0x209f058 size 0x78 virtual true final false
 System::Collections::Generic::IEnumerable_1<HoudiniEngineUnity::JSONNode> get_Children() ;

/// @brief Method WriteToStringBuilder addr 0x209f104 size 0x168 virtual true final false
...
/// @brief Method .ctor addr 0x209b8c8 size 0x7c virtual false final false
 void _ctor() ;
