...
/// @brief Method OnDestroy addr 0x2032200 size 0x1c8 virtual false final false
 void OnDestroy() ;

/// @brief Method RemoveHoudiniEngineAssetData addr 0x20323c8 size 0xdc virtual false final false
 void RemoveHoudiniEngineAssetData() ;

/// @brief Method ClearHoudiniEngineReferences addr 0x20324a4 size 0x74 virtual false final false
 void ClearHoudiniEngineReferences() ;

/// @brief Method DestroyRootComponent addr 0x2032518 size 0x10 virtual false final false
static void DestroyRootComponent(HoudiniEngineUnity::HEU_HoudiniAssetRoot assetRoot) ;

/// @brief Method Reset addr 0x2032528 size 0xe8 virtual false final false
 void Reset() ;

// Ctor Parameters []
explicit HEU_HoudiniAssetRoot() ;

/// @brief Method .ctor addr 0x2032610 size 0x7c virtual false final false
 void _ctor() ;
