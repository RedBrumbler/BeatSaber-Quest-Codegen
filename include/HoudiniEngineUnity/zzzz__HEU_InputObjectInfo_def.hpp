...
/// @brief Method CopyTo addr 0x2034a38 size 0x74 virtual false final false
 void CopyTo(HoudiniEngineUnity::HEU_InputObjectInfo destObject) ;

/// @brief Method SetReferencesFromGameObject addr 0x2034d20 size 0xec virtual false final false
 void SetReferencesFromGameObject() ;

/// @brief Method IsEquivalentTo addr 0x2036d58 size 0x28c virtual true final true
 bool IsEquivalentTo(HoudiniEngineUnity::HEU_InputObjectInfo other) ;

// Ctor Parameters []
explicit HEU_InputObjectInfo() ;

/// @brief Method .ctor addr 0x2034950 size 0xe8 virtual false final false
 void _ctor() ;
