...
/// @brief Method ApproximatelyEquals addr 0x2079d70 size 0x3c virtual false final false
...
/// @brief Method ApproximatelyEquals addr 0x2079dac size 0x10 virtual false final false
static bool ApproximatelyEquals(float_t self, float_t other, float_t epsilon) ;

/// @brief Method AsByteArray addr 0x2079dbc size 0x78 virtual false final false
static ::ArrayW<uint8_t> AsByteArray(::StringW self) ;

/// @brief Method AsString addr 0x2079e34 size 0x80 virtual false final false
static ::StringW AsString(::ArrayW<uint8_t> buffer) ;

/// @brief Method SwapXAndY addr 0x2079eb4 size 0x10 virtual false final false
static UnityEngine::Vector3 SwapXAndY(UnityEngine::Vector3 self) ;

/// @brief Method SwapXAndZ addr 0x2079ec4 size 0x10 virtual false final false
static UnityEngine::Vector3 SwapXAndZ(UnityEngine::Vector3 self) ;

/// @brief Method SwapYAndZ addr 0x2079ed4 size 0x10 virtual false final false
static UnityEngine::Vector3 SwapYAndZ(UnityEngine::Vector3 self) ;

/// @brief Method DecomposeToPosition addr 0x2079ee4 size 0xc virtual false final false
static UnityEngine::Vector3 DecomposeToPosition(UnityEngine::Matrix4x4 self) ;

/// @brief Method DecomposeToRotation addr 0x2079ef0 size 0x64 virtual false final false
static UnityEngine::Quaternion DecomposeToRotation(UnityEngine::Matrix4x4 self) ;

/// @brief Method DecomposeToScale addr 0x2079f54 size 0x194 virtual false final false
