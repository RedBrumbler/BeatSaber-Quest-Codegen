...
/// @brief Method get_SyncStatus addr 0x206b148 size 0x14 virtual false final false
 HoudiniEngineUnity::HoudiniEngineUnity__HEU_SessionSyncData__Status get_SyncStatus() ;

/// @brief Method set_SyncStatus addr 0x206b15c size 0xc virtual false final false
 void set_SyncStatus(HoudiniEngineUnity::HoudiniEngineUnity__HEU_SessionSyncData__Status value) ;

// Ctor Parameters []
explicit HEU_SessionSyncData() ;

/// @brief Method .ctor addr 0x20684dc size 0xac virtual false final false
 void _ctor() ;
