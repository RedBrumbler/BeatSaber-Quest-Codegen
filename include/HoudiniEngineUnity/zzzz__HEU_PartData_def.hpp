...
/// @brief Method .ctor addr 0x20441f8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <CopyGameObjectComponents>b__85_0 addr 0x2044200 size 0x18 virtual false final false
...
/// @brief Method .ctor addr 0x2041fc0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <CopyChildGameObjects>b__0 addr 0x2044218 size 0x10c virtual false final false
...
/// @brief Method .ctor addr 0x2042a30 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <BakePartToGameObject>b__0 addr 0x2044324 size 0x10c virtual false final false
...
/// @brief Method .ctor addr 0x2042a38 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <BakePartToGameObject>b__1 addr 0x2044430 size 0x10c virtual false final false
...
/// @brief Method get_PartID addr 0x203d514 size 0x8 virtual false final false
 int32_t get_PartID() ;

/// @brief Method get_PartName addr 0x203d51c size 0x8 virtual false final false
 ::StringW get_PartName() ;

/// @brief Method get_ParentGeoNode addr 0x203d524 size 0x8 virtual false final false
 HoudiniEngineUnity::HEU_GeoNode get_ParentGeoNode() ;

/// @brief Method get_ParentAsset addr 0x203d52c size 0x88 virtual false final false
 HoudiniEngineUnity::HEU_HoudiniAsset get_ParentAsset() ;

/// @brief Method IsPartInstancer addr 0x203d5b4 size 0x10 virtual false final false
 bool IsPartInstancer() ;

/// @brief Method IsAttribInstancer addr 0x203d5c4 size 0x8 virtual false final false
 bool IsAttribInstancer() ;

/// @brief Method IsInstancerAnyType addr 0x203d5cc size 0x2c virtual false final false
 bool IsInstancerAnyType() ;

/// @brief Method IsPartInstanced addr 0x203d5f8 size 0x8 virtual false final false
 bool IsPartInstanced() ;

/// @brief Method GetPartPointCount addr 0x203d600 size 0x8 virtual false final false
 int32_t GetPartPointCount() ;

/// @brief Method IsObjectInstancer addr 0x203d608 size 0x8 virtual false final false
 bool IsObjectInstancer() ;

/// @brief Method get_ObjectInstancesBeenGenerated addr 0x203d610 size 0x8 virtual false final false
 bool get_ObjectInstancesBeenGenerated() ;

/// @brief Method set_ObjectInstancesBeenGenerated addr 0x203d618 size 0xc virtual false final false
 void set_ObjectInstancesBeenGenerated(bool value) ;

/// @brief Method IsPartVolume addr 0x203af04 size 0x10 virtual false final false
 bool IsPartVolume() ;

/// @brief Method IsPartCurve addr 0x203d624 size 0x10 virtual false final false
 bool IsPartCurve() ;

/// @brief Method IsPartMesh addr 0x203d634 size 0x10 virtual false final false
 bool IsPartMesh() ;

/// @brief Method IsPartEditable addr 0x203d644 size 0x8 virtual false final false
 bool IsPartEditable() ;

/// @brief Method HaveInstancesBeenGenerated addr 0x203d64c size 0x8 virtual false final false
 bool HaveInstancesBeenGenerated() ;

/// @brief Method get_MeshVertexCount addr 0x203d654 size 0x8 virtual false final false
 int32_t get_MeshVertexCount() ;

/// @brief Method get_GeneratedOutput addr 0x203d65c size 0x8 virtual false final false
 HoudiniEngineUnity::HEU_GeneratedOutput get_GeneratedOutput() ;

/// @brief Method get_OutputGameObject addr 0x203d664 size 0x24 virtual false final false
 UnityEngine::GameObject get_OutputGameObject() ;

// Ctor Parameters []
explicit HEU_PartData() ;

/// @brief Method .ctor addr 0x203d688 size 0x80 virtual false final false
 void _ctor() ;

/// @brief Method Initialize addr 0x203d708 size 0x1e4 virtual false final false
...
/// @brief Method SetGameObjectName addr 0x203d8ec size 0x148 virtual false final false
 void SetGameObjectName(::StringW partName) ;

/// @brief Method SetGameObject addr 0x203da34 size 0x24 virtual false final false
 void SetGameObject(UnityEngine::GameObject gameObject) ;

/// @brief Method SetVolumeLayerName addr 0x203da58 size 0x8 virtual false final false
 void SetVolumeLayerName(::StringW name) ;

/// @brief Method GetVolumeLayerName addr 0x203da60 size 0x8 virtual false final false
 ::StringW GetVolumeLayerName() ;

/// @brief Method DestroyAllData addr 0x203da68 size 0x134 virtual false final false
 void DestroyAllData() ;

/// @brief Method ApplyHAPITransform addr 0x203dd40 size 0x168 virtual false final false
 void ApplyHAPITransform(ByRef<HoudiniEngineUnity::HAPI_Transform> hapiTransform) ;

/// @brief Method GetDebugInfo addr 0x203dea8 size 0x22c virtual false final false
 void GetDebugInfo(System::Text::StringBuilder sb) ;

/// @brief Method IsUsingMaterial addr 0x203e0d4 size 0x24 virtual false final false
 bool IsUsingMaterial(HoudiniEngineUnity::HEU_MaterialData materialData) ;

/// @brief Method GetClonableObjects addr 0x203e0f8 size 0x100 virtual false final false
 void GetClonableObjects(System::Collections::Generic::List_1<UnityEngine::GameObject> clonableObjects) ;

/// @brief Method GetClonableParts addr 0x203e1f8 size 0xf8 virtual false final false
 void GetClonableParts(System::Collections::Generic::List_1<HoudiniEngineUnity::HEU_PartData> clonableParts) ;

/// @brief Method GetOutputGameObjects addr 0x203e2f0 size 0x100 virtual false final false
 void GetOutputGameObjects(System::Collections::Generic::List_1<UnityEngine::GameObject> outputObjects) ;

/// @brief Method GetOutput addr 0x203e3f0 size 0xb8 virtual false final false
 void GetOutput(System::Collections::Generic::List_1<HoudiniEngineUnity::HEU_GeneratedOutput> outputs) ;

/// @brief Method GetHDAPartWithGameObject addr 0x203e4a8 size 0x84 virtual false final false
 HoudiniEngineUnity::HEU_PartData GetHDAPartWithGameObject(UnityEngine::GameObject inGameObject) ;

/// @brief Method SetObjectInstancer addr 0x203e52c size 0xc virtual false final false
 void SetObjectInstancer(bool bObjectInstancer) ;

/// @brief Method ClearInstances addr 0x203c6fc size 0x110 virtual false final false
 void ClearInstances() ;

/// @brief Method ClearObjectInstanceInfos addr 0x203db9c size 0xcc virtual false final false
 void ClearObjectInstanceInfos() ;

/// @brief Method ClearInvalidObjectInstanceInfos addr 0x203c80c size 0x200 virtual false final false
 void ClearInvalidObjectInstanceInfos() ;

/// @brief Method ClearGeneratedData addr 0x203e538 size 0x18 virtual false final false
 void ClearGeneratedData() ;

/// @brief Method ClearGeneratedMeshOutput addr 0x203e550 size 0x88 virtual false final false
 void ClearGeneratedMeshOutput() ;

/// @brief Method ClearGeneratedVolumeOutput addr 0x203e5d8 size 0x34 virtual false final false
 void ClearGeneratedVolumeOutput() ;

/// @brief Method GeneratePartInstances addr 0x203e60c size 0x738 virtual false final false
 void GeneratePartInstances(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method GenerateInstancesFromObjectID addr 0x203c1a4 size 0x3d4 virtual false final false
...
/// @brief Method GenerateInstancesFromObject addr 0x203f218 size 0x300 virtual false final false
...
/// @brief Method GenerateInstancesFromObjectIds addr 0x203af14 size 0x600 virtual false final false
 void GenerateInstancesFromObjectIds(HoudiniEngineUnity::HEU_SessionBase session, ::ArrayW<::StringW> instancePrefixes) ;

/// @brief Method GenerateInstancesFromUnityAssetPathAttribute addr 0x203b514 size 0xc90 virtual false final false
 void GenerateInstancesFromUnityAssetPathAttribute(HoudiniEngineUnity::HEU_SessionBase session, ::StringW unityInstanceAttr) ;

/// @brief Method CreateNewInstanceFromObject addr 0x203ee10 size 0x408 virtual false final false
...
/// @brief Method GenerateAttributesStore addr 0x203f77c size 0xb4 virtual false final false
 void GenerateAttributesStore(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method GetCurve addr 0x203f830 size 0x98 virtual false final false
 HoudiniEngineUnity::HEU_Curve GetCurve(bool bEditableOnly) ;

/// @brief Method SetVisiblity addr 0x203f8c8 size 0x1d8 virtual false final false
 void SetVisiblity(bool bVisibility) ;

/// @brief Method CalculateVisibility addr 0x203faa0 size 0x30 virtual false final false
 void CalculateVisibility(bool bParentVisibility, bool bParentDisplayGeo) ;

/// @brief Method SetColliderState addr 0x203fad0 size 0x1c virtual false final false
 void SetColliderState(bool bEnabled) ;

/// @brief Method CalculateColliderState addr 0x203faec size 0x2d8 virtual false final false
 void CalculateColliderState() ;

/// @brief Method CopyGameObjectComponents addr 0x203fdc4 size 0x1de0 virtual false final false
...
/// @brief Method CopyChildGameObjects addr 0x2041ba4 size 0x41c virtual false final false
...
/// @brief Method BakePartToNewGameObject addr 0x2041fc8 size 0x140 virtual false final false
...
/// @brief Method BakePartToGameObject addr 0x2042238 size 0x7f8 virtual false final false
...
/// @brief Method BakePartToGameObject addr 0x2042154 size 0xe4 virtual false final false
...
/// @brief Method GenerateMesh addr 0x2039414 size 0x3ec virtual false final false
...
/// @brief Method ProcessCurvePart addr 0x2042a40 size 0x138 virtual false final false
 void ProcessCurvePart(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method SyncAttributesStore addr 0x2042b78 size 0x128 virtual false final false
...
/// @brief Method SetupAttributeGeometry addr 0x2039980 size 0xcc virtual false final false
 void SetupAttributeGeometry(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method DestroyAttributesStore addr 0x203dc68 size 0xd8 virtual false final false
 void DestroyAttributesStore() ;

/// @brief Method PopulateObjectInstanceInfos addr 0x203cb44 size 0x58 virtual false final false
...
/// @brief Method SetObjectInstanceInfos addr 0x20437a8 size 0x16c virtual false final false
...
/// @brief Method GetObjectInstanceInfos addr 0x2043914 size 0x8 virtual false final false
 System::Collections::Generic::List_1<HoudiniEngineUnity::HEU_ObjectInstanceInfo> GetObjectInstanceInfos() ;

/// @brief Method CreateObjectInstanceInfo addr 0x203f5f0 size 0x18c virtual false final false
...
/// @brief Method GetObjectInstanceInfoWithObjectPath addr 0x203f518 size 0xd8 virtual false final false
 HoudiniEngineUnity::HEU_ObjectInstanceInfo GetObjectInstanceInfoWithObjectPath(::StringW path) ;

/// @brief Method GetObjectInstanceInfoWithObjectID addr 0x203ed44 size 0xcc virtual false final false
 HoudiniEngineUnity::HEU_ObjectInstanceInfo GetObjectInstanceInfoWithObjectID(int32_t objNodeID) ;

/// @brief Method SetTerrainOffsetPosition addr 0x204391c size 0xc virtual false final false
 void SetTerrainOffsetPosition(UnityEngine::Vector3 offsetPosition) ;

/// @brief Method SetTerrainData addr 0x2043928 size 0x1a0 virtual false final false
 void SetTerrainData(UnityEngine::TerrainData terrainData, ::StringW exportPathRelative, ::StringW exportPathUser) ;

/// @brief Method AppendBakedCloneName addr 0x2042108 size 0x4c virtual false final false
static ::StringW AppendBakedCloneName(::StringW name) ;

/// @brief Method ToString addr 0x2043ac8 size 0x70 virtual true final false
 ::StringW ToString() ;

/// @brief Method DestroyParts addr 0x2043b38 size 0xd4 virtual false final false
static void DestroyParts(System::Collections::Generic::List_1<HoudiniEngineUnity::HEU_PartData> parts) ;

/// @brief Method DestroyPart addr 0x2039800 size 0x2c virtual false final false
static void DestroyPart(HoudiniEngineUnity::HEU_PartData part) ;

/// @brief Method IsEquivalentTo addr 0x2043c0c size 0x588 virtual true final true
