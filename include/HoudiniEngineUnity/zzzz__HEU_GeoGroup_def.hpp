...
/// @brief Method CompareTo addr 0x208b3bc size 0x30 virtual true final true
 int32_t CompareTo(HoudiniEngineUnity::HEU_GeoGroup other) ;

/// @brief Method SetupNormalIndices addr 0x2088f10 size 0x120 virtual false final false
 void SetupNormalIndices(int32_t indicesCount) ;

// Ctor Parameters []
explicit HEU_GeoGroup() ;

/// @brief Method .ctor addr 0x2088e94 size 0x7c virtual false final false
 void _ctor() ;
