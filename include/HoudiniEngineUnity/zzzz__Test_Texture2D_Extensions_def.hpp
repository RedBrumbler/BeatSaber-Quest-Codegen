...
// Ctor Parameters []
explicit HoudiniEngineUnity__Test_Texture2D_Extensions____c() ;

/// @brief Method .ctor addr 0x20ace6c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ToTestObject>b__1_0 addr 0x20ace74 size 0x64 virtual false final false
 HoudiniEngineUnity::Test_Texture2D _ToTestObject_b__1_0(UnityEngine::Texture2D lod) ;

/// @brief Method <ToTestObject>b__2_0 addr 0x20aced8 size 0x64 virtual false final false
...
/// @brief Method ToTestObject addr 0x20ac694 size 0x64 virtual false final false
static HoudiniEngineUnity::Test_Texture2D ToTestObject(UnityEngine::Texture2D self) ;

/// @brief Method ToTestObject addr 0x20acc14 size 0xf8 virtual false final false
static ::ArrayW<HoudiniEngineUnity::Test_Texture2D> ToTestObject(::ArrayW<UnityEngine::Texture2D> self) ;

/// @brief Method ToTestObject addr 0x20acd0c size 0xfc virtual false final false
