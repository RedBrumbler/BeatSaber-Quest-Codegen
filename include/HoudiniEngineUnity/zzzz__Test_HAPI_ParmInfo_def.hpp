...
explicit Test_HAPI_ParmInfo(HoudiniEngineUnity::HAPI_ParmInfo self) ;

/// @brief Method .ctor addr 0x20a875c size 0x34 virtual false final false
 void _ctor(HoudiniEngineUnity::HAPI_ParmInfo self) ;

/// @brief Method IsEquivalentTo addr 0x20a8790 size 0x78c virtual true final true
