...
/// @brief Method .ctor addr 0x2093b90 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x20912fc size 0xc virtual false final false
 void _ctor() ;

/// @brief Method Initialize addr 0x2091308 size 0x70 virtual false final false
 void Initialize(HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings settings) ;

/// @brief Method CreateInputNodeWithDataUpload addr 0x2091378 size 0x198 virtual true final false
...
/// @brief Method IsThisInputObjectSupported addr 0x2092fe4 size 0xc4 virtual true final false
 bool IsThisInputObjectSupported(UnityEngine::GameObject inputObject) ;

/// @brief Method UploadData addr 0x20915e8 size 0x19fc virtual false final false
...
/// @brief Method GenerateTilemapDataFromGameObject addr 0x2091510 size 0xd8 virtual false final false
