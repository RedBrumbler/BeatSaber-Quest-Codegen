...
/// @brief Method Log addr 0x2095b30 size 0x58 virtual false final false
static void Log(::StringW text) ;

/// @brief Method LogFormat addr 0x2095b88 size 0x68 virtual false final false
static void LogFormat(::StringW text, ::ArrayW<::bs_hook::Il2CppWrapperType> args) ;

/// @brief Method LogWarning addr 0x20907a8 size 0x60 virtual false final false
static void LogWarning(::StringW text) ;

/// @brief Method LogWarningFormat addr 0x2090808 size 0x74 virtual false final false
static void LogWarningFormat(::StringW text, ::ArrayW<::bs_hook::Il2CppWrapperType> args) ;

/// @brief Method LogError addr 0x208eeb8 size 0x60 virtual false final false
static void LogError(::StringW text) ;

/// @brief Method LogErrorFormat addr 0x20911fc size 0x74 virtual false final false
static void LogErrorFormat(::StringW text, ::ArrayW<::bs_hook::Il2CppWrapperType> args) ;

/// @brief Method LogError addr 0x2095c94 size 0x8c virtual false final false
static void LogError(System::Exception ex) ;

/// @brief Method LogAssertion addr 0x2095d20 size 0x4 virtual false final false
static void LogAssertion(::StringW text) ;

/// @brief Method LogAssertionFormat addr 0x2095d24 size 0x4 virtual false final false
static void LogAssertionFormat(::StringW text, ::ArrayW<::bs_hook::Il2CppWrapperType> args) ;

/// @brief Method LogToCookLogsIfOn addr 0x2095bf0 size 0x40 virtual false final false
static void LogToCookLogsIfOn(::StringW text) ;

/// @brief Method LogToCookLogsIfOnFormat addr 0x2095c30 size 0x64 virtual false final false
static void LogToCookLogsIfOnFormat(::StringW text, ::ArrayW<::bs_hook::Il2CppWrapperType> args) ;

// Ctor Parameters []
explicit HEU_Logger() ;

/// @brief Method .ctor addr 0x2095d28 size 0x8 virtual false final false
 void _ctor() ;
