...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10422)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3828), inst: 298 }), TypeDefinitionIndex(TypeDefinitionIndex(9599)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10422), inst: 5065 }), TypeDefinitionIndex(TypeDefinitionIndex(3828)), TypeDefinitionIndex(TypeDefinitionIndex(10157))}
...
/// @brief Method .ctor addr 0x2014250 size 0x48 virtual false final false
 void _ctor() ;
