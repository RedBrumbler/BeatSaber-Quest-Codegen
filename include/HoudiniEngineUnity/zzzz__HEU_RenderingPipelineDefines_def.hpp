...
/// @brief Method UpdateDefines addr 0x2095fc8 size 0xd8 virtual false final false
static void UpdateDefines() ;

/// @brief Method GetPipeline addr 0x20960a0 size 0x130 virtual false final false
static HoudiniEngineUnity::HEU_PipelineType GetPipeline() ;

/// @brief Method AddDefine addr 0x20961d0 size 0x108 virtual false final false
static void AddDefine(::StringW define) ;

/// @brief Method RemoveDefine addr 0x20962d8 size 0xc0 virtual false final false
static void RemoveDefine(::StringW define) ;

/// @brief Method GetDefines addr 0x2096398 size 0x70 virtual false final false
static System::Collections::Generic::List_1<::StringW> GetDefines() ;

/// @brief Method SetDefines addr 0x2096408 size 0x4 virtual false final false
static void SetDefines(System::Collections::Generic::List_1<::StringW> definesList) ;

// Ctor Parameters []
explicit HEU_RenderingPipelineDefines() ;

/// @brief Method .ctor addr 0x209640c size 0x8 virtual false final false
 void _ctor() ;
