...
/// @brief Method GeneratePerTriangle addr 0x2085c8c size 0x4c virtual false final false
static ::ArrayW<UnityEngine::Vector2> GeneratePerTriangle(UnityEngine::Mesh meshSrc) ;

/// @brief Method GenerateSecondaryUVSet addr 0x208b3ec size 0x44 virtual false final false
static void GenerateSecondaryUVSet(UnityEngine::Mesh meshsrc) ;

/// @brief Method CalculateMeshTangents addr 0x2084c30 size 0x4d8 virtual false final false
static void CalculateMeshTangents(UnityEngine::Mesh mesh) ;

/// @brief Method GenerateCubeMeshFromPoints addr 0x208b430 size 0xb00 virtual false final false
...
/// @brief Method GetInstanceOutputName addr 0x208bf30 size 0xbc virtual false final false
