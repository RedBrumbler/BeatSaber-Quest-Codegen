...
/// @brief Method .ctor addr 0x20ab0a8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ToTestObject>b__1_0 addr 0x20ab0b0 size 0x64 virtual false final false
 HoudiniEngineUnity::Test_MeshRenderer _ToTestObject_b__1_0(UnityEngine::MeshRenderer lod) ;

/// @brief Method <ToTestObject>b__2_0 addr 0x20ab114 size 0x64 virtual false final false
...
/// @brief Method ToTestObject addr 0x20a7104 size 0x64 virtual false final false
static HoudiniEngineUnity::Test_MeshRenderer ToTestObject(UnityEngine::MeshRenderer self) ;

/// @brief Method ToTestObject addr 0x20aae50 size 0xf8 virtual false final false
static ::ArrayW<HoudiniEngineUnity::Test_MeshRenderer> ToTestObject(::ArrayW<UnityEngine::MeshRenderer> self) ;

/// @brief Method ToTestObject addr 0x20aaf48 size 0xfc virtual false final false
