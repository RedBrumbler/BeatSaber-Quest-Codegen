...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10420)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10420), inst: 5071 }), TypeDefinitionIndex(TypeDefinitionIndex(9556))}
...
/// @brief Method .ctor addr 0x2014178 size 0x48 virtual false final false
 void _ctor() ;
