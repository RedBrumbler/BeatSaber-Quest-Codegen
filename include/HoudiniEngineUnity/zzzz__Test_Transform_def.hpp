...
/// @brief Method .ctor addr 0x20a95e0 size 0x28 virtual false final false
 void _ctor(UnityEngine::Transform self) ;

/// @brief Method IsNull addr 0x20a9608 size 0x60 virtual true final true
 bool IsNull() ;

/// @brief Method IsEquivalentTo addr 0x20a9668 size 0x1cc virtual true final true
