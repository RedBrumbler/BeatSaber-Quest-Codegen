...
/// @brief Method getElementCountByAttributeOwner addr 0x20579c0 size 0x4c virtual false final false
 int32_t getElementCountByAttributeOwner(HoudiniEngineUnity::HAPI_AttributeOwner owner) ;

/// @brief Method getElementCountByGroupType addr 0x2057a0c size 0x28 virtual false final false
 int32_t getElementCountByGroupType(HoudiniEngineUnity::HAPI_GroupType type) ;

/// @brief Method init addr 0x204cbe0 size 0x58 virtual false final false
 void init() ;

/// @brief Method get_pointAttributeCount addr 0x2057a34 size 0x34 virtual false final false
 int32_t get_pointAttributeCount() ;

/// @brief Method set_pointAttributeCount addr 0x2057a68 size 0x40 virtual false final false
 void set_pointAttributeCount(int32_t value) ;

/// @brief Method get_primitiveAttributeCount addr 0x2057aa8 size 0x34 virtual false final false
 int32_t get_primitiveAttributeCount() ;

/// @brief Method set_primitiveAttributeCount addr 0x2057adc size 0x40 virtual false final false
 void set_primitiveAttributeCount(int32_t value) ;

/// @brief Method get_vertexAttributeCount addr 0x2057b1c size 0x30 virtual false final false
 int32_t get_vertexAttributeCount() ;

/// @brief Method set_vertexAttributeCount addr 0x2057b4c size 0x3c virtual false final false
 void set_vertexAttributeCount(int32_t value) ;

/// @brief Method get_detailAttributeCount addr 0x2057b88 size 0x34 virtual false final false
 int32_t get_detailAttributeCount() ;

/// @brief Method set_detailAttributeCount addr 0x2057bbc size 0x40 virtual false final false
