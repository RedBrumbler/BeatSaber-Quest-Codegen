...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10420)), TypeDefinitionIndex(TypeDefinitionIndex(9557)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10420), inst: 5069 })}
...
/// @brief Method .ctor addr 0x2014208 size 0x48 virtual false final false
 void _ctor() ;
