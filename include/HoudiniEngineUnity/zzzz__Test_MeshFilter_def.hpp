...
/// @brief Method .ctor addr 0x20ab178 size 0x28 virtual false final false
 void _ctor(UnityEngine::MeshFilter self) ;

/// @brief Method IsNull addr 0x20ab1a0 size 0x60 virtual true final true
 bool IsNull() ;

/// @brief Method IsEquivalentTo addr 0x20ab200 size 0x1a0 virtual true final true
