...
/// @brief Method .ctor addr 0x20ae33c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ToTestObject>b__1_0 addr 0x20ae344 size 0x64 virtual false final false
 HoudiniEngineUnity::Test_Terrain _ToTestObject_b__1_0(UnityEngine::Terrain lod) ;

/// @brief Method <ToTestObject>b__2_0 addr 0x20ae3a8 size 0x64 virtual false final false
...
/// @brief Method ToTestObject addr 0x20a7168 size 0x64 virtual false final false
static HoudiniEngineUnity::Test_Terrain ToTestObject(UnityEngine::Terrain self) ;

/// @brief Method ToTestObject addr 0x20ae0e4 size 0xf8 virtual false final false
static ::ArrayW<HoudiniEngineUnity::Test_Terrain> ToTestObject(::ArrayW<UnityEngine::Terrain> self) ;

/// @brief Method ToTestObject addr 0x20ae1dc size 0xfc virtual false final false
