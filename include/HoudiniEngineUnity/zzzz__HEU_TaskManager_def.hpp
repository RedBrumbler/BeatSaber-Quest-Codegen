...
/// @brief Method Update addr 0x2071300 size 0x4 virtual false final false
static void Update() ;

/// @brief Method GetTask addr 0x2071304 size 0x1a4 virtual false final false
static HoudiniEngineUnity::HEU_Task GetTask(System::Guid taskGuid) ;

/// @brief Method AddTask addr 0x20714a8 size 0x150 virtual false final false
static void AddTask(HoudiniEngineUnity::HEU_Task task) ;

/// @brief Method KillTask addr 0x20715f8 size 0xe8 virtual false final false
static void KillTask(HoudiniEngineUnity::HEU_Task task, bool bRemove) ;

/// @brief Method KillTask addr 0x2071824 size 0x9c virtual false final false
static void KillTask(System::Guid taskGuid, bool bRemove) ;

/// @brief Method RemoveTask addr 0x20716e0 size 0x144 virtual false final false
static void RemoveTask(HoudiniEngineUnity::HEU_Task task) ;

/// @brief Method ExecuteTask addr 0x20718c0 size 0x38 virtual false final false
static void ExecuteTask(HoudiniEngineUnity::HEU_Task task) ;

/// @brief Method CompleteTask addr 0x2070c24 size 0x28 virtual false final false
...
/// @brief Method InternalCompleteTask addr 0x20718f8 size 0x60 virtual false final false
static void InternalCompleteTask(HoudiniEngineUnity::HEU_Task task) ;

// Ctor Parameters []
explicit HEU_TaskManager() ;

/// @brief Method .ctor addr 0x2071958 size 0x8 virtual false final false
 void _ctor() ;
