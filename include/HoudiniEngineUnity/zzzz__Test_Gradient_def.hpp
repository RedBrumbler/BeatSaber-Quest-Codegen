...
/// @brief Method .ctor addr 0x20ab84c size 0x28 virtual false final false
 void _ctor(UnityEngine::Gradient self) ;

/// @brief Method IsNull addr 0x20ab874 size 0x10 virtual true final true
 bool IsNull() ;

/// @brief Method IsEquivalentTo addr 0x20ab884 size 0xf4 virtual true final true
