...
/// @brief Method .ctor addr 0x20abc34 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ToTestObject>b__1_0 addr 0x20abc3c size 0x64 virtual false final false
 HoudiniEngineUnity::Test_Gradient _ToTestObject_b__1_0(UnityEngine::Gradient lod) ;

/// @brief Method <ToTestObject>b__2_0 addr 0x20abca0 size 0x64 virtual false final false
...
/// @brief Method ToTestObject addr 0x20ab978 size 0x64 virtual false final false
static HoudiniEngineUnity::Test_Gradient ToTestObject(UnityEngine::Gradient self) ;

/// @brief Method ToTestObject addr 0x20ab9dc size 0xf8 virtual false final false
static ::ArrayW<HoudiniEngineUnity::Test_Gradient> ToTestObject(::ArrayW<UnityEngine::Gradient> self) ;

/// @brief Method ToTestObject addr 0x20abad4 size 0xfc virtual false final false
