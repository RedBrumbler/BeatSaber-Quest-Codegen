...
/// @brief Method SetAttribute addr 0x20497a0 size 0xfc virtual false final false
 void SetAttribute(HoudiniEngineUnity::HEU_OutputAttribute attribute) ;

/// @brief Method GetAttribute addr 0x204989c size 0x70 virtual false final false
 HoudiniEngineUnity::HEU_OutputAttribute GetAttribute(::StringW name) ;

/// @brief Method Clear addr 0x204990c size 0x50 virtual false final false
 void Clear() ;

// Ctor Parameters []
explicit HEU_OutputAttributesStore() ;

/// @brief Method .ctor addr 0x204995c size 0x64 virtual false final false
 void _ctor() ;
