...
/// @brief Method Reset addr 0x20626b0 size 0x24 virtual false final false
 void Reset() ;

/// @brief Method AreAllWorkItemsComplete addr 0x20626d4 size 0x4c virtual false final false
 bool AreAllWorkItemsComplete() ;

/// @brief Method AnyWorkItemsFailed addr 0x2062490 size 0x24 virtual false final false
 bool AnyWorkItemsFailed() ;

/// @brief Method AnyWorkItemsPending addr 0x2062768 size 0x58 virtual false final false
 bool AnyWorkItemsPending() ;

// Ctor Parameters []
explicit HEU_TOPNodeData() ;

/// @brief Method .ctor addr 0x2060c80 size 0xe4 virtual false final false
 void _ctor() ;
