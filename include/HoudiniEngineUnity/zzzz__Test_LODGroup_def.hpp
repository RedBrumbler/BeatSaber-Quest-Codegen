...
/// @brief Method .ctor addr 0x20a8fa4 size 0x28 virtual false final false
 void _ctor(UnityEngine::LODGroup self) ;

/// @brief Method IsNull addr 0x20a8fcc size 0x60 virtual true final true
 bool IsNull() ;

/// @brief Method IsEquivalentTo addr 0x20a902c size 0x28c virtual true final true
