...
/// @brief Method .ctor addr 0x20aa37c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ToTestObject>b__1_0 addr 0x20aa384 size 0x64 virtual false final false
 HoudiniEngineUnity::Test_Collider _ToTestObject_b__1_0(UnityEngine::Collider lod) ;

/// @brief Method <ToTestObject>b__2_0 addr 0x20aa3e8 size 0x64 virtual false final false
...
/// @brief Method ToTestObject addr 0x20a70a0 size 0x64 virtual false final false
static HoudiniEngineUnity::Test_Collider ToTestObject(UnityEngine::Collider self) ;

/// @brief Method ToTestObject addr 0x20aa124 size 0xf8 virtual false final false
static ::ArrayW<HoudiniEngineUnity::Test_Collider> ToTestObject(::ArrayW<UnityEngine::Collider> self) ;

/// @brief Method ToTestObject addr 0x20aa21c size 0xfc virtual false final false
