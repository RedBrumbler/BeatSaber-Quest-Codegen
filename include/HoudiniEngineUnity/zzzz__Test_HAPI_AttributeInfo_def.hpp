...
explicit Test_HAPI_AttributeInfo(HoudiniEngineUnity::HAPI_AttributeInfo self) ;

/// @brief Method .ctor addr 0x20a82a4 size 0x34 virtual false final false
 void _ctor(HoudiniEngineUnity::HAPI_AttributeInfo self) ;

/// @brief Method IsEquivalentTo addr 0x20a82d8 size 0xec virtual true final true
