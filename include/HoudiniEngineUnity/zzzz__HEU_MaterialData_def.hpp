...
/// @brief Method IsExistingMaterial addr 0x2063314 size 0x14 virtual false final false
 bool IsExistingMaterial() ;

/// @brief Method UpdateMaterialFromHoudini addr 0x2063328 size 0xf40 virtual false final false
 void UpdateMaterialFromHoudini(HoudiniEngineUnity::HAPI_MaterialInfo materialInfo, ::StringW assetCacheFolderPath) ;

/// @brief Method UseLegacyShaders addr 0x20642e4 size 0x5d8 virtual false final false
...
/// @brief Method GetTextureFileNameFromMaterialParam addr 0x20648bc size 0x24c virtual false final false
...
/// @brief Method IsTransparentMaterial addr 0x2064268 size 0x30 virtual false final false
...
/// @brief Method GetMaterialAlpha addr 0x2064f78 size 0x1d8 virtual false final false
...
/// @brief Method GetSupportedFileFormat addr 0x2065150 size 0x124 virtual false final false
...
/// @brief Method IsEquivalentTo addr 0x2065274 size 0x1c8 virtual true final true
 bool IsEquivalentTo(HoudiniEngineUnity::HEU_MaterialData other) ;

// Ctor Parameters []
explicit HEU_MaterialData() ;

/// @brief Method .ctor addr 0x206543c size 0x10 virtual false final false
 void _ctor() ;
