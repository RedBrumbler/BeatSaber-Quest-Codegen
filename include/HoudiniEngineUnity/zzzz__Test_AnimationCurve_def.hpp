...
/// @brief Method .ctor addr 0x20abd04 size 0x28 virtual false final false
 void _ctor(UnityEngine::AnimationCurve self) ;

/// @brief Method IsNull addr 0x20abd2c size 0x10 virtual true final true
 bool IsNull() ;

/// @brief Method IsEquivalentTo addr 0x20abd3c size 0xe0 virtual true final true
