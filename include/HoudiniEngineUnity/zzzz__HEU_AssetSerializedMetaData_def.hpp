...
/// @brief Method get_SoftDeleted addr 0x2016690 size 0x8 virtual false final false
 bool get_SoftDeleted() ;

/// @brief Method set_SoftDeleted addr 0x2016698 size 0xc virtual false final false
 void set_SoftDeleted(bool value) ;

/// @brief Method get_SavedCurveNodeData addr 0x20166a4 size 0x8 virtual false final false
...
/// @brief Method IsEquivalentTo addr 0x20166ac size 0xbc virtual true final true
 bool IsEquivalentTo(HoudiniEngineUnity::HEU_AssetSerializedMetaData other) ;

// Ctor Parameters []
explicit HEU_AssetSerializedMetaData() ;

/// @brief Method .ctor addr 0x2016768 size 0x7c virtual false final false
 void _ctor() ;
