...
/// @brief Method get_ParmID addr 0x2056680 size 0x8 virtual false final false
 int32_t get_ParmID() ;

/// @brief Method get_ParentID addr 0x2057df4 size 0x8 virtual false final false
 int32_t get_ParentID() ;

/// @brief Method get_ChildIndex addr 0x2057dfc size 0x8 virtual false final false
 int32_t get_ChildIndex() ;

/// @brief Method get_ParmSize addr 0x2057e04 size 0x8 virtual false final false
 int32_t get_ParmSize() ;

/// @brief Method IsInt addr 0x2057e0c size 0x10 virtual false final false
 bool IsInt() ;

/// @brief Method IsFloat addr 0x2057e1c size 0x10 virtual false final false
 bool IsFloat() ;

/// @brief Method IsString addr 0x2057e2c size 0x10 virtual false final false
 bool IsString() ;

/// @brief Method IsPathFile addr 0x2057e3c size 0x14 virtual false final false
 bool IsPathFile() ;

/// @brief Method HasMin addr 0x2057e50 size 0x8 virtual false final false
 bool HasMin() ;

/// @brief Method HasMax addr 0x2057e58 size 0x8 virtual false final false
 bool HasMax() ;

/// @brief Method HasUIMin addr 0x2057e60 size 0x8 virtual false final false
 bool HasUIMin() ;

/// @brief Method HasUIMax addr 0x2057e68 size 0x8 virtual false final false
 bool HasUIMax() ;

/// @brief Method get_IntMin addr 0x2057e70 size 0xdc virtual false final false
 int32_t get_IntMin() ;

/// @brief Method get_IntMax addr 0x2057f4c size 0xdc virtual false final false
 int32_t get_IntMax() ;

/// @brief Method get_IntUIMin addr 0x2058028 size 0xdc virtual false final false
 int32_t get_IntUIMin() ;

/// @brief Method get_IntUIMax addr 0x2058104 size 0xdc virtual false final false
 int32_t get_IntUIMax() ;

/// @brief Method get_FloatMin addr 0x20581e0 size 0x8 virtual false final false
 float_t get_FloatMin() ;

/// @brief Method get_FloatMax addr 0x20581e8 size 0x8 virtual false final false
 float_t get_FloatMax() ;

/// @brief Method get_FloatUIMin addr 0x20581f0 size 0x8 virtual false final false
 float_t get_FloatUIMin() ;

/// @brief Method get_FloatUIMax addr 0x20581f8 size 0x8 virtual false final false
 float_t get_FloatUIMax() ;

/// @brief Method IsContainer addr 0x2058200 size 0x54 virtual false final false
 bool IsContainer() ;

/// @brief Method IsMultiParam addr 0x2058254 size 0x10 virtual false final false
 bool IsMultiParam() ;

/// @brief Method IsRamp addr 0x2058264 size 0x10 virtual false final false
 bool IsRamp() ;

/// @brief Method IsToggle addr 0x2058274 size 0x10 virtual false final false
 bool IsToggle() ;

/// @brief Method IsColor addr 0x2058284 size 0x10 virtual false final false
 bool IsColor() ;

/// @brief Method ToVector3 addr 0x2058294 size 0x84 virtual false final false
 UnityEngine::Vector3 ToVector3() ;

/// @brief Method IsAssetPath addr 0x2058318 size 0x8 virtual false final false
 bool IsAssetPath() ;

/// @brief Method IsEquivalentTo addr 0x2058320 size 0x71c virtual true final true
 bool IsEquivalentTo(HoudiniEngineUnity::HEU_ParameterData other) ;

// Ctor Parameters []
explicit HEU_ParameterData() ;

/// @brief Method .ctor addr 0x2058a3c size 0x7c virtual false final false
 void _ctor() ;
