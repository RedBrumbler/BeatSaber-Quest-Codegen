...
/// @brief Method GetNewModifier addr 0x2058ab8 size 0x84 virtual false final false
...
/// @brief Method IsEquivalentTo addr 0x2058b44 size 0x28c virtual true final true
 bool IsEquivalentTo(HoudiniEngineUnity::HEU_ParameterModifier other) ;

// Ctor Parameters []
explicit HEU_ParameterModifier() ;

/// @brief Method .ctor addr 0x2058b3c size 0x8 virtual false final false
 void _ctor() ;
