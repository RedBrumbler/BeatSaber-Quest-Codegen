...
namespace HoudiniEngineUnity {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(9760))}
...
/// @brief Method GetTaskSession addr 0x20705c0 size 0xb4 virtual false final false
 HoudiniEngineUnity::HEU_SessionBase GetTaskSession() ;

/// @brief Method DoTask addr 0x2070674 size 0x5b0 virtual true final false
 void DoTask() ;

/// @brief Method KillTask addr 0x2070c4c size 0x240 virtual true final false
 void KillTask() ;

/// @brief Method CompleteTask addr 0x2070e8c size 0x240 virtual true final false
 void CompleteTask(HoudiniEngineUnity::HoudiniEngineUnity__HEU_Task__TaskResult result) ;

/// @brief Method CookCompletedCallback addr 0x20710cc size 0x80 virtual false final false
...
/// @brief Method CookCompletedCallback addr 0x207114c size 0x10 virtual false final false
 void CookCompletedCallback(HoudiniEngineUnity::HEU_CookedEventData cookedEventData) ;

/// @brief Method CookCompletedCallback addr 0x207115c size 0x10 virtual false final false
 void CookCompletedCallback(HoudiniEngineUnity::HEU_ReloadEventData reloadEventData) ;

// Ctor Parameters []
explicit HEU_AssetTask() ;

/// @brief Method .ctor addr 0x207116c size 0xb8 virtual false final false
 void _ctor() ;
