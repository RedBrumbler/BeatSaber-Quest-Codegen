...
/// @brief Method .ctor addr 0x2019150 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <UpdateCurveInputForCustomAttributes>b__0 addr 0x201b058 size 0x1c4 virtual false final false
 void _UpdateCurveInputForCustomAttributes_b__0(HoudiniEngineUnity::CurveNodeData data) ;

/// @brief Method <UpdateCurveInputForCustomAttributes>b__1 addr 0x201b21c size 0x3c8 virtual false final false
 void _UpdateCurveInputForCustomAttributes_b__1(int32_t nIndex1, int32_t nIndex2, float_t fCoeff, int32_t nInsertIndex) ;

/// @brief Method <UpdateCurveInputForCustomAttributes>b__2 addr 0x201b5e4 size 0x2d4 virtual false final false
...
/// @brief Method .ctor addr 0x2019c28 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <UpdatePoints>b__0 addr 0x201b8b8 size 0x120 virtual false final false
...
/// @brief Method .ctor addr 0x201a61c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetAllPoints>b__0 addr 0x201b9d8 size 0xb8 virtual false final false
...
/// @brief Method get_GeoID addr 0x2016ef4 size 0x8 virtual false final false
 int32_t get_GeoID() ;

/// @brief Method get_CurveNodeData addr 0x2016efc size 0x8 virtual false final false
 System::Collections::Generic::List_1<HoudiniEngineUnity::CurveNodeData> get_CurveNodeData() ;

/// @brief Method IsEditable addr 0x2016f04 size 0x8 virtual false final false
 bool IsEditable() ;

/// @brief Method get_Parameters addr 0x2016f0c size 0x8 virtual false final false
 HoudiniEngineUnity::HEU_Parameters get_Parameters() ;

/// @brief Method SetUploadParameterPreset addr 0x2016f14 size 0xc virtual false final false
 void SetUploadParameterPreset(bool bValue) ;

/// @brief Method get_CurveName addr 0x2016f20 size 0x8 virtual false final false
 ::StringW get_CurveName() ;

/// @brief Method IsGeoCurve addr 0x2016f28 size 0x8 virtual false final false
 bool IsGeoCurve() ;

/// @brief Method get_EditState addr 0x2016f30 size 0x8 virtual false final false
 HoudiniEngineUnity::HoudiniEngineUnity__HEU_Curve__CurveEditState get_EditState() ;

/// @brief Method get_ParentAsset addr 0x2016f38 size 0x8 virtual false final false
 HoudiniEngineUnity::HEU_HoudiniAsset get_ParentAsset() ;

/// @brief Method CreateSetupCurve addr 0x2016f40 size 0x184 virtual false final false
...
/// @brief Method DestroyAllData addr 0x2017198 size 0x14c virtual false final false
 void DestroyAllData(bool bIsRebuild) ;

/// @brief Method SetCurveName addr 0x20172e4 size 0x9c virtual false final false
 void SetCurveName(::StringW name) ;

/// @brief Method UploadParameterPreset addr 0x2017380 size 0xe8 virtual false final false
...
/// @brief Method ResetCurveParameters addr 0x2017468 size 0xd0 virtual false final false
 void ResetCurveParameters(HoudiniEngineUnity::HEU_SessionBase session, HoudiniEngineUnity::HEU_HoudiniAsset parentAsset) ;

/// @brief Method SetCurveParameterPreset addr 0x2017538 size 0xd0 virtual false final false
...
/// @brief Method UpdateCurve addr 0x2017608 size 0x1e8 virtual false final false
 void UpdateCurve(HoudiniEngineUnity::HEU_SessionBase session, int32_t partID) ;

/// @brief Method GenerateMesh addr 0x20177f0 size 0x3b4 virtual false final false
 void GenerateMesh(UnityEngine::GameObject inGameObject) ;

/// @brief Method UpdateCurveInputForCustomAttributes addr 0x2017ba4 size 0x15ac virtual false final false
...
/// @brief Method SyncFromParameters addr 0x20193b8 size 0x274 virtual false final false
 void SyncFromParameters(HoudiniEngineUnity::HEU_SessionBase session, HoudiniEngineUnity::HEU_HoudiniAsset parentAsset) ;

/// @brief Method UpdatePoints addr 0x201962c size 0x564 virtual false final false
 void UpdatePoints(HoudiniEngineUnity::HEU_SessionBase session, int32_t partID) ;

/// @brief Method ProjectToColliders addr 0x2019c30 size 0x4d8 virtual false final false
...
/// @brief Method GetPointsString addr 0x201a108 size 0x274 virtual false final false
static ::StringW GetPointsString(System::Collections::Generic::List_1<HoudiniEngineUnity::CurveNodeData> points) ;

/// @brief Method GetPointsString addr 0x2019158 size 0x260 virtual false final false
static ::StringW GetPointsString(System::Collections::Generic::List_1<UnityEngine::Vector3> points) ;

/// @brief Method SetEditState addr 0x201a37c size 0x8 virtual false final false
 void SetEditState(HoudiniEngineUnity::HoudiniEngineUnity__HEU_Curve__CurveEditState editState) ;

/// @brief Method SetCurvePoint addr 0x201a384 size 0xa0 virtual false final false
 void SetCurvePoint(int32_t pointIndex, UnityEngine::Vector3 newPosition) ;

/// @brief Method GetCurvePoint addr 0x201a424 size 0xd0 virtual false final false
 UnityEngine::Vector3 GetCurvePoint(int32_t pointIndex) ;

/// @brief Method GetAllPointTransforms addr 0x201a4f4 size 0x8 virtual false final false
 System::Collections::Generic::List_1<HoudiniEngineUnity::CurveNodeData> GetAllPointTransforms() ;

/// @brief Method GetAllPoints addr 0x201a4fc size 0x120 virtual false final false
 System::Collections::Generic::List_1<UnityEngine::Vector3> GetAllPoints() ;

/// @brief Method GetNumPoints addr 0x201a624 size 0x48 virtual false final false
 int32_t GetNumPoints() ;

/// @brief Method GetTransformedPoint addr 0x201a66c size 0xc8 virtual false final false
 UnityEngine::Vector3 GetTransformedPoint(int32_t pointIndex) ;

/// @brief Method GetTransformedPosition addr 0x201a734 size 0x50 virtual false final false
 UnityEngine::Vector3 GetTransformedPosition(UnityEngine::Vector3 inPosition) ;

/// @brief Method GetInvertedTransformedPosition addr 0x201a784 size 0x50 virtual false final false
 UnityEngine::Vector3 GetInvertedTransformedPosition(UnityEngine::Vector3 inPosition) ;

/// @brief Method GetInvertedTransformedDirection addr 0x201a7d4 size 0x50 virtual false final false
 UnityEngine::Vector3 GetInvertedTransformedDirection(UnityEngine::Vector3 inPosition) ;

/// @brief Method GetVertices addr 0x201a824 size 0x8 virtual false final false
 ::ArrayW<UnityEngine::Vector3> GetVertices() ;

/// @brief Method SetCurveGeometryVisibility addr 0x201a82c size 0xe8 virtual false final false
 void SetCurveGeometryVisibility(bool bVisible) ;

/// @brief Method DownloadPresetData addr 0x2019b90 size 0x98 virtual false final false
 void DownloadPresetData(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method UploadPresetData addr 0x201a914 size 0x98 virtual false final false
 void UploadPresetData(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method DownloadAsDefaultPresetData addr 0x201a9ac size 0x98 virtual false final false
 void DownloadAsDefaultPresetData(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method DuplicateCurveNodeData addr 0x201aa44 size 0x224 virtual false final false
 System::Collections::Generic::List_1<HoudiniEngineUnity::CurveNodeData> DuplicateCurveNodeData() ;

/// @brief Method SetCurveNodeData addr 0x201ac68 size 0x8 virtual false final false
 void SetCurveNodeData(System::Collections::Generic::List_1<HoudiniEngineUnity::CurveNodeData> curveNodeData) ;

/// @brief Method IsEquivalentTo addr 0x201ac70 size 0x36c virtual true final true
 bool IsEquivalentTo(HoudiniEngineUnity::HEU_Curve other) ;

// Ctor Parameters []
explicit HEU_Curve() ;

/// @brief Method .ctor addr 0x201afdc size 0x7c virtual false final false
 void _ctor() ;
