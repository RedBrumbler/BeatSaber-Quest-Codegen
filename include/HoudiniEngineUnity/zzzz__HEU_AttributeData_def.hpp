...
/// @brief Method IsColorAttribute addr 0x204453c size 0x70 virtual false final false
 bool IsColorAttribute() ;

/// @brief Method CopyValuesTo addr 0x20445ac size 0x124 virtual false final false
 void CopyValuesTo(HoudiniEngineUnity::HEU_AttributeData destAttrData) ;

/// @brief Method IsEquivalentTo addr 0x20446d0 size 0x328 virtual true final true
 bool IsEquivalentTo(HoudiniEngineUnity::HEU_AttributeData other) ;

// Ctor Parameters []
explicit HEU_AttributeData() ;

/// @brief Method .ctor addr 0x20449f8 size 0x8 virtual false final false
 void _ctor() ;
