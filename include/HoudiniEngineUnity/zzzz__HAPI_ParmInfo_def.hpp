...
/// @brief Method isInt addr 0x20578f0 size 0x20 virtual false final false
 bool isInt() ;

/// @brief Method isFloat addr 0x2057910 size 0x14 virtual false final false
 bool isFloat() ;

/// @brief Method isString addr 0x2057924 size 0x30 virtual false final false
 bool isString() ;

/// @brief Method isPath addr 0x2057954 size 0x20 virtual false final false
 bool isPath() ;

/// @brief Method isNode addr 0x2057974 size 0x10 virtual false final false
 bool isNode() ;

/// @brief Method isNonValue addr 0x2057984 size 0x14 virtual false final false
 bool isNonValue() ;
