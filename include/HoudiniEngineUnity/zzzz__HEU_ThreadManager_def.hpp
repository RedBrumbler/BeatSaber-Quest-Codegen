...
/// @brief Method get_Instance addr 0x2077d90 size 0x48 virtual false final false
static HoudiniEngineUnity::HEU_ThreadManager get_Instance() ;

/// @brief Method CreateInstance addr 0x2077dd8 size 0x4 virtual false final false
static void CreateInstance() ;

/// @brief Method Finalize addr 0x2077ddc size 0x8 virtual true final false
 void Finalize() ;

/// @brief Method Register addr 0x2077de8 size 0x4 virtual false final false
 void Register() ;

/// @brief Method Unregister addr 0x2077de4 size 0x4 virtual false final false
 void Unregister() ;

/// @brief Method Update addr 0x2077dec size 0x3d4 virtual false final false
 void Update() ;

/// @brief Method AddTask addr 0x20781c0 size 0xec virtual false final false
 void AddTask(HoudiniEngineUnity::HEU_ThreadedTask task) ;

/// @brief Method RemoveTask addr 0x20782ac size 0xec virtual false final false
 void RemoveTask(HoudiniEngineUnity::HEU_ThreadedTask task) ;

// Ctor Parameters []
explicit HEU_ThreadManager() ;

/// @brief Method .ctor addr 0x2078398 size 0xbc virtual false final false
 void _ctor() ;
