...
/// @brief Method .ctor addr 0x20aac8c size 0x28 virtual false final false
 void _ctor(UnityEngine::MeshRenderer self) ;

/// @brief Method IsNull addr 0x20aacb4 size 0x60 virtual true final true
 bool IsNull() ;

/// @brief Method IsEquivalentTo addr 0x20aad14 size 0x13c virtual true final true
