...
/// @brief Method get_InputType addr 0x203268c size 0x8 virtual false final false
 HoudiniEngineUnity::HoudiniEngineUnity__HEU_InputNode__InputNodeType get_InputType() ;

/// @brief Method get_ThisInputObjectType addr 0x2032694 size 0x8 virtual false final false
 HoudiniEngineUnity::HoudiniEngineUnity__HEU_InputNode__InputObjectType get_ThisInputObjectType() ;

/// @brief Method get_PendingInputObjectType addr 0x203269c size 0x8 virtual false final false
 HoudiniEngineUnity::HoudiniEngineUnity__HEU_InputNode__InputObjectType get_PendingInputObjectType() ;

/// @brief Method set_PendingInputObjectType addr 0x20326a4 size 0x8 virtual false final false
 void set_PendingInputObjectType(HoudiniEngineUnity::HoudiniEngineUnity__HEU_InputNode__InputObjectType value) ;

/// @brief Method get_InputObjects addr 0x20326ac size 0x8 virtual false final false
 System::Collections::Generic::List_1<HoudiniEngineUnity::HEU_InputObjectInfo> get_InputObjects() ;

/// @brief Method get_InputNodeID addr 0x20326b4 size 0x8 virtual false final false
 int32_t get_InputNodeID() ;

/// @brief Method get_RequiresCook addr 0x20326bc size 0x8 virtual false final false
 bool get_RequiresCook() ;

/// @brief Method set_RequiresCook addr 0x20326c4 size 0xc virtual false final false
 void set_RequiresCook(bool value) ;

/// @brief Method get_RequiresUpload addr 0x20326d0 size 0x8 virtual false final false
 bool get_RequiresUpload() ;

/// @brief Method set_RequiresUpload addr 0x20326d8 size 0xc virtual false final false
 void set_RequiresUpload(bool value) ;

/// @brief Method get_InputName addr 0x20326e4 size 0x8 virtual false final false
 ::StringW get_InputName() ;

/// @brief Method get_LabelName addr 0x20326ec size 0x8 virtual false final false
 ::StringW get_LabelName() ;

/// @brief Method get_ParamName addr 0x20326f4 size 0x8 virtual false final false
 ::StringW get_ParamName() ;

/// @brief Method set_ParamName addr 0x20326fc size 0x8 virtual false final false
 void set_ParamName(::StringW value) ;

/// @brief Method get_KeepWorldTransform addr 0x2032704 size 0x8 virtual false final false
 bool get_KeepWorldTransform() ;

/// @brief Method set_KeepWorldTransform addr 0x203270c size 0xc virtual false final false
 void set_KeepWorldTransform(bool value) ;

/// @brief Method get_PackGeometryBeforeMerging addr 0x2032718 size 0x8 virtual false final false
 bool get_PackGeometryBeforeMerging() ;

/// @brief Method set_PackGeometryBeforeMerging addr 0x2032720 size 0xc virtual false final false
 void set_PackGeometryBeforeMerging(bool value) ;

/// @brief Method get_ParentAsset addr 0x203272c size 0x8 virtual false final false
 HoudiniEngineUnity::HEU_HoudiniAsset get_ParentAsset() ;

/// @brief Method IsAssetInput addr 0x2032734 size 0x10 virtual false final false
 bool IsAssetInput() ;

/// @brief Method get_TilemapSettings addr 0x2032744 size 0x8 virtual false final false
 HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings get_TilemapSettings() ;

/// @brief Method CreateSetupInput addr 0x203274c size 0x90 virtual false final false
...
/// @brief Method SetInputNodeID addr 0x20327dc size 0x8 virtual false final false
 void SetInputNodeID(int32_t nodeID) ;

/// @brief Method DestroyAllData addr 0x20327e4 size 0x1c virtual false final false
 void DestroyAllData(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method ResetInputObjectTransforms addr 0x2032ae0 size 0xec virtual false final false
 void ResetInputObjectTransforms() ;

/// @brief Method ResetInputNode addr 0x2032bcc size 0x4c virtual false final false
 void ResetInputNode(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method InsertInputEntry addr 0x2032c98 size 0x258 virtual false final false
 void InsertInputEntry(int32_t index, UnityEngine::GameObject newInputGameObject) ;

/// @brief Method GetInputEntryGameObject addr 0x2032fe8 size 0x23c virtual false final false
 UnityEngine::GameObject GetInputEntryGameObject(int32_t index) ;

/// @brief Method AddInputEntryAtEnd addr 0x2033224 size 0x8c virtual false final false
 void AddInputEntryAtEnd(UnityEngine::GameObject newEntryGameObject) ;

/// @brief Method AddInputEntryAtEndMesh addr 0x2033420 size 0x2c virtual false final false
 HoudiniEngineUnity::HEU_InputObjectInfo AddInputEntryAtEndMesh(UnityEngine::GameObject newEntryGameObject) ;

/// @brief Method RemoveAllInputEntries addr 0x2032a38 size 0xa8 virtual false final false
 void RemoveAllInputEntries() ;

/// @brief Method NumInputEntries addr 0x203344c size 0x84 virtual false final false
 int32_t NumInputEntries() ;

/// @brief Method ChangeInputType addr 0x2032c68 size 0x30 virtual false final false
...
/// @brief Method ResetConnectionForForceUpdate addr 0x2032c18 size 0x50 virtual false final false
 void ResetConnectionForForceUpdate(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method UploadInput addr 0x2033a50 size 0x3fc virtual false final false
 void UploadInput(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method UploadHDAInput addr 0x2033e4c size 0x1c0 virtual false final false
 void UploadHDAInput(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method UploadUnityInput addr 0x203400c size 0x59c virtual false final false
 void UploadUnityInput(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method AreAnyInputHDAsConnected addr 0x20334d0 size 0x1b4 virtual false final false
 bool AreAnyInputHDAsConnected() ;

/// @brief Method ReconnectToUpstreamAsset addr 0x2034aac size 0x274 virtual false final false
 void ReconnectToUpstreamAsset() ;

/// @brief Method CreateInputObjectInfo addr 0x2032f10 size 0x68 virtual false final false
 HoudiniEngineUnity::HEU_InputObjectInfo CreateInputObjectInfo(UnityEngine::GameObject inputGameObject) ;

/// @brief Method CreateInputHDAInfo addr 0x2032f78 size 0x70 virtual false final false
 HoudiniEngineUnity::HEU_InputHDAInfo CreateInputHDAInfo(UnityEngine::GameObject inputGameObject) ;

/// @brief Method InternalAddInputObjectAtEnd addr 0x20332b0 size 0xb8 virtual false final false
 HoudiniEngineUnity::HEU_InputObjectInfo InternalAddInputObjectAtEnd(UnityEngine::GameObject newInputGameObject) ;

/// @brief Method InternalAddInputHDAAtEnd addr 0x2033368 size 0xb8 virtual false final false
 HoudiniEngineUnity::HEU_InputHDAInfo InternalAddInputHDAAtEnd(UnityEngine::GameObject newInputHDA) ;

/// @brief Method DisconnectConnectedMergeNode addr 0x2033684 size 0x214 virtual false final false
 void DisconnectConnectedMergeNode(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method ClearConnectedInputHDAs addr 0x2033898 size 0x1b8 virtual false final false
 void ClearConnectedInputHDAs() ;

/// @brief Method ConnectToMergeObject addr 0x20345a8 size 0x180 virtual false final false
 void ConnectToMergeObject(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method DisconnectAndDestroyInputs addr 0x2032808 size 0x230 virtual false final false
 void DisconnectAndDestroyInputs(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method GetConnectedInputCount addr 0x2034e1c size 0x84 virtual false final false
 int32_t GetConnectedInputCount() ;

/// @brief Method GetConnectedNodeID addr 0x2034ea0 size 0xd8 virtual false final false
 int32_t GetConnectedNodeID(int32_t index) ;

/// @brief Method UploadObjectMergeTransformType addr 0x2034728 size 0x114 virtual false final false
 bool UploadObjectMergeTransformType(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method UploadObjectMergePackGeometry addr 0x203483c size 0x114 virtual false final false
 bool UploadObjectMergePackGeometry(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method HasInputNodeTransformChanged addr 0x2034f78 size 0x25c virtual false final false
 bool HasInputNodeTransformChanged() ;

/// @brief Method UploadInputObjectTransforms addr 0x20351d4 size 0x188 virtual false final false
 void UploadInputObjectTransforms(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method UpdateOnAssetRecreation addr 0x203535c size 0x16c virtual false final false
 void UpdateOnAssetRecreation(HoudiniEngineUnity::HEU_SessionBase session) ;

/// @brief Method CopyInputValuesTo addr 0x20354c8 size 0x444 virtual false final false
 void CopyInputValuesTo(HoudiniEngineUnity::HEU_SessionBase session, HoudiniEngineUnity::HEU_InputNode destInputNode) ;

/// @brief Method PopulateInputPreset addr 0x2035930 size 0x58c virtual false final false
 void PopulateInputPreset(HoudiniEngineUnity::HEU_InputPreset inputPreset) ;

/// @brief Method LoadPreset addr 0x2035ebc size 0x524 virtual false final false
 void LoadPreset(HoudiniEngineUnity::HEU_SessionBase session, HoudiniEngineUnity::HEU_InputPreset inputPreset) ;

/// @brief Method FindAddToInputHDA addr 0x20363e0 size 0x158 virtual false final false
 bool FindAddToInputHDA(::StringW gameObjectName) ;

/// @brief Method NotifyParentRemovedInput addr 0x2036538 size 0x88 virtual false final false
 void NotifyParentRemovedInput() ;

/// @brief Method ClearUICache addr 0x2032800 size 0x8 virtual false final false
 void ClearUICache() ;

/// @brief Method HandleSelectedObjectsForInputObjects addr 0x20365c0 size 0x11c virtual false final false
 void HandleSelectedObjectsForInputObjects(::ArrayW<UnityEngine::GameObject> selectedObjects) ;

/// @brief Method HandleSelectedObjectsForInputHDAs addr 0x20366dc size 0x11c virtual false final false
 void HandleSelectedObjectsForInputHDAs(::ArrayW<UnityEngine::GameObject> selectedObjects) ;

/// @brief Method IsEquivalentTo addr 0x20367f8 size 0x414 virtual true final true
 bool IsEquivalentTo(HoudiniEngineUnity::HEU_InputNode other) ;

/// @brief Method GetInternalObjectType addr 0x2032ef0 size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0x2036c0c size 0x14c virtual false final false
 void _ctor() ;
