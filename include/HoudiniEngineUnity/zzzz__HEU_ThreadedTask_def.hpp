...
/// @brief Method Start addr 0x2071b18 size 0x13c virtual true final false
 void Start() ;

/// @brief Method Stop addr 0x2071dd4 size 0x3c virtual true final false
 void Stop() ;

/// @brief Method Abort addr 0x2071f98 size 0x34 virtual true final false
 void Abort() ;

/// @brief Method Reset addr 0x2071fcc size 0x84 virtual true final false
 void Reset() ;

/// @brief Method Update addr 0x2072050 size 0x58 virtual true final false
 void Update() ;

/// @brief Method DoWork addr 0x2072238 size 0x4 virtual true final false
 void DoWork() ;

/// @brief Method OnComplete addr 0x207223c size 0x4 virtual true final false
 void OnComplete() ;

/// @brief Method OnStopped addr 0x2072240 size 0x4 virtual true final false
 void OnStopped() ;

/// @brief Method CleanUp addr 0x2072244 size 0x4 virtual true final false
 void CleanUp() ;

/// @brief Method Run addr 0x2072248 size 0x24 virtual false final false
 void Run() ;

/// @brief Method get_TaskName addr 0x207226c size 0x8 virtual false final false
 ::StringW get_TaskName() ;

/// @brief Method get_IsComplete addr 0x2071e10 size 0xc8 virtual false final false
 bool get_IsComplete() ;

/// @brief Method set_IsComplete addr 0x2071d14 size 0xc0 virtual false final false
 void set_IsComplete(bool value) ;

/// @brief Method get_IsActive addr 0x20720a8 size 0xc8 virtual false final false
 bool get_IsActive() ;

/// @brief Method set_IsActive addr 0x2071c54 size 0xc0 virtual false final false
 void set_IsActive(bool value) ;

/// @brief Method get_StopRequested addr 0x2072170 size 0xc8 virtual false final false
 bool get_StopRequested() ;

/// @brief Method set_StopRequested addr 0x2071ed8 size 0xc0 virtual false final false
 void set_StopRequested(bool value) ;

/// @brief Method get_Priority addr 0x2072274 size 0x8 virtual false final false
 System::Threading::ThreadPriority get_Priority() ;

/// @brief Method set_Priority addr 0x207227c size 0x8 virtual false final false
 void set_Priority(System::Threading::ThreadPriority value) ;

/// @brief Method get_IsBackground addr 0x2072284 size 0x8 virtual false final false
 bool get_IsBackground() ;

/// @brief Method set_IsBackground addr 0x207228c size 0xc virtual false final false
 void set_IsBackground(bool value) ;

// Ctor Parameters []
explicit HEU_ThreadedTask() ;

/// @brief Method .ctor addr 0x2072298 size 0x70 virtual false final false
 void _ctor() ;
