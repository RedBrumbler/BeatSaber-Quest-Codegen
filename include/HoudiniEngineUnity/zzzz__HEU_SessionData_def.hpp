...
/// @brief Method GetOrCreateSessionSync addr 0x2068474 size 0x68 virtual false final false
 HoudiniEngineUnity::HEU_SessionSyncData GetOrCreateSessionSync() ;

/// @brief Method GetSessionSync addr 0x2068588 size 0x8 virtual false final false
 HoudiniEngineUnity::HEU_SessionSyncData GetSessionSync() ;

/// @brief Method SetSessionSync addr 0x2068590 size 0x8 virtual false final false
 void SetSessionSync(HoudiniEngineUnity::HEU_SessionSyncData syncData) ;

/// @brief Method get_SessionID addr 0x2068598 size 0x58 virtual false final false
 int64_t get_SessionID() ;

/// @brief Method set_SessionID addr 0x2067c7c size 0x8 virtual false final false
 void set_SessionID(int64_t value) ;

/// @brief Method get_ProcessID addr 0x20685f0 size 0x8 virtual false final false
 int32_t get_ProcessID() ;

/// @brief Method set_ProcessID addr 0x20685f8 size 0x8 virtual false final false
 void set_ProcessID(int32_t value) ;

/// @brief Method get_SessionType addr 0x2068600 size 0x8 virtual false final false
 HoudiniEngineUnity::HAPI_SessionType get_SessionType() ;

/// @brief Method set_SessionType addr 0x2068608 size 0x8 virtual false final false
 void set_SessionType(HoudiniEngineUnity::HAPI_SessionType value) ;

/// @brief Method get_IsInitialized addr 0x2068610 size 0x8 virtual false final false
 bool get_IsInitialized() ;

/// @brief Method set_IsInitialized addr 0x2068618 size 0xc virtual false final false
 void set_IsInitialized(bool value) ;

/// @brief Method get_IsValidSessionID addr 0x2068624 size 0x8 virtual false final false
 bool get_IsValidSessionID() ;

/// @brief Method get_PipeName addr 0x206862c size 0x40 virtual false final false
 ::StringW get_PipeName() ;

/// @brief Method set_PipeName addr 0x206866c size 0x8 virtual false final false
 void set_PipeName(::StringW value) ;

/// @brief Method get_Port addr 0x2068674 size 0x8 virtual false final false
 int32_t get_Port() ;

/// @brief Method set_Port addr 0x206867c size 0x8 virtual false final false
 void set_Port(int32_t value) ;

/// @brief Method get_SessionClassType addr 0x2068684 size 0xa8 virtual false final false
 System::Type get_SessionClassType() ;

/// @brief Method set_SessionClassType addr 0x206872c size 0x30 virtual false final false
 void set_SessionClassType(System::Type value) ;

/// @brief Method get_IsDefaultSession addr 0x206875c size 0x8 virtual false final false
 bool get_IsDefaultSession() ;

/// @brief Method set_IsDefaultSession addr 0x2068764 size 0xc virtual false final false
 void set_IsDefaultSession(bool value) ;

/// @brief Method get_IsSessionSync addr 0x206783c size 0x10 virtual false final false
 bool get_IsSessionSync() ;

/// @brief Method get_ThisConnectionMode addr 0x2068770 size 0x8 virtual false final false
 HoudiniEngineUnity::SessionConnectionState get_ThisConnectionMode() ;

/// @brief Method set_ThisConnectionMode addr 0x2068778 size 0x8 virtual false final false
 void set_ThisConnectionMode(HoudiniEngineUnity::SessionConnectionState value) ;

/// @brief Method get_ThisSessionMode addr 0x2068780 size 0x8 virtual false final false
 HoudiniEngineUnity::SessionMode get_ThisSessionMode() ;

/// @brief Method set_ThisSessionMode addr 0x2068788 size 0x8 virtual false final false
 void set_ThisSessionMode(HoudiniEngineUnity::SessionMode value) ;

// Ctor Parameters []
explicit HEU_SessionData() ;

/// @brief Method .ctor addr 0x2068790 size 0x10 virtual false final false
 void _ctor() ;
