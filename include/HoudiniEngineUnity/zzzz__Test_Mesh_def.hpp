...
/// @brief Method .ctor addr 0x20aa44c size 0x28 virtual false final false
 void _ctor(UnityEngine::Mesh self) ;

/// @brief Method IsNull addr 0x20aa474 size 0x60 virtual true final true
 bool IsNull() ;

/// @brief Method IsEquivalentTo addr 0x20aa4d4 size 0x42c virtual true final true
