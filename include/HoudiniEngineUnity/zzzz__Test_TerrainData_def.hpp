...
/// @brief Method .ctor addr 0x20ad584 size 0x28 virtual false final false
 void _ctor(UnityEngine::TerrainData self) ;

/// @brief Method IsNull addr 0x20ad5ac size 0x60 virtual true final true
 bool IsNull() ;

/// @brief Method IsEquivalentTo addr 0x20ad60c size 0x568 virtual true final true
