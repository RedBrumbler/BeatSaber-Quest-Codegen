...
/// @brief Method get_Instance addr 0x2078454 size 0x7c virtual false final false
static HoudiniEngineUnity::HEU_CookLogs get_Instance() ;

/// @brief Method GetCookLogString addr 0x207855c size 0x20 virtual false final false
 ::StringW GetCookLogString() ;

/// @brief Method AppendCookLog addr 0x207857c size 0x100 virtual false final false
 void AppendCookLog(::StringW logStr) ;

/// @brief Method ClearCookLog addr 0x20788c4 size 0x64 virtual false final false
 void ClearCookLog() ;

/// @brief Method GetCookLogFilePath addr 0x2078928 size 0xd4 virtual false final false
 ::StringW GetCookLogFilePath() ;

/// @brief Method DeleteCookingFile addr 0x20789fc size 0x88 virtual false final false
 void DeleteCookingFile() ;

/// @brief Method WriteToLogFile addr 0x207867c size 0x248 virtual false final false
 void WriteToLogFile(::StringW logStr, bool checkLastLogStr) ;

/// @brief Method GetFileSizeOfLogFile addr 0x2078a84 size 0x88 virtual false final false
 int64_t GetFileSizeOfLogFile() ;

// Ctor Parameters []
explicit HEU_CookLogs() ;

/// @brief Method .ctor addr 0x20784d0 size 0x8c virtual false final false
 void _ctor() ;
