...
/// @brief Method CopyTo addr 0x203590c size 0x24 virtual false final false
 void CopyTo(HoudiniEngineUnity::HEU_InputHDAInfo destInfo) ;

/// @brief Method IsEquivalentTo addr 0x2036fe4 size 0x130 virtual true final true
 bool IsEquivalentTo(HoudiniEngineUnity::HEU_InputHDAInfo other) ;

// Ctor Parameters []
explicit HEU_InputHDAInfo() ;

/// @brief Method .ctor addr 0x2034e0c size 0x10 virtual false final false
 void _ctor() ;
