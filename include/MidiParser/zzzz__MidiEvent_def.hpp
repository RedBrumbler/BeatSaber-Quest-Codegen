...
/// @brief Method get_MetaEventType addr 0x22b2e00 size 0x8 virtual false final false
 MidiParser::MetaEventType get_MetaEventType() ;

/// @brief Method get_Channel addr 0x22b2e08 size 0x8 virtual false final false
 int32_t get_Channel() ;

/// @brief Method get_Note addr 0x22b2e10 size 0x8 virtual false final false
 int32_t get_Note() ;

/// @brief Method get_Velocity addr 0x22b2e18 size 0x8 virtual false final false
 int32_t get_Velocity() ;

/// @brief Method get_Value addr 0x22b2e20 size 0x8 virtual false final false
 int32_t get_Value() ;
