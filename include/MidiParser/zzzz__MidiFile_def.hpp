...
/// @brief Method Read16 addr 0x22b2624 size 0x54 virtual false final false
static int32_t Read16(::ArrayW<uint8_t> data, ByRef<int32_t> i) ;

/// @brief Method Read32 addr 0x22b2594 size 0x90 virtual false final false
static int32_t Read32(::ArrayW<uint8_t> data, ByRef<int32_t> i) ;

/// @brief Method Read8 addr 0x22b2ba0 size 0x38 virtual false final false
static uint8_t Read8(::ArrayW<uint8_t> data, ByRef<int32_t> i) ;

/// @brief Method ReadAllBytesFromStream addr 0x22b2bd8 size 0x228 virtual false final false
static ::ArrayW<uint8_t> ReadAllBytesFromStream(System::IO::Stream input) ;

/// @brief Method ReadString addr 0x22b253c size 0x58 virtual false final false
static ::StringW ReadString(::ArrayW<uint8_t> data, ByRef<int32_t> i, int32_t length) ;

/// @brief Method ReadVarInt addr 0x22b2aa0 size 0x84 virtual false final false
...
/// @brief Method .ctor addr 0x22b2224 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x22b2248 size 0x2f4 virtual false final false
 void _ctor(::ArrayW<uint8_t> data) ;

/// @brief Method ParseMetaEvent addr 0x22b29bc size 0xe4 virtual false final false
...
/// @brief Method ParseTrack addr 0x22b2678 size 0x344 virtual false final false
