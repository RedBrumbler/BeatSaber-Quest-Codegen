...
/// @brief Method get_Enabled addr 0x22f8b14 size 0x60 virtual false final false
static bool get_Enabled() ;

/// @brief Method TaskWaitBegin_Asynchronous addr 0x22f8b74 size 0x84 virtual false final false
static void TaskWaitBegin_Asynchronous(int32_t OriginatingTaskSchedulerID, int32_t OriginatingTaskID, int32_t TaskID) ;

/// @brief Method TaskWaitBegin_Synchronous addr 0x22f8bf8 size 0x84 virtual false final false
static void TaskWaitBegin_Synchronous(int32_t OriginatingTaskSchedulerID, int32_t OriginatingTaskID, int32_t TaskID) ;

/// @brief Method TaskWaitEnd addr 0x22f8c7c size 0x84 virtual false final false
static void TaskWaitEnd(int32_t OriginatingTaskSchedulerID, int32_t OriginatingTaskID, int32_t TaskID) ;

/// @brief Method TaskScheduled addr 0x22f8d00 size 0xa0 virtual false final false
