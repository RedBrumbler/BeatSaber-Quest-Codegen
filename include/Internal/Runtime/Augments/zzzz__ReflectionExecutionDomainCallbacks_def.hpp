...
/// @brief Method CreateMissingMetadataException addr 0x22f8e98 size 0x5c virtual false final false
 System::Exception CreateMissingMetadataException(System::Type attributeType) ;

// Ctor Parameters []
explicit ReflectionExecutionDomainCallbacks() ;

/// @brief Method .ctor addr 0x22f8e90 size 0x8 virtual false final false
 void _ctor() ;
