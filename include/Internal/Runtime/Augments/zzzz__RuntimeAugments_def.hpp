...
/// @brief Method ReportUnhandledException addr 0x22f8da0 size 0x20 virtual false final false
static void ReportUnhandledException(System::Exception exception) ;

/// @brief Method get_Callbacks addr 0x22f8dc0 size 0x58 virtual false final false
