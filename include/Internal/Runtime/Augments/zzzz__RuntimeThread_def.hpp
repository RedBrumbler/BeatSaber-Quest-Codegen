...
/// @brief Method .ctor addr 0x22f8ef4 size 0x28 virtual false final false
 void _ctor(System::Threading::Thread t) ;

/// @brief Method Create addr 0x22f8f1c size 0xa4 virtual false final false
...
/// @brief Method set_IsBackground addr 0x22f8fc0 size 0x20 virtual false final false
 void set_IsBackground(bool value) ;

/// @brief Method Start addr 0x22f8fe0 size 0x1c virtual false final false
 void Start(::bs_hook::Il2CppWrapperType state) ;

/// @brief Method Sleep addr 0x22f8ffc size 0x8 virtual false final false
static void Sleep(int32_t millisecondsTimeout) ;

/// @brief Method Yield addr 0x22f9004 size 0x8 virtual false final false
static bool Yield() ;

/// @brief Method SpinWait addr 0x22f900c size 0x18 virtual false final false
static bool SpinWait(int32_t iterations) ;

/// @brief Method GetCurrentProcessorId addr 0x22f9024 size 0x8 virtual false final false
