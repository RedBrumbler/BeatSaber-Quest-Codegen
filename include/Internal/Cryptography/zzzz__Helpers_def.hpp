...
/// @brief Method CloneByteArray addr 0x22f9078 size 0x78 virtual false final false
static ::ArrayW<uint8_t> CloneByteArray(::ArrayW<uint8_t> src) ;

/// @brief Method ToHexArrayUpper addr 0x22f90f0 size 0xec virtual false final false
static ::ArrayW<char16_t> ToHexArrayUpper(::ArrayW<uint8_t> bytes) ;

/// @brief Method ToHexStringUpper addr 0x22f91f8 size 0x10 virtual false final false
static ::StringW ToHexStringUpper(::ArrayW<uint8_t> bytes) ;

/// @brief Method NibbleToHex addr 0x22f91dc size 0x1c virtual false final false
