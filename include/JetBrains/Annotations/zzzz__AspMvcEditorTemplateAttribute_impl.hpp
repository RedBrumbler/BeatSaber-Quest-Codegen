...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (JetBrains::Annotations::AspMvcEditorTemplateAttribute::*)()>(&JetBrains::Annotations::AspMvcEditorTemplateAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2d732d4;
...
// Ctor Parameters []
 JetBrains::Annotations::AspMvcEditorTemplateAttribute::AspMvcEditorTemplateAttribute()  : System::Attribute(THROW_UNLESS(::il2cpp_utils::New<AspMvcEditorTemplateAttribute>())) {}
