...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (JetBrains::Annotations::InvokerParameterNameAttribute::*)()>(&JetBrains::Annotations::InvokerParameterNameAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2d72c88;
...
// Ctor Parameters []
 JetBrains::Annotations::InvokerParameterNameAttribute::InvokerParameterNameAttribute()  : System::Attribute(THROW_UNLESS(::il2cpp_utils::New<InvokerParameterNameAttribute>())) {}
