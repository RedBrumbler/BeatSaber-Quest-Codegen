...
explicit AspMvcViewLocationFormatAttribute(::StringW format) ;

/// @brief Method .ctor addr 0x2d731b4 size 0x28 virtual false final false
 void _ctor(::StringW format) ;

/// @brief Method get_Format addr 0x2d731dc size 0x8 virtual false final false
 ::StringW get_Format() ;

/// @brief Method set_Format addr 0x2d731e4 size 0x8 virtual false final false
