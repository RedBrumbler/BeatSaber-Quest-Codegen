...
/// @brief Method .ctor addr 0x2d72f84 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "comment", ty: "::StringW", modifiers: "", def_value: None }]
explicit PublicAPIAttribute(::StringW comment) ;

/// @brief Method .ctor addr 0x2d72f8c size 0x28 virtual false final false
 void _ctor(::StringW comment) ;

/// @brief Method get_Comment addr 0x2d72fb4 size 0x8 virtual false final false
 ::StringW get_Comment() ;

/// @brief Method set_Comment addr 0x2d72fbc size 0x8 virtual false final false
