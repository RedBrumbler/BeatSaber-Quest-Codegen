...
/// @brief Method .ctor addr 0x2d73548 size 0x2c virtual false final false
 void _ctor(::StringW type, ::StringW fieldName) ;

/// @brief Method get_Type addr 0x2d73574 size 0x8 virtual false final false
 ::StringW get_Type() ;

/// @brief Method set_Type addr 0x2d7357c size 0x8 virtual false final false
 void set_Type(::StringW value) ;

/// @brief Method get_FieldName addr 0x2d73584 size 0x8 virtual false final false
 ::StringW get_FieldName() ;

/// @brief Method set_FieldName addr 0x2d7358c size 0x8 virtual false final false
