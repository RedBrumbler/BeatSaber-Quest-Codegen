...
/// @brief Method .ctor addr 0x2d73304 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }]
explicit HtmlElementAttributesAttribute(::StringW name) ;

/// @brief Method .ctor addr 0x2d7330c size 0x28 virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method get_Name addr 0x2d73334 size 0x8 virtual false final false
 ::StringW get_Name() ;

/// @brief Method set_Name addr 0x2d7333c size 0x8 virtual false final false
