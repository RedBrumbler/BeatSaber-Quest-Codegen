...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<JetBrains::Annotations::AssertionConditionType (JetBrains::Annotations::AssertionConditionAttribute::*)()>(&JetBrains::Annotations::AssertionConditionAttribute::get_ConditionType)> {
  ...
  constexpr static std::size_t addrs = 0x2d733ec;
...
::cordl_internals::setInstanceField<JetBrains::Annotations::AssertionConditionType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<JetBrains::Annotations::AssertionConditionType>(value));
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, conditionType);
}
...
return ::cordl_internals::RunMethodRethrow<JetBrains::Annotations::AssertionConditionType, false>(const_cast<void*>(instance), ___internal_method);
}
