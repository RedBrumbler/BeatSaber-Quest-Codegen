...
/// @brief Method .ctor addr 0x2d73144 size 0x28 virtual false final false
 void _ctor(::StringW format) ;

/// @brief Method get_Format addr 0x2d7316c size 0x8 virtual false final false
 ::StringW get_Format() ;

/// @brief Method set_Format addr 0x2d73174 size 0x8 virtual false final false
