...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (JetBrains::Annotations::AspMvcViewLocationFormatAttribute::*)()>(&JetBrains::Annotations::AspMvcViewLocationFormatAttribute::get_Format)> {
  ...
  constexpr static std::size_t addrs = 0x2d731dc;
...
constexpr ::StringW JetBrains::Annotations::AspMvcViewLocationFormatAttribute::__get__Format_k__BackingField() const {
return ::cordl_internals::getInstanceField<::StringW, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
// Ctor Parameters [CppParam { name: "format", ty: "::StringW", modifiers: "", def_value: None }]
 JetBrains::Annotations::AspMvcViewLocationFormatAttribute::AspMvcViewLocationFormatAttribute(::StringW format)  : System::Attribute(THROW_UNLESS(::il2cpp_utils::New<AspMvcViewLocationFormatAttribute>(format))) {}
 void JetBrains::Annotations::AspMvcViewLocationFormatAttribute::_ctor(::StringW format)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<JetBrains::Annotations::AspMvcViewLocationFormatAttribute>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
