...
/// @brief Method get_eventData addr 0x2d6ce18 size 0x8 virtual false final false
 VRUIControls::MouseButtonEventData get_eventData() ;

/// @brief Method set_eventData addr 0x2d6ce20 size 0x8 virtual false final false
 void set_eventData(VRUIControls::MouseButtonEventData value) ;

/// @brief Method get_button addr 0x2d6ce28 size 0x8 virtual false final false
 UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__InputButton get_button() ;

/// @brief Method set_button addr 0x2d6ce30 size 0x8 virtual false final false
 void set_button(UnityEngine::EventSystems::UnityEngine__EventSystems__PointerEventData__InputButton value) ;

/// @brief Method get_pressedValue addr 0x2d6ce38 size 0x8 virtual false final false
 float_t get_pressedValue() ;

/// @brief Method set_pressedValue addr 0x2d6ce40 size 0x8 virtual false final false
 void set_pressedValue(float_t value) ;

// Ctor Parameters []
explicit ButtonState() ;

/// @brief Method .ctor addr 0x2d6ce48 size 0x8 virtual false final false
 void _ctor() ;
