...
/// @brief Method SetLocalPosition addr 0x2d714f0 size 0x48 virtual false final false
 void SetLocalPosition(UnityEngine::Vector3 position) ;

/// @brief Method SetLocalScale addr 0x2d71538 size 0x48 virtual false final false
 void SetLocalScale(UnityEngine::Vector3 scale) ;

/// @brief Method SetFadeDistance addr 0x2d71580 size 0xfc virtual false final false
 void SetFadeDistance(float_t distance) ;

// Ctor Parameters []
explicit VRLaserPointer() ;

/// @brief Method .ctor addr 0x2d7167c size 0x8 virtual false final false
 void _ctor() ;
