...
/// @brief Method get_lastSelectedVrController addr 0x2d716ec size 0x8 virtual false final false
 GlobalNamespace::VRController get_lastSelectedVrController() ;

/// @brief Method get_cursorPosition addr 0x2d716f4 size 0xf0 virtual false final false
 UnityEngine::Vector3 get_cursorPosition() ;

/// @brief Method Awake addr 0x2d717e4 size 0xb4 virtual false final false
 void Awake() ;

/// @brief Method OnDisable addr 0x2d71af4 size 0x18 virtual false final false
 void OnDisable() ;

/// @brief Method LateUpdate addr 0x2d71b24 size 0x14c virtual false final false
 void LateUpdate() ;

/// @brief Method IsLeftControllerDown addr 0x2d71c70 size 0x50 virtual false final false
 bool IsLeftControllerDown() ;

/// @brief Method IsRightControllerDown addr 0x2d71cc0 size 0x50 virtual false final false
 bool IsRightControllerDown() ;

/// @brief Method SelectRightController addr 0x2d71ad0 size 0x14 virtual false final false
 void SelectRightController() ;

/// @brief Method SelectLeftController addr 0x2d71ae4 size 0x10 virtual false final false
 void SelectLeftController() ;

/// @brief Method EnabledLastSelectedPointer addr 0x2d71d10 size 0x54 virtual false final false
 void EnabledLastSelectedPointer() ;

/// @brief Method CreateLaserPointers addr 0x2d71898 size 0x104 virtual false final false
 bool CreateLaserPointers() ;

/// @brief Method SetupLaserPointer addr 0x2d71d64 size 0x74 virtual false final false
 void SetupLaserPointer(VRUIControls::VRLaserPointer laserPointer) ;

/// @brief Method CreateCursors addr 0x2d7199c size 0x134 virtual false final false
 bool CreateCursors() ;

/// @brief Method RefreshLaserPointerAndLaserHit addr 0x2d71dd8 size 0x238 virtual false final false
 void RefreshLaserPointerAndLaserHit(UnityEngine::EventSystems::PointerEventData pointerData) ;

/// @brief Method OnApplicationFocus addr 0x2d72010 size 0xc virtual false final false
 void OnApplicationFocus(bool hasFocus) ;

/// @brief Method HideLaserPointersAndCursors addr 0x2d71b0c size 0x18 virtual false final false
 void HideLaserPointersAndCursors() ;

/// @brief Method HideLaserPointers addr 0x2d7207c size 0x60 virtual false final false
 void HideLaserPointers() ;

/// @brief Method HideCursors addr 0x2d7201c size 0x60 virtual false final false
 void HideCursors() ;

/// @brief Method get_state addr 0x2d720dc size 0x2f4 virtual false final false
 ::StringW get_state() ;

/// @brief Method Process addr 0x2d70dd8 size 0x68 virtual false final false
 void Process(UnityEngine::EventSystems::PointerEventData pointerEventData) ;

// Ctor Parameters []
explicit VRPointer() ;

/// @brief Method .ctor addr 0x2d723d0 size 0x24 virtual false final false
 void _ctor() ;
