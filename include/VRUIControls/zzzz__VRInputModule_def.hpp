...
/// @brief Method add_onProcessMousePressEvent addr 0x2d6ec90 size 0xb0 virtual false final false
 void add_onProcessMousePressEvent(System::Action_1<UnityEngine::GameObject> value) ;

/// @brief Method remove_onProcessMousePressEvent addr 0x2d6ed40 size 0xb0 virtual false final false
 void remove_onProcessMousePressEvent(System::Action_1<UnityEngine::GameObject> value) ;

/// @brief Method OnDisable addr 0x2d6edf0 size 0x1c virtual true final false
 void OnDisable() ;

/// @brief Method GetPointerData addr 0x2d6f014 size 0xec virtual false final false
 bool GetPointerData(int32_t id, ByRef<UnityEngine::EventSystems::PointerEventData> data, bool create) ;

/// @brief Method GetMousePointerEventData addr 0x2d6f100 size 0x39c virtual true final false
 VRUIControls::MouseState GetMousePointerEventData(int32_t id) ;

/// @brief Method GetLastPointerEventData addr 0x2d6f49c size 0x20 virtual false final false
 UnityEngine::EventSystems::PointerEventData GetLastPointerEventData(int32_t id) ;

/// @brief Method ShouldStartDrag addr 0x2d6f4bc size 0x30 virtual false final false
 bool ShouldStartDrag(UnityEngine::Vector2 pressPos, UnityEngine::Vector2 currentPos, float_t threshold, bool useDragThreshold) ;

/// @brief Method ProcessMove addr 0x2d6f4ec size 0x18 virtual true final false
 void ProcessMove(UnityEngine::EventSystems::PointerEventData pointerEvent) ;

/// @brief Method ProcessDrag addr 0x2d6fdfc size 0x2c4 virtual true final false
 void ProcessDrag(UnityEngine::EventSystems::PointerEventData pointerEvent) ;

/// @brief Method IsPointerOverGameObject addr 0x2d700c0 size 0x9c virtual true final false
 bool IsPointerOverGameObject(int32_t pointerId) ;

/// @brief Method ClearSelection addr 0x2d6ee0c size 0x208 virtual false final false
 void ClearSelection() ;

/// @brief Method ToString addr 0x2d7015c size 0x270 virtual true final false
 ::StringW ToString() ;

/// @brief Method DeselectIfSelectionChanged addr 0x2d703cc size 0xf0 virtual false final false
 void DeselectIfSelectionChanged(UnityEngine::GameObject currentOverGo, UnityEngine::EventSystems::BaseEventData pointerEvent) ;

/// @brief Method Process addr 0x2d704bc size 0x1fc virtual true final false
 void Process() ;

/// @brief Method SendUpdateEventToSelectedObject addr 0x2d70e40 size 0x148 virtual false final false
 bool SendUpdateEventToSelectedObject() ;

/// @brief Method ProcessMousePress addr 0x2d706b8 size 0x720 virtual false final false
 void ProcessMousePress(VRUIControls::MouseButtonEventData data) ;

/// @brief Method HandlePointerExitAndEnter addr 0x2d6f504 size 0x8f8 virtual false final false
...
/// @brief Method RaycastComparer addr 0x2d70f88 size 0x3e4 virtual false final false
...
/// @brief Method .ctor addr 0x2d7136c size 0xf0 virtual false final false
 void _ctor() ;
