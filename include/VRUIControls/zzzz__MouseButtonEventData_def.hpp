...
/// @brief Method PressedThisFrame addr 0x2d6ce50 size 0x10 virtual false final false
 bool PressedThisFrame() ;

/// @brief Method ReleasedThisFrame addr 0x2d6ce60 size 0x14 virtual false final false
 bool ReleasedThisFrame() ;

// Ctor Parameters []
explicit MouseButtonEventData() ;

/// @brief Method .ctor addr 0x2d6ce74 size 0x8 virtual false final false
 void _ctor() ;
