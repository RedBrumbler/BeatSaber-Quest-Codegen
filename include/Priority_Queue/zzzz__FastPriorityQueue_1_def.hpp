...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6178))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6178), inst: 2 })
...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6179))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6179), inst: 2 })
