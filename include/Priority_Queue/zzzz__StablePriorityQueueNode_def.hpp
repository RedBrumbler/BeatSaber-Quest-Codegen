...
namespace Priority_Queue {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6180))}
...
/// @brief Method get_InsertionIndex addr 0x220ec10 size 0x8 virtual false final false
 int64_t get_InsertionIndex() ;

/// @brief Method set_InsertionIndex addr 0x220ec18 size 0x8 virtual false final false
 void set_InsertionIndex(int64_t value) ;

// Ctor Parameters []
explicit StablePriorityQueueNode() ;

/// @brief Method .ctor addr 0x220ec20 size 0x8 virtual false final false
 void _ctor() ;
