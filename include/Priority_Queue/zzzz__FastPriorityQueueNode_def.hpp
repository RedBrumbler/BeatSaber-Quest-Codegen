...
/// @brief Method get_Priority addr 0x220ebe8 size 0x8 virtual false final false
 float_t get_Priority() ;

/// @brief Method set_Priority addr 0x220ebf0 size 0x8 virtual false final false
 void set_Priority(float_t value) ;

/// @brief Method get_QueueIndex addr 0x220ebf8 size 0x8 virtual false final false
 int32_t get_QueueIndex() ;

/// @brief Method set_QueueIndex addr 0x220ec00 size 0x8 virtual false final false
 void set_QueueIndex(int32_t value) ;

// Ctor Parameters []
explicit FastPriorityQueueNode() ;

/// @brief Method .ctor addr 0x220ec08 size 0x8 virtual false final false
 void _ctor() ;
