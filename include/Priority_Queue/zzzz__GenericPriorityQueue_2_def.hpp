...
template<::cordl_internals::il2cpp_reference_type TItem,::cordl_internals::il2cpp_reference_type TPriority>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6181))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6181), inst: 80 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6181))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6181), inst: 1555 })
// CS Name: Priority_Queue.GenericPriorityQueue`2::<GetEnumerator>d__25
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6182), inst: 80 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6182))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6182), inst: 1555 })
// CS Name: Priority_Queue.GenericPriorityQueue`2
