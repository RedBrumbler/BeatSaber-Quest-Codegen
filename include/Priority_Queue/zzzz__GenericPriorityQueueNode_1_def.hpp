...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6183), inst: 2 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6183))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6183), inst: 374 })
// CS Name: Priority_Queue.GenericPriorityQueueNode`1
