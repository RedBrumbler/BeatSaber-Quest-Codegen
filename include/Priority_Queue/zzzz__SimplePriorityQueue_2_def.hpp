...
template<::cordl_internals::il2cpp_reference_type TItem,::cordl_internals::il2cpp_reference_type TPriority>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6183), inst: 2457 }), TypeDefinitionIndex(TypeDefinitionIndex(6186)), TypeDefinitionIndex(TypeDefinitionIndex(6183))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6186), inst: 80 })
...
template<::cordl_internals::il2cpp_reference_type TItem>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6183)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6183), inst: 2457 }), TypeDefinitionIndex(TypeDefinitionIndex(6186))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6186), inst: 1555 })
// CS Name: Priority_Queue.SimplePriorityQueue`2::SimpleNode
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6187), inst: 80 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6187))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6187), inst: 1555 })
// CS Name: Priority_Queue.SimplePriorityQueue`2
