...
template<::cordl_internals::il2cpp_reference_type TItem>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6188)), TypeDefinitionIndex(TypeDefinitionIndex(6187)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6187), inst: 3653 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6188), inst: 2 })
