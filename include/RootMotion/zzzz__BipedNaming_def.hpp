...
/// @brief Method GetBonesOfType addr 0x11b8eb4 size 0x1ac virtual false final false
...
/// @brief Method GetBonesOfSide addr 0x11b9178 size 0x1ac virtual false final false
...
/// @brief Method GetBonesOfTypeAndSide addr 0x11b93ac size 0x74 virtual false final false
...
/// @brief Method GetFirstBoneOfTypeAndSide addr 0x11b9420 size 0x94 virtual false final false
...
/// @brief Method GetNamingMatch addr 0x11b94b4 size 0x114 virtual false final false
static UnityEngine::Transform GetNamingMatch(::ArrayW<UnityEngine::Transform> transforms, ::ArrayW<::ArrayW<::StringW>> namings) ;

/// @brief Method GetBoneType addr 0x11b9060 size 0x118 virtual false final false
static RootMotion::RootMotion__BipedNaming__BoneType GetBoneType(::StringW boneName) ;

/// @brief Method GetBoneSide addr 0x11b9324 size 0x88 virtual false final false
static RootMotion::RootMotion__BipedNaming__BoneSide GetBoneSide(::StringW boneName) ;

/// @brief Method GetBone addr 0x11b9bec size 0x80 virtual false final false
...
/// @brief Method isLeft addr 0x11b9a44 size 0xd4 virtual false final false
static bool isLeft(::StringW boneName) ;

/// @brief Method isRight addr 0x11b9b18 size 0xd4 virtual false final false
static bool isRight(::StringW boneName) ;

/// @brief Method isSpine addr 0x11b969c size 0x9c virtual false final false
static bool isSpine(::StringW boneName) ;

/// @brief Method isHead addr 0x11b9738 size 0x9c virtual false final false
static bool isHead(::StringW boneName) ;

/// @brief Method isArm addr 0x11b97d4 size 0x9c virtual false final false
static bool isArm(::StringW boneName) ;

/// @brief Method isLeg addr 0x11b9870 size 0x9c virtual false final false
static bool isLeg(::StringW boneName) ;

/// @brief Method isTail addr 0x11b990c size 0x9c virtual false final false
static bool isTail(::StringW boneName) ;

/// @brief Method isEye addr 0x11b99a8 size 0x9c virtual false final false
static bool isEye(::StringW boneName) ;

/// @brief Method isTypeExclude addr 0x11b9dd4 size 0x60 virtual false final false
static bool isTypeExclude(::StringW boneName) ;

/// @brief Method matchesNaming addr 0x11b95c8 size 0xd4 virtual false final false
static bool matchesNaming(::StringW boneName, ::ArrayW<::StringW> namingConvention) ;

/// @brief Method excludesNaming addr 0x11b9d50 size 0x84 virtual false final false
static bool excludesNaming(::StringW boneName, ::ArrayW<::StringW> namingConvention) ;

/// @brief Method matchesLastLetter addr 0x11b9e34 size 0xc0 virtual false final false
static bool matchesLastLetter(::StringW boneName, ::ArrayW<::StringW> namingConvention) ;

/// @brief Method LastLetterIs addr 0x11b9ef4 size 0x34 virtual false final false
static bool LastLetterIs(::StringW boneName, ::StringW letter) ;

/// @brief Method firstLetter addr 0x11b9cdc size 0x74 virtual false final false
static ::StringW firstLetter(::StringW boneName) ;

/// @brief Method lastLetter addr 0x11b9c6c size 0x70 virtual false final false
