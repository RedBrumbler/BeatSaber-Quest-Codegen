...
/// @brief Method IsValid addr 0x11deab0 size 0x320 virtual true final false
 bool IsValid(RootMotion::FinalIK::IKSolver solver, ByRef<::StringW> message) ;

// Ctor Parameters []
explicit IKMappingSpine() ;

/// @brief Method .ctor addr 0x11dedd0 size 0x13c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11def0c size 0x170 virtual false final false
...
/// @brief Method SetBones addr 0x11df07c size 0x10 virtual false final false
...
/// @brief Method StoreDefaultLocalState addr 0x11df08c size 0x5c virtual false final false
 void StoreDefaultLocalState() ;

/// @brief Method FixTransforms addr 0x11df0e8 size 0x78 virtual false final false
 void FixTransforms() ;

/// @brief Method Initiate addr 0x11df160 size 0x614 virtual true final false
 void Initiate(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method UseFABRIK addr 0x11df774 size 0x38 virtual false final false
 bool UseFABRIK() ;

/// @brief Method ReadPose addr 0x11df7ac size 0x264 virtual false final false
 void ReadPose() ;

/// @brief Method WritePose addr 0x11dfa10 size 0x320 virtual false final false
 void WritePose(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method ForwardReach addr 0x11dfd30 size 0xe0 virtual false final false
 void ForwardReach(UnityEngine::Vector3 position) ;

/// @brief Method BackwardReach addr 0x11dfe10 size 0xb4 virtual false final false
 void BackwardReach(UnityEngine::Vector3 position) ;

/// @brief Method MapToSolverPositions addr 0x11dfec4 size 0x23c virtual false final false
