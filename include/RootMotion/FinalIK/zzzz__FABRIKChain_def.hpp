...
/// @brief Method IsValid addr 0x11d38c0 size 0xc4 virtual false final false
 bool IsValid(ByRef<::StringW> message) ;

/// @brief Method Initiate addr 0x11d3984 size 0x20 virtual false final false
 void Initiate() ;

/// @brief Method Stage1 addr 0x11d39a4 size 0xc0 virtual false final false
 void Stage1(::ArrayW<RootMotion::FinalIK::FABRIKChain> chain) ;

/// @brief Method Stage2 addr 0x11d3bf8 size 0xe4 virtual false final false
 void Stage2(UnityEngine::Vector3 rootPosition, ::ArrayW<RootMotion::FinalIK::FABRIKChain> chain) ;

/// @brief Method GetCentroid addr 0x11d3a64 size 0x194 virtual false final false
 UnityEngine::Vector3 GetCentroid(::ArrayW<RootMotion::FinalIK::FABRIKChain> chain) ;

// Ctor Parameters []
explicit FABRIKChain() ;

/// @brief Method .ctor addr 0x11d3cdc size 0x60 virtual false final false
 void _ctor() ;
