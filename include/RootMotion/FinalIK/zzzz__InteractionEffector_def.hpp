...
/// @brief Method get_effectorType addr 0x1204414 size 0x8 virtual false final false
 RootMotion::FinalIK::FullBodyBipedEffector get_effectorType() ;

/// @brief Method set_effectorType addr 0x120441c size 0x8 virtual false final false
 void set_effectorType(RootMotion::FinalIK::FullBodyBipedEffector value) ;

/// @brief Method get_isPaused addr 0x1204424 size 0x8 virtual false final false
 bool get_isPaused() ;

/// @brief Method set_isPaused addr 0x120442c size 0xc virtual false final false
 void set_isPaused(bool value) ;

/// @brief Method get_interactionObject addr 0x1204438 size 0x8 virtual false final false
 RootMotion::FinalIK::InteractionObject get_interactionObject() ;

/// @brief Method set_interactionObject addr 0x1204440 size 0x8 virtual false final false
 void set_interactionObject(RootMotion::FinalIK::InteractionObject value) ;

/// @brief Method get_inInteraction addr 0x1204448 size 0x60 virtual false final false
...
/// @brief Method .ctor addr 0x12044a8 size 0x90 virtual false final false
 void _ctor(RootMotion::FinalIK::FullBodyBipedEffector effectorType) ;

/// @brief Method Initiate addr 0x1204538 size 0x94 virtual false final false
 void Initiate(RootMotion::FinalIK::InteractionSystem interactionSystem) ;

/// @brief Method StoreDefaults addr 0x12045cc size 0x16c virtual false final false
 void StoreDefaults() ;

/// @brief Method ResetToDefaults addr 0x1204738 size 0x3dc virtual false final false
 bool ResetToDefaults(float_t speed) ;

/// @brief Method Pause addr 0x1204b14 size 0x120 virtual false final false
 bool Pause() ;

/// @brief Method Resume addr 0x1204c34 size 0x54 virtual false final false
 bool Resume() ;

/// @brief Method Start addr 0x1204c88 size 0x48c virtual false final false
 bool Start(RootMotion::FinalIK::InteractionObject interactionObject, ::StringW tag, float_t fadeInTime, bool interrupt) ;

/// @brief Method Update addr 0x1205790 size 0x640 virtual false final false
 void Update(UnityEngine::Transform root, float_t speed) ;

/// @brief Method get_progress addr 0x1206964 size 0x30 virtual false final false
 float_t get_progress() ;

/// @brief Method TriggerUntriggeredEvents addr 0x12061d8 size 0x220 virtual false final false
 void TriggerUntriggeredEvents(bool checkTime, ByRef<bool> pickUp, ByRef<bool> pause) ;

/// @brief Method PickUp addr 0x12063f8 size 0x218 virtual false final false
 void PickUp(UnityEngine::Transform root) ;

/// @brief Method Stop addr 0x120681c size 0x148 virtual false final false
 bool Stop() ;

/// @brief Method OnPostFBBIK addr 0x1206b64 size 0x23c virtual false final false
 void OnPostFBBIK() ;
