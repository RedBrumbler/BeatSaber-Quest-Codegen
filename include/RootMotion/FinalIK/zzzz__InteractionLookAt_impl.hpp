...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::InteractionLookAt::*)(UnityEngine::Transform, float_t)>(&RootMotion::FinalIK::InteractionLookAt::Look)> {
  ...
  constexpr static std::size_t addrs = 0x1206da0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::InteractionLookAt::*)()>(&RootMotion::FinalIK::InteractionLookAt::OnFixTransforms)> {
  ...
  constexpr static std::size_t addrs = 0x1206eb0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::InteractionLookAt::*)()>(&RootMotion::FinalIK::InteractionLookAt::SolveSpine)> {
  ...
  constexpr static std::size_t addrs = 0x1207138;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::InteractionLookAt::*)()>(&RootMotion::FinalIK::InteractionLookAt::SolveHead)> {
  ...
  constexpr static std::size_t addrs = 0x12071e0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::InteractionLookAt::*)()>(&RootMotion::FinalIK::InteractionLookAt::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x120728c;
...
::cordl_internals::setInstanceField<RootMotion::FinalIK::LookAtIK, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<RootMotion::FinalIK::LookAtIK>(value));
}
constexpr RootMotion::FinalIK::LookAtIK RootMotion::FinalIK::InteractionLookAt::__get_ik() const {
return ::cordl_internals::getInstanceField<RootMotion::FinalIK::LookAtIK, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void RootMotion::FinalIK::InteractionLookAt::__set_lerpSpeed(float_t value)  {
::cordl_internals::setInstanceField<float_t, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<float_t>(value));
}
constexpr float_t RootMotion::FinalIK::InteractionLookAt::__get_lerpSpeed() const {
...
constexpr float_t RootMotion::FinalIK::InteractionLookAt::__get_weightSpeed() const {
return ::cordl_internals::getInstanceField<float_t, 0x1c>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void RootMotion::FinalIK::InteractionLookAt::__set_isPaused(bool value)  {
::cordl_internals::setInstanceField<bool, 0x20>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<bool>(value));
}
constexpr bool RootMotion::FinalIK::InteractionLookAt::__get_isPaused() const {
...
constexpr UnityEngine::Transform RootMotion::FinalIK::InteractionLookAt::__get_lookAtTarget() const {
...
constexpr float_t RootMotion::FinalIK::InteractionLookAt::__get_stopLookTime() const {
...
constexpr float_t RootMotion::FinalIK::InteractionLookAt::__get_weight() const {
...
constexpr bool RootMotion::FinalIK::InteractionLookAt::__get_firstFBBIKSolve() const {
return ::cordl_internals::getInstanceField<bool, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
 void RootMotion::FinalIK::InteractionLookAt::Look(UnityEngine::Transform target, float_t time)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<RootMotion::FinalIK::InteractionLookAt>::get(),
                            "Look",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, target, time);
}
