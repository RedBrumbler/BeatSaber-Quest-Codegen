...
/// @brief Method .ctor addr 0x121480c size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x1214918 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x121491c size 0xe4 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x1214a00 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x1214a08 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x1214a48 size 0x8 virtual true final true
...
/// @brief Method Start addr 0x1213d50 size 0x7c virtual false final false
 void Start() ;

/// @brief Method LateUpdate addr 0x1213e50 size 0x52c virtual false final false
 void LateUpdate() ;

/// @brief Method get_pivot addr 0x1213dcc size 0x84 virtual false final false
 UnityEngine::Vector3 get_pivot() ;

/// @brief Method ApplyMinDistance addr 0x121437c size 0x184 virtual false final false
 void ApplyMinDistance() ;

/// @brief Method RootRotation addr 0x1214500 size 0x2a4 virtual false final false
 void RootRotation() ;

/// @brief Method TurnToTarget addr 0x12147a4 size 0x68 virtual false final false
 System::Collections::IEnumerator TurnToTarget() ;

// Ctor Parameters []
explicit AimController() ;

/// @brief Method .ctor addr 0x1214834 size 0xe4 virtual false final false
 void _ctor() ;
