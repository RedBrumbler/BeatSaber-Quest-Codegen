...
/// @brief Method UpdateConstraint addr 0x11c52f4 size 0x104 virtual true final false
 void UpdateConstraint() ;

// Ctor Parameters []
explicit ConstraintPositionOffset() ;

/// @brief Method .ctor addr 0x11c5454 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11c545c size 0x28 virtual false final false
 void _ctor(UnityEngine::Transform transform) ;

/// @brief Method get_positionChanged addr 0x11c53f8 size 0x5c virtual false final false
