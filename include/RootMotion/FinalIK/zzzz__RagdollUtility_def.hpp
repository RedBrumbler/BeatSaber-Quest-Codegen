...
/// @brief Method .ctor addr 0x120e5f0 size 0x154 virtual false final false
 void _ctor(UnityEngine::Rigidbody r) ;

/// @brief Method RecordVelocity addr 0x120f138 size 0xd4 virtual false final false
 void RecordVelocity() ;

/// @brief Method WakeUp addr 0x120eef8 size 0x240 virtual false final false
...
/// @brief Method .ctor addr 0x120e744 size 0x5c virtual false final false
 void _ctor(UnityEngine::Transform transform) ;

/// @brief Method FixTransform addr 0x120f250 size 0x110 virtual false final false
 void FixTransform(float_t weight) ;

/// @brief Method StoreLocalState addr 0x120f20c size 0x44 virtual false final false
...
/// @brief Method .ctor addr 0x120e7a0 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x120f570 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x120f574 size 0x1e0 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x120f754 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x120f75c size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x120f79c size 0x8 virtual true final true
...
/// @brief Method EnableRagdoll addr 0x120e048 size 0x2c virtual false final false
 void EnableRagdoll() ;

/// @brief Method DisableRagdoll addr 0x120e0d8 size 0x48 virtual false final false
 void DisableRagdoll() ;

/// @brief Method Start addr 0x120e1e4 size 0x40c virtual false final false
 void Start() ;

/// @brief Method DisableRagdollSmooth addr 0x120e17c size 0x68 virtual false final false
 System::Collections::IEnumerator DisableRagdollSmooth() ;

/// @brief Method Update addr 0x120e7c8 size 0x228 virtual false final false
 void Update() ;

/// @brief Method FixedUpdate addr 0x120e9f0 size 0x34 virtual false final false
 void FixedUpdate() ;

/// @brief Method LateUpdate addr 0x120ea90 size 0x70 virtual false final false
 void LateUpdate() ;

/// @brief Method AfterLastIK addr 0x120ec80 size 0x24 virtual false final false
 void AfterLastIK() ;

/// @brief Method AfterAnimation addr 0x120eb00 size 0x2c virtual false final false
 void AfterAnimation() ;

/// @brief Method OnFinalPose addr 0x120ec4c size 0x34 virtual false final false
 void OnFinalPose() ;

/// @brief Method RagdollEnabler addr 0x120ed00 size 0x1f8 virtual false final false
 void RagdollEnabler() ;

/// @brief Method get_isRagdoll addr 0x120e074 size 0x64 virtual false final false
 bool get_isRagdoll() ;

/// @brief Method RecordVelocities addr 0x120eca4 size 0x5c virtual false final false
 void RecordVelocities() ;

/// @brief Method get_ikUsed addr 0x120eb2c size 0x120 virtual false final false
 bool get_ikUsed() ;

/// @brief Method StoreLocalState addr 0x120e120 size 0x5c virtual false final false
 void StoreLocalState() ;

/// @brief Method FixTransforms addr 0x120ea24 size 0x6c virtual false final false
 void FixTransforms(float_t weight) ;

/// @brief Method OnDestroy addr 0x120f360 size 0x118 virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit RagdollUtility() ;

/// @brief Method .ctor addr 0x120f478 size 0xf8 virtual false final false
 void _ctor() ;
