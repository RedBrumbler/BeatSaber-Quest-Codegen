...
/// @brief Method AutoMapping addr 0x120d92c size 0xbc virtual true final false
 void AutoMapping() ;

/// @brief Method InitiatePoser addr 0x120d9e8 size 0x54 virtual true final false
 void InitiatePoser() ;

/// @brief Method FixPoserTransforms addr 0x120db8c size 0xe8 virtual true final false
 void FixPoserTransforms() ;

/// @brief Method UpdatePoser addr 0x120dc74 size 0x330 virtual true final false
 void UpdatePoser() ;

/// @brief Method StoreDefaultState addr 0x120da3c size 0x150 virtual false final false
 void StoreDefaultState() ;

// Ctor Parameters []
explicit HandPoser() ;

/// @brief Method .ctor addr 0x120dfa4 size 0x10 virtual false final false
 void _ctor() ;
