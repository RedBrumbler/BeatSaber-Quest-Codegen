...
/// @brief Method OpenUserManual addr 0x11d0ac0 size 0x44 virtual true final false
 void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x11d0b04 size 0x44 virtual true final false
 void OpenScriptReference() ;

/// @brief Method OpenSetupTutorial addr 0x11d0b48 size 0x44 virtual false final false
 void OpenSetupTutorial() ;

/// @brief Method SupportGroup addr 0x11d0b8c size 0x44 virtual false final false
 void SupportGroup() ;

/// @brief Method ASThread addr 0x11d0bd0 size 0x44 virtual false final false
 void ASThread() ;

/// @brief Method GetIKSolver addr 0x11d0c14 size 0x8 virtual true final false
 RootMotion::FinalIK::IKSolver GetIKSolver() ;

// Ctor Parameters []
explicit AimIK() ;

/// @brief Method .ctor addr 0x11d0c1c size 0x68 virtual false final false
 void _ctor() ;
