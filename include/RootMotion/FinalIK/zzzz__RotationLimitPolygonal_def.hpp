...
/// @brief Method get_o addr 0x12132c0 size 0x2c virtual false final false
 UnityEngine::Vector3 get_o() ;

/// @brief Method get_a addr 0x12132ec size 0x30 virtual false final false
 UnityEngine::Vector3 get_a() ;

/// @brief Method get_b addr 0x121331c size 0x30 virtual false final false
 UnityEngine::Vector3 get_b() ;

/// @brief Method get_c addr 0x121334c size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x121337c size 0x164 virtual false final false
 void _ctor(UnityEngine::Vector3 _o, UnityEngine::Vector3 _a, UnityEngine::Vector3 _b, UnityEngine::Vector3 _c) ;

/// @brief Method get_isValid addr 0x12134e0 size 0x10 virtual false final false
 bool get_isValid() ;

/// @brief Method Calculate addr 0x12134f0 size 0x274 virtual false final false
 void Calculate() ;
...
/// @brief Method .ctor addr 0x1213764 size 0x64 virtual false final false
 void _ctor() ;
...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12583))}
...
/// @brief Method OpenUserManual addr 0x12109b8 size 0x44 virtual false final false
 void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x12109fc size 0x44 virtual false final false
 void OpenScriptReference() ;

/// @brief Method SupportGroup addr 0x1210a40 size 0x44 virtual false final false
 void SupportGroup() ;

/// @brief Method ASThread addr 0x1210a84 size 0x44 virtual false final false
 void ASThread() ;

/// @brief Method SetLimitPoints addr 0x1210ac8 size 0x8c virtual false final false
 void SetLimitPoints(::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__RotationLimitPolygonal__LimitPoint> points) ;

/// @brief Method LimitRotation addr 0x121110c size 0x88 virtual true final false
 UnityEngine::Quaternion LimitRotation(UnityEngine::Quaternion rotation) ;

/// @brief Method Start addr 0x1211194 size 0x350 virtual false final false
 void Start() ;

/// @brief Method ResetToDefault addr 0x1211788 size 0x4cc virtual false final false
 void ResetToDefault() ;

/// @brief Method BuildReachCones addr 0x1210b54 size 0x5b8 virtual false final false
 void BuildReachCones() ;

/// @brief Method SmoothPoints addr 0x1211c54 size 0x430 virtual false final false
 ::ArrayW<UnityEngine::Vector3> SmoothPoints() ;

/// @brief Method GetScalar addr 0x1212084 size 0x48 virtual false final false
 float_t GetScalar(int32_t k) ;

/// @brief Method PointToTangentPlane addr 0x12120cc size 0x60 virtual false final false
 UnityEngine::Vector3 PointToTangentPlane(UnityEngine::Vector3 p, float_t r) ;

/// @brief Method TangentPointToSphere addr 0x121212c size 0x6c virtual false final false
 UnityEngine::Vector3 TangentPointToSphere(UnityEngine::Vector3 q, float_t r) ;

/// @brief Method LimitSwing addr 0x12114e4 size 0x2a4 virtual false final false
 UnityEngine::Quaternion LimitSwing(UnityEngine::Quaternion rotation) ;

/// @brief Method GetReachCone addr 0x1212198 size 0xcc virtual false final false
 int32_t GetReachCone(UnityEngine::Vector3 L) ;

// Ctor Parameters []
explicit RotationLimitPolygonal() ;

/// @brief Method .ctor addr 0x1212264 size 0x105c virtual false final false
 void _ctor() ;
