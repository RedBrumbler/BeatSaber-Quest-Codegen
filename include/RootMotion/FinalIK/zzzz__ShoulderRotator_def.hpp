...
/// @brief Method Start addr 0x121aeb4 size 0xf0 virtual false final false
 void Start() ;

/// @brief Method RotateShoulders addr 0x121afa4 size 0xdc virtual false final false
 void RotateShoulders() ;

/// @brief Method RotateShoulder addr 0x121b080 size 0x404 virtual false final false
 void RotateShoulder(RootMotion::FinalIK::FullBodyBipedChain chain, float_t weight, float_t offset) ;

/// @brief Method GetParentBoneMap addr 0x121b484 size 0x34 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap GetParentBoneMap(RootMotion::FinalIK::FullBodyBipedChain chain) ;

/// @brief Method OnDestroy addr 0x121b4b8 size 0x10c virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit ShoulderRotator() ;

/// @brief Method .ctor addr 0x121b5c4 size 0x14 virtual false final false
 void _ctor() ;
