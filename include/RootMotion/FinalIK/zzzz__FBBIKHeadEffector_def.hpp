...
/// @brief Method .ctor addr 0x11d757c size 0x60 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11d75dc size 0x7c virtual false final false
 void _ctor(UnityEngine::Transform transform, float_t weight) ;

/// @brief Method StoreDefaultLocalState addr 0x11d4ce0 size 0x2c virtual false final false
 void StoreDefaultLocalState() ;

/// @brief Method FixTransforms addr 0x11d50b0 size 0x28 virtual false final false
 void FixTransforms() ;
...
/// @brief Method Start addr 0x11d4480 size 0x3ec virtual false final false
 void Start() ;

/// @brief Method OnStoreDefaultLocalState addr 0x11d486c size 0x474 virtual false final false
 void OnStoreDefaultLocalState() ;

/// @brief Method OnFixTransforms addr 0x11d4d0c size 0x3a4 virtual false final false
 void OnFixTransforms() ;

/// @brief Method OnPreRead addr 0x11d50d8 size 0x640 virtual false final false
 void OnPreRead() ;

/// @brief Method SpineBend addr 0x11d59d4 size 0x3f8 virtual false final false
 void SpineBend() ;

/// @brief Method CCDPass addr 0x11d5dcc size 0x410 virtual false final false
 void CCDPass() ;

/// @brief Method Iterate addr 0x11d61dc size 0x798 virtual false final false
 void Iterate(int32_t iteration) ;

/// @brief Method OnPostUpdate addr 0x11d6b5c size 0x23c virtual false final false
 void OnPostUpdate() ;

/// @brief Method ChestDirection addr 0x11d5718 size 0x2bc virtual false final false
 void ChestDirection() ;

/// @brief Method PostStretching addr 0x11d6d98 size 0x304 virtual false final false
 void PostStretching() ;

/// @brief Method LerpSolverPosition addr 0x11d6a74 size 0xe8 virtual false final false
...
/// @brief Method Solve addr 0x11d6974 size 0x100 virtual false final false
 void Solve(ByRef<UnityEngine::Vector3> pos1, ByRef<UnityEngine::Vector3> pos2, float_t nominalDistance) ;

/// @brief Method OnDestroy addr 0x11d709c size 0x338 virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit FBBIKHeadEffector() ;

/// @brief Method .ctor addr 0x11d73d4 size 0x1a8 virtual false final false
 void _ctor() ;
