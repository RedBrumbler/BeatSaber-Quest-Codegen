...
/// @brief Method SetDefaultLocalRotation addr 0x120f7a4 size 0x3c virtual false final false
 void SetDefaultLocalRotation() ;

/// @brief Method SetDefaultLocalRotation addr 0x120f7e0 size 0x18 virtual false final false
 void SetDefaultLocalRotation(UnityEngine::Quaternion localRotation) ;

/// @brief Method GetLimitedLocalRotation addr 0x120f7f8 size 0x284 virtual false final false
 UnityEngine::Quaternion GetLimitedLocalRotation(UnityEngine::Quaternion localRotation, ByRef<bool> changed) ;

/// @brief Method Apply addr 0x120fb78 size 0x64 virtual false final false
 bool Apply() ;

/// @brief Method Disable addr 0x120fbdc size 0x2c virtual false final false
 void Disable() ;

/// @brief Method get_secondaryAxis addr 0x120fc08 size 0xc virtual false final false
 UnityEngine::Vector3 get_secondaryAxis() ;

/// @brief Method get_crossAxis addr 0x120fc14 size 0x30 virtual false final false
 UnityEngine::Vector3 get_crossAxis() ;

/// @brief Method get_defaultLocalRotationOverride addr 0x120fc44 size 0x8 virtual false final false
 bool get_defaultLocalRotationOverride() ;

/// @brief Method set_defaultLocalRotationOverride addr 0x120fc4c size 0xc virtual false final false
...
/// @brief Method Awake addr 0x120fa7c size 0xfc virtual false final false
 void Awake() ;

/// @brief Method LateUpdate addr 0x120fc58 size 0x4 virtual false final false
 void LateUpdate() ;

/// @brief Method LogWarning addr 0x120fc5c size 0x28 virtual false final false
 void LogWarning(::StringW message) ;

/// @brief Method Limit1DOF addr 0x120fc84 size 0xd4 virtual false final false
static UnityEngine::Quaternion Limit1DOF(UnityEngine::Quaternion rotation, UnityEngine::Vector3 axis) ;

/// @brief Method LimitTwist addr 0x120fd58 size 0x258 virtual false final false
...
/// @brief Method GetOrthogonalAngle addr 0x120ffb0 size 0x154 virtual false final false
...
/// @brief Method .ctor addr 0x1210104 size 0x60 virtual false final false
 void _ctor() ;
