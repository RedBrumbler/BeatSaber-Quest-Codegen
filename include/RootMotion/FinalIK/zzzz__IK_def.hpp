...
/// @brief Method UpdateSolver addr 0x11d1c4c size 0x78 virtual true final false
 void UpdateSolver() ;

/// @brief Method InitiateSolver addr 0x11d1cc4 size 0x70 virtual true final false
 void InitiateSolver() ;

/// @brief Method FixTransforms addr 0x11d1d34 size 0x50 virtual true final false
 void FixTransforms() ;
...
/// @brief Method .ctor addr 0x11d0c84 size 0x8 virtual false final false
 void _ctor() ;
