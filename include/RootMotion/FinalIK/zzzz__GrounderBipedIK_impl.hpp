...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::GrounderBipedIK::*)()>(&RootMotion::FinalIK::GrounderBipedIK::OpenUserManual)> {
  ...
  constexpr static std::size_t addrs = 0x11c73e8;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(RootMotion::FinalIK::GrounderBipedIK),
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::GrounderBipedIK::*)()>(&RootMotion::FinalIK::GrounderBipedIK::OpenScriptReference)> {
  constexpr static std::size_t size = 0x44;
  constexpr static std::size_t addrs = 0x11c742c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::GrounderBipedIK::*)()>(&RootMotion::FinalIK::GrounderBipedIK::ResetPosition)> {
  ...
  constexpr static std::size_t addrs = 0x11c7470;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (RootMotion::FinalIK::GrounderBipedIK::*)()>(&RootMotion::FinalIK::GrounderBipedIK::IsReadyToInitiate)> {
  ...
  constexpr static std::size_t addrs = 0x11c74dc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::GrounderBipedIK::*)()>(&RootMotion::FinalIK::GrounderBipedIK::Update)> {
  ...
  constexpr static std::size_t addrs = 0x11c757c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::GrounderBipedIK::*)()>(&RootMotion::FinalIK::GrounderBipedIK::Initiate)> {
  ...
  constexpr static std::size_t addrs = 0x11c75d0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::GrounderBipedIK::*)()>(&RootMotion::FinalIK::GrounderBipedIK::OnDisable)> {
  ...
  constexpr static std::size_t addrs = 0x11c78d4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::GrounderBipedIK::*)()>(&RootMotion::FinalIK::GrounderBipedIK::OnPostSolverUpdate)> {
  ...
  constexpr static std::size_t addrs = 0x11c7e34;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::GrounderBipedIK::*)()>(&RootMotion::FinalIK::GrounderBipedIK::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x11c8004;
...
::cordl_internals::setInstanceField<RootMotion::FinalIK::BipedIK, 0x40>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<RootMotion::FinalIK::BipedIK>(value));
}
constexpr RootMotion::FinalIK::BipedIK RootMotion::FinalIK::GrounderBipedIK::__get_ik() const {
return ::cordl_internals::getInstanceField<RootMotion::FinalIK::BipedIK, 0x40>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr float_t RootMotion::FinalIK::GrounderBipedIK::__get_spineBend() const {
...
constexpr float_t RootMotion::FinalIK::GrounderBipedIK::__get_spineSpeed() const {
return ::cordl_internals::getInstanceField<float_t, 0x4c>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void RootMotion::FinalIK::GrounderBipedIK::__set_feet(::ArrayW<UnityEngine::Transform> value)  {
...
constexpr ::ArrayW<UnityEngine::Transform> RootMotion::FinalIK::GrounderBipedIK::__get_feet() const {
return ::cordl_internals::getInstanceField<::ArrayW<UnityEngine::Transform>, 0x50>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void RootMotion::FinalIK::GrounderBipedIK::__set_footRotations(::ArrayW<UnityEngine::Quaternion> value)  {
::cordl_internals::setInstanceField<::ArrayW<UnityEngine::Quaternion>, 0x58>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<UnityEngine::Quaternion>>(value));
}
constexpr ::ArrayW<UnityEngine::Quaternion> RootMotion::FinalIK::GrounderBipedIK::__get_footRotations() const {
return ::cordl_internals::getInstanceField<::ArrayW<UnityEngine::Quaternion>, 0x58>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr UnityEngine::Vector3 RootMotion::FinalIK::GrounderBipedIK::__get_animatedPelvisLocalPosition() const {
...
constexpr UnityEngine::Vector3 RootMotion::FinalIK::GrounderBipedIK::__get_solvedPelvisLocalPosition() const {
...
constexpr UnityEngine::Vector3 RootMotion::FinalIK::GrounderBipedIK::__get_spineOffset() const {
...
constexpr float_t RootMotion::FinalIK::GrounderBipedIK::__get_lastWeight() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void RootMotion::FinalIK::GrounderBipedIK::SetLegIK(RootMotion::FinalIK::IKSolverLimb limb, int32_t index)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<RootMotion::FinalIK::GrounderBipedIK>::get(),
                            "SetLegIK",
                            std::vector<Il2CppClass*>{},
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, limb, index);
}
...
// Ctor Parameters []
 RootMotion::FinalIK::GrounderBipedIK::GrounderBipedIK()  : RootMotion::FinalIK::Grounder(THROW_UNLESS(::il2cpp_utils::New<GrounderBipedIK>())) {}
 void RootMotion::FinalIK::GrounderBipedIK::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<RootMotion::FinalIK::GrounderBipedIK>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
