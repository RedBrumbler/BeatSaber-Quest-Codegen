...
/// @brief Method OpenUserManual addr 0x12105e0 size 0x44 virtual false final false
 void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x1210624 size 0x44 virtual false final false
 void OpenScriptReference() ;

/// @brief Method SupportGroup addr 0x1210668 size 0x44 virtual false final false
 void SupportGroup() ;

/// @brief Method ASThread addr 0x12106ac size 0x44 virtual false final false
 void ASThread() ;

/// @brief Method LimitRotation addr 0x12106f0 size 0x1c virtual true final false
 UnityEngine::Quaternion LimitRotation(UnityEngine::Quaternion rotation) ;

/// @brief Method LimitHinge addr 0x121070c size 0x248 virtual false final false
 UnityEngine::Quaternion LimitHinge(UnityEngine::Quaternion rotation) ;

// Ctor Parameters []
explicit RotationLimitHinge() ;

/// @brief Method .ctor addr 0x1210954 size 0x64 virtual false final false
 void _ctor() ;
