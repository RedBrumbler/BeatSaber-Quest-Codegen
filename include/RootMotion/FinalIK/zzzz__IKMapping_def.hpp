...
/// @brief Method Initiate addr 0x11dcd34 size 0x28 virtual false final false
 void Initiate(UnityEngine::Transform transform, RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method get_swingDirection addr 0x11dcd5c size 0x30 virtual false final false
 UnityEngine::Vector3 get_swingDirection() ;

/// @brief Method StoreDefaultLocalState addr 0x11dcd8c size 0x44 virtual false final false
 void StoreDefaultLocalState() ;

/// @brief Method FixTransform addr 0x11dcdd0 size 0x44 virtual false final false
 void FixTransform(bool position) ;

/// @brief Method get_isNodeBone addr 0x11dce14 size 0x10 virtual false final false
 bool get_isNodeBone() ;

/// @brief Method SetLength addr 0x11dce24 size 0xd4 virtual false final false
 void SetLength(RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap nextBone) ;

/// @brief Method SetLocalSwingAxis addr 0x11dcef8 size 0x8 virtual false final false
 void SetLocalSwingAxis(RootMotion::FinalIK::RootMotion__FinalIK__IKMapping__BoneMap swingTarget) ;

/// @brief Method SetLocalSwingAxis addr 0x11dcf00 size 0xcc virtual false final false
...
/// @brief Method SetLocalTwistAxis addr 0x11dcfcc size 0x6c virtual false final false
 void SetLocalTwistAxis(UnityEngine::Vector3 twistDirection, UnityEngine::Vector3 normalDirection) ;

/// @brief Method SetPlane addr 0x11dd038 size 0x88 virtual false final false
...
/// @brief Method UpdatePlane addr 0x11dd0c0 size 0x110 virtual false final false
 void UpdatePlane(bool rotation, bool position) ;

/// @brief Method SetIKPosition addr 0x11dd338 size 0x2c virtual false final false
 void SetIKPosition() ;

/// @brief Method MaintainRotation addr 0x11dd364 size 0x2c virtual false final false
 void MaintainRotation() ;

/// @brief Method SetToIKPosition addr 0x11dd390 size 0x28 virtual false final false
 void SetToIKPosition() ;

/// @brief Method FixToNode addr 0x11dd3b8 size 0xc0 virtual false final false
...
/// @brief Method GetPlanePosition addr 0x11dd478 size 0x74 virtual false final false
 UnityEngine::Vector3 GetPlanePosition(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method PositionToPlane addr 0x11dd5fc size 0x24 virtual false final false
 void PositionToPlane(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method RotateToPlane addr 0x11dd620 size 0x120 virtual false final false
 void RotateToPlane(RootMotion::FinalIK::IKSolverFullBody solver, float_t weight) ;

/// @brief Method Swing addr 0x11dd740 size 0x64 virtual false final false
 void Swing(UnityEngine::Vector3 swingTarget, float_t weight) ;

/// @brief Method Swing addr 0x11dd7a4 size 0x180 virtual false final false
 void Swing(UnityEngine::Vector3 pos1, UnityEngine::Vector3 pos2, float_t weight) ;

/// @brief Method Twist addr 0x11dd924 size 0x180 virtual false final false
 void Twist(UnityEngine::Vector3 twistDirection, UnityEngine::Vector3 normalDirection, float_t weight) ;

/// @brief Method RotateToMaintain addr 0x11ddaa4 size 0x7c virtual false final false
 void RotateToMaintain(float_t weight) ;

/// @brief Method RotateToEffector addr 0x11ddb20 size 0x11c virtual false final false
 void RotateToEffector(RootMotion::FinalIK::IKSolverFullBody solver, float_t weight) ;

/// @brief Method GetTargetRotation addr 0x11dd4ec size 0x110 virtual false final false
 UnityEngine::Quaternion GetTargetRotation(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method get_lastAnimatedTargetRotation addr 0x11dd1d0 size 0x168 virtual false final false
 UnityEngine::Quaternion get_lastAnimatedTargetRotation() ;

// Ctor Parameters []
explicit RootMotion__FinalIK__IKMapping__BoneMap() ;

/// @brief Method .ctor addr 0x11ddc3c size 0x1c virtual false final false
 void _ctor() ;
...
/// @brief Method IsValid addr 0x11dcad0 size 0x8 virtual true final false
 bool IsValid(RootMotion::FinalIK::IKSolver solver, ByRef<::StringW> message) ;

/// @brief Method Initiate addr 0x11dcad8 size 0x4 virtual true final false
 void Initiate(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method BoneIsValid addr 0x11dcadc size 0x13c virtual false final false
...
/// @brief Method SolveFABRIKJoint addr 0x11dcc18 size 0x114 virtual false final false
 UnityEngine::Vector3 SolveFABRIKJoint(UnityEngine::Vector3 pos1, UnityEngine::Vector3 pos2, float_t length) ;

// Ctor Parameters []
explicit IKMapping() ;

/// @brief Method .ctor addr 0x11dcd2c size 0x8 virtual false final false
 void _ctor() ;
