...
/// @brief Method Apply addr 0x1218890 size 0x164 virtual false final false
 void Apply(RootMotion::FinalIK::IKEffector e, UnityEngine::Quaternion rootRotation) ;

/// @brief Method SpringAxis addr 0x1218b00 size 0x70 virtual false final false
 float_t SpringAxis(float_t value, float_t min, float_t max) ;

/// @brief Method Spring addr 0x1218b70 size 0x48 virtual false final false
 float_t Spring(float_t value, float_t limit, bool negative) ;

// Ctor Parameters []
explicit RootMotion__FinalIK__OffsetModifier__OffsetLimits() ;

/// @brief Method .ctor addr 0x1218bb8 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x1218794 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x1218bc0 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x1218bc4 size 0x150 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x1218d14 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x1218d1c size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x1218d5c size 0x8 virtual true final true
...
/// @brief Method get_deltaTime addr 0x12151e4 size 0x20 virtual false final false
 float_t get_deltaTime() ;

/// @brief Method OnModifyOffset addr 0x0 size 0xffffffffffffffff virtual true final false
 void OnModifyOffset() ;

/// @brief Method Start addr 0x12155ac size 0x20 virtual true final false
 void Start() ;

/// @brief Method Initiate addr 0x121872c size 0x68 virtual false final false
 System::Collections::IEnumerator Initiate() ;

/// @brief Method ModifyOffset addr 0x12187bc size 0xd4 virtual false final false
 void ModifyOffset() ;

/// @brief Method ApplyLimits addr 0x1217c14 size 0xa8 virtual false final false
 void ApplyLimits(::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__OffsetModifier__OffsetLimits> limits) ;

/// @brief Method OnDestroy addr 0x12189f4 size 0x10c virtual true final false
 void OnDestroy() ;

// Ctor Parameters []
explicit OffsetModifier() ;

/// @brief Method .ctor addr 0x1215524 size 0x10 virtual false final false
 void _ctor() ;
