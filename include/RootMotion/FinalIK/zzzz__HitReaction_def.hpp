...
/// @brief Method get_inProgress addr 0x1215a78 size 0x14 virtual false final false
 bool get_inProgress() ;

/// @brief Method get_crossFader addr 0x1215f78 size 0x8 virtual false final false
 float_t get_crossFader() ;

/// @brief Method set_crossFader addr 0x1215f80 size 0x8 virtual false final false
 void set_crossFader(float_t value) ;

/// @brief Method get_timer addr 0x1215f88 size 0x8 virtual false final false
 float_t get_timer() ;

/// @brief Method set_timer addr 0x1215f90 size 0x8 virtual false final false
 void set_timer(float_t value) ;

/// @brief Method get_force addr 0x1215f98 size 0xc virtual false final false
 UnityEngine::Vector3 get_force() ;

/// @brief Method set_force addr 0x1215fa4 size 0xc virtual false final false
 void set_force(UnityEngine::Vector3 value) ;

/// @brief Method get_point addr 0x1215fb0 size 0xc virtual false final false
 UnityEngine::Vector3 get_point() ;

/// @brief Method set_point addr 0x1215fbc size 0xc virtual false final false
 void set_point(UnityEngine::Vector3 value) ;

/// @brief Method Hit addr 0x1215e40 size 0x128 virtual false final false
 void Hit(UnityEngine::Vector3 force, UnityEngine::Vector3 point) ;

/// @brief Method Apply addr 0x1215b4c size 0xd8 virtual false final false
...
/// @brief Method .ctor addr 0x1215fc8 size 0x14 virtual false final false
 void _ctor() ;
...
/// @brief Method Apply addr 0x12162fc size 0x9c virtual false final false
 void Apply(RootMotion::FinalIK::IKSolverFullBodyBiped solver, UnityEngine::Vector3 offset, float_t crossFader) ;

/// @brief Method CrossFadeStart addr 0x1216158 size 0x14 virtual false final false
 void CrossFadeStart() ;

// Ctor Parameters []
explicit RootMotion__FinalIK__HitReaction__HitPointEffector__EffectorLink() ;

/// @brief Method .ctor addr 0x12163ac size 0x8 virtual false final false
 void _ctor() ;
...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12599))}
...
/// @brief Method GetLength addr 0x1215fdc size 0x11c virtual true final false
 float_t GetLength() ;

/// @brief Method CrossFadeStart addr 0x12160f8 size 0x60 virtual true final false
 void CrossFadeStart() ;

/// @brief Method OnApply addr 0x121616c size 0x190 virtual true final false
 void OnApply(RootMotion::FinalIK::IKSolverFullBodyBiped solver, float_t weight) ;

// Ctor Parameters []
explicit RootMotion__FinalIK__HitReaction__HitPointEffector() ;

/// @brief Method .ctor addr 0x1216398 size 0x14 virtual false final false
 void _ctor() ;
...
/// @brief Method Apply addr 0x121666c size 0x18c virtual false final false
 void Apply(RootMotion::FinalIK::IKSolverFullBodyBiped solver, UnityEngine::Quaternion offset, float_t crossFader) ;

/// @brief Method CrossFadeStart addr 0x1216498 size 0xc virtual false final false
 void CrossFadeStart() ;

// Ctor Parameters []
explicit RootMotion__FinalIK__HitReaction__HitPointBone__BoneLink() ;

/// @brief Method .ctor addr 0x121680c size 0x64 virtual false final false
 void _ctor() ;
...
/// @brief Method GetLength addr 0x12163b4 size 0x8c virtual true final false
 float_t GetLength() ;

/// @brief Method CrossFadeStart addr 0x1216440 size 0x58 virtual true final false
 void CrossFadeStart() ;

/// @brief Method OnApply addr 0x12164a4 size 0x1c8 virtual true final false
 void OnApply(RootMotion::FinalIK::IKSolverFullBodyBiped solver, float_t weight) ;

// Ctor Parameters []
explicit RootMotion__FinalIK__HitReaction__HitPointBone() ;

/// @brief Method .ctor addr 0x12167f8 size 0x14 virtual false final false
 void _ctor() ;
...
/// @brief Method get_inProgress addr 0x12159dc size 0x9c virtual false final false
 bool get_inProgress() ;

/// @brief Method OnModifyOffset addr 0x1215a8c size 0xc0 virtual true final false
 void OnModifyOffset() ;

/// @brief Method Hit addr 0x1215c24 size 0x21c virtual false final false
 void Hit(UnityEngine::Collider collider, UnityEngine::Vector3 force, UnityEngine::Vector3 point) ;

// Ctor Parameters []
explicit HitReaction() ;

/// @brief Method .ctor addr 0x1215f68 size 0x10 virtual false final false
 void _ctor() ;
