...
/// @brief Method IsValid addr 0x11da5f4 size 0x1d8 virtual false final false
 bool IsValid(RootMotion::FinalIK::IKSolverFullBody solver, RootMotion::RootMotion__Warning__Logger logger) ;

/// @brief Method get_initiated addr 0x11da7cc size 0x8 virtual false final false
 bool get_initiated() ;

/// @brief Method set_initiated addr 0x11da7d4 size 0xc virtual false final false
 void set_initiated(bool value) ;

// Ctor Parameters []
explicit IKConstraintBend() ;

/// @brief Method .ctor addr 0x11d7754 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11da7e0 size 0x8c virtual false final false
 void _ctor(UnityEngine::Transform bone1, UnityEngine::Transform bone2, UnityEngine::Transform bone3) ;

/// @brief Method SetBones addr 0x11d82f0 size 0xc virtual false final false
 void SetBones(UnityEngine::Transform bone1, UnityEngine::Transform bone2, UnityEngine::Transform bone3) ;

/// @brief Method Initiate addr 0x11d82fc size 0x268 virtual false final false
 void Initiate(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method SetLimbOrientation addr 0x11da9b4 size 0x354 virtual false final false
 void SetLimbOrientation(UnityEngine::Vector3 upper, UnityEngine::Vector3 lower, UnityEngine::Vector3 last) ;

/// @brief Method LimitBend addr 0x11dad08 size 0x3c8 virtual false final false
 void LimitBend(float_t solverWeight, float_t positionWeight) ;

/// @brief Method GetDir addr 0x11d92c8 size 0x630 virtual false final false
 UnityEngine::Vector3 GetDir(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method OrthoToLimb addr 0x11da86c size 0xa4 virtual false final false
 UnityEngine::Vector3 OrthoToLimb(RootMotion::FinalIK::IKSolverFullBody solver, UnityEngine::Vector3 tangent) ;

/// @brief Method OrthoToBone1 addr 0x11da910 size 0xa4 virtual false final false
