...
/// @brief Method .ctor addr 0x120d58c size 0x30 virtual false final false
 void _ctor(UnityEngine::Transform bone, UnityEngine::Transform target) ;

/// @brief Method StoreDefaultState addr 0x120d8c8 size 0x44 virtual false final false
 void StoreDefaultState() ;

/// @brief Method FixTransform addr 0x120d888 size 0x40 virtual false final false
 void FixTransform() ;

/// @brief Method Update addr 0x120d70c size 0x120 virtual false final false
...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12578))}
...
/// @brief Method AutoMapping addr 0x120d2a0 size 0x258 virtual true final false
 void AutoMapping() ;

/// @brief Method InitiatePoser addr 0x120d618 size 0x4 virtual true final false
 void InitiatePoser() ;

/// @brief Method UpdatePoser addr 0x120d61c size 0xf0 virtual true final false
 void UpdatePoser() ;

/// @brief Method FixPoserTransforms addr 0x120d82c size 0x5c virtual true final false
 void FixPoserTransforms() ;

/// @brief Method StoreDefaultState addr 0x120d5bc size 0x5c virtual false final false
 void StoreDefaultState() ;

/// @brief Method GetTargetNamed addr 0x120d4f8 size 0x94 virtual false final false
 UnityEngine::Transform GetTargetNamed(::StringW tName, ::ArrayW<UnityEngine::Transform> array) ;

// Ctor Parameters []
explicit GenericPoser() ;

/// @brief Method .ctor addr 0x120d90c size 0x10 virtual false final false
 void _ctor() ;
