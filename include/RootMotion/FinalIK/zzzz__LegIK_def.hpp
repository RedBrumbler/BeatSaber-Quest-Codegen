...
/// @brief Method OpenUserManual addr 0x11d1fcc size 0x44 virtual true final false
 void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x11d2010 size 0x44 virtual true final false
 void OpenScriptReference() ;

/// @brief Method SupportGroup addr 0x11d2054 size 0x44 virtual false final false
 void SupportGroup() ;

/// @brief Method ASThread addr 0x11d2098 size 0x44 virtual false final false
 void ASThread() ;

/// @brief Method GetIKSolver addr 0x11d20dc size 0x8 virtual true final false
 RootMotion::FinalIK::IKSolver GetIKSolver() ;

// Ctor Parameters []
explicit LegIK() ;

/// @brief Method .ctor addr 0x11d20e4 size 0x68 virtual false final false
 void _ctor() ;
