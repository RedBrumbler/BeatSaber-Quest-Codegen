...
/// @brief Method OpenUserManual addr 0x11ca380 size 0x44 virtual true final false
 void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x11ca3c4 size 0x44 virtual true final false
 void OpenScriptReference() ;

/// @brief Method ResetPosition addr 0x11ca408 size 0x18 virtual true final false
 void ResetPosition() ;

/// @brief Method IsReadyToInitiate addr 0x11ca420 size 0x20c virtual false final false
 bool IsReadyToInitiate() ;

/// @brief Method OnDisable addr 0x11ca62c size 0xe0 virtual false final false
 void OnDisable() ;

/// @brief Method Update addr 0x11ca70c size 0x56c virtual false final false
 void Update() ;

/// @brief Method Initiate addr 0x11cadf0 size 0x460 virtual false final false
 void Initiate() ;

/// @brief Method OnSolverUpdate addr 0x11cb250 size 0x1ac virtual false final false
 void OnSolverUpdate() ;

/// @brief Method SetLegIK addr 0x11cb3fc size 0x388 virtual false final false
 void SetLegIK(int32_t index) ;

/// @brief Method OnPostSolverUpdate addr 0x11cb784 size 0x1d8 virtual false final false
 void OnPostSolverUpdate() ;

/// @brief Method OnDestroy addr 0x11cb95c size 0x204 virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit GrounderIK() ;

/// @brief Method .ctor addr 0x11cbb60 size 0x90 virtual false final false
 void _ctor() ;
