...
/// @brief Method .ctor addr 0x121aeac size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Start addr 0x1219cfc size 0xd4 virtual false final false
 void Start() ;

/// @brief Method Apply addr 0x121a858 size 0x1cc virtual false final false
...
/// @brief Method .ctor addr 0x121ae98 size 0x14 virtual false final false
 void _ctor() ;
...
/// @brief Method get_isFinished addr 0x1219b60 size 0x24 virtual false final false
 bool get_isFinished() ;

/// @brief Method SetHandRotations addr 0x1219b84 size 0x2c virtual false final false
 void SetHandRotations(UnityEngine::Quaternion leftHandRotation, UnityEngine::Quaternion rightHandRotation) ;

/// @brief Method Fire addr 0x1219bb0 size 0x14c virtual false final false
 void Fire(float_t magnitude) ;

/// @brief Method OnModifyOffset addr 0x1219dd0 size 0xa88 virtual true final false
 void OnModifyOffset() ;

/// @brief Method AfterFBBIK addr 0x121aad4 size 0x118 virtual false final false
 void AfterFBBIK() ;

/// @brief Method AfterAimIK addr 0x121abec size 0x50 virtual false final false
 void AfterAimIK() ;

/// @brief Method get_primaryHandEffector addr 0x121aa5c size 0x3c virtual false final false
 RootMotion::FinalIK::IKEffector get_primaryHandEffector() ;

/// @brief Method get_secondaryHandEffector addr 0x121aa98 size 0x3c virtual false final false
 RootMotion::FinalIK::IKEffector get_secondaryHandEffector() ;

/// @brief Method get_primaryHand addr 0x121aa24 size 0x1c virtual false final false
 UnityEngine::Transform get_primaryHand() ;

/// @brief Method get_secondaryHand addr 0x121aa40 size 0x1c virtual false final false
 UnityEngine::Transform get_secondaryHand() ;

/// @brief Method OnDestroy addr 0x121ac3c size 0x1d0 virtual true final false
 void OnDestroy() ;

// Ctor Parameters []
explicit Recoil() ;

/// @brief Method .ctor addr 0x121ae0c size 0x8c virtual false final false
 void _ctor() ;
