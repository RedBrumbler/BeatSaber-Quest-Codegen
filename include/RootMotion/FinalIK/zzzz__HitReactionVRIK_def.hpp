...
/// @brief Method get_crossFader addr 0x1216d7c size 0x8 virtual false final false
 float_t get_crossFader() ;

/// @brief Method set_crossFader addr 0x1216d84 size 0x8 virtual false final false
 void set_crossFader(float_t value) ;

/// @brief Method get_timer addr 0x1216d8c size 0x8 virtual false final false
 float_t get_timer() ;

/// @brief Method set_timer addr 0x1216d94 size 0x8 virtual false final false
 void set_timer(float_t value) ;

/// @brief Method get_force addr 0x1216d9c size 0xc virtual false final false
 UnityEngine::Vector3 get_force() ;

/// @brief Method set_force addr 0x1216da8 size 0xc virtual false final false
 void set_force(UnityEngine::Vector3 value) ;

/// @brief Method get_point addr 0x1216db4 size 0xc virtual false final false
 UnityEngine::Vector3 get_point() ;

/// @brief Method set_point addr 0x1216dc0 size 0xc virtual false final false
 void set_point(UnityEngine::Vector3 value) ;

/// @brief Method Hit addr 0x1216c2c size 0x130 virtual false final false
 void Hit(UnityEngine::Vector3 force, ::ArrayW<UnityEngine::AnimationCurve> curves, UnityEngine::Vector3 point) ;

/// @brief Method Apply addr 0x1216928 size 0xe0 virtual false final false
...
/// @brief Method .ctor addr 0x1216dcc size 0x14 virtual false final false
 void _ctor() ;
...
/// @brief Method Apply addr 0x12171b0 size 0x78 virtual false final false
 void Apply(RootMotion::FinalIK::VRIK ik, UnityEngine::Vector3 offset, float_t crossFader) ;

/// @brief Method CrossFadeStart addr 0x1216fd4 size 0x14 virtual false final false
 void CrossFadeStart() ;

// Ctor Parameters []
explicit RootMotion__FinalIK__HitReactionVRIK__PositionOffset__PositionOffsetLink() ;

/// @brief Method .ctor addr 0x1217244 size 0x8 virtual false final false
 void _ctor() ;
...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12605))}
...
/// @brief Method GetLength addr 0x1216de0 size 0x194 virtual true final false
 float_t GetLength(::ArrayW<UnityEngine::AnimationCurve> curves) ;

/// @brief Method CrossFadeStart addr 0x1216f74 size 0x60 virtual true final false
 void CrossFadeStart() ;

/// @brief Method OnApply addr 0x1216fe8 size 0x1c8 virtual true final false
 void OnApply(RootMotion::FinalIK::VRIK ik, ::ArrayW<UnityEngine::AnimationCurve> curves, float_t weight) ;

// Ctor Parameters []
explicit RootMotion__FinalIK__HitReactionVRIK__PositionOffset() ;

/// @brief Method .ctor addr 0x1217228 size 0x1c virtual false final false
 void _ctor() ;
...
/// @brief Method Apply addr 0x1217604 size 0x108 virtual false final false
 void Apply(RootMotion::FinalIK::VRIK ik, UnityEngine::Quaternion offset, float_t crossFader) ;

/// @brief Method CrossFadeStart addr 0x121737c size 0xc virtual false final false
 void CrossFadeStart() ;

// Ctor Parameters []
explicit RootMotion__FinalIK__HitReactionVRIK__RotationOffset__RotationOffsetLink() ;

/// @brief Method .ctor addr 0x1217720 size 0x64 virtual false final false
 void _ctor() ;
...
/// @brief Method GetLength addr 0x121724c size 0xd8 virtual true final false
 float_t GetLength(::ArrayW<UnityEngine::AnimationCurve> curves) ;

/// @brief Method CrossFadeStart addr 0x1217324 size 0x58 virtual true final false
 void CrossFadeStart() ;

/// @brief Method OnApply addr 0x1217388 size 0x27c virtual true final false
 void OnApply(RootMotion::FinalIK::VRIK ik, ::ArrayW<UnityEngine::AnimationCurve> curves, float_t weight) ;

// Ctor Parameters []
explicit RootMotion__FinalIK__HitReactionVRIK__RotationOffset() ;

/// @brief Method .ctor addr 0x121770c size 0x14 virtual false final false
 void _ctor() ;
...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12619))}
...
/// @brief Method OnModifyOffset addr 0x1216870 size 0xb8 virtual true final false
 void OnModifyOffset() ;

/// @brief Method Hit addr 0x1216a08 size 0x224 virtual false final false
 void Hit(UnityEngine::Collider collider, UnityEngine::Vector3 force, UnityEngine::Vector3 point) ;

// Ctor Parameters []
explicit HitReactionVRIK() ;

/// @brief Method .ctor addr 0x1216d5c size 0x10 virtual false final false
 void _ctor() ;
