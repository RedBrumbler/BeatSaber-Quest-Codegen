...
/// @brief Method Start addr 0x1217cf0 size 0x68 virtual false final false
 void Start() ;

/// @brief Method LateUpdate addr 0x1217ddc size 0x4e8 virtual false final false
 void LateUpdate() ;

/// @brief Method get_pivot addr 0x1217d58 size 0x84 virtual false final false
 UnityEngine::Vector3 get_pivot() ;

/// @brief Method ApplyMinDistance addr 0x12182c4 size 0x184 virtual false final false
 void ApplyMinDistance() ;

/// @brief Method RootRotation addr 0x1218448 size 0x24c virtual false final false
 void RootRotation() ;

// Ctor Parameters []
explicit LookAtController() ;

/// @brief Method .ctor addr 0x1218694 size 0x98 virtual false final false
 void _ctor() ;
