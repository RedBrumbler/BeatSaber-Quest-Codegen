...
/// @brief Method get_initiated addr 0x11c571c size 0x8 virtual false final false
 bool get_initiated() ;

/// @brief Method set_initiated addr 0x11c5724 size 0xc virtual false final false
 void set_initiated(bool value) ;

/// @brief Method get_IKPosition addr 0x11c5730 size 0x20 virtual false final false
 UnityEngine::Vector3 get_IKPosition() ;

/// @brief Method set_IKPosition addr 0x11c5750 size 0x20 virtual false final false
 void set_IKPosition(UnityEngine::Vector3 value) ;

/// @brief Method get_IKRotation addr 0x11c5770 size 0x20 virtual false final false
 UnityEngine::Quaternion get_IKRotation() ;

/// @brief Method set_IKRotation addr 0x11c5790 size 0x20 virtual false final false
 void set_IKRotation(UnityEngine::Quaternion value) ;

/// @brief Method IsValid addr 0x11c57b0 size 0xec virtual false final false
 bool IsValid(ByRef<::StringW> errorMessage) ;

/// @brief Method Initiate addr 0x11c589c size 0x4e0 virtual false final false
 void Initiate(UnityEngine::Transform hand, int32_t index) ;

/// @brief Method FixTransforms addr 0x11c5d7c size 0xcc virtual false final false
 void FixTransforms() ;

/// @brief Method StoreDefaultLocalState addr 0x11c5e48 size 0xb8 virtual false final false
 void StoreDefaultLocalState() ;

/// @brief Method Update addr 0x11c5f00 size 0x660 virtual false final false
 void Update(float_t masterWeight) ;

// Ctor Parameters []
explicit Finger() ;

/// @brief Method .ctor addr 0x11c6560 size 0x10 virtual false final false
 void _ctor() ;
