...
/// @brief Method SetChain addr 0x11eb864 size 0x17c virtual false final false
 bool SetChain(::ArrayW<UnityEngine::Transform> hierarchy, UnityEngine::Transform root) ;

/// @brief Method AddBone addr 0x11eb9e0 size 0x12c virtual false final false
 void AddBone(UnityEngine::Transform bone) ;

/// @brief Method StoreDefaultLocalState addr 0x11ebb0c size 0x5c virtual true final false
 void StoreDefaultLocalState() ;

/// @brief Method FixTransforms addr 0x11ebb68 size 0x70 virtual true final false
 void FixTransforms() ;

/// @brief Method IsValid addr 0x11ebbd8 size 0x3c4 virtual true final false
 bool IsValid(ByRef<::StringW> message) ;

/// @brief Method GetPoints addr 0x11ebf9c size 0x8 virtual true final false
 ::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point> GetPoints() ;

/// @brief Method GetPoint addr 0x11ebfa4 size 0xdc virtual true final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point GetPoint(UnityEngine::Transform transform) ;

/// @brief Method get_minBones addr 0x11ec080 size 0x8 virtual true final false
 int32_t get_minBones() ;

/// @brief Method get_boneLengthCanBeZero addr 0x11ec088 size 0x8 virtual true final false
 bool get_boneLengthCanBeZero() ;

/// @brief Method get_allowCommonParent addr 0x11ec090 size 0x8 virtual true final false
 bool get_allowCommonParent() ;

/// @brief Method OnInitiate addr 0x11ec098 size 0x4 virtual true final false
 void OnInitiate() ;

/// @brief Method OnUpdate addr 0x11ec09c size 0x4 virtual true final false
 void OnUpdate() ;

/// @brief Method InitiateBones addr 0x11e39c0 size 0x488 virtual false final false
 void InitiateBones() ;

/// @brief Method get_localDirection addr 0x11ec0a0 size 0xbc virtual true final false
 UnityEngine::Vector3 get_localDirection() ;

/// @brief Method get_positionOffset addr 0x11e44d4 size 0x48 virtual false final false
 float_t get_positionOffset() ;

/// @brief Method GetSingularityOffset addr 0x11e4128 size 0x3ac virtual false final false
 UnityEngine::Vector3 GetSingularityOffset() ;

/// @brief Method SingularityDetected addr 0x11ec15c size 0x294 virtual false final false
 bool SingularityDetected() ;

// Ctor Parameters []
explicit IKSolverHeuristic() ;

/// @brief Method .ctor addr 0x11e2a94 size 0x74 virtual false final false
 void _ctor() ;
