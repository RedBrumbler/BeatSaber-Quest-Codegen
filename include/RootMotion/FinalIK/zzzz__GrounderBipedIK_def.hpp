...
/// @brief Method OpenUserManual addr 0x11c73e8 size 0x44 virtual true final false
 void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x11c742c size 0x44 virtual true final false
 void OpenScriptReference() ;

/// @brief Method ResetPosition addr 0x11c7470 size 0x6c virtual true final false
 void ResetPosition() ;

/// @brief Method IsReadyToInitiate addr 0x11c74dc size 0xa0 virtual false final false
 bool IsReadyToInitiate() ;

/// @brief Method Update addr 0x11c757c size 0x54 virtual false final false
 void Update() ;

/// @brief Method Initiate addr 0x11c75d0 size 0x304 virtual false final false
 void Initiate() ;

/// @brief Method OnDisable addr 0x11c78d4 size 0x40 virtual false final false
 void OnDisable() ;

/// @brief Method OnSolverUpdate addr 0x11c7914 size 0x460 virtual false final false
 void OnSolverUpdate() ;

/// @brief Method SetLegIK addr 0x11c7d74 size 0xc0 virtual false final false
 void SetLegIK(RootMotion::FinalIK::IKSolverLimb limb, int32_t index) ;

/// @brief Method OnPostSolverUpdate addr 0x11c7e34 size 0x1d0 virtual false final false
 void OnPostSolverUpdate() ;

/// @brief Method OnDestroy addr 0x11c8004 size 0x1a8 virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit GrounderBipedIK() ;

/// @brief Method .ctor addr 0x11c81ac size 0x108c virtual false final false
 void _ctor() ;
