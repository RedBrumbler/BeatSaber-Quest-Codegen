...
/// @brief Method Start addr 0x1215888 size 0x8c virtual false final false
 void Start() ;

/// @brief Method Update addr 0x1215914 size 0xc0 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit EditorIK() ;

/// @brief Method .ctor addr 0x12159d4 size 0x8 virtual false final false
 void _ctor() ;
