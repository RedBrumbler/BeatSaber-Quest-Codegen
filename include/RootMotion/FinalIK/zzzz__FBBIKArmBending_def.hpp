...
/// @brief Method LateUpdate addr 0x11d3d3c size 0x49c virtual false final false
 void LateUpdate() ;

/// @brief Method OnPostFBBIK addr 0x11d41d8 size 0x194 virtual false final false
 void OnPostFBBIK() ;

/// @brief Method OnDestroy addr 0x11d436c size 0x10c virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit FBBIKArmBending() ;

/// @brief Method .ctor addr 0x11d4478 size 0x8 virtual false final false
 void _ctor() ;
