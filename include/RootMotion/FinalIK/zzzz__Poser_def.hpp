...
/// @brief Method UpdateManual addr 0x120dfb4 size 0xc virtual false final false
 void UpdateManual() ;
...
/// @brief Method UpdateSolver addr 0x120dfc0 size 0x44 virtual true final false
 void UpdateSolver() ;

/// @brief Method InitiateSolver addr 0x120e004 size 0x2c virtual true final false
 void InitiateSolver() ;

/// @brief Method FixTransforms addr 0x120e030 size 0x18 virtual true final false
 void FixTransforms() ;

// Ctor Parameters []
explicit Poser() ;

/// @brief Method .ctor addr 0x120d91c size 0x10 virtual false final false
 void _ctor() ;
