...
/// @brief Method Look addr 0x1206da0 size 0x110 virtual false final false
 void Look(UnityEngine::Transform target, float_t time) ;

/// @brief Method OnFixTransforms addr 0x1206eb0 size 0x98 virtual false final false
 void OnFixTransforms() ;

/// @brief Method Update addr 0x1206f48 size 0x1f0 virtual false final false
 void Update() ;

/// @brief Method SolveSpine addr 0x1207138 size 0xa8 virtual false final false
 void SolveSpine() ;

/// @brief Method SolveHead addr 0x12071e0 size 0xac virtual false final false
 void SolveHead() ;

// Ctor Parameters []
explicit InteractionLookAt() ;

/// @brief Method .ctor addr 0x120728c size 0x14 virtual false final false
 void _ctor() ;
