...
/// @brief Method Initiate addr 0x11f1ff8 size 0xf0 virtual false final false
 void Initiate(UnityEngine::Vector3 childPosition, UnityEngine::Vector3 bendNormal) ;

/// @brief Method GetRotation addr 0x11f28a0 size 0x90 virtual false final false
 UnityEngine::Quaternion GetRotation(UnityEngine::Vector3 direction, UnityEngine::Vector3 bendNormal) ;

/// @brief Method GetBendNormalFromCurrentRotation addr 0x11ed5d4 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x11f293c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method SetBendGoalPosition addr 0x11f0d5c size 0x194 virtual false final false
 void SetBendGoalPosition(UnityEngine::Vector3 goalPosition, float_t weight) ;

/// @brief Method SetBendPlaneToCurrent addr 0x11f0ef0 size 0x180 virtual false final false
 void SetBendPlaneToCurrent() ;

/// @brief Method SetIKRotation addr 0x11f1070 size 0xc virtual false final false
 void SetIKRotation(UnityEngine::Quaternion rotation) ;

/// @brief Method SetIKRotationWeight addr 0x11f107c size 0x1c virtual false final false
 void SetIKRotationWeight(float_t weight) ;

/// @brief Method GetIKRotation addr 0x11f1098 size 0xc virtual false final false
 UnityEngine::Quaternion GetIKRotation() ;

/// @brief Method GetIKRotationWeight addr 0x11f10a4 size 0x8 virtual false final false
 float_t GetIKRotationWeight() ;

/// @brief Method GetPoints addr 0x11f10ac size 0xec virtual true final false
 ::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point> GetPoints() ;

/// @brief Method GetPoint addr 0x11f1198 size 0xf8 virtual true final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point GetPoint(UnityEngine::Transform transform) ;

/// @brief Method StoreDefaultLocalState addr 0x11f1290 size 0x40 virtual true final false
 void StoreDefaultLocalState() ;

/// @brief Method FixTransforms addr 0x11f12d0 size 0x50 virtual true final false
 void FixTransforms() ;

/// @brief Method IsValid addr 0x11f1320 size 0x3a4 virtual true final false
 bool IsValid(ByRef<::StringW> message) ;

/// @brief Method SetChain addr 0x11f16c4 size 0x4c virtual false final false
...
/// @brief Method Solve addr 0x11f1710 size 0x4f4 virtual false final false
...
/// @brief Method GetDirectionToBendPoint addr 0x11f1c04 size 0x158 virtual false final false
...
/// @brief Method OnInitiate addr 0x11f1d5c size 0x12c virtual true final false
 void OnInitiate() ;

/// @brief Method IsDirectHierarchy addr 0x11f1f08 size 0xf0 virtual false final false
 bool IsDirectHierarchy() ;

/// @brief Method InitiateBones addr 0x11f1e88 size 0x80 virtual false final false
 void InitiateBones() ;

/// @brief Method OnUpdate addr 0x11f20e8 size 0x5f8 virtual true final false
 void OnUpdate() ;

/// @brief Method OnInitiateVirtual addr 0x11f2930 size 0x4 virtual true final false
 void OnInitiateVirtual() ;

/// @brief Method OnUpdateVirtual addr 0x11f2934 size 0x4 virtual true final false
 void OnUpdateVirtual() ;

/// @brief Method OnPostSolveVirtual addr 0x11f2938 size 0x4 virtual true final false
 void OnPostSolveVirtual() ;

/// @brief Method GetBendDirection addr 0x11f26e0 size 0x1c0 virtual false final false
...
/// @brief Method .ctor addr 0x11ee77c size 0x128 virtual false final false
 void _ctor() ;
