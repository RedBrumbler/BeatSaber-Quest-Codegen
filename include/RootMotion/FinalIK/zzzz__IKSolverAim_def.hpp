...
/// @brief Method GetAngle addr 0x11e16b8 size 0x138 virtual false final false
 float_t GetAngle() ;

/// @brief Method get_transformAxis addr 0x11e17f0 size 0x30 virtual false final false
 UnityEngine::Vector3 get_transformAxis() ;

/// @brief Method get_transformPoleAxis addr 0x11e1820 size 0x30 virtual false final false
 UnityEngine::Vector3 get_transformPoleAxis() ;

/// @brief Method OnInitiate addr 0x11e1850 size 0x28c virtual true final false
 void OnInitiate() ;

/// @brief Method OnUpdate addr 0x11e1adc size 0x56c virtual true final false
 void OnUpdate() ;

/// @brief Method get_minBones addr 0x11e2454 size 0x8 virtual true final false
 int32_t get_minBones() ;

/// @brief Method Solve addr 0x11e23ac size 0xa8 virtual false final false
 void Solve() ;

/// @brief Method GetClampedIKPosition addr 0x11e2048 size 0x364 virtual false final false
 UnityEngine::Vector3 GetClampedIKPosition() ;

/// @brief Method RotateToTarget addr 0x11e245c size 0x538 virtual false final false
...
/// @brief Method get_localDirection addr 0x11e2994 size 0x60 virtual true final false
 UnityEngine::Vector3 get_localDirection() ;

// Ctor Parameters []
explicit IKSolverAim() ;

/// @brief Method .ctor addr 0x11e29f4 size 0xa0 virtual false final false
 void _ctor() ;
