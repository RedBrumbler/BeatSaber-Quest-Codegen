...
/// @brief Method IsValid addr 0x11ddf0c size 0x74 virtual true final false
 bool IsValid(RootMotion::FinalIK::IKSolver solver, ByRef<::StringW> message) ;

/// @brief Method GetBoneMap addr 0x11ddf80 size 0xc8 virtual false final false
...
/// @brief Method SetLimbOrientation addr 0x11de048 size 0x2b8 virtual false final false
 void SetLimbOrientation(UnityEngine::Vector3 upper, UnityEngine::Vector3 lower) ;

// Ctor Parameters []
explicit IKMappingLimb() ;

/// @brief Method .ctor addr 0x11de300 size 0x11c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11de41c size 0x148 virtual false final false
...
/// @brief Method SetBones addr 0x11de564 size 0xc virtual false final false
...
/// @brief Method StoreDefaultLocalState addr 0x11de570 size 0x98 virtual false final false
 void StoreDefaultLocalState() ;

/// @brief Method FixTransforms addr 0x11de608 size 0xa8 virtual false final false
 void FixTransforms() ;

/// @brief Method Initiate addr 0x11de6b0 size 0x25c virtual true final false
 void Initiate(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method ReadPose addr 0x11de90c size 0x60 virtual false final false
 void ReadPose() ;

/// @brief Method WritePose addr 0x11de96c size 0x144 virtual false final false
