...
/// @brief Method .ctor addr 0x1219b58 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Solve addr 0x121957c size 0x190 virtual false final false
 void Solve(RootMotion::FinalIK::IKSolverFullBodyBiped solver, float_t weight) ;

/// @brief Method GetOffsetTarget addr 0x121971c size 0x108 virtual false final false
 UnityEngine::Vector3 GetOffsetTarget(RootMotion::FinalIK::IKSolverFullBodyBiped solver) ;

/// @brief Method Raycast addr 0x1219824 size 0x320 virtual false final false
...
/// @brief Method .ctor addr 0x1219b44 size 0x14 virtual false final false
 void _ctor() ;
...
/// @brief Method OnModifyOffset addr 0x121950c size 0x70 virtual true final false
 void OnModifyOffset() ;

// Ctor Parameters []
explicit PenetrationAvoidance() ;

/// @brief Method .ctor addr 0x121970c size 0x10 virtual false final false
 void _ctor() ;
