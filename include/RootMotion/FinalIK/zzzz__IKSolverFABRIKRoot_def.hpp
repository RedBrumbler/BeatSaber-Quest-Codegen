...
/// @brief Method IsValid addr 0x11e6cc4 size 0x654 virtual true final false
 bool IsValid(ByRef<::StringW> message) ;

/// @brief Method StoreDefaultLocalState addr 0x11e7318 size 0x8c virtual true final false
 void StoreDefaultLocalState() ;

/// @brief Method FixTransforms addr 0x11e73a4 size 0x94 virtual true final false
 void FixTransforms() ;

/// @brief Method OnInitiate addr 0x11e7438 size 0xe8 virtual true final false
 void OnInitiate() ;

/// @brief Method IsRoot addr 0x11e7520 size 0x90 virtual false final false
 bool IsRoot(int32_t index) ;

/// @brief Method OnUpdate addr 0x11e75b0 size 0x1d8 virtual true final false
 void OnUpdate() ;

/// @brief Method GetPoints addr 0x11e79b0 size 0xa0 virtual true final false
 ::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point> GetPoints() ;

/// @brief Method GetPoint addr 0x11e7b88 size 0x84 virtual true final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point GetPoint(UnityEngine::Transform transform) ;

/// @brief Method AddPointsToArray addr 0x11e7a50 size 0x138 virtual false final false
...
/// @brief Method GetCentroid addr 0x11e7788 size 0x228 virtual false final false
 UnityEngine::Vector3 GetCentroid() ;

// Ctor Parameters []
explicit IKSolverFABRIKRoot() ;

/// @brief Method .ctor addr 0x11e7c0c size 0x70 virtual false final false
 void _ctor() ;
