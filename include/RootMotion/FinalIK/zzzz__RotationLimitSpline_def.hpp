...
/// @brief Method OpenUserManual addr 0x12137c8 size 0x44 virtual false final false
 void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x121380c size 0x44 virtual false final false
 void OpenScriptReference() ;

/// @brief Method SupportGroup addr 0x1213850 size 0x44 virtual false final false
 void SupportGroup() ;

/// @brief Method ASThread addr 0x1213894 size 0x44 virtual false final false
 void ASThread() ;

/// @brief Method SetSpline addr 0x12138d8 size 0x1c virtual false final false
 void SetSpline(::ArrayW<UnityEngine::Keyframe> keyframes) ;

/// @brief Method LimitRotation addr 0x12138f4 size 0x94 virtual true final false
 UnityEngine::Quaternion LimitRotation(UnityEngine::Quaternion rotation) ;

/// @brief Method LimitSwing addr 0x1213988 size 0x3b8 virtual false final false
 UnityEngine::Quaternion LimitSwing(UnityEngine::Quaternion rotation) ;

// Ctor Parameters []
explicit RotationLimitSpline() ;

/// @brief Method .ctor addr 0x1213d40 size 0x10 virtual false final false
 void _ctor() ;
