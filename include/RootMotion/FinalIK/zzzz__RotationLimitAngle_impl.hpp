...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::RotationLimitAngle::*)()>(&RootMotion::FinalIK::RotationLimitAngle::OpenUserManual)> {
  ...
  constexpr static std::size_t addrs = 0x1210164;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::RotationLimitAngle::*)()>(&RootMotion::FinalIK::RotationLimitAngle::SupportGroup)> {
  constexpr static std::size_t size = 0x44;
  constexpr static std::size_t addrs = 0x12101ec;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::RotationLimitAngle::*)()>(&RootMotion::FinalIK::RotationLimitAngle::ASThread)> {
  constexpr static std::size_t size = 0x44;
  constexpr static std::size_t addrs = 0x1210230;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Quaternion (RootMotion::FinalIK::RotationLimitAngle::*)(UnityEngine::Quaternion)>(&RootMotion::FinalIK::RotationLimitAngle::LimitRotation)> {
  ...
  constexpr static std::size_t addrs = 0x1210274;

  inline static const ::MethodInfo* methodInfo() {
    
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(RootMotion::FinalIK::RotationLimitAngle),
                                 ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<RootMotion::FinalIK::RotationLimitAngle>::get(),
                                  4
                                ));
    return ___internal_method;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<UnityEngine::Quaternion (RootMotion::FinalIK::RotationLimitAngle::*)(UnityEngine::Quaternion)>(&RootMotion::FinalIK::RotationLimitAngle::LimitSwing)> {
  ...
  constexpr static std::size_t addrs = 0x12102ac;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (RootMotion::FinalIK::RotationLimitAngle::*)()>(&RootMotion::FinalIK::RotationLimitAngle::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x12105d0;
...
constexpr float_t RootMotion::FinalIK::RotationLimitAngle::__get_limit() const {
...
constexpr float_t RootMotion::FinalIK::RotationLimitAngle::__get_twistLimit() const {
...
// Ctor Parameters []
 RootMotion::FinalIK::RotationLimitAngle::RotationLimitAngle()  : RootMotion::FinalIK::RotationLimit(THROW_UNLESS(::il2cpp_utils::New<RotationLimitAngle>())) {}
 void RootMotion::FinalIK::RotationLimitAngle::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<RootMotion::FinalIK::RotationLimitAngle>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
