...
/// @brief Method get_nominalDistance addr 0x11da590 size 0x8 virtual false final false
 float_t get_nominalDistance() ;

/// @brief Method set_nominalDistance addr 0x11da598 size 0x8 virtual false final false
 void set_nominalDistance(float_t value) ;

/// @brief Method get_isRigid addr 0x11da5a0 size 0x8 virtual false final false
 bool get_isRigid() ;

/// @brief Method set_isRigid addr 0x11da5a8 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x11da5b4 size 0x40 virtual false final false
 void _ctor(UnityEngine::Transform bone1, UnityEngine::Transform bone2, float_t pushElasticity, float_t pullElasticity) ;

/// @brief Method Initiate addr 0x11d829c size 0x54 virtual false final false
 void Initiate(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method OnPreSolve addr 0x11d8948 size 0x1e4 virtual false final false
 void OnPreSolve(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method Solve addr 0x11da354 size 0x23c virtual false final false
...
/// @brief Method .ctor addr 0x11d7658 size 0xfc virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11d77c0 size 0x134 virtual false final false
 void _ctor(float_t pin, float_t pull, ::ArrayW<UnityEngine::Transform> nodeTransforms) ;

/// @brief Method SetNodes addr 0x11d78f4 size 0x118 virtual false final false
 void SetNodes(::ArrayW<UnityEngine::Transform> boneTransforms) ;

/// @brief Method GetNodeIndex addr 0x11d7a0c size 0xbc virtual false final false
 int32_t GetNodeIndex(UnityEngine::Transform boneTransform) ;

/// @brief Method IsValid addr 0x11d7ac8 size 0x10c virtual false final false
 bool IsValid(ByRef<::StringW> message) ;

/// @brief Method Initiate addr 0x11d7bd4 size 0x16c virtual false final false
 void Initiate(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method ReadPose addr 0x11d8564 size 0x3e4 virtual false final false
 void ReadPose(RootMotion::FinalIK::IKSolverFullBody solver, bool fullBody) ;

/// @brief Method CalculateBoneLengths addr 0x11d7d40 size 0x55c virtual false final false
 void CalculateBoneLengths(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method Reach addr 0x11d8b2c size 0x294 virtual false final false
 void Reach(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method Push addr 0x11d8dc0 size 0x2d0 virtual false final false
 UnityEngine::Vector3 Push(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method SolveTrigonometric addr 0x11d9090 size 0x238 virtual false final false
 void SolveTrigonometric(RootMotion::FinalIK::IKSolverFullBody solver, bool calculateBendDirection) ;

/// @brief Method Stage1 addr 0x11d9a58 size 0x2ac virtual false final false
 void Stage1(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method Stage2 addr 0x11d9f50 size 0x104 virtual false final false
 void Stage2(RootMotion::FinalIK::IKSolverFullBody solver, UnityEngine::Vector3 position) ;

/// @brief Method SolveConstraintSystems addr 0x11da150 size 0xdc virtual false final false
 void SolveConstraintSystems(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method SolveFABRIKJoint addr 0x11d9e3c size 0x114 virtual false final false
 UnityEngine::Vector3 SolveFABRIKJoint(UnityEngine::Vector3 pos1, UnityEngine::Vector3 pos2, float_t length) ;

/// @brief Method GetDirToBendPoint addr 0x11d98f8 size 0x160 virtual false final false
...
/// @brief Method SolveChildConstraints addr 0x11d9dd8 size 0x64 virtual false final false
 void SolveChildConstraints(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method SolveLinearConstraint addr 0x11da22c size 0x128 virtual false final false
...
/// @brief Method ForwardReach addr 0x11d9d04 size 0xd4 virtual false final false
 void ForwardReach(UnityEngine::Vector3 position) ;

/// @brief Method BackwardReach addr 0x11da054 size 0xfc virtual false final false
