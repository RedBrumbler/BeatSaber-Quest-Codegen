...
/// @brief Method Start addr 0x121e134 size 0x50 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x121e184 size 0x28 virtual false final false
 void Update() ;

/// @brief Method GetLODLevel addr 0x121e1ac size 0x120 virtual false final false
 int32_t GetLODLevel() ;

// Ctor Parameters []
explicit VRIKLODController() ;

/// @brief Method .ctor addr 0x121e2cc size 0x18 virtual false final false
 void _ctor() ;
