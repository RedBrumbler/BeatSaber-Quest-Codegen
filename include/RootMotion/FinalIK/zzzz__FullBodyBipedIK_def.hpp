...
/// @brief Method OpenUserManual addr 0x11d128c size 0x44 virtual true final false
 void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x11d12d0 size 0x44 virtual true final false
 void OpenScriptReference() ;

/// @brief Method OpenSetupTutorial addr 0x11d1314 size 0x44 virtual false final false
 void OpenSetupTutorial() ;

/// @brief Method OpenInspectorTutorial addr 0x11d1358 size 0x44 virtual false final false
 void OpenInspectorTutorial() ;

/// @brief Method SupportGroup addr 0x11d139c size 0x44 virtual false final false
 void SupportGroup() ;

/// @brief Method ASThread addr 0x11d13e0 size 0x44 virtual false final false
 void ASThread() ;

/// @brief Method SetReferences addr 0x11d1424 size 0x24 virtual false final false
 void SetReferences(RootMotion::BipedReferences references, UnityEngine::Transform rootNode) ;

/// @brief Method GetIKSolver addr 0x11d1448 size 0x8 virtual true final false
 RootMotion::FinalIK::IKSolver GetIKSolver() ;

/// @brief Method ReferencesError addr 0x11d1450 size 0x1bc virtual false final false
 bool ReferencesError(ByRef<::StringW> errorMessage) ;

/// @brief Method ReferencesWarning addr 0x11d160c size 0x4b0 virtual false final false
 bool ReferencesWarning(ByRef<::StringW> warningMessage) ;

/// @brief Method Reinitiate addr 0x11d1abc size 0x20 virtual false final false
 void Reinitiate() ;

/// @brief Method AutoDetectReferences addr 0x11d1adc size 0xd8 virtual false final false
 void AutoDetectReferences() ;

// Ctor Parameters []
explicit FullBodyBipedIK() ;

/// @brief Method .ctor addr 0x11d1bb4 size 0x98 virtual false final false
 void _ctor() ;
