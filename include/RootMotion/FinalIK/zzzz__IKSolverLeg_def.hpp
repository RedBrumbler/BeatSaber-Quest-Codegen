...
/// @brief Method IsValid addr 0x11ec3f0 size 0x35c virtual true final false
 bool IsValid(ByRef<::StringW> message) ;

/// @brief Method SetChain addr 0x11ec74c size 0x64 virtual false final false
...
/// @brief Method GetPoints addr 0x11ec7b0 size 0x144 virtual true final false
 ::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point> GetPoints() ;

/// @brief Method GetPoint addr 0x11ec8f4 size 0x160 virtual true final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point GetPoint(UnityEngine::Transform transform) ;

/// @brief Method StoreDefaultLocalState addr 0x11eca54 size 0x50 virtual true final false
 void StoreDefaultLocalState() ;

/// @brief Method FixTransforms addr 0x11ecaa4 size 0x60 virtual true final false
 void FixTransforms() ;

/// @brief Method OnInitiate addr 0x11ecb04 size 0x58 virtual true final false
 void OnInitiate() ;

/// @brief Method OnUpdate addr 0x11ece60 size 0x20 virtual true final false
 void OnUpdate() ;

/// @brief Method Solve addr 0x11ece80 size 0x84 virtual false final false
 void Solve() ;

/// @brief Method Read addr 0x11ecb5c size 0x304 virtual false final false
 void Read() ;

/// @brief Method Write addr 0x11ecf04 size 0x178 virtual false final false
 void Write() ;

// Ctor Parameters []
explicit IKSolverLeg() ;

/// @brief Method .ctor addr 0x11ed2e4 size 0x194 virtual false final false
 void _ctor() ;
