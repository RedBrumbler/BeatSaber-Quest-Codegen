...
/// @brief Method OpenTutorial addr 0x11cdce8 size 0x44 virtual false final false
 void OpenTutorial() ;

/// @brief Method OpenUserManual addr 0x11cdd2c size 0x44 virtual true final false
 void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x11cdd70 size 0x44 virtual true final false
 void OpenScriptReference() ;

/// @brief Method ResetPosition addr 0x11cddb4 size 0x18 virtual true final false
 void ResetPosition() ;

/// @brief Method IsReadyToInitiate addr 0x11cddcc size 0x88 virtual false final false
 bool IsReadyToInitiate() ;

/// @brief Method Update addr 0x11cde54 size 0x54 virtual false final false
 void Update() ;

/// @brief Method Initiate addr 0x11cdea8 size 0x238 virtual false final false
 void Initiate() ;

/// @brief Method OnSolverUpdate addr 0x11ce0e0 size 0x1f4 virtual false final false
 void OnSolverUpdate() ;

/// @brief Method SetLegIK addr 0x11ce2d4 size 0x84 virtual false final false
...
/// @brief Method OnPostSolverUpdate addr 0x11ce358 size 0x29c virtual false final false
 void OnPostSolverUpdate() ;

/// @brief Method OnDrawGizmosSelected addr 0x11ce5f4 size 0x134 virtual false final false
 void OnDrawGizmosSelected() ;

/// @brief Method OnDestroy addr 0x11ce728 size 0x198 virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit GrounderVRIK() ;

/// @brief Method .ctor addr 0x11ce8c0 size 0x58 virtual false final false
 void _ctor() ;
