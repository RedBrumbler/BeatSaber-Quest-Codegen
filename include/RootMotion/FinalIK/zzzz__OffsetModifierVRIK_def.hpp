...
/// @brief Method .ctor addr 0x1218e0c size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x1219014 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x1219018 size 0x150 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x1219168 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x1219170 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x12191b0 size 0x8 virtual true final true
...
/// @brief Method get_deltaTime addr 0x1218d64 size 0x20 virtual false final false
 float_t get_deltaTime() ;

/// @brief Method OnModifyOffset addr 0x0 size 0xffffffffffffffff virtual true final false
 void OnModifyOffset() ;

/// @brief Method Start addr 0x1218d84 size 0x20 virtual true final false
 void Start() ;

/// @brief Method Initiate addr 0x1218da4 size 0x68 virtual false final false
 System::Collections::IEnumerator Initiate() ;

/// @brief Method ModifyOffset addr 0x1218e34 size 0xd4 virtual false final false
 void ModifyOffset() ;

/// @brief Method OnDestroy addr 0x1218f08 size 0x10c virtual true final false
 void OnDestroy() ;

// Ctor Parameters []
explicit OffsetModifierVRIK() ;

/// @brief Method .ctor addr 0x1216d6c size 0x10 virtual false final false
 void _ctor() ;
