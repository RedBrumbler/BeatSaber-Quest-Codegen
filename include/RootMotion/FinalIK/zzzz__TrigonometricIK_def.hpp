...
/// @brief Method OpenUserManual addr 0x11d244c size 0x44 virtual true final false
 void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x11d2490 size 0x44 virtual true final false
 void OpenScriptReference() ;

/// @brief Method SupportGroup addr 0x11d24d4 size 0x44 virtual false final false
 void SupportGroup() ;

/// @brief Method ASThread addr 0x11d2518 size 0x44 virtual false final false
 void ASThread() ;

/// @brief Method GetIKSolver addr 0x11d255c size 0x8 virtual true final false
 RootMotion::FinalIK::IKSolver GetIKSolver() ;

// Ctor Parameters []
explicit TrigonometricIK() ;

/// @brief Method .ctor addr 0x11d2564 size 0x68 virtual false final false
 void _ctor() ;
