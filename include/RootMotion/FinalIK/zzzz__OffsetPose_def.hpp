...
/// @brief Method Apply addr 0x12191b8 size 0x250 virtual false final false
...
/// @brief Method .ctor addr 0x1219504 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Apply addr 0x12157b8 size 0xb4 virtual false final false
 void Apply(RootMotion::FinalIK::IKSolverFullBodyBiped solver, float_t weight) ;

/// @brief Method Apply addr 0x1219408 size 0xa4 virtual false final false
 void Apply(RootMotion::FinalIK::IKSolverFullBodyBiped solver, float_t weight, UnityEngine::Quaternion rotation) ;

// Ctor Parameters []
explicit OffsetPose() ;

/// @brief Method .ctor addr 0x12194ac size 0x58 virtual false final false
 void _ctor() ;
