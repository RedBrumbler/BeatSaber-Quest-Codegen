...
/// @brief Method .ctor addr 0x11ee940 size 0x19c virtual false final false
...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12543))}
...
/// @brief Method MaintainRotation addr 0x11ed554 size 0x44 virtual false final false
 void MaintainRotation() ;

/// @brief Method MaintainBend addr 0x11ed598 size 0x3c virtual false final false
 void MaintainBend() ;

/// @brief Method OnInitiateVirtual addr 0x11ed604 size 0x35c virtual true final false
 void OnInitiateVirtual() ;

/// @brief Method OnUpdateVirtual addr 0x11edb4c size 0xbc virtual true final false
 void OnUpdateVirtual() ;

/// @brief Method OnPostSolveVirtual addr 0x11ee668 size 0xa8 virtual true final false
 void OnPostSolveVirtual() ;

// Ctor Parameters []
explicit IKSolverLimb() ;

/// @brief Method .ctor addr 0x11ee710 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11ee8a4 size 0x80 virtual false final false
 void _ctor(UnityEngine::AvatarIKGoal goal) ;

/// @brief Method get_axisDirections addr 0x11ee924 size 0x1c virtual false final false
 ::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolverLimb__AxisDirection> get_axisDirections() ;

/// @brief Method StoreAxisDirections addr 0x11ed960 size 0x1ec virtual false final false
 void StoreAxisDirections(ByRef<::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolverLimb__AxisDirection>> axisDirections) ;

/// @brief Method GetModifiedBendNormal addr 0x11edc08 size 0xa60 virtual false final false
