...
/// @brief Method Relax addr 0x1203988 size 0x444 virtual false final false
 void Relax() ;

/// @brief Method Start addr 0x1203dcc size 0x3a0 virtual false final false
 void Start() ;

/// @brief Method OnPostUpdate addr 0x120416c size 0x78 virtual false final false
 void OnPostUpdate() ;

/// @brief Method LateUpdate addr 0x12041e4 size 0x78 virtual false final false
 void LateUpdate() ;

/// @brief Method OnDestroy addr 0x120425c size 0x118 virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit TwistRelaxer() ;

/// @brief Method .ctor addr 0x1204374 size 0xa0 virtual false final false
 void _ctor() ;
