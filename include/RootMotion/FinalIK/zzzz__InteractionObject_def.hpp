...
/// @brief Method Activate addr 0x1206994 size 0xc4 virtual false final false
 void Activate(UnityEngine::Transform t) ;

// Ctor Parameters []
explicit RootMotion__FinalIK__InteractionObject__InteractionEvent() ;

/// @brief Method .ctor addr 0x120821c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Send addr 0x1208124 size 0xf8 virtual false final false
 void Send(UnityEngine::Transform t) ;

// Ctor Parameters []
explicit RootMotion__FinalIK__InteractionObject__Message() ;

/// @brief Method .ctor addr 0x1208224 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Activate addr 0x1208048 size 0xdc virtual false final false
 void Activate(bool pickUp) ;

/// @brief Method Activate addr 0x120822c size 0xb0 virtual false final false
 void Activate(UnityEngine::Animator animator) ;

/// @brief Method Activate addr 0x12082dc size 0xd8 virtual false final false
 void Activate(UnityEngine::Animation animation) ;

// Ctor Parameters []
explicit RootMotion__FinalIK__InteractionObject__AnimatorEvent() ;

/// @brief Method .ctor addr 0x12083b4 size 0x14 virtual false final false
 void _ctor() ;
...
/// @brief Method GetValue addr 0x1207958 size 0x1c virtual false final false
 float_t GetValue(float_t timer) ;

// Ctor Parameters []
explicit RootMotion__FinalIK__InteractionObject__WeightCurve() ;

/// @brief Method .ctor addr 0x12083c8 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method GetValue addr 0x1207f60 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x12083d0 size 0x10 virtual false final false
 void _ctor() ;
...
/// @brief Method OpenUserManual addr 0x12072a0 size 0x44 virtual false final false
 void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x12072e4 size 0x44 virtual false final false
 void OpenScriptReference() ;

/// @brief Method OpenTutorial1 addr 0x1207328 size 0x44 virtual false final false
 void OpenTutorial1() ;

/// @brief Method OpenTutorial2 addr 0x120736c size 0x44 virtual false final false
 void OpenTutorial2() ;

/// @brief Method OpenTutorial3 addr 0x12073b0 size 0x44 virtual false final false
 void OpenTutorial3() ;

/// @brief Method OpenTutorial4 addr 0x12073f4 size 0x44 virtual false final false
 void OpenTutorial4() ;

/// @brief Method SupportGroup addr 0x1207438 size 0x44 virtual false final false
 void SupportGroup() ;

/// @brief Method ASThread addr 0x120747c size 0x44 virtual false final false
 void ASThread() ;

/// @brief Method get_length addr 0x12074c0 size 0x8 virtual false final false
 float_t get_length() ;

/// @brief Method set_length addr 0x12074c8 size 0x8 virtual false final false
 void set_length(float_t value) ;

/// @brief Method get_lastUsedInteractionSystem addr 0x12074d0 size 0x8 virtual false final false
 RootMotion::FinalIK::InteractionSystem get_lastUsedInteractionSystem() ;

/// @brief Method set_lastUsedInteractionSystem addr 0x12074d8 size 0x8 virtual false final false
 void set_lastUsedInteractionSystem(RootMotion::FinalIK::InteractionSystem value) ;

/// @brief Method Initiate addr 0x12074e0 size 0x1b0 virtual false final false
 void Initiate() ;

/// @brief Method get_lookAtTarget addr 0x1207690 size 0x80 virtual false final false
 UnityEngine::Transform get_lookAtTarget() ;

/// @brief Method GetTarget addr 0x1207710 size 0x178 virtual false final false
...
/// @brief Method CurveUsed addr 0x1205258 size 0x94 virtual false final false
 bool CurveUsed(GlobalNamespace::RootMotion__FinalIK__InteractionObject__WeightCurve__Type type) ;

/// @brief Method GetTargets addr 0x1207888 size 0x8 virtual false final false
 ::ArrayW<RootMotion::FinalIK::InteractionTarget> GetTargets() ;

/// @brief Method GetTarget addr 0x1205114 size 0x13c virtual false final false
 UnityEngine::Transform GetTarget(RootMotion::FinalIK::FullBodyBipedEffector effectorType, ::StringW tag) ;

/// @brief Method OnStartInteraction addr 0x1205250 size 0x8 virtual false final false
 void OnStartInteraction(RootMotion::FinalIK::InteractionSystem interactionSystem) ;

/// @brief Method Apply addr 0x1205dd0 size 0x408 virtual false final false
...
/// @brief Method GetValue addr 0x1206610 size 0x20c virtual false final false
...
/// @brief Method get_targetsRoot addr 0x1206a58 size 0x80 virtual false final false
 UnityEngine::Transform get_targetsRoot() ;

/// @brief Method Start addr 0x1207f90 size 0x4 virtual false final false
 void Start() ;

/// @brief Method Apply addr 0x1207974 size 0x590 virtual false final false
...
/// @brief Method GetTarget addr 0x1207890 size 0x64 virtual false final false
 UnityEngine::Transform GetTarget(RootMotion::FinalIK::FullBodyBipedEffector effectorType) ;

/// @brief Method GetWeightCurveIndex addr 0x1207f04 size 0x5c virtual false final false
 int32_t GetWeightCurveIndex(GlobalNamespace::RootMotion__FinalIK__InteractionObject__WeightCurve__Type weightCurveType) ;

/// @brief Method GetMultiplierIndex addr 0x1207f94 size 0x5c virtual false final false
...
/// @brief Method .ctor addr 0x1207ff0 size 0x58 virtual false final false
 void _ctor() ;
