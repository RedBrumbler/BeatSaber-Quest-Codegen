...
/// @brief Method .ctor addr 0x11cc6ac size 0x34 virtual false final false
...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12479))}
...
/// @brief Method OpenUserManual addr 0x11cbbf0 size 0x44 virtual true final false
 void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x11cbc34 size 0x44 virtual true final false
 void OpenScriptReference() ;

/// @brief Method ResetPosition addr 0x11cbc78 size 0x28 virtual true final false
 void ResetPosition() ;

/// @brief Method IsReadyToInitiate addr 0x11cbca0 size 0x104 virtual false final false
 bool IsReadyToInitiate() ;

/// @brief Method IsReadyToInitiateLegs addr 0x11cbda4 size 0x1e4 virtual false final false
 bool IsReadyToInitiateLegs(::ArrayW<RootMotion::FinalIK::IK> ikComponents) ;

/// @brief Method OnDisable addr 0x11cbf88 size 0x64 virtual false final false
 void OnDisable() ;

/// @brief Method Update addr 0x11cbfec size 0x58 virtual false final false
 void Update() ;

/// @brief Method Initiate addr 0x11cc044 size 0x314 virtual false final false
 void Initiate() ;

/// @brief Method InitiateFeet addr 0x11cc358 size 0x354 virtual false final false
...
/// @brief Method LateUpdate addr 0x11cc6e0 size 0x90 virtual false final false
 void LateUpdate() ;

/// @brief Method RootRotation addr 0x11cc770 size 0x450 virtual false final false
 void RootRotation() ;

/// @brief Method OnSolverUpdate addr 0x11ccbc0 size 0x6c0 virtual false final false
 void OnSolverUpdate() ;

/// @brief Method UpdateForefeetRoot addr 0x11cd280 size 0x2b8 virtual false final false
 void UpdateForefeetRoot() ;

/// @brief Method SetFootIK addr 0x11cd538 size 0x134 virtual false final false
 void SetFootIK(RootMotion::FinalIK::RootMotion__FinalIK__GrounderQuadruped__Foot foot, float_t maxOffset) ;

/// @brief Method OnPostSolverUpdate addr 0x11cd66c size 0x2c8 virtual false final false
 void OnPostSolverUpdate() ;

/// @brief Method OnDestroy addr 0x11cd934 size 0x30 virtual false final false
 void OnDestroy() ;

/// @brief Method DestroyLegs addr 0x11cd964 size 0x1fc virtual false final false
 void DestroyLegs(::ArrayW<RootMotion::FinalIK::IK> ikComponents) ;

// Ctor Parameters []
explicit GrounderQuadruped() ;

/// @brief Method .ctor addr 0x11cdb60 size 0x134 virtual false final false
 void _ctor() ;
