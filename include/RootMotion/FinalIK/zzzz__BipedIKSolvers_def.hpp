...
/// @brief Method get_limbs addr 0x11c4468 size 0x130 virtual false final false
 ::ArrayW<RootMotion::FinalIK::IKSolverLimb> get_limbs() ;

/// @brief Method get_ikSolvers addr 0x11c5008 size 0x1b4 virtual false final false
 ::ArrayW<RootMotion::FinalIK::IKSolver> get_ikSolvers() ;

/// @brief Method AssignReferences addr 0x11c47e4 size 0x120 virtual false final false
 void AssignReferences(RootMotion::BipedReferences references) ;

// Ctor Parameters []
explicit BipedIKSolvers() ;

/// @brief Method .ctor addr 0x11c4e7c size 0x18c virtual false final false
 void _ctor() ;
