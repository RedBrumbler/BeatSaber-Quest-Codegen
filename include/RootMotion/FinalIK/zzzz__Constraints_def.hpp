...
/// @brief Method IsValid addr 0x11c56bc size 0x60 virtual false final false
 bool IsValid() ;

/// @brief Method Initiate addr 0x11c4904 size 0x50 virtual false final false
 void Initiate(UnityEngine::Transform transform) ;

/// @brief Method Update addr 0x11c4ac8 size 0x2f8 virtual false final false
 void Update() ;

// Ctor Parameters []
explicit Constraints() ;

/// @brief Method .ctor addr 0x11c51bc size 0x8 virtual false final false
 void _ctor() ;
