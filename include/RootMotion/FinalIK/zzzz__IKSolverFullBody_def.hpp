...
/// @brief Method GetEffector addr 0x11e7c7c size 0xdc virtual false final false
 RootMotion::FinalIK::IKEffector GetEffector(UnityEngine::Transform t) ;

/// @brief Method GetChain addr 0x11e7d58 size 0x48 virtual false final false
 RootMotion::FinalIK::FBIKChain GetChain(UnityEngine::Transform transform) ;

/// @brief Method GetChainIndex addr 0x11e7da0 size 0x114 virtual false final false
 int32_t GetChainIndex(UnityEngine::Transform transform) ;

/// @brief Method GetNode addr 0x11dbc2c size 0x50 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Node GetNode(int32_t chainIndex, int32_t nodeIndex) ;

/// @brief Method GetChainAndNodeIndexes addr 0x11dbaa0 size 0x74 virtual false final false
 void GetChainAndNodeIndexes(UnityEngine::Transform transform, ByRef<int32_t> chainIndex, ByRef<int32_t> nodeIndex) ;

/// @brief Method GetPoints addr 0x11e7eb4 size 0x198 virtual true final false
 ::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point> GetPoints() ;

/// @brief Method GetPoint addr 0x11e804c size 0x15c virtual true final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point GetPoint(UnityEngine::Transform transform) ;

/// @brief Method IsValid addr 0x11e81a8 size 0x1fc virtual true final false
 bool IsValid(ByRef<::StringW> message) ;

/// @brief Method StoreDefaultLocalState addr 0x11e83a4 size 0xd0 virtual true final false
 void StoreDefaultLocalState() ;

/// @brief Method FixTransforms addr 0x11e8474 size 0xdc virtual true final false
 void FixTransforms() ;

/// @brief Method OnInitiate addr 0x11e8550 size 0x15c virtual true final false
 void OnInitiate() ;

/// @brief Method OnUpdate addr 0x11e86ac size 0x198 virtual true final false
 void OnUpdate() ;

/// @brief Method ReadPose addr 0x11e8844 size 0x22c virtual true final false
 void ReadPose() ;

/// @brief Method Solve addr 0x11e8a70 size 0x2d0 virtual true final false
 void Solve() ;

/// @brief Method ApplyBendConstraints addr 0x11e8d40 size 0x38 virtual true final false
 void ApplyBendConstraints() ;

/// @brief Method WritePose addr 0x11e8d78 size 0xd8 virtual true final false
 void WritePose() ;

// Ctor Parameters []
explicit IKSolverFullBody() ;

/// @brief Method .ctor addr 0x11e8e50 size 0x118 virtual false final false
 void _ctor() ;
