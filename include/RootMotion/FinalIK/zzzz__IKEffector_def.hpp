...
/// @brief Method GetNode addr 0x11db0d0 size 0x5c virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Node GetNode(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method get_isEndEffector addr 0x11db12c size 0x8 virtual false final false
 bool get_isEndEffector() ;

/// @brief Method set_isEndEffector addr 0x11db134 size 0xc virtual false final false
 void set_isEndEffector(bool value) ;

/// @brief Method PinToBone addr 0x11db140 size 0x84 virtual false final false
 void PinToBone(float_t positionWeight, float_t rotationWeight) ;

// Ctor Parameters []
explicit IKEffector() ;

/// @brief Method .ctor addr 0x11db1c4 size 0x1a0 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11db364 size 0x1bc virtual false final false
 void _ctor(UnityEngine::Transform bone, ::ArrayW<UnityEngine::Transform> childBones) ;

/// @brief Method IsValid addr 0x11db520 size 0x2f4 virtual false final false
 bool IsValid(RootMotion::FinalIK::IKSolver solver, ByRef<::StringW> message) ;

/// @brief Method Initiate addr 0x11db814 size 0x28c virtual false final false
 void Initiate(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method ResetOffset addr 0x11dbb14 size 0x118 virtual false final false
 void ResetOffset(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method SetToTarget addr 0x11dbc7c size 0x9c virtual false final false
 void SetToTarget() ;

/// @brief Method OnPreSolve addr 0x11dbd18 size 0x6a0 virtual false final false
 void OnPreSolve(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method OnPostWrite addr 0x11dc3b8 size 0x58 virtual false final false
 void OnPostWrite() ;

/// @brief Method GetPlaneRotation addr 0x11dc410 size 0x1c8 virtual false final false
 UnityEngine::Quaternion GetPlaneRotation(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method Update addr 0x11dc5d8 size 0x248 virtual false final false
 void Update(RootMotion::FinalIK::IKSolverFullBody solver) ;

/// @brief Method GetPosition addr 0x11dc820 size 0x2b0 virtual false final false
