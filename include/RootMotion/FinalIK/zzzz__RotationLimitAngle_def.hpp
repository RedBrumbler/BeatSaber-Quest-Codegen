...
/// @brief Method OpenUserManual addr 0x1210164 size 0x44 virtual false final false
 void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x12101a8 size 0x44 virtual false final false
 void OpenScriptReference() ;

/// @brief Method SupportGroup addr 0x12101ec size 0x44 virtual false final false
 void SupportGroup() ;

/// @brief Method ASThread addr 0x1210230 size 0x44 virtual false final false
 void ASThread() ;

/// @brief Method LimitRotation addr 0x1210274 size 0x38 virtual true final false
 UnityEngine::Quaternion LimitRotation(UnityEngine::Quaternion rotation) ;

/// @brief Method LimitSwing addr 0x12102ac size 0x324 virtual false final false
 UnityEngine::Quaternion LimitSwing(UnityEngine::Quaternion rotation) ;

// Ctor Parameters []
explicit RotationLimitAngle() ;

/// @brief Method .ctor addr 0x12105d0 size 0x10 virtual false final false
 void _ctor() ;
