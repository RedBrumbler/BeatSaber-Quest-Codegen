...
/// @brief Method get_sqrMag addr 0x11fbe04 size 0x8 virtual false final false
 float_t get_sqrMag() ;

/// @brief Method set_sqrMag addr 0x11fbe0c size 0x8 virtual false final false
 void set_sqrMag(float_t value) ;

/// @brief Method get_mag addr 0x11fbe14 size 0x8 virtual false final false
 float_t get_mag() ;

/// @brief Method set_mag addr 0x11fbe1c size 0x8 virtual false final false
 void set_mag(float_t value) ;

/// @brief Method SetLOD addr 0x11fbe24 size 0x8 virtual false final false
 void SetLOD(int32_t LOD) ;

/// @brief Method Read addr 0x11ed224 size 0xc0 virtual false final false
...
/// @brief Method MovePosition addr 0x11fbe2c size 0x88 virtual false final false
 void MovePosition(UnityEngine::Vector3 position) ;

/// @brief Method MoveRotation addr 0x11fbeb4 size 0x98 virtual false final false
 void MoveRotation(UnityEngine::Quaternion rotation) ;

/// @brief Method Translate addr 0x11fbf4c size 0x48 virtual false final false
 void Translate(UnityEngine::Vector3 position, UnityEngine::Quaternion rotation) ;

/// @brief Method TranslateRoot addr 0x11f80f4 size 0x128 virtual false final false
 void TranslateRoot(UnityEngine::Vector3 newRootPos, UnityEngine::Quaternion newRootRot) ;

/// @brief Method RotateTo addr 0x11fb888 size 0x168 virtual false final false
...
/// @brief Method Visualize addr 0x11fbf94 size 0x124 virtual false final false
 void Visualize(UnityEngine::Color color) ;

/// @brief Method Visualize addr 0x11fc0b8 size 0x14 virtual false final false
 void Visualize() ;

// Ctor Parameters []
explicit RootMotion__FinalIK__IKSolverVR__BodyPart() ;

/// @brief Method .ctor addr 0x11fbd6c size 0x98 virtual false final false
 void _ctor() ;
...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12546))}
...
/// @brief Method get_position addr 0x11fa39c size 0xc virtual false final false
 UnityEngine::Vector3 get_position() ;

/// @brief Method set_position addr 0x11fa3a8 size 0xc virtual false final false
 void set_position(UnityEngine::Vector3 value) ;

/// @brief Method get_rotation addr 0x11fa3b4 size 0xc virtual false final false
 UnityEngine::Quaternion get_rotation() ;

/// @brief Method set_rotation addr 0x11fa3c0 size 0xc virtual false final false
 void set_rotation(UnityEngine::Quaternion value) ;

/// @brief Method get_shoulder addr 0x11fa3cc size 0x28 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone get_shoulder() ;

/// @brief Method get_upperArm addr 0x11fa3f4 size 0x34 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone get_upperArm() ;

/// @brief Method get_forearm addr 0x11fa428 size 0x40 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone get_forearm() ;

/// @brief Method get_hand addr 0x11fa468 size 0x40 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone get_hand() ;

/// @brief Method OnRead addr 0x11fa4a8 size 0x844 virtual true final false
 void OnRead(::ArrayW<UnityEngine::Vector3> positions, ::ArrayW<UnityEngine::Quaternion> rotations, bool hasChest, bool hasNeck, bool hasShoulders, bool hasToes, bool hasLegs, int32_t rootIndex, int32_t index) ;

/// @brief Method PreSolve addr 0x11facec size 0x2ac virtual true final false
 void PreSolve() ;

/// @brief Method ApplyOffsets addr 0x11faf98 size 0x24 virtual true final false
 void ApplyOffsets() ;

/// @brief Method Stretching addr 0x11fafbc size 0x350 virtual false final false
 void Stretching() ;

/// @brief Method Solve addr 0x11f821c size 0x15e4 virtual false final false
 void Solve(bool isLeft) ;

/// @brief Method ResetOffsets addr 0x11fb9f0 size 0x58 virtual true final false
 void ResetOffsets() ;

/// @brief Method Write addr 0x11fba48 size 0x20c virtual true final false
 void Write(ByRef<::ArrayW<UnityEngine::Vector3>> solvedPositions, ByRef<::ArrayW<UnityEngine::Quaternion>> solvedRotations) ;

/// @brief Method DamperValue addr 0x11fb30c size 0x80 virtual false final false
 float_t DamperValue(float_t value, float_t min, float_t max, float_t weight) ;

/// @brief Method GetBendNormal addr 0x11fb38c size 0x4fc virtual false final false
 UnityEngine::Vector3 GetBendNormal(UnityEngine::Vector3 dir) ;

/// @brief Method Visualize addr 0x11fbc54 size 0x118 virtual false final false
...
/// @brief Method .ctor addr 0x11fa124 size 0x18c virtual false final false
 void _ctor() ;
...
/// @brief Method get_isStepping addr 0x11fc0cc size 0x14 virtual false final false
 bool get_isStepping() ;

/// @brief Method get_stepProgress addr 0x11fc0e0 size 0x8 virtual false final false
 float_t get_stepProgress() ;

/// @brief Method set_stepProgress addr 0x11fc0e8 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x11fc0f0 size 0x1c4 virtual false final false
...
/// @brief Method get_position addr 0x11fca80 size 0xc virtual false final false
 UnityEngine::Vector3 get_position() ;

/// @brief Method set_position addr 0x11fca8c size 0xc virtual false final false
 void set_position(UnityEngine::Vector3 value) ;

/// @brief Method get_rotation addr 0x11fca98 size 0xc virtual false final false
 UnityEngine::Quaternion get_rotation() ;

/// @brief Method set_rotation addr 0x11fcaa4 size 0xc virtual false final false
 void set_rotation(UnityEngine::Quaternion value) ;

/// @brief Method get_hasToes addr 0x11fcab0 size 0x8 virtual false final false
 bool get_hasToes() ;

/// @brief Method set_hasToes addr 0x11fcab8 size 0xc virtual false final false
 void set_hasToes(bool value) ;

/// @brief Method get_thigh addr 0x11fcac4 size 0x28 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone get_thigh() ;

/// @brief Method get_calf addr 0x11fcaec size 0x2c virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone get_calf() ;

/// @brief Method get_foot addr 0x11fcb18 size 0x2c virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone get_foot() ;

/// @brief Method get_toes addr 0x11fcb44 size 0x2c virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone get_toes() ;

/// @brief Method get_lastBone addr 0x11f80c0 size 0x34 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone get_lastBone() ;

/// @brief Method get_thighRelativeToPelvis addr 0x11fcb70 size 0xc virtual false final false
 UnityEngine::Vector3 get_thighRelativeToPelvis() ;

/// @brief Method set_thighRelativeToPelvis addr 0x11fcb7c size 0xc virtual false final false
 void set_thighRelativeToPelvis(UnityEngine::Vector3 value) ;

/// @brief Method OnRead addr 0x11fcb88 size 0x568 virtual true final false
 void OnRead(::ArrayW<UnityEngine::Vector3> positions, ::ArrayW<UnityEngine::Quaternion> rotations, bool hasChest, bool hasNeck, bool hasShoulders, bool hasToes, bool hasLegs, int32_t rootIndex, int32_t index) ;

/// @brief Method PreSolve addr 0x11fd0f0 size 0x4d4 virtual true final false
 void PreSolve() ;

/// @brief Method ApplyOffsets addr 0x11fd860 size 0x4dc virtual true final false
 void ApplyOffsets() ;

/// @brief Method ApplyPositionOffset addr 0x11fd810 size 0x50 virtual false final false
 void ApplyPositionOffset(UnityEngine::Vector3 offset, float_t weight) ;

/// @brief Method ApplyRotationOffset addr 0x11fd5c4 size 0x24c virtual false final false
 void ApplyRotationOffset(UnityEngine::Quaternion offset, float_t weight) ;

/// @brief Method Solve addr 0x11ed07c size 0x1a8 virtual false final false
 void Solve(bool stretch) ;

/// @brief Method FixTwistRotations addr 0x11fe118 size 0x458 virtual false final false
 void FixTwistRotations() ;

/// @brief Method Stretching addr 0x11fdd3c size 0x3dc virtual false final false
 void Stretching() ;

/// @brief Method Write addr 0x11fe570 size 0x208 virtual true final false
 void Write(ByRef<::ArrayW<UnityEngine::Vector3>> solvedPositions, ByRef<::ArrayW<UnityEngine::Quaternion>> solvedRotations) ;

/// @brief Method ResetOffsets addr 0x11fe778 size 0xe0 virtual true final false
 void ResetOffsets() ;

// Ctor Parameters []
explicit RootMotion__FinalIK__IKSolverVR__Leg() ;

/// @brief Method .ctor addr 0x11ed478 size 0xdc virtual false final false
 void _ctor() ;
...
/// @brief Method get_centerOfMass addr 0x11fe858 size 0xc virtual false final false
 UnityEngine::Vector3 get_centerOfMass() ;

/// @brief Method set_centerOfMass addr 0x11fe864 size 0xc virtual false final false
 void set_centerOfMass(UnityEngine::Vector3 value) ;

/// @brief Method Initiate addr 0x11f69fc size 0x2f4 virtual false final false
 void Initiate(::ArrayW<UnityEngine::Vector3> positions, ::ArrayW<UnityEngine::Quaternion> rotations, bool hasToes) ;

/// @brief Method Reset addr 0x11f44fc size 0x1e4 virtual false final false
 void Reset(::ArrayW<UnityEngine::Vector3> positions, ::ArrayW<UnityEngine::Quaternion> rotations) ;

/// @brief Method AddDeltaRotation addr 0x11f39c8 size 0x3c8 virtual false final false
 void AddDeltaRotation(UnityEngine::Quaternion delta, UnityEngine::Vector3 pivot) ;

/// @brief Method AddDeltaPosition addr 0x11f3910 size 0xb8 virtual false final false
 void AddDeltaPosition(UnityEngine::Vector3 delta) ;

/// @brief Method Solve addr 0x11f6cf0 size 0x13d0 virtual false final false
...
/// @brief Method get_leftFootstepPosition addr 0x11fec40 size 0x34 virtual false final false
 UnityEngine::Vector3 get_leftFootstepPosition() ;

/// @brief Method get_rightFootstepPosition addr 0x11fec74 size 0x38 virtual false final false
 UnityEngine::Vector3 get_rightFootstepPosition() ;

/// @brief Method get_leftFootstepRotation addr 0x11fecac size 0x34 virtual false final false
 UnityEngine::Quaternion get_leftFootstepRotation() ;

/// @brief Method get_rightFootstepRotation addr 0x11fece0 size 0x38 virtual false final false
 UnityEngine::Quaternion get_rightFootstepRotation() ;

/// @brief Method StepBlocked addr 0x11fe870 size 0x1b4 virtual false final false
 bool StepBlocked(UnityEngine::Vector3 fromPosition, UnityEngine::Vector3 toPosition, UnityEngine::Vector3 rootPosition) ;

/// @brief Method CanStep addr 0x11fea24 size 0x6c virtual false final false
 bool CanStep() ;

/// @brief Method GetLineSphereCollision addr 0x11fea90 size 0x1b0 virtual false final false
...
/// @brief Method .ctor addr 0x11fa2b0 size 0xec virtual false final false
 void _ctor() ;
...
/// @brief Method get_pelvis addr 0x11fed18 size 0x34 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone get_pelvis() ;

/// @brief Method get_firstSpineBone addr 0x11fed4c size 0x34 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone get_firstSpineBone() ;

/// @brief Method get_chest addr 0x11fed80 size 0x48 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone get_chest() ;

/// @brief Method get_neck addr 0x11fedc8 size 0x34 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone get_neck() ;

/// @brief Method get_head addr 0x11fedfc size 0x34 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone get_head() ;

/// @brief Method get_anchorRotation addr 0x11fee30 size 0x14 virtual false final false
 UnityEngine::Quaternion get_anchorRotation() ;

/// @brief Method set_anchorRotation addr 0x11fee44 size 0x14 virtual false final false
 void set_anchorRotation(UnityEngine::Quaternion value) ;

/// @brief Method get_anchorRelativeToHead addr 0x11fee58 size 0x14 virtual false final false
 UnityEngine::Quaternion get_anchorRelativeToHead() ;

/// @brief Method set_anchorRelativeToHead addr 0x11fee6c size 0x14 virtual false final false
 void set_anchorRelativeToHead(UnityEngine::Quaternion value) ;

/// @brief Method OnRead addr 0x11fee80 size 0xc60 virtual true final false
 void OnRead(::ArrayW<UnityEngine::Vector3> positions, ::ArrayW<UnityEngine::Quaternion> rotations, bool hasChest, bool hasNeck, bool hasShoulders, bool hasToes, bool hasLegs, int32_t rootIndex, int32_t index) ;

/// @brief Method PreSolve addr 0x11ffb70 size 0x1e8 virtual true final false
 void PreSolve() ;

/// @brief Method ApplyOffsets addr 0x11ffd58 size 0x794 virtual true final false
 void ApplyOffsets() ;

/// @brief Method CalculateChestTargetRotation addr 0x12004ec size 0x244 virtual false final false
...
/// @brief Method Solve addr 0x1200b28 size 0x53c virtual false final false
...
/// @brief Method FABRIKPass addr 0x1201474 size 0x260 virtual false final false
 void FABRIKPass(UnityEngine::Vector3 animatedPelvisPos, UnityEngine::Vector3 rootUp, float_t weight) ;

/// @brief Method SolvePelvis addr 0x1201c1c size 0x290 virtual false final false
 void SolvePelvis() ;

/// @brief Method Write addr 0x120265c size 0x1d0 virtual true final false
 void Write(ByRef<::ArrayW<UnityEngine::Vector3>> solvedPositions, ByRef<::ArrayW<UnityEngine::Quaternion>> solvedRotations) ;

/// @brief Method ResetOffsets addr 0x120282c size 0xd4 virtual true final false
 void ResetOffsets() ;

/// @brief Method AdjustChestByHands addr 0x1200730 size 0x3f8 virtual false final false
...
/// @brief Method InverseTranslateToHead addr 0x1201944 size 0xdc virtual false final false
...
/// @brief Method TranslatePelvis addr 0x1201064 size 0x410 virtual false final false
...
/// @brief Method LimitPelvisPosition addr 0x1202900 size 0x2a8 virtual false final false
...
/// @brief Method Bend addr 0x1201a20 size 0x1fc virtual false final false
...
/// @brief Method Bend addr 0x12016d4 size 0x270 virtual false final false
...
/// @brief Method .ctor addr 0x1202d18 size 0x11c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11ffae0 size 0x70 virtual false final false
 void _ctor(UnityEngine::Vector3 position, UnityEngine::Quaternion rotation) ;

/// @brief Method Read addr 0x11ffb50 size 0x20 virtual false final false
 void Read(UnityEngine::Vector3 position, UnityEngine::Quaternion rotation) ;

/// @brief Method SwingRotation addr 0x1202e34 size 0x200 virtual false final false
...
/// @brief Method PreSolve addr 0x1203034 size 0x160 virtual false final false
static float_t PreSolve(ByRef<::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone>> bones) ;

/// @brief Method RotateAroundPoint addr 0x1202ba8 size 0x170 virtual false final false
...
/// @brief Method RotateBy addr 0x1203194 size 0x1a8 virtual false final false
...
/// @brief Method RotateBy addr 0x120333c size 0x188 virtual false final false
...
/// @brief Method RotateTo addr 0x12034c4 size 0xa4 virtual false final false
...
/// @brief Method SolveTrigonometric addr 0x1202278 size 0x3e4 virtual false final false
...
/// @brief Method GetDirectionToBendPoint addr 0x1203568 size 0x158 virtual false final false
...
/// @brief Method SolveFABRIK addr 0x1201eac size 0x3cc virtual false final false
...
/// @brief Method SolveFABRIKJoint addr 0x12036c0 size 0x114 virtual false final false
static UnityEngine::Vector3 SolveFABRIKJoint(UnityEngine::Vector3 pos1, UnityEngine::Vector3 pos2, float_t length) ;

/// @brief Method SolveCCD addr 0x12037d4 size 0x1b4 virtual false final false
...
/// @brief Method SetToReferences addr 0x11f2944 size 0x2d4 virtual false final false
 void SetToReferences(RootMotion::FinalIK::RootMotion__FinalIK__VRIK__References references) ;

/// @brief Method GuessHandOrientations addr 0x11f2d64 size 0x2f0 virtual false final false
 void GuessHandOrientations(RootMotion::FinalIK::RootMotion__FinalIK__VRIK__References references, bool onlyIfZero) ;

/// @brief Method DefaultAnimationCurves addr 0x11f2c18 size 0x14c virtual false final false
 void DefaultAnimationCurves() ;

/// @brief Method AddPositionOffset addr 0x11f3594 size 0x144 virtual false final false
...
/// @brief Method AddRotationOffset addr 0x11f36d8 size 0x40 virtual false final false
...
/// @brief Method AddRotationOffset addr 0x11f3718 size 0x124 virtual false final false
...
/// @brief Method AddPlatformMotion addr 0x11f383c size 0xd4 virtual false final false
...
/// @brief Method Reset addr 0x11f3d90 size 0x110 virtual false final false
 void Reset() ;

/// @brief Method StoreDefaultLocalState addr 0x11f46e0 size 0x154 virtual true final false
 void StoreDefaultLocalState() ;

/// @brief Method FixTransforms addr 0x11f4834 size 0x1ec virtual true final false
 void FixTransforms() ;

/// @brief Method GetPoints addr 0x11f4a20 size 0x70 virtual true final false
 ::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point> GetPoints() ;

/// @brief Method GetPoint addr 0x11f4a90 size 0x70 virtual true final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point GetPoint(UnityEngine::Transform transform) ;

/// @brief Method IsValid addr 0x11f4b00 size 0x1fc virtual true final false
 bool IsValid(ByRef<::StringW> message) ;

/// @brief Method GetNormal addr 0x11f4cfc size 0x270 virtual false final false
 UnityEngine::Vector3 GetNormal(::ArrayW<UnityEngine::Transform> transforms) ;

/// @brief Method GuessWristToPalmAxis addr 0x11f3054 size 0xe4 virtual false final false
 UnityEngine::Vector3 GuessWristToPalmAxis(UnityEngine::Transform hand, UnityEngine::Transform forearm) ;

/// @brief Method GuessPalmToThumbAxis addr 0x11f3138 size 0x348 virtual false final false
 UnityEngine::Vector3 GuessPalmToThumbAxis(UnityEngine::Transform hand, UnityEngine::Transform forearm) ;

/// @brief Method GetSineKeyframes addr 0x11f3480 size 0x114 virtual false final false
static ::ArrayW<UnityEngine::Keyframe> GetSineKeyframes(float_t mag) ;

/// @brief Method UpdateSolverTransforms addr 0x11f3ea0 size 0x150 virtual false final false
 void UpdateSolverTransforms() ;

/// @brief Method OnInitiate addr 0x11f4f6c size 0x3c virtual true final false
 void OnInitiate() ;

/// @brief Method OnUpdate addr 0x11f4fa8 size 0x408 virtual true final false
 void OnUpdate() ;

/// @brief Method WriteTransforms addr 0x11f6534 size 0x454 virtual false final false
 void WriteTransforms() ;

/// @brief Method Read addr 0x11f3ff0 size 0x50c virtual false final false
...
/// @brief Method Solve addr 0x11f53b0 size 0x1048 virtual false final false
 void Solve() ;

/// @brief Method GetPosition addr 0x11f6988 size 0x3c virtual false final false
 UnityEngine::Vector3 GetPosition(int32_t index) ;

/// @brief Method GetRotation addr 0x11f69c4 size 0x38 virtual false final false
 UnityEngine::Quaternion GetRotation(int32_t index) ;

/// @brief Method get_rootBone addr 0x11f9eec size 0x8 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone get_rootBone() ;

/// @brief Method set_rootBone addr 0x11f9ef4 size 0x8 virtual false final false
 void set_rootBone(RootMotion::FinalIK::RootMotion__FinalIK__IKSolverVR__VirtualBone value) ;

/// @brief Method Write addr 0x11f63f8 size 0x13c virtual false final false
 void Write() ;

/// @brief Method GetPelvisOffset addr 0x11f9800 size 0x6ec virtual false final false
 UnityEngine::Vector3 GetPelvisOffset() ;

// Ctor Parameters []
explicit IKSolverVR() ;

/// @brief Method .ctor addr 0x11f9efc size 0x228 virtual false final false
 void _ctor() ;
