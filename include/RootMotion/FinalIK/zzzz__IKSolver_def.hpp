...
/// @brief Method StoreDefaultLocalState addr 0x11e078c size 0x44 virtual false final false
 void StoreDefaultLocalState() ;

/// @brief Method FixTransform addr 0x11e07d0 size 0xe0 virtual false final false
 void FixTransform() ;

/// @brief Method UpdateSolverPosition addr 0x11e08b0 size 0x2c virtual false final false
 void UpdateSolverPosition() ;

/// @brief Method UpdateSolverLocalPosition addr 0x11e08dc size 0x2c virtual false final false
 void UpdateSolverLocalPosition() ;

/// @brief Method UpdateSolverState addr 0x11e0908 size 0x44 virtual false final false
 void UpdateSolverState() ;

/// @brief Method UpdateSolverLocalState addr 0x11e094c size 0x44 virtual false final false
 void UpdateSolverLocalState() ;

// Ctor Parameters []
explicit RootMotion__FinalIK__IKSolver__Point() ;

/// @brief Method .ctor addr 0x11e0990 size 0x60 virtual false final false
 void _ctor() ;
...
/// @brief Method get_rotationLimit addr 0x11e09f0 size 0xe0 virtual false final false
 RootMotion::FinalIK::RotationLimit get_rotationLimit() ;

/// @brief Method set_rotationLimit addr 0x11e0ad0 size 0x78 virtual false final false
 void set_rotationLimit(RootMotion::FinalIK::RotationLimit value) ;

/// @brief Method Swing addr 0x11e0b48 size 0x26c virtual false final false
 void Swing(UnityEngine::Vector3 swingTarget, float_t weight) ;

/// @brief Method SolverSwing addr 0x11e0db4 size 0x2bc virtual false final false
...
/// @brief Method Swing2D addr 0x11e1070 size 0x1f4 virtual false final false
 void Swing2D(UnityEngine::Vector3 swingTarget, float_t weight) ;

/// @brief Method SetToSolverPosition addr 0x11e1264 size 0x28 virtual false final false
 void SetToSolverPosition() ;

// Ctor Parameters []
explicit RootMotion__FinalIK__IKSolver__Bone() ;

/// @brief Method .ctor addr 0x11e128c size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11e12f8 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x11e1370 size 0x88 virtual false final false
...
/// @brief Method .ctor addr 0x11e13f8 size 0x4 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "transform", ty: "UnityEngine::Transform", modifiers: "", def_value: None }]
explicit RootMotion__FinalIK__IKSolver__Node(UnityEngine::Transform transform) ;

/// @brief Method .ctor addr 0x11e13fc size 0x24 virtual false final false
 void _ctor(UnityEngine::Transform transform) ;

// Ctor Parameters [CppParam { name: "transform", ty: "UnityEngine::Transform", modifiers: "", def_value: None }, CppParam { name: "weight", ty: "float_t", modifiers: "", def_value: None }]
explicit RootMotion__FinalIK__IKSolver__Node(UnityEngine::Transform transform, float_t weight) ;

/// @brief Method .ctor addr 0x11e1420 size 0x34 virtual false final false
 void _ctor(UnityEngine::Transform transform, float_t weight) ;
...
/// @brief Method .ctor addr 0x11e1454 size 0xbc virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x11e1510 size 0x14 virtual true final false
 void Invoke() ;

/// @brief Method BeginInvoke addr 0x11e1524 size 0x20 virtual true final false
 System::IAsyncResult BeginInvoke(System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType object) ;

/// @brief Method EndInvoke addr 0x11e1544 size 0xc virtual true final false
...
/// @brief Method .ctor addr 0x11e1550 size 0xc4 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x11e1614 size 0x14 virtual true final false
 void Invoke(int32_t i) ;

/// @brief Method BeginInvoke addr 0x11e1628 size 0x84 virtual true final false
 System::IAsyncResult BeginInvoke(int32_t i, System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType object) ;

/// @brief Method EndInvoke addr 0x11e16ac size 0xc virtual true final false
 void EndInvoke(System::IAsyncResult result) ;
...
/// @brief Method IsValid addr 0x11e0100 size 0x74 virtual false final false
 bool IsValid() ;

/// @brief Method IsValid addr 0x0 size 0xffffffffffffffff virtual true final false
 bool IsValid(ByRef<::StringW> message) ;

/// @brief Method Initiate addr 0x11e0174 size 0x170 virtual false final false
 void Initiate(UnityEngine::Transform root) ;

/// @brief Method Update addr 0x11e02e4 size 0x70 virtual false final false
 void Update() ;

/// @brief Method GetIKPosition addr 0x11e0354 size 0xc virtual true final false
 UnityEngine::Vector3 GetIKPosition() ;

/// @brief Method SetIKPosition addr 0x11e0360 size 0xc virtual false final false
 void SetIKPosition(UnityEngine::Vector3 position) ;

/// @brief Method GetIKPositionWeight addr 0x11e036c size 0x8 virtual false final false
 float_t GetIKPositionWeight() ;

/// @brief Method SetIKPositionWeight addr 0x11e0374 size 0x1c virtual false final false
 void SetIKPositionWeight(float_t weight) ;

/// @brief Method GetRoot addr 0x11e0390 size 0x8 virtual false final false
 UnityEngine::Transform GetRoot() ;

/// @brief Method get_initiated addr 0x11e0398 size 0x8 virtual false final false
 bool get_initiated() ;

/// @brief Method set_initiated addr 0x11e03a0 size 0xc virtual false final false
...
/// @brief Method LogWarning addr 0x11e03ac size 0x18 virtual false final false
 void LogWarning(::StringW message) ;

/// @brief Method ContainsDuplicateBone addr 0x11e03c4 size 0x124 virtual false final false
static UnityEngine::Transform ContainsDuplicateBone(::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Bone> bones) ;

/// @brief Method HierarchyIsValid addr 0x11e04e8 size 0x98 virtual false final false
static bool HierarchyIsValid(::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Bone> bones) ;

/// @brief Method PreSolveBones addr 0x11e0580 size 0x1f4 virtual false final false
static float_t PreSolveBones(ByRef<::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Bone>> bones) ;

// Ctor Parameters []
explicit IKSolver() ;

/// @brief Method .ctor addr 0x11e0774 size 0x18 virtual false final false
 void _ctor() ;
