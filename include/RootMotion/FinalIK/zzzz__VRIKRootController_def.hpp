...
/// @brief Method get_pelvisTargetRight addr 0x121e2e4 size 0xc virtual false final false
 UnityEngine::Vector3 get_pelvisTargetRight() ;

/// @brief Method set_pelvisTargetRight addr 0x121e2f0 size 0xc virtual false final false
 void set_pelvisTargetRight(UnityEngine::Vector3 value) ;

/// @brief Method Awake addr 0x121e2fc size 0xf4 virtual false final false
 void Awake() ;

/// @brief Method Calibrate addr 0x121cfc8 size 0x1c0 virtual false final false
 void Calibrate() ;

/// @brief Method Calibrate addr 0x121ddd8 size 0x158 virtual false final false
 void Calibrate(RootMotion::FinalIK::RootMotion__FinalIK__VRIKCalibrator__CalibrationData data) ;

/// @brief Method OnPreUpdate addr 0x121e3f0 size 0x3c8 virtual false final false
 void OnPreUpdate() ;

/// @brief Method OnDestroy addr 0x121e7b8 size 0x10c virtual false final false
 void OnDestroy() ;

// Ctor Parameters []
explicit VRIKRootController() ;

/// @brief Method .ctor addr 0x121e8c4 size 0x8 virtual false final false
 void _ctor() ;
