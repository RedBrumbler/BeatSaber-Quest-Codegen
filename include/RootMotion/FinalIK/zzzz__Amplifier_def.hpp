...
/// @brief Method .ctor addr 0x121555c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Update addr 0x1215204 size 0x310 virtual false final false
 void Update(RootMotion::FinalIK::IKSolverFullBodyBiped solver, float_t w, float_t deltaTime) ;

/// @brief Method Multiply addr 0x1215534 size 0x10 virtual false final false
...
/// @brief Method .ctor addr 0x1215544 size 0x18 virtual false final false
 void _ctor() ;
...
/// @brief Method OnModifyOffset addr 0x12150b4 size 0x130 virtual true final false
 void OnModifyOffset() ;

// Ctor Parameters []
explicit Amplifier() ;

/// @brief Method .ctor addr 0x1215514 size 0x10 virtual false final false
 void _ctor() ;
