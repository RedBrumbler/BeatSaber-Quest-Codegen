...
/// @brief Method Start addr 0x1215564 size 0x48 virtual true final false
 void Start() ;

/// @brief Method OnModifyOffset addr 0x12155cc size 0x1ec virtual true final false
 void OnModifyOffset() ;

// Ctor Parameters []
explicit BodyTilt() ;

/// @brief Method .ctor addr 0x121586c size 0x1c virtual false final false
 void _ctor() ;
