...
/// @brief Method IsInDirection addr 0x1214b20 size 0x4b0 virtual false final false
 bool IsInDirection(UnityEngine::Vector3 d) ;

/// @brief Method SetAngleBuffer addr 0x1215090 size 0x8 virtual false final false
 void SetAngleBuffer(float_t value) ;

// Ctor Parameters []
explicit RootMotion__FinalIK__AimPoser__Pose() ;

/// @brief Method .ctor addr 0x1215098 size 0x1c virtual false final false
 void _ctor() ;
...
/// @brief Method GetPose addr 0x1214a50 size 0xd0 virtual false final false
 RootMotion::FinalIK::RootMotion__FinalIK__AimPoser__Pose GetPose(UnityEngine::Vector3 localDirection) ;

/// @brief Method SetPoseActive addr 0x1214fd0 size 0x60 virtual false final false
 void SetPoseActive(RootMotion::FinalIK::RootMotion__FinalIK__AimPoser__Pose pose) ;

// Ctor Parameters []
explicit AimPoser() ;

/// @brief Method .ctor addr 0x1215030 size 0x60 virtual false final false
 void _ctor() ;
