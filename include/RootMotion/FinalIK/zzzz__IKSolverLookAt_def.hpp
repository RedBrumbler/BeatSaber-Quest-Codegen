...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12521))}
...
/// @brief Method .ctor addr 0x11f0d54 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11ef85c size 0x28 virtual false final false
 void _ctor(UnityEngine::Transform transform) ;

/// @brief Method Initiate addr 0x11efb0c size 0xec virtual false final false
 void Initiate(UnityEngine::Transform root) ;

/// @brief Method LookAt addr 0x11f0a44 size 0x108 virtual false final false
 void LookAt(UnityEngine::Vector3 direction, float_t weight) ;

/// @brief Method get_forward addr 0x11f06fc size 0x30 virtual false final false
...
/// @brief Method SetLookAtWeight addr 0x11eeadc size 0x1c virtual false final false
 void SetLookAtWeight(float_t weight) ;

/// @brief Method SetLookAtWeight addr 0x11eeaf8 size 0x2c virtual false final false
 void SetLookAtWeight(float_t weight, float_t bodyWeight) ;

/// @brief Method SetLookAtWeight addr 0x11eeb24 size 0x38 virtual false final false
 void SetLookAtWeight(float_t weight, float_t bodyWeight, float_t headWeight) ;

/// @brief Method SetLookAtWeight addr 0x11eeb5c size 0x48 virtual false final false
 void SetLookAtWeight(float_t weight, float_t bodyWeight, float_t headWeight, float_t eyesWeight) ;

/// @brief Method SetLookAtWeight addr 0x11eeba4 size 0x58 virtual false final false
 void SetLookAtWeight(float_t weight, float_t bodyWeight, float_t headWeight, float_t eyesWeight, float_t clampWeight) ;

/// @brief Method SetLookAtWeight addr 0x11eebfc size 0x70 virtual false final false
...
/// @brief Method StoreDefaultLocalState addr 0x11eec6c size 0x118 virtual true final false
 void StoreDefaultLocalState() ;

/// @brief Method FixTransforms addr 0x11eed84 size 0x12c virtual true final false
 void FixTransforms() ;

/// @brief Method IsValid addr 0x11eeeb0 size 0x1b0 virtual true final false
 bool IsValid(ByRef<::StringW> message) ;

/// @brief Method GetPoints addr 0x11ef2bc size 0x224 virtual true final false
 ::ArrayW<RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point> GetPoints() ;

/// @brief Method GetPoint addr 0x11ef4e0 size 0x160 virtual true final false
 RootMotion::FinalIK::RootMotion__FinalIK__IKSolver__Point GetPoint(UnityEngine::Transform transform) ;

/// @brief Method SetChain addr 0x11ef640 size 0xb0 virtual false final false
...
/// @brief Method OnInitiate addr 0x11ef884 size 0x288 virtual true final false
 void OnInitiate() ;

/// @brief Method OnUpdate addr 0x11efbf8 size 0xc4 virtual true final false
 void OnUpdate() ;

/// @brief Method get_spineIsValid addr 0x11ef060 size 0xcc virtual false final false
 bool get_spineIsValid() ;

/// @brief Method get_spineIsEmpty addr 0x11ef208 size 0x24 virtual false final false
 bool get_spineIsEmpty() ;

/// @brief Method SolveSpine addr 0x11efcbc size 0x21c virtual false final false
 void SolveSpine() ;

/// @brief Method get_headIsValid addr 0x11ef12c size 0x10 virtual false final false
 bool get_headIsValid() ;

/// @brief Method get_headIsEmpty addr 0x11ef22c size 0x6c virtual false final false
 bool get_headIsEmpty() ;

/// @brief Method SolveHead addr 0x11efed8 size 0x348 virtual false final false
 void SolveHead() ;

/// @brief Method get_eyesIsValid addr 0x11ef13c size 0xcc virtual false final false
 bool get_eyesIsValid() ;

/// @brief Method get_eyesIsEmpty addr 0x11ef298 size 0x24 virtual false final false
 bool get_eyesIsEmpty() ;

/// @brief Method SolveEyes addr 0x11f0220 size 0x4dc virtual false final false
 void SolveEyes() ;

/// @brief Method GetForwards addr 0x11f072c size 0x318 virtual false final false
...
/// @brief Method SetBones addr 0x11ef6f0 size 0x16c virtual false final false
...
/// @brief Method .ctor addr 0x11f0b4c size 0x208 virtual false final false
 void _ctor() ;
