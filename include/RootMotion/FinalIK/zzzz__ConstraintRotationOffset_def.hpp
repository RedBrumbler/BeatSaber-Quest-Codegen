...
/// @brief Method UpdateConstraint addr 0x11c5530 size 0x104 virtual true final false
 void UpdateConstraint() ;

// Ctor Parameters []
explicit ConstraintRotationOffset() ;

/// @brief Method .ctor addr 0x11c568c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x11c5694 size 0x28 virtual false final false
 void _ctor(UnityEngine::Transform transform) ;

/// @brief Method get_rotationChanged addr 0x11c5634 size 0x58 virtual false final false
