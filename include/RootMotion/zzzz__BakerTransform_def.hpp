...
/// @brief Method .ctor addr 0x11b3ce0 size 0x94 virtual false final false
 void _ctor(UnityEngine::Transform transform, UnityEngine::Transform root, bool recordPosition, bool isRootNode) ;

/// @brief Method SetRelativeSpace addr 0x11b3f54 size 0x14 virtual false final false
 void SetRelativeSpace(UnityEngine::Vector3 position, UnityEngine::Quaternion rotation) ;

/// @brief Method SetCurves addr 0x11b4230 size 0x2b4 virtual false final false
 void SetCurves(ByRef<UnityEngine::AnimationClip> clip) ;

/// @brief Method AddRootMotionCurves addr 0x11b7148 size 0x288 virtual false final false
 void AddRootMotionCurves(ByRef<UnityEngine::AnimationClip> clip) ;

/// @brief Method Reset addr 0x11b3e4c size 0x108 virtual false final false
 void Reset() ;

/// @brief Method ReduceKeyframes addr 0x11b73d0 size 0x68 virtual false final false
 void ReduceKeyframes(float_t maxError) ;

/// @brief Method SetKeyframes addr 0x11b4550 size 0x1f4 virtual false final false
 void SetKeyframes(float_t time) ;

/// @brief Method AddLoopFrame addr 0x11b3fd4 size 0x1f8 virtual false final false
