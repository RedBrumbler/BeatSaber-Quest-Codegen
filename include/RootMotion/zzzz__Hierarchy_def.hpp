...
/// @brief Method HierarchyIsValid addr 0x11bf708 size 0x84 virtual false final false
static bool HierarchyIsValid(::ArrayW<UnityEngine::Transform> bones) ;

/// @brief Method ContainsDuplicate addr 0x11bf5fc size 0x10c virtual false final false
static UnityEngine::Object ContainsDuplicate(::ArrayW<UnityEngine::Object> objects) ;

/// @brief Method IsAncestor addr 0x11bd9ec size 0x130 virtual false final false
static bool IsAncestor(UnityEngine::Transform transform, UnityEngine::Transform ancestor) ;

/// @brief Method ContainsChild addr 0x11bdffc size 0x110 virtual false final false
static bool ContainsChild(UnityEngine::Transform transform, UnityEngine::Transform child) ;

/// @brief Method AddAncestors addr 0x11bdc6c size 0x240 virtual false final false
...
/// @brief Method GetAncestor addr 0x11bf920 size 0xf4 virtual false final false
static UnityEngine::Transform GetAncestor(UnityEngine::Transform transform, int32_t minChildCount) ;

/// @brief Method GetFirstCommonAncestor addr 0x11bdb1c size 0x150 virtual false final false
static UnityEngine::Transform GetFirstCommonAncestor(UnityEngine::Transform t1, UnityEngine::Transform t2) ;

/// @brief Method GetFirstCommonAncestor addr 0x11bfa14 size 0x164 virtual false final false
static UnityEngine::Transform GetFirstCommonAncestor(::ArrayW<UnityEngine::Transform> transforms) ;

/// @brief Method GetFirstCommonAncestorRecursive addr 0x11bfd80 size 0x188 virtual false final false
...
/// @brief Method IsCommonAncestor addr 0x11bfb78 size 0x208 virtual false final false
static bool IsCommonAncestor(UnityEngine::Transform transform, ::ArrayW<UnityEngine::Transform> transforms) ;

// Ctor Parameters []
explicit Hierarchy() ;

/// @brief Method .ctor addr 0x11bff08 size 0x8 virtual false final false
 void _ctor() ;
