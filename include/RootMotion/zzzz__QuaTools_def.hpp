...
/// @brief Method RotationToLocalSpace addr 0x11c1528 size 0xa8 virtual false final false
static UnityEngine::Quaternion RotationToLocalSpace(UnityEngine::Quaternion space, UnityEngine::Quaternion rotation) ;

/// @brief Method FromToRotation addr 0x11c15d0 size 0x10c virtual false final false
static UnityEngine::Quaternion FromToRotation(UnityEngine::Quaternion from, UnityEngine::Quaternion to) ;

/// @brief Method GetAxis addr 0x11c16dc size 0x168 virtual false final false
static UnityEngine::Vector3 GetAxis(UnityEngine::Vector3 v) ;

/// @brief Method ClampRotation addr 0x11c1844 size 0x1e4 virtual false final false
static UnityEngine::Quaternion ClampRotation(UnityEngine::Quaternion rotation, float_t clampWeight, int32_t clampSmoothing) ;

/// @brief Method ClampAngle addr 0x11c1a28 size 0xd0 virtual false final false
static float_t ClampAngle(float_t angle, float_t clampWeight, int32_t clampSmoothing) ;

/// @brief Method MatchRotation addr 0x11c1af8 size 0x184 virtual false final false
...
/// @brief Method ToBiPolar addr 0x11c1c7c size 0x10c virtual false final false
static UnityEngine::Vector3 ToBiPolar(UnityEngine::Vector3 euler) ;

/// @brief Method ToBiPolar addr 0x11c1d88 size 0x58 virtual false final false
