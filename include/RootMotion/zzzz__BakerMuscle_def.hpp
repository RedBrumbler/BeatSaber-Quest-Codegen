...
/// @brief Method .ctor addr 0x11b6470 size 0x64 virtual false final false
 void _ctor(int32_t muscleIndex) ;

/// @brief Method MuscleNameToPropertyName addr 0x11b64d4 size 0xa34 virtual false final false
 ::StringW MuscleNameToPropertyName(::StringW n) ;

/// @brief Method MultiplyLength addr 0x11b6f68 size 0xa8 virtual false final false
 void MultiplyLength(UnityEngine::AnimationCurve curve, float_t mlp) ;

/// @brief Method SetCurves addr 0x11b7010 size 0xf4 virtual false final false
 void SetCurves(ByRef<UnityEngine::AnimationClip> clip, float_t maxError, float_t lengthMlp) ;

/// @brief Method Reset addr 0x11b6f08 size 0x60 virtual false final false
 void Reset() ;

/// @brief Method SetKeyframe addr 0x11b7104 size 0x3c virtual false final false
 void SetKeyframe(float_t time, ::ArrayW<float_t> muscles) ;

/// @brief Method SetLoopFrame addr 0x11b7140 size 0x8 virtual false final false
