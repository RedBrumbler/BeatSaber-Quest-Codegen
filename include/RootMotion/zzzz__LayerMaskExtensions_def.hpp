...
/// @brief Method Contains addr 0x11c0be4 size 0x4c virtual false final false
static bool Contains(UnityEngine::LayerMask mask, int32_t layer) ;

/// @brief Method Create addr 0x11c0c30 size 0x14 virtual false final false
static UnityEngine::LayerMask Create(::ArrayW<::StringW> layerNames) ;

/// @brief Method Create addr 0x11c0cec size 0x14 virtual false final false
static UnityEngine::LayerMask Create(::ArrayW<int32_t> layerNumbers) ;

/// @brief Method NamesToMask addr 0x11c0c44 size 0xa8 virtual false final false
static UnityEngine::LayerMask NamesToMask(::ArrayW<::StringW> layerNames) ;

/// @brief Method LayerNumbersToMask addr 0x11c0d00 size 0x90 virtual false final false
static UnityEngine::LayerMask LayerNumbersToMask(::ArrayW<int32_t> layerNumbers) ;

/// @brief Method Inverse addr 0x11c0d90 size 0x28 virtual false final false
static UnityEngine::LayerMask Inverse(UnityEngine::LayerMask original) ;

/// @brief Method AddToMask addr 0x11c0db8 size 0x4c virtual false final false
static UnityEngine::LayerMask AddToMask(UnityEngine::LayerMask original, ::ArrayW<::StringW> layerNames) ;

/// @brief Method RemoveFromMask addr 0x11c0e04 size 0x68 virtual false final false
static UnityEngine::LayerMask RemoveFromMask(UnityEngine::LayerMask original, ::ArrayW<::StringW> layerNames) ;

/// @brief Method MaskToNames addr 0x11c0e6c size 0x154 virtual false final false
static ::ArrayW<::StringW> MaskToNames(UnityEngine::LayerMask original) ;

/// @brief Method MaskToNumbers addr 0x11c0fc0 size 0x138 virtual false final false
static ::ArrayW<int32_t> MaskToNumbers(UnityEngine::LayerMask original) ;

/// @brief Method MaskToString addr 0x11c10f8 size 0x58 virtual false final false
static ::StringW MaskToString(UnityEngine::LayerMask original) ;

/// @brief Method MaskToString addr 0x11c1150 size 0x24 virtual false final false
