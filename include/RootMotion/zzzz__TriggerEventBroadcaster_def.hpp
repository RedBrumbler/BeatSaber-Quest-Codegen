...
/// @brief Method OnTriggerEnter addr 0x11c2334 size 0xb4 virtual false final false
 void OnTriggerEnter(UnityEngine::Collider collider) ;

/// @brief Method OnTriggerStay addr 0x11c23e8 size 0xb4 virtual false final false
 void OnTriggerStay(UnityEngine::Collider collider) ;

/// @brief Method OnTriggerExit addr 0x11c249c size 0xb4 virtual false final false
 void OnTriggerExit(UnityEngine::Collider collider) ;

// Ctor Parameters []
explicit TriggerEventBroadcaster() ;

/// @brief Method .ctor addr 0x11c2550 size 0x8 virtual false final false
 void _ctor() ;
