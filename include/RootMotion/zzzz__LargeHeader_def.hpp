...
explicit LargeHeader(::StringW name) ;

/// @brief Method .ctor addr 0x11c0b14 size 0x68 virtual false final false
...
explicit LargeHeader(::StringW name, ::StringW color) ;

/// @brief Method .ctor addr 0x11c0b7c size 0x68 virtual false final false
