...
/// @brief Method Awake addr 0x11b7438 size 0x4b8 virtual false final false
 void Awake() ;

/// @brief Method GetCharacterRoot addr 0x11b78f0 size 0x1c virtual true final false
 UnityEngine::Transform GetCharacterRoot() ;

/// @brief Method OnStartBaking addr 0x11b790c size 0xdc virtual true final false
 void OnStartBaking() ;

/// @brief Method OnSetLoopFrame addr 0x11b79e8 size 0xbc virtual true final false
 void OnSetLoopFrame(float_t time) ;

/// @brief Method OnSetCurves addr 0x11b7aa4 size 0x1a0 virtual true final false
 void OnSetCurves(ByRef<UnityEngine::AnimationClip> clip) ;

/// @brief Method OnSetKeyframes addr 0x11b7c44 size 0x2a4 virtual true final false
 void OnSetKeyframes(float_t time, bool lastFrame) ;

/// @brief Method UpdateHumanPose addr 0x11b7ee8 size 0xd8 virtual false final false
 void UpdateHumanPose() ;

// Ctor Parameters []
explicit HumanoidBaker() ;

/// @brief Method .ctor addr 0x11b7fc0 size 0xa4 virtual false final false
 void _ctor() ;
