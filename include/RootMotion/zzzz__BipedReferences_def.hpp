...
/// @brief Method .ctor addr 0x11bf7f4 size 0x14 virtual false final false
 void _ctor(bool legsParentInSpine, bool includeEyes) ;

/// @brief Method get_Default addr 0x11bf808 size 0x8 virtual false final false
...
/// @brief Method get_isFilled addr 0x11bbeec size 0x35c virtual true final false
 bool get_isFilled() ;

/// @brief Method get_isEmpty addr 0x11bc248 size 0x10 virtual false final false
 bool get_isEmpty() ;

/// @brief Method IsEmpty addr 0x11bc258 size 0x38c virtual true final false
 bool IsEmpty(bool includeRoot) ;

/// @brief Method Contains addr 0x11bc5e4 size 0x390 virtual true final false
 bool Contains(UnityEngine::Transform t, bool ignoreRoot) ;

/// @brief Method AutoDetectReferences addr 0x11bc974 size 0x1f8 virtual false final false
...
/// @brief Method DetectReferencesByNaming addr 0x11bcf98 size 0x748 virtual false final false
...
/// @brief Method AssignHumanoidReferences addr 0x11bcbd4 size 0x3c4 virtual false final false
...
/// @brief Method SetupError addr 0x11bd794 size 0xe0 virtual false final false
static bool SetupError(RootMotion::BipedReferences references, ByRef<::StringW> errorMessage) ;

/// @brief Method SetupWarning addr 0x11bd874 size 0x9c virtual false final false
static bool SetupWarning(RootMotion::BipedReferences references, ByRef<::StringW> warningMessage) ;

/// @brief Method IsNeckBone addr 0x11be2ec size 0xe0 virtual false final false
static bool IsNeckBone(UnityEngine::Transform bone, UnityEngine::Transform leftUpperArm) ;

/// @brief Method AddBoneToEyes addr 0x11be10c size 0xf4 virtual false final false
...
/// @brief Method AddBoneToSpine addr 0x11bdeac size 0x150 virtual false final false
...
/// @brief Method DetectLimb addr 0x11bd910 size 0xdc virtual false final false
...
/// @brief Method AddBoneToHierarchy addr 0x11be200 size 0xec virtual false final false
static void AddBoneToHierarchy(ByRef<::ArrayW<UnityEngine::Transform>> bones, UnityEngine::Transform transform) ;

/// @brief Method LimbError addr 0x11be3cc size 0x580 virtual false final false
...
/// @brief Method LimbWarning addr 0x11bee8c size 0x2d4 virtual false final false
...
/// @brief Method .ctor addr 0x11bcb6c size 0x68 virtual false final false
 void _ctor() ;
