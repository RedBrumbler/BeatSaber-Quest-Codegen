...
/// @brief Method .ctor addr 0x11b5828 size 0x178 virtual false final false
...
/// @brief Method .ctor addr 0x11b5ae4 size 0x188 virtual false final false
 void _ctor(UnityEngine::Transform transform, UnityEngine::AvatarIKGoal goal, ::StringW name) ;

/// @brief Method Reset addr 0x11b59a0 size 0x144 virtual false final false
 void Reset() ;

/// @brief Method SetIKKeyframes addr 0x11b5c6c size 0x234 virtual false final false
...
/// @brief Method SetKeyframes addr 0x11b5ea0 size 0xf0 virtual false final false
 void SetKeyframes(float_t time, UnityEngine::Vector3 pos, UnityEngine::Quaternion rot) ;

/// @brief Method MoveLastKeyframes addr 0x11b5f90 size 0x68 virtual false final false
 void MoveLastKeyframes(float_t time) ;

/// @brief Method SetLoopFrame addr 0x11b6074 size 0x68 virtual false final false
 void SetLoopFrame(float_t time) ;

/// @brief Method MoveLastKeyframe addr 0x11b5ff8 size 0x7c virtual false final false
 void MoveLastKeyframe(float_t time, UnityEngine::AnimationCurve curve) ;

/// @brief Method MultiplyLength addr 0x11b60dc size 0xa8 virtual false final false
 void MultiplyLength(UnityEngine::AnimationCurve curve, float_t mlp) ;

/// @brief Method SetCurves addr 0x11b6184 size 0x2ec virtual false final false
