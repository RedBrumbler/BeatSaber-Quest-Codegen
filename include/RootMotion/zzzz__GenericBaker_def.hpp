...
namespace RootMotion {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12432))}
...
/// @brief Method Awake addr 0x11b3958 size 0x218 virtual false final false
 void Awake() ;

/// @brief Method GetCharacterRoot addr 0x11b3d74 size 0x8 virtual true final false
 UnityEngine::Transform GetCharacterRoot() ;

/// @brief Method OnStartBaking addr 0x11b3d7c size 0xd0 virtual true final false
 void OnStartBaking() ;

/// @brief Method OnSetLoopFrame addr 0x11b3f68 size 0x6c virtual true final false
 void OnSetLoopFrame(float_t time) ;

/// @brief Method OnSetCurves addr 0x11b41cc size 0x64 virtual true final false
 void OnSetCurves(ByRef<UnityEngine::AnimationClip> clip) ;

/// @brief Method OnSetKeyframes addr 0x11b44e4 size 0x6c virtual true final false
 void OnSetKeyframes(float_t time, bool lastFrame) ;

/// @brief Method IsIgnored addr 0x11b3b70 size 0xb8 virtual false final false
 bool IsIgnored(UnityEngine::Transform t) ;

/// @brief Method BakePosition addr 0x11b3c28 size 0xb8 virtual false final false
 bool BakePosition(UnityEngine::Transform t) ;

// Ctor Parameters []
explicit GenericBaker() ;

/// @brief Method .ctor addr 0x11b4744 size 0x5c virtual false final false
 void _ctor() ;
