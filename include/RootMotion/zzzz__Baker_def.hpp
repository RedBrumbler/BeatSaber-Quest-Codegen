...
/// @brief Method OpenUserManual addr 0x11b3710 size 0x44 virtual false final false
 void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x11b3754 size 0x44 virtual false final false
 void OpenScriptReference() ;

/// @brief Method SupportGroup addr 0x11b3798 size 0x44 virtual false final false
 void SupportGroup() ;

/// @brief Method ASThread addr 0x11b37dc size 0x44 virtual false final false
 void ASThread() ;

/// @brief Method get_isBaking addr 0x11b3820 size 0x8 virtual false final false
 bool get_isBaking() ;

/// @brief Method set_isBaking addr 0x11b3828 size 0xc virtual false final false
 void set_isBaking(bool value) ;

/// @brief Method get_bakingProgress addr 0x11b3834 size 0x8 virtual false final false
 float_t get_bakingProgress() ;

/// @brief Method set_bakingProgress addr 0x11b383c size 0x8 virtual false final false
...
/// @brief Method get_clipLength addr 0x11b3844 size 0x8 virtual false final false
 float_t get_clipLength() ;

/// @brief Method set_clipLength addr 0x11b384c size 0x8 virtual false final false
 void set_clipLength(float_t value) ;

/// @brief Method BakeClip addr 0x11b3854 size 0x4 virtual false final false
 void BakeClip() ;

/// @brief Method StartBaking addr 0x11b3858 size 0x4 virtual false final false
 void StartBaking() ;

/// @brief Method StopBaking addr 0x11b385c size 0x4 virtual false final false
 void StopBaking() ;

// Ctor Parameters []
explicit Baker() ;

/// @brief Method .ctor addr 0x11b3860 size 0xf8 virtual false final false
 void _ctor() ;
