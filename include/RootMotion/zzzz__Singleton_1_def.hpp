...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12459)), TypeDefinitionIndex(TypeDefinitionIndex(10185))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12459), inst: 2 })
