...
/// @brief Method get_normalizedDeltaPosition addr 0x11c35ec size 0xc virtual false final false
 UnityEngine::Vector3 get_normalizedDeltaPosition() ;

/// @brief Method set_normalizedDeltaPosition addr 0x11c35f8 size 0xc virtual false final false
 void set_normalizedDeltaPosition(UnityEngine::Vector3 value) ;

/// @brief Method get_state addr 0x11c3604 size 0x8 virtual false final false
 RootMotion::Demos::RootMotion__Demos__Navigator__State get_state() ;

/// @brief Method set_state addr 0x11c360c size 0x8 virtual false final false
 void set_state(RootMotion::Demos::RootMotion__Demos__Navigator__State value) ;

/// @brief Method Initiate addr 0x11c3614 size 0xb4 virtual false final false
 void Initiate(UnityEngine::Transform transform) ;

/// @brief Method Update addr 0x11c36c8 size 0x444 virtual false final false
 void Update(UnityEngine::Vector3 targetPosition) ;

/// @brief Method CalculatePath addr 0x11c3be4 size 0x64 virtual false final false
 void CalculatePath(UnityEngine::Vector3 targetPosition) ;

/// @brief Method Find addr 0x11c3c48 size 0x134 virtual false final false
 bool Find(UnityEngine::Vector3 targetPosition) ;

/// @brief Method Stop addr 0x11c3b0c size 0x5c virtual false final false
 void Stop() ;

/// @brief Method HorDistance addr 0x11c3b68 size 0x7c virtual false final false
 float_t HorDistance(UnityEngine::Vector3 p1, UnityEngine::Vector3 p2) ;

/// @brief Method Visualize addr 0x11c3d7c size 0x1c4 virtual false final false
 void Visualize() ;

// Ctor Parameters []
explicit Navigator() ;

/// @brief Method .ctor addr 0x11c3f40 size 0x64 virtual false final false
 void _ctor() ;
