...
/// @brief Method ReduceKeyframes addr 0x11b50b4 size 0x38 virtual false final false
static void ReduceKeyframes(UnityEngine::AnimationCurve curve, float_t maxError) ;

/// @brief Method GetReducedKeyframes addr 0x11b50ec size 0x3c4 virtual false final false
static ::ArrayW<UnityEngine::Keyframe> GetReducedKeyframes(UnityEngine::AnimationCurve curve, float_t maxError) ;

/// @brief Method SetLoopFrame addr 0x11b54b0 size 0x1e0 virtual false final false
static void SetLoopFrame(float_t time, UnityEngine::AnimationCurve curve) ;

/// @brief Method SetTangentMode addr 0x11b5690 size 0x4 virtual false final false
static void SetTangentMode(UnityEngine::AnimationCurve curve) ;

/// @brief Method EnsureQuaternionContinuity addr 0x11b5694 size 0x194 virtual false final false
