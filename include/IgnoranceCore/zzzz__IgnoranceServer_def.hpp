...
/// @brief Method get_IsAlive addr 0x20bb568 size 0x14 virtual false final false
 bool get_IsAlive() ;

/// @brief Method Start addr 0x20bb57c size 0x3b8 virtual false final false
 void Start() ;

/// @brief Method Stop addr 0x20bbb78 size 0x9c virtual false final false
 void Stop() ;

/// @brief Method ThreadWorker addr 0x20bbc14 size 0x1180 virtual false final false
 void ThreadWorker(::bs_hook::Il2CppWrapperType parameters) ;

/// @brief Method SetupRingBuffersIfNull addr 0x20bb934 size 0x244 virtual false final false
 void SetupRingBuffersIfNull() ;

// Ctor Parameters []
explicit IgnoranceServer() ;

/// @brief Method .ctor addr 0x20bcd94 size 0xbc virtual false final false
 void _ctor() ;
