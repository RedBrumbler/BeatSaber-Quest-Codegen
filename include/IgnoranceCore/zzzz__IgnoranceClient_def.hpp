...
/// @brief Method get_IsAlive addr 0x20ba008 size 0x14 virtual false final false
 bool get_IsAlive() ;

/// @brief Method Start addr 0x20ba01c size 0x370 virtual false final false
 void Start() ;

/// @brief Method Stop addr 0x20ba5d0 size 0x90 virtual false final false
 void Stop() ;

/// @brief Method ThreadWorker addr 0x20ba660 size 0xe90 virtual false final false
 void ThreadWorker(::bs_hook::Il2CppWrapperType parameters) ;

/// @brief Method SetupRingBuffersIfNull addr 0x20ba38c size 0x244 virtual false final false
 void SetupRingBuffersIfNull() ;

// Ctor Parameters []
explicit IgnoranceClient() ;

/// @brief Method .ctor addr 0x20bb4f0 size 0x78 virtual false final false
 void _ctor() ;
