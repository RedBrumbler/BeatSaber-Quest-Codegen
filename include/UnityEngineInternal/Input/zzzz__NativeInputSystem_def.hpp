...
/// @brief Method get_onDeviceDiscovered addr 0x2bc9cfc size 0x58 virtual false final false
static System::Action_2<int32_t,::StringW> get_onDeviceDiscovered() ;

/// @brief Method set_onDeviceDiscovered addr 0x2bc9d54 size 0x84 virtual false final false
static void set_onDeviceDiscovered(System::Action_2<int32_t,::StringW> value) ;

/// @brief Method NotifyBeforeUpdate addr 0x2bc9e44 size 0x7c virtual false final false
static void NotifyBeforeUpdate(UnityEngineInternal::Input::NativeInputUpdateType updateType) ;

/// @brief Method NotifyUpdate addr 0x2bc9ec0 size 0x9c virtual false final false
static void NotifyUpdate(UnityEngineInternal::Input::NativeInputUpdateType updateType, ::cordl_internals::intptr_t eventBuffer) ;

/// @brief Method NotifyDeviceDiscovered addr 0x2bc9f5c size 0x90 virtual false final false
static void NotifyDeviceDiscovered(int32_t deviceId, ::StringW deviceDescriptor) ;

/// @brief Method ShouldRunUpdate addr 0x2bc9fec size 0x90 virtual false final false
static void ShouldRunUpdate(UnityEngineInternal::Input::NativeInputUpdateType updateType, ByRef<bool> retval) ;

/// @brief Method set_hasDeviceDiscoveredCallback addr 0x2bc9dd8 size 0x3c virtual false final false
static void set_hasDeviceDiscoveredCallback(bool value) ;

/// @brief Method get_currentTime addr 0x2bca07c size 0x28 virtual false final false
static double_t get_currentTime() ;

/// @brief Method get_currentTimeOffsetToRealtimeSinceStartup addr 0x2bca0a4 size 0x28 virtual false final false
static double_t get_currentTimeOffsetToRealtimeSinceStartup() ;

/// @brief Method AllocateDeviceId addr 0x2bca0cc size 0x28 virtual false final false
static int32_t AllocateDeviceId() ;

/// @brief Method QueueInputEvent addr 0x2bca0f4 size 0x3c virtual false final false
static void QueueInputEvent(::cordl_internals::intptr_t inputEvent) ;

/// @brief Method IOCTL addr 0x2bca130 size 0x5c virtual false final false
static int64_t IOCTL(int32_t deviceId, int32_t code, ::cordl_internals::intptr_t data, int32_t sizeInBytes) ;

/// @brief Method SetPollingFrequency addr 0x2bca18c size 0x38 virtual false final false
static void SetPollingFrequency(float_t hertz) ;

/// @brief Method Update addr 0x2bca1c4 size 0x103c virtual false final false
