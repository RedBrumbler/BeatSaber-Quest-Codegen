...
/// @brief Method RedirectTo addr 0x2d65ef8 size 0xf4 virtual false final false
static ::StringW RedirectTo(::StringW baseUri, ::StringW redirectUri) ;

/// @brief Method MakeInitialUrl addr 0x2d65fec size 0x398 virtual false final false
static ::StringW MakeInitialUrl(::StringW targetUrl, ::StringW localUrl) ;

/// @brief Method MakeUriString addr 0x2d66384 size 0x3f4 virtual false final false
static ::StringW MakeUriString(System::Uri targetUri, ::StringW targetUrl, bool prependProtocol) ;

/// @brief Method URLDecode addr 0x2d66778 size 0xa4 virtual false final false
