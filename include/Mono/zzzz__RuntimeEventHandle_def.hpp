...
/// @brief Method .ctor addr 0x22deff0 size 0x8 virtual false final false
 void _ctor(::cordl_internals::intptr_t v) ;

/// @brief Method get_Value addr 0x22deff8 size 0x8 virtual false final false
 ::cordl_internals::intptr_t get_Value() ;

/// @brief Method Equals addr 0x22df000 size 0x10c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x22df10c size 0x8 virtual true final false
 int32_t GetHashCode() ;
