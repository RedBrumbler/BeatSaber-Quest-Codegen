...
/// @brief Method get_Length addr 0x22e18b8 size 0x48 virtual true final true
 int32_t get_Length() ;

/// @brief Method GetName addr 0x22e1900 size 0x58 virtual true final true
 ::StringW GetName(int32_t i) ;

/// @brief Method GetValue addr 0x22e1958 size 0x58 virtual true final true
 ::StringW GetValue(int32_t i) ;

/// @brief Method GetValue addr 0x22e19b0 size 0xc0 virtual true final true
 ::StringW GetValue(::StringW name) ;

/// @brief Method get_Names addr 0x22e1a70 size 0x50 virtual true final true
 ::ArrayW<::StringW> get_Names() ;

/// @brief Method get_Values addr 0x22e1ac0 size 0x50 virtual true final true
 ::ArrayW<::StringW> get_Values() ;

/// @brief Method Clear addr 0x22e125c size 0x9c virtual false final false
 void Clear() ;

/// @brief Method Add addr 0x22e17a4 size 0x114 virtual false final false
 void Add(::StringW name, ::StringW value) ;

// Ctor Parameters []
explicit Mono__Xml__SmallXmlParser__AttrListImpl() ;

/// @brief Method .ctor addr 0x22dfee4 size 0xa0 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x22df7dc size 0x118 virtual false final false
 void _ctor() ;

/// @brief Method Error addr 0x22dff84 size 0x78 virtual false final false
 System::Exception Error(::StringW msg) ;

/// @brief Method UnexpectedEndError addr 0x22e00c8 size 0xec virtual false final false
 System::Exception UnexpectedEndError() ;

/// @brief Method IsNameChar addr 0x22e01b4 size 0xfc virtual false final false
 bool IsNameChar(char16_t c, bool start) ;

/// @brief Method IsWhitespace addr 0x22e02b0 size 0x30 virtual false final false
 bool IsWhitespace(int32_t c) ;

/// @brief Method SkipWhitespaces addr 0x22e02e0 size 0x8 virtual false final false
 void SkipWhitespaces() ;

/// @brief Method HandleWhitespaces addr 0x22e0394 size 0xc0 virtual false final false
 void HandleWhitespaces() ;

/// @brief Method SkipWhitespaces addr 0x22e02e8 size 0xac virtual false final false
 void SkipWhitespaces(bool expected) ;

/// @brief Method Peek addr 0x22e04bc size 0x20 virtual false final false
 int32_t Peek() ;

/// @brief Method Read addr 0x22e0454 size 0x68 virtual false final false
 int32_t Read() ;

/// @brief Method Expect addr 0x22e04dc size 0xc0 virtual false final false
 void Expect(int32_t c) ;

/// @brief Method ReadUntil addr 0x22e059c size 0xdc virtual false final false
 ::StringW ReadUntil(char16_t until, bool handleReferences) ;

/// @brief Method ReadName addr 0x22e0840 size 0x1a4 virtual false final false
 ::StringW ReadName() ;

/// @brief Method Parse addr 0x22df980 size 0x1c8 virtual false final false
 void Parse(System::IO::TextReader input, Mono::Xml::Mono__Xml__SmallXmlParser__IContentHandler handler) ;

/// @brief Method Cleanup addr 0x22e11e0 size 0x7c virtual false final false
 void Cleanup() ;

/// @brief Method ReadContent addr 0x22e09e4 size 0x6c4 virtual false final false
 void ReadContent() ;

/// @brief Method HandleBufferedContent addr 0x22e10a8 size 0x138 virtual false final false
 void HandleBufferedContent() ;

/// @brief Method ReadCharacters addr 0x22e15e4 size 0x88 virtual false final false
 void ReadCharacters() ;

/// @brief Method ReadReference addr 0x22e0678 size 0x1c8 virtual false final false
 void ReadReference() ;

/// @brief Method ReadCharacterReference addr 0x22e166c size 0x138 virtual false final false
 int32_t ReadCharacterReference() ;

/// @brief Method ReadAttribute addr 0x22e1480 size 0x164 virtual false final false
 void ReadAttribute(Mono::Xml::Mono__Xml__SmallXmlParser__AttrListImpl a) ;

/// @brief Method ReadCDATASection addr 0x22e12f8 size 0x100 virtual false final false
 void ReadCDATASection() ;

/// @brief Method ReadComment addr 0x22e13f8 size 0x88 virtual false final false
 void ReadComment() ;
