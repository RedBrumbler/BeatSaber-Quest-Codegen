...
/// @brief Method .ctor addr 0x22df774 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method LoadXml addr 0x22df8f4 size 0x8c virtual false final false
 void LoadXml(::StringW xml) ;

/// @brief Method ToXml addr 0x22dfb48 size 0x8 virtual false final false
 System::Security::SecurityElement ToXml() ;

/// @brief Method OnStartParsing addr 0x22dfb50 size 0x4 virtual true final true
 void OnStartParsing(Mono::Xml::SmallXmlParser parser) ;

/// @brief Method OnProcessingInstruction addr 0x22dfb54 size 0x4 virtual true final true
 void OnProcessingInstruction(::StringW name, ::StringW text) ;

/// @brief Method OnIgnorableWhitespace addr 0x22dfb58 size 0x4 virtual true final true
 void OnIgnorableWhitespace(::StringW s) ;

/// @brief Method OnStartElement addr 0x22dfb5c size 0x27c virtual true final true
 void OnStartElement(::StringW name, Mono::Xml::Mono__Xml__SmallXmlParser__IAttrList attrs) ;

/// @brief Method OnEndElement addr 0x22dfdd8 size 0x88 virtual true final true
 void OnEndElement(::StringW name) ;

/// @brief Method OnChars addr 0x22dfe60 size 0x80 virtual true final true
 void OnChars(::StringW ch) ;

/// @brief Method OnEndParsing addr 0x22dfee0 size 0x4 virtual true final true
