...
namespace Mono {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7624))}
...
/// @brief Method Import addr 0x26b6720 size 0x4 virtual true final false
 System::Security::Cryptography::X509Certificates::X509CertificateImpl Import(::ArrayW<uint8_t> data) ;

/// @brief Method Import addr 0x26b6724 size 0x4 virtual true final false
...
/// @brief Method Import addr 0x26b6728 size 0x8 virtual true final false
...
/// @brief Method .ctor addr 0x26b5cc0 size 0x58 virtual false final false
 void _ctor() ;
