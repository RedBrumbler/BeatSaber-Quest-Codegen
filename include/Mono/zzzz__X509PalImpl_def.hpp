...
/// @brief Method PEM addr 0x26b6738 size 0x134 virtual false final false
static ::ArrayW<uint8_t> PEM(::StringW type, ::ArrayW<uint8_t> data) ;

/// @brief Method ConvertData addr 0x26b686c size 0x10c virtual false final false
static ::ArrayW<uint8_t> ConvertData(::ArrayW<uint8_t> data) ;

/// @brief Method ImportFallback addr 0x26b5f34 size 0x1fc virtual false final false
 System::Security::Cryptography::X509Certificates::X509Certificate2Impl ImportFallback(::ArrayW<uint8_t> data) ;

/// @brief Method ImportFallback addr 0x26b61c4 size 0x7c virtual false final false
...
/// @brief Method get_SupportsLegacyBasicConstraintsExtension addr 0x26b6978 size 0x8 virtual false final false
 bool get_SupportsLegacyBasicConstraintsExtension() ;

/// @brief Method GetCertContentType addr 0x26b6980 size 0x40c virtual false final false
...
/// @brief Method .ctor addr 0x26b6730 size 0x8 virtual false final false
 void _ctor() ;
