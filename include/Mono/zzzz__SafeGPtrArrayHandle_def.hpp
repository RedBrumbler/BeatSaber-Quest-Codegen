...
/// @brief Method .ctor addr 0x22df604 size 0x20 virtual false final false
 void _ctor(::cordl_internals::intptr_t ptr) ;

/// @brief Method Dispose addr 0x22df624 size 0x1c virtual true final true
 void Dispose() ;

/// @brief Method get_Length addr 0x22df640 size 0x1c virtual false final false
 int32_t get_Length() ;

/// @brief Method get_Item addr 0x22df65c size 0x4 virtual false final false
