...
/// @brief Method StringToUtf8_icall addr 0x22df660 size 0x4 virtual false final false
static ::cordl_internals::intptr_t StringToUtf8_icall(ByRef<::StringW> str) ;

/// @brief Method StringToUtf8 addr 0x22df664 size 0x18 virtual false final false
static ::cordl_internals::intptr_t StringToUtf8(::StringW str) ;

/// @brief Method GFree addr 0x22df67c size 0x4 virtual false final false
static void GFree(::cordl_internals::intptr_t ptr) ;

/// @brief Method .ctor addr 0x22df438 size 0x60 virtual false final false
 void _ctor(::StringW str) ;

/// @brief Method get_Value addr 0x22df680 size 0x80 virtual false final false
 ::cordl_internals::intptr_t get_Value() ;

/// @brief Method Dispose addr 0x22df700 size 0x74 virtual true final true
 void Dispose() ;
