...
/// @brief Method .ctor addr 0x22df238 size 0x20 virtual false final false
 void _ctor(::cordl_internals::intptr_t ptr) ;

/// @brief Method get_Length addr 0x22df258 size 0x1c virtual false final false
 int32_t get_Length() ;

/// @brief Method get_Item addr 0x22df274 size 0x4 virtual false final false
 ::cordl_internals::intptr_t get_Item(int32_t i) ;

/// @brief Method Lookup addr 0x22df278 size 0x6c virtual false final false
 ::cordl_internals::intptr_t Lookup(int32_t i) ;

/// @brief Method GPtrArrayFree addr 0x22df2e4 size 0x4 virtual false final false
static void GPtrArrayFree(void* value) ;

/// @brief Method DestroyAndFree addr 0x22df2e8 size 0x1c virtual false final false
