...
/// @brief Method MoveNext addr 0x26bded8 size 0x358 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x26be270 size 0x58 virtual true final true
...
/// @brief Method MoveNext addr 0x26be2c8 size 0x494 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x26be9d4 size 0xc virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method MoveNext addr 0x26be9e0 size 0x350 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x26bee4c size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method get_Parent addr 0x26bda08 size 0x8 virtual false final false
 Mono::Net::Security::MobileAuthenticatedStream get_Parent() ;

/// @brief Method get_RunSynchronously addr 0x26bda10 size 0x8 virtual false final false
 bool get_RunSynchronously() ;

/// @brief Method get_Name addr 0x26bda18 size 0x24 virtual false final false
 ::StringW get_Name() ;

/// @brief Method get_UserResult addr 0x26bda3c size 0x8 virtual false final false
 int32_t get_UserResult() ;

/// @brief Method set_UserResult addr 0x26bda44 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x26bda4c size 0x88 virtual false final false
 void _ctor(Mono::Net::Security::MobileAuthenticatedStream parent, bool sync) ;

/// @brief Method RequestRead addr 0x26bdad4 size 0xc4 virtual false final false
 void RequestRead(int32_t size) ;

/// @brief Method RequestWrite addr 0x26bdb98 size 0xc virtual false final false
 void RequestWrite() ;

/// @brief Method StartOperation addr 0x26bdba4 size 0xf8 virtual false final false
...
/// @brief Method ProcessOperation addr 0x26bdc9c size 0xe0 virtual false final false
 System::Threading::Tasks::Task ProcessOperation(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method InnerRead addr 0x26bdd7c size 0x104 virtual false final false
...
/// @brief Method ToString addr 0x26bde80 size 0x58 virtual true final false
 ::StringW ToString() ;
