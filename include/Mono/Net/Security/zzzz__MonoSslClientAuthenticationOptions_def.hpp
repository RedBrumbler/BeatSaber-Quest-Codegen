...
/// @brief Method get_Options addr 0x26c37d8 size 0x8 virtual false final false
 System::Net::Security::SslClientAuthenticationOptions get_Options() ;

/// @brief Method get_ServerMode addr 0x26c37e0 size 0x8 virtual true final false
 bool get_ServerMode() ;

// Ctor Parameters []
explicit MonoSslClientAuthenticationOptions() ;

/// @brief Method .ctor addr 0x26c0b54 size 0x6c virtual false final false
 void _ctor() ;

/// @brief Method set_CertificateRevocationCheckMode addr 0x26c37e8 size 0x1c virtual true final false
 void set_CertificateRevocationCheckMode(System::Security::Cryptography::X509Certificates::X509RevocationMode value) ;

/// @brief Method set_EncryptionPolicy addr 0x26c3804 size 0x1c virtual true final false
 void set_EncryptionPolicy(System::Net::Security::EncryptionPolicy value) ;

/// @brief Method get_EnabledSslProtocols addr 0x26c3820 size 0x1c virtual true final false
 System::Security::Authentication::SslProtocols get_EnabledSslProtocols() ;

/// @brief Method set_EnabledSslProtocols addr 0x26c383c size 0x1c virtual true final false
 void set_EnabledSslProtocols(System::Security::Authentication::SslProtocols value) ;

/// @brief Method get_TargetHost addr 0x26c3858 size 0x1c virtual true final false
 ::StringW get_TargetHost() ;

/// @brief Method set_TargetHost addr 0x26c3874 size 0x1c virtual true final false
 void set_TargetHost(::StringW value) ;

/// @brief Method get_ClientCertificateRequired addr 0x26c3890 size 0x40 virtual true final false
 bool get_ClientCertificateRequired() ;

/// @brief Method set_ClientCertificateRequired addr 0x26c38d0 size 0x40 virtual true final false
 void set_ClientCertificateRequired(bool value) ;

/// @brief Method get_ClientCertificates addr 0x26c3910 size 0x1c virtual true final false
 System::Security::Cryptography::X509Certificates::X509CertificateCollection get_ClientCertificates() ;

/// @brief Method set_ClientCertificates addr 0x26c392c size 0x1c virtual true final false
 void set_ClientCertificates(System::Security::Cryptography::X509Certificates::X509CertificateCollection value) ;

/// @brief Method get_ServerCertificate addr 0x26c3948 size 0x40 virtual true final false
 System::Security::Cryptography::X509Certificates::X509Certificate get_ServerCertificate() ;

/// @brief Method set_ServerCertificate addr 0x26c3988 size 0x40 virtual true final false
