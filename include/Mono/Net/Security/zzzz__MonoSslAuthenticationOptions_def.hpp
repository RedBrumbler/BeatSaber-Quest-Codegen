...
/// @brief Method get_ServerCertSelectionDelegate addr 0x26c37c8 size 0x8 virtual false final false
 System::Net::Security::ServerCertSelectionCallback get_ServerCertSelectionDelegate() ;

// Ctor Parameters []
explicit MonoSslAuthenticationOptions() ;

/// @brief Method .ctor addr 0x26c37d0 size 0x8 virtual false final false
 void _ctor() ;
