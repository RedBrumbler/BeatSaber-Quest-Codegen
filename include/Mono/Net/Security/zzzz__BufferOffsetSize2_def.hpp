...
namespace Mono::Net::Security {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7685))}
...
/// @brief Method .ctor addr 0x26bd7c8 size 0x70 virtual false final false
 void _ctor(int32_t size) ;

/// @brief Method Reset addr 0x26bd838 size 0x5c virtual false final false
 void Reset() ;

/// @brief Method MakeRoom addr 0x26bd894 size 0xb4 virtual false final false
 void MakeRoom(int32_t size) ;

/// @brief Method AppendData addr 0x26bd948 size 0x60 virtual false final false
