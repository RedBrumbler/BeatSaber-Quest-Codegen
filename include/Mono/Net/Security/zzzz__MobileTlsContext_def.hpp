...
/// @brief Method .ctor addr 0x26b9f8c size 0x140 virtual false final false
 void _ctor(Mono::Net::Security::MobileAuthenticatedStream parent, Mono::Net::Security::MonoSslAuthenticationOptions options) ;

/// @brief Method get_Parent addr 0x26c36e0 size 0x8 virtual false final false
 Mono::Net::Security::MobileAuthenticatedStream get_Parent() ;

/// @brief Method get_Settings addr 0x26ba91c size 0x1c virtual false final false
...
/// @brief Method get_IsServer addr 0x26c36e8 size 0x8 virtual false final false
 bool get_IsServer() ;

/// @brief Method get_TargetHost addr 0x26c36f0 size 0x8 virtual false final false
 ::StringW get_TargetHost() ;

/// @brief Method get_ServerName addr 0x26c36f8 size 0x8 virtual false final false
 ::StringW get_ServerName() ;

/// @brief Method get_AskForClientCertificate addr 0x26c3700 size 0x8 virtual false final false
 bool get_AskForClientCertificate() ;

/// @brief Method get_ClientCertificates addr 0x26c3708 size 0x8 virtual false final false
...
/// @brief Method get_LocalServerCertificate addr 0x26c3710 size 0x8 virtual false final false
 System::Security::Cryptography::X509Certificates::X509Certificate get_LocalServerCertificate() ;

/// @brief Method set_LocalServerCertificate addr 0x26c3718 size 0x8 virtual false final false
...
/// @brief Method ValidateCertificate addr 0x26baca4 size 0x50 virtual false final false
...
/// @brief Method SelectClientCertificate addr 0x26bbdec size 0x504 virtual false final false
...
/// @brief Method Dispose addr 0x26c1964 size 0x70 virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x26c3720 size 0x4 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Finalize addr 0x26c3724 size 0xa4 virtual true final false
 void Finalize() ;
