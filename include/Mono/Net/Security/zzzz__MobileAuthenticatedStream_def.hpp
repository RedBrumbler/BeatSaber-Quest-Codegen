...
/// @brief Method MoveNext addr 0x26c1e98 size 0x904 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x26c279c size 0xc virtual true final true
...
/// @brief Method MoveNext addr 0x26c27a8 size 0x758 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x26c2f00 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method .ctor addr 0x26c2f58 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <InnerRead>b__0 addr 0x26c2f60 size 0x48 virtual false final false
...
/// @brief Method MoveNext addr 0x26c2fa8 size 0x444 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x26c33ec size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method MoveNext addr 0x26c3444 size 0x290 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x26c36d4 size 0xc virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
namespace Mono::Net::Security {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8234))}
...
/// @brief Method .ctor addr 0x26bcf30 size 0x134 virtual false final false
...
/// @brief Method get_SslStream addr 0x26c0668 size 0x8 virtual true final true
 System::Net::Security::SslStream get_SslStream() ;

/// @brief Method get_Settings addr 0x26c0670 size 0x8 virtual false final false
 Mono::Security::Interface::MonoTlsSettings get_Settings() ;

/// @brief Method get_Provider addr 0x26c0678 size 0x8 virtual false final false
 Mono::Net::Security::MobileTlsProvider get_Provider() ;

/// @brief Method get_TargetHost addr 0x26c0680 size 0x8 virtual false final false
 ::StringW get_TargetHost() ;

/// @brief Method set_TargetHost addr 0x26c0688 size 0x8 virtual false final false
 void set_TargetHost(::StringW value) ;

/// @brief Method CheckThrow addr 0x26c0690 size 0xc8 virtual false final false
 void CheckThrow(bool authSuccessCheck, bool shutdownCheck) ;

/// @brief Method GetSSPIException addr 0x26be75c size 0x194 virtual false final false
static System::Exception GetSSPIException(System::Exception e) ;

/// @brief Method GetIOException addr 0x26c0758 size 0x184 virtual false final false
static System::Exception GetIOException(System::Exception e, ::StringW message) ;

/// @brief Method GetInternalError addr 0x26c08dc size 0x50 virtual false final false
static System::Exception GetInternalError() ;

/// @brief Method GetInvalidNestedCallException addr 0x26c092c size 0x50 virtual false final false
static System::Exception GetInvalidNestedCallException() ;

/// @brief Method SetException addr 0x26be230 size 0x40 virtual false final false
 System::Runtime::ExceptionServices::ExceptionDispatchInfo SetException(System::Exception e) ;

/// @brief Method AuthenticateAsClient addr 0x26c097c size 0x1d8 virtual false final false
...
/// @brief Method AuthenticateAsServer addr 0x26c0cb4 size 0x1d8 virtual false final false
...
/// @brief Method AuthenticateAsClientAsync addr 0x26c0ef8 size 0x11c virtual true final true
...
/// @brief Method ProcessAuthentication addr 0x26c0bc0 size 0xf4 virtual false final false
...
/// @brief Method Read addr 0x26c1014 size 0xe4 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Write addr 0x26c1214 size 0xd0 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method ReadAsync addr 0x26c12e4 size 0x9c virtual true final false
...
/// @brief Method WriteAsync addr 0x26c1380 size 0x9c virtual true final false
...
/// @brief Method StartOperation addr 0x26c10f8 size 0x11c virtual false final false
...
/// @brief Method InternalRead addr 0x26bb584 size 0x10c virtual false final false
 int32_t InternalRead(::ArrayW<uint8_t> buffer, int32_t offset, int32_t size, ByRef<bool> outWantMore) ;

/// @brief Method InternalRead addr 0x26c141c size 0x180 virtual false final false
...
/// @brief Method InternalWrite addr 0x26bb09c size 0x1f0 virtual false final false
 bool InternalWrite(::ArrayW<uint8_t> buffer, int32_t offset, int32_t size) ;

/// @brief Method InternalWrite addr 0x26c159c size 0xfc virtual false final false
...
/// @brief Method InnerRead addr 0x26bed30 size 0x11c virtual false final false
...
/// @brief Method InnerWrite addr 0x26be8f0 size 0xe4 virtual false final false
 System::Threading::Tasks::Task InnerWrite(bool sync, System::Threading::CancellationToken cancellationToken) ;

/// @brief Method ProcessHandshake addr 0x26beec8 size 0x3d8 virtual false final false
 Mono::Net::Security::AsyncOperationStatus ProcessHandshake(Mono::Net::Security::AsyncOperationStatus status, bool renegotiate) ;

/// @brief Method ProcessRead addr 0x26bf428 size 0x160 virtual false final false
 System::ValueTuple_2<int32_t,bool> ProcessRead(Mono::Net::Security::BufferOffsetSize userBuffer) ;

/// @brief Method ProcessWrite addr 0x26bf608 size 0x160 virtual false final false
 System::ValueTuple_2<int32_t,bool> ProcessWrite(Mono::Net::Security::BufferOffsetSize userBuffer) ;

/// @brief Method get_IsAuthenticated addr 0x26c1698 size 0xe8 virtual true final false
 bool get_IsAuthenticated() ;

/// @brief Method Dispose addr 0x26c1780 size 0x1e4 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Flush addr 0x26c19d4 size 0x24 virtual true final false
 void Flush() ;

/// @brief Method get_LocalCertificate addr 0x26c19f8 size 0xdc virtual true final true
 System::Security::Cryptography::X509Certificates::X509Certificate get_LocalCertificate() ;

/// @brief Method get_InternalLocalCertificate addr 0x26c1ad4 size 0x100 virtual true final true
 System::Security::Cryptography::X509Certificates::X509Certificate get_InternalLocalCertificate() ;

/// @brief Method Seek addr 0x26c1bd4 size 0x40 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0x26c1c14 size 0x24 virtual true final false
 void SetLength(int64_t value) ;

/// @brief Method get_CanRead addr 0x26c1c38 size 0x44 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanTimeout addr 0x26c1c7c size 0x20 virtual true final false
 bool get_CanTimeout() ;

/// @brief Method get_CanWrite addr 0x26c1c9c size 0x64 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_CanSeek addr 0x26c1d00 size 0x8 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_Length addr 0x26c1d08 size 0x20 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x26c1d28 size 0x20 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x26c1d48 size 0x40 virtual true final false
 void set_Position(int64_t value) ;

/// @brief Method get_ReadTimeout addr 0x26c1d88 size 0x24 virtual true final false
 int32_t get_ReadTimeout() ;

/// @brief Method set_ReadTimeout addr 0x26c1dac size 0x24 virtual true final false
 void set_ReadTimeout(int32_t value) ;

/// @brief Method get_WriteTimeout addr 0x26c1dd0 size 0x24 virtual true final false
 int32_t get_WriteTimeout() ;

/// @brief Method set_WriteTimeout addr 0x26c1df4 size 0x24 virtual true final false
 void set_WriteTimeout(int32_t value) ;

/// @brief Method <InnerWrite>b__67_0 addr 0x26c1e64 size 0x34 virtual false final false
