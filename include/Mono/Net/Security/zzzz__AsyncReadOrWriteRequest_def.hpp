...
/// @brief Method get_UserBuffer addr 0x26bf2a0 size 0x8 virtual false final false
 Mono::Net::Security::BufferOffsetSize get_UserBuffer() ;

/// @brief Method get_CurrentSize addr 0x26bf2a8 size 0x8 virtual false final false
 int32_t get_CurrentSize() ;

/// @brief Method set_CurrentSize addr 0x26bf2b0 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x26bf2b8 size 0xa4 virtual false final false
...
/// @brief Method ToString addr 0x26bf35c size 0x5c virtual true final false
 ::StringW ToString() ;
