...
/// @brief Method GetProviderInternal addr 0x26bfb48 size 0x11c virtual false final false
static Mono::Net::Security::MobileTlsProvider GetProviderInternal() ;

/// @brief Method InitializeInternal addr 0x26c3bbc size 0x3ac virtual false final false
static void InitializeInternal() ;

/// @brief Method LookupProvider addr 0x26c4308 size 0x594 virtual false final false
static Mono::Net::Security::MobileTlsProvider LookupProvider(::StringW name, bool throwOnError) ;

/// @brief Method InitializeProviderRegistration addr 0x26c3f68 size 0x20c virtual false final false
static void InitializeProviderRegistration() ;

/// @brief Method PopulateUnityProviders addr 0x26c489c size 0x13c virtual false final false
static void PopulateUnityProviders() ;

/// @brief Method PopulateProviders addr 0x26c49d8 size 0x50 virtual false final false
static void PopulateProviders() ;

/// @brief Method CreateDefaultProviderImpl addr 0x26c4174 size 0x194 virtual false final false
static Mono::Net::Security::MobileTlsProvider CreateDefaultProviderImpl() ;

/// @brief Method GetProvider addr 0x26c4a28 size 0x4c virtual false final false
