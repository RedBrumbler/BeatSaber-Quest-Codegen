...
/// @brief Method get_EndOffset addr 0x26bd5f0 size 0xc virtual false final false
 int32_t get_EndOffset() ;

/// @brief Method get_Remaining addr 0x26bd5fc size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x26bd624 size 0x104 virtual false final false
 void _ctor(::ArrayW<uint8_t> buffer, int32_t offset, int32_t size) ;

/// @brief Method ToString addr 0x26bd728 size 0xa0 virtual true final false
 ::StringW ToString() ;
