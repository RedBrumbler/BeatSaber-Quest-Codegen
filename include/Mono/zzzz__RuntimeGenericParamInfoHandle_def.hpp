...
/// @brief Method .ctor addr 0x22dee44 size 0x20 virtual false final false
 void _ctor(::cordl_internals::intptr_t ptr) ;

/// @brief Method get_Constraints addr 0x22dee64 size 0x4 virtual false final false
 ::ArrayW<System::Type> get_Constraints() ;

/// @brief Method get_Attributes addr 0x22def94 size 0x1c virtual false final false
 System::Reflection::GenericParameterAttributes get_Attributes() ;

/// @brief Method GetConstraints addr 0x22dee68 size 0x12c virtual false final false
 ::ArrayW<System::Type> GetConstraints() ;

/// @brief Method GetConstraintsCount addr 0x22defb0 size 0x40 virtual false final false
