...
/// @brief Method get_SystemProvider addr 0x22de6d8 size 0x204 virtual false final false
static Mono::ISystemDependencyProvider get_SystemProvider() ;

/// @brief Method Register addr 0x22dea28 size 0x1a8 virtual false final false
static void Register(Mono::ISystemDependencyProvider provider) ;

/// @brief Method ReflectionLoad addr 0x22de8dc size 0x14c virtual false final false
