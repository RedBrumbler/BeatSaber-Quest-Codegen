...
/// @brief Method PtrToUtf8String addr 0x22df304 size 0xe4 virtual false final false
static ::StringW PtrToUtf8String(::cordl_internals::intptr_t ptr) ;

/// @brief Method MarshalString addr 0x22df3e8 size 0x50 virtual false final false
static Mono::SafeStringMarshal MarshalString(::StringW str) ;

/// @brief Method DecodeBlobSize addr 0x22df498 size 0x80 virtual false final false
static int32_t DecodeBlobSize(::cordl_internals::intptr_t in_ptr, ByRef<::cordl_internals::intptr_t> out_ptr) ;

/// @brief Method DecodeBlobArray addr 0x22df518 size 0xb8 virtual false final false
static ::ArrayW<uint8_t> DecodeBlobArray(::cordl_internals::intptr_t ptr) ;

/// @brief Method AsciHexDigitValue addr 0x22df5d0 size 0x2c virtual false final false
static int32_t AsciHexDigitValue(int32_t c) ;

/// @brief Method FreeAssemblyName addr 0x22df5fc size 0x8 virtual false final false
