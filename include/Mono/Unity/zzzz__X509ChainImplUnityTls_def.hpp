...
/// @brief Method .ctor addr 0x26bba98 size 0x88 virtual false final false
 void _ctor(Mono::Unity::Mono__Unity__UnityTls__unitytls_x509list_ref nativeCertificateChain, bool reverseOrder) ;

/// @brief Method get_IsValid addr 0x26bd0d4 size 0x28 virtual true final false
 bool get_IsValid() ;

/// @brief Method get_NativeCertificateChain addr 0x26bd0fc size 0x8 virtual false final false
 Mono::Unity::Mono__Unity__UnityTls__unitytls_x509list_ref get_NativeCertificateChain() ;

/// @brief Method get_ChainElements addr 0x26bd104 size 0x2dc virtual true final false
 System::Security::Cryptography::X509Certificates::X509ChainElementCollection get_ChainElements() ;

/// @brief Method AddStatus addr 0x26bd3e0 size 0x10c virtual true final false
 void AddStatus(System::Security::Cryptography::X509Certificates::X509ChainStatusFlags error) ;

/// @brief Method get_ChainPolicy addr 0x26bd4ec size 0x8 virtual true final false
 System::Security::Cryptography::X509Certificates::X509ChainPolicy get_ChainPolicy() ;

/// @brief Method get_ChainStatus addr 0x26bd4f4 size 0x7c virtual true final false
 ::ArrayW<System::Security::Cryptography::X509Certificates::X509ChainStatus> get_ChainStatus() ;

/// @brief Method Build addr 0x26bd570 size 0x8 virtual true final false
 bool Build(System::Security::Cryptography::X509Certificates::X509Certificate2 certificate) ;

/// @brief Method Reset addr 0x26bd578 size 0x40 virtual true final false
 void Reset() ;

/// @brief Method Dispose addr 0x26bd5b8 size 0x38 virtual true final false
