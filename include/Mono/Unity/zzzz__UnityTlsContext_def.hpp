...
namespace Mono::Unity {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7707))}
...
/// @brief Method .ctor addr 0x26b9884 size 0x708 virtual false final false
 void _ctor(Mono::Net::Security::MobileAuthenticatedStream parent, Mono::Net::Security::MonoSslAuthenticationOptions options) ;

/// @brief Method ExtractNativeKeyAndChainFromManagedCertificate addr 0x26ba13c size 0x340 virtual false final false
...
/// @brief Method get_IsAuthenticated addr 0x26ba47c size 0x8 virtual true final false
 bool get_IsAuthenticated() ;

/// @brief Method get_LocalClientCertificate addr 0x26ba484 size 0x8 virtual true final false
 System::Security::Cryptography::X509Certificates::X509Certificate get_LocalClientCertificate() ;

/// @brief Method get_RemoteCertificate addr 0x26ba48c size 0x8 virtual true final false
 System::Security::Cryptography::X509Certificates::X509Certificate2 get_RemoteCertificate() ;

/// @brief Method Read addr 0x26ba494 size 0x1a8 virtual true final false
 System::ValueTuple_2<int32_t,bool> Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Write addr 0x26ba63c size 0x1a0 virtual true final false
 System::ValueTuple_2<int32_t,bool> Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Renegotiate addr 0x26ba7dc size 0x40 virtual true final false
 void Renegotiate() ;

/// @brief Method PendingRenegotiation addr 0x26ba81c size 0x8 virtual true final false
 bool PendingRenegotiation() ;

/// @brief Method Shutdown addr 0x26ba824 size 0xf8 virtual true final false
 void Shutdown() ;

/// @brief Method Dispose addr 0x26ba938 size 0x78 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method StartHandshake addr 0x26ba9b0 size 0x180 virtual true final false
 void StartHandshake() ;

/// @brief Method ProcessHandshake addr 0x26bab30 size 0x174 virtual true final false
 bool ProcessHandshake() ;

/// @brief Method FinishHandshake addr 0x26bacf4 size 0x128 virtual true final false
 void FinishHandshake() ;

/// @brief Method WriteCallback addr 0x26b957c size 0xc8 virtual false final false
static ::cordl_internals::intptr_t WriteCallback(void* userData, void* data, ::cordl_internals::intptr_t bufferLen, void* errorState) ;

/// @brief Method WriteCallback addr 0x26bae3c size 0x260 virtual false final false
 ::cordl_internals::intptr_t WriteCallback(void* data, ::cordl_internals::intptr_t bufferLen, void* errorState) ;

/// @brief Method ReadCallback addr 0x26b9644 size 0xc8 virtual false final false
...
/// @brief Method ReadCallback addr 0x26bb28c size 0x2f8 virtual false final false
 ::cordl_internals::intptr_t ReadCallback(void* buffer, ::cordl_internals::intptr_t bufferLen, void* errorState) ;

/// @brief Method VerifyCallback addr 0x26b970c size 0xb0 virtual false final false
...
/// @brief Method VerifyCallback addr 0x26bb690 size 0x408 virtual false final false
...
/// @brief Method CertificateCallback addr 0x26b97bc size 0xc8 virtual false final false
...
/// @brief Method CertificateCallback addr 0x26bbb20 size 0x2cc virtual false final false
