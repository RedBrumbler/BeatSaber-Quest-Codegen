...
namespace Mono::Unity {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7706))}
...
/// @brief Method .ctor addr 0x26bc514 size 0x94 virtual false final false
...
/// @brief Method CreateContext addr 0x26bd064 size 0x70 virtual true final false
