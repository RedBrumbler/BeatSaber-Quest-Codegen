...
/// @brief Method get_Instance addr 0x26b63d8 size 0x5c virtual false final false
static Mono::SystemDependencyProvider get_Instance() ;

/// @brief Method Initialize addr 0x26b6434 size 0x154 virtual false final false
static void Initialize() ;

/// @brief Method Mono.ISystemDependencyProvider.get_CertificateProvider addr 0x26b6620 size 0x8 virtual true final true
 Mono::ISystemCertificateProvider Mono_ISystemDependencyProvider_get_CertificateProvider() ;

/// @brief Method get_CertificateProvider addr 0x26b6628 size 0x8 virtual false final false
 Mono::SystemCertificateProvider get_CertificateProvider() ;

/// @brief Method get_X509Pal addr 0x26b6630 size 0x18 virtual false final false
 Mono::X509PalImpl get_X509Pal() ;

// Ctor Parameters []
explicit SystemDependencyProvider() ;

/// @brief Method .ctor addr 0x26b6588 size 0x98 virtual false final false
 void _ctor() ;
