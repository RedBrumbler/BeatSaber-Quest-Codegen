...
/// @brief Method .ctor addr 0x22e3d08 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <BuildTailoringTables>b__17_0 addr 0x22e3d10 size 0x24 virtual false final false
...
/// @brief Method GetTailoringInfo addr 0x22e1ec0 size 0x104 virtual false final false
static Mono::Globalization::Unicode::TailoringInfo GetTailoringInfo(int32_t lcid) ;

/// @brief Method BuildTailoringTables addr 0x22e1fc4 size 0x750 virtual false final false
...
/// @brief Method SetCJKReferences addr 0x22e2714 size 0x238 virtual false final false
...
/// @brief Method Category addr 0x22e294c size 0xa4 virtual false final false
static uint8_t Category(int32_t cp) ;

/// @brief Method Level1 addr 0x22e29f0 size 0xa4 virtual false final false
static uint8_t Level1(int32_t cp) ;

/// @brief Method Level2 addr 0x22e2a94 size 0xa4 virtual false final false
static uint8_t Level2(int32_t cp) ;

/// @brief Method Level3 addr 0x22e2b38 size 0xa4 virtual false final false
static uint8_t Level3(int32_t cp) ;

/// @brief Method IsIgnorable addr 0x22e2bdc size 0x118 virtual false final false
static bool IsIgnorable(int32_t cp, uint8_t flag) ;

/// @brief Method IsIgnorableNonSpacing addr 0x22e2cf4 size 0x58 virtual false final false
static bool IsIgnorableNonSpacing(int32_t cp) ;

/// @brief Method ToKanaTypeInsensitive addr 0x22e2d4c size 0x20 virtual false final false
static int32_t ToKanaTypeInsensitive(int32_t i) ;

/// @brief Method ToWidthCompat addr 0x22e2d6c size 0x18c virtual false final false
static int32_t ToWidthCompat(int32_t i) ;

/// @brief Method HasSpecialWeight addr 0x22e2ef8 size 0x80 virtual false final false
static bool HasSpecialWeight(char16_t c) ;

/// @brief Method IsHalfWidthKana addr 0x22e2f78 size 0x14 virtual false final false
static bool IsHalfWidthKana(char16_t c) ;

/// @brief Method IsHiragana addr 0x22e2f8c size 0x18 virtual false final false
static bool IsHiragana(char16_t c) ;

/// @brief Method IsJapaneseSmallLetter addr 0x22e2fa4 size 0xe8 virtual false final false
static bool IsJapaneseSmallLetter(char16_t c) ;

/// @brief Method get_IsReady addr 0x22e308c size 0x58 virtual false final false
static bool get_IsReady() ;

/// @brief Method GetResource addr 0x22e30e4 size 0xb8 virtual false final false
static ::cordl_internals::intptr_t GetResource(::StringW name) ;

/// @brief Method UInt32FromBytePtr addr 0x22e319c size 0x30 virtual false final false
static uint32_t UInt32FromBytePtr(void* raw, uint32_t idx) ;

/// @brief Method FillCJK addr 0x22e3678 size 0x164 virtual false final false
...
/// @brief Method FillCJKCore addr 0x22e37dc size 0x4c8 virtual false final false
