...
/// @brief Method .ctor addr 0x22e577c size 0x8 virtual false final false
 void _ctor(int32_t lcid) ;

/// @brief Method Reset addr 0x22e9ad8 size 0x14 virtual false final false
 void Reset() ;

/// @brief Method Initialize addr 0x22e5784 size 0x178 virtual false final false
 void Initialize(System::Globalization::CompareOptions options, int32_t lcid, ::StringW s, bool frenchSort) ;

/// @brief Method AppendCJKExtension addr 0x22e61b8 size 0x94 virtual false final false
 void AppendCJKExtension(uint8_t lv1msb, uint8_t lv1lsb) ;

/// @brief Method AppendKana addr 0x22e6300 size 0x94 virtual false final false
...
/// @brief Method AppendNormal addr 0x22e6074 size 0x144 virtual false final false
 void AppendNormal(uint8_t category, uint8_t lv1, uint8_t lv2, uint8_t lv3) ;

/// @brief Method AppendLevel5 addr 0x22e9bb4 size 0x98 virtual false final false
 void AppendLevel5(uint8_t category, uint8_t lv1) ;

/// @brief Method AppendBufferPrimitive addr 0x22e9aec size 0xc8 virtual false final false
 void AppendBufferPrimitive(uint8_t value, ByRef<::ArrayW<uint8_t>> buf, ByRef<int32_t> bidx) ;

/// @brief Method GetResultAndReset addr 0x22e5c78 size 0x24 virtual false final false
 System::Globalization::SortKey GetResultAndReset() ;

/// @brief Method GetOptimizedLength addr 0x22ea128 size 0x60 virtual false final false
 int32_t GetOptimizedLength(::ArrayW<uint8_t> data, int32_t len, uint8_t defaultValue) ;

/// @brief Method GetResult addr 0x22e9c4c size 0x4dc virtual false final false
