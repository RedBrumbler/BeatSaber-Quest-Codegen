...
/// @brief Method .ctor addr 0x22decc0 size 0x8 virtual false final false
 void _ctor(void* value) ;

/// @brief Method .ctor addr 0x22decc8 size 0x20 virtual false final false
 void _ctor(::cordl_internals::intptr_t ptr) ;

/// @brief Method get_Value addr 0x22dece8 size 0x8 virtual false final false
 void* get_Value() ;

/// @brief Method Equals addr 0x22decf0 size 0x104 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x22dedf4 size 0x28 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method GetTypeFromClass addr 0x22dee1c size 0x4 virtual false final false
static ::cordl_internals::intptr_t GetTypeFromClass(void* klass) ;

/// @brief Method GetTypeHandle addr 0x22dee20 size 0x8 virtual false final false
