...
namespace Mono::Math::Prime::Generator {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14042))}
...
/// @brief Method GenerateSearchBase addr 0x22dcbe4 size 0x74 virtual true final false
 Mono::Math::BigInteger GenerateSearchBase(int32_t bits, ::bs_hook::Il2CppWrapperType context) ;

/// @brief Method GenerateNewPrime addr 0x22dcc58 size 0x10 virtual true final false
 Mono::Math::BigInteger GenerateNewPrime(int32_t bits) ;

/// @brief Method GenerateNewPrime addr 0x22dcc68 size 0x2e4 virtual true final false
 Mono::Math::BigInteger GenerateNewPrime(int32_t bits, ::bs_hook::Il2CppWrapperType context) ;

/// @brief Method IsPrimeAcceptable addr 0x22dcf4c size 0x8 virtual true final false
...
/// @brief Method .ctor addr 0x22db8cc size 0x8 virtual false final false
 void _ctor() ;
