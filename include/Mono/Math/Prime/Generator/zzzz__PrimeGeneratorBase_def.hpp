...
/// @brief Method get_Confidence addr 0x22f81e8 size 0x8 virtual true final false
 Mono::Math::Prime::ConfidenceFactor get_Confidence() ;

/// @brief Method get_PrimalityTest addr 0x22f81f0 size 0x74 virtual true final false
 Mono::Math::Prime::PrimalityTest get_PrimalityTest() ;

/// @brief Method get_TrialDivisionBounds addr 0x22f8264 size 0x8 virtual true final false
...
/// @brief Method .ctor addr 0x22f826c size 0x8 virtual false final false
 void _ctor() ;
