...
/// @brief Method GetSPPRounds addr 0x22f7bf8 size 0x194 virtual false final false
static int32_t GetSPPRounds(Mono::Math::BigInteger bi, Mono::Math::Prime::ConfidenceFactor confidence) ;

/// @brief Method Test addr 0x22f6d44 size 0x4c virtual false final false
static bool Test(Mono::Math::BigInteger n, Mono::Math::Prime::ConfidenceFactor confidence) ;

/// @brief Method RabinMillerTest addr 0x22f7f58 size 0x290 virtual false final false
static bool RabinMillerTest(Mono::Math::BigInteger n, Mono::Math::Prime::ConfidenceFactor confidence) ;

/// @brief Method SmallPrimeSppTest addr 0x22f7d8c size 0x1cc virtual false final false
