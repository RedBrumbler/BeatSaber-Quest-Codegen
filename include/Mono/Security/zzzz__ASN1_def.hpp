...
/// @brief Method .ctor addr 0x22ea188 size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x22ea1b4 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x22ea1e4 size 0x178 virtual false final false
 void _ctor(::ArrayW<uint8_t> data) ;

/// @brief Method get_Count addr 0x22ea480 size 0x1c virtual false final false
 int32_t get_Count() ;

/// @brief Method get_Value addr 0x22ea49c size 0x90 virtual false final false
 ::ArrayW<uint8_t> get_Value() ;

/// @brief Method Add addr 0x22ea52c size 0x8c virtual false final false
 Mono::Security::ASN1 Add(Mono::Security::ASN1 asn1) ;

/// @brief Method GetBytes addr 0x22ea5b8 size 0x698 virtual true final false
 ::ArrayW<uint8_t> GetBytes() ;

/// @brief Method Decode addr 0x22ea35c size 0x124 virtual false final false
 void Decode(::ArrayW<uint8_t> asn1, ByRef<int32_t> anPos, int32_t anLength) ;

/// @brief Method DecodeTLV addr 0x22eac50 size 0x124 virtual false final false
 void DecodeTLV(::ArrayW<uint8_t> asn1, ByRef<int32_t> pos, ByRef<uint8_t> tag, ByRef<int32_t> length, ByRef<::ArrayW<uint8_t>> content) ;

/// @brief Method ToString addr 0x22ead74 size 0x290 virtual true final false
 ::StringW ToString() ;
