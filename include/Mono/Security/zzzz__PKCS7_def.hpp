...
/// @brief Method .ctor addr 0x22bb708 size 0x78 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x22bb780 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x22bb7a4 size 0x70 virtual false final false
...
/// @brief Method .ctor addr 0x22bb814 size 0x188 virtual false final false
 void _ctor(Mono::Security::ASN1 asn1) ;

/// @brief Method get_ASN1 addr 0x22bb99c size 0x4 virtual false final false
 Mono::Security::ASN1 get_ASN1() ;

/// @brief Method get_Content addr 0x22bba54 size 0x8 virtual false final false
 Mono::Security::ASN1 get_Content() ;

/// @brief Method set_Content addr 0x22bba5c size 0x8 virtual false final false
 void set_Content(Mono::Security::ASN1 value) ;

/// @brief Method get_ContentType addr 0x22bba64 size 0x8 virtual false final false
 ::StringW get_ContentType() ;

/// @brief Method set_ContentType addr 0x22bba6c size 0x8 virtual false final false
 void set_ContentType(::StringW value) ;

/// @brief Method GetASN1 addr 0x22bb9a0 size 0xb4 virtual false final false
...
/// @brief Method .ctor addr 0x22bba74 size 0x1c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "asn1", ty: "Mono::Security::ASN1", modifiers: "", def_value: None }]
explicit Mono__Security__PKCS7__EncryptedData(Mono::Security::ASN1 asn1) ;

/// @brief Method .ctor addr 0x22bba90 size 0x2d8 virtual false final false
 void _ctor(Mono::Security::ASN1 asn1) ;

/// @brief Method get_EncryptionAlgorithm addr 0x22bbd68 size 0x8 virtual false final false
 Mono::Security::Mono__Security__PKCS7__ContentInfo get_EncryptionAlgorithm() ;

/// @brief Method get_EncryptedContent addr 0x22bbd70 size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x22bbde4 size 0x4e4 virtual false final false
 void _ctor(Mono::Security::ASN1 asn1) ;

/// @brief Method get_Certificates addr 0x22bcab4 size 0x8 virtual false final false
 Mono::Security::X509::X509CertificateCollection get_Certificates() ;

/// @brief Method get_ContentInfo addr 0x22bcabc size 0x8 virtual false final false
 Mono::Security::Mono__Security__PKCS7__ContentInfo get_ContentInfo() ;

/// @brief Method set_HashName addr 0x22bca94 size 0x20 virtual false final false
 void set_HashName(::StringW value) ;

/// @brief Method get_SignerInfo addr 0x22bcac4 size 0x8 virtual false final false
 Mono::Security::Mono__Security__PKCS7__SignerInfo get_SignerInfo() ;

/// @brief Method OidToName addr 0x22bc8e0 size 0x1b4 virtual false final false
...
/// @brief Method .ctor addr 0x22bc850 size 0x90 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "asn1", ty: "Mono::Security::ASN1", modifiers: "", def_value: None }]
explicit Mono__Security__PKCS7__SignerInfo(Mono::Security::ASN1 asn1) ;

/// @brief Method .ctor addr 0x22bc4d8 size 0x378 virtual false final false
 void _ctor(Mono::Security::ASN1 asn1) ;

/// @brief Method get_IssuerName addr 0x22bcc04 size 0x8 virtual false final false
 ::StringW get_IssuerName() ;

/// @brief Method get_SerialNumber addr 0x22bcc0c size 0x74 virtual false final false
 ::ArrayW<uint8_t> get_SerialNumber() ;

/// @brief Method get_AuthenticatedAttributes addr 0x22bcc80 size 0x8 virtual false final false
 System::Collections::ArrayList get_AuthenticatedAttributes() ;

/// @brief Method get_HashName addr 0x22bcc88 size 0x8 virtual false final false
 ::StringW get_HashName() ;

/// @brief Method set_HashName addr 0x22bcc90 size 0x8 virtual false final false
 void set_HashName(::StringW value) ;

/// @brief Method get_Signature addr 0x22bcc98 size 0x74 virtual false final false
 ::ArrayW<uint8_t> get_Signature() ;

/// @brief Method get_UnauthenticatedAttributes addr 0x22bcd0c size 0x8 virtual false final false
 System::Collections::ArrayList get_UnauthenticatedAttributes() ;

/// @brief Method get_Version addr 0x22bcd14 size 0x8 virtual false final false
 uint8_t get_Version() ;
