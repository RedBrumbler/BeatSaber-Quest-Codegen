...
/// @brief Method .ctor addr 0x22ce0a4 size 0xa4 virtual false final false
 void _ctor(::ArrayW<uint8_t> message) ;

/// @brief Method Finalize addr 0x22ce148 size 0xa8 virtual true final false
 void Finalize() ;

/// @brief Method get_Nonce addr 0x22cd18c size 0x78 virtual false final false
 ::ArrayW<uint8_t> get_Nonce() ;

/// @brief Method get_TargetName addr 0x22ce1f0 size 0x8 virtual false final false
 ::StringW get_TargetName() ;

/// @brief Method get_TargetInfo addr 0x22cd114 size 0x78 virtual false final false
 ::ArrayW<uint8_t> get_TargetInfo() ;

/// @brief Method Decode addr 0x22ce1f8 size 0x180 virtual true final false
 void Decode(::ArrayW<uint8_t> message) ;

/// @brief Method GetBytes addr 0x22ce378 size 0xb8 virtual true final false
