...
/// @brief Method .ctor addr 0x22cb314 size 0x70 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x22cb384 size 0x38 virtual false final false
 void _ctor(::StringW password, ::ArrayW<uint8_t> challenge) ;

/// @brief Method Finalize addr 0x22cb8fc size 0xa0 virtual true final false
 void Finalize() ;

/// @brief Method set_Password addr 0x22cb3bc size 0x40c virtual false final false
 void set_Password(::StringW value) ;

/// @brief Method set_Challenge addr 0x22cb7c8 size 0x134 virtual false final false
 void set_Challenge(::ArrayW<uint8_t> value) ;

/// @brief Method get_LM addr 0x22cbb44 size 0x64 virtual false final false
 ::ArrayW<uint8_t> get_LM() ;

/// @brief Method get_NT addr 0x22cbe84 size 0x64 virtual false final false
 ::ArrayW<uint8_t> get_NT() ;

/// @brief Method Dispose addr 0x22cb99c size 0x64 virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x22cbee8 size 0x6c virtual false final false
 void Dispose(bool disposing) ;

/// @brief Method GetResponse addr 0x22cbba8 size 0x2dc virtual false final false
 ::ArrayW<uint8_t> GetResponse(::ArrayW<uint8_t> pwd) ;

/// @brief Method PrepareDESKey addr 0x22cbf54 size 0x1f8 virtual false final false
 ::ArrayW<uint8_t> PrepareDESKey(::ArrayW<uint8_t> key56bits, int32_t position) ;

/// @brief Method PasswordToKey addr 0x22cba00 size 0x144 virtual false final false
