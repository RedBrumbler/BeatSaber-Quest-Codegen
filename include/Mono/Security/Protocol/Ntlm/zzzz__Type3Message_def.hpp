...
/// @brief Method .ctor addr 0x22ce430 size 0x1ec virtual false final false
 void _ctor(Mono::Security::Protocol::Ntlm::Type2Message type2) ;

/// @brief Method Finalize addr 0x22ce61c size 0xe0 virtual true final false
 void Finalize() ;

/// @brief Method set_Domain addr 0x22ce6fc size 0x80 virtual false final false
 void set_Domain(::StringW value) ;

/// @brief Method set_Password addr 0x22ce77c size 0x8 virtual false final false
 void set_Password(::StringW value) ;

/// @brief Method set_Username addr 0x22ce784 size 0x8 virtual false final false
 void set_Username(::StringW value) ;

/// @brief Method Decode addr 0x22ce78c size 0x220 virtual true final false
 void Decode(::ArrayW<uint8_t> message) ;

/// @brief Method DecodeString addr 0x22ce9ac size 0x58 virtual false final false
 ::StringW DecodeString(::ArrayW<uint8_t> buffer, int32_t offset, int32_t len) ;

/// @brief Method EncodeString addr 0x22cea04 size 0x90 virtual false final false
 ::ArrayW<uint8_t> EncodeString(::StringW text) ;

/// @brief Method GetBytes addr 0x22cea94 size 0x628 virtual true final false
