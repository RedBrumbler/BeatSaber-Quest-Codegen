...
/// @brief Method .ctor addr 0x22cdbe4 size 0x84 virtual false final false
 void _ctor() ;

/// @brief Method set_Domain addr 0x22cdc68 size 0x80 virtual false final false
 void set_Domain(::StringW value) ;

/// @brief Method set_Host addr 0x22cdce8 size 0x80 virtual false final false
 void set_Host(::StringW value) ;

/// @brief Method Decode addr 0x22cdd68 size 0xf0 virtual true final false
 void Decode(::ArrayW<uint8_t> message) ;

/// @brief Method GetBytes addr 0x22cde58 size 0x24c virtual true final false
