...
/// @brief Method .ctor addr 0x22cd6b4 size 0x28 virtual false final false
 void _ctor(int32_t messageType) ;

/// @brief Method get_Flags addr 0x22cd6dc size 0x8 virtual false final false
 Mono::Security::Protocol::Ntlm::NtlmFlags get_Flags() ;

/// @brief Method set_Flags addr 0x22cd6e4 size 0x8 virtual false final false
 void set_Flags(Mono::Security::Protocol::Ntlm::NtlmFlags value) ;

/// @brief Method get_Type addr 0x22cd6ec size 0x8 virtual false final false
 int32_t get_Type() ;

/// @brief Method PrepareMessage addr 0x22cd6f4 size 0x100 virtual false final false
 ::ArrayW<uint8_t> PrepareMessage(int32_t messageSize) ;

/// @brief Method Decode addr 0x22cd7f4 size 0x1a4 virtual true final false
 void Decode(::ArrayW<uint8_t> message) ;

/// @brief Method CheckHeader addr 0x22cd998 size 0x114 virtual false final false
