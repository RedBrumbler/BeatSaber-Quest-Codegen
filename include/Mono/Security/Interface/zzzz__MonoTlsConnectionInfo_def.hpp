...
/// @brief Method get_CipherSuiteCode addr 0x22cf28c size 0x8 virtual false final false
 Mono::Security::Interface::CipherSuiteCode get_CipherSuiteCode() ;

/// @brief Method set_CipherSuiteCode addr 0x22cf294 size 0x8 virtual false final false
 void set_CipherSuiteCode(Mono::Security::Interface::CipherSuiteCode value) ;

/// @brief Method get_ProtocolVersion addr 0x22cf29c size 0x8 virtual false final false
 Mono::Security::Interface::TlsProtocols get_ProtocolVersion() ;

/// @brief Method set_ProtocolVersion addr 0x22cf2a4 size 0x8 virtual false final false
 void set_ProtocolVersion(Mono::Security::Interface::TlsProtocols value) ;

/// @brief Method set_PeerDomainName addr 0x22cf2ac size 0x8 virtual false final false
 void set_PeerDomainName(::StringW value) ;

/// @brief Method ToString addr 0x22cf2b4 size 0xbc virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit MonoTlsConnectionInfo() ;

/// @brief Method .ctor addr 0x22cf370 size 0x8 virtual false final false
 void _ctor() ;
