...
/// @brief Method get_Level addr 0x22cf0bc size 0x8 virtual false final false
 Mono::Security::Interface::AlertLevel get_Level() ;

/// @brief Method get_Description addr 0x22cf0c4 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x22cf0cc size 0x6c virtual false final false
 void _ctor(Mono::Security::Interface::AlertDescription description) ;

/// @brief Method inferAlertLevel addr 0x22cf138 size 0x40 virtual false final false
 void inferAlertLevel() ;

/// @brief Method ToString addr 0x22cf178 size 0xbc virtual true final false
 ::StringW ToString() ;
