...
/// @brief Method FromInt32 addr 0x22ba550 size 0x150 virtual false final false
static Mono::Security::ASN1 FromInt32(int32_t value) ;

/// @brief Method FromOid addr 0x22ba6b8 size 0xe8 virtual false final false
static Mono::Security::ASN1 FromOid(::StringW oid) ;

/// @brief Method FromUnsignedBigInteger addr 0x22ba7a0 size 0x11c virtual false final false
static Mono::Security::ASN1 FromUnsignedBigInteger(::ArrayW<uint8_t> big) ;

/// @brief Method ToInt32 addr 0x22ba8bc size 0x118 virtual false final false
static int32_t ToInt32(Mono::Security::ASN1 asn1) ;

/// @brief Method ToOid addr 0x22ba9d4 size 0x28c virtual false final false
static ::StringW ToOid(Mono::Security::ASN1 asn1) ;

/// @brief Method ToDateTime addr 0x22bac60 size 0x55c virtual false final false
