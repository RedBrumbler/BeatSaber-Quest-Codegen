...
/// @brief Method get_Rng addr 0x22eb558 size 0x68 virtual false final false
static System::Security::Cryptography::RandomNumberGenerator get_Rng() ;

/// @brief Method Key addr 0x22eb5c0 size 0x70 virtual false final false
static ::ArrayW<uint8_t> Key(int32_t size) ;

/// @brief Method IV addr 0x22eb630 size 0x70 virtual false final false
static ::ArrayW<uint8_t> IV(int32_t size) ;
