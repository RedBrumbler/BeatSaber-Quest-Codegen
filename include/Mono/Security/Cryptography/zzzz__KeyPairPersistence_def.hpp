...
/// @brief Method .ctor addr 0x22eb6a0 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x22eb6a8 size 0x84 virtual false final false
 void _ctor(System::Security::Cryptography::CspParameters parameters, ::StringW keyPair) ;

/// @brief Method get_Filename addr 0x22eb7c4 size 0x18c virtual false final false
 ::StringW get_Filename() ;

/// @brief Method get_KeyValue addr 0x22ec500 size 0x8 virtual false final false
 ::StringW get_KeyValue() ;

/// @brief Method set_KeyValue addr 0x22ec508 size 0x14 virtual false final false
 void set_KeyValue(::StringW value) ;

/// @brief Method Load addr 0x22ec52c size 0x1b0 virtual false final false
 bool Load() ;

/// @brief Method Save addr 0x22ec7f8 size 0x24c virtual false final false
 void Save() ;

/// @brief Method Remove addr 0x22ecd78 size 0x14 virtual false final false
 void Remove() ;

/// @brief Method get_UserPath addr 0x22ebfb8 size 0x548 virtual false final false
static ::StringW get_UserPath() ;

/// @brief Method get_MachinePath addr 0x22eba70 size 0x548 virtual false final false
static ::StringW get_MachinePath() ;

/// @brief Method _CanSecure addr 0x22eceac size 0x4 virtual false final false
static bool _CanSecure(void* root) ;

/// @brief Method _ProtectUser addr 0x22eceb0 size 0x4 virtual false final false
static bool _ProtectUser(void* path) ;

/// @brief Method _ProtectMachine addr 0x22eceb4 size 0x4 virtual false final false
static bool _ProtectMachine(void* path) ;

/// @brief Method _IsUserProtected addr 0x22eceb8 size 0x4 virtual false final false
static bool _IsUserProtected(void* path) ;

/// @brief Method _IsMachineProtected addr 0x22ecebc size 0x4 virtual false final false
static bool _IsMachineProtected(void* path) ;

/// @brief Method CanSecure addr 0x22ecec0 size 0xa0 virtual false final false
static bool CanSecure(::StringW path) ;

/// @brief Method ProtectUser addr 0x22ecce8 size 0x90 virtual false final false
static bool ProtectUser(::StringW path) ;

/// @brief Method ProtectMachine addr 0x22ecc58 size 0x90 virtual false final false
static bool ProtectMachine(::StringW path) ;

/// @brief Method IsUserProtected addr 0x22ecd8c size 0x90 virtual false final false
static bool IsUserProtected(::StringW path) ;

/// @brief Method IsMachineProtected addr 0x22ece1c size 0x90 virtual false final false
static bool IsMachineProtected(::StringW path) ;

/// @brief Method get_CanChange addr 0x22ec51c size 0x10 virtual false final false
 bool get_CanChange() ;

/// @brief Method get_UseDefaultKeyContainer addr 0x22ecf60 size 0x20 virtual false final false
 bool get_UseDefaultKeyContainer() ;

/// @brief Method get_UseMachineKeyStore addr 0x22eba50 size 0x20 virtual false final false
 bool get_UseMachineKeyStore() ;

/// @brief Method get_ContainerName addr 0x22eb950 size 0x100 virtual false final false
 ::StringW get_ContainerName() ;

/// @brief Method Copy addr 0x22eb72c size 0x98 virtual false final false
 System::Security::Cryptography::CspParameters Copy(System::Security::Cryptography::CspParameters p) ;

/// @brief Method FromXml addr 0x22ec6dc size 0x11c virtual false final false
 void FromXml(::StringW xml) ;

/// @brief Method ToXml addr 0x22eca44 size 0x214 virtual false final false
 ::StringW ToXml() ;
