...
namespace Mono::Security::Cryptography {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14029))}
...
/// @brief Method .ctor addr 0x22cfa7c size 0x80 virtual false final false
 void _ctor() ;

/// @brief Method Finalize addr 0x22cfb78 size 0xa0 virtual true final false
 void Finalize() ;

/// @brief Method Dispose addr 0x22cfc18 size 0xac virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method get_Key addr 0x22cfcc4 size 0x94 virtual true final false
 ::ArrayW<uint8_t> get_Key() ;

/// @brief Method set_Key addr 0x22cfd58 size 0xd8 virtual true final false
 void set_Key(::ArrayW<uint8_t> value) ;

/// @brief Method CreateEncryptor addr 0x22cff10 size 0x20 virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateEncryptor(::ArrayW<uint8_t> rgbKey, ::ArrayW<uint8_t> rgvIV) ;

/// @brief Method CreateDecryptor addr 0x22cff30 size 0x2c virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateDecryptor(::ArrayW<uint8_t> rgbKey, ::ArrayW<uint8_t> rgvIV) ;

/// @brief Method GenerateIV addr 0x22cff5c size 0x5c virtual true final false
 void GenerateIV() ;

/// @brief Method GenerateKey addr 0x22cffb8 size 0x20 virtual true final false
 void GenerateKey() ;

/// @brief Method get_CanTransformMultipleBlocks addr 0x22d0048 size 0x8 virtual true final true
 bool get_CanTransformMultipleBlocks() ;

/// @brief Method get_InputBlockSize addr 0x22d0050 size 0x8 virtual true final true
 int32_t get_InputBlockSize() ;

/// @brief Method get_OutputBlockSize addr 0x22d0058 size 0x8 virtual true final true
 int32_t get_OutputBlockSize() ;

/// @brief Method KeySetup addr 0x22cfe30 size 0xe0 virtual false final false
 void KeySetup(::ArrayW<uint8_t> key) ;

/// @brief Method CheckInput addr 0x22d0060 size 0x154 virtual false final false
 void CheckInput(::ArrayW<uint8_t> inputBuffer, int32_t inputOffset, int32_t inputCount) ;

/// @brief Method TransformBlock addr 0x22d01b4 size 0x170 virtual true final true
...
/// @brief Method InternalTransformBlock addr 0x22d0324 size 0x130 virtual false final false
...
/// @brief Method TransformFinalBlock addr 0x22d0454 size 0x9c virtual true final true
