...
/// @brief Method .ctor addr 0x22cfafc size 0x7c virtual false final false
 void _ctor() ;

/// @brief Method get_IV addr 0x22d4670 size 0x44 virtual true final false
 ::ArrayW<uint8_t> get_IV() ;

/// @brief Method set_IV addr 0x22d46b4 size 0x4 virtual true final false
 void set_IV(::ArrayW<uint8_t> value) ;

/// @brief Method Create addr 0x22d46b8 size 0x58 virtual false final false
