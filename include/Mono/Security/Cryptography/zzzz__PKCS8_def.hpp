...
/// @brief Method .ctor addr 0x22d3518 size 0x70 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x22d3588 size 0x28 virtual false final false
 void _ctor(::ArrayW<uint8_t> data) ;

/// @brief Method get_Algorithm addr 0x22d3818 size 0x8 virtual false final false
 ::StringW get_Algorithm() ;

/// @brief Method get_PrivateKey addr 0x22d3820 size 0x74 virtual false final false
 ::ArrayW<uint8_t> get_PrivateKey() ;

/// @brief Method Decode addr 0x22d35b0 size 0x268 virtual false final false
 void Decode(::ArrayW<uint8_t> data) ;

/// @brief Method RemoveLeadingZero addr 0x22d3894 size 0x9c virtual false final false
static ::ArrayW<uint8_t> RemoveLeadingZero(::ArrayW<uint8_t> bigInt) ;

/// @brief Method Normalize addr 0x22d3930 size 0xa0 virtual false final false
static ::ArrayW<uint8_t> Normalize(::ArrayW<uint8_t> bigInt, int32_t length) ;

/// @brief Method DecodeRSA addr 0x22d39d0 size 0x3d0 virtual false final false
static System::Security::Cryptography::RSA DecodeRSA(::ArrayW<uint8_t> keypair) ;

/// @brief Method Encode addr 0x22d3da0 size 0x1fc virtual false final false
static ::ArrayW<uint8_t> Encode(System::Security::Cryptography::RSA rsa) ;

/// @brief Method DecodeDSA addr 0x22d3f9c size 0x12c virtual false final false
...
/// @brief Method Encode addr 0x22d40c8 size 0x4c virtual false final false
static ::ArrayW<uint8_t> Encode(System::Security::Cryptography::DSA dsa) ;

/// @brief Method Encode addr 0x22d4114 size 0x128 virtual false final false
...
/// @brief Method .ctor addr 0x22d423c size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "data", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None }]
explicit Mono__Security__Cryptography__PKCS8__EncryptedPrivateKeyInfo(::ArrayW<uint8_t> data) ;

/// @brief Method .ctor addr 0x22d4244 size 0x2c virtual false final false
 void _ctor(::ArrayW<uint8_t> data) ;

/// @brief Method get_Algorithm addr 0x22d4538 size 0x8 virtual false final false
 ::StringW get_Algorithm() ;

/// @brief Method get_EncryptedData addr 0x22d4540 size 0x74 virtual false final false
 ::ArrayW<uint8_t> get_EncryptedData() ;

/// @brief Method get_Salt addr 0x22d45b4 size 0xb4 virtual false final false
 ::ArrayW<uint8_t> get_Salt() ;

/// @brief Method get_IterationCount addr 0x22d4668 size 0x8 virtual false final false
 int32_t get_IterationCount() ;

/// @brief Method Decode addr 0x22d4270 size 0x2c8 virtual false final false
 void Decode(::ArrayW<uint8_t> data) ;
