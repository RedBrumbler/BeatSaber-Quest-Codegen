...
/// @brief Method .ctor addr 0x22f17ac size 0x2c8 virtual false final false
 void _ctor(System::Security::Cryptography::SymmetricAlgorithm symmAlgo, bool encryption, ::ArrayW<uint8_t> rgbIV) ;

/// @brief Method Finalize addr 0x22f1a74 size 0xa0 virtual true final false
 void Finalize() ;

/// @brief Method System.IDisposable.Dispose addr 0x22f1b14 size 0x6c virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method Dispose addr 0x22f1b80 size 0x54 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method get_CanTransformMultipleBlocks addr 0x22f1bd4 size 0x8 virtual true final false
 bool get_CanTransformMultipleBlocks() ;

/// @brief Method get_InputBlockSize addr 0x22f1bdc size 0x8 virtual true final false
 int32_t get_InputBlockSize() ;

/// @brief Method get_OutputBlockSize addr 0x22f1be4 size 0x8 virtual true final false
 int32_t get_OutputBlockSize() ;

/// @brief Method Transform addr 0x22f1bec size 0x164 virtual true final false
...
/// @brief Method CBC addr 0x22f1e38 size 0x164 virtual true final false
 void CBC(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output) ;

/// @brief Method CFB addr 0x22f1f9c size 0x1c8 virtual true final false
 void CFB(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output) ;

/// @brief Method OFB addr 0x22f2164 size 0x50 virtual true final false
 void OFB(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output) ;

/// @brief Method CTS addr 0x22f21b4 size 0x50 virtual true final false
 void CTS(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output) ;

/// @brief Method CheckInput addr 0x22f2204 size 0x154 virtual false final false
 void CheckInput(::ArrayW<uint8_t> inputBuffer, int32_t inputOffset, int32_t inputCount) ;

/// @brief Method TransformBlock addr 0x22f2358 size 0x218 virtual true final false
...
/// @brief Method get_KeepLastBlock addr 0x22f2570 size 0x24 virtual false final false
 bool get_KeepLastBlock() ;

/// @brief Method InternalTransformBlock addr 0x22f2594 size 0x1bc virtual false final false
...
/// @brief Method Random addr 0x22f2750 size 0xb0 virtual false final false
 void Random(::ArrayW<uint8_t> buffer, int32_t start, int32_t length) ;

/// @brief Method ThrowBadPaddingException addr 0x22f2800 size 0x1a8 virtual false final false
 void ThrowBadPaddingException(System::Security::Cryptography::PaddingMode padding, int32_t length, int32_t position) ;

/// @brief Method FinalEncrypt addr 0x22f29ec size 0x2a0 virtual true final false
 ::ArrayW<uint8_t> FinalEncrypt(::ArrayW<uint8_t> inputBuffer, int32_t inputOffset, int32_t inputCount) ;

/// @brief Method FinalDecrypt addr 0x22f2c8c size 0x2ac virtual true final false
 ::ArrayW<uint8_t> FinalDecrypt(::ArrayW<uint8_t> inputBuffer, int32_t inputOffset, int32_t inputCount) ;

/// @brief Method TransformFinalBlock addr 0x22f2f38 size 0xb4 virtual true final false
