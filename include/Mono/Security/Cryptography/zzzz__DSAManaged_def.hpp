...
/// @brief Method .ctor addr 0x22f4b6c size 0x130 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x22f4c9c size 0x14 virtual true final false
...
/// @brief Method .ctor addr 0x22f2fec size 0xe0 virtual false final false
 void _ctor(int32_t dwKeySize) ;

/// @brief Method Finalize addr 0x22f30cc size 0xa0 virtual true final false
 void Finalize() ;

/// @brief Method Generate addr 0x22f316c size 0x4c virtual false final false
 void Generate() ;

/// @brief Method GenerateKeyPair addr 0x22f36e0 size 0xe0 virtual false final false
 void GenerateKeyPair() ;

/// @brief Method add addr 0x22f38fc size 0xa4 virtual false final false
 void add(::ArrayW<uint8_t> a, ::ArrayW<uint8_t> b, int32_t value) ;

/// @brief Method GenerateParams addr 0x22f31b8 size 0x528 virtual false final false
 void GenerateParams(int32_t keyLength) ;

/// @brief Method get_Random addr 0x22f39a0 size 0x20 virtual false final false
 System::Security::Cryptography::RandomNumberGenerator get_Random() ;

/// @brief Method get_KeySize addr 0x22f3cd4 size 0x2c virtual true final false
 int32_t get_KeySize() ;

/// @brief Method get_PublicOnly addr 0x22f3d00 size 0x74 virtual false final false
 bool get_PublicOnly() ;

/// @brief Method NormalizeArray addr 0x22f3d74 size 0xa4 virtual false final false
 ::ArrayW<uint8_t> NormalizeArray(::ArrayW<uint8_t> array) ;

/// @brief Method ExportParameters addr 0x22f3e18 size 0x278 virtual true final false
 System::Security::Cryptography::DSAParameters ExportParameters(bool includePrivateParameters) ;

/// @brief Method ImportParameters addr 0x22f40fc size 0x2a8 virtual true final false
 void ImportParameters(System::Security::Cryptography::DSAParameters parameters) ;

/// @brief Method VerifySignature addr 0x22f43a4 size 0x4c0 virtual true final false
 bool VerifySignature(::ArrayW<uint8_t> rgbHash, ::ArrayW<uint8_t> rgbSignature) ;

/// @brief Method Dispose addr 0x22f4864 size 0x1d0 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method add_KeyGenerated addr 0x22f4a34 size 0x9c virtual false final false
...
/// @brief Method remove_KeyGenerated addr 0x22f4ad0 size 0x9c virtual false final false
