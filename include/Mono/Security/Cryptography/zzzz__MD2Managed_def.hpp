...
/// @brief Method Padding addr 0x22ed114 size 0x9c virtual false final false
 ::ArrayW<uint8_t> Padding(int32_t nLength) ;

// Ctor Parameters []
explicit MD2Managed() ;

/// @brief Method .ctor addr 0x22ed070 size 0xa4 virtual false final false
 void _ctor() ;

/// @brief Method Initialize addr 0x22ed1b0 size 0x60 virtual true final false
 void Initialize() ;

/// @brief Method HashCore addr 0x22ed210 size 0xdc virtual true final false
 void HashCore(::ArrayW<uint8_t> array, int32_t ibStart, int32_t cbSize) ;

/// @brief Method HashFinal addr 0x22ed544 size 0xf0 virtual true final false
 ::ArrayW<uint8_t> HashFinal() ;

/// @brief Method MD2Transform addr 0x22ed2ec size 0x258 virtual false final false
