...
/// @brief Method Compare addr 0x22d2450 size 0x74 virtual false final false
static bool Compare(::ArrayW<uint8_t> array1, ::ArrayW<uint8_t> array2) ;

/// @brief Method I2OSP addr 0x22d24c4 size 0x8c virtual false final false
static ::ArrayW<uint8_t> I2OSP(::ArrayW<uint8_t> x, int32_t size) ;

/// @brief Method OS2IP addr 0x22d2550 size 0xbc virtual false final false
static ::ArrayW<uint8_t> OS2IP(::ArrayW<uint8_t> x) ;

/// @brief Method RSAVP1 addr 0x22d260c size 0x1c virtual false final false
static ::ArrayW<uint8_t> RSAVP1(System::Security::Cryptography::RSA rsa, ::ArrayW<uint8_t> s) ;

/// @brief Method Verify_v15 addr 0x22d2628 size 0x1e0 virtual false final false
...
/// @brief Method Encode_v15 addr 0x22d2808 size 0x348 virtual false final false
...
/// @brief Method HashNameFromOid addr 0x22d2b50 size 0x394 virtual false final false
static ::StringW HashNameFromOid(::StringW oid, bool throwOnError) ;

/// @brief Method CreateFromOid addr 0x22d2f60 size 0x5c virtual false final false
static System::Security::Cryptography::HashAlgorithm CreateFromOid(::StringW oid) ;

/// @brief Method CreateFromName addr 0x22d2fbc size 0x40c virtual false final false
