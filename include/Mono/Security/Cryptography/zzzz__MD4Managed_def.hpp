...
/// @brief Method .ctor addr 0x22d1734 size 0xd0 virtual false final false
 void _ctor() ;

/// @brief Method Initialize addr 0x22d1804 size 0xb4 virtual true final false
 void Initialize() ;

/// @brief Method HashCore addr 0x22d18b8 size 0x124 virtual true final false
 void HashCore(::ArrayW<uint8_t> array, int32_t ibStart, int32_t cbSize) ;

/// @brief Method HashFinal addr 0x22d2054 size 0xfc virtual true final false
 ::ArrayW<uint8_t> HashFinal() ;

/// @brief Method Padding addr 0x22d2248 size 0x78 virtual false final false
 ::ArrayW<uint8_t> Padding(int32_t nLength) ;

/// @brief Method F addr 0x22d22c0 size 0x10 virtual false final false
 uint32_t F(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method G addr 0x22d22d0 size 0x14 virtual false final false
 uint32_t G(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method H addr 0x22d22e4 size 0xc virtual false final false
 uint32_t H(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method ROL addr 0x22d22f0 size 0x10 virtual false final false
 uint32_t ROL(uint32_t x, uint8_t n) ;

/// @brief Method FF addr 0x22d2300 size 0x2c virtual false final false
 void FF(ByRef<uint32_t> a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s) ;

/// @brief Method GG addr 0x22d232c size 0x3c virtual false final false
 void GG(ByRef<uint32_t> a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s) ;

/// @brief Method HH addr 0x22d2368 size 0x34 virtual false final false
 void HH(ByRef<uint32_t> a, uint32_t b, uint32_t c, uint32_t d, uint32_t x, uint8_t s) ;

/// @brief Method Encode addr 0x22d2150 size 0xf8 virtual false final false
 void Encode(::ArrayW<uint8_t> output, ::ArrayW<uint32_t> input) ;

/// @brief Method Decode addr 0x22d239c size 0xb4 virtual false final false
 void Decode(::ArrayW<uint32_t> output, ::ArrayW<uint8_t> input, int32_t index) ;

/// @brief Method MD4Transform addr 0x22d19dc size 0x678 virtual false final false
