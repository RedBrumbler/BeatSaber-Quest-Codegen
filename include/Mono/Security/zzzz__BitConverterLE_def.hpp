...
/// @brief Method GetUIntBytes addr 0x22eb004 size 0x110 virtual false final false
static ::ArrayW<uint8_t> GetUIntBytes(void* bytes) ;

/// @brief Method GetULongBytes addr 0x22eb114 size 0x190 virtual false final false
static ::ArrayW<uint8_t> GetULongBytes(void* bytes) ;

/// @brief Method GetBytes addr 0x22eb2a4 size 0x18 virtual false final false
static ::ArrayW<uint8_t> GetBytes(float_t value) ;

/// @brief Method GetBytes addr 0x22eb2bc size 0x18 virtual false final false
static ::ArrayW<uint8_t> GetBytes(double_t value) ;

/// @brief Method UIntFromBytes addr 0x22eb2d4 size 0x14c virtual false final false
static void UIntFromBytes(void* dst, ::ArrayW<uint8_t> src, int32_t startIndex) ;

/// @brief Method ULongFromBytes addr 0x22eb420 size 0xf0 virtual false final false
static void ULongFromBytes(void* dst, ::ArrayW<uint8_t> src, int32_t startIndex) ;

/// @brief Method ToSingle addr 0x22eb510 size 0x24 virtual false final false
static float_t ToSingle(::ArrayW<uint8_t> value, int32_t startIndex) ;

/// @brief Method ToDouble addr 0x22eb534 size 0x24 virtual false final false
