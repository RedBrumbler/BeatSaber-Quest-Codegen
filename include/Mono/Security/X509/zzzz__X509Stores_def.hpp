...
/// @brief Method .ctor addr 0x22ca810 size 0x30 virtual false final false
 void _ctor(::StringW path, bool newFormat) ;

/// @brief Method get_TrustedRoot addr 0x22ca8e0 size 0xdc virtual false final false
 Mono::Security::X509::X509Store get_TrustedRoot() ;

/// @brief Method Open addr 0x22ca9bc size 0x120 virtual false final false
