...
/// @brief Method Parse addr 0x22c6458 size 0x908 virtual false final false
...
/// @brief Method .ctor addr 0x22bc2d0 size 0x194 virtual false final false
 void _ctor(::ArrayW<uint8_t> data) ;

/// @brief Method GetUnsignedBigInteger addr 0x22c6e94 size 0x94 virtual false final false
 ::ArrayW<uint8_t> GetUnsignedBigInteger(::ArrayW<uint8_t> integer) ;

/// @brief Method get_DSA addr 0x22bfc58 size 0x29c virtual false final false
 System::Security::Cryptography::DSA get_DSA() ;

/// @brief Method set_DSA addr 0x22c6f28 size 0x10 virtual false final false
 void set_DSA(System::Security::Cryptography::DSA value) ;

/// @brief Method get_Extensions addr 0x22c6f38 size 0x8 virtual false final false
 Mono::Security::X509::X509ExtensionCollection get_Extensions() ;

/// @brief Method get_Hash addr 0x22c6f40 size 0x294 virtual false final false
 ::ArrayW<uint8_t> get_Hash() ;

/// @brief Method get_IssuerName addr 0x22c71d4 size 0x8 virtual true final false
 ::StringW get_IssuerName() ;

/// @brief Method get_KeyAlgorithm addr 0x22c71dc size 0x8 virtual true final false
 ::StringW get_KeyAlgorithm() ;

/// @brief Method get_KeyAlgorithmParameters addr 0x22c71e4 size 0x74 virtual true final false
 ::ArrayW<uint8_t> get_KeyAlgorithmParameters() ;

/// @brief Method set_KeyAlgorithmParameters addr 0x22c7258 size 0x8 virtual true final false
 void set_KeyAlgorithmParameters(::ArrayW<uint8_t> value) ;

/// @brief Method get_PublicKey addr 0x22c7260 size 0x74 virtual true final false
 ::ArrayW<uint8_t> get_PublicKey() ;

/// @brief Method get_RSA addr 0x22c72d4 size 0x18c virtual true final false
 System::Security::Cryptography::RSA get_RSA() ;

/// @brief Method set_RSA addr 0x22c7460 size 0x10 virtual true final false
 void set_RSA(System::Security::Cryptography::RSA value) ;

/// @brief Method get_RawData addr 0x22c7470 size 0x74 virtual true final false
 ::ArrayW<uint8_t> get_RawData() ;

/// @brief Method get_SerialNumber addr 0x22c74e4 size 0x74 virtual true final false
 ::ArrayW<uint8_t> get_SerialNumber() ;

/// @brief Method get_Signature addr 0x22c7558 size 0x43c virtual true final false
 ::ArrayW<uint8_t> get_Signature() ;

/// @brief Method get_SubjectName addr 0x22c7994 size 0x8 virtual true final false
 ::StringW get_SubjectName() ;

/// @brief Method get_ValidFrom addr 0x22c799c size 0x8 virtual true final false
 System::DateTime get_ValidFrom() ;

/// @brief Method get_ValidUntil addr 0x22c79a4 size 0x8 virtual true final false
 System::DateTime get_ValidUntil() ;

/// @brief Method get_Version addr 0x22c79ac size 0x8 virtual false final false
 int32_t get_Version() ;

/// @brief Method get_IsCurrent addr 0x22c79b4 size 0x60 virtual false final false
 bool get_IsCurrent() ;

/// @brief Method WasCurrent addr 0x22c7a14 size 0xd8 virtual false final false
 bool WasCurrent(System::DateTime instant) ;

/// @brief Method VerifySignature addr 0x22c7aec size 0xc8 virtual false final false
 bool VerifySignature(System::Security::Cryptography::DSA dsa) ;

/// @brief Method VerifySignature addr 0x22c7bb4 size 0x128 virtual false final false
 bool VerifySignature(System::Security::Cryptography::RSA rsa) ;

/// @brief Method VerifySignature addr 0x22c7cdc size 0x18c virtual false final false
 bool VerifySignature(System::Security::Cryptography::AsymmetricAlgorithm aa) ;

/// @brief Method get_IsSelfSigned addr 0x22c7e68 size 0x108 virtual false final false
 bool get_IsSelfSigned() ;

/// @brief Method GetObjectData addr 0x22c7f70 size 0x5c virtual true final false
 void GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method PEM addr 0x22c6d60 size 0x134 virtual false final false
