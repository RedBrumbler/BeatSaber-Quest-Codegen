...
/// @brief Method .ctor addr 0x22c8658 size 0x6c virtual false final false
 void _ctor() ;

/// @brief Method get_TrustAnchors addr 0x22c86c4 size 0x7c virtual false final false
 Mono::Security::X509::X509CertificateCollection get_TrustAnchors() ;

/// @brief Method LoadCertificates addr 0x22c880c size 0x18 virtual false final false
 void LoadCertificates(Mono::Security::X509::X509CertificateCollection collection) ;

/// @brief Method Build addr 0x22c8824 size 0x3a8 virtual false final false
 bool Build(Mono::Security::X509::X509Certificate leaf) ;

/// @brief Method Reset addr 0x22c91ec size 0x40 virtual false final false
 void Reset() ;

/// @brief Method IsValid addr 0x22c9140 size 0xac virtual false final false
 bool IsValid(Mono::Security::X509::X509Certificate cert) ;

/// @brief Method FindCertificateParent addr 0x22c8bcc size 0x1f0 virtual false final false
 Mono::Security::X509::X509Certificate FindCertificateParent(Mono::Security::X509::X509Certificate child) ;

/// @brief Method FindCertificateRoot addr 0x22c8dbc size 0x240 virtual false final false
 Mono::Security::X509::X509Certificate FindCertificateRoot(Mono::Security::X509::X509Certificate potentialRoot) ;

/// @brief Method IsTrusted addr 0x22c922c size 0x2c virtual false final false
 bool IsTrusted(Mono::Security::X509::X509Certificate potentialTrusted) ;

/// @brief Method IsParent addr 0x22c8ffc size 0x144 virtual false final false
