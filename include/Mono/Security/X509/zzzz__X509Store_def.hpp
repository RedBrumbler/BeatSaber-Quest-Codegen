...
/// @brief Method .ctor addr 0x22c9d34 size 0x40 virtual false final false
 void _ctor(::StringW path, bool crl, bool newFormat) ;

/// @brief Method get_Certificates addr 0x22c9d74 size 0x28 virtual false final false
 Mono::Security::X509::X509CertificateCollection get_Certificates() ;

/// @brief Method get_Crls addr 0x22c9f70 size 0x90 virtual false final false
 System::Collections::ArrayList get_Crls() ;

/// @brief Method Load addr 0x22ca1c0 size 0x20c virtual false final false
 ::ArrayW<uint8_t> Load(::StringW filename) ;

/// @brief Method LoadCertificate addr 0x22ca3cc size 0x70 virtual false final false
 Mono::Security::X509::X509Certificate LoadCertificate(::StringW filename) ;

/// @brief Method LoadCrl addr 0x22ca43c size 0x70 virtual false final false
 Mono::Security::X509::X509Crl LoadCrl(::StringW filename) ;

/// @brief Method CheckStore addr 0x22ca4ac size 0xdc virtual false final false
 bool CheckStore(::StringW path, bool throwException) ;

/// @brief Method BuildCertificatesCollection addr 0x22c9d9c size 0x1d4 virtual false final false
 Mono::Security::X509::X509CertificateCollection BuildCertificatesCollection(::StringW storeName) ;

/// @brief Method BuildCrlsCollection addr 0x22ca000 size 0x1c0 virtual false final false
