...
/// @brief Method .ctor addr 0x22bcd1c size 0x2c virtual false final false
 void _ctor(::StringW bagOID, Mono::Security::ASN1 asn1) ;

/// @brief Method get_BagOID addr 0x22bcd48 size 0x8 virtual false final false
 ::StringW get_BagOID() ;

/// @brief Method get_ASN1 addr 0x22bcd50 size 0x8 virtual false final false
