...
/// @brief Method .ctor addr 0x22c82fc size 0xb4 virtual false final false
 void _ctor(Mono::Security::X509::X509CertificateCollection mappings) ;

/// @brief Method get_Current addr 0x22bfb68 size 0xf0 virtual false final false
 Mono::Security::X509::X509Certificate get_Current() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x22c8470 size 0xa4 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.IEnumerator.MoveNext addr 0x22c8514 size 0xa0 virtual true final true
 bool System_Collections_IEnumerator_MoveNext() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x22c85b4 size 0xa4 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method MoveNext addr 0x22bfef4 size 0xa0 virtual false final false
 bool MoveNext() ;
...
/// @brief Method .ctor addr 0x22bc2c8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_Item addr 0x22c802c size 0x98 virtual false final false
 Mono::Security::X509::X509Certificate get_Item(int32_t index) ;

/// @brief Method Add addr 0x22bc464 size 0x74 virtual false final false
 int32_t Add(Mono::Security::X509::X509Certificate value) ;

/// @brief Method AddRange addr 0x22c80c4 size 0xd4 virtual false final false
 void AddRange(Mono::Security::X509::X509CertificateCollection value) ;

/// @brief Method Contains addr 0x22c8198 size 0x18 virtual false final false
 bool Contains(Mono::Security::X509::X509Certificate value) ;

/// @brief Method GetEnumerator addr 0x22bfb08 size 0x60 virtual false final false
 Mono::Security::X509::Mono__Security__X509__X509CertificateCollection__X509CertificateEnumerator GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x22c83b0 size 0x24 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method GetHashCode addr 0x22c83d4 size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method IndexOf addr 0x22c81b0 size 0x14c virtual false final false
 int32_t IndexOf(Mono::Security::X509::X509Certificate value) ;

/// @brief Method Compare addr 0x22c83f4 size 0x7c virtual false final false
