...
/// @brief Method .ctor addr 0x22c5820 size 0xd8 virtual false final false
 void _ctor(Mono::Security::ASN1 entry) ;

/// @brief Method get_SerialNumber addr 0x22c5ea4 size 0x78 virtual false final false
 ::ArrayW<uint8_t> get_SerialNumber() ;

/// @brief Method get_RevocationDate addr 0x22c6448 size 0x8 virtual false final false
 System::DateTime get_RevocationDate() ;

/// @brief Method get_Extensions addr 0x22c6450 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x22c5078 size 0xf8 virtual false final false
 void _ctor(::ArrayW<uint8_t> crl) ;

/// @brief Method Parse addr 0x22c5170 size 0x6b0 virtual false final false
 void Parse(::ArrayW<uint8_t> crl) ;

/// @brief Method get_Extensions addr 0x22c5a34 size 0x8 virtual false final false
 Mono::Security::X509::X509ExtensionCollection get_Extensions() ;

/// @brief Method get_Hash addr 0x22c5a3c size 0x214 virtual false final false
 ::ArrayW<uint8_t> get_Hash() ;

/// @brief Method get_IssuerName addr 0x22c5c50 size 0x8 virtual false final false
 ::StringW get_IssuerName() ;

/// @brief Method get_NextUpdate addr 0x22c5c58 size 0x8 virtual false final false
 System::DateTime get_NextUpdate() ;

/// @brief Method Compare addr 0x22c5c60 size 0x7c virtual false final false
 bool Compare(::ArrayW<uint8_t> array1, ::ArrayW<uint8_t> array2) ;

/// @brief Method GetCrlEntry addr 0x22c5cdc size 0x80 virtual false final false
 Mono::Security::X509::Mono__Security__X509__X509Crl__X509CrlEntry GetCrlEntry(Mono::Security::X509::X509Certificate x509) ;

/// @brief Method GetCrlEntry addr 0x22c5d5c size 0x148 virtual false final false
 Mono::Security::X509::Mono__Security__X509__X509Crl__X509CrlEntry GetCrlEntry(::ArrayW<uint8_t> serialNumber) ;

/// @brief Method VerifySignature addr 0x22c5f1c size 0x2cc virtual false final false
 bool VerifySignature(System::Security::Cryptography::DSA dsa) ;

/// @brief Method VerifySignature addr 0x22c61e8 size 0xd4 virtual false final false
 bool VerifySignature(System::Security::Cryptography::RSA rsa) ;

/// @brief Method VerifySignature addr 0x22c62bc size 0x18c virtual false final false
