...
/// @brief Method .ctor addr 0x22caadc size 0x4 virtual false final false
 void _ctor(Mono::Security::X509::X509Extension extension) ;

/// @brief Method Decode addr 0x22caae0 size 0x118 virtual true final false
 void Decode() ;

/// @brief Method Encode addr 0x22cabf8 size 0x124 virtual true final false
 void Encode() ;

/// @brief Method get_Identifier addr 0x22cad1c size 0x74 virtual false final false
 ::ArrayW<uint8_t> get_Identifier() ;

/// @brief Method ToString addr 0x22cad90 size 0x168 virtual true final false
 ::StringW ToString() ;
