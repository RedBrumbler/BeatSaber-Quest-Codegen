...
namespace Mono::Security::X509::Extensions {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13987))}
...
/// @brief Method .ctor addr 0x22c9308 size 0x4 virtual false final false
 void _ctor(Mono::Security::X509::X509Extension extension) ;

/// @brief Method Decode addr 0x22caef8 size 0x138 virtual true final false
 void Decode() ;

/// @brief Method Encode addr 0x22cb030 size 0x134 virtual true final false
 void Encode() ;

/// @brief Method get_CertificateAuthority addr 0x22cb164 size 0x8 virtual false final false
 bool get_CertificateAuthority() ;

/// @brief Method ToString addr 0x22cb16c size 0x1a8 virtual true final false
 ::StringW ToString() ;
