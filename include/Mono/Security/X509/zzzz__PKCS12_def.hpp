...
/// @brief Method .ctor addr 0x22bf3d8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method set_HashName addr 0x22c3cac size 0x8 virtual false final false
 void set_HashName(::StringW value) ;

/// @brief Method set_IterationCount addr 0x22c3cb4 size 0x8 virtual false final false
 void set_IterationCount(int32_t value) ;

/// @brief Method set_Password addr 0x22bf3e0 size 0xbc virtual false final false
 void set_Password(::ArrayW<uint8_t> value) ;

/// @brief Method set_Salt addr 0x22bf49c size 0xa8 virtual false final false
 void set_Salt(::ArrayW<uint8_t> value) ;

/// @brief Method Adjust addr 0x22c3cbc size 0xdc virtual false final false
 void Adjust(::ArrayW<uint8_t> a, int32_t aOff, ::ArrayW<uint8_t> b) ;

/// @brief Method Derive addr 0x22c3d98 size 0x430 virtual false final false
 ::ArrayW<uint8_t> Derive(::ArrayW<uint8_t> diversifier, int32_t n) ;

/// @brief Method DeriveKey addr 0x22bf544 size 0x70 virtual false final false
 ::ArrayW<uint8_t> DeriveKey(int32_t size) ;

/// @brief Method DeriveIV addr 0x22bf5b4 size 0x70 virtual false final false
 ::ArrayW<uint8_t> DeriveIV(int32_t size) ;

/// @brief Method DeriveMAC addr 0x22c0e08 size 0x70 virtual false final false
...
/// @brief Method .ctor addr 0x22bcd58 size 0xec virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "data", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None }]
explicit PKCS12(::ArrayW<uint8_t> data) ;

/// @brief Method .ctor addr 0x22bce44 size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x22bd6dc size 0x38 virtual false final false
 void _ctor(::ArrayW<uint8_t> data, ::StringW password) ;

/// @brief Method Decode addr 0x22bd02c size 0x6b0 virtual false final false
 void Decode(::ArrayW<uint8_t> data) ;

/// @brief Method Finalize addr 0x22be06c size 0xac virtual true final false
 void Finalize() ;

/// @brief Method set_Password addr 0x22bce78 size 0x1b4 virtual false final false
 void set_Password(::StringW value) ;

/// @brief Method get_IterationCount addr 0x22be118 size 0x8 virtual false final false
 int32_t get_IterationCount() ;

/// @brief Method set_IterationCount addr 0x22be120 size 0x8 virtual false final false
 void set_IterationCount(int32_t value) ;

/// @brief Method get_Keys addr 0x22be128 size 0x700 virtual false final false
 System::Collections::ArrayList get_Keys() ;

/// @brief Method get_Certificates addr 0x22be9dc size 0x450 virtual false final false
 Mono::Security::X509::X509CertificateCollection get_Certificates() ;

/// @brief Method get_RNG addr 0x22bee2c size 0x20 virtual false final false
 System::Security::Cryptography::RandomNumberGenerator get_RNG() ;

/// @brief Method Compare addr 0x22bd868 size 0x74 virtual false final false
 bool Compare(::ArrayW<uint8_t> expected, ::ArrayW<uint8_t> actual) ;

/// @brief Method GetSymmetricAlgorithm addr 0x22bee4c size 0x58c virtual false final false
...
/// @brief Method Decrypt addr 0x22be828 size 0x1b4 virtual false final false
 ::ArrayW<uint8_t> Decrypt(::StringW algorithmOid, ::ArrayW<uint8_t> salt, int32_t iterationCount, ::ArrayW<uint8_t> encryptedData) ;

/// @brief Method Decrypt addr 0x22bdfdc size 0x90 virtual false final false
 ::ArrayW<uint8_t> Decrypt(Mono::Security::Mono__Security__PKCS7__EncryptedData ed) ;

/// @brief Method Encrypt addr 0x22bf624 size 0x254 virtual false final false
 ::ArrayW<uint8_t> Encrypt(::StringW algorithmOid, ::ArrayW<uint8_t> salt, int32_t iterationCount, ::ArrayW<uint8_t> data) ;

/// @brief Method GetExistingParameters addr 0x22bf878 size 0x290 virtual false final false
 System::Security::Cryptography::DSAParameters GetExistingParameters(ByRef<bool> found) ;

/// @brief Method AddPrivateKey addr 0x22bff94 size 0x27c virtual false final false
 void AddPrivateKey(Mono::Security::Cryptography::Mono__Security__Cryptography__PKCS8__PrivateKeyInfo pki) ;

/// @brief Method ReadSafeBag addr 0x22bd8dc size 0x700 virtual false final false
 void ReadSafeBag(Mono::Security::ASN1 safeBag) ;

/// @brief Method CertificateSafeBag addr 0x22c0210 size 0xbf8 virtual false final false
 Mono::Security::ASN1 CertificateSafeBag(Mono::Security::X509::X509Certificate x509, System::Collections::IDictionary attributes) ;

/// @brief Method MAC addr 0x22bd714 size 0x154 virtual false final false
 ::ArrayW<uint8_t> MAC(::ArrayW<uint8_t> password, ::ArrayW<uint8_t> salt, int32_t iterations, ::ArrayW<uint8_t> data) ;

/// @brief Method GetBytes addr 0x22c0e78 size 0x2240 virtual false final false
 ::ArrayW<uint8_t> GetBytes() ;

/// @brief Method EncryptedContentInfo addr 0x22c30c8 size 0x310 virtual false final false
 Mono::Security::Mono__Security__PKCS7__ContentInfo EncryptedContentInfo(Mono::Security::ASN1 safeBags, ::StringW algorithmOid) ;

/// @brief Method AddCertificate addr 0x22c30c0 size 0x8 virtual false final false
 void AddCertificate(Mono::Security::X509::X509Certificate cert) ;

/// @brief Method AddCertificate addr 0x22c33d8 size 0x250 virtual false final false
 void AddCertificate(Mono::Security::X509::X509Certificate cert, System::Collections::IDictionary attributes) ;

/// @brief Method RemoveCertificate addr 0x22c30b8 size 0x8 virtual false final false
 void RemoveCertificate(Mono::Security::X509::X509Certificate cert) ;

/// @brief Method RemoveCertificate addr 0x22c3628 size 0x50c virtual false final false
 void RemoveCertificate(Mono::Security::X509::X509Certificate cert, System::Collections::IDictionary attrs) ;

/// @brief Method Clone addr 0x22c3b34 size 0xd4 virtual true final true
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method get_MaximumPasswordLength addr 0x22c3c08 size 0x58 virtual false final false
