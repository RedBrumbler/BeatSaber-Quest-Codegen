...
/// @brief Method ToString addr 0x22bcacc size 0x138 virtual false final false
static ::StringW ToString(Mono::Security::ASN1 seq) ;

/// @brief Method ToString addr 0x22c4aa0 size 0x1a8 virtual false final false
static ::StringW ToString(Mono::Security::ASN1 seq, bool reversed, ::StringW separator, bool quotes) ;

/// @brief Method AppendEntry addr 0x22c42dc size 0x7c4 virtual false final false
