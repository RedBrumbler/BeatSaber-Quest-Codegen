...
/// @brief Method .ctor addr 0x22c930c size 0x2cc virtual false final false
...
/// @brief Method .ctor addr 0x22c95d8 size 0x14c virtual false final false
 void _ctor(Mono::Security::X509::X509Extension extension) ;

/// @brief Method Decode addr 0x22c9750 size 0x4 virtual true final false
 void Decode() ;

/// @brief Method Encode addr 0x22c9754 size 0x4 virtual true final false
 void Encode() ;

/// @brief Method get_Oid addr 0x22c9758 size 0x8 virtual false final false
 ::StringW get_Oid() ;

/// @brief Method get_Critical addr 0x22c9760 size 0x8 virtual false final false
 bool get_Critical() ;

/// @brief Method get_Value addr 0x22c9724 size 0x2c virtual false final false
 Mono::Security::ASN1 get_Value() ;

/// @brief Method Equals addr 0x22c9768 size 0x144 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x22c98ac size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method WriteLine addr 0x22c98cc size 0x228 virtual false final false
 void WriteLine(System::Text::StringBuilder sb, int32_t n, int32_t pos) ;

/// @brief Method ToString addr 0x22c9af4 size 0xd8 virtual true final false
 ::StringW ToString() ;
