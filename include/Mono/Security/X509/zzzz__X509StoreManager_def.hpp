...
/// @brief Method get_CurrentUserPath addr 0x22ca588 size 0x100 virtual false final false
static ::StringW get_CurrentUserPath() ;

/// @brief Method get_LocalMachinePath addr 0x22ca688 size 0xe8 virtual false final false
static ::StringW get_LocalMachinePath() ;

/// @brief Method get_CurrentUser addr 0x22ca770 size 0xa0 virtual false final false
static Mono::Security::X509::X509Stores get_CurrentUser() ;

/// @brief Method get_LocalMachine addr 0x22ca840 size 0xa0 virtual false final false
static Mono::Security::X509::X509Stores get_LocalMachine() ;

/// @brief Method get_TrustedRootCertificates addr 0x22c8740 size 0xcc virtual false final false
