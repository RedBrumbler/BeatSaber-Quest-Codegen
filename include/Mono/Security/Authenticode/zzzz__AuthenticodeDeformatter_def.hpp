...
/// @brief Method .ctor addr 0x22d75fc size 0x8c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x22d7688 size 0x28 virtual false final false
 void _ctor(::ArrayW<uint8_t> rawData) ;

/// @brief Method set_RawData addr 0x22d76b0 size 0xd0 virtual false final false
 void set_RawData(::ArrayW<uint8_t> value) ;

/// @brief Method get_SigningCertificate addr 0x22d7b18 size 0x8 virtual false final false
 Mono::Security::X509::X509Certificate get_SigningCertificate() ;

/// @brief Method CheckSignature addr 0x22d7824 size 0x2f4 virtual false final false
 bool CheckSignature() ;

/// @brief Method CompareIssuerSerial addr 0x22d8568 size 0xf4 virtual false final false
 bool CompareIssuerSerial(::StringW issuer, ::ArrayW<uint8_t> serial, Mono::Security::X509::X509Certificate x509) ;

/// @brief Method VerifySignature addr 0x22d7b20 size 0xa48 virtual false final false
...
/// @brief Method VerifyCounterSignature addr 0x22d865c size 0xa00 virtual false final false
 bool VerifyCounterSignature(Mono::Security::Mono__Security__PKCS7__SignerInfo cs, ::ArrayW<uint8_t> signature) ;

/// @brief Method Reset addr 0x22d7780 size 0xa4 virtual false final false
 void Reset() ;
