...
/// @brief Method .ctor addr 0x22d6bbc size 0x5c virtual false final false
 void _ctor() ;

/// @brief Method get_PEOffset addr 0x22d6c18 size 0x28 virtual false final false
 int32_t get_PEOffset() ;

/// @brief Method Open addr 0x22d6d18 size 0x94 virtual false final false
 void Open(::StringW filename) ;

/// @brief Method Open addr 0x22d6dd8 size 0x8c virtual false final false
 void Open(::ArrayW<uint8_t> rawdata) ;

/// @brief Method Close addr 0x22d6dac size 0x2c virtual false final false
 void Close() ;

/// @brief Method ReadFirstBlock addr 0x22d6c40 size 0xd8 virtual false final false
 void ReadFirstBlock() ;

/// @brief Method ProcessFirstBlock addr 0x22d6e64 size 0x240 virtual false final false
 int32_t ProcessFirstBlock() ;

/// @brief Method GetSecurityEntry addr 0x22d70a4 size 0xd0 virtual false final false
 ::ArrayW<uint8_t> GetSecurityEntry() ;

/// @brief Method GetHash addr 0x22d7174 size 0x488 virtual false final false
