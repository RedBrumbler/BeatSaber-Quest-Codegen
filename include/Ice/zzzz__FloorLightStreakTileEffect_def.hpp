...
/// @brief Method get_lineIndex addr 0x121f3b0 size 0x8 virtual false final false
 int32_t get_lineIndex() ;

/// @brief Method get_currentTileY addr 0x121f3b8 size 0x8 virtual false final false
 int32_t get_currentTileY() ;

/// @brief Method get_color addr 0x121f3c0 size 0xc virtual false final false
 UnityEngine::Color get_color() ;

/// @brief Method Setup addr 0x121ef44 size 0x14 virtual false final false
 void Setup(UnityEngine::Color color, int32_t lineIndex, float_t stayOnTileDuration) ;

/// @brief Method ManualUpdate addr 0x121ee1c size 0x68 virtual false final false
 void ManualUpdate(float_t deltaTime) ;

// Ctor Parameters []
explicit Ice__FloorLightStreakTileEffect__Element() ;

/// @brief Method .ctor addr 0x121f2f8 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method Start addr 0x121eb68 size 0xc4 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x121ec2c size 0x1f0 virtual false final false
 void Update() ;

/// @brief Method SpawnEffect addr 0x121ee84 size 0xc0 virtual false final false
 void SpawnEffect(int32_t x, UnityEngine::Color color) ;

/// @brief Method DespawnAllEffects addr 0x121f110 size 0xe4 virtual false final false
 void DespawnAllEffects() ;

/// @brief Method CreateNewElement addr 0x121f1f4 size 0x104 virtual false final false
 Ice::Ice__FloorLightStreakTileEffect__Element CreateNewElement() ;

/// @brief Method HandleElementDidMoveToNextTile addr 0x121f300 size 0x9c virtual false final false
...
/// @brief Method .ctor addr 0x121f39c size 0x14 virtual false final false
 void _ctor() ;
