...
/// @brief Method set_spawnColor addr 0x121f9e0 size 0xc virtual false final false
 void set_spawnColor(UnityEngine::Color value) ;

/// @brief Method get_spawnColor addr 0x121f9ec size 0xc virtual false final false
 UnityEngine::Color get_spawnColor() ;

/// @brief Method Start addr 0x121f9f8 size 0x8c virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x121fa84 size 0x98 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleNoteWasCut addr 0x121fb1c size 0x64 virtual false final false
 void HandleNoteWasCut(GlobalNamespace::NoteController noteController, ByRef<GlobalNamespace::NoteCutInfo> noteCutInfo) ;

// Ctor Parameters []
explicit NoteCutFloorLightStreakTileEffectSpawner() ;

/// @brief Method .ctor addr 0x121fb80 size 0xc virtual false final false
 void _ctor() ;
