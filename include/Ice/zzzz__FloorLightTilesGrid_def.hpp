...
/// @brief Method get_ySize addr 0x121f8ac size 0x8 virtual false final false
 int32_t get_ySize() ;

/// @brief Method Init addr 0x121e9bc size 0x194 virtual false final false
 void Init(UnityEngine::Vector3 anchorPoint, int32_t xSize, int32_t ySize, float_t tileWidth, float_t tileHeight) ;

/// @brief Method HighlightTile addr 0x121ef58 size 0x1b8 virtual false final false
 void HighlightTile(int32_t x, int32_t y, float_t fadeInDuration, float_t fadeOutDuration, UnityEngine::Color color) ;

/// @brief Method DespawnAllTiles addr 0x121f8b4 size 0xc0 virtual false final false
 void DespawnAllTiles() ;

/// @brief Method HandleFloorLightTileDidFinish addr 0x121f9d4 size 0x4 virtual false final false
 void HandleFloorLightTileDidFinish(Ice::FloorLightTile floorLightTile) ;

/// @brief Method DespawnTile addr 0x121f974 size 0x60 virtual false final false
 void DespawnTile(Ice::FloorLightTile floorLightTile) ;

// Ctor Parameters []
explicit FloorLightTilesGrid() ;

/// @brief Method .ctor addr 0x121f9d8 size 0x8 virtual false final false
 void _ctor() ;
