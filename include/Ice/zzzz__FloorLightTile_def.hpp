...
/// @brief Method Awake addr 0x121f3cc size 0x1f0 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x121f5bc size 0xa0 virtual false final false
 void OnDestroy() ;

/// @brief Method HighlightWithColor addr 0x121f65c size 0xcc virtual false final false
 void HighlightWithColor(UnityEngine::Color color, float_t fadeInDuration, float_t fadeOutDuration) ;

/// @brief Method HandleFadeInTweenOnCompleted addr 0x121f728 size 0x24 virtual false final false
 void HandleFadeInTweenOnCompleted() ;

/// @brief Method HandleFadeOutTweenOnCompleted addr 0x121f74c size 0x20 virtual false final false
 void HandleFadeOutTweenOnCompleted() ;

/// @brief Method SetColor addr 0x121f76c size 0x64 virtual false final false
 void SetColor(UnityEngine::Color color) ;

// Ctor Parameters []
explicit FloorLightTile() ;

/// @brief Method .ctor addr 0x121f7d0 size 0x8 virtual false final false
 void _ctor() ;
...
namespace Ice {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11011), inst: 295 }), TypeDefinitionIndex(TypeDefinitionIndex(11011)), TypeDefinitionIndex(TypeDefinitionIndex(16021))}
...
/// @brief Method .ctor addr 0x121f7d8 size 0x48 virtual false final false
 void _ctor() ;
