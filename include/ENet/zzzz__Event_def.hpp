...
/// @brief Method get_NativeData addr 0x20b5ad8 size 0xc virtual false final false
 ENet::ENetEvent get_NativeData() ;

/// @brief Method set_NativeData addr 0x20b5ae4 size 0xc virtual false final false
 void set_NativeData(ENet::ENetEvent value) ;

/// @brief Method .ctor addr 0x20b5af0 size 0xc virtual false final false
 void _ctor(ENet::ENetEvent event) ;

/// @brief Method get_Type addr 0x20b5afc size 0x8 virtual false final false
 ENet::EventType get_Type() ;

/// @brief Method get_Peer addr 0x20b5b04 size 0x28 virtual false final false
 ENet::Peer get_Peer() ;

/// @brief Method get_ChannelID addr 0x20b5bac size 0x8 virtual false final false
 uint8_t get_ChannelID() ;

/// @brief Method get_Data addr 0x20b5bb4 size 0x8 virtual false final false
 uint32_t get_Data() ;

/// @brief Method get_Packet addr 0x20b5bbc size 0x8 virtual false final false
