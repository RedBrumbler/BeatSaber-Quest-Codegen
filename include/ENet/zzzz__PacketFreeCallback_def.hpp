...
/// @brief Method .ctor addr 0x20b4e18 size 0xc4 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x20b4edc size 0x14 virtual true final false
 void Invoke(ENet::Packet packet) ;

/// @brief Method BeginInvoke addr 0x20b4ef0 size 0x84 virtual true final false
 System::IAsyncResult BeginInvoke(ENet::Packet packet, System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType object) ;

/// @brief Method EndInvoke addr 0x20b4f74 size 0xc virtual true final false
