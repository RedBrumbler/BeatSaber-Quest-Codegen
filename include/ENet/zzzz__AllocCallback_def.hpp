...
explicit AllocCallback(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method .ctor addr 0x20b4a30 size 0xc4 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x20b4af4 size 0x14 virtual true final false
 ::cordl_internals::intptr_t Invoke(::cordl_internals::intptr_t size) ;

/// @brief Method BeginInvoke addr 0x20b4b08 size 0x84 virtual true final false
...
/// @brief Method EndInvoke addr 0x20b4b8c size 0x28 virtual true final false
