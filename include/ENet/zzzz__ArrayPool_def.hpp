...
/// @brief Method GetByteBuffer addr 0x20b5370 size 0x94 virtual false final false
static ::ArrayW<uint8_t> GetByteBuffer() ;

/// @brief Method GetPointerBuffer addr 0x20b5404 size 0x94 virtual false final false
