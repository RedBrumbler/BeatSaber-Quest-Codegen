...
/// @brief Method .ctor addr 0x20b4d1c size 0xbc virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x20b4dd8 size 0x14 virtual true final false
 void Invoke() ;

/// @brief Method BeginInvoke addr 0x20b4dec size 0x20 virtual true final false
 System::IAsyncResult BeginInvoke(System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType object) ;

/// @brief Method EndInvoke addr 0x20b4e0c size 0xc virtual true final false
