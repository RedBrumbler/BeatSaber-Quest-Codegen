...
/// @brief Method .ctor addr 0x2697af0 size 0x11c virtual false final false
 void _ctor(::cordl_internals::intptr_t pInterface) ;

/// @brief Method RequestScreenshot addr 0x2697c0c size 0x28 virtual false final false
...
/// @brief Method HookScreenshot addr 0x2697c34 size 0x2c virtual false final false
 OVR::OpenVR::EVRScreenshotError HookScreenshot(::ArrayW<OVR::OpenVR::EVRScreenshotType> pSupportedTypes) ;

/// @brief Method GetScreenshotPropertyType addr 0x2697c60 size 0x24 virtual false final false
...
/// @brief Method GetScreenshotPropertyFilename addr 0x2697c84 size 0x24 virtual false final false
...
/// @brief Method UpdateScreenshotProgress addr 0x2697ca8 size 0x24 virtual false final false
 OVR::OpenVR::EVRScreenshotError UpdateScreenshotProgress(uint32_t screenshotHandle, float_t flProgress) ;

/// @brief Method TakeStereoScreenshot addr 0x2697ccc size 0x28 virtual false final false
...
/// @brief Method SubmitScreenshot addr 0x2697cf4 size 0x24 virtual false final false
