...
/// @brief Method .ctor addr 0x2697448 size 0xd8 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x2697520 size 0x14 virtual true final false
...
/// @brief Method BeginInvoke addr 0x2697534 size 0x100 virtual true final false
...
/// @brief Method EndInvoke addr 0x2697634 size 0x34 virtual true final false
...
/// @brief Method .ctor addr 0x2696f14 size 0x114 virtual false final false
 void _ctor(::cordl_internals::intptr_t pInterface) ;

/// @brief Method LoadRenderModel_Async addr 0x2697028 size 0x24 virtual false final false
...
/// @brief Method FreeRenderModel addr 0x269704c size 0x24 virtual false final false
 void FreeRenderModel(::cordl_internals::intptr_t pRenderModel) ;

/// @brief Method LoadTexture_Async addr 0x2697070 size 0x24 virtual false final false
 OVR::OpenVR::EVRRenderModelError LoadTexture_Async(int32_t textureId, ByRef<::cordl_internals::intptr_t> ppTexture) ;

/// @brief Method FreeTexture addr 0x2697094 size 0x24 virtual false final false
 void FreeTexture(::cordl_internals::intptr_t pTexture) ;

/// @brief Method LoadTextureD3D11_Async addr 0x26970b8 size 0x24 virtual false final false
...
/// @brief Method LoadIntoTextureD3D11_Async addr 0x26970dc size 0x24 virtual false final false
 OVR::OpenVR::EVRRenderModelError LoadIntoTextureD3D11_Async(int32_t textureId, ::cordl_internals::intptr_t pDstTexture) ;

/// @brief Method FreeTextureD3D11 addr 0x2697100 size 0x24 virtual false final false
 void FreeTextureD3D11(::cordl_internals::intptr_t pD3D11Texture2D) ;

/// @brief Method GetRenderModelName addr 0x2697124 size 0x24 virtual false final false
...
/// @brief Method GetRenderModelCount addr 0x2697148 size 0x24 virtual false final false
 uint32_t GetRenderModelCount() ;

/// @brief Method GetComponentCount addr 0x269716c size 0x24 virtual false final false
 uint32_t GetComponentCount(::StringW pchRenderModelName) ;

/// @brief Method GetComponentName addr 0x2697190 size 0x24 virtual false final false
...
/// @brief Method GetComponentButtonMask addr 0x26971b4 size 0x24 virtual false final false
 uint64_t GetComponentButtonMask(::StringW pchRenderModelName, ::StringW pchComponentName) ;

/// @brief Method GetComponentRenderModelName addr 0x26971d8 size 0x24 virtual false final false
...
/// @brief Method GetComponentStateForDevicePath addr 0x26971fc size 0x24 virtual false final false
...
/// @brief Method GetComponentState addr 0x2697220 size 0x138 virtual false final false
...
/// @brief Method RenderModelHasComponent addr 0x2697358 size 0x24 virtual false final false
 bool RenderModelHasComponent(::StringW pchRenderModelName, ::StringW pchComponentName) ;

/// @brief Method GetRenderModelThumbnailURL addr 0x269737c size 0x24 virtual false final false
...
/// @brief Method GetRenderModelOriginalPath addr 0x26973a0 size 0x24 virtual false final false
...
/// @brief Method GetRenderModelErrorNameFromEnum addr 0x26973c4 size 0x84 virtual false final false
