...
/// @brief Method .ctor addr 0x269859c size 0x10c virtual false final false
 void _ctor(::cordl_internals::intptr_t pInterface) ;

/// @brief Method CreateSpatialAnchorFromDescriptor addr 0x26986a8 size 0x28 virtual false final false
 OVR::OpenVR::EVRSpatialAnchorError CreateSpatialAnchorFromDescriptor(::StringW pchDescriptor, ByRef<uint32_t> pHandleOut) ;

/// @brief Method CreateSpatialAnchorFromPose addr 0x26986d0 size 0x28 virtual false final false
...
/// @brief Method GetSpatialAnchorPose addr 0x26986f8 size 0x24 virtual false final false
...
/// @brief Method GetSpatialAnchorDescriptor addr 0x269871c size 0x28 virtual false final false
