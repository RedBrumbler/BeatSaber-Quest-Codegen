...
/// @brief Method .ctor addr 0x2694354 size 0x114 virtual false final false
 void _ctor(::cordl_internals::intptr_t pInterface) ;

/// @brief Method GetWindowBounds addr 0x2694468 size 0x34 virtual false final false
 void GetWindowBounds(ByRef<int32_t> pnX, ByRef<int32_t> pnY, ByRef<uint32_t> pnWidth, ByRef<uint32_t> pnHeight) ;

/// @brief Method GetEyeOutputViewport addr 0x269449c size 0x34 virtual false final false
...
/// @brief Method GetDXGIOutputInfo addr 0x26944d0 size 0x2c virtual false final false
