...
/// @brief Method .ctor addr 0x26997a8 size 0x2c virtual false final false
 void _ctor() ;

/// @brief Method Clear addr 0x269a62c size 0x18 virtual false final false
 void Clear() ;

/// @brief Method CheckClear addr 0x269a650 size 0xa0 virtual false final false
 void CheckClear() ;

/// @brief Method VRSystem addr 0x26997ec size 0xe4 virtual false final false
 OVR::OpenVR::CVRSystem VRSystem() ;

/// @brief Method VRChaperone addr 0x26998e8 size 0xe4 virtual false final false
 OVR::OpenVR::CVRChaperone VRChaperone() ;

/// @brief Method VRChaperoneSetup addr 0x26999e4 size 0xe4 virtual false final false
 OVR::OpenVR::CVRChaperoneSetup VRChaperoneSetup() ;

/// @brief Method VRCompositor addr 0x2699ae0 size 0xe4 virtual false final false
 OVR::OpenVR::CVRCompositor VRCompositor() ;

/// @brief Method VROverlay addr 0x2699bdc size 0xe4 virtual false final false
 OVR::OpenVR::CVROverlay VROverlay() ;

/// @brief Method VRRenderModels addr 0x2699cd8 size 0xe4 virtual false final false
 OVR::OpenVR::CVRRenderModels VRRenderModels() ;

/// @brief Method VRExtendedDisplay addr 0x2699dd4 size 0xe4 virtual false final false
 OVR::OpenVR::CVRExtendedDisplay VRExtendedDisplay() ;

/// @brief Method VRSettings addr 0x2699ed0 size 0xe4 virtual false final false
 OVR::OpenVR::CVRSettings VRSettings() ;

/// @brief Method VRApplications addr 0x2699fcc size 0xe4 virtual false final false
 OVR::OpenVR::CVRApplications VRApplications() ;

/// @brief Method VRScreenshots addr 0x269a0c8 size 0xe4 virtual false final false
 OVR::OpenVR::CVRScreenshots VRScreenshots() ;

/// @brief Method VRTrackedCamera addr 0x269a1c4 size 0xe4 virtual false final false
 OVR::OpenVR::CVRTrackedCamera VRTrackedCamera() ;

/// @brief Method VRInput addr 0x269a2c0 size 0xe4 virtual false final false
 OVR::OpenVR::CVRInput VRInput() ;

/// @brief Method VRSpatialAnchors addr 0x269a3bc size 0xe4 virtual false final false
...
/// @brief Method InitInternal addr 0x26995ec size 0x4 virtual false final false
static uint32_t InitInternal(ByRef<OVR::OpenVR::EVRInitError> peError, OVR::OpenVR::EVRApplicationType eApplicationType) ;

/// @brief Method InitInternal2 addr 0x26995f0 size 0x4 virtual false final false
...
/// @brief Method ShutdownInternal addr 0x26995f4 size 0x4 virtual false final false
static void ShutdownInternal() ;

/// @brief Method IsHmdPresent addr 0x26995f8 size 0x4 virtual false final false
static bool IsHmdPresent() ;

/// @brief Method IsRuntimeInstalled addr 0x26995fc size 0x4 virtual false final false
static bool IsRuntimeInstalled() ;

/// @brief Method GetStringForHmdError addr 0x2699600 size 0x68 virtual false final false
static ::StringW GetStringForHmdError(OVR::OpenVR::EVRInitError error) ;

/// @brief Method GetGenericInterface addr 0x2699668 size 0x4 virtual false final false
static ::cordl_internals::intptr_t GetGenericInterface(::StringW pchInterfaceVersion, ByRef<OVR::OpenVR::EVRInitError> peError) ;

/// @brief Method IsInterfaceVersionValid addr 0x269966c size 0x4 virtual false final false
static bool IsInterfaceVersionValid(::StringW pchInterfaceVersion) ;

/// @brief Method GetInitToken addr 0x2699670 size 0x4 virtual false final false
static uint32_t GetInitToken() ;

/// @brief Method get_VRToken addr 0x2699674 size 0x48 virtual false final false
static uint32_t get_VRToken() ;

/// @brief Method set_VRToken addr 0x26996bc size 0x4c virtual false final false
static void set_VRToken(uint32_t value) ;

/// @brief Method get_OpenVRInternal_ModuleContext addr 0x2699708 size 0xa0 virtual false final false
static OVR::OpenVR::OVR__OpenVR__OpenVR__COpenVRContext get_OpenVRInternal_ModuleContext() ;

/// @brief Method get_System addr 0x26997d4 size 0x18 virtual false final false
static OVR::OpenVR::CVRSystem get_System() ;

/// @brief Method get_Chaperone addr 0x26998d0 size 0x18 virtual false final false
static OVR::OpenVR::CVRChaperone get_Chaperone() ;

/// @brief Method get_ChaperoneSetup addr 0x26999cc size 0x18 virtual false final false
static OVR::OpenVR::CVRChaperoneSetup get_ChaperoneSetup() ;

/// @brief Method get_Compositor addr 0x2699ac8 size 0x18 virtual false final false
static OVR::OpenVR::CVRCompositor get_Compositor() ;

/// @brief Method get_Overlay addr 0x2699bc4 size 0x18 virtual false final false
static OVR::OpenVR::CVROverlay get_Overlay() ;

/// @brief Method get_RenderModels addr 0x2699cc0 size 0x18 virtual false final false
static OVR::OpenVR::CVRRenderModels get_RenderModels() ;

/// @brief Method get_ExtendedDisplay addr 0x2699dbc size 0x18 virtual false final false
static OVR::OpenVR::CVRExtendedDisplay get_ExtendedDisplay() ;

/// @brief Method get_Settings addr 0x2699eb8 size 0x18 virtual false final false
static OVR::OpenVR::CVRSettings get_Settings() ;

/// @brief Method get_Applications addr 0x2699fb4 size 0x18 virtual false final false
static OVR::OpenVR::CVRApplications get_Applications() ;

/// @brief Method get_Screenshots addr 0x269a0b0 size 0x18 virtual false final false
static OVR::OpenVR::CVRScreenshots get_Screenshots() ;

/// @brief Method get_TrackedCamera addr 0x269a1ac size 0x18 virtual false final false
static OVR::OpenVR::CVRTrackedCamera get_TrackedCamera() ;

/// @brief Method get_Input addr 0x269a2a8 size 0x18 virtual false final false
static OVR::OpenVR::CVRInput get_Input() ;

/// @brief Method get_SpatialAnchors addr 0x269a3a4 size 0x18 virtual false final false
static OVR::OpenVR::CVRSpatialAnchors get_SpatialAnchors() ;

/// @brief Method Init addr 0x269a4a0 size 0x18c virtual false final false
...
/// @brief Method Shutdown addr 0x269a644 size 0x4 virtual false final false
static void Shutdown() ;

// Ctor Parameters []
explicit OpenVR() ;

/// @brief Method .ctor addr 0x269a648 size 0x8 virtual false final false
 void _ctor() ;
