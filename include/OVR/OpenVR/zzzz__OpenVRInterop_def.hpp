...
/// @brief Method InitInternal addr 0x2698744 size 0x84 virtual false final false
static uint32_t InitInternal(ByRef<OVR::OpenVR::EVRInitError> peError, OVR::OpenVR::EVRApplicationType eApplicationType) ;

/// @brief Method InitInternal2 addr 0x26987c8 size 0xb0 virtual false final false
...
/// @brief Method ShutdownInternal addr 0x2698878 size 0x64 virtual false final false
static void ShutdownInternal() ;

/// @brief Method IsHmdPresent addr 0x26988dc size 0x70 virtual false final false
static bool IsHmdPresent() ;

/// @brief Method IsRuntimeInstalled addr 0x269894c size 0x70 virtual false final false
static bool IsRuntimeInstalled() ;

/// @brief Method GetStringForHmdError addr 0x26989bc size 0x7c virtual false final false
static ::cordl_internals::intptr_t GetStringForHmdError(OVR::OpenVR::EVRInitError error) ;

/// @brief Method GetGenericInterface addr 0x2698a38 size 0x9c virtual false final false
...
/// @brief Method IsInterfaceVersionValid addr 0x2698ad4 size 0x98 virtual false final false
static bool IsInterfaceVersionValid(ByRefConst<::StringW> pchInterfaceVersion) ;

/// @brief Method GetInitToken addr 0x2698b6c size 0x68 virtual false final false
static uint32_t GetInitToken() ;

// Ctor Parameters []
explicit OpenVRInterop() ;

/// @brief Method .ctor addr 0x2698bd4 size 0x8 virtual false final false
 void _ctor() ;
