...
/// @brief Method .ctor addr 0x26944fc size 0x114 virtual false final false
 void _ctor(::cordl_internals::intptr_t pInterface) ;

/// @brief Method GetCameraErrorNameFromEnum addr 0x2694610 size 0x84 virtual false final false
 ::StringW GetCameraErrorNameFromEnum(OVR::OpenVR::EVRTrackedCameraError eCameraError) ;

/// @brief Method HasCamera addr 0x2694694 size 0x28 virtual false final false
 OVR::OpenVR::EVRTrackedCameraError HasCamera(uint32_t nDeviceIndex, ByRef<bool> pHasCamera) ;

/// @brief Method GetCameraFrameSize addr 0x26946bc size 0x30 virtual false final false
...
/// @brief Method GetCameraIntrinsics addr 0x26946ec size 0x24 virtual false final false
...
/// @brief Method GetCameraProjection addr 0x2694710 size 0x24 virtual false final false
...
/// @brief Method AcquireVideoStreamingService addr 0x2694734 size 0x28 virtual false final false
 OVR::OpenVR::EVRTrackedCameraError AcquireVideoStreamingService(uint32_t nDeviceIndex, ByRef<uint64_t> pHandle) ;

/// @brief Method ReleaseVideoStreamingService addr 0x269475c size 0x24 virtual false final false
 OVR::OpenVR::EVRTrackedCameraError ReleaseVideoStreamingService(uint64_t hTrackedCamera) ;

/// @brief Method GetVideoStreamFrameBuffer addr 0x2694780 size 0x24 virtual false final false
...
/// @brief Method GetVideoStreamTextureSize addr 0x26947a4 size 0x2c virtual false final false
...
/// @brief Method GetVideoStreamTextureD3D11 addr 0x26947d0 size 0x24 virtual false final false
...
/// @brief Method GetVideoStreamTextureGL addr 0x26947f4 size 0x28 virtual false final false
...
/// @brief Method ReleaseVideoStreamTextureGL addr 0x269481c size 0x24 virtual false final false
