...
/// @brief Method .ctor addr 0x26983cc size 0x114 virtual false final false
 void _ctor(::cordl_internals::intptr_t pInterface) ;

/// @brief Method Open addr 0x26984e0 size 0x28 virtual false final false
...
/// @brief Method Close addr 0x2698508 size 0x24 virtual false final false
 OVR::OpenVR::EIOBufferError Close(uint64_t ulBuffer) ;

/// @brief Method Read addr 0x269852c size 0x28 virtual false final false
 OVR::OpenVR::EIOBufferError Read(uint64_t ulBuffer, ::cordl_internals::intptr_t pDst, uint32_t unBytes, ByRef<uint32_t> punRead) ;

/// @brief Method Write addr 0x2698554 size 0x24 virtual false final false
 OVR::OpenVR::EIOBufferError Write(uint64_t ulBuffer, ::cordl_internals::intptr_t pSrc, uint32_t unBytes) ;

/// @brief Method PropertyContainer addr 0x2698578 size 0x24 virtual false final false
