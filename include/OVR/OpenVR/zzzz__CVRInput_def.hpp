...
/// @brief Method .ctor addr 0x2697fec size 0x114 virtual false final false
 void _ctor(::cordl_internals::intptr_t pInterface) ;

/// @brief Method SetActionManifestPath addr 0x2698100 size 0x24 virtual false final false
 OVR::OpenVR::EVRInputError SetActionManifestPath(::StringW pchActionManifestPath) ;

/// @brief Method GetActionSetHandle addr 0x2698124 size 0x28 virtual false final false
 OVR::OpenVR::EVRInputError GetActionSetHandle(::StringW pchActionSetName, ByRef<uint64_t> pHandle) ;

/// @brief Method GetActionHandle addr 0x269814c size 0x28 virtual false final false
 OVR::OpenVR::EVRInputError GetActionHandle(::StringW pchActionName, ByRef<uint64_t> pHandle) ;

/// @brief Method GetInputSourceHandle addr 0x2698174 size 0x28 virtual false final false
 OVR::OpenVR::EVRInputError GetInputSourceHandle(::StringW pchInputSourcePath, ByRef<uint64_t> pHandle) ;

/// @brief Method UpdateActionState addr 0x269819c size 0x2c virtual false final false
...
/// @brief Method GetDigitalActionData addr 0x26981c8 size 0x24 virtual false final false
...
/// @brief Method GetAnalogActionData addr 0x26981ec size 0x24 virtual false final false
...
/// @brief Method GetPoseActionData addr 0x2698210 size 0x24 virtual false final false
...
/// @brief Method GetSkeletalActionData addr 0x2698234 size 0x24 virtual false final false
...
/// @brief Method GetSkeletalBoneData addr 0x2698258 size 0x30 virtual false final false
...
/// @brief Method GetSkeletalBoneDataCompressed addr 0x2698288 size 0x2c virtual false final false
...
/// @brief Method DecompressSkeletalBoneData addr 0x26982b4 size 0x2c virtual false final false
...
/// @brief Method TriggerHapticVibrationAction addr 0x26982e0 size 0x24 virtual false final false
...
/// @brief Method GetActionOrigins addr 0x2698304 size 0x2c virtual false final false
...
/// @brief Method GetOriginLocalizedName addr 0x2698330 size 0x24 virtual false final false
...
/// @brief Method GetOriginTrackedDeviceInfo addr 0x2698354 size 0x24 virtual false final false
...
/// @brief Method ShowActionOrigins addr 0x2698378 size 0x24 virtual false final false
 OVR::OpenVR::EVRInputError ShowActionOrigins(uint64_t actionSetHandle, uint64_t ulActionHandle) ;

/// @brief Method ShowBindingsForActionSet addr 0x269839c size 0x30 virtual false final false
