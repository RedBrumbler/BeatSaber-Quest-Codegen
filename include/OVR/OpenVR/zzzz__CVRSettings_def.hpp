...
/// @brief Method RemoveSection addr 0x2697aa8 size 0x24 virtual false final false
 void RemoveSection(::StringW pchSection, ByRef<OVR::OpenVR::EVRSettingsError> peError) ;

/// @brief Method RemoveKeyInSection addr 0x2697acc size 0x24 virtual false final false
