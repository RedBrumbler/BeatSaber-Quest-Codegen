...
/// @brief Method .ctor addr 0x2697e6c size 0x114 virtual false final false
 void _ctor(::cordl_internals::intptr_t pInterface) ;

/// @brief Method GetDriverCount addr 0x2697f80 size 0x24 virtual false final false
 uint32_t GetDriverCount() ;

/// @brief Method GetDriverName addr 0x2697fa4 size 0x24 virtual false final false
 uint32_t GetDriverName(uint32_t nDriver, System::Text::StringBuilder pchValue, uint32_t unBufferSize) ;

/// @brief Method GetDriverHandle addr 0x2697fc8 size 0x24 virtual false final false
