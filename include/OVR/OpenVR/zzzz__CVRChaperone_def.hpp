...
/// @brief Method .ctor addr 0x2694e80 size 0x114 virtual false final false
 void _ctor(::cordl_internals::intptr_t pInterface) ;

/// @brief Method GetCalibrationState addr 0x2694f94 size 0x24 virtual false final false
 OVR::OpenVR::ChaperoneCalibrationState GetCalibrationState() ;

/// @brief Method GetPlayAreaSize addr 0x2694fb8 size 0x2c virtual false final false
 bool GetPlayAreaSize(ByRef<float_t> pSizeX, ByRef<float_t> pSizeZ) ;

/// @brief Method GetPlayAreaRect addr 0x2694fe4 size 0x24 virtual false final false
 bool GetPlayAreaRect(ByRef<OVR::OpenVR::HmdQuad_t> rect) ;

/// @brief Method ReloadInfo addr 0x2695008 size 0x24 virtual false final false
 void ReloadInfo() ;

/// @brief Method SetSceneColor addr 0x269502c size 0x24 virtual false final false
 void SetSceneColor(OVR::OpenVR::HmdColor_t color) ;

/// @brief Method GetBoundsColor addr 0x2695050 size 0x24 virtual false final false
...
/// @brief Method AreBoundsVisible addr 0x2695074 size 0x24 virtual false final false
 bool AreBoundsVisible() ;

/// @brief Method ForceBoundsVisible addr 0x2695098 size 0x28 virtual false final false
