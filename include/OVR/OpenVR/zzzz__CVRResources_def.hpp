...
/// @brief Method .ctor addr 0x2697d18 size 0x10c virtual false final false
 void _ctor(::cordl_internals::intptr_t pInterface) ;

/// @brief Method LoadSharedResource addr 0x2697e24 size 0x24 virtual false final false
 uint32_t LoadSharedResource(::StringW pchResourceName, ::StringW pchBuffer, uint32_t unBufferLen) ;

/// @brief Method GetResourceFullPath addr 0x2697e48 size 0x24 virtual false final false
