...
/// @brief Method .ctor addr 0x2475568 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit MethodAccessException(::StringW message) ;

/// @brief Method .ctor addr 0x24755c4 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x24755e8 size 0x8 virtual false final false
