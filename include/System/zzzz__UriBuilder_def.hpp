...
/// @brief Method .ctor addr 0x27e42b0 size 0x10c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "uri", ty: "::StringW", modifiers: "", def_value: None }]
explicit UriBuilder(::StringW uri) ;

/// @brief Method .ctor addr 0x27e43bc size 0x1a8 virtual false final false
...
/// @brief Method .ctor addr 0x27e46d8 size 0x174 virtual false final false
 void _ctor(System::Uri uri) ;

/// @brief Method Init addr 0x27e4564 size 0x174 virtual false final false
 void Init(System::Uri uri) ;

/// @brief Method set_Host addr 0x27e49b0 size 0xec virtual false final false
 void set_Host(::StringW value) ;

/// @brief Method set_Path addr 0x27e4a9c size 0xb4 virtual false final false
 void set_Path(::StringW value) ;

/// @brief Method set_Port addr 0x27e4b50 size 0x70 virtual false final false
 void set_Port(int32_t value) ;

/// @brief Method set_Query addr 0x27e4bc0 size 0xb8 virtual false final false
 void set_Query(::StringW value) ;

/// @brief Method set_Scheme addr 0x27e4c78 size 0x148 virtual false final false
 void set_Scheme(::StringW value) ;

/// @brief Method get_Uri addr 0x27e4dc0 size 0x98 virtual false final false
 System::Uri get_Uri() ;

/// @brief Method Equals addr 0x27e4e58 size 0x5c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType rparam) ;

/// @brief Method GetHashCode addr 0x27e4eb4 size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method SetFieldsFromUri addr 0x27e484c size 0x164 virtual false final false
 void SetFieldsFromUri(System::Uri uri) ;

/// @brief Method ToString addr 0x27e4ed4 size 0x4cc virtual true final false
 ::StringW ToString() ;
