...
/// @brief Method .ctor addr 0x24932c8 size 0x124 virtual false final false
...
/// @brief Method .ctor addr 0x24933ec size 0xf8 virtual false final false
...
/// @brief Method .ctor addr 0x24934e4 size 0xc0 virtual false final false
...
/// @brief Method .ctor addr 0x24935a4 size 0x44 virtual false final false
 void _ctor(::StringW version) ;

// Ctor Parameters []
explicit Version() ;

/// @brief Method .ctor addr 0x2493684 size 0x24 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "version", ty: "System::Version", modifiers: "", def_value: None }]
explicit Version(System::Version version) ;

/// @brief Method .ctor addr 0x24936a8 size 0x3c virtual false final false
 void _ctor(System::Version version) ;

/// @brief Method Clone addr 0x24936e4 size 0x60 virtual true final true
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method get_Major addr 0x2493744 size 0x8 virtual false final false
 int32_t get_Major() ;

/// @brief Method get_Minor addr 0x249374c size 0x8 virtual false final false
 int32_t get_Minor() ;

/// @brief Method get_Build addr 0x2493754 size 0x8 virtual false final false
 int32_t get_Build() ;

/// @brief Method get_Revision addr 0x249375c size 0x8 virtual false final false
 int32_t get_Revision() ;

/// @brief Method CompareTo addr 0x2493764 size 0xbc virtual true final true
 int32_t CompareTo(::bs_hook::Il2CppWrapperType version) ;

/// @brief Method CompareTo addr 0x2493834 size 0x68 virtual true final true
 int32_t CompareTo(System::Version value) ;

/// @brief Method Equals addr 0x249389c size 0x64 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2493900 size 0x60 virtual true final true
 bool Equals(System::Version obj) ;

/// @brief Method GetHashCode addr 0x2493960 size 0x1c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x249397c size 0x28 virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x24939cc size 0x8c virtual false final false
 ::StringW ToString(int32_t fieldCount) ;

/// @brief Method TryFormat addr 0x2493ca4 size 0x2c virtual false final false
 bool TryFormat(System::Span_1<char16_t> destination, ByRef<int32_t> charsWritten) ;

/// @brief Method TryFormat addr 0x2493cd0 size 0x128 virtual false final false
 bool TryFormat(System::Span_1<char16_t> destination, int32_t fieldCount, ByRef<int32_t> charsWritten) ;

/// @brief Method System.ISpanFormattable.TryFormat addr 0x2493df8 size 0x2c virtual true final true
...
/// @brief Method get_DefaultFormatFieldCount addr 0x24939a4 size 0x28 virtual false final false
 int32_t get_DefaultFormatFieldCount() ;

/// @brief Method ToCachedStringBuilder addr 0x2493a58 size 0x24c virtual false final false
 System::Text::StringBuilder ToCachedStringBuilder(int32_t fieldCount) ;

/// @brief Method Parse addr 0x24935e8 size 0x9c virtual false final false
static System::Version Parse(::StringW input) ;

/// @brief Method ParseVersion addr 0x2493e24 size 0x4d4 virtual false final false
static System::Version ParseVersion(System::ReadOnlySpan_1<char16_t> input, bool throwOnFailure) ;

/// @brief Method TryParseComponent addr 0x24942f8 size 0x118 virtual false final false
...
/// @brief Method op_Equality addr 0x2493820 size 0x14 virtual false final false
static bool op_Equality(System::Version v1, System::Version v2) ;

/// @brief Method op_Inequality addr 0x2494410 size 0x28 virtual false final false
static bool op_Inequality(System::Version v1, System::Version v2) ;

/// @brief Method op_LessThan addr 0x2494438 size 0x64 virtual false final false
static bool op_LessThan(System::Version v1, System::Version v2) ;

/// @brief Method op_LessThanOrEqual addr 0x249449c size 0x68 virtual false final false
static bool op_LessThanOrEqual(System::Version v1, System::Version v2) ;

/// @brief Method op_GreaterThan addr 0x2494504 size 0x10 virtual false final false
static bool op_GreaterThan(System::Version v1, System::Version v2) ;

/// @brief Method op_GreaterThanOrEqual addr 0x2494514 size 0x10 virtual false final false
