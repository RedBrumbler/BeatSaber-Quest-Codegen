...
/// @brief Method .ctor addr 0x248a968 size 0x8 virtual false final false
 void _ctor(int64_t ticks) ;

/// @brief Method .ctor addr 0x248a970 size 0x80 virtual false final false
 void _ctor(int32_t hours, int32_t minutes, int32_t seconds) ;

/// @brief Method .ctor addr 0x248aa8c size 0xc0 virtual false final false
 void _ctor(int32_t days, int32_t hours, int32_t minutes, int32_t seconds, int32_t milliseconds) ;

/// @brief Method get_Ticks addr 0x248ab4c size 0x8 virtual false final false
 int64_t get_Ticks() ;

/// @brief Method get_Hours addr 0x248ab54 size 0x48 virtual false final false
 int32_t get_Hours() ;

/// @brief Method get_Minutes addr 0x248ab9c size 0x48 virtual false final false
 int32_t get_Minutes() ;

/// @brief Method get_Seconds addr 0x248abe4 size 0x4c virtual false final false
 int32_t get_Seconds() ;

/// @brief Method get_TotalDays addr 0x248ac30 size 0x18 virtual false final false
 double_t get_TotalDays() ;

/// @brief Method get_TotalHours addr 0x248ac48 size 0x18 virtual false final false
 double_t get_TotalHours() ;

/// @brief Method get_TotalMilliseconds addr 0x248ac60 size 0x34 virtual false final false
 double_t get_TotalMilliseconds() ;

/// @brief Method get_TotalMinutes addr 0x248ac94 size 0x18 virtual false final false
 double_t get_TotalMinutes() ;

/// @brief Method get_TotalSeconds addr 0x248acac size 0x18 virtual false final false
 double_t get_TotalSeconds() ;

/// @brief Method Add addr 0x248acc4 size 0x6c virtual false final false
 System::TimeSpan Add(System::TimeSpan ts) ;

/// @brief Method Compare addr 0x248ad30 size 0x18 virtual false final false
static int32_t Compare(System::TimeSpan t1, System::TimeSpan t2) ;

/// @brief Method CompareTo addr 0x248ad48 size 0xc8 virtual true final true
 int32_t CompareTo(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method CompareTo addr 0x248ae10 size 0x1c virtual true final true
 int32_t CompareTo(System::TimeSpan value) ;

/// @brief Method FromDays addr 0x248ae2c size 0x64 virtual false final false
static System::TimeSpan FromDays(double_t value) ;

/// @brief Method Duration addr 0x248afdc size 0xbc virtual false final false
 System::TimeSpan Duration() ;

/// @brief Method Equals addr 0x248b098 size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method Equals addr 0x248b110 size 0x10 virtual true final true
 bool Equals(System::TimeSpan obj) ;

/// @brief Method GetHashCode addr 0x248b120 size 0xc virtual true final false
 int32_t GetHashCode() ;

/// @brief Method FromHours addr 0x248b12c size 0x64 virtual false final false
static System::TimeSpan FromHours(double_t value) ;

/// @brief Method Interval addr 0x248ae90 size 0x14c virtual false final false
static System::TimeSpan Interval(double_t value, int32_t scale) ;

/// @brief Method FromMilliseconds addr 0x248b190 size 0x60 virtual false final false
static System::TimeSpan FromMilliseconds(double_t value) ;

/// @brief Method FromMinutes addr 0x248b1f0 size 0x60 virtual false final false
static System::TimeSpan FromMinutes(double_t value) ;

/// @brief Method Negate addr 0x248b250 size 0xb8 virtual false final false
 System::TimeSpan Negate() ;

/// @brief Method FromSeconds addr 0x248b308 size 0x60 virtual false final false
static System::TimeSpan FromSeconds(double_t value) ;

/// @brief Method Subtract addr 0x248b368 size 0x6c virtual false final false
 System::TimeSpan Subtract(System::TimeSpan ts) ;

/// @brief Method FromTicks addr 0x248b3d4 size 0x4 virtual false final false
static System::TimeSpan FromTicks(int64_t value) ;

/// @brief Method TimeToTicks addr 0x248a9f0 size 0x9c virtual false final false
static int64_t TimeToTicks(int32_t hour, int32_t minute, int32_t second) ;

/// @brief Method Parse addr 0x248b3d8 size 0x5c virtual false final false
static System::TimeSpan Parse(::StringW s) ;

/// @brief Method Parse addr 0x248b434 size 0x60 virtual false final false
static System::TimeSpan Parse(::StringW input, System::IFormatProvider formatProvider) ;

/// @brief Method TryParseExact addr 0x248b494 size 0xd4 virtual false final false
...
/// @brief Method ToString addr 0x248b568 size 0x64 virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x248b5cc size 0x70 virtual false final false
 ::StringW ToString(::StringW format) ;

/// @brief Method ToString addr 0x248b63c size 0x74 virtual true final true
 ::StringW ToString(::StringW format, System::IFormatProvider formatProvider) ;

/// @brief Method TryFormat addr 0x248b6b0 size 0xa4 virtual true final true
...
/// @brief Method op_UnaryNegation addr 0x248b754 size 0xb0 virtual false final false
static System::TimeSpan op_UnaryNegation(System::TimeSpan t) ;

/// @brief Method op_Subtraction addr 0x248b804 size 0x18 virtual false final false
static System::TimeSpan op_Subtraction(System::TimeSpan t1, System::TimeSpan t2) ;

/// @brief Method op_Addition addr 0x248b81c size 0x18 virtual false final false
static System::TimeSpan op_Addition(System::TimeSpan t1, System::TimeSpan t2) ;

/// @brief Method op_Equality addr 0x248b834 size 0xc virtual false final false
static bool op_Equality(System::TimeSpan t1, System::TimeSpan t2) ;

/// @brief Method op_Inequality addr 0x248b840 size 0xc virtual false final false
static bool op_Inequality(System::TimeSpan t1, System::TimeSpan t2) ;

/// @brief Method op_LessThan addr 0x248b84c size 0xc virtual false final false
static bool op_LessThan(System::TimeSpan t1, System::TimeSpan t2) ;

/// @brief Method op_LessThanOrEqual addr 0x248b858 size 0xc virtual false final false
static bool op_LessThanOrEqual(System::TimeSpan t1, System::TimeSpan t2) ;

/// @brief Method op_GreaterThan addr 0x248b864 size 0xc virtual false final false
static bool op_GreaterThan(System::TimeSpan t1, System::TimeSpan t2) ;

/// @brief Method op_GreaterThanOrEqual addr 0x248b870 size 0xc virtual false final false
