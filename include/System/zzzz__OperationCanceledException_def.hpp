...
/// @brief Method get_CancellationToken addr 0x2482918 size 0x8 virtual false final false
 System::Threading::CancellationToken get_CancellationToken() ;

/// @brief Method set_CancellationToken addr 0x2482920 size 0x8 virtual false final false
 void set_CancellationToken(System::Threading::CancellationToken value) ;

// Ctor Parameters []
explicit OperationCanceledException() ;

/// @brief Method .ctor addr 0x2482928 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit OperationCanceledException(::StringW message) ;

/// @brief Method .ctor addr 0x24829f8 size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0x2482a18 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x2482a48 size 0x4 virtual false final false
