...
/// @brief Method AddMapping addr 0x24c9914 size 0x120 virtual false final false
 void AddMapping(System::TermInfoStrings key, ::ArrayW<uint8_t> val) ;

/// @brief Method Sort addr 0x24c9a34 size 0x4 virtual false final false
 void Sort() ;

/// @brief Method StartsWith addr 0x24c6938 size 0x88 virtual false final false
 bool StartsWith(int32_t c) ;

/// @brief Method Match addr 0x24c69c0 size 0x48c virtual false final false
 System::TermInfoStrings Match(::ArrayW<char16_t> buffer, int32_t offset, int32_t length, ByRef<int32_t> used) ;

// Ctor Parameters []
explicit ByteMatcher() ;

/// @brief Method .ctor addr 0x24c984c size 0x7c virtual false final false
 void _ctor() ;
