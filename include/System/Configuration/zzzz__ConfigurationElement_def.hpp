...
/// @brief Method get_Properties addr 0x26ac554 size 0x38 virtual true final false
 System::Configuration::ConfigurationPropertyCollection get_Properties() ;

/// @brief Method IsModified addr 0x26ac58c size 0x38 virtual true final false
 bool IsModified() ;

/// @brief Method Reset addr 0x26ac5c4 size 0x38 virtual true final false
 void Reset(System::Configuration::ConfigurationElement parentElement) ;

/// @brief Method ResetModified addr 0x26ac5fc size 0x38 virtual true final false
 void ResetModified() ;
