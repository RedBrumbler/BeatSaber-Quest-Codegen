...
namespace System::Configuration {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(16093))}
...
/// @brief Method DeserializeSection addr 0x26ac634 size 0x38 virtual true final false
 void DeserializeSection(System::Xml::XmlReader reader) ;

/// @brief Method IsModified addr 0x26ac66c size 0x38 virtual true final false
 bool IsModified() ;

/// @brief Method ResetModified addr 0x26ac6a4 size 0x38 virtual true final false
 void ResetModified() ;

/// @brief Method SerializeSection addr 0x26ac6dc size 0x38 virtual true final false
