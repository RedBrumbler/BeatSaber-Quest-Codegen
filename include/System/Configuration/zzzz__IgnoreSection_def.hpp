...
/// @brief Method .ctor addr 0x26ac718 size 0x38 virtual false final false
 void _ctor() ;

/// @brief Method get_Properties addr 0x26ac750 size 0x38 virtual true final false
 System::Configuration::ConfigurationPropertyCollection get_Properties() ;

/// @brief Method DeserializeSection addr 0x26ac788 size 0x38 virtual true final false
 void DeserializeSection(System::Xml::XmlReader xmlReader) ;

/// @brief Method IsModified addr 0x26ac7c0 size 0x38 virtual true final false
 bool IsModified() ;

/// @brief Method Reset addr 0x26ac7f8 size 0x38 virtual true final false
 void Reset(System::Configuration::ConfigurationElement parentSection) ;

/// @brief Method ResetModified addr 0x26ac830 size 0x38 virtual true final false
 void ResetModified() ;

/// @brief Method SerializeSection addr 0x26ac868 size 0x38 virtual true final false
