...
/// @brief Method .ctor addr 0x249c5f8 size 0x28 virtual false final false
 void _ctor(int64_t cookie) ;

/// @brief Method get_Value addr 0x249c620 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_Value() ;

/// @brief Method set_Value addr 0x249c628 size 0x8 virtual false final false
 void set_Value(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_Cookie addr 0x249c630 size 0x8 virtual false final false
 int64_t get_Cookie() ;
