...
/// @brief Method Equals addr 0x24cb0bc size 0xd0 virtual true final true
 bool Equals(System::TypeName other) ;

/// @brief Method GetHashCode addr 0x24cb18c size 0x28 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x24cb1b4 size 0x60 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

// Ctor Parameters []
explicit System__TypeNames__ATypeName() ;

/// @brief Method .ctor addr 0x24cb214 size 0x4 virtual false final false
 void _ctor() ;
