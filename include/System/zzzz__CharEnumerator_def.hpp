...
/// @brief Method .ctor addr 0x23f1550 size 0x30 virtual false final false
 void _ctor(::StringW str) ;

/// @brief Method Clone addr 0x23f1580 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method MoveNext addr 0x23f1588 size 0x54 virtual true final true
 bool MoveNext() ;

/// @brief Method Dispose addr 0x23f15dc size 0x18 virtual true final true
 void Dispose() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x23f15f4 size 0x64 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method get_Current addr 0x23f1658 size 0xa4 virtual true final true
 char16_t get_Current() ;

/// @brief Method Reset addr 0x23f16fc size 0x10 virtual true final true
 void Reset() ;

// Ctor Parameters []
explicit CharEnumerator() ;

/// @brief Method .ctor addr 0x23f170c size 0x38 virtual false final false
 void _ctor() ;
