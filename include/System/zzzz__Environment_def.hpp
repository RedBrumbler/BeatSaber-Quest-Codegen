...
/// @brief Method GetResourceString addr 0x24b62b0 size 0x4 virtual false final false
static ::StringW GetResourceString(::StringW key) ;

/// @brief Method GetResourceString addr 0x24b8124 size 0x70 virtual false final false
static ::StringW GetResourceString(::StringW key, ::ArrayW<::bs_hook::Il2CppWrapperType> values) ;

/// @brief Method GetResourceStringEncodingName addr 0x24b98b0 size 0x17c virtual false final false
static ::StringW GetResourceStringEncodingName(int32_t codePage) ;

/// @brief Method get_CurrentDirectory addr 0x24b9a2c size 0x8 virtual false final false
static ::StringW get_CurrentDirectory() ;

/// @brief Method get_CurrentManagedThreadId addr 0x24b9a34 size 0x20 virtual false final false
static int32_t get_CurrentManagedThreadId() ;

/// @brief Method get_HasShutdownStarted addr 0x24b9a54 size 0x4 virtual false final false
static bool get_HasShutdownStarted() ;

/// @brief Method get_MachineName addr 0x24b9a58 size 0x4 virtual false final false
static ::StringW get_MachineName() ;

/// @brief Method GetNewLine addr 0x24b9a5c size 0x4 virtual false final false
static ::StringW GetNewLine() ;

/// @brief Method get_NewLine addr 0x24b9a60 size 0x68 virtual false final false
static ::StringW get_NewLine() ;

/// @brief Method get_Platform addr 0x24b9ac8 size 0x4 virtual false final false
static System::PlatformID get_Platform() ;

/// @brief Method GetOSVersionString addr 0x24b9acc size 0x4 virtual false final false
static ::StringW GetOSVersionString() ;

/// @brief Method get_OSVersion addr 0x24b9ad0 size 0xbc virtual false final false
static System::OperatingSystem get_OSVersion() ;

/// @brief Method CreateVersionFromString addr 0x24b9b8c size 0x21c virtual false final false
static System::Version CreateVersionFromString(::StringW info) ;

/// @brief Method get_StackTrace addr 0x24b9da8 size 0x6c virtual false final false
static ::StringW get_StackTrace() ;

/// @brief Method get_TickCount addr 0x24b9e14 size 0x4 virtual false final false
static int32_t get_TickCount() ;

/// @brief Method get_UserDomainName addr 0x24b9e18 size 0x4 virtual false final false
static ::StringW get_UserDomainName() ;

/// @brief Method get_UserName addr 0x24b9e1c size 0x4 virtual false final false
static ::StringW get_UserName() ;

/// @brief Method Exit addr 0x24b9e20 size 0x4 virtual false final false
static void Exit(int32_t exitCode) ;

/// @brief Method GetCommandLineArgs addr 0x24b9e24 size 0x4 virtual false final false
static ::ArrayW<::StringW> GetCommandLineArgs() ;

/// @brief Method internalGetEnvironmentVariable_native addr 0x24b9e28 size 0x4 virtual false final false
static ::StringW internalGetEnvironmentVariable_native(::cordl_internals::intptr_t variable) ;

/// @brief Method internalGetEnvironmentVariable addr 0x24b9e2c size 0xc8 virtual false final false
static ::StringW internalGetEnvironmentVariable(::StringW variable) ;

/// @brief Method GetEnvironmentVariable addr 0x24b9ef4 size 0x4 virtual false final false
static ::StringW GetEnvironmentVariable(::StringW variable) ;

/// @brief Method GetEnvironmentVariables addr 0x24b9ef8 size 0xcc virtual false final false
static System::Collections::IDictionary GetEnvironmentVariables() ;

/// @brief Method GetFolderPath addr 0x24b9fc8 size 0x8 virtual false final false
static ::StringW GetFolderPath(System::System__Environment__SpecialFolder folder) ;

/// @brief Method GetWindowsFolderPath addr 0x24ba004 size 0x4 virtual false final false
static ::StringW GetWindowsFolderPath(int32_t folder) ;

/// @brief Method GetFolderPath addr 0x24b9fd0 size 0x34 virtual false final false
...
/// @brief Method ReadXdgUserDir addr 0x24ba4c0 size 0x474 virtual false final false
static ::StringW ReadXdgUserDir(::StringW config_dir, ::StringW home_dir, ::StringW key, ::StringW fallback) ;

/// @brief Method UnixGetFolderPath addr 0x24ba020 size 0x4a0 virtual false final false
...
/// @brief Method GetEnvironmentVariable addr 0x24ba938 size 0x10 virtual false final false
static ::StringW GetEnvironmentVariable(::StringW variable, System::EnvironmentVariableTarget target) ;

/// @brief Method SetEnvironmentVariable addr 0x24ba948 size 0x17c virtual false final false
static void SetEnvironmentVariable(::StringW variable, ::StringW value) ;

/// @brief Method InternalSetEnvironmentVariable addr 0x24bab34 size 0x4 virtual false final false
static void InternalSetEnvironmentVariable(void* variable, int32_t variable_length, void* value, int32_t value_length) ;

/// @brief Method InternalSetEnvironmentVariable addr 0x24baac4 size 0x70 virtual false final false
static void InternalSetEnvironmentVariable(::StringW variable, ::StringW value) ;

/// @brief Method FailFast addr 0x24bab38 size 0x8 virtual false final false
static void FailFast(::StringW message, System::Exception exception) ;

/// @brief Method FailFast addr 0x24bab40 size 0x4 virtual false final false
static void FailFast(::StringW message, System::Exception exception, ::StringW errorSource) ;

/// @brief Method get_ProcessorCount addr 0x24bab44 size 0x4 virtual false final false
static int32_t get_ProcessorCount() ;

/// @brief Method get_IsRunningOnWindows addr 0x24ba008 size 0x18 virtual false final false
static bool get_IsRunningOnWindows() ;

/// @brief Method GetLogicalDrivesInternal addr 0x24bab48 size 0x4 virtual false final false
static ::ArrayW<::StringW> GetLogicalDrivesInternal() ;

/// @brief Method GetEnvironmentVariableNames addr 0x24b9fc4 size 0x4 virtual false final false
static ::ArrayW<::StringW> GetEnvironmentVariableNames() ;

/// @brief Method GetMachineConfigPath addr 0x24bab4c size 0x4 virtual false final false
static ::StringW GetMachineConfigPath() ;

/// @brief Method internalGetHome addr 0x24ba934 size 0x4 virtual false final false
static ::StringW internalGetHome() ;

/// @brief Method GetPageSize addr 0x24bab50 size 0x4 virtual false final false
static int32_t GetPageSize() ;

/// @brief Method get_IsUnix addr 0x24bab54 size 0x38 virtual false final false
static bool get_IsUnix() ;

/// @brief Method GetStackTrace addr 0x24bab8c size 0x98 virtual false final false
