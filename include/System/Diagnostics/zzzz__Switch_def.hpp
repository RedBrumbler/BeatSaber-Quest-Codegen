...
/// @brief Method .ctor addr 0x2808c58 size 0x60 virtual false final false
...
/// @brief Method .ctor addr 0x2808cb8 size 0x24c virtual false final false
 void _ctor(::StringW displayName, ::StringW description, ::StringW defaultSwitchValue) ;

/// @brief Method _pruneCachedSwitches addr 0x2808f04 size 0x4e4 virtual false final false
