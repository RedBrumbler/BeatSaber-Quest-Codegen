...
/// @brief Method IsLogging addr 0x243ff40 size 0x4 virtual false final false
static bool IsLogging() ;

/// @brief Method Log_icall addr 0x243ff44 size 0x4 virtual false final false
static void Log_icall(int32_t level, ByRef<::StringW> category, ByRef<::StringW> message) ;

/// @brief Method Log addr 0x243ff48 size 0x6c virtual false final false
static void Log(int32_t level, ::StringW category, ::StringW message) ;

/// @brief Method NotifyOfCrossThreadDependency addr 0x243ffb4 size 0x4 virtual false final false
