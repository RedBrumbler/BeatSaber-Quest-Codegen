...
/// @brief Method .ctor addr 0x280ccbc size 0x84 virtual false final false
 void _ctor(System::Diagnostics::Process parent) ;

/// @brief Method get_ArgumentList addr 0x280fe34 size 0x80 virtual false final false
 System::Collections::ObjectModel::Collection_1<::StringW> get_ArgumentList() ;

/// @brief Method get_Arguments addr 0x280feb4 size 0x54 virtual false final false
 ::StringW get_Arguments() ;

/// @brief Method set_Arguments addr 0x280ffb0 size 0x8 virtual false final false
 void set_Arguments(::StringW value) ;

/// @brief Method get_EnvironmentVariables addr 0x280f8c4 size 0x570 virtual false final false
 System::Collections::Specialized::StringDictionary get_EnvironmentVariables() ;

/// @brief Method get_RedirectStandardInput addr 0x280ffb8 size 0x8 virtual false final false
 bool get_RedirectStandardInput() ;

/// @brief Method get_RedirectStandardOutput addr 0x280ffc0 size 0x8 virtual false final false
 bool get_RedirectStandardOutput() ;

/// @brief Method get_RedirectStandardError addr 0x280ffc8 size 0x8 virtual false final false
 bool get_RedirectStandardError() ;

/// @brief Method get_StandardErrorEncoding addr 0x280ffd0 size 0x8 virtual false final false
 System::Text::Encoding get_StandardErrorEncoding() ;

/// @brief Method get_StandardOutputEncoding addr 0x280ffd8 size 0x8 virtual false final false
 System::Text::Encoding get_StandardOutputEncoding() ;

/// @brief Method get_UseShellExecute addr 0x280ffe0 size 0x8 virtual false final false
 bool get_UseShellExecute() ;

/// @brief Method get_UserName addr 0x280f550 size 0x54 virtual false final false
 ::StringW get_UserName() ;

/// @brief Method get_Password addr 0x280ffe8 size 0x8 virtual false final false
 System::Security::SecureString get_Password() ;

/// @brief Method get_Domain addr 0x280ff5c size 0x54 virtual false final false
 ::StringW get_Domain() ;

/// @brief Method get_LoadUserProfile addr 0x280fff0 size 0x8 virtual false final false
 bool get_LoadUserProfile() ;

/// @brief Method get_FileName addr 0x280d9e0 size 0x54 virtual false final false
 ::StringW get_FileName() ;

/// @brief Method set_FileName addr 0x280fff8 size 0x8 virtual false final false
 void set_FileName(::StringW value) ;

/// @brief Method get_WorkingDirectory addr 0x280ff08 size 0x54 virtual false final false
 ::StringW get_WorkingDirectory() ;

/// @brief Method get_HaveEnvVars addr 0x280f8b4 size 0x10 virtual false final false
 bool get_HaveEnvVars() ;

/// @brief Method get_StandardInputEncoding addr 0x2810000 size 0x8 virtual false final false
