...
/// @brief Method set_Guid addr 0x2442040 size 0x8 virtual false final false
 void set_Guid(::StringW value) ;

/// @brief Method set_Name addr 0x2442048 size 0x8 virtual false final false
 void set_Name(::StringW value) ;

// Ctor Parameters []
explicit EventSourceAttribute() ;

/// @brief Method .ctor addr 0x2442050 size 0x8 virtual false final false
 void _ctor() ;
