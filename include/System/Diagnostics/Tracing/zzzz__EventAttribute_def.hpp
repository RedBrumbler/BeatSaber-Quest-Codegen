...
/// @brief Method .ctor addr 0x24419e8 size 0x28 virtual false final false
 void _ctor(int32_t eventId) ;

/// @brief Method set_EventId addr 0x2441a10 size 0x8 virtual false final false
 void set_EventId(int32_t value) ;

/// @brief Method set_Level addr 0x2441a18 size 0x8 virtual false final false
 void set_Level(System::Diagnostics::Tracing::EventLevel value) ;

/// @brief Method set_Keywords addr 0x2441a20 size 0x8 virtual false final false
 void set_Keywords(System::Diagnostics::Tracing::EventKeywords value) ;

/// @brief Method set_Message addr 0x2441a28 size 0x8 virtual false final false
