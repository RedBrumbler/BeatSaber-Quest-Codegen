...
/// @brief Method set_DataPointer addr 0x2442028 size 0x8 virtual false final false
 void set_DataPointer(::cordl_internals::intptr_t value) ;

/// @brief Method set_Size addr 0x2442030 size 0x8 virtual false final false
 void set_Size(int32_t value) ;

/// @brief Method set_Reserved addr 0x2442038 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2441a30 size 0x3c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2441a6c size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x2441a94 size 0x28 virtual false final false
 void _ctor(System::Guid eventSourceGuid, ::StringW eventSourceName) ;

/// @brief Method Finalize addr 0x2441abc size 0xa0 virtual true final false
 void Finalize() ;

/// @brief Method set_Name addr 0x2441b5c size 0x8 virtual false final false
 void set_Name(::StringW value) ;

/// @brief Method IsEnabled addr 0x2441b64 size 0x8 virtual false final false
 bool IsEnabled() ;

/// @brief Method IsEnabled addr 0x2441b6c size 0x8 virtual false final false
 bool IsEnabled(System::Diagnostics::Tracing::EventLevel level, System::Diagnostics::Tracing::EventKeywords keywords) ;

/// @brief Method Dispose addr 0x2441b74 size 0x6c virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x2441be0 size 0x4 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method WriteEvent addr 0x2441be4 size 0x44 virtual false final false
 void WriteEvent(int32_t eventId) ;

/// @brief Method WriteEvent addr 0x2441c2c size 0xbc virtual false final false
 void WriteEvent(int32_t eventId, int32_t arg1) ;

/// @brief Method WriteEvent addr 0x2441ce8 size 0x104 virtual false final false
 void WriteEvent(int32_t eventId, int32_t arg1, int32_t arg2) ;

/// @brief Method WriteEvent addr 0x2441dec size 0x14c virtual false final false
 void WriteEvent(int32_t eventId, int32_t arg1, int32_t arg2, int32_t arg3) ;

/// @brief Method WriteEvent addr 0x2441c28 size 0x4 virtual false final false
 void WriteEvent(int32_t eventId, ::ArrayW<::bs_hook::Il2CppWrapperType> args) ;

/// @brief Method WriteEvent addr 0x2441f38 size 0xec virtual false final false
 void WriteEvent(int32_t eventId, ::StringW arg1, ::StringW arg2, ::StringW arg3) ;

/// @brief Method WriteEventCore addr 0x2442024 size 0x4 virtual false final false
