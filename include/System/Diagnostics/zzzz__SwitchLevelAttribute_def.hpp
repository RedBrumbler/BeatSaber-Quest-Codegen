...
/// @brief Method .ctor addr 0x2809474 size 0x2c virtual false final false
 void _ctor(System::Type switchLevelType) ;

/// @brief Method set_SwitchLevelType addr 0x28094a0 size 0xc0 virtual false final false
