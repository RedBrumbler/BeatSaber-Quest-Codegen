...
namespace System::Diagnostics {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7813))}
...
/// @brief Method GetPrefix addr 0x28101ac size 0x7c virtual false final false
static ::StringW GetPrefix(::StringW var, ::StringW target) ;

// Ctor Parameters []
explicit DefaultTraceListener() ;

/// @brief Method .ctor addr 0x280a080 size 0x64 virtual false final false
 void _ctor() ;

/// @brief Method get_LogFileName addr 0x2810228 size 0x8 virtual false final false
 ::StringW get_LogFileName() ;

/// @brief Method WriteWindowsDebugString addr 0x2810230 size 0x4 virtual false final false
static void WriteWindowsDebugString(void* message) ;

/// @brief Method WriteDebugString addr 0x2810234 size 0xb0 virtual false final false
 void WriteDebugString(::StringW message) ;

/// @brief Method WriteMonoTrace addr 0x28102e4 size 0x1ac virtual false final false
 void WriteMonoTrace(::StringW message) ;

/// @brief Method WritePrefix addr 0x281070c size 0x88 virtual false final false
 void WritePrefix() ;

/// @brief Method WriteImpl addr 0x2810794 size 0xbc virtual false final false
 void WriteImpl(::StringW message) ;

/// @brief Method WriteLogFile addr 0x2810490 size 0x27c virtual false final false
 void WriteLogFile(::StringW message, ::StringW logFile) ;

/// @brief Method Write addr 0x2810850 size 0x4 virtual true final false
 void Write(::StringW message) ;

/// @brief Method WriteLine addr 0x2810854 size 0x48 virtual true final false
