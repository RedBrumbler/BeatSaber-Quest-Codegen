...
/// @brief Method get_frame_info addr 0x2440018 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2440020 size 0x50 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2440070 size 0x60 virtual false final false
 void _ctor(int32_t skipFrames, bool fNeedFileInfo) ;

/// @brief Method GetFileLineNumber addr 0x24400d0 size 0x8 virtual true final false
 int32_t GetFileLineNumber() ;

/// @brief Method GetFileName addr 0x24400d8 size 0x8 virtual true final false
 ::StringW GetFileName() ;

/// @brief Method GetSecureFileName addr 0x24400e0 size 0xd4 virtual false final false
 ::StringW GetSecureFileName() ;

/// @brief Method GetILOffset addr 0x24401b4 size 0x8 virtual true final false
 int32_t GetILOffset() ;

/// @brief Method GetMethod addr 0x24401bc size 0x8 virtual true final false
 System::Reflection::MethodBase GetMethod() ;

/// @brief Method GetNativeOffset addr 0x24401c4 size 0x8 virtual true final false
 int32_t GetNativeOffset() ;

/// @brief Method GetMethodAddress addr 0x24401cc size 0x8 virtual false final false
 int64_t GetMethodAddress() ;

/// @brief Method GetMethodIndex addr 0x24401d4 size 0x8 virtual false final false
 uint32_t GetMethodIndex() ;

/// @brief Method GetInternalMethodName addr 0x24401dc size 0x8 virtual false final false
 ::StringW GetInternalMethodName() ;

/// @brief Method ToString addr 0x24401e4 size 0x23c virtual true final false
 ::StringW ToString() ;
