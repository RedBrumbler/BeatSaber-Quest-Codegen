...
/// @brief Method .ctor addr 0x280a010 size 0x70 virtual false final false
 void _ctor() ;

/// @brief Method get_Count addr 0x280ad54 size 0x24 virtual true final true
 int32_t get_Count() ;

/// @brief Method Add addr 0x280a1ac size 0x138 virtual false final false
 int32_t Add(System::Diagnostics::TraceListener listener) ;

/// @brief Method Clear addr 0x280ae6c size 0x60 virtual true final true
 void Clear() ;

/// @brief Method GetEnumerator addr 0x280aecc size 0x24 virtual true final true
 System::Collections::IEnumerator GetEnumerator() ;

/// @brief Method InitializeListener addr 0x280ad78 size 0xf4 virtual false final false
 void InitializeListener(System::Diagnostics::TraceListener listener) ;

/// @brief Method RemoveAt addr 0x280aef0 size 0x120 virtual true final true
 void RemoveAt(int32_t index) ;

/// @brief Method System.Collections.IList.get_Item addr 0x280b010 size 0x24 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IList_get_Item(int32_t index) ;

/// @brief Method System.Collections.IList.set_Item addr 0x280b034 size 0x110 virtual true final true
 void System_Collections_IList_set_Item(int32_t index, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.IList.get_IsReadOnly addr 0x280b144 size 0x8 virtual true final true
 bool System_Collections_IList_get_IsReadOnly() ;

/// @brief Method System.Collections.IList.get_IsFixedSize addr 0x280b14c size 0x8 virtual true final true
 bool System_Collections_IList_get_IsFixedSize() ;

/// @brief Method System.Collections.IList.Add addr 0x280b154 size 0x1e4 virtual true final true
 int32_t System_Collections_IList_Add(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.IList.Contains addr 0x280b338 size 0x24 virtual true final true
 bool System_Collections_IList_Contains(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.IList.IndexOf addr 0x280b35c size 0x24 virtual true final true
 int32_t System_Collections_IList_IndexOf(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.IList.Insert addr 0x280b380 size 0x1dc virtual true final true
 void System_Collections_IList_Insert(int32_t index, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.IList.Remove addr 0x280b55c size 0x120 virtual true final true
 void System_Collections_IList_Remove(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.ICollection.get_SyncRoot addr 0x280b67c size 0x4 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_ICollection_get_SyncRoot() ;

/// @brief Method System.Collections.ICollection.get_IsSynchronized addr 0x280b680 size 0x8 virtual true final true
 bool System_Collections_ICollection_get_IsSynchronized() ;

/// @brief Method System.Collections.ICollection.CopyTo addr 0x280b688 size 0x130 virtual true final true
