...
/// @brief Method GetTimestamp addr 0x2809b68 size 0x4 virtual false final false
static int64_t GetTimestamp() ;

/// @brief Method StartNew addr 0x281090c size 0x64 virtual false final false
static System::Diagnostics::Stopwatch StartNew() ;

// Ctor Parameters []
explicit Stopwatch() ;

/// @brief Method .ctor addr 0x2810970 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_Elapsed addr 0x28109e0 size 0xf8 virtual false final false
 System::TimeSpan get_Elapsed() ;

/// @brief Method get_ElapsedMilliseconds addr 0x2810b48 size 0x11c virtual false final false
 int64_t get_ElapsedMilliseconds() ;

/// @brief Method get_ElapsedTicks addr 0x2810ad8 size 0x70 virtual false final false
 int64_t get_ElapsedTicks() ;

/// @brief Method get_IsRunning addr 0x2810c64 size 0x8 virtual false final false
 bool get_IsRunning() ;

/// @brief Method Reset addr 0x2810c6c size 0xc virtual false final false
 void Reset() ;

/// @brief Method Start addr 0x2810978 size 0x68 virtual false final false
 void Start() ;

/// @brief Method Stop addr 0x2810c78 size 0x78 virtual false final false
 void Stop() ;
