...
/// @brief Method .ctor addr 0x2440420 size 0x24 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "fNeedFileInfo", ty: "bool", modifiers: "", def_value: None }]
explicit StackTrace(bool fNeedFileInfo) ;

/// @brief Method .ctor addr 0x2440640 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x2440670 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x24406a0 size 0x34 virtual false final false
 void _ctor(int32_t skipFrames, bool fNeedFileInfo) ;

/// @brief Method init_frames addr 0x2440444 size 0x1fc virtual false final false
 void init_frames(int32_t skipFrames, bool fNeedFileInfo) ;

/// @brief Method get_trace addr 0x24406d4 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x24406dc size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x24406e8 size 0xf0 virtual false final false
 void _ctor(System::Exception e, int32_t skipFrames, bool fNeedFileInfo) ;

/// @brief Method get_FrameCount addr 0x24407d8 size 0x18 virtual true final false
 int32_t get_FrameCount() ;

/// @brief Method GetFrame addr 0x24407f0 size 0x60 virtual true final false
 System::Diagnostics::StackFrame GetFrame(int32_t index) ;

/// @brief Method GetAotId addr 0x2440850 size 0xc8 virtual false final false
static ::StringW GetAotId() ;

/// @brief Method AddFrames addr 0x2440918 size 0x4b0 virtual false final false
 bool AddFrames(System::Text::StringBuilder sb, bool separator, ByRef<bool> isAsync) ;

/// @brief Method GetFullNameForStackTrace addr 0x2440dc8 size 0x658 virtual false final false
...
/// @brief Method ConvertAsyncStateMachineMethod addr 0x2441420 size 0x460 virtual false final false
static void ConvertAsyncStateMachineMethod(ByRef<System::Reflection::MethodBase> method, ByRef<System::Type> declaringType) ;

/// @brief Method ToString addr 0x2441880 size 0x15c virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x24419dc size 0xc virtual false final false
