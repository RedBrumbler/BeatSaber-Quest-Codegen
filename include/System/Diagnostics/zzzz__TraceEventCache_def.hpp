...
/// @brief Method get_Callstack addr 0x2809950 size 0x20 virtual false final false
 ::StringW get_Callstack() ;

/// @brief Method get_LogicalOperationStack addr 0x2809970 size 0x18 virtual false final false
 System::Collections::Stack get_LogicalOperationStack() ;

/// @brief Method get_DateTime addr 0x2809988 size 0x94 virtual false final false
 System::DateTime get_DateTime() ;

/// @brief Method get_ProcessId addr 0x2809a1c size 0x4 virtual false final false
 int32_t get_ProcessId() ;

/// @brief Method get_ThreadId addr 0x2809a74 size 0x70 virtual false final false
 ::StringW get_ThreadId() ;

/// @brief Method get_Timestamp addr 0x2809b04 size 0x64 virtual false final false
 int64_t get_Timestamp() ;

/// @brief Method InitProcessInfo addr 0x2809b6c size 0x130 virtual false final false
static void InitProcessInfo() ;

/// @brief Method GetProcessId addr 0x2809a20 size 0x54 virtual false final false
static int32_t GetProcessId() ;

/// @brief Method GetThreadId addr 0x2809ae4 size 0x20 virtual false final false
static int32_t GetThreadId() ;

// Ctor Parameters []
explicit TraceEventCache() ;

/// @brief Method .ctor addr 0x2809f70 size 0x70 virtual false final false
 void _ctor() ;
