...
/// @brief Method .ctor addr 0x280a424 size 0x38 virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method get_IsThreadSafe addr 0x280a45c size 0x8 virtual true final false
 bool get_IsThreadSafe() ;

/// @brief Method Dispose addr 0x280a464 size 0x6c virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x280a4d0 size 0x4 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Flush addr 0x280a4d4 size 0x4 virtual true final false
 void Flush() ;

/// @brief Method set_IndentLevel addr 0x280a0e4 size 0x1c virtual false final false
 void set_IndentLevel(int32_t value) ;

/// @brief Method set_IndentSize addr 0x280a100 size 0xac virtual false final false
 void set_IndentSize(int32_t value) ;

/// @brief Method get_Filter addr 0x280a4d8 size 0x8 virtual false final false
 System::Diagnostics::TraceFilter get_Filter() ;

/// @brief Method get_NeedIndent addr 0x280a4e0 size 0x8 virtual false final false
 bool get_NeedIndent() ;

/// @brief Method set_NeedIndent addr 0x280a4e8 size 0xc virtual false final false
 void set_NeedIndent(bool value) ;

/// @brief Method get_TraceOutputOptions addr 0x280a4f4 size 0x8 virtual false final false
...
/// @brief Method WriteIndent addr 0x280a4fc size 0xd4 virtual true final false
 void WriteIndent() ;

/// @brief Method WriteLine addr 0x0 size 0xffffffffffffffff virtual true final false
 void WriteLine(::StringW message) ;

/// @brief Method TraceEvent addr 0x280a5d0 size 0xc4 virtual true final false
...
/// @brief Method WriteHeader addr 0x280a694 size 0x110 virtual false final false
 void WriteHeader(::StringW source, System::Diagnostics::TraceEventType eventType, int32_t id) ;

/// @brief Method WriteFooter addr 0x280a7a4 size 0x5a0 virtual false final false
 void WriteFooter(System::Diagnostics::TraceEventCache eventCache) ;

/// @brief Method IsEnabled addr 0x280ad44 size 0x10 virtual false final false
