...
/// @brief Method get_TotalProcessorTime addr 0x280cf00 size 0xc virtual false final false
 System::TimeSpan get_TotalProcessorTime() ;

// Ctor Parameters []
explicit ProcessThreadTimes() ;

/// @brief Method .ctor addr 0x280cb5c size 0x8 virtual false final false
 void _ctor() ;
