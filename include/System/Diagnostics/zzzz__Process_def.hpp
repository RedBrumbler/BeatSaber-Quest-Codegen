...
namespace System::Diagnostics {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8339))}
...
/// @brief Method .ctor addr 0x280bbb0 size 0x88 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x280bc38 size 0x9c virtual false final false
 void _ctor(::StringW machineName, bool isRemoteMachine, int32_t processId, System::Diagnostics::ProcessInfo processInfo) ;

/// @brief Method get_Associated addr 0x280bcd4 size 0x20 virtual false final false
 bool get_Associated() ;

/// @brief Method get_HasExited addr 0x280bcf4 size 0x370 virtual false final false
 bool get_HasExited() ;

/// @brief Method GetProcessTimes addr 0x280c894 size 0x2c8 virtual false final false
 System::Diagnostics::ProcessThreadTimes GetProcessTimes() ;

/// @brief Method get_Handle addr 0x280cb64 size 0x30 virtual false final false
 ::cordl_internals::intptr_t get_Handle() ;

/// @brief Method get_Id addr 0x2809d24 size 0x1c virtual false final false
 int32_t get_Id() ;

/// @brief Method get_StartInfo addr 0x280cc50 size 0x6c virtual false final false
 System::Diagnostics::ProcessStartInfo get_StartInfo() ;

/// @brief Method get_SynchronizingObject addr 0x280cd40 size 0x1a0 virtual false final false
 System::ComponentModel::ISynchronizeInvoke get_SynchronizingObject() ;

/// @brief Method get_TotalProcessorTime addr 0x280cee0 size 0x20 virtual false final false
 System::TimeSpan get_TotalProcessorTime() ;

/// @brief Method ReleaseProcessHandle addr 0x280cf0c size 0x28 virtual false final false
 void ReleaseProcessHandle(Microsoft::Win32::SafeHandles::SafeProcessHandle handle) ;

/// @brief Method CompletionCallback addr 0x280cf34 size 0x18 virtual false final false
 void CompletionCallback(::bs_hook::Il2CppWrapperType context, bool wasSignaled) ;

/// @brief Method Dispose addr 0x280d060 size 0x50 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Close addr 0x280d0b0 size 0x158 virtual false final false
 void Close() ;

/// @brief Method EnsureState addr 0x280c064 size 0x138 virtual false final false
 void EnsureState(System::Diagnostics::System__Diagnostics__Process__State state) ;

/// @brief Method EnsureWatchingForExit addr 0x280d21c size 0x234 virtual false final false
 void EnsureWatchingForExit() ;

/// @brief Method GetProcessById addr 0x280d450 size 0x48 virtual false final false
static System::Diagnostics::Process GetProcessById(int32_t processId) ;

/// @brief Method GetCurrentProcess addr 0x2809c9c size 0x88 virtual false final false
static System::Diagnostics::Process GetCurrentProcess() ;

/// @brief Method OnExited addr 0x280d670 size 0x240 virtual false final false
 void OnExited() ;

/// @brief Method GetProcessHandle addr 0x280c19c size 0x4c4 virtual false final false
 Microsoft::Win32::SafeHandles::SafeProcessHandle GetProcessHandle(int32_t access, bool throwIfExited) ;

/// @brief Method GetProcessHandle addr 0x280d8b0 size 0x8 virtual false final false
 Microsoft::Win32::SafeHandles::SafeProcessHandle GetProcessHandle(int32_t access) ;

/// @brief Method OpenProcessHandle addr 0x280cb94 size 0xbc virtual false final false
 Microsoft::Win32::SafeHandles::SafeProcessHandle OpenProcessHandle(int32_t access) ;

/// @brief Method Refresh addr 0x280d208 size 0x14 virtual false final false
 void Refresh() ;

/// @brief Method SetProcessHandle addr 0x280d8b8 size 0x1c virtual false final false
 void SetProcessHandle(Microsoft::Win32::SafeHandles::SafeProcessHandle processHandle) ;

/// @brief Method SetProcessId addr 0x280d8d4 size 0x10 virtual false final false
 void SetProcessId(int32_t processId) ;

/// @brief Method Start addr 0x280d8e4 size 0xfc virtual false final false
 bool Start() ;

/// @brief Method StopWatchingForExit addr 0x280cf4c size 0x114 virtual false final false
 void StopWatchingForExit() ;

/// @brief Method ToString addr 0x280f1d4 size 0x16c virtual true final false
 ::StringW ToString() ;
...
/// @brief Method .ctor addr 0x280f340 size 0x90 virtual false final false
 void _ctor(Microsoft::Win32::SafeHandles::SafeProcessHandle handle, int32_t id) ;

/// @brief Method ProcessName_icall addr 0x280f3d0 size 0x4 virtual false final false
static ::StringW ProcessName_icall(::cordl_internals::intptr_t handle) ;

/// @brief Method ProcessName_internal addr 0x280f3d4 size 0xe0 virtual false final false
static ::StringW ProcessName_internal(Microsoft::Win32::SafeHandles::SafeProcessHandle handle) ;

/// @brief Method get_ProcessName addr 0x2809d40 size 0x230 virtual false final false
 ::StringW get_ProcessName() ;

/// @brief Method GetProcess_internal addr 0x280f4b4 size 0x4 virtual false final false
static ::cordl_internals::intptr_t GetProcess_internal(int32_t pid) ;

/// @brief Method GetProcessById addr 0x280d498 size 0x1d8 virtual false final false
static System::Diagnostics::Process GetProcessById(int32_t processId, ::StringW machineName) ;

/// @brief Method IsLocalMachine addr 0x280f4b8 size 0x90 virtual false final false
static bool IsLocalMachine(::StringW machineName) ;

/// @brief Method ShellExecuteEx_internal addr 0x280f548 size 0x4 virtual false final false
...
/// @brief Method CreateProcess_internal addr 0x280f54c size 0x4 virtual false final false
...
/// @brief Method StartWithShellExecuteEx addr 0x280da34 size 0x3c8 virtual false final false
 bool StartWithShellExecuteEx(System::Diagnostics::ProcessStartInfo startInfo) ;

/// @brief Method CreatePipe addr 0x280f6e4 size 0x19c virtual false final false
static void CreatePipe(ByRef<::cordl_internals::intptr_t> read, ByRef<::cordl_internals::intptr_t> write, bool writeDirection) ;

/// @brief Method get_IsWindows addr 0x280f880 size 0x34 virtual false final false
static bool get_IsWindows() ;

/// @brief Method StartWithCreateProcess addr 0x280ddfc size 0x13d8 virtual false final false
 bool StartWithCreateProcess(System::Diagnostics::ProcessStartInfo startInfo) ;

/// @brief Method FillUserInfo addr 0x280f5a4 size 0x140 virtual false final false
...
/// @brief Method RaiseOnExited addr 0x280c7b4 size 0xe0 virtual false final false
 void RaiseOnExited() ;
