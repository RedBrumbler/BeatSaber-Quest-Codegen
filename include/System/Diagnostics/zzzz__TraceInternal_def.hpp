...
/// @brief Method get_Listeners addr 0x28095ac size 0x254 virtual false final false
static System::Diagnostics::TraceListenerCollection get_Listeners() ;

/// @brief Method get_AutoFlush addr 0x280984c size 0x60 virtual false final false
static bool get_AutoFlush() ;

/// @brief Method get_IndentLevel addr 0x280a2e4 size 0x58 virtual false final false
static int32_t get_IndentLevel() ;

/// @brief Method get_IndentSize addr 0x280a33c size 0x60 virtual false final false
static int32_t get_IndentSize() ;

/// @brief Method InitializeSettings addr 0x280a00c size 0x4 virtual false final false
