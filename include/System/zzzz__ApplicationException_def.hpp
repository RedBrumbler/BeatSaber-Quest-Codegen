...
/// @brief Method .ctor addr 0x23eaab0 size 0x80 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit ApplicationException(::StringW message) ;

/// @brief Method .ctor addr 0x23eab30 size 0x78 virtual false final false
 void _ctor(::StringW message) ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "innerException", ty: "System::Exception", modifiers: "", def_value: None }]
explicit ApplicationException(::StringW message, System::Exception innerException) ;

/// @brief Method .ctor addr 0x23eaba8 size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x23eac28 size 0x80 virtual false final false
