...
/// @brief Method get_State addr 0x247376c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2473774 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x247379c size 0x50 virtual false final false
 void _ctor(System::Threading::LazyThreadSafetyMode mode, System::Exception exception) ;

/// @brief Method ThrowException addr 0x24737ec size 0x1c virtual false final false
 void ThrowException() ;

/// @brief Method Create addr 0x2473808 size 0x140 virtual false final false
static System::LazyHelper Create(System::Threading::LazyThreadSafetyMode mode, bool useDefaultConstructor) ;

/// @brief Method CreateViaDefaultConstructor addr 0x2473948 size 0xcc virtual false final false
