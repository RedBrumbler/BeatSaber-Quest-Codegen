...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::System__DelegateSerializationHolder__DelegateEntry::*)(System::Delegate, ::StringW)>(&System::System__DelegateSerializationHolder__DelegateEntry::_ctor)> {
  constexpr static std::size_t size = 0x11c;
  constexpr static std::size_t addrs = 0x24be8dc;
...
//  Writing Method size for method: System::System__DelegateSerializationHolder__DelegateEntry.DeserializeDelegate
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Delegate (System::System__DelegateSerializationHolder__DelegateEntry::*)(System::Runtime::Serialization::SerializationInfo, int32_t)>(&System::System__DelegateSerializationHolder__DelegateEntry::DeserializeDelegate)> {
  constexpr static std::size_t size = 0x278;
  constexpr static std::size_t addrs = 0x24be664;
...
constexpr void System::System__DelegateSerializationHolder__DelegateEntry::__set_type(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x10>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::StringW>(value));
}
constexpr ::StringW System::System__DelegateSerializationHolder__DelegateEntry::__get_type() const {
return ::cordl_internals::getInstanceField<::StringW, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::System__DelegateSerializationHolder__DelegateEntry::__set_assembly(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x18>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::StringW>(value));
}
constexpr ::StringW System::System__DelegateSerializationHolder__DelegateEntry::__get_assembly() const {
return ::cordl_internals::getInstanceField<::StringW, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::System__DelegateSerializationHolder__DelegateEntry::__set_target(::bs_hook::Il2CppWrapperType value)  {
...
constexpr ::bs_hook::Il2CppWrapperType System::System__DelegateSerializationHolder__DelegateEntry::__get_target() const {
return ::cordl_internals::getInstanceField<::bs_hook::Il2CppWrapperType, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::System__DelegateSerializationHolder__DelegateEntry::__set_targetTypeAssembly(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::StringW>(value));
}
constexpr ::StringW System::System__DelegateSerializationHolder__DelegateEntry::__get_targetTypeAssembly() const {
return ::cordl_internals::getInstanceField<::StringW, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::System__DelegateSerializationHolder__DelegateEntry::__set_targetTypeName(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x30>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::StringW>(value));
}
constexpr ::StringW System::System__DelegateSerializationHolder__DelegateEntry::__get_targetTypeName() const {
return ::cordl_internals::getInstanceField<::StringW, 0x30>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::System__DelegateSerializationHolder__DelegateEntry::__set_methodName(::StringW value)  {
::cordl_internals::setInstanceField<::StringW, 0x38>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::StringW>(value));
}
constexpr ::StringW System::System__DelegateSerializationHolder__DelegateEntry::__get_methodName() const {
return ::cordl_internals::getInstanceField<::StringW, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::System__DelegateSerializationHolder__DelegateEntry::__set_delegateEntry(System::System__DelegateSerializationHolder__DelegateEntry value)  {
::cordl_internals::setInstanceField<System::System__DelegateSerializationHolder__DelegateEntry, 0x40>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::System__DelegateSerializationHolder__DelegateEntry>(value));
}
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, del, targetLabel);
 ...
 System::Delegate System::System__DelegateSerializationHolder__DelegateEntry::DeserializeDelegate(System::Runtime::Serialization::SerializationInfo info, int32_t index)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::System__DelegateSerializationHolder__DelegateEntry>::get(),
                            "DeserializeDelegate",
                            std::vector<Il2CppClass*>{},
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(System::Delegate, System::Runtime::Serialization::SerializationInfo, System::Runtime::Serialization::StreamingContext)>(&System::DelegateSerializationHolder::GetDelegateData)> {
  ...
  constexpr static std::size_t addrs = 0x24be044;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::DelegateSerializationHolder::*)(System::Runtime::Serialization::SerializationInfo, System::Runtime::Serialization::StreamingContext)>(&System::DelegateSerializationHolder::GetObjectData)> {
  ...
  constexpr static std::size_t addrs = 0x24be9f8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::bs_hook::Il2CppWrapperType (System::DelegateSerializationHolder::*)(System::Runtime::Serialization::StreamingContext)>(&System::DelegateSerializationHolder::GetRealObject)> {
  ...
  constexpr static std::size_t addrs = 0x24bea38;
