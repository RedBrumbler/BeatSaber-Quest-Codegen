...
/// @brief Method get_Length addr 0x2469e0c size 0x3c virtual false final false
 int32_t get_Length() ;

/// @brief Method .ctor addr 0x2469e48 size 0x24 virtual false final false
 void _ctor(System::ReadOnlySpan_1<char16_t> str, System::Globalization::DateTimeFormatInfo dtfi, bool checkDigitToken) ;

/// @brief Method .ctor addr 0x2469e6c size 0xc4 virtual false final false
 void _ctor(System::ReadOnlySpan_1<char16_t> str, System::Globalization::DateTimeFormatInfo dtfi) ;

/// @brief Method get_CompareInfo addr 0x2469f30 size 0x8 virtual false final false
 System::Globalization::CompareInfo get_CompareInfo() ;

/// @brief Method GetNext addr 0x2469f38 size 0x78 virtual false final false
 bool GetNext() ;

/// @brief Method AtEnd addr 0x2469fb0 size 0x48 virtual false final false
 bool AtEnd() ;

/// @brief Method Advance addr 0x2469ff8 size 0x78 virtual false final false
 bool Advance(int32_t count) ;

/// @brief Method GetRegularToken addr 0x246a070 size 0x2e8 virtual false final false
...
/// @brief Method GetSeparatorToken addr 0x246a358 size 0xe0 virtual false final false
...
/// @brief Method MatchSpecifiedWord addr 0x246a560 size 0x100 virtual false final false
 bool MatchSpecifiedWord(::StringW target) ;

/// @brief Method MatchSpecifiedWords addr 0x246a660 size 0x44c virtual false final false
 bool MatchSpecifiedWords(::StringW target, bool checkWordBoundary, ByRef<int32_t> matchLength) ;

/// @brief Method Match addr 0x246aaac size 0x12c virtual false final false
 bool Match(::StringW str) ;

/// @brief Method Match addr 0x246abd8 size 0x9c virtual false final false
 bool Match(char16_t ch) ;

/// @brief Method MatchLongestWords addr 0x246ac74 size 0xb8 virtual false final false
 int32_t MatchLongestWords(::ArrayW<::StringW> words, ByRef<int32_t> maxMatchStrLen) ;

/// @brief Method GetRepeatCount addr 0x246ad2c size 0xa8 virtual false final false
 int32_t GetRepeatCount() ;

/// @brief Method GetNextDigit addr 0x246add4 size 0xb8 virtual false final false
 bool GetNextDigit() ;

/// @brief Method GetChar addr 0x246ae8c size 0x28 virtual false final false
 char16_t GetChar() ;

/// @brief Method GetDigit addr 0x246aeb4 size 0x2c virtual false final false
 int32_t GetDigit() ;

/// @brief Method SkipWhiteSpaces addr 0x246aee0 size 0xd4 virtual false final false
 void SkipWhiteSpaces() ;

/// @brief Method SkipWhiteSpaceCurrent addr 0x246a438 size 0x128 virtual false final false
 bool SkipWhiteSpaceCurrent() ;

/// @brief Method TrimTail addr 0x246afb4 size 0x10c virtual false final false
 void TrimTail() ;

/// @brief Method RemoveTrailingInQuoteSpaces addr 0x246b0c0 size 0x234 virtual false final false
 void RemoveTrailingInQuoteSpaces() ;

/// @brief Method RemoveLeadingInQuoteSpaces addr 0x246b2f4 size 0x274 virtual false final false
 void RemoveLeadingInQuoteSpaces() ;

/// @brief Method GetSubString addr 0x246b568 size 0x138 virtual false final false
 System::DTSubString GetSubString() ;

/// @brief Method ConsumeSubString addr 0x246b6a0 size 0x6c virtual false final false
