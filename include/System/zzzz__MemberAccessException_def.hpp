...
/// @brief Method .ctor addr 0x2474a94 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit MemberAccessException(::StringW message) ;

/// @brief Method .ctor addr 0x2474af0 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x2474b14 size 0x8 virtual false final false
