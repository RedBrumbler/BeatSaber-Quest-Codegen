...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2328), inst: 5947 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2610)), TypeDefinitionIndex(TypeDefinitionIndex(2328))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2328), inst: 6313 })
// CS Name: System.Action`6
