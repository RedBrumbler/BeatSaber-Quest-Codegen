...
/// @brief Method TryTermInfoDir addr 0x24c4c64 size 0x12c virtual false final false
static ::StringW TryTermInfoDir(::StringW dir, ::StringW term) ;

/// @brief Method SearchTerminfo addr 0x24c4d90 size 0x16c virtual false final false
static ::StringW SearchTerminfo(::StringW term) ;

/// @brief Method WriteConsole addr 0x24c4efc size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x24bc220 size 0x348 virtual false final false
 void _ctor(::StringW term) ;

/// @brief Method get_Initialized addr 0x24c5288 size 0x8 virtual true final true
 bool get_Initialized() ;

/// @brief Method Init addr 0x24c5290 size 0x864 virtual true final true
 void Init() ;

/// @brief Method IncrementX addr 0x24c5e74 size 0x6c virtual false final false
 void IncrementX() ;

/// @brief Method WriteSpecialKey addr 0x24c5f38 size 0x114 virtual false final false
 void WriteSpecialKey(System::ConsoleKeyInfo key) ;

/// @brief Method WriteSpecialKey addr 0x24c61fc size 0x28 virtual false final false
 void WriteSpecialKey(char16_t c) ;

/// @brief Method IsSpecialKey addr 0x24c63a8 size 0x84 virtual false final false
 bool IsSpecialKey(System::ConsoleKeyInfo key) ;

/// @brief Method IsSpecialKey addr 0x24c642c size 0x28 virtual false final false
 bool IsSpecialKey(char16_t c) ;

/// @brief Method GetCursorPosition addr 0x24c5be4 size 0x290 virtual false final false
 void GetCursorPosition() ;

/// @brief Method CheckWindowDimensions addr 0x24c6538 size 0x120 virtual false final false
 void CheckWindowDimensions() ;

/// @brief Method get_WindowHeight addr 0x24c5f0c size 0x2c virtual true final true
 int32_t get_WindowHeight() ;

/// @brief Method get_WindowWidth addr 0x24c5ee0 size 0x2c virtual true final true
 int32_t get_WindowWidth() ;

/// @brief Method AddToBuffer addr 0x24c6454 size 0xe4 virtual false final false
 void AddToBuffer(int32_t b) ;

/// @brief Method AdjustBuffer addr 0x24c6658 size 0x14 virtual false final false
 void AdjustBuffer() ;

/// @brief Method CreateKeyInfoFromInt addr 0x24c6224 size 0x184 virtual false final false
 System::ConsoleKeyInfo CreateKeyInfoFromInt(int32_t n, bool alt) ;

/// @brief Method GetKeyFromBuffer addr 0x24c666c size 0x2cc virtual false final false
 ::bs_hook::Il2CppWrapperType GetKeyFromBuffer(bool cooked) ;

/// @brief Method ReadKeyInternal addr 0x24c6e4c size 0x1c0 virtual false final false
 System::ConsoleKeyInfo ReadKeyInternal(ByRef<bool> fresh) ;

/// @brief Method InputPending addr 0x24c7178 size 0x34 virtual false final false
 bool InputPending() ;

/// @brief Method QueueEcho addr 0x24c71ac size 0xc8 virtual false final false
 void QueueEcho(char16_t c) ;

/// @brief Method Echo addr 0x24c7274 size 0x54 virtual false final false
 void Echo(System::ConsoleKeyInfo key) ;

/// @brief Method EchoFlush addr 0x24c72c8 size 0x34 virtual false final false
 void EchoFlush() ;

/// @brief Method Read addr 0x24c72fc size 0x304 virtual false final false
 int32_t Read(ByRef<::ArrayW<char16_t>> dest, int32_t index, int32_t count) ;

/// @brief Method ReadKey addr 0x24c7600 size 0x64 virtual true final true
 System::ConsoleKeyInfo ReadKey(bool intercept) ;

/// @brief Method ReadLine addr 0x24c7664 size 0x8 virtual true final true
 ::StringW ReadLine() ;

/// @brief Method ReadToEnd addr 0x24c7834 size 0x8 virtual false final false
 ::StringW ReadToEnd() ;

/// @brief Method ReadUntilConditionInternal addr 0x24c766c size 0x1c8 virtual false final false
 ::StringW ReadUntilConditionInternal(bool haltOnNewLine) ;

/// @brief Method SetCursorPosition addr 0x24c604c size 0x1b0 virtual true final true
 void SetCursorPosition(int32_t left, int32_t top) ;

/// @brief Method CreateKeyMap addr 0x24c79b4 size 0x1e98 virtual false final false
 void CreateKeyMap() ;

/// @brief Method InitKeys addr 0x24c700c size 0x16c virtual false final false
 void InitKeys() ;

/// @brief Method AddStringMapping addr 0x24c98c8 size 0x4c virtual false final false
