...
/// @brief Method .ctor addr 0x249292c size 0x74 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType exception, bool isTerminating) ;

/// @brief Method get_ExceptionObject addr 0x24929a0 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_ExceptionObject() ;

/// @brief Method get_IsTerminating addr 0x24929a8 size 0x8 virtual false final false
