...
/// @brief Method .ctor addr 0x2494714 size 0xa8 virtual false final false
 void _ctor(char16_t keyChar, System::ConsoleKey key, bool shift, bool alt, bool control) ;

/// @brief Method get_KeyChar addr 0x24947bc size 0x8 virtual false final false
 char16_t get_KeyChar() ;

/// @brief Method get_Key addr 0x24947c4 size 0x8 virtual false final false
 System::ConsoleKey get_Key() ;

/// @brief Method Equals addr 0x24947cc size 0x98 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method Equals addr 0x2494864 size 0x34 virtual false final false
 bool Equals(System::ConsoleKeyInfo obj) ;

/// @brief Method GetHashCode addr 0x2494898 size 0x14 virtual true final false
 int32_t GetHashCode() ;
