...
/// @brief Method .ctor addr 0x245c104 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit FieldAccessException(::StringW message) ;

/// @brief Method .ctor addr 0x245c160 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x245c184 size 0x8 virtual false final false
