...
/// @brief Method GetDefaultProxy_UsingOldMonoCode addr 0x2890698 size 0x8 virtual false final false
static System::Net::IWebProxy GetDefaultProxy_UsingOldMonoCode() ;

/// @brief Method GetSystemWebProxy addr 0x28906a0 size 0x8 virtual false final false
static System::Net::IWebProxy GetSystemWebProxy() ;

/// @brief Method get_ClassSyncObject addr 0x28906a8 size 0xa0 virtual false final false
static ::bs_hook::Il2CppWrapperType get_ClassSyncObject() ;

/// @brief Method GetSection addr 0x2890748 size 0x114 virtual false final false
static System::Net::Configuration::DefaultProxySectionInternal GetSection() ;

/// @brief Method get_WebProxy addr 0x2890864 size 0x8 virtual false final false
 System::Net::IWebProxy get_WebProxy() ;

// Ctor Parameters []
explicit DefaultProxySectionInternal() ;

/// @brief Method .ctor addr 0x289085c size 0x8 virtual false final false
 void _ctor() ;
