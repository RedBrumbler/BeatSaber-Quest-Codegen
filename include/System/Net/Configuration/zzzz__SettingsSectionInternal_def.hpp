...
/// @brief Method get_Section addr 0x289086c size 0x58 virtual false final false
static System::Net::Configuration::SettingsSectionInternal get_Section() ;

/// @brief Method get_Ipv6Enabled addr 0x28908c4 size 0x8 virtual false final false
 bool get_Ipv6Enabled() ;

// Ctor Parameters []
explicit SettingsSectionInternal() ;

/// @brief Method .ctor addr 0x28908cc size 0x18 virtual false final false
 void _ctor() ;
