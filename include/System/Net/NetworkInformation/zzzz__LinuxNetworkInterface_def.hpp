...
/// @brief Method get_IfacePath addr 0x288e744 size 0x8 virtual false final false
 ::StringW get_IfacePath() ;

// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }]
explicit LinuxNetworkInterface(::StringW name) ;

/// @brief Method .ctor addr 0x288e664 size 0xd8 virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method GetIPProperties addr 0x288e74c size 0x74 virtual true final false
 System::Net::NetworkInformation::IPInterfaceProperties GetIPProperties() ;

/// @brief Method get_OperationalStatus addr 0x288e7c0 size 0x2bc virtual true final false
 System::Net::NetworkInformation::OperationalStatus get_OperationalStatus() ;

/// @brief Method ReadLine addr 0x288ea7c size 0x2ec virtual false final false
