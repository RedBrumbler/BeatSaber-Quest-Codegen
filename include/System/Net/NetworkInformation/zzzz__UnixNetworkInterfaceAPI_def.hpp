...
namespace System::Net::NetworkInformation {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8153))}
...
/// @brief Method getifaddrs addr 0x288daf4 size 0x7c virtual false final false
static int32_t getifaddrs(ByRef<::cordl_internals::intptr_t> ifap) ;

/// @brief Method freeifaddrs addr 0x288da74 size 0x7c virtual false final false
static void freeifaddrs(::cordl_internals::intptr_t ifap) ;

// Ctor Parameters []
explicit UnixNetworkInterfaceAPI() ;

/// @brief Method .ctor addr 0x288d318 size 0x8 virtual false final false
 void _ctor() ;
