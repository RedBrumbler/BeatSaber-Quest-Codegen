...
/// @brief Method .ctor addr 0x288aa88 size 0x7c virtual false final false
 void _ctor() ;

/// @brief Method CopyTo addr 0x288ab04 size 0x68 virtual true final false
 void CopyTo(::ArrayW<System::Net::NetworkInformation::GatewayIPAddressInformation> array, int32_t offset) ;

/// @brief Method get_Count addr 0x288ab6c size 0x50 virtual true final false
 int32_t get_Count() ;

/// @brief Method get_IsReadOnly addr 0x288abbc size 0x8 virtual true final false
 bool get_IsReadOnly() ;

/// @brief Method Add addr 0x288abc4 size 0x60 virtual true final false
 void Add(System::Net::NetworkInformation::GatewayIPAddressInformation address) ;

/// @brief Method InternalAdd addr 0x288ac24 size 0x58 virtual false final false
 void InternalAdd(System::Net::NetworkInformation::GatewayIPAddressInformation address) ;

/// @brief Method Contains addr 0x288ac7c size 0x58 virtual true final false
 bool Contains(System::Net::NetworkInformation::GatewayIPAddressInformation address) ;

/// @brief Method GetEnumerator addr 0x288acd4 size 0x50 virtual true final false
 System::Collections::Generic::IEnumerator_1<System::Net::NetworkInformation::GatewayIPAddressInformation> GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x288ad24 size 0x10 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method Remove addr 0x288ad34 size 0x60 virtual true final false
 bool Remove(System::Net::NetworkInformation::GatewayIPAddressInformation address) ;

/// @brief Method Clear addr 0x288ad94 size 0x60 virtual true final false
 void Clear() ;
