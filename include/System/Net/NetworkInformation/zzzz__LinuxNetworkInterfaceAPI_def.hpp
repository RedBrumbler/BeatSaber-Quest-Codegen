...
/// @brief Method FreeInterfaceAddresses addr 0x288da70 size 0x4 virtual false final false
static void FreeInterfaceAddresses(::cordl_internals::intptr_t ifap) ;

/// @brief Method GetInterfaceAddresses addr 0x288daf0 size 0x4 virtual false final false
static int32_t GetInterfaceAddresses(ByRef<::cordl_internals::intptr_t> ifap) ;

/// @brief Method GetAllNetworkInterfaces addr 0x288db70 size 0xaf4 virtual true final false
 ::ArrayW<System::Net::NetworkInformation::NetworkInterface> GetAllNetworkInterfaces() ;

// Ctor Parameters []
explicit LinuxNetworkInterfaceAPI() ;

/// @brief Method .ctor addr 0x288e73c size 0x8 virtual false final false
 void _ctor() ;
