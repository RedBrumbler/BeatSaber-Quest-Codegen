...
/// @brief Method .ctor addr 0x288adf4 size 0x7c virtual false final false
 void _ctor() ;

/// @brief Method CopyTo addr 0x288ae70 size 0x68 virtual true final false
 void CopyTo(::ArrayW<System::Net::IPAddress> array, int32_t offset) ;

/// @brief Method get_Count addr 0x288aed8 size 0x50 virtual true final false
 int32_t get_Count() ;

/// @brief Method get_IsReadOnly addr 0x288af28 size 0x8 virtual true final false
 bool get_IsReadOnly() ;

/// @brief Method Add addr 0x288af30 size 0x60 virtual true final false
 void Add(System::Net::IPAddress address) ;

/// @brief Method InternalAdd addr 0x288af90 size 0x58 virtual false final false
 void InternalAdd(System::Net::IPAddress address) ;

/// @brief Method Contains addr 0x288afe8 size 0x58 virtual true final false
 bool Contains(System::Net::IPAddress address) ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x288b040 size 0x10 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method GetEnumerator addr 0x288b050 size 0x50 virtual true final false
 System::Collections::Generic::IEnumerator_1<System::Net::IPAddress> GetEnumerator() ;

/// @brief Method Remove addr 0x288b0a0 size 0x60 virtual true final false
 bool Remove(System::Net::IPAddress address) ;

/// @brief Method Clear addr 0x288b100 size 0x60 virtual true final false
 void Clear() ;
