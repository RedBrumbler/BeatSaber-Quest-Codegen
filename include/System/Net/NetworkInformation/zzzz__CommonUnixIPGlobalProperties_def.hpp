...
/// @brief Method getdomainname addr 0x288fe9c size 0x8c virtual false final false
static int32_t getdomainname(::ArrayW<uint8_t> name, int32_t len) ;

/// @brief Method get_DomainName addr 0x288ff28 size 0x17c virtual true final false
 ::StringW get_DomainName() ;

// Ctor Parameters []
explicit CommonUnixIPGlobalProperties() ;

/// @brief Method .ctor addr 0x28900a4 size 0x8 virtual false final false
 void _ctor() ;
