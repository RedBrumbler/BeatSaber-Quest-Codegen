...
/// @brief Method .ctor addr 0x288bb20 size 0x80 virtual false final false
...
/// @brief Method ParseRouteInfo_icall addr 0x288bbcc size 0x44 virtual false final false
static bool ParseRouteInfo_icall(::StringW iface, ByRef<::ArrayW<::StringW>> gw_addr_list) ;

/// @brief Method get_GatewayAddresses addr 0x288bc10 size 0x254 virtual true final false
