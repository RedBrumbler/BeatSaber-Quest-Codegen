...
/// @brief Method GetAllNetworkInterfaces addr 0x288b244 size 0x4c virtual false final false
static ::ArrayW<System::Net::NetworkInformation::NetworkInterface> GetAllNetworkInterfaces() ;

/// @brief Method get_Name addr 0x288b38c size 0x40 virtual true final false
 ::StringW get_Name() ;

/// @brief Method GetIPProperties addr 0x288b3cc size 0x40 virtual true final false
 System::Net::NetworkInformation::IPInterfaceProperties GetIPProperties() ;

/// @brief Method get_OperationalStatus addr 0x288b40c size 0x40 virtual true final false
 System::Net::NetworkInformation::OperationalStatus get_OperationalStatus() ;

/// @brief Method get_NetworkInterfaceType addr 0x288b44c size 0x40 virtual true final false
 System::Net::NetworkInformation::NetworkInterfaceType get_NetworkInterfaceType() ;

// Ctor Parameters []
explicit NetworkInterface() ;

/// @brief Method .ctor addr 0x288b48c size 0x8 virtual false final false
 void _ctor() ;
