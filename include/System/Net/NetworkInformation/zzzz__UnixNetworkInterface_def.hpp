...
/// @brief Method .ctor addr 0x288d320 size 0x90 virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method AddAddress addr 0x288d25c size 0xa8 virtual false final false
 void AddAddress(System::Net::IPAddress address) ;

/// @brief Method SetLinkLayerInfo addr 0x288d304 size 0xc virtual false final false
 void SetLinkLayerInfo(int32_t index, ::ArrayW<uint8_t> macAddress, System::Net::NetworkInformation::NetworkInterfaceType type) ;

/// @brief Method get_Name addr 0x2890688 size 0x8 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_NetworkInterfaceType addr 0x2890690 size 0x8 virtual true final false
