...
namespace System::Net::NetworkInformation {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8115))}
...
/// @brief Method .ctor addr 0x288b494 size 0x28 virtual false final false
 void _ctor(System::Net::IPAddress address) ;

/// @brief Method ToGatewayIpAddressInformationCollection addr 0x288b4bc size 0x2f0 virtual false final false
