...
/// @brief Method .ctor addr 0x288d53c size 0x70 virtual false final false
...
/// @brief Method ParseRouteInfo addr 0x288d5ac size 0x488 virtual false final false
 System::Net::NetworkInformation::IPAddressCollection ParseRouteInfo(::StringW iface) ;

/// @brief Method get_GatewayAddresses addr 0x288da34 size 0x3c virtual true final false
