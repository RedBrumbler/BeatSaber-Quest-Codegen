...
/// @brief Method .ctor addr 0x288d234 size 0x28 virtual false final false
 void _ctor(::StringW name, uint32_t ifa_flags, int32_t ifru_mtu) ;

/// @brief Method GetIPProperties addr 0x288d3b0 size 0x84 virtual true final false
 System::Net::NetworkInformation::IPInterfaceProperties GetIPProperties() ;

/// @brief Method get_OperationalStatus addr 0x288d434 size 0x14 virtual true final false
