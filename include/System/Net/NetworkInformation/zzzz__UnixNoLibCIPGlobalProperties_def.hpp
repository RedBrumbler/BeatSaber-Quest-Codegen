...
namespace System::Net::NetworkInformation {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8156))}
...
/// @brief Method get_DomainName addr 0x28900b4 size 0x48 virtual true final false
 ::StringW get_DomainName() ;

// Ctor Parameters []
explicit UnixNoLibCIPGlobalProperties() ;

/// @brief Method .ctor addr 0x28900fc size 0x8 virtual false final false
 void _ctor() ;
