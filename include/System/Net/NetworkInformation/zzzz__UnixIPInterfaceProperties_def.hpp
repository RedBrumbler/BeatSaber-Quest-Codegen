...
/// @brief Method .ctor addr 0x288bba0 size 0x2c virtual false final false
...
/// @brief Method get_UnicastAddresses addr 0x2890348 size 0x274 virtual true final false
