...
/// @brief Method get_PlatformNeedsLibCWorkaround addr 0x2890300 size 0x48 virtual false final false
static bool get_PlatformNeedsLibCWorkaround() ;

/// @brief Method Create addr 0x288d490 size 0xac virtual false final false
