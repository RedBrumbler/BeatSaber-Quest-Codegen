...
/// @brief Method .ctor addr 0x2851fe8 size 0x178 virtual false final false
...
/// @brief Method .ctor addr 0x2852160 size 0x39c virtual false final false
...
/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x28524fc size 0xc virtual true final true
 void System_Runtime_Serialization_ISerializable_GetObjectData(System::Runtime::Serialization::SerializationInfo serializationInfo, System::Runtime::Serialization::StreamingContext streamingContext) ;

/// @brief Method GetObjectData addr 0x2852508 size 0x290 virtual true final false
 void GetObjectData(System::Runtime::Serialization::SerializationInfo serializationInfo, System::Runtime::Serialization::StreamingContext streamingContext) ;

/// @brief Method get_Aborted addr 0x2852798 size 0x10 virtual false final false
 bool get_Aborted() ;

/// @brief Method set_ConnectionGroupName addr 0x28527a8 size 0x8 virtual true final false
 void set_ConnectionGroupName(::StringW value) ;

/// @brief Method get_ContentLength addr 0x28527b0 size 0x8 virtual true final false
 int64_t get_ContentLength() ;

/// @brief Method set_ContentLength addr 0x28527b8 size 0x84 virtual true final false
 void set_ContentLength(int64_t value) ;

/// @brief Method get_Credentials addr 0x285283c size 0x8 virtual true final false
 System::Net::ICredentials get_Credentials() ;

/// @brief Method set_Credentials addr 0x2852844 size 0x8 virtual true final false
 void set_Credentials(System::Net::ICredentials value) ;

/// @brief Method get_Headers addr 0x285284c size 0x8 virtual true final false
 System::Net::WebHeaderCollection get_Headers() ;

/// @brief Method get_Method addr 0x2852854 size 0x8 virtual true final false
 ::StringW get_Method() ;

/// @brief Method set_Method addr 0x285285c size 0xd4 virtual true final false
 void set_Method(::StringW value) ;

/// @brief Method set_PreAuthenticate addr 0x2852930 size 0xc virtual true final false
 void set_PreAuthenticate(bool value) ;

/// @brief Method get_Proxy addr 0x285293c size 0x8 virtual true final false
 System::Net::IWebProxy get_Proxy() ;

/// @brief Method set_Proxy addr 0x2852944 size 0x8 virtual true final false
 void set_Proxy(System::Net::IWebProxy value) ;

/// @brief Method get_Timeout addr 0x285294c size 0x8 virtual true final false
 int32_t get_Timeout() ;

/// @brief Method set_Timeout addr 0x2852954 size 0x88 virtual true final false
 void set_Timeout(int32_t value) ;

/// @brief Method get_RequestUri addr 0x28529dc size 0x8 virtual true final false
 System::Uri get_RequestUri() ;

/// @brief Method BeginGetRequestStream addr 0x28529e4 size 0x3d4 virtual true final false
 System::IAsyncResult BeginGetRequestStream(System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType state) ;

/// @brief Method BeginGetResponse addr 0x2852e28 size 0x2e0 virtual true final false
 System::IAsyncResult BeginGetResponse(System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType state) ;

/// @brief Method CanGetRequestStream addr 0x2852db8 size 0x70 virtual false final false
 bool CanGetRequestStream() ;

/// @brief Method EndGetRequestStream addr 0x2853108 size 0x304 virtual true final false
 System::IO::Stream EndGetRequestStream(System::IAsyncResult asyncResult) ;

/// @brief Method EndGetResponse addr 0x285340c size 0x304 virtual true final false
 System::Net::WebResponse EndGetResponse(System::IAsyncResult asyncResult) ;

/// @brief Method GetResponse addr 0x2853710 size 0x370 virtual true final false
 System::Net::WebResponse GetResponse() ;

/// @brief Method GetRequestStreamCallback addr 0x2853a80 size 0x230 virtual false final false
static void GetRequestStreamCallback(::bs_hook::Il2CppWrapperType state) ;

/// @brief Method GetResponseCallback addr 0x2853d4c size 0x324 virtual false final false
static void GetResponseCallback(::bs_hook::Il2CppWrapperType state) ;

/// @brief Method UnblockReader addr 0x285433c size 0xd8 virtual false final false
 void UnblockReader() ;

/// @brief Method get_UseDefaultCredentials addr 0x2854414 size 0x24 virtual true final false
 bool get_UseDefaultCredentials() ;

/// @brief Method Abort addr 0x2854438 size 0x3b4 virtual true final false
 void Abort() ;
