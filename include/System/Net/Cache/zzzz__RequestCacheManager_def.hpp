...
/// @brief Method GetBinding addr 0x28909ec size 0x1fc virtual false final false
static System::Net::Cache::RequestCacheBinding GetBinding(::StringW internedScheme) ;

/// @brief Method LoadConfigSettings addr 0x2890be8 size 0x184 virtual false final false
