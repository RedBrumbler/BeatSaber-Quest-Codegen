...
/// @brief Method .ctor addr 0x2890e30 size 0x7c virtual false final false
 void _ctor(System::Net::Cache::RequestCacheLevel level) ;

/// @brief Method get_Level addr 0x2890f40 size 0x8 virtual false final false
 System::Net::Cache::RequestCacheLevel get_Level() ;

/// @brief Method ToString addr 0x2890f48 size 0x98 virtual true final false
 ::StringW ToString() ;
