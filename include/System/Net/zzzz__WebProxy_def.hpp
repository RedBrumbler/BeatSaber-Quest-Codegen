...
/// @brief Method .ctor addr 0x28556ac size 0x14 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x28556c0 size 0xb4 virtual false final false
 void _ctor(System::Uri Address, bool BypassOnLocal, ::ArrayW<::StringW> BypassList, System::Net::ICredentials Credentials) ;

/// @brief Method get_Credentials addr 0x28559ac size 0x8 virtual true final true
 System::Net::ICredentials get_Credentials() ;

/// @brief Method get_UseDefaultCredentials addr 0x28559b4 size 0x7c virtual false final false
 bool get_UseDefaultCredentials() ;

/// @brief Method set_UseDefaultCredentials addr 0x2855a30 size 0x78 virtual false final false
 void set_UseDefaultCredentials(bool value) ;

/// @brief Method GetProxy addr 0x2855aa8 size 0x190 virtual true final true
 System::Uri GetProxy(System::Uri destination) ;

/// @brief Method UpdateRegExList addr 0x2855774 size 0x238 virtual false final false
 void UpdateRegExList(bool canThrow) ;

/// @brief Method IsMatchInBypassList addr 0x2855e88 size 0x198 virtual false final false
 bool IsMatchInBypassList(System::Uri input) ;

/// @brief Method IsLocal addr 0x2856020 size 0x160 virtual false final false
 bool IsLocal(System::Uri host) ;

/// @brief Method IsLocalInProxyHash addr 0x2856180 size 0xf0 virtual false final false
 bool IsLocalInProxyHash(System::Uri host) ;

/// @brief Method IsBypassed addr 0x2856270 size 0xf4 virtual true final true
 bool IsBypassed(System::Uri host) ;

/// @brief Method IsBypassedManual addr 0x2855dc0 size 0xc8 virtual false final false
...
/// @brief Method .ctor addr 0x285646c size 0x360 virtual false final false
...
/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x28567d8 size 0xc virtual true final true
 void System_Runtime_Serialization_ISerializable_GetObjectData(System::Runtime::Serialization::SerializationInfo serializationInfo, System::Runtime::Serialization::StreamingContext streamingContext) ;

/// @brief Method GetObjectData addr 0x28567e4 size 0x124 virtual true final false
 void GetObjectData(System::Runtime::Serialization::SerializationInfo serializationInfo, System::Runtime::Serialization::StreamingContext streamingContext) ;

/// @brief Method get_ScriptEngine addr 0x2856908 size 0x8 virtual false final false
 System::Net::AutoWebProxyScriptEngine get_ScriptEngine() ;

/// @brief Method CreateDefaultProxy addr 0x2856910 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x2856978 size 0x30 virtual false final false
 void _ctor(bool enableAutoproxy) ;

/// @brief Method UnsafeUpdateFromRegistry addr 0x28567cc size 0xc virtual false final false
 void UnsafeUpdateFromRegistry() ;

/// @brief Method GetProxyAuto addr 0x2855c38 size 0x188 virtual false final false
 bool GetProxyAuto(System::Uri destination, ByRef<System::Uri> proxyUri) ;

/// @brief Method IsBypassedAuto addr 0x2856364 size 0x108 virtual false final false
 bool IsBypassedAuto(System::Uri destination, ByRef<bool> isBypassed) ;

/// @brief Method AreAllBypassed addr 0x28569a8 size 0x308 virtual false final false
static bool AreAllBypassed(System::Collections::Generic::IEnumerable_1<::StringW> proxies, bool checkFirstOnly) ;

/// @brief Method ProxyUri addr 0x2856cb0 size 0x10a4 virtual false final false
