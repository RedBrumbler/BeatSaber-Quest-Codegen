...
/// @brief Method get_Scheduler addr 0x287aa9c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2878ff0 size 0x10c virtual false final false
 void _ctor(System::Net::ServicePointScheduler scheduler, ::StringW name) ;

/// @brief Method IsEmpty addr 0x2879684 size 0x74 virtual false final false
 bool IsEmpty() ;

/// @brief Method RemoveConnection addr 0x2879da8 size 0x88 virtual false final false
 void RemoveConnection(System::Net::WebConnection connection) ;

/// @brief Method Cleanup addr 0x2879efc size 0xf0 virtual false final false
 void Cleanup() ;

/// @brief Method Close addr 0x287a650 size 0x318 virtual false final false
 void Close() ;

/// @brief Method EnqueueOperation addr 0x287a5f8 size 0x58 virtual false final false
 void EnqueueOperation(System::Net::WebOperation operation) ;

/// @brief Method GetNextOperation addr 0x287a1c4 size 0xec virtual false final false
 System::Net::WebOperation GetNextOperation() ;

/// @brief Method FindIdleConnection addr 0x287ab4c size 0x314 virtual false final false
 System::Net::WebConnection FindIdleConnection(System::Net::WebOperation operation) ;

/// @brief Method CreateOrReuseConnection addr 0x2879fec size 0x1a0 virtual false final false
...
/// @brief Method .ctor addr 0x287b560 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Set>b__4_0 addr 0x287b568 size 0x9c virtual false final false
...
/// @brief Method WaitAsync addr 0x287b4a8 size 0x54 virtual false final false
 System::Threading::Tasks::Task_1<bool> WaitAsync(int32_t millisecondTimeout) ;

/// @brief Method Set addr 0x28791c4 size 0x230 virtual false final false
 void Set() ;

/// @brief Method Reset addr 0x2879884 size 0xc4 virtual false final false
 void Reset() ;
...
/// @brief Method .ctor addr 0x2878f48 size 0xa8 virtual false final false
...
/// @brief Method MoveNext addr 0x287b604 size 0xaf4 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x287c0f8 size 0xc virtual true final true
...
/// @brief Method MoveNext addr 0x287c104 size 0x44c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x287c550 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method get_ServicePoint addr 0x2878f30 size 0x8 virtual false final false
 System::Net::ServicePoint get_ServicePoint() ;

/// @brief Method set_ServicePoint addr 0x2878f38 size 0x8 virtual false final false
 void set_ServicePoint(System::Net::ServicePoint value) ;

/// @brief Method get_MaxIdleTime addr 0x2878f40 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2876df8 size 0x1d8 virtual false final false
 void _ctor(System::Net::ServicePoint servicePoint, int32_t connectionLimit, int32_t maxIdleTime) ;

/// @brief Method Run addr 0x28790fc size 0xc8 virtual false final false
 void Run() ;

/// @brief Method RunScheduler addr 0x28793f4 size 0xd0 virtual false final false
 System::Threading::Tasks::Task RunScheduler() ;

/// @brief Method Cleanup addr 0x28794c4 size 0x1c0 virtual false final false
 void Cleanup() ;

/// @brief Method RunSchedulerIteration addr 0x28796f8 size 0x18c virtual false final false
 void RunSchedulerIteration() ;

/// @brief Method OperationCompleted addr 0x2879a28 size 0x220 virtual false final false
...
/// @brief Method CloseIdleConnection addr 0x287a18c size 0x38 virtual false final false
...
/// @brief Method SchedulerIteration addr 0x2879948 size 0xe0 virtual false final false
 bool SchedulerIteration(System::Net::System__Net__ServicePointScheduler__ConnectionGroup group) ;

/// @brief Method RemoveOperation addr 0x287a2b0 size 0xcc virtual false final false
 void RemoveOperation(System::Net::WebOperation operation) ;

/// @brief Method RemoveIdleConnection addr 0x2879e30 size 0xcc virtual false final false
 void RemoveIdleConnection(System::Net::WebConnection connection) ;

/// @brief Method FinalCleanup addr 0x287a37c size 0x80 virtual false final false
 void FinalCleanup() ;

/// @brief Method SendRequest addr 0x28779d8 size 0xe8 virtual false final false
 void SendRequest(System::Net::WebOperation operation, ::StringW groupName) ;

/// @brief Method CloseConnectionGroup addr 0x2877bac size 0x110 virtual false final false
 bool CloseConnectionGroup(::StringW groupName) ;

/// @brief Method GetConnectionGroup addr 0x287a3fc size 0x1fc virtual false final false
 System::Net::System__Net__ServicePointScheduler__ConnectionGroup GetConnectionGroup(::StringW name) ;

/// @brief Method OnConnectionCreated addr 0x287a968 size 0xc virtual false final false
 void OnConnectionCreated(System::Net::WebConnection connection) ;

/// @brief Method OnConnectionClosed addr 0x287a974 size 0x1c virtual false final false
 void OnConnectionClosed(System::Net::WebConnection connection) ;

/// @brief Method WaitAsync addr 0x287a990 size 0x108 virtual false final false
static System::Threading::Tasks::Task_1<bool> WaitAsync(System::Threading::Tasks::Task workerTask, int32_t millisecondTimeout) ;

/// @brief Method <Run>b__31_0 addr 0x287aa98 size 0x4 virtual false final false
