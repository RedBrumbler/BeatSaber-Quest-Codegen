...
/// @brief Method .ctor addr 0x284d8f4 size 0xc virtual false final false
 void _ctor(::StringW name, System::Net::CookieVariant variant) ;

/// @brief Method get_Name addr 0x284d900 size 0x8 virtual false final false
 ::StringW get_Name() ;

/// @brief Method get_Variant addr 0x284d908 size 0x8 virtual false final false
