...
/// @brief Method .ctor addr 0x2872d88 size 0x30 virtual false final false
 void _ctor(::StringW prefix) ;

/// @brief Method ToString addr 0x28730a8 size 0x8 virtual true final false
 ::StringW ToString() ;

/// @brief Method get_Secure addr 0x28730b0 size 0x8 virtual false final false
 bool get_Secure() ;

/// @brief Method get_Host addr 0x28730b8 size 0x8 virtual false final false
 ::StringW get_Host() ;

/// @brief Method get_Port addr 0x28730c0 size 0x8 virtual false final false
 int32_t get_Port() ;

/// @brief Method get_Path addr 0x28730c8 size 0x8 virtual false final false
 ::StringW get_Path() ;

/// @brief Method Equals addr 0x28730d0 size 0x80 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method GetHashCode addr 0x2873150 size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Parse addr 0x2872db8 size 0x2f0 virtual false final false
 void Parse(::StringW uri) ;

/// @brief Method CheckUri addr 0x2873170 size 0x350 virtual false final false
