...
/// @brief Method .ctor addr 0x28751ec size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x28751f4 size 0x98 virtual false final false
 void _ctor(System::IO::Stream stream, ::ArrayW<uint8_t> buffer, int32_t offset, int32_t length, int64_t contentlength) ;

/// @brief Method get_CanRead addr 0x287528c size 0x8 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanSeek addr 0x2875294 size 0x8 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_CanWrite addr 0x287529c size 0x8 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_Length addr 0x28752a4 size 0x40 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x28752e4 size 0x40 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x2875324 size 0x40 virtual true final false
 void set_Position(int64_t value) ;

/// @brief Method Close addr 0x2875364 size 0xc virtual true final false
 void Close() ;

/// @brief Method Flush addr 0x2875370 size 0x4 virtual true final false
 void Flush() ;

/// @brief Method FillFromBuffer addr 0x2875374 size 0x29c virtual false final false
 int32_t FillFromBuffer(::ArrayW<uint8_t> buffer, int32_t off, int32_t count) ;

/// @brief Method Read addr 0x2875610 size 0x11c virtual true final false
 int32_t Read(ByRef<::ArrayW<uint8_t>> buffer, int32_t offset, int32_t count) ;

/// @brief Method BeginRead addr 0x287572c size 0x20c virtual true final false
...
/// @brief Method EndRead addr 0x2875938 size 0x29c virtual true final false
 int32_t EndRead(System::IAsyncResult ares) ;

/// @brief Method Seek addr 0x2875bd4 size 0x40 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0x2875c14 size 0x40 virtual true final false
 void SetLength(int64_t value) ;

/// @brief Method Write addr 0x2875c54 size 0x40 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method BeginWrite addr 0x2875c94 size 0x40 virtual true final false
...
/// @brief Method EndWrite addr 0x2875cd4 size 0x40 virtual true final false
