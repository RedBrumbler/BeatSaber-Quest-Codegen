...
/// @brief Method .ctor addr 0x2863ae8 size 0xb4 virtual false final false
 void _ctor(System::Net::HttpConnection cnc) ;

/// @brief Method get_ErrorStatus addr 0x28681d8 size 0x8 virtual false final false
 int32_t get_ErrorStatus() ;

/// @brief Method set_ErrorStatus addr 0x28681e0 size 0x8 virtual false final false
 void set_ErrorStatus(int32_t value) ;

/// @brief Method get_ErrorMessage addr 0x28681e8 size 0x8 virtual false final false
 ::StringW get_ErrorMessage() ;

/// @brief Method set_ErrorMessage addr 0x28681f0 size 0x8 virtual false final false
 void set_ErrorMessage(::StringW value) ;

/// @brief Method get_HaveError addr 0x2864794 size 0x10 virtual false final false
 bool get_HaveError() ;

/// @brief Method get_Connection addr 0x28681f8 size 0x8 virtual false final false
 System::Net::HttpConnection get_Connection() ;

/// @brief Method get_Request addr 0x2868200 size 0x8 virtual false final false
 System::Net::HttpListenerRequest get_Request() ;

/// @brief Method get_Response addr 0x2868208 size 0x8 virtual false final false
 System::Net::HttpListenerResponse get_Response() ;

/// @brief Method ParseAuthentication addr 0x2867c88 size 0x120 virtual false final false
 void ParseAuthentication(System::Net::AuthenticationSchemes expectedSchemes) ;

/// @brief Method ParseBasicAuthentication addr 0x2868210 size 0x24c virtual false final false
