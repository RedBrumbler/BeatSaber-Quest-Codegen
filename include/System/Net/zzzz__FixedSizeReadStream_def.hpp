...
/// @brief Method MoveNext addr 0x28635a8 size 0x2b0 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2863858 size 0x58 virtual true final true
...
/// @brief Method get_ContentLength addr 0x2863450 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2863458 size 0x28 virtual false final false
 void _ctor(System::Net::WebOperation operation, System::IO::Stream innerStream, int64_t contentLength) ;

/// @brief Method ProcessReadAsync addr 0x2863480 size 0x128 virtual true final false
