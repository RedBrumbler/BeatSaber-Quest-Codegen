...
/// @brief Method .ctor addr 0x2868014 size 0xb0 virtual false final false
 void _ctor(System::Net::HttpListenerContext context) ;

/// @brief Method SetRequestLine addr 0x2865330 size 0x34c virtual false final false
 void SetRequestLine(::StringW req) ;

/// @brief Method CreateQueryString addr 0x28688bc size 0x218 virtual false final false
 void CreateQueryString(::StringW query) ;

/// @brief Method MaybeUri addr 0x2868ad4 size 0xa8 virtual false final false
static bool MaybeUri(::StringW s) ;

/// @brief Method IsPredefinedScheme addr 0x2868b7c size 0x1f0 virtual false final false
static bool IsPredefinedScheme(::StringW scheme) ;

/// @brief Method FinishInitialization addr 0x28647a4 size 0x61c virtual false final false
 bool FinishInitialization() ;

/// @brief Method Unquote addr 0x2868e24 size 0x6c virtual false final false
static ::StringW Unquote(::StringW str) ;

/// @brief Method AddHeader addr 0x286567c size 0x8e4 virtual false final false
 void AddHeader(::StringW header) ;

/// @brief Method FlushInput addr 0x28663a4 size 0x2c8 virtual false final false
 bool FlushInput() ;

/// @brief Method get_HasEntityBody addr 0x2868e90 size 0x24 virtual false final false
 bool get_HasEntityBody() ;

/// @brief Method get_Headers addr 0x2868f58 size 0x8 virtual false final false
 System::Collections::Specialized::NameValueCollection get_Headers() ;

/// @brief Method get_InputStream addr 0x2868eb4 size 0xa4 virtual false final false
 System::IO::Stream get_InputStream() ;

/// @brief Method get_IsSecureConnection addr 0x2868de0 size 0x24 virtual false final false
 bool get_IsSecureConnection() ;

/// @brief Method get_KeepAlive addr 0x2866248 size 0x15c virtual false final false
 bool get_KeepAlive() ;

/// @brief Method get_LocalEndPoint addr 0x2868e04 size 0x20 virtual false final false
 System::Net::IPEndPoint get_LocalEndPoint() ;

/// @brief Method get_ProtocolVersion addr 0x2868f60 size 0x8 virtual false final false
 System::Version get_ProtocolVersion() ;

/// @brief Method get_Url addr 0x2868f68 size 0x8 virtual false final false
 System::Uri get_Url() ;

/// @brief Method get_UserHostAddress addr 0x2868dc0 size 0x20 virtual false final false
 ::StringW get_UserHostAddress() ;

/// @brief Method get_UserHostName addr 0x2868d6c size 0x54 virtual false final false
