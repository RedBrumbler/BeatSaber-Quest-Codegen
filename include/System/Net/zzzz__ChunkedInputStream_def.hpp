...
/// @brief Method .ctor addr 0x285b568 size 0x48 virtual false final false
...
namespace System::Net {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8068))}
...
/// @brief Method .ctor addr 0x285afb8 size 0x104 virtual false final false
...
/// @brief Method Read addr 0x285b0bc size 0x3c virtual true final false
 int32_t Read(ByRef<::ArrayW<uint8_t>> buffer, int32_t offset, int32_t count) ;

/// @brief Method BeginRead addr 0x285b0f8 size 0x308 virtual true final false
...
/// @brief Method OnRead addr 0x285b5b0 size 0x3a4 virtual false final false
 void OnRead(System::IAsyncResult base_ares) ;

/// @brief Method EndRead addr 0x285bb34 size 0x2a0 virtual true final false
 int32_t EndRead(System::IAsyncResult ares) ;

/// @brief Method Close addr 0x285bdd4 size 0x1c virtual true final false
 void Close() ;
