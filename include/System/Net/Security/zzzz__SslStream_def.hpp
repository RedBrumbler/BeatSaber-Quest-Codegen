...
/// @brief Method .ctor addr 0x279eb98 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <SetAndVerifySelectionCallback>b__0 addr 0x279f360 size 0x38 virtual false final false
...
/// @brief Method get_Impl addr 0x279e674 size 0x18 virtual false final false
 Mono::Net::Security::MobileAuthenticatedStream get_Impl() ;

/// @brief Method get_InternalTargetHost addr 0x279e6ec size 0x24 virtual false final false
 ::StringW get_InternalTargetHost() ;

/// @brief Method GetProvider addr 0x279e710 size 0x70 virtual false final false
...
/// @brief Method .ctor addr 0x279e780 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x279e78c size 0x90 virtual false final false
...
/// @brief Method .ctor addr 0x279ea74 size 0x124 virtual false final false
...
/// @brief Method SetAndVerifyValidationCallback addr 0x279e81c size 0xe0 virtual false final false
 void SetAndVerifyValidationCallback(System::Net::Security::RemoteCertificateValidationCallback callback) ;

/// @brief Method SetAndVerifySelectionCallback addr 0x279e8fc size 0x178 virtual false final false
 void SetAndVerifySelectionCallback(System::Net::Security::LocalCertificateSelectionCallback callback) ;

/// @brief Method AuthenticateAsClient addr 0x279eba0 size 0x54 virtual true final false
...
/// @brief Method BeginAuthenticateAsClient addr 0x279ebf4 size 0x74 virtual true final false
...
/// @brief Method EndAuthenticateAsClient addr 0x279ec68 size 0xc virtual true final false
 void EndAuthenticateAsClient(System::IAsyncResult asyncResult) ;

/// @brief Method AuthenticateAsServer addr 0x279ec74 size 0x54 virtual true final false
...
/// @brief Method AuthenticateAsClientAsync addr 0x279ecc8 size 0x54 virtual true final false
...
/// @brief Method get_IsAuthenticated addr 0x279ed1c size 0x2c virtual true final false
 bool get_IsAuthenticated() ;

/// @brief Method get_LocalCertificate addr 0x279ed48 size 0x24 virtual true final false
 System::Security::Cryptography::X509Certificates::X509Certificate get_LocalCertificate() ;

/// @brief Method get_CanSeek addr 0x279ed6c size 0x8 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_CanRead addr 0x279ed74 size 0x18 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanTimeout addr 0x279ed8c size 0x20 virtual true final false
 bool get_CanTimeout() ;

/// @brief Method get_CanWrite addr 0x279edac size 0x18 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_ReadTimeout addr 0x279edc4 size 0x2c virtual true final false
 int32_t get_ReadTimeout() ;

/// @brief Method set_ReadTimeout addr 0x279edf0 size 0x3c virtual true final false
 void set_ReadTimeout(int32_t value) ;

/// @brief Method get_WriteTimeout addr 0x279ee2c size 0x2c virtual true final false
 int32_t get_WriteTimeout() ;

/// @brief Method set_WriteTimeout addr 0x279ee58 size 0x3c virtual true final false
 void set_WriteTimeout(int32_t value) ;

/// @brief Method get_Length addr 0x279ee94 size 0x28 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x279eebc size 0x28 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x279eee4 size 0x60 virtual true final false
 void set_Position(int64_t value) ;

/// @brief Method SetLength addr 0x279ef44 size 0x3c virtual true final false
 void SetLength(int64_t value) ;

/// @brief Method Seek addr 0x279ef80 size 0x60 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method FlushAsync addr 0x279efe0 size 0x24 virtual true final false
 System::Threading::Tasks::Task FlushAsync(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method Flush addr 0x279f004 size 0x24 virtual true final false
 void Flush() ;

/// @brief Method CheckDisposed addr 0x279e68c size 0x60 virtual false final false
 void CheckDisposed() ;

/// @brief Method Dispose addr 0x279f028 size 0xac virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Read addr 0x279f0d4 size 0x54 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Write addr 0x279f128 size 0x54 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method ReadAsync addr 0x279f17c size 0x5c virtual true final false
...
/// @brief Method WriteAsync addr 0x279f1d8 size 0x5c virtual true final false
...
/// @brief Method BeginRead addr 0x279f234 size 0x6c virtual true final false
...
/// @brief Method EndRead addr 0x279f2a0 size 0x48 virtual true final false
 int32_t EndRead(System::IAsyncResult asyncResult) ;

/// @brief Method BeginWrite addr 0x279f2e8 size 0x6c virtual true final false
...
/// @brief Method EndWrite addr 0x279f354 size 0xc virtual true final false
