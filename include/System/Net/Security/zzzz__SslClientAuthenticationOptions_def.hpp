...
/// @brief Method set_LocalCertificateSelectionCallback addr 0x279dc84 size 0x8 virtual false final false
 void set_LocalCertificateSelectionCallback(System::Net::Security::LocalCertificateSelectionCallback value) ;

/// @brief Method get_TargetHost addr 0x279dc8c size 0x8 virtual false final false
 ::StringW get_TargetHost() ;

/// @brief Method set_TargetHost addr 0x279dc94 size 0x8 virtual false final false
 void set_TargetHost(::StringW value) ;

/// @brief Method get_ClientCertificates addr 0x279dc9c size 0x8 virtual false final false
 System::Security::Cryptography::X509Certificates::X509CertificateCollection get_ClientCertificates() ;

/// @brief Method set_ClientCertificates addr 0x279dca4 size 0x8 virtual false final false
 void set_ClientCertificates(System::Security::Cryptography::X509Certificates::X509CertificateCollection value) ;

/// @brief Method set_CertificateRevocationCheckMode addr 0x279dcac size 0xa0 virtual false final false
 void set_CertificateRevocationCheckMode(System::Security::Cryptography::X509Certificates::X509RevocationMode value) ;

/// @brief Method set_EncryptionPolicy addr 0x279dd4c size 0xa0 virtual false final false
 void set_EncryptionPolicy(System::Net::Security::EncryptionPolicy value) ;

/// @brief Method get_EnabledSslProtocols addr 0x279ddec size 0x8 virtual false final false
 System::Security::Authentication::SslProtocols get_EnabledSslProtocols() ;

/// @brief Method set_EnabledSslProtocols addr 0x279ddf4 size 0x8 virtual false final false
 void set_EnabledSslProtocols(System::Security::Authentication::SslProtocols value) ;

// Ctor Parameters []
explicit SslClientAuthenticationOptions() ;

/// @brief Method .ctor addr 0x279ddfc size 0x10 virtual false final false
 void _ctor() ;
