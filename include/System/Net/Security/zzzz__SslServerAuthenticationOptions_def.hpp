...
/// @brief Method get_ClientCertificateRequired addr 0x279de0c size 0x8 virtual false final false
 bool get_ClientCertificateRequired() ;

/// @brief Method set_ClientCertificateRequired addr 0x279de14 size 0xc virtual false final false
 void set_ClientCertificateRequired(bool value) ;

/// @brief Method get_ServerCertificate addr 0x279de20 size 0x8 virtual false final false
 System::Security::Cryptography::X509Certificates::X509Certificate get_ServerCertificate() ;

/// @brief Method set_ServerCertificate addr 0x279de28 size 0x8 virtual false final false
 void set_ServerCertificate(System::Security::Cryptography::X509Certificates::X509Certificate value) ;

/// @brief Method get_EnabledSslProtocols addr 0x279de30 size 0x8 virtual false final false
 System::Security::Authentication::SslProtocols get_EnabledSslProtocols() ;

/// @brief Method set_EnabledSslProtocols addr 0x279de38 size 0x8 virtual false final false
 void set_EnabledSslProtocols(System::Security::Authentication::SslProtocols value) ;

/// @brief Method set_CertificateRevocationCheckMode addr 0x279de40 size 0xa0 virtual false final false
 void set_CertificateRevocationCheckMode(System::Security::Cryptography::X509Certificates::X509RevocationMode value) ;

/// @brief Method set_EncryptionPolicy addr 0x279dee0 size 0xa0 virtual false final false
 void set_EncryptionPolicy(System::Net::Security::EncryptionPolicy value) ;

// Ctor Parameters []
explicit SslServerAuthenticationOptions() ;

/// @brief Method .ctor addr 0x279df80 size 0x10 virtual false final false
 void _ctor() ;
