...
/// @brief Method .ctor addr 0x279df90 size 0x198 virtual false final false
 void _ctor(System::IO::Stream innerStream, bool leaveInnerStreamOpen) ;

/// @brief Method get_InnerStream addr 0x279e128 size 0x8 virtual false final false
 System::IO::Stream get_InnerStream() ;

/// @brief Method Dispose addr 0x279e130 size 0xe8 virtual true final false
