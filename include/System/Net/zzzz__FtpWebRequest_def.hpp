...
struct CORDL_TYPE System__Net__FtpWebRequest__RequestStage : public ::bs_hook::EnumTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: None }]
constexpr System__Net__FtpWebRequest__RequestStage(int32_t value__) noexcept;


                    constexpr System__Net__FtpWebRequest__RequestStage(System__Net__FtpWebRequest__RequestStage const&) = default;
                    constexpr System__Net__FtpWebRequest__RequestStage(System__Net__FtpWebRequest__RequestStage&&) = default;
                    constexpr System__Net__FtpWebRequest__RequestStage& operator=(System__Net__FtpWebRequest__RequestStage const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr System__Net__FtpWebRequest__RequestStage& operator=(System__Net__FtpWebRequest__RequestStage&& o) noexcept {
...
constexpr explicit System__Net__FtpWebRequest__RequestStage(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::EnumTypeWrapper(),__instance(std::move(instance)) {
}
...
enum class __System__Net__FtpWebRequest__RequestStage_Unwrapped : int32_t {
__CheckForError = 0,
__RequestStarted = 1,
__WriteReady = 2,
__ReadReady = 3,
...
static System::Net::System__Net__FtpWebRequest__RequestStage const CheckForError;

/// @brief Field RequestStarted offset 0
static System::Net::System__Net__FtpWebRequest__RequestStage const RequestStarted;

/// @brief Field WriteReady offset 0
static System::Net::System__Net__FtpWebRequest__RequestStage const WriteReady;

/// @brief Field ReadReady offset 0
static System::Net::System__Net__FtpWebRequest__RequestStage const ReadReady;

/// @brief Field ReleaseConnection offset 0
static System::Net::System__Net__FtpWebRequest__RequestStage const ReleaseConnection;
...
struct CORDL_TYPE System__Net__FtpWebRequest___CreateConnectionAsync_d__86 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "System::Net::FtpWebRequest", modifiers: "", def_value: None }, CppParam { name: "_client_5__2", ty: "System::Net::Sockets::TcpClient", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "System::Runtime::CompilerServices::System__Runtime__CompilerServices__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter", modifiers: "", def_value: None }]
constexpr System__Net__FtpWebRequest___CreateConnectionAsync_d__86(int32_t __1__state, System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder, System::Net::FtpWebRequest __4__this, System::Net::Sockets::TcpClient _client_5__2, System::Runtime::CompilerServices::System__Runtime__CompilerServices__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter __u__1) noexcept;


                    constexpr System__Net__FtpWebRequest___CreateConnectionAsync_d__86(System__Net__FtpWebRequest___CreateConnectionAsync_d__86 const&) = default;
                    constexpr System__Net__FtpWebRequest___CreateConnectionAsync_d__86(System__Net__FtpWebRequest___CreateConnectionAsync_d__86&&) = default;
                    constexpr System__Net__FtpWebRequest___CreateConnectionAsync_d__86& operator=(System__Net__FtpWebRequest___CreateConnectionAsync_d__86 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr System__Net__FtpWebRequest___CreateConnectionAsync_d__86& operator=(System__Net__FtpWebRequest___CreateConnectionAsync_d__86&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit System__Net__FtpWebRequest___CreateConnectionAsync_d__86(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
/// @brief Method MoveNext addr 0x2838314 size 0x30c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2838620 size 0xc virtual true final true
...
class CORDL_TYPE System__Net__FtpWebRequest____c : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x10};

virtual ~System__Net__FtpWebRequest____c() = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Net__FtpWebRequest____c", modifiers: " const&", def_value: None }]
constexpr System__Net__FtpWebRequest____c(System__Net__FtpWebRequest____c const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Net__FtpWebRequest____c", modifiers: "&&", def_value: None }]
constexpr System__Net__FtpWebRequest____c(System__Net__FtpWebRequest____c&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit System__Net__FtpWebRequest____c(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr System__Net__FtpWebRequest____c& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr System__Net__FtpWebRequest____c& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr System__Net__FtpWebRequest____c& operator=(System__Net__FtpWebRequest____c&& o) noexcept = default;
  constexpr System__Net__FtpWebRequest____c& operator=(System__Net__FtpWebRequest____c const& o) noexcept = default;
                


// Fields

static System::Net::System__Net__FtpWebRequest____c __declspec(property(get=__get___9, put=__set___9))  __9;

static void __set___9(System::Net::System__Net__FtpWebRequest____c value) ;

static System::Net::System__Net__FtpWebRequest____c __get___9() ;
...
/// @brief Method .ctor addr 0x2838690 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <get_ClientCertificates>b__114_0 addr 0x2838698 size 0x5c virtual false final false
...
namespace System::Net {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7966))}
...
public:
// Declarations
using __c = System::Net::System__Net__FtpWebRequest____c;

using _CreateConnectionAsync_d__86 = System::Net::System__Net__FtpWebRequest___CreateConnectionAsync_d__86;

using RequestStage = System::Net::System__Net__FtpWebRequest__RequestStage;
...
constexpr System::Exception __get__exception() const;
 ...
 System::Net::System__Net__TimerThread__Queue __declspec(property(get=__get__timerQueue, put=__set__timerQueue))  _timerQueue;

constexpr void __set__timerQueue(System::Net::System__Net__TimerThread__Queue value) ;

constexpr System::Net::System__Net__TimerThread__Queue __get__timerQueue() const;

 System::Net::System__Net__TimerThread__Callback __declspec(property(get=__get__timerCallback, put=__set__timerCallback))  _timerCallback;

constexpr void __set__timerCallback(System::Net::System__Net__TimerThread__Callback value) ;

constexpr System::Net::System__Net__TimerThread__Callback __get__timerCallback() const;
...
constexpr System::IO::Stream __get__stream() const;
 ...
 System::Net::System__Net__FtpWebRequest__RequestStage __declspec(property(get=__get__requestStage, put=__set__requestStage))  _requestStage;

constexpr void __set__requestStage(System::Net::System__Net__FtpWebRequest__RequestStage value) ;

constexpr System::Net::System__Net__FtpWebRequest__RequestStage __get__requestStage() const;
...
// Properties
 ...
 System::Net::System__Net__TimerThread__Queue __declspec(property(get=get_TimerQueue))  TimerQueue;
...
/// @brief Method get_MethodInfo addr 0x28329e4 size 0x8 virtual false final false
 System::Net::FtpMethodInfo get_MethodInfo() ;

/// @brief Method get_Method addr 0x28329ec size 0x1c virtual true final false
 ::StringW get_Method() ;

/// @brief Method set_Method addr 0x2832a08 size 0x1ac virtual true final false
 void set_Method(::StringW value) ;

/// @brief Method get_RenameTo addr 0x2832bcc size 0x8 virtual false final false
 ::StringW get_RenameTo() ;

/// @brief Method get_Credentials addr 0x2832bd4 size 0x8 virtual true final false
 System::Net::ICredentials get_Credentials() ;

/// @brief Method set_Credentials addr 0x2832bdc size 0x150 virtual true final false
 void set_Credentials(System::Net::ICredentials value) ;

/// @brief Method get_RequestUri addr 0x2832d2c size 0x8 virtual true final false
 System::Uri get_RequestUri() ;

/// @brief Method get_Timeout addr 0x2832d34 size 0x8 virtual true final false
 int32_t get_Timeout() ;

/// @brief Method set_Timeout addr 0x2832d3c size 0xd8 virtual true final false
 void set_Timeout(int32_t value) ;

/// @brief Method get_RemainingTimeout addr 0x2832e14 size 0x8 virtual false final false
 int32_t get_RemainingTimeout() ;

/// @brief Method get_ReadWriteTimeout addr 0x2832e1c size 0x8 virtual false final false
 int32_t get_ReadWriteTimeout() ;

/// @brief Method get_ContentOffset addr 0x2832e24 size 0x8 virtual false final false
 int64_t get_ContentOffset() ;

/// @brief Method get_ContentLength addr 0x2832e2c size 0x8 virtual true final false
 int64_t get_ContentLength() ;

/// @brief Method set_ContentLength addr 0x2832e34 size 0x8 virtual true final false
 void set_ContentLength(int64_t value) ;

/// @brief Method get_Proxy addr 0x2832e3c size 0x8 virtual true final false
 System::Net::IWebProxy get_Proxy() ;

/// @brief Method set_Proxy addr 0x2832e44 size 0x68 virtual true final false
 void set_Proxy(System::Net::IWebProxy value) ;

/// @brief Method set_ConnectionGroupName addr 0x2832eac size 0x6c virtual true final false
 void set_ConnectionGroupName(::StringW value) ;

/// @brief Method get_Aborted addr 0x2832f18 size 0x8 virtual false final false
 bool get_Aborted() ;

// Ctor Parameters [CppParam { name: "uri", ty: "System::Uri", modifiers: "", def_value: None }]
explicit FtpWebRequest(System::Uri uri) ;

/// @brief Method .ctor addr 0x2832f20 size 0x3c0 virtual false final false
 void _ctor(System::Uri uri) ;

/// @brief Method GetResponse addr 0x28332e0 size 0x7ac virtual true final false
 System::Net::WebResponse GetResponse() ;

/// @brief Method BeginGetResponse addr 0x2834bf4 size 0x6c0 virtual true final false
 System::IAsyncResult BeginGetResponse(System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType state) ;

/// @brief Method EndGetResponse addr 0x28352b4 size 0x40c virtual true final false
 System::Net::WebResponse EndGetResponse(System::IAsyncResult asyncResult) ;

/// @brief Method BeginGetRequestStream addr 0x28356c0 size 0x53c virtual true final false
 System::IAsyncResult BeginGetRequestStream(System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType state) ;

/// @brief Method EndGetRequestStream addr 0x2835bfc size 0x470 virtual true final false
 System::IO::Stream EndGetRequestStream(System::IAsyncResult asyncResult) ;

/// @brief Method SubmitRequest addr 0x2833ed4 size 0x4ec virtual false final false
 void SubmitRequest(bool isAsync) ;

/// @brief Method TranslateConnectException addr 0x283695c size 0x104 virtual false final false
 System::Exception TranslateConnectException(System::Exception e) ;

/// @brief Method CreateConnectionAsync addr 0x283606c size 0x94 virtual false final false
 void CreateConnectionAsync() ;

/// @brief Method CreateConnection addr 0x2836100 size 0x164 virtual false final false
 System::Net::FtpControlStream CreateConnection() ;

/// @brief Method TimedSubmitRequestHelper addr 0x28362b4 size 0x428 virtual false final false
 System::IO::Stream TimedSubmitRequestHelper(bool isAsync) ;

/// @brief Method TimerCallback addr 0x2836acc size 0xfc virtual false final false
 void TimerCallback(System::Net::System__Net__TimerThread__Timer timer, int32_t timeNoticed, ::bs_hook::Il2CppWrapperType context) ;

/// @brief Method get_TimerQueue addr 0x2836a60 size 0x6c virtual false final false
 System::Net::System__Net__TimerThread__Queue get_TimerQueue() ;

/// @brief Method AttemptedRecovery addr 0x28366dc size 0x280 virtual false final false
 bool AttemptedRecovery(System::Exception e) ;

/// @brief Method SetException addr 0x28348b0 size 0x344 virtual false final false
 void SetException(System::Exception exception) ;

/// @brief Method CheckError addr 0x2833a8c size 0x14 virtual false final false
 void CheckError() ;

/// @brief Method RequestCallback addr 0x282ab24 size 0x10 virtual false final false
 void RequestCallback(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method SyncRequestCallback addr 0x2837638 size 0x3d0 virtual false final false
 void SyncRequestCallback(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method AsyncRequestCallback addr 0x2836bd8 size 0xa60 virtual false final false
 void AsyncRequestCallback(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method FinishRequestStage addr 0x2833aa0 size 0x434 virtual false final false
 System::Net::System__Net__FtpWebRequest__RequestStage FinishRequestStage(System::Net::System__Net__FtpWebRequest__RequestStage stage) ;

/// @brief Method Abort addr 0x2837a08 size 0x48c virtual true final false
 void Abort() ;

/// @brief Method set_CachePolicy addr 0x2837e94 size 0x68 virtual true final false
 void set_CachePolicy(System::Net::Cache::RequestCachePolicy value) ;

/// @brief Method get_UseBinary addr 0x2837efc size 0x8 virtual false final false
 bool get_UseBinary() ;

/// @brief Method get_UsePassive addr 0x2837f04 size 0x8 virtual false final false
 bool get_UsePassive() ;

/// @brief Method get_ClientCertificates addr 0x282d600 size 0xfc virtual false final false
 System::Security::Cryptography::X509Certificates::X509CertificateCollection get_ClientCertificates() ;

/// @brief Method get_EnableSsl addr 0x2837f0c size 0x8 virtual false final false
 bool get_EnableSsl() ;

/// @brief Method get_Headers addr 0x2837f14 size 0x6c virtual true final false
 System::Net::WebHeaderCollection get_Headers() ;

/// @brief Method get_UseDefaultCredentials addr 0x2837f80 size 0x28 virtual true final false
 bool get_UseDefaultCredentials() ;

/// @brief Method set_PreAuthenticate addr 0x2837fa8 size 0x28 virtual true final false
 void set_PreAuthenticate(bool value) ;

/// @brief Method get_InUse addr 0x2832bb4 size 0x18 virtual false final false
 bool get_InUse() ;

/// @brief Method EnsureFtpWebResponse addr 0x28343c0 size 0x4f0 virtual false final false
 void EnsureFtpWebResponse(System::Exception exception) ;

/// @brief Method DataStreamClosed addr 0x2838180 size 0x80 virtual false final false
...
DEFINE_IL2CPP_ARG_TYPE(System::Net::System__Net__FtpWebRequest__RequestStage, "System.Net", "FtpWebRequest/RequestStage");
NEED_NO_BOX(System::Net::FtpWebRequest);
DEFINE_IL2CPP_ARG_TYPE(System::Net::FtpWebRequest, "System.Net", "FtpWebRequest");
NEED_NO_BOX(System::Net::System__Net__FtpWebRequest____c);
DEFINE_IL2CPP_ARG_TYPE(System::Net::System__Net__FtpWebRequest____c, "System.Net", "FtpWebRequest/<>c");
DEFINE_IL2CPP_ARG_TYPE(System::Net::System__Net__FtpWebRequest___CreateConnectionAsync_d__86, "System.Net", "FtpWebRequest/<CreateConnectionAsync>d__86");
