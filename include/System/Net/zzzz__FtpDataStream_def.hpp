...
/// @brief Method .ctor addr 0x282d488 size 0xfc virtual false final false
 void _ctor(System::Net::Sockets::NetworkStream networkStream, System::Net::FtpWebRequest request, System::Net::TriState writeOnly) ;

/// @brief Method Dispose addr 0x283107c size 0x188 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method System.Net.ICloseEx.CloseEx addr 0x2831204 size 0x3e4 virtual true final true
 void System_Net_ICloseEx_CloseEx(System::Net::CloseExState closeState) ;

/// @brief Method CheckError addr 0x28315e8 size 0x44 virtual false final false
 void CheckError() ;

/// @brief Method get_CanRead addr 0x283162c size 0x8 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanSeek addr 0x2831634 size 0x20 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_CanWrite addr 0x2831654 size 0x8 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_Length addr 0x283165c size 0x20 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x283167c size 0x20 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x283169c size 0x24 virtual true final false
 void set_Position(int64_t value) ;

/// @brief Method Seek addr 0x28316c0 size 0xcc virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method Read addr 0x283178c size 0x104 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t size) ;

/// @brief Method Write addr 0x2831890 size 0xd8 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t size) ;

/// @brief Method AsyncReadCallback addr 0x2831968 size 0x2b0 virtual false final false
 void AsyncReadCallback(System::IAsyncResult ar) ;

/// @brief Method BeginRead addr 0x2831c18 size 0x1ac virtual true final false
...
/// @brief Method EndRead addr 0x2831dc4 size 0x1a0 virtual true final false
 int32_t EndRead(System::IAsyncResult ar) ;

/// @brief Method BeginWrite addr 0x2831f64 size 0xf4 virtual true final false
...
/// @brief Method EndWrite addr 0x2832058 size 0xa0 virtual true final false
 void EndWrite(System::IAsyncResult asyncResult) ;

/// @brief Method Flush addr 0x28320f8 size 0x24 virtual true final false
 void Flush() ;

/// @brief Method SetLength addr 0x283211c size 0x24 virtual true final false
 void SetLength(int64_t value) ;

/// @brief Method get_CanTimeout addr 0x2832140 size 0x20 virtual true final false
 bool get_CanTimeout() ;

/// @brief Method get_ReadTimeout addr 0x2832160 size 0x24 virtual true final false
 int32_t get_ReadTimeout() ;

/// @brief Method set_ReadTimeout addr 0x2832184 size 0x24 virtual true final false
 void set_ReadTimeout(int32_t value) ;

/// @brief Method get_WriteTimeout addr 0x28321a8 size 0x24 virtual true final false
 int32_t get_WriteTimeout() ;

/// @brief Method set_WriteTimeout addr 0x28321cc size 0x24 virtual true final false
 void set_WriteTimeout(int32_t value) ;

/// @brief Method SetSocketTimeoutOption addr 0x28321f0 size 0x50 virtual false final false
