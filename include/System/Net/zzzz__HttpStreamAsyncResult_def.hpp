...
/// @brief Method Complete addr 0x285bb2c size 0x8 virtual false final false
 void Complete(System::Exception e) ;

/// @brief Method Complete addr 0x285b468 size 0x100 virtual false final false
 void Complete() ;

/// @brief Method get_AsyncState addr 0x286a49c size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType get_AsyncState() ;

/// @brief Method get_AsyncWaitHandle addr 0x286a4a4 size 0x13c virtual true final true
 System::Threading::WaitHandle get_AsyncWaitHandle() ;

/// @brief Method get_CompletedSynchronously addr 0x286a5e0 size 0x14 virtual true final true
 bool get_CompletedSynchronously() ;

/// @brief Method get_IsCompleted addr 0x286a5f4 size 0xc8 virtual true final true
 bool get_IsCompleted() ;

// Ctor Parameters []
explicit HttpStreamAsyncResult() ;

/// @brief Method .ctor addr 0x285b400 size 0x68 virtual false final false
 void _ctor() ;
