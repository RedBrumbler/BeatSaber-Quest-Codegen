...
/// @brief Method .ctor addr 0x283d4cc size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x283d534 size 0xc4 virtual false final false
 void _ctor(::StringW userName, ::StringW password, ::StringW domain) ;

/// @brief Method get_UserName addr 0x283d6d8 size 0x8 virtual false final false
 ::StringW get_UserName() ;

/// @brief Method set_UserName addr 0x283d5f8 size 0x60 virtual false final false
 void set_UserName(::StringW value) ;

/// @brief Method get_Password addr 0x283d6e0 size 0xc virtual false final false
 ::StringW get_Password() ;

/// @brief Method set_Password addr 0x283d658 size 0x20 virtual false final false
 void set_Password(::StringW value) ;

/// @brief Method get_Domain addr 0x283d6f8 size 0x8 virtual false final false
 ::StringW get_Domain() ;

/// @brief Method set_Domain addr 0x283d678 size 0x60 virtual false final false
 void set_Domain(::StringW value) ;

/// @brief Method InternalGetUserName addr 0x283d700 size 0x8 virtual false final false
 ::StringW InternalGetUserName() ;

/// @brief Method InternalGetPassword addr 0x283d6ec size 0xc virtual false final false
 ::StringW InternalGetPassword() ;

/// @brief Method InternalGetDomain addr 0x283d708 size 0x8 virtual false final false
 ::StringW InternalGetDomain() ;

/// @brief Method GetCredential addr 0x283d710 size 0x4 virtual true final true
