...
/// @brief Method .ctor addr 0x2832240 size 0x44 virtual false final false
 void _ctor(::StringW method, System::Net::FtpOperation operation, System::Net::FtpMethodFlags flags, ::StringW httpCommand) ;

/// @brief Method HasFlag addr 0x282feb8 size 0x10 virtual false final false
 bool HasFlag(System::Net::FtpMethodFlags flags) ;

/// @brief Method get_IsCommandOnly addr 0x283005c size 0x10 virtual false final false
 bool get_IsCommandOnly() ;

/// @brief Method get_IsUpload addr 0x2830e58 size 0xc virtual false final false
 bool get_IsUpload() ;

/// @brief Method get_IsDownload addr 0x2830e64 size 0xc virtual false final false
 bool get_IsDownload() ;

/// @brief Method get_ShouldParseForResponseUri addr 0x282e710 size 0xc virtual false final false
 bool get_ShouldParseForResponseUri() ;

/// @brief Method GetMethodInfo addr 0x2832284 size 0x164 virtual false final false
