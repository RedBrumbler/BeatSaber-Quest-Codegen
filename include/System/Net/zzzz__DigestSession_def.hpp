...
/// @brief Method .ctor addr 0x285c838 size 0x70 virtual false final false
 void _ctor() ;

/// @brief Method get_Algorithm addr 0x285c8a8 size 0x18 virtual false final false
 ::StringW get_Algorithm() ;

/// @brief Method get_Realm addr 0x285c8c0 size 0x18 virtual false final false
 ::StringW get_Realm() ;

/// @brief Method get_Nonce addr 0x285c8d8 size 0x18 virtual false final false
 ::StringW get_Nonce() ;

/// @brief Method get_Opaque addr 0x285c8f0 size 0x18 virtual false final false
 ::StringW get_Opaque() ;

/// @brief Method get_QOP addr 0x285c908 size 0x18 virtual false final false
 ::StringW get_QOP() ;

/// @brief Method get_CNonce addr 0x285c920 size 0xf4 virtual false final false
 ::StringW get_CNonce() ;

/// @brief Method Parse addr 0x285ca14 size 0xe0 virtual false final false
 bool Parse(::StringW challenge) ;

/// @brief Method HashToHexString addr 0x285caf4 size 0x150 virtual false final false
 ::StringW HashToHexString(::StringW toBeHashed) ;

/// @brief Method HA1 addr 0x285cc44 size 0x124 virtual false final false
 ::StringW HA1(::StringW username, ::StringW password) ;

/// @brief Method HA2 addr 0x285cd68 size 0xd0 virtual false final false
 ::StringW HA2(System::Net::HttpWebRequest webRequest) ;

/// @brief Method Response addr 0x285ce38 size 0x160 virtual false final false
 ::StringW Response(::StringW username, ::StringW password, System::Net::HttpWebRequest webRequest) ;

/// @brief Method Authenticate addr 0x285cf98 size 0x5e0 virtual false final false
 System::Net::Authorization Authenticate(System::Net::WebRequest webRequest, System::Net::ICredentials credentials) ;

/// @brief Method get_LastUse addr 0x285d578 size 0x8 virtual false final false
