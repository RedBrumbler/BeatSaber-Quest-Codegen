...
/// @brief Method IsFatal addr 0x283c1f8 size 0xc0 virtual false final false
static bool IsFatal(System::Exception exception) ;

/// @brief Method IsAddressLocal addr 0x283c2b8 size 0x8c virtual false final false
static bool IsAddressLocal(System::Net::IPAddress ipAddress) ;

/// @brief Method GetLocalHost addr 0x283c800 size 0x18 virtual false final false
static System::Net::IPHostEntry GetLocalHost() ;

/// @brief Method get_LocalAddresses addr 0x283c344 size 0x4bc virtual false final false
static ::ArrayW<System::Net::IPAddress> get_LocalAddresses() ;

/// @brief Method get_LocalAddressesLock addr 0x283c818 size 0xa4 virtual false final false
