...
/// @brief Method get_AddressFamily addr 0x28391a8 size 0x28 virtual true final false
 System::Net::Sockets::AddressFamily get_AddressFamily() ;

/// @brief Method Serialize addr 0x28391d0 size 0x28 virtual true final false
 System::Net::SocketAddress Serialize() ;

/// @brief Method Create addr 0x28391f8 size 0x28 virtual true final false
 System::Net::EndPoint Create(System::Net::SocketAddress socketAddress) ;

// Ctor Parameters []
explicit EndPoint() ;

/// @brief Method .ctor addr 0x282a1ec size 0x8 virtual false final false
 void _ctor() ;
