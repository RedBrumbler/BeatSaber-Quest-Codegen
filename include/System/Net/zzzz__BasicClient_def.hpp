...
/// @brief Method Authenticate addr 0x285a440 size 0xac virtual true final true
...
/// @brief Method GetBytes addr 0x285a898 size 0xa8 virtual false final false
static ::ArrayW<uint8_t> GetBytes(::StringW str) ;

/// @brief Method InternalAuthenticate addr 0x285a4ec size 0x3ac virtual false final false
...
/// @brief Method PreAuthenticate addr 0x285a940 size 0xc virtual true final true
 System::Net::Authorization PreAuthenticate(System::Net::WebRequest webRequest, System::Net::ICredentials credentials) ;

/// @brief Method get_AuthenticationType addr 0x285a94c size 0x40 virtual true final true
 ::StringW get_AuthenticationType() ;

// Ctor Parameters []
explicit BasicClient() ;

/// @brief Method .ctor addr 0x2859894 size 0x8 virtual false final false
 void _ctor() ;
