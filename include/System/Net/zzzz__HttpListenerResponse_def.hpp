...
/// @brief Method .ctor addr 0x28680c4 size 0x114 virtual false final false
 void _ctor(System::Net::HttpListenerContext context) ;

/// @brief Method get_ForceCloseChunked addr 0x2869034 size 0x8 virtual false final false
 bool get_ForceCloseChunked() ;

/// @brief Method get_ContentEncoding addr 0x286616c size 0x20 virtual false final false
 System::Text::Encoding get_ContentEncoding() ;

/// @brief Method set_ContentLength64 addr 0x286903c size 0x130 virtual false final false
 void set_ContentLength64(int64_t value) ;

/// @brief Method set_ContentType addr 0x2866094 size 0xd8 virtual false final false
 void set_ContentType(::StringW value) ;

/// @brief Method get_Headers addr 0x286916c size 0x8 virtual false final false
 System::Net::WebHeaderCollection get_Headers() ;

/// @brief Method get_OutputStream addr 0x2869174 size 0x34 virtual false final false
 System::IO::Stream get_OutputStream() ;

/// @brief Method get_SendChunked addr 0x28691a8 size 0x8 virtual false final false
 bool get_SendChunked() ;

/// @brief Method set_SendChunked addr 0x2863f08 size 0xdc virtual false final false
 void set_SendChunked(bool value) ;

/// @brief Method set_StatusCode addr 0x2865f60 size 0x134 virtual false final false
 void set_StatusCode(int32_t value) ;

/// @brief Method System.IDisposable.Dispose addr 0x28691b0 size 0x8 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method Close addr 0x28691b8 size 0x2c virtual false final false
 void Close(bool force) ;

/// @brief Method Close addr 0x28691e4 size 0x14 virtual false final false
 void Close() ;

/// @brief Method Close addr 0x286618c size 0xbc virtual false final false
 void Close(::ArrayW<uint8_t> responseEntity, bool willBlock) ;

/// @brief Method SendHeaders addr 0x28691f8 size 0x9a8 virtual false final false
 void SendHeaders(bool closing, System::IO::MemoryStream ms) ;

/// @brief Method FormatHeaders addr 0x2869e38 size 0x254 virtual false final false
static ::StringW FormatHeaders(System::Net::WebHeaderCollection headers) ;

/// @brief Method CookieToClientString addr 0x2869ba0 size 0x298 virtual false final false
static ::StringW CookieToClientString(System::Net::Cookie cookie) ;

/// @brief Method QuotedString addr 0x286a08c size 0xd0 virtual false final false
static ::StringW QuotedString(System::Net::Cookie cookie, ::StringW value) ;

/// @brief Method IsToken addr 0x286a15c size 0xd0 virtual false final false
