...
/// @brief Method MoveNext addr 0x2888ab4 size 0x8e4 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2889398 size 0x58 virtual true final true
...
/// @brief Method .ctor addr 0x28875d8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ProcessRead>b__0 addr 0x28893f0 size 0x3c virtual false final false
 System::Threading::Tasks::Task_1<int32_t> _ProcessRead_b__0(System::Threading::CancellationToken ct) ;

/// @brief Method <ProcessRead>b__1 addr 0x288942c size 0x40 virtual false final false
 void _ProcessRead_b__1() ;

/// @brief Method <ProcessRead>b__2 addr 0x288946c size 0x24 virtual false final false
...
/// @brief Method MoveNext addr 0x2889490 size 0x568 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x28899f8 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method MoveNext addr 0x2889a50 size 0x95c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x288a3ac size 0xc virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method MoveNext addr 0x288a3b8 size 0x6bc virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x288aa74 size 0xc virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
namespace System::Net {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8090))}
...
/// @brief Method get_RequestStream addr 0x2887120 size 0x8 virtual false final false
 System::Net::WebRequestStream get_RequestStream() ;

/// @brief Method get_Headers addr 0x2887128 size 0x8 virtual false final false
 System::Net::WebHeaderCollection get_Headers() ;

/// @brief Method set_Headers addr 0x2887130 size 0x8 virtual false final false
 void set_Headers(System::Net::WebHeaderCollection value) ;

/// @brief Method get_StatusCode addr 0x2887138 size 0x8 virtual false final false
 System::Net::HttpStatusCode get_StatusCode() ;

/// @brief Method set_StatusCode addr 0x2887140 size 0x8 virtual false final false
 void set_StatusCode(System::Net::HttpStatusCode value) ;

/// @brief Method get_StatusDescription addr 0x2887148 size 0x8 virtual false final false
 ::StringW get_StatusDescription() ;

/// @brief Method set_StatusDescription addr 0x2887150 size 0x8 virtual false final false
 void set_StatusDescription(::StringW value) ;

/// @brief Method get_Version addr 0x2887158 size 0x8 virtual false final false
 System::Version get_Version() ;

/// @brief Method set_Version addr 0x2887160 size 0x8 virtual false final false
 void set_Version(System::Version value) ;

/// @brief Method get_KeepAlive addr 0x2887168 size 0x8 virtual false final false
 bool get_KeepAlive() ;

/// @brief Method set_KeepAlive addr 0x2887170 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x288717c size 0x84 virtual false final false
 void _ctor(System::Net::WebRequestStream request) ;

/// @brief Method get_CanRead addr 0x2887200 size 0x8 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanWrite addr 0x2887208 size 0x8 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_ChunkedRead addr 0x2887210 size 0x8 virtual false final false
 bool get_ChunkedRead() ;

/// @brief Method set_ChunkedRead addr 0x2887218 size 0xc virtual false final false
 void set_ChunkedRead(bool value) ;

/// @brief Method ReadAsync addr 0x2887224 size 0x134 virtual true final false
...
/// @brief Method ProcessRead addr 0x2887358 size 0x280 virtual false final false
...
/// @brief Method TryReadFromBufferedContent addr 0x28875e0 size 0xcc virtual true final false
 bool TryReadFromBufferedContent(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count, ByRef<int32_t> result) ;

/// @brief Method get_ExpectContent addr 0x28876ac size 0x90 virtual false final false
 bool get_ExpectContent() ;

/// @brief Method Initialize addr 0x288773c size 0x52c virtual false final false
 void Initialize(System::Net::BufferOffsetSize buffer) ;

/// @brief Method ReadAllAsyncInner addr 0x2887c68 size 0x100 virtual false final false
 System::Threading::Tasks::Task_1<::ArrayW<uint8_t>> ReadAllAsyncInner(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method ReadAllAsync addr 0x2887d68 size 0xf4 virtual false final false
 System::Threading::Tasks::Task ReadAllAsync(bool resending, System::Threading::CancellationToken cancellationToken) ;

/// @brief Method WriteAsync addr 0x2887e5c size 0x9c virtual true final false
...
/// @brief Method Close_internal addr 0x2887ef8 size 0x8c virtual true final false
 void Close_internal(ByRef<bool> disposed) ;

/// @brief Method GetReadException addr 0x2887f84 size 0x29c virtual false final false
 System::Net::WebException GetReadException(System::Net::WebExceptionStatus status, System::Exception error, ::StringW where) ;

/// @brief Method InitReadAsync addr 0x2888220 size 0xdc virtual false final false
 System::Threading::Tasks::Task InitReadAsync(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method GetResponse addr 0x28882fc size 0x7b8 virtual false final false
