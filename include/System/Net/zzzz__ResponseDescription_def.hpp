...
/// @brief Method get_PositiveIntermediate addr 0x282c6e4 size 0x14 virtual false final false
 bool get_PositiveIntermediate() ;

/// @brief Method get_PositiveCompletion addr 0x282c6f8 size 0x14 virtual false final false
 bool get_PositiveCompletion() ;

/// @brief Method get_TransientFailure addr 0x282c70c size 0x14 virtual false final false
 bool get_TransientFailure() ;

/// @brief Method get_PermanentFailure addr 0x282c720 size 0x14 virtual false final false
 bool get_PermanentFailure() ;

/// @brief Method get_InvalidStatusCode addr 0x282c734 size 0x14 virtual false final false
 bool get_InvalidStatusCode() ;

// Ctor Parameters []
explicit ResponseDescription() ;

/// @brief Method .ctor addr 0x282c748 size 0x70 virtual false final false
 void _ctor() ;
