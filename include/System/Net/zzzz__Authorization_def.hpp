...
/// @brief Method .ctor addr 0x2838f2c size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x2838fac size 0x80 virtual false final false
 void _ctor(::StringW token, bool finished) ;

/// @brief Method get_Message addr 0x283902c size 0x8 virtual false final false
 ::StringW get_Message() ;

/// @brief Method get_Complete addr 0x2839034 size 0x8 virtual false final false
 bool get_Complete() ;
