...
/// @brief Method .ctor addr 0x285fc74 size 0x260 virtual false final false
...
/// @brief Method Init addr 0x2863a40 size 0xa8 virtual false final false
 void Init() ;

/// @brief Method get_Reuses addr 0x2863b9c size 0x8 virtual false final false
 int32_t get_Reuses() ;

/// @brief Method get_LocalEndPoint addr 0x2863ba4 size 0xb8 virtual false final false
 System::Net::IPEndPoint get_LocalEndPoint() ;

/// @brief Method get_IsSecure addr 0x2863c5c size 0x8 virtual false final false
 bool get_IsSecure() ;

/// @brief Method set_Prefix addr 0x2863c64 size 0x8 virtual false final false
 void set_Prefix(System::Net::ListenerPrefix value) ;

/// @brief Method OnTimeout addr 0x2863c6c size 0x18 virtual false final false
 void OnTimeout(::bs_hook::Il2CppWrapperType unused) ;

/// @brief Method BeginReadRequest addr 0x285fed4 size 0x1a8 virtual false final false
 void BeginReadRequest() ;

/// @brief Method GetRequestStream addr 0x2863dbc size 0x14c virtual false final false
 System::Net::RequestStream GetRequestStream(bool chunked, int64_t contentlength) ;

/// @brief Method GetResponseStream addr 0x2863fe4 size 0xc8 virtual false final false
 System::Net::ResponseStream GetResponseStream() ;

/// @brief Method OnRead addr 0x28640ac size 0xd4 virtual false final false
static void OnRead(System::IAsyncResult ares) ;

/// @brief Method OnReadInternal addr 0x2864180 size 0x338 virtual false final false
 void OnReadInternal(System::IAsyncResult ares) ;

/// @brief Method RemoveConnection addr 0x2864dc0 size 0x40 virtual false final false
 void RemoveConnection() ;

/// @brief Method ProcessInput addr 0x28644d8 size 0x2bc virtual false final false
 bool ProcessInput(System::IO::MemoryStream ms) ;

/// @brief Method ReadLine addr 0x28651b8 size 0x178 virtual false final false
 ::StringW ReadLine(::ArrayW<uint8_t> buffer, int32_t offset, int32_t len, ByRef<int32_t> used) ;

/// @brief Method SendError addr 0x285b954 size 0x1d8 virtual false final false
 void SendError(::StringW msg, int32_t status) ;

/// @brief Method SendError addr 0x28644b8 size 0x20 virtual false final false
 void SendError() ;

/// @brief Method Unbind addr 0x2863d8c size 0x30 virtual false final false
 void Unbind() ;

/// @brief Method CloseSocket addr 0x2863c84 size 0x108 virtual false final false
 void CloseSocket() ;

/// @brief Method Close addr 0x2861788 size 0x268 virtual false final false
 void Close(bool force_close) ;

/// @brief Method <.ctor>b__24_0 addr 0x2866700 size 0xf4 virtual false final false
