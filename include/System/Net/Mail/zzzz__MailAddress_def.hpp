...
/// @brief Method .ctor addr 0x27a1188 size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x27a1a9c size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x27a1aa8 size 0x24c virtual false final false
 void _ctor(::StringW address, ::StringW displayName, System::Text::Encoding displayNameEncoding) ;

/// @brief Method get_DisplayName addr 0x27a1cf4 size 0x8 virtual false final false
 ::StringW get_DisplayName() ;

/// @brief Method get_Address addr 0x27a1cfc size 0x4c virtual false final false
 ::StringW get_Address() ;

/// @brief Method get_SmtpAddress addr 0x27a1d48 size 0x78 virtual false final false
 ::StringW get_SmtpAddress() ;

/// @brief Method ToString addr 0x27a1dc0 size 0xa4 virtual true final false
 ::StringW ToString() ;

/// @brief Method Equals addr 0x27a1e64 size 0x64 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetHashCode addr 0x27a1ec8 size 0x28 virtual true final false
 int32_t GetHashCode() ;
