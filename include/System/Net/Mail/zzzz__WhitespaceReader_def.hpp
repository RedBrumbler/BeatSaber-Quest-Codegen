...
/// @brief Method ReadFwsReverse addr 0x27a01cc size 0x20c virtual false final false
static int32_t ReadFwsReverse(::StringW data, int32_t index) ;

/// @brief Method ReadCfwsReverse addr 0x27a1208 size 0x2e0 virtual false final false
