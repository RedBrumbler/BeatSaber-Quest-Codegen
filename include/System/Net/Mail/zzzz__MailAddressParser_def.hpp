...
/// @brief Method ParseAddress addr 0x27a07c0 size 0x30 virtual false final false
static System::Net::Mail::MailAddress ParseAddress(::StringW data) ;

/// @brief Method ParseAddress addr 0x27a07f0 size 0x378 virtual false final false
static System::Net::Mail::MailAddress ParseAddress(::StringW data, bool expectMultipleAddresses, ByRef<int32_t> index) ;

/// @brief Method ReadCfwsAndThrowIfIncomplete addr 0x27a0b68 size 0x60 virtual false final false
static int32_t ReadCfwsAndThrowIfIncomplete(::StringW data, int32_t index) ;

/// @brief Method ParseDomain addr 0x27a0bc8 size 0xe8 virtual false final false
static ::StringW ParseDomain(::StringW data, ByRef<int32_t> index) ;

/// @brief Method ParseLocalPart addr 0x27a0cb0 size 0x2d4 virtual false final false
static ::StringW ParseLocalPart(::StringW data, ByRef<int32_t> index, bool expectAngleBracket, bool expectMultipleAddresses) ;

/// @brief Method ParseDisplayName addr 0x27a0f84 size 0x204 virtual false final false
static ::StringW ParseDisplayName(::StringW data, ByRef<int32_t> index, bool expectMultipleAddresses) ;

/// @brief Method NormalizeOrThrow addr 0x27a14e8 size 0xec virtual false final false
