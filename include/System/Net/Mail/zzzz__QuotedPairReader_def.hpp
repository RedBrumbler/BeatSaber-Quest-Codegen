...
/// @brief Method CountQuotedChars addr 0x27a03d8 size 0x194 virtual false final false
static int32_t CountQuotedChars(::StringW data, int32_t index, bool permitUnicodeEscaping) ;

/// @brief Method CountBackslashes addr 0x27a1940 size 0xa4 virtual false final false
