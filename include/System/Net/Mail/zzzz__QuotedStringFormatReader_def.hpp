...
/// @brief Method ReadReverseQuoted addr 0x27a15d4 size 0x1cc virtual false final false
static int32_t ReadReverseQuoted(::StringW data, int32_t index, bool permitUnicode) ;

/// @brief Method ReadReverseUnQuoted addr 0x27a17a0 size 0x1a0 virtual false final false
static int32_t ReadReverseUnQuoted(::StringW data, int32_t index, bool permitUnicode, bool expectCommaDelimiter) ;

/// @brief Method IsValidQtext addr 0x27a19e4 size 0xb8 virtual false final false
