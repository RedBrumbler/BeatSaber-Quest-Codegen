...
/// @brief Method .ctor addr 0x282dfb8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <PipelineCallback>b__0 addr 0x2830f84 size 0xf8 virtual false final false
...
namespace System::Net {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7906))}
...
/// @brief Method get_Credentials addr 0x282c7b8 size 0xa8 virtual false final false
 System::Net::NetworkCredential get_Credentials() ;

/// @brief Method set_Credentials addr 0x282c860 size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x282c8e0 size 0x8c virtual false final false
 void _ctor(System::Net::Sockets::TcpClient client) ;

/// @brief Method AbortConnect addr 0x282c96c size 0x8c virtual false final false
 void AbortConnect() ;

/// @brief Method AcceptCallback addr 0x282c9f8 size 0x368 virtual false final false
static void AcceptCallback(System::IAsyncResult asyncResult) ;

/// @brief Method ConnectCallback addr 0x282cdf4 size 0x1b0 virtual false final false
static void ConnectCallback(System::IAsyncResult asyncResult) ;

/// @brief Method SSLHandshakeCallback addr 0x282cfa4 size 0x1c4 virtual false final false
static void SSLHandshakeCallback(System::IAsyncResult asyncResult) ;

/// @brief Method QueueOrCreateFtpDataStream addr 0x282d168 size 0x29c virtual false final false
 System::Net::System__Net__CommandStream__PipelineInstruction QueueOrCreateFtpDataStream(ByRef<System::IO::Stream> stream) ;

/// @brief Method ClearState addr 0x282d6fc size 0x90 virtual true final false
 void ClearState() ;

/// @brief Method PipelineCallback addr 0x282d78c size 0x82c virtual true final false
...
/// @brief Method BuildCommandsList addr 0x282efe0 size 0xdd8 virtual true final false
 ::ArrayW<System::Net::System__Net__CommandStream__PipelineEntry> BuildCommandsList(System::Net::WebRequest req) ;

/// @brief Method QueueOrCreateDataConection addr 0x282dfc0 size 0x664 virtual false final false
...
/// @brief Method GetPathInfo addr 0x282fec8 size 0x194 virtual false final false
...
/// @brief Method FormatAddress addr 0x2830810 size 0x124 virtual false final false
 ::StringW FormatAddress(System::Net::IPAddress address, int32_t Port) ;

/// @brief Method FormatAddressV6 addr 0x2830934 size 0x110 virtual false final false
 ::StringW FormatAddressV6(System::Net::IPAddress address, int32_t port) ;

/// @brief Method get_ContentLength addr 0x2830a44 size 0x8 virtual false final false
 int64_t get_ContentLength() ;

/// @brief Method get_LastModified addr 0x2830a4c size 0x8 virtual false final false
 System::DateTime get_LastModified() ;

/// @brief Method get_ResponseUri addr 0x2830a54 size 0x8 virtual false final false
 System::Uri get_ResponseUri() ;

/// @brief Method get_BannerMessage addr 0x2830a5c size 0x18 virtual false final false
 ::StringW get_BannerMessage() ;

/// @brief Method get_WelcomeMessage addr 0x2830a74 size 0x18 virtual false final false
 ::StringW get_WelcomeMessage() ;

/// @brief Method get_ExitMessage addr 0x2830a8c size 0x18 virtual false final false
 ::StringW get_ExitMessage() ;

/// @brief Method GetContentLengthFrom213Response addr 0x282ea90 size 0x140 virtual false final false
 int64_t GetContentLengthFrom213Response(::StringW responseString) ;

/// @brief Method GetLastModifiedFrom213Response addr 0x282ebd0 size 0x360 virtual false final false
 System::DateTime GetLastModifiedFrom213Response(::StringW str) ;

/// @brief Method TryUpdateResponseUri addr 0x282e71c size 0x358 virtual false final false
 void TryUpdateResponseUri(::StringW str, System::Net::FtpWebRequest request) ;

/// @brief Method TryUpdateContentLength addr 0x282e624 size 0xec virtual false final false
 void TryUpdateContentLength(::StringW str) ;

/// @brief Method GetLoginDirectory addr 0x282ef30 size 0xb0 virtual false final false
 ::StringW GetLoginDirectory(::StringW str) ;

/// @brief Method GetPortV4 addr 0x28303dc size 0x1f4 virtual false final false
 int32_t GetPortV4(::StringW responseString) ;

/// @brief Method GetPortV6 addr 0x28305d0 size 0x1c0 virtual false final false
 int32_t GetPortV6(::StringW responseString) ;

/// @brief Method CreateFtpListenerSocket addr 0x283006c size 0x17c virtual false final false
 void CreateFtpListenerSocket(System::Net::FtpWebRequest request) ;

/// @brief Method GetPortCommandLine addr 0x28301e8 size 0x1f4 virtual false final false
 ::StringW GetPortCommandLine(System::Net::FtpWebRequest request) ;

/// @brief Method FormatFtpCommand addr 0x282fdb8 size 0x100 virtual false final false
 ::StringW FormatFtpCommand(::StringW command, ::StringW parameter) ;

/// @brief Method CreateFtpDataSocket addr 0x2830790 size 0x80 virtual false final false
 System::Net::Sockets::Socket CreateFtpDataSocket(System::Net::FtpWebRequest request, System::Net::Sockets::Socket templateSocket) ;

/// @brief Method CheckValid addr 0x2830aa4 size 0x3b4 virtual true final false
 bool CheckValid(System::Net::ResponseDescription response, ByRef<int32_t> validThrough, ByRef<int32_t> completeLength) ;

/// @brief Method IsFtpDataStreamWriteable addr 0x282d404 size 0x84 virtual false final false
