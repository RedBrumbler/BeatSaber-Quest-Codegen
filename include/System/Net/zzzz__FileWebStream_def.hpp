...
/// @brief Method .ctor addr 0x2853cb0 size 0x9c virtual false final false
...
/// @brief Method .ctor addr 0x2854920 size 0xb4 virtual false final false
...
/// @brief Method Dispose addr 0x28549d4 size 0xb0 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method System.Net.ICloseEx.CloseEx addr 0x2854a84 size 0x3c virtual true final true
 void System_Net_ICloseEx_CloseEx(System::Net::CloseExState closeState) ;

/// @brief Method Read addr 0x2854ac0 size 0xc8 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t size) ;

/// @brief Method Write addr 0x2854c08 size 0xc8 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t size) ;

/// @brief Method BeginRead addr 0x2854cd0 size 0xe0 virtual true final false
...
/// @brief Method EndRead addr 0x2854db0 size 0xa0 virtual true final false
 int32_t EndRead(System::IAsyncResult ar) ;

/// @brief Method BeginWrite addr 0x2854e50 size 0xe0 virtual true final false
...
/// @brief Method EndWrite addr 0x2854f30 size 0xa0 virtual true final false
 void EndWrite(System::IAsyncResult ar) ;

/// @brief Method CheckError addr 0x2854b88 size 0x80 virtual false final false
 void CheckError() ;
