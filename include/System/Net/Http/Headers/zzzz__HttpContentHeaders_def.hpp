...
/// @brief Method .ctor addr 0x26d1f04 size 0x70 virtual false final false
 void _ctor(System::Net::Http::HttpContent content) ;

/// @brief Method get_ContentLength addr 0x26cfb0c size 0x128 virtual false final false
 System::Nullable_1<int64_t> get_ContentLength() ;

/// @brief Method get_ContentType addr 0x26d2a98 size 0x68 virtual false final false
 System::Net::Http::Headers::MediaTypeHeaderValue get_ContentType() ;

/// @brief Method set_ContentType addr 0x26d40c8 size 0x74 virtual false final false
