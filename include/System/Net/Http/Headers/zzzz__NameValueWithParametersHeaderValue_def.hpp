...
namespace System::Net::Http::Headers {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14867))}
...
/// @brief Method .ctor addr 0x26dd9e8 size 0x1ec virtual false final false
 void _ctor(System::Net::Http::Headers::NameValueWithParametersHeaderValue source) ;

// Ctor Parameters []
explicit NameValueWithParametersHeaderValue() ;

/// @brief Method .ctor addr 0x26ddc54 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_Parameters addr 0x26ddbd4 size 0x80 virtual false final false
 System::Collections::Generic::ICollection_1<System::Net::Http::Headers::NameValueHeaderValue> get_Parameters() ;

/// @brief Method System.ICloneable.Clone addr 0x26ddc5c size 0x60 virtual true final true
 ::bs_hook::Il2CppWrapperType System_ICloneable_Clone() ;

/// @brief Method Equals addr 0x26ddcbc size 0xc0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x26ddd7c size 0x60 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x26ddddc size 0x94 virtual true final false
 ::StringW ToString() ;

/// @brief Method TryParse addr 0x26dde70 size 0xb0 virtual false final false
...
/// @brief Method TryParseElement addr 0x26ddf20 size 0x1dc virtual false final false
