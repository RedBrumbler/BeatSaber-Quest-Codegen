...
/// @brief Method get_Extensions addr 0x26d4960 size 0x80 virtual false final false
 System::Collections::Generic::ICollection_1<System::Net::Http::Headers::NameValueHeaderValue> get_Extensions() ;

/// @brief Method get_MaxAge addr 0x26d49e0 size 0xc virtual false final false
 System::Nullable_1<System::TimeSpan> get_MaxAge() ;

/// @brief Method set_MaxAge addr 0x26d49ec size 0x8 virtual false final false
 void set_MaxAge(System::Nullable_1<System::TimeSpan> value) ;

/// @brief Method get_MaxStale addr 0x26d49f4 size 0x8 virtual false final false
 bool get_MaxStale() ;

/// @brief Method set_MaxStale addr 0x26d49fc size 0xc virtual false final false
 void set_MaxStale(bool value) ;

/// @brief Method get_MaxStaleLimit addr 0x26d4a08 size 0xc virtual false final false
 System::Nullable_1<System::TimeSpan> get_MaxStaleLimit() ;

/// @brief Method set_MaxStaleLimit addr 0x26d4a14 size 0x8 virtual false final false
 void set_MaxStaleLimit(System::Nullable_1<System::TimeSpan> value) ;

/// @brief Method get_MinFresh addr 0x26d4a1c size 0xc virtual false final false
 System::Nullable_1<System::TimeSpan> get_MinFresh() ;

/// @brief Method set_MinFresh addr 0x26d4a28 size 0x8 virtual false final false
 void set_MinFresh(System::Nullable_1<System::TimeSpan> value) ;

/// @brief Method get_MustRevalidate addr 0x26d4a30 size 0x8 virtual false final false
 bool get_MustRevalidate() ;

/// @brief Method set_MustRevalidate addr 0x26d4a38 size 0xc virtual false final false
 void set_MustRevalidate(bool value) ;

/// @brief Method get_NoCache addr 0x26d4a44 size 0x8 virtual false final false
 bool get_NoCache() ;

/// @brief Method set_NoCache addr 0x26d4a4c size 0xc virtual false final false
 void set_NoCache(bool value) ;

/// @brief Method get_NoCacheHeaders addr 0x26d4a58 size 0x80 virtual false final false
 System::Collections::Generic::ICollection_1<::StringW> get_NoCacheHeaders() ;

/// @brief Method get_NoStore addr 0x26d4ad8 size 0x8 virtual false final false
 bool get_NoStore() ;

/// @brief Method set_NoStore addr 0x26d4ae0 size 0xc virtual false final false
 void set_NoStore(bool value) ;

/// @brief Method get_NoTransform addr 0x26d4aec size 0x8 virtual false final false
 bool get_NoTransform() ;

/// @brief Method set_NoTransform addr 0x26d4af4 size 0xc virtual false final false
 void set_NoTransform(bool value) ;

/// @brief Method get_OnlyIfCached addr 0x26d4b00 size 0x8 virtual false final false
 bool get_OnlyIfCached() ;

/// @brief Method set_OnlyIfCached addr 0x26d4b08 size 0xc virtual false final false
 void set_OnlyIfCached(bool value) ;

/// @brief Method get_Private addr 0x26d4b14 size 0x8 virtual false final false
 bool get_Private() ;

/// @brief Method set_Private addr 0x26d4b1c size 0xc virtual false final false
 void set_Private(bool value) ;

/// @brief Method get_PrivateHeaders addr 0x26d4b28 size 0x80 virtual false final false
 System::Collections::Generic::ICollection_1<::StringW> get_PrivateHeaders() ;

/// @brief Method get_ProxyRevalidate addr 0x26d4ba8 size 0x8 virtual false final false
 bool get_ProxyRevalidate() ;

/// @brief Method set_ProxyRevalidate addr 0x26d4bb0 size 0xc virtual false final false
 void set_ProxyRevalidate(bool value) ;

/// @brief Method get_Public addr 0x26d4bbc size 0x8 virtual false final false
 bool get_Public() ;

/// @brief Method set_Public addr 0x26d4bc4 size 0xc virtual false final false
 void set_Public(bool value) ;

/// @brief Method get_SharedMaxAge addr 0x26d4bd0 size 0xc virtual false final false
 System::Nullable_1<System::TimeSpan> get_SharedMaxAge() ;

/// @brief Method set_SharedMaxAge addr 0x26d4bdc size 0x8 virtual false final false
 void set_SharedMaxAge(System::Nullable_1<System::TimeSpan> value) ;

/// @brief Method System.ICloneable.Clone addr 0x26d4be4 size 0x568 virtual true final true
 ::bs_hook::Il2CppWrapperType System_ICloneable_Clone() ;

/// @brief Method Equals addr 0x26d514c size 0x384 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x26d54d0 size 0x260 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method TryParse addr 0x26d5730 size 0x8f4 virtual false final false
static bool TryParse(::StringW input, ByRef<System::Net::Http::Headers::CacheControlHeaderValue> parsedValue) ;

/// @brief Method ToString addr 0x26d620c size 0x6e0 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit CacheControlHeaderValue() ;

/// @brief Method .ctor addr 0x26d6024 size 0x8 virtual false final false
 void _ctor() ;
