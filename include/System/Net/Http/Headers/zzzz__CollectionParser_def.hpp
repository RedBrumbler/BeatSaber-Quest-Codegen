...
/// @brief Method TryParse addr 0x26d6c58 size 0xb0 virtual false final false
static bool TryParse(::StringW input, int32_t minimalCount, ByRef<System::Collections::Generic::List_1<::StringW>> result) ;

/// @brief Method TryParseStringElement addr 0x26d6d08 size 0xcc virtual false final false
