...
/// @brief Method .ctor addr 0x26d6c1c size 0x3c virtual false final false
...
/// @brief Method .ctor addr 0x26d70d4 size 0x34 virtual false final false
 void _ctor(System::Net::Http::Headers::NameValueHeaderValue source) ;

// Ctor Parameters []
explicit NameValueHeaderValue() ;

/// @brief Method .ctor addr 0x26dd560 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_Name addr 0x26dd568 size 0x8 virtual false final false
 ::StringW get_Name() ;

/// @brief Method set_Name addr 0x26dd570 size 0x8 virtual false final false
 void set_Name(::StringW value) ;

/// @brief Method get_Value addr 0x26dd578 size 0x8 virtual false final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x26d6ac0 size 0x15c virtual false final false
 void set_Value(::StringW value) ;

/// @brief Method Create addr 0x26d619c size 0x70 virtual false final false
static System::Net::Http::Headers::NameValueHeaderValue Create(::StringW name, ::StringW value) ;

/// @brief Method System.ICloneable.Clone addr 0x26dd580 size 0x60 virtual true final true
 ::bs_hook::Il2CppWrapperType System_ICloneable_Clone() ;

/// @brief Method GetHashCode addr 0x26dd5e0 size 0x7c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x26dd65c size 0xe0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method TryParsePragma addr 0x26dd73c size 0xb0 virtual false final false
...
/// @brief Method TryParseParameters addr 0x26d7474 size 0x2c0 virtual false final false
...
/// @brief Method ToString addr 0x26dd7ec size 0x74 virtual true final false
 ::StringW ToString() ;

/// @brief Method TryParseElement addr 0x26dd860 size 0x188 virtual false final false
