...
/// @brief Method .ctor addr 0x26d48f8 size 0xc virtual false final false
...
/// @brief Method get_StartPosition addr 0x26dbfc8 size 0x8 virtual false final false
 int32_t get_StartPosition() ;

/// @brief Method set_StartPosition addr 0x26dbfd0 size 0x8 virtual false final false
 void set_StartPosition(int32_t value) ;

/// @brief Method get_EndPosition addr 0x26dbfd8 size 0x8 virtual false final false
 int32_t get_EndPosition() ;

/// @brief Method set_EndPosition addr 0x26dbfe0 size 0x8 virtual false final false
 void set_EndPosition(int32_t value) ;

/// @brief Method get_Kind addr 0x26dbfe8 size 0x8 virtual false final false
 System::Net::Http::Headers::System__Net__Http__Headers__Token__Type get_Kind() ;

/// @brief Method op_Implicit addr 0x26dbff0 size 0x4 virtual false final false
...
/// @brief Method ToString addr 0x26dbff4 size 0x68 virtual true final false
 ::StringW ToString() ;
