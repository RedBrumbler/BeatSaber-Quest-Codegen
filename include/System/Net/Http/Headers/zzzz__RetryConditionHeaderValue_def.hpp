...
/// @brief Method .ctor addr 0x26e0898 size 0x90 virtual false final false
...
/// @brief Method .ctor addr 0x26e0928 size 0xd8 virtual false final false
 void _ctor(System::TimeSpan delta) ;

/// @brief Method get_Date addr 0x26e0a00 size 0x14 virtual false final false
 System::Nullable_1<System::DateTimeOffset> get_Date() ;

/// @brief Method set_Date addr 0x26e0a14 size 0x14 virtual false final false
 void set_Date(System::Nullable_1<System::DateTimeOffset> value) ;

/// @brief Method get_Delta addr 0x26e0a28 size 0xc virtual false final false
 System::Nullable_1<System::TimeSpan> get_Delta() ;

/// @brief Method set_Delta addr 0x26e0a34 size 0x8 virtual false final false
 void set_Delta(System::Nullable_1<System::TimeSpan> value) ;

/// @brief Method System.ICloneable.Clone addr 0x26e0a3c size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_ICloneable_Clone() ;

/// @brief Method Equals addr 0x26e0a44 size 0x1a4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x26e0be8 size 0x9c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method TryParse addr 0x26e0c84 size 0x1d0 virtual false final false
static bool TryParse(::StringW input, ByRef<System::Net::Http::Headers::RetryConditionHeaderValue> parsedValue) ;

/// @brief Method ToString addr 0x26e0e54 size 0x150 virtual true final false
 ::StringW ToString() ;
