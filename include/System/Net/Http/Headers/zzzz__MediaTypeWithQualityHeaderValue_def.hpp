...
namespace System::Net::Http::Headers {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14865))}
...
/// @brief Method .ctor addr 0x26dd340 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method TryParseElement addr 0x26dd348 size 0x168 virtual false final false
...
/// @brief Method TryParse addr 0x26dd4b0 size 0xb0 virtual false final false
