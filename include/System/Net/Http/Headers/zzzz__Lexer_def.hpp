...
/// @brief Method .ctor addr 0x26d43a0 size 0x28 virtual false final false
 void _ctor(::StringW stream) ;

/// @brief Method get_Position addr 0x26dc0b0 size 0x8 virtual false final false
 int32_t get_Position() ;

/// @brief Method set_Position addr 0x26dc0b8 size 0x8 virtual false final false
 void set_Position(int32_t value) ;

/// @brief Method GetStringValue addr 0x26d48a0 size 0x24 virtual false final false
 ::StringW GetStringValue(System::Net::Http::Headers::Token token) ;

/// @brief Method GetStringValue addr 0x26dc0c0 size 0x24 virtual false final false
 ::StringW GetStringValue(System::Net::Http::Headers::Token start, System::Net::Http::Headers::Token end) ;

/// @brief Method GetQuotedStringValue addr 0x26d6170 size 0x2c virtual false final false
 ::StringW GetQuotedStringValue(System::Net::Http::Headers::Token start) ;

/// @brief Method GetRemainingStringValue addr 0x26d48c4 size 0x34 virtual false final false
 ::StringW GetRemainingStringValue(int32_t position) ;

/// @brief Method IsStarStringValue addr 0x26d7de0 size 0x44 virtual false final false
 bool IsStarStringValue(System::Net::Http::Headers::Token token) ;

/// @brief Method TryGetNumericValue addr 0x26dc0e4 size 0xa0 virtual false final false
 bool TryGetNumericValue(System::Net::Http::Headers::Token token, ByRef<int32_t> value) ;

/// @brief Method TryGetNumericValue addr 0x26d7e24 size 0xa0 virtual false final false
 bool TryGetNumericValue(System::Net::Http::Headers::Token token, ByRef<int64_t> value) ;

/// @brief Method TryGetTimeSpanValue addr 0x26d60a8 size 0xc8 virtual false final false
 System::Nullable_1<System::TimeSpan> TryGetTimeSpanValue(System::Net::Http::Headers::Token token) ;

/// @brief Method TryGetDateValue addr 0x26dc184 size 0xdc virtual false final false
 bool TryGetDateValue(System::Net::Http::Headers::Token token, ByRef<System::DateTimeOffset> value) ;

/// @brief Method TryGetDateValue addr 0x26dc260 size 0xdc virtual false final false
static bool TryGetDateValue(::StringW text, ByRef<System::DateTimeOffset> value) ;

/// @brief Method TryGetDoubleValue addr 0x26dc33c size 0xa0 virtual false final false
 bool TryGetDoubleValue(System::Net::Http::Headers::Token token, ByRef<double_t> value) ;

/// @brief Method IsValidToken addr 0x26dc3dc size 0xb0 virtual false final false
static bool IsValidToken(::StringW input) ;

/// @brief Method IsValidCharacter addr 0x26dc48c size 0xb0 virtual false final false
static bool IsValidCharacter(char16_t input) ;

/// @brief Method EatChar addr 0x26d8574 size 0x10 virtual false final false
 void EatChar() ;

/// @brief Method PeekChar addr 0x26d8534 size 0x40 virtual false final false
 int32_t PeekChar() ;

/// @brief Method ScanCommentOptional addr 0x26dc53c size 0x150 virtual false final false
 bool ScanCommentOptional(ByRef<::StringW> value, ByRef<System::Net::Http::Headers::Token> readToken) ;

/// @brief Method Scan addr 0x26d45ac size 0x2f4 virtual false final false
