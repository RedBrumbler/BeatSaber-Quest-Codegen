...
/// @brief Method .ctor addr 0x26de9d8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_Name addr 0x26de9e0 size 0x8 virtual false final false
 ::StringW get_Name() ;

/// @brief Method set_Name addr 0x26de9e8 size 0x8 virtual false final false
 void set_Name(::StringW value) ;

/// @brief Method get_Version addr 0x26de9f0 size 0x8 virtual false final false
 ::StringW get_Version() ;

/// @brief Method set_Version addr 0x26de9f8 size 0x8 virtual false final false
 void set_Version(::StringW value) ;

/// @brief Method System.ICloneable.Clone addr 0x26dea00 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_ICloneable_Clone() ;

/// @brief Method Equals addr 0x26dea08 size 0xb8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x26deac0 size 0x64 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method TryParse addr 0x26deb24 size 0xb0 virtual false final false
...
/// @brief Method TryParseElement addr 0x26debd4 size 0x16c virtual false final false
...
/// @brief Method ToString addr 0x26ded40 size 0x5c virtual true final false
 ::StringW ToString() ;
