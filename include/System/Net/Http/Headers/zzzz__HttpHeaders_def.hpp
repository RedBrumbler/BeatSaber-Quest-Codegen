...
class CORDL_TYPE System__Net__Http__Headers__HttpHeaders__HeaderBucket : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __CORDL_REFERENCE_TYPE_SIZE{0x28};

virtual ~System__Net__Http__Headers__HttpHeaders__HeaderBucket() = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Net__Http__Headers__HttpHeaders__HeaderBucket", modifiers: " const&", def_value: None }]
constexpr System__Net__Http__Headers__HttpHeaders__HeaderBucket(System__Net__Http__Headers__HttpHeaders__HeaderBucket const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Net__Http__Headers__HttpHeaders__HeaderBucket", modifiers: "&&", def_value: None }]
constexpr System__Net__Http__Headers__HttpHeaders__HeaderBucket(System__Net__Http__Headers__HttpHeaders__HeaderBucket&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit System__Net__Http__Headers__HttpHeaders__HeaderBucket(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr System__Net__Http__Headers__HttpHeaders__HeaderBucket& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr System__Net__Http__Headers__HttpHeaders__HeaderBucket& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr System__Net__Http__Headers__HttpHeaders__HeaderBucket& operator=(System__Net__Http__Headers__HttpHeaders__HeaderBucket&& o) noexcept = default;
  constexpr System__Net__Http__Headers__HttpHeaders__HeaderBucket& operator=(System__Net__Http__Headers__HttpHeaders__HeaderBucket const& o) noexcept = default;
...
/// @brief Method .ctor addr 0x26dafd8 size 0x30 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType parsed, System::Func_2<::bs_hook::Il2CppWrapperType,::StringW> converter) ;

/// @brief Method get_HasStringValues addr 0x26db94c size 0x54 virtual false final false
 bool get_HasStringValues() ;

/// @brief Method get_Values addr 0x26db008 size 0x80 virtual false final false
 System::Collections::Generic::List_1<::StringW> get_Values() ;

/// @brief Method set_Values addr 0x26db9a0 size 0x8 virtual false final false
 void set_Values(System::Collections::Generic::List_1<::StringW> value) ;

/// @brief Method ParsedToString addr 0x26db910 size 0x3c virtual false final false
...
class CORDL_TYPE System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19() = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19", modifiers: " const&", def_value: None }]
constexpr System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19(System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19", modifiers: "&&", def_value: None }]
constexpr System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19(System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19& operator=(System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19&& o) noexcept = default;
  constexpr System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19& operator=(System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19 const& o) noexcept = default;
...
constexpr System::Net::Http::Headers::HttpHeaders __get___4__this() const;
 ...
 System::Collections::Generic::System__Collections__Generic__Dictionary_2__Enumerator<::StringW,System::Net::Http::Headers::System__Net__Http__Headers__HttpHeaders__HeaderBucket> __declspec(property(get=__get___7__wrap1, put=__set___7__wrap1))  __7__wrap1;

constexpr void __set___7__wrap1(System::Collections::Generic::System__Collections__Generic__Dictionary_2__Enumerator<::StringW,System::Net::Http::Headers::System__Net__Http__Headers__HttpHeaders__HeaderBucket> value) ;

constexpr System::Collections::Generic::System__Collections__Generic__Dictionary_2__Enumerator<::StringW,System::Net::Http::Headers::System__Net__Http__Headers__HttpHeaders__HeaderBucket> __get___7__wrap1() const;
...
/// @brief Method .ctor addr 0x26db340 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x26db9a8 size 0x1c virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x26db9c4 size 0x2c4 virtual true final true
 bool MoveNext() ;

/// @brief Method <>m__Finally1 addr 0x26dbc88 size 0x50 virtual false final false
 void __m__Finally1() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Collections.Generic.KeyValuePair<System.String,System.Collections.Generic.IEnumerable<System.String>>>.get_Current addr 0x26dbcd8 size 0xc virtual true final true
...
/// @brief Method System.Collections.IEnumerator.Reset addr 0x26dbce4 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x26dbd24 size 0x5c virtual true final true
...
public:
// Declarations
using _GetEnumerator_d__19 = System::Net::Http::Headers::System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19;

using HeaderBucket = System::Net::Http::Headers::System__Net__Http__Headers__HttpHeaders__HeaderBucket;
...
static System::Collections::Generic::Dictionary_2<::StringW,System::Net::Http::Headers::HeaderInfo> __get_known_headers() ;
 ...
 System::Collections::Generic::Dictionary_2<::StringW,System::Net::Http::Headers::System__Net__Http__Headers__HttpHeaders__HeaderBucket> __declspec(property(get=__get_headers, put=__set_headers))  headers;

constexpr void __set_headers(System::Collections::Generic::Dictionary_2<::StringW,System::Net::Http::Headers::System__Net__Http__Headers__HttpHeaders__HeaderBucket> value) ;

constexpr System::Collections::Generic::Dictionary_2<::StringW,System::Net::Http::Headers::System__Net__Http__Headers__HttpHeaders__HeaderBucket> __get_headers() const;
...
/// @brief Method .ctor addr 0x26da860 size 0xe4 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x26d87a8 size 0x24 virtual false final false
 void _ctor(System::Net::Http::Headers::HttpHeaderKind headerKind) ;

/// @brief Method AddInternal addr 0x26da944 size 0x694 virtual false final false
...
/// @brief Method TryAddWithoutValidation addr 0x26cdccc size 0xb0 virtual false final false
 bool TryAddWithoutValidation(::StringW name, System::Collections::Generic::IEnumerable_1<::StringW> values) ;

/// @brief Method CheckName addr 0x26db16c size 0x16c virtual false final false
 System::Net::Http::Headers::HeaderInfo CheckName(::StringW name) ;

/// @brief Method TryCheckName addr 0x26db088 size 0xe4 virtual false final false
 bool TryCheckName(::StringW name, ByRef<System::Net::Http::Headers::HeaderInfo> headerInfo) ;

/// @brief Method GetEnumerator addr 0x26cd7fc size 0x68 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x26db368 size 0x4 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method Remove addr 0x26db36c size 0x64 virtual false final false
 bool Remove(::StringW name) ;

/// @brief Method GetSingleHeaderString addr 0x26cfedc size 0x45c virtual false final false
static ::StringW GetSingleHeaderString(::StringW key, System::Collections::Generic::IEnumerable_1<::StringW> values) ;

/// @brief Method ToString addr 0x26db3d0 size 0x374 virtual true final false
 ::StringW ToString() ;
...
/// @brief Method GetAllHeaderValues addr 0x26db744 size 0x1cc virtual false final false
 System::Collections::Generic::List_1<::StringW> GetAllHeaderValues(System::Net::Http::Headers::System__Net__Http__Headers__HttpHeaders__HeaderBucket bucket, System::Net::Http::Headers::HeaderInfo headerInfo) ;

/// @brief Method GetKnownHeaderKind addr 0x26cfddc size 0x100 virtual false final false
...
NEED_NO_BOX(System::Net::Http::Headers::System__Net__Http__Headers__HttpHeaders__HeaderBucket);
DEFINE_IL2CPP_ARG_TYPE(System::Net::Http::Headers::System__Net__Http__Headers__HttpHeaders__HeaderBucket, "System.Net.Http.Headers", "HttpHeaders/HeaderBucket");
NEED_NO_BOX(System::Net::Http::Headers::System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19);
DEFINE_IL2CPP_ARG_TYPE(System::Net::Http::Headers::System__Net__Http__Headers__HttpHeaders___GetEnumerator_d__19, "System.Net.Http.Headers", "HttpHeaders/<GetEnumerator>d__19");
