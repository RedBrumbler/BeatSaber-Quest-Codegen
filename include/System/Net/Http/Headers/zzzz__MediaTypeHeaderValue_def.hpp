...
/// @brief Method .ctor addr 0x26dd2e0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <get_CharSet>b__6_0 addr 0x26dd2e8 size 0x58 virtual false final false
...
/// @brief Method .ctor addr 0x26d3ffc size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x26dc9fc size 0x278 virtual false final false
 void _ctor(System::Net::Http::Headers::MediaTypeHeaderValue source) ;

// Ctor Parameters []
explicit MediaTypeHeaderValue() ;

/// @brief Method .ctor addr 0x26dccf4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_CharSet addr 0x26d2b00 size 0x114 virtual false final false
 ::StringW get_CharSet() ;

/// @brief Method set_CharSet addr 0x26d4028 size 0xa0 virtual false final false
 void set_CharSet(::StringW value) ;

/// @brief Method set_MediaType addr 0x26dc8bc size 0x140 virtual false final false
 void set_MediaType(::StringW value) ;

/// @brief Method get_Parameters addr 0x26dcc74 size 0x80 virtual false final false
 System::Collections::Generic::ICollection_1<System::Net::Http::Headers::NameValueHeaderValue> get_Parameters() ;

/// @brief Method System.ICloneable.Clone addr 0x26dce8c size 0x60 virtual true final true
 ::bs_hook::Il2CppWrapperType System_ICloneable_Clone() ;

/// @brief Method Equals addr 0x26dceec size 0xc8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x26dcfb4 size 0x7c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Parse addr 0x26dd030 size 0x6c virtual false final false
static System::Net::Http::Headers::MediaTypeHeaderValue Parse(::StringW input) ;

/// @brief Method ToString addr 0x26dd210 size 0x6c virtual true final false
 ::StringW ToString() ;

/// @brief Method TryParse addr 0x26dd09c size 0x174 virtual false final false
static bool TryParse(::StringW input, ByRef<System::Net::Http::Headers::MediaTypeHeaderValue> parsedValue) ;

/// @brief Method TryParseMediaType addr 0x26dccfc size 0x190 virtual false final false
