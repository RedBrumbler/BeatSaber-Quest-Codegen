...
/// @brief Method .ctor addr 0x26df914 size 0x54 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x26df968 size 0x1e8 virtual false final false
 void _ctor(System::Net::Http::Headers::RangeHeaderValue source) ;

/// @brief Method get_Ranges addr 0x26dfb50 size 0x80 virtual false final false
 System::Collections::Generic::ICollection_1<System::Net::Http::Headers::RangeItemHeaderValue> get_Ranges() ;

/// @brief Method get_Unit addr 0x26dfbd0 size 0x8 virtual false final false
 ::StringW get_Unit() ;

/// @brief Method System.ICloneable.Clone addr 0x26dfbd8 size 0x60 virtual true final true
 ::bs_hook::Il2CppWrapperType System_ICloneable_Clone() ;

/// @brief Method Equals addr 0x26dfc38 size 0xc8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x26dfd00 size 0x7c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method TryParse addr 0x26dfd7c size 0x544 virtual false final false
static bool TryParse(::StringW input, ByRef<System::Net::Http::Headers::RangeHeaderValue> parsedValue) ;

/// @brief Method ToString addr 0x26e041c size 0x1a0 virtual true final false
 ::StringW ToString() ;
