...
/// @brief Method .ctor addr 0x26df2d4 size 0x90 virtual false final false
...
/// @brief Method .ctor addr 0x26df364 size 0x78 virtual false final false
 void _ctor(System::Net::Http::Headers::EntityTagHeaderValue entityTag) ;

/// @brief Method get_Date addr 0x26df3dc size 0x14 virtual false final false
 System::Nullable_1<System::DateTimeOffset> get_Date() ;

/// @brief Method set_Date addr 0x26df3f0 size 0x14 virtual false final false
 void set_Date(System::Nullable_1<System::DateTimeOffset> value) ;

/// @brief Method get_EntityTag addr 0x26df404 size 0x8 virtual false final false
 System::Net::Http::Headers::EntityTagHeaderValue get_EntityTag() ;

/// @brief Method set_EntityTag addr 0x26df40c size 0x8 virtual false final false
 void set_EntityTag(System::Net::Http::Headers::EntityTagHeaderValue value) ;

/// @brief Method System.ICloneable.Clone addr 0x26df414 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_ICloneable_Clone() ;

/// @brief Method Equals addr 0x26df41c size 0x144 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x26df560 size 0x84 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method TryParse addr 0x26df5e4 size 0x24c virtual false final false
static bool TryParse(::StringW input, ByRef<System::Net::Http::Headers::RangeConditionHeaderValue> parsedValue) ;

/// @brief Method ToString addr 0x26df830 size 0xe4 virtual true final false
 ::StringW ToString() ;
