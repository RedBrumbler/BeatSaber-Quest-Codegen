...
/// @brief Method .ctor addr 0x26d8124 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_IsWeak addr 0x26d812c size 0x8 virtual false final false
 bool get_IsWeak() ;

/// @brief Method set_IsWeak addr 0x26d8134 size 0xc virtual false final false
 void set_IsWeak(bool value) ;

/// @brief Method get_Tag addr 0x26d8140 size 0x8 virtual false final false
 ::StringW get_Tag() ;

/// @brief Method set_Tag addr 0x26d8148 size 0x8 virtual false final false
 void set_Tag(::StringW value) ;

/// @brief Method System.ICloneable.Clone addr 0x26d8150 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_ICloneable_Clone() ;

/// @brief Method Equals addr 0x26d8158 size 0xb4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x26d820c size 0x50 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method TryParse addr 0x26d825c size 0xf4 virtual false final false
static bool TryParse(::StringW input, ByRef<System::Net::Http::Headers::EntityTagHeaderValue> parsedValue) ;

/// @brief Method TryParseElement addr 0x26d8350 size 0x1e4 virtual false final false
...
/// @brief Method TryParse addr 0x26d8584 size 0xb0 virtual false final false
...
/// @brief Method ToString addr 0x26d8634 size 0x64 virtual true final false
 ::StringW ToString() ;
