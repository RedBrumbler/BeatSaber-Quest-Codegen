...
/// @brief Method .ctor addr 0x26ded9c size 0x68 virtual false final false
 void _ctor(System::Net::Http::Headers::ProductHeaderValue product) ;

// Ctor Parameters []
explicit ProductInfoHeaderValue() ;

/// @brief Method .ctor addr 0x26dee04 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_Comment addr 0x26dee0c size 0x8 virtual false final false
 ::StringW get_Comment() ;

/// @brief Method set_Comment addr 0x26dee14 size 0x8 virtual false final false
 void set_Comment(::StringW value) ;

/// @brief Method get_Product addr 0x26dee1c size 0x8 virtual false final false
 System::Net::Http::Headers::ProductHeaderValue get_Product() ;

/// @brief Method set_Product addr 0x26dee24 size 0x8 virtual false final false
 void set_Product(System::Net::Http::Headers::ProductHeaderValue value) ;

/// @brief Method System.ICloneable.Clone addr 0x26dee2c size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_ICloneable_Clone() ;

/// @brief Method Equals addr 0x26dee34 size 0xc0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x26deef4 size 0x2c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method TryParse addr 0x26def20 size 0x1a8 virtual false final false
...
/// @brief Method TryParseElement addr 0x26df0c8 size 0x1ec virtual false final false
...
/// @brief Method ToString addr 0x26df2b4 size 0x20 virtual true final false
 ::StringW ToString() ;
