...
/// @brief Method .ctor addr 0x26d0360 size 0x80 virtual false final false
 void _ctor(::ArrayW<uint8_t> content) ;

/// @brief Method SerializeToStreamAsync addr 0x26d03e8 size 0x28 virtual true final false
 System::Threading::Tasks::Task SerializeToStreamAsync(System::IO::Stream stream, System::Net::TransportContext context) ;

/// @brief Method TryComputeLength addr 0x26d0410 size 0x10 virtual true final false
