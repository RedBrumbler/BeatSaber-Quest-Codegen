...
/// @brief Method MoveNext addr 0x26d11d0 size 0x620 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x26d17f0 size 0x58 virtual true final true
...
/// @brief Method MoveNext addr 0x26d1848 size 0x4c4 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x26d1eac size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
namespace System::Net::Http {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14831))}
...
/// @brief Method .ctor addr 0x26d0420 size 0x64 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x26d0484 size 0xbc virtual false final false
 void _ctor(System::Net::Http::HttpMessageHandler handler, bool disposeHandler) ;

/// @brief Method get_MaxResponseContentBufferSize addr 0x26d05c4 size 0x8 virtual false final false
 int64_t get_MaxResponseContentBufferSize() ;

/// @brief Method set_Timeout addr 0x26d05cc size 0x134 virtual false final false
 void set_Timeout(System::TimeSpan value) ;

/// @brief Method Dispose addr 0x26d0700 size 0x6c virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method GetAsync addr 0x26d07a4 size 0xdc virtual false final false
...
/// @brief Method SendAsync addr 0x26d0934 size 0x74 virtual false final false
 System::Threading::Tasks::Task_1<System::Net::Http::HttpResponseMessage> SendAsync(System::Net::Http::HttpRequestMessage request) ;

/// @brief Method SendAsync addr 0x26d08bc size 0x78 virtual false final false
...
/// @brief Method SendAsync addr 0x26d0c38 size 0xc virtual true final false
...
/// @brief Method SendAsync addr 0x26d09a8 size 0x290 virtual false final false
...
/// @brief Method SendAsyncWorker addr 0x26d0efc size 0x118 virtual false final false
...
/// @brief Method GetStringAsync addr 0x26d1014 size 0x100 virtual false final false
 System::Threading::Tasks::Task_1<::StringW> GetStringAsync(System::Uri requestUri) ;

/// @brief Method <>n__0 addr 0x26d1190 size 0x20 virtual false final false
