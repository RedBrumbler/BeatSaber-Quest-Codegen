...
/// @brief Method .ctor addr 0x26ce154 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetConnectionKeepAlive>b__95_0 addr 0x26ce15c size 0x50 virtual false final false
 bool _GetConnectionKeepAlive_b__95_0(::StringW l) ;

/// @brief Method <CreateWebRequest>b__96_0 addr 0x26ce1ac size 0x4c virtual false final false
 bool _CreateWebRequest_b__96_0(::StringW l) ;

/// @brief Method <SendAsync>b__99_0 addr 0x26ce1f8 size 0xb0 virtual false final false
...
/// @brief Method MoveNext addr 0x26ce2a8 size 0x1700 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x26cfd84 size 0x58 virtual true final true
...
/// @brief Method .ctor addr 0x26cbeec size 0x1b0 virtual false final false
 void _ctor() ;

/// @brief Method EnsureModifiability addr 0x26cc91c size 0x60 virtual false final false
 void EnsureModifiability() ;

/// @brief Method get_CookieContainer addr 0x26cc97c size 0x6c virtual true final true
 System::Net::CookieContainer get_CookieContainer() ;

/// @brief Method get_MaxRequestContentBufferSize addr 0x26cc9e8 size 0x8 virtual true final true
 int64_t get_MaxRequestContentBufferSize() ;

/// @brief Method get_SslOptions addr 0x26cc9f0 size 0x6c virtual true final true
 System::Net::Security::SslClientAuthenticationOptions get_SslOptions() ;

/// @brief Method set_SslOptions addr 0x26cca5c size 0x24 virtual true final true
 void set_SslOptions(System::Net::Security::SslClientAuthenticationOptions value) ;

/// @brief Method Dispose addr 0x26cca80 size 0x10 virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x26cca90 size 0x84 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method GetConnectionKeepAlive addr 0x26ccb14 size 0x110 virtual false final false
 bool GetConnectionKeepAlive(System::Net::Http::Headers::HttpRequestHeaders headers) ;

/// @brief Method CreateWebRequest addr 0x26ccc8c size 0x7bc virtual true final false
 System::Net::HttpWebRequest CreateWebRequest(System::Net::Http::HttpRequestMessage request) ;

/// @brief Method CreateResponseMessage addr 0x26cd930 size 0x1c8 virtual false final false
...
/// @brief Method MethodHasBody addr 0x26cde60 size 0x10c virtual false final false
static bool MethodHasBody(System::Net::Http::HttpMethod method) ;

/// @brief Method SendAsync addr 0x26cdf6c size 0x114 virtual true final true
...
/// @brief Method System.Net.Http.IMonoHttpClientHandler.SetWebRequestTimeout addr 0x26ce080 size 0x70 virtual true final true
