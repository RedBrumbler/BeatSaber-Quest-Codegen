...
/// @brief Method .ctor addr 0x26cc90c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <set_ClientCertificateOptions>b__23_1 addr 0x26cc914 size 0x8 virtual false final false
...
namespace System::Net::Http {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14830))}
...
/// @brief Method CreateDefaultHandler addr 0x26cbe94 size 0x58 virtual false final false
static System::Net::Http::IMonoHttpClientHandler CreateDefaultHandler() ;

// Ctor Parameters []
explicit HttpClientHandler() ;

/// @brief Method .ctor addr 0x26cc09c size 0x38 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x26cc0d4 size 0x30 virtual false final false
 void _ctor(System::Net::Http::IMonoHttpClientHandler handler) ;

/// @brief Method Dispose addr 0x26cc38c size 0xb4 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method ThrowForModifiedManagedSslOptionsIfStarted addr 0x26cc444 size 0x104 virtual false final false
 void ThrowForModifiedManagedSslOptionsIfStarted() ;

/// @brief Method get_ClientCertificateOptions addr 0x26cc548 size 0x8 virtual false final false
 System::Net::Http::ClientCertificateOption get_ClientCertificateOptions() ;

/// @brief Method set_ClientCertificateOptions addr 0x26cc10c size 0x280 virtual false final false
 void set_ClientCertificateOptions(System::Net::Http::ClientCertificateOption value) ;

/// @brief Method get_ClientCertificates addr 0x26cc550 size 0x1dc virtual false final false
 System::Security::Cryptography::X509Certificates::X509CertificateCollection get_ClientCertificates() ;

/// @brief Method SetWebRequestTimeout addr 0x26cc72c size 0xac virtual false final false
 void SetWebRequestTimeout(System::TimeSpan timeout) ;

/// @brief Method SendAsync addr 0x26cc7d8 size 0xbc virtual true final false
...
/// @brief Method <set_ClientCertificateOptions>b__23_0 addr 0x26cc894 size 0x14 virtual false final false
