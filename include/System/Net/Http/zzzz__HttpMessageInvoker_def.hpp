...
/// @brief Method .ctor addr 0x26d0540 size 0x84 virtual false final false
 void _ctor(System::Net::Http::HttpMessageHandler handler, bool disposeHandler) ;

/// @brief Method Dispose addr 0x26d2c7c size 0x10 virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x26d076c size 0x38 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method SendAsync addr 0x26d11b0 size 0x20 virtual true final false
