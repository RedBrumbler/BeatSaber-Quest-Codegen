...
/// @brief Method .ctor addr 0x26d20d0 size 0x28 virtual false final false
 void _ctor(int64_t maxSize) ;

/// @brief Method CheckOverflow addr 0x26d2328 size 0xb0 virtual false final false
 void CheckOverflow(int32_t count) ;

/// @brief Method WriteByte addr 0x26d2440 size 0x30 virtual true final false
 void WriteByte(uint8_t value) ;

/// @brief Method Write addr 0x26d2470 size 0x48 virtual true final false
...
/// @brief Method MoveNext addr 0x26d24b8 size 0x264 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x26d271c size 0xc virtual true final true
...
/// @brief Method MoveNext addr 0x26d2728 size 0x370 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x26d2c14 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method get_Headers addr 0x26cdbf8 size 0x6c virtual false final false
 System::Net::Http::Headers::HttpContentHeaders get_Headers() ;

/// @brief Method get_LoadedBufferLength addr 0x26d1f74 size 0x7c virtual false final false
 System::Nullable_1<int64_t> get_LoadedBufferLength() ;

/// @brief Method CopyToAsync addr 0x26cfd0c size 0x8 virtual false final false
 System::Threading::Tasks::Task CopyToAsync(System::IO::Stream stream) ;

/// @brief Method CopyToAsync addr 0x26d1ff0 size 0x7c virtual false final false
 System::Threading::Tasks::Task CopyToAsync(System::IO::Stream stream, System::Net::TransportContext context) ;

/// @brief Method CreateFixedMemoryStream addr 0x26d206c size 0x64 virtual false final false
static System::Net::Http::System__Net__Http__HttpContent__FixedMemoryStream CreateFixedMemoryStream(int64_t maxBufferSize) ;

/// @brief Method Dispose addr 0x26d20f8 size 0x10 virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x26d2108 size 0x2c virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method LoadIntoBufferAsync addr 0x26d2134 size 0x8 virtual false final false
 System::Threading::Tasks::Task LoadIntoBufferAsync() ;

/// @brief Method LoadIntoBufferAsync addr 0x26cfc34 size 0xd8 virtual false final false
 System::Threading::Tasks::Task LoadIntoBufferAsync(int64_t maxBufferSize) ;

/// @brief Method ReadAsStringAsync addr 0x26d1dbc size 0xf0 virtual false final false
 System::Threading::Tasks::Task_1<::StringW> ReadAsStringAsync() ;

/// @brief Method GetEncodingFromBuffer addr 0x26d213c size 0x178 virtual false final false
static System::Text::Encoding GetEncodingFromBuffer(::ArrayW<uint8_t> buffer, int32_t length, ByRef<int32_t> preambleLength) ;

/// @brief Method StartsWith addr 0x26d22b4 size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x26d03e0 size 0x8 virtual false final false
 void _ctor() ;
