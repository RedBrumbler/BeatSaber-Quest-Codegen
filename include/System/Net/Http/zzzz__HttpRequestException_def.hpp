...
/// @brief Method .ctor addr 0x26d3180 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit HttpRequestException(::StringW message) ;

/// @brief Method .ctor addr 0x26d23d8 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x26cfd14 size 0x70 virtual false final false
