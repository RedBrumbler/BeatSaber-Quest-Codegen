...
/// @brief Method .ctor addr 0x26cdaf8 size 0x2c virtual false final false
 void _ctor(System::Net::HttpStatusCode statusCode) ;

/// @brief Method get_Content addr 0x26d3894 size 0x8 virtual false final false
 System::Net::Http::HttpContent get_Content() ;

/// @brief Method set_Content addr 0x26d389c size 0x8 virtual false final false
 void set_Content(System::Net::Http::HttpContent value) ;

/// @brief Method get_Headers addr 0x26cdc64 size 0x68 virtual false final false
 System::Net::Http::Headers::HttpResponseHeaders get_Headers() ;

/// @brief Method get_IsSuccessStatusCode addr 0x26d3904 size 0x14 virtual false final false
 bool get_IsSuccessStatusCode() ;

/// @brief Method get_ReasonPhrase addr 0x26d3918 size 0x1c virtual false final false
 ::StringW get_ReasonPhrase() ;

/// @brief Method set_ReasonPhrase addr 0x26d3934 size 0x8 virtual false final false
 void set_ReasonPhrase(::StringW value) ;

/// @brief Method set_RequestMessage addr 0x26d393c size 0x8 virtual false final false
 void set_RequestMessage(System::Net::Http::HttpRequestMessage value) ;

/// @brief Method get_StatusCode addr 0x26d3944 size 0x8 virtual false final false
 System::Net::HttpStatusCode get_StatusCode() ;

/// @brief Method set_StatusCode addr 0x26d3844 size 0x50 virtual false final false
 void set_StatusCode(System::Net::HttpStatusCode value) ;

/// @brief Method get_Version addr 0x26d394c size 0x64 virtual false final false
 System::Version get_Version() ;

/// @brief Method Dispose addr 0x26d39b0 size 0x10 virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x26d39c0 size 0x34 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method EnsureSuccessStatusCode addr 0x26d1d0c size 0xb0 virtual false final false
 System::Net::Http::HttpResponseMessage EnsureSuccessStatusCode() ;

/// @brief Method ToString addr 0x26d39f4 size 0x23c virtual true final false
 ::StringW ToString() ;
