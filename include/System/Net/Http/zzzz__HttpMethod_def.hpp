...
/// @brief Method .ctor addr 0x26d2c8c size 0x8c virtual false final false
 void _ctor(::StringW method) ;

/// @brief Method get_Get addr 0x26d2e24 size 0x58 virtual false final false
static System::Net::Http::HttpMethod get_Get() ;

/// @brief Method get_Method addr 0x26d2e7c size 0x8 virtual false final false
 ::StringW get_Method() ;

/// @brief Method get_Post addr 0x26d2e84 size 0x58 virtual false final false
static System::Net::Http::HttpMethod get_Post() ;

/// @brief Method op_Equality addr 0x26d2edc size 0x18 virtual false final false
static bool op_Equality(System::Net::Http::HttpMethod left, System::Net::Http::HttpMethod right) ;

/// @brief Method Equals addr 0x26d2ef4 size 0x24 virtual true final true
 bool Equals(System::Net::Http::HttpMethod other) ;

/// @brief Method Equals addr 0x26d2f18 size 0x8c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x26d2fa4 size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x26d2fc4 size 0x8 virtual true final false
 ::StringW ToString() ;
