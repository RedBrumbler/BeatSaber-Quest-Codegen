...
/// @brief Method IsContentHeader addr 0x26cdb98 size 0x60 virtual false final false
static bool IsContentHeader(::StringW name) ;

/// @brief Method GetSingleHeaderString addr 0x26cd8cc size 0x64 virtual false final false
static ::StringW GetSingleHeaderString(::StringW name, System::Collections::Generic::IEnumerable_1<::StringW> values) ;

/// @brief Method CreateStreamContent addr 0x26cdb24 size 0x74 virtual false final false
