...
/// @brief Method ParseSingleValue addr 0x2844a2c size 0x90 virtual false final false
static ::ArrayW<::StringW> ParseSingleValue(::StringW value) ;

/// @brief Method ParseMultiValue addr 0x2844abc size 0x1f8 virtual false final false
static ::ArrayW<::StringW> ParseMultiValue(::StringW value) ;

/// @brief Method get_Item addr 0x283ea58 size 0xdc virtual false final false
 System::Net::HeaderInfo get_Item(::StringW name) ;

// Ctor Parameters []
explicit HeaderInfoTable() ;

/// @brief Method .ctor addr 0x28411b8 size 0x8 virtual false final false
 void _ctor() ;
