...
namespace System::Net {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8082)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(8082), inst: 2 })}
...
/// @brief Method .ctor addr 0x287c5a8 size 0x4c virtual false final false
 void _ctor() ;
