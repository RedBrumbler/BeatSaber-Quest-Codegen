...
/// @brief Method .ctor addr 0x2876d18 size 0xe0 virtual false final false
...
/// @brief Method get_Key addr 0x2876fd0 size 0x8 virtual false final false
 System::Net::System__Net__ServicePointManager__SPKey get_Key() ;

/// @brief Method get_Scheduler addr 0x2876fd8 size 0x8 virtual false final false
 System::Net::ServicePointScheduler get_Scheduler() ;

/// @brief Method set_Scheduler addr 0x2876fe0 size 0x8 virtual false final false
 void set_Scheduler(System::Net::ServicePointScheduler value) ;

/// @brief Method get_Address addr 0x2876fe8 size 0x8 virtual false final false
 System::Uri get_Address() ;

/// @brief Method get_ConnectionLimit addr 0x2876ff0 size 0x8 virtual false final false
 int32_t get_ConnectionLimit() ;

/// @brief Method get_ProtocolVersion addr 0x2876ff8 size 0x8 virtual true final false
 System::Version get_ProtocolVersion() ;

/// @brief Method set_Expect100Continue addr 0x2877000 size 0xc virtual false final false
 void set_Expect100Continue(bool value) ;

/// @brief Method get_UseNagleAlgorithm addr 0x287700c size 0x8 virtual false final false
 bool get_UseNagleAlgorithm() ;

/// @brief Method set_UseNagleAlgorithm addr 0x2877014 size 0xc virtual false final false
 void set_UseNagleAlgorithm(bool value) ;

/// @brief Method get_SendContinue addr 0x2877020 size 0x9c virtual false final false
 bool get_SendContinue() ;

/// @brief Method set_SendContinue addr 0x28770bc size 0xc virtual false final false
 void set_SendContinue(bool value) ;

/// @brief Method SetTcpKeepAlive addr 0x28770c8 size 0xb8 virtual false final false
 void SetTcpKeepAlive(bool enabled, int32_t keepAliveTime, int32_t keepAliveInterval) ;

/// @brief Method KeepAliveSetup addr 0x2877180 size 0xb4 virtual false final false
 void KeepAliveSetup(System::Net::Sockets::Socket socket) ;

/// @brief Method PutBytes addr 0x2877234 size 0x144 virtual false final false
static void PutBytes(::ArrayW<uint8_t> bytes, uint32_t v, int32_t offset) ;

/// @brief Method get_UsesProxy addr 0x2877378 size 0x8 virtual false final false
 bool get_UsesProxy() ;

/// @brief Method set_UsesProxy addr 0x2877380 size 0xc virtual false final false
 void set_UsesProxy(bool value) ;

/// @brief Method get_UseConnect addr 0x287738c size 0x8 virtual false final false
 bool get_UseConnect() ;

/// @brief Method set_UseConnect addr 0x2877394 size 0xc virtual false final false
 void set_UseConnect(bool value) ;

/// @brief Method get_HasTimedOut addr 0x28773a0 size 0x12c virtual false final false
 bool get_HasTimedOut() ;

/// @brief Method get_HostEntry addr 0x28774cc size 0x388 virtual false final false
 System::Net::IPHostEntry get_HostEntry() ;

/// @brief Method SetVersion addr 0x2877854 size 0x8 virtual false final false
 void SetVersion(System::Version version) ;

/// @brief Method SendRequest addr 0x287785c size 0x17c virtual false final false
 void SendRequest(System::Net::WebOperation operation, ::StringW groupName) ;

/// @brief Method CloseConnectionGroup addr 0x2877ac0 size 0xec virtual false final false
 bool CloseConnectionGroup(::StringW connectionGroupName) ;

/// @brief Method FreeServicePoint addr 0x2877cbc size 0x10 virtual false final false
 void FreeServicePoint() ;

/// @brief Method UpdateServerCertificate addr 0x2877ccc size 0x34 virtual false final false
 void UpdateServerCertificate(System::Security::Cryptography::X509Certificates::X509Certificate certificate) ;

/// @brief Method UpdateClientCertificate addr 0x2877d00 size 0x34 virtual false final false
 void UpdateClientCertificate(System::Security::Cryptography::X509Certificates::X509Certificate certificate) ;

/// @brief Method CallEndPointDelegate addr 0x2877d34 size 0x1a4 virtual false final false
