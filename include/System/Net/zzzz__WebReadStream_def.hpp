...
/// @brief Method MoveNext addr 0x2883920 size 0x584 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2883ea4 size 0x58 virtual true final true
...
/// @brief Method get_Operation addr 0x2882f08 size 0x8 virtual false final false
 System::Net::WebOperation get_Operation() ;

/// @brief Method get_InnerStream addr 0x2882f10 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x28744f0 size 0x70 virtual false final false
 void _ctor(System::Net::WebOperation operation, System::IO::Stream innerStream) ;

/// @brief Method get_Length addr 0x2882f18 size 0x40 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x2882f58 size 0x40 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x2882f98 size 0x40 virtual true final false
 void set_Position(int64_t value) ;

/// @brief Method get_CanSeek addr 0x2882fd8 size 0x8 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_CanRead addr 0x2882fe0 size 0x8 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanWrite addr 0x2882fe8 size 0x8 virtual true final false
 bool get_CanWrite() ;

/// @brief Method SetLength addr 0x2882ff0 size 0x40 virtual true final false
 void SetLength(int64_t value) ;

/// @brief Method Seek addr 0x2883030 size 0x40 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method Write addr 0x2883070 size 0x40 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Flush addr 0x28830b0 size 0x40 virtual true final false
 void Flush() ;

/// @brief Method GetException addr 0x28830f0 size 0x168 virtual false final false
 System::Exception GetException(System::Exception e) ;

/// @brief Method Read addr 0x2883258 size 0x268 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t size) ;

/// @brief Method BeginRead addr 0x28834c0 size 0x1d0 virtual true final false
...
/// @brief Method EndRead addr 0x2883690 size 0x124 virtual true final false
 int32_t EndRead(System::IAsyncResult r) ;

/// @brief Method ReadAsync addr 0x28837b4 size 0x120 virtual true final true
...
/// @brief Method FinishReading addr 0x28747c4 size 0x104 virtual true final false
 System::Threading::Tasks::Task FinishReading(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method Dispose addr 0x28838d4 size 0x4c virtual true final false
