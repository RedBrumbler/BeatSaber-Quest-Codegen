...
/// @brief Method get_IsIPv4 addr 0x282825c size 0x10 virtual false final false
 bool get_IsIPv4() ;

/// @brief Method get_IsIPv6 addr 0x282826c size 0x10 virtual false final false
 bool get_IsIPv6() ;

/// @brief Method get_PrivateAddress addr 0x282827c size 0x8 virtual false final false
 uint32_t get_PrivateAddress() ;

/// @brief Method set_PrivateAddress addr 0x2828284 size 0x10 virtual false final false
 void set_PrivateAddress(uint32_t value) ;

/// @brief Method get_PrivateScopeId addr 0x2828294 size 0x8 virtual false final false
 uint32_t get_PrivateScopeId() ;

/// @brief Method set_PrivateScopeId addr 0x282829c size 0x10 virtual false final false
...
/// @brief Method .ctor addr 0x28282ac size 0x84 virtual false final false
...
/// @brief Method .ctor addr 0x2828330 size 0x7c virtual false final false
...
/// @brief Method .ctor addr 0x28283fc size 0x184 virtual false final false
...
/// @brief Method .ctor addr 0x2828580 size 0xb8 virtual false final false
...
/// @brief Method .ctor addr 0x2828638 size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x282866c size 0x6c virtual false final false
...
/// @brief Method .ctor addr 0x28286d8 size 0x150 virtual false final false
 void _ctor(System::ReadOnlySpan_1<uint8_t> address) ;

/// @brief Method TryParse addr 0x2828828 size 0x6c virtual false final false
static bool TryParse(::StringW ipString, ByRef<System::Net::IPAddress> address) ;

/// @brief Method Parse addr 0x2828a90 size 0x9c virtual false final false
static System::Net::IPAddress Parse(::StringW ipString) ;

/// @brief Method TryWriteBytes addr 0x2828b2c size 0x118 virtual false final false
 bool TryWriteBytes(System::Span_1<uint8_t> destination, ByRef<int32_t> bytesWritten) ;

/// @brief Method WriteIPv6Bytes addr 0x2828c44 size 0x8c virtual false final false
 void WriteIPv6Bytes(System::Span_1<uint8_t> destination) ;

/// @brief Method WriteIPv4Bytes addr 0x2828cd0 size 0x4c virtual false final false
 void WriteIPv4Bytes(System::Span_1<uint8_t> destination) ;

/// @brief Method GetAddressBytes addr 0x2828d1c size 0x154 virtual false final false
 ::ArrayW<uint8_t> GetAddressBytes() ;

/// @brief Method get_AddressFamily addr 0x2828e70 size 0x18 virtual false final false
 System::Net::Sockets::AddressFamily get_AddressFamily() ;

/// @brief Method get_ScopeId addr 0x2828e88 size 0x58 virtual false final false
 int64_t get_ScopeId() ;

/// @brief Method ToString addr 0x2828ee0 size 0x98 virtual true final false
 ::StringW ToString() ;

/// @brief Method IsLoopback addr 0x2828fec size 0xc8 virtual false final false
static bool IsLoopback(System::Net::IPAddress address) ;

/// @brief Method get_IsIPv6Multicast addr 0x28290b4 size 0x34 virtual false final false
 bool get_IsIPv6Multicast() ;

/// @brief Method Equals addr 0x28290e8 size 0x134 virtual false final false
 bool Equals(::bs_hook::Il2CppWrapperType comparandObj, bool compareScopeId) ;

/// @brief Method Equals addr 0x282921c size 0x8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType comparand) ;

/// @brief Method GetHashCode addr 0x2829224 size 0x468 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method MapToIPv6 addr 0x282968c size 0xe0 virtual false final false
 System::Net::IPAddress MapToIPv6() ;

/// @brief Method ThrowAddressNullException addr 0x28283ac size 0x50 virtual false final false
...
namespace System::Net {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7900))}
...
/// @brief Method .ctor addr 0x2829918 size 0x64 virtual false final false
 void _ctor(int64_t newAddress) ;
