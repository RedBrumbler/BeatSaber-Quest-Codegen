...
/// @brief Method .ctor addr 0x28387c4 size 0x8c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2838064 size 0x11c virtual false final false
...
/// @brief Method UpdateStatus addr 0x2836bc8 size 0x10 virtual false final false
 void UpdateStatus(System::Net::FtpStatusCode statusCode, ::StringW statusLine, ::StringW exitMessage) ;

/// @brief Method GetResponseStream addr 0x283875c size 0x68 virtual true final false
 System::IO::Stream GetResponseStream() ;

/// @brief Method SetResponseStream addr 0x2837fd0 size 0x94 virtual false final false
 void SetResponseStream(System::IO::Stream stream) ;

/// @brief Method Close addr 0x2838850 size 0xe4 virtual true final false
 void Close() ;

/// @brief Method get_Headers addr 0x2838934 size 0x120 virtual true final false
 System::Net::WebHeaderCollection get_Headers() ;

/// @brief Method get_ResponseUri addr 0x2838a54 size 0x8 virtual true final false
 System::Uri get_ResponseUri() ;

/// @brief Method get_StatusCode addr 0x2838a5c size 0x8 virtual false final false
