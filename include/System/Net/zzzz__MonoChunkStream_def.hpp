...
struct CORDL_TYPE System__Net__MonoChunkStream___ProcessReadAsync_d__7 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
...
constexpr System__Net__MonoChunkStream___ProcessReadAsync_d__7(int32_t __1__state, System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<int32_t> __t__builder, System::Threading::CancellationToken cancellationToken, System::Net::MonoChunkStream __4__this, ::ArrayW<uint8_t> buffer, int32_t offset, int32_t size, ::ArrayW<uint8_t> _moreBytes_5__2, System::Runtime::CompilerServices::System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<int32_t> __u__1) noexcept;


                    constexpr System__Net__MonoChunkStream___ProcessReadAsync_d__7(System__Net__MonoChunkStream___ProcessReadAsync_d__7 const&) = default;
                    constexpr System__Net__MonoChunkStream___ProcessReadAsync_d__7(System__Net__MonoChunkStream___ProcessReadAsync_d__7&&) = default;
                    constexpr System__Net__MonoChunkStream___ProcessReadAsync_d__7& operator=(System__Net__MonoChunkStream___ProcessReadAsync_d__7 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr System__Net__MonoChunkStream___ProcessReadAsync_d__7& operator=(System__Net__MonoChunkStream___ProcessReadAsync_d__7&& o) noexcept {
...
constexpr explicit System__Net__MonoChunkStream___ProcessReadAsync_d__7(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
/// @brief Method MoveNext addr 0x28748c8 size 0x36c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2874c34 size 0x58 virtual true final true
...
struct CORDL_TYPE System__Net__MonoChunkStream___FinishReading_d__8 : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
/// @brief Convert operator to System::Runtime::CompilerServices::IAsyncStateMachine
constexpr operator  System::Runtime::CompilerServices::IAsyncStateMachine() const;

// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "System::Net::MonoChunkStream", modifiers: "", def_value: None }, CppParam { name: "cancellationToken", ty: "System::Threading::CancellationToken", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "System::Runtime::CompilerServices::System__Runtime__CompilerServices__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter", modifiers: "", def_value: None }, CppParam { name: "_buffer_5__2", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "System::Runtime::CompilerServices::System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<int32_t>", modifiers: "", def_value: None }]
constexpr System__Net__MonoChunkStream___FinishReading_d__8(int32_t __1__state, System::Runtime::CompilerServices::AsyncTaskMethodBuilder __t__builder, System::Net::MonoChunkStream __4__this, System::Threading::CancellationToken cancellationToken, System::Runtime::CompilerServices::System__Runtime__CompilerServices__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter __u__1, ::ArrayW<uint8_t> _buffer_5__2, System::Runtime::CompilerServices::System__Runtime__CompilerServices__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<int32_t> __u__2) noexcept;


                    constexpr System__Net__MonoChunkStream___FinishReading_d__8(System__Net__MonoChunkStream___FinishReading_d__8 const&) = default;
                    constexpr System__Net__MonoChunkStream___FinishReading_d__8(System__Net__MonoChunkStream___FinishReading_d__8&&) = default;
                    constexpr System__Net__MonoChunkStream___FinishReading_d__8& operator=(System__Net__MonoChunkStream___FinishReading_d__8 const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr System__Net__MonoChunkStream___FinishReading_d__8& operator=(System__Net__MonoChunkStream___FinishReading_d__8&& o) noexcept {
                        __instance = std::move(o.__instance);
                        return *this;
                    };
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __CORDL_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
constexpr explicit System__Net__MonoChunkStream___FinishReading_d__8(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
/// @brief Method MoveNext addr 0x2874c8c size 0x3d0 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x287505c size 0xc virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
public:
// Declarations
using _FinishReading_d__8 = System::Net::System__Net__MonoChunkStream___FinishReading_d__8;

using _ProcessReadAsync_d__7 = System::Net::System__Net__MonoChunkStream___ProcessReadAsync_d__7;
...
/// @brief Method get_Decoder addr 0x2874458 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2874460 size 0x90 virtual false final false
 void _ctor(System::Net::WebOperation operation, System::IO::Stream innerStream, System::Net::WebHeaderCollection headers) ;

/// @brief Method ProcessReadAsync addr 0x2874560 size 0x124 virtual true final false
...
/// @brief Method FinishReading addr 0x2874684 size 0xe0 virtual true final false
 System::Threading::Tasks::Task FinishReading(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method ThrowExpectingChunkTrailer addr 0x2874764 size 0x5c virtual false final false
static void ThrowExpectingChunkTrailer() ;

/// @brief Method <>n__0 addr 0x28747c0 size 0x4 virtual false final false
...
DEFINE_IL2CPP_ARG_TYPE(System::Net::System__Net__MonoChunkStream___FinishReading_d__8, "System.Net", "MonoChunkStream/<FinishReading>d__8");
DEFINE_IL2CPP_ARG_TYPE(System::Net::System__Net__MonoChunkStream___ProcessReadAsync_d__7, "System.Net", "MonoChunkStream/<ProcessReadAsync>d__7");
