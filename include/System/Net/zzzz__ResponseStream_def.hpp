...
/// @brief Method .ctor addr 0x2875d14 size 0x84 virtual false final false
 void _ctor(System::IO::Stream stream, System::Net::HttpListenerResponse response, bool ignore_errors) ;

/// @brief Method get_CanRead addr 0x2875d98 size 0x8 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanSeek addr 0x2875da0 size 0x8 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_CanWrite addr 0x2875da8 size 0x8 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_Length addr 0x2875db0 size 0x40 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x2875df0 size 0x40 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x2875e30 size 0x40 virtual true final false
 void set_Position(int64_t value) ;

/// @brief Method Close addr 0x2875e70 size 0x260 virtual true final false
 void Close() ;

/// @brief Method GetHeaders addr 0x28760d0 size 0x15c virtual false final false
 System::IO::MemoryStream GetHeaders(bool closing) ;

/// @brief Method Flush addr 0x28763d8 size 0x4 virtual true final false
 void Flush() ;

/// @brief Method GetChunkSizeBytes addr 0x287622c size 0xf0 virtual false final false
static ::ArrayW<uint8_t> GetChunkSizeBytes(int32_t size, bool final) ;

/// @brief Method InternalWrite addr 0x287631c size 0xbc virtual false final false
 void InternalWrite(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Write addr 0x28763dc size 0x300 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method BeginWrite addr 0x28766dc size 0x23c virtual true final false
...
/// @brief Method EndWrite addr 0x2876918 size 0x22c virtual true final false
 void EndWrite(System::IAsyncResult ares) ;

/// @brief Method Read addr 0x2876b44 size 0x40 virtual true final false
 int32_t Read(ByRef<::ArrayW<uint8_t>> buffer, int32_t offset, int32_t count) ;

/// @brief Method BeginRead addr 0x2876b84 size 0x40 virtual true final false
...
/// @brief Method EndRead addr 0x2876bc4 size 0x40 virtual true final false
 int32_t EndRead(System::IAsyncResult ares) ;

/// @brief Method Seek addr 0x2876c04 size 0x40 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0x2876c44 size 0x40 virtual true final false
