...
/// @brief Method MoveNext addr 0x2882620 size 0x21c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x288283c size 0x58 virtual true final true
...
/// @brief Method MoveNext addr 0x2882894 size 0x58c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2882efc size 0xc virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method get_Request addr 0x28819f4 size 0x8 virtual false final false
 System::Net::HttpWebRequest get_Request() ;

/// @brief Method get_Connection addr 0x28819fc size 0x8 virtual false final false
 System::Net::WebConnection get_Connection() ;

/// @brief Method set_Connection addr 0x2881a04 size 0x8 virtual false final false
 void set_Connection(System::Net::WebConnection value) ;

/// @brief Method get_ServicePoint addr 0x2881a0c size 0x8 virtual false final false
 System::Net::ServicePoint get_ServicePoint() ;

/// @brief Method set_ServicePoint addr 0x2881a14 size 0x8 virtual false final false
 void set_ServicePoint(System::Net::ServicePoint value) ;

/// @brief Method get_WriteBuffer addr 0x2881a1c size 0x8 virtual false final false
 System::Net::BufferOffsetSize get_WriteBuffer() ;

/// @brief Method get_IsNtlmChallenge addr 0x2881a24 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2881a2c size 0x194 virtual false final false
...
/// @brief Method get_Aborted addr 0x287aafc size 0x50 virtual false final false
 bool get_Aborted() ;

/// @brief Method get_Closed addr 0x2881bc0 size 0x2c virtual false final false
 bool get_Closed() ;

/// @brief Method Abort addr 0x287aabc size 0x40 virtual false final false
 void Abort() ;

/// @brief Method Close addr 0x2881da8 size 0xac virtual false final false
 void Close() ;

/// @brief Method SetCanceled addr 0x2881cdc size 0xcc virtual false final false
 void SetCanceled() ;

/// @brief Method SetError addr 0x2882098 size 0xa4 virtual false final false
 void SetError(System::Exception error) ;

/// @brief Method SetDisposed addr 0x2881bec size 0xf0 virtual false final false
...
/// @brief Method CheckDisposed addr 0x288213c size 0x4c virtual false final false
...
/// @brief Method ThrowIfDisposed addr 0x28821e0 size 0x60 virtual false final false
 void ThrowIfDisposed() ;

/// @brief Method ThrowIfDisposed addr 0x287e274 size 0x44 virtual false final false
 void ThrowIfDisposed(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method ThrowIfClosedOrDisposed addr 0x287f744 size 0x60 virtual false final false
 void ThrowIfClosedOrDisposed() ;

/// @brief Method ThrowIfClosedOrDisposed addr 0x287ef64 size 0x4c virtual false final false
 void ThrowIfClosedOrDisposed(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method CheckThrowDisposed addr 0x2882188 size 0x58 virtual false final false
...
/// @brief Method RegisterRequest addr 0x287d45c size 0x254 virtual false final false
 void RegisterRequest(System::Net::ServicePoint servicePoint, System::Net::WebConnection connection) ;

/// @brief Method SetPriorityRequest addr 0x2882240 size 0x18c virtual false final false
 void SetPriorityRequest(System::Net::WebOperation operation) ;

/// @brief Method GetRequestStream addr 0x28823cc size 0xf0 virtual false final false
 System::Threading::Tasks::Task_1<System::IO::Stream> GetRequestStream() ;

/// @brief Method GetRequestStreamInternal addr 0x28824bc size 0x50 virtual false final false
 System::Threading::Tasks::Task_1<System::Net::WebRequestStream> GetRequestStreamInternal() ;

/// @brief Method get_WriteStream addr 0x288250c size 0x18 virtual false final false
 System::Net::WebRequestStream get_WriteStream() ;

/// @brief Method GetResponseStream addr 0x2882524 size 0x50 virtual false final false
 System::Threading::Tasks::Task_1<System::Net::WebResponseStream> GetResponseStream() ;

/// @brief Method get_Finished addr 0x2882574 size 0x8 virtual false final false
 System::Net::WebCompletionSource_1<System::ValueTuple_2<bool,System::Net::WebOperation>> get_Finished() ;

/// @brief Method Run addr 0x287d6b0 size 0x94 virtual false final false
 void Run() ;

/// @brief Method CompleteRequestWritten addr 0x288257c size 0x80 virtual false final false
 void CompleteRequestWritten(System::Net::WebRequestStream stream, System::Exception error) ;

/// @brief Method Finish addr 0x2881e54 size 0x244 virtual false final false
 void Finish(bool ok, System::Exception error) ;

/// @brief Method <RegisterRequest>b__48_0 addr 0x28825fc size 0x24 virtual false final false
