...
/// @brief Method .ctor addr 0x284662c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_CurrentThreadContext addr 0x2846598 size 0x94 virtual false final false
...
/// @brief Method .ctor addr 0x2846634 size 0x90 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType myObject, ::bs_hook::Il2CppWrapperType myState, System::AsyncCallback myCallBack) ;

/// @brief Method get_AsyncObject addr 0x28466c4 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_AsyncObject() ;

/// @brief Method get_AsyncState addr 0x28466cc size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType get_AsyncState() ;

/// @brief Method get_AsyncCallback addr 0x28466d4 size 0x8 virtual false final false
 System::AsyncCallback get_AsyncCallback() ;

/// @brief Method get_AsyncWaitHandle addr 0x28466dc size 0xa4 virtual true final true
 System::Threading::WaitHandle get_AsyncWaitHandle() ;

/// @brief Method LazilyCreateEvent addr 0x2846780 size 0x1b4 virtual false final false
 bool LazilyCreateEvent(ByRef<System::Threading::ManualResetEvent> waitHandle) ;

/// @brief Method get_CompletedSynchronously addr 0x2846944 size 0x30 virtual true final true
 bool get_CompletedSynchronously() ;

/// @brief Method get_IsCompleted addr 0x2846974 size 0x30 virtual true final true
 bool get_IsCompleted() ;

/// @brief Method get_InternalPeekCompleted addr 0x2846934 size 0x10 virtual false final false
 bool get_InternalPeekCompleted() ;

/// @brief Method get_EndCalled addr 0x28469a4 size 0x8 virtual false final false
 bool get_EndCalled() ;

/// @brief Method set_EndCalled addr 0x28469ac size 0xc virtual false final false
 void set_EndCalled(bool value) ;

/// @brief Method ProtectedInvokeCallback addr 0x28469b8 size 0x1d8 virtual false final false
 void ProtectedInvokeCallback(::bs_hook::Il2CppWrapperType result, ::cordl_internals::intptr_t userToken) ;

/// @brief Method InvokeCallback addr 0x2846b90 size 0x60 virtual false final false
 void InvokeCallback(::bs_hook::Il2CppWrapperType result) ;

/// @brief Method InvokeCallback addr 0x2846bf0 size 0x54 virtual false final false
 void InvokeCallback() ;

/// @brief Method Complete addr 0x2846c44 size 0x198 virtual true final false
 void Complete(::cordl_internals::intptr_t userToken) ;

/// @brief Method WorkerThreadComplete addr 0x2846ddc size 0xac virtual false final false
 void WorkerThreadComplete(::bs_hook::Il2CppWrapperType state) ;

/// @brief Method Cleanup addr 0x2846e88 size 0x4 virtual true final false
 void Cleanup() ;

/// @brief Method InternalWaitForCompletion addr 0x2846e8c size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType InternalWaitForCompletion() ;

/// @brief Method WaitForCompletion addr 0x2846e94 size 0x2b8 virtual false final false
