...
/// @brief Method .ctor addr 0x285c020 size 0xb4 virtual false final false
 void _ctor(::StringW header) ;

/// @brief Method get_Realm addr 0x285c0d4 size 0x28 virtual false final false
 ::StringW get_Realm() ;

/// @brief Method get_Opaque addr 0x285c0fc size 0x2c virtual false final false
 ::StringW get_Opaque() ;

/// @brief Method get_Nonce addr 0x285c128 size 0x2c virtual false final false
 ::StringW get_Nonce() ;

/// @brief Method get_Algorithm addr 0x285c154 size 0x2c virtual false final false
 ::StringW get_Algorithm() ;

/// @brief Method get_QOP addr 0x285c180 size 0x2c virtual false final false
 ::StringW get_QOP() ;

/// @brief Method Parse addr 0x285c1ac size 0x1dc virtual false final false
 bool Parse() ;

/// @brief Method SkipWhitespace addr 0x285c518 size 0x80 virtual false final false
 void SkipWhitespace() ;

/// @brief Method GetKey addr 0x285c598 size 0x90 virtual false final false
 ::StringW GetKey() ;

/// @brief Method GetKeywordAndValue addr 0x285c388 size 0x190 virtual false final false
