...
/// @brief Method .ctor addr 0x28495ec size 0xe0 virtual false final false
 void _ctor() ;

/// @brief Method get_Comment addr 0x28496cc size 0x8 virtual false final false
 ::StringW get_Comment() ;

/// @brief Method set_Comment addr 0x28496d4 size 0x58 virtual false final false
 void set_Comment(::StringW value) ;

/// @brief Method set_CommentUri addr 0x284972c size 0x8 virtual false final false
 void set_CommentUri(System::Uri value) ;

/// @brief Method set_HttpOnly addr 0x2849734 size 0xc virtual false final false
 void set_HttpOnly(bool value) ;

/// @brief Method set_Discard addr 0x2849740 size 0xc virtual false final false
 void set_Discard(bool value) ;

/// @brief Method get_Domain addr 0x284974c size 0x8 virtual false final false
 ::StringW get_Domain() ;

/// @brief Method set_Domain addr 0x2849754 size 0x74 virtual false final false
 void set_Domain(::StringW value) ;

/// @brief Method get__Domain addr 0x28497c8 size 0xcc virtual false final false
 ::StringW get__Domain() ;

/// @brief Method get_Expired addr 0x28498a4 size 0xb8 virtual false final false
 bool get_Expired() ;

/// @brief Method set_Expires addr 0x284995c size 0x8 virtual false final false
 void set_Expires(System::DateTime value) ;

/// @brief Method get_Name addr 0x2849964 size 0x8 virtual false final false
 ::StringW get_Name() ;

/// @brief Method set_Name addr 0x284996c size 0x18c virtual false final false
 void set_Name(::StringW value) ;

/// @brief Method InternalSetName addr 0x2849af8 size 0x104 virtual false final false
 bool InternalSetName(::StringW value) ;

/// @brief Method get_Path addr 0x2849c04 size 0x8 virtual false final false
 ::StringW get_Path() ;

/// @brief Method set_Path addr 0x2849c0c size 0x6c virtual false final false
 void set_Path(::StringW value) ;

/// @brief Method get__Path addr 0x2849c78 size 0x9c virtual false final false
 ::StringW get__Path() ;

/// @brief Method get_Plain addr 0x2849894 size 0x10 virtual false final false
 bool get_Plain() ;

/// @brief Method IsDomainEqualToHost addr 0x2849d14 size 0x58 virtual false final false
static bool IsDomainEqualToHost(::StringW domain, ::StringW host) ;

/// @brief Method VerifySetDefaults addr 0x2849d6c size 0x9f0 virtual false final false
...
/// @brief Method DomainCharsTest addr 0x284a75c size 0x9c virtual false final false
static bool DomainCharsTest(::StringW name) ;

/// @brief Method get_Port addr 0x284a8bc size 0x8 virtual false final false
 ::StringW get_Port() ;

/// @brief Method set_Port addr 0x284a8c4 size 0x334 virtual false final false
 void set_Port(::StringW value) ;

/// @brief Method get_PortList addr 0x284abf8 size 0x8 virtual false final false
 ::ArrayW<int32_t> get_PortList() ;

/// @brief Method get__Port addr 0x284ac00 size 0xc8 virtual false final false
 ::StringW get__Port() ;

/// @brief Method get_Secure addr 0x284acc8 size 0x8 virtual false final false
 bool get_Secure() ;

/// @brief Method set_Secure addr 0x284acd0 size 0xc virtual false final false
 void set_Secure(bool value) ;

/// @brief Method get_Value addr 0x284acdc size 0x8 virtual false final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x284ace4 size 0x68 virtual false final false
 void set_Value(::StringW value) ;

/// @brief Method get_Variant addr 0x284ad4c size 0x8 virtual false final false
 System::Net::CookieVariant get_Variant() ;

/// @brief Method get_DomainKey addr 0x284ad54 size 0x1c virtual false final false
 ::StringW get_DomainKey() ;

/// @brief Method get_Version addr 0x284ad70 size 0x8 virtual false final false
 int32_t get_Version() ;

/// @brief Method set_Version addr 0x284ad78 size 0x78 virtual false final false
 void set_Version(int32_t value) ;

/// @brief Method get__Version addr 0x284adf0 size 0xfc virtual false final false
 ::StringW get__Version() ;

/// @brief Method GetComparer addr 0x284aeec size 0x58 virtual false final false
static System::Collections::IComparer GetComparer() ;

/// @brief Method Equals addr 0x284af44 size 0xd0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType comparand) ;

/// @brief Method GetHashCode addr 0x284b014 size 0x268 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x284b27c size 0x310 virtual true final false
 ::StringW ToString() ;
