...
/// @brief Method .ctor addr 0x2826098 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Complete>b__17_0 addr 0x28260a0 size 0x80 virtual false final false
...
namespace System::Net {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7977))}
...
/// @brief Method SafeCaptureIdentity addr 0x28252f0 size 0x4 virtual false final false
 void SafeCaptureIdentity() ;

/// @brief Method CleanupInternal addr 0x28252f4 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x28252f8 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2825300 size 0x50 virtual false final false
...
/// @brief Method .ctor addr 0x2825350 size 0x78 virtual false final false
...
/// @brief Method StartPostingAsyncOp addr 0x28253c8 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType StartPostingAsyncOp() ;

/// @brief Method StartPostingAsyncOp addr 0x28253d0 size 0xfc virtual false final false
 ::bs_hook::Il2CppWrapperType StartPostingAsyncOp(bool lockCapture) ;

/// @brief Method FinishPostingAsyncOp addr 0x282559c size 0x44 virtual false final false
 bool FinishPostingAsyncOp() ;

/// @brief Method Cleanup addr 0x28259b8 size 0xa0 virtual true final false
 void Cleanup() ;

/// @brief Method CaptureOrComplete addr 0x28255e0 size 0x3d8 virtual false final false
 bool CaptureOrComplete(ByRef<System::Threading::ExecutionContext> cachedContext, bool returnContext) ;

/// @brief Method Complete addr 0x2825c7c size 0x2e8 virtual true final false
 void Complete(::cordl_internals::intptr_t userToken) ;

/// @brief Method CompleteCallback addr 0x2825f64 size 0xd0 virtual false final false
