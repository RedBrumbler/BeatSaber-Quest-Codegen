...
/// @brief Method .ctor addr 0x285f288 size 0x244 virtual false final false
 void _ctor(System::Net::HttpListener listener, System::Net::IPAddress addr, int32_t port, bool secure) ;

/// @brief Method get_Listener addr 0x285fa20 size 0x8 virtual false final false
 System::Net::HttpListener get_Listener() ;

/// @brief Method Accept addr 0x285f8d8 size 0x148 virtual false final false
...
/// @brief Method ProcessAccept addr 0x285fa28 size 0x24c virtual false final false
static void ProcessAccept(System::Net::Sockets::SocketAsyncEventArgs args) ;

/// @brief Method OnAccept addr 0x286007c size 0x8 virtual false final false
static void OnAccept(::bs_hook::Il2CppWrapperType sender, System::Net::Sockets::SocketAsyncEventArgs e) ;

/// @brief Method RemoveConnection addr 0x2860084 size 0x100 virtual false final false
 void RemoveConnection(System::Net::HttpConnection conn) ;

/// @brief Method BindContext addr 0x2860184 size 0x54 virtual false final false
 bool BindContext(System::Net::HttpListenerContext context) ;

/// @brief Method UnbindContext addr 0x2860828 size 0x2c virtual false final false
 void UnbindContext(System::Net::HttpListenerContext context) ;

/// @brief Method SearchListener addr 0x28601d8 size 0x650 virtual false final false
 System::Net::HttpListener SearchListener(System::Uri uri, ByRef<System::Net::ListenerPrefix> prefix) ;

/// @brief Method MatchFromList addr 0x2860a1c size 0x334 virtual false final false
...
/// @brief Method AddSpecial addr 0x2860d50 size 0x364 virtual false final false
 void AddSpecial(System::Collections::ArrayList coll, System::Net::ListenerPrefix prefix) ;

/// @brief Method RemoveSpecial addr 0x28610b4 size 0xf0 virtual false final false
 bool RemoveSpecial(System::Collections::ArrayList coll, System::Net::ListenerPrefix prefix) ;

/// @brief Method CheckIfRemove addr 0x28611a4 size 0xcc virtual false final false
 void CheckIfRemove() ;

/// @brief Method Close addr 0x28614d0 size 0x2b8 virtual false final false
 void Close() ;

/// @brief Method AddPrefix addr 0x28619f0 size 0x380 virtual false final false
 void AddPrefix(System::Net::ListenerPrefix prefix, System::Net::HttpListener listener) ;

/// @brief Method RemovePrefix addr 0x2861d70 size 0x2a0 virtual false final false
