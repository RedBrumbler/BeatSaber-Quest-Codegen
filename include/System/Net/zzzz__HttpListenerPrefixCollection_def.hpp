...
/// @brief Method .ctor addr 0x28669a0 size 0x90 virtual false final false
 void _ctor(System::Net::HttpListener listener) ;

/// @brief Method get_Count addr 0x2867ea4 size 0x48 virtual true final true
 int32_t get_Count() ;

/// @brief Method get_IsReadOnly addr 0x286845c size 0x8 virtual true final true
 bool get_IsReadOnly() ;

/// @brief Method Add addr 0x2868464 size 0x130 virtual true final true
 void Add(::StringW uriPrefix) ;

/// @brief Method Clear addr 0x2868594 size 0xb8 virtual true final true
 void Clear() ;

/// @brief Method Contains addr 0x286864c size 0x64 virtual true final true
 bool Contains(::StringW uriPrefix) ;

/// @brief Method CopyTo addr 0x28686b0 size 0x74 virtual true final true
 void CopyTo(::ArrayW<::StringW> array, int32_t offset) ;

/// @brief Method GetEnumerator addr 0x2862734 size 0x90 virtual true final true
 System::Collections::Generic::IEnumerator_1<::StringW> GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2868724 size 0x90 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method Remove addr 0x28687b4 size 0x108 virtual true final true
