...
/// @brief Method .ctor addr 0x284c104 size 0xc virtual false final false
 void _ctor(::StringW name, System::Net::CookieToken token) ;

/// @brief Method get_Token addr 0x284c110 size 0x8 virtual false final false
 System::Net::CookieToken get_Token() ;

/// @brief Method IsEqualTo addr 0x284bdd0 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x284b6e0 size 0x38 virtual false final false
 void _ctor(::StringW tokenStream) ;

/// @brief Method get_EndOfCookie addr 0x284b718 size 0x8 virtual false final false
 bool get_EndOfCookie() ;

/// @brief Method set_EndOfCookie addr 0x284b720 size 0xc virtual false final false
 void set_EndOfCookie(bool value) ;

/// @brief Method get_Eof addr 0x284b72c size 0x10 virtual false final false
 bool get_Eof() ;

/// @brief Method get_Name addr 0x284b73c size 0x8 virtual false final false
 ::StringW get_Name() ;

/// @brief Method set_Name addr 0x284b744 size 0x8 virtual false final false
 void set_Name(::StringW value) ;

/// @brief Method get_Quoted addr 0x284b74c size 0x8 virtual false final false
 bool get_Quoted() ;

/// @brief Method set_Quoted addr 0x284b754 size 0xc virtual false final false
 void set_Quoted(bool value) ;

/// @brief Method get_Token addr 0x284b760 size 0x8 virtual false final false
 System::Net::CookieToken get_Token() ;

/// @brief Method set_Token addr 0x284b768 size 0x8 virtual false final false
 void set_Token(System::Net::CookieToken value) ;

/// @brief Method get_Value addr 0x284b770 size 0x8 virtual false final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x284b778 size 0x8 virtual false final false
 void set_Value(::StringW value) ;

/// @brief Method Extract addr 0x284b780 size 0x88 virtual false final false
 ::StringW Extract() ;

/// @brief Method FindNext addr 0x284b808 size 0x2a4 virtual false final false
 System::Net::CookieToken FindNext(bool ignoreComma, bool ignoreEquals) ;

/// @brief Method Next addr 0x284baac size 0x100 virtual false final false
 System::Net::CookieToken Next(bool first, bool parseResponseCookies) ;

/// @brief Method Reset addr 0x284bbac size 0x68 virtual false final false
 void Reset() ;

/// @brief Method TokenFromName addr 0x284bc14 size 0x1bc virtual false final false
