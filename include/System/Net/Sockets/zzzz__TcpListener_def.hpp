...
/// @brief Method .ctor addr 0x279beec size 0x1a0 virtual false final false
 void _ctor(System::Net::IPAddress localaddr, int32_t port) ;

/// @brief Method get_LocalEndpoint addr 0x279c08c size 0x30 virtual false final false
 System::Net::EndPoint get_LocalEndpoint() ;

/// @brief Method Start addr 0x279c0bc size 0x8 virtual false final false
 void Start() ;

/// @brief Method Start addr 0x279c0c4 size 0x18c virtual false final false
 void Start(int32_t backlog) ;

/// @brief Method Stop addr 0x279c250 size 0xc4 virtual false final false
 void Stop() ;

/// @brief Method BeginAcceptTcpClient addr 0x279c314 size 0xb4 virtual false final false
 System::IAsyncResult BeginAcceptTcpClient(System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType state) ;

/// @brief Method EndAcceptTcpClient addr 0x279c3c8 size 0x164 virtual false final false
