...
/// @brief Method get_AcceptSocket addr 0x279cf90 size 0x8 virtual false final false
 System::Net::Sockets::Socket get_AcceptSocket() ;

/// @brief Method set_AcceptSocket addr 0x279cf98 size 0x8 virtual false final false
 void set_AcceptSocket(System::Net::Sockets::Socket value) ;

/// @brief Method get_BytesTransferred addr 0x279cfa0 size 0x8 virtual false final false
 int32_t get_BytesTransferred() ;

/// @brief Method set_BytesTransferred addr 0x279cfa8 size 0x8 virtual false final false
 void set_BytesTransferred(int32_t value) ;

/// @brief Method set_LastOperation addr 0x279cfb0 size 0x8 virtual false final false
 void set_LastOperation(System::Net::Sockets::SocketAsyncOperation value) ;

/// @brief Method set_RemoteEndPoint addr 0x279cfb8 size 0x8 virtual false final false
 void set_RemoteEndPoint(System::Net::EndPoint value) ;

/// @brief Method set_SendPacketsSendSize addr 0x279cfc0 size 0x8 virtual false final false
 void set_SendPacketsSendSize(int32_t value) ;

/// @brief Method get_SocketError addr 0x279cfc8 size 0x8 virtual false final false
 System::Net::Sockets::SocketError get_SocketError() ;

/// @brief Method set_SocketError addr 0x279cfd0 size 0x8 virtual false final false
 void set_SocketError(System::Net::Sockets::SocketError value) ;

/// @brief Method set_SocketFlags addr 0x279cfd8 size 0x8 virtual false final false
 void set_SocketFlags(System::Net::Sockets::SocketFlags value) ;

/// @brief Method get_UserToken addr 0x279cfe0 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_UserToken() ;

/// @brief Method set_UserToken addr 0x279cfe8 size 0x8 virtual false final false
 void set_UserToken(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method add_Completed addr 0x279cff0 size 0xb0 virtual false final false
 void add_Completed(System::EventHandler_1<System::Net::Sockets::SocketAsyncEventArgs> value) ;

/// @brief Method remove_Completed addr 0x279d0a0 size 0xb0 virtual false final false
 void remove_Completed(System::EventHandler_1<System::Net::Sockets::SocketAsyncEventArgs> value) ;

// Ctor Parameters []
explicit SocketAsyncEventArgs() ;

/// @brief Method .ctor addr 0x279d150 size 0x98 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x279d1f0 size 0x8c virtual false final false
 void _ctor(bool flowExecutionContext) ;

/// @brief Method Finalize addr 0x279d27c size 0x10 virtual true final false
 void Finalize() ;

/// @brief Method Dispose addr 0x279d28c size 0x14 virtual false final false
 void Dispose(bool disposing) ;

/// @brief Method Dispose addr 0x279d2a0 size 0x64 virtual true final true
 void Dispose() ;

/// @brief Method SetBytesTransferred addr 0x2799c6c size 0x8 virtual false final false
 void SetBytesTransferred(int32_t value) ;

/// @brief Method get_CurrentSocket addr 0x279d304 size 0x8 virtual false final false
 System::Net::Sockets::Socket get_CurrentSocket() ;

/// @brief Method SetCurrentSocket addr 0x279d30c size 0x8 virtual false final false
 void SetCurrentSocket(System::Net::Sockets::Socket socket) ;

/// @brief Method SetLastOperation addr 0x279d314 size 0xc8 virtual false final false
 void SetLastOperation(System::Net::Sockets::SocketAsyncOperation op) ;

/// @brief Method Complete_internal addr 0x279d3dc size 0x28 virtual false final false
 void Complete_internal() ;

/// @brief Method OnCompleted addr 0x279d404 size 0x28 virtual true final false
 void OnCompleted(System::Net::Sockets::SocketAsyncEventArgs e) ;

/// @brief Method get_MemoryBuffer addr 0x279d42c size 0xc virtual false final false
 System::Memory_1<uint8_t> get_MemoryBuffer() ;

/// @brief Method get_Offset addr 0x279d438 size 0x8 virtual false final false
 int32_t get_Offset() ;

/// @brief Method get_Count addr 0x279d440 size 0x8 virtual false final false
 int32_t get_Count() ;

/// @brief Method get_BufferList addr 0x279d448 size 0x8 virtual false final false
 System::Collections::Generic::IList_1<System::ArraySegment_1<uint8_t>> get_BufferList() ;

/// @brief Method SetBuffer addr 0x279d450 size 0xf4 virtual false final false
