...
/// @brief Method .ctor addr 0x279c52c size 0xcc virtual false final false
 void _ctor(::cordl_internals::intptr_t preexistingHandle, bool ownsHandle) ;

/// @brief Method ReleaseHandle addr 0x279c5f8 size 0x5cc virtual true final false
 bool ReleaseHandle() ;

/// @brief Method RegisterForBlockingSyscall addr 0x279cbc4 size 0x148 virtual false final false
 void RegisterForBlockingSyscall() ;

/// @brief Method UnRegisterForBlockingSyscall addr 0x279cd0c size 0x1f0 virtual false final false
