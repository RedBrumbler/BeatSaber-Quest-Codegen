...
/// @brief Method .ctor addr 0x279aea8 size 0x20 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x279aec8 size 0x110 virtual false final false
...
/// @brief Method .ctor addr 0x279b04c size 0x44 virtual false final false
 void _ctor(System::Net::Sockets::Socket acceptedSocket) ;

/// @brief Method get_Client addr 0x279b090 size 0x8 virtual false final false
 System::Net::Sockets::Socket get_Client() ;

/// @brief Method set_Client addr 0x279b098 size 0x8 virtual false final false
 void set_Client(System::Net::Sockets::Socket value) ;

/// @brief Method get_Connected addr 0x279b0a0 size 0x1c virtual false final false
 bool get_Connected() ;

/// @brief Method Connect addr 0x279b0bc size 0x6d0 virtual false final false
 void Connect(::StringW hostname, int32_t port) ;

/// @brief Method Connect addr 0x279b78c size 0x10c virtual false final false
 void Connect(System::Net::IPEndPoint remoteEP) ;

/// @brief Method BeginConnect addr 0x279b898 size 0x6c virtual false final false
...
/// @brief Method EndConnect addr 0x279b904 size 0x48 virtual false final false
 void EndConnect(System::IAsyncResult asyncResult) ;

/// @brief Method ConnectAsync addr 0x279b94c size 0x16c virtual false final false
 System::Threading::Tasks::Task ConnectAsync(::StringW host, int32_t port) ;

/// @brief Method GetStream addr 0x279bab8 size 0x14c virtual false final false
 System::Net::Sockets::NetworkStream GetStream() ;

/// @brief Method Close addr 0x279bc04 size 0xa4 virtual false final false
 void Close() ;

/// @brief Method Dispose addr 0x279bca8 size 0x194 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Dispose addr 0x279be3c size 0x10 virtual true final true
 void Dispose() ;

/// @brief Method Finalize addr 0x279be4c size 0xa0 virtual true final false
 void Finalize() ;

/// @brief Method initialize addr 0x279afd8 size 0x74 virtual false final false
 void initialize() ;
