...
/// @brief Method .ctor addr 0x279ae60 size 0x34 virtual false final false
 void _ctor(bool enable, int32_t seconds) ;

/// @brief Method set_Enabled addr 0x279ae94 size 0xc virtual false final false
 void set_Enabled(bool value) ;

/// @brief Method set_LingerTime addr 0x279aea0 size 0x8 virtual false final false
