...
/// @brief Method .ctor addr 0x279d840 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Complete>b__27_0 addr 0x279d848 size 0x78 virtual false final false
...
namespace System::Net::Sockets {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7765))}
...
/// @brief Method get_Handle addr 0x279d544 size 0x64 virtual false final false
 ::cordl_internals::intptr_t get_Handle() ;

// Ctor Parameters []
explicit SocketAsyncResult() ;

/// @brief Method .ctor addr 0x279d1e8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0x279d5a8 size 0xb4 virtual false final false
...
/// @brief Method .ctor addr 0x279d65c size 0x38 virtual false final false
...
/// @brief Method get_ErrorCode addr 0x279d694 size 0x80 virtual false final false
 System::Net::Sockets::SocketError get_ErrorCode() ;

/// @brief Method CheckIfThrowDelayedException addr 0x279d714 size 0xa8 virtual false final false
 void CheckIfThrowDelayedException() ;

/// @brief Method CompleteDisposed addr 0x279d7bc size 0x4 virtual true final false
 void CompleteDisposed() ;

/// @brief Method Complete addr 0x279945c size 0x1f0 virtual false final false
 void Complete() ;

/// @brief Method Complete addr 0x279d7c0 size 0xc virtual false final false
 void Complete(bool synch) ;

/// @brief Method Complete addr 0x2799f1c size 0x8 virtual false final false
 void Complete(int32_t total) ;

/// @brief Method Complete addr 0x279d7cc size 0x10 virtual false final false
 void Complete(System::Exception e, bool synch) ;

/// @brief Method Complete addr 0x2798cd4 size 0x8 virtual false final false
 void Complete(System::Exception e) ;

/// @brief Method Complete addr 0x2798cdc size 0x8 virtual false final false
 void Complete(System::Net::Sockets::Socket s) ;

/// @brief Method Complete addr 0x2798f24 size 0xc virtual false final false
