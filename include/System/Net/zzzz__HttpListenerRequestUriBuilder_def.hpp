...
/// @brief Method .ctor addr 0x2839408 size 0xcc virtual false final false
 void _ctor(::StringW rawUri, ::StringW cookedUriScheme, ::StringW cookedUriHost, ::StringW cookedUriPath, ::StringW cookedUriQuery) ;

/// @brief Method GetRequestUri addr 0x2839550 size 0x90 virtual false final false
...
/// @brief Method Build addr 0x28395e0 size 0xe8 virtual false final false
 System::Uri Build() ;

/// @brief Method BuildRequestUriUsingCookedPath addr 0x28396c8 size 0x294 virtual false final false
 void BuildRequestUriUsingCookedPath() ;

/// @brief Method BuildRequestUriUsingRawPath addr 0x283995c size 0x384 virtual false final false
 void BuildRequestUriUsingRawPath() ;

/// @brief Method GetEncoding addr 0x2839e58 size 0x6c virtual false final false
static System::Text::Encoding GetEncoding(System::Net::System__Net__HttpListenerRequestUriBuilder__EncodingType type) ;

/// @brief Method BuildRequestUriUsingRawPath addr 0x2839ec4 size 0x250 virtual false final false
...
/// @brief Method ParseRawPath addr 0x283a114 size 0x150 virtual false final false
 System::Net::System__Net__HttpListenerRequestUriBuilder__ParsingResult ParseRawPath(System::Text::Encoding encoding) ;

/// @brief Method AppendUnicodeCodePointValuePercentEncoded addr 0x283a60c size 0x314 virtual false final false
 bool AppendUnicodeCodePointValuePercentEncoded(::StringW codePoint) ;

/// @brief Method AddPercentEncodedOctetToRawOctetsList addr 0x283a920 size 0x154 virtual false final false
 bool AddPercentEncodedOctetToRawOctetsList(System::Text::Encoding encoding, ::StringW escapedCharacter) ;

/// @brief Method EmptyDecodeAndAppendRawOctetsList addr 0x283a264 size 0x3a8 virtual false final false
 bool EmptyDecodeAndAppendRawOctetsList(System::Text::Encoding encoding) ;

/// @brief Method AppendOctetsPercentEncoded addr 0x283aa74 size 0x36c virtual false final false
...
/// @brief Method GetOctetsAsString addr 0x283ade0 size 0x13d8 virtual false final false
static ::StringW GetOctetsAsString(System::Collections::Generic::IEnumerable_1<uint8_t> octets) ;

/// @brief Method GetPath addr 0x2839ce8 size 0x170 virtual false final false
static ::StringW GetPath(::StringW uriString) ;

/// @brief Method AddSlashToAsteriskOnlyPath addr 0x28394d4 size 0x7c virtual false final false
static ::StringW AddSlashToAsteriskOnlyPath(::StringW path) ;

/// @brief Method LogWarning addr 0x2839ce0 size 0x8 virtual false final false
