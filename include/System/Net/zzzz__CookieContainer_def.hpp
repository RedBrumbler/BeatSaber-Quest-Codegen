...
/// @brief Method .ctor addr 0x284d910 size 0xf4 virtual false final false
 void _ctor() ;

/// @brief Method AddRemoveDomain addr 0x284da04 size 0x128 virtual false final false
 void AddRemoveDomain(::StringW key, System::Net::PathList value) ;

/// @brief Method Add addr 0x284db2c size 0x820 virtual false final false
 void Add(System::Net::Cookie cookie, bool throwOnError) ;

/// @brief Method AgeCookies addr 0x284e980 size 0x153c virtual false final false
 bool AgeCookies(::StringW domain) ;

/// @brief Method ExpireCollection addr 0x284fee8 size 0x16c virtual false final false
 int32_t ExpireCollection(System::Net::CookieCollection cc) ;

/// @brief Method IsLocalDomain addr 0x2850078 size 0x29c virtual false final false
 bool IsLocalDomain(::StringW host) ;

/// @brief Method CookieCutter addr 0x2850314 size 0x6d4 virtual false final false
 System::Net::CookieCollection CookieCutter(System::Uri uri, ::StringW headerName, ::StringW setCookieHeader, bool isThrow) ;

/// @brief Method InternalGetCookies addr 0x28509e8 size 0x4ac virtual false final false
 System::Net::CookieCollection InternalGetCookies(System::Uri uri) ;

/// @brief Method BuildCookieCollectionFromDomainMatches addr 0x2850e94 size 0x804 virtual false final false
...
/// @brief Method MergeUpdateCollections addr 0x28516bc size 0x20c virtual false final false
...
/// @brief Method GetCookieHeader addr 0x28518c8 size 0xd0 virtual false final false
 ::StringW GetCookieHeader(System::Uri uri) ;

/// @brief Method GetCookieHeader addr 0x2851998 size 0x398 virtual false final false
