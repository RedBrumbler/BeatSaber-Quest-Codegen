...
/// @brief Method Parse addr 0x2828894 size 0x1fc virtual false final false
static System::Net::IPAddress Parse(System::ReadOnlySpan_1<char16_t> ipSpan, bool tryParse) ;

/// @brief Method IPv4AddressToString addr 0x2828f8c size 0x60 virtual false final false
static ::StringW IPv4AddressToString(uint32_t address) ;

/// @brief Method IPv4AddressToString addr 0x2829c50 size 0x70 virtual false final false
static void IPv4AddressToString(uint32_t address, System::Text::StringBuilder destination) ;

/// @brief Method IPv4AddressToStringHelper addr 0x2829bb4 size 0x9c virtual false final false
static int32_t IPv4AddressToStringHelper(uint32_t address, void* addressString) ;

/// @brief Method IPv6AddressToString addr 0x2828f78 size 0x14 virtual false final false
static ::StringW IPv6AddressToString(::ArrayW<uint16_t> address, uint32_t scopeId) ;

/// @brief Method IPv6AddressToStringHelper addr 0x2829d78 size 0x120 virtual false final false
static System::Text::StringBuilder IPv6AddressToStringHelper(::ArrayW<uint16_t> address, uint32_t scopeId) ;

/// @brief Method FormatIPv4AddressNumber addr 0x2829cc0 size 0xb8 virtual false final false
static void FormatIPv4AddressNumber(int32_t number, void* addressString, ByRef<int32_t> offset) ;

/// @brief Method Ipv4StringToAddress addr 0x2829ae0 size 0xd4 virtual false final false
static bool Ipv4StringToAddress(System::ReadOnlySpan_1<char16_t> ipSpan, ByRef<int64_t> address) ;

/// @brief Method Ipv6StringToAddress addr 0x282997c size 0x164 virtual false final false
...
/// @brief Method AppendSections addr 0x2829e98 size 0x1b8 virtual false final false
...
/// @brief Method AppendHex addr 0x282a08c size 0x68 virtual false final false
static void AppendHex(uint16_t value, System::Text::StringBuilder buffer) ;

/// @brief Method ExtractIPv4Address addr 0x282a050 size 0x3c virtual false final false
static uint32_t ExtractIPv4Address(::ArrayW<uint16_t> address) ;

/// @brief Method Reverse addr 0x282a0f4 size 0xc virtual false final false
