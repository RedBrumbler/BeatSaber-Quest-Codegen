...
/// @brief Method .ctor addr 0x282a774 size 0x84 virtual false final false
 void _ctor(System::Net::Sockets::TcpClient client) ;

/// @brief Method get_UsingSecureStream addr 0x282d584 size 0x7c virtual false final false
 bool get_UsingSecureStream() ;

/// @brief Method get_ServerAddress addr 0x282cd60 size 0x94 virtual false final false
 System::Net::IPAddress get_ServerAddress() ;

/// @brief Method get_Socket addr 0x282ea74 size 0x1c virtual false final false
 System::Net::Sockets::Socket get_Socket() ;

/// @brief Method get_NetworkStream addr 0x2838a64 size 0x8 virtual false final false
 System::Net::Sockets::NetworkStream get_NetworkStream() ;

/// @brief Method set_NetworkStream addr 0x2838a6c size 0x8 virtual false final false
 void set_NetworkStream(System::Net::Sockets::NetworkStream value) ;

/// @brief Method get_CanRead addr 0x2838a74 size 0x20 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanSeek addr 0x2838a94 size 0x20 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_CanWrite addr 0x2838ab4 size 0x20 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_CanTimeout addr 0x2838ad4 size 0x20 virtual true final false
 bool get_CanTimeout() ;

/// @brief Method get_ReadTimeout addr 0x2838af4 size 0x24 virtual true final false
 int32_t get_ReadTimeout() ;

/// @brief Method set_ReadTimeout addr 0x2838b18 size 0x24 virtual true final false
 void set_ReadTimeout(int32_t value) ;

/// @brief Method get_WriteTimeout addr 0x2838b3c size 0x24 virtual true final false
 int32_t get_WriteTimeout() ;

/// @brief Method set_WriteTimeout addr 0x2838b60 size 0x24 virtual true final false
 void set_WriteTimeout(int32_t value) ;

/// @brief Method get_Length addr 0x2838b84 size 0x20 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x2838ba4 size 0x20 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x2838bc4 size 0x24 virtual true final false
 void set_Position(int64_t value) ;

/// @brief Method Seek addr 0x2838be8 size 0x24 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method Read addr 0x2838c0c size 0x24 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t size) ;

/// @brief Method Write addr 0x2838c30 size 0x24 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t size) ;

/// @brief Method Dispose addr 0x2838c54 size 0xac virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method CloseSocket addr 0x282bc90 size 0x38 virtual false final false
 void CloseSocket() ;

/// @brief Method Close addr 0x282a9f0 size 0x30 virtual false final false
 void Close(int32_t timeout) ;

/// @brief Method BeginRead addr 0x2838d00 size 0x24 virtual true final false
...
/// @brief Method EndRead addr 0x2838d24 size 0x24 virtual true final false
 int32_t EndRead(System::IAsyncResult asyncResult) ;

/// @brief Method ReadAsync addr 0x2838d48 size 0x24 virtual true final false
...
/// @brief Method BeginWrite addr 0x2838d6c size 0x24 virtual true final false
...
/// @brief Method EndWrite addr 0x2838d90 size 0x24 virtual true final false
 void EndWrite(System::IAsyncResult asyncResult) ;

/// @brief Method WriteAsync addr 0x2838db4 size 0x24 virtual true final false
...
/// @brief Method Flush addr 0x2838dd8 size 0x24 virtual true final false
 void Flush() ;

/// @brief Method FlushAsync addr 0x2838dfc size 0x24 virtual true final false
 System::Threading::Tasks::Task FlushAsync(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method SetLength addr 0x2838e20 size 0x24 virtual true final false
 void SetLength(int64_t value) ;

/// @brief Method SetSocketTimeoutOption addr 0x2836264 size 0x50 virtual false final false
