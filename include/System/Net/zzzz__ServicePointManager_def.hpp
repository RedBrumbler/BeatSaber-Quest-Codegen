...
/// @brief Method .ctor addr 0x2878830 size 0x3c virtual false final false
 void _ctor(System::Uri uri, System::Uri proxy, bool use_connect) ;

/// @brief Method get_UsesProxy addr 0x2878d0c size 0x60 virtual false final false
 bool get_UsesProxy() ;

/// @brief Method GetHashCode addr 0x2878d6c size 0xd0 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2878e3c size 0xf4 virtual true final false
...
/// @brief Method GetLegacyCertificatePolicy addr 0x2877f88 size 0x58 virtual false final false
static System::Net::ICertificatePolicy GetLegacyCertificatePolicy() ;

/// @brief Method get_CheckCertificateRevocationList addr 0x2877fe0 size 0x58 virtual false final false
static bool get_CheckCertificateRevocationList() ;

/// @brief Method get_DnsRefreshTimeout addr 0x2878038 size 0x58 virtual false final false
static int32_t get_DnsRefreshTimeout() ;

/// @brief Method get_SecurityProtocol addr 0x2878090 size 0x58 virtual false final false
static System::Net::SecurityProtocolType get_SecurityProtocol() ;

/// @brief Method get_ServerCertValidationCallback addr 0x28780e8 size 0x58 virtual false final false
static System::Net::ServerCertValidationCallback get_ServerCertValidationCallback() ;

/// @brief Method get_ServerCertificateValidationCallback addr 0x2878140 size 0x88 virtual false final false
static System::Net::Security::RemoteCertificateValidationCallback get_ServerCertificateValidationCallback() ;

/// @brief Method FindServicePoint addr 0x28781c8 size 0x668 virtual false final false
static System::Net::ServicePoint FindServicePoint(System::Uri address, System::Net::IWebProxy proxy) ;

/// @brief Method CloseConnectionGroup addr 0x287886c size 0x408 virtual false final false
static void CloseConnectionGroup(::StringW connectionGroupName) ;

/// @brief Method RemoveServicePoint addr 0x2878c74 size 0x98 virtual false final false
