...
/// @brief Method .ctor addr 0x287f168 size 0xbc virtual false final false
 void _ctor(System::Net::WebConnection cnc, System::Net::WebOperation operation) ;

/// @brief Method get_Request addr 0x287f224 size 0x8 virtual false final false
 System::Net::HttpWebRequest get_Request() ;

/// @brief Method get_Connection addr 0x287f22c size 0x8 virtual false final false
 System::Net::WebConnection get_Connection() ;

/// @brief Method get_Operation addr 0x287f234 size 0x8 virtual false final false
 System::Net::WebOperation get_Operation() ;

/// @brief Method get_ServicePoint addr 0x287f23c size 0x1c virtual false final false
 System::Net::ServicePoint get_ServicePoint() ;

/// @brief Method get_CanTimeout addr 0x287f258 size 0x8 virtual true final false
 bool get_CanTimeout() ;

/// @brief Method get_ReadTimeout addr 0x287f260 size 0x8 virtual true final false
 int32_t get_ReadTimeout() ;

/// @brief Method set_ReadTimeout addr 0x287f268 size 0x64 virtual true final false
 void set_ReadTimeout(int32_t value) ;

/// @brief Method get_WriteTimeout addr 0x287f2cc size 0x8 virtual true final false
 int32_t get_WriteTimeout() ;

/// @brief Method set_WriteTimeout addr 0x287f2d4 size 0x64 virtual true final false
 void set_WriteTimeout(int32_t value) ;

/// @brief Method GetException addr 0x287f338 size 0x168 virtual false final false
...
/// @brief Method Read addr 0x287f4a0 size 0x2a4 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method BeginRead addr 0x287f7a4 size 0x1d0 virtual true final false
...
/// @brief Method EndRead addr 0x287f974 size 0x124 virtual true final false
 int32_t EndRead(System::IAsyncResult r) ;

/// @brief Method BeginWrite addr 0x287fa98 size 0x1d0 virtual true final false
...
/// @brief Method EndWrite addr 0x287fc68 size 0xf8 virtual true final false
 void EndWrite(System::IAsyncResult r) ;

/// @brief Method Write addr 0x287fd60 size 0x1f8 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Flush addr 0x287ff58 size 0x4 virtual true final false
 void Flush() ;

/// @brief Method FlushAsync addr 0x287ff5c size 0xc0 virtual true final false
 System::Threading::Tasks::Task FlushAsync(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method InternalClose addr 0x288001c size 0xc virtual false final false
 void InternalClose() ;
...
/// @brief Method Close addr 0x2880028 size 0x14 virtual true final false
 void Close() ;

/// @brief Method Seek addr 0x288003c size 0x50 virtual true final false
 int64_t Seek(int64_t a, System::IO::SeekOrigin b) ;

/// @brief Method SetLength addr 0x288008c size 0x50 virtual true final false
 void SetLength(int64_t a) ;

/// @brief Method get_CanSeek addr 0x28800dc size 0x8 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_Length addr 0x28800e4 size 0x50 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x2880134 size 0x50 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x2880184 size 0x50 virtual true final false
