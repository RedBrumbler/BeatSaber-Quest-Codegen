...
/// @brief Method get_Cache addr 0x285d580 size 0x168 virtual false final false
static System::Collections::Hashtable get_Cache() ;

/// @brief Method CheckExpired addr 0x285d6e8 size 0x848 virtual false final false
static void CheckExpired(int32_t count) ;

/// @brief Method Authenticate addr 0x285df30 size 0x2a8 virtual true final true
...
/// @brief Method PreAuthenticate addr 0x285e1d8 size 0x194 virtual true final true
 System::Net::Authorization PreAuthenticate(System::Net::WebRequest webRequest, System::Net::ICredentials credentials) ;

/// @brief Method get_AuthenticationType addr 0x285e36c size 0x40 virtual true final true
 ::StringW get_AuthenticationType() ;

// Ctor Parameters []
explicit DigestClient() ;

/// @brief Method .ctor addr 0x285988c size 0x8 virtual false final false
 void _ctor() ;
