...
/// @brief Method get_Family addr 0x283d73c size 0x38 virtual false final false
 System::Net::Sockets::AddressFamily get_Family() ;

/// @brief Method get_Size addr 0x283d774 size 0x8 virtual false final false
 int32_t get_Size() ;

/// @brief Method get_Item addr 0x283d77c size 0x7c virtual false final false
...
/// @brief Method .ctor addr 0x283d7f8 size 0x120 virtual false final false
...
/// @brief Method .ctor addr 0x283d918 size 0x288 virtual false final false
...
/// @brief Method .ctor addr 0x283dba0 size 0x5c virtual false final false
 void _ctor(System::Net::IPAddress ipaddress, int32_t port) ;

/// @brief Method GetIPAddress addr 0x283dbfc size 0x1f4 virtual false final false
 System::Net::IPAddress GetIPAddress() ;

/// @brief Method GetIPEndPoint addr 0x283ddf0 size 0xa8 virtual false final false
 System::Net::IPEndPoint GetIPEndPoint() ;

/// @brief Method Equals addr 0x283de98 size 0xec virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType comparand) ;

/// @brief Method GetHashCode addr 0x283df84 size 0x130 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x283e0b4 size 0x2ec virtual true final false
 ::StringW ToString() ;
