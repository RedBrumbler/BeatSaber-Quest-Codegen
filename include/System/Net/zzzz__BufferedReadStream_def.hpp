...
/// @brief Method MoveNext addr 0x285acb0 size 0x2b0 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x285af60 size 0x58 virtual true final true
...
/// @brief Method .ctor addr 0x285aad0 size 0x28 virtual false final false
 void _ctor(System::Net::WebOperation operation, System::IO::Stream innerStream, System::Net::BufferOffsetSize readBuffer) ;

/// @brief Method ProcessReadAsync addr 0x285aaf8 size 0x128 virtual true final false
...
/// @brief Method TryReadFromBuffer addr 0x285ac20 size 0x90 virtual false final false
