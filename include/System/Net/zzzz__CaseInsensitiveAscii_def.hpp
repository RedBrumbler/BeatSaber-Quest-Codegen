...
/// @brief Method GetHashCode addr 0x28411c0 size 0x118 virtual true final true
 int32_t GetHashCode(::bs_hook::Il2CppWrapperType myObject) ;

/// @brief Method Compare addr 0x28412d8 size 0x170 virtual true final true
 int32_t Compare(::bs_hook::Il2CppWrapperType firstObject, ::bs_hook::Il2CppWrapperType secondObject) ;

/// @brief Method FastGetHashCode addr 0x2841448 size 0xf0 virtual false final false
 int32_t FastGetHashCode(::StringW myString) ;

/// @brief Method Equals addr 0x2841538 size 0x178 virtual true final true
 bool Equals(::bs_hook::Il2CppWrapperType firstObject, ::bs_hook::Il2CppWrapperType secondObject) ;

// Ctor Parameters []
explicit CaseInsensitiveAscii() ;

/// @brief Method .ctor addr 0x28416b0 size 0x8 virtual false final false
 void _ctor() ;
