...
/// @brief Method .ctor addr 0x2874390 size 0x28 virtual false final false
 void _ctor(::ArrayW<uint8_t> chunk) ;

/// @brief Method Read addr 0x2873894 size 0x60 virtual false final false
...
/// @brief Method .ctor addr 0x28734c0 size 0xb8 virtual false final false
 void _ctor(System::Net::WebHeaderCollection headers) ;

/// @brief Method Read addr 0x2873578 size 0x4 virtual false final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t size) ;

/// @brief Method ReadFromChunks addr 0x287357c size 0x318 virtual false final false
 int32_t ReadFromChunks(::ArrayW<uint8_t> buffer, int32_t offset, int32_t size) ;

/// @brief Method Write addr 0x28738f4 size 0x20 virtual false final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t size) ;

/// @brief Method InternalWrite addr 0x2873914 size 0x13c virtual false final false
 void InternalWrite(::ArrayW<uint8_t> buffer, ByRef<int32_t> offset, int32_t size) ;

/// @brief Method get_WantMore addr 0x287425c size 0x28 virtual false final false
 bool get_WantMore() ;

/// @brief Method get_DataAvailable addr 0x2874284 size 0x100 virtual false final false
 bool get_DataAvailable() ;

/// @brief Method get_ChunkLeft addr 0x2874384 size 0xc virtual false final false
 int32_t get_ChunkLeft() ;

/// @brief Method ReadBody addr 0x2873d58 size 0x138 virtual false final false
 System::Net::System__Net__MonoChunkParser__State ReadBody(::ArrayW<uint8_t> buffer, ByRef<int32_t> offset, int32_t size) ;

/// @brief Method GetChunkSize addr 0x2873a50 size 0x308 virtual false final false
 System::Net::System__Net__MonoChunkParser__State GetChunkSize(::ArrayW<uint8_t> buffer, ByRef<int32_t> offset, int32_t size) ;

/// @brief Method RemoveChunkExtension addr 0x2874410 size 0x48 virtual false final false
static ::StringW RemoveChunkExtension(::StringW input) ;

/// @brief Method ReadCRLF addr 0x2873e90 size 0x100 virtual false final false
 System::Net::System__Net__MonoChunkParser__State ReadCRLF(::ArrayW<uint8_t> buffer, ByRef<int32_t> offset, int32_t size) ;

/// @brief Method ReadTrailer addr 0x2873f90 size 0x2cc virtual false final false
 System::Net::System__Net__MonoChunkParser__State ReadTrailer(::ArrayW<uint8_t> buffer, ByRef<int32_t> offset, int32_t size) ;

/// @brief Method ThrowProtocolViolation addr 0x28743b8 size 0x58 virtual false final false
