...
/// @brief Method .ctor addr 0x2872190 size 0x80 virtual false final false
 void _ctor(System::AsyncCallback cb, ::bs_hook::Il2CppWrapperType state) ;

/// @brief Method Complete addr 0x2872210 size 0x1f4 virtual false final false
 void Complete(System::Exception exc) ;

/// @brief Method InvokeCallback addr 0x2872404 size 0x13c virtual false final false
static void InvokeCallback(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method Complete addr 0x2872540 size 0x8 virtual false final false
 void Complete(System::Net::HttpListenerContext context) ;

/// @brief Method Complete addr 0x2872548 size 0x530 virtual false final false
 void Complete(System::Net::HttpListenerContext context, bool synch) ;

/// @brief Method GetContext addr 0x2872a78 size 0x3c virtual false final false
 System::Net::HttpListenerContext GetContext() ;

/// @brief Method get_AsyncState addr 0x2872ab4 size 0x14 virtual true final true
 ::bs_hook::Il2CppWrapperType get_AsyncState() ;

/// @brief Method get_AsyncWaitHandle addr 0x2872ac8 size 0x138 virtual true final true
 System::Threading::WaitHandle get_AsyncWaitHandle() ;

/// @brief Method get_CompletedSynchronously addr 0x2872c00 size 0x14 virtual true final true
 bool get_CompletedSynchronously() ;

/// @brief Method get_IsCompleted addr 0x2872c14 size 0xe0 virtual true final true
