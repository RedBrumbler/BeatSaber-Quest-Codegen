...
namespace System::Net {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8383))}
...
/// @brief Method NormalizeCommonHeaders addr 0x283e80c size 0x100 virtual false final false
 void NormalizeCommonHeaders() ;

/// @brief Method get_InnerCollection addr 0x283e90c size 0xa4 virtual false final false
 System::Collections::Specialized::NameValueCollection get_InnerCollection() ;

/// @brief Method AllowMultiValues addr 0x283e9b0 size 0xa8 virtual false final false
static bool AllowMultiValues(::StringW name) ;

/// @brief Method get_AllowHttpRequestHeader addr 0x283eb34 size 0x38 virtual false final false
 bool get_AllowHttpRequestHeader() ;

/// @brief Method Remove addr 0x283eb6c size 0xf8 virtual false final false
 void Remove(System::Net::HttpRequestHeader header) ;

/// @brief Method AddInternal addr 0x283ec64 size 0x54 virtual false final false
 void AddInternal(::StringW name, ::StringW value) ;

/// @brief Method ChangeInternal addr 0x283ecb8 size 0x54 virtual false final false
 void ChangeInternal(::StringW name, ::StringW value) ;

/// @brief Method RemoveInternal addr 0x283ed0c size 0x5c virtual false final false
 void RemoveInternal(::StringW name) ;

/// @brief Method CheckBadChars addr 0x283ed68 size 0x394 virtual false final false
static ::StringW CheckBadChars(::StringW name, bool isHeaderValue) ;

/// @brief Method ContainsNonAsciiChars addr 0x283f0fc size 0x84 virtual false final false
static bool ContainsNonAsciiChars(::StringW token) ;

/// @brief Method ThrowOnRestrictedHeader addr 0x283f180 size 0x168 virtual false final false
 void ThrowOnRestrictedHeader(::StringW headerName) ;

/// @brief Method Add addr 0x283f2e8 size 0x1b4 virtual true final false
 void Add(::StringW name, ::StringW value) ;

/// @brief Method Add addr 0x283f49c size 0x2dc virtual false final false
 void Add(::StringW header) ;

/// @brief Method Set addr 0x283f778 size 0x230 virtual true final false
 void Set(::StringW name, ::StringW value) ;

/// @brief Method SetInternal addr 0x283f9a8 size 0x224 virtual false final false
 void SetInternal(::StringW name, ::StringW value) ;

/// @brief Method Remove addr 0x283fbcc size 0x13c virtual true final false
 void Remove(::StringW name) ;

/// @brief Method GetValues addr 0x283fd08 size 0x208 virtual true final false
 ::ArrayW<::StringW> GetValues(::StringW header) ;

/// @brief Method ToString addr 0x283ff10 size 0x5c virtual true final false
 ::StringW ToString() ;

/// @brief Method GetAsString addr 0x283ff6c size 0x2a4 virtual false final false
...
/// @brief Method .ctor addr 0x2840210 size 0x64 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2840274 size 0xe4 virtual false final false
...
/// @brief Method .ctor addr 0x2840358 size 0x1c4 virtual false final false
...
/// @brief Method OnDeserialization addr 0x284051c size 0x4 virtual true final false
 void OnDeserialization(::bs_hook::Il2CppWrapperType sender) ;

/// @brief Method GetObjectData addr 0x2840520 size 0x180 virtual true final false
 void GetObjectData(System::Runtime::Serialization::SerializationInfo serializationInfo, System::Runtime::Serialization::StreamingContext streamingContext) ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x28406a0 size 0xc virtual true final true
 void System_Runtime_Serialization_ISerializable_GetObjectData(System::Runtime::Serialization::SerializationInfo serializationInfo, System::Runtime::Serialization::StreamingContext streamingContext) ;

/// @brief Method Get addr 0x28406ac size 0x328 virtual true final false
 ::StringW Get(::StringW name) ;

/// @brief Method GetEnumerator addr 0x28409d4 size 0x7c virtual true final false
 System::Collections::IEnumerator GetEnumerator() ;

/// @brief Method get_Count addr 0x2840a50 size 0x30 virtual true final false
 int32_t get_Count() ;

/// @brief Method Get addr 0x2840a80 size 0x40 virtual true final false
 ::StringW Get(int32_t index) ;

/// @brief Method GetValues addr 0x2840ac0 size 0x40 virtual true final false
 ::ArrayW<::StringW> GetValues(int32_t index) ;

/// @brief Method GetKey addr 0x2840b00 size 0x40 virtual true final false
