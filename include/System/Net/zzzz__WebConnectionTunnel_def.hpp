...
/// @brief Method MoveNext addr 0x2880400 size 0xdd4 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x28811d4 size 0xc virtual true final true
...
/// @brief Method MoveNext addr 0x28811e0 size 0x7bc virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x288199c size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method get_Request addr 0x28801d4 size 0x8 virtual false final false
 System::Net::HttpWebRequest get_Request() ;

/// @brief Method get_ConnectUri addr 0x28801dc size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x287e930 size 0x2c virtual false final false
 void _ctor(System::Net::HttpWebRequest request, System::Uri connectUri) ;

/// @brief Method get_Success addr 0x28801e4 size 0x8 virtual false final false
 bool get_Success() ;

/// @brief Method set_Success addr 0x28801ec size 0xc virtual false final false
 void set_Success(bool value) ;

/// @brief Method get_CloseConnection addr 0x28801f8 size 0x8 virtual false final false
 bool get_CloseConnection() ;

/// @brief Method set_CloseConnection addr 0x2880200 size 0xc virtual false final false
 void set_CloseConnection(bool value) ;

/// @brief Method get_StatusCode addr 0x288020c size 0x8 virtual false final false
 int32_t get_StatusCode() ;

/// @brief Method set_StatusCode addr 0x2880214 size 0x8 virtual false final false
 void set_StatusCode(int32_t value) ;

/// @brief Method set_StatusDescription addr 0x288021c size 0x8 virtual false final false
 void set_StatusDescription(::StringW value) ;

/// @brief Method get_Challenge addr 0x2880224 size 0x8 virtual false final false
 ::ArrayW<::StringW> get_Challenge() ;

/// @brief Method set_Challenge addr 0x288022c size 0x8 virtual false final false
 void set_Challenge(::ArrayW<::StringW> value) ;

/// @brief Method get_Headers addr 0x2880234 size 0x8 virtual false final false
 System::Net::WebHeaderCollection get_Headers() ;

/// @brief Method set_Headers addr 0x288023c size 0x8 virtual false final false
 void set_Headers(System::Net::WebHeaderCollection value) ;

/// @brief Method get_ProxyVersion addr 0x2880244 size 0x8 virtual false final false
 System::Version get_ProxyVersion() ;

/// @brief Method set_ProxyVersion addr 0x288024c size 0x8 virtual false final false
 void set_ProxyVersion(System::Version value) ;

/// @brief Method get_Data addr 0x2880254 size 0x8 virtual false final false
 ::ArrayW<uint8_t> get_Data() ;

/// @brief Method set_Data addr 0x288025c size 0x8 virtual false final false
 void set_Data(::ArrayW<uint8_t> value) ;

/// @brief Method Initialize addr 0x287e95c size 0xe4 virtual false final false
 System::Threading::Tasks::Task Initialize(System::IO::Stream stream, System::Threading::CancellationToken cancellationToken) ;

/// @brief Method ReadHeaders addr 0x2880264 size 0x108 virtual false final false
...
/// @brief Method FlushContents addr 0x288036c size 0x94 virtual false final false
