...
namespace System::Net {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7931))}
...
/// @brief Method get_AddressFamily addr 0x282a100 size 0x2c virtual true final false
...
/// @brief Method .ctor addr 0x282a12c size 0xc0 virtual false final false
 void _ctor(System::Net::IPAddress address, int32_t port) ;

/// @brief Method get_Address addr 0x282a1f4 size 0x8 virtual false final false
 System::Net::IPAddress get_Address() ;

/// @brief Method get_Port addr 0x282a1fc size 0x8 virtual false final false
 int32_t get_Port() ;

/// @brief Method ToString addr 0x282a204 size 0xc0 virtual true final false
 ::StringW ToString() ;

/// @brief Method Serialize addr 0x282a2c4 size 0x70 virtual true final false
 System::Net::SocketAddress Serialize() ;

/// @brief Method Create addr 0x282a334 size 0x1f4 virtual true final false
 System::Net::EndPoint Create(System::Net::SocketAddress socketAddress) ;

/// @brief Method Equals addr 0x282a528 size 0xb4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType comparand) ;

/// @brief Method GetHashCode addr 0x282a5dc size 0x30 virtual true final false
 int32_t GetHashCode() ;
