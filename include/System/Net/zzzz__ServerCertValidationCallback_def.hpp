...
/// @brief Method .ctor addr 0x28595a8 size 0x44 virtual false final false
...
/// @brief Method .ctor addr 0x2859314 size 0x78 virtual false final false
 void _ctor(System::Net::Security::RemoteCertificateValidationCallback validationCallback) ;

/// @brief Method get_ValidationCallback addr 0x285938c size 0x8 virtual false final false
 System::Net::Security::RemoteCertificateValidationCallback get_ValidationCallback() ;

/// @brief Method Callback addr 0x2859394 size 0xac virtual false final false
 void Callback(::bs_hook::Il2CppWrapperType state) ;

/// @brief Method Invoke addr 0x2859440 size 0x168 virtual false final false
