...
/// @brief Method .ctor addr 0x284c118 size 0x78 virtual false final false
 void _ctor(::StringW cookieString) ;

/// @brief Method Get addr 0x284c190 size 0x55c virtual false final false
 System::Net::Cookie Get() ;

/// @brief Method CheckQuoted addr 0x284a7f8 size 0xc4 virtual false final false
