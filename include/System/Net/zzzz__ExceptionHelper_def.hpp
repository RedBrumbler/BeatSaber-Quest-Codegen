...
/// @brief Method get_MethodNotImplementedException addr 0x283c9fc size 0x88 virtual false final false
static System::NotImplementedException get_MethodNotImplementedException() ;

/// @brief Method get_PropertyNotImplementedException addr 0x283ca84 size 0x88 virtual false final false
static System::NotImplementedException get_PropertyNotImplementedException() ;

/// @brief Method get_TimeoutException addr 0x283cb0c size 0x80 virtual false final false
static System::Net::WebException get_TimeoutException() ;

/// @brief Method get_PropertyNotSupportedException addr 0x283cba0 size 0x88 virtual false final false
static System::NotSupportedException get_PropertyNotSupportedException() ;

/// @brief Method get_RequestAbortedException addr 0x283cc28 size 0x94 virtual false final false
