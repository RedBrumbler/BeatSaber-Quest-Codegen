...
/// @brief Method MakeStringNull addr 0x283c8bc size 0x14 virtual false final false
static ::StringW MakeStringNull(::StringW stringValue) ;

/// @brief Method IsBlankString addr 0x283c8d0 size 0x1c virtual false final false
static bool IsBlankString(::StringW stringValue) ;

/// @brief Method ValidateTcpPort addr 0x283c8ec size 0xc virtual false final false
