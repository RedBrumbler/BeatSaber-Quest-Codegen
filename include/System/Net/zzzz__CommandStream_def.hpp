...
/// @brief Method .ctor addr 0x282c68c size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x282c6b4 size 0x30 virtual false final false
 void _ctor(::StringW command, System::Net::System__Net__CommandStream__PipelineEntryFlags flags) ;

/// @brief Method HasFlag addr 0x282b350 size 0x10 virtual false final false
...
namespace System::Net {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7924))}
...
/// @brief Method .ctor addr 0x282a6e0 size 0x94 virtual false final false
 void _ctor(System::Net::Sockets::TcpClient client) ;

/// @brief Method Abort addr 0x282a7f8 size 0x1f8 virtual true final false
 void Abort(System::Exception e) ;

/// @brief Method Dispose addr 0x282aa20 size 0x94 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method InvokeRequestCallback addr 0x282aab4 size 0x70 virtual false final false
 void InvokeRequestCallback(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method get_RecoverableFailure addr 0x282ab34 size 0x8 virtual false final false
 bool get_RecoverableFailure() ;

/// @brief Method MarkAsRecoverableFailure addr 0x282ab3c size 0x18 virtual false final false
 void MarkAsRecoverableFailure() ;

/// @brief Method SubmitRequest addr 0x282ab54 size 0x80 virtual false final false
 System::IO::Stream SubmitRequest(System::Net::WebRequest request, bool isAsync, bool readInitalResponseOnConnect) ;

/// @brief Method ClearState addr 0x282b13c size 0x10 virtual true final false
 void ClearState() ;

/// @brief Method BuildCommandsList addr 0x282b14c size 0x8 virtual true final false
 ::ArrayW<System::Net::System__Net__CommandStream__PipelineEntry> BuildCommandsList(System::Net::WebRequest request) ;

/// @brief Method GenerateException addr 0x282b154 size 0x80 virtual false final false
 System::Exception GenerateException(::StringW message, System::Net::WebExceptionStatus status, System::Exception innerException) ;

/// @brief Method GenerateException addr 0x282b1d4 size 0xc8 virtual false final false
...
/// @brief Method InitCommandPipeline addr 0x282abd4 size 0x90 virtual false final false
...
/// @brief Method CheckContinuePipeline addr 0x282b29c size 0xb4 virtual false final false
 void CheckContinuePipeline() ;

/// @brief Method ContinueCommandPipeline addr 0x282ac64 size 0x4d8 virtual false final false
 System::IO::Stream ContinueCommandPipeline() ;

/// @brief Method PostSendCommandProcessing addr 0x282b360 size 0x130 virtual false final false
 bool PostSendCommandProcessing(ByRef<System::IO::Stream> stream) ;

/// @brief Method PostReadCommandProcessing addr 0x282b7b8 size 0x200 virtual false final false
 bool PostReadCommandProcessing(ByRef<System::IO::Stream> stream) ;

/// @brief Method PipelineCallback addr 0x282b9b8 size 0x8 virtual true final false
...
/// @brief Method ReadCallback addr 0x282b9c0 size 0x2d0 virtual false final false
static void ReadCallback(System::IAsyncResult asyncResult) ;

/// @brief Method WriteCallback addr 0x282c21c size 0x2b4 virtual false final false
static void WriteCallback(System::IAsyncResult asyncResult) ;

/// @brief Method get_Encoding addr 0x282c4d0 size 0x8 virtual false final false
 System::Text::Encoding get_Encoding() ;

/// @brief Method set_Encoding addr 0x282c4d8 size 0x38 virtual false final false
 void set_Encoding(System::Text::Encoding value) ;

/// @brief Method CheckValid addr 0x282c510 size 0x8 virtual true final false
 bool CheckValid(System::Net::ResponseDescription response, ByRef<int32_t> validThrough, ByRef<int32_t> completeLength) ;

/// @brief Method ReceiveCommandResponse addr 0x282b490 size 0x328 virtual false final false
 System::Net::ResponseDescription ReceiveCommandResponse() ;

/// @brief Method ReceiveCommandResponseCallback addr 0x282bcc8 size 0x554 virtual false final false
