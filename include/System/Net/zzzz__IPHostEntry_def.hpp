...
/// @brief Method get_HostName addr 0x283c1b8 size 0x8 virtual false final false
 ::StringW get_HostName() ;

/// @brief Method set_HostName addr 0x283c1c0 size 0x8 virtual false final false
 void set_HostName(::StringW value) ;

/// @brief Method set_Aliases addr 0x283c1c8 size 0x8 virtual false final false
 void set_Aliases(::ArrayW<::StringW> value) ;

/// @brief Method get_AddressList addr 0x283c1d0 size 0x8 virtual false final false
 ::ArrayW<System::Net::IPAddress> get_AddressList() ;

/// @brief Method set_AddressList addr 0x283c1d8 size 0x8 virtual false final false
 void set_AddressList(::ArrayW<System::Net::IPAddress> value) ;

// Ctor Parameters []
explicit IPHostEntry() ;

/// @brief Method .ctor addr 0x283c1e0 size 0x10 virtual false final false
 void _ctor() ;
