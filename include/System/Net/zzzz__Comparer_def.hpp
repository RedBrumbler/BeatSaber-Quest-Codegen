...
/// @brief Method System.Collections.IComparer.Compare addr 0x284c6ec size 0xdc virtual true final true
 int32_t System_Collections_IComparer_Compare(::bs_hook::Il2CppWrapperType ol, ::bs_hook::Il2CppWrapperType or) ;

// Ctor Parameters []
explicit Comparer() ;

/// @brief Method .ctor addr 0x284b6d8 size 0x8 virtual false final false
 void _ctor() ;
