...
/// @brief Method .ctor addr 0x2475970 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit NullReferenceException(::StringW message) ;

/// @brief Method .ctor addr 0x24759cc size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x24759f0 size 0x8 virtual false final false
