...
/// @brief Method .ctor addr 0x24cb2b0 size 0x10 virtual false final false
 void _ctor(int32_t dimensions, bool bound) ;

/// @brief Method Resolve addr 0x24cb2c0 size 0x64 virtual true final true
 System::Type Resolve(System::Type type) ;

/// @brief Method Append addr 0x24cb324 size 0xa0 virtual true final true
 System::Text::StringBuilder Append(System::Text::StringBuilder sb) ;

/// @brief Method ToString addr 0x24cb3c4 size 0x74 virtual true final false
 ::StringW ToString() ;
