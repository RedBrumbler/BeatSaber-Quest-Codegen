...
/// @brief Method .ctor addr 0x2484c48 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit RankException(::StringW message) ;

/// @brief Method .ctor addr 0x2484ca0 size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0x2484cc0 size 0x4 virtual false final false
