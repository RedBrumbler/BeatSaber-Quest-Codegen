...
/// @brief Method .ctor addr 0x248a354 size 0x6c virtual false final false
 void _ctor(bool ignoreCase) ;

/// @brief Method Compare addr 0x248a3c0 size 0x58 virtual true final false
 int32_t Compare(::StringW x, ::StringW y) ;

/// @brief Method Equals addr 0x248a418 size 0x80 virtual true final false
 bool Equals(::StringW x, ::StringW y) ;

/// @brief Method GetHashCode addr 0x248a498 size 0x88 virtual true final false
 int32_t GetHashCode(::StringW obj) ;

/// @brief Method Equals addr 0x248a520 size 0x98 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x248a5b8 size 0x64 virtual true final false
 int32_t GetHashCode() ;
