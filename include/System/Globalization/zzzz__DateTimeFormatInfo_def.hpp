...
/// @brief Method .ctor addr 0x2419c4c size 0x3c virtual false final false
...
/// @brief Method get_CultureName addr 0x24141ac size 0x2c virtual false final false
 ::StringW get_CultureName() ;

/// @brief Method get_Culture addr 0x24141d8 size 0x84 virtual false final false
 System::Globalization::CultureInfo get_Culture() ;

/// @brief Method get_LanguageName addr 0x241425c size 0x2c virtual false final false
 ::StringW get_LanguageName() ;

/// @brief Method internalGetAbbreviatedDayOfWeekNames addr 0x2414288 size 0x14 virtual false final false
 ::ArrayW<::StringW> internalGetAbbreviatedDayOfWeekNames() ;

/// @brief Method internalGetAbbreviatedDayOfWeekNamesCore addr 0x241429c size 0x4c virtual false final false
 ::ArrayW<::StringW> internalGetAbbreviatedDayOfWeekNamesCore() ;

/// @brief Method internalGetDayOfWeekNames addr 0x24142e8 size 0x14 virtual false final false
 ::ArrayW<::StringW> internalGetDayOfWeekNames() ;

/// @brief Method internalGetDayOfWeekNamesCore addr 0x24142fc size 0x4c virtual false final false
 ::ArrayW<::StringW> internalGetDayOfWeekNamesCore() ;

/// @brief Method internalGetAbbreviatedMonthNames addr 0x2414348 size 0x14 virtual false final false
 ::ArrayW<::StringW> internalGetAbbreviatedMonthNames() ;

/// @brief Method internalGetAbbreviatedMonthNamesCore addr 0x241435c size 0x4c virtual false final false
 ::ArrayW<::StringW> internalGetAbbreviatedMonthNamesCore() ;

/// @brief Method internalGetMonthNames addr 0x24143a8 size 0x14 virtual false final false
 ::ArrayW<::StringW> internalGetMonthNames() ;

/// @brief Method internalGetMonthNamesCore addr 0x24143bc size 0x4c virtual false final false
 ::ArrayW<::StringW> internalGetMonthNamesCore() ;

// Ctor Parameters []
explicit DateTimeFormatInfo() ;

/// @brief Method .ctor addr 0x2414408 size 0xd0 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x24146c4 size 0x44 virtual false final false
 void _ctor(System::Globalization::CultureData cultureData, System::Globalization::Calendar cal) ;

/// @brief Method InitializeOverridableProperties addr 0x24145a8 size 0x11c virtual false final false
 void InitializeOverridableProperties(System::Globalization::CultureData cultureData, int32_t calendarId) ;

/// @brief Method get_InvariantInfo addr 0x24149b4 size 0xd0 virtual false final false
static System::Globalization::DateTimeFormatInfo get_InvariantInfo() ;

/// @brief Method get_CurrentInfo addr 0x2414a84 size 0x10c virtual false final false
static System::Globalization::DateTimeFormatInfo get_CurrentInfo() ;

/// @brief Method GetInstance addr 0x2414b90 size 0x1c0 virtual false final false
static System::Globalization::DateTimeFormatInfo GetInstance(System::IFormatProvider provider) ;

/// @brief Method GetFormat addr 0x2414d50 size 0x98 virtual true final true
 ::bs_hook::Il2CppWrapperType GetFormat(System::Type formatType) ;

/// @brief Method Clone addr 0x2414de8 size 0x100 virtual true final true
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method get_AMDesignator addr 0x2414ee8 size 0x2c virtual false final false
 ::StringW get_AMDesignator() ;

/// @brief Method get_Calendar addr 0x2414f14 size 0x8 virtual false final false
 System::Globalization::Calendar get_Calendar() ;

/// @brief Method set_Calendar addr 0x2414708 size 0x2ac virtual false final false
 void set_Calendar(System::Globalization::Calendar value) ;

/// @brief Method get_OptionalCalendars addr 0x2414fc0 size 0x30 virtual false final false
 ::ArrayW<System::Globalization::CalendarId> get_OptionalCalendars() ;

/// @brief Method get_EraNames addr 0x2415000 size 0x54 virtual false final false
 ::ArrayW<::StringW> get_EraNames() ;

/// @brief Method GetEraName addr 0x2415054 size 0xdc virtual false final false
 ::StringW GetEraName(int32_t era) ;

/// @brief Method get_AbbreviatedEraNames addr 0x2415130 size 0x54 virtual false final false
 ::ArrayW<::StringW> get_AbbreviatedEraNames() ;

/// @brief Method GetAbbreviatedEraName addr 0x2415184 size 0xec virtual false final false
 ::StringW GetAbbreviatedEraName(int32_t era) ;

/// @brief Method get_AbbreviatedEnglishEraNames addr 0x2415270 size 0x54 virtual false final false
 ::ArrayW<::StringW> get_AbbreviatedEnglishEraNames() ;

/// @brief Method get_DateSeparator addr 0x24152c4 size 0x54 virtual false final false
 ::StringW get_DateSeparator() ;

/// @brief Method get_FullDateTimePattern addr 0x2415318 size 0x74 virtual false final false
 ::StringW get_FullDateTimePattern() ;

/// @brief Method get_LongDatePattern addr 0x241538c size 0x3c virtual false final false
 ::StringW get_LongDatePattern() ;

/// @brief Method get_LongTimePattern addr 0x24153c8 size 0x3c virtual false final false
 ::StringW get_LongTimePattern() ;

/// @brief Method get_MonthDayPattern addr 0x2415488 size 0x54 virtual false final false
 ::StringW get_MonthDayPattern() ;

/// @brief Method get_PMDesignator addr 0x24154dc size 0x2c virtual false final false
 ::StringW get_PMDesignator() ;

/// @brief Method get_RFC1123Pattern addr 0x2415508 size 0x40 virtual false final false
 ::StringW get_RFC1123Pattern() ;

/// @brief Method get_ShortDatePattern addr 0x2415548 size 0x3c virtual false final false
 ::StringW get_ShortDatePattern() ;

/// @brief Method get_ShortTimePattern addr 0x24155d8 size 0x3c virtual false final false
 ::StringW get_ShortTimePattern() ;

/// @brief Method get_SortableDateTimePattern addr 0x2415644 size 0x40 virtual false final false
 ::StringW get_SortableDateTimePattern() ;

/// @brief Method get_GeneralShortTimePattern addr 0x2415684 size 0x74 virtual false final false
 ::StringW get_GeneralShortTimePattern() ;

/// @brief Method get_GeneralLongTimePattern addr 0x24156f8 size 0x74 virtual false final false
 ::StringW get_GeneralLongTimePattern() ;

/// @brief Method get_DateTimeOffsetPattern addr 0x241576c size 0x19c virtual false final false
 ::StringW get_DateTimeOffsetPattern() ;

/// @brief Method get_TimeSeparator addr 0x2415908 size 0x2c virtual false final false
 ::StringW get_TimeSeparator() ;

/// @brief Method get_UniversalSortableDateTimePattern addr 0x2415934 size 0x40 virtual false final false
 ::StringW get_UniversalSortableDateTimePattern() ;

/// @brief Method get_YearMonthPattern addr 0x2415974 size 0x3c virtual false final false
 ::StringW get_YearMonthPattern() ;

/// @brief Method get_AbbreviatedDayNames addr 0x2415a04 size 0x84 virtual false final false
 ::ArrayW<::StringW> get_AbbreviatedDayNames() ;

/// @brief Method get_DayNames addr 0x2415a88 size 0x84 virtual false final false
 ::ArrayW<::StringW> get_DayNames() ;

/// @brief Method get_AbbreviatedMonthNames addr 0x2415b0c size 0x84 virtual false final false
 ::ArrayW<::StringW> get_AbbreviatedMonthNames() ;

/// @brief Method get_MonthNames addr 0x2415b90 size 0x84 virtual false final false
 ::ArrayW<::StringW> get_MonthNames() ;

/// @brief Method get_HasSpacesInMonthNames addr 0x2415c14 size 0x28 virtual false final false
 bool get_HasSpacesInMonthNames() ;

/// @brief Method get_HasSpacesInDayNames addr 0x2415c54 size 0x28 virtual false final false
 bool get_HasSpacesInDayNames() ;

/// @brief Method internalGetMonthName addr 0x2415c7c size 0x16c virtual false final false
 ::StringW internalGetMonthName(int32_t month, System::Globalization::MonthNameStyles style, bool abbreviated) ;

/// @brief Method internalGetGenitiveMonthNames addr 0x2415de8 size 0x94 virtual false final false
 ::ArrayW<::StringW> internalGetGenitiveMonthNames(bool abbreviated) ;

/// @brief Method internalGetLeapYearMonthNames addr 0x2415e7c size 0x54 virtual false final false
 ::ArrayW<::StringW> internalGetLeapYearMonthNames() ;

/// @brief Method GetAbbreviatedDayName addr 0x2415ed0 size 0x100 virtual false final false
 ::StringW GetAbbreviatedDayName(System::DayOfWeek dayofweek) ;

/// @brief Method GetCombinedPatterns addr 0x2415fd0 size 0x16c virtual false final false
static ::ArrayW<::StringW> GetCombinedPatterns(::ArrayW<::StringW> patterns1, ::ArrayW<::StringW> patterns2, ::StringW connectString) ;

/// @brief Method GetAllDateTimePatterns addr 0x241613c size 0x37c virtual false final false
 ::ArrayW<::StringW> GetAllDateTimePatterns(char16_t format) ;

/// @brief Method GetDayName addr 0x24166fc size 0x100 virtual false final false
 ::StringW GetDayName(System::DayOfWeek dayofweek) ;

/// @brief Method GetAbbreviatedMonthName addr 0x24167fc size 0x104 virtual false final false
 ::StringW GetAbbreviatedMonthName(int32_t month) ;

/// @brief Method GetMonthName addr 0x2416900 size 0x104 virtual false final false
 ::StringW GetMonthName(int32_t month) ;

/// @brief Method GetMergedPatterns addr 0x2416a04 size 0x1e4 virtual false final false
static ::ArrayW<::StringW> GetMergedPatterns(::ArrayW<::StringW> patterns, ::StringW defaultPattern) ;

/// @brief Method get_AllYearMonthPatterns addr 0x2416688 size 0x74 virtual false final false
 ::ArrayW<::StringW> get_AllYearMonthPatterns() ;

/// @brief Method get_AllShortDatePatterns addr 0x24164b8 size 0x74 virtual false final false
 ::ArrayW<::StringW> get_AllShortDatePatterns() ;

/// @brief Method get_AllShortTimePatterns addr 0x24165a0 size 0x74 virtual false final false
 ::ArrayW<::StringW> get_AllShortTimePatterns() ;

/// @brief Method get_AllLongDatePatterns addr 0x241652c size 0x74 virtual false final false
 ::ArrayW<::StringW> get_AllLongDatePatterns() ;

/// @brief Method get_AllLongTimePatterns addr 0x2416614 size 0x74 virtual false final false
 ::ArrayW<::StringW> get_AllLongTimePatterns() ;

/// @brief Method get_UnclonedYearMonthPatterns addr 0x24159b0 size 0x54 virtual false final false
 ::ArrayW<::StringW> get_UnclonedYearMonthPatterns() ;

/// @brief Method get_UnclonedShortDatePatterns addr 0x2415584 size 0x54 virtual false final false
 ::ArrayW<::StringW> get_UnclonedShortDatePatterns() ;

/// @brief Method get_UnclonedLongDatePatterns addr 0x2415404 size 0x54 virtual false final false
 ::ArrayW<::StringW> get_UnclonedLongDatePatterns() ;

/// @brief Method get_UnclonedShortTimePatterns addr 0x2415614 size 0x30 virtual false final false
 ::ArrayW<::StringW> get_UnclonedShortTimePatterns() ;

/// @brief Method get_UnclonedLongTimePatterns addr 0x2415458 size 0x30 virtual false final false
 ::ArrayW<::StringW> get_UnclonedLongTimePatterns() ;

/// @brief Method get_IsReadOnly addr 0x2414f1c size 0xa4 virtual false final false
 bool get_IsReadOnly() ;

/// @brief Method get_MonthGenitiveNames addr 0x2416be8 size 0x80 virtual false final false
 ::ArrayW<::StringW> get_MonthGenitiveNames() ;

/// @brief Method get_FullTimeSpanPositivePattern addr 0x2416c68 size 0xd4 virtual false final false
 ::StringW get_FullTimeSpanPositivePattern() ;

/// @brief Method get_FullTimeSpanNegativePattern addr 0x2416d3c size 0x68 virtual false final false
 ::StringW get_FullTimeSpanNegativePattern() ;

/// @brief Method get_CompareInfo addr 0x2416da4 size 0x84 virtual false final false
 System::Globalization::CompareInfo get_CompareInfo() ;

/// @brief Method ValidateStyles addr 0x2416e28 size 0xd8 virtual false final false
static void ValidateStyles(System::Globalization::DateTimeStyles style, ::StringW parameterName) ;

/// @brief Method get_FormatFlags addr 0x2415c3c size 0x18 virtual false final false
 System::Globalization::DateTimeFormatFlags get_FormatFlags() ;

/// @brief Method InitializeFormatFlags addr 0x2416f00 size 0x13c virtual false final false
 System::Globalization::DateTimeFormatFlags InitializeFormatFlags() ;

/// @brief Method get_HasForceTwoDigitYears addr 0x2417160 size 0x34 virtual false final false
 bool get_HasForceTwoDigitYears() ;

/// @brief Method get_HasYearMonthAdjustment addr 0x2417194 size 0x28 virtual false final false
 bool get_HasYearMonthAdjustment() ;

/// @brief Method YearMonthAdjustment addr 0x24171bc size 0x134 virtual false final false
 bool YearMonthAdjustment(ByRef<int32_t> year, ByRef<int32_t> month, bool parsedMonthName) ;

/// @brief Method GetJapaneseCalendarDTFI addr 0x24172f0 size 0x194 virtual false final false
static System::Globalization::DateTimeFormatInfo GetJapaneseCalendarDTFI() ;

/// @brief Method GetTaiwanCalendarDTFI addr 0x2417484 size 0x194 virtual false final false
static System::Globalization::DateTimeFormatInfo GetTaiwanCalendarDTFI() ;

/// @brief Method ClearTokenHashTable addr 0x2414ff0 size 0x10 virtual false final false
 void ClearTokenHashTable() ;

/// @brief Method CreateTokenHashTable addr 0x2417618 size 0x8f0 virtual false final false
 ::ArrayW<System::Globalization::System__Globalization__DateTimeFormatInfo__TokenHashValue> CreateTokenHashTable() ;

/// @brief Method PopulateSpecialTokenHashTable addr 0x2418204 size 0x8dc virtual false final false
...
/// @brief Method IsJapaneseCalendar addr 0x2418ec8 size 0x13c virtual false final false
static bool IsJapaneseCalendar(System::Globalization::Calendar calendar) ;

/// @brief Method AddMonthNames addr 0x2418ae0 size 0xac virtual false final false
...
/// @brief Method TryParseHebrewNumber addr 0x2419004 size 0x134 virtual false final false
static bool TryParseHebrewNumber(ByRef<System::__DTString> str, ByRef<bool> badFormat, ByRef<int32_t> number) ;

/// @brief Method IsHebrewChar addr 0x24193a4 size 0x14 virtual false final false
static bool IsHebrewChar(char16_t ch) ;

/// @brief Method IsAllowedJapaneseTokenFollowedByNonSpaceLetter addr 0x24193b8 size 0x108 virtual false final false
 bool IsAllowedJapaneseTokenFollowedByNonSpaceLetter(::StringW tokenString, char16_t nextCh) ;

/// @brief Method Tokenize addr 0x24194c0 size 0x5cc virtual false final false
...
/// @brief Method InsertAtCurrentHashNode addr 0x2419a8c size 0x1c0 virtual false final false
...
/// @brief Method InsertHash addr 0x2417f08 size 0x2fc virtual false final false
...
/// @brief Method CompareStringIgnoreCaseOptimized addr 0x2419c88 size 0xf4 virtual false final false
