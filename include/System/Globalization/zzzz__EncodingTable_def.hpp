...
/// @brief Method GetNumEncodingItems addr 0x2432e58 size 0x64 virtual false final false
static int32_t GetNumEncodingItems() ;

/// @brief Method ENC addr 0x2432ebc size 0x8 virtual false final false
static System::Globalization::InternalEncodingDataItem ENC(::StringW name, uint16_t cp) ;

/// @brief Method MapCodePageDataItem addr 0x2432ec4 size 0x14 virtual false final false
...
/// @brief Method internalGetCodePageFromName addr 0x2438390 size 0x254 virtual false final false
static int32_t internalGetCodePageFromName(::StringW name) ;

/// @brief Method GetCodePageFromName addr 0x24385e4 size 0x284 virtual false final false
static int32_t GetCodePageFromName(::StringW name) ;

/// @brief Method GetCodePageDataItem addr 0x2438868 size 0x2e8 virtual false final false
