...
/// @brief Method get_MinSupportedDateTime addr 0x2429cc0 size 0x58 virtual true final false
 System::DateTime get_MinSupportedDateTime() ;

/// @brief Method get_MaxSupportedDateTime addr 0x2429d18 size 0x58 virtual true final false
 System::DateTime get_MaxSupportedDateTime() ;

// Ctor Parameters []
explicit HijriCalendar() ;

/// @brief Method .ctor addr 0x2429d70 size 0x10 virtual false final false
 void _ctor() ;

/// @brief Method get_ID addr 0x2429d80 size 0x8 virtual true final false
 int32_t get_ID() ;

/// @brief Method GetAbsoluteDateHijri addr 0x2429d88 size 0xc8 virtual false final false
 int64_t GetAbsoluteDateHijri(int32_t y, int32_t m, int32_t d) ;

/// @brief Method DaysUpToHijriYear addr 0x2429e50 size 0xbc virtual false final false
 int64_t DaysUpToHijriYear(int32_t HijriYear) ;

/// @brief Method get_HijriAdjustment addr 0x2429f0c size 0x68 virtual false final false
 int32_t get_HijriAdjustment() ;

/// @brief Method GetAdvanceHijriDate addr 0x2429f74 size 0x8 virtual false final false
static int32_t GetAdvanceHijriDate() ;

/// @brief Method CheckTicksRange addr 0x2429f7c size 0x1ac virtual false final false
static void CheckTicksRange(int64_t ticks) ;

/// @brief Method CheckEraRange addr 0x242a188 size 0xd0 virtual false final false
static void CheckEraRange(int32_t era) ;

/// @brief Method CheckYearRange addr 0x242a258 size 0x154 virtual false final false
static void CheckYearRange(int32_t year, int32_t era) ;

/// @brief Method CheckYearMonthRange addr 0x242a3cc size 0x184 virtual false final false
static void CheckYearMonthRange(int32_t year, int32_t month, int32_t era) ;

/// @brief Method GetDatePart addr 0x242a550 size 0x270 virtual true final false
 int32_t GetDatePart(int64_t ticks, int32_t part) ;

/// @brief Method GetDayOfMonth addr 0x242a7c0 size 0x44 virtual true final false
 int32_t GetDayOfMonth(System::DateTime time) ;

/// @brief Method GetDayOfWeek addr 0x242a804 size 0x68 virtual true final false
 System::DayOfWeek GetDayOfWeek(System::DateTime time) ;

/// @brief Method GetDaysInMonth addr 0x242a86c size 0xcc virtual true final false
 int32_t GetDaysInMonth(int32_t year, int32_t month, int32_t era) ;

/// @brief Method GetDaysInYear addr 0x242a938 size 0x94 virtual true final false
 int32_t GetDaysInYear(int32_t year, int32_t era) ;

/// @brief Method GetEra addr 0x242a9cc size 0x78 virtual true final false
 int32_t GetEra(System::DateTime time) ;

/// @brief Method get_Eras addr 0x242aa44 size 0x9c virtual true final false
 ::ArrayW<int32_t> get_Eras() ;

/// @brief Method GetMonth addr 0x242aae0 size 0x44 virtual true final false
 int32_t GetMonth(System::DateTime time) ;

/// @brief Method GetMonthsInYear addr 0x242ab24 size 0x6c virtual true final false
 int32_t GetMonthsInYear(int32_t year, int32_t era) ;

/// @brief Method GetYear addr 0x242ab90 size 0x44 virtual true final false
 int32_t GetYear(System::DateTime time) ;

/// @brief Method IsLeapYear addr 0x242abd4 size 0xa0 virtual true final false
 bool IsLeapYear(int32_t year, int32_t era) ;

/// @brief Method ToDateTime addr 0x242ac74 size 0x1e0 virtual true final false
...
/// @brief Method get_TwoDigitYearMax addr 0x242ae54 size 0x3c virtual true final false
 int32_t get_TwoDigitYearMax() ;

/// @brief Method set_TwoDigitYearMax addr 0x242ae90 size 0x118 virtual true final false
 void set_TwoDigitYearMax(int32_t value) ;

/// @brief Method ToFourDigitYear addr 0x242afa8 size 0x13c virtual true final false
