...
/// @brief Method .ctor addr 0x242c04c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method OnSerializing addr 0x242c5a8 size 0x84 virtual false final false
 void OnSerializing(System::Runtime::Serialization::StreamingContext ctx) ;

/// @brief Method OnDeserializing addr 0x242c62c size 0x4 virtual false final false
 void OnDeserializing(System::Runtime::Serialization::StreamingContext ctx) ;

/// @brief Method OnDeserialized addr 0x242c630 size 0x4 virtual false final false
 void OnDeserialized(System::Runtime::Serialization::StreamingContext ctx) ;

/// @brief Method VerifyGroupSeparator addr 0x242c634 size 0x70 virtual false final false
...
/// @brief Method .ctor addr 0x242c054 size 0x554 virtual false final false
 void _ctor(System::Globalization::CultureData cultureData) ;

/// @brief Method VerifyWritable addr 0x242c848 size 0x74 virtual false final false
 void VerifyWritable() ;

/// @brief Method get_InvariantInfo addr 0x242c8bc size 0xa4 virtual false final false
static System::Globalization::NumberFormatInfo get_InvariantInfo() ;

/// @brief Method GetInstance addr 0x242ca34 size 0x1bc virtual false final false
static System::Globalization::NumberFormatInfo GetInstance(System::IFormatProvider formatProvider) ;

/// @brief Method Clone addr 0x242cce4 size 0x6c virtual true final true
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method get_CurrencyDecimalDigits addr 0x242cd50 size 0x8 virtual false final false
 int32_t get_CurrencyDecimalDigits() ;

/// @brief Method get_CurrencyDecimalSeparator addr 0x242cd58 size 0x8 virtual false final false
 ::StringW get_CurrencyDecimalSeparator() ;

/// @brief Method get_IsReadOnly addr 0x242cd60 size 0x8 virtual false final false
 bool get_IsReadOnly() ;

/// @brief Method get_CurrencyGroupSizes addr 0x242cd68 size 0x78 virtual false final false
 ::ArrayW<int32_t> get_CurrencyGroupSizes() ;

/// @brief Method get_NumberGroupSizes addr 0x242cde0 size 0x78 virtual false final false
 ::ArrayW<int32_t> get_NumberGroupSizes() ;

/// @brief Method get_PercentGroupSizes addr 0x242ce58 size 0x78 virtual false final false
 ::ArrayW<int32_t> get_PercentGroupSizes() ;

/// @brief Method get_CurrencyGroupSeparator addr 0x242ced0 size 0x8 virtual false final false
 ::StringW get_CurrencyGroupSeparator() ;

/// @brief Method get_CurrencySymbol addr 0x242ced8 size 0x8 virtual false final false
 ::StringW get_CurrencySymbol() ;

/// @brief Method get_CurrentInfo addr 0x242cbf0 size 0xf4 virtual false final false
static System::Globalization::NumberFormatInfo get_CurrentInfo() ;

/// @brief Method get_NaNSymbol addr 0x242cee0 size 0x8 virtual false final false
 ::StringW get_NaNSymbol() ;

/// @brief Method set_NaNSymbol addr 0x242cee8 size 0x90 virtual false final false
 void set_NaNSymbol(::StringW value) ;

/// @brief Method get_CurrencyNegativePattern addr 0x242cf78 size 0x8 virtual false final false
 int32_t get_CurrencyNegativePattern() ;

/// @brief Method get_NumberNegativePattern addr 0x242cf80 size 0x8 virtual false final false
 int32_t get_NumberNegativePattern() ;

/// @brief Method get_PercentPositivePattern addr 0x242cf88 size 0x8 virtual false final false
 int32_t get_PercentPositivePattern() ;

/// @brief Method get_PercentNegativePattern addr 0x242cf90 size 0x8 virtual false final false
 int32_t get_PercentNegativePattern() ;

/// @brief Method get_NegativeInfinitySymbol addr 0x242cf98 size 0x8 virtual false final false
 ::StringW get_NegativeInfinitySymbol() ;

/// @brief Method get_NegativeSign addr 0x242cfa0 size 0x8 virtual false final false
 ::StringW get_NegativeSign() ;

/// @brief Method get_NumberDecimalDigits addr 0x242cfa8 size 0x8 virtual false final false
 int32_t get_NumberDecimalDigits() ;

/// @brief Method get_NumberDecimalSeparator addr 0x242cfb0 size 0x8 virtual false final false
 ::StringW get_NumberDecimalSeparator() ;

/// @brief Method get_NumberGroupSeparator addr 0x242cfb8 size 0x8 virtual false final false
 ::StringW get_NumberGroupSeparator() ;

/// @brief Method set_NumberGroupSeparator addr 0x242cfc0 size 0x64 virtual false final false
 void set_NumberGroupSeparator(::StringW value) ;

/// @brief Method get_CurrencyPositivePattern addr 0x242d024 size 0x8 virtual false final false
 int32_t get_CurrencyPositivePattern() ;

/// @brief Method get_PositiveInfinitySymbol addr 0x242d02c size 0x8 virtual false final false
 ::StringW get_PositiveInfinitySymbol() ;

/// @brief Method get_PositiveSign addr 0x242d034 size 0x8 virtual false final false
 ::StringW get_PositiveSign() ;

/// @brief Method get_PercentDecimalDigits addr 0x242d03c size 0x8 virtual false final false
 int32_t get_PercentDecimalDigits() ;

/// @brief Method get_PercentDecimalSeparator addr 0x242d044 size 0x8 virtual false final false
 ::StringW get_PercentDecimalSeparator() ;

/// @brief Method get_PercentGroupSeparator addr 0x242d04c size 0x8 virtual false final false
 ::StringW get_PercentGroupSeparator() ;

/// @brief Method get_PercentSymbol addr 0x242d054 size 0x8 virtual false final false
 ::StringW get_PercentSymbol() ;

/// @brief Method get_PerMilleSymbol addr 0x242d05c size 0x8 virtual false final false
 ::StringW get_PerMilleSymbol() ;

/// @brief Method GetFormat addr 0x242d064 size 0x98 virtual true final true
 ::bs_hook::Il2CppWrapperType GetFormat(System::Type formatType) ;

/// @brief Method ReadOnly addr 0x242c960 size 0xd4 virtual false final false
static System::Globalization::NumberFormatInfo ReadOnly(System::Globalization::NumberFormatInfo nfi) ;

/// @brief Method ValidateParseStyleInteger addr 0x242d0fc size 0xd8 virtual false final false
static void ValidateParseStyleInteger(System::Globalization::NumberStyles style) ;

/// @brief Method ValidateParseStyleFloatingPoint addr 0x242d1d4 size 0xcc virtual false final false
