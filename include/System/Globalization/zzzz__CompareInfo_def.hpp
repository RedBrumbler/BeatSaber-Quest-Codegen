...
/// @brief Method InvariantIndexOf addr 0x240f6dc size 0xc4 virtual false final false
static int32_t InvariantIndexOf(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase) ;

/// @brief Method InvariantLastIndexOf addr 0x240facc size 0xcc virtual false final false
static int32_t InvariantLastIndexOf(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase) ;

/// @brief Method InvariantFindString addr 0x240f7a0 size 0x32c virtual false final false
...
/// @brief Method InvariantToUpper addr 0x240fb98 size 0x18 virtual false final false
static char16_t InvariantToUpper(char16_t c) ;

/// @brief Method InvariantCreateSortKey addr 0x240fbb0 size 0x29c virtual false final false
...
/// @brief Method .ctor addr 0x240fe4c size 0x34 virtual false final false
 void _ctor(System::Globalization::CultureInfo culture) ;

/// @brief Method GetCompareInfo addr 0x240fe9c size 0xbc virtual false final false
static System::Globalization::CompareInfo GetCompareInfo(::StringW name) ;

/// @brief Method OnDeserializing addr 0x240ff58 size 0x8 virtual false final false
 void OnDeserializing(System::Runtime::Serialization::StreamingContext ctx) ;

/// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization addr 0x240ff60 size 0x4 virtual true final true
 void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::bs_hook::Il2CppWrapperType sender) ;

/// @brief Method OnDeserialized addr 0x2410008 size 0x4 virtual false final false
 void OnDeserialized(System::Runtime::Serialization::StreamingContext ctx) ;

/// @brief Method OnDeserialized addr 0x240ff64 size 0xa4 virtual false final false
 void OnDeserialized() ;

/// @brief Method OnSerializing addr 0x241000c size 0x8c virtual false final false
 void OnSerializing(System::Runtime::Serialization::StreamingContext ctx) ;

/// @brief Method get_Name addr 0x2410098 size 0x8c virtual true final false
 ::StringW get_Name() ;

/// @brief Method Compare addr 0x2410124 size 0x10 virtual true final false
 int32_t Compare(::StringW string1, ::StringW string2) ;

/// @brief Method Compare addr 0x2410134 size 0x2a8 virtual true final false
 int32_t Compare(::StringW string1, ::StringW string2, System::Globalization::CompareOptions options) ;

/// @brief Method Compare addr 0x24106cc size 0x3a0 virtual false final false
 int32_t Compare(System::ReadOnlySpan_1<char16_t> string1, ::StringW string2, System::Globalization::CompareOptions options) ;

/// @brief Method CompareOptionIgnoreCase addr 0x2410ad0 size 0x13c virtual false final false
 int32_t CompareOptionIgnoreCase(System::ReadOnlySpan_1<char16_t> string1, System::ReadOnlySpan_1<char16_t> string2) ;

/// @brief Method Compare addr 0x2410cfc size 0x560 virtual true final false
...
/// @brief Method CompareOrdinalIgnoreCase addr 0x241125c size 0x174 virtual false final false
...
/// @brief Method CompareOrdinalIgnoreCase addr 0x24103dc size 0x1f4 virtual false final false
static int32_t CompareOrdinalIgnoreCase(System::ReadOnlySpan_1<char16_t> strA, System::ReadOnlySpan_1<char16_t> strB) ;

/// @brief Method IsPrefix addr 0x2411530 size 0x224 virtual true final false
 bool IsPrefix(::StringW source, ::StringW prefix, System::Globalization::CompareOptions options) ;

/// @brief Method IsSuffix addr 0x24118c8 size 0x224 virtual true final false
 bool IsSuffix(::StringW source, ::StringW suffix, System::Globalization::CompareOptions options) ;

/// @brief Method IsSuffix addr 0x2411c5c size 0x4 virtual false final false
...
/// @brief Method IndexOf addr 0x2411cc0 size 0x70 virtual true final false
 int32_t IndexOf(::StringW source, ::StringW value, System::Globalization::CompareOptions options) ;

/// @brief Method IndexOf addr 0x2411d30 size 0x2c4 virtual true final false
...
/// @brief Method IndexOfOrdinal addr 0x2411ff4 size 0x100 virtual false final false
 int32_t IndexOfOrdinal(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase) ;

/// @brief Method LastIndexOf addr 0x2412170 size 0x74 virtual true final false
 int32_t LastIndexOf(::StringW source, ::StringW value, System::Globalization::CompareOptions options) ;

/// @brief Method LastIndexOf addr 0x24121e4 size 0x35c virtual true final false
...
/// @brief Method LastIndexOfOrdinal addr 0x2412540 size 0x100 virtual false final false
 int32_t LastIndexOfOrdinal(::StringW source, ::StringW value, int32_t startIndex, int32_t count, bool ignoreCase) ;

/// @brief Method GetSortKey addr 0x2412678 size 0xc8 virtual true final false
 System::Globalization::SortKey GetSortKey(::StringW source, System::Globalization::CompareOptions options) ;

/// @brief Method Equals addr 0x2412800 size 0xc0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetHashCode addr 0x24128c0 size 0x28 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method GetIgnoreCaseHash addr 0x24128e8 size 0x47c virtual false final false
static int32_t GetIgnoreCaseHash(::StringW source) ;

/// @brief Method GetHashCodeOfString addr 0x2412d64 size 0x1a8 virtual false final false
 int32_t GetHashCodeOfString(::StringW source, System::Globalization::CompareOptions options) ;

/// @brief Method GetHashCode addr 0x2412f38 size 0x104 virtual true final false
 int32_t GetHashCode(::StringW source, System::Globalization::CompareOptions options) ;

/// @brief Method ToString addr 0x241303c size 0x60 virtual true final false
 ::StringW ToString() ;

/// @brief Method get_UseManagedCollation addr 0x241309c size 0x144 virtual false final false
static bool get_UseManagedCollation() ;

/// @brief Method GetCollator addr 0x24131e0 size 0x334 virtual false final false
 System::Globalization::ISimpleCollator GetCollator() ;

/// @brief Method CreateSortKeyCore addr 0x2413514 size 0x13c virtual false final false
 System::Globalization::SortKey CreateSortKeyCore(::StringW source, System::Globalization::CompareOptions options) ;

/// @brief Method internal_index_switch addr 0x2413650 size 0x13c virtual false final false
...
/// @brief Method internal_compare_switch addr 0x24105d0 size 0xfc virtual false final false
...
/// @brief Method internal_compare_managed addr 0x2413a20 size 0x100 virtual false final false
...
/// @brief Method internal_index_managed addr 0x2413840 size 0x12c virtual false final false
...
/// @brief Method internal_compare_icall addr 0x2413b20 size 0x4 virtual false final false
...
/// @brief Method internal_compare addr 0x241396c size 0xb4 virtual false final false
...
/// @brief Method IndexOfCore addr 0x24120f4 size 0x5c virtual false final false
...
/// @brief Method CompareString addr 0x2410a6c size 0x64 virtual false final false
 int32_t CompareString(System::ReadOnlySpan_1<char16_t> string1, ::StringW string2, System::Globalization::CompareOptions options) ;

/// @brief Method CompareString addr 0x2410c0c size 0xf0 virtual false final false
...
/// @brief Method CreateSortKey addr 0x2412740 size 0xc0 virtual false final false
 System::Globalization::SortKey CreateSortKey(::StringW source, System::Globalization::CompareOptions options) ;

/// @brief Method StartsWith addr 0x2411754 size 0x174 virtual false final false
 bool StartsWith(::StringW source, ::StringW prefix, System::Globalization::CompareOptions options) ;

/// @brief Method EndsWith addr 0x2411aec size 0x170 virtual false final false
 bool EndsWith(::StringW source, ::StringW suffix, System::Globalization::CompareOptions options) ;

/// @brief Method EndsWith addr 0x2411c60 size 0x60 virtual false final false
...
/// @brief Method GetHashCodeOfStringCore addr 0x2412f0c size 0x2c virtual false final false
 int32_t GetHashCodeOfStringCore(::StringW source, System::Globalization::CompareOptions options) ;

// Ctor Parameters []
explicit CompareInfo() ;

/// @brief Method .ctor addr 0x2413bb4 size 0x38 virtual false final false
 void _ctor() ;
