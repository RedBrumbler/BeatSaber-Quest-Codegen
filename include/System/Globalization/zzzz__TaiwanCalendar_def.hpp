...
/// @brief Method GetDefaultInstance addr 0x242d2a0 size 0xb8 virtual false final false
static System::Globalization::Calendar GetDefaultInstance() ;

/// @brief Method get_MinSupportedDateTime addr 0x242d524 size 0x58 virtual true final false
 System::DateTime get_MinSupportedDateTime() ;

/// @brief Method get_MaxSupportedDateTime addr 0x242d57c size 0x58 virtual true final false
 System::DateTime get_MaxSupportedDateTime() ;

// Ctor Parameters []
explicit TaiwanCalendar() ;

/// @brief Method .ctor addr 0x242d358 size 0x1cc virtual false final false
 void _ctor() ;

/// @brief Method get_ID addr 0x242d5d4 size 0x8 virtual true final false
 int32_t get_ID() ;

/// @brief Method GetDaysInMonth addr 0x242d5dc size 0x1c virtual true final false
 int32_t GetDaysInMonth(int32_t year, int32_t month, int32_t era) ;

/// @brief Method GetDaysInYear addr 0x242d5f8 size 0x1c virtual true final false
 int32_t GetDaysInYear(int32_t year, int32_t era) ;

/// @brief Method GetDayOfMonth addr 0x242d614 size 0x1c virtual true final false
 int32_t GetDayOfMonth(System::DateTime time) ;

/// @brief Method GetDayOfWeek addr 0x242d630 size 0x1c virtual true final false
 System::DayOfWeek GetDayOfWeek(System::DateTime time) ;

/// @brief Method GetMonthsInYear addr 0x242d64c size 0x1c virtual true final false
 int32_t GetMonthsInYear(int32_t year, int32_t era) ;

/// @brief Method GetEra addr 0x242d668 size 0x1c virtual true final false
 int32_t GetEra(System::DateTime time) ;

/// @brief Method GetMonth addr 0x242d684 size 0x1c virtual true final false
 int32_t GetMonth(System::DateTime time) ;

/// @brief Method GetYear addr 0x242d6a0 size 0x1c virtual true final false
 int32_t GetYear(System::DateTime time) ;

/// @brief Method IsLeapYear addr 0x242d6bc size 0x1c virtual true final false
 bool IsLeapYear(int32_t year, int32_t era) ;

/// @brief Method ToDateTime addr 0x242d6d8 size 0x24 virtual true final false
...
/// @brief Method get_Eras addr 0x242d6fc size 0x1c virtual true final false
 ::ArrayW<int32_t> get_Eras() ;

/// @brief Method get_TwoDigitYearMax addr 0x242d718 size 0x3c virtual true final false
 int32_t get_TwoDigitYearMax() ;

/// @brief Method set_TwoDigitYearMax addr 0x242d754 size 0x13c virtual true final false
 void set_TwoDigitYearMax(int32_t value) ;

/// @brief Method ToFourDigitYear addr 0x242d890 size 0x14c virtual true final false
