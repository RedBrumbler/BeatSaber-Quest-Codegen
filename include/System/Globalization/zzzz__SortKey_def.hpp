...
/// @brief Method Compare addr 0x24317d4 size 0x174 virtual false final false
...
/// @brief Method .ctor addr 0x2431948 size 0xd4 virtual false final false
...
/// @brief Method .ctor addr 0x2431a1c size 0x40 virtual false final false
...
/// @brief Method .ctor addr 0x2431a5c size 0x48 virtual false final false
 void _ctor(::StringW localeName, ::StringW str, System::Globalization::CompareOptions options, ::ArrayW<uint8_t> keyData) ;

/// @brief Method get_OriginalString addr 0x2431aa4 size 0x8 virtual true final false
 ::StringW get_OriginalString() ;

/// @brief Method get_KeyData addr 0x2431aac size 0x8 virtual true final false
 ::ArrayW<uint8_t> get_KeyData() ;

/// @brief Method Equals addr 0x2431ab4 size 0xb0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetHashCode addr 0x2431b64 size 0x68 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2431bcc size 0x1f0 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit SortKey() ;

/// @brief Method .ctor addr 0x2431dbc size 0x38 virtual false final false
 void _ctor() ;
