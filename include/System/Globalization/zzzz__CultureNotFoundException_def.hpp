...
/// @brief Method .ctor addr 0x2413bec size 0x4c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2413c78 size 0x14 virtual false final false
...
/// @brief Method .ctor addr 0x2413c8c size 0x1bc virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method GetObjectData addr 0x2413e48 size 0x164 virtual true final false
 void GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method get_InvalidCultureId addr 0x2413fac size 0x8 virtual true final false
 System::Nullable_1<int32_t> get_InvalidCultureId() ;

/// @brief Method get_InvalidCultureName addr 0x2413fb4 size 0x8 virtual true final false
 ::StringW get_InvalidCultureName() ;

/// @brief Method get_DefaultMessage addr 0x2413c38 size 0x40 virtual false final false
static ::StringW get_DefaultMessage() ;

/// @brief Method get_FormatedInvalidCultureId addr 0x2413fbc size 0x134 virtual false final false
 ::StringW get_FormatedInvalidCultureId() ;

/// @brief Method get_Message addr 0x24140f0 size 0xbc virtual true final false
 ::StringW get_Message() ;
