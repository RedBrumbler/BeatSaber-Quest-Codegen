...
/// @brief Method get_KnownWords addr 0x2419e10 size 0x400 virtual false final false
static System::Collections::Generic::Dictionary_2<::StringW,::StringW> get_KnownWords() ;

/// @brief Method SkipWhiteSpacesAndNonLetter addr 0x241a210 size 0xfc virtual false final false
static int32_t SkipWhiteSpacesAndNonLetter(::StringW pattern, int32_t currentIndex) ;

/// @brief Method AddDateWordOrPostfix addr 0x241a30c size 0x2b0 virtual false final false
 void AddDateWordOrPostfix(::StringW formatPostfix, ::StringW str) ;

/// @brief Method AddDateWords addr 0x241a708 size 0x1d8 virtual false final false
 int32_t AddDateWords(::StringW pattern, int32_t index, ::StringW formatPostfix) ;

/// @brief Method ScanRepeatChar addr 0x241a8e0 size 0x84 virtual false final false
static int32_t ScanRepeatChar(::StringW pattern, char16_t ch, int32_t index, ByRef<int32_t> count) ;

/// @brief Method AddIgnorableSymbols addr 0x241a5bc size 0x14c virtual false final false
 void AddIgnorableSymbols(::StringW text) ;

/// @brief Method ScanDateWord addr 0x241a964 size 0x23c virtual false final false
 void ScanDateWord(::StringW pattern) ;

/// @brief Method GetDateWordsOfDTFI addr 0x2418c08 size 0x2c0 virtual false final false
 ::ArrayW<::StringW> GetDateWordsOfDTFI(System::Globalization::DateTimeFormatInfo dtfi) ;

/// @brief Method GetFormatFlagGenitiveMonth addr 0x241703c size 0x40 virtual false final false
...
/// @brief Method GetFormatFlagUseSpaceInMonthNames addr 0x241707c size 0xa4 virtual false final false
...
/// @brief Method GetFormatFlagUseSpaceInDayNames addr 0x2417120 size 0x30 virtual false final false
...
/// @brief Method GetFormatFlagUseHebrewCalendar addr 0x2417150 size 0x10 virtual false final false
static System::Globalization::FORMATFLAGS GetFormatFlagUseHebrewCalendar(int32_t calID) ;

/// @brief Method EqualStringArrays addr 0x241aba0 size 0xa8 virtual false final false
static bool EqualStringArrays(::ArrayW<::StringW> array1, ::ArrayW<::StringW> array2) ;

/// @brief Method ArrayElementsHaveSpace addr 0x241aea4 size 0xf4 virtual false final false
static bool ArrayElementsHaveSpace(::ArrayW<::StringW> array) ;

/// @brief Method ArrayElementsBeginWithDigit addr 0x241ac48 size 0x25c virtual false final false
static bool ArrayElementsBeginWithDigit(::ArrayW<::StringW> array) ;

// Ctor Parameters []
explicit DateTimeFormatInfoScanner() ;

/// @brief Method .ctor addr 0x2418b8c size 0x7c virtual false final false
 void _ctor() ;
