...
/// @brief Method .ctor addr 0x243dce4 size 0xd4 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x243ddb8 size 0x14 virtual true final false
...
/// @brief Method get__cultureData addr 0x24390cc size 0x8 virtual false final false
 System::Globalization::CultureData get__cultureData() ;

/// @brief Method get__isInherited addr 0x24390d4 size 0x8 virtual false final false
 bool get__isInherited() ;

/// @brief Method get_InvariantCulture addr 0x242a128 size 0x60 virtual false final false
static System::Globalization::CultureInfo get_InvariantCulture() ;

/// @brief Method get_CurrentCulture addr 0x242a3ac size 0x20 virtual false final false
static System::Globalization::CultureInfo get_CurrentCulture() ;

/// @brief Method get_CurrentUICulture addr 0x24390dc size 0x20 virtual false final false
static System::Globalization::CultureInfo get_CurrentUICulture() ;

/// @brief Method ConstructCurrentCulture addr 0x24390fc size 0x1e4 virtual false final false
static System::Globalization::CultureInfo ConstructCurrentCulture() ;

/// @brief Method ConstructCurrentUICulture addr 0x2439500 size 0x4c virtual false final false
static System::Globalization::CultureInfo ConstructCurrentUICulture() ;

/// @brief Method get_Territory addr 0x243954c size 0x8 virtual false final false
 ::StringW get_Territory() ;

/// @brief Method get__name addr 0x2439554 size 0x8 virtual false final false
 ::StringW get__name() ;

/// @brief Method get_LCID addr 0x243955c size 0x8 virtual true final false
 int32_t get_LCID() ;

/// @brief Method get_Name addr 0x2439564 size 0x8 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_Calendar addr 0x243956c size 0x84 virtual true final false
 System::Globalization::Calendar get_Calendar() ;

/// @brief Method get_Parent addr 0x2439848 size 0x23c virtual true final false
 System::Globalization::CultureInfo get_Parent() ;

/// @brief Method get_TextInfo addr 0x2439a90 size 0x11c virtual true final false
 System::Globalization::TextInfo get_TextInfo() ;

/// @brief Method Clone addr 0x2439c24 size 0x198 virtual true final false
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method Equals addr 0x2439dbc size 0xac virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetCultures addr 0x2439e68 size 0x230 virtual false final false
static ::ArrayW<System::Globalization::CultureInfo> GetCultures(System::Globalization::CultureTypes types) ;

/// @brief Method GetTextInfoData addr 0x243a0a8 size 0x18 virtual false final false
 System::Globalization::System__Globalization__CultureInfo__Data GetTextInfoData() ;

/// @brief Method GetHashCode addr 0x243a138 size 0xc virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x243a144 size 0x8 virtual true final false
 ::StringW ToString() ;

/// @brief Method get_CompareInfo addr 0x243a14c size 0x158 virtual true final false
 System::Globalization::CompareInfo get_CompareInfo() ;

/// @brief Method get_IsNeutralCulture addr 0x243a2a4 size 0x48 virtual true final false
 bool get_IsNeutralCulture() ;

/// @brief Method CheckNeutral addr 0x243a2ec size 0x4 virtual false final false
 void CheckNeutral() ;

/// @brief Method get_NumberFormat addr 0x243a2f0 size 0x8c virtual true final false
 System::Globalization::NumberFormatInfo get_NumberFormat() ;

/// @brief Method set_NumberFormat addr 0x243a37c size 0xd0 virtual true final false
 void set_NumberFormat(System::Globalization::NumberFormatInfo value) ;

/// @brief Method get_DateTimeFormat addr 0x243a44c size 0x160 virtual true final false
 System::Globalization::DateTimeFormatInfo get_DateTimeFormat() ;

/// @brief Method set_DateTimeFormat addr 0x243a5ac size 0xd0 virtual true final false
 void set_DateTimeFormat(System::Globalization::DateTimeFormatInfo value) ;

/// @brief Method get_EnglishName addr 0x243a67c size 0x30 virtual true final false
 ::StringW get_EnglishName() ;

/// @brief Method GetFormat addr 0x243a6ac size 0x110 virtual true final false
 ::bs_hook::Il2CppWrapperType GetFormat(System::Type formatType) ;

/// @brief Method Construct addr 0x24395f0 size 0x20 virtual false final false
 void Construct() ;

/// @brief Method construct_internal_locale_from_lcid addr 0x243a7bc size 0x4 virtual false final false
 bool construct_internal_locale_from_lcid(int32_t lcid) ;

/// @brief Method construct_internal_locale_from_name addr 0x243a7c0 size 0x4 virtual false final false
 bool construct_internal_locale_from_name(::StringW name) ;

/// @brief Method get_current_locale_name addr 0x24392e0 size 0x4 virtual false final false
static ::StringW get_current_locale_name() ;

/// @brief Method internal_get_cultures addr 0x243a098 size 0x10 virtual false final false
static ::ArrayW<System::Globalization::CultureInfo> internal_get_cultures(bool neutral, bool specific, bool installed) ;

/// @brief Method ConstructInvariant addr 0x243a7c4 size 0x14c virtual false final false
 void ConstructInvariant(bool read_only) ;

/// @brief Method CreateTextInfo addr 0x2439bac size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x2439a84 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x243a910 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x243a91c size 0x260 virtual false final false
 void _ctor(int32_t culture, bool useUserOverride, bool read_only) ;

// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }]
explicit CultureInfo(::StringW name) ;

/// @brief Method .ctor addr 0x242b98c size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x2431f08 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x243ab7c size 0x22c virtual false final false
 void _ctor(::StringW name, bool useUserOverride, bool read_only) ;

// Ctor Parameters []
explicit CultureInfo() ;

/// @brief Method .ctor addr 0x243aefc size 0x20 virtual false final false
 void _ctor() ;

/// @brief Method insert_into_shared_tables addr 0x243af1c size 0x188 virtual false final false
static void insert_into_shared_tables(System::Globalization::CultureInfo c) ;

/// @brief Method GetCultureInfo addr 0x242e060 size 0x244 virtual false final false
static System::Globalization::CultureInfo GetCultureInfo(int32_t culture) ;

/// @brief Method GetCultureInfo addr 0x242e2a4 size 0x22c virtual false final false
static System::Globalization::CultureInfo GetCultureInfo(::StringW name) ;

/// @brief Method CreateCulture addr 0x243b0a4 size 0x74 virtual false final false
static System::Globalization::CultureInfo CreateCulture(::StringW name, bool reference) ;

/// @brief Method CreateSpecificCulture addr 0x24392e4 size 0x21c virtual false final false
static System::Globalization::CultureInfo CreateSpecificCulture(::StringW name) ;

/// @brief Method ConstructLocaleFromName addr 0x243ada8 size 0x8c virtual false final false
 bool ConstructLocaleFromName(::StringW name) ;

/// @brief Method CreateSpecificCultureFromNeutral addr 0x243b118 size 0x2754 virtual false final false
static System::Globalization::CultureInfo CreateSpecificCultureFromNeutral(::StringW name) ;

/// @brief Method get_CalendarType addr 0x243a0c0 size 0x78 virtual false final false
 int32_t get_CalendarType() ;

/// @brief Method CreateCalendar addr 0x2439610 size 0x238 virtual false final false
static System::Globalization::Calendar CreateCalendar(int32_t calendarType) ;

/// @brief Method CreateNotFoundException addr 0x243ae34 size 0xc8 virtual false final false
static System::Exception CreateNotFoundException(::StringW name) ;

/// @brief Method get_DefaultThreadCurrentCulture addr 0x243d86c size 0x60 virtual false final false
static System::Globalization::CultureInfo get_DefaultThreadCurrentCulture() ;

/// @brief Method set_DefaultThreadCurrentCulture addr 0x243d8cc size 0x60 virtual false final false
static void set_DefaultThreadCurrentCulture(System::Globalization::CultureInfo value) ;

/// @brief Method get_DefaultThreadCurrentUICulture addr 0x243d92c size 0x60 virtual false final false
static System::Globalization::CultureInfo get_DefaultThreadCurrentUICulture() ;

/// @brief Method get_SortName addr 0x243d98c size 0x8 virtual false final false
 ::StringW get_SortName() ;

/// @brief Method get_UserDefaultUICulture addr 0x243d994 size 0x4c virtual false final false
static System::Globalization::CultureInfo get_UserDefaultUICulture() ;

/// @brief Method get_UserDefaultCulture addr 0x243d9e0 size 0x4c virtual false final false
static System::Globalization::CultureInfo get_UserDefaultCulture() ;

/// @brief Method InitializeUserPreferredCultureInfoInAppX addr 0x243da2c size 0x10 virtual false final false
...
/// @brief Method SetUserPreferredCultureInfoInAppX addr 0x243da3c size 0x10 virtual false final false
static void SetUserPreferredCultureInfoInAppX(::StringW name) ;

/// @brief Method OnCultureInfoChangedInAppX addr 0x243902c size 0xa0 virtual false final false
static void OnCultureInfoChangedInAppX(::StringW language) ;

/// @brief Method GetCultureInfoForUserPreferredLanguageInAppX addr 0x243da4c size 0xe0 virtual false final false
static System::Globalization::CultureInfo GetCultureInfoForUserPreferredLanguageInAppX() ;

/// @brief Method SetCultureInfoForUserPreferredLanguageInAppX addr 0x243db2c size 0x110 virtual false final false
