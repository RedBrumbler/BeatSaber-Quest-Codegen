...
/// @brief Method get_Start addr 0x241ca8c size 0x28 virtual false final false
 ::StringW get_Start() ;

/// @brief Method get_DayHourSep addr 0x241cab4 size 0x2c virtual false final false
 ::StringW get_DayHourSep() ;

/// @brief Method get_HourMinuteSep addr 0x241cae0 size 0x2c virtual false final false
 ::StringW get_HourMinuteSep() ;

/// @brief Method get_MinuteSecondSep addr 0x241cb0c size 0x2c virtual false final false
 ::StringW get_MinuteSecondSep() ;

/// @brief Method get_SecondFractionSep addr 0x241cb38 size 0x2c virtual false final false
 ::StringW get_SecondFractionSep() ;

/// @brief Method get_End addr 0x241cb64 size 0x2c virtual false final false
 ::StringW get_End() ;

/// @brief Method InitInvariant addr 0x241cc24 size 0x210 virtual false final false
static System::Globalization::System__Globalization__TimeSpanFormat__FormatLiterals InitInvariant(bool isNegative) ;

/// @brief Method Init addr 0x241c604 size 0x3f8 virtual false final false
...
/// @brief Method AppendNonNegativeInt32 addr 0x241b50c size 0xf8 virtual false final false
static void AppendNonNegativeInt32(System::Text::StringBuilder sb, int32_t n, int32_t digits) ;

/// @brief Method Format addr 0x241b604 size 0xb8 virtual false final false
static ::StringW Format(System::TimeSpan value, ::StringW format, System::IFormatProvider formatProvider) ;

/// @brief Method TryFormat addr 0x241b964 size 0x11c virtual false final false
...
/// @brief Method FormatToBuilder addr 0x241b6bc size 0x2a8 virtual false final false
...
/// @brief Method FormatStandard addr 0x241ba80 size 0x48c virtual false final false
...
/// @brief Method FormatCustomized addr 0x241bf0c size 0x6f8 virtual false final false
