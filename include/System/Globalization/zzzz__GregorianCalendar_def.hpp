...
/// @brief Method OnDeserialized addr 0x24271b8 size 0xdc virtual false final false
 void OnDeserialized(System::Runtime::Serialization::StreamingContext ctx) ;

/// @brief Method get_MinSupportedDateTime addr 0x2427294 size 0x58 virtual true final false
 System::DateTime get_MinSupportedDateTime() ;

/// @brief Method get_MaxSupportedDateTime addr 0x24272ec size 0x58 virtual true final false
 System::DateTime get_MaxSupportedDateTime() ;

/// @brief Method GetDefaultInstance addr 0x24144d8 size 0xd0 virtual false final false
static System::Globalization::Calendar GetDefaultInstance() ;

// Ctor Parameters []
explicit GregorianCalendar() ;

/// @brief Method .ctor addr 0x2427344 size 0x2c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2427370 size 0x154 virtual false final false
 void _ctor(System::Globalization::GregorianCalendarTypes type) ;

/// @brief Method get_ID addr 0x24274c4 size 0x8 virtual true final false
 int32_t get_ID() ;

/// @brief Method GetDatePart addr 0x24274cc size 0x1fc virtual true final false
 int32_t GetDatePart(int64_t ticks, int32_t part) ;

/// @brief Method GetAbsoluteDate addr 0x24276c8 size 0x1e8 virtual false final false
static int64_t GetAbsoluteDate(int32_t year, int32_t month, int32_t day) ;

/// @brief Method GetDayOfMonth addr 0x24278b0 size 0x44 virtual true final false
 int32_t GetDayOfMonth(System::DateTime time) ;

/// @brief Method GetDayOfWeek addr 0x24278f4 size 0x68 virtual true final false
 System::DayOfWeek GetDayOfWeek(System::DateTime time) ;

/// @brief Method GetDaysInMonth addr 0x242795c size 0x2b0 virtual true final false
 int32_t GetDaysInMonth(int32_t year, int32_t month, int32_t era) ;

/// @brief Method GetDaysInYear addr 0x2427c0c size 0x194 virtual true final false
 int32_t GetDaysInYear(int32_t year, int32_t era) ;

/// @brief Method GetEra addr 0x2427da0 size 0x8 virtual true final false
 int32_t GetEra(System::DateTime time) ;

/// @brief Method get_Eras addr 0x2427da8 size 0x64 virtual true final false
 ::ArrayW<int32_t> get_Eras() ;

/// @brief Method GetMonth addr 0x2427e0c size 0x44 virtual true final false
 int32_t GetMonth(System::DateTime time) ;

/// @brief Method GetMonthsInYear addr 0x2427e50 size 0x150 virtual true final false
 int32_t GetMonthsInYear(int32_t year, int32_t era) ;

/// @brief Method GetYear addr 0x2427fa0 size 0x44 virtual true final false
 int32_t GetYear(System::DateTime time) ;

/// @brief Method IsLeapYear addr 0x2427fe4 size 0x19c virtual true final false
 bool IsLeapYear(int32_t year, int32_t era) ;

/// @brief Method ToDateTime addr 0x2428180 size 0xa0 virtual true final false
...
/// @brief Method TryToDateTime addr 0x2428220 size 0xf4 virtual true final false
...
/// @brief Method get_TwoDigitYearMax addr 0x2428314 size 0x44 virtual true final false
 int32_t get_TwoDigitYearMax() ;

/// @brief Method set_TwoDigitYearMax addr 0x2428358 size 0x118 virtual true final false
 void set_TwoDigitYearMax(int32_t value) ;

/// @brief Method ToFourDigitYear addr 0x2428470 size 0x120 virtual true final false
