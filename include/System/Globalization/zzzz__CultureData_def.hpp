...
/// @brief Method .ctor addr 0x2431df4 size 0x28 virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method get_Invariant addr 0x242db9c size 0x3a4 virtual false final false
static System::Globalization::CultureData get_Invariant() ;

/// @brief Method GetCultureData addr 0x2431e1c size 0xec virtual false final false
static System::Globalization::CultureData GetCultureData(::StringW cultureName, bool useUserOverride) ;

/// @brief Method GetCultureData addr 0x2431f14 size 0x120 virtual false final false
...
/// @brief Method fill_culture_data addr 0x2432034 size 0x4 virtual false final false
 void fill_culture_data(int32_t datetimeIndex) ;

/// @brief Method GetCalendar addr 0x2432038 size 0x11c virtual false final false
 System::Globalization::CalendarData GetCalendar(int32_t calendarId) ;

/// @brief Method get_LongTimes addr 0x2432154 size 0x18 virtual false final false
 ::ArrayW<::StringW> get_LongTimes() ;

/// @brief Method get_ShortTimes addr 0x243216c size 0x18 virtual false final false
 ::ArrayW<::StringW> get_ShortTimes() ;

/// @brief Method get_SISO639LANGNAME addr 0x2432184 size 0x8 virtual false final false
 ::StringW get_SISO639LANGNAME() ;

/// @brief Method get_IFIRSTDAYOFWEEK addr 0x243218c size 0x8 virtual false final false
 int32_t get_IFIRSTDAYOFWEEK() ;

/// @brief Method get_IFIRSTWEEKOFYEAR addr 0x2432194 size 0x8 virtual false final false
 int32_t get_IFIRSTWEEKOFYEAR() ;

/// @brief Method get_SAM1159 addr 0x243219c size 0x8 virtual false final false
 ::StringW get_SAM1159() ;

/// @brief Method get_SPM2359 addr 0x24321a4 size 0x8 virtual false final false
 ::StringW get_SPM2359() ;

/// @brief Method get_TimeSeparator addr 0x24321ac size 0x8 virtual false final false
 ::StringW get_TimeSeparator() ;

/// @brief Method get_CalendarIds addr 0x24321b4 size 0x1b0 virtual false final false
 ::ArrayW<int32_t> get_CalendarIds() ;

/// @brief Method GetCalendarIds addr 0x2432364 size 0xd8 virtual false final false
 ::ArrayW<System::Globalization::CalendarId> GetCalendarIds() ;

/// @brief Method get_IsInvariantCulture addr 0x242c83c size 0xc virtual false final false
 bool get_IsInvariantCulture() ;

/// @brief Method get_CultureName addr 0x243243c size 0x8 virtual false final false
 ::StringW get_CultureName() ;

/// @brief Method get_SCOMPAREINFO addr 0x2432444 size 0x40 virtual false final false
 ::StringW get_SCOMPAREINFO() ;

/// @brief Method get_STEXTINFO addr 0x2432484 size 0x8 virtual false final false
 ::StringW get_STEXTINFO() ;

/// @brief Method get_UseUserOverride addr 0x243248c size 0x8 virtual false final false
 bool get_UseUserOverride() ;

/// @brief Method EraNames addr 0x2432494 size 0x1c virtual false final false
 ::ArrayW<::StringW> EraNames(int32_t calendarId) ;

/// @brief Method AbbrevEraNames addr 0x24324b0 size 0x1c virtual false final false
 ::ArrayW<::StringW> AbbrevEraNames(int32_t calendarId) ;

/// @brief Method AbbreviatedEnglishEraNames addr 0x24324cc size 0x1c virtual false final false
 ::ArrayW<::StringW> AbbreviatedEnglishEraNames(int32_t calendarId) ;

/// @brief Method ShortDates addr 0x24324e8 size 0x1c virtual false final false
 ::ArrayW<::StringW> ShortDates(int32_t calendarId) ;

/// @brief Method LongDates addr 0x2432504 size 0x1c virtual false final false
 ::ArrayW<::StringW> LongDates(int32_t calendarId) ;

/// @brief Method YearMonths addr 0x2432520 size 0x1c virtual false final false
 ::ArrayW<::StringW> YearMonths(int32_t calendarId) ;

/// @brief Method DayNames addr 0x243253c size 0x1c virtual false final false
 ::ArrayW<::StringW> DayNames(int32_t calendarId) ;

/// @brief Method AbbreviatedDayNames addr 0x2432558 size 0x1c virtual false final false
 ::ArrayW<::StringW> AbbreviatedDayNames(int32_t calendarId) ;

/// @brief Method MonthNames addr 0x2432574 size 0x1c virtual false final false
 ::ArrayW<::StringW> MonthNames(int32_t calendarId) ;

/// @brief Method GenitiveMonthNames addr 0x2432590 size 0x1c virtual false final false
 ::ArrayW<::StringW> GenitiveMonthNames(int32_t calendarId) ;

/// @brief Method AbbreviatedMonthNames addr 0x24325ac size 0x1c virtual false final false
 ::ArrayW<::StringW> AbbreviatedMonthNames(int32_t calendarId) ;

/// @brief Method AbbreviatedGenitiveMonthNames addr 0x24325c8 size 0x1c virtual false final false
 ::ArrayW<::StringW> AbbreviatedGenitiveMonthNames(int32_t calendarId) ;

/// @brief Method LeapYearMonthNames addr 0x24325e4 size 0x1c virtual false final false
 ::ArrayW<::StringW> LeapYearMonthNames(int32_t calendarId) ;

/// @brief Method MonthDay addr 0x2432600 size 0x1c virtual false final false
 ::StringW MonthDay(int32_t calendarId) ;

/// @brief Method DateSeparator addr 0x243261c size 0xac virtual false final false
 ::StringW DateSeparator(int32_t calendarId) ;

/// @brief Method GetDateSeparator addr 0x24326c8 size 0x48 virtual false final false
static ::StringW GetDateSeparator(::StringW format) ;

/// @brief Method GetSeparator addr 0x2432710 size 0x104 virtual false final false
static ::StringW GetSeparator(::StringW format, ::StringW timeParts) ;

/// @brief Method IndexOfTimePart addr 0x2432814 size 0xec virtual false final false
static int32_t IndexOfTimePart(::StringW format, int32_t startIndex, ::StringW timeParts) ;

/// @brief Method UnescapeNlsString addr 0x2432900 size 0x1a4 virtual false final false
static ::StringW UnescapeNlsString(::StringW str, int32_t start, int32_t end) ;

/// @brief Method ReescapeWin32Strings addr 0x2432aa4 size 0x4 virtual false final false
static ::ArrayW<::StringW> ReescapeWin32Strings(::ArrayW<::StringW> array) ;

/// @brief Method ReescapeWin32String addr 0x2432aa8 size 0x4 virtual false final false
static ::StringW ReescapeWin32String(::StringW str) ;

/// @brief Method strlen addr 0x2432aac size 0x18 virtual false final false
static int32_t strlen(void* s) ;

/// @brief Method idx2string addr 0x2432ac4 size 0x44 virtual false final false
static ::StringW idx2string(void* data, int32_t idx) ;

/// @brief Method create_group_sizes_array addr 0x2432b08 size 0xb4 virtual false final false
 ::ArrayW<int32_t> create_group_sizes_array(int32_t gs0, int32_t gs1) ;

/// @brief Method GetNFIValues addr 0x242c6a4 size 0x198 virtual false final false
 void GetNFIValues(System::Globalization::NumberFormatInfo nfi) ;

/// @brief Method fill_number_data addr 0x2432bbc size 0x4 virtual false final false
