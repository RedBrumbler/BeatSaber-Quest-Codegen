...
/// @brief Method get_MinSupportedDateTime addr 0x2424388 size 0x58 virtual true final false
 System::DateTime get_MinSupportedDateTime() ;

/// @brief Method get_MaxSupportedDateTime addr 0x24243e0 size 0x58 virtual true final false
 System::DateTime get_MaxSupportedDateTime() ;

// Ctor Parameters []
explicit Calendar() ;

/// @brief Method .ctor addr 0x2424438 size 0x14 virtual false final false
 void _ctor() ;

/// @brief Method get_ID addr 0x242444c size 0x8 virtual true final false
 int32_t get_ID() ;

/// @brief Method get_BaseCalendarID addr 0x2424454 size 0xc virtual true final false
 int32_t get_BaseCalendarID() ;

/// @brief Method Clone addr 0x2424460 size 0x88 virtual true final false
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method VerifyWritable addr 0x24244e8 size 0x74 virtual false final false
 void VerifyWritable() ;

/// @brief Method SetReadOnlyState addr 0x242455c size 0xc virtual false final false
 void SetReadOnlyState(bool readOnly) ;

/// @brief Method get_CurrentEraValue addr 0x2424568 size 0x8c virtual true final false
...
/// @brief Method IsLeapYear addr 0x242469c size 0x14 virtual true final false
...
/// @brief Method ToDateTime addr 0x24246b0 size 0x28 virtual true final false
...
/// @brief Method TryToDateTime addr 0x24246d8 size 0x160 virtual true final false
...
/// @brief Method IsValidYear addr 0x2424838 size 0x84 virtual true final false
 bool IsValidYear(int32_t year, int32_t era) ;

/// @brief Method IsValidMonth addr 0x24248bc size 0x78 virtual true final false
 bool IsValidMonth(int32_t year, int32_t month, int32_t era) ;

/// @brief Method IsValidDay addr 0x2424934 size 0x80 virtual true final false
 bool IsValidDay(int32_t year, int32_t month, int32_t day, int32_t era) ;

/// @brief Method get_TwoDigitYearMax addr 0x24249b4 size 0x8 virtual true final false
 int32_t get_TwoDigitYearMax() ;

/// @brief Method set_TwoDigitYearMax addr 0x24249bc size 0x24 virtual true final false
 void set_TwoDigitYearMax(int32_t value) ;

/// @brief Method ToFourDigitYear addr 0x24249e0 size 0xfc virtual true final false
 int32_t ToFourDigitYear(int32_t year) ;

/// @brief Method TimeToTicks addr 0x2424adc size 0x1bc virtual false final false
static int64_t TimeToTicks(int32_t hour, int32_t minute, int32_t second, int32_t millisecond) ;

/// @brief Method GetSystemTwoDigitYearSetting addr 0x2424c98 size 0x54 virtual false final false
