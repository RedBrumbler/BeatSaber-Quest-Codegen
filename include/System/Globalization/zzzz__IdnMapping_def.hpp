...
/// @brief Method .ctor addr 0x243ddcc size 0x90 virtual false final false
 void _ctor() ;

/// @brief Method Equals addr 0x243de9c size 0x8c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x243df28 size 0x10 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method GetAscii addr 0x243df38 size 0x64 virtual false final false
 ::StringW GetAscii(::StringW unicode) ;

/// @brief Method GetAscii addr 0x243df9c size 0xd4 virtual false final false
 ::StringW GetAscii(::StringW unicode, int32_t index, int32_t count) ;

/// @brief Method Convert addr 0x243e070 size 0x22c virtual false final false
 ::StringW Convert(::StringW input, int32_t index, int32_t count, bool toAscii) ;

/// @brief Method ToAscii addr 0x243e29c size 0x23c virtual false final false
 ::StringW ToAscii(::StringW s, int32_t offset) ;

/// @brief Method VerifyLength addr 0x243ed10 size 0xcc virtual false final false
 void VerifyLength(::StringW s, int32_t offset) ;

/// @brief Method NamePrep addr 0x243e6b0 size 0x14c virtual false final false
 ::StringW NamePrep(::StringW s, int32_t offset) ;

/// @brief Method VerifyProhibitedCharacters addr 0x243eddc size 0x240 virtual false final false
 void VerifyProhibitedCharacters(::StringW s, int32_t offset) ;

/// @brief Method VerifyStd3AsciiRules addr 0x243e7fc size 0x1d0 virtual false final false
 void VerifyStd3AsciiRules(::StringW s, int32_t offset) ;

/// @brief Method GetUnicode addr 0x243f01c size 0x64 virtual false final false
 ::StringW GetUnicode(::StringW ascii) ;

/// @brief Method GetUnicode addr 0x243f080 size 0xd4 virtual false final false
 ::StringW GetUnicode(::StringW ascii, int32_t index, int32_t count) ;

/// @brief Method ToUnicode addr 0x243e4d8 size 0x1d8 virtual false final false
