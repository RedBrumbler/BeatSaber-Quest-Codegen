...
/// @brief Method get_CurrentRegion addr 0x243f560 size 0xcc virtual false final false
...
/// @brief Method .ctor addr 0x243f7c4 size 0x10c virtual false final false
 void _ctor(int32_t culture) ;

// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }]
explicit RegionInfo(::StringW name) ;

/// @brief Method .ctor addr 0x243f97c size 0x144 virtual false final false
...
/// @brief Method .ctor addr 0x243f62c size 0x198 virtual false final false
 void _ctor(System::Globalization::CultureInfo ci) ;

/// @brief Method GetByTerritory addr 0x243f8d0 size 0xac virtual false final false
 bool GetByTerritory(System::Globalization::CultureInfo ci) ;

/// @brief Method construct_internal_region_from_name addr 0x243fac0 size 0x4 virtual false final false
 bool construct_internal_region_from_name(::StringW name) ;

/// @brief Method get_CurrencyEnglishName addr 0x243fac4 size 0x8 virtual true final false
 ::StringW get_CurrencyEnglishName() ;

/// @brief Method get_CurrencySymbol addr 0x243facc size 0x8 virtual true final false
 ::StringW get_CurrencySymbol() ;

/// @brief Method get_DisplayName addr 0x243fad4 size 0x8 virtual true final false
 ::StringW get_DisplayName() ;

/// @brief Method get_EnglishName addr 0x243fadc size 0x8 virtual true final false
 ::StringW get_EnglishName() ;

/// @brief Method get_GeoId addr 0x243fae4 size 0x8 virtual true final false
 int32_t get_GeoId() ;

/// @brief Method get_IsMetric addr 0x243faec size 0x8c virtual true final false
 bool get_IsMetric() ;

/// @brief Method get_ISOCurrencySymbol addr 0x243fb78 size 0x8 virtual true final false
 ::StringW get_ISOCurrencySymbol() ;

/// @brief Method get_NativeName addr 0x243fb80 size 0x8 virtual true final false
 ::StringW get_NativeName() ;

/// @brief Method get_CurrencyNativeName addr 0x243fb88 size 0x8 virtual true final false
 ::StringW get_CurrencyNativeName() ;

/// @brief Method get_Name addr 0x243fb90 size 0x8 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_ThreeLetterISORegionName addr 0x243fb98 size 0x8 virtual true final false
 ::StringW get_ThreeLetterISORegionName() ;

/// @brief Method get_ThreeLetterWindowsRegionName addr 0x243fba0 size 0x8 virtual true final false
 ::StringW get_ThreeLetterWindowsRegionName() ;

/// @brief Method get_TwoLetterISORegionName addr 0x243fba8 size 0x8 virtual true final false
 ::StringW get_TwoLetterISORegionName() ;

/// @brief Method Equals addr 0x243fbb0 size 0xc8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetHashCode addr 0x243fc78 size 0x2c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x243fca4 size 0x10 virtual true final false
 ::StringW ToString() ;

/// @brief Method ClearCachedData addr 0x243fcb4 size 0x48 virtual false final false
