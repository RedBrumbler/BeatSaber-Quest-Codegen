...
/// @brief Method get_Invariant addr 0x24242e0 size 0x58 virtual false final false
static bool get_Invariant() ;

/// @brief Method GetGlobalizationInvariantMode addr 0x2424338 size 0x8 virtual false final false
