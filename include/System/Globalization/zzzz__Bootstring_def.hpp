...
/// @brief Method .ctor addr 0x243f42c size 0x6c virtual false final false
...
/// @brief Method Encode addr 0x243e9cc size 0x344 virtual false final false
 ::StringW Encode(::StringW s, int32_t offset) ;

/// @brief Method EncodeDigit addr 0x243f498 size 0x18 virtual false final false
 char16_t EncodeDigit(int32_t d) ;

/// @brief Method DecodeDigit addr 0x243f528 size 0x38 virtual false final false
 int32_t DecodeDigit(char16_t c) ;

/// @brief Method Adapt addr 0x243f4b0 size 0x78 virtual false final false
 int32_t Adapt(int32_t delta, int32_t numPoints, bool firstTime) ;

/// @brief Method Decode addr 0x243f154 size 0x2d8 virtual false final false
