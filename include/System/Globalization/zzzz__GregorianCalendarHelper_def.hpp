...
/// @brief Method get_MaxYear addr 0x24287b0 size 0x8 virtual false final false
 int32_t get_MaxYear() ;
...
/// @brief Method .ctor addr 0x24287b8 size 0x78 virtual false final false
 void _ctor(System::Globalization::Calendar cal, ::ArrayW<System::Globalization::EraInfo> eraInfo) ;

/// @brief Method GetYearOffset addr 0x2428830 size 0x2f4 virtual false final false
 int32_t GetYearOffset(int32_t year, int32_t era, bool throwOnError) ;

/// @brief Method GetGregorianYear addr 0x2428b24 size 0x1c virtual false final false
 int32_t GetGregorianYear(int32_t year, int32_t era) ;

/// @brief Method IsValidYear addr 0x2428b40 size 0x1c virtual false final false
 bool IsValidYear(int32_t year, int32_t era) ;

/// @brief Method GetDatePart addr 0x2428b5c size 0x20c virtual true final false
 int32_t GetDatePart(int64_t ticks, int32_t part) ;

/// @brief Method GetAbsoluteDate addr 0x2428f00 size 0x1e8 virtual false final false
static int64_t GetAbsoluteDate(int32_t year, int32_t month, int32_t day) ;

/// @brief Method DateToTicks addr 0x24290e8 size 0x80 virtual false final false
static int64_t DateToTicks(int32_t year, int32_t month, int32_t day) ;

/// @brief Method TimeToTicks addr 0x2429168 size 0x1bc virtual false final false
static int64_t TimeToTicks(int32_t hour, int32_t minute, int32_t second, int32_t millisecond) ;

/// @brief Method CheckTicksRange addr 0x2428d68 size 0x198 virtual false final false
 void CheckTicksRange(int64_t ticks) ;

/// @brief Method GetDayOfMonth addr 0x2429324 size 0x40 virtual false final false
 int32_t GetDayOfMonth(System::DateTime time) ;

/// @brief Method GetDayOfWeek addr 0x2429364 size 0x8c virtual false final false
 System::DayOfWeek GetDayOfWeek(System::DateTime time) ;

/// @brief Method GetDaysInMonth addr 0x24293f0 size 0x18c virtual false final false
 int32_t GetDaysInMonth(int32_t year, int32_t month, int32_t era) ;

/// @brief Method GetDaysInYear addr 0x242957c size 0x70 virtual false final false
 int32_t GetDaysInYear(int32_t year, int32_t era) ;

/// @brief Method GetEra addr 0x24295ec size 0xd0 virtual false final false
 int32_t GetEra(System::DateTime time) ;

/// @brief Method get_Eras addr 0x24296bc size 0xf0 virtual false final false
 ::ArrayW<int32_t> get_Eras() ;

/// @brief Method GetMonth addr 0x24297ac size 0x40 virtual false final false
 int32_t GetMonth(System::DateTime time) ;

/// @brief Method GetMonthsInYear addr 0x24297ec size 0x18 virtual false final false
 int32_t GetMonthsInYear(int32_t year, int32_t era) ;

/// @brief Method GetYear addr 0x2429804 size 0xf0 virtual false final false
 int32_t GetYear(System::DateTime time) ;

/// @brief Method IsLeapYear addr 0x24298f4 size 0x70 virtual false final false
 bool IsLeapYear(int32_t year, int32_t era) ;

/// @brief Method ToDateTime addr 0x2429964 size 0x104 virtual false final false
...
/// @brief Method ToFourDigitYear addr 0x2429a68 size 0x188 virtual false final false
