...
/// @brief Method .ctor addr 0x2432bc0 size 0xa4 virtual false final false
 void _ctor(int32_t dataIndex) ;

/// @brief Method CreateString addr 0x2432c64 size 0xb4 virtual false final false
static ::StringW CreateString(::StringW pStrings, uint32_t index) ;

/// @brief Method get_WebName addr 0x2432d18 size 0xbc virtual false final false
 ::StringW get_WebName() ;
