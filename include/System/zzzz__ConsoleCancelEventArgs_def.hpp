...
/// @brief Method .ctor addr 0x2494668 size 0x6c virtual false final false
 void _ctor(System::ConsoleSpecialKey type) ;

/// @brief Method get_Cancel addr 0x24946d4 size 0x8 virtual false final false
 bool get_Cancel() ;

// Ctor Parameters []
explicit ConsoleCancelEventArgs() ;

/// @brief Method .ctor addr 0x24946dc size 0x38 virtual false final false
 void _ctor() ;
