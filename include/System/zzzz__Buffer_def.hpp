...
/// @brief Method InternalBlockCopy addr 0x24a08e4 size 0x4 virtual false final false
...
/// @brief Method IndexOfByte addr 0x24a08e8 size 0x110 virtual false final false
static int32_t IndexOfByte(void* src, uint8_t value, int32_t index, int32_t count) ;

/// @brief Method _ByteLength addr 0x24a09f8 size 0x4 virtual false final false
static int32_t _ByteLength(System::Array array) ;

/// @brief Method ZeroMemory addr 0x24a09fc size 0x24 virtual false final false
static void ZeroMemory(void* src, int64_t len) ;

/// @brief Method Memcpy addr 0x24a0a20 size 0x34 virtual false final false
static void Memcpy(void* pDest, int32_t destIndex, ::ArrayW<uint8_t> src, int32_t srcIndex, int32_t len) ;

/// @brief Method InternalMemcpy addr 0x24a0ac0 size 0x4 virtual false final false
static void InternalMemcpy(void* dest, void* src, int32_t count) ;

/// @brief Method ByteLength addr 0x24a0ac4 size 0x9c virtual false final false
static int32_t ByteLength(System::Array array) ;

/// @brief Method BlockCopy addr 0x24a0b60 size 0x1c0 virtual false final false
static void BlockCopy(System::Array src, int32_t srcOffset, System::Array dst, int32_t dstOffset, int32_t count) ;

/// @brief Method MemoryCopy addr 0x24a0d20 size 0x80 virtual false final false
static void MemoryCopy(void* source, void* destination, int64_t destinationSizeInBytes, int64_t sourceBytesToCopy) ;

/// @brief Method memcpy4 addr 0x24a0dcc size 0x8c virtual false final false
static void memcpy4(void* dest, void* src, int32_t size) ;

/// @brief Method memcpy2 addr 0x24a0e58 size 0x7c virtual false final false
static void memcpy2(void* dest, void* src, int32_t size) ;

/// @brief Method memcpy1 addr 0x24a0ed4 size 0xac virtual false final false
static void memcpy1(void* dest, void* src, int32_t size) ;

/// @brief Method Memcpy addr 0x24a0a54 size 0x6c virtual false final false
static void Memcpy(void* dest, void* src, int32_t len, bool useICall) ;

/// @brief Method Memmove addr 0x24a0da0 size 0x2c virtual false final false
