...
/// @brief Method .ctor addr 0x249ccf4 size 0x40 virtual false final false
 void _ctor(System::LocalDataStoreMgr mgr, int32_t slot, int64_t cookie) ;

/// @brief Method get_Manager addr 0x249cd34 size 0x8 virtual false final false
 System::LocalDataStoreMgr get_Manager() ;

/// @brief Method get_Slot addr 0x249cd3c size 0x8 virtual false final false
 int32_t get_Slot() ;

/// @brief Method get_Cookie addr 0x249cd44 size 0x8 virtual false final false
 int64_t get_Cookie() ;

/// @brief Method Finalize addr 0x249cd4c size 0xac virtual true final false
 void Finalize() ;
