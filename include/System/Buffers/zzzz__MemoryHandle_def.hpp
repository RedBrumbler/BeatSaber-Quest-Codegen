...
/// @brief Method .ctor addr 0x2452560 size 0xc virtual false final false
 void _ctor(void* pointer, System::Runtime::InteropServices::GCHandle handle, System::Buffers::IPinnable pinnable) ;

/// @brief Method get_Pointer addr 0x245256c size 0x8 virtual false final false
 void* get_Pointer() ;

/// @brief Method Dispose addr 0x2452574 size 0xc8 virtual true final true
 void Dispose() ;
