...
/// @brief Method CountDigits addr 0x2452708 size 0xbc virtual false final false
static int32_t CountDigits(uint64_t value) ;

/// @brief Method CountDigits addr 0x24527c4 size 0x6c virtual false final false
static int32_t CountDigits(uint32_t value) ;

/// @brief Method CountHexDigits addr 0x2452830 size 0x48 virtual false final false
