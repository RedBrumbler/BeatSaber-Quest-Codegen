...
/// @brief Method SelectBucketIndex addr 0x245263c size 0x7c virtual false final false
static int32_t SelectBucketIndex(int32_t bufferSize) ;

/// @brief Method GetMaxSizeForBucket addr 0x24526b8 size 0xc virtual false final false
