...
/// @brief Method ReverseEndianness addr 0x24526c4 size 0x8 virtual false final false
static int32_t ReverseEndianness(int32_t value) ;

/// @brief Method ReverseEndianness addr 0x24526cc size 0x14 virtual false final false
static int64_t ReverseEndianness(int64_t value) ;

/// @brief Method ReverseEndianness addr 0x24526e0 size 0xc virtual false final false
static uint16_t ReverseEndianness(uint16_t value) ;

/// @brief Method ReverseEndianness addr 0x24526ec size 0x8 virtual false final false
static uint32_t ReverseEndianness(uint32_t value) ;

/// @brief Method ReverseEndianness addr 0x24526f4 size 0x14 virtual false final false
