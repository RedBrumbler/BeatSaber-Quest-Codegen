...
/// @brief Method .ctor addr 0x2452234 size 0xac virtual false final false
 void _ctor() ;

/// @brief Method BufferRented addr 0x24522e0 size 0xec virtual false final false
 void BufferRented(int32_t bufferId, int32_t bufferSize, int32_t poolId, int32_t bucketId) ;

/// @brief Method BufferAllocated addr 0x24523cc size 0x108 virtual false final false
...
/// @brief Method BufferReturned addr 0x24524d4 size 0x10 virtual false final false
 void BufferReturned(int32_t bufferId, int32_t bufferSize, int32_t poolId) ;

/// @brief Method BufferTrimmed addr 0x24524e4 size 0x10 virtual false final false
 void BufferTrimmed(int32_t bufferId, int32_t bufferSize, int32_t poolId) ;

/// @brief Method BufferTrimPoll addr 0x24524f4 size 0xc virtual false final false
