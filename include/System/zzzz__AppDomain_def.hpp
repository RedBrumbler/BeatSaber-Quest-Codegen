...
/// @brief Method IsAppXModel addr 0x24b86f8 size 0x8 virtual false final false
static bool IsAppXModel() ;

// Ctor Parameters []
explicit AppDomain() ;

/// @brief Method .ctor addr 0x24b8700 size 0x4 virtual false final false
 void _ctor() ;

/// @brief Method getFriendlyName addr 0x24b8708 size 0x4 virtual false final false
 ::StringW getFriendlyName() ;

/// @brief Method getCurDomain addr 0x24b870c size 0x4 virtual false final false
static System::AppDomain getCurDomain() ;

/// @brief Method get_CurrentDomain addr 0x24b8710 size 0x4 virtual false final false
static System::AppDomain get_CurrentDomain() ;

/// @brief Method GetAssemblies addr 0x24b8714 size 0x8 virtual false final false
 ::ArrayW<System::Reflection::Assembly> GetAssemblies(bool refOnly) ;

/// @brief Method GetAssemblies addr 0x24b871c size 0x8 virtual true final true
 ::ArrayW<System::Reflection::Assembly> GetAssemblies() ;

/// @brief Method GetData addr 0x24b8724 size 0x4 virtual true final true
 ::bs_hook::Il2CppWrapperType GetData(::StringW name) ;

/// @brief Method InitializeLifetimeService addr 0x24b8728 size 0x8 virtual true final false
 ::bs_hook::Il2CppWrapperType InitializeLifetimeService() ;

/// @brief Method LoadAssembly addr 0x24b8730 size 0x8 virtual false final false
...
/// @brief Method Load addr 0x24b8738 size 0x24 virtual true final true
 System::Reflection::Assembly Load(::StringW assemblyString) ;

/// @brief Method Load addr 0x24b875c size 0x110 virtual false final false
...
/// @brief Method InternalSetDomainByID addr 0x24b886c size 0x4 virtual false final false
static System::AppDomain InternalSetDomainByID(int32_t domain_id) ;

/// @brief Method InternalSetDomain addr 0x24b8870 size 0x4 virtual false final false
static System::AppDomain InternalSetDomain(System::AppDomain context) ;

/// @brief Method InternalPushDomainRefByID addr 0x24b8874 size 0x4 virtual false final false
static void InternalPushDomainRefByID(int32_t domain_id) ;

/// @brief Method InternalPopDomainRef addr 0x24b8878 size 0x4 virtual false final false
static void InternalPopDomainRef() ;

/// @brief Method InternalSetContext addr 0x24b887c size 0x4 virtual false final false
static System::Runtime::Remoting::Contexts::Context InternalSetContext(System::Runtime::Remoting::Contexts::Context context) ;

/// @brief Method InternalGetContext addr 0x24b8880 size 0x4 virtual false final false
static System::Runtime::Remoting::Contexts::Context InternalGetContext() ;

/// @brief Method InternalGetDefaultContext addr 0x24b8884 size 0x4 virtual false final false
static System::Runtime::Remoting::Contexts::Context InternalGetDefaultContext() ;

/// @brief Method InternalGetProcessGuid addr 0x24b8888 size 0x4 virtual false final false
static ::StringW InternalGetProcessGuid(::StringW newguid) ;

/// @brief Method InvokeInDomainByID addr 0x24b888c size 0x190 virtual false final false
...
/// @brief Method GetProcessGuid addr 0x24b8a1c size 0x88 virtual false final false
static ::StringW GetProcessGuid() ;

/// @brief Method InternalIsFinalizingForUnload addr 0x24b8aa4 size 0x4 virtual false final false
static bool InternalIsFinalizingForUnload(int32_t domain_id) ;

/// @brief Method IsFinalizingForUnload addr 0x24b8aa8 size 0x14 virtual false final false
 bool IsFinalizingForUnload() ;

/// @brief Method getDomainID addr 0x24b8abc size 0x8 virtual false final false
 int32_t getDomainID() ;

/// @brief Method ToString addr 0x24b8ac4 size 0x4 virtual true final false
 ::StringW ToString() ;

/// @brief Method DoAssemblyLoad addr 0x24b8ac8 size 0x98 virtual false final false
 void DoAssemblyLoad(System::Reflection::Assembly assembly) ;

/// @brief Method DoAssemblyResolve addr 0x24b8b60 size 0x310 virtual false final false
 System::Reflection::Assembly DoAssemblyResolve(::StringW name, System::Reflection::Assembly requestingAssembly, bool refonly) ;

/// @brief Method DoTypeResolve addr 0x24b8e70 size 0x2d0 virtual false final false
 System::Reflection::Assembly DoTypeResolve(::StringW name) ;

/// @brief Method DoDomainUnload addr 0x24b9140 size 0x24 virtual false final false
 void DoDomainUnload() ;

/// @brief Method GetMarshalledDomainObjRef addr 0x24b9164 size 0xd8 virtual false final false
 ::ArrayW<uint8_t> GetMarshalledDomainObjRef() ;

/// @brief Method ProcessMessageInDomain addr 0x24b923c size 0x130 virtual false final false
...
/// @brief Method add_DomainUnload addr 0x24b936c size 0x98 virtual true final true
 void add_DomainUnload(System::EventHandler value) ;

/// @brief Method remove_DomainUnload addr 0x24b9578 size 0x98 virtual true final true
 void remove_DomainUnload(System::EventHandler value) ;

/// @brief Method add_UnhandledException addr 0x24b9780 size 0x98 virtual true final true
 void add_UnhandledException(System::UnhandledExceptionEventHandler value) ;

/// @brief Method remove_UnhandledException addr 0x24b9818 size 0x98 virtual true final true
