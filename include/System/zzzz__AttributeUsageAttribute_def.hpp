...
/// @brief Method .ctor addr 0x23eb74c size 0x38 virtual false final false
 void _ctor(System::AttributeTargets validOn) ;

/// @brief Method get_AllowMultiple addr 0x23eb784 size 0x8 virtual false final false
 bool get_AllowMultiple() ;

/// @brief Method set_AllowMultiple addr 0x23eb78c size 0xc virtual false final false
 void set_AllowMultiple(bool value) ;

/// @brief Method get_Inherited addr 0x23eb798 size 0x8 virtual false final false
 bool get_Inherited() ;

/// @brief Method set_Inherited addr 0x23eb7a0 size 0xc virtual false final false
