...
/// @brief Method .ctor addr 0x245a5e8 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit DllNotFoundException(::StringW message) ;

/// @brief Method .ctor addr 0x245a644 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x245a668 size 0x8 virtual false final false
