...
/// @brief Method Init addr 0x246b810 size 0x24 virtual false final false
 void Init(System::ReadOnlySpan_1<char16_t> originalDateTimeString) ;

/// @brief Method SetDate addr 0x246b834 size 0xc virtual false final false
 void SetDate(int32_t year, int32_t month, int32_t day) ;

/// @brief Method SetBadFormatSpecifierFailure addr 0x246b840 size 0x94 virtual false final false
 void SetBadFormatSpecifierFailure() ;

/// @brief Method SetBadFormatSpecifierFailure addr 0x246b8d4 size 0x64 virtual false final false
 void SetBadFormatSpecifierFailure(System::ReadOnlySpan_1<char16_t> failedFormatSpecifier) ;

/// @brief Method SetBadDateTimeFailure addr 0x246b938 size 0x50 virtual false final false
 void SetBadDateTimeFailure() ;

/// @brief Method SetFailure addr 0x246b988 size 0xc virtual false final false
 void SetFailure(System::ParseFailureKind failure, ::StringW failureMessageID) ;

/// @brief Method SetFailure addr 0x246b994 size 0xc virtual false final false
...
/// @brief Method SetFailure addr 0x246b9a0 size 0x10 virtual false final false
