...
/// @brief Method EqualsOrdinal addr 0x2474b1c size 0x134 virtual false final false
static bool EqualsOrdinal(System::ReadOnlySpan_1<char16_t> span, System::ReadOnlySpan_1<char16_t> value) ;

/// @brief Method EqualsOrdinalIgnoreCase addr 0x2474c50 size 0xac virtual false final false
static bool EqualsOrdinalIgnoreCase(System::ReadOnlySpan_1<char16_t> span, System::ReadOnlySpan_1<char16_t> value) ;

/// @brief Method Contains addr 0x2474cfc size 0x78 virtual false final false
static bool Contains(System::ReadOnlySpan_1<char16_t> source, char16_t value) ;

/// @brief Method ToUpperInvariant addr 0x2474d74 size 0x158 virtual false final false
static int32_t ToUpperInvariant(System::ReadOnlySpan_1<char16_t> source, System::Span_1<char16_t> destination) ;

/// @brief Method EndsWith addr 0x2474ecc size 0x330 virtual false final false
...
/// @brief Method AsSpan addr 0x24751fc size 0x58 virtual false final false
static System::ReadOnlySpan_1<char16_t> AsSpan(::StringW text) ;

/// @brief Method AsSpan addr 0x2475254 size 0x8c virtual false final false
static System::ReadOnlySpan_1<char16_t> AsSpan(::StringW text, int32_t start) ;

/// @brief Method AsSpan addr 0x24752e0 size 0xa0 virtual false final false
static System::ReadOnlySpan_1<char16_t> AsSpan(::StringW text, int32_t start, int32_t length) ;

/// @brief Method Trim addr 0x246c3d8 size 0x10 virtual false final false
static System::ReadOnlySpan_1<char16_t> Trim(System::ReadOnlySpan_1<char16_t> span) ;

/// @brief Method TrimStart addr 0x2475380 size 0xf4 virtual false final false
static System::ReadOnlySpan_1<char16_t> TrimStart(System::ReadOnlySpan_1<char16_t> span) ;

/// @brief Method TrimEnd addr 0x2475474 size 0xf4 virtual false final false
