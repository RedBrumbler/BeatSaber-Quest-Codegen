...
/// @brief Method GenerateGlobalSeed addr 0x246e5c0 size 0x24 virtual false final false
...
/// @brief Method Rol addr 0x246e5e4 size 0xc virtual false final false
static uint32_t Rol(uint32_t value, int32_t count) ;

/// @brief Method Initialize addr 0x246e5f0 size 0xb8 virtual false final false
static void Initialize(ByRef<uint32_t> v1, ByRef<uint32_t> v2, ByRef<uint32_t> v3, ByRef<uint32_t> v4) ;

/// @brief Method Round addr 0x246e6a8 size 0x78 virtual false final false
static uint32_t Round(uint32_t hash, uint32_t input) ;

/// @brief Method QueueRound addr 0x246e720 size 0x78 virtual false final false
static uint32_t QueueRound(uint32_t hash, uint32_t queuedValue) ;

/// @brief Method MixState addr 0x246e798 size 0x88 virtual false final false
static uint32_t MixState(uint32_t v1, uint32_t v2, uint32_t v3, uint32_t v4) ;

/// @brief Method MixFinal addr 0x246e820 size 0x28 virtual false final false
static uint32_t MixFinal(uint32_t hash) ;

/// @brief Method GetHashCode addr 0x246e848 size 0x4c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x246e8b8 size 0x4c virtual true final false
