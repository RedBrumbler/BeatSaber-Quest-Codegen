...
/// @brief Method .ctor addr 0x2489d84 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Compare addr 0x248a61c size 0x10 virtual true final false
 int32_t Compare(::StringW x, ::StringW y) ;

/// @brief Method Equals addr 0x248a62c size 0x10 virtual true final false
 bool Equals(::StringW x, ::StringW y) ;

/// @brief Method GetHashCode addr 0x248a63c size 0x20 virtual true final false
 int32_t GetHashCode(::StringW obj) ;

/// @brief Method GetObjectData addr 0x248a65c size 0xb4 virtual true final true
