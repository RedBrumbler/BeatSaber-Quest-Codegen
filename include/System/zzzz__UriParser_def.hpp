...
/// @brief Method get_SchemeName addr 0x27e87b0 size 0x8 virtual false final false
 ::StringW get_SchemeName() ;

/// @brief Method get_DefaultPort addr 0x27e87b8 size 0x8 virtual false final false
 int32_t get_DefaultPort() ;

/// @brief Method OnNewUri addr 0x27e87c0 size 0x4 virtual true final false
 System::UriParser OnNewUri() ;

/// @brief Method InitializeAndValidate addr 0x27e87c4 size 0x28 virtual true final false
 void InitializeAndValidate(System::Uri uri, ByRef<System::UriFormatException> parsingError) ;

/// @brief Method Resolve addr 0x27e87ec size 0x1e8 virtual true final false
 ::StringW Resolve(System::Uri baseUri, System::Uri relativeUri, ByRef<System::UriFormatException> parsingError) ;

/// @brief Method IsBaseOf addr 0x27e89d4 size 0x1c virtual true final false
 bool IsBaseOf(System::Uri baseUri, System::Uri relativeUri) ;

/// @brief Method GetComponents addr 0x27e89f0 size 0x22c virtual true final false
 ::StringW GetComponents(System::Uri uri, System::UriComponents components, System::UriFormat format) ;

/// @brief Method IsWellFormedOriginalString addr 0x27e8c1c size 0x18 virtual true final false
 bool IsWellFormedOriginalString(System::Uri uri) ;

/// @brief Method get_ShouldUseLegacyV2Quirks addr 0x27e8620 size 0x60 virtual false final false
static bool get_ShouldUseLegacyV2Quirks() ;

/// @brief Method get_Flags addr 0x27e9438 size 0x8 virtual false final false
 System::UriSyntaxFlags get_Flags() ;

/// @brief Method NotAny addr 0x27e5494 size 0x8 virtual false final false
 bool NotAny(System::UriSyntaxFlags flags) ;

/// @brief Method InFact addr 0x27e5478 size 0x1c virtual false final false
 bool InFact(System::UriSyntaxFlags flags) ;

/// @brief Method IsAllSet addr 0x27e949c size 0x8 virtual false final false
 bool IsAllSet(System::UriSyntaxFlags flags) ;

/// @brief Method IsFullMatch addr 0x27e9440 size 0x5c virtual false final false
...
/// @brief Method .ctor addr 0x27e94a4 size 0x6c virtual false final false
 void _ctor(System::UriSyntaxFlags flags) ;

/// @brief Method FindOrFetchAsUnknownV1Syntax addr 0x27e9510 size 0x2f0 virtual false final false
static System::UriParser FindOrFetchAsUnknownV1Syntax(::StringW lwrCaseScheme) ;

/// @brief Method GetSyntax addr 0x27e53a8 size 0xd0 virtual false final false
static System::UriParser GetSyntax(::StringW lwrCaseScheme) ;

/// @brief Method get_IsSimple addr 0x27e9800 size 0xc virtual false final false
 bool get_IsSimple() ;

/// @brief Method InternalOnNewUri addr 0x27e980c size 0x44 virtual false final false
 System::UriParser InternalOnNewUri() ;

/// @brief Method InternalValidate addr 0x27e9850 size 0xc virtual false final false
 void InternalValidate(System::Uri thisUri, ByRef<System::UriFormatException> parsingError) ;

/// @brief Method InternalResolve addr 0x27e985c size 0xc virtual false final false
 ::StringW InternalResolve(System::Uri thisBaseUri, System::Uri uriLink, ByRef<System::UriFormatException> parsingError) ;

/// @brief Method InternalIsBaseOf addr 0x27e9868 size 0xc virtual false final false
 bool InternalIsBaseOf(System::Uri thisBaseUri, System::Uri uriLink) ;

/// @brief Method InternalGetComponents addr 0x27e9874 size 0xc virtual false final false
 ::StringW InternalGetComponents(System::Uri thisUri, System::UriComponents uriComponents, System::UriFormat uriFormat) ;

/// @brief Method InternalIsWellFormedOriginalString addr 0x27e9880 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x27e93b8 size 0x80 virtual false final false
