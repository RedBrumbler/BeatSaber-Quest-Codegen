...
/// @brief Method get_PropertyName addr 0x27b3dd0 size 0x8 virtual false final false
 ::StringW get_PropertyName() ;

/// @brief Method get_ReceiverTypeName addr 0x27b3dd8 size 0x8 virtual false final false
