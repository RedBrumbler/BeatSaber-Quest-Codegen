...
/// @brief Method CanConvertFrom addr 0x27b6e04 size 0xa8 virtual true final false
 bool CanConvertFrom(System::ComponentModel::ITypeDescriptorContext context, System::Type sourceType) ;

/// @brief Method ConvertFrom addr 0x27b6eac size 0x84 virtual true final false
...
/// @brief Method .ctor addr 0x27b6f30 size 0x8 virtual false final false
 void _ctor() ;
