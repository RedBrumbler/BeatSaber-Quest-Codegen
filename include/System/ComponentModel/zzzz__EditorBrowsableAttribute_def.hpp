...
/// @brief Method .ctor addr 0x27a2140 size 0x28 virtual false final false
 void _ctor(System::ComponentModel::EditorBrowsableState state) ;

/// @brief Method Equals addr 0x27a2168 size 0x8c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x27a21f4 size 0x8 virtual true final false
 int32_t GetHashCode() ;
