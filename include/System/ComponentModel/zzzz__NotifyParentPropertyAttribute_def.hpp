...
/// @brief Method .ctor addr 0x27d7ef4 size 0x28 virtual false final false
 void _ctor(bool notifyParent) ;

/// @brief Method get_NotifyParent addr 0x27d7f1c size 0x8 virtual false final false
 bool get_NotifyParent() ;

/// @brief Method Equals addr 0x27d7f24 size 0x80 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x27d7fa4 size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method IsDefaultAttribute addr 0x27d7fac size 0x68 virtual true final false
