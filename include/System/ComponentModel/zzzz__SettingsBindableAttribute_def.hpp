...
/// @brief Method .ctor addr 0x27b6a38 size 0x28 virtual false final false
 void _ctor(bool bindable) ;

/// @brief Method get_Bindable addr 0x27b6a60 size 0x8 virtual false final false
 bool get_Bindable() ;

/// @brief Method Equals addr 0x27b6a68 size 0x8c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x27b6af4 size 0x20 virtual true final false
 int32_t GetHashCode() ;
