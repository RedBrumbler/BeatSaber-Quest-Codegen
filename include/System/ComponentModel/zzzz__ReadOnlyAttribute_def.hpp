...
/// @brief Method .ctor addr 0x27a3760 size 0x28 virtual false final false
 void _ctor(bool isReadOnly) ;

/// @brief Method get_IsReadOnly addr 0x27a3788 size 0x8 virtual false final false
 bool get_IsReadOnly() ;

/// @brief Method Equals addr 0x27a3790 size 0xe4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetHashCode addr 0x27a3874 size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method IsDefaultAttribute addr 0x27a387c size 0x80 virtual true final false
