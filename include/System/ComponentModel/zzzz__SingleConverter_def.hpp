...
/// @brief Method get_AllowHex addr 0x27b6ba8 size 0x8 virtual true final false
 bool get_AllowHex() ;

/// @brief Method get_TargetType addr 0x27b6bb0 size 0x6c virtual true final false
 System::Type get_TargetType() ;

/// @brief Method FromString addr 0x27b6c1c size 0xc0 virtual true final false
 ::bs_hook::Il2CppWrapperType FromString(::StringW value, int32_t radix) ;

/// @brief Method FromString addr 0x27b6cdc size 0x70 virtual true final false
 ::bs_hook::Il2CppWrapperType FromString(::StringW value, System::Globalization::NumberFormatInfo formatInfo) ;

/// @brief Method ToString addr 0x27b6d4c size 0xb0 virtual true final false
...
/// @brief Method .ctor addr 0x27b6dfc size 0x8 virtual false final false
 void _ctor() ;
