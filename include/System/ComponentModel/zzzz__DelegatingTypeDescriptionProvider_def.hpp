...
/// @brief Method .ctor addr 0x27acecc size 0x28 virtual false final false
 void _ctor(System::Type type) ;

/// @brief Method get_Provider addr 0x27acef4 size 0x5c virtual false final false
 System::ComponentModel::TypeDescriptionProvider get_Provider() ;

/// @brief Method GetCache addr 0x27acf50 size 0x28 virtual true final false
 System::Collections::IDictionary GetCache(::bs_hook::Il2CppWrapperType instance) ;

/// @brief Method GetExtendedTypeDescriptor addr 0x27acf78 size 0x28 virtual true final false
 System::ComponentModel::ICustomTypeDescriptor GetExtendedTypeDescriptor(::bs_hook::Il2CppWrapperType instance) ;

/// @brief Method GetExtenderProviders addr 0x27acfa0 size 0x28 virtual true final false
 ::ArrayW<System::ComponentModel::IExtenderProvider> GetExtenderProviders(::bs_hook::Il2CppWrapperType instance) ;

/// @brief Method GetReflectionType addr 0x27acfc8 size 0x38 virtual true final false
 System::Type GetReflectionType(System::Type objectType, ::bs_hook::Il2CppWrapperType instance) ;

/// @brief Method GetTypeDescriptor addr 0x27ad000 size 0x38 virtual true final false
