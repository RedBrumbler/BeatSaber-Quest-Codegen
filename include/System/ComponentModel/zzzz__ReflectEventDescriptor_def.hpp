...
namespace System::ComponentModel {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8293))}
...
/// @brief Method .ctor addr 0x27b5460 size 0x178 virtual false final false
 void _ctor(System::Type componentClass, System::Reflection::EventInfo eventInfo) ;

/// @brief Method FillAttributes addr 0x27b55d8 size 0x64 virtual true final false
 void FillAttributes(System::Collections::IList attributes) ;

/// @brief Method FillEventInfoAttribute addr 0x27b5a84 size 0x328 virtual false final false
 void FillEventInfoAttribute(System::Reflection::EventInfo realEventInfo, System::Collections::IList attributes) ;

/// @brief Method FillMethods addr 0x27b563c size 0x448 virtual false final false
 void FillMethods() ;

/// @brief Method FillSingleMethodAttribute addr 0x27b5dac size 0x368 virtual false final false
