...
/// @brief Method .ctor addr 0x27ad510 size 0x90 virtual false final false
 void _ctor(::StringW typeName, ::StringW baseTypeName) ;

/// @brief Method get_EditorBaseTypeName addr 0x27ad5a0 size 0x8 virtual false final false
 ::StringW get_EditorBaseTypeName() ;

/// @brief Method get_EditorTypeName addr 0x27ad5a8 size 0x8 virtual false final false
 ::StringW get_EditorTypeName() ;

/// @brief Method get_TypeId addr 0x27ad5b0 size 0x8c virtual true final false
 ::bs_hook::Il2CppWrapperType get_TypeId() ;

/// @brief Method Equals addr 0x27ad63c size 0xa4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x27ad6e0 size 0x8 virtual true final false
 int32_t GetHashCode() ;
