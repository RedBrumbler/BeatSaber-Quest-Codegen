...
/// @brief Method .ctor addr 0x27bb898 size 0x1a4 virtual false final false
...
/// @brief Method .ctor addr 0x27bba3c size 0x428 virtual false final false
 void _ctor(System::ComponentModel::MemberDescriptor oldMemberDescriptor, ::ArrayW<System::Attribute> newAttributes) ;

/// @brief Method get_AttributeArray addr 0x27bbe64 size 0x20 virtual true final false
 ::ArrayW<System::Attribute> get_AttributeArray() ;

/// @brief Method set_AttributeArray addr 0x27bc67c size 0xc4 virtual true final false
 void set_AttributeArray(::ArrayW<System::Attribute> value) ;

/// @brief Method get_Attributes addr 0x27bc740 size 0xe8 virtual true final false
 System::ComponentModel::AttributeCollection get_Attributes() ;

/// @brief Method get_Name addr 0x27bc828 size 0x50 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_NameHashCode addr 0x27bc878 size 0x8 virtual true final false
 int32_t get_NameHashCode() ;

/// @brief Method get_DisplayName addr 0x27bc880 size 0x128 virtual true final false
 ::StringW get_DisplayName() ;

/// @brief Method CheckAttributesValid addr 0x27bbe84 size 0xb0 virtual false final false
 void CheckAttributesValid() ;

/// @brief Method CreateAttributeCollection addr 0x27bc9a8 size 0x7c virtual true final false
 System::ComponentModel::AttributeCollection CreateAttributeCollection() ;

/// @brief Method Equals addr 0x27bca24 size 0x264 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method FillAttributes addr 0x27b6114 size 0xf4 virtual true final false
 void FillAttributes(System::Collections::IList attributeList) ;

/// @brief Method FilterAttributesIfNeeded addr 0x27bbf34 size 0x748 virtual false final false
 void FilterAttributesIfNeeded() ;

/// @brief Method FindMethod addr 0x27b6658 size 0x8 virtual false final false
...
/// @brief Method FindMethod addr 0x27bcc88 size 0xa4 virtual false final false
...
/// @brief Method GetHashCode addr 0x27bcd2c size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method GetInvocationTarget addr 0x27bcd34 size 0x110 virtual true final false
 ::bs_hook::Il2CppWrapperType GetInvocationTarget(System::Type type, ::bs_hook::Il2CppWrapperType instance) ;

/// @brief Method GetSite addr 0x27bd518 size 0xfc virtual false final false
