...
/// @brief Method .ctor addr 0x24f8f70 size 0x78 virtual false final false
 void _ctor(::StringW propertyName) ;

/// @brief Method get_PropertyName addr 0x24f8fe8 size 0x8 virtual true final false
 ::StringW get_PropertyName() ;

/// @brief Method set_PropertyName addr 0x24f8ff0 size 0x8 virtual true final false
