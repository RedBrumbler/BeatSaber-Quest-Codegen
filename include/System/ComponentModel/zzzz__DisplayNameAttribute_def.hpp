...
/// @brief Method .ctor addr 0x27a3390 size 0x5c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x27a33ec size 0x28 virtual false final false
 void _ctor(::StringW displayName) ;

/// @brief Method get_DisplayName addr 0x27a3414 size 0x8 virtual true final false
 ::StringW get_DisplayName() ;

/// @brief Method get_DisplayNameValue addr 0x27a341c size 0x8 virtual false final false
 ::StringW get_DisplayNameValue() ;

/// @brief Method set_DisplayNameValue addr 0x27a3424 size 0x8 virtual false final false
 void set_DisplayNameValue(::StringW value) ;

/// @brief Method Equals addr 0x27a342c size 0xcc virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x27a34f8 size 0x28 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method IsDefaultAttribute addr 0x27a3520 size 0x68 virtual true final false
