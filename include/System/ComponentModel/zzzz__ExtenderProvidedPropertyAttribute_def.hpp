...
/// @brief Method Create addr 0x27aeb00 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x27aef60 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_ExtenderProperty addr 0x27aef68 size 0x8 virtual false final false
 System::ComponentModel::PropertyDescriptor get_ExtenderProperty() ;

/// @brief Method set_ExtenderProperty addr 0x27aef70 size 0x8 virtual false final false
 void set_ExtenderProperty(System::ComponentModel::PropertyDescriptor value) ;

/// @brief Method get_Provider addr 0x27aef78 size 0x8 virtual false final false
 System::ComponentModel::IExtenderProvider get_Provider() ;

/// @brief Method set_Provider addr 0x27aef80 size 0x8 virtual false final false
 void set_Provider(System::ComponentModel::IExtenderProvider value) ;

/// @brief Method get_ReceiverType addr 0x27aef88 size 0x8 virtual false final false
 System::Type get_ReceiverType() ;

/// @brief Method set_ReceiverType addr 0x27aef90 size 0x8 virtual false final false
 void set_ReceiverType(System::Type value) ;

/// @brief Method Equals addr 0x27aef98 size 0xd4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x27af06c size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method IsDefaultAttribute addr 0x27af074 size 0x60 virtual true final false
