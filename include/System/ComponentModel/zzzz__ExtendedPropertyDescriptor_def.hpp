...
/// @brief Method .ctor addr 0x27ae8a8 size 0x250 virtual false final false
...
/// @brief Method CanResetValue addr 0x27aeb78 size 0x28 virtual true final false
 bool CanResetValue(::bs_hook::Il2CppWrapperType comp) ;

/// @brief Method get_ComponentType addr 0x27aeba0 size 0x24 virtual true final false
 System::Type get_ComponentType() ;

/// @brief Method get_IsReadOnly addr 0x27aebc4 size 0xf8 virtual true final false
 bool get_IsReadOnly() ;

/// @brief Method get_PropertyType addr 0x27aecbc size 0x24 virtual true final false
 System::Type get_PropertyType() ;

/// @brief Method get_DisplayName addr 0x27aece0 size 0x1dc virtual true final false
 ::StringW get_DisplayName() ;

/// @brief Method GetValue addr 0x27aeebc size 0x28 virtual true final false
 ::bs_hook::Il2CppWrapperType GetValue(::bs_hook::Il2CppWrapperType comp) ;

/// @brief Method ResetValue addr 0x27aeee4 size 0x28 virtual true final false
 void ResetValue(::bs_hook::Il2CppWrapperType comp) ;

/// @brief Method SetValue addr 0x27aef0c size 0x2c virtual true final false
 void SetValue(::bs_hook::Il2CppWrapperType component, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method ShouldSerializeValue addr 0x27aef38 size 0x28 virtual true final false
