...
/// @brief Method .ctor addr 0x27a315c size 0x28 virtual false final false
 void _ctor(System::ComponentModel::DesignerSerializationVisibility visibility) ;

/// @brief Method get_Visibility addr 0x27a3184 size 0x8 virtual false final false
 System::ComponentModel::DesignerSerializationVisibility get_Visibility() ;

/// @brief Method Equals addr 0x27a318c size 0xd8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x27a3264 size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method IsDefaultAttribute addr 0x27a326c size 0x68 virtual true final false
