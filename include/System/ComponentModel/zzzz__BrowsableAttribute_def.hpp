...
/// @brief Method .ctor addr 0x27a21fc size 0x28 virtual false final false
 void _ctor(bool browsable) ;

/// @brief Method get_Browsable addr 0x27a2224 size 0x8 virtual false final false
 bool get_Browsable() ;

/// @brief Method Equals addr 0x27a222c size 0xe4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x27a2310 size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method IsDefaultAttribute addr 0x27a2330 size 0x68 virtual true final false
