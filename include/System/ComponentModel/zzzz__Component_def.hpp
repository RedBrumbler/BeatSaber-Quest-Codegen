...
/// @brief Method Finalize addr 0x27b851c size 0xa0 virtual true final false
 void Finalize() ;

/// @brief Method get_CanRaiseEvents addr 0x27b85bc size 0x8 virtual true final false
 bool get_CanRaiseEvents() ;

/// @brief Method get_CanRaiseEventsInternal addr 0x27b85c4 size 0xc virtual false final false
 bool get_CanRaiseEventsInternal() ;

/// @brief Method get_Site addr 0x27b85d0 size 0x8 virtual true final false
 System::ComponentModel::ISite get_Site() ;

/// @brief Method Dispose addr 0x27b85d8 size 0x6c virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x27b8644 size 0x304 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method GetService addr 0x27b8948 size 0xb4 virtual true final false
 ::bs_hook::Il2CppWrapperType GetService(System::Type service) ;

/// @brief Method get_DesignMode addr 0x27b89fc size 0xb0 virtual false final false
 bool get_DesignMode() ;

/// @brief Method ToString addr 0x27b8aac size 0x130 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit Component() ;

/// @brief Method .ctor addr 0x27b8bdc size 0x8 virtual false final false
 void _ctor() ;
