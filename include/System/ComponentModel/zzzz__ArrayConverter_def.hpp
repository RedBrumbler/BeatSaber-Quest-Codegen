...
namespace System::ComponentModel {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8348))}
...
/// @brief Method .ctor addr 0x27a3d38 size 0xb8 virtual false final false
 void _ctor(System::Type arrayType, System::Type elementType, int32_t index) ;

/// @brief Method GetValue addr 0x27a3ef0 size 0xb4 virtual true final false
 ::bs_hook::Il2CppWrapperType GetValue(::bs_hook::Il2CppWrapperType instance) ;

/// @brief Method SetValue addr 0x27a3fa4 size 0x100 virtual true final false
...
namespace System::ComponentModel {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8338))}
...
/// @brief Method ConvertTo addr 0x27a3998 size 0x1cc virtual true final false
...
/// @brief Method GetProperties addr 0x27a3b64 size 0x1d4 virtual true final false
...
/// @brief Method GetPropertiesSupported addr 0x27a3ee0 size 0x8 virtual true final false
 bool GetPropertiesSupported(System::ComponentModel::ITypeDescriptorContext context) ;

// Ctor Parameters []
explicit ArrayConverter() ;

/// @brief Method .ctor addr 0x27a3ee8 size 0x8 virtual false final false
 void _ctor() ;
