...
/// @brief Method .ctor addr 0x27a2e58 size 0x5c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x27a2eb4 size 0x28 virtual false final false
 void _ctor(::StringW category) ;

/// @brief Method get_Category addr 0x27a2edc size 0x8 virtual false final false
 ::StringW get_Category() ;

/// @brief Method Equals addr 0x27a2ee4 size 0x90 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x27a2f74 size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method IsDefaultAttribute addr 0x27a2f94 size 0x78 virtual true final false
 bool IsDefaultAttribute() ;

/// @brief Method get_TypeId addr 0x27a300c size 0x38 virtual true final false
