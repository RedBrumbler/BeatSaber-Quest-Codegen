...
/// @brief Method .ctor addr 0x27d73cc size 0x74 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "error", ty: "int32_t", modifiers: "", def_value: None }]
explicit Win32Exception(int32_t error) ;

/// @brief Method .ctor addr 0x27d7440 size 0x38 virtual false final false
...
/// @brief Method .ctor addr 0x27d7d6c size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x27d7d98 size 0x88 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method get_NativeErrorCode addr 0x27d7e20 size 0x8 virtual false final false
 int32_t get_NativeErrorCode() ;

/// @brief Method GetObjectData addr 0x27d7e28 size 0xcc virtual true final false
 void GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method GetErrorMessage addr 0x27d7478 size 0x8f4 virtual false final false
