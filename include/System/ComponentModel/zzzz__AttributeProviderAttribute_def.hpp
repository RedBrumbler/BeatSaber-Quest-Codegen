...
/// @brief Method get_TypeName addr 0x27a4de0 size 0x8 virtual false final false
 ::StringW get_TypeName() ;

/// @brief Method get_PropertyName addr 0x27a4de8 size 0x8 virtual false final false
