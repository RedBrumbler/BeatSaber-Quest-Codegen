...
/// @brief Method .ctor addr 0x27a2c10 size 0x28 virtual false final false
 void _ctor(bool isDesignOnly) ;

/// @brief Method get_IsDesignOnly addr 0x27a2c38 size 0x8 virtual false final false
 bool get_IsDesignOnly() ;

/// @brief Method Equals addr 0x27a2c40 size 0xe4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x27a2d24 size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method IsDefaultAttribute addr 0x27a2d44 size 0x80 virtual true final false
