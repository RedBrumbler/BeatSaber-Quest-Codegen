...
/// @brief Method .ctor addr 0x27d8c30 size 0x3c virtual false final false
 void _ctor(::StringW serializerTypeName, ::StringW baseSerializerTypeName, bool reloadable) ;

/// @brief Method get_SerializerBaseTypeName addr 0x27d8c6c size 0x8 virtual false final false
 ::StringW get_SerializerBaseTypeName() ;

/// @brief Method get_TypeId addr 0x27d8c74 size 0x8c virtual true final false
