...
/// @brief Method .ctor addr 0x27b9d34 size 0x28 virtual false final false
 void _ctor(System::Type type) ;

/// @brief Method CanConvertFrom addr 0x27b9d5c size 0xf0 virtual true final false
 bool CanConvertFrom(System::ComponentModel::ITypeDescriptorContext context, System::Type sourceType) ;

/// @brief Method CanConvertTo addr 0x27b9e4c size 0xf0 virtual true final false
 bool CanConvertTo(System::ComponentModel::ITypeDescriptorContext context, System::Type destinationType) ;

/// @brief Method get_Comparer addr 0x27b9f3c size 0x58 virtual true final false
 System::Collections::IComparer get_Comparer() ;

/// @brief Method ConvertFrom addr 0x27b9f94 size 0x4fc virtual true final false
...
/// @brief Method ConvertTo addr 0x27ba490 size 0xd90 virtual true final false
...
/// @brief Method GetStandardValues addr 0x27bb298 size 0x3f0 virtual true final false
...
/// @brief Method GetStandardValuesExclusive addr 0x27bb77c size 0xa8 virtual true final false
 bool GetStandardValuesExclusive(System::ComponentModel::ITypeDescriptorContext context) ;

/// @brief Method GetStandardValuesSupported addr 0x27bb824 size 0x8 virtual true final false
 bool GetStandardValuesSupported(System::ComponentModel::ITypeDescriptorContext context) ;

/// @brief Method IsValid addr 0x27bb82c size 0x6c virtual true final false
