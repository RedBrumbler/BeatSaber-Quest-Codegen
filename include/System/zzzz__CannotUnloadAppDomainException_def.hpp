...
/// @brief Method .ctor addr 0x2495cec size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit CannotUnloadAppDomainException(::StringW message) ;

/// @brief Method .ctor addr 0x2495d44 size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0x2495d64 size 0x4 virtual false final false
