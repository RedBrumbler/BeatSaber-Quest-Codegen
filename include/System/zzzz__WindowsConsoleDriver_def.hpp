...
/// @brief Method .ctor addr 0x24cdee8 size 0x54 virtual false final false
 void _ctor() ;

/// @brief Method ReadKey addr 0x24ce054 size 0x140 virtual true final true
 System::ConsoleKeyInfo ReadKey(bool intercept) ;

/// @brief Method IsModifierKey addr 0x24ce29c size 0x34 virtual false final false
static bool IsModifierKey(int16_t virtualKeyCode) ;

/// @brief Method GetStdHandle addr 0x24cdf3c size 0x84 virtual false final false
static ::cordl_internals::intptr_t GetStdHandle(System::Handles handle) ;

/// @brief Method GetConsoleScreenBufferInfo addr 0x24cdfc0 size 0x94 virtual false final false
static bool GetConsoleScreenBufferInfo(::cordl_internals::intptr_t handle, ByRef<System::ConsoleScreenBufferInfo> info) ;

/// @brief Method ReadConsoleInput addr 0x24ce194 size 0x108 virtual false final false
