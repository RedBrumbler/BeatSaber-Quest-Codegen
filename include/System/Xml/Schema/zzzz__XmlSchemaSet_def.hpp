...
/// @brief Method .ctor addr 0x27685e0 size 0x64 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2768644 size 0x288 virtual false final false
 void _ctor(System::Xml::XmlNameTable nameTable) ;

/// @brief Method InternalValidationCallback addr 0x27688cc size 0x44 virtual false final false
