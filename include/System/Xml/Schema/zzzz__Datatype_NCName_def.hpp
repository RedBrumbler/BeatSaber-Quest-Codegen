...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11619))}
...
/// @brief Method get_TypeCode addr 0x275aeec size 0x8 virtual true final false
 System::Xml::Schema::XmlTypeCode get_TypeCode() ;

/// @brief Method TryParseValue addr 0x275aef4 size 0xfc virtual true final false
...
/// @brief Method .ctor addr 0x275aff0 size 0x4 virtual false final false
 void _ctor() ;
