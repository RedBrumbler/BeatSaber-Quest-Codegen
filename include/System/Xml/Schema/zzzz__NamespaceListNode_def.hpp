...
/// @brief Method .ctor addr 0x274d490 size 0x2c virtual false final false
 void _ctor(System::Xml::Schema::NamespaceList namespaceList, ::bs_hook::Il2CppWrapperType particle) ;

/// @brief Method GetResolvedSymbols addr 0x274d4bc size 0x20 virtual true final false
 System::Collections::ICollection GetResolvedSymbols(System::Xml::Schema::SymbolsDictionary symbols) ;

/// @brief Method ExpandTree addr 0x274d4dc size 0x478 virtual true final false
...
/// @brief Method ConstructPos addr 0x274d95c size 0x40 virtual true final false
...
/// @brief Method get_IsNullable addr 0x274d99c size 0x40 virtual true final false
 bool get_IsNullable() ;
