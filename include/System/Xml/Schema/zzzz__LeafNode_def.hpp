...
/// @brief Method .ctor addr 0x274d40c size 0x28 virtual false final false
 void _ctor(int32_t pos) ;

/// @brief Method get_Pos addr 0x274d434 size 0x8 virtual false final false
 int32_t get_Pos() ;

/// @brief Method set_Pos addr 0x274d43c size 0x8 virtual false final false
 void set_Pos(int32_t value) ;

/// @brief Method ExpandTree addr 0x274d444 size 0x4 virtual true final false
...
/// @brief Method ConstructPos addr 0x274d448 size 0x40 virtual true final false
...
/// @brief Method get_IsNullable addr 0x274d488 size 0x8 virtual true final false
 bool get_IsNullable() ;
