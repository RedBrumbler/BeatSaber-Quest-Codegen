...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11688))}
...
/// @brief Method get_Items addr 0x27685d8 size 0x8 virtual true final false
 System::Xml::Schema::XmlSchemaObjectCollection get_Items() ;

// Ctor Parameters []
explicit XmlSchemaSequence() ;

/// @brief Method .ctor addr 0x2767390 size 0x64 virtual false final false
 void _ctor() ;
