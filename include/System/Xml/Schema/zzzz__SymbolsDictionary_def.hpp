...
/// @brief Method .ctor addr 0x274c350 size 0xa4 virtual false final false
 void _ctor() ;

/// @brief Method get_Count addr 0x274c3f4 size 0xc virtual false final false
 int32_t get_Count() ;

/// @brief Method get_IsUpaEnforced addr 0x274c400 size 0x8 virtual false final false
 bool get_IsUpaEnforced() ;

/// @brief Method set_IsUpaEnforced addr 0x274c408 size 0xc virtual false final false
 void set_IsUpaEnforced(bool value) ;

/// @brief Method AddName addr 0x274c414 size 0x134 virtual false final false
 int32_t AddName(System::Xml::XmlQualifiedName name, ::bs_hook::Il2CppWrapperType particle) ;

/// @brief Method AddNamespaceList addr 0x274c548 size 0x39c virtual false final false
 void AddNamespaceList(System::Xml::Schema::NamespaceList list, ::bs_hook::Il2CppWrapperType particle, bool allowLocal) ;

/// @brief Method AddWildcard addr 0x274c8e4 size 0x168 virtual false final false
 void AddWildcard(::StringW wildcard, ::bs_hook::Il2CppWrapperType particle) ;

/// @brief Method GetNamespaceListSymbols addr 0x274ca4c size 0x78c virtual false final false
 System::Collections::ICollection GetNamespaceListSymbols(System::Xml::Schema::NamespaceList list) ;

/// @brief Method Exists addr 0x274d1d8 size 0x30 virtual false final false
 bool Exists(System::Xml::XmlQualifiedName name) ;

/// @brief Method GetParticle addr 0x274d208 size 0x3c virtual false final false
