...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11561))}
...
/// @brief Method get_Max addr 0x274e530 size 0xc virtual false final false
 System::Decimal get_Max() ;

/// @brief Method get_Min addr 0x274e53c size 0xc virtual false final false
 System::Decimal get_Min() ;

/// @brief Method get_NextIteration addr 0x274e548 size 0x8 virtual false final false
 System::Xml::Schema::BitSet get_NextIteration() ;

/// @brief Method set_NextIteration addr 0x274e550 size 0x8 virtual false final false
