...
/// @brief Method .ctor addr 0x2779028 size 0x68 virtual false final false
 void _ctor(System::Xml::Schema::XmlSchemaType schemaType) ;

/// @brief Method Create addr 0x2779090 size 0x60 virtual false final false
static System::Xml::Schema::XmlValueConverter Create(System::Xml::Schema::XmlSchemaType schemaType) ;

/// @brief Method ToString addr 0x27790f0 size 0x210 virtual true final false
 ::StringW ToString(::bs_hook::Il2CppWrapperType value, System::Xml::IXmlNamespaceResolver nsResolver) ;

/// @brief Method ChangeType addr 0x2779300 size 0x29c virtual true final false
...
/// @brief Method ChangeType addr 0x277959c size 0x43c virtual true final false
