...
/// @brief Method set_ProcessContents addr 0x2766a6c size 0x8 virtual false final false
 void set_ProcessContents(System::Xml::Schema::XmlSchemaContentProcessing value) ;

/// @brief Method BuildNamespaceList addr 0x2766a74 size 0x90 virtual false final false
 void BuildNamespaceList(::StringW targetNamespace) ;

// Ctor Parameters []
explicit XmlSchemaAnyAttribute() ;

/// @brief Method .ctor addr 0x2766b04 size 0x8 virtual false final false
 void _ctor() ;
