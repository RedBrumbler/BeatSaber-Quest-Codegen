...
/// @brief Method get_FacetsChecker addr 0x275e040 size 0x58 virtual true final false
 System::Xml::Schema::FacetsChecker get_FacetsChecker() ;

/// @brief Method get_TypeCode addr 0x275e098 size 0x8 virtual true final false
 System::Xml::Schema::XmlTypeCode get_TypeCode() ;

// Ctor Parameters []
explicit Datatype_positiveInteger() ;

/// @brief Method .ctor addr 0x275e0a0 size 0x54 virtual false final false
 void _ctor() ;
