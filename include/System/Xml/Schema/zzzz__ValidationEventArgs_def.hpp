...
/// @brief Method get_Severity addr 0x2765420 size 0x8 virtual false final false
 System::Xml::Schema::XmlSeverityType get_Severity() ;

/// @brief Method get_Exception addr 0x2765428 size 0x8 virtual false final false
