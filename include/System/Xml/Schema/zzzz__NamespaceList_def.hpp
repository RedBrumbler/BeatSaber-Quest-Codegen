...
/// @brief Method .ctor addr 0x27632f8 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2763300 size 0x2a0 virtual false final false
 void _ctor(::StringW namespaces, ::StringW targetNamespace) ;

/// @brief Method get_Type addr 0x27635a0 size 0x8 virtual false final false
 System::Xml::Schema::System__Xml__Schema__NamespaceList__ListType get_Type() ;

/// @brief Method get_Excluded addr 0x27635a8 size 0x8 virtual false final false
 ::StringW get_Excluded() ;

/// @brief Method get_Enumerate addr 0x27635b0 size 0x6c virtual false final false
 System::Collections::ICollection get_Enumerate() ;

/// @brief Method Allows addr 0x276361c size 0x84 virtual true final false
 bool Allows(::StringW ns) ;

/// @brief Method Allows addr 0x27636a0 size 0x20 virtual false final false
 bool Allows(System::Xml::XmlQualifiedName qname) ;

/// @brief Method ToString addr 0x27636c0 size 0x4c8 virtual true final false
 ::StringW ToString() ;
