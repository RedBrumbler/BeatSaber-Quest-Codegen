...
/// @brief Method get_TokenizedType addr 0x275e7b0 size 0x8 virtual true final false
 System::Xml::XmlTokenizedType get_TokenizedType() ;

/// @brief Method ParseValue addr 0x275e7b8 size 0x274 virtual true final false
 ::bs_hook::Il2CppWrapperType ParseValue(::StringW s, System::Xml::XmlNameTable nameTable, System::Xml::IXmlNamespaceResolver nsmgr) ;

/// @brief Method get_ValueType addr 0x275ea2c size 0x58 virtual true final false
 System::Type get_ValueType() ;

/// @brief Method get_ListValueType addr 0x275ea84 size 0x58 virtual true final false
 System::Type get_ListValueType() ;

// Ctor Parameters []
explicit Datatype_QNameXdr() ;

/// @brief Method .ctor addr 0x275eadc size 0x54 virtual false final false
 void _ctor() ;
