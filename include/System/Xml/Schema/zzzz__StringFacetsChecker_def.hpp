...
/// @brief Method get_LanguagePattern addr 0x2761fe4 size 0xb8 virtual false final false
static System::Text::RegularExpressions::Regex get_LanguagePattern() ;

/// @brief Method CheckValueFacets addr 0x276209c size 0x60 virtual true final false
 System::Exception CheckValueFacets(::bs_hook::Il2CppWrapperType value, System::Xml::Schema::XmlSchemaDatatype datatype) ;

/// @brief Method CheckValueFacets addr 0x27620fc size 0x8 virtual true final false
 System::Exception CheckValueFacets(::StringW value, System::Xml::Schema::XmlSchemaDatatype datatype) ;

/// @brief Method CheckValueFacets addr 0x275a6fc size 0x200 virtual false final false
 System::Exception CheckValueFacets(::StringW value, System::Xml::Schema::XmlSchemaDatatype datatype, bool verifyUri) ;

/// @brief Method MatchEnumeration addr 0x27624f0 size 0x5c virtual true final false
...
/// @brief Method MatchEnumeration addr 0x276231c size 0x1d4 virtual false final false
...
/// @brief Method CheckBuiltInFacets addr 0x2762104 size 0x218 virtual false final false
...
/// @brief Method .ctor addr 0x276254c size 0x8 virtual false final false
 void _ctor() ;
