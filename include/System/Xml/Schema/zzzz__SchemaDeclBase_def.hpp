...
/// @brief Method .ctor addr 0x2763b8c size 0x88 virtual false final false
 void _ctor(System::Xml::XmlQualifiedName name, ::StringW prefix) ;

// Ctor Parameters []
explicit SchemaDeclBase() ;

/// @brief Method .ctor addr 0x2763c18 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method get_Name addr 0x27641b4 size 0x8 virtual false final false
 System::Xml::XmlQualifiedName get_Name() ;

/// @brief Method get_Prefix addr 0x2763cd4 size 0x54 virtual false final false
 ::StringW get_Prefix() ;

/// @brief Method get_IsDeclaredInExternal addr 0x27641bc size 0x8 virtual false final false
 bool get_IsDeclaredInExternal() ;

/// @brief Method set_IsDeclaredInExternal addr 0x27641c4 size 0xc virtual false final false
 void set_IsDeclaredInExternal(bool value) ;

/// @brief Method get_Presence addr 0x27641d0 size 0x8 virtual false final false
 System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use get_Presence() ;

/// @brief Method set_Presence addr 0x27641d8 size 0x8 virtual false final false
 void set_Presence(System::Xml::Schema::System__Xml__Schema__SchemaDeclBase__Use value) ;

/// @brief Method set_SchemaType addr 0x27641e0 size 0x8 virtual false final false
 void set_SchemaType(System::Xml::Schema::XmlSchemaType value) ;

/// @brief Method get_Datatype addr 0x27641e8 size 0x8 virtual false final false
 System::Xml::Schema::XmlSchemaDatatype get_Datatype() ;

/// @brief Method set_Datatype addr 0x27641f0 size 0x8 virtual false final false
 void set_Datatype(System::Xml::Schema::XmlSchemaDatatype value) ;

/// @brief Method AddValue addr 0x27641f8 size 0xf0 virtual false final false
 void AddValue(::StringW value) ;

/// @brief Method get_Values addr 0x27642e8 size 0x8 virtual false final false
 System::Collections::Generic::List_1<::StringW> get_Values() ;

/// @brief Method get_DefaultValueRaw addr 0x27642f0 size 0x54 virtual false final false
 ::StringW get_DefaultValueRaw() ;

/// @brief Method get_DefaultValueTyped addr 0x2764344 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_DefaultValueTyped() ;

/// @brief Method set_DefaultValueTyped addr 0x276434c size 0x8 virtual false final false
