...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11695))}
...
/// @brief Method set_ProcessContents addr 0x2766904 size 0x8 virtual false final false
 void set_ProcessContents(System::Xml::Schema::XmlSchemaContentProcessing value) ;

/// @brief Method get_NamespaceList addr 0x276690c size 0x8 virtual false final false
 System::Xml::Schema::NamespaceList get_NamespaceList() ;

/// @brief Method BuildNamespaceList addr 0x2766914 size 0x90 virtual false final false
 void BuildNamespaceList(::StringW targetNamespace) ;

// Ctor Parameters []
explicit XmlSchemaAny() ;

/// @brief Method .ctor addr 0x27669a4 size 0x54 virtual false final false
 void _ctor() ;
