...
/// @brief Method CheckValueFacets addr 0x2761480 size 0x114 virtual true final false
 System::Exception CheckValueFacets(::bs_hook::Il2CppWrapperType value, System::Xml::Schema::XmlSchemaDatatype datatype) ;

/// @brief Method CheckValueFacets addr 0x2761594 size 0x320 virtual true final false
 System::Exception CheckValueFacets(System::TimeSpan value, System::Xml::Schema::XmlSchemaDatatype datatype) ;

/// @brief Method MatchEnumeration addr 0x27619c0 size 0x78 virtual true final false
...
/// @brief Method MatchEnumeration addr 0x27618b4 size 0x10c virtual false final false
 bool MatchEnumeration(System::TimeSpan value, System::Collections::ArrayList enumeration) ;

// Ctor Parameters []
explicit DurationFacetsChecker() ;

/// @brief Method .ctor addr 0x2761a38 size 0x8 virtual false final false
 void _ctor() ;
