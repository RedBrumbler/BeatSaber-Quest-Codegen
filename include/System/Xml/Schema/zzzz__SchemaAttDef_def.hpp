...
/// @brief Method .ctor addr 0x2763b88 size 0x4 virtual false final false
 void _ctor(System::Xml::XmlQualifiedName name, ::StringW prefix) ;

// Ctor Parameters []
explicit SchemaAttDef() ;

/// @brief Method .ctor addr 0x2763c14 size 0x4 virtual false final false
 void _ctor() ;

/// @brief Method System.Xml.IDtdAttributeInfo.get_Prefix addr 0x2763c80 size 0x54 virtual true final true
 ::StringW System_Xml_IDtdAttributeInfo_get_Prefix() ;

/// @brief Method System.Xml.IDtdAttributeInfo.get_LocalName addr 0x2763d28 size 0x1c virtual true final true
 ::StringW System_Xml_IDtdAttributeInfo_get_LocalName() ;

/// @brief Method System.Xml.IDtdAttributeInfo.get_LineNumber addr 0x2763d44 size 0x8 virtual true final true
 int32_t System_Xml_IDtdAttributeInfo_get_LineNumber() ;

/// @brief Method System.Xml.IDtdAttributeInfo.get_LinePosition addr 0x2763d4c size 0x8 virtual true final true
 int32_t System_Xml_IDtdAttributeInfo_get_LinePosition() ;

/// @brief Method System.Xml.IDtdAttributeInfo.get_IsNonCDataType addr 0x2763d54 size 0x2c virtual true final true
 bool System_Xml_IDtdAttributeInfo_get_IsNonCDataType() ;

/// @brief Method System.Xml.IDtdAttributeInfo.get_IsDeclaredInExternal addr 0x2763da0 size 0x8 virtual true final true
 bool System_Xml_IDtdAttributeInfo_get_IsDeclaredInExternal() ;

/// @brief Method System.Xml.IDtdAttributeInfo.get_IsXmlAttribute addr 0x2763da8 size 0x10 virtual true final true
 bool System_Xml_IDtdAttributeInfo_get_IsXmlAttribute() ;

/// @brief Method System.Xml.IDtdDefaultAttributeInfo.get_DefaultValueExpanded addr 0x2763db8 size 0x54 virtual true final true
 ::StringW System_Xml_IDtdDefaultAttributeInfo_get_DefaultValueExpanded() ;

/// @brief Method System.Xml.IDtdDefaultAttributeInfo.get_DefaultValueTyped addr 0x2763e0c size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Xml_IDtdDefaultAttributeInfo_get_DefaultValueTyped() ;

/// @brief Method System.Xml.IDtdDefaultAttributeInfo.get_ValueLineNumber addr 0x2763e14 size 0x8 virtual true final true
 int32_t System_Xml_IDtdDefaultAttributeInfo_get_ValueLineNumber() ;

/// @brief Method System.Xml.IDtdDefaultAttributeInfo.get_ValueLinePosition addr 0x2763e1c size 0x8 virtual true final true
 int32_t System_Xml_IDtdDefaultAttributeInfo_get_ValueLinePosition() ;

/// @brief Method get_LinePosition addr 0x2763e24 size 0x8 virtual false final false
 int32_t get_LinePosition() ;

/// @brief Method set_LinePosition addr 0x2763e2c size 0x8 virtual false final false
 void set_LinePosition(int32_t value) ;

/// @brief Method get_LineNumber addr 0x2763e34 size 0x8 virtual false final false
 int32_t get_LineNumber() ;

/// @brief Method set_LineNumber addr 0x2763e3c size 0x8 virtual false final false
 void set_LineNumber(int32_t value) ;

/// @brief Method get_ValueLinePosition addr 0x2763e44 size 0x8 virtual false final false
 int32_t get_ValueLinePosition() ;

/// @brief Method set_ValueLinePosition addr 0x2763e4c size 0x8 virtual false final false
 void set_ValueLinePosition(int32_t value) ;

/// @brief Method get_ValueLineNumber addr 0x2763e54 size 0x8 virtual false final false
 int32_t get_ValueLineNumber() ;

/// @brief Method set_ValueLineNumber addr 0x2763e5c size 0x8 virtual false final false
 void set_ValueLineNumber(int32_t value) ;

/// @brief Method get_DefaultValueExpanded addr 0x2760088 size 0x54 virtual false final false
 ::StringW get_DefaultValueExpanded() ;

/// @brief Method set_DefaultValueExpanded addr 0x2763e64 size 0x8 virtual false final false
 void set_DefaultValueExpanded(::StringW value) ;

/// @brief Method get_TokenizedType addr 0x2763d80 size 0x20 virtual false final false
 System::Xml::XmlTokenizedType get_TokenizedType() ;

/// @brief Method set_TokenizedType addr 0x2763e6c size 0x1c virtual false final false
 void set_TokenizedType(System::Xml::XmlTokenizedType value) ;

/// @brief Method get_Reserved addr 0x2763ee0 size 0x8 virtual false final false
 System::Xml::Schema::System__Xml__Schema__SchemaAttDef__Reserve get_Reserved() ;

/// @brief Method set_Reserved addr 0x2763ee8 size 0x8 virtual false final false
 void set_Reserved(System::Xml::Schema::System__Xml__Schema__SchemaAttDef__Reserve value) ;

/// @brief Method CheckXmlSpace addr 0x2763ef0 size 0x264 virtual false final false
