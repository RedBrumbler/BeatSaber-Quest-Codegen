...
/// @brief Method .ctor addr 0x2768458 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Add addr 0x27673f4 size 0xb8 virtual false final false
 int32_t Add(System::Xml::Schema::XmlSchemaObject item) ;

/// @brief Method OnInsert addr 0x2768460 size 0x1c virtual true final false
 void OnInsert(int32_t index, ::bs_hook::Il2CppWrapperType item) ;

/// @brief Method OnSet addr 0x276847c size 0x5c virtual true final false
 void OnSet(int32_t index, ::bs_hook::Il2CppWrapperType oldValue, ::bs_hook::Il2CppWrapperType newValue) ;

/// @brief Method OnClear addr 0x27684d8 size 0x1c virtual true final false
 void OnClear() ;

/// @brief Method OnRemove addr 0x27684f4 size 0x1c virtual true final false
