...
/// @brief Method ParseValue addr 0x275f0cc size 0x2ac virtual true final false
 ::bs_hook::Il2CppWrapperType ParseValue(::StringW s, System::Xml::XmlNameTable nameTable, System::Xml::IXmlNamespaceResolver nsmgr) ;

/// @brief Method TryParseValue addr 0x275f61c size 0x158 virtual true final false
...
/// @brief Method .ctor addr 0x275f774 size 0x54 virtual false final false
 void _ctor() ;
