...
/// @brief Method .ctor addr 0x2764a04 size 0x84 virtual false final false
 void _ctor(System::Xml::XmlQualifiedName qname, bool isParameter) ;

/// @brief Method System.Xml.IDtdEntityInfo.get_Name addr 0x2764a88 size 0x1c virtual true final true
 ::StringW System_Xml_IDtdEntityInfo_get_Name() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_IsExternal addr 0x2764aa4 size 0x8 virtual true final true
 bool System_Xml_IDtdEntityInfo_get_IsExternal() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_IsDeclaredInExternal addr 0x2764aac size 0x8 virtual true final true
 bool System_Xml_IDtdEntityInfo_get_IsDeclaredInExternal() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_IsUnparsedEntity addr 0x2764ab4 size 0x28 virtual true final true
 bool System_Xml_IDtdEntityInfo_get_IsUnparsedEntity() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_IsParameterEntity addr 0x2764adc size 0x8 virtual true final true
 bool System_Xml_IDtdEntityInfo_get_IsParameterEntity() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_BaseUriString addr 0x2764ae4 size 0x54 virtual true final true
 ::StringW System_Xml_IDtdEntityInfo_get_BaseUriString() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_DeclaredUriString addr 0x2764b8c size 0x54 virtual true final true
 ::StringW System_Xml_IDtdEntityInfo_get_DeclaredUriString() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_SystemId addr 0x2764c34 size 0x8 virtual true final true
 ::StringW System_Xml_IDtdEntityInfo_get_SystemId() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_PublicId addr 0x2764c3c size 0x8 virtual true final true
 ::StringW System_Xml_IDtdEntityInfo_get_PublicId() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_Text addr 0x2764c44 size 0x8 virtual true final true
 ::StringW System_Xml_IDtdEntityInfo_get_Text() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_LineNumber addr 0x2764c4c size 0x8 virtual true final true
 int32_t System_Xml_IDtdEntityInfo_get_LineNumber() ;

/// @brief Method System.Xml.IDtdEntityInfo.get_LinePosition addr 0x2764c54 size 0x8 virtual true final true
 int32_t System_Xml_IDtdEntityInfo_get_LinePosition() ;

/// @brief Method get_Name addr 0x2764c5c size 0x8 virtual false final false
 System::Xml::XmlQualifiedName get_Name() ;

/// @brief Method get_Url addr 0x2764c64 size 0x8 virtual false final false
 ::StringW get_Url() ;

/// @brief Method set_Url addr 0x2764c6c size 0x10 virtual false final false
 void set_Url(::StringW value) ;

/// @brief Method get_Pubid addr 0x2764c7c size 0x8 virtual false final false
 ::StringW get_Pubid() ;

/// @brief Method set_Pubid addr 0x2764c84 size 0x8 virtual false final false
 void set_Pubid(::StringW value) ;

/// @brief Method get_IsExternal addr 0x2764c8c size 0x8 virtual false final false
 bool get_IsExternal() ;

/// @brief Method set_IsExternal addr 0x2764c94 size 0xc virtual false final false
 void set_IsExternal(bool value) ;

/// @brief Method get_DeclaredInExternal addr 0x2764ca0 size 0x8 virtual false final false
 bool get_DeclaredInExternal() ;

/// @brief Method set_DeclaredInExternal addr 0x2764ca8 size 0xc virtual false final false
 void set_DeclaredInExternal(bool value) ;

/// @brief Method get_NData addr 0x2764cb4 size 0x8 virtual false final false
 System::Xml::XmlQualifiedName get_NData() ;

/// @brief Method set_NData addr 0x2764cbc size 0x8 virtual false final false
 void set_NData(System::Xml::XmlQualifiedName value) ;

/// @brief Method get_Text addr 0x2764cc4 size 0x8 virtual false final false
 ::StringW get_Text() ;

/// @brief Method set_Text addr 0x2764ccc size 0xc virtual false final false
 void set_Text(::StringW value) ;

/// @brief Method get_Line addr 0x2764cd8 size 0x8 virtual false final false
 int32_t get_Line() ;

/// @brief Method set_Line addr 0x2764ce0 size 0x8 virtual false final false
 void set_Line(int32_t value) ;

/// @brief Method get_Pos addr 0x2764ce8 size 0x8 virtual false final false
 int32_t get_Pos() ;

/// @brief Method set_Pos addr 0x2764cf0 size 0x8 virtual false final false
 void set_Pos(int32_t value) ;

/// @brief Method get_BaseURI addr 0x2764b38 size 0x54 virtual false final false
 ::StringW get_BaseURI() ;

/// @brief Method set_BaseURI addr 0x2764cf8 size 0x8 virtual false final false
 void set_BaseURI(::StringW value) ;

/// @brief Method get_ParsingInProgress addr 0x2764d00 size 0x8 virtual false final false
 bool get_ParsingInProgress() ;

/// @brief Method set_ParsingInProgress addr 0x2764d08 size 0xc virtual false final false
 void set_ParsingInProgress(bool value) ;

/// @brief Method get_DeclaredURI addr 0x2764be0 size 0x54 virtual false final false
 ::StringW get_DeclaredURI() ;

/// @brief Method set_DeclaredURI addr 0x2764d14 size 0x8 virtual false final false
