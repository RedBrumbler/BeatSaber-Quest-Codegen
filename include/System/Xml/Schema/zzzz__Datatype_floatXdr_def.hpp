...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11590))}
...
/// @brief Method ParseValue addr 0x275e4e0 size 0x27c virtual true final false
...
/// @brief Method .ctor addr 0x275e75c size 0x54 virtual false final false
 void _ctor() ;
