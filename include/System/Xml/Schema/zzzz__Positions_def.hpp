...
/// @brief Method Add addr 0x274d250 size 0x90 virtual false final false
 int32_t Add(int32_t symbol, ::bs_hook::Il2CppWrapperType particle) ;

/// @brief Method get_Item addr 0x274d2e0 size 0x90 virtual false final false
 System::Xml::Schema::Position get_Item(int32_t pos) ;

/// @brief Method get_Count addr 0x274d370 size 0x24 virtual false final false
 int32_t get_Count() ;

// Ctor Parameters []
explicit Positions() ;

/// @brief Method .ctor addr 0x274d394 size 0x68 virtual false final false
 void _ctor() ;
