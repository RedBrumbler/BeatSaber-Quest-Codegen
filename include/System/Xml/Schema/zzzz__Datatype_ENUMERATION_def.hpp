...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11618))}
...
/// @brief Method get_TokenizedType addr 0x275ebec size 0x8 virtual true final false
 System::Xml::XmlTokenizedType get_TokenizedType() ;

// Ctor Parameters []
explicit Datatype_ENUMERATION() ;

/// @brief Method .ctor addr 0x275ebf4 size 0x4 virtual false final false
 void _ctor() ;
