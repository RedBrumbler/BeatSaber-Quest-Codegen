...
/// @brief Method get_XmlType addr 0x2750558 size 0x8 virtual false final false
 System::Xml::Schema::XmlSchemaSimpleType get_XmlType() ;

/// @brief Method get_TypedValue addr 0x2750560 size 0x8 virtual false final false
