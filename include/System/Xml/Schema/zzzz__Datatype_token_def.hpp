...
/// @brief Method get_TypeCode addr 0x275aea0 size 0x8 virtual true final false
 System::Xml::Schema::XmlTypeCode get_TypeCode() ;

/// @brief Method get_BuiltInWhitespaceFacet addr 0x275aea8 size 0x8 virtual true final false
 System::Xml::Schema::XmlSchemaWhiteSpace get_BuiltInWhitespaceFacet() ;

// Ctor Parameters []
explicit Datatype_token() ;

/// @brief Method .ctor addr 0x275aeb0 size 0x4 virtual false final false
 void _ctor() ;
