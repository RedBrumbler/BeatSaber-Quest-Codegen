...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11699))}
...
/// @brief Method set_ItemType addr 0x276892c size 0x8 virtual false final false
 void set_ItemType(System::Xml::Schema::XmlSchemaSimpleType value) ;

/// @brief Method get_BaseItemType addr 0x2768934 size 0x8 virtual false final false
 System::Xml::Schema::XmlSchemaSimpleType get_BaseItemType() ;

/// @brief Method set_BaseItemType addr 0x276893c size 0x8 virtual false final false
 void set_BaseItemType(System::Xml::Schema::XmlSchemaSimpleType value) ;

// Ctor Parameters []
explicit XmlSchemaSimpleTypeList() ;

/// @brief Method .ctor addr 0x2768944 size 0x68 virtual false final false
 void _ctor() ;
