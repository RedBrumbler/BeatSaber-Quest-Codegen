...
/// @brief Method get_TypeCode addr 0x275aff4 size 0x8 virtual true final false
 System::Xml::Schema::XmlTypeCode get_TypeCode() ;

/// @brief Method get_TokenizedType addr 0x275affc size 0x8 virtual true final false
 System::Xml::XmlTokenizedType get_TokenizedType() ;

// Ctor Parameters []
explicit Datatype_ID() ;

/// @brief Method .ctor addr 0x275b004 size 0x4 virtual false final false
 void _ctor() ;
