...
/// @brief Method CreateAnyType addr 0x2766ce0 size 0x2e4 virtual false final false
...
/// @brief Method .ctor addr 0x2766fc4 size 0x6c virtual false final false
 void _ctor() ;

/// @brief Method get_AnyType addr 0x2767520 size 0x58 virtual false final false
static System::Xml::Schema::XmlSchemaComplexType get_AnyType() ;

/// @brief Method get_AnyTypeContentValidator addr 0x2767090 size 0x70 virtual false final false
static System::Xml::Schema::ContentValidator get_AnyTypeContentValidator() ;

/// @brief Method set_IsMixed addr 0x2767578 size 0x1c virtual true final false
 void set_IsMixed(bool value) ;

/// @brief Method get_ContentTypeParticle addr 0x2767594 size 0x8 virtual false final false
 System::Xml::Schema::XmlSchemaParticle get_ContentTypeParticle() ;

/// @brief Method SetContentTypeParticle addr 0x276759c size 0x8 virtual false final false
 void SetContentTypeParticle(System::Xml::Schema::XmlSchemaParticle value) ;

/// @brief Method SetAttributeWildcard addr 0x27675a4 size 0x8 virtual false final false
