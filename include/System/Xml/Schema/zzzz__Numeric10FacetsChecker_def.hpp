...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11647))}
...
/// @brief Method .ctor addr 0x2758554 size 0x40 virtual false final false
 void _ctor(System::Decimal minVal, System::Decimal maxVal) ;

/// @brief Method CheckValueFacets addr 0x276058c size 0x70 virtual true final false
 System::Exception CheckValueFacets(::bs_hook::Il2CppWrapperType value, System::Xml::Schema::XmlSchemaDatatype datatype) ;

/// @brief Method CheckValueFacets addr 0x27605fc size 0x558 virtual true final false
 System::Exception CheckValueFacets(System::Decimal value, System::Xml::Schema::XmlSchemaDatatype datatype) ;

/// @brief Method CheckValueFacets addr 0x2760d9c size 0x8c virtual true final false
 System::Exception CheckValueFacets(int64_t value, System::Xml::Schema::XmlSchemaDatatype datatype) ;

/// @brief Method CheckValueFacets addr 0x2760e28 size 0x8c virtual true final false
 System::Exception CheckValueFacets(int32_t value, System::Xml::Schema::XmlSchemaDatatype datatype) ;

/// @brief Method CheckValueFacets addr 0x2760eb4 size 0x8c virtual true final false
 System::Exception CheckValueFacets(int16_t value, System::Xml::Schema::XmlSchemaDatatype datatype) ;

/// @brief Method MatchEnumeration addr 0x2760f40 size 0x84 virtual true final false
...
/// @brief Method MatchEnumeration addr 0x2760c7c size 0x120 virtual false final false
...
/// @brief Method CheckTotalAndFractionDigits addr 0x275f378 size 0x2a4 virtual false final false
