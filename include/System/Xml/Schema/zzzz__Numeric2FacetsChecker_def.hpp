...
/// @brief Method CheckValueFacets addr 0x2761058 size 0x60 virtual true final false
 System::Exception CheckValueFacets(::bs_hook::Il2CppWrapperType value, System::Xml::Schema::XmlSchemaDatatype datatype) ;

/// @brief Method CheckValueFacets addr 0x27610b8 size 0x280 virtual true final false
 System::Exception CheckValueFacets(double_t value, System::Xml::Schema::XmlSchemaDatatype datatype) ;

/// @brief Method CheckValueFacets addr 0x27613f0 size 0x10 virtual true final false
 System::Exception CheckValueFacets(float_t value, System::Xml::Schema::XmlSchemaDatatype datatype) ;

/// @brief Method MatchEnumeration addr 0x2761400 size 0x78 virtual true final false
...
/// @brief Method MatchEnumeration addr 0x2761338 size 0xb8 virtual false final false
...
/// @brief Method .ctor addr 0x2761478 size 0x8 virtual false final false
 void _ctor() ;
