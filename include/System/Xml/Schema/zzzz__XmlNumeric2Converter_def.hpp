...
/// @brief Method .ctor addr 0x277277c size 0x64 virtual false final false
 void _ctor(System::Xml::Schema::XmlSchemaType schemaType) ;

/// @brief Method Create addr 0x2757778 size 0x60 virtual false final false
static System::Xml::Schema::XmlValueConverter Create(System::Xml::Schema::XmlSchemaType schemaType) ;

/// @brief Method ToDouble addr 0x27727e0 size 0xd0 virtual true final false
 double_t ToDouble(::StringW value) ;

/// @brief Method ToDouble addr 0x27728b0 size 0x340 virtual true final false
 double_t ToDouble(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method ToSingle addr 0x2772bf0 size 0x8 virtual true final false
 float_t ToSingle(double_t value) ;

/// @brief Method ToSingle addr 0x2772bf8 size 0xd0 virtual true final false
 float_t ToSingle(::StringW value) ;

/// @brief Method ToSingle addr 0x2772cc8 size 0x348 virtual true final false
 float_t ToSingle(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method ToString addr 0x2773010 size 0xb4 virtual true final false
 ::StringW ToString(double_t value) ;

/// @brief Method ToString addr 0x27730c4 size 0x88 virtual true final false
 ::StringW ToString(float_t value) ;

/// @brief Method ToString addr 0x277314c size 0x358 virtual true final false
 ::StringW ToString(::bs_hook::Il2CppWrapperType value, System::Xml::IXmlNamespaceResolver nsResolver) ;

/// @brief Method ChangeType addr 0x27734a4 size 0x36c virtual true final false
 ::bs_hook::Il2CppWrapperType ChangeType(double_t value, System::Type destinationType) ;

/// @brief Method ChangeType addr 0x2773810 size 0x3ac virtual true final false
...
/// @brief Method ChangeType addr 0x2773bbc size 0x6c8 virtual true final false
