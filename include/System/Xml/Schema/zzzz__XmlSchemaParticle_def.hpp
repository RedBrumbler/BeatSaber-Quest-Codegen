...
/// @brief Method set_MinOccurs addr 0x2767100 size 0x12c virtual false final false
 void set_MinOccurs(System::Decimal value) ;

/// @brief Method set_MaxOccurs addr 0x276722c size 0x164 virtual false final false
 void set_MaxOccurs(System::Decimal value) ;

// Ctor Parameters []
explicit XmlSchemaParticle() ;

/// @brief Method .ctor addr 0x27669f8 size 0x74 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2768584 size 0x54 virtual false final false
 void _ctor() ;
