...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Xml::Schema::Datatype_time::*)()>(&System::Xml::Schema::Datatype_time::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x27597c4;
...
// Ctor Parameters []
 System::Xml::Schema::Datatype_time::Datatype_time()  : System::Xml::Schema::Datatype_dateTimeBase(THROW_UNLESS(::il2cpp_utils::New<Datatype_time>())) {}
