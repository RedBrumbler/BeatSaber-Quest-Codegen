...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11591))}
...
/// @brief Method ParseValue addr 0x275e204 size 0x27c virtual true final false
...
/// @brief Method .ctor addr 0x275e48c size 0x54 virtual false final false
 void _ctor() ;
