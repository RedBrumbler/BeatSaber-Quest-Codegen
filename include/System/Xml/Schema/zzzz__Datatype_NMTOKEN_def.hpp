...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11615))}
...
/// @brief Method get_TypeCode addr 0x275aecc size 0x8 virtual true final false
 System::Xml::Schema::XmlTypeCode get_TypeCode() ;

/// @brief Method get_TokenizedType addr 0x275aed4 size 0x8 virtual true final false
 System::Xml::XmlTokenizedType get_TokenizedType() ;

// Ctor Parameters []
explicit Datatype_NMTOKEN() ;

/// @brief Method .ctor addr 0x275aedc size 0x4 virtual false final false
 void _ctor() ;
