...
/// @brief Method .ctor addr 0x27653d0 size 0x28 virtual false final false
 void _ctor(System::Xml::XmlQualifiedName name) ;

/// @brief Method get_Name addr 0x27653f8 size 0x8 virtual false final false
 System::Xml::XmlQualifiedName get_Name() ;

/// @brief Method get_SystemLiteral addr 0x2765400 size 0x8 virtual false final false
 ::StringW get_SystemLiteral() ;

/// @brief Method set_SystemLiteral addr 0x2765408 size 0x8 virtual false final false
 void set_SystemLiteral(::StringW value) ;

/// @brief Method get_Pubid addr 0x2765410 size 0x8 virtual false final false
 ::StringW get_Pubid() ;

/// @brief Method set_Pubid addr 0x2765418 size 0x8 virtual false final false
