...
/// @brief Method CreateValueConverter addr 0x2755210 size 0x2a4 virtual true final false
...
/// @brief Method .ctor addr 0x2754ce0 size 0x74 virtual false final false
 void _ctor(System::Xml::Schema::DatatypeImplementation type, int32_t minListSize) ;

/// @brief Method Compare addr 0x27554b4 size 0x29c virtual true final false
 int32_t Compare(::bs_hook::Il2CppWrapperType value1, ::bs_hook::Il2CppWrapperType value2) ;

/// @brief Method get_ValueType addr 0x2755750 size 0x10 virtual true final false
 System::Type get_ValueType() ;

/// @brief Method get_TokenizedType addr 0x2755760 size 0x20 virtual true final false
 System::Xml::XmlTokenizedType get_TokenizedType() ;

/// @brief Method get_ListValueType addr 0x2755780 size 0x24 virtual true final false
 System::Type get_ListValueType() ;

/// @brief Method get_FacetsChecker addr 0x27557a4 size 0x58 virtual true final false
 System::Xml::Schema::FacetsChecker get_FacetsChecker() ;

/// @brief Method get_TypeCode addr 0x27557fc size 0x20 virtual true final false
 System::Xml::Schema::XmlTypeCode get_TypeCode() ;

/// @brief Method TryParseValue addr 0x275581c size 0x1418 virtual true final false
