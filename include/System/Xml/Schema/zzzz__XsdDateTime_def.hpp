...
/// @brief Method Parse addr 0x27851c8 size 0x8b0 virtual false final false
 bool Parse(::StringW text, System::Xml::Schema::XsdDateTimeFlags kinds) ;

/// @brief Method ParseDate addr 0x2787320 size 0x1a0 virtual false final false
 bool ParseDate(int32_t start) ;

/// @brief Method ParseTimeAndZoneAndWhitespace addr 0x2787504 size 0x44 virtual false final false
 bool ParseTimeAndZoneAndWhitespace(int32_t start) ;

/// @brief Method ParseTimeAndWhitespace addr 0x278775c size 0x58 virtual false final false
 bool ParseTimeAndWhitespace(int32_t start) ;

/// @brief Method ParseTime addr 0x2787958 size 0x2f0 virtual false final false
 bool ParseTime(ByRef<int32_t> start) ;

/// @brief Method ParseZoneAndWhitespace addr 0x2787548 size 0x214 virtual false final false
 bool ParseZoneAndWhitespace(int32_t start) ;

/// @brief Method Parse4Dig addr 0x27877b4 size 0x10c virtual false final false
 bool Parse4Dig(int32_t start, ByRef<int32_t> num) ;

/// @brief Method Parse2Dig addr 0x27878c0 size 0x98 virtual false final false
 bool Parse2Dig(int32_t start, ByRef<int32_t> num) ;

/// @brief Method ParseChar addr 0x27874c0 size 0x44 virtual false final false
 bool ParseChar(int32_t start, char16_t ch) ;

/// @brief Method Test addr 0x2787314 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x278508c size 0x13c virtual false final false
 void _ctor(::StringW text, System::Xml::Schema::XsdDateTimeFlags kinds) ;

/// @brief Method .ctor addr 0x2785af4 size 0x30 virtual false final false
 void _ctor(System::Xml::Schema::System__Xml__Schema__XsdDateTime__Parser parser) ;

/// @brief Method InitiateXsdDateTime addr 0x2785a78 size 0x7c virtual false final false
 void InitiateXsdDateTime(System::Xml::Schema::System__Xml__Schema__XsdDateTime__Parser parser) ;

/// @brief Method TryParse addr 0x2785b24 size 0x74 virtual false final false
static bool TryParse(::StringW text, System::Xml::Schema::XsdDateTimeFlags kinds, ByRef<System::Xml::Schema::XsdDateTime> result) ;

/// @brief Method .ctor addr 0x2785b98 size 0x15c virtual false final false
 void _ctor(System::DateTime dateTime, System::Xml::Schema::XsdDateTimeFlags kinds) ;

/// @brief Method .ctor addr 0x2785cf4 size 0x8 virtual false final false
 void _ctor(System::DateTimeOffset dateTimeOffset) ;

/// @brief Method .ctor addr 0x2785cfc size 0x114 virtual false final false
 void _ctor(System::DateTimeOffset dateTimeOffset, System::Xml::Schema::XsdDateTimeFlags kinds) ;

/// @brief Method get_InternalTypeCode addr 0x2785e10 size 0x8 virtual false final false
 System::Xml::Schema::System__Xml__Schema__XsdDateTime__DateTimeTypeCode get_InternalTypeCode() ;

/// @brief Method get_InternalKind addr 0x2785e18 size 0x8 virtual false final false
 System::Xml::Schema::System__Xml__Schema__XsdDateTime__XsdDateTimeKind get_InternalKind() ;

/// @brief Method get_Year addr 0x2785e20 size 0x8 virtual false final false
 int32_t get_Year() ;

/// @brief Method get_Month addr 0x2785e28 size 0x8 virtual false final false
 int32_t get_Month() ;

/// @brief Method get_Day addr 0x2785e30 size 0x8 virtual false final false
 int32_t get_Day() ;

/// @brief Method get_Hour addr 0x2785e38 size 0x8 virtual false final false
 int32_t get_Hour() ;

/// @brief Method get_Minute addr 0x2785e40 size 0x8 virtual false final false
 int32_t get_Minute() ;

/// @brief Method get_Second addr 0x2785e48 size 0x8 virtual false final false
 int32_t get_Second() ;

/// @brief Method get_Fraction addr 0x2785e50 size 0xd8 virtual false final false
 int32_t get_Fraction() ;

/// @brief Method get_ZoneHour addr 0x2785f28 size 0x8 virtual false final false
 int32_t get_ZoneHour() ;

/// @brief Method get_ZoneMinute addr 0x2785f30 size 0x8 virtual false final false
 int32_t get_ZoneMinute() ;

/// @brief Method op_Implicit addr 0x2785f38 size 0x420 virtual false final false
static System::DateTime op_Implicit_System__DateTime(System::Xml::Schema::XsdDateTime xdt) ;

/// @brief Method op_Implicit addr 0x2786358 size 0x280 virtual false final false
static System::DateTimeOffset op_Implicit_System__DateTimeOffset(System::Xml::Schema::XsdDateTime xdt) ;

/// @brief Method ToString addr 0x27865d8 size 0x3d8 virtual true final false
 ::StringW ToString() ;

/// @brief Method PrintDate addr 0x27869b0 size 0x150 virtual false final false
 void PrintDate(System::Text::StringBuilder sb) ;

/// @brief Method PrintTime addr 0x2786b00 size 0x20c virtual false final false
 void PrintTime(System::Text::StringBuilder sb) ;

/// @brief Method PrintZone addr 0x2786ddc size 0x188 virtual false final false
 void PrintZone(System::Text::StringBuilder sb) ;

/// @brief Method IntToCharArray addr 0x2786d0c size 0x68 virtual false final false
 void IntToCharArray(::ArrayW<char16_t> text, int32_t start, int32_t value, int32_t digits) ;

/// @brief Method ShortToCharArray addr 0x2786d74 size 0x68 virtual false final false
