...
/// @brief Method .ctor addr 0x2787cdc size 0x178 virtual false final false
...
/// @brief Method .ctor addr 0x2787e54 size 0xd8 virtual false final false
 void _ctor(System::TimeSpan timeSpan) ;

/// @brief Method .ctor addr 0x2787f2c size 0x180 virtual false final false
 void _ctor(System::TimeSpan timeSpan, System::Xml::Schema::System__Xml__Schema__XsdDuration__DurationType durationType) ;

/// @brief Method .ctor addr 0x27880ac size 0x8c virtual false final false
 void _ctor(::StringW s, System::Xml::Schema::System__Xml__Schema__XsdDuration__DurationType durationType) ;

/// @brief Method get_IsNegative addr 0x2788830 size 0xc virtual false final false
 bool get_IsNegative() ;

/// @brief Method get_Years addr 0x278883c size 0x8 virtual false final false
 int32_t get_Years() ;

/// @brief Method get_Months addr 0x2788844 size 0x8 virtual false final false
 int32_t get_Months() ;

/// @brief Method get_Days addr 0x278884c size 0x8 virtual false final false
 int32_t get_Days() ;

/// @brief Method get_Hours addr 0x2788854 size 0x8 virtual false final false
 int32_t get_Hours() ;

/// @brief Method get_Minutes addr 0x278885c size 0x8 virtual false final false
 int32_t get_Minutes() ;

/// @brief Method get_Seconds addr 0x2788864 size 0x8 virtual false final false
 int32_t get_Seconds() ;

/// @brief Method get_Nanoseconds addr 0x2788824 size 0xc virtual false final false
 int32_t get_Nanoseconds() ;

/// @brief Method ToTimeSpan addr 0x278886c size 0x48 virtual false final false
 System::TimeSpan ToTimeSpan(System::Xml::Schema::System__Xml__Schema__XsdDuration__DurationType durationType) ;

/// @brief Method TryToTimeSpan addr 0x2788d94 size 0xc virtual false final false
 System::Exception TryToTimeSpan(ByRef<System::TimeSpan> result) ;

/// @brief Method TryToTimeSpan addr 0x27888b4 size 0x4e0 virtual false final false
...
/// @brief Method ToString addr 0x2788da0 size 0x8 virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x2788da8 size 0x3fc virtual false final false
 ::StringW ToString(System::Xml::Schema::System__Xml__Schema__XsdDuration__DurationType durationType) ;

/// @brief Method TryParse addr 0x27891a4 size 0xc virtual false final false
static System::Exception TryParse(::StringW s, ByRef<System::Xml::Schema::XsdDuration> result) ;

/// @brief Method TryParse addr 0x2788138 size 0x6ec virtual false final false
...
/// @brief Method TryParseDigits addr 0x27891b0 size 0x1bc virtual false final false
