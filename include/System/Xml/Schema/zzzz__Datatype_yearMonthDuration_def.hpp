...
/// @brief Method TryParseValue addr 0x2758af4 size 0x1c4 virtual true final false
...
/// @brief Method get_TypeCode addr 0x2758cb8 size 0x8 virtual true final false
 System::Xml::Schema::XmlTypeCode get_TypeCode() ;

// Ctor Parameters []
explicit Datatype_yearMonthDuration() ;

/// @brief Method .ctor addr 0x2758cc0 size 0x54 virtual false final false
 void _ctor() ;
