...
/// @brief Method get_LeftChild addr 0x274d9dc size 0x8 virtual false final false
 System::Xml::Schema::SyntaxTreeNode get_LeftChild() ;

/// @brief Method set_LeftChild addr 0x274d9e4 size 0x8 virtual false final false
 void set_LeftChild(System::Xml::Schema::SyntaxTreeNode value) ;

/// @brief Method get_RightChild addr 0x274d9ec size 0x8 virtual false final false
 System::Xml::Schema::SyntaxTreeNode get_RightChild() ;

/// @brief Method set_RightChild addr 0x274d9f4 size 0x8 virtual false final false
 void set_RightChild(System::Xml::Schema::SyntaxTreeNode value) ;

/// @brief Method ExpandTreeNoRecursive addr 0x274d9fc size 0x1e0 virtual false final false
...
/// @brief Method ExpandTree addr 0x274dbdc size 0x64 virtual true final false
...
/// @brief Method .ctor addr 0x274dc40 size 0x8 virtual false final false
 void _ctor() ;
