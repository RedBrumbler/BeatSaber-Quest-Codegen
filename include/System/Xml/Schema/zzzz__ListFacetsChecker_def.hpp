...
/// @brief Method CheckValueFacets addr 0x2762e58 size 0x234 virtual true final false
 System::Exception CheckValueFacets(::bs_hook::Il2CppWrapperType value, System::Xml::Schema::XmlSchemaDatatype datatype) ;

/// @brief Method MatchEnumeration addr 0x276308c size 0xb4 virtual true final false
...
/// @brief Method .ctor addr 0x2763140 size 0x8 virtual false final false
 void _ctor() ;
