...
/// @brief Method CheckValueFacets addr 0x2763148 size 0xf4 virtual true final false
 System::Exception CheckValueFacets(::bs_hook::Il2CppWrapperType value, System::Xml::Schema::XmlSchemaDatatype datatype) ;

/// @brief Method MatchEnumeration addr 0x276323c size 0xb4 virtual true final false
...
/// @brief Method .ctor addr 0x27632f0 size 0x8 virtual false final false
 void _ctor() ;
