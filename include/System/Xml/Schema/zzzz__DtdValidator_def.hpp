...
/// @brief Method LookupNamespace addr 0x276015c size 0x8 virtual true final false
 ::StringW LookupNamespace(::StringW prefix) ;

// Ctor Parameters []
explicit System__Xml__Schema__DtdValidator__NamespaceManager() ;

/// @brief Method .ctor addr 0x2760154 size 0x8 virtual false final false
 void _ctor() ;
...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11554))}
...
/// @brief Method SetDefaultTypedValue addr 0x275fcac size 0x3dc virtual false final false
