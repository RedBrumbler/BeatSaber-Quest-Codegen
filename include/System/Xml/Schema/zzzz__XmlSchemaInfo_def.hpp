...
/// @brief Method .ctor addr 0x276838c size 0x30 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x27683d8 size 0x3c virtual false final false
 void _ctor(System::Xml::Schema::XmlSchemaValidity validity) ;

/// @brief Method get_Validity addr 0x2768414 size 0x8 virtual true final true
 System::Xml::Schema::XmlSchemaValidity get_Validity() ;

/// @brief Method get_IsDefault addr 0x276841c size 0x8 virtual true final true
 bool get_IsDefault() ;

/// @brief Method get_IsNil addr 0x2768424 size 0x8 virtual true final true
 bool get_IsNil() ;

/// @brief Method get_MemberType addr 0x276842c size 0x8 virtual true final true
 System::Xml::Schema::XmlSchemaSimpleType get_MemberType() ;

/// @brief Method get_SchemaType addr 0x2768434 size 0x8 virtual true final true
 System::Xml::Schema::XmlSchemaType get_SchemaType() ;

/// @brief Method get_SchemaElement addr 0x276843c size 0x8 virtual true final true
 System::Xml::Schema::XmlSchemaElement get_SchemaElement() ;

/// @brief Method get_SchemaAttribute addr 0x2768444 size 0x8 virtual true final true
 System::Xml::Schema::XmlSchemaAttribute get_SchemaAttribute() ;

/// @brief Method Clear addr 0x27683bc size 0x1c virtual false final false
 void Clear() ;
