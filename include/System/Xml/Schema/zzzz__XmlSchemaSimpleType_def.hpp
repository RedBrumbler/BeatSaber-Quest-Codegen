...
/// @brief Method .ctor addr 0x2768910 size 0x4 virtual false final false
 void _ctor() ;

/// @brief Method get_Content addr 0x2768914 size 0x8 virtual false final false
 System::Xml::Schema::XmlSchemaSimpleTypeContent get_Content() ;

/// @brief Method set_Content addr 0x276891c size 0x8 virtual false final false
