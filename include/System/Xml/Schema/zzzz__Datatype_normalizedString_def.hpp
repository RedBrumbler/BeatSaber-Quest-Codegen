...
namespace System::Xml::Schema {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11588))}
...
/// @brief Method get_TypeCode addr 0x275ae80 size 0x8 virtual true final false
 System::Xml::Schema::XmlTypeCode get_TypeCode() ;

/// @brief Method get_BuiltInWhitespaceFacet addr 0x275ae88 size 0x8 virtual true final false
 System::Xml::Schema::XmlSchemaWhiteSpace get_BuiltInWhitespaceFacet() ;

// Ctor Parameters []
explicit Datatype_normalizedString() ;

/// @brief Method .ctor addr 0x275ae90 size 0x4 virtual false final false
 void _ctor() ;
