...
/// @brief Method MoveNext addr 0x27491cc size 0x37c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x2749548 size 0x58 virtual true final true
...
/// @brief Method get_DownloadManager addr 0x2748e64 size 0xd4 virtual false final false
static System::Xml::XmlDownloadManager get_DownloadManager() ;

// Ctor Parameters []
explicit XmlUrlResolver() ;

/// @brief Method .ctor addr 0x2748f38 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method GetEntity addr 0x2748f40 size 0x17c virtual true final false
 ::bs_hook::Il2CppWrapperType GetEntity(System::Uri absoluteUri, ::StringW role, System::Type ofObjectToReturn) ;

/// @brief Method ResolveUri addr 0x27490bc size 0x4 virtual true final false
 System::Uri ResolveUri(System::Uri baseUri, ::StringW relativeUri) ;

/// @brief Method GetEntityAsync addr 0x27490c0 size 0x10c virtual true final false
