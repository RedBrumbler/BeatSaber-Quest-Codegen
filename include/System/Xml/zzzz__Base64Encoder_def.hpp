...
/// @brief Method .ctor addr 0x26ebfc4 size 0x5c virtual false final false
 void _ctor() ;
...
/// @brief Method Encode addr 0x26ec020 size 0x334 virtual false final false
 void Encode(::ArrayW<uint8_t> buffer, int32_t index, int32_t count) ;

/// @brief Method Flush addr 0x26ec354 size 0xa8 virtual false final false
 void Flush() ;
