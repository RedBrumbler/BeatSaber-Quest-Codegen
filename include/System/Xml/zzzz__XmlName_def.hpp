...
/// @brief Method Create addr 0x272d9b8 size 0xf4 virtual false final false
...
/// @brief Method .ctor addr 0x272daac size 0x58 virtual false final false
...
/// @brief Method get_LocalName addr 0x272ded0 size 0x8 virtual false final false
 ::StringW get_LocalName() ;

/// @brief Method get_NamespaceURI addr 0x272ded8 size 0x8 virtual false final false
 ::StringW get_NamespaceURI() ;

/// @brief Method get_Prefix addr 0x272dee0 size 0x8 virtual false final false
 ::StringW get_Prefix() ;

/// @brief Method get_HashCode addr 0x272dee8 size 0x8 virtual false final false
 int32_t get_HashCode() ;

/// @brief Method get_OwnerDocument addr 0x272def0 size 0x8 virtual false final false
 System::Xml::XmlDocument get_OwnerDocument() ;

/// @brief Method get_Name addr 0x27281b0 size 0x1ac virtual false final false
 ::StringW get_Name() ;

/// @brief Method get_Validity addr 0x272def8 size 0x8 virtual true final false
 System::Xml::Schema::XmlSchemaValidity get_Validity() ;

/// @brief Method get_IsDefault addr 0x272df00 size 0x8 virtual true final false
 bool get_IsDefault() ;

/// @brief Method get_IsNil addr 0x272df08 size 0x8 virtual true final false
 bool get_IsNil() ;

/// @brief Method get_MemberType addr 0x272df10 size 0x8 virtual true final false
 System::Xml::Schema::XmlSchemaSimpleType get_MemberType() ;

/// @brief Method get_SchemaType addr 0x272df18 size 0x8 virtual true final false
 System::Xml::Schema::XmlSchemaType get_SchemaType() ;

/// @brief Method get_SchemaElement addr 0x272df20 size 0x8 virtual true final false
 System::Xml::Schema::XmlSchemaElement get_SchemaElement() ;

/// @brief Method get_SchemaAttribute addr 0x272df28 size 0x8 virtual true final false
 System::Xml::Schema::XmlSchemaAttribute get_SchemaAttribute() ;

/// @brief Method Equals addr 0x272df30 size 0xc virtual true final false
 bool Equals(System::Xml::Schema::IXmlSchemaInfo schemaInfo) ;

/// @brief Method GetHashCode addr 0x272df3c size 0x64 virtual false final false
