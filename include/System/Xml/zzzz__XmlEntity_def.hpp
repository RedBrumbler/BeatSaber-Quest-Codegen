...
/// @brief Method .ctor addr 0x2728be8 size 0x80 virtual false final false
...
/// @brief Method CloneNode addr 0x2728cec size 0x60 virtual true final false
 System::Xml::XmlNode CloneNode(bool deep) ;

/// @brief Method get_IsReadOnly addr 0x2728d4c size 0x8 virtual true final false
 bool get_IsReadOnly() ;

/// @brief Method get_Name addr 0x2728d54 size 0x8 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_LocalName addr 0x2728d5c size 0x8 virtual true final false
 ::StringW get_LocalName() ;

/// @brief Method get_InnerText addr 0x2728d64 size 0x4 virtual true final false
 ::StringW get_InnerText() ;

/// @brief Method set_InnerText addr 0x2728d68 size 0x60 virtual true final false
 void set_InnerText(::StringW value) ;

/// @brief Method get_IsContainer addr 0x2728dc8 size 0x8 virtual true final false
 bool get_IsContainer() ;

/// @brief Method get_LastNode addr 0x2728dd0 size 0x8c virtual true final false
 System::Xml::XmlLinkedNode get_LastNode() ;

/// @brief Method set_LastNode addr 0x2728ea8 size 0x8 virtual true final false
 void set_LastNode(System::Xml::XmlLinkedNode value) ;

/// @brief Method IsValidChildType addr 0x2728eb0 size 0x3c virtual true final false
 bool IsValidChildType(System::Xml::XmlNodeType type) ;

/// @brief Method get_NodeType addr 0x2728eec size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_SystemId addr 0x2728ef4 size 0x8 virtual false final false
 ::StringW get_SystemId() ;

/// @brief Method set_InnerXml addr 0x2728efc size 0x60 virtual true final false
 void set_InnerXml(::StringW value) ;

/// @brief Method get_BaseURI addr 0x2728f5c size 0x8 virtual true final false
 ::StringW get_BaseURI() ;

/// @brief Method SetBaseURI addr 0x2728f64 size 0x8 virtual false final false
