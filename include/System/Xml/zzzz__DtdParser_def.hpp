...
/// @brief Method .ctor addr 0x273c244 size 0x40 virtual false final false
...
/// @brief Method .ctor addr 0x273c284 size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x2732380 size 0x88 virtual false final false
 void _ctor() ;

/// @brief Method Create addr 0x272ca98 size 0x58 virtual false final false
static System::Xml::IDtdParser Create() ;

/// @brief Method Initialize addr 0x2732408 size 0x3d0 virtual false final false
 void Initialize(System::Xml::IDtdParserAdapter readerAdapter) ;

/// @brief Method InitializeFreeFloatingDtd addr 0x27327d8 size 0x3d0 virtual false final false
...
/// @brief Method System.Xml.IDtdParser.ParseInternalDtd addr 0x2732c24 size 0x30 virtual true final true
 System::Xml::IDtdInfo System_Xml_IDtdParser_ParseInternalDtd(System::Xml::IDtdParserAdapter adapter, bool saveInternalSubset) ;

/// @brief Method System.Xml.IDtdParser.ParseFreeFloatingDtd addr 0x2732eb0 size 0x24 virtual true final true
...
/// @brief Method get_ParsingInternalSubset addr 0x2732ed4 size 0x10 virtual false final false
 bool get_ParsingInternalSubset() ;

/// @brief Method get_IgnoreEntityReferences addr 0x2732ee4 size 0x10 virtual false final false
 bool get_IgnoreEntityReferences() ;

/// @brief Method get_SaveInternalSubsetValue addr 0x2732ef4 size 0xc0 virtual false final false
 bool get_SaveInternalSubsetValue() ;

/// @brief Method get_ParsingTopLevelMarkup addr 0x2732fb4 size 0x30 virtual false final false
 bool get_ParsingTopLevelMarkup() ;

/// @brief Method get_SupportNamespaces addr 0x2732fe4 size 0x8 virtual false final false
 bool get_SupportNamespaces() ;

/// @brief Method get_Normalize addr 0x2732fec size 0x8 virtual false final false
 bool get_Normalize() ;

/// @brief Method Parse addr 0x2732c54 size 0x25c virtual false final false
 void Parse(bool saveInternalSubset) ;

/// @brief Method ParseInDocumentDtd addr 0x2733048 size 0x150 virtual false final false
 void ParseInDocumentDtd(bool saveInternalSubset) ;

/// @brief Method ParseFreeFloatingDtd addr 0x2732ff4 size 0x54 virtual false final false
 void ParseFreeFloatingDtd() ;

/// @brief Method ParseInternalSubset addr 0x27344fc size 0x4 virtual false final false
 void ParseInternalSubset() ;

/// @brief Method ParseExternalSubset addr 0x2734500 size 0x1a4 virtual false final false
 void ParseExternalSubset() ;

/// @brief Method ParseSubset addr 0x27346a4 size 0x35c virtual false final false
 void ParseSubset() ;

/// @brief Method ParseAttlistDecl addr 0x2734a00 size 0x5c8 virtual false final false
 void ParseAttlistDecl() ;

/// @brief Method ParseAttlistType addr 0x2736434 size 0x55c virtual false final false
...
/// @brief Method ParseAttlistDefault addr 0x2736990 size 0x1b4 virtual false final false
 void ParseAttlistDefault(System::Xml::Schema::SchemaAttDef attrDef, bool ignoreErrors) ;

/// @brief Method ParseElementDecl addr 0x2734fc8 size 0x394 virtual false final false
 void ParseElementDecl() ;

/// @brief Method ParseElementOnlyContent addr 0x2737110 size 0x350 virtual false final false
 void ParseElementOnlyContent(System::Xml::Schema::ParticleContentValidator pcv, int32_t startParenEntityId) ;

/// @brief Method ParseHowMany addr 0x2737460 size 0x70 virtual false final false
 void ParseHowMany(System::Xml::Schema::ParticleContentValidator pcv) ;

/// @brief Method ParseElementMixedContent addr 0x2736e6c size 0x2a4 virtual false final false
 void ParseElementMixedContent(System::Xml::Schema::ParticleContentValidator pcv, int32_t startParenEntityId) ;

/// @brief Method ParseEntityDecl addr 0x273535c size 0x35c virtual false final false
 void ParseEntityDecl() ;

/// @brief Method ParseNotationDecl addr 0x27356b8 size 0x1f4 virtual false final false
 void ParseNotationDecl() ;

/// @brief Method AddUndeclaredNotation addr 0x2736c34 size 0x160 virtual false final false
 void AddUndeclaredNotation(::StringW notationName) ;

/// @brief Method ParseComment addr 0x27358ac size 0x244 virtual false final false
 void ParseComment() ;

/// @brief Method ParsePI addr 0x2735af0 size 0x164 virtual false final false
 void ParsePI() ;

/// @brief Method ParseCondSection addr 0x2735cbc size 0x224 virtual false final false
 void ParseCondSection() ;

/// @brief Method ParseExternalId addr 0x2733fe0 size 0x514 virtual false final false
...
/// @brief Method GetToken addr 0x2733578 size 0x8ac virtual false final false
 System::Xml::System__Xml__DtdParser__Token GetToken(bool needWhiteSpace) ;

/// @brief Method ScanSubsetContent addr 0x2737c40 size 0x704 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanSubsetContent() ;

/// @brief Method ScanNameExpected addr 0x2737bd8 size 0x24 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanNameExpected() ;

/// @brief Method ScanQNameExpected addr 0x2737bfc size 0x24 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanQNameExpected() ;

/// @brief Method ScanNmtokenExpected addr 0x2737c20 size 0x20 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanNmtokenExpected() ;

/// @brief Method ScanDoctype1 addr 0x2738344 size 0x11c virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanDoctype1() ;

/// @brief Method ScanDoctype2 addr 0x2738460 size 0xa8 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanDoctype2() ;

/// @brief Method ScanClosingTag addr 0x273a694 size 0x94 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanClosingTag() ;

/// @brief Method ScanElement1 addr 0x2738508 size 0x1d0 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanElement1() ;

/// @brief Method ScanElement2 addr 0x27386d8 size 0x1a4 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanElement2() ;

/// @brief Method ScanElement3 addr 0x273887c size 0x80 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanElement3() ;

/// @brief Method ScanElement4 addr 0x27388fc size 0xcc virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanElement4() ;

/// @brief Method ScanElement5 addr 0x27389c8 size 0xec virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanElement5() ;

/// @brief Method ScanElement6 addr 0x2738ab4 size 0xd0 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanElement6() ;

/// @brief Method ScanElement7 addr 0x2738b84 size 0x60 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanElement7() ;

/// @brief Method ScanAttlist1 addr 0x2738be4 size 0xc4 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanAttlist1() ;

/// @brief Method ScanAttlist2 addr 0x2738ca8 size 0x680 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanAttlist2() ;

/// @brief Method ScanAttlist3 addr 0x2739328 size 0xa0 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanAttlist3() ;

/// @brief Method ScanAttlist4 addr 0x27393c8 size 0xd0 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanAttlist4() ;

/// @brief Method ScanAttlist5 addr 0x2739498 size 0xd0 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanAttlist5() ;

/// @brief Method ScanAttlist6 addr 0x2739568 size 0x374 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanAttlist6() ;

/// @brief Method ScanAttlist7 addr 0x27398dc size 0xbc virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanAttlist7() ;

/// @brief Method ScanLiteral addr 0x273acd8 size 0xa88 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanLiteral(System::Xml::System__Xml__DtdParser__LiteralType literalType) ;

/// @brief Method ScanEntityName addr 0x273b760 size 0x160 virtual false final false
 System::Xml::XmlQualifiedName ScanEntityName() ;

/// @brief Method ScanNotation1 addr 0x2739998 size 0xf8 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanNotation1() ;

/// @brief Method ScanSystemId addr 0x2739a90 size 0xb4 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanSystemId() ;

/// @brief Method ScanEntity1 addr 0x2739c60 size 0x74 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanEntity1() ;

/// @brief Method ScanEntity2 addr 0x2739cd4 size 0x12c virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanEntity2() ;

/// @brief Method ScanEntity3 addr 0x2739e00 size 0x114 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanEntity3() ;

/// @brief Method ScanPublicId1 addr 0x2739b44 size 0xb4 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanPublicId1() ;

/// @brief Method ScanPublicId2 addr 0x2739bf8 size 0x68 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanPublicId2() ;

/// @brief Method ScanCondSection1 addr 0x2739f14 size 0x29c virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanCondSection1() ;

/// @brief Method ScanCondSection2 addr 0x273a1b0 size 0x98 virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanCondSection2() ;

/// @brief Method ScanCondSection3 addr 0x273a248 size 0x44c virtual false final false
 System::Xml::System__Xml__DtdParser__Token ScanCondSection3() ;

/// @brief Method ScanName addr 0x273a994 size 0x8 virtual false final false
 void ScanName() ;

/// @brief Method ScanQName addr 0x273a99c size 0x8 virtual false final false
 void ScanQName() ;

/// @brief Method ScanQName addr 0x273bac0 size 0x280 virtual false final false
 void ScanQName(bool isQName) ;

/// @brief Method ReadDataInName addr 0x273bd40 size 0x44 virtual false final false
 bool ReadDataInName() ;

/// @brief Method ScanNmtoken addr 0x273a9a4 size 0x16c virtual false final false
 void ScanNmtoken() ;

/// @brief Method EatPublicKeyword addr 0x273ab10 size 0xe4 virtual false final false
 bool EatPublicKeyword() ;

/// @brief Method EatSystemKeyword addr 0x273abf4 size 0xe4 virtual false final false
 bool EatSystemKeyword() ;

/// @brief Method GetNameQualified addr 0x2733e70 size 0x170 virtual false final false
 System::Xml::XmlQualifiedName GetNameQualified(bool canHavePrefix) ;

/// @brief Method GetNameString addr 0x2736c18 size 0x1c virtual false final false
 ::StringW GetNameString() ;

/// @brief Method GetNmtokenString addr 0x2736d94 size 0x1c virtual false final false
 ::StringW GetNmtokenString() ;

/// @brief Method GetValue addr 0x2736e10 size 0x5c virtual false final false
 ::StringW GetValue() ;

/// @brief Method GetValueWithStrippedSpaces addr 0x2736db0 size 0x60 virtual false final false
 ::StringW GetValueWithStrippedSpaces() ;

/// @brief Method ReadData addr 0x273a728 size 0xc4 virtual false final false
 int32_t ReadData() ;

/// @brief Method LoadParsingBuffer addr 0x27333fc size 0x17c virtual false final false
 void LoadParsingBuffer() ;

/// @brief Method SaveParsingBuffer addr 0x27344f4 size 0x8 virtual false final false
 void SaveParsingBuffer() ;

/// @brief Method SaveParsingBuffer addr 0x2735fbc size 0x14c virtual false final false
 void SaveParsingBuffer(int32_t internalSubsetValueEndPos) ;

/// @brief Method HandleEntityReference addr 0x2737acc size 0x50 virtual false final false
 bool HandleEntityReference(bool paramEntity, bool inLiteral, bool inAttribute) ;

/// @brief Method HandleEntityReference addr 0x273bfac size 0x298 virtual false final false
 bool HandleEntityReference(System::Xml::XmlQualifiedName entityName, bool paramEntity, bool inLiteral, bool inAttribute) ;

/// @brief Method HandleEntityEnd addr 0x273a7ec size 0x1a8 virtual false final false
 bool HandleEntityEnd(bool inLiteral) ;

/// @brief Method VerifyEntityReference addr 0x273b8c0 size 0x200 virtual false final false
...
/// @brief Method SendValidationEvent addr 0x2735ee0 size 0xdc virtual false final false
 void SendValidationEvent(int32_t pos, System::Xml::Schema::XmlSeverityType severity, ::StringW code, ::StringW arg) ;

/// @brief Method SendValidationEvent addr 0x2736b50 size 0xc8 virtual false final false
 void SendValidationEvent(System::Xml::Schema::XmlSeverityType severity, ::StringW code, ::StringW arg) ;

/// @brief Method SendValidationEvent addr 0x27332bc size 0x140 virtual false final false
 void SendValidationEvent(System::Xml::Schema::XmlSeverityType severity, System::Xml::Schema::XmlSchemaException e) ;

/// @brief Method IsAttributeValueType addr 0x2736b44 size 0xc virtual false final false
 bool IsAttributeValueType(System::Xml::System__Xml__DtdParser__Token token) ;

/// @brief Method get_LineNo addr 0x2736110 size 0xa4 virtual false final false
 int32_t get_LineNo() ;

/// @brief Method get_LinePos addr 0x27361b4 size 0xb0 virtual false final false
 int32_t get_LinePos() ;

/// @brief Method get_BaseUriStr addr 0x2733198 size 0x124 virtual false final false
 ::StringW get_BaseUriStr() ;

/// @brief Method OnUnexpectedError addr 0x2733e24 size 0x4c virtual false final false
 void OnUnexpectedError() ;

/// @brief Method Throw addr 0x2735c54 size 0x68 virtual false final false
 void Throw(int32_t curPos, ::StringW res) ;

/// @brief Method Throw addr 0x27374d0 size 0x1e8 virtual false final false
 void Throw(int32_t curPos, ::StringW res, ::StringW arg) ;

/// @brief Method Throw addr 0x2737864 size 0x1e8 virtual false final false
 void Throw(int32_t curPos, ::StringW res, ::ArrayW<::StringW> args) ;

/// @brief Method Throw addr 0x2736264 size 0x1d0 virtual false final false
 void Throw(::StringW res, ::StringW arg, int32_t lineNo, int32_t linePos) ;

/// @brief Method ThrowInvalidChar addr 0x2732ba8 size 0x7c virtual false final false
 void ThrowInvalidChar(int32_t pos, ::StringW data, int32_t invCharPos) ;

/// @brief Method ThrowInvalidChar addr 0x2737a4c size 0x80 virtual false final false
 void ThrowInvalidChar(::ArrayW<char16_t> data, int32_t length, int32_t invCharPos) ;

/// @brief Method ThrowUnexpectedToken addr 0x2736108 size 0x8 virtual false final false
 void ThrowUnexpectedToken(int32_t pos, ::StringW expectedToken) ;

/// @brief Method ThrowUnexpectedToken addr 0x27376b8 size 0x1ac virtual false final false
 void ThrowUnexpectedToken(int32_t pos, ::StringW expectedToken1, ::StringW expectedToken2) ;

/// @brief Method ParseUnexpectedToken addr 0x2737b1c size 0xbc virtual false final false
 ::StringW ParseUnexpectedToken(int32_t startPos) ;

/// @brief Method StripSpaces addr 0x273bd84 size 0x228 virtual false final false
