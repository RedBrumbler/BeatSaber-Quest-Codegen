...
/// @brief Method .ctor addr 0x27452f0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method GetCharCount addr 0x27452f8 size 0x8 virtual true final false
 int32_t GetCharCount(::ArrayW<uint8_t> bytes, int32_t index, int32_t count) ;

/// @brief Method GetChars addr 0x2745300 size 0x70 virtual true final false
 int32_t GetChars(::ArrayW<uint8_t> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t> chars, int32_t charIndex) ;

/// @brief Method Convert addr 0x2745370 size 0x88 virtual true final false
