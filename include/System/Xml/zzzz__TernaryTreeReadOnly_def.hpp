...
/// @brief Method .ctor addr 0x26ef95c size 0x28 virtual false final false
 void _ctor(::ArrayW<uint8_t> nodeBuffer) ;

/// @brief Method FindCaseInsensitiveString addr 0x26ee1b8 size 0x12c virtual false final false
