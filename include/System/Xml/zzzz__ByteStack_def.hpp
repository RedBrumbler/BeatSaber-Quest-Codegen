...
/// @brief Method .ctor addr 0x26ed070 size 0x70 virtual false final false
 void _ctor(int32_t growthRate) ;

/// @brief Method Push addr 0x26ed0e0 size 0xd0 virtual false final false
 void Push(uint8_t data) ;

/// @brief Method Pop addr 0x26ed1b0 size 0x4c virtual false final false
 uint8_t Pop() ;
