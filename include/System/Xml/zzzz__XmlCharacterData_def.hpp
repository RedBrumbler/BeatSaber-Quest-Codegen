...
/// @brief Method .ctor addr 0x27222d4 size 0x2c virtual false final false
 void _ctor(::StringW data, System::Xml::XmlDocument doc) ;

/// @brief Method get_Value addr 0x2722440 size 0x10 virtual true final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x2722450 size 0x10 virtual true final false
 void set_Value(::StringW value) ;

/// @brief Method get_InnerText addr 0x2722460 size 0xc virtual true final false
 ::StringW get_InnerText() ;

/// @brief Method set_InnerText addr 0x272246c size 0xc virtual true final false
 void set_InnerText(::StringW value) ;

/// @brief Method get_Data addr 0x2722478 size 0x54 virtual true final false
 ::StringW get_Data() ;

/// @brief Method set_Data addr 0x27224cc size 0xa0 virtual true final false
 void set_Data(::StringW value) ;

/// @brief Method CheckOnData addr 0x272256c size 0x38 virtual false final false
