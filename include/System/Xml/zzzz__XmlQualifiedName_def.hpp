...
/// @brief Method .ctor addr 0x27487a4 size 0xd8 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x2748ae8 size 0x14 virtual true final false
...
/// @brief Method .ctor addr 0x27481a0 size 0x54 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "name", ty: "::StringW", modifiers: "", def_value: None }]
explicit XmlQualifiedName(::StringW name) ;

/// @brief Method .ctor addr 0x2748280 size 0x60 virtual false final false
...
/// @brief Method .ctor addr 0x27481f4 size 0x8c virtual false final false
 void _ctor(::StringW name, ::StringW ns) ;

/// @brief Method get_Namespace addr 0x27482e0 size 0x8 virtual false final false
 ::StringW get_Namespace() ;

/// @brief Method get_Name addr 0x27482e8 size 0x8 virtual false final false
 ::StringW get_Name() ;

/// @brief Method GetHashCode addr 0x27482f0 size 0xcc virtual true final false
 int32_t GetHashCode() ;

/// @brief Method get_IsEmpty addr 0x2748538 size 0x3c virtual false final false
 bool get_IsEmpty() ;

/// @brief Method ToString addr 0x2748574 size 0x70 virtual true final false
 ::StringW ToString() ;

/// @brief Method Equals addr 0x27485e4 size 0xe0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType other) ;

/// @brief Method op_Equality addr 0x2748734 size 0x68 virtual false final false
static bool op_Equality(System::Xml::XmlQualifiedName a, System::Xml::XmlQualifiedName b) ;

/// @brief Method op_Inequality addr 0x27486c4 size 0x70 virtual false final false
static bool op_Inequality(System::Xml::XmlQualifiedName a, System::Xml::XmlQualifiedName b) ;

/// @brief Method GetHashCodeDelegate addr 0x27483bc size 0x17c virtual false final false
static System::Xml::System__Xml__XmlQualifiedName__HashCodeOfStringDelegate GetHashCodeDelegate() ;

/// @brief Method IsRandomizedHashingDisabled addr 0x274879c size 0x8 virtual false final false
static bool IsRandomizedHashingDisabled() ;

/// @brief Method GetHashCodeOfString addr 0x274887c size 0x1c virtual false final false
static int32_t GetHashCodeOfString(::StringW s, int32_t length, int64_t additionalEntropy) ;

/// @brief Method Init addr 0x2748898 size 0xc virtual false final false
 void Init(::StringW name, ::StringW ns) ;

/// @brief Method Parse addr 0x27488a4 size 0x1b4 virtual false final false
