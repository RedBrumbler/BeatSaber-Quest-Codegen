...
/// @brief Method .ctor addr 0x2743a80 size 0x80 virtual false final false
 void _ctor(System::IO::Stream stream, System::Xml::XmlDownloadManager downloadManager, ::StringW host) ;

/// @brief Method Finalize addr 0x27448c8 size 0xa4 virtual true final false
 void Finalize() ;

/// @brief Method Dispose addr 0x274496c size 0x138 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method BeginRead addr 0x2744aa4 size 0x24 virtual true final false
...
/// @brief Method BeginWrite addr 0x2744ac8 size 0x24 virtual true final false
...
/// @brief Method EndRead addr 0x2744aec size 0x24 virtual true final false
 int32_t EndRead(System::IAsyncResult asyncResult) ;

/// @brief Method EndWrite addr 0x2744b10 size 0x24 virtual true final false
 void EndWrite(System::IAsyncResult asyncResult) ;

/// @brief Method Flush addr 0x2744b34 size 0x24 virtual true final false
 void Flush() ;

/// @brief Method Read addr 0x2744b58 size 0x24 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method ReadByte addr 0x2744b7c size 0x24 virtual true final false
 int32_t ReadByte() ;

/// @brief Method Seek addr 0x2744ba0 size 0x24 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0x2744bc4 size 0x24 virtual true final false
 void SetLength(int64_t value) ;

/// @brief Method Write addr 0x2744be8 size 0x24 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method WriteByte addr 0x2744c0c size 0x24 virtual true final false
 void WriteByte(uint8_t value) ;

/// @brief Method get_CanRead addr 0x2744c30 size 0x20 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanSeek addr 0x2744c50 size 0x20 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_CanWrite addr 0x2744c70 size 0x20 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_Length addr 0x2744c90 size 0x20 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x2744cb0 size 0x20 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x2744cd0 size 0x24 virtual true final false
