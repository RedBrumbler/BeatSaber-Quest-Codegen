...
namespace System::Xml {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11476))}
...
/// @brief Method .ctor addr 0x272db04 size 0x3cc virtual false final false
...
/// @brief Method get_Validity addr 0x272dfec size 0x30 virtual true final false
 System::Xml::Schema::XmlSchemaValidity get_Validity() ;

/// @brief Method get_IsDefault addr 0x272e01c size 0xc virtual true final false
 bool get_IsDefault() ;

/// @brief Method get_IsNil addr 0x272e028 size 0xc virtual true final false
 bool get_IsNil() ;

/// @brief Method get_MemberType addr 0x272e034 size 0x8 virtual true final false
 System::Xml::Schema::XmlSchemaSimpleType get_MemberType() ;

/// @brief Method get_SchemaType addr 0x272e03c size 0x8 virtual true final false
 System::Xml::Schema::XmlSchemaType get_SchemaType() ;

/// @brief Method get_SchemaElement addr 0x272e044 size 0x7c virtual true final false
 System::Xml::Schema::XmlSchemaElement get_SchemaElement() ;

/// @brief Method get_SchemaAttribute addr 0x272e0c0 size 0x7c virtual true final false
 System::Xml::Schema::XmlSchemaAttribute get_SchemaAttribute() ;

/// @brief Method SetValidity addr 0x272dfa0 size 0x14 virtual false final false
 void SetValidity(System::Xml::Schema::XmlSchemaValidity value) ;

/// @brief Method SetIsDefault addr 0x272dfb4 size 0x1c virtual false final false
 void SetIsDefault(bool value) ;

/// @brief Method SetIsNil addr 0x272dfd0 size 0x1c virtual false final false
 void SetIsNil(bool value) ;

/// @brief Method Equals addr 0x272e13c size 0x3d4 virtual true final false
