...
namespace System::Xml {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11484))}
...
/// @brief Method .ctor addr 0x2722714 size 0x28 virtual false final false
 void _ctor(System::Xml::XmlNode container) ;

/// @brief Method get_Count addr 0x272273c size 0x4c virtual true final false
 int32_t get_Count() ;

/// @brief Method GetEnumerator addr 0x2722788 size 0xb4 virtual true final false
