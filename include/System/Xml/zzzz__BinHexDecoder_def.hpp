...
namespace System::Xml {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11393))}
...
/// @brief Method get_IsFull addr 0x26ec444 size 0x10 virtual true final false
 bool get_IsFull() ;

/// @brief Method Decode addr 0x26ec454 size 0x158 virtual true final false
 int32_t Decode(::ArrayW<char16_t> chars, int32_t startPos, int32_t len) ;

/// @brief Method Decode addr 0x26ec778 size 0x1e8 virtual false final false
static ::ArrayW<uint8_t> Decode(::ArrayW<char16_t> chars, bool allowOddChars) ;

/// @brief Method Decode addr 0x26ec5ac size 0x1cc virtual false final false
