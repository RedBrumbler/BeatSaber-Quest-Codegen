...
/// @brief Method .ctor addr 0x26ed270 size 0x74 virtual false final false
 void _ctor(System::Xml::CharEntityEncoderFallback parent) ;

/// @brief Method Fallback addr 0x26ed368 size 0x1f0 virtual true final false
 bool Fallback(char16_t charUnknown, int32_t index) ;

/// @brief Method Fallback addr 0x26ed558 size 0x280 virtual true final false
 bool Fallback(char16_t charUnknownHigh, char16_t charUnknownLow, int32_t index) ;

/// @brief Method GetNextChar addr 0x26ed7e8 size 0x58 virtual true final false
 char16_t GetNextChar() ;

/// @brief Method MovePrevious addr 0x26ed840 size 0x20 virtual true final false
 bool MovePrevious() ;

/// @brief Method get_Remaining addr 0x26ed860 size 0x34 virtual true final false
 int32_t get_Remaining() ;

/// @brief Method Reset addr 0x26ed894 size 0xc virtual true final false
 void Reset() ;

/// @brief Method SurrogateCharToUtf32 addr 0x26ed7d8 size 0x10 virtual false final false
