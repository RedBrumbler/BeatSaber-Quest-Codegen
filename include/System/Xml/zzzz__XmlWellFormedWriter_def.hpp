...
/// @brief Method .ctor addr 0x27176f4 size 0x28 virtual false final false
 void _ctor(System::Xml::XmlWellFormedWriter wfWriter) ;

/// @brief Method System.Xml.IXmlNamespaceResolver.LookupNamespace addr 0x271ea64 size 0x18 virtual true final true
 ::StringW System_Xml_IXmlNamespaceResolver_LookupNamespace(::StringW prefix) ;

/// @brief Method System.Xml.IXmlNamespaceResolver.LookupPrefix addr 0x271ea7c size 0x24 virtual true final true
...
/// @brief Method Set addr 0x271772c size 0x1c virtual false final false
 void Set(::StringW prefix, ::StringW localName, ::StringW namespaceUri, int32_t prevNSTop) ;

/// @brief Method WriteEndElement addr 0x2718f0c size 0x30 virtual false final false
 void WriteEndElement(System::Xml::XmlRawWriter rawWriter) ;

/// @brief Method WriteFullEndElement addr 0x27191fc size 0x30 virtual false final false
...
/// @brief Method Set addr 0x271771c size 0x10 virtual false final false
 void Set(::StringW prefix, ::StringW namespaceUri, System::Xml::System__Xml__XmlWellFormedWriter__NamespaceKind kind) ;

/// @brief Method WriteDecl addr 0x271dca0 size 0x12c virtual false final false
...
/// @brief Method Set addr 0x271df4c size 0x10 virtual false final false
 void Set(::StringW prefix, ::StringW localName, ::StringW namespaceUri) ;

/// @brief Method IsDuplicate addr 0x271df5c size 0x6c virtual false final false
...
/// @brief Method .ctor addr 0x271ec8c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Set addr 0x271ec94 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x271ec50 size 0x3c virtual false final false
...
/// @brief Method get_StringValue addr 0x271a634 size 0x34 virtual false final false
 ::StringW get_StringValue() ;

/// @brief Method WriteEntityRef addr 0x271b92c size 0x19c virtual false final false
 void WriteEntityRef(::StringW name) ;

/// @brief Method WriteCharEntity addr 0x271bc74 size 0x94 virtual false final false
 void WriteCharEntity(char16_t ch) ;

/// @brief Method WriteSurrogateCharEntity addr 0x271beac size 0xc4 virtual false final false
 void WriteSurrogateCharEntity(char16_t lowChar, char16_t highChar) ;

/// @brief Method WriteWhitespace addr 0x271c130 size 0x50 virtual false final false
 void WriteWhitespace(::StringW ws) ;

/// @brief Method WriteString addr 0x271c270 size 0x70 virtual false final false
 void WriteString(::StringW text) ;

/// @brief Method WriteChars addr 0x271c55c size 0xb0 virtual false final false
 void WriteChars(::ArrayW<char16_t> buffer, int32_t index, int32_t count) ;

/// @brief Method WriteRaw addr 0x271c888 size 0xb0 virtual false final false
 void WriteRaw(::ArrayW<char16_t> buffer, int32_t index, int32_t count) ;

/// @brief Method WriteRaw addr 0x271ca28 size 0x50 virtual false final false
 void WriteRaw(::StringW data) ;

/// @brief Method WriteValue addr 0x271d2e4 size 0x50 virtual false final false
 void WriteValue(::StringW value) ;

/// @brief Method Replay addr 0x271ab44 size 0x324 virtual false final false
 void Replay(System::Xml::XmlWriter writer) ;

/// @brief Method Trim addr 0x271ae68 size 0x454 virtual false final false
 void Trim() ;

/// @brief Method Clear addr 0x271b2bc size 0x30 virtual false final false
 void Clear() ;

/// @brief Method StartComplexValue addr 0x271eaa0 size 0x3c virtual false final false
 void StartComplexValue() ;

/// @brief Method AddItem addr 0x271eadc size 0x174 virtual false final false
...
/// @brief Method .ctor addr 0x271d49c size 0x70 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2717308 size 0x3e4 virtual false final false
 void _ctor(System::Xml::XmlWriter writer, System::Xml::XmlWriterSettings settings) ;

/// @brief Method get_WriteState addr 0x2717748 size 0x94 virtual true final false
 System::Xml::WriteState get_WriteState() ;

/// @brief Method WriteStartDocument addr 0x27177dc size 0x8 virtual true final false
 void WriteStartDocument() ;

/// @brief Method WriteStartDocument addr 0x2717998 size 0x1c virtual true final false
 void WriteStartDocument(bool standalone) ;

/// @brief Method WriteEndDocument addr 0x27179b4 size 0x15c virtual true final false
 void WriteEndDocument() ;

/// @brief Method WriteDocType addr 0x2717e1c size 0x4ec virtual true final false
 void WriteDocType(::StringW name, ::StringW pubid, ::StringW sysid, ::StringW subset) ;

/// @brief Method WriteStartElement addr 0x2718308 size 0x3b8 virtual true final false
 void WriteStartElement(::StringW prefix, ::StringW localName, ::StringW ns) ;

/// @brief Method WriteEndElement addr 0x2718d20 size 0x1ec virtual true final false
 void WriteEndElement() ;

/// @brief Method WriteFullEndElement addr 0x2719010 size 0x1ec virtual true final false
 void WriteFullEndElement() ;

/// @brief Method WriteStartAttribute addr 0x271922c size 0x6d4 virtual true final false
 void WriteStartAttribute(::StringW prefix, ::StringW localName, ::StringW namespaceName) ;

/// @brief Method WriteEndAttribute addr 0x2719e08 size 0x82c virtual true final false
 void WriteEndAttribute() ;

/// @brief Method WriteCData addr 0x271b2ec size 0x104 virtual true final false
 void WriteCData(::StringW text) ;

/// @brief Method WriteComment addr 0x271b3f0 size 0x104 virtual true final false
 void WriteComment(::StringW text) ;

/// @brief Method WriteProcessingInstruction addr 0x271b4f4 size 0x2bc virtual true final false
 void WriteProcessingInstruction(::StringW name, ::StringW text) ;

/// @brief Method WriteEntityRef addr 0x271b7b0 size 0x16c virtual true final false
 void WriteEntityRef(::StringW name) ;

/// @brief Method WriteCharEntity addr 0x271bac8 size 0x1ac virtual true final false
 void WriteCharEntity(char16_t ch) ;

/// @brief Method WriteSurrogateCharEntity addr 0x271bd08 size 0x1a4 virtual true final false
 void WriteSurrogateCharEntity(char16_t lowChar, char16_t highChar) ;

/// @brief Method WriteWhitespace addr 0x271bf70 size 0x1c0 virtual true final false
 void WriteWhitespace(::StringW ws) ;

/// @brief Method WriteString addr 0x271c180 size 0xf0 virtual true final false
 void WriteString(::StringW text) ;

/// @brief Method WriteChars addr 0x271c2e0 size 0x27c virtual true final false
 void WriteChars(::ArrayW<char16_t> buffer, int32_t index, int32_t count) ;

/// @brief Method WriteRaw addr 0x271c60c size 0x27c virtual true final false
 void WriteRaw(::ArrayW<char16_t> buffer, int32_t index, int32_t count) ;

/// @brief Method WriteRaw addr 0x271c938 size 0xf0 virtual true final false
 void WriteRaw(::StringW data) ;

/// @brief Method WriteBase64 addr 0x271ca78 size 0x250 virtual true final false
 void WriteBase64(::ArrayW<uint8_t> buffer, int32_t index, int32_t count) ;

/// @brief Method Close addr 0x271ccc8 size 0x1bc virtual true final false
 void Close() ;

/// @brief Method Flush addr 0x271ceb0 size 0xb4 virtual true final false
 void Flush() ;

/// @brief Method LookupPrefix addr 0x271cf64 size 0x280 virtual true final false
 ::StringW LookupPrefix(::StringW ns) ;

/// @brief Method WriteValue addr 0x271d1e4 size 0x100 virtual true final false
 void WriteValue(::StringW value) ;

/// @brief Method WriteBinHex addr 0x271d334 size 0x134 virtual true final false
 void WriteBinHex(::ArrayW<uint8_t> buffer, int32_t index, int32_t count) ;

/// @brief Method get_RawWriter addr 0x271d494 size 0x8 virtual false final false
 System::Xml::XmlRawWriter get_RawWriter() ;

/// @brief Method get_SaveAttrValue addr 0x271b91c size 0x10 virtual false final false
 bool get_SaveAttrValue() ;

/// @brief Method get_InBase64 addr 0x271ce84 size 0x2c virtual false final false
 bool get_InBase64() ;

/// @brief Method SetSpecialAttribute addr 0x2719900 size 0x90 virtual false final false
 void SetSpecialAttribute(System::Xml::System__Xml__XmlWellFormedWriter__SpecialAttribute special) ;

/// @brief Method WriteStartDocumentImpl addr 0x27177e4 size 0x1b4 virtual false final false
 void WriteStartDocumentImpl(System::Xml::XmlStandalone standalone) ;

/// @brief Method StartFragment addr 0x271d50c size 0xc virtual false final false
 void StartFragment() ;

/// @brief Method PushNamespaceImplicit addr 0x27188f4 size 0x42c virtual false final false
 void PushNamespaceImplicit(::StringW prefix, ::StringW ns) ;

/// @brief Method PushNamespaceExplicit addr 0x271a668 size 0x4dc virtual false final false
 bool PushNamespaceExplicit(::StringW prefix, ::StringW ns) ;

/// @brief Method AddNamespace addr 0x271d5f4 size 0x17c virtual false final false
 void AddNamespace(::StringW prefix, ::StringW ns, System::Xml::System__Xml__XmlWellFormedWriter__NamespaceKind kind) ;

/// @brief Method AddToNamespaceHashtable addr 0x271d87c size 0xe8 virtual false final false
 void AddToNamespaceHashtable(int32_t namespaceIndex) ;

/// @brief Method LookupNamespaceIndex addr 0x271d518 size 0xdc virtual false final false
 int32_t LookupNamespaceIndex(::StringW prefix) ;

/// @brief Method PopNamespaces addr 0x2718f3c size 0xd4 virtual false final false
 void PopNamespaces(int32_t indexFrom, int32_t indexTo) ;

/// @brief Method DupAttrException addr 0x271d770 size 0x10c virtual false final false
static System::Xml::XmlException DupAttrException(::StringW prefix, ::StringW localName) ;

/// @brief Method AdvanceState addr 0x2717b10 size 0x30c virtual false final false
 void AdvanceState(System::Xml::System__Xml__XmlWellFormedWriter__Token token) ;

/// @brief Method StartElementContent addr 0x271dbd8 size 0xc8 virtual false final false
 void StartElementContent() ;

/// @brief Method GetStateName addr 0x271d964 size 0xa0 virtual false final false
static ::StringW GetStateName(System::Xml::System__Xml__XmlWellFormedWriter__State state) ;

/// @brief Method LookupNamespace addr 0x27187c0 size 0x134 virtual false final false
 ::StringW LookupNamespace(::StringW prefix) ;

/// @brief Method LookupLocalNamespace addr 0x2719ac4 size 0xd0 virtual false final false
 ::StringW LookupLocalNamespace(::StringW prefix) ;

/// @brief Method GeneratePrefix addr 0x2719990 size 0x134 virtual false final false
 ::StringW GeneratePrefix() ;

/// @brief Method CheckNCName addr 0x27186c0 size 0x100 virtual false final false
 void CheckNCName(::StringW ncname) ;

/// @brief Method InvalidCharsException addr 0x271ddcc size 0x180 virtual false final false
static System::Exception InvalidCharsException(::StringW name, int32_t badCharIndex) ;

/// @brief Method ThrowInvalidStateTransition addr 0x271da04 size 0x1d4 virtual false final false
...
/// @brief Method get_IsClosedOrErrorState addr 0x271d468 size 0x10 virtual false final false
 bool get_IsClosedOrErrorState() ;

/// @brief Method AddAttribute addr 0x2719b94 size 0x274 virtual false final false
 void AddAttribute(::StringW prefix, ::StringW localName, ::StringW namespaceName) ;

/// @brief Method AddToAttrHashTable addr 0x271dfc8 size 0x13c virtual false final false
