...
namespace System::Xml {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11365))}
...
/// @brief Method .ctor addr 0x26ec3fc size 0x24 virtual false final false
 void _ctor(System::Xml::XmlRawWriter rawWriter) ;

/// @brief Method WriteChars addr 0x26ec420 size 0x24 virtual true final false
