...
/// @brief Method .ctor addr 0x26ecd78 size 0x20 virtual false final false
 void _ctor() ;

/// @brief Method PushBit addr 0x26ecd98 size 0x38 virtual false final false
 void PushBit(bool bit) ;

/// @brief Method PopBit addr 0x26ece98 size 0x28 virtual false final false
 bool PopBit() ;

/// @brief Method PeekBit addr 0x26ecf04 size 0xc virtual false final false
 bool PeekBit() ;

/// @brief Method PushCurr addr 0x26ecdd0 size 0xc8 virtual false final false
 void PushCurr() ;

/// @brief Method PopCurr addr 0x26ecec0 size 0x44 virtual false final false
 void PopCurr() ;
