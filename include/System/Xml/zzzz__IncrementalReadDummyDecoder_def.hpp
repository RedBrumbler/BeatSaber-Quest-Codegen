...
/// @brief Method get_IsFull addr 0x26f22f4 size 0x8 virtual true final false
 bool get_IsFull() ;

/// @brief Method Decode addr 0x26f22fc size 0x8 virtual true final false
 int32_t Decode(::ArrayW<char16_t> chars, int32_t startPos, int32_t len) ;

// Ctor Parameters []
explicit IncrementalReadDummyDecoder() ;

/// @brief Method .ctor addr 0x26f2304 size 0x8 virtual false final false
 void _ctor() ;
