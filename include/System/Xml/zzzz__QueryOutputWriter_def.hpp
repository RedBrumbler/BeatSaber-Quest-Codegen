...
/// @brief Method .ctor addr 0x26f230c size 0x2d4 virtual false final false
 void _ctor(System::Xml::XmlRawWriter writer, System::Xml::XmlWriterSettings settings) ;

/// @brief Method set_NamespaceResolver addr 0x26f25e8 size 0x2c virtual true final false
 void set_NamespaceResolver(System::Xml::IXmlNamespaceResolver value) ;

/// @brief Method WriteXmlDeclaration addr 0x26f2614 size 0x24 virtual true final false
 void WriteXmlDeclaration(System::Xml::XmlStandalone standalone) ;

/// @brief Method WriteXmlDeclaration addr 0x26f2638 size 0x24 virtual true final false
 void WriteXmlDeclaration(::StringW xmldecl) ;

/// @brief Method WriteDocType addr 0x26f265c size 0x38 virtual true final false
 void WriteDocType(::StringW name, ::StringW pubid, ::StringW sysid, ::StringW subset) ;

/// @brief Method WriteStartElement addr 0x26f2694 size 0x1c8 virtual true final false
 void WriteStartElement(::StringW prefix, ::StringW localName, ::StringW ns) ;

/// @brief Method WriteEndElement addr 0x26f2864 size 0x70 virtual true final false
 void WriteEndElement(::StringW prefix, ::StringW localName, ::StringW ns) ;

/// @brief Method WriteFullEndElement addr 0x26f28d4 size 0x70 virtual true final false
 void WriteFullEndElement(::StringW prefix, ::StringW localName, ::StringW ns) ;

/// @brief Method StartElementContent addr 0x26f2944 size 0x24 virtual true final false
 void StartElementContent() ;

/// @brief Method WriteStartAttribute addr 0x26f2968 size 0x2c virtual true final false
 void WriteStartAttribute(::StringW prefix, ::StringW localName, ::StringW ns) ;

/// @brief Method WriteEndAttribute addr 0x26f2994 size 0x2c virtual true final false
 void WriteEndAttribute() ;

/// @brief Method WriteNamespaceDeclaration addr 0x26f29c0 size 0x24 virtual true final false
 void WriteNamespaceDeclaration(::StringW prefix, ::StringW ns) ;

/// @brief Method get_SupportsNamespaceDeclarationInChunks addr 0x26f29e4 size 0x24 virtual true final false
 bool get_SupportsNamespaceDeclarationInChunks() ;

/// @brief Method WriteStartNamespaceDeclaration addr 0x26f2a08 size 0x24 virtual true final false
 void WriteStartNamespaceDeclaration(::StringW prefix) ;

/// @brief Method WriteEndNamespaceDeclaration addr 0x26f2a2c size 0x24 virtual true final false
 void WriteEndNamespaceDeclaration() ;

/// @brief Method WriteCData addr 0x26f2a50 size 0x24 virtual true final false
 void WriteCData(::StringW text) ;

/// @brief Method WriteComment addr 0x26f2a74 size 0x2c virtual true final false
 void WriteComment(::StringW text) ;

/// @brief Method WriteProcessingInstruction addr 0x26f2aa0 size 0x2c virtual true final false
 void WriteProcessingInstruction(::StringW name, ::StringW text) ;

/// @brief Method WriteWhitespace addr 0x26f2acc size 0x70 virtual true final false
 void WriteWhitespace(::StringW ws) ;

/// @brief Method WriteString addr 0x26f2b78 size 0x70 virtual true final false
 void WriteString(::StringW text) ;

/// @brief Method WriteChars addr 0x26f2be8 size 0x88 virtual true final false
 void WriteChars(::ArrayW<char16_t> buffer, int32_t index, int32_t count) ;

/// @brief Method WriteEntityRef addr 0x26f2c70 size 0x2c virtual true final false
 void WriteEntityRef(::StringW name) ;

/// @brief Method WriteCharEntity addr 0x26f2c9c size 0x2c virtual true final false
 void WriteCharEntity(char16_t ch) ;

/// @brief Method WriteSurrogateCharEntity addr 0x26f2cc8 size 0x2c virtual true final false
 void WriteSurrogateCharEntity(char16_t lowChar, char16_t highChar) ;

/// @brief Method WriteRaw addr 0x26f2cf4 size 0x88 virtual true final false
 void WriteRaw(::ArrayW<char16_t> buffer, int32_t index, int32_t count) ;

/// @brief Method WriteRaw addr 0x26f2d7c size 0x70 virtual true final false
 void WriteRaw(::StringW data) ;

/// @brief Method Close addr 0x26f2dec size 0xa8 virtual true final false
 void Close() ;

/// @brief Method Flush addr 0x26f2e94 size 0x24 virtual true final false
 void Flush() ;

/// @brief Method StartCDataSection addr 0x26f2b3c size 0x3c virtual false final false
 bool StartCDataSection() ;

/// @brief Method EndCDataSection addr 0x26f285c size 0x8 virtual false final false
