...
/// @brief Method .ctor addr 0x272291c size 0x190 virtual false final false
 void _ctor(::StringW version, ::StringW encoding, ::StringW standalone, System::Xml::XmlDocument doc) ;

/// @brief Method get_Version addr 0x2722cdc size 0x8 virtual false final false
 ::StringW get_Version() ;

/// @brief Method set_Version addr 0x2722ce4 size 0x8 virtual false final false
 void set_Version(::StringW value) ;

/// @brief Method get_Encoding addr 0x2722cec size 0x8 virtual false final false
 ::StringW get_Encoding() ;

/// @brief Method set_Encoding addr 0x2722b28 size 0x68 virtual false final false
 void set_Encoding(::StringW value) ;

/// @brief Method get_Standalone addr 0x2722cf4 size 0x8 virtual false final false
 ::StringW get_Standalone() ;

/// @brief Method set_Standalone addr 0x2722b90 size 0x14c virtual false final false
 void set_Standalone(::StringW value) ;

/// @brief Method get_Value addr 0x2722cfc size 0x10 virtual true final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x2722d0c size 0x10 virtual true final false
 void set_Value(::StringW value) ;

/// @brief Method get_InnerText addr 0x2722d1c size 0x168 virtual true final false
 ::StringW get_InnerText() ;

/// @brief Method set_InnerText addr 0x2722e84 size 0x18c virtual true final false
 void set_InnerText(::StringW value) ;

/// @brief Method get_Name addr 0x2723010 size 0x40 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_LocalName addr 0x2723050 size 0xc virtual true final false
 ::StringW get_LocalName() ;

/// @brief Method get_NodeType addr 0x272305c size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method CloneNode addr 0x2723064 size 0x3c virtual true final false
 System::Xml::XmlNode CloneNode(bool deep) ;

/// @brief Method IsValidXmlVersion addr 0x2722aac size 0x7c virtual false final false
