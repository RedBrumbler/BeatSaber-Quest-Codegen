...
/// @brief Method .ctor addr 0x2727778 size 0xc4 virtual false final false
 void _ctor(::StringW name, ::StringW publicId, ::StringW systemId, ::StringW internalSubset, System::Xml::XmlDocument doc) ;

/// @brief Method get_Name addr 0x27278bc size 0x8 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_LocalName addr 0x27278c4 size 0x8 virtual true final false
 ::StringW get_LocalName() ;

/// @brief Method get_NodeType addr 0x27278cc size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method CloneNode addr 0x27278d4 size 0x3c virtual true final false
 System::Xml::XmlNode CloneNode(bool deep) ;

/// @brief Method get_IsReadOnly addr 0x2727910 size 0x8 virtual true final false
 bool get_IsReadOnly() ;

/// @brief Method get_Entities addr 0x2727918 size 0x70 virtual false final false
 System::Xml::XmlNamedNodeMap get_Entities() ;

/// @brief Method get_Notations addr 0x27279b0 size 0x70 virtual false final false
 System::Xml::XmlNamedNodeMap get_Notations() ;

/// @brief Method get_PublicId addr 0x2727a20 size 0x8 virtual false final false
 ::StringW get_PublicId() ;

/// @brief Method get_SystemId addr 0x2727a28 size 0x8 virtual false final false
 ::StringW get_SystemId() ;

/// @brief Method get_InternalSubset addr 0x2727a30 size 0x8 virtual false final false
 ::StringW get_InternalSubset() ;

/// @brief Method get_ParseWithNamespaces addr 0x2727a38 size 0x8 virtual false final false
 bool get_ParseWithNamespaces() ;

/// @brief Method get_DtdSchemaInfo addr 0x2727a40 size 0x8 virtual false final false
 System::Xml::Schema::SchemaInfo get_DtdSchemaInfo() ;

/// @brief Method set_DtdSchemaInfo addr 0x2727a48 size 0x8 virtual false final false
