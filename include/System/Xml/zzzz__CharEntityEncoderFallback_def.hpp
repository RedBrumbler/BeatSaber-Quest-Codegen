...
/// @brief Method .ctor addr 0x26ed1fc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method CreateFallbackBuffer addr 0x26ed204 size 0x6c virtual true final false
 System::Text::EncoderFallbackBuffer CreateFallbackBuffer() ;

/// @brief Method get_MaxCharCount addr 0x26ed2e4 size 0x8 virtual true final false
 int32_t get_MaxCharCount() ;

/// @brief Method set_StartOffset addr 0x26ed2ec size 0x8 virtual false final false
 void set_StartOffset(int32_t value) ;

/// @brief Method Reset addr 0x26ed2f4 size 0xc virtual false final false
 void Reset(::ArrayW<int32_t> textContentMarks, int32_t endMarkPos) ;

/// @brief Method CanReplaceAt addr 0x26ed300 size 0x68 virtual false final false
