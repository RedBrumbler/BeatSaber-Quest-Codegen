...
/// @brief Method ResolveUri addr 0x2748afc size 0x1d8 virtual true final false
 System::Uri ResolveUri(System::Uri baseUri, ::StringW relativeUri) ;

/// @brief Method SupportsType addr 0x2748cd4 size 0x148 virtual true final false
 bool SupportsType(System::Uri absoluteUri, System::Type type) ;

/// @brief Method GetEntityAsync addr 0x2748e1c size 0x40 virtual true final false
...
/// @brief Method .ctor addr 0x2748e5c size 0x8 virtual false final false
 void _ctor() ;
