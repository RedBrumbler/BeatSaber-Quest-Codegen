...
/// @brief Method .ctor addr 0x2727204 size 0x84 virtual false final false
 void _ctor(System::Xml::XmlDocument ownerDocument) ;

/// @brief Method get_Name addr 0x2727290 size 0x28 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_LocalName addr 0x27272b8 size 0x28 virtual true final false
 ::StringW get_LocalName() ;

/// @brief Method get_NodeType addr 0x27272e0 size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_ParentNode addr 0x27272e8 size 0x8 virtual true final false
 System::Xml::XmlNode get_ParentNode() ;

/// @brief Method get_OwnerDocument addr 0x27272f0 size 0x78 virtual true final false
 System::Xml::XmlDocument get_OwnerDocument() ;

/// @brief Method set_InnerXml addr 0x2727368 size 0x8c virtual true final false
 void set_InnerXml(::StringW value) ;

/// @brief Method CloneNode addr 0x2727600 size 0x84 virtual true final false
 System::Xml::XmlNode CloneNode(bool deep) ;

/// @brief Method get_IsContainer addr 0x2727684 size 0x8 virtual true final false
 bool get_IsContainer() ;

/// @brief Method get_LastNode addr 0x272768c size 0x8 virtual true final false
 System::Xml::XmlLinkedNode get_LastNode() ;

/// @brief Method set_LastNode addr 0x2727694 size 0x8 virtual true final false
 void set_LastNode(System::Xml::XmlLinkedNode value) ;

/// @brief Method IsValidChildType addr 0x272769c size 0x6c virtual true final false
 bool IsValidChildType(System::Xml::XmlNodeType type) ;

/// @brief Method CanInsertAfter addr 0x2727708 size 0x70 virtual true final false
