...
/// @brief Method .ctor addr 0x272b320 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x272b318 size 0x8 virtual false final false
 void _ctor(::StringW strData, System::Xml::XmlDocument doc) ;

/// @brief Method get_Name addr 0x27315d4 size 0x28 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_LocalName addr 0x27315fc size 0x28 virtual true final false
 ::StringW get_LocalName() ;

/// @brief Method get_NodeType addr 0x2731624 size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_ParentNode addr 0x273162c size 0x84 virtual true final false
 System::Xml::XmlNode get_ParentNode() ;

/// @brief Method CloneNode addr 0x27316b0 size 0x5c virtual true final false
 System::Xml::XmlNode CloneNode(bool deep) ;

/// @brief Method get_Value addr 0x273170c size 0x10 virtual true final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x273171c size 0xd4 virtual true final false
 void set_Value(::StringW value) ;

/// @brief Method get_IsText addr 0x27317f0 size 0x8 virtual true final false
 bool get_IsText() ;
