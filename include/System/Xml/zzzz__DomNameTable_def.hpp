...
/// @brief Method .ctor addr 0x271fc54 size 0x84 virtual false final false
 void _ctor(System::Xml::XmlDocument document) ;

/// @brief Method GetName addr 0x271fcf4 size 0x15c virtual false final false
 System::Xml::XmlName GetName(::StringW prefix, ::StringW localName, ::StringW ns, System::Xml::Schema::IXmlSchemaInfo schemaInfo) ;

/// @brief Method AddName addr 0x271fe50 size 0x264 virtual false final false
 System::Xml::XmlName AddName(::StringW prefix, ::StringW localName, ::StringW ns, System::Xml::Schema::IXmlSchemaInfo schemaInfo) ;

/// @brief Method Grow addr 0x27200b4 size 0x124 virtual false final false
 void Grow() ;
