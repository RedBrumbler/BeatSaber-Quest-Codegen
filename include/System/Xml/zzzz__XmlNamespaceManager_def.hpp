...
/// @brief Method Set addr 0x2747748 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x2747584 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x274758c size 0x1bc virtual false final false
 void _ctor(System::Xml::XmlNameTable nameTable) ;

/// @brief Method get_NameTable addr 0x2747754 size 0x8 virtual true final false
 System::Xml::XmlNameTable get_NameTable() ;

/// @brief Method get_DefaultNamespace addr 0x274775c size 0x70 virtual true final false
 ::StringW get_DefaultNamespace() ;

/// @brief Method PushScope addr 0x27477cc size 0x10 virtual true final false
 void PushScope() ;

/// @brief Method PopScope addr 0x27477dc size 0xd8 virtual true final false
 bool PopScope() ;

/// @brief Method AddNamespace addr 0x27478b4 size 0x3a4 virtual true final false
 void AddNamespace(::StringW prefix, ::StringW uri) ;

/// @brief Method RemoveNamespace addr 0x2747de4 size 0x13c virtual true final false
 void RemoveNamespace(::StringW prefix, ::StringW uri) ;

/// @brief Method GetEnumerator addr 0x2747f20 size 0x170 virtual true final false
 System::Collections::IEnumerator GetEnumerator() ;

/// @brief Method LookupNamespace addr 0x2748090 size 0x4c virtual true final false
 ::StringW LookupNamespace(::StringW prefix) ;

/// @brief Method LookupNamespaceDecl addr 0x2747c58 size 0x18c virtual false final false
 int32_t LookupNamespaceDecl(::StringW prefix) ;

/// @brief Method LookupPrefix addr 0x27480dc size 0xc4 virtual true final false
