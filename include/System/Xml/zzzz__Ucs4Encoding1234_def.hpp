...
/// @brief Method .ctor addr 0x2745604 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method get_EncodingName addr 0x27457f8 size 0x40 virtual true final false
 ::StringW get_EncodingName() ;

/// @brief Method GetPreamble addr 0x2745838 size 0x78 virtual true final false
