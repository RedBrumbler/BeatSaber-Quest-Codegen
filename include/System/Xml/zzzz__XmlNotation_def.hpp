...
/// @brief Method .ctor addr 0x272caf0 size 0x68 virtual false final false
 void _ctor(::StringW name, ::StringW publicId, ::StringW systemId, System::Xml::XmlDocument doc) ;

/// @brief Method get_Name addr 0x27311b4 size 0x8 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_LocalName addr 0x27311bc size 0x8 virtual true final false
 ::StringW get_LocalName() ;

/// @brief Method get_NodeType addr 0x27311c4 size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method CloneNode addr 0x27311cc size 0x60 virtual true final false
 System::Xml::XmlNode CloneNode(bool deep) ;

/// @brief Method get_IsReadOnly addr 0x273122c size 0x8 virtual true final false
 bool get_IsReadOnly() ;

/// @brief Method set_InnerXml addr 0x2731234 size 0x60 virtual true final false
