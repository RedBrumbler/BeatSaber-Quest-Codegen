...
/// @brief Method InitEvent addr 0x26f7dec size 0xc virtual false final false
 void InitEvent(System::Xml::System__Xml__XmlEventCache__XmlEventType eventType, ::bs_hook::Il2CppWrapperType o) ;

/// @brief Method get_EventType addr 0x26f7e00 size 0x8 virtual false final false
 System::Xml::System__Xml__XmlEventCache__XmlEventType get_EventType() ;

/// @brief Method get_String1 addr 0x26f7e08 size 0x8 virtual false final false
 ::StringW get_String1() ;

/// @brief Method get_String2 addr 0x26f7e10 size 0x8 virtual false final false
 ::StringW get_String2() ;

/// @brief Method get_String3 addr 0x26f7e18 size 0x8 virtual false final false
 ::StringW get_String3() ;

/// @brief Method get_Object addr 0x26f7e20 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x26f3ce8 size 0x30 virtual false final false
 void _ctor(::StringW baseUri, bool hasRootNode) ;

/// @brief Method EndEvents addr 0x26f47f8 size 0x14 virtual false final false
 void EndEvents() ;

/// @brief Method EventsToWriter addr 0x26f480c size 0x6f4 virtual false final false
 void EventsToWriter(System::Xml::XmlWriter writer) ;

/// @brief Method WriteDocType addr 0x26f7530 size 0x18 virtual true final false
 void WriteDocType(::StringW name, ::StringW pubid, ::StringW sysid, ::StringW subset) ;

/// @brief Method WriteStartElement addr 0x26f75b8 size 0x14 virtual true final false
 void WriteStartElement(::StringW prefix, ::StringW localName, ::StringW ns) ;

/// @brief Method WriteStartAttribute addr 0x26f7630 size 0x14 virtual true final false
 void WriteStartAttribute(::StringW prefix, ::StringW localName, ::StringW ns) ;

/// @brief Method WriteEndAttribute addr 0x26f7644 size 0x8 virtual true final false
 void WriteEndAttribute() ;

/// @brief Method WriteCData addr 0x26f764c size 0xc virtual true final false
 void WriteCData(::StringW text) ;

/// @brief Method WriteComment addr 0x26f76a8 size 0xc virtual true final false
 void WriteComment(::StringW text) ;

/// @brief Method WriteProcessingInstruction addr 0x26f76b4 size 0x10 virtual true final false
 void WriteProcessingInstruction(::StringW name, ::StringW text) ;

/// @brief Method WriteWhitespace addr 0x26f7720 size 0xc virtual true final false
 void WriteWhitespace(::StringW ws) ;

/// @brief Method WriteString addr 0x26f772c size 0x24 virtual true final false
 void WriteString(::StringW text) ;

/// @brief Method WriteChars addr 0x26f7750 size 0x30 virtual true final false
 void WriteChars(::ArrayW<char16_t> buffer, int32_t index, int32_t count) ;

/// @brief Method WriteRaw addr 0x26f7780 size 0x30 virtual true final false
 void WriteRaw(::ArrayW<char16_t> buffer, int32_t index, int32_t count) ;

/// @brief Method WriteRaw addr 0x26f77b0 size 0xc virtual true final false
 void WriteRaw(::StringW data) ;

/// @brief Method WriteEntityRef addr 0x26f77bc size 0xc virtual true final false
 void WriteEntityRef(::StringW name) ;

/// @brief Method WriteCharEntity addr 0x26f77c8 size 0x6c virtual true final false
 void WriteCharEntity(char16_t ch) ;

/// @brief Method WriteSurrogateCharEntity addr 0x26f7884 size 0x8c virtual true final false
 void WriteSurrogateCharEntity(char16_t lowChar, char16_t highChar) ;

/// @brief Method WriteBase64 addr 0x26f7910 size 0x2c virtual true final false
 void WriteBase64(::ArrayW<uint8_t> buffer, int32_t index, int32_t count) ;

/// @brief Method WriteBinHex addr 0x26f79f0 size 0x2c virtual true final false
 void WriteBinHex(::ArrayW<uint8_t> buffer, int32_t index, int32_t count) ;

/// @brief Method Close addr 0x26f7a1c size 0x8 virtual true final false
 void Close() ;

/// @brief Method Flush addr 0x26f7a24 size 0x8 virtual true final false
 void Flush() ;

/// @brief Method WriteValue addr 0x26f7a2c size 0x10 virtual true final false
 void WriteValue(::StringW value) ;

/// @brief Method Dispose addr 0x26f7a3c size 0xb0 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method WriteXmlDeclaration addr 0x26f7aec size 0x6c virtual true final false
 void WriteXmlDeclaration(System::Xml::XmlStandalone standalone) ;

/// @brief Method WriteXmlDeclaration addr 0x26f7b58 size 0xc virtual true final false
 void WriteXmlDeclaration(::StringW xmldecl) ;

/// @brief Method StartElementContent addr 0x26f7b64 size 0x8 virtual true final false
 void StartElementContent() ;

/// @brief Method WriteEndElement addr 0x26f7b6c size 0x14 virtual true final false
 void WriteEndElement(::StringW prefix, ::StringW localName, ::StringW ns) ;

/// @brief Method WriteFullEndElement addr 0x26f7b80 size 0x14 virtual true final false
 void WriteFullEndElement(::StringW prefix, ::StringW localName, ::StringW ns) ;

/// @brief Method WriteNamespaceDeclaration addr 0x26f7b94 size 0x10 virtual true final false
 void WriteNamespaceDeclaration(::StringW prefix, ::StringW ns) ;

/// @brief Method WriteEndBase64 addr 0x26f7ba4 size 0x8 virtual true final false
 void WriteEndBase64() ;

/// @brief Method AddEvent addr 0x26f74e8 size 0x48 virtual false final false
 void AddEvent(System::Xml::System__Xml__XmlEventCache__XmlEventType eventType) ;

/// @brief Method AddEvent addr 0x26f7658 size 0x50 virtual false final false
 void AddEvent(System::Xml::System__Xml__XmlEventCache__XmlEventType eventType, ::StringW s1) ;

/// @brief Method AddEvent addr 0x26f76c4 size 0x5c virtual false final false
 void AddEvent(System::Xml::System__Xml__XmlEventCache__XmlEventType eventType, ::StringW s1, ::StringW s2) ;

/// @brief Method AddEvent addr 0x26f75cc size 0x64 virtual false final false
 void AddEvent(System::Xml::System__Xml__XmlEventCache__XmlEventType eventType, ::StringW s1, ::StringW s2, ::StringW s3) ;

/// @brief Method AddEvent addr 0x26f7548 size 0x70 virtual false final false
...
/// @brief Method AddEvent addr 0x26f7834 size 0x50 virtual false final false
 void AddEvent(System::Xml::System__Xml__XmlEventCache__XmlEventType eventType, ::bs_hook::Il2CppWrapperType o) ;

/// @brief Method NewEvent addr 0x26f7bac size 0x208 virtual false final false
 int32_t NewEvent() ;

/// @brief Method ToBytes addr 0x26f793c size 0xb4 virtual false final false
