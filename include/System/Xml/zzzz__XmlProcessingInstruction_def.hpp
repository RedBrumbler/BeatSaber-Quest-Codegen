...
/// @brief Method .ctor addr 0x272c798 size 0x30 virtual false final false
 void _ctor(::StringW target, ::StringW data, System::Xml::XmlDocument doc) ;

/// @brief Method get_Name addr 0x2731294 size 0x54 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_LocalName addr 0x27312e8 size 0xc virtual true final false
 ::StringW get_LocalName() ;

/// @brief Method get_Value addr 0x27312f4 size 0x8 virtual true final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x27312fc size 0x4 virtual true final false
 void set_Value(::StringW value) ;

/// @brief Method set_Data addr 0x2731300 size 0xa0 virtual false final false
 void set_Data(::StringW value) ;

/// @brief Method get_InnerText addr 0x27313a0 size 0x8 virtual true final false
 ::StringW get_InnerText() ;

/// @brief Method set_InnerText addr 0x27313a8 size 0x4 virtual true final false
 void set_InnerText(::StringW value) ;

/// @brief Method get_NodeType addr 0x27313ac size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method CloneNode addr 0x27313b4 size 0x38 virtual true final false
