...
/// @brief Method GetCharCount addr 0x2745adc size 0x1c virtual true final false
...
/// @brief Method GetChars addr 0x2745af8 size 0x178 virtual true final false
 int32_t GetChars(::ArrayW<uint8_t> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t> chars, int32_t charIndex) ;

/// @brief Method Convert addr 0x2745c70 size 0x1f4 virtual true final false
...
/// @brief Method Ucs4ToUTF16 addr 0x2745e64 size 0x58 virtual false final false
 void Ucs4ToUTF16(uint32_t code, ::ArrayW<char16_t> chars, int32_t charIndex) ;

// Ctor Parameters []
explicit Ucs4Decoder() ;

/// @brief Method .ctor addr 0x2745ebc size 0x58 virtual false final false
 void _ctor() ;
