...
/// @brief Method .ctor addr 0x26f88dc size 0x20 virtual false final false
 void _ctor() ;

/// @brief Method set_NameTable addr 0x26f8904 size 0x5c virtual false final false
 void set_NameTable(System::Xml::XmlNameTable value) ;

/// @brief Method set_IsXmlResolverSet addr 0x26f8a18 size 0xc virtual false final false
 void set_IsXmlResolverSet(bool value) ;

/// @brief Method set_XmlResolver addr 0x26f8a24 size 0x64 virtual false final false
 void set_XmlResolver(System::Xml::XmlResolver value) ;

/// @brief Method GetXmlResolver addr 0x26f8a88 size 0x8 virtual false final false
 System::Xml::XmlResolver GetXmlResolver() ;

/// @brief Method set_LineNumberOffset addr 0x26f8a90 size 0x5c virtual false final false
 void set_LineNumberOffset(int32_t value) ;

/// @brief Method set_LinePositionOffset addr 0x26f8aec size 0x5c virtual false final false
 void set_LinePositionOffset(int32_t value) ;

/// @brief Method set_ConformanceLevel addr 0x26f8b48 size 0xb0 virtual false final false
 void set_ConformanceLevel(System::Xml::ConformanceLevel value) ;

/// @brief Method set_CheckCharacters addr 0x26f8bf8 size 0x5c virtual false final false
 void set_CheckCharacters(bool value) ;

/// @brief Method set_MaxCharactersInDocument addr 0x26f8c54 size 0xac virtual false final false
 void set_MaxCharactersInDocument(int64_t value) ;

/// @brief Method set_MaxCharactersFromEntities addr 0x26f8d00 size 0xac virtual false final false
 void set_MaxCharactersFromEntities(int64_t value) ;

/// @brief Method set_IgnoreWhitespace addr 0x26f8dac size 0x5c virtual false final false
 void set_IgnoreWhitespace(bool value) ;

/// @brief Method set_IgnoreProcessingInstructions addr 0x26f8e08 size 0x5c virtual false final false
 void set_IgnoreProcessingInstructions(bool value) ;

/// @brief Method set_IgnoreComments addr 0x26f8e64 size 0x5c virtual false final false
 void set_IgnoreComments(bool value) ;

/// @brief Method set_DtdProcessing addr 0x26f8ec0 size 0xb0 virtual false final false
 void set_DtdProcessing(System::Xml::DtdProcessing value) ;

/// @brief Method get_ValidationType addr 0x26f8f70 size 0x8 virtual false final false
 System::Xml::ValidationType get_ValidationType() ;

/// @brief Method get_Schemas addr 0x26f8f78 size 0x6c virtual false final false
 System::Xml::Schema::XmlSchemaSet get_Schemas() ;

/// @brief Method set_ReadOnly addr 0x26f8fe4 size 0xc virtual false final false
 void set_ReadOnly(bool value) ;

/// @brief Method CheckReadOnly addr 0x26f8960 size 0xb8 virtual false final false
 void CheckReadOnly(::StringW propertyName) ;

/// @brief Method Initialize addr 0x26f88fc size 0x8 virtual false final false
 void Initialize() ;

/// @brief Method Initialize addr 0x26f8ff0 size 0x64 virtual false final false
 void Initialize(System::Xml::XmlResolver resolver) ;

/// @brief Method CreateDefaultResolver addr 0x26f9054 size 0x5c virtual false final false
static System::Xml::XmlResolver CreateDefaultResolver() ;

/// @brief Method EnableLegacyXmlSettings addr 0x26f90b0 size 0x100 virtual false final false
