...
/// @brief Method .ctor addr 0x272283c size 0x2c virtual false final false
 void _ctor(::StringW comment, System::Xml::XmlDocument doc) ;

/// @brief Method get_Name addr 0x2722868 size 0x28 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_LocalName addr 0x2722890 size 0x28 virtual true final false
 ::StringW get_LocalName() ;

/// @brief Method get_NodeType addr 0x27228b8 size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method CloneNode addr 0x27228c0 size 0x5c virtual true final false
