...
/// @brief Method .ctor addr 0x273221c size 0x40 virtual false final false
...
/// @brief Method .ctor addr 0x2729acc size 0x70 virtual false final false
 void _ctor() ;

/// @brief Method Add addr 0x2731c08 size 0x17c virtual true final false
 ::StringW Add(::StringW key) ;

/// @brief Method Add addr 0x2731e8c size 0x178 virtual true final false
 ::StringW Add(::ArrayW<char16_t> key, int32_t start, int32_t len) ;

/// @brief Method Get addr 0x27320b4 size 0x168 virtual true final false
 ::StringW Get(::StringW value) ;

/// @brief Method AddEntry addr 0x2731d84 size 0x108 virtual false final false
 ::StringW AddEntry(::StringW str, int32_t hashCode) ;

/// @brief Method Grow addr 0x273225c size 0x124 virtual false final false
 void Grow() ;

/// @brief Method TextEquals addr 0x2732004 size 0xb0 virtual false final false
