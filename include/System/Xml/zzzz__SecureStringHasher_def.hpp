...
/// @brief Method .ctor addr 0x26f3154 size 0xd8 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x26f322c size 0x14 virtual true final false
...
/// @brief Method .ctor addr 0x26f2eb8 size 0x24 virtual false final false
 void _ctor() ;

/// @brief Method Equals addr 0x26f2edc size 0x18 virtual true final true
 bool Equals(::StringW x, ::StringW y) ;

/// @brief Method GetHashCode addr 0x26f2ef4 size 0x9c virtual true final true
 int32_t GetHashCode(::StringW key) ;

/// @brief Method GetHashCodeOfString addr 0x26f30e8 size 0x6c virtual false final false
static int32_t GetHashCodeOfString(::StringW key, int32_t sLen, int64_t additionalEntropy) ;

/// @brief Method GetHashCodeDelegate addr 0x26f2f90 size 0x158 virtual false final false
