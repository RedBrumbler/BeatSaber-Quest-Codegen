...
/// @brief Method .ctor addr 0x2745544 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method get_EncodingName addr 0x27458b4 size 0x40 virtual true final false
 ::StringW get_EncodingName() ;

/// @brief Method GetPreamble addr 0x27458f4 size 0x74 virtual true final false
