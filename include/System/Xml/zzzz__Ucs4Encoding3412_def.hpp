...
namespace System::Xml {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11518))}
...
/// @brief Method .ctor addr 0x2745784 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method get_EncodingName addr 0x2745a28 size 0x40 virtual true final false
 ::StringW get_EncodingName() ;

/// @brief Method GetPreamble addr 0x2745a68 size 0x74 virtual true final false
