...
/// @brief Method get_NameTable addr 0x27495a8 size 0x8 virtual false final false
 System::Xml::XmlNameTable get_NameTable() ;

/// @brief Method GetXmlNamespaceNode addr 0x27495b0 size 0x10 virtual false final false
 int32_t GetXmlNamespaceNode(ByRef<::ArrayW<MS::Internal::Xml::Cache::XPathNode>> pageXmlNmsp) ;

/// @brief Method LookupNamespaces addr 0x27495c0 size 0xd4 virtual false final false
