...
/// @brief Method System.Collections.IEqualityComparer.Equals addr 0x274b424 size 0xdc virtual true final true
 bool System_Collections_IEqualityComparer_Equals(::bs_hook::Il2CppWrapperType obj1, ::bs_hook::Il2CppWrapperType obj2) ;

/// @brief Method System.Collections.IEqualityComparer.GetHashCode addr 0x274b500 size 0x1d0 virtual true final true
 int32_t System_Collections_IEqualityComparer_GetHashCode(::bs_hook::Il2CppWrapperType obj) ;

// Ctor Parameters []
explicit XPathNavigatorKeyComparer() ;

/// @brief Method .ctor addr 0x274b41c size 0x8 virtual false final false
 void _ctor() ;
