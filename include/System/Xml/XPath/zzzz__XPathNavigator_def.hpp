...
/// @brief Method ToString addr 0x27496b0 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method get_XmlType addr 0x27496bc size 0x188 virtual true final false
 System::Xml::Schema::XmlSchemaType get_XmlType() ;

/// @brief Method get_TypedValue addr 0x2749844 size 0x2dc virtual true final false
 ::bs_hook::Il2CppWrapperType get_TypedValue() ;

/// @brief Method get_ValueType addr 0x2749b20 size 0x20c virtual true final false
 System::Type get_ValueType() ;

/// @brief Method get_ValueAsBoolean addr 0x2749d2c size 0x2c4 virtual true final false
 bool get_ValueAsBoolean() ;

/// @brief Method get_ValueAsDateTime addr 0x2749ff0 size 0x2cc virtual true final false
 System::DateTime get_ValueAsDateTime() ;

/// @brief Method get_ValueAsDouble addr 0x274a2bc size 0x2cc virtual true final false
 double_t get_ValueAsDouble() ;

/// @brief Method get_ValueAsInt addr 0x274a588 size 0x2cc virtual true final false
 int32_t get_ValueAsInt() ;

/// @brief Method get_ValueAsLong addr 0x274a854 size 0x2cc virtual true final false
 int64_t get_ValueAsLong() ;

/// @brief Method ValueAs addr 0x274ab20 size 0x2ec virtual true final false
 ::bs_hook::Il2CppWrapperType ValueAs(System::Type returnType, System::Xml::IXmlNamespaceResolver nsResolver) ;

/// @brief Method System.ICloneable.Clone addr 0x274ae0c size 0x10 virtual true final true
...
/// @brief Method LookupNamespace addr 0x274ae1c size 0x1a4 virtual true final false
 ::StringW LookupNamespace(::StringW prefix) ;

/// @brief Method LookupPrefix addr 0x274afc0 size 0x1f0 virtual true final false
...
/// @brief Method get_UnderlyingObject addr 0x274b1b0 size 0x8 virtual true final false
 ::bs_hook::Il2CppWrapperType get_UnderlyingObject() ;

/// @brief Method MoveToNamespace addr 0x274b1b8 size 0xa0 virtual true final false
...
/// @brief Method get_SchemaInfo addr 0x274b258 size 0x48 virtual true final false
 System::Xml::Schema::IXmlSchemaInfo get_SchemaInfo() ;

/// @brief Method IsText addr 0x274b2a0 size 0x10 virtual false final false
static bool IsText(System::Xml::XPath::XPathNodeType type) ;

// Ctor Parameters []
explicit XPathNavigator() ;

/// @brief Method .ctor addr 0x274b2b0 size 0x8 virtual false final false
 void _ctor() ;
