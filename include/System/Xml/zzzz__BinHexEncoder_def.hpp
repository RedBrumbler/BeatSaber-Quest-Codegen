...
/// @brief Method Encode addr 0x26ec960 size 0x1a8 virtual false final false
static void Encode(::ArrayW<uint8_t> buffer, int32_t index, int32_t count, System::Xml::XmlWriter writer) ;

/// @brief Method Encode addr 0x26ecc2c size 0x14c virtual false final false
static ::StringW Encode(::ArrayW<uint8_t> inArray, int32_t offsetIn, int32_t count) ;

/// @brief Method Encode addr 0x26ecb08 size 0x124 virtual false final false
