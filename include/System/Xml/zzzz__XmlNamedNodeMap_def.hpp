...
/// @brief Method .ctor addr 0x272f400 size 0x30 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_Current addr 0x272f430 size 0x54 virtual true final true
 ::bs_hook::Il2CppWrapperType get_Current() ;

/// @brief Method MoveNext addr 0x272f484 size 0x1c virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x272f4a0 size 0xc virtual true final true
 void Reset() ;
...
/// @brief Method get_Count addr 0x272e9a8 size 0xa4 virtual false final false
 int32_t get_Count() ;

/// @brief Method get_Item addr 0x272e68c size 0xe0 virtual false final false
 ::bs_hook::Il2CppWrapperType get_Item(int32_t index) ;

/// @brief Method Add addr 0x272eccc size 0x11c virtual false final false
 void Add(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method RemoveAt addr 0x272eff8 size 0xe4 virtual false final false
 void RemoveAt(int32_t index) ;

/// @brief Method Insert addr 0x272f25c size 0x1a4 virtual false final false
 void Insert(int32_t index, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetEnumerator addr 0x272ea54 size 0x100 virtual false final false
...
/// @brief Method .ctor addr 0x2727988 size 0x28 virtual false final false
 void _ctor(System::Xml::XmlNode parent) ;

/// @brief Method GetNamedItem addr 0x272e510 size 0x98 virtual true final false
 System::Xml::XmlNode GetNamedItem(::StringW name) ;

/// @brief Method SetNamedItem addr 0x272e76c size 0xbc virtual true final false
 System::Xml::XmlNode SetNamedItem(System::Xml::XmlNode node) ;

/// @brief Method get_Count addr 0x272e9a0 size 0x8 virtual true final false
 int32_t get_Count() ;

/// @brief Method GetEnumerator addr 0x272ea4c size 0x8 virtual true final false
 System::Collections::IEnumerator GetEnumerator() ;

/// @brief Method FindNodeOffset addr 0x272e5a8 size 0xe4 virtual false final false
 int32_t FindNodeOffset(::StringW name) ;

/// @brief Method FindNodeOffset addr 0x272e828 size 0x124 virtual false final false
 int32_t FindNodeOffset(::StringW localName, ::StringW namespaceURI) ;

/// @brief Method AddNode addr 0x272eb54 size 0x178 virtual true final false
 System::Xml::XmlNode AddNode(System::Xml::XmlNode node) ;

/// @brief Method AddNodeForLoad addr 0x272ede8 size 0xa8 virtual true final false
 System::Xml::XmlNode AddNodeForLoad(System::Xml::XmlNode node, System::Xml::XmlDocument doc) ;

/// @brief Method RemoveNodeAt addr 0x272ee90 size 0x168 virtual true final false
 System::Xml::XmlNode RemoveNodeAt(int32_t i) ;

/// @brief Method ReplaceNodeAt addr 0x272e94c size 0x54 virtual false final false
 System::Xml::XmlNode ReplaceNodeAt(int32_t i, System::Xml::XmlNode node) ;

/// @brief Method InsertNodeAt addr 0x272f0dc size 0x180 virtual true final false
