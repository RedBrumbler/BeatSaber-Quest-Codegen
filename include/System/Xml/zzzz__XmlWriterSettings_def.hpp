...
/// @brief Method .ctor addr 0x271edcc size 0x84 virtual false final false
 void _ctor() ;

/// @brief Method get_Async addr 0x271f768 size 0x8 virtual false final false
 bool get_Async() ;

/// @brief Method get_Encoding addr 0x271f770 size 0x8 virtual false final false
 System::Text::Encoding get_Encoding() ;

/// @brief Method get_OmitXmlDeclaration addr 0x271f778 size 0x8 virtual false final false
 bool get_OmitXmlDeclaration() ;

/// @brief Method set_OmitXmlDeclaration addr 0x271f780 size 0x5c virtual false final false
 void set_OmitXmlDeclaration(bool value) ;

/// @brief Method get_NewLineHandling addr 0x271f894 size 0x8 virtual false final false
 System::Xml::NewLineHandling get_NewLineHandling() ;

/// @brief Method get_NewLineChars addr 0x271f89c size 0x8 virtual false final false
 ::StringW get_NewLineChars() ;

/// @brief Method get_Indent addr 0x271f8a4 size 0x10 virtual false final false
 bool get_Indent() ;

/// @brief Method set_Indent addr 0x271f8b4 size 0x68 virtual false final false
 void set_Indent(bool value) ;

/// @brief Method get_IndentChars addr 0x271f91c size 0x8 virtual false final false
 ::StringW get_IndentChars() ;

/// @brief Method get_NewLineOnAttributes addr 0x271f924 size 0x8 virtual false final false
 bool get_NewLineOnAttributes() ;

/// @brief Method get_CloseOutput addr 0x271f92c size 0x8 virtual false final false
 bool get_CloseOutput() ;

/// @brief Method get_ConformanceLevel addr 0x271f934 size 0x8 virtual false final false
 System::Xml::ConformanceLevel get_ConformanceLevel() ;

/// @brief Method set_ConformanceLevel addr 0x271f93c size 0xb0 virtual false final false
 void set_ConformanceLevel(System::Xml::ConformanceLevel value) ;

/// @brief Method get_CheckCharacters addr 0x271f9ec size 0x8 virtual false final false
 bool get_CheckCharacters() ;

/// @brief Method get_NamespaceHandling addr 0x271f9f4 size 0x8 virtual false final false
 System::Xml::NamespaceHandling get_NamespaceHandling() ;

/// @brief Method set_NamespaceHandling addr 0x271f9fc size 0xb0 virtual false final false
 void set_NamespaceHandling(System::Xml::NamespaceHandling value) ;

/// @brief Method get_WriteEndDocumentOnClose addr 0x271faac size 0x8 virtual false final false
 bool get_WriteEndDocumentOnClose() ;

/// @brief Method get_OutputMethod addr 0x271fab4 size 0x8 virtual false final false
 System::Xml::XmlOutputMethod get_OutputMethod() ;

/// @brief Method set_OutputMethod addr 0x271fabc size 0x8 virtual false final false
 void set_OutputMethod(System::Xml::XmlOutputMethod value) ;

/// @brief Method Clone addr 0x271fac4 size 0xcc virtual false final false
 System::Xml::XmlWriterSettings Clone() ;

/// @brief Method get_CDataSectionElements addr 0x271fb90 size 0x8 virtual false final false
 System::Collections::Generic::List_1<System::Xml::XmlQualifiedName> get_CDataSectionElements() ;

/// @brief Method get_DoNotEscapeUriAttributes addr 0x271fb98 size 0x8 virtual false final false
 bool get_DoNotEscapeUriAttributes() ;

/// @brief Method get_MergeCDataSections addr 0x271fba0 size 0x8 virtual false final false
 bool get_MergeCDataSections() ;

/// @brief Method get_MediaType addr 0x271fba8 size 0x8 virtual false final false
 ::StringW get_MediaType() ;

/// @brief Method get_DocTypeSystem addr 0x271fbb0 size 0x8 virtual false final false
 ::StringW get_DocTypeSystem() ;

/// @brief Method get_DocTypePublic addr 0x271fbb8 size 0x8 virtual false final false
 ::StringW get_DocTypePublic() ;

/// @brief Method get_Standalone addr 0x271fbc0 size 0x8 virtual false final false
 System::Xml::XmlStandalone get_Standalone() ;

/// @brief Method get_AutoXmlDeclaration addr 0x271fbc8 size 0x8 virtual false final false
 bool get_AutoXmlDeclaration() ;

/// @brief Method get_IndentInternal addr 0x271fbd0 size 0x8 virtual false final false
 System::Xml::TriState get_IndentInternal() ;

/// @brief Method get_IsQuerySpecific addr 0x271fbd8 size 0x70 virtual false final false
 bool get_IsQuerySpecific() ;

/// @brief Method CreateWriter addr 0x271ee50 size 0x4b4 virtual false final false
 System::Xml::XmlWriter CreateWriter(System::IO::Stream output) ;

/// @brief Method CreateWriter addr 0x271f36c size 0x31c virtual false final false
 System::Xml::XmlWriter CreateWriter(System::IO::TextWriter output) ;

/// @brief Method set_ReadOnly addr 0x271fc48 size 0xc virtual false final false
 void set_ReadOnly(bool value) ;

/// @brief Method CheckReadOnly addr 0x271f7dc size 0xb8 virtual false final false
 void CheckReadOnly(::StringW propertyName) ;

/// @brief Method Initialize addr 0x271f688 size 0xe0 virtual false final false
 void Initialize() ;
