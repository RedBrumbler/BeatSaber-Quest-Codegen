...
/// @brief Method .ctor addr 0x27230a0 size 0x64 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2723104 size 0x3c8 virtual false final false
 void _ctor(System::Xml::XmlImplementation imp) ;

/// @brief Method get_DtdSchemaInfo addr 0x27234cc size 0x8 virtual false final false
 System::Xml::Schema::SchemaInfo get_DtdSchemaInfo() ;

/// @brief Method set_DtdSchemaInfo addr 0x27234d4 size 0x8 virtual false final false
 void set_DtdSchemaInfo(System::Xml::Schema::SchemaInfo value) ;

/// @brief Method CheckName addr 0x27202e8 size 0xd8 virtual false final false
static void CheckName(::StringW name) ;

/// @brief Method AddXmlName addr 0x27234dc size 0x18 virtual false final false
...
/// @brief Method GetXmlName addr 0x27234f4 size 0x18 virtual false final false
...
/// @brief Method AddAttrXmlName addr 0x27203fc size 0x11c virtual false final false
...
/// @brief Method AddIdInfo addr 0x272350c size 0xc0 virtual false final false
 bool AddIdInfo(System::Xml::XmlName eleName, System::Xml::XmlName attrName) ;

/// @brief Method GetIDInfoByElement_ addr 0x27235cc size 0xd4 virtual false final false
 System::Xml::XmlName GetIDInfoByElement_(System::Xml::XmlName eleName) ;

/// @brief Method GetIDInfoByElement addr 0x2721f68 size 0x14 virtual false final false
 System::Xml::XmlName GetIDInfoByElement(System::Xml::XmlName eleName) ;

/// @brief Method GetElement addr 0x27236a0 size 0x650 virtual false final false
 System::WeakReference GetElement(System::Collections::ArrayList elementList, System::Xml::XmlElement elem) ;

/// @brief Method AddElementWithId addr 0x2721f7c size 0x1f4 virtual false final false
 void AddElementWithId(::StringW id, System::Xml::XmlElement elem) ;

/// @brief Method RemoveElementWithId addr 0x2722170 size 0x138 virtual false final false
 void RemoveElementWithId(::StringW id, System::Xml::XmlElement elem) ;

/// @brief Method CloneNode addr 0x2723cf0 size 0x60 virtual true final false
 System::Xml::XmlNode CloneNode(bool deep) ;

/// @brief Method get_NodeType addr 0x2723dec size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_ParentNode addr 0x2723df4 size 0x8 virtual true final false
 System::Xml::XmlNode get_ParentNode() ;

/// @brief Method get_DocumentType addr 0x2723dfc size 0x8c virtual true final false
 System::Xml::XmlDocumentType get_DocumentType() ;

/// @brief Method get_Declaration addr 0x2723e88 size 0xa4 virtual true final false
 System::Xml::XmlDeclaration get_Declaration() ;

/// @brief Method get_Implementation addr 0x2723f2c size 0x8 virtual false final false
 System::Xml::XmlImplementation get_Implementation() ;

/// @brief Method get_Name addr 0x2723f34 size 0x8 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_LocalName addr 0x2723f3c size 0x8 virtual true final false
 ::StringW get_LocalName() ;

/// @brief Method get_DocumentElement addr 0x2723f44 size 0x8c virtual false final false
 System::Xml::XmlElement get_DocumentElement() ;

/// @brief Method get_IsContainer addr 0x2723fd0 size 0x8 virtual true final false
 bool get_IsContainer() ;

/// @brief Method get_LastNode addr 0x2723fd8 size 0x8 virtual true final false
 System::Xml::XmlLinkedNode get_LastNode() ;

/// @brief Method set_LastNode addr 0x2723fe0 size 0x8 virtual true final false
 void set_LastNode(System::Xml::XmlLinkedNode value) ;

/// @brief Method get_OwnerDocument addr 0x2723fe8 size 0x8 virtual true final false
 System::Xml::XmlDocument get_OwnerDocument() ;

/// @brief Method set_Schemas addr 0x2723ff0 size 0x8 virtual false final false
 void set_Schemas(System::Xml::Schema::XmlSchemaSet value) ;

/// @brief Method get_CanReportValidity addr 0x2723ff8 size 0x8 virtual false final false
 bool get_CanReportValidity() ;

/// @brief Method get_HasSetResolver addr 0x2724000 size 0x8 virtual false final false
 bool get_HasSetResolver() ;

/// @brief Method GetResolver addr 0x2724008 size 0x8 virtual false final false
 System::Xml::XmlResolver GetResolver() ;

/// @brief Method set_XmlResolver addr 0x2724010 size 0x188 virtual true final false
 void set_XmlResolver(System::Xml::XmlResolver value) ;

/// @brief Method IsValidChildType addr 0x2724198 size 0xf0 virtual true final false
 bool IsValidChildType(System::Xml::XmlNodeType type) ;

/// @brief Method HasNodeTypeInPrevSiblings addr 0x2724288 size 0xb0 virtual false final false
 bool HasNodeTypeInPrevSiblings(System::Xml::XmlNodeType nt, System::Xml::XmlNode refNode) ;

/// @brief Method HasNodeTypeInNextSiblings addr 0x2724338 size 0x64 virtual false final false
 bool HasNodeTypeInNextSiblings(System::Xml::XmlNodeType nt, System::Xml::XmlNode refNode) ;

/// @brief Method CanInsertAfter addr 0x272439c size 0xf8 virtual true final false
 bool CanInsertAfter(System::Xml::XmlNode newChild, System::Xml::XmlNode refChild) ;

/// @brief Method CreateAttribute addr 0x2724494 size 0xc0 virtual false final false
 System::Xml::XmlAttribute CreateAttribute(::StringW name) ;

/// @brief Method SetDefaultNamespace addr 0x2724554 size 0x90 virtual false final false
 void SetDefaultNamespace(::StringW prefix, ::StringW localName, ByRef<::StringW> namespaceURI) ;

/// @brief Method CreateCDataSection addr 0x27245e4 size 0x7c virtual true final false
 System::Xml::XmlCDataSection CreateCDataSection(::StringW data) ;

/// @brief Method CreateComment addr 0x2724660 size 0x74 virtual true final false
 System::Xml::XmlComment CreateComment(::StringW data) ;

/// @brief Method CreateDocumentType addr 0x27246d4 size 0x94 virtual true final false
 System::Xml::XmlDocumentType CreateDocumentType(::StringW name, ::StringW publicId, ::StringW systemId, ::StringW internalSubset) ;

/// @brief Method CreateDocumentFragment addr 0x2724768 size 0x64 virtual true final false
 System::Xml::XmlDocumentFragment CreateDocumentFragment() ;

/// @brief Method CreateElement addr 0x27247cc size 0xb0 virtual false final false
 System::Xml::XmlElement CreateElement(::StringW name) ;

/// @brief Method AddDefaultAttributes addr 0x272487c size 0x288 virtual false final false
 void AddDefaultAttributes(System::Xml::XmlElement elem) ;

/// @brief Method GetSchemaElementDecl addr 0x2724b04 size 0x110 virtual false final false
 System::Xml::Schema::SchemaElementDecl GetSchemaElementDecl(System::Xml::XmlElement elem) ;

/// @brief Method PrepareDefaultAttribute addr 0x2724c14 size 0xfc virtual false final false
...
/// @brief Method CreateEntityReference addr 0x2724d10 size 0x74 virtual true final false
 System::Xml::XmlEntityReference CreateEntityReference(::StringW name) ;

/// @brief Method CreateProcessingInstruction addr 0x2724d84 size 0x7c virtual true final false
 System::Xml::XmlProcessingInstruction CreateProcessingInstruction(::StringW target, ::StringW data) ;

/// @brief Method CreateXmlDeclaration addr 0x2724e00 size 0x88 virtual true final false
 System::Xml::XmlDeclaration CreateXmlDeclaration(::StringW version, ::StringW encoding, ::StringW standalone) ;

/// @brief Method CreateTextNode addr 0x2724e88 size 0x74 virtual true final false
 System::Xml::XmlText CreateTextNode(::StringW text) ;

/// @brief Method CreateSignificantWhitespace addr 0x2724efc size 0x74 virtual true final false
 System::Xml::XmlSignificantWhitespace CreateSignificantWhitespace(::StringW text) ;

/// @brief Method CreateWhitespace addr 0x2724f70 size 0x74 virtual true final false
 System::Xml::XmlWhitespace CreateWhitespace(::StringW text) ;

/// @brief Method CreateAttribute addr 0x2724fe4 size 0xa4 virtual false final false
 System::Xml::XmlAttribute CreateAttribute(::StringW qualifiedName, ::StringW namespaceURI) ;

/// @brief Method CreateElement addr 0x2725088 size 0xa4 virtual false final false
 System::Xml::XmlElement CreateElement(::StringW qualifiedName, ::StringW namespaceURI) ;

/// @brief Method ImportNodeInternal addr 0x272512c size 0x4b0 virtual false final false
 System::Xml::XmlNode ImportNodeInternal(System::Xml::XmlNode node, bool deep) ;

/// @brief Method ImportAttributes addr 0x27255dc size 0x114 virtual false final false
 void ImportAttributes(System::Xml::XmlNode fromElem, System::Xml::XmlNode toElem) ;

/// @brief Method ImportChildren addr 0x2723d50 size 0x9c virtual false final false
 void ImportChildren(System::Xml::XmlNode fromNode, System::Xml::XmlNode toNode, bool deep) ;

/// @brief Method get_NameTable addr 0x271fcd8 size 0x1c virtual false final false
 System::Xml::XmlNameTable get_NameTable() ;

/// @brief Method CreateAttribute addr 0x27256f0 size 0xa0 virtual true final false
 System::Xml::XmlAttribute CreateAttribute(::StringW prefix, ::StringW localName, ::StringW namespaceURI) ;

/// @brief Method CreateDefaultAttribute addr 0x2725790 size 0x8c virtual true final false
 System::Xml::XmlAttribute CreateDefaultAttribute(::StringW prefix, ::StringW localName, ::StringW namespaceURI) ;

/// @brief Method CreateElement addr 0x272581c size 0xb8 virtual true final false
 System::Xml::XmlElement CreateElement(::StringW prefix, ::StringW localName, ::StringW namespaceURI) ;

/// @brief Method get_IsReadOnly addr 0x27258d4 size 0x8 virtual true final false
 bool get_IsReadOnly() ;

/// @brief Method get_Entities addr 0x27258dc size 0x70 virtual false final false
 System::Xml::XmlNamedNodeMap get_Entities() ;

/// @brief Method set_Entities addr 0x272594c size 0x8 virtual false final false
 void set_Entities(System::Xml::XmlNamedNodeMap value) ;

/// @brief Method get_IsLoading addr 0x2725954 size 0x8 virtual false final false
 bool get_IsLoading() ;

/// @brief Method set_IsLoading addr 0x272595c size 0xc virtual false final false
 void set_IsLoading(bool value) ;

/// @brief Method get_ActualLoadingStatus addr 0x2725968 size 0x8 virtual false final false
 bool get_ActualLoadingStatus() ;

/// @brief Method SetupReader addr 0x2725970 size 0x6c virtual false final false
 System::Xml::XmlTextReader SetupReader(System::Xml::XmlTextReader tr) ;

/// @brief Method Load addr 0x27259dc size 0x114 virtual true final false
 void Load(System::Xml::XmlReader reader) ;

/// @brief Method LoadXml addr 0x2725af0 size 0x14c virtual true final false
 void LoadXml(::StringW xml) ;

/// @brief Method set_InnerText addr 0x2725c3c size 0x60 virtual true final false
 void set_InnerText(::StringW value) ;

/// @brief Method set_InnerXml addr 0x2725c9c size 0x10 virtual true final false
 void set_InnerXml(::StringW value) ;

/// @brief Method GetEventArgs addr 0x2725cac size 0x100 virtual true final false
...
/// @brief Method GetInsertEventArgsForLoad addr 0x2720b60 size 0xbc virtual false final false
 System::Xml::XmlNodeChangedEventArgs GetInsertEventArgsForLoad(System::Xml::XmlNode node, System::Xml::XmlNode newParent) ;

/// @brief Method BeforeEvent addr 0x2725dac size 0x54 virtual true final false
 void BeforeEvent(System::Xml::XmlNodeChangedEventArgs args) ;

/// @brief Method AfterEvent addr 0x2725e00 size 0x54 virtual true final false
 void AfterEvent(System::Xml::XmlNodeChangedEventArgs args) ;

/// @brief Method GetDefaultAttribute addr 0x2721cd4 size 0x294 virtual false final false
...
/// @brief Method GetEntityNode addr 0x2725e54 size 0xc8 virtual false final false
 System::Xml::XmlEntity GetEntityNode(::StringW name) ;

/// @brief Method get_BaseURI addr 0x2725f1c size 0x8 virtual true final false
 ::StringW get_BaseURI() ;

/// @brief Method SetBaseURI addr 0x2725f24 size 0x8 virtual false final false
 void SetBaseURI(::StringW inBaseURI) ;

/// @brief Method AppendChildForLoad addr 0x2725f2c size 0x1d4 virtual true final false
