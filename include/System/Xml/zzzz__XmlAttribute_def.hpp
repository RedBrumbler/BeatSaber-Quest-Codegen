...
/// @brief Method .ctor addr 0x27201d8 size 0x110 virtual false final false
...
/// @brief Method .ctor addr 0x27203c0 size 0x3c virtual false final false
 void _ctor(::StringW prefix, ::StringW localName, ::StringW namespaceURI, System::Xml::XmlDocument doc) ;

/// @brief Method get_XmlName addr 0x2720518 size 0x8 virtual false final false
 System::Xml::XmlName get_XmlName() ;

/// @brief Method set_XmlName addr 0x2720520 size 0x8 virtual false final false
 void set_XmlName(System::Xml::XmlName value) ;

/// @brief Method CloneNode addr 0x2720528 size 0xc8 virtual true final false
 System::Xml::XmlNode CloneNode(bool deep) ;

/// @brief Method get_ParentNode addr 0x27205f0 size 0x8 virtual true final false
 System::Xml::XmlNode get_ParentNode() ;

/// @brief Method get_Name addr 0x27205f8 size 0x1c virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_LocalName addr 0x2720614 size 0x1c virtual true final false
 ::StringW get_LocalName() ;

/// @brief Method get_NamespaceURI addr 0x2720630 size 0x1c virtual true final false
 ::StringW get_NamespaceURI() ;

/// @brief Method get_Prefix addr 0x272064c size 0x1c virtual true final false
 ::StringW get_Prefix() ;

/// @brief Method get_NodeType addr 0x2720668 size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_OwnerDocument addr 0x2720670 size 0x1c virtual true final false
 System::Xml::XmlDocument get_OwnerDocument() ;

/// @brief Method get_Value addr 0x272068c size 0x10 virtual true final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x272069c size 0x10 virtual true final false
 void set_Value(::StringW value) ;

/// @brief Method set_InnerText addr 0x27206ac size 0x64 virtual true final false
 void set_InnerText(::StringW value) ;

/// @brief Method PrepareOwnerElementInElementIdAttrMap addr 0x2720710 size 0xb0 virtual false final false
 bool PrepareOwnerElementInElementIdAttrMap() ;

/// @brief Method ResetOwnerElementInElementIdAttrMap addr 0x27207c0 size 0x7c virtual false final false
 void ResetOwnerElementInElementIdAttrMap(::StringW oldInnerText) ;

/// @brief Method get_IsContainer addr 0x27209f0 size 0x8 virtual true final false
 bool get_IsContainer() ;

/// @brief Method AppendChildForLoad addr 0x27209f8 size 0x168 virtual true final false
 System::Xml::XmlNode AppendChildForLoad(System::Xml::XmlNode newChild, System::Xml::XmlDocument doc) ;

/// @brief Method get_LastNode addr 0x2720c1c size 0x8 virtual true final false
 System::Xml::XmlLinkedNode get_LastNode() ;

/// @brief Method set_LastNode addr 0x2720c24 size 0x8 virtual true final false
 void set_LastNode(System::Xml::XmlLinkedNode value) ;

/// @brief Method IsValidChildType addr 0x2720c2c size 0x18 virtual true final false
 bool IsValidChildType(System::Xml::XmlNodeType type) ;

/// @brief Method get_Specified addr 0x2720c44 size 0x8 virtual true final false
 bool get_Specified() ;

/// @brief Method RemoveChild addr 0x2720c4c size 0x78 virtual true final false
 System::Xml::XmlNode RemoveChild(System::Xml::XmlNode oldChild) ;

/// @brief Method AppendChild addr 0x2720cc4 size 0x78 virtual true final false
 System::Xml::XmlNode AppendChild(System::Xml::XmlNode newChild) ;

/// @brief Method get_OwnerElement addr 0x2720d3c size 0x7c virtual true final false
 System::Xml::XmlElement get_OwnerElement() ;

/// @brief Method set_InnerXml addr 0x2720db8 size 0x8c virtual true final false
 void set_InnerXml(::StringW value) ;

/// @brief Method get_BaseURI addr 0x2720e44 size 0x98 virtual true final false
 ::StringW get_BaseURI() ;

/// @brief Method SetParent addr 0x2720edc size 0x8 virtual true final false
