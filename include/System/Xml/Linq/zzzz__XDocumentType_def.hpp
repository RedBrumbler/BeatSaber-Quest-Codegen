...
/// @brief Method .ctor addr 0x26fd168 size 0x90 virtual false final false
...
/// @brief Method .ctor addr 0x26fd1f8 size 0x84 virtual false final false
 void _ctor(System::Xml::Linq::XDocumentType other) ;

/// @brief Method get_InternalSubset addr 0x26fd27c size 0x8 virtual false final false
 ::StringW get_InternalSubset() ;

/// @brief Method get_Name addr 0x26fd284 size 0x8 virtual false final false
 ::StringW get_Name() ;

/// @brief Method get_NodeType addr 0x26fd28c size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_PublicId addr 0x26fd294 size 0x8 virtual false final false
 ::StringW get_PublicId() ;

/// @brief Method get_SystemId addr 0x26fd29c size 0x8 virtual false final false
 ::StringW get_SystemId() ;

/// @brief Method WriteTo addr 0x26fd2a4 size 0x74 virtual true final false
 void WriteTo(System::Xml::XmlWriter writer) ;

/// @brief Method CloneNode addr 0x26fd318 size 0x60 virtual true final false
