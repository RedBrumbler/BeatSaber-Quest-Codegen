...
/// @brief Method .ctor addr 0x26fd864 size 0xc virtual false final false
 void _ctor(System::Xml::XmlWriter writer) ;

/// @brief Method WriteElement addr 0x26fd870 size 0x1a8 virtual false final false
 void WriteElement(System::Xml::Linq::XElement e) ;

/// @brief Method GetPrefixOfNamespace addr 0x26fe3a8 size 0xfc virtual false final false
 ::StringW GetPrefixOfNamespace(System::Xml::Linq::XNamespace ns, bool allowDefaultNamespace) ;

/// @brief Method PushAncestors addr 0x26fe0c8 size 0x128 virtual false final false
 void PushAncestors(System::Xml::Linq::XElement e) ;

/// @brief Method PushElement addr 0x26fe67c size 0xd4 virtual false final false
 void PushElement(System::Xml::Linq::XElement e) ;

/// @brief Method WriteEndElement addr 0x26fe350 size 0x2c virtual false final false
 void WriteEndElement() ;

/// @brief Method WriteFullEndElement addr 0x26fe37c size 0x2c virtual false final false
 void WriteFullEndElement() ;

/// @brief Method WriteStartElement addr 0x26fe1f0 size 0x160 virtual false final false
