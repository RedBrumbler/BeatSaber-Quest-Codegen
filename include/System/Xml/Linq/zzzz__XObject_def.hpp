...
/// @brief Method .ctor addr 0x26f92dc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_NodeType addr 0x0 size 0xffffffffffffffff virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Parent addr 0x26ff9ec size 0x7c virtual false final false
 System::Xml::Linq::XElement get_Parent() ;

/// @brief Method AnnotationForSealedType addr 0x26ffa68 size 0x144 virtual false final false
...
/// @brief Method NotifyChanged addr 0x26f9c14 size 0xa8 virtual false final false
 bool NotifyChanged(::bs_hook::Il2CppWrapperType sender, System::Xml::Linq::XObjectChangeEventArgs e) ;

/// @brief Method NotifyChanging addr 0x26f9b6c size 0xa8 virtual false final false
 bool NotifyChanging(::bs_hook::Il2CppWrapperType sender, System::Xml::Linq::XObjectChangeEventArgs e) ;

/// @brief Method SkipNotify addr 0x26fb0c8 size 0x70 virtual false final false
 bool SkipNotify() ;

/// @brief Method GetSaveOptionsFromAnnotations addr 0x26ff498 size 0xe0 virtual false final false
