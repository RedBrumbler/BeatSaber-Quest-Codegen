...
/// @brief Method .ctor addr 0x26fc738 size 0x3c virtual false final false
...
/// @brief Method .ctor addr 0x26fc774 size 0x84 virtual false final false
 void _ctor(System::Xml::Linq::XDeclaration other) ;

/// @brief Method get_Encoding addr 0x26fc7f8 size 0x8 virtual false final false
 ::StringW get_Encoding() ;

/// @brief Method set_Encoding addr 0x26fc800 size 0x8 virtual false final false
 void set_Encoding(::StringW value) ;

/// @brief Method get_Standalone addr 0x26fc808 size 0x8 virtual false final false
 ::StringW get_Standalone() ;

/// @brief Method set_Standalone addr 0x26fc810 size 0x8 virtual false final false
 void set_Standalone(::StringW value) ;

/// @brief Method get_Version addr 0x26fc818 size 0x8 virtual false final false
 ::StringW get_Version() ;

/// @brief Method ToString addr 0x26fc820 size 0x16c virtual true final false
 ::StringW ToString() ;
