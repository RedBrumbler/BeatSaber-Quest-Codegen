...
/// @brief Method .ctor addr 0x26fa3ec size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x26fa468 size 0x4 virtual false final false
 void _ctor(System::Xml::Linq::XCData other) ;

/// @brief Method get_NodeType addr 0x26fa4e8 size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method WriteTo addr 0x26fa4f0 size 0x74 virtual true final false
 void WriteTo(System::Xml::XmlWriter writer) ;

/// @brief Method CloneNode addr 0x26fa564 size 0x60 virtual true final false
