...
/// @brief Method .ctor addr 0x26fa3f0 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x26fa46c size 0x7c virtual false final false
 void _ctor(System::Xml::Linq::XText other) ;

/// @brief Method get_NodeType addr 0x27000a0 size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Value addr 0x27000a8 size 0x8 virtual false final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x26fc0d4 size 0xf4 virtual false final false
 void set_Value(::StringW value) ;

/// @brief Method WriteTo addr 0x27000b0 size 0xf4 virtual true final false
 void WriteTo(System::Xml::XmlWriter writer) ;

/// @brief Method AppendText addr 0x27001a4 size 0x24 virtual true final false
 void AppendText(System::Text::StringBuilder sb) ;

/// @brief Method CloneNode addr 0x27001c8 size 0x60 virtual true final false
