...
/// @brief Method .ctor addr 0x26ff0b0 size 0xf0 virtual false final false
 void _ctor(::StringW namespaceName) ;

/// @brief Method get_NamespaceName addr 0x26ff1a0 size 0x8 virtual false final false
 ::StringW get_NamespaceName() ;

/// @brief Method GetName addr 0x26fef84 size 0x64 virtual false final false
 System::Xml::Linq::XName GetName(::StringW localName) ;

/// @brief Method ToString addr 0x26ff1a8 size 0x8 virtual true final false
 ::StringW ToString() ;

/// @brief Method get_None addr 0x26fef1c size 0x68 virtual false final false
static System::Xml::Linq::XNamespace get_None() ;

/// @brief Method get_Xml addr 0x26ff29c size 0x60 virtual false final false
static System::Xml::Linq::XNamespace get_Xml() ;

/// @brief Method get_Xmlns addr 0x26ff2fc size 0x60 virtual false final false
static System::Xml::Linq::XNamespace get_Xmlns() ;

/// @brief Method Get addr 0x26fe580 size 0x64 virtual false final false
static System::Xml::Linq::XNamespace Get(::StringW namespaceName) ;

/// @brief Method op_Implicit addr 0x26ff35c size 0xc virtual false final false
static System::Xml::Linq::XNamespace op_Implicit_System__Xml__Linq__XNamespace(::StringW namespaceName) ;

/// @brief Method Equals addr 0x26ff368 size 0xc virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x26ff374 size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x26fd6e0 size 0xc virtual false final false
static bool op_Equality(System::Xml::Linq::XNamespace left, System::Xml::Linq::XNamespace right) ;

/// @brief Method op_Inequality addr 0x26ff37c size 0xc virtual false final false
static bool op_Inequality(System::Xml::Linq::XNamespace left, System::Xml::Linq::XNamespace right) ;

/// @brief Method GetName addr 0x26fee10 size 0x10c virtual false final false
 System::Xml::Linq::XName GetName(::StringW localName, int32_t index, int32_t count) ;

/// @brief Method Get addr 0x26feb28 size 0x2e8 virtual false final false
static System::Xml::Linq::XNamespace Get(::StringW namespaceName, int32_t index, int32_t count) ;

/// @brief Method ExtractLocalName addr 0x26ff388 size 0x18 virtual false final false
static ::StringW ExtractLocalName(System::Xml::Linq::XName n) ;

/// @brief Method ExtractNamespace addr 0x26ff3a0 size 0x78 virtual false final false
static ::StringW ExtractNamespace(System::WeakReference r) ;

/// @brief Method EnsureNamespace addr 0x26ff1b0 size 0xec virtual false final false
