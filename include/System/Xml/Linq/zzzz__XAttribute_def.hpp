...
namespace System::Xml::Linq {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15451))}
...
/// @brief Method .ctor addr 0x26f9220 size 0xbc virtual false final false
...
/// @brief Method .ctor addr 0x26f9920 size 0x7c virtual false final false
 void _ctor(System::Xml::Linq::XAttribute other) ;

/// @brief Method get_IsNamespaceDeclaration addr 0x26f999c size 0x9c virtual false final false
 bool get_IsNamespaceDeclaration() ;

/// @brief Method get_Name addr 0x26f9a54 size 0x8 virtual false final false
 System::Xml::Linq::XName get_Name() ;

/// @brief Method get_NodeType addr 0x26f9a5c size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Value addr 0x26f9a64 size 0x8 virtual false final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x26f9a6c size 0x100 virtual false final false
 void set_Value(::StringW value) ;

/// @brief Method ToString addr 0x26f9cbc size 0x3d4 virtual true final false
 ::StringW ToString() ;

/// @brief Method GetPrefixOfNamespace addr 0x26fa090 size 0x138 virtual false final false
 ::StringW GetPrefixOfNamespace(System::Xml::Linq::XNamespace ns) ;

/// @brief Method ValidateAttribute addr 0x26f96f0 size 0x230 virtual false final false
