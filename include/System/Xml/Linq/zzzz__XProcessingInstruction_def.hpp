...
/// @brief Method .ctor addr 0x26ffce0 size 0x84 virtual false final false
...
/// @brief Method .ctor addr 0x26ffe44 size 0x7c virtual false final false
 void _ctor(System::Xml::Linq::XProcessingInstruction other) ;

/// @brief Method get_Data addr 0x26ffec0 size 0x8 virtual false final false
 ::StringW get_Data() ;

/// @brief Method set_Data addr 0x26ffec8 size 0xf4 virtual false final false
 void set_Data(::StringW value) ;

/// @brief Method get_NodeType addr 0x26fffbc size 0x8 virtual true final false
 System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_Target addr 0x26fffc4 size 0x8 virtual false final false
 ::StringW get_Target() ;

/// @brief Method WriteTo addr 0x26fffcc size 0x74 virtual true final false
 void WriteTo(System::Xml::XmlWriter writer) ;

/// @brief Method CloneNode addr 0x2700040 size 0x60 virtual true final false
 System::Xml::Linq::XNode CloneNode() ;

/// @brief Method ValidateName addr 0x26ffd64 size 0xe0 virtual false final false
