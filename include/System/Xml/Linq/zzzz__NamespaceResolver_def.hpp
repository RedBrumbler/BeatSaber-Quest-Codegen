...
/// @brief Method .ctor addr 0x26fe874 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method PushScope addr 0x26fe750 size 0x10 virtual false final false
 void PushScope() ;

/// @brief Method PopScope addr 0x26fe7fc size 0x78 virtual false final false
 void PopScope() ;

/// @brief Method Add addr 0x26fe760 size 0x9c virtual false final false
 void Add(::StringW prefix, System::Xml::Linq::XNamespace ns) ;

/// @brief Method AddFirst addr 0x26fe5e4 size 0x98 virtual false final false
 void AddFirst(::StringW prefix, System::Xml::Linq::XNamespace ns) ;

/// @brief Method GetPrefixOfNamespace addr 0x26fe4a4 size 0xdc virtual false final false
