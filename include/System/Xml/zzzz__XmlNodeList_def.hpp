...
/// @brief Method System.IDisposable.Dispose addr 0x273119c size 0xc virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method PrivateDisposeNodeList addr 0x27311a8 size 0x4 virtual true final false
 void PrivateDisposeNodeList() ;

// Ctor Parameters []
explicit XmlNodeList() ;

/// @brief Method .ctor addr 0x27311ac size 0x8 virtual false final false
 void _ctor() ;
