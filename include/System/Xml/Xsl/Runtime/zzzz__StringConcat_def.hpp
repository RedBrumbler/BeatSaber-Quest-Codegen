...
/// @brief Method Clear addr 0x274b7c8 size 0xc virtual false final false
 void Clear() ;

/// @brief Method get_Count addr 0x274b7d4 size 0x8 virtual false final false
 int32_t get_Count() ;

/// @brief Method GetResult addr 0x274b7dc size 0xf4 virtual false final false
 ::StringW GetResult() ;

/// @brief Method ConcatNoDelimiter addr 0x274b8d0 size 0x2b8 virtual false final false
