...
/// @brief Method .ctor addr 0x2744cf4 size 0x30 virtual false final false
 void _ctor(bool bigEndian) ;

/// @brief Method GetCharCount addr 0x2744d24 size 0x10 virtual true final false
 int32_t GetCharCount(::ArrayW<uint8_t> bytes, int32_t index, int32_t count) ;

/// @brief Method GetCharCount addr 0x2744d34 size 0xec virtual true final false
 int32_t GetCharCount(::ArrayW<uint8_t> bytes, int32_t index, int32_t count, bool flush) ;

/// @brief Method GetChars addr 0x2744e20 size 0x238 virtual true final false
 int32_t GetChars(::ArrayW<uint8_t> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t> chars, int32_t charIndex) ;

/// @brief Method Convert addr 0x2745058 size 0x298 virtual true final false
