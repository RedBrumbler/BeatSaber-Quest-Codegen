...
/// @brief Method .ctor addr 0x24ddba0 size 0x28 virtual false final false
 void _ctor(System::Delegate start) ;

/// @brief Method SetExecutionContextHelper addr 0x24ddbc8 size 0x8 virtual false final false
 void SetExecutionContextHelper(System::Threading::ExecutionContext ec) ;

/// @brief Method ThreadStart_Context addr 0x24ddbd0 size 0x10c virtual false final false
static void ThreadStart_Context(::bs_hook::Il2CppWrapperType state) ;

/// @brief Method ThreadStart addr 0x24ddcdc size 0x100 virtual false final false
 void ThreadStart(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method ThreadStart addr 0x24ddddc size 0xf4 virtual false final false
 void ThreadStart() ;
