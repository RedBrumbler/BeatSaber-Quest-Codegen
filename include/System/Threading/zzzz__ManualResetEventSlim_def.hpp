...
/// @brief Method get_WaitHandle addr 0x24d5714 size 0x3c virtual false final false
 System::Threading::WaitHandle get_WaitHandle() ;

/// @brief Method get_IsSet addr 0x24d591c size 0x5c virtual false final false
 bool get_IsSet() ;

/// @brief Method set_IsSet addr 0x24d5980 size 0x20 virtual false final false
 void set_IsSet(bool value) ;

/// @brief Method get_SpinCount addr 0x24d5a44 size 0x5c virtual false final false
 int32_t get_SpinCount() ;

/// @brief Method set_SpinCount addr 0x24d5aac size 0x34 virtual false final false
 void set_SpinCount(int32_t value) ;

/// @brief Method get_Waiters addr 0x24d5ae0 size 0x5c virtual false final false
 int32_t get_Waiters() ;

/// @brief Method set_Waiters addr 0x24d5b3c size 0x94 virtual false final false
...
/// @brief Method .ctor addr 0x24d5bd0 size 0x7c virtual false final false
...
/// @brief Method .ctor addr 0x24d5cfc size 0x120 virtual false final false
 void _ctor(bool initialState, int32_t spinCount) ;

/// @brief Method Initialize addr 0x24d5c4c size 0xb0 virtual false final false
 void Initialize(bool initialState, int32_t spinCount) ;

/// @brief Method EnsureLockObjectCreated addr 0x24d5e1c size 0x88 virtual false final false
 void EnsureLockObjectCreated() ;

/// @brief Method LazyInitializeEvent addr 0x24d57b4 size 0x168 virtual false final false
 bool LazyInitializeEvent() ;

/// @brief Method Set addr 0x24d5f28 size 0x8 virtual false final false
 void Set() ;

/// @brief Method Set addr 0x24d5f30 size 0x1ac virtual false final false
 void Set(bool duringCancellation) ;

/// @brief Method Wait addr 0x24d6134 size 0x450 virtual false final false
 bool Wait(int32_t millisecondsTimeout, System::Threading::CancellationToken cancellationToken) ;

/// @brief Method Dispose addr 0x24d667c size 0x6c virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x24d66e8 size 0xf4 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method ThrowIfDisposed addr 0x24d5750 size 0x64 virtual false final false
 void ThrowIfDisposed() ;

/// @brief Method CancellationTokenCallback addr 0x24d67dc size 0x120 virtual false final false
static void CancellationTokenCallback(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method UpdateStateAtomically addr 0x24d59a0 size 0xa4 virtual false final false
 void UpdateStateAtomically(int32_t newBits, int32_t updateBitsMask) ;

/// @brief Method ExtractStatePortionAndShiftRight addr 0x24d5aa0 size 0xc virtual false final false
static int32_t ExtractStatePortionAndShiftRight(int32_t state, int32_t mask, int32_t rightBitShiftCount) ;

/// @brief Method ExtractStatePortion addr 0x24d5978 size 0x8 virtual false final false
