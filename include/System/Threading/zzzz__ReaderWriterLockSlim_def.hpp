...
/// @brief Method .ctor addr 0x26b3a40 size 0x88 virtual false final false
 void _ctor(int32_t millisecondsTimeout) ;

/// @brief Method get_RemainingMilliseconds addr 0x26b5654 size 0x48 virtual false final false
 int32_t get_RemainingMilliseconds() ;

/// @brief Method get_IsExpired addr 0x26b41e4 size 0x18 virtual false final false
 bool get_IsExpired() ;
...
/// @brief Method InitializeThreadCounts addr 0x26b37ec size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x26b37f8 size 0x84 virtual false final false
 void _ctor(System::Threading::LockRecursionPolicy recursionPolicy) ;

/// @brief Method IsRWEntryEmpty addr 0x26b387c size 0x40 virtual false final false
static bool IsRWEntryEmpty(System::Threading::ReaderWriterCount rwc) ;

/// @brief Method IsRwHashEntryChanged addr 0x26b38bc size 0x24 virtual false final false
 bool IsRwHashEntryChanged(System::Threading::ReaderWriterCount lrwc) ;

/// @brief Method GetThreadRWCount addr 0x26b38e0 size 0x12c virtual false final false
 System::Threading::ReaderWriterCount GetThreadRWCount(bool dontAllocate) ;

/// @brief Method EnterReadLock addr 0x26b3a0c size 0x8 virtual false final false
 void EnterReadLock() ;

/// @brief Method TryEnterReadLock addr 0x26b3a14 size 0x2c virtual false final false
 bool TryEnterReadLock(int32_t millisecondsTimeout) ;

/// @brief Method TryEnterReadLock addr 0x26b3ac8 size 0x4 virtual false final false
 bool TryEnterReadLock(System::Threading::System__Threading__ReaderWriterLockSlim__TimeoutTracker timeout) ;

/// @brief Method TryEnterReadLockCore addr 0x26b3acc size 0x700 virtual false final false
 bool TryEnterReadLockCore(System::Threading::System__Threading__ReaderWriterLockSlim__TimeoutTracker timeout) ;

/// @brief Method EnterWriteLock addr 0x26b44bc size 0x8 virtual false final false
 void EnterWriteLock() ;

/// @brief Method TryEnterWriteLock addr 0x26b44c4 size 0x2c virtual false final false
 bool TryEnterWriteLock(int32_t millisecondsTimeout) ;

/// @brief Method TryEnterWriteLock addr 0x26b44f0 size 0x4 virtual false final false
 bool TryEnterWriteLock(System::Threading::System__Threading__ReaderWriterLockSlim__TimeoutTracker timeout) ;

/// @brief Method TryEnterWriteLockCore addr 0x26b44f4 size 0x668 virtual false final false
 bool TryEnterWriteLockCore(System::Threading::System__Threading__ReaderWriterLockSlim__TimeoutTracker timeout) ;

/// @brief Method EnterUpgradeableReadLock addr 0x26b4b88 size 0x8 virtual false final false
 void EnterUpgradeableReadLock() ;

/// @brief Method TryEnterUpgradeableReadLock addr 0x26b4b90 size 0x2c virtual false final false
 bool TryEnterUpgradeableReadLock(int32_t millisecondsTimeout) ;

/// @brief Method TryEnterUpgradeableReadLock addr 0x26b4bbc size 0x4 virtual false final false
 bool TryEnterUpgradeableReadLock(System::Threading::System__Threading__ReaderWriterLockSlim__TimeoutTracker timeout) ;

/// @brief Method TryEnterUpgradeableReadLockCore addr 0x26b4bc0 size 0x504 virtual false final false
 bool TryEnterUpgradeableReadLockCore(System::Threading::System__Threading__ReaderWriterLockSlim__TimeoutTracker timeout) ;

/// @brief Method ExitReadLock addr 0x26b50c4 size 0x16c virtual false final false
 void ExitReadLock() ;

/// @brief Method ExitWriteLock addr 0x26b525c size 0x230 virtual false final false
 void ExitWriteLock() ;

/// @brief Method ExitUpgradeableReadLock addr 0x26b549c size 0x198 virtual false final false
 void ExitUpgradeableReadLock() ;

/// @brief Method LazyCreateEvent addr 0x26b4294 size 0x100 virtual false final false
 void LazyCreateEvent(ByRef<System::Threading::EventWaitHandle> waitEvent, bool makeAutoResetEvent) ;

/// @brief Method WaitOnEvent addr 0x26b4394 size 0x128 virtual false final false
...
/// @brief Method ExitAndWakeUpAppropriateWaiters addr 0x26b5230 size 0x2c virtual false final false
 void ExitAndWakeUpAppropriateWaiters() ;

/// @brief Method ExitAndWakeUpAppropriateWaitersPreferringWriters addr 0x26b569c size 0x84 virtual false final false
 void ExitAndWakeUpAppropriateWaitersPreferringWriters() ;

/// @brief Method ExitAndWakeUpAppropriateReadWaiters addr 0x26b5720 size 0x94 virtual false final false
 void ExitAndWakeUpAppropriateReadWaiters() ;

/// @brief Method IsWriterAcquired addr 0x26b4b5c size 0x10 virtual false final false
 bool IsWriterAcquired() ;

/// @brief Method SetWriterAcquired addr 0x26b4b6c size 0x10 virtual false final false
 void SetWriterAcquired() ;

/// @brief Method ClearWriterAcquired addr 0x26b548c size 0x10 virtual false final false
 void ClearWriterAcquired() ;

/// @brief Method SetWritersWaiting addr 0x26b5634 size 0x10 virtual false final false
 void SetWritersWaiting() ;

/// @brief Method ClearWritersWaiting addr 0x26b57b4 size 0x10 virtual false final false
 void ClearWritersWaiting() ;

/// @brief Method SetUpgraderWaiting addr 0x26b5644 size 0x10 virtual false final false
 void SetUpgraderWaiting() ;

/// @brief Method ClearUpgraderWaiting addr 0x26b57c4 size 0x10 virtual false final false
 void ClearUpgraderWaiting() ;

/// @brief Method GetNumReaders addr 0x26b4b7c size 0xc virtual false final false
 uint32_t GetNumReaders() ;

/// @brief Method EnterMyLock addr 0x26b57d4 size 0x34 virtual false final false
 void EnterMyLock() ;

/// @brief Method EnterMyLockSpin addr 0x26b5808 size 0xd8 virtual false final false
 void EnterMyLockSpin() ;

/// @brief Method ExitMyLock addr 0x26b41cc size 0x18 virtual false final false
 void ExitMyLock() ;

/// @brief Method SpinWait addr 0x26b41fc size 0x98 virtual false final false
static void SpinWait(int32_t SpinCount) ;

/// @brief Method Dispose addr 0x26b58e0 size 0x8 virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x26b58e8 size 0x140 virtual false final false
 void Dispose(bool disposing) ;

/// @brief Method get_IsReadLockHeld addr 0x26b5a28 size 0x18 virtual false final false
 bool get_IsReadLockHeld() ;

/// @brief Method get_IsUpgradeableReadLockHeld addr 0x26b5a40 size 0x18 virtual false final false
 bool get_IsUpgradeableReadLockHeld() ;

/// @brief Method get_IsWriteLockHeld addr 0x26b5a58 size 0x18 virtual false final false
 bool get_IsWriteLockHeld() ;

/// @brief Method get_RecursiveReadCount addr 0x26b5a70 size 0x80 virtual false final false
 int32_t get_RecursiveReadCount() ;

/// @brief Method get_RecursiveUpgradeCount addr 0x26b5af0 size 0xb0 virtual false final false
 int32_t get_RecursiveUpgradeCount() ;

/// @brief Method get_RecursiveWriteCount addr 0x26b5ba0 size 0xb0 virtual false final false
 int32_t get_RecursiveWriteCount() ;

/// @brief Method get_WaitingReadCount addr 0x26b5c50 size 0x8 virtual false final false
 int32_t get_WaitingReadCount() ;

/// @brief Method get_WaitingUpgradeCount addr 0x26b5c58 size 0x8 virtual false final false
 int32_t get_WaitingUpgradeCount() ;

/// @brief Method get_WaitingWriteCount addr 0x26b5c60 size 0x8 virtual false final false
