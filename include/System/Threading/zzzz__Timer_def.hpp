...
/// @brief Method System.Collections.IComparer.Compare addr 0x24e4898 size 0x98 virtual true final true
 int32_t System_Collections_IComparer_Compare(::bs_hook::Il2CppWrapperType x, ::bs_hook::Il2CppWrapperType y) ;

/// @brief Method Compare addr 0x24e4930 size 0x70 virtual true final true
...
/// @brief Method InitScheduler addr 0x24e49a0 size 0xf4 virtual false final false
 void InitScheduler() ;

/// @brief Method WakeupScheduler addr 0x24e4a94 size 0x1c virtual false final false
 void WakeupScheduler() ;

/// @brief Method SchedulerThread addr 0x24e4ab0 size 0x138 virtual false final false
 void SchedulerThread() ;

/// @brief Method get_Instance addr 0x24e4efc size 0x58 virtual false final false
static System::Threading::System__Threading__Timer__Scheduler get_Instance() ;

// Ctor Parameters []
explicit System__Threading__Timer__Scheduler() ;

/// @brief Method .ctor addr 0x24e4f54 size 0x9c virtual false final false
 void _ctor() ;

/// @brief Method Remove addr 0x24e4634 size 0xcc virtual false final false
 void Remove(System::Threading::Timer timer) ;

/// @brief Method Change addr 0x24e4704 size 0x190 virtual false final false
 void Change(System::Threading::Timer timer, int64_t new_next_run) ;

/// @brief Method Add addr 0x24e5020 size 0xf0 virtual false final false
 void Add(System::Threading::Timer timer) ;

/// @brief Method InternalRemove addr 0x24e4ff0 size 0x30 virtual false final false
 void InternalRemove(System::Threading::Timer timer) ;

/// @brief Method TimerCB addr 0x24e5110 size 0x78 virtual false final false
static void TimerCB(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method FireTimer addr 0x24e5188 size 0xc8 virtual false final false
 void FireTimer(System::Threading::Timer timer) ;

/// @brief Method RunSchedulerLoop addr 0x24e4be8 size 0x314 virtual false final false
...
/// @brief Method get_scheduler addr 0x24e41ac size 0x88 virtual false final false
...
/// @brief Method .ctor addr 0x24e4234 size 0x4c virtual false final false
...
/// @brief Method .ctor addr 0x24e42f4 size 0x90 virtual false final false
...
/// @brief Method Init addr 0x24e4280 size 0x74 virtual false final false
 void Init(System::Threading::TimerCallback callback, ::bs_hook::Il2CppWrapperType state, int64_t dueTime, int64_t period) ;

/// @brief Method Change addr 0x24e4564 size 0x20 virtual false final false
 bool Change(int32_t dueTime, int32_t period) ;

/// @brief Method Change addr 0x24e4584 size 0x78 virtual false final false
 bool Change(System::TimeSpan dueTime, System::TimeSpan period) ;

/// @brief Method Dispose addr 0x24e45fc size 0x38 virtual true final true
 void Dispose() ;

/// @brief Method Change addr 0x24e4384 size 0x1e0 virtual false final false
 bool Change(int64_t dueTime, int64_t period, bool first) ;

/// @brief Method KeepRootedWhileScheduled addr 0x24e4894 size 0x4 virtual false final false
 void KeepRootedWhileScheduled() ;

/// @brief Method GetTimeMonotonic addr 0x24e4700 size 0x4 virtual false final false
