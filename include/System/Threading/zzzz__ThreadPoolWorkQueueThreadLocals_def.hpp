...
/// @brief Method .ctor addr 0x24e08e8 size 0x11c virtual false final false
 void _ctor(System::Threading::ThreadPoolWorkQueue tpq) ;

/// @brief Method CleanUp addr 0x24e0a04 size 0xd4 virtual false final false
 void CleanUp() ;

/// @brief Method Finalize addr 0x24e0ad8 size 0xcc virtual true final false
 void Finalize() ;
