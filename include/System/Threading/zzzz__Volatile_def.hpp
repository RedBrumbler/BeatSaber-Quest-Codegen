...
/// @brief Method Read addr 0x24e53f0 size 0x18 virtual false final false
static bool Read(ByRef<bool> location) ;

/// @brief Method Write addr 0x24e5408 size 0x24 virtual false final false
static void Write(ByRef<bool> location, bool value) ;

/// @brief Method Read addr 0x24e542c size 0x18 virtual false final false
static int32_t Read(ByRef<int32_t> location) ;

/// @brief Method Write addr 0x24e5444 size 0x24 virtual false final false
