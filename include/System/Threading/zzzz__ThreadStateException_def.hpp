...
/// @brief Method .ctor addr 0x24d4ba0 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit ThreadStateException(::StringW message) ;

/// @brief Method .ctor addr 0x24d4bfc size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x24d4c20 size 0x8 virtual false final false
