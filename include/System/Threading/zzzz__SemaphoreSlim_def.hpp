...
/// @brief Method .ctor addr 0x24d97dc size 0x48 virtual false final false
 void _ctor() ;

/// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem addr 0x24d9efc size 0x4c virtual true final true
 void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem() ;

/// @brief Method System.Threading.IThreadPoolWorkItem.MarkAborted addr 0x24d9f48 size 0x4 virtual true final true
...
/// @brief Method MoveNext addr 0x24d9f4c size 0x76c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x24da6b8 size 0x58 virtual true final true
...
/// @brief Method get_CurrentCount addr 0x24d8b18 size 0x18 virtual false final false
...
/// @brief Method .ctor addr 0x24d8b30 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x24d8b38 size 0x194 virtual false final false
 void _ctor(int32_t initialCount, int32_t maxCount) ;

/// @brief Method Wait addr 0x24d8cd4 size 0xc virtual false final false
 void Wait() ;

/// @brief Method Wait addr 0x24d91b8 size 0x8 virtual false final false
 bool Wait(int32_t millisecondsTimeout) ;

/// @brief Method Wait addr 0x24d8ce0 size 0x4d8 virtual false final false
 bool Wait(int32_t millisecondsTimeout, System::Threading::CancellationToken cancellationToken) ;

/// @brief Method WaitUntilCountOrTimeout addr 0x24d9528 size 0x90 virtual false final false
...
/// @brief Method WaitAsync addr 0x24d961c size 0xc virtual false final false
 System::Threading::Tasks::Task WaitAsync() ;

/// @brief Method WaitAsync addr 0x24d9628 size 0xc virtual false final false
 System::Threading::Tasks::Task WaitAsync(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method WaitAsync addr 0x24d9244 size 0x2e4 virtual false final false
...
/// @brief Method CreateAndAddAsyncWaiter addr 0x24d9634 size 0x84 virtual false final false
 System::Threading::System__Threading__SemaphoreSlim__TaskNode CreateAndAddAsyncWaiter() ;

/// @brief Method RemoveAsyncWaiter addr 0x24d9824 size 0x80 virtual false final false
 bool RemoveAsyncWaiter(System::Threading::System__Threading__SemaphoreSlim__TaskNode task) ;

/// @brief Method WaitUntilCountOrTimeoutAsync addr 0x24d96b8 size 0x124 virtual false final false
...
/// @brief Method Release addr 0x24d98a4 size 0x8 virtual false final false
 int32_t Release() ;

/// @brief Method Release addr 0x24d98ac size 0x2e4 virtual false final false
 int32_t Release(int32_t releaseCount) ;

/// @brief Method QueueWaiterTask addr 0x24d9be8 size 0xc virtual false final false
static void QueueWaiterTask(System::Threading::System__Threading__SemaphoreSlim__TaskNode waiterTask) ;

/// @brief Method Dispose addr 0x24d9bf4 size 0x6c virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x24d9c60 size 0x5c virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method CancellationTokenCanceledEventHandler addr 0x24d9cbc size 0x114 virtual false final false
static void CancellationTokenCanceledEventHandler(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method CheckDispose addr 0x24d91c0 size 0x84 virtual false final false
 void CheckDispose() ;

/// @brief Method GetResourceString addr 0x24d8ccc size 0x8 virtual false final false
