...
/// @brief Method .ctor addr 0x24d6d88 size 0xc virtual false final false
...
/// @brief Method Unregister addr 0x24d6d94 size 0x7c virtual false final false
 bool Unregister() ;

/// @brief Method Dispose addr 0x24d6e10 size 0x94 virtual true final true
 void Dispose() ;

/// @brief Method Equals addr 0x24d6f24 size 0x90 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x24d6fb4 size 0x80 virtual true final true
 bool Equals(System::Threading::CancellationTokenRegistration other) ;

/// @brief Method GetHashCode addr 0x24d7034 size 0x90 virtual true final false
 int32_t GetHashCode() ;
