...
/// @brief Method .ctor addr 0x24d4598 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x24db274 size 0x2c0 virtual false final false
 void _ctor(bool initialState, System::Threading::EventResetMode mode, ::StringW name) ;

/// @brief Method Reset addr 0x24d95b8 size 0x64 virtual false final false
 bool Reset() ;

/// @brief Method Set addr 0x24d5ec4 size 0x64 virtual false final false
 bool Set() ;
