...
/// @brief Method get_Count addr 0x24d6998 size 0x8 virtual false final false
 int32_t get_Count() ;

/// @brief Method get_NextSpinWillYield addr 0x24d69a0 size 0x78 virtual false final false
 bool get_NextSpinWillYield() ;

/// @brief Method SpinOnce addr 0x24d68fc size 0x8 virtual false final false
 void SpinOnce() ;

/// @brief Method SpinOnce addr 0x24d658c size 0xac virtual false final false
 void SpinOnce(int32_t sleep1Threshold) ;

/// @brief Method SpinOnceCore addr 0x24d6a18 size 0x1a4 virtual false final false
 void SpinOnceCore(int32_t sleep1Threshold) ;

/// @brief Method Reset addr 0x24d6bbc size 0x8 virtual false final false
 void Reset() ;
