...
/// @brief Method .ctor addr 0x24e287c size 0x28 virtual false final false
 void _ctor(System::Threading::ReaderWriterLock rwlock) ;

/// @brief Method Wait addr 0x24e28a4 size 0x1b4 virtual false final false
 bool Wait(int32_t timeout) ;

/// @brief Method get_IsEmpty addr 0x24e2a58 size 0xc0 virtual false final false
 bool get_IsEmpty() ;

/// @brief Method Pulse addr 0x24e2b18 size 0xb8 virtual false final false
 void Pulse() ;
