...
namespace System::Threading::Tasks {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2783)), TypeDefinitionIndex(TypeDefinitionIndex(2770)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2770), inst: 383 })}
...
/// @brief Method .ctor addr 0x24f0e08 size 0x114 virtual false final false
 void _ctor(System::Collections::Generic::IList_1<System::Threading::Tasks::Task> tasks) ;

/// @brief Method Invoke addr 0x24f0f1c size 0x22c virtual true final true
 void Invoke(System::Threading::Tasks::Task completingTask) ;

/// @brief Method get_InvokeMayRunArbitraryCode addr 0x24f1148 size 0x8 virtual true final true
...
/// @brief Method .ctor addr 0x24ee840 size 0x14 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x24f0a40 size 0x50 virtual false final false
...
/// @brief Method CheckCreationOptions addr 0x24f0b98 size 0x60 virtual false final false
static void CheckCreationOptions(System::Threading::Tasks::TaskCreationOptions creationOptions) ;

/// @brief Method StartNew addr 0x24f0bf8 size 0x8c virtual false final false
...
/// @brief Method StartNew addr 0x24f0c84 size 0x90 virtual false final false
...
/// @brief Method CheckFromAsyncOptions addr 0x24f0d14 size 0xf4 virtual false final false
static void CheckFromAsyncOptions(System::Threading::Tasks::TaskCreationOptions creationOptions, bool hasBeginMethod) ;

/// @brief Method CommonCWAnyLogic addr 0x24edbd4 size 0x23c virtual false final false
...
/// @brief Method CheckMultiTaskContinuationOptions addr 0x24f0a90 size 0x108 virtual false final false
