...
/// @brief Method .ctor addr 0x24efb48 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Run>b__2_0 addr 0x24efb50 size 0xf0 virtual false final false
...
/// @brief Method .ctor addr 0x24eb180 size 0x30 virtual false final false
 void _ctor(System::Threading::Tasks::TaskScheduler scheduler, System::Action action, bool flowExecutionContext) ;

/// @brief Method Run addr 0x24ef6f4 size 0x244 virtual true final true
