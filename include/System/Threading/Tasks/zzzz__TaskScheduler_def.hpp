...
/// @brief Method TryRunInline addr 0x24ebbc4 size 0x1f8 virtual false final false
 bool TryRunInline(System::Threading::Tasks::Task task, bool taskWasPreviouslyQueued) ;

/// @brief Method TryDequeue addr 0x24f1150 size 0x8 virtual true final false
 bool TryDequeue(System::Threading::Tasks::Task task) ;

/// @brief Method NotifyWorkItemProgress addr 0x24f1158 size 0x4 virtual true final false
 void NotifyWorkItemProgress() ;

/// @brief Method get_RequiresAtomicStartTransition addr 0x24f115c size 0x8 virtual true final false
 bool get_RequiresAtomicStartTransition() ;

// Ctor Parameters []
explicit TaskScheduler() ;

/// @brief Method .ctor addr 0x24f1164 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_Default addr 0x24f116c size 0x58 virtual false final false
static System::Threading::Tasks::TaskScheduler get_Default() ;

/// @brief Method get_Current addr 0x24ec4fc size 0xa0 virtual false final false
static System::Threading::Tasks::TaskScheduler get_Current() ;

/// @brief Method get_InternalCurrent addr 0x24eb0dc size 0xa4 virtual false final false
static System::Threading::Tasks::TaskScheduler get_InternalCurrent() ;

/// @brief Method get_Id addr 0x24ebdbc size 0x94 virtual false final false
 int32_t get_Id() ;

/// @brief Method PublishUnobservedTaskException addr 0x24f0284 size 0x134 virtual false final false
