...
/// @brief Method .ctor addr 0x24ef680 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <.cctor>b__7_0 addr 0x24ef688 size 0x6c virtual false final false
...
/// @brief Method .ctor addr 0x24eb0ac size 0x30 virtual false final false
 void _ctor(System::Threading::SynchronizationContext context, System::Action action, bool flowExecutionContext) ;

/// @brief Method Run addr 0x24ef094 size 0x1ec virtual true final true
 void Run(System::Threading::Tasks::Task ignored, bool canInlineContinuationTask) ;

/// @brief Method PostAction addr 0x24ef3fc size 0x94 virtual false final false
static void PostAction(::bs_hook::Il2CppWrapperType state) ;

/// @brief Method GetPostActionCallback addr 0x24ef490 size 0xc8 virtual false final false
