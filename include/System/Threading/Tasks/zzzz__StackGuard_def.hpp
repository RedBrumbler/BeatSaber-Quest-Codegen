...
/// @brief Method TryBeginInliningScope addr 0x24eec0c size 0x40 virtual false final false
 bool TryBeginInliningScope() ;

/// @brief Method EndInliningScope addr 0x24eec4c size 0x14 virtual false final false
 void EndInliningScope() ;

// Ctor Parameters []
explicit StackGuard() ;

/// @brief Method .ctor addr 0x24e88d8 size 0x8 virtual false final false
 void _ctor() ;
