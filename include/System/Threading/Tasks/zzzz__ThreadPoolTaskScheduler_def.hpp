...
/// @brief Method .ctor addr 0x24f16bc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <.cctor>b__10_0 addr 0x24f16c4 size 0x84 virtual false final false
...
/// @brief Method .ctor addr 0x24f1270 size 0x58 virtual false final false
 void _ctor() ;

/// @brief Method QueueTask addr 0x24f12c8 size 0x1c8 virtual true final false
 void QueueTask(System::Threading::Tasks::Task task) ;

/// @brief Method TryExecuteTaskInline addr 0x24f1490 size 0xe4 virtual true final false
 bool TryExecuteTaskInline(System::Threading::Tasks::Task task, bool taskWasPreviouslyQueued) ;

/// @brief Method TryDequeue addr 0x24f1574 size 0x8 virtual true final false
 bool TryDequeue(System::Threading::Tasks::Task task) ;

/// @brief Method NotifyWorkItemProgress addr 0x24f157c size 0x10 virtual true final false
 void NotifyWorkItemProgress() ;

/// @brief Method get_RequiresAtomicStartTransition addr 0x24f158c size 0x8 virtual true final false
