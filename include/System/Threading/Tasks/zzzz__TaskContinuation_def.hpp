...
/// @brief Method InlineIfPossibleOrElseQueue addr 0x24eed30 size 0x144 virtual false final false
static void InlineIfPossibleOrElseQueue(System::Threading::Tasks::Task task, bool needsProtection) ;

// Ctor Parameters []
explicit TaskContinuation() ;

/// @brief Method .ctor addr 0x24eee74 size 0x8 virtual false final false
 void _ctor() ;
