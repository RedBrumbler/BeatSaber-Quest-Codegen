...
/// @brief Method .ctor addr 0x24e66f8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <.cctor>b__4_0 addr 0x24e6700 size 0x2a4 virtual false final false
...
namespace System::Threading::Tasks {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2770), inst: 868 }), TypeDefinitionIndex(TypeDefinitionIndex(2790)), TypeDefinitionIndex(TypeDefinitionIndex(2770))}
...
/// @brief Method .ctor addr 0x24e61a8 size 0x120 virtual false final false
...
/// @brief Method get_CompletedTask addr 0x24e5b84 size 0x88 virtual false final false
static System::Threading::Tasks::Task get_CompletedTask() ;

/// @brief Method .ctor addr 0x24e5c0c size 0x38 virtual false final false
 void _ctor(System::Threading::Tasks::Task task) ;

/// @brief Method .ctor addr 0x24e5c44 size 0x3c virtual false final false
 void _ctor(System::Threading::Tasks::Sources::IValueTaskSource source, int16_t token) ;

/// @brief Method .ctor addr 0x24e5c80 size 0x14 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType obj, int16_t token, bool continueOnCapturedContext) ;

/// @brief Method GetHashCode addr 0x24e5c94 size 0x18 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x24e5cac size 0x88 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x24e5d34 size 0x24 virtual true final true
 bool Equals(System::Threading::Tasks::ValueTask other) ;

/// @brief Method AsTask addr 0x24e5d58 size 0xb8 virtual false final false
 System::Threading::Tasks::Task AsTask() ;

/// @brief Method GetTaskForValueTaskSource addr 0x24e5e10 size 0x2d8 virtual false final false
 System::Threading::Tasks::Task GetTaskForValueTaskSource(System::Threading::Tasks::Sources::IValueTaskSource t) ;

/// @brief Method get_IsCompleted addr 0x24e62c8 size 0x104 virtual false final false
 bool get_IsCompleted() ;

/// @brief Method ThrowIfCompletedUnsuccessfully addr 0x24e63cc size 0x104 virtual false final false
 void ThrowIfCompletedUnsuccessfully() ;

/// @brief Method GetAwaiter addr 0x24e64d0 size 0xc virtual false final false
 System::Runtime::CompilerServices::ValueTaskAwaiter GetAwaiter() ;

/// @brief Method ConfigureAwait addr 0x24e64dc size 0x18 virtual false final false
