...
/// @brief Method get_LoggingOn addr 0x24e6abc size 0x8 virtual false final false
static bool get_LoggingOn() ;

/// @brief Method TraceOperationCreation addr 0x24e6ac4 size 0x4 virtual false final false
...
/// @brief Method TraceOperationCompletion addr 0x24e6ac8 size 0x4 virtual false final false
...
/// @brief Method TraceOperationRelation addr 0x24e6acc size 0x4 virtual false final false
...
/// @brief Method TraceSynchronousWorkStart addr 0x24e6ad0 size 0x4 virtual false final false
...
/// @brief Method TraceSynchronousWorkCompletion addr 0x24e6ad4 size 0x4 virtual false final false
...
/// @brief Method AddToActiveTasks addr 0x24e6ad8 size 0x94 virtual false final false
static void AddToActiveTasks(System::Threading::Tasks::Task task) ;

/// @brief Method AddToActiveTasksNonInlined addr 0x24e6b6c size 0x15c virtual false final false
static void AddToActiveTasksNonInlined(System::Threading::Tasks::Task task) ;

/// @brief Method RemoveFromActiveTasks addr 0x24e6d58 size 0x94 virtual false final false
static void RemoveFromActiveTasks(System::Threading::Tasks::Task task) ;

/// @brief Method RemoveFromActiveTasksNonInlined addr 0x24e6dec size 0x15c virtual false final false
