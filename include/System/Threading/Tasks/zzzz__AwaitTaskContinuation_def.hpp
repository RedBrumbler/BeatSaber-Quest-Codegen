...
/// @brief Method .ctor addr 0x24ef014 size 0x80 virtual false final false
 void _ctor(System::Action action, bool flowExecutionContext) ;

/// @brief Method CreateTask addr 0x24efa54 size 0x90 virtual false final false
...
/// @brief Method Run addr 0x24ef938 size 0x11c virtual true final false
 void Run(System::Threading::Tasks::Task ignored, bool canInlineContinuationTask) ;

/// @brief Method get_IsValidLocationForInlining addr 0x24efc98 size 0x134 virtual false final false
static bool get_IsValidLocationForInlining() ;

/// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem addr 0x24efdcc size 0x128 virtual true final true
 void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem() ;

/// @brief Method InvokeAction addr 0x24efef4 size 0x6c virtual false final false
static void InvokeAction(::bs_hook::Il2CppWrapperType state) ;

/// @brief Method GetInvokeActionCallback addr 0x24eff60 size 0xa8 virtual false final false
static System::Threading::ContextCallback GetInvokeActionCallback() ;

/// @brief Method RunCallback addr 0x24ef280 size 0x17c virtual false final false
...
/// @brief Method RunOrScheduleAction addr 0x24ec2b0 size 0x158 virtual false final false
static void RunOrScheduleAction(System::Action action, bool allowInlining, ByRef<System::Threading::Tasks::Task> currentTask) ;

/// @brief Method UnsafeScheduleAction addr 0x24eb244 size 0x8c virtual false final false
static void UnsafeScheduleAction(System::Action action) ;

/// @brief Method ThrowAsyncIfNecessary addr 0x24efc40 size 0x58 virtual false final false
static void ThrowAsyncIfNecessary(System::Exception exc) ;

/// @brief Method MarkAborted addr 0x24f0008 size 0x4 virtual true final true
