...
/// @brief Method .ctor addr 0x24e9304 size 0x28 virtual false final false
 void _ctor(System::Threading::Tasks::Task task) ;

/// @brief Method ShouldFailFastOnUnobservedException addr 0x24f000c size 0x8 virtual false final false
static bool ShouldFailFastOnUnobservedException() ;

/// @brief Method Finalize addr 0x24f0014 size 0x204 virtual true final false
 void Finalize() ;

/// @brief Method get_ContainsFaultList addr 0x24e8f18 size 0x1c virtual false final false
 bool get_ContainsFaultList() ;

/// @brief Method Add addr 0x24e932c size 0xc virtual false final false
 void Add(::bs_hook::Il2CppWrapperType exceptionObject, bool representsCancellation) ;

/// @brief Method SetCancellationException addr 0x24f03b8 size 0xbc virtual false final false
 void SetCancellationException(::bs_hook::Il2CppWrapperType exceptionObject) ;

/// @brief Method AddFaultException addr 0x24f0474 size 0x50c virtual false final false
 void AddFaultException(::bs_hook::Il2CppWrapperType exceptionObject) ;

/// @brief Method MarkAsUnhandled addr 0x24f0980 size 0x70 virtual false final false
 void MarkAsUnhandled() ;

/// @brief Method MarkAsHandled addr 0x24e90f0 size 0x7c virtual false final false
 void MarkAsHandled(bool calledFromFinalizer) ;

/// @brief Method CreateExceptionObject addr 0x24e9338 size 0x1b4 virtual false final false
 System::AggregateException CreateExceptionObject(bool calledFromFinalizer, System::Exception includeThisException) ;

/// @brief Method GetExceptionDispatchInfos addr 0x24e95f8 size 0x8c virtual false final false
...
/// @brief Method GetCancellationExceptionDispatchInfo addr 0x24f09f0 size 0x8 virtual false final false
