...
/// @brief Method Thread_free_internal addr 0x24e4104 size 0x4 virtual false final false
 void Thread_free_internal() ;

/// @brief Method Finalize addr 0x24e4108 size 0x94 virtual true final false
 void Finalize() ;

// Ctor Parameters []
explicit InternalThread() ;

/// @brief Method .ctor addr 0x24e419c size 0x10 virtual false final false
 void _ctor() ;
