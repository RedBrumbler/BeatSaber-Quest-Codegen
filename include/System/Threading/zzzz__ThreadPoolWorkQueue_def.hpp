...
/// @brief Method LocalPush addr 0x24df2c0 size 0x434 virtual false final false
 void LocalPush(System::Threading::IThreadPoolWorkItem obj) ;

/// @brief Method LocalFindAndPop addr 0x24df764 size 0x2bc virtual false final false
 bool LocalFindAndPop(System::Threading::IThreadPoolWorkItem obj) ;

/// @brief Method LocalPop addr 0x24dfbf0 size 0x274 virtual false final false
 bool LocalPop(ByRef<System::Threading::IThreadPoolWorkItem> obj) ;

/// @brief Method TrySteal addr 0x24dfe64 size 0x8 virtual false final false
 bool TrySteal(ByRef<System::Threading::IThreadPoolWorkItem> obj, ByRef<bool> missedSteal) ;

/// @brief Method TrySteal addr 0x24e034c size 0x244 virtual false final false
...
/// @brief Method .ctor addr 0x24e0590 size 0x80 virtual false final false
 void _ctor() ;
...
/// @brief Method GetIndexes addr 0x24e0610 size 0x34 virtual false final false
 void GetIndexes(ByRef<int32_t> upper, ByRef<int32_t> lower) ;

/// @brief Method CompareExchangeIndexes addr 0x24e0644 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x24e06b0 size 0x5c virtual false final false
 void _ctor() ;

/// @brief Method IsUsedUp addr 0x24e070c size 0x44 virtual false final false
 bool IsUsedUp() ;

/// @brief Method TryEnqueue addr 0x24e0750 size 0xac virtual false final false
 bool TryEnqueue(System::Threading::IThreadPoolWorkItem node) ;

/// @brief Method TryDequeue addr 0x24e07fc size 0xec virtual false final false
...
/// @brief Method .ctor addr 0x24def90 size 0x78 virtual false final false
 void _ctor() ;

/// @brief Method EnsureCurrentThreadHasQueue addr 0x24df008 size 0x90 virtual false final false
 System::Threading::ThreadPoolWorkQueueThreadLocals EnsureCurrentThreadHasQueue() ;

/// @brief Method EnsureThreadRequested addr 0x24df098 size 0xa0 virtual false final false
 void EnsureThreadRequested() ;

/// @brief Method MarkThreadRequestSatisfied addr 0x24df138 size 0x4c virtual false final false
 void MarkThreadRequestSatisfied() ;

/// @brief Method Enqueue addr 0x24df184 size 0x13c virtual false final false
 void Enqueue(System::Threading::IThreadPoolWorkItem callback, bool forceGlobal) ;

/// @brief Method LocalFindAndPop addr 0x24df6f4 size 0x70 virtual false final false
 bool LocalFindAndPop(System::Threading::IThreadPoolWorkItem callback) ;

/// @brief Method Dequeue addr 0x24dfa20 size 0x1d0 virtual false final false
...
/// @brief Method Dispatch addr 0x24dfe6c size 0x450 virtual false final false
