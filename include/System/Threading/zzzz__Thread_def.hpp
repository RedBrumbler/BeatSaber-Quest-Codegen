...
/// @brief Method AsyncLocalSetCurrentCulture addr 0x24ddf60 size 0x60 virtual false final false
...
/// @brief Method .ctor addr 0x24ddfc0 size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x24de168 size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x24de1e8 size 0xf0 virtual false final false
 void _ctor(System::Threading::ParameterizedThreadStart start, int32_t maxStackSize) ;

/// @brief Method Start addr 0x24de2d8 size 0x14 virtual false final false
 void Start() ;

/// @brief Method Start addr 0x24de3a8 size 0xd0 virtual false final false
 void Start(::bs_hook::Il2CppWrapperType parameter) ;

/// @brief Method Start addr 0x24de2ec size 0xbc virtual false final false
 void Start(ByRef<System::Threading::StackCrawlMark> stackMark) ;

/// @brief Method GetExecutionContextReader addr 0x24db658 size 0x8 virtual false final false
 System::Threading::System__Threading__ExecutionContext__Reader GetExecutionContextReader() ;

/// @brief Method get_ExecutionContextBelongsToCurrentScope addr 0x24dc5b8 size 0x10 virtual false final false
 bool get_ExecutionContextBelongsToCurrentScope() ;

/// @brief Method set_ExecutionContextBelongsToCurrentScope addr 0x24dc5c8 size 0x10 virtual false final false
 void set_ExecutionContextBelongsToCurrentScope(bool value) ;

/// @brief Method GetMutableExecutionContext addr 0x24dbe60 size 0x8c virtual false final false
 System::Threading::ExecutionContext GetMutableExecutionContext() ;

/// @brief Method SetExecutionContext addr 0x24dc608 size 0x14 virtual false final false
 void SetExecutionContext(System::Threading::ExecutionContext value, bool belongsToCurrentScope) ;

/// @brief Method SetExecutionContext addr 0x24db660 size 0x14 virtual false final false
 void SetExecutionContext(System::Threading::System__Threading__ExecutionContext__Reader value, bool belongsToCurrentScope) ;

/// @brief Method get_Priority addr 0x24de4e4 size 0x4 virtual false final false
 System::Threading::ThreadPriority get_Priority() ;

/// @brief Method set_Priority addr 0x24de4ec size 0x4 virtual false final false
 void set_Priority(System::Threading::ThreadPriority value) ;

/// @brief Method GetPriorityNative addr 0x24de4e8 size 0x4 virtual false final false
 int32_t GetPriorityNative() ;

/// @brief Method SetPriorityNative addr 0x24de4f0 size 0x4 virtual false final false
 void SetPriorityNative(int32_t priority) ;

/// @brief Method JoinInternal addr 0x24de4f4 size 0x4 virtual false final false
 bool JoinInternal(int32_t millisecondsTimeout) ;

/// @brief Method Join addr 0x24de4f8 size 0x8 virtual false final false
 void Join() ;

/// @brief Method SleepInternal addr 0x24de500 size 0x4 virtual false final false
static void SleepInternal(int32_t millisecondsTimeout) ;

/// @brief Method Sleep addr 0x24daf50 size 0x7c virtual false final false
static void Sleep(int32_t millisecondsTimeout) ;

/// @brief Method YieldInternal addr 0x24de504 size 0x4 virtual false final false
static bool YieldInternal() ;

/// @brief Method Yield addr 0x24dafcc size 0x4 virtual false final false
static bool Yield() ;

/// @brief Method SetStartHelper addr 0x24de040 size 0x128 virtual false final false
 void SetStartHelper(System::Delegate start, int32_t maxStackSize) ;

/// @brief Method get_CurrentUICulture addr 0x24de5f0 size 0x2c virtual false final false
 System::Globalization::CultureInfo get_CurrentUICulture() ;

/// @brief Method GetCurrentUICultureNoAppX addr 0x24de61c size 0xac virtual false final false
 System::Globalization::CultureInfo GetCurrentUICultureNoAppX() ;

/// @brief Method get_CurrentCulture addr 0x24de6c8 size 0x2c virtual false final false
 System::Globalization::CultureInfo get_CurrentCulture() ;

/// @brief Method set_CurrentCulture addr 0x24de7a0 size 0x1ec virtual false final false
 void set_CurrentCulture(System::Globalization::CultureInfo value) ;

/// @brief Method GetCurrentCultureNoAppX addr 0x24de6f4 size 0xac virtual false final false
 System::Globalization::CultureInfo GetCurrentCultureNoAppX() ;

/// @brief Method nativeInitCultureAccessors addr 0x24de98c size 0xa4 virtual false final false
static void nativeInitCultureAccessors() ;

/// @brief Method MemoryBarrier addr 0x24dea30 size 0x4 virtual false final false
static void MemoryBarrier() ;

/// @brief Method ConstructInternalThread addr 0x24dea34 size 0x4 virtual false final false
 void ConstructInternalThread() ;

/// @brief Method get_Internal addr 0x24dea38 size 0x24 virtual false final false
 System::Threading::InternalThread get_Internal() ;

/// @brief Method get_CurrentContext addr 0x24dea5c size 0x8 virtual false final false
static System::Runtime::Remoting::Contexts::Context get_CurrentContext() ;

/// @brief Method GetCurrentThread_icall addr 0x24dea64 size 0x4 virtual false final false
static void GetCurrentThread_icall(ByRef<System::Threading::Thread> thread) ;

/// @brief Method GetCurrentThread addr 0x24dea68 size 0x1c virtual false final false
static System::Threading::Thread GetCurrentThread() ;

/// @brief Method get_CurrentThread addr 0x24dafd0 size 0x5c virtual false final false
static System::Threading::Thread get_CurrentThread() ;

/// @brief Method get_CurrentThreadId addr 0x24dea84 size 0x24 virtual false final false
static int32_t get_CurrentThreadId() ;

/// @brief Method GetDomainID addr 0x24deaa8 size 0x4 virtual false final false
static int32_t GetDomainID() ;

/// @brief Method Thread_internal addr 0x24deaac size 0x4 virtual false final false
 bool Thread_internal(System::MulticastDelegate start) ;

/// @brief Method Finalize addr 0x24deab0 size 0x8 virtual true final false
 void Finalize() ;

/// @brief Method get_IsThreadPoolThread addr 0x24deab8 size 0x4 virtual false final false
 bool get_IsThreadPoolThread() ;

/// @brief Method get_IsThreadPoolThreadInternal addr 0x24deabc size 0x2c virtual false final false
 bool get_IsThreadPoolThreadInternal() ;

/// @brief Method get_IsAlive addr 0x24deae8 size 0x44 virtual false final false
 bool get_IsAlive() ;

/// @brief Method set_IsBackground addr 0x24deb30 size 0x48 virtual false final false
 void set_IsBackground(bool value) ;

/// @brief Method SetName_icall addr 0x24debf4 size 0x4 virtual false final false
static void SetName_icall(System::Threading::InternalThread thread, void* name, int32_t nameLength) ;

/// @brief Method SetName_internal addr 0x24debf8 size 0x40 virtual false final false
static void SetName_internal(System::Threading::InternalThread thread, ::StringW name) ;

/// @brief Method set_Name addr 0x24dec38 size 0x34 virtual false final false
 void set_Name(::StringW value) ;

/// @brief Method Abort_internal addr 0x24dec6c size 0x4 virtual false final false
static void Abort_internal(System::Threading::InternalThread thread, ::bs_hook::Il2CppWrapperType stateInfo) ;

/// @brief Method Abort addr 0x24dec70 size 0x28 virtual false final false
 void Abort() ;

/// @brief Method SpinWait_nop addr 0x24dec98 size 0x4 virtual false final false
static void SpinWait_nop() ;

/// @brief Method SpinWait addr 0x24daf28 size 0x28 virtual false final false
static void SpinWait(int32_t iterations) ;

/// @brief Method StartInternal addr 0x24de478 size 0x6c virtual false final false
 void StartInternal(::bs_hook::Il2CppWrapperType principal, ByRef<System::Threading::StackCrawlMark> stackMark) ;

/// @brief Method SetState addr 0x24debec size 0x4 virtual false final false
static void SetState(System::Threading::InternalThread thread, System::Threading::ThreadState set) ;

/// @brief Method ClrState addr 0x24debf0 size 0x4 virtual false final false
static void ClrState(System::Threading::InternalThread thread, System::Threading::ThreadState clr) ;

/// @brief Method GetState addr 0x24deb2c size 0x4 virtual false final false
static System::Threading::ThreadState GetState(System::Threading::InternalThread thread) ;

/// @brief Method SystemMaxStackStize addr 0x24dec9c size 0x4 virtual false final false
static int32_t SystemMaxStackStize() ;

/// @brief Method GetProcessDefaultStackSize addr 0x24de508 size 0xac virtual false final false
static int32_t GetProcessDefaultStackSize(int32_t maxStackSize) ;

/// @brief Method SetStart addr 0x24de5b4 size 0x3c virtual false final false
 void SetStart(System::MulticastDelegate start, int32_t maxStackSize) ;

/// @brief Method get_ManagedThreadId addr 0x24db02c size 0x2c virtual false final false
 int32_t get_ManagedThreadId() ;

/// @brief Method BeginCriticalRegion addr 0x24da7c4 size 0x50 virtual false final false
static void BeginCriticalRegion() ;

/// @brief Method EndCriticalRegion addr 0x24dad34 size 0x50 virtual false final false
static void EndCriticalRegion() ;

/// @brief Method GetHashCode addr 0x24deca0 size 0x4 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ValidateThreadState addr 0x24deb78 size 0x74 virtual false final false
