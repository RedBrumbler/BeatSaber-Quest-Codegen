...
/// @brief Method .ctor addr 0x24d4624 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit LockRecursionException(::StringW message) ;

/// @brief Method .ctor addr 0x24d467c size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x24d46e4 size 0x80 virtual false final false
