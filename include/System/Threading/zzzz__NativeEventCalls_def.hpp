...
/// @brief Method CreateEvent_internal addr 0x24e2bd0 size 0x58 virtual false final false
static ::cordl_internals::intptr_t CreateEvent_internal(bool manual, bool initial, ::StringW name, ByRef<int32_t> errorCode) ;

/// @brief Method CreateEvent_icall addr 0x24e2c28 size 0xc virtual false final false
...
/// @brief Method SetEvent addr 0x24e2c34 size 0xe0 virtual false final false
static bool SetEvent(Microsoft::Win32::SafeHandles::SafeWaitHandle handle) ;

/// @brief Method SetEvent_internal addr 0x24e2d14 size 0x4 virtual false final false
static bool SetEvent_internal(::cordl_internals::intptr_t handle) ;

/// @brief Method ResetEvent addr 0x24e2d18 size 0xe0 virtual false final false
static bool ResetEvent(Microsoft::Win32::SafeHandles::SafeWaitHandle handle) ;

/// @brief Method ResetEvent_internal addr 0x24e2df8 size 0x4 virtual false final false
static bool ResetEvent_internal(::cordl_internals::intptr_t handle) ;

/// @brief Method CloseEvent_internal addr 0x24e2dfc size 0x4 virtual false final false
