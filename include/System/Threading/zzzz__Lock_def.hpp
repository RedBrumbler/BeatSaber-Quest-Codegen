...
/// @brief Method Acquire addr 0x24d8a7c size 0x8 virtual false final false
 void Acquire() ;

/// @brief Method Release addr 0x24d8aa0 size 0x8 virtual false final false
 void Release() ;

// Ctor Parameters []
explicit Lock() ;

/// @brief Method .ctor addr 0x24d8ab0 size 0x68 virtual false final false
 void _ctor() ;
