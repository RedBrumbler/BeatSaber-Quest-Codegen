...
/// @brief Method .ctor addr 0x24e2e00 size 0xd4 virtual false final false
 void _ctor() ;

/// @brief Method Finalize addr 0x24e2ed4 size 0x8 virtual true final false
 void Finalize() ;

/// @brief Method get_IsWriterLockHeld addr 0x24e2edc size 0xdc virtual false final false
 bool get_IsWriterLockHeld() ;

/// @brief Method AcquireReaderLock addr 0x24e2fb8 size 0x8 virtual false final false
 void AcquireReaderLock(int32_t millisecondsTimeout) ;

/// @brief Method AcquireReaderLock addr 0x24e2fc0 size 0x39c virtual false final false
 void AcquireReaderLock(int32_t millisecondsTimeout, int32_t initialLockCount) ;

/// @brief Method AcquireWriterLock addr 0x24e3538 size 0x8 virtual false final false
 void AcquireWriterLock(int32_t millisecondsTimeout) ;

/// @brief Method AcquireWriterLock addr 0x24e3390 size 0x1a8 virtual false final false
 void AcquireWriterLock(int32_t millisecondsTimeout, int32_t initialLockCount) ;

/// @brief Method ReleaseReaderLock addr 0x24e3540 size 0x1ec virtual false final false
 void ReleaseReaderLock() ;

/// @brief Method ReleaseReaderLock addr 0x24e385c size 0x120 virtual false final false
 void ReleaseReaderLock(int32_t currentCount, int32_t releaseCount) ;

/// @brief Method ReleaseWriterLock addr 0x24e372c size 0x130 virtual false final false
 void ReleaseWriterLock() ;

/// @brief Method ReleaseWriterLock addr 0x24e397c size 0x60 virtual false final false
 void ReleaseWriterLock(int32_t releaseCount) ;

/// @brief Method HasWriterLock addr 0x24e335c size 0x34 virtual false final false
 bool HasWriterLock() ;
