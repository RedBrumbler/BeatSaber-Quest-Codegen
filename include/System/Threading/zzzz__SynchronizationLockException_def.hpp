...
/// @brief Method .ctor addr 0x24d4a48 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit SynchronizationLockException(::StringW message) ;

/// @brief Method .ctor addr 0x24d4aa4 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x24d4ac8 size 0x8 virtual false final false
