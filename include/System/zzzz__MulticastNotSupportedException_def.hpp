...
/// @brief Method .ctor addr 0x24757d0 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit MulticastNotSupportedException(::StringW message) ;

/// @brief Method .ctor addr 0x247582c size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x2475850 size 0x8 virtual false final false
