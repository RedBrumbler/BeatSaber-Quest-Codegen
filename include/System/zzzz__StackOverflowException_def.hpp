...
/// @brief Method .ctor addr 0x2489734 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit StackOverflowException(::StringW message) ;

/// @brief Method .ctor addr 0x248978c size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0x24897ac size 0x4 virtual false final false
