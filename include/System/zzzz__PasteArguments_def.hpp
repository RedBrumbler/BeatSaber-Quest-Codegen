...
/// @brief Method AppendArgument addr 0x27e3ea4 size 0x1dc virtual false final false
static void AppendArgument(System::Text::StringBuilder stringBuilder, ::StringW argument) ;

/// @brief Method ContainsNoWhitespaceOrQuotes addr 0x27e4080 size 0xc0 virtual false final false
