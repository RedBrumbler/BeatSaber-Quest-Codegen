...
/// @brief Method AllocateHandle addr 0x24cda94 size 0x28 virtual false final false
 void AllocateHandle(::bs_hook::Il2CppWrapperType target) ;

// Ctor Parameters []
explicit WeakReference() ;

/// @brief Method .ctor addr 0x24cdabc size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x24cdac4 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x24cdaf4 size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x24cdb28 size 0x138 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method get_IsAlive addr 0x24cdc60 size 0x20 virtual true final false
 bool get_IsAlive() ;

/// @brief Method get_Target addr 0x24cdc80 size 0x34 virtual true final false
 ::bs_hook::Il2CppWrapperType get_Target() ;

/// @brief Method set_Target addr 0x24cdcb4 size 0xc virtual true final false
 void set_Target(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_TrackResurrection addr 0x24cdcc0 size 0x8 virtual true final false
 bool get_TrackResurrection() ;

/// @brief Method Finalize addr 0x24cdcc8 size 0x9c virtual true final false
 void Finalize() ;

/// @brief Method GetObjectData addr 0x24cdd64 size 0x184 virtual true final false
