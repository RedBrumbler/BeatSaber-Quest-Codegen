...
/// @brief Method StringToLong addr 0x2482e68 size 0x18 virtual false final false
static int64_t StringToLong(System::ReadOnlySpan_1<char16_t> s, int32_t radix, int32_t flags) ;

/// @brief Method StringToLong addr 0x2482e80 size 0x370 virtual false final false
static int64_t StringToLong(System::ReadOnlySpan_1<char16_t> s, int32_t radix, int32_t flags, ByRef<int32_t> currPos) ;

/// @brief Method StringToInt addr 0x24834a4 size 0x18 virtual false final false
static int32_t StringToInt(System::ReadOnlySpan_1<char16_t> s, int32_t radix, int32_t flags) ;

/// @brief Method StringToInt addr 0x24834bc size 0x3cc virtual false final false
static int32_t StringToInt(System::ReadOnlySpan_1<char16_t> s, int32_t radix, int32_t flags, ByRef<int32_t> currPos) ;

/// @brief Method IntToString addr 0x2483aac size 0x380 virtual false final false
static ::StringW IntToString(int32_t n, int32_t radix, int32_t width, char16_t paddingChar, int32_t flags) ;

/// @brief Method LongToString addr 0x2483e2c size 0x3fc virtual false final false
static ::StringW LongToString(int64_t n, int32_t radix, int32_t width, char16_t paddingChar, int32_t flags) ;

/// @brief Method EatWhiteSpace addr 0x24831f0 size 0xc4 virtual false final false
static void EatWhiteSpace(System::ReadOnlySpan_1<char16_t> s, ByRef<int32_t> i) ;

/// @brief Method GrabLongs addr 0x24832b4 size 0x1f0 virtual false final false
static int64_t GrabLongs(int32_t radix, System::ReadOnlySpan_1<char16_t> s, ByRef<int32_t> i, bool isUnsigned) ;

/// @brief Method GrabInts addr 0x2483888 size 0x224 virtual false final false
static int32_t GrabInts(int32_t radix, System::ReadOnlySpan_1<char16_t> s, ByRef<int32_t> i, bool isUnsigned) ;

/// @brief Method ThrowOverflowInt32Exception addr 0x24842c0 size 0x4c virtual false final false
static void ThrowOverflowInt32Exception() ;

/// @brief Method ThrowOverflowInt64Exception addr 0x2484228 size 0x4c virtual false final false
static void ThrowOverflowInt64Exception() ;

/// @brief Method ThrowOverflowUInt32Exception addr 0x248430c size 0x4c virtual false final false
static void ThrowOverflowUInt32Exception() ;

/// @brief Method ThrowOverflowUInt64Exception addr 0x2484274 size 0x4c virtual false final false
static void ThrowOverflowUInt64Exception() ;

/// @brief Method IsDigit addr 0x2484358 size 0x54 virtual false final false
