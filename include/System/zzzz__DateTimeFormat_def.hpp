...
/// @brief Method ParseQuoteString addr 0x245c8a4 size 0x1b0 virtual false final false
static int32_t ParseQuoteString(System::ReadOnlySpan_1<char16_t> format, int32_t pos, System::Text::StringBuilder result) ;

/// @brief Method ParseNextChar addr 0x245ca54 size 0x70 virtual false final false
static int32_t ParseNextChar(System::ReadOnlySpan_1<char16_t> format, int32_t pos) ;

/// @brief Method IsUseGenitiveForm addr 0x245cac4 size 0x14c virtual false final false
...
/// @brief Method FormatCustomized addr 0x245cc10 size 0x10cc virtual false final false
...
/// @brief Method FormatCustomizedTimeZone addr 0x245dcdc size 0x31c virtual false final false
...
/// @brief Method FormatCustomizedRoundripTimeZone addr 0x245dff8 size 0x1fc virtual false final false
...
/// @brief Method Append2DigitNumber addr 0x245e1f4 size 0x5c virtual false final false
static void Append2DigitNumber(System::Text::StringBuilder result, int32_t val) ;

/// @brief Method GetRealFormat addr 0x245e250 size 0x2a8 virtual false final false
static ::StringW GetRealFormat(System::ReadOnlySpan_1<char16_t> format, System::Globalization::DateTimeFormatInfo dtfi) ;

/// @brief Method ExpandPredefinedFormat addr 0x245e4f8 size 0x370 virtual false final false
...
/// @brief Method Format addr 0x24562c4 size 0x78 virtual false final false
static ::StringW Format(System::DateTime dateTime, ::StringW format, System::IFormatProvider provider) ;

/// @brief Method Format addr 0x245936c size 0x2d0 virtual false final false
static ::StringW Format(System::DateTime dateTime, ::StringW format, System::IFormatProvider provider, System::TimeSpan offset) ;

/// @brief Method TryFormat addr 0x2456524 size 0xb8 virtual false final false
...
/// @brief Method TryFormat addr 0x245985c size 0x210 virtual false final false
...
/// @brief Method FormatStringBuilder addr 0x245f18c size 0x30c virtual false final false
...
/// @brief Method TryFormatO addr 0x245e86c size 0x508 virtual false final false
...
/// @brief Method TryFormatR addr 0x245ed74 size 0x418 virtual false final false
...
/// @brief Method WriteTwoDecimalDigits addr 0x245f498 size 0x4c virtual false final false
static void WriteTwoDecimalDigits(uint32_t value, System::Span_1<char16_t> destination, int32_t offset) ;

/// @brief Method WriteFourDecimalDigits addr 0x245f4e4 size 0xa0 virtual false final false
static void WriteFourDecimalDigits(uint32_t value, System::Span_1<char16_t> buffer, int32_t startingIndex) ;

/// @brief Method WriteDigits addr 0x245f584 size 0xac virtual false final false
static void WriteDigits(uint64_t value, System::Span_1<char16_t> buffer) ;

/// @brief Method InvalidFormatForLocal addr 0x245e868 size 0x4 virtual false final false
