...
/// @brief Method System.IFormattable.ToString addr 0x245c240 size 0x14 virtual true final true
 ::StringW System_IFormattable_ToString(::StringW ignored, System::IFormatProvider formatProvider) ;

/// @brief Method ToString addr 0x245c254 size 0x68 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit FormattableString() ;

/// @brief Method .ctor addr 0x245c2bc size 0x8 virtual false final false
 void _ctor() ;
