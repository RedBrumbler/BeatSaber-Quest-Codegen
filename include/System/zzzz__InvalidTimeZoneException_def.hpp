...
/// @brief Method .ctor addr 0x247362c size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit InvalidTimeZoneException(::StringW message) ;

/// @brief Method .ctor addr 0x2473684 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x24736ec size 0x80 virtual false final false
