...
/// @brief Method .ctor addr 0x249c638 size 0x70 virtual false final false
 void _ctor(System::LocalDataStoreMgr mgr, int32_t InitialCapacity) ;

/// @brief Method Dispose addr 0x249c5d4 size 0x1c virtual false final false
 void Dispose() ;

/// @brief Method GetData addr 0x249c7ac size 0xd8 virtual false final false
 ::bs_hook::Il2CppWrapperType GetData(System::LocalDataStoreSlot slot) ;

/// @brief Method SetData addr 0x249c900 size 0xe4 virtual false final false
 void SetData(System::LocalDataStoreSlot slot, ::bs_hook::Il2CppWrapperType data) ;

/// @brief Method FreeData addr 0x249cc90 size 0x48 virtual false final false
 void FreeData(int32_t slot, int64_t cookie) ;

/// @brief Method PopulateElement addr 0x249c9e4 size 0x2ac virtual false final false
