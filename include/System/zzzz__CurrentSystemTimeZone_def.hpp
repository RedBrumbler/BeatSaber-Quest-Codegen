...
/// @brief Method .ctor addr 0x24528b8 size 0xc4 virtual false final false
 void _ctor() ;

/// @brief Method GetDaylightChanges addr 0x245297c size 0xd0 virtual true final false
 System::Globalization::DaylightTime GetDaylightChanges(int32_t year) ;

/// @brief Method CreateDaylightChanges addr 0x2452c38 size 0x284 virtual false final false
static System::Globalization::DaylightTime CreateDaylightChanges(int32_t year) ;

/// @brief Method GetUtcOffset addr 0x2452ec4 size 0xb4 virtual true final false
 System::TimeSpan GetUtcOffset(System::DateTime time) ;

/// @brief Method GetTimeZoneData addr 0x2452fa0 size 0x4 virtual false final false
...
/// @brief Method GetCachedDaylightChanges addr 0x2452a4c size 0x1ec virtual false final false
