...
/// @brief Method .ctor addr 0x24967d4 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit OutOfMemoryException(::StringW message) ;

/// @brief Method .ctor addr 0x249682c size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0x249684c size 0x4 virtual false final false
