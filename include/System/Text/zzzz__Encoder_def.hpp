...
/// @brief Method .ctor addr 0x24f62c4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_Fallback addr 0x24f62cc size 0x8 virtual false final false
 System::Text::EncoderFallback get_Fallback() ;

/// @brief Method get_FallbackBuffer addr 0x24f2c28 size 0x3c virtual false final false
 System::Text::EncoderFallbackBuffer get_FallbackBuffer() ;

/// @brief Method get_InternalHasFallbackBuffer addr 0x24f2c18 size 0x10 virtual false final false
 bool get_InternalHasFallbackBuffer() ;

/// @brief Method Reset addr 0x24f62d4 size 0xe4 virtual true final false
 void Reset() ;
...
/// @brief Method GetByteCount addr 0x24f63b8 size 0x16c virtual true final false
...
/// @brief Method GetBytes addr 0x24f6524 size 0x218 virtual true final false
 int32_t GetBytes(void* chars, int32_t charCount, void* bytes, int32_t byteCount, bool flush) ;

/// @brief Method Convert addr 0x24f673c size 0x2f8 virtual true final false
...
/// @brief Method Convert addr 0x24f6a34 size 0x22c virtual true final false
