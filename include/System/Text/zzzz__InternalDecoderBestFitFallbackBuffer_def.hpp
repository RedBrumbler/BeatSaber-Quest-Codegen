...
/// @brief Method get_InternalSyncObject addr 0x24f464c size 0x9c virtual false final false
...
/// @brief Method .ctor addr 0x24f4450 size 0x128 virtual false final false
 void _ctor(System::Text::InternalDecoderBestFitFallback fallback) ;

/// @brief Method Fallback addr 0x24f46f0 size 0x40 virtual true final false
 bool Fallback(::ArrayW<uint8_t> bytesUnknown, int32_t index) ;

/// @brief Method GetNextChar addr 0x24f4870 size 0x40 virtual true final false
 char16_t GetNextChar() ;

/// @brief Method get_Remaining addr 0x24f48b0 size 0xc virtual true final false
 int32_t get_Remaining() ;

/// @brief Method Reset addr 0x24f48bc size 0x10 virtual true final false
 void Reset() ;

/// @brief Method InternalFallback addr 0x24f48cc size 0x8 virtual true final false
 int32_t InternalFallback(::ArrayW<uint8_t> bytes, void* pBytes) ;

/// @brief Method TryBestFit addr 0x24f4730 size 0x140 virtual false final false
