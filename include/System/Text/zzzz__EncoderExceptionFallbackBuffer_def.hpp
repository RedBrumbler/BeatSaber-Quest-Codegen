...
/// @brief Method .ctor addr 0x24f7380 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Fallback addr 0x24f73f4 size 0xb4 virtual true final false
 bool Fallback(char16_t charUnknown, int32_t index) ;

/// @brief Method Fallback addr 0x24f74d8 size 0x260 virtual true final false
 bool Fallback(char16_t charUnknownHigh, char16_t charUnknownLow, int32_t index) ;

/// @brief Method GetNextChar addr 0x24f7930 size 0x8 virtual true final false
 char16_t GetNextChar() ;

/// @brief Method MovePrevious addr 0x24f7938 size 0x8 virtual true final false
 bool MovePrevious() ;

/// @brief Method get_Remaining addr 0x24f7940 size 0x8 virtual true final false
