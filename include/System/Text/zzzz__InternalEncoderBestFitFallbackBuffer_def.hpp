...
/// @brief Method get_InternalSyncObject addr 0x24f6f08 size 0x9c virtual false final false
...
/// @brief Method .ctor addr 0x24f6cf0 size 0x128 virtual false final false
 void _ctor(System::Text::InternalEncoderBestFitFallback fallback) ;

/// @brief Method Fallback addr 0x24f6fac size 0x30 virtual true final false
 bool Fallback(char16_t charUnknown, int32_t index) ;

/// @brief Method Fallback addr 0x24f70b0 size 0x1e0 virtual true final false
 bool Fallback(char16_t charUnknownHigh, char16_t charUnknownLow, int32_t index) ;

/// @brief Method GetNextChar addr 0x24f7290 size 0x40 virtual true final false
 char16_t GetNextChar() ;

/// @brief Method MovePrevious addr 0x24f72d0 size 0x2c virtual true final false
 bool MovePrevious() ;

/// @brief Method get_Remaining addr 0x24f72fc size 0xc virtual true final false
 int32_t get_Remaining() ;

/// @brief Method Reset addr 0x24f7308 size 0x14 virtual true final false
 void Reset() ;

/// @brief Method TryBestFit addr 0x24f6fdc size 0xd4 virtual false final false
