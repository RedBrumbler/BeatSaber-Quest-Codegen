...
/// @brief Method .ctor addr 0x24f6c60 size 0x28 virtual false final false
 void _ctor(System::Text::Encoding encoding) ;

/// @brief Method CreateFallbackBuffer addr 0x24f6c90 size 0x60 virtual true final false
 System::Text::EncoderFallbackBuffer CreateFallbackBuffer() ;

/// @brief Method get_MaxCharCount addr 0x24f6e18 size 0x8 virtual true final false
 int32_t get_MaxCharCount() ;

/// @brief Method Equals addr 0x24f6e20 size 0xc4 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetHashCode addr 0x24f6ee4 size 0x24 virtual true final false
 int32_t GetHashCode() ;
