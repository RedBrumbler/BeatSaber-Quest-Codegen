...
/// @brief Method Acquire addr 0x2308fe4 size 0xd0 virtual false final false
static System::Text::StringBuilder Acquire(int32_t capacity) ;

/// @brief Method Release addr 0x23090b4 size 0x80 virtual false final false
static void Release(System::Text::StringBuilder sb) ;

/// @brief Method GetStringAndRelease addr 0x2309134 size 0x3c virtual false final false
