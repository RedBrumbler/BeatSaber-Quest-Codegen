...
/// @brief Method .ctor addr 0x26e6a50 size 0x10 virtual false final false
 void _ctor(System::Span_1<char16_t> initialBuffer) ;

/// @brief Method get_Length addr 0x26eb758 size 0x8 virtual false final false
 int32_t get_Length() ;

/// @brief Method ToString addr 0x26e6ebc size 0x198 virtual true final false
 ::StringW ToString() ;

/// @brief Method TryCopyTo addr 0x26e6c30 size 0x28c virtual false final false
 bool TryCopyTo(System::Span_1<char16_t> destination, ByRef<int32_t> charsWritten) ;

/// @brief Method Insert addr 0x26e6a60 size 0x1d0 virtual false final false
 void Insert(int32_t index, char16_t value, int32_t count) ;

/// @brief Method Append addr 0x26eb9a4 size 0x7c virtual false final false
 void Append(char16_t c) ;

/// @brief Method Append addr 0x26ebaa0 size 0xac virtual false final false
 void Append(::StringW s) ;

/// @brief Method AppendSlow addr 0x26ebb4c size 0x130 virtual false final false
 void AppendSlow(::StringW s) ;

/// @brief Method Append addr 0x26ea700 size 0xdc virtual false final false
 void Append(char16_t c, int32_t count) ;

/// @brief Method Append addr 0x26ea620 size 0xe0 virtual false final false
 void Append(void* value, int32_t length) ;

/// @brief Method AppendSpan addr 0x26ebc7c size 0xc0 virtual false final false
 System::Span_1<char16_t> AppendSpan(int32_t length) ;

/// @brief Method GrowAndAppend addr 0x26eba20 size 0x80 virtual false final false
 void GrowAndAppend(char16_t c) ;

/// @brief Method Grow addr 0x26eb760 size 0x244 virtual false final false
 void Grow(int32_t requiredAdditionalCapacity) ;

/// @brief Method Dispose addr 0x26ebd3c size 0xf8 virtual false final false
 void Dispose() ;
