...
/// @brief Method .ctor addr 0x24f1754 size 0xc virtual false final false
 void _ctor() ;

/// @brief Method SetDefaultFallbacks addr 0x24f1760 size 0x20 virtual true final false
 void SetDefaultFallbacks() ;

/// @brief Method GetByteCount addr 0x24f18b8 size 0x184 virtual true final false
 int32_t GetByteCount(::ArrayW<char16_t> chars, int32_t index, int32_t count) ;

/// @brief Method GetByteCount addr 0x24f1a3c size 0x90 virtual true final false
 int32_t GetByteCount(::StringW chars) ;

/// @brief Method GetByteCount addr 0x24f1acc size 0xd8 virtual true final false
 int32_t GetByteCount(void* chars, int32_t count) ;

/// @brief Method GetBytes addr 0x24f1ba4 size 0x260 virtual true final false
 int32_t GetBytes(::StringW chars, int32_t charIndex, int32_t charCount, ::ArrayW<uint8_t> bytes, int32_t byteIndex) ;

/// @brief Method GetBytes addr 0x24f1e04 size 0x27c virtual true final false
 int32_t GetBytes(::ArrayW<char16_t> chars, int32_t charIndex, int32_t charCount, ::ArrayW<uint8_t> bytes, int32_t byteIndex) ;

/// @brief Method GetBytes addr 0x24f2080 size 0x100 virtual true final false
 int32_t GetBytes(void* chars, int32_t charCount, void* bytes, int32_t byteCount) ;

/// @brief Method GetCharCount addr 0x24f2180 size 0x184 virtual true final false
 int32_t GetCharCount(::ArrayW<uint8_t> bytes, int32_t index, int32_t count) ;

/// @brief Method GetCharCount addr 0x24f2304 size 0xd8 virtual true final false
 int32_t GetCharCount(void* bytes, int32_t count) ;

/// @brief Method GetChars addr 0x24f23dc size 0x27c virtual true final false
 int32_t GetChars(::ArrayW<uint8_t> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t> chars, int32_t charIndex) ;

/// @brief Method GetChars addr 0x24f2658 size 0x100 virtual true final false
 int32_t GetChars(void* bytes, int32_t byteCount, void* chars, int32_t charCount) ;

/// @brief Method GetString addr 0x24f2758 size 0x1c8 virtual true final false
 ::StringW GetString(::ArrayW<uint8_t> bytes, int32_t byteIndex, int32_t byteCount) ;

/// @brief Method GetByteCount addr 0x24f2920 size 0x2f8 virtual true final false
 int32_t GetByteCount(void* chars, int32_t charCount, System::Text::EncoderNLS encoder) ;

/// @brief Method GetBytes addr 0x24f2cb4 size 0x42c virtual true final false
 int32_t GetBytes(void* chars, int32_t charCount, void* bytes, int32_t byteCount, System::Text::EncoderNLS encoder) ;

/// @brief Method GetCharCount addr 0x24f30e0 size 0x150 virtual true final false
 int32_t GetCharCount(void* bytes, int32_t count, System::Text::DecoderNLS decoder) ;

/// @brief Method GetChars addr 0x24f3274 size 0x288 virtual true final false
 int32_t GetChars(void* bytes, int32_t byteCount, void* chars, int32_t charCount, System::Text::DecoderNLS decoder) ;

/// @brief Method GetMaxByteCount addr 0x24f350c size 0x108 virtual true final false
 int32_t GetMaxByteCount(int32_t charCount) ;

/// @brief Method GetMaxCharCount addr 0x24f3614 size 0x104 virtual true final false
 int32_t GetMaxCharCount(int32_t byteCount) ;

/// @brief Method GetDecoder addr 0x24f3718 size 0x60 virtual true final false
 System::Text::Decoder GetDecoder() ;

/// @brief Method GetEncoder addr 0x24f37bc size 0x60 virtual true final false
...
/// @brief Method .ctor addr 0x24f38d4 size 0x5c virtual false final false
 void _ctor() ;
