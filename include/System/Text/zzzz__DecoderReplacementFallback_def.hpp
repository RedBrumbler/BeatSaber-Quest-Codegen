...
/// @brief Method .ctor addr 0x24f4c2c size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x24f5f38 size 0x104 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x24f603c size 0x5c virtual true final true
...
/// @brief Method .ctor addr 0x24f5d90 size 0x1a8 virtual false final false
 void _ctor(::StringW replacement) ;

/// @brief Method get_DefaultString addr 0x24f6098 size 0x8 virtual false final false
 ::StringW get_DefaultString() ;

/// @brief Method CreateFallbackBuffer addr 0x24f60a0 size 0x60 virtual true final false
 System::Text::DecoderFallbackBuffer CreateFallbackBuffer() ;

/// @brief Method get_MaxCharCount addr 0x24f613c size 0x1c virtual true final false
 int32_t get_MaxCharCount() ;

/// @brief Method Equals addr 0x24f6158 size 0x80 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetHashCode addr 0x24f61d8 size 0x20 virtual true final false
 int32_t GetHashCode() ;
