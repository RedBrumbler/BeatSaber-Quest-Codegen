...
/// @brief Method .ctor addr 0x230d580 size 0x8 virtual false final false
 void _ctor(System::Text::UTF7Encoding encoding) ;

/// @brief Method Reset addr 0x230d7a4 size 0x28 virtual true final false
 void Reset() ;

/// @brief Method get_HasState addr 0x230d7cc size 0x10 virtual true final false
 bool get_HasState() ;
...
/// @brief Method .ctor addr 0x230d5ec size 0x8 virtual false final false
 void _ctor(System::Text::UTF7Encoding encoding) ;

/// @brief Method Reset addr 0x230d7dc size 0x24 virtual true final false
 void Reset() ;

/// @brief Method get_HasState addr 0x230d800 size 0x20 virtual true final false
 bool get_HasState() ;
...
/// @brief Method .ctor addr 0x230bd00 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method CreateFallbackBuffer addr 0x230d820 size 0x64 virtual true final false
 System::Text::DecoderFallbackBuffer CreateFallbackBuffer() ;

/// @brief Method get_MaxCharCount addr 0x230d894 size 0x8 virtual true final false
 int32_t get_MaxCharCount() ;

/// @brief Method Equals addr 0x230d89c size 0x5c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetHashCode addr 0x230d8f8 size 0x8 virtual true final false
 int32_t GetHashCode() ;
...
/// @brief Method .ctor addr 0x230d884 size 0x10 virtual false final false
 void _ctor(System::Text::System__Text__UTF7Encoding__DecoderUTF7Fallback fallback) ;

/// @brief Method Fallback addr 0x230d900 size 0x40 virtual true final false
 bool Fallback(::ArrayW<uint8_t> bytesUnknown, int32_t index) ;

/// @brief Method GetNextChar addr 0x230d940 size 0x20 virtual true final false
 char16_t GetNextChar() ;

/// @brief Method get_Remaining addr 0x230d960 size 0xc virtual true final false
 int32_t get_Remaining() ;

/// @brief Method Reset addr 0x230d96c size 0x10 virtual true final false
 void Reset() ;

/// @brief Method InternalFallback addr 0x230d97c size 0x78 virtual true final false
...
/// @brief Method .ctor addr 0x230b970 size 0x24 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "allowOptionals", ty: "bool", modifiers: "", def_value: None }]
explicit UTF7Encoding(bool allowOptionals) ;

/// @brief Method .ctor addr 0x230b994 size 0x30 virtual false final false
 void _ctor(bool allowOptionals) ;

/// @brief Method MakeTables addr 0x230b9c4 size 0x284 virtual false final false
 void MakeTables() ;

/// @brief Method SetDefaultFallbacks addr 0x230bc48 size 0xb8 virtual true final false
 void SetDefaultFallbacks() ;

/// @brief Method Equals addr 0x230bd08 size 0xd0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetHashCode addr 0x230bdd8 size 0x6c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method GetByteCount addr 0x230be44 size 0x184 virtual true final false
 int32_t GetByteCount(::ArrayW<char16_t> chars, int32_t index, int32_t count) ;

/// @brief Method GetByteCount addr 0x230bfc8 size 0x90 virtual true final false
 int32_t GetByteCount(::StringW s) ;

/// @brief Method GetByteCount addr 0x230c058 size 0xd8 virtual true final false
 int32_t GetByteCount(void* chars, int32_t count) ;

/// @brief Method GetBytes addr 0x230c130 size 0x260 virtual true final false
 int32_t GetBytes(::StringW s, int32_t charIndex, int32_t charCount, ::ArrayW<uint8_t> bytes, int32_t byteIndex) ;

/// @brief Method GetBytes addr 0x230c390 size 0x27c virtual true final false
 int32_t GetBytes(::ArrayW<char16_t> chars, int32_t charIndex, int32_t charCount, ::ArrayW<uint8_t> bytes, int32_t byteIndex) ;

/// @brief Method GetBytes addr 0x230c60c size 0x100 virtual true final false
 int32_t GetBytes(void* chars, int32_t charCount, void* bytes, int32_t byteCount) ;

/// @brief Method GetCharCount addr 0x230c70c size 0x184 virtual true final false
 int32_t GetCharCount(::ArrayW<uint8_t> bytes, int32_t index, int32_t count) ;

/// @brief Method GetCharCount addr 0x230c890 size 0xd8 virtual true final false
 int32_t GetCharCount(void* bytes, int32_t count) ;

/// @brief Method GetChars addr 0x230c968 size 0x27c virtual true final false
 int32_t GetChars(::ArrayW<uint8_t> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t> chars, int32_t charIndex) ;

/// @brief Method GetChars addr 0x230cbe4 size 0x100 virtual true final false
 int32_t GetChars(void* bytes, int32_t byteCount, void* chars, int32_t charCount) ;

/// @brief Method GetString addr 0x230cce4 size 0x1c8 virtual true final false
 ::StringW GetString(::ArrayW<uint8_t> bytes, int32_t index, int32_t count) ;

/// @brief Method GetByteCount addr 0x230ceac size 0x1c virtual true final false
 int32_t GetByteCount(void* chars, int32_t count, System::Text::EncoderNLS baseEncoder) ;

/// @brief Method GetBytes addr 0x230cec8 size 0x39c virtual true final false
 int32_t GetBytes(void* chars, int32_t charCount, void* bytes, int32_t byteCount, System::Text::EncoderNLS baseEncoder) ;

/// @brief Method GetCharCount addr 0x230d264 size 0x1c virtual true final false
 int32_t GetCharCount(void* bytes, int32_t count, System::Text::DecoderNLS baseDecoder) ;

/// @brief Method GetChars addr 0x230d280 size 0x29c virtual true final false
 int32_t GetChars(void* bytes, int32_t byteCount, void* chars, int32_t charCount, System::Text::DecoderNLS baseDecoder) ;

/// @brief Method GetDecoder addr 0x230d51c size 0x64 virtual true final false
 System::Text::Decoder GetDecoder() ;

/// @brief Method GetEncoder addr 0x230d588 size 0x64 virtual true final false
 System::Text::Encoder GetEncoder() ;

/// @brief Method GetMaxByteCount addr 0x230d5f4 size 0xc4 virtual true final false
 int32_t GetMaxByteCount(int32_t charCount) ;

/// @brief Method GetMaxCharCount addr 0x230d6b8 size 0x78 virtual true final false
