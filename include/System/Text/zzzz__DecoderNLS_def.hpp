...
/// @brief Method .ctor addr 0x24f3778 size 0x44 virtual false final false
 void _ctor(System::Text::Encoding encoding) ;

/// @brief Method Reset addr 0x24f523c size 0x18 virtual true final false
 void Reset() ;

/// @brief Method GetCharCount addr 0x24f5254 size 0x10 virtual true final false
 int32_t GetCharCount(::ArrayW<uint8_t> bytes, int32_t index, int32_t count) ;

/// @brief Method GetCharCount addr 0x24f5264 size 0x1d8 virtual true final false
 int32_t GetCharCount(::ArrayW<uint8_t> bytes, int32_t index, int32_t count, bool flush) ;

/// @brief Method GetCharCount addr 0x24f543c size 0xf8 virtual true final false
 int32_t GetCharCount(void* bytes, int32_t count, bool flush) ;

/// @brief Method GetChars addr 0x24f5534 size 0x10 virtual true final false
 int32_t GetChars(::ArrayW<uint8_t> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t> chars, int32_t charIndex) ;

/// @brief Method GetChars addr 0x24f5544 size 0x298 virtual true final false
...
/// @brief Method GetChars addr 0x24f57dc size 0x120 virtual true final false
 int32_t GetChars(void* bytes, int32_t byteCount, void* chars, int32_t charCount, bool flush) ;

/// @brief Method Convert addr 0x24f58fc size 0x2d0 virtual true final false
...
/// @brief Method Convert addr 0x24f5bcc size 0x1ac virtual true final false
...
/// @brief Method get_MustFlush addr 0x24f5d78 size 0x8 virtual false final false
 bool get_MustFlush() ;

/// @brief Method get_HasState addr 0x24f5d80 size 0x8 virtual true final false
 bool get_HasState() ;

/// @brief Method ClearMustFlush addr 0x24f5d88 size 0x8 virtual false final false
 void ClearMustFlush() ;
