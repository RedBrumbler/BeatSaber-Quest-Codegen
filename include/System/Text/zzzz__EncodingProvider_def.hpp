...
/// @brief Method GetEncoding addr 0x2303fac size 0xfc virtual true final false
...
/// @brief Method GetEncodingFromProvider addr 0x23040a8 size 0xdc virtual false final false
static System::Text::Encoding GetEncodingFromProvider(int32_t codepage) ;

/// @brief Method GetEncodingFromProvider addr 0x2304184 size 0xdc virtual false final false
static System::Text::Encoding GetEncodingFromProvider(::StringW encodingName) ;

/// @brief Method GetEncodingFromProvider addr 0x2304260 size 0xf4 virtual false final false
