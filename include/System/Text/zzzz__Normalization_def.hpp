...
/// @brief Method PropValue addr 0x231b3f0 size 0x94 virtual false final false
static uint32_t PropValue(int32_t cp) ;

/// @brief Method CharMapIdx addr 0x231b484 size 0x94 virtual false final false
static int32_t CharMapIdx(int32_t cp) ;

/// @brief Method GetCombiningClass addr 0x231b518 size 0xa8 virtual false final false
static uint8_t GetCombiningClass(int32_t c) ;

/// @brief Method GetPrimaryCompositeFromMapIndex addr 0x231b5c0 size 0xa8 virtual false final false
static int32_t GetPrimaryCompositeFromMapIndex(int32_t src) ;

/// @brief Method GetPrimaryCompositeHelperIndex addr 0x231b668 size 0xa8 virtual false final false
static int32_t GetPrimaryCompositeHelperIndex(int32_t cp) ;

/// @brief Method Compose addr 0x231b710 size 0xe0 virtual false final false
static ::StringW Compose(::StringW source, int32_t checkType) ;

/// @brief Method Combine addr 0x231b920 size 0x13c virtual false final false
static System::Text::StringBuilder Combine(::StringW source, int32_t start, int32_t checkType) ;

/// @brief Method Combine addr 0x231ba5c size 0x110 virtual false final false
static void Combine(System::Text::StringBuilder sb, int32_t i, int32_t checkType) ;

/// @brief Method CombineHangul addr 0x231bc88 size 0x1c4 virtual false final false
static int32_t CombineHangul(System::Text::StringBuilder sb, ::StringW s, int32_t current) ;

/// @brief Method Fetch addr 0x231c080 size 0x3c virtual false final false
static int32_t Fetch(System::Text::StringBuilder sb, ::StringW s, int32_t i) ;

/// @brief Method TryComposeWithPreviousStarter addr 0x231be4c size 0x234 virtual false final false
static int32_t TryComposeWithPreviousStarter(System::Text::StringBuilder sb, ::StringW s, int32_t current) ;

/// @brief Method TryCompose addr 0x231c0bc size 0x118 virtual false final false
static int32_t TryCompose(int32_t i, int32_t starter, int32_t candidate) ;

/// @brief Method Decompose addr 0x231c1d4 size 0x8c virtual false final false
static ::StringW Decompose(::StringW source, int32_t checkType) ;

/// @brief Method Decompose addr 0x231b7f0 size 0x130 virtual false final false
static void Decompose(::StringW source, ByRef<System::Text::StringBuilder> sb, int32_t checkType) ;

/// @brief Method ReorderCanonical addr 0x231c438 size 0x270 virtual false final false
static void ReorderCanonical(::StringW src, ByRef<System::Text::StringBuilder> sb, int32_t start) ;

/// @brief Method DecomposeChar addr 0x231c260 size 0x1d8 virtual false final false
...
/// @brief Method QuickCheck addr 0x231bb6c size 0x11c virtual false final false
static System::Text::NormalizationCheck QuickCheck(char16_t c, int32_t type) ;

/// @brief Method GetCanonicalHangul addr 0x231c860 size 0xec virtual false final false
static int32_t GetCanonicalHangul(int32_t s, ::ArrayW<int32_t> buf, int32_t bufIdx) ;

/// @brief Method GetCanonical addr 0x231c6a8 size 0x1b8 virtual false final false
static int32_t GetCanonical(int32_t c, ::ArrayW<int32_t> buf, int32_t bufIdx, int32_t checkType) ;

/// @brief Method Normalize addr 0x231c94c size 0xbc virtual false final false
static ::StringW Normalize(::StringW source, System::Text::NormalizationForm normalizationForm) ;

/// @brief Method Normalize addr 0x231ca08 size 0x98 virtual false final false
static ::StringW Normalize(::StringW source, int32_t type) ;

/// @brief Method load_normalization_resource addr 0x231caa0 size 0x4 virtual false final false
