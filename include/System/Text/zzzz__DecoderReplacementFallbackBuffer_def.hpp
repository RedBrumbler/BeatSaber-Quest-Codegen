...
/// @brief Method .ctor addr 0x24f6100 size 0x3c virtual false final false
 void _ctor(System::Text::DecoderReplacementFallback fallback) ;

/// @brief Method Fallback addr 0x24f61f8 size 0x44 virtual true final false
 bool Fallback(::ArrayW<uint8_t> bytesUnknown, int32_t index) ;

/// @brief Method GetNextChar addr 0x24f623c size 0x50 virtual true final false
 char16_t GetNextChar() ;

/// @brief Method get_Remaining addr 0x24f628c size 0xc virtual true final false
 int32_t get_Remaining() ;

/// @brief Method Reset addr 0x24f6298 size 0x10 virtual true final false
 void Reset() ;

/// @brief Method InternalFallback addr 0x24f62a8 size 0x1c virtual true final false
