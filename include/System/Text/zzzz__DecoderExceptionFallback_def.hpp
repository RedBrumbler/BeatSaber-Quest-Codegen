...
/// @brief Method .ctor addr 0x24f48d4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method CreateFallbackBuffer addr 0x24f48dc size 0x5c virtual true final false
 System::Text::DecoderFallbackBuffer CreateFallbackBuffer() ;

/// @brief Method get_MaxCharCount addr 0x24f4940 size 0x8 virtual true final false
 int32_t get_MaxCharCount() ;

/// @brief Method Equals addr 0x24f4948 size 0x5c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetHashCode addr 0x24f49a4 size 0x8 virtual true final false
 int32_t GetHashCode() ;
