...
/// @brief Method .ctor addr 0x230d9f4 size 0x20 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x230da14 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x230da44 size 0x60 virtual false final false
 void _ctor(bool encoderShouldEmitUTF8Identifier, bool throwOnInvalidBytes) ;

/// @brief Method SetDefaultFallbacks addr 0x230daa4 size 0xd4 virtual true final false
 void SetDefaultFallbacks() ;

/// @brief Method GetByteCount addr 0x230db78 size 0x184 virtual true final false
 int32_t GetByteCount(::ArrayW<char16_t> chars, int32_t index, int32_t count) ;

/// @brief Method GetByteCount addr 0x230dcfc size 0x90 virtual true final false
 int32_t GetByteCount(::StringW chars) ;

/// @brief Method GetByteCount addr 0x230dd8c size 0xd8 virtual true final false
 int32_t GetByteCount(void* chars, int32_t count) ;

/// @brief Method GetBytes addr 0x230de64 size 0x260 virtual true final false
 int32_t GetBytes(::StringW s, int32_t charIndex, int32_t charCount, ::ArrayW<uint8_t> bytes, int32_t byteIndex) ;

/// @brief Method GetBytes addr 0x230e0c4 size 0x27c virtual true final false
 int32_t GetBytes(::ArrayW<char16_t> chars, int32_t charIndex, int32_t charCount, ::ArrayW<uint8_t> bytes, int32_t byteIndex) ;

/// @brief Method GetBytes addr 0x230e340 size 0x100 virtual true final false
 int32_t GetBytes(void* chars, int32_t charCount, void* bytes, int32_t byteCount) ;

/// @brief Method GetCharCount addr 0x230e440 size 0x184 virtual true final false
 int32_t GetCharCount(::ArrayW<uint8_t> bytes, int32_t index, int32_t count) ;

/// @brief Method GetCharCount addr 0x230e5c4 size 0xd8 virtual true final false
 int32_t GetCharCount(void* bytes, int32_t count) ;

/// @brief Method GetChars addr 0x230e69c size 0x27c virtual true final false
 int32_t GetChars(::ArrayW<uint8_t> bytes, int32_t byteIndex, int32_t byteCount, ::ArrayW<char16_t> chars, int32_t charIndex) ;

/// @brief Method GetChars addr 0x230e918 size 0x100 virtual true final false
 int32_t GetChars(void* bytes, int32_t byteCount, void* chars, int32_t charCount) ;

/// @brief Method GetString addr 0x230ea18 size 0x1c8 virtual true final false
 ::StringW GetString(::ArrayW<uint8_t> bytes, int32_t index, int32_t count) ;

/// @brief Method GetByteCount addr 0x230ebe0 size 0x60c virtual true final false
 int32_t GetByteCount(void* chars, int32_t count, System::Text::EncoderNLS baseEncoder) ;

/// @brief Method PtrDiff addr 0x230f200 size 0xc virtual false final false
static int32_t PtrDiff(void* a, void* b) ;

/// @brief Method PtrDiff addr 0x230f20c size 0x8 virtual false final false
static int32_t PtrDiff(void* a, void* b) ;

/// @brief Method InRange addr 0x230f1ec size 0x14 virtual false final false
static bool InRange(int32_t ch, int32_t start, int32_t end) ;

/// @brief Method GetBytes addr 0x230f214 size 0x748 virtual true final false
 int32_t GetBytes(void* chars, int32_t charCount, void* bytes, int32_t byteCount, System::Text::EncoderNLS baseEncoder) ;

/// @brief Method GetCharCount addr 0x230f95c size 0x540 virtual true final false
 int32_t GetCharCount(void* bytes, int32_t count, System::Text::DecoderNLS baseDecoder) ;

/// @brief Method GetChars addr 0x230fedc size 0x784 virtual true final false
 int32_t GetChars(void* bytes, int32_t byteCount, void* chars, int32_t charCount, System::Text::DecoderNLS baseDecoder) ;

/// @brief Method FallbackInvalidByteSequence addr 0x2310660 size 0x74 virtual false final false
...
/// @brief Method FallbackInvalidByteSequence addr 0x230fe9c size 0x40 virtual false final false
 int32_t FallbackInvalidByteSequence(void* pSrc, int32_t ch, System::Text::DecoderFallbackBuffer fallback) ;

/// @brief Method GetBytesUnknown addr 0x23106d4 size 0x1f4 virtual false final false
 ::ArrayW<uint8_t> GetBytesUnknown(ByRef<void*> pSrc, int32_t ch) ;

/// @brief Method GetDecoder addr 0x23108c8 size 0x64 virtual true final false
 System::Text::Decoder GetDecoder() ;

/// @brief Method GetEncoder addr 0x2310934 size 0x64 virtual true final false
 System::Text::Encoder GetEncoder() ;

/// @brief Method GetMaxByteCount addr 0x23109a0 size 0x108 virtual true final false
 int32_t GetMaxByteCount(int32_t charCount) ;

/// @brief Method GetMaxCharCount addr 0x2310aa8 size 0x108 virtual true final false
 int32_t GetMaxCharCount(int32_t byteCount) ;

/// @brief Method GetPreamble addr 0x2310bb0 size 0xd4 virtual true final false
 ::ArrayW<uint8_t> GetPreamble() ;

/// @brief Method get_Preamble addr 0x2310c84 size 0x160 virtual true final false
 System::ReadOnlySpan_1<uint8_t> get_Preamble() ;

/// @brief Method Equals addr 0x2310de4 size 0xd0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetHashCode addr 0x2310eb4 size 0x60 virtual true final false
 int32_t GetHashCode() ;
...
/// @brief Method .ctor addr 0x2310fe4 size 0x78 virtual false final false
 void _ctor(bool encoderShouldEmitUTF8Identifier) ;

/// @brief Method get_Preamble addr 0x231105c size 0xd4 virtual true final false
 System::ReadOnlySpan_1<uint8_t> get_Preamble() ;
...
/// @brief Method .ctor addr 0x2310998 size 0x8 virtual false final false
 void _ctor(System::Text::UTF8Encoding encoding) ;

/// @brief Method Reset addr 0x2311130 size 0x20 virtual true final false
 void Reset() ;

/// @brief Method get_HasState addr 0x2311150 size 0x10 virtual true final false
 bool get_HasState() ;
...
/// @brief Method .ctor addr 0x231092c size 0x8 virtual false final false
 void _ctor(System::Text::UTF8Encoding encoding) ;

/// @brief Method Reset addr 0x2311160 size 0x20 virtual true final false
 void Reset() ;

/// @brief Method get_HasState addr 0x2311180 size 0x10 virtual true final false
 bool get_HasState() ;
