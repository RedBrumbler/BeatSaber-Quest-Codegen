...
/// @brief Method Reset addr 0x24f4d18 size 0x28 virtual true final false
 void Reset() ;

/// @brief Method InternalReset addr 0x24f34fc size 0x10 virtual false final false
 void InternalReset() ;

/// @brief Method InternalInitialize addr 0x24f326c size 0x8 virtual false final false
 void InternalInitialize(void* byteStart, void* charEnd) ;

/// @brief Method InternalFallback addr 0x24f4d40 size 0x190 virtual true final false
 bool InternalFallback(::ArrayW<uint8_t> bytes, void* pBytes, ByRef<void*> chars) ;

/// @brief Method InternalFallback addr 0x24f4ed0 size 0x170 virtual true final false
 int32_t InternalFallback(::ArrayW<uint8_t> bytes, void* pBytes) ;

/// @brief Method ThrowLastBytesRecursive addr 0x24f5040 size 0x1fc virtual false final false
 void ThrowLastBytesRecursive(::ArrayW<uint8_t> bytesUnknown) ;

// Ctor Parameters []
explicit DecoderFallbackBuffer() ;

/// @brief Method .ctor addr 0x24f46e8 size 0x8 virtual false final false
 void _ctor() ;
