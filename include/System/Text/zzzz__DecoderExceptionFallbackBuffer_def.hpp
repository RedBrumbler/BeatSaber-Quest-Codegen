...
/// @brief Method Fallback addr 0x24f49ac size 0x8 virtual true final false
 bool Fallback(::ArrayW<uint8_t> bytesUnknown, int32_t index) ;

/// @brief Method GetNextChar addr 0x24f4b88 size 0x8 virtual true final false
 char16_t GetNextChar() ;

/// @brief Method get_Remaining addr 0x24f4b90 size 0x8 virtual true final false
 int32_t get_Remaining() ;

/// @brief Method Throw addr 0x24f49b4 size 0x1d4 virtual false final false
 void Throw(::ArrayW<uint8_t> bytesUnknown, int32_t index) ;

// Ctor Parameters []
explicit DecoderExceptionFallbackBuffer() ;

/// @brief Method .ctor addr 0x24f4938 size 0x8 virtual false final false
 void _ctor() ;
