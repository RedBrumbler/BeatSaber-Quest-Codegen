...
/// @brief Method .ctor addr 0x24f43b8 size 0x30 virtual false final false
 void _ctor(System::Text::Encoding encoding) ;

/// @brief Method CreateFallbackBuffer addr 0x24f43f0 size 0x60 virtual true final false
 System::Text::DecoderFallbackBuffer CreateFallbackBuffer() ;

/// @brief Method get_MaxCharCount addr 0x24f4578 size 0x8 virtual true final false
 int32_t get_MaxCharCount() ;

/// @brief Method Equals addr 0x24f4580 size 0xa8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetHashCode addr 0x24f4628 size 0x24 virtual true final false
 int32_t GetHashCode() ;
