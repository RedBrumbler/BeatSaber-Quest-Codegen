...
/// @brief Method .ctor addr 0x23043cc size 0xc virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x23043d8 size 0x4c virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x2304424 size 0xe8 virtual true final true
 void System_Runtime_Serialization_ISerializable_GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method GetByteCount addr 0x230450c size 0x1fc virtual true final false
 int32_t GetByteCount(void* chars, int32_t charCount, System::Text::EncoderNLS encoder) ;

/// @brief Method GetBytes addr 0x2304708 size 0x354 virtual true final false
 int32_t GetBytes(void* chars, int32_t charCount, void* bytes, int32_t byteCount, System::Text::EncoderNLS encoder) ;

/// @brief Method GetCharCount addr 0x2304a5c size 0x8 virtual true final false
 int32_t GetCharCount(void* bytes, int32_t count, System::Text::DecoderNLS decoder) ;

/// @brief Method GetChars addr 0x2304a64 size 0x74 virtual true final false
 int32_t GetChars(void* bytes, int32_t byteCount, void* chars, int32_t charCount, System::Text::DecoderNLS decoder) ;

/// @brief Method GetMaxByteCount addr 0x2304ad8 size 0x108 virtual true final false
 int32_t GetMaxByteCount(int32_t charCount) ;

/// @brief Method GetMaxCharCount addr 0x2304be0 size 0x104 virtual true final false
 int32_t GetMaxCharCount(int32_t byteCount) ;

/// @brief Method GetBestFitUnicodeToBytesData addr 0x2304ce4 size 0x58 virtual true final false
