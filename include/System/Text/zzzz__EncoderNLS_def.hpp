...
/// @brief Method .ctor addr 0x24f381c size 0x44 virtual false final false
 void _ctor(System::Text::Encoding encoding) ;

/// @brief Method Reset addr 0x24f7cc4 size 0x20 virtual true final false
 void Reset() ;

/// @brief Method GetByteCount addr 0x24f7ce4 size 0x1d8 virtual true final false
 int32_t GetByteCount(::ArrayW<char16_t> chars, int32_t index, int32_t count, bool flush) ;

/// @brief Method GetByteCount addr 0x24f7ebc size 0xf8 virtual true final false
 int32_t GetByteCount(void* chars, int32_t count, bool flush) ;

/// @brief Method GetBytes addr 0x24f7fb4 size 0x298 virtual true final false
...
/// @brief Method GetBytes addr 0x24f824c size 0x120 virtual true final false
 int32_t GetBytes(void* chars, int32_t charCount, void* bytes, int32_t byteCount, bool flush) ;

/// @brief Method Convert addr 0x24f836c size 0x2cc virtual true final false
...
/// @brief Method Convert addr 0x24f8638 size 0x1a8 virtual true final false
...
/// @brief Method get_Encoding addr 0x24f87e0 size 0x8 virtual false final false
 System::Text::Encoding get_Encoding() ;

/// @brief Method get_MustFlush addr 0x24f87e8 size 0x8 virtual false final false
 bool get_MustFlush() ;

/// @brief Method get_HasState addr 0x24f87f0 size 0x10 virtual true final false
 bool get_HasState() ;

/// @brief Method ClearMustFlush addr 0x24f8800 size 0x8 virtual false final false
 void ClearMustFlush() ;
