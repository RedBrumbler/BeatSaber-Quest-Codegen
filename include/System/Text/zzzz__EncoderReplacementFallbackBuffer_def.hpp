...
/// @brief Method .ctor addr 0x2302958 size 0x48 virtual false final false
 void _ctor(System::Text::EncoderReplacementFallback fallback) ;

/// @brief Method Fallback addr 0x2302a5c size 0x150 virtual true final false
 bool Fallback(char16_t charUnknown, int32_t index) ;

/// @brief Method Fallback addr 0x2302bac size 0x228 virtual true final false
 bool Fallback(char16_t charUnknownHigh, char16_t charUnknownLow, int32_t index) ;

/// @brief Method GetNextChar addr 0x2302dd4 size 0x50 virtual true final false
 char16_t GetNextChar() ;

/// @brief Method MovePrevious addr 0x2302e24 size 0x30 virtual true final false
 bool MovePrevious() ;

/// @brief Method get_Remaining addr 0x2302e54 size 0xc virtual true final false
 int32_t get_Remaining() ;

/// @brief Method Reset addr 0x2302e60 size 0x14 virtual true final false
 void Reset() ;
