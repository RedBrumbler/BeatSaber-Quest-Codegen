...
/// @brief Method get_UTF8Unmarked addr 0x231cca4 size 0x1f0 virtual false final false
static System::Text::Encoding get_UTF8Unmarked() ;

/// @brief Method InternalCodePage addr 0x231ce94 size 0x4 virtual false final false
static ::StringW InternalCodePage(ByRef<int32_t> code_page) ;

/// @brief Method GetDefaultEncoding addr 0x2319b40 size 0x17c virtual false final false
static System::Text::Encoding GetDefaultEncoding() ;

/// @brief Method InvokeI18N addr 0x2317f90 size 0x70c virtual false final false
