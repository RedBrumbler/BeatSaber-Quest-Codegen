...
/// @brief Method Reset addr 0x24f7a4c size 0x28 virtual true final false
 void Reset() ;

/// @brief Method InternalReset addr 0x24f7a74 size 0x18 virtual false final false
 void InternalReset() ;

/// @brief Method InternalInitialize addr 0x24f2c64 size 0x1c virtual false final false
 void InternalInitialize(void* charStart, void* charEnd, System::Text::EncoderNLS encoder, bool setEncoder) ;

/// @brief Method InternalGetNextChar addr 0x24f2c80 size 0x34 virtual false final false
 char16_t InternalGetNextChar() ;

/// @brief Method InternalFallback addr 0x24f7a8c size 0x1a8 virtual true final false
 bool InternalFallback(char16_t ch, ByRef<void*> chars) ;

/// @brief Method ThrowLastCharRecursive addr 0x24f7c34 size 0x90 virtual false final false
 void ThrowLastCharRecursive(int32_t charRecursive) ;

// Ctor Parameters []
explicit EncoderFallbackBuffer() ;

/// @brief Method .ctor addr 0x24f6fa4 size 0x8 virtual false final false
 void _ctor() ;
