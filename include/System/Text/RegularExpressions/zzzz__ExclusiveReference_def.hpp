...
/// @brief Method Get addr 0x27eed20 size 0x58 virtual false final false
 System::Text::RegularExpressions::RegexRunner Get() ;

/// @brief Method Release addr 0x27eed78 size 0xbc virtual false final false
 void Release(System::Text::RegularExpressions::RegexRunner obj) ;

// Ctor Parameters []
explicit ExclusiveReference() ;

/// @brief Method .ctor addr 0x27eee34 size 0x8 virtual false final false
 void _ctor() ;
