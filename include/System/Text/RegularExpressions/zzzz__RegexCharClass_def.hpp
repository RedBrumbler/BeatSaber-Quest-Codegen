...
/// @brief Method .ctor addr 0x27fbb18 size 0x10 virtual false final false
...
/// @brief Method .ctor addr 0x27fbb28 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Compare addr 0x27fbb30 size 0x20 virtual true final true
...
/// @brief Method .ctor addr 0x27fbbb4 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x27f166c size 0xbc virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x27f1728 size 0x4c virtual false final false
...
/// @brief Method get_CanMerge addr 0x27f1774 size 0x20 virtual false final false
 bool get_CanMerge() ;

/// @brief Method set_Negate addr 0x27f1794 size 0xc virtual false final false
 void set_Negate(bool value) ;

/// @brief Method AddChar addr 0x27f17a0 size 0x8 virtual false final false
 void AddChar(char16_t c) ;

/// @brief Method AddCharClass addr 0x27f18c8 size 0x174 virtual false final false
 void AddCharClass(System::Text::RegularExpressions::RegexCharClass cc) ;

/// @brief Method AddSet addr 0x27f1ae4 size 0x22c virtual false final false
 void AddSet(::StringW set) ;

/// @brief Method AddSubtraction addr 0x27f1d10 size 0x8 virtual false final false
 void AddSubtraction(System::Text::RegularExpressions::RegexCharClass sub) ;

/// @brief Method AddRange addr 0x27f17a8 size 0x120 virtual false final false
 void AddRange(char16_t first, char16_t last) ;

/// @brief Method AddCategoryFromName addr 0x27f1d18 size 0x210 virtual false final false
 void AddCategoryFromName(::StringW categoryName, bool invert, bool caseInsensitive, ::StringW pattern) ;

/// @brief Method AddCategory addr 0x27f2214 size 0x1c virtual false final false
 void AddCategory(::StringW category) ;

/// @brief Method AddLowercase addr 0x27f2230 size 0x13c virtual false final false
 void AddLowercase(System::Globalization::CultureInfo culture) ;

/// @brief Method AddLowercaseRange addr 0x27f236c size 0x230 virtual false final false
 void AddLowercaseRange(char16_t chMin, char16_t chMax, System::Globalization::CultureInfo culture) ;

/// @brief Method AddWord addr 0x27f259c size 0xf4 virtual false final false
 void AddWord(bool ecma, bool negate) ;

/// @brief Method AddSpace addr 0x27f2690 size 0xf4 virtual false final false
 void AddSpace(bool ecma, bool negate) ;

/// @brief Method AddDigit addr 0x27f2784 size 0xb4 virtual false final false
 void AddDigit(bool ecma, bool negate, ::StringW pattern) ;

/// @brief Method SingletonChar addr 0x27f2838 size 0x18 virtual false final false
static char16_t SingletonChar(::StringW set) ;

/// @brief Method IsMergeable addr 0x27f2850 size 0x9c virtual false final false
static bool IsMergeable(::StringW charClass) ;

/// @brief Method IsEmpty addr 0x27f296c size 0xc0 virtual false final false
static bool IsEmpty(::StringW charClass) ;

/// @brief Method IsSingleton addr 0x27f2a2c size 0x10c virtual false final false
static bool IsSingleton(::StringW set) ;

/// @brief Method IsSingletonInverse addr 0x27f2b38 size 0x110 virtual false final false
static bool IsSingletonInverse(::StringW set) ;

/// @brief Method IsSubtraction addr 0x27f2914 size 0x58 virtual false final false
static bool IsSubtraction(::StringW charClass) ;

/// @brief Method IsNegated addr 0x27f28ec size 0x28 virtual false final false
static bool IsNegated(::StringW set) ;

/// @brief Method IsECMAWordChar addr 0x27f2c48 size 0x6c virtual false final false
static bool IsECMAWordChar(char16_t ch) ;

/// @brief Method IsWordChar addr 0x27f2d1c size 0x80 virtual false final false
static bool IsWordChar(char16_t ch) ;

/// @brief Method CharInClass addr 0x27f2cb4 size 0x68 virtual false final false
static bool CharInClass(char16_t ch, ::StringW set) ;

/// @brief Method CharInClassRecursive addr 0x27f2d9c size 0x128 virtual false final false
static bool CharInClassRecursive(char16_t ch, ::StringW set, int32_t start) ;

/// @brief Method CharInClassInternal addr 0x27f2ec4 size 0x110 virtual false final false
static bool CharInClassInternal(char16_t ch, ::StringW set, int32_t start, int32_t mySetLength, int32_t myCategoryLength) ;

/// @brief Method CharInCategory addr 0x27f2fd4 size 0x188 virtual false final false
static bool CharInCategory(char16_t ch, ::StringW set, int32_t start, int32_t mySetLength, int32_t myCategoryLength) ;

/// @brief Method CharInCategoryGroup addr 0x27f315c size 0xd0 virtual false final false
...
/// @brief Method NegateCategory addr 0x27f1f28 size 0x88 virtual false final false
static ::StringW NegateCategory(::StringW category) ;

/// @brief Method Parse addr 0x27f322c size 0x58 virtual false final false
static System::Text::RegularExpressions::RegexCharClass Parse(::StringW charClass) ;

/// @brief Method ParseRecursive addr 0x27f3284 size 0x288 virtual false final false
static System::Text::RegularExpressions::RegexCharClass ParseRecursive(::StringW charClass, int32_t start) ;

/// @brief Method RangeCount addr 0x27f1a3c size 0x48 virtual false final false
 int32_t RangeCount() ;

/// @brief Method ToStringClass addr 0x27f350c size 0x19c virtual false final false
 ::StringW ToStringClass() ;

/// @brief Method GetRangeAt addr 0x27f1a84 size 0x60 virtual false final false
 System::Text::RegularExpressions::System__Text__RegularExpressions__RegexCharClass__SingleRange GetRangeAt(int32_t i) ;

/// @brief Method Canonicalize addr 0x27f36a8 size 0x23c virtual false final false
 void Canonicalize() ;

/// @brief Method SetFromProperty addr 0x27f1fb0 size 0x264 virtual false final false
