...
/// @brief Method .ctor addr 0x2801804 size 0x4e8 virtual false final false
 void _ctor(::StringW rep, System::Text::RegularExpressions::RegexNode concat, System::Collections::Hashtable _caps) ;

/// @brief Method GetOrCreate addr 0x2806298 size 0x114 virtual false final false
...
/// @brief Method get_Pattern addr 0x28063ac size 0x8 virtual false final false
 ::StringW get_Pattern() ;

/// @brief Method ReplacementImpl addr 0x28063b4 size 0x1a4 virtual false final false
 void ReplacementImpl(System::Text::StringBuilder sb, System::Text::RegularExpressions::Match match) ;

/// @brief Method ReplacementImplRTL addr 0x2806558 size 0x230 virtual false final false
 void ReplacementImplRTL(System::Collections::Generic::List_1<::StringW> al, System::Text::RegularExpressions::Match match) ;

/// @brief Method Replace addr 0x2806788 size 0x3a0 virtual false final false
