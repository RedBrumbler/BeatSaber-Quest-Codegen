...
/// @brief Method .ctor addr 0x27ebabc size 0x3c virtual false final false
 void _ctor(::StringW text, int32_t index, int32_t length) ;

/// @brief Method get_Index addr 0x27ebaf8 size 0x8 virtual false final false
 int32_t get_Index() ;

/// @brief Method set_Index addr 0x27ebb00 size 0x8 virtual false final false
 void set_Index(int32_t value) ;

/// @brief Method get_Length addr 0x27ebb08 size 0x8 virtual false final false
 int32_t get_Length() ;

/// @brief Method set_Length addr 0x27ebb10 size 0x8 virtual false final false
 void set_Length(int32_t value) ;

/// @brief Method get_Text addr 0x27ebb18 size 0x8 virtual false final false
 ::StringW get_Text() ;

/// @brief Method set_Text addr 0x27ebb20 size 0x8 virtual false final false
 void set_Text(::StringW value) ;

/// @brief Method get_Value addr 0x27ebb28 size 0x24 virtual false final false
 ::StringW get_Value() ;

/// @brief Method ToString addr 0x27ebb4c size 0x4 virtual true final false
 ::StringW ToString() ;

/// @brief Method GetLeftSubstring addr 0x27ebb50 size 0x88 virtual false final false
 System::ReadOnlySpan_1<char16_t> GetLeftSubstring() ;

/// @brief Method GetRightSubstring addr 0x27ebbd8 size 0x90 virtual false final false
