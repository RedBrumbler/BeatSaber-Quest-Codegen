...
/// @brief Method .ctor addr 0x28073cc size 0x148 virtual false final false
 void _ctor(System::Span_1<int32_t> emittedSpan, System::Span_1<int32_t> intStackSpan) ;

/// @brief Method Write addr 0x2807514 size 0x104 virtual false final false
static System::Text::RegularExpressions::RegexCode Write(System::Text::RegularExpressions::RegexTree tree) ;

/// @brief Method Dispose addr 0x2807a78 size 0x54 virtual false final false
 void Dispose() ;

/// @brief Method RegexCodeFromRegexTree addr 0x2807618 size 0x460 virtual false final false
 System::Text::RegularExpressions::RegexCode RegexCodeFromRegexTree(System::Text::RegularExpressions::RegexTree tree) ;

/// @brief Method PatchJump addr 0x2808628 size 0x64 virtual false final false
 void PatchJump(int32_t offset, int32_t jumpDest) ;

/// @brief Method Emit addr 0x280868c size 0xe4 virtual false final false
 void Emit(int32_t op) ;

/// @brief Method Emit addr 0x2807acc size 0x14c virtual false final false
 void Emit(int32_t op, int32_t opd1) ;

/// @brief Method Emit addr 0x2808770 size 0x1ac virtual false final false
 void Emit(int32_t op, int32_t opd1, int32_t opd2) ;

/// @brief Method StringCode addr 0x280891c size 0x14c virtual false final false
 int32_t StringCode(::StringW str) ;

/// @brief Method MapCapnum addr 0x2808a68 size 0xb4 virtual false final false
 int32_t MapCapnum(int32_t capnum) ;

/// @brief Method EmitFragment addr 0x2807c18 size 0xa10 virtual false final false
