...
/// @brief Method .ctor addr 0x27f0d44 size 0x4b4 virtual false final false
 void _ctor(::StringW pattern, bool caseInsensitive, bool rightToLeft, System::Globalization::CultureInfo culture) ;

/// @brief Method MatchPattern addr 0x27f11f8 size 0x124 virtual false final false
 bool MatchPattern(::StringW text, int32_t index) ;

/// @brief Method IsMatch addr 0x27f131c size 0x6c virtual false final false
 bool IsMatch(::StringW text, int32_t index, int32_t beglimit, int32_t endlimit) ;

/// @brief Method Scan addr 0x27f1388 size 0x2e4 virtual false final false
