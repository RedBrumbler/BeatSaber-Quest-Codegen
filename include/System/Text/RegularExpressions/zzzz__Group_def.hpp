...
namespace System::Text::RegularExpressions {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7770))}
...
/// @brief Method .ctor addr 0x27ebc68 size 0x9c virtual false final false
 void _ctor(::StringW text, ::ArrayW<int32_t> caps, int32_t capcount, ::StringW name) ;

/// @brief Method get_Success addr 0x27ebd04 size 0x10 virtual false final false
 bool get_Success() ;

// Ctor Parameters []
explicit Group() ;

/// @brief Method .ctor addr 0x27ebe10 size 0x38 virtual false final false
 void _ctor() ;
