...
/// @brief Method .ctor addr 0x27fcfb0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Scan addr 0x2806b28 size 0x304 virtual false final false
...
/// @brief Method StartTimeoutWatch addr 0x2806e2c size 0x34 virtual false final false
 void StartTimeoutWatch() ;

/// @brief Method CheckTimeout addr 0x27ff080 size 0x10 virtual false final false
 void CheckTimeout() ;

/// @brief Method DoCheckTimeout addr 0x2807080 size 0xd4 virtual false final false
 void DoCheckTimeout() ;
...
/// @brief Method InitMatch addr 0x2806e60 size 0x1dc virtual false final false
 void InitMatch() ;

/// @brief Method TidyMatch addr 0x280703c size 0x44 virtual false final false
 System::Text::RegularExpressions::Match TidyMatch(bool quick) ;

/// @brief Method EnsureStorage addr 0x27fd0d4 size 0x48 virtual false final false
 void EnsureStorage() ;

/// @brief Method IsBoundary addr 0x27ff278 size 0xf8 virtual false final false
 bool IsBoundary(int32_t index, int32_t startpos, int32_t endpos) ;

/// @brief Method IsECMABoundary addr 0x27ff370 size 0xf8 virtual false final false
 bool IsECMABoundary(int32_t index, int32_t startpos, int32_t endpos) ;

/// @brief Method DoubleTrack addr 0x28071f4 size 0xa0 virtual false final false
 void DoubleTrack() ;

/// @brief Method DoubleStack addr 0x2807154 size 0xa0 virtual false final false
 void DoubleStack() ;

/// @brief Method DoubleCrawl addr 0x2807294 size 0xa0 virtual false final false
 void DoubleCrawl() ;

/// @brief Method Crawl addr 0x2807334 size 0x5c virtual false final false
 void Crawl(int32_t i) ;

/// @brief Method Popcrawl addr 0x2807390 size 0x3c virtual false final false
 int32_t Popcrawl() ;

/// @brief Method Crawlpos addr 0x27ff254 size 0x24 virtual false final false
 int32_t Crawlpos() ;

/// @brief Method Capture addr 0x27ff1c4 size 0x60 virtual false final false
 void Capture(int32_t capnum, int32_t start, int32_t end) ;

/// @brief Method TransferCapture addr 0x27ff0b0 size 0x114 virtual false final false
 void TransferCapture(int32_t capnum, int32_t uncapnum, int32_t start, int32_t end) ;

/// @brief Method Uncapture addr 0x27ff224 size 0x30 virtual false final false
 void Uncapture() ;

/// @brief Method IsMatched addr 0x27ff090 size 0x20 virtual false final false
 bool IsMatched(int32_t cap) ;

/// @brief Method MatchIndex addr 0x27ff468 size 0x20 virtual false final false
 int32_t MatchIndex(int32_t cap) ;

/// @brief Method MatchLength addr 0x27ff488 size 0x20 virtual false final false
