...
/// @brief Method .ctor addr 0x27fc12c size 0x10 virtual false final false
 void _ctor(::StringW prefix, bool ci) ;

/// @brief Method get_CaseInsensitive addr 0x28061c8 size 0x8 virtual false final false
 bool get_CaseInsensitive() ;

/// @brief Method get_Empty addr 0x28061d0 size 0x58 virtual false final false
static System::Text::RegularExpressions::RegexPrefix get_Empty() ;

/// @brief Method get_Prefix addr 0x2806228 size 0x8 virtual false final false
 ::StringW get_Prefix() ;
