...
/// @brief Method .ctor addr 0x24f3930 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_Fallback addr 0x24f3938 size 0x8 virtual false final false
 System::Text::DecoderFallback get_Fallback() ;

/// @brief Method get_FallbackBuffer addr 0x24f3230 size 0x3c virtual false final false
 System::Text::DecoderFallbackBuffer get_FallbackBuffer() ;

/// @brief Method get_InternalHasFallbackBuffer addr 0x24f3940 size 0x10 virtual false final false
 bool get_InternalHasFallbackBuffer() ;

/// @brief Method Reset addr 0x24f3950 size 0x108 virtual true final false
 void Reset() ;
...
/// @brief Method GetCharCount addr 0x24f3a58 size 0xc virtual true final false
 int32_t GetCharCount(::ArrayW<uint8_t> bytes, int32_t index, int32_t count, bool flush) ;

/// @brief Method GetCharCount addr 0x24f3a64 size 0x164 virtual true final false
...
/// @brief Method GetChars addr 0x24f3bc8 size 0xc virtual true final false
...
/// @brief Method GetChars addr 0x24f3bd4 size 0x218 virtual true final false
 int32_t GetChars(void* bytes, int32_t byteCount, void* chars, int32_t charCount, bool flush) ;

/// @brief Method GetChars addr 0x24f3dec size 0xa8 virtual true final false
 int32_t GetChars(System::ReadOnlySpan_1<uint8_t> bytes, System::Span_1<char16_t> chars, bool flush) ;

/// @brief Method Convert addr 0x24f3e94 size 0x2f8 virtual true final false
...
/// @brief Method Convert addr 0x24f418c size 0x22c virtual true final false
