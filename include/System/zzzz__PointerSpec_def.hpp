...
/// @brief Method .ctor addr 0x24cb438 size 0x8 virtual false final false
 void _ctor(int32_t pointer_level) ;

/// @brief Method Resolve addr 0x24cb440 size 0x54 virtual true final true
 System::Type Resolve(System::Type type) ;

/// @brief Method Append addr 0x24cb494 size 0x28 virtual true final true
 System::Text::StringBuilder Append(System::Text::StringBuilder sb) ;

/// @brief Method ToString addr 0x24cb4bc size 0x74 virtual true final false
 ::StringW ToString() ;
