...
/// @brief Method ParseCanonicalName addr 0x27ea908 size 0x4 virtual false final false
static ::StringW ParseCanonicalName(::StringW str, int32_t start, int32_t end, ByRef<bool> loopback) ;

/// @brief Method IsValid addr 0x27ea90c size 0x2d8 virtual false final false
