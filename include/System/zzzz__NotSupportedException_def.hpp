...
/// @brief Method .ctor addr 0x24758e8 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit NotSupportedException(::StringW message) ;

/// @brief Method .ctor addr 0x246e894 size 0x24 virtual false final false
 void _ctor(::StringW message) ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "innerException", ty: "System::Exception", modifiers: "", def_value: None }]
explicit NotSupportedException(::StringW message, System::Exception innerException) ;

/// @brief Method .ctor addr 0x2475944 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x2475968 size 0x8 virtual false final false
