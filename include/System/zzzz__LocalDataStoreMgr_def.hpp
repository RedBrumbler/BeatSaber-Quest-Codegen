...
/// @brief Method CreateLocalDataStore addr 0x249cf90 size 0x1c0 virtual false final false
 System::LocalDataStoreHolder CreateLocalDataStore() ;

/// @brief Method DeleteLocalDataStore addr 0x249c6a8 size 0x104 virtual false final false
 void DeleteLocalDataStore(System::LocalDataStore store) ;

/// @brief Method AllocateDataSlot addr 0x249d150 size 0x250 virtual false final false
 System::LocalDataStoreSlot AllocateDataSlot() ;

/// @brief Method AllocateNamedDataSlot addr 0x249d3a0 size 0x11c virtual false final false
 System::LocalDataStoreSlot AllocateNamedDataSlot(::StringW name) ;

/// @brief Method GetNamedDataSlot addr 0x249d4bc size 0x11c virtual false final false
 System::LocalDataStoreSlot GetNamedDataSlot(::StringW name) ;

/// @brief Method FreeNamedDataSlot addr 0x249d5d8 size 0x104 virtual false final false
 void FreeNamedDataSlot(::StringW name) ;

/// @brief Method FreeDataSlot addr 0x249cdf8 size 0x198 virtual false final false
 void FreeDataSlot(int32_t slot, int64_t cookie) ;

/// @brief Method ValidateSlot addr 0x249c884 size 0x7c virtual false final false
 void ValidateSlot(System::LocalDataStoreSlot slot) ;

/// @brief Method GetSlotTableLength addr 0x249ccd8 size 0x1c virtual false final false
 int32_t GetSlotTableLength() ;

// Ctor Parameters []
explicit LocalDataStoreMgr() ;

/// @brief Method .ctor addr 0x249d6dc size 0xec virtual false final false
 void _ctor() ;
