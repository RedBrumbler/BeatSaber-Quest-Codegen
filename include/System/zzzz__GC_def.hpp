...
/// @brief Method GetCollectionCount addr 0x24ac5bc size 0x4 virtual false final false
static int32_t GetCollectionCount(int32_t generation) ;

/// @brief Method GetMaxGeneration addr 0x24ac5c0 size 0x4 virtual false final false
static int32_t GetMaxGeneration() ;

/// @brief Method InternalCollect addr 0x24ac5c4 size 0x4 virtual false final false
static void InternalCollect(int32_t generation) ;

/// @brief Method register_ephemeron_array addr 0x24ac5c8 size 0x4 virtual false final false
static void register_ephemeron_array(::ArrayW<System::Runtime::CompilerServices::Ephemeron> array) ;

/// @brief Method get_ephemeron_tombstone addr 0x24ac5cc size 0x4 virtual false final false
static ::bs_hook::Il2CppWrapperType get_ephemeron_tombstone() ;

/// @brief Method GetMemoryInfo addr 0x24ac5d0 size 0x98 virtual false final false
...
/// @brief Method Collect addr 0x24ac668 size 0x50 virtual false final false
static void Collect() ;

/// @brief Method CollectionCount addr 0x24ac704 size 0xc0 virtual false final false
static int32_t CollectionCount(int32_t generation) ;

/// @brief Method KeepAlive addr 0x24ac7c4 size 0x4 virtual false final false
static void KeepAlive(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method get_MaxGeneration addr 0x24ac6b8 size 0x4c virtual false final false
static int32_t get_MaxGeneration() ;

/// @brief Method _SuppressFinalize addr 0x24ac7c8 size 0x4 virtual false final false
static void _SuppressFinalize(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method SuppressFinalize addr 0x24ac7cc size 0xa4 virtual false final false
static void SuppressFinalize(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method _ReRegisterForFinalize addr 0x24ac870 size 0x4 virtual false final false
static void _ReRegisterForFinalize(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method ReRegisterForFinalize addr 0x24ac874 size 0xa4 virtual false final false
