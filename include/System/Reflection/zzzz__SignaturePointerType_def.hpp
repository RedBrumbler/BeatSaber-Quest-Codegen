...
/// @brief Method .ctor addr 0x23b44d0 size 0x24 virtual false final false
 void _ctor(System::Reflection::SignatureType elementType) ;

/// @brief Method IsArrayImpl addr 0x23b44f4 size 0x8 virtual true final true
 bool IsArrayImpl() ;

/// @brief Method IsByRefImpl addr 0x23b44fc size 0x8 virtual true final true
 bool IsByRefImpl() ;

/// @brief Method IsPointerImpl addr 0x23b4504 size 0x8 virtual true final true
 bool IsPointerImpl() ;

/// @brief Method get_IsSZArray addr 0x23b450c size 0x8 virtual true final true
 bool get_IsSZArray() ;

/// @brief Method get_IsVariableBoundArray addr 0x23b4514 size 0x8 virtual true final true
 bool get_IsVariableBoundArray() ;

/// @brief Method GetArrayRank addr 0x23b451c size 0x50 virtual true final true
 int32_t GetArrayRank() ;

/// @brief Method get_Suffix addr 0x23b456c size 0x40 virtual true final true
 ::StringW get_Suffix() ;
