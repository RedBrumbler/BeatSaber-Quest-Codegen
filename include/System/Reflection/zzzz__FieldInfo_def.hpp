...
/// @brief Method .ctor addr 0x23b0354 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_MemberType addr 0x23b035c size 0x8 virtual true final false
...
/// @brief Method get_IsInitOnly addr 0x23b0364 size 0x20 virtual true final true
 bool get_IsInitOnly() ;

/// @brief Method get_IsLiteral addr 0x23b0384 size 0x20 virtual true final true
 bool get_IsLiteral() ;

/// @brief Method get_IsNotSerialized addr 0x23b03a4 size 0x20 virtual true final true
 bool get_IsNotSerialized() ;

/// @brief Method get_IsStatic addr 0x23b03c4 size 0x20 virtual true final true
 bool get_IsStatic() ;

/// @brief Method get_IsPrivate addr 0x23b03e4 size 0x28 virtual true final true
 bool get_IsPrivate() ;

/// @brief Method get_IsPublic addr 0x23b040c size 0x28 virtual true final true
 bool get_IsPublic() ;
...
/// @brief Method Equals addr 0x23b0434 size 0x8 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x23b043c size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x23b0444 size 0x2c virtual false final false
static bool op_Equality(System::Reflection::FieldInfo left, System::Reflection::FieldInfo right) ;

/// @brief Method op_Inequality addr 0x23b0470 size 0x3c virtual false final false
...
/// @brief Method SetValue addr 0x23b04ac size 0x8c virtual true final true
...
/// @brief Method SetValueDirect addr 0x23b0538 size 0x50 virtual true final false
...
/// @brief Method GetRawConstantValue addr 0x23b0588 size 0x50 virtual true final false
 ::bs_hook::Il2CppWrapperType GetRawConstantValue() ;

/// @brief Method internal_from_handle_type addr 0x23b05d8 size 0x4 virtual false final false
...
/// @brief Method GetFieldFromHandle addr 0x23b05dc size 0xb8 virtual false final false
static System::Reflection::FieldInfo GetFieldFromHandle(System::RuntimeFieldHandle handle) ;

/// @brief Method GetFieldFromHandle addr 0x23b0694 size 0xe8 virtual false final false
...
/// @brief Method GetFieldOffset addr 0x23b077c size 0x50 virtual true final false
 int32_t GetFieldOffset() ;

/// @brief Method get_marshal_info addr 0x23b07cc size 0x4 virtual false final false
 System::Runtime::InteropServices::MarshalAsAttribute get_marshal_info() ;

/// @brief Method GetPseudoCustomAttributes addr 0x23b07d0 size 0x214 virtual false final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetPseudoCustomAttributes() ;

/// @brief Method GetPseudoCustomAttributesData addr 0x23b09e4 size 0x58c virtual false final false
