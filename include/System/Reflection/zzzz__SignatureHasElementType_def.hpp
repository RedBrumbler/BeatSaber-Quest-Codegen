...
/// @brief Method .ctor addr 0x23b3ab4 size 0x24 virtual false final false
 void _ctor(System::Reflection::SignatureType elementType) ;

/// @brief Method get_IsGenericTypeDefinition addr 0x23b4218 size 0x8 virtual true final true
 bool get_IsGenericTypeDefinition() ;

/// @brief Method HasElementTypeImpl addr 0x23b4220 size 0x8 virtual true final true
...
/// @brief Method get_IsConstructedGenericType addr 0x23b4228 size 0x8 virtual true final true
 bool get_IsConstructedGenericType() ;

/// @brief Method get_IsGenericParameter addr 0x23b4230 size 0x8 virtual true final true
 bool get_IsGenericParameter() ;

/// @brief Method get_IsGenericMethodParameter addr 0x23b4238 size 0x8 virtual true final true
 bool get_IsGenericMethodParameter() ;

/// @brief Method get_ContainsGenericParameters addr 0x23b4240 size 0x24 virtual true final true
 bool get_ContainsGenericParameters() ;

/// @brief Method get_ElementType addr 0x23b4264 size 0x8 virtual true final true
...
/// @brief Method GetGenericTypeDefinition addr 0x23b426c size 0x50 virtual true final true
 System::Type GetGenericTypeDefinition() ;

/// @brief Method GetGenericArguments addr 0x23b42bc size 0x7c virtual true final true
 ::ArrayW<System::Type> GetGenericArguments() ;

/// @brief Method get_GenericTypeArguments addr 0x23b4338 size 0x7c virtual true final true
 ::ArrayW<System::Type> get_GenericTypeArguments() ;

/// @brief Method get_GenericParameterPosition addr 0x23b43b4 size 0x50 virtual true final true
 int32_t get_GenericParameterPosition() ;

/// @brief Method get_Name addr 0x23b4404 size 0x54 virtual true final true
 ::StringW get_Name() ;

/// @brief Method get_Namespace addr 0x23b4458 size 0x24 virtual true final true
 ::StringW get_Namespace() ;

/// @brief Method ToString addr 0x23b447c size 0x54 virtual true final true
 ::StringW ToString() ;
