...
/// @brief Method .ctor addr 0x23b3a78 size 0x3c virtual false final false
 void _ctor(System::Reflection::SignatureType elementType, int32_t rank, bool isMultiDim) ;

/// @brief Method IsArrayImpl addr 0x23b3ad8 size 0x8 virtual true final true
 bool IsArrayImpl() ;

/// @brief Method IsByRefImpl addr 0x23b3ae0 size 0x8 virtual true final true
 bool IsByRefImpl() ;

/// @brief Method IsPointerImpl addr 0x23b3ae8 size 0x8 virtual true final true
 bool IsPointerImpl() ;

/// @brief Method get_IsSZArray addr 0x23b3af0 size 0x10 virtual true final true
 bool get_IsSZArray() ;

/// @brief Method get_IsVariableBoundArray addr 0x23b3b00 size 0x8 virtual true final true
 bool get_IsVariableBoundArray() ;

/// @brief Method GetArrayRank addr 0x23b3b08 size 0x8 virtual true final true
 int32_t GetArrayRank() ;

/// @brief Method get_Suffix addr 0x23b3b10 size 0xc8 virtual true final true
 ::StringW get_Suffix() ;
