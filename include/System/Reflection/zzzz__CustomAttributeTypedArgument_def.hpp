...
/// @brief Method .ctor addr 0x23b7780 size 0x88 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method .ctor addr 0x23b106c size 0x2b0 virtual false final false
 void _ctor(System::Type argumentType, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_ArgumentType addr 0x23b78c0 size 0x8 virtual false final false
 System::Type get_ArgumentType() ;

/// @brief Method get_Value addr 0x23b78c8 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_Value() ;

/// @brief Method Equals addr 0x23b78d0 size 0x70 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x23b7940 size 0x64 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x23b79a4 size 0x78 virtual false final false
...
/// @brief Method op_Inequality addr 0x23b7a1c size 0x7c virtual false final false
...
/// @brief Method ToString addr 0x23b7a98 size 0x8 virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x23b6e88 size 0x8f8 virtual false final false
 ::StringW ToString(bool typed) ;

/// @brief Method CanonicalizeValue addr 0x23b7808 size 0xb8 virtual false final false
