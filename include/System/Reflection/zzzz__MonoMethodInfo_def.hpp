...
/// @brief Method get_method_info addr 0x23bd518 size 0x4 virtual false final false
static void get_method_info(::cordl_internals::intptr_t handle, ByRef<System::Reflection::MonoMethodInfo> info) ;

/// @brief Method get_method_attributes addr 0x23bd51c size 0x4 virtual false final false
static int32_t get_method_attributes(::cordl_internals::intptr_t handle) ;

/// @brief Method GetMethodInfo addr 0x23bd520 size 0x30 virtual false final false
static System::Reflection::MonoMethodInfo GetMethodInfo(::cordl_internals::intptr_t handle) ;

/// @brief Method GetDeclaringType addr 0x23bd550 size 0x28 virtual false final false
static System::Type GetDeclaringType(::cordl_internals::intptr_t handle) ;

/// @brief Method GetReturnType addr 0x23bd578 size 0x28 virtual false final false
static System::Type GetReturnType(::cordl_internals::intptr_t handle) ;

/// @brief Method GetAttributes addr 0x23bd5a0 size 0x4 virtual false final false
static System::Reflection::MethodAttributes GetAttributes(::cordl_internals::intptr_t handle) ;

/// @brief Method GetCallingConvention addr 0x23bd5a4 size 0x28 virtual false final false
static System::Reflection::CallingConventions GetCallingConvention(::cordl_internals::intptr_t handle) ;

/// @brief Method GetMethodImplementationFlags addr 0x23bd5cc size 0x28 virtual false final false
static System::Reflection::MethodImplAttributes GetMethodImplementationFlags(::cordl_internals::intptr_t handle) ;

/// @brief Method get_parameter_info addr 0x23bd5f4 size 0x4 virtual false final false
...
/// @brief Method GetParametersInfo addr 0x23bd5f8 size 0x4 virtual false final false
...
/// @brief Method get_retval_marshal addr 0x23bd5fc size 0x4 virtual false final false
static System::Runtime::InteropServices::MarshalAsAttribute get_retval_marshal(::cordl_internals::intptr_t handle) ;

/// @brief Method GetReturnParameterInfo addr 0x23bd600 size 0x58 virtual false final false
