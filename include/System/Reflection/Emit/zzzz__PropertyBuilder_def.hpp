...
/// @brief Method get_CanRead addr 0x23c4e04 size 0x40 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanWrite addr 0x23c4e44 size 0x40 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_DeclaringType addr 0x23c4e84 size 0x40 virtual true final false
 System::Type get_DeclaringType() ;

/// @brief Method get_Name addr 0x23c4ec4 size 0x40 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_PropertyType addr 0x23c4f04 size 0x40 virtual true final false
 System::Type get_PropertyType() ;

/// @brief Method get_ReflectedType addr 0x23c4f44 size 0x40 virtual true final false
 System::Type get_ReflectedType() ;

/// @brief Method GetCustomAttributes addr 0x23c4f84 size 0x40 virtual true final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetCustomAttributes(bool inherit) ;

/// @brief Method GetCustomAttributes addr 0x23c4fc4 size 0x40 virtual true final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetCustomAttributes(System::Type attributeType, bool inherit) ;

/// @brief Method GetGetMethod addr 0x23c5004 size 0x40 virtual true final false
 System::Reflection::MethodInfo GetGetMethod(bool nonPublic) ;

/// @brief Method GetIndexParameters addr 0x23c5044 size 0x40 virtual true final false
 ::ArrayW<System::Reflection::ParameterInfo> GetIndexParameters() ;

/// @brief Method GetSetMethod addr 0x23c5084 size 0x40 virtual true final false
 System::Reflection::MethodInfo GetSetMethod(bool nonPublic) ;

/// @brief Method GetValue addr 0x23c50c4 size 0x40 virtual true final false
...
/// @brief Method IsDefined addr 0x23c5104 size 0x40 virtual true final false
 bool IsDefined(System::Type attributeType, bool inherit) ;

/// @brief Method SetValue addr 0x23c5144 size 0x40 virtual true final false
