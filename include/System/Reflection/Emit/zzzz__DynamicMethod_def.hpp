...
/// @brief Method get_Attributes addr 0x23c36f4 size 0x40 virtual true final false
 System::Reflection::MethodAttributes get_Attributes() ;

/// @brief Method get_DeclaringType addr 0x23c3734 size 0x40 virtual true final false
 System::Type get_DeclaringType() ;

/// @brief Method get_Name addr 0x23c3774 size 0x40 virtual true final false
 ::StringW get_Name() ;

/// @brief Method GetParameters addr 0x23c37b4 size 0x40 virtual true final false
 ::ArrayW<System::Reflection::ParameterInfo> GetParameters() ;

/// @brief Method get_MethodHandle addr 0x23c37f4 size 0x40 virtual true final false
 System::RuntimeMethodHandle get_MethodHandle() ;

/// @brief Method get_ReflectedType addr 0x23c3834 size 0x40 virtual true final false
 System::Type get_ReflectedType() ;

/// @brief Method GetCustomAttributes addr 0x23c3874 size 0x40 virtual true final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetCustomAttributes(bool inherit) ;

/// @brief Method GetCustomAttributes addr 0x23c38b4 size 0x40 virtual true final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetCustomAttributes(System::Type attributeType, bool inherit) ;

/// @brief Method GetMethodImplementationFlags addr 0x23c38f4 size 0x40 virtual true final false
 System::Reflection::MethodImplAttributes GetMethodImplementationFlags() ;

/// @brief Method GetBaseDefinition addr 0x23c3934 size 0x40 virtual true final false
 System::Reflection::MethodInfo GetBaseDefinition() ;

/// @brief Method Invoke addr 0x23c3974 size 0x40 virtual true final false
...
/// @brief Method IsDefined addr 0x23c39b4 size 0x40 virtual true final false
