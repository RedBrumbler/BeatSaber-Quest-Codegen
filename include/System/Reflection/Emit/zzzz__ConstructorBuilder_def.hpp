...
/// @brief Method get_Attributes addr 0x23c33f4 size 0x40 virtual true final false
 System::Reflection::MethodAttributes get_Attributes() ;

/// @brief Method get_DeclaringType addr 0x23c3434 size 0x40 virtual true final false
 System::Type get_DeclaringType() ;

/// @brief Method get_Name addr 0x23c3474 size 0x40 virtual true final false
 ::StringW get_Name() ;

/// @brief Method GetParameters addr 0x23c34b4 size 0x40 virtual true final false
 ::ArrayW<System::Reflection::ParameterInfo> GetParameters() ;

/// @brief Method GetMethodImplementationFlags addr 0x23c34f4 size 0x40 virtual true final false
 System::Reflection::MethodImplAttributes GetMethodImplementationFlags() ;

/// @brief Method get_MethodHandle addr 0x23c3534 size 0x40 virtual true final false
 System::RuntimeMethodHandle get_MethodHandle() ;

/// @brief Method Invoke addr 0x23c3574 size 0x40 virtual true final false
...
/// @brief Method IsDefined addr 0x23c35b4 size 0x40 virtual true final false
 bool IsDefined(System::Type attributeType, bool inherit) ;

/// @brief Method GetCustomAttributes addr 0x23c35f4 size 0x40 virtual true final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetCustomAttributes(bool inherit) ;

/// @brief Method GetCustomAttributes addr 0x23c3634 size 0x40 virtual true final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetCustomAttributes(System::Type attributeType, bool inherit) ;

/// @brief Method get_ReflectedType addr 0x23c3674 size 0x40 virtual true final false
 System::Type get_ReflectedType() ;

/// @brief Method Invoke addr 0x23c36b4 size 0x40 virtual true final false
