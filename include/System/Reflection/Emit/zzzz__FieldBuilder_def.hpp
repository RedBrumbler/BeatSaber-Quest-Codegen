...
/// @brief Method get_Attributes addr 0x23c4234 size 0x8 virtual true final false
 System::Reflection::FieldAttributes get_Attributes() ;

/// @brief Method get_DeclaringType addr 0x23c423c size 0x8 virtual true final false
 System::Type get_DeclaringType() ;

/// @brief Method get_FieldHandle addr 0x23c4244 size 0x8 virtual true final false
 System::RuntimeFieldHandle get_FieldHandle() ;

/// @brief Method get_FieldType addr 0x23c424c size 0x8 virtual true final false
 System::Type get_FieldType() ;

/// @brief Method get_Name addr 0x23c4254 size 0x8 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_ReflectedType addr 0x23c425c size 0x8 virtual true final false
 System::Type get_ReflectedType() ;

/// @brief Method GetCustomAttributes addr 0x23c4264 size 0x8 virtual true final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetCustomAttributes(bool inherit) ;

/// @brief Method GetCustomAttributes addr 0x23c426c size 0x8 virtual true final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetCustomAttributes(System::Type attributeType, bool inherit) ;

/// @brief Method GetValue addr 0x23c4274 size 0x8 virtual true final false
 ::bs_hook::Il2CppWrapperType GetValue(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method IsDefined addr 0x23c427c size 0x8 virtual true final false
 bool IsDefined(System::Type attributeType, bool inherit) ;

/// @brief Method SetValue addr 0x23c4284 size 0x40 virtual true final false
