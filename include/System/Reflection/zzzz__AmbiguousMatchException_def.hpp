...
/// @brief Method .ctor addr 0x23af9ec size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit AmbiguousMatchException(::StringW message) ;

/// @brief Method .ctor addr 0x23afa48 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x23afa6c size 0x8 virtual false final false
