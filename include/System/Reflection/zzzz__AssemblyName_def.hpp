...
/// @brief Method .ctor addr 0x23b9040 size 0x20 virtual false final false
 void _ctor() ;

/// @brief Method ParseAssemblyName addr 0x23b9060 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x23aac24 size 0x298 virtual false final false
...
/// @brief Method .ctor addr 0x23b9304 size 0x508 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo si, System::Runtime::Serialization::StreamingContext sc) ;

/// @brief Method get_Name addr 0x23b980c size 0x8 virtual false final false
 ::StringW get_Name() ;

/// @brief Method get_CultureInfo addr 0x23b9814 size 0x8 virtual false final false
 System::Globalization::CultureInfo get_CultureInfo() ;

/// @brief Method get_Flags addr 0x23b981c size 0x8 virtual false final false
 System::Reflection::AssemblyNameFlags get_Flags() ;

/// @brief Method get_FullName addr 0x23b9824 size 0x35c virtual false final false
 ::StringW get_FullName() ;

/// @brief Method get_Version addr 0x23b9c68 size 0x8 virtual false final false
 System::Version get_Version() ;

/// @brief Method set_Version addr 0x23b9c70 size 0x4c virtual false final false
 void set_Version(System::Version value) ;

/// @brief Method ToString addr 0x23b9cbc size 0x28 virtual true final false
 ::StringW ToString() ;

/// @brief Method GetPublicKeyToken addr 0x23aaebc size 0xe8 virtual false final false
 ::ArrayW<uint8_t> GetPublicKeyToken() ;

/// @brief Method get_IsPublicKeyValid addr 0x23b9ce4 size 0x84 virtual false final false
 bool get_IsPublicKeyValid() ;

/// @brief Method InternalGetPublicKeyToken addr 0x23b9b80 size 0xe8 virtual false final false
 ::ArrayW<uint8_t> InternalGetPublicKeyToken() ;

/// @brief Method get_public_token addr 0x23b9df4 size 0x4 virtual false final false
static void get_public_token(void* token, void* pubkey, int32_t len) ;

/// @brief Method ComputePublicKeyToken addr 0x23b9d68 size 0x8c virtual false final false
 ::ArrayW<uint8_t> ComputePublicKeyToken() ;

/// @brief Method GetObjectData addr 0x23b9df8 size 0x330 virtual true final true
 void GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method Clone addr 0x23ba128 size 0xb0 virtual true final true
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method OnDeserialization addr 0x23ba1d8 size 0x8 virtual true final true
 void OnDeserialization(::bs_hook::Il2CppWrapperType sender) ;

/// @brief Method GetNativeName addr 0x23ba1e0 size 0x4 virtual false final false
static void* GetNativeName(::cordl_internals::intptr_t assembly_ptr) ;

/// @brief Method FillName addr 0x23b9064 size 0x2a0 virtual false final false
 void FillName(void* native, ::StringW codeBase, bool addVersion, bool addPublickey, bool defaultToken, bool assemblyRef) ;

/// @brief Method Create addr 0x23ba1e4 size 0xcc virtual false final false
