...
/// @brief Method .ctor addr 0x23b3cb4 size 0x1a4 virtual false final false
 void _ctor(System::Type genericTypeDefinition, ::ArrayW<System::Type> typeArguments) ;

/// @brief Method get_IsGenericTypeDefinition addr 0x23b3eb0 size 0x8 virtual true final true
 bool get_IsGenericTypeDefinition() ;

/// @brief Method HasElementTypeImpl addr 0x23b3eb8 size 0x8 virtual true final true
 bool HasElementTypeImpl() ;

/// @brief Method IsArrayImpl addr 0x23b3ec0 size 0x8 virtual true final true
 bool IsArrayImpl() ;

/// @brief Method IsByRefImpl addr 0x23b3ec8 size 0x8 virtual true final true
 bool IsByRefImpl() ;

/// @brief Method IsPointerImpl addr 0x23b3ed0 size 0x8 virtual true final true
 bool IsPointerImpl() ;

/// @brief Method get_IsSZArray addr 0x23b3ed8 size 0x8 virtual true final true
 bool get_IsSZArray() ;

/// @brief Method get_IsVariableBoundArray addr 0x23b3ee0 size 0x8 virtual true final true
 bool get_IsVariableBoundArray() ;

/// @brief Method get_IsConstructedGenericType addr 0x23b3ee8 size 0x8 virtual true final true
 bool get_IsConstructedGenericType() ;

/// @brief Method get_IsGenericParameter addr 0x23b3ef0 size 0x8 virtual true final true
 bool get_IsGenericParameter() ;

/// @brief Method get_IsGenericMethodParameter addr 0x23b3ef8 size 0x8 virtual true final true
 bool get_IsGenericMethodParameter() ;

/// @brief Method get_ContainsGenericParameters addr 0x23b3f00 size 0x78 virtual true final true
 bool get_ContainsGenericParameters() ;

/// @brief Method get_ElementType addr 0x23b3f78 size 0x8 virtual true final true
 System::Reflection::SignatureType get_ElementType() ;

/// @brief Method GetArrayRank addr 0x23b3f80 size 0x50 virtual true final true
 int32_t GetArrayRank() ;

/// @brief Method GetGenericTypeDefinition addr 0x23b3fd0 size 0x8 virtual true final true
 System::Type GetGenericTypeDefinition() ;

/// @brief Method GetGenericArguments addr 0x23b3fd8 size 0x10 virtual true final true
 ::ArrayW<System::Type> GetGenericArguments() ;

/// @brief Method get_GenericTypeArguments addr 0x23b3fe8 size 0x78 virtual true final true
 ::ArrayW<System::Type> get_GenericTypeArguments() ;

/// @brief Method get_GenericParameterPosition addr 0x23b4060 size 0x50 virtual true final true
 int32_t get_GenericParameterPosition() ;

/// @brief Method get_Name addr 0x23b40b0 size 0x20 virtual true final true
 ::StringW get_Name() ;

/// @brief Method get_Namespace addr 0x23b40d0 size 0x24 virtual true final true
 ::StringW get_Namespace() ;

/// @brief Method ToString addr 0x23b40f4 size 0x124 virtual true final true
 ::StringW ToString() ;
