...
/// @brief Method get_Assembly addr 0x23bffe8 size 0x8 virtual true final false
 System::Reflection::Assembly get_Assembly() ;

/// @brief Method get_ScopeName addr 0x23bfff0 size 0x8 virtual true final false
 ::StringW get_ScopeName() ;

/// @brief Method get_ModuleVersionId addr 0x23bfff8 size 0x10 virtual true final false
 System::Guid get_ModuleVersionId() ;

/// @brief Method IsResource addr 0x23c0008 size 0x8 virtual true final false
 bool IsResource() ;

/// @brief Method GetCustomAttributes addr 0x23c0010 size 0x68 virtual true final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetCustomAttributes(bool inherit) ;

/// @brief Method GetCustomAttributes addr 0x23c0078 size 0x70 virtual true final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetCustomAttributes(System::Type attributeType, bool inherit) ;

/// @brief Method IsDefined addr 0x23c00e8 size 0x70 virtual true final false
 bool IsDefined(System::Type attributeType, bool inherit) ;

/// @brief Method GetObjectData addr 0x23c0158 size 0x98 virtual true final false
 void GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method GetRuntimeAssembly addr 0x23c01f0 size 0x78 virtual false final false
 System::Reflection::RuntimeAssembly GetRuntimeAssembly() ;

/// @brief Method GetModuleVersionId addr 0x23c0268 size 0x80 virtual true final false
 System::Guid GetModuleVersionId() ;

/// @brief Method GetGuidInternal addr 0x23c02e8 size 0x4 virtual false final false
static void GetGuidInternal(::cordl_internals::intptr_t module, ::ArrayW<uint8_t> guid) ;

// Ctor Parameters []
explicit RuntimeModule() ;

/// @brief Method .ctor addr 0x23c02ec size 0x58 virtual false final false
 void _ctor() ;
