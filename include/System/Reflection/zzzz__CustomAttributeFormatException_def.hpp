...
/// @brief Method .ctor addr 0x23afe50 size 0x60 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit CustomAttributeFormatException(::StringW message) ;

/// @brief Method .ctor addr 0x23afeb0 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x23afed8 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x23afefc size 0x8 virtual false final false
