...
/// @brief Method .ctor addr 0x248bd04 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit TimeoutException(::StringW message) ;

/// @brief Method .ctor addr 0x248bd5c size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0x248bd7c size 0x4 virtual false final false
