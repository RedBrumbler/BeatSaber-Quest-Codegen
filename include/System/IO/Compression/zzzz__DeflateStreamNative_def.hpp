...
/// @brief Method .ctor addr 0x27e1a60 size 0xc4 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x27e22b8 size 0x14 virtual true final false
...
/// @brief Method get_IsInvalid addr 0x27e22cc size 0x54 virtual true final false
 bool get_IsInvalid() ;

// Ctor Parameters []
explicit System__IO__Compression__DeflateStreamNative__SafeDeflateStreamHandle() ;

/// @brief Method .ctor addr 0x27e225c size 0x58 virtual false final false
 void _ctor() ;

/// @brief Method ReleaseHandle addr 0x27e2320 size 0x88 virtual true final false
 bool ReleaseHandle() ;
...
/// @brief Method .ctor addr 0x27e1a58 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Create addr 0x27e0240 size 0x134 virtual false final false
...
/// @brief Method Finalize addr 0x27e1bbc size 0x98 virtual true final false
 void Finalize() ;

/// @brief Method Dispose addr 0x27e04d0 size 0x104 virtual false final false
 void Dispose(bool disposing) ;

/// @brief Method Flush addr 0x27e0be0 size 0x54 virtual false final false
 void Flush() ;

/// @brief Method ReadZStream addr 0x27e061c size 0x78 virtual false final false
 int32_t ReadZStream(::cordl_internals::intptr_t buffer, int32_t length) ;

/// @brief Method WriteZStream addr 0x27e08c4 size 0x6c virtual false final false
 void WriteZStream(::cordl_internals::intptr_t buffer, int32_t length) ;

/// @brief Method UnmanagedRead addr 0x27e18e0 size 0xbc virtual false final false
static int32_t UnmanagedRead(::cordl_internals::intptr_t buffer, int32_t length, ::cordl_internals::intptr_t data) ;

/// @brief Method UnmanagedRead addr 0x27e1ee4 size 0x1a4 virtual false final false
 int32_t UnmanagedRead(::cordl_internals::intptr_t buffer, int32_t length) ;

/// @brief Method UnmanagedWrite addr 0x27e199c size 0xbc virtual false final false
static int32_t UnmanagedWrite(::cordl_internals::intptr_t buffer, int32_t length, ::cordl_internals::intptr_t data) ;

/// @brief Method UnmanagedWrite addr 0x27e2088 size 0x1d4 virtual false final false
 int32_t UnmanagedWrite(::cordl_internals::intptr_t buffer, int32_t length) ;

/// @brief Method CheckResult addr 0x27e1cb8 size 0x134 virtual false final false
 void CheckResult(int32_t result, ::StringW where) ;

/// @brief Method CreateZStream addr 0x27e1b24 size 0x98 virtual false final false
...
/// @brief Method CloseZStream addr 0x27e22b4 size 0x4 virtual false final false
static int32_t CloseZStream(::cordl_internals::intptr_t stream) ;

/// @brief Method Flush addr 0x27e1c54 size 0x64 virtual false final false
static int32_t Flush(System::IO::Compression::System__IO__Compression__DeflateStreamNative__SafeDeflateStreamHandle stream) ;

/// @brief Method ReadZStream addr 0x27e1dec size 0x7c virtual false final false
...
/// @brief Method WriteZStream addr 0x27e1e68 size 0x7c virtual false final false
