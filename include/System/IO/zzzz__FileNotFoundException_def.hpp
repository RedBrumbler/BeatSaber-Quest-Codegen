...
/// @brief Method .ctor addr 0x23c62b8 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit FileNotFoundException(::StringW message) ;

/// @brief Method .ctor addr 0x23c6314 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x23c6338 size 0x34 virtual false final false
 void _ctor(::StringW message, ::StringW fileName) ;

/// @brief Method get_Message addr 0x23c636c size 0x18 virtual true final false
 ::StringW get_Message() ;

/// @brief Method SetMessageField addr 0x23c6384 size 0x78 virtual false final false
 void SetMessageField() ;

/// @brief Method get_FileName addr 0x23c63fc size 0x8 virtual false final false
 ::StringW get_FileName() ;

/// @brief Method get_FusionLog addr 0x23c6404 size 0x8 virtual false final false
 ::StringW get_FusionLog() ;

/// @brief Method ToString addr 0x23c640c size 0x1e4 virtual true final false
 ::StringW ToString() ;
...
/// @brief Method .ctor addr 0x23c65f0 size 0xb0 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method GetObjectData addr 0x23c66a0 size 0x118 virtual true final false
