...
/// @brief Method .ctor addr 0x23c9d28 size 0x64 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x23cf1dc size 0x90 virtual false final false
 void _ctor(void* pointer, int64_t length, int64_t capacity, System::IO::FileAccess access) ;

/// @brief Method Initialize addr 0x23c9d8c size 0x208 virtual false final false
 void Initialize(void* pointer, int64_t length, int64_t capacity, System::IO::FileAccess access) ;

/// @brief Method get_CanRead addr 0x23cf26c size 0x1c virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanSeek addr 0x23cf288 size 0x8 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_CanWrite addr 0x23cf290 size 0x1c virtual true final false
 bool get_CanWrite() ;

/// @brief Method Dispose addr 0x23ca5b8 size 0x14 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method EnsureNotClosed addr 0x23cf2ac size 0x34 virtual false final false
 void EnsureNotClosed() ;

/// @brief Method EnsureReadable addr 0x23cf2e0 size 0x3c virtual false final false
 void EnsureReadable() ;

/// @brief Method EnsureWriteable addr 0x23cf31c size 0x3c virtual false final false
 void EnsureWriteable() ;

/// @brief Method Flush addr 0x23cf358 size 0x4 virtual true final false
 void Flush() ;

/// @brief Method FlushAsync addr 0x23cf35c size 0x174 virtual true final false
 System::Threading::Tasks::Task FlushAsync(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method get_Length addr 0x23cf4d0 size 0x1c virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x23cf4ec size 0x48 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x23cf534 size 0xa8 virtual true final false
 void set_Position(int64_t value) ;

/// @brief Method get_PositionPointer addr 0x23cf5dc size 0xc0 virtual false final false
 void* get_PositionPointer() ;

/// @brief Method Read addr 0x23cf69c size 0x1c0 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Read addr 0x23cf85c size 0xe4 virtual true final false
 int32_t Read(System::Span_1<uint8_t> buffer) ;

/// @brief Method ReadCore addr 0x23c9f98 size 0x22c virtual false final false
 int32_t ReadCore(System::Span_1<uint8_t> buffer) ;

/// @brief Method ReadAsync addr 0x23cf940 size 0x310 virtual true final false
...
/// @brief Method ReadAsync addr 0x23cfc50 size 0x294 virtual true final false
...
/// @brief Method ReadByte addr 0x23cfee4 size 0x160 virtual true final false
 int32_t ReadByte() ;

/// @brief Method Seek addr 0x23d0044 size 0x110 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin loc) ;

/// @brief Method SetLength addr 0x23d0154 size 0x190 virtual true final false
 void SetLength(int64_t value) ;

/// @brief Method Write addr 0x23d02e4 size 0x1ec virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Write addr 0x23d04d0 size 0xe4 virtual true final false
 void Write(System::ReadOnlySpan_1<uint8_t> buffer) ;

/// @brief Method WriteCore addr 0x23ca1c8 size 0x2fc virtual false final false
 void WriteCore(System::ReadOnlySpan_1<uint8_t> buffer) ;

/// @brief Method WriteAsync addr 0x23d05b4 size 0x2c0 virtual true final false
...
/// @brief Method WriteAsync addr 0x23d0874 size 0x214 virtual true final false
...
/// @brief Method WriteByte addr 0x23d0a88 size 0x228 virtual true final false
