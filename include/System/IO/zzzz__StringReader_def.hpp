...
/// @brief Method .ctor addr 0x2401d7c size 0xcc virtual false final false
 void _ctor(::StringW s) ;

/// @brief Method Close addr 0x2401e48 size 0x10 virtual true final false
 void Close() ;

/// @brief Method Dispose addr 0x2401e58 size 0x10 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Peek addr 0x2401e68 size 0x3c virtual true final false
 int32_t Peek() ;

/// @brief Method Read addr 0x2401ea4 size 0x44 virtual true final false
 int32_t Read() ;

/// @brief Method Read addr 0x2401ee8 size 0x1bc virtual true final false
 int32_t Read(ByRef<::ArrayW<char16_t>> buffer, int32_t index, int32_t count) ;

/// @brief Method ReadToEnd addr 0x24020a4 size 0x3c virtual true final false
 ::StringW ReadToEnd() ;

/// @brief Method ReadLine addr 0x24020e0 size 0x114 virtual true final false
 ::StringW ReadLine() ;
