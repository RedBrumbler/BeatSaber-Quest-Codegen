...
/// @brief Method .ctor addr 0x23d4e60 size 0x4 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "fileName", ty: "::StringW", modifiers: "", def_value: None }]
explicit FileInfo(::StringW fileName) ;

/// @brief Method .ctor addr 0x23d4e64 size 0x10 virtual false final false
...
/// @brief Method .ctor addr 0x23d4e74 size 0x128 virtual false final false
 void _ctor(::StringW originalPath, ::StringW fullPath, ::StringW fileName, bool isNormalized) ;

/// @brief Method get_Length addr 0x23d4f9c size 0x88 virtual false final false
 int64_t get_Length() ;

/// @brief Method CreateText addr 0x23d5174 size 0x68 virtual false final false
 System::IO::StreamWriter CreateText() ;

/// @brief Method AppendText addr 0x23d51dc size 0x68 virtual false final false
 System::IO::StreamWriter AppendText() ;

/// @brief Method Delete addr 0x23d5244 size 0x8 virtual true final false
 void Delete() ;

/// @brief Method OpenRead addr 0x23d524c size 0x7c virtual false final false
...
/// @brief Method .ctor addr 0x23d52c8 size 0x4 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method get_Name addr 0x23d52cc size 0x8 virtual true final false
 ::StringW get_Name() ;
