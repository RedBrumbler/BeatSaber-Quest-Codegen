...
/// @brief Method .ctor addr 0x23c5b7c size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit EndOfStreamException(::StringW message) ;

/// @brief Method .ctor addr 0x23c5bd8 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x23c5bfc size 0x8 virtual false final false
