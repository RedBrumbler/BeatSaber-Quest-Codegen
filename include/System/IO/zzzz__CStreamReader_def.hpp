...
/// @brief Method .ctor addr 0x240b5c4 size 0x114 virtual false final false
 void _ctor(System::IO::Stream stream, System::Text::Encoding encoding) ;

/// @brief Method Peek addr 0x240b6d8 size 0x88 virtual true final false
 int32_t Peek() ;

/// @brief Method Read addr 0x240b760 size 0xd0 virtual true final false
 int32_t Read() ;

/// @brief Method Read addr 0x240b830 size 0x1b0 virtual true final false
 int32_t Read(ByRef<::ArrayW<char16_t>> dest, int32_t index, int32_t count) ;

/// @brief Method ReadLine addr 0x240b9e0 size 0x98 virtual true final false
 ::StringW ReadLine() ;

/// @brief Method ReadToEnd addr 0x240ba78 size 0x98 virtual true final false
 ::StringW ReadToEnd() ;
