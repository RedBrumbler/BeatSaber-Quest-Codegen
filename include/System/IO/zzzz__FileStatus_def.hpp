...
/// @brief Method get_InitiallyDirectory addr 0x23d52d4 size 0x8 virtual false final false
 bool get_InitiallyDirectory() ;

/// @brief Method set_InitiallyDirectory addr 0x23d52dc size 0xc virtual false final false
 void set_InitiallyDirectory(bool value) ;

/// @brief Method Initialize addr 0x23d52e8 size 0x14 virtual false final false
static void Initialize(ByRef<System::IO::FileStatus> status, bool isDirectory) ;

/// @brief Method IsReadOnly addr 0x23d52fc size 0xf0 virtual false final false
 bool IsReadOnly(System::ReadOnlySpan_1<char16_t> path, bool continueOnError) ;

/// @brief Method GetAttributes addr 0x23d54a8 size 0xe8 virtual false final false
 System::IO::FileAttributes GetAttributes(System::ReadOnlySpan_1<char16_t> path, System::ReadOnlySpan_1<char16_t> fileName) ;

/// @brief Method GetExists addr 0x23d5590 size 0x44 virtual false final false
 bool GetExists(System::ReadOnlySpan_1<char16_t> path) ;

/// @brief Method GetLastWriteTime addr 0x23d5768 size 0x9c virtual false final false
 System::DateTimeOffset GetLastWriteTime(System::ReadOnlySpan_1<char16_t> path, bool continueOnError) ;

/// @brief Method UnixTimeToDateTimeOffset addr 0x23d5804 size 0xb4 virtual false final false
 System::DateTimeOffset UnixTimeToDateTimeOffset(int64_t seconds, int64_t nanoseconds) ;

/// @brief Method GetLength addr 0x23d58b8 size 0x1c virtual false final false
 int64_t GetLength(System::ReadOnlySpan_1<char16_t> path, bool continueOnError) ;

/// @brief Method Refresh addr 0x23d55d4 size 0x194 virtual false final false
 void Refresh(System::ReadOnlySpan_1<char16_t> path) ;

/// @brief Method EnsureStatInitialized addr 0x23d53ec size 0xbc virtual false final false
