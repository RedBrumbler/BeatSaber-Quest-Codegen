...
/// @brief Method .ctor addr 0x2406818 size 0xd8 virtual false final false
 void _ctor(System::AsyncCallback cb, ::bs_hook::Il2CppWrapperType state) ;

/// @brief Method CBWrapper addr 0x2407854 size 0x94 virtual false final false
static void CBWrapper(System::IAsyncResult ares) ;

/// @brief Method get_AsyncState addr 0x24078e8 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType get_AsyncState() ;

/// @brief Method get_CompletedSynchronously addr 0x24078f0 size 0x8 virtual true final true
 bool get_CompletedSynchronously() ;

/// @brief Method get_AsyncWaitHandle addr 0x24078f8 size 0x8 virtual true final true
 System::Threading::WaitHandle get_AsyncWaitHandle() ;

/// @brief Method get_IsCompleted addr 0x2407900 size 0x8 virtual true final true
