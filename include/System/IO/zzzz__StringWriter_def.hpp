...
/// @brief Method .ctor addr 0x24021f4 size 0x94 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2402370 size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x2402288 size 0xe8 virtual false final false
 void _ctor(System::Text::StringBuilder sb, System::IFormatProvider formatProvider) ;

/// @brief Method Close addr 0x24023e4 size 0x10 virtual true final false
 void Close() ;

/// @brief Method Dispose addr 0x24023f4 size 0x10 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method get_Encoding addr 0x2402404 size 0xac virtual true final false
 System::Text::Encoding get_Encoding() ;

/// @brief Method Write addr 0x24024b0 size 0x28 virtual true final false
 void Write(char16_t value) ;

/// @brief Method Write addr 0x24024d8 size 0x188 virtual true final false
 void Write(::ArrayW<char16_t> buffer, int32_t index, int32_t count) ;

/// @brief Method Write addr 0x2402660 size 0x34 virtual true final false
 void Write(::StringW value) ;

/// @brief Method ToString addr 0x2402694 size 0x20 virtual true final false
 ::StringW ToString() ;
