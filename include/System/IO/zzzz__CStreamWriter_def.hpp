...
/// @brief Method .ctor addr 0x240bb10 size 0x128 virtual false final false
 void _ctor(System::IO::Stream stream, System::Text::Encoding encoding, bool leaveOpen) ;

/// @brief Method Write addr 0x240bc38 size 0x348 virtual true final false
 void Write(::ArrayW<char16_t> buffer, int32_t index, int32_t count) ;

/// @brief Method Write addr 0x240bf80 size 0x18c virtual true final false
 void Write(char16_t val) ;

/// @brief Method InternalWriteString addr 0x240c190 size 0x84 virtual false final false
 void InternalWriteString(::StringW val) ;

/// @brief Method InternalWriteChar addr 0x240c10c size 0x84 virtual false final false
 void InternalWriteChar(char16_t val) ;

/// @brief Method InternalWriteChars addr 0x240c214 size 0x8c virtual false final false
 void InternalWriteChars(::ArrayW<char16_t> buffer, int32_t n) ;

/// @brief Method Write addr 0x240c2a0 size 0x28 virtual true final false
 void Write(::ArrayW<char16_t> val) ;

/// @brief Method Write addr 0x240c2c8 size 0xcc virtual true final false
 void Write(::StringW val) ;

/// @brief Method WriteLine addr 0x240c394 size 0x44 virtual true final false
