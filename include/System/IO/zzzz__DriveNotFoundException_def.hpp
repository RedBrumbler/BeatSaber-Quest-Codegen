...
/// @brief Method .ctor addr 0x23d0cb0 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit DriveNotFoundException(::StringW message) ;

/// @brief Method .ctor addr 0x23d0d0c size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x23d0d30 size 0x8 virtual false final false
