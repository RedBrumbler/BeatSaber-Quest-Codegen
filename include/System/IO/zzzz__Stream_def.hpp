...
/// @brief Method ClearBeginState addr 0x23fcf48 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x23fad88 size 0x144 virtual false final false
...
/// @brief Method InvokeAsyncCallback addr 0x23fcf50 size 0x7c virtual false final false
static void InvokeAsyncCallback(::bs_hook::Il2CppWrapperType completedTask) ;

/// @brief Method System.Threading.Tasks.ITaskCompletionAction.Invoke addr 0x23fcfcc size 0x120 virtual true final true
 void System_Threading_Tasks_ITaskCompletionAction_Invoke(System::Threading::Tasks::Task completingTask) ;

/// @brief Method System.Threading.Tasks.ITaskCompletionAction.get_InvokeMayRunArbitraryCode addr 0x23fd0ec size 0x8 virtual true final true
...
/// @brief Method EnsureAsyncActiveSemaphoreInitialized addr 0x23fa44c size 0xf8 virtual false final false
...
/// @brief Method get_CanTimeout addr 0x23fa544 size 0x8 virtual true final false
 bool get_CanTimeout() ;
...
/// @brief Method get_ReadTimeout addr 0x23fa54c size 0x50 virtual true final false
 int32_t get_ReadTimeout() ;

/// @brief Method set_ReadTimeout addr 0x23fa59c size 0x50 virtual true final false
 void set_ReadTimeout(int32_t value) ;

/// @brief Method get_WriteTimeout addr 0x23fa5ec size 0x50 virtual true final false
 int32_t get_WriteTimeout() ;

/// @brief Method set_WriteTimeout addr 0x23fa63c size 0x50 virtual true final false
 void set_WriteTimeout(int32_t value) ;

/// @brief Method CopyToAsync addr 0x23fa68c size 0x2c virtual false final false
 System::Threading::Tasks::Task CopyToAsync(System::IO::Stream destination) ;

/// @brief Method CopyToAsync addr 0x23fa77c size 0x84 virtual false final false
 System::Threading::Tasks::Task CopyToAsync(System::IO::Stream destination, int32_t bufferSize) ;

/// @brief Method CopyToAsync addr 0x23fa800 size 0x44 virtual true final false
...
/// @brief Method CopyToAsyncInternal addr 0x23fa844 size 0xf8 virtual false final false
...
/// @brief Method GetCopyBufferSize addr 0x23fa6b8 size 0xc4 virtual false final false
 int32_t GetCopyBufferSize() ;

/// @brief Method Close addr 0x23fa93c size 0x70 virtual true final false
 void Close() ;

/// @brief Method Dispose addr 0x23fa9ac size 0x10 virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x23fa9bc size 0x4 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Flush addr 0x0 size 0xffffffffffffffff virtual true final false
 void Flush() ;

/// @brief Method FlushAsync addr 0x23fa9c0 size 0x1c4 virtual true final false
 System::Threading::Tasks::Task FlushAsync(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method BeginRead addr 0x23fab84 size 0x20 virtual true final false
...
/// @brief Method BeginReadInternal addr 0x23faba4 size 0x1e4 virtual false final false
...
/// @brief Method EndRead addr 0x23fb104 size 0x1cc virtual true final false
 int32_t EndRead(System::IAsyncResult asyncResult) ;

/// @brief Method ReadAsync addr 0x23fb2d0 size 0x94 virtual false final false
 System::Threading::Tasks::Task_1<int32_t> ReadAsync(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method ReadAsync addr 0x23fb364 size 0xbc virtual true final false
...
/// @brief Method ReadAsync addr 0x23fb5d8 size 0x260 virtual true final false
...
/// @brief Method BeginEndReadAsync addr 0x23fb420 size 0x1b8 virtual false final false
 System::Threading::Tasks::Task_1<int32_t> BeginEndReadAsync(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method BeginWrite addr 0x23fb940 size 0x20 virtual true final false
...
/// @brief Method BeginWriteInternal addr 0x23fb960 size 0x1e4 virtual false final false
...
/// @brief Method RunReadWriteTaskWhenReady addr 0x23faecc size 0x184 virtual false final false
...
/// @brief Method RunReadWriteTask addr 0x23fb050 size 0xb4 virtual false final false
 void RunReadWriteTask(System::IO::System__IO__Stream__ReadWriteTask readWriteTask) ;

/// @brief Method FinishTrackingAsyncOperation addr 0x23fbb44 size 0x24 virtual false final false
 void FinishTrackingAsyncOperation() ;

/// @brief Method EndWrite addr 0x23fbb68 size 0x1bc virtual true final false
 void EndWrite(System::IAsyncResult asyncResult) ;

/// @brief Method WriteAsync addr 0x23fbd24 size 0x94 virtual false final false
 System::Threading::Tasks::Task WriteAsync(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method WriteAsync addr 0x23fbdb8 size 0xa8 virtual true final false
...
/// @brief Method WriteAsync addr 0x23fc018 size 0x278 virtual true final false
...
/// @brief Method FinishWriteAsync addr 0x23fc290 size 0xd8 virtual false final false
 System::Threading::Tasks::Task FinishWriteAsync(System::Threading::Tasks::Task writeTask, ::ArrayW<uint8_t> localBuffer) ;

/// @brief Method BeginEndWriteAsync addr 0x23fbe60 size 0x1b8 virtual false final false
...
/// @brief Method Read addr 0x23fc370 size 0x288 virtual true final false
 int32_t Read(System::Span_1<uint8_t> buffer) ;

/// @brief Method ReadByte addr 0x23fc5f8 size 0x94 virtual true final false
 int32_t ReadByte() ;
...
/// @brief Method Write addr 0x23fc68c size 0x1c8 virtual true final false
 void Write(System::ReadOnlySpan_1<uint8_t> buffer) ;

/// @brief Method WriteByte addr 0x23fc854 size 0x8c virtual true final false
 void WriteByte(uint8_t value) ;

/// @brief Method BlockingBeginRead addr 0x23fc8e0 size 0x184 virtual false final false
...
/// @brief Method BlockingEndRead addr 0x23fcae0 size 0x4 virtual false final false
static int32_t BlockingEndRead(System::IAsyncResult asyncResult) ;

/// @brief Method BlockingBeginWrite addr 0x23fcbd4 size 0x178 virtual false final false
...
/// @brief Method BlockingEndWrite addr 0x23fcd7c size 0x4 virtual false final false
static void BlockingEndWrite(System::IAsyncResult asyncResult) ;

/// @brief Method HasOverriddenBeginEndRead addr 0x23fb938 size 0x8 virtual false final false
 bool HasOverriddenBeginEndRead() ;

/// @brief Method HasOverriddenBeginEndWrite addr 0x23fc368 size 0x8 virtual false final false
 bool HasOverriddenBeginEndWrite() ;

// Ctor Parameters []
explicit Stream() ;

/// @brief Method .ctor addr 0x23fce74 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ReadAsync>g__FinishReadAsync|44_0 addr 0x23fb838 size 0x100 virtual false final false
...
/// @brief Method .ctor addr 0x23fcef0 size 0x58 virtual false final false
 void _ctor() ;

/// @brief Method get_CanRead addr 0x23fd0f4 size 0x8 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanWrite addr 0x23fd0fc size 0x8 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_CanSeek addr 0x23fd104 size 0x8 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_Length addr 0x23fd10c size 0x8 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x23fd114 size 0x8 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x23fd11c size 0x4 virtual true final false
 void set_Position(int64_t value) ;

/// @brief Method CopyToAsync addr 0x23fd120 size 0xe8 virtual true final false
 System::Threading::Tasks::Task CopyToAsync(System::IO::Stream destination, int32_t bufferSize, System::Threading::CancellationToken cancellationToken) ;

/// @brief Method Dispose addr 0x23fd208 size 0x4 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Flush addr 0x23fd20c size 0x4 virtual true final false
 void Flush() ;

/// @brief Method FlushAsync addr 0x23fd210 size 0xc0 virtual true final false
 System::Threading::Tasks::Task FlushAsync(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method BeginRead addr 0x23fd2d0 size 0x8c virtual true final false
 System::IAsyncResult BeginRead(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count, System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType state) ;

/// @brief Method EndRead addr 0x23fd35c size 0xa4 virtual true final false
 int32_t EndRead(System::IAsyncResult asyncResult) ;

/// @brief Method BeginWrite addr 0x23fd400 size 0x8c virtual true final false
 System::IAsyncResult BeginWrite(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count, System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType state) ;

/// @brief Method EndWrite addr 0x23fd48c size 0xa4 virtual true final false
 void EndWrite(System::IAsyncResult asyncResult) ;

/// @brief Method Read addr 0x23fd530 size 0x8 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Read addr 0x23fd538 size 0x8 virtual true final false
 int32_t Read(System::Span_1<uint8_t> buffer) ;

/// @brief Method ReadAsync addr 0x23fd540 size 0x58 virtual true final false
 System::Threading::Tasks::Task_1<int32_t> ReadAsync(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count, System::Threading::CancellationToken cancellationToken) ;

/// @brief Method ReadAsync addr 0x23fd598 size 0x34 virtual true final false
 System::Threading::Tasks::ValueTask_1<int32_t> ReadAsync(System::Memory_1<uint8_t> buffer, System::Threading::CancellationToken cancellationToken) ;

/// @brief Method ReadByte addr 0x23fd5cc size 0x8 virtual true final false
 int32_t ReadByte() ;

/// @brief Method Write addr 0x23fd5d4 size 0x4 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Write addr 0x23fd5d8 size 0x4 virtual true final false
 void Write(System::ReadOnlySpan_1<uint8_t> buffer) ;

/// @brief Method WriteAsync addr 0x23fd5dc size 0xc0 virtual true final false
 System::Threading::Tasks::Task WriteAsync(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count, System::Threading::CancellationToken cancellationToken) ;

/// @brief Method WriteAsync addr 0x23fd69c size 0x94 virtual true final false
 System::Threading::Tasks::ValueTask WriteAsync(System::ReadOnlyMemory_1<uint8_t> buffer, System::Threading::CancellationToken cancellationToken) ;

/// @brief Method WriteByte addr 0x23fd730 size 0x4 virtual true final false
 void WriteByte(uint8_t value) ;

/// @brief Method Seek addr 0x23fd734 size 0x8 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0x23fd73c size 0x4 virtual true final false
...
/// @brief Method .ctor addr 0x23fd954 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <get_AsyncWaitHandle>b__12_0 addr 0x23fd95c size 0x60 virtual false final false
...
/// @brief Method .ctor addr 0x23fca64 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x23fcd4c size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x23fca94 size 0x4c virtual false final false
 void _ctor(System::Exception ex, ::bs_hook::Il2CppWrapperType asyncStateObject, bool isWrite) ;

/// @brief Method get_IsCompleted addr 0x23fd7cc size 0x8 virtual true final true
 bool get_IsCompleted() ;

/// @brief Method get_AsyncWaitHandle addr 0x23fd7d4 size 0xf8 virtual true final true
 System::Threading::WaitHandle get_AsyncWaitHandle() ;

/// @brief Method get_AsyncState addr 0x23fd8cc size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType get_AsyncState() ;

/// @brief Method get_CompletedSynchronously addr 0x23fd8d4 size 0x8 virtual true final true
 bool get_CompletedSynchronously() ;

/// @brief Method ThrowIfError addr 0x23fd8dc size 0x14 virtual false final false
 void ThrowIfError() ;

/// @brief Method EndRead addr 0x23fcae4 size 0xf0 virtual false final false
static int32_t EndRead(System::IAsyncResult asyncResult) ;

/// @brief Method EndWrite addr 0x23fcd80 size 0xf4 virtual false final false
...
/// @brief Method .ctor addr 0x23fda20 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <EnsureAsyncActiveSemaphoreInitialized>b__4_0 addr 0x23fda28 size 0x64 virtual false final false
 System::Threading::SemaphoreSlim _EnsureAsyncActiveSemaphoreInitialized_b__4_0() ;

/// @brief Method <FlushAsync>b__37_0 addr 0x23fda8c size 0xb0 virtual false final false
 void _FlushAsync_b__37_0(::bs_hook::Il2CppWrapperType state) ;

/// @brief Method <BeginReadInternal>b__40_0 addr 0x23fdb3c size 0x190 virtual false final false
 int32_t _BeginReadInternal_b__40_0(::bs_hook::Il2CppWrapperType _p0_) ;

/// @brief Method <BeginEndReadAsync>b__45_0 addr 0x23fdccc size 0x34 virtual false final false
...
/// @brief Method <BeginEndReadAsync>b__45_1 addr 0x23fdd00 size 0x2c virtual false final false
 int32_t _BeginEndReadAsync_b__45_1(System::IO::Stream stream, System::IAsyncResult asyncResult) ;

/// @brief Method <BeginWriteInternal>b__48_0 addr 0x23fdd2c size 0x180 virtual false final false
 int32_t _BeginWriteInternal_b__48_0(::bs_hook::Il2CppWrapperType _p0_) ;

/// @brief Method <RunReadWriteTaskWhenReady>b__49_0 addr 0x23fdeac size 0x6c virtual false final false
 void _RunReadWriteTaskWhenReady_b__49_0(System::Threading::Tasks::Task t, ::bs_hook::Il2CppWrapperType state) ;

/// @brief Method <BeginEndWriteAsync>b__58_0 addr 0x23fdf18 size 0x34 virtual false final false
...
/// @brief Method <BeginEndWriteAsync>b__58_1 addr 0x23fdf4c size 0x34 virtual false final false
...
/// @brief Method MoveNext addr 0x23fdf80 size 0x6dc virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x23fe65c size 0xc virtual true final true
...
/// @brief Method MoveNext addr 0x23fe668 size 0x20c virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x23fe874 size 0xc virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
...
/// @brief Method MoveNext addr 0x23fe880 size 0x394 virtual true final true
 void MoveNext() ;

/// @brief Method SetStateMachine addr 0x23fec14 size 0x58 virtual true final true
 void SetStateMachine(System::Runtime::CompilerServices::IAsyncStateMachine stateMachine) ;
