...
/// @brief Method .ctor addr 0x23ff678 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x23ff970 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x23ff6f0 size 0x280 virtual false final false
 void _ctor(System::IO::Stream input, System::Text::Encoding encoding, bool leaveOpen) ;

/// @brief Method get_BaseStream addr 0x23ff978 size 0x8 virtual true final false
 System::IO::Stream get_BaseStream() ;

/// @brief Method Close addr 0x23ff980 size 0x10 virtual true final false
 void Close() ;

/// @brief Method Dispose addr 0x23ff990 size 0x44 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Dispose addr 0x23ff9d4 size 0x10 virtual true final true
 void Dispose() ;

/// @brief Method Read addr 0x23ff9e4 size 0x18 virtual true final false
 int32_t Read() ;

/// @brief Method ReadBoolean addr 0x23ffc64 size 0x48 virtual true final false
 bool ReadBoolean() ;

/// @brief Method ReadByte addr 0x23ffcac size 0x34 virtual true final false
 uint8_t ReadByte() ;

/// @brief Method ReadSByte addr 0x23ffce0 size 0x40 virtual true final false
 int8_t ReadSByte() ;

/// @brief Method ReadChar addr 0x23ffd20 size 0x24 virtual true final false
 char16_t ReadChar() ;

/// @brief Method ReadInt16 addr 0x23ffd44 size 0x48 virtual true final false
 int16_t ReadInt16() ;

/// @brief Method ReadUInt16 addr 0x23ffd8c size 0x48 virtual true final false
 uint16_t ReadUInt16() ;

/// @brief Method ReadInt32 addr 0x23ffdd4 size 0xf4 virtual true final false
 int32_t ReadInt32() ;

/// @brief Method ReadUInt32 addr 0x23ffec8 size 0x70 virtual true final false
 uint32_t ReadUInt32() ;

/// @brief Method ReadInt64 addr 0x23fff38 size 0xb0 virtual true final false
 int64_t ReadInt64() ;

/// @brief Method ReadUInt64 addr 0x23fffe8 size 0xb0 virtual true final false
 uint64_t ReadUInt64() ;

/// @brief Method ReadSingle addr 0x2400098 size 0x30 virtual true final false
 float_t ReadSingle() ;

/// @brief Method ReadDouble addr 0x24000c8 size 0x30 virtual true final false
 double_t ReadDouble() ;

/// @brief Method ReadDecimal addr 0x24000f8 size 0x214 virtual true final false
 System::Decimal ReadDecimal() ;

/// @brief Method ReadString addr 0x240030c size 0x298 virtual true final false
 ::StringW ReadString() ;

/// @brief Method InternalReadChars addr 0x240064c size 0x2f8 virtual false final false
 int32_t InternalReadChars(::ArrayW<char16_t> buffer, int32_t index, int32_t count) ;

/// @brief Method InternalReadOneChar addr 0x23ff9fc size 0x268 virtual false final false
 int32_t InternalReadOneChar() ;

/// @brief Method ReadChars addr 0x2400944 size 0x160 virtual true final false
 ::ArrayW<char16_t> ReadChars(int32_t count) ;

/// @brief Method Read addr 0x2400aa4 size 0x184 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t index, int32_t count) ;

/// @brief Method ReadBytes addr 0x2400c28 size 0x190 virtual true final false
 ::ArrayW<uint8_t> ReadBytes(int32_t count) ;

/// @brief Method FillBuffer addr 0x2400db8 size 0x124 virtual true final false
 void FillBuffer(int32_t numBytes) ;

/// @brief Method Read7BitEncodedInt addr 0x24005a4 size 0xa8 virtual false final false
