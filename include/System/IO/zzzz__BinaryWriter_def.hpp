...
/// @brief Method .ctor addr 0x2400edc size 0xec virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2400fc8 size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x24011c0 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2401048 size 0x178 virtual false final false
 void _ctor(System::IO::Stream output, System::Text::Encoding encoding, bool leaveOpen) ;

/// @brief Method Close addr 0x24011c8 size 0x10 virtual true final false
 void Close() ;

/// @brief Method Dispose addr 0x24011d8 size 0x48 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Dispose addr 0x2401220 size 0x10 virtual true final true
 void Dispose() ;

/// @brief Method Flush addr 0x2401230 size 0x24 virtual true final false
 void Flush() ;

/// @brief Method Write addr 0x2401254 size 0x50 virtual true final false
 void Write(bool value) ;

/// @brief Method Write addr 0x24012a4 size 0x24 virtual true final false
 void Write(uint8_t value) ;

/// @brief Method Write addr 0x24012c8 size 0x24 virtual true final false
 void Write(int8_t value) ;

/// @brief Method Write addr 0x24012ec size 0x7c virtual true final false
 void Write(::ArrayW<uint8_t> buffer) ;

/// @brief Method Write addr 0x2401368 size 0x24 virtual true final false
 void Write(::ArrayW<uint8_t> buffer, int32_t index, int32_t count) ;

/// @brief Method Write addr 0x240138c size 0x12c virtual true final false
 void Write(char16_t ch) ;

/// @brief Method Write addr 0x24014b8 size 0xa8 virtual true final false
 void Write(::ArrayW<char16_t> chars) ;

/// @brief Method Write addr 0x2401560 size 0x3c virtual true final false
 void Write(double_t value) ;

/// @brief Method Write addr 0x240159c size 0x68 virtual true final false
 void Write(int16_t value) ;

/// @brief Method Write addr 0x2401604 size 0x68 virtual true final false
 void Write(uint16_t value) ;

/// @brief Method Write addr 0x240166c size 0xa0 virtual true final false
 void Write(int32_t value) ;

/// @brief Method Write addr 0x240170c size 0xa0 virtual true final false
 void Write(uint32_t value) ;

/// @brief Method Write addr 0x24017ac size 0x110 virtual true final false
 void Write(int64_t value) ;

/// @brief Method Write addr 0x24018bc size 0x110 virtual true final false
 void Write(uint64_t value) ;

/// @brief Method Write addr 0x24019cc size 0x3c virtual true final false
 void Write(float_t value) ;

/// @brief Method Write addr 0x2401a08 size 0x2b4 virtual true final false
 void Write(::StringW value) ;

/// @brief Method Write7BitEncodedInt addr 0x2401cbc size 0x60 virtual false final false
