...
/// @brief Method .ctor addr 0x240a74c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <JoinInternal>b__56_0 addr 0x240a754 size 0x1a0 virtual false final false
...
/// @brief Method <JoinInternal>b__57_0 addr 0x240a8f4 size 0x264 virtual false final false
...
/// @brief Method ChangeExtension addr 0x2407c38 size 0x1fc virtual false final false
static ::StringW ChangeExtension(::StringW path, ::StringW extension) ;

/// @brief Method Combine addr 0x2407ec8 size 0x26c virtual false final false
static ::StringW Combine(::StringW path1, ::StringW path2) ;

/// @brief Method CleanPath addr 0x240825c size 0x440 virtual false final false
static ::StringW CleanPath(::StringW s) ;

/// @brief Method GetDirectoryName addr 0x2403a80 size 0x360 virtual false final false
static ::StringW GetDirectoryName(::StringW path) ;

/// @brief Method GetDirectoryName addr 0x2408acc size 0xd0 virtual false final false
static System::ReadOnlySpan_1<char16_t> GetDirectoryName(System::ReadOnlySpan_1<char16_t> path) ;

/// @brief Method GetExtension addr 0x2408b9c size 0x12c virtual false final false
static ::StringW GetExtension(::StringW path) ;

/// @brief Method GetFileName addr 0x23fef64 size 0x110 virtual false final false
static ::StringW GetFileName(::StringW path) ;

/// @brief Method GetFileNameWithoutExtension addr 0x2408cc8 size 0x5c virtual false final false
static ::StringW GetFileNameWithoutExtension(::StringW path) ;

/// @brief Method GetFullPath addr 0x2403de0 size 0x68 virtual false final false
static ::StringW GetFullPath(::StringW path) ;

/// @brief Method GetFullPathInternal addr 0x2408d24 size 0x54 virtual false final false
static ::StringW GetFullPathInternal(::StringW path) ;

/// @brief Method InsecureGetFullPath addr 0x2403384 size 0x654 virtual false final false
static ::StringW InsecureGetFullPath(::StringW path) ;

/// @brief Method IsDirectorySeparator addr 0x23feed8 size 0x8c virtual false final false
static bool IsDirectorySeparator(char16_t c) ;

/// @brief Method GetPathRoot addr 0x240869c size 0x430 virtual false final false
static ::StringW GetPathRoot(::StringW path) ;

/// @brief Method GetTempPath addr 0x2409198 size 0xe8 virtual false final false
static ::StringW GetTempPath() ;

/// @brief Method get_temp_path addr 0x2409280 size 0x4 virtual false final false
static ::StringW get_temp_path() ;

/// @brief Method IsPathRooted addr 0x2409284 size 0x104 virtual false final false
static bool IsPathRooted(System::ReadOnlySpan_1<char16_t> path) ;

/// @brief Method IsPathRooted addr 0x2408134 size 0x128 virtual false final false
static bool IsPathRooted(::StringW path) ;

/// @brief Method GetInvalidPathChars addr 0x2409388 size 0x94 virtual false final false
static ::ArrayW<char16_t> GetInvalidPathChars() ;

/// @brief Method GetRandomFileName addr 0x240941c size 0x164 virtual false final false
static ::StringW GetRandomFileName() ;

/// @brief Method findExtension addr 0x2407e34 size 0x94 virtual false final false
static int32_t findExtension(::StringW path) ;

/// @brief Method CanonicalizePath addr 0x2408d78 size 0x420 virtual false final false
static ::StringW CanonicalizePath(::StringW path) ;

/// @brief Method Combine addr 0x2409728 size 0x2ec virtual false final false
static ::StringW Combine(::ArrayW<::StringW> paths) ;

/// @brief Method Combine addr 0x2409a14 size 0x1a8 virtual false final false
static ::StringW Combine(::StringW path1, ::StringW path2, ::StringW path3) ;

/// @brief Method GetFileName addr 0x2409bbc size 0x14c virtual false final false
static System::ReadOnlySpan_1<char16_t> GetFileName(System::ReadOnlySpan_1<char16_t> path) ;

/// @brief Method Join addr 0x2409d08 size 0xb8 virtual false final false
static ::StringW Join(System::ReadOnlySpan_1<char16_t> path1, System::ReadOnlySpan_1<char16_t> path2) ;

/// @brief Method Join addr 0x240a03c size 0x110 virtual false final false
...
/// @brief Method TryJoin addr 0x240a4b4 size 0x234 virtual false final false
...
/// @brief Method JoinInternal addr 0x2409dc0 size 0x27c virtual false final false
static ::StringW JoinInternal(System::ReadOnlySpan_1<char16_t> first, System::ReadOnlySpan_1<char16_t> second) ;

/// @brief Method JoinInternal addr 0x240a14c size 0x368 virtual false final false
