...
/// @brief Method CheckAsyncTaskInProgress addr 0x23cc37c size 0x64 virtual false final false
 void CheckAsyncTaskInProgress() ;

/// @brief Method ThrowAsyncIOInProgress addr 0x23cc3e0 size 0x50 virtual false final false
static void ThrowAsyncIOInProgress() ;

/// @brief Method get_UTF8NoBOM addr 0x23cc430 size 0x50 virtual false final false
static System::Text::Encoding get_UTF8NoBOM() ;

// Ctor Parameters []
explicit StreamWriter() ;

/// @brief Method .ctor addr 0x23cc480 size 0xbc virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x23cc5c4 size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x23cc850 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x23cc85c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x23cc638 size 0x218 virtual false final false
...
/// @brief Method .ctor addr 0x23cc99c size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x23ccc60 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x23cca10 size 0x250 virtual false final false
 void _ctor(::StringW path, bool append, System::Text::Encoding encoding, int32_t bufferSize) ;

/// @brief Method Init addr 0x23cc864 size 0x138 virtual false final false
 void Init(System::IO::Stream streamArg, System::Text::Encoding encodingArg, int32_t bufferSize, bool shouldLeaveOpen) ;

/// @brief Method Close addr 0x23ccd54 size 0x6c virtual true final false
 void Close() ;

/// @brief Method Dispose addr 0x23ccdc0 size 0x94 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Flush addr 0x23ccfd4 size 0x20 virtual true final false
 void Flush() ;

/// @brief Method Flush addr 0x23cce54 size 0x180 virtual false final false
 void Flush(bool flushStream, bool flushEncoder) ;

/// @brief Method set_AutoFlush addr 0x23ccff4 size 0x44 virtual true final false
 void set_AutoFlush(bool value) ;

/// @brief Method get_LeaveOpen addr 0x23cd038 size 0x10 virtual false final false
 bool get_LeaveOpen() ;

/// @brief Method get_Encoding addr 0x23cd048 size 0x8 virtual true final false
 System::Text::Encoding get_Encoding() ;

/// @brief Method Write addr 0x23cd050 size 0x8c virtual true final false
 void Write(char16_t value) ;

/// @brief Method Write addr 0x23cd0dc size 0x268 virtual true final false
 void Write(::ArrayW<char16_t> buffer) ;

/// @brief Method Write addr 0x23cd344 size 0x3d8 virtual true final false
 void Write(::ArrayW<char16_t> buffer, int32_t index, int32_t count) ;

/// @brief Method WriteSpan addr 0x23cd71c size 0x2c8 virtual false final false
 void WriteSpan(System::ReadOnlySpan_1<char16_t> buffer, bool appendNewLine) ;

/// @brief Method Write addr 0x23cd9e4 size 0x26c virtual true final false
 void Write(::StringW value) ;

/// @brief Method WriteLine addr 0x23cdc50 size 0x2fc virtual true final false
