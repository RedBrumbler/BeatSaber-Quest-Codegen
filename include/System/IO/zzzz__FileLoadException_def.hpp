...
/// @brief Method .ctor addr 0x23c5de4 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit FileLoadException(::StringW message) ;

/// @brief Method .ctor addr 0x23c5e40 size 0x24 virtual false final false
 void _ctor(::StringW message) ;

/// @brief Method get_Message addr 0x23c5e64 size 0x24 virtual true final false
 ::StringW get_Message() ;

/// @brief Method get_FileName addr 0x23c5efc size 0x8 virtual false final false
 ::StringW get_FileName() ;

/// @brief Method get_FusionLog addr 0x23c5f04 size 0x8 virtual false final false
 ::StringW get_FusionLog() ;

/// @brief Method ToString addr 0x23c5f0c size 0x1e4 virtual true final false
 ::StringW ToString() ;
...
/// @brief Method .ctor addr 0x23c60f0 size 0xb0 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method GetObjectData addr 0x23c61a0 size 0x118 virtual true final false
 void GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method FormatFileLoadExceptionMessage addr 0x23c5e88 size 0x74 virtual false final false
