...
/// @brief Method .ctor addr 0x23c9c74 size 0xb4 virtual false final false
 void _ctor(::ArrayW<uint8_t> array) ;

/// @brief Method Read addr 0x23c9f94 size 0x4 virtual true final false
 int32_t Read(System::Span_1<uint8_t> buffer) ;

/// @brief Method Write addr 0x23ca1c4 size 0x4 virtual true final false
 void Write(System::ReadOnlySpan_1<uint8_t> buffer) ;

/// @brief Method Finalize addr 0x23ca4c4 size 0xa4 virtual true final false
 void Finalize() ;

/// @brief Method Dispose addr 0x23ca568 size 0x50 virtual true final false
