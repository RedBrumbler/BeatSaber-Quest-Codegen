...
/// @brief Method EndOfFile addr 0x23fec6c size 0x60 virtual false final false
static void EndOfFile() ;

/// @brief Method FileNotOpen addr 0x23feccc size 0x64 virtual false final false
static void FileNotOpen() ;

/// @brief Method ReaderClosed addr 0x23fed30 size 0x64 virtual false final false
static void ReaderClosed() ;

/// @brief Method GetDisplayablePath addr 0x23fed94 size 0x144 virtual false final false
static ::StringW GetDisplayablePath(::StringW path, bool isInvalidPath) ;

/// @brief Method WinIOError addr 0x23ff074 size 0x5a0 virtual false final false
static void WinIOError(int32_t errorCode, ::StringW maybeFullPath) ;

/// @brief Method WriterClosed addr 0x23ff614 size 0x64 virtual false final false
