...
/// @brief Method Initialize addr 0x240c3e0 size 0x280 virtual false final false
...
/// @brief Method get_FullPath addr 0x240c660 size 0x130 virtual false final false
 System::ReadOnlySpan_1<char16_t> get_FullPath() ;

/// @brief Method get_FileName addr 0x240c790 size 0x94 virtual false final false
 System::ReadOnlySpan_1<char16_t> get_FileName() ;

/// @brief Method get_Directory addr 0x240c824 size 0x10 virtual false final false
 System::ReadOnlySpan_1<char16_t> get_Directory() ;

/// @brief Method set_Directory addr 0x240c834 size 0xc virtual false final false
 void set_Directory(System::ReadOnlySpan_1<char16_t> value) ;

/// @brief Method get_RootDirectory addr 0x240c840 size 0x10 virtual false final false
 System::ReadOnlySpan_1<char16_t> get_RootDirectory() ;

/// @brief Method set_RootDirectory addr 0x240c850 size 0xc virtual false final false
 void set_RootDirectory(System::ReadOnlySpan_1<char16_t> value) ;

/// @brief Method get_OriginalRootDirectory addr 0x240c85c size 0x10 virtual false final false
 System::ReadOnlySpan_1<char16_t> get_OriginalRootDirectory() ;

/// @brief Method set_OriginalRootDirectory addr 0x240c86c size 0xc virtual false final false
 void set_OriginalRootDirectory(System::ReadOnlySpan_1<char16_t> value) ;

/// @brief Method get_Attributes addr 0x240c878 size 0x48 virtual false final false
 System::IO::FileAttributes get_Attributes() ;

/// @brief Method get_IsDirectory addr 0x240c8c0 size 0x8 virtual false final false
 bool get_IsDirectory() ;

/// @brief Method ToFileSystemInfo addr 0x240c8c8 size 0x70 virtual false final false
 System::IO::FileSystemInfo ToFileSystemInfo() ;

/// @brief Method ToFullPath addr 0x240c938 size 0x28 virtual false final false
 ::StringW ToFullPath() ;

/// @brief Method ToSpecifiedFullPath addr 0x240c960 size 0x184 virtual false final false
