...
/// @brief Method .ctor addr 0x2405c70 size 0xd8 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x240782c size 0x14 virtual true final false
 int32_t Invoke(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method BeginInvoke addr 0x2405d48 size 0xa8 virtual true final false
...
/// @brief Method EndInvoke addr 0x2405f54 size 0x28 virtual true final false
...
/// @brief Method .ctor addr 0x24068f0 size 0xd8 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x2407840 size 0x14 virtual true final false
 void Invoke(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method BeginInvoke addr 0x24069c8 size 0xa8 virtual true final false
 System::IAsyncResult BeginInvoke(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count, System::AsyncCallback callback, ::bs_hook::Il2CppWrapperType object) ;

/// @brief Method EndInvoke addr 0x2406bd8 size 0xc virtual true final false
...
/// @brief Method .ctor addr 0x24026b4 size 0x10 virtual false final false
...
/// @brief Method .ctor addr 0x24026c4 size 0x1ac virtual false final false
...
/// @brief Method .ctor addr 0x2402b58 size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x24032b4 size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x24032f8 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x240331c size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0x240333c size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x2403364 size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0x24032e0 size 0x18 virtual false final false
...
/// @brief Method .ctor addr 0x2402b8c size 0x728 virtual false final false
...
/// @brief Method Init addr 0x2402870 size 0x2e8 virtual false final false
...
/// @brief Method get_CanRead addr 0x2404b94 size 0x14 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanWrite addr 0x2404ba8 size 0x14 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_CanSeek addr 0x2404bbc size 0x8 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_Length addr 0x2404bc4 size 0x164 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x2404e60 size 0x170 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x2404fd0 size 0x90 virtual true final false
 void set_Position(int64_t value) ;

/// @brief Method get_SafeFileHandle addr 0x2405060 size 0x3c virtual true final false
 Microsoft::Win32::SafeHandles::SafeFileHandle get_SafeFileHandle() ;

/// @brief Method ExposeHandle addr 0x2404a2c size 0x28 virtual false final false
 void ExposeHandle() ;

/// @brief Method ReadByte addr 0x2405214 size 0x148 virtual true final false
 int32_t ReadByte() ;

/// @brief Method WriteByte addr 0x24054b4 size 0x15c virtual true final false
 void WriteByte(uint8_t value) ;

/// @brief Method Read addr 0x2405610 size 0x268 virtual true final false
 int32_t Read(ByRef<::ArrayW<uint8_t>> array, int32_t offset, int32_t count) ;

/// @brief Method ReadInternal addr 0x2405878 size 0x9c virtual false final false
 int32_t ReadInternal(::ArrayW<uint8_t> dest, int32_t offset, int32_t count) ;

/// @brief Method BeginRead addr 0x24059cc size 0x2a4 virtual true final false
...
/// @brief Method EndRead addr 0x2405df0 size 0x164 virtual true final false
 int32_t EndRead(System::IAsyncResult asyncResult) ;

/// @brief Method Write addr 0x2405f7c size 0x23c virtual true final false
 void Write(::ArrayW<uint8_t> array, int32_t offset, int32_t count) ;

/// @brief Method WriteInternal addr 0x24061b8 size 0x1b4 virtual false final false
 void WriteInternal(::ArrayW<uint8_t> src, int32_t offset, int32_t count) ;

/// @brief Method BeginWrite addr 0x240652c size 0x2ec virtual true final false
...
/// @brief Method EndWrite addr 0x2406a70 size 0x168 virtual true final false
 void EndWrite(System::IAsyncResult asyncResult) ;

/// @brief Method Seek addr 0x2406be4 size 0x264 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0x2406e48 size 0x210 virtual true final false
 void SetLength(int64_t value) ;

/// @brief Method Flush addr 0x2407188 size 0x78 virtual true final false
 void Flush() ;

/// @brief Method Finalize addr 0x2407200 size 0xa4 virtual true final false
 void Finalize() ;

/// @brief Method Dispose addr 0x24072a4 size 0x334 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method FlushAsync addr 0x24075dc size 0x88 virtual true final false
 System::Threading::Tasks::Task FlushAsync(System::Threading::CancellationToken cancellationToken) ;

/// @brief Method ReadAsync addr 0x2407664 size 0x4 virtual true final false
...
/// @brief Method WriteAsync addr 0x2407668 size 0x4 virtual true final false
...
/// @brief Method ReadSegment addr 0x2405914 size 0xb8 virtual false final false
 int32_t ReadSegment(::ArrayW<uint8_t> dest, int32_t dest_offset, int32_t count) ;

/// @brief Method WriteSegment addr 0x24064b4 size 0x78 virtual false final false
 int32_t WriteSegment(::ArrayW<uint8_t> src, int32_t src_offset, int32_t count) ;

/// @brief Method FlushBuffer addr 0x240509c size 0x178 virtual false final false
 void FlushBuffer() ;

/// @brief Method FlushBufferIfDirty addr 0x2404d28 size 0x10 virtual false final false
 void FlushBufferIfDirty() ;

/// @brief Method RefillBuffer addr 0x2405484 size 0x30 virtual false final false
 void RefillBuffer() ;

/// @brief Method ReadData addr 0x240535c size 0x128 virtual false final false
 int32_t ReadData(System::Runtime::InteropServices::SafeHandle safeHandle, ::ArrayW<uint8_t> buf, int32_t offset, int32_t count) ;

/// @brief Method InitBuffer addr 0x24047a0 size 0x28c virtual false final false
 void InitBuffer(int32_t size, bool isZeroSize) ;

/// @brief Method GetSecureFileName addr 0x2403ee4 size 0x78 virtual false final false
 ::StringW GetSecureFileName(::StringW filename) ;

/// @brief Method GetSecureFileName addr 0x24039d8 size 0xa8 virtual false final false
