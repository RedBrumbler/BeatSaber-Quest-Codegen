...
/// @brief Method get_Compatible addr 0x23d2890 size 0x58 virtual false final false
static System::IO::EnumerationOptions get_Compatible() ;

/// @brief Method get_CompatibleRecursive addr 0x23d28e8 size 0x58 virtual false final false
static System::IO::EnumerationOptions get_CompatibleRecursive() ;

/// @brief Method get_Default addr 0x23d2940 size 0x58 virtual false final false
static System::IO::EnumerationOptions get_Default() ;

// Ctor Parameters []
explicit EnumerationOptions() ;

/// @brief Method .ctor addr 0x23d2998 size 0x28 virtual false final false
 void _ctor() ;

/// @brief Method FromSearchOption addr 0x23d1a40 size 0x13c virtual false final false
static System::IO::EnumerationOptions FromSearchOption(System::IO::SearchOption searchOption) ;

/// @brief Method get_RecurseSubdirectories addr 0x23d29c0 size 0x8 virtual false final false
 bool get_RecurseSubdirectories() ;

/// @brief Method set_RecurseSubdirectories addr 0x23d29c8 size 0xc virtual false final false
 void set_RecurseSubdirectories(bool value) ;

/// @brief Method get_IgnoreInaccessible addr 0x23d29d4 size 0x8 virtual false final false
 bool get_IgnoreInaccessible() ;

/// @brief Method set_IgnoreInaccessible addr 0x23d29dc size 0xc virtual false final false
 void set_IgnoreInaccessible(bool value) ;

/// @brief Method get_AttributesToSkip addr 0x23d29e8 size 0x8 virtual false final false
 System::IO::FileAttributes get_AttributesToSkip() ;

/// @brief Method set_AttributesToSkip addr 0x23d29f0 size 0x8 virtual false final false
 void set_AttributesToSkip(System::IO::FileAttributes value) ;

/// @brief Method get_MatchType addr 0x23d29f8 size 0x8 virtual false final false
 System::IO::MatchType get_MatchType() ;

/// @brief Method set_MatchType addr 0x23d2a00 size 0x8 virtual false final false
 void set_MatchType(System::IO::MatchType value) ;

/// @brief Method get_MatchCasing addr 0x23d2a08 size 0x8 virtual false final false
 System::IO::MatchCasing get_MatchCasing() ;

/// @brief Method get_ReturnSpecialDirectories addr 0x23d2a10 size 0x8 virtual false final false
