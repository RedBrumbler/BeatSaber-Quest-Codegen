...
/// @brief Method .ctor addr 0x23d206c size 0x74 virtual false final false
 void _ctor() ;

/// @brief Method Create addr 0x23d68a4 size 0xdc virtual false final false
static System::IO::FileSystemInfo Create(::StringW fullPath, ::StringW fileName, ByRef<System::IO::FileStatus> fileStatus) ;

/// @brief Method Init addr 0x23d6980 size 0x7c virtual false final false
 void Init(ByRef<System::IO::FileStatus> fileStatus) ;

/// @brief Method get_Attributes addr 0x23d5024 size 0xd0 virtual false final false
 System::IO::FileAttributes get_Attributes() ;

/// @brief Method get_ExistsCore addr 0x23d69fc size 0x98 virtual false final false
 bool get_ExistsCore() ;

/// @brief Method get_LastWriteTimeCore addr 0x23d6a94 size 0x6c virtual false final false
 System::DateTimeOffset get_LastWriteTimeCore() ;

/// @brief Method get_LengthCore addr 0x23d50f4 size 0x80 virtual false final false
 int64_t get_LengthCore() ;

/// @brief Method Refresh addr 0x23d6b00 size 0x68 virtual false final false
 void Refresh() ;

/// @brief Method ThrowNotFound addr 0x23d6810 size 0x94 virtual false final false
static void ThrowNotFound(::StringW path) ;

/// @brief Method get_NormalizedPath addr 0x23d6b68 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x23d274c size 0x144 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method GetObjectData addr 0x23d6b70 size 0x148 virtual true final false
 void GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method get_FullName addr 0x23d6cb8 size 0x8 virtual true final false
 ::StringW get_FullName() ;

/// @brief Method get_Name addr 0x23d6cc0 size 0x8 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_Exists addr 0x23d6cc8 size 0x88 virtual true final false
 bool get_Exists() ;

/// @brief Method Delete addr 0x0 size 0xffffffffffffffff virtual true final false
 void Delete() ;

/// @brief Method get_LastWriteTime addr 0x23d6d50 size 0x38 virtual false final false
 System::DateTime get_LastWriteTime() ;

/// @brief Method get_LastWriteTimeUtc addr 0x23d6d88 size 0x28 virtual false final false
 System::DateTime get_LastWriteTimeUtc() ;

/// @brief Method ToString addr 0x23d6db0 size 0x54 virtual true final false
 ::StringW ToString() ;
