...
/// @brief Method .ctor addr 0x23aa704 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x23aa70c size 0x78 virtual false final false
...
/// @brief Method Init addr 0x23aa514 size 0x118 virtual false final false
 void Init() ;

// Ctor Parameters []
explicit ResourceManager() ;

/// @brief Method .ctor addr 0x23aa630 size 0xd4 virtual false final false
 void _ctor() ;

/// @brief Method OnDeserializing addr 0x23aa784 size 0x10 virtual false final false
 void OnDeserializing(System::Runtime::Serialization::StreamingContext ctx) ;

/// @brief Method OnDeserialized addr 0x23aa794 size 0x1cc virtual false final false
 void OnDeserialized(System::Runtime::Serialization::StreamingContext ctx) ;

/// @brief Method OnSerializing addr 0x23aa960 size 0x70 virtual false final false
 void OnSerializing(System::Runtime::Serialization::StreamingContext ctx) ;

/// @brief Method CompareNames addr 0x23aa9d0 size 0x254 virtual false final false
