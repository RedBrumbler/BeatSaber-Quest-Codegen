...
/// @brief Method .ctor addr 0x23a8b88 size 0x140 virtual false final false
...
/// @brief Method .ctor addr 0x23a8cc8 size 0x100 virtual false final false
 void _ctor(System::IO::Stream stream) ;

/// @brief Method Dispose addr 0x23a8dc8 size 0x124 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method GetEnumerator addr 0x23a8eec size 0x4 virtual true final false
 System::Collections::IDictionaryEnumerator GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x23a8ff0 size 0x4 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method GetEnumeratorHelper addr 0x23a8ef0 size 0x100 virtual false final false
 System::Collections::IDictionaryEnumerator GetEnumeratorHelper() ;

/// @brief Method GetString addr 0x23a8ff4 size 0x70 virtual true final false
 ::StringW GetString(::StringW key) ;

/// @brief Method GetString addr 0x23a9978 size 0x7c virtual true final false
 ::StringW GetString(::StringW key, bool ignoreCase) ;

/// @brief Method GetObject addr 0x23a99f4 size 0xc virtual true final false
 ::bs_hook::Il2CppWrapperType GetObject(::StringW key) ;

/// @brief Method GetObject addr 0x23a9a00 size 0xc virtual true final false
 ::bs_hook::Il2CppWrapperType GetObject(::StringW key, bool ignoreCase) ;

/// @brief Method GetObject addr 0x23a9064 size 0x914 virtual false final false
 ::bs_hook::Il2CppWrapperType GetObject(::StringW key, bool ignoreCase, bool isString) ;

/// @brief Method ResolveResourceLocator addr 0x23a9a0c size 0x188 virtual false final false
