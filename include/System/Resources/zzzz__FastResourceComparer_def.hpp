...
/// @brief Method GetHashCode addr 0x23a9c0c size 0x8c virtual true final true
 int32_t GetHashCode(::bs_hook::Il2CppWrapperType key) ;

/// @brief Method GetHashCode addr 0x23a9d04 size 0x54 virtual true final true
 int32_t GetHashCode(::StringW key) ;

/// @brief Method HashFunction addr 0x23a9c98 size 0x6c virtual false final false
static int32_t HashFunction(::StringW key) ;

/// @brief Method Compare addr 0x23a9d58 size 0x9c virtual true final true
 int32_t Compare(::bs_hook::Il2CppWrapperType a, ::bs_hook::Il2CppWrapperType b) ;

/// @brief Method Compare addr 0x23a9df4 size 0x10 virtual true final true
 int32_t Compare(::StringW a, ::StringW b) ;

/// @brief Method Equals addr 0x23a9e04 size 0x10 virtual true final true
 bool Equals(::StringW a, ::StringW b) ;

/// @brief Method Equals addr 0x23a9e14 size 0x9c virtual true final true
 bool Equals(::bs_hook::Il2CppWrapperType a, ::bs_hook::Il2CppWrapperType b) ;

/// @brief Method CompareOrdinal addr 0x23a9eb0 size 0xbc virtual false final false
static int32_t CompareOrdinal(::StringW a, ::ArrayW<uint8_t> bytes, int32_t bCharLength) ;

/// @brief Method CompareOrdinal addr 0x23a9f6c size 0x74 virtual false final false
static int32_t CompareOrdinal(::ArrayW<uint8_t> bytes, int32_t aCharLength, ::StringW b) ;

/// @brief Method CompareOrdinal addr 0x23a9fe0 size 0x94 virtual false final false
static int32_t CompareOrdinal(void* a, int32_t byteLen, ::StringW b) ;

// Ctor Parameters []
explicit FastResourceComparer() ;

/// @brief Method .ctor addr 0x23aa074 size 0x8 virtual false final false
 void _ctor() ;
