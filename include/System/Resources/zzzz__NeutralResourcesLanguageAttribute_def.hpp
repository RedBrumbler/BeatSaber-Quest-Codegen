...
/// @brief Method .ctor addr 0x23a8afc size 0x7c virtual false final false
 void _ctor(::StringW cultureName) ;

/// @brief Method get_CultureName addr 0x23a8b78 size 0x8 virtual false final false
 ::StringW get_CultureName() ;

/// @brief Method get_Location addr 0x23a8b80 size 0x8 virtual false final false
