...
/// @brief Method .ctor addr 0x23ab114 size 0xc virtual false final false
 void _ctor(int32_t dataPos, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_DataPosition addr 0x23ab120 size 0x8 virtual false final false
 int32_t get_DataPosition() ;

/// @brief Method get_Value addr 0x23ab128 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_Value() ;

/// @brief Method set_Value addr 0x23ab130 size 0x8 virtual false final false
 void set_Value(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method CanCache addr 0x23ab138 size 0xc virtual false final false
