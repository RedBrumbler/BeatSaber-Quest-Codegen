...
/// @brief Method get_SecurityEnabled addr 0x231dd10 size 0x8 virtual false final false
static bool get_SecurityEnabled() ;

/// @brief Method EnsureElevatedPermissions addr 0x2321460 size 0x4 virtual false final false
