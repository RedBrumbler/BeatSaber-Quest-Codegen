...
/// @brief Method .ctor addr 0x2344a4c size 0xe8 virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method get_Value addr 0x2344b34 size 0x8 virtual true final false
 ::StringW get_Value() ;

/// @brief Method Equals addr 0x2344b3c size 0x98 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method GetHashCode addr 0x2344c3c size 0x28 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2344c64 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method Translate addr 0x2344c70 size 0x22c virtual true final false
 System::Security::Principal::IdentityReference Translate(System::Type targetType) ;

/// @brief Method op_Equality addr 0x2344bd4 size 0x68 virtual false final false
