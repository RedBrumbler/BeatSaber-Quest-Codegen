...
/// @brief Method .ctor addr 0x2348b44 size 0x8c virtual false final false
 void _ctor(::cordl_internals::intptr_t token) ;

/// @brief Method Dispose addr 0x2349250 size 0x10 virtual true final true
 void Dispose() ;

/// @brief Method Undo addr 0x2349260 size 0xc4 virtual false final false
 void Undo() ;

/// @brief Method CloseToken addr 0x2349328 size 0x4 virtual false final false
static bool CloseToken(::cordl_internals::intptr_t token) ;

/// @brief Method DuplicateToken addr 0x2349248 size 0x4 virtual false final false
static ::cordl_internals::intptr_t DuplicateToken(::cordl_internals::intptr_t token) ;

/// @brief Method SetCurrentToken addr 0x234924c size 0x4 virtual false final false
static bool SetCurrentToken(::cordl_internals::intptr_t token) ;

/// @brief Method RevertToSelf addr 0x2349324 size 0x4 virtual false final false
