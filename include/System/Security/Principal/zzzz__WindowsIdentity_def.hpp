...
/// @brief Method .ctor addr 0x2348764 size 0x64 virtual false final false
...
/// @brief Method .ctor addr 0x2348928 size 0x3c virtual false final false
...
/// @brief Method .ctor addr 0x2348964 size 0xa4 virtual false final false
 void _ctor(System::Security::Claims::ClaimsIdentity claimsIdentity, ::cordl_internals::intptr_t userToken) ;

/// @brief Method Dispose addr 0x2348a08 size 0x50 virtual true final true
 void Dispose() ;

/// @brief Method GetCurrent addr 0x2348a58 size 0x84 virtual false final false
static System::Security::Principal::WindowsIdentity GetCurrent() ;

/// @brief Method Impersonate addr 0x2348ae0 size 0x64 virtual true final false
 System::Security::Principal::WindowsImpersonationContext Impersonate() ;

/// @brief Method get_AuthenticationType addr 0x2348bd0 size 0x8 virtual true final true
 ::StringW get_AuthenticationType() ;

/// @brief Method get_Name addr 0x2348bd8 size 0x68 virtual true final false
 ::StringW get_Name() ;

/// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization addr 0x2348c44 size 0x2d8 virtual true final true
 void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::bs_hook::Il2CppWrapperType sender) ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x2348f1c size 0x168 virtual true final true
 void System_Runtime_Serialization_ISerializable_GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method CloneAsBase addr 0x2349084 size 0x4 virtual false final false
 System::Security::Claims::ClaimsIdentity CloneAsBase() ;

/// @brief Method GetTokenInternal addr 0x23491d8 size 0x8 virtual false final false
 ::cordl_internals::intptr_t GetTokenInternal() ;

/// @brief Method SetToken addr 0x23487c8 size 0x160 virtual false final false
 void SetToken(::cordl_internals::intptr_t token) ;

/// @brief Method GetCurrentToken addr 0x2348adc size 0x4 virtual false final false
static ::cordl_internals::intptr_t GetCurrentToken() ;

/// @brief Method GetTokenName addr 0x2348c40 size 0x4 virtual false final false
