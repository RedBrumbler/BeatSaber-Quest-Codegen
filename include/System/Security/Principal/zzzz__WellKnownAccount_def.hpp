...
/// @brief Method set_WellKnownValue addr 0x2346358 size 0x8 virtual false final false
 void set_WellKnownValue(System::Security::Principal::WellKnownSidType value) ;

/// @brief Method get_IsAbsolute addr 0x2346360 size 0x8 virtual false final false
 bool get_IsAbsolute() ;

/// @brief Method set_IsAbsolute addr 0x2346368 size 0xc virtual false final false
 void set_IsAbsolute(bool value) ;

/// @brief Method get_Sid addr 0x2346374 size 0x8 virtual false final false
 ::StringW get_Sid() ;

/// @brief Method set_Sid addr 0x234637c size 0x8 virtual false final false
 void set_Sid(::StringW value) ;

/// @brief Method set_Rid addr 0x2346384 size 0x8 virtual false final false
 void set_Rid(::StringW value) ;

/// @brief Method get_Name addr 0x234638c size 0x8 virtual false final false
 ::StringW get_Name() ;

/// @brief Method set_Name addr 0x2346394 size 0x8 virtual false final false
 void set_Name(::StringW value) ;

/// @brief Method get_SddlForm addr 0x234639c size 0x8 virtual false final false
 ::StringW get_SddlForm() ;

/// @brief Method set_SddlForm addr 0x23463a4 size 0x8 virtual false final false
 void set_SddlForm(::StringW value) ;

/// @brief Method LookupBySid addr 0x2345fd8 size 0xc0 virtual false final false
static System::Security::Principal::WellKnownAccount LookupBySid(::StringW s) ;

/// @brief Method LookupByName addr 0x2344e9c size 0xc0 virtual false final false
static System::Security::Principal::WellKnownAccount LookupByName(::StringW s) ;

/// @brief Method LookupBySddlForm addr 0x2346098 size 0xc0 virtual false final false
static System::Security::Principal::WellKnownAccount LookupBySddlForm(::StringW s) ;

// Ctor Parameters []
explicit WellKnownAccount() ;

/// @brief Method .ctor addr 0x23463ac size 0x8 virtual false final false
 void _ctor() ;
