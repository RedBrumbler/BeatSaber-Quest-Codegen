...
/// @brief Method .ctor addr 0x2344100 size 0xbc virtual false final false
 void _ctor(::StringW name, ::StringW type) ;

// Ctor Parameters []
explicit GenericIdentity() ;

/// @brief Method .ctor addr 0x23442b0 size 0x1c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x23442cc size 0x30 virtual false final false
 void _ctor(System::Security::Principal::GenericIdentity identity) ;

/// @brief Method Clone addr 0x23444ec size 0x60 virtual true final false
 System::Security::Claims::ClaimsIdentity Clone() ;

/// @brief Method get_Claims addr 0x234454c size 0x4 virtual true final false
 System::Collections::Generic::IEnumerable_1<System::Security::Claims::Claim> get_Claims() ;

/// @brief Method get_Name addr 0x23445c8 size 0x8 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_AuthenticationType addr 0x23445d0 size 0x8 virtual true final false
 ::StringW get_AuthenticationType() ;

/// @brief Method AddNameClaim addr 0x23441d8 size 0xd8 virtual false final false
 void AddNameClaim() ;
