...
/// @brief Method .ctor addr 0x2344f5c size 0xbc virtual false final false
...
/// @brief Method .ctor addr 0x2345478 size 0xec virtual false final false
 void _ctor(::ArrayW<uint8_t> binaryForm, int32_t offset) ;

/// @brief Method CreateFromBinaryForm addr 0x2345564 size 0x168 virtual false final false
 void CreateFromBinaryForm(::cordl_internals::intptr_t binaryForm, int32_t length) ;

/// @brief Method get_BinaryLength addr 0x23456cc size 0x1c virtual false final false
 int32_t get_BinaryLength() ;

/// @brief Method get_Value addr 0x23456e8 size 0x1bc virtual true final false
 ::StringW get_Value() ;

/// @brief Method GetSidAuthority addr 0x23458a4 size 0x80 virtual false final false
 uint64_t GetSidAuthority() ;

/// @brief Method GetSidSubAuthorityCount addr 0x23459a0 size 0x2c virtual false final false
 uint8_t GetSidSubAuthorityCount() ;

/// @brief Method GetSidSubAuthority addr 0x2345924 size 0x7c virtual false final false
 uint32_t GetSidSubAuthority(uint8_t index) ;

/// @brief Method CompareTo addr 0x23459cc size 0x170 virtual true final true
 int32_t CompareTo(System::Security::Principal::SecurityIdentifier sid) ;

/// @brief Method Equals addr 0x2345ba4 size 0x64 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method Equals addr 0x2345c08 size 0xa8 virtual false final false
 bool Equals(System::Security::Principal::SecurityIdentifier sid) ;

/// @brief Method GetBinaryForm addr 0x2345cb0 size 0xc8 virtual false final false
 void GetBinaryForm(::ArrayW<uint8_t> binaryForm, int32_t offset) ;

/// @brief Method GetHashCode addr 0x2345d78 size 0x28 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2345da0 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method Translate addr 0x2345dac size 0x22c virtual true final false
 System::Security::Principal::IdentityReference Translate(System::Type targetType) ;

/// @brief Method op_Equality addr 0x2345b3c size 0x68 virtual false final false
...
/// @brief Method ParseSddlForm addr 0x2345018 size 0x460 virtual false final false
static ::ArrayW<uint8_t> ParseSddlForm(::StringW sddlForm) ;

/// @brief Method TryParseAuthority addr 0x2346158 size 0xd8 virtual false final false
static bool TryParseAuthority(::StringW s, ByRef<uint64_t> result) ;

/// @brief Method TryParseSubAuthority addr 0x2346230 size 0xd8 virtual false final false
