...
/// @brief Method HashString addr 0x2322e80 size 0x6c virtual false final false
static uint32_t HashString(::StringW str) ;

/// @brief Method HashCharArray addr 0x2322eec size 0x5c virtual false final false
static uint32_t HashCharArray(::ArrayW<char16_t> a, int32_t l) ;

// Ctor Parameters []
explicit System__Security__Util__Tokenizer__StringMaker() ;

/// @brief Method .ctor addr 0x2322f48 size 0x94 virtual false final false
 void _ctor() ;

/// @brief Method CompareStringAndChars addr 0x2322fdc size 0x94 virtual false final false
 bool CompareStringAndChars(::StringW str, ::ArrayW<char16_t> a, int32_t l) ;

/// @brief Method MakeString addr 0x231d550 size 0x26c virtual false final false
 ::StringW MakeString() ;
...
/// @brief Method .ctor addr 0x2322c64 size 0x2c virtual false final false
 void _ctor(System::IO::StreamReader input) ;

/// @brief Method Read addr 0x2323070 size 0x3c virtual true final false
 int32_t Read() ;

/// @brief Method get_NumCharEncountered addr 0x23230ac size 0x8 virtual false final false
...
/// @brief Method BasicInitialization addr 0x2322b90 size 0x78 virtual false final false
 void BasicInitialization() ;

/// @brief Method Recycle addr 0x2322c08 size 0x5c virtual false final false
 void Recycle() ;

// Ctor Parameters [CppParam { name: "input", ty: "::StringW", modifiers: "", def_value: None }]
explicit Tokenizer(::StringW input) ;

/// @brief Method .ctor addr 0x2322b48 size 0x48 virtual false final false
 void _ctor(::StringW input) ;

/// @brief Method ChangeFormat addr 0x23223d4 size 0x224 virtual false final false
 void ChangeFormat(System::Text::Encoding encoding) ;

/// @brief Method GetTokens addr 0x2321b94 size 0x7e0 virtual false final false
 void GetTokens(System::Security::Util::TokenizerStream stream, int32_t maxNum, bool endAfterKet) ;

/// @brief Method GetStringToken addr 0x2322d78 size 0x18 virtual false final false
