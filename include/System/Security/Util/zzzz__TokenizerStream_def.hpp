...
/// @brief Method .ctor addr 0x2322900 size 0xa8 virtual false final false
 void _ctor() ;

/// @brief Method AddToken addr 0x2322c90 size 0xe8 virtual false final false
 void AddToken(int16_t token) ;

/// @brief Method AddString addr 0x2322d90 size 0xf0 virtual false final false
 void AddString(::StringW str) ;

/// @brief Method Reset addr 0x23229a8 size 0x1c virtual false final false
 void Reset() ;

/// @brief Method GetNextFullToken addr 0x23229c4 size 0x70 virtual false final false
 int16_t GetNextFullToken() ;

/// @brief Method GetNextToken addr 0x23218ec size 0x14 virtual false final false
 int16_t GetNextToken() ;

/// @brief Method GetNextString addr 0x2321978 size 0x6c virtual false final false
 ::StringW GetNextString() ;

/// @brief Method ThrowAwayNextString addr 0x2321900 size 0x4 virtual false final false
 void ThrowAwayNextString() ;

/// @brief Method TagLastToken addr 0x2321904 size 0x74 virtual false final false
 void TagLastToken(int16_t tag) ;

/// @brief Method GetTokenCount addr 0x2323164 size 0x8 virtual false final false
 int32_t GetTokenCount() ;

/// @brief Method GoToPosition addr 0x2322374 size 0x60 virtual false final false
