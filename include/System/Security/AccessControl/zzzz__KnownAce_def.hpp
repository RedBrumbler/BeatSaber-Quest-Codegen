...
/// @brief Method .ctor addr 0x2351a88 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x2351a8c size 0x4 virtual false final false
 void _ctor(::ArrayW<uint8_t> binaryForm, int32_t offset) ;

/// @brief Method get_AccessMask addr 0x2351a90 size 0x8 virtual false final false
 int32_t get_AccessMask() ;

/// @brief Method set_AccessMask addr 0x2351a98 size 0x8 virtual false final false
 void set_AccessMask(int32_t value) ;

/// @brief Method get_SecurityIdentifier addr 0x2351aa0 size 0x8 virtual false final false
 System::Security::Principal::SecurityIdentifier get_SecurityIdentifier() ;

/// @brief Method set_SecurityIdentifier addr 0x2351aa8 size 0x8 virtual false final false
