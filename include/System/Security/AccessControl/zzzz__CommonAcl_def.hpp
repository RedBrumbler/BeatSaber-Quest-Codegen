...
/// @brief Method .ctor addr 0x234ed40 size 0xc8 virtual false final false
...
/// @brief Method .ctor addr 0x234eee4 size 0x8c virtual false final false
 void _ctor(bool isContainer, bool isDS, int32_t capacity) ;

/// @brief Method Init addr 0x234eecc size 0x18 virtual false final false
 void Init(bool isContainer, bool isDS, System::Security::AccessControl::RawAcl rawAcl) ;

/// @brief Method get_Count addr 0x234f034 size 0x20 virtual true final true
 int32_t get_Count() ;

/// @brief Method get_IsCanonical addr 0x234f054 size 0x8 virtual false final false
 bool get_IsCanonical() ;

/// @brief Method get_IsContainer addr 0x234f05c size 0x8 virtual false final false
 bool get_IsContainer() ;

/// @brief Method get_IsDS addr 0x234f064 size 0x8 virtual false final false
 bool get_IsDS() ;

/// @brief Method set_IsAefa addr 0x234f06c size 0xc virtual false final false
 void set_IsAefa(bool value) ;

/// @brief Method get_Item addr 0x234f078 size 0x24 virtual true final true
 System::Security::AccessControl::GenericAce get_Item(int32_t index) ;

/// @brief Method set_Item addr 0x234f128 size 0x40 virtual true final true
 void set_Item(int32_t index, System::Security::AccessControl::GenericAce value) ;

/// @brief Method RequireCanonicity addr 0x234f168 size 0x60 virtual false final false
 void RequireCanonicity() ;

/// @brief Method CanonicalizeAndClearAefa addr 0x234ef70 size 0xc4 virtual false final false
 void CanonicalizeAndClearAefa() ;

/// @brief Method IsAceMeaningless addr 0x234f4ac size 0x100 virtual true final false
 bool IsAceMeaningless(System::Security::AccessControl::GenericAce ace) ;

/// @brief Method TestCanonicity addr 0x234f1c8 size 0x1cc virtual false final false
 bool TestCanonicity() ;

/// @brief Method GetCanonicalExplicitDenyAceCount addr 0x234f828 size 0x144 virtual false final false
 int32_t GetCanonicalExplicitDenyAceCount() ;

/// @brief Method GetCanonicalExplicitAceCount addr 0x234fab4 size 0x80 virtual false final false
 int32_t GetCanonicalExplicitAceCount() ;

/// @brief Method MergeExplicitAces addr 0x234f394 size 0x118 virtual false final false
 void MergeExplicitAces() ;

/// @brief Method MergeExplicitAcePair addr 0x234fb34 size 0x404 virtual false final false
...
/// @brief Method GetObjectAceTypeGuids addr 0x234ffcc size 0x98 virtual false final false
...
/// @brief Method ApplyCanonicalSortToExplicitAces addr 0x23500fc size 0x1c4 virtual false final false
...
/// @brief Method AddAce addr 0x23502c0 size 0x1c virtual false final false
...
/// @brief Method AddAceGetQualifiedAce addr 0x23502dc size 0xc0 virtual false final false
 System::Security::AccessControl::QualifiedAce AddAceGetQualifiedAce(System::Security::AccessControl::AceQualifier aceQualifier, System::Security::Principal::SecurityIdentifier sid, int32_t accessMask, System::Security::AccessControl::InheritanceFlags inheritanceFlags, System::Security::AccessControl::PropagationFlags propagationFlags, System::Security::AccessControl::AuditFlags auditFlags) ;

/// @brief Method AddAce addr 0x235039c size 0x78 virtual false final false
 void AddAce(System::Security::AccessControl::QualifiedAce newAce) ;

/// @brief Method CopyAce addr 0x234f09c size 0x8c virtual false final false
...
/// @brief Method GetAceFlags addr 0x2350414 size 0xd8 virtual false final false
