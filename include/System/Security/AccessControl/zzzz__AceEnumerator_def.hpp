...
/// @brief Method .ctor addr 0x234e4cc size 0x30 virtual false final false
 void _ctor(System::Security::AccessControl::GenericAcl owner) ;

/// @brief Method get_Current addr 0x234e4fc size 0x34 virtual false final false
 System::Security::AccessControl::GenericAce get_Current() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x234e530 size 0x4 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method MoveNext addr 0x234e534 size 0x58 virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x234e58c size 0xc virtual true final true
 void Reset() ;
