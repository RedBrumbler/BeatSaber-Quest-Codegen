...
/// @brief Method .ctor addr 0x2352380 size 0xc4 virtual false final false
...
/// @brief Method .ctor addr 0x2350798 size 0xfc virtual false final false
 void _ctor(bool isContainer, bool isDS) ;

/// @brief Method set_AccessControlSectionsModified addr 0x2351cb8 size 0x24 virtual false final false
...
/// @brief Method ReadLock addr 0x23524b4 size 0x20 virtual false final false
 void ReadLock() ;

/// @brief Method ReadUnlock addr 0x23524d4 size 0x1c virtual false final false
 void ReadUnlock() ;

/// @brief Method Writing addr 0x2352444 size 0x70 virtual false final false
 void Writing() ;

/// @brief Method WriteLock addr 0x2351c98 size 0x20 virtual false final false
 void WriteLock() ;

/// @brief Method WriteUnlock addr 0x23524f0 size 0x1c virtual false final false
 void WriteUnlock() ;

/// @brief Method InternalGetAccessRules addr 0x23508a0 size 0x324 virtual false final false
...
/// @brief Method InternalAccessRuleFactory addr 0x235250c size 0x70 virtual true final false
