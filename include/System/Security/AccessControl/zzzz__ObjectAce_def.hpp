...
/// @brief Method .ctor addr 0x2350064 size 0x98 virtual false final false
...
/// @brief Method .ctor addr 0x2351464 size 0x264 virtual false final false
 void _ctor(::ArrayW<uint8_t> binaryForm, int32_t offset) ;

/// @brief Method get_BinaryLength addr 0x235213c size 0x54 virtual true final false
 int32_t get_BinaryLength() ;

/// @brief Method get_InheritedObjectAceType addr 0x2352190 size 0xc virtual false final false
 System::Guid get_InheritedObjectAceType() ;

/// @brief Method set_InheritedObjectAceType addr 0x235219c size 0x8 virtual false final false
 void set_InheritedObjectAceType(System::Guid value) ;

/// @brief Method get_InheritedObjectAceTypePresent addr 0x2352098 size 0xc virtual false final false
 bool get_InheritedObjectAceTypePresent() ;

/// @brief Method get_ObjectAceFlags addr 0x23521a4 size 0x8 virtual false final false
 System::Security::AccessControl::ObjectAceFlags get_ObjectAceFlags() ;

/// @brief Method set_ObjectAceFlags addr 0x23521ac size 0x8 virtual false final false
 void set_ObjectAceFlags(System::Security::AccessControl::ObjectAceFlags value) ;

/// @brief Method get_ObjectAceType addr 0x23521b4 size 0xc virtual false final false
 System::Guid get_ObjectAceType() ;

/// @brief Method set_ObjectAceType addr 0x23521c0 size 0x8 virtual false final false
 void set_ObjectAceType(System::Guid value) ;

/// @brief Method get_ObjectAceTypePresent addr 0x235208c size 0xc virtual false final false
 bool get_ObjectAceTypePresent() ;

/// @brief Method GetBinaryForm addr 0x23521c8 size 0x16c virtual true final false
 void GetBinaryForm(::ArrayW<uint8_t> binaryForm, int32_t offset) ;

/// @brief Method ConvertType addr 0x2351f7c size 0x110 virtual false final false
...
/// @brief Method WriteGuid addr 0x2352334 size 0x4c virtual false final false
 void WriteGuid(System::Guid val, ::ArrayW<uint8_t> buffer, int32_t offset) ;

/// @brief Method ReadGuid addr 0x23520a4 size 0x98 virtual false final false
