...
/// @brief Method .ctor addr 0x2350e00 size 0xc virtual false final false
 void _ctor(bool isContainer, bool isDS, int32_t capacity) ;

/// @brief Method AddAccess addr 0x2350e0c size 0x60 virtual false final false
...
/// @brief Method ApplyCanonicalSortToExplicitAces addr 0x2350fe0 size 0x48 virtual true final false
 void ApplyCanonicalSortToExplicitAces() ;

/// @brief Method GetAceInsertPosition addr 0x2351028 size 0x10 virtual true final false
 int32_t GetAceInsertPosition(System::Security::AccessControl::AceQualifier aceQualifier) ;

/// @brief Method GetAceQualifier addr 0x2350f80 size 0x60 virtual false final false
...
/// @brief Method IsAceMeaningless addr 0x2351038 size 0xf8 virtual true final false
