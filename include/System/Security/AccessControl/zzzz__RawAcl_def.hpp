...
/// @brief Method .ctor addr 0x234ee10 size 0xbc virtual false final false
 void _ctor(uint8_t revision, int32_t capacity) ;

/// @brief Method get_Count addr 0x235257c size 0x48 virtual true final false
 int32_t get_Count() ;

/// @brief Method get_Item addr 0x23525c4 size 0x58 virtual true final false
 System::Security::AccessControl::GenericAce get_Item(int32_t index) ;

/// @brief Method set_Item addr 0x235261c size 0x68 virtual true final false
 void set_Item(int32_t index, System::Security::AccessControl::GenericAce value) ;

/// @brief Method InsertAce addr 0x23504ec size 0xd8 virtual false final false
 void InsertAce(int32_t index, System::Security::AccessControl::GenericAce ace) ;

/// @brief Method RemoveAce addr 0x234ff38 size 0x58 virtual false final false
