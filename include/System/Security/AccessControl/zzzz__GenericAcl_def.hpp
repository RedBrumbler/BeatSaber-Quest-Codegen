...
/// @brief Method .ctor addr 0x234ee08 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_Count addr 0x0 size 0xffffffffffffffff virtual true final false
 int32_t get_Count() ;

/// @brief Method get_IsSynchronized addr 0x2351868 size 0x8 virtual true final true
...
/// @brief Method get_SyncRoot addr 0x2351870 size 0x4 virtual true final false
 ::bs_hook::Il2CppWrapperType get_SyncRoot() ;

/// @brief Method CopyTo addr 0x2351874 size 0x18c virtual false final false
 void CopyTo(::ArrayW<System::Security::AccessControl::GenericAce> array, int32_t index) ;

/// @brief Method System.Collections.ICollection.CopyTo addr 0x2351a00 size 0x84 virtual true final true
 void System_Collections_ICollection_CopyTo(System::Array array, int32_t index) ;

/// @brief Method GetEnumerator addr 0x234f6f4 size 0x6c virtual false final false
 System::Security::AccessControl::AceEnumerator GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2351a84 size 0x4 virtual true final true
