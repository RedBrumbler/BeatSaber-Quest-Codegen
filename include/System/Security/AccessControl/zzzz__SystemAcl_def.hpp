...
/// @brief Method ApplyCanonicalSortToExplicitAces addr 0x2352684 size 0x20 virtual true final false
 void ApplyCanonicalSortToExplicitAces() ;

/// @brief Method GetAceInsertPosition addr 0x23526a4 size 0x8 virtual true final false
