...
/// @brief Method .ctor addr 0x234e758 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x234e970 size 0x4 virtual false final false
 void _ctor(::ArrayW<uint8_t> binaryForm, int32_t offset) ;

/// @brief Method get_AceQualifier addr 0x234f76c size 0xbc virtual false final false
 System::Security::AccessControl::AceQualifier get_AceQualifier() ;

/// @brief Method get_IsCallback addr 0x234ff90 size 0x3c virtual false final false
 bool get_IsCallback() ;

/// @brief Method get_OpaqueLength addr 0x234eb08 size 0x18 virtual false final false
 int32_t get_OpaqueLength() ;

/// @brief Method GetOpaque addr 0x234eccc size 0x74 virtual false final false
 ::ArrayW<uint8_t> GetOpaque() ;

/// @brief Method SetOpaque addr 0x234ea28 size 0xa8 virtual false final false
