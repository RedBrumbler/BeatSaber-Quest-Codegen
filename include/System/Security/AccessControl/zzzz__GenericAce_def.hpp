...
/// @brief Method .ctor addr 0x2351224 size 0x90 virtual false final false
...
/// @brief Method .ctor addr 0x23512b4 size 0x144 virtual false final false
 void _ctor(::ArrayW<uint8_t> binaryForm, int32_t offset) ;

/// @brief Method get_AceFlags addr 0x23513f8 size 0x8 virtual false final false
 System::Security::AccessControl::AceFlags get_AceFlags() ;

/// @brief Method get_AceType addr 0x2351400 size 0x8 virtual false final false
 System::Security::AccessControl::AceType get_AceType() ;

/// @brief Method get_AuditFlags addr 0x2351130 size 0x1c virtual false final false
...
/// @brief Method get_InheritanceFlags addr 0x2351408 size 0x10 virtual false final false
 System::Security::AccessControl::InheritanceFlags get_InheritanceFlags() ;

/// @brief Method get_IsInherited addr 0x234f760 size 0xc virtual false final false
 bool get_IsInherited() ;

/// @brief Method get_PropagationFlags addr 0x2351418 size 0xc virtual false final false
 System::Security::AccessControl::PropagationFlags get_PropagationFlags() ;

/// @brief Method CreateFromBinaryForm addr 0x23505c4 size 0x1c8 virtual false final false
static System::Security::AccessControl::GenericAce CreateFromBinaryForm(::ArrayW<uint8_t> binaryForm, int32_t offset) ;

/// @brief Method Equals addr 0x23516c8 size 0x80 virtual true final true
...
/// @brief Method GetHashCode addr 0x2351748 size 0xcc virtual true final true
 int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x234f96c size 0x148 virtual false final false
static bool op_Equality(System::Security::AccessControl::GenericAce left, System::Security::AccessControl::GenericAce right) ;

/// @brief Method op_Inequality addr 0x234f5ac size 0x148 virtual false final false
static bool op_Inequality(System::Security::AccessControl::GenericAce left, System::Security::AccessControl::GenericAce right) ;

/// @brief Method IsObjectType addr 0x2351424 size 0x40 virtual false final false
static bool IsObjectType(System::Security::AccessControl::AceType type) ;

/// @brief Method ReadUShort addr 0x234e974 size 0x40 virtual false final false
static uint16_t ReadUShort(::ArrayW<uint8_t> buffer, int32_t offset) ;

/// @brief Method ReadInt addr 0x234e9b4 size 0x74 virtual false final false
static int32_t ReadInt(::ArrayW<uint8_t> buffer, int32_t offset) ;

/// @brief Method WriteInt addr 0x234ec4c size 0x80 virtual false final false
static void WriteInt(int32_t val, ::ArrayW<uint8_t> buffer, int32_t offset) ;

/// @brief Method WriteUShort addr 0x234ec04 size 0x48 virtual false final false
