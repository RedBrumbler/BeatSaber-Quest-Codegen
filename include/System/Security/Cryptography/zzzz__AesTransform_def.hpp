...
/// @brief Method .ctor addr 0x26ad294 size 0x6f4 virtual false final false
 void _ctor(System::Security::Cryptography::Aes algo, bool encryption, ::ArrayW<uint8_t> key, ::ArrayW<uint8_t> iv) ;

/// @brief Method ECB addr 0x26adca4 size 0x14 virtual true final false
 void ECB(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output) ;

/// @brief Method SubByte addr 0x26adbe0 size 0xc4 virtual false final false
 uint32_t SubByte(uint32_t a) ;

/// @brief Method Encrypt128 addr 0x26adcb8 size 0x1e2c virtual false final false
 void Encrypt128(::ArrayW<uint8_t> indata, ::ArrayW<uint8_t> outdata, ::ArrayW<uint32_t> ekey) ;

/// @brief Method Decrypt128 addr 0x26afae4 size 0x1df0 virtual false final false
