...
/// @brief Method .ctor addr 0x233afa4 size 0x2c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x233d13c size 0x38 virtual false final false
 void _ctor(int32_t dwKeySize) ;

/// @brief Method Common addr 0x233d174 size 0x224 virtual false final false
 void Common(int32_t dwKeySize, bool parameters) ;

/// @brief Method Finalize addr 0x233d398 size 0xa0 virtual true final false
 void Finalize() ;

/// @brief Method get_KeySize addr 0x233d438 size 0x20 virtual true final false
 int32_t get_KeySize() ;

/// @brief Method get_PublicOnly addr 0x233d458 size 0x1c virtual false final false
 bool get_PublicOnly() ;

/// @brief Method ExportParameters addr 0x233d474 size 0xb4 virtual true final false
 System::Security::Cryptography::DSAParameters ExportParameters(bool includePrivateParameters) ;

/// @brief Method ImportParameters addr 0x233d528 size 0x54 virtual true final false
 void ImportParameters(System::Security::Cryptography::DSAParameters parameters) ;

/// @brief Method VerifySignature addr 0x233d57c size 0x20 virtual true final false
 bool VerifySignature(::ArrayW<uint8_t> rgbHash, ::ArrayW<uint8_t> rgbSignature) ;

/// @brief Method Dispose addr 0x233d59c size 0x54 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method OnKeyGenerated addr 0x233d5f0 size 0x84 virtual false final false
