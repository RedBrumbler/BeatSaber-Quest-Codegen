...
/// @brief Method .ctor addr 0x2336bf0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method set_KeyAlgorithm addr 0x2336bf8 size 0x8 virtual false final false
 void set_KeyAlgorithm(::StringW value) ;

/// @brief Method set_DigestAlgorithm addr 0x2336c00 size 0x8 virtual false final false
 void set_DigestAlgorithm(::StringW value) ;

/// @brief Method set_FormatterAlgorithm addr 0x2336c08 size 0x8 virtual false final false
 void set_FormatterAlgorithm(::StringW value) ;

/// @brief Method set_DeformatterAlgorithm addr 0x2336c10 size 0x8 virtual false final false
