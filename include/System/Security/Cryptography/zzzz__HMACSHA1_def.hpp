...
/// @brief Method .ctor addr 0x232b164 size 0x28 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "key", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None }]
explicit HMACSHA1(::ArrayW<uint8_t> key) ;

/// @brief Method .ctor addr 0x232b83c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x232b844 size 0xc0 virtual false final false
