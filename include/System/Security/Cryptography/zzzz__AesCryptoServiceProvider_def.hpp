...
/// @brief Method .ctor addr 0x26ad0ec size 0x64 virtual false final false
 void _ctor() ;

/// @brief Method GenerateIV addr 0x26ad150 size 0x24 virtual true final false
 void GenerateIV() ;

/// @brief Method GenerateKey addr 0x26ad174 size 0x24 virtual true final false
 void GenerateKey() ;

/// @brief Method CreateDecryptor addr 0x26ad198 size 0xfc virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateDecryptor(::ArrayW<uint8_t> key, ::ArrayW<uint8_t> iv) ;

/// @brief Method CreateEncryptor addr 0x26ad988 size 0xfc virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateEncryptor(::ArrayW<uint8_t> key, ::ArrayW<uint8_t> iv) ;

/// @brief Method get_IV addr 0x26ada84 size 0x8 virtual true final false
 ::ArrayW<uint8_t> get_IV() ;

/// @brief Method set_IV addr 0x26ada8c size 0x8 virtual true final false
 void set_IV(::ArrayW<uint8_t> value) ;

/// @brief Method get_Key addr 0x26ada94 size 0x8 virtual true final false
 ::ArrayW<uint8_t> get_Key() ;

/// @brief Method set_Key addr 0x26ada9c size 0x8 virtual true final false
 void set_Key(::ArrayW<uint8_t> value) ;

/// @brief Method get_KeySize addr 0x26adaa4 size 0x8 virtual true final false
 int32_t get_KeySize() ;

/// @brief Method set_KeySize addr 0x26adaac size 0x8 virtual true final false
 void set_KeySize(int32_t value) ;

/// @brief Method get_FeedbackSize addr 0x26adab4 size 0x8 virtual true final false
 int32_t get_FeedbackSize() ;

/// @brief Method get_Mode addr 0x26adabc size 0x8 virtual true final false
 System::Security::Cryptography::CipherMode get_Mode() ;

/// @brief Method set_Mode addr 0x26adac4 size 0x60 virtual true final false
 void set_Mode(System::Security::Cryptography::CipherMode value) ;

/// @brief Method get_Padding addr 0x26adb24 size 0x8 virtual true final false
 System::Security::Cryptography::PaddingMode get_Padding() ;

/// @brief Method set_Padding addr 0x26adb2c size 0x8 virtual true final false
 void set_Padding(System::Security::Cryptography::PaddingMode value) ;

/// @brief Method CreateDecryptor addr 0x26adb34 size 0x50 virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateDecryptor() ;

/// @brief Method CreateEncryptor addr 0x26adb84 size 0x50 virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateEncryptor() ;

/// @brief Method Dispose addr 0x26adbd4 size 0xc virtual true final false
