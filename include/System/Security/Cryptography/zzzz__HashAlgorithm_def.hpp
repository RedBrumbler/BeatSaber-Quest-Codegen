...
/// @brief Method .ctor addr 0x2327ea4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Create addr 0x2327eac size 0x80 virtual false final false
static System::Security::Cryptography::HashAlgorithm Create(::StringW hashName) ;

/// @brief Method get_HashSize addr 0x2327f2c size 0x8 virtual true final false
 int32_t get_HashSize() ;

/// @brief Method get_Hash addr 0x2327f34 size 0xf8 virtual true final false
 ::ArrayW<uint8_t> get_Hash() ;

/// @brief Method ComputeHash addr 0x2328074 size 0xb0 virtual false final false
 ::ArrayW<uint8_t> ComputeHash(::ArrayW<uint8_t> buffer) ;

/// @brief Method ComputeHash addr 0x23281cc size 0x178 virtual false final false
 ::ArrayW<uint8_t> ComputeHash(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method CaptureHashCodeAndReinitialize addr 0x2328124 size 0xa8 virtual false final false
 ::ArrayW<uint8_t> CaptureHashCodeAndReinitialize() ;

/// @brief Method Dispose addr 0x2328344 size 0x6c virtual true final true
 void Dispose() ;

/// @brief Method Clear addr 0x23283b0 size 0x94 virtual false final false
 void Clear() ;

/// @brief Method Dispose addr 0x2328444 size 0x10 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method get_InputBlockSize addr 0x2328454 size 0x8 virtual true final false
 int32_t get_InputBlockSize() ;

/// @brief Method get_OutputBlockSize addr 0x232845c size 0x8 virtual true final false
 int32_t get_OutputBlockSize() ;

/// @brief Method get_CanTransformMultipleBlocks addr 0x2328464 size 0x8 virtual true final false
 bool get_CanTransformMultipleBlocks() ;

/// @brief Method TransformBlock addr 0x232846c size 0x9c virtual true final true
...
/// @brief Method TransformFinalBlock addr 0x2328664 size 0x124 virtual true final true
 ::ArrayW<uint8_t> TransformFinalBlock(::ArrayW<uint8_t> inputBuffer, int32_t inputOffset, int32_t inputCount) ;

/// @brief Method ValidateTransformBlock addr 0x2328508 size 0x15c virtual false final false
