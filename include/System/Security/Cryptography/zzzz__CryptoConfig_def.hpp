...
/// @brief Method CreateFromName addr 0x23378bc size 0x58 virtual false final false
static ::bs_hook::Il2CppWrapperType CreateFromName(::StringW name) ;

/// @brief Method CreateFromName addr 0x2339090 size 0x1f14 virtual false final false
static ::bs_hook::Il2CppWrapperType CreateFromName(::StringW name, ::ArrayW<::bs_hook::Il2CppWrapperType> args) ;

/// @brief Method MapNameToOID addr 0x233b0f0 size 0x7b4 virtual false final false
static ::StringW MapNameToOID(::StringW name) ;

/// @brief Method EncodeOID addr 0x233b8a4 size 0x40c virtual false final false
static ::ArrayW<uint8_t> EncodeOID(::StringW str) ;

/// @brief Method EncodeLongNumber addr 0x233bcb0 size 0x190 virtual false final false
static ::ArrayW<uint8_t> EncodeLongNumber(int64_t x) ;

/// @brief Method get_AllowOnlyFipsAlgorithms addr 0x2334e7c size 0x8 virtual false final false
