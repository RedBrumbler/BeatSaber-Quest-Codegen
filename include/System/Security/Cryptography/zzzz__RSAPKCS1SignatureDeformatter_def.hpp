...
/// @brief Method .ctor addr 0x233b078 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x233fd08 size 0x34 virtual false final false
 void _ctor(System::Security::Cryptography::AsymmetricAlgorithm key) ;

/// @brief Method SetHashAlgorithm addr 0x233fd3c size 0x60 virtual true final false
 void SetHashAlgorithm(::StringW strName) ;

/// @brief Method SetKey addr 0x233fd9c size 0xec virtual true final false
 void SetKey(System::Security::Cryptography::AsymmetricAlgorithm key) ;

/// @brief Method VerifySignature addr 0x233fe88 size 0x160 virtual true final false
