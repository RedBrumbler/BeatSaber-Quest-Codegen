...
/// @brief Method .ctor addr 0x26ac954 size 0x164 virtual false final false
 void _ctor() ;

/// @brief Method get_FeedbackSize addr 0x26acab8 size 0x20 virtual true final false
 int32_t get_FeedbackSize() ;

/// @brief Method get_IV addr 0x26acad8 size 0x20 virtual true final false
 ::ArrayW<uint8_t> get_IV() ;

/// @brief Method set_IV addr 0x26acaf8 size 0x20 virtual true final false
 void set_IV(::ArrayW<uint8_t> value) ;

/// @brief Method get_Key addr 0x26acb18 size 0x20 virtual true final false
 ::ArrayW<uint8_t> get_Key() ;

/// @brief Method set_Key addr 0x26acb38 size 0x20 virtual true final false
 void set_Key(::ArrayW<uint8_t> value) ;

/// @brief Method get_KeySize addr 0x26acb58 size 0x24 virtual true final false
 int32_t get_KeySize() ;

/// @brief Method set_KeySize addr 0x26acb7c size 0x24 virtual true final false
 void set_KeySize(int32_t value) ;

/// @brief Method get_Mode addr 0x26acba0 size 0x24 virtual true final false
 System::Security::Cryptography::CipherMode get_Mode() ;

/// @brief Method set_Mode addr 0x26acbc4 size 0x88 virtual true final false
 void set_Mode(System::Security::Cryptography::CipherMode value) ;

/// @brief Method get_Padding addr 0x26acc4c size 0x24 virtual true final false
 System::Security::Cryptography::PaddingMode get_Padding() ;

/// @brief Method set_Padding addr 0x26acc70 size 0x24 virtual true final false
 void set_Padding(System::Security::Cryptography::PaddingMode value) ;

/// @brief Method CreateDecryptor addr 0x26acc94 size 0x24 virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateDecryptor() ;

/// @brief Method CreateDecryptor addr 0x26accb8 size 0x14c virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateDecryptor(::ArrayW<uint8_t> key, ::ArrayW<uint8_t> iv) ;

/// @brief Method CreateEncryptor addr 0x26ace04 size 0x24 virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateEncryptor() ;

/// @brief Method CreateEncryptor addr 0x26ace28 size 0x14c virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateEncryptor(::ArrayW<uint8_t> key, ::ArrayW<uint8_t> iv) ;

/// @brief Method Dispose addr 0x26acf74 size 0x130 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method GenerateIV addr 0x26ad0a4 size 0x24 virtual true final false
 void GenerateIV() ;

/// @brief Method GenerateKey addr 0x26ad0c8 size 0x24 virtual true final false
 void GenerateKey() ;
