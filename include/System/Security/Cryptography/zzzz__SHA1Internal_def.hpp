...
/// @brief Method .ctor addr 0x233ffe8 size 0x9c virtual false final false
 void _ctor() ;

/// @brief Method HashCore addr 0x234010c size 0x100 virtual false final false
 void HashCore(::ArrayW<uint8_t> rgb, int32_t ibStart, int32_t cbSize) ;

/// @brief Method HashFinal addr 0x2340724 size 0xd8 virtual false final false
 ::ArrayW<uint8_t> HashFinal() ;

/// @brief Method Initialize addr 0x2340084 size 0x88 virtual false final false
 void Initialize() ;

/// @brief Method ProcessBlock addr 0x234020c size 0x518 virtual false final false
 void ProcessBlock(::ArrayW<uint8_t> inputBuffer, uint32_t inputOffset) ;

/// @brief Method InitialiseBuff addr 0x23409b8 size 0x6a0 virtual false final false
static void InitialiseBuff(::ArrayW<uint32_t> buff, ::ArrayW<uint8_t> input, uint32_t inputOffset) ;

/// @brief Method FillBuff addr 0x2341058 size 0x234 virtual false final false
static void FillBuff(::ArrayW<uint32_t> buff) ;

/// @brief Method ProcessFinalBlock addr 0x23407fc size 0x1bc virtual false final false
 void ProcessFinalBlock(::ArrayW<uint8_t> inputBuffer, int32_t inputOffset, int32_t inputCount) ;

/// @brief Method AddLength addr 0x234128c size 0xf0 virtual false final false
