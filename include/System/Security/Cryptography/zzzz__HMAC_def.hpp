...
/// @brief Method get_BlockSizeValue addr 0x232adc0 size 0x8 virtual false final false
 int32_t get_BlockSizeValue() ;

/// @brief Method set_BlockSizeValue addr 0x232adc8 size 0x8 virtual false final false
 void set_BlockSizeValue(int32_t value) ;

/// @brief Method UpdateIOPadBuffers addr 0x232add0 size 0x164 virtual false final false
 void UpdateIOPadBuffers() ;

/// @brief Method InitializeKey addr 0x232af34 size 0xd4 virtual false final false
 void InitializeKey(::ArrayW<uint8_t> key) ;

/// @brief Method get_Key addr 0x232b008 size 0x78 virtual true final false
 ::ArrayW<uint8_t> get_Key() ;

/// @brief Method set_Key addr 0x232b080 size 0x74 virtual true final false
 void set_Key(::ArrayW<uint8_t> value) ;

/// @brief Method Create addr 0x232b0f4 size 0x70 virtual false final false
static System::Security::Cryptography::HMAC Create() ;

/// @brief Method Initialize addr 0x232b18c size 0x48 virtual true final false
 void Initialize() ;

/// @brief Method HashCore addr 0x232b1d4 size 0x88 virtual true final false
 void HashCore(::ArrayW<uint8_t> rgb, int32_t ib, int32_t cb) ;

/// @brief Method HashFinal addr 0x232b25c size 0x144 virtual true final false
 ::ArrayW<uint8_t> HashFinal() ;

/// @brief Method Dispose addr 0x232b3a0 size 0x148 virtual true final false
 void Dispose(bool disposing) ;

// Ctor Parameters []
explicit HMAC() ;

/// @brief Method .ctor addr 0x232b530 size 0x10 virtual false final false
 void _ctor() ;
