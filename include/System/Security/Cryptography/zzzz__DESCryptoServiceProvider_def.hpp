...
/// @brief Method .ctor addr 0x23298f0 size 0xd0 virtual false final false
 void _ctor() ;

/// @brief Method CreateEncryptor addr 0x23299c0 size 0x148 virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateEncryptor(::ArrayW<uint8_t> rgbKey, ::ArrayW<uint8_t> rgbIV) ;

/// @brief Method CreateDecryptor addr 0x2329b08 size 0x148 virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateDecryptor(::ArrayW<uint8_t> rgbKey, ::ArrayW<uint8_t> rgbIV) ;

/// @brief Method GenerateKey addr 0x2329c50 size 0xe8 virtual true final false
 void GenerateKey() ;

/// @brief Method GenerateIV addr 0x2329d38 size 0x6c virtual true final false
 void GenerateIV() ;
