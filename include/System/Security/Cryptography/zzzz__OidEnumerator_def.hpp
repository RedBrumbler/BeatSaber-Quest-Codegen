...
/// @brief Method .ctor addr 0x2812bac size 0x30 virtual false final false
 void _ctor(System::Security::Cryptography::OidCollection oids) ;

/// @brief Method get_Current addr 0x2812da8 size 0x20 virtual false final false
 System::Security::Cryptography::Oid get_Current() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2812dc8 size 0x4 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method MoveNext addr 0x2812dcc size 0x50 virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x2812e1c size 0xc virtual true final true
 void Reset() ;
