...
/// @brief Method .ctor addr 0x232c00c size 0x130 virtual false final false
 void _ctor() ;

/// @brief Method Initialize addr 0x232c13c size 0x8 virtual true final false
 void Initialize() ;

/// @brief Method HashCore addr 0x232c144 size 0x170 virtual true final false
 void HashCore(::ArrayW<uint8_t> rgbData, int32_t ibStart, int32_t cbSize) ;

/// @brief Method HashFinal addr 0x232c344 size 0x14c virtual true final false
 ::ArrayW<uint8_t> HashFinal() ;

/// @brief Method Dispose addr 0x232c508 size 0xe8 virtual true final false
