...
/// @brief Method .ctor addr 0x23289a0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Dispose addr 0x23289a8 size 0x4 virtual true final true
 void Dispose() ;

/// @brief Method Clear addr 0x23289ac size 0x6c virtual false final false
 void Clear() ;

/// @brief Method Dispose addr 0x2328a18 size 0x4 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method get_KeySize addr 0x2328a1c size 0x8 virtual true final false
 int32_t get_KeySize() ;

/// @brief Method set_KeySize addr 0x2328a24 size 0xdc virtual true final false
 void set_KeySize(int32_t value) ;

/// @brief Method FromXmlString addr 0x2328b28 size 0x40 virtual true final false
 void FromXmlString(::StringW xmlString) ;

/// @brief Method ToXmlString addr 0x2328b68 size 0x40 virtual true final false
