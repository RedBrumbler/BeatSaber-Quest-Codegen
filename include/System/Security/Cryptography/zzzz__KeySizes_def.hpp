...
/// @brief Method get_MinSize addr 0x2328bb8 size 0x8 virtual false final false
 int32_t get_MinSize() ;

/// @brief Method get_MaxSize addr 0x2328bc0 size 0x8 virtual false final false
 int32_t get_MaxSize() ;

/// @brief Method get_SkipSize addr 0x2328bc8 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2328964 size 0x3c virtual false final false
 void _ctor(int32_t minSize, int32_t maxSize, int32_t skipSize) ;

/// @brief Method IsLegal addr 0x2328bd0 size 0x4c virtual false final false
 bool IsLegal(int32_t keySize) ;

/// @brief Method IsLegalKeySize addr 0x2328c1c size 0x80 virtual false final false
