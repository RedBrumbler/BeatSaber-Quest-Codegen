...
/// @brief Method .ctor addr 0x233afd0 size 0xa8 virtual false final false
 void _ctor() ;

/// @brief Method Finalize addr 0x233d674 size 0xa0 virtual true final false
 void Finalize() ;

/// @brief Method Dispose addr 0x233d714 size 0x70 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method HashCore addr 0x233d784 size 0x100 virtual true final false
 void HashCore(::ArrayW<uint8_t> rgb, int32_t ibStart, int32_t cbSize) ;

/// @brief Method HashFinal addr 0x233e4fc size 0xd8 virtual true final false
 ::ArrayW<uint8_t> HashFinal() ;

/// @brief Method Initialize addr 0x233e780 size 0x74 virtual true final false
 void Initialize() ;

/// @brief Method ProcessBlock addr 0x233d884 size 0xc78 virtual false final false
 void ProcessBlock(::ArrayW<uint8_t> inputBuffer, int32_t inputOffset) ;

/// @brief Method ProcessFinalBlock addr 0x233e5d4 size 0x1ac virtual false final false
 void ProcessFinalBlock(::ArrayW<uint8_t> inputBuffer, int32_t inputOffset, int32_t inputCount) ;

/// @brief Method AddLength addr 0x233e7f4 size 0xf0 virtual false final false
