...
/// @brief Method .ctor addr 0x23383d4 size 0x320 virtual false final false
 void _ctor(System::Security::Cryptography::TripleDES algo, bool encryption, ::ArrayW<uint8_t> key, ::ArrayW<uint8_t> iv) ;

/// @brief Method ECB addr 0x2341528 size 0x120 virtual true final false
 void ECB(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output) ;

/// @brief Method GetStrongKey addr 0x2341484 size 0xa4 virtual false final false
