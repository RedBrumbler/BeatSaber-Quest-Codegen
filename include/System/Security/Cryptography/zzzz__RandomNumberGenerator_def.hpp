...
/// @brief Method .ctor addr 0x232cb14 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Create addr 0x232cb1c size 0x5c virtual false final false
static System::Security::Cryptography::RandomNumberGenerator Create() ;

/// @brief Method Dispose addr 0x232cb78 size 0x6c virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x232cbe4 size 0x4 virtual true final false
