...
/// @brief Method .ctor addr 0x232b904 size 0x124 virtual false final false
 void _ctor() ;

/// @brief Method Initialize addr 0x2333860 size 0x44 virtual true final false
 void Initialize() ;

/// @brief Method HashCore addr 0x23338a4 size 0x4 virtual true final false
 void HashCore(::ArrayW<uint8_t> rgb, int32_t ibStart, int32_t cbSize) ;

/// @brief Method HashFinal addr 0x2333a24 size 0x4 virtual true final false
 ::ArrayW<uint8_t> HashFinal() ;

/// @brief Method InitializeState addr 0x23337dc size 0x84 virtual false final false
 void InitializeState() ;

/// @brief Method _HashData addr 0x23338a8 size 0x17c virtual false final false
 void _HashData(::ArrayW<uint8_t> partIn, int32_t ibStart, int32_t cbSize) ;

/// @brief Method _EndHash addr 0x2333a28 size 0x1a8 virtual false final false
 ::ArrayW<uint8_t> _EndHash() ;

/// @brief Method SHATransform addr 0x2333bd0 size 0x3f4 virtual false final false
static void SHATransform(void* expandedBuffer, void* state, void* block) ;

/// @brief Method SHAExpand addr 0x2333fc4 size 0x3c virtual false final false
