...
/// @brief Method .ctor addr 0x2328dd0 size 0x24 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit CryptographicUnexpectedOperationException(::StringW message) ;

/// @brief Method .ctor addr 0x232802c size 0x48 virtual false final false
...
/// @brief Method .ctor addr 0x2328df4 size 0x8 virtual false final false
