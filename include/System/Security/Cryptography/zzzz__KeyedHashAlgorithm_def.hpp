...
/// @brief Method .ctor addr 0x232b540 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Dispose addr 0x232b4e8 size 0x48 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method get_Key addr 0x232be88 size 0x78 virtual true final false
 ::ArrayW<uint8_t> get_Key() ;

/// @brief Method set_Key addr 0x232bf00 size 0x10c virtual true final false
