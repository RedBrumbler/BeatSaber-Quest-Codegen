...
// Ctor Parameters []
explicit OidCollection() ;

/// @brief Method .ctor addr 0x281296c size 0x80 virtual false final false
 void _ctor() ;

/// @brief Method Add addr 0x28129ec size 0xb4 virtual false final false
 int32_t Add(System::Security::Cryptography::Oid oid) ;

/// @brief Method get_Item addr 0x2812aa0 size 0x58 virtual false final false
 System::Security::Cryptography::Oid get_Item(int32_t index) ;

/// @brief Method get_Count addr 0x2812af8 size 0x48 virtual true final true
 int32_t get_Count() ;

/// @brief Method GetEnumerator addr 0x2812b40 size 0x6c virtual false final false
 System::Security::Cryptography::OidEnumerator GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2812bdc size 0x4 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method System.Collections.ICollection.CopyTo addr 0x2812be0 size 0x1bc virtual true final true
 void System_Collections_ICollection_CopyTo(System::Array array, int32_t index) ;

/// @brief Method get_IsSynchronized addr 0x2812d9c size 0x8 virtual true final true
 bool get_IsSynchronized() ;

/// @brief Method get_SyncRoot addr 0x2812da4 size 0x4 virtual true final true
