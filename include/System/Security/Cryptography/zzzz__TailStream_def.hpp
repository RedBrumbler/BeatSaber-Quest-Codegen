...
/// @brief Method .ctor addr 0x232c2b4 size 0x90 virtual false final false
 void _ctor(int32_t bufferSize) ;

/// @brief Method Clear addr 0x232c5f0 size 0x10 virtual false final false
 void Clear() ;

/// @brief Method Dispose addr 0x232c600 size 0xc0 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method get_Buffer addr 0x232c490 size 0x78 virtual false final false
 ::ArrayW<uint8_t> get_Buffer() ;

/// @brief Method get_CanRead addr 0x232c6c0 size 0x8 virtual true final false
 bool get_CanRead() ;

/// @brief Method get_CanSeek addr 0x232c6c8 size 0x8 virtual true final false
 bool get_CanSeek() ;

/// @brief Method get_CanWrite addr 0x232c6d0 size 0x10 virtual true final false
 bool get_CanWrite() ;

/// @brief Method get_Length addr 0x232c6e0 size 0x60 virtual true final false
 int64_t get_Length() ;

/// @brief Method get_Position addr 0x232c740 size 0x60 virtual true final false
 int64_t get_Position() ;

/// @brief Method set_Position addr 0x232c7a0 size 0x60 virtual true final false
 void set_Position(int64_t value) ;

/// @brief Method Flush addr 0x232c800 size 0x4 virtual true final false
 void Flush() ;

/// @brief Method Seek addr 0x232c804 size 0x60 virtual true final false
 int64_t Seek(int64_t offset, System::IO::SeekOrigin origin) ;

/// @brief Method SetLength addr 0x232c864 size 0x60 virtual true final false
 void SetLength(int64_t value) ;

/// @brief Method Read addr 0x232c8c4 size 0x60 virtual true final false
 int32_t Read(::ArrayW<uint8_t> buffer, int32_t offset, int32_t count) ;

/// @brief Method Write addr 0x232c924 size 0x174 virtual true final false
