...
/// @brief Method .ctor addr 0x2337e7c size 0x60 virtual false final false
 void _ctor() ;

/// @brief Method CreateEncryptor addr 0x23382c0 size 0x114 virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateEncryptor(::ArrayW<uint8_t> rgbKey, ::ArrayW<uint8_t> rgbIV) ;

/// @brief Method CreateDecryptor addr 0x23386f4 size 0x114 virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateDecryptor(::ArrayW<uint8_t> rgbKey, ::ArrayW<uint8_t> rgbIV) ;

/// @brief Method GenerateKey addr 0x2338808 size 0xc8 virtual true final false
 void GenerateKey() ;

/// @brief Method GenerateIV addr 0x2338970 size 0x68 virtual true final false
 void GenerateIV() ;
