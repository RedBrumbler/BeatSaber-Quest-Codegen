...
/// @brief Method .ctor addr 0x281261c size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "oid", ty: "::StringW", modifiers: "", def_value: None }]
explicit Oid(::StringW oid) ;

/// @brief Method .ctor addr 0x2812624 size 0x8c virtual false final false
...
/// @brief Method .ctor addr 0x28126b0 size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x28126dc size 0x84 virtual false final false
 void _ctor(System::Security::Cryptography::Oid oid) ;

/// @brief Method FromOidValue addr 0x2812760 size 0x13c virtual false final false
static System::Security::Cryptography::Oid FromOidValue(::StringW oidValue, System::Security::Cryptography::OidGroup group) ;

/// @brief Method get_Value addr 0x28128d8 size 0x8 virtual false final false
 ::StringW get_Value() ;

/// @brief Method set_Value addr 0x28128e0 size 0x8 virtual false final false
 void set_Value(::StringW value) ;

/// @brief Method get_FriendlyName addr 0x28128e8 size 0x84 virtual false final false
...
/// @brief Method .ctor addr 0x281289c size 0x3c virtual false final false
