...
/// @brief Method .ctor addr 0x23379b4 size 0x88 virtual false final false
 void _ctor() ;

/// @brief Method get_Key addr 0x2337a3c size 0xc8 virtual true final false
 ::ArrayW<uint8_t> get_Key() ;

/// @brief Method set_Key addr 0x2337c40 size 0x1e4 virtual true final false
 void set_Key(::ArrayW<uint8_t> value) ;

/// @brief Method Create addr 0x2337e24 size 0x58 virtual false final false
static System::Security::Cryptography::TripleDES Create() ;

/// @brief Method IsWeakKey addr 0x2337b04 size 0x13c virtual false final false
static bool IsWeakKey(::ArrayW<uint8_t> rgbKey) ;

/// @brief Method EqualBytes addr 0x2337fc8 size 0x1a0 virtual false final false
static bool EqualBytes(::ArrayW<uint8_t> rgbKey, int32_t start1, int32_t start2, int32_t count) ;

/// @brief Method IsLegalKeySize addr 0x2337edc size 0x24 virtual false final false
