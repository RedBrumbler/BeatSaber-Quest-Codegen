...
/// @brief Method .ctor addr 0x232ce54 size 0x174 virtual false final false
 void _ctor() ;

/// @brief Method get_EffectiveKeySize addr 0x232cfc8 size 0x8 virtual true final false
 int32_t get_EffectiveKeySize() ;

/// @brief Method CreateEncryptor addr 0x232cfd0 size 0xd4 virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateEncryptor(::ArrayW<uint8_t> rgbKey, ::ArrayW<uint8_t> rgbIV) ;

/// @brief Method CreateDecryptor addr 0x232d0a4 size 0xd4 virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateDecryptor(::ArrayW<uint8_t> rgbKey, ::ArrayW<uint8_t> rgbIV) ;

/// @brief Method GenerateKey addr 0x232d178 size 0x7c virtual true final false
 void GenerateKey() ;

/// @brief Method GenerateIV addr 0x232d1f4 size 0x6c virtual true final false
 void GenerateIV() ;
