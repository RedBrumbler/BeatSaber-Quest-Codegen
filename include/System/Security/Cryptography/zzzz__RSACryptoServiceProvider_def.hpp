...
/// @brief Method get_UseMachineKeyStore addr 0x2332cd4 size 0x54 virtual false final false
static bool get_UseMachineKeyStore() ;

// Ctor Parameters []
explicit RSACryptoServiceProvider() ;

/// @brief Method .ctor addr 0x23322b4 size 0x2c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2332d60 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x2332d28 size 0x38 virtual false final false
...
/// @brief Method .ctor addr 0x2332d6c size 0x5c virtual false final false
 void _ctor(int32_t dwKeySize, System::Security::Cryptography::CspParameters parameters) ;

/// @brief Method Common addr 0x2332dc8 size 0x21c virtual false final false
 void Common(int32_t dwKeySize, bool parameters) ;

/// @brief Method Common addr 0x2332fe4 size 0x120 virtual false final false
 void Common(System::Security::Cryptography::CspParameters p) ;

/// @brief Method Finalize addr 0x2333104 size 0xa0 virtual true final false
 void Finalize() ;

/// @brief Method get_KeySize addr 0x23331a4 size 0x20 virtual true final false
 int32_t get_KeySize() ;

/// @brief Method get_PublicOnly addr 0x23331c4 size 0x1c virtual false final false
 bool get_PublicOnly() ;

/// @brief Method EncryptValue addr 0x23331e0 size 0x20 virtual true final false
 ::ArrayW<uint8_t> EncryptValue(::ArrayW<uint8_t> rgb) ;

/// @brief Method ExportParameters addr 0x2333200 size 0x140 virtual true final false
 System::Security::Cryptography::RSAParameters ExportParameters(bool includePrivateParameters) ;

/// @brief Method ImportParameters addr 0x2333340 size 0x54 virtual true final false
 void ImportParameters(System::Security::Cryptography::RSAParameters parameters) ;

/// @brief Method GetHashNameFromOID addr 0x2333394 size 0x1cc virtual false final false
 ::StringW GetHashNameFromOID(::StringW oid) ;

/// @brief Method VerifyHash addr 0x2333560 size 0x128 virtual false final false
 bool VerifyHash(::ArrayW<uint8_t> rgbHash, ::StringW str, ::ArrayW<uint8_t> rgbSignature) ;

/// @brief Method Dispose addr 0x2333688 size 0x54 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method OnKeyGenerated addr 0x23336dc size 0x84 virtual false final false
