...
/// @brief Method .ctor addr 0x233b088 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method Finalize addr 0x234137c size 0xa0 virtual true final false
 void Finalize() ;

/// @brief Method Dispose addr 0x234141c size 0xc virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method HashCore addr 0x2341428 size 0x24 virtual true final false
 void HashCore(::ArrayW<uint8_t> rgb, int32_t ibStart, int32_t cbSize) ;

/// @brief Method HashFinal addr 0x234144c size 0x20 virtual true final false
 ::ArrayW<uint8_t> HashFinal() ;

/// @brief Method Initialize addr 0x234146c size 0x18 virtual true final false
 void Initialize() ;
