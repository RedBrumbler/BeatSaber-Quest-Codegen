...
/// @brief Method .ctor addr 0x232cbe8 size 0x7c virtual false final false
 void _ctor() ;

/// @brief Method get_EffectiveKeySize addr 0x232cc64 size 0x1c virtual true final false
 int32_t get_EffectiveKeySize() ;

/// @brief Method get_KeySize addr 0x232cc80 size 0x8 virtual true final false
 int32_t get_KeySize() ;

/// @brief Method set_KeySize addr 0x232cc88 size 0x7c virtual true final false
