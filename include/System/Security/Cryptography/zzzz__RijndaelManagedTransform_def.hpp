...
/// @brief Method .ctor addr 0x232d770 size 0x610 virtual false final false
...
/// @brief Method Dispose addr 0x232e2dc size 0x8 virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x232e2e4 size 0xbc virtual false final false
 void Dispose(bool disposing) ;

/// @brief Method get_InputBlockSize addr 0x232e3a0 size 0x8 virtual true final true
 int32_t get_InputBlockSize() ;

/// @brief Method get_OutputBlockSize addr 0x232e3a8 size 0x8 virtual true final true
 int32_t get_OutputBlockSize() ;

/// @brief Method get_CanTransformMultipleBlocks addr 0x232e3b0 size 0x8 virtual true final true
 bool get_CanTransformMultipleBlocks() ;

/// @brief Method TransformBlock addr 0x232e3b8 size 0x2d8 virtual true final true
...
/// @brief Method TransformFinalBlock addr 0x232fcac size 0x2e8 virtual true final true
 ::ArrayW<uint8_t> TransformFinalBlock(::ArrayW<uint8_t> inputBuffer, int32_t inputOffset, int32_t inputCount) ;

/// @brief Method Reset addr 0x232ff94 size 0x68 virtual false final false
 void Reset() ;

/// @brief Method EncryptData addr 0x232e690 size 0xbb0 virtual false final false
...
/// @brief Method DecryptData addr 0x232f240 size 0xa6c virtual false final false
...
/// @brief Method Enc addr 0x232fffc size 0x1c4 virtual false final false
 void Enc(void* encryptindex, void* encryptKeyExpansion, void* T, void* TF, void* work, void* temp) ;

/// @brief Method Dec addr 0x23301c0 size 0x1e0 virtual false final false
 void Dec(void* decryptindex, void* decryptKeyExpansion, void* iT, void* iTF, void* work, void* temp) ;

/// @brief Method GenerateKeyExpansion addr 0x232dd80 size 0x55c virtual false final false
 void GenerateKeyExpansion(::ArrayW<uint8_t> rgbKey) ;

/// @brief Method rot1 addr 0x2330498 size 0x8 virtual false final false
static int32_t rot1(int32_t val) ;

/// @brief Method rot2 addr 0x2330490 size 0x8 virtual false final false
static int32_t rot2(int32_t val) ;

/// @brief Method rot3 addr 0x23303a0 size 0x8 virtual false final false
static int32_t rot3(int32_t val) ;

/// @brief Method SubWord addr 0x23303a8 size 0xc4 virtual false final false
static int32_t SubWord(int32_t a) ;

/// @brief Method MulX addr 0x233046c size 0x24 virtual false final false
