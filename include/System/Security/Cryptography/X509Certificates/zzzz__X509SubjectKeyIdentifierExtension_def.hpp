...
/// @brief Method .ctor addr 0x2824250 size 0x9c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x28242ec size 0xcc virtual false final false
...
/// @brief Method .ctor addr 0x282451c size 0x1b8 virtual false final false
...
/// @brief Method .ctor addr 0x2824748 size 0x168 virtual false final false
...
/// @brief Method .ctor addr 0x28249a0 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x28249ac size 0x3cc virtual false final false
...
/// @brief Method get_SubjectKeyIdentifier addr 0x2824d78 size 0x88 virtual false final false
 ::StringW get_SubjectKeyIdentifier() ;

/// @brief Method CopyFrom addr 0x2824e00 size 0x1e0 virtual true final false
 void CopyFrom(System::Security::Cryptography::AsnEncodedData asnEncodedData) ;

/// @brief Method FromHexChar addr 0x2824fe0 size 0x48 virtual false final false
static uint8_t FromHexChar(char16_t c) ;

/// @brief Method FromHexChars addr 0x2825028 size 0x9c virtual false final false
static uint8_t FromHexChars(char16_t c1, char16_t c2) ;

/// @brief Method FromHex addr 0x28248b0 size 0xf0 virtual false final false
static ::ArrayW<uint8_t> FromHex(::StringW hex) ;

/// @brief Method Decode addr 0x28243b8 size 0x164 virtual false final false
 System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t> extension) ;

/// @brief Method Encode addr 0x28246d4 size 0x74 virtual false final false
 ::ArrayW<uint8_t> Encode() ;

/// @brief Method ToString addr 0x28250c4 size 0x22c virtual true final false
