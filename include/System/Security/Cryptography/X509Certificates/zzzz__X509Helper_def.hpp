...
/// @brief Method get_CertificateProvider addr 0x2343dac size 0xc8 virtual false final false
static Mono::ISystemCertificateProvider get_CertificateProvider() ;

/// @brief Method InitFromCertificate addr 0x2343e74 size 0xb0 virtual false final false
...
/// @brief Method InitFromCertificate addr 0x2343f24 size 0x14 virtual false final false
...
/// @brief Method IsValid addr 0x2343f38 size 0x14 virtual false final false
static bool IsValid(System::Security::Cryptography::X509Certificates::X509CertificateImpl impl) ;

/// @brief Method ThrowIfContextInvalid addr 0x2343f4c size 0x40 virtual false final false
static void ThrowIfContextInvalid(System::Security::Cryptography::X509Certificates::X509CertificateImpl impl) ;

/// @brief Method GetInvalidContextException addr 0x23439f4 size 0x88 virtual false final false
static System::Exception GetInvalidContextException() ;

/// @brief Method Import addr 0x2343f8c size 0xac virtual false final false
static System::Security::Cryptography::X509Certificates::X509CertificateImpl Import(::ArrayW<uint8_t> rawData) ;

/// @brief Method Import addr 0x2344038 size 0xc8 virtual false final false
