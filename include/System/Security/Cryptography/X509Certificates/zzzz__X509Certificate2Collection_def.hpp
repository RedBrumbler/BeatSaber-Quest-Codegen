...
namespace System::Security::Cryptography::X509Certificates {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7870))}
...
/// @brief Method .ctor addr 0x2817fec size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method GetEnumerator addr 0x28197c4 size 0x60 virtual false final false
