...
/// @brief Method .ctor addr 0x2822954 size 0x44 virtual false final false
 void _ctor(System::Collections::ArrayList list) ;

/// @brief Method get_Current addr 0x2822a64 size 0xf0 virtual false final false
 System::Security::Cryptography::X509Certificates::X509Extension get_Current() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2822b54 size 0xa4 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method MoveNext addr 0x2822bf8 size 0xa0 virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x2822c98 size 0xa4 virtual true final true
 void Reset() ;
