...
/// @brief Method .ctor addr 0x281d564 size 0x1c virtual false final false
 void _ctor() ;

/// @brief Method get_ExtraStore addr 0x281e4bc size 0x26c virtual false final false
 System::Security::Cryptography::X509Certificates::X509Certificate2Collection get_ExtraStore() ;

/// @brief Method get_RevocationFlag addr 0x28205c8 size 0x8 virtual false final false
 System::Security::Cryptography::X509Certificates::X509RevocationFlag get_RevocationFlag() ;

/// @brief Method set_RevocationFlag addr 0x28205d0 size 0x64 virtual false final false
 void set_RevocationFlag(System::Security::Cryptography::X509Certificates::X509RevocationFlag value) ;

/// @brief Method get_RevocationMode addr 0x2820634 size 0x8 virtual false final false
 System::Security::Cryptography::X509Certificates::X509RevocationMode get_RevocationMode() ;

/// @brief Method set_RevocationMode addr 0x282063c size 0x64 virtual false final false
 void set_RevocationMode(System::Security::Cryptography::X509Certificates::X509RevocationMode value) ;

/// @brief Method set_UrlRetrievalTimeout addr 0x28206a0 size 0x8 virtual false final false
 void set_UrlRetrievalTimeout(System::TimeSpan value) ;

/// @brief Method get_VerificationFlags addr 0x28206a8 size 0x8 virtual false final false
 System::Security::Cryptography::X509Certificates::X509VerificationFlags get_VerificationFlags() ;

/// @brief Method set_VerificationFlags addr 0x28206b0 size 0x64 virtual false final false
 void set_VerificationFlags(System::Security::Cryptography::X509Certificates::X509VerificationFlags value) ;

/// @brief Method get_VerificationTime addr 0x2820714 size 0x8 virtual false final false
 System::DateTime get_VerificationTime() ;

/// @brief Method set_VerificationTime addr 0x282071c size 0x8 virtual false final false
 void set_VerificationTime(System::DateTime value) ;

/// @brief Method Reset addr 0x28204d4 size 0xf4 virtual false final false
 void Reset() ;
