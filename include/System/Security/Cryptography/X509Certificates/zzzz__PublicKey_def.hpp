...
/// @brief Method .ctor addr 0x28142d0 size 0x174 virtual false final false
...
/// @brief Method get_EncodedKeyValue addr 0x2814444 size 0x8 virtual false final false
 System::Security::Cryptography::AsnEncodedData get_EncodedKeyValue() ;

/// @brief Method get_EncodedParameters addr 0x281444c size 0x8 virtual false final false
 System::Security::Cryptography::AsnEncodedData get_EncodedParameters() ;

/// @brief Method get_Key addr 0x2814454 size 0x1a4 virtual false final false
 System::Security::Cryptography::AsymmetricAlgorithm get_Key() ;

/// @brief Method get_Oid addr 0x2814e5c size 0x8 virtual false final false
 System::Security::Cryptography::Oid get_Oid() ;

/// @brief Method GetUnsignedBigInteger addr 0x2814e64 size 0x94 virtual false final false
static ::ArrayW<uint8_t> GetUnsignedBigInteger(::ArrayW<uint8_t> integer) ;

/// @brief Method DecodeDSA addr 0x28149b0 size 0x4ac virtual false final false
static System::Security::Cryptography::DSA DecodeDSA(::ArrayW<uint8_t> rawPublicKey, ::ArrayW<uint8_t> rawParameters) ;

/// @brief Method DecodeRSA addr 0x28145f8 size 0x3b8 virtual false final false
