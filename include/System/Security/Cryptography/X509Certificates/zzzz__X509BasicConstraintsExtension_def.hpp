...
/// @brief Method .ctor addr 0x2815758 size 0xa8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2814120 size 0xd8 virtual false final false
...
/// @brief Method .ctor addr 0x28159c4 size 0x140 virtual false final false
 void _ctor(bool certificateAuthority, bool hasPathLengthConstraint, int32_t pathLengthConstraint, bool critical) ;

/// @brief Method get_CertificateAuthority addr 0x2815c5c size 0x6c virtual false final false
 bool get_CertificateAuthority() ;

/// @brief Method get_HasPathLengthConstraint addr 0x2815cc8 size 0x6c virtual false final false
 bool get_HasPathLengthConstraint() ;

/// @brief Method get_PathLengthConstraint addr 0x2815d34 size 0x6c virtual false final false
 int32_t get_PathLengthConstraint() ;

/// @brief Method CopyFrom addr 0x2815da0 size 0x1dc virtual true final false
 void CopyFrom(System::Security::Cryptography::AsnEncodedData asnEncodedData) ;

/// @brief Method Decode addr 0x2815800 size 0x1c4 virtual false final false
 System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t> extension) ;

/// @brief Method Encode addr 0x2815b04 size 0x158 virtual false final false
 ::ArrayW<uint8_t> Encode() ;

/// @brief Method ToString addr 0x2815f7c size 0x298 virtual true final false
