...
/// @brief Method .ctor addr 0x2814f60 size 0x110 virtual false final false
 void _ctor(::ArrayW<uint8_t> encodedDistinguishedName) ;

/// @brief Method get_Name addr 0x2815168 size 0x8 virtual false final false
 ::StringW get_Name() ;

/// @brief Method Decode addr 0x2815170 size 0x158 virtual false final false
 ::StringW Decode(System::Security::Cryptography::X509Certificates::X500DistinguishedNameFlags flag) ;

/// @brief Method Format addr 0x281533c size 0x5c virtual true final false
 ::StringW Format(bool multiLine) ;

/// @brief Method GetSeparator addr 0x28152c8 size 0x74 virtual false final false
static ::StringW GetSeparator(System::Security::Cryptography::X509Certificates::X500DistinguishedNameFlags flag) ;

/// @brief Method DecodeRawData addr 0x2815070 size 0xf8 virtual false final false
 void DecodeRawData() ;

/// @brief Method Canonize addr 0x2815398 size 0x1cc virtual false final false
static ::StringW Canonize(::StringW s) ;

/// @brief Method AreEqual addr 0x2815564 size 0x1f4 virtual false final false
