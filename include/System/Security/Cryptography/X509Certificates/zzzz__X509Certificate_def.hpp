...
/// @brief Method Reset addr 0x234169c size 0xb8 virtual true final false
 void Reset() ;

// Ctor Parameters []
explicit X509Certificate() ;

/// @brief Method .ctor addr 0x2341754 size 0x74 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x23417c8 size 0xa0 virtual false final false
...
/// @brief Method .ctor addr 0x2341868 size 0x94 virtual false final false
...
/// @brief Method .ctor addr 0x23418fc size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x2341908 size 0x264 virtual false final false
...
/// @brief Method .ctor addr 0x2341c80 size 0xe4 virtual false final false
...
/// @brief Method .ctor addr 0x2341d64 size 0x44 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x2341da8 size 0x40 virtual true final true
 void System_Runtime_Serialization_ISerializable_GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization addr 0x2341de8 size 0x40 virtual true final true
 void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::bs_hook::Il2CppWrapperType sender) ;

/// @brief Method get_Issuer addr 0x2341e28 size 0x58 virtual false final false
 ::StringW get_Issuer() ;

/// @brief Method get_Subject addr 0x2341e8c size 0x58 virtual false final false
 ::StringW get_Subject() ;

/// @brief Method Dispose addr 0x2341ee4 size 0x10 virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x2341ef4 size 0x14 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Equals addr 0x2341f08 size 0x94 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x2341f9c size 0xec virtual true final false
 bool Equals(System::Security::Cryptography::X509Certificates::X509Certificate other) ;

/// @brief Method GetCertHash addr 0x23420d8 size 0x28 virtual true final false
 ::ArrayW<uint8_t> GetCertHash() ;

/// @brief Method GetCertHashString addr 0x234214c size 0x28 virtual true final false
 ::StringW GetCertHashString() ;

/// @brief Method GetRawCertHash addr 0x2342100 size 0x4c virtual false final false
 ::ArrayW<uint8_t> GetRawCertHash() ;

/// @brief Method GetRawCertData addr 0x2342174 size 0x38 virtual true final false
 ::ArrayW<uint8_t> GetRawCertData() ;

/// @brief Method GetHashCode addr 0x23421ac size 0x78 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method GetKeyAlgorithm addr 0x2342224 size 0x5c virtual true final false
 ::StringW GetKeyAlgorithm() ;

/// @brief Method GetKeyAlgorithmParameters addr 0x2342280 size 0x60 virtual true final false
 ::ArrayW<uint8_t> GetKeyAlgorithmParameters() ;

/// @brief Method GetPublicKey addr 0x23422e0 size 0x60 virtual true final false
 ::ArrayW<uint8_t> GetPublicKey() ;

/// @brief Method GetSerialNumber addr 0x2342340 size 0x6c virtual true final false
 ::ArrayW<uint8_t> GetSerialNumber() ;

/// @brief Method GetSerialNumberString addr 0x23423ac size 0x28 virtual true final false
 ::StringW GetSerialNumberString() ;

/// @brief Method GetRawSerialNumber addr 0x2342088 size 0x50 virtual false final false
 ::ArrayW<uint8_t> GetRawSerialNumber() ;

/// @brief Method ToString addr 0x23423d4 size 0x14 virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x23423e8 size 0x33c virtual true final false
 ::StringW ToString(bool fVerbose) ;

/// @brief Method GetNotAfter addr 0x23428d4 size 0xa0 virtual false final false
 System::DateTime GetNotAfter() ;

/// @brief Method GetNotBefore addr 0x2342724 size 0xa0 virtual false final false
 System::DateTime GetNotBefore() ;

/// @brief Method FormatDate addr 0x23427c4 size 0x110 virtual false final false
static ::StringW FormatDate(System::DateTime date) ;

/// @brief Method ValidateKeyStorageFlags addr 0x2341b6c size 0x114 virtual false final false
static void ValidateKeyStorageFlags(System::Security::Cryptography::X509Certificates::X509KeyStorageFlags keyStorageFlags) ;

/// @brief Method ImportHandle addr 0x2342974 size 0x30 virtual false final false
 void ImportHandle(System::Security::Cryptography::X509Certificates::X509CertificateImpl impl) ;

/// @brief Method get_Impl addr 0x23429a4 size 0x8 virtual false final false
 System::Security::Cryptography::X509Certificates::X509CertificateImpl get_Impl() ;

/// @brief Method get_IsValid addr 0x23429ac size 0x100c virtual false final false
 bool get_IsValid() ;

/// @brief Method ThrowIfInvalid addr 0x2341e80 size 0xc virtual false final false
 void ThrowIfInvalid() ;
