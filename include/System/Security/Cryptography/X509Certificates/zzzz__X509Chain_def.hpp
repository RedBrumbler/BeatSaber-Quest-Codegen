...
/// @brief Method get_Impl addr 0x281c3cc size 0x20 virtual false final false
 System::Security::Cryptography::X509Certificates::X509ChainImpl get_Impl() ;

// Ctor Parameters []
explicit X509Chain() ;

/// @brief Method .ctor addr 0x281c3ec size 0x28 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x281c414 size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x281c448 size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x281c47c size 0x48 virtual false final false
 void _ctor(::cordl_internals::intptr_t chainContext) ;

/// @brief Method get_ChainElements addr 0x281c4c4 size 0x30 virtual false final false
 System::Security::Cryptography::X509Certificates::X509ChainElementCollection get_ChainElements() ;

/// @brief Method get_ChainPolicy addr 0x281c4f4 size 0x30 virtual false final false
 System::Security::Cryptography::X509Certificates::X509ChainPolicy get_ChainPolicy() ;

/// @brief Method get_ChainStatus addr 0x281c524 size 0x30 virtual false final false
 ::ArrayW<System::Security::Cryptography::X509Certificates::X509ChainStatus> get_ChainStatus() ;

/// @brief Method Build addr 0x281b224 size 0x40 virtual false final false
 bool Build(System::Security::Cryptography::X509Certificates::X509Certificate2 certificate) ;

/// @brief Method Reset addr 0x281c554 size 0x30 virtual false final false
 void Reset() ;

/// @brief Method Create addr 0x281b1b8 size 0x6c virtual false final false
static System::Security::Cryptography::X509Certificates::X509Chain Create() ;

/// @brief Method Dispose addr 0x281c584 size 0x6c virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x281c5f0 size 0x20 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Finalize addr 0x281c67c size 0xa0 virtual true final false
 void Finalize() ;
