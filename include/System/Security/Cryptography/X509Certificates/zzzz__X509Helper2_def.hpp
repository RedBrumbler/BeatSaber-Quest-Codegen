...
/// @brief Method GetMonoCertificate addr 0x2822d3c size 0xd4 virtual false final false
...
/// @brief Method CreateChainImpl addr 0x2822e10 size 0x64 virtual false final false
static System::Security::Cryptography::X509Certificates::X509ChainImpl CreateChainImpl(bool useMachineContext) ;

/// @brief Method IsValid addr 0x2822e74 size 0x14 virtual false final false
static bool IsValid(System::Security::Cryptography::X509Certificates::X509ChainImpl impl) ;

/// @brief Method ThrowIfContextInvalid addr 0x2822e88 size 0x40 virtual false final false
static void ThrowIfContextInvalid(System::Security::Cryptography::X509Certificates::X509ChainImpl impl) ;

/// @brief Method GetInvalidChainContextException addr 0x2822ec8 size 0x88 virtual false final false
