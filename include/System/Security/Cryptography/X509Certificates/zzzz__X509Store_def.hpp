...
/// @brief Method .ctor addr 0x2823c38 size 0x138 virtual false final false
...
/// @brief Method get_Certificates addr 0x2823d70 size 0x88 virtual false final false
 System::Security::Cryptography::X509Certificates::X509Certificate2Collection get_Certificates() ;

/// @brief Method get_Factory addr 0x2823df8 size 0x1c virtual false final false
 Mono::Security::X509::X509Stores get_Factory() ;

/// @brief Method get_Store addr 0x2823e14 size 0x8 virtual false final false
 Mono::Security::X509::X509Store get_Store() ;

/// @brief Method Close addr 0x2823e1c size 0x1c virtual false final false
 void Close() ;

/// @brief Method Dispose addr 0x2823e38 size 0x1c virtual true final true
 void Dispose() ;

/// @brief Method Open addr 0x2823e54 size 0x3fc virtual false final false
