...
/// @brief Method .ctor addr 0x281ce18 size 0xb4 virtual false final false
 void _ctor(System::Collections::IEnumerable enumerable) ;

/// @brief Method get_Current addr 0x281d0e8 size 0xf0 virtual false final false
 System::Security::Cryptography::X509Certificates::X509ChainElement get_Current() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x281d1d8 size 0xa4 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method MoveNext addr 0x281d27c size 0xa0 virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x281d31c size 0xa4 virtual true final true
 void Reset() ;
