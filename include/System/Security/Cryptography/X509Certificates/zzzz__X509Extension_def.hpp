...
/// @brief Method .ctor addr 0x282208c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2822094 size 0x28 virtual false final false
 void _ctor(::StringW oid, ::ArrayW<uint8_t> rawData, bool critical) ;

/// @brief Method get_Critical addr 0x28220bc size 0x8 virtual false final false
 bool get_Critical() ;

/// @brief Method set_Critical addr 0x28220c4 size 0xc virtual false final false
 void set_Critical(bool value) ;

/// @brief Method CopyFrom addr 0x28220d0 size 0x130 virtual true final false
 void CopyFrom(System::Security::Cryptography::AsnEncodedData asnEncodedData) ;

/// @brief Method FormatUnkownData addr 0x2822200 size 0x114 virtual false final false
