...
namespace System::Security::Cryptography::X509Certificates {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7866))}
...
/// @brief Method EnsureCertData addr 0x281b334 size 0x80 virtual false final false
 void EnsureCertData() ;

/// @brief Method GetRawCertData addr 0x0 size 0xffffffffffffffff virtual true final false
 ::ArrayW<uint8_t> GetRawCertData() ;

/// @brief Method get_KeyAlgorithm addr 0x281b3b4 size 0x18 virtual true final true
 ::StringW get_KeyAlgorithm() ;

/// @brief Method get_KeyAlgorithmParameters addr 0x281b3cc size 0x18 virtual true final true
 ::ArrayW<uint8_t> get_KeyAlgorithmParameters() ;

/// @brief Method get_PublicKeyValue addr 0x281b3e4 size 0x18 virtual true final true
 ::ArrayW<uint8_t> get_PublicKeyValue() ;

/// @brief Method get_SerialNumber addr 0x281b3fc size 0x18 virtual true final true
 ::ArrayW<uint8_t> get_SerialNumber() ;

/// @brief Method get_SignatureAlgorithm addr 0x281b414 size 0x18 virtual true final true
 ::StringW get_SignatureAlgorithm() ;

/// @brief Method get_Version addr 0x281b42c size 0x1c virtual true final true
 int32_t get_Version() ;

/// @brief Method get_SubjectName addr 0x281b448 size 0x18 virtual true final true
 System::Security::Cryptography::X509Certificates::X500DistinguishedName get_SubjectName() ;

/// @brief Method get_IssuerName addr 0x281b460 size 0x18 virtual true final true
 System::Security::Cryptography::X509Certificates::X500DistinguishedName get_IssuerName() ;

/// @brief Method get_Subject addr 0x281b478 size 0x28 virtual true final true
 ::StringW get_Subject() ;

/// @brief Method get_Issuer addr 0x281b4a0 size 0x28 virtual true final true
 ::StringW get_Issuer() ;

/// @brief Method get_RawData addr 0x281b4c8 size 0x18 virtual true final true
 ::ArrayW<uint8_t> get_RawData() ;

/// @brief Method get_Thumbprint addr 0x281b4e0 size 0x194 virtual true final true
 ::ArrayW<uint8_t> get_Thumbprint() ;

/// @brief Method GetNameInfo addr 0x281b674 size 0x34 virtual true final true
 ::StringW GetNameInfo(System::Security::Cryptography::X509Certificates::X509NameType nameType, bool forIssuer) ;

/// @brief Method get_Extensions addr 0x281b6a8 size 0x18 virtual true final true
 System::Collections::Generic::IEnumerable_1<System::Security::Cryptography::X509Certificates::X509Extension> get_Extensions() ;

/// @brief Method get_NotAfter addr 0x281b6c0 size 0x1c virtual true final true
 System::DateTime get_NotAfter() ;

/// @brief Method get_NotBefore addr 0x281b6dc size 0x1c virtual true final true
 System::DateTime get_NotBefore() ;

/// @brief Method AppendPrivateKeyInfo addr 0x281b6f8 size 0x94 virtual true final true
 void AppendPrivateKeyInfo(System::Text::StringBuilder sb) ;

// Ctor Parameters []
explicit X509Certificate2ImplUnix() ;

/// @brief Method .ctor addr 0x2819df0 size 0x8 virtual false final false
 void _ctor() ;
