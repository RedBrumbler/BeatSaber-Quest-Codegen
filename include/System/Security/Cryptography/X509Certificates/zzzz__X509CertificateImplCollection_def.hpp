...
/// @brief Method .ctor addr 0x281afd0 size 0x80 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x281bdd0 size 0x230 virtual false final false
 void _ctor(System::Security::Cryptography::X509Certificates::X509CertificateImplCollection other) ;

/// @brief Method get_Count addr 0x281c000 size 0x48 virtual false final false
 int32_t get_Count() ;

/// @brief Method get_Item addr 0x281c048 size 0x58 virtual false final false
 System::Security::Cryptography::X509Certificates::X509CertificateImpl get_Item(int32_t index) ;

/// @brief Method Add addr 0x281b050 size 0xd4 virtual false final false
 void Add(System::Security::Cryptography::X509Certificates::X509CertificateImpl impl, bool takeOwnership) ;

/// @brief Method Clone addr 0x2819e3c size 0x60 virtual false final false
 System::Security::Cryptography::X509Certificates::X509CertificateImplCollection Clone() ;

/// @brief Method Dispose addr 0x281c0a0 size 0x6c virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x281c10c size 0x220 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Finalize addr 0x281c32c size 0xa0 virtual true final false
 void Finalize() ;
