...
namespace System::Security::Cryptography::X509Certificates {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7876))}
...
/// @brief Method .ctor addr 0x281d4ac size 0xb8 virtual false final false
 void _ctor(bool useMachineContext) ;

/// @brief Method get_IsValid addr 0x281d580 size 0x8 virtual true final false
 bool get_IsValid() ;

/// @brief Method get_ChainElements addr 0x281d588 size 0x8 virtual true final false
 System::Security::Cryptography::X509Certificates::X509ChainElementCollection get_ChainElements() ;

/// @brief Method get_ChainPolicy addr 0x281d590 size 0x8 virtual true final false
 System::Security::Cryptography::X509Certificates::X509ChainPolicy get_ChainPolicy() ;

/// @brief Method get_ChainStatus addr 0x281d598 size 0x64 virtual true final false
 ::ArrayW<System::Security::Cryptography::X509Certificates::X509ChainStatus> get_ChainStatus() ;

/// @brief Method AddStatus addr 0x281d5fc size 0x4 virtual true final false
 void AddStatus(System::Security::Cryptography::X509Certificates::X509ChainStatusFlags error) ;

/// @brief Method Build addr 0x281d600 size 0x5bc virtual true final false
 bool Build(System::Security::Cryptography::X509Certificates::X509Certificate2 certificate) ;

/// @brief Method Reset addr 0x281ddd8 size 0xcc virtual true final false
 void Reset() ;

/// @brief Method get_Roots addr 0x281dea4 size 0xc0 virtual false final false
 System::Security::Cryptography::X509Certificates::X509Certificate2Collection get_Roots() ;

/// @brief Method get_CertificateAuthorities addr 0x281e14c size 0xc0 virtual false final false
 System::Security::Cryptography::X509Certificates::X509Certificate2Collection get_CertificateAuthorities() ;

/// @brief Method get_LMRootStore addr 0x281df64 size 0xf4 virtual false final false
 System::Security::Cryptography::X509Certificates::X509Store get_LMRootStore() ;

/// @brief Method get_UserRootStore addr 0x281e058 size 0xf4 virtual false final false
 System::Security::Cryptography::X509Certificates::X509Store get_UserRootStore() ;

/// @brief Method get_LMCAStore addr 0x281e20c size 0xf4 virtual false final false
 System::Security::Cryptography::X509Certificates::X509Store get_LMCAStore() ;

/// @brief Method get_UserCAStore addr 0x281e300 size 0xf4 virtual false final false
 System::Security::Cryptography::X509Certificates::X509Store get_UserCAStore() ;

/// @brief Method get_CertificateCollection addr 0x281e3f4 size 0xc8 virtual false final false
 System::Security::Cryptography::X509Certificates::X509Certificate2Collection get_CertificateCollection() ;

/// @brief Method BuildChainFrom addr 0x281dbbc size 0xe8 virtual false final false
...
/// @brief Method SelectBestFromCollection addr 0x281e904 size 0x18c virtual false final false
...
/// @brief Method FindParent addr 0x281e728 size 0x114 virtual false final false
...
/// @brief Method IsChainComplete addr 0x281e83c size 0xc8 virtual false final false
 bool IsChainComplete(System::Security::Cryptography::X509Certificates::X509Certificate2 certificate) ;

/// @brief Method IsSelfIssued addr 0x281ebe0 size 0x48 virtual false final false
 bool IsSelfIssued(System::Security::Cryptography::X509Certificates::X509Certificate2 certificate) ;

/// @brief Method ValidateChain addr 0x281dca4 size 0x114 virtual false final false
 void ValidateChain(System::Security::Cryptography::X509Certificates::X509ChainStatusFlags flag) ;

/// @brief Method Process addr 0x281ec28 size 0x2a8 virtual false final false
 void Process(int32_t n) ;

/// @brief Method PrepareForNextCertificate addr 0x281eed0 size 0x200 virtual false final false
 void PrepareForNextCertificate(int32_t n) ;

/// @brief Method WrapUp addr 0x281f2c0 size 0x8c virtual false final false
 void WrapUp() ;

/// @brief Method ProcessCertificateExtensions addr 0x281f388 size 0xf8 virtual false final false
 void ProcessCertificateExtensions(System::Security::Cryptography::X509Certificates::X509ChainElement element) ;

/// @brief Method IsSignedWith addr 0x281f34c size 0x3c virtual false final false
...
/// @brief Method GetSubjectKeyIdentifier addr 0x281eb28 size 0xb8 virtual false final false
 ::StringW GetSubjectKeyIdentifier(System::Security::Cryptography::X509Certificates::X509Certificate2 certificate) ;

/// @brief Method GetAuthorityKeyIdentifier addr 0x281ea90 size 0x98 virtual false final false
static ::StringW GetAuthorityKeyIdentifier(System::Security::Cryptography::X509Certificates::X509Certificate2 certificate) ;

/// @brief Method GetAuthorityKeyIdentifier addr 0x281f5dc size 0x8c virtual false final false
static ::StringW GetAuthorityKeyIdentifier(Mono::Security::X509::X509Crl crl) ;

/// @brief Method GetAuthorityKeyIdentifier addr 0x281f480 size 0x15c virtual false final false
static ::StringW GetAuthorityKeyIdentifier(Mono::Security::X509::X509Extension ext) ;

/// @brief Method CheckRevocationOnChain addr 0x281f0d0 size 0x1f0 virtual false final false
 void CheckRevocationOnChain(System::Security::Cryptography::X509Certificates::X509ChainStatusFlags flag) ;

/// @brief Method CheckRevocation addr 0x281f668 size 0xcc virtual false final false
...
/// @brief Method CheckRevocation addr 0x281f734 size 0x1d8 virtual false final false
...
/// @brief Method CheckCrls addr 0x28200d8 size 0x394 virtual false final false
static Mono::Security::X509::X509Crl CheckCrls(::StringW subject, ::StringW ski, Mono::Security::X509::X509Store store) ;

/// @brief Method FindCrl addr 0x281f90c size 0x174 virtual false final false
 Mono::Security::X509::X509Crl FindCrl(System::Security::Cryptography::X509Certificates::X509Certificate2 caCertificate) ;

/// @brief Method ProcessCrlExtensions addr 0x281fd90 size 0x348 virtual false final false
 bool ProcessCrlExtensions(Mono::Security::X509::X509Crl crl) ;

/// @brief Method ProcessCrlEntryExtensions addr 0x281fa80 size 0x310 virtual false final false
