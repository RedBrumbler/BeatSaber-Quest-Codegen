...
/// @brief Method .ctor addr 0x281ddb8 size 0x20 virtual false final false
 void _ctor(System::Security::Cryptography::X509Certificates::X509ChainStatusFlags flag) ;

/// @brief Method get_Status addr 0x2820724 size 0x8 virtual false final false
 System::Security::Cryptography::X509Certificates::X509ChainStatusFlags get_Status() ;

/// @brief Method set_Status addr 0x282072c size 0x8 virtual false final false
 void set_Status(System::Security::Cryptography::X509Certificates::X509ChainStatusFlags value) ;

/// @brief Method set_StatusInformation addr 0x2820734 size 0x8 virtual false final false
 void set_StatusInformation(::StringW value) ;

/// @brief Method GetInformation addr 0x281c840 size 0x198 virtual false final false
