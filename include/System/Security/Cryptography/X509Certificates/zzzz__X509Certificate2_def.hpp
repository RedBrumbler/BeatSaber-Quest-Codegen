...
/// @brief Method Reset addr 0x2816214 size 0x58 virtual true final false
 void Reset() ;

// Ctor Parameters []
explicit X509Certificate2() ;

/// @brief Method .ctor addr 0x281626c size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2816274 size 0x1c8 virtual false final false
...
/// @brief Method .ctor addr 0x281643c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2816444 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x281644c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2816454 size 0x48 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method get_Extensions addr 0x281649c size 0x3c0 virtual false final false
 System::Security::Cryptography::X509Certificates::X509ExtensionCollection get_Extensions() ;

/// @brief Method get_HasPrivateKey addr 0x2816ac4 size 0x34 virtual false final false
 bool get_HasPrivateKey() ;

/// @brief Method get_PrivateKey addr 0x2816af8 size 0x15c virtual false final false
 System::Security::Cryptography::AsymmetricAlgorithm get_PrivateKey() ;

/// @brief Method get_IssuerName addr 0x2816c54 size 0x5c virtual false final false
 System::Security::Cryptography::X509Certificates::X500DistinguishedName get_IssuerName() ;

/// @brief Method get_NotAfter addr 0x2816cb0 size 0x8 virtual false final false
 System::DateTime get_NotAfter() ;

/// @brief Method get_NotBefore addr 0x2816cb8 size 0x8 virtual false final false
 System::DateTime get_NotBefore() ;

/// @brief Method get_PublicKey addr 0x2816cc0 size 0x15c virtual false final false
 System::Security::Cryptography::X509Certificates::PublicKey get_PublicKey() ;

/// @brief Method get_RawData addr 0x2816e1c size 0x5c virtual false final false
 ::ArrayW<uint8_t> get_RawData() ;

/// @brief Method get_SerialNumber addr 0x2816e78 size 0x10 virtual false final false
 ::StringW get_SerialNumber() ;

/// @brief Method get_SignatureAlgorithm addr 0x2816e88 size 0x64 virtual false final false
 System::Security::Cryptography::Oid get_SignatureAlgorithm() ;

/// @brief Method get_SubjectName addr 0x2816eec size 0x5c virtual false final false
 System::Security::Cryptography::X509Certificates::X500DistinguishedName get_SubjectName() ;

/// @brief Method get_Thumbprint addr 0x2816f48 size 0x1c virtual false final false
 ::StringW get_Thumbprint() ;

/// @brief Method get_Version addr 0x2816f64 size 0x5c virtual false final false
 int32_t get_Version() ;

/// @brief Method GetCertContentType addr 0x2816fc0 size 0x9c virtual false final false
static System::Security::Cryptography::X509Certificates::X509ContentType GetCertContentType(::ArrayW<uint8_t> rawData) ;

/// @brief Method GetNameInfo addr 0x281705c size 0x3c virtual false final false
 ::StringW GetNameInfo(System::Security::Cryptography::X509Certificates::X509NameType nameType, bool forIssuer) ;

/// @brief Method ToString addr 0x2817098 size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x28170a4 size 0xe74 virtual true final false
 ::StringW ToString(bool verbose) ;

/// @brief Method Verify addr 0x2817f18 size 0x2c virtual false final false
 bool Verify() ;

/// @brief Method CreateCustomExtensionIfAny addr 0x28168e8 size 0x1dc virtual false final false
...
/// @brief Method get_Impl addr 0x281685c size 0x8c virtual false final false
