...
/// @brief Method .ctor addr 0x232bc30 size 0x24 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "key", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None }]
explicit HMACSHA384(::ArrayW<uint8_t> key) ;

/// @brief Method .ctor addr 0x232bc54 size 0xf0 virtual false final false
 void _ctor(::ArrayW<uint8_t> key) ;

/// @brief Method get_BlockSize addr 0x232bd44 size 0x18 virtual false final false
