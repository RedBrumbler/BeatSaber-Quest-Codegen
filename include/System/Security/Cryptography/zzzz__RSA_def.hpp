...
/// @brief Method .ctor addr 0x2332238 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Create addr 0x2332240 size 0x74 virtual false final false
static System::Security::Cryptography::RSA Create() ;

/// @brief Method EncryptValue addr 0x23322e0 size 0x60 virtual true final false
 ::ArrayW<uint8_t> EncryptValue(::ArrayW<uint8_t> rgb) ;

/// @brief Method FromXmlString addr 0x2332340 size 0x558 virtual true final false
 void FromXmlString(::StringW xmlString) ;

/// @brief Method ToXmlString addr 0x2332898 size 0x43c virtual true final false
