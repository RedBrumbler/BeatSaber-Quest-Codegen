...
/// @brief Method .ctor addr 0x2328fe0 size 0x7c virtual false final false
 void _ctor() ;

/// @brief Method get_Key addr 0x232905c size 0xe8 virtual true final false
 ::ArrayW<uint8_t> get_Key() ;

/// @brief Method set_Key addr 0x2329480 size 0x20c virtual true final false
 void set_Key(::ArrayW<uint8_t> value) ;

/// @brief Method Create addr 0x232968c size 0x5c virtual false final false
static System::Security::Cryptography::DES Create() ;

/// @brief Method IsWeakKey addr 0x2329144 size 0x128 virtual false final false
static bool IsWeakKey(::ArrayW<uint8_t> rgbKey) ;

/// @brief Method IsSemiWeakKey addr 0x232926c size 0x214 virtual false final false
static bool IsSemiWeakKey(::ArrayW<uint8_t> rgbKey) ;

/// @brief Method IsLegalKeySize addr 0x23296e8 size 0x20 virtual false final false
static bool IsLegalKeySize(::ArrayW<uint8_t> rgbKey) ;

/// @brief Method QuadWordFromBigEndian addr 0x2329708 size 0x98 virtual false final false
