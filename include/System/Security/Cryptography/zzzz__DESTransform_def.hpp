...
/// @brief Method .ctor addr 0x233beb8 size 0x228 virtual false final false
 void _ctor(System::Security::Cryptography::SymmetricAlgorithm symmAlgo, bool encryption, ::ArrayW<uint8_t> key, ::ArrayW<uint8_t> iv) ;

/// @brief Method CipherFunct addr 0x233c544 size 0x230 virtual false final false
 uint32_t CipherFunct(uint32_t r, int32_t n) ;

/// @brief Method Permutation addr 0x233c774 size 0x324 virtual false final false
static void Permutation(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output, ::ArrayW<uint32_t> permTab, bool preSwap) ;

/// @brief Method BSwap addr 0x233ca98 size 0x78 virtual false final false
static void BSwap(::ArrayW<uint8_t> byteBuff) ;

/// @brief Method SetKey addr 0x233c1b8 size 0x38c virtual false final false
 void SetKey(::ArrayW<uint8_t> key) ;

/// @brief Method ProcessBlock addr 0x233cb10 size 0x388 virtual false final false
 void ProcessBlock(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output) ;

/// @brief Method ECB addr 0x233ce98 size 0xa4 virtual true final false
 void ECB(::ArrayW<uint8_t> input, ::ArrayW<uint8_t> output) ;

/// @brief Method GetStrongKey addr 0x233c0e0 size 0xd8 virtual false final false
