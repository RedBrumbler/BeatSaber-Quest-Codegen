...
/// @brief Method get_Flags addr 0x2328dfc size 0x8 virtual false final false
 System::Security::Cryptography::CspProviderFlags get_Flags() ;

/// @brief Method set_Flags addr 0x2328e04 size 0xe8 virtual false final false
 void set_Flags(System::Security::Cryptography::CspProviderFlags value) ;

// Ctor Parameters []
explicit CspParameters() ;

/// @brief Method .ctor addr 0x2328eec size 0x2c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "dwTypeIn", ty: "int32_t", modifiers: "", def_value: None }]
explicit CspParameters(int32_t dwTypeIn) ;

/// @brief Method .ctor addr 0x2328f5c size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x2328f18 size 0x44 virtual false final false
...
/// @brief Method .ctor addr 0x2328f90 size 0x50 virtual false final false
