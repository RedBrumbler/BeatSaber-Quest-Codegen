...
/// @brief Method .ctor addr 0x2336f14 size 0x24 virtual false final false
 void _ctor() ;

/// @brief Method Dispose addr 0x2336f38 size 0x6c virtual true final true
 void Dispose() ;

/// @brief Method Clear addr 0x2336fa4 size 0x94 virtual false final false
 void Clear() ;

/// @brief Method Dispose addr 0x2337038 size 0x4c virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method get_BlockSize addr 0x2337084 size 0x8 virtual true final false
 int32_t get_BlockSize() ;

/// @brief Method set_BlockSize addr 0x233708c size 0xf0 virtual true final false
 void set_BlockSize(int32_t value) ;

/// @brief Method get_FeedbackSize addr 0x233717c size 0x8 virtual true final false
 int32_t get_FeedbackSize() ;

/// @brief Method get_IV addr 0x2337184 size 0x94 virtual true final false
 ::ArrayW<uint8_t> get_IV() ;

/// @brief Method set_IV addr 0x2337218 size 0x168 virtual true final false
 void set_IV(::ArrayW<uint8_t> value) ;

/// @brief Method get_Key addr 0x2337380 size 0x94 virtual true final false
 ::ArrayW<uint8_t> get_Key() ;

/// @brief Method set_Key addr 0x2337414 size 0x160 virtual true final false
 void set_Key(::ArrayW<uint8_t> value) ;

/// @brief Method get_LegalKeySizes addr 0x2337610 size 0x78 virtual true final false
 ::ArrayW<System::Security::Cryptography::KeySizes> get_LegalKeySizes() ;

/// @brief Method get_KeySize addr 0x2337688 size 0x8 virtual true final false
 int32_t get_KeySize() ;

/// @brief Method set_KeySize addr 0x2337690 size 0x84 virtual true final false
 void set_KeySize(int32_t value) ;

/// @brief Method get_Mode addr 0x2337714 size 0x8 virtual true final false
 System::Security::Cryptography::CipherMode get_Mode() ;

/// @brief Method set_Mode addr 0x233771c size 0x7c virtual true final false
 void set_Mode(System::Security::Cryptography::CipherMode value) ;

/// @brief Method get_Padding addr 0x2337798 size 0x8 virtual true final false
 System::Security::Cryptography::PaddingMode get_Padding() ;

/// @brief Method set_Padding addr 0x23377a0 size 0x7c virtual true final false
 void set_Padding(System::Security::Cryptography::PaddingMode value) ;

/// @brief Method ValidKeySize addr 0x2337574 size 0x9c virtual false final false
 bool ValidKeySize(int32_t bitLength) ;

/// @brief Method Create addr 0x233781c size 0xa0 virtual false final false
static System::Security::Cryptography::SymmetricAlgorithm Create(::StringW algName) ;

/// @brief Method CreateEncryptor addr 0x2337914 size 0x50 virtual true final false
...
/// @brief Method CreateDecryptor addr 0x2337964 size 0x50 virtual true final false
