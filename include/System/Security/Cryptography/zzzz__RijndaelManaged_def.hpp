...
/// @brief Method .ctor addr 0x232d50c size 0xe0 virtual false final false
 void _ctor() ;

/// @brief Method CreateEncryptor addr 0x232d5ec size 0x14 virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateEncryptor(::ArrayW<uint8_t> rgbKey, ::ArrayW<uint8_t> rgbIV) ;

/// @brief Method CreateDecryptor addr 0x232d6fc size 0x14 virtual true final false
 System::Security::Cryptography::ICryptoTransform CreateDecryptor(::ArrayW<uint8_t> rgbKey, ::ArrayW<uint8_t> rgbIV) ;

/// @brief Method GenerateKey addr 0x232d710 size 0x30 virtual true final false
 void GenerateKey() ;

/// @brief Method GenerateIV addr 0x232d740 size 0x30 virtual true final false
 void GenerateIV() ;

/// @brief Method NewEncryptor addr 0x232d600 size 0xfc virtual false final false
