...
/// @brief Method .ctor addr 0x232a91c size 0x80 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x232a99c size 0xf4 virtual false final false
 void _ctor(System::Security::Cryptography::AsymmetricAlgorithm key) ;

/// @brief Method SetKey addr 0x232aa90 size 0xec virtual true final false
 void SetKey(System::Security::Cryptography::AsymmetricAlgorithm key) ;

/// @brief Method SetHashAlgorithm addr 0x232ab7c size 0xd0 virtual true final false
 void SetHashAlgorithm(::StringW strName) ;

/// @brief Method VerifySignature addr 0x232ac4c size 0xf4 virtual true final false
