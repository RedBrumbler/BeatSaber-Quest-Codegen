...
/// @brief Method .ctor addr 0x23389d8 size 0x98 virtual false final false
 void _ctor() ;

/// @brief Method Check addr 0x233f90c size 0xb4 virtual false final false
 void Check() ;

/// @brief Method RngOpen addr 0x233f904 size 0x4 virtual false final false
static bool RngOpen() ;

/// @brief Method RngInitialize addr 0x233f908 size 0x4 virtual false final false
static ::cordl_internals::intptr_t RngInitialize(void* seed, ::cordl_internals::intptr_t seed_length) ;

/// @brief Method RngGetBytes addr 0x233f9c0 size 0x4 virtual false final false
...
/// @brief Method RngClose addr 0x233f9c4 size 0x4 virtual false final false
static void RngClose(::cordl_internals::intptr_t handle) ;

/// @brief Method GetBytes addr 0x233f9c8 size 0x21c virtual true final false
 void GetBytes(::ArrayW<uint8_t> data) ;

/// @brief Method Finalize addr 0x233fbe4 size 0x118 virtual true final false
 void Finalize() ;

/// @brief Method Dispose addr 0x233fcfc size 0xc virtual true final false
