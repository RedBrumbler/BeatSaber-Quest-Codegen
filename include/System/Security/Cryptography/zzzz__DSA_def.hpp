...
/// @brief Method .ctor addr 0x2329da4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Create addr 0x2329dac size 0x5c virtual false final false
...
/// @brief Method FromXmlString addr 0x2329e08 size 0x6ac virtual true final false
 void FromXmlString(::StringW xmlString) ;

/// @brief Method ToXmlString addr 0x232a4b4 size 0x468 virtual true final false
