...
/// @brief Method .ctor addr 0x232b718 size 0x124 virtual false final false
 void _ctor() ;

/// @brief Method Initialize addr 0x2330788 size 0x44 virtual true final false
 void Initialize() ;

/// @brief Method HashCore addr 0x23307cc size 0x4 virtual true final false
 void HashCore(::ArrayW<uint8_t> rgb, int32_t ibStart, int32_t cbSize) ;

/// @brief Method HashFinal addr 0x233094c size 0x4 virtual true final false
 ::ArrayW<uint8_t> HashFinal() ;

/// @brief Method InitializeState addr 0x2330704 size 0x84 virtual false final false
 void InitializeState() ;

/// @brief Method _HashData addr 0x23307d0 size 0x17c virtual false final false
 void _HashData(::ArrayW<uint8_t> partIn, int32_t ibStart, int32_t cbSize) ;

/// @brief Method _EndHash addr 0x2330950 size 0x1a8 virtual false final false
 ::ArrayW<uint8_t> _EndHash() ;

/// @brief Method MDTransform addr 0x2330af8 size 0x16fc virtual false final false
static void MDTransform(void* blockDWords, void* state, void* block) ;

/// @brief Method F addr 0x23321f4 size 0xc virtual false final false
static uint32_t F(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method G addr 0x2332200 size 0x10 virtual false final false
static uint32_t G(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method H addr 0x2332210 size 0xc virtual false final false
static uint32_t H(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method I addr 0x233221c size 0x10 virtual false final false
static uint32_t I(uint32_t x, uint32_t y, uint32_t z) ;

/// @brief Method J addr 0x233222c size 0xc virtual false final false
