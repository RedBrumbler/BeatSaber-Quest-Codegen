...
/// @brief Method .ctor addr 0x2812e28 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2812e30 size 0x84 virtual false final false
...
/// @brief Method .ctor addr 0x2812fa8 size 0x3c virtual false final false
...
/// @brief Method .ctor addr 0x2813054 size 0xe0 virtual false final false
 void _ctor(System::Security::Cryptography::AsnEncodedData asnEncodedData) ;

/// @brief Method get_Oid addr 0x2813134 size 0x8 virtual false final false
 System::Security::Cryptography::Oid get_Oid() ;

/// @brief Method set_Oid addr 0x2812fe4 size 0x70 virtual false final false
 void set_Oid(System::Security::Cryptography::Oid value) ;

/// @brief Method get_RawData addr 0x281313c size 0x8 virtual false final false
 ::ArrayW<uint8_t> get_RawData() ;

/// @brief Method set_RawData addr 0x2812eb4 size 0xf4 virtual false final false
 void set_RawData(::ArrayW<uint8_t> value) ;

/// @brief Method CopyFrom addr 0x2813144 size 0xfc virtual true final false
 void CopyFrom(System::Security::Cryptography::AsnEncodedData asnEncodedData) ;

/// @brief Method Format addr 0x2813240 size 0x90 virtual true final false
 ::StringW Format(bool multiLine) ;

/// @brief Method ToString addr 0x28133e4 size 0x1b0 virtual true final false
 ::StringW ToString(bool multiLine) ;

/// @brief Method Default addr 0x28132d0 size 0x114 virtual false final false
 ::StringW Default(bool multiLine) ;

/// @brief Method BasicConstraintsExtension addr 0x2813594 size 0x10c virtual false final false
 ::StringW BasicConstraintsExtension(bool multiLine) ;

/// @brief Method EnhancedKeyUsageExtension addr 0x28136a0 size 0x10c virtual false final false
 ::StringW EnhancedKeyUsageExtension(bool multiLine) ;

/// @brief Method KeyUsageExtension addr 0x28137ac size 0x110 virtual false final false
 ::StringW KeyUsageExtension(bool multiLine) ;

/// @brief Method SubjectKeyIdentifierExtension addr 0x28138bc size 0x110 virtual false final false
 ::StringW SubjectKeyIdentifierExtension(bool multiLine) ;

/// @brief Method SubjectAltName addr 0x28139cc size 0x3c0 virtual false final false
 ::StringW SubjectAltName(bool multiLine) ;

/// @brief Method NetscapeCertType addr 0x2813d8c size 0x394 virtual false final false
