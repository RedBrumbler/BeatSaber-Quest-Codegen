...
/// @brief Method .ctor addr 0x231e244 size 0x6c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x231e330 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x231dd18 size 0x4c virtual false final false
 void _ctor(System::Security::IPermission perm) ;

/// @brief Method CopyTo addr 0x231ebcc size 0x178 virtual true final false
 void CopyTo(System::Array array, int32_t index) ;

/// @brief Method Demand addr 0x231ed44 size 0x228 virtual true final true
 void Demand() ;

/// @brief Method CasOnlyDemand addr 0x231dd64 size 0x78 virtual false final false
 void CasOnlyDemand(int32_t skip) ;

/// @brief Method GetEnumerator addr 0x231f31c size 0x24 virtual true final true
 System::Collections::IEnumerator GetEnumerator() ;

/// @brief Method IsEmpty addr 0x231ef6c size 0x3a0 virtual false final false
 bool IsEmpty() ;

/// @brief Method IsUnrestricted addr 0x231f30c size 0x10 virtual false final false
 bool IsUnrestricted() ;

/// @brief Method ToString addr 0x231f340 size 0x2c virtual true final false
 ::StringW ToString() ;

/// @brief Method ToXml addr 0x231e4c8 size 0x45c virtual true final false
 System::Security::SecurityElement ToXml() ;

/// @brief Method get_Count addr 0x231f36c size 0x24 virtual true final false
 int32_t get_Count() ;

/// @brief Method get_IsSynchronized addr 0x231f390 size 0x24 virtual true final false
 bool get_IsSynchronized() ;

/// @brief Method get_SyncRoot addr 0x231f3b4 size 0x4 virtual true final false
 ::bs_hook::Il2CppWrapperType get_SyncRoot() ;

/// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization addr 0x231f3b8 size 0x4 virtual true final true
 void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::bs_hook::Il2CppWrapperType sender) ;

/// @brief Method Equals addr 0x231e9b4 size 0x19c virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x231eb88 size 0x44 virtual true final false
 int32_t GetHashCode() ;
