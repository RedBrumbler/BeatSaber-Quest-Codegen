...
/// @brief Method .ctor addr 0x2323350 size 0x30 virtual false final false
 void _ctor(System::Collections::IEnumerator hostenum, System::Collections::IEnumerator assemblyenum) ;

/// @brief Method MoveNext addr 0x2323380 size 0x128 virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x23234a8 size 0x120 virtual true final true
 void Reset() ;

/// @brief Method get_Current addr 0x23235c8 size 0xa4 virtual true final true
...
/// @brief Method .ctor addr 0x232316c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_Count addr 0x2323174 size 0x5c virtual true final true
 int32_t get_Count() ;

/// @brief Method get_IsSynchronized addr 0x23231d0 size 0x8 virtual true final true
 bool get_IsSynchronized() ;

/// @brief Method get_SyncRoot addr 0x23231d8 size 0x4 virtual true final true
 ::bs_hook::Il2CppWrapperType get_SyncRoot() ;

/// @brief Method CopyTo addr 0x23231dc size 0xc4 virtual true final true
 void CopyTo(System::Array array, int32_t index) ;

/// @brief Method GetEnumerator addr 0x23232a0 size 0xb0 virtual true final true
