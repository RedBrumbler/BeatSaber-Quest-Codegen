...
/// @brief Method .ctor addr 0x2323a44 size 0x40 virtual false final false
...
/// @brief Method .ctor addr 0x2323a84 size 0x2c virtual false final false
 void _ctor(System::Security::Permissions::SecurityPermissionFlag flag) ;

/// @brief Method set_Flags addr 0x2323ab0 size 0xb8 virtual false final false
 void set_Flags(System::Security::Permissions::SecurityPermissionFlag value) ;

/// @brief Method IsUnrestricted addr 0x2323b68 size 0x14 virtual true final true
 bool IsUnrestricted() ;

/// @brief Method IsSubsetOf addr 0x2323b7c size 0x58 virtual true final false
 bool IsSubsetOf(System::Security::IPermission target) ;

/// @brief Method ToXml addr 0x2323c88 size 0xec virtual true final false
 System::Security::SecurityElement ToXml() ;

/// @brief Method IsEmpty addr 0x2323c78 size 0x10 virtual false final false
 bool IsEmpty() ;

/// @brief Method Cast addr 0x2323bd4 size 0xa4 virtual false final false
