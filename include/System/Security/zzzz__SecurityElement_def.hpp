...
/// @brief Method .ctor addr 0x2320184 size 0x164 virtual false final false
 void _ctor(::StringW name, ::StringW value) ;

/// @brief Method get_Name addr 0x232118c size 0x8 virtual false final false
 ::StringW get_Name() ;

/// @brief Method get_Value addr 0x2321194 size 0x8 virtual false final false
 ::StringW get_Value() ;
...
/// @brief Method .ctor addr 0x231da58 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x231f944 size 0x150 virtual false final false
 void _ctor(::StringW tag, ::StringW text) ;

/// @brief Method get_Children addr 0x231fc0c size 0x8 virtual false final false
 System::Collections::ArrayList get_Children() ;

/// @brief Method get_Tag addr 0x231fc14 size 0x8 virtual false final false
 ::StringW get_Tag() ;

/// @brief Method set_Text addr 0x231fb10 size 0xfc virtual false final false
 void set_Text(::StringW value) ;

/// @brief Method AddAttribute addr 0x231da60 size 0x1ac virtual false final false
 void AddAttribute(::StringW name, ::StringW value) ;

/// @brief Method AddChild addr 0x231dc0c size 0xd0 virtual false final false
 void AddChild(System::Security::SecurityElement child) ;

/// @brief Method Escape addr 0x23202e8 size 0x1ec virtual false final false
static ::StringW Escape(::StringW str) ;

/// @brief Method Unescape addr 0x231fc98 size 0x1dc virtual false final false
static ::StringW Unescape(::StringW str) ;

/// @brief Method IsValidAttributeName addr 0x23204d4 size 0x7c virtual false final false
static bool IsValidAttributeName(::StringW name) ;

/// @brief Method IsValidAttributeValue addr 0x2320550 size 0x7c virtual false final false
static bool IsValidAttributeValue(::StringW value) ;

/// @brief Method IsValidTag addr 0x231fa94 size 0x7c virtual false final false
static bool IsValidTag(::StringW tag) ;

/// @brief Method IsValidText addr 0x231fc1c size 0x7c virtual false final false
static bool IsValidText(::StringW text) ;

/// @brief Method SearchForChildByTag addr 0x23205cc size 0x128 virtual false final false
 System::Security::SecurityElement SearchForChildByTag(::StringW tag) ;

/// @brief Method ToString addr 0x23206f4 size 0x88 virtual true final false
 ::StringW ToString() ;

/// @brief Method ToXml addr 0x232077c size 0x64c virtual false final false
 void ToXml(ByRef<System::Text::StringBuilder> s, int32_t level) ;

/// @brief Method GetAttribute addr 0x231fe74 size 0x310 virtual false final false
 System::Security::System__Security__SecurityElement__SecurityAttribute GetAttribute(::StringW name) ;

/// @brief Method set_m_strText addr 0x2320dc8 size 0x8 virtual false final false
 void set_m_strText(::StringW value) ;

/// @brief Method SearchForTextOfLocalName addr 0x2320dd0 size 0x23c virtual false final false
