...
class CORDL_TYPE System__Security__Claims__ClaimsIdentity___get_Claims_d__51 : public ::bs_hook::Il2CppWrapperType {
public:
// Declarations
...
virtual ~System__Security__Claims__ClaimsIdentity___get_Claims_d__51() = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Security__Claims__ClaimsIdentity___get_Claims_d__51", modifiers: " const&", def_value: None }]
constexpr System__Security__Claims__ClaimsIdentity___get_Claims_d__51(System__Security__Claims__ClaimsIdentity___get_Claims_d__51 const& ) noexcept = default;

// Ctor Parameters [CppParam { name: "", ty: "System__Security__Claims__ClaimsIdentity___get_Claims_d__51", modifiers: "&&", def_value: None }]
constexpr System__Security__Claims__ClaimsIdentity___get_Claims_d__51(System__Security__Claims__ClaimsIdentity___get_Claims_d__51&& ) noexcept = default;

// Ctor Parameters [CppParam { name: "ptr", ty: "void*", modifiers: "", def_value: None }]
constexpr explicit System__Security__Claims__ClaimsIdentity___get_Claims_d__51(void* ptr) noexcept : ::bs_hook::Il2CppWrapperType(ptr) {
}


  constexpr System__Security__Claims__ClaimsIdentity___get_Claims_d__51& operator=(std::nullptr_t) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = nullptr;
    return *this;
  };

  constexpr System__Security__Claims__ClaimsIdentity___get_Claims_d__51& operator=(void* o) noexcept {
    this->::bs_hook::Il2CppWrapperType::instance = o;
    return *this;
  };

  constexpr System__Security__Claims__ClaimsIdentity___get_Claims_d__51& operator=(System__Security__Claims__ClaimsIdentity___get_Claims_d__51&& o) noexcept = default;
  constexpr System__Security__Claims__ClaimsIdentity___get_Claims_d__51& operator=(System__Security__Claims__ClaimsIdentity___get_Claims_d__51 const& o) noexcept = default;
...
/// @brief Method .ctor addr 0x234b140 size 0x34 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x234c268 size 0x1c virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x234c284 size 0x3f8 virtual true final true
 bool MoveNext() ;

/// @brief Method <>m__Finally1 addr 0x234c67c size 0xb0 virtual false final false
 void __m__Finally1() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Security.Claims.Claim>.get_Current addr 0x234c72c size 0x8 virtual true final true
 System::Security::Claims::Claim System_Collections_Generic_IEnumerator_System_Security_Claims_Claim__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x234c734 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x234c774 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<System.Security.Claims.Claim>.GetEnumerator addr 0x234c77c size 0xa4 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x234c820 size 0x4 virtual true final true
...
public:
// Declarations
using _get_Claims_d__51 = System::Security::Claims::System__Security__Claims__ClaimsIdentity___get_Claims_d__51;
...
/// @brief Method .ctor addr 0x23441bc size 0x1c virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2349b38 size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0x2349b54 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2349b5c size 0x67c virtual false final false
...
/// @brief Method .ctor addr 0x23442fc size 0x1f0 virtual false final false
...
/// @brief Method .ctor addr 0x234a728 size 0x19c virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method get_AuthenticationType addr 0x234b0a0 size 0x8 virtual true final false
 ::StringW get_AuthenticationType() ;

/// @brief Method get_Actor addr 0x234b0a8 size 0x8 virtual false final false
 System::Security::Claims::ClaimsIdentity get_Actor() ;

/// @brief Method set_Actor addr 0x234b0b0 size 0x90 virtual false final false
 void set_Actor(System::Security::Claims::ClaimsIdentity value) ;

/// @brief Method get_Claims addr 0x2344550 size 0x78 virtual true final false
 System::Collections::Generic::IEnumerable_1<System::Security::Claims::Claim> get_Claims() ;

/// @brief Method get_Name addr 0x234b174 size 0x24 virtual true final false
 ::StringW get_Name() ;

/// @brief Method get_NameClaimType addr 0x234b198 size 0x8 virtual false final false
 ::StringW get_NameClaimType() ;

/// @brief Method Clone addr 0x2349088 size 0x150 virtual true final false
 System::Security::Claims::ClaimsIdentity Clone() ;

/// @brief Method AddClaim addr 0x23445f8 size 0x178 virtual true final false
 void AddClaim(System::Security::Claims::Claim claim) ;

/// @brief Method SafeAddClaims addr 0x234a210 size 0x3ec virtual false final false
 void SafeAddClaims(System::Collections::Generic::IEnumerable_1<System::Security::Claims::Claim> claims) ;

/// @brief Method SafeAddClaim addr 0x234a5fc size 0x12c virtual false final false
 void SafeAddClaim(System::Security::Claims::Claim claim) ;

/// @brief Method FindFirst addr 0x234b1a0 size 0x37c virtual true final false
 System::Security::Claims::Claim FindFirst(::StringW type) ;

/// @brief Method OnSerializingMethod addr 0x234b51c size 0x64 virtual false final false
 void OnSerializingMethod(System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method OnDeserializedMethod addr 0x234b7cc size 0xdc virtual false final false
 void OnDeserializedMethod(System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method OnDeserializingMethod addr 0x234bbe0 size 0xdc virtual false final false
 void OnDeserializingMethod(System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method GetObjectData addr 0x234bcbc size 0x5ac virtual true final false
 void GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method DeserializeClaims addr 0x234b8a8 size 0x338 virtual false final false
 void DeserializeClaims(::StringW serializedClaims) ;

/// @brief Method SerializeClaims addr 0x234b580 size 0x24c virtual false final false
 ::StringW SerializeClaims() ;

/// @brief Method IsCircular addr 0x234a1d8 size 0x38 virtual false final false
 bool IsCircular(System::Security::Claims::ClaimsIdentity subject) ;

/// @brief Method Deserialize addr 0x234a8c4 size 0x7dc virtual false final false
...
NEED_NO_BOX(System::Security::Claims::System__Security__Claims__ClaimsIdentity___get_Claims_d__51);
DEFINE_IL2CPP_ARG_TYPE(System::Security::Claims::System__Security__Claims__ClaimsIdentity___get_Claims_d__51, "System.Security.Claims", "ClaimsIdentity/<get_Claims>d__51");
