...
/// @brief Method SelectPrimaryIdentity addr 0x234c824 size 0x380 virtual false final false
...
/// @brief Method get_ClaimsPrincipalSelector addr 0x234cba4 size 0x58 virtual false final false
static System::Func_1<System::Security::Claims::ClaimsPrincipal> get_ClaimsPrincipalSelector() ;

// Ctor Parameters []
explicit ClaimsPrincipal() ;

/// @brief Method .ctor addr 0x23448d8 size 0xa0 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x234cbfc size 0x100 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method OnSerializingMethod addr 0x234ce50 size 0x5c virtual false final false
 void OnSerializingMethod(System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method OnDeserializedMethod addr 0x234d8c0 size 0x60 virtual false final false
 void OnDeserializedMethod(System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method Deserialize addr 0x234ccfc size 0x154 virtual false final false
...
/// @brief Method DeserializeIdentities addr 0x234d920 size 0x6fc virtual false final false
 void DeserializeIdentities(::StringW identities) ;

/// @brief Method SerializeIdentities addr 0x234ceac size 0xa14 virtual false final false
