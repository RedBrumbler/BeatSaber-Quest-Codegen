...
/// @brief Method .ctor addr 0x23445d8 size 0x20 virtual false final false
...
/// @brief Method .ctor addr 0x234932c size 0x258 virtual false final false
...
/// @brief Method .ctor addr 0x23496bc size 0x314 virtual false final false
 void _ctor(System::Security::Claims::Claim other, System::Security::Claims::ClaimsIdentity subject) ;

/// @brief Method OnDeserializedMethod addr 0x23499d0 size 0x60 virtual false final false
 void OnDeserializedMethod(System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method get_Properties addr 0x2349584 size 0x138 virtual false final false
 System::Collections::Generic::IDictionary_2<::StringW,::StringW> get_Properties() ;

/// @brief Method get_Subject addr 0x2349a30 size 0x8 virtual false final false
 System::Security::Claims::ClaimsIdentity get_Subject() ;

/// @brief Method set_Subject addr 0x2349a38 size 0x8 virtual false final false
 void set_Subject(System::Security::Claims::ClaimsIdentity value) ;

/// @brief Method get_Type addr 0x2349a40 size 0x8 virtual false final false
 ::StringW get_Type() ;

/// @brief Method get_Value addr 0x2349a48 size 0x8 virtual false final false
 ::StringW get_Value() ;

/// @brief Method Clone addr 0x2349a50 size 0x70 virtual true final false
 System::Security::Claims::Claim Clone(System::Security::Claims::ClaimsIdentity identity) ;

/// @brief Method ToString addr 0x2349ac0 size 0x78 virtual true final false
 ::StringW ToString() ;
