...
/// @brief Method .ctor addr 0x2810d50 size 0x58 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit AuthenticationException(::StringW message) ;

/// @brief Method .ctor addr 0x2810da8 size 0x8 virtual false final false
 void _ctor(::StringW message) ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "innerException", ty: "System::Exception", modifiers: "", def_value: None }]
explicit AuthenticationException(::StringW message, System::Exception innerException) ;

/// @brief Method .ctor addr 0x2810db0 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2810db8 size 0x8 virtual false final false
