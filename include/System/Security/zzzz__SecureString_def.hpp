...
/// @brief Method .ctor addr 0x231f504 size 0x24 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x231f6a4 size 0x14c virtual false final false
 void _ctor(void* value, int32_t length) ;

/// @brief Method get_Length addr 0x231f7f4 size 0x64 virtual false final false
 int32_t get_Length() ;

/// @brief Method Dispose addr 0x231f858 size 0x38 virtual true final true
 void Dispose() ;

/// @brief Method Encrypt addr 0x231f7f0 size 0x4 virtual false final false
 void Encrypt() ;

/// @brief Method Decrypt addr 0x231f890 size 0x4 virtual false final false
 void Decrypt() ;

/// @brief Method Alloc addr 0x231f528 size 0x17c virtual false final false
 void Alloc(int32_t length, bool realloc) ;

/// @brief Method GetBuffer addr 0x231f894 size 0xb0 virtual false final false
