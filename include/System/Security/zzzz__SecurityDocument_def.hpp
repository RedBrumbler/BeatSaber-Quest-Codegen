...
/// @brief Method .ctor addr 0x231cf30 size 0x68 virtual false final false
 void _ctor(int32_t numData) ;

/// @brief Method GuaranteeSize addr 0x231cf98 size 0xa4 virtual false final false
 void GuaranteeSize(int32_t size) ;

/// @brief Method AddString addr 0x231d03c size 0x14c virtual false final false
 void AddString(::StringW str, ByRef<int32_t> position) ;

/// @brief Method AppendString addr 0x231d188 size 0x98 virtual false final false
 void AppendString(::StringW str, ByRef<int32_t> position) ;

/// @brief Method EncodedStringSize addr 0x231d220 size 0x20 virtual false final false
static int32_t EncodedStringSize(::StringW str) ;

/// @brief Method GetString addr 0x231d240 size 0x310 virtual false final false
 ::StringW GetString(ByRef<int32_t> position, bool bCreate) ;

/// @brief Method AddToken addr 0x231d7bc size 0x5c virtual false final false
 void AddToken(uint8_t b, ByRef<int32_t> position) ;

/// @brief Method GetRootElement addr 0x231d818 size 0x1c virtual false final false
 System::Security::SecurityElement GetRootElement() ;

/// @brief Method GetElement addr 0x231d834 size 0x1c virtual false final false
 System::Security::SecurityElement GetElement(int32_t position, bool bCreate) ;

/// @brief Method InternalGetElement addr 0x231d850 size 0x208 virtual false final false
