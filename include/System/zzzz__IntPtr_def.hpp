...
/// @brief Method .ctor addr 0x24bea40 size 0xc virtual false final false
 void _ctor(int32_t value) ;

/// @brief Method .ctor addr 0x24bea4c size 0x8 virtual false final false
 void _ctor(int64_t value) ;

/// @brief Method .ctor addr 0x24bea54 size 0x8 virtual false final false
 void _ctor(void* value) ;

/// @brief Method .ctor addr 0x24bea5c size 0x60 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method get_Size addr 0x24beabc size 0x8 virtual false final false
static int32_t get_Size() ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x24beac4 size 0xa4 virtual true final true
 void System_Runtime_Serialization_ISerializable_GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method Equals addr 0x24beb70 size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x24bacdc size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToInt32 addr 0x24bebe8 size 0x8 virtual false final false
 int32_t ToInt32() ;

/// @brief Method ToInt64 addr 0x24beb68 size 0x8 virtual false final false
 int64_t ToInt64() ;

/// @brief Method ToPointer addr 0x24bebf0 size 0x8 virtual false final false
 void* ToPointer() ;

/// @brief Method ToString addr 0x24bebf8 size 0x28 virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x24bec20 size 0x24 virtual false final false
 ::StringW ToString(::StringW format) ;

/// @brief Method op_Equality addr 0x24b6b30 size 0xc virtual false final false
static bool op_Equality(::cordl_internals::intptr_t value1, ::cordl_internals::intptr_t value2) ;

/// @brief Method op_Inequality addr 0x24be034 size 0xc virtual false final false
static bool op_Inequality(::cordl_internals::intptr_t value1, ::cordl_internals::intptr_t value2) ;

/// @brief Method op_Explicit addr 0x24bec44 size 0x8 virtual false final false
static ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(int32_t value) ;

/// @brief Method op_Explicit addr 0x24bec4c size 0x4 virtual false final false
static ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(int64_t value) ;

/// @brief Method op_Explicit addr 0x24bec50 size 0x4 virtual false final false
static ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(void* value) ;

/// @brief Method op_Explicit addr 0x24bec54 size 0x4 virtual false final false
static int32_t op_Explicit_int32_t(::cordl_internals::intptr_t value) ;

/// @brief Method op_Explicit addr 0x24bec58 size 0x4 virtual false final false
static int64_t op_Explicit_int64_t(::cordl_internals::intptr_t value) ;

/// @brief Method op_Explicit addr 0x24bec5c size 0x4 virtual false final false
static void* op_Explicit_void*(::cordl_internals::intptr_t value) ;

/// @brief Method Add addr 0x24bec60 size 0x8 virtual false final false
static ::cordl_internals::intptr_t Add(::cordl_internals::intptr_t pointer, int32_t offset) ;

/// @brief Method op_Addition addr 0x24bec68 size 0x8 virtual false final false
static ::cordl_internals::intptr_t op_Addition(::cordl_internals::intptr_t pointer, int32_t offset) ;

/// @brief Method op_Subtraction addr 0x24bec70 size 0x8 virtual false final false
static ::cordl_internals::intptr_t op_Subtraction(::cordl_internals::intptr_t pointer, int32_t offset) ;

/// @brief Method IsNull addr 0x24bec78 size 0x10 virtual false final false
 bool IsNull() ;

/// @brief Method System.IEquatable<System.IntPtr>.Equals addr 0x24bec88 size 0x10 virtual true final true
