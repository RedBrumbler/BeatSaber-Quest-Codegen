...
/// @brief Method .ctor addr 0x245c194 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit FormatException(::StringW message) ;

/// @brief Method .ctor addr 0x245c1f0 size 0x24 virtual false final false
 void _ctor(::StringW message) ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "innerException", ty: "System::Exception", modifiers: "", def_value: None }]
explicit FormatException(::StringW message, System::Exception innerException) ;

/// @brief Method .ctor addr 0x245c214 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x245c238 size 0x8 virtual false final false
