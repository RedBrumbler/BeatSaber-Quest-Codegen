...
/// @brief Method IndexOfAny addr 0x2487460 size 0x80 virtual false final false
static int32_t IndexOfAny(ByRef<uint8_t> searchSpace, int32_t searchSpaceLength, ByRef<uint8_t> value, int32_t valueLength) ;

/// @brief Method IndexOf addr 0x24874e0 size 0x298 virtual false final false
static int32_t IndexOf(ByRef<uint8_t> searchSpace, uint8_t value, int32_t length) ;

/// @brief Method SequenceEqual addr 0x2487778 size 0x1c8 virtual false final false
static bool SequenceEqual(ByRef<uint8_t> first, ByRef<uint8_t> second, uint64_t length) ;

/// @brief Method SequenceCompareTo addr 0x2487940 size 0x4d0 virtual false final false
static int32_t SequenceCompareTo(ByRef<char16_t> first, int32_t firstLength, ByRef<char16_t> second, int32_t secondLength) ;

/// @brief Method IndexOf addr 0x2487e10 size 0x73c virtual false final false
static int32_t IndexOf(ByRef<char16_t> searchSpace, char16_t value, int32_t length) ;

/// @brief Method LastIndexOf addr 0x248854c size 0x6e4 virtual false final false
static int32_t LastIndexOf(ByRef<char16_t> searchSpace, char16_t value, int32_t length) ;

/// @brief Method LocateFirstFoundChar addr 0x2488c30 size 0x1c0 virtual false final false
static int32_t LocateFirstFoundChar(System::Numerics::Vector_1<uint16_t> match) ;

/// @brief Method LocateFirstFoundChar addr 0x2488df0 size 0x20 virtual false final false
static int32_t LocateFirstFoundChar(uint64_t match) ;

/// @brief Method LocateLastFoundChar addr 0x2488e10 size 0x1c0 virtual false final false
static int32_t LocateLastFoundChar(System::Numerics::Vector_1<uint16_t> match) ;

/// @brief Method LocateLastFoundChar addr 0x2488fd0 size 0x2c virtual false final false
...
/// @brief Method EndsWithCultureHelper addr 0x2488ffc size 0x200 virtual false final false
...
/// @brief Method EndsWithCultureIgnoreCaseHelper addr 0x24891fc size 0x120 virtual false final false
...
/// @brief Method EndsWithOrdinalIgnoreCaseHelper addr 0x248931c size 0xe0 virtual false final false
static bool EndsWithOrdinalIgnoreCaseHelper(System::ReadOnlySpan_1<char16_t> span, System::ReadOnlySpan_1<char16_t> value) ;

/// @brief Method ClearWithoutReferences addr 0x24893fc size 0x1e8 virtual false final false
static void ClearWithoutReferences(ByRef<uint8_t> b, uint64_t byteLength) ;

/// @brief Method ClearWithReferences addr 0x24895e4 size 0x150 virtual false final false
