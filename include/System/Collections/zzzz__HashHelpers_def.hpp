...
/// @brief Method IsPrime addr 0x24425f4 size 0xb0 virtual false final false
static bool IsPrime(int32_t candidate) ;

/// @brief Method GetPrime addr 0x24426a4 size 0x190 virtual false final false
static int32_t GetPrime(int32_t min) ;

/// @brief Method ExpandPrime addr 0x2442834 size 0x84 virtual false final false
static int32_t ExpandPrime(int32_t oldSize) ;

/// @brief Method get_SerializationInfoTable addr 0x24428b8 size 0xe0 virtual false final false
