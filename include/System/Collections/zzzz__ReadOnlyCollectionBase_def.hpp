...
/// @brief Method get_InnerList addr 0x2445c38 size 0x68 virtual false final false
 System::Collections::ArrayList get_InnerList() ;

/// @brief Method get_Count addr 0x2445ca0 size 0x24 virtual true final false
 int32_t get_Count() ;

/// @brief Method System.Collections.ICollection.get_IsSynchronized addr 0x2445cc4 size 0x24 virtual true final true
 bool System_Collections_ICollection_get_IsSynchronized() ;

/// @brief Method System.Collections.ICollection.get_SyncRoot addr 0x2445ce8 size 0x24 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_ICollection_get_SyncRoot() ;

/// @brief Method System.Collections.ICollection.CopyTo addr 0x2445d0c size 0x3c virtual true final true
 void System_Collections_ICollection_CopyTo(System::Array array, int32_t index) ;

/// @brief Method GetEnumerator addr 0x2445d48 size 0x24 virtual true final false
 System::Collections::IEnumerator GetEnumerator() ;

// Ctor Parameters []
explicit ReadOnlyCollectionBase() ;

/// @brief Method .ctor addr 0x2445d6c size 0x8 virtual false final false
 void _ctor() ;
