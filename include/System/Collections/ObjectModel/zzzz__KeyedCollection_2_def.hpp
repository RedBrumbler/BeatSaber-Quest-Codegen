...
template<::cordl_internals::il2cpp_reference_type TKey,::cordl_internals::il2cpp_reference_type TItem>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3799), inst: 987 }), TypeDefinitionIndex(TypeDefinitionIndex(3801)), TypeDefinitionIndex(TypeDefinitionIndex(3799))}
