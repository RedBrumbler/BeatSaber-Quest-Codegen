...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8397))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(8397), inst: 2 })
...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8398))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(8398), inst: 2 })
...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8399))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(8399), inst: 2 })
