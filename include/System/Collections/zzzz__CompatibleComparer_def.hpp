...
/// @brief Method .ctor addr 0x2443b64 size 0x2c virtual false final false
 void _ctor(System::Collections::IHashCodeProvider hashCodeProvider, System::Collections::IComparer comparer) ;

/// @brief Method get_HashCodeProvider addr 0x2443b90 size 0x8 virtual false final false
 System::Collections::IHashCodeProvider get_HashCodeProvider() ;

/// @brief Method get_Comparer addr 0x2443b98 size 0x8 virtual false final false
 System::Collections::IComparer get_Comparer() ;

/// @brief Method Equals addr 0x2443ba0 size 0x18 virtual true final true
 bool Equals(::bs_hook::Il2CppWrapperType a, ::bs_hook::Il2CppWrapperType b) ;

/// @brief Method Compare addr 0x2443bb8 size 0x1c4 virtual false final false
 int32_t Compare(::bs_hook::Il2CppWrapperType a, ::bs_hook::Il2CppWrapperType b) ;

/// @brief Method GetHashCode addr 0x2443d7c size 0x10c virtual true final true
