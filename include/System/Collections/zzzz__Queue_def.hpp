...
/// @brief Method .ctor addr 0x2445858 size 0x50 virtual false final false
 void _ctor(System::Collections::Queue q) ;

/// @brief Method Clone addr 0x2445a48 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method MoveNext addr 0x2445a50 size 0xc8 virtual true final false
 bool MoveNext() ;

/// @brief Method get_Current addr 0x2445b18 size 0x94 virtual true final false
 ::bs_hook::Il2CppWrapperType get_Current() ;

/// @brief Method Reset addr 0x2445bac size 0x8c virtual true final false
 void Reset() ;
...
/// @brief Method .ctor addr 0x2444e6c size 0xc virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "capacity", ty: "int32_t", modifiers: "", def_value: None }]
explicit Queue(int32_t capacity) ;

/// @brief Method .ctor addr 0x2445038 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2444e78 size 0x1c0 virtual false final false
...
/// @brief Method .ctor addr 0x2445040 size 0x26c virtual false final false
 void _ctor(System::Collections::ICollection col) ;

/// @brief Method get_Count addr 0x24452ac size 0x8 virtual true final false
 int32_t get_Count() ;

/// @brief Method Clone addr 0x24452b4 size 0xe4 virtual true final false
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method get_IsSynchronized addr 0x2445398 size 0x8 virtual true final false
 bool get_IsSynchronized() ;

/// @brief Method get_SyncRoot addr 0x24453a0 size 0x7c virtual true final false
 ::bs_hook::Il2CppWrapperType get_SyncRoot() ;

/// @brief Method CopyTo addr 0x244541c size 0x1f4 virtual true final false
 void CopyTo(System::Array array, int32_t index) ;

/// @brief Method Enqueue addr 0x2445610 size 0xfc virtual true final false
 void Enqueue(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetEnumerator addr 0x24457f8 size 0x60 virtual true final false
 System::Collections::IEnumerator GetEnumerator() ;

/// @brief Method Dequeue addr 0x24458a8 size 0xcc virtual true final false
 ::bs_hook::Il2CppWrapperType Dequeue() ;

/// @brief Method Peek addr 0x2445974 size 0x94 virtual true final false
 ::bs_hook::Il2CppWrapperType Peek() ;

/// @brief Method GetElement addr 0x2445a08 size 0x40 virtual false final false
 ::bs_hook::Il2CppWrapperType GetElement(int32_t i) ;

/// @brief Method SetCapacity addr 0x244570c size 0xec virtual false final false
