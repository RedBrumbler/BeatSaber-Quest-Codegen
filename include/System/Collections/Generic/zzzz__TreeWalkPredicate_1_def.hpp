...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2610)), TypeDefinitionIndex(TypeDefinitionIndex(8413))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(8413), inst: 2 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2610)), TypeDefinitionIndex(TypeDefinitionIndex(8413))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(8413), inst: 730 })
// CS Name: System.Collections.Generic.TreeWalkPredicate`1
