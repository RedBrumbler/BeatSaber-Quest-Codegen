...
namespace System::Collections::Generic {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3854), inst: 718 }), TypeDefinitionIndex(TypeDefinitionIndex(3854))}
...
/// @brief Method Equals addr 0x2451e24 size 0x10 virtual true final false
 bool Equals(uint8_t x, uint8_t y) ;

/// @brief Method GetHashCode addr 0x2451e34 size 0x1c virtual true final false
 int32_t GetHashCode(uint8_t b) ;

/// @brief Method IndexOf addr 0x2451e50 size 0x194 virtual true final false
 int32_t IndexOf(::ArrayW<uint8_t> array, uint8_t value, int32_t startIndex, int32_t count) ;

/// @brief Method LastIndexOf addr 0x2451fe4 size 0x58 virtual true final false
 int32_t LastIndexOf(::ArrayW<uint8_t> array, uint8_t value, int32_t startIndex, int32_t count) ;

/// @brief Method Equals addr 0x245203c size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x24520b4 size 0x34 virtual true final false
 int32_t GetHashCode() ;

// Ctor Parameters []
explicit ByteEqualityComparer() ;

/// @brief Method .ctor addr 0x24520e8 size 0x48 virtual false final false
 void _ctor() ;
