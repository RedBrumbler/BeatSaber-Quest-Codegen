...
/// @brief Method FloorLog2PlusOne addr 0x2451d88 size 0x34 virtual false final false
static int32_t FloorLog2PlusOne(int32_t n) ;

/// @brief Method ThrowOrIgnoreBadComparer addr 0x2451dbc size 0x68 virtual false final false
