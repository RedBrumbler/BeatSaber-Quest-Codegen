...
/// @brief Method GetHashCode addr 0x2452130 size 0x20 virtual true final false
 int32_t GetHashCode(::StringW obj) ;

/// @brief Method Equals addr 0x2452150 size 0x30 virtual true final false
 bool Equals(::StringW x, ::StringW y) ;

/// @brief Method IndexOf addr 0x2452180 size 0x6c virtual true final false
 int32_t IndexOf(::ArrayW<::StringW> array, ::StringW value, int32_t startIndex, int32_t count) ;

// Ctor Parameters []
explicit InternalStringComparer() ;

/// @brief Method .ctor addr 0x24521ec size 0x48 virtual false final false
 void _ctor() ;
