...
template<typename T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3850)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3850), inst: 1000 }), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2447), inst: 2583 }), TypeDefinitionIndex(TypeDefinitionIndex(2447))}
