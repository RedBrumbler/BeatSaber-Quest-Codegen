...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3846)), TypeDefinitionIndex(TypeDefinitionIndex(3844)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3844), inst: 2552 })}
