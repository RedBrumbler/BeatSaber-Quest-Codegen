...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3859)), TypeDefinitionIndex(TypeDefinitionIndex(3854)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3854), inst: 1619 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3859), inst: 4831 })
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3854)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3854), inst: 1619 }), TypeDefinitionIndex(TypeDefinitionIndex(3859))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3859), inst: 6274 })
// CS Name: System.Collections.Generic.EnumEqualityComparer`1
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3854)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3854), inst: 1619 }), TypeDefinitionIndex(TypeDefinitionIndex(3859))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3859), inst: 7054 })
// CS Name: System.Collections.Generic.EnumEqualityComparer`1
