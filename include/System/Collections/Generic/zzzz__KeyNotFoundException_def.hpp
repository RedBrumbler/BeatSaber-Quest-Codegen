...
/// @brief Method .ctor addr 0x2451c40 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit KeyNotFoundException(::StringW message) ;

/// @brief Method .ctor addr 0x2451c9c size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x2451cc0 size 0x8 virtual false final false
