...
/// @brief Method .ctor addr 0x27df354 size 0x38 virtual false final false
...
/// @brief Method .ctor addr 0x27df38c size 0x30 virtual false final false
 void _ctor(::ArrayW<int32_t> bitArray, int32_t length) ;

/// @brief Method MarkBit addr 0x27df3bc size 0x7c virtual false final false
 void MarkBit(int32_t bitPosition) ;

/// @brief Method IsMarked addr 0x27df438 size 0x84 virtual false final false
 bool IsMarked(int32_t bitPosition) ;

/// @brief Method ToIntArrayLength addr 0x27df4bc size 0x28 virtual false final false
