...
/// @brief Method get_Item addr 0x27dce8c size 0x7c virtual false final false
 ::StringW get_Item(int32_t index) ;

/// @brief Method set_Item addr 0x27dcf08 size 0x24 virtual false final false
 void set_Item(int32_t index, ::StringW value) ;

/// @brief Method get_Count addr 0x27dcf2c size 0x24 virtual true final true
 int32_t get_Count() ;

/// @brief Method System.Collections.IList.get_IsReadOnly addr 0x27dcf50 size 0x8 virtual true final true
 bool System_Collections_IList_get_IsReadOnly() ;

/// @brief Method System.Collections.IList.get_IsFixedSize addr 0x27dcf58 size 0x8 virtual true final true
 bool System_Collections_IList_get_IsFixedSize() ;

/// @brief Method Add addr 0x27dcf60 size 0x24 virtual false final false
 int32_t Add(::StringW value) ;

/// @brief Method Clear addr 0x27dcf84 size 0x24 virtual true final true
 void Clear() ;

/// @brief Method Contains addr 0x27dcfa8 size 0x24 virtual false final false
 bool Contains(::StringW value) ;

/// @brief Method CopyTo addr 0x27dcfcc size 0x24 virtual false final false
 void CopyTo(::ArrayW<::StringW> array, int32_t index) ;

/// @brief Method IndexOf addr 0x27dcff0 size 0x24 virtual false final false
 int32_t IndexOf(::StringW value) ;

/// @brief Method Insert addr 0x27dd014 size 0x24 virtual false final false
 void Insert(int32_t index, ::StringW value) ;

/// @brief Method get_IsSynchronized addr 0x27dd038 size 0x8 virtual true final true
 bool get_IsSynchronized() ;

/// @brief Method Remove addr 0x27dd040 size 0x24 virtual false final false
 void Remove(::StringW value) ;

/// @brief Method RemoveAt addr 0x27dd064 size 0x24 virtual true final true
 void RemoveAt(int32_t index) ;

/// @brief Method get_SyncRoot addr 0x27dd088 size 0x24 virtual true final true
 ::bs_hook::Il2CppWrapperType get_SyncRoot() ;

/// @brief Method System.Collections.IList.get_Item addr 0x27dd0ac size 0x4 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IList_get_Item(int32_t index) ;

/// @brief Method System.Collections.IList.set_Item addr 0x27dd0b0 size 0x8c virtual true final true
 void System_Collections_IList_set_Item(int32_t index, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.IList.Add addr 0x27dd13c size 0x7c virtual true final true
 int32_t System_Collections_IList_Add(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.IList.Contains addr 0x27dd1b8 size 0x7c virtual true final true
 bool System_Collections_IList_Contains(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.IList.IndexOf addr 0x27dd234 size 0x7c virtual true final true
 int32_t System_Collections_IList_IndexOf(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.IList.Insert addr 0x27dd2b0 size 0x8c virtual true final true
 void System_Collections_IList_Insert(int32_t index, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.IList.Remove addr 0x27dd33c size 0x7c virtual true final true
 void System_Collections_IList_Remove(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.ICollection.CopyTo addr 0x27dd3b8 size 0x24 virtual true final true
 void System_Collections_ICollection_CopyTo(System::Array array, int32_t index) ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x27dd3dc size 0x24 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

// Ctor Parameters []
explicit StringCollection() ;

/// @brief Method .ctor addr 0x27dd400 size 0x68 virtual false final false
 void _ctor() ;
