...
/// @brief Method .ctor addr 0x27dbd18 size 0x4c virtual false final false
 void _ctor(System::Collections::ArrayList array, int32_t objectReturnType) ;

/// @brief Method get_Current addr 0x27dc378 size 0x1ac virtual true final true
 ::bs_hook::Il2CppWrapperType get_Current() ;

/// @brief Method get_Entry addr 0x27dc524 size 0x194 virtual true final true
 System::Collections::DictionaryEntry get_Entry() ;

/// @brief Method get_Key addr 0x27dc6b8 size 0xe4 virtual true final true
 ::bs_hook::Il2CppWrapperType get_Key() ;

/// @brief Method get_Value addr 0x27dc79c size 0xe4 virtual true final true
 ::bs_hook::Il2CppWrapperType get_Value() ;

/// @brief Method MoveNext addr 0x27dc880 size 0xa0 virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x27dc920 size 0xa4 virtual true final true
 void Reset() ;
...
/// @brief Method .ctor addr 0x27db4a0 size 0x30 virtual false final false
 void _ctor(System::Collections::ArrayList array, bool isKeys) ;

/// @brief Method System.Collections.ICollection.CopyTo addr 0x27dc9c4 size 0x3fc virtual true final true
 void System_Collections_ICollection_CopyTo(System::Array array, int32_t index) ;

/// @brief Method System.Collections.ICollection.get_Count addr 0x27dcdc0 size 0x24 virtual true final true
 int32_t System_Collections_ICollection_get_Count() ;

/// @brief Method System.Collections.ICollection.get_IsSynchronized addr 0x27dcde4 size 0x8 virtual true final true
 bool System_Collections_ICollection_get_IsSynchronized() ;

/// @brief Method System.Collections.ICollection.get_SyncRoot addr 0x27dcdec size 0x24 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_ICollection_get_SyncRoot() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x27dce10 size 0x7c virtual true final true
...
/// @brief Method .ctor addr 0x27db2d0 size 0x20 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "capacity", ty: "int32_t", modifiers: "", def_value: None }]
explicit OrderedDictionary(int32_t capacity) ;

/// @brief Method .ctor addr 0x27db2f0 size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x27db31c size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x27db34c size 0x28 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method get_Count addr 0x27db374 size 0x24 virtual true final true
 int32_t get_Count() ;

/// @brief Method System.Collections.IDictionary.get_IsFixedSize addr 0x27db40c size 0x8 virtual true final true
 bool System_Collections_IDictionary_get_IsFixedSize() ;

/// @brief Method get_IsReadOnly addr 0x27db414 size 0x8 virtual true final true
 bool get_IsReadOnly() ;

/// @brief Method System.Collections.ICollection.get_IsSynchronized addr 0x27db41c size 0x8 virtual true final true
 bool System_Collections_ICollection_get_IsSynchronized() ;

/// @brief Method get_Keys addr 0x27db424 size 0x7c virtual true final true
 System::Collections::ICollection get_Keys() ;

/// @brief Method get_objectsArray addr 0x27db398 size 0x74 virtual false final false
 System::Collections::ArrayList get_objectsArray() ;

/// @brief Method get_objectsTable addr 0x27db4d0 size 0x84 virtual false final false
 System::Collections::Hashtable get_objectsTable() ;

/// @brief Method System.Collections.ICollection.get_SyncRoot addr 0x27db554 size 0x7c virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_ICollection_get_SyncRoot() ;

/// @brief Method get_Item addr 0x27db5d0 size 0x2c virtual true final true
 ::bs_hook::Il2CppWrapperType get_Item(::bs_hook::Il2CppWrapperType key) ;

/// @brief Method set_Item addr 0x27db5fc size 0x180 virtual true final true
 void set_Item(::bs_hook::Il2CppWrapperType key, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_Values addr 0x27dba24 size 0x78 virtual true final true
 System::Collections::ICollection get_Values() ;

/// @brief Method Add addr 0x27db8fc size 0x128 virtual true final true
 void Add(::bs_hook::Il2CppWrapperType key, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method Clear addr 0x27dba9c size 0x98 virtual true final true
 void Clear() ;

/// @brief Method Contains addr 0x27dbb34 size 0x2c virtual true final true
 bool Contains(::bs_hook::Il2CppWrapperType key) ;

/// @brief Method CopyTo addr 0x27dbb60 size 0x3c virtual true final true
 void CopyTo(System::Array array, int32_t index) ;

/// @brief Method IndexOfKey addr 0x27db77c size 0x180 virtual false final false
 int32_t IndexOfKey(::bs_hook::Il2CppWrapperType key) ;

/// @brief Method Remove addr 0x27dbb9c size 0x108 virtual true final true
 void Remove(::bs_hook::Il2CppWrapperType key) ;

/// @brief Method GetEnumerator addr 0x27dbca4 size 0x74 virtual true final false
 System::Collections::IDictionaryEnumerator GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x27dbd64 size 0x74 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method GetObjectData addr 0x27dbdd8 size 0x1d8 virtual true final false
 void GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method System.Runtime.Serialization.IDeserializationCallback.OnDeserialization addr 0x27dbfb0 size 0x10 virtual true final true
 void System_Runtime_Serialization_IDeserializationCallback_OnDeserialization(::bs_hook::Il2CppWrapperType sender) ;

/// @brief Method OnDeserialization addr 0x27dbfc0 size 0x3b8 virtual true final false
