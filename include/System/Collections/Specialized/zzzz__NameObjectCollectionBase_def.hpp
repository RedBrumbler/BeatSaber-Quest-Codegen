...
/// @brief Method .ctor addr 0x27de80c size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x27de898 size 0x40 virtual false final false
 void _ctor(System::Collections::Specialized::NameObjectCollectionBase coll) ;

/// @brief Method MoveNext addr 0x27ded44 size 0xe0 virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x27dee24 size 0x90 virtual true final true
 void Reset() ;

/// @brief Method get_Current addr 0x27deeb4 size 0xa8 virtual true final true
...
/// @brief Method .ctor addr 0x27da36c size 0x60 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x27dd604 size 0x80 virtual false final false
...
/// @brief Method .ctor addr 0x27da554 size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x27da430 size 0xb0 virtual false final false
...
/// @brief Method .ctor addr 0x27db2c8 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x27da5ec size 0x28 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method GetObjectData addr 0x27dd800 size 0x580 virtual true final false
 void GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method OnDeserialization addr 0x27ddf3c size 0x768 virtual true final false
 void OnDeserialization(::bs_hook::Il2CppWrapperType sender) ;

/// @brief Method Reset addr 0x27dd684 size 0xb8 virtual false final false
 void Reset() ;

/// @brief Method Reset addr 0x27dd73c size 0xc4 virtual false final false
 void Reset(int32_t capacity) ;

/// @brief Method FindEntry addr 0x27de74c size 0xb8 virtual false final false
...
/// @brief Method get_IsReadOnly addr 0x27de804 size 0x8 virtual false final false
 bool get_IsReadOnly() ;

/// @brief Method BaseAdd addr 0x27da9e0 size 0x164 virtual false final false
 void BaseAdd(::StringW name, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method BaseRemove addr 0x27dae00 size 0x20c virtual false final false
 void BaseRemove(::StringW name) ;

/// @brief Method BaseGet addr 0x27da9c8 size 0x18 virtual false final false
 ::bs_hook::Il2CppWrapperType BaseGet(::StringW name) ;

/// @brief Method BaseSet addr 0x27dad48 size 0xb0 virtual false final false
 void BaseSet(::StringW name, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method BaseGet addr 0x27db0b0 size 0x9c virtual false final false
 ::bs_hook::Il2CppWrapperType BaseGet(int32_t index) ;

/// @brief Method BaseGetKey addr 0x27db1d4 size 0x9c virtual false final false
 ::StringW BaseGetKey(int32_t index) ;

/// @brief Method GetEnumerator addr 0x27de838 size 0x60 virtual true final false
 System::Collections::IEnumerator GetEnumerator() ;

/// @brief Method get_Count addr 0x27de8d8 size 0x24 virtual true final false
 int32_t get_Count() ;

/// @brief Method System.Collections.ICollection.CopyTo addr 0x27de8fc size 0x31c virtual true final true
 void System_Collections_ICollection_CopyTo(System::Array array, int32_t index) ;

/// @brief Method System.Collections.ICollection.get_SyncRoot addr 0x27dec18 size 0x7c virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_ICollection_get_SyncRoot() ;

/// @brief Method System.Collections.ICollection.get_IsSynchronized addr 0x27dec94 size 0x8 virtual true final true
