...
/// @brief Method .ctor addr 0x27dd468 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method Add addr 0x27dd4d0 size 0x98 virtual true final false
 void Add(::StringW key, ::StringW value) ;

/// @brief Method GetEnumerator addr 0x27dd568 size 0x24 virtual true final false
