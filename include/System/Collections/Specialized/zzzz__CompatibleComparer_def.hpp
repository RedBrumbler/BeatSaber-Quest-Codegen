...
/// @brief Method .ctor addr 0x27de720 size 0x2c virtual false final false
 void _ctor(System::Collections::IComparer comparer, System::Collections::IHashCodeProvider hashCodeProvider) ;

/// @brief Method Equals addr 0x27def5c size 0x200 virtual true final true
 bool Equals(::bs_hook::Il2CppWrapperType a, ::bs_hook::Il2CppWrapperType b) ;

/// @brief Method GetHashCode addr 0x27df15c size 0x10c virtual true final true
 int32_t GetHashCode(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method get_Comparer addr 0x27df268 size 0x8 virtual false final false
 System::Collections::IComparer get_Comparer() ;

/// @brief Method get_HashCodeProvider addr 0x27df270 size 0x8 virtual false final false
 System::Collections::IHashCodeProvider get_HashCodeProvider() ;

/// @brief Method get_DefaultComparer addr 0x27dde60 size 0xdc virtual false final false
static System::Collections::IComparer get_DefaultComparer() ;

/// @brief Method get_DefaultHashCodeProvider addr 0x27ddd80 size 0xe0 virtual false final false
