...
namespace System::Collections::Specialized {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8388))}
...
/// @brief Method .ctor addr 0x27dd58c size 0x4 virtual false final false
 void _ctor() ;

/// @brief Method Add addr 0x27dd590 size 0x74 virtual true final false
