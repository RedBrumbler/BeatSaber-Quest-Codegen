...
/// @brief Method get_Item addr 0x27d8d00 size 0x18 virtual false final false
 bool get_Item(int32_t bit) ;

/// @brief Method set_Item addr 0x27d8d18 size 0x1c virtual false final false
 void set_Item(int32_t bit, bool value) ;

/// @brief Method CreateMask addr 0x27d8d34 size 0x8 virtual false final false
static int32_t CreateMask() ;

/// @brief Method CreateMask addr 0x27d8d3c size 0x70 virtual false final false
static int32_t CreateMask(int32_t previous) ;

/// @brief Method Equals addr 0x27d8dac size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method GetHashCode addr 0x27d8e24 size 0x64 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x27d8e88 size 0xd0 virtual false final false
static ::StringW ToString(System::Collections::Specialized::BitVector32 value) ;

/// @brief Method ToString addr 0x27d8f58 size 0x8 virtual true final false
 ::StringW ToString() ;
