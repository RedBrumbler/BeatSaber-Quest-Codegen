...
/// @brief Method .ctor addr 0x24495f8 size 0x40 virtual false final false
 void _ctor(System::Collections::Stack stack) ;

/// @brief Method Clone addr 0x244985c size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method MoveNext addr 0x2449864 size 0xe4 virtual true final false
 bool MoveNext() ;

/// @brief Method get_Current addr 0x2449948 size 0x94 virtual true final false
 ::bs_hook::Il2CppWrapperType get_Current() ;

/// @brief Method Reset addr 0x24499dc size 0x80 virtual true final false
 void Reset() ;
...
/// @brief Method .ctor addr 0x2449070 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "initialCapacity", ty: "int32_t", modifiers: "", def_value: None }]
explicit Stack(int32_t initialCapacity) ;

/// @brief Method .ctor addr 0x24490cc size 0xcc virtual false final false
 void _ctor(int32_t initialCapacity) ;

/// @brief Method get_Count addr 0x2449198 size 0x8 virtual true final false
 int32_t get_Count() ;

/// @brief Method get_IsSynchronized addr 0x24491a0 size 0x8 virtual true final false
 bool get_IsSynchronized() ;

/// @brief Method get_SyncRoot addr 0x24491a8 size 0x78 virtual true final false
 ::bs_hook::Il2CppWrapperType get_SyncRoot() ;

/// @brief Method Clear addr 0x2449220 size 0x30 virtual true final false
 void Clear() ;

/// @brief Method Clone addr 0x2449250 size 0x90 virtual true final false
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method CopyTo addr 0x24492e0 size 0x2b8 virtual true final false
 void CopyTo(System::Array array, int32_t index) ;

/// @brief Method GetEnumerator addr 0x2449598 size 0x60 virtual true final false
 System::Collections::IEnumerator GetEnumerator() ;

/// @brief Method Peek addr 0x2449638 size 0x88 virtual true final false
 ::bs_hook::Il2CppWrapperType Peek() ;

/// @brief Method Pop addr 0x24496c0 size 0x98 virtual true final false
 ::bs_hook::Il2CppWrapperType Pop() ;

/// @brief Method Push addr 0x2449758 size 0x104 virtual true final false
