...
/// @brief Method .ctor addr 0x2444254 size 0x68 virtual false final false
 void _ctor() ;

/// @brief Method get_InnerList addr 0x244434c size 0x8 virtual false final false
 System::Collections::ArrayList get_InnerList() ;

/// @brief Method get_List addr 0x2444354 size 0x4 virtual false final false
 System::Collections::IList get_List() ;

/// @brief Method get_Count addr 0x2444358 size 0x24 virtual true final true
 int32_t get_Count() ;

/// @brief Method Clear addr 0x244437c size 0x4c virtual true final true
 void Clear() ;

/// @brief Method RemoveAt addr 0x24443c8 size 0x1d8 virtual true final true
 void RemoveAt(int32_t index) ;

/// @brief Method System.Collections.IList.get_IsReadOnly addr 0x24445a0 size 0x24 virtual true final true
 bool System_Collections_IList_get_IsReadOnly() ;

/// @brief Method System.Collections.IList.get_IsFixedSize addr 0x24445c4 size 0x24 virtual true final true
 bool System_Collections_IList_get_IsFixedSize() ;

/// @brief Method System.Collections.ICollection.get_IsSynchronized addr 0x24445e8 size 0x24 virtual true final true
 bool System_Collections_ICollection_get_IsSynchronized() ;

/// @brief Method System.Collections.ICollection.get_SyncRoot addr 0x244460c size 0x24 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_ICollection_get_SyncRoot() ;

/// @brief Method System.Collections.ICollection.CopyTo addr 0x2444630 size 0x24 virtual true final true
 void System_Collections_ICollection_CopyTo(System::Array array, int32_t index) ;

/// @brief Method System.Collections.IList.get_Item addr 0x2444654 size 0xbc virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IList_get_Item(int32_t index) ;

/// @brief Method System.Collections.IList.set_Item addr 0x2444710 size 0x1e8 virtual true final true
 void System_Collections_IList_set_Item(int32_t index, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.IList.Contains addr 0x24448f8 size 0x24 virtual true final true
 bool System_Collections_IList_Contains(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.IList.Add addr 0x244491c size 0x140 virtual true final true
 int32_t System_Collections_IList_Add(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.IList.Remove addr 0x2444a5c size 0x19c virtual true final true
 void System_Collections_IList_Remove(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.IList.IndexOf addr 0x2444bf8 size 0x24 virtual true final true
 int32_t System_Collections_IList_IndexOf(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method System.Collections.IList.Insert addr 0x2444c1c size 0x1b4 virtual true final true
 void System_Collections_IList_Insert(int32_t index, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetEnumerator addr 0x2444dd0 size 0x24 virtual true final true
 System::Collections::IEnumerator GetEnumerator() ;

/// @brief Method OnSet addr 0x2444df4 size 0x4 virtual true final false
 void OnSet(int32_t index, ::bs_hook::Il2CppWrapperType oldValue, ::bs_hook::Il2CppWrapperType newValue) ;

/// @brief Method OnInsert addr 0x2444df8 size 0x4 virtual true final false
 void OnInsert(int32_t index, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method OnClear addr 0x2444dfc size 0x4 virtual true final false
 void OnClear() ;

/// @brief Method OnRemove addr 0x2444e00 size 0x4 virtual true final false
 void OnRemove(int32_t index, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method OnValidate addr 0x2444e04 size 0x58 virtual true final false
 void OnValidate(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method OnSetComplete addr 0x2444e5c size 0x4 virtual true final false
 void OnSetComplete(int32_t index, ::bs_hook::Il2CppWrapperType oldValue, ::bs_hook::Il2CppWrapperType newValue) ;

/// @brief Method OnInsertComplete addr 0x2444e60 size 0x4 virtual true final false
 void OnInsertComplete(int32_t index, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method OnClearComplete addr 0x2444e64 size 0x4 virtual true final false
 void OnClearComplete() ;

/// @brief Method OnRemoveComplete addr 0x2444e68 size 0x4 virtual true final false
