...
/// @brief Method .ctor addr 0x23a55f4 size 0x128 virtual false final false
 void _ctor(System::Exception exception) ;

/// @brief Method get_BinaryStackTraceArray addr 0x23a571c size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_BinaryStackTraceArray() ;

/// @brief Method Capture addr 0x23a51b0 size 0xcc virtual false final false
static System::Runtime::ExceptionServices::ExceptionDispatchInfo Capture(System::Exception source) ;

/// @brief Method get_SourceException addr 0x23a5724 size 0x8 virtual false final false
 System::Exception get_SourceException() ;

/// @brief Method Throw addr 0x23a527c size 0x44 virtual false final false
 void Throw() ;

/// @brief Method Throw addr 0x23a572c size 0x18 virtual false final false
