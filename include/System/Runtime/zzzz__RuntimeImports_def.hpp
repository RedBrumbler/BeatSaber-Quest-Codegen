...
/// @brief Method RhZeroMemory addr 0x2352824 size 0x4 virtual false final false
static void RhZeroMemory(ByRef<uint8_t> b, uint64_t byteLength) ;

/// @brief Method ZeroMemory addr 0x2352828 size 0x4 virtual false final false
static void ZeroMemory(void* p, uint32_t byteLength) ;

/// @brief Method Memmove addr 0x235282c size 0x4 virtual false final false
static void Memmove(void* dest, void* src, uint32_t len) ;

/// @brief Method Memmove_wbarrier addr 0x2352830 size 0x4 virtual false final false
