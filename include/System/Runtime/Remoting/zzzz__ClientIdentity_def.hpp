...
/// @brief Method .ctor addr 0x2352dfc size 0x108 virtual false final false
 void _ctor(::StringW objectUri, System::Runtime::Remoting::ObjRef objRef) ;

/// @brief Method get_ClientProxy addr 0x2352f04 size 0x88 virtual false final false
 System::MarshalByRefObject get_ClientProxy() ;

/// @brief Method set_ClientProxy addr 0x2352f8c size 0x70 virtual false final false
 void set_ClientProxy(System::MarshalByRefObject value) ;

/// @brief Method CreateObjRef addr 0x2352ffc size 0x8 virtual true final false
 System::Runtime::Remoting::ObjRef CreateObjRef(System::Type requestedType) ;

/// @brief Method get_TargetUri addr 0x2353004 size 0x20 virtual false final false
