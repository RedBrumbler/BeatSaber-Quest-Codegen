...
/// @brief Method .ctor addr 0x236fdfc size 0x28 virtual false final false
 void _ctor(int32_t domainID) ;

/// @brief Method GetSink addr 0x236fae4 size 0x2a0 virtual false final false
static System::Runtime::Remoting::Channels::CrossAppDomainSink GetSink(int32_t domainID) ;

/// @brief Method get_TargetDomainId addr 0x236fe24 size 0x8 virtual false final false
 int32_t get_TargetDomainId() ;

/// @brief Method ProcessMessageInDomain addr 0x236fe2c size 0x138 virtual false final false
...
/// @brief Method SyncProcessMessage addr 0x23700a4 size 0x434 virtual true final false
 System::Runtime::Remoting::Messaging::IMessage SyncProcessMessage(System::Runtime::Remoting::Messaging::IMessage msgRequest) ;

/// @brief Method AsyncProcessMessage addr 0x23707ec size 0xcc virtual true final false
...
/// @brief Method SendAsyncMessage addr 0x23708e4 size 0x10c virtual false final false
 void SendAsyncMessage(::bs_hook::Il2CppWrapperType data) ;

/// @brief Method <AsyncProcessMessage>b__10_0 addr 0x2370aec size 0x80 virtual false final false
