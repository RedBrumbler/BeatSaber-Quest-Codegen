...
/// @brief Method RegisterCrossAppDomainChannel addr 0x236f760 size 0x144 virtual false final false
static void RegisterCrossAppDomainChannel() ;

/// @brief Method get_ChannelName addr 0x236f8ac size 0x40 virtual true final false
 ::StringW get_ChannelName() ;

/// @brief Method get_ChannelPriority addr 0x236f8ec size 0x8 virtual true final false
 int32_t get_ChannelPriority() ;

/// @brief Method get_ChannelData addr 0x236f8f4 size 0x6c virtual true final false
 ::bs_hook::Il2CppWrapperType get_ChannelData() ;

/// @brief Method StartListening addr 0x236f960 size 0x4 virtual true final false
 void StartListening(::bs_hook::Il2CppWrapperType data) ;

/// @brief Method CreateMessageSink addr 0x236f964 size 0x180 virtual true final false
...
/// @brief Method .ctor addr 0x236f8a4 size 0x8 virtual false final false
 void _ctor() ;
