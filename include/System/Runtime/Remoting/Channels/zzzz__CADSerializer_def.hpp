...
/// @brief Method DeserializeMessage addr 0x2370568 size 0x40 virtual false final false
...
/// @brief Method SerializeMessage addr 0x236ffb4 size 0xf0 virtual false final false
static System::IO::MemoryStream SerializeMessage(System::Runtime::Remoting::Messaging::IMessage msg) ;

/// @brief Method DeserializeObjectSafe addr 0x2370b74 size 0xa0 virtual false final false
static ::bs_hook::Il2CppWrapperType DeserializeObjectSafe(::ArrayW<uint8_t> mem) ;

/// @brief Method SerializeObject addr 0x2370c9c size 0xf0 virtual false final false
static System::IO::MemoryStream SerializeObject(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method DeserializeObject addr 0x2370c14 size 0x88 virtual false final false
