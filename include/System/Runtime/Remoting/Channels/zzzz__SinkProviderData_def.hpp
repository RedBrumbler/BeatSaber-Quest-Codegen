...
/// @brief Method .ctor addr 0x2370d8c size 0xac virtual false final false
 void _ctor(::StringW name) ;

/// @brief Method get_Children addr 0x2370e38 size 0x8 virtual false final false
 System::Collections::IList get_Children() ;

/// @brief Method get_Properties addr 0x2370e40 size 0x8 virtual false final false
