...
/// @brief Method get_CrossContextChannel addr 0x236c708 size 0x58 virtual false final false
static System::Runtime::Remoting::Contexts::CrossContextChannel get_CrossContextChannel() ;

/// @brief Method CreateClientChannelSinkChain addr 0x236c760 size 0x87c virtual false final false
...
/// @brief Method CreateClientChannelSinkChain addr 0x236cfdc size 0x208 virtual false final false
...
/// @brief Method RegisterChannel addr 0x236d1e4 size 0x58 virtual false final false
static void RegisterChannel(System::Runtime::Remoting::Channels::IChannel chnl) ;

/// @brief Method RegisterChannel addr 0x236d23c size 0x87c virtual false final false
static void RegisterChannel(System::Runtime::Remoting::Channels::IChannel chnl, bool ensureSecurity) ;

/// @brief Method RegisterChannelConfig addr 0x236dab8 size 0xbe8 virtual false final false
static void RegisterChannelConfig(System::Runtime::Remoting::ChannelData channel) ;

/// @brief Method CreateProvider addr 0x236e6a0 size 0x318 virtual false final false
static ::bs_hook::Il2CppWrapperType CreateProvider(System::Runtime::Remoting::ProviderData prov) ;

/// @brief Method SyncDispatchMessage addr 0x236e9b8 size 0xa8 virtual false final false
static System::Runtime::Remoting::Messaging::IMessage SyncDispatchMessage(System::Runtime::Remoting::Messaging::IMessage msg) ;

/// @brief Method CheckIncomingMessage addr 0x236ea60 size 0x2a8 virtual false final false
...
/// @brief Method CheckReturnMessage addr 0x236ed08 size 0x1d0 virtual false final false
...
/// @brief Method IsLocalCall addr 0x236eed8 size 0x8 virtual false final false
static bool IsLocalCall(System::Runtime::Remoting::Messaging::IMessage callMsg) ;

/// @brief Method GetCurrentChannelInfo addr 0x236eff4 size 0x500 virtual false final false
