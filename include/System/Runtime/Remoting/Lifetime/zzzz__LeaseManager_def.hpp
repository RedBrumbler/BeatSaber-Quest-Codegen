...
/// @brief Method SetPollTime addr 0x2368210 size 0xf8 virtual false final false
 void SetPollTime(System::TimeSpan timeSpan) ;

/// @brief Method TrackLifetime addr 0x2368308 size 0x134 virtual false final false
 void TrackLifetime(System::Runtime::Remoting::ServerIdentity identity) ;

/// @brief Method StartManager addr 0x236843c size 0x160 virtual false final false
 void StartManager() ;

/// @brief Method StopManager addr 0x236859c size 0x1c virtual false final false
 void StopManager() ;

/// @brief Method ManageLeases addr 0x23685b8 size 0x264 virtual false final false
 void ManageLeases(::bs_hook::Il2CppWrapperType state) ;

// Ctor Parameters []
explicit LeaseManager() ;

/// @brief Method .ctor addr 0x236881c size 0x68 virtual false final false
 void _ctor() ;
