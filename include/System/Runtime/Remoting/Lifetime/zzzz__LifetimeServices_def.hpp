...
/// @brief Method get_LeaseManagerPollTime addr 0x2368db4 size 0x58 virtual false final false
static System::TimeSpan get_LeaseManagerPollTime() ;

/// @brief Method set_LeaseManagerPollTime addr 0x2368e0c size 0x74 virtual false final false
static void set_LeaseManagerPollTime(System::TimeSpan value) ;

/// @brief Method get_LeaseTime addr 0x2368e80 size 0x58 virtual false final false
static System::TimeSpan get_LeaseTime() ;

/// @brief Method set_LeaseTime addr 0x2368ed8 size 0x5c virtual false final false
static void set_LeaseTime(System::TimeSpan value) ;

/// @brief Method get_RenewOnCallTime addr 0x2368f34 size 0x58 virtual false final false
static System::TimeSpan get_RenewOnCallTime() ;

/// @brief Method set_RenewOnCallTime addr 0x2368f8c size 0x5c virtual false final false
static void set_RenewOnCallTime(System::TimeSpan value) ;

/// @brief Method get_SponsorshipTimeout addr 0x2368fe8 size 0x58 virtual false final false
static System::TimeSpan get_SponsorshipTimeout() ;

/// @brief Method set_SponsorshipTimeout addr 0x2369040 size 0x5c virtual false final false
static void set_SponsorshipTimeout(System::TimeSpan value) ;

/// @brief Method TrackLifetime addr 0x235f65c size 0x68 virtual false final false
