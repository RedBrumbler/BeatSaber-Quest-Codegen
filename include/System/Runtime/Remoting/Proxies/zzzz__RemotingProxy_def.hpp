...
/// @brief Method .ctor addr 0x23657ec size 0x44 virtual false final false
...
/// @brief Method .ctor addr 0x2363054 size 0x48 virtual false final false
 void _ctor(System::Type type, ::StringW activationUrl, ::ArrayW<::bs_hook::Il2CppWrapperType> activationAttributes) ;

/// @brief Method Invoke addr 0x23661ec size 0x5c8 virtual true final false
 System::Runtime::Remoting::Messaging::IMessage Invoke(System::Runtime::Remoting::Messaging::IMessage request) ;

/// @brief Method AttachIdentity addr 0x2366b48 size 0x230 virtual false final false
 void AttachIdentity(System::Runtime::Remoting::Identity identity) ;

/// @brief Method ActivateRemoteObject addr 0x2364714 size 0xdc virtual false final false
 System::Runtime::Remoting::Messaging::IMessage ActivateRemoteObject(System::Runtime::Remoting::Messaging::IMethodMessage request) ;

/// @brief Method get_TypeName addr 0x2367308 size 0x138 virtual true final true
 ::StringW get_TypeName() ;

/// @brief Method CanCastTo addr 0x2367440 size 0x21c virtual true final true
 bool CanCastTo(System::Type fromType, ::bs_hook::Il2CppWrapperType o) ;

/// @brief Method Finalize addr 0x236765c size 0x11c virtual true final false
 void Finalize() ;
