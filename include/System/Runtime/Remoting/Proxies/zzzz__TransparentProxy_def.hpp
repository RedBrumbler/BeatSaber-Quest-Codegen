...
/// @brief Method GetProxyType addr 0x2363118 size 0xd0 virtual false final false
 System::RuntimeType GetProxyType() ;

/// @brief Method get_IsContextBoundObject addr 0x23631e8 size 0x1c virtual false final false
 bool get_IsContextBoundObject() ;

/// @brief Method get_TargetContext addr 0x2363204 size 0x1c virtual false final false
 System::Runtime::Remoting::Contexts::Context get_TargetContext() ;

/// @brief Method InCurrentContext addr 0x2363220 size 0x40 virtual false final false
 bool InCurrentContext() ;

/// @brief Method LoadRemoteFieldNew addr 0x2363260 size 0x2d8 virtual false final false
 ::bs_hook::Il2CppWrapperType LoadRemoteFieldNew(::cordl_internals::intptr_t classPtr, ::cordl_internals::intptr_t fieldPtr) ;

/// @brief Method StoreRemoteField addr 0x2363f44 size 0x2d8 virtual false final false
...
/// @brief Method .ctor addr 0x236421c size 0x8 virtual false final false
 void _ctor() ;
