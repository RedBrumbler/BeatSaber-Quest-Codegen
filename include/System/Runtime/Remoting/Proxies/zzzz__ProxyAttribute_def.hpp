...
/// @brief Method CreateInstance addr 0x2362f50 size 0x104 virtual true final false
 System::MarshalByRefObject CreateInstance(System::Type serverType) ;

/// @brief Method CreateProxy addr 0x236309c size 0x70 virtual true final false
...
/// @brief Method GetPropertiesForNewContext addr 0x236310c size 0x4 virtual true final true
 void GetPropertiesForNewContext(System::Runtime::Remoting::Activation::IConstructionCallMessage msg) ;

/// @brief Method IsContextOK addr 0x2363110 size 0x8 virtual true final true
