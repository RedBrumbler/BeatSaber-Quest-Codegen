...
/// @brief Method .ctor addr 0x2364224 size 0x10 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2364234 size 0x60 virtual false final false
...
/// @brief Method .ctor addr 0x23643c4 size 0x6c virtual false final false
...
/// @brief Method .ctor addr 0x2364294 size 0x130 virtual false final false
 void _ctor(System::Type classToProxy, ::cordl_internals::intptr_t stub, ::bs_hook::Il2CppWrapperType stubData) ;

/// @brief Method InternalGetProxyType addr 0x2364430 size 0x4 virtual false final false
static System::Type InternalGetProxyType(::bs_hook::Il2CppWrapperType transparentProxy) ;

/// @brief Method GetProxiedType addr 0x2364434 size 0xac virtual false final false
 System::Type GetProxiedType() ;

/// @brief Method GetObjectData addr 0x23644e0 size 0x98 virtual true final false
 void GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method get_ObjectIdentity addr 0x2364578 size 0x8 virtual false final false
 System::Runtime::Remoting::Identity get_ObjectIdentity() ;

/// @brief Method set_ObjectIdentity addr 0x2364580 size 0x8 virtual false final false
...
/// @brief Method PrivateInvoke addr 0x2363670 size 0x8d4 virtual false final false
...
/// @brief Method InternalGetTransparentProxy addr 0x2365484 size 0x4 virtual true final false
 ::bs_hook::Il2CppWrapperType InternalGetTransparentProxy(::StringW className) ;

/// @brief Method GetTransparentProxy addr 0x2365488 size 0x164 virtual true final false
 ::bs_hook::Il2CppWrapperType GetTransparentProxy() ;

/// @brief Method AttachServer addr 0x23655ec size 0x8 virtual false final false
 void AttachServer(System::MarshalByRefObject s) ;

/// @brief Method SetTargetDomain addr 0x23655f4 size 0x8 virtual false final false
 void SetTargetDomain(int32_t domainId) ;

/// @brief Method GetAppDomainTarget addr 0x23655fc size 0x12c virtual false final false
 ::bs_hook::Il2CppWrapperType GetAppDomainTarget() ;

/// @brief Method ProcessResponse addr 0x2364d80 size 0x704 virtual false final false
