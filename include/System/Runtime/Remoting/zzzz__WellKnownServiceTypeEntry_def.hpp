...
/// @brief Method .ctor addr 0x23625e8 size 0x140 virtual false final false
 void _ctor(::StringW typeName, ::StringW assemblyName, ::StringW objectUri, System::Runtime::Remoting::WellKnownObjectMode mode) ;

/// @brief Method get_Mode addr 0x2362728 size 0x8 virtual false final false
 System::Runtime::Remoting::WellKnownObjectMode get_Mode() ;

/// @brief Method get_ObjectType addr 0x2362730 size 0x8 virtual false final false
 System::Type get_ObjectType() ;

/// @brief Method get_ObjectUri addr 0x2362738 size 0x8 virtual false final false
 ::StringW get_ObjectUri() ;

/// @brief Method ToString addr 0x2362740 size 0x178 virtual true final false
 ::StringW ToString() ;
