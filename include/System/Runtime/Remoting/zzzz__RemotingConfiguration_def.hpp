...
/// @brief Method get_ApplicationName addr 0x2354374 size 0x58 virtual false final false
static ::StringW get_ApplicationName() ;

/// @brief Method set_ApplicationName addr 0x23543cc size 0x5c virtual false final false
static void set_ApplicationName(::StringW value) ;

/// @brief Method get_ProcessId addr 0x2354428 size 0xa8 virtual false final false
static ::StringW get_ProcessId() ;

/// @brief Method LoadDefaultDelayedChannels addr 0x23544d0 size 0x36c virtual false final false
static void LoadDefaultDelayedChannels() ;

/// @brief Method IsActivationAllowed addr 0x23548f4 size 0x144 virtual false final false
static bool IsActivationAllowed(System::Type svrType) ;

/// @brief Method IsRemotelyActivatedClientType addr 0x2354a38 size 0x18c virtual false final false
static System::Runtime::Remoting::ActivatedClientTypeEntry IsRemotelyActivatedClientType(System::Type svrType) ;

/// @brief Method IsWellKnownClientType addr 0x2354bc4 size 0x18c virtual false final false
static System::Runtime::Remoting::WellKnownClientTypeEntry IsWellKnownClientType(System::Type svrType) ;

/// @brief Method RegisterActivatedClientType addr 0x2354d50 size 0x28c virtual false final false
static void RegisterActivatedClientType(System::Runtime::Remoting::ActivatedClientTypeEntry entry) ;

/// @brief Method RegisterActivatedServiceType addr 0x2354fdc size 0x144 virtual false final false
static void RegisterActivatedServiceType(System::Runtime::Remoting::ActivatedServiceTypeEntry entry) ;

/// @brief Method RegisterWellKnownClientType addr 0x2355120 size 0x28c virtual false final false
static void RegisterWellKnownClientType(System::Runtime::Remoting::WellKnownClientTypeEntry entry) ;

/// @brief Method RegisterWellKnownServiceType addr 0x23553ac size 0x188 virtual false final false
static void RegisterWellKnownServiceType(System::Runtime::Remoting::WellKnownServiceTypeEntry entry) ;

/// @brief Method RegisterChannelTemplate addr 0x2355650 size 0x7c virtual false final false
static void RegisterChannelTemplate(System::Runtime::Remoting::ChannelData channel) ;

/// @brief Method RegisterClientProviderTemplate addr 0x23556cc size 0x7c virtual false final false
static void RegisterClientProviderTemplate(System::Runtime::Remoting::ProviderData prov) ;

/// @brief Method RegisterServerProviderTemplate addr 0x2355748 size 0x7c virtual false final false
static void RegisterServerProviderTemplate(System::Runtime::Remoting::ProviderData prov) ;

/// @brief Method RegisterChannels addr 0x23557c4 size 0xc90 virtual false final false
static void RegisterChannels(System::Collections::ArrayList channels, bool onlyDelayed) ;

/// @brief Method RegisterTypes addr 0x2357570 size 0x520 virtual false final false
static void RegisterTypes(System::Collections::ArrayList types) ;

/// @brief Method CustomErrorsEnabled addr 0x2357a90 size 0x94 virtual false final false
static bool CustomErrorsEnabled(bool isLocalRequest) ;

/// @brief Method SetCustomErrorsMode addr 0x2357b24 size 0x260 virtual false final false
