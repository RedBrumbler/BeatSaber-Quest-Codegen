...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Collections::ArrayList (System::Runtime::Remoting::ChannelData::*)()>(&System::Runtime::Remoting::ChannelData::get_ServerProviders)> {
  ...
  constexpr static std::size_t addrs = 0x2356d94;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Collections::ArrayList (System::Runtime::Remoting::ChannelData::*)()>(&System::Runtime::Remoting::ChannelData::get_ClientProviders)> {
  constexpr static std::size_t size = 0x6c;
  constexpr static std::size_t addrs = 0x2357504;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Runtime::Remoting::ChannelData::*)(System::Runtime::Remoting::ChannelData)>(&System::Runtime::Remoting::ChannelData::CopyFrom)> {
  ...
  constexpr static std::size_t addrs = 0x2356454;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Runtime::Remoting::ChannelData::*)()>(&System::Runtime::Remoting::ChannelData::_ctor)> {
  constexpr static std::size_t size = 0xb4;
  constexpr static std::size_t addrs = 0x235b07c;
...
constexpr ::StringW System::Runtime::Remoting::ChannelData::__get_DelayLoadAsClientChannel() const {
...
constexpr System::Collections::ArrayList System::Runtime::Remoting::ChannelData::__get__serverProviders() const {
...
constexpr System::Collections::ArrayList System::Runtime::Remoting::ChannelData::__get__clientProviders() const {
...
constexpr System::Collections::Hashtable System::Runtime::Remoting::ChannelData::__get__customProperties() const {
...
// Ctor Parameters []
 System::Runtime::Remoting::ChannelData::ChannelData()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<ChannelData>())) {}
 void System::Runtime::Remoting::ChannelData::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Runtime::Remoting::ChannelData>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
