...
/// @brief Method get_ServerProviders addr 0x2356d94 size 0x6c virtual false final false
 System::Collections::ArrayList get_ServerProviders() ;

/// @brief Method get_ClientProviders addr 0x2357504 size 0x6c virtual false final false
 System::Collections::ArrayList get_ClientProviders() ;

/// @brief Method get_CustomProperties addr 0x235b130 size 0x6c virtual false final false
 System::Collections::Hashtable get_CustomProperties() ;

/// @brief Method CopyFrom addr 0x2356454 size 0x940 virtual false final false
 void CopyFrom(System::Runtime::Remoting::ChannelData other) ;

// Ctor Parameters []
explicit ChannelData() ;

/// @brief Method .ctor addr 0x235b07c size 0xb4 virtual false final false
 void _ctor() ;
