...
/// @brief Method .ctor addr 0x235f8f0 size 0x410 virtual false final false
 void _ctor(System::Type type) ;

/// @brief Method get_TypeName addr 0x236220c size 0x8 virtual true final true
 ::StringW get_TypeName() ;

/// @brief Method CanCastTo addr 0x2362214 size 0x26c virtual true final true
