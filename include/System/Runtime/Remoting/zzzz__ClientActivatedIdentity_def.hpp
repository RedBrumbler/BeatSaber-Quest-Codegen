...
/// @brief Method .ctor addr 0x2360318 size 0x2c virtual false final false
 void _ctor(::StringW objectUri, System::Type objectType) ;

/// @brief Method GetServerObject addr 0x2360344 size 0x8 virtual false final false
 System::MarshalByRefObject GetServerObject() ;

/// @brief Method SetClientProxy addr 0x236034c size 0x8 virtual false final false
 void SetClientProxy(System::MarshalByRefObject obj) ;

/// @brief Method OnLifetimeExpired addr 0x2360354 size 0x60 virtual true final false
 void OnLifetimeExpired() ;

/// @brief Method SyncObjectProcessMessage addr 0x23603b4 size 0xdc virtual true final false
 System::Runtime::Remoting::Messaging::IMessage SyncObjectProcessMessage(System::Runtime::Remoting::Messaging::IMessage msg) ;

/// @brief Method AsyncObjectProcessMessage addr 0x2360648 size 0xf0 virtual true final false
