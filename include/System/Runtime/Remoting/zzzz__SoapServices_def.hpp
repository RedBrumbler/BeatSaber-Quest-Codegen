...
/// @brief Method .ctor addr 0x23620d4 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_XmlNsForClrTypeWithAssembly addr 0x236109c size 0x40 virtual false final false
static ::StringW get_XmlNsForClrTypeWithAssembly() ;

/// @brief Method get_XmlNsForClrTypeWithNs addr 0x23610dc size 0x40 virtual false final false
static ::StringW get_XmlNsForClrTypeWithNs() ;

/// @brief Method get_XmlNsForClrTypeWithNsAndAssembly addr 0x236111c size 0x40 virtual false final false
static ::StringW get_XmlNsForClrTypeWithNsAndAssembly() ;

/// @brief Method CodeXmlNamespaceForClrTypeNamespace addr 0x236115c size 0x198 virtual false final false
static ::StringW CodeXmlNamespaceForClrTypeNamespace(::StringW typeNamespace, ::StringW assemblyName) ;

/// @brief Method GetNameKey addr 0x23613d8 size 0x68 virtual false final false
static ::StringW GetNameKey(::StringW name, ::StringW namspace) ;

/// @brief Method GetAssemblyName addr 0x2361440 size 0x134 virtual false final false
static ::StringW GetAssemblyName(System::Reflection::MethodBase mb) ;

/// @brief Method GetXmlElementForInteropType addr 0x2361574 size 0xd0 virtual false final false
static bool GetXmlElementForInteropType(System::Type type, ByRef<::StringW> xmlElement, ByRef<::StringW> xmlNamespace) ;

/// @brief Method GetXmlNamespaceForMethodCall addr 0x2361644 size 0x94 virtual false final false
static ::StringW GetXmlNamespaceForMethodCall(System::Reflection::MethodBase mb) ;

/// @brief Method GetXmlNamespaceForMethodResponse addr 0x23616d8 size 0x94 virtual false final false
static ::StringW GetXmlNamespaceForMethodResponse(System::Reflection::MethodBase mb) ;

/// @brief Method GetXmlTypeForInteropType addr 0x236176c size 0xc8 virtual false final false
static bool GetXmlTypeForInteropType(System::Type type, ByRef<::StringW> xmlType, ByRef<::StringW> xmlTypeNamespace) ;

/// @brief Method PreLoad addr 0x2361834 size 0xbc virtual false final false
static void PreLoad(System::Reflection::Assembly assembly) ;

/// @brief Method PreLoad addr 0x23618f0 size 0x4c4 virtual false final false
static void PreLoad(System::Type type) ;

/// @brief Method RegisterInteropXmlElement addr 0x2361f44 size 0x190 virtual false final false
static void RegisterInteropXmlElement(::StringW xmlElement, ::StringW xmlNamespace, System::Type type) ;

/// @brief Method RegisterInteropXmlType addr 0x2361db4 size 0x190 virtual false final false
static void RegisterInteropXmlType(::StringW xmlType, ::StringW xmlTypeNamespace, System::Type type) ;

/// @brief Method EncodeNs addr 0x23612f4 size 0xe4 virtual false final false
