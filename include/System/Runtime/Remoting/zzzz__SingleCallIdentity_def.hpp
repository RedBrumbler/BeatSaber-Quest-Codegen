...
/// @brief Method .ctor addr 0x2360b14 size 0x30 virtual false final false
 void _ctor(::StringW objectUri, System::Runtime::Remoting::Contexts::Context context, System::Type objectType) ;

/// @brief Method SyncObjectProcessMessage addr 0x2360b44 size 0x210 virtual true final false
 System::Runtime::Remoting::Messaging::IMessage SyncObjectProcessMessage(System::Runtime::Remoting::Messaging::IMessage msg) ;

/// @brief Method AsyncObjectProcessMessage addr 0x2360d54 size 0x1c0 virtual true final false
