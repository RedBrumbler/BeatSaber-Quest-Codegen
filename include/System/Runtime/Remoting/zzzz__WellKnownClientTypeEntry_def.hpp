...
/// @brief Method .ctor addr 0x2362480 size 0x134 virtual false final false
 void _ctor(::StringW typeName, ::StringW assemblyName, ::StringW objectUrl) ;

/// @brief Method get_ApplicationUrl addr 0x23625b4 size 0x8 virtual false final false
 ::StringW get_ApplicationUrl() ;

/// @brief Method get_ObjectType addr 0x23625bc size 0x8 virtual false final false
 System::Type get_ObjectType() ;

/// @brief Method get_ObjectUrl addr 0x23625c4 size 0x8 virtual false final false
 ::StringW get_ObjectUrl() ;

/// @brief Method ToString addr 0x23625cc size 0x1c virtual true final false
 ::StringW ToString() ;
