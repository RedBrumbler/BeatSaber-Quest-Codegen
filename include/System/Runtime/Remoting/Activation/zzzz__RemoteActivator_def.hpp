...
/// @brief Method Activate addr 0x2372388 size 0x47c virtual true final true
...
/// @brief Method get_NextActivator addr 0x2372804 size 0x40 virtual true final true
