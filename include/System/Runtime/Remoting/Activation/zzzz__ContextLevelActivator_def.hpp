...
/// @brief Method .ctor addr 0x23710e0 size 0x28 virtual false final false
 void _ctor(System::Runtime::Remoting::Activation::IActivator next) ;

/// @brief Method get_NextActivator addr 0x2371c34 size 0x8 virtual true final true
 System::Runtime::Remoting::Activation::IActivator get_NextActivator() ;

/// @brief Method Activate addr 0x2371c3c size 0x334 virtual true final true
