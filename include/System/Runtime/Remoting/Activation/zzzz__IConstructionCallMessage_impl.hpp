...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<System::Type (System::Runtime::Remoting::Activation::IConstructionCallMessage::*)()>(&System::Runtime::Remoting::Activation::IConstructionCallMessage::get_ActivationType)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
                            ...
                            static auto* ___internal_method = THROW_UNLESS(::il2cpp_utils::ResolveVtableSlot(
                                classof(System::Runtime::Remoting::Activation::IConstructionCallMessage),
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::bs_hook::Il2CppWrapperType> (System::Runtime::Remoting::Activation::IConstructionCallMessage::*)()>(&System::Runtime::Remoting::Activation::IConstructionCallMessage::get_CallSiteActivationAttributes)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
constexpr  System::Runtime::Remoting::Activation::IConstructionCallMessage::operator System::Runtime::Remoting::Messaging::IMessage() const noexcept {
...
constexpr  System::Runtime::Remoting::Activation::IConstructionCallMessage::operator System::Runtime::Remoting::Messaging::IMethodCallMessage() const noexcept {
return System::Runtime::Remoting::Messaging::IMethodCallMessage(::bs_hook::Il2CppWrapperType::instance);
}
/// @brief Convert operator to System::Runtime::Remoting::Messaging::IMethodMessage
constexpr  System::Runtime::Remoting::Activation::IConstructionCallMessage::operator System::Runtime::Remoting::Messaging::IMethodMessage() const noexcept {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method, value);
 ...
 ::ArrayW<::bs_hook::Il2CppWrapperType> System::Runtime::Remoting::Activation::IConstructionCallMessage::get_CallSiteActivationAttributes()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Runtime::Remoting::Activation::IConstructionCallMessage>::get(),
