...
/// @brief Method .ctor addr 0x2371f70 size 0x28 virtual false final false
 void _ctor(System::Collections::IList contextProperties) ;

/// @brief Method IsContextOK addr 0x2371f98 size 0x8 virtual true final true
...
/// @brief Method GetPropertiesForNewContext addr 0x2371fa0 size 0x3e8 virtual true final true
