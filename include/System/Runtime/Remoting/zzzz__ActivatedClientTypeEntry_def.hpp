...
/// @brief Method .ctor addr 0x235294c size 0x130 virtual false final false
 void _ctor(::StringW typeName, ::StringW assemblyName, ::StringW appUrl) ;

/// @brief Method get_ApplicationUrl addr 0x2352a84 size 0x8 virtual false final false
 ::StringW get_ApplicationUrl() ;

/// @brief Method get_ContextAttributes addr 0x2352a8c size 0x8 virtual false final false
 ::ArrayW<System::Runtime::Remoting::Contexts::IContextAttribute> get_ContextAttributes() ;

/// @brief Method get_ObjectType addr 0x2352a94 size 0x8 virtual false final false
 System::Type get_ObjectType() ;

/// @brief Method ToString addr 0x2352a9c size 0x14 virtual true final false
 ::StringW ToString() ;
