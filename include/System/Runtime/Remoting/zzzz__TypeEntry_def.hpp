...
/// @brief Method .ctor addr 0x23621e4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_AssemblyName addr 0x23621ec size 0x8 virtual false final false
 ::StringW get_AssemblyName() ;

/// @brief Method set_AssemblyName addr 0x23621f4 size 0x8 virtual false final false
 void set_AssemblyName(::StringW value) ;

/// @brief Method get_TypeName addr 0x23621fc size 0x8 virtual false final false
 ::StringW get_TypeName() ;

/// @brief Method set_TypeName addr 0x2362204 size 0x8 virtual false final false
