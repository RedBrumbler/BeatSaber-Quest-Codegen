...
/// @brief Method .ctor addr 0x2372ae8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_UseAttribute addr 0x2372af0 size 0x8 virtual true final false
 bool get_UseAttribute() ;

/// @brief Method get_XmlElementName addr 0x2372af8 size 0x8 virtual false final false
 ::StringW get_XmlElementName() ;

/// @brief Method get_XmlNamespace addr 0x2372b00 size 0x8 virtual true final false
 ::StringW get_XmlNamespace() ;

/// @brief Method get_XmlTypeName addr 0x2372b08 size 0x8 virtual false final false
 ::StringW get_XmlTypeName() ;

/// @brief Method get_XmlTypeNamespace addr 0x2372b10 size 0x8 virtual false final false
 ::StringW get_XmlTypeNamespace() ;

/// @brief Method get_IsInteropXmlElement addr 0x2372b18 size 0x8 virtual false final false
 bool get_IsInteropXmlElement() ;

/// @brief Method get_IsInteropXmlType addr 0x2372b20 size 0x8 virtual false final false
 bool get_IsInteropXmlType() ;

/// @brief Method SetReflectionObject addr 0x2372b28 size 0x1fc virtual true final false
