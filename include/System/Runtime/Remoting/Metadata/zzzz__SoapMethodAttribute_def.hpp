...
/// @brief Method .ctor addr 0x237291c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method get_UseAttribute addr 0x2372924 size 0x8 virtual true final false
 bool get_UseAttribute() ;

/// @brief Method get_XmlNamespace addr 0x237292c size 0x8 virtual true final false
 ::StringW get_XmlNamespace() ;

/// @brief Method SetReflectionObject addr 0x2372934 size 0x1ac virtual true final false
