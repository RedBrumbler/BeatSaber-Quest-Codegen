...
/// @brief Method .ctor addr 0x236bab4 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_HasProperties addr 0x2369364 size 0x30 virtual false final false
 bool get_HasProperties() ;

/// @brief Method RegisterDynamicProperty addr 0x23695f0 size 0x2ec virtual false final false
 bool RegisterDynamicProperty(System::Runtime::Remoting::Contexts::IDynamicProperty prop) ;

/// @brief Method UnregisterDynamicProperty addr 0x2369954 size 0x178 virtual false final false
 bool UnregisterDynamicProperty(::StringW name) ;

/// @brief Method NotifyMessage addr 0x2369c34 size 0x65c virtual false final false
 void NotifyMessage(bool start, System::Runtime::Remoting::Messaging::IMessage msg, bool client_site, bool async) ;

/// @brief Method FindProperty addr 0x236b950 size 0x164 virtual false final false
 int32_t FindProperty(::StringW name) ;

// Ctor Parameters []
explicit DynamicPropertyCollection() ;

/// @brief Method .ctor addr 0x2369acc size 0x68 virtual false final false
 void _ctor() ;
