...
/// @brief Method RegisterContext addr 0x236909c size 0x4 virtual false final false
static void RegisterContext(System::Runtime::Remoting::Contexts::Context ctx) ;

/// @brief Method ReleaseContext addr 0x23690a0 size 0x4 virtual false final false
static void ReleaseContext(System::Runtime::Remoting::Contexts::Context ctx) ;

// Ctor Parameters []
explicit Context() ;

/// @brief Method .ctor addr 0x23690a4 size 0x84 virtual false final false
 void _ctor() ;

/// @brief Method Finalize addr 0x2369128 size 0xd0 virtual true final false
 void Finalize() ;

/// @brief Method get_DefaultContext addr 0x2360958 size 0x8 virtual false final false
static System::Runtime::Remoting::Contexts::Context get_DefaultContext() ;

/// @brief Method get_ContextID addr 0x23691f8 size 0x8 virtual true final false
 int32_t get_ContextID() ;

/// @brief Method get_ContextProperties addr 0x2369200 size 0x74 virtual true final false
 ::ArrayW<System::Runtime::Remoting::Contexts::IContextProperty> get_ContextProperties() ;

/// @brief Method get_IsDefaultContext addr 0x2369274 size 0x10 virtual false final false
 bool get_IsDefaultContext() ;

/// @brief Method get_NeedsContextSink addr 0x2369284 size 0xe0 virtual false final false
 bool get_NeedsContextSink() ;

/// @brief Method RegisterDynamicProperty addr 0x2369394 size 0x78 virtual false final false
...
/// @brief Method UnregisterDynamicProperty addr 0x23698dc size 0x78 virtual false final false
...
/// @brief Method GetDynamicPropertyCollection addr 0x236940c size 0x1e4 virtual false final false
...
/// @brief Method NotifyGlobalDynamicSinks addr 0x2369b34 size 0x100 virtual false final false
...
/// @brief Method get_HasGlobalDynamicSinks addr 0x236a290 size 0xa4 virtual false final false
static bool get_HasGlobalDynamicSinks() ;

/// @brief Method NotifyDynamicSinks addr 0x236a334 size 0x84 virtual false final false
 void NotifyDynamicSinks(bool start, System::Runtime::Remoting::Messaging::IMessage req_msg, bool client_site, bool async) ;

/// @brief Method get_HasDynamicSinks addr 0x236a3b8 size 0x40 virtual false final false
 bool get_HasDynamicSinks() ;

/// @brief Method get_HasExitSinks addr 0x2366888 size 0xb8 virtual false final false
 bool get_HasExitSinks() ;

/// @brief Method GetProperty addr 0x236a3f8 size 0x1e8 virtual true final false
 System::Runtime::Remoting::Contexts::IContextProperty GetProperty(::StringW name) ;

/// @brief Method SetProperty addr 0x236a5e0 size 0x1ac virtual true final false
 void SetProperty(System::Runtime::Remoting::Contexts::IContextProperty prop) ;

/// @brief Method Freeze addr 0x236a78c size 0x1ac virtual true final false
 void Freeze() ;

/// @brief Method ToString addr 0x236a938 size 0x5c virtual true final false
 ::StringW ToString() ;

/// @brief Method GetServerContextSinkChain addr 0x236a994 size 0x1c4 virtual false final false
 System::Runtime::Remoting::Messaging::IMessageSink GetServerContextSinkChain() ;

/// @brief Method GetClientContextSinkChain addr 0x2366940 size 0x208 virtual false final false
 System::Runtime::Remoting::Messaging::IMessageSink GetClientContextSinkChain() ;

/// @brief Method CreateServerObjectSinkChain addr 0x2360490 size 0x1b8 virtual false final false
...
/// @brief Method CreateEnvoySink addr 0x235fdf8 size 0x204 virtual false final false
 System::Runtime::Remoting::Messaging::IMessageSink CreateEnvoySink(System::MarshalByRefObject serverObject) ;

/// @brief Method SwitchToContext addr 0x236ab80 size 0x8 virtual false final false
static System::Runtime::Remoting::Contexts::Context SwitchToContext(System::Runtime::Remoting::Contexts::Context newContext) ;

/// @brief Method CreateNewContext addr 0x236ab88 size 0x844 virtual false final false
...
/// @brief Method DoCallBack addr 0x236b3cc size 0x174 virtual false final false
 void DoCallBack(System::Runtime::Remoting::Contexts::CrossContextDelegate deleg) ;

/// @brief Method get_MyLocalStore addr 0x236b54c size 0x174 virtual false final false
 System::LocalDataStore get_MyLocalStore() ;

/// @brief Method AllocateDataSlot addr 0x236b6c0 size 0x64 virtual false final false
static System::LocalDataStoreSlot AllocateDataSlot() ;

/// @brief Method AllocateNamedDataSlot addr 0x236b724 size 0x6c virtual false final false
static System::LocalDataStoreSlot AllocateNamedDataSlot(::StringW name) ;

/// @brief Method FreeNamedDataSlot addr 0x236b790 size 0x6c virtual false final false
static void FreeNamedDataSlot(::StringW name) ;

/// @brief Method GetNamedDataSlot addr 0x236b7fc size 0x6c virtual false final false
static System::LocalDataStoreSlot GetNamedDataSlot(::StringW name) ;

/// @brief Method GetData addr 0x236b868 size 0x30 virtual false final false
static ::bs_hook::Il2CppWrapperType GetData(System::LocalDataStoreSlot slot) ;

/// @brief Method SetData addr 0x236b898 size 0x40 virtual false final false
