...
/// @brief Method get_Datastore addr 0x2372f04 size 0x6c virtual false final false
 System::Collections::Hashtable get_Datastore() ;

/// @brief Method get_HostContext addr 0x2372f70 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_HostContext() ;

/// @brief Method set_HostContext addr 0x2372f78 size 0x8 virtual false final false
 void set_HostContext(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_HasUserData addr 0x2372f80 size 0x2c virtual false final false
 bool get_HasUserData() ;

/// @brief Method FreeNamedDataSlot addr 0x2372e40 size 0x2c virtual false final false
 void FreeNamedDataSlot(::StringW name) ;

/// @brief Method CreateCopy addr 0x2372fac size 0x254 virtual false final false
 System::Runtime::Remoting::Messaging::IllogicalCallContext CreateCopy() ;

// Ctor Parameters []
explicit IllogicalCallContext() ;

/// @brief Method .ctor addr 0x2373200 size 0x8 virtual false final false
 void _ctor() ;
