...
/// @brief Method .ctor addr 0x237c470 size 0xe4 virtual false final false
 void _ctor(System::Runtime::Remoting::Messaging::MessageDictionary methodDictionary) ;

/// @brief Method get_Current addr 0x237c5b4 size 0x64 virtual true final true
 ::bs_hook::Il2CppWrapperType get_Current() ;

/// @brief Method MoveNext addr 0x237c784 size 0x1c4 virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x237c948 size 0xac virtual true final true
 void Reset() ;

/// @brief Method get_Entry addr 0x237c618 size 0x16c virtual true final true
 System::Collections::DictionaryEntry get_Entry() ;

/// @brief Method get_Key addr 0x237c9f4 size 0x4 virtual true final true
 ::bs_hook::Il2CppWrapperType get_Key() ;

/// @brief Method get_Value addr 0x237c9f8 size 0x14 virtual true final true
...
/// @brief Method .ctor addr 0x2378cec size 0x28 virtual false final false
 void _ctor(System::Runtime::Remoting::Messaging::IMethodMessage message) ;

/// @brief Method HasUserData addr 0x2375b48 size 0xfc virtual false final false
 bool HasUserData() ;

/// @brief Method get_InternalDictionary addr 0x2375c44 size 0x88 virtual false final false
 System::Collections::IDictionary get_InternalDictionary() ;

/// @brief Method set_MethodKeys addr 0x237b2e8 size 0x8 virtual false final false
 void set_MethodKeys(::ArrayW<::StringW> value) ;

/// @brief Method AllocInternalProperties addr 0x237b2f0 size 0x68 virtual true final false
 System::Collections::IDictionary AllocInternalProperties() ;

/// @brief Method GetInternalProperties addr 0x2377de8 size 0x30 virtual false final false
 System::Collections::IDictionary GetInternalProperties() ;

/// @brief Method IsOverridenKey addr 0x237b358 size 0x8c virtual false final false
 bool IsOverridenKey(::StringW key) ;

/// @brief Method get_IsFixedSize addr 0x237b3e4 size 0x8 virtual true final true
 bool get_IsFixedSize() ;

/// @brief Method get_IsReadOnly addr 0x237b3ec size 0x8 virtual true final true
 bool get_IsReadOnly() ;

/// @brief Method get_Item addr 0x237b3f4 size 0x14c virtual true final true
 ::bs_hook::Il2CppWrapperType get_Item(::bs_hook::Il2CppWrapperType key) ;

/// @brief Method set_Item addr 0x237b540 size 0x4 virtual true final true
 void set_Item(::bs_hook::Il2CppWrapperType key, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetMethodProperty addr 0x23790c0 size 0x540 virtual true final false
 ::bs_hook::Il2CppWrapperType GetMethodProperty(::StringW key) ;

/// @brief Method SetMethodProperty addr 0x237986c size 0x2e0 virtual true final false
 void SetMethodProperty(::StringW key, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_Keys addr 0x237b6ac size 0x434 virtual true final true
 System::Collections::ICollection get_Keys() ;

/// @brief Method get_Values addr 0x237bae0 size 0x420 virtual true final true
 System::Collections::ICollection get_Values() ;

/// @brief Method Add addr 0x237b544 size 0x168 virtual true final true
 void Add(::bs_hook::Il2CppWrapperType key, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method Clear addr 0x237bf00 size 0xac virtual true final true
 void Clear() ;

/// @brief Method Contains addr 0x237bfac size 0x148 virtual true final true
 bool Contains(::bs_hook::Il2CppWrapperType key) ;

/// @brief Method Remove addr 0x237c0f4 size 0x188 virtual true final true
 void Remove(::bs_hook::Il2CppWrapperType key) ;

/// @brief Method get_Count addr 0x237c27c size 0xc8 virtual true final true
 int32_t get_Count() ;

/// @brief Method get_IsSynchronized addr 0x237c344 size 0x8 virtual true final true
 bool get_IsSynchronized() ;

/// @brief Method get_SyncRoot addr 0x237c34c size 0x4 virtual true final true
 ::bs_hook::Il2CppWrapperType get_SyncRoot() ;

/// @brief Method CopyTo addr 0x237c350 size 0xc0 virtual true final true
 void CopyTo(System::Array array, int32_t index) ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x237c410 size 0x60 virtual true final true
 System::Collections::IEnumerator System_Collections_IEnumerable_GetEnumerator() ;

/// @brief Method GetEnumerator addr 0x237c554 size 0x60 virtual true final true
