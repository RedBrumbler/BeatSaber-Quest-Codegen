...
/// @brief Method GetTypes addr 0x23747e0 size 0x14c virtual false final false
 ::ArrayW<System::Type> GetTypes(::ArrayW<::StringW> typeArray) ;

/// @brief Method Resolve addr 0x237492c size 0x524 virtual false final false
...
/// @brief Method .ctor addr 0x2374e50 size 0x2d0 virtual false final false
