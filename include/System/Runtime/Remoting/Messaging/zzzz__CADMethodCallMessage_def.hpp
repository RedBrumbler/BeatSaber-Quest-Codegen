...
/// @brief Method get_Uri addr 0x2376d6c size 0x8 virtual false final false
 ::StringW get_Uri() ;

/// @brief Method Create addr 0x23704d8 size 0x90 virtual false final false
...
/// @brief Method .ctor addr 0x2376d74 size 0x1f0 virtual false final false
 void _ctor(System::Runtime::Remoting::Messaging::IMethodCallMessage callMsg) ;

/// @brief Method GetArguments addr 0x2376f64 size 0x140 virtual false final false
 System::Collections::ArrayList GetArguments() ;

/// @brief Method GetArgs addr 0x23770a4 size 0x10 virtual false final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetArgs(System::Collections::ArrayList args) ;

/// @brief Method get_PropertiesCount addr 0x23770b4 size 0x8 virtual false final false
