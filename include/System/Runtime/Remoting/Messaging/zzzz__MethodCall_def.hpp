...
/// @brief Method .ctor addr 0x2377c50 size 0x98 virtual false final false
...
/// @brief Method .ctor addr 0x237a380 size 0x114 virtual false final false
 void _ctor(System::Runtime::Remoting::Messaging::CADMethodCallMessage msg) ;

// Ctor Parameters []
explicit MethodCall() ;

/// @brief Method .ctor addr 0x2377c44 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method CopyFrom addr 0x2366d84 size 0x35c virtual false final false
 void CopyFrom(System::Runtime::Remoting::Messaging::IMethodMessage call) ;

/// @brief Method InitMethodProperty addr 0x2378238 size 0x41c virtual true final false
 void InitMethodProperty(::StringW key, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method GetObjectData addr 0x23787ec size 0x490 virtual true final false
 void GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method get_ArgCount addr 0x237a494 size 0x1c virtual true final true
 int32_t get_ArgCount() ;

/// @brief Method get_Args addr 0x237a4b0 size 0x8 virtual true final true
 ::ArrayW<::bs_hook::Il2CppWrapperType> get_Args() ;

/// @brief Method get_LogicalCallContext addr 0x237a4b8 size 0x6c virtual true final true
 System::Runtime::Remoting::Messaging::LogicalCallContext get_LogicalCallContext() ;

/// @brief Method get_MethodBase addr 0x237a524 size 0x30 virtual true final true
 System::Reflection::MethodBase get_MethodBase() ;

/// @brief Method get_MethodName addr 0x237ab68 size 0x34 virtual true final true
 ::StringW get_MethodName() ;

/// @brief Method get_MethodSignature addr 0x237ab9c size 0x12c virtual true final true
 ::bs_hook::Il2CppWrapperType get_MethodSignature() ;

/// @brief Method get_Properties addr 0x2378cac size 0x30 virtual true final false
 System::Collections::IDictionary get_Properties() ;

/// @brief Method InitDictionary addr 0x237acc8 size 0x84 virtual true final false
 void InitDictionary() ;

/// @brief Method get_TypeName addr 0x237adc8 size 0x48 virtual true final true
 ::StringW get_TypeName() ;

/// @brief Method get_Uri addr 0x237ae10 size 0x8 virtual true final true
 ::StringW get_Uri() ;

/// @brief Method set_Uri addr 0x237ae18 size 0x8 virtual false final false
 void set_Uri(::StringW value) ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.get_Uri addr 0x237ae20 size 0x8 virtual true final true
 ::StringW System_Runtime_Remoting_Messaging_IInternalMessage_get_Uri() ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.set_Uri addr 0x237ae28 size 0x8 virtual true final true
 void System_Runtime_Remoting_Messaging_IInternalMessage_set_Uri(::StringW value) ;

/// @brief Method GetArg addr 0x237ae30 size 0x30 virtual true final true
 ::bs_hook::Il2CppWrapperType GetArg(int32_t argNum) ;

/// @brief Method Init addr 0x237ae60 size 0x4 virtual true final false
 void Init() ;

/// @brief Method ResolveMethod addr 0x237a554 size 0x614 virtual false final false
 void ResolveMethod() ;

/// @brief Method CastTo addr 0x237ae64 size 0x190 virtual false final false
 System::Type CastTo(::StringW clientType, System::Type serverType) ;

/// @brief Method GetTypeNameFromAssemblyQualifiedName addr 0x237b030 size 0xa8 virtual false final false
static ::StringW GetTypeNameFromAssemblyQualifiedName(::StringW aqname) ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.get_TargetIdentity addr 0x237b0d8 size 0x8 virtual true final true
 System::Runtime::Remoting::Identity System_Runtime_Remoting_Messaging_IInternalMessage_get_TargetIdentity() ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.set_TargetIdentity addr 0x237b0e0 size 0x8 virtual true final true
 void System_Runtime_Remoting_Messaging_IInternalMessage_set_TargetIdentity(System::Runtime::Remoting::Identity value) ;

/// @brief Method get_GenericArguments addr 0x237aff4 size 0x3c virtual false final false
