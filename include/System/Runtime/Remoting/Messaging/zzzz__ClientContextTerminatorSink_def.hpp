...
/// @brief Method .ctor addr 0x236ab58 size 0x28 virtual false final false
 void _ctor(System::Runtime::Remoting::Contexts::Context ctx) ;

/// @brief Method SyncProcessMessage addr 0x23776d4 size 0x1d8 virtual true final true
 System::Runtime::Remoting::Messaging::IMessage SyncProcessMessage(System::Runtime::Remoting::Messaging::IMessage msg) ;

/// @brief Method AsyncProcessMessage addr 0x23778ac size 0x228 virtual true final true
