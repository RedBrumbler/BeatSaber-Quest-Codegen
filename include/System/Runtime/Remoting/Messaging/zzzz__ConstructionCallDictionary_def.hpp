...
/// @brief Method .ctor addr 0x2377d6c size 0x7c virtual false final false
 void _ctor(System::Runtime::Remoting::Activation::IConstructionCallMessage message) ;

/// @brief Method GetMethodProperty addr 0x2378d14 size 0x3ac virtual true final false
 ::bs_hook::Il2CppWrapperType GetMethodProperty(::StringW key) ;

/// @brief Method SetMethodProperty addr 0x2379600 size 0x26c virtual true final false
