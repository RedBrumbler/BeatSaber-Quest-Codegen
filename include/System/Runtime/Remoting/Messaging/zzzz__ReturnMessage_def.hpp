...
/// @brief Method .ctor addr 0x2364988 size 0x168 virtual false final false
...
/// @brief Method .ctor addr 0x2364840 size 0x148 virtual false final false
 void _ctor(System::Exception e, System::Runtime::Remoting::Messaging::IMethodCallMessage mcm) ;

/// @brief Method get_ArgCount addr 0x237eb34 size 0x1c virtual true final true
 int32_t get_ArgCount() ;

/// @brief Method get_Args addr 0x237eb50 size 0x8 virtual true final true
 ::ArrayW<::bs_hook::Il2CppWrapperType> get_Args() ;

/// @brief Method get_LogicalCallContext addr 0x237eb58 size 0x6c virtual true final true
 System::Runtime::Remoting::Messaging::LogicalCallContext get_LogicalCallContext() ;

/// @brief Method get_MethodBase addr 0x237ebc4 size 0x8 virtual true final true
 System::Reflection::MethodBase get_MethodBase() ;

/// @brief Method get_MethodName addr 0x237ebcc size 0x50 virtual true final true
 ::StringW get_MethodName() ;

/// @brief Method get_MethodSignature addr 0x237ec1c size 0x12c virtual true final true
 ::bs_hook::Il2CppWrapperType get_MethodSignature() ;

/// @brief Method get_Properties addr 0x237ed48 size 0x6c virtual true final false
 System::Collections::IDictionary get_Properties() ;

/// @brief Method get_TypeName addr 0x237edb4 size 0x64 virtual true final true
 ::StringW get_TypeName() ;

/// @brief Method get_Uri addr 0x237ee18 size 0x8 virtual true final true
 ::StringW get_Uri() ;

/// @brief Method set_Uri addr 0x237ee20 size 0x8 virtual false final false
 void set_Uri(::StringW value) ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.get_Uri addr 0x237ee28 size 0x8 virtual true final true
 ::StringW System_Runtime_Remoting_Messaging_IInternalMessage_get_Uri() ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.set_Uri addr 0x237ee30 size 0x8 virtual true final true
 void System_Runtime_Remoting_Messaging_IInternalMessage_set_Uri(::StringW value) ;

/// @brief Method GetArg addr 0x237ee38 size 0x30 virtual true final true
 ::bs_hook::Il2CppWrapperType GetArg(int32_t argNum) ;

/// @brief Method get_Exception addr 0x237ee68 size 0x8 virtual true final true
 System::Exception get_Exception() ;

/// @brief Method get_OutArgs addr 0x237ee70 size 0x98 virtual true final true
 ::ArrayW<::bs_hook::Il2CppWrapperType> get_OutArgs() ;

/// @brief Method get_ReturnValue addr 0x237ef08 size 0x8 virtual true final false
 ::bs_hook::Il2CppWrapperType get_ReturnValue() ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.get_TargetIdentity addr 0x237ef10 size 0x8 virtual true final true
 System::Runtime::Remoting::Identity System_Runtime_Remoting_Messaging_IInternalMessage_get_TargetIdentity() ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.set_TargetIdentity addr 0x237ef18 size 0x1008 virtual true final true
