...
struct CORDL_TYPE System__Runtime__Remoting__Messaging__LogicalCallContext__Reader : public ::bs_hook::ValueTypeWrapper {
public:
// Declarations
// Ctor Parameters [CppParam { name: "m_ctx", ty: "System::Runtime::Remoting::Messaging::LogicalCallContext", modifiers: "", def_value: None }]
constexpr System__Runtime__Remoting__Messaging__LogicalCallContext__Reader(System::Runtime::Remoting::Messaging::LogicalCallContext m_ctx) noexcept;


                    constexpr System__Runtime__Remoting__Messaging__LogicalCallContext__Reader(System__Runtime__Remoting__Messaging__LogicalCallContext__Reader const&) = default;
                    constexpr System__Runtime__Remoting__Messaging__LogicalCallContext__Reader(System__Runtime__Remoting__Messaging__LogicalCallContext__Reader&&) = default;
                    constexpr System__Runtime__Remoting__Messaging__LogicalCallContext__Reader& operator=(System__Runtime__Remoting__Messaging__LogicalCallContext__Reader const& o) {
                        __instance = o.__instance;
                        return *this;
                    };
                    constexpr System__Runtime__Remoting__Messaging__LogicalCallContext__Reader& operator=(System__Runtime__Remoting__Messaging__LogicalCallContext__Reader&& o) noexcept {
...
constexpr explicit System__Runtime__Remoting__Messaging__LogicalCallContext__Reader(std::array<std::byte, __CORDL_VALUE_TYPE_SIZE> instance) noexcept : ::bs_hook::ValueTypeWrapper(),__instance(std::move(instance)) {
}
...
/// @brief Method .ctor addr 0x237409c size 0x8 virtual false final false
 void _ctor(System::Runtime::Remoting::Messaging::LogicalCallContext ctx) ;

/// @brief Method get_IsNull addr 0x23740a4 size 0x10 virtual false final false
 bool get_IsNull() ;

/// @brief Method get_HasInfo addr 0x23740b4 size 0x10 virtual false final false
 bool get_HasInfo() ;

/// @brief Method Clone addr 0x23740c4 size 0x68 virtual false final false
 System::Runtime::Remoting::Messaging::LogicalCallContext Clone() ;

/// @brief Method GetData addr 0x2372dc8 size 0x10 virtual false final false
...
public:
// Declarations
using Reader = System::Runtime::Remoting::Messaging::System__Runtime__Remoting__Messaging__LogicalCallContext__Reader;
...
/// @brief Method .ctor addr 0x2373208 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2373210 size 0x2fc virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method GetObjectData addr 0x2373578 size 0x354 virtual true final true
 void GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method Clone addr 0x23738f8 size 0x5f8 virtual true final true
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method Merge addr 0x2364b50 size 0x230 virtual false final false
 void Merge(System::Runtime::Remoting::Messaging::LogicalCallContext lc) ;

/// @brief Method get_HasInfo addr 0x2364af0 size 0x60 virtual false final false
 bool get_HasInfo() ;

/// @brief Method get_HasUserData addr 0x23738cc size 0x2c virtual false final false
 bool get_HasUserData() ;

/// @brief Method get_Datastore addr 0x237350c size 0x6c virtual false final false
 System::Collections::Hashtable get_Datastore() ;

/// @brief Method GetData addr 0x2373fe0 size 0x2c virtual false final false
 ::bs_hook::Il2CppWrapperType GetData(::StringW name) ;

/// @brief Method SetData addr 0x2372e6c size 0x98 virtual false final false
...
DEFINE_IL2CPP_ARG_TYPE(System::Runtime::Remoting::Messaging::System__Runtime__Remoting__Messaging__LogicalCallContext__Reader, "System.Runtime.Remoting.Messaging", "LogicalCallContext/Reader");
