...
/// @brief Method InitMessage addr 0x237dcd0 size 0x294 virtual false final false
...
/// @brief Method .ctor addr 0x237df64 size 0xc8 virtual false final false
...
/// @brief Method .ctor addr 0x2363538 size 0x138 virtual false final false
...
/// @brief Method GetMethodInfo addr 0x237e02c size 0xb4 virtual false final false
...
/// @brief Method .ctor addr 0x237e0e0 size 0x38 virtual false final false
 void _ctor(System::Type type, ::StringW methodName, ::ArrayW<::bs_hook::Il2CppWrapperType> in_args) ;

/// @brief Method get_Properties addr 0x237e118 size 0x6c virtual true final true
 System::Collections::IDictionary get_Properties() ;

/// @brief Method get_ArgCount addr 0x237e184 size 0x38 virtual true final true
 int32_t get_ArgCount() ;

/// @brief Method get_Args addr 0x237e1bc size 0x8 virtual true final true
 ::ArrayW<::bs_hook::Il2CppWrapperType> get_Args() ;

/// @brief Method get_LogicalCallContext addr 0x237e1c4 size 0x8 virtual true final true
 System::Runtime::Remoting::Messaging::LogicalCallContext get_LogicalCallContext() ;

/// @brief Method set_LogicalCallContext addr 0x237e1cc size 0x8 virtual false final false
 void set_LogicalCallContext(System::Runtime::Remoting::Messaging::LogicalCallContext value) ;

/// @brief Method get_MethodBase addr 0x237e1d4 size 0x8 virtual true final true
 System::Reflection::MethodBase get_MethodBase() ;

/// @brief Method get_MethodName addr 0x237e1dc size 0x80 virtual true final true
 ::StringW get_MethodName() ;

/// @brief Method get_MethodSignature addr 0x237e25c size 0x11c virtual true final true
 ::bs_hook::Il2CppWrapperType get_MethodSignature() ;

/// @brief Method get_TypeName addr 0x237e378 size 0x94 virtual true final true
 ::StringW get_TypeName() ;

/// @brief Method get_Uri addr 0x237e40c size 0x8 virtual true final true
 ::StringW get_Uri() ;

/// @brief Method set_Uri addr 0x237e414 size 0x8 virtual true final true
 void set_Uri(::StringW value) ;

/// @brief Method GetArg addr 0x23657b8 size 0x34 virtual true final true
 ::bs_hook::Il2CppWrapperType GetArg(int32_t arg_num) ;

/// @brief Method get_Exception addr 0x237e41c size 0x8 virtual true final true
 System::Exception get_Exception() ;

/// @brief Method get_OutArgCount addr 0x237e424 size 0x6c virtual true final true
 int32_t get_OutArgCount() ;

/// @brief Method get_OutArgs addr 0x237e490 size 0x128 virtual true final true
 ::ArrayW<::bs_hook::Il2CppWrapperType> get_OutArgs() ;

/// @brief Method get_ReturnValue addr 0x237e5b8 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType get_ReturnValue() ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.get_TargetIdentity addr 0x237e5c0 size 0x8 virtual true final true
 System::Runtime::Remoting::Identity System_Runtime_Remoting_Messaging_IInternalMessage_get_TargetIdentity() ;

/// @brief Method System.Runtime.Remoting.Messaging.IInternalMessage.set_TargetIdentity addr 0x237e5c8 size 0x8 virtual true final true
 void System_Runtime_Remoting_Messaging_IInternalMessage_set_TargetIdentity(System::Runtime::Remoting::Identity value) ;

/// @brief Method get_AsyncResult addr 0x237e5d0 size 0x8 virtual false final false
 System::Runtime::Remoting::Messaging::AsyncResult get_AsyncResult() ;

/// @brief Method get_CallType addr 0x2364588 size 0x7c virtual false final false
 System::Runtime::Remoting::Messaging::CallType get_CallType() ;

/// @brief Method NeedsOutProcessing addr 0x2365728 size 0x90 virtual false final false
