...
/// @brief Method .ctor addr 0x2380144 size 0x28 virtual false final false
 void _ctor(System::Runtime::Remoting::Messaging::IMessageSink nextSink) ;

/// @brief Method SyncProcessMessage addr 0x238016c size 0x174 virtual true final true
 System::Runtime::Remoting::Messaging::IMessage SyncProcessMessage(System::Runtime::Remoting::Messaging::IMessage msg) ;

/// @brief Method AsyncProcessMessage addr 0x23802e0 size 0x1cc virtual true final true
