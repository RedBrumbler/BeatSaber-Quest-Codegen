...
/// @brief Method .ctor addr 0x236ff64 size 0x50 virtual false final false
 void _ctor() ;

/// @brief Method get_ArgCount addr 0x237a180 size 0x8 virtual true final true
 int32_t get_ArgCount() ;

/// @brief Method get_Args addr 0x237a188 size 0x8 virtual true final true
 ::ArrayW<::bs_hook::Il2CppWrapperType> get_Args() ;

/// @brief Method get_MethodBase addr 0x237a190 size 0x8 virtual true final true
 System::Reflection::MethodBase get_MethodBase() ;

/// @brief Method get_MethodName addr 0x237a198 size 0x40 virtual true final true
 ::StringW get_MethodName() ;

/// @brief Method get_MethodSignature addr 0x237a1d8 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType get_MethodSignature() ;

/// @brief Method get_Properties addr 0x237a1e0 size 0x8 virtual true final false
 System::Collections::IDictionary get_Properties() ;

/// @brief Method get_TypeName addr 0x237a1e8 size 0x40 virtual true final true
 ::StringW get_TypeName() ;

/// @brief Method get_Uri addr 0x237a228 size 0x8 virtual true final true
 ::StringW get_Uri() ;

/// @brief Method GetArg addr 0x237a230 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType GetArg(int32_t arg_num) ;

/// @brief Method get_LogicalCallContext addr 0x237a238 size 0x8 virtual true final true
