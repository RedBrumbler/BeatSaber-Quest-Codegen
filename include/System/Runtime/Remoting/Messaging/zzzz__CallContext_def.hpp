...
/// @brief Method .ctor addr 0x2372d24 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method SetCurrentCallContext addr 0x2372d2c size 0x8 virtual false final false
static ::bs_hook::Il2CppWrapperType SetCurrentCallContext(System::Runtime::Remoting::Messaging::LogicalCallContext ctx) ;

/// @brief Method SetLogicalCallContext addr 0x2372d34 size 0x44 virtual false final false
...
/// @brief Method LogicalGetData addr 0x2372d78 size 0x50 virtual false final false
static ::bs_hook::Il2CppWrapperType LogicalGetData(::StringW name) ;

/// @brief Method LogicalSetData addr 0x2372dd8 size 0x68 virtual false final false
