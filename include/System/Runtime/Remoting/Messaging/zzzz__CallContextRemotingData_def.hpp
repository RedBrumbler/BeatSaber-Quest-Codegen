...
/// @brief Method get_LogicalCallID addr 0x2374134 size 0x8 virtual false final false
 ::StringW get_LogicalCallID() ;

/// @brief Method set_LogicalCallID addr 0x237413c size 0x8 virtual false final false
 void set_LogicalCallID(::StringW value) ;

/// @brief Method get_HasInfo addr 0x2373fc0 size 0x10 virtual false final false
 bool get_HasInfo() ;

/// @brief Method Clone addr 0x2373ef0 size 0x68 virtual true final true
 ::bs_hook::Il2CppWrapperType Clone() ;

// Ctor Parameters []
explicit CallContextRemotingData() ;

/// @brief Method .ctor addr 0x2374144 size 0x8 virtual false final false
 void _ctor() ;
