...
/// @brief Method .ctor addr 0x2352ab0 size 0x128 virtual false final false
 void _ctor(::StringW typeName, ::StringW assemblyName) ;

/// @brief Method get_ObjectType addr 0x2352bd8 size 0x8 virtual false final false
 System::Type get_ObjectType() ;

/// @brief Method ToString addr 0x2352be0 size 0x10 virtual true final false
 ::StringW ToString() ;
