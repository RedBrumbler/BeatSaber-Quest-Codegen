...
/// @brief Method .ctor addr 0x2360738 size 0x30 virtual false final false
 void _ctor(::StringW objectUri, System::Runtime::Remoting::Contexts::Context context, System::Type objectType) ;

/// @brief Method GetServerObject addr 0x2360768 size 0x1f0 virtual false final false
 System::MarshalByRefObject GetServerObject() ;

/// @brief Method SyncObjectProcessMessage addr 0x2360960 size 0xd0 virtual true final false
 System::Runtime::Remoting::Messaging::IMessage SyncObjectProcessMessage(System::Runtime::Remoting::Messaging::IMessage msg) ;

/// @brief Method AsyncObjectProcessMessage addr 0x2360a30 size 0xe4 virtual true final false
