...
/// @brief Method .ctor addr 0x23898c4 size 0x48 virtual false final false
 void _ctor(System::Runtime::Serialization::ObjectHolderList list, bool isFixupEnumerator) ;

/// @brief Method MoveNext addr 0x23887a8 size 0xbc virtual false final false
 bool MoveNext() ;

/// @brief Method get_Current addr 0x2388750 size 0x3c virtual false final false
