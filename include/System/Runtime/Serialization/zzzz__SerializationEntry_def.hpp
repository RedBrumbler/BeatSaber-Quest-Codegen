...
/// @brief Method .ctor addr 0x23810b8 size 0xc virtual false final false
 void _ctor(::StringW entryName, ::bs_hook::Il2CppWrapperType entryValue, System::Type entryType) ;

/// @brief Method get_Value addr 0x23810c4 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_Value() ;

/// @brief Method get_Name addr 0x23810cc size 0x8 virtual false final false
 ::StringW get_Name() ;
