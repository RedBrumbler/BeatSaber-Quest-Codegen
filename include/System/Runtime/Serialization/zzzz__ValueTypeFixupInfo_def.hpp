...
/// @brief Method .ctor addr 0x238275c size 0x150 virtual false final false
 void _ctor(int64_t containerID, System::Reflection::FieldInfo member, ::ArrayW<int32_t> parentIndex) ;

/// @brief Method get_ContainerID addr 0x23828ac size 0x8 virtual false final false
 int64_t get_ContainerID() ;

/// @brief Method get_ParentField addr 0x23828b4 size 0x8 virtual false final false
 System::Reflection::FieldInfo get_ParentField() ;

/// @brief Method get_ParentIndex addr 0x23828bc size 0x8 virtual false final false
