...
/// @brief Method .ctor addr 0x23859e0 size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x2387f28 size 0x1dc virtual false final false
...
/// @brief Method .ctor addr 0x2387888 size 0xe4 virtual false final false
...
/// @brief Method IncrementDescendentFixups addr 0x2389284 size 0x10 virtual false final false
 void IncrementDescendentFixups(int32_t amount) ;

/// @brief Method DecrementFixupsRemaining addr 0x23875c0 size 0x24 virtual false final false
 void DecrementFixupsRemaining(System::Runtime::Serialization::ObjectManager manager) ;

/// @brief Method RemoveDependency addr 0x23875e4 size 0x18 virtual false final false
 void RemoveDependency(int64_t id) ;

/// @brief Method AddFixup addr 0x2388944 size 0xbc virtual false final false
 void AddFixup(System::Runtime::Serialization::FixupHolder fixup, System::Runtime::Serialization::ObjectManager manager) ;

/// @brief Method UpdateDescendentDependencyChain addr 0x2389294 size 0x60 virtual false final false
 void UpdateDescendentDependencyChain(int32_t amount, System::Runtime::Serialization::ObjectManager manager) ;

/// @brief Method AddDependency addr 0x2388a00 size 0x74 virtual false final false
 void AddDependency(int64_t dependentObject) ;

/// @brief Method UpdateData addr 0x2388114 size 0x190 virtual false final false
...
/// @brief Method MarkForCompletionWhenAvailable addr 0x2387660 size 0xc virtual false final false
 void MarkForCompletionWhenAvailable() ;

/// @brief Method SetFlags addr 0x238622c size 0xb8 virtual false final false
 void SetFlags() ;

/// @brief Method get_IsIncompleteObjectReference addr 0x2385e3c size 0xc virtual false final false
 bool get_IsIncompleteObjectReference() ;

/// @brief Method set_IsIncompleteObjectReference addr 0x2386e94 size 0x1c virtual false final false
 void set_IsIncompleteObjectReference(bool value) ;

/// @brief Method get_RequiresDelayedFixup addr 0x2388104 size 0x10 virtual false final false
 bool get_RequiresDelayedFixup() ;

/// @brief Method get_RequiresValueTypeFixup addr 0x2386590 size 0xc virtual false final false
 bool get_RequiresValueTypeFixup() ;

/// @brief Method get_ValueTypeFixupPerformed addr 0x238659c size 0x38 virtual false final false
 bool get_ValueTypeFixupPerformed() ;

/// @brief Method set_ValueTypeFixupPerformed addr 0x238760c size 0x14 virtual false final false
 void set_ValueTypeFixupPerformed(bool value) ;

/// @brief Method get_HasISerializable addr 0x23874d0 size 0xc virtual false final false
 bool get_HasISerializable() ;

/// @brief Method get_HasSurrogate addr 0x2386080 size 0xc virtual false final false
 bool get_HasSurrogate() ;

/// @brief Method get_CanSurrogatedObjectValueChange addr 0x238608c size 0xa8 virtual false final false
 bool get_CanSurrogatedObjectValueChange() ;

/// @brief Method get_CanObjectValueChange addr 0x2385e1c size 0x20 virtual false final false
 bool get_CanObjectValueChange() ;

/// @brief Method get_DirectlyDependentObjects addr 0x238942c size 0x8 virtual false final false
 int32_t get_DirectlyDependentObjects() ;

/// @brief Method get_TotalDependentObjects addr 0x23882a4 size 0xc virtual false final false
 int32_t get_TotalDependentObjects() ;

/// @brief Method get_Reachable addr 0x2389434 size 0x8 virtual false final false
 bool get_Reachable() ;

/// @brief Method set_Reachable addr 0x238943c size 0xc virtual false final false
 void set_Reachable(bool value) ;

/// @brief Method get_TypeLoadExceptionReachable addr 0x23875fc size 0x10 virtual false final false
 bool get_TypeLoadExceptionReachable() ;

/// @brief Method get_TypeLoadException addr 0x2389448 size 0x8 virtual false final false
 System::Runtime::Serialization::TypeLoadExceptionHolder get_TypeLoadException() ;

/// @brief Method set_TypeLoadException addr 0x2389450 size 0x8 virtual false final false
 void set_TypeLoadException(System::Runtime::Serialization::TypeLoadExceptionHolder value) ;

/// @brief Method get_ObjectValue addr 0x2389458 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_ObjectValue() ;

/// @brief Method SetObjectValue addr 0x2386134 size 0xf8 virtual false final false
 void SetObjectValue(::bs_hook::Il2CppWrapperType obj, System::Runtime::Serialization::ObjectManager manager) ;

/// @brief Method get_SerializationInfo addr 0x2389460 size 0x8 virtual false final false
 System::Runtime::Serialization::SerializationInfo get_SerializationInfo() ;

/// @brief Method set_SerializationInfo addr 0x2389468 size 0x8 virtual false final false
 void set_SerializationInfo(System::Runtime::Serialization::SerializationInfo value) ;

/// @brief Method get_Surrogate addr 0x2389470 size 0x8 virtual false final false
 System::Runtime::Serialization::ISerializationSurrogate get_Surrogate() ;

/// @brief Method get_DependentObjects addr 0x2389478 size 0x8 virtual false final false
 System::Runtime::Serialization::LongList get_DependentObjects() ;

/// @brief Method set_DependentObjects addr 0x2389480 size 0x8 virtual false final false
 void set_DependentObjects(System::Runtime::Serialization::LongList value) ;

/// @brief Method get_RequiresSerInfoFixup addr 0x238878c size 0x1c virtual false final false
 bool get_RequiresSerInfoFixup() ;

/// @brief Method set_RequiresSerInfoFixup addr 0x2386574 size 0x1c virtual false final false
 void set_RequiresSerInfoFixup(bool value) ;

/// @brief Method get_ValueFixup addr 0x2389488 size 0x8 virtual false final false
 System::Runtime::Serialization::ValueTypeFixupInfo get_ValueFixup() ;

/// @brief Method get_CompletelyFixed addr 0x2385df8 size 0x24 virtual false final false
 bool get_CompletelyFixed() ;

/// @brief Method get_ContainerID addr 0x238938c size 0x18 virtual false final false
