...
/// @brief Method .ctor addr 0x2381a38 size 0x3c virtual false final false
 void _ctor(System::Type type, System::Runtime::Serialization::StreamingContext ctx) ;

/// @brief Method GetHashCode addr 0x2381a74 size 0x20 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2381a94 size 0x8c virtual true final false
