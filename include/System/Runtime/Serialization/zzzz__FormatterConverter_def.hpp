...
/// @brief Method Convert addr 0x2381648 size 0xa0 virtual true final true
 ::bs_hook::Il2CppWrapperType Convert(::bs_hook::Il2CppWrapperType value, System::Type type) ;

/// @brief Method ToBoolean addr 0x2381738 size 0x98 virtual true final true
 bool ToBoolean(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method ToInt32 addr 0x23817d0 size 0x98 virtual true final true
 int32_t ToInt32(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method ToInt64 addr 0x2381868 size 0x98 virtual true final true
 int64_t ToInt64(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method ToSingle addr 0x2381900 size 0x98 virtual true final true
 float_t ToSingle(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method ToString addr 0x2381998 size 0x98 virtual true final true
 ::StringW ToString(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method ThrowValueNullException addr 0x23816e8 size 0x50 virtual false final false
static void ThrowValueNullException() ;

// Ctor Parameters []
explicit FormatterConverter() ;

/// @brief Method .ctor addr 0x2381a30 size 0x8 virtual false final false
 void _ctor() ;
