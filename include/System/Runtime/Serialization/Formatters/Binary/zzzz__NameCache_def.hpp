...
/// @brief Method GetCachedValue addr 0x239ac40 size 0xa8 virtual false final false
 ::bs_hook::Il2CppWrapperType GetCachedValue(::StringW name) ;

/// @brief Method SetCachedValue addr 0x239b0e8 size 0x90 virtual false final false
 void SetCachedValue(::bs_hook::Il2CppWrapperType value) ;

// Ctor Parameters []
explicit NameCache() ;

/// @brief Method .ctor addr 0x239717c size 0x8 virtual false final false
 void _ctor() ;
