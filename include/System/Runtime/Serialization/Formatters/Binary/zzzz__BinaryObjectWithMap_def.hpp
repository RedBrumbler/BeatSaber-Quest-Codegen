...
/// @brief Method .ctor addr 0x238f0d4 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x238f0dc size 0x28 virtual false final false
 void _ctor(System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum) ;

/// @brief Method Set addr 0x238f104 size 0x24 virtual false final false
 void Set(int32_t objectId, ::StringW name, int32_t numMembers, ::ArrayW<::StringW> memberNames, int32_t assemId) ;

/// @brief Method Write addr 0x238f128 size 0x114 virtual true final true
 void Write(System::Runtime::Serialization::Formatters::Binary::__BinaryWriter sout) ;

/// @brief Method Read addr 0x238f23c size 0x13c virtual true final true
 void Read(System::Runtime::Serialization::Formatters::Binary::__BinaryParser input) ;

/// @brief Method Dump addr 0x238f378 size 0x4 virtual false final false
 void Dump() ;
