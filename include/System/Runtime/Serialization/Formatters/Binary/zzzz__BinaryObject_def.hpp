...
/// @brief Method .ctor addr 0x238ea9c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Set addr 0x238eaa4 size 0x8 virtual false final false
 void Set(int32_t objectId, int32_t mapId) ;

/// @brief Method Write addr 0x238eaac size 0x70 virtual true final true
 void Write(System::Runtime::Serialization::Formatters::Binary::__BinaryWriter sout) ;

/// @brief Method Read addr 0x238eb1c size 0x44 virtual true final true
 void Read(System::Runtime::Serialization::Formatters::Binary::__BinaryParser input) ;

/// @brief Method Dump addr 0x238eb60 size 0x4 virtual false final false
 void Dump() ;
