...
/// @brief Method .ctor addr 0x239d9f8 size 0x10c virtual false final false
 void _ctor(System::IO::Stream stream, System::Runtime::Serialization::Formatters::Binary::ObjectReader objectReader) ;

/// @brief Method get_SystemAssemblyInfo addr 0x239db04 size 0xac virtual false final false
 System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo get_SystemAssemblyInfo() ;

/// @brief Method get_ObjectMapIdTable addr 0x239dbb0 size 0x68 virtual false final false
 System::Runtime::Serialization::Formatters::Binary::SizedArray get_ObjectMapIdTable() ;

/// @brief Method get_AssemIdToAssemblyTable addr 0x239dc84 size 0x6c virtual false final false
 System::Runtime::Serialization::Formatters::Binary::SizedArray get_AssemIdToAssemblyTable() ;

/// @brief Method get_prs addr 0x239dd68 size 0x6c virtual false final false
 System::Runtime::Serialization::Formatters::Binary::ParseRecord get_prs() ;

/// @brief Method Run addr 0x2397494 size 0x5d4 virtual false final false
 void Run() ;

/// @brief Method ReadBegin addr 0x239dddc size 0x4 virtual false final false
 void ReadBegin() ;

/// @brief Method ReadEnd addr 0x239fb60 size 0x4 virtual false final false
 void ReadEnd() ;

/// @brief Method ReadBoolean addr 0x239feec size 0x20 virtual false final false
 bool ReadBoolean() ;

/// @brief Method ReadByte addr 0x239ff0c size 0x20 virtual false final false
 uint8_t ReadByte() ;

/// @brief Method ReadBytes addr 0x239ff2c size 0x24 virtual false final false
 ::ArrayW<uint8_t> ReadBytes(int32_t length) ;

/// @brief Method ReadBytes addr 0x239ff50 size 0x7c virtual false final false
 void ReadBytes(::ArrayW<uint8_t> byteA, int32_t offset, int32_t size) ;

/// @brief Method ReadChar addr 0x239ffcc size 0x20 virtual false final false
 char16_t ReadChar() ;

/// @brief Method ReadChars addr 0x239ffec size 0x24 virtual false final false
 ::ArrayW<char16_t> ReadChars(int32_t length) ;

/// @brief Method ReadDecimal addr 0x23a0010 size 0xb4 virtual false final false
 System::Decimal ReadDecimal() ;

/// @brief Method ReadSingle addr 0x23a00c4 size 0x24 virtual false final false
 float_t ReadSingle() ;

/// @brief Method ReadDouble addr 0x23a00e8 size 0x24 virtual false final false
 double_t ReadDouble() ;

/// @brief Method ReadInt16 addr 0x23a010c size 0x24 virtual false final false
 int16_t ReadInt16() ;

/// @brief Method ReadInt32 addr 0x23a0130 size 0x24 virtual false final false
 int32_t ReadInt32() ;

/// @brief Method ReadInt64 addr 0x23a0154 size 0x24 virtual false final false
 int64_t ReadInt64() ;

/// @brief Method ReadSByte addr 0x23a0178 size 0x20 virtual false final false
 int8_t ReadSByte() ;

/// @brief Method ReadString addr 0x23a0198 size 0x24 virtual false final false
 ::StringW ReadString() ;

/// @brief Method ReadTimeSpan addr 0x23a01bc size 0x24 virtual false final false
 System::TimeSpan ReadTimeSpan() ;

/// @brief Method ReadDateTime addr 0x23a01e0 size 0x7c virtual false final false
 System::DateTime ReadDateTime() ;

/// @brief Method ReadUInt16 addr 0x23a025c size 0x24 virtual false final false
 uint16_t ReadUInt16() ;

/// @brief Method ReadUInt32 addr 0x23a0280 size 0x24 virtual false final false
 uint32_t ReadUInt32() ;

/// @brief Method ReadUInt64 addr 0x23a02a4 size 0x24 virtual false final false
 uint64_t ReadUInt64() ;

/// @brief Method ReadSerializationHeaderRecord addr 0x239dde0 size 0xc0 virtual false final false
 void ReadSerializationHeaderRecord() ;

/// @brief Method ReadAssembly addr 0x239dea0 size 0x274 virtual false final false
 void ReadAssembly(System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum) ;

/// @brief Method ReadObject addr 0x239e114 size 0x358 virtual false final false
 void ReadObject() ;

/// @brief Method ReadCrossAppDomainMap addr 0x239e46c size 0x1cc virtual false final false
 void ReadCrossAppDomainMap() ;

/// @brief Method ReadObjectWithMap addr 0x239e638 size 0xa0 virtual false final false
 void ReadObjectWithMap(System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum) ;

/// @brief Method ReadObjectWithMap addr 0x23a0528 size 0x40c virtual false final false
 void ReadObjectWithMap(System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMap record) ;

/// @brief Method ReadObjectWithMapTyped addr 0x239e6d8 size 0x90 virtual false final false
 void ReadObjectWithMapTyped(System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum) ;

/// @brief Method ReadObjectWithMapTyped addr 0x23a0934 size 0x42c virtual false final false
 void ReadObjectWithMapTyped(System::Runtime::Serialization::Formatters::Binary::BinaryObjectWithMapTyped record) ;

/// @brief Method ReadObjectString addr 0x239e768 size 0x584 virtual false final false
 void ReadObjectString(System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum) ;

/// @brief Method ReadMemberPrimitiveTyped addr 0x239f288 size 0x384 virtual false final false
 void ReadMemberPrimitiveTyped() ;

/// @brief Method ReadArray addr 0x239ecec size 0x59c virtual false final false
 void ReadArray(System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum) ;

/// @brief Method ReadArrayAsBytes addr 0x23a0d60 size 0x338 virtual false final false
 void ReadArrayAsBytes(System::Runtime::Serialization::Formatters::Binary::ParseRecord pr) ;

/// @brief Method ReadMemberPrimitiveUnTyped addr 0x239fb64 size 0x2a8 virtual false final false
 void ReadMemberPrimitiveUnTyped() ;

/// @brief Method ReadMemberReference addr 0x239f60c size 0x1e8 virtual false final false
 void ReadMemberReference() ;

/// @brief Method ReadObjectNull addr 0x239f7f4 size 0x1f4 virtual false final false
 void ReadObjectNull(System::Runtime::Serialization::Formatters::Binary::BinaryHeaderEnum binaryHeaderEnum) ;

/// @brief Method ReadMessageEnd addr 0x239f9e8 size 0x178 virtual false final false
 void ReadMessageEnd() ;

/// @brief Method ReadValue addr 0x23a1098 size 0x420 virtual false final false
 ::bs_hook::Il2CppWrapperType ReadValue(System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code) ;

/// @brief Method GetOp addr 0x23a043c size 0xa8 virtual false final false
 System::Runtime::Serialization::Formatters::Binary::ObjectProgress GetOp() ;

/// @brief Method PutOp addr 0x239fe64 size 0x88 virtual false final false
