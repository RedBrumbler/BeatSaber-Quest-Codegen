...
/// @brief Method FlagTest addr 0x238dd0c size 0xc virtual false final false
...
/// @brief Method WriteStringWithCode addr 0x238dd18 size 0x74 virtual false final false
static void WriteStringWithCode(::StringW value, System::Runtime::Serialization::Formatters::Binary::__BinaryWriter sout) ;

/// @brief Method WriteWithCode addr 0x238dd8c size 0x12c virtual false final false
