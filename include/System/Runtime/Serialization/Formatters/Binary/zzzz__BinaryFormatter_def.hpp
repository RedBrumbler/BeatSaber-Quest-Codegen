...
/// @brief Method set_AssemblyFormat addr 0x2392988 size 0x8 virtual false final false
 void set_AssemblyFormat(System::Runtime::Serialization::Formatters::FormatterAssemblyStyle value) ;

/// @brief Method set_SurrogateSelector addr 0x2392990 size 0x8 virtual true final true
 void set_SurrogateSelector(System::Runtime::Serialization::ISurrogateSelector value) ;

/// @brief Method set_Binder addr 0x2392998 size 0x8 virtual true final true
 void set_Binder(System::Runtime::Serialization::SerializationBinder value) ;

// Ctor Parameters []
explicit BinaryFormatter() ;

/// @brief Method .ctor addr 0x23929a0 size 0x34 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x23929d4 size 0x4c virtual false final false
...
/// @brief Method Deserialize addr 0x2392a20 size 0xc virtual true final true
 ::bs_hook::Il2CppWrapperType Deserialize(System::IO::Stream serializationStream) ;

/// @brief Method Deserialize addr 0x2392a34 size 0x24c virtual false final false
...
/// @brief Method Deserialize addr 0x2392a2c size 0x8 virtual true final true
...
/// @brief Method Serialize addr 0x2392c80 size 0xc virtual true final true
 void Serialize(System::IO::Stream serializationStream, ::bs_hook::Il2CppWrapperType graph) ;

/// @brief Method Serialize addr 0x2392c8c size 0x8 virtual true final true
...
/// @brief Method Serialize addr 0x2392c94 size 0x1f8 virtual false final false
...
/// @brief Method GetTypeInformation addr 0x2392f44 size 0x25c virtual false final false
