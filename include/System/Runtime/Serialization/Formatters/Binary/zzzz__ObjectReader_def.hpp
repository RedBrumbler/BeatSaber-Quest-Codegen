...
/// @brief Method .ctor addr 0x239b0e0 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x239b178 size 0x28 virtual false final false
 void _ctor(System::Reflection::Assembly topLevelAssembly) ;

/// @brief Method ResolveType addr 0x239b354 size 0x68 virtual false final false
...
/// @brief Method get_ValueFixupStack addr 0x2396fcc size 0x80 virtual false final false
 System::Runtime::Serialization::Formatters::Binary::SerStack get_ValueFixupStack() ;

/// @brief Method get_TopObject addr 0x239704c size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_TopObject() ;

/// @brief Method set_TopObject addr 0x2397054 size 0x14 virtual false final false
...
/// @brief Method .ctor addr 0x2397068 size 0x114 virtual false final false
...
/// @brief Method Deserialize addr 0x2397184 size 0x310 virtual false final false
...
/// @brief Method HasSurrogate addr 0x2397a68 size 0xd4 virtual false final false
 bool HasSurrogate(System::Type t) ;

/// @brief Method CheckSerializable addr 0x2397b3c size 0x138 virtual false final false
 void CheckSerializable(System::Type t) ;

/// @brief Method InitFullDeserialization addr 0x2397c74 size 0x110 virtual false final false
 void InitFullDeserialization() ;

/// @brief Method CrossAppDomainArray addr 0x2397d84 size 0x30 virtual false final false
 ::bs_hook::Il2CppWrapperType CrossAppDomainArray(int32_t index) ;

/// @brief Method CreateReadObjectInfo addr 0x2397db4 size 0x34 virtual false final false
 System::Runtime::Serialization::Formatters::Binary::ReadObjectInfo CreateReadObjectInfo(System::Type objectType) ;

/// @brief Method CreateReadObjectInfo addr 0x2397de8 size 0x44 virtual false final false
...
/// @brief Method Parse addr 0x2397e2c size 0x144 virtual false final false
 void Parse(System::Runtime::Serialization::Formatters::Binary::ParseRecord pr) ;

/// @brief Method ParseError addr 0x2398a78 size 0x2d8 virtual false final false
...
/// @brief Method ParseSerializedStreamHeader addr 0x2397f70 size 0x18 virtual false final false
 void ParseSerializedStreamHeader(System::Runtime::Serialization::Formatters::Binary::ParseRecord pr) ;

/// @brief Method ParseSerializedStreamHeaderEnd addr 0x2397f88 size 0x18 virtual false final false
 void ParseSerializedStreamHeaderEnd(System::Runtime::Serialization::Formatters::Binary::ParseRecord pr) ;

/// @brief Method ParseObject addr 0x2397fa0 size 0x314 virtual false final false
 void ParseObject(System::Runtime::Serialization::Formatters::Binary::ParseRecord pr) ;

/// @brief Method ParseObjectEnd addr 0x23982b4 size 0x230 virtual false final false
 void ParseObjectEnd(System::Runtime::Serialization::Formatters::Binary::ParseRecord pr) ;

/// @brief Method ParseArray addr 0x2398e4c size 0x68c virtual false final false
 void ParseArray(System::Runtime::Serialization::Formatters::Binary::ParseRecord pr) ;

/// @brief Method NextRectangleMap addr 0x2399868 size 0xc4 virtual false final false
 void NextRectangleMap(System::Runtime::Serialization::Formatters::Binary::ParseRecord pr) ;

/// @brief Method ParseArrayMember addr 0x239992c size 0x79c virtual false final false
 void ParseArrayMember(System::Runtime::Serialization::Formatters::Binary::ParseRecord pr) ;

/// @brief Method ParseArrayMemberEnd addr 0x239a4f8 size 0x28 virtual false final false
 void ParseArrayMemberEnd(System::Runtime::Serialization::Formatters::Binary::ParseRecord pr) ;

/// @brief Method ParseMember addr 0x23984e4 size 0x4d8 virtual false final false
 void ParseMember(System::Runtime::Serialization::Formatters::Binary::ParseRecord pr) ;

/// @brief Method ParseMemberEnd addr 0x23989bc size 0xbc virtual false final false
 void ParseMemberEnd(System::Runtime::Serialization::Formatters::Binary::ParseRecord pr) ;

/// @brief Method ParseString addr 0x239a0fc size 0x40 virtual false final false
...
/// @brief Method RegisterObject addr 0x2399518 size 0x8 virtual false final false
...
/// @brief Method RegisterObject addr 0x239a564 size 0x124 virtual false final false
...
/// @brief Method GetId addr 0x239a688 size 0xdc virtual false final false
 int64_t GetId(int64_t objectId) ;

/// @brief Method Bind addr 0x239a8f8 size 0x58 virtual false final false
 System::Type Bind(::StringW assemblyString, ::StringW typeString) ;

/// @brief Method FastBindToType addr 0x239a950 size 0x2f0 virtual false final false
 System::Type FastBindToType(::StringW assemblyName, ::StringW typeName) ;

/// @brief Method ResolveSimpleAssemblyName addr 0x239ace8 size 0x60 virtual false final false
static System::Reflection::Assembly ResolveSimpleAssemblyName(System::Reflection::AssemblyName assemblyName) ;

/// @brief Method GetSimplyNamedTypeFromAssembly addr 0x239ad48 size 0x254 virtual false final false
static void GetSimplyNamedTypeFromAssembly(System::Reflection::Assembly assm, ::StringW typeName, ByRef<System::Type> type) ;

/// @brief Method GetType addr 0x239b1a0 size 0x1b4 virtual false final false
 System::Type GetType(System::Runtime::Serialization::Formatters::Binary::BinaryAssemblyInfo assemblyInfo, ::StringW name) ;

/// @brief Method CheckTypeForwardedTo addr 0x239af9c size 0x144 virtual false final false
