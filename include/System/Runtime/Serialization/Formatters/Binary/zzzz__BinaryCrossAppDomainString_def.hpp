...
/// @brief Method .ctor addr 0x238ef90 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Read addr 0x238ef98 size 0x44 virtual true final true
 void Read(System::Runtime::Serialization::Formatters::Binary::__BinaryParser input) ;

/// @brief Method Dump addr 0x238efdc size 0x4 virtual false final false
 void Dump() ;
