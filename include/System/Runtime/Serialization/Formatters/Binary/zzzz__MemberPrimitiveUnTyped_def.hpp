...
/// @brief Method .ctor addr 0x238feb0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Set addr 0x238feb8 size 0xc virtual false final false
...
/// @brief Method Set addr 0x238fec4 size 0x8 virtual false final false
 void Set(System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE typeInformation) ;

/// @brief Method Write addr 0x238fecc size 0x24 virtual true final true
 void Write(System::Runtime::Serialization::Formatters::Binary::__BinaryWriter sout) ;

/// @brief Method Read addr 0x238fef0 size 0x30 virtual true final true
 void Read(System::Runtime::Serialization::Formatters::Binary::__BinaryParser input) ;

/// @brief Method Dump addr 0x238ff20 size 0x4 virtual false final false
 void Dump() ;
