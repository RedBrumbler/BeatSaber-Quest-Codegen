...
/// @brief Method Write addr 0x238eb64 size 0x148 virtual false final false
 void Write(System::Runtime::Serialization::Formatters::Binary::__BinaryWriter sout) ;

/// @brief Method Dump addr 0x238ecac size 0x4 virtual false final false
 void Dump() ;

// Ctor Parameters []
explicit BinaryMethodCall() ;

/// @brief Method .ctor addr 0x238ecb0 size 0x10 virtual false final false
 void _ctor() ;
