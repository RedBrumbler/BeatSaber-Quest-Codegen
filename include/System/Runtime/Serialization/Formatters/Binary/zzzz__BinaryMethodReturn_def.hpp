...
/// @brief Method .ctor addr 0x238ed68 size 0x10 virtual false final false
 void _ctor() ;

/// @brief Method Write addr 0x238ed78 size 0x148 virtual true final true
 void Write(System::Runtime::Serialization::Formatters::Binary::__BinaryWriter sout) ;

/// @brief Method Dump addr 0x238eec0 size 0x4 virtual false final false
 void Dump() ;
