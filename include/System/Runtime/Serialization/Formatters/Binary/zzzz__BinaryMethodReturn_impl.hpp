...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::*)()>(&System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x238ed68;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::*)()>(&System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::Dump)> {
  ...
  constexpr static std::size_t addrs = 0x238eec0;
...
constexpr void System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::__set_returnValue(::bs_hook::Il2CppWrapperType value)  {
...
constexpr ::bs_hook::Il2CppWrapperType System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::__get_returnValue() const {
return ::cordl_internals::getInstanceField<::bs_hook::Il2CppWrapperType, 0x10>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::__set_args(::ArrayW<::bs_hook::Il2CppWrapperType> value)  {
...
constexpr ::ArrayW<::bs_hook::Il2CppWrapperType> System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::__get_args() const {
return ::cordl_internals::getInstanceField<::ArrayW<::bs_hook::Il2CppWrapperType>, 0x18>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::__set_callContext(::bs_hook::Il2CppWrapperType value)  {
...
constexpr ::bs_hook::Il2CppWrapperType System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::__get_callContext() const {
return ::cordl_internals::getInstanceField<::bs_hook::Il2CppWrapperType, 0x20>(this->::bs_hook::Il2CppWrapperType::instance);
}
constexpr void System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::__set_argTypes(::ArrayW<System::Type> value)  {
::cordl_internals::setInstanceField<::ArrayW<System::Type>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<::ArrayW<System::Type>>(value));
}
constexpr ::ArrayW<System::Type> System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::__get_argTypes() const {
return ::cordl_internals::getInstanceField<::ArrayW<System::Type>, 0x28>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr bool System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::__get_bArgsPrimitive() const {
...
::cordl_internals::setInstanceField<System::Runtime::Serialization::Formatters::Binary::MessageEnum, 0x34>(this->::bs_hook::Il2CppWrapperType::instance, std::forward<System::Runtime::Serialization::Formatters::Binary::MessageEnum>(value));
}
constexpr System::Runtime::Serialization::Formatters::Binary::MessageEnum System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::__get_messageEnum() const {
return ::cordl_internals::getInstanceField<System::Runtime::Serialization::Formatters::Binary::MessageEnum, 0x34>(this->::bs_hook::Il2CppWrapperType::instance);
}
...
constexpr System::Type System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::__get_returnType() const {
return ::cordl_internals::getInstanceField<System::Type, 0x38>(this->::bs_hook::Il2CppWrapperType::instance);
}
 void System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::__set_instanceOfVoid(::bs_hook::Il2CppWrapperType value)  {
::cordl_internals::setStaticField<::bs_hook::Il2CppWrapperType, "instanceOfVoid", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn>::get>(std::forward<::bs_hook::Il2CppWrapperType>(value));
}
 ::bs_hook::Il2CppWrapperType System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::__get_instanceOfVoid()  {
return ::cordl_internals::getStaticField<::bs_hook::Il2CppWrapperType, "instanceOfVoid", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn>::get>();
}
// Ctor Parameters []
 System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::BinaryMethodReturn()  : ::bs_hook::Il2CppWrapperType(THROW_UNLESS(::il2cpp_utils::New<BinaryMethodReturn>())) {}
 void System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn::_ctor()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<System::Runtime::Serialization::Formatters::Binary::BinaryMethodReturn>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
