...
/// @brief Method .ctor addr 0x239a764 size 0x68 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x23a1940 size 0xdc virtual false final false
 void _ctor(System::Runtime::Serialization::Formatters::Binary::IntSizedArray sizedArray) ;

/// @brief Method Clone addr 0x23a1a1c size 0x60 virtual true final true
 ::bs_hook::Il2CppWrapperType Clone() ;

/// @brief Method get_Item addr 0x239a7cc size 0x78 virtual false final false
 int32_t get_Item(int32_t index) ;

/// @brief Method set_Item addr 0x239a844 size 0xb4 virtual false final false
 void set_Item(int32_t index, int32_t value) ;

/// @brief Method IncreaseCapacity addr 0x23a1a7c size 0x220 virtual false final false
