...
/// @brief Method .ctor addr 0x238efe0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Read addr 0x238efe8 size 0x28 virtual true final true
 void Read(System::Runtime::Serialization::Formatters::Binary::__BinaryParser input) ;

/// @brief Method Dump addr 0x238f010 size 0x4 virtual false final false
 void Dump() ;
