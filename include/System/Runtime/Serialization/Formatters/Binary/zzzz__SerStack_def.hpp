...
/// @brief Method .ctor addr 0x2396e3c size 0x74 virtual false final false
 void _ctor(::StringW stackId) ;

/// @brief Method Push addr 0x2398d50 size 0xac virtual false final false
 void Push(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Pop addr 0x2398dfc size 0x50 virtual false final false
 ::bs_hook::Il2CppWrapperType Pop() ;

/// @brief Method IncreaseCapacity addr 0x23a1584 size 0x88 virtual false final false
 void IncreaseCapacity() ;

/// @brief Method Peek addr 0x23994d8 size 0x40 virtual false final false
 ::bs_hook::Il2CppWrapperType Peek() ;

/// @brief Method PeekPeek addr 0x23a04e4 size 0x44 virtual false final false
 ::bs_hook::Il2CppWrapperType PeekPeek() ;

/// @brief Method IsEmpty addr 0x239d9e0 size 0x10 virtual false final false
 bool IsEmpty() ;
