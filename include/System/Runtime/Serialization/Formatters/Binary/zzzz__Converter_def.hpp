...
/// @brief Method ToCode addr 0x238d26c size 0x124 virtual false final false
static System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE ToCode(System::Type type) ;

/// @brief Method IsWriteAsByteArray addr 0x2390fd8 size 0x24 virtual false final false
static bool IsWriteAsByteArray(System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code) ;

/// @brief Method TypeLength addr 0x2390ffc size 0x24 virtual false final false
static int32_t TypeLength(System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code) ;

/// @brief Method ToArrayType addr 0x238dc54 size 0xb8 virtual false final false
static System::Type ToArrayType(System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code) ;

/// @brief Method InitTypeA addr 0x23913d8 size 0x3b8 virtual false final false
static void InitTypeA() ;

/// @brief Method InitArrayTypeA addr 0x2391020 size 0x3b8 virtual false final false
static void InitArrayTypeA() ;

/// @brief Method ToType addr 0x238db9c size 0xb8 virtual false final false
static System::Type ToType(System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code) ;

/// @brief Method CreatePrimitiveArray addr 0x2391790 size 0x120 virtual false final false
...
/// @brief Method IsPrimitiveArray addr 0x238cdbc size 0x290 virtual false final false
static bool IsPrimitiveArray(System::Type type, ByRef<::bs_hook::Il2CppWrapperType> typeInformation) ;

/// @brief Method InitValueA addr 0x23918b0 size 0x46c virtual false final false
static void InitValueA() ;

/// @brief Method ToComType addr 0x238dae4 size 0xb8 virtual false final false
static ::StringW ToComType(System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code) ;

/// @brief Method InitTypeCodeA addr 0x2391d1c size 0x194 virtual false final false
static void InitTypeCodeA() ;

/// @brief Method ToTypeCode addr 0x2391eb0 size 0xb8 virtual false final false
static System::TypeCode ToTypeCode(System::Runtime::Serialization::Formatters::Binary::InternalPrimitiveTypeE code) ;

/// @brief Method InitCodeA addr 0x2391f68 size 0x1a8 virtual false final false
static void InitCodeA() ;

/// @brief Method ToPrimitiveTypeEnum addr 0x2390f20 size 0xb8 virtual false final false
...
/// @brief Method FromString addr 0x2392110 size 0xec virtual false final false
