...
/// @brief Method .ctor addr 0x238ffb4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method SetNullCount addr 0x238ffbc size 0x8 virtual false final false
 void SetNullCount(int32_t nullCount) ;

/// @brief Method Write addr 0x238ffc4 size 0xac virtual true final true
 void Write(System::Runtime::Serialization::Formatters::Binary::__BinaryWriter sout) ;

/// @brief Method Read addr 0x2390070 size 0x60 virtual false final false
...
/// @brief Method Dump addr 0x23900d0 size 0x4 virtual false final false
 void Dump() ;
