...
/// @brief Method .ctor addr 0x2390cf0 size 0x70 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0x2390d60 size 0x50 virtual false final false
 void Init() ;

/// @brief Method ArrayCountIncrement addr 0x2390db0 size 0x10 virtual false final false
 void ArrayCountIncrement(int32_t value) ;

/// @brief Method GetNext addr 0x2390dc0 size 0x114 virtual false final false
