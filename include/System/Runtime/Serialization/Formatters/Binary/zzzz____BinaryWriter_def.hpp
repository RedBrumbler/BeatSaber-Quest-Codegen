...
/// @brief Method .ctor addr 0x2392e8c size 0xb8 virtual false final false
...
/// @brief Method WriteBegin addr 0x239322c size 0x4 virtual false final false
 void WriteBegin() ;

/// @brief Method WriteEnd addr 0x2393230 size 0x20 virtual false final false
 void WriteEnd() ;

/// @brief Method WriteBoolean addr 0x2393250 size 0x24 virtual false final false
 void WriteBoolean(bool value) ;

/// @brief Method WriteByte addr 0x238d5b8 size 0x20 virtual false final false
 void WriteByte(uint8_t value) ;

/// @brief Method WriteBytes addr 0x2393274 size 0x20 virtual false final false
 void WriteBytes(::ArrayW<uint8_t> value) ;

/// @brief Method WriteBytes addr 0x2393294 size 0x20 virtual false final false
 void WriteBytes(::ArrayW<uint8_t> byteA, int32_t offset, int32_t size) ;

/// @brief Method WriteChar addr 0x23932b4 size 0x24 virtual false final false
 void WriteChar(char16_t value) ;

/// @brief Method WriteChars addr 0x23932d8 size 0x24 virtual false final false
 void WriteChars(::ArrayW<char16_t> value) ;

/// @brief Method WriteDecimal addr 0x23932fc size 0xc0 virtual false final false
 void WriteDecimal(System::Decimal value) ;

/// @brief Method WriteSingle addr 0x23933bc size 0x24 virtual false final false
 void WriteSingle(float_t value) ;

/// @brief Method WriteDouble addr 0x23933e0 size 0x24 virtual false final false
 void WriteDouble(double_t value) ;

/// @brief Method WriteInt16 addr 0x2393404 size 0x24 virtual false final false
 void WriteInt16(int16_t value) ;

/// @brief Method WriteInt32 addr 0x238d5fc size 0x24 virtual false final false
 void WriteInt32(int32_t value) ;

/// @brief Method WriteInt64 addr 0x2393428 size 0x24 virtual false final false
 void WriteInt64(int64_t value) ;

/// @brief Method WriteSByte addr 0x239344c size 0x20 virtual false final false
 void WriteSByte(int8_t value) ;

/// @brief Method WriteString addr 0x238d5d8 size 0x24 virtual false final false
 void WriteString(::StringW value) ;

/// @brief Method WriteTimeSpan addr 0x239346c size 0x24 virtual false final false
 void WriteTimeSpan(System::TimeSpan value) ;

/// @brief Method WriteDateTime addr 0x2393490 size 0x24 virtual false final false
 void WriteDateTime(System::DateTime value) ;

/// @brief Method WriteUInt16 addr 0x23934b4 size 0x24 virtual false final false
 void WriteUInt16(uint16_t value) ;

/// @brief Method WriteUInt32 addr 0x23934d8 size 0x24 virtual false final false
 void WriteUInt32(uint32_t value) ;

/// @brief Method WriteUInt64 addr 0x23934fc size 0x24 virtual false final false
 void WriteUInt64(uint64_t value) ;

/// @brief Method WriteObjectEnd addr 0x2393520 size 0x4 virtual false final false
...
/// @brief Method WriteSerializationHeaderEnd addr 0x2393524 size 0x5c virtual false final false
 void WriteSerializationHeaderEnd() ;

/// @brief Method WriteSerializationHeader addr 0x2393580 size 0x98 virtual false final false
 void WriteSerializationHeader(int32_t topId, int32_t headerId, int32_t minorVersion, int32_t majorVersion) ;

/// @brief Method WriteMethodCall addr 0x2393618 size 0x80 virtual false final false
 void WriteMethodCall() ;

/// @brief Method WriteMethodReturn addr 0x2393698 size 0x80 virtual false final false
 void WriteMethodReturn() ;

/// @brief Method WriteObject addr 0x2393718 size 0x4a8 virtual false final false
...
/// @brief Method WriteObjectString addr 0x2393dcc size 0x90 virtual false final false
 void WriteObjectString(int32_t objectId, ::StringW value) ;

/// @brief Method WriteSingleArray addr 0x2393e5c size 0x2fc virtual false final false
...
/// @brief Method WriteArrayAsBytes addr 0x2394158 size 0x22c virtual false final false
 void WriteArrayAsBytes(System::Array array, int32_t typeLength) ;

/// @brief Method WriteJaggedArray addr 0x2394384 size 0x190 virtual false final false
 void WriteJaggedArray(System::Runtime::Serialization::Formatters::Binary::NameInfo memberNameInfo, System::Runtime::Serialization::Formatters::Binary::NameInfo arrayNameInfo, System::Runtime::Serialization::Formatters::Binary::WriteObjectInfo objectInfo, System::Runtime::Serialization::Formatters::Binary::NameInfo arrayElemTypeNameInfo, int32_t length, int32_t lowerBound) ;

/// @brief Method WriteRectangleArray addr 0x2394514 size 0x158 virtual false final false
...
/// @brief Method WriteObjectByteArray addr 0x239466c size 0x60 virtual false final false
...
/// @brief Method WriteMember addr 0x23946cc size 0x108 virtual false final false
...
/// @brief Method WriteNullMember addr 0x23947d4 size 0xa0 virtual false final false
...
/// @brief Method WriteMemberObjectRef addr 0x2394874 size 0x94 virtual false final false
 void WriteMemberObjectRef(System::Runtime::Serialization::Formatters::Binary::NameInfo memberNameInfo, int32_t idRef) ;

/// @brief Method WriteMemberNested addr 0x2394908 size 0x1c virtual false final false
 void WriteMemberNested(System::Runtime::Serialization::Formatters::Binary::NameInfo memberNameInfo) ;

/// @brief Method WriteMemberString addr 0x2394924 size 0x48 virtual false final false
...
/// @brief Method WriteItem addr 0x239496c size 0x40 virtual false final false
...
/// @brief Method WriteNullItem addr 0x23949ac size 0x10 virtual false final false
...
/// @brief Method WriteDelayedNullItem addr 0x23949bc size 0x10 virtual false final false
 void WriteDelayedNullItem() ;

/// @brief Method WriteItemEnd addr 0x23949cc size 0x4 virtual false final false
 void WriteItemEnd() ;

/// @brief Method InternalWriteItemNull addr 0x2393bc0 size 0x90 virtual false final false
 void InternalWriteItemNull() ;

/// @brief Method WriteItemObjectRef addr 0x23949d0 size 0x30 virtual false final false
 void WriteItemObjectRef(System::Runtime::Serialization::Formatters::Binary::NameInfo nameInfo, int32_t idRef) ;

/// @brief Method WriteAssembly addr 0x2394a00 size 0xd4 virtual false final false
 void WriteAssembly(System::Type type, ::StringW assemblyString, int32_t assemId, bool isNew) ;

/// @brief Method WriteValue addr 0x238deb8 size 0x664 virtual false final false
