...
/// @brief Method .ctor addr 0x239d9f0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0x239d9c0 size 0x20 virtual false final false
 void Init() ;

/// @brief Method get_IsSealed addr 0x239d71c size 0x4c virtual false final false
 bool get_IsSealed() ;

/// @brief Method get_NIname addr 0x23a1d30 size 0x38 virtual false final false
 ::StringW get_NIname() ;

/// @brief Method set_NIname addr 0x23a1d68 size 0x8 virtual false final false
