...
/// @brief Method .ctor addr 0x238ff24 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method Set addr 0x238ff2c size 0x8 virtual false final false
 void Set(int32_t idRef) ;

/// @brief Method Write addr 0x238ff34 size 0x54 virtual true final true
 void Write(System::Runtime::Serialization::Formatters::Binary::__BinaryWriter sout) ;

/// @brief Method Read addr 0x238ff88 size 0x28 virtual true final true
 void Read(System::Runtime::Serialization::Formatters::Binary::__BinaryParser input) ;

/// @brief Method Dump addr 0x238ffb0 size 0x4 virtual false final false
 void Dump() ;
