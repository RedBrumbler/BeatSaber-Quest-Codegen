...
/// @brief Method .ctor addr 0x2389384 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2389490 size 0x6c virtual false final false
 void _ctor(int32_t startingSize) ;

/// @brief Method Add addr 0x23894fc size 0xa8 virtual true final false
 void Add(System::Runtime::Serialization::FixupHolder fixup) ;

/// @brief Method EnlargeArray addr 0x23895a4 size 0x88 virtual false final false
 void EnlargeArray() ;
