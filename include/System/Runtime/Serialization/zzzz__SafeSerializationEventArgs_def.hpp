...
/// @brief Method .ctor addr 0x238994c size 0xb8 virtual false final false
 void _ctor(System::Runtime::Serialization::StreamingContext streamingContext) ;

/// @brief Method get_SerializedStates addr 0x2389a04 size 0x8 virtual false final false
