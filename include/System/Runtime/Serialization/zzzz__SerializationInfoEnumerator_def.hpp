...
/// @brief Method .ctor addr 0x23810d4 size 0x50 virtual false final false
 void _ctor(::ArrayW<::StringW> members, ::ArrayW<::bs_hook::Il2CppWrapperType> info, ::ArrayW<System::Type> types, int32_t numItems) ;

/// @brief Method MoveNext addr 0x2381124 size 0x2c virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2381150 size 0x70 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_IEnumerator_get_Current() ;

/// @brief Method get_Current addr 0x23811c0 size 0xc8 virtual false final false
 System::Runtime::Serialization::SerializationEntry get_Current() ;

/// @brief Method Reset addr 0x2381288 size 0x10 virtual true final true
 void Reset() ;

/// @brief Method get_Name addr 0x2381298 size 0x88 virtual false final false
 ::StringW get_Name() ;

/// @brief Method get_Value addr 0x2381320 size 0x88 virtual false final false
 ::bs_hook::Il2CppWrapperType get_Value() ;

/// @brief Method get_ObjectType addr 0x23813a8 size 0x88 virtual false final false
