...
/// @brief Method .ctor addr 0x238509c size 0xd8 virtual false final false
 void _ctor() ;

/// @brief Method FindElement addr 0x2385174 size 0xc4 virtual false final false
 int32_t FindElement(::bs_hook::Il2CppWrapperType obj, ByRef<bool> found) ;

/// @brief Method GetId addr 0x2385238 size 0x184 virtual true final false
 int64_t GetId(::bs_hook::Il2CppWrapperType obj, ByRef<bool> firstTime) ;

/// @brief Method HasId addr 0x2385670 size 0xd4 virtual true final false
 int64_t HasId(::bs_hook::Il2CppWrapperType obj, ByRef<bool> firstTime) ;

/// @brief Method Rehash addr 0x23853bc size 0x2b4 virtual false final false
 void Rehash() ;
