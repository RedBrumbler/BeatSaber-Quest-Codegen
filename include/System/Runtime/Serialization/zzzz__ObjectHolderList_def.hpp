...
/// @brief Method .ctor addr 0x23858dc size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x2389728 size 0x6c virtual false final false
 void _ctor(int32_t startingSize) ;

/// @brief Method Add addr 0x2389794 size 0xa8 virtual true final false
 void Add(System::Runtime::Serialization::ObjectHolder value) ;

/// @brief Method GetFixupEnumerator addr 0x23886ec size 0x64 virtual false final false
 System::Runtime::Serialization::ObjectHolderListEnumerator GetFixupEnumerator() ;

/// @brief Method EnlargeArray addr 0x238983c size 0x88 virtual false final false
 void EnlargeArray() ;

/// @brief Method get_Version addr 0x238990c size 0x8 virtual false final false
 int32_t get_Version() ;

/// @brief Method get_Count addr 0x2389914 size 0x8 virtual false final false
 int32_t get_Count() ;
