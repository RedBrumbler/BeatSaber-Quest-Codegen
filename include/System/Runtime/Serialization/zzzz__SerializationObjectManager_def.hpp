...
/// @brief Method .ctor addr 0x2382508 size 0x94 virtual false final false
 void _ctor(System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method RegisterObject addr 0x238259c size 0x110 virtual false final false
 void RegisterObject(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method RaiseOnSerializedEvent addr 0x238273c size 0x20 virtual false final false
 void RaiseOnSerializedEvent() ;

/// @brief Method AddOnSerialized addr 0x23826ac size 0x90 virtual false final false
