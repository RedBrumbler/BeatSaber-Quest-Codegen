...
/// @brief Method .ctor addr 0x23857d8 size 0x80 virtual false final false
...
/// @brief Method CanCallGetType addr 0x2385858 size 0x8 virtual false final false
 bool CanCallGetType(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method set_TopObject addr 0x2385860 size 0x8 virtual false final false
 void set_TopObject(::bs_hook::Il2CppWrapperType value) ;

/// @brief Method get_TopObject addr 0x2385868 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_TopObject() ;

/// @brief Method get_SpecialFixupObjects addr 0x2385870 size 0x6c virtual false final false
 System::Runtime::Serialization::ObjectHolderList get_SpecialFixupObjects() ;

/// @brief Method FindObjectHolder addr 0x23858e4 size 0x58 virtual false final false
 System::Runtime::Serialization::ObjectHolder FindObjectHolder(int64_t objectID) ;

/// @brief Method FindOrCreateObjectHolder addr 0x238593c size 0xa4 virtual false final false
 System::Runtime::Serialization::ObjectHolder FindOrCreateObjectHolder(int64_t objectID) ;

/// @brief Method AddObjectHolder addr 0x2385a14 size 0x12c virtual false final false
 void AddObjectHolder(System::Runtime::Serialization::ObjectHolder holder) ;

/// @brief Method GetCompletionInfo addr 0x2385b40 size 0x2b8 virtual false final false
...
/// @brief Method FixupSpecialObject addr 0x2385e48 size 0x238 virtual false final false
 void FixupSpecialObject(System::Runtime::Serialization::ObjectHolder holder) ;

/// @brief Method ResolveObjectReference addr 0x2386c0c size 0x288 virtual false final false
 bool ResolveObjectReference(System::Runtime::Serialization::ObjectHolder holder) ;

/// @brief Method DoValueTypeFixup addr 0x23865d4 size 0x560 virtual false final false
...
/// @brief Method CompleteObject addr 0x2386eb0 size 0x620 virtual false final false
 void CompleteObject(System::Runtime::Serialization::ObjectHolder holder, bool bObjectFullyComplete) ;

/// @brief Method DoNewlyRegisteredObjectFixups addr 0x2386b34 size 0xd8 virtual false final false
 void DoNewlyRegisteredObjectFixups(System::Runtime::Serialization::ObjectHolder holder) ;

/// @brief Method GetObject addr 0x23876d4 size 0xb4 virtual true final false
 ::bs_hook::Il2CppWrapperType GetObject(int64_t objectID) ;

/// @brief Method RegisterString addr 0x2387788 size 0x100 virtual false final false
...
/// @brief Method RegisterObject addr 0x238796c size 0x5bc virtual false final false
...
/// @brief Method CompleteISerializableObject addr 0x23862e4 size 0x290 virtual false final false
...
/// @brief Method GetConstructor addr 0x23882b0 size 0x138 virtual false final false
static System::Reflection::RuntimeConstructorInfo GetConstructor(System::RuntimeType t) ;

/// @brief Method DoFixups addr 0x23883e8 size 0x304 virtual true final false
 void DoFixups() ;

/// @brief Method RegisterFixup addr 0x2388864 size 0xe0 virtual false final false
 void RegisterFixup(System::Runtime::Serialization::FixupHolder fixup, int64_t objectToBeFixed, int64_t objectRequired) ;

/// @brief Method RecordFixup addr 0x2388a74 size 0x2a0 virtual true final false
 void RecordFixup(int64_t objectToBeFixed, System::Reflection::MemberInfo member, int64_t objectRequired) ;

/// @brief Method RecordDelayedFixup addr 0x2388d50 size 0x168 virtual true final false
 void RecordDelayedFixup(int64_t objectToBeFixed, ::StringW memberName, int64_t objectRequired) ;

/// @brief Method RecordArrayElementFixup addr 0x2388eb8 size 0x168 virtual true final false
 void RecordArrayElementFixup(int64_t arrayToBeFixed, ::ArrayW<int32_t> indices, int64_t objectRequired) ;

/// @brief Method RaiseDeserializationEvent addr 0x2389020 size 0x4c virtual true final false
 void RaiseDeserializationEvent() ;

/// @brief Method AddOnDeserialization addr 0x238906c size 0x80 virtual true final false
 void AddOnDeserialization(System::Runtime::Serialization::DeserializationEventHandler handler) ;

/// @brief Method AddOnDeserialized addr 0x23890ec size 0x90 virtual true final false
 void AddOnDeserialized(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method RaiseOnDeserializedEvent addr 0x238917c size 0x84 virtual true final false
 void RaiseOnDeserializedEvent(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method RaiseOnDeserializingEvent addr 0x2389200 size 0x84 virtual false final false
