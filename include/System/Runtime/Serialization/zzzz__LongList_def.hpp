...
/// @brief Method .ctor addr 0x23893a4 size 0x8 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "startingSize", ty: "int32_t", modifiers: "", def_value: None }]
explicit LongList(int32_t startingSize) ;

/// @brief Method .ctor addr 0x238962c size 0x6c virtual false final false
 void _ctor(int32_t startingSize) ;

/// @brief Method Add addr 0x23893ac size 0x80 virtual false final false
 void Add(int64_t value) ;

/// @brief Method get_Count addr 0x2389720 size 0x8 virtual false final false
 int32_t get_Count() ;

/// @brief Method StartEnumeration addr 0x2387620 size 0xc virtual false final false
 void StartEnumeration() ;

/// @brief Method MoveNext addr 0x238766c size 0x68 virtual false final false
 bool MoveNext() ;

/// @brief Method get_Current addr 0x238762c size 0x34 virtual false final false
 int64_t get_Current() ;

/// @brief Method RemoveElement addr 0x23892f4 size 0x90 virtual false final false
 bool RemoveElement(int64_t value) ;

/// @brief Method EnlargeArray addr 0x2389698 size 0x88 virtual false final false
 void EnlargeArray() ;
