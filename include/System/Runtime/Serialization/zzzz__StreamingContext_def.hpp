...
/// @brief Method .ctor addr 0x238c4a8 size 0xc virtual false final false
 void _ctor(System::Runtime::Serialization::StreamingContextStates state) ;

/// @brief Method .ctor addr 0x238c4b4 size 0xc virtual false final false
 void _ctor(System::Runtime::Serialization::StreamingContextStates state, ::bs_hook::Il2CppWrapperType additional) ;

/// @brief Method get_Context addr 0x238c4c0 size 0x8 virtual false final false
 ::bs_hook::Il2CppWrapperType get_Context() ;

/// @brief Method Equals addr 0x238c4c8 size 0xb0 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x238c578 size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method get_State addr 0x238c580 size 0x8 virtual false final false
