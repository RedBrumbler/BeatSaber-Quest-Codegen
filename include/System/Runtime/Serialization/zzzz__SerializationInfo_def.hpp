...
/// @brief Method .ctor addr 0x238ac64 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x238ac6c size 0x1e0 virtual false final false
...
/// @brief Method get_FullTypeName addr 0x238ae4c size 0x8 virtual false final false
 ::StringW get_FullTypeName() ;

/// @brief Method get_AssemblyName addr 0x238ae54 size 0x8 virtual false final false
 ::StringW get_AssemblyName() ;

/// @brief Method SetType addr 0x238a11c size 0x138 virtual false final false
 void SetType(System::Type type) ;

/// @brief Method Compare addr 0x238ae60 size 0x88 virtual false final false
static bool Compare(::ArrayW<uint8_t> a, ::ArrayW<uint8_t> b) ;

/// @brief Method DemandForUnsafeAssemblyNameAssignments addr 0x238ae5c size 0x4 virtual false final false
static void DemandForUnsafeAssemblyNameAssignments(::StringW originalAssemblyName, ::StringW newAssemblyName) ;

/// @brief Method IsAssemblyNameAssignmentSafe addr 0x238aee8 size 0x134 virtual false final false
static bool IsAssemblyNameAssignmentSafe(::StringW originalAssemblyName, ::StringW newAssemblyName) ;

/// @brief Method get_MemberCount addr 0x238b01c size 0x8 virtual false final false
 int32_t get_MemberCount() ;

/// @brief Method get_ObjectType addr 0x238b024 size 0x8 virtual false final false
 System::Type get_ObjectType() ;

/// @brief Method get_IsFullTypeNameSetExplicit addr 0x238b02c size 0x8 virtual false final false
 bool get_IsFullTypeNameSetExplicit() ;

/// @brief Method get_IsAssemblyNameSetExplicit addr 0x238b034 size 0x8 virtual false final false
 bool get_IsAssemblyNameSetExplicit() ;

/// @brief Method GetEnumerator addr 0x238b03c size 0x94 virtual false final false
 System::Runtime::Serialization::SerializationInfoEnumerator GetEnumerator() ;

/// @brief Method ExpandArrays addr 0x238b0d0 size 0x10c virtual false final false
 void ExpandArrays() ;

/// @brief Method AddValue addr 0x238a098 size 0x84 virtual false final false
 void AddValue(::StringW name, ::bs_hook::Il2CppWrapperType value, System::Type type) ;

/// @brief Method AddValue addr 0x238b3b8 size 0xb8 virtual false final false
 void AddValue(::StringW name, ::bs_hook::Il2CppWrapperType value) ;

/// @brief Method AddValue addr 0x238b470 size 0xd4 virtual false final false
 void AddValue(::StringW name, bool value) ;

/// @brief Method AddValue addr 0x238b544 size 0xd4 virtual false final false
 void AddValue(::StringW name, uint8_t value) ;

/// @brief Method AddValue addr 0x238b618 size 0xd4 virtual false final false
 void AddValue(::StringW name, int16_t value) ;

/// @brief Method AddValue addr 0x238b6ec size 0xd4 virtual false final false
 void AddValue(::StringW name, int32_t value) ;

/// @brief Method AddValue addr 0x238b7c0 size 0xd4 virtual false final false
 void AddValue(::StringW name, int64_t value) ;

/// @brief Method AddValue addr 0x238b894 size 0xd4 virtual false final false
 void AddValue(::StringW name, uint64_t value) ;

/// @brief Method AddValue addr 0x238b968 size 0xdc virtual false final false
 void AddValue(::StringW name, float_t value) ;

/// @brief Method AddValue addr 0x238ba44 size 0xd4 virtual false final false
 void AddValue(::StringW name, System::DateTime value) ;

/// @brief Method AddValueInternal addr 0x238b1dc size 0x1dc virtual false final false
 void AddValueInternal(::StringW name, ::bs_hook::Il2CppWrapperType value, System::Type type) ;

/// @brief Method UpdateValue addr 0x23874dc size 0xe4 virtual false final false
 void UpdateValue(::StringW name, ::bs_hook::Il2CppWrapperType value, System::Type type) ;

/// @brief Method FindElement addr 0x238bb18 size 0xc8 virtual false final false
 int32_t FindElement(::StringW name) ;

/// @brief Method GetElement addr 0x238bbe0 size 0x104 virtual false final false
 ::bs_hook::Il2CppWrapperType GetElement(::StringW name, ByRef<System::Type> foundType) ;

/// @brief Method GetElementNoThrow addr 0x238bce4 size 0x7c virtual false final false
 ::bs_hook::Il2CppWrapperType GetElementNoThrow(::StringW name, ByRef<System::Type> foundType) ;

/// @brief Method GetValue addr 0x2389d00 size 0x214 virtual false final false
 ::bs_hook::Il2CppWrapperType GetValue(::StringW name, System::Type type) ;

/// @brief Method GetValueNoThrow addr 0x2389bf8 size 0x108 virtual false final false
 ::bs_hook::Il2CppWrapperType GetValueNoThrow(::StringW name, System::Type type) ;

/// @brief Method GetBoolean addr 0x238bd60 size 0x180 virtual false final false
 bool GetBoolean(::StringW name) ;

/// @brief Method GetInt32 addr 0x238bee0 size 0x174 virtual false final false
 int32_t GetInt32(::StringW name) ;

/// @brief Method GetInt64 addr 0x238c054 size 0x174 virtual false final false
 int64_t GetInt64(::StringW name) ;

/// @brief Method GetSingle addr 0x238c1c8 size 0x174 virtual false final false
 float_t GetSingle(::StringW name) ;

/// @brief Method GetString addr 0x238c33c size 0x16c virtual false final false
