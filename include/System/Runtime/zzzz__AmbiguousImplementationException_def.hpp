...
/// @brief Method .ctor addr 0x23526ac size 0x80 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit AmbiguousImplementationException(::StringW message) ;

/// @brief Method .ctor addr 0x235272c size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x23527a4 size 0x80 virtual false final false
