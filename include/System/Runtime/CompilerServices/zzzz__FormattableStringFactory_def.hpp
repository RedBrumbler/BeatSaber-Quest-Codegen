...
/// @brief Method .ctor addr 0x23a5e20 size 0x2c virtual false final false
 void _ctor(::StringW format, ::ArrayW<::bs_hook::Il2CppWrapperType> arguments) ;

/// @brief Method get_Format addr 0x23a5e4c size 0x8 virtual true final false
 ::StringW get_Format() ;

/// @brief Method GetArguments addr 0x23a5e54 size 0x8 virtual true final false
 ::ArrayW<::bs_hook::Il2CppWrapperType> GetArguments() ;

/// @brief Method get_ArgumentCount addr 0x23a5e5c size 0x1c virtual true final false
 int32_t get_ArgumentCount() ;

/// @brief Method GetArgument addr 0x23a5e78 size 0x30 virtual true final false
 ::bs_hook::Il2CppWrapperType GetArgument(int32_t index) ;

/// @brief Method ToString addr 0x23a5ea8 size 0x14 virtual true final false
...
/// @brief Method Create addr 0x23a5d40 size 0xe0 virtual false final false
