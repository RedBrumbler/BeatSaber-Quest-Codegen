...
/// @brief Method .ctor addr 0x23a5efc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method set_WrapNonExceptionThrows addr 0x23a5f04 size 0xc virtual false final false
