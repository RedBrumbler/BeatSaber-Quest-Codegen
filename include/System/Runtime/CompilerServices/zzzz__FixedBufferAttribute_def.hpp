...
/// @brief Method .ctor addr 0x23a5d00 size 0x30 virtual false final false
 void _ctor(System::Type elementType, int32_t length) ;

/// @brief Method get_ElementType addr 0x23a5d30 size 0x8 virtual false final false
 System::Type get_ElementType() ;

/// @brief Method get_Length addr 0x23a5d38 size 0x8 virtual false final false
 int32_t get_Length() ;
