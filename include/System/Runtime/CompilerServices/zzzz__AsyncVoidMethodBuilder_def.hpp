...
/// @brief Method Create addr 0x23a6ed4 size 0x40 virtual false final false
...
/// @brief Method SetStateMachine addr 0x23a6f14 size 0x8 virtual false final false
...
/// @brief Method SetResult addr 0x23a6fe4 size 0x5c virtual false final false
 void SetResult() ;

/// @brief Method SetException addr 0x23a7150 size 0x134 virtual false final false
 void SetException(System::Exception exception) ;

/// @brief Method NotifySynchronizationContextOfCompletion addr 0x23a70ac size 0xa4 virtual false final false
 void NotifySynchronizationContextOfCompletion() ;

/// @brief Method get_Task addr 0x23a7040 size 0x6c virtual false final false
