...
/// @brief Method .ctor addr 0x23a6244 size 0x84 virtual false final false
 void _ctor(::StringW assemblyFullName) ;

/// @brief Method get_AssemblyFullName addr 0x23a62c8 size 0x8 virtual false final false
