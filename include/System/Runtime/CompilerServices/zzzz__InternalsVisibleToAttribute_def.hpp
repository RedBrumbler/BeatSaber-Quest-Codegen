...
/// @brief Method .ctor addr 0x23a8850 size 0x30 virtual false final false
 void _ctor(::StringW assemblyName) ;

/// @brief Method set_AllInternalsVisible addr 0x23a8880 size 0xc virtual false final false
