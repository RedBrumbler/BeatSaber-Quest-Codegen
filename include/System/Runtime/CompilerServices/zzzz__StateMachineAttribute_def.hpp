...
/// @brief Method .ctor addr 0x23a57d0 size 0x28 virtual false final false
 void _ctor(System::Type stateMachineType) ;

/// @brief Method get_StateMachineType addr 0x23a61bc size 0x8 virtual false final false
