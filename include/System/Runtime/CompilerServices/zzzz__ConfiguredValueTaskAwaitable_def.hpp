...
/// @brief Method .ctor addr 0x23a581c size 0x8 virtual false final false
 void _ctor(System::Threading::Tasks::ValueTask value) ;

/// @brief Method get_IsCompleted addr 0x23a5824 size 0x108 virtual false final false
 bool get_IsCompleted() ;

/// @brief Method GetResult addr 0x23a592c size 0x100 virtual false final false
 void GetResult() ;

/// @brief Method UnsafeOnCompleted addr 0x23a5a2c size 0x1ac virtual true final true
...
/// @brief Method .ctor addr 0x23a5808 size 0x8 virtual false final false
 void _ctor(System::Threading::Tasks::ValueTask value) ;

/// @brief Method GetAwaiter addr 0x23a5810 size 0xc virtual false final false
