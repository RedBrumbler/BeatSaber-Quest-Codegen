...
/// @brief Method .ctor addr 0x23a6ce4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <OutputWaitEtwEvents>b__0 addr 0x23a6cec size 0x174 virtual false final false
...
/// @brief Method .ctor addr 0x23a6828 size 0x8 virtual false final false
 void _ctor(System::Threading::Tasks::Task task) ;

/// @brief Method get_IsCompleted addr 0x23a6830 size 0x1c virtual false final false
 bool get_IsCompleted() ;

/// @brief Method UnsafeOnCompleted addr 0x23a6674 size 0x10 virtual true final true
 void UnsafeOnCompleted(System::Action continuation) ;

/// @brief Method GetResult addr 0x23a6900 size 0x8 virtual false final false
 void GetResult() ;

/// @brief Method ValidateEnd addr 0x23a6908 size 0x4c virtual false final false
static void ValidateEnd(System::Threading::Tasks::Task task) ;

/// @brief Method HandleNonSuccessAndDebuggerNotification addr 0x23a6954 size 0x60 virtual false final false
static void HandleNonSuccessAndDebuggerNotification(System::Threading::Tasks::Task task) ;

/// @brief Method ThrowForNonSuccess addr 0x23a69b4 size 0x154 virtual false final false
static void ThrowForNonSuccess(System::Threading::Tasks::Task task) ;

/// @brief Method OnCompletedInternal addr 0x23a684c size 0xb4 virtual false final false
...
/// @brief Method OutputWaitEtwEvents addr 0x23a6b08 size 0x1dc virtual false final false
