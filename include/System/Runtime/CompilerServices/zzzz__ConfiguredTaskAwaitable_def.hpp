...
/// @brief Method .ctor addr 0x23a6e78 size 0x10 virtual false final false
 void _ctor(System::Threading::Tasks::Task task, bool continueOnCapturedContext) ;

/// @brief Method get_IsCompleted addr 0x23a6e94 size 0x1c virtual false final false
 bool get_IsCompleted() ;

/// @brief Method OnCompleted addr 0x23a6eb0 size 0x14 virtual true final true
 void OnCompleted(System::Action continuation) ;

/// @brief Method UnsafeOnCompleted addr 0x23a5bd8 size 0x14 virtual true final true
 void UnsafeOnCompleted(System::Action continuation) ;

/// @brief Method GetResult addr 0x23a6ec4 size 0x8 virtual false final false
 void GetResult() ;
...
/// @brief Method .ctor addr 0x23a6e60 size 0x18 virtual false final false
 void _ctor(System::Threading::Tasks::Task task, bool continueOnCapturedContext) ;

/// @brief Method GetAwaiter addr 0x23a6e88 size 0xc virtual false final false
