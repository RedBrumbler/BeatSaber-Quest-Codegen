...
/// @brief Method InitializeArray addr 0x23a890c size 0x4 virtual false final false
static void InitializeArray(System::Array array, ::cordl_internals::intptr_t fldHandle) ;

/// @brief Method InitializeArray addr 0x23a8910 size 0xa8 virtual false final false
static void InitializeArray(System::Array array, System::RuntimeFieldHandle fldHandle) ;

/// @brief Method get_OffsetToStringData addr 0x23a4360 size 0x4 virtual false final false
static int32_t get_OffsetToStringData() ;

/// @brief Method GetHashCode addr 0x23a89b8 size 0x8 virtual false final false
static int32_t GetHashCode(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method RunClassConstructor addr 0x23a89c0 size 0x4 virtual false final false
static void RunClassConstructor(::cordl_internals::intptr_t type) ;

/// @brief Method RunClassConstructor addr 0x23a89c4 size 0xc0 virtual false final false
static void RunClassConstructor(System::RuntimeTypeHandle type) ;

/// @brief Method SufficientExecutionStack addr 0x23a8a84 size 0x4 virtual false final false
static bool SufficientExecutionStack() ;

/// @brief Method TryEnsureSufficientExecutionStack addr 0x23a8a88 size 0x4 virtual false final false
static bool TryEnsureSufficientExecutionStack() ;

/// @brief Method PrepareConstrainedRegions addr 0x23a8a8c size 0x4 virtual false final false
