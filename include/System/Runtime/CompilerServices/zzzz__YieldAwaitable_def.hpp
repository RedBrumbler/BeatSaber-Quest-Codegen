...
/// @brief Method get_IsCompleted addr 0x23a8384 size 0x8 virtual false final false
 bool get_IsCompleted() ;

/// @brief Method UnsafeOnCompleted addr 0x23a838c size 0x58 virtual true final true
 void UnsafeOnCompleted(System::Action continuation) ;

/// @brief Method QueueContinuation addr 0x23a83e4 size 0x2a0 virtual false final false
static void QueueContinuation(System::Action continuation, bool flowContext) ;

/// @brief Method RunAction addr 0x23a8684 size 0x6c virtual false final false
static void RunAction(::bs_hook::Il2CppWrapperType state) ;

/// @brief Method GetResult addr 0x23a86f0 size 0x4 virtual false final false
 void GetResult() ;
...
/// @brief Method GetAwaiter addr 0x23a837c size 0x8 virtual false final false
