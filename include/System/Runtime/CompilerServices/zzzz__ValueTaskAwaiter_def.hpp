...
/// @brief Method .ctor addr 0x23a67ac size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <.cctor>b__9_0 addr 0x23a67b4 size 0x74 virtual false final false
...
/// @brief Method .ctor addr 0x23a62d8 size 0x8 virtual false final false
 void _ctor(System::Threading::Tasks::ValueTask value) ;

/// @brief Method get_IsCompleted addr 0x23a62e0 size 0x108 virtual false final false
 bool get_IsCompleted() ;

/// @brief Method GetResult addr 0x23a63e8 size 0x100 virtual false final false
 void GetResult() ;

/// @brief Method UnsafeOnCompleted addr 0x23a64e8 size 0x18c virtual true final true
