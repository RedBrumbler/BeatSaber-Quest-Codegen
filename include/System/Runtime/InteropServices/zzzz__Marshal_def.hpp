...
/// @brief Method .ctor addr 0x23a48c8 size 0xc4 virtual false final false
 void _ctor(::bs_hook::Il2CppWrapperType object, ::cordl_internals::intptr_t method) ;

/// @brief Method Invoke addr 0x23a5368 size 0x14 virtual true final false
...
/// @brief Method Equals addr 0x23a537c size 0x74 virtual true final true
 bool Equals(System::ValueTuple_2<System::Type,::StringW> lhs, System::ValueTuple_2<System::Type,::StringW> rhs) ;

/// @brief Method GetHashCode addr 0x23a53f0 size 0x54 virtual true final true
...
/// @brief Method .ctor addr 0x23a5444 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x23a54b0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <GetCustomMarshalerInstance>b__201_0 addr 0x23a54b8 size 0xa0 virtual false final false
...
/// @brief Method AllocCoTaskMem addr 0x23a3808 size 0x4 virtual false final false
static ::cordl_internals::intptr_t AllocCoTaskMem(int32_t cb) ;

/// @brief Method AllocHGlobal addr 0x23a380c size 0x4 virtual false final false
static ::cordl_internals::intptr_t AllocHGlobal(::cordl_internals::intptr_t cb) ;

/// @brief Method AllocHGlobal addr 0x23a3810 size 0x68 virtual false final false
static ::cordl_internals::intptr_t AllocHGlobal(int32_t cb) ;

/// @brief Method copy_to_unmanaged_fixed addr 0x23a3878 size 0x4 virtual false final false
...
/// @brief Method skip_fixed addr 0x23a387c size 0x34 virtual false final false
static bool skip_fixed(System::Array array, int32_t startIndex) ;

/// @brief Method copy_to_unmanaged addr 0x23a38b0 size 0xe8 virtual false final false
...
/// @brief Method Copy addr 0x23a3998 size 0xf4 virtual false final false
static void Copy(::ArrayW<uint8_t> source, int32_t startIndex, ::cordl_internals::intptr_t destination, int32_t length) ;

/// @brief Method copy_from_unmanaged addr 0x23a3a8c size 0x80 virtual false final false
...
/// @brief Method copy_from_unmanaged_fixed addr 0x23a3b0c size 0x4 virtual false final false
...
/// @brief Method Copy addr 0x23a3b10 size 0xf4 virtual false final false
static void Copy(::cordl_internals::intptr_t source, ::ArrayW<uint8_t> destination, int32_t startIndex, int32_t length) ;

/// @brief Method Copy addr 0x23a3c04 size 0xf4 virtual false final false
static void Copy(::cordl_internals::intptr_t source, ::ArrayW<char16_t> destination, int32_t startIndex, int32_t length) ;

/// @brief Method Copy addr 0x23a3cf8 size 0xf4 virtual false final false
static void Copy(::cordl_internals::intptr_t source, ::ArrayW<float_t> destination, int32_t startIndex, int32_t length) ;

/// @brief Method FreeBSTR addr 0x23a3dec size 0x4 virtual false final false
static void FreeBSTR(::cordl_internals::intptr_t ptr) ;

/// @brief Method FreeCoTaskMem addr 0x23a3df0 size 0x4 virtual false final false
static void FreeCoTaskMem(::cordl_internals::intptr_t ptr) ;

/// @brief Method FreeHGlobal addr 0x23a3df4 size 0x4 virtual false final false
static void FreeHGlobal(::cordl_internals::intptr_t hglobal) ;

/// @brief Method ClearBSTR addr 0x23a3df8 size 0xac virtual false final false
static void ClearBSTR(::cordl_internals::intptr_t ptr) ;

/// @brief Method ZeroFreeBSTR addr 0x23a3f14 size 0x5c virtual false final false
static void ZeroFreeBSTR(::cordl_internals::intptr_t s) ;

/// @brief Method ClearAnsi addr 0x23a3f70 size 0x9c virtual false final false
static void ClearAnsi(::cordl_internals::intptr_t ptr) ;

/// @brief Method ClearUnicode addr 0x23a4028 size 0x90 virtual false final false
static void ClearUnicode(::cordl_internals::intptr_t ptr) ;

/// @brief Method ZeroFreeGlobalAllocAnsi addr 0x23a414c size 0x5c virtual false final false
static void ZeroFreeGlobalAllocAnsi(::cordl_internals::intptr_t s) ;

/// @brief Method ZeroFreeGlobalAllocUnicode addr 0x23a41a8 size 0x5c virtual false final false
static void ZeroFreeGlobalAllocUnicode(::cordl_internals::intptr_t s) ;

/// @brief Method GetHRForException addr 0x23a4204 size 0xc virtual false final false
static int32_t GetHRForException(System::Exception e) ;

/// @brief Method IsComObject addr 0x23a4210 size 0x8 virtual false final false
static bool IsComObject(::bs_hook::Il2CppWrapperType o) ;

/// @brief Method GetLastWin32Error addr 0x23a4218 size 0x4 virtual false final false
static int32_t GetLastWin32Error() ;

/// @brief Method OffsetOf addr 0x23a421c size 0x4 virtual false final false
static ::cordl_internals::intptr_t OffsetOf(System::Type t, ::StringW fieldName) ;

/// @brief Method PtrToStringAnsi addr 0x23a4220 size 0x4 virtual false final false
static ::StringW PtrToStringAnsi(::cordl_internals::intptr_t ptr) ;

/// @brief Method PtrToStringAnsi addr 0x23a4224 size 0x4 virtual false final false
static ::StringW PtrToStringAnsi(::cordl_internals::intptr_t ptr, int32_t len) ;

/// @brief Method PtrToStringUni addr 0x23a4228 size 0x4 virtual false final false
static ::StringW PtrToStringUni(::cordl_internals::intptr_t ptr) ;

/// @brief Method PtrToStringUni addr 0x23a422c size 0x4 virtual false final false
static ::StringW PtrToStringUni(::cordl_internals::intptr_t ptr, int32_t len) ;

/// @brief Method PtrToStructure addr 0x23a4230 size 0x4 virtual false final false
static void PtrToStructure(::cordl_internals::intptr_t ptr, ::bs_hook::Il2CppWrapperType structure) ;

/// @brief Method PtrToStructure addr 0x23a4234 size 0x4 virtual false final false
...
/// @brief Method ReadByte addr 0x23a400c size 0x1c virtual false final false
static uint8_t ReadByte(::cordl_internals::intptr_t ptr, int32_t ofs) ;

/// @brief Method ReadInt16 addr 0x23a4104 size 0x48 virtual false final false
static int16_t ReadInt16(::cordl_internals::intptr_t ptr, int32_t ofs) ;

/// @brief Method ReadInt32 addr 0x23a4238 size 0x40 virtual false final false
static int32_t ReadInt32(::cordl_internals::intptr_t ptr) ;

/// @brief Method ReadInt32 addr 0x23a3ea4 size 0x4c virtual false final false
static int32_t ReadInt32(::cordl_internals::intptr_t ptr, int32_t ofs) ;

/// @brief Method SizeOf addr 0x23a4278 size 0x70 virtual false final false
static int32_t SizeOf(::bs_hook::Il2CppWrapperType structure) ;

/// @brief Method SizeOf addr 0x23a42e8 size 0x4 virtual false final false
...
/// @brief Method StringToHGlobalAnsi addr 0x23a42ec size 0x4 virtual false final false
static ::cordl_internals::intptr_t StringToHGlobalAnsi(void* s, int32_t length) ;

/// @brief Method StringToHGlobalAnsi addr 0x23a42f0 size 0x70 virtual false final false
static ::cordl_internals::intptr_t StringToHGlobalAnsi(::StringW s) ;

/// @brief Method SecureStringToBSTR addr 0x23a4364 size 0x188 virtual false final false
static ::cordl_internals::intptr_t SecureStringToBSTR(System::Security::SecureString s) ;

/// @brief Method SecureStringGlobalAllocator addr 0x23a44f0 size 0x54 virtual false final false
static ::cordl_internals::intptr_t SecureStringGlobalAllocator(int32_t len) ;

/// @brief Method SecureStringToUnicode addr 0x23a4544 size 0x294 virtual false final false
...
/// @brief Method SecureStringToGlobalAllocUnicode addr 0x23a47d8 size 0xf0 virtual false final false
static ::cordl_internals::intptr_t SecureStringToGlobalAllocUnicode(System::Security::SecureString s) ;

/// @brief Method StructureToPtr addr 0x23a498c size 0x8 virtual false final false
...
/// @brief Method BufferToBSTR addr 0x23a44ec size 0x4 virtual false final false
static ::cordl_internals::intptr_t BufferToBSTR(void* ptr, int32_t slen) ;

/// @brief Method UnsafeAddrOfPinnedArrayElement addr 0x23a4994 size 0x4 virtual false final false
...
/// @brief Method WriteByte addr 0x23a3ef0 size 0x24 virtual false final false
static void WriteByte(::cordl_internals::intptr_t ptr, int32_t ofs, uint8_t val) ;

/// @brief Method WriteInt16 addr 0x23a40b8 size 0x4c virtual false final false
static void WriteInt16(::cordl_internals::intptr_t ptr, int32_t ofs, int16_t val) ;

/// @brief Method GetFunctionPointerForDelegateInternal addr 0x23a4998 size 0x4 virtual false final false
...
/// @brief Method GetCustomMarshalerInstance addr 0x23a499c size 0x814 virtual false final false
