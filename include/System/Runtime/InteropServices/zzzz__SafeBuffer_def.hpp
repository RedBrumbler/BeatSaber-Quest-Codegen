...
/// @brief Method AcquirePointer addr 0x23a23c4 size 0x108 virtual false final false
 void AcquirePointer(ByRef<void*> pointer) ;

/// @brief Method ReleasePointer addr 0x23a2610 size 0xdc virtual false final false
 void ReleasePointer() ;

/// @brief Method NotInitialized addr 0x23a24cc size 0x74 virtual false final false
