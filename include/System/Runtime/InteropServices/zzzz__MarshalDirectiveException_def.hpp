...
/// @brief Method .ctor addr 0x23a233c size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit MarshalDirectiveException(::StringW message) ;

/// @brief Method .ctor addr 0x23a2398 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x23a23bc size 0x8 virtual false final false
