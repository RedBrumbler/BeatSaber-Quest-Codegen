...
/// @brief Method .ctor addr 0x23a2dd8 size 0x98 virtual false final false
 void _ctor(::cordl_internals::intptr_t invalidHandleValue, bool ownsHandle) ;

/// @brief Method Finalize addr 0x23a2e78 size 0xa0 virtual true final false
 void Finalize() ;

/// @brief Method SetHandle addr 0x23a2f18 size 0x8 virtual false final false
 void SetHandle(::cordl_internals::intptr_t handle) ;

/// @brief Method DangerousGetHandle addr 0x23a2f20 size 0x8 virtual false final false
 ::cordl_internals::intptr_t DangerousGetHandle() ;

/// @brief Method get_IsClosed addr 0x23a2f28 size 0xc virtual false final false
 bool get_IsClosed() ;

/// @brief Method get_IsInvalid addr 0x0 size 0xffffffffffffffff virtual true final false
 bool get_IsInvalid() ;

/// @brief Method Close addr 0x23a2f34 size 0x10 virtual false final false
 void Close() ;

/// @brief Method Dispose addr 0x23a2f44 size 0x10 virtual true final true
 void Dispose() ;

/// @brief Method Dispose addr 0x23a2f54 size 0x1c virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method ReleaseHandle addr 0x0 size 0xffffffffffffffff virtual true final false
 bool ReleaseHandle() ;

/// @brief Method SetHandleAsInvalid addr 0x23a302c size 0x84 virtual false final false
 void SetHandleAsInvalid() ;

/// @brief Method DangerousAddRef addr 0x23a2540 size 0xd0 virtual false final false
 void DangerousAddRef(ByRef<bool> success) ;

/// @brief Method DangerousRelease addr 0x23a26ec size 0x8 virtual false final false
 void DangerousRelease() ;

/// @brief Method InternalDispose addr 0x23a2f70 size 0xa8 virtual false final false
 void InternalDispose() ;

/// @brief Method InternalFinalize addr 0x23a3018 size 0x14 virtual false final false
 void InternalFinalize() ;

/// @brief Method DangerousReleaseInternal addr 0x23a30b0 size 0x170 virtual false final false
