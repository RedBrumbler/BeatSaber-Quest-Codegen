...
/// @brief Method DangerousMakeTwosComplement addr 0x26e44d4 size 0xbc virtual false final false
static void DangerousMakeTwosComplement(::ArrayW<uint32_t> d) ;

/// @brief Method MakeUlong addr 0x26e7a54 size 0x10 virtual false final false
static uint64_t MakeUlong(uint32_t uHi, uint32_t uLo) ;

/// @brief Method Abs addr 0x26e5370 size 0xc virtual false final false
static uint32_t Abs(int32_t a) ;

/// @brief Method CombineHash addr 0x26e7ba4 size 0x8 virtual false final false
static uint32_t CombineHash(uint32_t u1, uint32_t u2) ;

/// @brief Method CombineHash addr 0x26e47e4 size 0x8 virtual false final false
