...
/// @brief Method Add addr 0x26e537c size 0xd8 virtual false final false
static ::ArrayW<uint32_t> Add(::ArrayW<uint32_t> left, uint32_t right) ;

/// @brief Method Add addr 0x26e5454 size 0xf8 virtual false final false
static ::ArrayW<uint32_t> Add(::ArrayW<uint32_t> left, ::ArrayW<uint32_t> right) ;

/// @brief Method Add addr 0x26e622c size 0x88 virtual false final false
static void Add(void* left, int32_t leftLength, void* right, int32_t rightLength, void* bits, int32_t bitsLength) ;

/// @brief Method Subtract addr 0x26e56cc size 0xb8 virtual false final false
static ::ArrayW<uint32_t> Subtract(::ArrayW<uint32_t> left, uint32_t right) ;

/// @brief Method Subtract addr 0x26e5804 size 0x100 virtual false final false
static ::ArrayW<uint32_t> Subtract(::ArrayW<uint32_t> left, ::ArrayW<uint32_t> right) ;

/// @brief Method Subtract addr 0x26e62b4 size 0x78 virtual false final false
static void Subtract(void* left, int32_t leftLength, void* right, int32_t rightLength, void* bits, int32_t bitsLength) ;

/// @brief Method Compare addr 0x26e5784 size 0x80 virtual false final false
