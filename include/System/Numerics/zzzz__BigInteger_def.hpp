...
/// @brief Method .ctor addr 0x26e3d74 size 0x7c virtual false final false
 void _ctor(int32_t value) ;

/// @brief Method .ctor addr 0x26e3df0 size 0x118 virtual false final false
 void _ctor(int64_t value) ;

/// @brief Method .ctor addr 0x26e3f08 size 0xa0 virtual false final false
 void _ctor(::ArrayW<uint8_t> value) ;

/// @brief Method .ctor addr 0x26e3fa8 size 0x52c virtual false final false
 void _ctor(System::ReadOnlySpan_1<uint8_t> value, bool isUnsigned, bool isBigEndian) ;

/// @brief Method .ctor addr 0x26e4590 size 0xc virtual false final false
 void _ctor(int32_t n, ::ArrayW<uint32_t> rgu) ;

/// @brief Method .ctor addr 0x26e459c size 0x1a4 virtual false final false
 void _ctor(::ArrayW<uint32_t> value, bool negative) ;

/// @brief Method get_MinusOne addr 0x26e4740 size 0x58 virtual false final false
static System::Numerics::BigInteger get_MinusOne() ;

/// @brief Method GetHashCode addr 0x26e4798 size 0x4c virtual true final false
 int32_t GetHashCode() ;

/// @brief Method Equals addr 0x26e47ec size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method Equals addr 0x26e4864 size 0xbc virtual true final true
 bool Equals(System::Numerics::BigInteger other) ;

/// @brief Method CompareTo addr 0x26e4988 size 0x128 virtual true final true
 int32_t CompareTo(System::Numerics::BigInteger other) ;

/// @brief Method CompareTo addr 0x26e4ab0 size 0xd8 virtual true final true
 int32_t CompareTo(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method TryWriteBytes addr 0x26e4b88 size 0x40 virtual false final false
 bool TryWriteBytes(System::Span_1<uint8_t> destination, ByRef<int32_t> bytesWritten, bool isUnsigned, bool isBigEndian) ;

/// @brief Method TryWriteOrCountBytes addr 0x26e50b4 size 0x34 virtual false final false
 bool TryWriteOrCountBytes(System::Span_1<uint8_t> destination, ByRef<int32_t> bytesWritten, bool isUnsigned, bool isBigEndian) ;

/// @brief Method TryGetBytes addr 0x26e4bc8 size 0x4ec virtual false final false
...
/// @brief Method ToString addr 0x26e50e8 size 0x30 virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x26e51c4 size 0x38 virtual true final true
 ::StringW ToString(::StringW format, System::IFormatProvider provider) ;

/// @brief Method Add addr 0x26e51fc size 0x14c virtual false final false
...
/// @brief Method Subtract addr 0x26e554c size 0x180 virtual false final false
