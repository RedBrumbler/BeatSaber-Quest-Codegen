...
/// @brief Method .ctor addr 0x24b8704 size 0x4 virtual false final false
 void _ctor() ;

/// @brief Method get_ObjectIdentity addr 0x24bede8 size 0x40 virtual false final false
 System::Runtime::Remoting::ServerIdentity get_ObjectIdentity() ;

/// @brief Method set_ObjectIdentity addr 0x24bee28 size 0x40 virtual false final false
 void set_ObjectIdentity(System::Runtime::Remoting::ServerIdentity value) ;

/// @brief Method CreateObjRef addr 0x24bee68 size 0x40 virtual true final false
 System::Runtime::Remoting::ObjRef CreateObjRef(System::Type requestedType) ;

/// @brief Method InitializeLifetimeService addr 0x24beea8 size 0x40 virtual true final false
