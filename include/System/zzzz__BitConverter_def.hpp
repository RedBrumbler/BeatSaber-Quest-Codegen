...
/// @brief Method .ctor addr 0x23ec76c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <ToString>b__38_0 addr 0x23ec774 size 0x194 virtual false final false
...
/// @brief Method GetBytes addr 0x23ebd3c size 0x64 virtual false final false
static ::ArrayW<uint8_t> GetBytes(int32_t value) ;

/// @brief Method GetBytes addr 0x23ebda0 size 0x64 virtual false final false
static ::ArrayW<uint8_t> GetBytes(uint16_t value) ;

/// @brief Method GetBytes addr 0x23ebe04 size 0x64 virtual false final false
static ::ArrayW<uint8_t> GetBytes(uint32_t value) ;

/// @brief Method TryWriteBytes addr 0x23ebe68 size 0x84 virtual false final false
static bool TryWriteBytes(System::Span_1<uint8_t> destination, uint32_t value) ;

/// @brief Method GetBytes addr 0x23ebeec size 0x6c virtual false final false
static ::ArrayW<uint8_t> GetBytes(float_t value) ;

/// @brief Method ToChar addr 0x23ebf58 size 0x64 virtual false final false
static char16_t ToChar(::ArrayW<uint8_t> value, int32_t startIndex) ;

/// @brief Method ToInt16 addr 0x23ebfbc size 0x84 virtual false final false
static int16_t ToInt16(::ArrayW<uint8_t> value, int32_t startIndex) ;

/// @brief Method ToInt32 addr 0x23ec040 size 0x84 virtual false final false
static int32_t ToInt32(::ArrayW<uint8_t> value, int32_t startIndex) ;

/// @brief Method ToInt64 addr 0x23ec0c4 size 0x84 virtual false final false
static int64_t ToInt64(::ArrayW<uint8_t> value, int32_t startIndex) ;

/// @brief Method ToUInt16 addr 0x23ec148 size 0x64 virtual false final false
static uint16_t ToUInt16(::ArrayW<uint8_t> value, int32_t startIndex) ;

/// @brief Method ToUInt32 addr 0x23ec1ac size 0x64 virtual false final false
static uint32_t ToUInt32(::ArrayW<uint8_t> value, int32_t startIndex) ;

/// @brief Method ToUInt64 addr 0x23ec210 size 0x64 virtual false final false
static uint64_t ToUInt64(::ArrayW<uint8_t> value, int32_t startIndex) ;

/// @brief Method ToSingle addr 0x23ec274 size 0x6c virtual false final false
static float_t ToSingle(::ArrayW<uint8_t> value, int32_t startIndex) ;

/// @brief Method ToDouble addr 0x23ec2e0 size 0x6c virtual false final false
static double_t ToDouble(::ArrayW<uint8_t> value, int32_t startIndex) ;

/// @brief Method ToString addr 0x23ec34c size 0x2e0 virtual false final false
static ::StringW ToString(::ArrayW<uint8_t> value, int32_t startIndex, int32_t length) ;

/// @brief Method ToString addr 0x23ec62c size 0x70 virtual false final false
static ::StringW ToString(::ArrayW<uint8_t> value) ;

/// @brief Method DoubleToInt64Bits addr 0x23ec69c size 0x8 virtual false final false
static int64_t DoubleToInt64Bits(double_t value) ;

/// @brief Method Int64BitsToDouble addr 0x23ec6a4 size 0x8 virtual false final false
static double_t Int64BitsToDouble(int64_t value) ;

/// @brief Method SingleToInt32Bits addr 0x23ec6ac size 0x8 virtual false final false
static int32_t SingleToInt32Bits(float_t value) ;

/// @brief Method Int32BitsToSingle addr 0x23ec6b4 size 0x8 virtual false final false
