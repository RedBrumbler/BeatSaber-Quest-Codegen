...
/// @brief Method Init addr 0x24ab2e8 size 0x78 virtual false final false
 void Init() ;

// Ctor Parameters []
explicit Exception() ;

/// @brief Method .ctor addr 0x24ab360 size 0x1c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit Exception(::StringW message) ;

/// @brief Method .ctor addr 0x24ab37c size 0x30 virtual false final false
 void _ctor(::StringW message) ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "innerException", ty: "System::Exception", modifiers: "", def_value: None }]
explicit Exception(::StringW message, System::Exception innerException) ;

/// @brief Method .ctor addr 0x24ab3ac size 0x38 virtual false final false
...
/// @brief Method .ctor addr 0x24ab3e4 size 0x468 virtual false final false
 void _ctor(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method get_Message addr 0x24ab84c size 0xd8 virtual true final false
 ::StringW get_Message() ;

/// @brief Method get_Data addr 0x24ab960 size 0x6c virtual true final false
 System::Collections::IDictionary get_Data() ;

/// @brief Method GetClassName addr 0x24ab924 size 0x3c virtual false final false
 ::StringW GetClassName() ;

/// @brief Method get_InnerException addr 0x24ab9d4 size 0x8 virtual true final true
 System::Exception get_InnerException() ;

/// @brief Method get_StackTrace addr 0x24ab9dc size 0x8 virtual true final false
 ::StringW get_StackTrace() ;

/// @brief Method GetStackTrace addr 0x24ab9e4 size 0x4c virtual false final false
 ::StringW GetStackTrace(bool needFileInfo) ;

/// @brief Method SetErrorCode addr 0x24aba38 size 0x8 virtual false final false
 void SetErrorCode(int32_t hr) ;

/// @brief Method get_Source addr 0x24aba40 size 0x10c virtual true final false
 ::StringW get_Source() ;

/// @brief Method ToString addr 0x24abb4c size 0xc virtual true final false
 ::StringW ToString() ;

/// @brief Method ToString addr 0x24abb58 size 0x2a4 virtual false final false
 ::StringW ToString(bool needFileLineInfo, bool needMessage) ;

/// @brief Method GetObjectData addr 0x24abdfc size 0x4ac virtual true final false
 void GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method OnDeserialized addr 0x24ac2a8 size 0x80 virtual false final false
 void OnDeserialized(System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method StripFileInfo addr 0x24aba30 size 0x8 virtual false final false
 ::StringW StripFileInfo(::StringW stackTrace, bool isRemoteStackTrace) ;

/// @brief Method RestoreExceptionDispatchInfo addr 0x24ac328 size 0x9c virtual false final false
 void RestoreExceptionDispatchInfo(System::Runtime::ExceptionServices::ExceptionDispatchInfo exceptionDispatchInfo) ;

/// @brief Method get_HResult addr 0x24ac3c4 size 0x8 virtual false final false
 int32_t get_HResult() ;

/// @brief Method set_HResult addr 0x24ac3cc size 0x8 virtual false final false
 void set_HResult(int32_t value) ;

/// @brief Method GetType addr 0x24ab9cc size 0x8 virtual true final true
 System::Type GetType() ;

/// @brief Method GetMessageFromNativeResources addr 0x24ac3d4 size 0x84 virtual false final false
static ::StringW GetMessageFromNativeResources(System::System__Exception__ExceptionMessageKind kind) ;

/// @brief Method FixRemotingException addr 0x24ac458 size 0xe8 virtual false final false
 System::Exception FixRemotingException() ;

/// @brief Method ReportUnhandledException addr 0x24ac540 size 0x4 virtual false final false
