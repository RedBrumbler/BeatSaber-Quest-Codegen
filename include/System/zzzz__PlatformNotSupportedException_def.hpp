...
/// @brief Method .ctor addr 0x24843ac size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit PlatformNotSupportedException(::StringW message) ;

/// @brief Method .ctor addr 0x2484408 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x248442c size 0x8 virtual false final false
