...
/// @brief Method Init addr 0x24a7418 size 0x64 virtual false final false
 void Init(bool canMethodThrow) ;

/// @brief Method SetFailure addr 0x24a8270 size 0x10 virtual false final false
 void SetFailure(System::Exception unhandledException) ;

/// @brief Method SetFailure addr 0x24a7c70 size 0x3c virtual false final false
 void SetFailure(System::System__Enum__ParseFailureKind failure, ::StringW failureParameter) ;

/// @brief Method SetFailure addr 0x24a7cac size 0x40 virtual false final false
...
/// @brief Method GetEnumParseException addr 0x24a7af4 size 0x17c virtual false final false
...
/// @brief Method .ctor addr 0x24a68b4 size 0x2c virtual false final false
