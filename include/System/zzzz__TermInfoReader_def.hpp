...
/// @brief Method .ctor addr 0x24c4f24 size 0x2d8 virtual false final false
...
/// @brief Method .ctor addr 0x24c51fc size 0x8c virtual false final false
 void _ctor(::StringW term, ::ArrayW<uint8_t> buffer) ;

/// @brief Method DetermineVersion addr 0x24cae88 size 0xb0 virtual false final false
 void DetermineVersion(int16_t magic) ;

/// @brief Method ReadHeader addr 0x24cad94 size 0xc0 virtual false final false
 void ReadHeader(::ArrayW<uint8_t> buffer, ByRef<int32_t> position) ;

/// @brief Method ReadNames addr 0x24cae54 size 0x34 virtual false final false
 void ReadNames(::ArrayW<uint8_t> buffer, ByRef<int32_t> position) ;

/// @brief Method Get addr 0x24c5b84 size 0x60 virtual false final false
 int32_t Get(System::TermInfoNumbers number) ;

/// @brief Method Get addr 0x24c5af4 size 0x90 virtual false final false
 ::StringW Get(System::TermInfoStrings tstr) ;

/// @brief Method GetStringBytes addr 0x24c9a38 size 0x90 virtual false final false
 ::ArrayW<uint8_t> GetStringBytes(System::TermInfoStrings tstr) ;

/// @brief Method GetInt16 addr 0x24caf38 size 0x50 virtual false final false
 int16_t GetInt16(::ArrayW<uint8_t> buffer, int32_t offset) ;

/// @brief Method GetString addr 0x24caf88 size 0x7c virtual false final false
 ::StringW GetString(::ArrayW<uint8_t> buffer, int32_t offset) ;

/// @brief Method GetStringBytes addr 0x24cb004 size 0xb8 virtual false final false
