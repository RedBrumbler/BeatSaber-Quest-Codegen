...
/// @brief Method .ctor addr 0x24cad74 size 0xc virtual false final false
 void _ctor(int32_t value) ;

/// @brief Method .ctor addr 0x24cad80 size 0xc virtual false final false
 void _ctor(int32_t intValue, ::StringW stringValue) ;

/// @brief Method op_Implicit addr 0x24c783c size 0xc virtual false final false
...
/// @brief Method get_Int32 addr 0x24cad8c size 0x8 virtual false final false
 int32_t get_Int32() ;

/// @brief Method get_String addr 0x24ca600 size 0x54 virtual false final false
 ::StringW get_String() ;

/// @brief Method get_Object addr 0x24ca654 size 0x5c virtual false final false
...
/// @brief Method .ctor addr 0x24c9c98 size 0x50 virtual false final false
 void _ctor() ;

/// @brief Method Pop addr 0x24ca56c size 0x94 virtual false final false
 System::System__ParameterizedStrings__FormatParam Pop() ;

/// @brief Method Push addr 0x24ca904 size 0xd8 virtual false final false
 void Push(System::System__ParameterizedStrings__FormatParam item) ;

/// @brief Method Clear addr 0x24c9ce8 size 0x28 virtual false final false
 void Clear() ;
...
/// @brief Method Evaluate addr 0x24c7848 size 0x16c virtual false final false
static ::StringW Evaluate(::StringW format, ::ArrayW<System::System__ParameterizedStrings__FormatParam> args) ;

/// @brief Method EvaluateInternal addr 0x24c9d10 size 0x85c virtual false final false
...
/// @brief Method AsBool addr 0x24caaec size 0xc virtual false final false
static bool AsBool(int32_t i) ;

/// @brief Method AsInt addr 0x24caae4 size 0x8 virtual false final false
static int32_t AsInt(bool b) ;

/// @brief Method StringFromAsciiBytes addr 0x24caaf8 size 0xf8 virtual false final false
static ::StringW StringFromAsciiBytes(::ArrayW<uint8_t> buffer, int32_t offset, int32_t length) ;

/// @brief Method snprintf addr 0x24cabf0 size 0xcc virtual false final false
static int32_t snprintf(void* str, ::cordl_internals::intptr_t size, ::StringW format, ::StringW arg1) ;

/// @brief Method snprintf addr 0x24cacbc size 0xb8 virtual false final false
static int32_t snprintf(void* str, ::cordl_internals::intptr_t size, ::StringW format, int32_t arg1) ;

/// @brief Method FormatPrintF addr 0x24ca6b0 size 0x254 virtual false final false
static ::StringW FormatPrintF(::StringW format, ::bs_hook::Il2CppWrapperType arg) ;

/// @brief Method GetDynamicOrStaticVariables addr 0x24ca9dc size 0x108 virtual false final false
