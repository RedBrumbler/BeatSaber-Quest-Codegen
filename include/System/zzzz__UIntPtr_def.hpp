...
/// @brief Method .ctor addr 0x24cd550 size 0x60 virtual false final false
 void _ctor(uint64_t value) ;

/// @brief Method .ctor addr 0x24cd5b8 size 0xc virtual false final false
 void _ctor(uint32_t value) ;

/// @brief Method .ctor addr 0x24cd5c4 size 0x8 virtual false final false
 void _ctor(void* value) ;

/// @brief Method Equals addr 0x24cd5cc size 0x78 virtual true final false
 bool Equals(::bs_hook::Il2CppWrapperType obj) ;

/// @brief Method GetHashCode addr 0x24cd644 size 0x8 virtual true final false
 int32_t GetHashCode() ;

/// @brief Method ToString addr 0x24cd64c size 0x70 virtual true final false
 ::StringW ToString() ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x24cd6bc size 0xa4 virtual true final true
 void System_Runtime_Serialization_ISerializable_GetObjectData(System::Runtime::Serialization::SerializationInfo info, System::Runtime::Serialization::StreamingContext context) ;

/// @brief Method op_Equality addr 0x24cd760 size 0xc virtual false final false
static bool op_Equality(::cordl_internals::uintptr_t value1, ::cordl_internals::uintptr_t value2) ;

/// @brief Method op_Inequality addr 0x24cd76c size 0xc virtual false final false
static bool op_Inequality(::cordl_internals::uintptr_t value1, ::cordl_internals::uintptr_t value2) ;

/// @brief Method op_Explicit addr 0x24cd778 size 0x4 virtual false final false
static uint64_t op_Explicit_uint64_t(::cordl_internals::uintptr_t value) ;

/// @brief Method op_Explicit addr 0x24cd77c size 0x4 virtual false final false
static uint32_t op_Explicit_uint32_t(::cordl_internals::uintptr_t value) ;

/// @brief Method op_Explicit addr 0x24cd780 size 0x20 virtual false final false
static ::cordl_internals::uintptr_t op_Explicit___cordl_internals__uintptr_t(uint64_t value) ;

/// @brief Method op_Explicit addr 0x24cd7a0 size 0x8 virtual false final false
static ::cordl_internals::uintptr_t op_Explicit___cordl_internals__uintptr_t(uint32_t value) ;

/// @brief Method get_Size addr 0x24cd5b0 size 0x8 virtual false final false
static int32_t get_Size() ;

/// @brief Method System.IEquatable<System.UIntPtr>.Equals addr 0x24cd7a8 size 0x10 virtual true final true
