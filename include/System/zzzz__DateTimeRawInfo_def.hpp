...
/// @brief Method Init addr 0x246b7cc size 0x20 virtual false final false
 void Init(void* numberBuffer) ;

/// @brief Method AddNumber addr 0x246b7ec size 0x18 virtual false final false
 void AddNumber(int32_t value) ;

/// @brief Method GetNumber addr 0x246b804 size 0xc virtual false final false
