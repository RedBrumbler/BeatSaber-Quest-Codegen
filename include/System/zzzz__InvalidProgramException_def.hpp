...
/// @brief Method .ctor addr 0x24735a4 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "message", ty: "::StringW", modifiers: "", def_value: None }]
explicit InvalidProgramException(::StringW message) ;

/// @brief Method .ctor addr 0x2473600 size 0x24 virtual false final false
...
/// @brief Method .ctor addr 0x2473624 size 0x8 virtual false final false
