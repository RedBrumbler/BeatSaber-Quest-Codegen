...
/// @brief Method .ctor addr 0x2484434 size 0x5c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "Seed", ty: "int32_t", modifiers: "", def_value: None }]
explicit Random(int32_t Seed) ;

/// @brief Method .ctor addr 0x2484650 size 0x1b0 virtual false final false
 void _ctor(int32_t Seed) ;

/// @brief Method Sample addr 0x2484800 size 0x20 virtual true final false
 double_t Sample() ;

/// @brief Method InternalSample addr 0x2484820 size 0x90 virtual false final false
 int32_t InternalSample() ;

/// @brief Method GenerateSeed addr 0x2484490 size 0x1c0 virtual false final false
static int32_t GenerateSeed() ;

/// @brief Method GenerateGlobalSeed addr 0x24848b0 size 0x24 virtual false final false
static int32_t GenerateGlobalSeed() ;

/// @brief Method Next addr 0x24848d4 size 0x4 virtual true final false
 int32_t Next() ;

/// @brief Method GetSampleForLargeRange addr 0x24848d8 size 0x4c virtual false final false
 double_t GetSampleForLargeRange() ;

/// @brief Method Next addr 0x2484924 size 0x11c virtual true final false
 int32_t Next(int32_t minValue, int32_t maxValue) ;

/// @brief Method Next addr 0x2484a40 size 0xc8 virtual true final false
 int32_t Next(int32_t maxValue) ;

/// @brief Method NextDouble addr 0x2484b08 size 0xc virtual true final false
 double_t NextDouble() ;

/// @brief Method NextBytes addr 0x2484b14 size 0xb0 virtual true final false
