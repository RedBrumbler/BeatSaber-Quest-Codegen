...
/// @brief Method .ctor addr 0x249c510 size 0x28 virtual false final false
 void _ctor(System::LocalDataStore store) ;

/// @brief Method Finalize addr 0x249c538 size 0x9c virtual true final false
 void Finalize() ;

/// @brief Method get_Store addr 0x249c5f0 size 0x8 virtual false final false
