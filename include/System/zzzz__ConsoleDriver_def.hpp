...
/// @brief Method CreateNullConsoleDriver addr 0x24bc114 size 0x4c virtual false final false
static System::IConsoleDriver CreateNullConsoleDriver() ;

/// @brief Method CreateWindowsConsoleDriver addr 0x24bc160 size 0x5c virtual false final false
static System::IConsoleDriver CreateWindowsConsoleDriver() ;

/// @brief Method CreateTermInfoDriver addr 0x24bc1bc size 0x60 virtual false final false
static System::IConsoleDriver CreateTermInfoDriver(::StringW term) ;

/// @brief Method ReadKey addr 0x24bbad8 size 0xd8 virtual false final false
static System::ConsoleKeyInfo ReadKey(bool intercept) ;

/// @brief Method get_IsConsole addr 0x24bb328 size 0x138 virtual false final false
static bool get_IsConsole() ;

/// @brief Method Isatty addr 0x24bc568 size 0x4 virtual false final false
static bool Isatty(::cordl_internals::intptr_t handle) ;

/// @brief Method InternalKeyAvailable addr 0x24bc56c size 0x4 virtual false final false
static int32_t InternalKeyAvailable(int32_t ms_timeout) ;

/// @brief Method TtySetup addr 0x24bc570 size 0x4 virtual false final false
static bool TtySetup(::StringW keypadXmit, ::StringW teardown, ByRef<::ArrayW<uint8_t>> control_characters, ByRef<void*> address) ;

/// @brief Method SetEcho addr 0x24bc574 size 0x8 virtual false final false
