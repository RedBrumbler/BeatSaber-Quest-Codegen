...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14580), inst: 2 })
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14581), inst: 2 })
