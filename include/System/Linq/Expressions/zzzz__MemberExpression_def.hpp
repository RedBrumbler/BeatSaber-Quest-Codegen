...
namespace System::Linq::Expressions {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14601))}
...
/// @brief Method get_Member addr 0x26b35a8 size 0xc virtual false final false
 System::Reflection::MemberInfo get_Member() ;

/// @brief Method GetMember addr 0x26b35b4 size 0x24 virtual true final false
