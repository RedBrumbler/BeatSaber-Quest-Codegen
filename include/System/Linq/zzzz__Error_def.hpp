...
/// @brief Method ArgumentNull addr 0x26b1cd0 size 0x64 virtual false final false
static System::Exception ArgumentNull(::StringW s) ;

/// @brief Method ArgumentOutOfRange addr 0x26b1d34 size 0x64 virtual false final false
static System::Exception ArgumentOutOfRange(::StringW s) ;

/// @brief Method MoreThanOneElement addr 0x26b1d98 size 0x74 virtual false final false
static System::Exception MoreThanOneElement() ;

/// @brief Method MoreThanOneMatch addr 0x26b1e0c size 0x74 virtual false final false
static System::Exception MoreThanOneMatch() ;

/// @brief Method NoElements addr 0x26b1e80 size 0x74 virtual false final false
static System::Exception NoElements() ;

/// @brief Method NoMatch addr 0x26b1ef4 size 0x74 virtual false final false
static System::Exception NoMatch() ;

/// @brief Method NotSupported addr 0x26b1f68 size 0x5c virtual false final false
