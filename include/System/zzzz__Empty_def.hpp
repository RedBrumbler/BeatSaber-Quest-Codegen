...
/// @brief Method .ctor addr 0x24a6640 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method ToString addr 0x24a6648 size 0x48 virtual true final false
 ::StringW ToString() ;

/// @brief Method GetObjectData addr 0x24a6690 size 0x6c virtual true final true
