...
/// @brief Method FindCompressionRange addr 0x27e2a40 size 0xe0 virtual false final false
static System::ValueTuple_2<int32_t,int32_t> FindCompressionRange(System::ReadOnlySpan_1<uint16_t> numbers) ;

/// @brief Method ShouldHaveIpv4Embedded addr 0x27e2b20 size 0xd0 virtual false final false
static bool ShouldHaveIpv4Embedded(System::ReadOnlySpan_1<uint16_t> numbers) ;

/// @brief Method IsValidStrict addr 0x27e2bf0 size 0x344 virtual false final false
static bool IsValidStrict(void* name, int32_t start, ByRef<int32_t> end) ;

/// @brief Method Parse addr 0x27e2f34 size 0x50c virtual false final false
static void Parse(System::ReadOnlySpan_1<char16_t> address, void* numbers, int32_t start, ByRef<::StringW> scopeId) ;

/// @brief Method ParseCanonicalName addr 0x27e3440 size 0x63c virtual false final false
static ::StringW ParseCanonicalName(::StringW str, int32_t start, ByRef<bool> isLoopback, ByRef<::StringW> scopeId) ;

/// @brief Method IsLoopback addr 0x27e3a7c size 0xe0 virtual false final false
static bool IsLoopback(System::ReadOnlySpan_1<uint16_t> numbers) ;

/// @brief Method InternalIsValid addr 0x27e3b5c size 0x2dc virtual false final false
static bool InternalIsValid(void* name, int32_t start, ByRef<int32_t> end, bool validateStrictAddress) ;

/// @brief Method IsValid addr 0x27e3e38 size 0x8 virtual false final false
