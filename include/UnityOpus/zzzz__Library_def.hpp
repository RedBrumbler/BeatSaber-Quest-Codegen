...
/// @brief Method OpusEncoderCreate addr 0x220e64c size 0x9c virtual false final false
...
/// @brief Method OpusEncode addr 0x220ea60 size 0xbc virtual false final false
...
/// @brief Method OpusEncodeFloat addr 0x220e798 size 0xbc virtual false final false
...
/// @brief Method OpusEncoderDestroy addr 0x220e8d8 size 0x7c virtual false final false
static void OpusEncoderDestroy(::cordl_internals::intptr_t encoder) ;

/// @brief Method OpusEncoderSetBitrate addr 0x220e330 size 0x84 virtual false final false
static int32_t OpusEncoderSetBitrate(::cordl_internals::intptr_t encoder, int32_t bitrate) ;

/// @brief Method OpusEncoderSetComplexity addr 0x220e3e4 size 0x84 virtual false final false
static int32_t OpusEncoderSetComplexity(::cordl_internals::intptr_t encoder, int32_t complexity) ;

/// @brief Method OpusEncoderSetSignal addr 0x220e498 size 0x84 virtual false final false
static int32_t OpusEncoderSetSignal(::cordl_internals::intptr_t encoder, UnityOpus::OpusSignal signal) ;

/// @brief Method OpusDecoderCreate addr 0x220de24 size 0x94 virtual false final false
...
/// @brief Method OpusDecode addr 0x220eb1c size 0xc4 virtual false final false
...
/// @brief Method OpusDecodeFloat addr 0x220df84 size 0xc4 virtual false final false
...
/// @brief Method OpusDecoderDestroy addr 0x220e178 size 0x7c virtual false final false
static void OpusDecoderDestroy(::cordl_internals::intptr_t decoder) ;

/// @brief Method OpusPcmSoftClip addr 0x220e048 size 0xac virtual false final false
...
/// @brief Method .ctor addr 0x220ebe0 size 0x8 virtual false final false
 void _ctor() ;
