...
/// @brief Method get_Bitrate addr 0x220e300 size 0x8 virtual false final false
 int32_t get_Bitrate() ;

/// @brief Method set_Bitrate addr 0x220e308 size 0x28 virtual false final false
 void set_Bitrate(int32_t value) ;

/// @brief Method get_Complexity addr 0x220e3b4 size 0x8 virtual false final false
 int32_t get_Complexity() ;

/// @brief Method set_Complexity addr 0x220e3bc size 0x28 virtual false final false
 void set_Complexity(int32_t value) ;

/// @brief Method get_Signal addr 0x220e468 size 0x8 virtual false final false
 UnityOpus::OpusSignal get_Signal() ;

/// @brief Method set_Signal addr 0x220e470 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x220e51c size 0x130 virtual false final false
...
/// @brief Method Encode addr 0x220e6e8 size 0xb0 virtual false final false
 int32_t Encode(::ArrayW<float_t> pcm, int32_t count, ::ArrayW<uint8_t> output) ;

/// @brief Method Dispose addr 0x220e854 size 0x84 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Finalize addr 0x220e954 size 0xa0 virtual true final false
 void Finalize() ;

/// @brief Method Dispose addr 0x220e9f4 size 0x6c virtual true final true
 void Dispose() ;
