...
/// @brief Method .ctor addr 0x220dcd0 size 0x154 virtual false final false
 void _ctor(UnityOpus::SamplingFrequency samplingFrequency, UnityOpus::NumChannels channels) ;

/// @brief Method Decode addr 0x220deb8 size 0xcc virtual false final false
 int32_t Decode(::ArrayW<uint8_t> data, int32_t dataLength, ::ArrayW<float_t> pcm, int32_t decodeFec) ;

/// @brief Method Dispose addr 0x220e0f4 size 0x84 virtual true final false
 void Dispose(bool disposing) ;

/// @brief Method Finalize addr 0x220e1f4 size 0xa0 virtual true final false
 void Finalize() ;

/// @brief Method Dispose addr 0x220e294 size 0x6c virtual true final true
 void Dispose() ;
