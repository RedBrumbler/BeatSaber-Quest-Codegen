...
/// @brief Method GetClipPlaneMaterial addr 0x20d4928 size 0x104 virtual false final false
...
/// @brief Method GetGroundClipPlaneMaterial addr 0x20d4a2c size 0x9c virtual false final false
 UnityEngine::Material GetGroundClipPlaneMaterial(bool debugClipPlane, UnityEngine::Rendering::ColorWriteMask colorWriteMask) ;

/// @brief Method get_useDeferredRendering addr 0x20d4ac8 size 0x4c virtual false final false
 bool get_useDeferredRendering() ;

/// @brief Method get_interlacedRendering addr 0x20d4b14 size 0xc virtual false final false
 bool get_interlacedRendering() ;

/// @brief Method get_canRenderBackground addr 0x20d4b2c size 0x8c virtual false final false
 bool get_canRenderBackground() ;

/// @brief Method get_canRenderForeground addr 0x20d4bb8 size 0xa0 virtual false final false
 bool get_canRenderForeground() ;

/// @brief Method get_canRenderOptimized addr 0x20d4c58 size 0x78 virtual false final false
...
/// @brief Method .ctor addr 0x20d30c0 size 0x17c virtual false final false
 void _ctor(LIV::SDK::Unity::LIV liv) ;

/// @brief Method UpdateCameraSettings addr 0x20d54ac size 0x84 virtual false final false
 void UpdateCameraSettings() ;

/// @brief Method Render addr 0x20d3784 size 0xc4 virtual false final false
 void Render() ;

/// @brief Method RenderBackground addr 0x20d5e18 size 0x118 virtual false final false
 void RenderBackground() ;

/// @brief Method RenderForeground addr 0x20d5f30 size 0x4c0 virtual false final false
 void RenderForeground() ;

/// @brief Method RenderOptimized addr 0x20d63f0 size 0x500 virtual false final false
 void RenderOptimized() ;

/// @brief Method CreateAssets addr 0x20d4da0 size 0x70c virtual false final false
 void CreateAssets() ;

/// @brief Method DestroyAssets addr 0x20d7968 size 0x184 virtual false final false
 void DestroyAssets() ;

/// @brief Method Dispose addr 0x20d323c size 0x38 virtual true final true
 void Dispose() ;

/// @brief Method get_liv addr 0x20d7be4 size 0x8 virtual false final false
 LIV::SDK::Unity::LIV get_liv() ;

/// @brief Method get_outputFrame addr 0x20d7bec size 0x10 virtual false final false
 LIV::SDK::Unity::SDKOutputFrame get_outputFrame() ;

/// @brief Method get_inputFrame addr 0x20d7bfc size 0x10 virtual false final false
 LIV::SDK::Unity::SDKInputFrame get_inputFrame() ;

/// @brief Method get_resolution addr 0x20d7c0c size 0x8 virtual false final false
 LIV::SDK::Unity::SDKResolution get_resolution() ;

/// @brief Method get_cameraInstance addr 0x20d7c14 size 0x8 virtual false final false
 UnityEngine::Camera get_cameraInstance() ;

/// @brief Method get_cameraReference addr 0x20d709c size 0x8c virtual false final false
 UnityEngine::Camera get_cameraReference() ;

/// @brief Method get_hmdCamera addr 0x20d7c1c size 0x1c virtual false final false
 UnityEngine::Camera get_hmdCamera() ;

/// @brief Method get_stage addr 0x20d7c38 size 0x18 virtual false final false
 UnityEngine::Transform get_stage() ;

/// @brief Method get_stageTransform addr 0x20d7c50 size 0x1c virtual false final false
 UnityEngine::Transform get_stageTransform() ;

/// @brief Method get_stageLocalToWorldMatrix addr 0x20d7c6c size 0xf8 virtual false final false
 UnityEngine::Matrix4x4 get_stageLocalToWorldMatrix() ;

/// @brief Method get_localToWorldMatrix addr 0x20d56e8 size 0xc4 virtual false final false
 UnityEngine::Matrix4x4 get_localToWorldMatrix() ;

/// @brief Method get_spectatorLayerMask addr 0x20d57ac size 0x20 virtual false final false
 int32_t get_spectatorLayerMask() ;

/// @brief Method get_disableStandardAssets addr 0x20d6d4c size 0x1c virtual false final false
 bool get_disableStandardAssets() ;

/// @brief Method get_canSetPose addr 0x20d7d64 size 0x20 virtual false final false
 bool get_canSetPose() ;

/// @brief Method SetPose addr 0x20d7d84 size 0x2f4 virtual false final false
 bool SetPose(UnityEngine::Vector3 position, UnityEngine::Quaternion rotation, float_t verticalFieldOfView, bool useLocalSpace) ;

/// @brief Method SetGroundPlane addr 0x20d8228 size 0x194 virtual false final false
 void SetGroundPlane(float_t distance, UnityEngine::Vector3 normal, bool useLocalSpace) ;

/// @brief Method SetGroundPlane addr 0x20d83bc size 0x78 virtual false final false
 void SetGroundPlane(UnityEngine::Plane plane, bool useLocalSpace) ;

/// @brief Method SetGroundPlane addr 0x20d8434 size 0x1a0 virtual false final false
 void SetGroundPlane(UnityEngine::Transform transform, bool useLocalSpace) ;

/// @brief Method ReleaseBridgePoseControl addr 0x20d7aec size 0x64 virtual false final false
 void ReleaseBridgePoseControl() ;

/// @brief Method UpdateBridgeResolution addr 0x20d5a18 size 0x58 virtual false final false
 void UpdateBridgeResolution() ;

/// @brief Method UpdateBridgeInputFrame addr 0x20d5530 size 0x1b8 virtual false final false
 void UpdateBridgeInputFrame() ;

/// @brief Method InvokePreRender addr 0x20d5de0 size 0x38 virtual false final false
 void InvokePreRender() ;

/// @brief Method IvokePostRender addr 0x20d68f0 size 0x38 virtual false final false
 void IvokePostRender() ;

/// @brief Method InvokePreRenderBackground addr 0x20d6b38 size 0x38 virtual false final false
 void InvokePreRenderBackground() ;

/// @brief Method InvokePostRenderBackground addr 0x20d6c8c size 0x38 virtual false final false
 void InvokePostRenderBackground() ;

/// @brief Method InvokePreRenderForeground addr 0x20d6f60 size 0x38 virtual false final false
 void InvokePreRenderForeground() ;

/// @brief Method InvokePostRenderForeground addr 0x20d6f98 size 0x38 virtual false final false
 void InvokePostRenderForeground() ;

/// @brief Method CreateBackgroundTexture addr 0x20d85f8 size 0x94 virtual false final false
 void CreateBackgroundTexture() ;

/// @brief Method CreateForegroundTexture addr 0x20d87fc size 0x94 virtual false final false
 void CreateForegroundTexture() ;

/// @brief Method CreateOptimizedTexture addr 0x20d8890 size 0x94 virtual false final false
 void CreateOptimizedTexture() ;

/// @brief Method CreateComplexClipPlaneTexture addr 0x20d8924 size 0x94 virtual false final false
 void CreateComplexClipPlaneTexture() ;

/// @brief Method UpdateTextures addr 0x20d5b60 size 0x280 virtual false final false
 void UpdateTextures() ;

/// @brief Method SendTextureToBridge addr 0x20d6b70 size 0x11c virtual false final false
