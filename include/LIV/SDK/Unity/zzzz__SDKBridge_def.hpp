...
/// @brief Method AddStringToChannel addr 0x20d3898 size 0x8 virtual false final false
static int32_t AddStringToChannel(int32_t slot, ::cordl_internals::intptr_t str, int32_t length, uint64_t tag) ;

/// @brief Method addtexture addr 0x20d38a0 size 0x8 virtual false final false
static int32_t addtexture(::cordl_internals::intptr_t sourcetexture, uint64_t tag) ;

/// @brief Method GetObjectTimeStamp addr 0x20d38a8 size 0x8 virtual false final false
static uint64_t GetObjectTimeStamp(::cordl_internals::intptr_t obj) ;

/// @brief Method GetCurrentTimeTicks addr 0x20d38b0 size 0x8 virtual false final false
static uint64_t GetCurrentTimeTicks() ;

/// @brief Method GetIsCaptureActive addr 0x20d38b8 size 0x8 virtual false final false
static bool GetIsCaptureActive() ;

/// @brief Method GetRenderEventFunc addr 0x20d38c0 size 0x48 virtual false final false
static ::cordl_internals::intptr_t GetRenderEventFunc() ;

/// @brief Method GetCompositorChannelObject addr 0x20d3908 size 0x48 virtual false final false
static ::cordl_internals::intptr_t GetCompositorChannelObject(int32_t slot, uint64_t tag, uint64_t timestamp) ;

/// @brief Method AddObjectToCompositorChannel addr 0x20d3950 size 0x8 virtual false final false
static int32_t AddObjectToCompositorChannel(int32_t slot, ::cordl_internals::intptr_t obj, int32_t objectsize, uint64_t tag) ;

/// @brief Method AddObjectToFrame addr 0x20d3958 size 0x8 virtual false final false
static int32_t AddObjectToFrame(::cordl_internals::intptr_t obj, int32_t objectsize, uint64_t tag) ;

/// @brief Method updatinputframe addr 0x20d3960 size 0x48 virtual false final false
static ::cordl_internals::intptr_t updatinputframe(::cordl_internals::intptr_t InputFrame) ;

/// @brief Method GetViewportTexture addr 0x20d39a8 size 0x48 virtual false final false
static ::cordl_internals::intptr_t GetViewportTexture() ;

/// @brief Method GetChannelObject addr 0x20d39f0 size 0x48 virtual false final false
static ::cordl_internals::intptr_t GetChannelObject(int32_t slot, uint64_t tag, uint64_t timestamp) ;

/// @brief Method AddObjectToChannel addr 0x20d3a38 size 0x8 virtual false final false
static int32_t AddObjectToChannel(int32_t slot, ::cordl_internals::intptr_t obj, int32_t objectsize, uint64_t tag) ;

/// @brief Method Tag addr 0x20d3a40 size 0x84 virtual false final false
static uint64_t Tag(::StringW str) ;

/// @brief Method AddString addr 0x20d3ac4 size 0xfc virtual false final false
static void AddString(::StringW tag, ::StringW value, int32_t slot) ;

/// @brief Method AddTexture addr 0x20d3bc0 size 0xc0 virtual false final false
static void AddTexture(LIV::SDK::Unity::SDKTexture texture, uint64_t tag) ;

/// @brief Method GetObjectTime addr 0x20d3c80 size 0x5c virtual false final false
static uint64_t GetObjectTime(::cordl_internals::intptr_t objectptr) ;

/// @brief Method GetCurrentTime addr 0x20d3cdc size 0x5c virtual false final false
static uint64_t GetCurrentTime() ;

/// @brief Method get_IsActive addr 0x20d2ae0 size 0x98 virtual false final false
static bool get_IsActive() ;

/// @brief Method IssuePluginEvent addr 0x20d3d38 size 0xb0 virtual false final false
static void IssuePluginEvent() ;

/// @brief Method SubmitApplicationOutput addr 0x20d32f4 size 0x1f0 virtual false final false
...
/// @brief Method UpdateInputFrame addr 0x20d3de8 size 0x2c0 virtual false final false
static bool UpdateInputFrame(ByRef<LIV::SDK::Unity::SDKInputFrame> setframe) ;

/// @brief Method GetViewfinderTexture addr 0x20d41ec size 0x1d4 virtual false final false
static LIV::SDK::Unity::SDKTexture GetViewfinderTexture() ;

/// @brief Method AddTexture addr 0x20d441c size 0x130 virtual false final false
static void AddTexture(LIV::SDK::Unity::SDKTexture texture) ;

/// @brief Method CreateFrame addr 0x20d454c size 0x168 virtual false final false
static void CreateFrame(LIV::SDK::Unity::SDKOutputFrame frame) ;

/// @brief Method SetGroundPlane addr 0x20d46b4 size 0xa0 virtual false final false
static void SetGroundPlane(LIV::SDK::Unity::SDKPlane groundPlane) ;

/// @brief Method GetResolution addr 0x20d4754 size 0x130 virtual false final false
