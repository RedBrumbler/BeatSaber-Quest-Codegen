...
/// @brief Method op_Implicit addr 0x20d99c0 size 0x5c virtual false final false
static LIV::SDK::Unity::SDKPlane op_Implicit_LIV__SDK__Unity__SDKPlane(UnityEngine::Plane v) ;

/// @brief Method get_empty addr 0x20d9a1c size 0x14 virtual false final false
static LIV::SDK::Unity::SDKPlane get_empty() ;

/// @brief Method ToString addr 0x20d9a30 size 0xc4 virtual true final false
 ::StringW ToString() ;
