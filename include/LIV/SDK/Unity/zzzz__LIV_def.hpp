...
/// @brief Method .ctor addr 0x20d2cd0 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x20d36b0 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x20d36b4 size 0xd0 virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x20d3848 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x20d3850 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x20d3890 size 0x8 virtual true final true
...
/// @brief Method get_stage addr 0x20d2454 size 0x90 virtual false final false
 UnityEngine::Transform get_stage() ;

/// @brief Method set_stage addr 0x20d24e4 size 0x90 virtual false final false
 void set_stage(UnityEngine::Transform value) ;

/// @brief Method get_trackedSpaceOrigin addr 0x20d2588 size 0x4 virtual false final false
 UnityEngine::Transform get_trackedSpaceOrigin() ;

/// @brief Method set_trackedSpaceOrigin addr 0x20d258c size 0x4 virtual false final false
 void set_trackedSpaceOrigin(UnityEngine::Transform value) ;

/// @brief Method get_stageLocalToWorldMatrix addr 0x20d2590 size 0xf8 virtual false final false
 UnityEngine::Matrix4x4 get_stageLocalToWorldMatrix() ;

/// @brief Method get_stageWorldToLocalMatrix addr 0x20d2688 size 0xf8 virtual false final false
 UnityEngine::Matrix4x4 get_stageWorldToLocalMatrix() ;

/// @brief Method get_stageTransform addr 0x20d2780 size 0x8 virtual false final false
 UnityEngine::Transform get_stageTransform() ;

/// @brief Method set_stageTransform addr 0x20d2788 size 0x8 virtual false final false
 void set_stageTransform(UnityEngine::Transform value) ;

/// @brief Method get_HMDCamera addr 0x20d2790 size 0x8 virtual false final false
 UnityEngine::Camera get_HMDCamera() ;

/// @brief Method set_HMDCamera addr 0x20d2798 size 0xec virtual false final false
 void set_HMDCamera(UnityEngine::Camera value) ;

/// @brief Method get_MRCameraPrefab addr 0x20d2884 size 0x8 virtual false final false
 UnityEngine::Camera get_MRCameraPrefab() ;

/// @brief Method set_MRCameraPrefab addr 0x20d288c size 0x84 virtual false final false
 void set_MRCameraPrefab(UnityEngine::Camera value) ;

/// @brief Method get_disableStandardAssets addr 0x20d2910 size 0x8 virtual false final false
 bool get_disableStandardAssets() ;

/// @brief Method set_disableStandardAssets addr 0x20d2918 size 0xc virtual false final false
 void set_disableStandardAssets(bool value) ;

/// @brief Method get_spectatorLayerMask addr 0x20d2924 size 0x8 virtual false final false
 UnityEngine::LayerMask get_spectatorLayerMask() ;

/// @brief Method set_spectatorLayerMask addr 0x20d292c size 0x8 virtual false final false
 void set_spectatorLayerMask(UnityEngine::LayerMask value) ;

/// @brief Method get_excludeBehaviours addr 0x20d2934 size 0x8 virtual false final false
 ::ArrayW<::StringW> get_excludeBehaviours() ;

/// @brief Method set_excludeBehaviours addr 0x20d293c size 0x20 virtual false final false
 void set_excludeBehaviours(::ArrayW<::StringW> value) ;

/// @brief Method get_fixPostEffectsAlpha addr 0x20d295c size 0x8 virtual false final false
 bool get_fixPostEffectsAlpha() ;

/// @brief Method set_fixPostEffectsAlpha addr 0x20d2964 size 0xc virtual false final false
 void set_fixPostEffectsAlpha(bool value) ;

/// @brief Method get_isValid addr 0x20d2970 size 0xf4 virtual false final false
 bool get_isValid() ;

/// @brief Method get_isActive addr 0x20d2a64 size 0x8 virtual false final false
 bool get_isActive() ;

/// @brief Method get__isReady addr 0x20d2a6c size 0x74 virtual false final false
 bool get__isReady() ;

/// @brief Method get_render addr 0x20d2b78 size 0x8 virtual false final false
 LIV::SDK::Unity::SDKRender get_render() ;

/// @brief Method OnEnable addr 0x20d2b80 size 0xc virtual false final false
 void OnEnable() ;

/// @brief Method Update addr 0x20d2bd0 size 0x18 virtual false final false
 void Update() ;

/// @brief Method OnDisable addr 0x20d2c60 size 0x8 virtual false final false
 void OnDisable() ;

/// @brief Method WaitForUnityEndOfFrame addr 0x20d2c68 size 0x68 virtual false final false
 System::Collections::IEnumerator WaitForUnityEndOfFrame() ;

/// @brief Method Activate addr 0x20d2cf8 size 0x18 virtual false final false
 void Activate() ;

/// @brief Method UpdateSDKReady addr 0x20d2b8c size 0x44 virtual false final false
 void UpdateSDKReady() ;

/// @brief Method OnSDKReadyChanged addr 0x20d2d10 size 0xc virtual false final false
 void OnSDKReadyChanged(bool value) ;

/// @brief Method OnSDKActivate addr 0x20d2d1c size 0xac virtual false final false
 void OnSDKActivate() ;

/// @brief Method OnSDKDeactivate addr 0x20d2dc8 size 0xb4 virtual false final false
 void OnSDKDeactivate() ;

/// @brief Method CreateAssets addr 0x20d2fc8 size 0x70 virtual false final false
 void CreateAssets() ;

/// @brief Method DestroyAssets addr 0x20d30a0 size 0x20 virtual false final false
 void DestroyAssets() ;

/// @brief Method StartRenderCoroutine addr 0x20d3038 size 0x44 virtual false final false
 void StartRenderCoroutine() ;

/// @brief Method StopRenderCoroutine addr 0x20d307c size 0x24 virtual false final false
 void StopRenderCoroutine() ;

/// @brief Method SubmitSDKOutput addr 0x20d2e7c size 0x14c virtual false final false
 void SubmitSDKOutput() ;

/// @brief Method Invalidate addr 0x20d2be8 size 0x78 virtual false final false
 void Invalidate() ;

// Ctor Parameters []
explicit LIV() ;

/// @brief Method .ctor addr 0x20d34f0 size 0x1c0 virtual false final false
 void _ctor() ;
