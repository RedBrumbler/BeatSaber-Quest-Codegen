...
/// @brief Method get_zero addr 0x20d8c10 size 0x10 virtual false final false
static LIV::SDK::Unity::SDKVector3 get_zero() ;

/// @brief Method get_one addr 0x20d8c20 size 0x10 virtual false final false
static LIV::SDK::Unity::SDKVector3 get_one() ;

/// @brief Method get_forward addr 0x20d8c30 size 0x10 virtual false final false
static LIV::SDK::Unity::SDKVector3 get_forward() ;

/// @brief Method get_up addr 0x20d8c40 size 0x10 virtual false final false
static LIV::SDK::Unity::SDKVector3 get_up() ;

/// @brief Method get_right addr 0x20d8c50 size 0x10 virtual false final false
static LIV::SDK::Unity::SDKVector3 get_right() ;

/// @brief Method op_Implicit addr 0x20d8c60 size 0x4 virtual false final false
static UnityEngine::Vector3 op_Implicit_UnityEngine__Vector3(LIV::SDK::Unity::SDKVector3 v) ;

/// @brief Method op_Implicit addr 0x20d81dc size 0x4 virtual false final false
static LIV::SDK::Unity::SDKVector3 op_Implicit_LIV__SDK__Unity__SDKVector3(UnityEngine::Vector3 v) ;

/// @brief Method op_Addition addr 0x20d8c64 size 0x10 virtual false final false
static LIV::SDK::Unity::SDKVector3 op_Addition(LIV::SDK::Unity::SDKVector3 lhs, LIV::SDK::Unity::SDKVector3 rhs) ;

/// @brief Method op_Subtraction addr 0x20d8c74 size 0x10 virtual false final false
static LIV::SDK::Unity::SDKVector3 op_Subtraction(LIV::SDK::Unity::SDKVector3 lhs, LIV::SDK::Unity::SDKVector3 rhs) ;

/// @brief Method op_Multiply addr 0x20d8c84 size 0x10 virtual false final false
static LIV::SDK::Unity::SDKVector3 op_Multiply(LIV::SDK::Unity::SDKVector3 lhs, LIV::SDK::Unity::SDKVector3 rhs) ;

/// @brief Method op_Multiply addr 0x20d8c94 size 0x10 virtual false final false
static LIV::SDK::Unity::SDKVector3 op_Multiply(LIV::SDK::Unity::SDKVector3 lhs, float_t rhs) ;

/// @brief Method ToString addr 0x20d8ca4 size 0xc4 virtual true final false
 ::StringW ToString() ;
