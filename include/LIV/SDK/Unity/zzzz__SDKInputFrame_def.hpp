...
/// @brief Method get_empty addr 0x20d40a8 size 0x144 virtual false final false
static LIV::SDK::Unity::SDKInputFrame get_empty() ;

/// @brief Method ReleaseControl addr 0x20d85d4 size 0x10 virtual false final false
 void ReleaseControl() ;

/// @brief Method ObtainControl addr 0x20d85e4 size 0x14 virtual false final false
 void ObtainControl() ;

/// @brief Method ToString addr 0x20d9ff8 size 0x334 virtual true final false
 ::StringW ToString() ;
