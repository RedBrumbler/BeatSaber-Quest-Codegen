...
/// @brief Method StartRendering addr 0x20d6ab0 size 0x44 virtual false final false
static void StartRendering() ;

/// @brief Method StopRendering addr 0x20d6d08 size 0x44 virtual false final false
static void StopRendering() ;

/// @brief Method StartForegroundRendering addr 0x20d6f1c size 0x44 virtual false final false
static void StartForegroundRendering() ;

/// @brief Method StopForegroundRendering addr 0x20d6fd0 size 0x44 virtual false final false
static void StopForegroundRendering() ;

/// @brief Method StartBackgroundRendering addr 0x20d6af4 size 0x44 virtual false final false
static void StartBackgroundRendering() ;

/// @brief Method StopBackgroundRendering addr 0x20d6cc4 size 0x44 virtual false final false
