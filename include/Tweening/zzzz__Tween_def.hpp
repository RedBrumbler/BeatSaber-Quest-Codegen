...
/// @brief Method get_isStarted addr 0x28acb58 size 0x8 virtual false final false
 bool get_isStarted() ;

/// @brief Method get_isActive addr 0x28acb60 size 0x30 virtual false final false
 bool get_isActive() ;

/// @brief Method get_isComplete addr 0x28acb90 size 0x14 virtual false final false
 bool get_isComplete() ;

/// @brief Method get_isKilled addr 0x28acba4 size 0x8 virtual false final false
 bool get_isKilled() ;

/// @brief Method get_progress addr 0x28acbac size 0x8 virtual false final false
 float_t get_progress() ;

/// @brief Method get_startTime addr 0x28acbb4 size 0x8 virtual false final false
 float_t get_startTime() ;

/// @brief Method get_duration addr 0x28acbbc size 0x8 virtual false final false
 float_t get_duration() ;

/// @brief Method set_duration addr 0x28acbc4 size 0x8 virtual false final false
 void set_duration(float_t value) ;

/// @brief Method get_loop addr 0x28acbcc size 0x8 virtual false final false
 bool get_loop() ;

/// @brief Method set_loop addr 0x28acbd4 size 0xc virtual false final false
 void set_loop(bool value) ;

/// @brief Method get_delay addr 0x28acbe0 size 0x8 virtual false final false
 float_t get_delay() ;

/// @brief Method set_delay addr 0x28acbe8 size 0x8 virtual false final false
 void set_delay(float_t value) ;

/// @brief Method get_easeType addr 0x28acbf0 size 0x8 virtual false final false
 GlobalNamespace::EaseType get_easeType() ;

/// @brief Method set_easeType addr 0x28acbf8 size 0x8 virtual false final false
 void set_easeType(GlobalNamespace::EaseType value) ;

/// @brief Method Kill addr 0x28acc00 size 0xc virtual false final false
 void Kill() ;

/// @brief Method Restart addr 0x28acc0c size 0x10 virtual false final false
 void Restart(float_t startTime) ;

/// @brief Method Resume addr 0x28acc1c size 0x8 virtual false final false
 void Resume() ;

/// @brief Method SetStartTimeAndEndTime addr 0x28acc24 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x28acc30 size 0x10 virtual false final false
 void _ctor() ;
