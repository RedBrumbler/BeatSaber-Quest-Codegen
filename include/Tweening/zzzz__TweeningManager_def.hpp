...
/// @brief Method Start addr 0x28acc40 size 0x64 virtual false final false
 void Start() ;

/// @brief Method LateUpdate addr 0x28acca4 size 0x1ec virtual false final false
 void LateUpdate() ;

/// @brief Method GetTime addr 0x0 size 0xffffffffffffffff virtual true final false
 float_t GetTime() ;

/// @brief Method AddTween addr 0x28ad054 size 0x4c virtual false final false
 Tweening::Tween AddTween(Tweening::Tween tween, ::bs_hook::Il2CppWrapperType owner) ;

/// @brief Method RestartTween addr 0x28ad1d4 size 0x58 virtual false final false
 Tweening::Tween RestartTween(Tweening::Tween tween, ::bs_hook::Il2CppWrapperType owner) ;

/// @brief Method ResumeTween addr 0x28ad22c size 0x24 virtual false final false
 Tweening::Tween ResumeTween(Tweening::Tween tween, ::bs_hook::Il2CppWrapperType owner) ;

/// @brief Method KillAllTweens addr 0x28ad250 size 0x17c virtual false final false
 void KillAllTweens(::bs_hook::Il2CppWrapperType owner) ;

/// @brief Method RemoveTweenFromOwnerDictionary addr 0x28ace90 size 0x1c4 virtual false final false
 void RemoveTweenFromOwnerDictionary(Tweening::Tween tween) ;

/// @brief Method AddTweenToDataStructures addr 0x28ad0a0 size 0x134 virtual false final false
 bool AddTweenToDataStructures(Tweening::Tween tween, ::bs_hook::Il2CppWrapperType owner) ;

/// @brief Method AddTweenToOwnerDictionary addr 0x28ad3cc size 0x198 virtual false final false
 void AddTweenToOwnerDictionary(Tweening::Tween tween, ::bs_hook::Il2CppWrapperType owner) ;

// Ctor Parameters []
explicit TweeningManager() ;

/// @brief Method .ctor addr 0x28ac9cc size 0x18c virtual false final false
 void _ctor() ;
