...
namespace Tweening {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15958), inst: 280 }), TypeDefinitionIndex(TypeDefinitionIndex(15958)), TypeDefinitionIndex(TypeDefinitionIndex(10211))}
...
/// @brief Method .ctor addr 0x28ac734 size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x28ac77c size 0xd0 virtual false final false
...
/// @brief Method GetValue addr 0x28ac84c size 0x48 virtual true final false
