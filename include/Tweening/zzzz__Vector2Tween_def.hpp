...
namespace Tweening {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15958), inst: 393 }), TypeDefinitionIndex(TypeDefinitionIndex(15958)), TypeDefinitionIndex(TypeDefinitionIndex(10203))}
...
/// @brief Method .ctor addr 0x28ac260 size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x28ac2a8 size 0xa8 virtual false final false
...
/// @brief Method GetValue addr 0x28ac350 size 0x34 virtual true final false
