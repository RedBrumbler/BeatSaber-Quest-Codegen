...
namespace Tweening {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15958)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15958), inst: 374 })}
...
/// @brief Method .ctor addr 0x28ac030 size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x28ac078 size 0x90 virtual false final false
...
/// @brief Method GetValue addr 0x28ac108 size 0x2c virtual true final false
