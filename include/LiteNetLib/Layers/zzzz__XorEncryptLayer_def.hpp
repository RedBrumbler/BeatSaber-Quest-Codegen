...
/// @brief Method .ctor addr 0x20d21e4 size 0x1c virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "key", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None }]
explicit XorEncryptLayer(::ArrayW<uint8_t> key) ;

/// @brief Method .ctor addr 0x20d2200 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x20d22c4 size 0x30 virtual false final false
 void _ctor(::StringW key) ;

/// @brief Method SetKey addr 0x20d22f4 size 0x44 virtual false final false
 void SetKey(::StringW key) ;

/// @brief Method SetKey addr 0x20d2230 size 0x94 virtual false final false
 void SetKey(::ArrayW<uint8_t> key) ;

/// @brief Method ProcessInboundPacket addr 0x20d2338 size 0x90 virtual true final false
...
/// @brief Method ProcessOutBoundPacket addr 0x20d23c8 size 0x8c virtual true final false
