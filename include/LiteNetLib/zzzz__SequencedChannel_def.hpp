...
/// @brief Method .ctor addr 0x20c86c4 size 0xa8 virtual false final false
 void _ctor(LiteNetLib::NetPeer peer, bool reliable, uint8_t id) ;

/// @brief Method SendNextPackets addr 0x20cca48 size 0x308 virtual true final false
 void SendNextPackets() ;

/// @brief Method ProcessPacket addr 0x20ccd50 size 0x1d0 virtual true final false
