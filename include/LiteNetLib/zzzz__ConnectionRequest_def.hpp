...
/// @brief Method get_Result addr 0x20bd030 size 0x8 virtual false final false
 LiteNetLib::ConnectionRequestResult get_Result() ;

/// @brief Method set_Result addr 0x20bd038 size 0x8 virtual false final false
 void set_Result(LiteNetLib::ConnectionRequestResult value) ;

/// @brief Method TryActivate addr 0x20bd040 size 0x28 virtual false final false
 bool TryActivate() ;

/// @brief Method UpdateRequest addr 0x20bd068 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x20bd098 size 0x58 virtual false final false
...
/// @brief Method AcceptIfKey addr 0x20bd0f0 size 0x1a8 virtual false final false
 LiteNetLib::NetPeer AcceptIfKey(::StringW key) ;

/// @brief Method Accept addr 0x20bd798 size 0x64 virtual false final false
 LiteNetLib::NetPeer Accept() ;

/// @brief Method Reject addr 0x20bd7fc size 0x88 virtual false final false
 void Reject(::ArrayW<uint8_t> rejectData, int32_t start, int32_t length, bool force) ;

/// @brief Method Reject addr 0x20bd884 size 0x8 virtual false final false
 void Reject(::ArrayW<uint8_t> rejectData, int32_t start, int32_t length) ;

/// @brief Method RejectForce addr 0x20bd88c size 0x8 virtual false final false
 void RejectForce(::ArrayW<uint8_t> rejectData, int32_t start, int32_t length) ;

/// @brief Method RejectForce addr 0x20bd894 size 0x14 virtual false final false
 void RejectForce() ;

/// @brief Method RejectForce addr 0x20bd8a8 size 0x20 virtual false final false
 void RejectForce(::ArrayW<uint8_t> rejectData) ;

/// @brief Method RejectForce addr 0x20bd8c8 size 0x28 virtual false final false
 void RejectForce(LiteNetLib::Utils::NetDataWriter rejectData) ;

/// @brief Method Reject addr 0x20bd8f0 size 0x14 virtual false final false
 void Reject() ;

/// @brief Method Reject addr 0x20bd904 size 0x20 virtual false final false
 void Reject(::ArrayW<uint8_t> rejectData) ;

/// @brief Method Reject addr 0x20bd924 size 0x28 virtual false final false
