...
/// @brief Method ToString addr 0x20cc9e0 size 0x68 virtual true final false
 ::StringW ToString() ;

/// @brief Method Init addr 0x20cc460 size 0xc virtual false final false
 void Init(LiteNetLib::NetPacket packet) ;

/// @brief Method TrySend addr 0x20cc46c size 0x78 virtual false final false
 void TrySend(int64_t currentTime, LiteNetLib::NetPeer peer) ;

/// @brief Method Clear addr 0x20cbfb8 size 0x3c virtual false final false
...
namespace LiteNetLib {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14428))}
...
/// @brief Method .ctor addr 0x20c853c size 0x188 virtual false final false
 void _ctor(LiteNetLib::NetPeer peer, bool ordered, uint8_t id) ;

/// @brief Method ProcessAck addr 0x20cbc68 size 0x350 virtual false final false
 void ProcessAck(LiteNetLib::NetPacket packet) ;

/// @brief Method SendNextPackets addr 0x20cbff4 size 0x46c virtual true final false
 void SendNextPackets() ;

/// @brief Method ProcessPacket addr 0x20cc4e4 size 0x4fc virtual true final false
