...
/// @brief Method get_LocalPort addr 0x20c9d38 size 0x8 virtual false final false
 int32_t get_LocalPort() ;

/// @brief Method set_LocalPort addr 0x20c9d40 size 0x8 virtual false final false
 void set_LocalPort(int32_t value) ;

/// @brief Method get_Ttl addr 0x20c9d48 size 0x1c virtual false final false
 int16_t get_Ttl() ;

/// @brief Method set_Ttl addr 0x20c073c size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0x20c2040 size 0x28 virtual false final false
 void _ctor(LiteNetLib::INetSocketListener listener) ;

/// @brief Method IsActive addr 0x20c9e2c size 0x18 virtual false final false
 bool IsActive() ;

/// @brief Method ReceiveLogic addr 0x20c9e44 size 0x578 virtual false final false
 void ReceiveLogic(::bs_hook::Il2CppWrapperType state) ;

/// @brief Method Bind addr 0x20c5ca4 size 0x404 virtual false final false
...
/// @brief Method BindSocket addr 0x20ca3bc size 0x6bc virtual false final false
 bool BindSocket(System::Net::Sockets::Socket socket, System::Net::IPEndPoint ep, bool reuseAddress) ;

/// @brief Method SendBroadcast addr 0x20c666c size 0x30c virtual false final false
 bool SendBroadcast(::ArrayW<uint8_t> data, int32_t offset, int32_t size, int32_t port) ;

/// @brief Method SendTo addr 0x20c0758 size 0x360 virtual false final false
...
/// @brief Method Close addr 0x20c7504 size 0xa8 virtual false final false
