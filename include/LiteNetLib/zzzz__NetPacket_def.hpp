...
/// @brief Method get_Property addr 0x20c4a24 size 0x2c virtual false final false
 LiteNetLib::PacketProperty get_Property() ;

/// @brief Method set_Property addr 0x20c6638 size 0x34 virtual false final false
 void set_Property(LiteNetLib::PacketProperty value) ;

/// @brief Method get_ConnectionNumber addr 0x20c79c4 size 0x2c virtual false final false
 uint8_t get_ConnectionNumber() ;

/// @brief Method set_ConnectionNumber addr 0x20c3fc0 size 0x34 virtual false final false
 void set_ConnectionNumber(uint8_t value) ;

/// @brief Method get_Sequence addr 0x20c79f0 size 0x60 virtual false final false
 uint16_t get_Sequence() ;

/// @brief Method set_Sequence addr 0x20c7a50 size 0x10 virtual false final false
 void set_Sequence(uint16_t value) ;

/// @brief Method get_IsFragmented addr 0x20c7a64 size 0x30 virtual false final false
 bool get_IsFragmented() ;

/// @brief Method MarkFragmented addr 0x20c7a94 size 0x30 virtual false final false
 void MarkFragmented() ;

/// @brief Method get_ChannelId addr 0x20c7ac4 size 0x2c virtual false final false
 uint8_t get_ChannelId() ;

/// @brief Method set_ChannelId addr 0x20c7af0 size 0x2c virtual false final false
 void set_ChannelId(uint8_t value) ;

/// @brief Method get_FragmentId addr 0x20c7b1c size 0x60 virtual false final false
 uint16_t get_FragmentId() ;

/// @brief Method set_FragmentId addr 0x20c7b7c size 0x10 virtual false final false
 void set_FragmentId(uint16_t value) ;

/// @brief Method get_FragmentPart addr 0x20c7b8c size 0x60 virtual false final false
 uint16_t get_FragmentPart() ;

/// @brief Method set_FragmentPart addr 0x20c7bec size 0x10 virtual false final false
 void set_FragmentPart(uint16_t value) ;

/// @brief Method get_FragmentsTotal addr 0x20c7bfc size 0x60 virtual false final false
 uint16_t get_FragmentsTotal() ;

/// @brief Method set_FragmentsTotal addr 0x20c7c5c size 0x10 virtual false final false
...
/// @brief Method .ctor addr 0x20c7c6c size 0x6c virtual false final false
...
/// @brief Method .ctor addr 0x20c7cd8 size 0xcc virtual false final false
 void _ctor(LiteNetLib::PacketProperty property, int32_t size) ;

/// @brief Method GetHeaderSize addr 0x20c660c size 0x2c virtual false final false
static int32_t GetHeaderSize(LiteNetLib::PacketProperty property) ;

/// @brief Method GetHeaderSize addr 0x20c122c size 0x88 virtual false final false
 int32_t GetHeaderSize() ;

/// @brief Method FromBytes addr 0x20c48f8 size 0x12c virtual false final false
