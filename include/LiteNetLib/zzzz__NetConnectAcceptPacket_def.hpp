...
/// @brief Method .ctor addr 0x20c8048 size 0x40 virtual false final false
 void _ctor(int64_t connectionId, uint8_t connectionNumber, bool isReusedPeer) ;

/// @brief Method FromData addr 0x20c4dd0 size 0x108 virtual false final false
static LiteNetLib::NetConnectAcceptPacket FromData(LiteNetLib::NetPacket packet) ;

/// @brief Method Make addr 0x20c8088 size 0xbc virtual false final false
