...
/// @brief Method Equals addr 0x20c78b8 size 0x5c virtual true final true
 bool Equals(System::Net::IPEndPoint x, System::Net::IPEndPoint y) ;

/// @brief Method GetHashCode addr 0x20c7914 size 0x20 virtual true final true
 int32_t GetHashCode(System::Net::IPEndPoint obj) ;

// Ctor Parameters []
explicit LiteNetLib__NetManager__IPEndPointComparer() ;

/// @brief Method .ctor addr 0x20c2108 size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x20c77f0 size 0x8 virtual false final false
 void _ctor(LiteNetLib::NetPeer p) ;

/// @brief Method Dispose addr 0x20c7934 size 0x4 virtual true final true
 void Dispose() ;

/// @brief Method MoveNext addr 0x20c7938 size 0x3c virtual true final true
 bool MoveNext() ;

/// @brief Method Reset addr 0x20c7974 size 0x40 virtual true final true
 void Reset() ;

/// @brief Method get_Current addr 0x20c79b4 size 0x8 virtual true final true
 LiteNetLib::NetPeer get_Current() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x20c79bc size 0x8 virtual true final true
...
/// @brief Method get_IsRunning addr 0x20c163c size 0x24 virtual false final false
 bool get_IsRunning() ;

/// @brief Method get_LocalPort addr 0x20c1660 size 0x1c virtual false final false
 int32_t get_LocalPort() ;

/// @brief Method get_FirstPeer addr 0x20c167c size 0x18 virtual false final false
 LiteNetLib::NetPeer get_FirstPeer() ;

/// @brief Method get_ChannelsCount addr 0x20c1694 size 0x8 virtual false final false
 uint8_t get_ChannelsCount() ;

/// @brief Method set_ChannelsCount addr 0x20c169c size 0x6c virtual false final false
 void set_ChannelsCount(uint8_t value) ;

/// @brief Method get_ConnectedPeerList addr 0x20c1708 size 0x20 virtual false final false
 System::Collections::Generic::List_1<LiteNetLib::NetPeer> get_ConnectedPeerList() ;

/// @brief Method GetPeerById addr 0x20c1848 size 0x30 virtual false final false
 LiteNetLib::NetPeer GetPeerById(int32_t id) ;

/// @brief Method get_ConnectedPeersCount addr 0x20c1878 size 0x18 virtual false final false
 int32_t get_ConnectedPeersCount() ;

/// @brief Method TryGetPeer addr 0x20c1890 size 0x98 virtual false final false
 bool TryGetPeer(System::Net::IPEndPoint endPoint, ByRef<LiteNetLib::NetPeer> peer) ;

/// @brief Method AddPeer addr 0x20c1928 size 0x14c virtual false final false
 void AddPeer(LiteNetLib::NetPeer peer) ;

/// @brief Method RemovePeer addr 0x20c1a74 size 0x48 virtual false final false
 void RemovePeer(LiteNetLib::NetPeer peer) ;

/// @brief Method RemovePeerInternal addr 0x20c1abc size 0x1b4 virtual false final false
...
/// @brief Method .ctor addr 0x20c1c70 size 0x3d0 virtual false final false
 void _ctor(LiteNetLib::INetEventListener listener, LiteNetLib::Layers::PacketLayerBase extraPacketLayer) ;

/// @brief Method ConnectionLatencyUpdated addr 0x20c2110 size 0x40 virtual false final false
 void ConnectionLatencyUpdated(LiteNetLib::NetPeer fromPeer, int32_t latency) ;

/// @brief Method MessageDelivered addr 0x20c248c size 0x4c virtual false final false
 void MessageDelivered(LiteNetLib::NetPeer fromPeer, ::bs_hook::Il2CppWrapperType userData) ;

/// @brief Method SendRawAndRecycle addr 0x20c24d8 size 0x54 virtual false final false
 int32_t SendRawAndRecycle(LiteNetLib::NetPacket packet, System::Net::IPEndPoint remoteEndPoint) ;

/// @brief Method SendRaw addr 0x20c2794 size 0x28 virtual false final false
 int32_t SendRaw(LiteNetLib::NetPacket packet, System::Net::IPEndPoint remoteEndPoint) ;

/// @brief Method SendRaw addr 0x20c252c size 0x268 virtual false final false
 int32_t SendRaw(::ArrayW<uint8_t> message, int32_t start, int32_t length, System::Net::IPEndPoint remoteEndPoint) ;

/// @brief Method DisconnectPeerForce addr 0x20c2928 size 0x30 virtual false final false
...
/// @brief Method DisconnectPeer addr 0x20c2970 size 0xb0 virtual false final false
...
/// @brief Method CreateEvent addr 0x20c2150 size 0x33c virtual false final false
...
/// @brief Method ProcessEvent addr 0x20c2cdc size 0x4d4 virtual false final false
 void ProcessEvent(LiteNetLib::NetEvent evt) ;

/// @brief Method RecycleEvent addr 0x20c1440 size 0x114 virtual false final false
 void RecycleEvent(LiteNetLib::NetEvent evt) ;

/// @brief Method UpdateLogic addr 0x20c31c0 size 0x290 virtual false final false
 void UpdateLogic() ;

/// @brief Method LiteNetLib.INetSocketListener.OnMessageReceived addr 0x20c36d4 size 0x2b0 virtual true final true
...
/// @brief Method OnConnectionSolved addr 0x20bd39c size 0x3fc virtual false final false
...
/// @brief Method GetNextPeerId addr 0x20c3ff8 size 0x130 virtual false final false
 int32_t GetNextPeerId() ;

/// @brief Method ProcessConnectRequest addr 0x20c44cc size 0x2e8 virtual false final false
...
/// @brief Method SendToAll addr 0x20c5a88 size 0x30 virtual false final false
...
/// @brief Method SendToAll addr 0x20c5ab8 size 0x28 virtual false final false
...
/// @brief Method SendToAll addr 0x20c592c size 0x124 virtual false final false
...
/// @brief Method Start addr 0x20c5ae0 size 0x8 virtual false final false
 bool Start() ;

/// @brief Method Start addr 0x20c5b5c size 0x148 virtual false final false
 bool Start(System::Net::IPAddress addressIPv4, System::Net::IPAddress addressIPv6, int32_t port) ;

/// @brief Method Start addr 0x20c60a8 size 0x90 virtual false final false
 bool Start(::StringW addressIPv4, ::StringW addressIPv6, int32_t port) ;

/// @brief Method Start addr 0x20c5ae8 size 0x74 virtual false final false
 bool Start(int32_t port) ;

/// @brief Method SendUnconnectedMessage addr 0x20c62f0 size 0x20 virtual false final false
 bool SendUnconnectedMessage(::ArrayW<uint8_t> message, System::Net::IPEndPoint remoteEndPoint) ;

/// @brief Method SendUnconnectedMessage addr 0x20c6364 size 0x28 virtual false final false
 bool SendUnconnectedMessage(LiteNetLib::Utils::NetDataWriter writer, System::Net::IPEndPoint remoteEndPoint) ;

/// @brief Method SendUnconnectedMessage addr 0x20c6310 size 0x54 virtual false final false
 bool SendUnconnectedMessage(::ArrayW<uint8_t> message, int32_t start, int32_t length, System::Net::IPEndPoint remoteEndPoint) ;

/// @brief Method SendBroadcast addr 0x20c6464 size 0x28 virtual false final false
 bool SendBroadcast(LiteNetLib::Utils::NetDataWriter writer, int32_t port) ;

/// @brief Method SendBroadcast addr 0x20c65ec size 0x20 virtual false final false
 bool SendBroadcast(::ArrayW<uint8_t> data, int32_t port) ;

/// @brief Method SendBroadcast addr 0x20c648c size 0x160 virtual false final false
 bool SendBroadcast(::ArrayW<uint8_t> data, int32_t start, int32_t length, int32_t port) ;

/// @brief Method Flush addr 0x20c6978 size 0x28 virtual false final false
 void Flush() ;

/// @brief Method PollEvents addr 0x20c6bf0 size 0x160 virtual false final false
 void PollEvents() ;

/// @brief Method Connect addr 0x20c6d50 size 0x38 virtual false final false
 LiteNetLib::NetPeer Connect(::StringW address, int32_t port, ::StringW key) ;

/// @brief Method Connect addr 0x20c6df8 size 0x148 virtual false final false
 LiteNetLib::NetPeer Connect(::StringW address, int32_t port, LiteNetLib::Utils::NetDataWriter connectionData) ;

/// @brief Method Connect addr 0x20c7108 size 0x30 virtual false final false
 LiteNetLib::NetPeer Connect(System::Net::IPEndPoint target, ::StringW key) ;

/// @brief Method Connect addr 0x20c6f40 size 0x1c8 virtual false final false
 LiteNetLib::NetPeer Connect(System::Net::IPEndPoint target, LiteNetLib::Utils::NetDataWriter connectionData) ;

/// @brief Method Stop addr 0x20c7248 size 0x8 virtual false final false
 void Stop() ;

/// @brief Method Stop addr 0x20c7250 size 0x2b4 virtual false final false
 void Stop(bool sendDisconnectMessages) ;

/// @brief Method GetPeersCount addr 0x20c75ac size 0x74 virtual false final false
 int32_t GetPeersCount(LiteNetLib::ConnectionState peerState) ;

/// @brief Method GetPeersNonAlloc addr 0x20c1728 size 0x120 virtual false final false
 void GetPeersNonAlloc(System::Collections::Generic::List_1<LiteNetLib::NetPeer> peers, LiteNetLib::ConnectionState peerState) ;

/// @brief Method DisconnectAll addr 0x20c7620 size 0x10 virtual false final false
 void DisconnectAll() ;

/// @brief Method DisconnectAll addr 0x20c7630 size 0x90 virtual false final false
 void DisconnectAll(::ArrayW<uint8_t> data, int32_t start, int32_t count) ;

/// @brief Method DisconnectPeerForce addr 0x20c76c0 size 0x34 virtual false final false
 void DisconnectPeerForce(LiteNetLib::NetPeer peer) ;

/// @brief Method DisconnectPeer addr 0x20c76f4 size 0x34 virtual false final false
 void DisconnectPeer(LiteNetLib::NetPeer peer) ;

/// @brief Method DisconnectPeer addr 0x20c775c size 0x3c virtual false final false
 void DisconnectPeer(LiteNetLib::NetPeer peer, ::ArrayW<uint8_t> data) ;

/// @brief Method DisconnectPeer addr 0x20c7798 size 0x3c virtual false final false
 void DisconnectPeer(LiteNetLib::NetPeer peer, LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method DisconnectPeer addr 0x20c7728 size 0x34 virtual false final false
 void DisconnectPeer(LiteNetLib::NetPeer peer, ::ArrayW<uint8_t> data, int32_t start, int32_t count) ;

/// @brief Method GetEnumerator addr 0x20c77d4 size 0x1c virtual false final false
 LiteNetLib::LiteNetLib__NetManager__NetPeerEnumerator GetEnumerator() ;

/// @brief Method System.Collections.Generic.IEnumerable<LiteNetLib.NetPeer>.GetEnumerator addr 0x20c77f8 size 0x60 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x20c7858 size 0x60 virtual true final true
