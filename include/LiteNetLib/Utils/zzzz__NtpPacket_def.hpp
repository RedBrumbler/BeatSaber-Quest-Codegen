...
/// @brief Method get_Bytes addr 0x20d0a50 size 0x8 virtual false final false
 ::ArrayW<uint8_t> get_Bytes() ;

/// @brief Method set_Bytes addr 0x20d0a58 size 0x8 virtual false final false
 void set_Bytes(::ArrayW<uint8_t> value) ;

/// @brief Method get_LeapIndicator addr 0x20d0a60 size 0x2c virtual false final false
 LiteNetLib::Utils::NtpLeapIndicator get_LeapIndicator() ;

/// @brief Method get_VersionNumber addr 0x20d0a8c size 0x2c virtual false final false
 int32_t get_VersionNumber() ;

/// @brief Method set_VersionNumber addr 0x20d0ab8 size 0x34 virtual false final false
 void set_VersionNumber(int32_t value) ;

/// @brief Method get_Mode addr 0x20d0aec size 0x2c virtual false final false
 LiteNetLib::Utils::NtpMode get_Mode() ;

/// @brief Method set_Mode addr 0x20d0b18 size 0x34 virtual false final false
 void set_Mode(LiteNetLib::Utils::NtpMode value) ;

/// @brief Method get_Stratum addr 0x20d0b4c size 0x2c virtual false final false
 int32_t get_Stratum() ;

/// @brief Method get_Poll addr 0x20d0b78 size 0x2c virtual false final false
 int32_t get_Poll() ;

/// @brief Method get_Precision addr 0x20d0ba4 size 0x2c virtual false final false
 int32_t get_Precision() ;

/// @brief Method get_RootDelay addr 0x20d0bd0 size 0x8 virtual false final false
 System::TimeSpan get_RootDelay() ;

/// @brief Method get_RootDispersion addr 0x20d0c5c size 0x8 virtual false final false
 System::TimeSpan get_RootDispersion() ;

/// @brief Method get_ReferenceId addr 0x20d0c64 size 0x8 virtual false final false
 uint32_t get_ReferenceId() ;

/// @brief Method get_ReferenceTimestamp addr 0x20d0d0c size 0x8 virtual false final false
 System::Nullable_1<System::DateTime> get_ReferenceTimestamp() ;

/// @brief Method get_OriginTimestamp addr 0x20d0e30 size 0x8 virtual false final false
 System::Nullable_1<System::DateTime> get_OriginTimestamp() ;

/// @brief Method get_ReceiveTimestamp addr 0x20d0e38 size 0x8 virtual false final false
 System::Nullable_1<System::DateTime> get_ReceiveTimestamp() ;

/// @brief Method get_TransmitTimestamp addr 0x20d0e40 size 0x8 virtual false final false
 System::Nullable_1<System::DateTime> get_TransmitTimestamp() ;

/// @brief Method set_TransmitTimestamp addr 0x20d0e48 size 0x10 virtual false final false
 void set_TransmitTimestamp(System::Nullable_1<System::DateTime> value) ;

/// @brief Method get_DestinationTimestamp addr 0x20d0f98 size 0xc virtual false final false
 System::Nullable_1<System::DateTime> get_DestinationTimestamp() ;

/// @brief Method set_DestinationTimestamp addr 0x20d0fa4 size 0x8 virtual false final false
 void set_DestinationTimestamp(System::Nullable_1<System::DateTime> value) ;

/// @brief Method get_RoundTripTime addr 0x20d0fac size 0x160 virtual false final false
 System::TimeSpan get_RoundTripTime() ;

/// @brief Method get_CorrectionOffset addr 0x20d1240 size 0x174 virtual false final false
 System::TimeSpan get_CorrectionOffset() ;

// Ctor Parameters []
explicit NtpPacket() ;

/// @brief Method .ctor addr 0x20d13b4 size 0xe4 virtual false final false
 void _ctor() ;

// Ctor Parameters [CppParam { name: "bytes", ty: "::ArrayW<uint8_t>", modifiers: "", def_value: None }]
explicit NtpPacket(::ArrayW<uint8_t> bytes) ;

/// @brief Method .ctor addr 0x20d1498 size 0x9c virtual false final false
 void _ctor(::ArrayW<uint8_t> bytes) ;

/// @brief Method FromServerResponse addr 0x20d1534 size 0xa4 virtual false final false
static LiteNetLib::Utils::NtpPacket FromServerResponse(::ArrayW<uint8_t> bytes, System::DateTime destinationTimestamp) ;

/// @brief Method ValidateRequest addr 0x20d15d8 size 0xfc virtual false final false
 void ValidateRequest() ;

/// @brief Method ValidateReply addr 0x20d16d4 size 0x164 virtual false final false
 void ValidateReply() ;

/// @brief Method CheckTimestamps addr 0x20d110c size 0x134 virtual false final false
 void CheckTimestamps() ;

/// @brief Method GetDateTime64 addr 0x20d0d14 size 0x11c virtual false final false
 System::Nullable_1<System::DateTime> GetDateTime64(int32_t offset) ;

/// @brief Method SetDateTime64 addr 0x20d0e58 size 0x140 virtual false final false
 void SetDateTime64(int32_t offset, System::Nullable_1<System::DateTime> value) ;

/// @brief Method GetTimeSpan32 addr 0x20d0bd8 size 0x84 virtual false final false
 System::TimeSpan GetTimeSpan32(int32_t offset) ;

/// @brief Method GetUInt64BE addr 0x20d1838 size 0xa0 virtual false final false
 uint64_t GetUInt64BE(int32_t offset) ;

/// @brief Method SetUInt64BE addr 0x20d18d8 size 0x7c virtual false final false
 void SetUInt64BE(int32_t offset, uint64_t value) ;

/// @brief Method GetInt32BE addr 0x20d1954 size 0x4 virtual false final false
 int32_t GetInt32BE(int32_t offset) ;

/// @brief Method GetUInt32BE addr 0x20d0c6c size 0xa0 virtual false final false
 uint32_t GetUInt32BE(int32_t offset) ;

/// @brief Method SwapEndianness addr 0x20d19b8 size 0x8 virtual false final false
static uint32_t SwapEndianness(uint32_t x) ;

/// @brief Method SwapEndianness addr 0x20d1958 size 0x60 virtual false final false
