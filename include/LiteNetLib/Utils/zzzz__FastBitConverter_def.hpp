...
/// @brief Method WriteLittleEndian addr 0x20cd59c size 0xf0 virtual false final false
static void WriteLittleEndian(::ArrayW<uint8_t> buffer, int32_t offset, uint64_t data) ;

/// @brief Method WriteLittleEndian addr 0x20cd68c size 0x80 virtual false final false
static void WriteLittleEndian(::ArrayW<uint8_t> buffer, int32_t offset, int32_t data) ;

/// @brief Method WriteLittleEndian addr 0x20cd70c size 0x48 virtual false final false
static void WriteLittleEndian(::ArrayW<uint8_t> buffer, int32_t offset, int16_t data) ;

/// @brief Method GetBytes addr 0x20cd754 size 0x8 virtual false final false
static void GetBytes(::ArrayW<uint8_t> bytes, int32_t startIndex, double_t value) ;

/// @brief Method GetBytes addr 0x20cd75c size 0x8 virtual false final false
static void GetBytes(::ArrayW<uint8_t> bytes, int32_t startIndex, float_t value) ;

/// @brief Method GetBytes addr 0x20cd764 size 0x4 virtual false final false
static void GetBytes(::ArrayW<uint8_t> bytes, int32_t startIndex, int16_t value) ;

/// @brief Method GetBytes addr 0x20c7a60 size 0x4 virtual false final false
static void GetBytes(::ArrayW<uint8_t> bytes, int32_t startIndex, uint16_t value) ;

/// @brief Method GetBytes addr 0x20c8044 size 0x4 virtual false final false
static void GetBytes(::ArrayW<uint8_t> bytes, int32_t startIndex, int32_t value) ;

/// @brief Method GetBytes addr 0x20cd768 size 0x4 virtual false final false
static void GetBytes(::ArrayW<uint8_t> bytes, int32_t startIndex, uint32_t value) ;

/// @brief Method GetBytes addr 0x20c3ff4 size 0x4 virtual false final false
static void GetBytes(::ArrayW<uint8_t> bytes, int32_t startIndex, int64_t value) ;

/// @brief Method GetBytes addr 0x20cd76c size 0x4 virtual false final false
