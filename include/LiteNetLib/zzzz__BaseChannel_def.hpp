...
/// @brief Method .ctor addr 0x20bce58 size 0x94 virtual false final false
 void _ctor(LiteNetLib::NetPeer peer) ;

/// @brief Method get_PacketsInQueue addr 0x20bceec size 0x48 virtual false final false
 int32_t get_PacketsInQueue() ;

/// @brief Method AddToQueue addr 0x20bcf34 size 0xfc virtual false final false
