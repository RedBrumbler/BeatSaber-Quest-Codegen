...
/// @brief Method MakeEndPoint addr 0x20c00d4 size 0xa8 virtual false final false
static System::Net::IPEndPoint MakeEndPoint(::StringW hostStr, int32_t port) ;

/// @brief Method ResolveAddress addr 0x20c6138 size 0x1b8 virtual false final false
static System::Net::IPAddress ResolveAddress(::StringW hostStr) ;

/// @brief Method ResolveAddress addr 0x20cade4 size 0xcc virtual false final false
static System::Net::IPAddress ResolveAddress(::StringW hostStr, System::Net::Sockets::AddressFamily addressFamily) ;

/// @brief Method ResolveAddresses addr 0x20caeb0 size 0x20 virtual false final false
static ::ArrayW<System::Net::IPAddress> ResolveAddresses(::StringW hostStr) ;

/// @brief Method GetLocalIpList addr 0x20caed0 size 0xa4 virtual false final false
static System::Collections::Generic::List_1<::StringW> GetLocalIpList(LiteNetLib::LocalAddrType addrType) ;

/// @brief Method GetLocalIpList addr 0x20caf74 size 0x84c virtual false final false
static void GetLocalIpList(System::Collections::Generic::IList_1<::StringW> targetList, LiteNetLib::LocalAddrType addrType) ;

/// @brief Method GetLocalIp addr 0x20c0298 size 0x21c virtual false final false
static ::StringW GetLocalIp(LiteNetLib::LocalAddrType addrType) ;

/// @brief Method PrintInterfaceInfos addr 0x20cb7c0 size 0x41c virtual false final false
static void PrintInterfaceInfos() ;

/// @brief Method RelativeSequenceNumber addr 0x20c99f0 size 0x2c virtual false final false
