...
namespace LiteNetLib {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14495))}
...
/// @brief Method .ctor addr 0x20c11c0 size 0x2c virtual false final false
 void _ctor(LiteNetLib::NetManager manager, LiteNetLib::NetEvent evt) ;

/// @brief Method SetSource addr 0x20c11ec size 0x40 virtual false final false
 void SetSource(LiteNetLib::NetPacket packet) ;

/// @brief Method RecycleInternal addr 0x20c12b4 size 0x44 virtual false final false
 void RecycleInternal() ;

/// @brief Method Recycle addr 0x20c1554 size 0x6c virtual false final false
 void Recycle() ;
