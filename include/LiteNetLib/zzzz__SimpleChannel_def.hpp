...
/// @brief Method .ctor addr 0x20ccf20 size 0x4 virtual false final false
 void _ctor(LiteNetLib::NetPeer peer) ;

/// @brief Method SendNextPackets addr 0x20ccf24 size 0x170 virtual true final false
 void SendNextPackets() ;

/// @brief Method ProcessPacket addr 0x20cd094 size 0x8 virtual true final false
