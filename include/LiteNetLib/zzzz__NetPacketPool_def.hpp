...
/// @brief Method GetWithData addr 0x20c638c size 0xd8 virtual false final false
 LiteNetLib::NetPacket GetWithData(LiteNetLib::PacketProperty property, ::ArrayW<uint8_t> data, int32_t start, int32_t length) ;

/// @brief Method GetWithProperty addr 0x20c3f14 size 0xac virtual false final false
 LiteNetLib::NetPacket GetWithProperty(LiteNetLib::PacketProperty property, int32_t size) ;

/// @brief Method GetWithProperty addr 0x20c4ab8 size 0xa4 virtual false final false
 LiteNetLib::NetPacket GetWithProperty(LiteNetLib::PacketProperty property) ;

/// @brief Method GetPacket addr 0x20c27bc size 0x16c virtual false final false
 LiteNetLib::NetPacket GetPacket(int32_t size) ;

/// @brief Method Recycle addr 0x20c1300 size 0x140 virtual false final false
 void Recycle(LiteNetLib::NetPacket packet) ;

// Ctor Parameters []
explicit NetPacketPool() ;

/// @brief Method .ctor addr 0x20c2068 size 0x98 virtual false final false
 void _ctor() ;
