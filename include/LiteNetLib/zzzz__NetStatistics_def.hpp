...
/// @brief Method get_PacketsSent addr 0x20caa78 size 0xc virtual false final false
 int64_t get_PacketsSent() ;

/// @brief Method get_PacketsReceived addr 0x20caa84 size 0xc virtual false final false
 int64_t get_PacketsReceived() ;

/// @brief Method get_BytesSent addr 0x20caa90 size 0xc virtual false final false
 int64_t get_BytesSent() ;

/// @brief Method get_BytesReceived addr 0x20caa9c size 0xc virtual false final false
 int64_t get_BytesReceived() ;

/// @brief Method get_PacketLoss addr 0x20caaa8 size 0xc virtual false final false
 int64_t get_PacketLoss() ;

/// @brief Method get_PacketLossPercent addr 0x20caab4 size 0x4c virtual false final false
 int64_t get_PacketLossPercent() ;

/// @brief Method Reset addr 0x20cab00 size 0x5c virtual false final false
 void Reset() ;

/// @brief Method IncrementPacketsSent addr 0x20c2958 size 0xc virtual false final false
 void IncrementPacketsSent() ;

/// @brief Method IncrementPacketsReceived addr 0x20c48e0 size 0xc virtual false final false
 void IncrementPacketsReceived() ;

/// @brief Method AddBytesSent addr 0x20c2964 size 0xc virtual false final false
 void AddBytesSent(int64_t bytesSent) ;

/// @brief Method AddBytesReceived addr 0x20c48ec size 0xc virtual false final false
 void AddBytesReceived(int64_t bytesReceived) ;

/// @brief Method IncrementPacketLoss addr 0x20cab5c size 0xc virtual false final false
 void IncrementPacketLoss() ;

/// @brief Method AddPacketLoss addr 0x20cab68 size 0xc virtual false final false
 void AddPacketLoss(int64_t packetLoss) ;

/// @brief Method ToString addr 0x20cab74 size 0x270 virtual true final false
 ::StringW ToString() ;

// Ctor Parameters []
explicit NetStatistics() ;

/// @brief Method .ctor addr 0x20c2100 size 0x8 virtual false final false
 void _ctor() ;
