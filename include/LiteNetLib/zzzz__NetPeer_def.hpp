...
/// @brief Method .ctor addr 0x20c93bc size 0x8 virtual false final false
 void _ctor() ;
...
/// @brief Method get_ConnectionNum addr 0x20c8144 size 0x8 virtual false final false
 uint8_t get_ConnectionNum() ;

/// @brief Method set_ConnectionNum addr 0x20c814c size 0x4c virtual false final false
 void set_ConnectionNum(uint8_t value) ;

/// @brief Method get_ConnectionState addr 0x20c8198 size 0x8 virtual false final false
 LiteNetLib::ConnectionState get_ConnectionState() ;

/// @brief Method get_ConnectTime addr 0x20c81a0 size 0x8 virtual false final false
 int64_t get_ConnectTime() ;

/// @brief Method get_Ping addr 0x20c81a8 size 0x14 virtual false final false
 int32_t get_Ping() ;

/// @brief Method get_Mtu addr 0x20c81bc size 0x8 virtual false final false
 int32_t get_Mtu() ;

/// @brief Method get_RemoteTimeDelta addr 0x20c81c4 size 0x8 virtual false final false
 int64_t get_RemoteTimeDelta() ;

/// @brief Method get_RemoteUtcTime addr 0x20c81cc size 0x90 virtual false final false
 System::DateTime get_RemoteUtcTime() ;

/// @brief Method get_TimeSinceLastPacket addr 0x20c825c size 0x8 virtual false final false
 int32_t get_TimeSinceLastPacket() ;

/// @brief Method get_ResendDelay addr 0x20c8264 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x20c4128 size 0x320 virtual false final false
 void _ctor(LiteNetLib::NetManager netManager, System::Net::IPEndPoint remoteEndPoint, int32_t id) ;

/// @brief Method SetMtu addr 0x20c826c size 0xac virtual false final false
 void SetMtu(int32_t mtuIdx) ;

/// @brief Method GetPacketsCountInReliableQueue addr 0x20c8318 size 0xb0 virtual false final false
 int32_t GetPacketsCountInReliableQueue(uint8_t channelNumber, bool ordered) ;

/// @brief Method CreateChannel addr 0x20c83c8 size 0x174 virtual false final false
...
/// @brief Method .ctor addr 0x20c7138 size 0x110 virtual false final false
...
/// @brief Method .ctor addr 0x20c4464 size 0x68 virtual false final false
...
/// @brief Method Reject addr 0x20c4448 size 0x1c virtual false final false
 void Reject(int64_t connectionId, uint8_t connectionNumber, ::ArrayW<uint8_t> data, int32_t start, int32_t length) ;

/// @brief Method ProcessConnectAccept addr 0x20c4ed8 size 0x64 virtual false final false
 bool ProcessConnectAccept(LiteNetLib::NetConnectAcceptPacket packet) ;

/// @brief Method GetMaxSinglePacketSize addr 0x20c876c size 0x74 virtual false final false
 int32_t GetMaxSinglePacketSize(LiteNetLib::DeliveryMethod options) ;

/// @brief Method SendWithDeliveryEvent addr 0x20c87e0 size 0x84 virtual false final false
...
/// @brief Method SendWithDeliveryEvent addr 0x20c8d1c size 0x64 virtual false final false
...
/// @brief Method SendWithDeliveryEvent addr 0x20c8d80 size 0x8c virtual false final false
...
/// @brief Method SendInternal addr 0x20c8864 size 0x4b8 virtual false final false
...
/// @brief Method Disconnect addr 0x20c8ecc size 0x24 virtual false final false
 void Disconnect(::ArrayW<uint8_t> data) ;

/// @brief Method Disconnect addr 0x20c8ef0 size 0x24 virtual false final false
 void Disconnect(LiteNetLib::Utils::NetDataWriter writer) ;

/// @brief Method Disconnect addr 0x20c8f14 size 0x48 virtual false final false
 void Disconnect(::ArrayW<uint8_t> data, int32_t start, int32_t count) ;

/// @brief Method Disconnect addr 0x20c8f5c size 0x44 virtual false final false
 void Disconnect() ;

/// @brief Method ProcessDisconnect addr 0x20c4d08 size 0xc8 virtual false final false
 LiteNetLib::DisconnectResult ProcessDisconnect(LiteNetLib::NetPacket packet) ;

/// @brief Method Shutdown addr 0x20c2a20 size 0x2bc virtual false final false
 LiteNetLib::ShutdownResult Shutdown(::ArrayW<uint8_t> data, int32_t start, int32_t length, bool force) ;

/// @brief Method UpdateRoundTripTime addr 0x20c8fa0 size 0x3c virtual false final false
 void UpdateRoundTripTime(int32_t roundTripTime) ;

/// @brief Method AddReliablePacket addr 0x20c8fdc size 0x3e0 virtual false final false
 void AddReliablePacket(LiteNetLib::DeliveryMethod method, LiteNetLib::NetPacket p) ;

/// @brief Method ProcessMtuPacket addr 0x20c93c4 size 0x3e8 virtual false final false
 void ProcessMtuPacket(LiteNetLib::NetPacket packet) ;

/// @brief Method UpdateMtuLogic addr 0x20c97ac size 0x244 virtual false final false
 void UpdateMtuLogic(int32_t deltaTime) ;

/// @brief Method ProcessConnectRequest addr 0x20c47b4 size 0x12c virtual false final false
 LiteNetLib::ConnectRequestResult ProcessConnectRequest(LiteNetLib::NetConnectRequestPacket connRequest) ;

/// @brief Method ProcessPacket addr 0x20c4f3c size 0x574 virtual false final false
 void ProcessPacket(LiteNetLib::NetPacket packet) ;

/// @brief Method SendMerged addr 0x20c9a1c size 0xa0 virtual false final false
 void SendMerged() ;

/// @brief Method SendUserData addr 0x20c9abc size 0x11c virtual false final false
 void SendUserData(LiteNetLib::NetPacket packet) ;

/// @brief Method Flush addr 0x20c69a0 size 0x250 virtual false final false
 void Flush() ;

/// @brief Method Update addr 0x20c3450 size 0x284 virtual false final false
 void Update(int32_t deltaTime) ;

/// @brief Method RecycleAndDeliver addr 0x20c9bd8 size 0x160 virtual false final false
