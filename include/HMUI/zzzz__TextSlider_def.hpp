...
/// @brief Method set_valueTextColor addr 0x1fe94dc size 0x24 virtual false final false
 void set_valueTextColor(UnityEngine::Color value) ;

/// @brief Method get_handleRect addr 0x1feac48 size 0x8 virtual false final false
 UnityEngine::RectTransform get_handleRect() ;

/// @brief Method set_handleRect addr 0x1feac50 size 0x88 virtual false final false
 void set_handleRect(UnityEngine::RectTransform value) ;

/// @brief Method set_handleColor addr 0x1fe9418 size 0xc4 virtual false final false
 void set_handleColor(UnityEngine::Color value) ;

/// @brief Method get_handleSize addr 0x1feae10 size 0x8 virtual false final false
 float_t get_handleSize() ;

/// @brief Method set_handleSize addr 0x1feae18 size 0x80 virtual false final false
 void set_handleSize(float_t value) ;

/// @brief Method get_valueSize addr 0x1feae98 size 0x8 virtual false final false
 float_t get_valueSize() ;

/// @brief Method set_valueSize addr 0x1feaea0 size 0x80 virtual false final false
 void set_valueSize(float_t value) ;

/// @brief Method get_separatorSize addr 0x1feaf20 size 0x8 virtual false final false
 float_t get_separatorSize() ;

/// @brief Method set_separatorSize addr 0x1feaf28 size 0x80 virtual false final false
 void set_separatorSize(float_t value) ;

/// @brief Method get_numberOfSteps addr 0x1feafa8 size 0x8 virtual false final false
 int32_t get_numberOfSteps() ;

/// @brief Method set_numberOfSteps addr 0x1fe8b18 size 0x90 virtual false final false
 void set_numberOfSteps(int32_t value) ;

/// @brief Method get_normalizedValue addr 0x1fe9360 size 0xb8 virtual false final false
 float_t get_normalizedValue() ;

/// @brief Method set_normalizedValue addr 0x1fe9af4 size 0x8 virtual false final false
 void set_normalizedValue(float_t value) ;

/// @brief Method add_normalizedValueDidChangeEvent addr 0x1fe8ba8 size 0xb4 virtual false final false
 void add_normalizedValueDidChangeEvent(System::Action_2<HMUI::TextSlider,float_t> value) ;

/// @brief Method remove_normalizedValueDidChangeEvent addr 0x1fe8ce8 size 0xb4 virtual false final false
 void remove_normalizedValueDidChangeEvent(System::Action_2<HMUI::TextSlider,float_t> value) ;

/// @brief Method Rebuild addr 0x1feb044 size 0x4 virtual true final false
 void Rebuild(UnityEngine::UI::CanvasUpdate executing) ;

/// @brief Method LayoutComplete addr 0x1feb048 size 0x4 virtual true final false
 void LayoutComplete() ;

/// @brief Method GraphicUpdateComplete addr 0x1feb04c size 0x4 virtual true final false
 void GraphicUpdateComplete() ;

/// @brief Method OnEnable addr 0x1feb050 size 0x40 virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1feb090 size 0x24 virtual true final false
 void OnDisable() ;

/// @brief Method UpdateCachedReferences addr 0x1feacd8 size 0x138 virtual false final false
 void UpdateCachedReferences() ;

/// @brief Method SetNormalizedValue addr 0x1fea02c size 0x8 virtual false final false
 void SetNormalizedValue(float_t input) ;

/// @brief Method SetNormalizedValue addr 0x1feafb0 size 0x94 virtual false final false
 void SetNormalizedValue(float_t input, bool sendCallback) ;

/// @brief Method OnRectTransformDimensionsChange addr 0x1feb0b4 size 0x44 virtual true final false
 void OnRectTransformDimensionsChange() ;

/// @brief Method UpdateVisuals addr 0x1fe8f70 size 0x3f0 virtual true final false
 void UpdateVisuals() ;

/// @brief Method UpdateDrag addr 0x1feb0f8 size 0x2e0 virtual false final false
 void UpdateDrag(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method MayDrag addr 0x1feb3d8 size 0x64 virtual false final false
 bool MayDrag(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnBeginDrag addr 0x1feb43c size 0x88 virtual true final false
 void OnBeginDrag(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnDrag addr 0x1feb4c4 size 0x98 virtual true final false
 void OnDrag(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnPointerDown addr 0x1feb55c size 0xa0 virtual true final false
 void OnPointerDown(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnInitializePotentialDrag addr 0x1feb5fc size 0x18 virtual true final false
 void OnInitializePotentialDrag(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method TextForNormalizedValue addr 0x1feb614 size 0x1c virtual true final false
 ::StringW TextForNormalizedValue(float_t normalizedValue) ;

// Ctor Parameters []
explicit TextSlider() ;

/// @brief Method .ctor addr 0x1fe979c size 0x78 virtual false final false
 void _ctor() ;

/// @brief Method UnityEngine.UI.ICanvasElement.get_transform addr 0x1feb630 size 0x8 virtual true final true
