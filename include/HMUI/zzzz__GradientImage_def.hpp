...
/// @brief Method get_color0 addr 0x1ff70c4 size 0x14 virtual false final false
 UnityEngine::Color get_color0() ;

/// @brief Method set_color0 addr 0x1ff70d8 size 0x38 virtual false final false
 void set_color0(UnityEngine::Color value) ;

/// @brief Method get_color1 addr 0x1ff7110 size 0x14 virtual false final false
 UnityEngine::Color get_color1() ;

/// @brief Method set_color1 addr 0x1ff7124 size 0x38 virtual false final false
 void set_color1(UnityEngine::Color value) ;

/// @brief Method OnPopulateMesh addr 0x1ff715c size 0x174 virtual true final false
 void OnPopulateMesh(UnityEngine::UI::VertexHelper toFill) ;

/// @brief Method GenerateSimpleSprite addr 0x1ff72d0 size 0xab8 virtual false final false
 void GenerateSimpleSprite(UnityEngine::UI::VertexHelper vh, bool lPreserveAspect, float_t curvedUIRadius) ;

/// @brief Method GenerateSlicedSprite addr 0x1ff7d88 size 0xd80 virtual false final false
 void GenerateSlicedSprite(UnityEngine::UI::VertexHelper vh, float_t curvedUIRadius) ;

/// @brief Method GenerateTiledSprite addr 0x1ff8b08 size 0x22ec virtual false final false
 void GenerateTiledSprite(UnityEngine::UI::VertexHelper toFill) ;

/// @brief Method AddQuad addr 0x1ffd280 size 0xe4 virtual false final false
...
/// @brief Method AddQuad addr 0x1ffd12c size 0x154 virtual false final false
...
/// @brief Method AddQuad addr 0x1ffc884 size 0x8a8 virtual false final false
...
/// @brief Method GetAdjustedBorders addr 0x1ffc7ac size 0xd8 virtual false final false
 UnityEngine::Vector4 GetAdjustedBorders(UnityEngine::Vector4 border, UnityEngine::Rect rect) ;

/// @brief Method GenerateFilledSprite addr 0x1ffadf4 size 0x1430 virtual false final false
 void GenerateFilledSprite(UnityEngine::UI::VertexHelper toFill, bool preserveAspect) ;

/// @brief Method RadialCut addr 0x1ffd364 size 0x120 virtual false final false
...
/// @brief Method RadialCut addr 0x1ffd484 size 0x3ec virtual false final false
static void RadialCut(::ArrayW<UnityEngine::Vector3> xy, float_t cos, float_t sin, bool invert, int32_t corner) ;

/// @brief Method GetDrawingDimensions addr 0x1ffc224 size 0x588 virtual false final false
 UnityEngine::Vector4 GetDrawingDimensions(bool shouldPreserveAspect) ;

// Ctor Parameters []
explicit GradientImage() ;

/// @brief Method .ctor addr 0x1ffd870 size 0x8c virtual false final false
 void _ctor() ;
