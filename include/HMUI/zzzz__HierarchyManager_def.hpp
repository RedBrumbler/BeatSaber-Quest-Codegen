...
/// @brief Method Start addr 0x1ff085c size 0x11c virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x1ff0a24 size 0x140 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleSceneTransitionDidFinish addr 0x1ff0978 size 0xac virtual false final false
...
/// @brief Method HandleBeforeDismissingScenes addr 0x1ff0b64 size 0xac virtual false final false
 void HandleBeforeDismissingScenes() ;

/// @brief Method StartWithFlowCoordinator addr 0x1ff0c10 size 0x24 virtual false final false
 void StartWithFlowCoordinator(HMUI::FlowCoordinator flowCoordinator) ;

// Ctor Parameters []
explicit HierarchyManager() ;

/// @brief Method .ctor addr 0x1ff0c34 size 0x8 virtual false final false
 void _ctor() ;
