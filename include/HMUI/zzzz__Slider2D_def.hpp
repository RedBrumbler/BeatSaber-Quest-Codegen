...
/// @brief Method get_handleRect addr 0x1fea078 size 0x8 virtual false final false
 UnityEngine::RectTransform get_handleRect() ;

/// @brief Method set_handleRect addr 0x1fea080 size 0x88 virtual false final false
 void set_handleRect(UnityEngine::RectTransform value) ;

/// @brief Method set_handleColor addr 0x1fea240 size 0xc4 virtual false final false
 void set_handleColor(UnityEngine::Color value) ;

/// @brief Method get_normalizedValue addr 0x1fea304 size 0xc virtual false final false
 UnityEngine::Vector2 get_normalizedValue() ;

/// @brief Method set_normalizedValue addr 0x1fea310 size 0x8 virtual false final false
 void set_normalizedValue(UnityEngine::Vector2 value) ;

/// @brief Method add_normalizedValueDidChangeEvent addr 0x1fea3c8 size 0xb4 virtual false final false
 void add_normalizedValueDidChangeEvent(System::Action_2<HMUI::Slider2D,UnityEngine::Vector2> value) ;

/// @brief Method remove_normalizedValueDidChangeEvent addr 0x1fea47c size 0xb4 virtual false final false
 void remove_normalizedValueDidChangeEvent(System::Action_2<HMUI::Slider2D,UnityEngine::Vector2> value) ;

/// @brief Method Rebuild addr 0x1fea530 size 0x4 virtual true final false
 void Rebuild(UnityEngine::UI::CanvasUpdate executing) ;

/// @brief Method LayoutComplete addr 0x1fea534 size 0x4 virtual true final false
 void LayoutComplete() ;

/// @brief Method GraphicUpdateComplete addr 0x1fea538 size 0x4 virtual true final false
 void GraphicUpdateComplete() ;

/// @brief Method OnEnable addr 0x1fea53c size 0x44 virtual true final false
 void OnEnable() ;

/// @brief Method OnDisable addr 0x1fea580 size 0x24 virtual true final false
 void OnDisable() ;

/// @brief Method UpdateCachedReferences addr 0x1fea108 size 0x138 virtual false final false
 void UpdateCachedReferences() ;

/// @brief Method SetNormalizedValue addr 0x1fea5a4 size 0x8 virtual false final false
 void SetNormalizedValue(UnityEngine::Vector2 input) ;

/// @brief Method SetNormalizedValue addr 0x1fea318 size 0xb0 virtual false final false
 void SetNormalizedValue(UnityEngine::Vector2 input, bool sendCallback) ;

/// @brief Method OnRectTransformDimensionsChange addr 0x1fea5ac size 0x44 virtual true final false
 void OnRectTransformDimensionsChange() ;

/// @brief Method UpdateVisuals addr 0x1fea5f0 size 0x188 virtual true final false
 void UpdateVisuals() ;

/// @brief Method UpdateDrag addr 0x1fea778 size 0x230 virtual false final false
 void UpdateDrag(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method MayDrag addr 0x1fea9a8 size 0x64 virtual false final false
 bool MayDrag(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnBeginDrag addr 0x1feaa0c size 0x80 virtual true final false
 void OnBeginDrag(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnDrag addr 0x1feaa8c size 0x90 virtual true final false
 void OnDrag(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnPointerDown addr 0x1feab1c size 0xa0 virtual true final false
 void OnPointerDown(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnPointerEnter addr 0x1feabbc size 0x8 virtual true final false
 void OnPointerEnter(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method DoStateTransition addr 0x1feabc4 size 0xc virtual true final false
 void DoStateTransition(UnityEngine::UI::UnityEngine__UI__Selectable__SelectionState state, bool instant) ;

/// @brief Method OnInitializePotentialDrag addr 0x1feabd0 size 0x18 virtual true final false
 void OnInitializePotentialDrag(UnityEngine::EventSystems::PointerEventData eventData) ;

// Ctor Parameters []
explicit Slider2D() ;

/// @brief Method .ctor addr 0x1feabe8 size 0x58 virtual false final false
 void _ctor() ;

/// @brief Method UnityEngine.UI.ICanvasElement.get_transform addr 0x1feac40 size 0x8 virtual true final true
