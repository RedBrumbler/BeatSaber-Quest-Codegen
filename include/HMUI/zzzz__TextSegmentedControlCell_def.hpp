...
/// @brief Method set_text addr 0x1fe7c48 size 0x24 virtual false final false
 void set_text(::StringW value) ;

/// @brief Method get_text addr 0x1fe7cc4 size 0x24 virtual false final false
 ::StringW get_text() ;

/// @brief Method set_fontSize addr 0x1fe7c2c size 0x1c virtual false final false
 void set_fontSize(float_t value) ;

/// @brief Method get_fontSize addr 0x1fe7ce8 size 0x1c virtual false final false
 float_t get_fontSize() ;

/// @brief Method set_hideBackgroundImage addr 0x1fe7c6c size 0x24 virtual false final false
 void set_hideBackgroundImage(bool value) ;

/// @brief Method get_preferredWidth addr 0x1fe7c90 size 0x24 virtual false final false
 float_t get_preferredWidth() ;

// Ctor Parameters []
explicit TextSegmentedControlCell() ;

/// @brief Method .ctor addr 0x1fe7d04 size 0x8 virtual false final false
 void _ctor() ;
