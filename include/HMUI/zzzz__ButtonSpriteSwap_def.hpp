...
/// @brief Method Awake addr 0x1ff6004 size 0x78 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x1ff6130 size 0x2c virtual false final false
 void Start() ;

/// @brief Method OnEnable addr 0x1ff6180 size 0x24 virtual true final false
 void OnEnable() ;

/// @brief Method OnDestroy addr 0x1ff61a4 size 0xc0 virtual false final false
 void OnDestroy() ;

/// @brief Method HandleButtonSelectionStateDidChange addr 0x1ff6318 size 0xcc virtual true final false
 void HandleButtonSelectionStateDidChange(HMUI::HMUI__NoTransitionsButton__SelectionState state) ;

/// @brief Method RefreshVisualState addr 0x1ff615c size 0x24 virtual false final false
 void RefreshVisualState() ;

// Ctor Parameters []
explicit ButtonSpriteSwap() ;

/// @brief Method .ctor addr 0x1ff63e4 size 0x8 virtual false final false
 void _ctor() ;
