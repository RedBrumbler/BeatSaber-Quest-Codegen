...
namespace HMUI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13739))}
...
/// @brief Method add_didSelectRowInSectionEvent addr 0x200cd54 size 0xb0 virtual false final false
 void add_didSelectRowInSectionEvent(System::Action_3<HMUI::SectionTableView,int32_t,int32_t> value) ;

/// @brief Method remove_didSelectRowInSectionEvent addr 0x200ce04 size 0xb0 virtual false final false
 void remove_didSelectRowInSectionEvent(System::Action_3<HMUI::SectionTableView,int32_t,int32_t> value) ;

/// @brief Method add_didSelectHeaderEvent addr 0x200ceb4 size 0xb0 virtual false final false
 void add_didSelectHeaderEvent(System::Action_2<HMUI::SectionTableView,int32_t> value) ;

/// @brief Method remove_didSelectHeaderEvent addr 0x200cf64 size 0xb0 virtual false final false
 void remove_didSelectHeaderEvent(System::Action_2<HMUI::SectionTableView,int32_t> value) ;

/// @brief Method get_dataSource addr 0x200d014 size 0x8 virtual false final false
 HMUI::HMUI__SectionTableView__IDataSource get_dataSource() ;

/// @brief Method set_dataSource addr 0x200d01c size 0x24 virtual false final false
 void set_dataSource(HMUI::HMUI__SectionTableView__IDataSource value) ;

/// @brief Method IsSectionUnfolded addr 0x200d040 size 0x34 virtual false final false
 bool IsSectionUnfolded(int32_t section) ;

/// @brief Method CellSize addr 0x200d074 size 0xa0 virtual true final true
 float_t CellSize() ;

/// @brief Method NumberOfCells addr 0x200d114 size 0x48 virtual true final true
 int32_t NumberOfCells() ;

/// @brief Method CellForIdx addr 0x200d15c size 0x184 virtual true final true
 HMUI::TableCell CellForIdx(HMUI::TableView tableView, int32_t baseRow) ;

/// @brief Method ReloadData addr 0x200d3c0 size 0x8 virtual true final false
 void ReloadData() ;

/// @brief Method ReloadData addr 0x200d3c8 size 0x210 virtual false final false
 void ReloadData(bool resetFoldState) ;

/// @brief Method DidSelectCellWithIdx addr 0x200d90c size 0x7c virtual true final false
 void DidSelectCellWithIdx(int32_t baseRow) ;

/// @brief Method UnfoldAllSections addr 0x200d988 size 0x58 virtual false final false
 void UnfoldAllSections() ;

/// @brief Method FoldAll addr 0x200d9e0 size 0x54 virtual false final false
 void FoldAll() ;

/// @brief Method UnfoldSection addr 0x200da34 size 0x16c virtual false final false
 void UnfoldSection(int32_t section) ;

/// @brief Method FoldSection addr 0x200df50 size 0xa8 virtual false final false
 void FoldSection(int32_t section) ;

/// @brief Method ScrollToRow addr 0x200e364 size 0x44 virtual false final false
 void ScrollToRow(int32_t section, int32_t row, HMUI::HMUI__TableView__ScrollPositionType scrollPositionType, bool animated) ;

/// @brief Method SectionAndRowForBaseRow addr 0x200d2e0 size 0xe0 virtual false final false
...
/// @brief Method .ctor addr 0x200e484 size 0x4 virtual false final false
 void _ctor() ;
