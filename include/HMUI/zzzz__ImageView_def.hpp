...
namespace HMUI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13013))}
...
/// @brief Method get_useScriptableObjectColors addr 0x1ffda1c size 0x8 virtual false final false
 bool get_useScriptableObjectColors() ;

/// @brief Method set_useScriptableObjectColors addr 0x1ffda24 size 0xc virtual false final false
 void set_useScriptableObjectColors(bool value) ;

/// @brief Method get_color addr 0x1ffda30 size 0x88 virtual true final false
 UnityEngine::Color get_color() ;

/// @brief Method set_color addr 0x1ffdab8 size 0x8 virtual true final false
 void set_color(UnityEngine::Color value) ;

/// @brief Method get_skew addr 0x1ffdac0 size 0x8 virtual false final false
 float_t get_skew() ;

/// @brief Method get_gradient addr 0x1ffdac8 size 0x8 virtual false final false
 bool get_gradient() ;

/// @brief Method set_gradient addr 0x1ffdad0 size 0x18 virtual false final false
 void set_gradient(bool value) ;

/// @brief Method get_color0 addr 0x1ffdae8 size 0x90 virtual false final false
 UnityEngine::Color get_color0() ;

/// @brief Method set_color0 addr 0x1ff5d90 size 0x20 virtual false final false
 void set_color0(UnityEngine::Color value) ;

/// @brief Method get_color1 addr 0x1ffdb78 size 0x90 virtual false final false
 UnityEngine::Color get_color1() ;

/// @brief Method set_color1 addr 0x1ff5db0 size 0x20 virtual false final false
 void set_color1(UnityEngine::Color value) ;

/// @brief Method OnEnable addr 0x1ffdc08 size 0x28 virtual true final false
 void OnEnable() ;

/// @brief Method OnPopulateMesh addr 0x1ffdc30 size 0x174 virtual true final false
 void OnPopulateMesh(UnityEngine::UI::VertexHelper toFill) ;

/// @brief Method __Refresh addr 0x20046a8 size 0x10 virtual true final true
 void __Refresh() ;

/// @brief Method GenerateSimpleSprite addr 0x1ffdda4 size 0x14c0 virtual false final false
 void GenerateSimpleSprite(UnityEngine::UI::VertexHelper vh, bool lPreserveAspect, float_t curvedUIRadius) ;

/// @brief Method GenerateSlicedSprite addr 0x1fff264 size 0x1bcc virtual false final false
 void GenerateSlicedSprite(UnityEngine::UI::VertexHelper toFill, float_t curvedUIRadius) ;

/// @brief Method GenerateTiledSprite addr 0x2000e30 size 0x2394 virtual false final false
 void GenerateTiledSprite(UnityEngine::UI::VertexHelper toFill, float_t curvedUIRadius) ;

/// @brief Method AddQuad addr 0x2005ebc size 0xe4 virtual false final false
...
/// @brief Method AddQuad addr 0x2005c48 size 0x274 virtual false final false
...
/// @brief Method AddQuad addr 0x2005964 size 0x2e4 virtual false final false
...
/// @brief Method AddQuadWithHorizontalGradient addr 0x2004dac size 0x8c4 virtual false final false
...
/// @brief Method AddQuadWithVerticalGradient addr 0x2005670 size 0x2f4 virtual false final false
...
/// @brief Method GetAdjustedBorders addr 0x2004cd4 size 0xd8 virtual false final false
static UnityEngine::Vector4 GetAdjustedBorders(UnityEngine::Vector4 border, UnityEngine::Rect rect) ;

/// @brief Method GenerateFilledSprite addr 0x20031c4 size 0x14e4 virtual false final false
 void GenerateFilledSprite(UnityEngine::UI::VertexHelper toFill, bool preserveAspect, float_t curvedUIRadius) ;

/// @brief Method RadialCut addr 0x2005fa0 size 0x120 virtual false final false
...
/// @brief Method RadialCut addr 0x20060c0 size 0x3ec virtual false final false
static void RadialCut(::ArrayW<UnityEngine::Vector3> xy, float_t cos, float_t sin, bool invert, int32_t corner) ;

/// @brief Method GetNumberOfElements addr 0x2004c40 size 0x94 virtual false final false
static int32_t GetNumberOfElements(float_t curvedUIRadius, float_t width) ;

/// @brief Method GetDrawingDimensions addr 0x20046b8 size 0x588 virtual false final false
 UnityEngine::Vector4 GetDrawingDimensions(bool shouldPreserveAspect) ;

// Ctor Parameters []
explicit ImageView() ;

/// @brief Method .ctor addr 0x20064ac size 0x8c virtual false final false
 void _ctor() ;
