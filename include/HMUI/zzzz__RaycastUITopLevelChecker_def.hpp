...
/// @brief Method Awake addr 0x1fe6160 size 0x74 virtual false final false
 void Awake() ;

/// @brief Method get_isOnTop addr 0x1fe61d4 size 0x208 virtual false final false
 bool get_isOnTop() ;

// Ctor Parameters []
explicit RaycastUITopLevelChecker() ;

/// @brief Method .ctor addr 0x1fe63dc size 0x7c virtual false final false
 void _ctor() ;
