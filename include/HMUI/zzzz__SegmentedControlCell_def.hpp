...
/// @brief Method get_cellNumber addr 0x1fe7720 size 0x8 virtual false final false
 int32_t get_cellNumber() ;

/// @brief Method set_cellNumber addr 0x1fe7728 size 0x8 virtual false final false
 void set_cellNumber(int32_t value) ;

/// @brief Method SegmentedControlSetup addr 0x1fe74b4 size 0xc virtual false final false
 void SegmentedControlSetup(HMUI::SegmentedControl segmentedControl, int32_t cellNumber) ;

/// @brief Method InternalToggle addr 0x1fe7730 size 0x24 virtual true final false
 void InternalToggle() ;

// Ctor Parameters []
explicit SegmentedControlCell() ;

/// @brief Method .ctor addr 0x1fe6e78 size 0x8 virtual false final false
 void _ctor() ;
