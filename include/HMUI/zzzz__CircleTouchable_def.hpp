...
namespace HMUI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13638))}
...
/// @brief Method OnEnable addr 0x1febd24 size 0x1c virtual true final false
 void OnEnable() ;

/// @brief Method UpdateCachedReferences addr 0x1febd40 size 0x6c virtual false final false
 void UpdateCachedReferences() ;

/// @brief Method Raycast addr 0x1febdac size 0xcc virtual true final false
 bool Raycast(UnityEngine::Vector2 sp, UnityEngine::Camera eventCamera) ;

/// @brief Method OnDrawGizmosSelected addr 0x1febe78 size 0x110 virtual false final false
 void OnDrawGizmosSelected() ;

/// @brief Method DrawGizmoCircle addr 0x1febf88 size 0xe0 virtual false final false
 void DrawGizmoCircle(UnityEngine::Vector3 center, float_t radius, int32_t steps) ;

// Ctor Parameters []
explicit CircleTouchable() ;

/// @brief Method .ctor addr 0x1fec068 size 0x10 virtual false final false
 void _ctor() ;
