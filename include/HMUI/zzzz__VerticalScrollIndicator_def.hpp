...
/// @brief Method set_progress addr 0x200a3b8 size 0x2c virtual false final false
 void set_progress(float_t value) ;

/// @brief Method get_progress addr 0x2010980 size 0x8 virtual false final false
 float_t get_progress() ;

/// @brief Method set_normalizedPageHeight addr 0x200a150 size 0x2c virtual false final false
 void set_normalizedPageHeight(float_t value) ;

/// @brief Method get_normalizedPageHeight addr 0x2010988 size 0x8 virtual false final false
 float_t get_normalizedPageHeight() ;

/// @brief Method set_disabled addr 0x2010990 size 0x40 virtual false final false
 void set_disabled(bool value) ;

/// @brief Method OnEnable addr 0x20109d0 size 0x4 virtual false final false
 void OnEnable() ;

/// @brief Method RefreshHandle addr 0x2010890 size 0xf0 virtual false final false
 void RefreshHandle() ;

// Ctor Parameters []
explicit VerticalScrollIndicator() ;

/// @brief Method .ctor addr 0x20109d4 size 0x10 virtual false final false
 void _ctor() ;
