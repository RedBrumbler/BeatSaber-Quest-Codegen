...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(ByRef<UnityEngine::Color>, UnityEngine::Color)>(&HMUI::SetPropertyUtility::SetColor)> {
  ...
  constexpr static std::size_t addrs = 0x200bde8;
...
template<typename T>
 bool HMUI::SetPropertyUtility::SetStruct(ByRef<T> currentValue, T newValue)  {
...
template<typename T>
 bool HMUI::SetPropertyUtility::SetClass(ByRef<T> currentValue, T newValue)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HMUI::SetPropertyUtility>::get(),
                        "SetClass",
                        std::vector<Il2CppClass*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<T>::get()},
