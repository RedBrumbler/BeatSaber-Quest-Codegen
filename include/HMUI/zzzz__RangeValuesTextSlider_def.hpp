...
namespace HMUI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13632))}
...
/// @brief Method get_minValue addr 0x1fe99b0 size 0x8 virtual false final false
 float_t get_minValue() ;

/// @brief Method set_minValue addr 0x1fe99b8 size 0x80 virtual false final false
 void set_minValue(float_t value) ;

/// @brief Method get_maxValue addr 0x1fe9a38 size 0x8 virtual false final false
 float_t get_maxValue() ;

/// @brief Method set_maxValue addr 0x1fe9a40 size 0x80 virtual false final false
 void set_maxValue(float_t value) ;

/// @brief Method set_value addr 0x1fe9ac0 size 0x1c virtual false final false
 void set_value(float_t value) ;

/// @brief Method get_value addr 0x1fe9afc size 0x28 virtual false final false
 float_t get_value() ;

/// @brief Method add_valueDidChangeEvent addr 0x1fe9b3c size 0xb4 virtual false final false
 void add_valueDidChangeEvent(System::Action_2<HMUI::RangeValuesTextSlider,float_t> value) ;

/// @brief Method remove_valueDidChangeEvent addr 0x1fe9bf0 size 0xb4 virtual false final false
 void remove_valueDidChangeEvent(System::Action_2<HMUI::RangeValuesTextSlider,float_t> value) ;

/// @brief Method Awake addr 0x1fe9ca4 size 0x1ec virtual true final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x1fe9e90 size 0x98 virtual true final false
 void OnDestroy() ;

/// @brief Method HandleNormalizedValueDidChange addr 0x1fe9f28 size 0x34 virtual false final false
 void HandleNormalizedValueDidChange(HMUI::TextSlider slider, float_t normalizedValue) ;

/// @brief Method ConvertFromNormalizedValue addr 0x1fe9b24 size 0x18 virtual false final false
 float_t ConvertFromNormalizedValue(float_t normalizedValue) ;

/// @brief Method NormalizeValue addr 0x1fe9adc size 0x18 virtual false final false
 float_t NormalizeValue(float_t rangeValue) ;

/// @brief Method TextForNormalizedValue addr 0x1fe9f5c size 0x24 virtual true final false
 ::StringW TextForNormalizedValue(float_t normalizedValue) ;

/// @brief Method TextForValue addr 0x1fe9f80 size 0x68 virtual true final false
 ::StringW TextForValue(float_t value) ;

// Ctor Parameters []
explicit RangeValuesTextSlider() ;

/// @brief Method .ctor addr 0x1fe990c size 0xc virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__17_0 addr 0x1fe9fe8 size 0x44 virtual false final false
 void _Awake_b__17_0() ;

/// @brief Method <Awake>b__17_1 addr 0x1fea034 size 0x44 virtual false final false
 void _Awake_b__17_1() ;
