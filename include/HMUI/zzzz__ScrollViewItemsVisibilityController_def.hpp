...
/// @brief Method .ctor addr 0x200b568 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Start>b__11_0 addr 0x200b570 size 0x44 virtual false final false
 float_t _Start_b__11_0(System::Tuple_2<HMUI::ScrollViewItemForVisibilityController,float_t> item) ;

/// @brief Method <Start>b__11_1 addr 0x200b5b4 size 0x44 virtual false final false
...
/// @brief Method Start addr 0x200ac2c size 0x4a0 virtual false final false
 void Start() ;

/// @brief Method Update addr 0x200b274 size 0x9c virtual false final false
 void Update() ;

/// @brief Method UpdateVisibilityUpDirection addr 0x200b0cc size 0x1a8 virtual false final false
 void UpdateVisibilityUpDirection(float_t newContentAnchoredPositionY) ;

/// @brief Method UpdateVisibilityDownDirection addr 0x200b310 size 0x19c virtual false final false
 void UpdateVisibilityDownDirection(float_t newContentAnchoredPositionY) ;

// Ctor Parameters []
explicit ScrollViewItemsVisibilityController() ;

/// @brief Method .ctor addr 0x200b4ac size 0x58 virtual false final false
 void _ctor() ;
