...
/// @brief Method .ctor addr 0x200ab6c size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__42_1 addr 0x200ab74 size 0x4 virtual false final false
 float_t _Awake_b__42_1(float_t i) ;

/// @brief Method <Awake>b__42_3 addr 0x200ab78 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x200a6c8 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <PageUpButtonPressed>b__0 addr 0x200ab7c size 0x10 virtual false final false
...
/// @brief Method .ctor addr 0x200a9e4 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <PageDownButtonPressed>b__0 addr 0x200ab8c size 0x10 virtual false final false
...
/// @brief Method .ctor addr 0x200aa58 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <HandleJoystickWasCenteredThisFrame>b__0 addr 0x200ab9c size 0x10 virtual false final false
...
/// @brief Method .ctor addr 0x200aa60 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <HandleJoystickWasCenteredThisFrame>b__1 addr 0x200abac size 0x10 virtual false final false
...
/// @brief Method add_scrollPositionChangedEvent addr 0x2008c54 size 0xb0 virtual false final false
 void add_scrollPositionChangedEvent(System::Action_1<float_t> value) ;

/// @brief Method remove_scrollPositionChangedEvent addr 0x2008d04 size 0xb0 virtual false final false
 void remove_scrollPositionChangedEvent(System::Action_1<float_t> value) ;

/// @brief Method get_viewportTransform addr 0x2008db4 size 0x8 virtual false final false
 UnityEngine::RectTransform get_viewportTransform() ;

/// @brief Method get_contentTransform addr 0x2008dbc size 0x8 virtual false final false
 UnityEngine::RectTransform get_contentTransform() ;

/// @brief Method get_position addr 0x2008dc4 size 0x30 virtual false final false
 float_t get_position() ;

/// @brief Method get_scrollableSize addr 0x2008df4 size 0x34 virtual false final false
 float_t get_scrollableSize() ;

/// @brief Method get_scrollPageSize addr 0x2008e7c size 0x54 virtual false final false
 float_t get_scrollPageSize() ;

/// @brief Method get_contentSize addr 0x2008e28 size 0x54 virtual false final false
 float_t get_contentSize() ;

/// @brief Method Awake addr 0x2008ed0 size 0x4e8 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x200955c size 0x13c virtual false final false
 void OnDestroy() ;

/// @brief Method CheckScrollInput addr 0x2009698 size 0x15c virtual false final false
 void CheckScrollInput() ;

/// @brief Method Update addr 0x2009d3c size 0x120 virtual false final false
 void Update() ;

/// @brief Method SetContentSize addr 0x2009f30 size 0x220 virtual false final false
 void SetContentSize(float_t contentSize) ;

/// @brief Method UpdateContentSize addr 0x20093b8 size 0x94 virtual false final false
 void UpdateContentSize() ;

/// @brief Method ScrollToEnd addr 0x200a17c size 0x40 virtual false final false
 void ScrollToEnd(bool animated) ;

/// @brief Method ScrollToWorldPosition addr 0x200a1bc size 0x48 virtual false final false
 void ScrollToWorldPosition(UnityEngine::Vector3 worldPosition, float_t pageRelativePosition, bool animated) ;

/// @brief Method ScrollToWorldPositionIfOutsideArea addr 0x200a2b4 size 0xb0 virtual false final false
...
/// @brief Method ScrollTo addr 0x2008b88 size 0xc4 virtual false final false
 void ScrollTo(float_t destinationPos, bool animated) ;

/// @brief Method WorldPositionToScrollViewPosition addr 0x200a204 size 0xb0 virtual false final false
 UnityEngine::Vector2 WorldPositionToScrollViewPosition(UnityEngine::Vector3 worldPosition) ;

/// @brief Method SetDestinationPos addr 0x200a364 size 0x54 virtual false final false
 void SetDestinationPos(float_t value) ;

/// @brief Method UpdateVerticalScrollIndicator addr 0x2009e5c size 0xd4 virtual false final false
 void UpdateVerticalScrollIndicator(float_t posY) ;

/// @brief Method PageUpButtonPressed addr 0x200a3e4 size 0x2e4 virtual false final false
 void PageUpButtonPressed() ;

/// @brief Method PageDownButtonPressed addr 0x200a6d0 size 0x314 virtual false final false
 void PageDownButtonPressed() ;

/// @brief Method RefreshButtons addr 0x200944c size 0x110 virtual false final false
 void RefreshButtons() ;

/// @brief Method HandlePointerDidEnter addr 0x200a9ec size 0x14 virtual false final false
 void HandlePointerDidEnter(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method HandlePointerDidExit addr 0x200aa00 size 0x8 virtual false final false
 void HandlePointerDidExit(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method HandleJoystickWasNotCenteredThisFrame addr 0x20097f4 size 0xf4 virtual false final false
 void HandleJoystickWasNotCenteredThisFrame(UnityEngine::Vector2 deltaPos) ;

/// @brief Method HandleJoystickWasCenteredThisFrame addr 0x20098e8 size 0x454 virtual false final false
 void HandleJoystickWasCenteredThisFrame() ;

/// @brief Method ResolveScrollDirection addr 0x200aa08 size 0x50 virtual false final false
 HMUI::HMUI__ScrollView__ScrollDirection ResolveScrollDirection(UnityEngine::Vector2 deltaPos) ;

// Ctor Parameters []
explicit ScrollView() ;

/// @brief Method .ctor addr 0x200aa68 size 0x30 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__42_0 addr 0x200aa98 size 0x3c virtual false final false
 float_t _Awake_b__42_0(HMUI::ItemForFocussedScrolling item) ;

/// @brief Method <Awake>b__42_2 addr 0x200aad4 size 0x34 virtual false final false
