...
/// @brief Method add_colorDidChangeEvent addr 0x1fe8918 size 0xb4 virtual false final false
...
/// @brief Method remove_colorDidChangeEvent addr 0x1fe89cc size 0xb4 virtual false final false
...
/// @brief Method Awake addr 0x1fe8a80 size 0x98 virtual true final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x1fe8c5c size 0x8c virtual true final false
 void OnDestroy() ;

/// @brief Method SetColors addr 0x1fe8d9c size 0x30 virtual false final false
 void SetColors(UnityEngine::Color color0, UnityEngine::Color color1) ;

/// @brief Method UpdateVisuals addr 0x1fe8dcc size 0x1a4 virtual true final false
 void UpdateVisuals() ;

/// @brief Method TextForNormalizedValue addr 0x1fe9500 size 0x1a0 virtual true final false
 ::StringW TextForNormalizedValue(float_t normalizedValue) ;

/// @brief Method HandleNormalizedValueDidChange addr 0x1fe96a0 size 0x58 virtual false final false
 void HandleNormalizedValueDidChange(HMUI::TextSlider slider, float_t normalizedValue) ;

/// @brief Method OnPointerUp addr 0x1fe96f8 size 0xa0 virtual true final false
 void OnPointerUp(UnityEngine::EventSystems::PointerEventData eventData) ;

// Ctor Parameters []
explicit ColorGradientSlider() ;

/// @brief Method .ctor addr 0x1fe9798 size 0x4 virtual false final false
 void _ctor() ;
