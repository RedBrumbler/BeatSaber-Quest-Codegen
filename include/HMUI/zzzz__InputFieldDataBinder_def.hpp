...
/// @brief Method .ctor addr 0x1fe0460 size 0x80 virtual false final false
 void _ctor() ;
...
/// @brief Method ClearBindings addr 0x1fe04e0 size 0x2c4 virtual false final false
 void ClearBindings() ;
...
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13585), inst: 80 })
...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13586))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13586), inst: 2 })
