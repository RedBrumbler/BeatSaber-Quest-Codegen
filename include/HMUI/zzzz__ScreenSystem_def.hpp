...
/// @brief Method get_titleViewController addr 0x1ff2368 size 0x8 virtual false final false
 HMUI::TitleViewController get_titleViewController() ;

/// @brief Method get_mainScreen addr 0x1ff2370 size 0x8 virtual false final false
 HMUI::Screen get_mainScreen() ;

/// @brief Method get_leftScreen addr 0x1ff2378 size 0x8 virtual false final false
 HMUI::Screen get_leftScreen() ;

/// @brief Method get_rightScreen addr 0x1ff2380 size 0x8 virtual false final false
 HMUI::Screen get_rightScreen() ;

/// @brief Method get_bottomScreen addr 0x1ff2388 size 0x8 virtual false final false
 HMUI::Screen get_bottomScreen() ;

/// @brief Method get_topScreen addr 0x1ff2390 size 0x8 virtual false final false
 HMUI::Screen get_topScreen() ;

/// @brief Method add_backButtonWasPressedEvent addr 0x1ff2398 size 0x9c virtual false final false
 void add_backButtonWasPressedEvent(System::Action value) ;

/// @brief Method remove_backButtonWasPressedEvent addr 0x1ff2434 size 0x9c virtual false final false
 void remove_backButtonWasPressedEvent(System::Action value) ;

/// @brief Method Awake addr 0x1ff24d0 size 0xc4 virtual false final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x1ff2594 size 0x1c virtual false final false
 void OnDestroy() ;

/// @brief Method SetBackButton addr 0x1ff25b0 size 0x30 virtual false final false
 void SetBackButton(bool visible, bool animated) ;

// Ctor Parameters []
explicit ScreenSystem() ;

/// @brief Method .ctor addr 0x1ff25e0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__24_0 addr 0x1ff25e8 size 0x1c virtual false final false
 void _Awake_b__24_0() ;
