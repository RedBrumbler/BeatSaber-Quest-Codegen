...
/// @brief Method add_interactableChangeEvent addr 0x1fe4e60 size 0xb0 virtual false final false
 void add_interactableChangeEvent(System::Action_2<HMUI::Interactable,bool> value) ;

/// @brief Method remove_interactableChangeEvent addr 0x1fe4f10 size 0xb0 virtual false final false
 void remove_interactableChangeEvent(System::Action_2<HMUI::Interactable,bool> value) ;

/// @brief Method get_interactable addr 0x1fe4fc0 size 0x8 virtual false final false
 bool get_interactable() ;

/// @brief Method set_interactable addr 0x1fe4fc8 size 0x3c virtual false final false
 void set_interactable(bool value) ;

// Ctor Parameters []
explicit Interactable() ;

/// @brief Method .ctor addr 0x1fdf6cc size 0x10 virtual false final false
 void _ctor() ;
