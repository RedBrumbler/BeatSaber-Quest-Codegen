...
/// @brief Method get_radius addr 0x1fe2b70 size 0x8 virtual false final false
 float_t get_radius() ;

/// @brief Method SetRadius addr 0x1fe2b78 size 0x18 virtual false final false
 void SetRadius(float_t value) ;

/// @brief Method Start addr 0x1fe2c80 size 0xa4 virtual true final false
 void Start() ;

/// @brief Method OnPopulateMesh addr 0x1fe2d24 size 0x198 virtual true final false
 void OnPopulateMesh(UnityEngine::UI::VertexHelper vh) ;

/// @brief Method TransformPointFromCanvasTo3D addr 0x1fe2ebc size 0x40 virtual false final false
 UnityEngine::Vector3 TransformPointFromCanvasTo3D(UnityEngine::Vector2 point) ;

/// @brief Method RebuildAndSetup addr 0x1fe2b90 size 0xf0 virtual false final false
static void RebuildAndSetup(UnityEngine::Transform t) ;

// Ctor Parameters []
explicit CurvedCanvasSettings() ;

/// @brief Method .ctor addr 0x1fe2efc size 0x60 virtual false final false
 void _ctor() ;
