...
/// @brief Method get_skew addr 0x1fec874 size 0x8 virtual false final false
 float_t get_skew() ;

/// @brief Method OnPopulateMesh addr 0x1fec87c size 0x18 virtual true final false
 void OnPopulateMesh(UnityEngine::UI::VertexHelper vh) ;

// Ctor Parameters []
explicit Touchable() ;

/// @brief Method .ctor addr 0x1fec078 size 0x58 virtual false final false
 void _ctor() ;
