...
/// @brief Method .ctor addr 0x1fe24ec size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <AddBinding>b__0 addr 0x1fe2b34 size 0x3c virtual false final false
...
/// @brief Method .ctor addr 0x1fe20c0 size 0x24 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x1fe2158 size 0x3c virtual false final false
 void _ctor(System::Collections::Generic::List_1<System::Tuple_2<UnityEngine::UI::Toggle,System::Action_1<bool>>> bindingData) ;

/// @brief Method Init addr 0x1fe20e4 size 0x74 virtual false final false
 void Init() ;

/// @brief Method AddBindings addr 0x1fe2194 size 0x164 virtual false final false
 void AddBindings(System::Collections::Generic::List_1<System::Tuple_2<UnityEngine::UI::Toggle,System::Action_1<bool>>> bindingData) ;

/// @brief Method AddBinding addr 0x1fe22f8 size 0xd8 virtual false final false
 void AddBinding(UnityEngine::UI::Toggle toggle, System::Action_1<bool> action) ;

/// @brief Method AddBinding addr 0x1fe23d0 size 0x11c virtual false final false
 void AddBinding(UnityEngine::UI::Toggle toggle, bool enabled, System::Action action) ;

/// @brief Method ClearBindings addr 0x1fe24f4 size 0x234 virtual false final false
 void ClearBindings() ;

/// @brief Method Disable addr 0x1fe2728 size 0x204 virtual false final false
 void Disable() ;

/// @brief Method Enable addr 0x1fe292c size 0x208 virtual false final false
 void Enable() ;
