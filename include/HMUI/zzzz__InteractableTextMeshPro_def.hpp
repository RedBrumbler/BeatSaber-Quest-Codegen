...
/// @brief Method OnCanvasGroupChanged addr 0x1fe3848 size 0x194 virtual true final false
 void OnCanvasGroupChanged() ;

// Ctor Parameters []
explicit InteractableTextMeshPro() ;

/// @brief Method .ctor addr 0x1fe39dc size 0x88 virtual false final false
 void _ctor() ;
