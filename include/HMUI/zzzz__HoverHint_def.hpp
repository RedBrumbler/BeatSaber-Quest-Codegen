...
/// @brief Method get_text addr 0x1fe3e5c size 0x8 virtual false final false
 ::StringW get_text() ;

/// @brief Method set_text addr 0x1fe3e64 size 0x8 virtual false final false
 void set_text(::StringW value) ;

/// @brief Method get_size addr 0x1fe3e6c size 0x90 virtual false final false
 UnityEngine::Vector2 get_size() ;

/// @brief Method get_worldCenter addr 0x1fe3efc size 0xfc virtual false final false
 UnityEngine::Vector3 get_worldCenter() ;

/// @brief Method OnPointerEnter addr 0x1fe3ff8 size 0x1c virtual true final true
 void OnPointerEnter(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnPointerExit addr 0x1fe40a8 size 0xbc virtual true final true
 void OnPointerExit(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnDisable addr 0x1fe41dc size 0x80 virtual false final false
 void OnDisable() ;

// Ctor Parameters []
explicit HoverHint() ;

/// @brief Method .ctor addr 0x1fe425c size 0x58 virtual false final false
 void _ctor() ;
