...
/// @brief Method add_didSelectCellEvent addr 0x1fe6e80 size 0xb0 virtual false final false
 void add_didSelectCellEvent(System::Action_2<HMUI::SegmentedControl,int32_t> value) ;

/// @brief Method remove_didSelectCellEvent addr 0x1fe6f30 size 0xb0 virtual false final false
 void remove_didSelectCellEvent(System::Action_2<HMUI::SegmentedControl,int32_t> value) ;

/// @brief Method get_dataSource addr 0x1fe6fe0 size 0x8 virtual false final false
 HMUI::HMUI__SegmentedControl__IDataSource get_dataSource() ;

/// @brief Method set_dataSource addr 0x1fe6474 size 0x8 virtual false final false
 void set_dataSource(HMUI::HMUI__SegmentedControl__IDataSource value) ;

/// @brief Method get_selectedCellNumber addr 0x1fe6fe8 size 0x8 virtual false final false
 int32_t get_selectedCellNumber() ;

/// @brief Method get_cells addr 0x1fe6ff0 size 0x8 virtual false final false
 System::Collections::Generic::IReadOnlyList_1<HMUI::SegmentedControlCell> get_cells() ;

/// @brief Method CreateCells addr 0x1fe6ff8 size 0x4bc virtual false final false
 void CreateCells() ;

/// @brief Method HandleCellSelectionDidChange addr 0x1fe74c0 size 0x150 virtual false final false
...
/// @brief Method SetCallbackForCell addr 0x1fe7610 size 0x68 virtual false final false
 void SetCallbackForCell(int32_t cellNumber, System::Action_1<int32_t> callback) ;

/// @brief Method ReloadData addr 0x1fe64bc size 0x408 virtual false final false
 void ReloadData() ;

/// @brief Method SelectCellWithNumber addr 0x1fe7678 size 0xa8 virtual false final false
 void SelectCellWithNumber(int32_t selectCellNumber) ;

// Ctor Parameters []
explicit SegmentedControl() ;

/// @brief Method .ctor addr 0x1fe6cfc size 0x10c virtual false final false
 void _ctor() ;
