...
template<::cordl_internals::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13597))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13597), inst: 2 })
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13597))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13597), inst: 92 })
// CS Name: HMUI.ValueChangedBinder`1
