...
/// @brief Method get_reuseIdentifier addr 0x200e558 size 0x8 virtual false final false
 ::StringW get_reuseIdentifier() ;

/// @brief Method set_reuseIdentifier addr 0x200e560 size 0x8 virtual false final false
 void set_reuseIdentifier(::StringW value) ;

/// @brief Method get_idx addr 0x200e568 size 0x8 virtual false final false
 int32_t get_idx() ;

/// @brief Method set_idx addr 0x200e570 size 0x8 virtual false final false
 void set_idx(int32_t value) ;

/// @brief Method get_tableCellOwner addr 0x200e578 size 0x8 virtual false final false
 HMUI::ITableCellOwner get_tableCellOwner() ;

/// @brief Method TableViewSetup addr 0x200e580 size 0xc virtual true final false
 void TableViewSetup(HMUI::ITableCellOwner tableCellOwner, int32_t idx) ;

/// @brief Method MoveIdx addr 0x200e58c size 0x10 virtual false final false
 void MoveIdx(int32_t offset) ;

/// @brief Method InternalToggle addr 0x200e59c size 0x1f4 virtual true final false
 void InternalToggle() ;

/// @brief Method __WasPreparedForReuse addr 0x200e790 size 0x10 virtual false final false
 void __WasPreparedForReuse() ;

/// @brief Method WasPreparedForReuse addr 0x200e7a0 size 0x4 virtual true final false
 void WasPreparedForReuse() ;

// Ctor Parameters []
explicit TableCell() ;

/// @brief Method .ctor addr 0x200e7a4 size 0x8 virtual false final false
 void _ctor() ;
