...
/// @brief Method SetTexts addr 0x1fe7754 size 0x18 virtual false final false
 void SetTexts(System::Collections::Generic::IReadOnlyList_1<::StringW> texts) ;

/// @brief Method NumberOfCells addr 0x1fe776c size 0xac virtual true final true
 int32_t NumberOfCells() ;

/// @brief Method CellForCellNumber addr 0x1fe7818 size 0x294 virtual true final true
 HMUI::SegmentedControlCell CellForCellNumber(int32_t cellNumber) ;

/// @brief Method InstantiateCell addr 0x1fe7aac size 0x180 virtual false final false
 HMUI::TextSegmentedControlCell InstantiateCell(UnityEngine::Object prefab) ;

// Ctor Parameters []
explicit TextSegmentedControl() ;

/// @brief Method .ctor addr 0x1fe7cb4 size 0x10 virtual false final false
 void _ctor() ;
