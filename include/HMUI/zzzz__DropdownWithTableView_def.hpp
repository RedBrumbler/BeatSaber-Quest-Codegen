...
/// @brief Method add_didSelectCellWithIdxEvent addr 0x1ff68a8 size 0xb0 virtual false final false
 void add_didSelectCellWithIdxEvent(System::Action_2<HMUI::DropdownWithTableView,int32_t> value) ;

/// @brief Method remove_didSelectCellWithIdxEvent addr 0x1ff6958 size 0xb0 virtual false final false
 void remove_didSelectCellWithIdxEvent(System::Action_2<HMUI::DropdownWithTableView,int32_t> value) ;

/// @brief Method get_tableViewDataSource addr 0x1ff6a08 size 0x1c virtual false final false
 HMUI::HMUI__TableView__IDataSource get_tableViewDataSource() ;

/// @brief Method get_selectedIndex addr 0x1ff6a24 size 0x8 virtual false final false
 int32_t get_selectedIndex() ;

/// @brief Method set_selectedIndex addr 0x1ff6a2c size 0x8 virtual false final false
 void set_selectedIndex(int32_t value) ;

/// @brief Method Init addr 0x1ff6a34 size 0x20 virtual false final false
 void Init(HMUI::HMUI__TableView__IDataSource tableViewDataSource) ;

/// @brief Method ReloadData addr 0x1ff6a54 size 0x38 virtual false final false
 void ReloadData() ;

/// @brief Method SelectCellWithIdx addr 0x1ff6c0c size 0x28 virtual true final false
 void SelectCellWithIdx(int32_t idx) ;

/// @brief Method Awake addr 0x1ff6c34 size 0x17c virtual true final false
 void Awake() ;

/// @brief Method OnDisable addr 0x1ff6db0 size 0x8 virtual false final false
 void OnDisable() ;

/// @brief Method OnDestroy addr 0x1ff6df4 size 0x1f8 virtual true final false
 void OnDestroy() ;

/// @brief Method RefreshSize addr 0x1ff6a8c size 0x180 virtual false final false
 void RefreshSize(HMUI::HMUI__TableView__IDataSource dataSource) ;

/// @brief Method OnButtonClick addr 0x1ff6fec size 0x8 virtual false final false
 void OnButtonClick() ;

/// @brief Method HandleTableViewDidSelectCellWithIdx addr 0x1ff7074 size 0x38 virtual false final false
 void HandleTableViewDidSelectCellWithIdx(HMUI::TableView tableView, int32_t idx) ;

/// @brief Method Hide addr 0x1ff6db8 size 0x3c virtual false final false
 void Hide(bool animated) ;

/// @brief Method Show addr 0x1ff6ff4 size 0x80 virtual false final false
 void Show(bool animated) ;

/// @brief Method HandleModalViewBlockerClicked addr 0x1ff70ac size 0x8 virtual false final false
 void HandleModalViewBlockerClicked() ;

// Ctor Parameters []
explicit DropdownWithTableView() ;

/// @brief Method .ctor addr 0x1ff70b4 size 0x10 virtual false final false
 void _ctor() ;
