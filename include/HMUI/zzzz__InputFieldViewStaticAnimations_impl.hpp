...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HMUI::InputFieldViewStaticAnimations::*)()>(&HMUI::InputFieldViewStaticAnimations::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x20074c8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HMUI::InputFieldViewStaticAnimations::*)()>(&HMUI::InputFieldViewStaticAnimations::Start)> {
  ...
  constexpr static std::size_t addrs = 0x2007550;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HMUI::InputFieldViewStaticAnimations::*)()>(&HMUI::InputFieldViewStaticAnimations::OnEnable)> {
  ...
  constexpr static std::size_t addrs = 0x2007674;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HMUI::InputFieldViewStaticAnimations::*)()>(&HMUI::InputFieldViewStaticAnimations::OnDestroy)> {
  ...
  constexpr static std::size_t addrs = 0x2007690;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HMUI::InputFieldViewStaticAnimations::*)(HMUI::HMUI__InputFieldView__SelectionState)>(&HMUI::InputFieldViewStaticAnimations::HandleInputFieldViewSelectionStateDidChange)> {
  constexpr static std::size_t size = 0x100;
  constexpr static std::size_t addrs = 0x2007574;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<HMUI::HMUI__InputFieldView__SelectionState>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (HMUI::InputFieldViewStaticAnimations::*)()>(&HMUI::InputFieldViewStaticAnimations::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2007760;
...
constexpr HMUI::InputFieldView HMUI::InputFieldViewStaticAnimations::__get__inputFieldView() const {
...
constexpr UnityEngine::AnimationClip HMUI::InputFieldViewStaticAnimations::__get__normalClip() const {
...
constexpr UnityEngine::AnimationClip HMUI::InputFieldViewStaticAnimations::__get__highlightedClip() const {
...
constexpr UnityEngine::AnimationClip HMUI::InputFieldViewStaticAnimations::__get__pressedClip() const {
...
constexpr UnityEngine::AnimationClip HMUI::InputFieldViewStaticAnimations::__get__disabledClip() const {
...
constexpr UnityEngine::AnimationClip HMUI::InputFieldViewStaticAnimations::__get__selectedClip() const {
...
constexpr bool HMUI::InputFieldViewStaticAnimations::__get__didStart() const {
...
return ::cordl_internals::RunMethodRethrow<void, false>(const_cast<void*>(instance), ___internal_method);
 ...
 void HMUI::InputFieldViewStaticAnimations::HandleInputFieldViewSelectionStateDidChange(HMUI::HMUI__InputFieldView__SelectionState state)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<HMUI::InputFieldViewStaticAnimations>::get(),
                            "HandleInputFieldViewSelectionStateDidChange",
                            std::vector<Il2CppClass*>{},
