...
/// @brief Method get_text addr 0x1fe60f8 size 0x8 virtual false final false
 ::StringW get_text() ;

/// @brief Method set_text addr 0x1fe6100 size 0x8 virtual false final false
 void set_text(::StringW value) ;

/// @brief Method OnPointerEnter addr 0x1fe6108 size 0x20 virtual true final true
 void OnPointerEnter(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnPointerExit addr 0x1fe6128 size 0x18 virtual true final true
 void OnPointerExit(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnDisable addr 0x1fe6140 size 0x18 virtual false final false
 void OnDisable() ;

// Ctor Parameters []
explicit HoverTextSetter() ;

/// @brief Method .ctor addr 0x1fe6158 size 0x8 virtual false final false
 void _ctor() ;
