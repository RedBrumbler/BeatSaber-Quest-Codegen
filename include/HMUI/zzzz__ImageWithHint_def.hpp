...
/// @brief Method set_sprite addr 0x2006670 size 0x1c virtual false final false
 void set_sprite(UnityEngine::Sprite value) ;

/// @brief Method get_sprite addr 0x200668c size 0x1c virtual false final false
 UnityEngine::Sprite get_sprite() ;

/// @brief Method set_hintText addr 0x20066a8 size 0x1c virtual false final false
 void set_hintText(::StringW value) ;

// Ctor Parameters []
explicit ImageWithHint() ;

/// @brief Method .ctor addr 0x20066c4 size 0x8 virtual false final false
 void _ctor() ;
