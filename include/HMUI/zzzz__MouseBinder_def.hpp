...
/// @brief Method get_enabled addr 0x1fe1650 size 0x8 virtual false final false
 bool get_enabled() ;

/// @brief Method set_enabled addr 0x1fe1658 size 0xc virtual false final false
 void set_enabled(bool value) ;

// Ctor Parameters []
explicit MouseBinder() ;

/// @brief Method .ctor addr 0x1fe1664 size 0x1c virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0x1fe1680 size 0xc0 virtual false final false
 void Init() ;

/// @brief Method AddScrollBindings addr 0x1fe1740 size 0x13c virtual false final false
 void AddScrollBindings(System::Collections::Generic::List_1<UnityEngine::Events::UnityAction_1<float_t>> bindingData) ;

/// @brief Method AddScrollBinding addr 0x1fe187c size 0xa8 virtual false final false
 void AddScrollBinding(UnityEngine::Events::UnityAction_1<float_t> action) ;

/// @brief Method RemoveScrollBinding addr 0x1fe1924 size 0x58 virtual false final false
 void RemoveScrollBinding(UnityEngine::Events::UnityAction_1<float_t> action) ;

/// @brief Method AddButtonBindings addr 0x1fe197c size 0x174 virtual false final false
...
/// @brief Method AddButtonBinding addr 0x1fe1af0 size 0xf8 virtual false final false
...
/// @brief Method RemoveButtonBinding addr 0x1fe1be8 size 0xb0 virtual false final false
...
/// @brief Method ClearBindings addr 0x1fe1c98 size 0xa4 virtual false final false
 void ClearBindings() ;

/// @brief Method ManualUpdate addr 0x1fe1d3c size 0x384 virtual false final false
 void ManualUpdate() ;
