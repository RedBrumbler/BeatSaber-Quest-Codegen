...
/// @brief Method Awake addr 0x1ff1f58 size 0x144 virtual false final false
 void Awake() ;

/// @brief Method SetMode addr 0x1ff2134 size 0x214 virtual false final false
 void SetMode(HMUI::ScreenModeData screenModeData) ;

/// @brief Method SetDefaultMode addr 0x1ff2348 size 0x8 virtual false final false
 void SetDefaultMode() ;

// Ctor Parameters []
explicit ScreenModeController() ;

/// @brief Method .ctor addr 0x1ff2350 size 0x8 virtual false final false
 void _ctor() ;
