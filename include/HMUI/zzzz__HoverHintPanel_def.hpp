...
/// @brief Method get_isShown addr 0x1fe4c6c size 0x8 virtual false final false
 bool get_isShown() ;

/// @brief Method set_isShown addr 0x1fe4c74 size 0xc virtual false final false
 void set_isShown(bool value) ;

/// @brief Method Awake addr 0x1fe4c80 size 0xb4 virtual false final false
 void Awake() ;

/// @brief Method Show addr 0x1fe4790 size 0x274 virtual false final false
 void Show(::StringW text, UnityEngine::Transform parent, UnityEngine::Vector2 containerSize, UnityEngine::Rect spawnRect) ;

/// @brief Method Hide addr 0x1fe4354 size 0x28 virtual false final false
 void Hide() ;

/// @brief Method CalculatePanelPosition addr 0x1fe4d34 size 0x10c virtual false final false
...
/// @brief Method .ctor addr 0x1fe4e40 size 0x20 virtual false final false
 void _ctor() ;
