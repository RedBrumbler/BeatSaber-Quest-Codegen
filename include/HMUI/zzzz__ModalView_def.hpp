...
/// @brief Method .ctor addr 0x2007dcc size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <Hide>b__0 addr 0x200881c size 0x7c virtual false final false
 void _Hide_b__0() ;
...
/// @brief Method .ctor addr 0x2008804 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <HandleParentViewControllerDidDeactivate>b__0 addr 0x2008898 size 0x20 virtual false final false
...
/// @brief Method add_blockerClickedEvent addr 0x2007768 size 0x9c virtual false final false
 void add_blockerClickedEvent(System::Action value) ;

/// @brief Method remove_blockerClickedEvent addr 0x2007804 size 0x9c virtual false final false
 void remove_blockerClickedEvent(System::Action value) ;

/// @brief Method OnDisable addr 0x20078a0 size 0xc virtual false final false
 void OnDisable() ;

/// @brief Method OnDestroy addr 0x2007ac0 size 0x8c virtual false final false
 void OnDestroy() ;

/// @brief Method SetupView addr 0x2007b4c size 0x280 virtual false final false
 void SetupView(UnityEngine::Transform screenTransform) ;

/// @brief Method Hide addr 0x20078ac size 0x214 virtual false final false
 void Hide(bool animated, System::Action finishedCallback) ;

/// @brief Method Show addr 0x2007dd4 size 0x3e4 virtual false final false
 void Show(bool animated, bool moveToCenter, System::Action finishedCallback) ;

/// @brief Method CreateBlocker addr 0x20082b8 size 0x45c virtual false final false
 UnityEngine::GameObject CreateBlocker() ;

/// @brief Method HandleBlockerButtonClicked addr 0x2008714 size 0x1c virtual false final false
 void HandleBlockerButtonClicked() ;

/// @brief Method HandleParentViewControllerDidDeactivate addr 0x2008730 size 0xd4 virtual false final false
 void HandleParentViewControllerDidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) ;

/// @brief Method GetModalRootTransform addr 0x20081b8 size 0x100 virtual false final false
...
/// @brief Method .ctor addr 0x200880c size 0x10 virtual false final false
 void _ctor() ;
