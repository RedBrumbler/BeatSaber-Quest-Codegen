...
/// @brief Method get_childForceExpandWidth addr 0x1feb898 size 0x8 virtual false final false
 bool get_childForceExpandWidth() ;

/// @brief Method set_childForceExpandWidth addr 0x1feb8a0 size 0x5c virtual false final false
 void set_childForceExpandWidth(bool value) ;

/// @brief Method get_childForceExpandHeight addr 0x1feb8fc size 0x8 virtual false final false
 bool get_childForceExpandHeight() ;

/// @brief Method set_childForceExpandHeight addr 0x1feb904 size 0x5c virtual false final false
 void set_childForceExpandHeight(bool value) ;

// Ctor Parameters []
explicit StackLayoutGroup() ;

/// @brief Method .ctor addr 0x1feb960 size 0x10 virtual false final false
 void _ctor() ;

/// @brief Method CalculateLayoutInputHorizontal addr 0x1feb970 size 0x20 virtual true final false
 void CalculateLayoutInputHorizontal() ;

/// @brief Method CalculateLayoutInputVertical addr 0x1febb04 size 0x8 virtual true final false
 void CalculateLayoutInputVertical() ;

/// @brief Method SetLayoutHorizontal addr 0x1febb0c size 0x8 virtual true final false
 void SetLayoutHorizontal() ;

/// @brief Method SetLayoutVertical addr 0x1febd1c size 0x8 virtual true final false
 void SetLayoutVertical() ;

/// @brief Method CalcAlongAxis addr 0x1feb990 size 0x174 virtual false final false
 void CalcAlongAxis(int32_t axis) ;

/// @brief Method SetChildrenAlongAxis addr 0x1febb14 size 0x208 virtual false final false
