...
/// @brief Method .ctor addr 0x1fe07a4 size 0x24 virtual false final false
 void _ctor() ;

/// @brief Method Init addr 0x1fe07c8 size 0x74 virtual false final false
 void Init() ;

/// @brief Method AddBindings addr 0x1fe083c size 0x164 virtual false final false
...
/// @brief Method AddBinding addr 0x1fe09a0 size 0xd8 virtual false final false
 void AddBinding(HMUI::InputFieldView inputField, System::Action_1<HMUI::InputFieldView> action) ;

/// @brief Method ClearBindings addr 0x1fe0a78 size 0x234 virtual false final false
 void ClearBindings() ;

/// @brief Method Disable addr 0x1fe0cac size 0x204 virtual false final false
 void Disable() ;

/// @brief Method Enable addr 0x1fe0eb0 size 0x208 virtual false final false
 void Enable() ;
