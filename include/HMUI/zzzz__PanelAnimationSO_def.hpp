...
/// @brief Method ExecuteAnimation addr 0x1fdfd8c size 0x10 virtual false final false
 void ExecuteAnimation(UnityEngine::GameObject go) ;

/// @brief Method ExecuteAnimation addr 0x1fdfe68 size 0x10 virtual false final false
 void ExecuteAnimation(UnityEngine::GameObject go, System::Action finishedCallback) ;

/// @brief Method ExecuteAnimation addr 0x1fdfe78 size 0xc virtual false final false
 void ExecuteAnimation(UnityEngine::GameObject go, UnityEngine::CanvasGroup parentCanvasGroup, System::Action finishedCallback) ;

/// @brief Method ExecuteAnimation addr 0x1fdfd9c size 0xcc virtual false final false
...
/// @brief Method .ctor addr 0x1fdfe84 size 0x94 virtual false final false
 void _ctor() ;
