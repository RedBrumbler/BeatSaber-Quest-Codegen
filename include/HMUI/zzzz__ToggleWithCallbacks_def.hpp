...
/// @brief Method add_stateDidChangeEvent addr 0x200c958 size 0xb4 virtual false final false
 void add_stateDidChangeEvent(System::Action_1<HMUI::HMUI__ToggleWithCallbacks__SelectionState> value) ;

/// @brief Method remove_stateDidChangeEvent addr 0x200cc3c size 0xb4 virtual false final false
 void remove_stateDidChangeEvent(System::Action_1<HMUI::HMUI__ToggleWithCallbacks__SelectionState> value) ;

/// @brief Method get_selectionState addr 0x200ccf8 size 0x54 virtual false final false
 HMUI::HMUI__ToggleWithCallbacks__SelectionState get_selectionState() ;

/// @brief Method DoStateTransition addr 0x201083c size 0x4c virtual true final false
...
/// @brief Method .ctor addr 0x2010888 size 0x8 virtual false final false
 void _ctor() ;
