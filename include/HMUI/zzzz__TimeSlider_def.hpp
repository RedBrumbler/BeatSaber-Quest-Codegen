...
namespace HMUI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13630))}
...
/// @brief Method TextForValue addr 0x1feb638 size 0x254 virtual true final false
 ::StringW TextForValue(float_t value) ;

// Ctor Parameters []
explicit TimeSlider() ;

/// @brief Method .ctor addr 0x1feb88c size 0xc virtual false final false
 void _ctor() ;
