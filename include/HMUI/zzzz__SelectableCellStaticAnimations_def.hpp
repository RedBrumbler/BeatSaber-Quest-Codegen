...
/// @brief Method Awake addr 0x200bb98 size 0xec virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x200bc84 size 0x4 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x200bcec size 0xec virtual false final false
 void OnDestroy() ;

/// @brief Method HandleSelectionDidChange addr 0x200bdd8 size 0x4 virtual false final false
...
/// @brief Method HandleHighlightDidChange addr 0x200bddc size 0x4 virtual false final false
...
/// @brief Method RefreshVisuals addr 0x200bc88 size 0x64 virtual false final false
 void RefreshVisuals() ;

// Ctor Parameters []
explicit SelectableCellStaticAnimations() ;

/// @brief Method .ctor addr 0x200bde0 size 0x8 virtual false final false
 void _ctor() ;
