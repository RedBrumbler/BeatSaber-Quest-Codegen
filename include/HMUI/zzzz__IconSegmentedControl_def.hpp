...
/// @brief Method get_icon addr 0x1fe6e08 size 0x8 virtual false final false
 UnityEngine::Sprite get_icon() ;

/// @brief Method set_icon addr 0x1fe6e10 size 0x8 virtual false final false
 void set_icon(UnityEngine::Sprite value) ;

/// @brief Method get_hintText addr 0x1fe6e18 size 0x8 virtual false final false
 ::StringW get_hintText() ;

/// @brief Method set_hintText addr 0x1fe6e20 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x1fe6e28 size 0x2c virtual false final false
...
/// @brief Method Init addr 0x1fe6458 size 0x1c virtual false final false
 void Init() ;

/// @brief Method SetData addr 0x1fe647c size 0x40 virtual false final false
 void SetData(::ArrayW<HMUI::HMUI__IconSegmentedControl__DataItem> dataItems) ;

/// @brief Method NumberOfCells addr 0x1fe68c4 size 0x18 virtual true final true
 int32_t NumberOfCells() ;

/// @brief Method CellForCellNumber addr 0x1fe68dc size 0x180 virtual true final true
 HMUI::SegmentedControlCell CellForCellNumber(int32_t cellNumber) ;

/// @brief Method InstantiateCell addr 0x1fe6a5c size 0x180 virtual false final false
 HMUI::IconSegmentedControlCell InstantiateCell(UnityEngine::Object prefab) ;

// Ctor Parameters []
explicit IconSegmentedControl() ;

/// @brief Method .ctor addr 0x1fe6cec size 0x10 virtual false final false
 void _ctor() ;
