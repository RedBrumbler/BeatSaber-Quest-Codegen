...
/// @brief Method Awake addr 0x200c7f4 size 0x50 virtual false final false
 void Awake() ;

/// @brief Method Start addr 0x200c844 size 0x114 virtual false final false
 void Start() ;

/// @brief Method OnDestroy addr 0x200cb30 size 0x10c virtual false final false
 void OnDestroy() ;

/// @brief Method HandleOnValueChanged addr 0x200ccf0 size 0x4 virtual false final false
 void HandleOnValueChanged(bool value) ;

/// @brief Method HandleStateDidChange addr 0x200ccf4 size 0x4 virtual false final false
 void HandleStateDidChange(HMUI::HMUI__ToggleWithCallbacks__SelectionState value) ;

/// @brief Method RefreshVisuals addr 0x200ca0c size 0x124 virtual false final false
 void RefreshVisuals() ;

// Ctor Parameters []
explicit SwitchView() ;

/// @brief Method .ctor addr 0x200cd4c size 0x8 virtual false final false
 void _ctor() ;
