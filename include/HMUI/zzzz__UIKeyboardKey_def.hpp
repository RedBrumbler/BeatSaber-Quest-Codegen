...
/// @brief Method get_keyCode addr 0x1fe59f8 size 0x8 virtual false final false
 UnityEngine::KeyCode get_keyCode() ;

/// @brief Method get_canBeUppercase addr 0x1fe5a00 size 0x8 virtual false final false
 bool get_canBeUppercase() ;

/// @brief Method Awake addr 0x1fe5a08 size 0xa4 virtual false final false
 void Awake() ;

/// @brief Method OnValidate addr 0x1fe5aac size 0xe0 virtual false final false
 void OnValidate() ;

// Ctor Parameters []
explicit UIKeyboardKey() ;

/// @brief Method .ctor addr 0x1fe5b8c size 0x8 virtual false final false
 void _ctor() ;
