...
namespace HMUI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13609))}
...
/// @brief Method add_selectionDidChangeEvent addr 0x200b5f8 size 0xb0 virtual false final false
...
/// @brief Method remove_selectionDidChangeEvent addr 0x200b6a8 size 0xb0 virtual false final false
...
/// @brief Method add_highlightDidChangeEvent addr 0x200b758 size 0xb0 virtual false final false
 void add_highlightDidChangeEvent(System::Action_2<HMUI::SelectableCell,HMUI::HMUI__SelectableCell__TransitionType> value) ;

/// @brief Method remove_highlightDidChangeEvent addr 0x200b808 size 0xb0 virtual false final false
 void remove_highlightDidChangeEvent(System::Action_2<HMUI::SelectableCell,HMUI::HMUI__SelectableCell__TransitionType> value) ;

/// @brief Method get_highlighted addr 0x200b8b8 size 0x8 virtual false final false
 bool get_highlighted() ;

/// @brief Method set_highlighted addr 0x200b8c0 size 0xc virtual false final false
 void set_highlighted(bool value) ;

/// @brief Method get_selected addr 0x200b8cc size 0x8 virtual false final false
 bool get_selected() ;

/// @brief Method set_selected addr 0x200b8d4 size 0xc virtual false final false
 void set_selected(bool value) ;

/// @brief Method Start addr 0x200b8e0 size 0x30 virtual true final false
 void Start() ;

/// @brief Method SetSelected addr 0x200b910 size 0x80 virtual false final false
...
/// @brief Method ClearHighlight addr 0x200b990 size 0x10 virtual false final false
 void ClearHighlight(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method SetHighlight addr 0x200b9a0 size 0x78 virtual false final false
...
/// @brief Method SelectionDidChange addr 0x200ba18 size 0x4 virtual true final false
 void SelectionDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method HighlightDidChange addr 0x200ba1c size 0x4 virtual true final false
 void HighlightDidChange(HMUI::HMUI__SelectableCell__TransitionType transitionType) ;

/// @brief Method OnPointerClick addr 0x200ba20 size 0xb0 virtual true final false
 void OnPointerClick(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnSubmit addr 0x200bad0 size 0xa0 virtual true final false
 void OnSubmit(UnityEngine::EventSystems::BaseEventData eventData) ;

/// @brief Method OnPointerEnter addr 0x200bb70 size 0x10 virtual true final false
 void OnPointerEnter(UnityEngine::EventSystems::PointerEventData eventData) ;

/// @brief Method OnPointerExit addr 0x200bb80 size 0x10 virtual true final false
 void OnPointerExit(UnityEngine::EventSystems::PointerEventData eventData) ;

// Ctor Parameters []
explicit SelectableCell() ;

/// @brief Method .ctor addr 0x200bb90 size 0x8 virtual false final false
 void _ctor() ;
