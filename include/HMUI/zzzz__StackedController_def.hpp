...
/// @brief Method .ctor addr 0x1ff2a24 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <PopViewControllers>g__AnimationLayouter|0 addr 0x1ff2b60 size 0x74 virtual false final false
...
/// @brief Method get_topStackedViewController addr 0x1ff2604 size 0x78 virtual false final false
 HMUI::ViewController get_topStackedViewController() ;

/// @brief Method LayoutViewControllers addr 0x1ff267c size 0xe8 virtual true final false
 void LayoutViewControllers(System::Collections::Generic::List_1<HMUI::ViewController> viewControllers) ;

/// @brief Method PushViewController addr 0x1ff27b0 size 0xac virtual false final false
 void PushViewController(HMUI::ViewController viewController, System::Action finishedCallback, bool immediately) ;

/// @brief Method PopViewController addr 0x1ff285c size 0x14 virtual false final false
 void PopViewController(System::Action finishedCallback, bool immediately) ;

/// @brief Method PopViewControllers addr 0x1ff2870 size 0x1b4 virtual false final false
 void PopViewControllers(int32_t numberOfViewControllersToPop, System::Action finishedCallback, bool immediately) ;

/// @brief Method SetupViewControllerRect addr 0x1ff2764 size 0x28 virtual false final false
static void SetupViewControllerRect(HMUI::ViewController viewController, int32_t index) ;

// Ctor Parameters []
explicit StackedController() ;

/// @brief Method .ctor addr 0x1ff2ac0 size 0x8 virtual false final false
 void _ctor() ;

/// @brief Method <PushViewController>g__AnimationLayouter|3_0 addr 0x1ff2ac8 size 0x98 virtual false final false
