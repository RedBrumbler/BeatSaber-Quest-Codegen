...
/// @brief Method get_selectionState addr 0x20066cc size 0x8 virtual false final false
 HMUI::HMUI__InputFieldView__SelectionState get_selectionState() ;

/// @brief Method get_keyboardPositionOffset addr 0x20066d4 size 0x10 virtual false final false
 UnityEngine::Vector3 get_keyboardPositionOffset() ;

/// @brief Method add_selectionStateDidChangeEvent addr 0x20066e4 size 0xb4 virtual false final false
 void add_selectionStateDidChangeEvent(System::Action_1<HMUI::HMUI__InputFieldView__SelectionState> value) ;

/// @brief Method remove_selectionStateDidChangeEvent addr 0x2006798 size 0xb4 virtual false final false
 void remove_selectionStateDidChangeEvent(System::Action_1<HMUI::HMUI__InputFieldView__SelectionState> value) ;

/// @brief Method get_onValueChanged addr 0x200684c size 0x8 virtual false final false
 HMUI::HMUI__InputFieldView__InputFieldChanged get_onValueChanged() ;

/// @brief Method set_onValueChanged addr 0x2006854 size 0x8 virtual false final false
 void set_onValueChanged(HMUI::HMUI__InputFieldView__InputFieldChanged value) ;

/// @brief Method get_useGlobalKeyboard addr 0x200685c size 0x8 virtual false final false
 bool get_useGlobalKeyboard() ;

/// @brief Method get_text addr 0x2006864 size 0x8 virtual false final false
 ::StringW get_text() ;

/// @brief Method set_text addr 0x200686c size 0x58 virtual false final false
 void set_text(::StringW value) ;

/// @brief Method Awake addr 0x20069e4 size 0xec virtual true final false
 void Awake() ;

/// @brief Method OnDestroy addr 0x2006ad0 size 0x14 virtual true final false
 void OnDestroy() ;

/// @brief Method DoStateTransition addr 0x2006ae4 size 0x60 virtual true final false
 void DoStateTransition(UnityEngine::UI::UnityEngine__UI__Selectable__SelectionState state, bool instant) ;

/// @brief Method ActivateKeyboard addr 0x2006b44 size 0x1cc virtual false final false
 void ActivateKeyboard(HMUI::UIKeyboard keyboard) ;

/// @brief Method DeactivateKeyboard addr 0x2006d78 size 0x1a0 virtual false final false
 void DeactivateKeyboard(HMUI::UIKeyboard keyboard) ;

/// @brief Method SetText addr 0x2006f4c size 0x18 virtual false final false
 void SetText(::StringW value) ;

/// @brief Method ClearInput addr 0x2006f64 size 0x50 virtual false final false
 void ClearInput() ;

/// @brief Method KeyboardKeyPressed addr 0x2006fb4 size 0x128 virtual false final false
 void KeyboardKeyPressed(char16_t letter) ;

/// @brief Method KeyboardDeletePressed addr 0x20070dc size 0xdc virtual false final false
 void KeyboardDeletePressed() ;

/// @brief Method BlinkingCaretCoroutine addr 0x2006d10 size 0x68 virtual false final false
 System::Collections::IEnumerator BlinkingCaretCoroutine() ;

/// @brief Method UpdateCaretPosition addr 0x20068c4 size 0xf0 virtual false final false
 void UpdateCaretPosition() ;

/// @brief Method UpdatePlaceholder addr 0x20069b4 size 0x30 virtual false final false
 void UpdatePlaceholder() ;

/// @brief Method UpdateClearButton addr 0x2006f18 size 0x34 virtual false final false
 void UpdateClearButton() ;

// Ctor Parameters []
explicit InputFieldView() ;

/// @brief Method .ctor addr 0x20071e0 size 0x138 virtual false final false
 void _ctor() ;

/// @brief Method <Awake>b__34_0 addr 0x2007360 size 0x88 virtual false final false
 void _Awake_b__34_0() ;
...
namespace HMUI {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10420)), TypeDefinitionIndex(TypeDefinitionIndex(13702)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10420), inst: 316 })}
...
/// @brief Method .ctor addr 0x2007318 size 0x48 virtual false final false
 void _ctor() ;
...
/// @brief Method .ctor addr 0x20071b8 size 0x28 virtual false final false
 void _ctor(int32_t __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x20073e8 size 0x4 virtual true final true
 void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x20073ec size 0x8c virtual true final true
 bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x2007478 size 0x8 virtual true final true
 ::bs_hook::Il2CppWrapperType System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x2007480 size 0x40 virtual true final true
 void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x20074c0 size 0x8 virtual true final true
