...
/// @brief Method LazyInit addr 0x200be30 size 0xb0 virtual false final false
 void LazyInit() ;

/// @brief Method OnDestroy addr 0x200bee0 size 0x90 virtual true final false
 void OnDestroy() ;

/// @brief Method Init addr 0x200bf70 size 0x40 virtual false final false
 void Init(HMUI::HMUI__TableView__IDataSource initTableViewDataSource) ;

/// @brief Method SetTexts addr 0x200bfb0 size 0x1a0 virtual false final false
 void SetTexts(System::Collections::Generic::IReadOnlyList_1<::StringW> texts) ;

/// @brief Method SelectCellWithIdx addr 0x200c150 size 0x1ec virtual true final false
 void SelectCellWithIdx(int32_t idx) ;

/// @brief Method CellSize addr 0x200c33c size 0x8 virtual true final true
 float_t CellSize() ;

/// @brief Method NumberOfCells addr 0x200c344 size 0xac virtual true final true
 int32_t NumberOfCells() ;

/// @brief Method CellForIdx addr 0x200c3f0 size 0x1bc virtual true final true
 HMUI::TableCell CellForIdx(HMUI::TableView tableView, int32_t idx) ;

/// @brief Method HandleDidSelectCellWithIdx addr 0x200c698 size 0x14c virtual false final false
 void HandleDidSelectCellWithIdx(HMUI::DropdownWithTableView dropdownWithTableView, int32_t idx) ;

// Ctor Parameters []
explicit SimpleTextDropdown() ;

/// @brief Method .ctor addr 0x200c7e4 size 0x10 virtual false final false
 void _ctor() ;
