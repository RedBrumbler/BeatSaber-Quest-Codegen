...
/// @brief Method OnPopulateMesh addr 0x1fec0d0 size 0x5b8 virtual true final false
 void OnPopulateMesh(UnityEngine::UI::VertexHelper vh) ;

/// @brief Method OnDrawGizmosSelected addr 0x1fec688 size 0x18c virtual false final false
 void OnDrawGizmosSelected() ;

// Ctor Parameters []
explicit EmptyBoxGraphic() ;

/// @brief Method .ctor addr 0x1fec814 size 0x60 virtual false final false
 void _ctor() ;
