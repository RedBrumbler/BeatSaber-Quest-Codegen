...
namespace Unity::XR::OpenVR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6221))}
...
/// @brief Method get_grip addr 0x28d4ebc size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::AxisControl get_grip() ;

/// @brief Method set_grip addr 0x28d4ec4 size 0x8 virtual false final false
 void set_grip(UnityEngine::InputSystem::Controls::AxisControl value) ;

/// @brief Method get_gripPressed addr 0x28d4ecc size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_gripPressed() ;

/// @brief Method set_gripPressed addr 0x28d4ed4 size 0x8 virtual false final false
 void set_gripPressed(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_primary addr 0x28d4edc size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_primary() ;

/// @brief Method set_primary addr 0x28d4ee4 size 0x8 virtual false final false
 void set_primary(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_trackpadPressed addr 0x28d4eec size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_trackpadPressed() ;

/// @brief Method set_trackpadPressed addr 0x28d4ef4 size 0x8 virtual false final false
 void set_trackpadPressed(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_triggerPressed addr 0x28d4efc size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_triggerPressed() ;

/// @brief Method set_triggerPressed addr 0x28d4f04 size 0x8 virtual false final false
 void set_triggerPressed(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method FinishSetup addr 0x28d4f0c size 0x138 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit HandedViveTracker() ;

/// @brief Method .ctor addr 0x28d5044 size 0x8 virtual false final false
 void _ctor() ;
