...
/// @brief Method add_InputFocusAcquired addr 0x2b0fac8 size 0xb8 virtual false final false
static void add_InputFocusAcquired(System::Action value) ;

/// @brief Method remove_InputFocusAcquired addr 0x2b0fb80 size 0xb8 virtual false final false
static void remove_InputFocusAcquired(System::Action value) ;

/// @brief Method add_InputFocusLost addr 0x2b0fc38 size 0xbc virtual false final false
static void add_InputFocusLost(System::Action value) ;

/// @brief Method remove_InputFocusLost addr 0x2b0fcf4 size 0xbc virtual false final false
static void remove_InputFocusLost(System::Action value) ;

/// @brief Method get_hasInputFocus addr 0x2b0fdb0 size 0x4 virtual false final false
static bool get_hasInputFocus() ;

/// @brief Method Update addr 0x2b0fdb8 size 0xa0 virtual false final false
static void Update() ;

// Ctor Parameters []
explicit InputFocus() ;

/// @brief Method .ctor addr 0x2b0fe58 size 0x8 virtual false final false
 void _ctor() ;
