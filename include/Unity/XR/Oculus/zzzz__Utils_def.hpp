...
/// @brief Method SetColorScaleAndOffset addr 0x2b0f8d4 size 0x40 virtual false final false
static void SetColorScaleAndOffset(UnityEngine::Vector4 colorScale, UnityEngine::Vector4 colorOffset) ;

/// @brief Method GetSystemHeadsetType addr 0x2b0f91c size 0x4 virtual false final false
static Unity::XR::Oculus::SystemHeadset GetSystemHeadsetType() ;

/// @brief Method SetFoveationLevel addr 0x2b0f924 size 0x8c virtual false final false
static bool SetFoveationLevel(int32_t level) ;

/// @brief Method EnableDynamicFFR addr 0x2b0f9b8 size 0x8c virtual false final false
static bool EnableDynamicFFR(bool enable) ;

/// @brief Method GetFoveationLevel addr 0x2b0fa4c size 0x78 virtual false final false
