...
/// @brief Method IsDeviceSupported addr 0x2b10384 size 0x90 virtual false final false
static Unity::XR::Oculus::Unity__XR__Oculus__OculusLoader__DeviceSupportedResult IsDeviceSupported() ;

/// @brief Method get_displaySubsystem addr 0x2b10418 size 0x70 virtual false final false
 UnityEngine::XR::XRDisplaySubsystem get_displaySubsystem() ;

/// @brief Method get_inputSubsystem addr 0x2b10488 size 0x70 virtual false final false
 UnityEngine::XR::XRInputSubsystem get_inputSubsystem() ;

/// @brief Method Initialize addr 0x2b104f8 size 0x438 virtual true final false
 bool Initialize() ;

/// @brief Method PermissionGrantedCallback addr 0x2b10cc0 size 0x64 virtual false final false
 void PermissionGrantedCallback(::StringW permissionName) ;

/// @brief Method Start addr 0x2b10d2c size 0x7c virtual true final false
 bool Start() ;

/// @brief Method Stop addr 0x2b10da8 size 0x7c virtual true final false
 bool Stop() ;

/// @brief Method Deinitialize addr 0x2b10e24 size 0x7c virtual true final false
 bool Deinitialize() ;

/// @brief Method RuntimeLoadOVRPlugin addr 0x2b10f1c size 0x178 virtual false final false
static void RuntimeLoadOVRPlugin() ;

/// @brief Method GetSettings addr 0x2b11098 size 0x48 virtual false final false
 Unity::XR::Oculus::OculusSettings GetSettings() ;

/// @brief Method CheckUnityVersionCompatibility addr 0x2b10930 size 0x2dc virtual false final false
 bool CheckUnityVersionCompatibility() ;

// Ctor Parameters []
explicit OculusLoader() ;

/// @brief Method .ctor addr 0x2b110e0 size 0x8 virtual false final false
 void _ctor() ;
