...
/// @brief Method GetStereoRenderingMode addr 0x2b10c0c size 0x8 virtual false final false
 uint16_t GetStereoRenderingMode() ;

/// @brief Method Awake addr 0x2b14424 size 0x4c virtual false final false
 void Awake() ;

// Ctor Parameters []
explicit OculusSettings() ;

/// @brief Method .ctor addr 0x2b14470 size 0x30 virtual false final false
 void _ctor() ;
