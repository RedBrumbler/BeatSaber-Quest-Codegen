...
/// @brief Method get_back addr 0x2b15278 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_back() ;

/// @brief Method set_back addr 0x2b15280 size 0x8 virtual false final false
 void set_back(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_start addr 0x2b15288 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::ButtonControl get_start() ;

/// @brief Method set_start addr 0x2b15290 size 0x8 virtual false final false
 void set_start(UnityEngine::InputSystem::Controls::ButtonControl value) ;

/// @brief Method get_touchpad addr 0x2b15298 size 0x8 virtual false final false
 UnityEngine::InputSystem::Controls::Vector2Control get_touchpad() ;

/// @brief Method set_touchpad addr 0x2b152a0 size 0x8 virtual false final false
 void set_touchpad(UnityEngine::InputSystem::Controls::Vector2Control value) ;

/// @brief Method FinishSetup addr 0x2b152a8 size 0xe8 virtual true final false
 void FinishSetup() ;

// Ctor Parameters []
explicit OculusRemote() ;

/// @brief Method .ctor addr 0x2b15390 size 0x8 virtual false final false
 void _ctor() ;
