...
/// @brief Method TrySetCPULevel addr 0x2b111c0 size 0x18 virtual false final false
static bool TrySetCPULevel(int32_t level) ;

/// @brief Method TrySetGPULevel addr 0x2b111dc size 0x18 virtual false final false
static bool TrySetGPULevel(int32_t level) ;

/// @brief Method TryGetAvailableDisplayRefreshRates addr 0x2b111f8 size 0x1b8 virtual false final false
static bool TryGetAvailableDisplayRefreshRates(ByRef<::ArrayW<float_t>> refreshRates) ;

/// @brief Method TrySetDisplayRefreshRate addr 0x2b113b4 size 0x4 virtual false final false
static bool TrySetDisplayRefreshRate(float_t refreshRate) ;

/// @brief Method TryGetDisplayRefreshRate addr 0x2b113bc size 0x4 virtual false final false
