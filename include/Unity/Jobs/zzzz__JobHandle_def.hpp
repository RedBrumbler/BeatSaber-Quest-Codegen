...
/// @brief Method Complete addr 0x2b59f9c size 0x8c virtual false final false
 void Complete() ;

/// @brief Method get_IsCompleted addr 0x2b5a064 size 0x3c virtual false final false
 bool get_IsCompleted() ;

/// @brief Method ScheduleBatchedJobs addr 0x2b5a0dc size 0x28 virtual false final false
static void ScheduleBatchedJobs() ;

/// @brief Method ScheduleBatchedJobsAndComplete addr 0x2b5a028 size 0x3c virtual false final false
static void ScheduleBatchedJobsAndComplete(ByRef<Unity::Jobs::JobHandle> job) ;

/// @brief Method ScheduleBatchedJobsAndIsCompleted addr 0x2b5a0a0 size 0x3c virtual false final false
static bool ScheduleBatchedJobsAndIsCompleted(ByRef<Unity::Jobs::JobHandle> job) ;

/// @brief Method CombineDependencies addr 0x2b5a104 size 0x28 virtual false final false
static Unity::Jobs::JobHandle CombineDependencies(Unity::Jobs::JobHandle job0, Unity::Jobs::JobHandle job1) ;

/// @brief Method CombineDependenciesInternal2 addr 0x2b5a12c size 0x5c virtual false final false
static Unity::Jobs::JobHandle CombineDependenciesInternal2(ByRef<Unity::Jobs::JobHandle> job0, ByRef<Unity::Jobs::JobHandle> job1) ;

/// @brief Method CombineDependenciesInternal2_Injected addr 0x2b5a188 size 0x54 virtual false final false
