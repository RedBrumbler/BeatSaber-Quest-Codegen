...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2610)), TypeDefinitionIndex(TypeDefinitionIndex(9931))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9931), inst: 7146 })
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(9931)), TypeDefinitionIndex(TypeDefinitionIndex(2610))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9931), inst: 7147 })
// CS Name: Unity.Jobs.IJobParallelForExtensions::ParallelForJobStruct`1::ExecuteJobFunction
...
template<>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(9932)), TypeDefinitionIndex(TypeDefinitionIndex(2638))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9932), inst: 7146 })
...
template<>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2638)), TypeDefinitionIndex(TypeDefinitionIndex(9932))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9932), inst: 7147 })
// CS Name: Unity.Jobs.IJobParallelForExtensions::ParallelForJobStruct`1
