...
/// @brief Method IsBlittableValueType addr 0x2b5a728 size 0x60 virtual false final false
static bool IsBlittableValueType(System::Type t) ;

/// @brief Method GetReasonForTypeNonBlittableImpl addr 0x2b5a7c4 size 0x1bc virtual false final false
static ::StringW GetReasonForTypeNonBlittableImpl(System::Type t, ::StringW name) ;

/// @brief Method IsArrayBlittable addr 0x2b5a980 size 0x30 virtual false final false
...
/// @brief Method GetReasonForArrayNonBlittable addr 0x2b5a9b0 size 0x4c virtual false final false
...
/// @brief Method Malloc addr 0x2b5a9fc size 0x54 virtual false final false
static void* Malloc(int64_t size, int32_t alignment, Unity::Collections::Allocator allocator) ;

/// @brief Method Free addr 0x2b5a690 size 0x44 virtual false final false
static void Free(void* memory, Unity::Collections::Allocator allocator) ;

/// @brief Method MemCpy addr 0x2b5aa50 size 0x54 virtual false final false
static void MemCpy(void* destination, void* source, int64_t size) ;

/// @brief Method MemCpyStride addr 0x2b5aaa4 size 0x74 virtual false final false
...
/// @brief Method MemMove addr 0x2b5ab18 size 0x54 virtual false final false
static void MemMove(void* destination, void* source, int64_t size) ;

/// @brief Method MemSet addr 0x2b5ab6c size 0x54 virtual false final false
static void MemSet(void* destination, uint8_t value, int64_t size) ;

/// @brief Method MemClear addr 0x2b5abc0 size 0x48 virtual false final false
static void MemClear(void* destination, int64_t size) ;

/// @brief Method MemCmp addr 0x2b5ac08 size 0x54 virtual false final false
static int32_t MemCmp(void* ptr1, void* ptr2, int64_t size) ;

/// @brief Method IsBlittable addr 0x2b5a788 size 0x3c virtual false final false
